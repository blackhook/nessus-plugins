...
"A remote management agent is listening on the remote host.");
...
program allows a system to be managed remotely by an administrator.");
  script_set_attribute(attribute:"see_also", value:"https://www.microfocus.com/products/zenworks/?utm_medium=301&utm_source=novell.com");
