...
if (description)
{
  ...
  script_name(english:"Zoom Client for Meetings 5.7.3 < 5.11.5 Vulnerability (ZSB-22018)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Zoom Client for Meetings installed on the remote host is between 5.7.3 and 5.11.5. It is, therefore,
affected by a vulnerability as referenced in the ZSB-22018 advisory.

  - The Zoom Client for Meetings for macOS (Standard and for IT Admin) starting with version 5.7.3  and before
    5.11.5 and Zoom Rooms for Conference Room for macOS before version 5.11.6 contains a vulnerability in the
    auto update process. A local low-privileged user could exploit this vulnerability to escalate their
    privileges to root. Users can help keep themselves secure by applying current updates or downloading the
    latest Zoom software with all current security updates from https://zoom.us/download. *Changes -
    2022-09-13 - Updated title, description and added Zoom Rooms to the Affected Products section.
    (CVE-2022-28756)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-22018
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae4f0ce6");
...
var constraints = [
  { 'min_version' : '5.7.3', 'fixed_version' : '5.11.5' }
];
