...
if (description)
{
  ...
  script_cve_id("CVE-2022-22786");

  script_name(english:"Zoom Client for Meetings < 5.10.0 Vulnerability (ZSB-22008)");
...
vulnerability as referenced in the ZSB-22008 advisory.

  - The Zoom Client for Meetings for Windows before version 5.10.0 and Zoom Rooms for Conference Room for
    Windows before version 5.10.0, fails to properly check the installation version during the update process.
    This issue could be used in a more sophisticated attack to trick a user into downgrading their Zoom client
    to a less secure version. Users can help keep themselves secure by applying current updates or downloading
    the latest Zoom software with all current security updates from https://zoom.us/download. (CVE-2022-22786)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://explore.zoom.us/en/trust/security/security-bulletin/?filter-cve=&filter=&keywords=ZSB-22008
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b149cdb");
