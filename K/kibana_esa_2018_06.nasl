...
if (description)
{
  ...
  script_cve_id("CVE-2018-3823");

  script_name(english:"Kibana ESA-2018-06");
...
site scripting (XSS) vulnerability. Users with manage_ml permissions
could create jobs containing malicious data as part of their
configuration that could allow the attacker to obtain sensitive
information from or perform destructive actions on behalf of other ML
users viewing the results of the jobs.");
...
"Users should upgrade to Elasticsearch version 6.2.4 or 5.6.9");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-3823");
...
vcf::check_version_and_report(app_info:app_info, constraints:constraints, severity:SECURITY_NOTE, flags:flags);
