...
execute arbitrary code." );
 script_set_attribute(attribute:"see_also", value:"https://3proxy.ru/0.5.3h/Changelog.txt" );
 script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/archive/1/466650/100/100/threaded" );
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 2008-2018 Marcin Kozlowski");
