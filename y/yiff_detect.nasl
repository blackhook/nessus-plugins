...
network sound server.");
  script_set_attribute(attribute:"see_also", value:"http://freshmeat.sourceforge.net/projects/yiff/");
...
organization's acceptable use and security policies.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:raphael_bossek:yiff_server");
