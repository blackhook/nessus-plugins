...
# extracted from Debian Security Advisory DLA-1484-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1484-1 : squirrelmail security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00031.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"squirrelmail", reference:"2:1.4.23~svn20120406-2+deb8u3")) flag++;
