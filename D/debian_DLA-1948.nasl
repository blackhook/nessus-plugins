...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/10/msg00007.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/ruby-mini-magick"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected ruby-mini-magick package."
  );
