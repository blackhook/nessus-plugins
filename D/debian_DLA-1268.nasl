...
# extracted from Debian Security Advisory DLA-1268-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1268-1 : p7zip security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/02/msg00003.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"p7zip", reference:"9.20.1~dfsg.1-4+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"p7zip-full", reference:"9.20.1~dfsg.1-4+deb7u3")) flag++;
