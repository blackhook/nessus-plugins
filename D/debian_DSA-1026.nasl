...
# extracted from Debian Security Advisory DSA-1026. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1026-1 : sash - buffer overflows");
...
file compression and decompression, handles invalid input. This flaw
can cause programs which use zlib to crash when opening an invalid
file. A further error in the way zlib handles the inflation of certain
...
thus affected by these problems."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=318069"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1026"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the sash package.
...
flag = 0;
if (deb_check(release:"3.1", prefix:"sash", reference:"3.7-5sarge1")) flag++;
