...
# extracted from Debian Security Advisory DSA-318. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-318-1 : lyskom-server - denial of service");
...
server to become unresponsive as it processes a large query."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-318"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
The old stable distribution (potato) does not contain a lyskom-server
package.
...
We recommend that you update your lyskom-server package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:lyskom-server");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"lyskom-server", reference:"2.0.6-1woody1")) flag++;
