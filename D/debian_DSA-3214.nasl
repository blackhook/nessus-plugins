...
# extracted from Debian Security Advisory DSA-3214. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3214");

  script_name(english:"Debian DSA-3214-1 : mailman - security update");
...
exploit this, an attacker needs write access on the local file system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=781626"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3214"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"mailman", reference:"1:2.1.15-1+deb7u1")) flag++;
