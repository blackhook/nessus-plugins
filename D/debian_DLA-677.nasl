...
# extracted from Debian Security Advisory DLA-677-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-677-1 : nss security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/10/msg00030.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libnss3", reference:"3.26-1+debu7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libnss3-1d", reference:"3.26-1+debu7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libnss3-dbg", reference:"3.26-1+debu7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libnss3-dev", reference:"3.26-1+debu7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libnss3-tools", reference:"3.26-1+debu7u1")) flag++;
