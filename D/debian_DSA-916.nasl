...
# extracted from Debian Security Advisory DSA-916. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-916-1 : inkscape - buffer overflow");
...
project identifies the following problems :
  ...
  - CVE-2005-3885
    Javier Fernandez-Sanguino Pena noticed that the
    ps2epsi extension shell script uses a hard-coded
    temporary file making it vulnerable to symlink attacks."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=321501"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=330894"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-916"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 0.41-4.99.sarge2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:inkscape");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"inkscape", reference:"0.41-4.99.sarge2")) flag++;
