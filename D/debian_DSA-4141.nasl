...
is opened."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=893132"
  );
  # https://security-tracker.debian.org/tracker/source-package/libvorbisidec
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a433cb89"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/libvorbisidec"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/libvorbisidec"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2018/dsa-4141"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
