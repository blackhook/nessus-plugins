...
We recommend that you update your gzip package."
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"1998/01/28");
...
flag = 0;
if (deb_check(release:"2.2", prefix:"gzip", reference:"1.2.4-33.2")) flag++;
if (deb_check(release:"3.0", prefix:"gzip", reference:"1.3.2-3woody1")) flag++;
