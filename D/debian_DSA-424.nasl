...
# extracted from Debian Security Advisory DSA-424. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-424-1 : mc - buffer overflow");
...
arbitrary code to be executed if opened by Midnight Commander."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-424"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"gmc", reference:"4.5.55-1.2woody2")) flag++;
if (deb_check(release:"3.0", prefix:"mc", reference:"4.5.55-1.2woody2")) flag++;
if (deb_check(release:"3.0", prefix:"mc-common", reference:"4.5.55-1.2woody2")) flag++;
