...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0537");
...
platform = get_kb_item_or_exit(
  "DB2/" + port + "/Platform",
  exit_code:1,
  msg:"Failed to extract the platform value of IBM DB2 listening on port "+port+"."
);
...
eos_dates = make_array(
   ...
   '9.8', 'Apr 30, 2019',
  '10.1', 'Sep 30, 2020'
#  '10.5', 'Apr 30, 2023' # or later
#  '11.1', 'Apr 30, 2025' # or later
);
...
withdrawl_announcements = make_array(
  ...
  '10.5', 'https://www-01.ibm.com/common/ssi/ShowDoc.wss?docURL=/common/ssi/rep_ca/8/897/ENUS918-138/index.html&request_locale=en'
#  '11.1', 'https://www-01.ibm.com/common/ssi/cgi-bin/ssialias?subtype=ca&infotype=an&appname=iSource&supplier=897&letternum=ENUS920-049'
);

# Mostly from https://www.ibm.com/support/pages/node/578841
# Legacy version data from https://www-304.ibm.com/support/docview.wss?uid=swg27007053
#
...
lowest_supported_version = "10.5.0";
if ( ver_compare(ver:lowest_supported_version, fix:version_highlevel, strict:FALSE) > 0 )
{
