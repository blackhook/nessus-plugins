...
# extracted from Debian Security Advisory DSA-4652. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4652");

  script_name(english:"Debian DSA-4652-1 : gnutls28 - security update");
...
security guarantees of the DTLS protocol."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=955556"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2020/dsa-4652"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"gnutls-bin", reference:"3.6.7-4+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"gnutls-doc", reference:"3.6.7-4+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"libgnutls-dane0", reference:"3.6.7-4+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"libgnutls-openssl27", reference:"3.6.7-4+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"libgnutls28-dev", reference:"3.6.7-4+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"libgnutls30", reference:"3.6.7-4+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"libgnutlsxx28", reference:"3.6.7-4+deb10u3")) flag++;
