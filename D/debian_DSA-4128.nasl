...
# extracted from Debian Security Advisory DSA-4128. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4128");

  script_name(english:"Debian DSA-4128-1 : trafficserver - security update");
...
denial-of-service by application crash."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2018/dsa-4128"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"9.0", prefix:"trafficserver", reference:"7.0.0-6+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"trafficserver-dev", reference:"7.0.0-6+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"trafficserver-experimental-plugins", reference:"7.0.0-6+deb9u1")) flag++;
