...
crafted file is processed."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/catdoc"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/catdoc"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3917"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the catdoc packages.
...
flag = 0;
if (deb_check(release:"8.0", prefix:"catdoc", reference:"0.94.4-1.1+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"catdoc", reference:"1:0.94.3~git20160113.dbc9ec6+dfsg-1+deb9u1")) flag++;
