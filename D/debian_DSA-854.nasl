...
# extracted from Debian Security Advisory DSA-854. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-854-1 : tcpdump - infinite loop");
...
via an infinite loop."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-854"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"tcpdump", reference:"3.8.3-5sarge1")) flag++;
