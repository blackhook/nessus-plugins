...
# extracted from Debian Security Advisory DSA-570. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-570-1 : libpng - integer overflow");
...
specially crafted PNG image is processed."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-570"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libpng2", reference:"1.0.12-3.woody.9")) flag++;
if (deb_check(release:"3.0", prefix:"libpng2-dev", reference:"1.0.12-3.woody.9")) flag++;
