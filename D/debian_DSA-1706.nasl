...
# extracted from Debian Security Advisory DSA-1706. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1706-1 : amarok - integer overflows");
...
arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1706"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the amarok packages.
...
distribution (sid), this problem has been fixed in version 1.4.10-2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:amarok");
...
flag = 0;
if (deb_check(release:"4.0", prefix:"amarok", reference:"1.4.4-4etch1")) flag++;
if (deb_check(release:"4.0", prefix:"amarok-engines", reference:"1.4.4-4etch1")) flag++;
if (deb_check(release:"4.0", prefix:"amarok-xine", reference:"1.4.4-4etch1")) flag++;
