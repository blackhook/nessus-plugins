...
# extracted from Debian Security Advisory DLA-1792-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1792-2 : cups-filters regression update");
  ...
  script_set_attribute(
    ...
    value:
"The update for ghostscript released as DLA-1792-1 uncovered an issue
in cups-filters which was using the undocumented Ghostscript internal
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/05/msg00025.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2019/05/19");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"cups-browsed", reference:"1.0.61-5+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"cups-filters", reference:"1.0.61-5+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"cups-filters-core-drivers", reference:"1.0.61-5+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"libcupsfilters-dev", reference:"1.0.61-5+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"libcupsfilters1", reference:"1.0.61-5+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"libfontembed-dev", reference:"1.0.61-5+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"libfontembed1", reference:"1.0.61-5+deb8u4")) flag++;
