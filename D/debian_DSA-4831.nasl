...
# extracted from Debian Security Advisory DSA-4831. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4831");

  script_name(english:"Debian DSA-4831-1 : ruby-redcarpet - security update");
...
cross-site scripting attack."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=980057"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/buster/ruby-redcarpet"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4831"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Upgrade the ruby-redcarpet packages.
...
flag = 0;
if (deb_check(release:"10.0", prefix:"ruby-redcarpet", reference:"3.4.0-4+deb10u1")) flag++;
