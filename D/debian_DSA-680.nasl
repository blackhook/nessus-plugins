...
# extracted from Debian Security Advisory DSA-680. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-680-1 : htdig - unsanitised input");
...
ht://dig, a web search system for an intranet or small internet."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-680"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"htdig", reference:"3.1.6-3woody1")) flag++;
if (deb_check(release:"3.0", prefix:"htdig-doc", reference:"3.1.6-3woody1")) flag++;
