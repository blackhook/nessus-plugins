...
if (description)
{
  ...
  script_name(english:"Debian DLA-3178-1 : ffmpeg - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3178");
...
For Debian 10 buster, this problem has been fixed in version 7");
