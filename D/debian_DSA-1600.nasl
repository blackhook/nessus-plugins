...
# extracted from Debian Security Advisory DSA-1600. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1600");

  script_name(english:"Debian DSA-1600-1 : sympa - dos");
...
crash when processing certain types of malformed messages."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=475163"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1600"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"sympa", reference:"5.2.3-1.2+etch1")) flag++;
