...
# extracted from Debian Security Advisory DSA-2478. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2478");

  script_name(english:"Debian DSA-2478-1 : sudo - parsing error");
...
where the user would not be allowed to run the specified command."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2012/dsa-2478"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"6.0", prefix:"sudo", reference:"1.7.4p4-2.squeeze.3")) flag++;
if (deb_check(release:"6.0", prefix:"sudo-ldap", reference:"1.7.4p4-2.squeeze.3")) flag++;
