...
if (description)
{
  ...
  script_name(english:"Drupal 7.x < 7.73 / 8.8.x < 8.8.10 / 8.9.x < 8.9.6 / 9.0.x < 9.0.6 XSS (drupal-2020-09-16)");

  script_set_attribute(attribute:"synopsis", value:
"A PHP application running on the remote web server is affected by a cross-site scripting vulnerability");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, the instance of Drupal running on the remote web server is 7.x prior to 7.73, 
8.8.x prior to 8.8.10, 8.9.x prior to 8.9.6, or 9.0.x prior to 9.0.6. It is, therefore, affected by a cross-site 
scripting (XSS) vulnerability in the AJAX API component due to improper validation of user-supplied input before 
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.drupal.org/project/drupal/releases/7.73");
...
"Upgrade to Drupal version 7.73 / 8.8.10 / 8.9.6 / 9.0.6 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-13666");
...
constraints = [
  { 'min_version' : '7.0', 'fixed_version' : '7.73' },
