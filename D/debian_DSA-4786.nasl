...
# extracted from Debian Security Advisory DSA-4786. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4786");

  script_name(english:"Debian DSA-4786-1 : libexif - security update");
...
EXIF files, could be optimised away by the compiler, resulting in a
potential buffer overflow."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2020/dsa-4786"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"libexif-dev", reference:"0.6.21-5.1+deb10u5")) flag++;
if (deb_check(release:"10.0", prefix:"libexif-doc", reference:"0.6.21-5.1+deb10u5")) flag++;
if (deb_check(release:"10.0", prefix:"libexif12", reference:"0.6.21-5.1+deb10u5")) flag++;
