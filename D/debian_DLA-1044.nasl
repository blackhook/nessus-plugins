...
# extracted from Debian Security Advisory DLA-1044-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1044-1 : ipsec-tools security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/07/msg00039.html"
  );
  script_set_attribute(
    attribute:"see_also",
