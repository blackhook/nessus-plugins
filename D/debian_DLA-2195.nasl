...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/04/msg00025.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/w3m"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected w3m, and w3m-img packages."
  );
