...
# extracted from Debian Security Advisory DSA-858. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-858-1 : xloadimage - buffer overflows");
...
titles and cause the execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-858"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"xloadimage", reference:"4.1-10woody2")) flag++;
if (deb_check(release:"3.1", prefix:"xloadimage", reference:"4.1-14.3")) flag++;
