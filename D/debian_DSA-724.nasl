...
# extracted from Debian Security Advisory DSA-724. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-724-1 : phpsysinfo - design flaw");
...
in phpsysinfo, a PHP based host information application."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-724"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"phpsysinfo", reference:"2.0-3woody2")) flag++;
