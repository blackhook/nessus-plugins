...
# extracted from Debian Security Advisory DSA-1055. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1055-1 : mozilla-firefox - programming error");
...
codebase, Firefox may be vulnerable as well."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1055"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"mozilla-firefox", reference:"1.0.4-2sarge7")) flag++;
if (deb_check(release:"3.1", prefix:"mozilla-firefox-dom-inspector", reference:"1.0.4-2sarge7")) flag++;
if (deb_check(release:"3.1", prefix:"mozilla-firefox-gnome-support", reference:"1.0.4-2sarge7")) flag++;
