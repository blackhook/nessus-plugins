...
# extracted from Debian Security Advisory DLA-496-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-496-1 : ruby-activerecord-3.2 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/05/msg00050.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ruby-activerecord-3.2", reference:"3.2.6-5+deb7u2")) flag++;
