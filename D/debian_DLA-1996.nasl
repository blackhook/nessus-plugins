...
# extracted from Debian Security Advisory DLA-1996-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1996-1 : libapache2-mod-auth-openidc security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00016.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/libapache2-mod-auth-openidc"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected libapache2-mod-auth-openidc package."
  );
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libapache2-mod-auth-openidc", reference:"1.6.0-1+deb8u2")) flag++;
