...
# extracted from Debian Security Advisory DLA-882-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-882-1 : tryton-server security update");
...
For Debian 7 'Wheezy', this issue has been fixed in tryton-server
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/04/msg00001.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"tryton-server", reference:"2.2.4-1+deb7u4")) flag++;
