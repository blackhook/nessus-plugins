...
# extracted from Debian Security Advisory DSA-376. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-376-2 : exim - buffer overflow");
...
believed at this time to be exploitable to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-376"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"exim", reference:"3.35-1woody2")) flag++;
if (deb_check(release:"3.0", prefix:"exim-tls", reference:"3.35-3woody1")) flag++;
if (deb_check(release:"3.0", prefix:"eximon", reference:"3.35-1woody2")) flag++;
