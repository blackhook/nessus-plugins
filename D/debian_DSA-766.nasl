...
# extracted from Debian Security Advisory DSA-766. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-766-1 : webcalendar - authorisation failure");
...
information to unauthorised parties."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=315671"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-766"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"webcalendar", reference:"0.9.45-4sarge1")) flag++;
