...
# extracted from Debian Security Advisory DSA-3182. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3182");

  script_name(english:"Debian DSA-3182-1 : libssh2 - security update");
...
otherwise read and use unintended memory areas in this process."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=780249"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3182"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libssh2-1", reference:"1.4.2-1.1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libssh2-1-dbg", reference:"1.4.2-1.1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libssh2-1-dev", reference:"1.4.2-1.1+deb7u1")) flag++;
