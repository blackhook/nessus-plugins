...
# extracted from Debian Security Advisory DLA-415-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-415-1 : cpio security update");
  ...
  script_set_attribute(
    ...
    value:
"An out-of-bounds write was discovered in the parsing of cpio files.
For Debian 6 'Squeeze', this issue has been fixed in cpio version
2.11-4+deb6u2.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/02/msg00007.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"cpio", reference:"2.11-4+deb6u2")) flag++;
if (deb_check(release:"6.0", prefix:"cpio-win32", reference:"2.11-4+deb6u2")) flag++;
