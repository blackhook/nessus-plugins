...
# extracted from Debian Security Advisory dla-2926. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2926-1 : zsh - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2926
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2926");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'zsh', 'reference': '5.3.1-4+deb9u5'},
    {'release': '9.0', 'prefix': 'zsh-common', 'reference': '5.3.1-4+deb9u5'},
    {'release': '9.0', 'prefix': 'zsh-dev', 'reference': '5.3.1-4+deb9u5'},
    {'release': '9.0', 'prefix': 'zsh-doc', 'reference': '5.3.1-4+deb9u5'},
    {'release': '9.0', 'prefix': 'zsh-static', 'reference': '5.3.1-4+deb9u5'}
];
