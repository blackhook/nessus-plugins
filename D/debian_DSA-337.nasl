...
# extracted from Debian Security Advisory DSA-337. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-337-1 : gtksee - buffer overflow");
...
victim loads the file in gtksee."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/76346"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-337"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your gtksee package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:gtksee");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"gtksee", reference:"0.5.0-6")) flag++;
