...
# extracted from Debian Security Advisory dsa-5043. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5043-1 : lxml - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 / 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5043
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5043");
  ...
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/lxml");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'python-lxml', 'reference': '4.3.2-1+deb10u4'},
    {'release': '10.0', 'prefix': 'python-lxml-dbg', 'reference': '4.3.2-1+deb10u4'},
    {'release': '10.0', 'prefix': 'python-lxml-doc', 'reference': '4.3.2-1+deb10u4'},
    {'release': '10.0', 'prefix': 'python3-lxml', 'reference': '4.3.2-1+deb10u4'},
    {'release': '10.0', 'prefix': 'python3-lxml-dbg', 'reference': '4.3.2-1+deb10u4'},
    {'release': '11.0', 'prefix': 'python-lxml', 'reference': '4.6.3+dfsg-0.1+deb11u1'},
    {'release': '11.0', 'prefix': 'python-lxml-dbg', 'reference': '4.6.3+dfsg-0.1+deb11u1'},
    {'release': '11.0', 'prefix': 'python-lxml-doc', 'reference': '4.6.3+dfsg-0.1+deb11u1'},
    {'release': '11.0', 'prefix': 'python3-lxml', 'reference': '4.6.3+dfsg-0.1+deb11u1'},
    {'release': '11.0', 'prefix': 'python3-lxml-dbg', 'reference': '4.6.3+dfsg-0.1+deb11u1'}
];
