...
# extracted from Debian Security Advisory DLA-2543-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2543-1 : libdatetime-timezone-perl new upstream version");
  ...
  script_set_attribute(
    ...
    value:
"This update includes the changes in tzdata 2021a for the Perl
bindings. For the list of changes, see DLA-2542-1.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00004.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libdatetime-timezone-perl", reference:"1:2.09-1+2021a")) flag++;
