...
# extracted from Debian Security Advisory DSA-1315. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1315-1 : libphp-phpmailer - missing input validation");
...
The oldstable distribution (sarge) doesn't include libphp-phpmailer."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2007/dsa-1315"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libphp-phpmailer package.
...
flag = 0;
if (deb_check(release:"4.0", prefix:"libphp-phpmailer", reference:"1.73-2etch1")) flag++;
