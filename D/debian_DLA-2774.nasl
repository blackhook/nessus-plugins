...
# extracted from Debian Security Advisory dla-2774. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2774-1 : openssl1.0 - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2774
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2774");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libssl1.0-dev', 'reference': '1.0.2u-1~deb9u6'},
    {'release': '9.0', 'prefix': 'libssl1.0.2', 'reference': '1.0.2u-1~deb9u6'}
];
