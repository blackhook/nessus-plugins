...
# extracted from Debian Security Advisory DSA-574. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-574-1 : cabextract - missing directory sanitising");
...
files."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=277522"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-574"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"cabextract", reference:"0.2-2b")) flag++;
