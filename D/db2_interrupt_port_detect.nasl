...
port is used to support requests from down-level clients.");
  ...
  # https://www.ibm.com/support/knowledgecenter/SSEPGG_10.1.0/com.ibm.db2.luw.kc.doc/welcome.html?origURL=api/redirect/db2luw/v10r1/index.jsp
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0cf99b58");
