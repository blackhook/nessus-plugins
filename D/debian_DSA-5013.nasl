...
# extracted from Debian Security Advisory dsa-5013. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5013-1 : roundcube - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-5013");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'roundcube', 'reference': '1.3.17+dfsg.1-1~deb10u1'},
    {'release': '10.0', 'prefix': 'roundcube-core', 'reference': '1.3.17+dfsg.1-1~deb10u1'},
    {'release': '10.0', 'prefix': 'roundcube-mysql', 'reference': '1.3.17+dfsg.1-1~deb10u1'},
    {'release': '10.0', 'prefix': 'roundcube-pgsql', 'reference': '1.3.17+dfsg.1-1~deb10u1'},
    {'release': '10.0', 'prefix': 'roundcube-plugins', 'reference': '1.3.17+dfsg.1-1~deb10u1'},
    {'release': '10.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.3.17+dfsg.1-1~deb10u1'},
    {'release': '11.0', 'prefix': 'roundcube', 'reference': '1.4.12+dfsg.1-1~deb11u1'},
    {'release': '11.0', 'prefix': 'roundcube-core', 'reference': '1.4.12+dfsg.1-1~deb11u1'},
    {'release': '11.0', 'prefix': 'roundcube-mysql', 'reference': '1.4.12+dfsg.1-1~deb11u1'},
    {'release': '11.0', 'prefix': 'roundcube-pgsql', 'reference': '1.4.12+dfsg.1-1~deb11u1'},
    {'release': '11.0', 'prefix': 'roundcube-plugins', 'reference': '1.4.12+dfsg.1-1~deb11u1'},
    {'release': '11.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.4.12+dfsg.1-1~deb11u1'}
];
