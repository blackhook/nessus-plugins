...
# extracted from Debian Security Advisory dsa-5387. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5387-1 : openvswitch - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5387
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1034042");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/openvswitch");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5387");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'openvswitch-common', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-dbg', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-dev', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-ipsec', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-pki', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-switch', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-switch-dpdk', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-testcontroller', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'openvswitch-vtep', 'reference': '2.15.0+ds1-2+deb11u4'},
    {'release': '11.0', 'prefix': 'python3-openvswitch', 'reference': '2.15.0+ds1-2+deb11u4'}
];
