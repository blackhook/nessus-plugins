...
# extracted from Debian Security Advisory DSA-234. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-234-1 : kdeadmin - several vulnerabilities");
...
places."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-234"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
The old stable distribution (potato) does not contain KDE packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:kdeadmin");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"kcmlinuz", reference:"2.2.2-7.2")) flag++;
if (deb_check(release:"3.0", prefix:"kcron", reference:"2.2.2-7.2")) flag++;
if (deb_check(release:"3.0", prefix:"kpackage", reference:"2.2.2-7.2")) flag++;
if (deb_check(release:"3.0", prefix:"ksysv", reference:"2.2.2-7.2")) flag++;
if (deb_check(release:"3.0", prefix:"kuser", reference:"2.2.2-7.2")) flag++;
if (deb_check(release:"3.0", prefix:"kwuftpd", reference:"2.2.2-7.2")) flag++;
if (deb_check(release:"3.0", prefix:"lilo-config", reference:"2.2.2-7.2")) flag++;
if (deb_check(release:"3.0", prefix:"secpolicy", reference:"2.2.2-7.2")) flag++;
