...
# extracted from Debian Security Advisory DSA-304. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-304-1 : lv - privilege escalation");
...
privileges of the user invoking lv, including root."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-304"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your lv package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:lv");
...
flag = 0;
if (deb_check(release:"2.2", prefix:"lv", reference:"4.49.3-4potato2")) flag++;
if (deb_check(release:"3.0", prefix:"lv", reference:"4.49.4-7woody2")) flag++;
