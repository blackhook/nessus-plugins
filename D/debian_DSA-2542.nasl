...
# extracted from Debian Security Advisory DSA-2542. The text 
...
if (description)
{
  ...
  script_bugtraq_id(53725, 55413);
  script_xref(name:"DSA", value:"2542");

  script_name(english:"Debian DSA-2542-1 : qemu-kvm - multiple vulnerabilities");
...
and Exposures project identifies the following problems :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2012/dsa-2542"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
in version 0.12.5+dfsg-5+squeeze9."
  );
...
flag = 0;
if (deb_check(release:"6.0", prefix:"kvm", reference:"0.12.5+dfsg-5+squeeze9")) flag++;
if (deb_check(release:"6.0", prefix:"qemu-kvm", reference:"0.12.5+dfsg-5+squeeze9")) flag++;
if (deb_check(release:"6.0", prefix:"qemu-kvm-dbg", reference:"0.12.5+dfsg-5+squeeze9")) flag++;
