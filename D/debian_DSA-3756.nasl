...
# extracted from Debian Security Advisory DSA-3756. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3756");

  script_name(english:"Debian DSA-3756-1 : icoutils - security update");
...
arbitrary code if a malformed binary is parsed."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3756"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"icoutils", reference:"0.31.0-2+deb8u1")) flag++;
