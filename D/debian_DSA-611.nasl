...
# extracted from Debian Security Advisory DSA-611. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-611-1 : htget - buffer overflow");
...
buffer and execute arbitrary code by accessing a malicious URL."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-611"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the htget package.
...
This package is not present in the testing and unstable distributions."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:htget");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"htget", reference:"0.93-1.1woody1")) flag++;
