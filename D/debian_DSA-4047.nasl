...
# extracted from Debian Security Advisory DSA-4047. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4047");

  script_name(english:"Debian DSA-4047-1 : otrs2 - security update");
...
execution of arbitrary shell commands by logged-in agents."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-4047"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
fixed in version 3.3.18-1+deb8u2.

For the stable distribution (stretch), these problems have been fixed
in version 5.0.16-1+deb9u3."
  );
...
flag = 0;
if (deb_check(release:"8.0", prefix:"otrs", reference:"3.3.18-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"otrs2", reference:"3.3.18-1+deb8u2")) flag++;
if (deb_check(release:"9.0", prefix:"otrs", reference:"5.0.16-1+deb9u3")) flag++;
if (deb_check(release:"9.0", prefix:"otrs2", reference:"5.0.16-1+deb9u3")) flag++;
