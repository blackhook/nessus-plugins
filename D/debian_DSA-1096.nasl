...
# extracted from Debian Security Advisory DSA-1096. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1096-1 : webcalendar - uninitialised variable");
...
arbitrary PHP code when register_globals is turned on."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1096"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"webcalendar", reference:"0.9.45-4sarge5")) flag++;
