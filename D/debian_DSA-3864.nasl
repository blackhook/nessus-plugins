...
# extracted from Debian Security Advisory DSA-3864. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3864");

  script_name(english:"Debian DSA-3864-1 : fop - security update");
...
Apache FOP XML formatter may result in information disclosure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/fop"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3864"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the fop packages.
...
flag = 0;
if (deb_check(release:"8.0", prefix:"fop", reference:"1:1.1.dfsg2-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"fop-doc", reference:"1:1.1.dfsg2-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libfop-java", reference:"1:1.1.dfsg2-1+deb8u1")) flag++;
