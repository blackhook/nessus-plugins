...
if (description)
{
  ...
  script_name(english:"Debian DLA-3478-1 : yajl - LTS security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1039984");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/yajl");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3478");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libyajl-dev', 'reference': '2.1.0-3+deb10u1'},
    {'release': '10.0', 'prefix': 'libyajl-doc', 'reference': '2.1.0-3+deb10u1'},
    {'release': '10.0', 'prefix': 'libyajl2', 'reference': '2.1.0-3+deb10u1'},
    {'release': '10.0', 'prefix': 'libyajl2-dbg', 'reference': '2.1.0-3+deb10u1'},
    {'release': '10.0', 'prefix': 'yajl-tools', 'reference': '2.1.0-3+deb10u1'}
];
