...
if (description)
{
  script_id(164674);
  script_version("1.2");
  script_set_attribute(attribute:"plugin_modification_date", value:"2022/09/04");

  script_cve_id("CVE-2021-0561");

  script_name(english:"Debian DLA-3094-1 : flac - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3094");
