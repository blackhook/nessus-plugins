...
# extracted from Debian Security Advisory DLA-2425-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2425-1 : openldap security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2020/11/01");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"ldap-utils", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"libldap-2.4-2", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"libldap-2.4-2-dbg", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"libldap-common", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"libldap2-dev", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"slapd", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"slapd-dbg", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
if (deb_check(release:"9.0", prefix:"slapd-smbk5pwd", reference:"2.4.44+dfsg-5+deb9u5")) flag++;
