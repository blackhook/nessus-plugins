...
# extracted from Debian Security Advisory DSA-572. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-572-1 : ecartis - several vulnerabilities");
...
administrator privileges and alter list settings."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-572"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the ecartis package.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"ecartis", reference:"0.129a+1.0.0-snap20020514-1.3")) flag++;
if (deb_check(release:"3.0", prefix:"ecartis-cgi", reference:"0.129a+1.0.0-snap20020514-1.3")) flag++;
