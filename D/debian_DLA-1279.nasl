...
# extracted from Debian Security Advisory DLA-1279-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1279-1 : clamav security update");
...
service or maybe unspecified impact via drafted files (heap-based
buffer overflow and stack-based buffer over-read causing application
crash)
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/02/msg00014.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"clamav", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"clamav-base", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"clamav-daemon", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"clamav-dbg", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"clamav-docs", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"clamav-freshclam", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"clamav-milter", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"clamav-testfiles", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"libclamav-dev", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"libclamav7", reference:"0.99.2+dfsg-0+deb7u5")) flag++;
