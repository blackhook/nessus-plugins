...
# extracted from Debian Security Advisory DSA-3133. The text 
...
if (description)
{
  ...
  script_bugtraq_id(71993);
  script_xref(name:"DSA", value:"3133");

  script_name(english:"Debian DSA-3133-1 : privoxy - security update");
  ...
  script_set_attribute(
    ...
    value:
"Multiple use-after-frees were discovered in Privoxy, a
privacy-enhancing HTTP proxy."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3133"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"privoxy", reference:"3.0.19-2+deb7u1")) flag++;
