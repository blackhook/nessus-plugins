...
# extracted from Debian Security Advisory DSA-4839. The text 
...
non-sudoers) can exploit this flaw for root privilege escalation."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4839"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"sudo", reference:"1.8.27-1+deb10u3")) flag++;
if (deb_check(release:"10.0", prefix:"sudo-ldap", reference:"1.8.27-1+deb10u3")) flag++;
