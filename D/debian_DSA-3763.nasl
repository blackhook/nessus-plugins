...
# extracted from Debian Security Advisory DSA-3763. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3763");

  script_name(english:"Debian DSA-3763-1 : pdns-recursor - security update");
...
becomes overloaded."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3763"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"pdns-recursor", reference:"3.6.2-2+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"pdns-recursor-dbg", reference:"3.6.2-2+deb8u3")) flag++;
