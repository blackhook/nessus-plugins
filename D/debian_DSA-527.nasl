...
# extracted from Debian Security Advisory DSA-527. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-527-1 : pavuk - buffer overflow");
  ...
  script_set_attribute(
    ...
    value:
"Ulf Harnhammar discovered a vulnerability in pavuk, a file retrieval
...
of the pavuk process."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-527"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your pavuk package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:pavuk");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"pavuk", reference:"0.9pl28-1woody1")) flag++;
