...
# extracted from Debian Security Advisory DLA-1233-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1233-1 : gifsicle security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/01/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/gifsicle"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected gifsicle package."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"gifsicle", reference:"1.67-1.1~deb7u1")) flag++;
