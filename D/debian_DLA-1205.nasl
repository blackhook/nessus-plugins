...
# extracted from Debian Security Advisory DLA-1205-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1205-1 : simplesamlphp security update");
...
The InfoCard module for SimpleSAMLphp allows attackers to spoof XML
messages by leveraging an incorrect check of return values in
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/12/msg00007.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"simplesamlphp", reference:"1.9.2-1+deb7u1")) flag++;
