...
# extracted from Debian Security Advisory DLA-1837-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1837-2 : rdesktop regression update");
  ...
  script_set_attribute(
    ...
    value:
"The update for rdesktop released as 1.8.6-0+deb8u1 introduced a
regression which broke RDP protocol negotiation. Updated rdesktop
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/07/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"rdesktop", reference:"1.8.6-0+deb8u2")) flag++;
