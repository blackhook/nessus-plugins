...
if (description)
{
  ...
  script_xref(name:"EDB-ID", value:"40457");

  script_name(english:"Dup Scout HTTP POST Request Handling Remote Stack Buffer Overflow");
  ...
  Dup Scout product contains an overflow condition that is triggered
  ...
  script_set_attribute(attribute:"see_also", value:"https://dupscout.com");
  script_set_attribute(attribute:"solution", value:"Upgrade to Dup Scout 10.6 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");

  script_set_attribute(attribute:"cpe",value:"cpe:/a:flexense:dupscout");
  ...
  script_require_keys("installed_sw/Dup Scout");
