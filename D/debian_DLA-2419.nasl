...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/10/msg00029.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/dompurify.js"
  );
  # https://security-tracker.debian.org/tracker/source-package/dompurify.js
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?008b7ba5"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade the affected libjs-dompurify, and node-dompurify packages."
  );
