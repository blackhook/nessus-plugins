...
# extracted from Debian Security Advisory DLA-318-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-318-1 : flightgear security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/09/msg00014.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze-lts/flightgear"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected flightgear package."
  );
...
flag = 0;
if (deb_check(release:"6.0", prefix:"flightgear", reference:"1.9.1-1.1")) flag++;
