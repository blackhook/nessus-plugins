...
# extracted from Debian Security Advisory DSA-2762. The text 
...
if (description)
{
  ...
  script_bugtraq_id(62460, 62463, 62467, 62469, 62473, 62475, 62478, 62479);
  script_xref(name:"DSA", value:"2762");

  script_name(english:"Debian DSA-2762-1 : icedove - several vulnerabilities");
...
oldstable."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2013/dsa-2762"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"calendar-google-provider", reference:"17.0.9-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"icedove", reference:"17.0.9-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"icedove-dbg", reference:"17.0.9-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"icedove-dev", reference:"17.0.9-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"iceowl-extension", reference:"17.0.9-1~deb7u1")) flag++;
