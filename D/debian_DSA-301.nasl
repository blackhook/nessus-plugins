...
# extracted from Debian Security Advisory DSA-301. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-301-1 : libgtop - buffer overflow");
...
not carried over to later versions of libgtop."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-301"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libgtop-daemon", reference:"1.0.13-3.1")) flag++;
if (deb_check(release:"3.0", prefix:"libgtop-dev", reference:"1.0.13-3.1")) flag++;
if (deb_check(release:"3.0", prefix:"libgtop1", reference:"1.0.13-3.1")) flag++;
