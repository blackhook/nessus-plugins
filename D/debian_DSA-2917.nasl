...
# extracted from Debian Security Advisory DSA-2917. The text 
...
if (description)
{
  ...
  script_bugtraq_id(67114);
  script_xref(name:"DSA", value:"2917");

  script_name(english:"Debian DSA-2917-1 : super - security update");
...
against RLIMIT_NPROC attacks."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/super"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2917"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"6.0", prefix:"super", reference:"3.30.0-3+squeeze2")) flag++;
if (deb_check(release:"7.0", prefix:"super", reference:"3.30.0-6+deb7u1")) flag++;
