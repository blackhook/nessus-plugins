...
# extracted from Debian Security Advisory DSA-1129. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1129-1 : osiris - format string");
...
arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1129"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the osiris packages.
...
version 4.0.6-1sarge1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:osiris");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"osiris", reference:"4.0.6-1sarge1")) flag++;
if (deb_check(release:"3.1", prefix:"osirisd", reference:"4.0.6-1sarge1")) flag++;
if (deb_check(release:"3.1", prefix:"osirismd", reference:"4.0.6-1sarge1")) flag++;
