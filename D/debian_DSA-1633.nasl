...
# extracted from Debian Security Advisory DSA-1633. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1633-1 : slash - SQL Injection, XSS");
...
(CVE-2008-2231 ) and cross-site scripting (CVE-2008-2553 )."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=484499"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2008-2231"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2008-2553"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1633"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the slash package.
...
uninstallable and will be removed soon."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:slash");
...
flag = 0;
if (deb_check(release:"4.0", prefix:"slash", reference:"2.2.6-8etch1")) flag++;
