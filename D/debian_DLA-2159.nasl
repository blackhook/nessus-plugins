...
# extracted from Debian Security Advisory DLA-2159-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2159-1 : okular security update");
  ...
  script_set_attribute(
    ...
    value:
"Mickael Karatekin from Sysdream Labs discovered that the Okular
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/03/msg00033.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/okular"
  );
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libokularcore5", reference:"4:4.14.2-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"okular", reference:"4:4.14.2-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"okular-dbg", reference:"4:4.14.2-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"okular-dev", reference:"4:4.14.2-2+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"okular-extra-backends", reference:"4:4.14.2-2+deb8u2")) flag++;
