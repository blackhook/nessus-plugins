...
# extracted from Debian Security Advisory DSA-1670. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1670-1 : enscript - buffer overflows");
...
and Exposures project identifies the following problems :
  ...
  - CVE-2008-3863
    Ulf Harnhammer discovered that a buffer overflow may
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2008-3863"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2008-4306"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1670"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"enscript", reference:"1.6.4-11.1")) flag++;
