...
# extracted from Debian Security Advisory DLA-2008-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2008-1 : nss security update");
  ...
  script_set_attribute(
    ...
    value:
"A vulnerability has been discovered in nss, the Mozilla Network
Security Service library. An out-of-bounds write can occur when
passing an output buffer smaller than the block size to
NSC_EncryptUpdate.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00026.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libnss3", reference:"2:3.26-1+debu8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libnss3-1d", reference:"2:3.26-1+debu8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libnss3-dbg", reference:"2:3.26-1+debu8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libnss3-dev", reference:"2:3.26-1+debu8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libnss3-tools", reference:"2:3.26-1+debu8u7")) flag++;
