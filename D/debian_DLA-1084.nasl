...
# extracted from Debian Security Advisory DLA-1084-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1084-1 : libidn security update");
...
libidn's Punycode handling (an encoding used to convert Unicode
characters to ASCII) which would have allowed remote attackers to
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/09/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"idn", reference:"1.25-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libidn11", reference:"1.25-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libidn11-dev", reference:"1.25-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libidn11-java", reference:"1.25-2+deb7u3")) flag++;
