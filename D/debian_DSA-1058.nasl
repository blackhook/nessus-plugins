...
# extracted from Debian Security Advisory DSA-1058. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1058-1 : awstats - missing input sanitising");
...
execute arbitrary commands."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=364443"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=365909"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1058"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"awstats", reference:"6.4-1sarge2")) flag++;
