...
# extracted from Debian Security Advisory DLA-2627-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2627-1 : xorg-server security update");
...
escalation for authorised clients, particularly on systems where the X
server is running as a privileged user.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00013.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"xdmx", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xdmx-tools", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xnest", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xorg-server-source", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-common", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xephyr", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-core", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-core-udeb", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-dev", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-legacy", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xvfb", reference:"2:1.19.2-1+deb9u8")) flag++;
if (deb_check(release:"9.0", prefix:"xwayland", reference:"2:1.19.2-1+deb9u8")) flag++;
