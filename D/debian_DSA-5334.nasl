...
# extracted from Debian Security Advisory dsa-5334. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5334-1 : varnish - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5334
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1023751");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/varnish");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5334");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libvarnishapi-dev', 'reference': '6.5.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'libvarnishapi2', 'reference': '6.5.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'varnish', 'reference': '6.5.1-1+deb11u3'},
    {'release': '11.0', 'prefix': 'varnish-doc', 'reference': '6.5.1-1+deb11u3'}
];
