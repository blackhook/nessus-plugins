...
# extracted from Debian Security Advisory DSA-1045. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1045-1 : openvpn - design error");
...
malicious VPN server to take over connected clients."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=360559"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1045"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"openvpn", reference:"2.0-1sarge3")) flag++;
