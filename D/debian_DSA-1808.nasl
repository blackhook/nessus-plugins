...
# extracted from Debian Security Advisory DSA-1808. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1808-1 : drupal6 - insufficient input sanitising");
...
vulnerability."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=529190"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=531386"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1808"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"5.0", prefix:"drupal6", reference:"6.6-3lenny2")) flag++;
