...
# extracted from Debian Security Advisory DSA-1100. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1100-1 : wv2 - integer overflow");
...
overflow induced by processing word files."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1100"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libwv packages.
...
version 0.2.2-1sarge1"
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:wv2");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"libwv2-1", reference:"0.2.2-1sarge1")) flag++;
if (deb_check(release:"3.1", prefix:"libwv2-dev", reference:"0.2.2-1sarge1")) flag++;
