...
# extracted from Debian Security Advisory DSA-069. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-069-1 : xloadimage - buffer overflow");
...
"The version of xloadimage (a graphics files viewer for X) that was
 ...
 using xloadimagewhich would allow them to execute arbitrary code.

This problem was fixed in version 4.1-5potato1."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2001/dsa-069"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected xloadimage package."
  );
...
flag = 0;
if (deb_check(release:"2.2", prefix:"xloadimage", reference:"4.1-5potato1")) flag++;
