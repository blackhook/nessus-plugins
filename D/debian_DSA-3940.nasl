...
# extracted from Debian Security Advisory DSA-3940. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3940");

  script_name(english:"Debian DSA-3940-1 : cvs - security update");
...
allowed an attacker to run an arbitrary shell command."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=871810"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/cvs"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/cvs"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3940"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"cvs", reference:"2:1.12.13+real-15+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"cvs", reference:"2:1.12.13+real-22+deb9u1")) flag++;
