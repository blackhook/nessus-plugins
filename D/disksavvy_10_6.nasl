...
if (description)
{
  ...
  script_xref(name:"EDB-ID", value:"40459");

  script_name(english:"Disk Savvy HTTP POST Request Handling Remote Stack Buffer Overflow");
  script_summary(english:"Checks Disk Savvy Enterprise version from its web interface");

  script_set_attribute(attribute:"synopsis",value:"
  The remote host is affected by a buffer overflow vulnerability.");
  script_set_attribute(attribute:"description",value:"
  Disk Savvy product contains an overflow condition that is triggered
  ...
  script_set_attribute(attribute:"see_also", value:"https://disksavvy.com");
  script_set_attribute(attribute:"solution", value:"Upgrade to Disk Savvy 10.6 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");

  script_set_attribute(attribute:"cpe",value:"cpe:/a:flexense:disksavvy");
  ...
  script_require_keys("installed_sw/Disk Savvy");
