...
# extracted from Debian Security Advisory DSA-1175. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1175-1 : isakmpd - programming error");
...
the replay counter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=385894"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1175"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the isakmpd package.
...
version 20041012-1sarge1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:isakmpd");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"isakmpd", reference:"20041012-1sarge1")) flag++;
