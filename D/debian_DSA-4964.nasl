...
# extracted from Debian Security Advisory dsa-4964. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4964-1 : grilo - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-4964
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=992971");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/grilo");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4964");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-39365");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/grilo");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'gir1.2-grilo-0.3', 'reference': '0.3.13-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgrilo-0.3-0', 'reference': '0.3.13-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgrilo-0.3-bin', 'reference': '0.3.13-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgrilo-0.3-dev', 'reference': '0.3.13-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libgrilo-0.3-doc', 'reference': '0.3.13-1+deb11u1'}
];
