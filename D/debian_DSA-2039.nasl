...
# extracted from Debian Security Advisory DSA-2039. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-2039-1 : cacti - missing input sanitising");
...
systems and services missed input sanitising, making a SQL injection
attack possible."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=578909"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2010/dsa-2039"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"5.0", prefix:"cacti", reference:"0.8.7b-2.1+lenny2")) flag++;
