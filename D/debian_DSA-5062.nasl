...
# extracted from Debian Security Advisory dsa-5062. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5062-1 : nss - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 / 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5062
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5062");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libnss3', 'reference': '2:3.42.1-1+deb10u5'},
    {'release': '10.0', 'prefix': 'libnss3-dev', 'reference': '2:3.42.1-1+deb10u5'},
    {'release': '10.0', 'prefix': 'libnss3-tools', 'reference': '2:3.42.1-1+deb10u5'},
    {'release': '11.0', 'prefix': 'libnss3', 'reference': '2:3.61-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libnss3-dev', 'reference': '2:3.61-1+deb11u2'},
    {'release': '11.0', 'prefix': 'libnss3-tools', 'reference': '2:3.61-1+deb11u2'}
];
