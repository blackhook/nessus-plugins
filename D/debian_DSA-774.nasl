...
# extracted from Debian Security Advisory DSA-774. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-774-1 : fetchmail - buffer overflow");
...
code that will be executed on the victim host. If fetchmail is running
as root, this becomes a root exploit."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=212762"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-774"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"fetchmail", reference:"6.2.5-12sarge1")) flag++;
if (deb_check(release:"3.1", prefix:"fetchmail-ssl", reference:"6.2.5-12sarge1")) flag++;
if (deb_check(release:"3.1", prefix:"fetchmailconf", reference:"6.2.5-12sarge1")) flag++;
