...
# extracted from Debian Security Advisory dla-2878. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2878-1 : roundcube - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2878
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2878");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'roundcube', 'reference': '1.2.3+dfsg.1-4+deb9u10'},
    {'release': '9.0', 'prefix': 'roundcube-core', 'reference': '1.2.3+dfsg.1-4+deb9u10'},
    {'release': '9.0', 'prefix': 'roundcube-mysql', 'reference': '1.2.3+dfsg.1-4+deb9u10'},
    {'release': '9.0', 'prefix': 'roundcube-pgsql', 'reference': '1.2.3+dfsg.1-4+deb9u10'},
    {'release': '9.0', 'prefix': 'roundcube-plugins', 'reference': '1.2.3+dfsg.1-4+deb9u10'},
    {'release': '9.0', 'prefix': 'roundcube-sqlite3', 'reference': '1.2.3+dfsg.1-4+deb9u10'}
];
