...
# extracted from Debian Security Advisory DSA-902. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-902-1 : xmail - buffer overflow");
...
privileges."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-902"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the xmail package.
...
version 1.21-3sarge1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:xmail");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"xmail", reference:"1.21-3sarge1")) flag++;
if (deb_check(release:"3.1", prefix:"xmail-doc", reference:"1.21-3sarge1")) flag++;
