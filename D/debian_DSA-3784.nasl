...
# extracted from Debian Security Advisory DSA-3784. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3784");

  script_name(english:"Debian DSA-3784-1 : viewvc - security update");
...
problem resulted in a potential Cross-Site Scripting vulnerability."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=854681"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/viewvc"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3784"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"viewvc", reference:"1.1.22-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"viewvc-query", reference:"1.1.22-1+deb8u1")) flag++;
