...
# extracted from Debian Security Advisory DLA-770-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-770-2 : libphp-phpmailer regression update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/01/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libphp-phpmailer", reference:"5.1-1.2")) flag++;
