...
# extracted from Debian Security Advisory DLA-2492-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2492-1 : openssl security update");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libcrypto1.1-udeb", reference:"1.1.0l-1~deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libssl-dev", reference:"1.1.0l-1~deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libssl-doc", reference:"1.1.0l-1~deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libssl1.1", reference:"1.1.0l-1~deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libssl1.1-udeb", reference:"1.1.0l-1~deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"openssl", reference:"1.1.0l-1~deb9u2")) flag++;
