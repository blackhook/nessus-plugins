...
# extracted from Debian Security Advisory DSA-4850. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4850");

  script_name(english:"Debian DSA-4850-1 : libzstd - security update");
...
file had restrictive permissions."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4850"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"libzstd-dev", reference:"1.3.8+dfsg-3+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"libzstd1", reference:"1.3.8+dfsg-3+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"zstd", reference:"1.3.8+dfsg-3+deb10u1")) flag++;
