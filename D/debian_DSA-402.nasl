...
# extracted from Debian Security Advisory DSA-402. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-402-1 : minimalist - unsanitised input");
...
arbitrary commands."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-402"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the minimalist package.
...
version 2.2-4."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:minimalist");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"minimalist", reference:"2.2-4")) flag++;
