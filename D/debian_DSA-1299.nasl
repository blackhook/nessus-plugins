...
# extracted from Debian Security Advisory DSA-1299. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1299");

  script_name(english:"Debian DSA-1299-1 : ipsec-tools - missing input sanitising");
...
The oldstable distribution (sarge) isn't affected by this problem."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2007/dsa-1299"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"ipsec-tools", reference:"1:0.6.6-3.1etch1")) flag++;
if (deb_check(release:"4.0", prefix:"racoon", reference:"1:0.6.6-3.1etch1")) flag++;
