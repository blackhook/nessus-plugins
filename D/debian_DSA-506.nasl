...
# extracted from Debian Security Advisory DSA-506. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-506-1 : neon - buffer overflow");
...
cases. This can lead to an overflow of a static heap variable."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-506"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libneon* packages.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libneon-dev", reference:"0.19.3-2woody5")) flag++;
if (deb_check(release:"3.0", prefix:"libneon19", reference:"0.19.3-2woody5")) flag++;
