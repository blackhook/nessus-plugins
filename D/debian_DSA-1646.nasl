...
# extracted from Debian Security Advisory DSA-1646. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1646-1 : squid - array bounds check");
...
condition against squid."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2007-6239"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1646"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"squid", reference:"2.6.5-6etch2")) flag++;
if (deb_check(release:"4.0", prefix:"squid-cgi", reference:"2.6.5-6etch2")) flag++;
if (deb_check(release:"4.0", prefix:"squid-common", reference:"2.6.5-6etch2")) flag++;
if (deb_check(release:"4.0", prefix:"squidclient", reference:"2.6.5-6etch2")) flag++;
