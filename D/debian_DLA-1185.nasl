...
# extracted from Debian Security Advisory DLA-1185-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1185-1 : sam2p security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/11/msg00031.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/sam2p"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected sam2p package."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"sam2p", reference:"0.49.1-1+deb7u2")) flag++;
