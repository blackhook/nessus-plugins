...
# extracted from Debian Security Advisory DLA-2180-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2180-1 : file-roller security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/04/msg00013.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/file-roller"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected file-roller package."
  );
...
flag = 0;
if (deb_check(release:"8.0", prefix:"file-roller", reference:"3.14.1-1+deb8u2")) flag++;
