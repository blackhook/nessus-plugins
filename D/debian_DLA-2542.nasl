...
# extracted from Debian Security Advisory DLA-2542-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2542-1 : tzdata new upstream version");
  ...
  script_set_attribute(
    ...
    value:
"This update includes the changes in tzdata 2021a. Notable changes 
are :
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00003.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"tzdata", reference:"2021a-0+deb9u1")) flag++;
