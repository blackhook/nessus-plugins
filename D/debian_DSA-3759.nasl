...
if (description)
{
  ...
  script_cve_id("CVE-2016-10127", "CVE-2016-10149");
...
range of exploits."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=850716"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3759"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
