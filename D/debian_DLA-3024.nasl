...
# extracted from Debian Security Advisory dla-3024. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3024-1 : python-django - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3024
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3024");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-9402");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'python-django', 'reference': '1:1.10.7-2+deb9u17'},
    {'release': '9.0', 'prefix': 'python-django-common', 'reference': '1:1.10.7-2+deb9u17'},
    {'release': '9.0', 'prefix': 'python-django-doc', 'reference': '1:1.10.7-2+deb9u17'},
    {'release': '9.0', 'prefix': 'python3-django', 'reference': '1:1.10.7-2+deb9u17'}
];
