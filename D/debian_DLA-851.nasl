...
# extracted from Debian Security Advisory DLA-851-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-851-1 : wget security update");
...
wget (a tool to retrieve files from the web) which allowed remote
attackers to inject arbitrary HTTP headers via CRLF sequences in the
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/03/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"wget", reference:"1.13.4-3+deb7u4")) flag++;
