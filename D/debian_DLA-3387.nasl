...
if (description)
{
  ...
  script_name(english:"Debian DLA-3387-1 : udisks2 - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3387");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'gir1.2-udisks-2.0', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'libudisks2-0', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'libudisks2-dev', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'udisks2', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'udisks2-bcache', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'udisks2-btrfs', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'udisks2-doc', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'udisks2-lvm2', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'udisks2-vdo', 'reference': '2.8.1-4+deb10u1'},
    {'release': '10.0', 'prefix': 'udisks2-zram', 'reference': '2.8.1-4+deb10u1'}
];
