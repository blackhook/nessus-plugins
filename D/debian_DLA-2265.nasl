...
# extracted from Debian Security Advisory DLA-2265-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2265-1 : mailman security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/06/msg00036.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"mailman", reference:"1:2.1.18-2+deb8u7")) flag++;
