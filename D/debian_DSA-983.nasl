...
# extracted from Debian Security Advisory DSA-983. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-983-1 : pdftohtml - several vulnerabilities");
...
documents into HTML format."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-983"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"pdftohtml", reference:"0.36-11sarge2")) flag++;
