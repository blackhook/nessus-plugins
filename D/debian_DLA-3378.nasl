...
if (description)
{
  ...
  script_name(english:"Debian DLA-3378-1 : duktape - LTS security update");
...
advisory.
  ...
  - Duktape v2.99.99 was discovered to contain a SEGV vulnerability via the component duk_push_tval in
    duktape/duk_api_stack.c. (CVE-2021-46322)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3378");
