...
# extracted from Debian Security Advisory DSA-1849. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1849");

  script_name(english:"Debian DSA-1849-1 : xml-security-c - design flaw");
...
original HMAC output, whichever is greater."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1849"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"libxml-security-c-dev", reference:"1.2.1-3+etch1")) flag++;
if (deb_check(release:"4.0", prefix:"libxml-security-c-doc", reference:"1.2.1-3+etch1")) flag++;
if (deb_check(release:"4.0", prefix:"libxml-security-c12", reference:"1.2.1-3+etch1")) flag++;
if (deb_check(release:"5.0", prefix:"libxml-security-c-dev", reference:"1.4.0-3+lenny2")) flag++;
if (deb_check(release:"5.0", prefix:"libxml-security-c14", reference:"1.4.0-3+lenny2")) flag++;
