...
# extracted from Debian Security Advisory DLA-2018-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2018-1 : proftpd-dfsg security update");
  ...
  script_set_attribute(
    ...
    value:
"In mod_tls a crash with empty CRL was fixed.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00039.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19269");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"proftpd-basic", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-dev", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-doc", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-mod-geoip", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-mod-ldap", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-mod-mysql", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-mod-odbc", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-mod-pgsql", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
if (deb_check(release:"8.0", prefix:"proftpd-mod-sqlite", reference:"1.3.5e+r1.3.5-2+deb8u5")) flag++;
