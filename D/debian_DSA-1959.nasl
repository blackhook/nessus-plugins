...
# extracted from Debian Security Advisory DSA-1959. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1959");

  script_name(english:"Debian DSA-1959-1 : ganeti - missing input sanitation");
...
The oldstable distribution (etch) does not include ganeti."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1959"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"5.0", prefix:"ganeti", reference:"1.2.6-3+lenny2")) flag++;
