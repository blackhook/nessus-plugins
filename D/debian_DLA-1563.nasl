...
# extracted from Debian Security Advisory DLA-1563-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1563-1 : tzdata new upstream version");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/11/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"tzdata", reference:"2018g-0+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"tzdata-java", reference:"2018g-0+deb8u1")) flag++;
