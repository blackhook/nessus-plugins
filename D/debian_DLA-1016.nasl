...
# extracted from Debian Security Advisory DLA-1016-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1016-1 : radare2 security update");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that there was a heap-based buffer overflow in
radare2, a reverse-engineering framework. The grub_memmove function
allowed attackers to cause a remote denial of service.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/07/msg00008.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libradare2-0.9", reference:"0.9-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libradare2-0.9-dbg", reference:"0.9-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libradare2-dev", reference:"0.9-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"radare2", reference:"0.9-3+deb7u3")) flag++;
