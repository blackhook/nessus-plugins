...
# extracted from Debian Security Advisory DLA-1216-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1216-1 : wordpress security update");
...
wp-admin/user-new.php in WordPress sets the newbloguser key to a
string that can be directly derived from the user ID, which allows
remote attackers to bypass intended access restrictions by entering
this string.
...
wp-includes/feed.php in WordPress does not properly restrict
enclosures in RSS and Atom fields, which might allow attackers to
conduct XSS attacks via a crafted URL.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/12/msg00019.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"wordpress", reference:"3.6.1+dfsg-1~deb7u20")) flag++;
if (deb_check(release:"7.0", prefix:"wordpress-l10n", reference:"3.6.1+dfsg-1~deb7u20")) flag++;
