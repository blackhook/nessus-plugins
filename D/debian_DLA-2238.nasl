...
# extracted from Debian Security Advisory DLA-2238-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2238-1 : libupnp security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/06/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libupnp-dev", reference:"1.6.19+git20141001-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libupnp6", reference:"1.6.19+git20141001-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libupnp6-dbg", reference:"1.6.19+git20141001-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libupnp6-dev", reference:"1.6.19+git20141001-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"libupnp6-doc", reference:"1.6.19+git20141001-1+deb8u2")) flag++;
