...
# extracted from Debian Security Advisory DSA-3869. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3869");

  script_name(english:"Debian DSA-3869-1 : tnef - security update");
...
application crash."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=862442"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3869"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"tnef", reference:"1.4.9-1+deb8u3")) flag++;
