...
# extracted from Debian Security Advisory DSA-412. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-412-1 : nd - buffer overflows");
...
version of nd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-412"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your nd package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:nd");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"nd", reference:"0.5.0-1woody1")) flag++;
