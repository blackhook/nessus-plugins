...
# extracted from Debian Security Advisory DSA-722. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-722-1 : smail - buffer overflow");
...
execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=301428"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-722"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the smail package.
...
version 3.2.0.114-4woody1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:smail");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"smail", reference:"3.2.0.114-4woody1")) flag++;
