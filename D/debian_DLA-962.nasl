...
# extracted from Debian Security Advisory DLA-962-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-962-1 : tnef security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/05/msg00032.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"tnef", reference:"1.4.9-1+deb7u3")) flag++;
