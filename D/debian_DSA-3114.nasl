...
# extracted from Debian Security Advisory DSA-3114. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3114");

  script_name(english:"Debian DSA-3114-1 : mime-support - security update");
...
arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/mime-support"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-3114"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"mime-support", reference:"3.52-1+deb7u1")) flag++;
