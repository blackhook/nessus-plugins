...
if (description)
{
  ...
  script_name(english:"HCL Domino SEoL (10.0.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of HCL Domino is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, HCL Domino is 10.0.x. It is, therefore, no longer maintained by its vendor or provider.
...
"Upgrade to a version of HCL Domino that is currently supported.");
