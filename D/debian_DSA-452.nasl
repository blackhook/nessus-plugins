...
# extracted from Debian Security Advisory DSA-452. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-452-1 : libapache-mod-python - denial of service");
...
denial of service."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-452"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your libapache-mod-python package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libapache-mod-python");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:debian:debian_linux:3.0");

  script_set_attribute(attribute:"patch_publication_date", value:"2004/02/29");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libapache-mod-python", reference:"2.7.8-0.0woody2")) flag++;
