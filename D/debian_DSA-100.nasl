...
# extracted from Debian Security Advisory DSA-100. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-100-1 : gzip - Potential buffer overflow");
...
stable/unstable/testing with at least version 1.2.4-33."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://online.securityfocus.com/bid/3712"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2002/dsa-100"
  );
  script_set_attribute(attribute:"solution", value:"Upgrade the affected gzip package.");
...
flag = 0;
if (deb_check(release:"2.2", prefix:"gzip", reference:"1.2.4-33.1")) flag++;
