...
color formatting codes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/konversation"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-4033"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"konversation", reference:"1.5-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"konversation-data", reference:"1.5-2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"konversation-dbg", reference:"1.5-2+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"konversation", reference:"1.6.2-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"konversation-data", reference:"1.6.2-2+deb9u1")) flag++;
