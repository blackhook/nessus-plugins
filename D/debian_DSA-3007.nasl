...
# extracted from Debian Security Advisory DSA-3007. The text 
...
if (description)
{
  ...
  script_bugtraq_id(68759, 68858, 69213);
  script_xref(name:"DSA", value:"3007");

  script_name(english:"Debian DSA-3007-1 : cacti - security update");
...
sanitising and SQL injection) have been discovered in Cacti, a web
interface for graphing of monitoring systems."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-3007"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
in version 0.8.8a+dfsg-5+deb7u4."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"cacti", reference:"0.8.8a+dfsg-5+deb7u4")) flag++;
