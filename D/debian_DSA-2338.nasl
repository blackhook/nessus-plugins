...
been fixed in Moodle, a course management system for online learning :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=182737"
  );
  # http://moodle.org/mod/forum/discuss.php?d=188313
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=188313"
  );
  # http://moodle.org/mod/forum/discuss.php?d=188314
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=188314"
  );
  # http://moodle.org/mod/forum/discuss.php?d=188318
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=188318"
  );
  # http://moodle.org/mod/forum/discuss.php?d=188319
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=188319"
  );
  # http://moodle.org/mod/forum/discuss.php?d=188320
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=188320"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2011/dsa-2338"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
