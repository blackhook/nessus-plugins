...
# extracted from Debian Security Advisory DLA-1457-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1457-1 : ant security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00004.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"ant", reference:"1.9.4-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"ant-doc", reference:"1.9.4-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"ant-gcj", reference:"1.9.4-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"ant-optional", reference:"1.9.4-3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"ant-optional-gcj", reference:"1.9.4-3+deb8u2")) flag++;
