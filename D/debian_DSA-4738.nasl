...
# extracted from Debian Security Advisory DSA-4738. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4738");

  script_name(english:"Debian DSA-4738-1 : ark - security update");
...
sanitise extraction paths, which could result in maliciously crafted
archives writing outside the extraction directory."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2020/dsa-4738"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"ark", reference:"4:18.08.3-1+deb10u1")) flag++;
