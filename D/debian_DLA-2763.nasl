...
# extracted from Debian Security Advisory dla-2763. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2763-1 : ruby-kaminari - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-2763
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2763");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-11082");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/ruby-kaminari");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'ruby-kaminari', 'reference': '0.17.0-3+deb9u1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ruby-kaminari');
}
