...
# extracted from Debian Security Advisory DLA-2576-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2576-1 : redis security update");
...
tracker page at: https://security-tracker.debian.org/tracker/redis
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/02/msg00037.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"redis-sentinel", reference:"3:3.2.6-3+deb9u4")) flag++;
if (deb_check(release:"9.0", prefix:"redis-server", reference:"3:3.2.6-3+deb9u4")) flag++;
if (deb_check(release:"9.0", prefix:"redis-tools", reference:"3:3.2.6-3+deb9u4")) flag++;
