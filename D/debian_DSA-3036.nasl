...
# extracted from Debian Security Advisory DSA-3036. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3036");

  script_name(english:"Debian DSA-3036-1 : mediawiki - security update");
...
filter CSS in uploaded SVG files, allowing for cross site scripting."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=762754"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-3036"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"mediawiki", reference:"1:1.19.19+dfsg-0+deb7u1")) flag++;
