...
# extracted from Debian Security Advisory DLA-384-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-384-1 : inspircd security and regression update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/01/msg00008.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"inspircd", reference:"1.1.22+dfsg-4+squeeze3")) flag++;
if (deb_check(release:"6.0", prefix:"inspircd-dbg", reference:"1.1.22+dfsg-4+squeeze3")) flag++;
