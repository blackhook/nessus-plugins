...
# extracted from Debian Security Advisory DLA-688-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-688-1 : cairo security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/10/msg00044.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/cairo"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libcairo2-dbg");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"cairo-perf-utils", reference:"1.12.2-3+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libcairo-gobject2", reference:"1.12.2-3+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libcairo-script-interpreter2", reference:"1.12.2-3+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libcairo2", reference:"1.12.2-3+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libcairo2-dbg", reference:"1.12.2-3+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libcairo2-dev", reference:"1.12.2-3+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libcairo2-doc", reference:"1.12.2-3+deb7u1")) flag++;
