...
# extracted from Debian Security Advisory DLA-1212-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1212-1 : otrs2 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/12/msg00015.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"otrs", reference:"3.3.18-1~deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"otrs2", reference:"3.3.18-1~deb7u2")) flag++;
