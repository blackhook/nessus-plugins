...
# extracted from Debian Security Advisory DLA-827-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-827-1 : gst-plugins-base0.10 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/02/msg00016.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"gir1.2-gst-plugins-base-0.10", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-alsa", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-gnomevfs", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-base", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-base-apps", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-base-dbg", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-base-doc", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-x", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libgstreamer-plugins-base0.10-0", reference:"0.10.36-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libgstreamer-plugins-base0.10-dev", reference:"0.10.36-1.1+deb7u2")) flag++;
