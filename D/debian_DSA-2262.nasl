...
been fixed in Moodle, a course management system for online learning :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=170002"
  );
  # http://moodle.org/mod/forum/discuss.php?d=170003
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=170003"
  );
  # http://moodle.org/mod/forum/discuss.php?d=170009
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=170009"
  );
  # http://moodle.org/mod/forum/discuss.php?d=170012
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=170012"
  );
  # http://moodle.org/mod/forum/discuss.php?d=175592
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=175592"
  );
  # http://moodle.org/mod/forum/discuss.php?d=175590
  script_set_attribute(
    attribute:"see_also",
    value:"https://moodle.org/mod/forum/discuss.php?d=175590"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2011/dsa-2262"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
