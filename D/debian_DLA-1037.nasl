...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/07/msg00030.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/catdoc"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected catdoc package."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"catdoc", reference:"0.94.4-1.1+deb7u1")) flag++;
