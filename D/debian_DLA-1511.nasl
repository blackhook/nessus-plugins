...
# extracted from Debian Security Advisory DLA-1511-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1511-1 : reportbug update");
...
sent to the debian-lts mailing list.

This change requires two new dependencies, python-requests and
python-apt.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/09/msg00022.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/reportbug"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (deb_check(release:"8.0", prefix:"python-reportbug", reference:"6.6.3+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"reportbug", reference:"6.6.3+deb8u2")) flag++;
