...
# extracted from Debian Security Advisory DSA-398. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-398-1 : conquest - buffer overflow");
...
access to the group conquest."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-398"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the conquest package.
...
version 7.1.1-6woody1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:conquest");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"conquest", reference:"7.1.1-6woody1")) flag++;
