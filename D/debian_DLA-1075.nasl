...
# extracted from Debian Security Advisory DLA-1075-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1075-1 : wordpress security update");
  ...
  script_set_attribute(
    ...
    value:
"In WordPress, there is insufficient redirect validation in the HTTP
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/08/msg00026.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"wordpress", reference:"3.6.1+dfsg-1~deb7u16")) flag++;
if (deb_check(release:"7.0", prefix:"wordpress-l10n", reference:"3.6.1+dfsg-1~deb7u16")) flag++;
