...
# extracted from Debian Security Advisory DSA-1253. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1253-1 : mozilla-firefox - several vulnerabilities");
...
and Exposures project identifies the following vulnerabilities :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2007/dsa-1253"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the firefox and iceweasel packages.
...
flag = 0;
if (deb_check(release:"3.1", prefix:"mozilla-firefox", reference:"1.0.4-2sarge15")) flag++;
if (deb_check(release:"3.1", prefix:"mozilla-firefox-dom-inspector", reference:"1.0.4-2sarge15")) flag++;
if (deb_check(release:"3.1", prefix:"mozilla-firefox-gnome-support", reference:"1.0.4-2sarge15")) flag++;
