...
# extracted from Debian Security Advisory DLA-463-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-463-1 : ikiwiki security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/05/msg00014.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ikiwiki", reference:"3.20120629.2+deb7u1")) flag++;
