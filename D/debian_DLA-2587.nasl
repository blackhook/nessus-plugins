...
# extracted from Debian Security Advisory DLA-2587-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2587-1 : privoxy security update");
...
An assertion failure could be triggered with a crafted CGI request
...
An invalid read of size two may occur in chunked_body_is_complete()
leading to denial of service.

CVE-2021-20276

Invalid memory access with an invalid pattern passed to pcre_compile()
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/03/msg00009.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"privoxy", reference:"3.0.26-3+deb9u2")) flag++;
