...
# extracted from Debian Security Advisory DLA-1758-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1758-1 : debian-security-support update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/04/msg00018.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"debian-security-support", reference:"2019.02.02~deb8u1")) flag++;
