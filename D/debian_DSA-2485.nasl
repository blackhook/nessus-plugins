...
# extracted from Debian Security Advisory DSA-2485. The text 
...
if (description)
{
  ...
  script_bugtraq_id(51586);
  script_xref(name:"DSA", value:"2485");

  script_name(english:"Debian DSA-2485-1 : imp4 - XSS");
...
various crafted parameters."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=659392"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2012/dsa-2485"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"6.0", prefix:"imp4", reference:"4.3.7+debian0-2.2")) flag++;
