...
# extracted from Debian Security Advisory DSA-1250. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1250-1 : cacti - missing input sanitising");
...
insufficient validation of data passed to the 'cmd' script, which
allows SQL injection and the execution of arbitrary shell commands."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=404818"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2007/dsa-1250"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"cacti", reference:"0.8.6c-7sarge4")) flag++;
