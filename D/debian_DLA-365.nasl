...
# extracted from Debian Security Advisory DLA-365-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-365-1 : foomatic-filters security update");
...
PostScript data into the printer's native format.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/12/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"foomatic-filters", reference:"4.0.5-6+squeeze2+deb6u11")) flag++;
