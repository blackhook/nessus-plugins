...
# extracted from Debian Security Advisory DSA-719. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-719-1 : prozilla - format string problems");
...
running prozilla."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-719"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"prozilla", reference:"1.3.6-3woody2")) flag++;
