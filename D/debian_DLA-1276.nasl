...
# extracted from Debian Security Advisory DLA-1276-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1276-1 : tomcat-native security update");
...
skip the OCSP check. It was therefore possible for client certificates
that should have been rejected (if the OCSP check had been made) to be
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/02/msg00011.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/tomcat-native"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libtcnative-1", reference:"1.1.24-1+deb7u1")) flag++;
