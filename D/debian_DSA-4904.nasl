...
# extracted from Debian Security Advisory DSA-4904. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4904");

  script_name(english:"Debian DSA-4904-1 : gst-plugins-ugly1.0 - security update");
...
the execution of arbitrary code if a malformed media file is opened."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/buster/gst-plugins-ugly1.0"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4904"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"gstreamer1.0-plugins-ugly", reference:"1.14.4-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"gstreamer1.0-plugins-ugly-dbg", reference:"1.14.4-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"gstreamer1.0-plugins-ugly-doc", reference:"1.14.4-1+deb10u1")) flag++;
