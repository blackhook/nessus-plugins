...
# extracted from Debian Security Advisory DSA-1147. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1147-1 : drupal - missing input sanitising");
...
performs insufficient input sanitising in the user module, which might
lead to cross-site scripting."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1147"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"drupal", reference:"4.5.3-6.1sarge3")) flag++;
