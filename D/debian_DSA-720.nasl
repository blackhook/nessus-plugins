...
# extracted from Debian Security Advisory DSA-720. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-720-1 : smartlist - wrong input processing");
...
lists."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-720"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the smartlist package.
...
version 3.15-5.woody.1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:smartlist");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"smartlist", reference:"3.15-5.woody.1")) flag++;
