...
# extracted from Debian Security Advisory DLA-2643-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2643-1 : gst-plugins-ugly1.0 security update");
...
For the detailed security status of gst-plugins-ugly1.0 please refer
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00030.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/gst-plugins-ugly1.0"
  );
  # https://security-tracker.debian.org/tracker/source-package/gst-plugins-ugly1.0
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?163df78f"
  );
...
flag = 0;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-plugins-ugly", reference:"1.10.4-1+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-plugins-ugly-dbg", reference:"1.10.4-1+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-plugins-ugly-doc", reference:"1.10.4-1+deb9u1")) flag++;
