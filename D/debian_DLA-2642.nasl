...
# extracted from Debian Security Advisory DLA-2642-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2642-1 : gst-plugins-bad1.0 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00029.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"gir1.2-gst-plugins-bad-1.0", reference:"1.10.4-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-plugins-bad", reference:"1.10.4-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-plugins-bad-dbg", reference:"1.10.4-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-plugins-bad-doc", reference:"1.10.4-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libgstreamer-plugins-bad1.0-0", reference:"1.10.4-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libgstreamer-plugins-bad1.0-dev", reference:"1.10.4-1+deb9u2")) flag++;
