...
# extracted from Debian Security Advisory DLA-1089-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1089-1 : irssi security update");
...
CVE-2017-10965
  ...
  An issue was discovered in Irssi before 1.0.4. When receiving
messages with   invalid time stamps, Irssi would try to dereference
a NULL pointer.
...
interface and free   the nick while updating it. This would then
result in use-after-free   conditions on each access of the hash
table.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/09/msg00004.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"irssi", reference:"0.8.15-5+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"irssi-dev", reference:"0.8.15-5+deb7u3")) flag++;
