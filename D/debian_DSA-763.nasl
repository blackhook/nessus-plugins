...
# extracted from Debian Security Advisory DSA-763. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-763-1 : zlib - remote DoS");
...
This problem does not affect the old stable distribution (woody)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-763"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
fixed in version 1.2.2-4.sarge.2."
  );
...
flag = 0;
if (deb_check(release:"3.1", prefix:"lib64z1", reference:"1.2.2-4.sarge.2")) flag++;
if (deb_check(release:"3.1", prefix:"lib64z1-dev", reference:"1.2.2-4.sarge.2")) flag++;
