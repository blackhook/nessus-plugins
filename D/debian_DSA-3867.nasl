...
# extracted from Debian Security Advisory DSA-3867. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3867");

  script_name(english:"Debian DSA-3867-1 : sudo - security update");
...
from field 7 (tty_nr). A sudoers user can take advantage of this flaw
on an SELinux-enabled system to obtain full root privileges."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=863731"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3867"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"sudo", reference:"1.8.10p3-1+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"sudo-ldap", reference:"1.8.10p3-1+deb8u4")) flag++;
