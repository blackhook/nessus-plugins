...
# extracted from Debian Security Advisory DLA-1622-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1622-1 : debian-security-support security update");
...
has been updated in jessie. The jessie relevant changes are :
  ...
  - Mark webkit2gtk as unsupported in all releases. (Closes:
    #914567)

  - Mark jruby in jessie as end-of-life as per DSA-4219-1
    (Closes: #901032)
  ...
  - Mark redmine as end-of-life for Debian 8 (jessie)
    (Closes: #897609)
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/12/msg00022.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"debian-security-support", reference:"2018.11.25~deb8u2")) flag++;
