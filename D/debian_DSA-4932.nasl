...
# extracted from Debian Security Advisory DSA-4932. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4932");

  script_name(english:"Debian DSA-4932-1 : tor - security update");
...
could result in denial of service or spoofing."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=990000"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4932"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"tor", reference:"0.3.5.15-1")) flag++;
if (deb_check(release:"10.0", prefix:"tor-geoipdb", reference:"0.3.5.15-1")) flag++;
