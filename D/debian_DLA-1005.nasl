...
# extracted from Debian Security Advisory DLA-1005-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1005-1 : mercurial security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/06/msg00035.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"mercurial", reference:"2.2.2-4+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"mercurial-common", reference:"2.2.2-4+deb7u4")) flag++;
