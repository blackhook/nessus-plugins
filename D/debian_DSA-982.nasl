...
# extracted from Debian Security Advisory DSA-982. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-982-1 : gpdf - several vulnerabilities");
...
viewer with Gtk bindings."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-982"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"gpdf", reference:"2.8.2-1.2sarge4")) flag++;
