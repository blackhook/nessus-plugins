...
if (description)
{
  ...
  script_name(english:"Debian DLA-3427-1 : texlive-bin - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dla-3427
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3427");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libkpathsea-dev', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libkpathsea6', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libptexenc-dev', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libptexenc1', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsynctex-dev', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libsynctex2', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libtexlua52', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libtexlua52-dev', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libtexlua53', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libtexlua53-dev', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libtexluajit-dev', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'libtexluajit2', 'reference': '2018.20181218.49446-1+deb10u1'},
    {'release': '10.0', 'prefix': 'texlive-binaries', 'reference': '2018.20181218.49446-1+deb10u1'}
];
