...
# extracted from Debian Security Advisory DLA-474-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-474-1 : dosfstools security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/05/msg00026.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/dosfstools"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected dosfstools, and dosfstools-dbg packages."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"dosfstools", reference:"3.0.13-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"dosfstools-dbg", reference:"3.0.13-1+deb7u1")) flag++;
