...
# extracted from Debian Security Advisory DSA-400. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-400-1 : omega-rpg - buffer overflow");
...
unauthorised access to the group games."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-400"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the omega-rpg package.
...
version 0.90-pa9-7woody1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:omega-rpg");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"omega-rpg", reference:"0.90-pa9-7woody1")) flag++;
