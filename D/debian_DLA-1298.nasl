...
# extracted from Debian Security Advisory DLA-1298-1. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9814", "CVE-2016-9955");

  script_name(english:"Debian DLA-1298-1 : simplesamlphp security update");
...
utilities allowed an attacker to get invalid signatures accepted as
valid in the rare case of an error occurring during validation.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/03/msg00001.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"simplesamlphp", reference:"1.9.2-1+deb7u3")) flag++;
