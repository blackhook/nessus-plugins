...
# extracted from Debian Security Advisory DSA-2515. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2515");

  script_name(english:"Debian DSA-2515-1 : nsd3 - NULL pointer dereference");
  ...
  script_set_attribute(
    ...
    value:
"Marek Vavrusa and Lubos Slovak discovered that NSD, an authoritative
...
service attacks."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze/nsd3"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2012/dsa-2515"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the nsd3 packages.
...
flag = 0;
if (deb_check(release:"6.0", prefix:"nsd3", reference:"3.2.5-1.squeeze2")) flag++;
