...
# extracted from Debian Security Advisory DLA-886-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-886-1 : tzdata new upstream version");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/04/msg00005.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"tzdata", reference:"2017b-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"tzdata-java", reference:"2017b-0+deb7u1")) flag++;
