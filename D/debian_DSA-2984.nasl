...
# extracted from Debian Security Advisory DSA-2984. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2984");

  script_name(english:"Debian DSA-2984-1 : acpi-support - security update");
...
script."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2984"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"acpi-fakekey", reference:"0.140-5+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"acpi-support", reference:"0.140-5+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"acpi-support-base", reference:"0.140-5+deb7u1")) flag++;
