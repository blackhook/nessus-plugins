...
# extracted from Debian Security Advisory DSA-879. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-879-1 : gallery - programming error");
...
postnuke users full access to the gallery."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-879"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"gallery", reference:"1.5-1sarge1")) flag++;
