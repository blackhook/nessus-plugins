...
# extracted from Debian Security Advisory DSA-2801. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2801");

  script_name(english:"Debian DSA-2801-1 : libhttp-body-perl - design error");
...
The oldstable distribution (squeeze) is not affected by this problem."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=721634"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/libhttp-body-perl"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2013/dsa-2801"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libhttp-body-perl packages.
...
version 1.11-1+deb7u1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libhttp-body-perl");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libhttp-body-perl", reference:"1.11-1+deb7u1")) flag++;
