...
if (description)
{
  ...
  script_cve_id("CVE-2021-36300");
  script_xref(name:"IAVA", value:"2022-A-0225-S");

  script_name(english:"Dell EMC iDRAC9 < 5.00.00.00 (DSA-2021-177)");

  script_set_attribute(attribute:"synopsis", value:
"Dell EMC iDRAC9 installed on the remote host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Dell EMC iDRAC9 installed on the remote host is prior to 5.00.00.00. It is, therefore, affected by a
vulnerability as referenced in the DSA-2021-177 advisory:

  - iDRAC9 versions prior to 5.00.00.00 contain an improper input validation vulnerability. An unauthenticated
    remote attacker may potentially exploit this vulnerability by sending a specially crafted malicious
    request to crash the webserver or cause information disclosure. (CVE-2021-36300)
...
"Upgrade to Dell EMC iDRAC9 version 5.00.00.00 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-36300");
...
var constraints = [
{ 'fixed_version' : '5.00.00.00', 'idrac' : '9' }
];
