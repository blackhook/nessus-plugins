...
# extracted from Debian Security Advisory DSA-4125. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4125-1 : wavpack - security update");
...
crash or potential code execution."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=889274"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=889276"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=889559"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2018/dsa-4125"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libwavpack-dev", reference:"5.0.0-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"libwavpack1", reference:"5.0.0-2+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"wavpack", reference:"5.0.0-2+deb9u1")) flag++;
