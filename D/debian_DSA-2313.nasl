...
# extracted from Debian Security Advisory DSA-2313. The text 
...
if (description)
{
  ...
  script_bugtraq_id(49809, 49810, 49811, 49848);
  script_xref(name:"DSA", value:"2313");

  script_name(english:"Debian DSA-2313-1 : iceweasel - several vulnerabilities");
...
based on Firefox :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2011/dsa-2313"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 3.5.16-10. This update also marks the compromised DigiNotar
...
flag = 0;
if (deb_check(release:"5.0", prefix:"iceweasel", reference:"1.9.0.19-14")) flag++;
if (deb_check(release:"6.0", prefix:"iceweasel", reference:"3.5.16-10")) flag++;
if (deb_check(release:"6.0", prefix:"iceweasel-dbg", reference:"3.5.16-10")) flag++;
