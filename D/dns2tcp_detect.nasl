...
protocol.");
  script_set_attribute(attribute:"see_also", value:"https://www2.deloitte.com/fr/fr/pages/risque-compliance-et-controle-interne/articles/cyber-academy.html/ressources/outils/dns2tcp/index.html.en");
...
and guidelines.  Limit incoming traffic to this port if desired.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:hsc:dns2tcp");
