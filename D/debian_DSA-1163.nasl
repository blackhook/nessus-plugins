...
# extracted from Debian Security Advisory DSA-1163. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1163-1 : gtetrinet - programming error");
...
a remote server to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1163"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the gtetrinet package.
...
flag = 0;
if (deb_check(release:"3.1", prefix:"gtetrinet", reference:"0.7.8-1sarge2")) flag++;
