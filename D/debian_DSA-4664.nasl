...
# extracted from Debian Security Advisory DSA-4664. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4664");

  script_name(english:"Debian DSA-4664-1 : mailman - security update");
...
scripting attack on the webarchives of the Mailman mailing list
manager, by sending a special type of attachement."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/buster/mailman"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2020/dsa-4664"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"mailman", reference:"1:2.1.29-1+deb10u1")) flag++;
if (deb_check(release:"9.0", prefix:"mailman", reference:"1:2.1.23-1+deb9u5")) flag++;
