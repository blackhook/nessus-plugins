...
# extracted from Debian Security Advisory DLA-1063-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1063-1 : extplorer security update");
  ...
  script_set_attribute(
    ...
    value:
"CVE-2017-12756 Fix command inject in transfer from another server in
extplorer 2.1.9 and prior allows attacker to inject command via the
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/08/msg00015.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"extplorer", reference:"2.1.0b6+dfsg.3-4+deb7u5")) flag++;
