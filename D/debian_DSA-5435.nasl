...
# extracted from Debian Security Advisory dsa-5435. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5435-1 : trafficserver - security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5435");
...
For the stable distribution (bookworm), these problems have been fixed in version 9.2.0+ds-1~deb12u1.");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'trafficserver', 'reference': '8.1.7+ds-1~deb11u1'},
    {'release': '11.0', 'prefix': 'trafficserver-dev', 'reference': '8.1.7+ds-1~deb11u1'},
    {'release': '11.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '8.1.7+ds-1~deb11u1'},
    {'release': '12.0', 'prefix': 'trafficserver', 'reference': '9.2.0+ds-1~deb12u1'},
    {'release': '12.0', 'prefix': 'trafficserver-dev', 'reference': '9.2.0+ds-1~deb12u1'},
    {'release': '12.0', 'prefix': 'trafficserver-experimental-plugins', 'reference': '9.2.0+ds-1~deb12u1'}
];
