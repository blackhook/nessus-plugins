...
flag = 0;
if (deb_check(release:"7.0", prefix:"libmpg123-0", reference:"1.14.4-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libmpg123-dev", reference:"1.14.4-1+deb7u1")) flag++;
