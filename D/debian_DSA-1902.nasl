...
# extracted from Debian Security Advisory DSA-1902. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1902");

  script_name(english:"Debian DSA-1902-1 : elinks - buffer overflow");
...
opening a malformed HTML page."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1902"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"elinks", reference:"0.11.1-1.2etch2")) flag++;
if (deb_check(release:"4.0", prefix:"elinks-lite", reference:"0.11.1-1.2etch2")) flag++;
