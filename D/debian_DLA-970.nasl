...
# extracted from Debian Security Advisory DLA-970-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-970-1 : sudo security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/05/msg00039.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"sudo", reference:"1.8.5p2-1+nmu3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"sudo-ldap", reference:"1.8.5p2-1+nmu3+deb7u3")) flag++;
