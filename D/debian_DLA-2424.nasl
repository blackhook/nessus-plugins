...
# extracted from Debian Security Advisory DLA-2424-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2424-1 : tzdata new upstream version");
  ...
  script_set_attribute(
    ...
    value:
"tzdata, the time zone and daylight-saving time data, has been updated
to the latest version.

  - Revised predictions for Morocco's changes starting in
    2023.

  - Macquarie Island has stayed in sync with Tasmania since
    2011.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/10/msg00037.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"tzdata", reference:"2020d-0+deb9u1")) flag++;
