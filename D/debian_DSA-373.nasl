...
# extracted from Debian Security Advisory DSA-373. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-373-1 : autorespond - buffer overflow");
...
autoresponder used with qmail. This vulnerability could potentially be
exploited by a remote attacker to gain the privileges of a user who
...
may be situations in which these limits do not apply."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-373"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your autorespond package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:autorespond");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"autorespond", reference:"2.0.2-2woody1")) flag++;
