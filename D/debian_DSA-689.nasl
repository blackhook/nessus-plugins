...
# extracted from Debian Security Advisory DSA-689. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-689-1 : libapache-mod-python - missing input sanitizing");
...
extra information that should not be visible (information leak)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-689"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libapache-mod-python package.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libapache-mod-python", reference:"2.7.8-0.0woody5")) flag++;
