...
# extracted from Debian Security Advisory DSA-529. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-529-1 : netkit-telnet-ssl - format string");
...
'telnetd' user by default)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-529"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"telnet-ssl", reference:"0.17.17+0.1-2woody1")) flag++;
if (deb_check(release:"3.0", prefix:"telnetd-ssl", reference:"0.17.17+0.1-2woody1")) flag++;
