...
# extracted from Debian Security Advisory DLA-2430-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2430-1 : blueman security update");
...
For the detailed security status of blueman please refer to its
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00005.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/blueman"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/source-package/blueman"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade the affected blueman package."
  );
...
flag = 0;
if (deb_check(release:"9.0", prefix:"blueman", reference:"2.0.4-1+deb9u1")) flag++;
