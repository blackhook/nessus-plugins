...
# extracted from Debian Security Advisory DLA-972-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-972-1 : openldap security update");
...
A user with access to search the directory could crash slapd by
issuing a search requesting a 'Paged Results' value set to zero.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/06/msg00003.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ldap-utils", reference:"2.4.31-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libldap-2.4-2", reference:"2.4.31-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libldap-2.4-2-dbg", reference:"2.4.31-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libldap2-dev", reference:"2.4.31-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"slapd", reference:"2.4.31-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"slapd-dbg", reference:"2.4.31-2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"slapd-smbk5pwd", reference:"2.4.31-2+deb7u3")) flag++;
