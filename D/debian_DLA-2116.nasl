...
# extracted from Debian Security Advisory DLA-2116-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2116-1 : libpam-radius-auth security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/02/msg00023.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/libpam-radius-auth"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libpam-radius-auth", reference:"1.3.16-4.4+deb8u1")) flag++;
