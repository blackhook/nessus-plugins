...
# extracted from Debian Security Advisory DSA-796. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-796-1 : affix - remote command execution");
...
arbitrary commands on a vulnerable system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-796"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"affix", reference:"2.1.1-3")) flag++;
if (deb_check(release:"3.1", prefix:"libaffix-dev", reference:"2.1.1-3")) flag++;
if (deb_check(release:"3.1", prefix:"libaffix2", reference:"2.1.1-3")) flag++;
