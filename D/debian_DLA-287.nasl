...
# extracted from Debian Security Advisory DLA-287-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-287-1 : ia32-libs security update");
...
security fixes made to these libraries since the previous update of
ia32-libs and ia32-libs-gtk in Squeeze LTS.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/08/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"ia32-libs", reference:"20150804")) flag++;
if (deb_check(release:"6.0", prefix:"ia32-libs-dev", reference:"20150804")) flag++;
if (deb_check(release:"6.0", prefix:"ia32-libs-gtk", reference:"20150804")) flag++;
