...
if (description)
{
  ...
  script_name(english:"Debian DLA-3165-1 : expat - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3165");
