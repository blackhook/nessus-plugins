...
# extracted from Debian Security Advisory DLA-931-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-931-1 : freetype security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/05/msg00001.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"freetype2-demos", reference:"2.4.9-1.1+deb7u7")) flag++;
if (deb_check(release:"7.0", prefix:"libfreetype6", reference:"2.4.9-1.1+deb7u7")) flag++;
if (deb_check(release:"7.0", prefix:"libfreetype6-dev", reference:"2.4.9-1.1+deb7u7")) flag++;
if (deb_check(release:"7.0", prefix:"libfreetype6-udeb", reference:"2.4.9-1.1+deb7u7")) flag++;
