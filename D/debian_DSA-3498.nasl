...
# extracted from Debian Security Advisory DSA-3498. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3498");

  script_name(english:"Debian DSA-3498-1 : drupal7 - security update");
  ...
  script_set_attribute(
    ...
    value:
"Multiple security vulnerabilities have been found in the Drupal
content management framework. For additional information, please refer
to the upstream advisory at"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2016/dsa-3498"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"drupal7", reference:"7.14-2+deb7u12")) flag++;
if (deb_check(release:"8.0", prefix:"drupal7", reference:"7.32-1+deb8u6")) flag++;
