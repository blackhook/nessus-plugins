...
# extracted from Debian Security Advisory dla-2798. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2798-1 : libdatetime-timezone-perl - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-2798
...
version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2798");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libdatetime-timezone-perl', 'reference': '1:2.09-1+2021e'}
];
