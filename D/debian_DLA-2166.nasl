...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/04/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/libpam-krb5"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected libpam-heimdal, and libpam-krb5 packages."
  );
