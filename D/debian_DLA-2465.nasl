...
# extracted from Debian Security Advisory DLA-2465-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2465-1 : php-pear security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00043.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"php-pear", reference:"1:1.10.1+submodules+notgz-9+deb9u2")) flag++;
