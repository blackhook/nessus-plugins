...
# extracted from Debian Security Advisory DLA-674-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-674-2 : ghostscript regression update");
...
certain Postscript document viewers (evince, zathura). Updated
packages are now available to address this problem. For reference, the
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/10/msg00043.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ghostscript", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-cups", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-dbg", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-doc", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"ghostscript-x", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libgs-dev", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libgs9", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libgs9-common", reference:"9.05~dfsg-6.3+deb7u4")) flag++;
