...
# extracted from Debian Security Advisory DSA-1338. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1338-1 : iceweasel - several vulnerabilities");
...
upgrade to stable as soon as possible."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2007/dsa-1338"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 2.0.0.5-0etch1. Builds for alpha and mips are not yet
...
flag = 0;
if (deb_check(release:"4.0", prefix:"firefox", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"firefox-dom-inspector", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"firefox-gnome-support", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"iceweasel", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"iceweasel-dbg", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"iceweasel-dom-inspector", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"iceweasel-gnome-support", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"mozilla-firefox", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"mozilla-firefox-dom-inspector", reference:"2.0.0.5-0etch1")) flag++;
if (deb_check(release:"4.0", prefix:"mozilla-firefox-gnome-support", reference:"2.0.0.5-0etch1")) flag++;
