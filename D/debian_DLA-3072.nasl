...
if (description)
{
  ...
  script_name(english:"Debian DLA-3072-1 : postgresql-11 - LTS security update");
...
advisory.
  ...
  - Extension scripts replace objects not belonging to the extensionmore details (CVE-2022-2625)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3072");
