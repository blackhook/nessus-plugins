...
if (description)
{
  script_id(164935);
  script_version("1.2");
  script_set_attribute(attribute:"plugin_modification_date", value:"2022/09/10");

  script_cve_id("CVE-2019-5815", "CVE-2021-30560");

  script_name(english:"Debian DLA-3101-1 : libxslt - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3101");
