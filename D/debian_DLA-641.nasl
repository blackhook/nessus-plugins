...
# extracted from Debian Security Advisory DLA-641-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-641-1 : ruby-activesupport-3.2 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/09/msg00034.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ruby-activesupport-3.2", reference:"3.2_3.2.6-6+deb7u3")) flag++;
