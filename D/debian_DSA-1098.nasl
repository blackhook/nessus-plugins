...
# extracted from Debian Security Advisory DSA-1098. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1098-1 : horde3 - missing input sanitising");
...
performs insufficient input sanitising, which might lead to the
injection of web script code through cross-site scripting."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1098"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"horde3", reference:"3.0.4-4sarge4")) flag++;
