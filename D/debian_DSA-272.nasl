...
# extracted from Debian Security Advisory DSA-272. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-272-1 : dietlibc - integer overflow");
...
arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-272"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the dietlibc packages.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"dietlibc-dev", reference:"0.12-2.5")) flag++;
if (deb_check(release:"3.0", prefix:"dietlibc-doc", reference:"0.12-2.5")) flag++;
