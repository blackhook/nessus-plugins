...
# extracted from Debian Security Advisory DSA-829. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-829-1 : mysql - buffer overflow");
...
which distribution has this problem fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-829"
  );
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libmysqlclient10", reference:"3.23.49-8.14")) flag++;
if (deb_check(release:"3.0", prefix:"libmysqlclient10-dev", reference:"3.23.49-8.14")) flag++;
if (deb_check(release:"3.0", prefix:"mysql-client", reference:"3.23.49-8.14")) flag++;
if (deb_check(release:"3.0", prefix:"mysql-common", reference:"3.23.49-8.14")) flag++;
if (deb_check(release:"3.0", prefix:"mysql-doc", reference:"3.23.49-8.5")) flag++;
if (deb_check(release:"3.0", prefix:"mysql-server", reference:"3.23.49-8.14")) flag++;
