...
# extracted from Debian Security Advisory DSA-978. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-978-1 : gnupg - programming error");
...
though they don't contain a signature at all."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-978"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
Please note that this security advisory has been superseded by DSA
993. Therefore, the updated packages are no longer available from this
page."
  );
...
flag = 0;
if (deb_check(release:"3.0", prefix:"gnupg", reference:"1.0.6-4woody4")) flag++;
if (deb_check(release:"3.1", prefix:"gnupg", reference:"1.4.1-1sarge1")) flag++;
