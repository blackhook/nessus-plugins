...
# extracted from Debian Security Advisory DLA-1264-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1264-1 : unbound security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/01/msg00039.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://nlnetlabs.nl/downloads/unbound/CVE-2017-15105.txt"
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libunbound-dev", reference:"1.4.17-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libunbound2", reference:"1.4.17-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"python-unbound", reference:"1.4.17-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"unbound", reference:"1.4.17-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"unbound-anchor", reference:"1.4.17-3+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"unbound-host", reference:"1.4.17-3+deb7u3")) flag++;
