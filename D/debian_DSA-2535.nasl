...
# extracted from Debian Security Advisory DSA-2535. The text 
...
if (description)
{
  ...
  script_bugtraq_id(54689);
  script_xref(name:"DSA", value:"2535");

  script_name(english:"Debian DSA-2535-1 : rtfm - XSS");
...
administration page."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2012/dsa-2535"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"6.0", prefix:"rt3.8-rtfm", reference:"2.4.2-4+squeeze1")) flag++;
