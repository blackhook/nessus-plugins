...
# extracted from Debian Security Advisory DSA-1114. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1114-1 : hashcash - buffer overflow");
...
crafted entries."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=376444"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1114"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the hashcash package.
...
version 1.17-1sarge1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:hashcash");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"hashcash", reference:"1.17-1sarge1")) flag++;
