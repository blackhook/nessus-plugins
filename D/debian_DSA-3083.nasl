...
# extracted from Debian Security Advisory DSA-3083. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3083");

  script_name(english:"Debian DSA-3083-1 : mutt - security update");
...
service condition."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-3083"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"mutt", reference:"1.5.21-6.2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"mutt-dbg", reference:"1.5.21-6.2+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"mutt-patched", reference:"1.5.21-6.2+deb7u3")) flag++;
