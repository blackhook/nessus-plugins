...
# extracted from Debian Security Advisory DSA-356. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-356-1 : xtokkaetama - buffer overflows");
...
exploited by a local attacker to gain gid 'games'."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-356"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"For the current stable distribution (woody) this problem has been
fixed in version 1.0b-6woody1.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"xtokkaetama", reference:"1.0b-6woody1")) flag++;
