...
server, is running on the remote host.");
 # https://www.dell.com/support/article/us/en/4/SLN310974
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ecbc47e");
 # http://en.community.dell.com/techcenter/systems-management/w/wiki/1760.openmanage-server-administrator-omsa
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ecbc47e");
 # https://www.dell.com/support/contents/us/en/04/article/Product-Support/Self-support-Knowledgebase/enterprise-resource-center/SystemsManagement/OMSA
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3cb76714");
...
install = add_install(appname:'dell_omsa', port:port, dir:'', ver:version, cpe: "cpe:/a:dell:openmanage");
