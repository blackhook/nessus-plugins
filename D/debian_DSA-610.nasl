...
# extracted from Debian Security Advisory DSA-610. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-610-1 : cscope - insecure temporary file");
...
overwrite files via a symlink attack."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=282815"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-610"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"cscope", reference:"15.3-1woody2")) flag++;
