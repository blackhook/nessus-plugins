...
# extracted from Debian Security Advisory DLA-820-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-820-1 : viewvc security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/02/msg00008.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/viewvc"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected viewvc, and viewvc-query packages."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"viewvc", reference:"1.1.5-1.4+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"viewvc-query", reference:"1.1.5-1.4+deb7u1")) flag++;
