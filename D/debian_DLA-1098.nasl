...
# extracted from Debian Security Advisory DLA-1098-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1098-1 : freexl security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/09/msg00015.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libfreexl-dev", reference:"1.0.0b-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libfreexl1", reference:"1.0.0b-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libfreexl1-dbg", reference:"1.0.0b-1+deb7u4")) flag++;
