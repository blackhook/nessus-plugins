...
# extracted from Debian Security Advisory DSA-910. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-910-1 : zope.2.7 - design error");
...
files via include directives in reStructuredText functionality."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=334055"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-910"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"zope2.7", reference:"2.7.5-2sarge1")) flag++;
