...
# extracted from Debian Security Advisory DSA-849. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-849-1 : shorewall - programming error");
...
pass through the firewall, again without further checks."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=318946"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-849"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the shorewall package.
...
version 2.2.3-2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:shorewall");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"shorewall", reference:"2.2.3-2")) flag++;
