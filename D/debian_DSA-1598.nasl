...
# extracted from Debian Security Advisory DSA-1598. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1598");

  script_name(english:"Debian DSA-1598-1 : libtk-img - buffer overflow");
...
service and potentially the execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1598"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libtk-img package.
...
flag = 0;
if (deb_check(release:"4.0", prefix:"libtk-img", reference:"1:1.3-15etch2")) flag++;
