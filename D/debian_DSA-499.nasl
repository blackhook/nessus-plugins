...
# extracted from Debian Security Advisory DSA-499. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-499-2 : rsync - directory traversal");
...
exploitable when the daemon is configured with the 'chroot' option."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-499"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"rsync", reference:"2.5.5-0.5")) flag++;
