...
# extracted from Debian Security Advisory dla-2759. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2759-1 : gnutls28 - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2759
advisory. Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported
version number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=961889");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/gnutls28");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2759");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/gnutls28");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'gnutls-bin', 'reference': '3.5.8-5+deb9u6'},
    {'release': '9.0', 'prefix': 'gnutls-doc', 'reference': '3.5.8-5+deb9u6'},
    {'release': '9.0', 'prefix': 'libgnutls-dane0', 'reference': '3.5.8-5+deb9u6'},
    {'release': '9.0', 'prefix': 'libgnutls-openssl27', 'reference': '3.5.8-5+deb9u6'},
    {'release': '9.0', 'prefix': 'libgnutls28-dev', 'reference': '3.5.8-5+deb9u6'},
    {'release': '9.0', 'prefix': 'libgnutls30', 'reference': '3.5.8-5+deb9u6'},
    {'release': '9.0', 'prefix': 'libgnutlsxx28', 'reference': '3.5.8-5+deb9u6'}
];
