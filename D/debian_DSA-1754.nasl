...
# extracted from Debian Security Advisory DSA-1754. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1754-1 : roundup - insufficient access checks");
...
command line instead."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=518768"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1754"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"roundup", reference:"1.2.1-10+etch1")) flag++;
if (deb_check(release:"5.0", prefix:"roundup", reference:"1.4.4-4+lenny1")) flag++;
