...
# extracted from Debian Security Advisory DLA-328-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-328-1 : tzdata new upstream version");
...
time zones compared to the current version in squeeze-lts :
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/10/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"tzdata", reference:"2015g-0+deb6u1")) flag++;
if (deb_check(release:"6.0", prefix:"tzdata-java", reference:"2015g-0+deb6u1")) flag++;
