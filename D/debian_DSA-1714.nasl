...
# extracted from Debian Security Advisory DSA-1714. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1714");

  script_name(english:"Debian DSA-1714-1 : rt2570 - integer overflow");
...
can be found in /usr/share/doc/rt2570-source/README.Debian"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1714"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the rt2570 package.
...
1.1.0+cvs20080623-2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:rt2570");
...
flag = 0;
if (deb_check(release:"4.0", prefix:"rt2570-source", reference:"1.1.0+cvs20060620-3+etch1")) flag++;
