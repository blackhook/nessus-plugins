...
# extracted from Debian Security Advisory dla-2989. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3839", "CVE-2019-25059");
  script_xref(name:"IAVB", value:"2019-B-0042-S");

  script_name(english:"Debian DLA-2989-1 : ghostscript - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2989");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-25059");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2019-3839");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'ghostscript', 'reference': '9.26a~dfsg-0+deb9u9'},
    {'release': '9.0', 'prefix': 'ghostscript-dbg', 'reference': '9.26a~dfsg-0+deb9u9'},
    {'release': '9.0', 'prefix': 'ghostscript-doc', 'reference': '9.26a~dfsg-0+deb9u9'},
    {'release': '9.0', 'prefix': 'ghostscript-x', 'reference': '9.26a~dfsg-0+deb9u9'},
    {'release': '9.0', 'prefix': 'libgs-dev', 'reference': '9.26a~dfsg-0+deb9u9'},
    {'release': '9.0', 'prefix': 'libgs9', 'reference': '9.26a~dfsg-0+deb9u9'},
    {'release': '9.0', 'prefix': 'libgs9-common', 'reference': '9.26a~dfsg-0+deb9u9'}
];
