...
# extracted from Debian Security Advisory DSA-110. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-110-1 : cups - buffer overflow");
...
reads the names of attributes. This affects all versions of CUPS."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2002/dsa-110"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the CUPS packages immediately if you have them installed.
...
flag = 0;
if (deb_check(release:"2.2", prefix:"cupsys", reference:"1.0.4-10")) flag++;
if (deb_check(release:"2.2", prefix:"cupsys-bsd", reference:"1.0.4-10")) flag++;
if (deb_check(release:"2.2", prefix:"libcupsys1", reference:"1.0.4-10")) flag++;
if (deb_check(release:"2.2", prefix:"libcupsys1-dev", reference:"1.0.4-10")) flag++;
