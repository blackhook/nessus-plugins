...
# extracted from Debian Security Advisory DLA-780-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-780-1 : libav security update");
...
The put_no_rnd_pixels8_xy2_mmx function in x86/rnd_template.c in libav
11.7 and earlier allows remote attackers to cause a denial of service
(NULL pointer dereference and crash) via a crafted MP3 file. 
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/01/msg00012.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ffmpeg", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"ffmpeg-dbg", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"ffmpeg-doc", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libav-dbg", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libav-doc", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libav-extra-dbg", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libav-tools", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavcodec-dev", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavcodec-extra-53", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavcodec53", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavdevice-dev", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavdevice-extra-53", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavdevice53", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavfilter-dev", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavfilter-extra-2", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavfilter2", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavformat-dev", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavformat-extra-53", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavformat53", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavutil-dev", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavutil-extra-51", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libavutil51", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libpostproc-dev", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libpostproc-extra-52", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libpostproc52", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libswscale-dev", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libswscale-extra-2", reference:"6:0.8.19-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libswscale2", reference:"6:0.8.19-0+deb7u1")) flag++;
