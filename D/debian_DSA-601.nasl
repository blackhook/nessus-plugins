...
# extracted from Debian Security Advisory DSA-601. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-601-1 : libgd - integer overflow");
...
the execution of arbitrary code on the victim's machine."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-601"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 1.8.4-17.woody4."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libgd1");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libgd-dev", reference:"1.8.4-17.woody4")) flag++;
if (deb_check(release:"3.0", prefix:"libgd-noxpm-dev", reference:"1.8.4-17.woody4")) flag++;
if (deb_check(release:"3.0", prefix:"libgd1", reference:"1.8.4-17.woody4")) flag++;
if (deb_check(release:"3.0", prefix:"libgd1-noxpm", reference:"1.8.4-17.woody4")) flag++;
