...
# extracted from Debian Security Advisory DSA-1602. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1602-1 : pcre3 - buffer overflow");
...
branches, potentially leading to arbitrary code execution."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1602"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the pcre3 packages.
...
flag = 0;
if (deb_check(release:"4.0", prefix:"libpcre3", reference:"6.7+7.4-4")) flag++;
if (deb_check(release:"4.0", prefix:"libpcre3-dev", reference:"6.7+7.4-4")) flag++;
if (deb_check(release:"4.0", prefix:"libpcrecpp0", reference:"6.7+7.4-4")) flag++;
if (deb_check(release:"4.0", prefix:"pcregrep", reference:"6.7+7.4-4")) flag++;
