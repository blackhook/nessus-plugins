...
# extracted from Debian Security Advisory DSA-4577. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4577");

  script_name(english:"Debian DSA-4577-1 : haproxy - security update");
...
HTTP/1. This would allow a remote user to perform CRLF injections."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2019/dsa-4577"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"haproxy", reference:"1.8.19-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"haproxy-doc", reference:"1.8.19-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"vim-haproxy", reference:"1.8.19-1+deb10u1")) flag++;
