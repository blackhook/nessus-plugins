...
# extracted from Debian Security Advisory DLA-2359-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2359-1 : xorg-server security update");
...
different request handlers. One CVE is about a leak of uninitialize
heap memory to clients.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00057.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"xdmx", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xdmx-tools", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xnest", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xorg-server-source", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-common", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xephyr", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-core", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-core-udeb", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-dev", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xserver-xorg-legacy", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xvfb", reference:"2:1.19.2-1+deb9u6")) flag++;
if (deb_check(release:"9.0", prefix:"xwayland", reference:"2:1.19.2-1+deb9u6")) flag++;
