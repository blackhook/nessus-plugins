...
# extracted from Debian Security Advisory DLA-201-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-201-1 : tzdata new upstream version");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/04/msg00014.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"tzdata", reference:"2015c-0+deb6u1")) flag++;
if (deb_check(release:"6.0", prefix:"tzdata-java", reference:"2015c-0+deb6u1")) flag++;
