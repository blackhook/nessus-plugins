...
# extracted from Debian Security Advisory DLA-1208-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1208-1 : reportbug update");
...
This change requires a new dependency, python-requests, which will be
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/12/msg00011.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"python-reportbug", reference:"6.4.4+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"reportbug", reference:"6.4.4+deb7u2")) flag++;
