...
# extracted from Debian Security Advisory DSA-1477. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1477-1 : yarssr - missing input sanitising");
...
fix for the old stable distribution (sarge) needs to be postponed by a
few days."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1477"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 0.2.2-1etch1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:yarssr");
...
flag = 0;
if (deb_check(release:"4.0", prefix:"yarssr", reference:"0.2.2-1etch1")) flag++;
