...
# extracted from Debian Security Advisory DSA-2712. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2712");

  script_name(english:"Debian DSA-2712-1 : otrs2 - privilege escalation");
...
The oldstable distribution (squeeze) is not affected by this problem."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2013/dsa-2712"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"otrs", reference:"3.1.7+dfsg1-8+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"otrs2", reference:"3.1.7+dfsg1-8+deb7u2")) flag++;
