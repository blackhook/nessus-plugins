...
# extracted from Debian Security Advisory DSA-738. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-738-1 : razor - remote denial of service");
...
email headers that could potentially be used to crash the Razor
program, causing a denial of service."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-738"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the razor package.
...
The old stable distribution (woody) is not affected by this issue."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:razor");
