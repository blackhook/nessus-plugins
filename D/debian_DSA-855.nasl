...
# extracted from Debian Security Advisory DSA-855. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-855-1 : weex - format string vulnerability");
...
on the clients machine."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=332424"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-855"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the weex package.
...
version 2.6.1-6sarge1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:weex");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"weex", reference:"2.6.1-4woody2")) flag++;
if (deb_check(release:"3.1", prefix:"weex", reference:"2.6.1-6sarge1")) flag++;
