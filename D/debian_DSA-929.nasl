...
# extracted from Debian Security Advisory DSA-929. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-929-1 : petris - buffer overflow");
...
to execute arbitrary code with group games privileges."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-929"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the petris package.

The old stable distribution (woody) does not contain the petris
package.
...
version 1.0.1-4sarge0."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:petris");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"petris", reference:"1.0.1-4sarge0")) flag++;
