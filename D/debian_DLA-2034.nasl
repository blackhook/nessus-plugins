...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/12/msg00016.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/davical"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected davical, and davical-doc packages."
  );
