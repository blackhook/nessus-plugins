...
# extracted from Debian Security Advisory DSA-4853. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4853");

  script_name(english:"Debian DSA-4853-1 : spip - security update");
...
sensitive information, or execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4853"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"spip", reference:"3.2.4-1+deb10u4")) flag++;
