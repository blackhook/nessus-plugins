...
if (description)
{
  ...
  script_name(english:"Debian DLA-3319-1 : firefox-esr - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3319");
