...
if (description)
{
  ...
  script_name(english:"IBM DB2 Connect 9.7 < 9.7.1100.352 / 10.5 < 10.5.1100.2866 / 11.1 < 11.1.4050.859 / 11.5 < 11.5.5000.1587 DoS (Windows)");
...
"Apply the appropriate IBM DB2 Fix Pack or Special Build based on the most recent fix pack level for your branch.");
  ...
  script_require_keys("SMB/Registry/Enumerated", "installed_sw/DB2 Connect Server");
...
app_info = vcf::get_app_info(app:'DB2 Connect Server', win_local:TRUE);
