...
# extracted from Debian Security Advisory DLA-1038-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1038-1 : libtasn1-3 security update");
  ...
  script_set_attribute(
    ...
    value:
"CVE-2017-10790 The _asn1_check_identifier function in GNU Libtasn1
through 4.12 causes a NULL pointer dereference and crash when reading
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/07/msg00029.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libtasn1-3", reference:"2.13-2+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"libtasn1-3-bin", reference:"2.13-2+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"libtasn1-3-dbg", reference:"2.13-2+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"libtasn1-3-dev", reference:"2.13-2+deb7u5")) flag++;
