...
# extracted from Debian Security Advisory DSA-3692. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3692");

  script_name(english:"Debian DSA-3692-1 : freeimage - security update");
...
arbitrary code if a malformed XMP or RAW image is processed."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2016/dsa-3692"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libfreeimage-dev", reference:"3.15.4-4.2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libfreeimage3", reference:"3.15.4-4.2+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libfreeimage3-dbg", reference:"3.15.4-4.2+deb8u1")) flag++;
