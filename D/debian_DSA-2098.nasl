...
details can be found in the Typo3 security advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=590719"
  );
  # http://typo3.org/teams/security/security-bulletins/typo3-sa-2010-012/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a600eefc"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2010/dsa-2098"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 4.2.5-1+lenny4."
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2010/08/29");
