...
# extracted from Debian Security Advisory DSA-825. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-825-1 : loop-aes-utils - privilege escalation");
...
bypass filesystem access restrictions by re-mounting it read-only."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-825"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"loop-aes-utils", reference:"2.12p-4sarge1")) flag++;
