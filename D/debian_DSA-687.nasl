...
# extracted from Debian Security Advisory DSA-687. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-687-1 : bidwatcher - format string");
...
vulnerable anymore."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-687"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the bidwatcher package.
...
version 1.3.3-1woody1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:bidwatcher");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"bidwatcher", reference:"1.3.3-1woody1")) flag++;
