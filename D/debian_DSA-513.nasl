...
# extracted from Debian Security Advisory DSA-513. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-513-1 : log2mail - format string");
...
member of group 'adm' (which has access to read system logfiles).
 ...
 printlog()"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-513"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"log2mail", reference:"0.2.5.2")) flag++;
