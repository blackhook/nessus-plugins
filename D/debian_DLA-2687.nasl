...
# extracted from Debian Security Advisory DLA-2687-2. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2021-32921");

  script_name(english:"Debian DLA-2687-2 : prosody regression update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/06/msg00018.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/prosody"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"prosody", reference:"0.9.12-2+deb9u4")) flag++;
