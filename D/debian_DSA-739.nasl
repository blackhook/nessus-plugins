...
# extracted from Debian Security Advisory DSA-739. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2005-2007", "CVE-2005-2147");
  script_bugtraq_id(13990);
  script_xref(name:"DSA", value:"739");

  script_name(english:"Debian DSA-739-1 : trac - missing input sanitising");
...
therefore can lead to remote code execution in some configurations."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-739"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"trac", reference:"0.8.1-3sarge2")) flag++;
