...
# extracted from Debian Security Advisory DSA-2144. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2144");

  script_name(english:"Debian DSA-2144-1 : wireshark - buffer overflow");
...
lead to the execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2011/dsa-2144"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"5.0", prefix:"wireshark", reference:"1.0.2-3+lenny12")) flag++;
