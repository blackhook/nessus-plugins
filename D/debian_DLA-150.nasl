...
# extracted from Debian Security Advisory DLA-150-1. The text
...
if (description)
{
  ...
  script_bugtraq_id(71790, 71825);

  script_name(english:"Debian DLA-150-1 : unzip security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/02/msg00003.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"unzip", reference:"6.0-4+deb6u2")) flag++;
