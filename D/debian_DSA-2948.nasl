...
# extracted from Debian Security Advisory DSA-2948. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2948");

  script_name(english:"Debian DSA-2948-1 : python-bottle - security update");
...
bypass of security mechanisms."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2948"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"python-bottle", reference:"0.10.11-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"python-bottle-doc", reference:"0.10.11-1+deb7u1")) flag++;
