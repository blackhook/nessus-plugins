...
# extracted from Debian Security Advisory DSA-664. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-664-1 : cpio - broken file permissions");
...
those files."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-664"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"cpio", reference:"2.4.2-39woody1")) flag++;
