...
# extracted from Debian Security Advisory DLA-548-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-548-1 : drupal7 security update");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that there was an open redirect vulnerability in
drupal7, a content management framework.
...
the page in the browser window. The module did not sufficiently
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/07/msg00009.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"drupal7", reference:"7.14-2+deb7u13")) flag++;
