...
# extracted from Debian Security Advisory DLA-1272-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1272-1 : mailman security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/02/msg00007.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"mailman", reference:"1:2.1.15-1+deb7u3")) flag++;
