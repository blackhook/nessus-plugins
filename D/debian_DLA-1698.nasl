...
# extracted from Debian Security Advisory DLA-1698-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1698-2 : file regression update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/11/msg00037.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"file", reference:"1:5.22+15-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"file-dbg", reference:"1:5.22+15-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libmagic-dev", reference:"1:5.22+15-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"libmagic1", reference:"1:5.22+15-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"python-magic", reference:"1:5.22+15-2+deb8u7")) flag++;
if (deb_check(release:"8.0", prefix:"python3-magic", reference:"1:5.22+15-2+deb8u7")) flag++;
