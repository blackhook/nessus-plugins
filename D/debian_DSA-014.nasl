...
# extracted from Debian Security Advisory DSA-014. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-014-2 : splitvt - buffer overflow and format string attack");
...
gain access to the root user id."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2001/dsa-014"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the splitvt package immediately."
  );
...
flag = 0;
if (deb_check(release:"2.2", prefix:"splitvt", reference:"1.6.5-0potato1")) flag++;
