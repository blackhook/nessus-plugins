...
# extracted from Debian Security Advisory DSA-693. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-693-1 : luxman - buffer overflow");
...
as root."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-693"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the luxman package.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"luxman", reference:"0.41-17.2")) flag++;
