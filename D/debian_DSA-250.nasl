...
# extracted from Debian Security Advisory DSA-250. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-250-1 : w3mmee-ssl - missing HTML quoting");
...
information is not leaked automatically, though."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-250"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the w3mmee-ssl packages.
...
problems."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:w3mmee-ssl");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:debian:debian_linux:3.0");

  script_set_attribute(attribute:"patch_publication_date", value:"2003/02/12");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"w3mmee-ssl", reference:"0.3.p23.3-1.5")) flag++;
