...
# extracted from Debian Security Advisory DSA-1868. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1868");

  script_name(english:"Debian DSA-1868-1 : kde4libs - several vulnerabilities");
  ...
  script_set_attribute(
    ...
    value:
"Several security issues have been discovered in kde4libs, core
...
The oldstable distribution (etch) does not contain kde4libs."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=534949"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1868"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"5.0", prefix:"kdelibs-bin", reference:"4:4.1.0-3+lenny1")) flag++;
if (deb_check(release:"5.0", prefix:"kdelibs5", reference:"4:4.1.0-3+lenny1")) flag++;
if (deb_check(release:"5.0", prefix:"kdelibs5-data", reference:"4:4.1.0-3+lenny1")) flag++;
if (deb_check(release:"5.0", prefix:"kdelibs5-dbg", reference:"4:4.1.0-3+lenny1")) flag++;
if (deb_check(release:"5.0", prefix:"kdelibs5-dev", reference:"4:4.1.0-3+lenny1")) flag++;
