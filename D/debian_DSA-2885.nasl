...
# extracted from Debian Security Advisory DSA-2885. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2885");

  script_name(english:"Debian DSA-2885-1 : libyaml-libyaml-perl - security update");
...
libyaml-libyaml-perl package."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2885"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"6.0", prefix:"libyaml-libyaml-perl", reference:"0.33-1+squeeze3")) flag++;
if (deb_check(release:"7.0", prefix:"libyaml-libyaml-perl", reference:"0.38-3+deb7u2")) flag++;
