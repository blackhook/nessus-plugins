...
# extracted from Debian Security Advisory DLA-1302-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1302-1 : leptonlib security update");
...
$(command) approach in the gplot rootname argument. This issue existed
because of an incomplete fix for CVE-2018-3836.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/03/msg00005.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"leptonica-progs", reference:"1.69-3.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"liblept3", reference:"1.69-3.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libleptonica-dev", reference:"1.69-3.1+deb7u2")) flag++;
