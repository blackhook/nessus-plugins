...
# extracted from Debian Security Advisory DLA-811-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-811-1 : libplist security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/01/msg00048.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libplist++-dev", reference:"1.8-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libplist++1", reference:"1.8-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libplist-dbg", reference:"1.8-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libplist-dev", reference:"1.8-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libplist-doc", reference:"1.8-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libplist-utils", reference:"1.8-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libplist1", reference:"1.8-1+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"python-plist", reference:"1.8-1+deb7u1")) flag++;
