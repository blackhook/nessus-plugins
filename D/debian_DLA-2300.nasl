...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/07/msg00030.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/kdepim-runtime"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade the affected kdepim-runtime package."
  );
