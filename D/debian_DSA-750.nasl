...
# extracted from Debian Security Advisory DSA-750. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-750-1 : dhcpcd - out-of-bound memory access");
...
of the supplied DHCP buffer which could lead to the daemon crashing."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-750"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
