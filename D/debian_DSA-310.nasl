...
# extracted from Debian Security Advisory DSA-310. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-310-1 : xaos - improper setuid-root execution");
...
architecture only."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-310"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your xaos package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:xaos");
...
flag = 0;
if (deb_check(release:"2.2", prefix:"xaos", reference:"3.0-18potato1")) flag++;
if (deb_check(release:"3.0", prefix:"xaos", reference:"3.0-23woody1")) flag++;
