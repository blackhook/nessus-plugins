...
# extracted from Debian Security Advisory DLA-981-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-981-1 : apng2gif security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/06/msg00009.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/apng2gif"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected apng2gif package."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"apng2gif", reference:"1.5-1+deb7u1")) flag++;
