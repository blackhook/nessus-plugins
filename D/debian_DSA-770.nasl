...
# extracted from Debian Security Advisory DSA-770. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-770-1 : gopher - insecure tmpfile creating");
...
fashion."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-770"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 3.0.7sarge1."
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2005/07/29");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"gopher", reference:"3.0.3woody3")) flag++;
if (deb_check(release:"3.0", prefix:"gopherd", reference:"3.0.3woody3")) flag++;
