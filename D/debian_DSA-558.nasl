...
# extracted from Debian Security Advisory DSA-558. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-558-1 : libapache-mod-dav - NULL pointer dereference");
...
process and hence create a denial of service for the whole server."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-558"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the mod_dav packages.
...
version 1.0.3-3.1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libapache-mod-dav");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libapache-mod-dav", reference:"1.0.3-3.1")) flag++;
