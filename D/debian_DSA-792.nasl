...
# extracted from Debian Security Advisory DSA-792. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-792-1 : pstotext - missing input sanitising");
...
argument, which prevents potential malicious operations to happen."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=319758"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-792"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"pstotext", reference:"1.8g-5woody1")) flag++;
if (deb_check(release:"3.1", prefix:"pstotext", reference:"1.9-1sarge1")) flag++;
