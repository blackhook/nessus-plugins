...
# extracted from Debian Security Advisory DSA-1052. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1052-1 : cgiirc - buffer overflows");
...
IRC client, which could be exploited to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=365680"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1052"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the cgiirc package.
...
flag = 0;
if (deb_check(release:"3.1", prefix:"cgiirc", reference:"0.5.4-6sarge1")) flag++;
