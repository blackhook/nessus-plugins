...
# extracted from Debian Security Advisory DLA-1271-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1271-1 : postgresql-9.1 security update");
...
Tom Lane discovered that pg_upgrade, a tool used to upgrade PostgreSQL
database clusters, creates temporary files containing password hashes
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/02/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libecpg-compat3", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libecpg-dev", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libecpg6", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libpgtypes3", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libpq-dev", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libpq5", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-9.1-dbg", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-client-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-contrib-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-doc-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-plperl-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-plpython-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-plpython3-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-pltcl-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"postgresql-server-dev-9.1", reference:"9.1.24lts2-0+deb7u2")) flag++;
