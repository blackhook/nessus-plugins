...
# extracted from Debian Security Advisory DLA-979-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-979-1 : debian-security-support update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/06/msg00010.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"debian-security-support", reference:"2017.06.02+deb7u1")) flag++;
