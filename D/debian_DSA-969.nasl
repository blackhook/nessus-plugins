...
# extracted from Debian Security Advisory DSA-969. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-969-1 : scponly - design error");
...
have shell access to the machine."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=344418"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-969"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
The old stable distribution (woody) does not contain an scponly
package.
...
flag = 0;
if (deb_check(release:"3.1", prefix:"scponly", reference:"4.0-1sarge1")) flag++;
