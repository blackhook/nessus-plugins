...
if (description)
{
  script_id(168385);
  script_version("1.2");
  script_set_attribute(attribute:"plugin_modification_date", value:"2022/12/03");

  script_cve_id("CVE-2022-41946");

  script_name(english:"Debian DLA-3218-1 : libpgjava - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3218");
