...
# extracted from Debian Security Advisory DSA-592. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-592-1 : ez-ipupdate - format string");
...
types."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-592"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the ez-ipupdate package.
...
version 3.0.11b5-1woody2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:ez-ipupdate");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"ez-ipupdate", reference:"3.0.11b5-1woody2")) flag++;
