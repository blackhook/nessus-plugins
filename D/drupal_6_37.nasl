...
if (description)
{
  ...
  script_cve_id("CVE-2015-6658", "CVE-2015-6660", "CVE-2015-6661");
...
only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.drupal.org/project/drupal/releases/6.37");
