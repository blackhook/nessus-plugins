...
# extracted from Debian Security Advisory DSA-3527. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3527");

  script_name(english:"Debian DSA-3527-1 : inspircd - security update");
...
causing a denial-of-service,"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2016/dsa-3527"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"inspircd", reference:"2.0.5-1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"inspircd-dbg", reference:"2.0.5-1+deb7u2")) flag++;
if (deb_check(release:"8.0", prefix:"inspircd", reference:"2.0.17-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"inspircd-dbg", reference:"2.0.17-1+deb8u1")) flag++;
