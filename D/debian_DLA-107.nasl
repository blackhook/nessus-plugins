...
# extracted from Debian Security Advisory DLA-107-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-107-1 : unbound security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2014/12/msg00010.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze-lts/unbound"
  );
...
flag = 0;
if (deb_check(release:"6.0", prefix:"libunbound-dev", reference:"1.4.6-1+squeeze4")) flag++;
if (deb_check(release:"6.0", prefix:"libunbound2", reference:"1.4.6-1+squeeze4")) flag++;
if (deb_check(release:"6.0", prefix:"unbound", reference:"1.4.6-1+squeeze4")) flag++;
if (deb_check(release:"6.0", prefix:"unbound-host", reference:"1.4.6-1+squeeze4")) flag++;
