...
# extracted from Debian Security Advisory DLA-245-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-245-1 : p7zip security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/06/msg00010.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze-lts/p7zip"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (deb_check(release:"6.0", prefix:"p7zip", reference:"9.04~dfsg.1-1+deb6u1")) flag++;
if (deb_check(release:"6.0", prefix:"p7zip-full", reference:"9.04~dfsg.1-1+deb6u1")) flag++;
