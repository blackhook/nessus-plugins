...
# extracted from Debian Security Advisory DSA-993. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-993-2 : gnupg - programming error");
...
version turned out to be vulnerable as well."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-993"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"gnupg", reference:"1.0.6-4woody5")) flag++;
if (deb_check(release:"3.1", prefix:"gnupg", reference:"1.4.1-1.sarge3")) flag++;
