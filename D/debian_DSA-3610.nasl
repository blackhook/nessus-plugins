...
# extracted from Debian Security Advisory DSA-3610. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3610");

  script_name(english:"Debian DSA-3610-1 : xerces-c - security update");
...
environment variable (XERCES_DISABLE_DTD)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=828990"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2016/dsa-3610"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libxerces-c-dev", reference:"3.1.1-5.1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"libxerces-c-doc", reference:"3.1.1-5.1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"libxerces-c-samples", reference:"3.1.1-5.1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"libxerces-c3.1", reference:"3.1.1-5.1+deb8u3")) flag++;
