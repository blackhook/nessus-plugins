...
# extracted from Debian Security Advisory DLA-640-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-640-1 : icedove security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/09/msg00033.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"calendar-google-provider", reference:"1:45.3.0-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"icedove", reference:"1:45.3.0-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"icedove-dbg", reference:"1:45.3.0-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"icedove-dev", reference:"1:45.3.0-1~deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"iceowl-extension", reference:"1:45.3.0-1~deb7u1")) flag++;
