...
# extracted from Debian Security Advisory DSA-1278. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2006-4250", "CVE-2006-5616");
  script_xref(name:"DSA", value:"1278");

  script_name(english:"Debian DSA-1278-1 : man-db - buffer overflow");
...
setuid."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2007/dsa-1278"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"man-db", reference:"2.4.2-21sarge1")) flag++;
