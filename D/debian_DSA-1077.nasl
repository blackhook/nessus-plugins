...
# extracted from Debian Security Advisory DSA-1077. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1077-1 : lynx-ssl - programming error");
...
same code is present in lynx-ssl."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1077"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"lynx-ssl", reference:"2.8.4.1b-3.3")) flag++;
