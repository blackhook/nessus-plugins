...
# extracted from Debian Security Advisory DSA-643. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-643-1 : queue - buffer overflows");
...
buffer overflows in queue, a transparent load balancing system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-643"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the queue package.
...
version 1.30.1-4woody2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:queue");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"queue", reference:"1.30.1-4woody2")) flag++;
