...
# extracted from Debian Security Advisory DSA-2933. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2933");

  script_name(english:"Debian DSA-2933-1 : qemu-kvm - security update");
...
virtualization solution on x86 hardware.
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2933"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"kvm", reference:"1.1.2+dfsg-6+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"qemu-kvm", reference:"1.1.2+dfsg-6+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"qemu-kvm-dbg", reference:"1.1.2+dfsg-6+deb7u3")) flag++;
