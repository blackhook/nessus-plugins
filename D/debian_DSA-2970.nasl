...
# extracted from Debian Security Advisory DSA-2970. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2970");

  script_name(english:"Debian DSA-2970-1 : cacti - security update");
...
Cacti, a web frontend for RRDTool."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2970"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
in version 0.8.8a+dfsg-5+deb7u3."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"cacti", reference:"0.8.8a+dfsg-5+deb7u3")) flag++;
