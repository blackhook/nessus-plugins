...
# extracted from Debian Security Advisory DLA-887-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-887-1 : libdatetime-timezone-perl new upstream version");
  ...
  script_set_attribute(
    ...
    value:
"This update includes the changes in tzdata 2017b for the Perl
bindings. For the list of changes, see DLA-886-1.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/04/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libdatetime-timezone-perl", reference:"1:1.58-1+2017b")) flag++;
