...
# extracted from Debian Security Advisory DSA-4583. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4583");

  script_name(english:"Debian DSA-4583-1 : spip - security update");
...
The oldstable distribution (stretch) is not affected."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2019/dsa-4583"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 3.2.4-1+deb10u2."
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-19830");
...
flag = 0;
if (deb_check(release:"10.0", prefix:"spip", reference:"3.2.4-1+deb10u2")) flag++;
