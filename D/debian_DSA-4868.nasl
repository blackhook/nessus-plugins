...
# extracted from Debian Security Advisory DSA-4868. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4868");

  script_name(english:"Debian DSA-4868-1 : flatpak - security update");
...
via a malicious .desktop file."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4868"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"flatpak", reference:"1.2.5-0+deb10u4")) flag++;
if (deb_check(release:"10.0", prefix:"flatpak-tests", reference:"1.2.5-0+deb10u4")) flag++;
if (deb_check(release:"10.0", prefix:"gir1.2-flatpak-1.0", reference:"1.2.5-0+deb10u4")) flag++;
if (deb_check(release:"10.0", prefix:"libflatpak-dev", reference:"1.2.5-0+deb10u4")) flag++;
if (deb_check(release:"10.0", prefix:"libflatpak-doc", reference:"1.2.5-0+deb10u4")) flag++;
if (deb_check(release:"10.0", prefix:"libflatpak0", reference:"1.2.5-0+deb10u4")) flag++;
