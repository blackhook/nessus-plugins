...
# extracted from Debian Security Advisory DSA-909. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-909-1 : horde3 - missing input sanitising");
...
executed on the victims machine."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=340323"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-909"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"horde3", reference:"3.0.4-4sarge2")) flag++;
