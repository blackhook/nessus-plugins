...
# extracted from Debian Security Advisory DSA-2836. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2836");

  script_name(english:"Debian DSA-2836-1 : devscripts - arbitrary code execution");
...
would attempt to download a source tarball could execute arbitrary
code with the privileges of the user running uscan.
...
been assigned to identify them."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2013-6888"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/devscripts"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2836"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"devscripts", reference:"2.12.6+deb7u2")) flag++;
