...
# extracted from Debian Security Advisory DLA-188-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-188-1 : arj security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/04/msg00002.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze-lts/arj"
  );
  script_set_attribute(attribute:"solution", value:"Upgrade the affected arj package.");
...
flag = 0;
if (deb_check(release:"6.0", prefix:"arj", reference:"3.10.22-9+deb6u1")) flag++;
