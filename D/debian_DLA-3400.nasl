...
if (description)
{
  ...
  script_name(english:"Debian DLA-3400-1 : thunderbird - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3400");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'calendar-google-provider', 'reference': '1:102.10.0-1~deb10u1'},
