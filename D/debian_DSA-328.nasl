...
# extracted from Debian Security Advisory DSA-328. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-328-1 : webfs - buffer overflow");
...
arbitrary code to be executed."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-328"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"webfs", reference:"1.17.1")) flag++;
