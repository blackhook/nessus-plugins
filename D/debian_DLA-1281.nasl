...
# extracted from Debian Security Advisory DLA-1281-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1281-1 : advancecomp security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/02/msg00016.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/advancecomp"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (deb_check(release:"7.0", prefix:"advancecomp", reference:"1.15-1+deb7u1")) flag++;
