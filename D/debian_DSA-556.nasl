...
default, the 'telnetd' user)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-556"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the netkit-telnet package.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"telnet", reference:"0.17-18woody2")) flag++;
if (deb_check(release:"3.0", prefix:"telnetd", reference:"0.17-18woody2")) flag++;
