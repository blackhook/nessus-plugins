...
# extracted from Debian Security Advisory DSA-623. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-623-1 : nasm - buffer overflow");
...
file."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=285889"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-623"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the nasm package.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"nasm", reference:"0.98.28cvs-1woody2")) flag++;
