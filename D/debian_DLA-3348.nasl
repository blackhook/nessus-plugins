...
if (description)
{
  ...
  script_name(english:"Debian DLA-3348-1 : syslog-ng - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3348");
