...
# extracted from Debian Security Advisory DLA-260-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-260-1 : hostapd security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/06/msg00027.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze-lts/hostapd"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected hostapd package."
  );
...
flag = 0;
if (deb_check(release:"6.0", prefix:"hostapd", reference:"1:0.6.10-2+squeeze2")) flag++;
