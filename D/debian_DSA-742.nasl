...
# extracted from Debian Security Advisory DSA-742. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-742-1 : cvs - buffer overflow");
...
Versions System, which could lead to the execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=305254"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-742"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"cvs", reference:"1.11.1p1debian-12")) flag++;
if (deb_check(release:"3.1", prefix:"cvs", reference:"1.12.9-13")) flag++;
