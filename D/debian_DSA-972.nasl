...
# extracted from Debian Security Advisory DSA-972. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-972-1 : pdfkit.framework - buffer overflows");
...
application or possibly execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-972"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"pdfkit.framework", reference:"0.8-2sarge2")) flag++;
