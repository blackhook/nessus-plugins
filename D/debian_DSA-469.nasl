...
# extracted from Debian Security Advisory DSA-469. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-469-1 : pam-pgsql - missing input sanitising");
...
could exploit this bug to insert SQL statements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=230875"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-469"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libpam-pgsql package.
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libpam-pgsql", reference:"0.5.2-3woody2")) flag++;
