...
# extracted from Debian Security Advisory DLA-2644-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2644-1 : gst-libav1.0 security update");
...
For the detailed security status of gst-libav1.0 please refer to its
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00031.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/gst-libav1.0"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:gstreamer1.0-libav");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:gstreamer1.0-libav-dbg");
...
flag = 0;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-libav", reference:"1.10.4-1+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"gstreamer1.0-libav-dbg", reference:"1.10.4-1+deb9u1")) flag++;
