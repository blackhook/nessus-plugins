...
# extracted from Debian Security Advisory DLA-1186-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1186-1 : xorg-server security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/11/msg00032.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"xdmx", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xdmx-tools", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xnest", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xserver-common", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xserver-xephyr", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xserver-xfbdev", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xserver-xorg-core", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xserver-xorg-core-dbg", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xserver-xorg-core-udeb", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xserver-xorg-dev", reference:"2:1.12.4-6+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"xvfb", reference:"2:1.12.4-6+deb7u8")) flag++;
