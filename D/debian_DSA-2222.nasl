...
# extracted from Debian Security Advisory DSA-2222. The text 
...
if (description)
{
  ...
  script_bugtraq_id(47276);
  script_xref(name:"DSA", value:"2222");

  script_name(english:"Debian DSA-2222-1 : tinyproxy - incorrect ACL processing");
...
proxy, could lead to unintended network access rights.

The oldstable distribution (lenny) is not affected."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=621493"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2011/dsa-2222"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"6.0", prefix:"tinyproxy", reference:"1.8.2-1squeeze1")) flag++;
