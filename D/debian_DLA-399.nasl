...
# extracted from Debian Security Advisory DLA-399-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-399-1 : foomatic-filters security update");
...
checks when copying from environment variables to local buffers
(strcpy) as well on string concatenation operations (strcat).
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/01/msg00023.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"foomatic-filters", reference:"4.0.5-6+squeeze2+deb6u13")) flag++;
