...
# extracted from Debian Security Advisory DLA-944-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-944-1 : openvpn security update");
...
first cause the server to send it 2^32 packets (at least 196GB). For
Debian 7 'Wheezy', these problems have been fixed in version
2.2.1-8+deb7u4.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/05/msg00015.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"openvpn", reference:"2.2.1-8+deb7u4")) flag++;
