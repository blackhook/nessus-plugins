...
# extracted from Debian Security Advisory DSA-754. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-754-1 : centericq - insecure temporary file");
...
local attackers."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-754"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
