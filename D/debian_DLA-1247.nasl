...
# extracted from Debian Security Advisory DLA-1247-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1247-1 : rsync security update");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that there was an injection vulnerability in the
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/01/msg00021.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"rsync", reference:"3.0.9-4+deb7u2")) flag++;
