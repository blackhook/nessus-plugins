...
# extracted from Debian Security Advisory DLA-1094-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1094-1 : tiff3 security update");
...
A PlanarConfig=Contig image can cause an out-of-bounds write (related
to the ZIPDecode function). A crafted input may lead to a remote
denial of service attack or an arbitrary code execution attack.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/09/msg00011.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libtiff4", reference:"3.9.6-11+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"libtiff4-dev", reference:"3.9.6-11+deb7u8")) flag++;
if (deb_check(release:"7.0", prefix:"libtiffxx0c2", reference:"3.9.6-11+deb7u8")) flag++;
