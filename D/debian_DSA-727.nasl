...
# extracted from Debian Security Advisory DSA-727. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-727-1 : libconvert-uulib-perl - buffer overflow");
...
result in the execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-727"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the libconvert-uulib-perl package.
...
version 0.201-2woody1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libconvert-uulib-perl");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libconvert-uulib-perl", reference:"0.201-2woody1")) flag++;
