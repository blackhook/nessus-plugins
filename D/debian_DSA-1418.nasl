...
# extracted from Debian Security Advisory DSA-1418. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1418-1 : cacti - missing input sanitising");
...
performs insufficient input sanitising, which allows SQL injection."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=452085"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2007/dsa-1418"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"cacti", reference:"0.8.6c-7sarge5")) flag++;
if (deb_check(release:"4.0", prefix:"cacti", reference:"0.8.6i-3.2")) flag++;
