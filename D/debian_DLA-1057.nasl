...
# extracted from Debian Security Advisory DLA-1057-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1057-1 : libraw security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/08/msg00009.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libraw-bin", reference:"0.14.6-2+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libraw-dev", reference:"0.14.6-2+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libraw-doc", reference:"0.14.6-2+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libraw5", reference:"0.14.6-2+deb7u2")) flag++;
