...
# extracted from Debian Security Advisory DLA-513-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-513-1 : nspr security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/06/msg00014.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libnspr4", reference:"2:4.9.2-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libnspr4-0d", reference:"2:4.9.2-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libnspr4-dbg", reference:"2:4.9.2-1+deb7u4")) flag++;
if (deb_check(release:"7.0", prefix:"libnspr4-dev", reference:"2:4.9.2-1+deb7u4")) flag++;
