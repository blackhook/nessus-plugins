...
# extracted from Debian Security Advisory DSA-1569. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1569-2 : cacti - insufficient input sanitising");
...
site scripting and SQL injection being possible."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1569"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"cacti", reference:"0.8.6i-3.4")) flag++;
