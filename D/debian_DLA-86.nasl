...
# extracted from Debian Security Advisory DLA-86-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-86-1 : file security update");
...
For the long-term stable distribution (squeeze-lts), this problem has
been fixed in version 5.04-5+squeeze8.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2014/11/msg00005.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"file", reference:"5.04-5+squeeze8")) flag++;
if (deb_check(release:"6.0", prefix:"libmagic-dev", reference:"5.04-5+squeeze8")) flag++;
if (deb_check(release:"6.0", prefix:"libmagic1", reference:"5.04-5+squeeze8")) flag++;
if (deb_check(release:"6.0", prefix:"python-magic", reference:"5.04-5+squeeze8")) flag++;
if (deb_check(release:"6.0", prefix:"python-magic-dbg", reference:"5.04-5+squeeze8")) flag++;
