...
# extracted from Debian Security Advisory DSA-3134. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3134");

  script_name(english:"Debian DSA-3134-1 : sympa - security update");
...
sympa user."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/sympa"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3134"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"sympa", reference:"6.1.11~dfsg-5+deb7u2")) flag++;
