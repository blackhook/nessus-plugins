...
# extracted from Debian Security Advisory DSA-3876. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3876");

  script_name(english:"Debian DSA-3876-1 : otrs2 - security update");
...
escalate their privileges."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3876"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"otrs", reference:"3.3.9-3+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"otrs2", reference:"3.3.9-3+deb8u1")) flag++;
