...
# extracted from Debian Security Advisory DLA-413-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-413-1 : gajim security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/02/msg00004.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze-lts/gajim"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (deb_check(release:"6.0", prefix:"gajim", reference:"0.13.4-3+squeeze4")) flag++;
