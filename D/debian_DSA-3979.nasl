...
# extracted from Debian Security Advisory DSA-3979. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3979");

  script_name(english:"Debian DSA-3979-1 : pyjwt - security update");
...
which could allow a remote attacker to craft JWTs from scratch."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/pyjwt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3979"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"python-jwt", reference:"0.2.1-1+deb8u2")) flag++;
if (deb_check(release:"8.0", prefix:"python3-jwt", reference:"0.2.1-1+deb8u2")) flag++;
if (deb_check(release:"9.0", prefix:"python-jwt", reference:"1.4.2-1+deb9u1")) flag++;
if (deb_check(release:"9.0", prefix:"python3-jwt", reference:"1.4.2-1+deb9u1")) flag++;
