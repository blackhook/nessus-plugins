...
# extracted from Debian Security Advisory DSA-4870. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4870");

  script_name(english:"Debian DSA-4870-1 : pygments - security update");
...
of service."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2021/dsa-4870"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"10.0", prefix:"python-pygments", reference:"2.3.1+dfsg-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"python-pygments-doc", reference:"2.3.1+dfsg-1+deb10u1")) flag++;
if (deb_check(release:"10.0", prefix:"python3-pygments", reference:"2.3.1+dfsg-1+deb10u1")) flag++;
