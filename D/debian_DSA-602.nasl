...
# extracted from Debian Security Advisory DSA-602. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-602-1 : libgd2 - integer overflow");
...
the execution of arbitrary code on the victim's machine."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-602"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libgd-tools", reference:"2.0.1-10woody2")) flag++;
if (deb_check(release:"3.0", prefix:"libgd2", reference:"2.0.1-10woody2")) flag++;
if (deb_check(release:"3.0", prefix:"libgd2-dev", reference:"2.0.1-10woody2")) flag++;
if (deb_check(release:"3.0", prefix:"libgd2-noxpm", reference:"2.0.1-10woody2")) flag++;
