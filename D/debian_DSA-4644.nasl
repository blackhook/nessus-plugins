...
# extracted from Debian Security Advisory DSA-4644. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4644");

  script_name(english:"Debian DSA-4644-1 : tor - security update");
...
was found in Tor, a connection-based low-latency anonymous
communication system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2020/dsa-4644"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
discontinued. Please upgrade to the stable release (buster) to
...
flag = 0;
if (deb_check(release:"10.0", prefix:"tor", reference:"0.3.5.10-1")) flag++;
if (deb_check(release:"10.0", prefix:"tor-geoipdb", reference:"0.3.5.10-1")) flag++;
