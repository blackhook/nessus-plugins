...
if (description)
{
  ...
  script_cve_id("CVE-2016-7570", "CVE-2016-7571", "CVE-2016-7572");
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://www.drupal.org/forum/newsletters/security-advisories-for-drupal-core/2016-09-21/drupal-core-critical-multiple");
...
"Upgrade to Drupal version 8.1.10 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7571");
