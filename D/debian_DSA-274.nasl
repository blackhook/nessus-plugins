...
# extracted from Debian Security Advisory DSA-274. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-274-1 : mutt - buffer overflow");
...
possibly execute arbitrary code via a specially crafted mail folder."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-274"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"2.2", prefix:"mutt", reference:"1.2.5-5.2")) flag++;
if (deb_check(release:"3.0", prefix:"mutt", reference:"1.3.28-2.2")) flag++;
if (deb_check(release:"3.0", prefix:"mutt-utf8", reference:"1.3.28-2.2")) flag++;
