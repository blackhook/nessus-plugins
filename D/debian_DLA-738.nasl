...
# extracted from Debian Security Advisory DLA-738-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-738-1 : spip security update");
...
vulnerability in spip, a website publishing engine, which allowed
remote attackers to inject arbitrary web script or HTML via the 'rac'
parameter.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/12/msg00011.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"spip", reference:"2.1.17-1+deb7u7")) flag++;
