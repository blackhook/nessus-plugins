...
# extracted from Debian Security Advisory DSA-4021. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4021");

  script_name(english:"Debian DSA-4021-1 : otrs2 - security update");
...
write permissions for statistics."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-4021"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"otrs", reference:"3.3.18-1+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"otrs2", reference:"3.3.18-1+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"otrs", reference:"5.0.16-1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"otrs2", reference:"5.0.16-1+deb9u2")) flag++;
