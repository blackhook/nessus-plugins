...
# extracted from Debian Security Advisory DLA-135-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-135-1 : ia32-libs security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2015/01/msg00008.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"6.0", prefix:"ia32-libs", reference:"20150116")) flag++;
if (deb_check(release:"6.0", prefix:"ia32-libs-dev", reference:"20150116")) flag++;
if (deb_check(release:"6.0", prefix:"ia32-libs-gtk", reference:"20150116")) flag++;
