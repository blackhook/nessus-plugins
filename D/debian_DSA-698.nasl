...
# extracted from Debian Security Advisory DSA-698. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-698-1 : mc - buffer overflow");
...
also fixes a regression from DSA 497."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-698"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"gmc", reference:"4.5.55-1.2woody6")) flag++;
if (deb_check(release:"3.0", prefix:"mc", reference:"4.5.55-1.2woody6")) flag++;
if (deb_check(release:"3.0", prefix:"mc-common", reference:"4.5.55-1.2woody6")) flag++;
