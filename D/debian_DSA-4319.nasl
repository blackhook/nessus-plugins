...
# extracted from Debian Security Advisory DSA-4319. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4319");

  script_name(english:"Debian DSA-4319-1 : spice - security update");
...
demarshalling code in the SPICE protocol client and server library.
The generated demarshalling code is prone to multiple buffer
overflows. An authenticated attacker can take advantage of this flaw
to cause a denial of service (spice server crash), or possibly,
execute arbitrary code."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=906315"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2018/dsa-4319"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libspice-server-dev", reference:"0.12.8-2.1+deb9u2")) flag++;
if (deb_check(release:"9.0", prefix:"libspice-server1", reference:"0.12.8-2.1+deb9u2")) flag++;
