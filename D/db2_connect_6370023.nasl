...
if (description)
{
  ...
  script_name(english:"IBM DB2 Connect 9.7 < FP11 40481 / 10.1 < FP6 40480 / 10.5 < FP11 40479 / 11.1 < FP5 40478 / 11.5 < 11.5.5000.1587 Command Injection");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a command injection vulnerability.");
  script_set_attribute(attribute:"description", value:
"A command injection vulnerability exists in IBM DB2 Connect due to a DLL search order hijacking vulnerability in Microsoft
