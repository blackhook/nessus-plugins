...
# extracted from Debian Security Advisory DSA-4010. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"4010");

  script_name(english:"Debian DSA-4010-1 : git-annex - security update");
...
an arbitrary shell command."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=873088"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/git-annex"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-4010"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the git-annex packages.
...
flag = 0;
if (deb_check(release:"8.0", prefix:"git-annex", reference:"5.20141125+deb8u1")) flag++;
if (deb_check(release:"9.0", prefix:"git-annex", reference:"6.20170101-1+deb9u1")) flag++;
