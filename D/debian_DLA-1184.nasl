...
# extracted from Debian Security Advisory DLA-1184-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1184-1 : optipng security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/11/msg00030.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"optipng", reference:"0.6.4-1+deb7u3")) flag++;
