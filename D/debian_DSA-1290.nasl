...
# extracted from Debian Security Advisory DSA-1290. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1290-1 : squirrelmail - missing input sanitising");
...
email messages."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2007/dsa-1290"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"squirrelmail", reference:"2:1.4.4-11")) flag++;
if (deb_check(release:"4.0", prefix:"squirrelmail", reference:"2:1.4.9a-2")) flag++;
