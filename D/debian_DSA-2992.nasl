...
# extracted from Debian Security Advisory DSA-2992. The text 
...
if (description)
{
  ...
  script_bugtraq_id(68224, 68683);
  script_xref(name:"DSA", value:"2992");

  script_name(english:"Debian DSA-2992-1 : linux - security update");
...
may lead to a denial of service or privilege escalation :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=728705"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2014-3534"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2014-4667"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2014-4943"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-2992"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"linux", reference:"3.2.60-1+deb7u3")) flag++;
