...
# extracted from Debian Security Advisory dla-2914. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2914-1 : zabbix - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2914
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-2914");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-23134");
...
For Debian 9 stretch, this problem has been fixed in version 1");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-23134");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'zabbix-agent', 'reference': '1:3.0.32+dfsg-0+deb9u2'},
    {'release': '9.0', 'prefix': 'zabbix-frontend-php', 'reference': '1:3.0.32+dfsg-0+deb9u2'},
    {'release': '9.0', 'prefix': 'zabbix-java-gateway', 'reference': '1:3.0.32+dfsg-0+deb9u2'},
    {'release': '9.0', 'prefix': 'zabbix-proxy-mysql', 'reference': '1:3.0.32+dfsg-0+deb9u2'},
    {'release': '9.0', 'prefix': 'zabbix-proxy-pgsql', 'reference': '1:3.0.32+dfsg-0+deb9u2'},
    {'release': '9.0', 'prefix': 'zabbix-proxy-sqlite3', 'reference': '1:3.0.32+dfsg-0+deb9u2'},
    {'release': '9.0', 'prefix': 'zabbix-server-mysql', 'reference': '1:3.0.32+dfsg-0+deb9u2'},
    {'release': '9.0', 'prefix': 'zabbix-server-pgsql', 'reference': '1:3.0.32+dfsg-0+deb9u2'}
];
