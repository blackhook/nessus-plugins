...
# extracted from Debian Security Advisory DLA-948-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-948-1 : dropbear security update");
  ...
  script_set_attribute(
    ...
    value:
"A vulnerability was found in Dropbear, a lightweight SSH2 server and
client.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/05/msg00019.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"dropbear", reference:"2012.55-1.3+deb7u2")) flag++;
