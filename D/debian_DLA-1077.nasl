...
# extracted from Debian Security Advisory DLA-1077-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1077-1 : faad2 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/08/msg00029.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/faad2"
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"faad", reference:"2.7-8+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"faad2-dbg", reference:"2.7-8+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libfaad-dev", reference:"2.7-8+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libfaad2", reference:"2.7-8+deb7u1")) flag++;
