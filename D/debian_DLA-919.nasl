...
# extracted from Debian Security Advisory DLA-919-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-919-1 : weechat security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/04/msg00038.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"weechat", reference:"0.3.8-1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"weechat-core", reference:"0.3.8-1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"weechat-curses", reference:"0.3.8-1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"weechat-dbg", reference:"0.3.8-1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"weechat-dev", reference:"0.3.8-1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"weechat-doc", reference:"0.3.8-1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"weechat-plugins", reference:"0.3.8-1+deb7u2")) flag++;
