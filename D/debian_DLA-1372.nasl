...
# extracted from Debian Security Advisory DLA-1372-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1372-1 : libdatetime-timezone-perl new upstream release");
  ...
  script_set_attribute(
    ...
    value:
"This update includes the changes in tzdata 2018e for the Perl
bindings. For the list of changes, see DLA-1371-1.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/05/msg00003.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libdatetime-timezone-perl", reference:"1:1.58-1+2018e")) flag++;
