...
# extracted from Debian Security Advisory dla-2829. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2829-1 : libvpx - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2829
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2829");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-0034");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/stretch/libvpx");
...
For Debian 9 stretch, this problem has been fixed in version 1.6.1-3+deb9u3.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libvpx4");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libvpx-dev', 'reference': '1.6.1-3+deb9u3'},
    {'release': '9.0', 'prefix': 'libvpx-doc', 'reference': '1.6.1-3+deb9u3'},
    {'release': '9.0', 'prefix': 'libvpx4', 'reference': '1.6.1-3+deb9u3'},
    {'release': '9.0', 'prefix': 'vpx-tools', 'reference': '1.6.1-3+deb9u3'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libvpx-dev / libvpx-doc / libvpx4 / vpx-tools');
}
