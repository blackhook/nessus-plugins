...
# extracted from Debian Security Advisory DLA-808-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-808-1 : ruby-archive-tar-minitar security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/01/msg00045.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/ruby-archive-tar-minitar"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected ruby-archive-tar-minitar package."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"ruby-archive-tar-minitar", reference:"0.5.2-2+deb7u1")) flag++;
