...
# extracted from Debian Security Advisory DSA-1553. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1553");

  script_name(english:"Debian DSA-1553-1 : ikiwiki - cross-site request forgery");
...
(CSRF) attacks."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=475445"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1553"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"ikiwiki", reference:"1.33.5")) flag++;
