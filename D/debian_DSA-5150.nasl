...
# extracted from Debian Security Advisory dsa-5150. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5150-1 : rsyslog - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 / 11 host has packages installed that are affected by a vulnerability as referenced in the dsa-5150
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2022/dsa-5150");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2022-24903");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/rsyslog");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/bullseye/rsyslog");
...
For the stable distribution (bullseye), this problem has been fixed in version 8.2102.0-2+deb11u1.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:rsyslog-openssl");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'rsyslog', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-czmq', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-elasticsearch', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-gnutls', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-gssapi', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-hiredis', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-kafka', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-mongodb', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-mysql', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-openssl', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-pgsql', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '10.0', 'prefix': 'rsyslog-relp', 'reference': '8.1901.0-1+deb10u2'},
    {'release': '11.0', 'prefix': 'rsyslog', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-czmq', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-elasticsearch', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-gnutls', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-gssapi', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-hiredis', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-kafka', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-mongodb', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-mysql', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-openssl', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-pgsql', 'reference': '8.2102.0-2+deb11u1'},
    {'release': '11.0', 'prefix': 'rsyslog-relp', 'reference': '8.2102.0-2+deb11u1'}
];
