...
if (description)
{
  ...
  script_name(english:"Debian DLA-3320-1 : webkit2gtk - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3320");
...
var pkgs = [
    ...
    {'release': '10.0', 'prefix': 'libwebkit2gtk-4.0-37-gtk2', 'reference': '2.38.5-1~deb10u1'},
