...
# extracted from Debian Security Advisory dsa-4955. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-4955-1 : libspf2 - security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 10 host has packages installed that are affected by a vulnerability as referenced in the dsa-4955
advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2021/dsa-4955");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2021-20314");
  script_set_attribute(attribute:"see_also", value:"https://packages.debian.org/source/buster/libspf2");
...
var pkgs = [
    {'release': '10.0', 'prefix': 'libmail-spf-xs-perl', 'reference': '1.2.10-7.1~deb10u1'},
    {'release': '10.0', 'prefix': 'libspf2-2', 'reference': '1.2.10-7.1~deb10u1'},
    {'release': '10.0', 'prefix': 'libspf2-2-dbg', 'reference': '1.2.10-7.1~deb10u1'},
    {'release': '10.0', 'prefix': 'libspf2-dev', 'reference': '1.2.10-7.1~deb10u1'},
    {'release': '10.0', 'prefix': 'spfquery', 'reference': '1.2.10-7.1~deb10u1'}
];
