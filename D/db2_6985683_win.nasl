...
if (description)
{
  ...
  script_name(english:"IBM DB2 11.1 < 11.5.7.0 Special Build 29113 / 11.5.8.0 < 11.5.8.0 Special Build 29133 Denial of Service (Windows)");
...
var constraints = [
  ...
  {'fixed_version':'11.5.7.0', 'fixed_display':'11.5.7.0 Special Build 29113'},
