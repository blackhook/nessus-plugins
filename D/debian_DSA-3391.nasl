...
# extracted from Debian Security Advisory DSA-3391. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3391");

  script_name(english:"Debian DSA-3391-1 : php-horde - security update");
...
packages."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=803641"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3391"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"php-horde", reference:"5.2.1+debian0-2+deb8u2")) flag++;
