...
# extracted from Debian Security Advisory DSA-374. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-374-1 : libpam-smb - buffer overflow");
...
code with the privileges of the process which invokes PAM services."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-374"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your libpam-smb package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libpam-smb");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libpam-smb", reference:"1.1.6-1.1woody1")) flag++;
