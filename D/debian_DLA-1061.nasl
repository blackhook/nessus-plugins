...
# extracted from Debian Security Advisory DLA-1061-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1061-1 : newsbeuter security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/08/msg00013.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"newsbeuter", reference:"2.5-2+deb7u2")) flag++;
