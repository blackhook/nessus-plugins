...
# extracted from Debian Security Advisory DLA-1086-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1086-1 : enigmail security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/09/msg00002.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"enigmail", reference:"2:1.9.8.1-1~deb7u1")) flag++;
