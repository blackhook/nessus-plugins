...
"The remote Debian 9 host has a package installed that is affected by a vulnerability as referenced in the dla-2894
advisory.
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'aide-common');
}
