...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00047.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/php-horde-core"
  );
  # https://security-tracker.debian.org/tracker/source-package/php-horde-core
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?67db8a51"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade the affected php-horde-core package."
  );
