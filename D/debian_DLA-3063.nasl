...
# extracted from Debian Security Advisory dla-3063. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-3063-1 : systemd - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-3063
advisory.

  - A heap use-after-free vulnerability was found in systemd before version v245-rc1, where asynchronous
    Polkit queries are performed while handling dbus messages. A local unprivileged attacker can abuse this
    flaw to crash systemd services or potentially execute code and elevate their privileges, by sending
    specially crafted dbus messages. (CVE-2020-1712)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=950732");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/systemd");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3063");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/CVE-2020-1712");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'libnss-myhostname', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libnss-mymachines', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libnss-resolve', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libnss-systemd', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libpam-systemd', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libsystemd-dev', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libsystemd0', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libudev-dev', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'libudev1', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'systemd', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'systemd-container', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'systemd-coredump', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'systemd-journal-remote', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'systemd-sysv', 'reference': '232-25+deb9u14'},
    {'release': '9.0', 'prefix': 'udev', 'reference': '232-25+deb9u14'}
];
