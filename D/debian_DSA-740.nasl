...
# extracted from Debian Security Advisory DSA-740. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-740-1 : zlib - remote denial of service");
...
This problem does not affect the old stable distribution (woody)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-740"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the zlib package.
...
flag = 0;
if (deb_check(release:"3.1", prefix:"lib64z1", reference:"1.2.2-4.sarge.1")) flag++;
if (deb_check(release:"3.1", prefix:"lib64z1-dev", reference:"1.2.2-4.sarge.1")) flag++;
if (deb_check(release:"3.1", prefix:"zlib-bin", reference:"1.2.2-4.sarge.1")) flag++;
if (deb_check(release:"3.1", prefix:"zlib1g", reference:"1.2.2-4.sarge.1")) flag++;
if (deb_check(release:"3.1", prefix:"zlib1g-dev", reference:"1.2.2-4.sarge.1")) flag++;
