...
# extracted from Debian Security Advisory DSA-2074. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2074");

  script_name(english:"Debian DSA-2074-1 : ncompress - integer underflow");
...
compressed gzip archive."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2010/dsa-2074"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"5.0", prefix:"ncompress", reference:"4.2.4.2-1+lenny1")) flag++;
