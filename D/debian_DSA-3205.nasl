...
# extracted from Debian Security Advisory DSA-3205. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3205");

  script_name(english:"Debian DSA-3205-1 : batik - security update");
...
to arbitrary files or cause resource consumption."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=780897"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3205"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libbatik-java", reference:"1.7+dfsg-3+deb7u1")) flag++;
