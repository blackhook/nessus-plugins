...
# extracted from Debian Security Advisory DLA-2452-2. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2452-2 : libdatetime-timezone-perl regression update");
  ...
  script_set_attribute(
    ...
    value:
"2.09-1+2020d accidentally did omit changes to some files, resulting in
warnings.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/11/msg00028.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"libdatetime-timezone-perl", reference:"2.09-1+2020d+1")) flag++;
