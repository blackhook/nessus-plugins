...
# extracted from Debian Security Advisory DSA-1099. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1099-1 : horde2 - missing input sanitising");
...
injection of web script code through cross-site scripting."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1099"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"horde2", reference:"2.2.8-1sarge3")) flag++;
