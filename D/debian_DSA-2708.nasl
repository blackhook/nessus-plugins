...
# extracted from Debian Security Advisory DSA-2708. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2708");

  script_name(english:"Debian DSA-2708-1 : fail2ban - denial of service");
...
arbitrary addresses, thus causing a denial of service."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/squeeze/fail2ban"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2013/dsa-2708"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"6.0", prefix:"fail2ban", reference:"0.8.4-3+squeeze2")) flag++;
if (deb_check(release:"7.0", prefix:"fail2ban", reference:"0.8.6-3wheezy2")) flag++;
