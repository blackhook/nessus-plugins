...
# extracted from Debian Security Advisory DSA-1158. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1158-1 : streamripper - buffer overflow");
...
code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1158"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"streamripper", reference:"1.61.7-1sarge1")) flag++;
