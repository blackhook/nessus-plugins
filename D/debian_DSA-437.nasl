...
# extracted from Debian Security Advisory DSA-437. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-437-1 : cgiemail - open mail relay");
...
exploited to send unsolicited commercial email (spam)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-437"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"cgiemail", reference:"1.6-14woody1")) flag++;
