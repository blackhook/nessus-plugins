...
files via a symlink attack."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-583"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the lvm10 package.
...
version 1.0.4-5woody2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:lvm10");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"lvm10", reference:"1.0.4-5woody2")) flag++;
