...
# extracted from Debian Security Advisory DSA-1061. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1061-1 : popfile - missing input sanitising");
...
messages, which allows denial of service."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=354464"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1061"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the popfile package.
...
version 0.22.2-2sarge1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:popfile");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"popfile", reference:"0.22.2-2sarge1")) flag++;
