...
# extracted from Debian Security Advisory DSA-3993. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3993");

  script_name(english:"Debian DSA-3993-1 : tor - security update");
...
The oldstable distribution (jessie) is not affected."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2017/dsa-3993"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"9.0", prefix:"tor", reference:"0.2.9.12-1")) flag++;
if (deb_check(release:"9.0", prefix:"tor-dbg", reference:"0.2.9.12-1")) flag++;
if (deb_check(release:"9.0", prefix:"tor-geoipdb", reference:"0.2.9.12-1")) flag++;
