...
# extracted from Debian Security Advisory DLA-1458-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1458-1 : xml-security-c security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00006.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libxml-security-c-dev", reference:"1.7.2-3+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libxml-security-c17", reference:"1.7.2-3+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"xml-security-c-utils", reference:"1.7.2-3+deb8u1")) flag++;
