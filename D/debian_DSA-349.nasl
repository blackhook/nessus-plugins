...
# extracted from Debian Security Advisory DSA-349. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-349-1 : nfs-utils - buffer overflow");
...
service condition by sending certain RPC requests."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-349"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"nfs-common", reference:"1:1.0-2woody1")) flag++;
if (deb_check(release:"3.0", prefix:"nfs-kernel-server", reference:"1:1.0-2woody1")) flag++;
if (deb_check(release:"3.0", prefix:"nhfsstone", reference:"1:1.0-2woody1")) flag++;
