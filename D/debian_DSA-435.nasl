...
# extracted from Debian Security Advisory DSA-435. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-435-1 : mpg123 - heap overflow");
...
mp3 stream from a malicious remote server via HTTP."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-435"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"mpg123", reference:"0.59r-13woody2")) flag++;
if (deb_check(release:"3.0", prefix:"mpg123-esd", reference:"0.59r-13woody2")) flag++;
if (deb_check(release:"3.0", prefix:"mpg123-nas", reference:"0.59r-13woody2")) flag++;
if (deb_check(release:"3.0", prefix:"mpg123-oss-3dnow", reference:"0.59r-13woody2")) flag++;
if (deb_check(release:"3.0", prefix:"mpg123-oss-i486", reference:"0.59r-13woody2")) flag++;
