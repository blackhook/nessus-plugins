...
# extracted from Debian Security Advisory DLA-2053-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2053-1 : otrs2 security update");
...
attacker doesn&rsquo;t have permissions.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/01/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-18179");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"otrs", reference:"3.3.18-1+deb8u12")) flag++;
if (deb_check(release:"8.0", prefix:"otrs2", reference:"3.3.18-1+deb8u12")) flag++;
