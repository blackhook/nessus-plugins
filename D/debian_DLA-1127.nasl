...
# extracted from Debian Security Advisory DLA-1127-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1127-1 : sam2p security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/10/msg00007.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"sam2p", reference:"0.49.1-1+deb7u1")) flag++;
