...
# extracted from Debian Security Advisory DSA-684. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-684-1 : typespeed - format string");
...
games."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-684"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"typespeed", reference:"0.4.1-2.3")) flag++;
