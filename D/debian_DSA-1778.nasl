...
# extracted from Debian Security Advisory DSA-1778. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1778-1 : mahara - insufficient input sanitization");
...
The oldstable distribution (etch) does not contain mahara."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1778"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"5.0", prefix:"mahara", reference:"1.0.4-4+lenny2")) flag++;
if (deb_check(release:"5.0", prefix:"mahara-apache2", reference:"1.0.4-4+lenny2")) flag++;
