...
# extracted from Debian Security Advisory DLA-830-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-830-1 : gst-plugins-bad0.10 security update");
  ...
  script_set_attribute(
    ...
    value:
"Some memory management issues were found in the GStreamer 'bad'
plugins :
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/02/msg00019.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-bad", reference:"0.10.23-7.1+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-bad-dbg", reference:"0.10.23-7.1+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-bad-doc", reference:"0.10.23-7.1+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"libgstreamer-plugins-bad0.10-0", reference:"0.10.23-7.1+deb7u5")) flag++;
if (deb_check(release:"7.0", prefix:"libgstreamer-plugins-bad0.10-dev", reference:"0.10.23-7.1+deb7u5")) flag++;
