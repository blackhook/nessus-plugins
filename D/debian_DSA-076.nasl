...
# extracted from Debian Security Advisory DSA-076. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-076-1 : most - buffer overflow");
...
"Pavel Machek has found a buffer overflow in the `most' pager program.
 ...
 to compromise the users environment."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2001/dsa-076"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the most package immediately.
...
version of 4.9.0 for Debian GNU/Linux 2.2."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2001/09/18");
...
flag = 0;
if (deb_check(release:"2.2", prefix:"most", reference:"4.9.0-2.1")) flag++;
