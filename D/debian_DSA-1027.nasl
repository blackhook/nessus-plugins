...
# extracted from Debian Security Advisory DSA-1027. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1027-1 : mailman - programming error");
...
The old stable distribution (woody) is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=358892"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1027"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"mailman", reference:"2.1.5-8sarge2")) flag++;
