...
# extracted from Debian Security Advisory DSA-1440. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1440-1 : inotify-tools - buffer overflow");
...
The old stable distribution (sarge) does not provide inotify-tools."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=443913"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2007/dsa-1440"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the inotify-tools package.
...
version 3.3-2."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:inotify-tools");
...
flag = 0;
if (deb_check(release:"4.0", prefix:"inotify-tools", reference:"3.3-2")) flag++;
