...
for further details :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=823325"
  );
  # https://mariadb.com/kb/en/mariadb/mariadb-10024-release-notes/
  script_set_attribute(
    attribute:"see_also",
    value:"https://mariadb.com/kb/en/library/mariadb-10024-release-notes/"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2016/dsa-3595"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
