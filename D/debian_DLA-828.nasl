...
# extracted from Debian Security Advisory DLA-828-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-828-1 : gst-plugins-good0.10 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/02/msg00017.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-gconf", reference:"0.10.31-3+nmu1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-good", reference:"0.10.31-3+nmu1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-good-dbg", reference:"0.10.31-3+nmu1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-plugins-good-doc", reference:"0.10.31-3+nmu1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"gstreamer0.10-pulseaudio", reference:"0.10.31-3+nmu1+deb7u2")) flag++;
