...
# extracted from Debian Security Advisory DSA-522. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-522-1 : super - format string vulnerability");
...
local user to execute arbitrary code with root privileges."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-522"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"super", reference:"3.16.1-1.2")) flag++;
