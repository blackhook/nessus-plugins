...
# extracted from Debian Security Advisory DSA-3604. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3604");

  script_name(english:"Debian DSA-3604-1 : drupal7 - security update");
...
of the Drupal content management framework. For additional
...
https://www.drupal.org/SA-CORE-2016-002."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2016/dsa-3604"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"8.0", prefix:"drupal7", reference:"7.32-1+deb8u7")) flag++;
