...
# extracted from Debian Security Advisory DLA-1175-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1175-1 : lynx-cur security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/11/msg00021.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/lynx-cur"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected lynx, lynx-cur, and lynx-cur-wrapper packages."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:lynx-cur-wrapper");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"lynx", reference:"2.8.8dev.12-2+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"lynx-cur", reference:"2.8.8dev.12-2+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"lynx-cur-wrapper", reference:"2.8.8dev.12-2+deb7u2")) flag++;
