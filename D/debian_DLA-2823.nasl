...
# extracted from Debian Security Advisory dla-2823. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2823-1 : salt - LTS security update");

  script_set_attribute(attribute:"synopsis", value:
"The remote Debian host is missing a security-related update.");
  script_set_attribute(attribute:"description", value:
"The remote Debian 9 host has packages installed that are affected by a vulnerability as referenced in the dla-2823
advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=994016");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/salt");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2021/dla-2823");
...
For Debian 9 stretch, this problem has been fixed in version 2016.11.2+ds-1+deb9u8.");
...
var pkgs = [
    {'release': '9.0', 'prefix': 'salt-api', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-cloud', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-common', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-doc', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-master', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-minion', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-proxy', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-ssh', 'reference': '2016.11.2+ds-1+deb9u8'},
    {'release': '9.0', 'prefix': 'salt-syndic', 'reference': '2016.11.2+ds-1+deb9u8'}
];
