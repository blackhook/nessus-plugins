...
# extracted from Debian Security Advisory DLA-1952-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1952-1 : rsyslog security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/10/msg00011.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/rsyslog"
  );
...
flag = 0;
if (deb_check(release:"8.0", prefix:"rsyslog", reference:"8.4.2-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"rsyslog-elasticsearch", reference:"8.4.2-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"rsyslog-gnutls", reference:"8.4.2-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"rsyslog-gssapi", reference:"8.4.2-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"rsyslog-mongodb", reference:"8.4.2-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"rsyslog-mysql", reference:"8.4.2-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"rsyslog-pgsql", reference:"8.4.2-1+deb8u3")) flag++;
if (deb_check(release:"8.0", prefix:"rsyslog-relp", reference:"8.4.2-1+deb8u3")) flag++;
