...
# extracted from Debian Security Advisory DSA-1566. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1566");

  script_name(english:"Debian DSA-1566-1 : cpio - programming error");
...
of a maliciously crafted archive."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2008/dsa-1566"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"cpio", reference:"2.6-18.1+etch1")) flag++;
