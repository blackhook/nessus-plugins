...
# extracted from Debian Security Advisory DSA-287. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-287-1 : epic - buffer overflows");
...
user id of the chatting user."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-287"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the EPIC package.
...
fixed in version 3.004-16.1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:epic");
...
flag = 0;
if (deb_check(release:"2.2", prefix:"epic", reference:"3.004-16.1")) flag++;
if (deb_check(release:"3.0", prefix:"epic", reference:"3.004-17.1")) flag++;
