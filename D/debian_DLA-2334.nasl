...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/08/msg00031.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/stretch/ruby-websocket-extensions"
  );
  # https://security-tracker.debian.org/tracker/source-package/ruby-websocket-extensions
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e9b63587"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade the affected ruby-websocket-extensions package."
  );
