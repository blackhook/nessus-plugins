...
# extracted from Debian Security Advisory DLA-872-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-872-1 : xrdp security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/03/msg00030.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"xrdp", reference:"0.5.0-2+deb7u1")) flag++;
