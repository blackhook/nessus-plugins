...
# extracted from Debian Security Advisory DSA-430. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-430-1 : trr19 - missing privilege release");
...
attacker to gain access to the local group games."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-430"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the trr19 package.
...
version 1.0beta5-15woody1. The mipsel binary will be added later."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:trr19");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"trr19", reference:"1.0beta5-15woody1")) flag++;
