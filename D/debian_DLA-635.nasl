...
# extracted from Debian Security Advisory DLA-635-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-635-1 : dwarfutils security update");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that there were out-of-bounds read issues in
dwarfutils, a library to consume and produce DWARF debug information.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/09/msg00028.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"dwarfdump", reference:"20120410-2+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"libdwarf-dev", reference:"20120410-2+deb7u1")) flag++;
