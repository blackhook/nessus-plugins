...
# extracted from Debian Security Advisory DLA-1155-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1155-1 : tzdata new upstream version");
  ...
  script_set_attribute(
    ...
    value:
"This update includes the changes in tzdata 2017b. Notable changes 
are :

  - Northern Cyprus resumed EU rules starting 2017-10-29.

  - Namibia will switch from +01 with DST to +02 all year,
    affecting UT offsets starting 2018-04-01.

  - Sudan will switch from +03 to +02 on 2017-11-01.

  - Tonga will not observe DST on 2017-11-05.

  - Turks & Caicos will switch from -04 all year to -05 with
    US DST, affecting UT offset starting 2018-11-04.
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/10/msg00033.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"tzdata", reference:"2017c-0+deb7u1")) flag++;
if (deb_check(release:"7.0", prefix:"tzdata-java", reference:"2017c-0+deb7u1")) flag++;
