...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/01/msg00018.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/jessie/mxml"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade the affected libmxml-dev, and libmxml1 packages."
  );
