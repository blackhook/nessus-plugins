...
# extracted from Debian Security Advisory DLA-1219-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1219-1 : enigmail security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/12/msg00021.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"enigmail", reference:"2:1.9.9-1~deb7u1")) flag++;
