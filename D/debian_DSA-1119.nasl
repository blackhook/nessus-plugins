...
# extracted from Debian Security Advisory DSA-1119. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1119-1 : hiki - design flaw");
...
large and specially crafted Wiki pages."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=378059"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1119"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"hiki", reference:"0.6.5-2")) flag++;
