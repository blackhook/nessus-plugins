...
# extracted from Debian Security Advisory DSA-1713. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"1713");

  script_name(english:"Debian DSA-1713-1 : rt2500 - integer overflow");
...
can be found in /usr/share/doc/rt2500-source/README.Debian"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2009/dsa-1713"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the rt2500 package.
...
1:1.1.0-b4+cvs20080623-3."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:rt2500");
...
flag = 0;
if (deb_check(release:"4.0", prefix:"rt2500", reference:"1.1.0+cvs20060620-3+etch1")) flag++;
if (deb_check(release:"4.0", prefix:"rt2500-source", reference:"1.1.0+cvs20060620-3+etch1")) flag++;
