...
# extracted from Debian Security Advisory DSA-3105. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3105");

  script_name(english:"Debian DSA-3105-1 : heirloom-mailx - security update");
...
implementation of the 'mail' command :
  ...
  - CVE-2014-7844
    An unexpected feature of mailx treats syntactically
    valid email addresses as shell commands to execute.

Shell command execution can be re-enabled using the
'expandaddr'option.
...
the mail header."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security-tracker.debian.org/tracker/CVE-2014-7844"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/heirloom-mailx"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-3105"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the heirloom-mailx packages.

For the stable distribution (wheezy), these problems have been fixed
in version 12.5-2+deb7u1."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"heirloom-mailx", reference:"12.5-2+deb7u1")) flag++;
