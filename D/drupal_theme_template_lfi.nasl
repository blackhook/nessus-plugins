...
arbitrary PHP scripts with the permissions of the web server process.");
  # https://www.acunetix.com/blog/news/drupal-local-file-inclusion-vulnerability/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fbad9862");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/501297/30/0/threaded");
