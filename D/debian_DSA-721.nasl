...
# extracted from Debian Security Advisory DSA-721. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-721-1 : squid - design flaw");
...
less restrictive ACLs than intended by the administrator."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=307132"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-721"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"squid", reference:"2.4.6-2woody8")) flag++;
if (deb_check(release:"3.0", prefix:"squid-cgi", reference:"2.4.6-2woody8")) flag++;
if (deb_check(release:"3.0", prefix:"squidclient", reference:"2.4.6-2woody8")) flag++;
