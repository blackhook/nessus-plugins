...
# extracted from Debian Security Advisory DSA-591. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-591-1 : libgd2 - integer overflows");
...
execution of arbitrary code on the victim's machine."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-591"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"libgd-tools", reference:"2.0.1-10woody1")) flag++;
if (deb_check(release:"3.0", prefix:"libgd2", reference:"2.0.1-10woody1")) flag++;
if (deb_check(release:"3.0", prefix:"libgd2-dev", reference:"2.0.1-10woody1")) flag++;
if (deb_check(release:"3.0", prefix:"libgd2-noxpm", reference:"2.0.1-10woody1")) flag++;
