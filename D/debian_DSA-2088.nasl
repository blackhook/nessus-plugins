...
# extracted from Debian Security Advisory DSA-2088. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"2088");

  script_name(english:"Debian DSA-2088-1 : wget - missing input sanitization");
...
invoking wget with the new --use-server-file-name option."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=590296"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2010/dsa-2088"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the wget package.
...
flag = 0;
if (deb_check(release:"5.0", prefix:"wget", reference:"1.11.4-2+lenny2")) flag++;
