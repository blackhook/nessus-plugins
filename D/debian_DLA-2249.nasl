...
# extracted from Debian Security Advisory DLA-2249-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2249-1 : libexif security update");
...
In exif_entry_get_value of exif-entry.c, there is a possible out of
...
In exif_data_load_data_content of exif-data.c, there is a possible
UBSAN abort due to an integer overflow. This could lead to remote
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2020/06/msg00020.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-0182");
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libexif-dev", reference:"0.6.21-2+deb8u4")) flag++;
if (deb_check(release:"8.0", prefix:"libexif12", reference:"0.6.21-2+deb8u4")) flag++;
