...
# extracted from Debian Security Advisory DSA-595. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-595-1 : bnc - buffer overflow");
...
size and execute arbitrary code on the client host."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-595"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the bnc package.
...
This package does not exist in the testing or unstable distributions."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:bnc");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"bnc", reference:"2.6.4-3.3")) flag++;
