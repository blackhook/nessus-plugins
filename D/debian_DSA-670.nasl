...
# extracted from Debian Security Advisory DSA-670. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-670-1 : emacs20 - format string");
...
privileges of group mail."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-670"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
version 20.7-13.3."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:emacs20");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"emacs20", reference:"20.7-13.3")) flag++;
if (deb_check(release:"3.0", prefix:"emacs20-el", reference:"20.7-13.3")) flag++;
