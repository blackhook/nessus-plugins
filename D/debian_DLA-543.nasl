...
# extracted from Debian Security Advisory DLA-543-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-543-1 : sqlite3 security update");
...
database engine, would reject a temporary directory (e.g., as
specified by the TMPDIR environment variable) to which the executing
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/07/msg00004.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"lemon", reference:"3.7.13-1+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libsqlite3-0", reference:"3.7.13-1+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libsqlite3-0-dbg", reference:"3.7.13-1+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libsqlite3-dev", reference:"3.7.13-1+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"libsqlite3-tcl", reference:"3.7.13-1+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"sqlite3", reference:"3.7.13-1+deb7u3")) flag++;
if (deb_check(release:"7.0", prefix:"sqlite3-doc", reference:"3.7.13-1+deb7u3")) flag++;
