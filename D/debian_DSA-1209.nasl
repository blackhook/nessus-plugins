...
# extracted from Debian Security Advisory DSA-1209. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1209-2 : trac - cross-site request forgery");
...
software development projects, performs insufficient validation
against cross-site request forgery, which might lead to an attacker
being able to perform manipulation of a Trac site with the privileges
of the attacked Trac user."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2006/dsa-1209"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.1", prefix:"trac", reference:"0.8.1-3sarge7")) flag++;
