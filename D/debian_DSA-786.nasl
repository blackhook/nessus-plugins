...
# extracted from Debian Security Advisory DSA-786. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-786-1 : simpleproxy - format string vulnerability");
...
can be exploited via replies from remote HTTP proxies."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2005/dsa-786"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade the simpleproxy package.
...
version 3.2-3sarge1."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:simpleproxy");
...
flag = 0;
if (deb_check(release:"3.1", prefix:"simpleproxy", reference:"3.2-3sarge1")) flag++;
