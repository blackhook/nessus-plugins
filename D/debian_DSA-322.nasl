...
# extracted from Debian Security Advisory DSA-322. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-322-1 : typespeed - buffer overflow");
...
typespeed, in addition to gid games."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2003/dsa-322"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your typespeed package."
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2003/06/12");
...
flag = 0;
if (deb_check(release:"2.2", prefix:"typespeed", reference:"0.4.0-5.2")) flag++;
if (deb_check(release:"3.0", prefix:"typespeed", reference:"0.4.1-2.2")) flag++;
