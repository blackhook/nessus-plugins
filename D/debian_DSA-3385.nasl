...
for further details :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=802874"
  );
  # https://mariadb.com/kb/en/mariadb/mariadb-10021-release-notes/
  script_set_attribute(
    attribute:"see_also",
    value:"https://mariadb.com/kb/en/library/mariadb-10021-release-notes/"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3385"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
