...
# extracted from Debian Security Advisory dsa-5412. The text
...
if (description)
{
  ...
  script_name(english:"Debian DSA-5412-1 : libraw - security update");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=1031790");
  script_set_attribute(attribute:"see_also", value:"https://security-tracker.debian.org/tracker/source-package/libraw");
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/security/2023/dsa-5412");
...
var pkgs = [
    {'release': '11.0', 'prefix': 'libraw-bin', 'reference': '0.20.2-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libraw-dev', 'reference': '0.20.2-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libraw-doc', 'reference': '0.20.2-1+deb11u1'},
    {'release': '11.0', 'prefix': 'libraw20', 'reference': '0.20.2-1+deb11u1'}
];
