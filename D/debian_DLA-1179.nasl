...
# extracted from Debian Security Advisory DLA-1179-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1179-1 : shibboleth-sp2 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2017/11/msg00025.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:libshibsp5");
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libapache2-mod-shib2", reference:"2.4.3+dfsg-5+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libshibsp-dev", reference:"2.4.3+dfsg-5+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libshibsp-doc", reference:"2.4.3+dfsg-5+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libshibsp5", reference:"2.4.3+dfsg-5+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"shibboleth-sp2-schemas", reference:"2.4.3+dfsg-5+deb7u2")) flag++;
