...
if (description)
{
  ...
  script_name(english:"Debian DLA-3419-1 : webkit2gtk - LTS security update");
...
dla-3419 advisory.
  ...
  - This issue was addressed with improved state management. This issue is fixed in macOS Ventura 13.3,
    watchOS 9.4, tvOS 16.4, Safari 16.4, iOS 16.4 and iPadOS 16.4. Processing maliciously crafted web content
    may bypass Same Origin Policy (CVE-2023-27932)

  - The issue was addressed by removing origin information. This issue is fixed in macOS Ventura 13.3, watchOS
    9.4, tvOS 16.4, iOS 15.7.4 and iPadOS 15.7.4, Safari 16.4, iOS 16.4 and iPadOS 16.4. A website may be able
    to track sensitive user information (CVE-2023-27954)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2023/dla-3419");
...
var pkgs = [
    ...
    {'release': '10.0', 'prefix': 'libwebkit2gtk-4.0-37-gtk2', 'reference': '2.38.6-0+deb10u1'},
