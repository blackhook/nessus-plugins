...
# extracted from Debian Security Advisory DLA-2615-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-2615-1 : spamassassin security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2021/04/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"9.0", prefix:"sa-compile", reference:"3.4.2-1~deb9u4")) flag++;
if (deb_check(release:"9.0", prefix:"spamassassin", reference:"3.4.2-1~deb9u4")) flag++;
if (deb_check(release:"9.0", prefix:"spamc", reference:"3.4.2-1~deb9u4")) flag++;
