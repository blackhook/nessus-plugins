...
# extracted from Debian Security Advisory DLA-1287-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1287-1 : zziplib security update");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that there was a uncontrolled memory allocation
issue in zziplib, a ZIP archive library. Remote attackers could
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2018/02/msg00022.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"libzzip-0-13", reference:"0.13.56-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"libzzip-dev", reference:"0.13.56-1.1+deb7u2")) flag++;
if (deb_check(release:"7.0", prefix:"zziplib-bin", reference:"0.13.56-1.1+deb7u2")) flag++;
