...
if (description)
{
  ...
  script_name(english:"Debian DLA-3183-1 : webkit2gtk - LTS security update");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.debian.org/lts/security/2022/dla-3183");
...
var pkgs = [
    ...
    {'release': '10.0', 'prefix': 'libwebkit2gtk-4.0-37-gtk2', 'reference': '2.38.2-1~deb10u1'},
