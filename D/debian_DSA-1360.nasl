...
# extracted from Debian Security Advisory DSA-1360. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-1360-1 : rsync - buffer overflow");
...
attackers to execute arbitrary code via long directory names."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2007/dsa-1360"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"4.0", prefix:"rsync", reference:"2.6.9-2etch1")) flag++;
