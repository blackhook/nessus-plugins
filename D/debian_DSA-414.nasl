...
# extracted from Debian Security Advisory DSA-414. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-414-1 : jabber - denial of service");
...
server process to crash, resulting in a denial of service."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-414"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
We recommend that you update your jabber package."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:debian:debian_linux:jabber");
...
flag = 0;
if (deb_check(release:"3.0", prefix:"jabber", reference:"1.4.2a-1.1woody1")) flag++;
