...
# extracted from Debian Security Advisory DSA-3017. The text 
...
if (description)
{
  ...
  script_bugtraq_id(69496);
  script_xref(name:"DSA", value:"3017");

  script_name(english:"Debian DSA-3017-1 : php-cas - security update");
...
to an URL, creating a possibility for cross site scripting."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=759718"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://packages.debian.org/source/wheezy/php-cas"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2014/dsa-3017"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"7.0", prefix:"php-cas", reference:"1.3.1-4+deb7u1")) flag++;
