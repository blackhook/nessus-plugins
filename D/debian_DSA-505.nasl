...
# extracted from Debian Security Advisory DSA-505. The text 
...
if (description)
{
  ...
  script_name(english:"Debian DSA-505-1 : cvs - heap overflow");
...
serves the popular Concurrent Versions System. Malformed 'Entry' Lines
in combination with Is-modified and Unchanged can be used to overflow
malloc()ed memory. This was proven to be exploitable."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.debian.org/security/2004/dsa-505"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (deb_check(release:"3.0", prefix:"cvs", reference:"1.11.1p1debian-9woody4")) flag++;
