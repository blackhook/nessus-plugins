...
# extracted from Debian Security Advisory DLA-485-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-485-1 : extplorer security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2016/05/msg00038.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"7.0", prefix:"extplorer", reference:"2.1.0b6+dfsg.3-4+deb7u3")) flag++;
