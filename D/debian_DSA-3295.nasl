...
# extracted from Debian Security Advisory DSA-3295. The text 
...
if (description)
{
  ...
  script_xref(name:"DSA", value:"3295");

  script_name(english:"Debian DSA-3295-1 : cacti - security update");
...
systems."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2015/dsa-3295"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
fixed in version 0.8.8a+dfsg-5+deb7u5.

For the stable distribution (jessie), these problems have been fixed
in version 0.8.8b+dfsg-8+deb8u1."
  );
...
flag = 0;
if (deb_check(release:"7.0", prefix:"cacti", reference:"0.8.8a+dfsg-5+deb7u5")) flag++;
if (deb_check(release:"8.0", prefix:"cacti", reference:"0.8.8b+dfsg-8+deb8u1")) flag++;
