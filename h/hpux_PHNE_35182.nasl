...
# extracted from HP patch PHNE_35182. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_35182 : HP-UX Running ARPA Transport, Local Denial of Service (DoS) (HPSBUX02192 SSRT061233 rev.1)");
...
local user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_35182 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_35182 applies to a different OS release.");
}

patches = make_list("PHNE_35182", "PHNE_35765", "PHNE_35766", "PHNE_37395", "PHNE_37670", "PHNE_37897", "PHNE_38679", "PHNE_39387", "PHNE_41436", "PHNE_42094", "PHNE_43215");
