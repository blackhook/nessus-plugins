...
# extracted from HP patch PHNE_34936. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_34936 : HP-UX Sendmail MIME Remote Denial of Service (DoS) (HPSBUX02124 SSRT061159 rev.2)");
...
running Sendmail processing malformed multipart MIME messages. This
vulnerability could potentially allow a remote unauthenticated user to
cause a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_34936 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_34936 applies to a different OS release.");
}

patches = make_list("PHNE_34936", "PHNE_35484", "PHNE_35950", "PHNE_40393");
