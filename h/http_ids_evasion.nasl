...
# http://web.archive.org/web/20030413094741/http://www.wiretrip.net/rfp/pages/whitepapers/whiskerids.html
...
if(description)
{
  ...
  script_cvs_date("$Date: 2017/06/30 15:19:35 $");

  script_name(english:"HTTP NIDS Evasion");
  script_summary(english:"NIDS evasion options");

  script_set_attribute(
    attribute:'synopsis',
    value:"This plugin configures Nessus for NIDS evasion."
  );

  script_set_attribute(
    attribute:'description',
    value:"This plugin configures Nessus for NIDS evasion (see the 'Prefs' panel).
...
Read http://www.nessus.org/u?55bcc045 for more information.
...
This plugin does not do any security check."
  ...
  script_set_attribute(attribute:'see_also', value:"http://www.nessus.org/u?55bcc045");
  script_set_attribute(attribute:'risk_factor', value:'None');

  script_set_attribute(attribute:"plugin_publication_date", value: "2002/03/12");
