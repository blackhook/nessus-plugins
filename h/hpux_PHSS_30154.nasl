...
# extracted from HP patch PHSS_30154. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30154 : HPSBUX0401-305 SSRT4681 Apache 1.3.29 web server on VVOS");
...
modules for Apache versions prior to 1.3.29."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30154 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30154 applies to a different OS release.");
}

patches = make_list("PHSS_30154", "PHSS_30405", "PHSS_30645", "PHSS_30947", "PHSS_31057", "PHSS_31826", "PHSS_32183", "PHSS_33397", "PHSS_34120", "PHSS_35108", "PHSS_35462", "PHSS_35557");
