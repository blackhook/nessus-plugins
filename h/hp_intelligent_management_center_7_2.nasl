...
target host.");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c05200601
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76f33419");
...
"Upgrade to HP IMC version 7.2 E0403P04 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-4372");
