...
# extracted from HP patch PHNE_26771. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_26771 : HP-UX Running ARPA Transport, Advisory, RFC 1948 ISN Randomization (HPSBUX00205 SSRT080009 rev.3)");
...
is available for HP-UX. References: CVE-2001-0328, CERT CA-2001-09."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_26771 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_26771 applies to a different OS release.");
}

patches = make_list("PHNE_26771", "PHNE_27886", "PHNE_28538", "PHNE_29473", "PHNE_32041", "PHNE_33395", "PHNE_35729");
