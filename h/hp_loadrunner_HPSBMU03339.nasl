...
overflow, resulting in the execution of arbitrary code.");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c04692147
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc7af3f7");
  script_set_attribute(attribute:"solution", value:
"Upgrade to HP LoadRunner 12.50 or later.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-5426");
