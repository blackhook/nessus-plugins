...
# extracted from HP patch PHSS_33538. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_33538 : HP OpenView Event Correlation Services (OV ECS), Remote Unauthorized Privileged Access (HPSBMA01225 SSRT051030 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV ECS3.33 PA RISC Consolidated Patch : 
...
remotely by an unauthorized user to gain privileged access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_33538 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_33538 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_33538", "PHSS_34634", "PHSS_37280");
