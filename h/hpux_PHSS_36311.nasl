...
# extracted from HP patch PHSS_36311. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_36311 : HP-UX Running Aries PA Emulator, Local Unauthorized Access (HPSBUX02285 SSRT071484 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.31 Aries cumulative patch : 
...
vulnerability may allow local unauthorized access."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5b6b00a9"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_36311 or subsequent."
  );
...
if (!hpux_check_ctx(ctx:"11.31", proc:"ia64"))
{
  exit(0, "The host is not affected since PHSS_36311 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_36311", "PHSS_36520", "PHSS_37553", "PHSS_38527", "PHSS_39294", "PHSS_39898", "PHSS_41099", "PHSS_41423", "PHSS_42739", "PHSS_42863", "PHSS_43150", "PHSS_44258", "PHSS_44514");
