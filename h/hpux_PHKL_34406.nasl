...
# extracted from HP patch PHKL_34406. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_34406 : HP-UX Local Denial of Service (DoS) (HPSBUX02120 SSRT051057 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 Timers disabling, early SIGXCPU : 
...
authorized user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cfa0b4d0"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_34406 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_34406 applies to a different OS release.");
}

patches = make_list("PHKL_34406");
