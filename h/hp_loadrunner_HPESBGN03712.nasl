...
remote attacker can exploit this to execute arbitrary code.");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-hpesbgn03712en_us
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f64b91c");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/research/tra-2017-13");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-17-160/");
...
"Upgrade to HP LoadRunner version 12.53 patch 4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-5789");
