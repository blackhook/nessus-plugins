...
# extracted from HP patch PHSS_37183. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_37183 : HP OpenView Operations (OVO) Running on HP-UX and Solaris, Remote Unauthorized Access, Denial of Service (DoS) (HPSBMA02288 SSRT071465 rev.1)");
...
CVE-2007-3922, CVE-2007-3698."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_37183 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_37183 applies to a different OS release.");
}

patches = make_list("PHSS_37183", "PHSS_37566", "PHSS_38203", "PHSS_38854", "PHSS_39327", "PHSS_39896", "PHSS_40468", "PHSS_41213");
