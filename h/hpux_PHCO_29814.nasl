...
# extracted from HP patch PHCO_29814. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_29814 : HP-UX Shells, Local Increase of Privilege, Denial of Service (DoS) (HPSBUX00275 SSRT3618 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) sh-posix(1) cumulative patch : 
...
Shells improperly manage files during operations."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_29814 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_29814 applies to a different OS release.");
}

patches = make_list("PHCO_29814");
