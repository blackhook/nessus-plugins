...
"Serviceguard A.11.16.00");
 script_set_attribute(attribute:"see_also", value:"ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_35303");
 script_set_attribute(attribute:"solution", value:"Apply the PHSS_35303 patch.");
