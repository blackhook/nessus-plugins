...
# extracted from HP patch PHCO_40520. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_40520 : HP-UX Running VRTSweb, Remote Execution of Arbitrary Code, Increase of Privilege (HPSBUX02480 SSRT090253 rev.1)");
...
remotely to execute arbitrary code or increase privilege."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_40520 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_40520 applies to a different OS release.");
}

patches = make_list("PHCO_40520");
...
flag = 0;
if (hpux_check_patch(app:"VRTSweb.VRTSWEB", version:"5.5.27.0")) flag++;
