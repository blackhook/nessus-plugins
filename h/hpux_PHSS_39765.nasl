...
# extracted from HP patch PHSS_39765. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_39765 : HP-UX Running Kerberos, Remote Denial of Service (DoS), Execution of Arbitrary Code (HPSBUX02421 SSRT090047 rev.2)");
...
execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_39765 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_39765 applies to a different OS release.");
}

patches = make_list("PHSS_39765", "PHSS_41167");
