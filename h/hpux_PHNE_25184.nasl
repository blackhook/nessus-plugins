...
# extracted from HP patch PHNE_25184. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_25184 : HP-UX running sendmail(1M), Remote Unauthorized Access (HPSBUX00179 SSRT071387 rev.3)");
...
However, HP sendmail(1m) release 8.11.1 does not exhibit this problem."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_25184 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_25184 applies to a different OS release.");
}

patches = make_list("PHNE_25184", "PHNE_26305", "PHNE_28810", "PHNE_29774", "PHNE_31917", "PHNE_34936", "PHNE_35484", "PHNE_35950", "PHNE_40393");
