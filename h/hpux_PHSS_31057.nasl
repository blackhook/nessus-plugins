...
# extracted from HP patch PHSS_31057. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31057 : s700_800 11.04 Virtualvault 4.6 OWS update");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31057 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31057 applies to a different OS release.");
}

patches = make_list("PHSS_31057", "PHSS_31826", "PHSS_32183", "PHSS_33397", "PHSS_34120", "PHSS_35108", "PHSS_35462", "PHSS_35557");
