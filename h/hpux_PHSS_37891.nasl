...
# extracted from HP patch PHSS_37891. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_37891 : HP-UX running WBEM Services, Remote Execution of Arbitrary Code, Gain Extended Privileges (HPSBMA02331 SSRT080000 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.31 HP WBEM Services A.02.07 : 
...
remotely to execute arbitrary code or to gain extended privileges."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_37891 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_37891 applies to a different OS release.");
}

patches = make_list("PHSS_37891");
