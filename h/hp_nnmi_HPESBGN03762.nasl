...
remote Windows host is 10.0x prior to 10.00 Patch 5, 10.1x prior to
...
Patch 4 / 10.20 Patch 3 or later.");
  ...
  script_require_keys("installed_sw/HP Network Node Manager i", "SMB/Registry/Enumerated");
  exit(0);
}
...
# Ensure we're checking NNMi on Windows
