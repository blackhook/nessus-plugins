...
# extracted from HP patch PHNE_36449. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_36449 : HP-UX Running rpc.yppasswdd, Remote Denial of Service (DoS) (HPSBUX02295 SSRT071333 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.31 rpc.yppasswdd patch : 
...
to create a denial of service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_36449 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_36449 applies to a different OS release.");
}

patches = make_list("PHNE_36449");
...
flag = 0;
if (hpux_check_patch(app:"NFS.NIS2-SERVER", version:"B.11.31")) flag++;
