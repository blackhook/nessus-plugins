...
"(VVOS) libnss_dns DNS backend patch");
 script_set_attribute(attribute:"see_also", value:"ftp://ftp.itrc.hp.com//hp-ux_patches/s700_800/11.X/PHNE_30007");
 script_set_attribute(attribute:"solution", value:"Apply the PHNE_30007 patch.");
