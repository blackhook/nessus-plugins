...
# extracted from HP patch PHNE_30589. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_30589 : HP-UX Running tftpd, Remote Denial of Service (HPSBUX00266 SSRT3487 rev.6)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) bootpd(1M)/DHCP,tftp(1) and tftpd(1M) : 
...
Potential Security Vulnerability in tftpd."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_30589 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_30589 applies to a different OS release.");
}

patches = make_list("PHNE_30589");
...
if (hpux_check_patch(app:"InternetSrvcs.INETSVCS-INC", version:"B.11.04")) flag++;
