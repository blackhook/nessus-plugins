...
# extracted from HP patch PHSS_22320. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_22320 : HPSBUX0011-128 Sec. Vulnerability in dtterm (rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 CDE Runtime SEP2000 Periodic Patch : 

dtterm has misuse potential."
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_22320 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_22320 applies to a different OS release.");
}

patches = make_list("PHSS_22320", "PHSS_22341", "PHSS_23517", "PHSS_23797", "PHSS_23800", "PHSS_25138", "PHSS_25194", "PHSS_25787", "PHSS_26490", "PHSS_27427", "PHSS_27869", "PHSS_28675", "PHSS_29734", "PHSS_30010", "PHSS_30668", "PHSS_32107", "PHSS_32539", "PHSS_35433");
