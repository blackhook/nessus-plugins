...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2010-B-0010-S");
...
execute arbitrary commands."
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de4c4a7e");
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_40368 or subsequent."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0445");
