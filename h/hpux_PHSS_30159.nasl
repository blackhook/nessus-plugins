...
# extracted from HP patch PHSS_30159. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30159 : HPSBUX0401-305 SSRT4681 Apache 1.3.29 web server on VVOS");
...
modules for Apache versions prior to 1.3.29."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30159 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30159 applies to a different OS release.");
}

patches = make_list("PHSS_30159", "PHSS_30647", "PHSS_31827", "PHSS_32141", "PHSS_34171", "PHSS_35104", "PHSS_35306", "PHSS_35458", "PHSS_35553");
