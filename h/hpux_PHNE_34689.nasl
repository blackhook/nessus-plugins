...
# extracted from HP patch PHNE_34689. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_34689 : HP-UX Sendmail MIME Remote Denial of Service (DoS) (HPSBUX02124 SSRT061159 rev.2)");
...
cause a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_34689 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_34689 applies to a different OS release.");
}

patches = make_list("PHNE_34689", "PHNE_35485", "PHNE_35951", "PHNE_40388");
