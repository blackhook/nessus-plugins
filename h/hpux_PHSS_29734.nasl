...
# extracted from HP patch PHSS_29734. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_29734 : s700_800 11.00 CDE Runtime Periodic Patch");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_29734 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_29734 applies to a different OS release.");
}

patches = make_list("PHSS_29734", "PHSS_30010", "PHSS_30668", "PHSS_32107", "PHSS_32539", "PHSS_35433");
