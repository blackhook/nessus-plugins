...
# extracted from HP patch PHSS_33129. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_33129 : HP-UX Running Motif Applications Remote Arbitrary Code Execution, Denial of Service (DoS) (HPSBUX02119 SSRT4848 rev.1)");
...
Service (DoS). References: CERT VU#537878, VU#882750."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?192db7a9"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_33129 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_33129 applies to a different OS release.");
}

patches = make_list("PHSS_33129");
...
flag = 0;
if (hpux_check_patch(app:"X11.MOTIF-SHLIB", version:"B.11.00")) flag++;
if (hpux_check_patch(app:"X11.X11-FONT-AUX", version:"B.11.00")) flag++;
if (hpux_check_patch(app:"X11.X11R5-SHLIBS", version:"B.11.00")) flag++;
if (hpux_check_patch(app:"X11.X11R6-SHLIBS", version:"B.11.00")) flag++;
