...
# extracted from HP patch PHSS_30057. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30057 : HPSBUX0310-284 SSRT3622 rev.3 HP-UX Apache HTTP Server Denial of Service,unauthorized access");
...
http://www.openssl.org/news/secadv/20030930.txt."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30057 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30057 applies to a different OS release.");
}

patches = make_list("PHSS_30057", "PHSS_30642", "PHSS_34164", "PHSS_35481", "PHSS_35560");
