...
# extracted from HP patch PHNE_40388. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_40388 : HP-UX Running sendmail, Remote Denial of Service (DoS) (HPSBUX02495 SSRT090151 rev.2)");
...
create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?16c072f8"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_40388 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_40388 applies to a different OS release.");
}

patches = make_list("PHNE_40388");
