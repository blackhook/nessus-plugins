...
# extracted from HP patch PHSS_32514. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32514 : HP OpenView Network Node Manager (OV NNM), Remote Denial of Service (DoS) (HPSBMA01125 SSRT4829 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV NNM7.50 Patch for Dec-04 : 
...
by an unauthorized user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32514 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32514 applies to a different OS release.");
}

patches = make_list("PHSS_32514", "PHSS_32692", "PHSS_32816", "PHSS_33072", "PHSS_33222", "PHSS_33344", "PHSS_33459", "PHSS_33662", "PHSS_34098", "PHSS_34870");
