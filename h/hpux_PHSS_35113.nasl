...
# extracted from HP patch PHSS_35113. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_35113 : s700_800 11.X OV NNM6.2 Intermediate Patch 19");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV NNM6.2 Intermediate Patch 19 : 
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_35113 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_35113 applies to a different OS release.");
}

patches = make_list("PHSS_35113");
