...
# extracted from HP patch PHCO_43873. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_43873 : s700_800 11.11 libpam_updbe patch");
...
restrictions. References: CVE-2014-7879 (SSRT101489)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_43873 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_43873 applies to a different OS release.");
}

patches = make_list("PHCO_43873");
