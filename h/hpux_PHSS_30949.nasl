...
# extracted from HP patch PHSS_30949. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30949 : s700_800 11.04 Webproxy server 2.0 update");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30949 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30949 applies to a different OS release.");
}

patches = make_list("PHSS_30949", "PHSS_31829", "PHSS_32363", "PHSS_33788", "PHSS_34204", "PHSS_35110");
