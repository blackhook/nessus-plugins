...
# extracted from HP patch PHSS_34203. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_34203 : HP-UX VirtualVault running Apache 1.3.X Remote Unauthorized Access (HPSBUX02101 SSRT051128 rev.1)");
...
References: Apache HTTP Server version 1.3.34 announcement."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_34203 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_34203 applies to a different OS release.");
}

patches = make_list("PHSS_34203", "PHSS_35111");
