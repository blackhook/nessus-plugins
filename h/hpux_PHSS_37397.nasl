...
# extracted from HP patch PHSS_37397. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_37397 : HP OpenView Operations (OVO) Agents Running Shared Trace Service, Remote Arbitrary Code Execution (HPSBMA02239 SSRT061260 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV OVO8.X Core Agt HPUX 11 PA A.08.17.3 : 
...
vulnerability could be remotely exploited to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_37397 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_37397 applies to a different OS release.");
}

patches = make_list("OAHPUX_00001", "PHSS_37397", "PHSS_37402", "PHSS_38509", "PHSS_38516");
...
if (hpux_check_patch(app:"OVO-CLT.OVO-UX11-CLT", version:"A.08.10.160")) flag++;
