...
# extracted from HP patch PHSS_32692. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32692 : HP OpenView Network Node Manager (OV NNM), Remote Unauthorized Privileged Code Execution, Denial of Service (DoS) (HPSBMA01140 SSRT4795, SSRT4797, SSRT4864 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV NNM7.50 Patch for Jan-05 : 
...
cause a Denial of Service(DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32692 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32692 applies to a different OS release.");
}

patches = make_list("PHSS_32692", "PHSS_32816", "PHSS_33072", "PHSS_33222", "PHSS_33344", "PHSS_33459", "PHSS_33662", "PHSS_34098", "PHSS_34870");
