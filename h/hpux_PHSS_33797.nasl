...
# extracted from HP patch PHSS_33797. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_33797 : HP OpenView Event Correlation Services (OV ECS), Remote Unauthorized Privileged Access (HPSBMA01225 SSRT051030 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV ECS3.20 Patch for Sep-05 : 
...
remotely by an unauthorized user to gain privileged access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_33797 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_33797 applies to a different OS release.");
}

patches = make_list("PHSS_33797");
...
flag = 0;
if (hpux_check_patch(app:"OVECS.OVECS-CMG", version:"A.03.20")) flag++;
