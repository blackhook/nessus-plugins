...
# extracted from HP patch PHKL_23423. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_23423 : HP-UX Running setrlimit(1M), Denial of Service (DoS) (HPSBUX00156 SSRT071363 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.11 improper core dump msg : 
...
The setrlimit() allows incorrect core files Rev.1 **."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_23423 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_23423 applies to a different OS release.");
}

patches = make_list("PHKL_23423", "PHKL_29911", "PHKL_32204");
