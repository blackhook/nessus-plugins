...
# extracted from HP patch PHSS_29735. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_29735 : s700_800 11.11 CDE Base Periodic Patch");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_29735 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_29735 applies to a different OS release.");
}

patches = make_list("PHSS_29735", "PHSS_30011", "PHSS_30788", "PHSS_32110", "PHSS_33325", "PHSS_35249", "PHSS_36394", "PHSS_43518");
