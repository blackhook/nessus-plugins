...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0535");
...
security vulnerabilities.");
  # https://softwaresupport.softwaregrp.com/web/softwaresupport/obsolescence-migrations
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?731124ca");
...
if (ver[0] == 'A')
{
  ...
  if (ver[1] < 8 || (ver[1] == 8 && ver[2] < 10))
  {
    ...
    report =
      ...
      '\n  EOL URL            : https://softwaresupport.softwaregrp.com/web/softwaresupport/obsolescence-migrations\n';
