...
# extracted from HP patch PHNE_44296. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_44296 : s700_800 11.23 cumulative PPP patch");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 cumulative PPP patch : 
...
SSRT102094."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_44296 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_44296 applies to a different OS release.");
}

patches = make_list("PHNE_44296");
...
if (hpux_check_patch(app:"Networking.PPP-RUN", version:"B.11.23")) flag++;
if (hpux_check_patch(app:"Networking.PPP2-RUN", version:"B.11.23")) flag++;
