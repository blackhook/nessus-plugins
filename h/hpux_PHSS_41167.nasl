...
# extracted from HP patch PHSS_41167. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_41167 : HP-UX Running Kerberos, Remote Denial of Service (DoS), Execution of Arbitrary Code (HPSBUX02544 SSRT100107 rev.1)");
...
execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_41167 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_41167 applies to a different OS release.");
}

patches = make_list("PHSS_41167");
