...
# extracted from HP patch PHNE_29634. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_29634 : s700_800 11.04 (VVOS) Bind 4.9.7 components");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_29634 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_29634 applies to a different OS release.");
}

patches = make_list("PHNE_29634");
