...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2010-B-0118-S");
...
management interface."
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2010/Dec/102");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2010/Dec/260");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-12-015/");
  # https://support.hpe.com/hpsc/doc/public/display?action=submitDocDisplay&docId=emr_na-c02660754
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08b08d05");
...
"Use the workaround described in the HP security bulletin SSRT100356.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4115");
