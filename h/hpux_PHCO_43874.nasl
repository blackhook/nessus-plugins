...
# extracted from HP patch PHCO_43874. The text itself is
...
if (description)
{
  ...
  script_cve_id("CVE-2014-7879");
  script_bugtraq_id(71308);
  script_xref(name:"HP", value:"emr_na-c04511778");

  script_name(english:"HP-UX PHCO_43874 : s700_800 11.23 libpam_updbe cumulative patch");
...
restrictions. References: CVE-2014-7879 (SSRT101489)."
  ...
  # http://h20000.www2.hp.com/bizsupport/TechSupport/Document.jsp?objectID=c04511778
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?462a1237"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_43874 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_43874 applies to a different OS release.");
}

patches = make_list("PHCO_43874");
