...
# extracted from HP patch PHNE_20681. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_20681 : HPSBUX9912-106 Security Vulnerability in wu-ftp (rev.2)");
...
Multiple vulnerabilities in wu-ftp software."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_20681 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_20681 applies to a different OS release.");
}

patches = make_list("PHNE_20681", "PHNE_22060", "PHNE_24395", "PHNE_31034", "PHNE_32813", "PHNE_34077");
