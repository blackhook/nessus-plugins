...
# extracted from HP patch PHSS_31826. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31826 : s700_800 11.04 Virtualvault 4.6 OWS update");
...
2.8.19 that may allow execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31826 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31826 applies to a different OS release.");
}

patches = make_list("PHSS_31826", "PHSS_32183", "PHSS_33397", "PHSS_34120", "PHSS_35108", "PHSS_35462", "PHSS_35557");
