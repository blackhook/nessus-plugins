...
# extracted from HP patch PHSS_31933. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31933 : HP OpenView Operations (OVO), Remote Unauthorized Privilege Elevation (HPSBMA01092 SSRT4847 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV ITO7.1X intermediate server A.07.22.1 : 
...
OVO."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31933 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31933 applies to a different OS release.");
}

patches = make_list("PHSS_31933", "PHSS_32174", "PHSS_32403", "PHSS_33143", "PHSS_33580", "PHSS_33865", "PHSS_34294", "PHSS_34594");
