...
# extracted from HP patch PHSS_27477. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27477 : s700_800 11.04 Virtualvault 4.5 Inside Admin Server Update");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 Virtualvault 4.5 Inside Admin Server Update : 
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27477 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_27477 applies to a different OS release.");
}

patches = make_list("PHSS_27477", "PHSS_28111", "PHSS_28521", "PHSS_29541", "PHSS_29892", "PHSS_30159", "PHSS_30647", "PHSS_31827", "PHSS_32141", "PHSS_34171", "PHSS_35104", "PHSS_35306", "PHSS_35458", "PHSS_35553");
