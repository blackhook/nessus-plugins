...
# extracted from HP patch PHCO_41200. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_41200 : HP-UX running Software Distributor (sd), Local Privilege Increase, Unauthorized Access (HPSBUX02552 SSRT100062 rev.1)");
...
unauthorized access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_41200 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_41200 applies to a different OS release.");
}

patches = make_list("PHCO_41200");
...
if (hpux_check_patch(app:"SW-DIST.GZIP", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.GZIP", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-AGENT", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-AGENT", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-CMDS", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-CMDS", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-ENG-A-MAN", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-ENG-A-MAN", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-FRE-I-MSG", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-FRE-I-MSG", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-GER-I-MSG", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-GER-I-MSG", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-HELP", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-HELP", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-JPN-E-HELP", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-JPN-E-HELP", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-JPN-E-MAN", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-JPN-E-MAN", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-JPN-E-MSG", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-JPN-E-MSG", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-JPN-S-HELP", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-JPN-S-HELP", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-JPN-S-MAN", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-JPN-S-MAN", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-JPN-S-MSG", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-JPN-S-MSG", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-KOR-E-MSG", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-KOR-E-MSG", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-TCH-B-MSG", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-TCH-B-MSG", version:"B.11.11.0909.340")) flag++;
...
if (hpux_check_patch(app:"SW-DIST.SD-TCH-H-MSG", version:"B.11.11.0903.332")) flag++;
if (hpux_check_patch(app:"SW-DIST.SD-TCH-H-MSG", version:"B.11.11.0909.340")) flag++;
