...
# extracted from HP patch PHNE_28449. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_28449 : s700_800 11.00 Bind 4.9.7 components");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_28449 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_28449 applies to a different OS release.");
}

patches = make_list("PHNE_28449");
