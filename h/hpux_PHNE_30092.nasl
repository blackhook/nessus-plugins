...
# extracted from HP patch PHNE_30092. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_30092 : HP-UX Running RPC, Remote Denial of Service (DoS) (HPSBUX01020 SSRT2384 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 RPC commands and daemons cumulative patch : 
...
unauthorized remote user to create a denial of service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_30092 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_30092 applies to a different OS release.");
}

patches = make_list("PHKL_31500", "PHNE_30092");
