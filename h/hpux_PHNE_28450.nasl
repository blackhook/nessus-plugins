...
# extracted from HP patch PHNE_28450. The text itself is
...
if (description)
{
  ...
  script_xref(name:"HP", value:"emr_na-c00957868");
  script_xref(name:"HP", value:"emr_na-c00957990");
  script_xref(name:"HP", value:"HPSBUX00209");
  script_xref(name:"HP", value:"HPSBUX00233");
  script_xref(name:"HP", value:"SSRT2316");
  script_xref(name:"HP", value:"SSRT2408");

  script_name(english:"HP-UX PHNE_28450 : s700_800 11.11 Bind 8.1.2 Patch");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  - Potential buffer overflows in DNS resolver libraries.
    (HPSBUX00233 SSRT2408)

  - Potential buffer overflows in DNS resolver libraries.
    (HPSBUX00209 SSRT2316)"
  );
  ...
  # http://h20000.www2.hp.com/bizsupport/TechSupport/Document.jsp?objectID=c00957868
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e3a5c9dd"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_28450 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_28450 applies to a different OS release.");
}

patches = make_list("PHNE_28450", "PHNE_30068", "PHNE_33766", "PHNE_36185");
