...
# extracted from HP patch PHCO_27344. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_27344 : HP-UX Shells, Local Increase of Privilege, Denial of Service (DoS) (HPSBUX00275 SSRT3618 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 sh-posix(1) cumulative patch : 
...
Shells improperly manage files during operations."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_27344 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_27344 applies to a different OS release.");
}

patches = make_list("PHCO_27344", "PHCO_28831", "PHCO_29768", "PHCO_31160", "PHCO_32565");
