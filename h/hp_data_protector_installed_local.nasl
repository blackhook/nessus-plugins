...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"0001-T-0609");
...
Windows host.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e3b76983");
...
register_install(
  app_name:app,
  vendor : 'HP',
  product : 'Storage Data Protector',
  path:path,
  version:version,
