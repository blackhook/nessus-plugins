...
# extracted from HP patch PHCO_28480. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_28480 : s700_800 11.00 cumulative 10.20 libc compatibility support");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 cumulative 10.20 libc compatibility support : 
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_28480 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_28480 applies to a different OS release.");
}

patches = make_list("PHCO_28480", "PHCO_31921");
