...
# extracted from HP patch PHSS_38747. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_38747 : HP-UX running WBEM Services, Remote Execution of Arbitrary Code, Gain Extended Privileges (HPSBMA02331 SSRT080000 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.11 HP WBEM Services A.02.00.11 : 
...
remotely to execute arbitrary code or to gain extended privileges."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_38747 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_38747 applies to a different OS release.");
}

patches = make_list("PHSS_38747");
