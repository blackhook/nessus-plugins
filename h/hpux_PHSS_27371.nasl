...
# extracted from HP patch PHSS_27371. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27371 : HP-UX Running Apache, Remote Denial of Service (DoS) or Elevation Privilege, or Execution of Arbitrary Code (HPSBUX00197 SSRT2332 rev.11)");
...
data chunks in Apache-based web servers."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27371 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_27371 applies to a different OS release.");
}

patches = make_list("PHSS_27371", "PHSS_27627", "PHSS_28098", "PHSS_28685", "PHSS_29545", "PHSS_29690", "PHSS_30160", "PHSS_30648", "PHSS_31828", "PHSS_32184", "PHSS_33396", "PHSS_34119", "PHSS_35107", "PHSS_35461", "PHSS_35556");
