...
exploit this to gain access to admin or root password information.");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c04790231
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33b8fc43");
...
(UCMDB) version 10.01 CUP12 / 10.11 CUP6 / 10.21.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-5440");
