...
# extracted from HP patch PHSS_25787. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_25787 : HP-UX running CDE dtspcd, Remote Unauthorized Access, Increased Privilege, Arbitrary Code Execution (HPSBUX00175 SSRT071388 rev.5)");
...
Buffer overflow in dtspcd."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_25787 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_25787 applies to a different OS release.");
}

patches = make_list("PHSS_25787", "PHSS_26490", "PHSS_27427", "PHSS_27869", "PHSS_28675", "PHSS_29734", "PHSS_30010", "PHSS_30668", "PHSS_32107", "PHSS_32539", "PHSS_35433");
