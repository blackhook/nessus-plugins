...
# extracted from HP patch PHNE_23274. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_23274 : HP-UX running BIND, Remote Denial of Service (DoS) (HPSBUX00144 SSRT071378 rev.2)");
...
following URL: http://www.isc.org/products/BIND/bind-security.html."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_23274 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_23274 applies to a different OS release.");
}

patches = make_list("PHNE_23274", "PHNE_28449");
