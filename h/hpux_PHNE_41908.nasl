...
# extracted from HP patch PHNE_41908. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_41908 : HP-UX Running XNTP, Remote Denial of Service (DoS) (HPSBUX02639 SSRT100293 rev.1)");
...
Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_41908 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_41908 applies to a different OS release.");
}

patches = make_list("PHNE_41908", "PHNE_44236");
