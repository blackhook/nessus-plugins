...
# extracted from HP patch PHSS_29214. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_29214 : HP-UX running CDE, Remote Unauthorized Privileged Access, Execution of Arbitrary Code (HPSBUX00263 SSRT2373 rev.3)");
...
Potential security vulnerabilities in CDE libraries and programs."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_29214 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_29214 applies to a different OS release.");
}

patches = make_list("PHSS_29214", "PHSS_30167", "PHSS_30807");
