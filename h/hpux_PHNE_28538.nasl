...
Certain network traffic can cause programs to fail."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_28538 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_28538 applies to a different OS release.");
}

patches = make_list("PHNE_28538", "PHNE_29473", "PHNE_32041", "PHNE_33395", "PHNE_35729");
