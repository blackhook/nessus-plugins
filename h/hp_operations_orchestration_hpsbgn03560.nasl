...
the target host.");
  # https://support.hpe.com/hpsc/doc/public/display?calledBy=&docId=emr_na-c05050545
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?140fc076");
...
"Upgrade to HP Operations Orchestration version 10.51 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1997");
