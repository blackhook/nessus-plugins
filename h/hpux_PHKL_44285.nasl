...
# extracted from HP patch PHKL_44285. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_44285 : s700_800 11.23 exec(2) cumulative patch");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 exec(2) cumulative patch : 
...
CVE-2015-2132 (SSRT102037)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_44285 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_44285 applies to a different OS release.");
}

patches = make_list("PHKL_44285");
