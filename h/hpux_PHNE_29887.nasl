...
# extracted from HP patch PHNE_29887. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_29887 : HP-UX Running ARPA Transport, Local Denial of Service (DoS) (HPSBUX01054 SSRT3552 rev.2)");
...
of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_29887 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_29887 applies to a different OS release.");
}

patches = make_list("PHNE_29887", "PHNE_31247", "PHNE_33159", "PHNE_33628", "PHNE_34135", "PHNE_34672", "PHNE_35183", "PHNE_35351", "PHNE_36125", "PHNE_37671", "PHNE_37898", "PHNE_38678", "PHNE_39386", "PHNE_42029");
