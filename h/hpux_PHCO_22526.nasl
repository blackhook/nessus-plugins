...
# extracted from HP patch PHCO_22526. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_22526 : HPSBUX0102-143 Sec. Vulnerability in SD-UX (Rev.02)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.0 Software Distributor (SD) Cumulative Patch : 

Security defect in Software Distributor SD-UX."
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_22526 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_22526 applies to a different OS release.");
}

patches = make_list("PHCO_22526", "PHCO_23966", "PHCO_25875", "PHCO_27672", "PHCO_28847", "PHCO_34568");
