...
# extracted from HP patch PHKL_22932. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_22932 : HP-UX Filesystem Deadlock, Local Denial of Service (DoS) (HPSBUX00178 SSRT071361 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 ufs(hfs) deadlock causes the system hang : 
...
filesystem deadlock causes the system hang."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_22932 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_22932 applies to a different OS release.");
}

patches = make_list("PHKL_22932", "PHKL_29851");
