...
"Probe,IDDS,PM,VM,PA-8700,AIO,T600,FS,Hang");
 script_set_attribute(attribute:"see_also", value:"ftp://ftp.itrc.hp.com//patches_with_warnings/hp-ux_patches/s700_800/11.X/PHKL_27759");
 script_set_attribute(attribute:"solution", value:"Apply the PHKL_27759 patch.");
