...
# extracted from HP patch PHSS_29892. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_29892 : HPSBUX0310-284 SSRT3622 rev.3 HP-UX Apache HTTP Server Denial of Service,unauthorized access");
...
http://www.openssl.org/news/secadv/20030930.txt."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_29892 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_29892 applies to a different OS release.");
}

patches = make_list("PHSS_29892", "PHSS_30159", "PHSS_30647", "PHSS_31827", "PHSS_32141", "PHSS_34171", "PHSS_35104", "PHSS_35306", "PHSS_35458", "PHSS_35553");
