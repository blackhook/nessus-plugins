...
# extracted from HP patch PHSS_36902. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_36902 : s700_800 11.X OV NNM7.51 IA-64 Intermediate Patch 17");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_36902 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_36902 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_36902", "PHSS_37274");
