...
# extracted from HP patch PHSS_42866. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_42866 : HP-UX running DCE, Remote Denial of Service (DoS) (HPSBUX02758 SSRT100774 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 HP DCE/9000 1.9 Server cumulative patch : 
...
Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_42866 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_42866 applies to a different OS release.");
}

patches = make_list("PHSS_42866");
...
flag = 0;
if (hpux_check_patch(app:"DCE-SEC-Server.SEC-SERVER", version:"B.11.23.11")) flag++;
