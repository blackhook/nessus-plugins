...
# extracted from HP patch PHCO_34533. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_34533 : HPSBUX02128 SSRT5996 - rev.1 HP-UX mkdir(1) Local Unauthorized Access");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 mkdir(1) cumulative patch : 
...
access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_34533 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_34533 applies to a different OS release.");
}

patches = make_list("PHCO_34533");
