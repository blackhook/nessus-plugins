...
# extracted from HP patch PHSS_28174. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_28174 : HP-UX Running rpc.ttdbserver, Remote Denial of Service(DoS), Privilege Increase (HPSBUX00199 SSRT071348 rev.6)");
...
Buffer overflow in rpc.ttdbserver."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_28174 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_28174 applies to a different OS release.");
}

patches = make_list("PHSS_28174", "PHSS_29214", "PHSS_30167", "PHSS_30807");
