...
# extracted from HP patch PHCO_32149. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_32149 : HP-UX passwd(1) Local Denial of Service (DoS) (HPSBUX02103 SSRT5953 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 passwd(1) cumulative patch : 
...
Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_32149 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_32149 applies to a different OS release.");
}

patches = make_list("PHCO_32149", "PHCO_35849", "PHCO_36426", "PHCO_39768");
