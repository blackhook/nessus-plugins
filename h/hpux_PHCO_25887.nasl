...
# extracted from HP patch PHCO_25887. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_25887 : HP-UX running SD, Local Unauthorized Access, Denial of Service (DoS) (HPSBUX00194 SSRT071391 rev.2)");
...
not normally readable by user."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_25887 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_25887 applies to a different OS release.");
}

patches = make_list("PHCO_25887", "PHCO_27671", "PHCO_28848", "PHCO_32116", "PHCO_33822", "PHCO_34295", "PHCO_34539", "PHCO_35587", "PHCO_38226", "PHCO_41200");
