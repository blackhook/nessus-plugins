...
"chmod(1M) cumulative patch");
 script_set_attribute(attribute:"see_also", value:"ftp://ftp.itrc.hp.com//hp-ux_patches/11.X/PHCO_38482");
 script_set_attribute(attribute:"solution", value:"Apply the PHCO_38482 patch.");
