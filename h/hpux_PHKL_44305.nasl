...
# extracted from HP patch PHKL_44305. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_44305 : s700_800 11.11 exec(2) patch");
...
CVE-2015-2132 (SSRT102037)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_44305 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_44305 applies to a different OS release.");
}

patches = make_list("PHKL_44305");
