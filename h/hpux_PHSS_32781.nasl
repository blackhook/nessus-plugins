...
# extracted from HP patch PHSS_32781. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32781 : HP OpenView Network Node Manager (OV NNM), Remote Unauthorized Privileged Code Execution, Denial of Service (DoS) (HPSBMA01140 SSRT4795, SSRT4797, SSRT4864 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV NNM6.4x/ET2.0x Patch for Feb-05 : 
...
cause a Denial of Service(DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32781 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32781 applies to a different OS release.");
}

patches = make_list("PHSS_32781", "PHSS_33585", "PHSS_34202", "PHSS_34949", "PHSS_35830", "PHSS_37141", "PHSS_37757");
