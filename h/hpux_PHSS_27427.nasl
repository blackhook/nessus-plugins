...
# extracted from HP patch PHSS_27427. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27427 : HP-UX Running rpc.ttdbserver, Remote Denial of Service(DoS), Privilege Increase (HPSBUX00199 SSRT071348 rev.6)");
...
Buffer overflow in rpc.ttdbserver."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27427 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_27427 applies to a different OS release.");
}

patches = make_list("PHSS_27427", "PHSS_27869", "PHSS_28675", "PHSS_29734", "PHSS_30010", "PHSS_30668", "PHSS_32107", "PHSS_32539", "PHSS_35433");
