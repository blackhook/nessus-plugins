...
# extracted from HP patch PHSS_27258. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27258 : HP-UX with PHSS_25710, PHSS_26394, or PHSS_26396, Remote Denial of Service (DoS) (HPSBUX00196 SSRT071360 rev.2)");
...
Internal data can be modified causing rpcd or dced to crash."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27258 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_27258 applies to a different OS release.");
}

patches = make_list("PHSS_27258", "PHSS_28386", "PHSS_29964", "PHSS_33949", "PHSS_35467", "PHSS_36004", "PHSS_38183", "PHSS_42852");
