...
# extracted from HP patch PHCO_33215. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_33215 : s700_800 11.11 libpam_unix cumulative patch");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_33215 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_33215 applies to a different OS release.");
}

patches = make_list("PHCO_33215", "PHCO_34214", "PHCO_35250", "PHCO_39815", "PHCO_40837");
