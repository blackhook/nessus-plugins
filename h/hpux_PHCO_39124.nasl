...
# extracted from HP patch PHCO_39124. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_39124 : HP-UX Running VERITAS File System (VRTSvxfs) or VERITAS Oracle Disk Manager (VRTSodm), Local Escalation of Privilege (HPSBUX02409 SSRT080171 rev.3)");
...
Oracle (SMO)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_39124 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_39124 applies to a different OS release.");
}

patches = make_list("PHCO_39124", "PHCO_39659", "PHCO_41878");
...
flag = 0;
if (hpux_check_patch(app:"VRTSvxfs.VXFS-ENG-A-MAN", version:"3.5-ga15")) flag++;
if (hpux_check_patch(app:"VRTSvxfs.VXFS-RUN", version:"3.5-ga15")) flag++;
