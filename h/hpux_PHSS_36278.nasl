...
# extracted from HP patch PHSS_36278. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_36278 : HP OpenView Operations (OVO) Agents Running Shared Trace Service, Remote Arbitrary Code Execution (HPSBMA02239 SSRT061260 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV OVO8.X EventAction Linux A.08.17 : 
...
vulnerability could be remotely exploited to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_36278 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_36278 applies to a different OS release.");
}

patches = make_list("OALIN_00001", "PHSS_36278", "PHSS_37522", "PHSS_37680", "PHSS_38512", "PHSS_39502");
...
if (hpux_check_patch(app:"OVO-CLT.OVO-LIN-CLT", version:"A.08.10.160")) flag++;
