...
# extracted from HP patch PHSS_31823. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31823 : s700_800 11.04 Virtualvault 4.7 IWS update");
...
2.8.19 that may allow execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31823 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31823 applies to a different OS release.");
}

patches = make_list("PHSS_31823", "PHSS_32140", "PHSS_34169", "PHSS_35106", "PHSS_35308", "PHSS_35460", "PHSS_35555");
