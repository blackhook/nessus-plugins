...
# extracted from HP patch PHSS_30405. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30405 : s700_800 11.04 Virtualvault 4.6 mod_jk update");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 Virtualvault 4.6 mod_jk update : 
...
gain unauthorized access to information."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30405 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30405 applies to a different OS release.");
}

patches = make_list("PHSS_30405", "PHSS_30645", "PHSS_30947", "PHSS_31057", "PHSS_31826", "PHSS_32183", "PHSS_33397", "PHSS_34120", "PHSS_35108", "PHSS_35462", "PHSS_35557");
