...
# extracted from HP patch PHCO_33219. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_33219 : HP-UX passwd(1) Local Denial of Service (DoS) (HPSBUX02103 SSRT5953 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 /sbin/passwd cumulative patch : 
...
Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_33219 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_33219 applies to a different OS release.");
}

patches = make_list("PHCO_33219");
