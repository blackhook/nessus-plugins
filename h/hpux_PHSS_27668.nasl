...
# extracted from HP patch PHSS_27668. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27668 : HP-UX Running Apache, Remote Denial of Service (DoS) or Elevation Privilege, or Execution of Arbitrary Code (HPSBUX00197 SSRT2332 rev.11)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV SIP3.0 SIP3.0: web server update : 
...
data chunks in Apache-based web servers."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27668 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_27668 applies to a different OS release.");
}

patches = make_list("PHSS_27668");
