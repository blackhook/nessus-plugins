...
# extracted from HP patch PHSS_31829. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31829 : s700_800 11.04 Webproxy server 2.0 update");
...
2.8.19 that may allow execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31829 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31829 applies to a different OS release.");
}

patches = make_list("PHSS_31829", "PHSS_32363", "PHSS_33788", "PHSS_34204", "PHSS_35110");
