...
"VM core(4) related changes");
 script_set_attribute(attribute:"see_also", value:"ftp://ftp.itrc.hp.com//hp-ux_patches/s700_800/11.X/PHKL_32204");
 script_set_attribute(attribute:"solution", value:"Apply the PHKL_32204 patch.");
