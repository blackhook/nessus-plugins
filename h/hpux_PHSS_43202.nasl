...
# extracted from HP patch PHSS_43202. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_43202 : s700_800 11.23 X Font Server Patch");
...
access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_43202 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_43202 applies to a different OS release.");
}

patches = make_list("PHSS_43202");
