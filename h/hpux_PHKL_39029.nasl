...
# extracted from HP patch PHKL_39029. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_39029 : HP-UX Running VERITAS File System (VRTSvxfs) or VERITAS Oracle Disk Manager (VRTSodm), Local Escalation of Privilege (HPSBUX02409 SSRT080171 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 VRTS 4.1 MP2RP2 VRTSodm Kernel Patch : 
...
Oracle (SMO)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_39029 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_39029 applies to a different OS release.");
}

patches = make_list("PHKL_39029", "PHKL_40947", "PHKL_42268", "PHKL_42645", "PHKL_44155");
...
flag = 0;
if (hpux_check_patch(app:"VRTSodm.ODM-KRN", version:"4.1")) flag++;
if (hpux_check_patch(app:"VRTSodm.ODM-MAN", version:"4.1")) flag++;
if (hpux_check_patch(app:"VRTSodm.ODM-RUN", version:"4.1")) flag++;
