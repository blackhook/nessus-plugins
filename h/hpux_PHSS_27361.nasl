...
# extracted from HP patch PHSS_27361. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27361 : HP-UX Running Apache, Remote Denial of Service (DoS) or Elevation Privilege, or Execution of Arbitrary Code (HPSBUX00197 SSRT2332 rev.11)");
...
data chunks in Apache-based web servers."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27361 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_27361 applies to a different OS release.");
}

patches = make_list("PHSS_27361", "PHSS_27476", "PHSS_27988", "PHSS_28099", "PHSS_28686", "PHSS_29546", "PHSS_29691", "PHSS_30154", "PHSS_30405", "PHSS_30645", "PHSS_30947", "PHSS_31057", "PHSS_31826", "PHSS_32183", "PHSS_33397", "PHSS_34120", "PHSS_35108", "PHSS_35462", "PHSS_35557");
