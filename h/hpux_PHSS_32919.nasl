...
# extracted from HP patch PHSS_32919. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32919 : HP OpenView Event Correlation Services (OV ECS), Remote Unauthorized Privileged Code Execution, Denial of Service (DoS) (HPSBMA01141 SSRT4796, SSRT4873 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 OV ECS3.33 /3.32 Patch Mar'05 : 
...
or to cause a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32919 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32919 applies to a different OS release.");
}

patches = make_list("PHSS_32919", "PHSS_33539", "PHSS_34635", "PHSS_37281");
