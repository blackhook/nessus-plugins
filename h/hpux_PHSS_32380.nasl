...
# extracted from HP patch PHSS_32380. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32380 : HP OpenView Operations, Remote Unauthorized Access and Denial of Service (DoS) (HPSBMA02149 SSRT050968 rev.1)");
...
to allow unauthorized access or to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32380 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32380 applies to a different OS release.");
}

patches = make_list("PHSS_32380", "PHSS_35836");
