...
# extracted from HP patch PHCO_34814. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_34814 : HP-UX Running Software Distributor Local Elevation of Privilege (HPSBUX02114 SSRT061115 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) Software Distributor (SD) Cuml Patch : 
...
by a local authorized user to gain elevated privileges."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_34814 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_34814 applies to a different OS release.");
}

patches = make_list("PHCO_34814");
