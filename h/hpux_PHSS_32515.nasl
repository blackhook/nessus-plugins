...
# extracted from HP patch PHSS_32515. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32515 : HP OpenView Network Node Manager (OV NNM), Remote Denial of Service (DoS) (HPSBMA01125 SSRT4829 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 OV NNM7.50 Patch for Dec-04 : 
...
by an unauthorized user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32515 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32515 applies to a different OS release.");
}

patches = make_list("PHSS_32515", "PHSS_32693", "PHSS_32817", "PHSS_33073", "PHSS_33223", "PHSS_33345", "PHSS_33460", "PHSS_33663", "PHSS_34099", "PHSS_34871");
