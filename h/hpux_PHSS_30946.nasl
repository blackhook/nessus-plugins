...
# extracted from HP patch PHSS_30946. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30946 : s700_800 11.04 Virtualvault 4.6 IWS update");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30946 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30946 applies to a different OS release.");
}

patches = make_list("PHSS_30946", "PHSS_31825", "PHSS_32139", "PHSS_32206", "PHSS_34170", "PHSS_35105", "PHSS_35307", "PHSS_35459", "PHSS_35554");
