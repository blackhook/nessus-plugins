...
# extracted from HP patch PHSS_23797. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_23797 : HP-UX running CDE, Local Increased Privilege, Denial of Service (DoS) (HPSBUX00151 SSRT071382 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 CDE Runtime APR2001 Periodic Patch : 
...
Buffer overflows and other vulnerabilities in CDE for HP-UX."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_23797 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_23797 applies to a different OS release.");
}

patches = make_list("PHSS_23797", "PHSS_23800", "PHSS_25138", "PHSS_25194", "PHSS_25787", "PHSS_26490", "PHSS_27427", "PHSS_27869", "PHSS_28675", "PHSS_29734", "PHSS_30010", "PHSS_30668", "PHSS_32107", "PHSS_32539", "PHSS_35433");
