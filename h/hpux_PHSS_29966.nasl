...
# extracted from HP patch PHSS_29966. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_29966 : HP-UX Running DCE, Remote Denial of Service (DoS) (HPSBUX00299 SSRT3660 rev.4)");
...
Potential security vulnerability in DCE."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_29966 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_29966 applies to a different OS release.");
}

patches = make_list("PHSS_29966", "PHSS_30771", "PHSS_33321", "PHSS_35466", "PHSS_36005", "PHSS_38258", "PHSS_42853");
