...
# extracted from HP patch PHSS_32046. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32046 : HP OpenView Network Node Manager (OV NNM), Remote Denial of Service (DoS) (HPSBMA01125 SSRT4829 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV NNM6.2 Patch for Sept-04 : 
...
by an unauthorized user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32046 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32046 applies to a different OS release.");
}

patches = make_list("PHSS_32046", "PHSS_32690", "PHSS_33287", "PHSS_34008", "PHSS_35113");
