...
# extracted from HP patch PHNE_32449. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_32449 : HP-UX Running tftpd, Remote Denial of Service (HPSBUX00266 SSRT3487 rev.6)");
...
Potential Security Vulnerability in tftpd."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_32449 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_32449 applies to a different OS release.");
}

patches = make_list("PHNE_32449", "PHNE_32825", "PHNE_36217", "PHNE_39700");
