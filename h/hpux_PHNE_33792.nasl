...
# extracted from HP patch PHNE_33792. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_33792 : s700_800 11.23 r-commands cumulative mega-patch");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 r-commands cumulative mega-patch : 
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_33792 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_33792 applies to a different OS release.");
}

patches = make_list("PHNE_33792", "PHNE_34150", "PHNE_40889");
