...
# extracted from HP patch PHSS_41174. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_41174 : HP-UX Running CDE Calendar Manager, Remote Execution of Arbitrary Code (HPSBUX02628 SSRT090183 rev.1)");
...
ZDI-CAN-561."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_41174 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_41174 applies to a different OS release.");
}

patches = make_list("PHSS_41174");
