...
# extracted from HP patch PHKL_39130. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_39130 : HP-UX Running VERITAS File System (VRTSvxfs) or VERITAS Oracle Disk Manager (VRTSodm), Local Escalation of Privilege (HPSBUX02409 SSRT080171 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.31 VRTS 5.0 GARP2 VRTSodm Kernel Patch : 
...
Oracle (SMO)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_39130 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_39130 applies to a different OS release.");
}

patches = make_list("PHKL_39130", "PHKL_39471", "PHKL_41797", "PHKL_43683", "PHKL_44460");
...
flag = 0;
if (hpux_check_patch(app:"VRTSodm.ODM-KRN", version:"5.0.31.0")) flag++;
if (hpux_check_patch(app:"VRTSodm.ODM-MAN", version:"5.0.31.0")) flag++;
if (hpux_check_patch(app:"VRTSodm.ODM-RUN", version:"5.0.31.0")) flag++;
