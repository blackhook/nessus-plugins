...
# extracted from HP patch PHNE_34671. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_34671 : HP-UX Running ARPA Transport Software, Local Denial of Service (DoS) (HPSBUX02151 SSRT051021 rev.1)");
...
by a local, authenticated user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_34671 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_34671 applies to a different OS release.");
}

patches = make_list("PHNE_34671", "PHNE_35182", "PHNE_35765", "PHNE_35766", "PHNE_37395", "PHNE_37670", "PHNE_37897", "PHNE_38679", "PHNE_39387", "PHNE_41436", "PHNE_42094", "PHNE_43215");
