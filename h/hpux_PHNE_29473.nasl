...
# extracted from HP patch PHNE_29473. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_29473 : HP-UX Running ARPA Transport, Local Denial of Service (DoS) (HPSBUX01054 SSRT3552 rev.2)");
...
of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_29473 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_29473 applies to a different OS release.");
}

patches = make_list("PHNE_29473", "PHNE_32041", "PHNE_33395", "PHNE_35729");
