...
{
 r = w[1]; headers = r;
 if ( pgrep(pattern:"^Keep-Alive:", string:r) ||
      pgrep(pattern:"^Connection: Keep-Alive", string:r) ) ka = "yes";
 else ka = "no";
}

report = '\n';
report += 'Response Code : ' + w[0] + '\n';
