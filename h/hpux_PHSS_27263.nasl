...
# extracted from HP patch PHSS_27263. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27263 : HPSBUX0209-217 Sec. Vulnerability in Apache OpenSSL (rev.2)");
...
CA-2002-21 and CVE-2002-0658."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27263 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_27263 applies to a different OS release.");
}

patches = make_list("PHSS_27263", "PHSS_29057", "PHSS_29886", "PHSS_30253", "PHSS_30644", "PHSS_34567");
