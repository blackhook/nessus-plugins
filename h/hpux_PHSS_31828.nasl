...
# extracted from HP patch PHSS_31828. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31828 : s700_800 11.04 Virtualvault 4.5 OWS update");
...
2.8.19 that may allow execution of arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31828 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31828 applies to a different OS release.");
}

patches = make_list("PHSS_31828", "PHSS_32184", "PHSS_33396", "PHSS_34119", "PHSS_35107", "PHSS_35461", "PHSS_35556");
