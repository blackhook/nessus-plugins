...
# extracted from HP patch PHSS_28675. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_28675 : s700_800 11.00 CDE Runtime Periodic Patch");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_28675 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_28675 applies to a different OS release.");
}

patches = make_list("PHSS_28675", "PHSS_29734", "PHSS_30010", "PHSS_30668", "PHSS_32107", "PHSS_32539", "PHSS_35433");
