...
# extracted from HP patch PHCO_39104. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_39104 : HP-UX Running VERITAS File System (VRTSvxfs) or VERITAS Oracle Disk Manager (VRTSodm), Local Escalation of Privilege (HPSBUX02409 SSRT080171 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 VRTS 5.0 MP1RP4 VRTSfsman Command Patch : 
...
Oracle (SMO)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_39104 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_39104 applies to a different OS release.");
}

patches = make_list("PHCO_38836", "PHCO_39104", "PHCO_40589", "PHCO_43113", "PHCO_43391", "PHCO_43748");
...
flag = 0;
if (hpux_check_patch(app:"VRTSfsman.VXFS-ENG-A-MAN", version:"5.0.01.02")) flag++;
if (hpux_check_patch(app:"VRTSfsman.VXFS-ENG-A-MAN", version:"5.0.01.05")) flag++;
