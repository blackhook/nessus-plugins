...
# extracted from HP patch PHSS_30668. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30668 : HP-UX running CDE dtlogin, Remote Unauthorized Privileged Access, Denial of Service (DoS) (HPSBUX01038 SSRT4721 rev.2)");
...
or a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30668 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30668 applies to a different OS release.");
}

patches = make_list("PHSS_30668", "PHSS_32107", "PHSS_32539", "PHSS_35433");
