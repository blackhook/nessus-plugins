...
# extracted from HP patch PHSS_37335. The text itself is
...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"2007-T-0033-S");
  script_xref(name:"HP", value:"SSRT061260");

  script_name(english:"HP-UX PHSS_37335 : HP OpenView Operations (OVO) Agents Running Shared Trace Service, Remote Arbitrary Code Execution (HPSBMA02239 SSRT061260 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV OVO8.X Core Agt Windows A.08.17.3 : 
...
vulnerability could be remotely exploited to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_37335 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_37335 applies to a different OS release.");
}

patches = make_list("OAWIN_00001", "PHSS_37335", "PHSS_38332", "PHSS_38514", "PHSS_39503", "PHSS_39505");
...
if (hpux_check_patch(app:"OVO-CLT.OVO-WIN-CLT", version:"A.08.10.160")) flag++;
