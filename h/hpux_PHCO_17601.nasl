...
# extracted from HP patch PHCO_17601. The text itself is
...
if (description)
{
  ...
  script_cve_id("CVE-1999-0432");
  script_xref(name:"HP", value:"HPSBUX9903-094");

  script_name(english:"HP-UX PHCO_17601 : s700_800 11.00 libc cumulative patch");
...
Security Vulnerability during ftp operations."
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_17601 or subsequent."
  );
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"1999/03/19");
...
{
  exit(0, "The host is not affected since PHCO_17601 applies to a different OS release.");
}

patches = make_list("PHCO_17601", "PHCO_18103", "PHCO_18227", "PHCO_19090", "PHCO_19391", "PHCO_19491", "PHCO_19691", "PHCO_20555", "PHCO_20765", "PHCO_22076", "PHCO_22314", "PHCO_22923", "PHCO_23770", "PHCO_24148", "PHCO_24723", "PHCO_25707", "PHCO_25976", "PHCO_27608", "PHCO_27731", "PHCO_27774", "PHCO_28425", "PHCO_29284", "PHCO_29633", "PHCO_29956", "PHCO_32448", "PHCO_33609");
