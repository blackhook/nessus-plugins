...
Horde Project for managing email filter rules.");
  script_set_attribute(attribute:"see_also", value:"https://www.horde.org/apps/ingo/");
...
"n/a");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:horde:ingo");
