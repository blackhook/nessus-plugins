...
# extracted from HP patch PHSS_32960. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_32960 : HP-UX Running Xserver Local Execution of Arbitrary Code, Privilege Elevation (HPSBUX02137 SSRT051024 rev.1)");
...
to execute arbitrary code with the privileges of the Xserver."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_32960 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_32960 applies to a different OS release.");
}

patches = make_list("PHSS_32960", "PHSS_35253", "PHSS_35966", "PHSS_36452", "PHSS_37971", "PHSS_37972", "PHSS_39257", "PHSS_40810", "PHSS_41260");
