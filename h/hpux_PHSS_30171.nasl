...
# extracted from HP patch PHSS_30171. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30171 : HP-UX XFree86, Remote Unauthorized Privileged Access, Execution of Arbitrary Code (HPSBUX01018 SSRT4692 rev.2)");
...
unauthorized privileged access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30171 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30171 applies to a different OS release.");
}

patches = make_list("PHSS_30171", "PHSS_30502", "PHSS_30505", "PHSS_30872", "PHSS_31252", "PHSS_32953", "PHSS_32960", "PHSS_35253", "PHSS_35966", "PHSS_36452", "PHSS_37971", "PHSS_37972", "PHSS_39257", "PHSS_40810", "PHSS_41260");
