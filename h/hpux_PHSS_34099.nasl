...
# extracted from HP patch PHSS_34099. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_34099 : s700_800 11.23 OV NNM7.50 IA-64 Consolidated Patch 3");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 OV NNM7.50 IA-64 Consolidated Patch 3 : 
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_34099 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_34099 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_34099", "PHSS_34871");
