...
# extracted from HP patch PHSS_37336. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_37336 : HP OpenView Operations (OVO) Agents Running Shared Trace Service, Remote Arbitrary Code Execution (HPSBMA02239 SSRT061260 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV OVO8.X Core Agt AIX A.08.17.3 : 
...
vulnerability could be remotely exploited to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_37336 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_37336 applies to a different OS release.");
}

patches = make_list("OAAIX_00001", "PHSS_37336", "PHSS_37681", "PHSS_38513", "PHSS_39504");
...
flag = 0;
if (hpux_check_patch(app:"OVO-CLT.OVO-AIX-CLT", version:"A.08.10.160")) flag++;
