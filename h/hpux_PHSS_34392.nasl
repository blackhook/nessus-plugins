...
# extracted from HP patch PHSS_34392. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_34392 : HP-UX Running Xserver, Remote Execution of Arbitrary Code (HPSBUX02381 SSRT080083 rev.2)");
...
execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_34392 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_34392 applies to a different OS release.");
}

patches = make_list("PHSS_34392");
