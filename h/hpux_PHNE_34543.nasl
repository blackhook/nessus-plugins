...
# extracted from HP patch PHNE_34543. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_34543 : HP-UX Running wu-ftpd Remote Denial of Service (DoS) (HPSBUX02110 SSRT061110 rev.1)");
...
remote user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_34543 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_34543 applies to a different OS release.");
}

patches = make_list("PHNE_34543");
