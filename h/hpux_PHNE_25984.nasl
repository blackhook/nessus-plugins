...
# extracted from HP patch PHNE_25984. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_25984 : HP-UX running sendmail(1M), Remote Unauthorized Access (HPSBUX00179 SSRT071387 rev.3)");
...
However, HP sendmail(1m) release 8.11.1 does not exhibit this problem."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_25984 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_25984 applies to a different OS release.");
}

patches = make_list("PHNE_25984", "PHNE_29526", "PHNE_30224", "PHNE_34927", "PHNE_35314");
