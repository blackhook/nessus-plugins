...
# extracted from HP patch PHNE_29785. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_29785 : HP-UX Running rpc.ypupdated, Remote Unauthorized Access (HPSBUX01002 SSRT4688 rev.2)");
...
unauthorized access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_29785 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_29785 applies to a different OS release.");
}

patches = make_list("PHNE_29785", "PHNE_29882", "PHNE_30377", "PHNE_30660", "PHNE_31096");
