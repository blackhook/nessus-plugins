...
# extracted from HP patch PHSS_29894. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_29894 : s700_800 11.04 Webproxy server 2.0 update");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_29894 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_29894 applies to a different OS release.");
}

patches = make_list("PHSS_29894", "PHSS_30650", "PHSS_30949", "PHSS_31829", "PHSS_32363", "PHSS_33788", "PHSS_34204", "PHSS_35110");
