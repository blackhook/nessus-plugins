...
# extracted from HP patch PHSS_38782. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_38782 : HP OpenView Network Node Manager (OV NNM), Remote Execution of Arbitrary Code, Unauthorized Access to Data (HPSBMA02406 SSRT080100 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV NNM7.53 PA-RISC Intermediate Patch 21 : 
...
unauthorized access to data."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_38782 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_38782 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_38782", "PHSS_39245", "PHSS_39639", "PHSS_39944", "PHSS_40374", "PHSS_40707", "PHSS_41242", "PHSS_41606", "PHSS_41857", "PHSS_42232", "PHSS_43046", "PHSS_43353");
