...
# extracted from HP patch PHNE_39873. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_39873 : HP-UX Running XNTP, Remote Execution of Arbitrary Code (HPSBUX02437 SSRT090038 rev.2)");
...
arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_39873 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_39873 applies to a different OS release.");
}

patches = make_list("PHNE_39873", "PHNE_41177");
