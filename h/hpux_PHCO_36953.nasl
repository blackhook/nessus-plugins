...
# extracted from HP patch PHCO_36953. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_36953 : HP-UX Running useradd(1M), Local Unauthorized Access (HPSBUX02335 SSRT071454 rev.2)");
...
to allow unauthorized access to directories or files."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_36953 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_36953 applies to a different OS release.");
}

patches = make_list("PHCO_36953", "PHCO_38159", "PHCO_38250", "PHCO_38547", "PHCO_41781", "PHCO_43045");
