...
# extracted from HP patch PHSS_25788. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_25788 : HP-UX running CDE dtspcd, Remote Unauthorized Access, Increased Privilege, Arbitrary Code Execution (HPSBUX00175 SSRT071388 rev.5)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.11 CDE Base DEC2001 Periodic Patch : 
...
Buffer overflow in dtspcd."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_25788 or subsequent."
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2001/12/18");
  script_set_attribute(attribute:"patch_publication_date", value:"2001/12/18");
...
{
  exit(0, "The host is not affected since PHSS_25788 applies to a different OS release.");
}

patches = make_list("PHSS_25788", "PHSS_26492", "PHSS_27428", "PHSS_27872", "PHSS_28676", "PHSS_29735", "PHSS_30011", "PHSS_30788", "PHSS_32110", "PHSS_33325", "PHSS_35249", "PHSS_36394", "PHSS_43518");
