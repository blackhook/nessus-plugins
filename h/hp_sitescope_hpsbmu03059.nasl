...
by an authentication bypass vulnerability having unspecified impact.");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c04355129
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?795e1635");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/532631/30/0/threaded");
...
11.24 with Cumulative Fixes SSRT101473 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-2614");
