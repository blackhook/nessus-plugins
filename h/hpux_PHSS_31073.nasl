...
# extracted from HP patch PHSS_31073. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31073 : HP-UX Running Serviceguard, Remote Increase in Privilege (HPSBUX01080 SSRT3526 rev.2)");
...
unauthorized privileges."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31073 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31073 applies to a different OS release.");
}

patches = make_list("PHSS_31073", "PHSS_31077", "PHSS_32732", "PHSS_32734");
