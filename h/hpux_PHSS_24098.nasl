...
# extracted from HP patch PHSS_24098. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_24098 : HP-UX running CDE, Local Increased Privilege, Denial of Service (DoS) (HPSBUX00151 SSRT071382 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) CDE Runtime APR2001 Periodic Patch : 
...
Buffer overflows and other vulnerabilities in CDE for HP-UX."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_24098 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_24098 applies to a different OS release.");
}

patches = make_list("PHSS_24098", "PHSS_25420", "PHSS_26030", "PHSS_28174", "PHSS_29214", "PHSS_30167", "PHSS_30807");
