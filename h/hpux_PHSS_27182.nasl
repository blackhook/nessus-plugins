...
# extracted from HP patch PHSS_27182. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_27182 : HP-UX, HP Jetdirect, HP Procurve Switches, HP OpenView Network Node Manager (NNM), OpenView Distributed Management (DM), HP TopTools Remote Control Card Running SNMP, Remote Unauthorized Access, Denial of Service (DoS) (HPSBUX00184 SSRT071347 rev.17)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV EMANATE14.2 snmpdm - subagent handling : 
...
Vulnerabilities in SNMP request and trap handling."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_27182 or subsequent."
  );
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2002/05/30");
...
{
  exit(0, "The host is not affected since PHSS_27182 applies to a different OS release.");
}

patches = make_list("PHSS_27182", "PHSS_27570", "PHSS_27850", "PHSS_27858", "PHSS_39886", "PHSS_41032", "PHSS_41556", "PHSS_42775", "PHSS_43156", "PHSS_43646", "PHSS_43817", "PHSS_44264");
