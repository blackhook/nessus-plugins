...
# extracted from HP patch PHNE_21155. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_21155 : HPSBUX0010-123 Sec. Vulnerability in net.init (rev.1)");
...
/sbin/init.d/net.init uses /tmp files."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_21155 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_21155 applies to a different OS release.");
}

patches = make_list("PHNE_21155", "PHNE_24084", "PHNE_26101", "PHNE_29453", "PHNE_30905", "PHNE_33427");
