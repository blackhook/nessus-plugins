...
# extracted from HP patch PHCO_34215. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_34215 : HP-UX in Trusted mode, Local Denial of Service (DoS) (HPSBUX02141 SSRT51153 rev.1)");
...
(DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_34215 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_34215 applies to a different OS release.");
}

patches = make_list("PHCO_34215", "PHCO_35251", "PHCO_35850", "PHCO_36759", "PHCO_37070", "PHCO_37076", "PHCO_39230", "PHCO_39711", "PHCO_40360", "PHCO_40836");
