...
# extracted from HP patch PHNE_27796. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_27796 : HP-UX DNS and Resolver Libraries, Remote Execution of Arbitrary Code, Denial of Service (DoS) (HPSBUX00209 SSRT2316 rev.17)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.11 libnss_dns DNS backend patch : 
...
Potential buffer overflows in DNS resolver libraries."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_27796 or subsequent."
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2003/01/07");
...
{
  exit(0, "The host is not affected since PHNE_27796 applies to a different OS release.");
}

patches = make_list("PHNE_27796", "PHNE_29445", "PHNE_35865");
