...
# extracted from HP patch PHNE_36192. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_36192 : HP-UX Running ftp, Remote Denial of Service (DoS) (HPSBUX02334 SSRT071403 rev.2)");
...
server application only."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_36192 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_36192 applies to a different OS release.");
}

patches = make_list("PHNE_36192", "PHNE_38458", "PHNE_40774");
