...
# extracted from HP patch PHSS_28682. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_28682 : s700_800 11.22 CDE Base Periodic Patch");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_28682 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_28682 applies to a different OS release.");
}

patches = make_list("PHSS_28682", "PHSS_29736", "PHSS_30012");
