...
# extracted from HP patch PHSS_35165. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_35165 : HP OpenView Storage Data Protector, Local Execution of Arbitrary Code (HPSBMA02190 SSRT071300 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 OV DP5.50 IA-64 patch - DA packet : 
...
code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_35165 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_35165 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_35165", "PHSS_36293", "PHSS_38285");
