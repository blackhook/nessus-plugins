...
# extracted from HP patch PHSS_42852. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_42852 : HP-UX running DCE, Remote Denial of Service (DoS) (HPSBUX02758 SSRT100774 rev.1)");
...
Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_42852 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_42852 applies to a different OS release.");
}

patches = make_list("PHSS_42852");
