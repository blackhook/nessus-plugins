...
if (description)
{
 ...
 script_name(english:"HP-UX Security Patch : PHSS_27479");
 script_summary(english:"Checks for patch in swlist output");

 script_set_attribute(attribute:"synopsis", value: 
"The remote HP-UX host is missing a security-related patch.");
 script_set_attribute(attribute:"description", value:
"OV NNM6.1 NNMDevKit/pmd fixes");
 script_set_attribute(attribute:"solution", value:"This patch has been superseded.");
