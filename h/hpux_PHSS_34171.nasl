...
# extracted from HP patch PHSS_34171. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_34171 : HP-UX VirtualVault running Apache 1.3.X Remote Unauthorized Access (HPSBUX02101 SSRT051128 rev.1)");
...
References: Apache HTTP Server version 1.3.34 announcement."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_34171 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_34171 applies to a different OS release.");
}

patches = make_list("PHSS_34171", "PHSS_35104", "PHSS_35306", "PHSS_35458", "PHSS_35553");
