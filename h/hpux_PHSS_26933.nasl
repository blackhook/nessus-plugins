...
# extracted from HP patch PHSS_26933. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_26933 : HP-UX, HP Jetdirect, HP Procurve Switches, HP OpenView Network Node Manager (NNM), OpenView Distributed Management (DM), HP TopTools Remote Control Card Running SNMP, Remote Unauthorized Access, Denial of Service (DoS) (HPSBUX00184 SSRT071347 rev.17)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV NNM6.2 snmpCollect fixes : 
...
Vulnerabilities in SNMP request and trap handling."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_26933 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_26933 applies to a different OS release.");
}

patches = make_list("PHSS_26933", "PHSS_27002", "PHSS_27014", "PHSS_27069", "PHSS_27125", "PHSS_27174", "PHSS_27184", "PHSS_27206", "PHSS_27300", "PHSS_27323", "PHSS_27333");
