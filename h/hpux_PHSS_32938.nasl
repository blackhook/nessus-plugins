...
"Xserver cumulative patch");
 script_set_attribute(attribute:"see_also", value:"ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32938");
 script_set_attribute(attribute:"solution", value:"Apply the PHSS_32938 patch.");
