...
# extracted from HP patch PHCO_27418. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_27418 : HP-UX Shells, Local Increase of Privilege, Denial of Service (DoS) (HPSBUX00275 SSRT3618 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 ksh(1) cumulative patch : 
...
Shells improperly manage files during operations."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_27418 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_27418 applies to a different OS release.");
}

patches = make_list("PHCO_27418");
