...
# extracted from HP patch PHSS_31058. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31058 : s700_800 11.04 Virtualvault 4.7 OWS update");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31058 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31058 applies to a different OS release.");
}

patches = make_list("PHSS_31058", "PHSS_31824", "PHSS_32182", "PHSS_33398", "PHSS_34121", "PHSS_35109", "PHSS_35463", "PHSS_35558");
