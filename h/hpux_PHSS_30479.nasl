...
# extracted from HP patch PHSS_30479. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30479 : HP-UX XFree86, Remote Unauthorized Privileged Access, Execution of Arbitrary Code (HPSBUX01018 SSRT4692 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.22 X11 Font Library Patch : 
...
unauthorized privileged access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30479 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30479 applies to a different OS release.");
}

patches = make_list("PHSS_30479");
...
flag = 0;
if (hpux_check_patch(app:"X11.MKFONTDIR", version:"B.11.22")) flag++;
