...
related to the 'TTF16.ocx' ActiveX control.");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c04454636
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66336ae2");
  script_set_attribute(attribute:"solution", value:
"Apply HP Sprinter Service Pack 12.01 Patch 1.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-2638");
