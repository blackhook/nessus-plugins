...
# extracted from HP patch PHCO_36808. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_36808 : HP-UX Running logins(1M), Remote Unauthorized Access (HPSBUX02259 SSRT071439 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 logins(1M) cumulative patch : 
...
allowing remote unauthorized access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_36808 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_36808 applies to a different OS release.");
}

patches = make_list("PHCO_36808", "PHCO_37831");
...
flag = 0;
if (hpux_check_patch(app:"SOE.SOE", version:"B.11.23")) flag++;
if (hpux_check_patch(app:"SOE.SOE-ENG-A-MAN", version:"B.11.23")) flag++;
