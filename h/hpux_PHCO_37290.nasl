...
# extracted from HP patch PHCO_37290. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_37290 : HP-UX Running useradd(1M), Local Unauthorized Access (HPSBUX02335 SSRT071454 rev.2)");
...
to allow unauthorized access to directories or files."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_37290 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_37290 applies to a different OS release.");
}

patches = make_list("PHCO_37290", "PHCO_38492");
