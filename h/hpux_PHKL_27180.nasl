...
# extracted from HP patch PHKL_27180. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_27180 : HP-UX running ptrace(2), Local Denial of Service (DoS) (HPSBUX00206 SSRT071397 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.00 Corrected reference to thread register state : 
...
Improper use of ptrace(2) could panic the system."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_27180 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_27180 applies to a different OS release.");
}

patches = make_list("PHKL_27180");
