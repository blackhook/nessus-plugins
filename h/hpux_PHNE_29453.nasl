...
# extracted from HP patch PHNE_29453. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_29453 : HP-UX Running on HP9000 Series 700/800, Denial of Service (DoS) (HPSBUX00264 SSRT3460 rev.5)");
...
Certain network traffic can cause programs to fail."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_29453 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_29453 applies to a different OS release.");
}

patches = make_list("PHNE_29453", "PHNE_30905", "PHNE_33427");
