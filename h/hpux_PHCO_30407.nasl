...
# extracted from HP patch PHCO_30407. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_30407 : HP-UX Running RPC, Remote Unauthorized Access or Denial of Service (DoS) (HPSBUX00252 SSRT2439 rev.13)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) cuml 10.24 libc compatibility support : 
...
Potential buffer overflow in xdrmem_getbytes() and related functions."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_30407 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_30407 applies to a different OS release.");
}

patches = make_list("PHCO_30407");
