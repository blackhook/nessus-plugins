...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_35142 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_35142 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_35142", "PHSS_35534", "PHSS_36290", "PHSS_37382", "PHSS_38722");
