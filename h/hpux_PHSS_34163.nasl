...
# extracted from HP patch PHSS_34163. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_34163 : Apache-based Web Server on HP-UX mod_ssl, proxy_http, Remote Execution of Arbitrary Code, Denial of Service (DoS), and Unauthorized Access (HPSBUX02074 SSRT051251 rev.2)");
...
unauthorized access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_34163 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_34163 applies to a different OS release.");
}

patches = make_list("PHSS_34163", "PHSS_35437");
