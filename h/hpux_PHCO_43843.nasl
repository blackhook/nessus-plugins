...
# extracted from HP patch PHCO_43843. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_43843 : s700_800 11.23 m4(1) cumulative patch");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 m4(1) cumulative patch : 
...
(SSRT101297)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_43843 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_43843 applies to a different OS release.");
}

patches = make_list("PHCO_43843");
