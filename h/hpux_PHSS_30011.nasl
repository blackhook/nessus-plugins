...
# extracted from HP patch PHSS_30011. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30011 : HP-UX Running CDE, Local Elevation of Privileges (HPSBUX00297 SSRT3657 rev.4)");
...
CDE libDtHelp has a potential buffer overflow."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30011 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30011 applies to a different OS release.");
}

patches = make_list("PHSS_30011", "PHSS_30788", "PHSS_32110", "PHSS_33325", "PHSS_35249", "PHSS_36394", "PHSS_43518");
