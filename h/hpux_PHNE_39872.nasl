...
# extracted from HP patch PHNE_39872. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_39872 : HP-UX Running XNTP, Remote Execution of Arbitrary Code (HPSBUX02437 SSRT090038 rev.2)");
...
arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_39872 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_39872 applies to a different OS release.");
}

patches = make_list("PHNE_39872", "PHNE_41908", "PHNE_44236");
