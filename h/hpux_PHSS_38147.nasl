...
# extracted from HP patch PHSS_38147. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_38147 : s700_800 11.X OV NNM7.53 PA-RISC Intermediate Patch 19");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_38147 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_38147 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_38147", "PHSS_38488", "PHSS_38782", "PHSS_39245", "PHSS_39639", "PHSS_39944", "PHSS_40374", "PHSS_40707", "PHSS_41242", "PHSS_41606", "PHSS_41857", "PHSS_42232", "PHSS_43046", "PHSS_43353");
