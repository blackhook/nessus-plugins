...
# extracted from HP patch PHNE_30095. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_30095 : HP-UX Running rpc.ypupdated, Remote Unauthorized Access (HPSBUX01002 SSRT4688 rev.2)");
...
unauthorized access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_30095 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_30095 applies to a different OS release.");
}

patches = make_list("PHKL_31500", "PHNE_30095");
