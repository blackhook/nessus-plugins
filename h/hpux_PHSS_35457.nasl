...
# extracted from HP patch PHSS_35457. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_35457 : HP OpenView Operations (OVO) Agents Running Shared Trace Service, Remote Arbitrary Code Execution (HPSBMA02239 SSRT061260 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV OVO8.X Core Agt Tru64 A.08.17 : 
...
vulnerability could be remotely exploited to execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_35457 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_35457 applies to a different OS release.");
}

patches = make_list("PHSS_35457", "PHSS_37505", "PHSS_37682", "PHSS_38515");
...
flag = 0;
if (hpux_check_patch(app:"OVO-CLT.OVO-TRU-CLT", version:"08.12.000")) flag++;
