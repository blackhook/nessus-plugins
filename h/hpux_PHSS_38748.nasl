...
# extracted from HP patch PHSS_38748. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_38748 : HP-UX running WBEM Services, Remote Execution of Arbitrary Code, Gain Extended Privileges (HPSBMA02331 SSRT080000 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 HP WBEM Services A.02.00.11 : 
...
remotely to execute arbitrary code or to gain extended privileges."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_38748 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_38748 applies to a different OS release.");
}

patches = make_list("PHSS_38748");
...
flag = 0;
if (hpux_check_patch(app:"WBEMServices.WBEM-CORE", version:"A.02.00.11")) flag++;
