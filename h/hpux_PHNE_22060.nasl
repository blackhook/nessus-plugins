...
# extracted from HP patch PHNE_22060. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_22060 : HPSBUX0007-117 Sec. Vulnerability in ftpd (rev.5)");
...
The ftp server (ftpd) on HP-UX allows users root access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_22060 or subsequent."
  );
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2000/10/05");
...
{
  exit(0, "The host is not affected since PHNE_22060 applies to a different OS release.");
}

patches = make_list("PHNE_22060", "PHNE_24395", "PHNE_31034", "PHNE_32813", "PHNE_34077");
