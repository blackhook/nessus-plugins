...
# extracted from HP patch PHNE_28102. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_28102 : s700_800 11.00 ONC/NFS General Release/Performance Patch");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_28102 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_28102 applies to a different OS release.");
}

patches = make_list("PHNE_28102", "PHNE_28567", "PHNE_28982", "PHNE_29210", "PHNE_29302", "PHNE_29785", "PHNE_29882", "PHNE_30377", "PHNE_30660", "PHNE_31096");
