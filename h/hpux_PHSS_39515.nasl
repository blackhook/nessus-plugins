...
# extracted from HP patch PHSS_39515. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_39515 : HP OpenView Storage Data Protector, Local Unauthorized Access (HPSBMA02502 SSRT090171 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.X OV DP6.10 HP-UX IA64 - Cell Server patch : 
...
to gain unauthorized access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_39515 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_39515 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_39515", "PHSS_41873");
