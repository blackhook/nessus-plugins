...
# extracted from HP patch PHSS_41607. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_41607 : s700_800 11.X OV NNM7.53 IA-64 Intermediate Patch 28");
...
The remote HP-UX host is affected by multiple vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_41607 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_41607 applies to a different OS release / architecture.");
}

patches = make_list("PHSS_41607", "PHSS_41858", "PHSS_42233", "PHSS_43047", "PHSS_43354");
