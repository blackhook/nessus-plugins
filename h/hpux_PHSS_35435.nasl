...
# extracted from HP patch PHSS_35435. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_35435 : HP-UX Running dtmail, Local Execution of Arbitrary Code (HPSBUX02162 SSRT061223 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.23 CDE Applications Patch : 
...
group. References: NETRAGARD-20060810."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_35435 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_35435 applies to a different OS release.");
}

patches = make_list("PHSS_35435", "PHSS_35885", "PHSS_39135", "PHSS_39408", "PHSS_41174");
...
flag = 0;
if (hpux_check_patch(app:"CDE.CDE-ENG-A-MAN", version:"B.11.23")) flag++;
if (hpux_check_patch(app:"CDE.CDE-LANGS", version:"B.11.23")) flag++;
if (hpux_check_patch(app:"CDE.CDE-RUN", version:"B.11.23")) flag++;
