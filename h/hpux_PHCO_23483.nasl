...
# extracted from HP patch PHCO_23483. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_23483 : HPSBUX0102-143 Sec. Vulnerability in SD-UX (Rev.02)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) SD-UX Cumulative Patch : 

Security defect in Software Distributor SD-UX."
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_23483 or subsequent."
  );
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2001/03/16");
  script_set_attribute(attribute:"patch_modification_date", value:"2001/04/02");
...
{
  exit(0, "The host is not affected since PHCO_23483 applies to a different OS release.");
}

patches = make_list("PHCO_23483", "PHCO_25064", "PHCO_30006", "PHCO_34814");
