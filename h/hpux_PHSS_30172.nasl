...
# extracted from HP patch PHSS_30172. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_30172 : HP-UX XFree86, Remote Unauthorized Privileged Access, Execution of Arbitrary Code (HPSBUX01018 SSRT4692 rev.2)");
...
unauthorized privileged access."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_30172 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_30172 applies to a different OS release.");
}

patches = make_list("PHSS_30172");
