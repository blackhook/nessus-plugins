...
if (description)
{
  ...
  script_name(english:"Hosting Controller < 6.1 Hotfix 2.1 Multiple Vulnerabilities");
...
the remote host suffers from multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/403571/30/0/threaded");
