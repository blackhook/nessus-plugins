...
# extracted from HP patch PHSS_25420. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_25420 : HP-UX running rpc.ttdbserverd, Remote Unauthorized Access, Increased Privilege (HPSBUX00168 SSRT071383 rev.5)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) CDE Runtime SEP2001 Periodic Patch : 
...
Buffer overflow in rpc.ttdbserver."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_25420 or subsequent."
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2001/11/16");
  script_set_attribute(attribute:"patch_publication_date", value:"2001/11/16");
...
{
  exit(0, "The host is not affected since PHSS_25420 applies to a different OS release.");
}

patches = make_list("PHSS_25420", "PHSS_26030", "PHSS_28174", "PHSS_29214", "PHSS_30167", "PHSS_30807");
