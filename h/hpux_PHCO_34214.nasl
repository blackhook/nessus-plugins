...
# extracted from HP patch PHCO_34214. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHCO_34214 : HP-UX in Trusted mode, Local Denial of Service (DoS) (HPSBUX02141 SSRT51153 rev.1)");
...
(DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHCO_34214 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHCO_34214 applies to a different OS release.");
}

patches = make_list("PHCO_34214", "PHCO_35250", "PHCO_39815", "PHCO_40837");
