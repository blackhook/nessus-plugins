...
# extracted from HP patch PHSS_31181. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_31181 : HP-UX Running xfs and stmkfont, Remote Unauthorized Access (HPSBUX01061 SSRT4773 rev.2)");
...
allow remote unauthorized access to resources owned by group 'bin.'."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_31181 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_31181 applies to a different OS release.");
}

patches = make_list("PHSS_31181", "PHSS_31990", "PHSS_37225", "PHSS_43202");
