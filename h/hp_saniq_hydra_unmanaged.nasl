...
"The remote storage system is currently unmanaged.");
...
console.");
  ...
  script_set_attribute(attribute:"cvss_score_rationale", value:"Unauthenticated remote administrative access.");
