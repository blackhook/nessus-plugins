...
# extracted from HP patch PHKL_41945. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_41945 : HP-UX, Local Denial of Service (DoS) (HPSBUX02646 SSRT100396 rev.1)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.31 system call infrastructure cumulative patch : 
...
Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_41945 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_41945 applies to a different OS release.");
}

patches = make_list("PHKL_41945", "PHKL_42335", "PHKL_42488", "PHKL_43361", "PHKL_44179", "PHKL_44345");
