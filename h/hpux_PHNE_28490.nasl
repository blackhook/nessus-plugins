...
# extracted from HP patch PHNE_28490. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHNE_28490 : HP-UX DNS and Resolver Libraries, Remote Execution of Arbitrary Code, Denial of Service (DoS) (HPSBUX00209 SSRT2316 rev.17)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.22 Bind 9.2.0 components : 
...
Potential buffer overflows in DNS resolver libraries."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHNE_28490 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHNE_28490 applies to a different OS release.");
}

patches = make_list("PHNE_28490");
