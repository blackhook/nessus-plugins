...
# extracted from HP patch PHSS_34389. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_34389 : HP-UX Running Xserver, Local Denial of Service (DoS) (HPSBUX02225 SSRT071295 rev.1)");
...
user to create a Denial of Service (DoS)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_34389 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_34389 applies to a different OS release.");
}

patches = make_list("PHSS_34389", "PHSS_34390", "PHSS_34391", "PHSS_34392");
