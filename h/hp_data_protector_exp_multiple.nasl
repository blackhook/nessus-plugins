...
affected host."
  ...
  script_set_attribute(
    attribute:"see_also", 
    value:"https://www.zerodayinitiative.com/advisories/ZDI-10-174/");

  script_set_attribute(
    attribute:"see_also", 
    value:"https://www.zerodayinitiative.com/advisories/ZDI-10-175/");

  script_set_attribute(
    attribute:"see_also", 
    value:"https://seclists.org/bugtraq/2010/Sep/62");

  # https://support.hpe.com/hpsc/doc/public/display?docLocale=en&docId=emr_na-c02498535-1
  script_set_attribute(
    attribute:"see_also", 
    value:"http://www.nessus.org/u?c4e353e5");
