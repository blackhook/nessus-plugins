...
# extracted from HP patch PHKL_27536. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHKL_27536 : HP-UX running ptrace(2), Local Denial of Service (DoS) (HPSBUX00206 SSRT071397 rev.2)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.04 (VVOS) Corrected ref to thread reg state : 
...
Improper use of ptrace(2) could panic the system."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHKL_27536 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHKL_27536 applies to a different OS release.");
}

patches = make_list("PHKL_27536");
