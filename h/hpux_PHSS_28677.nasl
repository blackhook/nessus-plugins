...
# extracted from HP patch PHSS_28677. The text itself is
...
if (description)
{
  ...
  script_name(english:"HP-UX PHSS_28677 : HP-UX running CDE, Remote Unauthorized Privileged Access, Execution of Arbitrary Code (HPSBUX00263 SSRT2373 rev.3)");
  ...
  script_set_attribute(
    ...
    value:
"s700_800 11.11 CDE Applications Periodic Patch : 
...
Potential security vulnerabilities in CDE libraries and programs."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Install patch PHSS_28677 or subsequent."
  );
...
{
  exit(0, "The host is not affected since PHSS_28677 applies to a different OS release.");
}

patches = make_list("PHSS_28677", "PHSS_29740", "PHSS_30669", "PHSS_30789", "PHSS_32111", "PHSS_32540", "PHSS_33326", "PHSS_34101", "PHSS_35434", "PHSS_36407");
