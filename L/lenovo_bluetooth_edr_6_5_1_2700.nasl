...
inject and execute code from arbitrary .dll files."
  ...
  script_set_attribute(attribute:"see_also",value:"https://download.lenovo.com/ibmdl/pub/pc/pccbbs/mobiles/g4wb10ww.txt");
  script_set_attribute(attribute:"see_also",value:"https://docs.microsoft.com/en-us/security-updates/VulnerabilityResearchAdvisories/2013/msvr13-001");
  script_set_attribute(
    attribute:"solution",
    value:
