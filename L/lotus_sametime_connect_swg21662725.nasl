...
information.");
  # https://www.ibm.com/blogs/psirt/ibm-security-bulletin-unsigned-java-plugins-cve-2013-6727/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96224fd9");
...
"Apply the patch referenced in the advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6727");
