...
to write arbitrary files to the web server file system.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/oss-sec/2016/q3/102");
...
that application for a fix.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6255");
