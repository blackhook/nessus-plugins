...
if (description)
{
  ...
  script_name(english:"Tenable Log Correlation Engine Client Unsupported Version Detection (Mac OS X)");
...
Correlation Engine Client for Mac OS X.");
  script_set_attribute(attribute:"description", value:
"According to its version, the installation of the Tenable Log
Correlation Engine (LCE) Client for Mac OS X on the remote host is no
longer supported.
...
"Upgrade to a version of Log Correlation Engine Client for Mac OS X
...
app = 'Log Correlation Engine Mac OSX Client';
...
if (ver[0] < 5)
{
  ...
  register_unsupported_product(product_name:'Tenable Log Correlation Engine Client', is_custom_cpe:TRUE,
                               version:version, cpe_base:"tenable:log_correlation_engine:client:macosx");
