...
package_info['Log Correlation Engine Nix Client']['Regex'] = "^[0-3]\.|4\.[01]\.";
package_info['Log Correlation Engine Nix Client']['Supported'] = '4.2.0';
package_info['Log Correlation Engine Nix Client']['XML'] = 'nix:';
package_info['Log Correlation Engine NetFlow Monitor']['Regex'] = "^[0-3]\.|4\.[0-1]";
package_info['Log Correlation Engine NetFlow Monitor']['Supported'] = '4.2.x';
package_info['Log Correlation Engine NetFlow Monitor']['XML'] = 'netflow:';
package_info['Log Correlation Engine Network Monitor']['Regex'] = "^[0-3]\.|4\.[0-1]";
package_info['Log Correlation Engine Network Monitor']['Supported'] = '4.2.x';
...
package_info['Log Correlation Engine OPSEC Client']['Supported'] = '4.5.x';
package_info['Log Correlation Engine OPSEC Client']['XML'] = 'opsec:';
package_info['Log Correlation Engine RDEP Monitor']['Regex'] = "^[0-2]\.|3\.[0-5]|3\.6\.0";
package_info['Log Correlation Engine RDEP Monitor']['Supported'] = '3.6.1';
package_info['Log Correlation Engine RDEP Monitor']['XML'] = 'rdep:';
package_info['Log Correlation Engine SDEE Monitor']['Regex'] = "^[0-3]\.|4\.[0-1]\.";
package_info['Log Correlation Engine SDEE Monitor']['Supported'] = '4.2.x';
package_info['Log Correlation Engine SDEE Monitor']['XML'] = 'sdee:';
package_info['Log Correlation Engine Splunk Client']['Regex'] = "^[0-3]\.|4\.[0-5]\.";
package_info['Log Correlation Engine Splunk Client']['Supported'] = '4.6.x';
package_info['Log Correlation Engine Splunk Client']['XML'] = 'splunk:';
package_info['Log Correlation Engine WMI Monitor']['Regex'] = "^[0-3]\.|4\.[01]\.|4\.2\.[01]";
package_info['Log Correlation Engine WMI Monitor']['Supported'] = '4.2.2';
