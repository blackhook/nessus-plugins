...
the privileges of the user running the affected application.");
  # https://www.ibm.com/blogs/psirt/security-bulletin-ibm-notes-png-integer-overflow-cve-2013-2977/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c85f4909");
...
workaround.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2977");
