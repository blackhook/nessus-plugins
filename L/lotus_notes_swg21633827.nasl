...
execute arbitrary code upon the next logon of a user.");
  # https://www.ibm.com/blogs/psirt/security-bulletin-ibm-notes-multi-user-profile-cleanup-service-enables-an-attacker-to-execute-arbitrary-code-on-the-next-logon-of-a-user-cve-2013-0536/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8bc8ff24");
...
later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-0536");
