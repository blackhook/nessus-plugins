...
if (description)
{
  ...
  script_name(english:"IBM Notes 8.5.x < 8.5.3 FP5 Multiple Vulnerabilities");
...
"Upgrade to IBM Notes 8.5.3 Fix Pack 5 or later.");
