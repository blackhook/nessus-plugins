...
if (description)
{
  ...
  script_name(english:"Wireshark 3.0.x < 3.0.4 Gryphon Dissector DoS Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote Windows host is prior to 3.0.4. It is, therefore, affected by a
vulnerability as referenced in the wireshark-3.0.4 advisory.
