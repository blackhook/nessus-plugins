...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0532");

  script_name(english:"Eudora WorldMail Unsupported");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is running an unsupported mail server.");
...
security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"http://www.computerhistory.org/atchm/the-eudora-email-client-source-code/");
  script_set_attribute(attribute:"solution", value:
"Migrate to another mail server.");
