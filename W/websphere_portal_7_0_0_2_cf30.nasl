...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Portal 7.0.0.x < 7.0.0.2 CF30 Unspecified XSS (PI80564)");
...
host is 7.0.0.x prior to 7.0.0.2 CF30. It is, therefore, affected by
...
"Upgrade to IBM WebSphere Portal 7.0.0.2 Cumulative Fix 30 (CF30) and
...
websphere_portal_check_version(
  ranges:make_list("7.0.0.0, 7.0.0.2, CF30"),
  fix:"PI80564",
