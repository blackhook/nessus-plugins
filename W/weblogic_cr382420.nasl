...
if (description)
{
  ...
  script_cve_id("CVE-2008-5460");
  script_bugtraq_id(33177);

  script_name(english:"Oracle WebLogic JSP Pages and Servlets Unspecified Information Disclosure (CVE-2008-5460)");
...
remote information disclosure vulnerability in JSP pages and
servlets.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/technetwork/topics/security/2810-090551.html");
