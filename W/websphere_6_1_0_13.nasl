...
if (description)
{
  ...
  script_cve_id("CVE-2007-5798", "CVE-2007-5799", "CVE-2007-6679");
  script_bugtraq_id(26276);
  script_xref(name:"Secunia", value:"25704");

  script_name(english:"IBM WebSphere Application Server 6.1 < 6.1.0.13 Multiple Vulnerabilities");
...
"IBM WebSphere Application Server 6.1 before Fix Pack 13 appears to be
running on the remote host.  As such, it is reportedly affected by the
following vulnerabilities :

  - Multiple cross-site request forgery vulnerabilities
    exist in 'uddigui/navigateTree.do' in the UDDI user
    console. (PK50245)

  - An unspecified vulnerability exists in the
    Administrative Console. (PK45768)");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-1.ibm.com/support/docview.wss?uid=swg27007951#61013");
  script_set_attribute(attribute:"solution", value:
"If using WebSphere Application Server, apply Fix Pack 13 (6.1.0.13) or
later. 
...
if (ver[0] == 6 && ver[1] == 1 && ver[2] == 0 && ver[3] < 13)
{
