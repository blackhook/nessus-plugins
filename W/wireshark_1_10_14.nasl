...
if (description)
{
  ...
  script_name(english:"Wireshark 1.10.x < 1.10.14 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote Windows host is prior to 1.10.14. It is, therefore, affected by
multiple vulnerabilities as referenced in the wireshark-1.10.14 advisory.
