...
allows a remote attacker to crash the application.");
  script_set_attribute(attribute:"see_also", value:"https://winscp.net/tracker/show_bug.cgi?id=1017");
  script_set_attribute(attribute:"see_also", value:"https://winscp.net/eng/docs/history#5.1.6");
...
"Upgrade to WinSCP version 5.1.6 / 5.2.2 beta or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-4852");
