...
page'." );
 # https://www.tenable.com/blog/nessus-web-application-scanning-new-plugins-configuration
 script_set_attribute(attribute:"see_also", value: "http://www.nessus.org/u?9711b23a");
