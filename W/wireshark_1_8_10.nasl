...
if (description)
{
  ...
  script_bugtraq_id(61471, 62315, 62318, 62319, 62320, 62321, 62868);

  script_name(english:"Wireshark 1.8.x < 1.8.10 Multiple DoS");
...
"The installed version of Wireshark 1.8 is earlier than 1.8.10.  It
...
following dissectors :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-1.8.10.html");
  script_set_attribute(attribute:"solution", value:"Upgrade to Wireshark version 1.8.10 or later.");
...
var constraints = [
  { 'min_version' : '1.8.0', 'max_version' : '1.8.9', 'fixed_version' : '1.8.10' }
];
