...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server 7.0 < Fix Pack 25 Multiple Vulnerabilities");
  script_summary(english:"Reads the version number from the SOAP port");

  script_set_attribute(
    attribute:"synopsis",
    value:"The remote application server may be affected by multiple vulnerabilities."
  );
  script_set_attribute(
...
following vulnerabilities :
  ...
  # 7.0.0.25 downloads
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg24033267");
  # 7.0.0.25 fix list
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg27014463#70025");
  # 7.0.0.25 security bulletin
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21611313");
...
if (ver[0] == 7 && ver[1] == 0 && ver[2] == 0 && ver[3] < 25)
{
