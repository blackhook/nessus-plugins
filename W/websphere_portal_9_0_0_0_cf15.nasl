...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Portal 9.0.0.x < 9.0.0.0 CF15 Unspecified XSS (PI92039)");
...
host is 9.0.0.x prior to 9.0.0.0 CF15. It is, therefore, affected by
...
"Upgrade to IBM WebSphere Portal 9.0.0.0 Cumulative Fix 15 (CF15) and
...
websphere_portal_check_version(
  ranges:make_list("9.0.0.0, 9.0.0.0, CF15"),
  fix:"PI92039",
