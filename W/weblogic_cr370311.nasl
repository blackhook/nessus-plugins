...
if (description)
{
  ...
  script_cve_id("CVE-2008-2582");

  script_name(english:"Oracle WebLogic DoS (CVE-2008-2582)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle WebLogic Server has an unspecified denial of
service vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported banner, the version of Oracle WebLogic
Server running on the remote host is affected by an unspecified denial
of service vulnerability that could be exploited remotely.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/technetwork/topics/security/2792-083684.html");
