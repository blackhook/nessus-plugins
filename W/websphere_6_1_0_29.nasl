...
if (description)
{
  ...
  script_cve_id("CVE-2009-2746", "CVE-2009-2747", "CVE-2009-2748");
  script_bugtraq_id(37015, 37355);

  script_name(english:"IBM WebSphere Application Server < 6.1.0.29 Multiple Vulnerabilities");
...
multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg27007951#61029");
  script_set_attribute(attribute:"solution", value:
"If using WebSphere Application Server, apply Fix Pack 29 (6.1.0.29) or
later. 
...
if (ver[0] == 6 && ver[1] == 1 && ver[2] == 0 && ver[3] < 29)
{
