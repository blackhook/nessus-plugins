...
if (description)
{
  ...
  script_cve_id("CVE-2017-1557");
  script_bugtraq_id(102418);

  script_name(english:"IBM WebSphere MQ Denial of Service (CVE-2017-1557)");
...
installed on the remote Windows host is version
8.0.0.x prior to 8.0.0.8, 9.0.x prior to 9.0.4 or 9.0.0.x prior to 9.0.0.2.
...
service to stop responding.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/docview.wss?uid=swg22004378");
  script_set_attribute(attribute:"solution", value:
"Upgrade to IBM MQ 8.0.0.8 / 9.0.4 / 9.0.0.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-1557");
...
if( app_info['version'] =~ "^9\.0\.0\.\d{1,2}($|[^0-9])")
  ...
  constraints = [
    { 'min_version' : '8.0.0', 'fixed_version' : '8.0.0.8'},
