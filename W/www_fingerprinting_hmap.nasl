...
can also be approximated, as well as some options.");
  ...
  script_copyright(english:"This script is Copyright (C) 2003-2022 Tenable Network Security, Inc. - HMAP research by Dustin Lee");
  ...
  script_dependencies("find_service1.nasl", "http_login.nasl", "httpver.nasl", "no404.nasl", "embedded_web_server_detect.nasl", "broken_web_server.nasl");
