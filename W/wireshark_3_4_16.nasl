...
if (description)
{
  ...
  script_name(english:"Wireshark 3.4.x < 3.4.16 A Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote Windows host is prior to 3.4.16. It is, therefore, affected by a
vulnerability as referenced in the wireshark-3.4.16 advisory.
