...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Portal 6.1.0.x < 6.1.0.6 CF27 Multiple Vulnerabilities");
...
6.1.0.x prior 6.1.0.6 CF27. It is, therefore, affected by multiple
vulnerabilities :
...
"Upgrade to IBM WebSphere Portal 6.1.0.6 Cumulative Fix 27 (CF27) or
later.");
...
websphere_portal_check_version(
  ranges:make_list("6.1.0.0, 6.1.0.6"),
  fix:"CF27",
