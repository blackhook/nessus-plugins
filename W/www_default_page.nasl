...
# IIS 10.0
#
iis10_head = '<title>iis windows server</title>';
iis10_body = '<img src="iisstart.png" alt="iis"';

if (iis10_head >< res && iis10_body >< res)
  report_def(port:port, srv: "IIS");
...
# Aspen 0.8
#
aspen_0_8_result = '<body>\r\ncongratulations!</body>';
aspen_0_8_header = 'aspen/0.8';
if ( aspen_0_8_result >< res && aspen_0_8_header >< res ) report_def(port:port, srv:"Aspen 0.8");
