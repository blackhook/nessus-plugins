...
inject arbitrary XML into a user's browser.");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/450704/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/search.wss?rs=0&q=PK16602&apar=only");
