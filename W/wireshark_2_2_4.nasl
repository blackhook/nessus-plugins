...
multiple denial of service vulnerabilities :
  ...
  - A denial of service vulnerability exists when handling
    ...
    excessive CPU resources (CVE-2017-5597).
...
var constraints = [
  { 'min_version' : '2.2.0', 'max_version' : '2.2.3', 'fixed_version' : '2.2.4' },
  { 'min_version' : '2.0.0', 'max_version' : '2.0.9', 'fixed_version' : '2.0.10' }
];
