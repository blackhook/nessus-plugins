...
if (description)
{
  ...
  script_cve_id("CVE-2008-2580");

  script_name(english:"Oracle WebLogic JSP Pages Unspecified Information Disclosure (CVE-2008-2580)");
...
information disclosure vulnerability in JSP pages.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/technetwork/topics/security/2786-092615.html");
