...
if (description)
{
  ...
  script_cve_id("CVE-2016-8919");
  script_bugtraq_id(95650);

  script_name(english:"IBM WebSphere Application Server 7.0.0.x < 7.0.0.43 / 8.0.0.x < 8.0.0.14 / 8.5.x < 8.5.5.12 / 9.0.0.x < 9.0.0.4 SOAP Connectors DoS");
...
resources on the target system.");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21993797");
...
October 2017) / 8.5 Fix Pack 12 (8.5.5.12) / 9.0 Fix Pack 4
