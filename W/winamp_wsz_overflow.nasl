...
"The version of Winamp on the remote host is vulnerable to a buffer overflow.");
...
Winamp.");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/373146");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Winamp 5.0.5 or newer");
