...
or more of those is installed elsewhere.");
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/technetwork/topics/security/2785-088160.html");
  script_set_attribute(attribute:"solution", value:
"Follow the advice in Oracle's advisory to upgrade the plug-ins.");
