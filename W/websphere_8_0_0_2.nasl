...
if (description)
{
  ...
  script_name(english:"IBM WebSphere Application Server 8.0 < Fix Pack 2 Multiple Vulnerabilities");
...
following vulnerabilities :
  ...
  # 8.0.0.2 downloads
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg24031368");
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?609dea34");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg27022958#8002");
  script_set_attribute(
    attribute:"solution", 
    value:"Apply Fix Pack 2 for version 8.0 (8.0.0.2) or later."
  );
...
if (ver[0] == 8 && ver[1] == 0 && ver[2] == 0 && ver[3] < 2)
{
