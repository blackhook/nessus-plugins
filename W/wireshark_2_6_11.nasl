...
if (description)
{
  ...
  script_name(english:"Wireshark 2.6.x < 2.6.11 Gryphon Dissector DoS Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote Windows host is prior to 2.6.11. It is, therefore, affected by a
vulnerability as referenced in the wireshark-2.6.11 advisory.
