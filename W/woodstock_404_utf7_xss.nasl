...
browser to auto-detect encoding, and the browser recognizes UTF-7.");
  script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20100323035516/http://dsecrg.com:80/pages/vul/show.php?id=138");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/503239/30/0/threaded");
