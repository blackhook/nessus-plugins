...
if (description)
{
  ...
  script_name(english:"Wireshark 1.10.x < 1.10.10 Multiple DoS Vulnerabilities");
...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/security/wnpa-sec-2014-12.html");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.wireshark.org/docs/relnotes/wireshark-1.10.10.html");
...
var constraints = [
  { 'min_version' : '1.10.0', 'max_version' : '1.10.9', 'fixed_version' : '1.10.10' }
];
