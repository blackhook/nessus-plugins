...
if (description)
{
  ...
  script_cve_id("CVE-2007-3397", "CVE-2007-3960");
  script_bugtraq_id(21636, 24608);
  script_xref(name:"Secunia", value:"23414");
  script_xref(name:"Secunia", value:"26183");

  script_name(english:"IBM WebSphere Application Server 6.0 < 6.0.2.21 Multiple Vulnerabilities");
...
by multiple vulnerabilities. 
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?rs=180&uid=swg27006876#60221");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?rs=180&uid=swg24015854");
  script_set_attribute(attribute:"solution", value:"Apply Fix Pack 21 (6.0.2.21) or later.");
...
if (
  ...
  (ver[0] == 6 && ver[1] == 0 && ver[2] == 2 && ver[3] < 21)
)
{
