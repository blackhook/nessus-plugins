...
relied on the version in War FTP Daemon's banner.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2013/Feb/142");
  script_set_attribute(attribute:"solution", value:
"Upgrade to War FTP Daemon version 1.83 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2278");
