...
if (description)
{
  ...
  script_cve_id("CVE-2020-25598");
  script_xref(name:"IAVB", value:"2020-B-0056-S");

  script_name(english:"XENMEM_aquire_resources Error Path DoS (XSA-334)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Xen hypervisor installation is missing a security update.");
  script_set_attribute(attribute:"description", value:
"A denial of service (DoS) vulnerability exists in Xen servers XENMEM_acquire_resource due to an error path exiting 
without releasing an RCU (Read, Copy, Update) reference. An authenticated, local attacker can exploit this issue, via 
a malicious HVM stubdomain which can cause an RCU reference to be leaked, that leads to subsequent administration 
operations, (e.g. CPU offline) to livelock, resulting in a host DoS.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-334.html");
...
"Apply the appropriate patch or mitigation as described in the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25598");
...
fixes['4.12']['fixed_ver_display']   = '4.12.4-pre (changeset 8b8fff2)';
fixes['4.12']['affected_ver_regex']  = "^4\.12\.";
fixes['4.12']['affected_changesets'] = make_list('320e7a7', '0446e3d',
...
fixes['4.13']['fixed_ver_display']   = '4.13.2-pre (changeset 286b353)';
fixes['4.13']['affected_ver_regex']  = "^4\.13\.";
fixes['4.13']['affected_changesets'] = make_list('b980319', 'aa1d9a7',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset 5eab5f0)';
fixes['4.14']['affected_ver_regex']  = "^4\.14\.";
fixes['4.14']['affected_changesets'] = make_list('b04d673', '28855eb',
