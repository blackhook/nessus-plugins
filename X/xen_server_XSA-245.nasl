...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2017-B-0134-S");

  script_name(english:"Xen Hypervisor Memory Leak on Boot (XSA-235)");
...
installed on the remote host is affected by flaw within the
page_alloc.c and asm-arm/numa.h due to not scrubbing the memory on
boot. This could potentially leave sensitive information available to
read after a reboot.
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"http://xenbits.xen.org/xsa/advisory-245.html");
...
fixes['4.5']['fixed_ver_display']   = '4.5.5 (changeset db487a6)';
fixes['4.5']['affected_ver_regex']  = '^4\\.5\\.';
fixes['4.5']['affected_changesets'] = make_list("709230f", "83724d9",
...
fixes['4.6']['fixed_ver_display']   = '4.6.6 (changeset 78fd0c3)';
fixes['4.6']['affected_ver_regex']  = '^4\\.6\\.';
fixes['4.6']['affected_changesets'] = make_list("9079e0d", "1658a87",
  "22b6dfa", "a8cd231", "629eddd", "64c03bb", "b4660b4", "1ac8162",
  "747df3c", "5ae011e", "f974d32", "3300ad3", "d708b69");

fixes['4.7']['fixed_ver']           = '4.7.4';
fixes['4.7']['fixed_ver_display']   = '4.7.4-pre (changeset d6aad63)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("7c99633", "145c18d",
...
fixes['4.8']['fixed_ver_display']   = '4.8.3-pre (changeset 2116fec)';
fixes['4.8']['affected_ver_regex']  = '^4\\.8\\.';
fixes['4.8']['affected_changesets'] = make_list("1a535c3", "ee3fc24",
  "d623d82", "dda458c", "c642b12", "80d7ef3", "ff4f60a", "36898eb",
  "4d7ccae", "e574046", "90dafa4", "c020cf2");

fixes['4.9']['fixed_ver']           = '4.9.1';
fixes['4.9']['fixed_ver_display']   = '4.9.1-pre (changeset 1cdcb36)';
fixes['4.9']['affected_ver_regex']  = '^4\\.9\\.';
fixes['4.9']['affected_changesets'] = make_list("84c039e", "b244ac9",
