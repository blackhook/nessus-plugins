...
if (description)
{
  ...
  script_cve_id("CVE-2020-27670");

  script_name(english:"Xen unsafe AMD IOMMU page table updates (XSA-347)");
...
allowing x86 guest OS users to cause a denial of service (data corruption), cause a data leak, or possibly gain
privileges because an AMD IOMMU page-table entry can be half-updated.
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-27670");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset 71da63b)';
fixes['4.10']['affected_ver_regex']  = "^4\.10([^0-9]|$)";
fixes['4.10']['affected_changesets'] = make_list('56f8da7', 'd73e972',
...
fixes['4.11']['fixed_ver_display']   = '4.11.4 (changeset 63199df)';
fixes['4.11']['affected_ver_regex']  = "^4\.11([^0-9]|$)";
fixes['4.11']['affected_changesets'] = make_list('7739ffd', '4f35f7f',
...
fixes['4.12']['fixed_ver_display']   = '4.12.4-pre (changeset 14b0a08)';
fixes['4.12']['affected_ver_regex']  = "^4\.12([^0-9]|$)";
fixes['4.12']['affected_changesets'] = make_list('97f9def', 'b402e2a',
  '37f45de', 'e461318', '1cec253', '03926de', '6888017', '0186e76',
  '0ca821f', 'cfd61e6', '2aa4864', '8e25d52', '9c2a027', '9dda47c',
...
fixes['4.13']['fixed_ver_display']   = '4.13.2-pre (changeset e891c28)';
fixes['4.13']['affected_ver_regex']  = "^4\.13([^0-9]|$)";
fixes['4.13']['affected_changesets'] = make_list('3009e4d', '1c86c83',
  '745652f', '6e237b6', '98ec971', '7f5d676', 'a2c0c91', '8e7e585',
  '88f5b41', 'f63b20a', 'b015fbe', '54becf6', '43572a4', '2105429',
  'a8122e9', 'e1364e0', '5867a14', '0537543', 'ae922b9', 'f27980a',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset a279fcb)';
fixes['4.14']['affected_ver_regex']  = "^4\.14([^0-9]|$)";
fixes['4.14']['affected_changesets'] = make_list('f7ab0c1', '7339975',
...
fixes['4.15']['fixed_ver_display']   = '4.15-unstable (changeset 0514a3a)';
fixes['4.15']['affected_ver_regex']  = "^4\.15([^0-9]|$)";
fixes['4.15']['affected_changesets'] = make_list('3b05512', '73f62c7',
