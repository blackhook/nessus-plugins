...
if (description)
{
  ...
  script_cve_id("CVE-2018-12892");
  script_bugtraq_id(104571);
  script_xref(name:"IAVB", value:"2018-B-0094-S");

  script_name(english:"Xen Project Local Security Bypass Vulnerability (XSA-266)");
...
installed on the remote host is affected by a local security bypass
vulnerability.
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"http://xenbits.xen.org/xsa/advisory-266.html");
...
fixes['4.7']['fixed_ver_display']   = '4.7.5 (changeset b292518)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("790847d", "f9898e7",
  "253c3ec", "839826b", "55674ed", "0feed48", "a8d37ee", "117ef5e",
  "536d16c", "196932a", "0d44ee0", "f9b8c11", "ed4f56d", "3f5bd56",
  "03bf349", "375c01e", "acdf07d", "53c6a02", "466ab42", "870d737",
  "fb665b3", "6678f08", "bd63f04", "340c686", "55c1e84", "88f810a",
  "ea94f1e", "9299683", "8c699a0", "0b5b62a", "ff11aaf", "f666dab",
  "366e041", "5d271d5", "5d8c6fd", "226c231", "6de86cf", "ce22cc3",
  "4f713cf", "0b6c7b4", "2bc2e1f", "11fd624", "3478fb7", "0bc0693",
  "be0d7af", "d355f02", "236b8be", "e9281ad", "fb70754", "a6a2b5a",
  "54ff338", "1bd5a36", "5fc0102", "a8ef075", "e613050", "2fbc006",
  "1619cff", "5c81317", "912aa9b", "63b140f", "62b1879", "9680710", "dca80ab");

fixes['4.8']['fixed_ver']           = '4.8.4';
fixes['4.8']['fixed_ver_display']   = '4.8.4-pre (changeset 321254a)';
fixes['4.8']['affected_ver_regex']  = '^4\\.8\\.';
fixes['4.8']['affected_changesets'] = make_list("500d567", "5fd28d2",
  "d615412", "9a7fa68", "b736afd", "b9b9d9e", "028656f", "c1aaad5",
  "c5a5692", "1522a81", "37b3dfd", "f8a489f", "0954b11", "266d511",
  "2d97baa", "61fc6a4", "73b68d2", "811c168", "eef72b8", "ae0a87e",
  "b494c13", "c36aaca", "1afb894", "845d2b6", "9d73586", "7f4ae16",
  "05b41f2", "618a96e", "455a429", "1fd1973", "ef14d39", "c696ef0",
  "68d02a7", "b0ea18e", "e60a287", "9419337", "cc0bb3b", "197e605",
  "eaa9d0a", "d66898a", "f2837b5", "0f475fe", "210bd51", "b4ad8a6",
  "4cdd4cc", "193130f", "7f2959f", "9cba9ae", "f99bc15", "44c709e",
  "c10ddc1", "2bef7bf", "326d25f", "3f59d0b", "a89390b", "40c4ab8",
...
fixes['4.9']['fixed_ver_display']   = '4.9.3-pre (changeset 5d92007)';
fixes['4.9']['affected_ver_regex']  = '^4\\.9\\.';
fixes['4.9']['affected_changesets'] = make_list("c257e35", "ad08a1b",
...
fixes['4.10']['fixed_ver_display']   = '4.10.2-pre (changeset 2308158)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("b2444d2", "42219af",
