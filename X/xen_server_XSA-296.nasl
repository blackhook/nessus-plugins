...
if (description)
{
  ...
  script_cve_id("CVE-2019-18420");
  script_xref(name:"IAVB", value:"2019-B-0084-S");

  script_name(english:"Xen Project VCPUOP_initialise DoS (XSA-296)");
...
the remote host is affected by a denial of service vulnerability due to poor
handling of an invalid format string in 'hypercall_create_continuation()'. This
function can be reached via a long-running 'VCPUOP_initialise' hypercall. This
vulnerability may allow an attacker to preform a guest-to-host denial of
service attack causing the Xen hypervisor to crash. Only x86 PV guests are
exploitable.
...
applied manually to the source code before a recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-296.html");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-18420");
...
fixes['4.11']['fixed_ver_display']   = '4.11.3-pre';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';

fixes['4.12']['fixed_ver']           = '4.12.2';
fixes['4.12']['fixed_ver_display']   = '4.12.2-pre';
