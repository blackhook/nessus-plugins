...
if (description)
{
  ...
  script_cve_id("CVE-2017-17045");
  script_xref(name:"IAVB", value:"2017-B-0165-S");

  script_name(english:"Xen Hypervisor Guest-to-Host Privilege Escalation (XSA-247)");
...
This issue only affects HVM guests.
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"http://xenbits.xen.org/xsa/advisory-247.html");
...
fixes['4.5']['fixed_ver_display']   = '4.5.5 (changeset ea1620f)';
fixes['4.5']['affected_ver_regex']  = '^4\\.5\\.';
fixes['4.5']['affected_changesets'] = make_list("ca708d3", "d144bda",
  "41f6dd0", "b0be3c2", "42ea1dc", "08aa260", "03b06d3", "77666b6",
...
fixes['4.7']['fixed_ver_display']   = '4.7.5-pre (changeset b3981ea)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("184f259", "67966a9",
  "af3f585");

fixes['4.9']['fixed_ver']           = '4.9.2';
fixes['4.9']['fixed_ver_display']   = '4.9.2-pre (changeset 0a0dcdc)';
fixes['4.9']['affected_ver_regex']  = '^4\\.9\\.';
fixes['4.9']['affected_changesets'] = make_list("fb51cab", "61c13ed",
  "52ad651");
