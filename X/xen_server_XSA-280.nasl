...
if (description)
{
  ...
  script_name(english:"Xen Project XSA-240 Mitigation Shadow Paging Conflict Vulnerability (XSA-280)");
...
information, and perform a DoS against the host. A number of caveats
exist to determine if a system is vulnerable. Please refer to the
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-280.html");
...
fixes['4.7']['fixed_ver_display']   = '4.7.6 (changeset ab6d56c)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("4f3858f", "045d4f7",
  "2b3463f", "efe21ad", "9c82759", "3d3e474", "4e69e43", "3d33cc6",
...
fixes['4.8']['fixed_ver_display']   = '4.8.5-pre (changeset 92f3118)';
fixes['4.8']['affected_ver_regex']  = '^4\\.8\\.';
fixes['4.8']['affected_changesets'] = make_list("4be61c4", "538c7c7",
  "14854d0", "f030ad0", "d6798ce", "d792e57", "ba4eb85", "88b5e36",
...
fixes['4.9']['fixed_ver_display']   = '4.9.4-pre (changeset ca5ede6)';
fixes['4.9']['affected_ver_regex']  = '^4\\.9\\.';
fixes['4.9']['affected_changesets'] = make_list("d96e629", "d819a65",
  "15b4ee9", "f97a1d1", "f13983d", "8d6f213", "c4a3f16", "1bd7c17",
...
fixes['4.10']['fixed_ver_display']   = '4.10.3-pre (changeset 8b1efc9)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("2f5a67c", "c1fd070",
  "d5d8074", "421aada", "e907460", "ba6ac89", "4c7cd94", "c841c82",
...
fixes['4.11']['fixed_ver_display']   = '4.11.1-pre (changeset bbe48b5)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("93177f1", "e738850",
  "eb6830a", "b88ccb3", "3b2a779", "946f345", "086a9dd", "dea9fc0",
