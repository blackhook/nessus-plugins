...
if (description)
{
  ...
  script_cve_id("CVE-2020-25603");
  script_xref(name:"IAVB", value:"2020-B-0056-S");

  script_name(english:"Xen Missing memory barriers DoS (XSA-340)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Xen hypervisor installation is missing a security update.");
  script_set_attribute(attribute:"description", value:
"A denial of service (DoS) vulnerability exists in Xen servers when accessing/allocating an event channel due to a
missing memory barrier. An authenticated, local attacker may be able to cause a hypervisor crash resulting in a 
Denial of Service (DoS). 

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version 
number.");
  # https://xenbits.xen.org/xsa/advisory-340.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3aa7d082");
...
"Apply the appropriate patch or workaround according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25603");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset baf80b6)';
fixes['4.10']['affected_ver_regex']  = "^4\.10\.";
fixes['4.10']['affected_changesets'] = make_list('5402540', 'f85223f',
...
fixes['4.11']['fixed_ver_display']   = '4.11.4 (changeset 13f60bf)';
fixes['4.11']['affected_ver_regex']  = "^4\.11\.";
fixes['4.11']['affected_changesets'] = make_list('9703a2f', '7284bfa',
...
fixes['4.12']['fixed_ver_display']   = '4.12.4-pre (changeset 253a1e6)';
fixes['4.12']['affected_ver_regex']  = "^4\.12\.";
fixes['4.12']['affected_changesets'] = make_list('3e039e1', 'b2db007',
...
fixes['4.13']['fixed_ver_display']   = '4.13.2-pre (changeset 5867a14)';
fixes['4.13']['affected_ver_regex']  = "^4\.13\.";
fixes['4.13']['affected_changesets'] = make_list('0537543', 'ae922b9',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset f546906)';
fixes['4.14']['affected_ver_regex']  = "^4\.14\.";
fixes['4.14']['affected_changesets'] = make_list('eb4a543', 'e417504',
