...
if (description)
{
  ...
  script_cve_id("CVE-2020-29485");
  script_xref(name:"IAVB", value:"2020-B-0077-S");

  script_name(english:"Xen Memory Leak DoS (XSA-330)");
...
of service vulnerability due to a memory leak in XS_RESET_WATCHES. A guest can cause unbounded memory usage in
oxenstored to cause the system to stop responding with a system-wide DoS.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version 
number.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-330.html");
...
"Apply the appropriate patch or workaround according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-29485");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset 7073b82)';
fixes['4.10']['affected_ver_regex']  = "^4\.10\.";
fixes['4.10']['affected_changesets'] = make_list('3056f89', '03569ab',
  '17b26b8', '66e2db1', 'fcc17dc', 'e644edc', '7e16a0e', 'a4c2c94',
...
fixes['4.11']['fixed_ver_display']   = '4.11.4 (changeset 1e87058)';
fixes['4.11']['affected_ver_regex']  = "^4\.11\.";
fixes['4.11']['affected_changesets'] = make_list('4cc2387', '4053771',
  'b3f4121', 'e36f81f', '1034a45', '7791d2e', '5724431', '495e973',
...
fixes['4.12']['fixed_ver_display']   = '4.12.4 (changeset d4b884b)';
fixes['4.12']['affected_ver_regex']  = "^4\.12\.";
fixes['4.12']['affected_changesets'] = make_list('7da9325', 'd6d3b13',
...
fixes['4.13']['fixed_ver_display']   = '4.13.3-pre (changeset d6a55f1)';
fixes['4.13']['affected_ver_regex']  = "^4\.13\.";
fixes['4.13']['affected_changesets'] = make_list('c6196ca', '18c0abb',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset de822c4)';
fixes['4.14']['affected_ver_regex']  = "^4\.14\.";
fixes['4.14']['affected_changesets'] = make_list('57bbcd0', '7214cc7',
