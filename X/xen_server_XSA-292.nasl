...
if (description)
{
  ...
  script_name(english:"Xen Project Process Context Identifiers TLB Flushing Multiple Vulnerabilities (XSA-292)");
...
escalation. Only x86 systems are affected.
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-292.html");
...
fixes['4.7']['fixed_ver_display']   = '4.7.6 (changeset 0bdd0db)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("c1f397d", "516671a",
  "384a6dd", "a1500d4", "362cca8", "eeea811", "710cc09", "ab6d56c",
  "4f3858f", "045d4f7", "2b3463f", "efe21ad", "9c82759", "3d3e474",
  "4e69e43", "3d33cc6", "3f7b4ec", "7ba1c7d", "87d5aa4", "9b8375a",
  "da93914", "0aa4696", "f05a33e", "f440b31", "1a90803", "0abc1ae",
  "1fdb25a", "c9641d4", "61c4360", "df66c1c", "59732fd", "3f7fd2b",
...
fixes['4.10']['fixed_ver_display']   = '4.10.4-pre (changeset a595111)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("aae0d18", "631b902",
  "f6f1e94", "b450b20", "dfc7e3c", "382e4a6", "edbc9b0", "edb80d2");

fixes['4.11']['fixed_ver']           = '4.11.2';
fixes['4.11']['fixed_ver_display']   = '4.11.2-pre (changeset 6c197f9)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("7bbd3a5", "92227e2",
  "4835974", "be58f86", "4298abd", "4f785ea", "1028304", "87f51bf",
  "dd492b8", "e2e3a1d", "850ca94", "514dccd", "e202feb", "1986728",
  "2cd833d", "de09411", "dd914e4", "63d7113", "af25f52", "91f2ad7",
  "0b2be0b", "7d1bd98", "d8b2418", "bf608fd");
