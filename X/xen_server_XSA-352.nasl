...
if (description)
{
  ...
  script_cve_id("CVE-2020-29486");
  script_xref(name:"IAVB", value:"2020-B-0077-S");

  script_name(english:"Xen oxenstored DoS (XSA-352)");
...
of service vulnerability due to an issue with oxenstored. A malicious guest administrator can change xenstore node
ownership to run another guest out of quota, or create an unbounded number of nodes owned by dom0 to run xenstored out
of memory. This can cause a specific guest or the system to stop responding.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version 
number.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-352.html");
...
"Apply the appropriate patch or workaround according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-29486");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset fef52f1)';
fixes['4.10']['affected_ver_regex']  = "^4\.10\.";
fixes['4.10']['affected_changesets'] = make_list('7073b82', '3056f89',
  '03569ab', '17b26b8', '66e2db1', 'fcc17dc', 'e644edc', '7e16a0e',
  'a4c2c94', 'bdd36b6', '59dc712', '57a55a4', '03937f9', 'f06e4ac',
  '3658044', '9edd614', '8cb4d2d', '2fee46c', '06092d1', '77d6b2b',
  'a043a64', '3afd384', 'e8231b6', '1d72d99', '8eb5328', 'f79f47f',
  'f91d2a9', '1fdcfdb', '17ec9b4', '15b2980', '398f91c', '5114e77',
...
fixes['4.11']['fixed_ver_display']   = '4.11.4 (changeset f1f3dee)';
fixes['4.11']['affected_ver_regex']  = "^4\.11\.";
fixes['4.11']['affected_changesets'] = make_list('1e87058', '4cc2387',
...
fixes['4.12']['fixed_ver_display']   = '4.12.4 (changeset 3c13a87)';
fixes['4.12']['affected_ver_regex']  = "^4\.12\.";
fixes['4.12']['affected_changesets'] = make_list('d4b884b', '7da9325',
...
fixes['4.13']['fixed_ver_display']   = '4.13.3-pre (changeset a2f7ae1)';
fixes['4.13']['affected_ver_regex']  = "^4\.13\.";
fixes['4.13']['affected_changesets'] = make_list('d6a55f1', 'c6196ca',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset 13268c5)';
fixes['4.14']['affected_ver_regex']  = "^4\.14\.";
fixes['4.14']['affected_changesets'] = make_list('de822c4', '57bbcd0',
  '7214cc7', '49ed711', 'dc871dd', 'b1c5e40', '61d3863', '9e53440',
  '335ef5b', '6fa3e05', 'f4405b6', '228e562', '0a79a1b', '5073c6b',
  '5259358', '3d0e1a1', '117521e', '91992c7', '4e298fa', '3beffb3',
  'da67712', '9c898a8', 'f130d5f', '1d1d1f5', '72bd989', '8e6c236',
  '1cfb9b1', '7c6ee4e', 'd11d977', '1ad1773', '0057b1f', 'd101b41',
  'd95f450', '73a0927', 'a38060e', '78a53f0', '89ae1b1', '7398a44',
  '59b8366', '1f9f1cb', 'f728b2d', '71a12a9', '0c96e42', '29b48aa',
  'd131310', '7d2b21f', 'f61c5d0', 'fc8fab1', '898864c', '9f954ae',
  '5784d1e', '10bb63c', '941f69a', '7b1e587', 'ee47e8e', '4ba3fb0',
  'd2ba323', 'b081a5f', 'e936515', '9c1cc64', '829dbe2', '8d14800',
  '0521dc9', '64c3951', '0974e00', 'a279fcb', 'f7ab0c1', '7339975',
  '94c157f', '79f1701', '9e757fc', '809a70b', 'b427109', 'c93b520',
  'f37a1cf', '5478934', '43eceee', '03019c2', '66cdf34', 'ecc6428',
  '2ee270e', '9b9fc8e', 'b8c2efb', 'f546906', 'eb4a543', 'e417504',
  '0bc4177', '5ad3152', 'fc8200a', '5eab5f0', 'b04d673', '28855eb',
  '174be04', '158c3bd', '3535f23', 'de7e543', '483b43c', '431d52a',
  'ceafff7', '369e7a3', '98aa6ea', '80dec06', '5482c28', 'edf5b86',
  'eca6d5e', 'c3a0fc2', '864d570', 'afed8e4', 'a5dab0a', 'b8c3e33', 'f836759');
