...
if (description)
{
  ...
  script_name(english:"Xen Project Process Context Identifiers Shadow Pagetables Denial of Service Vulnerability (XSA-294)");
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-294.html");
...
fixes['4.7']['fixed_ver_display']   = '4.7.6 (changeset 88f936d)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("f111e93", "4bd37f1",
  "1b3e639", "0bdd0db", "c1f397d", "516671a", "384a6dd", "a1500d4",
  "362cca8", "eeea811", "710cc09", "ab6d56c", "4f3858f", "045d4f7",
...
fixes['4.10']['fixed_ver_display']   = '4.10.4-pre (changeset 7842419)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("9f663d2", "d176cd6",
  "a595111", "aae0d18", "631b902", "f6f1e94", "b450b20", "dfc7e3c",
  "382e4a6", "edbc9b0", "edb80d2");

fixes['4.11']['fixed_ver']           = '4.11.2';
fixes['4.11']['fixed_ver_display']   = '4.11.2-pre (changeset e984846)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("4f9ab5f", "c567b05",
  "6c197f9", "7bbd3a5", "92227e2", "4835974", "be58f86", "4298abd",
  "4f785ea", "1028304", "87f51bf", "dd492b8", "e2e3a1d", "850ca94",
  "514dccd", "e202feb", "1986728", "2cd833d", "de09411", "dd914e4",
  "63d7113", "af25f52", "91f2ad7", "0b2be0b", "7d1bd98", "d8b2418", "bf608fd");
