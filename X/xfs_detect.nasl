...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0626");
...
serves font files to clients.");
  script_set_attribute(attribute:"see_also", value:"https://www.x.org/docs/FSProtocol/fsproto.pdf");
  script_set_attribute(attribute:"see_also", value:"https://en.wikipedia.org/wiki/X_Font_Server");
