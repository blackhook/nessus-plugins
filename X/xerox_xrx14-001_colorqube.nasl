...
by multiple, unspecified vulnerabilities."
  ...
  # https://www.xerox.com/download/security/security-bulletin/f89c-4f1d6f982b8a7/cert_XRX14-001_v1.0.pdf
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?94270a96");
  script_set_attribute(
    attribute:"solution",
    value:
