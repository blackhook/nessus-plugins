...
if (description)
{
  ...
  script_cve_id("CVE-2018-15469");
  script_xref(name:"IAVB", value:"2018-B-0111-S");

  script_name(english:"Xen Project ARM Grant Table v2 DoS (XSA-268)");
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"http://xenbits.xen.org/xsa/advisory-268.html");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-15469");
...
fixes['4.6']['fixed_ver_display']   = '4.6.6 (changeset 45f6a27)';
fixes['4.6']['affected_ver_regex']  = '^4\\.6\\.';
fixes['4.6']['affected_changesets'] = make_list("4c8d9f8", "1840f82",
  "a80ce17", "7d98594", "f30c9b6", "a1b8d86", "ff1d0b6", "3bd7cf6",
  "55c7bd6", "98d7948", "e0981f6", "91cf29f", "a0c3f80", "cf7d9d1",
  "170c48b", "c39cd00", "2d69b6d", "03ba272", "1fa0ecb", "598a375",
  "b7b7c4d", "ba7d011", "a544804", "2642b56", "03938ba", "542f711",
...
fixes['4.7']['fixed_ver_display']   = '4.7.6 (changeset 3f7fd2b)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("bcbd8b9", "dfee811",
...
fixes['4.8']['fixed_ver_display']   = '4.8.5-pre (changeset 0406164)';
fixes['4.8']['affected_ver_regex']  = '^4\\.8\\.';
fixes['4.8']['affected_changesets'] = make_list("e3d0ce3", "c00fabc",
...
fixes['4.9']['fixed_ver_display']   = '4.9.3-pre (changeset ab34a43)';
fixes['4.9']['affected_ver_regex']  = '^4\\.9\\.';
fixes['4.9']['affected_changesets'] = make_list("023da62", "01b624b",
...
fixes['4.10']['fixed_ver_display']   = '4.10.2-pre (changeset 5fd0bb3)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("9e7ee94", "0de39f3",
...
fixes['4.11']['fixed_ver_display']   = '4.11.1-pre (changeset fa79f9e)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("1d32c21", "7b420e8",
