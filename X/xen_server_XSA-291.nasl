...
if (description)
{
  ...
  script_cve_id("CVE-2019-17345");

  script_name(english:"Xen Project PCI Pass-through Device Denial of Service Vulnerability (XSA-291)");
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-291.html");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17345");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4-pre (changeset aae0d18)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("631b902", "f6f1e94",
  "b450b20", "dfc7e3c", "382e4a6", "edbc9b0", "edb80d2");

fixes['4.11']['fixed_ver']           = '4.11.2';
fixes['4.11']['fixed_ver_display']   = '4.11.2-pre (changeset 7bbd3a5)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("92227e2", "4835974",
  "be58f86", "4298abd", "4f785ea", "1028304", "87f51bf", "dd492b8",
  "e2e3a1d", "850ca94", "514dccd", "e202feb", "1986728", "2cd833d",
  "de09411", "dd914e4", "63d7113", "af25f52", "91f2ad7", "0b2be0b",
  "7d1bd98", "d8b2418", "bf608fd");
