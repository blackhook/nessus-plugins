...
if (description)
{
  ...
  script_cve_id("CVE-2018-5244");
  script_bugtraq_id(102433);
  script_xref(name:"IAVB", value:"2018-B-0013-S");

  script_name(english:"Xen vcpu Destruction Handling Memory Exhaustion Guest-to-Host DoS (XSA-253)");
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"http://xenbits.xen.org/xsa/advisory-253.html");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-5244");
...
fixes['4.10']['fixed_ver_display']   = '4.10.1-pre (changeset a87ec48)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("9dc5eda", "135b67e",
