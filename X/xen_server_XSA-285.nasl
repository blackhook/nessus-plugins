...
if (description)
{
  ...
  script_name(english:"Xen Project Pass-through PCI Device Guest-to-Host Privilege Escalation (XSA-285)");
...
installed on the remote host is affected by guest-to-host privilege
escalation vulnerability. Only x86 systems are affected.
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-285.html");
...
fixes['4.7']['fixed_ver_display']   = '4.7.6 (changeset 362cca8)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("eeea811", "710cc09",
  "ab6d56c", "4f3858f", "045d4f7", "2b3463f", "efe21ad", "9c82759",
...
fixes['4.10']['fixed_ver_display']   = '4.10.4-pre (changeset 382e4a6)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("edbc9b0", "edb80d2");

fixes['4.11']['fixed_ver']           = '4.11.2';
fixes['4.11']['fixed_ver_display']   = '4.11.2-pre (changeset 4f785ea)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("1028304", "87f51bf",
