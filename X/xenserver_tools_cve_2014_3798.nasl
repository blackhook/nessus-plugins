...
sending specially crafted packets.");
  script_set_attribute(attribute:"see_also", value:"https://support.citrix.com/article/CTX140814");
...
"Apply the appropriate patch per the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3798");
  ...
  script_require_keys("SMB/xenserver_tools/Version", "SMB/xenserver_tools/Path");
