...
if (description)
{
  ...
  script_name(english:"Xen xenstored watch DoS (XSA-324)");
...
of service vulnerability due to an issue with max payload length in xenstored. A malicious guest can exploit this, by
registering a 'watch' with using a very large tag, to cause an error condition in xenstored. This error can result in a
NULL pointer dereference, which can crash xenstored.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version 
number.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-324.html");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset 03569ab)';
fixes['4.10']['affected_ver_regex']  = "^4\.10\.";
fixes['4.10']['affected_changesets'] = make_list('17b26b8', '66e2db1',
  'fcc17dc', 'e644edc', '7e16a0e', 'a4c2c94', 'bdd36b6', '59dc712',
  '57a55a4', '03937f9', 'f06e4ac', '3658044', '9edd614', '8cb4d2d',
  '2fee46c', '06092d1', '77d6b2b', 'a043a64', '3afd384', 'e8231b6',
  '1d72d99', '8eb5328', 'f79f47f', 'f91d2a9', '1fdcfdb', '17ec9b4',
  '15b2980', '398f91c', '5114e77', '7a4ec79', '78d903e', '2012db4',
  '71da63b', '56f8da7', 'd73e972', '6f012ec', '75a05da', 'c334b87',
  '07ad8ff', '1719f79', 'f58caa4', 'f2befb6', '83b7f04', 'e081568',
  '7f0793a', '8fac37e', 'baf80b6', '5402540', 'f85223f', '635ae12',
...
fixes['4.11']['fixed_ver_display']   = '4.11.4 (changeset 4053771)';
fixes['4.11']['affected_ver_regex']  = "^4\.11\.";
fixes['4.11']['affected_changesets'] = make_list('b3f4121', 'e36f81f',
...
fixes['4.12']['fixed_ver_display']   = '4.12.4 (changeset d6d3b13)';
fixes['4.12']['affected_ver_regex']  = "^4\.12\.";
fixes['4.12']['affected_changesets'] = make_list('9fe89e1', 'd009b8d',
...
fixes['4.13']['fixed_ver_display']   = '4.13.3-pre (changeset 18c0abb)';
fixes['4.13']['affected_ver_regex']  = "^4\.13\.";
fixes['4.13']['affected_changesets'] = make_list('782aa4b', '6aea4d8',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset 7214cc7)';
fixes['4.14']['affected_ver_regex']  = "^4\.14\.";
fixes['4.14']['affected_changesets'] = make_list('49ed711', 'dc871dd',
