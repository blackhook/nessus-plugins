...
if (description)
{
  ...
  script_cve_id("CVE-2020-29570");
  script_xref(name:"IAVB", value:"2020-B-0077-S");

  script_name(english:"Xen Control Block DoS (XSA-358)");
...
of service vulnerability. Recording of the per-vCPU control block mapping maintained by Xen and that of pointers into
the control block is reversed. The consumer assumes, seeing the former initialized, that the latter are also ready for
use. Malicious or buggy guest kernels can mount a Denial of Service (DoS) attack affecting the entire system.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version 
number.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-358.html");
...
"Apply the appropriate patch or workaround according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-29570");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset 136ac88)';
fixes['4.10']['affected_ver_regex']  = "^4\.10\.";
fixes['4.10']['affected_changesets'] = make_list('cbc06ee', 'fef52f1',
  '7073b82', '3056f89', '03569ab', '17b26b8', '66e2db1', 'fcc17dc',
...
fixes['4.11']['fixed_ver_display']   = '4.11.4 (changeset 2d49825)';
fixes['4.11']['affected_ver_regex']  = "^4\.11\.";
fixes['4.11']['affected_changesets'] = make_list('24f7d03', 'f1f3dee',
...
fixes['4.12']['fixed_ver_display']   = '4.12.4 (changeset 51e9505)';
fixes['4.12']['affected_ver_regex']  = "^4\.12\.";
fixes['4.12']['affected_changesets'] = make_list('4943ea7', '3c13a87',
...
fixes['4.13']['fixed_ver_display']   = '4.13.3-pre (changeset bb534d6)';
fixes['4.13']['affected_ver_regex']  = "^4\.13\.";
fixes['4.13']['affected_changesets'] = make_list('16d0dc0', '13afcdf',
  'd39eb6f', 'a2f7ae1', 'd6a55f1', 'c6196ca', '18c0abb', '782aa4b',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset 9872981)';
fixes['4.14']['affected_ver_regex']  = "^4\.14\.";
fixes['4.14']['affected_changesets'] = make_list('d785e07', 'd8f08a4',
  '5174e42', 'bfc99c3', '13268c5', 'de822c4', '57bbcd0', '7214cc7',
  '49ed711', 'dc871dd', 'b1c5e40', '61d3863', '9e53440', '335ef5b',
