...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2017-B-0148-S");

  script_name(english:"Xen Hypervisor Pin Count / Page Reference Grant Table Code Guest-to-Host Memory Corruption (XSA-236)");
...
installed on the remote host is affected by a memory corruption
vulnerability. This may allow an attacker on the guest to cause a
denial of service or gain elevated privileges on the host.
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"http://xenbits.xenproject.org/xsa/advisory-236.html");
...
fixes['4.5']['fixed_ver_display']   = '4.5.5 (changeset 08aa260)';
fixes['4.5']['affected_ver_regex']  = '^4\\.5\\.';
fixes['4.5']['affected_changesets'] = make_list("03b06d3", "77666b6",
  "bbeb763", "5fdf16f", "0e9967d", "da4f24d", "b7582ac", "196371c",
  "7afc8ad", "72c107b", "5659aa5", "a224de6", "6442fa9", "db487a6",
  "709230f", "83724d9", "04b8c4c", "0b2ceae", "e3f0768", "d5a5231",
...
fixes['4.6']['fixed_ver_display']   = '4.6.6 (changeset 9454e30)';
fixes['4.6']['affected_ver_regex']  = '^4\\.6\\.';
fixes['4.6']['affected_changesets'] = make_list("aad5a67", "d8b0ebf",
  "f0208a4", "42b2c82", "57318e1", "9f22d72", "e0353b4", "76f1549",
  "9bac910", "c7a43e3", "913d4f8", "c5881c5", "b0239cd", "78fd0c3",
  "9079e0d", "1658a87", "22b6dfa", "a8cd231", "629eddd", "64c03bb",
  "b4660b4", "1ac8162", "747df3c", "5ae011e", "f974d32", "3300ad3", "d708b69");

fixes['4.7']['fixed_ver']           = '4.7.4';
fixes['4.7']['fixed_ver_display']   = '4.7.4-pre (changeset f03b9e8)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("df0949d", "c10dc54",
  "8cd1258", "1d01ddc", "5ca7d11", "ebd47d4", "6a6a339", "e61be54",
  "e3f7a64", "957ad23", "b1ae705", "3add76f", "314a8fc", "d6aad63",
  "7c99633", "145c18d", "c3fa5cd", "487f8f9", "ffcfc40", "c7783d9",
  "3331050", "83966a3", "a67b223", "68dbba2", "2728470", "dea68ed",
  "9d12253", "73d7bc5", "b704b1a", "ca4ef7b", "ece330a", "3d63ebc",
  "30d50f8", "2dc3cdb", "5151257", "c9f3ca0", "e873251", "8aebf85",
  "c362cde", "fece08a");

fixes['4.8']['fixed_ver']           = '4.8.3';
fixes['4.8']['fixed_ver_display']   = '4.8.3-pre (changeset fcbbd0f)';
fixes['4.8']['affected_ver_regex']  = '^4\\.8\\.';
fixes['4.8']['affected_changesets'] = make_list("0c647de", "bdc2ae6",
  "96e6364", "1a8ad09", "df89197", "c4f969d", "b1f3f1d", "7251c06",
  "1960ca8", "866cfa1", "ddd6e41", "370cc9a", "39e3024", "9f092f5",
  "667f70e", "2116fec", "1a535c3", "ee3fc24", "d623d82", "dda458c",
  "c642b12", "80d7ef3", "ff4f60a", "36898eb", "4d7ccae", "e574046",
  "90dafa4", "c020cf2");

fixes['4.9']['fixed_ver']           = '4.9.1';
fixes['4.9']['fixed_ver_display']   = '4.9.1-pre (changeset 174a569)';
fixes['4.9']['affected_ver_regex']  = '^4\\.9\\.';
fixes['4.9']['affected_changesets'] = make_list("2040ac1", "de38e28",
  "7fe0a24", "a2af47d", "61a2d31", "c2b0a92", "d842630", "ef61bcf",
  "44ceb19", "ae45442", "784afd9", "22032b2", "58da67f", "d1b64cc",
  "9cde7a8", "1cdcb36", "84c039e", "b244ac9", "612044a", "e8fd372",
  "a568e25", "8fef83e", "478e40c", "22ea731", "e7703a2", "91ded3b",
  "2cc3d32", "79775f5", "43cb0c4", "4821228", "d23bcc5", "308654c",
