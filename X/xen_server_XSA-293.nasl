...
if (description)
{
  ...
  script_cve_id("CVE-2019-17347");

  script_name(english:"Xen Project fsgsbase CPU Feature Privilege Escalation Vulnerability (XSA-293)");
...
vulnerability. Only x86 systems with the fsgsbase CPU feature are
affected.
...
recompile and reinstall.");
  script_set_attribute(attribute:"see_also", value:"https://xenbits.xen.org/xsa/advisory-293.html");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17347");
...
fixes['4.7']['fixed_ver_display']   = '4.7.6 (changeset f111e93)';
fixes['4.7']['affected_ver_regex']  = '^4\\.7\\.';
fixes['4.7']['affected_changesets'] = make_list("4bd37f1", "1b3e639",
  "0bdd0db", "c1f397d", "516671a", "384a6dd", "a1500d4", "362cca8",
...
fixes['4.10']['fixed_ver_display']   = '4.10.4-pre (changeset 9f663d2)';
fixes['4.10']['affected_ver_regex']  = '^4\\.10\\.';
fixes['4.10']['affected_changesets'] = make_list("d176cd6", "a595111",
  "aae0d18", "631b902", "f6f1e94", "b450b20", "dfc7e3c", "382e4a6",
  "edbc9b0", "edb80d2");

fixes['4.11']['fixed_ver']           = '4.11.2';
fixes['4.11']['fixed_ver_display']   = '4.11.2-pre (changeset 4f9ab5f)';
fixes['4.11']['affected_ver_regex']  = '^4\\.11\\.';
fixes['4.11']['affected_changesets'] = make_list("c567b05", "6c197f9",
  "7bbd3a5", "92227e2", "4835974", "be58f86", "4298abd", "4f785ea",
