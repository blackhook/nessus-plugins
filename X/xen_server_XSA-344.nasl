...
if (description)
{
  ...
  script_cve_id("CVE-2020-25601");
  script_xref(name:"IAVB", value:"2020-B-0056-S");

  script_name(english:"Xen lack of preemption in evtchn_reset() / evtchn_destroy() DoS (XSA-344)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Xen hypervisor installation is missing a security update.");
  script_set_attribute(attribute:"description", value:
"A denial of service (DoS) vulnerability exists in Xen servers in FIFO event channel modules evtchn_reset() / 
evtchn_destroy() due to a lack of preemption. An authenticated, local attacker can mount a Denial of Service (DoS) 
attack affecting the entire system.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version 
number.");
  # https://xenbits.xen.org/xsa/advisory-344.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d527020d");
...
"Apply the appropriate patch or workaround according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-25601");
...
fixes['4.10']['fixed_ver_display']   = '4.10.4 (changeset f58caa4)';
fixes['4.10']['affected_ver_regex']  = "^4\.10\.";
fixes['4.10']['affected_changesets'] = make_list('f2befb6', '83b7f04',
...
fixes['4.11']['fixed_ver_display']   = '4.11.4 (changeset 3263f25)';
fixes['4.11']['affected_ver_regex']  = "^4\.11\.";
fixes['4.11']['affected_changesets'] = make_list('3e565a9', '30b3f29',
...
fixes['4.12']['fixed_ver_display']   = '4.12.4-pre (changeset cfd61e6)';
fixes['4.12']['affected_ver_regex']  = "^4\.12\.";
fixes['4.12']['affected_changesets'] = make_list('2aa4864', '8e25d52',
...
fixes['4.13']['fixed_ver_display']   = '4.13.2-pre (changeset b015fbe)';
fixes['4.13']['affected_ver_regex']  = "^4\.13\.";
fixes['4.13']['affected_changesets'] = make_list('54becf6', '43572a4',
...
fixes['4.14']['fixed_ver_display']   = '4.14.1-pre (changeset 03019c2)';
fixes['4.14']['affected_ver_regex']  = "^4\.14\.";
fixes['4.14']['affected_changesets'] = make_list('66cdf34', 'ecc6428',
