...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : docker-engine (EulerOS-SA-2022-1550)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1550
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2869734");
...
var pkgs = [
  "docker-engine-18.09.0.101-1.h49.19.9.eulerosv2r7",
  "docker-engine-selinux-18.09.0.101-1.h49.19.9.eulerosv2r7"
];
