...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : httpd (EulerOS-SA-2021-2832)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2832
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c04bf861");
...
var pkgs = [
  "httpd-2.4.6-80.1.h11",
  "httpd-tools-2.4.6-80.1.h11",
  "mod_ssl-2.4.6-80.1.h11"
];
