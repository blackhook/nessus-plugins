...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : golang (EulerOS-SA-2020-1852)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1852
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5723088d");
...
pkgs = ["golang-1.11.2-16.eulerosv2r8",
        "golang-bin-1.11.2-16.eulerosv2r8",
        "golang-src-1.11.2-16.eulerosv2r8"];
