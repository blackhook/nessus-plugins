...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : httpd (EulerOS-SA-2021-2381)");
...
vulnerabilities :
  ...
  - In Apache HTTP Server versions 2.4.0 to 2.4.46 a
    specially crafted SessionHeader sent by an origin
    server could cause a heap overflow(CVE-2021-26691)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2381
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?993e4329");
...
pkgs = ["httpd-2.4.6-45.0.1.4.h18",
        "httpd-devel-2.4.6-45.0.1.4.h18",
        "httpd-manual-2.4.6-45.0.1.4.h18",
        "httpd-tools-2.4.6-45.0.1.4.h18",
        "mod_ssl-2.4.6-45.0.1.4.h18"];
