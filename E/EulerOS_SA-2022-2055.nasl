...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libarchive (EulerOS-SA-2022-2055)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2055
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2655944");
...
var pkgs = [
  "libarchive-3.4.3-2.h3.eulerosv2r10"
];
