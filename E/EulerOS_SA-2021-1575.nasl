...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : sudo (EulerOS-SA-2021-1575)");
...
by the following vulnerabilities :
  ...
  - The sudoedit personality of Sudo before 1.9.5 may allow
    a local unprivileged user to perform arbitrary
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1575
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?921c6501");
...
pkgs = ["sudo-1.8.23-3.h18.eulerosv2r8"];
