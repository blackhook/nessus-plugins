...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libxslt (EulerOS-SA-2022-2472)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libxslt packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2472
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0becc93c");
...
var pkgs = [
  "libxslt-1.1.32-3.h7.eulerosv2r8",
  "libxslt-devel-1.1.32-3.h7.eulerosv2r8"
];
