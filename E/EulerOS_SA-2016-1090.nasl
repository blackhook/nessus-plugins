...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : python (EulerOS-SA-2016-1090)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1090
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6fc64183");
...
pkgs = ["python-2.7.5-48.h2",
        "python-devel-2.7.5-48.h2",
        "python-libs-2.7.5-48.h2"];
