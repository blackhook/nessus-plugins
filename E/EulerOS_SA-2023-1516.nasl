...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : sudo (EulerOS-SA-2023-1516)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1516
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9af1d9b9");
...
var pkgs = [
  "sudo-1.8.19p2-14.h10.eulerosv2r7"
];
