...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : gnutls (EulerOS-SA-2017-1115)");
...
vulnerability :
  ...
  - GnuTLS before 2017-02-20 has an out-of-bounds write
    caused by an integer overflow and heap-based buffer
    overflow related to the cdk_pkt_read function in
    opencdk/read-packet.c. This issue (which is a subset of
    the vendor's GNUTLS-SA-2017-3 report) is fixed in
    3.5.10.i1/4^CVE-2017-7869i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1115
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28585f1f");
...
pkgs = ["gnutls-3.3.8-14.h2",
        "gnutls-c++-3.3.8-14.h2",
        "gnutls-dane-3.3.8-14.h2",
        "gnutls-devel-3.3.8-14.h2",
        "gnutls-utils-3.3.8-14.h2"];
