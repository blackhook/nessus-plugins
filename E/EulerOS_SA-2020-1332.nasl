...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : libssh (EulerOS-SA-2020-1332)");
...
by the following vulnerability :
  ...
  - A flaw was found with the libssh API function
    ssh_scp_new(). A user able to connect to a server using
    SCP could execute arbitrary command using a
    user-provided path, leading to a compromise of the
    remote target.(CVE-2019-14889)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1332
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9796c967");
