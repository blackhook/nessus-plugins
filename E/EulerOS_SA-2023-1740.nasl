...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : libxml2 (EulerOS-SA-2023-1740)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1740
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98f2cbea");
...
var pkgs = [
  "libxml2-2.9.1-6.3.h33",
  "libxml2-devel-2.9.1-6.3.h33",
  "libxml2-python-2.9.1-6.3.h33"
];
