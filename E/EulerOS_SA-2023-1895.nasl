...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : pixman (EulerOS-SA-2023-1895)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1895
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f11fc04f");
...
var pkgs = [
  "pixman-0.40.0-1.h1.eulerosv2r10"
];
