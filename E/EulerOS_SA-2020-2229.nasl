...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : perl (EulerOS-SA-2020-2229)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2229
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1ce3aec7");
...
pkgs = ["perl-5.16.3-292.h12.eulerosv2r7",
        "perl-File-Path-2.09-2.h1.eulerosv2r7",
