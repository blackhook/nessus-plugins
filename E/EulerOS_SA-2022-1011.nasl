...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libarchive (EulerOS-SA-2022-1011)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1011
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66381496");
...
var pkgs = [
  "libarchive-3.4.1-4.h1.eulerosv2r9"
];
