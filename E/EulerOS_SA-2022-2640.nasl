...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : xorg-x11-server  (EulerOS-SA-2022-2640)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2640
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e48b863");
...
var pkgs = [
  "xorg-x11-server-Xephyr-1.17.2-10.h12",
  "xorg-x11-server-Xorg-1.17.2-10.h12",
  "xorg-x11-server-common-1.17.2-10.h12"
];
