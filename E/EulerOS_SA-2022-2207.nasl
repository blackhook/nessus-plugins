...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : protobuf (EulerOS-SA-2022-2207)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2207
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d90aafce");
...
var pkgs = [
  "protobuf-3.9.0-9.h3.eulerosv2r9",
  "protobuf-compiler-3.9.0-9.h3.eulerosv2r9"
];
