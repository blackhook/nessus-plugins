...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gstreamer1-plugins-bad-free (EulerOS-SA-2022-1346)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1346
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ad38384f");
...
var pkgs = [
  "gstreamer1-plugins-bad-free-1.14.4-1.h2.eulerosv2r8"
];
