...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : samba (EulerOS-SA-2022-1145)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1145
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?35b1f81d");
...
var pkgs = [
  "libsmbclient-4.7.1-9.h27.eulerosv2r7",
