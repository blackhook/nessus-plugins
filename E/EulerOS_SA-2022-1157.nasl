...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ceph-common (EulerOS-SA-2022-1157)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1157
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?41ad2fbc");
...
var pkgs = [
  "ceph-common-0.80.7-4.h1",
  "librados2-0.80.7-4.h1",
  "librbd1-0.80.7-4.h1",
  "python-rados-0.80.7-4.h1",
  "python-rbd-0.80.7-4.h1"
];
