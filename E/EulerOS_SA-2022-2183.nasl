...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : libxml2 (EulerOS-SA-2022-2183)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2183
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c1d3f776");
...
var pkgs = [
  "libxml2-2.9.10-1.h26.eulerosv2r9",
  "python3-libxml2-2.9.10-1.h26.eulerosv2r9"
];
