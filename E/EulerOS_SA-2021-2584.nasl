...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : gstreamer-plugins-good (EulerOS-SA-2021-2584)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gstreamer-plugins-good package installed, the EulerOS installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2584
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7ea5e7b");
...
var pkgs = [
  "gstreamer-plugins-good-0.10.31-13.h1"
];
