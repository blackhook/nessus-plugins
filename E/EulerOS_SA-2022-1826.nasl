...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : flac (EulerOS-SA-2022-1826)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1826
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45c09e52");
...
var pkgs = [
  "flac-help-1.3.3-4.h3.eulerosv2r10"
];
