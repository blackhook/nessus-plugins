...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : c-ares (EulerOS-SA-2023-2117)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2117
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c135d31");
...
var pkgs = [
  "c-ares-1.18.1-1.h2.eulerosv2r11"
];
