...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.0 : openssl (EulerOS-SA-2018-1339)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1339
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c7a9848");
...
pkgs = ["openssl-1.0.2k-8.h1",
        "openssl-devel-1.0.2k-8.h1",
        "openssl-libs-1.0.2k-8.h1"];
