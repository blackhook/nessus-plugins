...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-engine (EulerOS-SA-2022-1658)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1658
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ce893c22");
...
var pkgs = [
  "docker-engine-18.09.0.200-200.h44.25.14.eulerosv2r10",
  "docker-engine-selinux-18.09.0.200-200.h44.25.14.eulerosv2r10"
];
