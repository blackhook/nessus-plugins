...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : haproxy (EulerOS-SA-2022-1866)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1866
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?93b2a275");
...
var pkgs = [
  "haproxy-2.0.14-1.h5.eulerosv2r9"
];
