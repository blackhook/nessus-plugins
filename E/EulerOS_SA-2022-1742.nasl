...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libxv (EulerOS-SA-2022-1742)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libxv packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1742
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26a54f2a");
  script_set_attribute(attribute:"solution", value:
"Update the affected libxv packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:libXv-devel");
