...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : bcel (EulerOS-SA-2023-1307)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the bcel packages installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1307
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c909d53");
...
var pkgs = [
  "bcel-6.2-3.h1.eulerosv2r8",
  "hunspell-1.6.2-3.h1.eulerosv2r8",
