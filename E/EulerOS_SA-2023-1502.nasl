...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : git (EulerOS-SA-2023-1502)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1502
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd36d7dc");
...
var pkgs = [
  "git-2.23.0-1.h10.eulerosv2r7",
  "git-core-2.23.0-1.h10.eulerosv2r7",
  "git-core-doc-2.23.0-1.h10.eulerosv2r7",
  "perl-Git-2.23.0-1.h10.eulerosv2r7"
];
