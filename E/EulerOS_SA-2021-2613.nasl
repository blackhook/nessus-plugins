...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : rpm (EulerOS-SA-2021-2613)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2613
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd63ffe5");
...
var pkgs = [
  "rpm-4.11.3-21.h8",
  "rpm-build-4.11.3-21.h8",
  "rpm-build-libs-4.11.3-21.h8",
  "rpm-devel-4.11.3-21.h8",
  "rpm-libs-4.11.3-21.h8",
  "rpm-python-4.11.3-21.h8",
  "rpm-sign-4.11.3-21.h8"
];
