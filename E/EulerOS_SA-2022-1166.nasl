...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : golang (EulerOS-SA-2022-1166)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1166
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7d3c0671");
...
var pkgs = [
  "golang-1.13.3-9.h6",
  "golang-bin-1.13.3-9.h6",
  "golang-src-1.13.3-9.h6"
];
