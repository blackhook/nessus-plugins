...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : python (EulerOS-SA-2020-2095)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2095
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?62ee4ac7");
...
pkgs = ["python-2.7.5-58.h27",
        "python-devel-2.7.5-58.h27",
        "python-libs-2.7.5-58.h27",
        "tkinter-2.7.5-58.h27"];
