...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : cups (EulerOS-SA-2022-1369)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1369
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28c2a625");
...
"Update the affected cups packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:cups-help");
...
var pkgs = [
  "cups-2.2.13-4.h4.eulerosv2r10",
  "cups-devel-2.2.13-4.h4.eulerosv2r10",
  "cups-help-2.2.13-4.h4.eulerosv2r10",
  "cups-libs-2.2.13-4.h4.eulerosv2r10"
];
