...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : virglrenderer (EulerOS-SA-2022-1198)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the virglrenderer packages installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1198
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c03aa67b");
...
var pkgs = [
  "virglrenderer-0.6.0-9.20170210git76b3da97b.h1.eulerosv2r8",
  "virglrenderer-devel-0.6.0-9.20170210git76b3da97b.h1.eulerosv2r8"
];
