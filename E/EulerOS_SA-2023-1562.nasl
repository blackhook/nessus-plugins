...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : protobuf (EulerOS-SA-2023-1562)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the protobuf packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1562
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e73582cd");
...
var pkgs = [
  "protobuf-3.12.3-14.h4.eulerosv2r10",
  "protobuf-compiler-3.12.3-14.h4.eulerosv2r10"
];
