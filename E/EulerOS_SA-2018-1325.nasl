...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : php (EulerOS-SA-2018-1325)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1325
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9dde268");
...
pkgs = ["php-5.4.16-42.h8",
        "php-cli-5.4.16-42.h8"];
