...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : postgresql (EulerOS-SA-2020-1587)");
...
vulnerability :
  ...
  - A flaw was found in PostgreSQL's 'ALTER ... DEPENDS ON
    EXTENSION', where sub-commands did not perform
    authorization checks. An authenticated attacker could
    use this flaw in certain configurations to perform drop
    objects such as function, triggers, et al., leading to
    database corruption. This issue affects PostgreSQL
    versions before 12.2, before 11.7, before 10.12 and
    before 9.6.17.(CVE-2020-1720)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1587
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a174641");
...
pkgs = ["postgresql-10.5-3.h7.eulerosv2r8",
        "postgresql-contrib-10.5-3.h7.eulerosv2r8",
        "postgresql-devel-10.5-3.h7.eulerosv2r8",
        "postgresql-docs-10.5-3.h7.eulerosv2r8",
        "postgresql-libs-10.5-3.h7.eulerosv2r8",
        "postgresql-plperl-10.5-3.h7.eulerosv2r8",
        "postgresql-plpython-10.5-3.h7.eulerosv2r8",
        "postgresql-pltcl-10.5-3.h7.eulerosv2r8",
        "postgresql-server-10.5-3.h7.eulerosv2r8",
        "postgresql-test-10.5-3.h7.eulerosv2r8"];
