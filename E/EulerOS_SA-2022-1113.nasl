...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : cifs-utils (EulerOS-SA-2022-1113)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1113
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dd9711b0");
...
var pkgs = [
  "cifs-utils-6.2-10.h3.eulerosv2r7"
];
