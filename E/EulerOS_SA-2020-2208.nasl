...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : memcached (EulerOS-SA-2020-2208)");
...
"According to the versions of the memcached packages installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2208
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1c3da76");
...
"Update the affected memcached packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python-memcached");
...
pkgs = ["memcached-1.4.15-10.1.h2.eulerosv2r7",
        "python-memcached-1.48-4.eulerosv2r7"];
