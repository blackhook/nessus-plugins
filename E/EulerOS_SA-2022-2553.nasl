...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : dnsmasq (EulerOS-SA-2022-2553)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2553
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ccc5f1f3");
...
var pkgs = [
  "dnsmasq-2.79-7.h7.eulerosv2r8",
  "dnsmasq-utils-2.79-7.h7.eulerosv2r8"
];
