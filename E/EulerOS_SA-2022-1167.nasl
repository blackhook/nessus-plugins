...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : httpd (EulerOS-SA-2022-1167)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1167
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e0f663a");
...
var pkgs = [
  "httpd-2.4.6-45.0.1.4.h23",
  "httpd-devel-2.4.6-45.0.1.4.h23",
  "httpd-manual-2.4.6-45.0.1.4.h23",
  "httpd-tools-2.4.6-45.0.1.4.h23",
  "mod_ssl-2.4.6-45.0.1.4.h23"
];
