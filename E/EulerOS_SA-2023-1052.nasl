...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : openssl (EulerOS-SA-2023-1052)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1052
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92eaf186");
...
var pkgs = [
  "openssl-1.0.2k-16.h15.eulerosv2r7",
  "openssl-devel-1.0.2k-16.h15.eulerosv2r7",
  "openssl-libs-1.0.2k-16.h15.eulerosv2r7"
];
