...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : binutils (EulerOS-SA-2021-2521)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2521
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31c7bb68");
...
var pkgs = [
  "binutils-2.34-1.h20.eulerosv2r9"
];
