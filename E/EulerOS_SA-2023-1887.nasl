...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : emacs (EulerOS-SA-2023-1887)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1887
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c1c47c8");
...
var pkgs = [
  "emacs-filesystem-27.1-4.h5.eulerosv2r10"
];
