...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libvorbis (EulerOS-SA-2022-1080)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libvorbis package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1080
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f6dfe4f");
...
var pkgs = [
  "libvorbis-1.3.6-3.h3.eulerosv2r8"
];
