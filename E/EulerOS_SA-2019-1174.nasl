...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : dnsmasq (EulerOS-SA-2019-1174)");
...
the following vulnerabilities :
  ...
  - An integer underflow flaw leading to a buffer over-read
    was found in dnsmasq in the DNS code. An attacker could
    send crafted DNS packets to dnsmasq which would cause
    it to crash.i1/4^CVE-2017-13704i1/4%0
  ...
  - A vulnerability was found in Dnsmasq's implementation
    ...
    hostnames that actually exist.i1/4^CVE-2017-15107i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1174
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04f73541");
...
pkgs = ["dnsmasq-2.76-2.3",
        "dnsmasq-utils-2.76-2.3"];
