...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : dhcp (EulerOS-SA-2023-1727)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1727
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a9134546");
...
var pkgs = [
  "dhclient-4.2.5-68.1.h19",
  "dhcp-4.2.5-68.1.h19",
  "dhcp-common-4.2.5-68.1.h19",
  "dhcp-libs-4.2.5-68.1.h19"
];
