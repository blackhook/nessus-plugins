...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : gstreamer (EulerOS-SA-2017-1205)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1205
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f617f494");
...
"Update the affected gstreamer packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:gstreamer1-plugins-base-tools");
...
pkgs = ["gstreamer-plugins-bad-free-0.10.23-23",
        "gstreamer-plugins-bad-free-devel-0.10.23-23",
        "gstreamer-plugins-bad-free-devel-docs-0.10.23-23",
