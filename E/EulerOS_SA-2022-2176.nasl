...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : bind (EulerOS-SA-2022-2176)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2176
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?81037694");
...
var pkgs = [
  "bind-9.11.4-17.h16.eulerosv2r9",
  "bind-chroot-9.11.4-17.h16.eulerosv2r9",
  "bind-export-libs-9.11.4-17.h16.eulerosv2r9",
  "bind-libs-9.11.4-17.h16.eulerosv2r9",
  "bind-libs-lite-9.11.4-17.h16.eulerosv2r9",
  "bind-pkcs11-9.11.4-17.h16.eulerosv2r9",
  "bind-utils-9.11.4-17.h16.eulerosv2r9",
  "python3-bind-9.11.4-17.h16.eulerosv2r9"
];
