...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-pillow (EulerOS-SA-2023-1110)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1110
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77a45713");
...
var pkgs = [
  "python3-pillow-5.3.0-4.h22.eulerosv2r9",
  "python3-pillow-help-5.3.0-4.h22.eulerosv2r9"
];
