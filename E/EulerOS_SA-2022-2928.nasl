...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : e2fsprogs (EulerOS-SA-2022-2928)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the e2fsprogs package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2928
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?706974a7");
...
var pkgs = [
  "e2fsprogs-1.45.6-1.h12.eulerosv2r10"
];
