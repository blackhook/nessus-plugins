...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : kernel (EulerOS-SA-2018-1352)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1352
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cea57acd");
...
pkgs = ["kernel-3.10.0-514.44.5.10_102",
        "kernel-devel-3.10.0-514.44.5.10_102",
        "kernel-headers-3.10.0-514.44.5.10_102",
        "kernel-tools-3.10.0-514.44.5.10_102",
        "kernel-tools-libs-3.10.0-514.44.5.10_102",
        "kernel-tools-libs-devel-3.10.0-514.44.5.10_102"];
