...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : bind (EulerOS-SA-2021-2320)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2320
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03b87963");
...
pkgs = ["bind-9.9.4-61.1.h16.eulerosv2r7",
