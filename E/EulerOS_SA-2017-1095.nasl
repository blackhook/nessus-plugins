...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : jasper (EulerOS-SA-2017-1095)");
...
vulnerabilities :
  ...
  - Multiple flaws were found in the way JasPer decoded
    JPEG 2000 image files. A specially crafted file could
    cause an application using JasPer to crash or,
    possibly, execute arbitrary code. (CVE-2016-8654,
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1095
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c5f5394");
