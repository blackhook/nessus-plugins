...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : freeradius (EulerOS-SA-2023-1312)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the freeradius package installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1312
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3b78868c");
...
var pkgs = [
  "freeradius-3.0.15-14.h7.eulerosv2r8"
];
