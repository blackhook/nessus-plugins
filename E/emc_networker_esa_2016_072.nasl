...
different NetWorker instance.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2016/Jun/att-43/ESA-2016-072.txt");
...
"Upgrade to EMC NetWorker 8.2.2.6 / 8.2.3.0 / 9.0.0.6 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0916");
