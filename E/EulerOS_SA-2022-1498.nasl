...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : uboot-tools (EulerOS-SA-2022-1498)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1498
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?99407605");
...
var pkgs = [
  "uboot-tools-2020.07-2.h3.eulerosv2r10",
  "uboot-tools-help-2020.07-2.h3.eulerosv2r10"
];
