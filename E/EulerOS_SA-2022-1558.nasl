...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ceph (EulerOS-SA-2022-1558)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the ceph packages installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1558
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8bd29ddb");
...
var pkgs = [
  "librados2-12.2.8-1.h12.eulerosv2r8",
  "librbd1-12.2.8-1.h12.eulerosv2r8",
  "python-rados-12.2.8-1.h12.eulerosv2r8",
  "python-rbd-12.2.8-1.h12.eulerosv2r8"
];
