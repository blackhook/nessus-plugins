...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-pillow (EulerOS-SA-2021-2345)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2345
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eecd4c31");
...
pkgs = ["python-pillow-2.0.0-19.h12.gitd1c6db8.eulerosv2r7"];
