...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : bind (EulerOS-SA-2022-1685)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1685
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b85c6bfb");
...
var pkgs = [
  "bind-libs-9.9.4-61.1.h17",
  "bind-libs-lite-9.9.4-61.1.h17",
  "bind-license-9.9.4-61.1.h17",
  "bind-utils-9.9.4-61.1.h17"
];
