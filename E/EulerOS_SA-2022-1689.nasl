...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : xorg-x11-server (EulerOS-SA-2022-1689)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1689
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c80afc1e");
...
var pkgs = [
  "xorg-x11-server-Xorg-1.19.5-5.h15",
  "xorg-x11-server-common-1.19.5-5.h15"
];
