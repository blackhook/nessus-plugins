...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dpkg (EulerOS-SA-2022-2219)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the dpkg package installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2219
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc225b8d");
  script_set_attribute(attribute:"solution", value:
"Update the affected dpkg packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:dpkg");
