...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : rpm (EulerOS-SA-2022-1143)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1143
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?21bb1d6d");
...
var pkgs = [
  "rpm-4.11.3-32.h8.eulerosv2r7",
  "rpm-build-4.11.3-32.h8.eulerosv2r7",
  "rpm-build-libs-4.11.3-32.h8.eulerosv2r7",
  "rpm-devel-4.11.3-32.h8.eulerosv2r7",
  "rpm-libs-4.11.3-32.h8.eulerosv2r7",
  "rpm-python-4.11.3-32.h8.eulerosv2r7",
  "rpm-sign-4.11.3-32.h8.eulerosv2r7"
];
