...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : xorg-x11-server (EulerOS-SA-2017-1296)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1296
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?74b1a1f9");
...
pkgs = ["xorg-x11-server-Xephyr-1.17.2-10.h1",
        "xorg-x11-server-Xorg-1.17.2-10.h1",
        "xorg-x11-server-common-1.17.2-10.h1"];
