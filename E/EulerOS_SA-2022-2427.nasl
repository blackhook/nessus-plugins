...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-engine (EulerOS-SA-2022-2427)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2427
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4364c43");
...
var pkgs = [
  "docker-engine-18.09.0.200-200.h55.31.17.eulerosv2r10"
];
