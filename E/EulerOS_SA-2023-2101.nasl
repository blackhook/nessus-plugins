...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : python-pillow (EulerOS-SA-2023-2101)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-pillow packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2101
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f658c122");
...
"Update the affected python-pillow packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-45199");
...
var pkgs = [
  "python3-pillow-9.0.1-1.h3.eulerosv2r11",
  "python3-pillow-help-9.0.1-1.h3.eulerosv2r11"
];
