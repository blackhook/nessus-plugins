...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : apr-util (EulerOS-SA-2023-1860)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1860
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d9f77e64");
...
var pkgs = [
  "apr-util-1.6.1-11.h1.eulerosv2r9"
];
