...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : selinux-policy (EulerOS-SA-2022-2122)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2122
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2868fccd");
...
"Update the affected selinux-policy packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:selinux-policy-help");
...
var pkgs = [
  ...
  "selinux-policy-help-3.14.2-65.h21.eulerosv2r10"
];
