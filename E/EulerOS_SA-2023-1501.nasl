...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : expat (EulerOS-SA-2023-1501)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1501
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56878309");
...
var pkgs = [
  "expat-2.1.0-10.h12.eulerosv2r7",
  "expat-devel-2.1.0-10.h12.eulerosv2r7",
  "expat-static-2.1.0-10.h12.eulerosv2r7"
];
