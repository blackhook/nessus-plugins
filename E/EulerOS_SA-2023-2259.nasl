...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : apr-util  (EulerOS-SA-2023-2259)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the apr-util  package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2259
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?410621aa");
...
var pkgs = [
  "apr-util-1.6.1-12.h3.eulerosv2r11"
];
