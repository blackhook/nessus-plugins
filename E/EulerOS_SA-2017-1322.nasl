...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : mariadb (EulerOS-SA-2017-1322)");
...
vulnerability :
  ...
  - Vulnerability in the MySQL Server component of Oracle
    ...
    MySQL Server accessible data and unauthorized ability
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1322
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?faec9aa9");
...
pkgs = ["mariadb-5.5.56-2.h1",
        "mariadb-bench-5.5.56-2.h1",
        "mariadb-devel-5.5.56-2.h1",
        "mariadb-embedded-5.5.56-2.h1",
        "mariadb-libs-5.5.56-2.h1",
        "mariadb-server-5.5.56-2.h1",
        "mariadb-test-5.5.56-2.h1"];
