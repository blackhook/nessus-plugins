...
application, possibly even reading arbitrary database entries." );
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2005/Jun/7" );
 script_set_attribute(attribute:"see_also", value:"https://photography-on-the.net/forum/showthread.php?p=579692" );
