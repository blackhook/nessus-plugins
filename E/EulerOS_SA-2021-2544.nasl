...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : xorg-x11-server (EulerOS-SA-2021-2544)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2544
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58bee7bb");
...
var pkgs = [
  "xorg-x11-server-help-1.20.6-5.h5.eulerosv2r9"
];
