...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : rsyslog (EulerOS-SA-2023-1291)");
...
is affected by the following vulnerabilities :
  ...
  - The zmq3 input and output modules in rsyslog before 8.28.0 interpreted description fields as format
    strings, possibly allowing a format string attack with unspecified impact. (CVE-2017-12588)
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1291
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bf488230");
