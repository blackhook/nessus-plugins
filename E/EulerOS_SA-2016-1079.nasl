...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : bind (EulerOS-SA-2016-1079)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1079
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25a2542b");
...
pkgs = ["bind-9.9.4-29.4.h3",
        "bind-chroot-9.9.4-29.4.h3",
        "bind-libs-9.9.4-29.4.h3",
        "bind-libs-lite-9.9.4-29.4.h3",
        "bind-license-9.9.4-29.4.h3",
        "bind-utils-9.9.4-29.4.h3"];
