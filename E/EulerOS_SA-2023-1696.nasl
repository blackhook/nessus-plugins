...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : bind (EulerOS-SA-2023-1696)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1696
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?24d66a26");
...
var pkgs = [
  "bind-libs-9.9.4-61.1.h19",
  "bind-libs-lite-9.9.4-61.1.h19",
  "bind-license-9.9.4-61.1.h19",
  "bind-utils-9.9.4-61.1.h19"
];
