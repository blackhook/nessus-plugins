...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : emacs (EulerOS-SA-2023-2237)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2237
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d97113c0");
...
var pkgs = [
  "emacs-common-26.1-8.h3.eulerosv2r8",
  "emacs-filesystem-26.1-8.h3.eulerosv2r8",
  "emacs-nox-26.1-8.h3.eulerosv2r8"
];
