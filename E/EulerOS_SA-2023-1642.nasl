...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : libXpm (EulerOS-SA-2023-1642)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1642
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b53e3086");
...
var pkgs = [
  "libXpm-3.5.12-11.h1.eulerosv2r9"
];
