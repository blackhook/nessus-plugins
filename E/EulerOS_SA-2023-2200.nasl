...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libjpeg-turbo (EulerOS-SA-2023-2200)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2200
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?277c2eaf");
...
var pkgs = [
  "libjpeg-turbo-2.0.0-1.h5.eulerosv2r8",
  "libjpeg-turbo-devel-2.0.0-1.h5.eulerosv2r8"
];
