...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : fetchmail (EulerOS-SA-2021-2658)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2658
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4e8e7e3");
...
var pkgs = [
  "fetchmail-6.3.24-7.h1.eulerosv2r7"
];
