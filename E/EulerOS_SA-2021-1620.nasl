...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : p11-kit (EulerOS-SA-2021-1620)");
...
"According to the versions of the p11-kit package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1620
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f90549cf");
...
pkgs = ["p11-kit-0.23.14-6.h2.eulerosv2r9"];
