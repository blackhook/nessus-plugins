...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : bluez (EulerOS-SA-2022-1219)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1219
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72f2a223");
...
var pkgs = [
  "bluez-help-5.54-1.h4.eulerosv2r10"
];
