...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : flac (EulerOS-SA-2022-2556)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2556
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c3603ca");
...
var pkgs = [
  "flac-libs-1.3.2-8.h2.eulerosv2r8"
];
