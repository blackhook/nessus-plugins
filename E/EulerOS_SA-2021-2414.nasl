...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : openjpeg (EulerOS-SA-2021-2414)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2414
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2119d5e8");
...
"Update the affected openjpeg packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2018-16375");
...
pkgs = ["openjpeg-libs-1.5.1-16.h8"];
