...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : libsoup (EulerOS-SA-2017-1209)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1209
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92c35d89");
...
pkgs = ["libsoup-2.48.1-3.h1",
        "libsoup-devel-2.48.1-3.h1"];
