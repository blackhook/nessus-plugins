...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : python-pillow (EulerOS-SA-2023-1897)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1897
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4145d8a4");
...
var pkgs = [
  "python3-pillow-8.1.1-2.h9.eulerosv2r10",
  "python3-pillow-help-8.1.1-2.h9.eulerosv2r10"
];
