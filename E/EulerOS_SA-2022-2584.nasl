...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : protobuf (EulerOS-SA-2022-2584)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2584
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?277c6ddd");
...
var pkgs = [
  "protobuf-3.9.0-8.h7.eulerosv2r8",
  "protobuf-compiler-3.9.0-8.h7.eulerosv2r8"
];
