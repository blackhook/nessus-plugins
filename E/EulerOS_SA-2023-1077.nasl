...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : python-lxml (EulerOS-SA-2023-1077)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1077
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56c05886");
...
var pkgs = [
  "python-lxml-3.2.1-4.h6.eulerosv2r7"
];
