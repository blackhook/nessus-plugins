...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : openssh (EulerOS-SA-2017-1138)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1138
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00338f54");
...
pkgs = ["openssh-6.6.1p1-28.h9",
        "openssh-askpass-6.6.1p1-28.h9",
        "openssh-clients-6.6.1p1-28.h9",
        "openssh-keycat-6.6.1p1-28.h9",
        "openssh-server-6.6.1p1-28.h9"];
