...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : php-pear (EulerOS-SA-2021-1345)");
...
vulnerability :
  ...
  - Archive_Tar through 1.4.10 has :// filename
    sanitization only to address phar attacks, and thus any
    other stream-wrapper attack (such as file:// to
    overwrite files) can still succeed.(CVE-2020-28949)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1345
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9ff45ae5");
