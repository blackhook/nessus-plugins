...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : dnsmasq (EulerOS-SA-2017-1240)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1240
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?943277a5");
...
pkgs = ["dnsmasq-2.66-14.2.h1",
        "dnsmasq-utils-2.66-14.2.h1"];
