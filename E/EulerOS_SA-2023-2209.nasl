...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : dhcp (EulerOS-SA-2023-2209)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2209
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b5d5053");
...
var pkgs = [
  "dhcp-client-4.3.6-28.h18.eulerosv2r8",
  "dhcp-common-4.3.6-28.h18.eulerosv2r8",
  "dhcp-libs-4.3.6-28.h18.eulerosv2r8",
  "dhcp-relay-4.3.6-28.h18.eulerosv2r8",
  "dhcp-server-4.3.6-28.h18.eulerosv2r8"
];
