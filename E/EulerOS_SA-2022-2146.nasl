...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : selinux-policy (EulerOS-SA-2022-2146)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the selinux-policy packages installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2146
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f2c6b43d");
...
var pkgs = [
  "selinux-policy-3.14.2-65.h21.eulerosv2r10",
  "selinux-policy-minimum-3.14.2-65.h21.eulerosv2r10",
  "selinux-policy-mls-3.14.2-65.h21.eulerosv2r10",
  "selinux-policy-sandbox-3.14.2-65.h21.eulerosv2r10",
  "selinux-policy-targeted-3.14.2-65.h21.eulerosv2r10"
];
