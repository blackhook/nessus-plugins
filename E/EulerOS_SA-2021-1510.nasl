...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : perl-DBI (EulerOS-SA-2021-1510)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1510
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19ff7257");
...
pkgs = ["perl-DBI-1.627-4.h2.eulerosv2r7"];
