...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssl (EulerOS-SA-2022-1753)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1753
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?589017db");
...
var pkgs = [
  "openssl-1.0.2k-16.h18",
  "openssl-devel-1.0.2k-16.h18",
  "openssl-libs-1.0.2k-16.h18"
];
