...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : multipath-tools (EulerOS-SA-2023-1394)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the multipath-tools packages installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1394
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba9a3ce0");
...
var pkgs = [
  "kpartx-0.8.4-6.h13.eulerosv2r10",
  "multipath-tools-0.8.4-6.h13.eulerosv2r10"
];
