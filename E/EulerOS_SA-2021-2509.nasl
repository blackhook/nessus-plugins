...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : linuxptp (EulerOS-SA-2021-2509)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the linuxptp package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2509
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebe0c133");
  script_set_attribute(attribute:"solution", value:
"Update the affected linuxptp packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:linuxptp");
