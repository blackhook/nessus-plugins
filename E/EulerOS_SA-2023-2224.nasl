...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libtar (EulerOS-SA-2023-2224)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2224
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4b7c43d");
...
var pkgs = [
  "libtar-1.2.20-15.h3.eulerosv2r8"
];
