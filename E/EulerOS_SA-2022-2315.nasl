...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : git (EulerOS-SA-2022-2315)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2315
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?430af0ae");
...
var pkgs = [
  "git-2.23.0-12.h8.eulerosv2r9",
  "git-help-2.23.0-12.h8.eulerosv2r9"
];
