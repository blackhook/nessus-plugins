...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : java-1.8.0-openjdk (EulerOS-SA-2017-1015)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1015
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0f74e96");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.121-0.b13",
        "java-1.8.0-openjdk-devel-1.8.0.121-0.b13",
        "java-1.8.0-openjdk-headless-1.8.0.121-0.b13"];
