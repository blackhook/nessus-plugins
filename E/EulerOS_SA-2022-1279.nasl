...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : OpenEXR (EulerOS-SA-2022-1279)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1279
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?77f3cbdc");
...
var pkgs = [
  "OpenEXR-libs-1.7.1-7.h5.eulerosv2r7"
];
