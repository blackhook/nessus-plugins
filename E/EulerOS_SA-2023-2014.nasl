...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : curl (EulerOS-SA-2023-2014)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2014
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22d9d061");
...
var pkgs = [
  "curl-7.69.1-2.h20.eulerosv2r9",
  "libcurl-7.69.1-2.h20.eulerosv2r9"
];
