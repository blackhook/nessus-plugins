...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : compat-glibc (EulerOS-SA-2021-2653)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2653
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49812893");
...
var pkgs = [
  "compat-glibc-2.12-5.h2.eulerosv2r7",
  "compat-glibc-headers-2.12-5.h2.eulerosv2r7"
];
