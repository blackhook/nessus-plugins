...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : harfbuzz (EulerOS-SA-2023-1871)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1871
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c7c39b1");
...
var pkgs = [
  "harfbuzz-2.6.1-2.h4.eulerosv2r9",
  "harfbuzz-devel-2.6.1-2.h4.eulerosv2r9",
  "harfbuzz-help-2.6.1-2.h4.eulerosv2r9"
];
