...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : squid (EulerOS-SA-2022-2807)");
...
following vulnerabilities :
  ...
  - This update for squid fixes the following issues: Updated squid to version 5.7: - CVE-2022-41317: Fixed
    exposure of sensitive information in cache manager (bsc#1203677). - CVE-2022-41318: Fixed buffer overread
    in SSPI and SMB Authentication (bsc#1203680). (CVE-2022-41317)
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2807
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c34416d1");
