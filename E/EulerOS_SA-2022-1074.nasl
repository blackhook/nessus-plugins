...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libgcrypt (EulerOS-SA-2022-1074)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1074
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?47185bc8");
...
var pkgs = [
  "libgcrypt-1.8.3-3.h4.eulerosv2r8",
  "libgcrypt-devel-1.8.3-3.h4.eulerosv2r8"
];
