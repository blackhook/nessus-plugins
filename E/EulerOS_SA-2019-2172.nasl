...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libXfont (EulerOS-SA-2019-2172)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the libXfont package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2172
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9529e892");
...
pkgs = ["libXfont-1.5.2-1.h1.eulerosv2r7"];
