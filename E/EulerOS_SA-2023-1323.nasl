...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libexif (EulerOS-SA-2023-1323)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libexif package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1323
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82df0ea0");
...
"Update the affected libexif packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-0093");
...
var pkgs = [
  "libexif-0.6.21-17.h11.eulerosv2r8"
];
