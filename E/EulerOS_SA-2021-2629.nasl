...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : fetchmail (EulerOS-SA-2021-2629)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the fetchmail package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2629
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?53383742");
  script_set_attribute(attribute:"solution", value:
"Update the affected fetchmail packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:fetchmail");
...
var pkgs = [
  "fetchmail-6.3.26-22.h1.eulerosv2r8"
];
