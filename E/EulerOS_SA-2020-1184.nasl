...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : unzip (EulerOS-SA-2020-1184)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1184
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9430d97");
...
pkgs = ["unzip-6.0-40.h4.eulerosv2r8"];
