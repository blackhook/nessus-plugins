...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : systemd (EulerOS-SA-2023-2027)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2027
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?803bc254");
...
var pkgs = [
  "systemd-243-18.h118.eulerosv2r9",
  "systemd-container-243-18.h118.eulerosv2r9",
  "systemd-libs-243-18.h118.eulerosv2r9",
  "systemd-udev-243-18.h118.eulerosv2r9",
  "systemd-udev-compat-243-18.h118.eulerosv2r9"
];
