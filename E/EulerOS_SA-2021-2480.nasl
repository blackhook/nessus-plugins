...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : php-pear (EulerOS-SA-2021-2480)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the php-pear package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2480
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6b52df7");
  script_set_attribute(attribute:"solution", value:
"Update the affected php-pear packages.");
...
var pkgs = [
  "php-pear-1.10.6-1.h3.eulerosv2r8"
];
