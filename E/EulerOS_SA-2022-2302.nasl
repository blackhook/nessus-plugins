...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : python-jwt (EulerOS-SA-2022-2302)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python-jwt package installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2302
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d82c7e46");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-jwt packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:python-jwt-help");
...
var pkgs = [
  "python-jwt-help-1.7.1-2.h1.r1.eulerosv2r9"
];
