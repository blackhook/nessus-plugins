...
if (description)
{
  ...
  script_name(english:"EMC Unisphere for VMAX Virtual Appliance < 8.4.0.15 Authentication Bypass Vulnerability");
...
"The version of EMC Unisphere for VMAX Virtual Appliance running on
the remote host is prior to 8.4.0.15. It is, therefore, affected by
an authentication bypass vulnerability.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2017/Oct/70");
  script_set_attribute(attribute:"solution", value:
"Upgrade to EMC Unisphere for VMAX Virtual Appliance version 8.4.0.15
or later.");
  ...
  script_require_keys("Host/EMC/Unisphere for VMAX Virtual Appliance/Version", "Settings/ParanoidReport");
...
# A hotfix can be applied to 8.3.0.10
