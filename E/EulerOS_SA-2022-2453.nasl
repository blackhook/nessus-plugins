...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : 389-ds-base (EulerOS-SA-2022-2453)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2453
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3ab01efc");
...
var pkgs = [
  "389-ds-base-libs-1.4.0.16-1.h5.eulerosv2r8"
];
