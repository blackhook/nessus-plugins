...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : dnsmasq (EulerOS-SA-2020-1378)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1378
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03beb252");
...
pkgs = ["dnsmasq-2.76-2.2.h1",
        "dnsmasq-utils-2.76-2.2.h1"];
