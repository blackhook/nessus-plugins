...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : cups (EulerOS-SA-2023-1185)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1185
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e926e497");
...
var pkgs = [
  "cups-libs-2.2.13-3.h7.eulerosv2r9"
];
