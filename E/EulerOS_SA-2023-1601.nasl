...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : mod_security (EulerOS-SA-2023-1601)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1601
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?08d06267");
...
var pkgs = [
  "mod_security-2.9.2-6.h4.eulerosv2r8"
];
