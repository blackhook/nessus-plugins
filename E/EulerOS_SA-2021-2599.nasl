...
if (description)
{
  ...
  script_cve_id("CVE-2017-20005", "CVE-2021-3618", "CVE-2021-23017");
  script_xref(name:"IAVB", value:"2021-B-0031");

  script_name(english:"EulerOS 2.0 SP3 : nginx (EulerOS-SA-2021-2599)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the nginx package installed, the EulerOS installation on the remote host is affected by the
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2599
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2e09e43b");
