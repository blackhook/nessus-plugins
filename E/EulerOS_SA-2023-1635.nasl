...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : emacs (EulerOS-SA-2023-1635)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1635
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1cb8cf2f");
...
var pkgs = [
  "emacs-filesystem-26.1-13.h6.eulerosv2r9"
];
