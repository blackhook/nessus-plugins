...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : gd (EulerOS-SA-2017-1045)");
...
vulnerabilities :
  ...
  - Heap-based buffer overflow in the horizontalDifference8
    ...
    image to tiffcp.(CVE-2016-8670)

  - The gdImageCreate function in the GD Graphics Library
    (aka libgd) before 2.2.4 allows remote attackers to
    cause a denial of service (system hang) via an
    oversized image.(CVE-2016-9317)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1045
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71318847");
