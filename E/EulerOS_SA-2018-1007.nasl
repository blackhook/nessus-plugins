...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : krb5 (EulerOS-SA-2018-1007)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1007
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?031e180d");
...
pkgs = ["krb5-devel-1.14.1-26.h2",
        "krb5-libs-1.14.1-26.h2",
        "krb5-pkinit-1.14.1-26.h2",
        "krb5-server-1.14.1-26.h2",
        "krb5-server-ldap-1.14.1-26.h2",
        "krb5-workstation-1.14.1-26.h2",
        "libkadm5-1.14.1-26.h2"];
