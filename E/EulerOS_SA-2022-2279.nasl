...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : protobuf (EulerOS-SA-2022-2279)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the protobuf package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2279
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc2ab434");
...
var pkgs = [
  "protobuf-3.9.0-8.h7.eulerosv2r7"
];
