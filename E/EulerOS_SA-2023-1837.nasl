...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : docker-engine (EulerOS-SA-2023-1837)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1837
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?707f592f");
...
var pkgs = [
  "docker-engine-18.09.0.129-1.h68.32.18.eulerosv2r9"
];
