...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : openldap (EulerOS-SA-2021-2342)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2342
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5beeef8d");
...
pkgs = ["openldap-2.4.44-15.h15.eulerosv2r7",
