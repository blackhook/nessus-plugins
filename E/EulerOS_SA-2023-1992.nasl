...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : c-ares (EulerOS-SA-2023-1992)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1992
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6c269948");
...
var pkgs = [
  "c-ares-1.16.0-1.h6.eulerosv2r9"
];
