...
if (description)
{
  script_id(156309);
  script_version("1.2");
  script_set_attribute(attribute:"plugin_modification_date", value:"2021/12/26");

  script_cve_id("CVE-2021-28116");

  script_name(english:"EulerOS 2.0 SP8 : squid (EulerOS-SA-2021-2815)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2815
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f6338ed");
