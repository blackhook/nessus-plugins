...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : subversion (EulerOS-SA-2022-1588)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1588
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f6f098a0");
...
var pkgs = [
  "mod_dav_svn-1.10.2-1.h5.eulerosv2r8",
  "subversion-1.10.2-1.h5.eulerosv2r8",
  "subversion-libs-1.10.2-1.h5.eulerosv2r8"
];
