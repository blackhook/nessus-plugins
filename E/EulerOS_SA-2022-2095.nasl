...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : openjpeg2 (EulerOS-SA-2022-2095)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the openjpeg2 packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2095
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56fc8aa2");
...
var pkgs = [
  "openjpeg2-2.3.1-5.h7.eulerosv2r10",
  "openjpeg2-help-2.3.1-5.h7.eulerosv2r10"
];
