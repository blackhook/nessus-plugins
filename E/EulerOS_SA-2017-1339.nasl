...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : binutils (EulerOS-SA-2017-1339)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1339
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ab1d86c");
...
pkgs = ["binutils-2.23.52.0.1-55.h8",
        "binutils-devel-2.23.52.0.1-55.h8"];
