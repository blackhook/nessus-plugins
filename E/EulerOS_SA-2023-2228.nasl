...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : pixman (EulerOS-SA-2023-2228)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2228
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?23bb5222");
...
var pkgs = [
  "pixman-0.34.0-10.h1.eulerosv2r8",
  "pixman-devel-0.34.0-10.h1.eulerosv2r8"
];
