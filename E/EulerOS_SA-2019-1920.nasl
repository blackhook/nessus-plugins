...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : bzip2 (EulerOS-SA-2019-1920)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1920
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cdf50093");
...
pkgs = ["bzip2-1.0.6-14.h4",
        "bzip2-libs-1.0.6-14.h4"];
