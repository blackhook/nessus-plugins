...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : qemu-kvm (EulerOS-SA-2016-1066)");
...
vulnerabilities :
  ...
  - An integer overflow flaw and an out-of-bounds read flaw
    ...
    VGA registers while in VBE mode. A privileged guest
    user could use this flaw to crash the QEMU process
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1066
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f89fc9c3");
