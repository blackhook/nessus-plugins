...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : e2fsprogs (EulerOS-SA-2022-2600)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2600
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f4bb556");
...
var pkgs = [
  "e2fsprogs-1.43.6-1.h4",
  "e2fsprogs-devel-1.43.6-1.h4",
  "e2fsprogs-libs-1.43.6-1.h4"
];
