...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : openblas (EulerOS-SA-2022-1408)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the openblas package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1408
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9df1b974");
  script_set_attribute(attribute:"solution", value:
"Update the affected openblas packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:openblas");
...
var pkgs = [
  "openblas-0.3.10-1.h4.eulerosv2r10"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "openblas");
}
