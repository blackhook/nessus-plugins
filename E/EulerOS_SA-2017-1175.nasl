...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : subversion (EulerOS-SA-2017-1175)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1175
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1287ee12");
...
pkgs = ["subversion-1.7.14-11",
        "subversion-libs-1.7.14-11"];
