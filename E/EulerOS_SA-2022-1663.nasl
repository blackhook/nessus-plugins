...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : openssl (EulerOS-SA-2022-1663)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1663
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63563742");
...
var pkgs = [
  "openssl-1.1.1f-8.h23.eulerosv2r10",
  "openssl-libs-1.1.1f-8.h23.eulerosv2r10",
  "openssl-perl-1.1.1f-8.h23.eulerosv2r10"
];
