...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : shadow (EulerOS-SA-2022-2918)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2918
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc4472a8");
...
var pkgs = [
  "shadow-4.8.1-1.h22.eulerosv2r10"
];
