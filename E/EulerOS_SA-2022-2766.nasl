...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : golang (EulerOS-SA-2022-2766)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2766
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f365ac68");
...
"Update the affected golang packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-0601");
...
var pkgs = [
  "golang-1.13.3-10.h30.eulerosv2r9",
  "golang-devel-1.13.3-10.h30.eulerosv2r9",
  "golang-help-1.13.3-10.h30.eulerosv2r9"
];
