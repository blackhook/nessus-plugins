...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : java-1.8.0-openjdk (EulerOS-SA-2020-1307)");
...
the following vulnerabilities :
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    This vulnerability can also be exploited by using APIs
    in the specified Component, e.g., through a web service
    which supplies data to the APIs.(CVE-2020-2601)
  ...
  - Vulnerability in the Java SE product of Oracle Java SE
    ...
    vulnerability can only be exploited by supplying data
    to APIs in the specified Component without using
    Untrusted Java Web Start applications or Untrusted Java
    applets, such as through a web service.(CVE-2020-2654)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    data to the APIs.(CVE-2020-2659)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    This vulnerability can also be exploited by using APIs
    in the specified Component, e.g., through a web service
    which supplies data to the APIs.(CVE-2020-2593)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product
    ...
    can also be exploited by using APIs in the specified
    Component, e.g., through a web service which supplies
    data to the APIs.(CVE-2020-2590)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1307
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd084f4f");
...
"Update the affected java-1.8.0-openjdk packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2593");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.191.b12-0.h9.eulerosv2r7",
        "java-1.8.0-openjdk-devel-1.8.0.191.b12-0.h9.eulerosv2r7",
        "java-1.8.0-openjdk-headless-1.8.0.191.b12-0.h9.eulerosv2r7"];
