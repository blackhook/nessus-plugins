...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libtiff (EulerOS-SA-2023-2241)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2241
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b32fbeab");
...
var pkgs = [
  "libtiff-4.0.9-11.h28.eulerosv2r8",
  "libtiff-devel-4.0.9-11.h28.eulerosv2r8"
];
