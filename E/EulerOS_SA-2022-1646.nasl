...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : golang (EulerOS-SA-2022-1646)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1646
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4607afd");
...
var pkgs = [
  "golang-1.15.7-2.h16.eulerosv2r10",
  "golang-devel-1.15.7-2.h16.eulerosv2r10",
  "golang-help-1.15.7-2.h16.eulerosv2r10"
];
