...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : sudo (EulerOS-SA-2023-1047)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1047
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26a9e471");
...
var pkgs = [
  "sudo-1.9.8p2-2.h6.eulerosv2r11"
];
