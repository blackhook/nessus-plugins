...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : spice (EulerOS-SA-2017-1021)");
  script_summary(english:"Checks the rpm output for the updated packages.");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the spice package installed, the EulerOS
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ed6a395");
