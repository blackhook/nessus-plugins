...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : rpm (EulerOS-SA-2021-2823)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2823
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c92abcdf");
...
var pkgs = [
  "rpm-4.11.3-32.h9",
  "rpm-build-4.11.3-32.h9",
  "rpm-build-libs-4.11.3-32.h9",
  "rpm-libs-4.11.3-32.h9",
  "rpm-python-4.11.3-32.h9"
];
