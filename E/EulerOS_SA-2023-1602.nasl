...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openssl (EulerOS-SA-2023-1602)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1602
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e688083");
...
var pkgs = [
  "openssl-1.1.1-3.h25.eulerosv2r8",
  "openssl-devel-1.1.1-3.h25.eulerosv2r8",
  "openssl-libs-1.1.1-3.h25.eulerosv2r8",
  "openssl-perl-1.1.1-3.h25.eulerosv2r8"
];
