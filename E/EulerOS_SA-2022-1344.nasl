...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gegl04 (EulerOS-SA-2022-1344)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gegl04 package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1344
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3965c277");
  script_set_attribute(attribute:"solution", value:
"Update the affected gegl04 packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:gegl04");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gegl04");
}
