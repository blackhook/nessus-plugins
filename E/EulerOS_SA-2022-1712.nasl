...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : cyrus-sasl (EulerOS-SA-2022-1712)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1712
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3e75dbd");
...
var pkgs = [
  "cyrus-sasl-2.1.26-20.h2",
  "cyrus-sasl-devel-2.1.26-20.h2",
  "cyrus-sasl-gssapi-2.1.26-20.h2",
  "cyrus-sasl-lib-2.1.26-20.h2",
  "cyrus-sasl-md5-2.1.26-20.h2",
  "cyrus-sasl-plain-2.1.26-20.h2",
  "cyrus-sasl-scram-2.1.26-20.h2"
];
