...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libwebp (EulerOS-SA-2022-1081)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1081
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06b2fcf8");
...
var pkgs = [
  "libwebp-1.0.0-3.h1.eulerosv2r8"
];
