...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : cyrus-sasl (EulerOS-SA-2022-1802)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1802
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?469d7651");
...
var pkgs = [
  "cyrus-sasl-2.1.27-10.h4.eulerosv2r10",
  "cyrus-sasl-lib-2.1.27-10.h4.eulerosv2r10"
];
