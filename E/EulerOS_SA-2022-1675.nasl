...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : samba (EulerOS-SA-2022-1675)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1675
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0aec6b08");
...
var pkgs = [
  "libsmbclient-4.7.1-9.h30",
  "libwbclient-4.7.1-9.h30",
  "samba-client-libs-4.7.1-9.h30",
  "samba-common-4.7.1-9.h30",
  "samba-common-libs-4.7.1-9.h30",
  "samba-common-tools-4.7.1-9.h30",
  "samba-libs-4.7.1-9.h30"
];
