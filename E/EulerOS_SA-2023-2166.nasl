...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-setuptools (EulerOS-SA-2023-2166)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2166
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?298a0d5a");
...
var pkgs = [
  "python2-setuptools-22.0.5-1.h1.eulerosv2r7"
];
