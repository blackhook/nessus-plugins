...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gnutls (EulerOS-SA-2022-2461)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2461
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9937bf53");
...
var pkgs = [
  "gnutls-3.6.7-1.h10.eulerosv2r8",
  "gnutls-c++-3.6.7-1.h10.eulerosv2r8",
  "gnutls-dane-3.6.7-1.h10.eulerosv2r8",
  "gnutls-devel-3.6.7-1.h10.eulerosv2r8",
  "gnutls-utils-3.6.7-1.h10.eulerosv2r8"
];
