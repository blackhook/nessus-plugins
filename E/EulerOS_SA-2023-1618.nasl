...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : docker-engine (EulerOS-SA-2023-1618)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1618
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec9e6a47");
...
var pkgs = [
  "docker-engine-18.09.0.101-1.h29.14.5.eulerosv2r8"
];
