...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : kernel (EulerOS-SA-2022-1466)");
...
the following vulnerabilities :
  ...
  - In __configfs_open_file of file.c, there is a possible use-after-free due to improper locking. This could
    lead to local escalation of privilege in the kernel with System execution privileges needed. User
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1466
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aea47862");
...
"Update the affected kernel packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-4037");
...
var pkgs = [
  "kernel-4.19.90-vhulk2111.1.0.h963.eulerosv2r10",
  "kernel-abi-stablelists-4.19.90-vhulk2111.1.0.h963.eulerosv2r10",
  "kernel-tools-4.19.90-vhulk2111.1.0.h963.eulerosv2r10",
  "kernel-tools-libs-4.19.90-vhulk2111.1.0.h963.eulerosv2r10",
  "python3-perf-4.19.90-vhulk2111.1.0.h963.eulerosv2r10"
];
