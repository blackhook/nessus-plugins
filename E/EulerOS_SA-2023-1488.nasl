...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : kernel (EulerOS-SA-2023-1488)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1488
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4b0c35a");
...
var pkgs = [
  "kernel-4.18.0-147.5.1.6.h425.eulerosv2r9",
