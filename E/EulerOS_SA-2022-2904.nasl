...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : gnutls (EulerOS-SA-2022-2904)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2904
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9955aaba");
...
var pkgs = [
  "gnutls-3.6.14-6.h7.eulerosv2r10",
  "gnutls-utils-3.6.14-6.h7.eulerosv2r10"
];
