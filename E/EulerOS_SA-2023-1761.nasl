...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : libtiff (EulerOS-SA-2023-1761)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1761
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32db2e96");
...
var pkgs = [
  "libtiff-4.3.0-9.h11.eulerosv2r11"
];
