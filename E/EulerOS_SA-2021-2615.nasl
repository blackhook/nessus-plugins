...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : samba (EulerOS-SA-2021-2615)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2615
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89e54941");
...
var pkgs = [
  "libsmbclient-4.6.2-8.h18",
  "libwbclient-4.6.2-8.h18",
  "samba-4.6.2-8.h18",
  "samba-client-4.6.2-8.h18",
  "samba-client-libs-4.6.2-8.h18",
  "samba-common-4.6.2-8.h18",
  "samba-common-libs-4.6.2-8.h18",
  "samba-common-tools-4.6.2-8.h18",
  "samba-libs-4.6.2-8.h18",
  "samba-python-4.6.2-8.h18",
  "samba-winbind-4.6.2-8.h18",
  "samba-winbind-clients-4.6.2-8.h18",
  "samba-winbind-modules-4.6.2-8.h18"
];
