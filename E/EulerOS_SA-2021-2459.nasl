...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : dovecot (EulerOS-SA-2021-2459)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the dovecot packages installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2459
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?15b9ff6f");
...
var pkgs = [
  "dovecot-2.3.3-1.h13.eulerosv2r8",
  "dovecot-mysql-2.3.3-1.h13.eulerosv2r8",
  "dovecot-pigeonhole-2.3.3-1.h13.eulerosv2r8"
];
