...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : python-pillow (EulerOS-SA-2020-2227)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2227
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b465c253");
...
pkgs = ["python-pillow-2.0.0-19.h6.gitd1c6db8.eulerosv2r7"];
