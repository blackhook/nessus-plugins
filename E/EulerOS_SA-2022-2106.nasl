...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : cifs-utils (EulerOS-SA-2022-2106)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2106
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86cd8ca7");
...
var pkgs = [
  "cifs-utils-6.10-0.h5.eulerosv2r10"
];
