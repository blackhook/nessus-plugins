...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : jettison (EulerOS-SA-2023-2151)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the jettison package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2151
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39d7d9c1");
  script_set_attribute(attribute:"solution", value:
"Update the affected jettison packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:jettison");
...
var pkgs = [
  "jettison-1.3.3-4.h1.eulerosv2r7"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "jettison");
}
