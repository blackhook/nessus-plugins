...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : glusterfs (EulerOS-SA-2023-1821)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1821
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff444c3b");
...
var pkgs = [
  "glusterfs-7.0-6.h1.eulerosv2r10",
  "python3-gluster-7.0-6.h1.eulerosv2r10"
];
