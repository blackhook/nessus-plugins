...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : e2fsprogs (EulerOS-SA-2023-1634)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1634
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?781aaa57");
...
var pkgs = [
  "e2fsprogs-1.45.6-0.h10.eulerosv2r9"
];
