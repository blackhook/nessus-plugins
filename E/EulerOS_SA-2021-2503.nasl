...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libgcrypt (EulerOS-SA-2021-2503)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2503
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3dec4bb1");
...
var pkgs = [
  "libgcrypt-1.5.3-14.h5.eulerosv2r7",
  "libgcrypt-devel-1.5.3-14.h5.eulerosv2r7"
];
