...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : httpd (EulerOS-SA-2022-1206)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1206
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb31647e");
...
"Update the affected httpd packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:httpd-help");
...
var pkgs = [
  ...
  "httpd-devel-2.4.43-4.h11.eulerosv2r10",
  "httpd-filesystem-2.4.43-4.h11.eulerosv2r10",
  "httpd-help-2.4.43-4.h11.eulerosv2r10",
