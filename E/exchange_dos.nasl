...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"275714");
 script_xref(name:"MSKB", value:"834130");
...
*** if the patch has been applied." );
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2000/ms00-082");
