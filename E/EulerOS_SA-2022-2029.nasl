...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libxml2 (EulerOS-SA-2022-2029)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2029
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72253589");
...
var pkgs = [
  "libxml2-2.9.10-11.h15.eulerosv2r10",
  "python3-libxml2-2.9.10-11.h15.eulerosv2r10"
];
