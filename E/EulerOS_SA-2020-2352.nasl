...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : java-1.8.0-openjdk (EulerOS-SA-2020-2352)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2352
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6b0553f");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.191.b12-0.h6",
        "java-1.8.0-openjdk-devel-1.8.0.191.b12-0.h6",
        "java-1.8.0-openjdk-headless-1.8.0.191.b12-0.h6"];
