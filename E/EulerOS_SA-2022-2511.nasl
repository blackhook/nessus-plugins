...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libdb (EulerOS-SA-2022-2511)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libdb packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2511
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9c0c894");
  script_set_attribute(attribute:"solution", value:
"Update the affected libdb packages.");
...
var pkgs = [
  "libdb-5.3.21-24.h9.eulerosv2r7",
  "libdb-devel-5.3.21-24.h9.eulerosv2r7",
  "libdb-utils-5.3.21-24.h9.eulerosv2r7"
];
