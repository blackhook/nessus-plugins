...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : xorg-x11-server (EulerOS-SA-2022-2672)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2672
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f9f17cd");
...
var pkgs = [
  "xorg-x11-server-help-1.20.8-4.h5.eulerosv2r10"
];
