...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : xorg-x11-server (EulerOS-SA-2021-1863)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1863
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2a0f36e");
...
pkgs = ["xorg-x11-server-Xephyr-1.17.2-10.h10",
        "xorg-x11-server-Xorg-1.17.2-10.h10",
        "xorg-x11-server-common-1.17.2-10.h10"];
