...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : rsyslog (EulerOS-SA-2022-2121)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2121
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67e3932d");
...
var pkgs = [
  "rsyslog-8.2006.0-5.h13.eulerosv2r10"
];
