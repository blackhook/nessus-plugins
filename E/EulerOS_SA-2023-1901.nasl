...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : httpd (EulerOS-SA-2023-1901)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1901
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58f9ae88");
...
var pkgs = [
  "httpd-2.4.43-4.h19.eulerosv2r10",
  "httpd-filesystem-2.4.43-4.h19.eulerosv2r10",
  "httpd-tools-2.4.43-4.h19.eulerosv2r10",
  "mod_ssl-2.4.43-4.h19.eulerosv2r10"
];
