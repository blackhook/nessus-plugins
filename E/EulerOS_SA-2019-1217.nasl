...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.4 : systemd (EulerOS-SA-2019-1217)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1217
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a545fc62");
...
pkgs = ["libgudev1-devel-219-57.h58",
        "systemd-219-57.h58",
