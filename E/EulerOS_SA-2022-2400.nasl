...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : rsyslog (EulerOS-SA-2022-2400)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the rsyslog package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2400
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9cbcc5f3");
...
var pkgs = [
  "rsyslog-8.2006.0-4.h9.eulerosv2r9"
];
