...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : pixman (EulerOS-SA-2023-1662)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1662
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9636230");
...
var pkgs = [
  "pixman-0.38.4-1.h1.eulerosv2r9"
];
