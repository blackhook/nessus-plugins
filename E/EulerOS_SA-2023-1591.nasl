...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : docker-engine (EulerOS-SA-2023-1591)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1591
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6d595c9");
...
var pkgs = [
  "docker-engine-18.09.0.101-1.h60.24.16.eulerosv2r8"
];
