...
vulnerabilities :
  ...
  - gdk-pixbuf is an image loading library that can be
    ...
    Fix(es):An exploitable heap overflow vulnerability
    exists in the gdk_pixbuf__jpeg_image_load_increment
    functionality of Gdk-Pixbuf 2.36.6. A specially crafted
    jpeg file can cause a heap overflow resulting in remote
    code execution. An attacker can send a file or url to
    trigger this vulnerability.(CVE-2017-2862)An
    ...
    trigger this vulnerability.(CVE-2017-2870)Gnome
    gdk-pixbuf 2.36.8 and older is vulnerable to several
    integer overflow in the gif_get_lzw function resulting
    in memory corruption and potential code
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1045
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f299cb8");
