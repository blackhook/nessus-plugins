...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : bind (EulerOS-SA-2022-1237)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1237
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?020989ea");
...
var pkgs = [
  "bind-9.11.21-4.h9.eulerosv2r10",
  "bind-chroot-9.11.21-4.h9.eulerosv2r10",
  "bind-export-libs-9.11.21-4.h9.eulerosv2r10",
  "bind-libs-9.11.21-4.h9.eulerosv2r10",
  "bind-libs-lite-9.11.21-4.h9.eulerosv2r10",
  "bind-pkcs11-9.11.21-4.h9.eulerosv2r10",
  "bind-utils-9.11.21-4.h9.eulerosv2r10",
  "python3-bind-9.11.21-4.h9.eulerosv2r10"
];
