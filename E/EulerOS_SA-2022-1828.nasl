...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : grub2 (EulerOS-SA-2022-1828)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1828
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8586b4f8");
...
var pkgs = [
  ...
  "grub2-efi-aa64-2.04-16.h28.eulerosv2r10",
  "grub2-efi-aa64-modules-2.04-16.h28.eulerosv2r10",
