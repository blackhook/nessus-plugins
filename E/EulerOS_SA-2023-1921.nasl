...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libarchive (EulerOS-SA-2023-1921)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1921
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?24c232a0");
...
var pkgs = [
  "libarchive-3.4.3-2.h5.eulerosv2r10"
];
