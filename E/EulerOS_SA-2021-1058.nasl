...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : 389-ds-base (EulerOS-SA-2021-1058)");
...
vulnerabilities :
  ...
  - It was found that the fix for CVE-2018-14648 in
    389-ds-base, versions 1.4.0.x before 1.4.0.17, was
    incorrectly applied in RHEL 7.5. An attacker would
    still be able to provoke excessive CPU consumption
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1058
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?576cae80");
...
pkgs = ["389-ds-base-1.3.7.5-28.h5",
        "389-ds-base-libs-1.3.7.5-28.h5"];
