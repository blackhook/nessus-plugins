...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : samba (EulerOS-SA-2016-1006)");
...
vulnerability :
  ...
  - A flaw was found in the way Samba handled ACLs on
    symbolic links. An authenticated user could use this
    flaw to gain access to an arbitrary file or directory
    by overwriting its ACL. (CVE-2015-7560)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1006
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04144302");
...
pkgs = ["libsmbclient-4.2.3-12",
        "libwbclient-4.2.3-12",
        "samba-4.2.3-12",
        "samba-client-4.2.3-12",
        "samba-client-libs-4.2.3-12",
        "samba-common-4.2.3-12",
        "samba-common-libs-4.2.3-12",
        "samba-common-tools-4.2.3-12",
        "samba-libs-4.2.3-12",
        "samba-python-4.2.3-12",
        "samba-winbind-4.2.3-12",
        "samba-winbind-clients-4.2.3-12",
        "samba-winbind-modules-4.2.3-12"];
