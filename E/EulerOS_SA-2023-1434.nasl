...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : xorg-x11-server (EulerOS-SA-2023-1434)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1434
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e18cfcac");
...
"Update the affected xorg-x11-server packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-3551");
...
var pkgs = [
  "xorg-x11-server-help-1.20.11-4.h5.eulerosv2r11"
];
