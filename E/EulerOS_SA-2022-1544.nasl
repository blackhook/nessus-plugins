...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : OpenEXR (EulerOS-SA-2022-1544)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1544
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a47494f0");
...
var pkgs = [
  "OpenEXR-libs-1.7.1-7.h6.eulerosv2r7"
];
