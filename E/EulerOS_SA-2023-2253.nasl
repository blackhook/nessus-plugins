...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : libXpm (EulerOS-SA-2023-2253)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2253
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9877c8da");
...
var pkgs = [
  "libXpm-3.5.12-8.eulerosv2r8",
  "libXpm-devel-3.5.12-8.eulerosv2r8"
];
