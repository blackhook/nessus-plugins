...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : multipath-tools (EulerOS-SA-2023-1477)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1477
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28eea47e");
...
var pkgs = [
  "kpartx-0.7.7-35.h15.eulerosv2r9",
  "multipath-tools-0.7.7-35.h15.eulerosv2r9"
];
