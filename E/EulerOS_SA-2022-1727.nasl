...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : gstreamer-plugins-bad-free (EulerOS-SA-2022-1727)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1727
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b71a8ca");
...
var pkgs = [
  "gstreamer-plugins-bad-free-0.10.23-22.h1"
];
