...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : cups (EulerOS-SA-2022-1002)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1002
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ee8faa8");
...
var pkgs = [
  "cups-libs-2.2.13-3.h5.eulerosv2r9"
];
