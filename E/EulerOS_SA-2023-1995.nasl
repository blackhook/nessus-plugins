...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : emacs (EulerOS-SA-2023-1995)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1995
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a57a9c0");
...
var pkgs = [
  "emacs-filesystem-26.1-13.h7.eulerosv2r9"
];
