...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : python-jwt (EulerOS-SA-2022-2434)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2434
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e8f7b1e1");
...
var pkgs = [
  "python-jwt-help-1.7.1-2.h2.eulerosv2r10"
];
