...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ruby (EulerOS-SA-2023-2321)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2321
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f6fafff");
...
var pkgs = [
  "ruby-2.5.1-104.h16.eulerosv2r9",
  "ruby-help-2.5.1-104.h16.eulerosv2r9",
  "ruby-irb-2.5.1-104.h16.eulerosv2r9"
];
