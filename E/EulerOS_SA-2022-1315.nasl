...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : lapack (EulerOS-SA-2022-1315)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1315
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?056b776d");
...
var pkgs = [
  "lapack-help-3.9.0-1.h3.eulerosv2r9"
];
