...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : httpd (EulerOS-SA-2022-2931)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2931
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ddee13d3");
...
"Update the affected httpd packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-28330");
...
var pkgs = [
  "httpd-2.4.43-4.h16.eulerosv2r10",
  "httpd-filesystem-2.4.43-4.h16.eulerosv2r10",
  "httpd-tools-2.4.43-4.h16.eulerosv2r10",
  "mod_ssl-2.4.43-4.h16.eulerosv2r10"
];
