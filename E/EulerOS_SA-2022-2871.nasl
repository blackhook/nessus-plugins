...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : cups (EulerOS-SA-2022-2871)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2871
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6d8bd62");
...
var pkgs = [
  "cups-libs-2.2.13-4.h5.eulerosv2r10"
];
