...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : binutils (EulerOS-SA-2023-1184)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1184
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?499f60e8");
...
var pkgs = [
  "binutils-2.34-1.h26.eulerosv2r9"
];
