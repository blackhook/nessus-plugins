...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libwebp (EulerOS-SA-2021-2403)");
...
vulnerabilities :
  ...
  - flaw was found in libwebp in versions before 1.0.1. A
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2403
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c0d96cd3");
