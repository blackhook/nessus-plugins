...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : mariadb (EulerOS-SA-2021-1815)");
...
vulnerabilities :
  ...
  - Vulnerability in the MySQL Server component of Oracle
    ...
    and prior, 5.7.23 and prior and 8.0.12 and prior.
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1815
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?574b7a59");
