...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : flac (EulerOS-SA-2021-2879)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2879
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2cc9b3b");
...
var pkgs = [
  "flac-libs-1.3.0-5.h1.eulerosv2r7"
];
