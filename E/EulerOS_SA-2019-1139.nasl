...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : java-1.7.0-openjdk (EulerOS-SA-2019-1139)");
...
the following vulnerability :
  ...
  - OpenJDK: memory disclosure in
    FileChannelImpl.(CVE-2019-2422)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1139
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?015147a6");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.191-2.6.15.4.h1.eulerosv2r7",
        "java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.h1.eulerosv2r7",
        "java-1.7.0-openjdk-headless-1.7.0.191-2.6.15.4.h1.eulerosv2r7"];
