...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : kata-containers (EulerOS-SA-2023-1564)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the kata-containers package installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1564
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b409dfa9");
  script_set_attribute(attribute:"solution", value:
"Update the affected kata-containers packages.");
...
var pkgs = [
  "kata-containers-v1.11.1-6.h42.eulerosv2r10"
];
