...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : xorg-x11-server (EulerOS-SA-2023-1376)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1376
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?125a677b");
...
var pkgs = [
  "xorg-x11-server-help-1.20.8-4.h7.eulerosv2r10"
];
