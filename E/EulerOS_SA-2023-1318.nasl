...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ImageMagick (EulerOS-SA-2023-1318)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1318
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2d717f9");
...
var pkgs = [
  "ImageMagick-6.9.9.38-3.h27.eulerosv2r8",
  "ImageMagick-c++-6.9.9.38-3.h27.eulerosv2r8",
  "ImageMagick-libs-6.9.9.38-3.h27.eulerosv2r8",
  "ImageMagick-perl-6.9.9.38-3.h27.eulerosv2r8"
];
