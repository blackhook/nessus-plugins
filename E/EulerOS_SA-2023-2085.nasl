...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : cryptsetup (EulerOS-SA-2023-2085)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the cryptsetup packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2085
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?43fb6af4");
  script_set_attribute(attribute:"solution", value:
"Update the affected cryptsetup packages.");
...
var pkgs = [
  "cryptsetup-2.4.1-1.h5.eulerosv2r11",
  "cryptsetup-reencrypt-2.4.1-1.h5.eulerosv2r11"
];
