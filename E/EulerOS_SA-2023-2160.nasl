...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : mod_security (EulerOS-SA-2023-2160)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2160
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb99351f");
...
var pkgs = [
  "mod_security-2.9.2-1.h2.eulerosv2r7"
];
