...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : cups (EulerOS-SA-2022-2926)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2926
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e747aa6a");
...
"Update the affected cups packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-8842");
...
var pkgs = [
  "cups-libs-2.2.13-4.h6.eulerosv2r10"
];
