...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : libksba (EulerOS-SA-2023-2107)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2107
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?992dd59e");
...
var pkgs = [
  "libksba-1.6.0-1.h1.eulerosv2r11"
];
