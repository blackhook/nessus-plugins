...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : dnsmasq (EulerOS-SA-2022-2901)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2901
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae1faed7");
...
var pkgs = [
  "dnsmasq-2.82-5.h18.eulerosv2r10"
];
