...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openldap (EulerOS-SA-2021-2602)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2602
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4788f3b9");
...
var pkgs = [
  "openldap-2.4.44-5.h12",
  "openldap-clients-2.4.44-5.h12",
  "openldap-devel-2.4.44-5.h12",
  "openldap-servers-2.4.44-5.h12"
];
