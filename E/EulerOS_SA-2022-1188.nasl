...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : samba (EulerOS-SA-2022-1188)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1188
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd86a0bd");
...
var pkgs = [
  "libsmbclient-4.6.2-8.h19",
  "libwbclient-4.6.2-8.h19",
  "samba-4.6.2-8.h19",
  "samba-client-4.6.2-8.h19",
  "samba-client-libs-4.6.2-8.h19",
  "samba-common-4.6.2-8.h19",
  "samba-common-libs-4.6.2-8.h19",
  "samba-common-tools-4.6.2-8.h19",
  "samba-libs-4.6.2-8.h19",
  "samba-python-4.6.2-8.h19",
  "samba-winbind-4.6.2-8.h19",
  "samba-winbind-clients-4.6.2-8.h19",
  "samba-winbind-modules-4.6.2-8.h19"
];
