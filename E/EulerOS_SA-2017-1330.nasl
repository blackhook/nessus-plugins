...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : java-1.7.0-openjdk (EulerOS-SA-2017-1330)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1330
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2858c091");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.161-2.6.12.0",
        "java-1.7.0-openjdk-devel-1.7.0.161-2.6.12.0",
        "java-1.7.0-openjdk-headless-1.7.0.161-2.6.12.0"];
