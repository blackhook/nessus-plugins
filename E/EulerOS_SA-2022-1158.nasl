...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : compat-glibc (EulerOS-SA-2022-1158)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1158
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dfe01907");
...
var pkgs = [
  "compat-glibc-2.12-5.h1",
  "compat-glibc-headers-2.12-5.h1"
];
