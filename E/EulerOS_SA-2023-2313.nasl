...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : glusterfs (EulerOS-SA-2023-2313)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2313
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d9f2537");
...
var pkgs = [
  "glusterfs-7.0-5.h2.eulerosv2r9",
  "python3-gluster-7.0-5.h2.eulerosv2r9"
];
