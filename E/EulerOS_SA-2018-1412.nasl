...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.2 : ghostscript (EulerOS-SA-2018-1412)");
...
the following vulnerabilities :
  ...
  - It was discovered that the ghostscript .tempfile
    ...
    PostScript document.i1/4^CVE-2018-15908i1/4%0
  ...
  - It was discovered that the ghostscript .shfill operator
    ...
    document.i1/4^CVE-2018-15909i1/4%0
  ...
  - It was discovered that the ghostscript .type operator
    ...
    context of the ghostscript process.i1/4^CVE-2018-16511i1/4%0

  - It was discovered that the ghostscript did not properly
    restrict access to files open prior to enabling the
    -dSAFER mode. An attacker could possibly exploit this
    to bypass the -dSAFER protection and disclose the
    content of affected files via a specially crafted
    PostScript document.i1/4^CVE-2018-16539i1/4%0
  ...
  - It was discovered that the ghostscript device cleanup
    ...
    context via a specially crafted PostScript
    document.i1/4^CVE-2018-16541i1/4%0
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1412
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?15e4fe8f");
