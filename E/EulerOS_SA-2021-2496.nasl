...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : glibc (EulerOS-SA-2021-2496)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2496
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa6f966d");
...
var pkgs = [
  "glibc-2.17-222.h45.eulerosv2r7",
  "glibc-common-2.17-222.h45.eulerosv2r7",
  "glibc-devel-2.17-222.h45.eulerosv2r7",
  "glibc-headers-2.17-222.h45.eulerosv2r7",
  "glibc-static-2.17-222.h45.eulerosv2r7",
  "glibc-utils-2.17-222.h45.eulerosv2r7",
  "nscd-2.17-222.h45.eulerosv2r7"
];
