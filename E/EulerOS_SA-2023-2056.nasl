...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : libXpm (EulerOS-SA-2023-2056)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2056
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?faf34301");
...
var pkgs = [
  "libXpm-3.5.13-1.h2.eulerosv2r11"
];
