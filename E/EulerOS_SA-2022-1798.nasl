...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : util-linux (EulerOS-SA-2022-1798)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1798
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6af38afe");
...
var pkgs = [
  "libblkid-2.35.2-2.h24.eulerosv2r10",
  "libfdisk-2.35.2-2.h24.eulerosv2r10",
  "libmount-2.35.2-2.h24.eulerosv2r10",
  "libsmartcols-2.35.2-2.h24.eulerosv2r10",
  "libuuid-2.35.2-2.h24.eulerosv2r10",
  "util-linux-2.35.2-2.h24.eulerosv2r10",
  "util-linux-user-2.35.2-2.h24.eulerosv2r10"
];
