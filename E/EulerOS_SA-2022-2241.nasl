...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : dpdk (EulerOS-SA-2022-2241)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2241
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71c721ba");
...
var pkgs = [
  "dpdk-19.11-5.h12.eulerosv2r10",
  "dpdk-tools-19.11-5.h12.eulerosv2r10"
];
