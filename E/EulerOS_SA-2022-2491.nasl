...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : curl (EulerOS-SA-2022-2491)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2491
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9f9533f2");
...
var pkgs = [
  ...
  "libcurl-devel-7.29.0-46.h22.eulerosv2r7"
];
