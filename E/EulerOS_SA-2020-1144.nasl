...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : curl (EulerOS-SA-2020-1144)");
...
pkgs = ["curl-7.61.1-2.h6.eulerosv2r8",
        "libcurl-7.61.1-2.h6.eulerosv2r8",
        "libcurl-devel-7.61.1-2.h6.eulerosv2r8"];
