...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openjpeg2 (EulerOS-SA-2022-1941)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1941
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01eeb0d1");
...
var pkgs = [
  "openjpeg2-2.3.0-9.h14.eulerosv2r8"
];
