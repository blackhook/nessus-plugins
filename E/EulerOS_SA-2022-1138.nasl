...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : postgresql (EulerOS-SA-2022-1138)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1138
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4224aa31");
...
var pkgs = [
  "postgresql-9.2.24-1.h2.eulerosv2r7",
