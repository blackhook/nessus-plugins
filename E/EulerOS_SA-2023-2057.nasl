...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : net-snmp (EulerOS-SA-2023-2057)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2057
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c2357fc");
...
var pkgs = [
  "net-snmp-5.9.1-1.h4.eulerosv2r11",
  "net-snmp-libs-5.9.1-1.h4.eulerosv2r11",
  "python3-net-snmp-5.9.1-1.h4.eulerosv2r11"
];
