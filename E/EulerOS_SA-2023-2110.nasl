...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : pkgconf (EulerOS-SA-2023-2110)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2110
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f22723ec");
...
var pkgs = [
  "pkgconf-1.8.0-1.h2.eulerosv2r11"
];
