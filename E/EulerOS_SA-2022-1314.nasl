...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : xorg-x11-server (EulerOS-SA-2022-1314)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1314
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4de517d1");
...
var pkgs = [
  "xorg-x11-server-help-1.20.6-5.h7.eulerosv2r9"
];
