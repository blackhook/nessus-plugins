...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : python-lxml (EulerOS-SA-2022-2036)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2036
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?435b539e");
...
var pkgs = [
  "python3-lxml-4.5.2-2.h7.eulerosv2r10"
];
