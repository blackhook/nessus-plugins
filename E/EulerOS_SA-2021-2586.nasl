...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : httpd (EulerOS-SA-2021-2586)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2586
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e35cc6e9");
...
var pkgs = [
  "httpd-2.4.6-45.0.1.4.h21",
  "httpd-devel-2.4.6-45.0.1.4.h21",
  "httpd-manual-2.4.6-45.0.1.4.h21",
  "httpd-tools-2.4.6-45.0.1.4.h21",
  "mod_ssl-2.4.6-45.0.1.4.h21"
];
