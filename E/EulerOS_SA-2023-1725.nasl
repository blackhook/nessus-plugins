...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : openldap (EulerOS-SA-2023-1725)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1725
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e78391ab");
...
var pkgs = [
  "openldap-2.4.44-15.h17",
  "openldap-clients-2.4.44-15.h17"
];
