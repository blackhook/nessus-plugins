...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-engine (EulerOS-SA-2022-2129)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2129
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?48438761");
...
var pkgs = [
  "docker-engine-18.09.0.200-200.h48.28.15.eulerosv2r10"
];
