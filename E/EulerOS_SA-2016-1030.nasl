...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : httpd (EulerOS-SA-2016-1030)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1030
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2251b398");
...
pkgs = ["httpd-2.4.6-40.4",
        "httpd-devel-2.4.6-40.4",
        "httpd-manual-2.4.6-40.4",
        "httpd-tools-2.4.6-40.4",
        "mod_ssl-2.4.6-40.4"];
