...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libarchive (EulerOS-SA-2023-1322)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libarchive packages installed, the EulerOS installation on the remote host is affected
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1322
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0f30d269");
...
var pkgs = [
  "bsdtar-3.3.2-2.h10.eulerosv2r8",
  "libarchive-3.3.2-2.h10.eulerosv2r8",
  "libarchive-devel-3.3.2-2.h10.eulerosv2r8"
];
