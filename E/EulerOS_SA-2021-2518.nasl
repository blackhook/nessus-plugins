...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : python-pillow (EulerOS-SA-2021-2518)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2518
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ba5081a");
...
var pkgs = [
  "python-pillow-2.0.0-19.h13.gitd1c6db8.eulerosv2r7"
];
