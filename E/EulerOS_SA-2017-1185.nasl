...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : python (EulerOS-SA-2017-1185)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1185
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1753609");
...
pkgs = ["python-2.7.5-58",
        "python-devel-2.7.5-58",
        "python-libs-2.7.5-58"];
