...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : cups (EulerOS-SA-2021-1465)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1465
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f73fe41e");
...
pkgs = ["cups-1.6.3-35.h7.eulerosv2r7",
        "cups-client-1.6.3-35.h7.eulerosv2r7",
        "cups-devel-1.6.3-35.h7.eulerosv2r7",
        "cups-filesystem-1.6.3-35.h7.eulerosv2r7",
        "cups-libs-1.6.3-35.h7.eulerosv2r7",
        "cups-lpd-1.6.3-35.h7.eulerosv2r7"];
