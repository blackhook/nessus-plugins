...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : lapack (EulerOS-SA-2022-1476)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the lapack package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1476
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5056d704");
...
"Update the affected lapack packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:lapack-help");
...
var pkgs = [
  "lapack-help-3.9.0-2.h3.eulerosv2r10"
];
