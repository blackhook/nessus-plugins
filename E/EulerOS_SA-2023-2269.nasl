...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : haproxy (EulerOS-SA-2023-2269)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2269
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ecca2571");
...
var pkgs = [
  "haproxy-2.4.8-2.h2.eulerosv2r11"
];
