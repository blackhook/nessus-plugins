...
if (description)
{
  ...
  script_cve_id("CVE-2021-33560", "CVE-2021-33560");

  script_name(english:"EulerOS Virtualization 3.0.6.6 : libgcrypt (EulerOS-SA-2022-1127)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libgcrypt packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1127
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4313847a");
...
var pkgs = [
  ...
  "libgcrypt-devel-1.5.3-14.h6.eulerosv2r7"
];
