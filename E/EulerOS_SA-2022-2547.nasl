...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : cifs-utils (EulerOS-SA-2022-2547)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the cifs-utils packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2547
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?422fec99");
...
var pkgs = [
  "cifs-utils-6.8-2.h5.eulerosv2r8",
  "pam_cifscreds-6.8-2.h5.eulerosv2r8"
];
