...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : openssl1.1.0f (EulerOS-SA-2019-2254)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the openssl1.1.0f packages installed,
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2254
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63c0629c");
  script_set_attribute(attribute:"solution", value:
"Update the affected openssl1.1.0f packages.");
...
pkgs = ["openssl110f-1.1.0f-5.h9",
        ...
        "openssl110f-static-1.1.0f-5.h9"];
