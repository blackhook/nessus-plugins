...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : libxslt (EulerOS-SA-2022-2623)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2623
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9977fe19");
...
var pkgs = [
  "libxslt-1.1.28-5.h9",
  "libxslt-devel-1.1.28-5.h9",
  "libxslt-python-1.1.28-5.h9"
];
