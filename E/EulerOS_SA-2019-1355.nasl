...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.3 : openssh (EulerOS-SA-2019-1355)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-1355
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?73ece78c");
...
pkgs = ["openssh-7.4p1-13.h10",
        "openssh-clients-7.4p1-13.h10",
        "openssh-keycat-7.4p1-13.h10",
        "openssh-server-7.4p1-13.h10",
