...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.1 : libarchive (EulerOS-SA-2023-2045)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2045
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83c5a13e");
...
var pkgs = [
  "libarchive-3.5.2-1.h3.eulerosv2r11"
];
