...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : linux-firmware (EulerOS-SA-2023-1131)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the linux-firmware package installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1131
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25a7bdc7");
...
var pkgs = [
  "linux-firmware-20190815-6.h5.eulerosv2r9"
];
