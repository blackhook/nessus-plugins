...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : bluez (EulerOS-SA-2022-1657)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1657
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19b530fc");
...
var pkgs = [
  "bluez-help-5.54-1.h6.eulerosv2r10"
];
