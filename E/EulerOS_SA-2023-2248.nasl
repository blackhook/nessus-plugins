...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : ruby (EulerOS-SA-2023-2248)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the ruby package installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2248
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5544d2b9");
...
var pkgs = [
  "rubygems-2.7.6-98.h18.eulerosv2r8"
];
