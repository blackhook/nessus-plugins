...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : cryptsetup (EulerOS-SA-2022-2888)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2888
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dab43ce1");
...
var pkgs = [
  "cryptsetup-2.3.3-1.h3.eulerosv2r10",
  "cryptsetup-reencrypt-2.3.3-1.h3.eulerosv2r10"
];
