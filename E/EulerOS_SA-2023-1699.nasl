...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : xorg-x11-server (EulerOS-SA-2023-1699)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1699
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89291708");
...
var pkgs = [
  "xorg-x11-server-Xorg-1.19.5-5.h16",
  "xorg-x11-server-common-1.19.5-5.h16"
];
