...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : gstreamer1-plugins-bad-free (EulerOS-SA-2022-1323)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the gstreamer1-plugins-bad-free packages installed, the EulerOS installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1323
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71223f12");
...
"Update the affected gstreamer1-plugins-bad-free packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:gstreamer1-plugins-bad-free-gtk");
...
var pkgs = [
  "gstreamer1-plugins-bad-free-1.10.4-3.h1.eulerosv2r7",
  "gstreamer1-plugins-bad-free-gtk-1.10.4-3.h1.eulerosv2r7"
];
