...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : glibc (EulerOS-SA-2018-1332)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1332
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0b47365f");
...
pkgs = ["glibc-2.17-157.h15",
        "glibc-common-2.17-157.h15",
        "glibc-devel-2.17-157.h15",
        "glibc-headers-2.17-157.h15",
        "nscd-2.17-157.h15"];
