...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : httpd (EulerOS-SA-2022-2614)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2614
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8934ab2d");
...
var pkgs = [
  "httpd-2.4.6-45.0.1.4.h27",
  "httpd-devel-2.4.6-45.0.1.4.h27",
  "httpd-manual-2.4.6-45.0.1.4.h27",
  "httpd-tools-2.4.6-45.0.1.4.h27",
  "mod_ssl-2.4.6-45.0.1.4.h27"
];
