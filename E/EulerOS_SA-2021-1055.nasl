...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.2.0 : mariadb (EulerOS-SA-2021-1055)");
...
affected by the following vulnerabilities :
  ...
  - The mariadb-libs package provides the essential shared
    libraries for any MariaDB/MySQL client program or
    interface. You will need to install this package to use
    any other MariaDB package or any clients that need to
    connect to a MariaDB/MySQL server. MariaDB is a
    community developed branch of MySQL.Security
    Fix(es):Vulnerability in the MySQL Client product of
    Oracle MySQL (component: C API). Supported versions
    that are affected are 5.6.46 and prior, 5.7.28 and
    prior and 8.0.18 and prior. Difficult to exploit
    ...
    (CVE-2019-2974)Vulnerability in the MySQL Server
    ...
    (CVE-2019-2481)Vulnerability in the MySQL Server
    component of Oracle MySQL (subcomponent: Server:
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1055
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bbe86979");
...
"Update the affected mariadb packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2019-2974");
