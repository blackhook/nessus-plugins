...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : unbound (EulerOS-SA-2023-1156)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1156
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8913067d");
...
var pkgs = [
  "python3-unbound-1.11.0-2.h6.eulerosv2r10",
  "unbound-1.11.0-2.h6.eulerosv2r10",
  "unbound-libs-1.11.0-2.h6.eulerosv2r10"
];
