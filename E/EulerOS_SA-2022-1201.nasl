...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : cups (EulerOS-SA-2022-1201)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1201
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?766b60cb");
...
var pkgs = [
  "cups-2.2.13-4.h3.eulerosv2r10",
  "cups-devel-2.2.13-4.h3.eulerosv2r10",
  "cups-help-2.2.13-4.h3.eulerosv2r10",
  "cups-libs-2.2.13-4.h3.eulerosv2r10"
];
