...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : 389-ds-base (EulerOS-SA-2018-1032)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1032
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?04acab78");
...
pkgs = ["389-ds-base-1.3.4.0-26.h1",
        "389-ds-base-libs-1.3.4.0-26.h1"];
