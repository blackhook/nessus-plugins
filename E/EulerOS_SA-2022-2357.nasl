...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : openjpeg2 (EulerOS-SA-2022-2357)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2357
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?784db500");
...
var pkgs = [
  "openjpeg2-2.3.1-2.h9.eulerosv2r9"
];
