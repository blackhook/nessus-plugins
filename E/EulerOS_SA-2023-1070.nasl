...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.6 : lapack (EulerOS-SA-2023-1070)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the lapack packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1070
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3371a74");
  script_set_attribute(attribute:"solution", value:
"Update the affected lapack packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:blas");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:lapack");
...
var pkgs = [
  "blas-3.4.2-8.h1.eulerosv2r7",
  "lapack-3.4.2-8.h1.eulerosv2r7"
];
