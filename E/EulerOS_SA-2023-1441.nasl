...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : git (EulerOS-SA-2023-1441)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1441
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ee596eaa");
...
var pkgs = [
  "git-2.23.0-12.h11.eulerosv2r9",
  "git-help-2.23.0-12.h11.eulerosv2r9"
];
