...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : golang (EulerOS-SA-2022-2610)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2610
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1b39be20");
...
var pkgs = [
  "golang-1.13.3-9.h9",
  "golang-bin-1.13.3-9.h9",
  "golang-src-1.13.3-9.h9"
];
