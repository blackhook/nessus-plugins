...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : pidgin (EulerOS-SA-2022-2277)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the pidgin package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2277
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8dce85ea");
...
var pkgs = [
  "libpurple-2.10.11-7.h7.eulerosv2r7"
];
