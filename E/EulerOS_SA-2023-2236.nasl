...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : e2fsprogs (EulerOS-SA-2023-2236)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the e2fsprogs packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2236
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2cf57678");
...
var pkgs = [
  "e2fsprogs-1.44.3-1.h15.eulerosv2r8",
  "e2fsprogs-devel-1.44.3-1.h15.eulerosv2r8",
  "e2fsprogs-libs-1.44.3-1.h15.eulerosv2r8",
  "libcom_err-1.44.3-1.h15.eulerosv2r8",
  "libcom_err-devel-1.44.3-1.h15.eulerosv2r8",
  "libss-1.44.3-1.h15.eulerosv2r8"
];
