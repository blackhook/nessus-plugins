...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libtar (EulerOS-SA-2022-2713)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2713
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70841584");
...
var pkgs = [
  "libtar-1.2.11-29.h3.eulerosv2r7"
];
