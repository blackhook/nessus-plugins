...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libgcrypt (EulerOS-SA-2021-2532)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2532
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b68fa691");
...
var pkgs = [
  "libgcrypt-1.8.5-1.h3.eulerosv2r9"
];
