...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : postgresql (EulerOS-SA-2016-1001)");
...
vulnerability :
  ...
  - An integer overflow flaw, leading to a heap-based
    buffer overflow, was found in the PostgreSQL handling
    code for regular expressions. A remote attacker could
    use a specially crafted regular expression to cause
    PostgreSQL to crash or possibly execute arbitrary
    code.(CVE-2016-0773)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1001
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?19a11099");
...
pkgs = ["postgresql-9.2.15-1",
        "postgresql-contrib-9.2.15-1",
        "postgresql-devel-9.2.15-1",
        "postgresql-docs-9.2.15-1",
        "postgresql-libs-9.2.15-1",
        "postgresql-plperl-9.2.15-1",
        "postgresql-plpython-9.2.15-1",
        "postgresql-pltcl-9.2.15-1",
        "postgresql-server-9.2.15-1",
        "postgresql-test-9.2.15-1"];
