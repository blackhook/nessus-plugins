...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : protobuf (EulerOS-SA-2023-2093)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2093
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cd3affb3");
...
var pkgs = [
  "protobuf-3.14.0-1.h4.eulerosv2r11",
  "protobuf-compiler-3.14.0-1.h4.eulerosv2r11"
];
