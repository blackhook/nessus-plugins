...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : flac (EulerOS-SA-2022-2496)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2496
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4d4d66fe");
...
var pkgs = [
  "flac-libs-1.3.0-5.h2.eulerosv2r7"
];
