...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : postgresql (EulerOS-SA-2021-2811)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2811
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc9db2a2");
...
"Update the affected postgresql packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-32028");
...
var pkgs = [
  "postgresql-10.5-3.h14.eulerosv2r8",
  "postgresql-contrib-10.5-3.h14.eulerosv2r8",
  "postgresql-devel-10.5-3.h14.eulerosv2r8",
  "postgresql-docs-10.5-3.h14.eulerosv2r8",
  "postgresql-libs-10.5-3.h14.eulerosv2r8",
  "postgresql-plperl-10.5-3.h14.eulerosv2r8",
  "postgresql-plpython-10.5-3.h14.eulerosv2r8",
  "postgresql-pltcl-10.5-3.h14.eulerosv2r8",
  "postgresql-server-10.5-3.h14.eulerosv2r8",
  "postgresql-test-10.5-3.h14.eulerosv2r8"
];
