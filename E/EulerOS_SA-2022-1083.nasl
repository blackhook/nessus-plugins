...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : lz4 (EulerOS-SA-2022-1083)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the lz4 packages installed, the EulerOS Virtualization installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1083
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4693699c");
...
var pkgs = [
  "lz4-1.8.2-2.h4.eulerosv2r8",
  "lz4-devel-1.8.2-2.h4.eulerosv2r8",
  "lz4-libs-1.8.2-2.h4.eulerosv2r8"
];
