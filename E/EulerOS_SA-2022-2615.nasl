...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : ImageMagick (EulerOS-SA-2022-2615)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2615
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a528847");
...
var pkgs = [
  "ImageMagick-6.9.9.38-1.h18",
  "ImageMagick-c++-6.9.9.38-1.h18",
  "ImageMagick-libs-6.9.9.38-1.h18",
  "ImageMagick-perl-6.9.9.38-1.h18"
];
