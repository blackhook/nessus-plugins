...
code.");
  # https://www.secureauth.com/labs/advisories/novell-imanager-buffer-overflow-off-by-one-vulnerabilities
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae3ef2f4");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-12-146/");
  script_set_attribute(attribute:"see_also", value:"https://support.microfocus.com/kb/doc.php?id=7009947");
...
"Upgrade to eDirectory 8.8 SP6 Patch 5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-1929");
