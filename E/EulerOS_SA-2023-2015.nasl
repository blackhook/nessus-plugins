...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : dnsmasq (EulerOS-SA-2023-2015)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2015
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ac646f1");
...
var pkgs = [
  "dnsmasq-2.81-1.h12.eulerosv2r9"
];
