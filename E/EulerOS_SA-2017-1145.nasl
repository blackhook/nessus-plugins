...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ghostscript (EulerOS-SA-2017-1145)");
...
vulnerability :
  ...
  - The mem_get_bits_rectangle function in Artifex
    Software, Inc. Ghostscript 9.20 allows remote attackers
    to cause a denial of service (NULL pointer dereference)
    via a crafted PostScript document.(CVE-2017-7207)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1145
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2571f37f");
...
pkgs = ["ghostscript-9.07-20.1.h3",
        "ghostscript-cups-9.07-20.1.h3"];
