...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : libjpeg-turbo (EulerOS-SA-2022-2733)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2733
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39f31078");
...
var pkgs = [
  "libjpeg-turbo-2.0.4-1.h3.eulerosv2r9"
];
