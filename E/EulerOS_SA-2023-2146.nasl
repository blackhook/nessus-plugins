...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : golang (EulerOS-SA-2023-2146)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2146
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0de2215");
...
var pkgs = [
  "golang-1.13.3-9.h28.eulerosv2r7",
  "golang-bin-1.13.3-9.h28.eulerosv2r7",
  "golang-src-1.13.3-9.h28.eulerosv2r7"
];
