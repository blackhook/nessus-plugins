...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : haproxy (EulerOS-SA-2022-1806)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1806
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?745e74bf");
...
var pkgs = [
  "haproxy-2.0.14-2.h7.eulerosv2r10"
];
