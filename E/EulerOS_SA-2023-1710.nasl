...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : wayland (EulerOS-SA-2023-1710)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the wayland packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1710
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a6b1b58");
...
var pkgs = [
  "libwayland-client-1.15.0-1.h1",
  "libwayland-cursor-1.15.0-1.h1",
  "libwayland-egl-1.15.0-1.h1",
  "libwayland-server-1.15.0-1.h1"
];
