...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : containerd (EulerOS-SA-2023-1406)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1406
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?934c62b2");
...
var pkgs = [
  "docker-engine-18.09.0-300.h25.32.25.eulerosv2r11"
];
