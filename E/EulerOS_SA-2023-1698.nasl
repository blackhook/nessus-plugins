...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : systemd (EulerOS-SA-2023-1698)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1698
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c4e2d02");
...
var pkgs = [
  "libgudev1-219-62.5.h130",
  "systemd-219-62.5.h130",
  "systemd-libs-219-62.5.h130",
  "systemd-networkd-219-62.5.h130",
  "systemd-python-219-62.5.h130",
  "systemd-resolved-219-62.5.h130",
  "systemd-sysv-219-62.5.h130",
  "systemd-udev-compat-219-62.5.h130"
];
