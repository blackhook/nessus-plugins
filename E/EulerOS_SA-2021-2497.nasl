...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : golang (EulerOS-SA-2021-2497)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2497
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?766bf374");
...
var pkgs = [
  "golang-1.13.3-9.h7.eulerosv2r7",
  "golang-bin-1.13.3-9.h7.eulerosv2r7",
  "golang-src-1.13.3-9.h7.eulerosv2r7"
];
