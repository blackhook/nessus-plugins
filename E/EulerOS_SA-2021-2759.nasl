...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : libgcrypt (EulerOS-SA-2021-2759)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2759
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?241c27b5");
...
var pkgs = [
  "libgcrypt-1.8.5-1.h5.eulerosv2r9"
];
