...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : ceph (EulerOS-SA-2023-1308)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1308
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7a0a211a");
...
var pkgs = [
  "librados2-12.2.8-1.h13.eulerosv2r8",
  "librbd1-12.2.8-1.h13.eulerosv2r8",
  "python-rados-12.2.8-1.h13.eulerosv2r8",
  "python-rbd-12.2.8-1.h13.eulerosv2r8"
];
