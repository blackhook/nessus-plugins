...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libarchive (EulerOS-SA-2022-1403)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1403
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?918d43c6");
...
var pkgs = [
  "libarchive-3.4.3-2.h2.eulerosv2r10"
];
