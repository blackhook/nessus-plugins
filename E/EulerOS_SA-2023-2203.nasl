...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : python2-lxml (EulerOS-SA-2023-2203)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the python2-lxml packages installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2203
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?83d31627");
  script_set_attribute(attribute:"solution", value:
"Update the affected python2-lxml packages.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python2-lxml");
}
