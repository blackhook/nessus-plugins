...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : binutils (EulerOS-SA-2017-1285)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1285
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?550c681a");
...
pkgs = ["binutils-2.23.52.0.1-55.h4",
        "binutils-devel-2.23.52.0.1-55.h4"];
