...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP11 : harfbuzz (EulerOS-SA-2023-2270)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2270
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?180b369c");
...
var pkgs = [
  "harfbuzz-2.8.2-1.h2.eulerosv2r11",
  "harfbuzz-devel-2.8.2-1.h2.eulerosv2r11",
  "harfbuzz-help-2.8.2-1.h2.eulerosv2r11"
];
