...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : harfbuzz (EulerOS-SA-2023-1977)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1977
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe2770a7");
...
var pkgs = [
  "harfbuzz-2.8.1-1.h3.eulerosv2r10",
  "harfbuzz-devel-2.8.1-1.h3.eulerosv2r10",
  "harfbuzz-help-2.8.1-1.h3.eulerosv2r10"
];
