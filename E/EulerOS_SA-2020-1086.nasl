...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.5.0 : sudo (EulerOS-SA-2020-1086)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1086
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1cf3c4c6");
...
pkgs = ["sudo-1.8.23-3.h10.eulerosv2r8"];
