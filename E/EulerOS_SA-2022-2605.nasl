...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : dbus (EulerOS-SA-2022-2605)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2605
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7d1502d4");
...
var pkgs = [
  "dbus-1.6.12-14.h22",
  "dbus-devel-1.6.12-14.h22",
  "dbus-libs-1.6.12-14.h22",
  "dbus-x11-1.6.12-14.h22"
];
