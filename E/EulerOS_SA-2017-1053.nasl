...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : libvirt (EulerOS-SA-2017-1053)");
  script_summary(english:"Checks the rpm output for the updated package.");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the version of the libvirt package installed, the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1053
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8e1d649");
...
pkgs = ["libvirt-client-2.0.0-10.5"];
