...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : protobuf (EulerOS-SA-2022-2062)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the protobuf packages installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2062
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b3742f8");
...
"Update the affected protobuf packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:protobuf");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:protobuf-compiler");
...
var pkgs = [
  "protobuf-3.12.3-14.h3.eulerosv2r10",
  "protobuf-compiler-3.12.3-14.h3.eulerosv2r10"
];
