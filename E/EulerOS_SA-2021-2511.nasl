...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : mod_auth_mellon (EulerOS-SA-2021-2511)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2511
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b272a5f0");
...
var pkgs = [
  "mod_auth_mellon-0.13.1-3.h5.eulerosv2r7"
];
