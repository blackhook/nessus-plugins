...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : java-1.7.0-openjdk (EulerOS-SA-2019-2007)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2019-2007
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3728412");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.191-2.6.15.4.h5",
        "java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.h5",
        "java-1.7.0-openjdk-headless-1.7.0.191-2.6.15.4.h5"];
