...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : openssl (EulerOS-SA-2022-2032)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2032
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?789d94a7");
...
var pkgs = [
  "openssl-1.1.1f-8.h24.eulerosv2r10",
  "openssl-libs-1.1.1f-8.h24.eulerosv2r10",
  "openssl-perl-1.1.1f-8.h24.eulerosv2r10"
];
