...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : openjpeg (EulerOS-SA-2021-2478)");
...
the following vulnerabilities :
  ...
  - A flaw was found in OpenJPEGs encoder. This flaw allows an attacker to pass specially crafted x,y offset
  ...
  - A flaw was found in OpenJPEGs encoder in the opj_dwt_calc_explicit_stepsizes() function. This flaw allows
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2478
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?55f4f4d9");
...
var pkgs = [
  "openjpeg-libs-1.5.1-22.h3.eulerosv2r8"
];
