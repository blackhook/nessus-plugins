...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : rsyslog (EulerOS-SA-2023-1692)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1692
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc43942e");
...
var pkgs = [
  "rsyslog-8.24.0-17.h26",
  "rsyslog-mmjsonparse-8.24.0-17.h26"
];
