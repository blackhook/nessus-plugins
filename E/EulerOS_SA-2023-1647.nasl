...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : python-pillow (EulerOS-SA-2023-1647)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1647
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af815265");
...
var pkgs = [
  "python3-pillow-5.3.0-4.h23.eulerosv2r9",
  "python3-pillow-help-5.3.0-4.h23.eulerosv2r9"
];
