...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : docker-runc (EulerOS-SA-2023-1800)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1800
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a12a0f13");
...
var pkgs = [
  "docker-runc-1.0.0.rc3-200.h15.eulerosv2r10"
];
