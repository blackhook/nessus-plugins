...
name server on all hosts involved in distributed Erlang computations.");
  script_set_attribute(attribute:"see_also", value:"http://erlang.org/doc/man/epmd.html");
  script_set_attribute(attribute:"see_also", value:"http://erlang.org/doc/apps/erts/erl_dist_protocol.html");
