...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : python (EulerOS-SA-2017-1335)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1335
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01e8eda5");
...
pkgs = ["python-2.7.5-58.h6",
        "python-devel-2.7.5-58.h6",
        "python-libs-2.7.5-58.h6",
        "tkinter-2.7.5-58.h6"];
