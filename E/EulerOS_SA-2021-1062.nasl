...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : compat-libtiff3 (EulerOS-SA-2021-1062)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-1062
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2167a03c");
...
pkgs = ["compat-libtiff3-3.9.4-11.h21"];
