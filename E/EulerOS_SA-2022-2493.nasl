...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : e2fsprogs (EulerOS-SA-2022-2493)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2493
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00ee2d8e");
...
var pkgs = [
  "e2fsprogs-1.45.3-1.h8.eulerosv2r7",
  "e2fsprogs-devel-1.45.3-1.h8.eulerosv2r7",
  "e2fsprogs-libs-1.45.3-1.h8.eulerosv2r7",
  "libcom_err-1.45.3-1.h8.eulerosv2r7",
  "libcom_err-devel-1.45.3-1.h8.eulerosv2r7",
  "libss-1.45.3-1.h8.eulerosv2r7"
];
