...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : openblas (EulerOS-SA-2022-1300)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1300
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb1b09db");
...
var pkgs = [
  "openblas-0.3.9-4.h2.eulerosv2r9"
];
