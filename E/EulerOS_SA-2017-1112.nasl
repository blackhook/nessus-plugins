...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ImageMagick (EulerOS-SA-2017-1112)");
...
vulnerabilities :
  ...
  - coders/psd.c in ImageMagick allows remote attackers to
    ...
    crafted PSD file.(CVE-2016-7535)
  ...
  - coders/psd.c in ImageMagick allows remote attackers to
    cause a denial of service (out-of-bounds write) via a
    crafted file.(CVE-2016-7538)

  - coders/psd.c in ImageMagick allows remote attackers to
    cause a denial of service (out-of-bounds read) via a
    crafted PSD file.(CVE-2016-7532)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1112
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ec34c941");
