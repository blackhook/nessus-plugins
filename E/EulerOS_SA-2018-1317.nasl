...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : wpa_supplicant (EulerOS-SA-2018-1317)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1317
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2658eaab");
...
pkgs = ["wpa_supplicant-2.6-5.1.h9"];
