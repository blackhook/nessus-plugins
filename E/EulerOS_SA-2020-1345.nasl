...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : curl (EulerOS-SA-2020-1345)");
...
pkgs = ["curl-7.61.1-2.h7.eulerosv2r8",
        "libcurl-7.61.1-2.h7.eulerosv2r8"];
