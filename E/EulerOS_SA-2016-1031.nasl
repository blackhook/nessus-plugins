...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : samba (EulerOS-SA-2016-1031)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2016-1031
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06939b65");
...
pkgs = ["libsmbclient-4.2.10-7",
        "libwbclient-4.2.10-7",
        "samba-4.2.10-7",
        "samba-client-4.2.10-7",
        "samba-client-libs-4.2.10-7",
        "samba-common-4.2.10-7",
        "samba-common-libs-4.2.10-7",
        "samba-common-tools-4.2.10-7",
        "samba-libs-4.2.10-7",
        "samba-python-4.2.10-7",
        "samba-winbind-4.2.10-7",
        "samba-winbind-clients-4.2.10-7",
        "samba-winbind-modules-4.2.10-7"];
