...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : sssd (EulerOS-SA-2023-2026)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2026
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78430bdd");
...
var pkgs = [
  "python3-sssd-2.2.2-3.h16.eulerosv2r9",
  "sssd-2.2.2-3.h16.eulerosv2r9"
];
