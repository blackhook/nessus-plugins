...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : tcpdump (EulerOS-SA-2023-2175)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the tcpdump package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2175
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33eeed28");
...
var pkgs = [
  "tcpdump-4.9.2-3.h5.eulerosv2r7"
];
