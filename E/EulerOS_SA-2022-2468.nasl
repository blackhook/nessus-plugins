...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : libmspack (EulerOS-SA-2022-2468)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libmspack package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2468
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2203ea70");
...
var pkgs = [
  "libmspack-0.7-0.1.alpha.h6.eulerosv2r8"
];
