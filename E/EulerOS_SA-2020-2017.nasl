...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : bind (EulerOS-SA-2020-2017)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2017
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52125b13");
...
pkgs = ["bind-export-libs-9.11.4-10.P2.h21.eulerosv2r8",
