...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : docker-engine (EulerOS-SA-2022-1993)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1993
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6d4c1a78");
...
var pkgs = [
  "docker-engine-18.09.0.129-1.h59.28.13.eulerosv2r9"
];
