...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.5.1 : qemu-kvm (EulerOS-SA-2018-1321)");
...
the following vulnerability :
  ...
  - Qemu before version 2.9 is vulnerable to an improper
    ...
    host.i1/4^CVE-2016-9602i1/4%0

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1321
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb9a3d2b");
...
pkgs = ["qemu-kvm-2.8.1-25.142",
        "qemu-kvm-common-2.8.1-25.142",
        "qemu-kvm-tools-2.8.1-25.142"];
