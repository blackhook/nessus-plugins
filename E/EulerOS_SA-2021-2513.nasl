...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : nginx (EulerOS-SA-2021-2513)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2513
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?981b517e");
...
var pkgs = [
  "nginx-1.16.1-1.h4.eulerosv2r7",
  "nginx-all-modules-1.16.1-1.h4.eulerosv2r7",
  "nginx-filesystem-1.16.1-1.h4.eulerosv2r7",
  "nginx-mod-http-image-filter-1.16.1-1.h4.eulerosv2r7",
  "nginx-mod-http-perl-1.16.1-1.h4.eulerosv2r7",
  "nginx-mod-http-xslt-filter-1.16.1-1.h4.eulerosv2r7",
  "nginx-mod-mail-1.16.1-1.h4.eulerosv2r7",
  "nginx-mod-stream-1.16.1-1.h4.eulerosv2r7"
];
