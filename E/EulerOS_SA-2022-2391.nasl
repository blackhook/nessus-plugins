...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : libxslt (EulerOS-SA-2022-2391)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2391
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?afdec6fa");
...
var pkgs = [
  "libxslt-1.1.34-1.h2.eulerosv2r9"
];
