...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : java-1.7.0-openjdk (EulerOS-SA-2017-1098)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1098
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25d4be49");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.141-2.6.10.1",
        "java-1.7.0-openjdk-devel-1.7.0.141-2.6.10.1",
        "java-1.7.0-openjdk-headless-1.7.0.141-2.6.10.1"];
