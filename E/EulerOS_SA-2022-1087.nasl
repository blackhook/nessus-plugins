...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : openldap (EulerOS-SA-2022-1087)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1087
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f54d2b3");
...
var pkgs = [
  "openldap-2.4.46-8.h14.eulerosv2r8",
