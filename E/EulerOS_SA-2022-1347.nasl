...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : gstreamer-plugins-bad-free (EulerOS-SA-2022-1347)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1347
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0384d265");
...
var pkgs = [
  "gstreamer-plugins-bad-free-0.10.23-47.h2.eulerosv2r8"
];
