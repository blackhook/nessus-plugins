...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : python-pip (EulerOS-SA-2021-2761)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2761
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a8aa65c");
...
var pkgs = [
  "python-pip-wheel-18.0-13.h5.eulerosv2r9",
  "python3-pip-18.0-13.h5.eulerosv2r9"
];
