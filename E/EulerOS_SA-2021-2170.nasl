...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : sudo (EulerOS-SA-2021-2170)");
...
following vulnerability :
  ...
  - Sudo before 1.9.5p2 has a Heap-based Buffer
    Overflow,allowing privilege escalation to root via
    'sudoedit -s' and a command-line argument that ends
    with a single backslash character: (CVE-2021-3156)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2170
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c388a4c7");
