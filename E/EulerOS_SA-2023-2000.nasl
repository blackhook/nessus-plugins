...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : libtiff (EulerOS-SA-2023-2000)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2000
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a063052");
...
var pkgs = [
  "libtiff-4.1.0-1.h1.r19.eulerosv2r9"
];
