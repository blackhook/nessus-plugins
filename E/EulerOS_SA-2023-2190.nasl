...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : docker-engine (EulerOS-SA-2023-2190)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2190
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?58113d8c");
...
var pkgs = [
  "docker-engine-18.09.0.101-1.h62.25.17.eulerosv2r8"
];
