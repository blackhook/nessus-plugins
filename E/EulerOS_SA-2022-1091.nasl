...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : python-pip (EulerOS-SA-2022-1091)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1091
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2c4aeb23");
...
var pkgs = [
  "python-pip-wheel-18.0-4.h9.eulerosv2r8",
  "python2-pip-18.0-4.h9.eulerosv2r8",
  "python3-pip-18.0-4.h9.eulerosv2r8"
];
