...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : bind (EulerOS-SA-2021-2572)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2572
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?54df7f23");
...
var pkgs = [
  "bind-9.9.4-61.1.h12",
  "bind-chroot-9.9.4-61.1.h12",
  "bind-libs-9.9.4-61.1.h12",
  "bind-libs-lite-9.9.4-61.1.h12",
  "bind-license-9.9.4-61.1.h12",
  "bind-pkcs11-9.9.4-61.1.h12",
  "bind-pkcs11-libs-9.9.4-61.1.h12",
  "bind-pkcs11-utils-9.9.4-61.1.h12",
  "bind-utils-9.9.4-61.1.h12"
];
