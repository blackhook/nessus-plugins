...
"Update the affected numpy packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:numpy-f2py-1.7.1-13.h3.aarch64.rpm numpy");
...
var pkgs = [
  "numpy-f2py-1.7.1-13.h3.aarch64.rpm numpy-1.7.1-13.h3"
];
