...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : ceph-common (EulerOS-SA-2022-1525)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1525
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31713d1e");
...
var pkgs = [
  "ceph-common-0.94.5-2.h2.eulerosv2r7",
  "librados2-0.94.5-2.h2.eulerosv2r7",
  "librbd1-0.94.5-2.h2.eulerosv2r7",
  "python-rados-0.94.5-2.h2.eulerosv2r7",
  "python-rbd-0.94.5-2.h2.eulerosv2r7"
];
