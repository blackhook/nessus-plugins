...
"The web server hosts a remotely accessible error logging application.");
...
sensitive data that could be used to launch further attacks.");
  script_set_attribute(attribute:"see_also", value:"https://code.google.com/archive/p/elmah");
  script_set_attribute(attribute:"see_also", value:"https://code.google.com/archive/p/elmah/wikis/SecuringErrorLogPages.wiki");
