...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : cryptsetup (EulerOS-SA-2022-2339)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2339
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d22f1c4d");
...
var pkgs = [
  "cryptsetup-2.3.1-1.h4.eulerosv2r9",
  "cryptsetup-reencrypt-2.3.1-1.h4.eulerosv2r9"
];
