...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : gnutls (EulerOS-SA-2023-2221)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2221
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a1700191");
...
var pkgs = [
  "gnutls-3.6.7-1.h11.eulerosv2r8",
  "gnutls-c++-3.6.7-1.h11.eulerosv2r8",
  "gnutls-dane-3.6.7-1.h11.eulerosv2r8",
  "gnutls-devel-3.6.7-1.h11.eulerosv2r8",
  "gnutls-utils-3.6.7-1.h11.eulerosv2r8"
];
