...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : golang (EulerOS-SA-2022-1473)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1473
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d81d8f6c");
...
"Update the affected golang packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-41771");
...
var pkgs = [
  "golang-1.15.7-2.h13.eulerosv2r10",
  "golang-devel-1.15.7-2.h13.eulerosv2r10",
  "golang-help-1.15.7-2.h13.eulerosv2r10"
];
