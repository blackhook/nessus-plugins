...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : libwebp (EulerOS-SA-2022-2516)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2516
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb52ecf7");
...
"Update the affected libwebp packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-36332");
...
var pkgs = [
  "libwebp-0.3.0-7.h3.eulerosv2r7"
];
