...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : shim (EulerOS-SA-2023-1962)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1962
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31c7641a");
...
var pkgs = [
  "shim-15-20.h8.eulerosv2r10",
  "shim-aa64-storage-15-20.h8.eulerosv2r10"
];
