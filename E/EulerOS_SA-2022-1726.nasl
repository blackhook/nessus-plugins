...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : gstreamer1-plugins-bad-free (EulerOS-SA-2022-1726)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1726
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eedb854d");
...
var pkgs = [
  "gstreamer1-plugins-bad-free-1.10.4-2.h1"
];
