...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : poppler (EulerOS-SA-2017-1229)");
...
vulnerabilities :
  ...
  - An integer overflow leading to heap-based buffer
    ...
    applications that use poppler (such as Evince) to
    crash, or potentially execute arbitrary code when
    opened. (CVE-2017-9776)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1229
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f53d3ae8");
...
pkgs = ["poppler-0.26.5-17",
        "poppler-glib-0.26.5-17",
        "poppler-qt-0.26.5-17",
        "poppler-utils-0.26.5-17"];
