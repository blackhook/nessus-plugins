...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP1 : dhcp (EulerOS-SA-2018-1035)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1035
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e53468c");
...
pkgs = ["dhcp-4.2.5-58.1.h2",
        "dhcp-common-4.2.5-58.1.h2",
        "dhcp-libs-4.2.5-58.1.h2"];
