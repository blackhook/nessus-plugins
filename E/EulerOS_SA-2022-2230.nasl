...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : pidgin (EulerOS-SA-2022-2230)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2230
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?145aa180");
...
var pkgs = [
  "libpurple-2.13.0-6.h1.eulerosv2r8"
];
