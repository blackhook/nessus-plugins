...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : ruby (EulerOS-SA-2022-2010)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2010
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6ed1aa2c");
...
var pkgs = [
  "ruby-2.5.1-104.h14.eulerosv2r9",
  "ruby-help-2.5.1-104.h14.eulerosv2r9",
  "ruby-irb-2.5.1-104.h14.eulerosv2r9"
];
