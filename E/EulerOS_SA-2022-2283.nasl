...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP9 : docker-runc (EulerOS-SA-2022-2283)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2283
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?579ed273");
...
var pkgs = [
  "docker-runc-1.0.0.rc3-108.h15.eulerosv2r9"
];
