...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : cyrus-sasl (EulerOS-SA-2023-1694)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1694
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da424064");
...
var pkgs = [
  "cyrus-sasl-2.1.26-23.h4",
  "cyrus-sasl-gssapi-2.1.26-23.h4",
  "cyrus-sasl-lib-2.1.26-23.h4",
  "cyrus-sasl-md5-2.1.26-23.h4",
  "cyrus-sasl-plain-2.1.26-23.h4"
];
