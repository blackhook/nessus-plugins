...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.0 : libxslt (EulerOS-SA-2022-2876)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libxslt package installed, the EulerOS Virtualization installation on the remote host
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2876
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc10f293");
...
var pkgs = [
  "libxslt-1.1.34-3.h2.eulerosv2r10"
];
