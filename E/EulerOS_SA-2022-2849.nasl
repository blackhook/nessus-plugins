...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libjpeg-turbo (EulerOS-SA-2022-2849)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2849
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?372a0c96");
...
var pkgs = [
  "libjpeg-turbo-2.0.5-1.h3.eulerosv2r10"
];
