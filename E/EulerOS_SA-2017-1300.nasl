...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : firefox (EulerOS-SA-2017-1300)");
...
vulnerabilities :
  ...
  - Multiple flaws were found in the processing of
    ...
    running Firefox. (CVE-2017-7826, CVE-2017-7828,
    CVE-2017-7830)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1300
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?510612ca");
