...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : systemd (EulerOS-SA-2020-1436)");
...
vulnerability :
  ...
  - The manager_invoke_notify_message function in systemd
    231 and earlier allows local users to cause a denial of
    service (assertion failure and PID 1 hang) via a
    zero-length message received over a notify
    socket.(CVE-2016-7795)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-1436
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12c63250");
...
pkgs = ["libgudev1-219-30.6.h73",
        "libgudev1-devel-219-30.6.h73",
        "systemd-219-30.6.h73",
        "systemd-devel-219-30.6.h73",
        "systemd-libs-219-30.6.h73",
        "systemd-python-219-30.6.h73",
        "systemd-sysv-219-30.6.h73"];
