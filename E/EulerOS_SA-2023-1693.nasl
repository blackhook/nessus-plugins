...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : glibc (EulerOS-SA-2023-1693)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1693
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?371e1176");
...
var pkgs = [
  "glibc-2.28-9.h72",
  "glibc-all-langpacks-2.28-9.h72",
  "glibc-common-2.28-9.h72",
  "glibc-devel-2.28-9.h72",
  "glibc-headers-2.28-9.h72",
  "libnsl-2.28-9.h72",
  "nscd-2.28-9.h72"
];
