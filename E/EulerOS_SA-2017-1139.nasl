...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : openssh (EulerOS-SA-2017-1139)");
...
vulnerability :
  ...
  - The shared memory manager (associated with
    ...
    before 7.4 does not ensure that a bounds check is
    enforced by all compilers, which might allows local
    users to gain privileges by leveraging access to a
    sandboxed privilege-separation process, related to the
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1139
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e615b28");
...
pkgs = ["openssh-6.6.1p1-28.h11",
        "openssh-askpass-6.6.1p1-28.h11",
        "openssh-clients-6.6.1p1-28.h11",
        "openssh-keycat-6.6.1p1-28.h11",
        "openssh-server-6.6.1p1-28.h11"];
