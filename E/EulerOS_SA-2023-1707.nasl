...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : expat (EulerOS-SA-2023-1707)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1707
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?82422851");
...
var pkgs = [
  "expat-2.1.0-10.h12",
  "expat-devel-2.1.0-10.h12",
  "expat-static-2.1.0-10.h12"
];
