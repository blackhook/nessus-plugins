...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : kernel (EulerOS-SA-2023-2184)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2184
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4fe6f253");
...
"Update the affected kernel packages.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-20565");
...
var pkgs = [
  "kernel-3.10.0-862.14.1.5.h483.eulerosv2r7",
