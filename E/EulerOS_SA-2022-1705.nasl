...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP3 : bind (EulerOS-SA-2022-1705)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1705
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f9c8111");
...
var pkgs = [
  "bind-9.9.4-61.1.h13",
  "bind-chroot-9.9.4-61.1.h13",
  "bind-libs-9.9.4-61.1.h13",
  "bind-libs-lite-9.9.4-61.1.h13",
  "bind-license-9.9.4-61.1.h13",
  "bind-pkcs11-9.9.4-61.1.h13",
  "bind-pkcs11-libs-9.9.4-61.1.h13",
  "bind-pkcs11-utils-9.9.4-61.1.h13",
  "bind-utils-9.9.4-61.1.h13"
];
