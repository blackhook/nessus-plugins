...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : libnl3 (EulerOS-SA-2017-1162)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1162
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8690e9cc");
...
pkgs = ["libnl3-3.2.28-4.h1",
        "libnl3-cli-3.2.28-4.h1"];
