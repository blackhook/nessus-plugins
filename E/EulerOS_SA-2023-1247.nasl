...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.2 : cifs-utils (EulerOS-SA-2023-1247)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1247
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3e3f4fea");
...
var pkgs = [
  "cifs-utils-6.2-10.h4.eulerosv2r7"
];
