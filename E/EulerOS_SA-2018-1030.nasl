...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : ruby (EulerOS-SA-2018-1030)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1030
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a20b0cc1");
...
pkgs = ["ruby-2.0.0.598-25.h6",
        "ruby-irb-2.0.0.598-25.h6",
        "ruby-libs-2.0.0.598-25.h6"];
