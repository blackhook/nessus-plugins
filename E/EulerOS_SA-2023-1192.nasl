...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : gnutls (EulerOS-SA-2023-1192)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1192
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b84e9bfa");
...
var pkgs = [
  ...
  "gnutls-utils-3.6.9-6.h11.eulerosv2r9"
];
