...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.0 : unbound (EulerOS-SA-2023-2215)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2215
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba4de0ee");
...
var pkgs = [
  "python2-unbound-1.7.3-9.h8.eulerosv2r8",
  "python3-unbound-1.7.3-9.h8.eulerosv2r8",
  "unbound-1.7.3-9.h8.eulerosv2r8",
  "unbound-libs-1.7.3-9.h8.eulerosv2r8"
];
