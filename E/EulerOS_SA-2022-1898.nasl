...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : libinput (EulerOS-SA-2022-1898)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1898
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c201593f");
...
var pkgs = [
  "libinput-1.8.4-2.h1.eulerosv2r7"
];
