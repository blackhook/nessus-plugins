...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP8 : compat-openssl10 (EulerOS-SA-2022-1559)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1559
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63d7c9bc");
...
var pkgs = [
  "compat-openssl10-1.0.2o-3.h13.eulerosv2r8"
];
