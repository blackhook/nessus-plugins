...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.2.0 : virglrenderer (EulerOS-SA-2023-1749)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the virglrenderer package installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1749
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ca90dfdd");
...
var pkgs = [
  "virglrenderer-0.6.0-3.20170210git76b3da97b"
];
