...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : samba (EulerOS-SA-2017-1234)");
...
vulnerabilities :
  ...
  - It was found that samba did not enforce 'SMB signing'
    ...
    and retrieve information in plain-text.
    (CVE-2017-12150)
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1234
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70b242e2");
...
pkgs = ["libsmbclient-4.6.2-8.h3",
        "libwbclient-4.6.2-8.h3",
        "samba-4.6.2-8.h3",
        "samba-client-4.6.2-8.h3",
        "samba-client-libs-4.6.2-8.h3",
        "samba-common-4.6.2-8.h3",
        "samba-common-libs-4.6.2-8.h3",
        "samba-common-tools-4.6.2-8.h3",
        "samba-libs-4.6.2-8.h3",
        "samba-python-4.6.2-8.h3",
        "samba-winbind-4.6.2-8.h3",
        "samba-winbind-clients-4.6.2-8.h3",
        "samba-winbind-modules-4.6.2-8.h3"];
