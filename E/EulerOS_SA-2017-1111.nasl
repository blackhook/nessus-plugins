...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : gnutls (EulerOS-SA-2017-1111)");
...
vulnerability :
  ...
  - GnuTLS before 2017-02-20 has an out-of-bounds write
    ...
    3.5.10.(CVE-2017-7869)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1111
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d808c1f");
