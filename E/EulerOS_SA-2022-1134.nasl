...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 3.0.6.6 : openldap (EulerOS-SA-2022-1134)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1134
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?322638da");
...
var pkgs = [
  "openldap-2.4.44-15.h15.eulerosv2r7",
  "openldap-clients-2.4.44-15.h15.eulerosv2r7",
  "openldap-devel-2.4.44-15.h15.eulerosv2r7",
  "openldap-servers-2.4.44-15.h15.eulerosv2r7"
];
