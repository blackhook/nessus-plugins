...
"A web application can be accessed with default credentials.");
  script_set_attribute(attribute:"description", value:
"It is possible to log into the Ektron CMS400.NET install on the remote
host using a default set of credentials.");
  script_set_attribute(attribute:"see_also", value:"https://www.episerver.com/products/episerver-cms-individualized-content/?utm_campaign=REF-ektron-redirect&utm_medium=referral&utm_source=ektron.com");
