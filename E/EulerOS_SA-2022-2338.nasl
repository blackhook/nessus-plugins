...
if (description)
{
  script_id(165414);
  script_version("1.2");
  script_set_attribute(attribute:"plugin_modification_date", value:"2022/09/24");

  script_cve_id("CVE-2022-27239", "CVE-2022-29869");

  script_name(english:"EulerOS Virtualization 2.9.1 : cifs-utils (EulerOS-SA-2022-2338)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS Virtualization host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the cifs-utils package installed, the EulerOS Virtualization installation on the remote
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2338
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b6fb2321");
...
var pkgs = [
  "cifs-utils-6.10-0.h2.r1.eulerosv2r9"
];
