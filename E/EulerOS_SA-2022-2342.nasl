...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.1 : dnsmasq (EulerOS-SA-2022-2342)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2342
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e0f2e447");
...
var pkgs = [
  "dnsmasq-2.81-1.h10.eulerosv2r9"
];
