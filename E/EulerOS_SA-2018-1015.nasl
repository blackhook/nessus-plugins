...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : qemu-kvm (EulerOS-SA-2018-1015)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2018-1015
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?02d289de");
...
pkgs = ["qemu-img-1.5.3-141.6.h2",
        "qemu-kvm-1.5.3-141.6.h2",
        "qemu-kvm-common-1.5.3-141.6.h2"];
