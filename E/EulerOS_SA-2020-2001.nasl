...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization for ARM 64 3.0.6.0 : vim (EulerOS-SA-2020-2001)");
...
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2020-2001
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8501190");
...
pkgs = ["vim-common-8.1.450-1.h8.eulerosv2r8",
