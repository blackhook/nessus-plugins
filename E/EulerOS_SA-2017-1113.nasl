...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP2 : irssi (EulerOS-SA-2017-1113)");
...
vulnerability :
  ...
  - The netjoin processing in Irssi 1.x before 1.0.2 allows
    ...
    vectors.(CVE-2017-7191)

Note that Tenable Network Security has extracted the preceding
description block directly from the EulerOS security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2017-1113
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a989bf23");
