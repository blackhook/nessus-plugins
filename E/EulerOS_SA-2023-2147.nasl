...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP5 : hsqldb (EulerOS-SA-2023-2147)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the hsqldb package installed, the EulerOS installation on the remote host is affected by
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2147
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?99d699f6");
  script_set_attribute(attribute:"solution", value:
"Update the affected hsqldb packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:huawei:euleros:hsqldb");
...
var pkgs = [
  "hsqldb-1.8.1.3-14.h2.eulerosv2r7"
];
