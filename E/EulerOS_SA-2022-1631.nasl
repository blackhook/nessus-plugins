...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.9.0 : libarchive (EulerOS-SA-2022-1631)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-1631
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af576107");
...
var pkgs = [
  "libarchive-3.4.1-4.h3.eulerosv2r9"
];
