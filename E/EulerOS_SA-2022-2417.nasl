...
if (description)
{
  ...
  script_name(english:"EulerOS 2.0 SP10 : libjpeg-turbo (EulerOS-SA-2022-2417)");

  script_set_attribute(attribute:"synopsis", value:
"The remote EulerOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"According to the versions of the libjpeg-turbo package installed, the EulerOS installation on the remote host is
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2022-2417
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e23c923b");
...
var pkgs = [
  "libjpeg-turbo-2.0.5-1.h2.eulerosv2r10"
];
