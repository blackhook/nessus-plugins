...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.11.0 : tpm2-tss (EulerOS-SA-2023-2114)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-2114
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2a8fec8");
...
var pkgs = [
  "tpm2-tss-3.1.0-1.h1.eulerosv2r11"
];
