...
if (description)
{
  ...
  script_name(english:"EulerOS Virtualization 2.10.1 : libXpm (EulerOS-SA-2023-1906)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2023-1906
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?581a3364");
...
var pkgs = [
  "libXpm-3.5.13-1.h1.eulerosv2r10"
];
