...
if (description)
{
  ...
  script_cve_id("CVE-2021-3743", "CVE-2021-33909");
  script_xref(name:"IAVA", value:"2021-A-0350");

  script_name(english:"EulerOS Virtualization 2.9.0 : kernel (EulerOS-SA-2021-2782)");
...
issues.");
  # https://developer.huaweicloud.com/ict/en/site-euleros/euleros/security-advisories/EulerOS-SA-2021-2782
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b01424e6");
...
var pkgs = [
  ...
  "perf-4.18.0-147.5.1.6.h579.eulerosv2r9"
];
