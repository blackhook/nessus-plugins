...
possible for an authenticated FTP user to crash the affected service."
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2010/Jan/201");
  script_set_attribute(attribute:"see_also", value:"https://www.tbsoftinc.com/tbserver/turboftp-server-releasenotes.html" );
