...
function tftp_ping(port, huge)
{
 ...
 for (i = 0; i < 3; i ++)	# Try 3 times
 {
  ...
  if(rep)
  {
   dbg::detailed_log(lvl:3, src:FUNCTION_NAME, msg:'TFTP (IP)', msg_details:{"Data":{"lvl":3, "value":rep}});
   data = get_udp_element(udp: rep, element:"data");
   dbg::detailed_log(lvl:3, src:FUNCTION_NAME, msg:'TFTP (UDP)', msg_details:{"Data":{"lvl":3, "value":data}});
