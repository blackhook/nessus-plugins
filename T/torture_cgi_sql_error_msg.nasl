...
database, or even take control of the remote operating system.");
  # https://www.cisco.com/c/en/us/about/security-center/sql-injection.html#5
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d25a4dfe");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5946d990");
...
- Filter error messages out.");
  ...
  script_dependencies("http_version.nasl", "webmirror.nasl", "web_app_test_settings.nasl");
