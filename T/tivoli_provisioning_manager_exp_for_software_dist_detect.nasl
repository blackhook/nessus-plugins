...
if ('<title>Tivoli Provisioning Manager Express for Software Distribution' >< res[2])
{
  ...
  install = add_install(dir:'/tpmx/', ver:ver, appname:'tivoli_provisioning_manager_exp_for_software_dist', port:port, cpe: "cpe:/a:ibm:tivoli_provisioning_manager_express");
