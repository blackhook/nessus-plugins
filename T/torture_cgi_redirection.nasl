...
credentials (phishing)." );
 script_set_attribute(attribute:"see_also", value:"https://en.wikipedia.org/wiki/URL_redirection#Manipulating_visitors");
 script_set_attribute(attribute:"see_also", value:"https://www.owasp.org/index.php/Open_redirect");
