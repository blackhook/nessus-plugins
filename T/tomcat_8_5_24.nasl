...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.16 < 8.5.24 Insecure CGI Servlet Search Algorithm Description Weakness");
...
prior to 8.5.24. It is, therefore, affected by a flaw that is due to 
...
system in an insecure state.");
  # http://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.5.24
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ffc49044");
...
tomcat_check_version(fixed:"8.5.24", min:"8.5.16", severity:SECURITY_WARNING, granularity_regex:"^8\.5\.$");
