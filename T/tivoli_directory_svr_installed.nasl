...
installed on the remote Windows host.");
  script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20160131102905/http://www-03.ibm.com/software/products/en/directoryserv");
...
foreach path (paths)
{
  ...
  register_install(
    app_name:app_name,
    vendor : 'IBM',
    product : 'Tivoli Directory Server',
    path:path,
    version:version,
