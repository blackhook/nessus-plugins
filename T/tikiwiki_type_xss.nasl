...
cross-site request forgery and local file inclusion.");
  ...
  # https://tiki.org/article113-Tiki-Wiki-CMS-Groupware-Releases-5-3-and-3-8-LTS-Security-Patches
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?939709be");
  script_set_attribute(attribute:"solution", value:
"Upgrade to 5.3 / 3.8 LTS.");
