...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.0.RC1 < 8.0.50 Security Constraint Weakness");
...
prior to 8.0.50. It is, therefore, affected by a security constraints
flaw which could expose resources to unauthorized users.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d6e5f446");
...
tomcat_check_version(fixed:"8.0.50", min:"8.0.0.RC1", severity:SECURITY_WARNING, granularity_regex:"^8\.0\.$");
