...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.0.RC1 < 8.0.45 Cache Poisoning");
...
instead relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7318cfac");
...
tomcat_check_version(fixed:"8.0.45", min:"8.0.0.RC1", severity:SECURITY_WARNING, granularity_regex:"^8(\.0)?$");
