...
if (description)
{
  ...
  script_name(english:"Apache Tomcat < 7.0.67 Session Fixation");
...
instance listening on the remote host is prior to 7.0.67. It is,
therefore, affected by a session fixation vulnerability:
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://tomcat.apache.org/security-7.html#Fixed_in_Apache_Tomcat_7.0.67");
...
tomcat_check_version(fixed:"7.0.66", fixed_display:"7.0.67", min:"7.0.0", severity:SECURITY_WARNING, granularity_regex:"^7(\.0)?$");
