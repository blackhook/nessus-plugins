...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.0.x < 8.0.52 / 8.5.x < 8.5.31 / 9.0.x < 9.0.8 Denial of Service");
...
instance listening on the remote host is 8.0.x < 8.0.52, 
8.5.x < 8.5.31 or 9.0.x < 9.0.8. It is, therefore, affected 
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.0.52");
  script_set_attribute(attribute:"see_also", value:"http://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.5.31");
  script_set_attribute(attribute:"see_also", value:"http://tomcat.apache.org/security-9.html#Fixed_in_Apache_Tomcat_9.0.8");
...
tomcat_check_version(fixed:make_list("8.0.52", "8.5.31", "9.0.8"), severity:SECURITY_WARNING, granularity_regex:"^(8(\.(0|5))?|9(\.0)?)$");
