...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 9.0.0.M1 < 9.0.30 Privilege Escalation Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote Apache Tomcat server is affected by a privilege escalation vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of Tomcat installed on the remote host is prior to 9.0.30. It is, therefore, affected by a privilege
escalation vulnerability as referenced in the 'Fixed in Apache Tomcat 9.0.30' advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/apache/tomcat/commit/1ecba14");
...
tomcat_check_version(fixed:'9.0.30', min:'9.0.0.M1', severity:SECURITY_WARNING, granularity_regex:"^9(\.0)?$");
