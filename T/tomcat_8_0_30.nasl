...
if (description)
{
  ...
  script_name(english:"Apache Tomcat < 8.0.30 Directory Disclosure");
...
instance listening on the remote host is prior to 8.0.30. It is,
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://tomcat.apache.org/security-8.html#Fixed_in_Apache_Tomcat_8.0.30");
...
tomcat_check_version(fixed:"8.0.30", min:"8.0.0", severity:SECURITY_WARNING, granularity_regex:"^8(\.0)?$");
