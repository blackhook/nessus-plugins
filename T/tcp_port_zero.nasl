...
be used. This might be a backdoor (REx)." );
 # https://web.archive.org/web/20160323130821/http://www.simovits.com/trojans/tr_data/y2814.html
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9bf6aad7" );
 script_set_attribute(attribute:"see_also", value:"http://www.bizsystems.com/downloads/labrea/localTrojans.pl" );
 script_set_attribute(attribute:"see_also", value:"https://www.lifewire.com/port-0-in-tcp-and-udp-818145" );
