...
"The version of Tomcat installed on the remote host is prior to 7.0.108. It is, therefore, affected by multiple
vulnerabilities as referenced in the Fixed_in_Apache_Tomcat_7.0.108 advisory:
  ...
  - The fix for CVE-2020-9484 was incomplete. 
    ...
    CVE-2020-9484 and the previously published mitigations for CVE-2020-9484 also apply to this issue. (CVE-2021-25329)
