...
structure.");
  ...
  script_dependencies("smb_sid2user.nasl", "smb_hotfixes.nasl", "smb_samr_user_enum.nasl");
...
file = "Documents and Settings\" + admin + "\ldapinst.log";
fh = CreateFile(
  file               : file,
