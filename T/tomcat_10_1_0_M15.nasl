...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.1.0.M1 < 10.1.0.M15 vulnerability");
...
tomcat_check_version(fixed: '10.1.0.M15', min:'10.1.0.M1', severity:SECURITY_WARNING, granularity_regex: "^(10(\.1(\.0)?)?)$");
