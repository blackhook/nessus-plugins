...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 10.0.0.M1 < 10.0.21 vulnerability");
...
tomcat_check_version(fixed: '10.0.21', min:'10.0.0.M1', severity:SECURITY_WARNING, granularity_regex: "^10(\.0)?$");
