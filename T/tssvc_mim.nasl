...
if (description)
{
  ...
  script_name(english:"Remote Desktop Protocol Server Man-in-the-Middle Weakness");
...
Authentication' setting if it is available.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2005-1794");
...
var port = get_service(svc:'msrdp', default:3389, exit_on_fail:TRUE);
var rdp_legacy = get_kb_item('msrdp/'+port+'/security_protocol/rdp_legacy');
...
var req1 = raw_string ( 0x03, 0x00, 0x00, 0x24, 0x1F, 0xE0, 0x00, 0x00, 0x00, 0x00,
...
var resp = raw_string (0x03, 0x00, 0x00, 0x0B, 0x06, 0xD0, 0x00, 0x00, 0x12, 0x34, 0x00);
...
for (i = 0; i < 3; i++)
{
  ...
  var public_key = substr (buf, first, end);
