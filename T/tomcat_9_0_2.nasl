...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 9.0.0.M22 < 9.0.2 Insecure CGI Servlet Search Algorithm Description Weakness");
...
prior to 9.0.2. It is, therefore, affected by a flaw that is due to 
...
system in an insecure state.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c5ed0752");
...
tomcat_check_version(fixed:"9.0.2", min:"9.0.0.M22", severity:SECURITY_WARNING, granularity_regex:"^9\.0\.$");
