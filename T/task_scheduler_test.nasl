...
website.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e22930a6");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2004-0212");
  ...
  script_dependencies("os_fingerprint.nasl","dcetest.nasl","smb_nativelanman.nasl");
        	...
        	send(socket:soc, data:req);
                ...
                if (r)
                {
                	if ( (ord(r[28]) == 13) &&
                           ...
                           (ord(r[30]) == 4) )
                        {
                        	security_report_v4(port:storedport, severity:SECURITY_HOLE);
				exit(0);
                        }
		}
	}
