...
var file = 'nessus' + rand();
var data, hostIp, hostIpNoScope, filter, rep, i;

foreach var mode (make_list("netascii", "octet"))
{
  ...
  hostIp = get_host_ip();
  hostIpNoScope = ereg_replace(string:hostIp, pattern:"(.*)(%.*)", replace:"\1");
  filter = 'udp and src host ' + hostIpNoScope + ' and udp[8:1]=0x00';
