...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 8.5.7 < 8.5.11 nextRequest Information Disclosure");
...
tomcat_check_version(fixed:"8.5.10", fixed_display:"8.5.11", min:"8.5.7", severity:SECURITY_WARNING, granularity_regex:"^(8(\.5))?$");
