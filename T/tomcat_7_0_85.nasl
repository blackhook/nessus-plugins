...
if (description)
{
  ...
  script_name(english:"Apache Tomcat 7.0.0 < 7.0.85 Security Constraint Weakness");
...
prior to 7.0.85. It is, therefore, affected by a security constraints
flaw which could expose resources to unauthorized users.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?170a880f");
...
tomcat_check_version(fixed:"7.0.85", min:"7.0.0", severity:SECURITY_WARNING, granularity_regex:"^7(\.0)?$");
