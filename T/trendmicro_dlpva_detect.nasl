...
"The remote web server hosts Trend Micro DLP Web Console.");
...
"n/a");
  ...
  script_set_attribute(attribute:"cpe", value:"x-cpe:/a:trendmicro:data_loss_prevention");
...
foreach dir (dirs)
{
  ...
  if ('<title>Trend Micro Data Loss Prevention Logon</title>' >< res)
  {
    ...
    installs = add_install(
      ...
      port:port,
      cpe: "x-cpe:/a:trendmicro:data_loss_prevention"
    );
