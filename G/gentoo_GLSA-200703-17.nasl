...
# extracted from Gentoo Linux Security Advisory GLSA 200703-17.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200703-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200703-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All ulogd users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ulogd");
...
if (qpkg_check(package:"app-admin/ulogd", unaffected:make_list("ge 1.23-r1"), vulnerable:make_list("lt 1.23-r1"))) flag++;
