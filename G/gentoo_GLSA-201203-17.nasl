...
# extracted from Gentoo Linux Security Advisory GLSA 201203-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201203-17");

  script_name(english:"GLSA-201203-17 : HPLIP: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201203-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201203-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-print/hplip", unaffected:make_list("ge 3.11.10"), vulnerable:make_list("lt 3.11.10"))) flag++;
