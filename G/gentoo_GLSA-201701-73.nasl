...
# extracted from Gentoo Linux Security Advisory GLSA 201701-73.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-73");

  script_name(english:"GLSA-201701-73 : SQUASHFS: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-73
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-73"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-fs/squashfs-tools", unaffected:make_list("ge 4.3-r1"), vulnerable:make_list("lt 4.3-r1"))) flag++;
