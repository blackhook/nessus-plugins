...
# extracted from Gentoo Linux Security Advisory GLSA 200607-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200607-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200607-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/tiff", unaffected:make_list("ge 3.8.2-r1"), vulnerable:make_list("lt 3.8.2-r1"))) flag++;
