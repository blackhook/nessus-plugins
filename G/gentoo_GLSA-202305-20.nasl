...
# extracted from Gentoo Linux Security Advisory GLSA 202305-20.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202305-20 : libapreq2: Buffer Overflow");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202305-20 (libapreq2: Buffer Overflow)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-20");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=866536");
...
"All libapreq2 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libapreq2");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 2.17"),
    'vulnerable' : make_list("lt 2.17")
  }
];
