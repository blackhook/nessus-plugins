...
# extracted from Gentoo Linux Security Advisory GLSA 200712-19.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200712-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200712-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/syslog-ng", unaffected:make_list("ge 2.0.6"), vulnerable:make_list("lt 2.0.6"))) flag++;
