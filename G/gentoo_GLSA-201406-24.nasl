...
# extracted from Gentoo Linux Security Advisory GLSA 201406-24.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-24");

  script_name(english:"GLSA-201406-24 : Dnsmasq: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-24
(Dnsmasq: Denial of Service)

    When used with certain libvirt configurations Dnsmasq replies to queries
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/dnsmasq", unaffected:make_list("ge 2.66"), vulnerable:make_list("lt 2.66"))) flag++;
