...
# extracted from Gentoo Linux Security Advisory GLSA 200605-07.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200605-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Nagios users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2006/05/07");
...
if (qpkg_check(package:"net-analyzer/nagios-core", unaffected:make_list("ge 1.4.1"), vulnerable:make_list("lt 1.4.1"))) flag++;
