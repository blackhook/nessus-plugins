...
# extracted from Gentoo Linux Security Advisory GLSA 200408-21.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?91170697"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200408-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/cacti", unaffected:make_list("ge 0.8.5a-r1"), vulnerable:make_list("le 0.8.5a"))) flag++;
