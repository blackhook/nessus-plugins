...
# extracted from Gentoo Linux Security Advisory GLSA 200705-21.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-09"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-video/mplayer", unaffected:make_list("ge 1.0.20070321", "lt 1.0"), vulnerable:make_list("lt 1.0.20070321"))) flag++;
