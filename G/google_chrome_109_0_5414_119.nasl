...
"The version of Google Chrome installed on the remote Windows host is prior to 109.0.5414.119. It is, therefore, affected
...
google_chrome_check_version(installs:installs, fix:'109.0.5414.119', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
