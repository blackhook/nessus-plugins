...
# extracted from Gentoo Linux Security Advisory GLSA 200409-03.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200409-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/python", unaffected:make_list("ge 2.2.2", "lt 2.2"), vulnerable:make_list("lt 2.2.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Python 2.2");
}
