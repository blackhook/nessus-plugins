...
# extracted from Gentoo Linux Security Advisory GLSA 202006-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202006-20");

  script_name(english:"GLSA-202006-20 : Asterisk: Root privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202006-20
(Asterisk: Root privilege escalation)

    It was discovered that Gentoo&rsquo;s Asterisk ebuild does not properly set
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202006-20"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-misc/asterisk", unaffected:make_list("ge 13.32.0-r1"), vulnerable:make_list("lt 13.32.0-r1"))) flag++;
