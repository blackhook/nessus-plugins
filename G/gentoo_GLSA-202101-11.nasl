...
# extracted from Gentoo Linux Security Advisory GLSA 202101-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-11");

  script_name(english:"GLSA-202101-11 : Zabbix: Root privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202101-11
(Zabbix: Root privilege escalation)

    It was discovered that Gentoo&rsquo;s Zabbix ebuild did not properly set
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202101-11"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-analyzer/zabbix", unaffected:make_list("ge 3.0.30", "ge 4.0.18"), vulnerable:make_list("lt 4.4.6"))) flag++;
