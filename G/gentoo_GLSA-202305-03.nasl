...
# extracted from Gentoo Linux Security Advisory GLSA 202305-03.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202305-03 : ProFTPd: Memory Disclosure");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202305-03 (ProFTPd: Memory Disclosure)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-03");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=811495");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.3.7c"),
    'vulnerable' : make_list("lt 1.3.7c")
  }
];
