...
# extracted from Gentoo Linux Security Advisory GLSA 200410-25.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200410-25
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200410-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-fs/netatalk", unaffected:make_list("ge 1.6.4-r1"), vulnerable:make_list("lt 1.6.4-r1"))) flag++;
