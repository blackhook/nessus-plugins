...
# extracted from Gentoo Linux Security Advisory GLSA 200509-08.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200509-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/python", unaffected:make_list("ge 2.3.5-r2"), vulnerable:make_list("lt 2.3.5-r2"))) flag++;
