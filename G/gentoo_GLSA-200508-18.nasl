...
# extracted from Gentoo Linux Security Advisory GLSA 200508-18.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200508-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/phpwiki", unaffected:make_list("ge 1.3.10-r2"), vulnerable:make_list("lt 1.3.10-r2"))) flag++;
