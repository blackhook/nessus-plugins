...
# extracted from Gentoo Linux Security Advisory GLSA 201607-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201607-14");

  script_name(english:"GLSA-201607-14 : Ansible: Privilege escalation");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201607-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/ansible", unaffected:make_list("ge 2.0.2.0-r1", "rge 1.9.6"), vulnerable:make_list("lt 2.0.2.0-r1"))) flag++;
