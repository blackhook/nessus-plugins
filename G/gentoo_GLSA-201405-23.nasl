...
# extracted from Gentoo Linux Security Advisory GLSA 201405-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201405-23");

  script_name(english:"GLSA-201405-23 : lib3ds: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201405-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201405-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All lib3ds 2.0 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:lib3ds");
...
if (qpkg_check(package:"media-libs/lib3ds", unaffected:make_list("ge 2.0.0_rc1", "rge 1.3.0-r1"), vulnerable:make_list("lt 2.0.0_rc1"))) flag++;
