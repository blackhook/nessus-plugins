...
# extracted from Gentoo Linux Security Advisory GLSA 202008-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-19");
  script_xref(name:"IAVA", value:"2020-A-0385-S");

  script_name(english:"GLSA-202008-19 : BIND: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202008-19
...
Workaround :
  ...
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202008-19");
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-dns/bind", unaffected:make_list("ge 9.16.6"), vulnerable:make_list("lt 9.16.6"))) flag++;
