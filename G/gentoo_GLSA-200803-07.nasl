...
# extracted from Gentoo Linux Security Advisory GLSA 200803-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200803-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200803-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Paramiko users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:paramiko");
...
if (qpkg_check(package:"dev-python/paramiko", unaffected:make_list("ge 1.7.2"), vulnerable:make_list("lt 1.7.2"))) flag++;
