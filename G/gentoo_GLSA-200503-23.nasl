...
# extracted from Gentoo Linux Security Advisory GLSA 200503-23.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200503-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200503-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-terms/rxvt-unicode", unaffected:make_list("ge 5.3", "lt 4.8"), vulnerable:make_list("lt 5.3"))) flag++;
