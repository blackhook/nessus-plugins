...
# extracted from Gentoo Linux Security Advisory GLSA 201401-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201401-02");

  script_name(english:"GLSA-201401-02 : Gajim: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201401-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-im/gajim", unaffected:make_list("ge 0.15.3-r1"), vulnerable:make_list("lt 0.15.3-r1"))) flag++;
