...
# extracted from Gentoo Linux Security Advisory GLSA 200410-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200410-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200410-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-print/cups", unaffected:make_list("rge 1.1.20-r3", "ge 1.1.21-r1"), vulnerable:make_list("le 1.1.20-r2", "eq 1.1.21"))) flag++;
