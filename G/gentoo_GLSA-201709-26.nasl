...
# extracted from Gentoo Linux Security Advisory GLSA 201709-26.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201709-26");

  script_name(english:"GLSA-201709-26 : libsoup: Arbitrary remote code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201709-26
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/libsoup", unaffected:make_list("ge 2.56.1"), vulnerable:make_list("lt 2.56.1"))) flag++;
