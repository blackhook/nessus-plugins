...
# extracted from Gentoo Linux Security Advisory GLSA 201406-03.
#
...
if (description)
{
  ...
  script_bugtraq_id(60467, 65184);
  script_xref(name:"GLSA", value:"201406-03");

  script_name(english:"GLSA-201406-03 : Fail2ban: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-03
...
Impact :
    ...
    A remote attacker could send a crafted URL to a website which, when
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/fail2ban", unaffected:make_list("ge 0.8.12"), vulnerable:make_list("lt 0.8.12"))) flag++;
