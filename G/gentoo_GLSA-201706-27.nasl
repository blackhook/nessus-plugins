...
# extracted from Gentoo Linux Security Advisory GLSA 201706-27.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-27");

  script_name(english:"GLSA-201706-27 : FreeRADIUS: Security bypass");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-27
(FreeRADIUS: Security bypass)

    It was discovered that the implementation of TTLS and PEAP in FreeRADIUS
...
Workaround :
    ...
    Set &ldquo;enabled = no&rdquo; in the cache subsection of eap module settings to
      disable TLS session caching."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-27"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dialup/freeradius", unaffected:make_list("ge 3.0.14"), vulnerable:make_list("lt 3.0.14"))) flag++;
