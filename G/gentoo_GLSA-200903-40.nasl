...
# extracted from Gentoo Linux Security Advisory GLSA 200903-40.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200903-40
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200903-40"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Analog users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:analog");
...
if (qpkg_check(package:"app-admin/analog", unaffected:make_list("ge 6.0-r2"), vulnerable:make_list("lt 6.0-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Analog");
}
