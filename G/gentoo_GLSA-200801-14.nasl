...
# extracted from Gentoo Linux Security Advisory GLSA 200801-14.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200801-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Blam users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:blam");
...
if (qpkg_check(package:"net-news/blam", unaffected:make_list("ge 1.8.4"), vulnerable:make_list("lt 1.8.4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Blam");
}
