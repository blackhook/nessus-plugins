...
# extracted from Gentoo Linux Security Advisory GLSA 202007-41.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-41");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/07/13");

  script_name(english:"GLSA-202007-41 : Roundcube: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202007-41
(Roundcube: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in Roundcube. Please
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202007-41"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"mail-client/roundcube", unaffected:make_list("ge 1.4.4", "ge 1.3.11"), vulnerable:make_list("lt 1.4.4", "lt 1.3.11"))) flag++;
