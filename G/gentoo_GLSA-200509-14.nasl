...
# extracted from Gentoo Linux Security Advisory GLSA 200509-14.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200509-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200509-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Zebedee users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:zebedee");
...
if (qpkg_check(package:"net-misc/zebedee", unaffected:make_list("rge 2.4.1-r1", "ge 2.5.3"), vulnerable:make_list("lt 2.5.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Zebedee");
}
