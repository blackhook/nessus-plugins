...
# extracted from Gentoo Linux Security Advisory GLSA 200603-21.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200603-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"mail-mta/sendmail", unaffected:make_list("ge 8.13.6"), vulnerable:make_list("lt 8.13.6"))) flag++;
