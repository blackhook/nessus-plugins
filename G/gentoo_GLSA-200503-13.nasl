...
# extracted from Gentoo Linux Security Advisory GLSA 200503-13.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/project/shownotes.php?release_id=310416"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200503-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All mlterm users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:mlterm");
...
if (qpkg_check(package:"x11-terms/mlterm", unaffected:make_list("ge 2.9.2"), vulnerable:make_list("lt 2.9.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mlterm");
}
