...
# extracted from Gentoo Linux Security Advisory GLSA 201402-02.
#
...
if (description)
{
  ...
  script_bugtraq_id(64525, 65208);
  script_xref(name:"GLSA", value:"201402-02");

  script_name(english:"GLSA-201402-02 : NVIDIA Drivers: Privilege Escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201402-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201402-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-drivers/nvidia-drivers", unaffected:make_list("ge 331.20", "rge 319.76", "rge 304.116", "rge 304.119", "rge 304.121"), vulnerable:make_list("lt 331.20"))) flag++;
