...
# extracted from Gentoo Linux Security Advisory GLSA 200701-01.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200701-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200701-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/denyhosts", unaffected:make_list("ge 2.6"), vulnerable:make_list("lt 2.6"))) flag++;
