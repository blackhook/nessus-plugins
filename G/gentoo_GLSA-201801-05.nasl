...
# extracted from Gentoo Linux Security Advisory GLSA 201801-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201801-05");

  script_name(english:"GLSA-201801-05 : OpenSSH: Permission issue");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201801-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201801-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/openssh", unaffected:make_list("ge 7.5_p1-r3"), vulnerable:make_list("lt 7.5_p1-r3"))) flag++;
