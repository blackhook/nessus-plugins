...
# extracted from Gentoo Linux Security Advisory GLSA 202105-38.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-38");

  script_name(english:"GLSA-202105-38 : nginx: Remote code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-38
(nginx: Remote code execution)

    It was discovered that nginx did not properly handle DNS responses when
      &ldquo;resolver&rdquo; directive is used.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-38"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"www-servers/nginx", unaffected:make_list("ge 1.20.1", "ge 1.21.0"), vulnerable:make_list("lt 1.21.0"))) flag++;
