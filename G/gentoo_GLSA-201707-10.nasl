...
# extracted from Gentoo Linux Security Advisory GLSA 201707-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201707-10");

  script_name(english:"GLSA-201707-10 : VLC: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201707-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201707-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-video/vlc", unaffected:make_list("ge 2.2.6"), vulnerable:make_list("lt 2.2.6"))) flag++;
