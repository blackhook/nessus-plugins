...
# extracted from Gentoo Linux Security Advisory GLSA 200603-01.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/wordpress", unaffected:make_list("ge 2.0.1"), vulnerable:make_list("le 1.5.2"))) flag++;
