...
# extracted from Gentoo Linux Security Advisory GLSA 201711-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201711-09");

  script_name(english:"GLSA-201711-09 : LXC: Remote security bypass");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201711-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201711-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-emulation/lxc", unaffected:make_list("ge 2.0.7"), vulnerable:make_list("lt 2.0.7"))) flag++;
