...
# extracted from Gentoo Linux Security Advisory GLSA 201412-50.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-50");

  script_name(english:"GLSA-201412-50 : getmail: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-50
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-50"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All getmail users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:getmail");
...
if (qpkg_check(package:"net-mail/getmail", unaffected:make_list("ge 4.46.0"), vulnerable:make_list("lt 4.46.0"))) flag++;
