...
# extracted from Gentoo Linux Security Advisory GLSA 201603-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201603-13");

  script_name(english:"GLSA-201603-13 : Libreswan: Multiple Vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201603-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201603-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/libreswan", unaffected:make_list("ge 3.15"), vulnerable:make_list("lt 3.15"))) flag++;
