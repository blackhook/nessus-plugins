...
# extracted from Gentoo Linux Security Advisory GLSA 201612-53.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-2896", "CVE-2014-2897", "CVE-2014-2898", "CVE-2014-2899", "CVE-2014-2900");
  script_xref(name:"GLSA", value:"201612-53");

  script_name(english:"GLSA-201612-53 : CyaSSL: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-53
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-53"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upstream has discontinued the software in favor of wolfSSL. Therefore,
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:cyassl");
...
if (qpkg_check(package:"net-libs/cyassl", unaffected:make_list(), vulnerable:make_list("rle 2.9.4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "CyaSSL");
}
