...
# extracted from Gentoo Linux Security Advisory GLSA 201309-02.
#
...
if (description)
{
  ...
  script_bugtraq_id(59580, 59837, 61564);
  script_xref(name:"GLSA", value:"201309-02");

  script_name(english:"GLSA-201309-02 : strongSwan: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201309-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201309-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/strongswan", unaffected:make_list("ge 5.1.0"), vulnerable:make_list("lt 5.1.0"))) flag++;
