...
# extracted from Gentoo Linux Security Advisory GLSA 201406-02.
#
...
if (description)
{
  ...
  script_bugtraq_id(47737, 58926);
  script_xref(name:"GLSA", value:"201406-02");

  script_name(english:"GLSA-201406-02 : libarchive: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-arch/libarchive", unaffected:make_list("ge 3.1.2-r1"), vulnerable:make_list("lt 3.1.2-r1"))) flag++;
