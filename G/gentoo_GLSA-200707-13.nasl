...
# extracted from Gentoo Linux Security Advisory GLSA 200707-13.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200707-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.ossec.net/en/attacking-loganalysis.html#fail2ban"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200707-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/fail2ban", unaffected:make_list("ge 0.8.0-r1"), vulnerable:make_list("lt 0.8.0-r1"))) flag++;
