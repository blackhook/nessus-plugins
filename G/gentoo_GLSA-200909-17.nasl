...
# extracted from Gentoo Linux Security Advisory GLSA 200909-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200909-17");

  script_name(english:"GLSA-200909-17 : ZNC: Directory traversal");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200909-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200909-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-irc/znc", unaffected:make_list("ge 0.074"), vulnerable:make_list("lt 0.074"))) flag++;
