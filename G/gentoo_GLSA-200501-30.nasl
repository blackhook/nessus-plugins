...
# extracted from Gentoo Linux Security Advisory GLSA 200501-30.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200501-30
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-30"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-print/cups", unaffected:make_list("ge 1.1.23-r1"), vulnerable:make_list("lt 1.1.23-r1"))) flag++;
