...
# extracted from Gentoo Linux Security Advisory GLSA 201412-30.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-30");

  script_name(english:"GLSA-201412-30 : Varnish: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-30
(Varnish: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in Varnish. Please review
      the CVE identifiers referenced below for details.
  
Impact :

    A remote attacker could cause a Denial of Service condition via a
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-30"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-servers/varnish", unaffected:make_list("ge 3.0.5"), vulnerable:make_list("lt 3.0.5"))) flag++;
