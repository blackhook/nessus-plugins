...
# extracted from Gentoo Linux Security Advisory GLSA 200609-02.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200609-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200609-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All GTetrinet users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gtetrinet");
...
if (qpkg_check(package:"games-puzzle/gtetrinet", unaffected:make_list("ge 0.7.10"), vulnerable:make_list("lt 0.7.10"))) flag++;
