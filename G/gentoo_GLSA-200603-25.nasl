...
# extracted from Gentoo Linux Security Advisory GLSA 200603-25.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-office/openoffice-bin", unaffected:make_list("ge 2.0.2"), vulnerable:make_list("lt 2.0.2"))) flag++;
if (qpkg_check(package:"app-office/openoffice", unaffected:make_list("ge 2.0.1-r1"), vulnerable:make_list("lt 2.0.1-r1"))) flag++;
