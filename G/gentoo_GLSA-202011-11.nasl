...
# extracted from Gentoo Linux Security Advisory GLSA 202011-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202011-11");

  script_name(english:"GLSA-202011-11 : Blueman: Local privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202011-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202011-11"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All Blueman users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:blueman");
...
if (qpkg_check(package:"net-wireless/blueman", unaffected:make_list("ge 2.1.4"), vulnerable:make_list("lt 2.1.4"))) flag++;
