...
# extracted from Gentoo Linux Security Advisory GLSA 202305-23.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-5461", "CVE-2021-44647", "CVE-2022-28805");

  script_name(english:"GLSA-202305-23 : Lua: Multiple Vulnerabilities");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-23");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=520480");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=831053");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=837521");
...
All Lua 5.4 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:lua");
...
var packages = [
  {
    'name' : 'dev-lang/lua',
    'unaffected' : make_list("ge 5.1.5-r200", "ge 5.2.3", "ge 5.4.4-r103"),
    'vulnerable' : make_list("le 5.1.5-r4", "lt 5.1.5-r200", "lt 5.2.3", "lt 5.4.4-r103")
  }
];
