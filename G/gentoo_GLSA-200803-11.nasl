...
# extracted from Gentoo Linux Security Advisory GLSA 200803-11.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200803-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200803-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Vobcopy users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:vobcopy");
...
if (qpkg_check(package:"media-video/vobcopy", unaffected:make_list("ge 1.1.0"), vulnerable:make_list("lt 1.1.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Vobcopy");
}
