...
# extracted from Gentoo Linux Security Advisory GLSA 200509-10.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8c8d5481"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200509-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/mailutils", unaffected:make_list("ge 0.6-r2"), vulnerable:make_list("lt 0.6-r2"))) flag++;
