...
# extracted from Gentoo Linux Security Advisory GLSA 200501-46.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/p/legacy_/forum/forum.php?forum_id=440649"
  );
  # http://secunia.com/advisories/13900/
  script_set_attribute(
    attribute:"see_also",
    value:"https://secuniaresearch.flexerasoftware.com/advisories/13900/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-46"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-antivirus/clamav", unaffected:make_list("ge 0.81"), vulnerable:make_list("le 0.80"))) flag++;
