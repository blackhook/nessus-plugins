...
# extracted from Gentoo Linux Security Advisory GLSA 200701-15.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200701-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-java/sun-jre-bin", unaffected:make_list("ge 1.5.0.09", "rge 1.4.2.18", "rge 1.4.2.17", "rge 1.4.2.15", "rge 1.4.2.14", "rge 1.4.2.13"), vulnerable:make_list("lt 1.5.0.09"))) flag++;
if (qpkg_check(package:"dev-java/sun-jdk", unaffected:make_list("ge 1.5.0.09", "rge 1.4.2.18", "rge 1.4.2.17", "rge 1.4.2.15", "rge 1.4.2.14", "rge 1.4.2.13"), vulnerable:make_list("lt 1.5.0.09"))) flag++;
