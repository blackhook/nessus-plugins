...
# extracted from Gentoo Linux Security Advisory GLSA 201009-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201009-08");

  script_name(english:"GLSA-201009-08 : python-updater: Untrusted search path");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201009-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201009-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All python-updater users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:python-updater");
...
if (qpkg_check(package:"app-admin/python-updater", unaffected:make_list("ge 0.7-r1"), vulnerable:make_list("lt 0.7-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python-updater");
}
