...
# extracted from Gentoo Linux Security Advisory GLSA 200801-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200801-20");

  script_name(english:"GLSA-200801-20 : libxml2: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200801-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200801-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libxml2", unaffected:make_list("ge 2.6.30-r1"), vulnerable:make_list("lt 2.6.30-r1"))) flag++;
