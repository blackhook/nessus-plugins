...
# extracted from Gentoo Linux Security Advisory GLSA 200608-14.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200608-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All users of DUMB should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:dumb");
...
if (qpkg_check(package:"media-libs/dumb", unaffected:make_list("ge 0.9.3-r1"), vulnerable:make_list("lt 0.9.3-r1"))) flag++;
