...
# extracted from Gentoo Linux Security Advisory GLSA 201701-26.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-26");

  script_name(english:"GLSA-201701-26 : BIND: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-26
(BIND: Denial of Service)

    A defect in BIND&rsquo;s handling of responses containing a DNAME answer can
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/bind", unaffected:make_list("ge 9.10.4_p4"), vulnerable:make_list("lt 9.10.4_p4"))) flag++;
