...
# extracted from Gentoo Linux Security Advisory GLSA 200510-09.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200510-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200510-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Weex users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:weex");
...
if (qpkg_check(package:"net-ftp/weex", unaffected:make_list("ge 2.6.1.5-r1"), vulnerable:make_list("lt 2.6.1.5-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Weex");
}
