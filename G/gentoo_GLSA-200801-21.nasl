...
# extracted from Gentoo Linux Security Advisory GLSA 200801-21.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200801-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200801-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-misc/xdg-utils", unaffected:make_list("ge 1.0.2-r1"), vulnerable:make_list("lt 1.0.2-r1"))) flag++;
