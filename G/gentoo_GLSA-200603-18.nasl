...
# extracted from Gentoo Linux Security Advisory GLSA 200603-18.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/pngcrush", unaffected:make_list("ge 1.6.2"), vulnerable:make_list("lt 1.6.2"))) flag++;
