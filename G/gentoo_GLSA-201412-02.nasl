...
# extracted from Gentoo Linux Security Advisory GLSA 201412-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-02");

  script_name(english:"GLSA-201412-02 : nfs-utils: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-fs/nfs-utils", unaffected:make_list("ge 1.2.8"), vulnerable:make_list("lt 1.2.8"))) flag++;
