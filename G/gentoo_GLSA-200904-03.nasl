...
# extracted from Gentoo Linux Security Advisory GLSA 200904-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200904-03");

  script_name(english:"GLSA-200904-03 : Gnumeric: Untrusted search path");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200904-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200904-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-office/gnumeric", unaffected:make_list("ge 1.8.4-r1"), vulnerable:make_list("lt 1.8.4-r1"))) flag++;
