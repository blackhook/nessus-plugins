...
# extracted from Gentoo Linux Security Advisory GLSA 200504-23.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All kdewebdev users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:kdewebdev");
...
if (qpkg_check(package:"kde-base/kdewebdev", unaffected:make_list("ge 3.3.2-r2"), vulnerable:make_list("lt 3.3.2-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Kommander");
}
