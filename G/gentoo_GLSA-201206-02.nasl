...
# extracted from Gentoo Linux Security Advisory GLSA 201206-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201206-02");

  script_name(english:"GLSA-201206-02 : QtGui: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201206-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201206-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All QtGui users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:qt-gui");
...
if (qpkg_check(package:"x11-libs/qt-gui", unaffected:make_list("ge 4.7.4-r1"), vulnerable:make_list("lt 4.7.4-r1"))) flag++;
