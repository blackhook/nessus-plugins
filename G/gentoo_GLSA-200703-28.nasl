...
# extracted from Gentoo Linux Security Advisory GLSA 200703-28.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200703-28
...
if (qpkg_check(package:"net-print/cups", unaffected:make_list("ge 1.2.9"), vulnerable:make_list("lt 1.2.9"))) flag++;
