...
# extracted from Gentoo Linux Security Advisory GLSA 200903-21.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200903-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/curl", unaffected:make_list("ge 7.19.4"), vulnerable:make_list("lt 7.19.4"))) flag++;
