...
# extracted from Gentoo Linux Security Advisory GLSA 200610-05.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200610-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All CAPI4Hylafax users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:capi4hylafax");
...
if (qpkg_check(package:"net-misc/capi4hylafax", unaffected:make_list("ge 01.03.00.99.300.3-r1"), vulnerable:make_list("lt 01.03.00.99.300.3-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "CAPI4Hylafax fax receiver");
}
