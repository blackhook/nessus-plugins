...
# extracted from Gentoo Linux Security Advisory GLSA 201706-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-13");

  script_name(english:"GLSA-201706-13 : minicom: Remote execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All minicom users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:minicom");
...
if (qpkg_check(package:"net-dialup/minicom", unaffected:make_list("ge 2.7.1"), vulnerable:make_list("lt 2.7.1"))) flag++;
