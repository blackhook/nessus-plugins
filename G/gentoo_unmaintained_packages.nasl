...
"Remove or upgrade those packages.");
 ...
 script_copyright(english: "Copyright (C) 2007-2021 Tenable Network Security, Inc.");
...
if(get_kb_item("Host/Gentoo/ebuild-list/timedout"))
  exit(0, "Find command in ssh_get_info2.nasl timed about before getting full list of maintained packages.");
