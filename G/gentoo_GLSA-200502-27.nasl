...
# extracted from Gentoo Linux Security Advisory GLSA 200502-27.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://archives.seul.org/gftp/announce/Feb-2005/msg00000.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-27"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All gFTP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gftp");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:gentoo:linux");

  script_set_attribute(attribute:"patch_publication_date", value:"2005/02/19");
...
if (qpkg_check(package:"net-ftp/gftp", unaffected:make_list("ge 2.0.18-r1"), vulnerable:make_list("lt 2.0.18-r1"))) flag++;
