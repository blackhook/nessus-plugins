...
# extracted from Gentoo Linux Security Advisory GLSA 201708-09.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-7392", "CVE-2017-9153");
  script_xref(name:"GLSA", value:"201708-09");

  script_name(english:"GLSA-201708-09 : AutoTrace: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201708-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201708-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Gentoo has discontinued support for AutoTrace. We recommend that users
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:autotrace");
...
if (qpkg_check(package:"media-gfx/autotrace", unaffected:make_list(), vulnerable:make_list("le 0.31.1-r8"))) flag++;
