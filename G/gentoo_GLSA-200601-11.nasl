...
# extracted from Gentoo Linux Security Advisory GLSA 200601-11.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200601-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200601-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All kdelibs users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2006/01/23");
...
if (qpkg_check(package:"kde-base/kdelibs", unaffected:make_list("ge 3.4.3-r1"), vulnerable:make_list("lt 3.4.3-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "KDE kjs");
}
