...
# extracted from Gentoo Linux Security Advisory GLSA 200712-09.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200712-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200712-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Ruby-GNOME2 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ruby-gtk2");
...
if (qpkg_check(package:"dev-ruby/ruby-gtk2", unaffected:make_list("ge 0.16.0-r2"), vulnerable:make_list("lt 0.16.0-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Ruby-GNOME2");
}
