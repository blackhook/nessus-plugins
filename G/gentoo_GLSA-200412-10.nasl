...
# extracted from Gentoo Linux Security Advisory GLSA 200412-10.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200412-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200412-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-editors/vim", unaffected:make_list("ge 6.3-r2"), vulnerable:make_list("lt 6.3-r2"))) flag++;
if (qpkg_check(package:"app-editors/gvim", unaffected:make_list("ge 6.3-r2"), vulnerable:make_list("lt 6.3-r2"))) flag++;
