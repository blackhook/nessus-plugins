...
# extracted from Gentoo Linux Security Advisory GLSA 201202-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201202-04");

  script_name(english:"GLSA-201202-04 : PowerDNS: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201202-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://doc.powerdns.com/md/security/powerdns-advisory-2012-01/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201202-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/pdns", unaffected:make_list("ge 3.0.1"), vulnerable:make_list("lt 3.0.1"))) flag++;
