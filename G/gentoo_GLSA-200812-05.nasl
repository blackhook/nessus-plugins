...
# extracted from Gentoo Linux Security Advisory GLSA 200812-05.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200812-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200812-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libsamplerate users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libsamplerate");
...
if (qpkg_check(package:"media-libs/libsamplerate", unaffected:make_list("ge 0.1.4"), vulnerable:make_list("lt 0.1.4"))) flag++;
