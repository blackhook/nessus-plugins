...
# extracted from Gentoo Linux Security Advisory GLSA 200406-22.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200406-22
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200406-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/pavuk", unaffected:make_list("ge 0.9.28-r2"), vulnerable:make_list("le 0.9.28-r1"))) flag++;
