...
# extracted from Gentoo Linux Security Advisory GLSA 202305-05.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202305-05 : xfce4-settings: Browser Argument Injection");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202305-05 (xfce4-settings: Browser Argument
Injection)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-05");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=880257");
...
"All xfce4-settings users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:xfce4-settings");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 4.17.1"),
    'vulnerable' : make_list("lt 4.17.1")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'xfce4-settings');
}
