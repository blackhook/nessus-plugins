...
# extracted from Gentoo Linux Security Advisory GLSA 200508-05.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200508-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200508-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Heartbeat users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2005/08/07");
...
if (qpkg_check(package:"sys-cluster/heartbeat", unaffected:make_list("ge 1.2.3-r1"), vulnerable:make_list("lt 1.2.3-r1"))) flag++;
