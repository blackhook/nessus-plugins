...
# extracted from Gentoo Linux Security Advisory GLSA 200402-07.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200402-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-antivirus/clamav", unaffected:make_list("ge 0.67"), vulnerable:make_list("lt 0.67"))) flag++;
