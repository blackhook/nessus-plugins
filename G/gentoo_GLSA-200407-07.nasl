...
# extracted from Gentoo Linux Security Advisory GLSA 200407-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200407-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200407-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-firewall/shorewall", unaffected:make_list("ge 1.4.10f"), vulnerable:make_list("le 1.4.10c"))) flag++;
