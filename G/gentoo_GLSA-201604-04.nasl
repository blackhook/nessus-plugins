...
# extracted from Gentoo Linux Security Advisory GLSA 201604-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201604-04");

  script_name(english:"GLSA-201604-04 : libksba: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201604-04
...
if (qpkg_check(package:"dev-libs/libksba", unaffected:make_list("ge 1.3.3"), vulnerable:make_list("lt 1.3.3"))) flag++;
