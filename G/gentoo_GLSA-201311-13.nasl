...
# extracted from Gentoo Linux Security Advisory GLSA 201311-13.
#
...
if (description)
{
  ...
  script_bugtraq_id(36935, 59672);
  script_xref(name:"GLSA", value:"201311-13");

  script_name(english:"GLSA-201311-13 : OpenVPN: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201311-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201311-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/openvpn", unaffected:make_list("ge 2.3.1"), vulnerable:make_list("lt 2.3.1"))) flag++;
