...
# extracted from Gentoo Linux Security Advisory GLSA 202004-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202004-06");

  script_name(english:"GLSA-202004-06 : GnuTLS: DTLS protocol regression");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202004-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.gnutls.org/security-new.html#GNUTLS-SA-2020-03-31"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202004-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/gnutls", unaffected:make_list("ge 3.6.13"), vulnerable:make_list("lt 3.6.13"))) flag++;
