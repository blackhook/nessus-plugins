...
# extracted from Gentoo Linux Security Advisory GLSA 200502-19.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-db/postgresql", unaffected:make_list("eq 7.3*", "eq 7.4*", "ge 8.0.1-r1"), vulnerable:make_list("lt 7.3.9-r1", "lt 7.4.13", "lt 8.0.1-r1"))) flag++;
