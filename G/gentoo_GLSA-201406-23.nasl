...
# extracted from Gentoo Linux Security Advisory GLSA 201406-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-23");

  script_name(english:"GLSA-201406-23 : DenyHosts: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All DenyHost users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:denyhosts");
...
if (qpkg_check(package:"app-admin/denyhosts", unaffected:make_list("ge 2.6-r9"), vulnerable:make_list("lt 2.6-r9"))) flag++;
