...
# extracted from Gentoo Linux Security Advisory GLSA 200502-12.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/webmin", unaffected:make_list("ge 1.170-r3"), vulnerable:make_list("lt 1.170-r3"))) flag++;
