...
# extracted from Gentoo Linux Security Advisory GLSA 201301-06.
#
...
if (description)
{
  ...
  script_bugtraq_id(47176, 49120, 50971, 51408, 54665, 55530);
  script_xref(name:"GLSA", value:"201301-06");

  script_name(english:"GLSA-201301-06 : ISC DHCP: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201301-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201301-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/dhcp", unaffected:make_list("ge 4.2.4_p2"), vulnerable:make_list("lt 4.2.4_p2"))) flag++;
