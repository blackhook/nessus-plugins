...
# extracted from Gentoo Linux Security Advisory GLSA 200612-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200612-02");

  script_name(english:"GLSA-200612-02 : xine-lib: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200612-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200612-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/xine-lib", unaffected:make_list("ge 1.1.2-r3"), vulnerable:make_list("lt 1.1.2-r3"))) flag++;
