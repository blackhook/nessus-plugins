...
# extracted from Gentoo Linux Security Advisory GLSA 200909-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200909-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200909-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All aMule users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:amule");
...
if (qpkg_check(package:"net-p2p/amule", unaffected:make_list("ge 2.2.5"), vulnerable:make_list("lt 2.2.5"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "aMule");
}
