...
# extracted from Gentoo Linux Security Advisory GLSA 200910-01.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200910-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/wget", unaffected:make_list("ge 1.12"), vulnerable:make_list("lt 1.12"))) flag++;
