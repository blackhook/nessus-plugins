...
# extracted from Gentoo Linux Security Advisory GLSA 200903-17.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200903-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200903-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Real VNC users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:vnc");
...
if (qpkg_check(package:"net-misc/vnc", unaffected:make_list("ge 4.1.3"), vulnerable:make_list("lt 4.1.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Real VNC");
}
