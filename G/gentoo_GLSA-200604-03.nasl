...
# extracted from Gentoo Linux Security Advisory GLSA 200604-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200604-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200604-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dialup/freeradius", unaffected:make_list("ge 1.1.1", "lt 1.0.0"), vulnerable:make_list("lt 1.1.1"))) flag++;
