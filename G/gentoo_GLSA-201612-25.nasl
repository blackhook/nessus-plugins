...
# extracted from Gentoo Linux Security Advisory GLSA 201612-25.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-25");

  script_name(english:"GLSA-201612-25 : CrackLib: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-25
...
Impact :
    ...
    A local attacker could set a specially crafted GECOS field value in
      &ldquo;/etc/passwd&rdquo;; possibly resulting in the execution of arbitrary code
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All CrackLib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:cracklib");
...
if (qpkg_check(package:"sys-libs/cracklib", unaffected:make_list("ge 2.9.6-r1"), vulnerable:make_list("lt 2.9.6-r1"))) flag++;
