...
# extracted from Gentoo Linux Security Advisory GLSA 200601-16.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200601-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200601-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All MyDNS users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:mydns");
...
if (qpkg_check(package:"net-dns/mydns", unaffected:make_list("ge 1.1.0"), vulnerable:make_list("lt 1.1.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "MyDNS");
}
