...
# extracted from Gentoo Linux Security Advisory GLSA 200510-13.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200510-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All SPE users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:spe");
...
if (qpkg_check(package:"dev-util/spe", unaffected:make_list("ge 0.7.5c-r1", "rge 0.5.1f-r1"), vulnerable:make_list("lt 0.7.5c-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "SPE");
}
