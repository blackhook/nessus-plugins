...
# extracted from Gentoo Linux Security Advisory GLSA 200602-12.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200602-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200602-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/gpdf", unaffected:make_list("ge 2.10.0-r4"), vulnerable:make_list("lt 2.10.0-r4"))) flag++;
