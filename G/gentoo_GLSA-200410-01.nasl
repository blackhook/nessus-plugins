...
# extracted from Gentoo Linux Security Advisory GLSA 200410-01.
#
...
if (qpkg_check(package:"app-arch/sharutils", unaffected:make_list("ge 4.2.1-r10"), vulnerable:make_list("le 4.2.1-r9"))) flag++;
