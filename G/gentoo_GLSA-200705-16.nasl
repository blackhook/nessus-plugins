...
# extracted from Gentoo Linux Security Advisory GLSA 200705-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200705-16");

  script_name(english:"GLSA-200705-16 : PhpWiki: Remote execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All PhpWiki users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2007/04/08");
...
if (qpkg_check(package:"www-apps/phpwiki", unaffected:make_list("ge 1.3.10-r3"), vulnerable:make_list("lt 1.3.10-r3"))) flag++;
