...
"The version of Google Chrome installed on the remote Windows host is prior to 84.0.4147.135. It is, therefore, affected
by a vulnerability as referenced in the 2020_08_stable-channel-update-for-desktop_18 advisory. Note that Nessus has not
...
google_chrome_check_version(installs:installs, fix:'84.0.4147.135', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
