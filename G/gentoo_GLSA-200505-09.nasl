...
if (description)
{
  ...
  script_name(english:"GLSA-200505-09 : Gaim: Denial of Service and buffer overflow vulnerabilities");
...
(Gaim: Denial of Service and buffer overflow vulnerabilities)
