...
# extracted from Gentoo Linux Security Advisory GLSA 201411-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201411-03");

  script_name(english:"GLSA-201411-03 : TigerVNC: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201411-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201411-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/tigervnc", unaffected:make_list("ge 1.3.1"), vulnerable:make_list("lt 1.3.1"))) flag++;
