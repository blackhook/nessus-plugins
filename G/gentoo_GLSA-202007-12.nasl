...
# extracted from Gentoo Linux Security Advisory GLSA 202007-12.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-11868", "CVE-2020-13817", "CVE-2020-15025");
  script_xref(name:"GLSA", value:"202007-12");

  script_name(english:"GLSA-202007-12 : NTP: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202007-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202007-12"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-misc/ntp", unaffected:make_list("ge 4.2.8_p15"), vulnerable:make_list("lt 4.2.8_p15"))) flag++;
