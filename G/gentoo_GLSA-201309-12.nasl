...
# extracted from Gentoo Linux Security Advisory GLSA 201309-12.
#
...
if (description)
{
  ...
  script_bugtraq_id(21865, 55704, 59826, 61129);
  script_xref(name:"GLSA", value:"201309-12");

  script_name(english:"GLSA-201309-12 : Apache HTTP Server: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201309-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.iacr.org/cryptodb/archive/2002/FSE/3091/3091.pdf"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201309-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-servers/apache", unaffected:make_list("ge 2.2.25"), vulnerable:make_list("lt 2.2.25"))) flag++;
