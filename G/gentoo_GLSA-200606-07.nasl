...
# extracted from Gentoo Linux Security Advisory GLSA 200606-07.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-process/vixie-cron", unaffected:make_list("ge 4.1-r9"), vulnerable:make_list("lt 4.1-r9"))) flag++;
