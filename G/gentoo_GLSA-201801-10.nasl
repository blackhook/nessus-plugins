...
# extracted from Gentoo Linux Security Advisory GLSA 201801-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201801-10");

  script_name(english:"GLSA-201801-10 : LibXfont, LibXfont2: Arbitrary file access");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201801-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201801-10"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"x11-libs/libXfont", unaffected:make_list("ge 1.5.4"), vulnerable:make_list("lt 1.5.4"))) flag++;
if (qpkg_check(package:"x11-libs/libXfont2", unaffected:make_list("ge 2.0.3"), vulnerable:make_list("lt 2.0.3"))) flag++;
