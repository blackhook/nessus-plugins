...
# extracted from Gentoo Linux Security Advisory GLSA 201209-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201209-19");

  script_name(english:"GLSA-201209-19 : NUT: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201209-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201209-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All NUT users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:nut");
...
if (qpkg_check(package:"sys-power/nut", unaffected:make_list("ge 2.6.3"), vulnerable:make_list("lt 2.6.3"))) flag++;
