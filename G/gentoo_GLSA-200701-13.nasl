...
# extracted from Gentoo Linux Security Advisory GLSA 200701-13.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200701-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/fetchmail", unaffected:make_list("ge 6.3.6"), vulnerable:make_list("lt 6.3.6"))) flag++;
