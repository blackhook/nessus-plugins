...
# extracted from Gentoo Linux Security Advisory GLSA 200611-22.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200611-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Ingo H3 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:horde-ingo");
...
if (qpkg_check(package:"www-apps/horde-ingo", unaffected:make_list("ge 1.1.2"), vulnerable:make_list("lt 1.1.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Ingo H3");
}
