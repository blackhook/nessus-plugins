...
# extracted from Gentoo Linux Security Advisory GLSA 201711-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201711-14");

  script_name(english:"GLSA-201711-14 : IcedTea: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201711-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201711-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-java/icedtea-bin", unaffected:make_list("ge 3.6.0"), vulnerable:make_list("lt 3.6.0"))) flag++;
