...
# extracted from Gentoo Linux Security Advisory GLSA 201201-18.
#
...
if (description)
{
  ...
  script_bugtraq_id(42995, 51646);
  script_xref(name:"GLSA", value:"201201-18");

  script_name(english:"GLSA-201201-18 : bip: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201201-18
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201201-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All bip users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:bip");
...
if (qpkg_check(package:"net-irc/bip", unaffected:make_list("ge 0.8.8-r1"), vulnerable:make_list("lt 0.8.8-r1"))) flag++;
