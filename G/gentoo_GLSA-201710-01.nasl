...
# extracted from Gentoo Linux Security Advisory GLSA 201710-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-01");

  script_name(english:"GLSA-201710-01 : RubyGems: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All RubyGems users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:rubygems");
...
if (qpkg_check(package:"dev-ruby/rubygems", unaffected:make_list("ge 2.6.13"), vulnerable:make_list("lt 2.6.13"))) flag++;
