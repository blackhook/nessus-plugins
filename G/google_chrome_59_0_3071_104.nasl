...
if (description)
{
  ...
  script_name(english:"Google Chrome < 59.0.3071.104 Multiple Vulnerabilities");
...
prior to 59.0.3071.104. It is, therefore, affected by the following
vulnerabilities :
...
google_chrome_check_version(installs:installs, fix:'59.0.3071.104', severity:SECURITY_WARNING);
