...
# extracted from Gentoo Linux Security Advisory GLSA 201206-32.
#
...
if (description)
{
  ...
  script_bugtraq_id(33108);
  script_xref(name:"GLSA", value:"201206-32");

  script_name(english:"GLSA-201206-32 : Links: SSL verification vulnerability");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201206-32
...
Workaround :
  ...
  # https://secunia.com/Advisories/33391/
  script_set_attribute(
    attribute:"see_also",
    value:"https://secuniaresearch.flexerasoftware.com//Advisories/33391/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201206-32"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-client/links", unaffected:make_list("ge 2.6"), vulnerable:make_list("lt 2.6"))) flag++;
