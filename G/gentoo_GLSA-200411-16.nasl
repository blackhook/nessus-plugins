...
# extracted from Gentoo Linux Security Advisory GLSA 200411-16.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200411-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All zip users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:zip");
...
if (qpkg_check(package:"app-arch/zip", unaffected:make_list("ge 2.3-r4"), vulnerable:make_list("le 2.3-r3"))) flag++;
