...
# extracted from Gentoo Linux Security Advisory GLSA 200601-14.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200601-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All users should upgrade to the latest version and run revdep-rebuild:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libast");
...
if (qpkg_check(package:"x11-libs/libast", unaffected:make_list("ge 0.7"), vulnerable:make_list("lt 0.7"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "LibAST");
}
