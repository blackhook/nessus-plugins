...
# extracted from Gentoo Linux Security Advisory GLSA 201607-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201607-06");

  script_name(english:"GLSA-201607-06 : CUPS: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201607-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201607-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-print/cups", unaffected:make_list("ge 2.0.2-r1"), vulnerable:make_list("lt 2.0.2-r1"))) flag++;
