...
# extracted from Gentoo Linux Security Advisory GLSA 201711-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201711-06");

  script_name(english:"GLSA-201711-06 : GNU Wget: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201711-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201711-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/wget", unaffected:make_list("ge 1.19.1-r2"), vulnerable:make_list("lt 1.19.1-r2"))) flag++;
