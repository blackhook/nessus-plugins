...
# extracted from Gentoo Linux Security Advisory GLSA 202105-35.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-35");

  script_name(english:"GLSA-202105-35 : OpenSSH: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-35
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-35"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-misc/openssh", unaffected:make_list("ge 8.5_p1"), vulnerable:make_list("lt 8.5_p1"))) flag++;
