...
# extracted from Gentoo Linux Security Advisory GLSA 201710-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-04");

  script_name(english:"GLSA-201710-04 : sudo: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/sudo", unaffected:make_list("ge 1.8.20_p2"), vulnerable:make_list("lt 1.8.20_p2"))) flag++;
