...
# extracted from Gentoo Linux Security Advisory GLSA 200711-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200711-09");

  script_name(english:"GLSA-200711-09 : MadWifi: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200711-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200711-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-wireless/madwifi-ng", unaffected:make_list("ge 0.9.3.3"), vulnerable:make_list("lt 0.9.3.3"))) flag++;
