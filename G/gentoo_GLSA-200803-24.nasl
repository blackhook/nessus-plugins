...
# extracted from Gentoo Linux Security Advisory GLSA 200803-24.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200803-24");

  script_name(english:"GLSA-200803-24 : PCRE: Buffer overflow");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200803-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libpcre", unaffected:make_list("ge 7.6-r1"), vulnerable:make_list("lt 7.6-r1"))) flag++;
if (qpkg_check(package:"dev-libs/glib", unaffected:make_list("ge 2.14.6", "lt 2.14.0"), vulnerable:make_list("lt 2.14.6"))) flag++;
