...
if (description)
{
  ...
  script_bugtraq_id(105959);

  script_name(english:"Google Chrome < 70.0.3538.110 Vulnerability");
...
prior to 70.0.3538.110. It is, therefore, affected by a vulnerability
as noted in Google Chrome stable channel update release notes for
2018/11/19. Please refer to the release notes for additional
...
version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?25e158fe");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome version 70.0.3538.110 or later.");
...
google_chrome_check_version(installs:installs, fix:'70.0.3538.110', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
