...
# extracted from Gentoo Linux Security Advisory GLSA 201312-06.
#
...
if (description)
{
  ...
  script_bugtraq_id(44395);
  script_xref(name:"GLSA", value:"201312-06");

  script_name(english:"GLSA-201312-06 : Festival: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201312-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201312-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Festival users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:festival");
...
if (qpkg_check(package:"app-accessibility/festival", unaffected:make_list("ge 2.1"), vulnerable:make_list("lt 2.1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Festival");
}
