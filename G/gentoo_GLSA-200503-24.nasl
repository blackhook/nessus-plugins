...
# extracted from Gentoo Linux Security Advisory GLSA 200503-24.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200503-24
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200503-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All LTris users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ltris");
...
if (qpkg_check(package:"games-puzzle/ltris", unaffected:make_list("ge 1.0.10"), vulnerable:make_list("lt 1.0.10"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "LTris");
}
