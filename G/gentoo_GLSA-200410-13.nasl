...
# extracted from Gentoo Linux Security Advisory GLSA 200410-13.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.gotbnc.com/changes.html#2.8.9"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200410-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-irc/bnc", unaffected:make_list("ge 2.8.9"), vulnerable:make_list("lt 2.8.9"))) flag++;
