...
by multiple vulnerabilities as referenced in the 2019_08_stable-channel-update-for-desktop advisory. Note that Nessus
...
google_chrome_check_version(installs:installs, fix:'76.0.3809.100', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
