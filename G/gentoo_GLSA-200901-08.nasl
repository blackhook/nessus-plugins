...
# extracted from Gentoo Linux Security Advisory GLSA 200901-08.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200901-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200901-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Online-Bookmarks users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:online-bookmarks");
...
if (qpkg_check(package:"www-apps/online-bookmarks", unaffected:make_list("ge 0.6.28"), vulnerable:make_list("lt 0.6.28"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Online-Bookmarks");
}
