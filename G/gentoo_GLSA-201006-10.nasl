...
# extracted from Gentoo Linux Security Advisory GLSA 201006-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201006-10");

  script_name(english:"GLSA-201006-10 : multipath-tools: World-writeable socket");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201006-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-fs/multipath-tools", unaffected:make_list("ge 0.4.8-r1"), vulnerable:make_list("lt 0.4.8-r1"))) flag++;
