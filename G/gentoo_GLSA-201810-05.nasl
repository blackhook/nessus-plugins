...
# extracted from Gentoo Linux Security Advisory GLSA 201810-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201810-05");

  script_name(english:"GLSA-201810-05 : xkbcommon: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201810-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201810-05"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All libxkbcommon users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libxkbcommon");
...
if (qpkg_check(package:"x11-libs/libxkbcommon", unaffected:make_list("ge 0.8.2"), vulnerable:make_list("lt 0.8.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "xkbcommon");
}
