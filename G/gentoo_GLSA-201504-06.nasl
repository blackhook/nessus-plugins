...
# extracted from Gentoo Linux Security Advisory GLSA 201504-06.
#
...
if (description)
{
  ...
  script_bugtraq_id(71595, 71596, 71597, 71598, 71599, 71600, 71601, 71602, 71603, 71604, 71605, 71606, 71608, 72578);
  script_xref(name:"GLSA", value:"201504-06");

  script_name(english:"GLSA-201504-06 : X.Org X Server: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201504-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201504-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-base/xorg-server", unaffected:make_list("ge 1.12.4-r4"), vulnerable:make_list("lt 1.12.4-r4"))) flag++;
