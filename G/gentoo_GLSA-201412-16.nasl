...
# extracted from Gentoo Linux Security Advisory GLSA 201412-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-16");

  script_name(english:"GLSA-201412-16 : CouchDB: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-db/couchdb", unaffected:make_list("ge 1.5.1"), vulnerable:make_list("lt 1.5.1"))) flag++;
