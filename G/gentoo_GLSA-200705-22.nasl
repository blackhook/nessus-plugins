...
# extracted from Gentoo Linux Security Advisory GLSA 200705-22.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-22
...
if (qpkg_check(package:"media-libs/freetype", unaffected:make_list("ge 2.3.4-r2", "lt 2.0"), vulnerable:make_list("lt 2.3.4-r2"))) flag++;
