...
# extracted from Gentoo Linux Security Advisory GLSA 200606-26.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.energymech.net/versions-3.0.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All EnergyMech users should update to the latest stable version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:emech");
...
if (qpkg_check(package:"net-irc/emech", unaffected:make_list("ge 3.0.2"), vulnerable:make_list("lt 3.0.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "EnergyMech");
}
