...
# extracted from Gentoo Linux Security Advisory GLSA 201502-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201502-09");

  script_name(english:"GLSA-201502-09 : Antiword: User-assisted execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201502-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Antiword users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:antiword");
...
if (qpkg_check(package:"app-text/antiword", unaffected:make_list("ge 0.37-r1"), vulnerable:make_list("lt 0.37-r1"))) flag++;
