...
# extracted from Gentoo Linux Security Advisory GLSA 201710-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-05");

  script_name(english:"GLSA-201710-05 : Munin: Arbitrary file write");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-05"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-analyzer/munin", unaffected:make_list("ge 2.0.33"), vulnerable:make_list("lt 2.0.33"))) flag++;
