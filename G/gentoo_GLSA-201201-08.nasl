...
# extracted from Gentoo Linux Security Advisory GLSA 201201-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201201-08");

  script_name(english:"GLSA-201201-08 : FontForge: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201201-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201201-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/fontforge", unaffected:make_list("ge 20110222-r1"), vulnerable:make_list("lt 20110222-r1"))) flag++;
