...
# extracted from Gentoo Linux Security Advisory GLSA 201405-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201405-02");

  script_name(english:"GLSA-201405-02 : libSRTP: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201405-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201405-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libSRTP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libsrtp");
...
if (qpkg_check(package:"net-libs/libsrtp", unaffected:make_list("ge 1.4.4_p20121108-r1"), vulnerable:make_list("lt 1.4.4_p20121108-r1"))) flag++;
