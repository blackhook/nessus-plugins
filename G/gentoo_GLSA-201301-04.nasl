...
# extracted from Gentoo Linux Security Advisory GLSA 201301-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201301-04");

  script_name(english:"GLSA-201301-04 : dhcpcd: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201301-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201301-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/dhcpcd", unaffected:make_list("ge 5.2.12"), vulnerable:make_list("lt 5.2.12"))) flag++;
