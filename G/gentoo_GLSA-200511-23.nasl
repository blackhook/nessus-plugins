...
# extracted from Gentoo Linux Security Advisory GLSA 200511-23.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200511-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All chmlib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:chmlib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:kchmviewer");
...
if (qpkg_check(package:"app-text/kchmviewer", unaffected:make_list("ge 1.1"), vulnerable:make_list("lt 1.1"))) flag++;
if (qpkg_check(package:"dev-libs/chmlib", unaffected:make_list("ge 0.37.4"), vulnerable:make_list("lt 0.37.4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "chmlib / KchmViewer");
}
