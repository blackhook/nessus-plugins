...
# extracted from Gentoo Linux Security Advisory GLSA 200710-12.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200710-12
...
if (qpkg_check(package:"media-libs/t1lib", unaffected:make_list("ge 5.0.2-r1"), vulnerable:make_list("lt 5.0.2-r1"))) flag++;
