...
# extracted from Gentoo Linux Security Advisory GLSA 200601-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200601-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Wine users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:wine");
...
if (qpkg_check(package:"app-emulation/wine", unaffected:make_list("ge 0.9"), vulnerable:make_list("lt 20060000", "gt 20040000"))) flag++;
