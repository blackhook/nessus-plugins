...
# extracted from Gentoo Linux Security Advisory GLSA 201606-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201606-03");

  script_name(english:"GLSA-201606-03 : libjpeg-turbo: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201606-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201606-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libjpeg-turbo", unaffected:make_list("ge 1.4.2"), vulnerable:make_list("lt 1.4.2"))) flag++;
