...
# extracted from Gentoo Linux Security Advisory GLSA 202007-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-23");

  script_name(english:"GLSA-202007-23 : ClamAV: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202007-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202007-23"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-antivirus/clamav", unaffected:make_list("ge 0.102.4"), vulnerable:make_list("lt 0.102.4"))) flag++;
