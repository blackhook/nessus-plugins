...
# extracted from Gentoo Linux Security Advisory GLSA 201612-32.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-32");

  script_name(english:"GLSA-201612-32 : elfutils: Heap-based buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-32
(elfutils: Heap-based buffer overflow)

    An integer overflow, in the check_section function of dwarf_begin_elf.c,
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-32"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/elfutils", unaffected:make_list("ge 0.159"), vulnerable:make_list("lt 0.159"))) flag++;
