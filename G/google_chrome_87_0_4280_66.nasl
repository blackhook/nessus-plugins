...
by multiple vulnerabilities as referenced in the 2020_11_stable-channel-update-for-desktop_17 advisory. Note that Nessus
...
google_chrome_check_version(installs:installs, fix:'87.0.4280.66', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
