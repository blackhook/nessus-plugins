...
# extracted from Gentoo Linux Security Advisory GLSA 202003-32.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-32");

  script_name(english:"GLSA-202003-32 : Libgcrypt: Side-channel attack");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202003-32
...
if (qpkg_check(package:"dev-libs/libgcrypt", unaffected:make_list("ge 1.8.5"), vulnerable:make_list("lt 1.8.5"))) flag++;
