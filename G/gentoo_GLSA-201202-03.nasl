...
# extracted from Gentoo Linux Security Advisory GLSA 201202-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201202-03");

  script_name(english:"GLSA-201202-03 : MaraDNS: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201202-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201202-03"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-dns/maradns", unaffected:make_list("ge 1.4.09"), vulnerable:make_list("lt 1.4.09"))) flag++;
