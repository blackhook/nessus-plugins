...
# extracted from Gentoo Linux Security Advisory GLSA 201707-07.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-5203", "CVE-2015-8751", "CVE-2016-9262", "CVE-2016-9591");
  script_xref(name:"GLSA", value:"201707-07");

  script_name(english:"GLSA-201707-07 : JasPer: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201707-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201707-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/jasper", unaffected:make_list("ge 2.0.12"), vulnerable:make_list("lt 2.0.12"))) flag++;
