...
# extracted from Gentoo Linux Security Advisory GLSA 200811-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200811-03");

  script_name(english:"GLSA-200811-03 : FAAD2: User-assisted execution of arbitrary code");
...
if (qpkg_check(package:"media-libs/faad2", unaffected:make_list("ge 2.6.1-r2"), vulnerable:make_list("lt 2.6.1-r2"))) flag++;
