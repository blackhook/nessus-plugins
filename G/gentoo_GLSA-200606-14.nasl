...
# extracted from Gentoo Linux Security Advisory GLSA 200606-14.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.gnome.org/show_bug.cgi?id=343476"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"gnome-base/gdm", unaffected:make_list("ge 2.8.0.8"), vulnerable:make_list("lt 2.8.0.8"))) flag++;
