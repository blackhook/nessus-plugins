...
# extracted from Gentoo Linux Security Advisory GLSA 200909-11.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200909-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200909-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All GCC-XML users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gccxml");
...
if (qpkg_check(package:"dev-cpp/gccxml", unaffected:make_list("ge 0.9.0_pre20090516"), vulnerable:make_list("lt 0.9.0_pre20090516"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GCC-XML");
}
