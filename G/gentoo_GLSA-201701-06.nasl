...
# extracted from Gentoo Linux Security Advisory GLSA 201701-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-06");

  script_name(english:"GLSA-201701-06 : e2fsprogs: Heap-based buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-06
(e2fsprogs: Heap-based buffer overflow)

    A heap-based buffer overflow was discovered in openfs.c in the libext2fs
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-fs/e2fsprogs", unaffected:make_list("ge 1.42.12"), vulnerable:make_list("lt 1.42.12"))) flag++;
