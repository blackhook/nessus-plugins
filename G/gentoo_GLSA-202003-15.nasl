...
# extracted from Gentoo Linux Security Advisory GLSA 202003-15.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-15");

  script_name(english:"GLSA-202003-15 : ICU: Integer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202003-15
(ICU: Integer overflow)

    It was discovered that ICU&rsquo;s UnicodeString::doAppend() function is
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202003-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/icu", unaffected:make_list("ge 65.1-r1"), vulnerable:make_list("lt 65.1-r1"))) flag++;
