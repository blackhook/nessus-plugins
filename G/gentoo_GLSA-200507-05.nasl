...
# extracted from Gentoo Linux Security Advisory GLSA 200507-05.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200507-05
...
if (qpkg_check(package:"sys-libs/zlib", unaffected:make_list("ge 1.2.2-r1"), vulnerable:make_list("lt 1.2.2-r1"))) flag++;
