...
# extracted from Gentoo Linux Security Advisory GLSA 200507-22.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200507-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All sandbox users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:sandbox");
...
if (qpkg_check(package:"sys-apps/sandbox", unaffected:make_list("ge 1.2.11"), vulnerable:make_list("lt 1.2.11"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "sandbox");
}
