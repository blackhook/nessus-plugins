...
# extracted from Gentoo Linux Security Advisory GLSA 201405-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201405-03");

  script_name(english:"GLSA-201405-03 : WeeChat: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201405-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201405-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-irc/weechat", unaffected:make_list("ge 0.3.9.2"), vulnerable:make_list("lt 0.3.9.2"))) flag++;
