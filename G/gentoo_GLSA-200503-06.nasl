...
# extracted from Gentoo Linux Security Advisory GLSA 200503-06.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200503-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All BidWatcher users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:bidwatcher");
...
if (qpkg_check(package:"net-misc/bidwatcher", unaffected:make_list("ge 1.3.17"), vulnerable:make_list("lt 1.3.17"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "BidWatcher");
}
