...
# extracted from Gentoo Linux Security Advisory GLSA 202003-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-20");

  script_name(english:"GLSA-202003-20 : systemd: Heap use-after-free");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202003-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202003-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/systemd", unaffected:make_list("ge 244.3"), vulnerable:make_list("lt 244.3"))) flag++;
