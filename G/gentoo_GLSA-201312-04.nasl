...
# extracted from Gentoo Linux Security Advisory GLSA 201312-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201312-04");

  script_name(english:"GLSA-201312-04 : libtheora: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201312-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201312-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libtheora users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libtheora");
...
if (qpkg_check(package:"media-libs/libtheora", unaffected:make_list("ge 1.1.1"), vulnerable:make_list("lt 1.1.1"))) flag++;
