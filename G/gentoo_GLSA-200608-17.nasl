...
# extracted from Gentoo Linux Security Advisory GLSA 200608-17.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200608-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libwmf", unaffected:make_list("ge 0.2.8.4"), vulnerable:make_list("lt 0.2.8.4"))) flag++;
