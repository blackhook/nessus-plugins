...
# extracted from Gentoo Linux Security Advisory GLSA 200611-01.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200611-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200611-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-misc/screen", unaffected:make_list("ge 4.0.3"), vulnerable:make_list("lt 4.0.3"))) flag++;
