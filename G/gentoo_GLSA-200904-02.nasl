...
# extracted from Gentoo Linux Security Advisory GLSA 200904-02.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200904-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200904-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/glib", unaffected:make_list("ge 2.18.4-r1", "rge 2.16.6-r1", "lt 2"), vulnerable:make_list("lt 2.18.4-r1"))) flag++;
