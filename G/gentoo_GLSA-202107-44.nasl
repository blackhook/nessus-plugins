...
# extracted from Gentoo Linux Security Advisory GLSA 202107-44.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-44");

  script_name(english:"GLSA-202107-44 : libslirp: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-44
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-44"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All libslirp users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libslirp");
...
if (qpkg_check(package:"net-libs/libslirp", unaffected:make_list("ge 4.6.0"), vulnerable:make_list("lt 4.6.0"))) flag++;
