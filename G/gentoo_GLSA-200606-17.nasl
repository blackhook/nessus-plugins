...
# extracted from Gentoo Linux Security Advisory GLSA 200606-17.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-nsd/openldap", unaffected:make_list("ge 2.3.22"), vulnerable:make_list("lt 2.3.22"))) flag++;
