...
# extracted from Gentoo Linux Security Advisory GLSA 202010-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202010-08");

  script_name(english:"GLSA-202010-08 : Mozilla Firefox, Mozilla Thunderbird: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202010-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.mozilla.org/en-US/security/advisories/mfsa2020-45/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.mozilla.org/en-US/security/advisories/mfsa2020-46/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.mozilla.org/en-US/security/advisories/mfsa2020-47/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202010-08"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 78.4.0"), vulnerable:make_list("lt 78.4.0"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 78.4.0"), vulnerable:make_list("lt 78.4.0"))) flag++;
if (qpkg_check(package:"www-client/firefox", unaffected:make_list("ge 82.0", "ge 78.4.0"), vulnerable:make_list("lt 82.0"))) flag++;
if (qpkg_check(package:"www-client/firefox-bin", unaffected:make_list("ge 82.0", "ge 78.4.0"), vulnerable:make_list("lt 82.0"))) flag++;
