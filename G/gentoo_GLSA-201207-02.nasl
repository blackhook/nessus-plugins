...
# extracted from Gentoo Linux Security Advisory GLSA 201207-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201207-02");

  script_name(english:"GLSA-201207-02 : libxml2: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201207-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201207-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libxml2", unaffected:make_list("ge 2.8.0_rc1"), vulnerable:make_list("lt 2.8.0_rc1"))) flag++;
