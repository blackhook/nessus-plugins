...
# extracted from Gentoo Linux Security Advisory GLSA 201710-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-10");

  script_name(english:"GLSA-201710-10 : elfutils: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-10
(elfutils: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in elfutils. Please review
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/elfutils", unaffected:make_list("ge 0.169-r1"), vulnerable:make_list("lt 0.169-r1"))) flag++;
