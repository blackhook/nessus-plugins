...
# extracted from Gentoo Linux Security Advisory GLSA 201709-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201709-07");

  script_name(english:"GLSA-201709-07 : Kpathsea: User-assisted execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Kpathsea users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:kpathsea");
...
if (qpkg_check(package:"dev-libs/kpathsea", unaffected:make_list("ge 6.2.2_p20160523"), vulnerable:make_list("lt 6.2.2_p20160523"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Kpathsea");
}
