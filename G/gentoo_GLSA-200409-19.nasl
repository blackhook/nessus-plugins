...
# extracted from Gentoo Linux Security Advisory GLSA 200409-19.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.pdc.kth.se/heimdal/advisory/2004-09-13/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.frasunek.com/lukemftpd.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200409-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-crypt/heimdal", unaffected:make_list("ge 0.6.3"), vulnerable:make_list("lt 0.6.3"))) flag++;
