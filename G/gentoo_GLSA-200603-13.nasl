...
# extracted from Gentoo Linux Security Advisory GLSA 200603-13.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200603-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All PEAR-Auth users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:PEAR-Auth");
...
if (qpkg_check(package:"dev-php/PEAR-Auth", unaffected:make_list("ge 1.2.4"), vulnerable:make_list("lt 1.2.4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "PEAR-Auth");
}
