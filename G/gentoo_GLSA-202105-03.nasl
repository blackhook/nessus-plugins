...
# extracted from Gentoo Linux Security Advisory GLSA 202105-03.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-0308");
  script_xref(name:"GLSA", value:"202105-03");

  script_name(english:"GLSA-202105-03 : GPT fdisk: Integer underflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-03"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All GPT fdisk users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gptfdisk");
...
if (qpkg_check(package:"sys-apps/gptfdisk", unaffected:make_list("ge 1.0.6"), vulnerable:make_list("lt 1.0.6"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GPT fdisk");
}
