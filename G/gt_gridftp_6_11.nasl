...
client under another account.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.globus.org/pipermail/security-announce/2012-May/000019.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 3.42 / 6.11 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3292");
