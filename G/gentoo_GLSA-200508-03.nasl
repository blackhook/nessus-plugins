...
# extracted from Gentoo Linux Security Advisory GLSA 200508-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200508-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://nbsmtp.ferdyx.org/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200508-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All nbSMTP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:nbsmtp");
...
if (qpkg_check(package:"mail-mta/nbsmtp", unaffected:make_list("ge 1.00"), vulnerable:make_list("lt 1.00"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "nbSMTP");
}
