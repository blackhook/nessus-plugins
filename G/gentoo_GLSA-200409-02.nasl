...
# extracted from Gentoo Linux Security Advisory GLSA 200409-02.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200409-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-db/mysql", unaffected:make_list("ge 4.0.20-r1"), vulnerable:make_list("le 4.0.20"))) flag++;
