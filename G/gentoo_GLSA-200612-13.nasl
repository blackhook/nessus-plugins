...
# extracted from Gentoo Linux Security Advisory GLSA 200612-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200612-13");

  script_name(english:"GLSA-200612-13 : libgsf: Buffer overflow");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200612-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"gnome-extra/libgsf", unaffected:make_list("ge 1.14.2"), vulnerable:make_list("lt 1.14.2"))) flag++;
