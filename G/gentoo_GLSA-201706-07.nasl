...
# extracted from Gentoo Linux Security Advisory GLSA 201706-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-07");

  script_name(english:"GLSA-201706-07 : Libtirpc and RPCBind: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-07"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-libs/libtirpc", unaffected:make_list("ge 1.0.1-r1"), vulnerable:make_list("lt 1.0.1-r1"))) flag++;
if (qpkg_check(package:"net-nds/rpcbind", unaffected:make_list("ge 0.2.4-r1"), vulnerable:make_list("lt 0.2.4-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Libtirpc and RPCBind");
}
