...
# extracted from Gentoo Linux Security Advisory GLSA 201612-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-06");

  script_name(english:"GLSA-201612-06 : nghttp2: Heap-use-after-free");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/nghttp2", unaffected:make_list("ge 1.6.0"), vulnerable:make_list("lt 1.6.0"))) flag++;
