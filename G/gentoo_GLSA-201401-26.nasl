...
# extracted from Gentoo Linux Security Advisory GLSA 201401-26.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201401-26");

  script_name(english:"GLSA-201401-26 : Zabbix: Shell command injection");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201401-26
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/zabbix", unaffected:make_list("ge 2.0.9-r1"), vulnerable:make_list("lt 2.0.9-r1"))) flag++;
