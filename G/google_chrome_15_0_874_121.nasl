...
application crashes or can potentially allow code execution.");
  # https://chromereleases.googleblog.com/2011/11/stable-channel-update_16.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5ffccc6");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome 15.0.874.121 or later.");
