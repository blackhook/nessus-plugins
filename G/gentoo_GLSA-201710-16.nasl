...
# extracted from Gentoo Linux Security Advisory GLSA 201710-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-16");

  script_name(english:"GLSA-201710-16 : Shadow: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/shadow", unaffected:make_list("ge 4.5"), vulnerable:make_list("lt 4.5"))) flag++;
