...
# extracted from Gentoo Linux Security Advisory GLSA 200710-17.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200710-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200710-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Balsa users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:balsa");
...
if (qpkg_check(package:"mail-client/balsa", unaffected:make_list("ge 2.3.20"), vulnerable:make_list("lt 2.3.20"))) flag++;
