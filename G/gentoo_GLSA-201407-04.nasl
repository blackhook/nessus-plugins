...
# extracted from Gentoo Linux Security Advisory GLSA 201407-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201407-04");

  script_name(english:"GLSA-201407-04 : GnuPG: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201407-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201407-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-crypt/gnupg", unaffected:make_list("ge 2.0.24", "rge 1.4.17", "rge 1.4.18", "rge 1.4.19", "rge 1.4.20", "rge 1.4.21"), vulnerable:make_list("lt 2.0.24"))) flag++;
