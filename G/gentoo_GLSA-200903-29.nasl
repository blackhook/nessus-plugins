...
# extracted from Gentoo Linux Security Advisory GLSA 200903-29.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200903-29"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All bluez-utils users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:bluez-libs");
...
if (qpkg_check(package:"net-wireless/bluez-libs", unaffected:make_list("ge 3.36"), vulnerable:make_list("lt 3.36"))) flag++;
if (qpkg_check(package:"net-wireless/bluez-utils", unaffected:make_list("ge 3.36"), vulnerable:make_list("lt 3.36"))) flag++;
