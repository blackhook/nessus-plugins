...
# extracted from Gentoo Linux Security Advisory GLSA 201207-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201207-07");

  script_name(english:"GLSA-201207-07 : Keepalived: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201207-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201207-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-cluster/keepalived", unaffected:make_list("ge 1.2.2-r3"), vulnerable:make_list("lt 1.2.2-r3"))) flag++;
