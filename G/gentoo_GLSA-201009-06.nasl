...
# extracted from Gentoo Linux Security Advisory GLSA 201009-06.
#
...
if (description)
{
  ...
  script_bugtraq_id(39262, 40317, 40318);
  script_xref(name:"GLSA", value:"201009-06");

  script_name(english:"GLSA-201009-06 : Clam AntiVirus: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201009-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201009-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-antivirus/clamav", unaffected:make_list("ge 0.96.1"), vulnerable:make_list("lt 0.96.1"))) flag++;
