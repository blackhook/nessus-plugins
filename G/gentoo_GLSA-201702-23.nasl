...
# extracted from Gentoo Linux Security Advisory GLSA 201702-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201702-23");

  script_name(english:"GLSA-201702-23 : Dropbear: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201702-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201702-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/dropbear", unaffected:make_list("ge 2016.74"), vulnerable:make_list("lt 2016.74"))) flag++;
