...
# extracted from Gentoo Linux Security Advisory GLSA 200511-17.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200511-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200511-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-fs/fuse", unaffected:make_list("ge 2.4.1-r1"), vulnerable:make_list("lt 2.4.1-r1"))) flag++;
