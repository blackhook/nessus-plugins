...
# extracted from Gentoo Linux Security Advisory GLSA 201405-13.
#
...
if (description)
{
  ...
  script_bugtraq_id(34870, 35774, 45842, 46632);
  script_xref(name:"GLSA", value:"201405-13");

  script_name(english:"GLSA-201405-13 : Pango: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201405-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201405-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-libs/pango", unaffected:make_list("ge 1.28.3-r1"), vulnerable:make_list("lt 1.28.3-r1"))) flag++;
