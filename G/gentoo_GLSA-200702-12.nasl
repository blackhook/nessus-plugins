...
# extracted from Gentoo Linux Security Advisory GLSA 200702-12.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1687293e"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200702-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All CHMlib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2007/01/26");
...
if (qpkg_check(package:"dev-libs/chmlib", unaffected:make_list("ge 0.39"), vulnerable:make_list("lt 0.39"))) flag++;
