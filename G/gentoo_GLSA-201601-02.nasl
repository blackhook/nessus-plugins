...
# extracted from Gentoo Linux Security Advisory GLSA 201601-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201601-02");

  script_name(english:"GLSA-201601-02 : WebKitGTK+: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201601-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201601-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/webkit-gtk", unaffected:make_list("ge 2.4.9"), vulnerable:make_list("lt 2.4.9"))) flag++;
