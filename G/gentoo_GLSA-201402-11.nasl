...
# extracted from Gentoo Linux Security Advisory GLSA 201402-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201402-11");

  script_name(english:"GLSA-201402-11 : Links: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201402-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201402-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-client/links", unaffected:make_list("ge 2.8-r1"), vulnerable:make_list("lt 2.8-r1"))) flag++;
