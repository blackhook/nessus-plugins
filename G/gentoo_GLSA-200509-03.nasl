...
# extracted from Gentoo Linux Security Advisory GLSA 200509-03.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2005-2763", "CVE-2005-2764");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200509-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"games-simulation/openttd", unaffected:make_list("ge 0.4.0.1-r1"), vulnerable:make_list("lt 0.4.0.1-r1"))) flag++;
