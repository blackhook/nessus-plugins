...
# extracted from Gentoo Linux Security Advisory GLSA 201607-11.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-1572", "CVE-2014-1573", "CVE-2014-8630");
  script_xref(name:"GLSA", value:"201607-11");

  script_name(english:"GLSA-201607-11 : Bugzilla: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201607-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201607-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/bugzilla", unaffected:make_list("ge 5.0.3", "rgt 4.4.12"), vulnerable:make_list("lt 5.0.3"))) flag++;
