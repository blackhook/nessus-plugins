...
# extracted from Gentoo Linux Security Advisory GLSA 200812-10.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200812-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200812-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Archive::Tar users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:Archive-Tar");
...
if (qpkg_check(package:"perl-core/Archive-Tar", unaffected:make_list("ge 1.40"), vulnerable:make_list("lt 1.40"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Archive::Tar");
}
