...
# extracted from Gentoo Linux Security Advisory GLSA 200711-31.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200711-31
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200711-31"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/net-snmp", unaffected:make_list("ge 5.4.1-r1"), vulnerable:make_list("lt 5.4.1-r1"))) flag++;
