...
# extracted from Gentoo Linux Security Advisory GLSA 200604-08.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200604-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2762e917"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200604-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apache/libapreq2", unaffected:make_list("ge 2.07"), vulnerable:make_list("lt 2.07"))) flag++;
