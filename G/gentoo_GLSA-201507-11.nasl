...
# extracted from Gentoo Linux Security Advisory GLSA 201507-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201507-11");

  script_name(english:"GLSA-201507-11 : Perl: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201507-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201507-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/perl", unaffected:make_list("ge 5.20.1-r4"), vulnerable:make_list("lt 5.20.1-r4"))) flag++;
