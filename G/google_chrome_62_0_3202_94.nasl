...
if (description)
{
  ...
  script_name(english:"Google Chrome < 62.0.3202.94 Out of bounds read flaw in V8");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by
an out of bounds read flaw in the V8 component of Google Chrome.");
  script_set_attribute(attribute:"description", value:
"The version of Google Chrome installed on the remote Windows host is
prior to 62.0.3202.94. It is, therefore, affected by an out of bounds
read flaw in V8 as noted in Chrome stable channel update release
notes for November 13th, 2017. Please refer to the release notes for
...
google_chrome_check_version(installs:installs, fix:'62.0.3202.94', severity:SECURITY_WARNING);
