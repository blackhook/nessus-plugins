...
# extracted from Gentoo Linux Security Advisory GLSA 201204-05.
#
...
if (description)
{
  ...
  script_bugtraq_id(42433);
  script_xref(name:"GLSA", value:"201204-05");

  script_name(english:"GLSA-201204-05 : SWFTools: User-assisted execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201204-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Gentoo discontinued support for SWFTools. We recommend that users
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:swftools");
...
if (qpkg_check(package:"media-gfx/swftools", unaffected:make_list(), vulnerable:make_list("le 0.9.1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "SWFTools");
}
