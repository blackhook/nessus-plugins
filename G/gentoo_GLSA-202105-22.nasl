...
# extracted from Gentoo Linux Security Advisory GLSA 202105-22.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-22");

  script_name(english:"GLSA-202105-22 : Samba: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-22
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-22"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-fs/samba", unaffected:make_list("ge 4.13.8"), vulnerable:make_list("lt 4.13.8"))) flag++;
