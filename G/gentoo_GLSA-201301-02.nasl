...
# extracted from Gentoo Linux Security Advisory GLSA 201301-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201301-02");

  script_name(english:"GLSA-201301-02 : HAProxy: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201301-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201301-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-proxy/haproxy", unaffected:make_list("ge 1.4.21"), vulnerable:make_list("lt 1.4.21"))) flag++;
