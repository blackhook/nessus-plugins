...
# extracted from Gentoo Linux Security Advisory GLSA 201101-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201101-06");

  script_name(english:"GLSA-201101-06 : IO::Socket::SSL: Certificate validation error");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201101-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201101-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All IO::Socket::SSL users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:IO-Socket-SSL");
...
if (qpkg_check(package:"dev-perl/IO-Socket-SSL", unaffected:make_list("ge 1.26"), vulnerable:make_list("lt 1.26"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "IO::Socket::SSL");
}
