...
# extracted from Gentoo Linux Security Advisory GLSA 200409-32.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.qcc.ca/~charlesc/software/getmail-4/CHANGELOG"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://article.gmane.org/gmane.mail.getmail.user/1430"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200409-32"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/getmail", unaffected:make_list("ge 4.2.0"), vulnerable:make_list("lt 4.2.0"))) flag++;
