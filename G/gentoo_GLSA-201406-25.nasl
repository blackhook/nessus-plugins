...
# extracted from Gentoo Linux Security Advisory GLSA 201406-25.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-25");

  script_name(english:"GLSA-201406-25 : Asterisk: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-25
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/asterisk", unaffected:make_list("ge 11.10.2", "rge 1.8.28.2"), vulnerable:make_list("lt 11.10.2"))) flag++;
