...
# extracted from Gentoo Linux Security Advisory GLSA 202011-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202011-17");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-202011-17 : MIT Kerberos 5: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202011-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202011-17"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-crypt/mit-krb5", unaffected:make_list("ge 1.18.2-r2"), vulnerable:make_list("lt 1.18.2-r2"))) flag++;
