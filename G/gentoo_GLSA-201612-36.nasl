...
# extracted from Gentoo Linux Security Advisory GLSA 201612-36.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-6051", "CVE-2014-8240");
  script_xref(name:"GLSA", value:"201612-36");

  script_name(english:"GLSA-201612-36 : TigerVNC: Integer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-36
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-36"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/tigervnc", unaffected:make_list("ge 1.4.2"), vulnerable:make_list("lt 1.4.2"))) flag++;
