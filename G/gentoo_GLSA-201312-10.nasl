...
# extracted from Gentoo Linux Security Advisory GLSA 201312-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201312-10");

  script_name(english:"GLSA-201312-10 : libsmi: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201312-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201312-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libsmi users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libsmi");
...
if (qpkg_check(package:"net-libs/libsmi", unaffected:make_list("ge 0.4.8-r1"), vulnerable:make_list("lt 0.4.8-r1"))) flag++;
