...
# extracted from Gentoo Linux Security Advisory GLSA 201612-22.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-22");

  script_name(english:"GLSA-201612-22 : Coreutils: Arbitrary code execution");
...
(Coreutils: Arbitrary code execution)
    ...
    A memory corruption flaw in GNU Coreutils&rsquo; parse_datetime function was
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/coreutils", unaffected:make_list("ge 8.23"), vulnerable:make_list("lt 8.23"))) flag++;
