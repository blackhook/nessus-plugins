...
# extracted from Gentoo Linux Security Advisory GLSA 201611-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201611-14");

  script_name(english:"GLSA-201611-14 : MIT Kerberos 5: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201611-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201611-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-crypt/mit-krb5", unaffected:make_list("ge 1.13.2-r2"), vulnerable:make_list("lt 1.13.2-r2"))) flag++;
