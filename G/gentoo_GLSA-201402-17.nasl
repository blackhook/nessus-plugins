...
# extracted from Gentoo Linux Security Advisory GLSA 201402-17.
#
...
if (description)
{
  ...
  script_bugtraq_id(37350, 43594, 43841, 43845);
  script_xref(name:"GLSA", value:"201402-17");

  script_name(english:"GLSA-201402-17 : Xpdf: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201402-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201402-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/xpdf", unaffected:make_list(), vulnerable:make_list("le 3.02-r4"))) flag++;
