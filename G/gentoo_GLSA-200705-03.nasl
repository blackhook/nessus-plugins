...
# extracted from Gentoo Linux Security Advisory GLSA 200705-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-servers/tomcat", unaffected:make_list("ge 5.5.22"), vulnerable:make_list("lt 5.5.22"))) flag++;
