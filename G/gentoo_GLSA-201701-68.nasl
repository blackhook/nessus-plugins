...
# extracted from Gentoo Linux Security Advisory GLSA 201701-68.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-0852", "CVE-2016-5684");
  script_xref(name:"GLSA", value:"201701-68");

  script_name(english:"GLSA-201701-68 : FreeImage: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-68
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-68"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/freeimage", unaffected:make_list("ge 3.15.4-r1"), vulnerable:make_list("lt 3.15.4-r1"))) flag++;
