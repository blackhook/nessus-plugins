...
# extracted from Gentoo Linux Security Advisory GLSA 200503-25.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200503-25
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/support/security/advisories/2005_15_openslp/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200503-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/openslp", unaffected:make_list("ge 1.2.1"), vulnerable:make_list("lt 1.2.1"))) flag++;
