...
# extracted from Gentoo Linux Security Advisory GLSA 200712-15.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200712-15
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200712-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libexif", unaffected:make_list("ge 0.6.16-r1"), vulnerable:make_list("lt 0.6.16-r1"))) flag++;
