...
# extracted from Gentoo Linux Security Advisory GLSA 202107-43.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-43");

  script_name(english:"GLSA-202107-43 : RPM: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-43
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-43"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-arch/rpm", unaffected:make_list("ge 4.16.1.3"), vulnerable:make_list("lt 4.16.1.3"))) flag++;
