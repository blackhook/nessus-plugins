...
# extracted from Gentoo Linux Security Advisory GLSA 200903-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200903-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200903-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-sound/audacity", unaffected:make_list("ge 1.3.6"), vulnerable:make_list("lt 1.3.6"))) flag++;
