...
# extracted from Gentoo Linux Security Advisory GLSA 201709-08.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6311", "CVE-2017-6312", "CVE-2017-6313", "CVE-2017-6314");
  script_xref(name:"GLSA", value:"201709-08");

  script_name(english:"GLSA-201709-08 : GDK-PixBuf: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201709-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-08"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"x11-libs/gdk-pixbuf", unaffected:make_list("ge 2.36.9"), vulnerable:make_list("lt 2.36.9"))) flag++;
