...
# extracted from Gentoo Linux Security Advisory GLSA 200612-04.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200612-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libmodplug", unaffected:make_list("ge 0.8-r1"), vulnerable:make_list("lt 0.8-r1"))) flag++;
