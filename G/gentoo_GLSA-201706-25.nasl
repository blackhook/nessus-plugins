...
# extracted from Gentoo Linux Security Advisory GLSA 201706-25.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-25");

  script_name(english:"GLSA-201706-25 : Graphite: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-25
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/graphite2", unaffected:make_list("ge 1.3.8-r1"), vulnerable:make_list("lt 1.3.8-r1"))) flag++;
