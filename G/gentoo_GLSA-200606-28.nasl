...
# extracted from Gentoo Linux Security Advisory GLSA 200606-28.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200606-28
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-28"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/horde", unaffected:make_list("ge 3.1.1-r1"), vulnerable:make_list("lt 3.1.1-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Horde Web Application Framework");
}
