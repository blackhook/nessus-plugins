...
# extracted from Gentoo Linux Security Advisory GLSA 201812-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201812-09");

  script_name(english:"GLSA-201812-09 : Go: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201812-09
...
Impact :
    ...
    A remote attacker could cause arbitrary code execution by passing
      specially crafted Go packages the &lsquo;go get -u&rsquo; command.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201812-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/go", unaffected:make_list("ge 1.10.7"), vulnerable:make_list("lt 1.10.7"))) flag++;
