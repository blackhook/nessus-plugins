...
# extracted from Gentoo Linux Security Advisory GLSA 201609-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201609-02");

  script_name(english:"GLSA-201609-02 : Bundler: Insecure installation");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201609-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-ruby/bundler", unaffected:make_list("ge 1.7.3"), vulnerable:make_list("lt 1.7.3"))) flag++;
