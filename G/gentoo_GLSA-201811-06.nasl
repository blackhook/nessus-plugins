...
# extracted from Gentoo Linux Security Advisory GLSA 201811-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201811-06");

  script_name(english:"GLSA-201811-06 : libde265: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201811-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/strukturag/libde265/compare/v1.0.2...v1.0.3"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201811-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libde265", unaffected:make_list("ge 1.0.3"), vulnerable:make_list("lt 1.0.3"))) flag++;
