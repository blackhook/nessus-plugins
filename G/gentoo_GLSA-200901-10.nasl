...
# extracted from Gentoo Linux Security Advisory GLSA 200901-10.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200901-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200901-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/gnutls", unaffected:make_list("ge 2.4.1-r2"), vulnerable:make_list("lt 2.4.1-r2"))) flag++;
