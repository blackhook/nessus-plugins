...
# extracted from Gentoo Linux Security Advisory GLSA 200606-24.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200606-24
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All wv2 users should update to the latest stable version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:wv2");
...
if (qpkg_check(package:"app-text/wv2", unaffected:make_list("ge 0.2.3"), vulnerable:make_list("lt 0.2.3"))) flag++;
