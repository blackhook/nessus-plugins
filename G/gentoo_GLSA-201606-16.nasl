...
# extracted from Gentoo Linux Security Advisory GLSA 201606-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201606-16");

  script_name(english:"GLSA-201606-16 : PLIB: Buffer overflow vulnerability");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201606-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
