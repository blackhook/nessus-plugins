...
(nettle: Information disclosure)
    ...
    It was found that nettle&rsquo;s RSA and DSA decryption code was vulnerable
      to cache-related side channel attacks.
    See the referenced technical paper &ldquo;Cache Attacks Enable Bulk Key
      Recovery on the Cloud&rdquo; below for details.
