...
# extracted from Gentoo Linux Security Advisory GLSA 201309-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201309-07");

  script_name(english:"GLSA-201309-07 : libotr: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201309-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201309-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/libotr", unaffected:make_list("ge 3.2.1"), vulnerable:make_list("lt 3.2.1"))) flag++;
