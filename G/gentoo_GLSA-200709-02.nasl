...
# extracted from Gentoo Linux Security Advisory GLSA 200709-02.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200709-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200709-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-irc/kvirc", unaffected:make_list("ge 3.2.6_pre20070714"), vulnerable:make_list("lt 3.2.6_pre20070714"))) flag++;
