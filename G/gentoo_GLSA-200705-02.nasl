...
# extracted from Gentoo Linux Security Advisory GLSA 200705-02.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/freetype", unaffected:make_list("ge 2.1.10-r3", "lt 2.0"), vulnerable:make_list("lt 2.1.10-r3"))) flag++;
