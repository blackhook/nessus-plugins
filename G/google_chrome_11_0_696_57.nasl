...
vulnerabilities:
  ...
  - Multiple stale pointers exist with PDF forms.
    (Issue #79364)");
  # https://chromereleases.googleblog.com/2011/04/chrome-stable-update.html?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed:+GoogleChromeReleases+(Google+Chrome+Releases)&utm_content=Google+Reader
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?16b8be08");
