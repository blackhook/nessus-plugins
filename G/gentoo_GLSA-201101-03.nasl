...
# extracted from Gentoo Linux Security Advisory GLSA 201101-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201101-03");

  script_name(english:"GLSA-201101-03 : libvpx: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201101-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201101-03"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"media-libs/libvpx", unaffected:make_list("ge 0.9.5"), vulnerable:make_list("lt 0.9.5"))) flag++;
