...
# extracted from Gentoo Linux Security Advisory GLSA 200605-05.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200605-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All rsync users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2006/04/22");
...
if (qpkg_check(package:"net-misc/rsync", unaffected:make_list("ge 2.6.8"), vulnerable:make_list("lt 2.6.8"))) flag++;
