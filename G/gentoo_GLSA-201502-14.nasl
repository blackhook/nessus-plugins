...
# extracted from Gentoo Linux Security Advisory GLSA 201502-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201502-14");

  script_name(english:"GLSA-201502-14 : grep: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201502-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201502-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/grep", unaffected:make_list("ge 2.21-r1"), vulnerable:make_list("lt 2.21-r1"))) flag++;
