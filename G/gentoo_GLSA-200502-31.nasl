...
# extracted from Gentoo Linux Security Advisory GLSA 200502-31.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200502-31
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.freedesktop.org/archives/uim/2005-February/000996.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-31"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-i18n/uim", unaffected:make_list("ge 0.4.5.1"), vulnerable:make_list("lt 0.4.5.1"))) flag++;
