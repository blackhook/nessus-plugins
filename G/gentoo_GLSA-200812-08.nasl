...
# extracted from Gentoo Linux Security Advisory GLSA 200812-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200812-08");

  script_name(english:"GLSA-200812-08 : Mgetty: Insecure temporary file usage");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200812-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200812-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Mgetty users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:mgetty");
...
if (qpkg_check(package:"net-dialup/mgetty", unaffected:make_list("ge 1.1.36-r3"), vulnerable:make_list("lt 1.1.36-r3"))) flag++;
