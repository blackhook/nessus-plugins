...
# extracted from Gentoo Linux Security Advisory GLSA 200502-11.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?707f8740"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/mailman", unaffected:make_list("ge 2.1.5-r4"), vulnerable:make_list("lt 2.1.5-r4"))) flag++;
