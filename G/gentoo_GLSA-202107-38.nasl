...
# extracted from Gentoo Linux Security Advisory GLSA 202107-38.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-38");

  script_name(english:"GLSA-202107-38 : Apache: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-38
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-38"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"www-servers/apache", unaffected:make_list("ge 2.4.48"), vulnerable:make_list("lt 2.4.48"))) flag++;
