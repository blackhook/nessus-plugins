...
# extracted from Gentoo Linux Security Advisory GLSA 201201-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201201-17");

  script_name(english:"GLSA-201201-17 : Chromium: Multiple vulnerabilities");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?190a254f"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201201-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-client/chromium", unaffected:make_list("ge 16.0.912.77"), vulnerable:make_list("lt 16.0.912.77"))) flag++;
