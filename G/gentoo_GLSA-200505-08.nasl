...
# extracted from Gentoo Linux Security Advisory GLSA 200505-08.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200505-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All hteditor users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:hteditor");
...
if (qpkg_check(package:"app-editors/hteditor", unaffected:make_list("ge 0.8.0-r2"), vulnerable:make_list("lt 0.8.0-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "HT Editor");
}
