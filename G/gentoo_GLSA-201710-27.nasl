...
# extracted from Gentoo Linux Security Advisory GLSA 201710-27.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-27");
  script_xref(name:"IAVA", value:"2017-A-0284-S");

  script_name(english:"GLSA-201710-27 : Dnsmasq: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-27
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-27"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/dnsmasq", unaffected:make_list("ge 2.78"), vulnerable:make_list("lt 2.78"))) flag++;
