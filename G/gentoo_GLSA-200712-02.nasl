...
# extracted from Gentoo Linux Security Advisory GLSA 200712-02.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200712-02
(Cacti: SQL injection)
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200712-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/cacti", unaffected:make_list("rge 0.8.6j-r7", "ge 0.8.7a"), vulnerable:make_list("lt 0.8.7a"))) flag++;
