...
# extracted from Gentoo Linux Security Advisory GLSA 200904-14.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200904-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200904-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-antivirus/f-prot", unaffected:make_list("ge 6.0.2"), vulnerable:make_list("lt 6.0.2"))) flag++;
