...
# extracted from Gentoo Linux Security Advisory GLSA 200704-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200704-07
...
"All libwpd users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libwpd");
...
if (qpkg_check(package:"app-text/libwpd", unaffected:make_list("ge 0.8.9"), vulnerable:make_list("lt 0.8.9"))) flag++;
