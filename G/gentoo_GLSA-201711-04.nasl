...
# extracted from Gentoo Linux Security Advisory GLSA 201711-04.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15945");
  script_xref(name:"GLSA", value:"201711-04");

  script_name(english:"GLSA-201711-04 : MariaDB, MySQL: Root privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201711-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201711-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-db/mariadb", unaffected:make_list("ge 10.0.30-r1"), vulnerable:make_list("lt 10.0.30-r1"))) flag++;
if (qpkg_check(package:"dev-db/mysql", unaffected:make_list("ge 5.6.36-r1"), vulnerable:make_list("lt 5.6.36-r1"))) flag++;
