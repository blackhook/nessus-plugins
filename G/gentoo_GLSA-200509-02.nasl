...
# extracted from Gentoo Linux Security Advisory GLSA 200509-02.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200509-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-office/gnumeric", unaffected:make_list("ge 1.4.3-r2"), vulnerable:make_list("lt 1.4.3-r2"))) flag++;
