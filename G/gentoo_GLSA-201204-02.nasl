...
# extracted from Gentoo Linux Security Advisory GLSA 201204-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201204-02");

  script_name(english:"GLSA-201204-02 : InspIRCd: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201204-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201204-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-irc/inspircd", unaffected:make_list("ge 2.0.5-r1"), vulnerable:make_list("lt 2.0.5-r1"))) flag++;
