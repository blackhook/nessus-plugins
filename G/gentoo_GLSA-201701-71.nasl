...
# extracted from Gentoo Linux Security Advisory GLSA 201701-71.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-7122", "CVE-2016-7450", "CVE-2016-7502", "CVE-2016-7555", "CVE-2016-7562", "CVE-2016-7785", "CVE-2016-7905");
  script_xref(name:"GLSA", value:"201701-71");

  script_name(english:"GLSA-201701-71 : FFmpeg: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-71
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-71"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-video/ffmpeg", unaffected:make_list("ge 2.8.10"), vulnerable:make_list("lt 2.8.10"))) flag++;
