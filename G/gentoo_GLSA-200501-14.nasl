...
# extracted from Gentoo Linux Security Advisory GLSA 200501-14.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200501-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/archive/1/374433"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-sound/mpg123", unaffected:make_list("ge 0.59s-r9"), vulnerable:make_list("lt 0.59s-r9"))) flag++;
