...
# extracted from Gentoo Linux Security Advisory GLSA 201706-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-02");

  script_name(english:"GLSA-201706-02 : Shadow: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/shadow", unaffected:make_list("ge 4.4-r2"), vulnerable:make_list("lt 4.4-r2"))) flag++;
