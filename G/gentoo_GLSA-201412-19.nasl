...
# extracted from Gentoo Linux Security Advisory GLSA 201412-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-19");

  script_name(english:"GLSA-201412-19 : PPP: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dialup/ppp", unaffected:make_list("ge 2.4.7 "), vulnerable:make_list("lt 2.4.7 "))) flag++;
