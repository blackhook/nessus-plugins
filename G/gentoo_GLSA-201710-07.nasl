...
# extracted from Gentoo Linux Security Advisory GLSA 201710-07.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-9772");
  script_xref(name:"GLSA", value:"201710-07");

  script_name(english:"GLSA-201710-07 : OCaml: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/ocaml", unaffected:make_list("ge 4.04.2"), vulnerable:make_list("lt 4.04.2"))) flag++;
