...
# extracted from Gentoo Linux Security Advisory GLSA 201707-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201707-13");

  script_name(english:"GLSA-201707-13 : libcroco: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201707-13
(libcroco: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in libcroco. Please review
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201707-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libcroco", unaffected:make_list("ge 0.6.12-r1"), vulnerable:make_list("lt 0.6.12-r1"))) flag++;
