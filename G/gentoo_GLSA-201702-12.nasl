...
# extracted from Gentoo Linux Security Advisory GLSA 201702-12.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6265", "CVE-2016-6525", "CVE-2017-5896");
  script_xref(name:"GLSA", value:"201702-12");

  script_name(english:"GLSA-201702-12 : MuPDF: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201702-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201702-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/mupdf", unaffected:make_list("ge 1.10a-r1"), vulnerable:make_list("lt 1.10a-r1"))) flag++;
