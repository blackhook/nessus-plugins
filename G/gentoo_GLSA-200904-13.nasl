...
# extracted from Gentoo Linux Security Advisory GLSA 200904-13.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200904-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200904-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Ventrilo users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ventrilo-server-bin");
...
if (qpkg_check(package:"media-sound/ventrilo-server-bin", unaffected:make_list("ge 3.0.3"), vulnerable:make_list("lt 3.0.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Ventrilo");
}
