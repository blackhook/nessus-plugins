...
# extracted from Gentoo Linux Security Advisory GLSA 202209-03.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202209-03 : OpenSC: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202209-03 (OpenSC: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202209-03");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=839357");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 0.22.0", "lt 0.0.0"),
    'vulnerable' : make_list("lt 0.22.0")
  }
];
