...
# extracted from Gentoo Linux Security Advisory GLSA 201101-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201101-01");

  script_name(english:"GLSA-201101-01 : gif2png: User-assisted execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201101-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/gif2png", unaffected:make_list("ge 2.5.1-r1"), vulnerable:make_list("lt 2.5.1-r1"))) flag++;
