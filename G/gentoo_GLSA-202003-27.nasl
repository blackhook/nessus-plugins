...
# extracted from Gentoo Linux Security Advisory GLSA 202003-27.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202003-27");
  script_xref(name:"IAVA", value:"2020-A-0203");

  script_name(english:"GLSA-202003-27 : libssh: Arbitrary command execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202003-27
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202003-27"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-libs/libssh", unaffected:make_list("ge 0.9.3"), vulnerable:make_list("lt 0.9.3"))) flag++;
