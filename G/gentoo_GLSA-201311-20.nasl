...
# extracted from Gentoo Linux Security Advisory GLSA 201311-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201311-20");

  script_name(english:"GLSA-201311-20 : Okular: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201311-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201311-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"kde-base/okular", unaffected:make_list("ge 4.4.5-r2"), vulnerable:make_list("lt 4.4.5-r2"))) flag++;
