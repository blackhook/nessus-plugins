...
# extracted from Gentoo Linux Security Advisory GLSA 201406-29.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-29");

  script_name(english:"GLSA-201406-29 : spice-gtk: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-29
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-29"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/spice-gtk", unaffected:make_list("ge 0.14"), vulnerable:make_list("lt 0.14"))) flag++;
