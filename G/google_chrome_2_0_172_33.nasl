...
issues :
  ...
  # https://chromereleases.googleblog.com/2009/06/stable-beta-update-security-fix.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe07ffbf");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome 2.0.172.33 or later.");
