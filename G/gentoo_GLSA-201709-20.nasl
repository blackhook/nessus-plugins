...
# extracted from Gentoo Linux Security Advisory GLSA 201709-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201709-20");

  script_name(english:"GLSA-201709-20 : Postfix: Privilege escalation");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postfix.org/announcements/postfix-3.2.2.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"mail-mta/postfix", unaffected:make_list("ge 3.1.6"), vulnerable:make_list("lt 3.1.6"))) flag++;
