...
# extracted from Gentoo Linux Security Advisory GLSA 201606-01.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-5309", "CVE-2016-2563");
  script_xref(name:"GLSA", value:"201606-01");

  script_name(english:"GLSA-201606-01 : PuTTY: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201606-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201606-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/putty", unaffected:make_list("ge 0.67"), vulnerable:make_list("lt 0.67"))) flag++;
