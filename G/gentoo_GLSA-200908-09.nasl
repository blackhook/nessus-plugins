...
# extracted from Gentoo Linux Security Advisory GLSA 200908-09.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200908-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200908-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/dokuwiki", unaffected:make_list("ge 20090214b"), vulnerable:make_list("lt 20090214b"))) flag++;
