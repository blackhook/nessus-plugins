...
# extracted from Gentoo Linux Security Advisory GLSA 202107-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-01");

  script_name(english:"GLSA-202107-01 : corosync: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-01
(corosync: Denial of service)

    It was discovered that corosync allowed an unauthenticated user to cause
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-01"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All corosync users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:corosync");
...
if (qpkg_check(package:"sys-cluster/corosync", unaffected:make_list("ge 3.0.4"), vulnerable:make_list("lt 3.0.4"))) flag++;
