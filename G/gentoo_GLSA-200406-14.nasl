...
# extracted from Gentoo Linux Security Advisory GLSA 200406-14.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200406-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://archives.neohapsis.com/archives/secunia/2004-q2/0616.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200406-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/aspell", unaffected:make_list("ge 0.50.5-r4"), vulnerable:make_list("le 0.50.5-r3"))) flag++;
