...
# extracted from Gentoo Linux Security Advisory GLSA 201710-06.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-7484", "CVE-2017-7485", "CVE-2017-7486", "CVE-2017-7546", "CVE-2017-7547", "CVE-2017-7548");
  script_xref(name:"GLSA", value:"201710-06");

  script_name(english:"GLSA-201710-06 : PostgreSQL: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-db/postgresql", unaffected:make_list("ge 9.6.4", "ge 9.5.8", "ge 9.4.13", "ge 9.3.18", "ge 9.2.22"), vulnerable:make_list("lt 9.6.4"))) flag++;
