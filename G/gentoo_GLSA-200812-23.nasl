...
# extracted from Gentoo Linux Security Advisory GLSA 200812-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200812-23");

  script_name(english:"GLSA-200812-23 : Imlib2: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200812-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200812-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/imlib2", unaffected:make_list("ge 1.4.2-r1"), vulnerable:make_list("lt 1.4.2-r1"))) flag++;
