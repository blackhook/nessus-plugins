...
if (description)
{
  ...
  script_bugtraq_id(47377);
  script_xref(name:"SECUNIA", value:"44141");

  script_name(english:"Google Chrome < 10.0.648.205 Multiple Vulnerabilities");
...
than 10.0.648.205.  Such versions are affected by multiple
vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bde4912e");
...
google_chrome_check_version(installs:installs, fix:'10.0.648.205', severity:SECURITY_HOLE);
