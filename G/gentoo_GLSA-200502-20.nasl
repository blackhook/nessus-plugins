...
# extracted from Gentoo Linux Security Advisory GLSA 200502-20.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200502-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-editors/emacs", unaffected:make_list("ge 21.4", "lt 19"), vulnerable:make_list("lt 21.4"))) flag++;
if (qpkg_check(package:"app-editors/xemacs", unaffected:make_list("ge 21.4.15-r3"), vulnerable:make_list("lt 21.4.15-r3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Emacs / XEmacs");
}
