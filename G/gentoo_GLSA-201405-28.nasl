...
# extracted from Gentoo Linux Security Advisory GLSA 201405-28.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201405-28");

  script_name(english:"GLSA-201405-28 : xmonad-contrib: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201405-28
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201405-28"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All xmonad-contrib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:xmonad-contrib");
...
if (qpkg_check(package:"x11-wm/xmonad-contrib", unaffected:make_list("ge 0.11.2"), vulnerable:make_list("lt 0.11.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "xmonad-contrib");
}
