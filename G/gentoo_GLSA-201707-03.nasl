...
# extracted from Gentoo Linux Security Advisory GLSA 201707-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201707-03");

  script_name(english:"GLSA-201707-03 : phpMyAdmin: Security bypass");
...
(phpMyAdmin: Security bypass)
    ...
    A vulnerability was discovered where the restrictions caused by
      &ldquo;$cfg[&lsquo;Servers&rsquo;][$i][&lsquo;AllowNoPassword&rsquo;] = false&rdquo; are bypassed
      ...
      &ldquo;$cfg[&lsquo;Servers&rsquo;][$i][&lsquo;AllowNoPassword&rsquo;]&rdquo; to false (which is
      the default).
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.phpmyadmin.net/security/PMASA-2017-8/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201707-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-db/phpmyadmin", unaffected:make_list("ge 4.0.10.20", "ge 4.7.0"), vulnerable:make_list("lt 4.0.10.20", "lt 4.7.0"))) flag++;
