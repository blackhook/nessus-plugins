...
# extracted from Gentoo Linux Security Advisory GLSA 200809-01.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200809-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All yelp users running GNOME 2.22 should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:yelp");
...
if (qpkg_check(package:"gnome-extra/yelp", unaffected:make_list("ge 2.22.1-r2", "rge 2.20.0-r1"), vulnerable:make_list("lt 2.22.1-r2"))) flag++;
