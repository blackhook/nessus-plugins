...
# extracted from Gentoo Linux Security Advisory GLSA 200504-19.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-video/mplayer", unaffected:make_list("ge 1.0_pre6-r4"), vulnerable:make_list("lt 1.0_pre6-r4"))) flag++;
