...
if (description)
{
  ...
  script_name(english:"GIGABYTE OC GURU II 2.08 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The GIGABYTE OC GURU II software installed on the remote host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of GIGABYTE OC GURU II installed on the remote host is 2.08. It is, therefore, affected by multiple
vulnerabilities as referenced in GIGABYTE security advisory 1801:
...
"Uninstall GIGABYTE OC GURU II.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:gigabyte:oc_guru_ii");
  ...
  script_dependencies("gigabyte_oc_guru_II_win_installed.nbin");
  script_require_keys("installed_sw/Gigabyte OC Guru II");
...
var app = 'Gigabyte OC Guru II';

var app_info = vcf::get_app_info(app:app, win_local:TRUE);

var constraints = [
  { 'equal':'2.08', 'fixed_display':'None' }
];
