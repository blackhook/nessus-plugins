...
# extracted from Gentoo Linux Security Advisory GLSA 200507-10.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.ruby-lang.org/en/20050701.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200507-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/ruby", unaffected:make_list("ge 1.8.2-r2"), vulnerable:make_list("lt 1.8.2-r2"))) flag++;
