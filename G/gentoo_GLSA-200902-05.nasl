...
# extracted from Gentoo Linux Security Advisory GLSA 200902-05.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200902-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-p2p/ktorrent", unaffected:make_list("ge 2.2.8"), vulnerable:make_list("lt 2.2.8"))) flag++;
