...
# extracted from Gentoo Linux Security Advisory GLSA 201702-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201702-13");

  script_name(english:"GLSA-201702-13 : Mozilla Thunderbird: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201702-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201702-13"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"mail-client/thunderbird", unaffected:make_list("ge 45.7.0"), vulnerable:make_list("lt 45.7.0"))) flag++;
if (qpkg_check(package:"mail-client/thunderbird-bin", unaffected:make_list("ge 45.7.0"), vulnerable:make_list("lt 45.7.0"))) flag++;
