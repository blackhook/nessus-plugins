...
# extracted from Gentoo Linux Security Advisory GLSA 201406-16.
#
...
if (description)
{
  ...
  script_bugtraq_id(66158, 66161, 66163, 66166, 66601, 66624);
  script_xref(name:"GLSA", value:"201406-16");

  script_name(english:"GLSA-201406-16 : cups-filters: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-print/cups-filters", unaffected:make_list("ge 1.0.53"), vulnerable:make_list("lt 1.0.53"))) flag++;
