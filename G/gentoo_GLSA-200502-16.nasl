...
# extracted from Gentoo Linux Security Advisory GLSA 200502-16.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-200502-16 : ht://Dig: XSS vulnerability");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://securitytracker.com/alerts/2005/Feb/1013078.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All ht://Dig users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:htdig");
...
if (qpkg_check(package:"www-misc/htdig", unaffected:make_list("ge 3.1.6-r7"), vulnerable:make_list("lt 3.1.6-r7"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "ht://Dig");
}
