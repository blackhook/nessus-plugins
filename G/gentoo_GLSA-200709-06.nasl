...
# extracted from Gentoo Linux Security Advisory GLSA 200709-06.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200709-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All flac123 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:flac123");
...
if (qpkg_check(package:"media-sound/flac123", unaffected:make_list("ge 0.0.11"), vulnerable:make_list("lt 0.0.11"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "flac123");
}
