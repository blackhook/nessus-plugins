...
# extracted from Gentoo Linux Security Advisory GLSA 201412-25.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-25");

  script_name(english:"GLSA-201412-25 : QtGui: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-25
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-qt/qtgui", unaffected:make_list("ge 4.8.5-r2"), vulnerable:make_list("lt 4.8.5-r2"))) flag++;
