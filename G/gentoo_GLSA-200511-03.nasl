...
# extracted from Gentoo Linux Security Advisory GLSA 200511-03.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200511-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All giflib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:giflib");
...
if (qpkg_check(package:"media-libs/giflib", unaffected:make_list("ge 4.1.4"), vulnerable:make_list("lt 4.1.4"))) flag++;
