...
# extracted from Gentoo Linux Security Advisory GLSA 201705-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201705-04");

  script_name(english:"GLSA-201705-04 : Mozilla Network Security Service (NSS): Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201705-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201705-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/nss", unaffected:make_list("ge 3.29.5"), vulnerable:make_list("lt 3.29.5"))) flag++;
