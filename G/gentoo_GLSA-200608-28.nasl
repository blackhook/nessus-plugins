...
# extracted from Gentoo Linux Security Advisory GLSA 200608-28.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200608-28"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/php", unaffected:make_list("rge 4.4.3-r1", "rge 4.4.4-r4", "rge 4.4.6", "rge 4.4.7", "rge 4.4.8_pre20070816", "ge 5.1.4-r6"), vulnerable:make_list("lt 5.1.4-r6"))) flag++;
