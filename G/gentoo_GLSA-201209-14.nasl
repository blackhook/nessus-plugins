...
# extracted from Gentoo Linux Security Advisory GLSA 201209-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201209-14");

  script_name(english:"GLSA-201209-14 : file: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201209-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201209-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/file", unaffected:make_list("ge 5.11"), vulnerable:make_list("lt 5.11"))) flag++;
