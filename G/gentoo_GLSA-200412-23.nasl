...
# extracted from Gentoo Linux Security Advisory GLSA 200412-23.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://zwiki.org/925ZwikiXSSVulnerability"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200412-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Zwiki users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:zwiki");
...
if (qpkg_check(package:"net-zope/zwiki", unaffected:make_list("ge 0.36.2-r1"), vulnerable:make_list("lt 0.36.2-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Zwiki");
}
