...
# extracted from Gentoo Linux Security Advisory GLSA 200610-09.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200610-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200610-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libmusicbrainz users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:musicbrainz");
...
if (qpkg_check(package:"media-libs/musicbrainz", unaffected:make_list("ge 2.1.4"), vulnerable:make_list("lt 2.1.4"))) flag++;
