...
# extracted from Gentoo Linux Security Advisory GLSA 200812-22.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200812-22
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200812-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/ampache", unaffected:make_list("ge 3.4.3"), vulnerable:make_list("lt 3.4.3"))) flag++;
