...
# extracted from Gentoo Linux Security Advisory GLSA 201406-35.
#
...
if (description)
{
  ...
  script_bugtraq_id(34804, 66717);
  script_xref(name:"GLSA", value:"201406-35");

  script_name(english:"GLSA-201406-35 : Openfire: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-35
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-35"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-im/openfire", unaffected:make_list("ge 3.9.2-r1"), vulnerable:make_list("lt 3.9.2-r1"))) flag++;
