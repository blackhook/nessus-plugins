...
# extracted from Gentoo Linux Security Advisory GLSA 200501-11.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-client/dillo", unaffected:make_list("ge 0.8.3-r4"), vulnerable:make_list("lt 0.8.3-r4"))) flag++;
