...
# extracted from Gentoo Linux Security Advisory GLSA 202012-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-13");
  script_xref(name:"IAVA", value:"2020-A-0566-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-202012-13 : OpenSSL: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202012-13
...
if (qpkg_check(package:"dev-libs/openssl", unaffected:make_list("ge 1.1.1i"), vulnerable:make_list("lt 1.1.1i"))) flag++;
