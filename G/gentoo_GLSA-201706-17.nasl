...
# extracted from Gentoo Linux Security Advisory GLSA 201706-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-17");

  script_name(english:"GLSA-201706-17 : Kodi: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-tv/kodi", unaffected:make_list("ge 17.2"), vulnerable:make_list("lt 17.2"))) flag++;
