...
# extracted from Gentoo Linux Security Advisory GLSA 201203-21.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201203-21");

  script_name(english:"GLSA-201203-21 : Asterisk: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201203-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://downloads.asterisk.org/pub/security/AST-2012-002.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://downloads.asterisk.org/pub/security/AST-2012-003.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201203-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/asterisk", unaffected:make_list("ge 1.8.10.1"), vulnerable:make_list("lt 1.8.10.1"))) flag++;
