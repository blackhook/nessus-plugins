...
# extracted from Gentoo Linux Security Advisory GLSA 200502-15.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/pdns", unaffected:make_list("ge 2.9.17"), vulnerable:make_list("lt 2.9.17"))) flag++;
