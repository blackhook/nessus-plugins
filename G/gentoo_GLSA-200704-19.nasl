...
# extracted from Gentoo Linux Security Advisory GLSA 200704-19.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200704-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/blender", unaffected:make_list("ge 2.43"), vulnerable:make_list("lt 2.43"))) flag++;
