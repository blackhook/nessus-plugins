...
# extracted from Gentoo Linux Security Advisory GLSA 200510-04.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200510-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200510-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Texinfo users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:texinfo");
...
if (qpkg_check(package:"sys-apps/texinfo", unaffected:make_list("ge 4.8-r1"), vulnerable:make_list("lt 4.8-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Texinfo");
}
