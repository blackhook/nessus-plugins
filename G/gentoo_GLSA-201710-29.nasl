...
# extracted from Gentoo Linux Security Advisory GLSA 201710-29.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-14098", "CVE-2017-14099", "CVE-2017-14100", "CVE-2017-14603");
  script_xref(name:"GLSA", value:"201710-29");

  script_name(english:"GLSA-201710-29 : Asterisk: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-29
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-29"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/asterisk", unaffected:make_list("ge 11.25.3"), vulnerable:make_list("lt 11.25.3"))) flag++;
