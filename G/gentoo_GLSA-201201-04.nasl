...
# extracted from Gentoo Linux Security Advisory GLSA 201201-04.
#
...
if (description)
{
  ...
  script_bugtraq_id(50171);
  script_xref(name:"GLSA", value:"201201-04");

  script_name(english:"GLSA-201201-04 : Logsurfer: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201201-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201201-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Logsurfer users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:logsurfer+");
...
if (qpkg_check(package:"app-admin/logsurfer+", unaffected:make_list("ge 1.8"), vulnerable:make_list("lt 1.8"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Logsurfer");
}
