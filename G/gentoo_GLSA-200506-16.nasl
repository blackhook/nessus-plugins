...
# extracted from Gentoo Linux Security Advisory GLSA 200506-16.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200506-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/archive/1/396429"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200506-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-arch/cpio", unaffected:make_list("ge 2.6-r3"), vulnerable:make_list("lt 2.6-r3"))) flag++;
