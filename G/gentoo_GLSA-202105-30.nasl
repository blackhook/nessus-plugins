...
# extracted from Gentoo Linux Security Advisory GLSA 202105-30.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-30");

  script_name(english:"GLSA-202105-30 : MuPDF: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-30
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-30"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-text/mupdf", unaffected:make_list("ge 1.18.0-r3"), vulnerable:make_list("lt 1.18.0-r3"))) flag++;
