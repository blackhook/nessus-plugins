...
# extracted from Gentoo Linux Security Advisory GLSA 201801-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201801-02");

  script_name(english:"GLSA-201801-02 : OptiPNG: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201801-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201801-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/optipng", unaffected:make_list("ge 0.7.6-r2"), vulnerable:make_list("lt 0.7.6-r2"))) flag++;
