...
# extracted from Gentoo Linux Security Advisory GLSA 200707-11.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200707-11
...
if (qpkg_check(package:"app-crypt/mit-krb5", unaffected:make_list("ge 1.5.2-r3"), vulnerable:make_list("lt 1.5.2-r3"))) flag++;
