...
# extracted from Gentoo Linux Security Advisory GLSA 200611-20.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200611-20
...
if (qpkg_check(package:"app-text/gv", unaffected:make_list("ge 3.6.2-r1"), vulnerable:make_list("lt 3.6.2-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GNU gv");
}
