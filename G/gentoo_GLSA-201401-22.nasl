...
# extracted from Gentoo Linux Security Advisory GLSA 201401-22.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201401-22");

  script_name(english:"GLSA-201401-22 : Active Record: SQL injection");
...
Workaround :
    ...
    The vulnerability may be mitigated by converting the input to an
      ...
      &lsquo;Post.find_by_id(params[:id])&rsquo; in code using Active Record to
      &lsquo;Post.find_by_id(params[:id].to_s)&rsquo;"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Active Record users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:activerecord");
...
if (qpkg_check(package:"dev-ruby/activerecord", unaffected:make_list("ge 2.3.14-r1"), vulnerable:make_list("lt 2.3.14-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Active Record");
}
