...
# extracted from Gentoo Linux Security Advisory GLSA 200703-20.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200703-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200703-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All lsat users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:lsat");
...
if (qpkg_check(package:"app-admin/lsat", unaffected:make_list("ge 0.9.5"), vulnerable:make_list("lt 0.9.5"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "LSAT");
}
