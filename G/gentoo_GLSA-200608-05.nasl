...
# extracted from Gentoo Linux Security Advisory GLSA 200608-05.
#
...
if (qpkg_check(package:"net-libs/libvncserver", unaffected:make_list("ge 0.8.2"), vulnerable:make_list("lt 0.8.2"))) flag++;
