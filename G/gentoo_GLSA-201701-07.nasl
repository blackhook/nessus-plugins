...
# extracted from Gentoo Linux Security Advisory GLSA 201701-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-07");

  script_name(english:"GLSA-201701-07 : Open vSwitch: Remote execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/openvswitch", unaffected:make_list("ge 2.5.0"), vulnerable:make_list("lt 2.5.0"))) flag++;
