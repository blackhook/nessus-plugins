...
# extracted from Gentoo Linux Security Advisory GLSA 201309-17.
#
...
if (description)
{
  ...
  script_bugtraq_id(60210, 60333, 60425);
  script_xref(name:"GLSA", value:"201309-17");

  script_name(english:"GLSA-201309-17 : Monkey HTTP Daemon: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201309-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201309-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-servers/monkeyd", unaffected:make_list("ge 1.2.2"), vulnerable:make_list("lt 1.2.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Monkey HTTP Daemon");
}
