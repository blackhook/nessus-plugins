...
# extracted from Gentoo Linux Security Advisory GLSA 200412-02.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://dvs.easysol.net/threats/details.cgi?id=115906"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200412-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All PDFlib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2004/12/05");
...
if (qpkg_check(package:"media-libs/pdflib", unaffected:make_list("ge 5.0.4_p1"), vulnerable:make_list("lt 5.0.4_p1"))) flag++;
