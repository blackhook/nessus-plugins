...
# extracted from Gentoo Linux Security Advisory GLSA 201904-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201904-23");

  script_name(english:"GLSA-201904-23 : GLib: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201904-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201904-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/glib", unaffected:make_list("ge 2.56.4"), vulnerable:make_list("lt 2.56.4"))) flag++;
