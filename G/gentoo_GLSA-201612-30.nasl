...
# extracted from Gentoo Linux Security Advisory GLSA 201612-30.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-30");

  script_name(english:"GLSA-201612-30 : SoX: User-assisted execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-30"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-sound/sox", unaffected:make_list("ge 14.4.2"), vulnerable:make_list("lt 14.4.2"))) flag++;
