...
# extracted from Gentoo Linux Security Advisory GLSA 201206-30.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201206-30");
  script_xref(name:"IAVA", value:"2010-A-0002");

  script_name(english:"GLSA-201206-30 : sendmail: X.509 NULL spoofing vulnerability");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201206-30
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201206-30"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"mail-mta/sendmail", unaffected:make_list("ge 8.14.4"), vulnerable:make_list("lt 8.14.4"))) flag++;
