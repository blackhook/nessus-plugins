...
# extracted from Gentoo Linux Security Advisory GLSA 201709-24.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2012-6706", "CVE-2017-12940", "CVE-2017-12941", "CVE-2017-12942");
  script_xref(name:"GLSA", value:"201709-24");

  script_name(english:"GLSA-201709-24 : RAR, UnRAR: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201709-24
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-24"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-arch/rar", unaffected:make_list("ge 5.5.0_p20170811"), vulnerable:make_list("lt 5.5.0_p20170811"))) flag++;
if (qpkg_check(package:"app-arch/unrar", unaffected:make_list("ge 5.5.7"), vulnerable:make_list("lt 5.5.7"))) flag++;
