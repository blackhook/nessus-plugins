...
# extracted from Gentoo Linux Security Advisory GLSA 200412-11.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200412-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/archive/1/381443"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200412-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-util/cscope", unaffected:make_list("ge 15.5-r2"), vulnerable:make_list("lt 15.5-r2"))) flag++;
