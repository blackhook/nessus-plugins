...
# extracted from Gentoo Linux Security Advisory GLSA 200705-18.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-18
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All PPTPD users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:pptpd");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:gentoo:linux");

  script_set_attribute(attribute:"patch_publication_date", value:"2007/05/20");
...
if (qpkg_check(package:"net-dialup/pptpd", unaffected:make_list("ge 1.3.4"), vulnerable:make_list("lt 1.3.4"))) flag++;
