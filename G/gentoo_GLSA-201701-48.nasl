...
# extracted from Gentoo Linux Security Advisory GLSA 201701-48.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-1245", "CVE-2016-4049");
  script_xref(name:"GLSA", value:"201701-48");

  script_name(english:"GLSA-201701-48 : Quagga: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-48
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-48"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/quagga", unaffected:make_list("ge 1.1.0-r2"), vulnerable:make_list("lt 1.1.0-r2"))) flag++;
