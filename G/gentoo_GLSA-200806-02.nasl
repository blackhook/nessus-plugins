...
# extracted from Gentoo Linux Security Advisory GLSA 200806-02.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200806-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libxslt", unaffected:make_list("ge 1.1.24"), vulnerable:make_list("lt 1.1.24"))) flag++;
