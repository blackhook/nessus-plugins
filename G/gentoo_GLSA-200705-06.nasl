...
# extracted from Gentoo Linux Security Advisory GLSA 200705-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All X.Org X11 library users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2007/05/05");
  script_set_attribute(attribute:"plugin_publication_date", value:"2007/05/07");
...
if (qpkg_check(package:"x11-libs/libX11", unaffected:make_list("ge 1.0.3-r2"), vulnerable:make_list("lt 1.0.3-r2"))) flag++;
