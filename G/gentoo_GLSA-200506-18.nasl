...
# extracted from Gentoo Linux Security Advisory GLSA 200506-18.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200506-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/tor", unaffected:make_list("ge 0.0.9.10"), vulnerable:make_list("lt 0.0.9.10"))) flag++;
