...
# extracted from Gentoo Linux Security Advisory GLSA 200909-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200909-02");

  script_name(english:"GLSA-200909-02 : libvorbis: User-assisted execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200909-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libvorbis", unaffected:make_list("ge 1.2.3"), vulnerable:make_list("lt 1.2.3"))) flag++;
