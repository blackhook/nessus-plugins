...
# extracted from Gentoo Linux Security Advisory GLSA 201006-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201006-09");

  script_name(english:"GLSA-201006-09 : sudo: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201006-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201006-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/sudo", unaffected:make_list("ge 1.7.2_p6"), vulnerable:make_list("lt 1.7.2_p6"))) flag++;
