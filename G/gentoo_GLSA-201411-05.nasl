...
# extracted from Gentoo Linux Security Advisory GLSA 201411-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201411-05");

  script_name(english:"GLSA-201411-05 : GNU Wget: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201411-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201411-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/wget", unaffected:make_list("ge 1.16"), vulnerable:make_list("lt 1.16"))) flag++;
