...
# extracted from Gentoo Linux Security Advisory GLSA 201409-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201409-07");

  script_name(english:"GLSA-201409-07 : c-icap: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201409-07
(c-icap: Denial of Service)
    ...
    c-icap contains a flaw in the parse_request() function of request.c that
      ...
      buffer fails to contain a &lsquo; &lsquo; or &lsquo;?&rsquo; symbol, which will cause the
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201409-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All c-icap users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:c-icap");
...
if (qpkg_check(package:"net-proxy/c-icap", unaffected:make_list("ge 0.2.6"), vulnerable:make_list("lt 0.2.6"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "c-icap");
}
