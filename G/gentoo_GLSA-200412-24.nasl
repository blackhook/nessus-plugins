...
# extracted from Gentoo Linux Security Advisory GLSA 200412-24.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200412-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/gpdf", unaffected:make_list("ge 2.8.1-r1"), vulnerable:make_list("le 2.8.1"))) flag++;
if (qpkg_check(package:"app-text/xpdf", unaffected:make_list("ge 3.00-r7"), vulnerable:make_list("le 3.00-r6"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Xpdf / GPdf");
}
