...
# extracted from Gentoo Linux Security Advisory GLSA 200704-12.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200704-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-07"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-office/openoffice-bin", unaffected:make_list("ge 2.2.0"), vulnerable:make_list("lt 2.2.0"))) flag++;
if (qpkg_check(package:"app-office/openoffice", unaffected:make_list("ge 2.1.0-r1"), vulnerable:make_list("lt 2.1.0-r1"))) flag++;
