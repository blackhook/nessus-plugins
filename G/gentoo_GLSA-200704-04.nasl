...
# extracted from Gentoo Linux Security Advisory GLSA 200704-04.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200704-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"OpenPBS has been masked in the Portage tree for replacement by Torque.
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:openpbs");
...
if (qpkg_check(package:"sys-cluster/openpbs", unaffected:make_list(), vulnerable:make_list("le 2.3.16-r4"))) flag++;
