...
# extracted from Gentoo Linux Security Advisory GLSA 201611-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201611-10");

  script_name(english:"GLSA-201611-10 : libuv: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201611-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201611-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libuv", unaffected:make_list("ge 1.4.2"), vulnerable:make_list("lt 1.4.2"))) flag++;
