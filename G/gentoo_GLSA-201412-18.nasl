...
# extracted from Gentoo Linux Security Advisory GLSA 201412-18.
#
...
if (description)
{
  ...
  script_bugtraq_id(67670);
  script_xref(name:"GLSA", value:"201412-18");

  script_name(english:"GLSA-201412-18 : FreeRDP: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-18
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/freerdp", unaffected:make_list("ge 1.1.0_beta1_p20130710-r1"), vulnerable:make_list("lt 1.1.0_beta1_p20130710-r1"))) flag++;
