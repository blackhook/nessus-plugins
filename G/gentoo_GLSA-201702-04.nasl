...
# extracted from Gentoo Linux Security Advisory GLSA 201702-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201702-04");

  script_name(english:"GLSA-201702-04 : GnuTLS: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201702-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201702-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/gnutls", unaffected:make_list("ge 3.3.26"), vulnerable:make_list("lt 3.3.26"))) flag++;
