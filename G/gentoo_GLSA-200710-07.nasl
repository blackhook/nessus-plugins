...
# extracted from Gentoo Linux Security Advisory GLSA 200710-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200710-07
(Tk: Buffer overflow)
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200710-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/tk", unaffected:make_list("ge 8.4.15-r1"), vulnerable:make_list("lt 8.4.15-r1"))) flag++;
