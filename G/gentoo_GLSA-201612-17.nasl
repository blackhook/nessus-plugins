...
# extracted from Gentoo Linux Security Advisory GLSA 201612-17.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-5873");
  script_xref(name:"GLSA", value:"201612-17");

  script_name(english:"GLSA-201612-17 : PECL HTTP: Remote execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All PECL HTTP users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:pecl-http");
...
if (qpkg_check(package:"dev-php/pecl-http", unaffected:make_list("rge 2.5.6"), vulnerable:make_list("lt 2.5.6"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "PECL HTTP");
}
