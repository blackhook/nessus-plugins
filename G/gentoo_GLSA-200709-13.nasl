...
# extracted from Gentoo Linux Security Advisory GLSA 200709-13.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200709-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200709-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/rsync", unaffected:make_list("ge 2.6.9-r3"), vulnerable:make_list("lt 2.6.9-r3"))) flag++;
