...
# extracted from Gentoo Linux Security Advisory GLSA 202101-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-23");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/09/15");

  script_name(english:"GLSA-202101-23 : PEAR Archive_Tar: Directory traversal");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202101-23
(PEAR Archive_Tar: Directory traversal)

    Multiple vulnerabilities have been discovered in PEAR Archive_Tar.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202101-23"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-php/PEAR-Archive_Tar", unaffected:make_list("ge 1.4.12"), vulnerable:make_list("lt 1.4.12"))) flag++;
