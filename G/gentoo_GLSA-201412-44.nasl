...
# extracted from Gentoo Linux Security Advisory GLSA 201412-44.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-44");

  script_name(english:"GLSA-201412-44 : policycoreutils: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-44
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-44"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All policycoreutils users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:policycoreutils");
...
if (qpkg_check(package:"sys-apps/policycoreutils", unaffected:make_list("ge 2.2.5-r4"), vulnerable:make_list("lt 2.2.5-r4"))) flag++;
