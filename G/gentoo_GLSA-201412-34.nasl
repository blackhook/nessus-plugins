...
# extracted from Gentoo Linux Security Advisory GLSA 201412-34.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201412-34");

  script_name(english:"GLSA-201412-34 : NTP: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-34
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-34"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/ntp", unaffected:make_list("ge 4.2.8"), vulnerable:make_list("lt 4.2.8"))) flag++;
