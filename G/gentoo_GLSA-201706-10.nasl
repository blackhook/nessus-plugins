...
# extracted from Gentoo Linux Security Advisory GLSA 201706-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-10");
  script_xref(name:"IAVB", value:"2017-B-0029");

  script_name(english:"GLSA-201706-10 : Pidgin: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-im/pidgin", unaffected:make_list("ge 2.12.0"), vulnerable:make_list("lt 2.12.0"))) flag++;
