...
if (description)
{
  ...
  script_name(english:"Google Chrome < 64.0.3282.140 V8 Factory::NewFunction() RCE");
...
prior to 64.0.3282.140. It is, therefore, affected by a flaw in the
...
google_chrome_check_version(installs:installs, fix:'64.0.3282.140', severity:SECURITY_WARNING);
