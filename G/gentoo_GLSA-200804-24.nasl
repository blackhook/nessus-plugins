...
# extracted from Gentoo Linux Security Advisory GLSA 200804-24.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200804-24
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200804-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All DBMail users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:dbmail");
...
if (qpkg_check(package:"net-mail/dbmail", unaffected:make_list("ge 2.2.9"), vulnerable:make_list("lt 2.2.9"))) flag++;
