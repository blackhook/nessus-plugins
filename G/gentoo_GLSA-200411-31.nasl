...
# extracted from Gentoo Linux Security Advisory GLSA 200411-31.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200411-31
...
"Currently, there is no released version of ProZilla that contains a fix
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:prozilla");
...
if (qpkg_check(package:"www-client/prozilla", unaffected:make_list(), vulnerable:make_list("le 1.3.7.3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "ProZilla");
}
