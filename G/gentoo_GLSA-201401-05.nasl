...
# extracted from Gentoo Linux Security Advisory GLSA 201401-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201401-05");

  script_name(english:"GLSA-201401-05 : ISC DHCP: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201401-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/dhcp", unaffected:make_list("ge 4.2.5_p1"), vulnerable:make_list("lt 4.2.5_p1"))) flag++;
