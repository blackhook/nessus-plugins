...
# extracted from Gentoo Linux Security Advisory GLSA 200805-21.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200805-21");

  script_name(english:"GLSA-200805-21 : Roundup: Permission bypass");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200805-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200805-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/roundup", unaffected:make_list("ge 1.4.4-r1"), vulnerable:make_list("lt 1.4.4-r1"))) flag++;
