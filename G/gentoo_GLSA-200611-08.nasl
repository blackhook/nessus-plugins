...
# extracted from Gentoo Linux Security Advisory GLSA 200611-08.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200611-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-arch/rpm", unaffected:make_list("ge 4.4.6-r3"), vulnerable:make_list("lt 4.4.6-r3"))) flag++;
