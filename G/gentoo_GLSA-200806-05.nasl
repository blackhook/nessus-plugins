...
# extracted from Gentoo Linux Security Advisory GLSA 200806-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200806-05");

  script_name(english:"GLSA-200806-05 : cbrPager: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200806-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200806-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All cbrPager users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:cbrpager");
...
if (qpkg_check(package:"app-misc/cbrpager", unaffected:make_list("ge 0.9.17"), vulnerable:make_list("lt 0.9.17"))) flag++;
