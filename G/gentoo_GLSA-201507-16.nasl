...
# extracted from Gentoo Linux Security Advisory GLSA 201507-16.
#
...
if (description)
{
  ...
  script_bugtraq_id(59878);
  script_xref(name:"GLSA", value:"201507-16");

  script_name(english:"GLSA-201507-16 : Portage: Man-in-the-middle attack");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201507-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201507-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/portage", unaffected:make_list("ge 2.1.12.2"), vulnerable:make_list("lt 2.1.12.2"))) flag++;
