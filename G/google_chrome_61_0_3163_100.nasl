...
if (description)
{
  ...
  script_name(english:"Google Chrome < 61.0.3163.100 Multiple Vulnerabilities");
...
google_chrome_check_version(installs:installs, fix:'61.0.3163.100', severity:SECURITY_WARNING);
