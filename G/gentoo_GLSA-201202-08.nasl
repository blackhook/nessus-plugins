...
# extracted from Gentoo Linux Security Advisory GLSA 201202-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201202-08");

  script_name(english:"GLSA-201202-08 : stunnel: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201202-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201202-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/stunnel", unaffected:make_list("ge 4.44", "lt 4"), vulnerable:make_list("lt 4.44"))) flag++;
