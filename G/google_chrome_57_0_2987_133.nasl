...
if (description)
{
  ...
  script_bugtraq_id(97220, 97221);

  script_name(english:"Google Chrome < 57.0.2987.133 Multiple Vulnerabilities");
...
google_chrome_check_version(installs:installs, fix:'57.0.2987.133', severity:SECURITY_HOLE);
