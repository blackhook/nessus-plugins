...
# extracted from Gentoo Linux Security Advisory GLSA 200501-24.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-ftp/tnftp", unaffected:make_list("ge 20050103"), vulnerable:make_list("lt 20050103"))) flag++;
