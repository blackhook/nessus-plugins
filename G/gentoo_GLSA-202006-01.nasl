...
# extracted from Gentoo Linux Security Advisory GLSA 202006-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202006-01");

  script_name(english:"GLSA-202006-01 : GnuTLS: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202006-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202006-01"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-libs/gnutls", unaffected:make_list("ge 3.6.14"), vulnerable:make_list("lt 3.6.14"))) flag++;
