...
# extracted from Gentoo Linux Security Advisory GLSA 201406-22.
#
...
if (description)
{
  ...
  script_bugtraq_id(61848, 61852);
  script_xref(name:"GLSA", value:"201406-22");

  script_name(english:"GLSA-201406-22 : Network Audio System: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-22
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/nas", unaffected:make_list("ge 1.9.4"), vulnerable:make_list("lt 1.9.4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Network Audio System");
}
