...
# extracted from Gentoo Linux Security Advisory GLSA 200710-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200710-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/nx", unaffected:make_list("ge 3.0.0"), vulnerable:make_list("lt 3.0.0"))) flag++;
if (qpkg_check(package:"net-misc/nxnode", unaffected:make_list("ge 3.0.0-r3"), vulnerable:make_list("lt 3.0.0-r3"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "NX 2.1");
}
