...
# extracted from Gentoo Linux Security Advisory GLSA 200807-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200807-09");

  script_name(english:"GLSA-200807-09 : Mercurial: Directory traversal");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200807-09
(Mercurial: Directory traversal)

    Jakub Wilk discovered a directory traversal vulnerability in the
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200807-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-util/mercurial", unaffected:make_list("ge 1.0.1-r2"), vulnerable:make_list("lt 1.0.1-r2"))) flag++;
