...
# extracted from Gentoo Linux Security Advisory GLSA 200704-05.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200704-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All zziplib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:zziplib");
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2007/03/17");
...
if (qpkg_check(package:"dev-libs/zziplib", unaffected:make_list("ge 0.13.49"), vulnerable:make_list("lt 0.13.49"))) flag++;
