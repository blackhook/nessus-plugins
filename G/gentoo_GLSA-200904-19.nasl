...
# extracted from Gentoo Linux Security Advisory GLSA 200904-19.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200904-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200904-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/lcms", unaffected:make_list("ge 1.18-r1"), vulnerable:make_list("lt 1.18-r1"))) flag++;
