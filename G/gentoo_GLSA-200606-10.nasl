...
# extracted from Gentoo Linux Security Advisory GLSA 200606-10.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-util/cscope", unaffected:make_list("ge 15.5-r6"), vulnerable:make_list("lt 15.5-r6"))) flag++;
