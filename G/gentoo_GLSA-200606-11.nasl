...
# extracted from Gentoo Linux Security Advisory GLSA 200606-11.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200606-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"JPEG users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:jpeg");
...
if (qpkg_check(package:"media-libs/jpeg", unaffected:make_list("ge 6b-r7"), vulnerable:make_list("lt 6b-r7"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "JPEG library");
}
