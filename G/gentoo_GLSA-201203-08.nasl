...
# extracted from Gentoo Linux Security Advisory GLSA 201203-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201203-08");

  script_name(english:"GLSA-201203-08 : libxslt: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201203-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201203-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libxslt", unaffected:make_list("ge 1.1.26-r3"), vulnerable:make_list("lt 1.1.26-r3"))) flag++;
