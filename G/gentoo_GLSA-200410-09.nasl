...
# extracted from Gentoo Linux Security Advisory GLSA 200410-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200410-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-libs/lesstif", unaffected:make_list("ge 0.93.97"), vulnerable:make_list("lt 0.93.97"))) flag++;
