...
# extracted from Gentoo Linux Security Advisory GLSA 200502-26.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200502-26
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All GProFTPD users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gproftpd");
...
if (qpkg_check(package:"net-ftp/gproftpd", unaffected:make_list("ge 8.1.9"), vulnerable:make_list("lt 8.1.9"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GProFTPD");
}
