...
# extracted from Gentoo Linux Security Advisory GLSA 201706-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-16");

  script_name(english:"GLSA-201706-16 : GNU Wget: Header injection");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/wget", unaffected:make_list("ge 1.19.1-r1"), vulnerable:make_list("lt 1.19.1-r1"))) flag++;
