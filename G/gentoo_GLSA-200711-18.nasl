...
# extracted from Gentoo Linux Security Advisory GLSA 200711-18.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200711-18
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200711-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-arch/cpio", unaffected:make_list("ge 2.9-r1"), vulnerable:make_list("lt 2.9-r1"))) flag++;
