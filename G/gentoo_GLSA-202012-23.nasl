...
# extracted from Gentoo Linux Security Advisory GLSA 202012-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-23");
  script_xref(name:"IAVA", value:"2020-A-0570-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"GLSA-202012-23 : Apache Tomcat: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202012-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202012-23"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"www-servers/tomcat", unaffected:make_list("ge 8.5.60", "ge 9.0.40"), vulnerable:make_list("lt 8.5.60", "lt 9.0.40"))) flag++;
