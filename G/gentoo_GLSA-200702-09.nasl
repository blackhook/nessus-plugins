...
# extracted from Gentoo Linux Security Advisory GLSA 200702-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200702-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Nexuiz users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:nexuiz");
...
if (qpkg_check(package:"games-fps/nexuiz", unaffected:make_list("ge 2.2.1"), vulnerable:make_list("lt 2.2.1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Nexuiz");
}
