...
# extracted from Gentoo Linux Security Advisory GLSA 201402-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201402-13");

  script_name(english:"GLSA-201402-13 : DjVu: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201402-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201402-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/djvu", unaffected:make_list("ge 3.5.25.3"), vulnerable:make_list("lt 3.5.25.3"))) flag++;
