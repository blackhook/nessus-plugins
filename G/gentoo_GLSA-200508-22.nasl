...
# extracted from Gentoo Linux Security Advisory GLSA 200508-22.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200508-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-auth/pam_ldap", unaffected:make_list("ge 180"), vulnerable:make_list("lt 180"))) flag++;
