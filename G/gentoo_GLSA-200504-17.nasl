...
# extracted from Gentoo Linux Security Advisory GLSA 200504-17.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/xv", unaffected:make_list("ge 3.10a-r11"), vulnerable:make_list("lt 3.10a-r11"))) flag++;
