...
# extracted from Gentoo Linux Security Advisory GLSA 200504-27.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200504-27
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-27"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/xine-lib", unaffected:make_list("ge 1.0-r2", "rge 1_rc6-r2"), vulnerable:make_list("lt 1.0-r2"))) flag++;
