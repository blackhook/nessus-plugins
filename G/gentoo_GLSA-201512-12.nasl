...
# extracted from Gentoo Linux Security Advisory GLSA 201512-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201512-12");

  script_name(english:"GLSA-201512-12 : KDE Systemsettings: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201512-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201512-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All KDE Systemsettings users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:systemsettings");
...
if (qpkg_check(package:"kde-base/systemsettings", unaffected:make_list("ge 4.11.13-r1"), vulnerable:make_list("lt 4.11.13-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "KDE Systemsettings");
}
