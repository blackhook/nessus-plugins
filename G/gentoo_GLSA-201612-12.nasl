...
# extracted from Gentoo Linux Security Advisory GLSA 201612-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-12");

  script_name(english:"GLSA-201612-12 : Patch: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-devel/patch", unaffected:make_list("ge 2.7.4"), vulnerable:make_list("lt 2.7.4"))) flag++;
