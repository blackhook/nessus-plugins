...
# extracted from Gentoo Linux Security Advisory GLSA 201502-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201502-03");

  script_name(english:"GLSA-201502-03 : BIND: Multiple Vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201502-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201502-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/bind", unaffected:make_list("ge 9.10.1_p1"), vulnerable:make_list("lt 9.10.1_p1"))) flag++;
