...
# extracted from Gentoo Linux Security Advisory GLSA 201402-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201402-05");

  script_name(english:"GLSA-201402-05 : Banshee: Arbitrary code execution");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201402-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Banshee users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:banshee");
...
if (qpkg_check(package:"media-sound/banshee", unaffected:make_list("ge 1.8.0-r1"), vulnerable:make_list("lt 1.8.0-r1"))) flag++;
