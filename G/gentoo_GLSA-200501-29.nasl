...
# extracted from Gentoo Linux Security Advisory GLSA 200501-29.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-200501-29 : Mailman: XSS vulnerability");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-29"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/mailman", unaffected:make_list("ge 2.1.5-r3"), vulnerable:make_list("lt 2.1.5-r3"))) flag++;
