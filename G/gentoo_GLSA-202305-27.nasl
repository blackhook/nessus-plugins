...
# extracted from Gentoo Linux Security Advisory GLSA 202305-27.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202305-27 : Tinyproxy: Memory Disclosure");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202305-27 (Tinyproxy: Memory Disclosure)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-27");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=871924");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.11.1_p20220908"),
    'vulnerable' : make_list("lt 1.11.1_p20220908")
  }
];
