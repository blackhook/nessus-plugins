...
# extracted from Gentoo Linux Security Advisory GLSA 200708-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200708-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200708-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Net::DNS users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:Net-DNS");
...
if (qpkg_check(package:"dev-perl/Net-DNS", unaffected:make_list("ge 0.60"), vulnerable:make_list("lt 0.60"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Net::DNS");
}
