...
# extracted from Gentoo Linux Security Advisory GLSA 201401-07.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2012-2870", "CVE-2012-2893", "CVE-2012-6139", "CVE-2013-4520");
  script_bugtraq_id(55331, 55676, 58685, 63548);
  script_xref(name:"GLSA", value:"201401-07");

  script_name(english:"GLSA-201401-07 : libxslt: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201401-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libxslt", unaffected:make_list("ge 1.1.28"), vulnerable:make_list("lt 1.1.28"))) flag++;
