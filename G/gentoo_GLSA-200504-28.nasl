...
# extracted from Gentoo Linux Security Advisory GLSA 200504-28.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-28"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-crypt/heimdal", unaffected:make_list("ge 0.6.4"), vulnerable:make_list("lt 0.6.4"))) flag++;
