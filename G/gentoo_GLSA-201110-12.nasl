...
# extracted from Gentoo Linux Security Advisory GLSA 201110-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201110-12");

  script_name(english:"GLSA-201110-12 : Unbound: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201110-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201110-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/unbound", unaffected:make_list("ge 1.4.10"), vulnerable:make_list("lt 1.4.10"))) flag++;
