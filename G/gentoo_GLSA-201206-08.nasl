...
# extracted from Gentoo Linux Security Advisory GLSA 201206-08.
#
...
if (description)
{
  ...
  script_bugtraq_id(51703, 52987);
  script_xref(name:"GLSA", value:"201206-08");

  script_name(english:"GLSA-201206-08 : Wicd: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201206-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201206-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/wicd", unaffected:make_list("ge 1.7.2.1"), vulnerable:make_list("lt 1.7.2.1"))) flag++;
