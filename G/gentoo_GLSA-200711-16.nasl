...
# extracted from Gentoo Linux Security Advisory GLSA 200711-16.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200711-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-print/cups", unaffected:make_list("ge 1.2.12-r2"), vulnerable:make_list("lt 1.2.12-r2"))) flag++;
