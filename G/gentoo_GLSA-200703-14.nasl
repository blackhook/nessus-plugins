...
# extracted from Gentoo Linux Security Advisory GLSA 200703-14.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200703-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://labs.musecurity.com/advisories/MU-200703-01.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200703-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/asterisk", unaffected:make_list("ge 1.2.14-r1", "rge 1.0.12-r1"), vulnerable:make_list("lt 1.2.14-r1"))) flag++;
