...
# extracted from Gentoo Linux Security Advisory GLSA 202008-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202008-03");

  script_name(english:"GLSA-202008-03 : Ark: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202008-03
(Ark: Arbitrary code execution)

    A maliciously crafted archive with &ldquo;../&rdquo; in the file path(s) could
      install files anywhere in the user&rsquo;s home directory upon extraction.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202008-03"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"kde-apps/ark", unaffected:make_list("ge 20.04.3-r1"), vulnerable:make_list("lt 20.04.3-r1"))) flag++;
