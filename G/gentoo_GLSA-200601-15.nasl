...
# extracted from Gentoo Linux Security Advisory GLSA 200601-15.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200601-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Paros users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:paros");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:gentoo:linux");

  script_set_attribute(attribute:"patch_publication_date", value:"2006/01/29");
...
if (qpkg_check(package:"net-proxy/paros", unaffected:make_list("gt 3.2.5"), vulnerable:make_list("le 3.2.5"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Paros");
}
