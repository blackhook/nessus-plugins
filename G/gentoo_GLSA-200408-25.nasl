...
# extracted from Gentoo Linux Security Advisory GLSA 200408-25.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e36556a4"
  );
  script_set_attribute(
    attribute:"see_also",
...
if (qpkg_check(package:"www-apps/moinmoin", unaffected:make_list("ge 1.2.3"), vulnerable:make_list("le 1.2.2"))) flag++;
