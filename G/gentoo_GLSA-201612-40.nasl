...
# extracted from Gentoo Linux Security Advisory GLSA 201612-40.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-40");

  script_name(english:"GLSA-201612-40 : SQUASHFS: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-40
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-40"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-fs/squashfs-tools", unaffected:make_list("ge 4.3"), vulnerable:make_list("lt 4.3"))) flag++;
