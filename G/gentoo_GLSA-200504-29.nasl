...
# extracted from Gentoo Linux Security Advisory GLSA 200504-29.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8bda67c3"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-29"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-servers/pound", unaffected:make_list("ge 1.8.3"), vulnerable:make_list("lt 1.8.3"))) flag++;
