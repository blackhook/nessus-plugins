...
# extracted from Gentoo Linux Security Advisory GLSA 201401-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201401-19");

  script_name(english:"GLSA-201401-19 : GMime: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201401-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"GMime 2.4.x users on the PPC64 architecture should upgrade to the latest
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gmime");
...
if (qpkg_check(package:"dev-libs/gmime", unaffected:make_list("ge 2.4.15", "rge 2.4.17", "rge 2.2.26"), vulnerable:make_list("lt 2.4.15"))) flag++;
