...
# extracted from Gentoo Linux Security Advisory GLSA 201406-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-05");

  script_name(english:"GLSA-201406-05 : Mutt: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"mail-client/mutt", unaffected:make_list("ge 1.5.22-r3"), vulnerable:make_list("lt 1.5.22-r3"))) flag++;
