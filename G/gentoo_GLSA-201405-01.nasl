...
# extracted from Gentoo Linux Security Advisory GLSA 201405-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201405-01");

  script_name(english:"GLSA-201405-01 : udisks: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201405-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201405-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All udisks 1.0 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:udisks");
...
if (qpkg_check(package:"sys-fs/udisks", unaffected:make_list("rge 1.0.5", "ge 2.1.3"), vulnerable:make_list("lt 2.1.3"))) flag++;
