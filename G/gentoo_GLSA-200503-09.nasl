...
# extracted from Gentoo Linux Security Advisory GLSA 200503-09.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200503-09
...
if (qpkg_check(package:"media-gfx/xv", unaffected:make_list("ge 3.10a-r10"), vulnerable:make_list("lt 3.10a-r10"))) flag++;
