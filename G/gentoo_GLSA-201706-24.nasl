...
# extracted from Gentoo Linux Security Advisory GLSA 201706-24.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-24");

  script_name(english:"GLSA-201706-24 : jbig2dec: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-24
(jbig2dec: Multiple vulnerabilities)

    Multiple vulnerabilities have been discovered in jbig2dec. Please review
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All jbig2dec users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:jbig2dec");
...
if (qpkg_check(package:"media-libs/jbig2dec", unaffected:make_list("ge 0.13-r1"), vulnerable:make_list("lt 0.13-r1"))) flag++;
