...
# extracted from Gentoo Linux Security Advisory GLSA 200705-24.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-24
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-24"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libpng", unaffected:make_list("ge 1.2.17"), vulnerable:make_list("lt 1.2.17"))) flag++;
