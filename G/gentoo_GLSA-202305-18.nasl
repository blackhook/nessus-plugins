...
# extracted from Gentoo Linux Security Advisory GLSA 202305-18.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-33657", "CVE-2022-4743");

  script_name(english:"GLSA-202305-18 : libsdl2: Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202305-18 (libsdl2: Multiple Vulnerabilities)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-18");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=836665");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=890614");
...
var packages = [
  {
    'name' : 'media-libs/libsdl2',
    'unaffected' : make_list("ge 2.26.0"),
    'vulnerable' : make_list("lt 2.26.0")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libsdl2');
}
