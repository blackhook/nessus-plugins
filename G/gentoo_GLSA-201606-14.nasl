...
# extracted from Gentoo Linux Security Advisory GLSA 201606-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201606-14");

  script_name(english:"GLSA-201606-14 : ImageMagick: Multiple vulnerabilities");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.launchpad.net/ubuntu/+source/imagemagick/+bug/1448803"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.launchpad.net/ubuntu/+source/imagemagick/+bug/1490362"
  );
  # http://www.openwall.com/lists/oss-security/2014/12/24/1
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.openwall.com/lists/oss-security/2014/12/24/1"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.launchpad.net/ubuntu/+source/imagemagick/+bug/1459747"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201606-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/imagemagick", unaffected:make_list("ge 6.9.0.3"), vulnerable:make_list("lt 6.9.0.3"))) flag++;
