...
# extracted from Gentoo Linux Security Advisory GLSA 201708-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201708-10");

  script_name(english:"GLSA-201708-10 : jbig2dec: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201708-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201708-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/jbig2dec", unaffected:make_list("ge 0.13-r4"), vulnerable:make_list("lt 0.13-r4"))) flag++;
