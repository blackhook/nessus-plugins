...
# extracted from Gentoo Linux Security Advisory GLSA 200501-26.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200501-26
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/imagemagick", unaffected:make_list("ge 6.1.8.8"), vulnerable:make_list("lt 6.1.8.8"))) flag++;
