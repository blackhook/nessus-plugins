...
# extracted from Gentoo Linux Security Advisory GLSA 202007-49.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202007-49");

  script_name(english:"GLSA-202007-49 : Mozilla Network Security Service (NSS): Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202007-49
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202007-49"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-libs/nss", unaffected:make_list("ge 3.52.1"), vulnerable:make_list("lt 3.52.1"))) flag++;
