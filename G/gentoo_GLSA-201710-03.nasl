...
# extracted from Gentoo Linux Security Advisory GLSA 201710-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-03");

  script_name(english:"GLSA-201710-03 : ICU: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/icu", unaffected:make_list("ge 58.2-r1"), vulnerable:make_list("lt 58.2-r1"))) flag++;
