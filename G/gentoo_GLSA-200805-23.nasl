...
# extracted from Gentoo Linux Security Advisory GLSA 200805-23.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200805-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-fs/samba", unaffected:make_list("ge 3.0.28a-r1"), vulnerable:make_list("lt 3.0.28a-r1"))) flag++;
