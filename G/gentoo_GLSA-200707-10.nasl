...
# extracted from Gentoo Linux Security Advisory GLSA 200707-10.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200707-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-accessibility/festival", unaffected:make_list("ge 1.95_beta-r4"), vulnerable:make_list("lt 1.95_beta-r4"))) flag++;
