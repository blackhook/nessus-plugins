...
# extracted from Gentoo Linux Security Advisory GLSA 201904-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201904-20");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/03");
  script_xref(name:"CEA-ID", value:"CEA-2019-0203");

  script_name(english:"GLSA-201904-20 : Apache: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201904-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201904-20"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"www-servers/apache", unaffected:make_list("ge 2.4.39"), vulnerable:make_list("lt 2.4.39"))) flag++;
