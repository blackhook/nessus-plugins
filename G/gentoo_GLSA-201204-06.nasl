...
# extracted from Gentoo Linux Security Advisory GLSA 201204-06.
#
...
if (description)
{
  ...
  script_bugtraq_id(39198, 47496);
  script_xref(name:"GLSA", value:"201204-06");

  script_name(english:"GLSA-201204-06 : PolicyKit: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201204-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201204-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-auth/polkit", unaffected:make_list("ge 0.104-r1"), vulnerable:make_list("lt 0.104-r1"))) flag++;
