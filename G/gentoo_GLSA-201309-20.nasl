...
# extracted from Gentoo Linux Security Advisory GLSA 201309-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201309-20");

  script_name(english:"GLSA-201309-20 : Dropbear: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201309-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.gentoo.org/show_bug.cgi?id=328383"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201309-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/dropbear", unaffected:make_list("ge 2012.55"), vulnerable:make_list("lt 2012.55"))) flag++;
