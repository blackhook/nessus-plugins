...
# extracted from Gentoo Linux Security Advisory GLSA 200709-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200709-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200709-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-sound/streamripper", unaffected:make_list("ge 1.62.2"), vulnerable:make_list("lt 1.62.2"))) flag++;
