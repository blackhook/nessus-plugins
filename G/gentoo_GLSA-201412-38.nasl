...
# extracted from Gentoo Linux Security Advisory GLSA 201412-38.
#
...
if (description)
{
  ...
  script_bugtraq_id(71205, 71312);
  script_xref(name:"GLSA", value:"201412-38");

  script_name(english:"GLSA-201412-38 : Icecast: Multiple Vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-38
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-38"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/icecast", unaffected:make_list("ge 2.4.1"), vulnerable:make_list("lt 2.4.1"))) flag++;
