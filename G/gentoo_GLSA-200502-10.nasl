...
# extracted from Gentoo Linux Security Advisory GLSA 200502-10.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/pdftohtml", unaffected:make_list("ge 0.36-r3"), vulnerable:make_list("lt 0.36-r3"))) flag++;
