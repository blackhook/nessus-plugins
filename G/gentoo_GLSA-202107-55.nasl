...
# extracted from Gentoo Linux Security Advisory GLSA 202107-55.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202107-55");

  script_name(english:"GLSA-202107-55 : SDL 2: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202107-55
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202107-55"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"media-libs/libsdl2", unaffected:make_list("ge 2.0.14-r1"), vulnerable:make_list("lt 2.0.14-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "SDL 2");
}
