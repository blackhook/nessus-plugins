...
# extracted from Gentoo Linux Security Advisory GLSA 201408-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201408-08");

  script_name(english:"GLSA-201408-08 : file: Denial of Service");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201408-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/file", unaffected:make_list("ge 5.15"), vulnerable:make_list("lt 5.15"))) flag++;
