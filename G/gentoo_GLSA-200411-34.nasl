...
# extracted from Gentoo Linux Security Advisory GLSA 200411-34.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200411-34"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/cyrus-imapd", unaffected:make_list("ge 2.2.10"), vulnerable:make_list("lt 2.2.10"))) flag++;
