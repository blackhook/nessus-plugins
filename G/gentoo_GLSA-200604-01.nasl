...
# extracted from Gentoo Linux Security Advisory GLSA 200604-01.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-200604-01 : MediaWiki: XSS vulnerability");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200604-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?959b69eb"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200604-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/mediawiki", unaffected:make_list("ge 1.4.15"), vulnerable:make_list("lt 1.4.15"))) flag++;
