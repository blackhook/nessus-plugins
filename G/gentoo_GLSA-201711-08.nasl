...
# extracted from Gentoo Linux Security Advisory GLSA 201711-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201711-08");

  script_name(english:"GLSA-201711-08 : LibXfont, LibXfont2: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201711-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201711-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All LibXfont2 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libXfont2");
...
if (qpkg_check(package:"x11-libs/libXfont", unaffected:make_list("ge 1.5.3"), vulnerable:make_list("lt 1.5.3"))) flag++;
if (qpkg_check(package:"x11-libs/libXfont2", unaffected:make_list("ge 2.0.2"), vulnerable:make_list("lt 2.0.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "LibXfont / LibXfont2");
}
