...
# extracted from Gentoo Linux Security Advisory GLSA 201709-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201709-10");

  script_name(english:"GLSA-201709-10 : Git: Command injection");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=git&m=150238802328673&w=2"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-vcs/git", unaffected:make_list("ge 2.13.5"), vulnerable:make_list("lt 2.13.5"))) flag++;
