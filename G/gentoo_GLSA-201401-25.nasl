...
# extracted from Gentoo Linux Security Advisory GLSA 201401-25.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201401-25");

  script_name(english:"GLSA-201401-25 : ldns: Arbitrary code execution");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-25"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All ldns users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:ldns");
...
if (qpkg_check(package:"net-libs/ldns", unaffected:make_list("ge 1.6.11"), vulnerable:make_list("lt 1.6.11"))) flag++;
