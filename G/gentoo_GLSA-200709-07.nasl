...
# extracted from Gentoo Linux Security Advisory GLSA 200709-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200709-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200709-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Eggdrop users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:eggdrop");
...
if (qpkg_check(package:"net-irc/eggdrop", unaffected:make_list("ge 1.6.18-r3"), vulnerable:make_list("lt 1.6.18-r3"))) flag++;
