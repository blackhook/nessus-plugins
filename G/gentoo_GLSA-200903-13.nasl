...
# extracted from Gentoo Linux Security Advisory GLSA 200903-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200903-13");

  script_name(english:"GLSA-200903-13 : MPFR: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200903-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200903-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/mpfr", unaffected:make_list("ge 2.4.1"), vulnerable:make_list("lt 2.4.1"))) flag++;
