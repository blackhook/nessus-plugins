...
# extracted from Gentoo Linux Security Advisory GLSA 202101-25.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202101-25");

  script_name(english:"GLSA-202101-25 : Mutt: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202101-25
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202101-25"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"mail-client/mutt", unaffected:make_list("ge 2.0.4-r1"), vulnerable:make_list("lt 2.0.4-r1"))) flag++;
