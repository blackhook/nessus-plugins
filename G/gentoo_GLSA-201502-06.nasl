...
# extracted from Gentoo Linux Security Advisory GLSA 201502-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201502-06");

  script_name(english:"GLSA-201502-06 : nginx: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201502-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201502-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-servers/nginx", unaffected:make_list("ge 1.7.6"), vulnerable:make_list("lt 1.7.6"))) flag++;
