...
# extracted from Gentoo Linux Security Advisory GLSA 200807-11.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200807-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200807-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-sound/peercast", unaffected:make_list("ge 0.1218-r1"), vulnerable:make_list("lt 0.1218-r1"))) flag++;
