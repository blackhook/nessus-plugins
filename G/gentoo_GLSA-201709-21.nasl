...
# extracted from Gentoo Linux Security Advisory GLSA 201709-21.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-11362", "CVE-2017-11628", "CVE-2017-12932");
  script_xref(name:"GLSA", value:"201709-21");

  script_name(english:"GLSA-201709-21 : PHP: Multiple vulnerabilities");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/php", unaffected:make_list("ge 5.6.31", "ge 7.0.23"), vulnerable:make_list("lt 5.6.31", "lt 7.0.23"))) flag++;
