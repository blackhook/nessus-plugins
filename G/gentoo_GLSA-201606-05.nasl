...
# extracted from Gentoo Linux Security Advisory GLSA 201606-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201606-05");

  script_name(english:"GLSA-201606-05 : spice: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201606-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201606-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-emulation/spice", unaffected:make_list("ge 0.12.7-r1"), vulnerable:make_list("lt 0.12.7-r1"))) flag++;
