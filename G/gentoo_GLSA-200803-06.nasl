...
# extracted from Gentoo Linux Security Advisory GLSA 200803-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200803-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200803-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All SWORD users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:sword");
...
if (qpkg_check(package:"app-text/sword", unaffected:make_list("ge 1.5.8-r2"), vulnerable:make_list("lt 1.5.8-r2"))) flag++;
