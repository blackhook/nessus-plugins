...
"All GNU TeXmacs users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:texmacs");
...
if (qpkg_check(package:"app-office/texmacs", unaffected:make_list("ge 1.0.7.2-r1"), vulnerable:make_list("lt 1.0.7.2-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GNU TeXmacs");
}
