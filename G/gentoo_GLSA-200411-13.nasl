...
# extracted from Gentoo Linux Security Advisory GLSA 200411-13.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200411-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Portage users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gentoolkit");
...
if (qpkg_check(package:"sys-apps/portage", unaffected:make_list("ge 2.0.51-r3"), vulnerable:make_list("le 2.0.51-r2"))) flag++;
if (qpkg_check(package:"app-portage/gentoolkit", unaffected:make_list("ge 0.2.0_pre10-r1", "rge 0.2.0_pre8-r1"), vulnerable:make_list("le 0.2.0_pre10"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Portage / Gentoolkit");
}
