...
# extracted from Gentoo Linux Security Advisory GLSA 201709-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201709-17");

  script_name(english:"GLSA-201709-17 : CVS: Command injection");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-vcs/cvs", unaffected:make_list("ge 1.12.12-r12"), vulnerable:make_list("lt 1.12.12-r12"))) flag++;
