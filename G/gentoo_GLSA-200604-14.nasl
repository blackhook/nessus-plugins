...
# extracted from Gentoo Linux Security Advisory GLSA 200604-14.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200604-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-office/dia", unaffected:make_list("ge 0.94-r5"), vulnerable:make_list("lt 0.94-r5"))) flag++;
