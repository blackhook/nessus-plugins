...
# extracted from Gentoo Linux Security Advisory GLSA 201110-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201110-09");

  script_name(english:"GLSA-201110-09 : Conky: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201110-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201110-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Conky users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:conky");
...
if (qpkg_check(package:"app-admin/conky", unaffected:make_list("ge 1.8.1-r2"), vulnerable:make_list("lt 1.8.1-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Conky");
}
