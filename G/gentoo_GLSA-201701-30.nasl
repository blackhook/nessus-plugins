...
# extracted from Gentoo Linux Security Advisory GLSA 201701-30.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-30");

  script_name(english:"GLSA-201701-30 : vzctl: Security bypass");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-30
...
Impact :
    ...
    An attacker with root privileges, in a simfs-based container, could gain
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-30"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All vzctl users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:vzctl");
...
if (qpkg_check(package:"sys-cluster/vzctl", unaffected:make_list("ge 4.9.4"), vulnerable:make_list("lt 4.9.4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "vzctl");
}
