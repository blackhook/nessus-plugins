...
# extracted from Gentoo Linux Security Advisory GLSA 200605-01.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200605-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All MPlayer users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:mplayer-bin");
...
if (qpkg_check(package:"media-video/mplayer", unaffected:make_list("ge 1.0.20060415", "ge 1.0_pre8"), vulnerable:make_list("lt 1.0.20060415"))) flag++;
if (qpkg_check(package:"media-video/mplayer-bin", unaffected:make_list("ge 1.0.20060415", "ge 1.0_pre8"), vulnerable:make_list("lt 1.0.20060415"))) flag++;
