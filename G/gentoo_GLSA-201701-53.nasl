...
# extracted from Gentoo Linux Security Advisory GLSA 201701-53.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-53");

  script_name(english:"GLSA-201701-53 : Lua: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-53
(Lua: Buffer overflow)
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-53"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/lua", unaffected:make_list("ge 5.1.5-r4"), vulnerable:make_list("lt 5.1.5-r4"))) flag++;
