...
# extracted from Gentoo Linux Security Advisory GLSA 200909-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200909-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200909-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All TkMan users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:tkman");
...
if (qpkg_check(package:"app-text/tkman", unaffected:make_list("ge 2.2-r1"), vulnerable:make_list("lt 2.2-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "TkMan");
}
