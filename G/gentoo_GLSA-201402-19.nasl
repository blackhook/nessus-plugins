...
# extracted from Gentoo Linux Security Advisory GLSA 201402-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201402-19");

  script_name(english:"GLSA-201402-19 : libtar: Arbitraty code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201402-19
(libtar: Arbitraty code execution)

    An integer overflow error within the &ldquo;th_read()&rdquo; function when
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201402-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libtar users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libtar");
...
if (qpkg_check(package:"dev-libs/libtar", unaffected:make_list("ge 1.2.20-r2"), vulnerable:make_list("lt 1.2.20-r2"))) flag++;
