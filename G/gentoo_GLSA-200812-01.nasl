...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200812-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/optipng", unaffected:make_list("ge 0.6.2"), vulnerable:make_list("lt 0.6.2"))) flag++;
