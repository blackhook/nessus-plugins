...
# extracted from Gentoo Linux Security Advisory GLSA 200506-22.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.sudo.ws/sudo/alerts/path_race.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200506-22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/sudo", unaffected:make_list("ge 1.6.8_p9"), vulnerable:make_list("lt 1.6.8_p9"))) flag++;
