...
# extracted from Gentoo Linux Security Advisory GLSA 201401-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201401-09");

  script_name(english:"GLSA-201401-09 : Openswan: User-assisted execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201401-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/openswan", unaffected:make_list("ge 2.6.39"), vulnerable:make_list("lt 2.6.39"))) flag++;
