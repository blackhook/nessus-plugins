...
# extracted from Gentoo Linux Security Advisory GLSA 200411-04.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://speedtouch.sourceforge.net/index.php?/news.en.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200411-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Speedtouch USB driver users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:speedtouch");
...
if (qpkg_check(package:"net-dialup/speedtouch", unaffected:make_list("ge 1.3.1"), vulnerable:make_list("lt 1.3.1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Speedtouch USB driver");
}
