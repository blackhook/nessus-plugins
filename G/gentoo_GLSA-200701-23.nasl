...
# extracted from Gentoo Linux Security Advisory GLSA 200701-23.
#
...
Impact :
    ...
    These vulnerabilities can result in the execution of arbitrary shell
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200701-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/cacti", unaffected:make_list("ge 0.8.6i-r1"), vulnerable:make_list("lt 0.8.6i-r1"))) flag++;
