...
"A distributed version control server is running on the remote host.");
  script_set_attribute(attribute:"description", value:
"A Git daemon using the Git protocol is running on the remote host.");
  script_set_attribute(attribute:"see_also", value:"https://git-scm.com/book/en/v2/Git-on-the-Server-The-Protocols");
