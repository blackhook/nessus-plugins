...
if (description)
{
  ...
  script_name(english:"Google Chrome < 61.0.3163.79 Multiple Vulnerabilities");
...
prior to 61.0.3163.79. It is, therefore, affected by the following
vulnerabilities :
...
google_chrome_check_version(installs:installs, fix:'61.0.3163.79', severity:SECURITY_WARNING);
