...
# extracted from Gentoo Linux Security Advisory GLSA 201110-17.
#
...
if (description)
{
  ...
  script_bugtraq_id(41075, 46446);
  script_xref(name:"GLSA", value:"201110-17");

  script_name(english:"GLSA-201110-17 : Avahi: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201110-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201110-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/avahi", unaffected:make_list("ge 0.6.28-r1"), vulnerable:make_list("lt 0.6.28-r1"))) flag++;
