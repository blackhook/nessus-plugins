...
if (description)
{
  ...
  script_name(english:"Google Chrome < 53.0.2785.143 Multiple Vulnerabilities");
...
google_chrome_check_version(installs:installs, fix:'53.0.2785.143', severity:SECURITY_HOLE);
