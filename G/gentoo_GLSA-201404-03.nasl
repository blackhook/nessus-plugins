...
# extracted from Gentoo Linux Security Advisory GLSA 201404-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201404-03");

  script_name(english:"GLSA-201404-03 : OptiPNG: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201404-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201404-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/optipng", unaffected:make_list("ge 0.7.3"), vulnerable:make_list("lt 0.7.3"))) flag++;
