...
# extracted from Gentoo Linux Security Advisory GLSA 200809-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200809-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200809-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-video/realplayer", unaffected:make_list("ge 11.0.0.4028-r1"), vulnerable:make_list("lt 11.0.0.4028-r1"))) flag++;
