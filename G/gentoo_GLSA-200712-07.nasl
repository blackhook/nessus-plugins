...
# extracted from Gentoo Linux Security Advisory GLSA 200712-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200712-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200712-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Lookup users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:lookup");
...
if (qpkg_check(package:"app-emacs/lookup", unaffected:make_list("ge 1.4.1"), vulnerable:make_list("lt 1.4.1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Lookup");
}
