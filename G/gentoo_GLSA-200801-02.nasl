...
# extracted from Gentoo Linux Security Advisory GLSA 200801-02.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200801-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200801-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/R", unaffected:make_list("ge 2.2.1-r1"), vulnerable:make_list("lt 2.2.1-r1"))) flag++;
