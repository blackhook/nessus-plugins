...
# extracted from Gentoo Linux Security Advisory GLSA 200803-28.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200803-28"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-nds/openldap", unaffected:make_list("ge 2.3.41"), vulnerable:make_list("lt 2.3.41"))) flag++;
