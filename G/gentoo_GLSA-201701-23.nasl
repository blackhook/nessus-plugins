...
# extracted from Gentoo Linux Security Advisory GLSA 201701-23.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-2849", "CVE-2016-2850");
  script_xref(name:"GLSA", value:"201701-23");

  script_name(english:"GLSA-201701-23 : Botan: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Botan users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:botan");
...
if (qpkg_check(package:"dev-libs/botan", unaffected:make_list("ge 1.10.13"), vulnerable:make_list("lt 1.10.13"))) flag++;
