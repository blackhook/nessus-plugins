...
# extracted from Gentoo Linux Security Advisory GLSA 200801-12.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200801-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200801-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/xine-lib", unaffected:make_list("ge 1.1.9.1"), vulnerable:make_list("lt 1.1.9.1"))) flag++;
