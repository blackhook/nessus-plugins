...
# extracted from Gentoo Linux Security Advisory GLSA 200608-13.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200608-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.clamav.net/security/0.88.4.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200608-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-antivirus/clamav", unaffected:make_list("ge 0.88.4"), vulnerable:make_list("lt 0.88.4"))) flag++;
