...
# extracted from Gentoo Linux Security Advisory GLSA 200411-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200411-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200411-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All MIME-tools users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:MIME-tools");
...
if (qpkg_check(package:"dev-perl/MIME-tools", unaffected:make_list("ge 5.415"), vulnerable:make_list("lt 5.415"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "MIME-tools");
}
