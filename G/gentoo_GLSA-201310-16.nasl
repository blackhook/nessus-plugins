...
# extracted from Gentoo Linux Security Advisory GLSA 201310-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201310-16");

  script_name(english:"GLSA-201310-16 : TPTEST: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201310-16
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201310-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All TPTEST users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:tptest");
...
if (qpkg_check(package:"net-analyzer/tptest", unaffected:make_list("ge 3.1.7-r2"), vulnerable:make_list("lt 3.1.7-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "TPTEST");
}
