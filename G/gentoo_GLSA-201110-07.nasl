...
# extracted from Gentoo Linux Security Advisory GLSA 201110-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201110-07");

  script_name(english:"GLSA-201110-07 : vsftpd: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201110-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201110-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All vsftpd users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:vsftpd");
...
if (qpkg_check(package:"net-ftp/vsftpd", unaffected:make_list("ge 2.3.4"), vulnerable:make_list("lt 2.3.4"))) flag++;
