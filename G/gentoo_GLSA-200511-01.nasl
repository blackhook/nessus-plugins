...
# extracted from Gentoo Linux Security Advisory GLSA 200511-01.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200511-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libgda users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libgda");
...
if (qpkg_check(package:"gnome-extra/libgda", unaffected:make_list("ge 1.2.2-r1"), vulnerable:make_list("lt 1.2.2-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libgda");
}
