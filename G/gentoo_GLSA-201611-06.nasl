...
# extracted from Gentoo Linux Security Advisory GLSA 201611-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201611-06");

  script_name(english:"GLSA-201611-06 : xinetd: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201611-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201611-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All xinetd users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:xinetd");
...
if (qpkg_check(package:"sys-apps/xinetd", unaffected:make_list("ge 2.3.15-r2"), vulnerable:make_list("lt 2.3.15-r2"))) flag++;
