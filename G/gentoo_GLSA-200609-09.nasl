...
# extracted from Gentoo Linux Security Advisory GLSA 200609-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200609-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-video/ffmpeg", unaffected:make_list("ge 0.4.9_p20060530"), vulnerable:make_list("lt 0.4.9_p20060530"))) flag++;
