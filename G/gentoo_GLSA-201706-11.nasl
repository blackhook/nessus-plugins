...
# extracted from Gentoo Linux Security Advisory GLSA 201706-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-11");

  script_name(english:"GLSA-201706-11 : PCRE library: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libpcre", unaffected:make_list("ge 8.40-r1"), vulnerable:make_list("lt 8.40-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "PCRE library");
}
