...
# extracted from Gentoo Linux Security Advisory GLSA 201507-21.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201507-21");

  script_name(english:"GLSA-201507-21 : libXfont: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201507-21
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201507-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-libs/libXfont", unaffected:make_list("rge 1.4.9", "ge 1.5.1"), vulnerable:make_list("lt 1.5.1"))) flag++;
