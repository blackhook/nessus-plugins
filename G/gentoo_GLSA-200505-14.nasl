...
# extracted from Gentoo Linux Security Advisory GLSA 200505-14.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://secuniaresearch.flexerasoftware.com/advisories/15386/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200505-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Cheetah users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:cheetah");
...
if (qpkg_check(package:"dev-python/cheetah", unaffected:make_list("ge 0.9.17_rc1"), vulnerable:make_list("lt 0.9.17_rc1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Cheetah");
}
