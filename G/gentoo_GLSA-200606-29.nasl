...
# extracted from Gentoo Linux Security Advisory GLSA 200606-29.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2006-3047", "CVE-2006-3048");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200606-29
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-29"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/tikiwiki", unaffected:make_list("ge 1.9.4"), vulnerable:make_list("lt 1.9.4"))) flag++;
