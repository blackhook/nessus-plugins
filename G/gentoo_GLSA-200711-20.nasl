...
# extracted from Gentoo Linux Security Advisory GLSA 200711-20.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2007-5933", "CVE-2007-6010");
  script_xref(name:"GLSA", value:"200711-20");

  script_name(english:"GLSA-200711-20 : Pioneers: Multiple Denials of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200711-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200711-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Pioneers users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:pioneers");
...
if (qpkg_check(package:"games-board/pioneers", unaffected:make_list("ge 0.11.3-r1"), vulnerable:make_list("lt 0.11.3-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Pioneers");
}
