...
# extracted from Gentoo Linux Security Advisory GLSA 201504-02.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201504-02");

  script_name(english:"GLSA-201504-02 : sudo: Information disclosure");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201504-02
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201504-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-admin/sudo", unaffected:make_list("ge 1.8.12"), vulnerable:make_list("lt 1.8.12"))) flag++;
