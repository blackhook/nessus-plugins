...
# extracted from Gentoo Linux Security Advisory GLSA 200809-16.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200809-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-util/git", unaffected:make_list("ge 1.5.6.4"), vulnerable:make_list("lt 1.5.6.4"))) flag++;
