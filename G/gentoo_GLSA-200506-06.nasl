...
# extracted from Gentoo Linux Security Advisory GLSA 200506-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200506-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.gnu.org/software/libextractor/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200506-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libextractor", unaffected:make_list("ge 0.5.0"), vulnerable:make_list("lt 0.5.0"))) flag++;
