...
# extracted from Gentoo Linux Security Advisory GLSA 200705-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-firewall/ipsec-tools", unaffected:make_list("ge 0.6.7"), vulnerable:make_list("lt 0.6.7"))) flag++;
