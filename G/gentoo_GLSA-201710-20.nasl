...
# extracted from Gentoo Linux Security Advisory GLSA 201710-20.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9565", "CVE-2016-9566", "CVE-2017-12847");
  script_xref(name:"GLSA", value:"201710-20");

  script_name(english:"GLSA-201710-20 : Nagios: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-20
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/nagios-core", unaffected:make_list("ge 4.3.3"), vulnerable:make_list("lt 4.3.3"))) flag++;
