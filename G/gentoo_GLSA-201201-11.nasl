...
# extracted from Gentoo Linux Security Advisory GLSA 201201-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201201-11");

  script_name(english:"GLSA-201201-11 : Firewall Builder: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201201-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201201-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Firewall Builder users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:fwbuilder");
...
if (qpkg_check(package:"net-firewall/fwbuilder", unaffected:make_list("ge 3.0.7"), vulnerable:make_list("lt 3.0.7"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Firewall Builder");
}
