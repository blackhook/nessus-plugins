...
# extracted from Gentoo Linux Security Advisory GLSA 201311-18.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201311-18");

  script_name(english:"GLSA-201311-18 : Unbound: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201311-18
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201311-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dns/unbound", unaffected:make_list("ge 1.4.13_p2"), vulnerable:make_list("lt 1.4.13_p2"))) flag++;
