...
# extracted from Gentoo Linux Security Advisory GLSA 200505-02.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200505-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Oops! users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:oops");
...
if (qpkg_check(package:"net-proxy/oops", unaffected:make_list("ge 1.5.24_pre20050503"), vulnerable:make_list("lt 1.5.24_pre20050503"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Oops!");
}
