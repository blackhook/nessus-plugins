...
# extracted from Gentoo Linux Security Advisory GLSA 200404-08.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200404-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200404-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-devel/automake", unaffected:make_list("ge 1.8.5-r3", "rge 1.7.9-r1", "lt 1.7"), vulnerable:make_list("le 1.8.5-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "sys-devel/automake");
}
