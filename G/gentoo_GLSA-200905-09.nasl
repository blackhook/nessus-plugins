...
# extracted from Gentoo Linux Security Advisory GLSA 200905-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200905-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/libsndfile", unaffected:make_list("ge 1.0.20"), vulnerable:make_list("lt 1.0.20"))) flag++;
