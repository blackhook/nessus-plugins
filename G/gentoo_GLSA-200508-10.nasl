...
# extracted from Gentoo Linux Security Advisory GLSA 200508-10.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a98987d"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200508-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Kismet users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:kismet");
...
if (qpkg_check(package:"net-wireless/kismet", unaffected:make_list("ge 2005.08.1"), vulnerable:make_list("lt 2005.08.1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Kismet");
}
