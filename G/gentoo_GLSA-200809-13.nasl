...
# extracted from Gentoo Linux Security Advisory GLSA 200809-13.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200809-13");

  script_name(english:"GLSA-200809-13 : R: Insecure temporary file creation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200809-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200809-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/R", unaffected:make_list("ge 2.7.1"), vulnerable:make_list("lt 2.7.1"))) flag++;
