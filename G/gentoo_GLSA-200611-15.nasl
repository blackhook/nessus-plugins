...
# extracted from Gentoo Linux Security Advisory GLSA 200611-15.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200611-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All qmailAdmin users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:qmailadmin");
...
if (qpkg_check(package:"net-mail/qmailadmin", unaffected:make_list("ge 1.2.10"), vulnerable:make_list("lt 1.2.10"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "qmailAdmin");
}
