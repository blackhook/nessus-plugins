...
# extracted from Gentoo Linux Security Advisory GLSA 200711-15.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200711-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-libs/flac", unaffected:make_list("ge 1.2.1-r1"), vulnerable:make_list("lt 1.2.1-r1"))) flag++;
