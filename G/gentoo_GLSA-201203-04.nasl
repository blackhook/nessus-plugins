...
# extracted from Gentoo Linux Security Advisory GLSA 201203-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201203-04");

  script_name(english:"GLSA-201203-04 : libxml2: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201203-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201203-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/libxml2", unaffected:make_list("ge 2.7.8-r5"), vulnerable:make_list("lt 2.7.8-r5"))) flag++;
