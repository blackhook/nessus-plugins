...
# extracted from Gentoo Linux Security Advisory GLSA 201707-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201707-08");

  script_name(english:"GLSA-201707-08 : feh: Arbitrary remote code execution");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201707-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/feh", unaffected:make_list("ge 2.18.3"), vulnerable:make_list("lt 2.18.3"))) flag++;
