...
# extracted from Gentoo Linux Security Advisory GLSA 201607-16.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201607-16");

  script_name(english:"GLSA-201607-16 : arpwatch: Privilege escalation");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201607-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/arpwatch", unaffected:make_list("ge 2.1.15-r8"), vulnerable:make_list("lt 2.1.15-r8"))) flag++;
