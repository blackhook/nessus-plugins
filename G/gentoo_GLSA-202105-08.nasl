...
# extracted from Gentoo Linux Security Advisory GLSA 202105-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-08");

  script_name(english:"GLSA-202105-08 : ICU: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9666135d"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://unicode-org.atlassian.net/browse/ICU-21383"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://unicode-org.atlassian.net/browse/ICU-21385"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-08"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-libs/icu", unaffected:make_list("ge 68.2"), vulnerable:make_list("lt 68.2"))) flag++;
