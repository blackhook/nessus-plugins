...
# extracted from Gentoo Linux Security Advisory GLSA 200501-16.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.kde.org/info/security/advisory-20041220-1.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"kde-base/kdelibs", unaffected:make_list("ge 3.3.2"), vulnerable:make_list("lt 3.3.2"))) flag++;
