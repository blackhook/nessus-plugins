...
# extracted from Gentoo Linux Security Advisory GLSA 201110-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201110-05");

  script_name(english:"GLSA-201110-05 : GnuTLS: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201110-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201110-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/gnutls", unaffected:make_list("ge 2.10.0"), vulnerable:make_list("lt 2.10.0"))) flag++;
