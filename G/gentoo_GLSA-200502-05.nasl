...
# extracted from Gentoo Linux Security Advisory GLSA 200502-05.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Newspost users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:newspost");
...
if (qpkg_check(package:"net-nntp/newspost", unaffected:make_list("rge 2.0-r1", "ge 2.1.1-r1"), vulnerable:make_list("lt 2.1.1-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Newspost");
}
