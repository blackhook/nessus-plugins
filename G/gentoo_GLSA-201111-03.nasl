...
# extracted from Gentoo Linux Security Advisory GLSA 201111-03.
#
...
if (description)
{
  ...
  script_bugtraq_id(44844, 49439);
  script_xref(name:"GLSA", value:"201111-03");

  script_name(english:"GLSA-201111-03 : OpenTTD: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201111-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201111-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"games-simulation/openttd", unaffected:make_list("ge 1.1.3"), vulnerable:make_list("lt 1.1.3"))) flag++;
