...
# extracted from Gentoo Linux Security Advisory GLSA 202012-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202012-17");

  script_name(english:"GLSA-202012-17 : D-Bus: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202012-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6fa2dd89"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202012-17"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"sys-apps/dbus", unaffected:make_list("ge 1.12.20"), vulnerable:make_list("lt 1.12.20"))) flag++;
