...
# extracted from Gentoo Linux Security Advisory GLSA 201510-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201510-03");

  script_name(english:"GLSA-201510-03 : Wireshark: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201510-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201510-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/wireshark", unaffected:make_list("ge 1.12.7"), vulnerable:make_list("lt 1.12.7"))) flag++;
