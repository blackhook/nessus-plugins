...
# extracted from Gentoo Linux Security Advisory GLSA 202105-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202105-12");

  script_name(english:"GLSA-202105-12 : OpenSMTPD: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202105-12
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202105-12"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"All OpenSMTPD users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:opensmtpd");
...
if (qpkg_check(package:"mail-mta/opensmtpd", unaffected:make_list("ge 6.8.0_p2"), vulnerable:make_list("lt 6.8.0_p2"))) flag++;
