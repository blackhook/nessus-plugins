...
# extracted from Gentoo Linux Security Advisory GLSA 201203-10.
#
...
if (description)
{
  ...
  script_bugtraq_id(41917, 42464);
  script_xref(name:"GLSA", value:"201203-10");

  script_name(english:"GLSA-201203-10 : libmikmod: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201203-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201203-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All libmikmod 3.2 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:libmikmod");
...
if (qpkg_check(package:"media-libs/libmikmod", unaffected:make_list("ge 3.2.0_beta2-r3", "rge 3.1.12-r1"), vulnerable:make_list("lt 3.2.0_beta2-r3"))) flag++;
