...
# extracted from Gentoo Linux Security Advisory GLSA 200801-13.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200801-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200801-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-irc/ngircd", unaffected:make_list("ge 0.10.4"), vulnerable:make_list("lt 0.10.4"))) flag++;
