...
# extracted from Gentoo Linux Security Advisory GLSA 201705-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201705-11");

  script_name(english:"GLSA-201705-11 : Xen: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201705-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201705-11"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"app-emulation/xen", unaffected:make_list("ge 4.7.2-r1"), vulnerable:make_list("lt 4.7.2-r1"))) flag++;
if (qpkg_check(package:"app-emulation/xen-pvgrub", unaffected:make_list("ge 4.7.2"), vulnerable:make_list("lt 4.7.2"))) flag++;
if (qpkg_check(package:"app-emulation/xen-tools", unaffected:make_list("ge 4.7.2"), vulnerable:make_list("lt 4.7.2"))) flag++;
