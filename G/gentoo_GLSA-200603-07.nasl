...
# extracted from Gentoo Linux Security Advisory GLSA 200603-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200603-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-devel/flex", unaffected:make_list("ge 2.5.33-r1"), vulnerable:make_list("lt 2.5.33-r1"))) flag++;
