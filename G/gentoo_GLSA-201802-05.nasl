...
# extracted from Gentoo Linux Security Advisory GLSA 201802-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201802-05");

  script_name(english:"GLSA-201802-05 : Ruby: Command injection");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201802-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201802-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/ruby", unaffected:make_list("ge 2.2.9"), vulnerable:make_list("lt 2.2.9"))) flag++;
