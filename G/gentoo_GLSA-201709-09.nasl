...
# extracted from Gentoo Linux Security Advisory GLSA 201709-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201709-09");

  script_name(english:"GLSA-201709-09 : Subversion: Arbitrary code execution");
...
(Subversion: Arbitrary code execution)
    ...
    Specially crafted &lsquo;ssh://...&rsquo; URLs may allow the owner of the
      repository to execute arbitrary commands on client&rsquo;s machine if those
      commands are already installed on the client&rsquo;s system. This is
      especially dangerous when the third-party repository has one or more
      submodules with specially crafted &lsquo;ssh://...&rsquo; URLs. Each time the
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://subversion.apache.org/security/CVE-2017-9800-advisory.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-vcs/subversion", unaffected:make_list("ge 1.9.7", "rgt 1.8.18"), vulnerable:make_list("lt 1.9.7"))) flag++;
