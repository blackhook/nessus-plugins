...
# extracted from Gentoo Linux Security Advisory GLSA 200802-10.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200802-10
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200802-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/python", unaffected:make_list("ge 2.3.6-r4"), vulnerable:make_list("lt 2.3.6-r4"))) flag++;
