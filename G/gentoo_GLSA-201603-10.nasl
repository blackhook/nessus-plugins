...
# extracted from Gentoo Linux Security Advisory GLSA 201603-10.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201603-10");

  script_name(english:"GLSA-201603-10 : QtGui: Multiple vulnerabilities");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201603-10"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-qt/qtgui", unaffected:make_list("ge 5.4.1-r1", "rge 4.8.6-r4", "rge 4.8.7"), vulnerable:make_list("lt 5.4.1-r1"))) flag++;
