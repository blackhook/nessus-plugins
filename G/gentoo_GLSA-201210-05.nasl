...
# extracted from Gentoo Linux Security Advisory GLSA 201210-05.
#
...
if (description)
{
  ...
  script_bugtraq_id(32733, 54937);
  script_xref(name:"GLSA", value:"201210-05");

  script_name(english:"GLSA-201210-05 : Bash: Multiple vulnerabilities");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201210-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-shells/bash", unaffected:make_list("ge 4.2_p37"), vulnerable:make_list("lt 4.2_p37"))) flag++;
