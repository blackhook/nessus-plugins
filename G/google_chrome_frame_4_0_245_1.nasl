...
that may allow an attacker to bypass cross-origin protections.");
  # http://lostmon.blogspot.com/2009/11/google-chrome-frame-null-domain-xss.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f3e794e");
  # https://chromereleases.googleblog.com/2009/11/google-chrome-frame-update-bug-fixes.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?57bc184e");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome Frame 4.0.245.1 or later.");
