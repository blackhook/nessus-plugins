...
# extracted from Gentoo Linux Security Advisory GLSA 200406-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200406-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200406-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All sitecopy users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:sitecopy");
...
if (qpkg_check(package:"net-misc/sitecopy", unaffected:make_list("ge 0.13.4-r2"), vulnerable:make_list("le 0.13.4-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "sitecopy");
}
