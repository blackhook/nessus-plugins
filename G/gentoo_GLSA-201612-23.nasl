...
# extracted from Gentoo Linux Security Advisory GLSA 201612-23.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-23");

  script_name(english:"GLSA-201612-23 : socat: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201612-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.dest-unreach.org/socat/contrib/socat-secadv7.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.dest-unreach.org/socat/contrib/socat-secadv8.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/socat", unaffected:make_list("ge 1.7.3.1"), vulnerable:make_list("lt 1.7.3.1"))) flag++;
