...
# extracted from Gentoo Linux Security Advisory GLSA 200805-20.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200805-20");

  script_name(english:"GLSA-200805-20 : GnuTLS: Execution of arbitrary code");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200805-20"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/gnutls", unaffected:make_list("ge 2.2.5"), vulnerable:make_list("lt 2.2.5"))) flag++;
