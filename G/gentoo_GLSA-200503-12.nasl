...
# extracted from Gentoo Linux Security Advisory GLSA 200503-12.
#
...
if (qpkg_check(package:"net-misc/hashcash", unaffected:make_list("ge 1.16-r1"), vulnerable:make_list("lt 1.16-r1"))) flag++;
