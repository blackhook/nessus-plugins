...
# extracted from Gentoo Linux Security Advisory GLSA 201707-05.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2010-3609", "CVE-2012-4428", "CVE-2016-4912", "CVE-2016-7567");
  script_xref(name:"GLSA", value:"201707-05");

  script_name(english:"GLSA-201707-05 : OpenSLP: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201707-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201707-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-libs/openslp", unaffected:make_list("ge 2.0.0-r4"), vulnerable:make_list("lt 2.0.0-r4"))) flag++;
