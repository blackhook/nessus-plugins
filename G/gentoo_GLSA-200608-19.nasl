...
# extracted from Gentoo Linux Security Advisory GLSA 200608-19.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200608-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/wordpress", unaffected:make_list("ge 2.0.4"), vulnerable:make_list("lt 2.0.4"))) flag++;
