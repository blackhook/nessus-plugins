...
# extracted from Gentoo Linux Security Advisory GLSA 200502-02.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/uw-imap", unaffected:make_list("ge 2004b"), vulnerable:make_list("le 2004a"))) flag++;
