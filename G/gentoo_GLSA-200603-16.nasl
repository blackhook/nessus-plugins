...
# extracted from Gentoo Linux Security Advisory GLSA 200603-16.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/metamail", unaffected:make_list("ge 2.7.45.3-r1"), vulnerable:make_list("lt 2.7.45.3-r1"))) flag++;
