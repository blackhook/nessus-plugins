...
# extracted from Gentoo Linux Security Advisory GLSA 200705-08.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"200705-08");

  script_name(english:"GLSA-200705-08 : GIMP: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200705-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200705-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/gimp", unaffected:make_list("ge 2.2.14"), vulnerable:make_list("lt 2.2.14"))) flag++;
