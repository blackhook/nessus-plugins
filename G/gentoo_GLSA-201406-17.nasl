...
# extracted from Gentoo Linux Security Advisory GLSA 201406-17.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-17");

  script_name(english:"GLSA-201406-17 : Adobe Flash Player: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-17
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-plugins/adobe-flash", unaffected:make_list("ge 11.2.202.378 "), vulnerable:make_list("lt 11.2.202.378 "))) flag++;
