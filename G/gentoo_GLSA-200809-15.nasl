...
# extracted from Gentoo Linux Security Advisory GLSA 200809-15.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200809-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/ed", unaffected:make_list("ge 1.0"), vulnerable:make_list("lt 1.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "GNU ed");
}
