...
# extracted from Gentoo Linux Security Advisory GLSA 201701-50.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-50");

  script_name(english:"GLSA-201701-50 : PPP: Buffer overflow");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-50
(PPP: Buffer overflow)

    A buffer overflow was discovered in the rc_mksid function in
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-50"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dialup/ppp", unaffected:make_list("ge 2.4.7-r3"), vulnerable:make_list("lt 2.4.7-r3"))) flag++;
