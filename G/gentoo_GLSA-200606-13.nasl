...
# extracted from Gentoo Linux Security Advisory GLSA 200606-13.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-db/mysql", unaffected:make_list("ge 5.0.22", "rge 4.1.20", "rge 4.1.21", "rge 4.1.22", "lt 4.1"), vulnerable:make_list("lt 5.0.22"))) flag++;
