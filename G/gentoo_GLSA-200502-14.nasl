...
# extracted from Gentoo Linux Security Advisory GLSA 200502-14.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200502-14
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apache/mod_python", unaffected:make_list("ge 3.1.3-r1", "rge 2.7.11"), vulnerable:make_list("lt 3.1.3-r1"))) flag++;
