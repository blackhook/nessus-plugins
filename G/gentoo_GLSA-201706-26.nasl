...
# extracted from Gentoo Linux Security Advisory GLSA 201706-26.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201706-26");

  script_name(english:"GLSA-201706-26 : Vim, gVim: Remote execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201706-26
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201706-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-editors/gvim", unaffected:make_list("ge 8.0.0386"), vulnerable:make_list("lt 8.0.0386"))) flag++;
if (qpkg_check(package:"app-editors/vim", unaffected:make_list("ge 8.0.0386"), vulnerable:make_list("lt 8.0.0386"))) flag++;
