...
# extracted from Gentoo Linux Security Advisory GLSA 200610-07.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200610-07
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200610-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-lang/python", unaffected:make_list("ge 2.4.3-r4", "rge 2.3.5-r3", "rge 2.3.6"), vulnerable:make_list("lt 2.4.3-r4"))) flag++;
