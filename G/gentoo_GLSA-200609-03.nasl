...
# extracted from Gentoo Linux Security Advisory GLSA 200609-03.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200609-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"games-simulation/openttd", unaffected:make_list("ge 0.4.8"), vulnerable:make_list("lt 0.4.8"))) flag++;
