...
# extracted from Gentoo Linux Security Advisory GLSA 201606-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201606-07");

  script_name(english:"GLSA-201606-07 : dhcpcd: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201606-07
(dhcpcd: Multiple vulnerabilities)

    A heap overflow can be triggered via malformed DHCP responses in the
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201606-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All dhcpcd users should upgrade to the latest version:
      # emerge --sync
      # emerge --ask --oneshot --verbose '>=net-misc/dhcpcd-6.10.0&rdquo;"
  );
...
if (qpkg_check(package:"net-misc/dhcpcd", unaffected:make_list("ge 6.10.0"), vulnerable:make_list("lt 6.10.0"))) flag++;
