...
# extracted from Gentoo Linux Security Advisory GLSA 201606-11.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3566", "CVE-2015-8614", "CVE-2015-8708");
  script_xref(name:"GLSA", value:"201606-11");

  script_name(english:"GLSA-201606-11 : claws-mail: Multiple Vulnerabilities (POODLE)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201606-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201606-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"mail-client/claws-mail", unaffected:make_list("ge 3.13.2"), vulnerable:make_list("lt 3.13.2"))) flag++;
