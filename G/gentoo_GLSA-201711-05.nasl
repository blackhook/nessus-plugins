...
# extracted from Gentoo Linux Security Advisory GLSA 201711-05.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-12176", "CVE-2017-12177", "CVE-2017-12178", "CVE-2017-12179", "CVE-2017-12180", "CVE-2017-12181", "CVE-2017-12182", "CVE-2017-12183");
  script_xref(name:"GLSA", value:"201711-05");

  script_name(english:"GLSA-201711-05 : X.Org Server: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201711-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201711-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-base/xorg-server", unaffected:make_list("ge 1.19.5"), vulnerable:make_list("lt 1.19.5"))) flag++;
