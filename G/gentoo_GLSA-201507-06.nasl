...
# extracted from Gentoo Linux Security Advisory GLSA 201507-06.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201507-06");

  script_name(english:"GLSA-201507-06 : UnRTF: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201507-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201507-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-text/unrtf", unaffected:make_list("ge 0.21.9"), vulnerable:make_list("lt 0.21.9"))) flag++;
