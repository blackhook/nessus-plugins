...
# extracted from Gentoo Linux Security Advisory GLSA 200704-13.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200704-13
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-13"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/file", unaffected:make_list("ge 4.21-r1"), vulnerable:make_list("eq 4.21"))) flag++;
