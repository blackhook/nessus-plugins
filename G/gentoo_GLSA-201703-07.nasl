...
# extracted from Gentoo Linux Security Advisory GLSA 201703-07.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201703-07");
  script_xref(name:"IAVB", value:"2017-B-0024-S");

  script_name(english:"GLSA-201703-07 : Xen: Privilege Escalation");
...
Workaround :
    ...
    Running HVM guests with the device model in a stubdomain will mitigate
      the issue.
    Changing the video card emulation to stdvga (stdvga=1, vga=&rdquo;stdvga&rdquo;,
      in the xl domain configuration) will avoid the vulnerability."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201703-07"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-emulation/xen-tools", unaffected:make_list("ge 4.7.1-r8"), vulnerable:make_list("lt 4.7.1-r8"))) flag++;
