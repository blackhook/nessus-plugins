...
# extracted from Gentoo Linux Security Advisory GLSA 200502-23.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200502-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All KStars users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:kdeedu");
...
if (qpkg_check(package:"kde-base/kdeedu", unaffected:make_list("ge 3.3.2-r1"), vulnerable:make_list("lt 3.3.2-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "KStars");
}
