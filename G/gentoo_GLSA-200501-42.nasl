...
# extracted from Gentoo Linux Security Advisory GLSA 200501-42.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200501-42"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All VDR users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:vdr");
...
if (qpkg_check(package:"media-video/vdr", unaffected:make_list("ge 1.2.6-r1"), vulnerable:make_list("lt 1.2.6-r1"))) flag++;
