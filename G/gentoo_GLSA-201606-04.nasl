...
if (qpkg_check(package:"app-crypt/gnupg", unaffected:make_list("ge 2.0.26-r3", "rge 1.4.19", "rge 1.4.20", "rge 1.4.21", "rge 1.4.22"), vulnerable:make_list("lt 2.0.26-r3"))) flag++;
