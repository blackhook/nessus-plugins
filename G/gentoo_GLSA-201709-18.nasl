...
# extracted from Gentoo Linux Security Advisory GLSA 201709-18.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201709-18");

  script_name(english:"GLSA-201709-18 : Mercurial: Multiple vulnerabilities");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201709-18"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-vcs/mercurial", unaffected:make_list("ge 4.3"), vulnerable:make_list("lt 4.3"))) flag++;
