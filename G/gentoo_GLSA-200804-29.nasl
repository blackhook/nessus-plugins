...
# extracted from Gentoo Linux Security Advisory GLSA 200804-29.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200804-29
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200804-29"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Comix users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:comix");
...
if (qpkg_check(package:"media-gfx/comix", unaffected:make_list("ge 3.6.4-r1"), vulnerable:make_list("lt 3.6.4-r1"))) flag++;
