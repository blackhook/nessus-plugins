...
# extracted from Gentoo Linux Security Advisory GLSA 201801-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201801-11");

  script_name(english:"GLSA-201801-11 : PySAML2: Security bypass");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201801-11
(PySAML2: Security bypass)

    It was found that the PySAML2 relies on an assert statement to check the
      user&rsquo;s password. A python optimizations might remove this assertion.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201801-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All PySAML2 4.0 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:pysaml2");
...
if (qpkg_check(package:"dev-python/pysaml2", unaffected:make_list("ge 4.0.2-r3", "ge 4.5.0"), vulnerable:make_list("lt 4.0.2-r3", "lt 4.5.0"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "PySAML2");
}
