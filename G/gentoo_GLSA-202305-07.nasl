...
# extracted from Gentoo Linux Security Advisory GLSA 202305-07.
#
...
if (description)
{
  ...
  script_name(english:"GLSA-202305-07 : slixmpp: Insufficient Certificate Validation");

  script_set_attribute(attribute:"synopsis", value:
"");
  script_set_attribute(attribute:"description", value:
"The remote host is affected by the vulnerability described in GLSA-202305-07 (slixmpp: Insufficient Certificate
Validation)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://security.gentoo.org/glsa/202305-07");
  script_set_attribute(attribute:"see_also", value:"https://bugs.gentoo.org/show_bug.cgi?id=881181");
...
"All slixmpp users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:slixmpp");
...
var packages = [
  {
    ...
    'unaffected' : make_list("ge 1.8.3"),
    'vulnerable' : make_list("lt 1.8.3")
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'slixmpp');
}
