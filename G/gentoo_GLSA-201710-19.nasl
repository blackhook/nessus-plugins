...
# extracted from Gentoo Linux Security Advisory GLSA 201710-19.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201710-19");

  script_name(english:"GLSA-201710-19 : libarchive: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201710-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201710-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-arch/libarchive", unaffected:make_list("ge 3.3.0"), vulnerable:make_list("lt 3.3.0"))) flag++;
