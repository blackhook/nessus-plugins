...
# extracted from Gentoo Linux Security Advisory GLSA 201309-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201309-04");

  script_name(english:"GLSA-201309-04 : Snack: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201309-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201309-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Snack users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:snack");
...
if (qpkg_check(package:"dev-tcltk/snack", unaffected:make_list("ge 2.2.10-r5"), vulnerable:make_list("lt 2.2.10-r5"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Snack");
}
