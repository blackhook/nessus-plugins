...
# extracted from Gentoo Linux Security Advisory GLSA 200512-17.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://sublimation.org/scponly/index.html#relnotes"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200512-17"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All scponly users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2005/12/29");
...
if (qpkg_check(package:"net-misc/scponly", unaffected:make_list("ge 4.2"), vulnerable:make_list("lt 4.2"))) flag++;
