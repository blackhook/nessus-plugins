...
# extracted from Gentoo Linux Security Advisory GLSA 201111-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201111-11");

  script_name(english:"GLSA-201111-11 : GNU Tar: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201111-11
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201111-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"app-arch/tar", unaffected:make_list("ge 1.23"), vulnerable:make_list("lt 1.23"))) flag++;
