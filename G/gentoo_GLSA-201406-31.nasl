...
# extracted from Gentoo Linux Security Advisory GLSA 201406-31.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-31");

  script_name(english:"GLSA-201406-31 : Konqueror: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-31
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-31"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Konqueror users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:konqueror");
...
if (qpkg_check(package:"kde-base/konqueror", unaffected:make_list("ge 4.9.3-r1"), vulnerable:make_list("lt 4.9.3-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Konqueror");
}
