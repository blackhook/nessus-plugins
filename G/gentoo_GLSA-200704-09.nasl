...
# extracted from Gentoo Linux Security Advisory GLSA 200704-09.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200704-09
...
if (qpkg_check(package:"media-libs/xine-lib", arch:"x86", unaffected:make_list("ge 1.1.4-r2"), vulnerable:make_list("lt 1.1.4-r2"))) flag++;
