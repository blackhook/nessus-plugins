...
vulnerabilities :
  ...
  - An unspecified browser crash related to nested URLs.
    (Issue #31517)");
  script_set_attribute(attribute:"see_also", value:"https://secuniaresearch.flexerasoftware.com/secunia_research/2009-65/");
  # https://chromereleases.googleblog.com/2010/01/stable-channel-update_25.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1619ecd");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Google Chrome 4.0.249.78 or later.");
