...
# extracted from Gentoo Linux Security Advisory GLSA 201701-52.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201701-52");
  script_xref(name:"TRA", value:"TRA-2017-10");

  script_name(english:"GLSA-201701-52 : libupnp: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201701-52
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201701-52"
  );
  script_set_attribute(
    attribute:"see_also",
...
if (qpkg_check(package:"net-libs/libupnp", unaffected:make_list("ge 1.6.21"), vulnerable:make_list("lt 1.6.21"))) flag++;
