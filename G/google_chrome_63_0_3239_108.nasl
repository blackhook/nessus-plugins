...
if (description)
{
  ...
  script_name(english:"Google Chrome < 63.0.3239.108 Multiple Vulnerabilities");
...
prior to 63.0.3239.108. It is, therefore, affected by multiple
vulnerabilities as noted in Chrome stable channel update release
notes for Thursday, December 14, 2017. Please refer to the release
...
google_chrome_check_version(installs:installs, fix:'63.0.3239.108', severity:SECURITY_WARNING);
