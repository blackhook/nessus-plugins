...
# extracted from Gentoo Linux Security Advisory GLSA 201605-05.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201605-05");

  script_name(english:"GLSA-201605-05 : Linux-PAM: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201605-05
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201605-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-libs/pam", unaffected:make_list("ge 1.2.1"), vulnerable:make_list("lt 1.2.1"))) flag++;
