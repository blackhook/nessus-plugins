...
# extracted from Gentoo Linux Security Advisory GLSA 200702-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200702-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200702-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-analyzer/snort", unaffected:make_list("ge 2.6.1.2"), vulnerable:make_list("lt 2.6.1.2"))) flag++;
