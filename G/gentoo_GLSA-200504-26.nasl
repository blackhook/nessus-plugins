...
# extracted from Gentoo Linux Security Advisory GLSA 200504-26.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All Convert-UUlib users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:Convert-UUlib");
...
if (qpkg_check(package:"dev-perl/Convert-UUlib", unaffected:make_list("ge 1.051"), vulnerable:make_list("lt 1.051"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Convert-UUlib");
}
