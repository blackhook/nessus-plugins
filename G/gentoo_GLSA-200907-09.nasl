...
# extracted from Gentoo Linux Security Advisory GLSA 200907-09.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200907-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-libs/cyrus-sasl", unaffected:make_list("ge 2.1.23"), vulnerable:make_list("lt 2.1.23"))) flag++;
