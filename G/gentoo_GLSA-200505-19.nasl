...
# extracted from Gentoo Linux Security Advisory GLSA 200505-19.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.0xbadexworm.org/adv/gxinefmt.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200505-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-video/gxine", unaffected:make_list("rge 0.3.3-r2", "rge 0.4.1-r1", "ge 0.4.4"), vulnerable:make_list("lt 0.4.4"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gxine");
}
