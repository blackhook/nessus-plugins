...
# extracted from Gentoo Linux Security Advisory GLSA 202009-11.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"202009-11");

  script_name(english:"GLSA-202009-11 : ProFTPD: Denial of service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202009-11
...
Impact :
    ...
    An authenticated remote attacker could issue invalid SCP commands,
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/proftpd/proftpd/issues/1043"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202009-11"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"net-ftp/proftpd", unaffected:make_list("ge 1.3.7a"), vulnerable:make_list("lt 1.3.7a"))) flag++;
