...
# extracted from Gentoo Linux Security Advisory GLSA 201406-12.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201406-12");

  script_name(english:"GLSA-201406-12 : FreeRADIUS: Arbitrary code execution");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201406-12
(FreeRADIUS: Arbitrary code execution)

    Large passwords can trigger a stack-based buffer overflow in
      FreeRADIUS&rsquo;s rlm_pap module when authenticating against an LDAP server.
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201406-12"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-dialup/freeradius", unaffected:make_list("ge 2.2.5"), vulnerable:make_list("lt 2.2.5"))) flag++;
