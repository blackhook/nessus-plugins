...
# extracted from Gentoo Linux Security Advisory GLSA 201111-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201111-04");

  script_name(english:"GLSA-201111-04 : phpDocumentor: Function call injection");
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201111-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All phpDocumentor users should upgrade to the latest stable version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:PEAR-PhpDocumentor");
...
if (qpkg_check(package:"dev-php/PEAR-PhpDocumentor", unaffected:make_list("ge 1.4.3-r1"), vulnerable:make_list("lt 1.4.3-r1"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "phpDocumentor");
}
