...
# extracted from Gentoo Linux Security Advisory GLSA 200503-34.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200503-34"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All mpg321 users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:mpg321");
...
if (qpkg_check(package:"media-sound/mpg321", unaffected:make_list("ge 0.2.10-r2"), vulnerable:make_list("lt 0.2.10-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mpg321");
}
