...
# extracted from Gentoo Linux Security Advisory GLSA 200503-33.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200503-33"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-firewall/ipsec-tools", unaffected:make_list("rge 0.4-r1", "ge 0.5-r1"), vulnerable:make_list("lt 0.5-r1"))) flag++;
