...
# extracted from Gentoo Linux Security Advisory GLSA 201207-04.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201207-04");

  script_name(english:"GLSA-201207-04 : X.Org X Server: Privilege escalation");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201207-04
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201207-04"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"x11-base/xorg-server", unaffected:make_list("ge 1.11.4-r1", "rge 1.10.6-r1", "rle 1.9.5-r1"), vulnerable:make_list("lt 1.11.4-r1"))) flag++;
