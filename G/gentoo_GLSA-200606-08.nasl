...
# extracted from Gentoo Linux Security Advisory GLSA 200606-08.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200606-08"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/wordpress", unaffected:make_list("ge 2.0.3"), vulnerable:make_list("lt 2.0.3"))) flag++;
