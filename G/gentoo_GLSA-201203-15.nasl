...
# extracted from Gentoo Linux Security Advisory GLSA 201203-15.
#
...
if (description)
{
  ...
  script_bugtraq_id(45815, 45920);
  script_xref(name:"GLSA", value:"201203-15");

  script_name(english:"GLSA-201203-15 : gif2png: Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201203-15
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201203-15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All gif2png users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:gif2png");
...
if (qpkg_check(package:"media-gfx/gif2png", unaffected:make_list("ge 2.5.8"), vulnerable:make_list("lt 2.5.8"))) flag++;
