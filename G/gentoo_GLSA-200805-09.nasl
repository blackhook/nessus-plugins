...
# extracted from Gentoo Linux Security Advisory GLSA 200805-09.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200805-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200805-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-apps/moinmoin", unaffected:make_list("ge 1.6.3"), vulnerable:make_list("lt 1.6.3"))) flag++;
