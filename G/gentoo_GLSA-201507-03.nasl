...
# extracted from Gentoo Linux Security Advisory GLSA 201507-03.
#
...
if (description)
{
  ...
  script_bugtraq_id(71912);
  script_xref(name:"GLSA", value:"201507-03");

  script_name(english:"GLSA-201507-03 : Exiv2: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201507-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201507-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-gfx/exiv2", unaffected:make_list("ge 0.24-r1"), vulnerable:make_list("lt 0.24-r1"))) flag++;
