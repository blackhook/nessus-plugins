...
# extracted from Gentoo Linux Security Advisory GLSA 200507-21.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200507-21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-mail/fetchmail", unaffected:make_list("ge 6.2.5.2"), vulnerable:make_list("lt 6.2.5.2"))) flag++;
