...
# extracted from Gentoo Linux Security Advisory GLSA 201412-40.
#
...
if (description)
{
  ...
  script_bugtraq_id(71280);
  script_xref(name:"GLSA", value:"201412-40");

  script_name(english:"GLSA-201412-40 : FLAC: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201412-40
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201412-40"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All FLAC users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:flac");
...
if (qpkg_check(package:"media-libs/flac", unaffected:make_list("ge 1.3.1-r1"), vulnerable:make_list("lt 1.3.1-r1"))) flag++;
