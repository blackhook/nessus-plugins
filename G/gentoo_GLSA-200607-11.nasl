...
# extracted from Gentoo Linux Security Advisory GLSA 200607-11.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://tickets.metabrainz.org/ticket/1764"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200607-11"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All tunepimp users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:tunepimp");
...
if (qpkg_check(package:"media-libs/tunepimp", unaffected:make_list("ge 0.5.0"), vulnerable:make_list("le 0.4.2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "TunePimp");
}
