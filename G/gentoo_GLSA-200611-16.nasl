...
# extracted from Gentoo Linux Security Advisory GLSA 200611-16.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200611-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/texinfo", unaffected:make_list("ge 4.8-r5"), vulnerable:make_list("lt 4.8-r5"))) flag++;
