...
# extracted from Gentoo Linux Security Advisory GLSA 200504-06.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200504-06
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.ubuntu.com/support/documentation/usn/usn-104-1"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200504-06"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All sharutils users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:sharutils");
...
if (qpkg_check(package:"app-arch/sharutils", unaffected:make_list("ge 4.2.1-r11"), vulnerable:make_list("lt 4.2.1-r11"))) flag++;
