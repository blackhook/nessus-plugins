...
# extracted from Gentoo Linux Security Advisory GLSA 200704-16.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200704-16"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-wireless/aircrack-ng", unaffected:make_list("ge 0.7-r2"), vulnerable:make_list("lt 0.7-r2"))) flag++;
