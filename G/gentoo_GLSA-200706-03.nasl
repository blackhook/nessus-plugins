...
# extracted from Gentoo Linux Security Advisory GLSA 200706-03.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200706-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200706-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"www-client/elinks", unaffected:make_list("ge 0.11.2-r1"), vulnerable:make_list("lt 0.11.2-r1"))) flag++;
