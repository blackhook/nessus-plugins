...
# extracted from Gentoo Linux Security Advisory GLSA 201001-01.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201001-01");

  script_name(english:"GLSA-201001-01 : NTP: Denial of Service");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201001-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201001-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/ntp", unaffected:make_list("ge 4.2.4_p7-r1"), vulnerable:make_list("lt 4.2.4_p7-r1"))) flag++;
