...
# extracted from Gentoo Linux Security Advisory GLSA 200603-19.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200603-19
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200603-19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"net-misc/curl", unaffected:make_list("rge 7.15.1-r1", "ge 7.15.3", "le 7.14.1"), vulnerable:make_list("lt 7.15.3"))) flag++;
