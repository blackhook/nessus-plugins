...
# extracted from Gentoo Linux Security Advisory GLSA 202008-08.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2020-12400", "CVE-2020-12401", "CVE-2020-12403");
  script_xref(name:"GLSA", value:"202008-08");

  script_name(english:"GLSA-202008-08 : Mozilla Network Security Service (NSS): Multiple vulnerabilities");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-202008-08
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/202008-08"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (qpkg_check(package:"dev-libs/nss", unaffected:make_list("ge 3.55"), vulnerable:make_list("lt 3.55"))) flag++;
