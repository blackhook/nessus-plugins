...
# extracted from Gentoo Linux Security Advisory GLSA 201310-09.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201310-09");

  script_name(english:"GLSA-201310-09 : Setuptools: Man-in-the-Middle attack");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201310-09
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201310-09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"dev-python/setuptools", unaffected:make_list("ge 0.8-r1"), vulnerable:make_list("lt 0.8-r1"))) flag++;
