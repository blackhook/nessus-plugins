...
# extracted from Gentoo Linux Security Advisory GLSA 201207-03.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201207-03");

  script_name(english:"GLSA-201207-03 : ChaSen: User-assisted execution of arbitrary code");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-201207-03
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201207-03"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All ChaSen users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:chasen");
...
if (qpkg_check(package:"app-text/chasen", unaffected:make_list("ge 2.4.4-r2"), vulnerable:make_list("lt 2.4.4-r2"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "ChaSen");
}
