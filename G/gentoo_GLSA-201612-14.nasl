...
# extracted from Gentoo Linux Security Advisory GLSA 201612-14.
#
...
if (description)
{
  ...
  script_xref(name:"GLSA", value:"201612-14");

  script_name(english:"GLSA-201612-14 : util-linux: Arbitrary code execution");
...
(util-linux: Arbitrary code execution)
    ...
    A command injection flaw was discovered in util-linux&rsquo;s &ldquo;blkid&rdquo;
      ...
      However, it does not strip &lsquo;&rdquo;&rsquo; character, so it can be confused to
...
Impact :
    ...
    A local attacker could create a specially crafted partition label
      containing arbitrary code which would get executed when the &ldquo;blkid&rdquo;
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/201612-14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"sys-apps/util-linux", unaffected:make_list("ge 2.26"), vulnerable:make_list("lt 2.26"))) flag++;
