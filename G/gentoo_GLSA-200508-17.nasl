...
# extracted from Gentoo Linux Security Advisory GLSA 200508-17.
#
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://securitytracker.com/id/1014744"
  );
  script_set_attribute(
    attribute:"see_also",
...
if (qpkg_check(package:"dev-libs/libpcre", unaffected:make_list("ge 6.3"), vulnerable:make_list("lt 6.3"))) flag++;
