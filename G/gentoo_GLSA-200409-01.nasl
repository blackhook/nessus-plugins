...
# extracted from Gentoo Linux Security Advisory GLSA 200409-01.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200409-01
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/p/legacy_/forum/forum.php?forum_id=400873"
  );
  # http://www.securityfocus.com/archive/1/371913/2004-08-15/2004-08-21/0
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/archive/1/371913/2004-08-15/2004-08-21/0"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200409-01"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"All vpopmail users should upgrade to the latest version:
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:gentoo:linux:vpopmail");
...
if (qpkg_check(package:"net-mail/vpopmail", unaffected:make_list("ge 5.4.6"), vulnerable:make_list("lt 5.4.6"))) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "vpopmail");
}
