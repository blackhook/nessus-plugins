...
# extracted from Gentoo Linux Security Advisory GLSA 200407-23.
#
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The remote host is affected by the vulnerability described in GLSA-200407-23
...
Workaround :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22afc462"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://security.gentoo.org/glsa/200407-23"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (qpkg_check(package:"media-sound/sox", unaffected:make_list("ge 12.17.4-r2"), vulnerable:make_list("le 12.17.4-r1"))) flag++;
