...
if (description)
{
  ...
  script_name(english:"ISC BIND 9.9.4-S1 < 9.16.33-S1 / 9.8.4 < 9.16.33 / 9.16.8-S1 < 9.16.33-S1 Memory Exhaustion (cve-2022-38177)");

  script_set_attribute(attribute:"synopsis", value:
"The remote name server is affected by a memory exhaustion vulnerability vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of ISC BIND installed on the remote host is prior to tested version. It is, therefore, affected by a
vulnerability as referenced in the cve-2022-38177 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kb.isc.org/v1/docs/cve-2022-38177");
  script_set_attribute(attribute:"solution", value:
"Upgrade to ISC BIND version 9.16.33 / 9.16.33-S1 or later.");
...
var constraints = [
  { 'min_version' : '9.9.4-S1', 'max_version' : '9.11.37-S1', 'fixed_version' : '9.16.33-S1' },
  { 'min_version' : '9.8.4', 'max_version' : '9.16.32', 'fixed_version' : '9.16.33' },
  { 'min_version' : '9.16.8-S1', 'max_version' : '9.16.32-S1', 'fixed_version' : '9.16.33-S1' }
];
