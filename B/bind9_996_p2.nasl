...
if (description)
{
  ...
  script_name(english:"ISC BIND 9.7.0.x < 9.9.6-P2 DNSSEC Validation DoS");
...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://kb.isc.org/article/AA-01245/0/BIND-9.9.6-P2-Release-Notes.html");
...
# Vuln 9.7.0.x < 9.9.6-P2
# per https://kb.isc.org/docs/aa-01235
if (
  ver =~ "^9\.[78]($|[^0-9])"     ||
  ver =~ "^9\.9\.[0-5]($|[^0-9])" ||
  ver =~ "^9\.9\.6($|([ab][12]|rc[12]|-P1)$)"
)
{
