...
scripts by prefixing the path to the .jsp files by /*.shtml/" );
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2000/Jul/411" );
...
script_copyright(english:"This script is (C) 2003-2021 Tenable Network Security, Inc.");
