...
when handling certain sequences of recursive queries.");
  script_set_attribute(attribute:"see_also", value:"https://marc.info/?l=bind-users&m=117781099030155&w=2");
  ...
  script_set_attribute(attribute:"see_also", value:"https://marc.info/?l=bind-announce&m=117798912418849&w=2" );
