...
programmatically or via a network utility like netcat.");
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2000/Apr/47");
 ...
 script_copyright(english:"This script is Copyright (C) 2000-2021 Roelof Temmingh <roelof@sensepost.com>");
