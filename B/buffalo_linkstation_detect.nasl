...
with an embedded web server.");
  script_set_attribute(attribute:"see_also", value:"https://www.buffalotech.com/products/category/network-attached-storage-nas");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/h:buffalo:linkstation");
