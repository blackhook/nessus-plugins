...
if (description)
{
  ...
  script_name(english:"ISC BIND 9.18.0 < 9.18.7 / 9.19.0 < 9.19.5 Memory Exhaustion (cve-2022-2906)");
...
vulnerability as referenced in the cve-2022-2906 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://kb.isc.org/v1/docs/cve-2022-2906");
  script_set_attribute(attribute:"solution", value:
"Upgrade to ISC BIND version 9.18.7 / 9.19.5 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-2906");
...
var constraints = [
  { 'min_version' : '9.18.0', 'max_version' : '9.18.6', 'fixed_version' : '9.18.7' },
  { 'min_version' : '9.19.0', 'max_version' : '9.19.4', 'fixed_version' : '9.19.5' }
];
