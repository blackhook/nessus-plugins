...
configured to use its own authentication system.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2007/Jun/31");
  # http://secureideas.cvs.sourceforge.net/secureideas/base-php4/base_main.php?revision=1.52&view=markup
