...
request." );
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2002/Apr/422" );
...
script_copyright(english:"This script is (C) 2002-2021 Tenable Network Security, Inc.");
