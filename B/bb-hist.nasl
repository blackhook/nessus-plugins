...
information from the system." );
 script_set_attribute(
   attribute:"see_also",
   value:"https://seclists.org/bugtraq/1999/Apr/251"
 );
 script_set_attribute(
   attribute:"solution", 
 ...
 script_copyright("This script is Copyright (C) 1999-2021 and is owned by Tenable, Inc. or an Affiliate thereof."); 
