...
cross-site scripting, and arbitrary command execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.bugzilla.org/security/2.16/");
  script_set_attribute(attribute:"see_also", value:"https://www.bugzilla.org/security/2.16.1/");
  script_set_attribute(attribute:"see_also", value:"https://www.bugzilla.org/security/2.16.1-nr/");
