...
and IMAP and powered by MySQL.");
  script_set_attribute(attribute:"see_also", value:"https://sourceforge.net/projects/basilix/");
...
"n/a");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:basilix:basilix_webmail");
