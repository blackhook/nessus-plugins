...
authentication and gain access to the application.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2009/Jun/217");
  script_set_attribute(attribute:"solution", value:
"Upgrade to BASE version 1.2.5 as that reportedly addresses the issue.");
