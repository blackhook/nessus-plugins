...
host.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/beanstalkd/beanstalkd/wiki");
  ...
  script_set_attribute(attribute:"see_also", value:"https://github.com/beanstalkd/beanstalkd/blob/v1.3/doc/protocol.txt");
...
localhost, consider limiting incoming traffic to this port.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:wildbit:beanstalkd");
