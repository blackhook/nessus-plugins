...
# extracted from Fedora Security Advisory FEDORA-2016-8e4e733bef.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : systemd (2016-8e4e733bef)");
  ...
  script_set_attribute(
    ...
    value:
"Fix for the assertion failure on empty notification message
(#1380287).
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-8e4e733bef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"systemd-222-17.fc23")) flag++;
