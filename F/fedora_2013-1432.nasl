...
# extracted from Fedora Security Advisory 2013-1432.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-1432");

  script_name(english:"Fedora 16 : seamonkey-2.15.1-1.fc16 (2013-1432)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-February/098093.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f58940f5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"seamonkey-2.15.1-1.fc16")) flag++;
