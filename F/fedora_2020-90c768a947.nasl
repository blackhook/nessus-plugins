...
# extracted from Fedora Security Advisory FEDORA-2020-90c768a947.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : libxslt (2020-90c768a947)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-90c768a947"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libxslt-1.1.34-1.fc31")) flag++;
