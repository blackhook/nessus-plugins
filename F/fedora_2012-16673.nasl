...
# extracted from Fedora Security Advisory 2012-16673.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16673");

  script_name(english:"Fedora 16 : viewvc-1.1.17-1.fc16 (2012-16673)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091075.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0dd84c3b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"viewvc-1.1.17-1.fc16")) flag++;
