...
# extracted from Fedora Security Advisory FEDORA-2016-68b71978a1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-68b71978a1");

  script_name(english:"Fedora 23 : xen (2016-68b71978a1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-68b71978a1"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"xen-4.5.5-4.fc23")) flag++;
