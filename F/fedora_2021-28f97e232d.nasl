...
# extracted from Fedora Security Advisory FEDORA-2021-28f97e232d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-28f97e232d");

  script_name(english:"Fedora 33 : 32:bind (2021-28f97e232d)");
...
FEDORA-2021-28f97e232d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-28f97e232d");
...
pkgs = [
    {'reference':'bind-9.11.28-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
];
