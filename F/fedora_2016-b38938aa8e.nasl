...
# extracted from Fedora Security Advisory FEDORA-2016-b38938aa8e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b38938aa8e");

  script_name(english:"Fedora 24 : haproxy (2016-b38938aa8e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-b38938aa8e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"haproxy-1.6.5-3.fc24")) flag++;
