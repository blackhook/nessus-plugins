...
# extracted from Fedora Security Advisory 2014-14069.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : pidgin-2.10.10-1.fc20 (2014-14069)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 2.10.10 Security fix for CVE-2014-3694, CVE-2014-3695,
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/143310.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?11c4c088"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"pidgin-2.10.10-1.fc20")) flag++;
