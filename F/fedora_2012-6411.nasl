...
# extracted from Fedora Security Advisory 2012-6411.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-6411");

  script_name(english:"Fedora 16 : nginx-1.0.15-1.fc16 (2012-6411)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/079467.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?424d3439"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"nginx-1.0.15-1.fc16")) flag++;
