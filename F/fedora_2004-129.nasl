...
# extracted from Fedora Security Advisory 2004-129.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-129");

  script_name(english:"Fedora Core 1 : neon-0.24.5-2.1 (2004-129)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-May/000129.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f5b7c541"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", reference:"neon-0.24.5-2.1")) flag++;
if (rpm_check(release:"FC1", reference:"neon-debuginfo-0.24.5-2.1")) flag++;
if (rpm_check(release:"FC1", reference:"neon-devel-0.24.5-2.1")) flag++;
