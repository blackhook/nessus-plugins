...
# extracted from Fedora Security Advisory FEDORA-2017-8308bc2a6e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-8308bc2a6e");

  script_name(english:"Fedora 24 : pdns-recursor (2017-8308bc2a6e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-8308bc2a6e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"pdns-recursor-4.0.4-1.fc24")) flag++;
