...
# extracted from Fedora Security Advisory 2016-1ab53bf440.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-1ab53bf440");

  script_name(english:"Fedora 22 : bind-9.10.3-8.P3.fc22 (2016-1ab53bf440)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a9e60114"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"bind-9.10.3-8.P3.fc22")) flag++;
