...
# extracted from Fedora Security Advisory 2006-867.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-867");

  script_name(english:"Fedora Core 4 : gnupg-1.4.5-1 (2006-867)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-August/000481.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e10781e6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"gnupg-1.4.5-1")) flag++;
if (rpm_check(release:"FC4", reference:"gnupg-debuginfo-1.4.5-1")) flag++;
