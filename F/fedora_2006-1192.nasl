...
# extracted from Fedora Security Advisory 2006-1192.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1192");

  script_name(english:"Fedora Core 6 : thunderbird-1.5.0.8-1.fc6 (2006-1192)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-November/000838.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?57dce7aa"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"thunderbird-1.5.0.8-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"thunderbird-debuginfo-1.5.0.8-1.fc6")) flag++;
