...
# extracted from Fedora Security Advisory FEDORA-2017-270ab2baa3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-270ab2baa3");

  script_name(english:"Fedora 25 : glibc (2017-270ab2baa3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-270ab2baa3"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"glibc-2.24-10.fc25")) flag++;
