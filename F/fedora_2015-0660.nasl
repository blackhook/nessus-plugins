...
# extracted from Fedora Security Advisory 2015-0660.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : libsndfile-1.0.25-14.fc21 (2015-0660)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1177254"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148432.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4ee33664"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"libsndfile-1.0.25-14.fc21")) flag++;
