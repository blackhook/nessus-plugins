...
# extracted from Fedora Security Advisory FEDORA-2017-09b1c3f099.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-09b1c3f099");

  script_name(english:"Fedora 27 : libidn2 (2017-09b1c3f099)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-09b1c3f099"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libidn2 package."
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libidn2-2.0.4-1.fc27")) flag++;
