...
# extracted from Fedora Security Advisory 2013-20814.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : ReviewBoard-1.7.18-1.fc19 / python-djblets-0.7.23-1.fc19 (2013-20814)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/121922.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?96b95434"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/121923.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f4c3db4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"ReviewBoard-1.7.18-1.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"python-djblets-0.7.23-1.fc19")) flag++;
