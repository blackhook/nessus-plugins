...
# extracted from Fedora Security Advisory FEDORA-2016-e8a8561ee7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : ntp (2016-e8a8561ee7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e8a8561ee7"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"ntp-4.2.6p5-43.fc23")) flag++;
