...
# extracted from Fedora Security Advisory 2013-12075.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12075");

  script_name(english:"Fedora 17 : gegl-0.2.0-11.fc17 (2013-12075)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111228.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4468226f"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gegl-0.2.0-11.fc17")) flag++;
