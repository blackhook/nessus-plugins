...
# extracted from Fedora Security Advisory 2015-1267.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1267");

  script_name(english:"Fedora 20 : unzip-6.0-15.fc20 (2015-1267)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148849.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?352d7e19"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"unzip-6.0-15.fc20")) flag++;
