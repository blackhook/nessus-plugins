...
# extracted from Fedora Security Advisory FEDORA-2016-372b6f936e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : xguest (2016-372b6f936e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-372b6f936e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected xguest package."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:xguest");
...
flag = 0;
if (rpm_check(release:"FC24", reference:"xguest-1.0.10-34.fc24")) flag++;
