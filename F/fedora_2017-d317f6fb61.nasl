...
# extracted from Fedora Security Advisory FEDORA-2017-d317f6fb61.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d317f6fb61");

  script_name(english:"Fedora 24 : webkitgtk4 (2017-d317f6fb61)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d317f6fb61"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"webkitgtk4-2.14.3-1.fc24")) flag++;
