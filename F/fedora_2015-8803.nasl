...
# extracted from Fedora Security Advisory 2015-8803.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8803");

  script_name(english:"Fedora 22 : batik-1.8-0.18.svn1230816.fc22 (2015-8803)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159375.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3ad2824d"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"batik-1.8-0.18.svn1230816.fc22")) flag++;
