...
# extracted from Fedora Security Advisory 2011-10718.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-10718");

  script_name(english:"Fedora 14 : ecryptfs-utils-90-1.fc14 (2011-10718)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/065061.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?17111c06"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"ecryptfs-utils-90-1.fc14")) flag++;
