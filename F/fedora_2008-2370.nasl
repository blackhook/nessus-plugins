...
# extracted from Fedora Security Advisory 2008-2370.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : roundup-1.4.4-1.fc7 (2008-2370)");
  ...
  script_set_attribute(
    ...
    value:
"  - Bug #436546 - Roundup 1.4.4 contains some sekrit
    security fixes
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-March/008603.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2f2beb11"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"roundup-1.4.4-1.fc7")) flag++;
