...
# extracted from Fedora Security Advisory 2012-1709.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-1709");

  script_name(english:"Fedora 16 : apr-1.4.6-1.fc16 (2012-1709)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=781606"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-March/074089.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?13bd74ee"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"apr-1.4.6-1.fc16")) flag++;
