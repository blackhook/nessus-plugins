...
# extracted from Fedora Security Advisory 2005-771.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-771");

  script_name(english:"Fedora Core 3 : slocate-2.7-12.fc3.1 (2005-771)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001272.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?af41ab55"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"slocate-2.7-12.fc3.1")) flag++;
if (rpm_check(release:"FC3", reference:"slocate-debuginfo-2.7-12.fc3.1")) flag++;
