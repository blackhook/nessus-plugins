...
# extracted from Fedora Security Advisory FEDORA-2019-0bf4c4c4ed.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-0bf4c4c4ed");

  script_name(english:"Fedora 30 : wordpress (2019-0bf4c4c4ed)");
...
Release](https://wordpress.org/news/2019/03/wordpress-5-1-1-security-a
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0bf4c4c4ed"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"wordpress-5.1.1-1.fc30")) flag++;
