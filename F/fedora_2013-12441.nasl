...
# extracted from Fedora Security Advisory 2013-12441.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12441");

  script_name(english:"Fedora 17 : gallery3-3.0.9-1.fc17 (2013-12441)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111660.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d0462831"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gallery3-3.0.9-1.fc17")) flag++;
