...
# extracted from Fedora Security Advisory 2012-19664.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-19664");

  script_name(english:"Fedora 18 : bogofilter-1.2.3-1.fc18 (2012-19664)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/096299.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?747a9498"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"bogofilter-1.2.3-1.fc18")) flag++;
