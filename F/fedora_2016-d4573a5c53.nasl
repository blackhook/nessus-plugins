...
# extracted from Fedora Security Advisory FEDORA-2016-d4573a5c53.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : p7zip (2016-d4573a5c53)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-d4573a5c53"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"p7zip-16.02-2.fc24")) flag++;
