...
# extracted from Fedora Security Advisory FEDORA-2017-b444c3b9c5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b444c3b9c5");

  script_name(english:"Fedora 27 : libwmf (2017-b444c3b9c5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b444c3b9c5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libwmf-0.2.8.4-53.fc27")) flag++;
