...
# extracted from Fedora Security Advisory 2008-4679.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : samba-3.0.30-0.fc8 (2008-4679)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-May/010658.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?900a6d93"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"samba-3.0.30-0.fc8")) flag++;
