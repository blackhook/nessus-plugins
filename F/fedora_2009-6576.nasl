...
# extracted from Fedora Security Advisory 2009-6576.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6576");

  script_name(english:"Fedora 11 : moin-1.8.4-1.fc11 (2009-6576)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025202.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8475d926"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"moin-1.8.4-1.fc11")) flag++;
