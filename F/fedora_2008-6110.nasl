...
# extracted from Fedora Security Advisory 2008-6110.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : pcre-7.3-4.fc9 (2008-6110)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-July/012061.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0ae4f1bc"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"pcre-7.3-4.fc9")) flag++;
