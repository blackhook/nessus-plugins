...
# extracted from Fedora Security Advisory 2013-12115.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12115");

  script_name(english:"Fedora 19 : gegl-0.2.0-11.fc19 (2013-12115)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111249.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?81350d6a"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"gegl-0.2.0-11.fc19")) flag++;
