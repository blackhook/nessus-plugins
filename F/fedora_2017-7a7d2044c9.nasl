...
# extracted from Fedora Security Advisory FEDORA-2017-7a7d2044c9.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-10327", "CVE-2017-7856", "CVE-2017-7870");
  script_xref(name:"FEDORA", value:"2017-7a7d2044c9");

  script_name(english:"Fedora 24 : 1:libreoffice (2017-7a7d2044c9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7a7d2044c9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libreoffice-5.1.6.2-8.fc24", epoch:"1")) flag++;
