...
# extracted from Fedora Security Advisory 2005-123.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-123");

  script_name(english:"Fedora Core 3 : cups-1.1.22-0.rc1.8.5 (2005-123)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000684.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7b578bb"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"cups-1.1.22-0.rc1.8.5")) flag++;
if (rpm_check(release:"FC3", reference:"cups-debuginfo-1.1.22-0.rc1.8.5")) flag++;
if (rpm_check(release:"FC3", reference:"cups-devel-1.1.22-0.rc1.8.5")) flag++;
if (rpm_check(release:"FC3", reference:"cups-libs-1.1.22-0.rc1.8.5")) flag++;
