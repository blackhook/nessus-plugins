...
# extracted from F5 Networks BIG-IP Solution K20804323.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K20804323)");
...
Using a crafted packet to create a peer association with hmode > 7
causes the MATCH_ASSOC() lookup to make an out-of-bounds reference."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K20804323"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
