...
# extracted from Fedora Security Advisory 2012-14664.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14664");

  script_name(english:"Fedora 18 : openjpeg-1.5.0-5.fc18 (2012-14664)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090021.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?56a9febb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"openjpeg-1.5.0-5.fc18")) flag++;
