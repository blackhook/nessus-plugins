...
# extracted from Fedora Security Advisory FEDORA-2016-7a2ed52d41.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-7a2ed52d41");

  script_name(english:"Fedora 24 : curl (2016-7a2ed52d41)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-7a2ed52d41"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"curl-7.47.1-8.fc24")) flag++;
