...
# extracted from Fedora Security Advisory FEDORA-2017-6aff7475b7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : ansible (2017-6aff7475b7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6aff7475b7"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"ansible-2.3.1.0-1.fc24")) flag++;
