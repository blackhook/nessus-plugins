...
# extracted from Fedora Security Advisory 2013-15013.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 18 : poppler-0.20.2-16.fc18 (2013-15013)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes a problem with escaping of error messages
(CVE-2012-2142).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2deb8b86"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"poppler-0.20.2-16.fc18")) flag++;
