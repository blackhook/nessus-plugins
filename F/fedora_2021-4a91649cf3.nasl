...
# extracted from Fedora Security Advisory FEDORA-2021-4a91649cf3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-4a91649cf3");

  script_name(english:"Fedora 33 : tcmu-runner (2021-4a91649cf3)");
...
FEDORA-2021-4a91649cf3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-4a91649cf3");
...
"Update the affected tcmu-runner package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:tcmu-runner");
...
pkgs = [
    {'reference':'tcmu-runner-1.5.2-7.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
