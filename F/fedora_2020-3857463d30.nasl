...
# extracted from Fedora Security Advisory FEDORA-2020-3857463d30.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:NetworkManager (2020-3857463d30)");
...
"  - Update to 1.22.14 release
  ...
  - ifcfg-rh: handle '802-1x.{,phase2-}ca-path'
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-3857463d30"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"NetworkManager-1.22.14-1.fc32", epoch:"1")) flag++;
