...
# extracted from Fedora Security Advisory 2015-d8253e2b1d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-d8253e2b1d");

  script_name(english:"Fedora 23 : xen-4.5.2-6.fc23 (2015-d8253e2b1d)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-December/174288.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cb79bcf5"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"xen-4.5.2-6.fc23")) flag++;
