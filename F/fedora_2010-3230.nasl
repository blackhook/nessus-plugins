...
# extracted from Fedora Security Advisory 2010-3230.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : sunbird-1.0-0.19.20090916hg.fc12 / thunderbird-3.0.2-1.fc12 (2010-3230)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/036097.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?164c87aa"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/036098.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ff36ec68"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"sunbird-1.0-0.19.20090916hg.fc12")) flag++;
if (rpm_check(release:"FC12", reference:"thunderbird-3.0.2-1.fc12")) flag++;
