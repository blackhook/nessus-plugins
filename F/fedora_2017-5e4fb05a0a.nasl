...
# extracted from Fedora Security Advisory FEDORA-2017-5e4fb05a0a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : elfutils (2017-5e4fb05a0a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-5e4fb05a0a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"elfutils-0.169-1.fc25")) flag++;
