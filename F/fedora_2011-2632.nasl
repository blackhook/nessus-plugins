...
# extracted from Fedora Security Advisory 2011-2632.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : wireshark-1.4.4-1.fc14 (2011-2632)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a819ad00"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"wireshark-1.4.4-1.fc14")) flag++;
