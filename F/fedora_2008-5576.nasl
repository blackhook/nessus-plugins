...
# extracted from Fedora Security Advisory 2008-5576.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : gallery2-2.2.5-1.fc9 (2008-5576)");
...
"  - Wed Jun 18 2008 John Berninger <john at ncphotography
    ...
    - Tue Apr 22 2008 John Berninger <john at ncphotography
      dot com> - 2.2.4-4

    - update version for tag conflict due to devel build
      prior to update of cvs checkout
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-June/011579.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fad9b69d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"gallery2-2.2.5-1.fc9")) flag++;
