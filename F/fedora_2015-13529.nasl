...
# extracted from Fedora Security Advisory 2015-13529.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : php-ZendFramework2-2.4.7-1.fc22 / php-guzzle-Guzzle-3.9.3-5.fc22 (2015-13529)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-August/165146.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22288d75"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-August/165147.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f8cf0c9f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC22", reference:"php-ZendFramework2-2.4.7-1.fc22")) flag++;
if (rpm_check(release:"FC22", reference:"php-guzzle-Guzzle-3.9.3-5.fc22")) flag++;
