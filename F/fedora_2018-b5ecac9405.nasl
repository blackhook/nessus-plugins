...
# extracted from Fedora Security Advisory FEDORA-2018-b5ecac9405.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-b5ecac9405");

  script_name(english:"Fedora 26 : flatpak (2018-b5ecac9405)");
...
Major changes in 0.10.3
  ...
  - Make permission handling ignore unknown permissions for
    forwards compatibility

  - Removed incorrect error message in update --appdata when
    ther was no updates
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b5ecac9405"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"flatpak-0.10.3-1.fc26")) flag++;
