...
# extracted from Fedora Security Advisory 2011-3033.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3033");

  script_name(english:"Fedora 15 : avahi-0.6.29-1.fc15 (2011-3033)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/055858.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4ad5586d"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"avahi-0.6.29-1.fc15")) flag++;
