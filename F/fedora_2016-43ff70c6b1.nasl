...
# extracted from Fedora Security Advisory FEDORA-2016-43ff70c6b1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-43ff70c6b1");

  script_name(english:"Fedora 25 : 1:nodejs (2016-43ff70c6b1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-43ff70c6b1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"nodejs-6.7.0-107.fc25", epoch:"1")) flag++;
