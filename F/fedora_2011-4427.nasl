...
# extracted from Fedora Security Advisory 2011-4427.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-4427");

  script_name(english:"Fedora 13 : rsync-3.0.8-1.fc13 (2011-4427)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?54a2c35a"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"rsync-3.0.8-1.fc13")) flag++;
