...
# extracted from Fedora Security Advisory FEDORA-2018-cd4311d4d6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : p7zip (2018-cd4311d4d6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-cd4311d4d6"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"p7zip-16.02-9.fc26")) flag++;
