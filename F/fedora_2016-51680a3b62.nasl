...
# extracted from Fedora Security Advisory FEDORA-2016-51680a3b62.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-51680a3b62");

  script_name(english:"Fedora 23 : mbedtls (2016-51680a3b62)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-51680a3b62"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mbedtls-2.3.0-1.fc23")) flag++;
