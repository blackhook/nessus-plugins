...
# extracted from Fedora Security Advisory FEDORA-2016-ed5f606dde.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-ed5f606dde");

  script_name(english:"Fedora 23 : drupal7-views (2016-ed5f606dde)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-ed5f606dde"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"drupal7-views-3.14-1.fc23")) flag++;
