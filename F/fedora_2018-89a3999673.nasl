...
# extracted from Fedora Security Advisory FEDORA-2018-89a3999673.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : rpm (2018-89a3999673)");
...
by using &ndash;setperms, &ndash;setugids or &ndash;restore with rpm
4.14.2, it merely fixes the functionlity itself. Any damage needs to
be investigated and fixed manually, such as using &ndash;verify and
&ndash;restore or reinstalling packages.**
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-89a3999673"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"rpm-4.14.2.1-1.fc29")) flag++;
