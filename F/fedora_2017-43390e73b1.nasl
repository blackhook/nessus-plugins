...
# extracted from Fedora Security Advisory FEDORA-2017-43390e73b1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-43390e73b1");

  script_name(english:"Fedora 26 : mingw-openjpeg2 (2017-43390e73b1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-43390e73b1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-openjpeg2-2.2.0-3.fc26")) flag++;
