...
# extracted from Fedora Security Advisory 2009-7435.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-7435");

  script_name(english:"Fedora 11 : perl-IO-Socket-SSL-1.26-1.fc11 (2009-7435)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026559.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4ad29fba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"perl-IO-Socket-SSL-1.26-1.fc11")) flag++;
