...
# extracted from Fedora Security Advisory FEDORA-2017-abb54caee2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-abb54caee2");

  script_name(english:"Fedora 27 : pure-ftpd (2017-abb54caee2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-abb54caee2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"pure-ftpd-1.0.46-2.fc27")) flag++;
