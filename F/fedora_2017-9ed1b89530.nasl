...
# extracted from Fedora Security Advisory FEDORA-2017-9ed1b89530.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-9ed1b89530");

  script_name(english:"Fedora 25 : mbedtls (2017-9ed1b89530)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9ed1b89530"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mbedtls-2.4.2-1.fc25")) flag++;
