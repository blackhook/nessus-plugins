...
# extracted from Fedora Security Advisory FEDORA-2020-caf7f7d0d9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-caf7f7d0d9");

  script_name(english:"Fedora 31 : ansible (2020-caf7f7d0d9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-caf7f7d0d9"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"ansible-2.9.3-1.fc31")) flag++;
