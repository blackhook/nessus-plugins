...
# extracted from Fedora Security Advisory FEDORA-2016-0049aa6e5d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0049aa6e5d");
  script_xref(name:"IAVB", value:"2016-B-0118-S");

  script_name(english:"Fedora 23 : xen (2016-0049aa6e5d) (Bunker Buster)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0049aa6e5d"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"xen-4.5.3-9.fc23")) flag++;
