...
# extracted from Fedora Security Advisory FEDORA-2016-861b8c46b7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : 1:nodejs (2016-861b8c46b7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-861b8c46b7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"nodejs-4.6.0-5.fc24", epoch:"1")) flag++;
