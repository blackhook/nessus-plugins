...
# extracted from Fedora Security Advisory FEDORA-2017-7bd193c0ed.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-7bd193c0ed");

  script_name(english:"Fedora 27 : libzip (2017-7bd193c0ed)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7bd193c0ed"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libzip-1.3.0-1.fc27")) flag++;
