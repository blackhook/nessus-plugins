...
# extracted from Fedora Security Advisory 2014-3534.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-3534");

  script_name(english:"Fedora 20 : php-5.5.10-1.fc20 (2014-3534)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-March/129639.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?14a9c3f9"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC20", reference:"php-5.5.10-1.fc20")) flag++;
