...
# extracted from Fedora Security Advisory FEDORA-2017-23535a31f8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-23535a31f8");
  script_xref(name:"TRA", value:"TRA-2017-10");

  script_name(english:"Fedora 26 : libupnp (2017-23535a31f8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-23535a31f8"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libupnp-1.6.21-1.fc26")) flag++;
