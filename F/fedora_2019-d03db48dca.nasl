...
# extracted from Fedora Security Advisory FEDORA-2019-d03db48dca.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 1:java-1.8.0-openjdk (2019-d03db48dca)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d03db48dca"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"java-1.8.0-openjdk-1.8.0.232.b09-0.fc30", epoch:"1")) flag++;
