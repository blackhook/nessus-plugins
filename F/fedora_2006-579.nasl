...
# extracted from Fedora Security Advisory 2006-579.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-579");

  script_name(english:"Fedora Core 4 : postgresql-8.0.8-1.FC4.1 (2006-579)");
...
"  - Mon May 22 2006 Tom Lane <tgl at redhat.com>
    ...
    - Update to PostgreSQL 8.0.8 (includes fixes for
  ...
  - Update to jdbc driver build 316
    ...
    - Repair extraneous quote in pgtcl configure script ...
      odd that bash didn't use to spit up on this.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000116.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9f90309a"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"postgresql-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-contrib-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-debuginfo-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-devel-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-docs-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-jdbc-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-libs-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-pl-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-python-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-server-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-tcl-8.0.8-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"postgresql-test-8.0.8-1.FC4.1")) flag++;
