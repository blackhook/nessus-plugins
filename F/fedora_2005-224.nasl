...
# extracted from Fedora Security Advisory 2005-224.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-224");

  script_name(english:"Fedora Core 2 : sylpheed-1.0.3-0.FC2 (2005-224)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Mar 17 2005 Akira TAGOH <tagoh at redhat.com> -
    1.0.3-0.FC2
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000773.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a36ea262"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"sylpheed-1.0.3-0.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"sylpheed-debuginfo-1.0.3-0.FC2")) flag++;
