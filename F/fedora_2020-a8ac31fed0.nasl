...
# extracted from Fedora Security Advisory FEDORA-2020-a8ac31fed0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mediawiki (2020-a8ac31fed0)");
  ...
  script_set_attribute(
    ...
    value:
"https://lists.wikimedia.org/pipermail/mediawiki-announce/2019-December
/000243.html
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a8ac31fed0"
  );
  # https://lists.wikimedia.org/pipermail/mediawiki-announce/2019-December/000243.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c8b56ec0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mediawiki-1.32.6-1.fc31")) flag++;
