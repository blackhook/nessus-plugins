...
# extracted from Fedora Security Advisory 2005-407.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-407");

  script_name(english:"Fedora Core 4 : tcpdump-3.8.2-13.FC4 (2005-407)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Jun 7 2005 Martin Stransky <stransky at redhat.com>
    - 14:3.8.2-13.FC4
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-June/000939.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b299823e"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"arpwatch-2.1a13-13.FC4")) flag++;
if (rpm_check(release:"FC4", reference:"libpcap-0.8.3-13.FC4")) flag++;
if (rpm_check(release:"FC4", reference:"tcpdump-3.8.2-13.FC4")) flag++;
if (rpm_check(release:"FC4", reference:"tcpdump-debuginfo-3.8.2-13.FC4")) flag++;
