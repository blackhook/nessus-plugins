...
# extracted from Fedora Security Advisory FEDORA-2020-54760174b6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : dnsmasq (2020-54760174b6)");
  ...
  script_set_attribute(
    ...
    value:
"Make dnsmasq listen in default configuration only on localhost device.
bind-dynamic is not required, because localhost should not change
during the life of dnsmasq.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-54760174b6"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"dnsmasq-2.82-3.fc33")) flag++;
