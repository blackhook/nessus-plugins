...
# extracted from Fedora Security Advisory FEDORA-2016-2d90e27e50.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : python-cryptography / python-cryptography-vectors (2016-2d90e27e50)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-2d90e27e50"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC25", reference:"python-cryptography-1.5.3-3.fc25")) flag++;
if (rpm_check(release:"FC25", reference:"python-cryptography-vectors-1.5.3-1.fc25")) flag++;
