...
# extracted from Fedora Security Advisory 2012-15194.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-15194");

  script_name(english:"Fedora 17 : qt-4.8.2-7.fc17 (2012-15194)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/089815.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb48c497"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"qt-4.8.2-7.fc17")) flag++;
