...
# extracted from Fedora Security Advisory 2014-15967.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15967");

  script_name(english:"Fedora 21 : couchdb-1.6.1-4.fc21 (2014-15967)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145821.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4b58d4c4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"couchdb-1.6.1-4.fc21")) flag++;
