...
# extracted from Fedora Security Advisory 2008-5143.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : openoffice.org-2.4.1-17.3.fc9 (2008-5143)");
  ...
  script_set_attribute(
    ...
    value:
"Update to upstream version 2.4.1 to fix a range of reported problems
and a security issue CVE-2008-2152:
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.openoffice.org/security/cves/CVE-2008-2152.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=450518"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-June/011128.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a9f00619"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"openoffice.org-2.4.1-17.3.fc9")) flag++;
