...
# extracted from Fedora Security Advisory 2004-176.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-176");

  script_name(english:"Fedora Core 2 : libpng10-1.0.15-5 (2004-176)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000178.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c46a400"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"libpng10-1.0.15-5")) flag++;
if (rpm_check(release:"FC2", reference:"libpng10-debuginfo-1.0.15-5")) flag++;
if (rpm_check(release:"FC2", reference:"libpng10-devel-1.0.15-5")) flag++;
