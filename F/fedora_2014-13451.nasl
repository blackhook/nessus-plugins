...
# extracted from Fedora Security Advisory 2014-13451.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13451");

  script_name(english:"Fedora 19 : webkitgtk3-2.0.4-4.fc19 (2014-13451)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/142720.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9ff97be7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"webkitgtk3-2.0.4-4.fc19")) flag++;
