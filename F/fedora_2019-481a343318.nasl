...
# extracted from Fedora Security Advisory FEDORA-2019-481a343318.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : nss (2019-481a343318)");
...
https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.44
_release_notes
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-481a343318"
  );
  # https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.44_release_notes
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39550b0c"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"nss-3.44.0-2.fc30")) flag++;
