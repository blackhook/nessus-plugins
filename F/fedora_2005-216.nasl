...
# extracted from Fedora Security Advisory 2005-216.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-216");

  script_name(english:"Fedora Core 2 : ipsec-tools-0.5-2.fc2 (2005-216)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000760.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3294e86d"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"ipsec-tools-0.5-2.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"ipsec-tools-debuginfo-0.5-2.fc2")) flag++;
