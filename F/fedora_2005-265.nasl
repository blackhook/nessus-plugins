...
# extracted from Fedora Security Advisory 2005-265.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-265");

  script_name(english:"Fedora Core 2 : gdk-pixbuf-0.22.0-12.fc2 (2005-265)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000826.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c7964b28"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", cpu:"i386", reference:"gdk-pixbuf-0.22.0-12.fc2")) flag++;
