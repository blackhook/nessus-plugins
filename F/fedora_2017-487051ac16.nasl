...
# extracted from Fedora Security Advisory FEDORA-2017-487051ac16.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6060");
  script_xref(name:"FEDORA", value:"2017-487051ac16");

  script_name(english:"Fedora 26 : mupdf (2017-487051ac16)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-487051ac16"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mupdf-1.10a-4.fc26")) flag++;
