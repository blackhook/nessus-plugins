...
# extracted from Fedora Security Advisory FEDORA-2018-5cdc56766f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : firefox (2018-5cdc56766f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5cdc56766f"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.mozilla.org/en-US/firefox/58.0.2/releasenotes/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"firefox-58.0.2-1.fc26")) flag++;
