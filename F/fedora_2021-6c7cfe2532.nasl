...
# extracted from Fedora Security Advisory FEDORA-2021-6c7cfe2532
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-6c7cfe2532");

  script_name(english:"Fedora 32 : suricata (2021-6c7cfe2532)");
...
FEDORA-2021-6c7cfe2532 advisory.

  - Various performance, accuracy and stability issues have been fixed. (FEDORA-2021-6c7cfe2532)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-6c7cfe2532");
...
pkgs = [
    {'reference':'suricata-5.0.6-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
