...
# extracted from Fedora Security Advisory 2015-2872.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-2872");

  script_name(english:"Fedora 22 : gnupg-1.4.19-1.fc22 (2015-2872)");
...
"New upstream v1.4.19
  ...
  - Use ciphertext blinding for Elgamal decryption
    ...
    - Fixed data-dependent timing variations in modular
      exponentiation [related to CVE-2015-0837]
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/151661.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f8d45c62"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"gnupg-1.4.19-1.fc22")) flag++;
