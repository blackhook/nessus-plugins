...
# extracted from Fedora Security Advisory FEDORA-2020-cd9ec9d660.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : community-mysql (2020-cd9ec9d660)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-cd9ec9d660"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://dev.mysql.com/doc/relnotes/mysql/8.0/en/news-8-0-19.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"community-mysql-8.0.19-1.fc30")) flag++;
