...
# extracted from Fedora Security Advisory 2010-12742.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : drupal-6.19-1.fc12 (2010-12742)");
...
without introducing additional issues."
  ...
  # http://drupal.org/drupal-6.19
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b215af9"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/updating-and-upgrading-drupal-core"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://ftp-origin.drupal.org/files/projects/drupal-5.23.tar.gz"
  );
  # http://ftp.drupal.org/files/projects/drupal-6.18.tar.gz
  script_set_attribute(
    attribute:"see_also",
    value:"https://ftp-origin.drupal.org/files/projects/drupal-6.18.tar.gz"
  );
  # http://ftp.drupal.org/files/projects/drupal-6.19.tar.gz
  script_set_attribute(
    attribute:"see_also",
    value:"https://ftp-origin.drupal.org/files/projects/drupal-6.19.tar.gz"
  );
  # http://lists.drupal.org/mailman/listinfo/security-news
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.drupal.org/mailman/listinfo/security-news"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-August/045440.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea616b69"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2010/08/13");
...
flag = 0;
if (rpm_check(release:"FC12", reference:"drupal-6.19-1.fc12")) flag++;
