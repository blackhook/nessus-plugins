...
# extracted from Fedora Security Advisory FEDORA-2016-01198b9f9d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-01198b9f9d");

  script_name(english:"Fedora 22 : cacti (2016-01198b9f9d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-01198b9f9d"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"cacti-0.8.8h-1.fc22")) flag++;
