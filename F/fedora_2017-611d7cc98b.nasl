...
# extracted from Fedora Security Advisory FEDORA-2017-611d7cc98b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-611d7cc98b");

  script_name(english:"Fedora 27 : libextractor (2017-611d7cc98b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-611d7cc98b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libextractor-1.6-1.fc27")) flag++;
