...
# extracted from Fedora Security Advisory 2014-15102.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : moodle-2.5.9-1.fc20 (2014-15102)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144901.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e191a298"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC20", reference:"moodle-2.5.9-1.fc20")) flag++;
