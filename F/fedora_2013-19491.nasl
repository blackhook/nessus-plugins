...
# extracted from Fedora Security Advisory 2013-19491.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-19491");

  script_name(english:"Fedora 18 : libuv-0.10.18-1.fc18 / nodejs-0.10.21-1.fc18 (2013-19491)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1a9a1c54"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119798.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c8331b2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"libuv-0.10.18-1.fc18")) flag++;
if (rpm_check(release:"FC18", reference:"nodejs-0.10.21-1.fc18")) flag++;
