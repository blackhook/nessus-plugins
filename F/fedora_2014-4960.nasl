...
# extracted from Fedora Security Advisory 2014-4960.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-4960");

  script_name(english:"Fedora 19 : jbigkit-2.0-9.fc19 (2014-4960)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/131966.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc051a1f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"jbigkit-2.0-9.fc19")) flag++;
