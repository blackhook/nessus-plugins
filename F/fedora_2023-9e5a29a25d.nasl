...
FEDORA-2023-9e5a29a25d advisory.
  ...
  - GVariant deserialisation does not match spec for non-normal data [fedora-38] (CVE-2023-32665)

  - GVariant offset table entry size is not checked in is_normal() [fedora-38] (CVE-2023-29499)

  - g_variant_byteswap() can take a long time with some non-normal inputs [fedora-38] (CVE-2023-32611)
