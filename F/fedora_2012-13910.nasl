...
# extracted from Fedora Security Advisory 2012-13910.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13910");

  script_name(english:"Fedora 18 : dhcp-4.2.4-15.P2.fc18 (2012-13910)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=856766"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086992.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?89b6b2d1"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"dhcp-4.2.4-15.P2.fc18")) flag++;
