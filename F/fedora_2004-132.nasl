...
# extracted from Fedora Security Advisory 2004-132.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-132");

  script_name(english:"Fedora Core 2 : ipsec-tools-0.2.5-2 (2004-132)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-May/000133.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5526a830"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"ipsec-tools-0.2.5-2")) flag++;
if (rpm_check(release:"FC2", reference:"ipsec-tools-debuginfo-0.2.5-2")) flag++;
