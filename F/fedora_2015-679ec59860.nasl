...
# extracted from Fedora Security Advisory FEDORA-2015-679ec59860.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-679ec59860");

  script_name(english:"Fedora 22 : ca-certificates (2015-679ec59860)");
  ...
  script_set_attribute(
    ...
    value:
"This is an update to the set of CA certificates version 2.5 as
released with NSS version 3.19.3

However, as in previous versions of the ca-certificates package, the
CA list has been modified to keep several legacy CAs still trusted for
compatibility reasons. Please refer to the project URL for details.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2015-679ec59860"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"ca-certificates-2015.2.5-1.0.fc22")) flag++;
