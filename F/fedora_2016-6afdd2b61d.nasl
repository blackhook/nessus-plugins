...
# extracted from Fedora Security Advisory FEDORA-2016-6afdd2b61d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : kernel (2016-6afdd2b61d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-6afdd2b61d"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2016-6afdd2b61d");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC25", reference:"kernel-4.8.11-300.fc25")) flag++;
