...
# extracted from Fedora Security Advisory 2012-0840.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-0840");

  script_name(english:"Fedora 16 : polipo-1.0.4.1-6.fc16 (2012-0840)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/072708.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?471a9181"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"polipo-1.0.4.1-6.fc16")) flag++;
