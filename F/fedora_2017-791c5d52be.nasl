...
# extracted from Fedora Security Advisory FEDORA-2017-791c5d52be.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 2:samba (2017-791c5d52be)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-791c5d52be"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"samba-4.7.3-0.fc27", epoch:"2")) flag++;
