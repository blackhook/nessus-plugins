...
# extracted from Fedora Security Advisory FEDORA-2016-a1e5b2331a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a1e5b2331a");

  script_name(english:"Fedora 25 : mingw-gnutls (2016-a1e5b2331a)");
  ...
  script_set_attribute(
    ...
    value:
"https://lists.gnupg.org/pipermail/gnutls-devel/2016-September/008153.h
tml
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a1e5b2331a"
  );
  # https://lists.gnupg.org/pipermail/gnutls-devel/2016-September/008153.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ae52582e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-gnutls-3.5.4-1.fc25")) flag++;
