...
# extracted from Fedora Security Advisory FEDORA-2017-fe4f93fde4.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-14061");
  script_xref(name:"FEDORA", value:"2017-fe4f93fde4");

  script_name(english:"Fedora 26 : mingw-libidn2 (2017-fe4f93fde4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-fe4f93fde4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-libidn2-2.0.4-1.fc26")) flag++;
