...
# extracted from Fedora Security Advisory FEDORA-2020-42564738a1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-42564738a1");

  script_name(english:"Fedora 31 : mbedtls (2020-42564738a1)");
...
Release notes:
https://tls.mbed.org/tech-updates/releases/mbedtls-2.16.6-and-2.7.15-r
eleased
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-42564738a1"
  );
  # https://tls.mbed.org/tech-updates/security-advisories/mbedtls-security-advisory-2020-04
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b66af52d"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mbedtls-2.16.6-1.fc31")) flag++;
