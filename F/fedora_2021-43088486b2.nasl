...
# extracted from Fedora Security Advisory FEDORA-2021-43088486b2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-43088486b2");

  script_name(english:"Fedora 32 : firefox (2021-43088486b2)");
...
FEDORA-2021-43088486b2 advisory.

  - Stability update for hardware accelerated backend (mozbz#1694670).  ----  New upstream version (86.0)
    (FEDORA-2021-43088486b2)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-43088486b2");
...
pkgs = [
    {'reference':'firefox-86.0-7.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
