...
# extracted from F5 Networks BIG-IP Solution SOL12953.
#
...
if (description)
{
  ...
  script_bugtraq_id(48579);

  script_name(english:"F5 Networks BIG-IP : XSS vulnerability in BIG-IP ASM Web Scraping feature (SOL12953)");
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K12953"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.cirosec.de/english/company/about-us.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["ASM"]["unaffected"] = make_list("9","10.0.0-10.0.1","10.2.3","10.2.4","11");
