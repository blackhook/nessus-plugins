...
# extracted from Fedora Security Advisory FEDORA-2016-80a1d6211a.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6896");
  script_xref(name:"FEDORA", value:"2016-80a1d6211a");

  script_name(english:"Fedora 25 : wordpress (2016-80a1d6211a)");
...
&ldquo;Pepper&rdquo;](https://wordpress.org/news/2016/08/pepper/)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-80a1d6211a"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://wordpress.org/news/2016/08/pepper/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"wordpress-4.6-2.fc25")) flag++;
