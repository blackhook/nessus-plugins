...
# extracted from Fedora Security Advisory 2012-6999.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-6999");

  script_name(english:"Fedora 15 : samba-3.5.15-74.fc15.1 (2012-6999)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?caeb099f"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"samba-3.5.15-74.fc15.1")) flag++;
