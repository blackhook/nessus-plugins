...
# extracted from Fedora Security Advisory FEDORA-2017-6f8fcff58c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : systemd (2017-6f8fcff58c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6f8fcff58c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"systemd-233-7.fc26")) flag++;
