...
# extracted from Fedora Security Advisory 2014-7954.
#
...
if (description)
{
  ...
  script_bugtraq_id(66753);
  script_xref(name:"FEDORA", value:"2014-7954");

  script_name(english:"Fedora 20 : openstack-nova-2013.2.3-2.fc20 (2014-7954)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1084868"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135320.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aeaebd45"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"openstack-nova-2013.2.3-2.fc20")) flag++;
