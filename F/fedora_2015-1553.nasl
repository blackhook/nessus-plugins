...
# extracted from Fedora Security Advisory 2015-1553.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : patch-2.7.4-1.fc21 (2015-1553)");
  ...
  script_set_attribute(
    ...
    value:
"Latest upstream release, restoring the ability to create symbolic
links referencing '..' pathname components and preventing a local
denial of service.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ef7bc0d6"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"patch-2.7.4-1.fc21")) flag++;
