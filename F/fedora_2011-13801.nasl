...
# extracted from Fedora Security Advisory 2011-13801.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-13801");

  script_name(english:"Fedora 15 : phpPgAdmin-5.0.3-1.fc15 (2011-13801)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/067846.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?201e33ea"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"phpPgAdmin-5.0.3-1.fc15")) flag++;
