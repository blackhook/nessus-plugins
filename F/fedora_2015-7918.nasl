...
# extracted from Fedora Security Advisory 2015-7918.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7918");

  script_name(english:"Fedora 22 : ca-certificates-2015.2.4-1.0.fc22 (2015-7918)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/157796.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a27d28e9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"ca-certificates-2015.2.4-1.0.fc22")) flag++;
