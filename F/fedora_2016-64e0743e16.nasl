...
# extracted from Fedora Security Advisory FEDORA-2016-64e0743e16.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : 1:openssl (2016-64e0743e16)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-64e0743e16"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"openssl-1.0.2j-1.fc25", epoch:"1")) flag++;
