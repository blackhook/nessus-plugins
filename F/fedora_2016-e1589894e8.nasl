...
# extracted from Fedora Security Advisory FEDORA-2016-e1589894e8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e1589894e8");

  script_name(english:"Fedora 24 : gnutls (2016-e1589894e8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e1589894e8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"gnutls-3.4.15-1.fc24")) flag++;
