...
# extracted from Fedora Security Advisory FEDORA-2021-85087f8a70
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-85087f8a70");

  script_name(english:"Fedora 32 : privoxy (2021-85087f8a70)");
...
FEDORA-2021-85087f8a70 advisory.

  - 3.0.32  (FEDORA-2021-85087f8a70)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-85087f8a70");
...
pkgs = [
    {'reference':'privoxy-3.0.32-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
