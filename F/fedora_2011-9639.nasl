...
# extracted from Fedora Security Advisory 2011-9639.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-9639");

  script_name(english:"Fedora 15 : glpi-0.78.5-2.svn14966.fc15 (2011-9639)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes a database information disclosure vulnerability in
GLPI (Advisory not yet published).
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-August/063408.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?681b2866"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"glpi-0.78.5-2.svn14966.fc15")) flag++;
