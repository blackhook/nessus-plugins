...
# extracted from Fedora Security Advisory 2015-4486.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4486");

  script_name(english:"Fedora 20 : ca-certificates-2015.2.3-1.0.fc20 (2015-4486)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154649.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?36e7de84"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"ca-certificates-2015.2.3-1.0.fc20")) flag++;
