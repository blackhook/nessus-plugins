...
# extracted from Fedora Security Advisory FEDORA-2020-b4b9280811.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : firefox (2020-b4b9280811)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b4b9280811"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"firefox-83.0-3.fc32", allowmaj:TRUE)) flag++;
