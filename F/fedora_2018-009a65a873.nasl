...
# extracted from Fedora Security Advisory FEDORA-2018-009a65a873.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : flatpak (2018-009a65a873)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-009a65a873"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"flatpak-1.0.5-2.fc29")) flag++;
