...
# extracted from Fedora Security Advisory 2010-10383.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : python-paste-1.7.4-1.fc12 (2010-10383)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/043541.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b76fc230"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"python-paste-1.7.4-1.fc12")) flag++;
