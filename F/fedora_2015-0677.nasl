...
# extracted from Fedora Security Advisory 2015-0677.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-0677");

  script_name(english:"Fedora 20 : elfutils-0.161-2.fc20 (2015-0677)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ff1887c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"elfutils-0.161-2.fc20")) flag++;
