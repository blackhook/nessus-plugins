...
# extracted from Fedora Security Advisory FEDORA-2017-66fd940572.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : libpng15 (2017-66fd940572)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-66fd940572"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libpng15-1.5.28-1.fc24")) flag++;
