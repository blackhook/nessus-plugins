...
# extracted from Fedora Security Advisory 2004-272.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-272");

  script_name(english:"Fedora Core 1 : mc-4.6.0-17.fc1 (2004-272)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-September/000274.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f3938b3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", reference:"mc-4.6.0-17.fc1")) flag++;
if (rpm_check(release:"FC1", reference:"mc-debuginfo-4.6.0-17.fc1")) flag++;
