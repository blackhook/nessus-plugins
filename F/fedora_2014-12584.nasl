...
# extracted from Fedora Security Advisory 2014-12584.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12584");

  script_name(english:"Fedora 19 : bugzilla-4.2.11-1.fc19 (2014-12584)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141309.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e919f9cc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"bugzilla-4.2.11-1.fc19")) flag++;
