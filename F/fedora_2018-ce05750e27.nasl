...
# extracted from Fedora Security Advisory FEDORA-2018-ce05750e27.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-ce05750e27");

  script_name(english:"Fedora 27 : redis (2018-ce05750e27)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ce05750e27"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"redis-4.0.10-1.fc27")) flag++;
