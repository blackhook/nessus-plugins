...
# extracted from Fedora Security Advisory 2006-929.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-929");

  script_name(english:"Fedora Core 5 : ImageMagick-6.2.5.4-4.2.1.fc5.4 (2006-929)");
...
file. (CVE-2006-3743, CVE-2006-4144)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-August/000559.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e761c36"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"ImageMagick-6.2.5.4-4.2.1.fc5.4")) flag++;
if (rpm_check(release:"FC5", reference:"ImageMagick-c++-6.2.5.4-4.2.1.fc5.4")) flag++;
if (rpm_check(release:"FC5", reference:"ImageMagick-c++-devel-6.2.5.4-4.2.1.fc5.4")) flag++;
if (rpm_check(release:"FC5", reference:"ImageMagick-debuginfo-6.2.5.4-4.2.1.fc5.4")) flag++;
if (rpm_check(release:"FC5", reference:"ImageMagick-devel-6.2.5.4-4.2.1.fc5.4")) flag++;
if (rpm_check(release:"FC5", reference:"ImageMagick-perl-6.2.5.4-4.2.1.fc5.4")) flag++;
