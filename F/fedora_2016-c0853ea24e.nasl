...
# extracted from Fedora Security Advisory 2016-c0853ea24e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c0853ea24e");

  script_name(english:"Fedora 23 : php-5.6.19-1.fc23 (2016-c0853ea24e)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76d8890b"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-5.6.19-1.fc23")) flag++;
