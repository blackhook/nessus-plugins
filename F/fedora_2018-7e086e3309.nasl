...
# extracted from Fedora Security Advisory FEDORA-2018-7e086e3309.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : moodle (2018-7e086e3309)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7e086e3309"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"moodle-3.2.7-1.fc26")) flag++;
