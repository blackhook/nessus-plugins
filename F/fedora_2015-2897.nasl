...
# extracted from Fedora Security Advisory 2015-2897.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-2897");

  script_name(english:"Fedora 20 : qt-4.8.6-25.fc20 (2015-2897)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/150940.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?37a319bb"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"qt-4.8.6-25.fc20")) flag++;
