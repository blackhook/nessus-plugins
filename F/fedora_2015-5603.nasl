...
# extracted from Fedora Security Advisory 2015-5603.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5603");

  script_name(english:"Fedora 21 : arj-3.10.22-22.fc21 (2015-5603)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154518.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7e57037d"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"arj-3.10.22-22.fc21")) flag++;
