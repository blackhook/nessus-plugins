...
# extracted from Fedora Security Advisory FEDORA-2016-c25125c408.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c25125c408");

  script_name(english:"Fedora 24 : moodle (2016-c25125c408)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c25125c408"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"moodle-3.0.4-1.fc24")) flag++;
