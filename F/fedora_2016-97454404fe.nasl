...
# extracted from Fedora Security Advisory FEDORA-2016-97454404fe.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : 1:openssl (2016-97454404fe)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-97454404fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"openssl-1.0.2j-1.fc23", epoch:"1")) flag++;
