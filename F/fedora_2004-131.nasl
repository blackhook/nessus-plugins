...
# extracted from Fedora Security Advisory 2004-131.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-131");

  script_name(english:"Fedora Core 2 : cvs-1.11.15-6 (2004-131)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-May/000128.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9f173b85"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"cvs-1.11.15-6")) flag++;
if (rpm_check(release:"FC2", reference:"cvs-debuginfo-1.11.15-6")) flag++;
