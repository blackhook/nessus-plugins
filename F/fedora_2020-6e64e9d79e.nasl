...
# extracted from Fedora Security Advisory FEDORA-2020-6e64e9d79e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : mediawiki (2020-6e64e9d79e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-6e64e9d79e"
  );
  # https://lists.wikimedia.org/pipermail/mediawiki-announce/2020-September/000262.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31ee1f71"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"mediawiki-1.34.4-1.fc33")) flag++;
