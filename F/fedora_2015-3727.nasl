...
# extracted from Fedora Security Advisory 2015-3727.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3727");

  script_name(english:"Fedora 22 : python-django-1.8-0.6.b2.fc22 (2015-3727)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152163.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?820ea6a9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"python-django-1.8-0.6.b2.fc22")) flag++;
