...
# extracted from Fedora Security Advisory FEDORA-2016-f5107c318e.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-1856", "CVE-2016-1857");
  script_xref(name:"FEDORA", value:"2016-f5107c318e");

  script_name(english:"Fedora 22 : webkitgtk4 (2016-f5107c318e)");
...
Additional fixes :
  ...
  - Improved the detection of supported MIME types supported
    by the media player.

  - Fix web process crash when playing adaptive streaming
    media.

  - Change the volume while thumb slider is dragged, not
    only when released.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f5107c318e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"webkitgtk4-2.12.3-1.fc22")) flag++;
