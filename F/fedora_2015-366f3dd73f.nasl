...
# extracted from Fedora Security Advisory 2015-366f3dd73f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-366f3dd73f");

  script_name(english:"Fedora 21 : php-5.6.14-1.fc21 (2015-366f3dd73f)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-October/169253.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7916ee45"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"php-5.6.14-1.fc21")) flag++;
