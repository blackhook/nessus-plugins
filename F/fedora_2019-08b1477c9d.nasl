...
# extracted from Fedora Security Advisory FEDORA-2019-08b1477c9d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : pdns (2019-08b1477c9d)");
...
Release notes:
https://doc.powerdns.com/authoritative/changelog/4.1.html#change-4.1.1
0
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-08b1477c9d"
  );
  # https://doc.powerdns.com/authoritative/security-advisories/powerdns-advisory-2019-05.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b41acc24"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"pdns-4.1.10-1.fc29")) flag++;
