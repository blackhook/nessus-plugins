...
# extracted from Fedora Security Advisory FEDORA-2018-6227e1ff4c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : suricata (2018-6227e1ff4c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6227e1ff4c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"suricata-4.0.5-1.fc27")) flag++;
