...
# extracted from Fedora Security Advisory 2016-2e89eba0c1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-2e89eba0c1");

  script_name(english:"Fedora 22 : gsi-openssh-6.9p1-7.fc22 (2016-2e89eba0c1)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-February/176516.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9677d439"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"gsi-openssh-6.9p1-7.fc22")) flag++;
