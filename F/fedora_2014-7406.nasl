...
# extracted from Fedora Security Advisory 2014-7406.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-7406");

  script_name(english:"Fedora 20 : rb_libtorrent-0.16.11-2.fc20 (2014-7406)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ef811b45"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"rb_libtorrent-0.16.11-2.fc20")) flag++;
