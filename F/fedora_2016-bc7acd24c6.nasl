...
# extracted from Fedora Security Advisory 2016-bc7acd24c6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-bc7acd24c6");

  script_name(english:"Fedora 22 : privoxy-3.0.23-3.fc22 (2016-bc7acd24c6)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-February/176492.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9ad95fdc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"privoxy-3.0.23-3.fc22")) flag++;
