...
# extracted from Fedora Security Advisory FEDORA-2019-0c1d62bf5b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : drupal7 (2019-0c1d62bf5b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0c1d62bf5b"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/project/drupal/releases/7.61"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"drupal7-7.64-1.fc29")) flag++;
