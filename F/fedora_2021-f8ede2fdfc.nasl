...
# extracted from Fedora Security Advisory FEDORA-2021-f8ede2fdfc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-f8ede2fdfc");

  script_name(english:"Fedora 32 : kernel (2021-f8ede2fdfc)");
...
FEDORA-2021-f8ede2fdfc advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-f8ede2fdfc");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-20194");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2021-20194');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-f8ede2fdfc');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.15-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
