...
# extracted from Fedora Security Advisory 2009-10390.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10390");

  script_name(english:"Fedora 11 : Django-1.1.1-1.fc11 (2009-10390)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=528246"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030104.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e0897527"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"Django-1.1.1-1.fc11")) flag++;
