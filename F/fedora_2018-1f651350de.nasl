...
# extracted from Fedora Security Advisory FEDORA-2018-1f651350de.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-1f651350de");

  script_name(english:"Fedora 27 : thunderbird-enigmail (2018-1f651350de)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1f651350de"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC27", reference:"thunderbird-enigmail-2.0.6-1.fc27")) flag++;
