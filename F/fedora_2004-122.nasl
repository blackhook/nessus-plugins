...
# extracted from Fedora Security Advisory 2004-122.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-122");

  script_name(english:"Fedora Core 2 : kdelibs-3.2.2-6 (2004-122)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-May/000126.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6151bdcc"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"kdelibs-3.2.2-6")) flag++;
if (rpm_check(release:"FC2", reference:"kdelibs-debuginfo-3.2.2-6")) flag++;
if (rpm_check(release:"FC2", reference:"kdelibs-devel-3.2.2-6")) flag++;
