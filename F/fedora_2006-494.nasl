...
# extracted from Fedora Security Advisory 2006-494.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-494");

  script_name(english:"Fedora Core 5 : yelp-2.14.1-1.fc5.2 (2006-494)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000025.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0717a0e2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC5", reference:"yelp-2.14.1-1.fc5.2")) flag++;
if (rpm_check(release:"FC5", reference:"yelp-debuginfo-2.14.1-1.fc5.2")) flag++;
