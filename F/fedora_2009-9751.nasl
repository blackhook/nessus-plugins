...
# extracted from Fedora Security Advisory 2009-9751.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-9751");

  script_name(english:"Fedora 10 : drupal-6.14-1.fc10 (2009-9751)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-September/029328.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b80e84a6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"drupal-6.14-1.fc10")) flag++;
