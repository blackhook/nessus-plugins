...
# extracted from Fedora Security Advisory 2011-5676.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : polkit-0.98-5.fc14 (2011-5676)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Apr 19 2011 David Zeuthen <davidz at redhat.com> -
    0.98-5
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c49cbe6b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"polkit-0.98-5.fc14")) flag++;
