...
# extracted from Fedora Security Advisory FEDORA-2016-ea58a428a1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-ea58a428a1");

  script_name(english:"Fedora 25 : php-pecl-zip (2016-ea58a428a1)");
...
"**Version 1.13.5**
  ...
  - Fixed bug php#68302 (impossible to compile php with zip
    support). (cmb)

  - Fixed bug php#70752 (Depacking with wrong password
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-ea58a428a1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"php-pecl-zip-1.13.5-1.fc25")) flag++;
