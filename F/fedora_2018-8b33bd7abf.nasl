...
# extracted from Fedora Security Advisory FEDORA-2018-8b33bd7abf.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-8b33bd7abf");

  script_name(english:"Fedora 27 : tor (2018-8b33bd7abf)");
  ...
  script_set_attribute(
    ...
    value:
"Update to latest version. Security-Fixes TROVE-2018-001,
TROVE-2018-002,
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-8b33bd7abf"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"tor-0.3.1.10-1.fc27")) flag++;
