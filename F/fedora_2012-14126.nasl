...
# extracted from Fedora Security Advisory 2012-14126.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14126");

  script_name(english:"Fedora 16 : dbus-1.4.10-4.fc16 (2012-14126)");
  ...
  script_set_attribute(
    ...
    value:
"Resolves https://bugzilla.redhat.com/show_bug.cgi?id=857226
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091028.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d1dc9262"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"dbus-1.4.10-4.fc16")) flag++;
