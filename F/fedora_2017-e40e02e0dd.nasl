...
# extracted from Fedora Security Advisory FEDORA-2017-e40e02e0dd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-e40e02e0dd");

  script_name(english:"Fedora 25 : moodle (2017-e40e02e0dd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e40e02e0dd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"moodle-3.1.9-1.fc25")) flag++;
