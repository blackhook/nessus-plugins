...
# extracted from Fedora Security Advisory 2015-5974.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : python-virtualenv-12.0.7-1.fc21 (2015-5974)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155248.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d5c695dd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"python-virtualenv-12.0.7-1.fc21")) flag++;
