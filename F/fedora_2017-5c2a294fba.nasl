...
# extracted from Fedora Security Advisory FEDORA-2017-5c2a294fba.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-5c2a294fba");

  script_name(english:"Fedora 26 : weechat (2017-5c2a294fba)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-5c2a294fba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"weechat-1.9.1-1.fc26")) flag++;
