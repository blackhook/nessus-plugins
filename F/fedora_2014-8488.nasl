...
# extracted from Fedora Security Advisory 2014-8488.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-8488");

  script_name(english:"Fedora 19 : drupal6-6.32-1.fc19 (2014-8488)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/136099.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?30522ccc"
  );
  # https://www.drupal.org/SA-CORE-2014-003
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?92b5f0c4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"drupal6-6.32-1.fc19")) flag++;
