...
FEDORA-2022-d93b3bd8b9 advisory.
  ...
  - Adobe InDesign versions 16.4.2 (and earlier) and 17.3 (and earlier) are affected by an out-of-bounds read
    ...
    that a victim must open a malicious file. (CVE-2022-30674)
