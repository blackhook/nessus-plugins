...
# extracted from Fedora Security Advisory FEDORA-2016-08533fc59c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-08533fc59c");

  script_name(english:"Fedora 25 : curl (2016-08533fc59c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-08533fc59c"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"curl-7.50.3-1.fc25")) flag++;
