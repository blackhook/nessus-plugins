...
# extracted from Fedora Security Advisory FEDORA-2020-11b0f45883.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-11b0f45883");

  script_name(english:"Fedora 30 : webkit2gtk3 (2020-11b0f45883)");
...
"Update to WebKitGTK 2.28.1 :
  ...
  - Fix position of default option element popup windows
    under Wayland.

  - Fix rendering after a cross site navigation with PSON
    enabled and hardware acceleration forced.

  - Fix a crash in nested wayland compositor when closing a
    tab with PSON enabled.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-11b0f45883"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"webkit2gtk3-2.28.1-3.fc30")) flag++;
