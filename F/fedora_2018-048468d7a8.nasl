...
# extracted from Fedora Security Advisory FEDORA-2018-048468d7a8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-048468d7a8");

  script_name(english:"Fedora 27 : poppler (2018-048468d7a8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-048468d7a8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"poppler-0.57.0-7.fc27")) flag++;
