...
if (description)
{
  script_id(139412);
  script_version("1.1");
  script_cvs_date("Date: 2020/08/07");

  script_name(english:"Foxit Studio Photo < 3.6.6.925 Out-of-Bounds Read Vulnerability");
...
affected by an out-of-bounds read error in the use of PNG files to improper validation of user-supplied              
