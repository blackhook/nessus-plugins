...
# extracted from Fedora Security Advisory FEDORA-2016-7f193a0c59.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : php-ZendFramework (2016-7f193a0c59)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-7f193a0c59"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"php-ZendFramework-1.12.20-1.fc24")) flag++;
