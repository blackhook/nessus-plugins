...
# extracted from Fedora Security Advisory 2009-10180.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10180");

  script_name(english:"Fedora 11 : samba-3.4.2-0.42.fc11 (2009-10180)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/029726.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?519340cb"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"samba-3.4.2-0.42.fc11")) flag++;
