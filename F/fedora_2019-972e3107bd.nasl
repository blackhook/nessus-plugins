...
# extracted from Fedora Security Advisory FEDORA-2019-972e3107bd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-972e3107bd");

  script_name(english:"Fedora 29 : gvfs (2019-972e3107bd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-972e3107bd"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"gvfs-1.38.1-2.fc29")) flag++;
