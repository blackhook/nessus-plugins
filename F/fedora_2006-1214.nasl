...
# extracted from Fedora Security Advisory 2006-1214.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1214");

  script_name(english:"Fedora Core 5 : openssh-4.3p2-4.11.fc5 (2006-1214)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-November/000934.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7796a206"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"openssh-4.3p2-4.11.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"openssh-askpass-4.3p2-4.11.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"openssh-clients-4.3p2-4.11.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"openssh-debuginfo-4.3p2-4.11.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"openssh-server-4.3p2-4.11.fc5")) flag++;
