...
# extracted from Fedora Security Advisory 2007-1361.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : tcpdump-3.9.7-1.fc7 (2007-1361)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/003019.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f28a1b79"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"tcpdump-3.9.7-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"tcpdump-debuginfo-3.9.7-1.fc7")) flag++;
