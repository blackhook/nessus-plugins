...
# extracted from Fedora Security Advisory 2011-3942.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3942");

  script_name(english:"Fedora 14 : asterisk-1.6.2.17.2-1.fc14 (2011-3942)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/057163.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d67ffc1a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"asterisk-1.6.2.17.2-1.fc14")) flag++;
