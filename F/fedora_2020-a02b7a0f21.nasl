...
# extracted from Fedora Security Advisory FEDORA-2020-a02b7a0f21.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 32:bind / bind-dyndb-ldap / dnsperf (2020-a02b7a0f21)");
  ...
  script_set_attribute(
    ...
    value:
"[Upstream release
notes](https://downloads.isc.org/isc/bind9/9.11.22/RELEASE-NOTES-bind-
9.11.22.html)
...
possible without introducing additional issues."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a02b7a0f21");
  # https://downloads.isc.org/isc/bind9/9.11.22/RELEASE-NOTES-bind-9.11.22.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fdf0c02b");
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"FC32", reference:"bind-9.11.22-1.fc32", epoch:"32")) flag++;
if (rpm_check(release:"FC32", reference:"bind-dyndb-ldap-11.3-2.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"dnsperf-2.3.4-2.fc32")) flag++;
