...
# extracted from Fedora Security Advisory FEDORA-2019-b4d6be9176.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : haproxy (2019-b4d6be9176)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b4d6be9176"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"haproxy-2.0.10-1.fc31")) flag++;
