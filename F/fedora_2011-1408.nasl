...
# extracted from Fedora Security Advisory 2011-1408.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-1408");

  script_name(english:"Fedora 14 : phpMyAdmin-3.3.9.2-1.fc14 (2011-1408)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1901059d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"phpMyAdmin-3.3.9.2-1.fc14")) flag++;
