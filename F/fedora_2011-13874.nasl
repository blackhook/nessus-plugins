...
# extracted from Fedora Security Advisory 2011-13874.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : perl-5.12.4-147.fc14 (2011-13874)");
...
(CVE-2011-3597)= and in decoding Unicode string by interpreter
(CVE-2011-2939).
----------------------------------------------------------------------
-----=
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=731246"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=743010"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-November/068753.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2b7b2232"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"perl-5.12.4-147.fc14")) flag++;
