...
# extracted from Fedora Security Advisory 2006-979.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-979");

  script_name(english:"Fedora Core 5 : nss-3.11.3-0.5.fc5 (2006-979)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-September/000610.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?67f30053"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"nss-3.11.3-0.5.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"nss-debuginfo-3.11.3-0.5.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"nss-devel-3.11.3-0.5.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"nss-pkcs11-devel-3.11.3-0.5.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"nss-tools-3.11.3-0.5.fc5")) flag++;
