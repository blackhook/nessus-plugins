...
if (description)
{
  ...
  script_name(english:"Flash Player <= 11.7.700.242 / 11.9.900.117 Memory Corruptions (APSB13-26)");
...
remote Windows host is equal or prior to 11.7.700.242 / 11.8.x or 11.9.x
equal or prior to 11.9.900.117.  It is, therefore, potentially affected
by multiple memory corruption vulnerabilities that could lead to code
execution.");
...
"Upgrade to Adobe Flash Player version 11.7.700.252 / 11.9.900.152 or
later.");
      ...
      if (ver)
      {
        ...
        )
        {
          ...
          if (variant == "Chrome_Pepper")
            info += '\n  Fixed version     : 11.9.900.152 (Chrome PepperFlash)';
 	  else
