...
# extracted from Fedora Security Advisory 2014-6891.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6891");

  script_name(english:"Fedora 20 : gnutls-3.1.25-1.fc20 (2014-6891)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/133930.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e07270df"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"gnutls-3.1.25-1.fc20")) flag++;
