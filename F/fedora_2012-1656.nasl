...
# extracted from Fedora Security Advisory 2012-1656.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 15 : apr-1.4.6-1.fc15 (2012-1656)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-March/074140.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?19c319c7"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"apr-1.4.6-1.fc15")) flag++;
