...
# extracted from Fedora Security Advisory FEDORA-2017-25df1dbd02.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-25df1dbd02");

  script_name(english:"Fedora 24 : munin (2017-25df1dbd02)");
  ...
  script_set_attribute(
    ...
    value:
"  - CVE-2017-6188: Upstream PR 797: Fix wrong parameter
    expansion in CGI
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-25df1dbd02"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"munin-2.0.30-5.fc24")) flag++;
