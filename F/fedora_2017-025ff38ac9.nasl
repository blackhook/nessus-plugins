...
# extracted from Fedora Security Advisory FEDORA-2017-025ff38ac9.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-14517", "CVE-2017-14518", "CVE-2017-14519", "CVE-2017-14617", "CVE-2017-14926", "CVE-2017-14927", "CVE-2017-14928", "CVE-2017-14929");
  script_xref(name:"FEDORA", value:"2017-025ff38ac9");

  script_name(english:"Fedora 27 : poppler (2017-025ff38ac9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-025ff38ac9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"poppler-0.57.0-5.fc27")) flag++;
