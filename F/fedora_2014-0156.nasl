...
# extracted from Fedora Security Advisory 2014-0156.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-0156");

  script_name(english:"Fedora 20 : poppler-0.24.3-3.fc20 (2014-0156)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8caa6495"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"poppler-0.24.3-3.fc20")) flag++;
