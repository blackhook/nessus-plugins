...
# extracted from Fedora Security Advisory FEDORA-2018-18023f40fa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : drupal7 (2018-18023f40fa)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-18023f40fa"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC28", reference:"drupal7-7.60-2.fc28")) flag++;
