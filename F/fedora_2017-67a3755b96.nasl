...
# extracted from Fedora Security Advisory FEDORA-2017-67a3755b96.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : libsndfile (2017-67a3755b96)");
  ...
  script_set_attribute(
    ...
    value:
"fixes heap-based Buffer Overflow in psf_binheader_writef function
(#1483140, CVE-2017-12562)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-67a3755b96"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libsndfile-1.0.28-6.fc26")) flag++;
