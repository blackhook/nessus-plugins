...
# extracted from Fedora Security Advisory FEDORA-2021-10ce8fcbf1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-10ce8fcbf1");

  script_name(english:"Fedora 33 : 1:golang-github-containerd-cri (2021-10ce8fcbf1)");
...
FEDORA-2021-10ce8fcbf1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-10ce8fcbf1");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:golang-github-containerd-cri package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:golang-github-containerd-cri");
...
pkgs = [
    {'reference':'golang-github-containerd-cri-1.19.0-3.20210307gitaa2d5a9.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, '1:golang-github-containerd-cri');
}
