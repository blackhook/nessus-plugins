...
# extracted from Fedora Security Advisory FEDORA-2016-3113e71193.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-3113e71193");

  script_name(english:"Fedora 24 : ansible (2016-3113e71193)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3113e71193"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"ansible-2.2.0.0-3.fc24")) flag++;
