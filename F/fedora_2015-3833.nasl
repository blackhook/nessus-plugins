...
# extracted from Fedora Security Advisory 2015-3833.
#
...
if (description)
{
  ...
  script_bugtraq_id(73157);
  script_xref(name:"FEDORA", value:"2015-3833");

  script_name(english:"Fedora 22 : php-ZendFramework2-2.3.7-1.fc22 (2015-3833)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152319.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0baa4ea5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"php-ZendFramework2-2.3.7-1.fc22")) flag++;
