...
# extracted from Fedora Security Advisory FEDORA-2017-ebc4d197b2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ebc4d197b2");

  script_name(english:"Fedora 26 : gnome-shell (2017-ebc4d197b2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ebc4d197b2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"gnome-shell-3.24.3-2.fc26")) flag++;
