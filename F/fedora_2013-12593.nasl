...
# extracted from Fedora Security Advisory 2013-12593.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12593");

  script_name(english:"Fedora 19 : libXvMC-1.0.8-1.fc19 (2013-12593)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 1.0.8, fixes potential strncpy overflow Update to latest git
to fix the following CVEs: CVE-2013-1999 CVE-2013-1990
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111904.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76b403cd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libXvMC-1.0.8-1.fc19")) flag++;
