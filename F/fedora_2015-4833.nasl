...
# extracted from Fedora Security Advisory 2015-4833.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4833");

  script_name(english:"Fedora 20 : setroubleshoot-3.2.17-2.fc20 (2015-4833)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154427.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ee13f889"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"setroubleshoot-3.2.17-2.fc20")) flag++;
