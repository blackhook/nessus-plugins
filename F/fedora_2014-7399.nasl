...
# extracted from Fedora Security Advisory 2014-7399.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-7399");

  script_name(english:"Fedora 19 : python-jinja2-2.6-7.fc19 (2014-7399)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134649.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5d6b89d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python-jinja2-2.6-7.fc19")) flag++;
