...
# extracted from Fedora Security Advisory 2005-744.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-744");

  script_name(english:"Fedora Core 4 : kdeedu-3.4.2-0.fc4.2 (2005-744)");
...
to overwrite files writeable by the user invoking the conversion
script.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001252.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2bf7fbac"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"kdeedu-3.4.2-0.fc4.2")) flag++;
if (rpm_check(release:"FC4", reference:"kdeedu-debuginfo-3.4.2-0.fc4.2")) flag++;
if (rpm_check(release:"FC4", reference:"kdeedu-devel-3.4.2-0.fc4.2")) flag++;
