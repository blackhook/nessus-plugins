...
# extracted from Fedora Security Advisory 2005-651.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-651");

  script_name(english:"Fedora Core 3 : ethereal-0.10.12-1.FC3.1 (2005-651)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Jul 28 2005 Jindrich Novy <jnovy at redhat.com>
    0.10.12-1.FC3.1
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-July/001154.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b1378cb"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"ethereal-0.10.12-1.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"ethereal-debuginfo-0.10.12-1.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"ethereal-gnome-0.10.12-1.FC3.1")) flag++;
