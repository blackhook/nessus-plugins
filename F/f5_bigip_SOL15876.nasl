...
# extracted from F5 Networks BIG-IP Solution SOL15876.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PHP vulnerability (SOL15876)");
...
argument to the quoted_printable_encode function."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15876"
  );
  script_set_attribute(
    attribute:"solution",
    value:
