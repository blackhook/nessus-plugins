...
# extracted from Fedora Security Advisory 2016-bb7bdd7063.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-bb7bdd7063");

  script_name(english:"Fedora 22 : php-pecl-http-2.5.6-1.fc22 (2016-bb7bdd7063)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-March/179360.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43420fe9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"php-pecl-http-2.5.6-1.fc22")) flag++;
