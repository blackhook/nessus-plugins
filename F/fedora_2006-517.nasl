...
# extracted from Fedora Security Advisory 2006-517.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-517");

  script_name(english:"Fedora Core 4 : kernel-2.6.16-1.2108_FC4 (2006-517)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000044.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d02d01a2"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"kernel-2.6.16-1.2108_FC4")) flag++;
if (rpm_check(release:"FC4", reference:"kernel-debuginfo-2.6.16-1.2108_FC4")) flag++;
if (rpm_check(release:"FC4", reference:"kernel-devel-2.6.16-1.2108_FC4")) flag++;
if (rpm_check(release:"FC4", reference:"kernel-doc-2.6.16-1.2108_FC4")) flag++;
if (rpm_check(release:"FC4", reference:"kernel-smp-2.6.16-1.2108_FC4")) flag++;
if (rpm_check(release:"FC4", reference:"kernel-smp-devel-2.6.16-1.2108_FC4")) flag++;
