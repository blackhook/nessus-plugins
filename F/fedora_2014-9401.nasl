...
# extracted from Fedora Security Advisory 2014-9401.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9401");

  script_name(english:"Fedora 19 : ppp-2.4.5-33.fc19 (2014-9401)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1128748"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-August/137138.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?db75ca48"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"ppp-2.4.5-33.fc19")) flag++;
