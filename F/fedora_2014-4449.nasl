...
# extracted from Fedora Security Advisory 2014-4449.
#
...
if (description)
{
  ...
  script_bugtraq_id(66457);
  script_xref(name:"FEDORA", value:"2014-4449");

  script_name(english:"Fedora 19 : curl-7.29.0-17.fc19 (2014-4449)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1079148"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-March/130856.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb398474"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"curl-7.29.0-17.fc19")) flag++;
