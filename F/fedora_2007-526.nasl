...
# extracted from Fedora Security Advisory 2007-526.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 5 : php-5.1.6-1.6 (2007-526)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001745.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?609d8010"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"php-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-bcmath-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-dba-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-debuginfo-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-devel-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-gd-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-imap-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-ldap-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-mbstring-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-mysql-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-ncurses-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-odbc-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-pdo-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-pgsql-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-snmp-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-soap-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-xml-5.1.6-1.6")) flag++;
if (rpm_check(release:"FC5", reference:"php-xmlrpc-5.1.6-1.6")) flag++;
