...
# extracted from Fedora Security Advisory FEDORA-2017-f0c18420e8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f0c18420e8");

  script_name(english:"Fedora 27 : 2:samba (2017-f0c18420e8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f0c18420e8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"samba-4.7.0-12.fc27", epoch:"2")) flag++;
