...
# extracted from Fedora Security Advisory FEDORA-2017-ea4ed9e540.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ea4ed9e540");

  script_name(english:"Fedora 27 : freexl (2017-ea4ed9e540)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ea4ed9e540"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"freexl-1.0.4-1.fc27")) flag++;
