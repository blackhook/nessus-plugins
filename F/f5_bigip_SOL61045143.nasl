...
# extracted from F5 Networks BIG-IP Solution K61045143.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Configuration utility CSRF vulnerability (K61045143)");
...
Configuration utility, may allow a malicious site to force an
administrative session to log out and require re-authentication."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K61045143"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
