...
# extracted from Fedora Security Advisory FEDORA-2017-4dad5165dc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-4dad5165dc");

  script_name(english:"Fedora 27 : slurm (2017-4dad5165dc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4dad5165dc"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://nvd.nist.gov/vuln/detail/CVE-2017-15566"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"slurm-17.02.9-2.fc27")) flag++;
