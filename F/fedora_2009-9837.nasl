...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.wireshark.org/docs/relnotes/wireshark-1.2.1.html"
  );
  # http://www.wireshark.org/docs/relnotes/wireshark-1.2.2.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.wireshark.org/docs/relnotes/wireshark-1.2.2.html"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.wireshark.org/security/wnpa-sec-2009-06.html"
  );
  script_set_attribute(
    attribute:"see_also",
