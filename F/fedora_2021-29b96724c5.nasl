...
# extracted from Fedora Security Advisory FEDORA-2021-29b96724c5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-29b96724c5");

  script_name(english:"Fedora 32 : clamav (2021-29b96724c5)");
...
FEDORA-2021-29b96724c5 advisory.

  - 0.103.2 (#1947267) https://blog.clamav.net/2021/04/clamav-01032-security-patch-release.html
    (FEDORA-2021-29b96724c5)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-29b96724c5");
...
pkgs = [
    {'reference':'clamav-0.103.2-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
