...
# extracted from Fedora Security Advisory FEDORA-2021-8b3202b783
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-8b3202b783");

  script_name(english:"Fedora 33 : zeromq (2021-8b3202b783)");
...
FEDORA-2021-8b3202b783 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-8b3202b783");
  script_set_attribute(attribute:"solution", value:
"Update the affected zeromq package.");
  script_set_attribute(attribute:"risk_factor", value:"High");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-20234");
...
pkgs = [
    {'reference':'zeromq-4.3.4-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
