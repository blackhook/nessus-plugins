...
# extracted from Fedora Security Advisory 2014-7645.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-7645");

  script_name(english:"Fedora 19 : couchdb-1.6.0-9.fc19 / erlang-ibrowse-4.0.1-1.fc19 (2014-7645)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135674.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c1c68d8"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135675.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?55dfb9ce"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"couchdb-1.6.0-9.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"erlang-ibrowse-4.0.1-1.fc19")) flag++;
