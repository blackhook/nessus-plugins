...
# extracted from Fedora Security Advisory 2010-17826.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : openssl-1.0.0b-1.fc12 (2010-17826)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-November/051255.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ddfc8e9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"openssl-1.0.0b-1.fc12")) flag++;
