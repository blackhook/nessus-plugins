...
# extracted from Fedora Security Advisory 2011-7409.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : php-ZendFramework-1.11.6-1.fc14 (2011-7409)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061004.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?27068395"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061091.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b9cc3099"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"php-ZendFramework-1.11.6-1.fc14")) flag++;
