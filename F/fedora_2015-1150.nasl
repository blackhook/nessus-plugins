...
# extracted from Fedora Security Advisory 2015-1150.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1150");

  script_name(english:"Fedora 20 : java-1.8.0-openjdk-1.8.0.31-1.b13.fc20 (2015-1150)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148534.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e886fa9c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"java-1.8.0-openjdk-1.8.0.31-1.b13.fc20")) flag++;
