...
# extracted from Fedora Security Advisory FEDORA-2016-007efacd1c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-007efacd1c");
  script_xref(name:"IAVA", value:"2017-A-0004");

  script_name(english:"Fedora 24 : 32:bind (2016-007efacd1c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-007efacd1c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"bind-9.10.4-1.P2.fc24", epoch:"32")) flag++;
