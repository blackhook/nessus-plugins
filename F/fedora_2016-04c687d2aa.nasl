...
# extracted from Fedora Security Advisory FEDORA-2016-04c687d2aa.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-04c687d2aa");

  script_name(english:"Fedora 25 : mapserver (2016-04c687d2aa)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-04c687d2aa"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mapserver-7.0.3-1.git0f9ece8.fc25")) flag++;
