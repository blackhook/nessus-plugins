...
# extracted from Fedora Security Advisory FEDORA-2017-2ddf7d452a.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-10128");
  script_xref(name:"FEDORA", value:"2017-2ddf7d452a");

  script_name(english:"Fedora 25 : libgit2 (2017-2ddf7d452a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2ddf7d452a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libgit2-0.24.6-1.fc25")) flag++;
