...
# extracted from Fedora Security Advisory 2013-17026.
#
...
if (description)
{
  ...
  script_bugtraq_id(56434, 62426);
  script_xref(name:"FEDORA", value:"2013-17026");

  script_name(english:"Fedora 19 : icedtea-web-1.4.1-0.fc19 (2013-17026)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1007960"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115934.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d33632bf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"icedtea-web-1.4.1-0.fc19")) flag++;
