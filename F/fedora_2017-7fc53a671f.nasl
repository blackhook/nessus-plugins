...
# extracted from Fedora Security Advisory FEDORA-2017-7fc53a671f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-7fc53a671f");

  script_name(english:"Fedora 25 : deluge (2017-7fc53a671f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://dev.deluge-torrent.org/wiki/ReleaseNotes/1.3.15"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7fc53a671f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"deluge-1.3.15-1.fc25")) flag++;
