...
# extracted from Fedora Security Advisory 2015-2994.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-2994");

  script_name(english:"Fedora 20 : jBCrypt-0.4-1.fc20 (2015-2994)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/151797.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83250bd1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"jBCrypt-0.4-1.fc20")) flag++;
