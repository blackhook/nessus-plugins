...
# extracted from Fedora Security Advisory FEDORA-2017-7a7ea1cf50.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : knot / knot-resolver (2017-7a7ea1cf50)");
  ...
  script_set_attribute(
    ...
    value:
"Major update for Knot DNS and Knot Resolver :
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7a7ea1cf50"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"knot-2.6.1-1.fc27")) flag++;
if (rpm_check(release:"FC27", reference:"knot-resolver-1.5.0-1.fc27")) flag++;
