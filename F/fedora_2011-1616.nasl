...
# extracted from Fedora Security Advisory 2011-1616.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-1616");

  script_name(english:"Fedora 15 : gitolite-1.5.8-3.fc15 (2011-1616)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/054697.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d6bfc070"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"gitolite-1.5.8-3.fc15")) flag++;
