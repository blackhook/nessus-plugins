...
# extracted from Fedora Security Advisory 2011-3408.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3408");

  script_name(english:"Fedora 15 : wordpress-3.1-1.fc15 (2011-3408)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 3.1 to fix multiple vulnerabilities and track upstream.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/056412.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1f6a7d61"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"wordpress-3.1-1.fc15")) flag++;
