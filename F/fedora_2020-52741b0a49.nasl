...
# extracted from Fedora Security Advisory FEDORA-2020-52741b0a49.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-52741b0a49");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 31 : ant (2020-52741b0a49)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-52741b0a49"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected ant package.");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"ant-1.10.8-1.fc31")) flag++;
