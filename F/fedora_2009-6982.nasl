...
# extracted from Fedora Security Advisory 2009-6982.
#
...
if (description)
{
  ...
  script_bugtraq_id(30107, 34568);
  script_xref(name:"FEDORA", value:"2009-6982");

  script_name(english:"Fedora 9 : poppler-0.8.7-2.fc9 (2009-6982)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=496943"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025672.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?64fb68b5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"poppler-0.8.7-2.fc9")) flag++;
