...
# extracted from Fedora Security Advisory 2005-1170.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1170");

  script_name(english:"Fedora Core 3 : xpdf-3.01-0.FC3.4 (2005-1170)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001687.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?99e5f8fc"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2005/12/17");
...
flag = 0;
if (rpm_check(release:"FC3", reference:"xpdf-3.01-0.FC3.4")) flag++;
if (rpm_check(release:"FC3", reference:"xpdf-debuginfo-3.01-0.FC3.4")) flag++;
