...
# extracted from Fedora Security Advisory 2011-5135.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5135");

  script_name(english:"Fedora 15 : fail2ban-0.8.4-27.fc15 (2011-5135)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058401.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?30db9fe7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"fail2ban-0.8.4-27.fc15")) flag++;
