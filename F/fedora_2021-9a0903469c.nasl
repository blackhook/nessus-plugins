...
# extracted from Fedora Security Advisory FEDORA-2021-9a0903469c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-9a0903469c");
  script_xref(name:"IAVB", value:"2021-B-0013-S");

  script_name(english:"Fedora 32 : ansible (2021-9a0903469c)");
...
FEDORA-2021-9a0903469c advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-9a0903469c");
...
pkgs = [
    {'reference':'ansible-2.9.18-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
