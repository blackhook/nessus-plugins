...
# extracted from F5 Networks BIG-IP Solution SOL9754.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND 9 vulnerability (SOL9754)");
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K9754"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
