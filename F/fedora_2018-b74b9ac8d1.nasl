...
if (description)
{
  ...
  script_name(english:"Fedora 28 : tmux (2018-b74b9ac8d1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b74b9ac8d1"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"tmux-2.8-2.fc28")) flag++;
