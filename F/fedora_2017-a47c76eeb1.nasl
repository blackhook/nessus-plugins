...
# extracted from Fedora Security Advisory FEDORA-2017-a47c76eeb1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : glusterfs (2017-a47c76eeb1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a47c76eeb1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"glusterfs-3.10.6-4.fc26")) flag++;
