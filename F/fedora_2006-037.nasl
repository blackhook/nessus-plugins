...
# extracted from Fedora Security Advisory 2006-037.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-037");

  script_name(english:"Fedora Core 4 : kdegraphics-3.5.0-0.2.fc4 (2006-037)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-January/001748.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b421f994"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
