...
# extracted from Fedora Security Advisory 2015-5833.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : perl-Module-Signature-0.78-1.fc21 / perl-Test-Signature-1.11-1.fc21 (2015-5833)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154707.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f29d4586"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154709.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7dc5ca36"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC21", reference:"perl-Module-Signature-0.78-1.fc21")) flag++;
if (rpm_check(release:"FC21", reference:"perl-Test-Signature-1.11-1.fc21")) flag++;
