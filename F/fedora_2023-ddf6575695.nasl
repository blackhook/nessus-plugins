...
FEDORA-2023-ddf6575695 advisory.
  ...
  - HSTS ignored on multiple requests [fedora-all] (CVE-2023-23914)

  - HSTS amnesia with --parallel [fedora-all] (CVE-2023-23915)

  - HTTP multi-header compression denial of service [fedora-all] (CVE-2023-23916)
