...
# extracted from Fedora Security Advisory 2015-4788.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4788");

  script_name(english:"Fedora 22 : freeipa-4.1.4-1.fc22 / slapi-nis-0.54.2-1.fc22 (2015-4788)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/154102.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6926f1bc"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/154103.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eb802d89"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"freeipa-4.1.4-1.fc22")) flag++;
if (rpm_check(release:"FC22", reference:"slapi-nis-0.54.2-1.fc22")) flag++;
