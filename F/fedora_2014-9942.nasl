...
# extracted from Fedora Security Advisory 2014-9942.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9942");

  script_name(english:"Fedora 19 : mariadb-5.5.39-1.fc19 (2014-9942)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137572.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?568953e4"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"mariadb-5.5.39-1.fc19")) flag++;
