...
# extracted from Fedora Security Advisory 2006-491.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-491");

  script_name(english:"Fedora Core 5 : epiphany-2.14.1-1.fc5.2 (2006-491)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000022.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b4dd85e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC5", reference:"epiphany-2.14.1-1.fc5.2")) flag++;
if (rpm_check(release:"FC5", reference:"epiphany-debuginfo-2.14.1-1.fc5.2")) flag++;
if (rpm_check(release:"FC5", reference:"epiphany-devel-2.14.1-1.fc5.2")) flag++;
