...
# extracted from Fedora Security Advisory 2005-1132.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1132");

  script_name(english:"Fedora Core 4 : poppler-0.4.1-1.2 (2005-1132)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001638.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78146e1f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"poppler-0.4.1-1.2")) flag++;
if (rpm_check(release:"FC4", reference:"poppler-debuginfo-0.4.1-1.2")) flag++;
if (rpm_check(release:"FC4", reference:"poppler-devel-0.4.1-1.2")) flag++;
