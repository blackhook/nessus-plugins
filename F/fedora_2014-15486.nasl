...
# extracted from Fedora Security Advisory 2014-15486.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15486");

  script_name(english:"Fedora 20 : libreoffice-4.2.7.2-9.fc20 (2014-15486)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144836.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e520921"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libreoffice-4.2.7.2-9.fc20")) flag++;
