...
# extracted from Fedora Security Advisory 2011-9589.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-9589");

  script_name(english:"Fedora 15 : cgit-0.9.0.2-2.fc15 (2011-9589)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-August/063860.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?702044f1"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"cgit-0.9.0.2-2.fc15")) flag++;
