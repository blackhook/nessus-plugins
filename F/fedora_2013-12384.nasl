...
# extracted from Fedora Security Advisory 2013-12384.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12384");

  script_name(english:"Fedora 19 : gallery3-3.0.9-1.fc19 (2013-12384)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111694.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?825363f8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"gallery3-3.0.9-1.fc19")) flag++;
