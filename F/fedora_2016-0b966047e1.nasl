...
# extracted from Fedora Security Advisory FEDORA-2016-0b966047e1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : krb5 (2016-0b966047e1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0b966047e1"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2016/07/09");
...
flag = 0;
if (rpm_check(release:"FC23", reference:"krb5-1.14.1-7.fc23")) flag++;
