...
# extracted from Fedora Security Advisory 2014-17642.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-17642");

  script_name(english:"Fedora 21 : mingw-pcre-8.35-1.fc21 (2014-17642)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c9a79bfc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mingw-pcre-8.35-1.fc21")) flag++;
