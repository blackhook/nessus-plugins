...
# extracted from Fedora Security Advisory 2005-729.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-729");

  script_name(english:"Fedora Core 4 : xpdf-3.00-20.FC4.2 (2005-729)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001242.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b1e06813"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"xpdf-3.00-20.FC4.2")) flag++;
if (rpm_check(release:"FC4", reference:"xpdf-debuginfo-3.00-20.FC4.2")) flag++;
