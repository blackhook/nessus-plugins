...
# extracted from Fedora Security Advisory FEDORA-2017-a1625d5c7b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a1625d5c7b");

  script_name(english:"Fedora 25 : redis (2017-a1625d5c7b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a1625d5c7b"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"redis-3.2.7-1.fc25")) flag++;
