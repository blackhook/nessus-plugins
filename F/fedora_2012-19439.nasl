...
# extracted from Fedora Security Advisory 2012-19439.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-19439");

  script_name(english:"Fedora 18 : php-symfony2-HttpFoundation-2.1.4-1.fc18 (2012-19439)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/094115.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?318b7a20"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"php-symfony2-HttpFoundation-2.1.4-1.fc18")) flag++;
