...
# extracted from Fedora Security Advisory 2016-c848d48286.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c848d48286");

  script_name(english:"Fedora 23 : mingw-poppler-0.34.0-2.fc23 (2016-c848d48286)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes a heap buffer overflow.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1326228"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-April/183142.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e881ed9f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mingw-poppler-0.34.0-2.fc23")) flag++;
