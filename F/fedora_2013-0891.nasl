...
# extracted from Fedora Security Advisory 2013-0891.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-0891");

  script_name(english:"Fedora 17 : firefox-18.0-1.fc17 / xulrunner-18.0-6.fc17 (2013-0891)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/097000.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?778ca270"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/097001.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?047e6bbe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"firefox-18.0-1.fc17")) flag++;
if (rpm_check(release:"FC17", reference:"xulrunner-18.0-6.fc17")) flag++;
