...
# extracted from Fedora Security Advisory 2007-763.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : xorg-x11-xfs-1.0.5-1.fc6 (2007-763)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Dec 6 2007 Adam Jackson <ajax at redhat.com>
    1:1.0.5-1
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-December/005763.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43bc4eb4"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"xorg-x11-xfs-1.0.5-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-xfs-debuginfo-1.0.5-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-xfs-utils-1.0.5-1.fc6")) flag++;
