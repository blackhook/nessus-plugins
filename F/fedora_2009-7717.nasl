...
# extracted from Fedora Security Advisory 2009-7717.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-7717");

  script_name(english:"Fedora 10 : mingw32-libtiff-3.8.2-17.fc10 (2009-7717)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026584.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?09783b95"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"mingw32-libtiff-3.8.2-17.fc10")) flag++;
