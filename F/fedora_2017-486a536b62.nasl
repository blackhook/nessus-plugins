...
# extracted from Fedora Security Advisory FEDORA-2017-486a536b62.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-486a536b62");

  script_name(english:"Fedora 24 : mosquitto (2017-486a536b62)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-486a536b62"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mosquitto-1.4.12-1.fc24")) flag++;
