...
# extracted from Fedora Security Advisory FEDORA-2017-80c4677540.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-80c4677540");

  script_name(english:"Fedora 26 : LibRaw (2017-80c4677540)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-80c4677540"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"LibRaw-0.18.4-1.fc26")) flag++;
