...
# extracted from Fedora Security Advisory 2004-576.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-576");

  script_name(english:"Fedora Core 2 : libtiff-3.5.7-21.fc2 (2004-576)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-December/000531.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39b43c61"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"libtiff-3.5.7-21.fc2")) flag++;
