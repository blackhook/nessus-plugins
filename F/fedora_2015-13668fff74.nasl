...
# extracted from Fedora Security Advisory 2015-13668fff74.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-13668fff74");

  script_name(english:"Fedora 23 : mingw-libpng-1.6.19-1.fc23 (2015-13668fff74)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/172769.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9903ad7c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mingw-libpng-1.6.19-1.fc23")) flag++;
