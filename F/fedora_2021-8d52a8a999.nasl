...
# extracted from Fedora Security Advisory FEDORA-2021-8d52a8a999
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-8d52a8a999");

  script_name(english:"Fedora 33 : rpm (2021-8d52a8a999)");
...
FEDORA-2021-8d52a8a999 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-8d52a8a999");
...
pkgs = [
    {'reference':'rpm-4.16.1.3-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
