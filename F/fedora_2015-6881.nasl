...
# extracted from Fedora Security Advisory 2015-6881.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6881");

  script_name(english:"Fedora 21 : mingw-libgcrypt-1.6.3-1.fc21 (2015-6881)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/157184.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6cbcec80"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mingw-libgcrypt-1.6.3-1.fc21")) flag++;
