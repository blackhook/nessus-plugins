...
# extracted from F5 Networks BIG-IP Solution K17515.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-7855");

  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K17515)");
  ...
  script_set_attribute(
    ...
    value:
"The decodenetnum function in ntpd in NTP 4.2.x before 4.2.8p4, and
4.3.x before 4.3.77 allows remote attackers to cause a denial of
service (assertion failure) via a 6 or mode 7 packet containing a long
data value. (CVE-2015-7855)

Impact

A locally authenticated user may be able to disrupt ntpd functionality
with a specially crafted packet."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17515"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
