...
# extracted from Fedora Security Advisory 2013-15072.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-2207");
  script_bugtraq_id(61960);
  script_xref(name:"FEDORA", value:"2013-15072");

  script_name(english:"Fedora 18 : glibc-2.16-34.fc18 (2013-15072)");
...
The fix may break chroots if their devpts was not mounted correctly.
Fix is to mount the devpts correctly with gid=5.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115157.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76ca4849"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"glibc-2.16-34.fc18")) flag++;
