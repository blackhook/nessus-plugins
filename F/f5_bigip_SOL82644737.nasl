...
vmatrix["AFM"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1");
vmatrix["AM"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1","11.2.1","10.2.1-10.2.4");
vmatrix["APM"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1","11.2.1","10.2.1-10.2.4");
vmatrix["ASM"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1","11.2.1");
vmatrix["AVR"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("11.4.0-11.6.1","11.2.1","10.2.1-10.2.4");
vmatrix["GTM"]["unaffected"] = make_list("11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1","11.2.1","10.2.1-10.2.4");
vmatrix["LC"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1","11.2.1","10.2.1-10.2.4");
vmatrix["LTM"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("12.0.0-12.1.1","11.4.0-11.6.1");
vmatrix["PEM"]["unaffected"] = make_list("13.0.0-16.0.0","12.1.2-12.1.5","11.6.1HF2-11.6.5","11.5.4HF4-11.5.10");
