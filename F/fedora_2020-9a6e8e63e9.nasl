...
# extracted from Fedora Security Advisory FEDORA-2020-9a6e8e63e9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-9a6e8e63e9");

  script_name(english:"Fedora 32 : mbedtls (2020-9a6e8e63e9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9a6e8e63e9"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"mbedtls-2.16.6-1.fc32")) flag++;
