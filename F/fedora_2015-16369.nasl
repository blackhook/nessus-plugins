...
# extracted from Fedora Security Advisory 2015-16369.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : qemu-2.3.1-5.fc22 (2015-16369)");
  ...
  script_set_attribute(
    ...
    value:
"  - Fix typo causing qemu-img to link against entire world
    (bz #1260996) * CVE-2015-6815: net: e1000: infinite loop
    issue (bz #1260225) * CVE-2015-6855: ide: divide by zero
    issue (bz #1261793) * CVE-2015-5278: Infinite loop in
    ...
    * Make block copy more stable (bz #1264416) * Fix hang
    ...
    ---- Fix emulation of various instructions, required by
    libm in F22 ppc64 guests.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?271994af"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"qemu-2.3.1-5.fc22")) flag++;
