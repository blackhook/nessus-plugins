...
# extracted from Fedora Security Advisory 2013-8370.
#
...
if (description)
{
  ...
  script_bugtraq_id(59858, 59859, 59863, 59868);
  script_xref(name:"FEDORA", value:"2013-8370");

  script_name(english:"Fedora 19 : thunderbird-17.0.6-1.fc19 (2013-8370)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e45a7a0"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/107008.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?da2c30e0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"thunderbird-17.0.6-1.fc19")) flag++;
