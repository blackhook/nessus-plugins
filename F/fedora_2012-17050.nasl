...
# extracted from Fedora Security Advisory 2012-17050.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-17050");

  script_name(english:"Fedora 17 : pcp-3.6.9-1.fc17 (2012-17050)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091065.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?747abb7d"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"pcp-3.6.9-1.fc17")) flag++;
