...
# extracted from Fedora Security Advisory 2015-15676.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-15676");

  script_name(english:"Fedora 22 : icedtea-web-1.6.1-1.fc22 (2015-15676)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/167120.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?49159a89"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"icedtea-web-1.6.1-1.fc22")) flag++;
