...
# extracted from Fedora Security Advisory 2005-597.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-597");

  script_name(english:"Fedora Core 2 : libtiff-3.5.7-22.fc2 (2005-597)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-January/000563.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2599d4ab"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"libtiff-3.5.7-22.fc2")) flag++;
