...
# extracted from Fedora Security Advisory 2013-22776.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-22776");

  script_name(english:"Fedora 19 : gimp-2.8.10-4.fc19 (2013-22776)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/124185.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a49d9fb4"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"gimp-2.8.10-4.fc19")) flag++;
