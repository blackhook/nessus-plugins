...
# extracted from Fedora Security Advisory 2012-15754.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-15754");

  script_name(english:"Fedora 17 : phpMyAdmin-3.5.3-1.fc17 (2012-15754)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090874.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ab4c8d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"phpMyAdmin-3.5.3-1.fc17")) flag++;
