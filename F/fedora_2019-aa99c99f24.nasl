...
# extracted from Fedora Security Advisory FEDORA-2019-aa99c99f24.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-aa99c99f24");

  script_name(english:"Fedora 28 : firefox (2019-aa99c99f24)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-aa99c99f24"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"firefox-65.0-1.fc28")) flag++;
