...
# extracted from Fedora Security Advisory 2004-174.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-174");

  script_name(english:"Fedora Core 1 : libpng10-1.0.15-4 (2004-174)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000176.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b076655a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC1", reference:"libpng10-1.0.15-4")) flag++;
if (rpm_check(release:"FC1", reference:"libpng10-debuginfo-1.0.15-4")) flag++;
if (rpm_check(release:"FC1", reference:"libpng10-devel-1.0.15-4")) flag++;
