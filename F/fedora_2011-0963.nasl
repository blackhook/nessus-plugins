...
# extracted from Fedora Security Advisory 2011-0963.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : postgresql-8.4.7-1.fc13 (2011-0963)");
...
http://www.postgresql.org/docs/8.4/static/release-8-4-7.html including
the fix for CVE-2010-4015
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/8.4/release-8-4-7.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=664402"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-February/053888.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0dc326b6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"postgresql-8.4.7-1.fc13")) flag++;
