...
# extracted from Fedora Security Advisory FEDORA-2017-e4e6928969.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-e4e6928969");

  script_name(english:"Fedora 26 : seamonkey (2017-e4e6928969)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e4e6928969"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"seamonkey-2.48-1.fc26")) flag++;
