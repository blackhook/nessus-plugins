...
# extracted from F5 Networks BIG-IP Solution SOL8280.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2008-0265");
  script_bugtraq_id(27272);
  script_xref(name:"Secunia", value:"28505");

  script_name(english:"F5 Networks BIG-IP : XSS vulnerabilities in BIG-IP Configuration utility (SOL8280)");
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K8280"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["ASM"]["affected"  ] = make_list("9.2.0-9.4.8");
vmatrix["ASM"]["unaffected"] = make_list("10","11");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("9.2.2-9.4.8");
vmatrix["GTM"]["unaffected"] = make_list("10","11");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("9.2.2-9.4.8");
vmatrix["LC"]["unaffected"] = make_list("10","11");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("9.0.0-9.4.8");
