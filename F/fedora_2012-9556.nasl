...
# extracted from Fedora Security Advisory 2012-9556.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-9556");

  script_name(english:"Fedora 17 : gc-7.2b-2.fc17 (2012-9556)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082926.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c15adf37"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gc-7.2b-2.fc17")) flag++;
