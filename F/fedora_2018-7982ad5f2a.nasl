...
# extracted from Fedora Security Advisory FEDORA-2018-7982ad5f2a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : mupdf (2018-7982ad5f2a)");
  ...
  script_set_attribute(
    ...
    value:
"CVE-2017-17858 (rh bz #1537952) (gs bz #698819) CVE-2018-5686 (rh bz
#1539854) gs bz #698860)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7982ad5f2a"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mupdf-1.12.0-2.fc27")) flag++;
