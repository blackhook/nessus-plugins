...
# extracted from Fedora Security Advisory FEDORA-2020-a41fda3b4c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : php-horde-horde (2020-a41fda3b4c)");
...
"**horde 5.2.23**
  ...
  - [mjr] SECURITY: Fix JavaScript injection vulnerability
    in mobile login page.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a41fda3b4c"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"php-horde-horde-5.2.23-1.fc32")) flag++;
