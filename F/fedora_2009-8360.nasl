...
# extracted from Fedora Security Advisory 2009-8360.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8360");

  script_name(english:"Fedora 10 : apr-1.3.8-1.fc10 (2009-8360)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027623.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?810a5fbd"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"apr-1.3.8-1.fc10")) flag++;
