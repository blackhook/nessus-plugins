...
# extracted from Fedora Security Advisory 2015-9034.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-9034");

  script_name(english:"Fedora 22 : php-symfony-2.5.12-1.fc22 (2015-9034)");
...
"**2.5.12** (2015-05-27)
  ...
  - security #14759 CVE-2015-4050 [HttpKernel] Do not call
    the FragmentListener if _controller is already defined
    (jakzal)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1227264"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159603.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?03742664"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"php-symfony-2.5.12-1.fc22")) flag++;
