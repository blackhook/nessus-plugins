...
# extracted from Fedora Security Advisory 2015-3399.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3399");

  script_name(english:"Fedora 22 : libgcrypt-1.6.3-1.fc22 (2015-3399)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/151507.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a2000c70"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"libgcrypt-1.6.3-1.fc22")) flag++;
