...
# extracted from Fedora Security Advisory 2015-6397.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6397");

  script_name(english:"Fedora 20 : java-1.7.0-openjdk-1.7.0.79-2.5.5.0.fc20 (2015-6397)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155820.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bba8ec27"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"java-1.7.0-openjdk-1.7.0.79-2.5.5.0.fc20")) flag++;
