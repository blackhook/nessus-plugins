...
# extracted from Fedora Security Advisory 2015-16033.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-16033");

  script_name(english:"Fedora 23 : php-ZendFramework2-2.4.8-1.fc23 (2015-16033)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/167671.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e2db1ce0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-ZendFramework2-2.4.8-1.fc23")) flag++;
