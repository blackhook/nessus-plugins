...
# extracted from Fedora Security Advisory FEDORA-2016-a15d2be020.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a15d2be020");

  script_name(english:"Fedora 24 : wireshark (2016-a15d2be020)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a15d2be020"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"wireshark-2.1.1-1.fc24")) flag++;
