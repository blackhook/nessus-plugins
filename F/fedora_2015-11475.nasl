...
# extracted from Fedora Security Advisory 2015-11475.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : openssl-1.0.1k-11.fc22 (2015-11475)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1238619"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/161782.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ba6a77cd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"openssl-1.0.1k-11.fc22")) flag++;
