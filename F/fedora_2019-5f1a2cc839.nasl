...
# extracted from Fedora Security Advisory FEDORA-2019-5f1a2cc839.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : drupal7 (2019-5f1a2cc839)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5f1a2cc839"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"drupal7-7.69-1.fc30")) flag++;
