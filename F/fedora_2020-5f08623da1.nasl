...
# extracted from Fedora Security Advisory FEDORA-2020-5f08623da1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-5f08623da1");
  script_xref(name:"IAVA", value:"2020-A-0195-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/03");
  script_xref(name:"CEA-ID", value:"CEA-2020-0134");

  script_name(english:"Fedora 33 : salt (2020-5f08623da1)");
  ...
  script_set_attribute(
    ...
    value:
"Update to CVE release 3002.1-1 for Python3 Includes fixes for
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-5f08623da1"
  );
...
flag = 0;
if (rpm_check(release:"FC33", reference:"salt-3002.1-1.fc33")) flag++;
