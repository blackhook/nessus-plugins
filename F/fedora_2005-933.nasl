...
# extracted from Fedora Security Advisory 2005-933.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-933");

  script_name(english:"Fedora Core 3 : devhelp-0.9.2-2.3.6 (2005-933)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001420.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?547461d5"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"devhelp-0.9.2-2.3.6")) flag++;
if (rpm_check(release:"FC3", reference:"devhelp-debuginfo-0.9.2-2.3.6")) flag++;
if (rpm_check(release:"FC3", reference:"devhelp-devel-0.9.2-2.3.6")) flag++;
