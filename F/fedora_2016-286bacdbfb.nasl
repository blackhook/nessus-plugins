...
# extracted from Fedora Security Advisory FEDORA-2016-286bacdbfb.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-3729");
  script_xref(name:"FEDORA", value:"2016-286bacdbfb");

  script_name(english:"Fedora 23 : moodle (2016-286bacdbfb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-286bacdbfb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"moodle-2.9.6-1.fc23")) flag++;
