...
# extracted from Fedora Security Advisory 2013-21231.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-21231");

  script_name(english:"Fedora 19 : drupal6-context-3.3-1.fc19 (2013-21231)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/122407.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2e8b03b1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"drupal6-context-3.3-1.fc19")) flag++;
