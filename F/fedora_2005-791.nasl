...
# extracted from Fedora Security Advisory 2005-791.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-791");

  script_name(english:"Fedora Core 3 : cvs-1.11.17-7.FC3 (2005-791)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Aug 23 2005 Martin Stransky <stransky at redhat.com>
    1.11.17-7.FC3
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001289.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?068e3587"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"cvs-1.11.17-7.FC3")) flag++;
if (rpm_check(release:"FC3", reference:"cvs-debuginfo-1.11.17-7.FC3")) flag++;
