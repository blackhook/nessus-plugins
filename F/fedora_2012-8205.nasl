...
# extracted from Fedora Security Advisory 2012-8205.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 15 : python-tornado-2.2.1-1.fc15 (2012-8205)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/081514.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6a90ca18"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"python-tornado-2.2.1-1.fc15")) flag++;
