...
# extracted from Fedora Security Advisory 2013-17397.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-17397");

  script_name(english:"Fedora 19 : xpdf-3.03-8.fc19 (2013-17397)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/117728.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8db6054b"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"xpdf-3.03-8.fc19")) flag++;
