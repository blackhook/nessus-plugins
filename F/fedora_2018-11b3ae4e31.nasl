...
# extracted from Fedora Security Advisory FEDORA-2018-11b3ae4e31.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-11b3ae4e31");

  script_name(english:"Fedora 27 : ca-certificates (2018-11b3ae4e31)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-11b3ae4e31"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"ca-certificates-2018.2.26-1.0.fc27")) flag++;
