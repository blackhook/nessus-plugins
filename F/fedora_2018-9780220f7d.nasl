...
# extracted from Fedora Security Advisory FEDORA-2018-9780220f7d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-9780220f7d");

  script_name(english:"Fedora 26 : dnsmasq (2018-9780220f7d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9780220f7d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"dnsmasq-2.76-6.fc26")) flag++;
