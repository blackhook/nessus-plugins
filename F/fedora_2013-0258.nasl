...
# extracted from Fedora Security Advisory 2013-0258.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-0258");

  script_name(english:"Fedora 17 : gnupg2-2.0.19-7.fc17 (2013-0258)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/096520.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8774770a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gnupg2-2.0.19-7.fc17")) flag++;
