...
# extracted from Fedora Security Advisory 2013-9117.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-9117");

  script_name(english:"Fedora 18 : libXvMC-1.0.7-6.20130524gite9415ddef.fc18 (2013-9117)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/107499.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97ac7919"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"libXvMC-1.0.7-6.20130524gite9415ddef.fc18")) flag++;
