...
# extracted from Fedora Security Advisory FEDORA-2021-db5caaeb91
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-db5caaeb91");

  script_name(english:"Fedora 32 : 1:cups (2021-db5caaeb91)");
...
FEDORA-2021-db5caaeb91 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-db5caaeb91");
...
pkgs = [
    {'reference':'cups-2.3.3op2-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
