...
# extracted from Fedora Security Advisory 2014-5880.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5880");

  script_name(english:"Fedora 20 : mutt-1.5.23-1.fc20 (2014-5880)");
  ...
  script_set_attribute(
    ...
    value:
"fix: CVE-2014-0467 heap-based buffer overflow when parsing certain
headers
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/132677.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b3b041f"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"mutt-1.5.23-1.fc20")) flag++;
