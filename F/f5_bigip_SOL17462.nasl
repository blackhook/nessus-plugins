...
# extracted from F5 Networks BIG-IP Solution K17462.
#
...
if (description)
{
  ...
  script_bugtraq_id(73699);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K17462)");
...
privileges through a crafted application that uses the fork or close
system call."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17462"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.4.0-11.5.4");
vmatrix["AM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("12.0.0","11.6.1-11.6.1","11.0.0-11.5.4","10.1.0-10.2.4");
vmatrix["APM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0","11.6.1-11.6.1","11.0.0-11.5.4","10.1.0-10.2.4");
vmatrix["ASM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.0.0-11.5.4");
vmatrix["AVR"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");
...
vmatrix["LC"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.0.0-11.5.4","10.1.0-10.2.4");
vmatrix["LTM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.3.0-11.5.4");
vmatrix["PEM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5");
