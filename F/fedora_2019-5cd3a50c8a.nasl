...
# extracted from Fedora Security Advisory FEDORA-2019-5cd3a50c8a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : wordpress (2019-5cd3a50c8a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5cd3a50c8a"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"wordpress-5.2.3-1.fc29")) flag++;
