...
# extracted from Fedora Security Advisory FEDORA-2017-a69b0bb52d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : gd (2017-a69b0bb52d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a69b0bb52d"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"gd-2.2.5-1.fc25")) flag++;
