...
"The version of F5 Networks BIG-IP installed on the remote host is prior to 14.1.4.5 / 15.1.4.1 / 15.1.5 / 16.1.2. It is,
therefore, affected by a vulnerability as referenced in the K40508224 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K40508224");
...
var vmatrix = {
  'AFM': {
    ...
    'unaffected': [
      '16.1.2','15.1.5','15.1.4.1','14.1.4.5'
    ],
  },
  'APM': {
    'affected': [
