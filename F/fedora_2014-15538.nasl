...
# extracted from Fedora Security Advisory 2014-15538.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15538");

  script_name(english:"Fedora 20 : phpMyAdmin-4.2.12-1.fc20 (2014-15538)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145013.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?204f9c76"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"phpMyAdmin-4.2.12-1.fc20")) flag++;
