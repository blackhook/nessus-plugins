...
# extracted from Fedora Security Advisory 2016-68b43a4e0d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-68b43a4e0d");

  script_name(english:"Fedora 22 : webkitgtk4-2.10.9-1.fc22 (2016-68b43a4e0d)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-March/180040.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b16b4881"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"webkitgtk4-2.10.9-1.fc22")) flag++;
