...
# extracted from Fedora Security Advisory 2005-235.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-235");

  script_name(english:"Fedora Core 3 : ImageMagick-6.2.0.7-2.fc3 (2005-235)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000825.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eba9abd4"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"ImageMagick-6.2.0.7-2.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"ImageMagick-c++-6.2.0.7-2.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"ImageMagick-c++-devel-6.2.0.7-2.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"ImageMagick-debuginfo-6.2.0.7-2.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"ImageMagick-devel-6.2.0.7-2.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"ImageMagick-perl-6.2.0.7-2.fc3")) flag++;
