...
# extracted from Fedora Security Advisory 2005-1186.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1186");

  script_name(english:"Fedora Core 3 : fetchmail-6.2.5.5-1.fc3 (2005-1186)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001699.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a5ca3f9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"fetchmail-6.2.5.5-1.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"fetchmail-debuginfo-6.2.5.5-1.fc3")) flag++;
