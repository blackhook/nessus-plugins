...
# extracted from Fedora Security Advisory 2007-058.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : kernel-2.6.19-1.2895.fc6 (2007-058)");
  ...
  script_set_attribute(
    ...
    value:
"This is a large rebase to the latest upstream stable kernel (2.6.19.2)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-January/001284.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?87681afe"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"kernel-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debug-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debug-debuginfo-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debug-devel-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debuginfo-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-devel-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debug-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debug-debuginfo-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debug-devel-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debuginfo-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debuginfo-common-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-devel-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-doc-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-headers-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-kdump-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-kdump-debuginfo-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-kdump-devel-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-xen-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-xen-debuginfo-2.6.19-1.2895.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-xen-devel-2.6.19-1.2895.fc6")) flag++;
