...
# extracted from Fedora Security Advisory 2013-9771.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-9771");

  script_name(english:"Fedora 17 : rubygem-passenger-3.0.21-1.fc17 (2013-9771)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/108479.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1750b150"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"rubygem-passenger-3.0.21-1.fc17")) flag++;
