...
# extracted from Fedora Security Advisory FEDORA-2021-5497f7409b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-5497f7409b");

  script_name(english:"Fedora 33 : 1:grub2 (2021-5497f7409b)");
...
FEDORA-2021-5497f7409b advisory.

  - Update to 2.06~rc1 to fix a bunch of CVEs (FEDORA-2021-5497f7409b)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5497f7409b");
...
pkgs = [
    {'reference':'grub2-2.06~rc1-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
