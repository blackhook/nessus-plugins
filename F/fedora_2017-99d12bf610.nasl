...
# extracted from Fedora Security Advisory FEDORA-2017-99d12bf610.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-99d12bf610");

  script_name(english:"Fedora 27 : python35 (2017-99d12bf610)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-99d12bf610"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"python35-3.5.4-2.fc27")) flag++;
