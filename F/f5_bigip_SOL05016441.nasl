...
# extracted from F5 Networks BIG-IP Solution K05016441.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-3500", "CVE-2016-3508");

  script_name(english:"F5 Networks BIG-IP : Oracle Java vulnerability (K05016441)");
...
vulnerability than CVE-2016-3500. (CVE-2016-3508)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K05016441"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
