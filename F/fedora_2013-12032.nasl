...
# extracted from Fedora Security Advisory 2013-12032.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12032");

  script_name(english:"Fedora 18 : autotrace-0.31.1-34.fc18 (2013-12032)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111045.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?55a6b8ea"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"autotrace-0.31.1-34.fc18")) flag++;
