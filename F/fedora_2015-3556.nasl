...
# extracted from Fedora Security Advisory 2015-3556.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3556");

  script_name(english:"Fedora 21 : patch-2.7.5-1.fc21 (2015-3556)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152800.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?001d4e99"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"patch-2.7.5-1.fc21")) flag++;
