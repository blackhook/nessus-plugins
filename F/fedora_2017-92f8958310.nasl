...
# extracted from Fedora Security Advisory FEDORA-2017-92f8958310.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-92f8958310");

  script_name(english:"Fedora 26 : glibc (2017-92f8958310)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-92f8958310"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"glibc-2.25-8.fc26")) flag++;
