...
# extracted from Fedora Security Advisory FEDORA-2017-da0b00fd64.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-da0b00fd64");

  script_name(english:"Fedora 24 : jasper (2017-da0b00fd64)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-da0b00fd64"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"jasper-1.900.13-4.fc24")) flag++;
