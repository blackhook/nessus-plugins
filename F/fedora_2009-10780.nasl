...
# extracted from Fedora Security Advisory 2009-10780.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10780");
  script_xref(name:"Secunia", value:"37107");

  script_name(english:"Fedora 11 : squidGuard-1.4-8.fc11 (2009-10780)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/bid/36800/info"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/030578.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc5f9286"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"squidGuard-1.4-8.fc11")) flag++;
