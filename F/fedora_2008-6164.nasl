...
# extracted from Fedora Security Advisory 2008-6164.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : jetty-5.1.14-1jpp.1.fc8 (2008-6164)");
  ...
  script_set_attribute(
    ...
    value:
"  - Fri Jul 4 2008 Jeff Johnston <jjohnstn at redhat.com>
    5.1.14-1jpp.1
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-July/012130.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4fed6ba7"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"jetty-5.1.14-1jpp.1.fc8")) flag++;
