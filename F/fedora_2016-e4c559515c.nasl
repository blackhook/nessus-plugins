...
# extracted from Fedora Security Advisory FEDORA-2016-e4c559515c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e4c559515c");

  script_name(english:"Fedora 22 : roundcubemail (2016-e4c559515c)");
  ...
  script_set_attribute(
    ...
    value:
"Upstream announcement: [Roundcube Webmail 1.2.0
released](https://roundcube.net/news/2016/05/22/roundcube-webmail-1.2.
0-released)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e4c559515c"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://roundcube.net/news/2016/05/22/roundcube-webmail-1.2.0-released"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"roundcubemail-1.2.0-1.fc22")) flag++;
