...
# extracted from Fedora Security Advisory FEDORA-2021-2306e89112
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-2306e89112");

  script_name(english:"Fedora 33 : kernel / kernel-headers / kernel-tools (2021-2306e89112)");
...
FEDORA-2021-2306e89112 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-2306e89112");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-2306e89112');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.11.11-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-5.11.11-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-5.11.11-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
