...
# extracted from Fedora Security Advisory 2005-369.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-369");

  script_name(english:"Fedora Core 3 : gaim-1.3.0-1.fc3 (2005-369)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-May/000908.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?350472b6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"gaim-1.3.0-1.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"gaim-debuginfo-1.3.0-1.fc3")) flag++;
