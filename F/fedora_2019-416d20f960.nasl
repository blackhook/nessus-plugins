...
# extracted from Fedora Security Advisory FEDORA-2019-416d20f960.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : golang (2019-416d20f960)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-416d20f960");
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"golang-1.12.10-1.fc30")) flag++;
