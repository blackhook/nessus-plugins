...
# extracted from Fedora Security Advisory 2010-17098.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : proftpd-1.3.3c-1.fc13 (2010-17098)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26f3558a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"proftpd-1.3.3c-1.fc13")) flag++;
