...
# extracted from F5 Networks BIG-IP Solution SOL17171.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-2628");
  script_bugtraq_id(75796);

  script_name(english:"F5 Networks BIG-IP : OpenJDK vulnerability (SOL17171)");
...
CORBA."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17171"
  );
  script_set_attribute(
    attribute:"solution",
    value:
