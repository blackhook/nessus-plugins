...
# extracted from Fedora Security Advisory FEDORA-2017-3fb16e3a65.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : openvas-cli / openvas-gsa / openvas-libraries / openvas-manager / etc (2017-3fb16e3a65)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3fb16e3a65"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"openvas-cli-1.4.5-3.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"openvas-gsa-7.0.2-2.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"openvas-libraries-9.0.1-1.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"openvas-manager-7.0.2-1.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"openvas-scanner-5.1.1-1.fc26")) flag++;
