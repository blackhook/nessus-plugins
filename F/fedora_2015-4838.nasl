...
# extracted from Fedora Security Advisory 2015-4838.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4838");

  script_name(english:"Fedora 21 : setroubleshoot-3.2.22-1.fc21 (2015-4838)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154444.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1e77a88c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"setroubleshoot-3.2.22-1.fc21")) flag++;
