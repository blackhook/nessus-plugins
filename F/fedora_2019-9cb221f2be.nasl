...
# extracted from Fedora Security Advisory FEDORA-2019-9cb221f2be.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-9cb221f2be");
  script_xref(name:"IAVA", value:"2019-A-0378-S");

  script_name(english:"Fedora 30 : sudo (2019-9cb221f2be)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9cb221f2be"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"sudo-1.8.28-1.fc30")) flag++;
