...
# extracted from Fedora Security Advisory 2009-8318.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8318");

  script_name(english:"Fedora 10 : apr-util-1.3.9-1.fc10 (2009-8318)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027569.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d50b23ac"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"apr-util-1.3.9-1.fc10")) flag++;
