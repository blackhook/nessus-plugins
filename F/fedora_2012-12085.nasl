...
# extracted from Fedora Security Advisory 2012-12085.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-12085");

  script_name(english:"Fedora 16 : wireshark-1.6.10-1.fc16 (2012-12085)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-August/085648.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca1042eb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"wireshark-1.6.10-1.fc16")) flag++;
