...
# extracted from Fedora Security Advisory FEDORA-2017-ccb10391ad.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ccb10391ad");

  script_name(english:"Fedora 25 : mingw-poppler (2017-ccb10391ad)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ccb10391ad"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-poppler-0.45.0-4.fc25")) flag++;
