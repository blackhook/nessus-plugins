...
# extracted from Fedora Security Advisory FEDORA-2018-2eb691e7d7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-2eb691e7d7");

  script_name(english:"Fedora 27 : freexl (2018-2eb691e7d7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2eb691e7d7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"freexl-1.0.5-1.fc27")) flag++;
