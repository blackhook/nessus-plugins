...
# extracted from Fedora Security Advisory 2009-11066.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11066");

  script_name(english:"Fedora 10 : alienarena-7.32-1.fc10 / alienarena-data-20091102-1.fc10 (2009-11066)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/030714.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9d2d6e3f"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/030715.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ee4ab5af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"alienarena-7.32-1.fc10")) flag++;
if (rpm_check(release:"FC10", reference:"alienarena-data-20091102-1.fc10")) flag++;
