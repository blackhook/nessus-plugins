...
# extracted from Fedora Security Advisory FEDORA-2019-e7c83bdf19.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e7c83bdf19");

  script_name(english:"Fedora 31 : python-pillow (2019-e7c83bdf19)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e7c83bdf19"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python-pillow-6.1.0-4.fc31")) flag++;
