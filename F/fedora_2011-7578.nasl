...
# extracted from Fedora Security Advisory 2011-7578.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7578");

  script_name(english:"Fedora 14 : drupal-6.22-1.fc14 (2011-7578)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061178.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f55f6f83"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"drupal-6.22-1.fc14")) flag++;
