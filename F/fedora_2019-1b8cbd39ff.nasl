...
# extracted from Fedora Security Advisory FEDORA-2019-1b8cbd39ff.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1b8cbd39ff");
  script_xref(name:"IAVB", value:"2019-B-0085-S");

  script_name(english:"Fedora 31 : golang (2019-1b8cbd39ff)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1b8cbd39ff");
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"golang-1.13.1-1.fc31")) flag++;
