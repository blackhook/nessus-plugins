...
# extracted from Fedora Security Advisory FEDORA-2020-2d9a75fadb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : xen (2020-2d9a75fadb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2d9a75fadb"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"xen-4.11.3-3.fc30")) flag++;
