...
# extracted from Fedora Security Advisory FEDORA-2018-d7ea552cde.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-d7ea552cde");

  script_name(english:"Fedora 26 : cups-filters / qpdf (2018-d7ea552cde)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d7ea552cde"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"cups-filters-1.13.4-5.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"qpdf-7.1.1-5.fc26")) flag++;
