...
# extracted from Fedora Security Advisory 2014-17272.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-17272");

  script_name(english:"Fedora 20 : ca-certificates-2014.2.2-1.0.fc20 (2014-17272)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/147983.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a6663d76"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"ca-certificates-2014.2.2-1.0.fc20")) flag++;
