...
# extracted from Fedora Security Advisory 2014-5396.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5396");

  script_name(english:"Fedora 19 : community-mysql-5.5.37-1.fc19 (2014-5396)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/132262.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c142fc47"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"community-mysql-5.5.37-1.fc19")) flag++;
