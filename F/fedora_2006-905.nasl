...
# extracted from Fedora Security Advisory 2006-905.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-905");

  script_name(english:"Fedora Core 5 : krb5-1.4.3-5.1 (2006-905)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-August/000493.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5d2cf151"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"krb5-debuginfo-1.4.3-5.1")) flag++;
if (rpm_check(release:"FC5", reference:"krb5-devel-1.4.3-5.1")) flag++;
if (rpm_check(release:"FC5", reference:"krb5-libs-1.4.3-5.1")) flag++;
if (rpm_check(release:"FC5", reference:"krb5-server-1.4.3-5.1")) flag++;
if (rpm_check(release:"FC5", reference:"krb5-workstation-1.4.3-5.1")) flag++;
