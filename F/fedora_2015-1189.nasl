...
# extracted from Fedora Security Advisory 2015-1189.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1189");

  script_name(english:"Fedora 21 : unzip-6.0-18.fc21 (2015-1189)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88356cd9"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"unzip-6.0-18.fc21")) flag++;
