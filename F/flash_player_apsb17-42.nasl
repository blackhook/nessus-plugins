...
if (description)
{
  ...
  script_name(english:"Adobe Flash Player <= 27.0.0.187 (APSB17-42)");
...
host is equal or prior to version 27.0.0.187. It is, therefore,
affected by a vulnerability which may allow an attacker
...
foreach variant (variants)
{
  ...
  foreach key (keys(vers))
  {
    ...
    # <= 27.0.0.187
    if (ver_compare(ver:ver,fix:"27.0.0.187",strict:FALSE) <= 0)
    {
      ...
      else if ("Chrome" >< variant)
      {
        ...
        if (variant == "Chrome")
          fix = "Upgrade to a version of Google Chrome running Flash Player 28.0.0.126";
      }
      info += '\n  Path              : ' + file +
              '\n  Installed version : ' + ver;
      if (variant == "Chrome_Pepper")
        info += '\n  Fixed version     : 28.0.0.126 (Chrome PepperFlash)';
      else if (!isnull(fix))
        info += '\n  Fixed version     : '+fix;
      info += '\n';
    }
