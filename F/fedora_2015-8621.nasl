...
# extracted from Fedora Security Advisory 2015-8621.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8621");

  script_name(english:"Fedora 22 : dcraw-9.25.0-2.fc22 (2015-8621)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159665.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b32a87d5"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"dcraw-9.25.0-2.fc22")) flag++;
