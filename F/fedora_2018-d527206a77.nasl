...
# extracted from Fedora Security Advisory FEDORA-2018-d527206a77.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : roundcubemail (2018-d527206a77)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d527206a77"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"roundcubemail-1.3.8-1.fc27")) flag++;
