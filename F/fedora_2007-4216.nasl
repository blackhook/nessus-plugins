...
# extracted from Fedora Security Advisory 2007-4216.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : ruby-gnome2-0.16.0-18.fc8 (2007-4216)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=405601"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-December/005676.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b9b5b7b"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"ruby-atk-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-atk-devel-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gconf2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gdkpixbuf2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-glib2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-glib2-devel-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gnome2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gnome2-debuginfo-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gnomecanvas2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gnomeprint2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gnomeprintui2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gnomevfs-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gtk2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gtk2-devel-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gtkglext-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gtkhtml2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gtkmozembed-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-gtksourceview-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-libart2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-libart2-devel-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-libglade2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-panelapplet2-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-pango-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-pango-devel-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-poppler-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-rsvg-0.16.0-18.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ruby-vte-0.16.0-18.fc8")) flag++;
