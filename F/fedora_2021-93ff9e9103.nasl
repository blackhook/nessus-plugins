...
# extracted from Fedora Security Advisory FEDORA-2021-93ff9e9103
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-93ff9e9103");

  script_name(english:"Fedora 33 : 2:ceph (2021-93ff9e9103)");
...
FEDORA-2021-93ff9e9103 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-93ff9e9103");
...
pkgs = [
    {'reference':'ceph-15.2.9-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'}
];
