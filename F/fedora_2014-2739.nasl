...
# extracted from Fedora Security Advisory 2014-2739.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-2739");

  script_name(english:"Fedora 20 : file-5.14-15.fc20 (2014-2739)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1065836"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128994.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?de799828"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"file-5.14-15.fc20")) flag++;
