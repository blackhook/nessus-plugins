...
# extracted from Fedora Security Advisory 2015-6860.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : wpa_supplicant-2.0-13.fc21 (2015-6860)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/156218.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2832ebb"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC21", reference:"wpa_supplicant-2.0-13.fc21")) flag++;
