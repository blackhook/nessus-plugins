...
# extracted from Fedora Security Advisory 2013-17305.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-4291", "CVE-2013-4296", "CVE-2013-4311");
  script_bugtraq_id(62508, 62510);
  script_xref(name:"FEDORA", value:"2013-17305");

  script_name(english:"Fedora 18 : libvirt-0.10.2.8-1.fc18 (2013-17305)");
...
"  - Rebased to version 0.10.2.8
    ...
    - Fix LXC container creation if selinux disabled (bz
      #977114)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/117749.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e7ab2cb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"libvirt-0.10.2.8-1.fc18")) flag++;
