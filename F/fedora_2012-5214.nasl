...
# extracted from Fedora Security Advisory 2012-5214.
#
...
if (description)
{
  ...
  script_bugtraq_id(52735, 52736, 52737);
  script_xref(name:"FEDORA", value:"2012-5214");

  script_name(english:"Fedora 17 : wireshark-1.6.6-2.fc17 (2012-5214)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/077296.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?430ea5e4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"wireshark-1.6.6-2.fc17")) flag++;
