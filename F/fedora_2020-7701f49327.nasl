...
# extracted from Fedora Security Advisory FEDORA-2020-7701f49327.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : wordpress (2020-7701f49327)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7701f49327"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"wordpress-5.4.1-1.fc31")) flag++;
