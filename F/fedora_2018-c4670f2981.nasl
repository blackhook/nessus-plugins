...
# extracted from Fedora Security Advisory FEDORA-2018-c4670f2981.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-c4670f2981");

  script_name(english:"Fedora 26 : linux-firmware (2018-c4670f2981)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c4670f2981"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"linux-firmware-20171215-82.git2451bb22.fc26")) flag++;
