...
# extracted from Fedora Security Advisory 2013-3457.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-3457");

  script_name(english:"Fedora 17 : poppler-0.18.4-4.fc17 (2013-3457)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes these security issues: CVE-2013-1788 and
CVE-2013-1790.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c77141fa"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"poppler-0.18.4-4.fc17")) flag++;
