...
# extracted from Fedora Security Advisory FEDORA-2017-c9828b259c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : lynx (2017-c9828b259c)");
  ...
  script_set_attribute(
    ...
    value:
"  - update to the latest upstream pre-release (fixes
    CVE-2016-9179)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c9828b259c"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"lynx-2.8.9-0.14.dev11.fc25")) flag++;
