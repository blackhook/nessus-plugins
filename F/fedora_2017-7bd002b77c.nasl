...
# extracted from Fedora Security Advisory FEDORA-2017-7bd002b77c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : 1:xrdp / xorgxrdp (2017-7bd002b77c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7bd002b77c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"xrdp-0.9.2-5.fc25", epoch:"1")) flag++;
if (rpm_check(release:"FC25", reference:"xorgxrdp-0.2.1-1.fc25")) flag++;
