...
# extracted from Fedora Security Advisory FEDORA-2017-df3032c978.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : quagga (2017-df3032c978)");
  ...
  script_set_attribute(
    ...
    value:
"rebase to version 1.2.2, solves CVE-2017-16227, solves error produced
by install script
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-df3032c978"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"quagga-1.2.2-1.fc26")) flag++;
