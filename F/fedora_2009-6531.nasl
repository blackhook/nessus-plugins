...
# extracted from Fedora Security Advisory 2009-6531.
#
...
if (description)
{
  ...
  script_bugtraq_id(33827, 35233);
  script_xref(name:"FEDORA", value:"2009-6531");

  script_name(english:"Fedora 10 : libpng-1.2.37-1.fc10 (2009-6531)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025137.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9d32828f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"libpng-1.2.37-1.fc10")) flag++;
