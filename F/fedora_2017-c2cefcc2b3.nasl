...
# extracted from Fedora Security Advisory FEDORA-2017-c2cefcc2b3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c2cefcc2b3");

  script_name(english:"Fedora 24 : icu (2017-c2cefcc2b3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c2cefcc2b3"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"icu-56.1-8.fc24")) flag++;
