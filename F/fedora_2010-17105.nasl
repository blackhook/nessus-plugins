...
# extracted from Fedora Security Advisory 2010-17105.
#
...
if (description)
{
  ...
  script_bugtraq_id(42817, 44243, 44245, 44246, 44247, 44248, 44249, 44250, 44251, 44252, 44253, 44425);
  script_xref(name:"FEDORA", value:"2010-17105");

  script_name(english:"Fedora 14 : seamonkey-2.0.10-1.fc14 (2010-17105)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-November/050233.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd2e0d35"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"seamonkey-2.0.10-1.fc14")) flag++;
