...
# extracted from Fedora Security Advisory FEDORA-2019-b1636e0b70.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-b1636e0b70");

  script_name(english:"Fedora 30 : sqlite (2019-b1636e0b70)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b1636e0b70"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"sqlite-3.26.0-7.fc30")) flag++;
