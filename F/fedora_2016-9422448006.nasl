...
# extracted from Fedora Security Advisory 2016-9422448006.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-9422448006");

  script_name(english:"Fedora 22 : owncloud-8.0.10-1.fc22 (2016-9422448006)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-January/175955.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6766c6c0"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"owncloud-8.0.10-1.fc22")) flag++;
