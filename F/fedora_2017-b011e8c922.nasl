...
# extracted from Fedora Security Advisory FEDORA-2017-b011e8c922.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b011e8c922");

  script_name(english:"Fedora 24 : 6:kdelibs (2017-b011e8c922)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b011e8c922"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"kdelibs-4.14.29-2.fc24", epoch:"6")) flag++;
