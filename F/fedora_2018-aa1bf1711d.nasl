...
# extracted from Fedora Security Advisory FEDORA-2018-aa1bf1711d.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15370", "CVE-2017-15372", "CVE-2017-15642");
  script_xref(name:"FEDORA", value:"2018-aa1bf1711d");

  script_name(english:"Fedora 26 : sox (2018-aa1bf1711d)");
  ...
  script_set_attribute(
    ...
    value:
"*SOX_PLUGINS* environment variable, added in *sox-14.4.2.0-16* to
allow overriding standard *sox* path to plugins for the test purposes,
is no longer exposed to user.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-aa1bf1711d"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"sox-14.4.2.0-17.fc26")) flag++;
