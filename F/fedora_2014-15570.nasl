...
# extracted from Fedora Security Advisory 2014-15570.
#
...
if (description)
{
  ...
  script_bugtraq_id(71209);
  script_xref(name:"FEDORA", value:"2014-15570");

  script_name(english:"Fedora 21 : python-pip-1.5.6-3.fc21 (2014-15570)");
...
flag = 0;
if (rpm_check(release:"FC21", reference:"python-pip-1.5.6-3.fc21")) flag++;
