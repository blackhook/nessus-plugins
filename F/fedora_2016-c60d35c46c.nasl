...
# extracted from Fedora Security Advisory FEDORA-2016-c60d35c46c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c60d35c46c");

  script_name(english:"Fedora 23 : 1:java-1.8.0-openjdk (2016-c60d35c46c)");
  ...
  script_set_attribute(
    ...
    value:
"updated to security jdk8u101-b14 (from aarch64-port/jdk8u)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c60d35c46c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"java-1.8.0-openjdk-1.8.0.101-1.b14.fc23", epoch:"1")) flag++;
