...
# extracted from Fedora Security Advisory 2004-110.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-110");

  script_name(english:"Fedora Core 1 : cvs-1.11.15-1 (2004-110)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-May/000122.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?68a37e08"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", reference:"cvs-1.11.15-1")) flag++;
if (rpm_check(release:"FC1", reference:"cvs-debuginfo-1.11.15-1")) flag++;
