...
# extracted from F5 Networks BIG-IP Solution K16950.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : SQLite vulnerability (K16950)");
...
crafted printf function call in a SELECT statement. (CVE-2015-3416)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16950"
  );
  script_set_attribute(
    attribute:"solution",
    value:
