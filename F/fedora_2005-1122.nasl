...
# extracted from Fedora Security Advisory 2005-1122.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1122");

  script_name(english:"Fedora Core 4 : xpdf-3.01-0.FC4.3 (2005-1122)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001627.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?124e3d2d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"xpdf-3.01-0.FC4.3")) flag++;
if (rpm_check(release:"FC4", reference:"xpdf-debuginfo-3.01-0.FC4.3")) flag++;
