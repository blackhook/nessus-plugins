...
if (description)
{
  ...
  script_name(english:"Fedora 36 : 5:podman (2023-998dbd3b79)");
...
FEDORA-2023-998dbd3b79 advisory.
  ...
  - symlink exchange attack in podman export volume [fedora-all] (CVE-2023-0778)
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, '5:podman');
}
