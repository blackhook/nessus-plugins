...
# extracted from Fedora Security Advisory FEDORA-2016-604616dc33.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : python3 (2016-604616dc33) (httpoxy)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-604616dc33"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"python3-3.4.3-12.fc23")) flag++;
