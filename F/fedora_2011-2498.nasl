...
# extracted from Fedora Security Advisory 2011-2498.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-2498");

  script_name(english:"Fedora 15 : libtiff-3.9.4-3.fc15 (2011-2498)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/055683.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0f7addcb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libtiff-3.9.4-3.fc15")) flag++;
