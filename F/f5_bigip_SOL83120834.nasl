...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Diffie-Hellman key agreement protocol vulnerability (K83120834)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is prior to tested version. It is, therefore, affected by
a vulnerability as referenced in the K83120834 advisory.
  ...
  - The Diffie-Hellman Key Agreement Protocol allows remote attackers (from the client side) to send arbitrary
    ...
    with DHE, and the server must be configured to allow DHE. (CVE-2002-20001)
...
var vmatrix = {
  ...
  'APM': {
    'affected': [
      '17.0.0-17.1.0','17.0.0','16.1.0-16.1.3','15.1.0-15.1.8','14.1.0-14.1.5','13.1.0-13.1.5'
    ],
    'unaffected': [
      '17.1.0'
    ],
