...
# extracted from Fedora Security Advisory FEDORA-2021-7d86bec29e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7d86bec29e");

  script_name(english:"Fedora 33 : 7:squid (2021-7d86bec29e)");
...
FEDORA-2021-7d86bec29e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7d86bec29e");
...
pkgs = [
    {'reference':'squid-4.14-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
