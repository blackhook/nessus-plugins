...
# extracted from Fedora Security Advisory 2015-7725.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7725");

  script_name(english:"Fedora 22 : wordpress-4.2.2-1.fc22 (2015-7725)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158773.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43f5bdc1"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"wordpress-4.2.2-1.fc22")) flag++;
