...
# extracted from Fedora Security Advisory 2014-14883.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-14883");

  script_name(english:"Fedora 20 : python-pillow-2.2.1-7.fc20 (2014-14883)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144755.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9ea9e002"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-pillow-2.2.1-7.fc20")) flag++;
