...
# extracted from Fedora Security Advisory 2013-23339.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-23339");

  script_name(english:"Fedora 20 : openttd-1.3.3-1.fc20 (2013-23339)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/125010.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a5f65d6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"openttd-1.3.3-1.fc20")) flag++;
