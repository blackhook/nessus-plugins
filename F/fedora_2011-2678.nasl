...
# extracted from Fedora Security Advisory 2011-2678.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-2678");

  script_name(english:"Fedora 13 : php-ZendFramework-1.11.4-1.fc13 (2011-2678)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/055737.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?373c2769"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"php-ZendFramework-1.11.4-1.fc13")) flag++;
