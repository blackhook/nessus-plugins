...
# extracted from Fedora Security Advisory 2007-1144.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : yelp-2.18.1-5.fc7 (2007-1144)");
...
contain an update to yelp built against the updated Firefox packages.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/002806.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e4aa840d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"yelp-2.18.1-5.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"yelp-debuginfo-2.18.1-5.fc7")) flag++;
