...
# extracted from Fedora Security Advisory FEDORA-2016-8491ec1ebd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-8491ec1ebd");

  script_name(english:"Fedora 23 : libarchive (2016-8491ec1ebd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-8491ec1ebd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"libarchive-3.1.2-15.fc23")) flag++;
