...
# extracted from Fedora Security Advisory FEDORA-2017-e58a762c3f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : qpdf (2017-e58a762c3f)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2017-11627, CVE-2017-11626, CVE-2017-11625,
CVE-2017-11624, CVE-2017-9208, CVE-2017-9209, CVE-2017-9210.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e58a762c3f"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected qpdf package.");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"qpdf-6.0.0-6.fc26")) flag++;
