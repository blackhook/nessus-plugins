...
# extracted from Fedora Security Advisory 2014-11641.
#
...
if (description)
{
  ...
  script_bugtraq_id(70237);
  script_xref(name:"FEDORA", value:"2014-11641");

  script_name(english:"Fedora 20 : qemu-1.6.2-9.fc20 (2014-11641)");
  ...
  script_set_attribute(
    ...
    value:
"  - CVE-2014-3640 qemu: slirp: NULL pointer (bz #1144821, bz
    #1144818)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00cfdfeb"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"qemu-1.6.2-9.fc20")) flag++;
