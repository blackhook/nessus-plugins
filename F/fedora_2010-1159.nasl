...
# extracted from Fedora Security Advisory 2010-1159.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : fuse-2.8.1-4.fc12 (2010-1159)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-February/034580.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2eb254d"
  );
...
flag = 0;
if (rpm_check(release:"FC12", reference:"fuse-2.8.1-4.fc12")) flag++;
