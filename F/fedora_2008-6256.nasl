...
# extracted from Fedora Security Advisory 2008-6256.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : bind-9.5.0-33.P1.fc9 (2008-6256)");
...
also fixes typo in bind-sdb summary and fixes parsing of inner ACLs.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-July/012282.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?55601577"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"bind-9.5.0-33.P1.fc9")) flag++;
