...
# extracted from Fedora Security Advisory 2015-0301.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-0301");

  script_name(english:"Fedora 21 : exiv2-0.24-4.fc21 (2015-0301)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1178908"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148382.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?28939d1f"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"exiv2-0.24-4.fc21")) flag++;
