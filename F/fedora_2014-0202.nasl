...
# extracted from Fedora Security Advisory 2014-0202.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-0202");

  script_name(english:"Fedora 20 : x2goserver-4.0.1.10-1.fc20 (2014-0202)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a1b7152"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2014/01/04");
...
flag = 0;
if (rpm_check(release:"FC20", reference:"x2goserver-4.0.1.10-1.fc20")) flag++;
