...
# extracted from Fedora Security Advisory FEDORA-2016-b967ac1a74.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b967ac1a74");

  script_name(english:"Fedora 24 : php (2016-b967ac1a74)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-b967ac1a74"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"php-5.6.22-1.fc24")) flag++;
