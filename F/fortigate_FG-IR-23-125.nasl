...
vulnerability as referenced in the FG-IR-23-125 advisory.
  ...
  - A NULL pointer dereference vulnerability [CWE-476] in FortiOS may allow an authenticated attacker to crash
    the SSL-VPN daemon via specially crafted HTTP requests to the /proxy endpoint (CVE-2023-29179)
