...
# extracted from Fedora Security Advisory 2007-1044.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : gimp-2.2.16-2.fc7 (2007-1044)");
  ...
  script_set_attribute(
    ...
    value:
"  - Wed Jul 11 2007 Nils Philippsen <nphilipp at redhat.com>
    - 2:2.2.16-2
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/002716.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?20aeae0a"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"gimp-2.2.16-2.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gimp-debuginfo-2.2.16-2.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gimp-devel-2.2.16-2.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gimp-libs-2.2.16-2.fc7")) flag++;
