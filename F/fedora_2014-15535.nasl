...
# extracted from Fedora Security Advisory 2014-15535.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15535");

  script_name(english:"Fedora 19 : phpMyAdmin-4.2.12-1.fc19 (2014-15535)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145023.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1ceb84c0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"phpMyAdmin-4.2.12-1.fc19")) flag++;
