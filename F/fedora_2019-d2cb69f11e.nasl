...
# extracted from Fedora Security Advisory FEDORA-2019-d2cb69f11e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-d2cb69f11e");

  script_name(english:"Fedora 29 : krb5 (2019-d2cb69f11e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d2cb69f11e"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"krb5-1.16.1-24.fc29")) flag++;
