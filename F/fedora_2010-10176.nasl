...
# extracted from Fedora Security Advisory 2010-10176.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : drupal-cck-6.x.2.7-1.fc12 (2010-10176)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/043172.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5332525e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"drupal-cck-6.x.2.7-1.fc12")) flag++;
