...
# extracted from Fedora Security Advisory 2004-489.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-489");

  script_name(english:"Fedora Core 2 : cyrus-imapd-2.2.10-1.fc2 (2004-489)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-December/000461.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?320f8938"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"cyrus-imapd-2.2.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"cyrus-imapd-devel-2.2.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"cyrus-imapd-murder-2.2.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"cyrus-imapd-nntp-2.2.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"cyrus-imapd-utils-2.2.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"perl-Cyrus-2.2.10-1.fc2")) flag++;
