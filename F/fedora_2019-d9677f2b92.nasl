...
# extracted from Fedora Security Advisory FEDORA-2019-d9677f2b92.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : wordpress (2019-d9677f2b92)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d9677f2b92"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"wordpress-5.2.3-1.fc30")) flag++;
