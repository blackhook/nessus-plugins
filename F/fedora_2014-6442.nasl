...
# extracted from Fedora Security Advisory 2014-6442.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6442");

  script_name(english:"Fedora 20 : python-django14-1.4.13-1.fc20 (2014-6442)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133699.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d6ee9ef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-django14-1.4.13-1.fc20")) flag++;
