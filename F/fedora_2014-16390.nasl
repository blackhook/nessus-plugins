...
# extracted from Fedora Security Advisory 2014-16390.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : python-tornado-2.2.1-7.fc20 (2014-16390)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/146329.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?795a72e2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-tornado-2.2.1-7.fc20")) flag++;
