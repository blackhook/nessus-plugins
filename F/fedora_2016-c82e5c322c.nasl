...
# extracted from Fedora Security Advisory 2016-c82e5c322c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c82e5c322c");

  script_name(english:"Fedora 23 : gajim-0.16.5-1.fc23 (2016-c82e5c322c)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80695a12"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"gajim-0.16.5-1.fc23")) flag++;
