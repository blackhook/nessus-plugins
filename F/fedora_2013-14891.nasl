...
# extracted from Fedora Security Advisory 2013-14891.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-14891");

  script_name(english:"Fedora 19 : python-virtualenv-1.10.1-1.fc19 (2013-14891)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=994182"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115118.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd3665d3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python-virtualenv-1.10.1-1.fc19")) flag++;
