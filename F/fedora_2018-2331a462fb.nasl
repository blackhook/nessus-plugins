...
# extracted from Fedora Security Advisory FEDORA-2018-2331a462fb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-2331a462fb");

  script_name(english:"Fedora 27 : milkytracker (2018-2331a462fb)");
  ...
  script_set_attribute(
    ...
    value:
"New upstream version Security fix for upstream issue 35
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2331a462fb"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/milkytracker/MilkyTracker/issues/35"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"milkytracker-1.01.00-1.fc27")) flag++;
