...
# extracted from Fedora Security Advisory 2011-6245.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6245");

  script_name(english:"Fedora 14 : seamonkey-2.0.14-1.fc14 (2011-6245)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059996.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ec8cd8af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"seamonkey-2.0.14-1.fc14")) flag++;
