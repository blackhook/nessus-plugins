...
# extracted from Fedora Security Advisory FEDORA-2020-f3fa778924.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-f3fa778924");

  script_name(english:"Fedora 30 : webkit2gtk3 (2020-f3fa778924)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f3fa778924"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"webkit2gtk3-2.28.0-5.fc30")) flag++;
