...
# extracted from Fedora Security Advisory FEDORA-2016-d4571bf555.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-d4571bf555");

  script_name(english:"Fedora 25 : python-django (2016-d4571bf555)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-9013, CVE-2016-9014
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-d4571bf555"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"python-django-1.9.11-1.fc25")) flag++;
