...
# extracted from Fedora Security Advisory FEDORA-2020-68ef4b6bc5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : seamonkey (2020-68ef4b6bc5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-68ef4b6bc5"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"seamonkey-2.53.5-2.fc33")) flag++;
