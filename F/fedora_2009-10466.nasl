...
# extracted from Fedora Security Advisory 2009-10466.
#
...
if (description)
{
  ...
  script_bugtraq_id(36584);
  script_xref(name:"FEDORA", value:"2009-10466");

  script_name(english:"Fedora 11 : drupal-service_links-6.x.1.0-5.fc11 (2009-10466)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.madirish.net/?article=251"
  );
  # http://www.securityfocus.com/bid/36584
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/bid/36584"
  );
  # http://xforce.iss.net/xforce/xfdb/53633
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ebdaabbf"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=528200"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030030.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ef8a2398"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected drupal-service_links package."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:drupal-service_links");
...
flag = 0;
if (rpm_check(release:"FC11", reference:"drupal-service_links-6.x.1.0-5.fc11")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "drupal-service_links");
}
