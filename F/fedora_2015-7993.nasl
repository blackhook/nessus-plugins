...
# extracted from Fedora Security Advisory 2015-7993.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7993");

  script_name(english:"Fedora 22 : LibRaw-0.16.1-6.fc22 (2015-7993)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/157876.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88d3ed3d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"LibRaw-0.16.1-6.fc22")) flag++;
