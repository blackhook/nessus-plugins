...
# extracted from Fedora Security Advisory 2013-12667.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12667");

  script_name(english:"Fedora 19 : file-roller-3.8.3-1.fc19 (2013-12667)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2816b84c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"file-roller-3.8.3-1.fc19")) flag++;
