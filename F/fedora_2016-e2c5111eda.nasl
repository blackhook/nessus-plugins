...
# extracted from Fedora Security Advisory 2016-e2c5111eda.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e2c5111eda");

  script_name(english:"Fedora 22 : prosody-0.9.10-1.fc22 (2016-e2c5111eda)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-February/176796.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1793723d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"prosody-0.9.10-1.fc22")) flag++;
