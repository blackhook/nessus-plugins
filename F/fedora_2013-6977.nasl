...
# extracted from Fedora Security Advisory 2013-6977.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-6977");

  script_name(english:"Fedora 18 : phpMyAdmin-3.5.8.1-1.fc18 (2013-6977)");
...
"phpMyAdmin 3.5.8.1 (2013-04-24) ===============================
  ...
  - [security] Remote code execution (preg_replace),
    ...
    - [security] Locally Saved SQL Dump File Multiple File
      Extension Remote Code Execution, reported by Janek
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=956398"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=956401"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/104770.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5fd709a7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"phpMyAdmin-3.5.8.1-1.fc18")) flag++;
