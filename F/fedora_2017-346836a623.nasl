...
# extracted from Fedora Security Advisory FEDORA-2017-346836a623.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-346836a623");

  script_name(english:"Fedora 25 : phpldapadmin (2017-346836a623)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-346836a623"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"phpldapadmin-1.2.3-10.fc25")) flag++;
