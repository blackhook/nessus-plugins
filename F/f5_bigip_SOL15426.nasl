...
# extracted from F5 Networks BIG-IP Solution SOL15426.
#
...
if (description)
{
  ...
  script_bugtraq_id(67671);

  script_name(english:"F5 Networks BIG-IP : Apache Tomcat vulnerability (SOL15426)");
...
a request during the streaming of data."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15426"
  );
  script_set_attribute(
    attribute:"solution",
    value:
