...
# extracted from Fedora Security Advisory FEDORA-2016-047a86f5b1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : setroubleshoot (2016-047a86f5b1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-047a86f5b1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"setroubleshoot-3.3.9.1-1.fc24")) flag++;
