...
# extracted from Fedora Security Advisory 2013-0245.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 17 : rubygem-activerecord-3.0.11-4.fc17 (2013-0245)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/096815.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f5d4195b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"rubygem-activerecord-3.0.11-4.fc17")) flag++;
