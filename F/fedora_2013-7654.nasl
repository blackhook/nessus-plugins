...
# extracted from Fedora Security Advisory 2013-7654.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-7654");

  script_name(english:"Fedora 19 : mediawiki-1.20.5-1.fc19 (2013-7654)");
...
"Changes since 1.20.4
  ...
  - (bug 46590) Add hook AbortChangePassword to
    ...
    - (bug 43594) Correctly supress warnings that were
      missed after the upstream
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://translatewiki.net/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=958303"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/106293.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3edcc808"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"mediawiki-1.20.5-1.fc19")) flag++;
