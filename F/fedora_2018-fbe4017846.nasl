...
# extracted from Fedora Security Advisory FEDORA-2018-fbe4017846.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : dnsmasq (2018-fbe4017846)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-fbe4017846"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"dnsmasq-2.78-2.fc27")) flag++;
