...
# extracted from Fedora Security Advisory 2011-7546.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7546");

  script_name(english:"Fedora 13 : drupal-6.22-1.fc13 (2011-7546)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061174.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?044948e4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"drupal-6.22-1.fc13")) flag++;
