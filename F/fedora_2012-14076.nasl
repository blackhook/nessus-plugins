...
# extracted from Fedora Security Advisory 2012-14076.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14076");

  script_name(english:"Fedora 16 : dhcp-4.2.4-1.P2.fc16 (2012-14076)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e08c13d9"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"dhcp-4.2.4-1.P2.fc16")) flag++;
