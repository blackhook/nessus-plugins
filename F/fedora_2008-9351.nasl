...
# extracted from Fedora Security Advisory 2008-9351.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : enscript-1.6.4-9.fc8 (2008-9351)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-November/015881.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ecd19fd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"enscript-1.6.4-9.fc8")) flag++;
