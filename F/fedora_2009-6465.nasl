...
# extracted from Fedora Security Advisory 2009-6465.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6465");

  script_name(english:"Fedora 11 : mutt-1.5.19-5.fc11 (2009-6465)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=504979"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025096.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88b8c240"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"mutt-1.5.19-5.fc11")) flag++;
