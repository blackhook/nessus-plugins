...
# extracted from Fedora Security Advisory 2014-12935.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12935");

  script_name(english:"Fedora 21 : java-1.8.0-openjdk-1.8.0.25-0.b18.fc21 (2014-12935)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/142022.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?08612bdf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"java-1.8.0-openjdk-1.8.0.25-0.b18.fc21")) flag++;
