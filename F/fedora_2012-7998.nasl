...
# extracted from Fedora Security Advisory 2012-7998.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-7998");

  script_name(english:"Fedora 17 : sudo-1.8.3p1-7.fc17 (2012-7998)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?adf43858"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"sudo-1.8.3p1-7.fc17")) flag++;
