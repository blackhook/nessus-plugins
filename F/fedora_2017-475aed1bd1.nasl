...
# extracted from Fedora Security Advisory FEDORA-2017-475aed1bd1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-475aed1bd1");

  script_name(english:"Fedora 26 : rt (2017-475aed1bd1)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-6127 CVE-2017-5361 CVE-2017-5943
CVE-2017-5944
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-475aed1bd1"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"rt-4.4.1-9.fc26")) flag++;
