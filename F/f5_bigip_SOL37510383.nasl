...
# extracted from F5 Networks BIG-IP Solution K37510383.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux kernel SCTP vulnerability (K37510383)");
...
have finished. (CVE-2015-5283)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K37510383"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["PEM"]["affected"  ] = make_list("12.0.0-12.1.5","11.3.0-11.6.3");
