...
# extracted from Fedora Security Advisory 2009-8169.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8169");

  script_name(english:"Fedora 10 : Django-1.0.3-6.fc10 (2009-8169)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.djangoproject.com/weblog/2009/jul/28/security/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=514581"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027325.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b1fbb717"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"Django-1.0.3-6.fc10")) flag++;
