...
# extracted from Fedora Security Advisory FEDORA-2016-83cd045bcc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : libgcrypt (2016-83cd045bcc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-83cd045bcc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libgcrypt-1.6.5-1.fc24")) flag++;
