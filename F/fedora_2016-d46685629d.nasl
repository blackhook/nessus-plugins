...
# extracted from Fedora Security Advisory FEDORA-2016-d46685629d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-d46685629d");

  script_name(english:"Fedora 23 : libreswan (2016-d46685629d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-d46685629d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"libreswan-3.18-1.fc23")) flag++;
