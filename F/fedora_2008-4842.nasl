...
# extracted from Fedora Security Advisory 2008-4842.
#
...
if (description)
{
  ...
  script_xref(name:"Secunia", value:"30401");

  script_name(english:"Fedora 8 : imlib2-1.4.0-7.fc8 (2008-4842)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=449073"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-June/010773.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8718ea6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"imlib2-1.4.0-7.fc8")) flag++;
