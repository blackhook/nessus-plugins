...
# extracted from Fedora Security Advisory 2012-20620.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-20620");

  script_name(english:"Fedora 17 : inkscape-0.48.4-1.fc17 (2012-20620)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/095380.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aee86545"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"inkscape-0.48.4-1.fc17")) flag++;
