...
# extracted from Fedora Security Advisory 2012-19056.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-19056");

  script_name(english:"Fedora 18 : squashfs-tools-4.2-5.fc18 (2012-19056)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/094426.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd1357ec"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"squashfs-tools-4.2-5.fc18")) flag++;
