...
# extracted from Fedora Security Advisory FEDORA-2016-72d7f05b90.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-72d7f05b90");

  script_name(english:"Fedora 25 : libXfixes (2016-72d7f05b90)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-72d7f05b90"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libXfixes-5.0.3-1.fc25")) flag++;
