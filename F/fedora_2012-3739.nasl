...
# extracted from Fedora Security Advisory 2012-3739.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-3739");

  script_name(english:"Fedora 16 : libpng-1.2.48-1.fc16 (2012-3739)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e0d7cd90"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"libpng-1.2.48-1.fc16")) flag++;
