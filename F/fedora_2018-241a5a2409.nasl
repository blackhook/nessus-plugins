...
# extracted from Fedora Security Advisory FEDORA-2018-241a5a2409.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : curl (2018-241a5a2409)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-241a5a2409"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"curl-7.55.1-9.fc27")) flag++;
