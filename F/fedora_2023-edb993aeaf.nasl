...
FEDORA-2023-edb993aeaf advisory.
  ...
  - This is the June 2023 monthly update for .NET 6. It includes fixes for several CVEs.  Release Notes: -
    Runtime: https://github.com/dotnet/core/blob/main/release-notes/6.0/6.0.18/6.0.18.md - SDK:
    https://github.com/dotnet/core/blob/main/release-notes/6.0/6.0.18/6.0.118.md (FEDORA-2023-edb993aeaf)
