...
# extracted from Fedora Security Advisory 2014-13535.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13535");

  script_name(english:"Fedora 21 : file-5.19-7.fc21 (2014-13535)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1155071"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/143278.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c563b122"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"file-5.19-7.fc21")) flag++;
