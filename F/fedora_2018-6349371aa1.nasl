...
# extracted from Fedora Security Advisory FEDORA-2018-6349371aa1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-6349371aa1");

  script_name(english:"Fedora 27 : libvpx (2018-6349371aa1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6349371aa1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libvpx-1.6.1-5.fc27")) flag++;
