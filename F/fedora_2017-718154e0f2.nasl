...
# extracted from Fedora Security Advisory FEDORA-2017-718154e0f2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-718154e0f2");

  script_name(english:"Fedora 26 : mbedtls (2017-718154e0f2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-718154e0f2"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mbedtls-2.4.2-1.fc26")) flag++;
