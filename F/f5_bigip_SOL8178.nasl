...
# extracted from F5 Networks BIG-IP Solution SOL8178.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : MySQL vulnerabilities (SOL8178)");
  ...
  script_set_attribute(
    ...
    value:
"Information about these advisories is available at the following
locations :"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K8178"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
