...
# extracted from Fedora Security Advisory 2015-8498.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8498");

  script_name(english:"Fedora 21 : mingw-LibRaw-0.16.2-1.fc21 (2015-8498)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/159123.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fbeec3f4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mingw-LibRaw-0.16.2-1.fc21")) flag++;
