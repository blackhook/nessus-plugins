...
# extracted from Fedora Security Advisory 2008-11257.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 10 : phpMyAdmin-3.1.1-1.fc10 (2008-11257)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-December/017740.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c64820cc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"phpMyAdmin-3.1.1-1.fc10")) flag++;
