...
# extracted from F5 Networks BIG-IP Solution K25102203.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : ImageMagick vulnerability (K25102203)");
...
known as ImageTragick."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K25102203"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
