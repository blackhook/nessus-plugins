...
# extracted from Fedora Security Advisory FEDORA-2016-97ca9d52a4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-97ca9d52a4");

  script_name(english:"Fedora 23 : python-django (2016-97ca9d52a4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-97ca9d52a4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"python-django-1.8.14-1.fc23")) flag++;
