...
# extracted from Fedora Security Advisory FEDORA-2017-988ee3e365.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-988ee3e365");

  script_name(english:"Fedora 26 : ettercap (2017-988ee3e365)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-988ee3e365"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"ettercap-0.8.2-8.20170306git60aca9.fc26")) flag++;
