...
# extracted from Fedora Security Advisory FEDORA-2017-08a350c878.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-08a350c878");

  script_name(english:"Fedora 25 : kernel (2017-08a350c878)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-08a350c878"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2017-08a350c878");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC25", reference:"kernel-4.13.12-100.fc25")) flag++;
