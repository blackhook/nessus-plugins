...
# extracted from Fedora Security Advisory FEDORA-2021-a311bf10d4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a311bf10d4");

  script_name(english:"Fedora 32 : python39 (2021-a311bf10d4)");
...
FEDORA-2021-a311bf10d4 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a311bf10d4");
...
pkgs = [
    {'reference':'python39-3.9.4-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
