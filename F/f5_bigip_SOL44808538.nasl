...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"When multiple HTTP requests from the same client toconfigured SAML
Single Logout (SLO) URL are passing through aTCP Keep-Alive
connection, traffic to theTraffic Management Microkernel (TMM) can be
disrupted. (CVE-2020-5934)

Impact

A remote attacker may be able to cause a traffic disruption or
failover event on the BIG-IP APM system."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K44808538"
  );
  script_set_attribute(
    attribute:"solution",
    value:
