...
# extracted from Fedora Security Advisory 2006-194.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-194");

  script_name(english:"Fedora Core 4 : sendmail-8.13.6-0.FC4.1 (2006-194)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-April/001980.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f1f2df1e"
  );
  # https://lists.fedoraproject.org/pipermail/announce/2006-March/001898.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2720e69"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"sendmail-8.13.6-0.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-cf-8.13.6-0.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-debuginfo-8.13.6-0.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-devel-8.13.6-0.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-doc-8.13.6-0.FC4.1")) flag++;
