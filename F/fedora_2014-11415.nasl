...
# extracted from Fedora Security Advisory 2014-11415.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11415");

  script_name(english:"Fedora 20 : nginx-1.4.7-3.fc20 (2014-11415)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/140360.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf21b09f"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"nginx-1.4.7-3.fc20")) flag++;
