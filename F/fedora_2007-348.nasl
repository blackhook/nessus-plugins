...
# extracted from Fedora Security Advisory 2007-348.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 5 : tcpdump-3.9.4-4.fc5 (2007-348)");
...
"  - Thu Mar 15 2007 Miroslav Lichvar <mlichvar at
    ...
    - Wed Nov 8 2006 Miroslav Lichvar <mlichvar at
      redhat.com> - 14:3.9.4-3.fc5

    - fix processing of Prism and AVS headers (#207435)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-March/001576.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?11b1a1d8"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"arpwatch-2.1a13-15.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"libpcap-0.9.4-4.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"tcpdump-3.9.4-4.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"tcpdump-debuginfo-3.9.4-4.fc5")) flag++;
