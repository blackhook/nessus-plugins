...
# extracted from Fedora Security Advisory 2011-5304.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2009-5022", "CVE-2010-4665");
  script_bugtraq_id(47338);
  script_xref(name:"FEDORA", value:"2011-5304");

  script_name(english:"Fedora 14 : libtiff-3.9.5-1.fc14 (2011-5304)");
...
other fixes, notably the fix for CVE-2009-5022
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058478.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8c33a3ba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"libtiff-3.9.5-1.fc14")) flag++;
