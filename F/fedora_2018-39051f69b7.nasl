...
# extracted from Fedora Security Advisory FEDORA-2018-39051f69b7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : freeipa (2018-39051f69b7)");
  ...
  script_set_attribute(
    ...
    value:
"dbus-python dependency was added to freeipa-server to make sure
ipa-dnskeysyncd is usable. ipa-dnskeysyncd is still using Python 2 in
Fedora 27.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-39051f69b7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"freeipa-4.6.4-2.fc27")) flag++;
