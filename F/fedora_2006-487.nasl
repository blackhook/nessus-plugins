...
# extracted from Fedora Security Advisory 2006-487.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-487");

  script_name(english:"Fedora Core 5 : mozilla-1.7.13-1.1.fc5 (2006-487)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000018.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a32f3ef8"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"mozilla-1.7.13-1.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"mozilla-chat-1.7.13-1.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"mozilla-debuginfo-1.7.13-1.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"mozilla-devel-1.7.13-1.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"mozilla-dom-inspector-1.7.13-1.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"mozilla-js-debugger-1.7.13-1.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"mozilla-mail-1.7.13-1.1.fc5")) flag++;
