...
# extracted from Fedora Security Advisory FEDORA-2016-6b1938566f.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-5093", "CVE-2016-5096");
  script_xref(name:"FEDORA", value:"2016-6b1938566f");

  script_name(english:"Fedora 23 : php (2016-6b1938566f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-6b1938566f"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-5.6.22-1.fc23")) flag++;
