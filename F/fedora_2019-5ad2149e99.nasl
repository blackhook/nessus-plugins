...
# extracted from Fedora Security Advisory FEDORA-2019-5ad2149e99.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2019-3498", "CVE-2019-6975");
  script_xref(name:"FEDORA", value:"2019-5ad2149e99");

  script_name(english:"Fedora 28 : python2-django1.11 (2019-5ad2149e99)");
  ...
  script_set_attribute(
    ...
    value:
"  - CVE-2019-3498: Content spoofing possibility in the
    default 404 page
  ...
  - geo: Prevented repetitive calls to geos_version_tuple()
    in the WKBWriter class
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5ad2149e99"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python2-django1.11-1.11.20-1.fc28")) flag++;
