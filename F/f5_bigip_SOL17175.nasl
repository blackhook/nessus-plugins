...
# extracted from F5 Networks BIG-IP Solution K17175.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-4731");
  script_bugtraq_id(75812);

  script_name(english:"F5 Networks BIG-IP : OpenJDK vulnerability (K17175)");
...
SE Embedded 7u75; and Java SE Embedded 8u33 allows remote attackers to
affect confidentiality, integrity, and availability via vectors
related to JMX. (CVE-2015-4731)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17175"
  );
  script_set_attribute(
    attribute:"solution",
    value:
