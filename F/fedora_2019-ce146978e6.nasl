...
# extracted from Fedora Security Advisory FEDORA-2019-ce146978e6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : haproxy (2019-ce146978e6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ce146978e6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"haproxy-1.8.23-1.fc30")) flag++;
