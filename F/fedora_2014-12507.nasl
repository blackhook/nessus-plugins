...
# extracted from Fedora Security Advisory 2014-12507.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12507");

  script_name(english:"Fedora 20 : openjpeg-1.5.1-13.fc20 (2014-12507)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/140667.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?44633307"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"openjpeg-1.5.1-13.fc20")) flag++;
