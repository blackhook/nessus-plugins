...
# extracted from Fedora Security Advisory 2012-10000.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-10000");

  script_name(english:"Fedora 17 : openldap-2.4.31-3.fc17 (2012-10000)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-July/083890.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00a30067"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"openldap-2.4.31-3.fc17")) flag++;
