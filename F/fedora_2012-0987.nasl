...
# extracted from Fedora Security Advisory 2012-0987.
#
...
if (description)
{
  ...
  script_bugtraq_id(51488, 51493, 51503, 51504, 51506, 51507, 51508, 51510, 51511, 51512, 51513, 51514, 51515, 51516, 51517, 51518, 51519, 51520, 51521, 51522, 51523, 51524, 51525, 51526);
  script_xref(name:"FEDORA", value:"2012-0987");

  script_name(english:"Fedora 15 : mysql-5.5.20-1.fc15 (2012-0987)");
...
http://dev.mysql.com/doc/refman/5.5/en/news-5-5-20.html as well as
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/073182.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8fb303e"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"mysql-5.5.20-1.fc15")) flag++;
