...
# extracted from Fedora Security Advisory 2013-11568.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-11568");

  script_name(english:"Fedora 17 : curl-7.24.0-10.fc17 (2013-11568)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/112218.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c4d232f"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"curl-7.24.0-10.fc17")) flag++;
