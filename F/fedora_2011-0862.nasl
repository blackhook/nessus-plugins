...
# extracted from Fedora Security Advisory 2011-0862.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0862");

  script_name(english:"Fedora 14 : dhcp-4.2.0-19.P2.fc14 (2011-0862)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-February/053644.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74e9a8ab"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"dhcp-4.2.0-19.P2.fc14")) flag++;
