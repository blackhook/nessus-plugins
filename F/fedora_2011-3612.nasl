...
# extracted from Fedora Security Advisory 2011-3612.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3612");

  script_name(english:"Fedora 15 : openldap-2.4.24-2.fc15 (2011-3612)");
...
Changes not covered by bugs :
  ...
  - new: system resource limiting for slapd using ulimit
    ...
    - fix: possible NULL pointer dereference in NSS
      implementation OpenLDAP package was rebased to 2.4.24.

Extension of API :

  - libldap adds: ldap_destroy ldap_dup
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058639.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb893d2c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"openldap-2.4.24-2.fc15")) flag++;
