...
# extracted from Fedora Security Advisory 2015-1488.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1488");

  script_name(english:"Fedora 21 : pigz-2.3.3-1.fc21 (2015-1488)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-February/149937.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c9079ed"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"pigz-2.3.3-1.fc21")) flag++;
