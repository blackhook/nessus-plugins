...
# extracted from Fedora Security Advisory 2013-18686.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-18686");

  script_name(english:"Fedora 18 : mod_fcgid-2.3.9-1.fc18 (2013-18686)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119351.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0310f1a6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"mod_fcgid-2.3.9-1.fc18")) flag++;
