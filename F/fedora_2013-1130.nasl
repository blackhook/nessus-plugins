...
# extracted from Fedora Security Advisory 2013-1130.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-1130");

  script_name(english:"Fedora 16 : php-symfony2-Yaml-2.0.22-1.fc16 (2013-1130)");
...
Changelog:
https://github.com/symfony/symfony/blob/v2.0.22/CHANGELOG-2.0.md
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9c0fab9d"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/symfony/symfony/blob/v2.0.22/CHANGELOG-2.0.md"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/097596.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ad82505"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"php-symfony2-Yaml-2.0.22-1.fc16")) flag++;
