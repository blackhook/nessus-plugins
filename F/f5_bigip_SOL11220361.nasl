...
# extracted from F5 Networks BIG-IP Solution K11220361.
#
...
if (description)
{
  ...
  script_bugtraq_id(73438);

  script_name(english:"F5 Networks BIG-IP : LibTIFF vulnerability (K11220361)");
...
settings enabled for TIFF files are vulnerable to this issue."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K11220361"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AM"]["affected"  ] = make_list("13.0.0","12.0.0-12.1.2","11.4.1-11.6.1");
