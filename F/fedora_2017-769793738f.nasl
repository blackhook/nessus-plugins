...
# extracted from Fedora Security Advisory FEDORA-2017-769793738f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-769793738f");

  script_name(english:"Fedora 26 : jasper (2017-769793738f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-769793738f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"jasper-2.0.14-1.fc26")) flag++;
