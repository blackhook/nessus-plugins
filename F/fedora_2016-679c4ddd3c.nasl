...
# extracted from Fedora Security Advisory 2016-679c4ddd3c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-679c4ddd3c");

  script_name(english:"Fedora 24 : ansible-2.0.2.0-1.fc24 (2016-679c4ddd3c)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-May/184175.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a06a2fbf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"ansible-2.0.2.0-1.fc24")) flag++;
