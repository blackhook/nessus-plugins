...
# extracted from Fedora Security Advisory 2014-3606.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-3606");

  script_name(english:"Fedora 20 : file-5.14-17.fc20 (2014-3606)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-March/130007.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ab40cf34"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"file-5.14-17.fc20")) flag++;
