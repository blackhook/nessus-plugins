...
# extracted from Fedora Security Advisory FEDORA-2019-94fb5d75e6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-94fb5d75e6");

  script_name(english:"Fedora 30 : libzip (2019-94fb5d75e6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-94fb5d75e6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libzip-1.5.2-1.fc30")) flag++;
