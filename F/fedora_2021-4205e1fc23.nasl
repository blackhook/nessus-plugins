...
# extracted from Fedora Security Advisory FEDORA-2021-4205e1fc23
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-4205e1fc23");

  script_name(english:"Fedora 32 : 5:mutt (2021-4205e1fc23)");
...
FEDORA-2021-4205e1fc23 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-4205e1fc23");
...
pkgs = [
    {'reference':'mutt-2.0.5-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
