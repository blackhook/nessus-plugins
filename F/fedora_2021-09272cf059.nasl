...
# extracted from Fedora Security Advisory FEDORA-2021-09272cf059
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-09272cf059");

  script_name(english:"Fedora 33 : 1:java-1.8.0-openjdk (2021-09272cf059)");
...
FEDORA-2021-09272cf059 advisory.
  ...
  - # New in release OpenJDK 8u282 (2021-01-19)  Live versions of these release notes can be found at:  *
    ...
    policy.   * Make java-1.8.0-openjdk-demo own its directories as well as its files (FEDORA-2021-09272cf059)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-09272cf059");
...
pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.282.b08-0.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
