...
# extracted from Fedora Security Advisory 2007-0414.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : libexif-0.6.15-2.fc7 (2007-0414)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-June/002040.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?843f9de2"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC7", reference:"libexif-0.6.15-2.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"libexif-debuginfo-0.6.15-2.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"libexif-devel-0.6.15-2.fc7")) flag++;
