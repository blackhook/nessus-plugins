...
# extracted from Fedora Security Advisory 2014-15779.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15779");

  script_name(english:"Fedora 21 : docker-io-1.3.2-2.fc21 (2014-15779)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1167505"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1167506"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145154.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7db0ff31"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"docker-io-1.3.2-2.fc21")) flag++;
