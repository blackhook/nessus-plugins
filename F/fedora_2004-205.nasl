...
# extracted from Fedora Security Advisory 2004-205.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-205");

  script_name(english:"Fedora Core 2 : kernel-2.6.6-1.435.2.3 (2004-205)");
...
name CVE-2004-0497 to this issue.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-July/000206.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d5401ab9"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"kernel-2.6.6-1.435.2.3")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-debuginfo-2.6.6-1.435.2.3")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-doc-2.6.6-1.435.2.3")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-smp-2.6.6-1.435.2.3")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-sourcecode-2.6.6-1.435.2.3")) flag++;
