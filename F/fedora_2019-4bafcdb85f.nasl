...
# extracted from Fedora Security Advisory FEDORA-2019-4bafcdb85f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 1:java-11-openjdk (2019-4bafcdb85f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4bafcdb85f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"java-11-openjdk-11.0.5.10-0.fc29", epoch:"1")) flag++;
