...
# extracted from Fedora Security Advisory 2011-16833.
#
...
if (description)
{
  ...
  script_bugtraq_id(50923);
  script_xref(name:"FEDORA", value:"2011-16833");

  script_name(english:"Fedora 16 : moodle-2.0.6-1.fc16 (2011-16833)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=761249"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=761250"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-December/071200.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43bc0858"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"moodle-2.0.6-1.fc16")) flag++;
