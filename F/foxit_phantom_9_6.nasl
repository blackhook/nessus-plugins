...
if (description)
{
  ...
  script_summary(english:"Checks version of Foxit PhantomPDF");
...
host is prior to 9.6. It is, therefore affected by  multiple vulnerabilities: Note that Nessus has not tested for this
...
"Upgrade to Foxit PhantomPDF version 9.6 or later");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-6776");
