...
# extracted from Fedora Security Advisory FEDORA-2017-1dc71e1acd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1dc71e1acd");

  script_name(english:"Fedora 26 : shellinabox (2017-1dc71e1acd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1dc71e1acd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"shellinabox-2.20-5.fc26")) flag++;
