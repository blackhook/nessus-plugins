...
# extracted from Fedora Security Advisory 2008-3100.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : otrs-2.1.5-4.fc7 (2008-3100)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=439932"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-April/009309.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26459705"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:otrs");
...
flag = 0;
if (rpm_check(release:"FC7", reference:"otrs-2.1.5-4.fc7")) flag++;
