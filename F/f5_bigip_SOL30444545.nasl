...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenJDK vulnerability (K30444545)");
...
vulnerability as referenced in the K30444545 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K30444545");
