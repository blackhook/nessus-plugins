...
# extracted from Fedora Security Advisory 2011-9739.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-9739");

  script_name(english:"Fedora 14 : systemtap-1.5-8.fc14 (2011-9739)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-July/063230.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b175cb19"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"systemtap-1.5-8.fc14")) flag++;
