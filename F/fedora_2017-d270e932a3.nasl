...
# extracted from Fedora Security Advisory FEDORA-2017-d270e932a3.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6209", "CVE-2016-9565", "CVE-2016-9566", "CVE-2017-12847", "CVE-2017-14312");
  script_xref(name:"FEDORA", value:"2017-d270e932a3");

  script_name(english:"Fedora 27 : nagios (2017-d270e932a3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d270e932a3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"nagios-4.3.4-3.fc27")) flag++;
