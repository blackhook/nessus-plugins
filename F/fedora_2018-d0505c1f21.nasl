...
# extracted from Fedora Security Advisory FEDORA-2018-d0505c1f21.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:nodejs (2018-d0505c1f21)");
  ...
  script_set_attribute(
    ...
    value:
"August security updates for Node.js
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d0505c1f21"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"nodejs-8.11.4-1.fc27", epoch:"1")) flag++;
