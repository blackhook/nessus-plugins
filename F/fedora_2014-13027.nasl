...
# extracted from Fedora Security Advisory 2014-13027.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13027");

  script_name(english:"Fedora 19 : java-1.7.0-openjdk-1.7.0.71-2.5.3.0.fc19 (2014-13027)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141347.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9cc8875e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"java-1.7.0-openjdk-1.7.0.71-2.5.3.0.fc19")) flag++;
