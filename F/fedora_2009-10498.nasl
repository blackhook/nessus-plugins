...
# extracted from Fedora Security Advisory 2009-10498.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10498");

  script_name(english:"Fedora 11 : rt3-3.8.2-11.fc11 (2009-10498)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/030516.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?237c82cc"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"rt3-3.8.2-11.fc11")) flag++;
