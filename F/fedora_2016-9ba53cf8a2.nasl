...
# extracted from Fedora Security Advisory FEDORA-2016-9ba53cf8a2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-9ba53cf8a2");

  script_name(english:"Fedora 23 : jenkins (2016-9ba53cf8a2)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-3721, CVE-2016-3722, CVE-2016-3723,
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-9ba53cf8a2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"jenkins-1.625.3-4.fc23")) flag++;
