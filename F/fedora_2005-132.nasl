...
# extracted from Fedora Security Advisory 2005-132.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-132");

  script_name(english:"Fedora Core 3 : mailman-2.1.5-30.fc3 (2005-132)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000694.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f79fddd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"mailman-2.1.5-30.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"mailman-debuginfo-2.1.5-30.fc3")) flag++;
