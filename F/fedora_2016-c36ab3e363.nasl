...
# extracted from Fedora Security Advisory FEDORA-2016-c36ab3e363.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c36ab3e363");

  script_name(english:"Fedora 24 : 1:nodejs (2016-c36ab3e363)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c36ab3e363"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://nodejs.org/en/blog/vulnerability/openssl-may-2016/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"nodejs-4.4.4-1.fc24", epoch:"1")) flag++;
