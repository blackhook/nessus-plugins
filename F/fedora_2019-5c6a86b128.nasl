...
# extracted from Fedora Security Advisory FEDORA-2019-5c6a86b128.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-5c6a86b128");

  script_name(english:"Fedora 29 : 2:samba / libldb (2019-5c6a86b128)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5c6a86b128"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"samba-4.9.14-0.fc29", epoch:"2")) flag++;
if (rpm_check(release:"FC29", reference:"libldb-1.4.8-1.fc29")) flag++;
