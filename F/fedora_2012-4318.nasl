...
# extracted from Fedora Security Advisory 2012-4318.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-4318");

  script_name(english:"Fedora 16 : asterisk-1.8.10.1-1.fc16 (2012-4318)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-March/076684.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e4cda007"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"asterisk-1.8.10.1-1.fc16")) flag++;
