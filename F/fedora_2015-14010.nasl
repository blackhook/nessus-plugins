...
# extracted from Fedora Security Advisory 2015-14010.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-14010");

  script_name(english:"Fedora 21 : mingw-gdk-pixbuf-2.31.6-1.fc21 (2015-14010)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/165730.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e2ab7c5e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mingw-gdk-pixbuf-2.31.6-1.fc21")) flag++;
