...
# extracted from Fedora Security Advisory FEDORA-2017-25358a23ad.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-25358a23ad");

  script_name(english:"Fedora 25 : 1:java-1.8.0-openjdk (2017-25358a23ad)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-25358a23ad"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"java-1.8.0-openjdk-1.8.0.131-1.b12.fc25", epoch:"1")) flag++;
