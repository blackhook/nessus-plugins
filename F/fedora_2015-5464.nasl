...
# extracted from Fedora Security Advisory 2015-5464.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5464");

  script_name(english:"Fedora 20 : php-symfony-2.5.11-1.fc20 (2015-5464)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154676.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d117e2c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"php-symfony-2.5.11-1.fc20")) flag++;
