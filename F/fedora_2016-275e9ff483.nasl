...
# extracted from Fedora Security Advisory 2016-275e9ff483.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-8567", "CVE-2015-8568", "CVE-2015-8613", "CVE-2015-8743", "CVE-2016-1922");
  script_xref(name:"FEDORA", value:"2016-275e9ff483");

  script_name(english:"Fedora 22 : qemu-2.3.1-11.fc22 (2016-275e9ff483)");
...
"  - CVE-2015-8567: net: vmxnet3: host memory leakage (bz
    #1289818) * CVE-2016-1922: i386: avoid NULL pointer
    dereference (bz #1292766) * CVE-2015-8613: buffer
    overflow in megasas_ctrl_get_info (bz #1284008) *
    CVE-2015-8743: ne2000: OOB memory access in ioport r/w
    functions (bz #1294787)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-February/176558.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb3e69d1"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"qemu-2.3.1-11.fc22")) flag++;
