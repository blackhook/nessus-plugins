...
# extracted from Fedora Security Advisory FEDORA-2018-1724b6a0dc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : monitorix (2018-1724b6a0dc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1724b6a0dc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"monitorix-3.10.1-1.fc27")) flag++;
