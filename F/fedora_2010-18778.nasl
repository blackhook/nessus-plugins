...
# extracted from Fedora Security Advisory 2010-18778.
#
...
if (description)
{
  ...
  script_bugtraq_id(45347, 45348, 45352);
  script_xref(name:"FEDORA", value:"2010-18778");

  script_name(english:"Fedora 13 : thunderbird-3.1.7-2.fc13 (2010-18778)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-December/052220.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd5fc7ce"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"thunderbird-3.1.7-2.fc13")) flag++;
