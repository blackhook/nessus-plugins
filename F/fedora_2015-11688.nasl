...
# extracted from Fedora Security Advisory 2015-11688.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-11688");

  script_name(english:"Fedora 22 : xrdp-0.9.0-4.fc22 (2015-11688)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1194214"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1194215"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/162958.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca596bfc"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"xrdp-0.9.0-4.fc22")) flag++;
