...
# extracted from Fedora Security Advisory 2008-10499.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : openvpn-2.1-0.29.rc15.fc8 (2008-10499)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-December/017850.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?490cba56"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"openvpn-2.1-0.29.rc15.fc8")) flag++;
