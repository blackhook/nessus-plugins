...
# extracted from Fedora Security Advisory 2014-7679.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-7679");

  script_name(english:"Fedora 19 : libreoffice-4.1.6.2-7.fc19 (2014-7679)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes CVE-2014-0247 which allowed for unconditional
execution of VBA macros when opening certain documents.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1111083"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135020.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?614469d9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libreoffice-4.1.6.2-7.fc19")) flag++;
