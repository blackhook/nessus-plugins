...
# extracted from Fedora Security Advisory 2009-11710.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11710");

  script_name(english:"Fedora 12 : wordpress-2.8.6-2.fc12 (2009-11710)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/031172.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4f92c148"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"wordpress-2.8.6-2.fc12")) flag++;
