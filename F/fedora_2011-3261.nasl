...
# extracted from Fedora Security Advisory 2011-3261.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3261");

  script_name(english:"Fedora 15 : gnash-0.8.9-0.1.20110312git.fc15 (2011-3261)");
  ...
  script_set_attribute(
    ...
    value:
"  - Bug #669851 - CVE-2010-4337 gnash: symlink attack via
    configure script
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/056169.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3243b078"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"gnash-0.8.9-0.1.20110312git.fc15")) flag++;
