...
# extracted from Fedora Security Advisory FEDORA-2017-2d0066d567.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-2d0066d567");

  script_name(english:"Fedora 26 : tigervnc (2017-2d0066d567)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2d0066d567"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"tigervnc-1.7.1-4.fc26")) flag++;
