...
# extracted from Fedora Security Advisory FEDORA-2016-c1b01b9278.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : 1:tomcat (2016-c1b01b9278) (httpoxy)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c1b01b9278"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"tomcat-8.0.38-1.fc24", epoch:"1")) flag++;
