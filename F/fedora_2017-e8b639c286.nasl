...
# extracted from Fedora Security Advisory FEDORA-2017-e8b639c286.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-e8b639c286");

  script_name(english:"Fedora 26 : 1:dovecot (2017-e8b639c286)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e8b639c286"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"dovecot-2.2.29.1-1.fc26", epoch:"1")) flag++;
