...
# extracted from Fedora Security Advisory FEDORA-2020-fd5918d946.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : seamonkey (2020-fd5918d946)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-fd5918d946"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"seamonkey-2.53.5-2.fc31")) flag++;
