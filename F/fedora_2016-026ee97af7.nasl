...
# extracted from Fedora Security Advisory FEDORA-2016-026ee97af7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-026ee97af7");

  script_name(english:"Fedora 24 : moodle (2016-026ee97af7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-026ee97af7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"moodle-3.1.3-1.fc24")) flag++;
