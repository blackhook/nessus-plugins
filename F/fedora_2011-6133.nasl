...
# extracted from Fedora Security Advisory 2011-6133.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6133");

  script_name(english:"Fedora 15 : widelands-0-0.24.build16.fc15 (2011-6133)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059449.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?69147d75"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"widelands-0-0.24.build16.fc15")) flag++;
