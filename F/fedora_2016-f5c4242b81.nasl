...
# extracted from Fedora Security Advisory FEDORA-2016-f5c4242b81.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-f5c4242b81");

  script_name(english:"Fedora 23 : openvpn (2016-f5c4242b81)");
...
https://community.openvpn.net/openvpn/wiki/ChangesInOpenvpn23#OpenVPN2
.3.11
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f5c4242b81"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"openvpn-2.3.11-1.fc23")) flag++;
