...
# extracted from F5 Networks BIG-IP Solution K03331206.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP :  NTP vulnerability (K03331206)");
...
a packet with an incorrect MAC value at a certain time.(CVE-2016-4955)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K03331206"
  );
  script_set_attribute(
    attribute:"solution",
    value:
