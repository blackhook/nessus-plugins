...
# extracted from Fedora Security Advisory FEDORA-2017-c98c2e8e7a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c98c2e8e7a");

  script_name(english:"Fedora 26 : libwmf (2017-c98c2e8e7a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c98c2e8e7a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libwmf-0.2.8.4-53.fc26")) flag++;
