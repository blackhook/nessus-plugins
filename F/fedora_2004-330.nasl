...
# extracted from Fedora Security Advisory 2004-330.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-330");
  script_xref(name:"Secunia", value:"12508");

  script_name(english:"Fedora Core 2 : squid-2.5.STABLE5-4.fc2 (2004-330)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-October/000318.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d676ece5"
  );
  script_set_attribute(
    attribute:"solution", 
