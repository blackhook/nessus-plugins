...
# extracted from Fedora Security Advisory 2006-495.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-495");

  script_name(english:"Fedora Core 4 : yelp-2.10.0-1.4.3 (2006-495)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000026.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?201c60ac"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"yelp-2.10.0-1.4.3")) flag++;
if (rpm_check(release:"FC4", reference:"yelp-debuginfo-2.10.0-1.4.3")) flag++;
