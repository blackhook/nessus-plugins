...
# extracted from Fedora Security Advisory 2004-160.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-160");

  script_name(english:"Fedora Core 2 : squirrelmail-1.4.3-1 (2004-160)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000157.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?382efdba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"squirrelmail-1.4.3-1")) flag++;
