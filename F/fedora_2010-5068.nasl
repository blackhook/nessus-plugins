...
# extracted from Fedora Security Advisory 2010-5068.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-5068");

  script_name(english:"Fedora 13 : glpi-0.72.4-2.svn11035.fc13 (2010-5068)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037845.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9a24af90"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"glpi-0.72.4-2.svn11035.fc13")) flag++;
