...
# extracted from Fedora Security Advisory 2015-11859.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-11859");

  script_name(english:"Fedora 21 : java-1.8.0-openjdk-1.8.0.51-4.b16.fc21 (2015-11859)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/162249.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f1907a83"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"java-1.8.0-openjdk-1.8.0.51-4.b16.fc21")) flag++;
