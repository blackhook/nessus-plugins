...
# extracted from Fedora Security Advisory 2015-10962.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-10962");

  script_name(english:"Fedora 22 : libssh-0.7.1-1.fc22 (2015-10962)");
  ...
  script_set_attribute(
    ...
    value:
"Update to version 0.7.1 Add patch to fix undefined symbol:
ssh_forward_listen (bug #1221310)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1213775"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/161802.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6ded7bc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"libssh-0.7.1-1.fc22")) flag++;
