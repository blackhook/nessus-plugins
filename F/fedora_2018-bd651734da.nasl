...
# extracted from Fedora Security Advisory FEDORA-2018-bd651734da.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : flatpak (2018-bd651734da)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-bd651734da"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"flatpak-0.10.3-1.fc27")) flag++;
