...
# extracted from Fedora Security Advisory 2016-9b591e1952.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-9b591e1952");

  script_name(english:"Fedora 24 : moodle-3.0.3-1.fc24 (2016-9b591e1952)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-March/179817.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f52869f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"moodle-3.0.3-1.fc24")) flag++;
