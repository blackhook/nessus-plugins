...
# extracted from Fedora Security Advisory 2012-10721.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-10721");

  script_name(english:"Fedora 16 : libjpeg-turbo-1.2.1-1.fc16 (2012-10721)");
  ...
  script_set_attribute(
    ...
    value:
"Update to the 1.2.1 bugfix release. For detailed list of changes check
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-August/084738.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6f831250"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"libjpeg-turbo-1.2.1-1.fc16")) flag++;
