...
# extracted from Fedora Security Advisory FEDORA-2016-879977eea0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-879977eea0");

  script_name(english:"Fedora 23 : cacti (2016-879977eea0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-879977eea0"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"cacti-0.8.8h-1.fc23")) flag++;
