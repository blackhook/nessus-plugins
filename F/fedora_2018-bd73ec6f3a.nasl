...
# extracted from Fedora Security Advisory FEDORA-2018-bd73ec6f3a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-bd73ec6f3a");

  script_name(english:"Fedora 27 : quassel (2018-bd73ec6f3a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-bd73ec6f3a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"quassel-0.12.5-1.fc27")) flag++;
