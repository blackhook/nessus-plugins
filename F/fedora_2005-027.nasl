...
# @DEPRECATED@
#
# This script has been deprecated by fedora_2006-027.nasl.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-027");

  script_name(english:"Fedora Core 4 : xpdf-3.01-0.FC4.6 (2005-027)");
...
patch to resolve these issues."
  ...
  # http://lists.fedoraproject.org/pipermail/announce/2006-January/001738.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9618b2d9"
  );
  script_set_attribute(
    attribute:"solution", 
...
# Deprecated.
exit(0, "This plugin has been deprecated. Refer to plugin #20408 (fedora_2006-027.nasl) instead.");
