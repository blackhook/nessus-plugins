...
# extracted from F5 Networks BIG-IP Solution K16347.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux file utility vulnerabilities (K16347)");
  ...
  script_set_attribute(
    ...
    value:
"CVE-2014-8116 The ELF parser (readelf.c) in file before 5.21 allows
remote attackers to cause a denial of service (CPU consumption or
crash) via a large number of (1) program or (2) section headers or (3)
invalid capabilities.

CVE-2014-8117 softmagic.c in file before 5.21 does not properly limit
recursion, which allows remote attackers to cause a denial of service
(CPU consumption or crash) via unspecified vectors."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16347"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["ASM"]["affected"  ] = make_list("12.0.0-12.1.5","11.0.0-11.6.5","10.0.0-10.2.4");
...
vmatrix["LC"]["affected"  ] = make_list("12.0.0-12.1.5","11.0.0-11.6.5","10.0.0-10.2.4");
vmatrix["LC"]["unaffected"] = make_list("13.0.0");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0-12.1.5","11.0.0-11.6.5","10.0.0-10.2.4");
