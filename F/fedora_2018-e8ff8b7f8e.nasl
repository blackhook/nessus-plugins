...
# extracted from Fedora Security Advisory FEDORA-2018-e8ff8b7f8e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 1:rubygem-rack (2018-e8ff8b7f8e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e8ff8b7f8e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"rubygem-rack-2.0.4-4.fc29", epoch:"1")) flag++;
