...
# extracted from Fedora Security Advisory FEDORA-2016-3a0df9e256.
#
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3a0df9e256"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"sudo-1.8.18p1-1.fc25")) flag++;
