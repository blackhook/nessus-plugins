...
# extracted from Fedora Security Advisory 2004-203.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-203");

  script_name(english:"Fedora Core 1 : httpd-2.0.50-1.0 (2004-203)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-July/000219.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b700f86e"
  );
...
flag = 0;
if (rpm_check(release:"FC1", reference:"httpd-2.0.50-1.0")) flag++;
if (rpm_check(release:"FC1", reference:"httpd-debuginfo-2.0.50-1.0")) flag++;
if (rpm_check(release:"FC1", reference:"httpd-devel-2.0.50-1.0")) flag++;
if (rpm_check(release:"FC1", reference:"httpd-manual-2.0.50-1.0")) flag++;
if (rpm_check(release:"FC1", reference:"mod_ssl-2.0.50-1.0")) flag++;
