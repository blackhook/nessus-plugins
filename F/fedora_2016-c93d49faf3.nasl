...
# extracted from Fedora Security Advisory 2016-c93d49faf3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c93d49faf3");

  script_name(english:"Fedora 23 : dhcp-4.3.3-9.P1.fc23 (2016-c93d49faf3)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?48166827"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"dhcp-4.3.3-9.P1.fc23")) flag++;
