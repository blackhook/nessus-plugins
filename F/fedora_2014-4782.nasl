...
# extracted from Fedora Security Advisory 2014-4782.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : mingw-openjpeg-1.5.1-8.fc20 (2014-4782)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?25ccadd7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"mingw-openjpeg-1.5.1-8.fc20")) flag++;
