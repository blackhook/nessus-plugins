...
# extracted from Fedora Security Advisory FEDORA-2017-0f38995622.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0f38995622");

  script_name(english:"Fedora 24 : webkitgtk4 (2017-0f38995622)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0f38995622"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"webkitgtk4-2.16.0-1.fc24")) flag++;
