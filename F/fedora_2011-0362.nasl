...
# extracted from Fedora Security Advisory 2011-0362.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0362");

  script_name(english:"Fedora 14 : dpkg-1.15.5.6-6.fc14 (2011-0362)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5315b031"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"dpkg-1.15.5.6-6.fc14")) flag++;
