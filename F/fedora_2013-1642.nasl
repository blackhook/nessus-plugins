...
# extracted from Fedora Security Advisory 2013-1642.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : libvirt-0.9.6.4-1.fc16 (2013-1642)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-February/098370.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd2821b5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"libvirt-0.9.6.4-1.fc16")) flag++;
