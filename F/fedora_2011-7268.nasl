...
# extracted from Fedora Security Advisory 2011-7268.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7268");

  script_name(english:"Fedora 15 : dovecot-2.0.13-1.fc15 (2011-7268)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/060825.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6516e5e3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"dovecot-2.0.13-1.fc15")) flag++;
