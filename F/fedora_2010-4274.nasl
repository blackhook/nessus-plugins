...
# extracted from Fedora Security Advisory 2010-4274.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-4274");

  script_name(english:"Fedora 13 : tar-1.22-16.fc13 (2010-4274)");
...
"  - CVE-2010-0624 tar, cpio: Heap-based buffer overflow by
    ...
    cause descriptor exhaustion (#570591)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037251.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a71f1900"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"tar-1.22-16.fc13")) flag++;
