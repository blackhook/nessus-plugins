...
# extracted from Fedora Security Advisory FEDORA-2021-c90cb486f7
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:dovecot (2021-c90cb486f7)");
...
FEDORA-2021-c90cb486f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-c90cb486f7");
...
pkgs = [
    {'reference':'dovecot-2.3.13-2.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
