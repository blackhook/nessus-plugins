...
# extracted from Fedora Security Advisory 2012-18264.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-18264");

  script_name(english:"Fedora 18 : bugzilla-4.2.4-1.fc18 (2012-18264)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/093145.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78f8a417"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"bugzilla-4.2.4-1.fc18")) flag++;
