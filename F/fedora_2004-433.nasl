...
# extracted from Fedora Security Advisory 2004-433.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-433");

  script_name(english:"Fedora Core 2 : xorg-x11-6.7.0-10 (2004-433)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-November/000402.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?12c5c0e3"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"xorg-x11-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-100dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-75dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-14-100dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-14-75dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-15-100dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-15-75dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-2-100dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-2-75dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-9-100dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-ISO8859-9-75dpi-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-Mesa-libGL-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-Mesa-libGLU-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-Xnest-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-Xvfb-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-base-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-cyrillic-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-devel-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-doc-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-font-utils-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-libs-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-libs-data-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-sdk-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-syriac-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-tools-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-truetype-fonts-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-twm-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-xauth-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-xdm-6.7.0-10")) flag++;
if (rpm_check(release:"FC2", reference:"xorg-x11-xfs-6.7.0-10")) flag++;
