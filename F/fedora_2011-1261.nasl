...
# extracted from Fedora Security Advisory 2011-1261.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : Django-1.2.5-1.fc13 (2011-1261)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-February/054207.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d94c6a7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"Django-1.2.5-1.fc13")) flag++;
