...
# extracted from Fedora Security Advisory FEDORA-2017-4762689cb7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-4762689cb7");

  script_name(english:"Fedora 26 : knot-resolver (2017-4762689cb7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4762689cb7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"knot-resolver-1.3.2-1.fc26")) flag++;
