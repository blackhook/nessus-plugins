...
# extracted from Fedora Security Advisory 2004-172.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-172");

  script_name(english:"Fedora Core 2 : ethereal-0.10.3-2.2 (2004-172)");
...
All users of ethereal are strongly recommended to update to these
latest packages.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000171.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c263fa82"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"ethereal-0.10.3-2.2")) flag++;
if (rpm_check(release:"FC2", reference:"ethereal-debuginfo-0.10.3-2.2")) flag++;
if (rpm_check(release:"FC2", reference:"ethereal-gnome-0.10.3-2.2")) flag++;
