...
# extracted from Fedora Security Advisory 2004-220.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-220");

  script_name(english:"Fedora Core 2 : ethereal-0.10.5-0.2.1 (2004-220)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-July/000216.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?27706b9e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"ethereal-0.10.5-0.2.1")) flag++;
if (rpm_check(release:"FC2", reference:"ethereal-debuginfo-0.10.5-0.2.1")) flag++;
if (rpm_check(release:"FC2", reference:"ethereal-gnome-0.10.5-0.2.1")) flag++;
