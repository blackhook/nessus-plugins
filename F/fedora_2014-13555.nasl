...
# extracted from Fedora Security Advisory 2014-13555.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13555");

  script_name(english:"Fedora 20 : wpa_supplicant-2.0-12.fc20 (2014-13555)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141546.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f93272f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"wpa_supplicant-2.0-12.fc20")) flag++;
