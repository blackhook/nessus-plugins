...
# extracted from Fedora Security Advisory FEDORA-2016-1aaf308de4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : community-mysql (2016-1aaf308de4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-1aaf308de4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"community-mysql-5.6.30-1.fc22")) flag++;
