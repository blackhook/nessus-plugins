...
# extracted from Fedora Security Advisory FEDORA-2020-c2f8a1e8a5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : ark (2020-c2f8a1e8a5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-c2f8a1e8a5"
  );
...
flag = 0;
if (rpm_check(release:"FC32", reference:"ark-20.04.3-5.fc32")) flag++;
