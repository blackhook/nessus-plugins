...
# extracted from Fedora Security Advisory 2011-14480.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-14480");

  script_name(english:"Fedora 16 : asterisk-1.8.7.1-1.fc16 (2011-14480)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-November/069074.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97e12095"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"asterisk-1.8.7.1-1.fc16")) flag++;
