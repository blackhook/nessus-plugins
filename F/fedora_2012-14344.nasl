...
# extracted from Fedora Security Advisory 2012-14344.
#
...
if (description)
{
  ...
  script_bugtraq_id(52255);
  script_xref(name:"FEDORA", value:"2012-14344");

  script_name(english:"Fedora 17 : phpldapadmin-1.2.2-3.gitbbedf1.fc17 (2012-14344)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=799873"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/089313.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e9475b3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"phpldapadmin-1.2.2-3.gitbbedf1.fc17")) flag++;
