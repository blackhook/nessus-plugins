...
# extracted from Fedora Security Advisory 2012-8702.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8702");

  script_name(english:"Fedora 15 : arpwatch-2.1a15-16.fc15 (2012-8702)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=825328"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082565.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9d654b3a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"arpwatch-2.1a15-16.fc15")) flag++;
