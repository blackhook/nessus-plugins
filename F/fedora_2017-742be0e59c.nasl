...
# extracted from Fedora Security Advisory FEDORA-2017-742be0e59c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : git (2017-742be0e59c)");
  ...
  script_set_attribute(
    ...
    value:
"Previous versions of git mishandled layers of tree objects, which
allowed remote attackers to cause a denial of service (memory
consumption) via a crafted repository, aka a git bomb. This can also
have an impact of disk consumption; however, an affected process
typically would not survive its attempt to build the data structure in
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-742be0e59c"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"git-2.13.6-2.fc26")) flag++;
