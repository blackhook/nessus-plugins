...
# extracted from Fedora Security Advisory 2013-8738.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-8738");

  script_name(english:"Fedora 19 : ruby-2.0.0.195-8.fc19 (2013-8738)");
  ...
  script_set_attribute(
    ...
    value:
"  - Update to Ruby 2.0.0-p195.

    - Fix object taint bypassing in DL and Fiddle
      (CVE-2013-2065).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=962035"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/107120.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?569ed74a"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"ruby-2.0.0.195-8.fc19")) flag++;
