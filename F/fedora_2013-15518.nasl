...
# extracted from Fedora Security Advisory 2013-15518.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 18 : 389-ds-base-1.3.0.8-1.fc18 (2013-15518)");
...
invalid DN crashed the server -- was fixed.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/114899.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c18008bb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"389-ds-base-1.3.0.8-1.fc18")) flag++;
