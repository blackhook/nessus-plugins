...
# extracted from Fedora Security Advisory 2011-0514.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0514");

  script_name(english:"Fedora 14 : myproxy-5.3-1.fc14 (2011-0514)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053461.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d0192290"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"myproxy-5.3-1.fc14")) flag++;
