...
# extracted from Fedora Security Advisory 2005-411.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-411");

  script_name(english:"Fedora Core 4 : gaim-1.3.1-0.fc4 (2005-411)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-June/000947.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d36dd2be"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"gaim-1.3.1-0.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"gaim-debuginfo-1.3.1-0.fc4")) flag++;
