...
# extracted from Fedora Security Advisory 2010-18856.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : dhcp-4.2.0-16.P2.fc14 (2010-18856)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=662325"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-December/052329.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d91b526"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"dhcp-4.2.0-16.P2.fc14")) flag++;
