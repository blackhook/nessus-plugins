...
# extracted from Fedora Security Advisory 2005-353.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-353");

  script_name(english:"Fedora Core 3 : perl-5.8.5-12.FC3 (2005-353)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-May/000891.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?193717a3"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"perl-5.8.5-12.FC3")) flag++;
