...
# extracted from Fedora Security Advisory 2012-3536.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 15 : libpng10-1.0.58-1.fc15 (2012-3536)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83fba7ba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libpng10-1.0.58-1.fc15")) flag++;
