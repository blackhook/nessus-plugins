...
# extracted from Fedora Security Advisory 2014-16600.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-16600");

  script_name(english:"Fedora 20 : xorg-x11-server-1.14.4-13.fc20 (2014-16600)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/146330.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a59c90a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"xorg-x11-server-1.14.4-13.fc20")) flag++;
