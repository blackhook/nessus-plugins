...
# extracted from Fedora Security Advisory FEDORA-2016-6b9c658707.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-6b9c658707");

  script_name(english:"Fedora 24 : spice (2016-6b9c658707)");
  ...
  script_set_attribute(
    ...
    value:
"Update to upstream 0.12.8 release
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-6b9c658707"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"spice-0.12.8-1.fc24")) flag++;
