...
# extracted from Fedora Security Advisory FEDORA-2017-a40590256c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a40590256c");

  script_name(english:"Fedora 26 : glpi (2017-a40590256c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a40590256c"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"glpi-9.1.5-1.fc26")) flag++;
