...
# extracted from Fedora Security Advisory 2004-548.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-548");

  script_name(english:"Fedora Core 2 : kdelibs-3.2.2-10.FC2 (2004-548)");
...
"  - Tue Dec 14 2004 Than Ngo <than at redhat.com>
  ...
  - Tue Sep 07 2004 Than Ngo <than at redhat.com>
    6:3.2.2-9.FC2
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-December/000503.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f0094561"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"kdelibs-3.2.2-10.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kdelibs-debuginfo-3.2.2-10.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kdelibs-devel-3.2.2-10.FC2")) flag++;
