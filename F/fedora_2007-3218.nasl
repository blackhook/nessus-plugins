...
# extracted from Fedora Security Advisory 2007-3218.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : perl-5.8.8-31.fc8 (2007-3218)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=378141"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004711.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c7c58c5b"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:perl-core");
...
flag = 0;
if (rpm_check(release:"FC8", reference:"perl-5.8.8-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-CPAN-1.76_02-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-ExtUtils-Embed-1.26-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-ExtUtils-MakeMaker-6.30-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-Test-Harness-2.56-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-Test-Simple-0.62-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-core-5.8.8-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-debuginfo-5.8.8-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-devel-5.8.8-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-libs-5.8.8-31.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"perl-suidperl-5.8.8-31.fc8")) flag++;
