...
# extracted from Fedora Security Advisory 2004-175.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-175");

  script_name(english:"Fedora Core 2 : libpng-1.2.5-5 (2004-175)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000177.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b003242b"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", cpu:"x86_64", reference:"libpng-1.2.5-5")) flag++;
if (rpm_check(release:"FC2", reference:"libpng-debuginfo-1.2.5-5")) flag++;
if (rpm_check(release:"FC2", reference:"libpng-devel-1.2.5-5")) flag++;
