...
# extracted from Fedora Security Advisory FEDORA-2016-59fda81436.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-59fda81436");

  script_name(english:"Fedora 24 : jansson (2016-59fda81436)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-59fda81436"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"jansson-2.9-1.fc24")) flag++;
