...
# extracted from F5 Networks BIG-IP Solution K35240323.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PHP vulnerability (K35240323)");
...
zero. (CVE-2016-4539)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K35240323"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
