...
17.0.0.1. It is, therefore, affected by a vulnerability as referenced in the K43024307 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K43024307");
...
var vmatrix = {
  'AFM': {
    ...
    'unaffected': [
      '17.0.0.1','16.1.3.2','15.1.7','14.1.5.2','13.1.5.1'
    ],
  },
  'APM': {
    'affected': [
