...
# extracted from Fedora Security Advisory 2005-1000.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1000");

  script_name(english:"Fedora Core 3 : curl-7.12.3-4.fc3 (2005-1000)");
  ...
  script_set_attribute(
    ...
    value:
"This package fixes a buffer overflow bug in NTLM authentication code
of curl (CVE-2005-3185).
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-October/001500.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?223fcef5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"curl-7.12.3-4.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"curl-debuginfo-7.12.3-4.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"curl-devel-7.12.3-4.fc3")) flag++;
