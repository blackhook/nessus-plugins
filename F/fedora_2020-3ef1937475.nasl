...
# extracted from Fedora Security Advisory FEDORA-2020-3ef1937475.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : nspr / nss (2020-3ef1937475)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-3ef1937475"
  );
  # https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.54_release_notes
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"nspr-4.26.0-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"nss-3.54.0-1.fc32")) flag++;
