...
# extracted from Fedora Security Advisory 2011-6231.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6231");

  script_name(english:"Fedora 15 : thunderbird-3.1.10-1.fc15 (2011-6231)");
  ...
  script_set_attribute(
    ...
    value:
"Update to new upstream Thunderbird version 3.1.10, fixing multiple
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059301.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d193cf9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"thunderbird-3.1.10-1.fc15")) flag++;
