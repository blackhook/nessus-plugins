...
# extracted from Fedora Security Advisory FEDORA-2016-e8652e3efb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e8652e3efb");

  script_name(english:"Fedora 24 : cacti (2016-e8652e3efb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e8652e3efb"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"cacti-0.8.8h-1.fc24")) flag++;
