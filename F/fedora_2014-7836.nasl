...
# extracted from Fedora Security Advisory 2014-7836.
#
...
if (description)
{
  ...
  script_bugtraq_id(68257);
  script_xref(name:"FEDORA", value:"2014-7836");

  script_name(english:"Fedora 20 : cacti-0.8.8b-7.fc20 (2014-7836)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1113035"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135211.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f243bbcc"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"cacti-0.8.8b-7.fc20")) flag++;
