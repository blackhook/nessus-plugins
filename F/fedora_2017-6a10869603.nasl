...
# extracted from Fedora Security Advisory FEDORA-2017-6a10869603.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-6a10869603");

  script_name(english:"Fedora 27 : file (2017-6a10869603)");
  ...
  script_set_attribute(
    ...
    value:
"  - fix a possible stack based buffer overflow
    (CVE-2017-1000249)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6a10869603"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"file-5.31-10.fc27")) flag++;
