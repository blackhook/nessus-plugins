...
# extracted from Fedora Security Advisory FEDORA-2017-93868169a0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-93868169a0");

  script_name(english:"Fedora 24 : mingw-poppler (2017-93868169a0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-93868169a0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mingw-poppler-0.41.0-3.fc24")) flag++;
