...
passing a 0x5d414141414141410000 value to sinl on x86 targets. This is
related to sysdeps/ieee754/ldbl-96/e_rem_pio2l.c. (CVE-2020-10029)

Impact

Specially crafted values passed to certain glibc functions may create
a stack-based overflow, potentially leading to an unexpected process
restart."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K38481791"
  );
  script_set_attribute(
    attribute:"solution",
    value:
