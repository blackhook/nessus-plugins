...
# extracted from Fedora Security Advisory 2009-11352.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11352");

  script_name(english:"Fedora 12 : tomcat6-6.0.20-1.fc12 (2009-11352)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/031712.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4543f1fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"tomcat6-6.0.20-1.fc12")) flag++;
