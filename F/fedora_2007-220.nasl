...
# extracted from Fedora Security Advisory 2007-220.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : samba-3.0.24-1.fc6 (2007-220)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Nov 16 2006 Jay Fenlason <fenlason at redhat.com>
    3.0.24-1.fc6
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-February/001390.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0954d0e2"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"samba-3.0.24-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"samba-client-3.0.24-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"samba-common-3.0.24-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"samba-debuginfo-3.0.24-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"samba-swat-3.0.24-1.fc6")) flag++;
