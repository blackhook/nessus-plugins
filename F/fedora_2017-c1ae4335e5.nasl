...
# extracted from Fedora Security Advisory FEDORA-2017-c1ae4335e5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c1ae4335e5");

  script_name(english:"Fedora 25 : pdns-recursor (2017-c1ae4335e5)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-2120, CVE-2016-7068, CVE-2016-7072,
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c1ae4335e5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"pdns-recursor-4.0.4-1.fc25")) flag++;
