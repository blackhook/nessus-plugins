...
# extracted from Fedora Security Advisory FEDORA-2017-fc634e7ee7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-fc634e7ee7");

  script_name(english:"Fedora 26 : 1:xrdp / xorgxrdp (2017-fc634e7ee7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-fc634e7ee7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"xrdp-0.9.2-5.fc26", epoch:"1")) flag++;
if (rpm_check(release:"FC26", reference:"xorgxrdp-0.2.1-1.fc26")) flag++;
