...
# extracted from Fedora Security Advisory 2012-1934.
#
...
if (description)
{
  ...
  script_bugtraq_id(51600);
  script_xref(name:"FEDORA", value:"2012-1934");

  script_name(english:"Fedora 16 : WebCalendar-1.2.4-3.fc16 (2012-1934)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=794499"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/073762.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9bb34a78"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"WebCalendar-1.2.4-3.fc16")) flag++;
