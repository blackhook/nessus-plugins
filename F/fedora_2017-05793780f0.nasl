...
# extracted from Fedora Security Advisory FEDORA-2017-05793780f0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : spice (2017-05793780f0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-05793780f0"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"spice-0.12.8-2.fc24")) flag++;
