...
# extracted from Fedora Security Advisory 2012-12352.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-12352");

  script_name(english:"Fedora 17 : GraphicsMagick-1.3.16-5.fc17 (2012-12352)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086029.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9cdc55a6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"GraphicsMagick-1.3.16-5.fc17")) flag++;
