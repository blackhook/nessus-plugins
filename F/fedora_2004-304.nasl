...
# extracted from Fedora Security Advisory 2004-304.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-304");

  script_name(english:"Fedora Core 1 : samba-3.0.7-2.FC1 (2004-304)");
  ...
  script_set_attribute(
    ...
    value:
"This update addresses two DoS errors in Samba-3.0.6
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-September/000290.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ee064bfa"
  );
...
flag = 0;
if (rpm_check(release:"FC1", reference:"samba-3.0.7-2.FC1")) flag++;
if (rpm_check(release:"FC1", reference:"samba-client-3.0.7-2.FC1")) flag++;
if (rpm_check(release:"FC1", reference:"samba-common-3.0.7-2.FC1")) flag++;
if (rpm_check(release:"FC1", reference:"samba-debuginfo-3.0.7-2.FC1")) flag++;
if (rpm_check(release:"FC1", reference:"samba-swat-3.0.7-2.FC1")) flag++;
