...
# extracted from Fedora Security Advisory FEDORA-2018-97ad7e69c1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-97ad7e69c1");

  script_name(english:"Fedora 26 : wordpress (2018-97ad7e69c1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-97ad7e69c1"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"wordpress-4.9.5-1.fc26")) flag++;
