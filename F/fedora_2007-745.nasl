...
# extracted from Fedora Security Advisory 2007-745.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : mono-1.1.17.1-5.fc6 (2007-745)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004859.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?93556d29"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"bytefx-data-mysql-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ibm-data-db2-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-core-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-data-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-data-firebird-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-data-oracle-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-data-postgresql-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-data-sqlite-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-data-sybase-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-debuginfo-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-devel-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-extras-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-jscript-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-locale-extras-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-nunit-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-nunit-devel-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-web-1.1.17.1-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mono-winforms-1.1.17.1-5.fc6")) flag++;
