...
# extracted from F5 Networks BIG-IP Solution K35322517.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (K35322517)");
...
resolver.c. (CVE-2016-8864)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K35322517"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
