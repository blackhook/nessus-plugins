...
# extracted from Fedora Security Advisory FEDORA-2020-9e97ec4cba.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : mbedtls (2020-9e97ec4cba)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9e97ec4cba"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"mbedtls-2.16.9-1.fc33")) flag++;
