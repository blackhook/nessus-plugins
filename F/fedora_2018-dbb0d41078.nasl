...
# extracted from Fedora Security Advisory FEDORA-2018-dbb0d41078.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : php-zendframework-zend-diactoros (2018-dbb0d41078)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-dbb0d41078"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"php-zendframework-zend-diactoros-1.8.4-1.fc27")) flag++;
