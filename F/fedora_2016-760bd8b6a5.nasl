...
# extracted from Fedora Security Advisory FEDORA-2016-760bd8b6a5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-760bd8b6a5");

  script_name(english:"Fedora 24 : libarchive (2016-760bd8b6a5)");
  ...
  script_set_attribute(
    ...
    value:
"fix manual pages to mention correctly spelled binary names
(rhbz#1294252), fix CVE-2016-1541, rhbz#1334213
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-760bd8b6a5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libarchive-3.1.2-17.fc24")) flag++;
