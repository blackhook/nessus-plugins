...
# extracted from Fedora Security Advisory FEDORA-2021-d4f4c994cc
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-d4f4c994cc");

  script_name(english:"Fedora 32 : seamonkey (2021-d4f4c994cc)");
...
FEDORA-2021-d4f4c994cc advisory.

  - Update to 2.53.6 (FEDORA-2021-d4f4c994cc)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-d4f4c994cc");
...
pkgs = [
    {'reference':'seamonkey-2.53.6-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
