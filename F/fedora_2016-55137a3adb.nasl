...
# extracted from Fedora Security Advisory 2016-55137a3adb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-55137a3adb");

  script_name(english:"Fedora 23 : mingw-curl-7.47.0-1.fc23 (2016-55137a3adb)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97850687"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mingw-curl-7.47.0-1.fc23")) flag++;
