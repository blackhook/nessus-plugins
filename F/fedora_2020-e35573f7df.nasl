...
# extracted from Fedora Security Advisory FEDORA-2020-e35573f7df.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-e35573f7df");

  script_name(english:"Fedora 30 : okular (2020-e35573f7df)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e35573f7df"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"okular-19.12.3-2.fc30")) flag++;
