...
# extracted from Fedora Security Advisory 2013-10695.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-2140", "CVE-2013-2147", "CVE-2013-2148", "CVE-2013-2164", "CVE-2013-2850", "CVE-2013-2851", "CVE-2013-2852");
  script_bugtraq_id(60243, 60280, 60341, 60375, 60409, 60410, 60414);
  script_xref(name:"FEDORA", value:"2013-10695");

  script_name(english:"Fedora 18 : kernel-3.9.5-201.fc18 (2013-10695)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/108756.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea56e6dd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"kernel-3.9.5-201.fc18")) flag++;
