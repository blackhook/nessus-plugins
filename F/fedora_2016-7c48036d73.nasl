...
# extracted from Fedora Security Advisory FEDORA-2016-7c48036d73.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-7c48036d73");

  script_name(english:"Fedora 23 : community-mysql (2016-7c48036d73)");
  ...
  script_set_attribute(
    ...
    value:
"Update to latest upstream release. Also fixes CVE-2016-0705,
CVE-2016-0639, CVE-2016-2047, CVE-2016-0647, CVE-2016-0648,
CVE-2016-0666, CVE-2016-0642, CVE-2016-0655, CVE-2016-0643
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-7c48036d73"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"community-mysql-5.6.30-1.fc23")) flag++;
