...
# extracted from Fedora Security Advisory 2013-16925.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-4338", "CVE-2013-4339", "CVE-2013-4340");
  script_bugtraq_id(62344, 62345, 62346);
  script_xref(name:"FEDORA", value:"2013-16925");

  script_name(english:"Fedora 19 : wordpress-3.6.1-1.fc19 (2013-16925)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/116832.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fe7f5aa6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"wordpress-3.6.1-1.fc19")) flag++;
