...
# extracted from Fedora Security Advisory FEDORA-2017-541aea2890.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-541aea2890");

  script_name(english:"Fedora 25 : wireshark (2017-541aea2890)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-541aea2890"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"wireshark-2.2.4-1.fc25")) flag++;
