...
# extracted from Fedora Security Advisory FEDORA-2020-ace543feff.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 1:NetworkManager (2020-ace543feff)");
...
"  - Update to 1.20.12 release
  ...
  - ifcfg-rh: handle '802-1x.{,phase2-}ca-path' (rh
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-ace543feff"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"NetworkManager-1.20.12-1.fc31", epoch:"1")) flag++;
