...
# extracted from Fedora Security Advisory FEDORA-2017-d04f7ddd73.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : 32:bind / bind-dyndb-ldap / dnsperf (2017-d04f7ddd73)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d04f7ddd73"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC25", reference:"bind-9.10.5-2.P2.fc25", epoch:"32")) flag++;
if (rpm_check(release:"FC25", reference:"bind-dyndb-ldap-10.1-2.fc25")) flag++;
if (rpm_check(release:"FC25", reference:"dnsperf-2.1.0.0-3.fc25")) flag++;
