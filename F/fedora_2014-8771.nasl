...
# extracted from Fedora Security Advisory 2014-8771.
#
...
if (description)
{
  ...
  script_bugtraq_id(63022, 63023, 63601);
  script_xref(name:"FEDORA", value:"2014-8771");

  script_name(english:"Fedora 19 : ReviewBoard-1.7.27-1.fc19 (2014-8771)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.reviewboard.org/docs/releasenotes/reviewboard/1.7.27/"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137812.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1f5c7fd6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"ReviewBoard-1.7.27-1.fc19")) flag++;
