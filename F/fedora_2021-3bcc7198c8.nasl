...
# extracted from Fedora Security Advisory FEDORA-2021-3bcc7198c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-3bcc7198c8");

  script_name(english:"Fedora 33 : kernel (2021-3bcc7198c8)");
...
FEDORA-2021-3bcc7198c8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-3bcc7198c8");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2021-3178');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-3bcc7198c8');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.10-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
