...
# extracted from Fedora Security Advisory 2013-23432.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-23432");

  script_name(english:"Fedora 19 : openttd-1.3.3-1.fc19 (2013-23432)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/125014.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e3c9697"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"openttd-1.3.3-1.fc19")) flag++;
