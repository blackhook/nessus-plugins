...
# extracted from F5 Networks BIG-IP Solution SOL5725.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : pam_ldap password policy control vulnerability (SOL5725)");
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K5725"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["ASM"]["unaffected"] = make_list("9.2.2-9.2.5","9.3","9.4","10");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("9.0.0-9.1.2","9.2.0");
vmatrix["LTM"]["unaffected"] = make_list("9.1.3","9.2.2-9.2.5","9.3","9.4","10");
