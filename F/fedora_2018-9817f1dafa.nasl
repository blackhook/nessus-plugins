...
# extracted from Fedora Security Advisory FEDORA-2018-9817f1dafa.
#
...
Release notes:
https://tls.mbed.org/tech-updates/releases/mbedtls-2.7.0-2.1.10-and-1.
3.22-released
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9817f1dafa"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mbedtls-2.7.0-1.fc26")) flag++;
