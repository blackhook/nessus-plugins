...
# extracted from Fedora Security Advisory FEDORA-2021-99cad2b81f
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-99cad2b81f");

  script_name(english:"Fedora 32 : 1:wpa_supplicant (2021-99cad2b81f)");
...
FEDORA-2021-99cad2b81f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-99cad2b81f");
...
pkgs = [
    {'reference':'wpa_supplicant-2.9-6.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
