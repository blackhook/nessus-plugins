...
# extracted from Fedora Security Advisory 2014-11289.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11289");

  script_name(english:"Fedora 21 : nodejs-send-0.3.0-4.fc21 (2014-11289)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/139415.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f135a7a3"
  );
  # https://nodesecurity.io/advisories/send-directory-traversal
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.npmjs.com/advisories/send-directory-traversal"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"nodejs-send-0.3.0-4.fc21")) flag++;
