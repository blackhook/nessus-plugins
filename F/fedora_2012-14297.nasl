...
# extracted from Fedora Security Advisory 2012-14297.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14297");

  script_name(english:"Fedora 16 : automake-1.11.6-1.fc16 (2012-14297)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b4db3468"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"automake-1.11.6-1.fc16")) flag++;
