...
# extracted from Fedora Security Advisory FEDORA-2018-20ba39cba9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-20ba39cba9");

  script_name(english:"Fedora 26 : poppler (2018-20ba39cba9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-20ba39cba9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"poppler-0.52.0-11.fc26")) flag++;
