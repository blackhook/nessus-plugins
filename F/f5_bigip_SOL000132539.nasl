...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIG-IP Edge Client for Windows Improper Certificate Validation (K000132539)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"The version of F5 Networks BIG-IP installed on the remote host is affected by a vulnerability 
as referenced in the K000132539 advisory.

  - An improper certificate validation vulnerability exists in BIG-IP Edge Client for Windows 
    and macOS and may allow an attacker to impersonate a BIG-IP APM system. (CVE-2023-24461)
