...
# extracted from Fedora Security Advisory FEDORA-2016-5763cacac0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-5763cacac0");

  script_name(english:"Fedora 23 : php-horde-horde (2016-5763cacac0)");
...
"**horde 5.2.12**
  ...
  - [jan] SECURITY: Add CSRF protection tokens to portal
    layout forms (Reported by Florian K&ouml;llich).
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-5763cacac0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-horde-horde-5.2.12-1.fc23")) flag++;
