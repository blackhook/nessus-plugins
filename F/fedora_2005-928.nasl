...
# extracted from Fedora Security Advisory 2005-928.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-928");

  script_name(english:"Fedora Core 4 : devhelp-0.10-1.4.2 (2005-928)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001415.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?56103488"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"devhelp-0.10-1.4.2")) flag++;
if (rpm_check(release:"FC4", reference:"devhelp-debuginfo-0.10-1.4.2")) flag++;
if (rpm_check(release:"FC4", reference:"devhelp-devel-0.10-1.4.2")) flag++;
