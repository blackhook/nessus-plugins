...
# extracted from Fedora Security Advisory FEDORA-2017-59f85fef2c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-59f85fef2c");

  script_name(english:"Fedora 26 : mosquitto (2017-59f85fef2c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-59f85fef2c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mosquitto-1.4.12-1.fc26")) flag++;
