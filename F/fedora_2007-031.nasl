...
# extracted from Fedora Security Advisory 2007-031.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : xterm-223-1.fc6 (2007-031)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-January/001220.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd05df8f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC6", reference:"xterm-223-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xterm-debuginfo-223-1.fc6")) flag++;
