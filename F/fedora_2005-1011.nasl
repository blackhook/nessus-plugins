...
# extracted from Fedora Security Advisory 2005-1011.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1011");

  script_name(english:"Fedora Core 4 : ethereal-0.10.13-1.FC4.2 (2005-1011)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-October/001505.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c11bd10e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"ethereal-0.10.13-1.FC4.2")) flag++;
if (rpm_check(release:"FC4", reference:"ethereal-debuginfo-0.10.13-1.FC4.2")) flag++;
if (rpm_check(release:"FC4", reference:"ethereal-gnome-0.10.13-1.FC4.2")) flag++;
