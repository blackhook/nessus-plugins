...
# extracted from Fedora Security Advisory FEDORA-2016-26a03340e6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-26a03340e6");

  script_name(english:"Fedora 24 : libreswan (2016-26a03340e6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-26a03340e6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libreswan-3.18-1.fc24")) flag++;
