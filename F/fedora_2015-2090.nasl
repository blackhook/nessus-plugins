...
# extracted from Fedora Security Advisory 2015-2090.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-2090");

  script_name(english:"Fedora 20 : apache-poi-3.10.1-2.fc20 (2015-2090)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1181223"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-February/150228.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60238699"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"apache-poi-3.10.1-2.fc20")) flag++;
