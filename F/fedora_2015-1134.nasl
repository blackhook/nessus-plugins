...
# extracted from Fedora Security Advisory 2015-1134.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1134");

  script_name(english:"Fedora 21 : patch-2.7.3-1.fc21 (2015-1134)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b9ac6bea"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"patch-2.7.3-1.fc21")) flag++;
