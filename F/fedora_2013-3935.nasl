...
# extracted from Fedora Security Advisory 2013-3935.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-3935");

  script_name(english:"Fedora 18 : puppet-3.1.1-1.fc18 (2013-3935)");
...
https://groups.google.com/group/puppet-announce/browse_thread/thread/7
ff8326dc79257a1

update to 3.1.0 with proper handling of Systemd. Here is where you
give an explanation of your update.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bb62e72b"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/112935.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?753d0437"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"puppet-3.1.1-1.fc18")) flag++;
