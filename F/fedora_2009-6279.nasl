...
# extracted from Fedora Security Advisory 2009-6279.
#
...
if (description)
{
  ...
  script_bugtraq_id(31534, 35112);
  script_xref(name:"FEDORA", value:"2009-6279");

  script_name(english:"Fedora 9 : pam_krb5-2.3.5-1.fc9 (2009-6279)");
...
and makes the '-n' option for the 'afs5log' command work as
advertised.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025735.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b84fd6af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"pam_krb5-2.3.5-1.fc9")) flag++;
