...
# extracted from Fedora Security Advisory 2012-3605.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-3605");

  script_name(english:"Fedora 17 : libpng-1.5.9-1.fc17 (2012-3605)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a9b28b22"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"libpng-1.5.9-1.fc17")) flag++;
