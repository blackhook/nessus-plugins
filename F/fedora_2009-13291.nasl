...
# extracted from Fedora Security Advisory 2009-13291.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-13291");

  script_name(english:"Fedora 12 : drupal-6.15-1.fc12 (2009-13291)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?04d857c2"
  );
  # http://drupal.org/files/sa-core-2009-009/SA-CORE-2009-009-6.14.patch
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2d567343"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://ftp-origin.drupal.org/files/projects/drupal-5.21.tar.gz"
  );
  # http://ftp.drupal.org/files/projects/drupal-6.15.tar.gz
  script_set_attribute(
    attribute:"see_also",
    value:"https://ftp-origin.drupal.org/files/projects/drupal-6.15.tar.gz"
  );
  # http://lists.drupal.org/mailman/listinfo/security-news
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-December/032761.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6c52ed8e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"drupal-6.15-1.fc12")) flag++;
