...
# extracted from Fedora Security Advisory FEDORA-2018-7151603128.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-7151603128");

  script_name(english:"Fedora 26 : mupdf (2018-7151603128)");
  ...
  script_set_attribute(
    ...
    value:
"CVE-2017-17858 (rh bz #1537952) (gs bz #698819) CVE-2018-5686 (gs bz
#698860)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7151603128"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mupdf-1.12.0-2.fc26")) flag++;
