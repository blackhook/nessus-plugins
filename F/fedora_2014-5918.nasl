...
# extracted from Fedora Security Advisory 2014-5918.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5918");

  script_name(english:"Fedora 20 : owncloud-6.0.3-1.fc20 (2014-5918)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1079855"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1091987"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133263.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fbee4854"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"owncloud-6.0.3-1.fc20")) flag++;
