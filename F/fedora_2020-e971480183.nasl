...
# extracted from Fedora Security Advisory FEDORA-2020-e971480183.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : golang (2020-e971480183)");
...
"  - Rebase to go1.14.13
  ...
  - Security fix for CVE-2020-28362, CVE-2020-28367 and
    CVE-2020-28366
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e971480183"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"golang-1.14.13-1.fc32")) flag++;
