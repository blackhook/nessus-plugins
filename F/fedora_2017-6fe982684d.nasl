...
# extracted from Fedora Security Advisory FEDORA-2017-6fe982684d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-6fe982684d");

  script_name(english:"Fedora 25 : mupdf (2017-6fe982684d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6fe982684d"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mupdf-1.10a-1.fc25")) flag++;
