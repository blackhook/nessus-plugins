...
# extracted from Fedora Security Advisory FEDORA-2016-fad6fc78dd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-fad6fc78dd");

  script_name(english:"Fedora 24 : golang (2016-fad6fc78dd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-fad6fc78dd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"golang-1.6.4-2.fc24")) flag++;
