...
# extracted from Fedora Security Advisory 2016-f802cade15.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-f802cade15");

  script_name(english:"Fedora 23 : exiv2-0.25-3.fc23 (2016-f802cade15)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2149b164"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"exiv2-0.25-3.fc23")) flag++;
