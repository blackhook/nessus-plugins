...
# extracted from Fedora Security Advisory FEDORA-2018-602b5345fa.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-602b5345fa");

  script_name(english:"Fedora 27 : clamav (2018-602b5345fa)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-602b5345fa"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"clamav-0.99.4-1.fc27")) flag++;
