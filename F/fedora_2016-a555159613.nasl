...
# extracted from Fedora Security Advisory FEDORA-2016-a555159613.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-2177", "CVE-2016-2178", "CVE-2016-2179", "CVE-2016-2180", "CVE-2016-2181", "CVE-2016-2182", "CVE-2016-6302", "CVE-2016-6304", "CVE-2016-6306", "CVE-2016-7052");
  script_xref(name:"FEDORA", value:"2016-a555159613");

  script_name(english:"Fedora 24 : 1:openssl (2016-a555159613)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a555159613"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"openssl-1.0.2j-1.fc24", epoch:"1")) flag++;
