...
# extracted from Fedora Security Advisory 2007-1157.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : blam-1.8.3-5.fc7 (2007-1157)");
...
Users of Blam are advised to upgrade to this errata package, which has
been rebuilt against the updated Firefox package.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/002828.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e6f0e440"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"blam-1.8.3-5.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"blam-debuginfo-1.8.3-5.fc7")) flag++;
