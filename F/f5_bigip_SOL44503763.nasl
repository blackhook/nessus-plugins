...
# extracted from F5 Networks BIG-IP Solution K44503763.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : libcurl vulnerability (K44503763)");
...
buffer being under allocated in 32bit systems if it receives at least
1Gb as input via `CURLOPT_USERNAME`. (CVE-2016-8617)

Impact

This vulnerability may allow an attacker to overwrite memory behind
the output buffer."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K44503763"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
