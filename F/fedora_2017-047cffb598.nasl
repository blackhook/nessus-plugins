...
# extracted from Fedora Security Advisory FEDORA-2017-047cffb598.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-047cffb598");

  script_name(english:"Fedora 25 : ghostscript (2017-047cffb598)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-047cffb598"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1434353"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ghostscript-9.20-7.fc25")) flag++;
