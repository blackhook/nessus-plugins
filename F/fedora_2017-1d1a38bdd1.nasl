...
# extracted from Fedora Security Advisory FEDORA-2017-1d1a38bdd1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1d1a38bdd1");

  script_name(english:"Fedora 25 : subversion (2017-1d1a38bdd1)");
...
#### Client-side bugfixes :
  ...
  - Fix arbitrary code execution vulnerability CVE-2017-9800
    See
    <https://subversion.apache.org/security/CVE-2017-9800-ad
    visory.txt> for details.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1d1a38bdd1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"subversion-1.9.7-1.fc25")) flag++;
