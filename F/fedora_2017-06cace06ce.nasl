...
# extracted from Fedora Security Advisory FEDORA-2017-06cace06ce.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : mingw-openjpeg2 / openjpeg2 (2017-06cace06ce)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-06cace06ce"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-openjpeg2-2.2.0-2.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"openjpeg2-2.2.0-2.fc26")) flag++;
