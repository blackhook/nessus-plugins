...
# extracted from Fedora Security Advisory FEDORA-2019-8606c6da35.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : wordpress (2019-8606c6da35)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8606c6da35"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"wordpress-5.1.1-1.fc28")) flag++;
