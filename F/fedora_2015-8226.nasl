...
# extracted from Fedora Security Advisory 2015-8226.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8226");

  script_name(english:"Fedora 22 : java-1.8.0-openjdk-1.8.0.45-38.b14.fc22 (2015-8226)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158791.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?66fb2158"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"java-1.8.0-openjdk-1.8.0.45-38.b14.fc22")) flag++;
