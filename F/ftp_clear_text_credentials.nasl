...
encrypted.");
 ...
 script_set_attribute(attribute:"cvss_score_rationale", value:"Cleartext credentials can be intercepted on the network");
 script_cwe_id(
 ...
 script_dependencies("ftpserver_detect_type_nd_version.nasl", "ftp_starttls.nasl", "smtp_settings.nasl");
