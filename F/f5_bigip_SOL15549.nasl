...
# extracted from F5 Networks BIG-IP Solution SOL15549.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2007-6199");
  script_bugtraq_id(26638);

  script_name(english:"F5 Networks BIG-IP : Rsync vulnerability (SOL15549)");
...
outside of the module's hierarchy."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15549"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("11.6.0","11.4.0-11.5.1");
vmatrix["AM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.1","10.1.0-10.2.4");
vmatrix["APM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.1","10.0.0-10.2.4");
vmatrix["ASM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.1");
vmatrix["AVR"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.1","10.0.0-10.2.4");
vmatrix["GTM"]["unaffected"] = make_list("11.6.0HF5","11.5.2","11.4.1HF9");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.1","10.0.0-10.2.4");
vmatrix["LC"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.1","10.0.0-10.2.4");
vmatrix["LTM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("11.6.0","11.3.0-11.5.1");
vmatrix["PEM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.2","11.4.1HF9");
