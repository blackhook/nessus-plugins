...
# extracted from Fedora Security Advisory 2005-622.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-622");

  script_name(english:"Fedora Core 4 : yelp-2.10.0-1.4.1 (2005-622)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-July/001117.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c55c8a02"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"yelp-2.10.0-1.4.1")) flag++;
if (rpm_check(release:"FC4", reference:"yelp-debuginfo-2.10.0-1.4.1")) flag++;
