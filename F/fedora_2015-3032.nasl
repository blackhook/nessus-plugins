...
# extracted from Fedora Security Advisory 2015-3032.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3032");

  script_name(english:"Fedora 21 : jBCrypt-0.4-1.fc21 (2015-3032)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/151786.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f01574dc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"jBCrypt-0.4-1.fc21")) flag++;
