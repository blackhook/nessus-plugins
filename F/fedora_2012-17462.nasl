...
# extracted from Fedora Security Advisory 2012-17462.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 17 : kernel-3.6.5-1.fc17 (2012-17462)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6efa5acf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"kernel-3.6.5-1.fc17")) flag++;
