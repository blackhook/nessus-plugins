...
# extracted from Fedora Security Advisory FEDORA-2018-25a7ba3cb6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-25a7ba3cb6");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/03");
  script_xref(name:"CEA-ID", value:"CEA-2020-0129");

  script_name(english:"Fedora 26 : exim (2018-25a7ba3cb6)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-25a7ba3cb6");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"exim-4.90.1-2.fc26")) flag++;
