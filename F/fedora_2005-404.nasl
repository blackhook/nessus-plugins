...
# extracted from Fedora Security Advisory 2005-404.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-404");

  script_name(english:"Fedora Core 3 : mikmod-3.1.6-31.FC3 (2005-404)");
  ...
  script_set_attribute(
    ...
    value:
"  - Mon Jun 06 2005 Martin Stransky <stransky at redhat.com>
    3.1.6-31.FC3
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-June/000930.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0ac019c8"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"mikmod-3.1.6-31.FC3")) flag++;
if (rpm_check(release:"FC3", reference:"mikmod-debuginfo-3.1.6-31.FC3")) flag++;
if (rpm_check(release:"FC3", reference:"mikmod-devel-3.1.6-31.FC3")) flag++;
