...
# extracted from Fedora Security Advisory 2008-0856.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : mantis-1.1.1-1.fc8 (2008-0856)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-January/007087.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1235c744"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"mantis-1.1.1-1.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mantis-config-httpd-1.1.1-1.fc8")) flag++;
