...
# extracted from Fedora Security Advisory FEDORA-2020-7e042e371a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 1:java-11-openjdk (2020-7e042e371a)");
...
http://mail.openjdk.java.net/pipermail/jdk-updates-dev/2020-January/00
2374.html
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7e042e371a"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"java-11-openjdk-11.0.6.10-0.fc31", epoch:"1")) flag++;
