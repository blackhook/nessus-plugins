...
# extracted from Fedora Security Advisory FEDORA-2018-9438795217.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-9438795217");

  script_name(english:"Fedora 28 : php (2018-9438795217)");
...
**Core:**
  ...
  - Fixed bug php#76520 (Object creation leaks memory when
    executed over HTTP). (Nikita)
...
**EXIF:**
  ...
  - Fixed bug php#76409 (heap use after free in
    _php_stream_free). (cmb)

  - Fixed bug php#76423 (Int Overflow lead to Heap OverFlow
    in exif_thumbnail_extract of exif.c). (Stas)

  - Fixed bug php#76557 (heap-buffer-overflow (READ of size
    48) while reading exif data). (Stas)
...
**Opcache:**
  ...
  - Fixed bug php#76477 (Opcache causes empty return value).
    (Nikita, Laruence)
...
**Win32:**
  ...
  - Fixed bug php#76459 (windows linkinfo lacks openbasedir
    check). (Anatol)

**ZIP:**

  - Fixed bug php#76461 (OPSYS_Z_CPM defined instead of
    OPSYS_CPM). (Dennis Birkholz, Remi)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9438795217"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"php-7.2.8-1.fc28")) flag++;
