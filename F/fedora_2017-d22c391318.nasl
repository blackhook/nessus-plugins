...
# extracted from Fedora Security Advisory FEDORA-2017-d22c391318.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d22c391318");

  script_name(english:"Fedora 26 : upx (2017-d22c391318)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d22c391318"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"upx-3.94-1.fc26")) flag++;
