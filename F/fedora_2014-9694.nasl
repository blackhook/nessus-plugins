...
# extracted from Fedora Security Advisory 2014-9694.
#
...
if (description)
{
  ...
  script_bugtraq_id(69064);
  script_xref(name:"FEDORA", value:"2014-9694");

  script_name(english:"Fedora 20 : smack-3.2.2-5.fc20 (2014-9694)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1127276"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137233.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?871cd9a7"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"smack-3.2.2-5.fc20")) flag++;
