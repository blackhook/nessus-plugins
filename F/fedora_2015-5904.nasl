...
# extracted from Fedora Security Advisory 2015-5904.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5904");

  script_name(english:"Fedora 22 : perl-Module-Signature-0.78-1.fc22 / perl-Test-Signature-1.11-1.fc22 (2015-5904)");
...
changed default behaviour is included in this update.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155160.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2b404c16"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155161.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f6804cc"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC22", reference:"perl-Module-Signature-0.78-1.fc22")) flag++;
if (rpm_check(release:"FC22", reference:"perl-Test-Signature-1.11-1.fc22")) flag++;
