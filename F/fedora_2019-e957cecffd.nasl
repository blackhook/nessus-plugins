...
# extracted from Fedora Security Advisory FEDORA-2019-e957cecffd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : polkit (2019-e957cecffd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e957cecffd"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC29", reference:"polkit-0.115-4.2.fc29")) flag++;
