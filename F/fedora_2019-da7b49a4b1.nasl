...
# extracted from Fedora Security Advisory FEDORA-2019-da7b49a4b1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : wordpress (2019-da7b49a4b1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-da7b49a4b1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"wordpress-5.3.2-1.fc30")) flag++;
