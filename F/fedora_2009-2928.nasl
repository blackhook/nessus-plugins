...
# extracted from Fedora Security Advisory 2009-2928.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2928");

  script_name(english:"Fedora 9 : lcms-1.18-1.fc9 (2009-2928)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021604.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7a973bdb"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"lcms-1.18-1.fc9")) flag++;
