...
# extracted from Fedora Security Advisory FEDORA-2017-a41f6a8078.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a41f6a8078");

  script_name(english:"Fedora 27 : python34 (2017-a41f6a8078)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a41f6a8078"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"python34-3.4.7-2.fc27")) flag++;
