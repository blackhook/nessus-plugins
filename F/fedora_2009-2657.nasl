...
# extracted from Fedora Security Advisory 2009-2657.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2657");

  script_name(english:"Fedora 10 : glib2-2.18.4-2.fc10 (2009-2657)");
...
code. This has been reported in CVE-2008-4316.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022690.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a3a9ba5"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"glib2-2.18.4-2.fc10")) flag++;
