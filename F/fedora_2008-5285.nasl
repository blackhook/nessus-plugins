...
# extracted from Fedora Security Advisory 2008-5285.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : xorg-x11-server-1.3.0.0-17.fc7 (2008-5285)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-June/011299.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?03a0dbc0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"xorg-x11-server-1.3.0.0-17.fc7")) flag++;
