...
# extracted from Fedora Security Advisory 2009-3433.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-3433");

  script_name(english:"Fedora 10 : xine-lib-1.1.16.3-1.fc10 (2009-3433)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022161.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b9417d7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"xine-lib-1.1.16.3-1.fc10")) flag++;
