...
# extracted from Fedora Security Advisory FEDORA-2016-87dc28b1a0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-87dc28b1a0");

  script_name(english:"Fedora 25 : w3m (2016-87dc28b1a0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-87dc28b1a0"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"w3m-0.5.3-27.git20161120.fc25")) flag++;
