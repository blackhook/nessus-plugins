...
# extracted from Fedora Security Advisory 2009-9400.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-9400");

  script_name(english:"Fedora 10 : kdelibs3-3.5.10-13.fc10.1 (2009-9400)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-September/028896.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?976a1c6a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"kdelibs3-3.5.10-13.fc10.1")) flag++;
