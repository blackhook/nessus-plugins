...
# extracted from Fedora Security Advisory 2007-1219.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 5 : cups-1.2.8-1.fc5 (2007-1219)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-March/001564.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6b9cb519"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"cups-1.2.8-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"cups-debuginfo-1.2.8-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"cups-devel-1.2.8-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"cups-libs-1.2.8-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"cups-lpd-1.2.8-1.fc5")) flag++;
