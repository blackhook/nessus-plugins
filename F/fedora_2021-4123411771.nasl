...
# extracted from Fedora Security Advisory FEDORA-2021-4123411771
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-4123411771");

  script_name(english:"Fedora 33 : seamonkey (2021-4123411771)");
...
FEDORA-2021-4123411771 advisory.

  - Update to 2.53.6 (FEDORA-2021-4123411771)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-4123411771");
...
pkgs = [
    {'reference':'seamonkey-2.53.6-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
