...
# extracted from Fedora Security Advisory FEDORA-2016-897a1e6698.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-897a1e6698");

  script_name(english:"Fedora 25 : smack (2016-897a1e6698)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-897a1e6698"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"smack-4.1.5-3.fc25")) flag++;
