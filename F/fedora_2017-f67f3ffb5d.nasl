...
# extracted from Fedora Security Advisory FEDORA-2017-f67f3ffb5d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f67f3ffb5d");

  script_name(english:"Fedora 26 : 1:xrdp (2017-f67f3ffb5d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f67f3ffb5d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"xrdp-0.9.4-2.fc26", epoch:"1")) flag++;
