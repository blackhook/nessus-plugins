...
# extracted from Fedora Security Advisory FEDORA-2021-a4f016c6c8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a4f016c6c8");

  script_name(english:"Fedora 33 : 5:mutt (2021-a4f016c6c8)");
...
FEDORA-2021-a4f016c6c8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a4f016c6c8");
...
pkgs = [
    {'reference':'mutt-2.0.5-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
];
