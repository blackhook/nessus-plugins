...
# extracted from Fedora Security Advisory FEDORA-2017-8614a6e905.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-8614a6e905");

  script_name(english:"Fedora 26 : python-django (2017-8614a6e905)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-8614a6e905"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"python-django-1.10.8-1.fc26")) flag++;
