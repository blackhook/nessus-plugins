...
# extracted from Fedora Security Advisory 2011-0316.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0316");

  script_name(english:"Fedora 14 : libuser-0.56.18-3.fc14 (2011-0316)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053365.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?79a8a1b0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"libuser-0.56.18-3.fc14")) flag++;
