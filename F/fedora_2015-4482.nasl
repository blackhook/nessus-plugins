...
# extracted from Fedora Security Advisory 2015-4482.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4482");

  script_name(english:"Fedora 21 : osc-0.151.1-163.2.1.fc21 (2015-4482)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154267.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fa37b5f0"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"osc-0.151.1-163.2.1.fc21")) flag++;
