...
# extracted from Fedora Security Advisory 2015-14361.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-14361");

  script_name(english:"Fedora 23 : xen-4.5.1-6.fc23 (2015-14361)");
  ...
  script_set_attribute(
    ...
    value:
"Use after free in QEMU/Xen block unplug protocol [XSA-139,
CVE-2015-5166] QEMU leak of uninitialized heap memory in rtl8139
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6f047789"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"xen-4.5.1-6.fc23")) flag++;
