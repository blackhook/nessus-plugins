...
# extracted from Fedora Security Advisory 2011-4964.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-4964");

  script_name(english:"Fedora 15 : libvirt-0.8.8-4.fc15 (2011-4964)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058093.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cafc576e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libvirt-0.8.8-4.fc15")) flag++;
