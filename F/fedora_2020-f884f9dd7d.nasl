...
# extracted from Fedora Security Advisory FEDORA-2020-f884f9dd7d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : kernel / kernel-headers (2020-f884f9dd7d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f884f9dd7d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"kernel-5.4.19-200.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"kernel-headers-5.4.18-200.fc31")) flag++;
