...
# extracted from Fedora Security Advisory FEDORA-2017-deefb26e8b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : mingw-openjpeg2 / openjpeg2 (2017-deefb26e8b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-deefb26e8b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-openjpeg2-2.2.0-2.fc25")) flag++;
if (rpm_check(release:"FC25", reference:"openjpeg2-2.2.0-2.fc25")) flag++;
