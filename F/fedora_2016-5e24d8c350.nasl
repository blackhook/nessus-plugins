...
# extracted from Fedora Security Advisory FEDORA-2016-5e24d8c350.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : kernel (2016-5e24d8c350)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-5e24d8c350"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2016-6828");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2016-5e24d8c350");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC24", reference:"kernel-4.6.7-300.fc24")) flag++;
