...
# extracted from Fedora Security Advisory 2015-aa14be8d92.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-aa14be8d92");

  script_name(english:"Fedora 23 : claws-mail-3.13.1-4.fc23 (2015-aa14be8d92)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?998ba029"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"claws-mail-3.13.1-4.fc23")) flag++;
