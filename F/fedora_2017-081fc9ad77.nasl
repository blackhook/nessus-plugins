...
# extracted from Fedora Security Advisory FEDORA-2017-081fc9ad77.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : knot-resolver (2017-081fc9ad77)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-081fc9ad77"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"knot-resolver-1.3.1-1.fc24")) flag++;
