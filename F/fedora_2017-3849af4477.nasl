...
# extracted from Fedora Security Advisory FEDORA-2017-3849af4477.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-3849af4477");

  script_name(english:"Fedora 24 : libplist (2017-3849af4477)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3849af4477"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libplist-2.0.0-1.fc24")) flag++;
