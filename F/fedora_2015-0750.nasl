...
# extracted from Fedora Security Advisory 2015-0750.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-8737", "CVE-2014-8738");
  script_bugtraq_id(70908, 71083);
  script_xref(name:"FEDORA", value:"2015-0750");

  script_name(english:"Fedora 21 : binutils-2.24-30.fc21 (2015-0750)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148438.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2d24e005"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"binutils-2.24-30.fc21")) flag++;
