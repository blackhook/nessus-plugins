...
# extracted from Fedora Security Advisory FEDORA-2021-f347d1c866
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-f347d1c866");

  script_name(english:"Fedora 32 : 1:openssl (2021-f347d1c866)");
...
FEDORA-2021-f347d1c866 advisory.

  - update to version 1.1.1k  (FEDORA-2021-f347d1c866)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-f347d1c866");
...
pkgs = [
    {'reference':'openssl-1.1.1k-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
