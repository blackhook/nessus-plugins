...
# extracted from Fedora Security Advisory 2013-2955.
#
...
if (description)
{
  ...
  script_bugtraq_id(58105);
  script_xref(name:"FEDORA", value:"2013-2955");

  script_name(english:"Fedora 17 : nginx-1.0.15-9.fc17 (2013-2955)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=913734"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-March/099655.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4020c609"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"nginx-1.0.15-9.fc17")) flag++;
