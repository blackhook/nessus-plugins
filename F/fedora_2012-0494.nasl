...
# extracted from Fedora Security Advisory 2012-0494.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-0494");

  script_name(english:"Fedora 16 : emacs-23.3-9.fc16 (2012-0494)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=773023"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-January/072288.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1085618f"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"emacs-23.3-9.fc16")) flag++;
