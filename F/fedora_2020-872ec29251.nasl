...
# extracted from Fedora Security Advisory FEDORA-2020-872ec29251.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : varnish (2020-872ec29251)");
...
"New upstream release, a security release
  ...
  - Temporarily disable haproxy unit tests, as haproxy seems
    broken in rawhide
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-872ec29251"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"varnish-6.3.2-3.fc30")) flag++;
