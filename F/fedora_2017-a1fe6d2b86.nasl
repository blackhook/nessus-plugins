...
# extracted from Fedora Security Advisory FEDORA-2017-a1fe6d2b86.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a1fe6d2b86");

  script_name(english:"Fedora 25 : nasm (2017-a1fe6d2b86)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a1fe6d2b86"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"nasm-2.13.01-3.fc25")) flag++;
