...
# extracted from Fedora Security Advisory FEDORA-2019-a87aba290f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-a87aba290f");

  script_name(english:"Fedora 29 : 1:java-1.8.0-openjdk (2019-a87aba290f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a87aba290f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"java-1.8.0-openjdk-1.8.0.232.b09-0.fc29", epoch:"1")) flag++;
