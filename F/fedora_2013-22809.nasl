...
# extracted from Fedora Security Advisory 2013-22809.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-22809");

  script_name(english:"Fedora 20 : net-snmp-5.7.2-16.fc20 (2013-22809)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cc1a38ab"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"net-snmp-5.7.2-16.fc20")) flag++;
