...
# extracted from Fedora Security Advisory FEDORA-2016-777d838c1b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-777d838c1b");

  script_name(english:"Fedora 22 : ntp (2016-777d838c1b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-777d838c1b"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"ntp-4.2.6p5-40.fc22")) flag++;
