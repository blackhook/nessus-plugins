...
# extracted from Fedora Security Advisory FEDORA-2019-f36ac0db92.
#
...
if (description)
{
  script_id(130137);
  script_version("1.1");
  script_cvs_date("Date: 2019/10/22 10:44:43");

  script_xref(name:"FEDORA", value:"2019-f36ac0db92");

  script_name(english:"Fedora 30 : 1:java-11-openjdk (2019-f36ac0db92)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f36ac0db92"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"java-11-openjdk-11.0.5.10-0.fc30", epoch:"1")) flag++;
