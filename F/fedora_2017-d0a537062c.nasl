...
# extracted from Fedora Security Advisory FEDORA-2017-d0a537062c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d0a537062c");

  script_name(english:"Fedora 24 : 2:samba (2017-d0a537062c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d0a537062c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"samba-4.4.9-0.fc24", epoch:"2")) flag++;
