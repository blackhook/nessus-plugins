...
# extracted from Fedora Security Advisory FEDORA-2016-cde4525fab.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-cde4525fab");

  script_name(english:"Fedora 25 : moin (2016-cde4525fab)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-cde4525fab"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"moin-1.9.9-1.fc25")) flag++;
