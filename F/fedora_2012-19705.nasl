...
# extracted from Fedora Security Advisory 2012-19705.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-19705");

  script_name(english:"Fedora 17 : bogofilter-1.2.3-1.fc17 (2012-19705)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=883358"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/094623.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3c266fae"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"bogofilter-1.2.3-1.fc17")) flag++;
