...
# extracted from Fedora Security Advisory FEDORA-2017-bd3c3c957f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-bd3c3c957f");

  script_name(english:"Fedora 25 : viewvc (2017-bd3c3c957f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-bd3c3c957f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"viewvc-1.1.26-1.fc25")) flag++;
