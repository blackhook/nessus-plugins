...
# extracted from Fedora Security Advisory 2013-23139.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-23139");

  script_name(english:"Fedora 18 : nspr-4.10.2-1.fc18 (2013-23139)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123450.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c3fa1ff9"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"nspr-4.10.2-1.fc18")) flag++;
