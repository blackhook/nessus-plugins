...
# extracted from Fedora Security Advisory FEDORA-2019-f0d1f795c7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : putty (2019-f0d1f795c7)");
  ...
  script_set_attribute(
    ...
    value:
"This is an update fixing multiple vulnerabilities.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-f0d1f795c7"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"putty-0.73-1.fc29")) flag++;
