...
# extracted from Fedora Security Advisory FEDORA-2018-1c5750c688.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-1c5750c688");

  script_name(english:"Fedora 28 : seamonkey (2018-1c5750c688)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-1c5750c688"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2018/05/13");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"seamonkey-2.49.3-1.fc28")) flag++;
