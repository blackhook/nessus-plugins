...
# extracted from Fedora Security Advisory 2012-20531.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-20531");

  script_name(english:"Fedora 17 : libvirt-0.9.11.8-2.fc17 (2012-20531)");
...
"  - Fix conflict with NM launched dnsmasq (bz #886663)
    ...
    - CVE-2012-3411: avoid open DNS proxy with dnsmasq (bz
      #874702, bz #882309)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=874702"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/095332.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?150ee7fc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"libvirt-0.9.11.8-2.fc17")) flag++;
