...
# extracted from Fedora Security Advisory 2015-5813.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5813");

  script_name(english:"Fedora 21 : knot-1.6.3-1.fc21 (2015-5813)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154751.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9583ec1"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"knot-1.6.3-1.fc21")) flag++;
