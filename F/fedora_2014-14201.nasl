...
# extracted from Fedora Security Advisory 2014-14201.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-14201");

  script_name(english:"Fedora 21 : polarssl-1.3.9-1.fc21 (2014-14201)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/142914.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2bbdd7f6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"polarssl-1.3.9-1.fc21")) flag++;
