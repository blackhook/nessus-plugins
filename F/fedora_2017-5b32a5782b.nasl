...
# extracted from Fedora Security Advisory FEDORA-2017-5b32a5782b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-5b32a5782b");

  script_name(english:"Fedora 24 : tor (2017-5b32a5782b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-5b32a5782b"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"tor-0.2.9.10-1.fc24")) flag++;
