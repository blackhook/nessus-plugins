...
# extracted from Fedora Security Advisory 2013-23683.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-23683");

  script_name(english:"Fedora 20 : nss-3.15.3.1-1.fc20 (2013-23683)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/124865.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?319cb6ab"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"nss-3.15.3.1-1.fc20")) flag++;
