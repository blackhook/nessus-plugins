...
# extracted from Fedora Security Advisory 2013-15181.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-15181");

  script_name(english:"Fedora 18 : ansible-1.2.3-2.fc18 (2013-15181)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd4c7cc0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"ansible-1.2.3-2.fc18")) flag++;
