...
# extracted from Fedora Security Advisory FEDORA-2017-4a071ecbc7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-4a071ecbc7");

  script_name(english:"Fedora 27 : jackson-databind (2017-4a071ecbc7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4a071ecbc7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"jackson-databind-2.7.6-5.fc27")) flag++;
