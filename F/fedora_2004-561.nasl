...
# extracted from Fedora Security Advisory 2004-561.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-561");

  script_name(english:"Fedora Core 2 : samba-3.0.10-1.fc2 (2004-561)");
  ...
  script_set_attribute(
    ...
    value:
"  - Fri Dec 17 2004 Jay Fenlason <fenlason at redhat.com>
    3.0.10-1.fc2

  - New upstream release that closes CVE-2004-1154 bz#142544

    - Include the -64bit patch from Nalin. This closes
      bz#142873

    - Update the -logfiles patch to work with 3.0.10

    - Create /var/run/winbindd and make it part of the
      -common rpm to close bz#142242
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-December/000521.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bfb24775"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"samba-3.0.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-client-3.0.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-common-3.0.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-debuginfo-3.0.10-1.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-swat-3.0.10-1.fc2")) flag++;
