...
# extracted from Fedora Security Advisory 2009-4064.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-4064");

  script_name(english:"Fedora 9 : libmodplug-0.8.7-1.fc9 (2009-4064)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022853.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97c73008"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"libmodplug-0.8.7-1.fc9")) flag++;
