...
# extracted from Fedora Security Advisory FEDORA-2019-b607cc1839.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-b607cc1839");

  script_name(english:"Fedora 30 : pspp (2019-b607cc1839)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b607cc1839"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"pspp-1.2.0-1.fc30")) flag++;
