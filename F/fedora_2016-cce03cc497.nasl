...
# extracted from Fedora Security Advisory FEDORA-2016-cce03cc497.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-cce03cc497");

  script_name(english:"Fedora 24 : openssh (2016-cce03cc497)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-cce03cc497"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"openssh-7.2p2-5.fc24")) flag++;
