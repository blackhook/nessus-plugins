...
# extracted from Fedora Security Advisory FEDORA-2017-2f1ca6beb7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-2f1ca6beb7");

  script_name(english:"Fedora 25 : cacti (2017-2f1ca6beb7)");
...
Release notes: https://www.cacti.net/release_notes.php?version=1.1.19
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2f1ca6beb7"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.cacti.net/release_notes.php?version=1.1.19"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"cacti-1.1.19-1.fc25")) flag++;
