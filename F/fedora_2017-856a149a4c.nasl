...
# extracted from Fedora Security Advisory FEDORA-2017-856a149a4c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-856a149a4c");

  script_name(english:"Fedora 26 : thunderbird-enigmail (2017-856a149a4c)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 1.9.9. This release addresses security vulnerabilities
discovered by Cure53. Details can be found in the Security Audit
Report:
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-856a149a4c"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"thunderbird-enigmail-1.9.9-1.fc26")) flag++;
