...
# extracted from Fedora Security Advisory FEDORA-2021-14f6642aa6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-14f6642aa6");

  script_name(english:"Fedora 32 : kernel / kernel-headers / kernel-tools (2021-14f6642aa6)");
...
FEDORA-2021-14f6642aa6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-14f6642aa6");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2021-28375');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-14f6642aa6');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.11.7-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-5.11.7-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-tools-5.11.7-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
