...
# extracted from F5 Networks BIG-IP Solution K94105604.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K94105604)");
...
(OOPS) via crafted keyctl commands. (CVE-2015-7872)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K94105604"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["APM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF3","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.1.0-11.5.4");
vmatrix["ASM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF3","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.1.0-11.5.4");
vmatrix["AVR"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF3","11.6.2","11.5.5","11.0.0");
...
vmatrix["LC"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF3","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.1.0-11.5.4");
vmatrix["LTM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF3","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");
