...
# extracted from Fedora Security Advisory 2013-6148.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-6148");

  script_name(english:"Fedora 19 : postgresql-9.2.4-1.fc19 (2013-6148)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?64e6d83a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"postgresql-9.2.4-1.fc19")) flag++;
