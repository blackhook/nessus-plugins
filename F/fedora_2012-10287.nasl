...
# extracted from Fedora Security Advisory 2012-10287.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-10287");

  script_name(english:"Fedora 17 : pidgin-2.10.5-1.fc17 (2012-10287)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-July/083599.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4d0ab5c8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"pidgin-2.10.5-1.fc17")) flag++;
