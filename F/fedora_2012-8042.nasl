...
# extracted from Fedora Security Advisory 2012-8042.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8042");

  script_name(english:"Fedora 16 : libreoffice-3.4.5.2-15.fc16 (2012-8042)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6025b7fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"libreoffice-3.4.5.2-15.fc16")) flag++;
