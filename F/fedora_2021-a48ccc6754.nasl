...
# extracted from Fedora Security Advisory FEDORA-2021-a48ccc6754
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a48ccc6754");

  script_name(english:"Fedora 32 : mingw-flac (2021-a48ccc6754)");
...
FEDORA-2021-a48ccc6754 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a48ccc6754");
...
pkgs = [
    {'reference':'mingw-flac-1.3.3-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
