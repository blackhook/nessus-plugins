...
# extracted from Fedora Security Advisory 2015-97055df8a0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-97055df8a0");

  script_name(english:"Fedora 22 : proftpd-1.3.5a-5.fc22 (2015-97055df8a0)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-December/173688.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d88b5bfa"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"proftpd-1.3.5a-5.fc22")) flag++;
