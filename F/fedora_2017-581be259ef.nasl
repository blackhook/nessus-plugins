...
# extracted from Fedora Security Advisory FEDORA-2017-581be259ef.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : 2:samba (2017-581be259ef)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-581be259ef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"samba-4.5.14-0.fc25", epoch:"2")) flag++;
