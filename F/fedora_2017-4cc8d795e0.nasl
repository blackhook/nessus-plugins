...
# extracted from Fedora Security Advisory FEDORA-2017-4cc8d795e0.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-7489");
  script_xref(name:"FEDORA", value:"2017-4cc8d795e0");

  script_name(english:"Fedora 25 : moodle (2017-4cc8d795e0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4cc8d795e0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"moodle-3.1.6-1.fc25")) flag++;
