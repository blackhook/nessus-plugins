...
# extracted from Fedora Security Advisory 2009-3011.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-3011");

  script_name(english:"Fedora 10 : argyllcms-1.0.3-3.fc10 (2009-3011)");
...
Consortium Format Library (icclib). An attacker could use this flaw to
potentially execute arbitrary code by requesting to translate a
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021681.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?11517a5e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"argyllcms-1.0.3-3.fc10")) flag++;
