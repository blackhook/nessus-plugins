...
# extracted from Fedora Security Advisory 2012-5080.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-5080");

  script_name(english:"Fedora 16 : libpng10-1.0.59-1.fc16 (2012-5080)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/077043.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?243521e5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"libpng10-1.0.59-1.fc16")) flag++;
