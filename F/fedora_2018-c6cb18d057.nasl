...
# extracted from Fedora Security Advisory FEDORA-2018-c6cb18d057.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-c6cb18d057");

  script_name(english:"Fedora 27 : seamonkey (2018-c6cb18d057)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c6cb18d057"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"seamonkey-2.49.2-2.fc27")) flag++;
