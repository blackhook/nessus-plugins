...
# extracted from Fedora Security Advisory FEDORA-2020-202cb87e26.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 1:java-1.8.0-openjdk (2020-202cb87e26)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-202cb87e26"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"java-1.8.0-openjdk-1.8.0.242.b08-0.fc31", epoch:"1")) flag++;
