...
# extracted from Fedora Security Advisory 2012-16440.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16440");

  script_name(english:"Fedora 17 : Django-1.4.2-1.fc17 (2012-16440)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a59b190"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"Django-1.4.2-1.fc17")) flag++;
