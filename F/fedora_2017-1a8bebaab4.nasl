...
# extracted from Fedora Security Advisory FEDORA-2017-1a8bebaab4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1a8bebaab4");

  script_name(english:"Fedora 24 : phpldapadmin (2017-1a8bebaab4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1a8bebaab4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"phpldapadmin-1.2.3-10.fc24")) flag++;
