...
# extracted from F5 Networks BIG-IP Solution SOL17199.
#
...
if (description)
{
  ...
  script_bugtraq_id(70691);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL17199)");
...
PR_SET_TSC prctl calls within a modified copy of QEMU."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17199"
  );
  script_set_attribute(
    attribute:"solution",
    value:
