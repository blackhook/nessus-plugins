...
# extracted from Fedora Security Advisory 2010-1743.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : moin-1.8.7-1.fc11 (2010-1743)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-February/035374.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78dd386d"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"moin-1.8.7-1.fc11")) flag++;
