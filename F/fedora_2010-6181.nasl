...
# extracted from Fedora Security Advisory 2010-6181.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-6181");

  script_name(english:"Fedora 13 : drupal-views-6.x.2.9-1.fc13 (2010-6181)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/038707.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1fcef11d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"drupal-views-6.x.2.9-1.fc13")) flag++;
