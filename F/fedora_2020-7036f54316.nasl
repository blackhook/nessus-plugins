...
# extracted from Fedora Security Advisory FEDORA-2020-7036f54316.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-7036f54316");

  script_name(english:"Fedora 31 : okular (2020-7036f54316)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7036f54316"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected okular package."
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"okular-19.12.3-2.fc31")) flag++;
