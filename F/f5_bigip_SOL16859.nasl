...
# extracted from F5 Networks BIG-IP Solution SOL16859.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : SUSE coreutils vulnerabilities (SOL16859)");
...
in the alloca function."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16859"
  );
  script_set_attribute(
    attribute:"solution",
    value:
