...
# extracted from Fedora Security Advisory 2007-256.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : gnucash-2.0.5-1.fc6 (2007-256)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-February/001514.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2823b778"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected gnucash and / or gnucash-debuginfo packages."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:P/A:P");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gnucash");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:gnucash-debuginfo");
...
flag = 0;
if (rpm_check(release:"FC6", reference:"gnucash-2.0.5-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"gnucash-debuginfo-2.0.5-1.fc6")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gnucash / gnucash-debuginfo");
}
