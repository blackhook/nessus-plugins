...
# extracted from Fedora Security Advisory FEDORA-2017-b97f9d82dc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b97f9d82dc");

  script_name(english:"Fedora 25 : libmspack (2017-b97f9d82dc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b97f9d82dc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libmspack-0.6-0.1.alpha.fc25")) flag++;
