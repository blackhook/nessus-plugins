...
# extracted from F5 Networks BIG-IP Solution SOL15348.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2009-1387");
  script_bugtraq_id(35417);

  script_name(english:"F5 Networks BIG-IP : OpenSSL DTLS Buffer vulnerability (SOL15348)");
...
out-of-sequence DTLS handshake message, related to a 'fragment bug.'"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15348"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["AM"]["affected"  ] = make_list("11.0.0-11.3.0","10.1.0-10.2.4");
vmatrix["AM"]["unaffected"] = make_list("11.4.0-11.5.1");
