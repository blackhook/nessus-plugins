...
# extracted from Fedora Security Advisory FEDORA-2017-d0c9bf9508.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d0c9bf9508");

  script_name(english:"Fedora 24 : bind99 (2017-d0c9bf9508)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d0c9bf9508"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"bind99-9.9.9-4.P6.fc24")) flag++;
