...
# extracted from Fedora Security Advisory FEDORA-2016-a21b2cb7a0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : xen (2016-a21b2cb7a0)");
...
back compatibility and for virt-manager

----

qemu-kvm: Integer overflow in SDL when creating too wide screen, QEMU:
Banked access to VGA memory (VBE) uses inconsistent bounds check
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a21b2cb7a0"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"xen-4.6.1-8.fc24")) flag++;
