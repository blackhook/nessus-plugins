...
# extracted from Fedora Security Advisory FEDORA-2020-2bed89517f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-2bed89517f");

  script_name(english:"Fedora 30 : ansible (2020-2bed89517f)");
  ...
  script_set_attribute(
    ...
    value:
"Update to bugfix release 2.9.3. See
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2bed89517f"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"ansible-2.9.3-1.fc30")) flag++;
