...
# extracted from Fedora Security Advisory 2012-4935.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-4935");

  script_name(english:"Fedora 17 : freetype-2.4.8-3.fc17 (2012-4935)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/077429.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4dd8a84"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"freetype-2.4.8-3.fc17")) flag++;
