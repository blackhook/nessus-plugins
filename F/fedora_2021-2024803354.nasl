...
# extracted from Fedora Security Advisory FEDORA-2021-2024803354
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-2024803354");

  script_name(english:"Fedora 32 : 1:busybox (2021-2024803354)");
...
FEDORA-2021-2024803354 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-2024803354");
...
pkgs = [
    {'reference':'busybox-1.32.1-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
