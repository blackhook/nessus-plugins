...
# extracted from Fedora Security Advisory 2007-3667.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : cacti-0.8.7a-1.fc8 (2007-3667)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Nov 20 2007 Mike McGrath <mmcgrath at redhat.com> -
    0.8.7a-1
    ...
    - Sat Oct 13 2007 Mike McGrath <mmcgrath at redhat.com>
      - 0.8.7-2
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=391981"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/005182.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5b1919e"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"cacti-0.8.7a-1.fc8")) flag++;
