...
# extracted from Fedora Security Advisory 2007-552.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 5 : devhelp-0.11-7.fc5 / epiphany-2.14.3-6.fc5 / seamonkey-1.0.9-1.fc5 / etc (2007-552)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001766.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9de1cd6"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001767.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?19a029b6"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001768.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e4a99ed4"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001769.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e08eb091"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"devhelp-0.11-7.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"devhelp-debuginfo-0.11-7.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"devhelp-devel-0.11-7.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"epiphany-2.14.3-6.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"epiphany-debuginfo-2.14.3-6.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"epiphany-devel-2.14.3-6.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"seamonkey-1.0.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"seamonkey-chat-1.0.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"seamonkey-debuginfo-1.0.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"seamonkey-devel-1.0.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"seamonkey-dom-inspector-1.0.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"seamonkey-js-debugger-1.0.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"seamonkey-mail-1.0.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"yelp-2.14.3-5.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"yelp-debuginfo-2.14.3-5.fc5")) flag++;
