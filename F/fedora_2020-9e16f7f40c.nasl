...
# extracted from Fedora Security Advisory FEDORA-2020-9e16f7f40c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : tor (2020-9e16f7f40c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9e16f7f40c"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"tor-0.4.2.7-1.fc31")) flag++;
