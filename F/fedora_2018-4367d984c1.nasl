...
# extracted from Fedora Security Advisory FEDORA-2018-4367d984c1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : sblim-sfcb (2018-4367d984c1)");
  ...
  script_set_attribute(
    ...
    value:
"Fix NULL pointer (DoS) vulnerability via POST request to /cimom
(CVE-2018-6644)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-4367d984c1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"sblim-sfcb-1.4.9-7.fc26")) flag++;
