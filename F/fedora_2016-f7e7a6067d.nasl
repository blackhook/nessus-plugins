...
# extracted from Fedora Security Advisory FEDORA-2016-f7e7a6067d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : jenkins (2016-f7e7a6067d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f7e7a6067d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"jenkins-1.609.3-7.fc22")) flag++;
