...
# extracted from Fedora Security Advisory FEDORA-2018-a32082df51.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : postgresql (2018-a32082df51)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a32082df51"
  );
  # https://www.postgresql.org/docs/9.6/static/release-9-6-8.html
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC27", reference:"postgresql-9.6.8-1.fc27")) flag++;
