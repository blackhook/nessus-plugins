...
# extracted from Fedora Security Advisory FEDORA-2019-ec644ec323.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-ec644ec323");

  script_name(english:"Fedora 29 : 1:java-1.8.0-openjdk (2019-ec644ec323)");
...
http://mail.openjdk.java.net/pipermail/jdk8u-dev/2019-April/009115.htm
l
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e92d1863"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-ec644ec323"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"java-1.8.0-openjdk-1.8.0.212.b04-0.fc29", epoch:"1")) flag++;
