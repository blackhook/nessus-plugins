...
# extracted from Fedora Security Advisory FEDORA-2019-a66789a334.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : glpi (2019-a66789a334)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a66789a334"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"glpi-9.3.3-2.fc29")) flag++;
