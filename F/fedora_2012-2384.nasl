...
# extracted from Fedora Security Advisory 2012-2384.
#
...
if (description)
{
  ...
  script_bugtraq_id(52268);
  script_xref(name:"FEDORA", value:"2012-2384");

  script_name(english:"Fedora 16 : uzbl-0-0.28.20111001git9576f59f05.fc16 (2012-2384)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-March/074380.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8f5a0b9"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"uzbl-0-0.28.20111001git9576f59f05.fc16")) flag++;
