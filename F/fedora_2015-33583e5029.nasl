...
# extracted from Fedora Security Advisory FEDORA-2015-33583e5029.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-33583e5029");

  script_name(english:"Fedora 23 : erlang (2015-33583e5029)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2015-33583e5029"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"erlang-17.4-5.fc23")) flag++;
