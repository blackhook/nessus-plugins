...
# extracted from Fedora Security Advisory 2015-14011.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-14011");

  script_name(english:"Fedora 22 : mingw-gdk-pixbuf-2.31.6-1.fc22 (2015-14011)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/165701.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a83ba8c4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"mingw-gdk-pixbuf-2.31.6-1.fc22")) flag++;
