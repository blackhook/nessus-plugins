...
# extracted from Fedora Security Advisory FEDORA-2017-274d763ed8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-274d763ed8");
  script_xref(name:"IAVA", value:"2017-A-0284-S");

  script_name(english:"Fedora 27 : dnsmasq (2017-274d763ed8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-274d763ed8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"dnsmasq-2.77-7.fc27")) flag++;
