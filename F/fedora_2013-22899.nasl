...
# extracted from Fedora Security Advisory 2013-22899.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 18 : ufraw-0.19.2-10.fc18 (2013-22899)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/124193.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?678b9bc4"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"ufraw-0.19.2-10.fc18")) flag++;
