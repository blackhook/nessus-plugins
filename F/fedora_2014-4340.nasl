...
# extracted from Fedora Security Advisory 2014-4340.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : file-5.14-20.fc20 (2014-4340)");
  ...
  script_set_attribute(
    ...
    value:
"fix #1079847 - fix for CVE-2013-7345 fix #1079847 - fix for
CVE-2013-7345
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7630f35"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"file-5.14-20.fc20")) flag++;
