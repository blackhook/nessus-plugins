...
# extracted from Fedora Security Advisory 2014-6904.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : php-phpunit-PHPUnit-MockObject-1.2.3-4.fc19 / php-5.5.13-3.fc19 / etc (2014-6904)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134464.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eab0bd98"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134465.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?20354abe"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134466.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?861ebe37"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC19", reference:"php-5.5.13-3.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"php-doctrine-orm-2.4.2-2.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"php-phpunit-PHPUnit-MockObject-1.2.3-4.fc19")) flag++;
