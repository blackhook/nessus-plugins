...
# extracted from Fedora Security Advisory 2014-8032.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : ansible-1.6.6-1.fc20 (2014-8032)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 1.6.6. Yet more security tweaks. Update to 1.6.5. Further
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?959302f8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"ansible-1.6.6-1.fc20")) flag++;
