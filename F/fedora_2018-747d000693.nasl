...
# extracted from Fedora Security Advisory FEDORA-2018-747d000693.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : suricata (2018-747d000693)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-747d000693"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"suricata-4.0.5-1.fc28")) flag++;
