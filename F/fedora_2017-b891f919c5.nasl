...
# extracted from Fedora Security Advisory FEDORA-2017-b891f919c5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b891f919c5");

  script_name(english:"Fedora 27 : 1:xrdp (2017-b891f919c5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b891f919c5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"xrdp-0.9.4-2.fc27", epoch:"1")) flag++;
