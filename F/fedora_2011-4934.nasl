...
# extracted from Fedora Security Advisory 2011-4934.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-4934");

  script_name(english:"Fedora 15 : dhcp-4.2.1-4.P1.fc15 (2011-4934)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058279.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d5a7ce82"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"dhcp-4.2.1-4.P1.fc15")) flag++;
