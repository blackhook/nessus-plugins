...
# extracted from Fedora Security Advisory 2014-5214.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5214");

  script_name(english:"Fedora 19 : znc-1.2-3.fc19 (2014-5214)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/132081.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dc4c8e44"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"znc-1.2-3.fc19")) flag++;
