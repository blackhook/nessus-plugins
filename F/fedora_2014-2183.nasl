...
# extracted from Fedora Security Advisory 2014-2183.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : apache-commons-fileupload-1.3-5.fc19 (2014-2183)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128505.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a329da6f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"apache-commons-fileupload-1.3-5.fc19")) flag++;
