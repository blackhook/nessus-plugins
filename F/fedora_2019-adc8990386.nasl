...
# extracted from Fedora Security Advisory FEDORA-2019-adc8990386.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : python-django (2019-adc8990386)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-adc8990386"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"python-django-2.2.8-1.fc31")) flag++;
