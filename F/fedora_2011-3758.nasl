...
# extracted from Fedora Security Advisory 2011-3758.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3758");

  script_name(english:"Fedora 15 : logrotate-3.7.9-8.fc15 (2011-3758)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/056992.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?58c9f91b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"logrotate-3.7.9-8.fc15")) flag++;
