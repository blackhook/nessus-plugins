...
# extracted from Fedora Security Advisory 2013-13216.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : python-pip-1.3.1-4.fc19 (2013-13216)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/112563.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b305b352"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python-pip-1.3.1-4.fc19")) flag++;
