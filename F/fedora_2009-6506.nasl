...
# extracted from Fedora Security Advisory 2009-6506.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6506");

  script_name(english:"Fedora 11 : libpng-1.2.37-1.fc11 (2009-6506)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025124.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?069b825e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"libpng-1.2.37-1.fc11")) flag++;
