...
# extracted from Fedora Security Advisory 2009-2970.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2970");

  script_name(english:"Fedora 10 : lcms-1.18-0.1.beta2.fc10 (2009-2970)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021644.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3be7a3ad"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"lcms-1.18-0.1.beta2.fc10")) flag++;
