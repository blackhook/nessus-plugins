...
# extracted from Fedora Security Advisory 2012-20621.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-20621");

  script_name(english:"Fedora 16 : inkscape-0.48.4-1.fc16 (2012-20621)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/095398.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9bd85d5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"inkscape-0.48.4-1.fc16")) flag++;
