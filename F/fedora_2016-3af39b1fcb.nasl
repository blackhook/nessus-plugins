...
# extracted from Fedora Security Advisory FEDORA-2016-3af39b1fcb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : php-pecl-zip (2016-3af39b1fcb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3af39b1fcb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"php-pecl-zip-1.13.4-1.fc24")) flag++;
