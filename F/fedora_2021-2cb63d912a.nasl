...
# extracted from Fedora Security Advisory FEDORA-2021-2cb63d912a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-2cb63d912a");
  script_xref(name:"IAVA", value:"2021-A-0053");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/27");

  script_name(english:"Fedora 33 : sudo (2021-2cb63d912a)");
...
FEDORA-2021-2cb63d912a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-2cb63d912a");
...
pkgs = [
    {'reference':'sudo-1.9.5p2-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
