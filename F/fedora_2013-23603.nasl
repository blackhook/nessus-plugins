...
# extracted from Fedora Security Advisory 2013-23603.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-23603");

  script_name(english:"Fedora 20 : gnupg-1.4.16-2.fc20 (2013-23603)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/124967.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6d204ed"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"gnupg-1.4.16-2.fc20")) flag++;
