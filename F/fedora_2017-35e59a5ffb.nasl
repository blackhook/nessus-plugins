...
# extracted from Fedora Security Advisory FEDORA-2017-35e59a5ffb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-35e59a5ffb");

  script_name(english:"Fedora 26 : libarchive (2017-35e59a5ffb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-35e59a5ffb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libarchive-3.2.2-4.fc26")) flag++;
