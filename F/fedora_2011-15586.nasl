...
# extracted from Fedora Security Advisory 2011-15586.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : nss-3.12.10-7.fc14 (2011-15586)");
  ...
  script_set_attribute(
    ...
    value:
"This security update revokes trust in DigiCert Sdn. Bhd Intermediate
Certificate Authority from NSS - rhbz#751674
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=751674"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-November/070056.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5b6731bf"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"nss-3.12.10-7.fc14")) flag++;
