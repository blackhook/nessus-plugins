...
# extracted from F5 Networks BIG-IP Solution SOL16871.
#
...
if (description)
{
  ...
  script_bugtraq_id(47107);

  script_name(english:"F5 Networks BIG-IP : logrotate vulnerability (SOL16871)");
...
machine name."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16871"
  );
  script_set_attribute(
    attribute:"solution",
    value:
