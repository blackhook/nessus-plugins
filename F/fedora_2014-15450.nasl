...
# extracted from Fedora Security Advisory 2014-15450.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15450");

  script_name(english:"Fedora 21 : python-eyed3-0.7.4-4.fc21 (2014-15450)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145388.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b821dfed"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"python-eyed3-0.7.4-4.fc21")) flag++;
