...
# extracted from Fedora Security Advisory 2015-3471.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3471");

  script_name(english:"Fedora 21 : freexl-1.0.0i-1.fc21 (2015-3471)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152218.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ecaad1ad"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"freexl-1.0.0i-1.fc21")) flag++;
