...
# extracted from Fedora Security Advisory 2011-7388.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7388");

  script_name(english:"Fedora 13 : php-ZendFramework-1.11.6-1.fc13 (2011-7388)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061111.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb9f8335"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"php-ZendFramework-1.11.6-1.fc13")) flag++;
