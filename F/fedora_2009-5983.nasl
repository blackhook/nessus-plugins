...
# extracted from Fedora Security Advisory 2009-5983.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-5983");

  script_name(english:"Fedora 11 : pam_krb5-2.3.5-1.fc11 (2009-5983)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025669.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb53ff3a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"pam_krb5-2.3.5-1.fc11")) flag++;
