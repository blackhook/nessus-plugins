...
# extracted from Fedora Security Advisory FEDORA-2017-994ff5ced8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-994ff5ced8");

  script_name(english:"Fedora 26 : wordpress (2017-994ff5ced8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-994ff5ced8"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"wordpress-4.9.1-1.fc26")) flag++;
