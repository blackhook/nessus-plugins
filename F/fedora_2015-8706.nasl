...
# extracted from Fedora Security Advisory 2015-8706.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8706");

  script_name(english:"Fedora 20 : ufraw-0.21-1.fc20 (2015-8706)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159518.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?57922564"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"ufraw-0.21-1.fc20")) flag++;
