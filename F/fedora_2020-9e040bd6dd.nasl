...
# extracted from Fedora Security Advisory FEDORA-2020-9e040bd6dd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : salt (2020-9e040bd6dd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9e040bd6dd"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"salt-3001.3-1.fc31")) flag++;
