...
# extracted from Fedora Security Advisory 2014-17497.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-17497");

  script_name(english:"Fedora 21 : glpi-0.84.8-3.fc21 (2014-17497)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f2891b2"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"glpi-0.84.8-3.fc21")) flag++;
