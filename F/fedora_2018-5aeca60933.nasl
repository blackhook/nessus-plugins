...
# extracted from Fedora Security Advisory FEDORA-2018-5aeca60933.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-5aeca60933");

  script_name(english:"Fedora 28 : phpMyAdmin (2018-5aeca60933)");
...
version 4.8.4**. Among other bug fixes, this contains several
...
The security fixes involve :
  ...
  - XSRF/CSRF vulnerabilities allowing a specially crafted
    URL to perform harmful operations
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5aeca60933"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC28", reference:"phpMyAdmin-4.8.4-1.fc28")) flag++;
