...
# extracted from Fedora Security Advisory 2014-10359.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-10359");

  script_name(english:"Fedora 19 : procmail-3.22-36.fc19 (2014-10359)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/138649.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ece99b2e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"procmail-3.22-36.fc19")) flag++;
