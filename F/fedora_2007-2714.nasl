...
# extracted from Fedora Security Advisory 2007-2714.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : pidgin-2.2.2-1.fc7 (2007-2714)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004415.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b4122ce"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"finch-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"finch-devel-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"libpurple-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"libpurple-devel-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"libpurple-perl-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"libpurple-tcl-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"pidgin-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"pidgin-debuginfo-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"pidgin-devel-2.2.2-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"pidgin-perl-2.2.2-1.fc7")) flag++;
