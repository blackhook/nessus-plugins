...
# extracted from Fedora Security Advisory 2013-16971.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16971");

  script_name(english:"Fedora 20 : icedtea-web-1.4.1-0.fc20 (2013-16971)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/116466.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dd54ac18"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"icedtea-web-1.4.1-0.fc20")) flag++;
