...
# extracted from Fedora Security Advisory 2013-21826.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-21826");

  script_name(english:"Fedora 19 : nginx-1.4.4-1.fc19 (2013-21826)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123014.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c0bb3a8"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"nginx-1.4.4-1.fc19")) flag++;
