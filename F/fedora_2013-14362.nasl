...
# extracted from Fedora Security Advisory 2013-14362.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-14362");

  script_name(english:"Fedora 18 : spice-0.12.4-1.fc18 (2013-14362)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=984769"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/114055.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc369dd1"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"spice-0.12.4-1.fc18")) flag++;
