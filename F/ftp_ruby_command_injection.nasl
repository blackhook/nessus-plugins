...
LIST command."
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.vapid.dhs.org/advisory.php?v=34");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2013/Mar/10");
...
if (vuln)
{
  ...
  {
    command_result = data_protection::sanitize_uid(output:command_result);
