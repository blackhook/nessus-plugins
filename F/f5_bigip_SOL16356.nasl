...
# extracted from F5 Networks BIG-IP Solution K16356.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (K16356)");
...
for use. (CVE-2015-1349)

Impact

This vulnerability can only be exploited if you explicitly enable
DNSSEC validation and managed-keys features in the BIND configuration.
The default BIND configuration on a BIG-IP system does not have these
features enabled and is not vulnerable. When exploited, the remote
attacker may be able to cause the named process to exit or crash,
resulting in a denial of service (DoS).

Note : The BIG-IP DNSSEC feature does not use BIND code and is not
vulnerable."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16356"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["APM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.3","11.4.1HF9","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.2");
vmatrix["ASM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.3","11.4.1HF9","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.2");
vmatrix["AVR"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.3","11.4.1HF9");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.2");
vmatrix["GTM"]["unaffected"] = make_list("11.6.0HF5","11.5.3","11.4.1HF9","10.1.0-10.2.4");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.2");
vmatrix["LC"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.3","11.4.1HF9","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("11.6.0","11.0.0-11.5.2");
vmatrix["LTM"]["unaffected"] = make_list("12.0.0","11.6.0HF5","11.5.3","11.4.1HF9","10.1.0-10.2.4");
