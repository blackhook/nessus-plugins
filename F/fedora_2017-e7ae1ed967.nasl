...
# extracted from Fedora Security Advisory FEDORA-2017-e7ae1ed967.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : 1:gdm (2017-e7ae1ed967)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 3.24.3 to address CVE-2017-12164 (lock screen bypass when
using autologin)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e7ae1ed967"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"gdm-3.24.3-1.fc26", epoch:"1")) flag++;
