...
# extracted from Fedora Security Advisory FEDORA-2016-c1faf6005c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : kernel (2016-c1faf6005c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c1faf6005c"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2016-4951");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2016-c1faf6005c");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC23", reference:"kernel-4.5.6-200.fc23")) flag++;
