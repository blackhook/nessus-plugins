...
# extracted from Fedora Security Advisory FEDORA-2016-364f61377b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-364f61377b");

  script_name(english:"Fedora 25 : 2:samba (2016-364f61377b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-364f61377b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"samba-4.5.3-0.fc25", epoch:"2")) flag++;
