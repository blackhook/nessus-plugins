...
# extracted from Fedora Security Advisory FEDORA-2016-b9ab1def88.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b9ab1def88");

  script_name(english:"Fedora 24 : openvas-gsa / openvas-libraries / openvas-manager / openvas-scanner (2016-b9ab1def88)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-b9ab1def88"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"openvas-gsa-6.0.11-3.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"openvas-libraries-8.0.8-2.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"openvas-manager-6.0.9-1.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"openvas-scanner-5.0.6-1.fc24")) flag++;
