...
# extracted from Fedora Security Advisory FEDORA-2018-0a3b07a003.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : 1:libreoffice (2018-0a3b07a003)");
  ...
  script_set_attribute(
    ...
    value:
"  - CVE-2018-1055 Remote arbitrary file disclosure
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-0a3b07a003"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libreoffice-5.3.7.2-8.fc26", epoch:"1")) flag++;
