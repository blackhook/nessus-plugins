...
# extracted from Fedora Security Advisory 2015-14199.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-14199");

  script_name(english:"Fedora 22 : sblim-sfcb-1.4.9-2.fc22 (2015-14199)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/172659.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7e8d02d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"sblim-sfcb-1.4.9-2.fc22")) flag++;
