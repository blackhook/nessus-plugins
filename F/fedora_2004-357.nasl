...
# extracted from Fedora Security Advisory 2004-357.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-357");

  script_name(english:"Fedora Core 2 : kdegraphics-3.2.2-1.1 (2004-357)");
...
a number of buffer overflow bugs that affect libtiff have been found.
The kfax application contains a copy of the libtiff code used for
parsing TIFF files and is therefore affected by these bugs. An
attacker who has the ability to trick a user into opening a malicious
TIFF file could cause kfax to crash or possibly execute arbitrary
code. The Common Vulnerabilities and Exposures project (cve.mitre.org)
has assigned the name CVE-2004-0803 to this issue.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-October/000345.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1170fef"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"kdegraphics-3.2.2-1.1")) flag++;
if (rpm_check(release:"FC2", reference:"kdegraphics-debuginfo-3.2.2-1.1")) flag++;
if (rpm_check(release:"FC2", reference:"kdegraphics-devel-3.2.2-1.1")) flag++;
