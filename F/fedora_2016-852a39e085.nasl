...
# extracted from Fedora Security Advisory 2016-852a39e085.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-852a39e085");

  script_name(english:"Fedora 24 : cacti-0.8.8g-1.fc24 (2016-852a39e085)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?32719ab7"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"cacti-0.8.8g-1.fc24")) flag++;
