...
# extracted from Fedora Security Advisory FEDORA-2018-d9706e9f1f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : firefox (2018-d9706e9f1f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d9706e9f1f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"firefox-58.0.1-1.fc26")) flag++;
