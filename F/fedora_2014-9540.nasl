...
# extracted from Fedora Security Advisory 2014-9540.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9540");

  script_name(english:"Fedora 20 : python-pillow-2.2.1-5.fc20 (2014-9540)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-August/137035.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78aae90f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-pillow-2.2.1-5.fc20")) flag++;
