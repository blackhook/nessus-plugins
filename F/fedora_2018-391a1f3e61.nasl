...
# extracted from Fedora Security Advisory FEDORA-2018-391a1f3e61.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : krb5 (2018-391a1f3e61)");
  ...
  script_set_attribute(
    ...
    value:
"Fix CVE-2018-5729, CVE-2018-5730.

These are low-impact, requiring administrator access to exploit.

----

Fix leak in previous version.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-391a1f3e61"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"krb5-1.15.2-7.fc27")) flag++;
