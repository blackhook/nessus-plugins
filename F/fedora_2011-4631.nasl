...
# extracted from Fedora Security Advisory 2011-4631.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-4631");

  script_name(english:"Fedora 15 : perl-5.12.3-156.fc15 (2011-4631)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?df8d1113"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"perl-5.12.3-156.fc15")) flag++;
