...
# extracted from F5 Networks BIG-IP Solution K99254031.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6458");

  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K99254031)");
  ...
  script_set_attribute(
    ...
    value:
"Multiple buffer overflows in the ctl_put* functions in NTP before
4.2.8p10 and 4.3.x before 4.3.94 allow remote authenticated users to
have unspecified impact via a long variable. (CVE-2017-6458)

Impact

This vulnerability allows remote authenticated users to have an
unspecified impact using a long variable."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K99254031"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
