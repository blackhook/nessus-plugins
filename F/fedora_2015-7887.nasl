...
# extracted from Fedora Security Advisory 2015-7887.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7887");

  script_name(english:"Fedora 20 : php-ZendFramework2-2.3.8-1.fc20 (2015-7887)");
  ...
  script_set_attribute(
    ...
    value:
"  - **ZF2015-04**: Zend\Mail and Zend\Http were both
    ...
    you use either Zend\Mail or Zend\Http (which includes
    users of Zend\Mvc), we recommend upgrading immediately.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158248.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?34e4406e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"php-ZendFramework2-2.3.8-1.fc20")) flag++;
