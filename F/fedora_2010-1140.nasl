...
# extracted from Fedora Security Advisory 2010-1140.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : fuse-2.8.1-2.fc11 (2010-1140)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-February/034518.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8f6eedc"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"fuse-2.8.1-2.fc11")) flag++;
