...
# extracted from Fedora Security Advisory 2013-16162.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16162");

  script_name(english:"Fedora 20 : roundcubemail-0.9.4-1.fc20 (2013-16162)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/roundcube/roundcubemail/issues/4283"
  );
  # http://trac.roundcube.net/wiki/Changelog#RELEASE0.9.3
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/roundcube/roundcubemail/wiki/Changelog#RELEASE0.9.3"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/116493.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2eb000d1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"roundcubemail-0.9.4-1.fc20")) flag++;
