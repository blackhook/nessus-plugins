...
# extracted from Fedora Security Advisory 2016-558167a417.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-558167a417");

  script_name(english:"Fedora 23 : php-5.6.17-1.fc23 (2016-558167a417)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-January/175601.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2cfb0607"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-5.6.17-1.fc23")) flag++;
