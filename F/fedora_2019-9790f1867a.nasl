...
# extracted from Fedora Security Advisory FEDORA-2019-9790f1867a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : radvd (2019-9790f1867a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-9790f1867a"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"radvd-2.17-17.fc29")) flag++;
