...
# extracted from Fedora Security Advisory FEDORA-2016-b39fedec11.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b39fedec11");

  script_name(english:"Fedora 24 : httpd (2016-b39fedec11)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-b39fedec11"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"httpd-2.4.23-5.fc24")) flag++;
