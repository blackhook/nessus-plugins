...
# extracted from Fedora Security Advisory 2011-5812.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5812");

  script_name(english:"Fedora 14 : mediawiki-1.16.4-58.fc14 (2011-5812)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f8d4d3eb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"mediawiki-1.16.4-58.fc14")) flag++;
