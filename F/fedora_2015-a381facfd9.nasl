...
# extracted from Fedora Security Advisory 2015-a381facfd9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-a381facfd9");

  script_name(english:"Fedora 21 : php-horde-horde-5.2.8-1.fc21 / php-horde-imp-6.2.11-1.fc21 / php-horde-ingo-3.2.7-1.fc21 / etc (2015-a381facfd9)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/170931.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?766c4c59"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/170932.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e66d852b"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/170933.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fcd5d6a1"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/170934.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3174f3bf"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"php-horde-horde-5.2.8-1.fc21")) flag++;
if (rpm_check(release:"FC21", reference:"php-horde-imp-6.2.11-1.fc21")) flag++;
if (rpm_check(release:"FC21", reference:"php-horde-ingo-3.2.7-1.fc21")) flag++;
if (rpm_check(release:"FC21", reference:"php-horde-passwd-5.0.4-1.fc21")) flag++;
