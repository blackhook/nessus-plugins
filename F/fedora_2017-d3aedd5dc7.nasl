...
# extracted from Fedora Security Advisory FEDORA-2017-d3aedd5dc7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d3aedd5dc7");

  script_name(english:"Fedora 26 : mediawiki (2017-d3aedd5dc7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d3aedd5dc7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mediawiki-1.28.2-1.fc26")) flag++;
