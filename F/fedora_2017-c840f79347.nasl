...
# extracted from Fedora Security Advisory FEDORA-2017-c840f79347.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c840f79347");

  script_name(english:"Fedora 25 : moodle (2017-c840f79347)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c840f79347"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"moodle-3.1.8-1.fc25")) flag++;
