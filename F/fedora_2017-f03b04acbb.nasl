...
# extracted from Fedora Security Advisory FEDORA-2017-f03b04acbb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f03b04acbb");

  script_name(english:"Fedora 26 : mercurial (2017-f03b04acbb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f03b04acbb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mercurial-4.2.3-1.fc26")) flag++;
