...
# extracted from Fedora Security Advisory 2011-17492.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-17492");

  script_name(english:"Fedora 15 : krb5-appl-1.0.1-8.fc15 (2011-17492)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-January/071627.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e3c12db6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"krb5-appl-1.0.1-8.fc15")) flag++;
