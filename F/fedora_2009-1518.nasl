...
# extracted from Fedora Security Advisory 2009-1518.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-1518");

  script_name(english:"Fedora 10 : python-fedora-0.3.9-1.fc10 (2009-1518)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/020008.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?99ac53a6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"python-fedora-0.3.9-1.fc10")) flag++;
