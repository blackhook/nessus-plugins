...
# extracted from Fedora Security Advisory 2013-14656.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : putty-0.63-1.fc19 (2013-14656)");
  ...
  script_set_attribute(
    ...
    value:
"This is an update that fixes many bugs, for details see upstream
announcement:
http://www.chiark.greenend.org.uk/~sgtatham/putty/changes.html This is
an update that fixes four CVEs: CVE-2013-4206 CVE-2013-4207
CVE-2013-4208 CVE-2013-4852
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=993031"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/114463.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3d6502c8"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"putty-0.63-1.fc19")) flag++;
