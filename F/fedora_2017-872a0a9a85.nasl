...
# extracted from Fedora Security Advisory FEDORA-2017-872a0a9a85.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : libsoup (2017-872a0a9a85)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-872a0a9a85"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libsoup-2.56.1-1.fc25")) flag++;
