...
# extracted from Fedora Security Advisory 2006-029.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-029");

  script_name(english:"Fedora Core 3 : tetex-2.0.2-21.7.FC3 (2006-029)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-January/001741.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a26fe5fa"
  );
