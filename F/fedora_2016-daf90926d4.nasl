...
# extracted from Fedora Security Advisory FEDORA-2016-daf90926d4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-daf90926d4");

  script_name(english:"Fedora 25 : 1:dovecot (2016-daf90926d4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-daf90926d4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"dovecot-2.2.27-1.fc25", epoch:"1")) flag++;
