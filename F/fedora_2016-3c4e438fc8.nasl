...
# extracted from Fedora Security Advisory 2016-3c4e438fc8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-3c4e438fc8");

  script_name(english:"Fedora 22 : mingw-poppler-0.30.0-4.fc22 (2016-3c4e438fc8)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dfd7dbb7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"mingw-poppler-0.30.0-4.fc22")) flag++;
