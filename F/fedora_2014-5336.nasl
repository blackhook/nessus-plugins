...
# extracted from Fedora Security Advisory 2014-5336.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5336");

  script_name(english:"Fedora 20 : java-1.8.0-openjdk-1.8.0.5-1.b13.fc20 (2014-5336)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/132124.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb40f3ae"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"java-1.8.0-openjdk-1.8.0.5-1.b13.fc20")) flag++;
