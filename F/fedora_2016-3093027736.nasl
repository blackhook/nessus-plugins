...
# extracted from Fedora Security Advisory FEDORA-2016-3093027736.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : mediawiki (2016-3093027736)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3093027736"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mediawiki-1.26.3-1.fc23")) flag++;
