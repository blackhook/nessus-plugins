...
# extracted from Fedora Security Advisory FEDORA-2016-0767ed2760.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0767ed2760");

  script_name(english:"Fedora 25 : libgit2 (2016-0767ed2760)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0767ed2760"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libgit2-0.24.3-1.fc25")) flag++;
