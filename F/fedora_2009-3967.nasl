...
# extracted from Fedora Security Advisory 2009-3967.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-3967");

  script_name(english:"Fedora 10 : lcms-1.18-2.fc10 (2009-3967)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-May/023186.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ebe84721"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"lcms-1.18-2.fc10")) flag++;
