...
# extracted from Fedora Security Advisory 2012-11988.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-11988");

  script_name(english:"Fedora 18 : pcp-3.6.5-1.fc18 (2012-11988)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/087415.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5add7b17"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"pcp-3.6.5-1.fc18")) flag++;
