...
# extracted from Fedora Security Advisory 2013-19976.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-19976");

  script_name(english:"Fedora 18 : mod_nss-1.0.8-24.fc18 (2013-19976)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/120135.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?94fe43a6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"mod_nss-1.0.8-24.fc18")) flag++;
