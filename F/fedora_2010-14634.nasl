...
# extracted from Fedora Security Advisory 2010-14634.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : cabextract-1.3-1.fc12 / libmspack-0.2-0.1.20100723alpha.fc12 (2010-14634)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-September/048484.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d24d3b67"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-September/048485.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad2b6c9b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"cabextract-1.3-1.fc12")) flag++;
if (rpm_check(release:"FC12", reference:"libmspack-0.2-0.1.20100723alpha.fc12")) flag++;
