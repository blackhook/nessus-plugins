...
# extracted from Fedora Security Advisory 2015-9456.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-9456");

  script_name(english:"Fedora 22 : xen-4.5.0-10.fc22 (2015-9456)");
...
qemu-xen patches, work around a gcc 5 bug, Potential unintended writes
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d70bfc4"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"xen-4.5.0-10.fc22")) flag++;
