...
# extracted from Fedora Security Advisory 2009-12562.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-12562");

  script_name(english:"Fedora 12 : libtool-2.2.6-17.fc12 (2009-12562)");
  ...
  script_set_attribute(
    ...
    value:
"libltdl may load and execute code from a library in the current
directory.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-December/033315.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e9439ffa"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"libtool-2.2.6-17.fc12")) flag++;
