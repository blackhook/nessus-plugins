...
FEDORA-2023-1bd07375a7 advisory.
  ...
  - compression commands depend on $PATH [fedora-all] (CVE-2022-4883)

  - Runaway loop on width of 0 and enormous height [fedora-all] (CVE-2022-44617)

  - Infinite loop on unclosed comments [fedora-all] (CVE-2022-46285)
