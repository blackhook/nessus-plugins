...
# extracted from Fedora Security Advisory FEDORA-2016-a1563af431.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a1563af431");

  script_name(english:"Fedora 25 : golang (2016-a1563af431)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a1563af431"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"golang-1.7.4-1.fc25")) flag++;
