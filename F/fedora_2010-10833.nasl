...
# extracted from Fedora Security Advisory 2010-10833.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : libpng10-1.0.54-1.fc12 (2010-10833)");
  ...
  script_set_attribute(
    ...
    value:
"This update addresses two security issues: * CVE-2010-1205, in which a
buffer overflow might allow remote attackers to execute arbitrary code
via a PNG image that triggers an additional data row. * CVE-2010-2249,
in which a memory leak allows remote attackers to cause a denial of
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-July/044397.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f3d97b28"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"libpng10-1.0.54-1.fc12")) flag++;
