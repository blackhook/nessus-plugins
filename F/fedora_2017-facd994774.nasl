...
# extracted from Fedora Security Advisory FEDORA-2017-facd994774.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-facd994774");

  script_name(english:"Fedora 24 : sudo (2017-facd994774)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-facd994774"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"sudo-1.8.20p2-1.fc24")) flag++;
