...
# extracted from Fedora Security Advisory 2012-13412.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13412");

  script_name(english:"Fedora 17 : wordpress-3.4.2-2.fc17 (2012-13412)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086296.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2910b3e4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"wordpress-3.4.2-2.fc17")) flag++;
