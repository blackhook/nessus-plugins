...
# extracted from Fedora Security Advisory 2013-21418.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-21418");

  script_name(english:"Fedora 19 : python3-3.3.2-8.fc19 (2013-21418)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6d2b2819"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python3-3.3.2-8.fc19")) flag++;
