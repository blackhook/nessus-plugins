...
# extracted from Fedora Security Advisory FEDORA-2018-87971e3c98.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : gcab (2018-87971e3c98)");
...
"New upstream release
  ...
  - Fix the calculation of the checksum on big endian
    machines
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-87971e3c98"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"gcab-1.0-1.fc27")) flag++;
