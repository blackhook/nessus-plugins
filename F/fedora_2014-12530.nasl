...
# extracted from Fedora Security Advisory 2014-12530.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12530");

  script_name(english:"Fedora 20 : bugzilla-4.2.11-1.fc20 (2014-12530)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1150091"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141321.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?982a774f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"bugzilla-4.2.11-1.fc20")) flag++;
