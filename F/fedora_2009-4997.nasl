...
# extracted from Fedora Security Advisory 2009-4997.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-4997");

  script_name(english:"Fedora 9 : drupal-6.12-1.fc9 (2009-4997)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-May/023571.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5cc6fb88"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"drupal-6.12-1.fc9")) flag++;
