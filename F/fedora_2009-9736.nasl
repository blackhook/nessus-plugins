...
# extracted from Fedora Security Advisory 2009-9736.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-9736");

  script_name(english:"Fedora 11 : drupal-date-6.x.2.4-0.fc11 (2009-9736)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-September/029317.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7c43ee68"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"drupal-date-6.x.2.4-0.fc11")) flag++;
