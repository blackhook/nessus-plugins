...
# extracted from Fedora Security Advisory FEDORA-2020-b8091188d0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:qt (2020-b8091188d0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b8091188d0"
  );
...
flag = 0;
if (rpm_check(release:"FC32", reference:"qt-4.8.7-55.fc32", epoch:"1")) flag++;
