...
# extracted from Fedora Security Advisory 2016-80c07fbb6c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-80c07fbb6c");

  script_name(english:"Fedora 23 : w3m-0.5.3-24.fc23 (2016-80c07fbb6c)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c468ceae"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"w3m-0.5.3-24.fc23")) flag++;
