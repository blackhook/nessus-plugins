...
# extracted from F5 Networks BIG-IP Solution K04225025.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-5202", "CVE-2017-5203", "CVE-2017-5204", "CVE-2017-5205", "CVE-2017-5342");

  script_name(english:"F5 Networks BIG-IP : tcpdump vulnerabilities (K04225025)");
...
CVE-2017-5342 In tcpdump before 4.9.0, a bug in multiple protocol
parsers (Geneve, GRE, NSH, OTV, VXLAN and VXLAN GPE) could cause a
buffer overflow in print-ether.c:ether_print()."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K04225025"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
