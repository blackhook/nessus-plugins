...
# extracted from Fedora Security Advisory FEDORA-2017-1179268a20.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1179268a20");

  script_name(english:"Fedora 26 : tor (2017-1179268a20)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1179268a20"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"tor-0.3.1.7-1.fc26")) flag++;
