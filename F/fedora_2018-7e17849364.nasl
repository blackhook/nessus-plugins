...
# extracted from Fedora Security Advisory FEDORA-2018-7e17849364.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 2:microcode_ctl (2018-7e17849364)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7e17849364"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"microcode_ctl-2.1-20.fc27", epoch:"2")) flag++;
