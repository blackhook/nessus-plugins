...
# extracted from F5 Networks BIG-IP Solution K57500018.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : ISC DHCP 4.x vulnerability (K57500018)");
...
(CVE-2015-8605)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K57500018"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
