...
# extracted from Fedora Security Advisory 2009-4175.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-4175");

  script_name(english:"Fedora 10 : drupal-6.11-1.fc10 (2009-4175)");
  ...
  script_set_attribute(
    ...
    value:
"6.11, Fix for SA-CORE-2009-005. See http://drupal.org/node/449078 for
more information. Remember to log in to your site as the admin user
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=498643"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-May/023009.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d54bd0b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"drupal-6.11-1.fc10")) flag++;
