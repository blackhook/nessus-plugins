...
# extracted from Fedora Security Advisory FEDORA-2018-499a02cc9d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-499a02cc9d");

  script_name(english:"Fedora 27 : transmission (2018-499a02cc9d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-499a02cc9d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"transmission-2.92-12.fc27")) flag++;
