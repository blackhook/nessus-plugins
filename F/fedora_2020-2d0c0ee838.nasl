...
# extracted from Fedora Security Advisory FEDORA-2020-2d0c0ee838.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : chromium (2020-2d0c0ee838)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2d0c0ee838"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"chromium-86.0.4240.198-1.fc33", allowmaj:TRUE)) flag++;
