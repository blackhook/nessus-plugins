...
# extracted from F5 Networks BIG-IP Solution K69662152.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Grep vulnerability (K69662152)");
...
overflow. (CVE-2012-5667)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K69662152"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
