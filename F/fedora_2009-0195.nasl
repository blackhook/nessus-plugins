...
# extracted from Fedora Security Advisory 2009-0195.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-0195");

  script_name(english:"Fedora 8 : proftpd-1.3.1-8.fc8 (2009-0195)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-January/018686.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f56576a9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"proftpd-1.3.1-8.fc8")) flag++;
