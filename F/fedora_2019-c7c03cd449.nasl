...
# extracted from Fedora Security Advisory FEDORA-2019-c7c03cd449.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-c7c03cd449");

  script_name(english:"Fedora 30 : php-twig2 (2019-c7c03cd449)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c7c03cd449"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"php-twig2-2.7.2-1.fc30")) flag++;
