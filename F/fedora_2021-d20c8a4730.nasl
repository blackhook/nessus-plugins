...
# extracted from Fedora Security Advisory FEDORA-2021-d20c8a4730
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-d20c8a4730");

  script_name(english:"Fedora 33 : 1:busybox (2021-d20c8a4730)");
...
FEDORA-2021-d20c8a4730 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-d20c8a4730");
  script_set_attribute(attribute:"solution", value:
"Update the affected 1:busybox package.");
...
pkgs = [
    {'reference':'busybox-1.32.1-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, '1:busybox');
}
