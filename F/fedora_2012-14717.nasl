...
# extracted from Fedora Security Advisory 2012-14717.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14717");

  script_name(english:"Fedora 17 : openjpeg-1.4-14.fc17 (2012-14717)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091019.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb409eeb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"openjpeg-1.4-14.fc17")) flag++;
