...
# extracted from Fedora Security Advisory FEDORA-2019-1d78e14cfd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1d78e14cfd");

  script_name(english:"Fedora 30 : php (2019-1d78e14cfd)");
...
**Core:**
  ...
  - Fixed bug php#77345 (Stack Overflow caused by circular
    reference in garbage collection). (Alexandru Patranescu,
    Nikita, Dmitry)

  - Fixed bug php#76956 (Wrong value for 'syslog.filter'
    documented in php.ini). (cmb)

**Apache2Handler:**

  - Fixed bug php#77648 (BOM in
    sapi/apache2handler/php_functions.c). (cmb)
...
**CLI Server:**
  ...
  - Fixed bug php#77722 (Incorrect IP set to
    $_SERVER['REMOTE_ADDR'] on the localhost). (Nikita)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1d78e14cfd"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"php-7.3.4-1.fc30")) flag++;
