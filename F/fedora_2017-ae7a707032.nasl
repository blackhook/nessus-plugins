...
# extracted from Fedora Security Advisory FEDORA-2017-ae7a707032.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : moodle (2017-ae7a707032)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ae7a707032"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"moodle-3.1.4-1.fc25")) flag++;
