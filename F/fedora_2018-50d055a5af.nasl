...
# extracted from Fedora Security Advisory FEDORA-2018-50d055a5af.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : knot-resolver (2018-50d055a5af)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-50d055a5af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"knot-resolver-2.4.0-1.fc27")) flag++;
