...
# extracted from Fedora Security Advisory FEDORA-2019-3d7105bd2a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-3d7105bd2a");

  script_name(english:"Fedora 30 : xen (2019-3d7105bd2a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3d7105bd2a"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"xen-4.11.2-4.fc30")) flag++;
