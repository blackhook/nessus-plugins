...
# extracted from F5 Networks BIG-IP Solution SOL51841514.
#
...
if (description)
{
  script_id(87433);
  script_version("2.8");
  script_cvs_date("Date: 2019/08/27  9:41:32");

  script_cve_id("CVE-2015-6855");

  script_name(english:"F5 Networks BIG-IP : QEMU vulnerability (SOL51841514)");
...
drive, which triggers a divide-by-zero error and instance crash."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K51841514"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade to one of the non-vulnerable versions listed in the F5
Solution SOL51841514."
  );
