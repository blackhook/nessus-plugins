...
# extracted from Fedora Security Advisory FEDORA-2020-7d8f772540.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : drupal7 (2020-7d8f772540)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7d8f772540"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"drupal7-7.74-1.fc33")) flag++;
