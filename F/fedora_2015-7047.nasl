...
# extracted from Fedora Security Advisory 2015-7047.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7047");

  script_name(english:"Fedora 21 : pdns-3.4.4-1.fc21 (2015-7047)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?33971b57"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"pdns-3.4.4-1.fc21")) flag++;
