...
# extracted from Fedora Security Advisory 2012-9079.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-9079");

  script_name(english:"Fedora 15 : thunderbird-13.0-1.fc15 / thunderbird-lightning-1.5-2.fc15 (2012-9079)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082826.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aa5803c9"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082827.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?69b0ad19"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC15", reference:"thunderbird-13.0-1.fc15")) flag++;
if (rpm_check(release:"FC15", reference:"thunderbird-lightning-1.5-2.fc15")) flag++;
