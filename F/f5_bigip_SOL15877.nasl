...
# extracted from F5 Networks BIG-IP Solution SOL15877.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Apache vulnerability (SOL15877)");
...
sequence for a terminal emulator."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15877"
  );
  script_set_attribute(
    attribute:"solution",
    value:
