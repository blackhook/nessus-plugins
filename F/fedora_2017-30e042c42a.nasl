...
# extracted from Fedora Security Advisory FEDORA-2017-30e042c42a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-30e042c42a");

  script_name(english:"Fedora 26 : mingw-gnutls (2017-30e042c42a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-30e042c42a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-gnutls-3.5.11-1.fc26")) flag++;
