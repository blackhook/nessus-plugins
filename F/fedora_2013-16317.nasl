...
# extracted from Fedora Security Advisory 2013-16317.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16317");

  script_name(english:"Fedora 19 : polarssl-1.2.8-1.fc19 (2013-16317)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f80b3447"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"polarssl-1.2.8-1.fc19")) flag++;
