...
# extracted from Fedora Security Advisory FEDORA-2017-2643ef1cad.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-2643ef1cad");

  script_name(english:"Fedora 25 : mediawiki (2017-2643ef1cad)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2643ef1cad"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mediawiki-1.27.3-1.fc25")) flag++;
