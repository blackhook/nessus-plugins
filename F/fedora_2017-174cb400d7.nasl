...
# extracted from Fedora Security Advisory FEDORA-2017-174cb400d7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : flatpak (2017-174cb400d7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-174cb400d7"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/flatpak/flatpak/releases/tag/0.8.5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"flatpak-0.8.5-1.fc24")) flag++;
