...
# extracted from Fedora Security Advisory 2009-6557.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6557");

  script_name(english:"Fedora 10 : moin-1.6.4-2.fc10 (2009-6557)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025153.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?17ea16d2"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"moin-1.6.4-2.fc10")) flag++;
