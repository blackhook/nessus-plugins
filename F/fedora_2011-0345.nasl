...
# extracted from Fedora Security Advisory 2011-0345.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0345");

  script_name(english:"Fedora 13 : dpkg-1.15.5.6-6.fc13 (2011-0345)");
  ...
  script_set_attribute(
    ...
    value:
"Fix CVE-2010-1679 Fix CVE-2011-0402
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=668922"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=668930"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053311.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1637b34c"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"dpkg-1.15.5.6-6.fc13")) flag++;
