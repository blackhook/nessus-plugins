...
# extracted from Fedora Security Advisory 2008-7747.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : fedora-release-8-6.transition (2008-7747)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-September/013604.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b096fa26"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected fedora-release package."
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"fedora-release-8-6.transition")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "fedora-release");
}
