...
# extracted from Fedora Security Advisory 2008-0958.
#
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26e33d2b"
  );
  # http://www.kernel.org/pub/linux/kernel/v2.6/ChangeLog-2.6.23.14
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-January/007321.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?df419abe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"kernel-2.6.23.14-64.fc7")) flag++;
