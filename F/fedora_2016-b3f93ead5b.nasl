...
# extracted from Fedora Security Advisory FEDORA-2016-b3f93ead5b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b3f93ead5b");

  script_name(english:"Fedora 24 : moin (2016-b3f93ead5b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-b3f93ead5b"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"moin-1.9.8-1.fc24")) flag++;
