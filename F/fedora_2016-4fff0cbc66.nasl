...
# extracted from Fedora Security Advisory FEDORA-2016-4fff0cbc66.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : gstreamer1-plugins-base (2016-4fff0cbc66)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-4fff0cbc66"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected gstreamer1-plugins-base package."
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"gstreamer1-plugins-base-1.8.3-2.fc24")) flag++;
