...
# extracted from Fedora Security Advisory 2013-9096.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-9096");

  script_name(english:"Fedora 19 : libXcursor-1.1.13-5.20130524git8f677eaea.fc19 (2013-9096)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4cb5ced4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libXcursor-1.1.13-5.20130524git8f677eaea.fc19")) flag++;
