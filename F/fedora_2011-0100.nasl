...
# extracted from Fedora Security Advisory 2011-0100.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0100");

  script_name(english:"Fedora 14 : mod_auth_mysql-3.0.0-12.fc14 (2011-0100)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-February/053899.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00343358"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"mod_auth_mysql-3.0.0-12.fc14")) flag++;
