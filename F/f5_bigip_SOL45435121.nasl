...
serial number has changed."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K45435121"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["GTM"]["affected"  ] = make_list("13.1.0","12.1.3");
vmatrix["GTM"]["unaffected"] = make_list("14.0.0","13.1.0.8","12.1.3.6");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("13.1.0","12.1.3");
vmatrix["LC"]["unaffected"] = make_list("14.0.0","13.1.0.8","12.1.3.6");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("13.1.0","12.1.3");
vmatrix["LTM"]["unaffected"] = make_list("14.0.0","13.1.0.8","12.1.3.6");
...
else
{
  ...
  else audit(AUDIT_HOST_NOT, "running any of the affected modules GTM / LC / LTM");
}
