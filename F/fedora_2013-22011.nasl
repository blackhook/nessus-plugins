...
# extracted from Fedora Security Advisory 2013-22011.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-22011");

  script_name(english:"Fedora 18 : monitorix-3.3.1-1.fc18 (2013-22011)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123097.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c98c6291"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"monitorix-3.3.1-1.fc18")) flag++;
