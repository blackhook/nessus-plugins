...
# extracted from Fedora Security Advisory 2013-17366.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-17366");

  script_name(english:"Fedora 18 : seamonkey-2.21-1.fc18 (2013-17366)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77551bfc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"seamonkey-2.21-1.fc18")) flag++;
