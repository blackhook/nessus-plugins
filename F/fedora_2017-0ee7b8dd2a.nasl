...
# extracted from Fedora Security Advisory FEDORA-2017-0ee7b8dd2a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0ee7b8dd2a");

  script_name(english:"Fedora 25 : mingw-poppler (2017-0ee7b8dd2a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0ee7b8dd2a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-poppler-0.45.0-2.fc25")) flag++;
