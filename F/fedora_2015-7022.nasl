...
# extracted from Fedora Security Advisory 2015-7022.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7022");

  script_name(english:"Fedora 21 : libreoffice-4.3.7.2-3.fc21 (2015-7022)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60793bbb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"libreoffice-4.3.7.2-3.fc21")) flag++;
