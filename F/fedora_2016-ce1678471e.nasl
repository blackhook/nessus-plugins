...
# extracted from Fedora Security Advisory FEDORA-2016-ce1678471e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : mediawiki (2016-ce1678471e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-ce1678471e"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mediawiki-1.26.4-1.fc23")) flag++;
