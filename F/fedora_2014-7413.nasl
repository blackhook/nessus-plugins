...
# extracted from Fedora Security Advisory 2014-7413.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : rb_libtorrent-0.16.8-2.fc19 (2014-7413)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134705.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7994b6c3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"rb_libtorrent-0.16.8-2.fc19")) flag++;
