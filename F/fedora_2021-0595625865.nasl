...
# extracted from Fedora Security Advisory FEDORA-2021-0595625865
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-0595625865");

  script_name(english:"Fedora 32 : 32:bind (2021-0595625865)");
...
FEDORA-2021-0595625865 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-0595625865");
...
pkgs = [
    {'reference':'bind-9.11.28-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'32'}
];
