...
# extracted from Fedora Security Advisory FEDORA-2020-b0b85758e9.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : p11-kit (2020-b0b85758e9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b0b85758e9"
  );
  # https://github.com/p11-glue/p11-kit/security/advisories/GHSA-q4r3-hm6m-mvc2
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"p11-kit-0.23.22-1.fc33")) flag++;
