...
# extracted from Fedora Security Advisory FEDORA-2021-76aaa904e2
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-76aaa904e2");

  script_name(english:"Fedora 33 : kernel (2021-76aaa904e2)");
...
FEDORA-2021-76aaa904e2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-76aaa904e2");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-76aaa904e2');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.15-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
