...
# extracted from Fedora Security Advisory 2014-10632.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-10632");

  script_name(english:"Fedora 20 : pdns-recursor-3.6.1-1.fc20 (2014-10632)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137798.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1704bd97"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"pdns-recursor-3.6.1-1.fc20")) flag++;
