...
# extracted from Fedora Security Advisory FEDORA-2017-d5487d0f80.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d5487d0f80");

  script_name(english:"Fedora 27 : mingw-libzip (2017-d5487d0f80)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d5487d0f80"
  );
  # https://nih.at/libzip/NEWS.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://libzip.org/news/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mingw-libzip-1.3.0-1.fc27")) flag++;
