...
# extracted from Fedora Security Advisory 2013-14608.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : php-symfony2-HttpFoundation-2.2.5-1.fc19 (2013-14608)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0f0c393e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"php-symfony2-HttpFoundation-2.2.5-1.fc19")) flag++;
