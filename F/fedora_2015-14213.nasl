...
# extracted from Fedora Security Advisory 2015-14213.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-14213");

  script_name(english:"Fedora 23 : ntp-4.2.6p5-33.fc23 (2015-14213)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/166992.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?04fd5621"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"ntp-4.2.6p5-33.fc23")) flag++;
