...
# extracted from Fedora Security Advisory FEDORA-2017-8722576148.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-8722576148");

  script_name(english:"Fedora 25 : ettercap (2017-8722576148)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-8722576148"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ettercap-0.8.2-4.2.fc25")) flag++;
