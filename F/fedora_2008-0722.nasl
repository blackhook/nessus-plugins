...
# extracted from Fedora Security Advisory 2008-0722.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : python-paramiko-1.7.1-3.fc7 (2008-0722)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=428728"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-January/006947.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b4dfee5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"python-paramiko-1.7.1-3.fc7")) flag++;
