...
# extracted from Fedora Security Advisory 2010-19070.
#
...
if (description)
{
  ...
  script_bugtraq_id(42233, 42959, 43604, 43837, 45399);
  script_xref(name:"FEDORA", value:"2010-19070");

  script_name(english:"Fedora 13 : mantis-1.1.8-5.fc13 (2010-19070)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?410afb82"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"mantis-1.1.8-5.fc13")) flag++;
