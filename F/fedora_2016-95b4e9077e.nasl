...
# extracted from Fedora Security Advisory FEDORA-2016-95b4e9077e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-95b4e9077e");

  script_name(english:"Fedora 25 : tor (2016-95b4e9077e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-95b4e9077e"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"tor-0.2.8.12-1.fc25")) flag++;
