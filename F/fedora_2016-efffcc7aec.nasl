...
# extracted from Fedora Security Advisory FEDORA-2016-efffcc7aec.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : pdns (2016-efffcc7aec)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-efffcc7aec"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://docs.powerdns.com/md/security/powerdns-advisory-2016-01/"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"pdns-3.4.10-1.fc23")) flag++;
