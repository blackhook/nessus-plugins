...
# extracted from Fedora Security Advisory 2014-6263.
#
...
if (description)
{
  ...
  script_bugtraq_id(67536);
  script_xref(name:"FEDORA", value:"2014-6263");

  script_name(english:"Fedora 20 : botan-1.10.8-1.fc20 (2014-6263)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133511.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?344b6c9b"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"botan-1.10.8-1.fc20")) flag++;
