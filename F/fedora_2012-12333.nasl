...
# extracted from Fedora Security Advisory 2012-12333.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-12333");

  script_name(english:"Fedora 18 : GraphicsMagick-1.3.16-5.fc18 (2012-12333)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/087327.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd45a3cc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"GraphicsMagick-1.3.16-5.fc18")) flag++;
