...
# extracted from Fedora Security Advisory FEDORA-2017-a05e2b8545.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : cups-filters / qpdf (2017-a05e2b8545)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a05e2b8545"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"cups-filters-1.10.0-4.fc25")) flag++;
if (rpm_check(release:"FC25", reference:"qpdf-6.0.0-6.fc25")) flag++;
