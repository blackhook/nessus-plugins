...
# extracted from Fedora Security Advisory 2004-575.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-575");

  script_name(english:"Fedora Core 3 : cups-1.1.22-0.rc1.8.2 (2004-575)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-December/000537.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8644c283"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"cups-1.1.22-0.rc1.8.2")) flag++;
if (rpm_check(release:"FC3", reference:"cups-debuginfo-1.1.22-0.rc1.8.2")) flag++;
if (rpm_check(release:"FC3", reference:"cups-devel-1.1.22-0.rc1.8.2")) flag++;
if (rpm_check(release:"FC3", reference:"cups-libs-1.1.22-0.rc1.8.2")) flag++;
