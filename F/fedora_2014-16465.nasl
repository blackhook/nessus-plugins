...
# extracted from Fedora Security Advisory 2014-16465.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-16465");

  script_name(english:"Fedora 19 : jasper-1.900.1-26.fc19 (2014-16465)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/147561.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?057cb30e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"jasper-1.900.1-26.fc19")) flag++;
