...
# extracted from Fedora Security Advisory FEDORA-2020-9493cfc1ac.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : thunderbird (2020-9493cfc1ac)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9493cfc1ac"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"thunderbird-78.5.0-1.fc32", allowmaj:TRUE)) flag++;
