...
# extracted from Fedora Security Advisory 2014-7102.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : openssl-1.0.1e-38.fc20 (2014-7102)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134016.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?930f7230"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"openssl-1.0.1e-38.fc20")) flag++;
