...
# extracted from Fedora Security Advisory 2014-1883.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1883");

  script_name(english:"Fedora 19 : zarafa-7.1.8-1.fc19 (2014-1883)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128413.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf7b1366"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"zarafa-7.1.8-1.fc19")) flag++;
