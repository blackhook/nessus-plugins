...
# extracted from Fedora Security Advisory 2010-18927.
#
...
if (description)
{
  ...
  script_bugtraq_id(45437);
  script_xref(name:"FEDORA", value:"2010-18927");

  script_name(english:"Fedora 13 : drupal-views-6.x.2.12-1.fc13 (2010-18927)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/052802.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b00e527"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"drupal-views-6.x.2.12-1.fc13")) flag++;
