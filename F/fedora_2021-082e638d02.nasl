...
# extracted from Fedora Security Advisory FEDORA-2021-082e638d02
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : kernel / kernel-headers (2021-082e638d02)");
...
FEDORA-2021-082e638d02 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-082e638d02");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-082e638d02');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.7-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-5.10.7-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
