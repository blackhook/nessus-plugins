...
# extracted from Fedora Security Advisory 2013-21927.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-21927");

  script_name(english:"Fedora 20 : monitorix-3.3.1-1.fc20 (2013-21927)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123679.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?50ddb73d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"monitorix-3.3.1-1.fc20")) flag++;
