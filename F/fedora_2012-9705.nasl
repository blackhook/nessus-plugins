...
# extracted from Fedora Security Advisory 2012-9705.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-9705");

  script_name(english:"Fedora 17 : gallery3-3.0.4-1.fc17 (2012-9705)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082954.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?36326dc3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gallery3-3.0.4-1.fc17")) flag++;
