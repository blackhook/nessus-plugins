...
"The remote host contains the FlexCell.Grid ActiveX control, a component of the FlexCell grid control software.

The version of the control installed on the remote host reportedly fails to validate input to the 'File' argument of
the 'SaveFile' and 'ExportToXML' methods before writing to the specified filename.

If an attacker can trick a user on the affected host into viewing a specially crafted HTML document, this issue could
be leveraged to create or overwrite arbitrary files on the affected system subject to the user's privileges.
...
number.");
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:P/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0301");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:grid2000:flexcell_grid_control");
