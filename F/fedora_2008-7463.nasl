...
# extracted from Fedora Security Advisory 2008-7463.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : wordpress-2.6.1-1.fc8 (2008-7463)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-September/014033.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6e6e9e46"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"wordpress-2.6.1-1.fc8")) flag++;
