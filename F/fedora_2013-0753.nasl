...
# extracted from Fedora Security Advisory 2013-0753.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-0753");

  script_name(english:"Fedora 17 : nagios-3.4.4-1.fc17 (2013-0753)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=893269"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/097239.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f4480cb0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"nagios-3.4.4-1.fc17")) flag++;
