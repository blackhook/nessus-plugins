...
# extracted from Fedora Security Advisory 2006-1467.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1467");

  script_name(english:"Fedora Core 5 : gdm-2.14.11-1.fc5 (2006-1467)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-December/001131.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fdfd1aef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC5", reference:"gdm-2.14.11-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"gdm-debuginfo-2.14.11-1.fc5")) flag++;
