...
# extracted from Fedora Security Advisory FEDORA-2016-fdedfc86d0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-fdedfc86d0");

  script_name(english:"Fedora 25 : gstreamer-plugins-bad-free (2016-fdedfc86d0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-fdedfc86d0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"gstreamer-plugins-bad-free-0.10.23-34.fc25")) flag++;
