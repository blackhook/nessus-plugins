...
# extracted from Fedora Security Advisory 2014-7577.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : claws-mail-3.10.1-1.fc20 / claws-mail-plugins-3.10.1-1.fc20 (2014-7577)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1110254"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135345.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d14691d3"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/135346.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9764eae7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"claws-mail-3.10.1-1.fc20")) flag++;
if (rpm_check(release:"FC20", reference:"claws-mail-plugins-3.10.1-1.fc20")) flag++;
