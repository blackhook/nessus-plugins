...
# extracted from F5 Networks BIG-IP Solution SOL16480.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Multiple unzip vulnerabilities (SOL16480)");
...
unzip's '-t' option."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16480"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["APM"]["affected"  ] = make_list("11.0.0-11.6.0","10.2.1-10.2.4");
vmatrix["APM"]["unaffected"] = make_list("12.0.0");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("11.0.0-11.6.0","10.2.1-10.2.4");
...
vmatrix["LC"]["affected"  ] = make_list("11.0.0-11.6.0","10.2.1-10.2.4");
vmatrix["LC"]["unaffected"] = make_list("12.0.0");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("11.0.0-11.6.0","10.2.1-10.2.4");
