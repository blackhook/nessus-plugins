...
# extracted from Fedora Security Advisory 2014-12036.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12036");

  script_name(english:"Fedora 20 : xen-4.3.3-3.fc20 (2014-12036)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a3aad8ea"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"xen-4.3.3-3.fc20")) flag++;
