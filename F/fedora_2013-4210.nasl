...
# extracted from Fedora Security Advisory 2013-4210.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 17 : gajim-0.15.3-1.fc17 (2013-4210)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-March/101144.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?929a11eb"
  );
  # https://trac.gajim.org/query?status=closed&milestone=0.15.3
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gajim-0.15.3-1.fc17")) flag++;
