...
# extracted from Fedora Security Advisory 2010-13928.
#
...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"  - Bug #626783 - CVE-2010-2948 Quagga (bgpd): Stack buffer
    overflow by processing certain Route-Refresh messages
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-September/047471.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c362114a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"quagga-0.99.17-1.fc14")) flag++;
