...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/066828.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e9a15679"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"NetworkManager-0.9.1.90-3.git20110927.fc16")) flag++;
