...
# extracted from Fedora Security Advisory FEDORA-2017-4de07172f4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : postgresql (2017-4de07172f4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4de07172f4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"postgresql-9.5.7-1.fc24")) flag++;
