...
# extracted from F5 Networks BIG-IP Solution K05428062.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : pcregrep in PCRE vulnerability (K05428062)");
  ...
  script_set_attribute(
    ...
    value:
"pcregrep in PCRE before 8.38 mishandles the -q option for binary
files, which might allow remote attackers to obtain sensitive
information via a crafted file, as demonstrated by a CGI script that
sends stdout data to a client. (CVE-2015-8393)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K05428062"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
