...
# extracted from Fedora Security Advisory 2011-2138.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-2138");

  script_name(english:"Fedora 13 : rubygem-actionpack-2.3.5-4.fc13 (2011-2138)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/055088.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?37b56b9a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"rubygem-actionpack-2.3.5-4.fc13")) flag++;
