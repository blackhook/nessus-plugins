...
# extracted from Fedora Security Advisory FEDORA-2021-47f53a940a
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-47f53a940a");

  script_name(english:"Fedora 33 : xen (2021-47f53a940a)");
...
FEDORA-2021-47f53a940a advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-47f53a940a");
...
pkgs = [
    {'reference':'xen-4.14.1-5.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
