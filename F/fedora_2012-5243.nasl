...
# extracted from Fedora Security Advisory 2012-5243.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-5243");

  script_name(english:"Fedora 16 : wireshark-1.6.6-1.fc16 (2012-5243)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=807611"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=807624"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f2d1243a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"wireshark-1.6.6-1.fc16")) flag++;
