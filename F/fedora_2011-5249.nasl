...
# extracted from Fedora Security Advisory 2011-5249.
#
...
if (description)
{
  ...
  script_bugtraq_id(47285);
  script_xref(name:"FEDORA", value:"2011-5249");

  script_name(english:"Fedora 15 : ikiwiki-3.20110328-1.fc15 (2011-5249)");
...
Security fix: Possible JavaScript insertion via insufficient
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058403.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00619c3c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"ikiwiki-3.20110328-1.fc15")) flag++;
