...
# extracted from Fedora Security Advisory 2015-8c475f7169.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8c475f7169");

  script_name(english:"Fedora 23 : libpng10-1.0.65-1.fc23 (2015-8c475f7169)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-December/174105.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb05b0e4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"libpng10-1.0.65-1.fc23")) flag++;
