...
# extracted from Fedora Security Advisory 2004-159.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2004-0521");
  script_xref(name:"FEDORA", value:"2004-159");

  script_name(english:"Fedora Core 1 : squirrelmail-1.4.3-0.f1.1 (2004-159)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000156.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?35bfedbe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", reference:"squirrelmail-1.4.3-0.f1.1")) flag++;
