...
# extracted from Fedora Security Advisory FEDORA-2020-41e57d7649.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:grub2 (2020-41e57d7649)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-41e57d7649"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"grub2-2.04-22.fc32", epoch:"1")) flag++;
