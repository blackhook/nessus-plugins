...
# extracted from F5 Networks BIG-IP Solution K16323.
#
...
if (description)
{
  ...
  script_bugtraq_id(73196, 73239);

  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability  (K16323)");
...
application crash) or possibly have unspecified other impacts via a
malformed Elliptic Curve (EC) private-key file that is improperly
handled during import. (CVE-2015-0209)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16323"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.5.4");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("11.4.0-11.6.0");
vmatrix["AM"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.6.0HF5","11.5.4","11.5.3HF2","11.4.1HF9");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("11.0.0-11.6.0","10.1.0-10.2.4");
vmatrix["APM"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.6.0HF5","11.5.4","11.5.3HF2","11.4.1HF9","11.2.1HF15");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("11.0.0-11.6.0","10.1.0-10.2.4");
vmatrix["ASM"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.6.0HF5","11.5.4","11.5.3HF2","11.4.1HF9","11.2.1HF15");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("11.0.0-11.6.0");
vmatrix["AVR"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.6.0HF5","11.5.4","11.5.3HF2","11.4.1HF9","11.2.1HF15");
...
vmatrix["LC"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.6.0HF5","11.5.4","11.5.3HF2","11.4.1HF9","11.2.1HF15");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("11.0.0-11.6.0","10.0.1-10.2.4");
vmatrix["LTM"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.6.0HF5","11.5.4","11.5.3HF2","11.4.1HF9","11.2.1HF15");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("11.3.0-11.6.0");
vmatrix["PEM"]["unaffected"] = make_list("12.1.0","12.0.0","11.6.1","11.6.0HF5","11.5.4","11.5.3HF2","11.4.1HF9");
