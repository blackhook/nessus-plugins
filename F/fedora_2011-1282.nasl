...
# extracted from Fedora Security Advisory 2011-1282.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-1282");

  script_name(english:"Fedora 15 : phpMyAdmin-3.3.9.2-1.fc15 (2011-1282)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=676172"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/054525.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?59ee96c7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"phpMyAdmin-3.3.9.2-1.fc15")) flag++;
