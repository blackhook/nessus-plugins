...
# extracted from Fedora Security Advisory 2011-0613.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0613");

  script_name(english:"Fedora 13 : proftpd-1.3.3d-1.fc13 (2011-0613)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053537.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?852284f9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"proftpd-1.3.3d-1.fc13")) flag++;
