...
# extracted from Fedora Security Advisory 2011-6363.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6363");

  script_name(english:"Fedora 13 : wordpress-3.1.2-1.fc13 (2011-6363)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059968.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23c1dca0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"wordpress-3.1.2-1.fc13")) flag++;
