...
# extracted from Fedora Security Advisory 2010-4392.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : gnu-smalltalk-3.1-8.fc11 (2010-4392)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037654.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b4ee485f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"gnu-smalltalk-3.1-8.fc11")) flag++;
