...
# extracted from Fedora Security Advisory 2009-8114.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8114");

  script_name(english:"Fedora 10 : wordpress-2.8.2-1.fc10 (2009-8114)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/027182.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6eecf69f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"wordpress-2.8.2-1.fc10")) flag++;
