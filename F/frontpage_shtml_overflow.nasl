...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"324096");
...
Security Bulletin MS02-053 to determine if you are vulnerable or not.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2002/ms02-053");
