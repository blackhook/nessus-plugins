...
# extracted from Fedora Security Advisory 2008-0170.
#
...
if (description)
{
  ...
  script_bugtraq_id(26927, 26946, 27063);
  script_xref(name:"FEDORA", value:"2008-0170");

  script_name(english:"Fedora 7 : clamav-0.92-6.fc7 (2008-0170)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=240610"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=426211"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-January/006997.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e2befbe"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"clamav-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-data-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-data-empty-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-debuginfo-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-devel-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-filesystem-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-lib-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-milter-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-milter-sysv-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-server-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-server-sysv-0.92-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-update-0.92-6.fc7")) flag++;
