...
# extracted from Fedora Security Advisory FEDORA-2016-d286ffb801.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-d286ffb801");

  script_name(english:"Fedora 23 : libXvMC (2016-d286ffb801)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-d286ffb801"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"libXvMC-1.0.10-1.fc23")) flag++;
