...
# extracted from Fedora Security Advisory 2004-549.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-549");

  script_name(english:"Fedora Core 2 : kdebase-3.2.2-8.FC2 (2004-549)");
...
"  - Tue Dec 14 2004 Than Ngo <than at redhat.com>
  ...
  - Tue Sep 28 2004 Than Ngo <than at redhat.com>
    6:3.2.2-7.FC2
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-December/000504.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?42267a55"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"kdebase-3.2.2-8.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kdebase-debuginfo-3.2.2-8.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kdebase-devel-3.2.2-8.FC2")) flag++;
