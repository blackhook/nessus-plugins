...
# extracted from Fedora Security Advisory FEDORA-2018-0ad6e73ac0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : w3m (2018-0ad6e73ac0)");
  ...
  script_set_attribute(
    ...
    value:
"Rebase to latest upstream gitrev 20180125 and Security fix for
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-0ad6e73ac0"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"w3m-0.5.3-36.git20180125.fc27")) flag++;
