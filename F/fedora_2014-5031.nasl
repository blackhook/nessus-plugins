...
# extracted from Fedora Security Advisory 2014-5031.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5031");

  script_name(english:"Fedora 19 : elfutils-0.158-3.fc19 (2014-5031)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1085663"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/132287.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3b8b28f9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"elfutils-0.158-3.fc19")) flag++;
