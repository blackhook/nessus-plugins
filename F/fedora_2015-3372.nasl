...
# extracted from Fedora Security Advisory 2015-3372.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3372");

  script_name(english:"Fedora 20 : freexl-1.0.0i-1.fc20 (2015-3372)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152057.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d0df15ee"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"freexl-1.0.0i-1.fc20")) flag++;
