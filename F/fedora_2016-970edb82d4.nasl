...
# extracted from Fedora Security Advisory FEDORA-2016-970edb82d4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : python (2016-970edb82d4) (httpoxy)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-970edb82d4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"python-2.7.11-8.fc23")) flag++;
