...
# extracted from Fedora Security Advisory 2014-11065.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11065");

  script_name(english:"Fedora 20 : nodejs-0.10.32-1.fc20 / v8-3.14.5.10-14.fc20 (2014-11065)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/139228.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b09f638e"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/139229.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8c989a74"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"nodejs-0.10.32-1.fc20")) flag++;
if (rpm_check(release:"FC20", reference:"v8-3.14.5.10-14.fc20")) flag++;
