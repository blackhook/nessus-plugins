...
# extracted from Fedora Security Advisory FEDORA-2017-f8094477ee.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f8094477ee");

  script_name(english:"Fedora 24 : mapserver (2017-f8094477ee)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f8094477ee"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mapserver-6.2.4-1.fc24")) flag++;
