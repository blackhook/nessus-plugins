...
# extracted from Fedora Security Advisory FEDORA-2018-c587c0a62d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : moodle (2018-c587c0a62d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c587c0a62d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"moodle-3.3.4-1.fc27")) flag++;
