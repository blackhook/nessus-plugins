...
# extracted from Fedora Security Advisory FEDORA-2017-f44afd1f34.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : libXfont2 (2017-f44afd1f34)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f44afd1f34"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libXfont2-2.0.2-1.fc26")) flag++;
