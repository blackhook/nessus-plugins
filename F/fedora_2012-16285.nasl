...
# extracted from Fedora Security Advisory 2012-16285.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16285");

  script_name(english:"Fedora 18 : java-1.7.0-openjdk-1.7.0.9-2.3.3.fc18 (2012-16285)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090234.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fdfc3232"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"java-1.7.0-openjdk-1.7.0.9-2.3.3.fc18")) flag++;
