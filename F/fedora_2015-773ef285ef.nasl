...
# extracted from Fedora Security Advisory 2015-773ef285ef.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-773ef285ef");

  script_name(english:"Fedora 22 : openjpeg2-2.1.0-7.fc22 (2015-773ef285ef)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?59ad026d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"openjpeg2-2.1.0-7.fc22")) flag++;
