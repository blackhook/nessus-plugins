...
# extracted from Fedora Security Advisory FEDORA-2019-2d831039a3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : drupal7-entity (2019-2d831039a3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-2d831039a3"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"drupal7-entity-1.9-1.fc30")) flag++;
