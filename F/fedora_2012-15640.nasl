...
# extracted from Fedora Security Advisory 2012-15640.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-15640");

  script_name(english:"Fedora 16 : libvirt-0.9.6.3-1.fc16 (2012-15640)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?205d6461"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"libvirt-0.9.6.3-1.fc16")) flag++;
