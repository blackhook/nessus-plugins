...
# extracted from Fedora Security Advisory 2010-4524.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : qt-4.6.2-8.fc11 (2010-4524)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037833.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88b3a23f"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"qt-4.6.2-8.fc11")) flag++;
