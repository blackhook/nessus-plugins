...
# extracted from Fedora Security Advisory FEDORA-2016-f8a01aa629.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-f8a01aa629");

  script_name(english:"Fedora 23 : squidGuard (2016-f8a01aa629)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.squidguard.org/Downloads/Patches/1.4/Readme.Patch-20150201"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f8a01aa629"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"squidGuard-1.4-26.fc23")) flag++;
