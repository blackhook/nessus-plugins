...
# extracted from Fedora Security Advisory FEDORA-2016-fd6100dd68.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : jenkins (2016-fd6100dd68)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-fd6100dd68"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"jenkins-1.651.2-1.fc24")) flag++;
