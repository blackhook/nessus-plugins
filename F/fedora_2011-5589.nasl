...
# extracted from Fedora Security Advisory 2011-5589.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5589");

  script_name(english:"Fedora 15 : polkit-0.101-5.fc15 (2011-5589)");
  ...
  script_set_attribute(
    ...
    value:
"  - Bug #692922 - CVE-2011-1485 polkitd/pkexec vulnerability
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=692922"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058752.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?36adaa85"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"polkit-0.101-5.fc15")) flag++;
