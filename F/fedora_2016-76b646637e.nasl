...
# extracted from Fedora Security Advisory FEDORA-2016-76b646637e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : tor (2016-76b646637e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-76b646637e"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"tor-0.2.8.12-1.fc24")) flag++;
