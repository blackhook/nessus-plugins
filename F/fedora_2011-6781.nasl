...
# extracted from Fedora Security Advisory 2011-6781.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6781");

  script_name(english:"Fedora 15 : mediawiki-1.16.5-59.fc15 (2011-6781)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/060435.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4deb51cc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"mediawiki-1.16.5-59.fc15")) flag++;
