...
# extracted from F5 Networks BIG-IP Solution K15317.
#
...
if (description)
{
  ...
  script_bugtraq_id(65943);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K15317)");
...
(CVE-2014-0101)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15317"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["APM"]["affected"  ] = make_list("11.1.0-11.5.3");
vmatrix["APM"]["unaffected"] = make_list("12.0.0","11.6.0","11.0.0","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("11.1.0-11.5.3");
vmatrix["ASM"]["unaffected"] = make_list("12.0.0","11.6.0","11.0.0","10.0.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("11.1.0-11.5.3");
vmatrix["AVR"]["unaffected"] = make_list("12.0.0","11.6.0","11.0.0");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("11.1.0-11.5.3");
vmatrix["GTM"]["unaffected"] = make_list("11.6.0","11.0.0","10.0.0-10.2.4");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("11.1.0-11.5.3");
vmatrix["LC"]["unaffected"] = make_list("12.0.0","11.6.0","11.0.0","10.0.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("11.1.0-11.5.3");
vmatrix["LTM"]["unaffected"] = make_list("12.0.0","11.6.0","11.0.0","10.0.0-10.2.4");
