...
# extracted from Fedora Security Advisory 2005-638.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-638");

  script_name(english:"Fedora Core 3 : httpd-2.0.53-3.2 (2005-638)");
...
also adds security fixes for CVE-2005-2088 and CVE-2005-1268.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001190.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7587611d"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"httpd-2.0.53-3.2")) flag++;
if (rpm_check(release:"FC3", reference:"httpd-debuginfo-2.0.53-3.2")) flag++;
if (rpm_check(release:"FC3", reference:"httpd-devel-2.0.53-3.2")) flag++;
if (rpm_check(release:"FC3", reference:"httpd-manual-2.0.53-3.2")) flag++;
if (rpm_check(release:"FC3", reference:"httpd-suexec-2.0.53-3.2")) flag++;
if (rpm_check(release:"FC3", reference:"mod_ssl-2.0.53-3.2")) flag++;
