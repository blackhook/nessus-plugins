...
# extracted from Fedora Security Advisory FEDORA-2017-54580efa82.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-54580efa82");

  script_name(english:"Fedora 25 : sudo (2017-54580efa82)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-54580efa82"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"sudo-1.8.20p2-1.fc25")) flag++;
