...
# extracted from Fedora Security Advisory 2009-8449.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8449");

  script_name(english:"Fedora 11 : subversion-1.6.4-2.fc11 (2009-8449)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://subversion.apache.org/source-code"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=514744"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027755.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4dbd95f8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"subversion-1.6.4-2.fc11")) flag++;
