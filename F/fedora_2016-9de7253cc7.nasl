...
# extracted from Fedora Security Advisory FEDORA-2016-9de7253cc7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : lighttpd (2016-9de7253cc7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-9de7253cc7"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC23", reference:"lighttpd-1.4.41-1.fc23")) flag++;
