...
# extracted from Fedora Security Advisory FEDORA-2018-b7a613ea5d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-b7a613ea5d");

  script_name(english:"Fedora 27 : gsoap (2018-b7a613ea5d)");
...
that may cause the receiver to become unresponsive when a malformed
DIME protocol message is received. --
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b7a613ea5d"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.genivia.com/advisory.html"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"gsoap-2.8.49-4.fc27")) flag++;
