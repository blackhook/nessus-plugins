...
vulnerability as referenced in the K92451315 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K92451315");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.3','15.1.0-15.1.6','14.1.0-14.1.5','13.1.0-13.1.5','12.1.0-12.1.5','11.6.1-11.6.5'
    ],
    'unaffected': [
      '17.0.0'
    ],
