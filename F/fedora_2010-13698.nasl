...
# extracted from Fedora Security Advisory 2010-13698.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : libgdiplus-2.6.7-2.fc13 (2010-13698)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-September/047268.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8c0bceb5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"libgdiplus-2.6.7-2.fc13")) flag++;
