...
# extracted from Fedora Security Advisory FEDORA-2017-1607a3a78e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1607a3a78e");
  script_xref(name:"IAVB", value:"2017-B-0024-S");

  script_name(english:"Fedora 24 : xen (2017-1607a3a78e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1607a3a78e"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"xen-4.6.4-8.fc24")) flag++;
