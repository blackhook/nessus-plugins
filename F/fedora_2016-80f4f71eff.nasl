...
# extracted from Fedora Security Advisory FEDORA-2016-80f4f71eff.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-80f4f71eff");

  script_name(english:"Fedora 23 : curl (2016-80f4f71eff)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-80f4f71eff"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"curl-7.43.0-10.fc23")) flag++;
