...
# extracted from Fedora Security Advisory 2012-20643.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-20643");

  script_name(english:"Fedora 18 : inkscape-0.48.4-1.fc18 (2012-20643)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=888249"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/095024.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6608bb60"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"inkscape-0.48.4-1.fc18")) flag++;
