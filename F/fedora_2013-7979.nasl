...
# extracted from Fedora Security Advisory 2013-7979.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-7979");

  script_name(english:"Fedora 19 : tomcat-7.0.40-2.fc19 (2013-7979)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/106342.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e2af710c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"tomcat-7.0.40-2.fc19")) flag++;
