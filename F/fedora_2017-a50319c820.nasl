...
# extracted from Fedora Security Advisory FEDORA-2017-a50319c820.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a50319c820");

  script_name(english:"Fedora 26 : dropbear (2017-a50319c820)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a50319c820"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"dropbear-2017.75-1.fc26")) flag++;
