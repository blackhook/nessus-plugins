...
# extracted from Fedora Security Advisory FEDORA-2017-beb25f1953.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-beb25f1953");

  script_name(english:"Fedora 25 : rpm (2017-beb25f1953)");
...
(http://rpm.org/wiki/Releases/4.13.0.1) which includes several
important security and regression fixes.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rpm.org/wiki/Releases/4.13.0.1"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-beb25f1953"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"rpm-4.13.0.1-1.fc25")) flag++;
