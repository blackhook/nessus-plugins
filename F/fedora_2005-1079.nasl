...
# extracted from Fedora Security Advisory 2005-1079.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1079");

  script_name(english:"Fedora Core 4 : lynx-2.8.5-23.2 (2005-1079)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-November/001579.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?64ea6562"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"lynx-2.8.5-23.2")) flag++;
if (rpm_check(release:"FC4", reference:"lynx-debuginfo-2.8.5-23.2")) flag++;
