...
# extracted from Fedora Security Advisory 2013-14902.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-14902");

  script_name(english:"Fedora 18 : python-virtualenv-1.10.1-1.fc18 (2013-14902)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115117.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23283565"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"python-virtualenv-1.10.1-1.fc18")) flag++;
