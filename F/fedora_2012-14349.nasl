...
# extracted from Fedora Security Advisory 2012-14349.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14349");

  script_name(english:"Fedora 17 : automake-1.11.6-1.fc17 (2012-14349)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=838660"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/087538.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?134f82d0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"automake-1.11.6-1.fc17")) flag++;
