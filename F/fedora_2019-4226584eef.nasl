...
# extracted from Fedora Security Advisory FEDORA-2019-4226584eef.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : php-horde-horde (2019-4226584eef)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4226584eef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-horde-horde-5.2.21-1.fc29")) flag++;
