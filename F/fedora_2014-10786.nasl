...
# extracted from Fedora Security Advisory 2014-10786.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : python-oauth2-1.5.211-7.fc20 (2014-10786)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?720b54fc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-oauth2-1.5.211-7.fc20")) flag++;
