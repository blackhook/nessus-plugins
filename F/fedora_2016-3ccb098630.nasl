...
# extracted from Fedora Security Advisory FEDORA-2016-3ccb098630.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : ansible (2016-3ccb098630)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3ccb098630"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ansible-2.2.0.0-3.fc25")) flag++;
