...
# extracted from Fedora Security Advisory FEDORA-2019-93b4b78e58.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 2:runc (2019-93b4b78e58)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-93b4b78e58"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"runc-1.0.0-67.dev.git12f6a99.fc28", epoch:"2")) flag++;
