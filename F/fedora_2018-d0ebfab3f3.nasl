...
# extracted from Fedora Security Advisory FEDORA-2018-d0ebfab3f3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : rsync (2018-d0ebfab3f3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d0ebfab3f3"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"rsync-3.1.3-1.fc27")) flag++;
