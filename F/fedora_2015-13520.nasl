...
# extracted from Fedora Security Advisory 2015-13520.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : openssh-6.9p1-5.fc22 (2015-13520)");
  ...
  script_set_attribute(
    ...
    value:
"This update brings fixes for vulnerabilities published with
openssh-7.0 and is fixing pam_ssh_agent_auth module to be functional
again.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3ad7c20d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"openssh-6.9p1-5.fc22")) flag++;
