...
# extracted from Fedora Security Advisory 2011-7426.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7426");

  script_name(english:"Fedora 15 : php-ZendFramework-1.11.6-1.fc15 (2011-7426)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/060878.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3dfa758c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"php-ZendFramework-1.11.6-1.fc15")) flag++;
