...
# extracted from Fedora Security Advisory 2009-8109.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8109");

  script_name(english:"Fedora 11 : wordpress-2.8.2-1.fc11 (2009-8109)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Jul 28 2009 Adrian Reber <adrian at lisas.de> -
    2.8.2-1

    - updated to 2.8.2 for security fixes - BZ 512900

    - fixed 'wrong-script-end-of-line-encoding' of
      license.txt
    ...
    - Mon Jul 27 2009 Fedora Release Engineering <rel-eng at
      lists.fedoraproject.org> - 2.8.1-2
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=512900"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://fedoraproject.org/wiki/Fedora_12_Mass_Rebuild"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/027170.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06b7a91b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"wordpress-2.8.2-1.fc11")) flag++;
