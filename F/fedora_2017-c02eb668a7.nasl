...
# extracted from Fedora Security Advisory FEDORA-2017-c02eb668a7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : libICE (2017-c02eb668a7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c02eb668a7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libICE-1.0.9-8.fc25")) flag++;
