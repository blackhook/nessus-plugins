...
# extracted from Fedora Security Advisory FEDORA-2021-b1d1655cef
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-b1d1655cef");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"Fedora 32 : community-mysql / mysql-connector-odbc (2021-b1d1655cef)");
...
FEDORA-2021-b1d1655cef advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-b1d1655cef");
...
pkgs = [
    {'reference':'community-mysql-8.0.23-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mysql-connector-odbc-8.0.23-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
