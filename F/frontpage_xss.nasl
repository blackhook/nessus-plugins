...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"260347");
  script_xref(name:"MSKB", value:"275657");
...
browser session.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2000/ms00-060");
