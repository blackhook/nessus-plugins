...
# extracted from Fedora Security Advisory 2015-13526.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-13526");

  script_name(english:"Fedora 22 : audit-2.4.4-1.fc22 (2015-13526)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?de05daf2"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"audit-2.4.4-1.fc22")) flag++;
