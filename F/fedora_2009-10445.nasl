...
# extracted from Fedora Security Advisory 2009-10445.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10445");

  script_name(english:"Fedora 10 : drupal-service_links-6.x.1.0-5.fc10 (2009-10445)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030006.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?62b0e7ac"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"drupal-service_links-6.x.1.0-5.fc10")) flag++;
