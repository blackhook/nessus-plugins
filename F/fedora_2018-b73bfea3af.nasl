...
# extracted from Fedora Security Advisory FEDORA-2018-b73bfea3af.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : boost (2018-b73bfea3af)");
  ...
  script_set_attribute(
    ...
    value:
"Updated Boost libraries are available that fix compatibility with CUDA
9.x compilers and fix a possible integer overflow in Boost.Regex.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b73bfea3af"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"boost-1.63.0-12.fc26")) flag++;
