...
# extracted from Fedora Security Advisory FEDORA-2016-8586235698.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-8586235698");

  script_name(english:"Fedora 24 : nagios-plugins (2016-8586235698)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-8586235698"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"nagios-plugins-2.1.4-2.fc24")) flag++;
