...
if (description)
{
  ...
  script_name(english:"Adobe Flash Player <= 27.0.0.159 Type Confusion Vulnerability (APSB17-32)");
...
is equal or prior to version 27.0.0.159. It is, therefore, affected by
an unspecified type confusion flaw that is caused by input not being
properly validated. An unauthenticated, remote attacker can exploit
this, by convincing a user to visit a website containing specially
crafted Flash content, to trigger the vulnerability and potentially
...
foreach variant (variants)
{
  ...
  foreach key (keys(vers))
  {
    ...
    # <= 27.0.0.159
    if (ver_compare(ver:ver,fix:"27.0.0.159",strict:FALSE) <= 0)
    {
      ...
      else if ("Chrome" >< variant)
      {
        ...
        if (variant == "Chrome")
          fix = "Upgrade to a version of Google Chrome running Flash Player 27.0.0.170";
      }
      info += '\n  Path              : ' + file +
              '\n  Installed version : ' + ver;
      if (variant == "Chrome_Pepper")
        info += '\n  Fixed version     : 27.0.0.170 (Chrome PepperFlash)';
      else if (!isnull(fix))
        info += '\n  Fixed version     : '+fix;
      info += '\n';
    }
