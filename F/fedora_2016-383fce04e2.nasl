...
# extracted from Fedora Security Advisory 2016-383fce04e2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-383fce04e2");

  script_name(english:"Fedora 24 : samba-4.4.2-1.fc24 (2016-383fce04e2) (Badlock)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-April/182288.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a82cf544"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"samba-4.4.2-1.fc24")) flag++;
