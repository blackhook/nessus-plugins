...
# extracted from Fedora Security Advisory FEDORA-2016-689f240960.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-689f240960");
  script_xref(name:"IAVB", value:"2016-B-0149-S");

  script_name(english:"Fedora 23 : xen (2016-689f240960)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-689f240960"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"xen-4.5.5-2.fc23")) flag++;
