...
# extracted from Fedora Security Advisory FEDORA-2017-93ed1d1687.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-93ed1d1687");

  script_name(english:"Fedora 25 : mapserver (2017-93ed1d1687)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-93ed1d1687"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mapserver-7.0.4-1.gitb4bc015.fc25")) flag++;
