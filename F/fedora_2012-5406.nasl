...
# extracted from Fedora Security Advisory 2012-5406.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-5406");

  script_name(english:"Fedora 15 : libtiff-3.9.5-3.fc15 (2012-5406)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/078403.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?59fecb79"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libtiff-3.9.5-3.fc15")) flag++;
