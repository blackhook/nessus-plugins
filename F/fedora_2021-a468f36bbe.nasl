...
# extracted from Fedora Security Advisory FEDORA-2021-a468f36bbe
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a468f36bbe");

  script_name(english:"Fedora 32 : xen (2021-a468f36bbe)");
...
FEDORA-2021-a468f36bbe advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a468f36bbe");
...
pkgs = [
    {'reference':'xen-4.13.2-8.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
