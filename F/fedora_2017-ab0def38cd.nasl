...
# extracted from Fedora Security Advisory FEDORA-2017-ab0def38cd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ab0def38cd");

  script_name(english:"Fedora 26 : 1:tomcat (2017-ab0def38cd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ab0def38cd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"tomcat-8.0.46-1.fc26", epoch:"1")) flag++;
