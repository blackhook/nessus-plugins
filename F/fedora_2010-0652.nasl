...
# extracted from Fedora Security Advisory 2010-0652.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : php-ZendFramework-1.9.7-1.fc12 (2010-0652)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-January/034021.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1bd0a053"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"php-ZendFramework-1.9.7-1.fc12")) flag++;
