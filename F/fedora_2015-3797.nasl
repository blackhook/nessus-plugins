...
# extracted from Fedora Security Advisory 2015-3797.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3797");

  script_name(english:"Fedora 21 : libssh2-1.5.0-1.fc21 (2015-3797)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152362.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a7e559f0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"libssh2-1.5.0-1.fc21")) flag++;
