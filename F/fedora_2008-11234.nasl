...
# extracted from Fedora Security Advisory 2008-11234.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : roundcubemail-0.2-4.beta.fc9 (2008-11234)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-December/017712.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1a686e41"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"roundcubemail-0.2-4.beta.fc9")) flag++;
