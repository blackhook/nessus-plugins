...
# extracted from Fedora Security Advisory FEDORA-2020-dd8c133829.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 2:freerdp / remmina (2020-dd8c133829)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-dd8c133829"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"freerdp-2.1.2-1.fc31", epoch:"2")) flag++;
if (rpm_check(release:"FC31", reference:"remmina-1.4.7-1.fc31")) flag++;
