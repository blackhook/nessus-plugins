...
# extracted from Fedora Security Advisory 2005-217.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-217");

  script_name(english:"Fedora Core 3 : ipsec-tools-0.5-2.fc3 (2005-217)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000761.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a899270"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"ipsec-tools-0.5-2.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"ipsec-tools-debuginfo-0.5-2.fc3")) flag++;
