...
# extracted from Fedora Security Advisory 2011-2558.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-2558");

  script_name(english:"Fedora 13 : asterisk-1.6.2.17-1.fc13 (2011-2558)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/055634.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c603fa0f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"asterisk-1.6.2.17-1.fc13")) flag++;
