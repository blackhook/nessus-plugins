...
# extracted from Fedora Security Advisory 2012-17143.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-17143");

  script_name(english:"Fedora 18 : rt3-3.8.15-1.fc18 (2012-17143)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091310.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?09897512"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"rt3-3.8.15-1.fc18")) flag++;
