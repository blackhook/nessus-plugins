...
# extracted from Fedora Security Advisory FEDORA-2017-f47206eae4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f47206eae4");

  script_name(english:"Fedora 27 : collectd (2017-f47206eae4)");
...
https://collectd.org/news.shtml#news106 for the list of changes.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f47206eae4"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://collectd.org/news.shtml#news106"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"collectd-5.8.0-2.fc27")) flag++;
