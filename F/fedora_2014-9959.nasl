...
# extracted from Fedora Security Advisory 2014-9959.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9959");

  script_name(english:"Fedora 20 : kernel-3.15.10-201.fc20 (2014-9959)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-August/137179.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f349e10"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"kernel-3.15.10-201.fc20")) flag++;
