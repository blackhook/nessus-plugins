...
# extracted from F5 Networks BIG-IP Solution K40524634.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (K40524634)");
...
and crypto/bn/bn_print.c. (CVE-2016-0797)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K40524634"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
