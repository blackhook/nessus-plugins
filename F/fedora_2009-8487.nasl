...
# extracted from Fedora Security Advisory 2009-8487.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8487");

  script_name(english:"Fedora 10 : wordpress-2.8.3-2.fc10 (2009-8487)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f93528b8"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027793.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7374051e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"wordpress-2.8.3-2.fc10")) flag++;
