...
# extracted from Fedora Security Advisory 2011-5495.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5495");

  script_name(english:"Fedora 15 : mediawiki-1.16.4-57.fc15 (2011-5495)");
  ...
  script_set_attribute(
    ...
    value:
"This update brings mediawiki to version 1.16.2, which is the latest
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed12070b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"mediawiki-1.16.4-57.fc15")) flag++;
