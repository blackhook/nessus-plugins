...
# extracted from Fedora Security Advisory 2004-119.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-119");

  script_name(english:"Fedora Core 1 : lha-1.14i-12.1 (2004-119)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-May/000119.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?46d92541"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", reference:"lha-1.14i-12.1")) flag++;
if (rpm_check(release:"FC1", reference:"lha-debuginfo-1.14i-12.1")) flag++;
