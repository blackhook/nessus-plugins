...
# extracted from Fedora Security Advisory 2006-493.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-493");

  script_name(english:"Fedora Core 5 : devhelp-0.11-3.1.fc5 (2006-493)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000024.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c9610c4"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC5", reference:"devhelp-0.11-3.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"devhelp-debuginfo-0.11-3.1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"devhelp-devel-0.11-3.1.fc5")) flag++;
