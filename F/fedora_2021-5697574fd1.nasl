...
# extracted from Fedora Security Advisory FEDORA-2021-5697574fd1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-5697574fd1");

  script_name(english:"Fedora 33 : exim (2021-5697574fd1)");
...
FEDORA-2021-5697574fd1 advisory.

  - Fixed cname handling in TLS certificate verification (FEDORA-2021-5697574fd1)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5697574fd1");
...
pkgs = [
    {'reference':'exim-4.94-7.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
