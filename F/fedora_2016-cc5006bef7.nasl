...
# extracted from Fedora Security Advisory FEDORA-2016-cc5006bef7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-cc5006bef7");

  script_name(english:"Fedora 25 : dracut (2016-cc5006bef7)");
  ...
  script_set_attribute(
    ...
    value:
"  - fixed permissions of initramfs file, if microcode is
    prepended (CVE-2016-8637)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-cc5006bef7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"dracut-044-78.fc25")) flag++;
