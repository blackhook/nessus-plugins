...
# extracted from Fedora Security Advisory FEDORA-2018-3564527be4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-3564527be4");

  script_name(english:"Fedora 28 : haproxy (2018-3564527be4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3564527be4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"haproxy-1.8.8-1.fc28")) flag++;
