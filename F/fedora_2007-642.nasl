...
# extracted from Fedora Security Advisory 2007-642.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : firefox-1.5.0.12-4.fc6 (2007-642)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/002849.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d2bd541"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"firefox-1.5.0.12-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"firefox-debuginfo-1.5.0.12-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"firefox-devel-1.5.0.12-4.fc6")) flag++;
