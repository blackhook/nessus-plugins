...
# extracted from Fedora Security Advisory 2014-16016.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-16016");

  script_name(english:"Fedora 20 : util-linux-2.24.2-2.fc20 (2014-16016)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4e4532b6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"util-linux-2.24.2-2.fc20")) flag++;
