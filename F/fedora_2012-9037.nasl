...
# extracted from Fedora Security Advisory 2012-9037.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-9037");

  script_name(english:"Fedora 16 : thunderbird-13.0-1.fc16 / thunderbird-lightning-1.5-2.fc16 (2012-9037)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082820.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?731c0c80"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082821.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?66d89194"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC16", reference:"thunderbird-13.0-1.fc16")) flag++;
if (rpm_check(release:"FC16", reference:"thunderbird-lightning-1.5-2.fc16")) flag++;
