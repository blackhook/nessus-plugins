...
# extracted from Fedora Security Advisory 2005-1137.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1137");

  script_name(english:"Fedora Core 4 : curl-7.13.1-5.fc4 (2005-1137)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001647.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bc669082"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"curl-7.13.1-5.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"curl-debuginfo-7.13.1-5.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"curl-devel-7.13.1-5.fc4")) flag++;
