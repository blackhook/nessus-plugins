...
# extracted from Fedora Security Advisory FEDORA-2017-4a42419c16.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-4a42419c16");

  script_name(english:"Fedora 26 : libextractor (2017-4a42419c16)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4a42419c16"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libextractor-1.6-1.fc26")) flag++;
