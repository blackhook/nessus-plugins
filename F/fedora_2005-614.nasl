...
# extracted from Fedora Security Advisory 2005-614.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-614");

  script_name(english:"Fedora Core 3 : fetchmail-6.2.5-7.fc3.1 (2005-614)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-July/001110.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?08d458cc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"fetchmail-6.2.5-7.fc3.1")) flag++;
if (rpm_check(release:"FC3", reference:"fetchmail-debuginfo-6.2.5-7.fc3.1")) flag++;
