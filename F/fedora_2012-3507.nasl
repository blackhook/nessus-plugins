...
# extracted from Fedora Security Advisory 2012-3507.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-3507");

  script_name(english:"Fedora 17 : libpng10-1.0.58-1.fc17 (2012-3507)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7fc39ea6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"libpng10-1.0.58-1.fc17")) flag++;
