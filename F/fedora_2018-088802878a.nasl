...
# extracted from Fedora Security Advisory FEDORA-2018-088802878a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : phpMyAdmin (2018-088802878a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-088802878a"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC29", reference:"phpMyAdmin-4.8.4-1.fc29")) flag++;
