...
# extracted from Fedora Security Advisory 2013-18931.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : ReviewBoard-1.7.16-2.fc19 / python-djblets-0.7.21-1.fc19 (2013-18931)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119819.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8a88af5"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119820.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9c2e147"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"ReviewBoard-1.7.16-2.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"python-djblets-0.7.21-1.fc19")) flag++;
