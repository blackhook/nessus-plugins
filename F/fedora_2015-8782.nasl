...
# extracted from Fedora Security Advisory 2015-8782.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8782");

  script_name(english:"Fedora 20 : fuse-2.9.4-1.fc20 (2015-8782)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5588bb27"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"fuse-2.9.4-1.fc20")) flag++;
