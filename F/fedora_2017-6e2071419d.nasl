...
# extracted from Fedora Security Advisory FEDORA-2017-6e2071419d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-6e2071419d");

  script_name(english:"Fedora 25 : seamonkey (2017-6e2071419d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6e2071419d"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"seamonkey-2.49.1-1.fc25")) flag++;
