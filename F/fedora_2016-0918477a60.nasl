...
# extracted from Fedora Security Advisory FEDORA-2016-0918477a60.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0918477a60");

  script_name(english:"Fedora 25 : dpkg (2016-0918477a60)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0918477a60"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"dpkg-1.17.27-1.fc25")) flag++;
