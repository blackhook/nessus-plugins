...
# extracted from Fedora Security Advisory 2013-10032.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-10032");

  script_name(english:"Fedora 19 : gallery3-3.0.8-1.fc19 (2013-10032)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/108840.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c053dae6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"gallery3-3.0.8-1.fc19")) flag++;
