...
# extracted from Fedora Security Advisory 2014-6919.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6919");

  script_name(english:"Fedora 19 : libtasn1-3.6-1.fc19 (2014-6919)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134144.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b610e47"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libtasn1-3.6-1.fc19")) flag++;
