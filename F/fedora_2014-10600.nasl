...
# extracted from Fedora Security Advisory 2014-10600.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-10600");

  script_name(english:"Fedora 21 : pdns-recursor-3.6.1-1.fc21 (2014-10600)");
...
3.6.0 remotely (CVE-2014-3614) Affected: All deployments of PowerDNS
Recursor 3.6.0
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1139251"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137883.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d0c9288"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"pdns-recursor-3.6.1-1.fc21")) flag++;
