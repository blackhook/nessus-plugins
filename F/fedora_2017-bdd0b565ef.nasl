...
# extracted from Fedora Security Advisory FEDORA-2017-bdd0b565ef.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : thunderbird (2017-bdd0b565ef)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-bdd0b565ef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"thunderbird-52.3.0-1.fc25")) flag++;
