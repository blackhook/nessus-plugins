...
# extracted from Fedora Security Advisory FEDORA-2017-b11b460865.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b11b460865");

  script_name(english:"Fedora 24 : util-linux (2017-b11b460865)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b11b460865"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"util-linux-2.28.2-2.fc24")) flag++;
