...
# extracted from Fedora Security Advisory 2012-13575.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13575");

  script_name(english:"Fedora 18 : wordpress-3.4.2-2.fc18 (2012-13575)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086993.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ac50744e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"wordpress-3.4.2-2.fc18")) flag++;
