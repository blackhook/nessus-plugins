...
# extracted from Fedora Security Advisory FEDORA-2017-72f0c1ea9c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-72f0c1ea9c");

  script_name(english:"Fedora 24 : systemd (2017-72f0c1ea9c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-72f0c1ea9c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"systemd-229-22.fc24")) flag++;
