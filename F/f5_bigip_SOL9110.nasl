...
# extracted from F5 Networks BIG-IP Solution SOL9110.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2008-2370");
  script_bugtraq_id(30494);

  script_name(english:"F5 Networks BIG-IP : Apache Tomcat information disclosure vulnerability (SOL9110)");
...
read arbitrary files through a .. (dot dot) in a request parameter."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K9110"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
