...
# extracted from Fedora Security Advisory 2007-2406.
#
...
if (description)
{
  ...
  script_bugtraq_id(25847);
  script_xref(name:"FEDORA", value:"2007-2406");

  script_name(english:"Fedora 7 : ruby-1.8.6.110-1.fc7 (2007-2406)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Oct 4 2007 Akira TAGOH <tagoh at redhat.com> -
    1.8.6.110-1
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=313791"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-October/004067.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5b2c624a"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"ruby-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-debuginfo-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-devel-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-docs-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-irb-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-libs-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-mode-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-rdoc-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-ri-1.8.6.110-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"ruby-tcltk-1.8.6.110-1.fc7")) flag++;
