...
# extracted from Fedora Security Advisory FEDORA-2017-29d909f5ec.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-29d909f5ec");

  script_name(english:"Fedora 25 : systemd (2017-29d909f5ec)");
  ...
  script_set_attribute(
    ...
    value:
"A fix for an out-of-bounds write in systemd-resolved after a crafted
DNS packet (CVE-2017-9445).
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-29d909f5ec"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"systemd-231-17.fc25")) flag++;
