...
# extracted from Fedora Security Advisory FEDORA-2017-16f06ee9d8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-16f06ee9d8");

  script_name(english:"Fedora 25 : mingw-wavpack (2017-16f06ee9d8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-16f06ee9d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-wavpack-5.1.0-1.fc25")) flag++;
