...
# extracted from Fedora Security Advisory 2010-3267.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : sunbird-1.0-0.14.20090715hg.fc11 / thunderbird-3.0.2-1.fc11 (2010-3267)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.thunderbird.net/en-US/thunderbird/3.0.2/releasenotes/"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/036132.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6630ad5"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/036133.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a01bfc73"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"sunbird-1.0-0.14.20090715hg.fc11")) flag++;
if (rpm_check(release:"FC11", reference:"thunderbird-3.0.2-1.fc11")) flag++;
