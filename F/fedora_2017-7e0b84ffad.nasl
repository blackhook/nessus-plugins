...
# extracted from Fedora Security Advisory FEDORA-2017-7e0b84ffad.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-7e0b84ffad");

  script_name(english:"Fedora 24 : wordpress (2017-7e0b84ffad)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7e0b84ffad"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"wordpress-4.7.3-1.fc24")) flag++;
