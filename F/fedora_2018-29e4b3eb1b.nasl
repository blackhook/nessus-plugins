...
# extracted from Fedora Security Advisory FEDORA-2018-29e4b3eb1b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-29e4b3eb1b");

  script_name(english:"Fedora 27 : lighttpd (2018-29e4b3eb1b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-29e4b3eb1b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"lighttpd-1.4.50-1.fc27")) flag++;
