...
# extracted from Fedora Security Advisory 2014-7223.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-7223");

  script_name(english:"Fedora 20 : python-djblets-0.7.30-2.fc20 (2014-7223)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?45bfc687"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-djblets-0.7.30-2.fc20")) flag++;
