...
# extracted from Fedora Security Advisory 2014-5111.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5111");

  script_name(english:"Fedora 19 : knot-1.4.5-1.fc19 (2014-5111)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/132119.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31603106"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"knot-1.4.5-1.fc19")) flag++;
