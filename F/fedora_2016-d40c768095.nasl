...
# extracted from Fedora Security Advisory FEDORA-2016-d40c768095.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-d40c768095");

  script_name(english:"Fedora 24 : moin (2016-d40c768095)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-d40c768095"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"moin-1.9.9-1.fc24")) flag++;
