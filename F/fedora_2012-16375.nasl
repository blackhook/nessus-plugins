...
# extracted from Fedora Security Advisory 2012-16375.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16375");

  script_name(english:"Fedora 18 : drupal7-7.16-1.fc18 (2012-16375)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://drupal.org/node/1815904"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090623.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?304694c5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"drupal7-7.16-1.fc18")) flag++;
