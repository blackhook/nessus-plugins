...
# extracted from Fedora Security Advisory 2005-926.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-926");

  script_name(english:"Fedora Core 4 : firefox-1.0.7-1.1.fc4 (2005-926)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001413.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?361fc0c3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"firefox-1.0.7-1.1.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"firefox-debuginfo-1.0.7-1.1.fc4")) flag++;
