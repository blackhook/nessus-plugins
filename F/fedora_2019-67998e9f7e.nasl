...
# extracted from Fedora Security Advisory FEDORA-2019-67998e9f7e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-67998e9f7e");

  script_name(english:"Fedora 31 : sudo (2019-67998e9f7e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-67998e9f7e"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"sudo-1.8.28-1.fc31")) flag++;
