...
# extracted from Fedora Security Advisory 2013-7552.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-7552");

  script_name(english:"Fedora 17 : openvpn-2.3.1-2.fc17 (2013-7552)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/105568.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31f2990c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"openvpn-2.3.1-2.fc17")) flag++;
