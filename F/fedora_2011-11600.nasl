...
# extracted from Fedora Security Advisory 2011-11600.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : rubygem-activesupport-2.3.8-4.fc14 (2011-11600)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/065189.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?af69e678"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"rubygem-activesupport-2.3.8-4.fc14")) flag++;
