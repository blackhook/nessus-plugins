...
# extracted from Fedora Security Advisory FEDORA-2018-318b5d74bd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-318b5d74bd");

  script_name(english:"Fedora 26 : tomcat-native (2018-318b5d74bd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-318b5d74bd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"tomcat-native-1.2.16-1.fc26")) flag++;
