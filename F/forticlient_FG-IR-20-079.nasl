...
if (description)
{
  ...
  script_name(english:"Fortinet FortiClient 6.4.x < 6.4.3 / 7.x < 7.0.2 Privilege Escalation (FG-IR-20-079)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by a privilege escalation.");
  script_set_attribute(attribute:"description", value:
"The version of Fortinet FortiClient running on the remote host is 6.4.x prior to 6.4.3 or 7.x prior to 7.0.2. It is,
therefore, affected by a privilege escalation vulnerability due to improper authorization. An unauthenticated, local
attacker can exploit this, via the named pipe responsible for FortiClient updates, to escalate privileges to SYSTEM.
...
"Upgrade to Fortinet FortiClient 6.4.3, 7.0.2, or later.");
