...
# extracted from Fedora Security Advisory FEDORA-2017-c76259ddea.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c76259ddea");

  script_name(english:"Fedora 26 : perltidy (2017-c76259ddea)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c76259ddea"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"perltidy-20170521-1.fc26")) flag++;
