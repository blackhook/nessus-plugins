...
# extracted from F5 Networks BIG-IP Solution SOL16912.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (SOL16912)");
...
crafted zone data and then making a query for a name in that zone."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16912"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("11.4.0-11.6.0");
vmatrix["AM"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("11.0.0-11.6.0");
vmatrix["APM"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10","11.2.1HF15","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("11.0.0-11.6.0");
vmatrix["ASM"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10","11.2.1HF15","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("11.0.0-11.6.0");
vmatrix["AVR"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10","11.2.1HF15");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("11.0.0-11.6.0");
vmatrix["GTM"]["unaffected"] = make_list("11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10","11.2.1HF15","10.1.0-10.2.4");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("11.0.0-11.6.0");
vmatrix["LC"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10","11.2.1HF15","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("11.0.0-11.6.0");
vmatrix["LTM"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10","11.2.1HF15","10.1.0-10.2.4");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("11.3.0-11.6.0");
vmatrix["PEM"]["unaffected"] = make_list("12.0.0","11.6.0HF6-11.6.1","11.5.3HF2-11.5.4","11.4.1HF10");

# PSM
vmatrix["PSM"] = make_array();
vmatrix["PSM"]["affected"  ] = make_list("11.0.0-11.4.1");
vmatrix["PSM"]["unaffected"] = make_list("11.4.1HF10","11.2.1HF15","10.1.0-10.2.4");
