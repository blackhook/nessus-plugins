...
# extracted from Fedora Security Advisory FEDORA-2021-d049f32a82
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-d049f32a82");

  script_name(english:"Fedora 33 : 1:openssl (2021-d049f32a82)");
...
FEDORA-2021-d049f32a82 advisory.

  - Upgrade to version 1.1.1.k (FEDORA-2021-d049f32a82)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-d049f32a82");
...
pkgs = [
    {'reference':'openssl-1.1.1k-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
