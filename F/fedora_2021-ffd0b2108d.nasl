...
# extracted from Fedora Security Advisory FEDORA-2021-ffd0b2108d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ffd0b2108d");

  script_name(english:"Fedora 32 : git (2021-ffd0b2108d)");
...
FEDORA-2021-ffd0b2108d advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ffd0b2108d");
...
pkgs = [
    {'reference':'git-2.26.3-2.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
