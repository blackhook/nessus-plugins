...
# extracted from Fedora Security Advisory 2014-12235.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12235");

  script_name(english:"Fedora 19 : mksh-50c-1.fc19 (2014-12235)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/140318.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?af930377"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"mksh-50c-1.fc19")) flag++;
