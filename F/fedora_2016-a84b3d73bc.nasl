...
# extracted from Fedora Security Advisory FEDORA-2016-a84b3d73bc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a84b3d73bc");

  script_name(english:"Fedora 24 : drupal7 (2016-a84b3d73bc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a84b3d73bc"
  );
  # https://www.drupal.org/SA-CORE-2016-002
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"drupal7-7.44-1.fc24")) flag++;
