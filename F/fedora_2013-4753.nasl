...
# extracted from Fedora Security Advisory 2013-4753.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-4753");

  script_name(english:"Fedora 19 : microcode_ctl-2.0-3.1.fc19 (2013-4753)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/106640.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bb88a0c5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"microcode_ctl-2.0-3.1.fc19")) flag++;
