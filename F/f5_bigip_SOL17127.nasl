...
# extracted from F5 Networks BIG-IP Solution K17127.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PHP vulnerability (K17127)");
...
gdImageCreateFromGif function. (CVE-2014-9709)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17127"
  );
  script_set_attribute(
    attribute:"solution",
    value:
