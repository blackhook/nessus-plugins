...
# extracted from Fedora Security Advisory FEDORA-2017-d80262b43f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d80262b43f");

  script_name(english:"Fedora 26 : mupdf (2017-d80262b43f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d80262b43f"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mupdf-1.10a-6.fc26")) flag++;
