...
# extracted from Fedora Security Advisory 2006-1013.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1013");

  script_name(english:"Fedora Core 5 : mailman-2.1.9-0.fc5.1 (2006-1013)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-October/000669.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9a0d89d6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC5", reference:"mailman-2.1.9-0.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mailman-debuginfo-2.1.9-0.fc5.1")) flag++;
