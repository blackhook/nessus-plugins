...
# extracted from Fedora Security Advisory 2005-091.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-091");

  script_name(english:"Fedora Core 2 : enscript-1.6.1-25.3 (2005-091)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-January/000646.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?67d48f47"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"enscript-1.6.1-25.3")) flag++;
if (rpm_check(release:"FC2", reference:"enscript-debuginfo-1.6.1-25.3")) flag++;
