...
# extracted from Fedora Security Advisory 2014-6380.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : openssh-6.4p1-4.fc20 (2014-6380)");
...
"  - environment variables with embedded '=' or '\0'
    ...
    - ssh-agent is now suspend-aware as it gets also
      CLOCK_BOOTTIME time

    - /etc/ssh/moduli is readable by all now

    - sshd-keygen.service depends on existence of
      /etc/ssh/ssh_host_ecdsa_key instead of
      /etc/ssh/ssh_host_dsa_key by default
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5fd30e0c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"openssh-6.4p1-4.fc20")) flag++;
