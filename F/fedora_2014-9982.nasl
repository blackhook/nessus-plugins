...
# extracted from Fedora Security Advisory 2014-9982.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9982");

  script_name(english:"Fedora 21 : net-snmp-5.7.2-23.fc21 (2014-9982)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/138437.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dac27f04"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"net-snmp-5.7.2-23.fc21")) flag++;
