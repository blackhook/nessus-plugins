...
# extracted from Fedora Security Advisory FEDORA-2016-0cadb1feae.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0cadb1feae");

  script_name(english:"Fedora 25 : irssi (2016-0cadb1feae)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0cadb1feae"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"irssi-0.8.20-1.fc25")) flag++;
