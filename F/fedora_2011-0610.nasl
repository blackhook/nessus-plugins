...
# extracted from Fedora Security Advisory 2011-0610.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0610");

  script_name(english:"Fedora 14 : proftpd-1.3.3d-1.fc14 (2011-0610)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=670170"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053540.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d3fcc9d2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"proftpd-1.3.3d-1.fc14")) flag++;
