...
# extracted from Fedora Security Advisory FEDORA-2018-31f5fe58f7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : redis (2018-31f5fe58f7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-31f5fe58f7"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"redis-4.0.10-1.fc28")) flag++;
