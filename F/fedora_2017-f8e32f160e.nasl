...
# extracted from Fedora Security Advisory FEDORA-2017-f8e32f160e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f8e32f160e");

  script_name(english:"Fedora 25 : cacti (2017-f8e32f160e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f8e32f160e"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"cacti-1.1.12-2.fc25")) flag++;
