...
# extracted from Fedora Security Advisory FEDORA-2019-1198005e1f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1198005e1f");

  script_name(english:"Fedora 29 : golang (2019-1198005e1f)");
...
"  - Rebase to go1.11.4
  ...
  - Security fix for CVE-2018-16875, CVE-2018-16874 and
    CVE-2018-16873
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1198005e1f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"golang-1.11.4-1.fc29")) flag++;
