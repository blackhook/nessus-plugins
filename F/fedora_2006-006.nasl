...
# extracted from Fedora Security Advisory 2006-006.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-006");

  script_name(english:"Fedora Core 4 : ethereal-0.10.14-1.FC4.1 (2006-006)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Dec 29 2005 Radek Vokal <rvokal at redhat.com>
    0.10.14-1.FC4.1
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-January/001711.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7149a03d"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"ethereal-0.10.14-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"ethereal-debuginfo-0.10.14-1.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"ethereal-gnome-0.10.14-1.FC4.1")) flag++;
