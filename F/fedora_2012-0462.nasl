...
# extracted from Fedora Security Advisory 2012-0462.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-0462");

  script_name(english:"Fedora 15 : emacs-23.3-8.fc15 (2012-0462)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-January/072285.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f944659"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"emacs-23.3-8.fc15")) flag++;
