...
# extracted from Fedora Security Advisory 2005-1045.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1045");

  script_name(english:"Fedora Core 3 : libungif-4.1.3-1.fc3.2 (2005-1045)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-November/001537.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74ed3ded"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"libungif-4.1.3-1.fc3.2")) flag++;
if (rpm_check(release:"FC3", reference:"libungif-debuginfo-4.1.3-1.fc3.2")) flag++;
if (rpm_check(release:"FC3", reference:"libungif-devel-4.1.3-1.fc3.2")) flag++;
if (rpm_check(release:"FC3", reference:"libungif-progs-4.1.3-1.fc3.2")) flag++;
