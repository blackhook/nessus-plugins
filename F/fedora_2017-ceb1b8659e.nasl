...
# extracted from Fedora Security Advisory FEDORA-2017-ceb1b8659e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ceb1b8659e");

  script_name(english:"Fedora 25 : openldap (2017-ceb1b8659e)");
...
"This update should make OpenLDAP up to date with latest NSS, notably :
  ...
  - make use of NSS global settings for `DEFAULTS'
    TLS_CIPHER_SUITE keyword 

Additionaly, slapd should start correctly after network is online,
now.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ceb1b8659e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"openldap-2.4.44-7.fc25")) flag++;
