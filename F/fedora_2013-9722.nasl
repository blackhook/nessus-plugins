...
# extracted from Fedora Security Advisory 2013-9722.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-9722");

  script_name(english:"Fedora 19 : LibRaw-0.14.8-2.fc19 (2013-9722)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/108696.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8be1bf57"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"LibRaw-0.14.8-2.fc19")) flag++;
