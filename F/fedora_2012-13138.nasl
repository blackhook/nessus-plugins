...
# extracted from Fedora Security Advisory 2012-13138.
#
...
if (description)
{
  ...
  script_bugtraq_id(55213);
  script_xref(name:"FEDORA", value:"2012-13138");

  script_name(english:"Fedora 16 : java-1.7.0-openjdk-1.7.0.6-2.3.1.fc16.2 (2012-13138)");
  ...
  script_set_attribute(
    ...
    value:
"This update is fixing recent important security impact. A Common
Vulnerability Scoring System (CVSS) base score, which gives a detailed
severity rating, is available from the CVE.
...
it to bypass Java sandbox restrictions. (CVE-2012-4681) Updated to
latest IcedTea7 2.3 based on latest build of OpenJDK u6.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?01bc4bcb"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/085935.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e61d516d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"java-1.7.0-openjdk-1.7.0.6-2.3.1.fc16.2")) flag++;
