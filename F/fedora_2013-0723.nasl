...
# extracted from Fedora Security Advisory 2013-0723.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-0723");

  script_name(english:"Fedora 16 : thunderbird-17.0.2-1.fc16 (2013-0723)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-February/097899.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c7c9d6f6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"thunderbird-17.0.2-1.fc16")) flag++;
