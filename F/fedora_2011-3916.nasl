...
# extracted from Fedora Security Advisory 2011-3916.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3916");

  script_name(english:"Fedora 13 : quagga-0.99.18-1.fc13 (2011-3916)");
  ...
  script_set_attribute(
    ...
    value:
"  - Wed Mar 23 2011 Jiri Skala <jskala at redhat.com> -
    0.99.18-1

    - fixes #689852 - CVE-2010-1674 CVE-2010-1675 quagga
      various flaws

    - fixes #689763 - updated to latest upstream version
      0.99.18
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/057831.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd7721f8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"quagga-0.99.18-1.fc13")) flag++;
