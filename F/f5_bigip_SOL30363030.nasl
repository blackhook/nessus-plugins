...
# extracted from F5 Networks BIG-IP Solution K30363030.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PHP vulnerability (K30363030)");
...
crash) via crafted serialized data. (CVE-2016-5771)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K30363030"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
