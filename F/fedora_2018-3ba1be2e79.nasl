...
# extracted from Fedora Security Advisory FEDORA-2018-3ba1be2e79.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-3ba1be2e79");

  script_name(english:"Fedora 27 : wavpack (2018-3ba1be2e79)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-3ba1be2e79"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"wavpack-5.1.0-7.fc27")) flag++;
