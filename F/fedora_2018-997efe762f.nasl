...
# extracted from Fedora Security Advisory FEDORA-2018-997efe762f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : seamonkey (2018-997efe762f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-997efe762f"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"seamonkey-2.49.4-1.fc28")) flag++;
