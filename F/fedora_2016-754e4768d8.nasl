...
# extracted from Fedora Security Advisory FEDORA-2016-754e4768d8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-754e4768d8");

  script_name(english:"Fedora 23 : kernel (2016-754e4768d8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-754e4768d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2016-754e4768d8");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC23", reference:"kernel-4.6.5-200.fc23")) flag++;
