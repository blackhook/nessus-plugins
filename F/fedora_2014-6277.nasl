...
# extracted from Fedora Security Advisory 2014-6277.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6277");

  script_name(english:"Fedora 20 : dpkg-1.16.14-1.fc20 (2014-6277)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133444.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7d01a6fc"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"dpkg-1.16.14-1.fc20")) flag++;
