...
# extracted from Fedora Security Advisory 2009-1526.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-1526");

  script_name(english:"Fedora 10 : squid-3.0.STABLE13-1.fc10 (2009-1526)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/020002.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eaa799f3"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"squid-3.0.STABLE13-1.fc10")) flag++;
