...
# extracted from Fedora Security Advisory FEDORA-2021-7f0e71beb1
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7f0e71beb1");

  script_name(english:"Fedora 34 : firefox (2021-7f0e71beb1)");
...
FEDORA-2021-7f0e71beb1 advisory.

  - - New upstream version (94.0) (FEDORA-2021-7f0e71beb1)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7f0e71beb1");
...
var pkgs = [
    {'reference':'firefox-94.0-1.fc34', 'release':'FC34', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
