...
# extracted from Fedora Security Advisory 2007-4471.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : mysql-5.0.45-6.fc7 (2007-4471)");
...
"  - Thu Dec 13 2007 Tom Lane <tgl at redhat.com> 5.0.45-6
  ...
  - Update License tag to match code.
    ...
    - Update to MySQL 5.0.45 Resolves: #246535

  - Move mysql_config's man page to base package Resolves:
    #245770

  - move my_print_defaults to base RPM, for consistency with
    Stacks packaging
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=424921"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-December/005937.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?adda7ac5"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"mysql-5.0.45-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"mysql-bench-5.0.45-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"mysql-debuginfo-5.0.45-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"mysql-devel-5.0.45-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"mysql-libs-5.0.45-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"mysql-server-5.0.45-6.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"mysql-test-5.0.45-6.fc7")) flag++;
