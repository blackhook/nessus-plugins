...
# extracted from Fedora Security Advisory FEDORA-2016-f3262abda6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : dosfstools (2016-f3262abda6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f3262abda6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"dosfstools-3.0.27-2.fc22")) flag++;
