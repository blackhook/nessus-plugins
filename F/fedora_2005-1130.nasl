...
# extracted from Fedora Security Advisory 2005-1130.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1130");

  script_name(english:"Fedora Core 3 : curl-7.12.3-5.fc3 (2005-1130)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001637.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c6484cf3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"curl-7.12.3-5.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"curl-debuginfo-7.12.3-5.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"curl-devel-7.12.3-5.fc3")) flag++;
