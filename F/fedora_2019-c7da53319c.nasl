...
# extracted from Fedora Security Advisory FEDORA-2019-c7da53319c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : haproxy (2019-c7da53319c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c7da53319c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"haproxy-1.8.17-1.fc29")) flag++;
