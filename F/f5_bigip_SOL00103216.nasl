...
a failover occurs."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K00103216"
  );
  script_set_attribute(
    attribute:"solution",
    value:
