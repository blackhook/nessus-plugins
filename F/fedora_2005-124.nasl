...
# extracted from Fedora Security Advisory 2005-124.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-124");

  script_name(english:"Fedora Core 3 : postgresql-7.4.7-1.FC3.2 (2005-124)");
...
"  - Mon Feb 07 2005 Tom Lane <tgl at redhat.com>
  ...
  - Update to PostgreSQL 7.4.7 (fixes CVE-2005-0227 and
    ...
    - Add restorecon to postgresql.init in order to restore
      database to correct SELinux context.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000681.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?049071dd"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"postgresql-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-contrib-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-debuginfo-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-devel-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-docs-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-jdbc-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-libs-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-pl-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-python-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-server-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-tcl-7.4.7-1.FC3.2")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-test-7.4.7-1.FC3.2")) flag++;
