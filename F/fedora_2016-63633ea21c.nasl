...
# extracted from Fedora Security Advisory FEDORA-2016-63633ea21c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-63633ea21c");

  script_name(english:"Fedora 23 : openvas-gsa / openvas-libraries / openvas-manager / openvas-scanner (2016-63633ea21c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-63633ea21c"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"openvas-gsa-6.0.11-3.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"openvas-libraries-8.0.8-2.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"openvas-manager-6.0.9-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"openvas-scanner-5.0.6-1.fc23")) flag++;
