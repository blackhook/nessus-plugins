...
# extracted from Fedora Security Advisory 2004-060.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-060");

  script_name(english:"Fedora Core 1 : mailman-2.1.4-1 (2004-060)");
...
Updated packages were made available in February 2004 however the
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-May/000120.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?564bb3fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", reference:"mailman-2.1.4-1")) flag++;
if (rpm_check(release:"FC1", reference:"mailman-debuginfo-2.1.4-1")) flag++;
