...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected mingw-libidn package."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mingw-libidn");
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-libidn-1.33-1.fc25")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mingw-libidn");
}
