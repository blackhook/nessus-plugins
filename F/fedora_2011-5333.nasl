...
# extracted from Fedora Security Advisory 2011-5333.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5333");

  script_name(english:"Fedora 15 : krb5-1.9-7.fc15 (2011-5333)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a56afebf"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"krb5-1.9-7.fc15")) flag++;
