...
# extracted from Fedora Security Advisory FEDORA-2019-e4c45e113c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : nspr / nss (2019-e4c45e113c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e4c45e113c"
  );
  # https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.47_release_notes
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC29", reference:"nspr-4.23.0-1.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"nss-3.47.0-2.fc29")) flag++;
