...
# extracted from Fedora Security Advisory 2010-10124.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : drupal-views-6.x.2.11-1.fc12 (2010-10124)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/043097.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c9c41a2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"drupal-views-6.x.2.11-1.fc12")) flag++;
