...
"The version of F5 Networks BIG-IP installed on the remote host is prior to 14.1.4.4 / 16.1.0. It is, therefore, affected
by a vulnerability as referenced in the K07944249 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K07944249");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.0','16.0.0-16.0.1','15.1.0-15.1.3','14.1.0-14.1.4','13.1.0-13.1.4','12.1.0-12.1.6'
    ],
    'unaffected': [
      '16.1.0','14.1.4.4'
    ],
