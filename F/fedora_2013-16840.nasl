...
# extracted from Fedora Security Advisory 2013-16840.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16840");

  script_name(english:"Fedora 20 : python-django14-1.4.8-1.fc20 (2013-16840)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/116758.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2b9948be"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-django14-1.4.8-1.fc20")) flag++;
