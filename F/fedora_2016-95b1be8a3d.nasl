...
# extracted from Fedora Security Advisory FEDORA-2016-95b1be8a3d.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9449");
  script_xref(name:"FEDORA", value:"2016-95b1be8a3d");

  script_name(english:"Fedora 25 : drupal7 (2016-95b1be8a3d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-95b1be8a3d"
  );
  # https://www.drupal.org/SA-CORE-2016-005
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"drupal7-7.52-1.fc25")) flag++;
