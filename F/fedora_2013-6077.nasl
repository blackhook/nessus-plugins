...
# extracted from Fedora Security Advisory 2013-6077.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-6077");

  script_name(english:"Fedora 19 : php-twig-Twig-1.12.3-1.fc19 (2013-6077)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-April/103331.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3b1a6324"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"php-twig-Twig-1.12.3-1.fc19")) flag++;
