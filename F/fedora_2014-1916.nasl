...
# extracted from Fedora Security Advisory 2014-1916.
#
...
if (description)
{
  ...
  script_bugtraq_id(65035);
  script_xref(name:"FEDORA", value:"2014-1916");

  script_name(english:"Fedora 19 : chrony-1.29.1-1.fc19 (2014-1916)");
...
"This update fixes the following security vulnerability :
  ...
  - Modify chronyc protocol to prevent amplification attacks
    (CVE-2014-0021) (incompatible with previous protocol
    version, chronyc supports both)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1054790"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128753.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9f9d037"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"chrony-1.29.1-1.fc19")) flag++;
