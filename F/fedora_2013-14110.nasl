...
# extracted from Fedora Security Advisory 2013-14110.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-14110");

  script_name(english:"Fedora 19 : spice-0.12.4-1.fc19 (2013-14110)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4e21469a"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"spice-0.12.4-1.fc19")) flag++;
