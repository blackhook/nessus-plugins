...
# extracted from Fedora Security Advisory FEDORA-2020-227a4c0530.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : kernel (2020-227a4c0530)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-227a4c0530"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2020-227a4c0530");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC31", reference:"kernel-5.5.7-200.fc31")) flag++;
