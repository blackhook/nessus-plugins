...
# extracted from Fedora Security Advisory 2010-4114.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : maniadrive-1.2-18.fc11 / php-5.2.13-1.fc11 (2010-4114)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=569788"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/038276.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?370b2233"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/038277.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e0274dfa"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"maniadrive-1.2-18.fc11")) flag++;
if (rpm_check(release:"FC11", reference:"php-5.2.13-1.fc11")) flag++;
