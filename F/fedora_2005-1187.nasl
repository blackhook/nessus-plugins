...
# extracted from Fedora Security Advisory 2005-1187.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1187");

  script_name(english:"Fedora Core 4 : fetchmail-6.2.5.5-1.fc4 (2005-1187)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001700.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2f0972ec"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"fetchmail-6.2.5.5-1.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"fetchmail-debuginfo-6.2.5.5-1.fc4")) flag++;
