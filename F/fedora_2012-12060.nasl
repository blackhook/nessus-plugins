...
# extracted from Fedora Security Advisory 2012-12060.
#
...
if (description)
{
  ...
  script_bugtraq_id(55057, 55068);
  script_xref(name:"FEDORA", value:"2012-12060");

  script_name(english:"Fedora 16 : phpMyAdmin-3.5.2.2-1.fc16 (2012-12060)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-August/085749.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?63e7f64c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"phpMyAdmin-3.5.2.2-1.fc16")) flag++;
