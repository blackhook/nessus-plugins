...
# extracted from Fedora Security Advisory FEDORA-2020-b48e3c177e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : thunderbird-enigmail (2020-b48e3c177e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b48e3c177e"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"thunderbird-enigmail-2.1.5-1.fc31", allowmaj:TRUE)) flag++;
