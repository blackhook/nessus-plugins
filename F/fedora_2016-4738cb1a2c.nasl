...
# extracted from Fedora Security Advisory FEDORA-2016-4738cb1a2c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-4738cb1a2c");

  script_name(english:"Fedora 24 : mingw-gnutls (2016-4738cb1a2c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-4738cb1a2c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mingw-gnutls-3.4.14-1.fc24")) flag++;
