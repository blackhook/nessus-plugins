...
# extracted from Fedora Security Advisory 2011-12322.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : audacious-plugins-3.0.2-2.fc16 (2011-12322)");
  ...
  script_set_attribute(
    ...
    value:
"Merge changes from pre-3.0.3 git, such as using the system's
libmodplug library.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/066542.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b58f869"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"audacious-plugins-3.0.2-2.fc16")) flag++;
