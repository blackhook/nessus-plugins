...
# extracted from Fedora Security Advisory FEDORA-2017-0188f21212.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0188f21212");

  script_name(english:"Fedora 25 : postgresql (2017-0188f21212)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0188f21212"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"postgresql-9.5.10-1.fc25")) flag++;
