...
# extracted from Fedora Security Advisory 2013-22352.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-22352");

  script_name(english:"Fedora 20 : drupal6-6.29-1.fc20 (2013-22352)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123811.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2b478238"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"drupal6-6.29-1.fc20")) flag++;
