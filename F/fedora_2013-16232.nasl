...
# extracted from Fedora Security Advisory 2013-16232.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16232");

  script_name(english:"Fedora 19 : roundcubemail-0.9.4-1.fc19 (2013-16232)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115815.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc577e07"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"roundcubemail-0.9.4-1.fc19")) flag++;
