...
# extracted from Fedora Security Advisory FEDORA-2016-19c34099d3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-19c34099d3");

  script_name(english:"Fedora 22 : libarchive (2016-19c34099d3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-19c34099d3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"libarchive-3.1.2-14.fc22")) flag++;
