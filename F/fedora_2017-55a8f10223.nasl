...
# extracted from Fedora Security Advisory FEDORA-2017-55a8f10223.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-55a8f10223");

  script_name(english:"Fedora 25 : libarchive (2017-55a8f10223)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-55a8f10223"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libarchive-3.2.2-2.fc25")) flag++;
