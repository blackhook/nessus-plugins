...
# extracted from Fedora Security Advisory 2014-11896.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11896");

  script_name(english:"Fedora 21 : check-mk-1.2.4p5-2.fc21 (2014-11896)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/139901.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2aaa1bd1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"check-mk-1.2.4p5-2.fc21")) flag++;
