...
# extracted from Fedora Security Advisory 2011-5991.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5991");

  script_name(english:"Fedora 15 : mingw32-libtiff-3.9.5-1.fc15 (2011-5991)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/059201.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?72cea367"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"mingw32-libtiff-3.9.5-1.fc15")) flag++;
