...
# extracted from Fedora Security Advisory 2014-0934.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-0934");

  script_name(english:"Fedora 19 : memcached-1.4.17-1.fc19 (2014-0934)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/127640.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?394c78e3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"memcached-1.4.17-1.fc19")) flag++;
