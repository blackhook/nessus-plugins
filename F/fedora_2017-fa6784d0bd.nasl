...
# extracted from Fedora Security Advisory FEDORA-2017-fa6784d0bd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : libsndfile (2017-fa6784d0bd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-fa6784d0bd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libsndfile-1.0.28-6.fc25")) flag++;
