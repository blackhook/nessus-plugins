...
# extracted from Fedora Security Advisory 2015-12921.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : pcre-8.37-3.fc22 (2015-12921)");
  ...
  script_set_attribute(
    ...
    value:
"This release fixes buffer overflows when compiling certain
expressions.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?beb9f2f0"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"pcre-8.37-3.fc22")) flag++;
