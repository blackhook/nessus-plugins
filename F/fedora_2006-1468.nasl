...
# extracted from Fedora Security Advisory 2006-1468.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1468");

  script_name(english:"Fedora Core 6 : gdm-2.16.4-1.fc6 (2006-1468)");
...
problem where a user can enter strings like '%08x' into the gdmchooser
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-December/001132.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ef343349"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC6", reference:"gdm-2.16.4-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"gdm-debuginfo-2.16.4-1.fc6")) flag++;
