...
# extracted from Fedora Security Advisory 2013-22026.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-22026");

  script_name(english:"Fedora 20 : nginx-1.4.4-1.fc20 (2013-22026)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://nginx.org/en/CHANGES-1.4"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1032266"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123784.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80e90f48"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"nginx-1.4.4-1.fc20")) flag++;
