...
# extracted from Fedora Security Advisory FEDORA-2017-63ff51c0dc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : libwpd (2017-63ff51c0dc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-63ff51c0dc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libwpd-0.10.2-1.fc26")) flag++;
