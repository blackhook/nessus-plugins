...
# extracted from F5 Networks BIG-IP Solution K17309.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K17309)");
...
different vulnerability than CVE-2015-5364. (CVE-2015-5366)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17309"
  );
  script_set_attribute(
    attribute:"solution",
    value:
