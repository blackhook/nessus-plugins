...
# extracted from Fedora Security Advisory 2014-7603.
#
...
if (description)
{
  ...
  script_bugtraq_id(68075);
  script_xref(name:"FEDORA", value:"2014-7603");

  script_name(english:"Fedora 19 : zabbix-2.0.12-3.fc19 (2014-7603)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1110496"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134909.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d0e10e84"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.zabbix.com/browse/ZBX-8151"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"zabbix-2.0.12-3.fc19")) flag++;
