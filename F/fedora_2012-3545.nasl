...
# extracted from Fedora Security Advisory 2012-3545.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-3545");

  script_name(english:"Fedora 16 : libpng10-1.0.58-1.fc16 (2012-3545)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d3a0ab1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"libpng10-1.0.58-1.fc16")) flag++;
