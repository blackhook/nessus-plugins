...
# extracted from Fedora Security Advisory FEDORA-2021-7cd0c1fb70
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7cd0c1fb70");

  script_name(english:"Fedora 32 : tor (2021-7cd0c1fb70)");
...
FEDORA-2021-7cd0c1fb70 advisory.

  - update to latest upstream release  (with security fixes!) (FEDORA-2021-7cd0c1fb70)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7cd0c1fb70");
...
pkgs = [
    {'reference':'tor-0.4.5.7-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
