...
# extracted from Fedora Security Advisory 2010-13589.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : kdegraphics-4.5.0-2.fc14 (2010-13589)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.kde.org/info/security/advisory-20100825-1.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=627289"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-August/046448.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c7e890a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"kdegraphics-4.5.0-2.fc14")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "kdegraphics");
}
