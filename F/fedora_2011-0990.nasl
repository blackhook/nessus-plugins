...
# extracted from Fedora Security Advisory 2011-0990.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : postgresql-8.4.7-1.fc14 (2011-0990)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9453ad10"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"postgresql-8.4.7-1.fc14")) flag++;
