...
# extracted from Fedora Security Advisory 2011-7684.
#
...
if (description)
{
  ...
  script_bugtraq_id(47943, 47945);
  script_xref(name:"FEDORA", value:"2011-7684");

  script_name(english:"Fedora 15 : phpMyAdmin-3.4.1-1.fc15 (2011-7684)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061166.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?90709ae2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"phpMyAdmin-3.4.1-1.fc15")) flag++;
