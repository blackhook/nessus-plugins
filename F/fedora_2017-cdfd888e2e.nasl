...
# extracted from Fedora Security Advisory FEDORA-2017-cdfd888e2e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : git (2017-cdfd888e2e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-cdfd888e2e"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"git-2.9.5-3.fc25")) flag++;
