...
# extracted from Fedora Security Advisory 2008-10038.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2008-10038");

  script_name(english:"Fedora 10 : libxml2-2.7.2-2.fc10 (2008-10038)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-November/016551.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b3494e01"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"libxml2-2.7.2-2.fc10")) flag++;
