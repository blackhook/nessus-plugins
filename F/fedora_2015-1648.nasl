...
# extracted from Fedora Security Advisory 2015-1648.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1648");

  script_name(english:"Fedora 20 : lcms-1.19-13.fc20 (2015-1648)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=992975"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155913.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3076aaa8"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"lcms-1.19-13.fc20")) flag++;
