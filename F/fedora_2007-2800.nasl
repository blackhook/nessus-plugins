...
# extracted from Fedora Security Advisory 2007-2800.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : tar-1.17-4.fc8 (2007-2800)");
...
"  - Wed Oct 24 2007 Radek Brich <rbrich at redhat.com>
    ...
    - upstream patch for CVE-2007-4476 (tar stack crashing
      in safer_name_suffix)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004509.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b0811cb7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"tar-1.17-4.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"tar-debuginfo-1.17-4.fc8")) flag++;
