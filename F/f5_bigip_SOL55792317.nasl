...
# extracted from F5 Networks BIG-IP Solution K55792317.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9250");

  script_name(english:"F5 Networks BIG-IP : BIG-IP management vulnerability (K55792317)");
  ...
  script_set_attribute(
    ...
    value:
"In F5 BIG-IP 11.2.1, 11.4.0 through 11.6.1, and 12.0.0 through 12.1.2,
an unauthenticated user with access to the control plane may be able
to delete arbitrary files through an undisclosed mechanism.
(CVE-2016-9250)

Impact

An unauthenticated user with access to the management control plane
may be able to delete arbitrary files through an undisclosed
mechanism. There is control plane exposure for the web Configuration
utility, iControl REST, and iControl SOAP. There is no data plane
exposure."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K55792317"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["APM"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.1HF2","11.5.4HF3");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0-12.1.2","11.4.0-11.6.1","11.2.1");
vmatrix["ASM"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.1HF2","11.5.4HF3");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0-12.1.2","11.4.0-11.6.1","11.2.1");
vmatrix["AVR"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.1HF2","11.5.4HF3");
...
vmatrix["LC"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.1HF2","11.5.4HF3");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0-12.1.2","11.4.0-11.6.1","11.2.1");
vmatrix["LTM"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.1HF2","11.5.4HF3");
