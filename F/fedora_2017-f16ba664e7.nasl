...
# extracted from Fedora Security Advisory FEDORA-2017-f16ba664e7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f16ba664e7");

  script_name(english:"Fedora 24 : ruby (2017-f16ba664e7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f16ba664e7"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"ruby-2.3.3-62.fc24")) flag++;
