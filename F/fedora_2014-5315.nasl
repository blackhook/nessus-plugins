...
# extracted from Fedora Security Advisory 2014-5315.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5315");

  script_name(english:"Fedora 20 : rsync-3.1.0-3.fc20 (2014-5315)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1087841"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/131910.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?912603d5"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"rsync-3.1.0-3.fc20")) flag++;
