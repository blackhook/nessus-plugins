...
# extracted from Fedora Security Advisory 2015-7079.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7079");

  script_name(english:"Fedora 20 : pdns-recursor-3.7.2-1.fc20 (2015-7079)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e9dbcf1e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"pdns-recursor-3.7.2-1.fc20")) flag++;
