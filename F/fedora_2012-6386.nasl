...
# extracted from Fedora Security Advisory 2012-6386.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-6386");

  script_name(english:"Fedora 16 : kernel-3.3.2-6.fc16 (2012-6386)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/079034.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?17eb43d7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"kernel-3.3.2-6.fc16")) flag++;
