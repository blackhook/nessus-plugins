...
# extracted from Fedora Security Advisory 2015-3880.
#
...
if (description)
{
  ...
  script_bugtraq_id(66358, 70011, 70378);
  script_xref(name:"FEDORA", value:"2015-3880");

  script_name(english:"Fedora 20 : php-ZendFramework2-2.3.7-1.fc20 (2015-3880)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152789.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?25769157"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"php-ZendFramework2-2.3.7-1.fc20")) flag++;
