...
# extracted from Fedora Security Advisory 2013-3546.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-3546");

  script_name(english:"Fedora 18 : icu-49.1.1-8.fc18 (2013-3546)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-March/100277.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8bc0e28f"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"icu-49.1.1-8.fc18")) flag++;
