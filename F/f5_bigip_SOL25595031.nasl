...
BIG-IP DNS or BIG-IP GTM andat least one DNS zone."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K25595031"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["GTM"]["affected"  ] = make_list("15.0.0-15.1.0","14.1.0-14.1.3","13.1.0-13.1.3","12.1.0-12.1.5","11.6.1-11.6.5");
vmatrix["GTM"]["unaffected"] = make_list("16.0.0","15.1.1","14.1.3.1","13.1.3.5","12.1.5.3","11.6.5.3");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("15.0.0-15.1.0","14.1.0-14.1.3","13.1.0-13.1.3","12.1.0-12.1.5","11.6.1-11.6.5");
vmatrix["LC"]["unaffected"] = make_list("16.0.0","15.1.1","14.1.3.1","13.1.3.5","12.1.5.3","11.6.5.3");
...
else
{
  ...
  else audit(AUDIT_HOST_NOT, "running any of the affected modules GTM / LC");
}
