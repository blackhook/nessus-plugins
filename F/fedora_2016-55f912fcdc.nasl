...
# extracted from Fedora Security Advisory FEDORA-2016-55f912fcdc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-55f912fcdc");

  script_name(english:"Fedora 24 : seamonkey (2016-55f912fcdc)");
...
No more includes Chatzilla and DOM Inspector in the package -- install
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-55f912fcdc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"seamonkey-2.46-1.fc24")) flag++;
