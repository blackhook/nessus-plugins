...
# extracted from Fedora Security Advisory FEDORA-2017-97eb475d93.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-97eb475d93");

  script_name(english:"Fedora 25 : cvs (2017-97eb475d93)");
  ...
  script_set_attribute(
    ...
    value:
"This relase fixes CVE-2017-12836 vulerbaility (command injection via
malicious SSH URL).
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-97eb475d93"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"cvs-1.11.23-41.fc25")) flag++;
