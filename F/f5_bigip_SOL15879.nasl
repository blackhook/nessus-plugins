...
# extracted from F5 Networks BIG-IP Solution SOL15879.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : SOAP parser vulnerability (SOL15879)");
  ...
  script_set_attribute(
    ...
    value:
"The SOAP parser in PHP before 5.3.22 and 5.4.x before 5.4.12 allows
...
soap_xmlParseFile and soap_xmlParseMemory functions."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15879"
  );
  script_set_attribute(
    attribute:"solution",
    value:
