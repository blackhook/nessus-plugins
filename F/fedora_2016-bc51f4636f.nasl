...
# extracted from Fedora Security Advisory FEDORA-2016-bc51f4636f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : libgit2 (2016-bc51f4636f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-bc51f4636f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libgit2-0.24.2-2.fc24")) flag++;
