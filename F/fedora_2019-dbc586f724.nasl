...
# extracted from Fedora Security Advisory FEDORA-2019-dbc586f724.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : spamassassin (2019-dbc586f724)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-dbc586f724"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"spamassassin-3.4.3-1.fc31")) flag++;
