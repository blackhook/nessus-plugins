...
# extracted from Fedora Security Advisory 2012-19203.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-19203");

  script_name(english:"Fedora 17 : squashfs-tools-4.2-5.fc17 (2012-19203)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/094628.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2479b470"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"squashfs-tools-4.2-5.fc17")) flag++;
