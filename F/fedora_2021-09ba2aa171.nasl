...
# extracted from Fedora Security Advisory FEDORA-2021-09ba2aa171
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-09ba2aa171");

  script_name(english:"Fedora 34 : firefox (2021-09ba2aa171)");
...
FEDORA-2021-09ba2aa171 advisory.

  - * New upstream version (92.0)  (FEDORA-2021-09ba2aa171)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-09ba2aa171");
...
var pkgs = [
    {'reference':'firefox-92.0-2.fc34', 'release':'FC34', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
