...
# extracted from Fedora Security Advisory 2004-271.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-271");

  script_name(english:"Fedora Core 2 : qt-3.3.3-0.1 (2004-271)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-August/000269.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?688ca3e6"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"qt-3.3.3-0.1")) flag++;
if (rpm_check(release:"FC2", reference:"qt-MySQL-3.3.3-0.1")) flag++;
if (rpm_check(release:"FC2", reference:"qt-ODBC-3.3.3-0.1")) flag++;
if (rpm_check(release:"FC2", reference:"qt-PostgreSQL-3.3.3-0.1")) flag++;
if (rpm_check(release:"FC2", reference:"qt-debuginfo-3.3.3-0.1")) flag++;
if (rpm_check(release:"FC2", reference:"qt-designer-3.3.3-0.1")) flag++;
if (rpm_check(release:"FC2", reference:"qt-devel-3.3.3-0.1")) flag++;
