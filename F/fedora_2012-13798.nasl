...
# extracted from Fedora Security Advisory 2012-13798.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13798");

  script_name(english:"Fedora 18 : trytond-2.4.2-1.fc18 (2012-13798)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086843.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c187043b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"trytond-2.4.2-1.fc18")) flag++;
