...
# extracted from Fedora Security Advisory 2005-810.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-810");

  script_name(english:"Fedora Core 4 : php-5.0.4-10.4 (2005-810)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001302.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f10537b7"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"php-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-bcmath-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-dba-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-debuginfo-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-devel-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-gd-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-imap-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-ldap-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-mbstring-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-mysql-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-ncurses-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-odbc-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-pear-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-pgsql-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-snmp-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-soap-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-xml-5.0.4-10.4")) flag++;
if (rpm_check(release:"FC4", reference:"php-xmlrpc-5.0.4-10.4")) flag++;
