...
# extracted from Fedora Security Advisory FEDORA-2020-edcc40be4b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : p11-kit (2020-edcc40be4b)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes 3 security issues in the RPC protocol which p11-kit
server/remote commands use :
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-edcc40be4b"
  );
  # https://github.com/p11-glue/p11-kit/security/advisories/GHSA-q4r3-hm6m-mvc2
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4d222c38"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:p11-kit");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"p11-kit-0.23.22-1.fc32")) flag++;
