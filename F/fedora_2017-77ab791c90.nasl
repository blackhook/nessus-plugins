...
# extracted from Fedora Security Advisory FEDORA-2017-77ab791c90.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-77ab791c90");

  script_name(english:"Fedora 25 : ark (2017-77ab791c90)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-77ab791c90"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ark-16.08.3-2.fc25")) flag++;
