...
# extracted from Fedora Security Advisory 2009-11374.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11374");

  script_name(english:"Fedora 11 : tomcat6-6.0.20-1.fc11 (2009-11374)");
  ...
  script_set_attribute(
    ...
    value:
"Fix for CVE-2008-5515, CVE-2009-0033, CVE-2009-0580, CVE-2009-0781,
and CVE-2009-0783.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=533903"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/031652.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cedc61af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"tomcat6-6.0.20-1.fc11")) flag++;
