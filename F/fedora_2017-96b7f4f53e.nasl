...
# extracted from Fedora Security Advisory FEDORA-2017-96b7f4f53e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-96b7f4f53e");

  script_name(english:"Fedora 25 : bind99 (2017-96b7f4f53e)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2017-3135 (unaffected), fixes regression made by
CVE-2016-8864
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-96b7f4f53e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"bind99-9.9.9-4.P6.fc25")) flag++;
