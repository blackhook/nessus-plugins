...
# extracted from Fedora Security Advisory 2009-1769.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-1769");

  script_name(english:"Fedora 10 : net-snmp-5.4.2.1-3.fc10 (2009-1769)");
  ...
  script_set_attribute(
    ...
    value:
"  - Mon Feb 16 2009 Jan Safranek <jsafranek at redhat.com>
    5.4.2.1-3

    - fix tcp_wrappers integration (CVE-2008-6123)

    - Mon Dec 1 2008 Jan Safranek <jsafranek at redhat.com>
      5.4.2.1-2
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=485211"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/020404.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ccb5d0ed"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"net-snmp-5.4.2.1-3.fc10")) flag++;
