...
# extracted from Fedora Security Advisory 2013-12653.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12653");

  script_name(english:"Fedora 18 : file-roller-3.6.4-1.fc18 (2013-12653)");
...
arbitrary files in any location, writable by the user executing the
extraction, outside the current working directory. This behaviour is
triggered when the option 'Keep directory structure' is selected from
the application 'Extract' dialog.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=981471"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/112439.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?53dfd954"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected file-roller package."
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"file-roller-3.6.4-1.fc18")) flag++;
