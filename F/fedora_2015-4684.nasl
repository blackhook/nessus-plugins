...
# extracted from Fedora Security Advisory 2015-4684.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4684");

  script_name(english:"Fedora 21 : glpi-0.84.8-4.fc21 (2015-4684)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2e9f785d"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"glpi-0.84.8-4.fc21")) flag++;
