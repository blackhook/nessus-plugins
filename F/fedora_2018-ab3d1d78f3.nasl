...
# extracted from Fedora Security Advisory FEDORA-2018-ab3d1d78f3.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-1000031", "CVE-2018-1000035");
  script_xref(name:"FEDORA", value:"2018-ab3d1d78f3");

  script_name(english:"Fedora 27 : unzip (2018-ab3d1d78f3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ab3d1d78f3"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"unzip-6.0-37.fc27")) flag++;
