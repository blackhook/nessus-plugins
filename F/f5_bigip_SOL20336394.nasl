...
vulnerability."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K20336394"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AM"]["unaffected"] = make_list("16.0.0","15.1.0.2","15.0.1.3","14.1.2.5","13.1.3.4","12.1.5.2","11.6.5.2");

# WAM
vmatrix["WAM"] = make_array();
vmatrix["WAM"]["affected"  ] = make_list("15.0.0-15.0.1","14.0.0-14.1.2","13.1.0-13.1.3","12.1.0-12.1.5","11.5.2-11.6.5");
vmatrix["WAM"]["unaffected"] = make_list("16.0.0","15.1.0.2","15.0.1.3","14.1.2.5","13.1.3.4","12.1.5.2","11.6.5.2");
