...
# extracted from Fedora Security Advisory 2015-11278.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-11278");

  script_name(english:"Fedora 21 : drupal7-views_bulk_operations-3.3-1.fc21 (2015-11278)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/162178.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0bc78a24"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC21", reference:"drupal7-views_bulk_operations-3.3-1.fc21")) flag++;
