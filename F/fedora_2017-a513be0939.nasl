...
# extracted from Fedora Security Advisory FEDORA-2017-a513be0939.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a513be0939");

  script_name(english:"Fedora 24 : cacti (2017-a513be0939)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a513be0939"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"cacti-1.0.4-1.fc24")) flag++;
