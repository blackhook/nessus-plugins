...
# extracted from Fedora Security Advisory FEDORA-2018-5fb03f38a0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-5fb03f38a0");

  script_name(english:"Fedora 28 : asterisk (2018-5fb03f38a0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5fb03f38a0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"asterisk-15.3.0-1.fc28")) flag++;
