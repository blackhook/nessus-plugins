...
# extracted from Fedora Security Advisory FEDORA-2016-d9dbd6d339.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-d9dbd6d339");

  script_name(english:"Fedora 23 : openslp (2016-d9dbd6d339)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-4912
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-d9dbd6d339"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"openslp-2.0.0-8.fc23")) flag++;
