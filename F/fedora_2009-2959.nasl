...
# extracted from Fedora Security Advisory 2009-2959.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2959");

  script_name(english:"Fedora 10 : postgresql-8.3.7-1.fc10 (2009-2959)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021636.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1e193c1f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"postgresql-8.3.7-1.fc10")) flag++;
