...
# extracted from Fedora Security Advisory FEDORA-2016-610fe5f5f8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-610fe5f5f8");

  script_name(english:"Fedora 23 : libidn (2016-610fe5f5f8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-610fe5f5f8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"libidn-1.33-1.fc23")) flag++;
