...
# extracted from Fedora Security Advisory FEDORA-2016-95f1569a73.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-95f1569a73");

  script_name(english:"Fedora 22 : drupal7 (2016-95f1569a73)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-95f1569a73"
  );
  # https://www.drupal.org/SA-CORE-2016-002
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"drupal7-7.44-1.fc22")) flag++;
