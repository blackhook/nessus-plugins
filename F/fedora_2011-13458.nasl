...
# extracted from Fedora Security Advisory 2011-13458.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-13458");

  script_name(english:"Fedora 14 : php-5.3.8-3.fc14 (2011-13458)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/067423.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?943cecfb"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"php-5.3.8-3.fc14")) flag++;
