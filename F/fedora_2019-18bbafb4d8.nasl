...
# extracted from Fedora Security Advisory FEDORA-2019-18bbafb4d8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : drupal7-views (2019-18bbafb4d8)");
...
- https://www.drupal.org/project/views/releases/7.x-3.21
  ...
  - [Less critical - Cross site scripting -
    SA-CONTRIB-2019-036](https://www.drupal.org/sa-contrib-2
    019-036)

  - [Moderately critical - Information disclosure -
    SA-CONTRIB-2019-035](https://www.drupal.org/sa-contrib-2
    019-035)

  - [Moderately critical - Information Disclosure -
    SA-CONTRIB-2019-034](https://www.drupal.org/sa-contrib-2
    019-034)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-18bbafb4d8"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/project/views/releases/7.x-3.19"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"drupal7-views-3.23-1.fc30")) flag++;
