...
# extracted from Fedora Security Advisory 2010-11361.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2010-0654", "CVE-2010-1121", "CVE-2010-1196", "CVE-2010-1199", "CVE-2010-1200", "CVE-2010-1201", "CVE-2010-1202", "CVE-2010-1205", "CVE-2010-1211", "CVE-2010-1213", "CVE-2010-2752", "CVE-2010-2753", "CVE-2010-2754");
  script_xref(name:"FEDORA", value:"2010-11361");

  script_name(english:"Fedora 12 : sunbird-1.0-0.23.20090916hg.fc12 / thunderbird-3.0.6-1.fc12 (2010-11361)");
  ...
  script_set_attribute(
    ...
    value:
"Update to new upstream Thunderbird version 3.0.6, fixing multiple
security issues detailed in the upstream advisories:
http://www.mozilla.org/security
/known-vulnerabilities/thunderbird30.html#thunderbird3.0.5
http://www.mozilla.org/security/known-
vulnerabilities/thunderbird30.html#thunderbird3.0.6 Update also
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=608108"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-July/044464.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7119ac6e"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-July/044465.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ae860226"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"sunbird-1.0-0.23.20090916hg.fc12")) flag++;
if (rpm_check(release:"FC12", reference:"thunderbird-3.0.6-1.fc12")) flag++;
