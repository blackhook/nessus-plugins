...
# extracted from Fedora Security Advisory 2014-1999.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1999");

  script_name(english:"Fedora 19 : pidgin-2.10.9-1.fc19 (2014-1999)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128265.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80cb9c23"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"pidgin-2.10.9-1.fc19")) flag++;
