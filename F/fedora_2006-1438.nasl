...
# extracted from Fedora Security Advisory 2006-1438.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1438");

  script_name(english:"Fedora Core 6 : evince-0.6.0-5.fc6 (2006-1438)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-December/001087.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60d5534e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC6", reference:"evince-0.6.0-5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"evince-debuginfo-0.6.0-5.fc6")) flag++;
