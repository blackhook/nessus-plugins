...
# extracted from Fedora Security Advisory FEDORA-2017-9a452dc893.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : moodle (2017-9a452dc893)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9a452dc893"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"moodle-3.2.5-1.fc26")) flag++;
