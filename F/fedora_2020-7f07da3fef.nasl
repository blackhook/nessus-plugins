...
# extracted from Fedora Security Advisory FEDORA-2020-7f07da3fef.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-7f07da3fef");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 32 : ant (2020-7f07da3fef)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7f07da3fef"
  );
...
flag = 0;
if (rpm_check(release:"FC32", reference:"ant-1.10.8-1.fc32")) flag++;
