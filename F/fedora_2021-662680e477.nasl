...
# extracted from Fedora Security Advisory FEDORA-2021-662680e477
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-662680e477");

  script_name(english:"Fedora 32 : rpm (2021-662680e477)");
...
FEDORA-2021-662680e477 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-662680e477");
...
pkgs = [
    {'reference':'rpm-4.15.1.1-1.fc32.1', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
