...
# extracted from Fedora Security Advisory 2016-e9bba2bb01.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e9bba2bb01");

  script_name(english:"Fedora 23 : qemu-2.4.1-5.fc23 (2016-e9bba2bb01)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f22b7de4"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"qemu-2.4.1-5.fc23")) flag++;
