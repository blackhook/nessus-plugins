...
# extracted from F5 Networks BIG-IP Solution SOL16875.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : file vulnerability (SOL16875)");
...
of service (crash) via a crafted Composite Document File (CDF) file
that triggers (1) an out-of-bounds read or (2) an invalid pointer
dereference."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16875"
  );
  script_set_attribute(
    attribute:"solution",
    value:
