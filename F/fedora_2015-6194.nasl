...
# extracted from Fedora Security Advisory 2015-6194.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6194");

  script_name(english:"Fedora 22 : cherokee-1.2.103-6.fc22 (2015-6194)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e3eb2f92"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"cherokee-1.2.103-6.fc22")) flag++;
