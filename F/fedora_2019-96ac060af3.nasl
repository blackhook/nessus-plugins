...
# extracted from Fedora Security Advisory FEDORA-2019-96ac060af3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 1:java-11-openjdk (2019-96ac060af3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-96ac060af3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"java-11-openjdk-11.0.2.7-0.fc28", epoch:"1")) flag++;
