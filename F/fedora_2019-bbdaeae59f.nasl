...
# extracted from Fedora Security Advisory FEDORA-2019-bbdaeae59f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : freeradius (2019-bbdaeae59f)");
  ...
  script_set_attribute(
    ...
    value:
"Update to FreeRADIUS Server 3.0.19-1
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-bbdaeae59f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"freeradius-3.0.19-1.fc28")) flag++;
