...
# extracted from Fedora Security Advisory 2011-8816.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-8816");

  script_name(english:"Fedora 14 : dokuwiki-0-0.8.20110525.a.fc14 (2011-8816)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=717146"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-July/062389.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f04e3cc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"dokuwiki-0-0.8.20110525.a.fc14")) flag++;
