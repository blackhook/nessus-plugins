...
# extracted from Fedora Security Advisory 2014-17243.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : mailx-12.5-14.fc21 (2014-17243)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1162783"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/147445.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f4678aad"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:mailx");
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mailx-12.5-14.fc21")) flag++;
