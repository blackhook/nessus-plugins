...
# extracted from Fedora Security Advisory 2005-140.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-140");

  script_name(english:"Fedora Core 3 : mod_python-3.1.3-5.2 (2005-140)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000697.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a59c484e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"mod_python-3.1.3-5.2")) flag++;
if (rpm_check(release:"FC3", reference:"mod_python-debuginfo-3.1.3-5.2")) flag++;
