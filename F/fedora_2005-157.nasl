...
# extracted from Fedora Security Advisory 2005-157.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-157");

  script_name(english:"Fedora Core 3 : postgresql-7.4.7-3.FC3.1 (2005-157)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000711.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dd1f3e3b"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"postgresql-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-contrib-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-debuginfo-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-devel-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-docs-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-jdbc-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-libs-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-pl-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-python-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-server-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-tcl-7.4.7-3.FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"postgresql-test-7.4.7-3.FC3.1")) flag++;
