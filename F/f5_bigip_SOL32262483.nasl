...
# extracted from F5 Networks BIG-IP Solution K32262483.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6451");

  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K32262483)");
...
4.2.8p10 and 4.3.x before 4.3.94 does not properly handle the return
value of the snprintf function, which allows local users to execute
arbitrary code via unspecified vectors, which trigger an out-of-bounds
memory write. (CVE-2017-6451)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K32262483"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
