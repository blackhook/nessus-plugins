...
# extracted from F5 Networks BIG-IP Solution SOL17079.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-2590", "CVE-2015-4732");
  script_bugtraq_id(75818, 75823);
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/03/24");

  script_name(english:"F5 Networks BIG-IP : Java SE vulnerabilities (SOL17079)");
...
related to Libraries, a different vulnerability than CVE-2015-4732.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K17079");
