...
# extracted from Fedora Security Advisory 2011-12233.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : openssl-1.0.0e-1.fc16 (2011-12233)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/065744.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?437902f1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"openssl-1.0.0e-1.fc16")) flag++;
