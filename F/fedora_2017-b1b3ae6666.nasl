...
# extracted from Fedora Security Advisory FEDORA-2017-b1b3ae6666.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : git (2017-b1b3ae6666)");
...
From the [release
announcement](https://public-inbox.org/git/xmqqh8xf482j.fsf@gitster.mt
v.corp.google.com/) :
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b1b3ae6666"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"git-2.13.5-1.fc26")) flag++;
