...
# extracted from Fedora Security Advisory FEDORA-2021-fb078913dd
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : dotnet3.1 (2021-fb078913dd)");
...
FEDORA-2021-fb078913dd advisory.

  - ASP.NET Core and Visual Studio Denial of Service Vulnerability (CVE-2021-1723)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-fb078913dd");
...
pkgs = [
    {'reference':'dotnet3.1-3.1.111-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
