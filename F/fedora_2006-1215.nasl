...
# extracted from Fedora Security Advisory 2006-1215.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1215");

  script_name(english:"Fedora Core 6 : openssh-4.3p2-10.0.fc6 (2006-1215)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-November/000937.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d8539051"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"openssh-4.3p2-10.0.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"openssh-askpass-4.3p2-10.0.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"openssh-clients-4.3p2-10.0.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"openssh-debuginfo-4.3p2-10.0.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"openssh-server-4.3p2-10.0.fc6")) flag++;
