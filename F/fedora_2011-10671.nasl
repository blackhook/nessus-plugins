...
# extracted from Fedora Security Advisory 2011-10671.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-10671");

  script_name(english:"Fedora 16 : ecryptfs-utils-90-1.fc16 (2011-10671)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/065422.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1c9a887"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"ecryptfs-utils-90-1.fc16")) flag++;
