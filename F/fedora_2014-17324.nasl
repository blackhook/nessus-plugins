...
# extracted from Fedora Security Advisory 2014-17324.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-17324");

  script_name(english:"Fedora 21 : libssh-0.6.4-1.fc21 (2014-17324)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?46a8ce9c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"libssh-0.6.4-1.fc21")) flag++;
