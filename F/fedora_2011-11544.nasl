...
# extracted from Fedora Security Advisory 2011-11544.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2011-3184");
  script_xref(name:"FEDORA", value:"2011-11544");

  script_name(english:"Fedora 15 : pidgin-2.10.0-1.fc15 (2011-11544)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=732405"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-August/064943.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2c256d1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"pidgin-2.10.0-1.fc15")) flag++;
