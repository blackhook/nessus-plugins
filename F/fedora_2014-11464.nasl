...
# extracted from Fedora Security Advisory 2014-11464.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : krfb-4.11.5-4.fc19 (2014-11464)");
  ...
  script_set_attribute(
    ...
    value:
"security fix, unbundles libvncserver and uses the system libvncserver.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/140219.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9f424ca3"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"krfb-4.11.5-4.fc19")) flag++;
