...
# extracted from Fedora Security Advisory 2010-4521.
#
...
if (description)
{
  ...
  script_bugtraq_id(38684, 38685, 38686, 38689, 38691, 38692);
  script_xref(name:"FEDORA", value:"2010-4521");

  script_name(english:"Fedora 13 : qt-4.6.2-8.fc13 (2010-4521)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037834.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?90baa22e"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"qt-4.6.2-8.fc13")) flag++;
