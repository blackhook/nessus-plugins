...
# extracted from Fedora Security Advisory FEDORA-2021-470fa24f5b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-470fa24f5b");

  script_name(english:"Fedora 33 : containerd (2021-470fa24f5b)");
...
FEDORA-2021-470fa24f5b advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-470fa24f5b");
...
pkgs = [
    {'reference':'containerd-1.4.4-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
