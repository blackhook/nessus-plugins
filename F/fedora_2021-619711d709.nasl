...
# extracted from Fedora Security Advisory FEDORA-2021-619711d709
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-619711d709");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2021/11/17");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/25");

  script_name(english:"Fedora 32 : webkit2gtk3 (2021-619711d709)");
...
FEDORA-2021-619711d709 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-619711d709");
...
pkgs = [
    {'reference':'webkit2gtk3-2.30.6-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
