...
# extracted from Fedora Security Advisory 2014-8485.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-8485");

  script_name(english:"Fedora 20 : drupal7-7.29-1.fc20 (2014-8485)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/136090.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?34a73d1b"
  );
  # https://www.drupal.org/drupal-7.29-release-notes
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC20", reference:"drupal7-7.29-1.fc20")) flag++;
