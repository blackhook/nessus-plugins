...
# extracted from Fedora Security Advisory 2007-0006.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2007-0006");

  script_name(english:"Fedora 7 : devhelp-0.13-8.fc7 (2007-0006)");
...
Users of devhelp are advised to upgrade to these erratum packages,
which contain an update to devhelp built against the updated Firefox
packages.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001780.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b3416a44"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC7", reference:"devhelp-0.13-8.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"devhelp-debuginfo-0.13-8.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"devhelp-devel-0.13-8.fc7")) flag++;
