...
# extracted from Fedora Security Advisory 2011-6380.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6380");

  script_name(english:"Fedora 14 : wordpress-3.1.2-1.fc14 (2011-6380)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059986.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f1b85d1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"wordpress-3.1.2-1.fc14")) flag++;
