...
# extracted from Fedora Security Advisory 2014-9791.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0480", "CVE-2014-0481", "CVE-2014-0482");
  script_bugtraq_id(69423, 69425, 69430);
  script_xref(name:"FEDORA", value:"2014-9791");

  script_name(english:"Fedora 19 : python-django-1.5.9-1.fc19 (2014-9791)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137385.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf1a2e15"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python-django-1.5.9-1.fc19")) flag++;
