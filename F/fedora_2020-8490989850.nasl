...
# extracted from Fedora Security Advisory FEDORA-2020-8490989850.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : xen (2020-8490989850)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8490989850"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"xen-4.12.2-2.fc31")) flag++;
