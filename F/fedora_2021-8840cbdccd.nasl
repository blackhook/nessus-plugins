...
# extracted from Fedora Security Advisory FEDORA-2021-8840cbdccd
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-8840cbdccd");
  script_xref(name:"IAVA", value:"2021-A-0053");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/27");

  script_name(english:"Fedora 32 : sudo (2021-8840cbdccd)");
...
FEDORA-2021-8840cbdccd advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-8840cbdccd");
...
pkgs = [
    {'reference':'sudo-1.9.5p2-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
