...
# extracted from Fedora Security Advisory FEDORA-2017-3b367c896f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-3b367c896f");

  script_name(english:"Fedora 24 : pcre (2017-3b367c896f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3b367c896f"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"pcre-8.40-7.fc24")) flag++;
