...
# extracted from Fedora Security Advisory 2015-6157.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6157");

  script_name(english:"Fedora 22 : spatialite-tools-4.2.0-10.fc22 / sqlite-3.8.9-1.fc22 (2015-6157)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155919.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a2627c86"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155920.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dad8b27d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"spatialite-tools-4.2.0-10.fc22")) flag++;
if (rpm_check(release:"FC22", reference:"sqlite-3.8.9-1.fc22")) flag++;
