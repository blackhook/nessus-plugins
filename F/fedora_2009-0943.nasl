...
# extracted from Fedora Security Advisory 2009-0943.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-0943");

  script_name(english:"Fedora 10 : dia-0.96.1-9.fc10 (2009-0943)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-January/019425.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea77b16a"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"dia-0.96.1-9.fc10")) flag++;
