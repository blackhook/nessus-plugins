...
# extracted from Fedora Security Advisory FEDORA-2017-5d79b43fcc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-5d79b43fcc");

  script_name(english:"Fedora 27 : poppler (2017-5d79b43fcc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-5d79b43fcc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"poppler-0.57.0-2.fc27")) flag++;
