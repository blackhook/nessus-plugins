...
# extracted from Fedora Security Advisory 2005-745.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-745");

  script_name(english:"Fedora Core 3 : kdeedu-3.4.2-0.fc3.2 (2005-745)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001245.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eaa6ab27"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"kdeedu-3.4.2-0.fc3.2")) flag++;
if (rpm_check(release:"FC3", reference:"kdeedu-debuginfo-3.4.2-0.fc3.2")) flag++;
if (rpm_check(release:"FC3", reference:"kdeedu-devel-3.4.2-0.fc3.2")) flag++;
