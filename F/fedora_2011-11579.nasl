...
# extracted from Fedora Security Advisory 2011-11579.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 15 : rubygem-activesupport-3.0.5-4.fc15 (2011-11579)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/065114.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b0a0b5c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"rubygem-activesupport-3.0.5-4.fc15")) flag++;
