...
# extracted from Fedora Security Advisory 2015-15198.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-15198");

  script_name(english:"Fedora 21 : php-doctrine-cache-1.4.2-1.fc21 (2015-15198)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/166327.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?894988ea"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"php-doctrine-cache-1.4.2-1.fc21")) flag++;
