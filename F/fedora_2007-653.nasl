...
# extracted from Fedora Security Advisory 2007-653.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : gdm-2.16.5-2.fc6 (2007-653)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-August/003058.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ec8b4c6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC6", reference:"gdm-2.16.5-2.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"gdm-debuginfo-2.16.5-2.fc6")) flag++;
