...
# extracted from Fedora Security Advisory FEDORA-2021-ef84cd3f69
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ef84cd3f69");

  script_name(english:"Fedora 33 : 1:cups (2021-ef84cd3f69)");
...
FEDORA-2021-ef84cd3f69 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ef84cd3f69");
...
pkgs = [
    {'reference':'cups-2.3.3op2-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
