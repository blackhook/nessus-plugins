...
# extracted from Fedora Security Advisory 2009-1525.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-1525");

  script_name(english:"Fedora 10 : xine-lib-1.1.16.2-1.fc10 (2009-1525)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/019999.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f58b39a0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"xine-lib-1.1.16.2-1.fc10")) flag++;
