...
# extracted from F5 Networks BIG-IP Solution K31310492.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K31310492)");
  ...
  script_set_attribute(
    ...
    value:
"Stack-based buffer overflow in the reslist function in ntpq in NTP
before 4.2.8p10 and 4.3.x before 4.3.94 allows remote servers have
unspecified impact via a long flagstr variable in a restriction list
response. (CVE-2017-6460)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/#/article/K31310492"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
