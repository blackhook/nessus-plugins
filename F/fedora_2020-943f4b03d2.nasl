...
# extracted from Fedora Security Advisory FEDORA-2020-943f4b03d2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : kubernetes (2020-943f4b03d2)");
  ...
  script_set_attribute(
    ...
    value:
"Update to v1.15.7 (CVE-2018-1002102 kubernetes: improper validation of
URL redirection in the Kubernetes API server allows an
attacker-controlled Kubelet to redirect API server requests from
streaming endpoints)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-943f4b03d2"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-1002102");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"kubernetes-1.15.7-1.fc31")) flag++;
