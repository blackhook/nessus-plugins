...
# extracted from Fedora Security Advisory 2008-6916.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : drupal-5.9-1.fc8 (2008-6916)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 5.9, security fixes: SA-2008-046 -
http://drupal.org/node/286417 CVE-2008-3222 - session fixation issue,
that was first reported to be fixed via SA-2008-044 in drupal 5.8, but
the patch for it was not included in the 5.8 tarball. Remember to log
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://drupal.org/node/286417"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=454849"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-August/013265.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?81966756"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"drupal-5.9-1.fc8")) flag++;
