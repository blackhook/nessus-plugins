...
# extracted from Fedora Security Advisory 2004-058.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-058");

  script_name(english:"Fedora Core 1 : mc-4.6.0-8.4 (2004-058)");
  ...
  script_set_attribute(
    ...
    value:
"  - Sat Jan 31 2004 Jakub Jelinek <jakub at redhat.com>
    4.6.0-8.4

  - fix previous patch

  - Fri Jan 30 2004 Jakub Jelinek <jakub at redhat.com>
    4.6.0-8.3
  ...
  - Fri Jan 23 2004 Jakub Jelinek <jakub at redhat.com>
    4.6.0-8.2

  - update CVE-2003-1023 fix to still make vfs symlinks
    relative, but with bounds checking

  - Sat Jan 17 2004 Warren Togami <wtogami at redhat.com>
    4.6.0-8.1
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-February/000050.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea1a95cb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", cpu:"i386", reference:"mc-4.6.0-8.4")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"mc-debuginfo-4.6.0-8.4")) flag++;
