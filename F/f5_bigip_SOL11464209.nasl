...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"X509 certificate verification was not correctly implemented in the IP
...
potentially be compromised."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K11464209"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["affected"  ] = make_list("12.1.0-12.1.2","11.6.1-11.6.2","11.5.1-11.5.5");
vmatrix["AFM"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.3","11.5.6");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.1.0-12.1.2","11.6.1-11.6.2","11.5.1-11.5.5");
vmatrix["ASM"]["unaffected"] = make_list("13.0.0","12.1.2HF1","11.6.3","11.5.6");
