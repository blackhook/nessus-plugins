...
# extracted from Fedora Security Advisory 2015-13616.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : mod_nss-1.0.11-4.fc22 (2015-13616)");
  ...
  script_set_attribute(
    ...
    value:
"Fix issue in parsing logical AND in OpenSSL-style ciphers,
CVE-2015-3277.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1243518"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/170607.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?357ca402"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"mod_nss-1.0.11-4.fc22")) flag++;
