...
# extracted from Fedora Security Advisory FEDORA-2016-5f616afe10.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-5f616afe10");

  script_name(english:"Fedora 25 : community-mysql (2016-5f616afe10)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-5f616afe10"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"community-mysql-5.7.15-1.fc25")) flag++;
