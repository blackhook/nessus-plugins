...
# extracted from Fedora Security Advisory 2011-13446.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-13446");

  script_name(english:"Fedora 15 : php-5.3.8-3.fc15 (2011-13446)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/067401.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b4129fa9"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"php-5.3.8-3.fc15")) flag++;
