...
# extracted from Fedora Security Advisory 2005-604.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-604");

  script_name(english:"Fedora Core 3 : thunderbird-1.0.6-1.1.fc3 (2005-604)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-July/001100.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf3cd606"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"thunderbird-1.0.6-1.1.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"thunderbird-debuginfo-1.0.6-1.1.fc3")) flag++;
