...
# extracted from Fedora Security Advisory FEDORA-2016-7f0fb9b38d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-7f0fb9b38d");

  script_name(english:"Fedora 25 : knot (2016-7f0fb9b38d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-7f0fb9b38d"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"knot-2.3.0-2.fc25")) flag++;
