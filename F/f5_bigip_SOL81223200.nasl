...
# extracted from F5 Networks BIG-IP Solution K81223200.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-3425");

  script_name(english:"F5 Networks BIG-IP : Oracle Java SE vulnerability (K81223200)");
...
affect availability via vectors related to JAXP. (CVE-2016-3425)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K81223200"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
