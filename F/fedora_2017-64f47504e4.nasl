...
# extracted from Fedora Security Advisory FEDORA-2017-64f47504e4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-64f47504e4");

  script_name(english:"Fedora 26 : ocaml (2017-64f47504e4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-64f47504e4"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"ocaml-4.04.0-10.fc26")) flag++;
