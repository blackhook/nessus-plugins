...
# extracted from Fedora Security Advisory 2013-1167.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-1167");

  script_name(english:"Fedora 18 : php-symfony2-Yaml-2.1.7-1.fc18 (2013-1167)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-February/098192.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ab8e799"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"php-symfony2-Yaml-2.1.7-1.fc18")) flag++;
