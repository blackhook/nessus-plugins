...
# extracted from Fedora Security Advisory FEDORA-2017-0bc23764e7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0bc23764e7");

  script_name(english:"Fedora 24 : php-PHPMailer (2017-0bc23764e7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0bc23764e7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"php-PHPMailer-5.2.24-1.fc24")) flag++;
