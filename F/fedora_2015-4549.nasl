...
# extracted from Fedora Security Advisory 2015-4549.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4549");

  script_name(english:"Fedora 20 : osc-0.151.1-163.2.1.fc20 (2015-4549)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154257.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a040a4e7"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"osc-0.151.1-163.2.1.fc20")) flag++;
