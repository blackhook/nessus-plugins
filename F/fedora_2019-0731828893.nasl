...
# extracted from Fedora Security Advisory FEDORA-2019-0731828893.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 2:microcode_ctl (2019-0731828893)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0731828893"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"microcode_ctl-2.1-29.fc29", epoch:"2")) flag++;
