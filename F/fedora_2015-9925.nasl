...
# extracted from Fedora Security Advisory 2015-9925.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-9925");

  script_name(english:"Fedora 21 : postgresql-9.3.9-1.fc21 (2015-9925)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/161084.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?01d92973"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"postgresql-9.3.9-1.fc21")) flag++;
