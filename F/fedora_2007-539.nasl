...
# extracted from Fedora Security Advisory 2007-539.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : mutt-1.4.2.3-1.fc6 (2007-539)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001756.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fa34fbc0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC6", reference:"mutt-1.4.2.3-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"mutt-debuginfo-1.4.2.3-1.fc6")) flag++;
