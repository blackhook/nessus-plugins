...
# extracted from Fedora Security Advisory 2009-3430.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-3430");

  script_name(english:"Fedora 9 : argyllcms-1.0.3-4.fc9 (2009-3430)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022157.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed53263d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"argyllcms-1.0.3-4.fc9")) flag++;
