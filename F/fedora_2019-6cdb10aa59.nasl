...
# extracted from Fedora Security Advisory FEDORA-2019-6cdb10aa59.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-6cdb10aa59");
  script_xref(name:"IAVB", value:"2019-B-0081-S");

  script_name(english:"Fedora 31 : ghostscript (2019-6cdb10aa59)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6cdb10aa59");
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"ghostscript-9.27-2.fc31")) flag++;
