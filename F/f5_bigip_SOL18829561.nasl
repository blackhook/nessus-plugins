...
# extracted from F5 Networks BIG-IP Solution K18829561.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND vulnerability (K18829561)");
...
that meets certain criteria.This assertion can be triggered even if
the apparent source address isn't allowed to make queries (i.e.
doesn't match 'allow-query').(CVE-2016-2776)"
  );
  # https://kb.isc.org/article/AA-01419/0/CVE-2016-2776
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K18829561"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
