...
# extracted from Fedora Security Advisory 2009-7315.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-7315");

  script_name(english:"Fedora 11 : drupal-6.13-1.fc11 (2009-7315)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026052.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1416bf8b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"drupal-6.13-1.fc11")) flag++;
