...
# extracted from Fedora Security Advisory FEDORA-2016-df0726ae26.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : httpd (2016-df0726ae26) (httpoxy)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-df0726ae26"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"httpd-2.4.23-4.fc23")) flag++;
