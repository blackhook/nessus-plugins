...
# extracted from Fedora Security Advisory FEDORA-2016-3fba74e7f5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-3fba74e7f5");
  script_xref(name:"IAVA", value:"2017-A-0004");

  script_name(english:"Fedora 23 : 32:bind (2016-3fba74e7f5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3fba74e7f5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"bind-9.10.4-1.P2.fc23", epoch:"32")) flag++;
