...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Users with access to edit iRules are able to create iRules which can
lead to an elevation of privilege, configuration modification, and
arbitrary system command execution. (CVE-2019-6685)

Impact

BIG-IP

iRules manager roles are able to access data stored on other
administrative partitions when the accessprivilege iselevated.

BIG-IQ,Enterprise Manager, and Traffix SDC

There is no impact on these F5 products because theyare not affected
by this vulnerability."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K30215839"
  );
  script_set_attribute(
    attribute:"solution",
    value:
