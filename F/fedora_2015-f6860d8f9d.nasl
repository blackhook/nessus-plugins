...
# extracted from Fedora Security Advisory 2015-f6860d8f9d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-f6860d8f9d");

  script_name(english:"Fedora 22 : pacemaker-1.1.13-3.fc22 (2015-f6860d8f9d)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-October/169671.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e41ec26e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"pacemaker-1.1.13-3.fc22")) flag++;
