...
# extracted from Fedora Security Advisory 2009-6973.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6973");

  script_name(english:"Fedora 10 : poppler-0.8.7-6.fc10 (2009-6973)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=496942"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025658.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88c663a7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"poppler-0.8.7-6.fc10")) flag++;
