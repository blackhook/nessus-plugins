...
# extracted from Fedora Security Advisory 2014-6892.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6892");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1086671"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134206.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf0e0c32"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"mingw-libpng-1.5.18-1.fc19")) flag++;
