...
# extracted from Fedora Security Advisory FEDORA-2016-f90dc5ee3e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : 1:nodejs (2016-f90dc5ee3e)");
  ...
  script_set_attribute(
    ...
    value:
"Update to latest LTS security release (4.4.6)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f90dc5ee3e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"nodejs-4.4.6-2.fc24", epoch:"1")) flag++;
