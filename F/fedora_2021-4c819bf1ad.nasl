...
# extracted from Fedora Security Advisory FEDORA-2021-4c819bf1ad
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-26933", "CVE-2021-26934");
  script_xref(name:"FEDORA", value:"2021-4c819bf1ad");

  script_name(english:"Fedora 32 : xen (2021-4c819bf1ad)");
...
FEDORA-2021-4c819bf1ad advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-4c819bf1ad");
...
pkgs = [
    {'reference':'xen-4.13.2-7.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
