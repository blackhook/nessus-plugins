...
# extracted from Fedora Security Advisory 2012-1213.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-1213");

  script_name(english:"Fedora 15 : usbmuxd-1.0.7-3.fc15 (2012-1213)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=783523"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/073428.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f90f992"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected usbmuxd package."
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"usbmuxd-1.0.7-3.fc15")) flag++;
