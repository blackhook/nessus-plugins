...
# extracted from Fedora Security Advisory FEDORA-2017-f838eb0c5e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f838eb0c5e");

  script_name(english:"Fedora 25 : php-PHPMailer (2017-f838eb0c5e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f838eb0c5e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"php-PHPMailer-5.2.24-1.fc25")) flag++;
