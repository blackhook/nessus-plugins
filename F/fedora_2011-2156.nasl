...
# extracted from Fedora Security Advisory 2011-2156.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-2156");

  script_name(english:"Fedora 14 : moin-1.9.3-4.fc14 (2011-2156)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/055116.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?99297561"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"moin-1.9.3-4.fc14")) flag++;
