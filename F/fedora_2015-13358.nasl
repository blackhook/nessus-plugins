...
# extracted from Fedora Security Advisory 2015-13358.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-13358");

  script_name(english:"Fedora 23 : qemu-2.4.0-1.fc23 (2015-13358)");
  ...
  script_set_attribute(
    ...
    value:
"  - Rebased to version 2.4.0 * Support for virtio-gpu, 2D
    only * Support for virtio-based keyboard/mouse/tablet
    emulation * x86 support for memory hot-unplug

  - ACPI v5.1 table support for 'virt' board *
    CVE-2015-3209: pcnet: multi-tmd buffer overflow in the
    tx path (bz #1230536) * CVE-2015-3214: i8254: out-of-
    bounds memory access (bz #1243728) * CVE-2015-5158: scsi
    stack-based buffer overflow (bz #1246025) *
    CVE-2015-5154: ide: atapi: heap overflow during I/O
    buffer memory access (bz #1247141) * CVE-2015-5165:
    rtl8139 uninitialized heap memory information leakage to
    guest (bz #1249755) * CVE-2015-5166: BlockBackend object
    use after free issue (bz #1249758) * CVE-2015-5745:
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-August/164489.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ddc8e52e"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"qemu-2.4.0-1.fc23")) flag++;
