...
# extracted from Fedora Security Advisory FEDORA-2017-fa1d8ad61a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-fa1d8ad61a");

  script_name(english:"Fedora 25 : mercurial (2017-fa1d8ad61a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-fa1d8ad61a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mercurial-3.8.1-4.fc25")) flag++;
