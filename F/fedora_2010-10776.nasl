...
# extracted from Fedora Security Advisory 2010-10776.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : mingw32-libpng-1.2.44-1.fc12 (2010-10776)");
  ...
  script_set_attribute(
    ...
    value:
"  - Update to 1.2.44 - Fixes CVE-2010-1205 and CVE-2010-2249
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-July/044590.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d7ab6c3b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"mingw32-libpng-1.2.44-1.fc12")) flag++;
