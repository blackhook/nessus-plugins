...
# extracted from Fedora Security Advisory FEDORA-2017-7eaec3353d.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-7515", "CVE-2017-9406", "CVE-2017-9408", "CVE-2017-9775", "CVE-2017-9776", "CVE-2017-9865");
  script_xref(name:"FEDORA", value:"2017-7eaec3353d");

  script_name(english:"Fedora 25 : poppler (2017-7eaec3353d)");
  ...
  script_set_attribute(
    ...
    value:
"  - various flaws: CVE-2017-7515 CVE-2017-9775 CVE-2017-9776
    CVE-2017-9865
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7eaec3353d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"poppler-0.45.0-5.fc25")) flag++;
