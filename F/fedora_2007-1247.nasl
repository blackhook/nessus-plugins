...
# extracted from Fedora Security Advisory 2007-1247.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : bind-9.4.1-7.P1.fc7 (2007-1247)");
  ...
  script_set_attribute(
    ...
    value:
"  - CVE-2007-2925 - allow-query-cache/allow-recursion
    default acls not set

    - workaround - disable recursion or explicitly set
      allow-query-cache and allow-recursion acls
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/002911.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ff04e7d2"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"bind-9.4.1-7.P1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"bind-chroot-9.4.1-7.P1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"bind-debuginfo-9.4.1-7.P1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"bind-devel-9.4.1-7.P1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"bind-libs-9.4.1-7.P1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"bind-sdb-9.4.1-7.P1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"bind-utils-9.4.1-7.P1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"caching-nameserver-9.4.1-7.P1.fc7")) flag++;
