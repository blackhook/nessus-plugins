...
# extracted from Fedora Security Advisory FEDORA-2017-f58bbbbdb0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : konversation (2017-f58bbbbdb0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f58bbbbdb0"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"konversation-1.7.4-1.fc25")) flag++;
