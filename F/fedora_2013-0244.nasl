...
# extracted from Fedora Security Advisory 2013-0244.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : rubygem-activerecord-3.0.10-4.fc16 (2013-0244)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/096787.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?11dea40c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"rubygem-activerecord-3.0.10-4.fc16")) flag++;
