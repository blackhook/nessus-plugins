...
# extracted from Fedora Security Advisory FEDORA-2017-51ff8fe326.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : poppler (2017-51ff8fe326)");
  ...
  script_set_attribute(
    ...
    value:
"Resolves: rhbz#1505731 rebuild for qt5 5.9.2
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-51ff8fe326"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"poppler-0.52.0-9.fc26")) flag++;
