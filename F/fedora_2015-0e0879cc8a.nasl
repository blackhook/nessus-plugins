...
# extracted from Fedora Security Advisory 2015-0e0879cc8a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-0e0879cc8a");

  script_name(english:"Fedora 22 : samba-4.2.7-0.fc22 (2015-0e0879cc8a)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77ff84dc"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"samba-4.2.7-0.fc22")) flag++;
