...
# extracted from Fedora Security Advisory 2011-5204.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5204");

  script_name(english:"Fedora 14 : libmodplug-0.8.8.2-1.fc14 (2011-5204)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=695420"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058368.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78cc9175"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"libmodplug-0.8.8.2-1.fc14")) flag++;
