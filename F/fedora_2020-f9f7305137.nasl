...
# extracted from Fedora Security Advisory FEDORA-2020-f9f7305137.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : firefox (2020-f9f7305137)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f9f7305137"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"firefox-83.0-3.fc33", allowmaj:TRUE)) flag++;
