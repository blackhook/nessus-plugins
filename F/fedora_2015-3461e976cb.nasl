...
# extracted from Fedora Security Advisory 2015-3461e976cb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3461e976cb");

  script_name(english:"Fedora 22 : libpng10-1.0.65-1.fc22 (2015-3461e976cb)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-December/174127.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74ea2593"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"libpng10-1.0.65-1.fc22")) flag++;
