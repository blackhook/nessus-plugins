...
# extracted from Fedora Security Advisory FEDORA-2016-f341d71730.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : springframework (2016-f341d71730)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 3.2.18.RELEASE. Resolves: CVE-2016-9878
(rhbz#1408164,1408165)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f341d71730"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"springframework-3.2.18-1.fc25")) flag++;
