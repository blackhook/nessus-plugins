...
FEDORA-2023-2455981016 advisory.
  ...
  - **PHP version 8.2.7** (08 Jun 2023)  **Core:**  * Fixed bug [GH-11152](https://github.com/php/php-
    src/issues/11152) (Unable to alias namespaces containing reserved class names). (ilutov) * Fixed bug
    [GH-9068](https://github.com/php/php-src/issues/9068) (Conditional jump or move depends on uninitialised
    value(s)). (nielsdos) * Fixed bug [GH-11189](https://github.com/php/php-src/issues/11189) (Exceeding
    memory limit in zend_hash_do_resize leaves the array in an invalid state). (Bob) * Fixed bug
    [GH-11063](https://github.com/php/php-src/issues/11063) (Compilation error on old GCC versions).
    (ingamedeo) * Fixed bug [GH-11222](https://github.com/php/php-src/issues/11222) (foreach by-ref may jump
    over keys during a rehash). (Bob)  **Date:**  * Fixed bug [GH-11281](https://github.com/php/php-
    ...
    stream wrapper chunk sizes). (nielsdos)  **FPM:**  * Fixed bug [GH-10461](https://github.com/php/php-
    ...
    [GH-11180](https://github.com/php/php-src/issues/11180) (hash_file() appears to be restricted to 3
    arguments). (nielsdos)  **LibXML:**  * Fixed bug [GH-11160](https://github.com/php/php-src/issues/11160)
    (Few tests failed building with new libxml 2.11.0). (nielsdos)  **MBString:**  * Fix bug
    [GH-11217](https://github.com/php/php-src/issues/11217) (Segfault in mb_strrpos / mb_strripos when using
    negative offset and ASCII encoding). (ilutov)  **Opcache:**  * Fixed bug
    [GH-11134](https://github.com/php/php-src/issues/11134) (Incorrect match default branch optimization).
    (ilutov) * Fixed too wide OR and AND range inference. (nielsdos) * Fixed missing class redeclaration error
    with OPcache enabled. (ilutov) * Fixed bug [GH-11245](https://github.com/php/php-src/issues/11245) (In
    ...
    pg_lo_export(). (kocsismate)  **Phar:**  * Fixed bug [GH-11099](https://github.com/php/php-
    ...
    timwolla) * Fixed bug [GH-8426](https://github.com/php/php-src/issues/8426) (make test fail while soap
    extension build). (nielsdos)  **SPL:**  * Fixed bug [GH-11178](https://github.com/php/php-
    src/issues/11178) (Segmentation fault in spl_array_it_get_current_data (PHP 8.1.18)). (nielsdos)
    **Standard:**  * Fixed bug [GH-11138](https://github.com/php/php-src/issues/11138) (move_uploaded_file()
    emits open_basedir warning for source file). (ilutov) * Fixed bug [GH-11274](https://github.com/php/php-
    ...
    * Fixed bug [GH-10031](https://github.com/php/php-src/issues/10031) ([Stream] STREAM_NOTIFY_PROGRESS over
    ...
    [GH-11175](https://github.com/php/php-src/issues/11175) (Stream Socket Timeout). (nielsdos) * Fixed bug
    [GH-11177](https://github.com/php/php-src/issues/11177) (ASAN UndefinedBehaviorSanitizer when timeout = -1
