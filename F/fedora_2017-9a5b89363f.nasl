...
# extracted from Fedora Security Advisory FEDORA-2017-9a5b89363f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : libwmf (2017-9a5b89363f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9a5b89363f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libwmf-0.2.8.4-50.fc24")) flag++;
