...
# extracted from Fedora Security Advisory 2012-8946.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8946");

  script_name(english:"Fedora 16 : bind-9.8.3-2.P1.fc16 (2012-8946)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/082274.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5edadca8"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"bind-9.8.3-2.P1.fc16")) flag++;
