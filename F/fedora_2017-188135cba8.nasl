...
# extracted from Fedora Security Advisory FEDORA-2017-188135cba8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-188135cba8");

  script_name(english:"Fedora 26 : pcre (2017-188135cba8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-188135cba8"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"pcre-8.40-7.fc26")) flag++;
