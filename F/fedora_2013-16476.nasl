...
# extracted from Fedora Security Advisory 2013-16476.
#
...
if (description)
{
  ...
  script_bugtraq_id(62408, 62410, 62411, 62412);
  script_xref(name:"FEDORA", value:"2013-16476");

  script_name(english:"Fedora 19 : moodle-2.4.6-1.fc19 (2013-16476)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://docs.moodle.org/dev/Moodle_2.3.9_release_notes"
  );
  # http://docs.moodle.org/dev/Moodle_2.4.6_release_notes
  script_set_attribute(
    attribute:"see_also",
    value:"https://docs.moodle.org/dev/Moodle_2.4.6_release_notes"
  );
  # http://docs.moodle.org/dev/Moodle_2.5.2_release_notes
  script_set_attribute(
    attribute:"see_also",
    value:"https://docs.moodle.org/dev/Moodle_2.5.2_release_notes"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115895.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6259c32f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"moodle-2.4.6-1.fc19")) flag++;
