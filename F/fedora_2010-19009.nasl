...
# extracted from Fedora Security Advisory 2010-19009.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-19009");

  script_name(english:"Fedora 14 : drupal-views-6.x.2.12-1.fc14 (2010-19009)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/052814.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f3e548a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"drupal-views-6.x.2.12-1.fc14")) flag++;
