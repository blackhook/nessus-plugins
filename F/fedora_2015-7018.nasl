...
# extracted from Fedora Security Advisory 2015-7018.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7018");

  script_name(english:"Fedora 22 : pdns-3.4.4-1.fc22 (2015-7018)");
...
Release notes:
https://doc.powerdns.com/md/changelog/#powerdns-authoritative-server-3
44
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1213377"
  );
  # https://doc.powerdns.com/md/changelog/#powerdns-authoritative-server-344
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4f894596"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?27907f66"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"pdns-3.4.4-1.fc22")) flag++;
