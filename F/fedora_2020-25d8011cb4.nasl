...
# extracted from Fedora Security Advisory FEDORA-2020-25d8011cb4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : rpki-client (2020-25d8011cb4)");
...
"# rpki-client 6.7p1
  ...
  - Security fix: Incorrect use of `EVP_PKEY_cmp` allowed an
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-25d8011cb4"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"rpki-client-6.7p1-1.fc32")) flag++;
