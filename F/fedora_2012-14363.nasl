...
# extracted from Fedora Security Advisory 2012-14363.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14363");

  script_name(english:"Fedora 16 : phpldapadmin-1.2.2-3.gitbbedf1.fc16 (2012-14363)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?357ca96b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"phpldapadmin-1.2.2-3.gitbbedf1.fc16")) flag++;
