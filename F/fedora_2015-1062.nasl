...
# extracted from Fedora Security Advisory 2015-1062.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1062");

  script_name(english:"Fedora 21 : jasper-1.900.1-30.fc21 (2015-1062)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-February/149445.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4acca7e1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"jasper-1.900.1-30.fc21")) flag++;
