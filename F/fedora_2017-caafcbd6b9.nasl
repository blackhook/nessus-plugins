...
# extracted from Fedora Security Advisory FEDORA-2017-caafcbd6b9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-caafcbd6b9");

  script_name(english:"Fedora 25 : upx (2017-caafcbd6b9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-caafcbd6b9"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"upx-3.94-1.fc25")) flag++;
