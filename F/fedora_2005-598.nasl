...
# extracted from Fedora Security Advisory 2005-598.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-598");

  script_name(english:"Fedora Core 3 : libtiff-3.6.1-9.fc3 (2005-598)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-January/000564.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7876573"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"libtiff-3.6.1-9.fc3")) flag++;
