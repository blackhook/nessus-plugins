...
# extracted from Fedora Security Advisory 2014-2870.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-2870");

  script_name(english:"Fedora 20 : postgresql-9.3.3-1.fc20 (2014-2870)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128991.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b212a27b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"postgresql-9.3.3-1.fc20")) flag++;
