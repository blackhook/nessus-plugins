...
# extracted from Fedora Security Advisory 2013-2450.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-2450");

  script_name(english:"Fedora 17 : pixman-0.28.0-1.fc17 (2013-2450)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-March/099466.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9c8bda1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"pixman-0.28.0-1.fc17")) flag++;
