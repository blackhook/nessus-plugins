...
# extracted from Fedora Security Advisory FEDORA-2016-cb03b6b70f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-cb03b6b70f");

  script_name(english:"Fedora 24 : mapserver (2016-cb03b6b70f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-cb03b6b70f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mapserver-6.2.3-1.fc24")) flag++;
