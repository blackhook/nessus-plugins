...
# extracted from Fedora Security Advisory FEDORA-2018-147d33439c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : php-phpmyadmin-motranslator / php-phpmyadmin-sql-parser / etc (2018-147d33439c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-147d33439c"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"php-phpmyadmin-motranslator-4.0-1.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"php-phpmyadmin-sql-parser-4.2.4-3.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"phpMyAdmin-4.7.8-1.fc26")) flag++;
