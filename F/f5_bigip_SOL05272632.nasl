...
# extracted from F5 Networks BIG-IP Solution SOL05272632.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIG-IP AOM password sync vulnerability (SOL05272632)");
  ...
  script_set_attribute(
    ...
    value:
"BIG-IP systems on the 2000, 4000, 5000, 7000, and 10000 platforms may
fail to sync passwords to the Always-On-Management (AOM)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K05272632"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade to one of the non-vulnerable versions listed in the F5
Solution SOL05272632."
  );
