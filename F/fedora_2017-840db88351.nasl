...
# extracted from Fedora Security Advisory FEDORA-2017-840db88351.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-840db88351");

  script_name(english:"Fedora 26 : libzip (2017-840db88351)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-840db88351"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libzip-1.3.0-1.fc26")) flag++;
