...
# extracted from Fedora Security Advisory 2014-14266.
#
...
if (description)
{
  ...
  script_bugtraq_id(68147);
  script_xref(name:"FEDORA", value:"2014-14266");

  script_name(english:"Fedora 19 : python-2.7.5-15.fc19 (2014-14266)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1113528"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144826.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d1e7b1da"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python-2.7.5-15.fc19")) flag++;
