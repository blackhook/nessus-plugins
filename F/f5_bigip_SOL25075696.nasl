...
# extracted from F5 Networks BIG-IP Solution K25075696.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Oracle Java vulnerability (K25075696)");
...
vulnerability than CVE-2016-3508. (CVE-2016-3500)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K25075696"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
