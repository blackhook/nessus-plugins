...
# extracted from Fedora Security Advisory FEDORA-2020-0450cfd7e3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : ansible (2020-0450cfd7e3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0450cfd7e3"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"ansible-2.9.13-1.fc31")) flag++;
