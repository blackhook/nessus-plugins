...
# extracted from Fedora Security Advisory FEDORA-2017-9a819664a6.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6525", "CVE-2017-5896", "CVE-2017-6060");
  script_xref(name:"FEDORA", value:"2017-9a819664a6");

  script_name(english:"Fedora 25 : mupdf (2017-9a819664a6)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2017-6060 CVE-2017-5896
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9a819664a6"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mupdf-1.10a-4.fc25")) flag++;
