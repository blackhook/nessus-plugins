...
# extracted from Fedora Security Advisory 2014-14227.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : python-2.7.5-15.fc20 (2014-14227)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/142835.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?47624eba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-2.7.5-15.fc20")) flag++;
