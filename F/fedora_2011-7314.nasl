...
# extracted from Fedora Security Advisory 2011-7314.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7314");

  script_name(english:"Fedora 15 : systemtap-1.4-9.fc15 (2011-7314)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/060791.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?950a3944"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"systemtap-1.4-9.fc15")) flag++;
