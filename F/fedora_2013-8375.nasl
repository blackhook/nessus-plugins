...
# extracted from Fedora Security Advisory 2013-8375.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-8375");

  script_name(english:"Fedora 18 : ruby-1.9.3.429-30.fc18 (2013-8375)");
  ...
  script_set_attribute(
    ...
    value:
"A vulnerability was found in DL and Fiddle in Ruby where tainted
strings can be used by system calls regardless of the $SAFE level set
in Ruby. This vulnerability has been assigned the CVE identifier
CVE-2013-2065.

This rpm will fix this issue.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=962862"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/107098.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2922d670"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"ruby-1.9.3.429-30.fc18")) flag++;
