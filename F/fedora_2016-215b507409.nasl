...
# extracted from Fedora Security Advisory 2016-215b507409.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-215b507409");

  script_name(english:"Fedora 22 : cgit-0.12-1.fc22 (2016-215b507409)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9e0618f1"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"cgit-0.12-1.fc22")) flag++;
