...
if (description)
{
  ...
  script_name(english:"Fortinet FortiOS 5.0.x < 5.0.5 FortiToken Security Bypass");
...
to 5.0.5. It is, therefore, affected by a security bypass
vulnerability due to an unspecified flaw in FortiToken. An
unauthenticated, remote attacker can exploit this to successfully
authenticate even when a token is locked.");
  # https://kb.fortinet.com/kb/microsites/search.do?cmd=displayKC&docType=kc&externalId=FortiOS-v50-Patch-Release-5-Release-Notespdf
  script_set_attribute(attribute:"see_also",value:"http://www.nessus.org/u?dcf17ed3");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Fortinet FortiOS 5.0.5 or later.");
