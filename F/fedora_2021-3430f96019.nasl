...
# extracted from Fedora Security Advisory FEDORA-2021-3430f96019
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-3430f96019");

  script_name(english:"Fedora 33 : 1:wpa_supplicant (2021-3430f96019)");
...
FEDORA-2021-3430f96019 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-3430f96019");
...
pkgs = [
    {'reference':'wpa_supplicant-2.9-8.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
