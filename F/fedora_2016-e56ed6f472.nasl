...
# extracted from Fedora Security Advisory FEDORA-2016-e56ed6f472.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e56ed6f472");

  script_name(english:"Fedora 25 : tor (2016-e56ed6f472)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e56ed6f472"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"tor-0.2.8.9-1.fc25")) flag++;
