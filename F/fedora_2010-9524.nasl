...
# extracted from Fedora Security Advisory 2010-9524.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : exim-4.72-1.fc13 (2010-9524)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes the following security flaws: * CVE-2010-2023 exim:
hard-link following vulnerability in mailbox handling * CVE-2010-2024
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/042613.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2002cb2b"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"exim-4.72-1.fc13")) flag++;
