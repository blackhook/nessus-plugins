...
# extracted from F5 Networks BIG-IP Solution SOL8938.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND DNS cache poisoning vulnerability (SOL8938)");
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K8938"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["ASM"]["unaffected"] = make_list("9.3.1HF4","9.4.5HF2","9.4.6-9.4.8","10","11");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("9.3.0-9.3.1","9.4.0-9.4.5");
vmatrix["GTM"]["unaffected"] = make_list("9.3.1HF4","9.4.5HF2","9.4.6-9.4.8","10","11");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("9.3.0-9.3.1","9.4.0-9.4.5");
vmatrix["LC"]["unaffected"] = make_list("9.3.1HF4","9.4.5HF2","9.4.6-9.4.8","10","11");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("9.3.0-9.3.1","9.4.0-9.4.5","9.6.0-9.6.1");
vmatrix["LTM"]["unaffected"] = make_list("9.3.1HF4","9.4.5HF2","9.4.6-9.4.8","9.6.1HF2","10","11");

# PSM
vmatrix["PSM"] = make_array();
vmatrix["PSM"]["affected"  ] = make_list("9.4.0-9.4.5");
