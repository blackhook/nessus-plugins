...
# extracted from Fedora Security Advisory 2014-11370.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11370");

  script_name(english:"Fedora 19 : nginx-1.4.7-3.fc19 (2014-11370)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/140309.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6beffa5f"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"nginx-1.4.7-3.fc19")) flag++;
