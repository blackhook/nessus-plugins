...
# extracted from Fedora Security Advisory FEDORA-2016-505d7fe198.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-505d7fe198");

  script_name(english:"Fedora 25 : libgit2 (2016-505d7fe198)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-505d7fe198"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libgit2-0.24.2-2.fc25")) flag++;
