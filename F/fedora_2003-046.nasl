...
# extracted from Fedora Security Advisory 2003-046.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2003-046");

  script_name(english:"Fedora Core 1 : kernel-2.4.22-1.2138.nptl (2003-046)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-January/000032.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?568e7688"
  );
...
flag = 0;
if (rpm_check(release:"FC1", cpu:"i386", reference:"kernel-2.4.22-1.2138.nptl")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"kernel-BOOT-2.4.22-1.2138.nptl")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"kernel-debuginfo-2.4.22-1.2138.nptl")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"kernel-doc-2.4.22-1.2138.nptl")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"kernel-smp-2.4.22-1.2138.nptl")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"kernel-source-2.4.22-1.2138.nptl")) flag++;
