...
# extracted from Fedora Security Advisory FEDORA-2018-ff58779d1b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : ca-certificates (2018-ff58779d1b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ff58779d1b"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"ca-certificates-2018.2.26-1.0.fc28")) flag++;
