...
# extracted from Fedora Security Advisory 2008-10638.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : samba-3.0.33-0.fc8 (2008-10638)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-December/017051.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c2c7e5a"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"samba-3.0.33-0.fc8")) flag++;
