...
# extracted from Fedora Security Advisory 2015-8745.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8745");

  script_name(english:"Fedora 20 : batik-1.8-0.12.svn1230816.fc20 (2015-8745)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159423.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4df4fbdf"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"batik-1.8-0.12.svn1230816.fc20")) flag++;
