...
# extracted from Fedora Security Advisory FEDORA-2018-de6d032aae.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-de6d032aae");

  script_name(english:"Fedora 27 : lighttpd (2018-de6d032aae)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-de6d032aae"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC27", reference:"lighttpd-1.4.51-1.fc27")) flag++;
