...
# extracted from Fedora Security Advisory FEDORA-2017-d9cac37bd8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d9cac37bd8");

  script_name(english:"Fedora 26 : postgresql (2017-d9cac37bd8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d9cac37bd8"
  );
  # https://www.postgresql.org/docs/9.6/static/release-9-6-4.html
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"postgresql-9.6.4-1.fc26")) flag++;
