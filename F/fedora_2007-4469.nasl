...
# extracted from Fedora Security Advisory 2007-4469.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : autofs-5.0.1-29 (2007-4469)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=421351"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-December/005936.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d563a94"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"autofs-5.0.1-29")) flag++;
if (rpm_check(release:"FC7", reference:"autofs-debuginfo-5.0.1-29")) flag++;
