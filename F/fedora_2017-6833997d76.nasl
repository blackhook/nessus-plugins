...
# extracted from Fedora Security Advisory FEDORA-2017-6833997d76.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-6833997d76");

  script_name(english:"Fedora 26 : cacti (2017-6833997d76)");
...
"  - Update to 1.1.16
  ...
  - CVE-2017-12065 CVE-2017-12066

Release notes: https://www.cacti.net/release_notes.php?version=1.1.16
...
Release notes: https://www.cacti.net/release_notes.php?version=1.1.14
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6833997d76"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.cacti.net/release_notes.php?version=1.1.14"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"cacti-1.1.16-1.fc26")) flag++;
