...
# extracted from Fedora Security Advisory FEDORA-2016-cef912e3a4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : 1:oxygen-icon-theme / breeze-icon-theme / extra-cmake-modules / kf5 / etc (2016-cef912e3a4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-cef912e3a4"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"oxygen-icon-theme-5.24.0-1.fc23", epoch:"1")) flag++;
if (rpm_check(release:"FC23", reference:"breeze-icon-theme-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"extra-cmake-modules-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-attica-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-baloo-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-bluez-qt-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-frameworkintegration-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kactivities-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kactivities-stats-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kapidox-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-karchive-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kauth-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kbookmarks-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kcmutils-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kcodecs-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kcompletion-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kconfig-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kconfigwidgets-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kcoreaddons-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kcrash-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdbusaddons-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdeclarative-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kded-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdelibs4support-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdesignerplugin-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdesu-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdewebkit-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdnssd-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kdoctools-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kemoticons-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kfilemetadata-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kglobalaccel-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kguiaddons-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-khtml-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-ki18n-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kiconthemes-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kidletime-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kimageformats-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kinit-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kio-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kitemmodels-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kitemviews-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kjobwidgets-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kjs-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kjsembed-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kmediaplayer-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-knewstuff-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-knotifications-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-knotifyconfig-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kpackage-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kparts-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kpeople-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kplotting-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kpty-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kross-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-krunner-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kservice-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-ktexteditor-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-ktextwidgets-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kunitconversion-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kwallet-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kwayland-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kwidgetsaddons-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kwindowsystem-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kxmlgui-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-kxmlrpcclient-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-modemmanager-qt-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-networkmanager-qt-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-plasma-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-solid-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-sonnet-5.24.0-1.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"kf5-threadweaver-5.24.0-1.fc23")) flag++;
