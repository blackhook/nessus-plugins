...
# extracted from Fedora Security Advisory 2009-10461.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10461");

  script_name(english:"Fedora 10 : slim-1.3.1-9.fc10 (2009-10461)");
...
"  - Sat Oct 10 2009 Lorenzo Villani <lvillani at
    ...
    - Sat Feb 28 2009 Anders F Bjorklund <afb at
      users.sourceforge.net> 1.3.1-5

    - provide service(graphical-login) for anaconda
      yuminstall (#485789)

    - Sun Feb 22 2009 Anders F Bjorklund <afb at
      users.sourceforge.net> 1.3.1-4

    - Add header for remove(3)

    - Wed Feb 4 2009 Anders F Bjorklund <afb at
      users.sourceforge.net> 1.3.1-3

    - use small 'default_blue' background, instead of large
      compat 'default'
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030416.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c3da8d17"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"slim-1.3.1-9.fc10")) flag++;
