...
# extracted from Fedora Security Advisory FEDORA-2016-7eea952041.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-7eea952041");

  script_name(english:"Fedora 23 : golang (2016-7eea952041)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-7eea952041"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"golang-1.5.4-5.fc23")) flag++;
