...
# extracted from Fedora Security Advisory FEDORA-2021-bedb7cc66e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-bedb7cc66e");

  script_name(english:"Fedora 33 : clamav (2021-bedb7cc66e)");
...
FEDORA-2021-bedb7cc66e advisory.

  - 0.103.2 (#1947267) https://blog.clamav.net/2021/04/clamav-01032-security-patch-release.html
    (FEDORA-2021-bedb7cc66e)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-bedb7cc66e");
...
pkgs = [
    {'reference':'clamav-0.103.2-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
