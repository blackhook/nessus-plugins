...
# extracted from Fedora Security Advisory 2015-9309.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-9309");

  script_name(english:"Fedora 22 : libreswan-3.13-1.fc22 (2015-9309)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159980.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?57a90104"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"libreswan-3.13-1.fc22")) flag++;
