...
# extracted from Fedora Security Advisory FEDORA-2017-e698bba980.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-e698bba980");

  script_name(english:"Fedora 25 : freeradius (2017-e698bba980)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e698bba980"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"freeradius-3.0.14-1.fc25")) flag++;
