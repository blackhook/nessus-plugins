...
# extracted from Fedora Security Advisory FEDORA-2016-7209ab4e02.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : ntp (2016-7209ab4e02)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-7209ab4e02"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ntp-4.2.6p5-43.fc25")) flag++;
