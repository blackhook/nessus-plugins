...
# extracted from Fedora Security Advisory 2015-6170.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6170");

  script_name(english:"Fedora 22 : java-1.8.0-openjdk-1.8.0.45-31.b13.fc22 (2015-6170)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155836.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6408fca5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"java-1.8.0-openjdk-1.8.0.45-31.b13.fc22")) flag++;
