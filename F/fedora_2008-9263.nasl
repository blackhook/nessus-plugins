...
# extracted from Fedora Security Advisory 2008-9263.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : ed-1.1-1.fc9 (2008-9263)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-October/015813.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d1c15960"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"ed-1.1-1.fc9")) flag++;
