...
# extracted from Fedora Security Advisory FEDORA-2016-430bc0f808.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-430bc0f808");

  script_name(english:"Fedora 23 : p7zip (2016-430bc0f808)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-430bc0f808"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"p7zip-16.02-1.fc23")) flag++;
