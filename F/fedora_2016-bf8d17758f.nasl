...
# extracted from Fedora Security Advisory FEDORA-2016-bf8d17758f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : php-horde-horde (2016-bf8d17758f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-bf8d17758f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"php-horde-horde-5.2.12-1.fc24")) flag++;
