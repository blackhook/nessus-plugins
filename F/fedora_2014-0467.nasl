...
# extracted from Fedora Security Advisory 2014-0467.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-0467");

  script_name(english:"Fedora 19 : libXfont-1.4.5-5.fc19 (2014-0467)");
  ...
  script_set_attribute(
    ...
    value:
"Fix CVE-2013-6462, potential stack overflow, see
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-January/127429.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7c6ae38e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libXfont-1.4.5-5.fc19")) flag++;
