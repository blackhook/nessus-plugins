...
# extracted from Fedora Security Advisory 2011-0631.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : perl-CGI-Simple-1.113-1.fc13 (2011-0631)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053576.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d4df5f4f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"perl-CGI-Simple-1.113-1.fc13")) flag++;
