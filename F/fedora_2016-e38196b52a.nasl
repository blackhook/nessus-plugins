...
# extracted from Fedora Security Advisory FEDORA-2016-e38196b52a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e38196b52a");

  script_name(english:"Fedora 24 : 32:bind (2016-e38196b52a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e38196b52a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"bind-9.10.4-2.P4.fc24", epoch:"32")) flag++;
