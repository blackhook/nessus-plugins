...
# extracted from Fedora Security Advisory FEDORA-2019-78aa18e571.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : chromium (2019-78aa18e571)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-78aa18e571"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"chromium-77.0.3865.120-1.fc30", allowmaj:TRUE)) flag++;
