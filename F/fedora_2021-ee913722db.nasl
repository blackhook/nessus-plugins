...
# extracted from Fedora Security Advisory FEDORA-2021-ee913722db
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ee913722db");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 33 : mingw-c-ares (2021-ee913722db)");
...
FEDORA-2021-ee913722db advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ee913722db");
  script_set_attribute(attribute:"solution", value:
"Update the affected mingw-c-ares package.");
...
pkgs = [
    {'reference':'mingw-c-ares-1.17.1-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
