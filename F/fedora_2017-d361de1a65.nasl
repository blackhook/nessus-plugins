...
# extracted from Fedora Security Advisory FEDORA-2017-d361de1a65.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d361de1a65");

  script_name(english:"Fedora 25 : libwmf (2017-d361de1a65)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d361de1a65"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libwmf-0.2.8.4-53.fc25")) flag++;
