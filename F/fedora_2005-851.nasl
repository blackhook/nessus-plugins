...
# extracted from Fedora Security Advisory 2005-851.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-851");

  script_name(english:"Fedora Core 4 : squid-2.5.STABLE9-8 (2005-851)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001333.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f010c758"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"squid-2.5.STABLE9-8")) flag++;
if (rpm_check(release:"FC4", reference:"squid-debuginfo-2.5.STABLE9-8")) flag++;
