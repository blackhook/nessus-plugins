...
# extracted from Fedora Security Advisory FEDORA-2020-a1b4d24680.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-a1b4d24680");

  script_name(english:"Fedora 31 : moodle (2020-a1b4d24680)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-a1b4d24680"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"moodle-3.7.6-1.fc31")) flag++;
