...
# extracted from Fedora Security Advisory FEDORA-2019-b4356521ba.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 2:runc (2019-b4356521ba)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-b4356521ba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"runc-1.0.0-67.dev.git12f6a99.fc29", epoch:"2")) flag++;
