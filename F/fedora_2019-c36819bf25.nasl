...
# extracted from Fedora Security Advisory FEDORA-2019-c36819bf25.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : glpi (2019-c36819bf25)");
...
This release also fix some minor issues.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c36819bf25"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"glpi-9.3.4-1.fc29")) flag++;
