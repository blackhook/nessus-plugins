...
# extracted from F5 Networks BIG-IP Solution K05046514.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K05046514)");
...
cause a denial of service (client-server association tear down) by
sending broadcast packets with invalid authentication to a broadcast
client. (CVE-2015-7979)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K05046514"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
