...
# extracted from Fedora Security Advisory 2015-5546.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5546");

  script_name(english:"Fedora 20 : arj-3.10.22-22.fc20 (2015-5546)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154605.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24bcd9b2"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"arj-3.10.22-22.fc20")) flag++;
