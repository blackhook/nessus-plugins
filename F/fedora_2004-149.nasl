...
# extracted from Fedora Security Advisory 2004-149.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-149");

  script_name(english:"Fedora Core 1 : krb5-1.3.3-6 (2004-149)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000153.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2d06dbd4"
  );
...
flag = 0;
if (rpm_check(release:"FC1", reference:"krb5-debuginfo-1.3.3-6")) flag++;
if (rpm_check(release:"FC1", reference:"krb5-devel-1.3.3-6")) flag++;
if (rpm_check(release:"FC1", reference:"krb5-libs-1.3.3-6")) flag++;
if (rpm_check(release:"FC1", reference:"krb5-server-1.3.3-6")) flag++;
if (rpm_check(release:"FC1", reference:"krb5-workstation-1.3.3-6")) flag++;
