...
# extracted from Fedora Security Advisory 2015-10848.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-10848");

  script_name(english:"Fedora 21 : pam-1.1.8-19.fc21 (2015-10848)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fe71f108"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"pam-1.1.8-19.fc21")) flag++;
