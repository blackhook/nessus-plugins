...
# extracted from Fedora Security Advisory 2011-17289.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : python-virtualenv-1.7-1.fc16 (2011-17289)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-January/071638.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2f5e9b8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"python-virtualenv-1.7-1.fc16")) flag++;
