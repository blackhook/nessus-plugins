...
# extracted from Fedora Security Advisory 2010-9061.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : mysql-5.1.47-1.fc11 (2010-9061)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://dev.mysql.com/doc/refman/5.1/en/news-5-1-47.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/042551.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a3154703"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"mysql-5.1.47-1.fc11")) flag++;
