...
# extracted from Fedora Security Advisory FEDORA-2021-2cb0643316
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : roundcubemail (2021-2cb0643316)");
...
FEDORA-2021-2cb0643316 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-2cb0643316");
...
pkgs = [
    {'reference':'roundcubemail-1.4.10-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
