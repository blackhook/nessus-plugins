...
# extracted from Fedora Security Advisory 2012-16033.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 17 : haproxy-1.4.22-1.fc17 (2012-16033)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090601.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?18afb8cd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"haproxy-1.4.22-1.fc17")) flag++;
