...
# extracted from F5 Networks BIG-IP Solution K17246.
#
...
if (description)
{
  ...
  script_bugtraq_id(74450);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (K17246)");
...
system call after a disconnect. (CVE-2015-3636)

Impact

A locally authenticated user, with a role that allows advanced shell
access, may be able to escalate privileges or cause a
denial-of-service (DoS) attack."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17246"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["APM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.1.0-11.5.4");
vmatrix["ASM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.1.0-11.5.4");
vmatrix["AVR"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5","11.0.0");
...
vmatrix["LC"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0","11.6.0-11.6.1","11.1.0-11.5.4");
vmatrix["LTM"]["unaffected"] = make_list("13.0.0","12.1.0-12.1.2","12.0.0HF1","11.6.2","11.5.5","11.0.0","10.1.0-10.2.4");
