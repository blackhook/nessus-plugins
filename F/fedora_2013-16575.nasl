...
# extracted from Fedora Security Advisory 2013-16575.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16575");

  script_name(english:"Fedora 18 : glpi-0.83.9.1-4.fc18 (2013-16575)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/116050.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7cdb9ec"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"glpi-0.83.9.1-4.fc18")) flag++;
