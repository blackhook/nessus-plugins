...
# extracted from Fedora Security Advisory 2015-0611.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : libsndfile-1.0.25-9.fc20 (2015-0611)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148331.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f67f3941"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libsndfile-1.0.25-9.fc20")) flag++;
