...
# extracted from Fedora Security Advisory FEDORA-2016-0df69ab477.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0df69ab477");

  script_name(english:"Fedora 25 : libX11 (2016-0df69ab477)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-7942, CVE-2016-7943
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0df69ab477"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libX11-1.6.4-1.fc25")) flag++;
