...
# extracted from Fedora Security Advisory 2009-8177.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8177");

  script_name(english:"Fedora 11 : Django-1.0.3-6.fc11 (2009-8177)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027339.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4887f3fd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"Django-1.0.3-6.fc11")) flag++;
