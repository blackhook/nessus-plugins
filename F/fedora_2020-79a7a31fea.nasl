...
# extracted from Fedora Security Advisory FEDORA-2020-79a7a31fea.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : spice-gtk (2020-79a7a31fea)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-79a7a31fea"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"spice-gtk-0.39-1.fc33")) flag++;
