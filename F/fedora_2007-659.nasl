...
# extracted from Fedora Security Advisory 2007-659.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : xorg-x11-xinit-1.0.2-16.fc6 (2007-659)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-August/003159.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?64dab9ef"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"xorg-x11-xinit-1.0.2-16.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-xinit-debuginfo-1.0.2-16.fc6")) flag++;
