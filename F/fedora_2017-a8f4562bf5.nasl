...
# extracted from Fedora Security Advisory FEDORA-2017-a8f4562bf5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : postgresql (2017-a8f4562bf5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/9.5/release-9-5-7.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a8f4562bf5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"postgresql-9.5.7-1.fc25")) flag++;
