...
# extracted from Fedora Security Advisory 2008-11220.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : roundcubemail-0.2-4.beta.fc8 (2008-11220)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-December/017693.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b1cb141"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"roundcubemail-0.2-4.beta.fc8")) flag++;
