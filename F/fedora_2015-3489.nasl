...
# extracted from Fedora Security Advisory 2015-3489.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3489");

  script_name(english:"Fedora 21 : libgcrypt-1.6.3-1.fc21 (2015-3489)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152065.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24389202"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"libgcrypt-1.6.3-1.fc21")) flag++;
