...
# extracted from Fedora Security Advisory 2009-2179.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2179");

  script_name(english:"Fedora 9 : rubygem-actionpack-2.1.1-2.fc9 (2009-2179)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/020757.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8eff9cda"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"rubygem-actionpack-2.1.1-2.fc9")) flag++;
