...
# extracted from Fedora Security Advisory 2015-360b358af4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-360b358af4");

  script_name(english:"Fedora 22 : webkitgtk-2.4.9-2.fc22 / webkitgtk3-2.4.9-2.fc22 (2015-360b358af4)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-October/168740.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1d1173a"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-October/168741.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?07ecd465"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"webkitgtk-2.4.9-2.fc22")) flag++;
if (rpm_check(release:"FC22", reference:"webkitgtk3-2.4.9-2.fc22")) flag++;
