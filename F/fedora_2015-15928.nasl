...
# extracted from Fedora Security Advisory 2015-15928.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-15928");

  script_name(english:"Fedora 22 : openjpeg2-2.1.0-6.fc22 (2015-15928)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7d02fa2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"openjpeg2-2.1.0-6.fc22")) flag++;
