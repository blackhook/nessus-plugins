...
# extracted from Fedora Security Advisory FEDORA-2017-6f3ea63acc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-6f3ea63acc");

  script_name(english:"Fedora 25 : tor (2017-6f3ea63acc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6f3ea63acc"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"tor-0.2.9.10-1.fc25")) flag++;
