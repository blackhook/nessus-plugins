...
# extracted from Fedora Security Advisory 2012-13244.
#
...
if (description)
{
  ...
  script_bugtraq_id(54863);
  script_xref(name:"FEDORA", value:"2012-13244");

  script_name(english:"Fedora 17 : pnp4nagios-0.6.16-4.fc17 (2012-13244)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086161.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8adbd275"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"pnp4nagios-0.6.16-4.fc17")) flag++;
