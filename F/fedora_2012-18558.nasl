...
# extracted from Fedora Security Advisory 2012-18558.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 17 : claws-mail-3.9.0-1.fc17 / claws-mail-plugins-3.9.0-2.fc17 (2012-18558)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/093768.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a67e566"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/093769.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aa490849"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"claws-mail-3.9.0-1.fc17")) flag++;
if (rpm_check(release:"FC17", reference:"claws-mail-plugins-3.9.0-2.fc17")) flag++;
