...
# extracted from Fedora Security Advisory 2014-15811.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15811");

  script_name(english:"Fedora 19 : graphviz-2.30.1-13.fc19 (2014-15811)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145748.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?722fe223"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"graphviz-2.30.1-13.fc19")) flag++;
