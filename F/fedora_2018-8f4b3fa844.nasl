...
# extracted from Fedora Security Advisory FEDORA-2018-8f4b3fa844.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : sharutils (2018-8f4b3fa844)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-8f4b3fa844"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"sharutils-4.15.2-8.fc27")) flag++;
