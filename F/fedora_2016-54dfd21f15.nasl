...
# extracted from Fedora Security Advisory FEDORA-2016-54dfd21f15.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-54dfd21f15");

  script_name(english:"Fedora 23 : nfdump (2016-54dfd21f15)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-54dfd21f15"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"nfdump-1.6.15-1.fc23")) flag++;
