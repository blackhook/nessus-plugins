...
# extracted from F5 Networks BIG-IP Solution K16914.
#
...
if (description)
{
  ...
  script_bugtraq_id(75161);

  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (K16914)");
...
that had been obtained earlier. (CVE-2015-1791)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16914"
  );
  script_set_attribute(
    attribute:"solution",
    value:
