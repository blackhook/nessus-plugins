...
# extracted from Fedora Security Advisory 2012-14149.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14149");

  script_name(english:"Fedora 17 : dhcp-4.2.4-13.P2.fc17 (2012-14149)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97a9680f"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"dhcp-4.2.4-13.P2.fc17")) flag++;
