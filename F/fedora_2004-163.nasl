...
# extracted from Fedora Security Advisory 2004-163.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-163");

  script_name(english:"Fedora Core 1 : squid-2.5.STABLE3-2.fc1 (2004-163)");
...
"  - Mon Jun 07 2004 Jay Fenlason <fenlason at redhat.com>
  ...
  - Backport patch for CVE-2004-0541: buffer overflow in
    ntlm auth helper.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000159.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a3dffcbd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", reference:"squid-2.5.STABLE3-2.fc1")) flag++;
if (rpm_check(release:"FC1", reference:"squid-debuginfo-2.5.STABLE3-2.fc1")) flag++;
