...
# extracted from Fedora Security Advisory 2009-9554.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-9554");

  script_name(english:"Fedora 11 : bugzilla-3.2.5-1.fc11 (2009-9554)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-September/029299.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8cb260b9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"bugzilla-3.2.5-1.fc11")) flag++;
