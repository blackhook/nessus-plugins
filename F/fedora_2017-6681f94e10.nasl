...
# extracted from Fedora Security Advisory FEDORA-2017-6681f94e10.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-8642");
  script_xref(name:"FEDORA", value:"2017-6681f94e10");

  script_name(english:"Fedora 24 : moodle (2017-6681f94e10)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6681f94e10"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"moodle-3.1.4-1.fc24")) flag++;
