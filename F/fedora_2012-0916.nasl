...
# extracted from Fedora Security Advisory 2012-0916.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-0916");

  script_name(english:"Fedora 15 : bip-0.8.8-2.fc15 (2012-0916)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=784299"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/072767.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e057d2e2"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"bip-0.8.8-2.fc15")) flag++;
