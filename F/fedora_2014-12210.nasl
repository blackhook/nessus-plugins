...
# extracted from Fedora Security Advisory 2014-12210.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12210");

  script_name(english:"Fedora 21 : mksh-50c-1.fc21 (2014-12210)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/140359.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f9c4193"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mksh-50c-1.fc21")) flag++;
