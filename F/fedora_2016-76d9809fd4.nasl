...
# extracted from Fedora Security Advisory FEDORA-2016-76d9809fd4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : w3m (2016-76d9809fd4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-76d9809fd4"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"w3m-0.5.3-27.git20161120.fc24")) flag++;
