...
# extracted from Fedora Security Advisory 2009-8324.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8324");

  script_name(english:"Fedora 11 : squid-3.0.STABLE18-1.fc11 (2009-8324)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/028040.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dec0e98d"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"squid-3.0.STABLE18-1.fc11")) flag++;
