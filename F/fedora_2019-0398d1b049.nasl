...
# extracted from Fedora Security Advisory FEDORA-2019-0398d1b049.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : haproxy (2019-0398d1b049)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0398d1b049"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"haproxy-1.8.17-1.fc28")) flag++;
