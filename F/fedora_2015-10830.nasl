...
# extracted from Fedora Security Advisory 2015-10830.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-10830");

  script_name(english:"Fedora 22 : pam-1.1.8-19.fc22 (2015-10830)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1228571"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/161249.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?75643046"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"pam-1.1.8-19.fc22")) flag++;
