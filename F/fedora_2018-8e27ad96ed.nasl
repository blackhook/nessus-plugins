...
# extracted from Fedora Security Advisory FEDORA-2018-8e27ad96ed.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-15670", "CVE-2017-15671", "CVE-2017-15804", "CVE-2017-16997", "CVE-2018-1000001");
  script_xref(name:"FEDORA", value:"2018-8e27ad96ed");

  script_name(english:"Fedora 26 : glibc (2018-8e27ad96ed)");
...
"This update addresses two security vulnerabilities :
  ...
  - CVE-2017-15670, CVE-2017-15671, CVE-2017-15804: Various
    vulnerabilities could lead to memory corruption in the
    `glob` and `glob64` function. (RHBZ#1505298,
    RHBZ##1504807)
...
In addition, this update replaces the dynamic linker trampoline on
x86-64 with a version which uses the `XSAVE` instruction if it is
available. This improves compatibility with future hardware and
compilers which do not follow the x86-64 ABI. This update also adjusts
the thread stack size accounting to provide additional stack space
compared to previous glibc versions (to avoid introducing
RHBZ#1527887).
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-8e27ad96ed"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"glibc-2.25-13.fc26")) flag++;
