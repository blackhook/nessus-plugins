...
# extracted from Fedora Security Advisory 2012-8675.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8675");

  script_name(english:"Fedora 16 : arpwatch-2.1a15-18.fc16 (2012-8675)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?95e76911"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"arpwatch-2.1a15-18.fc16")) flag++;
