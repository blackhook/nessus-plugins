...
# extracted from Fedora Security Advisory 2013-14482.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : libtomcrypt-1.17-20.fc19 / libtommath-0.42.0-2.fc19 (2013-14482)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5deb3735"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/114307.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e2496dfe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libtomcrypt-1.17-20.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"libtommath-0.42.0-2.fc19")) flag++;
