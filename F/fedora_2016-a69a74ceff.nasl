...
# extracted from Fedora Security Advisory FEDORA-2016-a69a74ceff.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : openvpn (2016-a69a74ceff)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a69a74ceff"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"openvpn-2.3.11-1.fc22")) flag++;
