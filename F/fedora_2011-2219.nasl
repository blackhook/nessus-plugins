...
# extracted from Fedora Security Advisory 2011-2219.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-2219");

  script_name(english:"Fedora 15 : moin-1.9.3-4.fc15 (2011-2219)");
  ...
  script_set_attribute(
    ...
    value:
"  - Bug #679523 - CVE-2011-1058 MoinMoin: XSS in the rst
    parser
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/054544.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d172ad63"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"moin-1.9.3-4.fc15")) flag++;
