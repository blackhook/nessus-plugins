...
# extracted from Fedora Security Advisory 2015-6974.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : dpkg-1.16.16-5.fc22 (2015-6974)");
...
dpkg-perl-libexecdir.patch Revert location of dpkg/parsechangelog .
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/157387.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b4af65f"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"dpkg-1.16.16-5.fc22")) flag++;
