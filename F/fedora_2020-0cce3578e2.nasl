...
# extracted from Fedora Security Advisory FEDORA-2020-0cce3578e2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-0cce3578e2");

  script_name(english:"Fedora 32 : gnutls (2020-0cce3578e2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0cce3578e2"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"gnutls-3.6.14-1.fc32")) flag++;
