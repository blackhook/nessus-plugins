...
# extracted from Fedora Security Advisory 2008-5480.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : libetpan-0.54-1.fc8 (2008-5480)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-June/011787.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4dfe2e8a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"libetpan-0.54-1.fc8")) flag++;
