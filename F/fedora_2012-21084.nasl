...
# extracted from Fedora Security Advisory 2012-21084.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-21084");

  script_name(english:"Fedora 18 : php-pear-CAS-1.3.2-1.fc18 (2012-21084)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/096294.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7d270d15"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"php-pear-CAS-1.3.2-1.fc18")) flag++;
