...
# extracted from Fedora Security Advisory FEDORA-2017-d51eedb333.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d51eedb333");

  script_name(english:"Fedora 26 : smb4k (2017-d51eedb333)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d51eedb333"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"smb4k-1.2.3-1.fc26")) flag++;
