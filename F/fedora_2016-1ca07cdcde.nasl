...
# extracted from Fedora Security Advisory FEDORA-2016-1ca07cdcde.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-1ca07cdcde");

  script_name(english:"Fedora 23 : p7zip (2016-1ca07cdcde)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-1ca07cdcde"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2016/11/12");
...
flag = 0;
if (rpm_check(release:"FC23", reference:"p7zip-16.02-2.fc23")) flag++;
