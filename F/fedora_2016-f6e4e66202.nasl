...
# extracted from Fedora Security Advisory FEDORA-2016-f6e4e66202.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-f6e4e66202");
  script_xref(name:"IAVA", value:"2017-A-0004");

  script_name(english:"Fedora 25 : bind99 (2016-f6e4e66202)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f6e4e66202"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"bind99-9.9.9-2.P3.fc25")) flag++;
