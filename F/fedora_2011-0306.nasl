...
# extracted from Fedora Security Advisory 2011-0306.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0306");

  script_name(english:"Fedora 13 : wordpress-2.8.6-4.fc13 (2011-0306)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=666781"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053293.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?96d0119b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"wordpress-2.8.6-4.fc13")) flag++;
