...
# extracted from Fedora Security Advisory 2014-8515.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-8515");

  script_name(english:"Fedora 19 : drupal7-7.29-1.fc19 (2014-8515)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1120641"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/136125.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b992319a"
  );
  # https://www.drupal.org/drupal-7.29-release-notes
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/project/drupal/releases/7.29"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"drupal7-7.29-1.fc19")) flag++;
