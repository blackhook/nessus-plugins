...
# extracted from Fedora Security Advisory 2013-7339.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-7339");

  script_name(english:"Fedora 19 : libtiff-4.0.3-6.fc19 (2013-7339)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=952131"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=952158"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/104916.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?db930e9a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libtiff-4.0.3-6.fc19")) flag++;
