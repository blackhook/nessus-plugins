...
# extracted from Fedora Security Advisory 2008-2587.
#
...
if (description)
{
  ...
  script_bugtraq_id(28105);
  script_xref(name:"FEDORA", value:"2008-2587");

  script_name(english:"Fedora 7 : gallery2-2.2.4-3.fc7 (2008-2587)");
...
"  - Thu Mar 20 2008 John Berninger <john at ncphotography
    ...
    - Fri Aug 31 2007 John Berninger <john at ncphotography
      dot com> - 2.2-0.7.svn20070831

    - update to 2.2.3 SVN snapshot to fix security vuln's -
      bz 267421

    - Tue Jun 5 2007 John Berninger <johnw at
      berningeronline dot net> - 2.2-0.6.svn20070506

    - Fix escaping syntax problem in post scriptlet

    - Tue May 15 2007 John Berninger <johnw at
      berningeronline dot net> - 2.2-0.5.svn20070506
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=435810"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-April/009383.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?03b28483"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC7", reference:"gallery2-2.2.4-3.fc7")) flag++;
