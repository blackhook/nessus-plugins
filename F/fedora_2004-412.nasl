...
# extracted from Fedora Security Advisory 2004-412.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-412");

  script_name(english:"Fedora Core 3 : gd-2.0.28-1.30.1 (2004-412)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-November/000392.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?62e8eb7d"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"gd-2.0.28-1.30.1")) flag++;
if (rpm_check(release:"FC3", reference:"gd-debuginfo-2.0.28-1.30.1")) flag++;
if (rpm_check(release:"FC3", reference:"gd-devel-2.0.28-1.30.1")) flag++;
if (rpm_check(release:"FC3", reference:"gd-progs-2.0.28-1.30.1")) flag++;
