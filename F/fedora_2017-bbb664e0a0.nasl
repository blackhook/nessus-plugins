...
# extracted from Fedora Security Advisory FEDORA-2017-bbb664e0a0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : mingw-poppler (2017-bbb664e0a0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-bbb664e0a0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-poppler-0.52.0-3.fc26")) flag++;
