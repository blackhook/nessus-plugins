...
# extracted from Fedora Security Advisory 2004-300.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-300");

  script_name(english:"Fedora Core 1 : imlib-1.9.13-15.fc1 (2004-300)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-September/000288.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77b119e5"
  );
...
flag = 0;
if (rpm_check(release:"FC1", reference:"imlib-1.9.13-15.fc1")) flag++;
if (rpm_check(release:"FC1", reference:"imlib-cfgeditor-1.9.13-15.fc1")) flag++;
if (rpm_check(release:"FC1", reference:"imlib-debuginfo-1.9.13-15.fc1")) flag++;
if (rpm_check(release:"FC1", reference:"imlib-devel-1.9.13-15.fc1")) flag++;
