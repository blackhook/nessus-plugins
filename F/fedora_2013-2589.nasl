...
# extracted from Fedora Security Advisory 2013-2589.
#
...
if (description)
{
  ...
  script_bugtraq_id(57971);
  script_xref(name:"FEDORA", value:"2013-2589");

  script_name(english:"Fedora 17 : pigz-2.2.5-1.fc17 (2013-2589)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=911556"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-February/099279.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bbc68093"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"pigz-2.2.5-1.fc17")) flag++;
