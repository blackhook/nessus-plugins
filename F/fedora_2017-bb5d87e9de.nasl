...
# extracted from Fedora Security Advisory FEDORA-2017-bb5d87e9de.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : mingw-libzip (2017-bb5d87e9de)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-bb5d87e9de"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-libzip-1.1.3-3.fc25")) flag++;
