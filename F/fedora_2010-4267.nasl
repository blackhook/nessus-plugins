...
# extracted from Fedora Security Advisory 2010-4267.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-4267");

  script_name(english:"Fedora 13 : cpio-2.10-6.fc13 (2010-4267)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037582.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4d8aaf3c"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"cpio-2.10-6.fc13")) flag++;
