...
# extracted from Fedora Security Advisory 2009-2884.
#
...
if (description)
{
  ...
  script_bugtraq_id(33598, 33827, 33990);
  script_xref(name:"FEDORA", value:"2009-2884");

  script_name(english:"Fedora 9 : thunderbird-2.0.0.21-1.fc9 (2009-2884)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021564.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ce5a8e3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"thunderbird-2.0.0.21-1.fc9")) flag++;
