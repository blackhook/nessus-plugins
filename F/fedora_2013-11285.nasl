...
# extracted from Fedora Security Advisory 2013-11285.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-11285");

  script_name(english:"Fedora 18 : java-1.7.0-openjdk-1.7.0.25-2.3.10.3.fc18 (2013-11285)");
...
"  - Updated to latest IcedTea7-forest 2.3.10
  ...
  - this update is known to break icedtea-web. But also
    ...
    least icedtea-web-1.4-1.fc18 installed before tesitn
    appelts/javaws
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/109584.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6243efde"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"java-1.7.0-openjdk-1.7.0.25-2.3.10.3.fc18")) flag++;
