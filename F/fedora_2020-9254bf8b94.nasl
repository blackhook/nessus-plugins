...
# extracted from Fedora Security Advisory FEDORA-2020-9254bf8b94.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : nss (2020-9254bf8b94)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9254bf8b94"
  );
  # https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.49_release_notes
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"nss-3.49.0-1.fc30")) flag++;
