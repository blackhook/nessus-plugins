...
# extracted from Fedora Security Advisory FEDORA-2017-7e5b5201e7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-7e5b5201e7");

  script_name(english:"Fedora 25 : xen (2017-7e5b5201e7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7e5b5201e7"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"xen-4.7.2-4.fc25")) flag++;
