...
# extracted from Fedora Security Advisory 2010-3956.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-3956");

  script_name(english:"Fedora 12 : nss-3.12.6-1.2.fc12 (2010-3956)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037093.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9115bea6"
  );
...
flag = 0;
if (rpm_check(release:"FC12", reference:"nss-3.12.6-1.2.fc12")) flag++;
