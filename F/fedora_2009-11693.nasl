...
# extracted from Fedora Security Advisory 2009-11693.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11693");

  script_name(english:"Fedora 11 : wordpress-2.8.6-2.fc11 (2009-11693)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/031159.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8937ff0c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"wordpress-2.8.6-2.fc11")) flag++;
