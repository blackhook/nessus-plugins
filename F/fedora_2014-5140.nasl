...
# extracted from Fedora Security Advisory 2014-5140.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5140");

  script_name(english:"Fedora 20 : knot-1.4.5-1.fc20 (2014-5140)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/132084.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?99ef5eb9"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"knot-1.4.5-1.fc20")) flag++;
