...
# extracted from Fedora Security Advisory 2015-15981.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-15981");

  script_name(english:"Fedora 22 : wordpress-4.3.1-1.fc22 (2015-15981)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/167701.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cbd7704b"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"wordpress-4.3.1-1.fc22")) flag++;
