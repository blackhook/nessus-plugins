...
# extracted from Fedora Security Advisory 2009-10329.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10329");

  script_name(english:"Fedora 11 : python-markdown2-1.0.1.15-1.fc11 (2009-10329)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030427.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7de3cc90"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"python-markdown2-1.0.1.15-1.fc11")) flag++;
