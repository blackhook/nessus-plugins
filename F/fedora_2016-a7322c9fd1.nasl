...
# extracted from Fedora Security Advisory FEDORA-2016-a7322c9fd1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a7322c9fd1");

  script_name(english:"Fedora 23 : spice (2016-a7322c9fd1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a7322c9fd1"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"spice-0.12.8-1.fc23")) flag++;
