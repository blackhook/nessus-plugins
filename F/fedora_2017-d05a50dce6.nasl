...
# extracted from Fedora Security Advisory FEDORA-2017-d05a50dce6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d05a50dce6");

  script_name(english:"Fedora 27 : mingw-poppler (2017-d05a50dce6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d05a50dce6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mingw-poppler-0.57.0-2.fc27")) flag++;
