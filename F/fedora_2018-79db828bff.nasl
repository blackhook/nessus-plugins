...
# extracted from Fedora Security Advisory FEDORA-2018-79db828bff.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : firefox (2018-79db828bff)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-79db828bff"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"firefox-58.0.1-1.fc27")) flag++;
