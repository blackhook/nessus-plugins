...
# extracted from Fedora Security Advisory 2009-7337.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-7337");

  script_name(english:"Fedora 9 : phpMyAdmin-3.2.0.1-1.fc9 (2009-7337)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026079.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ce04e26"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"phpMyAdmin-3.2.0.1-1.fc9")) flag++;
