...
# extracted from Fedora Security Advisory 2006-868.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-868");

  script_name(english:"Fedora Core 5 : gnupg-1.4.5-2 (2006-868)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-August/000482.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b658b27"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC5", reference:"gnupg-1.4.5-2")) flag++;
if (rpm_check(release:"FC5", reference:"gnupg-debuginfo-1.4.5-2")) flag++;
