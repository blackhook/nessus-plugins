...
# extracted from Fedora Security Advisory FEDORA-2019-40ed49f449.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : community-mysql (2019-40ed49f449)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-40ed49f449"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"community-mysql-8.0.18-4.fc30")) flag++;
