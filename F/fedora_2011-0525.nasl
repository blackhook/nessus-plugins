...
# extracted from Fedora Security Advisory 2011-0525.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0525");

  script_name(english:"Fedora 13 : hplip-3.10.9-14.fc13 (2011-0525)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053472.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd890f6c"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"hplip-3.10.9-14.fc13")) flag++;
