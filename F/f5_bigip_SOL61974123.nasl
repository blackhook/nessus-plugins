...
# extracted from F5 Networks BIG-IP Solution K61974123.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : ImageMagick vulnerability (K61974123)");
...
forgery (SSRF) attacks via a crafted image. (CVE-2016-3718)
...
known as ImageTragick."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K61974123"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
Solution K61974123."
  ...
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:C/C:N/I:H/A:N");
