...
# extracted from Fedora Security Advisory 2005-852.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-852");

  script_name(english:"Fedora Core 3 : squid-2.5.STABLE9-1.FC3.7 (2005-852)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Sep 6 2005 Martin Stransky <stransky at redhat.com>
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001334.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1a5eb97b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"squid-2.5.STABLE9-1.FC3.7")) flag++;
if (rpm_check(release:"FC3", reference:"squid-debuginfo-2.5.STABLE9-1.FC3.7")) flag++;
