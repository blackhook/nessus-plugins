...
# extracted from Fedora Security Advisory FEDORA-2019-08c700185f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : community-mysql (2019-08c700185f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-08c700185f"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2019/12/07");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"community-mysql-8.0.18-4.fc31")) flag++;
