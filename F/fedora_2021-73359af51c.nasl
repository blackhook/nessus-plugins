...
# extracted from Fedora Security Advisory FEDORA-2021-73359af51c
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : roundcubemail (2021-73359af51c)");
...
FEDORA-2021-73359af51c advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-73359af51c");
...
pkgs = [
    {'reference':'roundcubemail-1.4.10-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
