...
# extracted from Fedora Security Advisory FEDORA-2017-6be762ea64.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : python (2017-6be762ea64)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6be762ea64"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"python-2.7.13-3.fc25")) flag++;
