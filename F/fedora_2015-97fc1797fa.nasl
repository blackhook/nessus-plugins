...
# extracted from Fedora Security Advisory 2015-97fc1797fa.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-97fc1797fa");

  script_name(english:"Fedora 22 : mingw-libpng-1.6.19-1.fc22 (2015-97fc1797fa)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/172797.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9d98d59e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"mingw-libpng-1.6.19-1.fc22")) flag++;
