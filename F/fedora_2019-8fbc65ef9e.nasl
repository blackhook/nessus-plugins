...
# extracted from Fedora Security Advisory FEDORA-2019-8fbc65ef9e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : nss (2019-8fbc65ef9e)");
...
Updates the nss package to upstream NSS 3.47.1.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8fbc65ef9e"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"nss-3.47.1-4.fc30")) flag++;
