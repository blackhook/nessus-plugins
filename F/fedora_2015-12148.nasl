...
# extracted from Fedora Security Advisory 2015-12148.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-12148");

  script_name(english:"Fedora 21 : wordpress-4.2.4-1.fc21 (2015-12148)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-August/163720.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9af9c336"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"wordpress-4.2.4-1.fc21")) flag++;
