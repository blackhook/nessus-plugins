...
# extracted from Fedora Security Advisory FEDORA-2016-e9e5c081d4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e9e5c081d4");

  script_name(english:"Fedora 24 : 4:perl (2016-e9e5c081d4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e9e5c081d4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"perl-5.22.2-362.fc24", epoch:"4")) flag++;
