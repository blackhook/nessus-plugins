...
# extracted from Fedora Security Advisory FEDORA-2017-24f067299e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-24f067299e");
  script_xref(name:"IAVA", value:"2017-A-0284-S");

  script_name(english:"Fedora 26 : dnsmasq (2017-24f067299e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-24f067299e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"dnsmasq-2.76-5.fc26")) flag++;
