...
# extracted from Fedora Security Advisory 2009-2131.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2131");

  script_name(english:"Fedora 10 : mingw32-libpng-1.2.35-1.fc10 (2009-2131)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/020741.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9a79eafd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"mingw32-libpng-1.2.35-1.fc10")) flag++;
