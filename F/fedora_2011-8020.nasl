...
# extracted from Fedora Security Advisory 2011-8020.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-8020");

  script_name(english:"Fedora 13 : java-1.6.0-openjdk-1.6.0.0-51.1.8.8.fc13 (2011-8020)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061434.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea9a82d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"java-1.6.0-openjdk-1.6.0.0-51.1.8.8.fc13")) flag++;
