...
# extracted from Fedora Security Advisory FEDORA-2018-ccbe8b931c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : spatialite-tools / sqlite (2018-ccbe8b931c)");
...
sqlite rebased to version 3.26.0 per:
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ccbe8b931c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"spatialite-tools-4.3.0-31.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"sqlite-3.26.0-1.fc29")) flag++;
