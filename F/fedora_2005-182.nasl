...
# extracted from Fedora Security Advisory 2005-182.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-182");

  script_name(english:"Fedora Core 3 : firefox-1.0.1-1.3.1 (2005-182)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000727.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d343877d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"firefox-1.0.1-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"firefox-debuginfo-1.0.1-1.3.1")) flag++;
