...
# extracted from Fedora Security Advisory 2006-1109.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1109");

  script_name(english:"Fedora Core 6 : ruby-1.8.5-4.fc6 (2006-1109)");
...
[plus 360 lines in the Changelog]
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-October/000717.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?584a7c5b"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"ruby-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-debuginfo-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-devel-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-docs-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-irb-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-libs-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-mode-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-rdoc-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-ri-1.8.5-4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"ruby-tcltk-1.8.5-4.fc6")) flag++;
