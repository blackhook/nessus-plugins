...
# extracted from Fedora Security Advisory 2014-13537.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13537");

  script_name(english:"Fedora 21 : wpa_supplicant-2.0-12.fc21 (2014-13537)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1151259"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/143100.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c842ad03"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"wpa_supplicant-2.0-12.fc21")) flag++;
