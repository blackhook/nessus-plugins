...
# extracted from Fedora Security Advisory 2014-10445.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : qemu-1.6.2-8.fc20 (2014-10445)");
...
"  - Fix spice audio playback sample rate (bz #1129961)
    ...
    - Fix virtio-blk migration incompatibility caused by CVE
      backport (bz #1115604)

    - CVE-2014-3615 Fix crash when guest sets high
      resolution (bz #1139121, bz #1139115)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d3134c89"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"qemu-1.6.2-8.fc20")) flag++;
