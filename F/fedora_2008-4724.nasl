...
# extracted from Fedora Security Advisory 2008-4724.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : samba-3.2.0-1.rc1.14.fc9 (2008-4724)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=446724"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-May/010682.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f18615b9"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"samba-3.2.0-1.rc1.14.fc9")) flag++;
