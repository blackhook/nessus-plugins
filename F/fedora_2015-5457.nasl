...
# extracted from Fedora Security Advisory 2015-5457.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5457");

  script_name(english:"Fedora 21 : php-symfony-2.5.11-1.fc21 (2015-5457)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154708.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca565f1d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"php-symfony-2.5.11-1.fc21")) flag++;
