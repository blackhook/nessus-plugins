...
if (description)
{
  ...
  script_cve_id("CVE-2016-6867", "CVE-2016-6868");

  script_name(english:"Foxit PhantomPDF < 8.0.2 Multiple Vulnerabilities");
...
8.0.2. It is, therefore, affected by multiple vulnerabilities.");
...
"Upgrade to Foxit PhantomPDF version 8.0.2 or later.");
