...
# extracted from Fedora Security Advisory 2005-1078.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1078");

  script_name(english:"Fedora Core 3 : lynx-2.8.5-18.0.2 (2005-1078)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-November/001578.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e82b6ef9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"lynx-2.8.5-18.0.2")) flag++;
if (rpm_check(release:"FC3", reference:"lynx-debuginfo-2.8.5-18.0.2")) flag++;
