...
# extracted from Fedora Security Advisory FEDORA-2020-b00f3fbb69.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : seamonkey (2020-b00f3fbb69)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b00f3fbb69"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"seamonkey-2.53.1-2.fc30")) flag++;
