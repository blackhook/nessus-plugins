...
# extracted from Fedora Security Advisory FEDORA-2017-ce66f11df1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ce66f11df1");

  script_name(english:"Fedora 24 : deluge (2017-ce66f11df1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ce66f11df1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"deluge-1.3.14-1.fc24")) flag++;
