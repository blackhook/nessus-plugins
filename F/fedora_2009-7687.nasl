...
# extracted from Fedora Security Advisory 2009-7687.
#
...
if (description)
{
  ...
  script_bugtraq_id(35604);
  script_xref(name:"FEDORA", value:"2009-7687");

  script_name(english:"Fedora 11 : bugzilla-3.2.4-1.fc11 (2009-7687)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/027123.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f4cdf2ac"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"bugzilla-3.2.4-1.fc11")) flag++;
