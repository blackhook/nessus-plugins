...
# extracted from Fedora Security Advisory 2007-677.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : libvorbis-1.1.2-2.fc6 (2007-677)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-August/003622.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ae2b1f7a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"libvorbis-1.1.2-2.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"libvorbis-debuginfo-1.1.2-2.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"libvorbis-devel-1.1.2-2.fc6")) flag++;
