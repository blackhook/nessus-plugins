...
# extracted from Fedora Security Advisory 2015-12699.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-12699");

  script_name(english:"Fedora 22 : devscripts-2.15.8-1.fc22 (2015-12699)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-August/163705.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?186bd1b6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"devscripts-2.15.8-1.fc22")) flag++;
