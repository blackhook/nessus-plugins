...
# extracted from Fedora Security Advisory FEDORA-2021-65100169e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-65100169e4");

  script_name(english:"Fedora 32 : mosquitto (2021-65100169e4)");
...
FEDORA-2021-65100169e4 advisory.

  - Update to 1.6.14  https://mosquitto.org/blog/2021/03/version-2-0-9-released/ (FEDORA-2021-65100169e4)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-65100169e4");
...
pkgs = [
    {'reference':'mosquitto-1.6.14-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
