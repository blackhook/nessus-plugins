...
# extracted from Fedora Security Advisory 2015-5503.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5503");

  script_name(english:"Fedora 22 : python-httplib2-0.9-6.fc22 (2015-5503)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=958638"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154921.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed5651f4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"python-httplib2-0.9-6.fc22")) flag++;
