...
# extracted from Fedora Security Advisory 2013-8193.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 18 : python-virtualenv-1.9.1-1.fc18 (2013-8193)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/105952.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8871a1f7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"python-virtualenv-1.9.1-1.fc18")) flag++;
