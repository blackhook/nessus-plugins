...
# extracted from Fedora Security Advisory 2004-318.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-318");

  script_name(english:"Fedora Core 2 : subversion-1.0.8-1 (2004-318)");
...
including a security fix for information disclosure bugs in handling
of metadata (such as log messages) in repositories using mod_authz_svn
for path-based access-control (CVE-2004-0749).
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-September/000304.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6eb8c3c5"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"mod_dav_svn-1.0.8-1")) flag++;
if (rpm_check(release:"FC2", reference:"subversion-1.0.8-1")) flag++;
if (rpm_check(release:"FC2", reference:"subversion-debuginfo-1.0.8-1")) flag++;
if (rpm_check(release:"FC2", reference:"subversion-devel-1.0.8-1")) flag++;
if (rpm_check(release:"FC2", reference:"subversion-perl-1.0.8-1")) flag++;
