...
# extracted from Fedora Security Advisory FEDORA-2017-81cf93b7c2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-81cf93b7c2");

  script_name(english:"Fedora 27 : rubygems (2017-81cf93b7c2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-81cf93b7c2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"rubygems-2.6.13-100.fc27")) flag++;
