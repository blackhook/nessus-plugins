...
# extracted from Fedora Security Advisory 2010-15120.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : bzip2-1.0.6-1.fc13 (2010-15120)");
  ...
  script_set_attribute(
    ...
    value:
"  - Wed Sep 22 2010 Ivana Hutarova Varekova <varekova at
    redhat.com> - 1.0.6-1
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-September/048294.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ee3fb1e"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"bzip2-1.0.6-1.fc13")) flag++;
