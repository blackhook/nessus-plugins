...
# extracted from Fedora Security Advisory FEDORA-2017-a8dc348834.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : pcre (2017-a8dc348834)");
  ...
  script_set_attribute(
    ...
    value:
"This release fixes pcregrep multi-line matching with --only-matching
option, a crash when JIT-compiling some patterns (CVE-2017-6004) and a
possible buffer overflow when formatting a pcregrep error message.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a8dc348834"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"pcre-8.40-2.fc24")) flag++;
