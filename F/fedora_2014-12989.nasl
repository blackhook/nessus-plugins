...
# extracted from Fedora Security Advisory 2014-12989.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12989");

  script_name(english:"Fedora 20 : zarafa-7.1.11-1.fc20 (2014-12989)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/143105.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9f711e89"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"zarafa-7.1.11-1.fc20")) flag++;
