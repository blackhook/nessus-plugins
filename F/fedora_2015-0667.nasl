...
# extracted from Fedora Security Advisory 2015-0667.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-0667");

  script_name(english:"Fedora 21 : python-pillow-2.6.1-2.fc21 (2015-0667)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes a potential denial-of-service during PNG
decompression.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1179354"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148442.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6d626c04"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"python-pillow-2.6.1-2.fc21")) flag++;
