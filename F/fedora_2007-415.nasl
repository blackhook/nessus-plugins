...
# extracted from Fedora Security Advisory 2007-415.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : php-5.1.6-3.5.fc6 (2007-415)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-April/001668.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1bb2304b"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"php-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-bcmath-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-cli-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-common-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-dba-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-debuginfo-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-devel-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-gd-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-imap-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-ldap-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-mbstring-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-mysql-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-ncurses-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-odbc-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-pdo-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-pgsql-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-snmp-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-soap-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-xml-5.1.6-3.5.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"php-xmlrpc-5.1.6-3.5.fc6")) flag++;
