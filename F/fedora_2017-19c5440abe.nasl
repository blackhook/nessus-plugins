...
# extracted from Fedora Security Advisory FEDORA-2017-19c5440abe.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-19c5440abe");

  script_name(english:"Fedora 24 : 1:tomcat (2017-19c5440abe)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-19c5440abe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"tomcat-8.0.41-1.fc24", epoch:"1")) flag++;
