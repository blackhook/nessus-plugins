...
# extracted from Fedora Security Advisory 2012-6365.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : openstack-nova-2011.3.1-8.fc16 (2012-6365)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=814361"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/079434.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7a072c0f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"openstack-nova-2011.3.1-8.fc16")) flag++;
