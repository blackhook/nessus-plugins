...
# extracted from Fedora Security Advisory FEDORA-2017-0ca78fabc5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0ca78fabc5");

  script_name(english:"Fedora 26 : libgxps (2017-0ca78fabc5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0ca78fabc5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libgxps-0.3.0-1.fc26")) flag++;
