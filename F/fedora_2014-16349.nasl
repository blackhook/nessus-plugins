...
# extracted from Fedora Security Advisory 2014-16349.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-16349");

  script_name(english:"Fedora 20 : jasper-1.900.1-27.fc20 (2014-16349)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/147536.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?be400c5b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"jasper-1.900.1-27.fc20")) flag++;
