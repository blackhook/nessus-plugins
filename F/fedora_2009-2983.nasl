...
# extracted from Fedora Security Advisory 2009-2983.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2983");

  script_name(english:"Fedora 9 : java-1.6.0-openjdk-1.6.0.0-0.21.b09.fc9 (2009-2983)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021651.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?363abd3f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"java-1.6.0-openjdk-1.6.0.0-0.21.b09.fc9")) flag++;
