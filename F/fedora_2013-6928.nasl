...
# extracted from Fedora Security Advisory 2013-6928.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-6928");

  script_name(english:"Fedora 19 : phpMyAdmin-3.5.8.1-1.fc19 (2013-6928)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b43e6f5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"phpMyAdmin-3.5.8.1-1.fc19")) flag++;
