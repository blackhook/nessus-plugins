...
# extracted from F5 Networks BIG-IP Solution K16506.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K16506)");
...
(CVE-2015-1799)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16506"
  );
  script_set_attribute(
    attribute:"solution",
    value:
