...
# extracted from Fedora Security Advisory FEDORA-2018-e6ee09fc50.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-e6ee09fc50");

  script_name(english:"Fedora 28 : thunderbird-enigmail (2018-e6ee09fc50)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e6ee09fc50"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC28", reference:"thunderbird-enigmail-2.0.6-1.fc28")) flag++;
