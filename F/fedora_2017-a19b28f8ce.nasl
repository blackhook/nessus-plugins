...
# extracted from Fedora Security Advisory FEDORA-2017-a19b28f8ce.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a19b28f8ce");

  script_name(english:"Fedora 26 : icu (2017-a19b28f8ce)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a19b28f8ce"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"icu-57.1-6.fc26")) flag++;
