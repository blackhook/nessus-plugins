...
# extracted from Fedora Security Advisory FEDORA-2018-669520d2ba.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : coreutils (2018-669520d2ba)");
  ...
  script_set_attribute(
    ...
    value:
"  - doc: warn about following symlinks recursively in
    chown/chgrp (CVE-2017-18018)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-669520d2ba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"coreutils-8.27-19.fc27")) flag++;
