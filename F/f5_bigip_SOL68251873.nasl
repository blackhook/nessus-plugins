...
a vulnerability as referenced in the K68251873 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K68251873");
...
var vmatrix = {
  'AFM': {
    'affected': [
      '16.0.0-16.1.0','15.1.0-15.1.3','14.1.0-14.1.4','13.1.0-13.1.4','12.1.0-12.1.5','11.6.1-11.6.5'
    ],
  },
  'AM': {
    'affected': [
