...
# extracted from Fedora Security Advisory 2010-19022.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-19022");

  script_name(english:"Fedora 13 : libwmf-0.2.8.4-22.fc13 (2010-19022)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/052854.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a0db570f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"libwmf-0.2.8.4-22.fc13")) flag++;
