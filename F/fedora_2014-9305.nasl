...
# extracted from Fedora Security Advisory 2014-9305.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9305");

  script_name(english:"Fedora 19 : krb5-1.11.3-25.fc19 (2014-9305)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1128157"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-August/137056.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b4aad56"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"krb5-1.11.3-25.fc19")) flag++;
