...
vmatrix["AFM"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.3.0-11.6.4");
vmatrix["AFM"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.4.0-11.6.4");
vmatrix["AM"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.0.0-11.6.4");
vmatrix["APM"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4","10.1.0-10.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.0.0-11.6.4");
vmatrix["ASM"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4","10.1.0-10.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.0.0-11.6.4");
vmatrix["AVR"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4");
...
vmatrix["LC"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.0.0-11.6.4");
vmatrix["LC"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4","10.1.0-10.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.0.0-11.6.4");
vmatrix["LTM"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4","10.1.0-10.2.4");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("14.0.0","13.0.0-13.1.1","11.3.0-11.6.4");
vmatrix["PEM"]["unaffected"] = make_list("14.1.0","12.0.0-12.1.4");
