...
affected."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K61705126"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["APM"]["affected"  ] = make_list("14.1.0-14.1.2","13.0.0-13.1.3","12.1.0-12.1.4","11.6.2-11.6.5");
vmatrix["APM"]["unaffected"] = make_list("15.1.0","15.0.0","14.1.2.1","13.1.3.2","12.1.5","11.6.5.1");
