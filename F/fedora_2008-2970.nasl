...
# extracted from Fedora Security Advisory 2008-2970.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : bzip2-1.0.4-13.fc8 (2008-2970)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes bzip2 denial of service (crash) on malformed
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=438118"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-April/009190.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a8a9b50f"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"bzip2-1.0.4-13.fc8")) flag++;
