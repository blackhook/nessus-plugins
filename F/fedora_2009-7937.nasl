...
# extracted from Fedora Security Advisory 2009-7937.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-7937");

  script_name(english:"Fedora 10 : znc-0.072-3.fc10 (2009-7937)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026894.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9e8f423a"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"znc-0.072-3.fc10")) flag++;
