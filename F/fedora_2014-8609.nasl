...
# extracted from Fedora Security Advisory 2014-8609.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : moodle-2.4.11-1.fc19 (2014-8609)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://seclists.org/oss-sec/2014/q3/195"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/136148.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7e8dcac"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC19", reference:"moodle-2.4.11-1.fc19")) flag++;
