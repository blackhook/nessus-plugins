...
# extracted from Fedora Security Advisory 2014-14084.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-14084");

  script_name(english:"Fedora 21 : firefox-33.0-1.fc21 (2014-14084)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/141796.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?db004610"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"firefox-33.0-1.fc21")) flag++;
