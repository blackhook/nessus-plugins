...
# extracted from Fedora Security Advisory 2009-6121.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6121");

  script_name(english:"Fedora 9 : icu-3.8.1-9.fc9 (2009-6121)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/024717.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d96de7a9"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"icu-3.8.1-9.fc9")) flag++;
