...
# extracted from Fedora Security Advisory 2011-7588.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7588");

  script_name(english:"Fedora 14 : drupal7-7.2-1.fc14 (2011-7588)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061190.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b50792a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"drupal7-7.2-1.fc14")) flag++;
