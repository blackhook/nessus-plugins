...
# extracted from Fedora Security Advisory FEDORA-2019-4942e01cdc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : libmodbus (2019-4942e01cdc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4942e01cdc"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libmodbus-3.0.8-1.fc30")) flag++;
