...
# extracted from Fedora Security Advisory 2008-1334.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : mailman-2.1.9-8.2.fc8 (2008-1334)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Feb 5 2008 Tomas Smetana <tsmetana at redhat.com> -
    3:2.1.9-8.2

    - patch for CVE-2008-0564; XSS triggerable by list
      administrator
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=431526"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-February/007833.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e1fe79d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"mailman-2.1.9-8.2.fc8")) flag++;
