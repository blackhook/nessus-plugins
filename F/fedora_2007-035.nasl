...
# extracted from Fedora Security Advisory 2007-035.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : xorg-x11-server-1.1.1-47.4.fc6 (2007-035)");
...
"  - Tue Jan 9 2007 Adam Jackson <ajax at redhat.com>
    ...
    - Tue Dec 5 2006 Adam Jackson <ajax at redhat.com>
      1.1.1-47.3.fc6

    - xorg-x11-server-1.1.1-xf86config-comment-less.patch:
      Added, makes pyxf86config not grow the config file
      every time it's run.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-January/001224.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cafabcda"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xdmx-1.1.1-47.4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xephyr-1.1.1-47.4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xnest-1.1.1-47.4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xorg-1.1.1-47.4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xvfb-1.1.1-47.4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-debuginfo-1.1.1-47.4.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-sdk-1.1.1-47.4.fc6")) flag++;
