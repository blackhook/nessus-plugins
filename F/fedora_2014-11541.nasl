...
# extracted from Fedora Security Advisory 2014-11541.
#
...
if (description)
{
  ...
  script_bugtraq_id(39895, 70091, 70092, 70093, 70094, 70096);
  script_xref(name:"FEDORA", value:"2014-11541");

  script_name(english:"Fedora 19 : libvncserver-0.9.10-0.6.20140718git9453be42.fc19 (2014-11541)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/139814.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f685cc61"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libvncserver-0.9.10-0.6.20140718git9453be42.fc19")) flag++;
