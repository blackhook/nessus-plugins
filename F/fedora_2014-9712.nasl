...
# extracted from Fedora Security Advisory 2014-9712.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2012-1571", "CVE-2014-3587");
  script_bugtraq_id(52225, 69325);
  script_xref(name:"FEDORA", value:"2014-9712");

  script_name(english:"Fedora 20 : file-5.19-4.fc20 (2014-9712)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d46fae9"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"file-5.19-4.fc20")) flag++;
