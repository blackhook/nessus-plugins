...
# extracted from Fedora Security Advisory FEDORA-2017-a9c79eed83.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a9c79eed83");

  script_name(english:"Fedora 27 : libgcrypt (2017-a9c79eed83)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a9c79eed83"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libgcrypt-1.8.1-1.fc27")) flag++;
