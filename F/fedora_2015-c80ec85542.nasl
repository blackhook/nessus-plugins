...
# extracted from Fedora Security Advisory 2015-c80ec85542.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-c80ec85542");

  script_name(english:"Fedora 23 : libpng15-1.5.25-1.fc23 (2015-c80ec85542)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-January/174905.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6624fc4b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"libpng15-1.5.25-1.fc23")) flag++;
