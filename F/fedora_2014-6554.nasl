...
# extracted from Fedora Security Advisory 2014-6554.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6554");

  script_name(english:"Fedora 20 : emacs-24.3-17.fc20 (2014-6554)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1095587"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133825.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ff0cb16d"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"emacs-24.3-17.fc20")) flag++;
