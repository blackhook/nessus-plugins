...
# extracted from Fedora Security Advisory 2006-1199.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1199");

  script_name(english:"Fedora Core 5 : firefox-1.5.0.8-1.fc5 (2006-1199)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-November/000845.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?93965e5b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC5", reference:"firefox-1.5.0.8-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"firefox-debuginfo-1.5.0.8-1.fc5")) flag++;
