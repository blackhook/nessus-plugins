...
# extracted from Fedora Security Advisory 2014-1341.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1341");

  script_name(english:"Fedora 20 : perl-MARC-XML-1.0.2-1.fc20 (2014-1341)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-January/127513.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8fc9e5a2"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC20", reference:"perl-MARC-XML-1.0.2-1.fc20")) flag++;
