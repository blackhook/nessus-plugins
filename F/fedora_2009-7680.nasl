...
# extracted from Fedora Security Advisory 2009-7680.
#
...
if (description)
{
  ...
  script_bugtraq_id(26355, 29902, 35307);
  script_xref(name:"FEDORA", value:"2009-7680");

  script_name(english:"Fedora 10 : perl-5.10.0-73.fc10 (2009-7680)");
...
modules. For example, a rebuild of perl-Wx against perl-5.10.0-73 will
fix bug 508496.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=504386"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=508496"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026536.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77b8ccca"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"perl-5.10.0-73.fc10")) flag++;
