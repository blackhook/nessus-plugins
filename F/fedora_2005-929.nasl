...
# extracted from Fedora Security Advisory 2005-929.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-929");

  script_name(english:"Fedora Core 4 : epiphany-1.6.5-2 (2005-929)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001416.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e9d8971"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"epiphany-1.6.5-2")) flag++;
if (rpm_check(release:"FC4", reference:"epiphany-debuginfo-1.6.5-2")) flag++;
if (rpm_check(release:"FC4", reference:"epiphany-devel-1.6.5-2")) flag++;
