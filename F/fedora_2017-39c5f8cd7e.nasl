...
# extracted from Fedora Security Advisory FEDORA-2017-39c5f8cd7e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-39c5f8cd7e");

  script_name(english:"Fedora 27 : sssd (2017-39c5f8cd7e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-39c5f8cd7e"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"sssd-1.15.3-5.fc27")) flag++;
