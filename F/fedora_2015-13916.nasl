...
# extracted from Fedora Security Advisory 2015-13916.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-13916");

  script_name(english:"Fedora 22 : drupal7-7.39-1.fc22 (2015-13916)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a43f03a6"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"drupal7-7.39-1.fc22")) flag++;
