...
# extracted from Fedora Security Advisory FEDORA-2017-ab4f51572f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : wavpack (2017-ab4f51572f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ab4f51572f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"wavpack-5.1.0-1.fc25")) flag++;
