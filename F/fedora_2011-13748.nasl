...
# extracted from Fedora Security Advisory 2011-13748.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-13748");

  script_name(english:"Fedora 16 : phpPgAdmin-5.0.3-1.fc16 (2011-13748)");
...
"  - Update to 5.0.3, per changes described at:
    ...
    =4E897F6C.90905%40free.fr&forum_name=phppgadmin-news
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/068009.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6745f04"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"phpPgAdmin-5.0.3-1.fc16")) flag++;
