...
# extracted from Fedora Security Advisory 2012-10420.
#
...
if (description)
{
  ...
  script_bugtraq_id(54277, 54278);
  script_xref(name:"FEDORA", value:"2012-10420");

  script_name(english:"Fedora 17 : openstack-nova-2012.1.1-3.fc17 (2012-10420)");
...
"  - Update to latest essex stable branch
    ...
    - Support injecting new .ssh/authorized_keys files to
      SELinux enabled guests
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-July/083984.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?075b52bf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"openstack-nova-2012.1.1-3.fc17")) flag++;
