...
# extracted from Fedora Security Advisory 2015-4690.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4690");

  script_name(english:"Fedora 22 : glpi-0.85.2-2.fc22 (2015-4690)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?264908b6"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"glpi-0.85.2-2.fc22")) flag++;
