...
# extracted from Fedora Security Advisory 2012-3705.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 15 : libpng-1.2.48-1.fc15 (2012-3705)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?605d323d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libpng-1.2.48-1.fc15")) flag++;
