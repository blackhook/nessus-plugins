...
# extracted from Fedora Security Advisory 2007-2020.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : gallery2-2.2-0.7.svn20070831.fc7 (2007-2020)");
...
CVE text: Multiple unspecified vulnerabilities in Gallery before 2.2.3
allow attackers to (1) rename items, (2) read and modify item
properties, or (3) lock and replace items via unknown vectors in (a)
the WebDAV module; and (4) edit unspecified data files using 'linked
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-September/003616.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?45da19c9"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"gallery2-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-ajaxian-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-albumselect-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-archiveupload-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-captcha-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-carbon-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-cart-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-classic-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-colorpack-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-comment-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-customfield-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-dcraw-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-debug-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-digibug-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-dynamicalbum-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-ecard-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-exif-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-ffmpeg-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-flashvideo-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-floatrix-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-fotokasten-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-gd-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-getid3-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-hidden-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-httpauth-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-hybrid-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-icons-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-imageblock-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-imageframe-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-imagemagick-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-itemadd-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-keyalbum-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-linkitem-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-matrix-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-members-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-migrate-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-mime-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-mp3audio-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-multilang-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-multiroot-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-netpbm-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-newitems-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-nokiaupload-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-panorama-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-password-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-permalinks-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-photoaccess-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-picasa-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-publishxp-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-quotas-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-randomhighlight-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-rating-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-rearrange-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-register-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-remote-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-replica-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-reupload-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-rewrite-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-rss-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-search-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-shutterfly-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-siriux-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-sitemap-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-sizelimit-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-slider-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-slideshow-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-slideshowapplet-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-squarethumb-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-thumbnail-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-thumbpage-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-tile-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-uploadapplet-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-useralbum-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-watermark-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-webcam-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-webdav-2.2-0.7.svn20070831.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"gallery2-zipcart-2.2-0.7.svn20070831.fc7")) flag++;
