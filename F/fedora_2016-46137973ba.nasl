...
# extracted from Fedora Security Advisory FEDORA-2016-46137973ba.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-46137973ba");

  script_name(english:"Fedora 25 : 32:bind (2016-46137973ba)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-46137973ba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"bind-9.10.4-2.P4.fc25", epoch:"32")) flag++;
