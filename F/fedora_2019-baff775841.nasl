...
# extracted from Fedora Security Advisory FEDORA-2019-baff775841.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : rdesktop (2019-baff775841)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 1.8.6 release which fixes a bug in 1.8.5. 1.8.5 is a
security release to address various buffer overflow and overrun issues
in the rdesktop protocol handling.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-baff775841"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"rdesktop-1.8.6-1.fc30")) flag++;
