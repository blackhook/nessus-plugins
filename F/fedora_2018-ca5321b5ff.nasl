...
# extracted from Fedora Security Advisory FEDORA-2018-ca5321b5ff.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-ca5321b5ff");

  script_name(english:"Fedora 28 : mysql-mmm (2018-ca5321b5ff)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ca5321b5ff"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"mysql-mmm-2.2.1-20.fc28")) flag++;
