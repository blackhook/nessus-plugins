...
# extracted from Fedora Security Advisory 2005-809.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-809");

  script_name(english:"Fedora Core 3 : php-4.3.11-2.7 (2005-809)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001301.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5033a9fd"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"php-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-debuginfo-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-devel-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-domxml-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-gd-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-imap-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-ldap-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-mbstring-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-mysql-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-ncurses-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-odbc-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-pear-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-pgsql-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-snmp-4.3.11-2.7")) flag++;
if (rpm_check(release:"FC3", reference:"php-xmlrpc-4.3.11-2.7")) flag++;
