...
# extracted from Fedora Security Advisory 2009-2834.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2834");

  script_name(english:"Fedora 9 : krb5-1.6.3-16.fc9 (2009-2834)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022151.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?70661daf"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"krb5-1.6.3-16.fc9")) flag++;
