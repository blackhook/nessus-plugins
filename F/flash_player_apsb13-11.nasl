...
if (description)
{
  ...
  script_name(english:"Flash Player <= 10.3.183.68 / 11.6.602.180 Multiple Vulnerabilities (APSB13-11)");
...
remote Windows host is 11.x equal or prior to 11.6.602.180, or 10.x
equal or prior to 10.3.183.68.  It is, therefore, potentially affected
...
"Upgrade to Adobe Flash Player version 10.3.183.75 / 11.7.700.169 or
later, or Google Chrome PepperFlash 11.7.700.179 or later.");
      ...
      if (ver)
      {
        ...
        )
        {
          ...
          if (variant == "Chrome_Pepper")
            info += '\n  Fixed version     : 11.7.700.179 (Chrome PepperFlash)';
          else
