...
# extracted from Fedora Security Advisory FEDORA-2017-704c201dbb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : subversion (2017-704c201dbb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-704c201dbb"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"subversion-1.9.6-2.fc26")) flag++;
