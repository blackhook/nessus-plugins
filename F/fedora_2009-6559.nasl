...
# extracted from Fedora Security Advisory 2009-6559.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6559");

  script_name(english:"Fedora 9 : moin-1.6.4-2.fc9 (2009-6559)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025156.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e59f414"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"moin-1.6.4-2.fc9")) flag++;
