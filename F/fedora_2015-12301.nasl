...
# extracted from Fedora Security Advisory 2015-12301.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : libuser-0.62-1.fc22 (2015-12301)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74330717"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"libuser-0.62-1.fc22")) flag++;
