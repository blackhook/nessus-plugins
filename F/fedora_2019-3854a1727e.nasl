...
# extracted from Fedora Security Advisory FEDORA-2019-3854a1727e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 1:java-1.8.0-openjdk (2019-3854a1727e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://mail.openjdk.java.net/pipermail/jdk8u-dev/2019-July/009840.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-3854a1727e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"java-1.8.0-openjdk-1.8.0.222.b10-0.fc29", epoch:"1")) flag++;
