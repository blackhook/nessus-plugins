...
# extracted from Fedora Security Advisory 2006-1012.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1012");

  script_name(english:"Fedora Core 5 : mono-1.1.13.7-2.fc5.1 (2006-1012)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-October/000646.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?93715b3d"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"bytefx-data-mysql-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"ibm-data-db2-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-basic-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-core-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-data-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-data-firebird-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-data-oracle-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-data-postgresql-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-data-sqlite-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-data-sybase-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-debuginfo-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-devel-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-extras-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-jscript-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-locale-extras-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-nunit-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-web-1.1.13.7-2.fc5.1")) flag++;
if (rpm_check(release:"FC5", reference:"mono-winforms-1.1.13.7-2.fc5.1")) flag++;
