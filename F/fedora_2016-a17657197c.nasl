...
# extracted from Fedora Security Advisory FEDORA-2016-a17657197c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : gstreamer-plugins-base (2016-a17657197c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a17657197c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"gstreamer-plugins-base-0.10.36-15.fc24")) flag++;
