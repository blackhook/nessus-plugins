...
# extracted from Fedora Security Advisory 2015-7057.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7057");

  script_name(english:"Fedora 20 : pdns-3.3.1-3.fc20 (2015-7057)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dae70072"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"pdns-3.3.1-3.fc20")) flag++;
