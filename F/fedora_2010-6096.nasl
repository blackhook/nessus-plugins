...
without introducing additional issues."
  ...
  # http://kde.org/announcements/announce-4.4.2.php
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.kde.org/announcements/announce-4.4.2.php"
  );
  # http://www.riverbankcomputing.co.uk/static/Downloads/PyQt4/ChangeLog
  script_set_attribute(
    attribute:"see_also",
    value:"https://riverbankcomputing.com/static/Downloads/PyQt4/ChangeLog"
  );
  # http://www.riverbankcomputing.co.uk/static/Downloads/sip4/ChangeLog
  script_set_attribute(
    attribute:"see_also",
    value:"https://riverbankcomputing.com/static/Downloads/sip4/ChangeLog"
  );
  script_set_attribute(
    attribute:"see_also",
