...
# extracted from Fedora Security Advisory FEDORA-2016-8d73759936.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-8d73759936");

  script_name(english:"Fedora 25 : mujs / zathura-pdf-mupdf (2016-8d73759936)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-8d73759936"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mujs-0-5.20160921git5c337af.fc25")) flag++;
if (rpm_check(release:"FC25", reference:"zathura-pdf-mupdf-0.3.0-2.fc25")) flag++;
