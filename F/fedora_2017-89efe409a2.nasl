...
# extracted from Fedora Security Advisory FEDORA-2017-89efe409a2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-89efe409a2");

  script_name(english:"Fedora 25 : weechat (2017-89efe409a2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-89efe409a2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"weechat-1.9.1-1.fc25")) flag++;
