...
# extracted from Fedora Security Advisory 2005-134.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-134");

  script_name(english:"Fedora Core 2 : kdegraphics-3.2.2-1.4 (2005-134)");
  ...
  script_set_attribute(
    ...
    value:
"  - Wed Feb 09 2005 Than Ngo <than at redhat.com>
    7:3.2.2-1.4
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000691.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e8ab2b44"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"kdegraphics-3.2.2-1.4")) flag++;
if (rpm_check(release:"FC2", reference:"kdegraphics-debuginfo-3.2.2-1.4")) flag++;
if (rpm_check(release:"FC2", reference:"kdegraphics-devel-3.2.2-1.4")) flag++;
