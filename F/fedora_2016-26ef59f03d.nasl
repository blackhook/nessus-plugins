...
# extracted from Fedora Security Advisory FEDORA-2016-26ef59f03d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : libwebp (2016-26ef59f03d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-26ef59f03d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libwebp-0.5.1-2.fc25")) flag++;
