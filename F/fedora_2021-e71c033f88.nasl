...
# extracted from Fedora Security Advisory FEDORA-2021-e71c033f88
#
...
if (description)
{
  ...
  script_cve_id("CVE-2021-29154", "CVE-2021-30178");
  script_xref(name:"FEDORA", value:"2021-e71c033f88");

  script_name(english:"Fedora 33 : kernel (2021-e71c033f88)");
...
FEDORA-2021-e71c033f88 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-e71c033f88");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2021-29154', 'CVE-2021-30178');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-e71c033f88');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.11.13-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
