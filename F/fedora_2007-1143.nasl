...
# extracted from Fedora Security Advisory 2007-1143.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : devhelp-0.13-9.fc7 (2007-1143)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/002805.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?37c0001e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC7", reference:"devhelp-0.13-9.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"devhelp-debuginfo-0.13-9.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"devhelp-devel-0.13-9.fc7")) flag++;
