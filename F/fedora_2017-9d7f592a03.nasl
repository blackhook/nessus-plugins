...
# extracted from Fedora Security Advisory FEDORA-2017-9d7f592a03.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-9d7f592a03");

  script_name(english:"Fedora 24 : wavpack (2017-9d7f592a03)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9d7f592a03"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"wavpack-5.1.0-1.fc24")) flag++;
