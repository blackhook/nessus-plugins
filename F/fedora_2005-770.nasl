...
# extracted from Fedora Security Advisory 2005-770.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-770");

  script_name(english:"Fedora Core 4 : slocate-2.7-22.fc4.1 (2005-770)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001271.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38d2984d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"slocate-2.7-22.fc4.1")) flag++;
if (rpm_check(release:"FC4", reference:"slocate-debuginfo-2.7-22.fc4.1")) flag++;
