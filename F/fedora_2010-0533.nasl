...
# extracted from Fedora Security Advisory 2010-0533.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : ruby-1.8.6.383-6.fc11 (2010-0533)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-January/033931.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e06cbe0"
  );
...
os_ver = os_ver[1];
if (! preg(pattern:"^11([^0-9]|$)", string:os_ver)) audit(AUDIT_OS_NOT, "Fedora 11.x", "Fedora " + os_ver);
...
flag = 0;
if (rpm_check(release:"FC11", reference:"ruby-1.8.6.383-6.fc11")) flag++;
