...
# extracted from Fedora Security Advisory 2016-1b264ab4a4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-1b264ab4a4");

  script_name(english:"Fedora 24 : qemu-2.5.0-10.fc24 (2016-1b264ab4a4)");
...
"  - CVE-2016-2538: Integer overflow in usb module (bz
    ...
    (bz #1307115) * Fix external snapshot any more after
    active committing (bz #1300209)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-March/179710.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?063ff697"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"qemu-2.5.0-10.fc24")) flag++;
