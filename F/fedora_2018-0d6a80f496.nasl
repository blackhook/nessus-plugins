...
# extracted from Fedora Security Advisory FEDORA-2018-0d6a80f496.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-0d6a80f496");

  script_name(english:"Fedora 26 : 3:mariadb (2018-0d6a80f496)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-0d6a80f496"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mariadb-10.1.30-1.fc26", epoch:"3")) flag++;
