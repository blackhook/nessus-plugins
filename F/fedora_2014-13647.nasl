...
# extracted from Fedora Security Advisory 2014-13647.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13647");

  script_name(english:"Fedora 21 : python-rhsm-1.13.6-1.fc21 / subscription-manager-1.13.6-1.fc21 (2014-13647)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/143169.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74a033dc"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/143170.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3723d5e1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC21", reference:"python-rhsm-1.13.6-1.fc21")) flag++;
if (rpm_check(release:"FC21", reference:"subscription-manager-1.13.6-1.fc21")) flag++;
