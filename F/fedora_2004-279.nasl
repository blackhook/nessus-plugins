...
# extracted from Fedora Security Advisory 2004-279.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-279");

  script_name(english:"Fedora Core 2 : gaim-0.82-0.FC2 (2004-279)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-August/000271.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?41515b08"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"gaim-0.82-0.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"gaim-debuginfo-0.82-0.FC2")) flag++;
