...
# extracted from F5 Networks BIG-IP Solution K58084500.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-0714");

  script_name(english:"F5 Networks BIG-IP : Apache Tomcat 6.x vulnerabilities (K58084500)");
...
crafted object in a session. (CVE-2016-0714)

Impact

A remote authenticated user may bypass the intended security manager
restrictions and execute arbitrary code in a privileged context by
exploiting this vulnerability via a web application that places a
...
in a way that exposes this vulnerability.
...
service is accessible only from the internal network."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K58084500"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
