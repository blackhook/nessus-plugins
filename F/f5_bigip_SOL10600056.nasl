...
# extracted from F5 Networks BIG-IP Solution K10600056.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K10600056)");
...
any restrictions. (CVE-2015-5300)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K10600056"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
