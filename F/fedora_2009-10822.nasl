...
# extracted from Fedora Security Advisory 2009-10822.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10822");

  script_name(english:"Fedora 10 : sahana-0.6.2.2-6.fc10 (2009-10822)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030380.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a3f211b9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"sahana-0.6.2.2-6.fc10")) flag++;
