...
# extracted from Fedora Security Advisory 2015-15364.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-15364");

  script_name(english:"Fedora 22 : qemu-2.3.1-3.fc22 (2015-15364)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/166798.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?35ca6a77"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"qemu-2.3.1-3.fc22")) flag++;
