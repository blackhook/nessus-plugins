...
# extracted from Fedora Security Advisory 2013-6262.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-6262");

  script_name(english:"Fedora 19 : libtirpc-0.2.3-2.fc19 (2013-6262)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-April/103835.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8cdcf95b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libtirpc-0.2.3-2.fc19")) flag++;
