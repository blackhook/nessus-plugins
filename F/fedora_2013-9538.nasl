...
# extracted from Fedora Security Advisory 2013-9538.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-9538");

  script_name(english:"Fedora 19 : bzr-2.5.1-11.fc19 (2013-9538)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/108021.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c68c1dee"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"bzr-2.5.1-11.fc19")) flag++;
