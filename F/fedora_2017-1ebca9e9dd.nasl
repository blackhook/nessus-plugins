...
# extracted from Fedora Security Advisory FEDORA-2017-1ebca9e9dd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1ebca9e9dd");

  script_name(english:"Fedora 27 : 1:java-1.8.0-openjdk (2017-1ebca9e9dd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1ebca9e9dd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"java-1.8.0-openjdk-1.8.0.151-1.b12.fc27", epoch:"1")) flag++;
