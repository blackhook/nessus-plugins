...
# extracted from Fedora Security Advisory 2010-6279.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-6279");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/06/15");

  script_name(english:"Fedora 13 : java-1.6.0-openjdk-1.6.0.0-37.b17.fc13 (2010-6279)");
...
without introducing additional issues.");
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/039049.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7bf6eb3");
...
flag = 0;
if (rpm_check(release:"FC13", reference:"java-1.6.0-openjdk-1.6.0.0-37.b17.fc13")) flag++;
