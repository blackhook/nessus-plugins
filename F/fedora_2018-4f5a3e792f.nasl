...
# extracted from Fedora Security Advisory FEDORA-2018-4f5a3e792f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-4f5a3e792f");

  script_name(english:"Fedora 27 : libXfont2 (2018-4f5a3e792f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-4f5a3e792f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libXfont2-2.0.3-1.fc27")) flag++;
