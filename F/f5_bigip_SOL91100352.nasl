...
# extracted from F5 Networks BIG-IP Solution K91100352.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Mozilla NSS vulnerability (K91100352)");
...
remote attackers to execute arbitrary code via crafted ASN.1 data in
an X.509 certificate. (CVE-2016-1950)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K91100352"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
