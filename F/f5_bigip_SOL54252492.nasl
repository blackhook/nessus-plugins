...
an attacker with local user access via a speculative buffer overflow
and side-channel analysis. (CVE-2018-3693 also known as Spectre or
Spectre-NG Variant 1.1)
...
F5 continues to investigate the impact of the Spectre-NG1.1
vulnerability on our products.F5 is also monitoring developments about
Spectre-NG 1.2 and awaiting evaluation by hardware vendors. F5 is
focused onproviding patched releases as soon as we have fully tested
and verified fixes. F5 will update this article with the most current
...
protected against Spectre-NG.

For vCMP environments, F5 believes that while the Spectre-NG Variant
1.1 attackdoes offer a theoretical possibility of guest-to-guest or
guest-to-host attacks, these would be very difficult to successfully
conduct in the BIG-IP environment.
...
vmatrix["AFM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["AFM"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["AM"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["APM"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["ASM"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["AVR"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["GTM"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["LC"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["LTM"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["PEM"]["unaffected"] = make_list("15.0.0","14.1.2.3");

# WAM
vmatrix["WAM"] = make_array();
vmatrix["WAM"]["affected"  ] = make_list("14.0.0-14.1.2","13.0.0-13.1.1","12.1.0-12.1.4","11.6.1-11.6.3","11.5.1-11.5.8","11.2.1");
vmatrix["WAM"]["unaffected"] = make_list("15.0.0","14.1.2.3");
