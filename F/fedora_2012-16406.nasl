...
# extracted from Fedora Security Advisory 2012-16406.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16406");

  script_name(english:"Fedora 18 : python-django-1.4.2-1.fc18 (2012-16406)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=865164"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090666.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0451143a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"python-django-1.4.2-1.fc18")) flag++;
