...
# extracted from Fedora Security Advisory FEDORA-2017-c756d37779.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c756d37779");

  script_name(english:"Fedora 25 : ikiwiki (2017-c756d37779)");
  ...
  script_set_attribute(
    ...
    value:
"Update to the latest stable version. See https://ikiwiki.info/news/
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c756d37779"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://ikiwiki.info/news/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ikiwiki-3.20170111-1.fc25")) flag++;
