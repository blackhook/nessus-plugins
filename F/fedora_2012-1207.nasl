...
# extracted from Fedora Security Advisory 2012-1207.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-1207");

  script_name(english:"Fedora 15 : pdns-2.9.22.6-1.fc15 (2012-1207)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=772581"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/073002.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4618471a"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"pdns-2.9.22.6-1.fc15")) flag++;
