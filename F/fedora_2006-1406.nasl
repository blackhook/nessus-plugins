...
# extracted from Fedora Security Advisory 2006-1406.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1406");

  script_name(english:"Fedora Core 6 : gnupg-1.4.6-2 (2006-1406)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-December/001064.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?199e731b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC6", reference:"gnupg-1.4.6-2")) flag++;
if (rpm_check(release:"FC6", reference:"gnupg-debuginfo-1.4.6-2")) flag++;
