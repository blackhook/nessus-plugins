...
# extracted from Fedora Security Advisory 2014-1803.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1803");

  script_name(english:"Fedora 20 : libpng15-1.5.17-2.fc20 (2014-1803)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?211d14d2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libpng15-1.5.17-2.fc20")) flag++;
