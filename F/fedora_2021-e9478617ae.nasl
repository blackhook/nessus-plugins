...
# extracted from Fedora Security Advisory FEDORA-2021-e9478617ae
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-e9478617ae");
  script_xref(name:"IAVB", value:"2021-B-0013-S");

  script_name(english:"Fedora 33 : ansible (2021-e9478617ae)");
...
FEDORA-2021-e9478617ae advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-e9478617ae");
...
pkgs = [
    {'reference':'ansible-2.9.18-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
