...
# extracted from Fedora Security Advisory FEDORA-2016-fce8b939c9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-fce8b939c9");

  script_name(english:"Fedora 25 : python-wikitcms (2016-fce8b939c9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-fce8b939c9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"python-wikitcms-2.1.10-1.fc25")) flag++;
