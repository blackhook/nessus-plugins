...
# extracted from Fedora Security Advisory 2016-b0c2412ab2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b0c2412ab2");

  script_name(english:"Fedora 22 : postgresql-9.4.6-1.fc22 (2016-b0c2412ab2)");
  ...
  script_set_attribute(
    ...
    value:
"minor version update with security fix for CVE-2016-0773
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c803bd3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"postgresql-9.4.6-1.fc22")) flag++;
