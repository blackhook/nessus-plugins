...
# extracted from Fedora Security Advisory 2014-9542.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9542");

  script_name(english:"Fedora 20 : perl-Plack-1.0031-1.fc20 (2014-9542)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-August/137115.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8d502033"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"perl-Plack-1.0031-1.fc20")) flag++;
