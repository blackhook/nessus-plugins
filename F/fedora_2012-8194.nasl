...
# extracted from Fedora Security Advisory 2012-8194.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8194");

  script_name(english:"Fedora 17 : python-tornado-2.2.1-1.fc17 (2012-8194)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/081486.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a23de46"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"python-tornado-2.2.1-1.fc17")) flag++;
