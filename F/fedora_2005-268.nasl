...
# extracted from Fedora Security Advisory 2005-268.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-268");

  script_name(english:"Fedora Core 3 : gtk2-2.4.14-3.fc3 (2005-268)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000829.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?25023bc5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"gtk2-2.4.14-3.fc3")) flag++;
if (rpm_check(release:"FC3", cpu:"i386", reference:"gtk2-devel-2.4.14-3.fc3")) flag++;
