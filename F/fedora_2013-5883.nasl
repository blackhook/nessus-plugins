...
# extracted from Fedora Security Advisory 2013-5883.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-5883");

  script_name(english:"Fedora 19 : xorg-x11-server-1.14.0-6.fc19 (2013-5883)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-April/104089.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78c6633e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"xorg-x11-server-1.14.0-6.fc19")) flag++;
