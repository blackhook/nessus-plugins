...
# extracted from Fedora Security Advisory FEDORA-2017-b469be1a72.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b469be1a72");

  script_name(english:"Fedora 27 : mingw-libidn2 (2017-b469be1a72)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b469be1a72"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mingw-libidn2-2.0.4-1.fc27")) flag++;
