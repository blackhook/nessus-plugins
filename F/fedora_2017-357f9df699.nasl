...
# extracted from Fedora Security Advisory FEDORA-2017-357f9df699.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : spatialite-tools / sqlite (2017-357f9df699)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2017-10989: Heap-buffer overflow in the
getNodeSize function

Additionally sqlite has been updated to version 3.19.3, and
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-357f9df699"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"spatialite-tools-4.3.0-23.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"sqlite-3.19.3-1.fc26")) flag++;
