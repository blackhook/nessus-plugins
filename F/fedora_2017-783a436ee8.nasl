...
# extracted from Fedora Security Advisory FEDORA-2017-783a436ee8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : postgresql (2017-783a436ee8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-783a436ee8"
  );
  # https://www.postgresql.org/docs/9.6/static/release-9-6-6.html
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC27", reference:"postgresql-9.6.6-1.fc27")) flag++;
