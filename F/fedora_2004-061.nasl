...
# extracted from Fedora Security Advisory 2004-061.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-061");

  script_name(english:"Fedora Core 1 : mutt-1.4.1-5 (2004-061)");
...
mutt to crash. This is the vulnerability fixed in the recently
released mutt-1.4.2.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-February/000059.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a9fb6c91"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", cpu:"i386", reference:"mutt-1.4.1-5")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"mutt-debuginfo-1.4.1-5")) flag++;
