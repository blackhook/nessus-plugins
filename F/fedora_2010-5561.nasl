...
# extracted from Fedora Security Advisory 2010-5561.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2010-0174", "CVE-2010-0175", "CVE-2010-0176");
  script_bugtraq_id(39122, 39123, 39125, 39128);
  script_xref(name:"FEDORA", value:"2010-5561");

  script_name(english:"Fedora 13 : sunbird-1.0-0.21.20090916hg.fc13 / thunderbird-3.0.4-1.fc13 (2010-5561)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/038406.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1cc264df"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/038407.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ad4bc61"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"sunbird-1.0-0.21.20090916hg.fc13")) flag++;
if (rpm_check(release:"FC13", reference:"thunderbird-3.0.4-1.fc13")) flag++;
