...
# extracted from Fedora Security Advisory 2009-2982.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2982");

  script_name(english:"Fedora 10 : java-1.6.0-openjdk-1.6.0.0-11.b14.fc10 (2009-2982)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021650.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cc44d6e1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"java-1.6.0-openjdk-1.6.0.0-11.b14.fc10")) flag++;
