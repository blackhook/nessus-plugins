...
# extracted from Fedora Security Advisory 2012-8217.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8217");

  script_name(english:"Fedora 16 : python-tornado-2.2.1-1.fc16 (2012-8217)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=822852"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/081511.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c90fd04d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"python-tornado-2.2.1-1.fc16")) flag++;
