...
if (description)
{
  ...
  script_name(english:"Flash Player <= 10.3.183.50 / 11.5.502.146 Multiple Vulnerabilities (APSB13-04)");
...
remote Windows host is 11.x equal or prior to 11.5.502.146, or 10.x
equal or prior to 10.3.183.50.  It is, therefore, potentially affected
...
"Upgrade to Adobe Flash Player version 10.3.183.51 / 11.5.502.149 or
later, or Google Chrome PepperFlash 11.5.31.139 or later.");
      ...
      if (ver)
      {
        ...
        )
        {
          ...
          if (variant == "Chrome_Pepper")
            info += '\n  Fixed version     : 11.5.31.139 (Chrome PepperFlash)';
          else
