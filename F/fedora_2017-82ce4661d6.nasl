...
# extracted from Fedora Security Advisory FEDORA-2017-82ce4661d6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : drupal7-views (2017-82ce4661d6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-82ce4661d6"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"drupal7-views-3.15-1.fc25")) flag++;
