...
# extracted from Fedora Security Advisory 2012-5026.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-5026");

  script_name(english:"Fedora 16 : openstack-nova-2011.3.1-7.fc16 (2012-5026)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=808150"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/077047.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a1c4744c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"openstack-nova-2011.3.1-7.fc16")) flag++;
