...
# extracted from Fedora Security Advisory 2013-8284.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-8284");

  script_name(english:"Fedora 17 : thunderbird-17.0.6-1.fc17 (2013-8284)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/107436.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78025708"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"thunderbird-17.0.6-1.fc17")) flag++;
