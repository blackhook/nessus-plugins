...
# extracted from Fedora Security Advisory 2011-2790.
#
...
if (description)
{
  ...
  script_bugtraq_id(46756);
  script_xref(name:"FEDORA", value:"2011-2790");

  script_name(english:"Fedora 15 : cgit-0.9-1.fc15 (2011-2790)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?54104cfa"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"cgit-0.9-1.fc15")) flag++;
