...
# extracted from Fedora Security Advisory 2013-11281.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-11281");

  script_name(english:"Fedora 17 : java-1.7.0-openjdk-1.7.0.25-2.3.10.3.fc17 (2013-11281)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/109575.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?95a1c3e9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"java-1.7.0-openjdk-1.7.0.25-2.3.10.3.fc17")) flag++;
