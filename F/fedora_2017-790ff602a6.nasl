...
# extracted from Fedora Security Advisory FEDORA-2017-790ff602a6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-790ff602a6");

  script_name(english:"Fedora 24 : 1:perl-XML-LibXML (2017-790ff602a6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-790ff602a6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"perl-XML-LibXML-2.0128-2.fc24", epoch:"1")) flag++;
