...
# extracted from Fedora Security Advisory 2014-14252.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : fedup-0.9.0-2.fc19 (2014-14252)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1066679"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/142698.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?caf4852c"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected fedup package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:fedup");
...
flag = 0;
if (rpm_check(release:"FC19", reference:"fedup-0.9.0-2.fc19")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "fedup");
}
