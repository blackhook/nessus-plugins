...
# extracted from Fedora Security Advisory 2014-16234.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : openvpn-2.3.6-1.fc19 / pkcs11-helper-1.11-3.fc19 (2014-16234)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/146029.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fbe72017"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/146030.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b28831fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"openvpn-2.3.6-1.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"pkcs11-helper-1.11-3.fc19")) flag++;
