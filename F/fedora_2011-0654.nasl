...
# extracted from Fedora Security Advisory 2011-0654.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : perl-CGI-3.51-1.fc13 (2011-0654)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053601.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0cdbf7fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"perl-CGI-3.51-1.fc13")) flag++;
