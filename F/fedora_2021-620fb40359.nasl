...
# extracted from Fedora Security Advisory FEDORA-2021-620fb40359
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : kernel / kernel-headers (2021-620fb40359)");
...
FEDORA-2021-620fb40359 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-620fb40359");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-620fb40359');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.10.7-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kernel-headers-5.10.7-200.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
