...
# extracted from Fedora Security Advisory 2014-6408.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6408");

  script_name(english:"Fedora 20 : mutt-1.5.23-2.fc20 (2014-6408)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133435.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dcfd76e6"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"mutt-1.5.23-2.fc20")) flag++;
