...
# extracted from Fedora Security Advisory FEDORA-2021-7d55c00267
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-7d55c00267");

  script_name(english:"Fedora 32 : switchboard-plug-bluetooth (2021-7d55c00267)");
...
FEDORA-2021-7d55c00267 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-7d55c00267");
...
pkgs = [
    {'reference':'switchboard-plug-bluetooth-2.3.5-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
