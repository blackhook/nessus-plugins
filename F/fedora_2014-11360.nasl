...
# extracted from Fedora Security Advisory 2014-11360.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11360");
  script_xref(name:"IAVA", value:"2014-A-0142");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/07/28");
  script_xref(name:"CEA-ID", value:"CEA-2019-0240");

  script_name(english:"Fedora 20 : bash-4.2.47-4.fc20 (2014-11360)");
...
without introducing additional issues.");
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/138583.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3beab4d1");
...
flag = 0;
if (rpm_check(release:"FC20", reference:"bash-4.2.47-4.fc20")) flag++;
