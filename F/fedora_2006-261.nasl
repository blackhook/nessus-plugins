...
# extracted from Fedora Security Advisory 2006-261.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-261");

  script_name(english:"Fedora Core 4 : dia-0.94-13.fc4 (2006-261)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-April/001984.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?382c0d1d"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"dia-0.94-13.fc4")) flag++;
