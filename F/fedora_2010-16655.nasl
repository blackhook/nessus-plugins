...
# extracted from Fedora Security Advisory 2010-16655.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : glibc-2.12.1-4 (2010-16655)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/050087.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad5fb0b5"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"glibc-2.12.1-4")) flag++;
