...
# extracted from Fedora Security Advisory 2016-a9c8f9dcff.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a9c8f9dcff");

  script_name(english:"Fedora 22 : roundcubemail-1.1.5-1.fc22 (2016-a9c8f9dcff)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-May/183345.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1808061b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"roundcubemail-1.1.5-1.fc22")) flag++;
