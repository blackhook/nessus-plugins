...
# extracted from Fedora Security Advisory 2013-21298.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-21298");

  script_name(english:"Fedora 18 : drupal6-context-3.3-1.fc18 (2013-21298)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/122375.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a41bd62"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"drupal6-context-3.3-1.fc18")) flag++;
