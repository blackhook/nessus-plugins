...
# extracted from Fedora Security Advisory FEDORA-2019-d57de29e94.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : drupal7-entity (2019-d57de29e94)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d57de29e94"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/sa-contrib-2018-013"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"drupal7-entity-1.9-1.fc29")) flag++;
