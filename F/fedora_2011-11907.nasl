...
# extracted from Fedora Security Advisory 2011-11907.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-11907");

  script_name(english:"Fedora 16 : ca-certificates-2011.78-1.fc16 (2011-11907)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=734679"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/065220.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2d6bc25"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"ca-certificates-2011.78-1.fc16")) flag++;
