...
# extracted from Fedora Security Advisory FEDORA-2017-e0abe14016.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : python34 (2017-e0abe14016)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e0abe14016"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"python34-3.4.7-2.fc26")) flag++;
