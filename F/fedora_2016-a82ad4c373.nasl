...
# extracted from Fedora Security Advisory FEDORA-2016-a82ad4c373.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a82ad4c373");

  script_name(english:"Fedora 24 : gd (2016-a82ad4c373)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2015-8877

---

Upgrade to latest version - mainly bugfixes.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a82ad4c373"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"gd-2.2.1-1.fc24")) flag++;
