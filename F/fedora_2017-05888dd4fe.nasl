...
# extracted from Fedora Security Advisory FEDORA-2017-05888dd4fe.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : phpldapadmin (2017-05888dd4fe)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-05888dd4fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"phpldapadmin-1.2.3-10.fc26")) flag++;
