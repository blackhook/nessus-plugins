...
# extracted from Fedora Security Advisory 2005-812.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-812");

  script_name(english:"Fedora Core 3 : ntp-4.2.0.a.20040617-5.FC3 (2005-812)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001303.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b373722c"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ntp-debuginfo");
...
flag = 0;
if (rpm_check(release:"FC3", reference:"ntp-4.2.0.a.20040617-5.FC3")) flag++;
if (rpm_check(release:"FC3", reference:"ntp-debuginfo-4.2.0.a.20040617-5.FC3")) flag++;
