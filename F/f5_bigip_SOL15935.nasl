...
# extracted from F5 Networks BIG-IP Solution SOL15935.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (SOL15935)");
  ...
  script_set_attribute(
    ...
    value:
"util/ntp-keygen.c in ntp-keygen in NTP before 4.2.7p230 uses a weak
RNG seed, which makes it easier for remote attackers to defeat
cryptographic protection mechanisms via a brute-force attack."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15935"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["AFM"]["unaffected"] = make_list("12.0.0","11.6.0HF4","11.5.3","11.5.0HF7","11.4.1HF9","11.4.0HF10");
