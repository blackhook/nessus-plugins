...
# extracted from Fedora Security Advisory FEDORA-2021-e435a8bb88
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-e435a8bb88");

  script_name(english:"Fedora 33 : golang (2021-e435a8bb88)");
...
FEDORA-2021-e435a8bb88 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-e435a8bb88");
...
pkgs = [
    {'reference':'golang-1.15.7-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
