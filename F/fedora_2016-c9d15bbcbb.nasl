...
# extracted from Fedora Security Advisory FEDORA-2016-c9d15bbcbb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c9d15bbcbb");

  script_name(english:"Fedora 24 : kdepimlibs (2016-c9d15bbcbb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c9d15bbcbb"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"kdepimlibs-4.14.10-15.fc24")) flag++;
