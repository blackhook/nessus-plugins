...
# extracted from Fedora Security Advisory 2015-3721.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3721");

  script_name(english:"Fedora 20 : xen-4.3.3-12.fc20 (2015-3721)");
...
[XSA-119, CVE-2015-2152] Hypervisor memory corruption due to x86
emulator flaw [XSA-123, CVE-2015-2151] Information leak via internal
x86 system device emulation, Information leak through version
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2b5887a4"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"xen-4.3.3-12.fc20")) flag++;
