...
# extracted from Fedora Security Advisory 2013-18543.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-18543");

  script_name(english:"Fedora 20 : gnupg-1.4.15-1.fc20 (2013-18543)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/118764.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6a97f573"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"gnupg-1.4.15-1.fc20")) flag++;
