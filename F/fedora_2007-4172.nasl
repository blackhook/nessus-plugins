...
# extracted from Fedora Security Advisory 2007-4172.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : openoffice.org-2.3.0-6.7.fc8 (2007-4172)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=384391"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=386371"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-December/005617.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b984833"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:openoffice.org-langpack-dz");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:openoffice.org-langpack-sr");
...
flag = 0;
if (rpm_check(release:"FC8", reference:"openoffice.org-base-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-calc-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-core-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-debuginfo-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-draw-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-emailmerge-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-graphicfilter-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-headless-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-impress-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-javafilter-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-af_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ar-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-as_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-bg_BG-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-bn-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ca_ES-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-cs_CZ-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-cy_GB-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-da_DK-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-de-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-dz-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-el_GR-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-en-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-es-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-et_EE-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-eu_ES-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-fi_FI-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-fr-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ga_IE-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-gl_ES-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-gu_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-he_IL-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-hi_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-hr_HR-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-hu_HU-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-it-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ja_JP-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-kn_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ko_KR-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-lt_LT-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ml_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-mr_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ms_MY-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-nb_NO-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-nl-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-nn_NO-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-nr_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-nso_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-or_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-pa_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-pl_PL-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-pt_BR-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-pt_PT-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ru-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-sk_SK-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-sl_SI-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-sr-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ss_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-st_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-sv-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ta_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-te_IN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-th_TH-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-tn_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-tr_TR-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ts_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ur-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-ve_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-xh_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-zh_CN-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-zh_TW-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-langpack-zu_ZA-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-math-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-pyuno-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-sdk-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-sdk-doc-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-testtools-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-writer-2.3.0-6.7.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"openoffice.org-xsltfilter-2.3.0-6.7.fc8")) flag++;
