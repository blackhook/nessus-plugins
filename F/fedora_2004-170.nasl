...
# extracted from Fedora Security Advisory 2004-170.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-170");

  script_name(english:"Fedora Core 2 : cvs-1.11.17-2 (2004-170)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000166.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b5883c4c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"cvs-1.11.17-2")) flag++;
if (rpm_check(release:"FC2", reference:"cvs-debuginfo-1.11.17-2")) flag++;
