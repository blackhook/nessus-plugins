...
# extracted from Fedora Security Advisory FEDORA-2017-4767e2991d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : openssh (2017-4767e2991d)");
  ...
  script_set_attribute(
    ...
    value:
"This update provides new upstream release with several security fixes.
See the attached bugs.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4767e2991d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"openssh-7.4p1-1.fc25")) flag++;
