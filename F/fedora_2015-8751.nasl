...
# extracted from Fedora Security Advisory 2015-8751.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8751");

  script_name(english:"Fedora 21 : fuse-2.9.4-1.fc21 (2015-8751)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d7025b41"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"fuse-2.9.4-1.fc21")) flag++;
