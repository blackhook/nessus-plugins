...
# extracted from Fedora Security Advisory FEDORA-2018-ff8d8c33b1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-ff8d8c33b1");

  script_name(english:"Fedora 28 : dpkg (2018-ff8d8c33b1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-ff8d8c33b1"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"dpkg-1.18.25-1.fc28")) flag++;
