...
# extracted from F5 Networks BIG-IP Solution SOL15428.
#
...
if (description)
{
  ...
  script_bugtraq_id(67667);

  script_name(english:"F5 Networks BIG-IP : Apache Tomcat vulnerability (SOL15428)");
...
related to an XML External Entity (XXE) issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15428"
  );
  script_set_attribute(
    attribute:"solution",
    value:
