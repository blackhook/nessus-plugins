...
# extracted from Fedora Security Advisory 2014-16823.
#
...
if (description)
{
  ...
  script_bugtraq_id(71468);
  script_xref(name:"FEDORA", value:"2014-16823");

  script_name(english:"Fedora 21 : tcpdump-4.6.2-3.fc21 (2014-16823)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/147734.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e84378d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"tcpdump-4.6.2-3.fc21")) flag++;
