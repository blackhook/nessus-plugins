...
# extracted from Fedora Security Advisory 2007-566.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 5 : postgresql-8.1.9-1.fc5 (2007-566)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-June/001849.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aa66bdb3"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"postgresql-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-contrib-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-debuginfo-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-devel-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-docs-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-jdbc-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-libs-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-pl-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-python-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-server-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-tcl-8.1.9-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"postgresql-test-8.1.9-1.fc5")) flag++;
