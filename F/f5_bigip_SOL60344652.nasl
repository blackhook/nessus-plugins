...
over to a peer system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K60344652"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["affected"  ] = make_list("15.0.0-15.1.0","14.1.0-14.1.3","13.1.0-13.1.3");
vmatrix["AFM"]["unaffected"] = make_list("16.0.0","15.1.1","14.1.3.1","13.1.4");
