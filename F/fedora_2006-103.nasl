...
# extracted from Fedora Security Advisory 2006-103.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-103");

  script_name(english:"Fedora Core 4 : poppler-0.4.5-1.1 (2006-103)");
  ...
  script_set_attribute(
    ...
    value:
"Heap-based buffer overflow in Splash.cc in poppler, allows attackers
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-February/001813.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4e15dc1b"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"poppler-0.4.5-1.1")) flag++;
if (rpm_check(release:"FC4", reference:"poppler-debuginfo-0.4.5-1.1")) flag++;
if (rpm_check(release:"FC4", reference:"poppler-devel-0.4.5-1.1")) flag++;
