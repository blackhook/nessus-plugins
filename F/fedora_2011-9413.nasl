...
# extracted from Fedora Security Advisory 2011-9413.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-9413");

  script_name(english:"Fedora 15 : xmms-1.2.11-15.20071117cvs.fc15 (2011-9413)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-July/063082.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1fbdfb86"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"xmms-1.2.11-15.20071117cvs.fc15")) flag++;
