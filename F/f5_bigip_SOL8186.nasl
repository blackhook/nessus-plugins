...
# extracted from F5 Networks BIG-IP Solution SOL8186.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2007-5000");
  script_bugtraq_id(26838);

  script_name(english:"F5 Networks BIG-IP : XSS vulnerability in Apache mod_imap (SOL8186)");
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K8186"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
Solution SOL8186."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2007/12/27");
...
vmatrix["LTM"]["unaffected"] = make_list("9.3","9.4","10","11");
