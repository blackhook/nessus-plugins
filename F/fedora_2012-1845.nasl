...
# extracted from Fedora Security Advisory 2012-1845.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-1845");

  script_name(english:"Fedora 15 : xulrunner-10.0.1-3.fc15 (2012-1845)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-March/074364.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e226e1ab"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"xulrunner-10.0.1-3.fc15")) flag++;
