...
# extracted from Fedora Security Advisory 2013-0934.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : qemu-0.15.1-9.fc16 (2013-0934)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/097705.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?210bbe96"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"qemu-0.15.1-9.fc16")) flag++;
