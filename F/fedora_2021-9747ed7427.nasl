...
# extracted from Fedora Security Advisory FEDORA-2021-9747ed7427
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-9747ed7427");

  script_name(english:"Fedora 33 : suricata (2021-9747ed7427)");
...
FEDORA-2021-9747ed7427 advisory.

  - Various performance, accuracy and stability issues have been fixed. (FEDORA-2021-9747ed7427)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-9747ed7427");
...
pkgs = [
    {'reference':'suricata-5.0.6-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
