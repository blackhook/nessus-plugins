...
# extracted from Fedora Security Advisory 2005-844.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-844");

  script_name(english:"Fedora Core 3 : unzip-5.51-4.fc3 (2005-844)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001351.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e348b9a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"unzip-5.51-4.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"unzip-debuginfo-5.51-4.fc3")) flag++;
