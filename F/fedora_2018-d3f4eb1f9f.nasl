...
# extracted from Fedora Security Advisory FEDORA-2018-d3f4eb1f9f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : drupal7 (2018-d3f4eb1f9f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d3f4eb1f9f"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC29", reference:"drupal7-7.60-2.fc29")) flag++;
