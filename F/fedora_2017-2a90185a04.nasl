...
# extracted from Fedora Security Advisory FEDORA-2017-2a90185a04.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-2a90185a04");

  script_name(english:"Fedora 25 : php-pear-CAS (2017-2a90185a04)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2a90185a04"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"php-pear-CAS-1.3.5-1.fc25")) flag++;
