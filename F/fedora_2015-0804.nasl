...
# extracted from Fedora Security Advisory 2015-0804.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : python-django14-1.4.18-1.fc20 (2015-0804)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148608.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1965509b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-django14-1.4.18-1.fc20")) flag++;
