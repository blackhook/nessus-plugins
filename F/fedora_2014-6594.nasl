...
# extracted from Fedora Security Advisory 2014-6594.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6594");

  script_name(english:"Fedora 19 : libtiff-4.0.3-10.fc19 (2014-6594)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=996832"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134153.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3954cd42"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libtiff-4.0.3-10.fc19")) flag++;
