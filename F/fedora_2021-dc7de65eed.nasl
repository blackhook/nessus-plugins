...
# extracted from Fedora Security Advisory FEDORA-2021-dc7de65eed
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-dc7de65eed");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/09/15");

  script_name(english:"Fedora 33 : 1:php-pear (2021-dc7de65eed)");
...
FEDORA-2021-dc7de65eed advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-dc7de65eed");
...
pkgs = [
    {'reference':'php-pear-1.10.12-5.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
