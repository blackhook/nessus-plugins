...
# extracted from Fedora Security Advisory FEDORA-2018-d4bfa98f6a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-d4bfa98f6a");

  script_name(english:"Fedora 27 : 1:java-1.8.0-openjdk (2018-d4bfa98f6a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-d4bfa98f6a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"java-1.8.0-openjdk-1.8.0.181-7.b13.fc27", epoch:"1")) flag++;
