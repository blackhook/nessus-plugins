...
# extracted from Fedora Security Advisory FEDORA-2019-899ef6056c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : xen (2019-899ef6056c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-899ef6056c"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"xen-4.11.1-6.fc29")) flag++;
