...
# extracted from F5 Networks BIG-IP Solution K02951273.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K02951273)");
...
(CVE-2017-6463)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K02951273"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
