...
# extracted from Fedora Security Advisory FEDORA-2017-0348398d64.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0348398d64");

  script_name(english:"Fedora 27 : LibRaw (2017-0348398d64)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0348398d64"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"LibRaw-0.18.5-1.fc27")) flag++;
