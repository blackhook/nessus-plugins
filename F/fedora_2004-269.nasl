...
# extracted from Fedora Security Advisory 2004-269.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-269");

  script_name(english:"Fedora Core 2 : rsync-2.6.2-1.fc2.0 (2004-269)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-August/000266.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2cfd9c1f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"rsync-2.6.2-1.fc2.0")) flag++;
if (rpm_check(release:"FC2", reference:"rsync-debuginfo-2.6.2-1.fc2.0")) flag++;
