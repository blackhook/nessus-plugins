...
# extracted from Fedora Security Advisory 2007-590.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : iscsi-initiator-utils-6.2.0.865-0.0.fc6 (2007-590)");
...
reconfiguring them. Once the db has been updated you cannot use older
tools on it.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-June/002046.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?32dc8dd1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"iscsi-initiator-utils-6.2.0.865-0.0.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"iscsi-initiator-utils-debuginfo-6.2.0.865-0.0.fc6")) flag++;
