...
# extracted from Fedora Security Advisory 2011-15196.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-15196");

  script_name(english:"Fedora 16 : openswan-2.6.37-1.fc16 (2011-15196)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-December/070695.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0fb5ca30"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"openswan-2.6.37-1.fc16")) flag++;
