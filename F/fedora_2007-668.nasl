...
# extracted from Fedora Security Advisory 2007-668.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : rpm-4.4.2.1-1.fc6 (2007-668)");
...
"Summary of changes :
  ...
  - update to 4.4.2.1 (fixing #247749 and countless others)
    ...
    - avoid unnecessary .rpmsave / .rpmnew files (#29470,
      #128622)

    - stricter docdir checking (#246819)

    - allow checking for pending signals from python
      (#181434)

    - add hook to python for cleaning up on unclean exit
      (#245389)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-August/003421.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4ea979b1"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"popt-1.10.2.1-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"rpm-4.4.2.1-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"rpm-build-4.4.2.1-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"rpm-debuginfo-4.4.2.1-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"rpm-devel-4.4.2.1-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"rpm-libs-4.4.2.1-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"rpm-python-4.4.2.1-1.fc6")) flag++;
