...
# extracted from Fedora Security Advisory FEDORA-2018-7b8101dcbc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-7b8101dcbc");

  script_name(english:"Fedora 27 : znc (2018-7b8101dcbc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-7b8101dcbc"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"znc-1.7.1-1.fc27")) flag++;
