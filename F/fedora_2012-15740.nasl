...
# extracted from Fedora Security Advisory 2012-15740.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-15740");

  script_name(english:"Fedora 17 : qemu-1.0.1-2.fc17 (2012-15740)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/089835.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e3e01a2"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"qemu-1.0.1-2.fc17")) flag++;
