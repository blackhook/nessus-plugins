...
# extracted from Fedora Security Advisory FEDORA-2020-4ff32ef9be.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : xen (2020-4ff32ef9be)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4ff32ef9be"
  );
...
flag = 0;
if (rpm_check(release:"FC32", reference:"xen-4.13.2-4.fc32")) flag++;
