...
# extracted from Fedora Security Advisory 2006-486.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-486");

  script_name(english:"Fedora Core 4 : epiphany-1.6.5-3 (2006-486)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000017.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f62d062e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"epiphany-1.6.5-3")) flag++;
if (rpm_check(release:"FC4", reference:"epiphany-debuginfo-1.6.5-3")) flag++;
if (rpm_check(release:"FC4", reference:"epiphany-devel-1.6.5-3")) flag++;
