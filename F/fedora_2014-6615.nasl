...
# extracted from Fedora Security Advisory 2014-6615.
#
...
if (description)
{
  ...
  script_bugtraq_id(67567);
  script_xref(name:"FEDORA", value:"2014-6615");

  script_name(english:"Fedora 20 : drupal7-views-3.8-1.fc20 (2014-6615)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/node/2271305"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-August/136457.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88b794cd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"drupal7-views-3.8-1.fc20")) flag++;
