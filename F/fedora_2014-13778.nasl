...
# extracted from Fedora Security Advisory 2014-13778.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13778");

  script_name(english:"Fedora 19 : hostapd-2.0-5.fc19 (2014-13778)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/142770.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8e41b4ba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"hostapd-2.0-5.fc19")) flag++;
