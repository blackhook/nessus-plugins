...
# extracted from Fedora Security Advisory 2013-21956.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-21956");

  script_name(english:"Fedora 20 : drupal7-7.24-1.fc20 (2013-21956)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/project/drupal/releases/7.24"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123648.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5d556a5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"drupal7-7.24-1.fc20")) flag++;
