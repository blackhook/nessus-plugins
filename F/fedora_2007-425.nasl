...
# extracted from Fedora Security Advisory 2007-425.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : xorg-x11-server-1.1.1-47.8.fc6 (2007-425)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-April/001652.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?19091b23"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xdmx-1.1.1-47.8.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xephyr-1.1.1-47.8.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xnest-1.1.1-47.8.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xorg-1.1.1-47.8.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-Xvfb-1.1.1-47.8.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-debuginfo-1.1.1-47.8.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"xorg-x11-server-sdk-1.1.1-47.8.fc6")) flag++;
