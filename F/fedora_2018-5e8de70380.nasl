...
# extracted from Fedora Security Advisory FEDORA-2018-5e8de70380.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : quassel (2018-5e8de70380)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5e8de70380"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"quassel-0.12.5-1.fc26")) flag++;
