...
# extracted from Fedora Security Advisory 2015-3757.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : libssh2-1.5.0-1.fc22 (2015-3757)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/151943.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3930a525"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"libssh2-1.5.0-1.fc22")) flag++;
