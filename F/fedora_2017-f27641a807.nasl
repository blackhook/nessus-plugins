...
# extracted from Fedora Security Advisory FEDORA-2017-f27641a807.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f27641a807");

  script_name(english:"Fedora 25 : drupal7-views (2017-f27641a807)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f27641a807"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/node/2902604"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"drupal7-views-3.18-1.fc25")) flag++;
