...
# extracted from Fedora Security Advisory 2015-12961.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-12961");

  script_name(english:"Fedora 22 : pure-ftpd-1.0.36-7.fc22 (2015-12961)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b057c428"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"pure-ftpd-1.0.36-7.fc22")) flag++;
