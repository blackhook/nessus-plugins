...
# extracted from Fedora Security Advisory FEDORA-2017-7b17451b82.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-7b17451b82");

  script_name(english:"Fedora 26 : 1:java-1.8.0-openjdk (2017-7b17451b82)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7b17451b82"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"java-1.8.0-openjdk-1.8.0.151-1.b12.fc26", epoch:"1")) flag++;
