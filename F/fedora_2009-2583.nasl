...
# extracted from Fedora Security Advisory 2009-2583.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2583");

  script_name(english:"Fedora 10 : roundup-1.4.6-4.fc10 (2009-2583)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021222.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f6463980"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"roundup-1.4.6-4.fc10")) flag++;
