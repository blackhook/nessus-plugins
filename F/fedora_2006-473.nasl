...
# extracted from Fedora Security Advisory 2006-473.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-473");

  script_name(english:"Fedora Core 4 : libtiff-3.7.1-6.fc4.1 (2006-473)");
  ...
  script_set_attribute(
    ...
    value:
"This updates fixes several vulnerabilities in libtiff.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-April/002178.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?99947345"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"libtiff-3.7.1-6.fc4.1")) flag++;
if (rpm_check(release:"FC4", reference:"libtiff-debuginfo-3.7.1-6.fc4.1")) flag++;
if (rpm_check(release:"FC4", reference:"libtiff-devel-3.7.1-6.fc4.1")) flag++;
