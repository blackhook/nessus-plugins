...
# extracted from F5 Networks BIG-IP Solution SOL16898.
#
...
if (description)
{
  ...
  script_bugtraq_id(75157);

  script_name(english:"F5 Networks BIG-IP : PKCS #7 vulnerability (SOL16898)");
...
that uses ASN.1 encoding and lacks inner EncryptedContent data."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16898"
  );
  script_set_attribute(
    attribute:"solution",
    value:
