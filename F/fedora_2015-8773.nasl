...
# extracted from Fedora Security Advisory 2015-8773.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8773");

  script_name(english:"Fedora 22 : ntfs-3g-2015.3.14-2.fc22 (2015-8773)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1224103"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159298.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06087aba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"ntfs-3g-2015.3.14-2.fc22")) flag++;
