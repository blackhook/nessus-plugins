...
# extracted from Fedora Security Advisory 2012-16417.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16417");

  script_name(english:"Fedora 16 : Django-1.3.4-1.fc16 (2012-16417)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6c747cf2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"Django-1.3.4-1.fc16")) flag++;
