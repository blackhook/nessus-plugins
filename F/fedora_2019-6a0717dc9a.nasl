...
# extracted from Fedora Security Advisory FEDORA-2019-6a0717dc9a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : drupal8 / php-typo3-phar-stream-wrapper2 (2019-6a0717dc9a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-6a0717dc9a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected drupal8 and / or php-typo3-phar-stream-wrapper2
packages."
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"drupal8-8.6.10-1.fc28")) flag++;
if (rpm_check(release:"FC28", reference:"php-typo3-phar-stream-wrapper2-2.0.1-1.fc28")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "drupal8 / php-typo3-phar-stream-wrapper2");
}
