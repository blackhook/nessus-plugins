...
# extracted from Fedora Security Advisory FEDORA-2020-afa955de8a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : mingw-podofo (2020-afa955de8a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-afa955de8a"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"mingw-podofo-0.9.6-16.fc31")) flag++;
