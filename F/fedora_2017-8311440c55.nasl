...
# extracted from Fedora Security Advisory FEDORA-2017-8311440c55.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-8311440c55");

  script_name(english:"Fedora 24 : pcsc-lite (2017-8311440c55)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-8311440c55"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"pcsc-lite-1.8.20-1.fc24")) flag++;
