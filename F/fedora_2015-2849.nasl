...
# extracted from Fedora Security Advisory 2015-2849.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-2849");

  script_name(english:"Fedora 21 : drupal7-entity-1.6-1.fc21 (2015-2849)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/154059.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4bf4b38"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC21", reference:"drupal7-entity-1.6-1.fc21")) flag++;
