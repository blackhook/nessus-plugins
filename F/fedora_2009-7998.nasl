...
# extracted from Fedora Security Advisory 2009-7998.
#
...
if (description)
{
  ...
  script_bugtraq_id(34291, 34457, 35748, 36846);
  script_xref(name:"FEDORA", value:"2009-7998");

  script_name(english:"Fedora 10 : wireshark-1.2.1-1.fc10 (2009-7998)");
  ...
  script_set_attribute(
    ...
    value:
"Rebased to 1.2.x, fixing several security flaws, see the security
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.wireshark.org/security/wnpa-sec-2009-04.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-December/032116.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22a35dc4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"wireshark-1.2.1-1.fc10")) flag++;
