...
# extracted from Fedora Security Advisory 2010-5539.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : sunbird-1.0-0.21.20090916hg.fc12 / thunderbird-3.0.4-1.fc12 (2010-5539)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/038378.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?68d1f2d8"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/038379.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a9679a97"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"sunbird-1.0-0.21.20090916hg.fc12")) flag++;
if (rpm_check(release:"FC12", reference:"thunderbird-3.0.4-1.fc12")) flag++;
