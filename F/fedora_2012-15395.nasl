...
# extracted from Fedora Security Advisory 2012-15395.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-15395");

  script_name(english:"Fedora 17 : ruby-1.9.3.194-17.fc17 (2012-15395)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/089887.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1aa8b50b"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"ruby-1.9.3.194-17.fc17")) flag++;
