...
# extracted from Fedora Security Advisory 2011-11116.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : hplip-3.11.7-2.fc16 (2011-11116)");
...
HPLIP when debugging is enabled.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-August/064881.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?264f47bb"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"hplip-3.11.7-2.fc16")) flag++;
