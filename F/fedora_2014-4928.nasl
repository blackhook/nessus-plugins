...
# extracted from Fedora Security Advisory 2014-4928.
#
...
if (description)
{
  ...
  script_bugtraq_id(66387, 66390, 66392, 66555, 66630);
  script_xref(name:"FEDORA", value:"2014-4928");

  script_name(english:"Fedora 19 : cacti-0.8.8b-5.fc19 (2014-4928)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1082122"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1084258"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/131821.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1696b2e6"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"cacti-0.8.8b-5.fc19")) flag++;
