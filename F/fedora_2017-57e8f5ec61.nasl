...
# extracted from Fedora Security Advisory FEDORA-2017-57e8f5ec61.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-57e8f5ec61");

  script_name(english:"Fedora 26 : libtirpc (2017-57e8f5ec61)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-57e8f5ec61"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libtirpc-1.0.1-4.rc3.fc26")) flag++;
