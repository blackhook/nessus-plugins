...
# extracted from Fedora Security Advisory FEDORA-2017-b25c8a7087.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b25c8a7087");

  script_name(english:"Fedora 27 : curl (2017-b25c8a7087)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b25c8a7087"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"curl-7.55.1-7.fc27")) flag++;
