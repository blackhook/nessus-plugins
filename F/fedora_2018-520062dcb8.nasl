...
# extracted from Fedora Security Advisory FEDORA-2018-520062dcb8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : php-horde-horde (2018-520062dcb8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-520062dcb8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"php-horde-horde-5.2.20-1.fc28")) flag++;
