...
# extracted from Fedora Security Advisory 2015-9466.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : xen-4.4.2-5.fc21 (2015-9466)");
...
[XSA-128, CVE-2015-4103], PCI MSI mask bits inadvertently exposed to
guests [XSA-129, CVE-2015-4104], Guest triggerable qemu MSI-X
pass-through error messages [XSA-130, CVE-2015-4105], Unmediated PCI
register access in qemu [XSA-131, CVE-2015-4106]
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e46e776f"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"xen-4.4.2-5.fc21")) flag++;
