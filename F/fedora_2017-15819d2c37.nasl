...
# extracted from Fedora Security Advisory FEDORA-2017-15819d2c37.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-15819d2c37");

  script_name(english:"Fedora 27 : jasper (2017-15819d2c37)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-15819d2c37"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"jasper-2.0.14-1.fc27")) flag++;
