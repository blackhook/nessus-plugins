...
# extracted from Fedora Security Advisory FEDORA-2019-8f2b27efce.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 1:java-1.8.0-openjdk (2019-8f2b27efce)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8f2b27efce"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"java-1.8.0-openjdk-1.8.0.201.b09-2.fc29", epoch:"1")) flag++;
