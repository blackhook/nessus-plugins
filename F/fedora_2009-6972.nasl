...
# extracted from Fedora Security Advisory 2009-6972.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6972");

  script_name(english:"Fedora 11 : poppler-0.10.7-2.fc11 (2009-6972)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.freedesktop.org/archives/poppler/2009-May/004721.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=496944"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026496.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dfbc9287"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"poppler-0.10.7-2.fc11")) flag++;
