...
# extracted from Fedora Security Advisory 2007-3414.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : thunderbird-2.0.0.9-1.fc8 (2007-3414)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004889.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ccdfa15"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC8", reference:"thunderbird-2.0.0.9-1.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"thunderbird-debuginfo-2.0.0.9-1.fc8")) flag++;
