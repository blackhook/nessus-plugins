...
# extracted from Fedora Security Advisory 2014-5015.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5015");

  script_name(english:"Fedora 20 : elfutils-0.158-3.fc20 (2014-5015)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/131861.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?804a0ebe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"elfutils-0.158-3.fc20")) flag++;
