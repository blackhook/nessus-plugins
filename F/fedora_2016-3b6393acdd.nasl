...
# extracted from Fedora Security Advisory FEDORA-2016-3b6393acdd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-3b6393acdd");

  script_name(english:"Fedora 23 : tor (2016-3b6393acdd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3b6393acdd"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"tor-0.2.8.9-1.fc23")) flag++;
