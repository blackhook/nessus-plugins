...
# extracted from Fedora Security Advisory 2016-8d983eeb13.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-8d983eeb13");

  script_name(english:"Fedora 22 : drupal7-block_class-2.3-1.fc22 (2016-8d983eeb13)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-April/182953.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1aba5b9"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"drupal7-block_class-2.3-1.fc22")) flag++;
