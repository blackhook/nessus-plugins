...
# extracted from Fedora Security Advisory 2009-10719.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10719");

  script_name(english:"Fedora 11 : systemtap-1.0-2.fc11 (2009-10719)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=529175"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030258.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?72bb57bd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"systemtap-1.0-2.fc11")) flag++;
