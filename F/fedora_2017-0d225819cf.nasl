...
# extracted from Fedora Security Advisory FEDORA-2017-0d225819cf.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0d225819cf");

  script_name(english:"Fedora 27 : openvswitch (2017-0d225819cf)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0d225819cf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"openvswitch-2.8.1-1.fc27")) flag++;
