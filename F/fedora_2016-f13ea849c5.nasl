...
# extracted from Fedora Security Advisory FEDORA-2016-f13ea849c5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-f13ea849c5");

  script_name(english:"Fedora 24 : 2:qemu (2016-f13ea849c5)");
...
"  - CVE-2016-4020: memory leak in kvmvapic.c (bz #1326904)
  ...
  - Fix crash with aarch64 gic-version=host and accel=tcg
    (bz #1339977)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f13ea849c5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"qemu-2.6.0-3.fc24", epoch:"2")) flag++;
