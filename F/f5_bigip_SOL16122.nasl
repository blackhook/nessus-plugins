...
# extracted from F5 Networks BIG-IP Solution SOL16122.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL16122)");
...
wrong space."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16122"
  );
  script_set_attribute(
    attribute:"solution",
    value:
