...
# extracted from F5 Networks BIG-IP Solution SOL17251.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Apache vulnerability (SOL17251)");
...
before 2.4.14 does not properly parse chunk headers, which allows
remote attackers to conduct HTTP request smuggling attacks via a
crafted request, related to mishandling of large chunk-size values and
invalid chunk-extension characters in modules/http/http_filters.c."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17251"
  );
  script_set_attribute(
    attribute:"solution",
    value:
