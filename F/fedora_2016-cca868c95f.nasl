...
# extracted from Fedora Security Advisory FEDORA-2016-cca868c95f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : mingw-freeimage (2016-cca868c95f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-cca868c95f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mingw-freeimage-3.17.0-4.fc23")) flag++;
