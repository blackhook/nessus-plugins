...
# extracted from Fedora Security Advisory FEDORA-2021-139f3fc21c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-139f3fc21c");

  script_name(english:"Fedora 33 : xorg-x11-server (2021-139f3fc21c)");
...
FEDORA-2021-139f3fc21c advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-139f3fc21c");
...
pkgs = [
    {'reference':'xorg-x11-server-1.20.11-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
