...
# extracted from Fedora Security Advisory 2014-13021.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13021");

  script_name(english:"Fedora 20 : java-1.7.0-openjdk-1.7.0.71-2.5.3.0.fc20 (2014-13021)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d4851c44"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141067.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76d303f8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"java-1.7.0-openjdk-1.7.0.71-2.5.3.0.fc20")) flag++;
