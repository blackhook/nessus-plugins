...
# extracted from Fedora Security Advisory 2014-14963.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : avr-binutils-2.24-3.fc20 (2014-14963)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145262.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2f355be"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected avr-binutils package."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:avr-binutils");
...
flag = 0;
if (rpm_check(release:"FC20", reference:"avr-binutils-2.24-3.fc20")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "avr-binutils");
}
