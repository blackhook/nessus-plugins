...
# extracted from Fedora Security Advisory 2012-18210.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-18210");

  script_name(english:"Fedora 17 : bugzilla-4.0.9-1.fc17 (2012-18210)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/093080.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d2b3cb3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"bugzilla-4.0.9-1.fc17")) flag++;
