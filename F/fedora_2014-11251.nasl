...
# extracted from Fedora Security Advisory 2014-11251.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11251");

  script_name(english:"Fedora 21 : nginx-1.6.2-2.fc21 (2014-11251)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1142573"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/139483.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3eceff73"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"nginx-1.6.2-2.fc21")) flag++;
