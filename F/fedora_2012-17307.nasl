...
# extracted from Fedora Security Advisory 2012-17307.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-17307");

  script_name(english:"Fedora 17 : thunderbird-16.0.2-1.fc17 (2012-17307)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091201.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?41f2c038"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"thunderbird-16.0.2-1.fc17")) flag++;
