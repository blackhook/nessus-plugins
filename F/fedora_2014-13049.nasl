...
# extracted from Fedora Security Advisory 2014-13049.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13049");

  script_name(english:"Fedora 19 : java-1.8.0-openjdk-1.8.0.25-0.b18.fc19 (2014-13049)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141335.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c8fc5b60"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"java-1.8.0-openjdk-1.8.0.25-0.b18.fc19")) flag++;
