...
# extracted from Fedora Security Advisory 2005-251.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-251");

  script_name(english:"Fedora Core 2 : devhelp-0.9.1-0.2.5 (2005-251)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000804.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?925c6a51"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"devhelp-0.9.1-0.2.5")) flag++;
if (rpm_check(release:"FC2", reference:"devhelp-debuginfo-0.9.1-0.2.5")) flag++;
if (rpm_check(release:"FC2", reference:"devhelp-devel-0.9.1-0.2.5")) flag++;
