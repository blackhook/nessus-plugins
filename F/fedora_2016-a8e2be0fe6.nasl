...
# extracted from Fedora Security Advisory 2016-a8e2be0fe6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-a8e2be0fe6");

  script_name(english:"Fedora 23 : cacti-0.8.8g-1.fc23 (2016-a8e2be0fe6)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c520517"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"cacti-0.8.8g-1.fc23")) flag++;
