...
# extracted from Fedora Security Advisory FEDORA-2017-5972ebe591.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-5972ebe591");

  script_name(english:"Fedora 25 : spice (2017-5972ebe591)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-5972ebe591"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"spice-0.13.3-2.fc25")) flag++;
