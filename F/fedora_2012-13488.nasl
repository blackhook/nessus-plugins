...
# extracted from Fedora Security Advisory 2012-13488.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13488");

  script_name(english:"Fedora 16 : wordpress-3.4.2-2.fc16 (2012-13488)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086325.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74c8ba72"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"wordpress-3.4.2-2.fc16")) flag++;
