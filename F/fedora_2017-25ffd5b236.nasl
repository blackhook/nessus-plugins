...
# extracted from Fedora Security Advisory FEDORA-2017-25ffd5b236.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-25ffd5b236");

  script_name(english:"Fedora 25 : webkitgtk4 (2017-25ffd5b236)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-25ffd5b236"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"webkitgtk4-2.16.0-1.fc25")) flag++;
