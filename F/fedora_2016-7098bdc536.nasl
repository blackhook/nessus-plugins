...
# extracted from Fedora Security Advisory FEDORA-2016-7098bdc536.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : pdns (2016-7098bdc536)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-7098bdc536"
  );
  # https://doc.powerdns.com/md/changelog/#powerdns-authoritative-server-401
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c66595ac"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"pdns-4.0.1-1.fc24")) flag++;
