...
# extracted from Fedora Security Advisory FEDORA-2017-38c3781b89.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-38c3781b89");

  script_name(english:"Fedora 26 : wget (2017-38c3781b89)");
  ...
  script_set_attribute(
    ...
    value:
"  - fixed CVE-2017-6508 CRLF injection in the url_parse
    function in url.c
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-38c3781b89"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"wget-1.19.1-3.fc26")) flag++;
