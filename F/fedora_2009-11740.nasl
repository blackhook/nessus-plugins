...
# extracted from Fedora Security Advisory 2009-11740.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11740");

  script_name(english:"Fedora 11 : wget-1.12-2.fc11 (2009-11740)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-December/032024.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?62af2ff7"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"wget-1.12-2.fc11")) flag++;
