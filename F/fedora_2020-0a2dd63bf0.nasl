...
# extracted from Fedora Security Advisory FEDORA-2020-0a2dd63bf0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 1:java-1.8.0-openjdk (2020-0a2dd63bf0)");
...
http://mail.openjdk.java.net/pipermail/jdk8u-dev/2020-January/010979.h
tml
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-0a2dd63bf0"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://openjdk.java.net/groups/vulnerability/advisories/2020-01-14"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"java-1.8.0-openjdk-1.8.0.242.b08-0.fc30", epoch:"1")) flag++;
