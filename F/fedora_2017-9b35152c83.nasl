...
# extracted from Fedora Security Advisory FEDORA-2017-9b35152c83.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-9b35152c83");

  script_name(english:"Fedora 26 : git (2017-9b35152c83)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9b35152c83"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"git-2.13.6-1.fc26")) flag++;
