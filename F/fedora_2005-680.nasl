...
# extracted from Fedora Security Advisory 2005-680.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2005-2410");
  script_xref(name:"FEDORA", value:"2005-680");

  script_name(english:"Fedora Core 4 : NetworkManager-0.4-20.FC4.1 (2005-680)");
...
format string. This causes it to crash when connecting to access
points that contain format string characters.

This was reported initially by Ian Jackson :

http://mail.gnome.org/archives/networkmanager-list/2005-July/msg00196.
html
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?09f2adc8"
  );
  # https://lists.fedoraproject.org/pipermail/announce/2005-July/001183.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?98a7a469"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"NetworkManager-0.4-20.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"NetworkManager-debuginfo-0.4-20.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"NetworkManager-devel-0.4-20.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"NetworkManager-glib-0.4-20.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"NetworkManager-gnome-0.4-20.FC4.1")) flag++;
