...
# extracted from Fedora Security Advisory FEDORA-2018-2c612c6d92.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : python-django (2018-2c612c6d92)");
  ...
  script_set_attribute(
    ...
    value:
"update to 1.11.10, fix for CVE-2018-6188: Information leakage in
AuthenticationForm
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2c612c6d92"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"python-django-1.11.10-1.fc27")) flag++;
