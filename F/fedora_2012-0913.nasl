...
# extracted from Fedora Security Advisory 2012-0913.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-0913");

  script_name(english:"Fedora 16 : moodle-2.0.7-1.fc16 (2012-0913)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/072726.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?156020df"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"moodle-2.0.7-1.fc16")) flag++;
