...
# extracted from Fedora Security Advisory 2005-790.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-790");

  script_name(english:"Fedora Core 4 : cvs-1.11.19-9 (2005-790)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001288.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b5d22dee"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"cvs-1.11.19-9")) flag++;
if (rpm_check(release:"FC4", reference:"cvs-debuginfo-1.11.19-9")) flag++;
