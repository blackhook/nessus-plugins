...
# extracted from Fedora Security Advisory FEDORA-2016-34403df2af.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-7168");
  script_xref(name:"FEDORA", value:"2016-34403df2af");

  script_name(english:"Fedora 25 : wordpress (2016-34403df2af)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-34403df2af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"wordpress-4.6.1-1.fc25")) flag++;
