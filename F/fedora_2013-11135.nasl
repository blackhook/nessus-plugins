...
# extracted from Fedora Security Advisory 2013-11135.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-11135");

  script_name(english:"Fedora 19 : haproxy-1.4.24-1.fc19 (2013-11135)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/110063.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca9ea4d9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"haproxy-1.4.24-1.fc19")) flag++;
