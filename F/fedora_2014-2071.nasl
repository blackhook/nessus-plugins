...
# extracted from Fedora Security Advisory 2014-2071.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-2071");

  script_name(english:"Fedora 19 : icedtea-web-1.4.2-0.fc19 (2014-2071)");
...
"New in release 1.4.2 (2014-02-05) :
  ...
  - Dialogs center on screen before becoming visible
    ...
    - RH1010958: insecure temporary file use flaw in
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/128269.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1cb6a653"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"icedtea-web-1.4.2-0.fc19")) flag++;
