...
# extracted from Fedora Security Advisory 2006-474.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-474");

  script_name(english:"Fedora Core 5 : libtiff-3.7.4-4 (2006-474)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-April/002179.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf4dd704"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC5", reference:"libtiff-3.7.4-4")) flag++;
if (rpm_check(release:"FC5", reference:"libtiff-debuginfo-3.7.4-4")) flag++;
if (rpm_check(release:"FC5", reference:"libtiff-devel-3.7.4-4")) flag++;
