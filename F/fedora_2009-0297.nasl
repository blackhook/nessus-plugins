...
# extracted from Fedora Security Advisory 2009-0297.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-0297");

  script_name(english:"Fedora 9 : nfs-utils-1.1.2-9.fc9 (2009-0297)");
...
"  - Added warnings to tcp wrapper code when mounts are
  ...
  - gssd: By default, don't spam syslog when users'
    credentials expire Re-enabled and fixed/enhanced tcp
    wrappers.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-January/018967.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f1603d4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"nfs-utils-1.1.2-9.fc9")) flag++;
