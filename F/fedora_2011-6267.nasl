...
# extracted from Fedora Security Advisory 2011-6267.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6267");

  script_name(english:"Fedora 15 : seamonkey-2.0.14-1.fc15 (2011-6267)");
  ...
  script_set_attribute(
    ...
    value:
"Update to new upstream SeaMonkey version 2.0.14, fixing multiple
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?340fe7b3"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059546.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24c089f6"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2011/04/30");
...
flag = 0;
if (rpm_check(release:"FC15", reference:"seamonkey-2.0.14-1.fc15")) flag++;
