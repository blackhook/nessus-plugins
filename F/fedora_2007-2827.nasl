...
# extracted from Fedora Security Advisory 2007-2827.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : cpio-2.9-5.fc8 (2007-2827)");
...
"  - Thu Nov 1 2007 Radek Brich <rbrich at redhat.com> 2.9-5
    ...
    - upstream patch for CVE-2007-4476 (stack crashing in
      safer_name_suffix)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=363891"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004522.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?57bf89ee"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"cpio-2.9-5.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"cpio-debuginfo-2.9-5.fc8")) flag++;
