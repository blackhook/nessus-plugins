...
# extracted from Fedora Security Advisory 2005-934.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-934");

  script_name(english:"Fedora Core 3 : epiphany-1.4.9-1 (2005-934)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001421.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ee797860"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"epiphany-1.4.9-1")) flag++;
if (rpm_check(release:"FC3", reference:"epiphany-debuginfo-1.4.9-1")) flag++;
if (rpm_check(release:"FC3", reference:"epiphany-devel-1.4.9-1")) flag++;
