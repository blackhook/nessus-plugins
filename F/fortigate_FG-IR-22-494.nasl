...
vulnerability as referenced in the FG-IR-22-494 advisory.
  ...
  - An out-of-bounds write vulnerability [CWE-787] in Command Line Interface of FortiOS and FortiProxy may
    allow an authenticated attacker to achieve arbitrary code execution via specifically crafted commands.
    (CVE-2023-22639)
...
var constraints = [
  { 'min_version' : '6.0.0', 'max_version' : '6.0.17', 'fixed_version' : '6.4.13' },
