...
# extracted from Fedora Security Advisory FEDORA-2018-8d544ee879.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-6484", "CVE-2018-6869");
  script_xref(name:"FEDORA", value:"2018-8d544ee879");

  script_name(english:"Fedora 27 : zziplib (2018-8d544ee879)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-8d544ee879"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"zziplib-0.13.68-1.fc27")) flag++;
