...
# extracted from Fedora Security Advisory 2005-188.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2005-0455");
  script_xref(name:"FEDORA", value:"2005-188");

  script_name(english:"Fedora Core 3 : HelixPlayer-1.0.3-3.fc3 (2005-188)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000732.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b805099"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"HelixPlayer-1.0.3-3.fc3")) flag++;
