...
# extracted from Fedora Security Advisory FEDORA-2020-b190375a37.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : golang (2020-b190375a37)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-b190375a37");
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"golang-1.13.15-1.fc31")) flag++;
