...
# extracted from Fedora Security Advisory FEDORA-2020-e7f95c4df0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-e7f95c4df0");

  script_name(english:"Fedora 30 : mbedtls (2020-e7f95c4df0)");
...
Release notes:
https://tls.mbed.org/tech-updates/releases/mbedtls-2.16.5-and-2.7.14-r
eleased
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e7f95c4df0"
  );
  # https://tls.mbed.org/tech-updates/security-advisories/mbedtls-security-advisory-2020-02
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8e1ade23"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mbedtls-2.16.5-1.fc30")) flag++;
