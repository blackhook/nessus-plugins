...
# extracted from Fedora Security Advisory FEDORA-2017-d5ef38bf2c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d5ef38bf2c");

  script_name(english:"Fedora 26 : ansible (2017-d5ef38bf2c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d5ef38bf2c"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"ansible-2.3.0.0-1.fc26")) flag++;
