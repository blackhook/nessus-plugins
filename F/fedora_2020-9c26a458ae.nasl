...
# extracted from Fedora Security Advisory FEDORA-2020-9c26a458ae.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 1:xrdp (2020-9c26a458ae)");
...
local buffer overflow vulnerability.
  ...
  - CVE-2020-4044: Local users can perform a buffer overflow
    attack against the xrdp-sesman service and then
    impersonate it
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9c26a458ae"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"xrdp-0.9.13.1-1.fc31", epoch:"1")) flag++;
