...
# extracted from Fedora Security Advisory FEDORA-2016-8660c7656f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-8660c7656f");

  script_name(english:"Fedora 24 : 389-ds-base (2016-8660c7656f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-8660c7656f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"389-ds-base-1.3.5.15-1.fc24")) flag++;
