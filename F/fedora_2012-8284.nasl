...
# extracted from Fedora Security Advisory 2012-8284.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8284");

  script_name(english:"Fedora 17 : moodle-2.2.3-1.fc17 (2012-8284)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/081607.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?87f606de"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"moodle-2.2.3-1.fc17")) flag++;
