...
# extracted from Fedora Security Advisory FEDORA-2021-5329c680f7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-5329c680f7");

  script_name(english:"Fedora 33 : python-django (2021-5329c680f7)");
...
FEDORA-2021-5329c680f7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-5329c680f7");
...
pkgs = [
    {'reference':'python-django-3.0.12-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
