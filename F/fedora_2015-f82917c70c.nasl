...
# extracted from Fedora Security Advisory 2015-f82917c70c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-f82917c70c");

  script_name(english:"Fedora 23 : php-5.6.14-1.fc23 (2015-f82917c70c)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-October/169228.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?87bf56b5"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-5.6.14-1.fc23")) flag++;
