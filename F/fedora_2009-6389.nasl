...
# extracted from Fedora Security Advisory 2009-6389.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6389");

  script_name(english:"Fedora 10 : drupal-views-6.x.2.6-1.fc10 (2009-6389)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/024996.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?acc6fc65"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"drupal-views-6.x.2.6-1.fc10")) flag++;
