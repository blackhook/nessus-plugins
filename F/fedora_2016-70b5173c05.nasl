...
# extracted from Fedora Security Advisory FEDORA-2016-70b5173c05.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-70b5173c05");

  script_name(english:"Fedora 23 : ecryptfs-utils (2016-70b5173c05)");
...
"  - ecryptfs-utils updated to 111
  ...
  - fix ecryptfs-setup-swap improperly configures encrypted
    swap when using GPT partitioning on a NVMe or MMC drive
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-70b5173c05"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"ecryptfs-utils-111-1.fc23")) flag++;
