...
# extracted from Fedora Security Advisory FEDORA-2016-8f9d466bcc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-8f9d466bcc");

  script_name(english:"Fedora 25 : 389-ds-base (2016-8f9d466bcc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-8f9d466bcc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"389-ds-base-1.3.5.15-1.fc25")) flag++;
