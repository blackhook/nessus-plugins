...
# extracted from Fedora Security Advisory FEDORA-2020-9c97633708.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : mediawiki (2020-9c97633708)");
  ...
  script_set_attribute(
    ...
    value:
"https://lists.wikimedia.org/pipermail/mediawiki-announce/2020-June/000
252.html
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-9c97633708"
  );
  # https://lists.wikimedia.org/pipermail/mediawiki-announce/2020-June/000252.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c346e518"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-15005");
...
flag = 0;
if (rpm_check(release:"FC32", reference:"mediawiki-1.33.4-1.fc32")) flag++;
