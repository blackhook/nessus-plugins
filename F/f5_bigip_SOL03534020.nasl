...
# extracted from F5 Networks BIG-IP Solution K03534020.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PHP vulnerability (K03534020)");
...
crafted image dimensions. (CVE-2016-5767)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K03534020"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["AFM"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("12.0.0-12.1.2","11.6.0-11.6.1","11.4.0-11.5.5");
vmatrix["AM"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("12.0.0-12.1.2","11.6.0-11.6.1","11.4.0-11.5.5","11.2.1","10.2.1-10.2.4");
vmatrix["APM"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("12.0.0-12.1.2","11.6.0-11.6.1","11.4.0-11.5.5","11.2.1","10.2.1-10.2.4");
vmatrix["ASM"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("12.0.0-12.1.2","11.6.0-11.6.1","11.4.0-11.5.5","11.2.1");
vmatrix["AVR"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("11.6.0-11.6.1","11.4.0-11.5.5","11.2.1","10.2.1-10.2.4");
vmatrix["GTM"]["unaffected"] = make_list("11.6.2-11.6.3","11.5.6-11.5.7");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("12.0.0-12.1.2","11.6.0-11.6.1","11.4.0-11.5.5","11.2.1","10.2.1-10.2.4");
vmatrix["LC"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("12.0.0-12.1.2","11.6.0-11.6.1","11.4.0-11.5.5","11.2.1","10.2.1-10.2.4");
vmatrix["LTM"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("12.0.0-12.1.2","11.6.0-11.6.1","11.4.0-11.5.5");
vmatrix["PEM"]["unaffected"] = make_list("14.0.0","13.0.0-13.1.1","12.1.2HF1-12.1.3","11.6.2-11.6.3","11.5.6-11.5.7");
