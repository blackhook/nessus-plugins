...
# extracted from Fedora Security Advisory FEDORA-2017-f0b31bc9c5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f0b31bc9c5");

  script_name(english:"Fedora 25 : mingw-libzip (2017-f0b31bc9c5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f0b31bc9c5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-libzip-1.1.3-2.fc25")) flag++;
