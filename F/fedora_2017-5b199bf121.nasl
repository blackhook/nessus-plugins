...
# extracted from Fedora Security Advisory FEDORA-2017-5b199bf121.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : qt5-qtwebengine (2017-5b199bf121)");
  ...
  script_set_attribute(
    ...
    value:
"This update adds security fixes for CVE-2017-5052 and CVE-2017-5054,
backported to Chromium 49 / QtWebEngine 5.6 by the Qt developers.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-5b199bf121"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"qt5-qtwebengine-5.6.3-0.2.20170712gitee719ad313e564.fc24")) flag++;
