...
# extracted from Fedora Security Advisory FEDORA-2020-d735a887d1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 1:java-11-openjdk (2020-d735a887d1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d735a887d1"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"java-11-openjdk-11.0.6.10-0.fc30", epoch:"1")) flag++;
