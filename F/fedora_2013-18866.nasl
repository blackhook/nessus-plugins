...
# extracted from Fedora Security Advisory 2013-18866.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-18866");

  script_name(english:"Fedora 20 : gnupg2-2.0.22-1.fc20 (2013-18866)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/118966.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc2c20c9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"gnupg2-2.0.22-1.fc20")) flag++;
