...
#
# This plugin text was extracted from Fedora Security Advisory 2011-4075
#
...
if(description)
{
 script_id(53307);
 script_version("1.3");
script_name(english: "Fedora 14 2011-4075");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2011-4075.");
...
flag = 0;
if ( rpm_check( reference:"php-pear-1.9.2-3.fc14", release:"FC14") ) flag ++;
if (flag)
{
