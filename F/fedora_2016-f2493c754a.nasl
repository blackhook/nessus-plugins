...
# extracted from Fedora Security Advisory FEDORA-2016-f2493c754a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : setroubleshoot (2016-f2493c754a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f2493c754a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"setroubleshoot-3.3.9.1-1.fc23")) flag++;
