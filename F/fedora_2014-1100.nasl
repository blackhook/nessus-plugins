...
# extracted from Fedora Security Advisory 2014-1100.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1100");

  script_name(english:"Fedora 19 : nss-3.15.4-1.fc19 / nss-softokn-3.15.4-1.fc19 / nss-util-3.15.4-1.fc19 (2014-1100)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0f78d44f"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/127672.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?84c71588"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/127673.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23eaff8f"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-February/127674.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f397bf28"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"nss-3.15.4-1.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"nss-softokn-3.15.4-1.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"nss-util-3.15.4-1.fc19")) flag++;
