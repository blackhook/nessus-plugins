...
# extracted from Fedora Security Advisory 2012-5079.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 15 : libpng10-1.0.59-1.fc15 (2012-5079)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/077007.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d6dcebe2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libpng10-1.0.59-1.fc15")) flag++;
