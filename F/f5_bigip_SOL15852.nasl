...
# extracted from F5 Networks BIG-IP Solution SOL15852.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3122");
  script_bugtraq_id(67162);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL15852)");
...
page-table mappings."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15852"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["PSM"]["unaffected"] = make_list("12.0.0","11.0.0","10.0.0-10.2.4");
