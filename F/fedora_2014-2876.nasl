...
# extracted from Fedora Security Advisory 2014-2876.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-2876");

  script_name(english:"Fedora 19 : file-5.11-12.fc19 (2014-2876)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-March/129412.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e2b178d"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"file-5.11-12.fc19")) flag++;
