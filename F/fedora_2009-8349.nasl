...
# extracted from Fedora Security Advisory 2009-8349.
#
...
if (description)
{
  ...
  script_bugtraq_id(35221, 35949);
  script_xref(name:"FEDORA", value:"2009-8349");

  script_name(english:"Fedora 11 : apr-util-1.3.9-1.fc11 (2009-8349)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027612.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5d6f2a29"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"apr-util-1.3.9-1.fc11")) flag++;
