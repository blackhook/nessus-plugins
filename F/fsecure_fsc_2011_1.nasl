...
allow disclosure of sensitive information.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d088e126");
     ...
     header =
      ...
      if (report_verbosity > 1)
      {
        trailer =
          ...
          beginning_of_response(resp:data_protection::sanitize_user_full_redaction(output:res[2]), max_lines:line_limit) +
          crap(data:"-", length:30) + " snip " + crap(data:"-", length:30);
      }
