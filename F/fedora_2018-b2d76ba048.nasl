...
# extracted from Fedora Security Advisory FEDORA-2018-b2d76ba048.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-b2d76ba048");

  script_name(english:"Fedora 26 : seamonkey (2018-b2d76ba048)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b2d76ba048"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"seamonkey-2.49.2-2.fc26")) flag++;
