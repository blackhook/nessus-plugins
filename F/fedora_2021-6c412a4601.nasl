...
# extracted from Fedora Security Advisory FEDORA-2021-6c412a4601
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-6c412a4601");

  script_name(english:"Fedora 33 : pki-core (2021-6c412a4601)");
...
FEDORA-2021-6c412a4601 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-6c412a4601");
...
pkgs = [
    {'reference':'pki-core-10.10.5-5.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
