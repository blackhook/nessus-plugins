...
# extracted from Fedora Security Advisory FEDORA-2020-14c194e5af.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 32:bind / bind-dyndb-ldap / dnsperf (2020-14c194e5af)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-14c194e5af");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"bind-9.11.22-1.fc31", epoch:"32")) flag++;
if (rpm_check(release:"FC31", reference:"bind-dyndb-ldap-11.2-4.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"dnsperf-2.3.4-2.fc31")) flag++;
