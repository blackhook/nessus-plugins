...
# extracted from Fedora Security Advisory 2012-8677.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8677");

  script_name(english:"Fedora 17 : arpwatch-2.1a15-20.fc17 (2012-8677)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c5b382f7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"arpwatch-2.1a15-20.fc17")) flag++;
