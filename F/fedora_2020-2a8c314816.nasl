...
# extracted from Fedora Security Advisory FEDORA-2020-2a8c314816.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : tor (2020-2a8c314816)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2a8c314816"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"tor-0.4.2.7-1.fc30")) flag++;
