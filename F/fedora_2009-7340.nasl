...
# extracted from Fedora Security Advisory 2009-7340.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-7340");

  script_name(english:"Fedora 10 : phpMyAdmin-3.2.0.1-1.fc10 (2009-7340)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026081.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3b968003"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"phpMyAdmin-3.2.0.1-1.fc10")) flag++;
