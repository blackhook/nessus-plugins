...
# extracted from Fedora Security Advisory FEDORA-2016-b08d0b00fc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b08d0b00fc");

  script_name(english:"Fedora 22 : php-pecl-zip (2016-b08d0b00fc)");
  ...
  script_set_attribute(
    ...
    value:
"  - Fix bug php#71561 (NULL pointer dereference in
    Zip::ExtractTo)

  - Fix bug php#72434: ZipArchive class Use After Free
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-b08d0b00fc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"php-pecl-zip-1.12.5-2.fc22")) flag++;
