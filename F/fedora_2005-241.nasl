...
# extracted from Fedora Security Advisory 2005-241.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-241");

  script_name(english:"Fedora Core 2 : mailman-2.1.5-10.fc2 (2005-241)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000788.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?48aa26d1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"mailman-2.1.5-10.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"mailman-debuginfo-2.1.5-10.fc2")) flag++;
