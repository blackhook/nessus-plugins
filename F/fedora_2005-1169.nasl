...
# extracted from Fedora Security Advisory 2005-1169.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1169");

  script_name(english:"Fedora Core 4 : xpdf-3.01-0.FC4.5 (2005-1169)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001686.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?10b2bbef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"xpdf-3.01-0.FC4.5")) flag++;
if (rpm_check(release:"FC4", reference:"xpdf-debuginfo-3.01-0.FC4.5")) flag++;
