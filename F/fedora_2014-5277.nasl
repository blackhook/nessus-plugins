...
# extracted from Fedora Security Advisory 2014-5277.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-5277");

  script_name(english:"Fedora 19 : java-1.7.0-openjdk-1.7.0.60-2.4.7.0.fc19 (2014-5277)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c3d46a7e"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/131846.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a4e99ebf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"java-1.7.0-openjdk-1.7.0.60-2.4.7.0.fc19")) flag++;
