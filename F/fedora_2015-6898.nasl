...
# extracted from Fedora Security Advisory 2015-6898.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6898");

  script_name(english:"Fedora 22 : wpa_supplicant-2.3-3.fc22 (2015-6898)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/156428.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cfb374f0"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"wpa_supplicant-2.3-3.fc22")) flag++;
