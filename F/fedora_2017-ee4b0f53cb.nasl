...
# extracted from Fedora Security Advisory FEDORA-2017-ee4b0f53cb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ee4b0f53cb");

  script_name(english:"Fedora 25 : 32:bind (2017-ee4b0f53cb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ee4b0f53cb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"bind-9.10.4-4.P8.fc25", epoch:"32")) flag++;
