...
# extracted from Fedora Security Advisory 2014-6912.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : mingw-curl-7.37.0-1.fc20 (2014-6912)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134033.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?521861e0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"mingw-curl-7.37.0-1.fc20")) flag++;
