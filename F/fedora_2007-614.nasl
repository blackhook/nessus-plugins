...
# extracted from Fedora Security Advisory 2007-614.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : libexif-0.6.15-2.fc6 (2007-614)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-June/002412.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?14137101"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"libexif-0.6.15-2.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"libexif-debuginfo-0.6.15-2.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"libexif-devel-0.6.15-2.fc6")) flag++;
