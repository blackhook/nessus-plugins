...
# extracted from Fedora Security Advisory FEDORA-2019-e99c1603c3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-e99c1603c3");
  script_xref(name:"IAVB", value:"2019-B-0085-S");

  script_name(english:"Fedora 29 : golang (2019-e99c1603c3)");
  ...
  script_set_attribute(
    ...
    value:
"  - Security fix for CVE-2019-16276
...
possible without introducing additional issues."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-e99c1603c3");
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"golang-1.11.13-2.fc29")) flag++;
