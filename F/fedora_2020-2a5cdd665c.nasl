...
# extracted from Fedora Security Advisory FEDORA-2020-2a5cdd665c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : kernel / kernel-headers (2020-2a5cdd665c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-2a5cdd665c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"kernel-5.4.19-100.fc30")) flag++;
if (rpm_check(release:"FC30", reference:"kernel-headers-5.4.18-100.fc30")) flag++;
