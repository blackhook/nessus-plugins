...
# extracted from Fedora Security Advisory 2009-4068.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-4068");

  script_name(english:"Fedora 10 : libmodplug-0.8.7-1.fc10 (2009-4068)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 0.8.7:
http://sourceforge.net/project/shownotes.php?group_id=1275&release_id=
675660
http://sourceforge.net/project/shownotes.php?group_id=1275&release_id=
677065
http://sourceforge.net/project/shownotes.php?group_id=1275&release_id=
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/projects/modplug-xmms/"
  );
  # http://sourceforge.net/project/shownotes.php?group_id=1275&release_id=677065
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9f56209"
  );
  # http://sourceforge.net/project/shownotes.php?group_id=1275&release_id=678622
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?da48e5d2"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=496834"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022854.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?045c2dec"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"libmodplug-0.8.7-1.fc10")) flag++;
