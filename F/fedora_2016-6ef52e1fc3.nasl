...
# extracted from Fedora Security Advisory FEDORA-2016-6ef52e1fc3.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-6ef52e1fc3");

  script_name(english:"Fedora 24 : 2:docker (2016-6ef52e1fc3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-6ef52e1fc3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"docker-1.10.3-15.gitf476348.fc24", epoch:"2")) flag++;
