...
# extracted from Fedora Security Advisory FEDORA-2016-ca1d1e1dc1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : freeipa (2016-ca1d1e1dc1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-ca1d1e1dc1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"freeipa-4.4.3-1.fc25")) flag++;
