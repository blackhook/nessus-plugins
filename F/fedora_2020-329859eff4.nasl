...
# extracted from Fedora Security Advisory FEDORA-2020-329859eff4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : dnsmasq (2020-329859eff4)");
  ...
  script_set_attribute(
    ...
    value:
"Change dnsmasq default configuration to listen only on localhost. If
it should answer local network, configuration has to be modified.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-329859eff4"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"dnsmasq-2.80-16.fc31")) flag++;
