...
# extracted from Fedora Security Advisory FEDORA-2019-c728543252.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : pdns (2019-c728543252)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c728543252"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"pdns-4.1.11-1.fc30")) flag++;
