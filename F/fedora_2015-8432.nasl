...
# extracted from Fedora Security Advisory 2015-8432.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8432");

  script_name(english:"Fedora 22 : LibRaw-0.16.2-1.fc22 (2015-8432)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158529.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05d16a5b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"LibRaw-0.16.2-1.fc22")) flag++;
