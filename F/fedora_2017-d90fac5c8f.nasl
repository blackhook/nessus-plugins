...
# extracted from Fedora Security Advisory FEDORA-2017-d90fac5c8f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d90fac5c8f");

  script_name(english:"Fedora 24 : jasper (2017-d90fac5c8f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d90fac5c8f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"jasper-1.900.13-2.fc24")) flag++;
