...
# extracted from Fedora Security Advisory 2012-6612.
#
...
if (description)
{
  ...
  script_bugtraq_id(52523, 52815, 53206, 53210);
  script_xref(name:"FEDORA", value:"2012-6612");

  script_name(english:"Fedora 16 : asterisk-1.8.11.1-1.fc16 (2012-6612)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/079729.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23cada77"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"asterisk-1.8.11.1-1.fc16")) flag++;
