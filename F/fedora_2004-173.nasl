...
# extracted from Fedora Security Advisory 2004-173.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-173");

  script_name(english:"Fedora Core 1 : libpng-1.2.5-4 (2004-173)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000175.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca69e2de"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
