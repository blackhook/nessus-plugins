...
# extracted from Fedora Security Advisory FEDORA-2018-c4e9207c31.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-c4e9207c31");

  script_name(english:"Fedora 26 : php (2018-c4e9207c31)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-c4e9207c31"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"php-7.1.13-1.fc26")) flag++;
