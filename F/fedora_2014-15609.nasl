...
# extracted from Fedora Security Advisory 2014-15609.
#
...
if (description)
{
  ...
  script_bugtraq_id(71150, 71153, 71155);
  script_xref(name:"FEDORA", value:"2014-15609");

  script_name(english:"Fedora 21 : tcpdump-4.6.2-2.fc21 (2014-15609)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145449.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38eb13ef"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"tcpdump-4.6.2-2.fc21")) flag++;
