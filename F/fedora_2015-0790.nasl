...
# extracted from Fedora Security Advisory 2015-0790.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-0219", "CVE-2015-0221", "CVE-2015-0222");
  script_xref(name:"FEDORA", value:"2015-0790");

  script_name(english:"Fedora 20 : python-django-1.6.10-1.fc20 (2015-0790)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148696.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ddd4e38f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-django-1.6.10-1.fc20")) flag++;
