...
# extracted from Fedora Security Advisory FEDORA-2019-541e91b477.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : ignition (2019-541e91b477)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-541e91b477"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected ignition package."
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:ignition");
...
flag = 0;
if (rpm_check(release:"FC28", reference:"ignition-0.31.0-1.gitf59a653.fc28")) flag++;
