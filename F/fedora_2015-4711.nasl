...
# extracted from Fedora Security Advisory 2015-4711.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-4711");

  script_name(english:"Fedora 21 : ca-certificates-2015.2.3-1.0.fc21 (2015-4711)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154653.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?98efb3e8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"ca-certificates-2015.2.3-1.0.fc21")) flag++;
