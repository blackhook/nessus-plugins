...
# extracted from Fedora Security Advisory 2016-ac1dff014c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-ac1dff014c");

  script_name(english:"Fedora 22 : webkitgtk4-2.12.1-1.fc22 (2016-ac1dff014c)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-April/183100.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0db713da"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"webkitgtk4-2.12.1-1.fc22")) flag++;
