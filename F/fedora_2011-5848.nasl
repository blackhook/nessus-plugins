...
# extracted from Fedora Security Advisory 2011-5848.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5848");

  script_name(english:"Fedora 15 : mediawiki-1.16.4-58.fc15 (2011-5848)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7bc2ee23"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"mediawiki-1.16.4-58.fc15")) flag++;
