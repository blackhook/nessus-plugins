...
# extracted from Fedora Security Advisory 2011-8403.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : xen-4.0.2-1.fc14 (2011-8403)");
  ...
  script_set_attribute(
    ...
    value:
"update to 4.0.2 - includes various bugfixes and fix for
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?30ad2824"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"xen-4.0.2-1.fc14")) flag++;
