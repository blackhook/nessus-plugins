...
# extracted from Fedora Security Advisory 2015-8717.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8717");

  script_name(english:"Fedora 21 : ufraw-0.21-1.fc21 (2015-8717)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159469.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6ddd70d"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"ufraw-0.21-1.fc21")) flag++;
