...
# extracted from Fedora Security Advisory FEDORA-2019-1add9a328f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-1add9a328f");

  script_name(english:"Fedora 29 : 1:dovecot (2019-1add9a328f)");
  ...
  script_set_attribute(
    ...
    value:
"dovecot updated to 2.3.7.1, pigeonhole to 0.5.7.1
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1add9a328f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"dovecot-2.3.7.1-1.fc29", epoch:"1")) flag++;
