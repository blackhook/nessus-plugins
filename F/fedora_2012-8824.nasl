...
# extracted from Fedora Security Advisory 2012-8824.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-8824");

  script_name(english:"Fedora 17 : kernel-3.4.0-1.fc17 (2012-8824)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/081855.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f6254785"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"kernel-3.4.0-1.fc17")) flag++;
