...
if (description)
{
  ...
  script_cve_id("CVE-2020-11493", "CVE-2020-12247", "CVE-2020-12248");
...
"Upgrade to Foxit PhantomPDF version 10.0.1 or later");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-12248");
...
constraints = [
  { 'min_version' : '10.0', 'max_version' : '10.0.0.35798', 'fixed_version' : '10.0.1' }
];
