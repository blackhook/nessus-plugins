...
# extracted from Fedora Security Advisory 2016-0f490eea10.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0f490eea10");

  script_name(english:"Fedora 22 : jenkins-1.609.3-6.fc22 / jenkins-remoting-2.53.3-1.fc22 (2016-0f490eea10)");
...
flag = 0;
if (rpm_check(release:"FC22", reference:"jenkins-1.609.3-6.fc22")) flag++;
if (rpm_check(release:"FC22", reference:"jenkins-remoting-2.53.3-1.fc22")) flag++;
