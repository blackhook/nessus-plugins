...
# extracted from Fedora Security Advisory FEDORA-2017-2bce6ed778.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-2bce6ed778");

  script_name(english:"Fedora 24 : viewvc (2017-2bce6ed778)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2bce6ed778"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"viewvc-1.1.26-1.fc24")) flag++;
