...
# extracted from Fedora Security Advisory FEDORA-2016-24478a88fe.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-24478a88fe");

  script_name(english:"Fedora 25 : python-tornado (2016-24478a88fe)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-24478a88fe"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2016/11/26");
...
flag = 0;
if (rpm_check(release:"FC25", reference:"python-tornado-4.4.2-1.fc25")) flag++;
