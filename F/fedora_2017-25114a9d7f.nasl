...
# extracted from Fedora Security Advisory FEDORA-2017-25114a9d7f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-25114a9d7f");

  script_name(english:"Fedora 27 : drupal7-views (2017-25114a9d7f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-25114a9d7f"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC27", reference:"drupal7-views-3.18-1.fc27")) flag++;
