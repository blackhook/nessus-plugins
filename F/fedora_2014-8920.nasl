...
# extracted from Fedora Security Advisory 2014-8920.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-8920");

  script_name(english:"Fedora 20 : bugzilla-4.2.10-1.fc20 (2014-8920)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2e2bde9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"bugzilla-4.2.10-1.fc20")) flag++;
