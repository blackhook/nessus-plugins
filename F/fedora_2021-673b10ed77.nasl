...
# extracted from Fedora Security Advisory FEDORA-2021-673b10ed77
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-673b10ed77");

  script_name(english:"Fedora 33 : python-aiohttp (2021-673b10ed77)");
...
FEDORA-2021-673b10ed77 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-673b10ed77");
...
pkgs = [
    {'reference':'python-aiohttp-3.7.4-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
