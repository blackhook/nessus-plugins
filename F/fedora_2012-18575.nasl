...
# extracted from Fedora Security Advisory 2012-18575.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-18575");

  script_name(english:"Fedora 16 : weechat-0.3.8-4.fc16 (2012-18575)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/093457.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e10cc33"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/093516.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a7ebf16"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"weechat-0.3.8-4.fc16")) flag++;
