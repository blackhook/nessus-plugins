...
# extracted from Fedora Security Advisory 2015-7714.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7714");

  script_name(english:"Fedora 20 : ca-certificates-2015.2.4-1.0.fc20 (2015-7714)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/159057.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca8d785b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"ca-certificates-2015.2.4-1.0.fc20")) flag++;
