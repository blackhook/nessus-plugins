...
# extracted from Fedora Security Advisory FEDORA-2017-3dba8a70ce.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : jasper (2017-3dba8a70ce)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3dba8a70ce"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"jasper-1.900.13-3.fc25")) flag++;
