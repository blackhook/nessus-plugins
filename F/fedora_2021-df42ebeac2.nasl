...
# extracted from Fedora Security Advisory FEDORA-2021-df42ebeac2
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : flac (2021-df42ebeac2)");
...
FEDORA-2021-df42ebeac2 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-df42ebeac2");
...
pkgs = [
    {'reference':'flac-1.3.3-4.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
