...
# extracted from Fedora Security Advisory 2014-2421.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-2421");

  script_name(english:"Fedora 20 : maradns-2.0.09-1.fc20 (2014-2421)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ce7189d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"maradns-2.0.09-1.fc20")) flag++;
