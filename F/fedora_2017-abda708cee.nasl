...
# extracted from Fedora Security Advisory FEDORA-2017-abda708cee.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-abda708cee");

  script_name(english:"Fedora 27 : kernel (2017-abda708cee)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-abda708cee"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2017-abda708cee");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC27", reference:"kernel-4.13.12-300.fc27")) flag++;
