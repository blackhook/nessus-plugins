...
# extracted from Fedora Security Advisory FEDORA-2017-191d7ec089.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : cups-filters / qpdf (2017-191d7ec089)");
  ...
  script_set_attribute(
    ...
    value:
"Adding patches for CVEs in qpdf does binary incompatibility, so
cups-filters needed to be rebuilt.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-191d7ec089"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"cups-filters-1.13.4-3.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"qpdf-6.0.0-8.fc26")) flag++;
