...
# extracted from Fedora Security Advisory FEDORA-2018-e23d2dae46.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-e23d2dae46");

  script_name(english:"Fedora 26 : mingw-poppler (2018-e23d2dae46)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-e23d2dae46"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-poppler-0.52.0-6.fc26")) flag++;
