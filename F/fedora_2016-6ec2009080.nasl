...
# extracted from Fedora Security Advisory FEDORA-2016-6ec2009080.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-6ec2009080");

  script_name(english:"Fedora 23 : 4:perl (2016-6ec2009080)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-1238
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-6ec2009080"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"perl-5.22.2-354.fc23", epoch:"4")) flag++;
