...
# extracted from Fedora Security Advisory FEDORA-2016-9b83c6862d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-9b83c6862d");

  script_name(english:"Fedora 25 : community-mysql (2016-9b83c6862d)");
  ...
  script_set_attribute(
    ...
    value:
"  - Mon Dec 12 2016 Norvald H. Ryeng
    <norvald.ryeng@oracle.com> - 5.7.17-1
  ...
  - Add numactl-devel to buildreq and enable NUMA support
    (if available)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-9b83c6862d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"community-mysql-5.7.17-1.fc25")) flag++;
