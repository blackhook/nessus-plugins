...
# extracted from Fedora Security Advisory 2009-4892.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-4892");

  script_name(english:"Fedora 11 : opensc-0.11.8-1.fc11 (2009-4892)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-May/024308.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?200962dd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"opensc-0.11.8-1.fc11")) flag++;
