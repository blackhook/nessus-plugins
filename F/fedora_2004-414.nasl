...
# extracted from Fedora Security Advisory 2004-414.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-414");

  script_name(english:"Fedora Core 2 : unarj-2.63a-7 (2004-414)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-November/000393.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d089fdde"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected unarj package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:unarj");
...
flag = 0;
if (rpm_check(release:"FC2", reference:"unarj-2.63a-7")) flag++;
