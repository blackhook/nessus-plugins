...
# extracted from Fedora Security Advisory 2007-3403.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2007-4572");
  script_xref(name:"FEDORA", value:"2007-3403");

  script_name(english:"Fedora 8 : samba-3.0.27-0.fc8 (2007-3403)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004908.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d8719628"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"libsmbclient-3.0.27-0.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"libsmbclient-devel-3.0.27-0.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"samba-3.0.27-0.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"samba-client-3.0.27-0.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"samba-common-3.0.27-0.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"samba-debuginfo-3.0.27-0.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"samba-doc-3.0.27-0.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"samba-swat-3.0.27-0.fc8")) flag++;
