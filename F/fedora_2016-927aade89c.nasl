...
# extracted from Fedora Security Advisory FEDORA-2016-927aade89c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-927aade89c");

  script_name(english:"Fedora 22 : rpm (2016-927aade89c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-927aade89c"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"rpm-4.12.0.1-17.fc22")) flag++;
