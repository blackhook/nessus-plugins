...
# extracted from Fedora Security Advisory 2010-0530.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : ruby-1.8.6.383-6.fc12 (2010-0530)");
  ...
  script_set_attribute(
    ...
    value:
"A security vulnerability is found on WEBrick module in Ruby currently
shipped on Fedora 12 that WEBrick lets attackers to inject malicious
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=554485"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-January/033929.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e21990e4"
  );
...
os_ver = os_ver[1];
if (! preg(pattern:"^12([^0-9]|$)", string:os_ver)) audit(AUDIT_OS_NOT, "Fedora 12.x", "Fedora " + os_ver);
...
flag = 0;
if (rpm_check(release:"FC12", reference:"ruby-1.8.6.383-6.fc12")) flag++;
