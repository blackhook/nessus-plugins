...
# extracted from Fedora Security Advisory FEDORA-2018-da33a74b32.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-da33a74b32");

  script_name(english:"Fedora 27 : libgxps (2018-da33a74b32)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-da33a74b32"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libgxps-0.3.0-5.fc27")) flag++;
