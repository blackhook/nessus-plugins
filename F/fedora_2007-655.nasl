...
# extracted from Fedora Security Advisory 2007-655.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : kernel-2.6.22.1-32.fc6 (2007-655)");
...
Fixes since initial 2.6.22 test kernel was released: Fix timer
problems and failure to boot. Fix failure to boot on PS3. Fix failure
to initialize Hpt37x ATA controllers. Hopefully fix atl1 ethernet
controller DMA. Add RAID autostart (dropped during initial rebase.)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://mirrors.edge.kernel.org/pub/linux/kernel/v2.6/ChangeLog-2.6.22"
  );
  # http://www.kernel.org/pub/linux/kernel/v2.6/ChangeLog-2.6.22.1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eb3a8c62"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-August/003165.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8865ef84"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"kernel-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debug-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debug-debuginfo-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debug-devel-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-debuginfo-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", cpu:"i386", reference:"kernel-PAE-devel-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debug-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debug-debuginfo-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debug-devel-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debuginfo-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-debuginfo-common-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-devel-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-doc-2.6.22.1-32.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"kernel-headers-2.6.22.1-32.fc6")) flag++;
