...
# extracted from Fedora Security Advisory 2014-6530.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6530");

  script_name(english:"Fedora 19 : php-ZendFramework2-2.2.7-1.fc19 (2014-6530)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133789.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?274a24cb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"php-ZendFramework2-2.2.7-1.fc19")) flag++;
