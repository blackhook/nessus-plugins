...
# extracted from Fedora Security Advisory 2015-11860.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-11860");

  script_name(english:"Fedora 22 : java-1.8.0-openjdk-1.8.0.51-4.b16.fc22 (2015-11860)");
  ...
  script_set_attribute(
    ...
    value:
"security update to oracle CPU july 2015 -
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/162250.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ec1d017"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"java-1.8.0-openjdk-1.8.0.51-4.b16.fc22")) flag++;
