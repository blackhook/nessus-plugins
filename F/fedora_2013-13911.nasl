...
# extracted from Fedora Security Advisory 2013-13911.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-13911");

  script_name(english:"Fedora 18 : ReviewBoard-1.7.12-1.fc18 / python-djblets-0.7.16-1.fc18 (2013-13911)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/113468.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a77c05ea"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/113469.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a283226f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"ReviewBoard-1.7.12-1.fc18")) flag++;
if (rpm_check(release:"FC18", reference:"python-djblets-0.7.16-1.fc18")) flag++;
