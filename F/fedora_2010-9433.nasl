...
# extracted from Fedora Security Advisory 2010-9433.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : dhcp-4.1.1-22.P1.fc13 (2010-9433)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e4b7de4f"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"dhcp-4.1.1-22.P1.fc13")) flag++;
