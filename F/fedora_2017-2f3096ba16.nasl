...
# extracted from Fedora Security Advisory FEDORA-2017-2f3096ba16.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-2f3096ba16");

  script_name(english:"Fedora 26 : php-pear-CAS (2017-2f3096ba16)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2f3096ba16"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"php-pear-CAS-1.3.5-1.fc26")) flag++;
