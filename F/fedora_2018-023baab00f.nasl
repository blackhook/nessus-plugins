...
# extracted from Fedora Security Advisory FEDORA-2018-023baab00f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-023baab00f");

  script_name(english:"Fedora 27 : mingw-wavpack (2018-023baab00f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-023baab00f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"mingw-wavpack-5.1.0-4.fc27")) flag++;
