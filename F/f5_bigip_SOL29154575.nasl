...
# extracted from F5 Networks BIG-IP Solution K29154575.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : ImageMagick vulnerability (K29154575)");
...
known as ImageTragick."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K29154575"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
