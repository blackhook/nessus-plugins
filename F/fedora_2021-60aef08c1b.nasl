...
# extracted from Fedora Security Advisory FEDORA-2021-60aef08c1b
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-60aef08c1b");

  script_name(english:"Fedora 35 : firefox (2021-60aef08c1b)");
...
FEDORA-2021-60aef08c1b advisory.

  - - New upstream update (93.0) - Fixed NSS package dependency (NSS 3.70)  ----  - New upstream release
    (93.0)    (FEDORA-2021-60aef08c1b)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-60aef08c1b");
...
var pkgs = [
    {'reference':'firefox-93.0-2.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
