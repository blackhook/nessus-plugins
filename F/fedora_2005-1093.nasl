...
# extracted from Fedora Security Advisory 2005-1093.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1093");

  script_name(english:"Fedora Core 4 : openswan-2.4.4-1.0.FC4.1 (2005-1093)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-November/001591.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?236b14ee"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"openswan-2.4.4-1.0.FC4.1")) flag++;
if (rpm_check(release:"FC4", reference:"openswan-doc-2.4.4-1.0.FC4.1")) flag++;
