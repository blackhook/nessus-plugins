...
# extracted from Fedora Security Advisory 2009-10432.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10432");

  script_name(english:"Fedora 10 : Django-1.1.1-1.fc10 (2009-10432)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030106.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d1d5559"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"Django-1.1.1-1.fc10")) flag++;
