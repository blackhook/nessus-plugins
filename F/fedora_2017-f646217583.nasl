...
# extracted from Fedora Security Advisory FEDORA-2017-f646217583.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f646217583");

  script_name(english:"Fedora 25 : gnutls (2017-f646217583)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f646217583"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"gnutls-3.5.13-1.fc25")) flag++;
