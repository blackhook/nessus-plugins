...
# extracted from Fedora Security Advisory FEDORA-2017-150762f6be.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : glusterfs (2017-150762f6be)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-150762f6be"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"glusterfs-3.10.6-4.fc25")) flag++;
