...
# extracted from Fedora Security Advisory 2011-0640.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-0640");

  script_name(english:"Fedora 14 : perl-CGI-3.51-1.fc14 (2011-0640)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=657950"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-January/053628.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6e8e6562"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"perl-CGI-3.51-1.fc14")) flag++;
