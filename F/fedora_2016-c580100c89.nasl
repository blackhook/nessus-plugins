...
# extracted from Fedora Security Advisory FEDORA-2016-c580100c89.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-c580100c89");

  script_name(english:"Fedora 24 : libarchive (2016-c580100c89)");
  ...
  script_set_attribute(
    ...
    value:
"rebase on to version 3.2.1 fixing several flaws
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c580100c89"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libarchive-3.2.1-3.fc24")) flag++;
