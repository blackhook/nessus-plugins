...
# extracted from Fedora Security Advisory 2014-8495.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-8495");

  script_name(english:"Fedora 20 : drupal6-6.32-1.fc20 (2014-8495)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/136094.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e69e3563"
  );
  # https://www.drupal.org/SA-CORE-2014-003
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC20", reference:"drupal6-6.32-1.fc20")) flag++;
