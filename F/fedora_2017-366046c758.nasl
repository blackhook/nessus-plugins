...
# extracted from Fedora Security Advisory FEDORA-2017-366046c758.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-366046c758");

  script_name(english:"Fedora 26 : 2:samba (2017-366046c758)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-366046c758"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"samba-4.6.11-0.fc26", epoch:"2")) flag++;
