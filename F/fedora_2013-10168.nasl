...
# extracted from Fedora Security Advisory 2013-10168.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-10168");

  script_name(english:"Fedora 17 : gallery3-3.0.8-1.fc17 (2013-10168)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/apps/trac/gallery/ticket/2068"
  );
  # http://sourceforge.net/apps/trac/gallery/ticket/2070
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/apps/trac/gallery/ticket/2070"
  );
  # http://sourceforge.net/mailarchive/message.php?msg_id=30925931
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/p/gallery/mailman/message/30925931/"
  );
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/108895.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b53f03a4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gallery3-3.0.8-1.fc17")) flag++;
