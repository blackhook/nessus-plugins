...
# extracted from Fedora Security Advisory 2013-18455.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-4296", "CVE-2013-4297", "CVE-2013-4311");
  script_bugtraq_id(62508, 62510, 62576);
  script_xref(name:"FEDORA", value:"2013-18455");

  script_name(english:"Fedora 20 : libvirt-1.1.3-2.fc20 (2013-18455)");
...
"  - Allow QoS change with update-device (bz #1014200)
    ...
    - Fix nwfilter crash during firewalld install (bz
      #1014762)

    - Fix crash with nographics (bz #1014088) Update to
      1.1.3 release
  ...
  - Sync with v1.1.2-maint
    ...
    - CVE-2013-4297: Invalid free in NBDDeviceAssociate (bz
      #1006505, bz #1006511)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1006505"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/118934.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e43a7d5a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libvirt-1.1.3-2.fc20")) flag++;
