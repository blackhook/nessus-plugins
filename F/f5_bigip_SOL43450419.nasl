...
peer system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K43450419"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["AFM"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["AM"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["APM"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["ASM"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["AVR"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["GTM"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["LC"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["LTM"]["unaffected"] = make_list("15.0.0","14.1.2.4");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("14.1.0-14.1.2");
vmatrix["PEM"]["unaffected"] = make_list("15.0.0","14.1.2.4");
