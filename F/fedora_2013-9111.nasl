...
# extracted from Fedora Security Advisory 2013-9111.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-9111");

  script_name(english:"Fedora 17 : livecd-tools-17.17-1.fc17 (2013-9111)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/108503.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a2dc33dd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"livecd-tools-17.17-1.fc17")) flag++;
