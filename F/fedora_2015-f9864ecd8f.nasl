...
# extracted from Fedora Security Advisory 2015-f9864ecd8f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-f9864ecd8f");

  script_name(english:"Fedora 23 : pacemaker-1.1.13-3.fc23 (2015-f9864ecd8f)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-October/169995.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1780d708"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"pacemaker-1.1.13-3.fc23")) flag++;
