...
# extracted from Fedora Security Advisory 2013-11234.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-11234");

  script_name(english:"Fedora 17 : haproxy-1.4.24-1.fc17 (2013-11234)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/109968.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3076b2bc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"haproxy-1.4.24-1.fc17")) flag++;
