...
# extracted from Fedora Security Advisory FEDORA-2017-266ab882cd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-266ab882cd");
  script_xref(name:"IAVB", value:"2017-B-0024-S");

  script_name(english:"Fedora 25 : xen (2017-266ab882cd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-266ab882cd"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"xen-4.7.1-9.fc25")) flag++;
