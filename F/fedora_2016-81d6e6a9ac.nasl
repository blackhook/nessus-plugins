...
# extracted from Fedora Security Advisory FEDORA-2016-81d6e6a9ac.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-81d6e6a9ac");
  script_xref(name:"CEA-ID", value:"CEA-2019-0547");

  script_name(english:"Fedora 25 : openvpn (2016-81d6e6a9ac) (SWEET32)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-81d6e6a9ac");
...
flag = 0;
if (rpm_check(release:"FC25", reference:"openvpn-2.3.12-1.fc25")) flag++;
