...
# extracted from Fedora Security Advisory 2012-19715.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-19715");

  script_name(english:"Fedora 16 : qt-4.8.4-1.fc16 (2012-19715)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7315ee7e"
  );
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/094986.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2026d86d"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"qt-4.8.4-1.fc16")) flag++;
