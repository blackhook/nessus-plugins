...
# extracted from Fedora Security Advisory FEDORA-2021-4b0a8b8629
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-4b0a8b8629");

  script_name(english:"Fedora 32 : seamonkey (2021-4b0a8b8629)");
...
FEDORA-2021-4b0a8b8629 advisory.

  - Appled all the changes from the upstream 2.53.7.1 update. Fixed tab opening in background and tab choosing
    on a tab close.  ----  Fix updating and support of legacy javascript extensions.  ----  Update to 2.53.7
    ...
    Some performance fixes, including from upcoming releases. (FEDORA-2021-4b0a8b8629)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-4b0a8b8629");
...
pkgs = [
    {'reference':'seamonkey-2.53.7-3.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
