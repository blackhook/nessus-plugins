...
# extracted from Fedora Security Advisory 2011-13424.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-13424");

  script_name(english:"Fedora 16 : thunderbird-7.0-1.fc16 / thunderbird-lightning-1.0-0.50.b7.fc16 (2011-13424)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?746d010b"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/067124.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?235f798c"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/067125.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e366341e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC16", reference:"thunderbird-7.0-1.fc16")) flag++;
if (rpm_check(release:"FC16", reference:"thunderbird-lightning-1.0-0.50.b7.fc16")) flag++;
