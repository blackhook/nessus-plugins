...
# extracted from Fedora Security Advisory 2016-474c1d8264.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-474c1d8264");

  script_name(english:"Fedora 23 : php-pecl-http-2.5.6-1.fc23 (2016-474c1d8264)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-March/179321.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e2b825d7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-pecl-http-2.5.6-1.fc23")) flag++;
