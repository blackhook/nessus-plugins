...
# extracted from Fedora Security Advisory 2004-295.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-295");

  script_name(english:"Fedora Core 2 : lha-1.14i-14.1 (2004-295)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-September/000280.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?19b18310"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"lha-1.14i-14.1")) flag++;
if (rpm_check(release:"FC2", reference:"lha-debuginfo-1.14i-14.1")) flag++;
