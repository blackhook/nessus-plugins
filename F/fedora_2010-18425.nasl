...
# extracted from Fedora Security Advisory 2010-18425.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : krb5-1.7.1-16.fc13 (2010-18425)");
  ...
  script_set_attribute(
    ...
    value:
"This update incorporates the upstream patches to correct bugs outlined
in MITKRB5-SA-2010-007 (CVE-2010-1323, CVE-2010-1324, and
CVE-2010-4020).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=648674"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=648734"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=648735"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-December/051999.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5767c6b0"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"krb5-1.7.1-16.fc13")) flag++;
