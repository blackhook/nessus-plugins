...
# extracted from Fedora Security Advisory 2014-2505.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-2505");

  script_name(english:"Fedora 20 : imapsync-1.584-1.fc20 (2014-2505)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?67816925"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"imapsync-1.584-1.fc20")) flag++;
