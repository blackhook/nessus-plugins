...
# extracted from Fedora Security Advisory FEDORA-2016-6802f2e52a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : fontconfig (2016-6802f2e52a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-6802f2e52a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"fontconfig-2.11.94-5.fc23")) flag++;
