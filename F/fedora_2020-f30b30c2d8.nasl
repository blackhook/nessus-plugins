...
# extracted from Fedora Security Advisory FEDORA-2020-f30b30c2d8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : rpki-client (2020-f30b30c2d8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-f30b30c2d8"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"rpki-client-6.8p1-1.fc33")) flag++;
