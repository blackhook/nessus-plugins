...
# extracted from Fedora Security Advisory 2009-12737.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-12737");

  script_name(english:"Fedora 12 : expat-2.0.1-8.fc12 (2009-12737)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-December/032222.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?765c53f5"
  );
...
flag = 0;
if (rpm_check(release:"FC12", reference:"expat-2.0.1-8.fc12")) flag++;
