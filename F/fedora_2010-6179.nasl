...
# extracted from Fedora Security Advisory 2010-6179.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-6179");

  script_name(english:"Fedora 13 : alienarena-7.33-2.fc13 (2010-6179)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/038705.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7c8a9386"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"alienarena-7.33-2.fc13")) flag++;
