...
# extracted from Fedora Security Advisory 2003-030.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2003-030");

  script_name(english:"Fedora Core 1 : rsync-2.5.7-2 (2003-030)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2003-December/000014.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38f14d17"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC1", cpu:"i386", reference:"rsync-2.5.7-2")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"rsync-debuginfo-2.5.7-2")) flag++;
