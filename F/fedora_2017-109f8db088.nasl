...
# extracted from Fedora Security Advisory FEDORA-2017-109f8db088.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-109f8db088");

  script_name(english:"Fedora 27 : chromium (2017-109f8db088)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 61.0.3163.100. Security fix for CVE-2017-5111,
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-109f8db088"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"chromium-61.0.3163.100-1.fc27")) flag++;
