...
# extracted from Fedora Security Advisory FEDORA-2019-2bad806189.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : glpi (2019-2bad806189)");
...
Non exhaustive list of changes :
  ...
  - New &ldquo;Prevent take into account&rdquo; action on
    tickets business rules,

  - New &ldquo;Status&rdquo; criterion on tickets business
    rules,
...
See
[changelog](https://github.com/glpi-project/glpi/milestone/36?closed=1
) for details.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-2bad806189"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/glpi-project/glpi/milestone/36?closed=1"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"glpi-9.4.3-1.fc30")) flag++;
