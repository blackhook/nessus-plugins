...
# extracted from Fedora Security Advisory FEDORA-2016-cafdfdf58c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-cafdfdf58c");

  script_name(english:"Fedora 25 : gnutls (2016-cafdfdf58c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-cafdfdf58c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"gnutls-3.5.4-1.fc25")) flag++;
