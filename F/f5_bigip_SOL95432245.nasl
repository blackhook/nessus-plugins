...
# extracted from F5 Networks BIG-IP Solution K95432245.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PHP vulnerability (K95432245)");
...
(CVE-2016-5768)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K95432245"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
