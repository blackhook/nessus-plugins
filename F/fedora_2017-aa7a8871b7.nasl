...
# extracted from Fedora Security Advisory FEDORA-2017-aa7a8871b7.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-13735", "CVE-2017-14348");
  script_xref(name:"FEDORA", value:"2017-aa7a8871b7");

  script_name(english:"Fedora 25 : mingw-LibRaw (2017-aa7a8871b7)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes CVE-2017-14348.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-aa7a8871b7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-LibRaw-0.17.2-3.fc25")) flag++;
