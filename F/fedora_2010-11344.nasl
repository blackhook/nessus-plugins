...
# extracted from Fedora Security Advisory 2010-11344.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : bind-9.7.1-2.P2.fc13 (2010-11344)");
  ...
  script_set_attribute(
    ...
    value:
"RRSIG query handling bug in BIND 9.7.1 (CVE-2010-0213)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?27b42b51"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=616706"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-July/044445.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?02b4c105"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"bind-9.7.1-2.P2.fc13")) flag++;
