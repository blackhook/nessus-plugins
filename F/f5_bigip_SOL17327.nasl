...
# extracted from F5 Networks BIG-IP Solution K17327.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : GnuTLS RSA PKCS signature vulnerability (K17327)");
  ...
  script_set_attribute(
    ...
    value:
"GnuTLS before 3.1.0 does not verify that the RSA PKCS #1 signature
algorithm matches the signature algorithm in the certificate, which
allows remote attackers to conduct downgrade attacks via unspecified
vectors. (CVE-2015-0282)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K17327"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["PEM"]["unaffected"] = make_list("12.1.0","11.3.0-11.6.0");
