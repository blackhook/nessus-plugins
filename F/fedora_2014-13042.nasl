...
# extracted from Fedora Security Advisory 2014-13042.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13042");

  script_name(english:"Fedora 20 : firefox-33.0-1.fc20 (2014-13042)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/141085.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?75cf85a7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"firefox-33.0-1.fc20")) flag++;
