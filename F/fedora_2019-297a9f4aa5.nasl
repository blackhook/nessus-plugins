...
# extracted from Fedora Security Advisory FEDORA-2019-297a9f4aa5.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : python3 (2019-297a9f4aa5)");
  ...
  script_set_attribute(
    ...
    value:
"Python 3.7.6 is the latest *bugfix* release of Python 3.7. It includes
some security fixes as well.

----

Backport `-k` and `-a` options for `pathfix.py` to allow keeping and
adding shebang flags.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-297a9f4aa5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"python3-3.7.6-1.fc30")) flag++;
