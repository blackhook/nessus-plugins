...
# extracted from Fedora Security Advisory FEDORA-2017-15987a1b7f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : SDL2_image (2017-15987a1b7f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-15987a1b7f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"SDL2_image-2.0.1-8.fc25")) flag++;
