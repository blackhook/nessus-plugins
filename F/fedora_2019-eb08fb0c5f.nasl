...
# extracted from Fedora Security Advisory FEDORA-2019-eb08fb0c5f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : 2:microcode_ctl (2019-eb08fb0c5f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-eb08fb0c5f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"microcode_ctl-2.1-29.fc30", epoch:"2")) flag++;
