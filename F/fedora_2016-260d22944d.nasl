...
# extracted from Fedora Security Advisory FEDORA-2016-260d22944d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-260d22944d");

  script_name(english:"Fedora 25 : httpd (2016-260d22944d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-260d22944d"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"httpd-2.4.23-5.fc25")) flag++;
