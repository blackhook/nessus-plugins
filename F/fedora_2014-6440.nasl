...
# extracted from Fedora Security Advisory 2014-6440.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6440");

  script_name(english:"Fedora 20 : python-django15-1.5.8-1.fc20 (2014-6440)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133704.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31660b70"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-django15-1.5.8-1.fc20")) flag++;
