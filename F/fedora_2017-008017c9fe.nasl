...
# extracted from Fedora Security Advisory FEDORA-2017-008017c9fe.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : ansible (2017-008017c9fe)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-008017c9fe"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ansible-2.4.1.0-2.fc25")) flag++;
