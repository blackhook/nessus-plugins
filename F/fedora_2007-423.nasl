...
# extracted from Fedora Security Advisory 2007-423.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : libXfont-1.2.8-1.fc6 (2007-423)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-April/001648.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8dc52a66"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC6", reference:"libXfont-1.2.8-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"libXfont-debuginfo-1.2.8-1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"libXfont-devel-1.2.8-1.fc6")) flag++;
