...
# extracted from F5 Networks BIG-IP Solution K31997425.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-8575", "CVE-2017-5482", "CVE-2017-5483", "CVE-2017-5484", "CVE-2017-5485", "CVE-2017-5486");

  script_name(english:"F5 Networks BIG-IP : tcpdump vulnerabilities (K31997425)");
...
CVE-2017-5484 The ATM parser in tcpdump before 4.9.0 has a buffer
overflow in print-atm.c:sig_print().
...
overflow in print-isoclns.c:clnp_print()."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K31997425"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
