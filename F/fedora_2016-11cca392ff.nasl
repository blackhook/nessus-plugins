...
# extracted from Fedora Security Advisory 2016-11cca392ff.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-11cca392ff");

  script_name(english:"Fedora 22 : mbedtls-1.3.16-1.fc22 (2016-11cca392ff)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-January/175762.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3251eaef"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"mbedtls-1.3.16-1.fc22")) flag++;
