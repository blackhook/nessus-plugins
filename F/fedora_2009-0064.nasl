...
# extracted from Fedora Security Advisory 2009-0064.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-0064");

  script_name(english:"Fedora 9 : proftpd-1.3.1-8.fc9 (2009-0064)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-January/018519.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e889fda0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"proftpd-1.3.1-8.fc9")) flag++;
