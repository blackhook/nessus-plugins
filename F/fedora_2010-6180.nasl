...
# extracted from Fedora Security Advisory 2010-6180.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-6180");

  script_name(english:"Fedora 13 : moin-1.9.2-2.fc13 (2010-6180)");
  ...
  script_set_attribute(
    ...
    value:
"  - Bug #578801 - CVE-2010-0828 Moin v1.8.7 / v.1.9.2 -- XSS
    in Despam action
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/038706.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e99a5eb7"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"moin-1.9.2-2.fc13")) flag++;
