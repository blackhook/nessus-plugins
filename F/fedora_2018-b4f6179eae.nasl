...
# extracted from Fedora Security Advisory FEDORA-2018-b4f6179eae.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : 1:php-pear (2018-b4f6179eae)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-b4f6179eae"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-pear-1.10.7-2.fc29", epoch:"1")) flag++;
