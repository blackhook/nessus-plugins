...
# extracted from Fedora Security Advisory FEDORA-2021-afed2b904e
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-afed2b904e");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 32 : mingw-c-ares (2021-afed2b904e)");
...
FEDORA-2021-afed2b904e advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-afed2b904e");
...
pkgs = [
    {'reference':'mingw-c-ares-1.17.1-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
