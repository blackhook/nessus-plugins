...
# extracted from Fedora Security Advisory 2015-7687.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7687");

  script_name(english:"Fedora 21 : php-ZendFramework2-2.3.8-1.fc21 (2015-7687)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?863d9e66"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"php-ZendFramework2-2.3.8-1.fc21")) flag++;
