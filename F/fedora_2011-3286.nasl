...
# extracted from Fedora Security Advisory 2011-3286.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3286");

  script_name(english:"Fedora 15 : libvirt-0.8.8-3.fc15 (2011-3286)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/056209.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2673d05d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libvirt-0.8.8-3.fc15")) flag++;
