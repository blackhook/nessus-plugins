...
# extracted from F5 Networks BIG-IP Solution K23873366.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (K23873366)");
...
(CVE-2016-2177)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/#/article/K23873366"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["APM"]["affected"  ] = make_list("12.0.0-12.1.2","11.4.0-11.6.1","11.2.1","10.2.1-10.2.4","13.0.0","12.0.0-12.1.2","11.4.0-11.6.1","11.2.1","10.2.1-10.2.4");
