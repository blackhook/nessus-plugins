...
# extracted from Fedora Security Advisory FEDORA-2019-be98a08835.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-be98a08835");

  script_name(english:"Fedora 31 : 2:samba (2019-be98a08835)");
  ...
  script_set_attribute(
    ...
    value:
"Update to Samba 4.11.3 - Security fixes for CVE-2019-14861,
CVE-2019-14870
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-be98a08835"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"samba-4.11.3-0.fc31", epoch:"2")) flag++;
