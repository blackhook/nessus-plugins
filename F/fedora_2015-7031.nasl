...
# extracted from Fedora Security Advisory 2015-7031.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7031");

  script_name(english:"Fedora 21 : pdns-recursor-3.7.2-1.fc21 (2015-7031)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?41dad01b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"pdns-recursor-3.7.2-1.fc21")) flag++;
