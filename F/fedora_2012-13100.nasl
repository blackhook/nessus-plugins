...
# extracted from Fedora Security Advisory 2012-13100.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13100");

  script_name(english:"Fedora 18 : java-1.7.0-openjdk-1.7.0.6-2.3.1.fc18.2 (2012-13100)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086759.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?73d3dba5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"java-1.7.0-openjdk-1.7.0.6-2.3.1.fc18.2")) flag++;
