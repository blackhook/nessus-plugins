...
# extracted from Fedora Security Advisory 2013-16533.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16533");

  script_name(english:"Fedora 20 : glpi-0.83.9.1-4.fc20 (2013-16533)");
  ...
  script_set_attribute(
    ...
    value:
"Security improvement: restrict access to installation wizard from
local server only.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/116124.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f04191fa"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"glpi-0.83.9.1-4.fc20")) flag++;
