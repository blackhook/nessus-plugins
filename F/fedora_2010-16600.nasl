...
# extracted from Fedora Security Advisory 2010-16600.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : cvs-1.11.23-10.fc13 (2010-16600)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Oct 21 2010 Petr Pisar <ppisar at redhat.com> -
    1.11.23-10

    - Fix CVE-2010-3846 (bug #645386)

    - Tue Jan 12 2010 Jiri Moskovcak <jmoskovc at
      redhat.com> 1.11.23-9
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=642146"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/050090.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1174f400"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"cvs-1.11.23-10.fc13")) flag++;
