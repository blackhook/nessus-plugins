...
# extracted from Fedora Security Advisory FEDORA-2020-36b36afea6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : seamonkey (2020-36b36afea6)");
...
If you have Lightning and/or Chatzilla extensions previously disabled,
they are enabled after the update. Disable it again if needed (in
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-36b36afea6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"seamonkey-2.53.2-1.fc30")) flag++;
