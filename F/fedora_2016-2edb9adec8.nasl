...
# extracted from Fedora Security Advisory FEDORA-2016-2edb9adec8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : gnutls (2016-2edb9adec8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-2edb9adec8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"gnutls-3.4.15-1.fc23")) flag++;
