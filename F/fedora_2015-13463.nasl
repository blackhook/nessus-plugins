...
# extracted from Fedora Security Advisory 2015-13463.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-13463");

  script_name(english:"Fedora 23 : php-twig-1.20.0-1.fc23 (2015-13463)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-August/165134.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?012ea47c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-twig-1.20.0-1.fc23")) flag++;
