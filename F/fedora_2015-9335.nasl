...
# extracted from Fedora Security Advisory 2015-9335.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-9335");

  script_name(english:"Fedora 21 : libreswan-3.13-1.fc21 (2015-9335)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/159967.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?731700e6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"libreswan-3.13-1.fc21")) flag++;
