...
# extracted from Fedora Security Advisory 2005-262.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-262");

  script_name(english:"Fedora Core 2 : kernel-2.6.10-1.771_FC2 (2005-262)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000805.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b696972"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"kernel-2.6.10-1.771_FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-debuginfo-2.6.10-1.771_FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-doc-2.6.10-1.771_FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-smp-2.6.10-1.771_FC2")) flag++;
if (rpm_check(release:"FC2", reference:"kernel-sourcecode-2.6.10-1.771_FC2")) flag++;
