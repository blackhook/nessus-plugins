...
# extracted from Fedora Security Advisory FEDORA-2020-d5b2e71a17.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : community-mysql (2020-d5b2e71a17)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-d5b2e71a17"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"community-mysql-8.0.21-11.fc31")) flag++;
