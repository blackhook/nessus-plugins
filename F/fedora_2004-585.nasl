...
# extracted from Fedora Security Advisory 2004-585.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-585");

  script_name(english:"Fedora Core 3 : tetex-2.0.2-21.2 (2004-585)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-January/000551.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e8c19d15"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"tetex-2.0.2-21.2")) flag++;
if (rpm_check(release:"FC3", reference:"tetex-afm-2.0.2-21.2")) flag++;
if (rpm_check(release:"FC3", reference:"tetex-debuginfo-2.0.2-21.2")) flag++;
if (rpm_check(release:"FC3", reference:"tetex-doc-2.0.2-21.2")) flag++;
if (rpm_check(release:"FC3", reference:"tetex-dvips-2.0.2-21.2")) flag++;
if (rpm_check(release:"FC3", reference:"tetex-fonts-2.0.2-21.2")) flag++;
if (rpm_check(release:"FC3", reference:"tetex-latex-2.0.2-21.2")) flag++;
if (rpm_check(release:"FC3", reference:"tetex-xdvi-2.0.2-21.2")) flag++;
