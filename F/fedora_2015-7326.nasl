...
# extracted from Fedora Security Advisory 2015-7326.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : drupal7-views-3.11-1.fc21 (2015-7326)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/160541.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c418d45"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC21", reference:"drupal7-views-3.11-1.fc21")) flag++;
