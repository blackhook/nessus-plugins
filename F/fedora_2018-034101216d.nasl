...
# extracted from Fedora Security Advisory FEDORA-2018-034101216d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-034101216d");

  script_name(english:"Fedora 26 : rsync (2018-034101216d)");
  ...
  script_set_attribute(
    ...
    value:
"Removing dependencies on systemd-units
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-034101216d"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"rsync-3.1.3-2.fc26")) flag++;
