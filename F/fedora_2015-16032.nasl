...
# extracted from Fedora Security Advisory 2015-16032.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-16032");

  script_name(english:"Fedora 21 : php-ZendFramework2-2.4.8-1.fc21 (2015-16032)");
...
without introducing additional issues."
  ...
  # http://framework.zend.com/changelog/2.4.8
  script_set_attribute(
    attribute:"see_also",
    value:"https://framework.zend.com/changelog/2.4.8"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/167728.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5656eca6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"php-ZendFramework2-2.4.8-1.fc21")) flag++;
