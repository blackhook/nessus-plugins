...
# extracted from Fedora Security Advisory 2011-3958.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3958");

  script_name(english:"Fedora 15 : asterisk-1.8.3.2-1.fc15 (2011-3958)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/056945.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?331a26d1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"asterisk-1.8.3.2-1.fc15")) flag++;
