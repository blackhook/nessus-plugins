...
# extracted from Fedora Security Advisory FEDORA-2016-a8657278bf.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6896", "CVE-2016-7168");
  script_xref(name:"FEDORA", value:"2016-a8657278bf");

  script_name(english:"Fedora 24 : wordpress (2016-a8657278bf)");
...
"See upstream announcements :
  ...
  - [WordPress 4.6
    &ldquo;Pepper&rdquo;](https://wordpress.org/news/2016/08
    /pepper/)

  - [WordPress 4.6.1 Security and Maintenance
    Release](https://wordpress.org/news/2016/09/wordpress-4-
    6-1-security-and-maintenance-release/)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a8657278bf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"wordpress-4.6.1-1.fc24")) flag++;
