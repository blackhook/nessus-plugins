...
# extracted from Fedora Security Advisory 2012-11049.
#
...
if (description)
{
  ...
  script_bugtraq_id(54634);
  script_xref(name:"FEDORA", value:"2012-11049");

  script_name(english:"Fedora 16 : ecryptfs-utils-99-1.fc16 (2012-11049)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=841940"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-August/084607.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c779ead"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"ecryptfs-utils-99-1.fc16")) flag++;
