...
# extracted from Fedora Security Advisory FEDORA-2016-a820774fc2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : kernel (2016-a820774fc2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a820774fc2"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2016-a820774fc2");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC23", reference:"kernel-4.8.11-100.fc23")) flag++;
