...
# extracted from Fedora Security Advisory 2015-2783.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-2783");

  script_name(english:"Fedora 22 : drupal7-entity-1.6-1.fc22 (2015-2783)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/153990.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?71098e0f"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"drupal7-entity-1.6-1.fc22")) flag++;
