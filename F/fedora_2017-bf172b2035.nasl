...
# extracted from Fedora Security Advisory FEDORA-2017-bf172b2035.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : lynx (2017-bf172b2035)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-bf172b2035"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"lynx-2.8.9-0.20.dev16.fc26")) flag++;
