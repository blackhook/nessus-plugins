...
# extracted from Fedora Security Advisory 2012-1192.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-1192");

  script_name(english:"Fedora 16 : usbmuxd-1.0.7-3.fc16 (2012-1192)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/073433.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?16c74988"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"usbmuxd-1.0.7-3.fc16")) flag++;
