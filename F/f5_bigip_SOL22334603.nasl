...
# extracted from F5 Networks BIG-IP Solution K22334603.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (K22334603)");
...
different vulnerability than CVE-2016-2842. (CVE-2016-0799)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K22334603"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
