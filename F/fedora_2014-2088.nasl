...
# extracted from Fedora Security Advisory 2014-2088.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-2088");

  script_name(english:"Fedora 20 : icedtea-web-1.4.2-0.fc20 (2014-2088)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c1f68975"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"icedtea-web-1.4.2-0.fc20")) flag++;
