...
# extracted from Fedora Security Advisory FEDORA-2017-c5d7fd07c5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c5d7fd07c5");

  script_name(english:"Fedora 25 : LibRaw (2017-c5d7fd07c5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c5d7fd07c5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"LibRaw-0.17.2-2.fc25")) flag++;
