...
# extracted from Fedora Security Advisory 2013-16855.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-16855");

  script_name(english:"Fedora 20 : wordpress-3.6.1-1.fc20 (2013-16855)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/116828.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fac92ef3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"wordpress-3.6.1-1.fc20")) flag++;
