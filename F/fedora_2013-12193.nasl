...
# extracted from Fedora Security Advisory 2013-12193.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-12193");

  script_name(english:"Fedora 18 : lldpad-0.9.45-4.fc18 (2013-12193)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-July/111956.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?21ec8f12"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"lldpad-0.9.45-4.fc18")) flag++;
