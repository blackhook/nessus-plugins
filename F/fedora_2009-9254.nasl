...
# extracted from Fedora Security Advisory 2009-9254.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-9254");

  script_name(english:"Fedora 10 : ikiwiki-2.72-2.fc10 (2009-9254)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-September/028994.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cdc0c346"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"ikiwiki-2.72-2.fc10")) flag++;
