...
# extracted from Fedora Security Advisory 2013-18911.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-18911");

  script_name(english:"Fedora 18 : ReviewBoard-1.7.16-2.fc18 / python-djblets-0.7.21-1.fc18 (2013-18911)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119830.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?04576f5d"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119831.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d5191d31"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"ReviewBoard-1.7.16-2.fc18")) flag++;
if (rpm_check(release:"FC18", reference:"python-djblets-0.7.21-1.fc18")) flag++;
