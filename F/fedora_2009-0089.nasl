...
# extracted from Fedora Security Advisory 2009-0089.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-0089");

  script_name(english:"Fedora 10 : proftpd-1.3.1-8.fc10 (2009-0089)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=464127"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-January/018547.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a6707fed"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"proftpd-1.3.1-8.fc10")) flag++;
