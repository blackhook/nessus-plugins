...
# extracted from Fedora Security Advisory 2008-0644.
#
...
if (description)
{
  ...
  script_bugtraq_id(27307);
  script_xref(name:"FEDORA", value:"2008-0644");

  script_name(english:"Fedora 8 : python-paramiko-1.7.1-3.fc8 (2008-0644)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=428727"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=428729"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-January/006882.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b07d27db"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"python-paramiko-1.7.1-3.fc8")) flag++;
