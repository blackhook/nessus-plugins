...
# extracted from Fedora Security Advisory 2010-18736.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : openssl-1.0.0c-1.fc13 (2010-18736)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-December/052315.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d8fcfcdc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"openssl-1.0.0c-1.fc13")) flag++;
