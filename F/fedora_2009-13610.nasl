...
# extracted from Fedora Security Advisory 2009-13610.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-13610");

  script_name(english:"Fedora 12 : viewvc-1.1.3-1.fc12 (2009-13610)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-December/033230.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?08a9ce0f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"viewvc-1.1.3-1.fc12")) flag++;
