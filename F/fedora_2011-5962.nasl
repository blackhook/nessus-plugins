...
# extracted from Fedora Security Advisory 2011-5962.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5962");

  script_name(english:"Fedora 14 : mingw32-libtiff-3.9.5-1.fc14 (2011-5962)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059467.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ce57282d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"mingw32-libtiff-3.9.5-1.fc14")) flag++;
