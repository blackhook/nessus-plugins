...
# extracted from Fedora Security Advisory FEDORA-2017-018464cbf9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-018464cbf9");

  script_name(english:"Fedora 26 : optipng (2017-018464cbf9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-018464cbf9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"optipng-0.7.6-6.fc26")) flag++;
