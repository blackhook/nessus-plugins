...
# extracted from Fedora Security Advisory 2014-13017.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13017");

  script_name(english:"Fedora 19 : zarafa-7.1.11-1.fc19 (2014-13017)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/143267.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ff97208f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"zarafa-7.1.11-1.fc19")) flag++;
