...
# extracted from Fedora Security Advisory 2008-0485.
#
...
if (description)
{
  ...
  script_bugtraq_id(27238);
  script_xref(name:"FEDORA", value:"2008-0485");

  script_name(english:"Fedora 8 : drupal-5.6-1.fc8 (2008-0485)");
...
DRUPAL-SA-2008-005 DRUPAL-SA-2008-006 DRUPAL-SA-2008-007
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=427720"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-January/006754.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7dc0e103"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"drupal-5.6-1.fc8")) flag++;
