...
# extracted from Fedora Security Advisory 2015-8771.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8771");

  script_name(english:"Fedora 21 : ntfs-3g-2015.3.14-2.fc21 (2015-8771)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9ebe7caa"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"ntfs-3g-2015.3.14-2.fc21")) flag++;
