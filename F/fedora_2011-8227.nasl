...
# extracted from Fedora Security Advisory 2011-8227.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-8227");

  script_name(english:"Fedora 15 : libvoikko-3.2.1-1.fc15 (2011-8227)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/062164.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?01964be7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"libvoikko-3.2.1-1.fc15")) flag++;
