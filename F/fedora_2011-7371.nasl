...
# extracted from Fedora Security Advisory 2011-7371.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7371");

  script_name(english:"Fedora 15 : gimp-2.6.11-14.fc15 (2011-7371)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/060817.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf55ba0b"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"gimp-2.6.11-14.fc15")) flag++;
