...
# extracted from Fedora Security Advisory 2009-3740.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-3740");

  script_name(english:"Fedora 10 : argyllcms-1.0.3-5.fc10 (2009-3740)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022444.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c04cbf73"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"argyllcms-1.0.3-5.fc10")) flag++;
