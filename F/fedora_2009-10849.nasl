...
# extracted from Fedora Security Advisory 2009-10849.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10849");

  script_name(english:"Fedora 10 : systemtap-1.0-2.fc10 (2009-10849)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-October/030424.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?279fdfb6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"systemtap-1.0-2.fc10")) flag++;
