...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-July/000207.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f24be4db"
  );
...
flag = 0;
if (rpm_check(release:"FC1", reference:"kernel-2.4.22-1.2197.nptl")) flag++;
if (rpm_check(release:"FC1", cpu:"i386", reference:"kernel-BOOT-2.4.22-1.2197.nptl")) flag++;
if (rpm_check(release:"FC1", reference:"kernel-debuginfo-2.4.22-1.2197.nptl")) flag++;
if (rpm_check(release:"FC1", reference:"kernel-doc-2.4.22-1.2197.nptl")) flag++;
if (rpm_check(release:"FC1", reference:"kernel-smp-2.4.22-1.2197.nptl")) flag++;
if (rpm_check(release:"FC1", reference:"kernel-source-2.4.22-1.2197.nptl")) flag++;
