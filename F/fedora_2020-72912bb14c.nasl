...
# extracted from Fedora Security Advisory FEDORA-2020-72912bb14c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : nss (2020-72912bb14c)");
  ...
  script_set_attribute(
    ...
    value:
"Updates the nss package to upstream NSS 3.49.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-72912bb14c"
  );
  # https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.49_release_notes
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?591bbe33"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"nss-3.49.0-1.fc31")) flag++;
