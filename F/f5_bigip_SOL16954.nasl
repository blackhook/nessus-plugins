...
# extracted from F5 Networks BIG-IP Solution SOL16954.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Multiple PHP CDF vulnerabilities (SOL16954)");
...
triggering many file_printf calls."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16954"
  );
  script_set_attribute(
    attribute:"solution",
    value:
