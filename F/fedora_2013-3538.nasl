...
# extracted from Fedora Security Advisory 2013-3538.
#
...
if (description)
{
  ...
  script_bugtraq_id(58318);
  script_xref(name:"FEDORA", value:"2013-3538");

  script_name(english:"Fedora 17 : icu-4.8.1.1-5.fc17 (2013-3538)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=918167"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-March/100197.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?665a03e4"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"icu-4.8.1.1-5.fc17")) flag++;
