...
# extracted from Fedora Security Advisory 2015-11265.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-11265");

  script_name(english:"Fedora 22 : drupal7-migrate-2.8-1.fc22 (2015-11265)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/162189.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a824052e"
  );
  # https://security.drupal.org/node/155268.
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5fd355c7"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC22", reference:"drupal7-migrate-2.8-1.fc22")) flag++;
