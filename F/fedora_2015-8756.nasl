...
# extracted from Fedora Security Advisory 2015-8756.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8756");

  script_name(english:"Fedora 22 : fuse-2.9.4-1.fc22 (2015-8756)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c03fcf8b"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"fuse-2.9.4-1.fc22")) flag++;
