...
# extracted from Fedora Security Advisory 2014-11940.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11940");

  script_name(english:"Fedora 21 : krb5-1.12.2-9.fc21 (2014-11940)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/140132.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c8dd7e7b"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"krb5-1.12.2-9.fc21")) flag++;
