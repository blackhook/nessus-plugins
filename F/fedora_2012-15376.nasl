...
# extracted from Fedora Security Advisory 2012-15376.
#
...
if (description)
{
  ...
  script_bugtraq_id(55757);
  script_xref(name:"FEDORA", value:"2012-15376");

  script_name(english:"Fedora 18 : ruby-1.9.3.194-18.fc18 (2012-15376)");
  ...
  script_set_attribute(
    ...
    value:
"Some security flaws were found on ruby currently shipped on Fedora 18
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=862907"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/089554.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f47a6f89"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"ruby-1.9.3.194-18.fc18")) flag++;
