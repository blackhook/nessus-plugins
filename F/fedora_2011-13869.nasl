...
# extracted from Fedora Security Advisory 2011-13869.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : cyrus-imapd-2.3.18-1.fc14 (2011-13869)");
...
"  - cyrus-imapd updated to 2.3.18
    ...
    - fix CVE-2011-3208: a remotely exploitable buffer
      overflow in nntpd
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/068024.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c00fdf63"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"cyrus-imapd-2.3.18-1.fc14")) flag++;
