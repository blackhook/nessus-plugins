...
# extracted from Fedora Security Advisory FEDORA-2020-8dd4252dbe.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : 1:libuv (2020-8dd4252dbe)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8dd4252dbe"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"libuv-1.40.0-1.fc33", epoch:"1")) flag++;
