...
# extracted from Fedora Security Advisory FEDORA-2017-1fedb9890c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1fedb9890c");

  script_name(english:"Fedora 26 : community-mysql (2017-1fedb9890c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1fedb9890c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"community-mysql-5.7.18-2.fc26")) flag++;
