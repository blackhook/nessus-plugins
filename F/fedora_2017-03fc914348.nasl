...
# extracted from Fedora Security Advisory FEDORA-2017-03fc914348.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-9502");
  script_xref(name:"FEDORA", value:"2017-03fc914348");

  script_name(english:"Fedora 26 : mingw-curl (2017-03fc914348)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-03fc914348"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-curl-7.54.1-1.fc26")) flag++;
