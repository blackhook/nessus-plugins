...
# extracted from Fedora Security Advisory 2005-562.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-562");

  script_name(english:"Fedora Core 3 : net-snmp-5.2.1.2-FC3.1 (2005-562)");
  ...
  script_set_attribute(
    ...
    value:
"  - Wed Jul 13 2005 Radek Vokal <rvokal at redhat.com>

  - CVE-2005-2177 new upstream version fixing DoS (#162908)

    - CVE-2005-1740 net-snmp insecure temporary file usage
      (#158770)

    - session free fixed, agentx modules build fine
      (#157851)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-July/001066.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?46b438e4"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"net-snmp-5.2.1.2-FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"net-snmp-debuginfo-5.2.1.2-FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"net-snmp-devel-5.2.1.2-FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"net-snmp-libs-5.2.1.2-FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"net-snmp-perl-5.2.1.2-FC3.1")) flag++;
if (rpm_check(release:"FC3", reference:"net-snmp-utils-5.2.1.2-FC3.1")) flag++;
