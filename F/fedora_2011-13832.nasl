...
# extracted from Fedora Security Advisory 2011-13832.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-13832");

  script_name(english:"Fedora 16 : cyrus-imapd-2.4.12-1.fc16 (2011-13832)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/068081.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bbdc33ca"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"cyrus-imapd-2.4.12-1.fc16")) flag++;
