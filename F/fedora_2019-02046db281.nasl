...
# extracted from Fedora Security Advisory FEDORA-2019-02046db281.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : mediawiki (2019-02046db281)");
  ...
  script_set_attribute(
    ...
    value:
"https://lists.wikimedia.org/pipermail/mediawiki-announce/2019-June/000
230.html
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-02046db281"
  );
  # https://lists.wikimedia.org/pipermail/mediawiki-announce/2019-June/000230.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fa98ca56"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"mediawiki-1.32.2-1.fc30")) flag++;
