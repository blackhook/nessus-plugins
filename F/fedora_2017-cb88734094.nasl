...
# extracted from Fedora Security Advisory FEDORA-2017-cb88734094.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-cb88734094");

  script_name(english:"Fedora 25 : ansible (2017-cb88734094)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-cb88734094"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ansible-2.2.1.0-1.fc25")) flag++;
