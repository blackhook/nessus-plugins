...
# extracted from Fedora Security Advisory 2012-5463.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-5463");

  script_name(english:"Fedora 17 : libtiff-3.9.5-3.fc17 (2012-5463)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-April/077463.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3881b554"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"libtiff-3.9.5-3.fc17")) flag++;
