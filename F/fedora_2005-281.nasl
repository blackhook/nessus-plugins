...
# extracted from Fedora Security Advisory 2005-281.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-281");

  script_name(english:"Fedora Core 3 : sharutils-4.2.1-22.1.FC3 (2005-281)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-April/000833.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea0fffff"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"sharutils-4.2.1-22.1.FC3")) flag++;
if (rpm_check(release:"FC3", reference:"sharutils-debuginfo-4.2.1-22.1.FC3")) flag++;
