...
# extracted from Fedora Security Advisory 2014-6120.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6120");

  script_name(english:"Fedora 20 : mariadb-galera-5.5.37-2.fc20 (2014-6120)");
...
issues described at
https://kb.askmonty.org/en/mariadb-5537-changelog/. Initial build
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133363.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad8f7d1f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"mariadb-galera-5.5.37-2.fc20")) flag++;
