...
# extracted from Fedora Security Advisory 2006-511.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-511");

  script_name(english:"Fedora Core 4 : busybox-1.00-5.fc4 (2006-511)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000035.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?374d92f2"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"busybox-1.00-5.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"busybox-anaconda-1.00-5.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"busybox-debuginfo-1.00-5.fc4")) flag++;
