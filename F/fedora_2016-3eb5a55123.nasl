...
# extracted from Fedora Security Advisory FEDORA-2016-3eb5a55123.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-3eb5a55123");

  script_name(english:"Fedora 24 : python-django (2016-3eb5a55123)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-3eb5a55123"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"python-django-1.9.11-1.fc24")) flag++;
