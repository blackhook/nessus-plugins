...
# extracted from Fedora Security Advisory 2015-11483.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-11483");

  script_name(english:"Fedora 22 : bind-9.10.2-3.P2.fc22 (2015-11483)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1237258"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/162040.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?709d5829"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"bind-9.10.2-3.P2.fc22")) flag++;
