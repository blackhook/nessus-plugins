...
# extracted from Fedora Security Advisory 2010-5942.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-5942");

  script_name(english:"Fedora 13 : httpd-2.2.15-1.fc13 (2010-5942)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-April/039957.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5fb36b2c"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"httpd-2.2.15-1.fc13")) flag++;
