...
# extracted from Fedora Security Advisory FEDORA-2019-c701e6605a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : 1:java-1.8.0-openjdk (2019-c701e6605a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-c701e6605a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"java-1.8.0-openjdk-1.8.0.212.b04-0.fc28", epoch:"1")) flag++;
