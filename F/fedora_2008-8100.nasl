...
# extracted from Fedora Security Advisory 2008-8100.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : fedora-package-config-apt-8-2.transitional / etc (2008-8100)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-September/014375.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?478f97c3"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-September/014377.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e80bfab3"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC8", reference:"fedora-package-config-apt-8-2.transitional")) flag++;
if (rpm_check(release:"FC8", reference:"fedora-package-config-smart-8-12.0.2.transitional")) flag++;
