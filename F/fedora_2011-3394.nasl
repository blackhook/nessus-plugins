...
# extracted from Fedora Security Advisory 2011-3394.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3394");

  script_name(english:"Fedora 14 : postfix-2.7.3-1.fc14 (2011-3394)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.postfix.org/download.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=674814"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/056559.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?63472de1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"postfix-2.7.3-1.fc14")) flag++;
