...
# extracted from Fedora Security Advisory 2015-6349.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6349");

  script_name(english:"Fedora 20 : spatialite-tools-4.1.1-12.fc20 / sqlite-3.8.9-1.fc20 (2015-6349)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/156056.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bea6c2b3"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/156057.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4787db01"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"spatialite-tools-4.1.1-12.fc20")) flag++;
if (rpm_check(release:"FC20", reference:"sqlite-3.8.9-1.fc20")) flag++;
