...
# extracted from Fedora Security Advisory 2015-10450.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-10450");

  script_name(english:"Fedora 21 : cups-x2go-3.0.1.3-1.fc21 (2015-10450)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-July/161604.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc560eb4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"cups-x2go-3.0.1.3-1.fc21")) flag++;
