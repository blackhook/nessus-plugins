...
# extracted from Fedora Security Advisory 2008-3098.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : nagios-2.11-3.fc8 (2008-3098)");
  ...
  script_set_attribute(
    ...
    value:
"  - Tue Mar 18 2008 Tom 'spot' Callaway <tcallawa at
    redhat.com> 2.11-3
    ...
    - Mon Mar 17 2008 Mike McGrath <mmcgrath at redhat.com>
      2.11-2
    ...
    - Tue Feb 12 2008 Mike McGrath <mmcgrath at redhat.com>
      2.10-6
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=362891"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-April/009307.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b210610"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"nagios-2.11-3.fc8")) flag++;
