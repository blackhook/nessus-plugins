...
# extracted from Fedora Security Advisory FEDORA-2016-af3b0af887.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-6331");
  script_xref(name:"FEDORA", value:"2016-af3b0af887");

  script_name(english:"Fedora 24 : mediawiki (2016-af3b0af887)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-af3b0af887"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.mediawiki.org/wiki/Release_notes/1.26#MediaWiki_1.26.4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mediawiki-1.26.4-1.fc24")) flag++;
