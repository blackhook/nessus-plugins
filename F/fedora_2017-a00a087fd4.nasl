...
# extracted from Fedora Security Advisory FEDORA-2017-a00a087fd4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a00a087fd4");

  script_name(english:"Fedora 25 : 1:tomcat (2017-a00a087fd4)");
  ...
  script_set_attribute(
    ...
    value:
"This update includes a rebase from 8.0.44 up to 8.0.46 which resolves
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a00a087fd4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"tomcat-8.0.46-1.fc25", epoch:"1")) flag++;
