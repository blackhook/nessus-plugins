...
# extracted from Fedora Security Advisory FEDORA-2019-333a7aa511.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : radvd (2019-333a7aa511)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-333a7aa511"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"radvd-2.17-12.fc28")) flag++;
