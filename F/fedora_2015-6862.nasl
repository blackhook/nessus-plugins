...
# extracted from Fedora Security Advisory 2015-6862.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6862");

  script_name(english:"Fedora 20 : springframework-3.1.4-3.fc20 (2015-6862)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1110110"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/157348.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4bcdeb1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"springframework-3.1.4-3.fc20")) flag++;
