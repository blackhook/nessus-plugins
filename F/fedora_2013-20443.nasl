...
# extracted from Fedora Security Advisory 2013-20443.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-20443");

  script_name(english:"Fedora 19 : poppler-0.22.1-5.fc19 (2013-20443)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb7289ad"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"poppler-0.22.1-5.fc19")) flag++;
