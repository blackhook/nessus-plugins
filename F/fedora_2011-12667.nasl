...
# extracted from Fedora Security Advisory 2011-12667.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-12667");

  script_name(english:"Fedora 16 : httpd-2.2.21-1.fc16 (2011-12667)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/066686.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3771791b"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"httpd-2.2.21-1.fc16")) flag++;
