...
# extracted from Fedora Security Advisory FEDORA-2021-9d65b22041
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-9d65b22041");

  script_name(english:"Fedora 33 : mingw-SDL2 (2021-9d65b22041)");
...
FEDORA-2021-9d65b22041 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-9d65b22041");
...
pkgs = [
    {'reference':'mingw-SDL2-2.0.12-3.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
