...
# extracted from Fedora Security Advisory FEDORA-2017-9d06448c3e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-9d06448c3e");

  script_name(english:"Fedora 24 : knot-resolver (2017-9d06448c3e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9d06448c3e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"knot-resolver-1.2.4-1.fc24")) flag++;
