...
# extracted from Fedora Security Advisory FEDORA-2017-d2e7217e2a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d2e7217e2a");

  script_name(english:"Fedora 24 : irssi (2017-d2e7217e2a)");
  ...
  script_set_attribute(
    ...
    value:
"This is an security update fixing CVE-2017-5193, CVE-2017-5194,
CVE-2017-5195, CVE-2017-5196, CVE-2017-5356.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d2e7217e2a"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"irssi-0.8.21-1.fc24")) flag++;
