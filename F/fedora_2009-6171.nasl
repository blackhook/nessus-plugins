...
# extracted from Fedora Security Advisory 2009-6171.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6171");

  script_name(english:"Fedora 9 : drupal-views-6.x.2.6-1.fc9 (2009-6171)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/024763.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?350b06f6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"drupal-views-6.x.2.6-1.fc9")) flag++;
