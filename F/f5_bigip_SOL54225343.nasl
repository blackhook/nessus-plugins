...
# extracted from F5 Networks BIG-IP Solution K54225343.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : libxml2 vulnerabilities (K54225343)");
  ...
  script_set_attribute(
    ...
    value:
"CVE-2016-3627 The xmlStringGetNodeList function in tree.c in libxml2
2.9.3 and earlier, when used in recovery mode, allows
context-dependent attackers to cause a denial of service (infinite
recursion, stack consumption, and application crash) via a crafted XML
document

CVE-2016-3705 The (1) xmlParserEntityCheck and (2)
xmlParseAttValueComplex functions in parser.c in libxml2 2.9.3 do not
properly keep track of the recursion depth, which allows
...
containing a large number of nested entity references."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K54225343"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
