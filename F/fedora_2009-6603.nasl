...
# extracted from Fedora Security Advisory 2009-6603.
#
...
if (description)
{
  ...
  script_bugtraq_id(28770, 33827, 35233);
  script_xref(name:"FEDORA", value:"2009-6603");

  script_name(english:"Fedora 9 : libpng-1.2.37-1.fc9 (2009-6603)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025223.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b15baf0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"libpng-1.2.37-1.fc9")) flag++;
