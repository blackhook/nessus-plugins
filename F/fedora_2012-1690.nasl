...
# extracted from Fedora Security Advisory 2012-1690.
#
...
if (description)
{
  ...
  script_bugtraq_id(51194, 51467, 52009, 52011, 52012, 52013, 52017, 52018);
  script_xref(name:"FEDORA", value:"2012-1690");

  script_name(english:"Fedora 16 : java-1.7.0-openjdk-1.7.0.3-2.1.fc16 (2012-1690)");
...
"  - Updated to OpenJDK7u3/IcedTea7 2.1
    ...
    - S7118283, CVE-2012-0501: Off-by-one bug in ZIP reading
      code - S7110704, CVE-2012-0506: CORBA fix
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/073349.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5faa5b50"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"java-1.7.0-openjdk-1.7.0.3-2.1.fc16")) flag++;
