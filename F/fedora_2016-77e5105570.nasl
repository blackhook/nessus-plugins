...
# extracted from Fedora Security Advisory FEDORA-2016-77e5105570.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-77e5105570");

  script_name(english:"Fedora 23 : php-ZendFramework (2016-77e5105570)");
  ...
  script_set_attribute(
    ...
    value:
"Probably the last update for Zend Framework 1 as it is being EOLd on
September 28, 2016.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-77e5105570"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-ZendFramework-1.12.20-1.fc23")) flag++;
