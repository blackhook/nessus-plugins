...
# extracted from Fedora Security Advisory FEDORA-2016-0eb1d4ad19.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0eb1d4ad19");

  script_name(english:"Fedora 24 : mingw-libpng (2016-0eb1d4ad19)");
  ...
  script_set_attribute(
    ...
    value:
"MinGW cross compiled libpng 1.6.27 release, fixing a potential
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0eb1d4ad19"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mingw-libpng-1.6.27-1.fc24")) flag++;
