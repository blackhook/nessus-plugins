...
# extracted from Fedora Security Advisory 2013-10853.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-10853");

  script_name(english:"Fedora 19 : clamav-0.97.8-2.fc19 (2013-10853)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-June/109514.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7d709f81"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"clamav-0.97.8-2.fc19")) flag++;
