...
# extracted from Fedora Security Advisory 2015-6550.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6550");

  script_name(english:"Fedora 21 : mksh-50f-1.fc21 (2015-6550)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/156730.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c6e00a76"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mksh-50f-1.fc21")) flag++;
