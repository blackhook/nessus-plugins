...
# extracted from Fedora Security Advisory FEDORA-2017-97b730736f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 27 : 1:ceph (2017-97b730736f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-97b730736f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"ceph-12.2.2-1.fc27", epoch:"1")) flag++;
