...
# extracted from Fedora Security Advisory FEDORA-2016-9c63b652a8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-9c63b652a8");

  script_name(english:"Fedora 25 : gstreamer-plugins-bad-free (2016-9c63b652a8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-9c63b652a8"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected gstreamer-plugins-bad-free package."
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"gstreamer-plugins-bad-free-0.10.23-35.fc25")) flag++;
