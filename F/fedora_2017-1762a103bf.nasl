...
# extracted from Fedora Security Advisory FEDORA-2017-1762a103bf.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : poppler (2017-1762a103bf)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1762a103bf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"poppler-0.52.0-10.fc26")) flag++;
