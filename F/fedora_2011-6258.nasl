...
# extracted from Fedora Security Advisory 2011-6258.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-6258");

  script_name(english:"Fedora 13 : seamonkey-2.0.14-1.fc13 (2011-6258)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/059975.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?40220e7d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"seamonkey-2.0.14-1.fc13")) flag++;
