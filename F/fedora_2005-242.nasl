...
# extracted from Fedora Security Advisory 2005-242.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-242");

  script_name(english:"Fedora Core 3 : mailman-2.1.5-32.fc3 (2005-242)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000789.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2e4f7109"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"mailman-2.1.5-32.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"mailman-debuginfo-2.1.5-32.fc3")) flag++;
