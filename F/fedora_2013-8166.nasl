...
# extracted from Fedora Security Advisory 2013-8166.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-8166");

  script_name(english:"Fedora 19 : python-virtualenv-1.9.1-1.fc19 (2013-8166)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://pypi.org/project/virtualenv/#id2"
  );
  # http://pypi.python.org/pypi/virtualenv/1.7.1.2
  script_set_attribute(
    attribute:"see_also",
    value:"https://pypi.org/project/virtualenv/1.7.1.2/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=923974"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/106311.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2d593cb2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python-virtualenv-1.9.1-1.fc19")) flag++;
