...
# extracted from Fedora Security Advisory FEDORA-2021-2ab6f060d9
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-2ab6f060d9");

  script_name(english:"Fedora 33 : python3.8 (2021-2ab6f060d9)");
...
FEDORA-2021-2ab6f060d9 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-2ab6f060d9");
...
pkgs = [
    {'reference':'python3.8-3.8.9-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
