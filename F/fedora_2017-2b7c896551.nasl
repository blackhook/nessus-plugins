...
# extracted from Fedora Security Advisory FEDORA-2017-2b7c896551.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : rt (2017-2b7c896551)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2b7c896551"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"rt-4.2.13-2.fc24")) flag++;
