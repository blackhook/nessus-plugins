...
# extracted from Fedora Security Advisory FEDORA-2019-a1636592a3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : glpi (2019-a1636592a3)");
...
Non exhaustive list of changes :
  ...
  - fix some transfer errors related to entities among
    others,

  - and more!

See
[changelog](https://github.com/glpi-project/glpi/milestone/37?closed=1
) for details.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a1636592a3"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/glpi-project/glpi/milestone/37?closed=1"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"glpi-9.4.4-1.fc30")) flag++;
