...
# extracted from Fedora Security Advisory FEDORA-2016-8354baae0f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-8354baae0f");

  script_name(english:"Fedora 23 : curl (2016-8354baae0f)");
  ...
  script_set_attribute(
    ...
    value:
"  - fix re-using connections with wrong client cert
    (CVE-2016-5420)
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-8354baae0f"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"curl-7.43.0-8.fc23")) flag++;
