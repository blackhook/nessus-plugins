...
# extracted from Fedora Security Advisory FEDORA-2019-fc95e6255c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : chromium (2019-fc95e6255c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-fc95e6255c"
  );
  # https://chromereleases.googleblog.com/2019/10/stable-channel-update-for-desktop.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b28b0fb8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"chromium-77.0.3865.120-1.fc29")) flag++;
