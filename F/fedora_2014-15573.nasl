...
# extracted from Fedora Security Advisory 2014-15573.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15573");

  script_name(english:"Fedora 21 : pcre-8.35-8.fc21 (2014-15573)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f100adac"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"pcre-8.35-8.fc21")) flag++;
