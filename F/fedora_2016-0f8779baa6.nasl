...
# extracted from Fedora Security Advisory FEDORA-2016-0f8779baa6.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : eog (2016-0f8779baa6)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0f8779baa6"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"eog-3.18.3-1.fc23")) flag++;
