...
# extracted from Fedora Security Advisory 2006-877.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-877");

  script_name(english:"Fedora Core 5 : libtiff-3.7.4-8 (2006-877)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-August/000471.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6e88055"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC5", reference:"libtiff-3.7.4-8")) flag++;
if (rpm_check(release:"FC5", reference:"libtiff-debuginfo-3.7.4-8")) flag++;
if (rpm_check(release:"FC5", reference:"libtiff-devel-3.7.4-8")) flag++;
