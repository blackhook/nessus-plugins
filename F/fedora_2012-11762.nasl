...
# extracted from Fedora Security Advisory 2012-11762.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-11762");

  script_name(english:"Fedora 17 : ImageMagick-6.7.5.6-4.fc17 (2012-11762)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-August/085641.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c52d5c21"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"ImageMagick-6.7.5.6-4.fc17")) flag++;
