...
# extracted from Fedora Security Advisory 2010-15857.
#
...
if (description)
{
  ...
  script_bugtraq_id(43594);
  script_xref(name:"FEDORA", value:"2010-15857");

  script_name(english:"Fedora 14 : poppler-0.14.4-1.fc14 (2010-15857)");
  ...
  script_set_attribute(
    ...
    value:
"  - Bug #595245 - CVE-2010-3702 xpdf: uninitialized
    Gfx::parser pointer dereference

  - Bug #638960 - CVE-2010-3704 xpdf: array indexing error
    in FoFiType1::parse()

  - Bug #639356 - CVE-2010-3703 poppler: use of initialized
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/049392.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dd7c889a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"poppler-0.14.4-1.fc14")) flag++;
