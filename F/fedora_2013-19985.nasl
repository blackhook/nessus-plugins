...
# extracted from Fedora Security Advisory 2013-19985.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-19985");

  script_name(english:"Fedora 19 : mod_nss-1.0.8-24.fc19 (2013-19985)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/120145.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e6dbd8b8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"mod_nss-1.0.8-24.fc19")) flag++;
