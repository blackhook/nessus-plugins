...
# extracted from Fedora Security Advisory 2012-12031.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-12031");

  script_name(english:"Fedora 17 : phpMyAdmin-3.5.2.2-1.fc17 (2012-12031)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-August/085706.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e8830567"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"phpMyAdmin-3.5.2.2-1.fc17")) flag++;
