...
# extracted from Fedora Security Advisory FEDORA-2019-bd0d5f0ea7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : libgcrypt (2019-bd0d5f0ea7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-bd0d5f0ea7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libgcrypt-1.8.5-1.fc29")) flag++;
