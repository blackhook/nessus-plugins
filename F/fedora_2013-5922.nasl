...
# extracted from Fedora Security Advisory 2013-5922.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 17 : java-1.7.0-openjdk-1.7.0.19-2.3.9.1.fc17 (2013-5922)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-April/102111.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2f718f2a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"java-1.7.0-openjdk-1.7.0.19-2.3.9.1.fc17")) flag++;
