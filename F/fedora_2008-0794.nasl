...
# extracted from Fedora Security Advisory 2008-0794.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : libXfont-1.3.1-2.fc8 (2008-0794)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=429132"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-January/007027.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?da731589"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC8", reference:"libXfont-1.3.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"libXfont-debuginfo-1.3.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"libXfont-devel-1.3.1-2.fc8")) flag++;
