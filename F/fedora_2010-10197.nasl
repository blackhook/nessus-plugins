...
# extracted from Fedora Security Advisory 2010-10197.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : drupal-views-6.x.2.11-1.fc11 (2010-10197)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/043188.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9e24a3bc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"drupal-views-6.x.2.11-1.fc11")) flag++;
