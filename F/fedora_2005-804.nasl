...
# extracted from Fedora Security Advisory 2005-804.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-804");

  script_name(english:"Fedora Core 3 : epiphany-1.4.9-0 (2005-804)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Aug 18 2005 Marco Pesenti Gritti <mpg at redhat.com>
    1.4.9-0
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001297.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ce80ac22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"epiphany-1.4.9-0")) flag++;
if (rpm_check(release:"FC3", reference:"epiphany-debuginfo-1.4.9-0")) flag++;
if (rpm_check(release:"FC3", reference:"epiphany-devel-1.4.9-0")) flag++;
