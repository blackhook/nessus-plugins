...
# extracted from Fedora Security Advisory 2007-0004.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2007-0004");

  script_name(english:"Fedora 7 : libpng10-1.0.26-1.fc7.1 (2007-0004)");
  ...
  script_set_attribute(
    ...
    value:
"The png_handle_tRNS function in pngrutil.c in libpng before 1.0.25 and
1.2.x before 1.2.17 allows remote attackers to cause a denial of
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=240398"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-May/001776.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b7a9a3a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC7", reference:"libpng10-1.0.26-1.fc7.1")) flag++;
if (rpm_check(release:"FC7", reference:"libpng10-debuginfo-1.0.26-1.fc7.1")) flag++;
if (rpm_check(release:"FC7", reference:"libpng10-devel-1.0.26-1.fc7.1")) flag++;
