...
# extracted from Fedora Security Advisory 2015-11414.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 21 : openssl-1.0.1k-11.fc21 (2015-11414)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ffbd8c1a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"openssl-1.0.1k-11.fc21")) flag++;
