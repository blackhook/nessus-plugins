...
# extracted from Fedora Security Advisory 2014-9412.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-9412");

  script_name(english:"Fedora 20 : ppp-2.4.5-34.fc20 (2014-9412)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8a73bd0"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"ppp-2.4.5-34.fc20")) flag++;
