...
# extracted from Fedora Security Advisory FEDORA-2018-6d62140b89.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : php-pear-CAS (2018-6d62140b89)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6d62140b89"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-pear-CAS-1.3.6-1.fc29")) flag++;
