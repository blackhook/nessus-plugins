...
# extracted from Fedora Security Advisory 2015-0983.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-0983");

  script_name(english:"Fedora 20 : java-1.7.0-openjdk-1.7.0.75-2.5.4.2.fc20 (2015-0983)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-January/148482.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a7a9919f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"java-1.7.0-openjdk-1.7.0.75-2.5.4.2.fc20")) flag++;
