...
# extracted from Fedora Security Advisory 2012-13400.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13400");

  script_name(english:"Fedora 16 : moin-1.9.4-3.fc16 (2012-13400)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=854730"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/086228.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?128cc5c5"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"moin-1.9.4-3.fc16")) flag++;
