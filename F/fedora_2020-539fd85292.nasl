...
# extracted from Fedora Security Advisory FEDORA-2020-539fd85292.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : botan2 (2020-539fd85292)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 2.14.0 including security fix (Side channel during CBC
padding).
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-539fd85292"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"botan2-2.14.0-1.fc32")) flag++;
