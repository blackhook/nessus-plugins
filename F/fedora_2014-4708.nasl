...
# extracted from Fedora Security Advisory 2014-4708.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-4708");

  script_name(english:"Fedora 20 : cups-filters-1.0.41-6.fc20 (2014-4708)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9581abb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"cups-filters-1.0.41-6.fc20")) flag++;
