...
# extracted from Fedora Security Advisory FEDORA-2016-266a26df2b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-266a26df2b");

  script_name(english:"Fedora 24 : gnutls (2016-266a26df2b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-266a26df2b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"gnutls-3.4.13-1.fc24")) flag++;
