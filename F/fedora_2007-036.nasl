...
# extracted from Fedora Security Advisory 2007-036.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 5 : xorg-x11-server-1.0.1-9.fc5.6 (2007-036)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-January/001225.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7499b334"
  );
...
flag = 0;
if (rpm_check(release:"FC5", reference:"xorg-x11-server-Xdmx-1.0.1-9.fc5.6")) flag++;
if (rpm_check(release:"FC5", reference:"xorg-x11-server-Xnest-1.0.1-9.fc5.6")) flag++;
if (rpm_check(release:"FC5", reference:"xorg-x11-server-Xorg-1.0.1-9.fc5.6")) flag++;
if (rpm_check(release:"FC5", reference:"xorg-x11-server-Xvfb-1.0.1-9.fc5.6")) flag++;
if (rpm_check(release:"FC5", reference:"xorg-x11-server-debuginfo-1.0.1-9.fc5.6")) flag++;
if (rpm_check(release:"FC5", reference:"xorg-x11-server-sdk-1.0.1-9.fc5.6")) flag++;
