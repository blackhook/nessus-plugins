...
# extracted from Fedora Security Advisory 2012-20179.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-20179");

  script_name(english:"Fedora 18 : python-django-1.4.3-1.fc18 (2012-20179)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/096074.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d22d2bb0"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC18", reference:"python-django-1.4.3-1.fc18")) flag++;
