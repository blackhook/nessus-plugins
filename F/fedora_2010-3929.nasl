...
# extracted from Fedora Security Advisory 2010-3929.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-3929");

  script_name(english:"Fedora 13 : nss-3.12.6-1.2.fc13 (2010-3929)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037028.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dff5468d"
  );
...
flag = 0;
if (rpm_check(release:"FC13", reference:"nss-3.12.6-1.2.fc13")) flag++;
