...
# extracted from Fedora Security Advisory FEDORA-2017-37f68e3534.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : webkitgtk4 (2017-37f68e3534)");
...
"This update addresses the following vulnerabilities :
  ...
  -
    [CVE-2017-2538](https://cve.mitre.org/cgi-bin/cvename.cg
    i?name=CVE-2017-2538)
...
Additional fixes :
  ...
  - Improve theme rendering performance when using GTK+ >=
    3.20.

  - Fix positioning of popup menus in Wayland.

  - Fix JavaScriptCore crashes on big-endian architectures

  - Fix a web process crash when page finishes loading in
    several websites.

  - Fix the menu of select elements not showing in some
    cases under Wayland.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-37f68e3534"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"webkitgtk4-2.16.5-1.fc24")) flag++;
