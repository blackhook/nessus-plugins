...
# extracted from Fedora Security Advisory 2013-4507.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 18 : libxslt-1.1.28-1.fc18 (2013-4507)");
  ...
  script_set_attribute(
    ...
    value:
"Update to libxslt-1.1.28 to fix CVE-2012-6139 where the library could
crash on invalid key references in stylesheets
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=927580"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-April/102065.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed5522f1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"libxslt-1.1.28-1.fc18")) flag++;
