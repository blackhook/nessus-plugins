...
# extracted from Fedora Security Advisory FEDORA-2020-c1745db1aa.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : cacti / cacti-spine (2020-c1745db1aa)");
...
Release notes: https://www.cacti.net/release_notes.php?version=1.2.11
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-c1745db1aa"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.cacti.net/release_notes.php?version=1.2.11"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"cacti-1.2.11-1.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"cacti-spine-1.2.11-1.fc31")) flag++;
