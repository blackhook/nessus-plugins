...
# extracted from Fedora Security Advisory 2008-2981.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : comix-3.6.4-6.fc8 (2008-2981)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=430635"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-April/009196.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4723d8fe"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected comix package.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_cwe_id(20);

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:comix");
...
flag = 0;
if (rpm_check(release:"FC8", reference:"comix-3.6.4-6.fc8")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "comix");
}
