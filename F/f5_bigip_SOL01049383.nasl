...
with access to logs will be able to view that data."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K01049383"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["AFM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["AFM"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["AM"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["APM"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["ASM"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["AVR"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["GTM"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["LC"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["LTM"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["PEM"]["unaffected"] = make_list("14.0.0","13.1.1.5");

# WAM
vmatrix["WAM"] = make_array();
vmatrix["WAM"]["affected"  ] = make_list("13.1.0-13.1.1");
vmatrix["WAM"]["unaffected"] = make_list("14.0.0","13.1.1.5");
