...
# extracted from Fedora Security Advisory 2013-23466.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-6400");
  script_bugtraq_id(64195);
  script_xref(name:"FEDORA", value:"2013-23466");

  script_name(english:"Fedora 18 : xen-4.2.3-12.fc18 (2013-23466)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?15bf7205"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"xen-4.2.3-12.fc18")) flag++;
