...
# extracted from Fedora Security Advisory 2014-10142.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-10142");

  script_name(english:"Fedora 21 : procmail-3.22-36.fc21 (2014-10142)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/138201.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ef17638"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"procmail-3.22-36.fc21")) flag++;
