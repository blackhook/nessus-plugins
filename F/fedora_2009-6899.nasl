...
# extracted from Fedora Security Advisory 2009-6899.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6899");

  script_name(english:"Fedora 11 : rt3-3.8.2-8.fc11 (2009-6899)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/025548.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d91d5dae"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"rt3-3.8.2-8.fc11")) flag++;
