...
# extracted from Fedora Security Advisory FEDORA-2019-1f05925d82.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : libgcrypt (2019-1f05925d82)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-1f05925d82"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"libgcrypt-1.8.5-1.fc30")) flag++;
