...
# extracted from Fedora Security Advisory 2015-6369.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6369");

  script_name(english:"Fedora 21 : java-1.8.0-openjdk-1.8.0.45-31.b13.fc21 (2015-6369)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155843.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4f6bc57b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"java-1.8.0-openjdk-1.8.0.45-31.b13.fc21")) flag++;
