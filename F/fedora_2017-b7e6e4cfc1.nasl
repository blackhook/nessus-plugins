...
# extracted from Fedora Security Advisory FEDORA-2017-b7e6e4cfc1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b7e6e4cfc1");

  script_name(english:"Fedora 25 : freexl (2017-b7e6e4cfc1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b7e6e4cfc1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"freexl-1.0.4-1.fc25")) flag++;
