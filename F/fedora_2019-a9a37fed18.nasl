...
# extracted from Fedora Security Advisory FEDORA-2019-a9a37fed18.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : php-twig2 (2019-a9a37fed18)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-a9a37fed18"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"php-twig2-2.7.2-1.fc29")) flag++;
