...
# extracted from Fedora Security Advisory FEDORA-2021-fba11d37ee
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-fba11d37ee");

  script_name(english:"Fedora 33 : 2:dpdk / openvswitch (2021-fba11d37ee)");
...
FEDORA-2021-fba11d37ee advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-fba11d37ee");
...
pkgs = [
    {'reference':'dpdk-20.11-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
    {'reference':'openvswitch-2.15.0-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, '2:dpdk / openvswitch');
}
