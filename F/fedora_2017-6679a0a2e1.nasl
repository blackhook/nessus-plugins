...
# extracted from Fedora Security Advisory FEDORA-2017-6679a0a2e1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : freexl (2017-6679a0a2e1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-6679a0a2e1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"freexl-1.0.4-1.fc26")) flag++;
