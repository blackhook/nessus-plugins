...
# extracted from Fedora Security Advisory FEDORA-2017-e68e87955b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : LibRaw (2017-e68e87955b)");
  ...
  script_set_attribute(
    ...
    value:
"https://www.libraw.org/news/libraw-0-18-6
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e68e87955b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"LibRaw-0.18.6-1.fc26")) flag++;
