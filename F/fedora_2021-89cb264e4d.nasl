...
# extracted from Fedora Security Advisory FEDORA-2021-89cb264e4d
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-89cb264e4d");

  script_name(english:"Fedora 32 : exim (2021-89cb264e4d)");
...
FEDORA-2021-89cb264e4d advisory.

  - Fixed cname handling in TLS certificate verification (FEDORA-2021-89cb264e4d)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-89cb264e4d");
...
pkgs = [
    {'reference':'exim-4.94-2.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
