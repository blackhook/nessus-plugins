...
# extracted from Fedora Security Advisory 2014-4892.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-4892");

  script_name(english:"Fedora 20 : cacti-0.8.8b-5.fc20 (2014-4892)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6d455ef4"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"cacti-0.8.8b-5.fc20")) flag++;
