...
# extracted from Fedora Security Advisory 2011-7258.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7258");

  script_name(english:"Fedora 14 : dovecot-2.0.13-1.fc14 (2011-7258)");
...
"  - dovecot updated to 2.0.13
    ...
    - mdbox purge: Fixed wrong warning about corrupted
      extrefs.

    - script-login binary wasn't actually dropping
      privileges to the user/group/chroot specified by its
      service settings.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-May/060815.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?732df27a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"dovecot-2.0.13-1.fc14")) flag++;
