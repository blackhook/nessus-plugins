...
# extracted from F5 Networks BIG-IP Solution SOL15984.
#
...
if (description)
{
  ...
  script_bugtraq_id(64677);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL15984)");
...
(1) recvfrom, (2) recvmmsg, or (3) recvmsg system call."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15984"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
