...
# extracted from Fedora Security Advisory FEDORA-2019-0b73bd3e5d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : libzip (2019-0b73bd3e5d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0b73bd3e5d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"libzip-1.5.2-1.fc28")) flag++;
