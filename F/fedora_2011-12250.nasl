...
# extracted from Fedora Security Advisory 2011-12250.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : rsyslog-5.8.5-1.fc16 (2011-12250)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a947cd33"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"rsyslog-5.8.5-1.fc16")) flag++;
