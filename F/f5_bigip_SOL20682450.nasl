...
proof of concept."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K20682450"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["affected"  ] = make_list("13.0.0","12.1.0-12.1.2","11.6.1-11.6.2");
vmatrix["AFM"]["unaffected"] = make_list("13.1.0","13.0.0HF1","12.1.0-12.1.3","12.1.2HF1","11.6.3");
