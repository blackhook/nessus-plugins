...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-88fb82d1cd"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.nongnu.org/archive/html/lout-users/2020-10/msg00013.html"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected lout package.");
