...
# extracted from Fedora Security Advisory FEDORA-2017-bb0b9ddf27.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-bb0b9ddf27");

  script_name(english:"Fedora 24 : pdns (2017-bb0b9ddf27)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-bb0b9ddf27"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"pdns-4.0.3-1.fc24")) flag++;
