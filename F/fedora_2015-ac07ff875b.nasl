...
# extracted from Fedora Security Advisory 2015-ac07ff875b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-ac07ff875b");

  script_name(english:"Fedora 23 : python-cryptography-1.0.2-2.fc23 / python-cryptography-vectors-1.0.2-2.fc23 (2015-ac07ff875b)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for undefined behavior could lead to a crash
...
flag = 0;
if (rpm_check(release:"FC23", reference:"python-cryptography-1.0.2-2.fc23")) flag++;
if (rpm_check(release:"FC23", reference:"python-cryptography-vectors-1.0.2-2.fc23")) flag++;
