...
# extracted from Fedora Security Advisory 2009-11260.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11260");

  script_name(english:"Fedora 11 : wordpress-mu-2.8.5.2-1.fc11 (2009-11260)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/030871.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a253c56"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"wordpress-mu-2.8.5.2-1.fc11")) flag++;
