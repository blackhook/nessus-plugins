...
# extracted from F5 Networks BIG-IP Solution K21154730.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-6141");

  script_name(english:"F5 Networks BIG-IP : TMM SSL/TLS profile vulnerability (K21154730)");
  ...
  script_set_attribute(
    ...
    value:
"Certain values in a TLS abbreviated handshake when using a client SSL
profile with the Session Ticket option enabled may cause disruption of
service to the Traffic Management Microkernel (TMM). The Session
Ticket option is disabled by default. (CVE-2017-6141)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K21154730"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["AM"]["unaffected"] = make_list("13.0.0","12.1.2HF1","12.0.0","11.4.0-11.6.1");
