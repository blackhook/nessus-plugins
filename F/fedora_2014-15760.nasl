...
# extracted from Fedora Security Advisory 2014-15760.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15760");

  script_name(english:"Fedora 21 : graphviz-2.38.0-11.fc21 (2014-15760)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1167866"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145509.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eeea9267"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"graphviz-2.38.0-11.fc21")) flag++;
