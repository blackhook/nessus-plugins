...
# extracted from F5 Networks BIG-IP Solution K04450715.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-8806");

  script_name(english:"F5 Networks BIG-IP : libxml2 vulnerability (K04450715)");
...
character immediately after the '<!DOCTYPE html' substring in a
crafted HTML document. (CVE-2015-8806)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K04450715"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
