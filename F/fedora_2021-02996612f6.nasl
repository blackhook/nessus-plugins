...
# extracted from Fedora Security Advisory FEDORA-2021-02996612f6
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-02996612f6");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/09/15");

  script_name(english:"Fedora 32 : 1:php-pear (2021-02996612f6)");
...
FEDORA-2021-02996612f6 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-02996612f6");
...
pkgs = [
    {'reference':'php-pear-1.10.12-5.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
];
