...
# extracted from Fedora Security Advisory FEDORA-2016-bc0e4e3f5a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-bc0e4e3f5a");

  script_name(english:"Fedora 23 : community-mysql (2016-bc0e4e3f5a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-bc0e4e3f5a"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2016/10/02");
...
flag = 0;
if (rpm_check(release:"FC23", reference:"community-mysql-5.6.33-1.fc23")) flag++;
