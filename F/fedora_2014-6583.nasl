...
# extracted from Fedora Security Advisory 2014-6583.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-6583");

  script_name(english:"Fedora 20 : libtiff-4.0.3-15.fc20 (2014-6583)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-May/133762.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6b56949b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libtiff-4.0.3-15.fc20")) flag++;
