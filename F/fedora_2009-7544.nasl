...
# extracted from Fedora Security Advisory 2009-7544.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-7544");

  script_name(english:"Fedora 10 : perl-IO-Socket-SSL-1.26-1.fc10 (2009-7544)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=509819"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026688.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?10c10d4c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"perl-IO-Socket-SSL-1.26-1.fc10")) flag++;
