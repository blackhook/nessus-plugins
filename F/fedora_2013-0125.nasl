...
# extracted from Fedora Security Advisory 2013-0125.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 18 : drupal6-context-3.1-1.fc18 (2013-0125)");
  ...
  script_set_attribute(
    ...
    value:
"  - Thu Jan 3 2013 Anderson Silva <ansilva at redhat.com> -
    3.1-1
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/097125.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?647aa1c7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"drupal6-context-3.1-1.fc18")) flag++;
