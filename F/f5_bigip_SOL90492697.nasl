...
# extracted from F5 Networks BIG-IP Solution K90492697.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (K90492697)");
...
s3_clnt.c and s3_srvr.c.(CVE-2016-6306)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K90492697"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["APM"]["unaffected"] = make_list("13.0.0","112.1.2HF1","11.6.2","11.5.6");
