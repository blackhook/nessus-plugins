...
# extracted from Fedora Security Advisory 2016-f1d98cf017.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-f1d98cf017");

  script_name(english:"Fedora 23 : php-5.6.21-1.fc23 (2016-f1d98cf017)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-May/183403.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d1f994a8"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"php-5.6.21-1.fc23")) flag++;
