...
# extracted from Fedora Security Advisory FEDORA-2017-44d0e642a4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : libtirpc (2017-44d0e642a4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-44d0e642a4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libtirpc-1.0.1-4.rc3.fc25")) flag++;
