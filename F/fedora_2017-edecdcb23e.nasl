...
# extracted from Fedora Security Advisory FEDORA-2017-edecdcb23e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-edecdcb23e");

  script_name(english:"Fedora 26 : deluge (2017-edecdcb23e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-edecdcb23e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"deluge-1.3.15-1.fc26")) flag++;
