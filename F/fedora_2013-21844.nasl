...
# extracted from Fedora Security Advisory 2013-21844.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-21844");

  script_name(english:"Fedora 19 : drupal7-7.24-1.fc19 (2013-21844)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123015.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c1600d4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"drupal7-7.24-1.fc19")) flag++;
