...
# extracted from Fedora Security Advisory 2007-375.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 5 : openoffice.org-2.0.2-5.21.2 (2007-375)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-March/001603.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?660a48b9"
  );
...
flag = 0;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-base-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-calc-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-core-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-debuginfo-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-draw-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-emailmerge-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-graphicfilter-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-impress-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-javafilter-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-af_ZA-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ar-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-bg_BG-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-bn_IN-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ca_ES-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-cs_CZ-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-cy_GB-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-da_DK-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-de-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-el_GR-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-es-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-et_EE-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-eu_ES-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-fi_FI-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-fr-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ga_IE-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-gl_ES-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-gu_IN-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-he_IL-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-hi_IN-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-hr_HR-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-hu_HU-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-it-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ja_JP-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ko_KR-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-lt_LT-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ms_MY-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-nb_NO-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-nl-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-nn_NO-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-pa_IN-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-pl_PL-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-pt_BR-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-pt_PT-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ru-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-sk_SK-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-sl_SI-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-sr_CS-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-sv-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-ta_IN-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-th_TH-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-tr_TR-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-zh_CN-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-zh_TW-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-langpack-zu_ZA-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-math-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-pyuno-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-testtools-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-writer-2.0.2-5.21.2")) flag++;
if (rpm_check(release:"FC5", cpu:"i386", reference:"openoffice.org-xsltfilter-2.0.2-5.21.2")) flag++;
