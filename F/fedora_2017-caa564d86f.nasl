...
# extracted from Fedora Security Advisory FEDORA-2017-caa564d86f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-caa564d86f");

  script_name(english:"Fedora 26 : FlightGear (2017-caa564d86f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-caa564d86f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"FlightGear-2017.2.1-2.fc26")) flag++;
