...
# extracted from Fedora Security Advisory FEDORA-2016-a3bc78de2b.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-9447", "CVE-2016-9809");
  script_xref(name:"FEDORA", value:"2016-a3bc78de2b");

  script_name(english:"Fedora 24 : gstreamer-plugins-bad-free (2016-a3bc78de2b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a3bc78de2b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"gstreamer-plugins-bad-free-0.10.23-34.fc24")) flag++;
