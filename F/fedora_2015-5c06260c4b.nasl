...
# extracted from Fedora Security Advisory 2015-5c06260c4b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5c06260c4b");

  script_name(english:"Fedora 21 : php-udan11-sql-parser-3.0.4-1.fc21 / phpMyAdmin-4.5.1-1.fc21 (2015-5c06260c4b)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/171326.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?002d57a0"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-November/171327.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bfea1ae5"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC21", reference:"php-udan11-sql-parser-3.0.4-1.fc21")) flag++;
if (rpm_check(release:"FC21", reference:"phpMyAdmin-4.5.1-1.fc21")) flag++;
