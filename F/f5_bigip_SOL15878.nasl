...
# extracted from F5 Networks BIG-IP Solution SOL15878.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : bzip2 vulnerability (SOL15878)");
...
arbitrary code via a crafted compressed file."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15878"
  );
  script_set_attribute(
    attribute:"solution",
    value:
