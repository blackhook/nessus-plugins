...
# extracted from Fedora Security Advisory FEDORA-2017-e136d63c99.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-0899", "CVE-2017-0900", "CVE-2017-0901", "CVE-2017-0902", "CVE-2017-14064");
  script_xref(name:"FEDORA", value:"2017-e136d63c99");

  script_name(english:"Fedora 25 : ruby (2017-e136d63c99)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e136d63c99"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ruby-2.3.4-64.fc25")) flag++;
