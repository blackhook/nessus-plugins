...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-5904d0794d"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2018-5904d0794d");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC29", reference:"kernel-4.19.7-300.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"kernel-headers-4.19.7-300.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"kernel-tools-4.19.7-300.fc29")) flag++;
