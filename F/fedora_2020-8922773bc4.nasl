...
# extracted from Fedora Security Advisory FEDORA-2020-8922773bc4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : 1:libreoffice (2020-8922773bc4)");
...
"  - CVE-2020-12803 limit forms to http[s]
  ...
  - CVE-2020-12802 improve docx steathmode import
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8922773bc4"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libreoffice-6.3.6.2-4.fc31", epoch:"1")) flag++;
