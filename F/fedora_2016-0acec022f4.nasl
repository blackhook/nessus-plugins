...
# extracted from Fedora Security Advisory FEDORA-2016-0acec022f4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0acec022f4");

  script_name(english:"Fedora 24 : 2:samba (2016-0acec022f4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-0acec022f4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"samba-4.4.5-1.fc24", epoch:"2")) flag++;
