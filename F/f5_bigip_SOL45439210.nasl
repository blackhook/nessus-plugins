...
# extracted from F5 Networks BIG-IP Solution K45439210.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : libxml2 vulnerability (K45439210)");
  ...
  script_set_attribute(
    ...
    value:
"The htmlParseComment function in HTMLparser.c in libxml2 allows
attackers to obtain sensitive information, cause a denial of service
(out-of-bounds heap memory access and application crash), or possibly
have unspecified other impact via an unclosed HTML comment.
(CVE-2015-8710)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K45439210"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
