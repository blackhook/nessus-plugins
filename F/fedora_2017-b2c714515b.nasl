...
# extracted from Fedora Security Advisory FEDORA-2017-b2c714515b.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-0375", "CVE-2017-0380");
  script_xref(name:"FEDORA", value:"2017-b2c714515b");

  script_name(english:"Fedora 27 : tor (2017-b2c714515b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b2c714515b"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"tor-0.3.1.7-1.fc27")) flag++;
