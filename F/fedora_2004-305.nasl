...
# extracted from Fedora Security Advisory 2004-305.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-305");

  script_name(english:"Fedora Core 2 : samba-3.0.7-2.FC2 (2004-305)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-September/000291.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?329b3cc0"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"samba-3.0.7-2.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-client-3.0.7-2.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-common-3.0.7-2.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-debuginfo-3.0.7-2.FC2")) flag++;
if (rpm_check(release:"FC2", reference:"samba-swat-3.0.7-2.FC2")) flag++;
