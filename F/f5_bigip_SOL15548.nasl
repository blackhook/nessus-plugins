...
# extracted from F5 Networks BIG-IP Solution SOL15548.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Rsync sender.c vulnerability (SOL15548)");
...
remote attackers to execute arbitrary code via directory names that
are not properly handled when calling the f_name function."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15548"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
