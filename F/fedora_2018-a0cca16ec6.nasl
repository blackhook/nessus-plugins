...
# extracted from Fedora Security Advisory FEDORA-2018-a0cca16ec6.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a0cca16ec6");

  script_name(english:"Fedora 26 : exim (2018-a0cca16ec6)");
  ...
  script_set_attribute(
    ...
    value:
"This is an update fixing dec64table OOB read in b64decode.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a0cca16ec6"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"exim-4.90.1-3.fc26")) flag++;
