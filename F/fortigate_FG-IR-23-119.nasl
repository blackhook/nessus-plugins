...
vulnerability as referenced in the FG-IR-23-119 advisory.
  ...
  - A use of externally-controlled format string vulnerability [CWE-134] in the Fclicense daemon of FortiOS
    may allow a remote authenticated attacker to execute arbitrary code or commands via specially crafted
    requests. (CVE-2023-29181)
...
var constraints = [
  { 'min_version' : '4.0.0', 'max_version' : '4.0.4', 'fixed_version' : '6.2.15' },
  { 'min_version' : '4.1.1', 'max_version' : '4.1.11', 'fixed_version' : '6.2.15' },
  { 'min_version' : '4.2.0', 'max_version' : '4.2.16', 'fixed_version' : '6.2.15' },
  { 'min_version' : '4.3.0', 'max_version' : '4.3.19', 'fixed_version' : '6.2.15' },
  { 'min_version' : '5.0.0', 'max_version' : '5.0.14', 'fixed_version' : '6.2.15' },
  { 'min_version' : '5.2.0', 'max_version' : '5.2.15', 'fixed_version' : '6.2.15' },
  { 'min_version' : '5.4.0', 'max_version' : '5.4.13', 'fixed_version' : '6.2.15' },
  { 'min_version' : '5.6.0', 'max_version' : '5.6.14', 'fixed_version' : '6.2.15' },
  { 'min_version' : '6.0.0', 'max_version' : '6.0.16', 'fixed_version' : '6.2.15' },
