...
# extracted from Fedora Security Advisory FEDORA-2017-3abea58794.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-3abea58794");

  script_name(english:"Fedora 25 : mbedtls (2017-3abea58794)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3abea58794"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mbedtls-2.6.0-1.fc25")) flag++;
