...
# extracted from Fedora Security Advisory FEDORA-2020-62ee541bbb.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : php (2020-62ee541bbb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-62ee541bbb"
  );
...
flag = 0;
if (rpm_check(release:"FC31", reference:"php-7.3.17-1.fc31")) flag++;
