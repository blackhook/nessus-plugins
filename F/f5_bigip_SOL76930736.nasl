...
# extracted from F5 Networks BIG-IP Solution SOL76930736.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Libpng vulnerability (SOL76930736)");
...
image."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K76930736"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Upgrade to one of the non-vulnerable versions listed in the F5
Solution SOL76930736."
  );
