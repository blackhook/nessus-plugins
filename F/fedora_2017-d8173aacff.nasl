...
# extracted from Fedora Security Advisory FEDORA-2017-d8173aacff.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-d8173aacff");

  script_name(english:"Fedora 26 : libplist (2017-d8173aacff)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-d8173aacff"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libplist-2.0.0-1.fc26")) flag++;
