...
# extracted from F5 Networks BIG-IP Solution SOL16471.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2010-0415");
  script_bugtraq_id(38144);

  script_name(english:"F5 Networks BIG-IP : Linux kernel vulnerability (SOL16471)");
...
node that is not part of the kernel's node set."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16471"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["APM"]["affected"  ] = make_list("10.0.0-10.2.4");
