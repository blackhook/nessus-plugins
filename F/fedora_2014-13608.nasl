...
# extracted from Fedora Security Advisory 2014-13608.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-13608");

  script_name(english:"Fedora 21 : hostapd-2.3-1.fc21 (2014-13608)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/141865.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?359e57f6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"hostapd-2.3-1.fc21")) flag++;
