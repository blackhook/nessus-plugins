...
# extracted from Fedora Security Advisory FEDORA-2017-801e01d1ed.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : 3:mariadb (2017-801e01d1ed)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-801e01d1ed"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mariadb-10.1.21-1.fc25", epoch:"3")) flag++;
