...
# extracted from Fedora Security Advisory FEDORA-2017-1081235137.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1081235137");

  script_name(english:"Fedora 26 : php-horde-horde (2017-1081235137)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1081235137"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"php-horde-horde-5.2.16-1.fc26")) flag++;
