...
# extracted from Fedora Security Advisory 2014-15385.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-15385");

  script_name(english:"Fedora 20 : wget-1.16-3.fc20 (2014-15385)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/144706.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e69e80a1"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"wget-1.16-3.fc20")) flag++;
