...
# extracted from Fedora Security Advisory FEDORA-2020-51ca2615fe.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : pdns-recursor (2020-51ca2615fe)");
...
Release notes:
https://docs.powerdns.com/recursor/security-advisories/powerdns-adviso
ry-2020-07.html
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-51ca2615fe"
  );
  # https://docs.powerdns.com/recursor/security-advisories/powerdns-advisory-2020-07.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3d1ac366"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"pdns-recursor-4.3.5-1.fc33")) flag++;
