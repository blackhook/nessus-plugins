...
# extracted from Fedora Security Advisory 2013-20749.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-20749");

  script_name(english:"Fedora 20 : ReviewBoard-1.7.17-1.fc20 / python-djblets-0.7.23-1.fc20 (2013-20749)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.reviewboard.org/docs/releasenotes/reviewboard/1.7.17/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1027010"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/121352.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8e73bd85"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/121353.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?96f1d1d5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"ReviewBoard-1.7.17-1.fc20")) flag++;
if (rpm_check(release:"FC20", reference:"python-djblets-0.7.23-1.fc20")) flag++;
