...
# extracted from Fedora Security Advisory FEDORA-2016-308f78b2f4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : python3 (2016-308f78b2f4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-308f78b2f4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"python3-3.4.3-11.fc23")) flag++;
