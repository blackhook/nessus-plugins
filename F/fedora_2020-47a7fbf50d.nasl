...
# extracted from Fedora Security Advisory FEDORA-2020-47a7fbf50d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : dnf / libdnf (2020-47a7fbf50d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-47a7fbf50d"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected dnf and / or libdnf packages."
  );
...
flag = 0;
if (rpm_check(release:"FC32", reference:"dnf-4.4.0-2.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"libdnf-0.54.2-2.fc32")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "dnf / libdnf");
}
