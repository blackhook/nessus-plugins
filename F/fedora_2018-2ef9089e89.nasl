...
# extracted from Fedora Security Advisory FEDORA-2018-2ef9089e89.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-2ef9089e89");

  script_name(english:"Fedora 28 : wordpress (2018-2ef9089e89)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2ef9089e89"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC28", reference:"wordpress-4.9.5-1.fc28")) flag++;
