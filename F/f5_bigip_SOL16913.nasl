...
# extracted from F5 Networks BIG-IP Solution SOL16913.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (SOL16913)");
...
(CVE-2015-1789)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16913"
  );
  script_set_attribute(
    attribute:"solution",
    value:
