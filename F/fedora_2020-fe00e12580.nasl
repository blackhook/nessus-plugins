...
# extracted from Fedora Security Advisory FEDORA-2020-fe00e12580.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : kernel (2020-fe00e12580)");
  ...
  script_set_attribute(
    ...
    value:
"The 5.5.7 stable kernel update contains a number of important fixes
across the tree.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-fe00e12580"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for FEDORA-2020-fe00e12580");
  }
  else
  {
...
flag = 0;
if (rpm_check(release:"FC30", reference:"kernel-5.5.7-100.fc30")) flag++;
