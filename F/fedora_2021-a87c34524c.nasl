...
# extracted from Fedora Security Advisory FEDORA-2021-a87c34524c
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-a87c34524c");

  script_name(english:"Fedora 35 : firefox (2021-a87c34524c)");
...
FEDORA-2021-a87c34524c advisory.

  - - New upstream version (94.0) (FEDORA-2021-a87c34524c)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-a87c34524c");
...
var pkgs = [
    {'reference':'firefox-94.0-1.fc35', 'release':'FC35', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
