...
# extracted from Fedora Security Advisory 2008-9600.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : gnutls-1.6.3-5.fc8 (2008-9600)");
...
"  - Tue Nov 11 2008 Tomas Mraz <tmraz at redhat.com> 1.6.3-5
    ...
    - Fri Jun 20 2008 Tomas Mraz <tmraz at redhat.com>
      1.6.3-4
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-November/016160.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bc7883d2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"gnutls-1.6.3-5.fc8")) flag++;
