...
# extracted from Fedora Security Advisory FEDORA-2017-8873ebdb43.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-8873ebdb43");

  script_name(english:"Fedora 24 : ikiwiki (2017-8873ebdb43)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-8873ebdb43"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"ikiwiki-3.20170111-1.fc24")) flag++;
