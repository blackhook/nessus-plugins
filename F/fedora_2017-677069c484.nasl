...
# extracted from Fedora Security Advisory FEDORA-2017-677069c484.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-677069c484");

  script_name(english:"Fedora 27 : python26 (2017-677069c484)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-677069c484"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"python26-2.6.9-10.fc27")) flag++;
