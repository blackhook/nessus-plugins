...
# extracted from Fedora Security Advisory FEDORA-2021-6edfd606d3
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-6edfd606d3");

  script_name(english:"Fedora 33 : php (2021-6edfd606d3)");
...
FEDORA-2021-6edfd606d3 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-6edfd606d3");
...
pkgs = [
    {'reference':'php-7.4.15-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
