...
# extracted from Fedora Security Advisory 2011-8831.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-8831");

  script_name(english:"Fedora 15 : dokuwiki-0-0.9.20110525.a.fc15 (2011-8831)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-July/062380.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb960b38"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"dokuwiki-0-0.9.20110525.a.fc15")) flag++;
