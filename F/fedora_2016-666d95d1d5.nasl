...
# extracted from Fedora Security Advisory FEDORA-2016-666d95d1d5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-666d95d1d5");

  script_name(english:"Fedora 25 : php-ZendFramework (2016-666d95d1d5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-666d95d1d5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"php-ZendFramework-1.12.20-1.fc25")) flag++;
