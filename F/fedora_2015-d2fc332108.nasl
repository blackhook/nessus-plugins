...
# extracted from Fedora Security Advisory 2015-d2fc332108.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-d2fc332108");

  script_name(english:"Fedora 23 : LibRaw-0.16.2-3.fc23 (2015-d2fc332108)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bb6ccaa1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"LibRaw-0.16.2-3.fc23")) flag++;
