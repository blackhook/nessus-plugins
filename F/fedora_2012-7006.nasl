...
# extracted from Fedora Security Advisory 2012-7006.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-7006");

  script_name(english:"Fedora 16 : samba-3.6.5-85.fc16 (2012-7006)");
  ...
  script_set_attribute(
    ...
    value:
"Security Release, fixes CVE-2012-2111 Fix dependency on (private)
libkrb5 symbol. This fixes smbd and nmbd startup issues.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=754783"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f6d00ca6"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"samba-3.6.5-85.fc16")) flag++;
