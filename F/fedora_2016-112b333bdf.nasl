...
# extracted from Fedora Security Advisory FEDORA-2016-112b333bdf.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : sudo (2016-112b333bdf)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-112b333bdf"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"sudo-1.8.18p1-1.fc24")) flag++;
