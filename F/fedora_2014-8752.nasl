...
# extracted from Fedora Security Advisory 2014-8752.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-8752");

  script_name(english:"Fedora 20 : cups-1.7.4-3.fc20 (2014-8752)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes one security flaw as well as broken CGI script
handling.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-July/136188.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05cdc722"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"cups-1.7.4-3.fc20")) flag++;
