...
# extracted from Fedora Security Advisory 2011-11595.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : pidgin-2.10.0-1.fc14 (2011-11595)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7c91cb05"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"pidgin-2.10.0-1.fc14")) flag++;
