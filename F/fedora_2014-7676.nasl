...
# extracted from Fedora Security Advisory 2014-7676.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : gnupg-1.4.17-1.fc20 (2014-7676)");
...
"New upstream v1.4.17
  ...
  - Avoid DoS due to garbled compressed data packets.
    ...
    - Screen keyserver reponses to avoid import of unwanted
      keys by rogue servers.

    - Add hash algorithms to the 'sig' records of the colon
      output.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134805.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?09da3020"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"gnupg-1.4.17-1.fc20")) flag++;
