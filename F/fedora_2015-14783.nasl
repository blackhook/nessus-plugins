...
# extracted from Fedora Security Advisory 2015-14783.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-14783");

  script_name(english:"Fedora 23 : qemu-2.4.0-2.fc23 (2015-14783)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/165484.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?81c4a748"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"qemu-2.4.0-2.fc23")) flag++;
