...
# extracted from Fedora Security Advisory FEDORA-2016-2941b3264e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : 12:dhcp / bind99 (2016-2941b3264e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-2941b3264e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"dhcp-4.3.3-10.P1.fc23", epoch:"12")) flag++;
if (rpm_check(release:"FC23", reference:"bind99-9.9.9-1.P2.fc23")) flag++;
