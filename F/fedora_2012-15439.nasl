...
# extracted from Fedora Security Advisory 2012-15439.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-15439");

  script_name(english:"Fedora 18 : perl-HTML-Template-Pro-0.9509-1.fc18 (2012-15439)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/089603.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06ca838b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"perl-HTML-Template-Pro-0.9509-1.fc18")) flag++;
