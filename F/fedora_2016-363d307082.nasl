...
# extracted from Fedora Security Advisory FEDORA-2016-363d307082.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : gd (2016-363d307082)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-363d307082"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"gd-2.1.1-4.fc22")) flag++;
