...
# extracted from Fedora Security Advisory 2013-20869.
#
...
if (description)
{
  ...
  script_bugtraq_id(63324);
  script_xref(name:"FEDORA", value:"2013-20869");

  script_name(english:"Fedora 20 : libvirt-1.1.3.1-1.fc20 (2013-20869)");
...
"  - Rebased to version 1.1.3.1
    ...
    - CVE-2013-4400: virt-login-shell arbitrary file
      overwrites vulnerability (bz #1015228, bz #1025685)

    - Fix possible domain disappearance on libvirtd crash
      (bz #1015246)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1015228"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/121370.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05148c83"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libvirt-1.1.3.1-1.fc20")) flag++;
