...
# extracted from Fedora Security Advisory 2009-3383.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-3383");

  script_name(english:"Fedora 9 : mapserver-5.2.2-1.fc9 (2009-3383)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022116.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?51c45a57"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"mapserver-5.2.2-1.fc9")) flag++;
