...
# extracted from Fedora Security Advisory FEDORA-2016-567a5591e4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-567a5591e4");

  script_name(english:"Fedora 25 : bind99 (2016-567a5591e4)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2016-6170
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-567a5591e4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"bind99-9.9.9-4.P4.fc25")) flag++;
