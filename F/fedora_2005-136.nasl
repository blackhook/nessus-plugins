...
# extracted from Fedora Security Advisory 2005-136.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-136");

  script_name(english:"Fedora Core 3 : xpdf-3.00-10.4 (2005-136)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-February/000689.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?50827210"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"xpdf-3.00-10.4")) flag++;
if (rpm_check(release:"FC3", reference:"xpdf-debuginfo-3.00-10.4")) flag++;
