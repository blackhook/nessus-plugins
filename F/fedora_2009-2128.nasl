...
# extracted from Fedora Security Advisory 2009-2128.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2128");

  script_name(english:"Fedora 9 : libpng-1.2.35-1.fc9 (2009-2128)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/020736.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d766462"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"libpng-1.2.35-1.fc9")) flag++;
