...
# extracted from Fedora Security Advisory FEDORA-2019-169f1eec7c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : glpi (2019-169f1eec7c)");
  ...
  script_set_attribute(
    ...
    value:
"Includes security fix backported from 9.4.3
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-169f1eec7c"
  );
...
flag = 0;
if (rpm_check(release:"FC29", reference:"glpi-9.3.4-2.fc29")) flag++;
