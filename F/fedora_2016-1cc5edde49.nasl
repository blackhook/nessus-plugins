...
# extracted from Fedora Security Advisory FEDORA-2016-1cc5edde49.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : drupal7 (2016-1cc5edde49)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-1cc5edde49"
  );
  # https://www.drupal.org/SA-CORE-2016-005
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC24", reference:"drupal7-7.52-1.fc24")) flag++;
