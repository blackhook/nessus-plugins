...
# extracted from Fedora Security Advisory FEDORA-2017-2ae4a42cd4.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-2ae4a42cd4");

  script_name(english:"Fedora 26 : wordpress (2017-2ae4a42cd4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-2ae4a42cd4"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"wordpress-4.7.3-1.fc26")) flag++;
