...
# extracted from Fedora Security Advisory 2013-13635.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-13635");

  script_name(english:"Fedora 18 : perl-Proc-ProcessTable-0.48-1.fc18 (2013-13635)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/113103.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2dd7389d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"perl-Proc-ProcessTable-0.48-1.fc18")) flag++;
