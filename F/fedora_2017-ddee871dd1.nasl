...
# extracted from Fedora Security Advisory FEDORA-2017-ddee871dd1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ddee871dd1");

  script_name(english:"Fedora 24 : shotwell (2017-ddee871dd1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ddee871dd1"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2017/02/02");
...
flag = 0;
if (rpm_check(release:"FC24", reference:"shotwell-0.24.5-1.fc24")) flag++;
