...
# extracted from Fedora Security Advisory 2006-075.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-075");

  script_name(english:"Fedora Core 4 : mozilla-1.7.12-1.5.2 (2006-075)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2006-February/001779.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f59fe42"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"mozilla-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-chat-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-debuginfo-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-devel-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-dom-inspector-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-js-debugger-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-mail-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-nspr-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-nspr-devel-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-nss-1.7.12-1.5.2")) flag++;
if (rpm_check(release:"FC4", reference:"mozilla-nss-devel-1.7.12-1.5.2")) flag++;
