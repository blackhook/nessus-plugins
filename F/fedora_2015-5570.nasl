...
# extracted from Fedora Security Advisory 2015-5570.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5570");

  script_name(english:"Fedora 21 : mediawiki-1.24.2-1.fc21 (2015-5570)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154868.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?61d8190a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mediawiki-1.24.2-1.fc21")) flag++;
