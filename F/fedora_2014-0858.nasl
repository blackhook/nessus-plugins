...
# extracted from Fedora Security Advisory 2014-0858.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : bind-9.9.3-14.P2.fc19 (2014-0858)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b1fde471"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"bind-9.9.3-14.P2.fc19")) flag++;
