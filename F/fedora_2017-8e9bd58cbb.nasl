...
# extracted from Fedora Security Advisory FEDORA-2017-8e9bd58cbb.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-8e9bd58cbb");

  script_name(english:"Fedora 25 : dropbear (2017-8e9bd58cbb)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-8e9bd58cbb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"dropbear-2017.75-1.fc25")) flag++;
