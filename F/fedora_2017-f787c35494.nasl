...
# extracted from Fedora Security Advisory FEDORA-2017-f787c35494.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-10166");
  script_xref(name:"FEDORA", value:"2017-f787c35494");

  script_name(english:"Fedora 25 : libwmf (2017-f787c35494)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f787c35494"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libwmf-0.2.8.4-50.fc25")) flag++;
