...
# extracted from Fedora Security Advisory FEDORA-2019-253da50ddd.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-253da50ddd");

  script_name(english:"Fedora 28 : php (2019-253da50ddd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-253da50ddd"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"php-7.2.17-1.fc28")) flag++;
