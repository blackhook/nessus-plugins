...
# extracted from Fedora Security Advisory 2012-10421.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-10421");

  script_name(english:"Fedora 17 : cifs-utils-5.5-2.fc17 (2012-10421)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-July/083954.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?86901768"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"cifs-utils-5.5-2.fc17")) flag++;
