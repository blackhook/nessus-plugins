...
# extracted from Fedora Security Advisory FEDORA-2016-f30fae0f67.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-f30fae0f67");

  script_name(english:"Fedora 25 : nagios-plugins (2016-f30fae0f67)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f30fae0f67"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"nagios-plugins-2.1.4-2.fc25")) flag++;
