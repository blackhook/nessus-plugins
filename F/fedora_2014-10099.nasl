...
# extracted from Fedora Security Advisory 2014-10099.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : net-snmp-5.7.2-15.fc19 (2014-10099)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/137529.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aceae309"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"net-snmp-5.7.2-15.fc19")) flag++;
