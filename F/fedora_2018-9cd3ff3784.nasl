...
# extracted from Fedora Security Advisory FEDORA-2018-9cd3ff3784.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-9cd3ff3784");
  script_xref(name:"CEA-ID", value:"CEA-2019-0227");

  script_name(english:"Fedora 27 : quagga (2018-9cd3ff3784)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Fedora host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Fixed CVE-2018-5379 - Double free vulnerability in bgpd when
processing
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-9cd3ff3784");
...
flag = 0;
if (rpm_check(release:"FC27", reference:"quagga-1.2.2-2.fc27")) flag++;
