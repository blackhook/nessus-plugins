...
# extracted from Fedora Security Advisory FEDORA-2020-e9a96ec860.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : tor (2020-e9a96ec860)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e9a96ec860"
  );
...
flag = 0;
if (rpm_check(release:"FC32", reference:"tor-0.4.4.6-1.fc32")) flag++;
