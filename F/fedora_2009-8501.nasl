...
# extracted from Fedora Security Advisory 2009-8501.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8501");

  script_name(english:"Fedora 10 : viewvc-1.0.9-1.fc10 (2009-8501)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=513006"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027827.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?19255a65"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"viewvc-1.0.9-1.fc10")) flag++;
