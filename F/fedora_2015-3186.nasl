...
# extracted from Fedora Security Advisory 2015-3186.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-3186");

  script_name(english:"Fedora 21 : dokuwiki-0-0.24.20140929c.fc21 (2015-3186)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/153062.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80317846"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"dokuwiki-0-0.24.20140929c.fc21")) flag++;
