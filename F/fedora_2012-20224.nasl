...
# extracted from Fedora Security Advisory 2012-20224.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-20224");

  script_name(english:"Fedora 17 : Django-1.4.3-1.fc17 (2012-20224)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/094954.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?10907255"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC17", reference:"Django-1.4.3-1.fc17")) flag++;
