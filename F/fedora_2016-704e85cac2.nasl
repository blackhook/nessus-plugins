...
# extracted from Fedora Security Advisory FEDORA-2016-704e85cac2.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-704e85cac2");

  script_name(english:"Fedora 25 : python-django (2016-704e85cac2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-704e85cac2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"python-django-1.9.10-1.fc25")) flag++;
