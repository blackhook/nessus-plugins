...
# extracted from Fedora Security Advisory FEDORA-2020-46ecc60897.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-46ecc60897");

  script_name(english:"Fedora 31 : 2:runc (2020-46ecc60897)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-46ecc60897"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"runc-1.0.0-102.dev.gitdc9208a.fc31", epoch:"2")) flag++;
