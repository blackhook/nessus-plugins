...
# extracted from Fedora Security Advisory FEDORA-2019-53b0dc52ee.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-53b0dc52ee");

  script_name(english:"Fedora 30 : xen (2019-53b0dc52ee)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-53b0dc52ee"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"xen-4.11.1-4.fc30")) flag++;
