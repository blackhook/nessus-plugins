...
# extracted from Fedora Security Advisory FEDORA-2020-25247f0fe7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : thunderbird (2020-25247f0fe7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-25247f0fe7"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC33", reference:"thunderbird-78.4.0-1.fc33", allowmaj:TRUE)) flag++;
