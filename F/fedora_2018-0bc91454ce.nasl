...
# extracted from Fedora Security Advisory FEDORA-2018-0bc91454ce.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-0bc91454ce");

  script_name(english:"Fedora 28 : php-pear-CAS (2018-0bc91454ce)");
...
**Improvement:**
  ...
  - Fix continue statement within switch/case for php 7.3
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-0bc91454ce"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"php-pear-CAS-1.3.6-1.fc28")) flag++;
