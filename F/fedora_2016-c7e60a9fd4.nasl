...
# extracted from Fedora Security Advisory FEDORA-2016-c7e60a9fd4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : community-mysql (2016-c7e60a9fd4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-c7e60a9fd4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"community-mysql-5.7.17-1.fc24")) flag++;
