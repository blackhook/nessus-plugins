...
# extracted from Fedora Security Advisory 2015-16370.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-16370");

  script_name(english:"Fedora 23 : qemu-2.4.0-4.fc23 (2015-16370)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-September/167369.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?72fad9f4"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"qemu-2.4.0-4.fc23")) flag++;
