...
# extracted from Fedora Security Advisory 2015-13718.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-13718");

  script_name(english:"Fedora 22 : rt-4.2.12-1.fc22 (2015-13718)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e0a3e7eb"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"rt-4.2.12-1.fc22")) flag++;
