...
# extracted from Fedora Security Advisory FEDORA-2021-ed9c13a1d5
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ed9c13a1d5");

  script_name(english:"Fedora 33 : mingw-flac (2021-ed9c13a1d5)");
...
FEDORA-2021-ed9c13a1d5 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ed9c13a1d5");
...
pkgs = [
    {'reference':'mingw-flac-1.3.3-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
