...
# extracted from Fedora Security Advisory 2015-6565f29415.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6565f29415");

  script_name(english:"Fedora 22 : pax-utils-1.1.4-1.fc22 (2015-6565f29415)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-December/173807.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a1078ae4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"pax-utils-1.1.4-1.fc22")) flag++;
