...
# extracted from F5 Networks BIG-IP Solution K91084571.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : PHP vulnerability (K91084571)");
...
recursive method calls. (CVE-2015-8873)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K91084571"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["AM"]["affected"  ] = make_list("12.0.0","11.4.0-11.6.0","11.2.1");
