...
# extracted from Fedora Security Advisory 2014-0020.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-0020");

  script_name(english:"Fedora 19 : gnome-chemistry-utils-0.14.5-1.fc19 / gnumeric-1.12.9-1.fc19 / goffice-0.10.9-1.fc19 (2014-0020)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-January/126349.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a9ef467b"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-January/126350.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4cbf259b"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-January/126351.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?58d68c3e"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"gnome-chemistry-utils-0.14.5-1.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"gnumeric-1.12.9-1.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"goffice-0.10.9-1.fc19")) flag++;
