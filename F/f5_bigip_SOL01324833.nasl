...
# extracted from F5 Networks BIG-IP Solution K01324833.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : NTP vulnerability (K01324833)");
  ...
  script_set_attribute(
    ...
    value:
"The getresponse function in ntpq in NTP versions before 4.2.8p9 and
4.3.x before 4.3.90 allows remote attackers to cause a denial of
service (infinite loop) via crafted packets with incorrect values.
(CVE-2015-8158)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K01324833"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
