...
# extracted from Fedora Security Advisory 2015-8691.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-8691");

  script_name(english:"Fedora 22 : python-django-1.8.2-1.fc22 (2015-8691)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1223591"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/159156.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23c0803f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"python-django-1.8.2-1.fc22")) flag++;
