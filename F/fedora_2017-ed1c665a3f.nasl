...
# extracted from Fedora Security Advisory FEDORA-2017-ed1c665a3f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ed1c665a3f");

  script_name(english:"Fedora 24 : wget (2017-ed1c665a3f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ed1c665a3f"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"wget-1.18-2.fc24")) flag++;
