...
# extracted from Fedora Security Advisory 2004-411.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-411");

  script_name(english:"Fedora Core 2 : gd-2.0.21-5.20.1 (2004-411)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-November/000391.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1fec530d"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"gd-2.0.21-5.20.1")) flag++;
if (rpm_check(release:"FC2", reference:"gd-debuginfo-2.0.21-5.20.1")) flag++;
if (rpm_check(release:"FC2", reference:"gd-devel-2.0.21-5.20.1")) flag++;
if (rpm_check(release:"FC2", reference:"gd-progs-2.0.21-5.20.1")) flag++;
