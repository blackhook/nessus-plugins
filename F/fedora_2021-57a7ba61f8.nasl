...
# extracted from Fedora Security Advisory FEDORA-2021-57a7ba61f8
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-57a7ba61f8");

  script_name(english:"Fedora 32 : kernel (2021-57a7ba61f8)");
...
FEDORA-2021-57a7ba61f8 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-57a7ba61f8");
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-30178");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2021-30178');
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for FEDORA-2021-57a7ba61f8');
  }
  else
  {
...
pkgs = [
    {'reference':'kernel-5.11.13-100.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
