...
# extracted from Fedora Security Advisory FEDORA-2017-951b6a78d4.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : subversion (2017-951b6a78d4)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-951b6a78d4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"subversion-1.9.7-1.fc26")) flag++;
