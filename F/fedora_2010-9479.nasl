...
# extracted from Fedora Security Advisory 2010-9479.
#
...
if (description)
{
  ...
  script_bugtraq_id(40775);
  script_xref(name:"FEDORA", value:"2010-9479");

  script_name(english:"Fedora 12 : dhcp-4.1.1-17.P1.fc12 (2010-9479)");
...
bug fixes including one for a security related bug.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://ftp.isc.org/isc/dhcp/dhcp-4.1.1-P1-RELNOTES"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=601403"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/043384.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?64a134af"
  );
...
flag = 0;
if (rpm_check(release:"FC12", reference:"dhcp-4.1.1-17.P1.fc12")) flag++;
