...
# extracted from Fedora Security Advisory FEDORA-2017-f04296e37e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f04296e37e");

  script_name(english:"Fedora 27 : LibRaw (2017-f04296e37e)");
...
Fix for CVE-2017-13735 Additional checks for X-Trans CFA pattern data 
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f04296e37e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"LibRaw-0.18.4-2.fc27")) flag++;
