...
# extracted from Fedora Security Advisory 2005-780.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-780");

  script_name(english:"Fedora Core 4 : squirrelmail-1.4.6-0.cvs20050812.1.fc4 (2005-780)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-August/001280.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1072f22a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC4", reference:"squirrelmail-1.4.6-0.cvs20050812.1.fc4")) flag++;
