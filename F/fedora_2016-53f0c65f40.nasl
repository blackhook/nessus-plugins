...
# extracted from Fedora Security Advisory FEDORA-2016-53f0c65f40.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : bind99 (2016-53f0c65f40)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-53f0c65f40"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"bind99-9.9.9-1.P2.fc24")) flag++;
