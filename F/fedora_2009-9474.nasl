...
# extracted from Fedora Security Advisory 2009-9474.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-9474");

  script_name(english:"Fedora 10 : postgresql-8.3.8-1.fc10 (2009-9474)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/8.3/release-8-3-8.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-September/028979.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9eadb964"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"postgresql-8.3.8-1.fc10")) flag++;
