...
# extracted from Fedora Security Advisory 2015-13664.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-13664");

  script_name(english:"Fedora 21 : rt-4.2.12-1.fc21 (2015-13664)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?badc1a9c"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"rt-4.2.12-1.fc21")) flag++;
