...
# extracted from Fedora Security Advisory FEDORA-2017-3bf0bd9c0c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-3bf0bd9c0c");

  script_name(english:"Fedora 25 : wordpress (2017-3bf0bd9c0c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3bf0bd9c0c"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"wordpress-4.8.2-1.fc25")) flag++;
