...
# extracted from Fedora Security Advisory 2015-1225.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-1225");

  script_name(english:"Fedora 21 : privoxy-3.0.23-1.fc21 (2015-1225)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://seclists.org/oss-sec/2015/q1/259"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-February/149086.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?61b2f239"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"privoxy-3.0.23-1.fc21")) flag++;
