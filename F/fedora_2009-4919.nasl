...
# extracted from Fedora Security Advisory 2009-4919.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-4919");

  script_name(english:"Fedora 10 : opensc-0.11.8-1.fc10 (2009-4919)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-May/024321.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bb978459"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"opensc-0.11.8-1.fc10")) flag++;
