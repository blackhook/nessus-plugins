...
# extracted from Fedora Security Advisory FEDORA-2017-dfaf0ca892.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-dfaf0ca892");

  script_name(english:"Fedora 26 : webkitgtk4 (2017-dfaf0ca892)");
  ...
  script_set_attribute(
    ...
    value:
"Highlights of the 2.16.0 release :

  - Hardware acceleration is now enabled on demand to
    drastically reduce memory consumption.

  - CSS Grid Layout is enabled by default.

  - New WebKitSetting to set the hardware acceleration
    policy.

  - UI process API to configure network proxy settings.

  - Improved private browsing by adding new API to create
    ephemeral web views.
...
This update brings the following changes :
  ...
  - Fix web process deadlocks when destroying the media
    player.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-dfaf0ca892"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"webkitgtk4-2.16.0-1.fc26")) flag++;
