...
# extracted from Fedora Security Advisory 2011-3150.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3150");

  script_name(english:"Fedora 15 : pidgin-2.7.11-1.fc15 (2011-3150)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b82e137c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"pidgin-2.7.11-1.fc15")) flag++;
