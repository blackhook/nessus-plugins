...
# extracted from Fedora Security Advisory 2015-2893.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-2893");

  script_name(english:"Fedora 21 : gnupg-1.4.19-1.fc21 (2015-2893)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88c4db32"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"gnupg-1.4.19-1.fc21")) flag++;
