...
# extracted from Fedora Security Advisory 2009-2852.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2852");

  script_name(english:"Fedora 10 : krb5-1.6.3-18.fc10 (2009-2852)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=490634"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=491033"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=491034"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=491036"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-April/022152.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?17502e2d"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"krb5-1.6.3-18.fc10")) flag++;
