...
# extracted from Fedora Security Advisory 2009-1204.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-1204");
  script_xref(name:"Secunia", value:"33622");

  script_name(english:"Fedora 10 : roundcubemail-0.2-7.stable.fc10 (2009-1204)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for: Common Vulnerabilities and Exposures assigned an
identifier CVE-2009-0413 to the following vulnerability: Cross-site
scripting (XSS) vulnerability in RoundCube Webmail (roundcubemail) 0.2
stable allows remote attackers to inject arbitrary web script or HTML
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-February/019658.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?285637b6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"roundcubemail-0.2-7.stable.fc10")) flag++;
