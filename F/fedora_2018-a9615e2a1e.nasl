...
# extracted from Fedora Security Advisory FEDORA-2018-a9615e2a1e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : gsoap (2018-a9615e2a1e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a9615e2a1e"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"gsoap-2.8.43-3.fc26")) flag++;
