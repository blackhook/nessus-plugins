...
# extracted from Fedora Security Advisory 2004-270.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2004-0691");
  script_xref(name:"FEDORA", value:"2004-270");

  script_name(english:"Fedora Core 1 : qt-3.1.2-14.2 (2004-270)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-August/000268.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2576f349"
  );
...
flag = 0;
if (rpm_check(release:"FC1", reference:"qt-3.1.2-14.2")) flag++;
if (rpm_check(release:"FC1", reference:"qt-MySQL-3.1.2-14.2")) flag++;
if (rpm_check(release:"FC1", reference:"qt-ODBC-3.1.2-14.2")) flag++;
if (rpm_check(release:"FC1", reference:"qt-PostgreSQL-3.1.2-14.2")) flag++;
if (rpm_check(release:"FC1", reference:"qt-debuginfo-3.1.2-14.2")) flag++;
if (rpm_check(release:"FC1", reference:"qt-designer-3.1.2-14.2")) flag++;
if (rpm_check(release:"FC1", reference:"qt-devel-3.1.2-14.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "qt / qt-MySQL / qt-ODBC / qt-PostgreSQL / qt-debuginfo / etc");
}
