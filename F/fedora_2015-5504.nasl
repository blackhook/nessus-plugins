...
# extracted from Fedora Security Advisory 2015-5504.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5504");

  script_name(english:"Fedora 22 : php-symfony-2.5.11-1.fc22 (2015-5504)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155234.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ba5c3e9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"php-symfony-2.5.11-1.fc22")) flag++;
