...
# extracted from Fedora Security Advisory 2009-3101.
#
...
if (description)
{
  ...
  script_bugtraq_id(33598, 33990, 34181, 34235);
  script_xref(name:"FEDORA", value:"2009-3101");

  script_name(english:"Fedora 9 : seamonkey-1.1.15-3.fc9 (2009-3101)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021871.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed6a0fdc"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021940.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?651f5f67"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"seamonkey-1.1.15-3.fc9")) flag++;
