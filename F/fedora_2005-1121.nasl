...
# extracted from Fedora Security Advisory 2005-1121.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-1121");

  script_name(english:"Fedora Core 3 : xpdf-3.01-0.FC3.3 (2005-1121)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-December/001626.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e19b2420"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"xpdf-3.01-0.FC3.3")) flag++;
if (rpm_check(release:"FC3", reference:"xpdf-debuginfo-3.01-0.FC3.3")) flag++;
