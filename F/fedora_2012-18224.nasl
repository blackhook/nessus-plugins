...
# extracted from Fedora Security Advisory 2012-18224.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-18224");

  script_name(english:"Fedora 16 : bugzilla-4.0.9-1.fc16 (2012-18224)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/093070.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?28f6b3b5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"bugzilla-4.0.9-1.fc16")) flag++;
