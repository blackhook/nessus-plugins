...
# extracted from Fedora Security Advisory 2016-ec05afb364.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-ec05afb364");

  script_name(english:"Fedora 23 : webkitgtk4-2.10.7-1.fc23 (2016-ec05afb364)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?62a529bc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"webkitgtk4-2.10.7-1.fc23")) flag++;
