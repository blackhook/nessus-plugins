...
# extracted from Fedora Security Advisory 2013-18493.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : qemu-1.4.2-12.fc19 (2013-18493)");
...
"  - CVE-2013-4344: buffer overflow in
    ...
    - Require newer ceph-libs to fix symbol error (bz
      #995883)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c0d5f87"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119083.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a63e8ae4"
  );
...
flag = 0;
if (rpm_check(release:"FC19", reference:"qemu-1.4.2-12.fc19")) flag++;
