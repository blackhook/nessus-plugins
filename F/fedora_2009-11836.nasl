...
# extracted from Fedora Security Advisory 2009-11836.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-11836");

  script_name(english:"Fedora 12 : wget-1.12-2.fc12 (2009-11836)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-December/032020.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b0d028f4"
  );
...
flag = 0;
if (rpm_check(release:"FC12", reference:"wget-1.12-2.fc12")) flag++;
