...
# extracted from Fedora Security Advisory 2015-7708.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7708");

  script_name(english:"Fedora 22 : php-ZendFramework2-2.3.8-1.fc22 (2015-7708)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158739.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1e7d63a1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"php-ZendFramework2-2.3.8-1.fc22")) flag++;
