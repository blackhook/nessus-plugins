...
# extracted from Fedora Security Advisory FEDORA-2016-e6ba110670.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-e6ba110670");

  script_name(english:"Fedora 25 : libXtst (2016-e6ba110670)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-e6ba110670"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libXtst-1.2.3-1.fc25")) flag++;
