...
# extracted from Fedora Security Advisory 2015-6006.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : python-virtualenv-12.0.7-1.fc20 (2015-6006)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1066692"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155291.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a6847137"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"python-virtualenv-12.0.7-1.fc20")) flag++;
