...
# extracted from Fedora Security Advisory 2010-15520.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : nss-3.12.8-2.fc13 / nss-softokn-3.12.8-1.fc13 / nss-util-3.12.8-1.fc13 (2010-15520)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/049760.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ecee1bbc"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/049761.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?70379c9e"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/049762.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a53ef47b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"nss-3.12.8-2.fc13")) flag++;
if (rpm_check(release:"FC13", reference:"nss-softokn-3.12.8-1.fc13")) flag++;
if (rpm_check(release:"FC13", reference:"nss-util-3.12.8-1.fc13")) flag++;
