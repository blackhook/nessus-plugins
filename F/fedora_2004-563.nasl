...
# extracted from Fedora Security Advisory 2004-563.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-563");

  script_name(english:"Fedora Core 2 : krb5-1.3.6-1 (2004-563)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-December/000524.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?635ec77a"
  );
...
flag = 0;
if (rpm_check(release:"FC2", reference:"krb5-debuginfo-1.3.6-1")) flag++;
if (rpm_check(release:"FC2", reference:"krb5-devel-1.3.6-1")) flag++;
if (rpm_check(release:"FC2", reference:"krb5-libs-1.3.6-1")) flag++;
if (rpm_check(release:"FC2", reference:"krb5-server-1.3.6-1")) flag++;
if (rpm_check(release:"FC2", reference:"krb5-workstation-1.3.6-1")) flag++;
