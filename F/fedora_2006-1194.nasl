...
# extracted from Fedora Security Advisory 2006-1194.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1194");

  script_name(english:"Fedora Core 5 : thunderbird-1.5.0.8-1.fc5 (2006-1194)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-November/000840.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80bcc3b0"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC5", reference:"thunderbird-1.5.0.8-1.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"thunderbird-debuginfo-1.5.0.8-1.fc5")) flag++;
