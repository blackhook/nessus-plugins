...
# extracted from Fedora Security Advisory 2009-8307.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8307");

  script_name(english:"Fedora 11 : wordpress-2.8.3-1.fc11 (2009-8307)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027552.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60b22638"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"wordpress-2.8.3-1.fc11")) flag++;
