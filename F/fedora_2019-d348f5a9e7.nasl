...
# extracted from Fedora Security Advisory FEDORA-2019-d348f5a9e7.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : php-horde-horde (2019-d348f5a9e7)");
...
"**horde 5.2.21**
  ...
  - [mjr] SECURITY: Fix XSS vulnerability in the Cloud
    Block.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-d348f5a9e7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"php-horde-horde-5.2.21-1.fc30")) flag++;
