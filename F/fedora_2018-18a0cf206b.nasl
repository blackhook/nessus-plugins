...
# extracted from Fedora Security Advisory FEDORA-2018-18a0cf206b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : tor (2018-18a0cf206b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-18a0cf206b"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"tor-0.3.1.10-1.fc26")) flag++;
