...
FEDORA-2021-6feb090c97 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-6feb090c97");
...
pkgs = [
    {'reference':'glibc-2.32-3.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
