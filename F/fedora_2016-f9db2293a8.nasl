...
# extracted from Fedora Security Advisory FEDORA-2016-f9db2293a8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : pulp / pulp-docker / pulp-ostree / pulp-puppet / pulp-python / etc (2016-f9db2293a8)");
  ...
  script_set_attribute(
    ...
    value:
"Update to Pulp 2.8.3, a security and bugfix update.

----

  - CVE-2016-3111: Protect the RSA keys during and after
    install (#1325693).
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-f9db2293a8"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"pulp-2.8.3-1.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"pulp-docker-2.0.1-1.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"pulp-ostree-1.1.1-1.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"pulp-puppet-2.8.3-2.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"pulp-python-1.1.1-1.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"pulp-rpm-2.8.3-1.fc24")) flag++;
