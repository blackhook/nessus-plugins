...
# extracted from Fedora Security Advisory 2011-16981.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-16981");

  script_name(english:"Fedora 16 : dhcp-4.2.3-4.P1.fc16 (2011-16981)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-December/070980.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c8c89d76"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"dhcp-4.2.3-4.P1.fc16")) flag++;
