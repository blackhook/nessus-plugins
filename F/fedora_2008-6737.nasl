...
# extracted from Fedora Security Advisory 2008-6737.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : thunderbird-2.0.0.16-1.fc9 (2008-6737)");
...
available for Fedora 9. Several flaws were found in the processing of
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-August/013374.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e73fd30"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"thunderbird-2.0.0.16-1.fc9")) flag++;
