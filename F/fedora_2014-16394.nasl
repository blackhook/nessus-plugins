...
# extracted from Fedora Security Advisory 2014-16394.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-16394");

  script_name(english:"Fedora 20 : icecast-2.4.1-1.fc20 (2014-16394)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/146260.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8dbc8a5c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"icecast-2.4.1-1.fc20")) flag++;
