...
# extracted from Fedora Security Advisory 2013-15755.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-15755");

  script_name(english:"Fedora 18 : perl-Crypt-DSA-1.17-10.fc18 (2013-15755)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://rdist.root.org/2010/11/19/dsa-requirements-for-random-k-value/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=743567"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115606.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf712e28"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"perl-Crypt-DSA-1.17-10.fc18")) flag++;
