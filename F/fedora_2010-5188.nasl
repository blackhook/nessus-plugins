...
# extracted from Fedora Security Advisory 2010-5188.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : glpi-0.72.4-2.svn11035.fc11 (2010-5188)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037946.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?151d1d30"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"glpi-0.72.4-2.svn11035.fc11")) flag++;
