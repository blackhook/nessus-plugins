...
# extracted from Fedora Security Advisory 2015-0772f3f93b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-0772f3f93b");

  script_name(english:"Fedora 22 : rpm-4.12.0.1-14.fc22 (2015-0772f3f93b)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?94c4dfc3"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"rpm-4.12.0.1-14.fc22")) flag++;
