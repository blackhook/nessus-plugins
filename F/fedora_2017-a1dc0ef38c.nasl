...
# extracted from Fedora Security Advisory FEDORA-2017-a1dc0ef38c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : 1:emacs (2017-a1dc0ef38c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a1dc0ef38c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"emacs-25.3-1.fc26", epoch:"1")) flag++;
