...
# extracted from Fedora Security Advisory 2008-6411.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : drupal-5.8-1.fc8 (2008-6411)");
  ...
  script_set_attribute(
    ...
    value:
"Update to 5.8, security fixes: SA-2008-044 Remember to log in to your
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-July/012431.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dc4794e6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"drupal-5.8-1.fc8")) flag++;
