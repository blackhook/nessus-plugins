...
# extracted from Fedora Security Advisory 2012-18559.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-18559");

  script_name(english:"Fedora 16 : claws-mail-3.9.0-1.fc16 / claws-mail-plugins-3.9.0-2.fc16 (2012-18559)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/093782.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7d56ca63"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-December/093784.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?704e7c96"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"claws-mail-3.9.0-1.fc16")) flag++;
if (rpm_check(release:"FC16", reference:"claws-mail-plugins-3.9.0-2.fc16")) flag++;
