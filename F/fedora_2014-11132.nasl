...
# extracted from Fedora Security Advisory 2014-11132.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11132");

  script_name(english:"Fedora 21 : nodejs-0.10.32-1.fc21 / v8-3.14.5.10-14.fc21 (2014-11132)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/138841.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bff56968"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/138842.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c54f5c8d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"nodejs-0.10.32-1.fc21")) flag++;
if (rpm_check(release:"FC21", reference:"v8-3.14.5.10-14.fc21")) flag++;
