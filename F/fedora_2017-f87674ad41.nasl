...
# extracted from Fedora Security Advisory FEDORA-2017-f87674ad41.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f87674ad41");

  script_name(english:"Fedora 25 : ed (2017-f87674ad41)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f87674ad41"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"ed-1.14.1-1.fc25")) flag++;
