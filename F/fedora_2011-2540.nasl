...
# extracted from Fedora Security Advisory 2011-2540.
#
...
if (description)
{
  ...
  script_bugtraq_id(46658);
  script_xref(name:"FEDORA", value:"2011-2540");

  script_name(english:"Fedora 14 : libtiff-3.9.4-3.fc14 (2011-2540)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/055240.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7a7f0f5d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"libtiff-3.9.4-3.fc14")) flag++;
