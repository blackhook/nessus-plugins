...
# extracted from Fedora Security Advisory 2006-658.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-658");

  script_name(english:"Fedora Core 4 : spamassassin-3.0.6-1.fc4 (2006-658)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-June/000184.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f906aaf3"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC4", reference:"spamassassin-3.0.6-1.fc4")) flag++;
if (rpm_check(release:"FC4", reference:"spamassassin-debuginfo-3.0.6-1.fc4")) flag++;
