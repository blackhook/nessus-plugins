...
# extracted from Fedora Security Advisory 2014-11495.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11495");

  script_name(english:"Fedora 19 : nodejs-send-0.3.0-4.fc19 (2014-11495)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/139938.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?57bf6cc5"
  );
  # https://nodesecurity.io/advisories/send-directory-traversal
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC19", reference:"nodejs-send-0.3.0-4.fc19")) flag++;
