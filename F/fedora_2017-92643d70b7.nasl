...
# extracted from Fedora Security Advisory FEDORA-2017-92643d70b7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-92643d70b7");

  script_name(english:"Fedora 25 : knot-resolver (2017-92643d70b7)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-92643d70b7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"knot-resolver-1.3.1-1.fc25")) flag++;
