...
# extracted from Fedora Security Advisory 2010-17827.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : openssl-1.0.0b-1.fc14 (2010-17827)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-November/051170.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f066200f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"openssl-1.0.0b-1.fc14")) flag++;
