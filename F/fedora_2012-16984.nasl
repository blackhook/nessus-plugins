...
# extracted from Fedora Security Advisory 2012-16984.
#
...
if (description)
{
  ...
  script_bugtraq_id(56411);
  script_xref(name:"FEDORA", value:"2012-16984");

  script_name(english:"Fedora 18 : pcp-3.6.9-1.fc18 (2012-16984)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091982.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1a4c04b3"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"pcp-3.6.9-1.fc18")) flag++;
