...
# extracted from Fedora Security Advisory 2015-6558.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-6558");

  script_name(english:"Fedora 22 : mksh-50f-1.fc22 (2015-6558)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155970.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?11c4abf0"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"mksh-50f-1.fc22")) flag++;
