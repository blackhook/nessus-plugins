...
# extracted from Fedora Security Advisory 2011-16976.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-16976");

  script_name(english:"Fedora 15 : dhcp-4.2.1-14.P1.fc15 (2011-16976)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=761265"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-January/071549.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4c56bce8"
  );
...
flag = 0;
if (rpm_check(release:"FC15", reference:"dhcp-4.2.1-14.P1.fc15")) flag++;
