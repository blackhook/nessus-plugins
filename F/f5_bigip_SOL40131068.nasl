...
# extracted from F5 Networks BIG-IP Solution SOL40131068.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : GnuPG vulnerability (SOL40131068)");
...
(infinite recursion) via a crafted OpenPGP message."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K40131068"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Upgrade to one of the non-vulnerable versions listed in the F5
Solution SOL40131068."
  );
...
vmatrix["AFM"]["unaffected"] = make_list("11.5.0-11.6.1");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("12.0.0-12.1.0","11.4.0-11.4.1");
vmatrix["AM"]["unaffected"] = make_list("11.5.0-11.6.1");
...
vmatrix["LTM"]["unaffected"] = make_list("11.5.0-11.6.1");
