...
# extracted from Fedora Security Advisory FEDORA-2016-5c8dce58c9.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : mingw-libpng (2016-5c8dce58c9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-5c8dce58c9"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-libpng-1.6.27-1.fc25")) flag++;
