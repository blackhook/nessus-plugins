...
# extracted from Fedora Security Advisory FEDORA-2020-51637cf853.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : drupal8 (2020-51637cf853)");
  ...
  script_set_attribute(
    ...
    value:
"https://www.drupal.org/project/drupal/releases?version=8
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-51637cf853"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.drupal.org/project/drupal/releases?version=8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"drupal8-8.8.4-1.fc30")) flag++;
