...
# extracted from Fedora Security Advisory 2014-8351.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : cups-1.7.4-1.fc20 (2014-8351)");
  ...
  script_set_attribute(
    ...
    value:
"New upstream release which among others fixes one security flaw.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77315a36"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"cups-1.7.4-1.fc20")) flag++;
