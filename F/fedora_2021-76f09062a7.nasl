...
# extracted from Fedora Security Advisory FEDORA-2021-76f09062a7
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-76f09062a7");

  script_name(english:"Fedora 32 : 7:squid (2021-76f09062a7)");
...
FEDORA-2021-76f09062a7 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-76f09062a7");
...
pkgs = [
    {'reference':'squid-4.14-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
