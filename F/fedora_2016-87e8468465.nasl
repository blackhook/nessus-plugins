...
# extracted from Fedora Security Advisory FEDORA-2016-87e8468465.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : mingw-xerces-c (2016-87e8468465)");
  ...
  script_set_attribute(
    ...
    value:
"MinGW cross compiled xerces-c 3.1.4, fixing CVE-2016-0729,
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-87e8468465"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mingw-xerces-c-3.1.4-1.fc23")) flag++;
