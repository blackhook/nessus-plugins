...
# extracted from Fedora Security Advisory 2013-7999.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-7999");

  script_name(english:"Fedora 17 : tomcat-7.0.40-1.fc17 (2013-7999)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-May/105855.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?693abda5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"tomcat-7.0.40-1.fc17")) flag++;
