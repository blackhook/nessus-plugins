...
# extracted from Fedora Security Advisory FEDORA-2021-33a1b73e48
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-33a1b73e48");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Fedora 33 : batik (2021-33a1b73e48)");
...
FEDORA-2021-33a1b73e48 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-33a1b73e48");
...
pkgs = [
    {'reference':'batik-1.14-2.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
