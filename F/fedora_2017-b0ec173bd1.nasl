...
# extracted from Fedora Security Advisory FEDORA-2017-b0ec173bd1.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b0ec173bd1");

  script_name(english:"Fedora 26 : libsoup (2017-b0ec173bd1)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b0ec173bd1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"libsoup-2.58.2-1.fc26")) flag++;
