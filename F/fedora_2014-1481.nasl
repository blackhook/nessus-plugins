...
# extracted from Fedora Security Advisory 2014-1481.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1481");

  script_name(english:"Fedora 20 : mupdf-1.1-5.fc20 (2014-1481)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f0b76a5"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"mupdf-1.1-5.fc20")) flag++;
