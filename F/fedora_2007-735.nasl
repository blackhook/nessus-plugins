...
# extracted from Fedora Security Advisory 2007-735.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : tar-1.15.1-27.fc6 (2007-735)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004477.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a486ad5a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC6", reference:"tar-1.15.1-27.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"tar-debuginfo-1.15.1-27.fc6")) flag++;
