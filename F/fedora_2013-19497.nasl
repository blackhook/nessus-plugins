...
# extracted from Fedora Security Advisory 2013-19497.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : libuv-0.10.18-1.fc19 / nodejs-0.10.21-1.fc19 (2013-19497)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119775.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d183c91e"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-October/119776.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?029c16b9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"libuv-0.10.18-1.fc19")) flag++;
if (rpm_check(release:"FC19", reference:"nodejs-0.10.21-1.fc19")) flag++;
