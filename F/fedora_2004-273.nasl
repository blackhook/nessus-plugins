...
# extracted from Fedora Security Advisory 2004-273.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-273");

  script_name(english:"Fedora Core 2 : mc-4.6.0-17.fc2 (2004-273)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://bugzilla.redhat.com/bugzilla/show_bug.cgi?id=127973."
  );
  # https://lists.fedoraproject.org/pipermail/announce/2004-September/000275.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aa162af6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC2", reference:"mc-4.6.0-17.fc2")) flag++;
if (rpm_check(release:"FC2", reference:"mc-debuginfo-4.6.0-17.fc2")) flag++;
