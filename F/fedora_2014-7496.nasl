...
# extracted from Fedora Security Advisory 2014-7496.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-7496");

  script_name(english:"Fedora 19 : readline-6.2-8.fc19 (2014-7496)");
...
update fix it. Security patch for debug function
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/145720.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7898bbc6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"readline-6.2-8.fc19")) flag++;
