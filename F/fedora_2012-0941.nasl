...
# extracted from Fedora Security Advisory 2012-0941.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : bip-0.8.8-2.fc16 (2012-0941)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-February/072752.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b2c67c3a"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"bip-0.8.8-2.fc16")) flag++;
