...
# extracted from Fedora Security Advisory 2007-2969.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : mono-1.2.5.1-2.fc8 (2007-2969)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004586.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ac79a453"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"bytefx-data-mysql-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"ibm-data-db2-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-core-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-data-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-data-firebird-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-data-oracle-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-data-postgresql-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-data-sqlite-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-data-sybase-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-debuginfo-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-devel-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-extras-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-jscript-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-locale-extras-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-nunit-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-nunit-devel-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-web-1.2.5.1-2.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"mono-winforms-1.2.5.1-2.fc8")) flag++;
