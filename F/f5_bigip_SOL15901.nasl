...
# extracted from F5 Networks BIG-IP Solution SOL15901.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : Apache HTTP server vulnerability (SOL15901)");
...
properly handled during construction of a variant list."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15901"
  );
  script_set_attribute(
    attribute:"solution",
    value:
