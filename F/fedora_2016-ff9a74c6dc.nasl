...
# extracted from Fedora Security Advisory FEDORA-2016-ff9a74c6dc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-ff9a74c6dc");

  script_name(english:"Fedora 23 : drupal7 (2016-ff9a74c6dc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-ff9a74c6dc"
  );
  # https://www.drupal.org/SA-CORE-2016-005
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC23", reference:"drupal7-7.52-1.fc23")) flag++;
