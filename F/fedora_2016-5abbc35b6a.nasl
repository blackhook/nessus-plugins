...
# extracted from Fedora Security Advisory FEDORA-2016-5abbc35b6a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : eog (2016-5abbc35b6a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-5abbc35b6a"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"eog-3.20.4-1.fc24")) flag++;
