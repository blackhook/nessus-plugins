...
# extracted from Fedora Security Advisory FEDORA-2016-90836ca57d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : sudo (2016-90836ca57d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-90836ca57d"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"sudo-1.8.17p1-1.fc22")) flag++;
