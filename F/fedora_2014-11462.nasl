...
# extracted from Fedora Security Advisory 2014-11462.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-11462");

  script_name(english:"Fedora 20 : suricata-2.0.4-1.fc20 (2014-11462)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1146020"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-October/139821.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?682a17a6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"suricata-2.0.4-1.fc20")) flag++;
