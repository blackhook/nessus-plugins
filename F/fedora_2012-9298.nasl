...
# extracted from Fedora Security Advisory 2012-9298.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 17 : gd-2.0.35-17.fc17 (2012-9298)");
  ...
  script_set_attribute(
    ...
    value:
"This is an update, that fixes insufficient input validation in
_gdGetColors().
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=830745"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-June/083178.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05b398e5"
  );
...
flag = 0;
if (rpm_check(release:"FC17", reference:"gd-2.0.35-17.fc17")) flag++;
