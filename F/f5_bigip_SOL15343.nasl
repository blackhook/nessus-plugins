...
# extracted from F5 Networks BIG-IP Solution SOL15343.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : OpenSSL vulnerability (SOL15343)");
...
via a DTLS hello message in an invalid DTLS handshake."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15343"
  );
  script_set_attribute(
    attribute:"solution",
    value:
