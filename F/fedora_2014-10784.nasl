...
# extracted from Fedora Security Advisory 2014-10784.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-10784");

  script_name(english:"Fedora 19 : python-oauth2-1.5.211-7.fc19 (2014-10784)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-September/138695.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?951d772b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"python-oauth2-1.5.211-7.fc19")) flag++;
