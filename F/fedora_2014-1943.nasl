...
# extracted from Fedora Security Advisory 2014-1943.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1943");

  script_name(english:"Fedora 20 : chrony-1.29.1-1.fc20 (2014-1943)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4107350"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"chrony-1.29.1-1.fc20")) flag++;
