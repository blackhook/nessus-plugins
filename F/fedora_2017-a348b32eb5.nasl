...
# extracted from Fedora Security Advisory FEDORA-2017-a348b32eb5.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-a348b32eb5");

  script_name(english:"Fedora 25 : libgcrypt (2017-a348b32eb5)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-a348b32eb5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libgcrypt-1.7.8-1.fc25")) flag++;
