...
# extracted from Fedora Security Advisory FEDORA-2016-bb007a4097.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-bb007a4097");

  script_name(english:"Fedora 23 : openssh (2016-bb007a4097)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-bb007a4097"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"openssh-7.2p2-6.fc23")) flag++;
