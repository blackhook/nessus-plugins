...
# extracted from Fedora Security Advisory 2011-12204.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-12204");

  script_name(english:"Fedora 16 : nss-3.12.10-7.fc16 (2011-12204)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-September/065835.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a51b8905"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"nss-3.12.10-7.fc16")) flag++;
