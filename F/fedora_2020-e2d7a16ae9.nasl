...
# extracted from Fedora Security Advisory FEDORA-2020-e2d7a16ae9.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : mbedtls (2020-e2d7a16ae9)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-e2d7a16ae9"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/ARMmbed/mbedtls/releases/tag/v2.16.9"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"mbedtls-2.16.9-1.fc32")) flag++;
