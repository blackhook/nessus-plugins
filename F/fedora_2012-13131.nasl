...
# extracted from Fedora Security Advisory 2012-13131.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-13131");

  script_name(english:"Fedora 17 : java-1.7.0-openjdk-1.7.0.6-2.3.1.fc17.2 (2012-13131)");
...
it to bypass Java sandbox restrictions. (CVE-2012-4681)
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-September/085930.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?957b03d7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"java-1.7.0-openjdk-1.7.0.6-2.3.1.fc17.2")) flag++;
