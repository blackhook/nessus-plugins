...
# extracted from Fedora Security Advisory FEDORA-2016-50b0066b7f.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : ntp (2016-50b0066b7f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-50b0066b7f"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"ntp-4.2.6p5-41.fc24")) flag++;
