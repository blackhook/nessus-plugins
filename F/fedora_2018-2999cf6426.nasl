...
# extracted from Fedora Security Advisory FEDORA-2018-2999cf6426.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-2999cf6426");

  script_name(english:"Fedora 26 : postgresql (2018-2999cf6426)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-2999cf6426"
  );
  # https://www.postgresql.org/docs/9.6/static/release-9-6-8.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/9.6/release-9-6-8.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"postgresql-9.6.8-1.fc26")) flag++;
