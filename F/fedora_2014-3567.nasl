...
# extracted from Fedora Security Advisory 2014-3567.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-3567");

  script_name(english:"Fedora 19 : subversion-1.7.16-1.fc19 (2014-3567)");
...
1.7, fixing a security issue (CVE-2014-0032) :
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-March/130157.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c8f6a50"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC19", reference:"subversion-1.7.16-1.fc19")) flag++;
