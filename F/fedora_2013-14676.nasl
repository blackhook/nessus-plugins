...
# extracted from Fedora Security Advisory 2013-14676.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-14676");

  script_name(english:"Fedora 18 : putty-0.63-1.fc18 (2013-14676)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-August/114377.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?abc7b641"
  );
...
flag = 0;
if (rpm_check(release:"FC18", reference:"putty-0.63-1.fc18")) flag++;
