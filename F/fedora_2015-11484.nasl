...
# extracted from Fedora Security Advisory 2015-11484.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-11484");

  script_name(english:"Fedora 21 : bind-9.9.6-9.P1.fc21 (2015-11484)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?edebba71"
  );
...
flag = 0;
if (rpm_check(release:"FC21", reference:"bind-9.9.6-9.P1.fc21")) flag++;
