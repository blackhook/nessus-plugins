...
# extracted from Fedora Security Advisory FEDORA-2021-24fdc228e4
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-24fdc228e4");

  script_name(english:"Fedora 32 : rubygem-mechanize (2021-24fdc228e4)");
...
FEDORA-2021-24fdc228e4 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-24fdc228e4");
  script_set_attribute(attribute:"solution", value:
"Update the affected rubygem-mechanize package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:rubygem-mechanize");
...
pkgs = [
    {'reference':'rubygem-mechanize-2.7.7-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rubygem-mechanize');
}
