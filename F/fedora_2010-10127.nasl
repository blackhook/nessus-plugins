...
# extracted from Fedora Security Advisory 2010-10127.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 11 : drupal-cck-6.x.2.7-1.fc11 (2010-10127)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-June/043100.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7e3054bd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"drupal-cck-6.x.2.7-1.fc11")) flag++;
