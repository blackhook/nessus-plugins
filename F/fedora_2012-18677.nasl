...
# extracted from Fedora Security Advisory 2012-18677.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-18677");

  script_name(english:"Fedora 17 : libssh-0.5.3-1.fc17 (2012-18677)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/093467.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?af259324"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/093474.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?85bc07b9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"libssh-0.5.3-1.fc17")) flag++;
