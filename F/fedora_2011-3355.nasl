...
# extracted from Fedora Security Advisory 2011-3355.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3355");

  script_name(english:"Fedora 13 : postfix-2.7.3-1.fc13 (2011-3355)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d782652"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"postfix-2.7.3-1.fc13")) flag++;
