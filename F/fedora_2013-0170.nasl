...
# extracted from Fedora Security Advisory 2013-0170.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-0170");

  script_name(english:"Fedora 18 : drupal7-context-3.0-0.3.beta6.fc18 (2013-0170)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-January/096755.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?481ada1b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"drupal7-context-3.0-0.3.beta6.fc18")) flag++;
