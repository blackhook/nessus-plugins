...
# extracted from Fedora Security Advisory FEDORA-2020-dc41c28f86.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : thunderbird-enigmail (2020-dc41c28f86)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-dc41c28f86"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"thunderbird-enigmail-2.1.5-1.fc30", allowmaj:TRUE)) flag++;
