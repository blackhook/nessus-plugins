...
# extracted from Fedora Security Advisory 2010-15737.
#
...
if (description)
{
  ...
  script_bugtraq_id(42400);
  script_xref(name:"FEDORA", value:"2010-15737");

  script_name(english:"Fedora 12 : drupal-cck-6.x.2.8-1.fc12 (2010-15737)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://drupal.org/node/880736"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=639646"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/049247.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0d8c9a95"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"drupal-cck-6.x.2.8-1.fc12")) flag++;
