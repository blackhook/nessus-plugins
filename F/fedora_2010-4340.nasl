...
# extracted from Fedora Security Advisory 2010-4340.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2010-4340");

  script_name(english:"Fedora 13 : gnu-smalltalk-3.1-8.fc13 (2010-4340)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-March/037647.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?be0ae3ca"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"gnu-smalltalk-3.1-8.fc13")) flag++;
