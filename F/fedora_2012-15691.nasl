...
# extracted from Fedora Security Advisory 2012-15691.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-15691");

  script_name(english:"Fedora 18 : phpMyAdmin-3.5.3-1.fc18 (2012-15691)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/089954.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?41e57ef3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"phpMyAdmin-3.5.3-1.fc18")) flag++;
