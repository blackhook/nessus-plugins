...
# extracted from Fedora Security Advisory FEDORA-2019-8b0ad69829.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-8b0ad69829");
  script_xref(name:"IAVA", value:"2020-A-0203");

  script_name(english:"Fedora 31 : libssh (2019-8b0ad69829)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-8b0ad69829"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"libssh-0.9.3-1.fc31")) flag++;
