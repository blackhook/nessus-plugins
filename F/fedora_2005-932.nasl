...
# extracted from Fedora Security Advisory 2005-932.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-932");

  script_name(english:"Fedora Core 3 : mozilla-1.7.12-1.3.1 (2005-932)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-September/001419.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5b6b0253"
  );
...
flag = 0;
if (rpm_check(release:"FC3", reference:"mozilla-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-chat-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-debuginfo-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-devel-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-dom-inspector-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-js-debugger-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-mail-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-nspr-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-nspr-devel-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-nss-1.7.12-1.3.1")) flag++;
if (rpm_check(release:"FC3", reference:"mozilla-nss-devel-1.7.12-1.3.1")) flag++;
