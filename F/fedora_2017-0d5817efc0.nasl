...
# extracted from Fedora Security Advisory FEDORA-2017-0d5817efc0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-0d5817efc0");

  script_name(english:"Fedora 26 : mingw-postgresql (2017-0d5817efc0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0d5817efc0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-postgresql-9.6.3-1.fc26")) flag++;
