...
# extracted from Fedora Security Advisory 2016-0bcab055a7.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-0bcab055a7");

  script_name(english:"Fedora 24 : openssh-7.2p2-1.fc24 (2016-0bcab055a7)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f7c5253"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"openssh-7.2p2-1.fc24")) flag++;
