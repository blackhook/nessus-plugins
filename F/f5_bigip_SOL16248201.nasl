...
configured in a device group may fail over."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K16248201"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
vmatrix["AFM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["AFM"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# AM
vmatrix["AM"] = make_array();
vmatrix["AM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["AM"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# APM
vmatrix["APM"] = make_array();
vmatrix["APM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["APM"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# ASM
vmatrix["ASM"] = make_array();
vmatrix["ASM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["ASM"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# AVR
vmatrix["AVR"] = make_array();
vmatrix["AVR"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["AVR"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# GTM
vmatrix["GTM"] = make_array();
vmatrix["GTM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["GTM"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# LC
vmatrix["LC"] = make_array();
vmatrix["LC"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["LC"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# LTM
vmatrix["LTM"] = make_array();
vmatrix["LTM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["LTM"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# PEM
vmatrix["PEM"] = make_array();
vmatrix["PEM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
vmatrix["PEM"]["unaffected"] = make_list("14.1.0","14.0.0.3","13.1.1.2","12.1.3.7");

# WAM
vmatrix["WAM"] = make_array();
vmatrix["WAM"]["affected"  ] = make_list("14.0.0-14.0.0.2","13.1.1","13.1.0.4-13.1.0.8","12.1.3.4-12.1.3.6");
