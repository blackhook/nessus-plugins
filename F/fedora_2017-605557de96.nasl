...
# extracted from Fedora Security Advisory FEDORA-2017-605557de96.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : 1:java-1.8.0-openjdk (2017-605557de96)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-605557de96"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"java-1.8.0-openjdk-1.8.0.141-1.b16.fc24", epoch:"1")) flag++;
