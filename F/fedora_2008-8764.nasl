...
# extracted from Fedora Security Advisory 2008-8764.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 9 : dbus-1.2.4-1.fc9 (2008-8764)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=464674"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2008-October/015238.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f3c5ac84"
  );
...
flag = 0;
if (rpm_check(release:"FC9", reference:"dbus-1.2.4-1.fc9")) flag++;
