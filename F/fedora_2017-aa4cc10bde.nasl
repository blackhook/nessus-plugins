...
# extracted from Fedora Security Advisory FEDORA-2017-aa4cc10bde.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : qt5-qtbase (2017-aa4cc10bde)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-aa4cc10bde"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"qt5-qtbase-5.9.2-6.fc26")) flag++;
