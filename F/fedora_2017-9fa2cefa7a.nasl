...
# extracted from Fedora Security Advisory FEDORA-2017-9fa2cefa7a.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : mingw-poppler (2017-9fa2cefa7a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-9fa2cefa7a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"mingw-poppler-0.45.0-3.fc25")) flag++;
