...
# extracted from Fedora Security Advisory 2012-6273.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-6273");

  script_name(english:"Fedora 17 : openstack-nova-2012.1-2.fc17 (2012-6273)");
...
"  - Sync up with Essex stable branch
  ...
  - Provide a startup script for the separated metadata api
    service update to essex release
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=814275"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/079551.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dd2cb732"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"openstack-nova-2012.1-2.fc17")) flag++;
