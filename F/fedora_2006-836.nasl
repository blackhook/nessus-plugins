...
# extracted from Fedora Security Advisory 2006-836.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-836");

  script_name(english:"Fedora Core 4 : sendmail-8.13.7-2.fc4.1 (2006-836)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-July/000438.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?816fe4ad"
  );
...
flag = 0;
if (rpm_check(release:"FC4", reference:"sendmail-8.13.7-2.fc4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-cf-8.13.7-2.fc4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-debuginfo-8.13.7-2.fc4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-devel-8.13.7-2.fc4.1")) flag++;
if (rpm_check(release:"FC4", reference:"sendmail-doc-8.13.7-2.fc4.1")) flag++;
