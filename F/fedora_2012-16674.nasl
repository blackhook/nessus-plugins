...
# extracted from Fedora Security Advisory 2012-16674.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16674");

  script_name(english:"Fedora 17 : viewvc-1.1.17-1.fc17 (2012-16674)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-November/091067.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9dcb85b0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"viewvc-1.1.17-1.fc17")) flag++;
