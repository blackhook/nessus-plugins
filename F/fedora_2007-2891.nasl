...
# extracted from Fedora Security Advisory 2007-2891.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 8 : xscreensaver-5.03-14.fc8 (2007-2891)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-November/004547.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?556d67e3"
  );
...
flag = 0;
if (rpm_check(release:"FC8", reference:"xscreensaver-5.03-14.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"xscreensaver-base-5.03-14.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"xscreensaver-debuginfo-5.03-14.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"xscreensaver-extras-5.03-14.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"xscreensaver-extras-gss-5.03-14.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"xscreensaver-gl-base-5.03-14.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"xscreensaver-gl-extras-5.03-14.fc8")) flag++;
if (rpm_check(release:"FC8", reference:"xscreensaver-gl-extras-gss-5.03-14.fc8")) flag++;
