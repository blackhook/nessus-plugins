...
# extracted from Fedora Security Advisory 2015-9025.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : php-symfony-2.5.12-1.fc20 (2015-9025)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf42836e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"php-symfony-2.5.12-1.fc20")) flag++;
