...
# extracted from Fedora Security Advisory FEDORA-2016-07eca37ea0.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-07eca37ea0");

  script_name(english:"Fedora 23 : 2:qemu (2016-07eca37ea0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-07eca37ea0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"qemu-2.4.1-10.fc23", epoch:"2")) flag++;
