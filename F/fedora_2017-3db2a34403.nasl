...
# extracted from Fedora Security Advisory FEDORA-2017-3db2a34403.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-3db2a34403");

  script_name(english:"Fedora 24 : cacti (2017-3db2a34403)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3db2a34403"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"cacti-1.1.12-2.fc24")) flag++;
