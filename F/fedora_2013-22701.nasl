...
# extracted from Fedora Security Advisory 2013-22701.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-22701");

  script_name(english:"Fedora 20 : gimp-2.8.10-4.fc20 (2013-22701)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-December/123547.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c7057a71"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"gimp-2.8.10-4.fc20")) flag++;
