...
# extracted from Fedora Security Advisory FEDORA-2020-da859aadde.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : calamares / kde-partitionmanager / kpmcore (2020-da859aadde)");
...
This update also fixes a not yet disclosed CVE.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-da859aadde"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"FC32", reference:"calamares-3.2.11-14.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"kde-partitionmanager-4.2.0-1.fc32")) flag++;
if (rpm_check(release:"FC32", reference:"kpmcore-4.2.0-1.fc32")) flag++;
