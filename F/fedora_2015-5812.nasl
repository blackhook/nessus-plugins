...
# extracted from Fedora Security Advisory 2015-5812.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5812");

  script_name(english:"Fedora 20 : knot-1.6.3-1.fc20 (2015-5812)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/154726.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6b81e6f8"
  );
...
flag = 0;
if (rpm_check(release:"FC20", reference:"knot-1.6.3-1.fc20")) flag++;
