...
# extracted from Fedora Security Advisory 2014-4962.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-4962");

  script_name(english:"Fedora 20 : systemd-208-16.fc20 (2014-4962)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1084286"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-April/131370.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f4aea7ab"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"systemd-208-16.fc20")) flag++;
