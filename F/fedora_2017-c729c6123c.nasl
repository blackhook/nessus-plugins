...
# extracted from Fedora Security Advisory FEDORA-2017-c729c6123c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-c729c6123c");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/04/20");

  script_name(english:"Fedora 26 : 2:samba (2017-c729c6123c) (SambaCry)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-c729c6123c");
...
flag = 0;
if (rpm_check(release:"FC26", reference:"samba-4.6.4-0.fc26", epoch:"2")) flag++;
