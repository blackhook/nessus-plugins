...
# extracted from Fedora Security Advisory 2009-8565.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8565");

  script_name(english:"Fedora 11 : gnutls-2.6.6-3.fc11 (2009-8565)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-September/029464.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?254e8112"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"gnutls-2.6.6-3.fc11")) flag++;
