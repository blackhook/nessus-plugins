...
# extracted from F5 Networks BIG-IP Solution SOL15863.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2012-1173", "CVE-2012-2088");
  script_bugtraq_id(52891, 54270);

  script_name(english:"F5 Networks BIG-IP : Libtiff vulnerabilities (SOL15863)");
  ...
  script_set_attribute(attribute:"description", value:"CVE-2012-1173");
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15863"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
