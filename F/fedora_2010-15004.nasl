...
# extracted from Fedora Security Advisory 2010-15004.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : php-pecl-apc-3.1.4-2.fc12 (2010-15004)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=634334"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-September/048630.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2b5a281"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC12", reference:"php-pecl-apc-3.1.4-2.fc12")) flag++;
