...
# extracted from F5 Networks BIG-IP Solution K39512927.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-7928", "CVE-2016-7929", "CVE-2016-7930", "CVE-2016-7931", "CVE-2016-7933");

  script_name(english:"F5 Networks BIG-IP : tcpdump vulnerabilities (K39512927)");
...
CVE-2016-7929 The Juniper PPPoE ATM parser in tcpdump before 4.9.0 has
a buffer overflow in print-juniper.c:juniper_parse_header().

CVE-2016-7930 The LLC/SNAP parser in tcpdump before 4.9.0 has a buffer
overflow in print-llc.c:llc_print().

CVE-2016-7931 The MPLS parser in tcpdump before 4.9.0 has a buffer
overflow in print-mpls.c:mpls_print().

CVE-2016-7933 The PPP parser in tcpdump before 4.9.0 has a buffer
overflow in print-ppp.c:ppp_hdlc_if_print()."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K39512927"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
