...
# extracted from Fedora Security Advisory 2007-4163.
#
...
if (description)
{
  ...
  script_bugtraq_id(26735);
  script_xref(name:"FEDORA", value:"2007-4163");

  script_name(english:"Fedora 8 : drupal-5.4-1.fc8 (2007-4163)");
  ...
  script_set_attribute(
    ...
    value:
"5.4, fixes a few security issues, as well as a README update.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=254228"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-December/005720.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23af124b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC8", reference:"drupal-5.4-1.fc8")) flag++;
