...
# extracted from Fedora Security Advisory FEDORA-2019-006dfc94cd.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 30 : exim (2019-006dfc94cd)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-006dfc94cd"
  );
...
flag = 0;
if (rpm_check(release:"FC30", reference:"exim-4.92.3-1.fc30")) flag++;
