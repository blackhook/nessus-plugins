...
# extracted from Fedora Security Advisory 2004-153.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2004-153");

  script_name(english:"Fedora Core 2 : ethereal-0.10.3-2.1 (2004-153)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2004-June/000149.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8bfaa622"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC2", reference:"ethereal-0.10.3-2.1")) flag++;
if (rpm_check(release:"FC2", reference:"ethereal-debuginfo-0.10.3-2.1")) flag++;
if (rpm_check(release:"FC2", reference:"ethereal-gnome-0.10.3-2.1")) flag++;
