...
# extracted from Fedora Security Advisory FEDORA-2018-928e15e1db.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-928e15e1db");

  script_name(english:"Fedora 28 : roundcubemail (2018-928e15e1db)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-928e15e1db"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC28", reference:"roundcubemail-1.3.8-1.fc28")) flag++;
