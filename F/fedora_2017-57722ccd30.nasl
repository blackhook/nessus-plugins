...
# extracted from Fedora Security Advisory FEDORA-2017-57722ccd30.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : libidn2 (2017-57722ccd30)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-57722ccd30"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"libidn2-2.0.4-1.fc25")) flag++;
