...
# extracted from Fedora Security Advisory FEDORA-2016-894abe29d2.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : systemd (2016-894abe29d2)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-894abe29d2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"systemd-231-6.fc25")) flag++;
