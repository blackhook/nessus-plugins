...
# extracted from Fedora Security Advisory FEDORA-2018-6855bf9ff3.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 28 : php (2018-6855bf9ff3)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-6855bf9ff3"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"php-7.2.12-1.fc28")) flag++;
