...
# extracted from Fedora Security Advisory 2009-6166.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6166");

  script_name(english:"Fedora 11 : webkitgtk-1.1.8-1.fc11 (2009-6166)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://svn.webkit.org/repository/webkit/trunk/WebKit/gtk/NEWS"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=443048"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=484335"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=502673"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-July/026232.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?81703ee6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC11", reference:"webkitgtk-1.1.8-1.fc11")) flag++;
