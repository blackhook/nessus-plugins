...
# extracted from Fedora Security Advisory FEDORA-2021-77a4202036
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : dotnet3.1 (2021-77a4202036)");
...
FEDORA-2021-77a4202036 advisory.

  - ASP.NET Core and Visual Studio Denial of Service Vulnerability (CVE-2021-1723)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-77a4202036");
...
pkgs = [
    {'reference':'dotnet3.1-3.1.111-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
