...
# extracted from Fedora Security Advisory FEDORA-2020-83d03bdb76.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-83d03bdb76");

  script_name(english:"Fedora 31 : crun (2020-83d03bdb76)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-83d03bdb76"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected crun package.");
...
flag = 0;
if (rpm_check(release:"FC31", reference:"crun-0.15-2.fc31")) flag++;
