...
# extracted from Fedora Security Advisory 2012-16346.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-16346");

  script_name(english:"Fedora 17 : java-1.7.0-openjdk-1.7.0.9-2.3.3.fc17 (2012-16346)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090183.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0471634d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"java-1.7.0-openjdk-1.7.0.9-2.3.3.fc17")) flag++;
