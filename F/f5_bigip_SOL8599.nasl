...
# extracted from F5 Networks BIG-IP Solution SOL8599.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : XSS vulnerability viewing logs from the Console section of the web management interface (SOL8599)");
...
advisory."
  ...
  # http://www.securityfocus.com/archive/1/489290
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/archive/1/489290"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K8599"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
