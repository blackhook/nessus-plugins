...
# extracted from Fedora Security Advisory 2011-5151.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-5151");

  script_name(english:"Fedora 13 : fail2ban-0.8.4-27.fc13 (2011-5151)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-April/058872.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?45800e4f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"fail2ban-0.8.4-27.fc13")) flag++;
