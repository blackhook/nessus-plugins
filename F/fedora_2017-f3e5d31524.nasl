...
# extracted from Fedora Security Advisory FEDORA-2017-f3e5d31524.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-f3e5d31524");

  script_name(english:"Fedora 27 : libXfont (2017-f3e5d31524)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-f3e5d31524"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"libXfont-1.5.2-5.fc27")) flag++;
