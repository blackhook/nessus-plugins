...
# extracted from Fedora Security Advisory FEDORA-2016-4cedbd4308.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 23 : mongodb (2016-4cedbd4308)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-4cedbd4308"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"mongodb-3.0.12-2.fc23")) flag++;
