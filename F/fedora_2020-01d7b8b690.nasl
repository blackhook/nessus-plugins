...
# extracted from Fedora Security Advisory FEDORA-2020-01d7b8b690.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : php-horde-horde (2020-01d7b8b690)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-01d7b8b690"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"php-horde-horde-5.2.23-1.fc31")) flag++;
