...
# extracted from Fedora Security Advisory FEDORA-2017-63f99b3977.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-63f99b3977");

  script_name(english:"Fedora 26 : drupal7-views (2017-63f99b3977)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-63f99b3977"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC26", reference:"drupal7-views-3.18-1.fc26")) flag++;
