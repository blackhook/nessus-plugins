...
# extracted from Fedora Security Advisory FEDORA-2016-b1a36cccc8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-b1a36cccc8");

  script_name(english:"Fedora 23 : 389-ds-base (2016-b1a36cccc8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-b1a36cccc8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC23", reference:"389-ds-base-1.3.4.14-1.fc23")) flag++;
