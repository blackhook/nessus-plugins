...
# extracted from Fedora Security Advisory 2014-17278.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-17278");

  script_name(english:"Fedora 21 : mediawiki-1.24.1-1.fc21 (2014-17278)");
...
"  - (bug T76686) [SECURITY] thumb.php outputs wikitext
    ...
    of entries in RELEASE-NOTES-1.24.\r\n* (bug T76168)
    OutputPage: Add accessors for some protected
    properties.\r\n* (bug T74834) Make 1.24 branch directly
    installable under PostgreSQL.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-December/147136.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?650abdc4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"mediawiki-1.24.1-1.fc21")) flag++;
