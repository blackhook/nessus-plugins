...
# extracted from Fedora Security Advisory 2011-7559.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7559");

  script_name(english:"Fedora 15 : drupal6-6.22-1.fc15 (2011-7559)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061132.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6c2c0f6f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"drupal6-6.22-1.fc15")) flag++;
