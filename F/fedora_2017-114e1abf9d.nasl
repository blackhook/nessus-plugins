...
# extracted from Fedora Security Advisory FEDORA-2017-114e1abf9d.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-114e1abf9d");

  script_name(english:"Fedora 26 : irssi (2017-114e1abf9d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-114e1abf9d"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"irssi-1.0.4-1.fc26")) flag++;
