...
# extracted from Fedora Security Advisory 2006-1464.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1464");

  script_name(english:"Fedora Core 5 : dbus-0.62-0.2.fc5 (2006-1464)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-December/001129.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?12c3b76e"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fedoraproject:fedora:dbus-sharp");
...
flag = 0;
if (rpm_check(release:"FC5", reference:"dbus-0.62-0.2.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"dbus-debuginfo-0.62-0.2.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"dbus-devel-0.62-0.2.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"dbus-glib-0.62-0.2.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"dbus-python-0.62-0.2.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"dbus-sharp-0.62-0.2.fc5")) flag++;
if (rpm_check(release:"FC5", reference:"dbus-x11-0.62-0.2.fc5")) flag++;
