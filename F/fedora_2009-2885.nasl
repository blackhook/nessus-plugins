...
# extracted from Fedora Security Advisory 2009-2885.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2885");

  script_name(english:"Fedora 10 : ghostscript-8.63-5.fc10 (2009-2885)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021565.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?52579040"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"ghostscript-8.63-5.fc10")) flag++;
