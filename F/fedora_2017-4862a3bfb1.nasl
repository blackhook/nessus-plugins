...
# extracted from Fedora Security Advisory FEDORA-2017-4862a3bfb1.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 26 : openssh (2017-4862a3bfb1)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2017-15906: Improper write operations in readonly
mode
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4862a3bfb1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"openssh-7.5p1-4.fc26")) flag++;
