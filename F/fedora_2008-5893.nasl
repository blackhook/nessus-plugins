...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=linux-netdev&m=121304710526613&w=2"
  );
  # http://marc.info/?l=linux-netdev&m=121346686508160&w=2
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=linux-netdev&m=121346686508160&w=2"
  );
  # http://marc.info/?l=linux-wireless&m=121459423021061&w=2
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=linux-wireless&m=121459423021061&w=2"
  );
  # http://www.kernel.org/pub/linux/kernel/v2.6/ChangeLog-2.6.25.7
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a720b12"
  );
  # http://www.kernel.org/pub/linux/kernel/v2.6/ChangeLog-2.6.25.8
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ee81a5c5"
  );
  # http://www.kernel.org/pub/linux/kernel/v2.6/ChangeLog-2.6.25.9
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fbad01f9"
  );
  script_set_attribute(
    attribute:"see_also",
