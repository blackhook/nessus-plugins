...
# extracted from Fedora Security Advisory 2015-345966871c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-345966871c");

  script_name(english:"Fedora 22 : phpMyAdmin-4.5.3.1-1.fc22 (2015-345966871c)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-December/174750.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e882949c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"phpMyAdmin-4.5.3.1-1.fc22")) flag++;
