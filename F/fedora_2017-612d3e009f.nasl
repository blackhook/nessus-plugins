...
# extracted from Fedora Security Advisory FEDORA-2017-612d3e009f.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-612d3e009f");

  script_name(english:"Fedora 27 : moodle (2017-612d3e009f)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-612d3e009f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC27", reference:"moodle-3.3.3-1.fc27")) flag++;
