...
# extracted from Fedora Security Advisory FEDORA-2016-15cf686c8d.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 25 : 2:docker (2016-15cf686c8d)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-15cf686c8d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"docker-1.12.3-6.git9a594b9.fc25", epoch:"2")) flag++;
