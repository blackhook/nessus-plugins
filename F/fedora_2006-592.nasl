...
# extracted from Fedora Security Advisory 2006-592.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-592");

  script_name(english:"Fedora Core 5 : libtiff-3.7.4-6 (2006-592)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-May/000128.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7904b30"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC5", reference:"libtiff-3.7.4-6")) flag++;
if (rpm_check(release:"FC5", reference:"libtiff-debuginfo-3.7.4-6")) flag++;
if (rpm_check(release:"FC5", reference:"libtiff-devel-3.7.4-6")) flag++;
