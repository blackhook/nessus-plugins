...
# extracted from Fedora Security Advisory 2011-3945.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3945");

  script_name(english:"Fedora 13 : asterisk-1.6.2.17.2-1.fc13 (2011-3945)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://downloads.asterisk.org/pub/security/AST-2011-003.pdf"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://downloads.asterisk.org/pub/security/AST-2011-004.pdf"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f0701a5c"
  );
  # http://downloads.asterisk.org/pub/telephony/asterisk/releases/ChangeLog-1.6.2.17.2
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?30c4b6d0"
  );
  # http://downloads.asterisk.org/pub/telephony/asterisk/releases/ChangeLog-1.8.3.2
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e486547a"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=688675"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=688678"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/057156.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ecb83518"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"asterisk-1.6.2.17.2-1.fc13")) flag++;
