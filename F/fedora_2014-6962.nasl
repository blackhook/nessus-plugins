...
# extracted from Fedora Security Advisory 2014-6962.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 19 : mediawiki-1.21.10-1.fc19 (2014-6962)");
  ...
  script_set_attribute(
    ...
    value:
"  - (bug 65501) SECURITY: Don't parse usernames as wikitext
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-June/134032.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76398b2e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"mediawiki-1.21.10-1.fc19")) flag++;
