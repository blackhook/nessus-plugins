...
# extracted from Fedora Security Advisory FEDORA-2017-7a9447c0af.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-7a9447c0af");

  script_name(english:"Fedora 26 : pure-ftpd (2017-7a9447c0af)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-7a9447c0af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"pure-ftpd-1.0.46-2.fc26")) flag++;
