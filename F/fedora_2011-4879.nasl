...
# extracted from Fedora Security Advisory 2011-4879.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 13 : xorg-x11-server-utils-7.4-17.fc13 (2011-4879)");
  ...
  script_set_attribute(
    ...
    value:
"Fix CVE-2011-0465 root hole with rogue hostnames via xrdb
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061390.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9feb27cf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"xorg-x11-server-utils-7.4-17.fc13")) flag++;
