...
# extracted from Fedora Security Advisory 2011-3738.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-3738");

  script_name(english:"Fedora 13 : wordpress-3.1-1.fc13 (2011-3738)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-March/056998.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b24f5a34"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"wordpress-3.1-1.fc13")) flag++;
