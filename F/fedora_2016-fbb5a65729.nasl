...
# extracted from Fedora Security Advisory FEDORA-2016-fbb5a65729.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : squidGuard (2016-fbb5a65729)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-fbb5a65729"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"squidGuard-1.4-26.fc22")) flag++;
