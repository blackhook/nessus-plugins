...
# extracted from Fedora Security Advisory FEDORA-2019-4175e7cb56.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 31 : nspr / nss (2019-4175e7cb56)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-4175e7cb56"
  );
  # https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/NSS_3.47_release_notes
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c64cd31e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC31", reference:"nspr-4.23.0-1.fc31")) flag++;
if (rpm_check(release:"FC31", reference:"nss-3.47.0-2.fc31")) flag++;
