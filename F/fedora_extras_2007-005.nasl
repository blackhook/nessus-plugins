...
if (description)
{
  ...
  script_name(english:"Fedora Extras : mediawiki-1.8.3-7 (2007-005)");
...
There is no danger in the default configuration, with $wgUseAjax off.
  ...
  - Tue Jan 9 2007 Axel Thimm <Axel.Thimm at ATrpms.net> -
    1.8.3-7

    - Update to 1.8.3.

    - Update fixes an XSS injection vulnerability in the
      AJAX module.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-January/001226.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5ba13f5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC5", reference:"mediawiki-1.8.3-7")) flag++;

if (rpm_check(release:"FC6", reference:"mediawiki-1.8.3-7")) flag++;
