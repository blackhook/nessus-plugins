...
# extracted from Fedora Security Advisory FEDORA-2017-376ae2b92c.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-376ae2b92c");

  script_name(english:"Fedora 25 : 1:tomcat (2017-376ae2b92c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-376ae2b92c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"tomcat-8.0.41-1.fc25", epoch:"1")) flag++;
