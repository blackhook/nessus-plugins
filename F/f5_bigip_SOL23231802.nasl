...
if (description)
{
  script_id(160395);
  script_version("1.2");
  script_set_attribute(attribute:"plugin_modification_date", value:"2022/05/01");
...
a vulnerability as referenced in the K23231802 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://support.f5.com/csp/article/K23231802");
