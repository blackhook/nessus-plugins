...
# extracted from Fedora Security Advisory FEDORA-2017-1a7b8c0730.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-1a7b8c0730");

  script_name(english:"Fedora 25 : pcsc-lite (2017-1a7b8c0730)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-1a7b8c0730"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC25", reference:"pcsc-lite-1.8.20-1.fc25")) flag++;
