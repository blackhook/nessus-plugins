...
# extracted from Fedora Security Advisory 2016-1323b9078a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-1323b9078a");

  script_name(english:"Fedora 22 : bind99-9.9.8-2.P3.fc22 (2016-1323b9078a)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cffca436"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"bind99-9.9.8-2.P3.fc22")) flag++;
