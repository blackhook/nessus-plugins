...
# extracted from Fedora Security Advisory FEDORA-2018-0c75cc72bc.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-0c75cc72bc");

  script_name(english:"Fedora 26 : python-crypto (2018-0c75cc72bc)");
...
This update includes a fix for this problem backported from
pycryptodome.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-0c75cc72bc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"python-crypto-2.6.1-22.fc26")) flag++;
