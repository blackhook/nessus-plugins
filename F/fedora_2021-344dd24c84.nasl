...
# extracted from Fedora Security Advisory FEDORA-2021-344dd24c84
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-344dd24c84");

  script_name(english:"Fedora 32 : pki-core (2021-344dd24c84)");
...
FEDORA-2021-344dd24c84 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-344dd24c84");
...
pkgs = [
    {'reference':'pki-core-10.10.5-5.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
