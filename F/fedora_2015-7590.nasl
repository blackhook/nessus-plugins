...
# extracted from Fedora Security Advisory 2015-7590.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-7590");

  script_name(english:"Fedora 21 : libssh-0.6.5-1.fc21 (2015-7590)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2e24d2c2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"libssh-0.6.5-1.fc21")) flag++;
