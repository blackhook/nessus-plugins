...
# extracted from Fedora Security Advisory 2009-6273.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-6273");

  script_name(english:"Fedora 10 : icu-4.0-3.1.fc10 (2009-6273)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=503071"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-June/024859.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5010b66a"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"icu-4.0-3.1.fc10")) flag++;
