...
# extracted from Fedora Security Advisory FEDORA-2017-efbe206b58.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-efbe206b58");

  script_name(english:"Fedora 26 : 12:dhcp (2017-efbe206b58)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-efbe206b58"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected 12:dhcp package."
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"dhcp-4.3.5-10.fc26", epoch:"12")) flag++;
