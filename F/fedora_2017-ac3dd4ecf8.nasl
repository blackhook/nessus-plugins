...
# extracted from Fedora Security Advisory FEDORA-2017-ac3dd4ecf8.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ac3dd4ecf8");

  script_name(english:"Fedora 27 : gd (2017-ac3dd4ecf8)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ac3dd4ecf8"
  );
...
flag = 0;
if (rpm_check(release:"FC27", reference:"gd-2.2.5-1.fc27")) flag++;
