...
# extracted from Fedora Security Advisory 2016-5a141de5d9.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-5a141de5d9");

  script_name(english:"Fedora 22 : mingw-curl-7.47.0-1.fc22 (2016-5a141de5d9)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1302264"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-February/177383.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ec060a7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC22", reference:"mingw-curl-7.47.0-1.fc22")) flag++;
