...
# extracted from Fedora Security Advisory 2014-12591.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-12591");

  script_name(english:"Fedora 21 : bugzilla-4.4.6-1.fc21 (2014-12591)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2014-November/142524.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b2d9939f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC21", reference:"bugzilla-4.4.6-1.fc21")) flag++;
