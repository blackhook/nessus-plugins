...
# extracted from Fedora Security Advisory FEDORA-2017-0f44f2b8c8.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : 3:mariadb (2017-0f44f2b8c8)");
...
"Important change :
  ...
  - most of the utilities were move to the new sub-package
    'server-utils'

Other enhancements: (see changelog)

  - CVE fixes, SPECfile fixes, patches revision, tests
    blacklist revisions

  - Preparation and testing of the Cracklib plugin to be
    added
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-0f44f2b8c8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mariadb-10.1.21-1.fc24", epoch:"3")) flag++;
