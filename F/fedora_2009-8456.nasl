...
# extracted from Fedora Security Advisory 2009-8456.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-8456");

  script_name(english:"Fedora 10 : xmlsec1-1.2.12-1.fc10 (2009-8456)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-August/027764.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d99d064b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC10", reference:"xmlsec1-1.2.12-1.fc10")) flag++;
