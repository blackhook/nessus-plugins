...
# extracted from Fedora Security Advisory FEDORA-2017-e9936d561b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-e9936d561b");

  script_name(english:"Fedora 26 : lxterminal / menu-cache / pcmanfm (2017-e9936d561b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-e9936d561b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"lxterminal-0.3.0-3.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"menu-cache-1.0.2-4.D20170514git56f6668459.fc26")) flag++;
if (rpm_check(release:"FC26", reference:"pcmanfm-1.2.5-2.fc26")) flag++;
