...
# extracted from Fedora Security Advisory FEDORA-2020-77b758d6dc.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : 1:libuv (2020-77b758d6dc)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-77b758d6dc"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"libuv-1.40.0-1.fc32", epoch:"1")) flag++;
