...
# extracted from Fedora Security Advisory FEDORA-2016-fe9112a9ff.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : sudo (2016-fe9112a9ff)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-fe9112a9ff"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"sudo-1.8.15-2.fc22")) flag++;
