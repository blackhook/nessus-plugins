...
# extracted from Fedora Security Advisory 2015-5786.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2015-5786");

  script_name(english:"Fedora 22 : knot-1.6.3-1.fc22 (2015-5786)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-April/155415.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80207c26"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"knot-1.6.3-1.fc22")) flag++;
