...
# extracted from Fedora Security Advisory 2012-14279.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-14279");

  script_name(english:"Fedora 18 : phpldapadmin-1.2.2-3.gitbbedf1.fc18 (2012-14279)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?51c1d6d9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC18", reference:"phpldapadmin-1.2.2-3.gitbbedf1.fc18")) flag++;
