...
# extracted from Fedora Security Advisory 2012-6704.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2012-1183", "CVE-2012-1184", "CVE-2012-2414", "CVE-2012-2415", "CVE-2012-2416");
  script_bugtraq_id(52523, 52815, 53205, 53206, 53210);
  script_xref(name:"FEDORA", value:"2012-6704");

  script_name(english:"Fedora 17 : asterisk-10.3.1-1.fc17 (2012-6704)");
...
Update to 1.8.11.0 Update to 1.8.10.1, which fixes 2 security
vulnerabilities.
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-May/079781.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f242e2f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC17", reference:"asterisk-10.3.1-1.fc17")) flag++;
