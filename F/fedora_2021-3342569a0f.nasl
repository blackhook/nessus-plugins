...
# extracted from Fedora Security Advisory FEDORA-2021-3342569a0f
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : PyYAML (2021-3342569a0f)");
...
FEDORA-2021-3342569a0f advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-3342569a0f");
...
pkgs = [
    {'reference':'PyYAML-5.4.1-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
