...
# extracted from Fedora Security Advisory 2010-15135.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 14 : seamonkey-2.0.8-1.fc14 (2010-15135)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.seamonkey-project.org/releases/seamonkey2.0.6/"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/049002.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d74d6d45"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC14", reference:"seamonkey-2.0.8-1.fc14")) flag++;
