...
# extracted from Fedora Security Advisory 2006-1055.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2006-1055");

  script_name(english:"Fedora Core 6 : qt-3.3.7-0.1.fc6 (2006-1055)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2006-October/000689.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?19458ea1"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"qt-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-MySQL-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-ODBC-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-PostgreSQL-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-config-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-debuginfo-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-designer-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-devel-3.3.7-0.1.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"qt-devel-docs-3.3.7-0.1.fc6")) flag++;
