...
# extracted from Fedora Security Advisory FEDORA-2021-ae5a54ba78
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2021-ae5a54ba78");

  script_name(english:"Fedora 32 : php (2021-ae5a54ba78)");
...
FEDORA-2021-ae5a54ba78 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-ae5a54ba78");
...
pkgs = [
    {'reference':'php-7.4.15-1.fc32', 'release':'FC32', 'rpm_spec_vers_cmp':TRUE}
];
