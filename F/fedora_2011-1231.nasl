...
# extracted from Fedora Security Advisory 2011-1231.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-1231");

  script_name(english:"Fedora 13 : java-1.6.0-openjdk-1.6.0.0-50.1.8.6.fc13 (2011-1231)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-February/053926.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a1cc58af"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC13", reference:"java-1.6.0-openjdk-1.6.0.0-50.1.8.6.fc13")) flag++;
