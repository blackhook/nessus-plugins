...
HTTP/2 profile."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K07369970"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["GTM"]["affected"  ] = make_list("13.0.0");
vmatrix["GTM"]["unaffected"] = make_list("13.1.0","13.0.1","12.1.3.2");
...
vmatrix["WAM"]["affected"  ] = make_list("13.0.0");
vmatrix["WAM"]["unaffected"] = make_list("13.1.0","13.0.1","12.1.3.2");
