...
# extracted from Fedora Security Advisory 2013-20937.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2013-20937");

  script_name(english:"Fedora 20 : wireshark-1.10.3-3.fc20 (2013-20937)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-November/121582.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9e6f8cf1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"wireshark-1.10.3-3.fc20")) flag++;
