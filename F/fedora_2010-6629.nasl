...
# extracted from Fedora Security Advisory 2010-6629.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : irssi-0.8.15-1.fc12 (2010-6629)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-May/041054.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?478b27e9"
  );
...
flag = 0;
if (rpm_check(release:"FC12", reference:"irssi-0.8.15-1.fc12")) flag++;
