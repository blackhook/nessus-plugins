...
# extracted from Fedora Security Advisory 2014-1770.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2014-1770");

  script_name(english:"Fedora 20 : libpng12-1.2.50-6.fc20 (2014-1770)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60a59dd2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libpng12-1.2.50-6.fc20")) flag++;
