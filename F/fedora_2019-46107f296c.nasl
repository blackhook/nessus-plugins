...
# extracted from Fedora Security Advisory FEDORA-2019-46107f296c.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : drupal8 / php-typo3-phar-stream-wrapper2 (2019-46107f296c)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-46107f296c"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC29", reference:"drupal8-8.6.10-1.fc29")) flag++;
if (rpm_check(release:"FC29", reference:"php-typo3-phar-stream-wrapper2-2.0.1-1.fc29")) flag++;
