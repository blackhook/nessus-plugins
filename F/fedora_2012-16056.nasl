...
# extracted from Fedora Security Advisory 2012-16056.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 16 : haproxy-1.4.22-1.fc16 (2012-16056)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-October/090578.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad1b70a8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC16", reference:"haproxy-1.4.22-1.fc16")) flag++;
