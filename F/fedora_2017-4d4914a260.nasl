...
# extracted from Fedora Security Advisory FEDORA-2017-4d4914a260.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-4d4914a260");

  script_name(english:"Fedora 26 : mingw-libzip (2017-4d4914a260)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-4d4914a260"
  );
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mingw-libzip-1.3.0-1.fc26")) flag++;
