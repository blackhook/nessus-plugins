...
# extracted from Fedora Security Advisory 2010-16641.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 12 : glibc-2.11.2-3 (2010-16641)");
  ...
  script_set_attribute(
    ...
    value:
"  - Correct x86 CPU family and model check (BZ#11640,
    #596554)
    ...
    - Require suid bit on audit objects in privileged
      programs (CVE-2010-3856)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=645672"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2010-October/050175.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?db83ce86"
  );
...
flag = 0;
if (rpm_check(release:"FC12", reference:"glibc-2.11.2-3")) flag++;
