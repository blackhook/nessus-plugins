...
# extracted from Fedora Security Advisory FEDORA-2019-0c1be924df.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-0c1be924df");

  script_name(english:"Fedora 28 : gvfs (2019-0c1be924df)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-0c1be924df"
  );
...
flag = 0;
if (rpm_check(release:"FC28", reference:"gvfs-1.36.2-3.fc28")) flag++;
