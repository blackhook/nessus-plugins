...
# extracted from Fedora Security Advisory 2005-255.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-255");

  script_name(english:"Fedora Core 3 : evolution-2.0.4-2 (2005-255)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-March/000798.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f43f7c3a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC3", reference:"evolution-2.0.4-2")) flag++;
if (rpm_check(release:"FC3", reference:"evolution-debuginfo-2.0.4-2")) flag++;
if (rpm_check(release:"FC3", reference:"evolution-devel-2.0.4-2")) flag++;
