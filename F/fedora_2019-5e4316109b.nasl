...
# extracted from Fedora Security Advisory FEDORA-2019-5e4316109b.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : qt5-qtwebengine (2019-5e4316109b)");
  ...
  script_set_attribute(
    ...
    value:
"Update to latest qtwebengine release, includes bug and security fixes.
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-5e4316109b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"qt5-qtwebengine-5.12.4-5.fc29")) flag++;
