...
# extracted from Fedora Security Advisory FEDORA-2017-382c240580.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-382c240580");

  script_name(english:"Fedora 26 : mbedtls (2017-382c240580)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-382c240580"
  );
  # https://tls.mbed.org/tech-updates/security-advisories/mbedtls-security-advisory-2017-02
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0f327403"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"mbedtls-2.6.0-1.fc26")) flag++;
