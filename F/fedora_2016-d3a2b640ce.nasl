...
# extracted from Fedora Security Advisory FEDORA-2016-d3a2b640ce.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-d3a2b640ce");

  script_name(english:"Fedora 24 : python-cryptography / python-cryptography-vectors (2016-d3a2b640ce)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-d3a2b640ce"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC24", reference:"python-cryptography-1.5.3-3.fc24")) flag++;
if (rpm_check(release:"FC24", reference:"python-cryptography-vectors-1.5.3-1.fc24")) flag++;
