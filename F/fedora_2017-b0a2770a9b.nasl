...
# extracted from Fedora Security Advisory FEDORA-2017-b0a2770a9b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-b0a2770a9b");

  script_name(english:"Fedora 25 : knot (2017-b0a2770a9b)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-b0a2770a9b"
  );
...
flag = 0;
if (rpm_check(release:"FC25", reference:"knot-2.4.5-1.fc25")) flag++;
