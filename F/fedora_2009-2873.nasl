...
# extracted from Fedora Security Advisory 2009-2873.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-2873");

  script_name(english:"Fedora 9 : drupal-cck-6.x.2.2-1.fc9 (2009-2873)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-March/021551.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f065d0e6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"drupal-cck-6.x.2.2-1.fc9")) flag++;
