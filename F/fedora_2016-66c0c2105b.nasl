...
# extracted from Fedora Security Advisory FEDORA-2016-66c0c2105b.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-66c0c2105b");

  script_name(english:"Fedora 23 : knot (2016-66c0c2105b)");
...
new upstream release, security fix for CVE-2016-6171
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-66c0c2105b"
  );
...
flag = 0;
if (rpm_check(release:"FC23", reference:"knot-2.3.0-2.fc23")) flag++;
