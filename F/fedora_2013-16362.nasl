...
# extracted from Fedora Security Advisory 2013-16362.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-4920", "CVE-2013-4921", "CVE-2013-4922", "CVE-2013-4923", "CVE-2013-4924", "CVE-2013-4925", "CVE-2013-4926", "CVE-2013-4927", "CVE-2013-4928");
  script_bugtraq_id(61471);
  script_xref(name:"FEDORA", value:"2013-16362");

  script_name(english:"Fedora 19 : wireshark-1.10.1-1.fc19 (2013-16362)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2013-September/115569.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ec99e784"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC19", reference:"wireshark-1.10.1-1.fc19")) flag++;
