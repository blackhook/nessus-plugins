...
# extracted from Fedora Security Advisory 2005-410.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2005-410");

  script_name(english:"Fedora Core 3 : gaim-1.3.1-0.fc3 (2005-410)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/announce/2005-June/000946.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f8f9940c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC3", reference:"gaim-1.3.1-0.fc3")) flag++;
if (rpm_check(release:"FC3", reference:"gaim-debuginfo-1.3.1-0.fc3")) flag++;
