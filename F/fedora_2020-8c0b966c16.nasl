...
# extracted from Fedora Security Advisory FEDORA-2020-8c0b966c16.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 32 : libslirp (2020-8c0b966c16)");
  ...
  script_set_attribute(
    ...
    value:
"New v4.3.1 release, fixing CVE-2020-10756
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-8c0b966c16"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC32", reference:"libslirp-4.3.1-1.fc32")) flag++;
