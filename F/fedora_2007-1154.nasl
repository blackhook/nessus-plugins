...
# extracted from Fedora Security Advisory 2007-1154.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 7 : clamav-0.90.3-1.fc7 (2007-1154)");
  ...
  script_set_attribute(
    ...
    value:
"Can't reach the maintainer, so pushing this myself, given it's a
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-July/002824.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c9d608b0"
  );
...
flag = 0;
if (rpm_check(release:"FC7", reference:"clamav-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-data-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-data-empty-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-debuginfo-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-devel-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-filesystem-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-lib-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-milter-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-milter-sysv-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-server-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-server-sysv-0.90.3-1.fc7")) flag++;
if (rpm_check(release:"FC7", reference:"clamav-update-0.90.3-1.fc7")) flag++;
