...
# extracted from Fedora Security Advisory FEDORA-2020-7aba37f66a.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-7aba37f66a");

  script_name(english:"Fedora 30 : moodle (2020-7aba37f66a)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-7aba37f66a"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-10738");
...
flag = 0;
if (rpm_check(release:"FC30", reference:"moodle-3.6.10-1.fc30")) flag++;
