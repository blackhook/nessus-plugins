...
# extracted from Fedora Security Advisory 2015-9388.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : libreswan-3.13-1.fc20 (2015-9388)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-June/160122.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f5888d9b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"libreswan-3.13-1.fc20")) flag++;
