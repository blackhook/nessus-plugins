...
vulnerability as referenced in the FG-IR-22-391 advisory.
  ...
  - A relative path traversal vulnerability[CWE-23] in FortiOS, FortiProxy, and FortiSwitchManager may allow
    an authenticated attacker to read and write files on the underlying Linux system via crafted HTTP or HTTPS
    requests. (CVE-2022-41335)
