...
# extracted from Fedora Security Advisory FEDORA-2019-615e060d4e.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 29 : libzip (2019-615e060d4e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-615e060d4e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC29", reference:"libzip-1.5.2-1.fc29")) flag++;
