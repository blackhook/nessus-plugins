...
# extracted from Fedora Security Advisory 2011-14648.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-14648");

  script_name(english:"Fedora 15 : java-1.6.0-openjdk-1.6.0.0-60.1.10.4.fc15 (2011-14648)");
  ...
  script_set_attribute(
    ...
    value:
"http://blog.fuseyism.com/index.php/2011/10/18/security-icedtea6-1-8-10
-1-9-10-and-1-10-4-released/
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8fbe8754"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-October/068458.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?487ba42b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC15", reference:"java-1.6.0-openjdk-1.6.0.0-60.1.10.4.fc15")) flag++;
