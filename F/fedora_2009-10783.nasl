...
# extracted from Fedora Security Advisory 2009-10783.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-10783");

  script_name(english:"Fedora 11 : snort-2.8.5.1-1.fc11 (2009-10783)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-November/031360.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ebbcfc4"
  );
...
flag = 0;
if (rpm_check(release:"FC11", reference:"snort-2.8.5.1-1.fc11")) flag++;
