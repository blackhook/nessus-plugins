...
# extracted from Fedora Security Advisory FEDORA-2020-4832f2bd62.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2020-4832f2bd62");

  script_name(english:"Fedora 31 : webkit2gtk3 (2020-4832f2bd62)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2020-4832f2bd62"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"FC31", reference:"webkit2gtk3-2.28.1-3.fc31")) flag++;
