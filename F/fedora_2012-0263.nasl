...
# extracted from Fedora Security Advisory 2012-0263.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2012-0263");

  script_name(english:"Fedora 16 : pdns-3.0.1-1.fc16 (2012-0263)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2012-January/072090.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ab1f807"
  );
...
flag = 0;
if (rpm_check(release:"FC16", reference:"pdns-3.0.1-1.fc16")) flag++;
