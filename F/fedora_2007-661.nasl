...
# extracted from Fedora Security Advisory 2007-661.
#
...
if (description)
{
  ...
  script_name(english:"Fedora Core 6 : openssl-0.9.8b-14.fc6 (2007-661)");
...
"  - Fri Aug 3 2007 Tomas Mraz <tmraz at redhat.com>
    ...
    - Mon Dec 11 2006 Tomas Mraz <tmraz at redhat.com>
      0.9.8b-12
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2007-August/003328.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5a91a8e"
  );
...
flag = 0;
if (rpm_check(release:"FC6", reference:"openssl-0.9.8b-14.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"openssl-debuginfo-0.9.8b-14.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"openssl-devel-0.9.8b-14.fc6")) flag++;
if (rpm_check(release:"FC6", reference:"openssl-perl-0.9.8b-14.fc6")) flag++;
