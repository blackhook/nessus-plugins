...
# extracted from Fedora Security Advisory FEDORA-2018-a9fe5e183e.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2018-a9fe5e183e");

  script_name(english:"Fedora 28 : python-cryptography / python-cryptography-vectors (2018-a9fe5e183e)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2018-a9fe5e183e"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"FC28", reference:"python-cryptography-2.3-1.fc28")) flag++;
if (rpm_check(release:"FC28", reference:"python-cryptography-vectors-2.3-1.fc28")) flag++;
