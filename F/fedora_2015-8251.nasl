...
# extracted from Fedora Security Advisory 2015-8251.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : java-1.8.0-openjdk-1.8.0.45-38.b14.fc20 (2015-8251)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158810.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0519cd35"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"java-1.8.0-openjdk-1.8.0.45-38.b14.fc20")) flag++;
