...
# extracted from F5 Networks BIG-IP Solution SOL15432.
#
...
if (description)
{
  ...
  script_bugtraq_id(67668);

  script_name(english:"F5 Networks BIG-IP : Apache Tomcat vulnerability (SOL15432)");
...
HTTP header."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K15432"
  );
  script_set_attribute(
    attribute:"solution",
    value:
