...
# extracted from Fedora Security Advisory FEDORA-2017-ffc47d48ec.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-ffc47d48ec");

  script_name(english:"Fedora 26 : openslp (2017-ffc47d48ec)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-ffc47d48ec"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC26", reference:"openslp-2.0.0-12.fc26")) flag++;
