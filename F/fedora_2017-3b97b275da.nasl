...
# extracted from Fedora Security Advisory FEDORA-2017-3b97b275da.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2017-3b97b275da");

  script_name(english:"Fedora 24 : mupdf (2017-3b97b275da)");
  ...
  script_set_attribute(
    ...
    value:
"Security fix for CVE-2017-5896 CVE-2017-6060
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2017-3b97b275da"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mupdf-1.10a-4.fc24")) flag++;
