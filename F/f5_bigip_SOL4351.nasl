...
# extracted from F5 Networks BIG-IP Solution SOL4351.
#
...
if (description)
{
  ...
  script_name(english:"F5 Networks BIG-IP : BIND 9.3.0 denial of service vulnerability (SOL4351)");
...
advisory."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.f5.com/csp/article/K4351"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
vmatrix["LTM"]["unaffected"] = make_list("9.1","9.2","9.3","9.4","9.6","10");
