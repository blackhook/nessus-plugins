...
# extracted from Fedora Security Advisory FEDORA-2021-dee141fc61
#
...
if (description)
{
  ...
  script_name(english:"Fedora 33 : coturn (2021-dee141fc61)");
...
FEDORA-2021-dee141fc61 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2021-dee141fc61");
...
pkgs = [
    {'reference':'coturn-4.5.2-1.fc33', 'release':'FC33', 'rpm_spec_vers_cmp':TRUE}
];
