...
# extracted from Fedora Security Advisory 2011-7393.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2011-7393");

  script_name(english:"Fedora 14 : gimp-2.6.11-14.fc14 (2011-7393)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2011-June/061212.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9771ebf3"
  );
...
flag = 0;
if (rpm_check(release:"FC14", reference:"gimp-2.6.11-14.fc14")) flag++;
