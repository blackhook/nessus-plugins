...
vulnerability as referenced in the FG-IR-22-151 advisory.
  ...
  - A stack-based buffer overflow vulnerability [CWE-121] in FortiWeb SAML server configuration may allow an
    authenticated attacker to achieve arbitrary code execution viaspecifically crafted XML files.
    (CVE-2023-23781)
...
var constraints = [
  { 'min_version' : '6.3.6', 'fixed_version' : '6.3.20' },
