...
# extracted from Fedora Security Advisory 2015-8220.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 22 : qemu-2.3.0-4.fc22 (2015-8220) (Venom)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-May/158621.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5706fe3d"
  );
...
flag = 0;
if (rpm_check(release:"FC22", reference:"qemu-2.3.0-4.fc22")) flag++;
