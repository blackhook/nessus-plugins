...
# extracted from Fedora Security Advisory FEDORA-2016-883e40d094.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-883e40d094");

  script_name(english:"Fedora 24 : mbedtls (2016-883e40d094)");
...
https://tls.mbed.org/tech-updates/releases/mbedtls-2.3.0-2.1.5-and-1.3
.17-released
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-883e40d094"
  );
  # https://tls.mbed.org/tech-updates/releases/mbedtls-2.3.0-2.1.5-and-1.3.17-released
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?84c11e33"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"mbedtls-2.3.0-1.fc24")) flag++;
