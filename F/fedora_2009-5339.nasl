...
# extracted from Fedora Security Advisory 2009-5339.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-5339");

  script_name(english:"Fedora 9 : wireshark-1.0.8-1.fc9 (2009-5339)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-May/024068.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24dcf707"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC9", reference:"wireshark-1.0.8-1.fc9")) flag++;
