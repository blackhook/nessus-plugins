...
# extracted from Fedora Security Advisory FEDORA-2019-54420e5182.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-54420e5182");

  script_name(english:"Fedora 30 : drupal8 (2019-54420e5182)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-54420e5182"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"FC30", reference:"drupal8-8.6.13-1.fc30")) flag++;
