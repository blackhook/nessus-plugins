...
# extracted from Fedora Security Advisory 2014-17559.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 20 : mapserver-6.2.2-1.fc20 (2014-17559)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2015-March/152352.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c12554b7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC20", reference:"mapserver-6.2.2-1.fc20")) flag++;
