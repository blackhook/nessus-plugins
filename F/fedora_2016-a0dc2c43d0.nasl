...
# extracted from Fedora Security Advisory FEDORA-2016-a0dc2c43d0.
#
...
if (description)
{
  ...
  script_name(english:"Fedora 24 : icu (2016-a0dc2c43d0)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2016-a0dc2c43d0"
  );
...
flag = 0;
if (rpm_check(release:"FC24", reference:"icu-56.1-7.fc24")) flag++;
