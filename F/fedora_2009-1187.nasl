...
# extracted from Fedora Security Advisory 2009-1187.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2009-1187");

  script_name(english:"Fedora 10 : gedit-2.24.3-3.fc10 (2009-1187)");
...
without introducing additional issues."
  ...
  # https://lists.fedoraproject.org/pipermail/package-announce/2009-January/019634.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?309fa77d"
  );
...
flag = 0;
if (rpm_check(release:"FC10", reference:"gedit-2.24.3-3.fc10")) flag++;
