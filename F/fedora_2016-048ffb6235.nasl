...
# extracted from Fedora Security Advisory 2016-048ffb6235.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2016-048ffb6235");

  script_name(english:"Fedora 24 : libtasn1-4.8-1.fc24 (2016-048ffb6235)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=1325965"
  );
  # https://lists.fedoraproject.org/pipermail/package-announce/2016-April/182299.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?badaac9b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC24", reference:"libtasn1-4.8-1.fc24")) flag++;
