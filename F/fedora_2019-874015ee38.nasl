...
# extracted from Fedora Security Advisory FEDORA-2019-874015ee38.
#
...
if (description)
{
  ...
  script_xref(name:"FEDORA", value:"2019-874015ee38");

  script_name(english:"Fedora 30 : php-twig (2019-874015ee38)");
...
possible without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bodhi.fedoraproject.org/updates/FEDORA-2019-874015ee38"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"FC30", reference:"php-twig-1.38.2-2.fc30")) flag++;
