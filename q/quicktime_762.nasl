...
than 7.6.2.  Such versions contain several vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://support.apple.com/kb/HT3591");
  # http://lists.apple.com/archives/security-announce/2009/Jun/msg00000.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?63ea434a");
  script_set_attribute(attribute:"solution", value:
"Upgrade to QuickTime 7.6.2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0010");
...
)
{
  ...
  security_report_v4(severity:SECURITY_HOLE, port:get_kb_item("SMB/transport"), extra:report);
}
