...
if (description)
{
  ...
  script_name(english:"QNAP QTS / QuTS Hero DEADBOLT Ransomware (QSA-22-02)");
...
vulnerability which is being actively exploited by the DEADBOLT ransomware. The ransomware encrypts files, renames them 
with a .deadbolt extension and hijacks the login page with a ransom note. An investigation conducted by QNAP 
established the ransomware is exploiting the vulnerability outlined in qsa-21-57. 

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.qnap.com/en/security-advisory/qsa-22-02");
