...
specially crafted file, resulting in arbitrary code execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2013/Mar/75");
  # https://packetstormsecurity.com/files/120797/QlikView-Desktop-Client-11.00-SR2-Integer-Overflow.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71b0a975");
