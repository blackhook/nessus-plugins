...
if (description)
{
  ...
  script_name(english:"SonicWall Secure Remote Access (SRA) SQLi (SNWLID-2021-0017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is affected by an SQL injection vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote host is a SonicWall Secure Remote Access (SRA) device that is affected by an SQL injection
...
"Upgrade to a SonicWall SRA version that is 9.0.0.10-28sv or later.");
