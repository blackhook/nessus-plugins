...
e +=  solaris_check_patch(release:"5.5.1_x86", arch:"i386", patch:"106910-01", obsoleted_by:"", package:"SUNWdtdst", version:"1.1,REV=10.97.06.18");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
