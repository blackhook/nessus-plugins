...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2011-A-0087-S");
  script_xref(name:"MSKB", value:"2535512");
...
Windows host has the following vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?e03135e2");
  script_set_attribute(
    attribute:"solution",
    value:
