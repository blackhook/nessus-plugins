...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119009-11 (deprecated)");
...
119009 patch-revision plugins, or deemed non-security related."
  );
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 119009 instead.");
