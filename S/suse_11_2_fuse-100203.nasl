...
# extracted from openSUSE Security Update fuse-1897.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : fuse (fuse-1897)");
  script_summary(english:"Check for the fuse-1897 patch");
...
if ( rpm_check(release:"SUSE11.2", reference:"fuse-2.7.4-3.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"fuse-devel-2.7.4-3.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"fuse-devel-static-2.7.4-3.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libfuse2-2.7.4-3.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libfuse2-32bit-2.7.4-3.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "fuse / fuse-devel / fuse-devel-static / libfuse2 / libfuse2-32bit");
}
