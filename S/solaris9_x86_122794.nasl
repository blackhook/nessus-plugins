...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 122794-36");
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"122794-36", obsoleted_by:"", package:"SUNWuwc", version:"6.1,REV=2004.04.29") < 0) flag++;
