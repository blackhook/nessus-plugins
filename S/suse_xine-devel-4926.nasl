...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : xine (ZYPP Patch Number 4926)");
...
The xine user interface didn't display properly due to that."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2008-0225.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 4926.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:1, reference:"xine-devel-1.1.1-24.26")) flag++;
if (rpm_check(release:"SLED10", sp:1, reference:"xine-lib-1.1.1-24.26")) flag++;
if (rpm_check(release:"SLED10", sp:1, cpu:"x86_64", reference:"xine-lib-32bit-1.1.1-24.26")) flag++;
