...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : logrotate (SAT Patch Number 4583)");
...
"This update for logrotate provides the following fixes :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=651685"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2011-1154.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2011-1155.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4583.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:11:logrotate");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"logrotate-3.7.7-10.24.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"logrotate-3.7.7-10.24.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"logrotate-3.7.7-10.24.1")) flag++;
