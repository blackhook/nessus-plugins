...
# extracted from openSUSE Security Update pam_mount-5598.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : pam_mount (pam_mount-5598)");
  script_summary(english:"Check for the pam_mount-5598 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"pam_mount-0.18-22") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pam_mount-0.18-84.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"pam_mount-32bit-0.18-84.2") ) flag++;
