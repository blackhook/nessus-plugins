...
if(description)
{
 ...
 script_name(english: "Solaris 5.8 (x86) : 113138-07");
...
e +=  solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"113138-07", obsoleted_by:"", package:"SDRMsia", version:"5.3,REV=2002.03.27.15.30");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
