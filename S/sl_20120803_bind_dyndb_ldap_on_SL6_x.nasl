...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind-dyndb-ldap on SL6.x i386/x86_64 (20120803)");
...
update to take effect, the named service must be restarted."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1208&L=scientific-linux-errata&T=0&P=733
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ae75b66a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"bind-dyndb-ldap-1.1.0-0.9.b1.el6_3.1")) flag++;
if (rpm_check(release:"SL6", reference:"bind-dyndb-ldap-debuginfo-1.1.0-0.9.b1.el6_3.1")) flag++;
