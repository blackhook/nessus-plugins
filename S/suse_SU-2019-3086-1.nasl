...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1154884"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1154887"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2019-12290/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2019-18224/"
  );
  # https://www.suse.com/support/update/announcement/2019/suse-su-20193086-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39a92a9f"
  );
  script_set_attribute(
    attribute:"solution",
    value:
