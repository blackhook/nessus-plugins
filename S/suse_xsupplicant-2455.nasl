...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : xsupplicant (ZYPP Patch Number 2455)");
...
bugfixes and one security fix :
  ...
  - A post-authentication stack overflow in the EAP handling
    ...
    overflow a stackbuffer and so potentially execute code.
    (CVE-2006-5601)"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 2455.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:0, reference:"xsupplicant-1.2.8-14.4")) flag++;
