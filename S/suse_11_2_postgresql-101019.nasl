...
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-contrib-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-devel-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-libs-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-plperl-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-plpython-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-pltcl-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"postgresql-server-8.4.5-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"postgresql-libs-32bit-8.4.5-0.2.1") ) flag++;
