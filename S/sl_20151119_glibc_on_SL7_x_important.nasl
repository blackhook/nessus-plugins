...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : glibc on SL7.x x86_64_important (20151119)");
...
privileges. (CVE-2015-5277)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=7709
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c217cec1"
  );
