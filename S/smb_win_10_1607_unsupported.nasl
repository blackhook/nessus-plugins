...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 Version 1607 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:"
The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 version 1607 is running on the remote host.
Microsoft ended support for Windows 10 version 1607 Home/Pro on April 10, 2018
and ends for Windows 10 version 1607 Enterprise/Educational on April 10, 2019.
...
# Not Build 14393 (version 1607)
if ("14393" != os_build) audit(AUDIT_OS_NOT, product_name);

# Server versions have a different life cycle
if ("server" >< tolower(os_name) || "ltsb" >< tolower(os_name)) audit(AUDIT_OS_NOT, "affected");
