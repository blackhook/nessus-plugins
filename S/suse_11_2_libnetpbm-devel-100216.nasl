...
if ( rpm_check(release:"SUSE11.2", reference:"libnetpbm-devel-10.35.66-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libnetpbm10-10.35.66-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"netpbm-10.35.66-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libnetpbm10-32bit-10.35.66-2.4.1") ) flag++;
