...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : php53 on SL5.x i386/x86_64 (20130712)");
...
restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1307&L=scientific-linux-errata&T=0&P=828
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ea4d52f"
  );
