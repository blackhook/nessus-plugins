...
if (description)
{
  ...
  script_name(english:"SuSE 11.2 Security Update : systemtap (SAT Patch Number 7444)");
...
"This collective update for systemtap provides the following fixes :
  ...
  - Fix kernel panic when processing malformed DWARF unwind
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2012-0875.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 7444.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:11:systemtap-server");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:2, reference:"systemtap-1.5-0.9.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, reference:"systemtap-server-1.5-0.9.1")) flag++;
