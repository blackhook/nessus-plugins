...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 16 for SLE 12 SP4) (SUSE-SU-2021:3073-1)");
...
"Update the affected kernel-livepatch-5_3_18-59_19-default, kgraft-patch-4_12_14-122_83-default and / or kgraft-
patch-4_12_14-95_60-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.83-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_83-default-2-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      ...
      '5.3.18-59.19-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-59_19-default-2-2.3', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3', 'SLE_HPC-release-15.3', 'sle-module-live-patching-release-15.3', 'sles-release-15.3']}
        ]
      }
    }
  }
