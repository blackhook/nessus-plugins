...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 117654-67");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"117654-67", obsoleted_by:"", package:"SUNWstadm", version:"2.4") < 0) flag++;
