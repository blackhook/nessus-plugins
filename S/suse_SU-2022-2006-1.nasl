...
var kernel_live_checks = [
  {
    'kernels': {
      ...
      '4.4.180-94.147-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_147-default-13-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
      ...
      '4.4.180-94.150-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_150-default-9-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
          {'reference':'kgraft-patch-4_4_180-94_150-default-9-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      },
      '4.4.180-94.153-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_153-default-5-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
          {'reference':'kgraft-patch-4_4_180-94_153-default-5-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      },
      '4.4.180-94.156-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_156-default-4-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
