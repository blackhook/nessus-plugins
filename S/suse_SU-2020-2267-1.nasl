...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1174922"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1174923"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-12673/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-12674/"
  );
  # https://www.suse.com/support/update/announcement/2020/suse-su-20202267-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4c5b10d5"
  );
  script_set_attribute(
    attribute:"solution",
    value:
