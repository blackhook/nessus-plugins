...
# extracted from openSUSE Security Update imlib2-5571.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : imlib2 (imlib2-5571)");
  script_summary(english:"Check for the imlib2-5571 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"imlib2-1.2.1-46") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"imlib2-devel-1.2.1-46") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"imlib2-filters-1.2.1-46") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"imlib2-loaders-1.2.1-46") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"imlib2-1.3.0-66.3") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"imlib2-devel-1.3.0-66.3") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"imlib2-filters-1.3.0-66.3") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"imlib2-loaders-1.3.0-66.3") ) flag++;
