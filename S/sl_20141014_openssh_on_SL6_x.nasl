...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssh on SL6.x i386/x86_64 (20141014)");
...
In addition, this update adds the following enhancements :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1410&L=scientific-linux-errata&T=0&P=1694
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?732a5f93"
  );
