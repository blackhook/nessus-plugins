...
# extracted from openSUSE Security Update mono-core-2392.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : mono-core (mono-core-2392)");
  script_summary(english:"Check for the mono-core-2392 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"bytefx-data-mysql-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"ibm-data-db2-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-basic-1.1.18-9.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-core-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-data-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-data-firebird-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-data-oracle-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-data-postgresql-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-data-sqlite-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-data-sybase-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-devel-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-extras-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-jscript-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-locale-extras-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-nunit-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-web-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"mono-winforms-1.1.18.1-12.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", cpu:"x86_64", reference:"mono-core-32bit-1.1.18.1-12.2") ) flag++;
