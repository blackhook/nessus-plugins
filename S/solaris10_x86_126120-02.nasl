...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 126120-02");
  script_summary(english:"Check for patch 126120-02");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 126120-02"
  );
  script_set_attribute(
...
including arbitrary code execution."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 126120-02 or higher");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-6521");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:126120");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"126120-02", obsoleted_by:"", package:"SUNWpmowu", version:"3.6.21,REV=2004.12.17") < 0) flag++;
