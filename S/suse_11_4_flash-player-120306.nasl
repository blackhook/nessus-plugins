...
# extracted from openSUSE Security Update flash-player-5927.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : flash-player (openSUSE-SU-2012:0331-1)");
  script_summary(english:"Check for the flash-player-5927 patch");
...
"flash-player 11.1.102.63 fixes two security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-03/msg00004.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"flash-player-11.1.102.63-0.2.1") ) flag++;
