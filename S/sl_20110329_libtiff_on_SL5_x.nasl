...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libtiff on SL5.x i386/x86_64");
...
This update also fixes the following bug :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=688825"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1103&L=scientific-linux-errata&T=0&P=10784
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?941ce8f1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"libtiff-3.8.2-7.el5_6.7")) flag++;
if (rpm_check(release:"SL5", reference:"libtiff-devel-3.8.2-7.el5_6.7")) flag++;
