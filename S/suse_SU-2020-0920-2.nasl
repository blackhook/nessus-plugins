...
# extracted from SUSE update advisory SUSE-SU-2020:0920-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : libxslt (SUSE-SU-2020:0920-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2ef7831a"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"libxslt-debugsource-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libxslt-tools-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libxslt-tools-debuginfo-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libxslt1-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libxslt1-32bit-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libxslt1-debuginfo-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libxslt1-debuginfo-32bit-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libxslt-debugsource-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libxslt-tools-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libxslt-tools-debuginfo-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libxslt1-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libxslt1-32bit-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libxslt1-debuginfo-1.1.28-17.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libxslt1-debuginfo-32bit-1.1.28-17.9.1")) flag++;
