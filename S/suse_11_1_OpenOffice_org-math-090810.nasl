...
# extracted from openSUSE Security Update OpenOffice_org-math-1191.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : OpenOffice_org-math (OpenOffice_org-math-1191)");
  script_summary(english:"Check for the OpenOffice_org-math-1191 patch");
...
documents."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected OpenOffice_org-math packages."
  );
...
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-math-3.0.0.9-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-writer-3.0.0.9-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-writer-devel-3.0.0.9-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-writer-l10n-prebuilt-3.0.0.9-2.8.1") ) flag++;
