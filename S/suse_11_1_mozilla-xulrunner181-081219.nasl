...
# extracted from openSUSE Security Update mozilla-xulrunner181-383.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mozilla-xulrunner181 (mozilla-xulrunner181-383)");
  script_summary(english:"Check for the mozilla-xulrunner181-383 patch");
...
version containing these fixes can be installed."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:mozilla-xulrunner181-l10n-32bit");
...
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner181-1.8.1.19-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner181-devel-1.8.1.19-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner181-l10n-1.8.1.19-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner181-32bit-1.8.1.19-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner181-l10n-32bit-1.8.1.19-1.1") ) flag++;
