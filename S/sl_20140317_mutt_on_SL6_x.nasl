...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mutt on SL6.x i386/x86_64 (20140317)");
...
take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1403&L=scientific-linux-errata&T=0&P=1330
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?575e1028"
  );
  script_set_attribute(
    attribute:"solution", 
