...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : gnutls (cve_2011_4128_buffer_overflow)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2011-4128-buffer-overflow-vulnerability-in-gnutls
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7d07182f"
  );
