...
flag = 0;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"MozillaFirefox-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"MozillaFirefox-branding-SLED-7-0.6.9.62")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"MozillaFirefox-translations-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"MozillaFirefox-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"MozillaFirefox-branding-SLED-7-0.6.9.62")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"MozillaFirefox-translations-17.0.10esr-0.4.2.4")) flag++;
