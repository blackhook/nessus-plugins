...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ypbind on SL3.x i386/x86_64");
...
"This updated package fixes the following bugs :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0805&L=scientific-linux-errata&T=0&P=2551
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bfde1fef"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected ypbind package."
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"ypbind-1.12-6")) flag++;
