...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 148626-01");
  script_summary(english:"Check for patch 148626-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 148626-01"
  );
  script_set_attribute(
...
partial denial of service (partial DOS) of Solaris."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 148626-01 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3121");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:148626");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"148626-01", obsoleted_by:"", package:"SUNWtnamd", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
...
if (flag) {
  ...
  audit(AUDIT_PACKAGE_NOT_INSTALLED, "SUNWtnamd");
}
