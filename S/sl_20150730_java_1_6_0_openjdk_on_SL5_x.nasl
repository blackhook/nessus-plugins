...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.6.0-openjdk on SL5.x, SL6.x, SL7.x i386/x86_64 (20150730) (Bar Mitzvah) (Logjam)");
...
to take effect.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a2ea1f88");
