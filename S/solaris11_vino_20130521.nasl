...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : vino (cve_2012_4429_information_leak)");
...
security updates :
  ...
  - Vino 2.28, 2.32, 3.4.2, and earlier allows remote
    attackers to read clipboard activity by listening on TCP
    port 5900. (CVE-2012-4429)"
  );
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2012-4429-information-leak-disclosure-in-vino
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?51bab276"
  );
