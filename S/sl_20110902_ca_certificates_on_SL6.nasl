...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ca-certificates on SL6.x");
...
restarted for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1109&L=scientific-linux-errata&T=0&P=1002
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?406753a9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"ca-certificates-2010.63-3.el6_1.5")) flag++;
