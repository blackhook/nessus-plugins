...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tk on SL4.x, SL5.x i386/x86_64");
...
(CVE-2007-5378)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0802&L=scientific-linux-errata&T=0&P=1057
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?576463c8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"tk-8.4.7-3.el4_6.1")) flag++;
if (rpm_check(release:"SL4", reference:"tk-devel-8.4.7-3.el4_6.1")) flag++;

if (rpm_check(release:"SL5", reference:"tk-8.4.13-5.el5_1.1")) flag++;
if (rpm_check(release:"SL5", reference:"tk-devel-8.4.13-5.el5_1.1")) flag++;
