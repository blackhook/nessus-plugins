...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"828040");
...
message to a user of this host.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2004/ms04-009");
