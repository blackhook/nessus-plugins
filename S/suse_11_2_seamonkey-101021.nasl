...
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-dom-inspector-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-irc-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-venkman-2.0.9-0.5.1") ) flag++;
