...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 127556-05 (deprecated)");
  script_summary(english:"Check for patch 127556-05");
...
127556 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/127556-05"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"n/a"
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 127556 instead.");
