...
# extracted from SUSE update advisory SUSE-SU-2019:2987-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : ucode-intel (SUSE-SU-2019:2987-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?040b3f09"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
SUSE-SLE-Module-Basesystem-15-SP1-2019-2987=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"ucode-intel-20191112a-3.13.2")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"ucode-intel-20191112a-3.13.2")) flag++;
