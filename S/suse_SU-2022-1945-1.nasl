...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 25 for SLE 15 SP1) (SUSE-SU-2022:1945-1)");
...
"Update the affected kernel-livepatch-4_12_14-197_102-default, kernel-livepatch-4_12_14-197_105-default and / or kernel-
livepatch-4_12_14-197_92-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-197.102-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_102-default-9-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '4.12.14-197.105-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_105-default-5-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '4.12.14-197.92-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_92-default-16-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      }
    }
  }
