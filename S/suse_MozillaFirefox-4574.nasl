...
# extracted from openSUSE Security Update MozillaFirefox-4574.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaFirefox (MozillaFirefox-4574)");
  script_summary(english:"Check for the MozillaFirefox-4574 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"MozillaFirefox-2.0.0.8-1.2") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"MozillaFirefox-translations-2.0.0.8-1.2") ) flag++;
