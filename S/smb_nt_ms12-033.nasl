...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2690533");
...
privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-033");
  script_set_attribute(
    attribute:"solution",
    value:
