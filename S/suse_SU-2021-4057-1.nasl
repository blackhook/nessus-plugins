...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 37 for SLE 12 SP3) (SUSE-SU-2021:4057-1)");
...
"Update the affected kgraft-patch-4_4_180-94_138-default and / or kgraft-patch-4_4_180-94_147-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.4.180-94.138-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_138-default-13-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      },
      '4.4.180-94.147-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_147-default-6-2.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']}
        ]
      }
    }
  }
