...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2797052");
...
attacker to execute arbitrary code on the remote host.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-010");
