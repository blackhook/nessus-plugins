...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:0411");

  script_name(english:"Scientific Linux Security Update : flatpak on SL7.x x86_64 (2021:0411)");
...
SLSA-2021:0411-1 advisory.

  - flatpak: sandbox escape via spawn portal (CVE-2021-21261)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20210411-1");
...
pkgs = [
    {'reference':'flatpak-1.0.9-10.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'flatpak-builder-1.0.0-10.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'flatpak-debuginfo-1.0.9-10.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'flatpak-devel-1.0.9-10.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'flatpak-libs-1.0.9-10.el7_9', 'cpu':'x86_64', 'release':'SL7'}
];
