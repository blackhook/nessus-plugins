...
# extracted from openSUSE Security Update bluez-865.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bluez (bluez-865)");
  script_summary(english:"Check for the bluez-865 patch");
...
behavior and therefore needs a new configuration."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:bluez-gstreamer");
...
if ( rpm_check(release:"SUSE11.1", reference:"bluez-4.22-6.1.10") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"bluez-alsa-4.22-6.1.10") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"bluez-compat-4.22-6.1.10") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"bluez-cups-4.22-6.1.10") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"bluez-devel-4.22-6.1.10") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"bluez-gstreamer-4.22-6.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"bluez-test-4.22-6.1.10") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libbluetooth3-4.22-6.1.10") ) flag++;
