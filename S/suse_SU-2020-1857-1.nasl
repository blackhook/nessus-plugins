...
# extracted from SUSE update advisory SUSE-SU-2020:1857-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : permissions (SUSE-SU-2020:1857-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8cef9d59"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"permissions-20170707-3.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"permissions-debuginfo-20170707-3.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"permissions-debugsource-20170707-3.24.1")) flag++;
