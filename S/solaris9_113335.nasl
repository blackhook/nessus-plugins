...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 113335-05");
  script_summary(english:"Check for patch 113335-05");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 113335-05"
  );
  script_set_attribute(
...
crash (complete DOS)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/113335-05"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"113335-05", obsoleted_by:"", package:"SUNWcarx", version:"11.9.0,REV=2002.04.09.12.25") < 0) flag++;
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"113335-05", obsoleted_by:"", package:"SUNWcsr", version:"11.9.0,REV=2002.04.06.15.27") < 0) flag++;
