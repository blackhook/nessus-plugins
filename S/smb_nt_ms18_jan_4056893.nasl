...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4056893");
  script_xref(name:"IAVA", value:"2018-A-0019");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"MSFT", value:"MS18-4075199");
  script_xref(name:"MSKB", value:"4056893");
  script_xref(name:"MSFT", value:"MS18-4075199");

  script_name(english:"KB4056893: Windows 10 LTSB January 2018 Security Update (Meltdown)(Spectre)");
  script_summary(english:"Checks for rollup.");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4056893
...
vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72844320");
  # https://support.microsoft.com/en-ca/help/4075199/windows-10-update-kb4075199
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cf4402c9");
  ...
  "Apply Cumulative Update KB4056893 or KB4075199.
...
Notes: 
  ...
  - KB4075199 Addresses an issue with KB4056893 where some 
...
if (
  smb_check_rollup(os:"10",
                   ...
                   rollup_date:"01_2018",
                   bulletin:bulletin,
                   rollup_kb_list:[4056893,4075199])
)
{
