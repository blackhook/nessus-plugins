...
if ( rpm_check(release:"SUSE11.2", reference:"dhcp-3.1.2p1-4.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"dhcp-client-3.1.2p1-4.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"dhcp-devel-3.1.2p1-4.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"dhcp-relay-3.1.2p1-4.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"dhcp-server-3.1.2p1-4.10.1") ) flag++;
