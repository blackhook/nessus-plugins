...
if (description)
{
  script_id(86067);
  script_version("1.6");
  script_cvs_date("Date: 2019/01/25 15:50:56");
...
can potentially exploit this to generate another certificate with the same digital
...
sunsetting of the SHA-1 cryptographic hash algorithm.");
  script_set_attribute(attribute:"see_also", value:"https://blog.chromium.org/2014/09/gradually-sunsetting-sha-1.html");
