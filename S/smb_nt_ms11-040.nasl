...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2011-A-0085-S");
...
arbitrary code on the remote host.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?151b33a0");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a patch for Forefront Threat Management
Gateway.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1889");
