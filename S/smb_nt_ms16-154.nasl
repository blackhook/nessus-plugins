...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS16-154");
  script_xref(name:"MSKB", value:"3209498");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/15");

  script_name(english:"MS16-154: Security Update for Adobe Flash Player (3209498)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host has a browser plugin installed that is
affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing KB3209498. It is, therefore,
affected by multiple vulnerabilities :
  ...
  - An unspecified security bypass vulnerability exists.
    (CVE-2016-7890)");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-154");
...
# all <= 23.0.0.207
fix = FALSE;
if(ver_compare(ver:iver, fix:"23.0.0.207", strict:FALSE) <= 0)
  fix = "24.0.0.186";
...
if (info != '')
{
  ...
  hotfix_add_report(bulletin:'MS16-154', kb:'3209498', report);
