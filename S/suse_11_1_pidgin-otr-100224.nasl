...
# extracted from openSUSE Security Update pidgin-otr-2096.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pidgin-otr (pidgin-otr-2096)");
  script_summary(english:"Check for the pidgin-otr-2096 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update contains the missed pidgin-otr dependend package of the
last pidgin update."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.1", reference:"pidgin-otr-3.2.0-1.16.34") ) flag++;
