...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : gpg2 (ZYPP Patch Number 8576)");
...
"This update for gpg2 provides the following fixes :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8576.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"gpg2-1.9.18-17.23.1")) flag++;
