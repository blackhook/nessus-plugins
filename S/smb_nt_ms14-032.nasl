...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2963286");
  script_xref(name:"MSKB", value:"2963288");
...
exploited by tricking a user into clicking a specially crafted URL.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-032");
