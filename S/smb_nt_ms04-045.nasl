...
if (description)
{
 ...
 script_xref(name:"CERT", value:"145134");
 script_xref(name:"CERT", value:"378160");
...
if (
  hotfix_is_vulnerable(os:"5.2", sp:0, file:"Wins.exe", version:"5.2.3790.239", dir:"\system32", bulletin:bulletin, kb:kb) ||
  hotfix_is_vulnerable(os:"5.0", file:"Wins.exe", version:"5.0.2195.7005", dir:"\system32", bulletin:bulletin, kb:kb) ||
  hotfix_is_vulnerable(os:"4.0", file:"Wins.exe", version:"4.0.1381.7329", dir:"\system32", bulletin:bulletin, kb:kb)
)
{
