...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 117367-02");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"117367-02", obsoleted_by:"", package:"SUNWstui", version:"2.1.0 ,REV=04.15.04") < 0) flag++;
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"117367-02", obsoleted_by:"", package:"SUNWstmsu", version:"2.1.0 ,REV=04.15.04") < 0) flag++;
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"117367-02", obsoleted_by:"", package:"SUNWstoba", version:"2.1.0 ,REV=04.15.04") < 0) flag++;
