...
# extracted from openSUSE Security Update ModemManager-6030.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : ModemManager (ModemManager-6030)");
  script_summary(english:"Check for the ModemManager-6030 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"NetworkManager-0.6.5-37.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"NetworkManager-devel-0.6.5-37.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"NetworkManager-glib-0.6.5-37.6") ) flag++;
