...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libguestfs on SL6.x x86_64 (20170321)");
...
fixed version of OCaml to address this issue."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1704&L=scientific-linux-errata&F=&S=&P=1463
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?37c996b5"
  );
...
flag = 0;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-debuginfo-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-devel-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-java-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-java-devel-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-javadoc-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-tools-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libguestfs-tools-c-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"ocaml-libguestfs-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"ocaml-libguestfs-devel-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"perl-Sys-Guestfs-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"python-libguestfs-1.20.11-20.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"ruby-libguestfs-1.20.11-20.el6")) flag++;
