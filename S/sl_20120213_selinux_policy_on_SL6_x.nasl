...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : selinux-policy on SL6.x i386/x86_64 (20120213)");
...
packages, which fix these bugs."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=2091
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b41a1d12"
  );
