...
# extracted from openSUSE Security Update libwmf-6212.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libwmf (libwmf-6212)");
  script_summary(english:"Check for the libwmf-6212 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libwmf-0.2.8.4-92.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libwmf-devel-0.2.8.4-92.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libwmf-gnome-0.2.8.4-92.2") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libwmf / libwmf-devel / libwmf-gnome");
}
