...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : IBM Java JRE and SDK (YOU Patch Number 12706)");
...
http://www.ibm.com/developerworks/java/jdk/alerts/"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12706.");
...
flag = 0;
if (rpm_check(release:"SUSE9", cpu:"i586", reference:"IBMJava2-JRE-1.4.2_sr13.9-0.6")) flag++;
if (rpm_check(release:"SUSE9", cpu:"i586", reference:"IBMJava2-SDK-1.4.2_sr13.9-0.6")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"IBMJava2-JRE-1.4.2_sr13.9-0.7")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"IBMJava2-SDK-1.4.2_sr13.9-0.7")) flag++;
