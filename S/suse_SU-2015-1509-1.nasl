...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?38e9b81d");
...
if (isnull(sp)) sp = "0";
if (os_ver == "SLES11" && (! preg(pattern:"^(1|2|3)$", string:sp))) audit(AUDIT_OS_NOT, "SLES11 SP1/2/3", os_ver + " SP" + sp);
