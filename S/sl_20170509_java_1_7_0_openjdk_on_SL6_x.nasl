...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.7.0-openjdk on SL6.x, SL7.x i386/x86_64 (20170509)");
...
jdk.jar.disabledAlgorithms security property.
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1705&L=scientific-linux-errata&F=&S=&P=3214
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0a5e2b8f"
  );
