...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : jul2018_SRU11_2_11_5_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    ...
    with network access via DHCP to compromise Solaris.
    Successful attacks of this vulnerability can result in
    unauthorized ability to cause a partial denial of
    service (partial DOS) of Solaris. (CVE-2018-2901)"
  );
  script_set_attribute(
    attribute:"see_also",
