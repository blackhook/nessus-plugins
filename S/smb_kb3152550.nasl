...
if (description)
{
  script_id(90511);
  script_version("1.4");
  script_cvs_date("Date: 2019/06/18 17:09:48");

  script_xref(name:"MSKB", value:"3152550");
...
into Microsoft wireless mouse devices through the use of USB dongles.");
  # https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2016/3152550  
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0ef42794");
...
# Validate the scanned host is one of the affected OS versions and Service Packs
if (hotfix_check_sp_range(win7:'1', win81:'0', win10:'0') <= 0) audit(AUDIT_OS_SP_NOT_VULN);

# Validate it's correct Windows 10 BuildVersions
os = get_kb_item("SMB/WindowsVersion");
os_build = get_kb_item("SMB/WindowsVersionBuild");
if((os_build != "10586") && (os_build != "10240") && os == "10") audit(AUDIT_OS_SP_NOT_VULN);
