...
# extracted from openSUSE Security Update rsyslog-367.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rsyslog (rsyslog-367)");
  script_summary(english:"Check for the rsyslog-367 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"rsyslog-3.18.3-4.2") ) flag++;
