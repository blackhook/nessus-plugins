...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:2322");

  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL7.x x86_64 (2021:2322)");
...
SLSA-2021:2322-1 advisory.

  - QEMU: ide: atapi: OOB access while processing read commands (CVE-2020-29443)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20212322-1");
...
pkgs = [
    {'reference':'qemu-img-1.5.3-175.el7_9.4', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qemu-kvm-1.5.3-175.el7_9.4', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qemu-kvm-common-1.5.3-175.el7_9.4', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qemu-kvm-debuginfo-1.5.3-175.el7_9.4', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qemu-kvm-tools-1.5.3-175.el7_9.4', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
