...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2424434");
...
dynamic link library (DLL) file.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-093");
