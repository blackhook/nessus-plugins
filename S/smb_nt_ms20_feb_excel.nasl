...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4484256");
  script_xref(name:"MSKB", value:"4484265");
  script_xref(name:"MSKB", value:"4484267");
  script_xref(name:"MSFT", value:"MS20-4484256");
  script_xref(name:"MSFT", value:"MS20-4484265");
  script_xref(name:"MSFT", value:"MS20-4484267");

  script_name(english:"Security Updates for Microsoft Excel Products (February 2020)");
...
"The Microsoft Excel Products are missing a security update. It is, therefore, affected by the following vulnerability :
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4484256");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4484265");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4484267");
...
checks = make_array(
  '14.0', make_array('sp', 2, 'version', '14.0.7245.5000', 'kb', '4484267'),
  '15.0', make_array('sp', 1, 'version', '15.0.5215.1000', 'kb', '4484265'),
  '16.0', make_nested_list(
    make_array('sp', 0, 'version', '16.0.4966.1000', 'channel', 'MSI', 'kb', '4484256'))
);
