...
if ( rpm_check(release:"SUSE11.1", reference:"libmysqlclient-devel-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libmysqlclient15-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libmysqlclient_r15-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mysql-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mysql-Max-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mysql-bench-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mysql-client-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mysql-debug-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mysql-test-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mysql-tools-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libmysqlclient15-32bit-5.0.67-12.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libmysqlclient_r15-32bit-5.0.67-12.16.1") ) flag++;
