...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : shadow-utils on SL3.x i386/x86_64");
...
mailbox. (CVE-2006-1174)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0706&L=scientific-linux-errata&T=0&P=2244
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?994ea62c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"shadow-utils-4.0.3-29.RHEL3")) flag++;
