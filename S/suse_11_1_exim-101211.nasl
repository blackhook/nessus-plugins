...
root access (CVE-2010-4345).");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=658731");
  script_set_attribute(attribute:"see_also", value:"https://lists.opensuse.org/opensuse-updates/2010-12/msg00029.html");
...
if ( rpm_check(release:"SUSE11.1", reference:"exim-4.69-70.15.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"eximon-4.69-70.15.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"eximstats-html-4.69-70.15.1") ) flag++;
