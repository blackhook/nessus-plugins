...
if ( rpm_check(release:"SUSE11.3", reference:"cyrus-imapd-2.3.16-8.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"cyrus-imapd-devel-2.3.16-8.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"perl-Cyrus-IMAP-2.3.16-8.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"perl-Cyrus-SIEVE-managesieve-2.3.16-8.7.1") ) flag++;
