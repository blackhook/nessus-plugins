...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:2683");

  script_name(english:"Scientific Linux Security Update : xstream on SL7.x (noarch) (2021:2683)");
...
SLSA-2021:2683-1 advisory.

  - XStream: remote command execution attack by manipulating the processed input stream (CVE-2021-29505)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20212683-1");
...
pkgs = [
    {'reference':'xstream-1.3.1-14.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xstream-javadoc-1.3.1-14.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
