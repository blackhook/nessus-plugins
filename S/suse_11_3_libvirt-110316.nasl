...
potentially execute code (CVE-2011-1146)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00022.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-0.8.1-4.6.2") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-client-0.8.1-4.6.2") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-devel-0.8.1-4.6.2") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-python-0.8.1-4.6.2") ) flag++;
