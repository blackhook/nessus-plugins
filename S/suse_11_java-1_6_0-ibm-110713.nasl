...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : IBM Java (SAT Patch Number 4875)");
...
security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=705423"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4875.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:1, reference:"java-1_6_0-ibm-1.6.0_sr9.2-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"java-1_6_0-ibm-fonts-1.6.0_sr9.2-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"java-1_6_0-ibm-jdbc-1.6.0_sr9.2-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, cpu:"i586", reference:"java-1_6_0-ibm-alsa-1.6.0_sr9.2-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, cpu:"i586", reference:"java-1_6_0-ibm-plugin-1.6.0_sr9.2-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, cpu:"x86_64", reference:"java-1_6_0-ibm-plugin-1.6.0_sr9.2-0.4.1")) flag++;
