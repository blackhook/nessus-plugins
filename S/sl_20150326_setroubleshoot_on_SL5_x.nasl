...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : setroubleshoot on SL5.x, SL6.x, SL7.x i386/x86_64 (20150326)");
...
shell command. (CVE-2015-1815)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1503&L=scientific-linux-errata&T=0&P=3858
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?93afb13c"
  );
