...
to Gdm's unix domain socket. (CVE-2007-3381)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0708&L=scientific-linux-errata&T=0&P=444
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cfab2c41"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"gdm-2.16.0-31.0.1.el5")) flag++;
