...
(CVE-2011-2462, CVE-2011-4369)");
  ...
  script_set_attribute(attribute:"see_also", value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00030.html");
...
if ( rpm_check(release:"SUSE11.3", reference:"acroread-9.4.7-0.3.1") ) flag++;
