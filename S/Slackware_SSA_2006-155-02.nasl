...
# extracted from Slackware Security Advisory 2006-155-02. The text 
...
if (description)
{
  ...
  script_name(english:"Slackware 10.2 / current : firefox/thunderbird/seamonkey (SSA:2006-155-02)");
...
package is available for Slackware -current to fix similar issues."
  ...
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2006&m=slackware-security.477679
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7cf7deeb"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (slackware_check(osver:"10.2", pkgname:"mozilla-firefox", pkgver:"1.5.0.4", pkgarch:"i686", pkgnum:"1")) flag++;
if (slackware_check(osver:"10.2", pkgname:"mozilla-thunderbird", pkgver:"1.5.0.4", pkgarch:"i686", pkgnum:"1")) flag++;

if (slackware_check(osver:"current", pkgname:"mozilla-firefox", pkgver:"1.5.0.4", pkgarch:"i686", pkgnum:"1")) flag++;
if (slackware_check(osver:"current", pkgname:"mozilla-thunderbird", pkgver:"1.5.0.4", pkgarch:"i686", pkgnum:"1")) flag++;
if (slackware_check(osver:"current", pkgname:"seamonkey", pkgver:"1.0.2", pkgarch:"i486", pkgnum:"1")) flag++;
