...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rpcbind on SL7.x x86_64 (20170521)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1705&L=scientific-linux-errata&F=&S=&P=5546
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77100aa1"
  );
  script_set_attribute(
    attribute:"solution", 
