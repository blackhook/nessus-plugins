...
if (description)
{
  ...
  script_name(english:"SonicWALL Global Management System (GMS) / Analyzer GMC Service XML External Entity (XXE) Injection");
...
"Apply Hotfix 174525 per the vendor advisory.");
  ...
  script_require_keys("sonicwall/universal_management_appliance");
...
get_kb_item_or_exit("sonicwall/universal_management_appliance"); 
