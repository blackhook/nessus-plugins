...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0908&L=scientific-linux-errata&T=0&P=1101
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4a42e6e7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"curl-7.10.6-10.rhel3")) flag++;
if (rpm_check(release:"SL3", reference:"curl-devel-7.10.6-10.rhel3")) flag++;
