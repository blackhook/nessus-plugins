...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : dhcpcd (ZYPP Patch Number 7432)");
...
needs to sanitize the host name offered by the server. (CVE-2011-0996)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7432.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"dhcpcd-1.3.22pl4-223.16.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"dhcpcd-1.3.22pl4-223.16.1")) flag++;
