...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 112760-19");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"112760-19", obsoleted_by:"", package:"SPROcc", version:"8.0,REV=2003.03.13") < 0) flag++;
