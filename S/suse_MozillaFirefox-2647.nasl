...
# extracted from openSUSE Security Update MozillaFirefox-2647.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaFirefox (MozillaFirefox-2647)");
  script_summary(english:"Check for the MozillaFirefox-2647 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"MozillaFirefox-2.0.0.2-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"MozillaFirefox-translations-2.0.0.2-1.1") ) flag++;
