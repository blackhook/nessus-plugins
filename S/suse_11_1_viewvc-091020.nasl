...
# extracted from openSUSE Security Update viewvc-1420.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : viewvc (viewvc-1420)");
  script_summary(english:"Check for the viewvc-1420 patch");
...
error messages (CVE-2009-3618, CVE-2009-3619)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=537154"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"viewvc-1.0.9-0.1.1") ) flag++;
