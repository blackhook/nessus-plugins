...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2010-A-0141-S");
...
context of the Network Service account.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?6405e412");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows Vista and Windows
7.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3225");
