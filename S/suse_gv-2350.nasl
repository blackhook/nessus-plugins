...
# extracted from openSUSE Security Update gv-2350.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gv (gv-2350)");
  script_summary(english:"Check for the gv-2350 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"gv-3.5.8-1184.2") ) flag++;
