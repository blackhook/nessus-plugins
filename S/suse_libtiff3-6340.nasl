...
# extracted from openSUSE Security Update libtiff3-6340.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libtiff3 (libtiff3-6340)");
  script_summary(english:"Check for the libtiff3-6340 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libtiff3-3.8.2-68.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libtiff3-32bit-3.8.2-68.6") ) flag++;
