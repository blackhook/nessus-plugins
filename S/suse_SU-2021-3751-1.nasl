...
the SUSE-SU-2021:3751-1 advisory.
...
"Update the affected kgraft-patch-4_4_180-94_135-default and / or kgraft-patch-4_4_180-94_147-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.4.180-94.135-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_135-default-14-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']}
        ]
      },
      '4.4.180-94.147-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_147-default-5-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_4_180-94_135-default / etc');
}
