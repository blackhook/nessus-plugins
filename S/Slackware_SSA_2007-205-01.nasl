...
# extracted from Slackware Security Advisory 2007-205-01. The text 
...
if (description)
{
  ...
  script_name(english:"Slackware 11.0 / 12.0 : thunderbird (SSA:2007-205-01)");
...
back...)"
  ...
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.371349
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b365695b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (slackware_check(osver:"11.0", pkgname:"mozilla-thunderbird", pkgver:"2.0.0.5", pkgarch:"i686", pkgnum:"1")) flag++;

if (slackware_check(osver:"12.0", pkgname:"mozilla-thunderbird", pkgver:"2.0.0.5", pkgarch:"i686", pkgnum:"1")) flag++;
