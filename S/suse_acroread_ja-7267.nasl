...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : acroread_ja (ZYPP Patch Number 7267)");
...
(AV:N/AC:M/Au:N/C:P/I:P/A:P): Buffer Errors (CWE-119))"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7267.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread_ja-9.4.1-0.4.1")) flag++;
