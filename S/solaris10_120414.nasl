...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 120414-27 (deprecated)");
...
120414 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 120414 instead.");
