...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : selinux-policy enhancement update on SL5.x, SL6.x i386/x86_64 (20120911)");
...
bugs."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1209&L=scientific-linux-errata&T=0&P=1083
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2ec1ed9a"
  );
