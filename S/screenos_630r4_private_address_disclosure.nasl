...
only on the application's self-reported version number.");
  # https://www.juniper.net/documentation/software/screenos/screenos6.3.0/rn-630-r4.pdf
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?85df86f2");
