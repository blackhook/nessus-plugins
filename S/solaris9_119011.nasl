...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 119011-01");
  script_summary(english:"Check for patch 119011-01");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 119011-01");
  script_set_attribute(attribute:"description", value:
"VERITAS NetBackup 5.1 Product Patch MP4. Date this patch was last
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"119011-01", obsoleted_by:"116271-07 ", package:"VRTSnetbp", version:"5.1,REV=2004.05.11.17.55") < 0) flag++;
