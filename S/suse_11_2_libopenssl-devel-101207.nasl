...
if ( rpm_check(release:"SUSE11.2", reference:"libopenssl-devel-0.9.8k-3.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libopenssl0_9_8-0.9.8k-3.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"openssl-0.9.8k-3.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libopenssl0_9_8-32bit-0.9.8k-3.12.1") ) flag++;
