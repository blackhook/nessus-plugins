...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL5.x, SL6.x, SL7.x i386/x86_64 (20151126)");
...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a17d213"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL5", reference:"thunderbird-38.4.0-1.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"thunderbird-debuginfo-38.4.0-1.el5_11")) flag++;

if (rpm_check(release:"SL6", reference:"thunderbird-38.4.0-1.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-38.4.0-1.el6_7")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-38.4.0-1.el7_2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"thunderbird-debuginfo-38.4.0-1.el7_2")) flag++;
