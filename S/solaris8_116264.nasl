...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 116264-09");
  script_summary(english:"Check for patch 116264-09");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 116264-09");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"116264-09", obsoleted_by:"", package:"VRTSnetbp", version:"5.0,REV=2003.11.06.09.24") < 0) flag++;
