...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : apr2018_SRU11_3_28_4_0");
...
fix_release = "0.5.11-0.175.3.28.0.4.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.28.0.4.0", sru:"11.3.28.4.0") > 0) flag++;
