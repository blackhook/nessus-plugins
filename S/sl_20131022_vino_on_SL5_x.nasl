...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : vino on SL5.x, SL6.x i386/x86_64 (20131022)");
...
this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1310&L=scientific-linux-errata&T=0&P=2493
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ae52eb60"
  );
  script_set_attribute(
    attribute:"solution", 
