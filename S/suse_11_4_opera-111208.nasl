...
if (description)
{
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-12/msg00005.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"opera-11.60-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"opera-gtk-11.60-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"opera-kde4-11.60-0.2.1") ) flag++;
