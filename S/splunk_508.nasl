...
if (description)
{
  ...
  script_cve_id("CVE-2014-2578");
  script_bugtraq_id(66453);

  script_name(english:"Splunk < 5.0.8 Unspecified XSS");
...
vulnerability. An attacker can exploit this vulnerability to inject
...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://www.splunk.com/view/SP-CAAAKQX");
  script_set_attribute(attribute:"solution", value:"Upgrade to Splunk 5.0.8 or later.");
...
if (ver_compare(ver:ver,fix:"5.0.8",strict:FALSE) < 0)
{
