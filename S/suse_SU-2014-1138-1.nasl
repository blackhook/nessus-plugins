...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=856756"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=882809"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=883526"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=884530"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://download.suse.com/patch/finder/?keywords=33223d7de0d6fcaf9f12c0175a720ae1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05c35e93"
  );
  # https://download.suse.com/patch/finder/?keywords=753dcd87154cfcee28dc062d0421697d
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?780d66eb"
  );
  # https://download.suse.com/patch/finder/?keywords=ad20790f90bee656575f760123b63fe2
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ac80d87e"
  );
  # https://download.suse.com/patch/finder/?keywords=bb89429b2b6bbf8e51a9b446b5a9f825
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?98552c52"
  );
  # https://download.suse.com/patch/finder/?keywords=cc2185e1b7bb5f72a49d967c7dcf07ee
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9c0b05a"
  );
  # https://download.suse.com/patch/finder/?keywords=f3d32743e8c31acee5f4fb836923cc28
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?840438e1"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-1860/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-4162/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-7266/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-7267/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-7268/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-7269/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-7270/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2013-7271/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2014-0203/"
  );
  script_set_attribute(
    attribute:"see_also",
