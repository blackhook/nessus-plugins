...
# extracted from openSUSE Security Update cpio-4180.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : cpio (cpio-4180)");
  script_summary(english:"Check for the cpio-4180 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"cpio-2.6-19.17") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"cpio-2.6-42") ) flag++;
