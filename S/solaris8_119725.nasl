...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 119725-06");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"119725-06", obsoleted_by:"", package:"SUNWljdk", version:"1.0,REV=2004.10.11.06.02") < 0) flag++;
