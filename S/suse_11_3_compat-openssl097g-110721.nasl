...
if ( rpm_check(release:"SUSE11.3", reference:"compat-openssl097g-0.9.7g-155.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"compat-openssl097g-32bit-0.9.7g-155.3.1") ) flag++;
