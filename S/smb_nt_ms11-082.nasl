...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2578757");
...
services to become unresponsive."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-082");
  script_set_attribute(
    attribute:"solution",
    value:
