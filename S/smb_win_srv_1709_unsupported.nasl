...
if (description)
{
  ...
  script_name(english:"Microsoft Windows Server Version 1709 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:
"The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows Server version 1709 is running on the remote host.
Microsoft ended support for Windows Server version 1709 on Apr 9, 2019.
...
product_name  = "Windows Server version 1709";
tag           = "microsoft:windows_server_1709";
cpe_ver       = "-:*";
