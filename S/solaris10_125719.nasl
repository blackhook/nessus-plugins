...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 125719-58 (deprecated)");
  script_summary(english:"Check for patch 125719-58");
...
125719 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/125719-58"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"n/a"
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 125719 instead.");
