...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150.83-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_83-default-3-150000.2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15']}
        ]
      }
    }
  }
