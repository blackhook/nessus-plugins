...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : jul2019_SRU11_3_36_13_0");
...
security update :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    Sun Systems Products Suite (component: Kernel).
    Supported versions that are affected are 11.4 and 11.3.
    Easily exploitable vulnerability allows unauthenticated
    attacker with network access via IPv6 to compromise
    ...
    DOS) of Oracle Solaris. (CVE-2019-5597)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.oracle.com/epmos/faces/DocumentDisplay?id=2560938.1"
  );
  # https://www.oracle.com/ocom/groups/public/@otn/documents/webcontent/5572395.xml
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?561cd719"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.oracle.com/security-alerts/cpujul2019.html"
  );
  script_set_attribute(
    attribute:"solution",
...
fix_release = "0.5.11-0.175.3.36.0.13.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.36.0.13.0", sru:"11.3.36.13.0") > 0) flag++;
