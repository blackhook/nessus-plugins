...
if (description)
{
  ...
  script_cve_id("CVE-2015-0448", "CVE-2015-2578");

  script_name(english:"Oracle Solaris Critical Patch Update : apr2015_SRU11_2_8_5_0");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: ZFS File system).
    The supported version that is affected is 11.2. Easily
    ...
    including arbitrary code execution. (CVE-2015-0448)

  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: Kernel IDMap). The
    supported version that is affected is 11.2. Difficult to
    ...
    (complete DOS). (CVE-2015-2578)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.oracle.com/epmos/faces/DocumentDisplay?id=1993991.1"
  );
  # https://www.oracle.com/ocom/groups/public/@otn/documents/webcontent/2367958.xml
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fa693492"
  );
  script_set_attribute(
    attribute:"solution",
...
fix_release = "0.5.11-0.175.2.8.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.2.8.0.5.0", sru:"11.2.8.5.0") > 0) flag++;
