...
# extracted from openSUSE Security Update audacity-5997.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : audacity (audacity-5997)");
  script_summary(english:"Check for the audacity-5997 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"audacity-1.3.3-46.2") ) flag++;
