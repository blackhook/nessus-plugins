...
the secure_path setting. (CVE-2010-1646)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1006&L=scientific-linux-errata&T=0&P=1006
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f527920c"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"sudo-1.7.2p1-7.el5_5")) flag++;
