...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"951071");
...
remote host with SYSTEM privileges." );
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2008/ms08-065");
