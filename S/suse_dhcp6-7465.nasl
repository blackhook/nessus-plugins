...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : dhcp6 (ZYPP Patch Number 7465)");
...
needs to sanitize the host name offered by the server. (CVE-2011-0997)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7465.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:4, reference:"dhcp6-1.0.11-0.13.9")) flag++;
