...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kvm on SL5.x x86_64 (20160927)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1609&L=scientific-linux-errata&F=&S=&P=8686
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b069b410"
  );
