...
and page are affected.");
  script_set_attribute(attribute:"see_also", value:"https://forum.snitz.com/forum/Topic/Posts/68812?pagenum=-1");
  script_set_attribute(attribute:"solution", value:
"Apply the patch referenced in the vendor's security notice.");
