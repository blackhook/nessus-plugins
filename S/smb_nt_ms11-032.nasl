...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2507618");
...
in kernel mode."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-032");
  script_set_attribute(
    attribute:"solution",
    value:
