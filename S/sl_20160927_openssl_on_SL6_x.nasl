...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl on SL6.x, SL7.x i386/x86_64 (20160927)");
...
enable them by default.
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1609&L=scientific-linux-errata&F=&S=&P=9018
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d34e41aa"
  );
