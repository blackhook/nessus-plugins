...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sudo on SL6.x i386/x86_64 (20131121)");
...
In addition, this update adds the following enhancements :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=2951
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b44a6cac"
  );
  script_set_attribute(
    attribute:"solution", 
