...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2957189");
  script_xref(name:"MSKB", value:"2961858");
...
system to stop responding until it is restarted.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-031");
