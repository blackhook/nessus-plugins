...
if (description)
{
  ...
  script_cve_id("CVE-2016-0669");

  script_name(english:"Oracle Solaris Critical Patch Update : apr2016_SRU11_3_6_5_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: Fwflash). The
...
fix_release = "0.5.11-0.175.3.6.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.6.0.5.0", sru:"11.3.6.5.0") > 0) flag++;
