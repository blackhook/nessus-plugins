...
if ( rpm_check(release:"SUSE11.2", reference:"opera-11.00-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"opera-gtk-11.00-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"opera-kde4-11.00-1.2.1") ) flag++;
