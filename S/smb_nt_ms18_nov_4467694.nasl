...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4467694");
  script_xref(name:"MSFT", value:"MS18-4467694");

  script_name(english:"KB4467694: Security update for Adobe Flash Player (November 2018)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host has a browser plugin installed that is
affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update KB4467694. It is,
...
"Microsoft has released KB4467694 to address this issue.");
...
# all <= 31.0.0.122
fix = FALSE;
if(ver_compare(ver:iver, fix:"31.0.0.122", strict:FALSE) <= 0)
  fix = "31.0.0.148";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS18-11', kb:'4467694', report);
