...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba on SL7.x x86_64 (20170921)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4de020a5"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libsmbclient-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libsmbclient-devel-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libwbclient-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libwbclient-devel-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-client-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-client-libs-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"samba-common-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-common-libs-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-common-tools-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-dc-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-dc-libs-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-debuginfo-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-devel-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-krb5-printing-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-libs-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"samba-pidl-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-python-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-test-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-test-libs-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-vfs-glusterfs-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-clients-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-krb5-locator-4.6.2-11.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"samba-winbind-modules-4.6.2-11.el7_4")) flag++;
