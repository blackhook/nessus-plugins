...
# extracted from openSUSE Security Update libsndfile-949.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libsndfile (libsndfile-949)");
  script_summary(english:"Check for the libsndfile-949 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"libsndfile-1.0.17-171.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libsndfile-devel-1.0.17-171.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libsndfile-octave-1.0.17-171.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libsndfile-progs-1.0.17-171.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libsndfile-32bit-1.0.17-171.9.1") ) flag++;
