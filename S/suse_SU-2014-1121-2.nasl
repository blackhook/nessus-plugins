...
# extracted from SUSE update advisory SUSE-SU-2014:1121-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED11 / SLES11 Security Update : kdelibs4 (SUSE-SU-2014:1121-2)");
...
without introducing additional issues."
  ...
  # https://download.suse.com/patch/finder/?keywords=4f8706278a1e76233f67163bb601296d
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5128ffa"
  );
  # https://www.suse.com/support/update/announcement/2014/suse-su-20141121-2.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?968ec164"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch sdksp3-kdelibs4-9676

SUSE Linux Enterprise Server 11 SP3 for VMware :

zypper in -t patch slessp3-kdelibs4-9676
...
zypper in -t patch sledsp3-kdelibs4-9676
...
To bring your system up-to-date, use 'zypper patch'."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kdelibs4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kdelibs4-core");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kdelibs4-doc");
