...
var pkgs = [
    {'reference':'python3-PyJWT-1.5.3-150000.3.3.1', 'sp':'0', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15', 'SLE_HPC-release-15', 'sle-module-public-cloud-release-15', 'sles-release-15']}
];
