...
# extracted from openSUSE Security Update bluez-audio-6197.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : bluez-audio (bluez-audio-6197)");
  script_summary(english:"Check for the bluez-audio-6197 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"bluez-cups-3.18-13.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"bluez-test-3.18-13.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"bluez-utils-3.18-13.7") ) flag++;
