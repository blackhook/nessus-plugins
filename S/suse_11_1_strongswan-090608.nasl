...
# extracted from openSUSE Security Update strongswan-965.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : strongswan (strongswan-965)");
  script_summary(english:"Check for the strongswan-965 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"strongswan-4.2.8-1.25.1") ) flag++;
