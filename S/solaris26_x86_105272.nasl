...
if(description)
{
 script_id(23174);
 script_version ("1.11");
 name["english"] = "Solaris 2.6 (i386) : 105272-13";
...
"https://getupdates.oracle.com/readme/105272-13" );
...
e +=  solaris_check_patch(release:"5.6_x86", arch:"i386", patch:"105272-13", obsoleted_by:"", package:"SUNWsds", version:"1.0,PATCH=13");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
