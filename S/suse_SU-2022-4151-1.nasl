...
the SUSE-SU-2022:4151-1 advisory.
...
var pkgs = [
    {'reference':'cni-plugins-0.8.6-150000.1.7.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15', 'SLE_HPC-release-15', 'sle-module-public-cloud-release-15', 'sles-release-15']}
];
