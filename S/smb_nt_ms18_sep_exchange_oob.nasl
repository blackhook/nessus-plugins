...
if (description)
{
  ...
  script_cve_id("CVE-2018-8154");
  script_bugtraq_id(104054);
  script_xref(name:"MSKB", value:"4458321");
  script_xref(name:"MSFT", value:"MS18-4458321");

  script_name(english:"Security Update for Exchange (September 2018)");
  script_summary(english:"Checks for Microsoft security updates.");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Exchange Server installed on the remote host is affected by a
...
a remote code execution vulnerability :
  ...
  - A remote code execution vulnerability exists in
    ...
    (CVE-2018-8154)");
  # https://support.microsoft.com/en-hk/help/4458321/update-rollup-24-for-exchange-server-2010-service-pack-3
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bac29e4");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4458321 to address this issue.");
