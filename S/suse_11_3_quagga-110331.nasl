...
"This security update of quagga fixes :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00000.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"quagga-0.99.17-1.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"quagga-devel-0.99.17-1.5.1") ) flag++;
