...
if (description)
{
  ...
  script_cve_id("CVE-2021-33677");
  script_xref(name:"IAVA", value:"2021-A-0310");

  script_name(english:"SAP NetWeaver AS ABAP and ABAP Information Disclosure (3044754)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver server is affected by an information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"An information disclosure vulnerability exists in SAP NetWeaver Application Server ABAP. ABAP Server 
and ABAP Platform may expose functions externally that can lead to an information disclosure.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3044754");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-33677");
