...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2589320");
  script_xref(name:"MSKB", value:"2596785");
...
in arbitrary code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-089");
  script_set_attribute(
    attribute:"solution",
    value:
