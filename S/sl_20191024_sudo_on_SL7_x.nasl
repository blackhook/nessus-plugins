...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sudo on SL7.x x86_64 (20191024)");
...
"Security Fix(es) :
  ...
  - sudo: Privilege escalation via 'Runas' specification
    with 'ALL' keyword (CVE-2019-14287)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1910&L=SCIENTIFIC-LINUX-ERRATA&P=10003
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dd4cc21f"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sudo-1.8.23-4.el7_7.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sudo-debuginfo-1.8.23-4.el7_7.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sudo-devel-1.8.23-4.el7_7.1")) flag++;
