...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : apache (cve_2013_2765_denial_of)");
...
security updates :
  ...
  - The ModSecurity module before 2.7.4 for the Apache HTTP
    Server allows remote attackers to cause a denial of
    service (NULL pointer dereference, process crash, and
    disk consumption) via a POST request with a large body
    and a crafted Content-Type header. (CVE-2013-2765)"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2013-2765-denial-of-servicedos-vulnerability-in-apache-http-server"
  );
