...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x, SL7.x i386/x86_64 (20160803)");
...
Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1608&L=scientific-linux-errata&F=&S=&P=2347
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a328792c"
  );
  script_set_attribute(
    attribute:"solution", 
