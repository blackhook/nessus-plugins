...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 148403-01 (deprecated)");
...
148403 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 148403 instead.");
