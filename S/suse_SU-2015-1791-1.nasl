...
# extracted from SUSE update advisory SUSE-SU-2015:1791-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : strongswan (SUSE-SU-2015:1791-1)");
...
This security issue was fixed :
  ...
  - CVE-2015-4171: A problem that could enable rogue servers
    to gain user credentials from a client in certain IKEv2
    setups. (bsc#933591)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c9275a4a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch slessp4-strongswan-12152=1

SUSE Linux Enterprise Debuginfo 11-SP4 :

zypper in -t patch dbgsp4-strongswan-12152=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"strongswan-4.4.0-6.29.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"strongswan-doc-4.4.0-6.29.2")) flag++;
