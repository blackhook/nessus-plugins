...
if ( rpm_check(release:"SUSE11.1", reference:"libopenssl-devel-0.9.8h-28.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libopenssl0_9_8-0.9.8h-28.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"openssl-0.9.8h-28.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"openssl-certs-0.9.8h-25.2.7") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libopenssl0_9_8-32bit-0.9.8h-28.10.1") ) flag++;
