...
commands to SAProuter.");
  ...
  # https://erpscan.com/advisories/erpscan-13-023-saprouter-authentication-bypass/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6db5b37c");
