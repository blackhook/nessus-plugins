...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2718523");
...
kernel-mode drivers that could allow elevation of privilege :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.secureauth.com/labs/advisories/windows-kernel-readlayoutfile");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/523557/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-047");
  script_set_attribute(
    attribute:"solution",
    value:
