...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kvm on SL5.x x86_64 (20120221)");
...
backported patches to correct these issues."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1203&L=scientific-linux-errata&T=0&P=770
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?030e0f2a"
  );
