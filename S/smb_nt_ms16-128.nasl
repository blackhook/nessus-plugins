...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS16-128");
  script_xref(name:"MSKB", value:"3201860");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/03/24");

  script_name(english:"MS16-128: Security Update for Adobe Flash Player (3201860)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host has a browser plugin installed that is
affected by an arbitrary code execution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing KB3201860. It is, therefore,
...
in the execution of arbitrary code in the context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-128");
...
if (info != '')
{
  ...
  hotfix_add_report(bulletin:'MS16-128', kb:'3201860', report);
