...
if ( rpm_check(release:"SUSE11.0", reference:"ConsoleKit-0.2.10-14.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ConsoleKit-devel-0.2.10-14.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ConsoleKit-x11-0.2.10-14.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"ConsoleKit-32bit-0.2.10-14.4") ) flag++;
