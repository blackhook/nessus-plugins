...
if (description)
{
  ...
  script_name(english:"SAP Sybase Adaptive Server Enterprise Information Disclosure (SAP Note 1893562)");
...
"Information about SAP Sybase ASE may be discovered in database dump
files.  This information may be used by an attacker to create targeted
attacks against SAP Sybase ASE.");
  script_set_attribute(attribute:"see_also", value:"https://service.sap.com/sap/support/notes/1893562");
