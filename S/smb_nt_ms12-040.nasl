...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2711239");
...
This plugin checks if the system is missing KB2711239."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-040");
  script_set_attribute(
    attribute:"solution",
    value:
