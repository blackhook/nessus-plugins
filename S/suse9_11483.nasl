...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : XMMS (YOU Patch Number 11483)");
...
files. (CVE-2007-0653 / CVE-2007-0654)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11483.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"xmms-1.2.10-44.6")) flag++;
if (rpm_check(release:"SUSE9", reference:"xmms-devel-1.2.10-44.6")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"xmms-32bit-9-200704052143")) flag++;
