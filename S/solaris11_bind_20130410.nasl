...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : bind (cve_2012_3817_denial_of)");
...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2012-3817-denial-of-service-dos-vulnerability-in-bind"
  );
