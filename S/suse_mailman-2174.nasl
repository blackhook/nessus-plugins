...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : mailman (ZYPP Patch Number 2174)");
...
"This update of mailman fixes the following security issues :
  ...
  - Several cross-site scripting issues have been fixed.
    ...
    CVE-2006-3636: - Fixed an unexploitable format string
    vulnerability. Discovery and fix by Karl Chen. Analysis
    of non-exploitability by Martin 'Joey' Schulze. Also
    thanks go to Lionel Elie Mamane. CVE-2006-2191."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 2174.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:0, reference:"mailman-2.1.7-15.5")) flag++;
