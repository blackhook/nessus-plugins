...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3057154");
...
DES encryption for secure communication.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/3057154/microsoft-security-advisory-update-to-harden-use-of-des-encryption-jul");
