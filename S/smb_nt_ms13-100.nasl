...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2850058");
  script_xref(name:"MSKB", value:"2553298");
  script_xref(name:"MSKB", value:"2837629");
  script_xref(name:"MSKB", value:"2837631");
  script_xref(name:"MSKB", value:"2910228");
...
remote host subject to the privileges of the W3WP service account.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-100");
...
SharePoint Server 2013 and Office Web Apps 2013.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-5059");
