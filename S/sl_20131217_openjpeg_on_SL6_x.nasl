...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openjpeg on SL6.x i386/x86_64 (20131217)");
...
All running applications using OpenJPEG must be restarted for the
update to take effect."
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=5174
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f06b5c62"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"openjpeg-1.3-10.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"openjpeg-debuginfo-1.3-10.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"openjpeg-devel-1.3-10.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"openjpeg-libs-1.3-10.el6_5")) flag++;
