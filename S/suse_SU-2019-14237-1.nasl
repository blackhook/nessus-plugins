...
# SUSE update advisory SUSE-SU-2019:14237-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2019:14237-1");

  script_name(english:"SUSE SLES11 Security Update : permissions (SUSE-SU-2019:14237-1)");
...
number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2019-December/006220.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52530f46");
...
pkgs = [
    {'reference':'permissions-2013.1.7-0.6.5', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'permissions-2013.1.7-0.6.5', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
