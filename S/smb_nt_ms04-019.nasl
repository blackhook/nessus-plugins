...
if (description)
{
 ...
 script_xref(name:"MSFT", value:"MS04-019");
 script_xref(name:"MSKB", value:"842526");

 script_name(english:"MS04-019: Utility Manager Could Allow Code Execution (842526)");
 script_summary(english:"Checks for ms04-019 over the registry");

 script_set_attribute(attribute:"synopsis", value:"Local users can elevate their privileges.");
 script_set_attribute(attribute:"description", value:
"The remote host is running a version of the Utility Manager that could
...
system.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2004/ms04-019");
...
if (hotfix_is_vulnerable(os:"5.0", file:"Umandlg.dll", version:"1.0.0.5", dir:"\system32", bulletin:bulletin, kb:kb))
{
