...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : 389-ds-base on SL6.x i386/x86_64 (20140313)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1403&L=scientific-linux-errata&T=0&P=1075
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?338ead72"
  );
