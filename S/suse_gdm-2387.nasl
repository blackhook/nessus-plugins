...
# extracted from openSUSE Security Update gdm-2387.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gdm (gdm-2387)");
  script_summary(english:"Check for the gdm-2387 patch");
...
exploited to execute code under a different user id."
  );
...
if ( rpm_check(release:"SUSE10.2", reference:"gdm-2.16.1-36.2") ) flag++;
