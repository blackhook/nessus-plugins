...
# extracted from SUSE update advisory SUSE-SU-2020:2216-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : python36 (SUSE-SU-2020:2216-1)");
...
CVE-2020-14422, bsc#1173274: where hash collisions in IPv4Interface
and IPv6Interface could lead to DOS.
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20202216-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0dce8ac7"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython3_6m1_0-3.6.10-4.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libpython3_6m1_0-debuginfo-3.6.10-4.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-3.6.10-4.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-base-3.6.10-4.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-base-debuginfo-3.6.10-4.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-base-debugsource-3.6.10-4.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-debuginfo-3.6.10-4.17.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"python36-debugsource-3.6.10-4.17.1")) flag++;
