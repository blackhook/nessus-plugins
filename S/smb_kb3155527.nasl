...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3155527");
...
an attacker's chosen cipher suite from the client's list.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2016/3155527");
