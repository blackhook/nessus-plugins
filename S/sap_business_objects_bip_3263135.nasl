...
if (description)
{
  ...
  script_cve_id("CVE-2023-0020");
  script_xref(name:"IAVA", value:"2023-A-0076");

  script_name(english:"SAP BusinessObjects Business Intelligence Platform Information Disclosure (3263135)");
...
4.2 SP9 P12, 4.3 SP2 P9, 4.3 SP3 P1 or 4.3 SP4. It is, therefore, affected by an information disclosure vulnerability.
An authenticated, remote attacker can access sensitive information which is otherwise restricted.

Note that Nessus has not attempted to exploit these issues but has instead relied only on the application's
self-reported version number.");
  # https://www.sap.com/documents/2022/02/fa865ea4-167e-0010-bca6-c68f7e60039b.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18f404d5");
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3263135");
...
"See vendor advisories.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0020");
