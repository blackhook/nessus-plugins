...
this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1104&L=scientific-linux-errata&T=0&P=2096
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77123f56"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libtiff-3.9.4-1.el6_0.3")) flag++;
if (rpm_check(release:"SL6", reference:"libtiff-devel-3.9.4-1.el6_0.3")) flag++;
if (rpm_check(release:"SL6", reference:"libtiff-static-3.9.4-1.el6_0.3")) flag++;
