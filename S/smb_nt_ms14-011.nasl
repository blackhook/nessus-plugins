...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2909210");
  script_xref(name:"MSKB", value:"2909212");
  script_xref(name:"MSKB", value:"2909213");
...
code on the affected system, subject to the user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-011");
  script_set_attribute(
    attribute:"solution",
    value:
