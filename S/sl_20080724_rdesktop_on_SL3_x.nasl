...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rdesktop on SL3.x i386/x86_64");
...
possibly, execute an arbitrary code. (CVE-2008-1801)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0807&L=scientific-linux-errata&T=0&P=2387
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?010f5945"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"rdesktop-1.2.0-3")) flag++;
