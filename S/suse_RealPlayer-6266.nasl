...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : RealPlayer (ZYPP Patch Number 6266)");
...
file system permissions."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2007-5400.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6266.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"RealPlayer-10.0.9-2.7")) flag++;
