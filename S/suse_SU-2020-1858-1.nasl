...
# extracted from SUSE update advisory SUSE-SU-2020:1858-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : permissions (SUSE-SU-2020:1858-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2c5cf365"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-2020-1858=1

SUSE Linux Enterprise Server 15-LTSS :

zypper in -t patch SUSE-SLE-Product-SLES-15-2020-1858=1

SUSE Linux Enterprise High Performance Computing 15-LTSS :

zypper in -t patch SUSE-SLE-Product-HPC-15-2020-1858=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"permissions-20180125-3.27.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"permissions-debuginfo-20180125-3.27.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"permissions-debugsource-20180125-3.27.1")) flag++;
