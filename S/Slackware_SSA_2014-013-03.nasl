...
# extracted from Slackware Security Advisory 2014-013-03. The text 
...
if (description)
{
  ...
  script_xref(name:"SSA", value:"2014-013-03");

  script_name(english:"Slackware 14.0 / 14.1 / current : php (SSA:2014-013-03)");
...
to fix a security issue."
  ...
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2014&m=slackware-security.409445
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ee78b724"
  );
...
if (slackware_check(osver:"current", pkgname:"php", pkgver:"5.4.24", pkgarch:"i486", pkgnum:"1")) flag++;
if (slackware_check(osver:"current", arch:"x86_64", pkgname:"php", pkgver:"5.4.24", pkgarch:"x86_64", pkgnum:"1")) flag++;
