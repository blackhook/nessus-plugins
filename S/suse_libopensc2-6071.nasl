...
# extracted from openSUSE Security Update libopensc2-6071.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libopensc2 (libopensc2-6071)");
  script_summary(english:"Check for the libopensc2-6071 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libopensc2-0.11.3-21.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"opensc-0.11.3-21.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"opensc-devel-0.11.3-21.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libopensc2-32bit-0.11.3-21.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"opensc-32bit-0.11.3-21.6") ) flag++;
