...
flag = 0;
if (rpm_check(release:"SLES11", sp:0, cpu:"i586", reference:"websphere-as_ce-2.1.1.2-2.2")) flag++;
if (rpm_check(release:"SLES11", sp:0, cpu:"x86_64", reference:"websphere-as_ce-2.1.1.2-2.2")) flag++;
