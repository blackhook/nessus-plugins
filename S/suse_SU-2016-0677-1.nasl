...
# extracted from SUSE update advisory SUSE-SU-2016:0677-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED11 / SLES11 Security Update : postgresql94 (SUSE-SU-2016:0677-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160677-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea2ea61a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libpq5-32bit-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"libpq5-32bit-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libecpg6-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libpq5-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-contrib-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-docs-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-server-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"x86_64", reference:"libecpg6-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"x86_64", reference:"libpq5-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"x86_64", reference:"postgresql94-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"x86_64", reference:"postgresql94-docs-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"x86_64", reference:"libpq5-32bit-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"i586", reference:"libecpg6-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"i586", reference:"libpq5-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"i586", reference:"postgresql94-9.4.6-0.14.3")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"i586", reference:"postgresql94-docs-9.4.6-0.14.3")) flag++;
