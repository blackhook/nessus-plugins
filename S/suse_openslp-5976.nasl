...
# extracted from openSUSE Security Update openslp-5976.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : openslp (openslp-5976)");
  script_summary(english:"Check for the openslp-5976 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"openslp-1.2.0-96.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"openslp-devel-1.2.0-96.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"openslp-server-1.2.0-96.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"openslp-32bit-1.2.0-96.2") ) flag++;
