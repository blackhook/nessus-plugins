...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : gv (YOU Patch Number 11335)");
...
display and crash. Code execution however was not possible."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11335.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"gv-3.5.8-1129.10")) flag++;
