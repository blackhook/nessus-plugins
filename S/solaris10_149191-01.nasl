...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 149191-01");
  script_summary(english:"Check for patch 149191-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 149191-01"
  );
  script_set_attribute(
...
Solaris accessible data."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/149191-01"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 149191-01 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:N");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3131");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:149191");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"149191-01", obsoleted_by:"147147-26 147440-26 ", package:"SUNWnfssu", version:"11.10.0,REV=2005.01.21.15.53") < 0) flag++;
