...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : pam (ZYPP Patch Number 7815)");
...
inside pam_xauth has been fixed. (CVE-2010-3316)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7815.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"pam-0.99.6.3-28.20.3.4")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"pam-devel-0.99.6.3-28.20.3.4")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"pam-32bit-0.99.6.3-28.20.3.4")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"pam-devel-32bit-0.99.6.3-28.20.3.4")) flag++;
