...
if(description)
{
 ...
 script_name(english: "Solaris 2.6 (x86) : 105182-38");
 script_set_attribute(attribute: "synopsis", value:
"The remote host is missing Sun Security Patch number 105182-38");
 script_set_attribute(attribute: "description", value:
'SunOS 5.6_x86: kernel update patch.
Date this patch was last updated by Sun : Mar/04/04');
 script_set_attribute(attribute: "solution", value:
"You should install this patch for your system to be up-to-date.");
 script_set_attribute(attribute: "see_also", value:
"https://getupdates.oracle.com/readme/105182-38");
 script_set_attribute(attribute: "risk_factor", value: "Medium");
 script_set_attribute(attribute:"plugin_publication_date", value: "2004/07/12");
 script_end_attributes();

 script_summary(english: "Check for patch 105182-38");
...
e +=  solaris_check_patch(release:"5.6_x86", arch:"i386", patch:"105182-38", obsoleted_by:"", package:"SUNWcar", version:"11.6.0,REV=1997.07.16.00.21");
