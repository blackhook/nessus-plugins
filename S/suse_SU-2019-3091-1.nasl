...
# extracted from SUSE update advisory SUSE-SU-2019:3091-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : ucode-intel (SUSE-SU-2019:3091-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1157004"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd283a9a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
SUSE-SLE-SERVER-12-SP5-2019-3091=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"ucode-intel-20191115-3.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"ucode-intel-debuginfo-20191115-3.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", cpu:"x86_64", reference:"ucode-intel-debugsource-20191115-3.3.1")) flag++;
