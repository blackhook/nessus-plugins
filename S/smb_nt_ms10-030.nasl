...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2010-B-0039-S");
  script_xref(name:"MSFT", value:"MS10-030");
  script_xref(name:"MSKB", value:"978542");
...
victim's email client.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?1e5b69c4");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Outlook Express and
Windows Mail.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0816");
