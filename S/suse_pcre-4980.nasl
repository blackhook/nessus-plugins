...
# extracted from openSUSE Security Update pcre-4980.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : pcre (pcre-4980)");
  script_summary(english:"Check for the pcre-4980 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"pcre-7.2-14.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pcre-devel-7.2-14.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"pcre-32bit-7.2-14.4") ) flag++;
