...
if (description)
{
  ...
  script_name(english:"Sun Java J2SE 1.4.2 < Update 18 Multiple Vulnerabilities (Unix)");
...
on the remote host is affected by multiple security issues :
  ...
  - A buffer overflow vulnerability in the font processing
    ...
    of the user running an untrusted applet (238666).
  ...
  - A vulnerability in the JRE may allow an untrusted applet
    ...
    local host and potentially exploit vulnerabilities
