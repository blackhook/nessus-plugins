...
# extracted from openSUSE Security Update dovecot20-4610.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dovecot20 (dovecot20-4610)");
  script_summary(english:"Check for the dovecot20-4610 patch");
...
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-backend-mysql-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-backend-mysql-debuginfo-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-backend-pgsql-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-backend-pgsql-debuginfo-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-backend-sqlite-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-backend-sqlite-debuginfo-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-debuginfo-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-debugsource-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-devel-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-fts-solr-2.0.13-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dovecot20-fts-solr-debuginfo-2.0.13-0.3.1") ) flag++;
