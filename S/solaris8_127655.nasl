...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 127655-07");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"127655-07", obsoleted_by:"", package:"SYMCnetbp", version:"6.5,REV=2007.07.24.02.54") < 0) flag++;
