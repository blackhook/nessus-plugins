...
# extracted from SUSE update advisory SUSE-SU-2018:0039-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : kvm (SUSE-SU-2018:0039-1) (Spectre)");
  ...
  script_set_attribute(
    ...
    value:
"This update for kvm fixes the following issues: A security flaw
mitigation has been applied :
  ...
  - CVE-2017-5715: QEMU was updated to allow passing through
    ...
    the Intel CPU. (bsc#1068032) Also a security fix has
    been applied :
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4b794d1d"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"3", reference:"kvm-1.4.2-53.14.1")) flag++;
