...
if ( rpm_check(release:"SUSE11.1", reference:"compat-openssl097g-0.9.7g-146.11.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"compat-openssl097g-32bit-0.9.7g-146.11.1") ) flag++;
