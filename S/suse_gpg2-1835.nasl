...
# extracted from openSUSE Security Update gpg2-1835.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gpg2 (gpg2-1835)");
  script_summary(english:"Check for the gpg2-1835 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"gpg2-1.9.18-17.5") ) flag++;
