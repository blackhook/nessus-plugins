...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3081320");
...
the attack is initiated.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-121");
