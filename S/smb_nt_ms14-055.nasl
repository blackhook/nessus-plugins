...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2982390");
  script_xref(name:"MSKB", value:"2986072");
  script_xref(name:"MSKB", value:"2982389");
  script_xref(name:"MSKB", value:"2992965");
  script_xref(name:"MSKB", value:"2982388");
  script_xref(name:"MSKB", value:"2982385");
...
affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-055");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Microsoft Lync Server 2010
and 2013.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4070");
