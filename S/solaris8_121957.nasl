...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 121957-01");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"121957-01", obsoleted_by:"124520-01 123038-01 ", package:"SUNWsgeex", version:"6.0,REV=2004.06.03.16.00") < 0) flag++;
