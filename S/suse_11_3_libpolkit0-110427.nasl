...
# extracted from openSUSE Security Update libpolkit0-4440.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpolkit0 (openSUSE-SU-2011:0412-1)");
  script_summary(english:"Check for the libpolkit0-4440 patch");
...
assigned to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00080.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"libpolkit0-0.96-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"polkit-0.96-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"polkit-devel-0.96-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libpolkit0-32bit-0.96-5.3.1") ) flag++;
