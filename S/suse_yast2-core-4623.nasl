...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : YaST2 (ZYPP Patch Number 4623)");
...
Stefan Nordhausen for reporting this to us."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 4623.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:1, reference:"yast2-core-2.13.41-0.2")) flag++;
if (rpm_check(release:"SLES10", sp:1, reference:"yast2-core-2.13.41-0.2")) flag++;
if (rpm_check(release:"SLES10", sp:1, reference:"yast2-core-devel-2.13.41-0.2")) flag++;
