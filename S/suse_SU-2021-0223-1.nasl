...
# extracted from SUSE update advisory SUSE-SU-2021:0223-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : go1.15 (SUSE-SU-2021:0223-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?88c2d65c");
...
zypper in -t patch SUSE-SLE-Product-SUSE-Manager-Server-4.0-2021-223=1

SUSE Manager Retail Branch Server 4.0 :

zypper in -t patch
SUSE-SLE-Product-SUSE-Manager-Retail-Branch-Server-4.0-2021-223=1

SUSE Manager Proxy 4.0 :

zypper in -t patch SUSE-SLE-Product-SUSE-Manager-Proxy-4.0-2021-223=1

SUSE Linux Enterprise Server for SAP 15-SP1 :

zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-SP1-2021-223=1

SUSE Linux Enterprise Server 15-SP1-LTSS :

zypper in -t patch SUSE-SLE-Product-SLES-15-SP1-LTSS-2021-223=1

SUSE Linux Enterprise Server 15-SP1-BCL :

zypper in -t patch SUSE-SLE-Product-SLES-15-SP1-BCL-2021-223=1

SUSE Linux Enterprise Module for Development Tools 15-SP2 :

zypper in -t patch SUSE-SLE-Module-Development-Tools-15-SP2-2021-223=1

SUSE Linux Enterprise High Performance Computing 15-SP1-LTSS :

zypper in -t patch SUSE-SLE-Product-HPC-15-SP1-LTSS-2021-223=1

SUSE Linux Enterprise High Performance Computing 15-SP1-ESPOS :

zypper in -t patch SUSE-SLE-Product-HPC-15-SP1-ESPOS-2021-223=1

SUSE Enterprise Storage 6 :

zypper in -t patch SUSE-Storage-6-2021-223=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"go1.15-1.15.7-1.17.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"go1.15-doc-1.15.7-1.17.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"go1.15-1.15.7-1.17.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"go1.15-doc-1.15.7-1.17.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"go1.15-1.15.7-1.17.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"go1.15-doc-1.15.7-1.17.1")) flag++;
