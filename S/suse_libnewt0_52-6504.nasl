...
# extracted from openSUSE Security Update libnewt0_52-6504.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libnewt0_52 (libnewt0_52-6504)");
  script_summary(english:"Check for the libnewt0_52-6504 patch");
...
CVE-2009-2905 has been assigned to this issue."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:newt-32bit");
...
if ( rpm_check(release:"SUSE10.3", reference:"newt-0.52.7-36.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"newt-devel-0.52.7-36.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"newt-static-0.52.7-36.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"newt-32bit-0.52.7-36.2") ) flag++;
