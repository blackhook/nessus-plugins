...
if(description)
{
 script_id(23464);
 script_version ("1.11");
 name["english"] = "Solaris 8 (i386) : 118619-01";
...
"https://getupdates.oracle.com/readme/118619-01" );
...
e +=  solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"118619-01", obsoleted_by:"", package:"SUNWjss", version:"3.1.2.3,REV=2003.03.08.13.04");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
