...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : pam_ldap (YOU Patch Number 11259)");
...
for xscreensaver. (CVE-2006-5170)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11259.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"pam_ldap-169-28.7")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"pam_ldap-32bit-9-200610241503")) flag++;
