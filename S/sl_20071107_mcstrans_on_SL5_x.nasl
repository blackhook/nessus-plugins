...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mcstrans on SL5.x i386/x86_64");
...
Multi-Level Security (MLS) Policy with multiple categories"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0711&L=scientific-linux-errata&T=0&P=1762
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76b7817f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"mcstrans-0.2.6-1.el5")) flag++;
