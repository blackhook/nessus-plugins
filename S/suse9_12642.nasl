...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : libpng (YOU Patch Number 12642)");
...
(CVE-2010-1205, CVE-2010-2249)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12642.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"libpng-1.2.5-182.30")) flag++;
if (rpm_check(release:"SUSE9", reference:"libpng-devel-1.2.5-182.30")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"libpng-32bit-9-201009011027")) flag++;
