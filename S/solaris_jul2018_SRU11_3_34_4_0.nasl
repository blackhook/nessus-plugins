...
if (description)
{
  ...
  script_cve_id("CVE-2018-1171", "CVE-2018-2926", "CVE-2018-2928");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2018_SRU11_3_34_4_0");
...
fix_release = "0.5.11-0.175.3.34.0.4.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.34.0.4.0", sru:"11.3.34.4.0") > 0) flag++;
