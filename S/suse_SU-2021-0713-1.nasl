...
# extracted from SUSE update advisory SUSE-SU-2021:0713-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : freeradius-server (SUSE-SU-2021:0713-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?92b7d000"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-debugsource-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-doc-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-krb5-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-krb5-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-ldap-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-ldap-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-libs-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-libs-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-mysql-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-mysql-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-perl-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-perl-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-postgresql-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-postgresql-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-python-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-python-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-sqlite-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-sqlite-debuginfo-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-utils-3.0.19-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"freeradius-server-utils-debuginfo-3.0.19-3.6.1")) flag++;
