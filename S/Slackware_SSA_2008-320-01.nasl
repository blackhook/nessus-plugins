...
# extracted from Slackware Security Advisory 2008-320-01. The text 
...
if (description)
{
  ...
  script_name(english:"Slackware 12.0 / 12.1 / current : gnutls (SSA:2008-320-01)");
...
self-signed certificate may cause GnuTLS linked programs to crash."
  ...
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2008&m=slackware-security.366240
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?10eb1098"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (slackware_check(osver:"12.0", pkgname:"gnutls", pkgver:"2.6.2", pkgarch:"i486", pkgnum:"1_slack12.0")) flag++;

if (slackware_check(osver:"12.1", pkgname:"gnutls", pkgver:"2.6.2", pkgarch:"i486", pkgnum:"1_slack12.1")) flag++;

if (slackware_check(osver:"current", pkgname:"gnutls", pkgver:"2.6.2", pkgarch:"i486", pkgnum:"1")) flag++;
