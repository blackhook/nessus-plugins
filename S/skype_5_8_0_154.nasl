...
"The remote Skype install has an unspecified vulnerability.");
...
vulnerability.");
  script_set_attribute(attribute:"see_also", value:"http://blogs.skype.com/garage/2012/02/skype_for_windows_update.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Skype for Windows 5.8.0.154 or later.");
