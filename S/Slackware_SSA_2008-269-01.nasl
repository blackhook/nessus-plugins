...
# extracted from Slackware Security Advisory 2008-269-01. The text 
...
if (description)
{
  ...
  script_xref(name:"SSA", value:"2008-269-01");

  script_name(english:"Slackware 10.2 / 11.0 / 12.0 / 12.1 / current : mozilla-firefox (SSA:2008-269-01)");
...
12.0, 12.1, and -current to fix security issues."
  ...
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2008&m=slackware-security.405232
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ccd4aec3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (slackware_check(osver:"10.2", pkgname:"mozilla-firefox", pkgver:"2.0.0.17", pkgarch:"i686", pkgnum:"1")) flag++;

if (slackware_check(osver:"11.0", pkgname:"mozilla-firefox", pkgver:"2.0.0.17", pkgarch:"i686", pkgnum:"1")) flag++;

if (slackware_check(osver:"12.0", pkgname:"mozilla-firefox", pkgver:"2.0.0.17", pkgarch:"i686", pkgnum:"1")) flag++;

if (slackware_check(osver:"12.1", pkgname:"mozilla-firefox", pkgver:"2.0.0.17", pkgarch:"i686", pkgnum:"1")) flag++;

if (slackware_check(osver:"current", pkgname:"mozilla-firefox", pkgver:"3.0.2", pkgarch:"i686", pkgnum:"1")) flag++;
