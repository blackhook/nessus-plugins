...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : subversion on SL6.x i386/x86_64 (20150210)");
...
the svn:// protocol."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1502&L=scientific-linux-errata&T=0&P=772
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5385370c"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"mod_dav_svn-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-debuginfo-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-devel-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-gnome-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-javahl-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-kde-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-perl-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-ruby-1.6.11-12.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"subversion-svn2cl-1.6.11-12.el6_6")) flag++;
