...
# extracted from openSUSE Security Update libxml2-314.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxml2 (libxml2-314)");
  script_summary(english:"Check for the libxml2-314 patch");
...
crafted XML files (CVE-2008-4225)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=445677"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"libxml2-2.6.32-11.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libxml2-devel-2.6.32-11.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libxml2-32bit-2.6.32-11.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libxml2-devel-32bit-2.6.32-11.5") ) flag++;
