...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : clamav (ZYPP Patch Number 5416)");
...
but not mentioned. The update contains stability and bugfixes."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 5416.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"clamav-0.93.3-0.2")) flag++;
if (rpm_check(release:"SLES10", sp:1, reference:"clamav-0.93.3-0.2")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"clamav-0.93.3-0.2")) flag++;
