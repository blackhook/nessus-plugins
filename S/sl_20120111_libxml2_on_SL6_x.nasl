...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libxml2 on SL6.x i386/x86_64 (20120111)");
...
effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1201&L=scientific-linux-errata&T=0&P=576
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b7e3ac1"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libxml2-2.7.6-4.el6_2.1")) flag++;
if (rpm_check(release:"SL6", reference:"libxml2-debuginfo-2.7.6-4.el6_2.1")) flag++;
if (rpm_check(release:"SL6", reference:"libxml2-devel-2.7.6-4.el6_2.1")) flag++;
if (rpm_check(release:"SL6", reference:"libxml2-python-2.7.6-4.el6_2.1")) flag++;
if (rpm_check(release:"SL6", reference:"libxml2-static-2.7.6-4.el6_2.1")) flag++;
