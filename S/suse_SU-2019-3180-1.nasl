...
# extracted from SUSE update advisory SUSE-SU-2019:3180-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : permissions (SUSE-SU-2019:3180-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2019/suse-su-20193180-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1ec5a7b"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
SUSE-OpenStack-Cloud-Crowbar-8-2019-3180=1

SUSE OpenStack Cloud 8:zypper in -t patch
SUSE-OpenStack-Cloud-8-2019-3180=1

SUSE OpenStack Cloud 7:zypper in -t patch
SUSE-OpenStack-Cloud-7-2019-3180=1

SUSE Linux Enterprise Server for SAP 12-SP3:zypper in -t patch
SUSE-SLE-SAP-12-SP3-2019-3180=1

SUSE Linux Enterprise Server for SAP 12-SP2:zypper in -t patch
SUSE-SLE-SAP-12-SP2-2019-3180=1

SUSE Linux Enterprise Server 12-SP3-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2019-3180=1

SUSE Linux Enterprise Server 12-SP3-BCL:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-BCL-2019-3180=1

SUSE Linux Enterprise Server 12-SP2-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2019-3180=1

SUSE Linux Enterprise Server 12-SP2-BCL:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-BCL-2019-3180=1

SUSE Enterprise Storage 5:zypper in -t patch
SUSE-Storage-5-2019-3180=1
...
HPE-Helion-OpenStack-8-2019-3180=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"permissions-2015.09.28.1626-17.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"permissions-debuginfo-2015.09.28.1626-17.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"permissions-debugsource-2015.09.28.1626-17.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"permissions-2015.09.28.1626-17.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"permissions-debuginfo-2015.09.28.1626-17.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"permissions-debugsource-2015.09.28.1626-17.20.1")) flag++;
