...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ntp on SL5.x i386/x86_64 (20141220)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1412&L=scientific-linux-errata&T=0&P=3596
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60d976e2"
  );
  script_set_attribute(
    attribute:"solution", 
