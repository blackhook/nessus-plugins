...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4516115");
  script_xref(name:"MSFT", value:"MS19-4516115");
  script_xref(name:"IAVA", value:"2019-A-0321-S");

  script_name(english:"KB4516115: Security update for Adobe Flash Player (September 2019)");
...
"The remote Windows host is missing security update KB4516115. It is,
therefore, affected by multiple arbitrary code execution vulnerabilities
in Adobe Flash Player.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4516115");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4516115 to address this issue.");
...
# all <= 32.0.0.207
fix = FALSE;
if(ver_compare(ver:iver, fix:'32.0.0.207', strict:FALSE) <= 0)
  fix = '32.0.0.255';
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS19-09', kb:'4516115', report);
