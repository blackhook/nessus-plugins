...
if (description)
{
  ...
  script_cve_id("CVE-2023-31406");
  script_xref(name:"IAVA", value:"2023-A-0241");
  script_xref(name:"IAVA", value:"2023-A-0285");

  script_name(english:"SAP BusinessObjects Business Intelligence Platform XSS (3319400)");

  script_set_attribute(attribute:"synopsis", value:
"The SAP business intelligence product installed on the remote Windows host is affected by cross-site scripting vulnerability");
...
a cross-site scripting vulnerability. Due to insufficient input validation, SAP BusinessObjects Business Intelligence 
Platform - versions 420, 430, allows an unauthenticated attacker to redirect users to untrusted site using a malicious 
link. On successful exploitation, an attacker can view or modify information causing a limited impact on 
...
self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3319400");
...
"See vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-31406");
