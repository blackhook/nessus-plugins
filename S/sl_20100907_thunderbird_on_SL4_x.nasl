...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1009&L=scientific-linux-errata&T=0&P=1022
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6cab455"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"thunderbird-1.5.0.12-30.el4")) flag++;

if (rpm_check(release:"SL5", reference:"thunderbird-2.0.0.24-8.el5")) flag++;
