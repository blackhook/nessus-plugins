...
if ( rpm_check(release:"SUSE11.1", reference:"opera-10.63-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"opera-gtk-10.63-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"opera-kde4-10.63-1.1.1") ) flag++;
