...
relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f35f1c7");
  # https://download.samba.org/pub/samba/patches/security/samba-4.1.15-CVE-2014-8143.patch
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c6eaa6e");
