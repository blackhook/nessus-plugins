...
# extracted from openSUSE Security Update dovecot-6539.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : dovecot (dovecot-6539)");
  script_summary(english:"Check for the dovecot-6539 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"dovecot-1.0.5-6.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"dovecot-devel-1.0.5-6.6") ) flag++;
