...
# extracted from openSUSE Security Update bluez-audio-5441.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : bluez-audio (bluez-audio-5441)");
  script_summary(english:"Check for the bluez-audio-5441 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"bluez-cups-3.7-29.4") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"bluez-libs-3.7-14.3") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"bluez-test-3.7-29.4") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"bluez-utils-3.7-29.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"bluez-cups-3.18-13.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"bluez-libs-3.18-5.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"bluez-test-3.18-13.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"bluez-utils-3.18-13.2") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "bluez-cups / bluez-libs / bluez-test / bluez-utils");
}
