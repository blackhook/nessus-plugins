...
# extracted from openSUSE Security Update MozillaThunderbird-3973.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaThunderbird (MozillaThunderbird-3973)");
  script_summary(english:"Check for the MozillaThunderbird-3973 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes several security problems in Mozilla Thunderbird
1.5.0.12.
...
if ( rpm_check(release:"SUSE10.2", reference:"MozillaThunderbird-1.5.0.12-3.4") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"MozillaThunderbird-translations-1.5.0.12-3.4") ) flag++;
