...
if(description)
{
 script_id(24956);
 script_version ("1.8");
 name["english"] = "Solaris 2.5.1 (sparc) : 110029-02";
...
"https://getupdates.oracle.com/readme/110029-02" );
...
e +=  solaris_check_patch(release:"5.5.1", arch:"sparc", patch:"110029-02", obsoleted_by:"", package:"VRTSvmsa", version:"3.0.3,REV=08.27.1999.13.55");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
