...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 118667-86");
  script_summary(english:"Check for patch 118667-86");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 118667-86"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"118667-86", obsoleted_by:"", package:"SUNWj5dmx", version:"1.5.0,REV=2004.12.06.22.09") < 0) flag++;
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"118667-86", obsoleted_by:"", package:"SUNWj5dvx", version:"1.5.0,REV=2004.12.06.22.09") < 0) flag++;
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"118667-86", obsoleted_by:"", package:"SUNWj5rtx", version:"1.5.0,REV=2004.12.06.22.09") < 0) flag++;
