...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : coreutils on SL4.x i386/x86_64");
...
accounts using 'su'. (CVE-2008-1946)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0807&L=scientific-linux-errata&T=0&P=2977
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3213763e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"coreutils-5.2.1-31.8.el4")) flag++;
