...
# extracted from openSUSE Security Update MozillaFirefox-6379.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaFirefox (MozillaFirefox-6379)");
  script_summary(english:"Check for the MozillaFirefox-6379 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"MozillaFirefox-3.0.12-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"MozillaFirefox-translations-3.0.12-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mozilla-xulrunner190-1.9.0.12-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mozilla-xulrunner190-devel-1.9.0.12-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mozilla-xulrunner190-gnomevfs-1.9.0.12-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mozilla-xulrunner190-translations-1.9.0.12-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"python-xpcom190-1.9.0.12-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"mozilla-xulrunner190-32bit-1.9.0.12-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"mozilla-xulrunner190-gnomevfs-32bit-1.9.0.12-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"mozilla-xulrunner190-translations-32bit-1.9.0.12-1.1") ) flag++;
