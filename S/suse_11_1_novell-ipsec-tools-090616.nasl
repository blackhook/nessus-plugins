...
if ( rpm_check(release:"SUSE11.1", reference:"novell-ipsec-tools-0.7.1-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"novell-ipsec-tools-devel-0.7.1-2.5.1") ) flag++;
