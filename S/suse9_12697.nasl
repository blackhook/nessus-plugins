...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : dhcp6 (YOU Patch Number 12697)");
...
needs to sanitize the host name offered by the server. (CVE-2011-0996)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12697.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"dhcp6-0.10-18.8")) flag++;
