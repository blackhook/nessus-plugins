...
affected by multiple vulnerabilities :
  ...
  - A type confusion error exists that allows an
    unauthenticated, remote attacker to execute arbitrary
    code. (CVE-2017-2995)");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2017/ms17-005");
...
if (info != '')
{
  ...
  hotfix_add_report(bulletin:'MS17-005', kb:'4010250', report);
