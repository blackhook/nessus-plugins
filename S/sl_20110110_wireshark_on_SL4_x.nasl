...
take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1101&L=scientific-linux-errata&T=0&P=399
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?577fa777"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"wireshark-1.0.15-1.el4_8.3")) flag++;
if (rpm_check(release:"SL4", reference:"wireshark-gnome-1.0.15-1.el4_8.3")) flag++;

if (rpm_check(release:"SL5", reference:"wireshark-1.0.15-1.el5_5.3")) flag++;
if (rpm_check(release:"SL5", reference:"wireshark-gnome-1.0.15-1.el5_5.3")) flag++;
