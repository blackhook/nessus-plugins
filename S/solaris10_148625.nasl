...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 148625-01 (deprecated)");
...
148625 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 148625 instead.");
