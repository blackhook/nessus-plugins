...
flag = 0;
if (rpm_check(release:"SLED11", sp:0, cpu:"i586", reference:"wireshark-1.0.5-1.34.1")) flag++;
if (rpm_check(release:"SLES11", sp:0, cpu:"i586", reference:"wireshark-1.0.5-1.34.1")) flag++;
