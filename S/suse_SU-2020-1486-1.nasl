...
# extracted from SUSE update advisory SUSE-SU-2020:1486-1.
...
if (description)
{
  ...
  script_cve_id("CVE-2020-1749", "CVE-2020-12653", "CVE-2020-12654");

  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2020:1486-1)");
...
CVE-2020-1749: Fixed an improper implementation in some IPsec
protocols where the data were sent unencrypted allowing an attacker to
read them (bsc#1165631).
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201486-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7bab2135");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"kgraft-patch-4_4_121-92_129-default-2-2.1")) flag++;
