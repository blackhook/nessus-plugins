...
if (description)
{
  ...
  script_name(english:"Microsoft Windows SMB Registry : Windows 8.1 / Server 2012 R2 Service Pack Detection");
...
"It was possible to determine the service pack version of the
Windows 8.1 / Server 2012 R2 system by reading the registry key
...
if (win == "6.3")
{
  ...
  {
    set_kb_item(name:"SMB/8.1/ServicePack", value:sp);
    if (report_verbosity > 0)
    {
      report = '\n' + 'The remote Windows 8.1 / Server 2012 R2 has ' + sp + ' applied.\n';
...
else audit(AUDIT_OS_NOT, "Windows 8.1 / Server 2012 R2");
