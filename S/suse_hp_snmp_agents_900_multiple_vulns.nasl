...
if (description)
{
  ...
  script_name(english:"HP SNMP Agents < 9.0.0 Multiple Vulnerabilities (HPSBMU02771 SSRT100558) (SuSE)");
...
"The version of the HP SNMP Agents package installed on the SuSE Linux
Enterprise Server host is earlier than 9.0.0 and, as such, potentially
affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2012-05/0007.html");
...
my_rpm = parse_rpm_name(rpm:'hp-snmp-agents-9.0.0.48-47');
...
foreach package (lines)
{
  ...
  if (
    ...
    (
      ...
      (
        ver[3] < 48 ||
        ver[3] == 48 && int(item['release']) < 47
      )
    )
  )
  {
    vuln++;
    rpm_report_add(package:package, reference:'hp-snmp-agents-9.0.0.48-47');
  }
}
