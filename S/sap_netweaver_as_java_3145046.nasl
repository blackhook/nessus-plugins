...
if (description)
{
  ...
  script_cve_id("CVE-2022-27656");
  script_xref(name:"IAVA", value:"2022-A-0192-S");

  script_name(english:"SAP NetWeaver AS Java XSS (3145046)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver AS Java server may be affected by a cross-site scripting vulnerability.");
  script_set_attribute(attribute:"description", value:
"A cross site scripting vulnerability exists in SAP NetWeaver AS Java versions 7.22, 7.49, 7.53, 7.77, 7.81, 7.85, 7.86,
7.87, and 8.04 which may allow an unauthenticated attacker to steal authentication information of the user.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3145046");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-27656");
