...
# extracted from SUSE update advisory SUSE-SU-2020:3369-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : go1.14 (SUSE-SU-2020:3369-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20203369-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?be331016");
...
zypper in -t patch
SUSE-SLE-Module-Development-Tools-15-SP2-2020-3369=1

SUSE Linux Enterprise Module for Development Tools 15-SP1 :

zypper in -t patch
SUSE-SLE-Module-Development-Tools-15-SP1-2020-3369=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"go1.14-1.14.12-1.26.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"go1.14-doc-1.14.12-1.26.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"go1.14-1.14.12-1.26.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"go1.14-doc-1.14.12-1.26.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"go1.14-1.14.12-1.26.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"go1.14-doc-1.14.12-1.26.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"go1.14-1.14.12-1.26.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"go1.14-doc-1.14.12-1.26.1")) flag++;
