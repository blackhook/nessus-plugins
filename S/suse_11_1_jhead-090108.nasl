...
# extracted from openSUSE Security Update jhead-399.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jhead (jhead-399)");
  script_summary(english:"Check for the jhead-399 patch");
...
"This update of jhead fixes several security problems :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=435979"
  );
...
if ( rpm_check(release:"SUSE11.1", reference:"jhead-2.84-1.24.1") ) flag++;
