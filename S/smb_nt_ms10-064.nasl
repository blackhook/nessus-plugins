...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2293422");
...
server with Online Mode."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-064");
  script_set_attribute(
    attribute:"solution",
    value:
