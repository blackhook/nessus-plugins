...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 119433-01"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Mar/28/05"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/119433-01"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"119433-01", obsoleted_by:"", package:"SUNWtnetc", version:"11.9.0,REV=2002.04.06.15.27") < 0) flag++;
