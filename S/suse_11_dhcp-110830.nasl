...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : dhcp (SAT Patch Number 5079)");
...
fixed to not wipe out iptables connmark when renewing the lease."
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 5079.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"dhcp-3.1.3.ESV-0.13.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"dhcp-client-3.1.3.ESV-0.13.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"dhcp-3.1.3.ESV-0.13.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"dhcp-client-3.1.3.ESV-0.13.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"dhcp-3.1.3.ESV-0.13.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"dhcp-client-3.1.3.ESV-0.13.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"dhcp-relay-3.1.3.ESV-0.13.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"dhcp-server-3.1.3.ESV-0.13.1")) flag++;
