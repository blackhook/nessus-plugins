...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss-pam-ldapd on SL6.x i386/x86_64 (20130304)");
...
packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:nss-pam-ldapd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:nss-pam-ldapd-debuginfo");
