...
# extracted from SUSE update advisory SUSE-SU-2016:1735-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : dhcp (SUSE-SU-2016:1735-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161735-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b385d0f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch slessp2-dhcp-12637=1

SUSE Linux Enterprise Debuginfo 11-SP2 :

zypper in -t patch dbgsp2-dhcp-12637=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"2", reference:"dhcp-4.2.4.P2-0.11.15.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"dhcp-client-4.2.4.P2-0.11.15.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"dhcp-relay-4.2.4.P2-0.11.15.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"dhcp-server-4.2.4.P2-0.11.15.1")) flag++;
