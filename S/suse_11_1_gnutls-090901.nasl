...
# extracted from openSUSE Security Update gnutls-1259.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gnutls (gnutls-1259)");
  script_summary(english:"Check for the gnutls-1259 patch");
...
names in SSL certificates (CVE-2009-2730)."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.1", reference:"gnutls-2.4.1-24.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libgnutls-devel-2.4.1-24.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libgnutls-extra-devel-2.4.1-24.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libgnutls-extra26-2.4.1-24.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libgnutls26-2.4.1-24.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libgnutls26-32bit-2.4.1-24.4.1") ) flag++;
