...
# extracted from openSUSE Security Update libapr-util1-6288.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libapr-util1 (libapr-util1-6288)");
  script_summary(english:"Check for the libapr-util1-6288 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libapr-util1-1.2.8-68.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libapr-util1-dbd-mysql-1.2.8-68.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libapr-util1-dbd-pgsql-1.2.8-68.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libapr-util1-dbd-sqlite3-1.2.8-68.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libapr-util1-devel-1.2.8-68.2") ) flag++;
