...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tomcat on SL7.x (noarch) (20150512)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1505&L=scientific-linux-errata&T=0&P=1247
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f59f7db"
  );
