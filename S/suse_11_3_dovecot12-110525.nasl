...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dovecot12 (openSUSE-SU-2011:0540-1)");
...
(CVE-2011-1929)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-05/msg00056.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-1.2.17-2.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-backend-mysql-1.2.17-2.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-backend-pgsql-1.2.17-2.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-backend-sqlite-1.2.17-2.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-devel-1.2.17-2.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-fts-lucene-1.2.17-2.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-fts-solr-1.2.17-2.2.1") ) flag++;
