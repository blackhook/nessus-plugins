...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 34 for SLE 12 SP3) (SUSE-SU-2021:2433-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2021:2433-1 advisory.
...
"Update the affected kgraft-patch-4_4_180-94_127-default and / or kgraft-patch-4_4_180-94_144-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.4.180-94.127-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_127-default-12-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      },
      '4.4.180-94.144-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_144-default-3-2.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_4_180-94_127-default / etc');
}
