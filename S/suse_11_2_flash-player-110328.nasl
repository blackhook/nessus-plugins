...
fixing several bugs and one security issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=682902");
  script_set_attribute(attribute:"see_also", value:"https://lists.opensuse.org/opensuse-updates/2011-03/msg00031.html");
...
if ( rpm_check(release:"SUSE11.2", reference:"flash-player-10.2.153.1-0.4.1") ) flag++;
