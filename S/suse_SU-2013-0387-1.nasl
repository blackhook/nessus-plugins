...
# extracted from SUSE update advisory SUSE-SU-2013:0387-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES10 Security Update : apache2 (SUSE-SU-2013:0387-1)");
...
Additionally, some non-security bugs have been fixed as enumerated in
the changelog of the RPM.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2012-0883"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2012-2687"
  );
  # http://download.suse.com/patch/finder/?keywords=f43eb058005728c7f0f35af643e86652
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9de42515"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2013/suse-su-20130387-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d8f17a9d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SLES10", sp:"4", reference:"apache2-2.2.3-16.46.1")) flag++;
if (rpm_check(release:"SLES10", sp:"4", reference:"apache2-devel-2.2.3-16.46.1")) flag++;
if (rpm_check(release:"SLES10", sp:"4", reference:"apache2-doc-2.2.3-16.46.1")) flag++;
if (rpm_check(release:"SLES10", sp:"4", reference:"apache2-example-pages-2.2.3-16.46.1")) flag++;
if (rpm_check(release:"SLES10", sp:"4", reference:"apache2-prefork-2.2.3-16.46.1")) flag++;
if (rpm_check(release:"SLES10", sp:"4", reference:"apache2-worker-2.2.3-16.46.1")) flag++;
