...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind on SL6.x i386/x86_64 (20140120)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1401&L=scientific-linux-errata&T=0&P=1087
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d69bdd81"
  );
