...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"970238");
...
host and take complete control of it.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-026");
