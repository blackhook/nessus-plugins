...
# extracted from openSUSE Security Update emacs-4620.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : emacs (emacs-4620)");
  script_summary(english:"Check for the emacs-4620 patch");
  ...
  script_set_attribute(
    ...
    value:
"The setting ':safe' of 'enable-local-variables' could be bypassed by
specially crafted files (CVE-2007-5795)."
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE10.3", reference:"emacs-22.1-40.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"emacs-el-22.1-40.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"emacs-info-22.1-40.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"emacs-nox-22.1-40.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"emacs-x11-22.1-40.4") ) flag++;
