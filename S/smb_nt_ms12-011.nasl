...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2597124");
  script_xref(name:"MSKB", value:"2553413");
...
malicious request, resulting in arbitrary script code execution.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-011");
