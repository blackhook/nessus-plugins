...
(CVE-2011-2899)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00028.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"python-cupshelpers-1.2.0-2.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"system-config-printer-1.2.0-2.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"system-config-printer-lang-1.2.0-2.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"udev-configure-printer-1.2.0-2.7.1") ) flag++;
