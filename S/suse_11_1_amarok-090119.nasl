...
if ( rpm_check(release:"SUSE11.1", reference:"amarok-1.4.10-26.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"amarok-lang-1.4.10-26.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"amarok-libvisual-1.4.10-26.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"amarok-xine-1.4.10-26.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"amarok-yauap-1.4.10-26.2.1") ) flag++;
