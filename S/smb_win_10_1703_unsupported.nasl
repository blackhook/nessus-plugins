...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 Version 1703 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:"
The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 version 1703 is running on the remote host.
Microsoft ended support for Windows 10 version 1703 Home/Pro on October 9, 2018
and ends for Windows 10 version 1703 Enterprise/Educational on October 8, 2019.
...
product_name  = "Windows 10 version 1703";
...
# Not Build 15063 (version 1703)
if ("15063" != os_build) audit(AUDIT_OS_NOT, product_name);

# Server versions have a different life cycle
if ("server" >< tolower(os_name)) audit(AUDIT_OS_NOT, "affected");
