...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : augeas on SL7.x x86_64 (20170921)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24587305"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"augeas-1.4.0-2.el7_4.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"augeas-debuginfo-1.4.0-2.el7_4.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"augeas-devel-1.4.0-2.el7_4.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"augeas-libs-1.4.0-2.el7_4.1")) flag++;
