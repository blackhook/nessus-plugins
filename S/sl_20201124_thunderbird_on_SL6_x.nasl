...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5164");

  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i686/x86_64 (2020:5164)");
...
SLSA-2020:5164-1 advisory.

  - Mozilla: Write side effects in MCallGetProperty opcode not accounted for (CVE-2020-26950)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205164-1");
...
pkgs = [
    {'reference':'thunderbird-78.4.3-1.el6_10', 'cpu':'i686', 'release':'SL6', 'allowmaj':TRUE},
    {'reference':'thunderbird-78.4.3-1.el6_10', 'cpu':'x86_64', 'release':'SL6', 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-78.4.3-1.el6_10', 'cpu':'x86_64', 'release':'SL6', 'allowmaj':TRUE}
];
