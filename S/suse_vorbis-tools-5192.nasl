...
# extracted from openSUSE Security Update vorbis-tools-5192.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : vorbis-tools (vorbis-tools-5192)");
  script_summary(english:"Check for the vorbis-tools-5192 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"vorbis-tools-1.1.1-13.7") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"vorbis-tools-1.1.1-39") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"vorbis-tools-1.1.1-112.2") ) flag++;
