...
if (description)
{
 ...
 script_name(english:"Microsoft Windows - Users Information : Disabled Accounts");
 script_summary(english:"Lists user accounts that have been disabled.");
...
while(login)
{
 ...
 if(acb)
 {
  if(acb & 0x0002){ # UF_ACCOUNTDISABLE
    ...
    set_kb_item(name:"SMB/Users/Disabled/"+count, value:login);
	}
 }
 count = count + 1;
 login = get_kb_item(string("SMB/Users/", count));
