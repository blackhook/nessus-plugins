...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5350");

  script_name(english:"Scientific Linux Security Update : net-snmp on SL7.x i686/x86_64 (2020:5350)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205350-1");
...
pkgs = [
    {'reference':'net-snmp-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-agent-libs-5.7.2-49.el7_9.1', 'cpu':'i686', 'release':'SL7'},
    {'reference':'net-snmp-agent-libs-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-debuginfo-5.7.2-49.el7_9.1', 'cpu':'i686', 'release':'SL7'},
    {'reference':'net-snmp-debuginfo-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-devel-5.7.2-49.el7_9.1', 'cpu':'i686', 'release':'SL7'},
    {'reference':'net-snmp-devel-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-gui-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-libs-5.7.2-49.el7_9.1', 'cpu':'i686', 'release':'SL7'},
    {'reference':'net-snmp-libs-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-perl-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-python-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-sysvinit-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'net-snmp-utils-5.7.2-49.el7_9.1', 'cpu':'x86_64', 'release':'SL7'}
];
