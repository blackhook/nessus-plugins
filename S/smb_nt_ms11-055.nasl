...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2011-A-0098-S");
...
execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?91fd941a");
  script_set_attribute(attribute:"solution", value:"Microsoft has released a patch for Visio 2003.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3148");
