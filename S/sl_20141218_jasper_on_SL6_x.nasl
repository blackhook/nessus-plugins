...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : jasper on SL6.x, SL7.x i386/x86_64 (20141218)");
...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1412&L=scientific-linux-errata&T=0&P=3342
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7efce0e0"
  );
