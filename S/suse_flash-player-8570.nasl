...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : flash-player (ZYPP Patch Number 8570)");
...
https://www.adobe.com/support/security/bulletins/apsb13-14.html"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8570.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"flash-player-11.2.202.285-0.5.1")) flag++;
