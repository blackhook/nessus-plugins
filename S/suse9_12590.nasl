...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : sendmail (YOU Patch Number 12590)");
...
the SSL certificate. (CVE-2009-4565: CVSS v2 Base Score: 7.5)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12590.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"sendmail-8.12.11-2.16")) flag++;
if (rpm_check(release:"SUSE9", reference:"sendmail-devel-8.12.11-2.13")) flag++;
if (rpm_check(release:"SUSE9", reference:"uucp-1.07-225.19")) flag++;
