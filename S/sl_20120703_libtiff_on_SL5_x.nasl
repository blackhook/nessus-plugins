...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libtiff on SL5.x, SL6.x i386/x86_64 (20120703)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=1120
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00b2e60e"
  );
