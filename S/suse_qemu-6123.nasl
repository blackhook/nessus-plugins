...
# extracted from openSUSE Security Update qemu-6123.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : qemu (qemu-6123)");
  script_summary(english:"Check for the qemu-6123 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"qemu-0.10.1-0.1") ) flag++;
