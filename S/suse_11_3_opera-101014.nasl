...
changelog: http://www.opera.com/docs/changelogs/unix/1063/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-10/msg00017.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"opera-10.63-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"opera-gtk-10.63-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"opera-kde4-10.63-1.1.1") ) flag++;
