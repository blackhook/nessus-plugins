...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : system-config-printer on SL4.x, SL5.x i386/x86_64");
...
for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1108&L=scientific-linux-errata&T=0&P=2908
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5eaac682"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL4", reference:"system-config-printer-0.6.116.10-1.6.el4")) flag++;
if (rpm_check(release:"SL4", reference:"system-config-printer-gui-0.6.116.10-1.6.el4")) flag++;

if (rpm_check(release:"SL5", reference:"system-config-printer-0.7.32.10-1.el5_7.1")) flag++;
if (rpm_check(release:"SL5", reference:"system-config-printer-libs-0.7.32.10-1.el5_7.1")) flag++;
