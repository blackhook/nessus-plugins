...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4493210");
  script_xref(name:"MSFT", value:"MS21-4493210");
  script_xref(name:"IAVA", value:"2021-A-0070-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2013 (February 2021)");
...
affected by multiple vulnerabilities:
  ...
  - A remote code execution vulnerability. An attacker can
    ...
    CVE-2021-24072)");
  # https://support.microsoft.com/en-us/office/description-of-the-security-update-for-sharepoint-foundation-2013-february-9-2021-kb4493210-acb52a51-bd4f-e06d-3d93-0016e7d4c6bb
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7202aba1");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4493210 to address this issue.");
