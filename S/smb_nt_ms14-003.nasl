...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS14-003");
  script_xref(name:"MSKB", value:"2913602");

  script_name(english:"MS14-003: Vulnerability in Windows Kernel-Mode Driver Could Allow Elevation of Privilege (2913602)");
...
a local attacker to take complete control of an affected system."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-003");
...
if (
  ...
  hotfix_is_vulnerable(os:"6.1", sp:1, file:"Win32k.sys", version:"6.1.7601.18327", min_version:"6.1.7600.18000", dir:"\system32", bulletin:bulletin, kb:kb) ||
  hotfix_is_vulnerable(os:"6.1", sp:1, file:"Win32k.sys", version:"6.1.7601.22525", min_version:"6.1.7601.22000", dir:"\system32", bulletin:bulletin, kb:kb)
)
{
