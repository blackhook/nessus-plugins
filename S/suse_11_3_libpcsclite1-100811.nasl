...
if ( rpm_check(release:"SUSE11.3", reference:"libpcsclite1-1.5.5-7.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"pcsc-lite-1.5.5-7.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"pcsc-lite-devel-1.5.5-7.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libpcsclite1-32bit-1.5.5-7.1.1") ) flag++;
