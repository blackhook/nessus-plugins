...
# extracted from openSUSE Security Update clamav-4832.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : clamav (clamav-4832)");
  script_summary(english:"Check for the clamav-4832 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"clamav-0.92-0.2") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"clamav-db-0.92-0.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"clamav-0.92-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"clamav-db-0.92-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"clamav-0.92-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"clamav-db-0.92-0.1") ) flag++;
