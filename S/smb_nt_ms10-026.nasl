...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2010-A-0053-S");
  script_xref(name:"MSFT", value:"MS10-026");
  script_xref(name:"MSKB", value:"977816");
...
malicious AVI file, which would lead to arbitrary code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?d9016aad");
  script_set_attribute(
    attribute:"solution",
    value:
...
Vista, and 2008."
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0480");
