...
# extracted from SUSE update advisory SUSE-SU-2018:0233-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2018:0233-1)");
  ...
  script_set_attribute(
    ...
    value:
"This update for the Linux Kernel 3.12.61-52_111 fixes one issue. The
following security issue was fixed :
  ...
  - CVE-2017-15649: net/packet/af_packet.c in the Linux
    ...
    leads to a use-after-free. This fixes the earlier kgraft
    update, that could have caused crashes when trying to
    exploit this vulnerability after applying the kgraft
    update (bsc#1064392, bsc#1064388).
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180233-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?df082217"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_111-default-2-2.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_111-xen-2-2.1")) flag++;
