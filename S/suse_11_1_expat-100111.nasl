...
if ( rpm_check(release:"SUSE11.1", reference:"expat-2.0.1-88.18.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libexpat-devel-2.0.1-88.18.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libexpat1-2.0.1-88.18.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libexpat1-32bit-2.0.1-88.18.1") ) flag++;
