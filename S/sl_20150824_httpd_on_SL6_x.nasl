...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : httpd on SL6.x i386/x86_64 (20150824)");
...
restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?974a1f9e"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"httpd-2.2.15-47.sl6")) flag++;
if (rpm_check(release:"SL6", reference:"httpd-debuginfo-2.2.15-47.sl6")) flag++;
if (rpm_check(release:"SL6", reference:"httpd-devel-2.2.15-47.sl6")) flag++;
if (rpm_check(release:"SL6", reference:"httpd-manual-2.2.15-47.sl6")) flag++;
if (rpm_check(release:"SL6", reference:"httpd-tools-2.2.15-47.sl6")) flag++;
if (rpm_check(release:"SL6", reference:"mod_ssl-2.2.15-47.sl6")) flag++;
