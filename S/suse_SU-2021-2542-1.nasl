...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 10 for SLE 15 SP2) (SUSE-SU-2021:2542-1)");
...
"Update the affected kernel-livepatch-4_12_14-197_78-default and / or kernel-livepatch-5_3_18-24_49-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-197.78-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_78-default-9-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
      '5.3.18-24.49-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_49-default-8-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
