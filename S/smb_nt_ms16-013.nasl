...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3115858");
...
in the execution of arbitrary code in the context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-013");
...
2008 R2, 2012, 8.1, 2012 R2, and 10.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0038");
