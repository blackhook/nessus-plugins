...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openjpeg on SL6.x i386/x86_64 (20170319)");
...
"Security Fix(es) :
  ...
  - A vulnerability was found in the patch for CVE-2013-6045
    ...
    read by an application using OpenJPEG, could cause
    heap-based buffer overflows leading to a crash or,
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?20bef4c6"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"openjpeg-1.3-16.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"openjpeg-debuginfo-1.3-16.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"openjpeg-devel-1.3-16.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"openjpeg-libs-1.3-16.el6_8")) flag++;
