...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1179879"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-16587/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-16588/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-16589/"
  );
  # https://www.suse.com/support/update/announcement/2020/suse-su-20203931-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?116de572"
  );
  script_set_attribute(
    attribute:"solution",
    value:
