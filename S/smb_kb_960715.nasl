...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2009-A-0016-S");
  script_xref(name:"IAVB", value:"2009-B-0009-S");
...
issues.");
  # https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2009/960715
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?7d9d1626");
