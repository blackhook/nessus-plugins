...
if (description)
{
  ...
  script_name(english:"Security Update for Microsoft ASP.NET Core (September 2020)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft ASP.NET Core installations on the remote host contain vulnerable packages.");
  script_set_attribute(attribute:"description", value:
"The Microsoft ASP.NET Core installation on the remote host is version 2.1.x < 2.1.22, or 3.1.x < 3.1.8. It is,
therefore, affected by a security feature bypass vulnerability in the way ASP.NET Core parses encoded cookie names. An
unauthenticated, remote attacker can exploit this issue, by sending a specially crafted cookies to the ASP.NET Core
application to set a second cookie.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://github.com/dotnet/announcements/issues/165");
  # https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/CVE-2020-1045
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9bcbab3f");
...
constraints = [
  { 'min_version' : '3.1', 'fixed_version' : '3.1.8' },
  { 'min_version' : '2.1', 'fixed_version' : '2.1.22' }
];
