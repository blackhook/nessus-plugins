...
# extracted from openSUSE Security Update dhcp-4314.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dhcp (openSUSE-SU-2011:0320-1)");
  script_summary(english:"Check for the dhcp-4314 patch");
...
needs to sanitize the host name offered by the server (CVE-2011-0997)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00031.html"
  );
...
if ( rpm_check(release:"SUSE11.3", reference:"dhcp-4.1.2.ESV.1-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dhcp-client-4.1.2.ESV.1-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dhcp-devel-4.1.2.ESV.1-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dhcp-relay-4.1.2.ESV.1-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dhcp-server-4.1.2.ESV.1-0.6.1") ) flag++;
