...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 121332-01");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"121332-01", obsoleted_by:"", package:"SUNWlzas", version:"2.0,REV=rr24") < 0) flag++;
