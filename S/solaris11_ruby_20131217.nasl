...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : ruby (multiple_cryptographic_issues_vulnerabilities_in)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/multiple-cryptographic-issues-vulnerabilities-in-ruby
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f98c72fe"
  );
