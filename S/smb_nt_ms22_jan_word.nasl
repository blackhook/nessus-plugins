...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002057");
  script_xref(name:"MSFT", value:"MS22-5002057");
  script_xref(name:"IAVA", value:"2022-A-0019-S");

  script_name(english:"Security Updates for Microsoft Word Products (January 2022)");
...
It is, therefore, affected by the following vulnerability:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002057");
...
var checks = make_array(
  '16.0', make_nested_list(
    make_array('sp', 0, 'version', '16.0.5266.1000', 'channel', 'MSI', 'kb', '5002057')
  )
);
