...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:6834");

  script_name(english:"Scientific Linux Security Update : expat on SL7.x i686/x86_64 (2022:6834)");
...
SLSA-2022:6834-1 advisory.

  - expat: a use-after-free in the doContent function in xmlparse.c (CVE-2022-40674)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20226834-1");
...
var pkgs = [
    {'reference':'expat-2.1.0-15.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-2.1.0-15.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-debuginfo-2.1.0-15.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-debuginfo-2.1.0-15.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.1.0-15.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-devel-2.1.0-15.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.1.0-15.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'expat-static-2.1.0-15.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
