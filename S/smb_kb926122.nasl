...
if (description)
{
  ...
  script_cve_id("CVE-2007-0040", "CVE-2007-3028");
  script_bugtraq_id(24796, 24800);
  script_xref(name:"MSFT", value:"MS07-039");
  script_xref(name:"MSKB", value:"926122");
...
service vulnerability.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?780e67ea");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows 2000.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-0040");
