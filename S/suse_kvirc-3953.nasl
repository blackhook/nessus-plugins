...
# extracted from openSUSE Security Update kvirc-3953.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : kvirc (kvirc-3953)");
  script_summary(english:"Check for the kvirc-3953 patch");
...
commands by tricking a user into opening a specially crafted URI in
kvirc (CVE-2007-2951)."
  );
...
if ( rpm_check(release:"SUSE10.1", reference:"kvirc-3.2.0-21.3") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"kvirc-3.2.5-26") ) flag++;
