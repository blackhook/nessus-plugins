...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : gnome-vfs (YOU Patch Number 10009)");
...
"This update fixes the following security problems :
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 10009.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"gnome-vfs-1.0.5-806.7")) flag++;
