...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss on SL5.x, SL6.x i386/x86_64 (20131219)");
...
for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=5851
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2c6604e6"
  );
