...
var pkgs = [
    ...
    {'reference':'java-1_7_1-ibm-alsa-1.7.1_sr5.0-26.68.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']},
    ...
    {'reference':'java-1_7_1-ibm-plugin-1.7.1_sr5.0-26.68.1', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-11.4']}
];
