...
if (description)
{
  ...
  script_cve_id("CVE-2013-3765");
  script_bugtraq_id(61275);

  script_name(english:"Oracle Solaris Critical Patch Update : july2013_SRU11_1_7_5_0");
...
fix_release = "0.5.11-0.175.1.7.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.1.7.0.5.0", sru:"11.1.7.5.0") > 0) flag++;
