...
the SUSE-SU-2021:2842-1 advisory.
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.4.180-94.127-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_127-default-14-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']}
        ]
      },
      '4.4.180-94.144-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_144-default-5-2.1', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      }
    }
  }
