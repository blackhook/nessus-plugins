...
# extracted from openSUSE Security Update xpdf-793.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xpdf (xpdf-793)");
  script_summary(english:"Check for the xpdf-793 patch");
  ...
  script_set_attribute(
    ...
    value:
"Specially crafted PDF files could lead to crashes, make the viewer run
into an infinite loop or potentially even allow execution of arbitrary
code.
...
CVE-2009-1181, CVE-2009-1182, CVE-2009-1183)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=485892"
  );
...
if ( rpm_check(release:"SUSE11.1", reference:"xpdf-3.02-97.78.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xpdf-tools-3.02-97.78.1") ) flag++;
