...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ghostscript on SL7.x x86_64 (20170802)");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-9.07-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-cups-9.07-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-debuginfo-9.07-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-devel-9.07-28.el7")) flag++;
if (rpm_check(release:"SL7", reference:"ghostscript-doc-9.07-28.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-gtk-9.07-28.el7")) flag++;
