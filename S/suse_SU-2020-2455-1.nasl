...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1174010"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1175223"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-7068/"
  );
  # https://www.suse.com/support/update/announcement/2020/suse-su-20202455-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22b5c1c1"
  );
  script_set_attribute(
    attribute:"solution",
    value:
