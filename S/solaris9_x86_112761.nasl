...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 112761-13");
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"112761-13", obsoleted_by:"", package:"SPROcc", version:"8.0,REV=2003.03.13") < 0) flag++;
