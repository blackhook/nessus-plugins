...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.6.0-openjdk on SL6.x i386/x86_64 (20120613)");
...
OpenJDK Java must be restarted for the update to take effect.");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1206&L=scientific-linux-errata&T=0&P=1412
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e056b719");
