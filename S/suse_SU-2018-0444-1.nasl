...
# extracted from SUSE update advisory SUSE-SU-2018:0444-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : dhcp (SUSE-SU-2018:0444-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180444-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?379a7563"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-dhcp-13465=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-dhcp-13465=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"dhcp-4.2.4.P2-0.28.5.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"dhcp-client-4.2.4.P2-0.28.5.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"dhcp-relay-4.2.4.P2-0.28.5.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"dhcp-server-4.2.4.P2-0.28.5.3")) flag++;
