...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:4953");

  script_name(english:"Scientific Linux Security Update : xorg-x11-server on SL6.x i686/x86_64 (2020:4953)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20204953-1");
...
pkgs = [
    {'reference':'xorg-x11-server-common-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-common-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'},
    {'reference':'xorg-x11-server-debuginfo-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-debuginfo-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'},
    {'reference':'xorg-x11-server-devel-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-devel-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'},
    {'reference':'xorg-x11-server-source-1.17.4-18.el6_10', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xdmx-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xdmx-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xephyr-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xephyr-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xnest-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xnest-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xorg-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xorg-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xvfb-1.17.4-18.el6_10', 'cpu':'i686', 'release':'SL6'},
    {'reference':'xorg-x11-server-Xvfb-1.17.4-18.el6_10', 'cpu':'x86_64', 'release':'SL6'}
];
