...
# extracted from SUSE update advisory SUSE-SU-2016:2895-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : tar (SUSE-SU-2016:2895-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b61fa286"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"tar-1.26-1.2.10.1")) flag++;
