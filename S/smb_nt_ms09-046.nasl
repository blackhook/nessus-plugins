...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2009-A-0075-S");
  script_xref(name:"MSFT", value:"MS09-046");
  script_xref(name:"MSKB", value:"956844");
...
arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?15c573d6");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows 2000, XP, and
2003.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2519");
