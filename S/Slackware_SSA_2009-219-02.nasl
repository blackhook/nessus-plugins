...
# extracted from Slackware Security Advisory 2009-219-02. The text 
...
if (description)
{
  ...
  script_name(english:"Slackware 11.0 / 12.0 / 12.1 / 12.2 / current : apr (SSA:2009-219-02)");
...
and -current to fix a security issue."
  ...
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2009&m=slackware-security.431437
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?748e32ff"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (slackware_check(osver:"11.0", pkgname:"apr", pkgver:"1.3.8", pkgarch:"i486", pkgnum:"1_slack11.0")) flag++;

if (slackware_check(osver:"12.0", pkgname:"apr", pkgver:"1.3.8", pkgarch:"i486", pkgnum:"1_slack12.0")) flag++;

if (slackware_check(osver:"12.1", pkgname:"apr", pkgver:"1.3.8", pkgarch:"i486", pkgnum:"1_slack12.1")) flag++;

if (slackware_check(osver:"12.2", pkgname:"apr", pkgver:"1.3.8", pkgarch:"i486", pkgnum:"1_slack12.2")) flag++;
