...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"969805");
  script_xref(name:"MSKB", value:"970437");
...
both of the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-018");
