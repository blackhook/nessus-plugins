...
if (description)
{
  ...
  script_name(english:"SAP Sybase Adaptive Server Enterprise DoS (SAP Note 1893561)");
...
"An attacker can launch a specially crafted request causing the SAP
Sybase ASE process on Microsoft Windows to be terminated.  This causes
the SAP Sybase ASE to become unavailable until the process is rebooted
manually.  This condition can be intentionally provoked by an attacker
to cause a denial of service.");
  script_set_attribute(attribute:"see_also", value:"https://service.sap.com/sap/support/notes/1893561");
