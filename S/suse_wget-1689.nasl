...
# extracted from openSUSE Security Update wget-1689.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : wget (wget-1689)");
  script_summary(english:"Check for the wget-1689 patch");
...
Additionaly a previous '.file' fix was found to be buggy and replaced.
This bug could lead to '.directories' not being retrievable and
'_files' being overwritten."
  );
...
if ( rpm_check(release:"SUSE10.1", reference:"wget-1.10.2-15.4") ) flag++;
