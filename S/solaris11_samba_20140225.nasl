...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2012-6150-input-validation-vulnerability-in-samba
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22e3202d"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2013-4408-buffer-errors-vulnerability-in-samba"
  );
