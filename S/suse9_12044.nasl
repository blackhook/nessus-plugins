...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : MySQL (YOU Patch Number 12044)");
...
versions are affected by every bug) :
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12044.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"mysql-4.0.18-32.32")) flag++;
if (rpm_check(release:"SUSE9", reference:"mysql-Max-4.0.18-32.32")) flag++;
if (rpm_check(release:"SUSE9", reference:"mysql-client-4.0.18-32.32")) flag++;
if (rpm_check(release:"SUSE9", reference:"mysql-devel-4.0.18-32.32")) flag++;
if (rpm_check(release:"SUSE9", reference:"mysql-shared-4.0.18-32.32")) flag++;
