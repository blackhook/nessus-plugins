...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2010-5107-denial-of-service-vulnerability-in-ssh"
  );
  # https://blogs.oracle.com/sunsecurity/cve-2012-0814-credentials-management-vulnerability-in-ssh
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?41838c0f"
  );
