...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ntp on SL4.x i386/x86_64");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0905&L=scientific-linux-errata&T=0&P=1532
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?117dd373"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"ntp-4.2.0.a.20040617-8.el4_7.2")) flag++;
