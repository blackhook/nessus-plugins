...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : IBM Java (ZYPP Patch Number 7626)");
...
security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7626.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"java-1_6_0-ibm-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"java-1_6_0-ibm-devel-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"java-1_6_0-ibm-fonts-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"java-1_6_0-ibm-jdbc-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"java-1_6_0-ibm-plugin-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"i586", reference:"java-1_6_0-ibm-alsa-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"java-1_6_0-ibm-32bit-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"java-1_6_0-ibm-alsa-32bit-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"java-1_6_0-ibm-devel-32bit-1.6.0_sr9.2-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"java-1_6_0-ibm-plugin-32bit-1.6.0_sr9.2-0.6.1")) flag++;
