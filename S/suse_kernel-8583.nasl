...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Linux kernel (ZYPP Patch Number 8583)");
...
Also the following bugs have been fixed :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8583.");
...
if (rpm_check(release:"SLES10", sp:4, cpu:"i586", reference:"kernel-default-2.6.16.60-0.103.1")) flag++;
...
if (rpm_check(release:"SLES10", sp:4, cpu:"i586", reference:"kernel-source-2.6.16.60-0.103.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, cpu:"i586", reference:"kernel-syms-2.6.16.60-0.103.1")) flag++;
