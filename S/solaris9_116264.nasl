...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 116264-09");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"116264-09", obsoleted_by:"", package:"VRTSnetbp", version:"5.0,REV=2003.11.06.09.24") < 0) flag++;
