...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3096735");
  script_xref(name:"MSKB", value:"3096736");
  script_xref(name:"MSKB", value:"3096738");
...
in the possible disclosure of sensitive information or other actions.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-123");
