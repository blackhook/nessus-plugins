...
(AV:N/AC:M/Au:N/C:P/I:P/A:P): Resource Management Errors (CWE-399)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-07/msg00000.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"libvorbis-1.2.0-83.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libvorbis-devel-1.2.0-83.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libvorbis-32bit-1.2.0-83.3.1") ) flag++;
