...
if (description)
{
  ...
  script_name(english:"Shockwave Player <= 12.0.6.147 Memory Corruptions (APSB13-29)");
...
that is prior to or equal to 12.0.6.147.  It is, therefore, potentially
affected by two memory corruption vulnerabilities.  A remote attacker
could exploit these issues by tricking a user into viewing a malicious
Shockwave file, resulting in arbitrary code execution.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/shockwave/apsb13-29.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Shockwave Player 12.0.7.148 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-5334");
...
latest_vuln_version = "12.0.6.147"; # versions <= this version are vuln
fix = "12.0.7.148";
