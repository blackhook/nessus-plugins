...
if (description)
{
  ...
  script_name(english:"Sun Java JRE XML Signature Command Injection (102993) (Unix)");
...
to the privileges under which the application operates.");
  # http://web.archive.org/web/20120112213518/http://www.isecpartners.com/advisories/2007-04-dsig.txt
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?12fdcd89");
  # http://web.archive.org/web/20120420195216/http://www.isecpartners.com/files/XMLDSIG_Command_Injection.pdf
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c7b05f6");
