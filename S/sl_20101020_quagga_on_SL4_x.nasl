...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : quagga on SL4.x, SL5.x i386/x86_64");
...
restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1010&L=scientific-linux-errata&T=0&P=2386
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9f4e75eb"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL4", reference:"quagga-0.98.3-4.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"quagga-contrib-0.98.3-4.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"quagga-devel-0.98.3-4.el4_8.1")) flag++;

if (rpm_check(release:"SL5", reference:"quagga-0.98.6-5.el5_5.2")) flag++;
if (rpm_check(release:"SL5", reference:"quagga-contrib-0.98.6-5.el5_5.2")) flag++;
if (rpm_check(release:"SL5", reference:"quagga-devel-0.98.6-5.el5_5.2")) flag++;
