...
# extracted from openSUSE Security Update xpdf-6182.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : xpdf (xpdf-6182)");
  script_summary(english:"Check for the xpdf-6182 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"xpdf-3.02-19.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"xpdf-tools-3.02-19.8") ) flag++;
