...
if (description)
{
  ...
  script_cvs_date("$Date: 2017/11/30 16:02:03 $");


  script_name(english:"Splunk Enterprise 6.6.x < 6.6.3 / Splunk Light 6.6.x < 6.6.3 Multiple XSS");
  script_summary(english:"Checks the version of Splunk Enterprise.");

  script_set_attribute(attribute:"synopsis", value:
"An application running on the remote web server is affected by multiple
cross-site scripting vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version number, the version of Splunk
running on the remote web server is Splunk Light 6.5.x prior to 6.6.3
or Splunk Enterprise 6.6.x prior to 6.6.3. It is, therefore,
affected by multiple cross-site scripting (XSS) vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.splunk.com/view/SP-CAAAP3H");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Splunk Enterprise version 6.6.3 or later or Splunk Light
6.6.3 or later.");
