...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119011-01 (deprecated)");
...
119011 patch-revision plugins, or deemed non-security related."
  );
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 119011 instead.");
