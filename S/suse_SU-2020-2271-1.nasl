...
# extracted from SUSE update advisory SUSE-SU-2020:2271-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : postgresql12 (SUSE-SU-2020:2271-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e456651d");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP1-2020-2271=1

SUSE Linux Enterprise Module for Basesystem 15-SP1 :

zypper in -t patch SUSE-SLE-Module-Basesystem-15-SP1-2020-2271=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libpq5-32bit-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"libpq5-32bit-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libecpg6-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libecpg6-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libpq5-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"libpq5-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-contrib-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-contrib-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-debugsource-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-devel-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-devel-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-plperl-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-plperl-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-plpython-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-plpython-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-pltcl-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-pltcl-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-server-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-server-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-server-devel-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"postgresql12-server-devel-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"libpq5-32bit-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"libpq5-32bit-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libpq5-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"libpq5-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"postgresql12-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"postgresql12-debuginfo-12.4-3.11.1")) flag++;
if (rpm_check(release:"SLED15", sp:"1", reference:"postgresql12-debugsource-12.4-3.11.1")) flag++;
