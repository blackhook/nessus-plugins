...
# extracted from SUSE update advisory SUSE-SU-2021:1116-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : umoci (SUSE-SU-2021:1116-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1184147"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2021-29136/"
  );
  # https://www.suse.com/support/update/announcement/2021/suse-su-20211116-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c6faa9d4"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch
SUSE-SLE-Product-SUSE-Manager-Server-4.0-2021-1116=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"umoci-0.4.6-3.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"3", reference:"umoci-0.4.6-3.9.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"umoci-0.4.6-3.9.1")) flag++;
