...
"Update the affected kernel-livepatch-5_3_18-59_13-default and / or kernel-livepatch-5_3_18-59_5-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-59.13-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-59_13-default-8-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      },
      '5.3.18-59.5-default': {
        'pkgs': [
