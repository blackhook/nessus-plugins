...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3196348");
...
code in the context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-147");
