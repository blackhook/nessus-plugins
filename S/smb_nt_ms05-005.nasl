...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"873352");
 script_xref(name:"MSKB", value:"873354");
 script_xref(name:"MSKB", value:"873355");
...
buffer overflow which may be exploited to execute arbitrary code.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2005/ms05-005");
