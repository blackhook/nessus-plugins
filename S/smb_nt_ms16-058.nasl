...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3141083");
...
crafted library, to inject and execute arbitrary code.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-058");
...
"Microsoft has released a set of patches for Windows Vista and 2008.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0152");
