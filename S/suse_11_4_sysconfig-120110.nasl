...
# extracted from openSUSE Security Update sysconfig-5631.
#
...
if (description)
{
  ...
  script_summary(english:"Check for the sysconfig-5631 patch");
...
"This update for sysconfig contains the following fixes :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-02/msg00035.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"sysconfig-0.74.5-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"sysconfig-debuginfo-0.74.5-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"sysconfig-debugsource-0.74.5-6.13.1") ) flag++;
