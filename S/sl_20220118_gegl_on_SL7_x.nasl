...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:0162");

  script_name(english:"Scientific Linux Security Update : gegl on SL7.x i686/x86_64 (2022:0162)");
...
SLSA-2022:0162-1 advisory.

  - gegl: shell expansion via a crafted pathname (CVE-2021-45463)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20220162-1");
...
"Update the affected gegl, gegl-debuginfo and / or gegl-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:gegl-debuginfo");
...
var pkgs = [
    {'reference':'gegl-0.2.0-19.el7_9.1', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-0.2.0-19.el7_9.1', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-debuginfo-0.2.0-19.el7_9.1', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-debuginfo-0.2.0-19.el7_9.1', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-devel-0.2.0-19.el7_9.1', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gegl-devel-0.2.0-19.el7_9.1', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
