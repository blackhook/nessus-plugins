...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rpm on SL7.x x86_64 (20141209)");
...
restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1412&L=scientific-linux-errata&T=0&P=1453
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ebeadac7"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:rpm-build-libs");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:rpm-sign");
