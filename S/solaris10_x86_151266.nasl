...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 151266-03 (deprecated)");
...
151266 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 151266 instead.");
