...
# extracted from openSUSE Security Update gimp-3949.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gimp (gimp-3949)");
  script_summary(english:"Check for the gimp-3949 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"gimp-2.2.10-22.27") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"gimp-devel-2.2.10-22.27") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"gimp-unstable-2.3.7-17.8") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"gimp-unstable-devel-2.3.7-17.8") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gimp-2.2.13-34") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gimp-devel-2.2.13-34") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gimp-unstable-2.3.11-51.4") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gimp-unstable-devel-2.3.11-51.4") ) flag++;
