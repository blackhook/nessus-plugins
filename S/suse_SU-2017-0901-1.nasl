...
# extracted from SUSE update advisory SUSE-SU-2017:0901-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : libpng12-0 (SUSE-SU-2017:0901-1)");
  ...
  script_set_attribute(
    ...
    value:
"This update for libpng12-0 fixes the following issues: Security issues
fixed :
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170901-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c3a82300"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-libpng12-0-13045=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-libpng12-0-13045=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-libpng12-0-13045=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libpng12-0-32bit-1.2.31-5.43.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"libpng12-0-32bit-1.2.31-5.43.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libpng12-0-1.2.31-5.43.1")) flag++;
