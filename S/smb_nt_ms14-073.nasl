...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2889838");
...
the security context of the logged-on user.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa023802");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4116");
