...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 141009-01"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Mar/12/09"
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 141009-01");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"141009-01", obsoleted_by:"139556-08 ", package:"SUNWckr", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
