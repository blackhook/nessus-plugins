...
was opened by a victim. (CVE-2007-0245)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0706&L=scientific-linux-errata&T=0&P=2705
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f939d7e4"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL3", reference:"openoffice.org-1.1.2-39.2.0.EL3")) flag++;
if (rpm_check(release:"SL3", reference:"openoffice.org-i18n-1.1.2-39.2.0.EL3")) flag++;
if (rpm_check(release:"SL3", reference:"openoffice.org-libs-1.1.2-39.2.0.EL3")) flag++;
