...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 120672-08");
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"120672-08", obsoleted_by:"", package:"SUNWmoznav", version:"1.7,REV=10.2005.12.08") < 0) flag++;
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"120672-08", obsoleted_by:"", package:"SUNWmozmail", version:"1.7,REV=10.2005.12.08") < 0) flag++;
