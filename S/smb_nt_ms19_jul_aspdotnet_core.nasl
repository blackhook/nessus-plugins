...
and convince the user to click the link that will redirect a targeted user to a malicious website");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?33943e33");
  # https://github.com/aspnet/Announcements/issues/373
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1092a0e5");
  # https://github.com/aspnet/AspNetCore/issues/12007
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5dedfb4a");
