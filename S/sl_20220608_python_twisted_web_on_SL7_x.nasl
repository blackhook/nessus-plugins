...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:4930");

  script_name(english:"Scientific Linux Security Update : python-twisted-web on SL7.x x86_64 (2022:4930)");
...
SLSA-2022:4930-1 advisory.

  - python-twisted: possible http request smuggling (CVE-2022-24801)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20224930-1");
...
var pkgs = [
    {'reference':'python-twisted-web-12.1.0-8.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
