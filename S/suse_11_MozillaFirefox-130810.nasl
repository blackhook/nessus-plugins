...
flag = 0;
if (rpm_check(release:"SLES11", sp:2, cpu:"s390x", reference:"MozillaFirefox-17.0.8esr-0.4.2.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"s390x", reference:"MozillaFirefox-translations-17.0.8esr-0.4.2.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"s390x", reference:"MozillaFirefox-17.0.8esr-0.7.2")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"s390x", reference:"MozillaFirefox-translations-17.0.8esr-0.7.2")) flag++;
