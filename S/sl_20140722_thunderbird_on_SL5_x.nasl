...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL5.x, SL6.x i386/x86_64 (20140722)");
...
Thunderbird must be restarted for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1407&L=scientific-linux-errata&T=0&P=1746
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?957c26e3"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL5", reference:"thunderbird-24.7.0-1.el5_10")) flag++;
if (rpm_check(release:"SL5", reference:"thunderbird-debuginfo-24.7.0-1.el5_10")) flag++;

if (rpm_check(release:"SL6", reference:"thunderbird-24.7.0-1.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-24.7.0-1.el6_5")) flag++;
