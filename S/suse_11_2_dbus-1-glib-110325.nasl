...
read-only via dbus (CVE-2010-1172)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00020.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"dbus-1-glib-0.80-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"dbus-1-glib-devel-0.80-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"dbus-1-glib-32bit-0.80-3.4.1") ) flag++;
