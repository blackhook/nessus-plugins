...
# extracted from openSUSE Security Update enscript-274.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : enscript (enscript-274)");
  script_summary(english:"Check for the enscript-274 patch");
...
can be exploited during file processing."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=433756"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"enscript-1.6.4-124.2") ) flag++;
