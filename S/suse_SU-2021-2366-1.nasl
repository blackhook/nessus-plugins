...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 12 for SLE 15 SP2) (SUSE-SU-2021:2366-1)");
...
"Update the affected kernel-livepatch-5_3_18-24_61-default and / or kgraft-patch-4_12_14-122_71-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      ...
      '5.3.18-24.61-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_61-default-3-2.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
