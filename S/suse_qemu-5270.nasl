...
# extracted from openSUSE Security Update qemu-5270.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : qemu (qemu-5270)");
  script_summary(english:"Check for the qemu-5270 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"qemu-0.8.0-14.4") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"qemu-0.8.2-34.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"qemu-0.9.0.cvs-35.2") ) flag++;
