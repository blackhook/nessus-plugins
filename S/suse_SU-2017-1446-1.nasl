...
# extracted from SUSE update advisory SUSE-SU-2017:1446-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : sudo (SUSE-SU-2017:1446-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e2702b6"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch SUSE-SLE-SDK-12-SP1-2017-888=1

SUSE Linux Enterprise Server for SAP 12:zypper in -t patch
SUSE-SLE-SAP-12-2017-888=1

SUSE Linux Enterprise Server 12-SP1:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2017-888=1

SUSE Linux Enterprise Server 12-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-2017-888=1

SUSE Linux Enterprise Desktop 12-SP1:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP1-2017-888=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"sudo-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"sudo-debuginfo-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"sudo-debugsource-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"sudo-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"sudo-debuginfo-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"sudo-debugsource-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"sudo-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"sudo-debuginfo-1.8.10p3-2.11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"sudo-debugsource-1.8.10p3-2.11.1")) flag++;
