...
if ( rpm_check(release:"SUSE11.2", reference:"libmodplug-devel-0.8.7-11.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libmodplug0-0.8.7-11.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libmodplug-devel / libmodplug0");
}
