...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : perl-HTML-Parser (ZYPP Patch Number 6621)");
...
into an endless loop. (CVE-2009-3627)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6621.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"perl-HTML-Parser-3.48-12.7.1")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"perl-HTML-Parser-3.48-12.7.1")) flag++;
