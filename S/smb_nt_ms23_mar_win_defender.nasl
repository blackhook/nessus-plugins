...
if (description)
{
  ...
  script_cve_id("CVE-2023-23389");
  script_xref(name:"MSKB", value:"4052623");
  script_xref(name:"MSFT", value:"MS22-4052623");

  script_name(english:"Security Updates for Windows Defender (March 2023)");
...
1.1.20000.2. It is, therefore, affected by a privilege escalation vulnerability. An authenticated attacker can exploit
...
"Microsoft has released KB4052623 to address this issue.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-23389");
