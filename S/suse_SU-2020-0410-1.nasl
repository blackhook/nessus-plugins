...
# extracted from SUSE update advisory SUSE-SU-2020:0410-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : wicked (SUSE-SU-2020:0410-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?374141f4"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
SUSE-OpenStack-Cloud-Crowbar-8-2020-410=1

SUSE OpenStack Cloud 8:zypper in -t patch
SUSE-OpenStack-Cloud-8-2020-410=1

SUSE OpenStack Cloud 7:zypper in -t patch
SUSE-OpenStack-Cloud-7-2020-410=1

SUSE Linux Enterprise Server for SAP 12-SP3:zypper in -t patch
SUSE-SLE-SAP-12-SP3-2020-410=1

SUSE Linux Enterprise Server for SAP 12-SP2:zypper in -t patch
SUSE-SLE-SAP-12-SP2-2020-410=1

SUSE Linux Enterprise Server 12-SP3-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2020-410=1

SUSE Linux Enterprise Server 12-SP3-BCL:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-BCL-2020-410=1

SUSE Linux Enterprise Server 12-SP2-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2020-410=1

SUSE Linux Enterprise Server 12-SP2-BCL:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-BCL-2020-410=1

SUSE Enterprise Storage 5:zypper in -t patch SUSE-Storage-5-2020-410=1
...
HPE-Helion-OpenStack-8-2020-410=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"wicked-0.6.60-38.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"wicked-debuginfo-0.6.60-38.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"wicked-debugsource-0.6.60-38.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"wicked-service-0.6.60-38.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"wicked-0.6.60-38.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"wicked-debuginfo-0.6.60-38.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"wicked-debugsource-0.6.60-38.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"wicked-service-0.6.60-38.27.1")) flag++;
