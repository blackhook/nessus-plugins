...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2645640");
...
complete control of the affected system."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-009");
  script_set_attribute(
    attribute:"solution",
    value:
