...
if(description)
{
 script_id(25282);
 script_version ("1.18");
 name["english"] = "Solaris 8 (i386) : 125672-01";
...
e +=  solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"125672-01", obsoleted_by:"122608-04 122608-05 122608-06 122608-07", package:"SUNWjass", version:"4.2.0");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
