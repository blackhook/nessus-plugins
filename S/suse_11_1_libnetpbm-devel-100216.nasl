...
if ( rpm_check(release:"SUSE11.1", reference:"libnetpbm-devel-10.26.44-98.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libnetpbm10-10.26.44-98.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"netpbm-10.26.44-98.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libnetpbm10-32bit-10.26.44-98.17.1") ) flag++;
