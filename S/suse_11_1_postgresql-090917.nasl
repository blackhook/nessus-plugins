...
# extracted from openSUSE Security Update postgresql-1322.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : postgresql (postgresql-1322)");
  script_summary(english:"Check for the postgresql-1322 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"postgresql-8.3.8-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"postgresql-contrib-8.3.8-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"postgresql-devel-8.3.8-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"postgresql-libs-8.3.8-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"postgresql-server-8.3.8-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"postgresql-libs-32bit-8.3.8-0.1.1") ) flag++;
