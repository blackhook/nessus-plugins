...
if (description)
{
  ...
  script_cve_id("CVE-2013-0412");
  script_bugtraq_id(59236);

  script_name(english:"Oracle Solaris Critical Patch Update : apr2013_SRU5");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: Utility/pax).
...
fix_release = "0.5.11-0.175.0.5.0.4.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.0.5.0.4.0", sru:"Solaris 11.0.5.4") > 0) flag++;
