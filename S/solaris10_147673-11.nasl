...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 147673-11");
  script_summary(english:"Check for patch 147673-11");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 147673-11"
  );
  script_set_attribute(
...
to cause a partial denial of service (partial DOS) of Solaris."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 147673-11 or higher");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"147673-11", obsoleted_by:"", package:"SUNWmcon", version:"3.0.2,REV=2006.12.08.20.48") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"147673-11", obsoleted_by:"", package:"SUNWmconr", version:"3.0.2,REV=2006.12.08.20.48") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"147673-11", obsoleted_by:"", package:"SUNWmcos", version:"3.0.2,REV=2006.12.08.20.48") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"147673-11", obsoleted_by:"", package:"SUNWmcosx", version:"3.0.2,REV=2006.12.08.20.48") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"147673-11", obsoleted_by:"", package:"SUNWmctag", version:"3.0.2,REV=2006.12.08.20.48") < 0) flag++;
