...
# extracted from openSUSE Security Update java-1_5_0-sun-1017.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : java-1_5_0-sun (java-1_5_0-sun-1017)");
  script_summary(english:"Check for the java-1_5_0-sun-1017 patch");
...
http://java.sun.com/j2se/1.5.0/ReleaseNotes.html"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.oracle.com/technetwork/java/index.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=507056"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"java-1_5_0-sun-1.5.0_update19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"java-1_5_0-sun-alsa-1.5.0_update19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"java-1_5_0-sun-demo-1.5.0_update19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"java-1_5_0-sun-devel-1.5.0_update19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"java-1_5_0-sun-jdbc-1.5.0_update19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"java-1_5_0-sun-plugin-1.5.0_update19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"java-1_5_0-sun-src-1.5.0_update19-0.1") ) flag++;
