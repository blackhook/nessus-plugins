...
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-0.8.1-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-client-0.8.1-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-devel-0.8.1-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-python-0.8.1-4.8.1") ) flag++;
