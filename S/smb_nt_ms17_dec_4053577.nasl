...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4053577");
  script_xref(name:"MSFT", value:"MS17-4053577");

  script_name(english:"KB4053577: Security update for Adobe Flash Player (December 2017)");
...
"The remote Windows host is missing security update KB4053577. It is,
therefore, affected by a vulnerability which may allow an attacker
to reset the global settings preference file.");
  ...
  # https://support.microsoft.com/en-us/help/4053577/security-update-for-adobe-flash-player-december-12-2017
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e94655ce");
...
# all <= 27.0.0.187
fix = FALSE;
if(ver_compare(ver:iver, fix:"27.0.0.187", strict:FALSE) <= 0)
  fix = "28.0.0.126";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS17-12', kb:'4053577', report);
