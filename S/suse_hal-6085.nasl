...
# extracted from openSUSE Security Update hal-6085.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : hal (hal-6085)");
  script_summary(english:"Check for the hal-6085 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"powersave-0.15.17-10.3") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"powersave-devel-0.15.17-10.3") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"powersave-libs-0.15.17-10.3") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"powersave-libs-32bit-0.15.17-10.3") ) flag++;
