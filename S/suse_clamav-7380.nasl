...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : clamav (ZYPP Patch Number 7380)");
...
was updated to version 0.97 to fix the issue. (CVE-2011-1003)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7380.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"clamav-0.97-5.5.3")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"clamav-0.97-5.5.3")) flag++;
