...
# extracted from openSUSE Security Update mailman-4271.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mailman (openSUSE-SU-2011:0312-1)");
  script_summary(english:"Check for the mailman-4271 patch");
  ...
  script_set_attribute(
    ...
    value:
"mailman was updates to version 2.1.14 to fix several
cross-site-scripting (XSS) vulnerabilities (CVE-2011-0707,
CVE-2010-3089)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=418589"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00023.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"mailman-2.1.14-6.2.1") ) flag++;
