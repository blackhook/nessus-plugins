...
# extracted from openSUSE Security Update gd-3896.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gd (gd-3896)");
  script_summary(english:"Check for the gd-3896 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"gd-2.0.32-23.10") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"gd-devel-2.0.32-23.10") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gd-2.0.32-53") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gd-devel-2.0.32-53") ) flag++;
