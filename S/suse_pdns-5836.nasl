...
# extracted from openSUSE Security Update pdns-5836.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : pdns (pdns-5836)");
  script_summary(english:"Check for the pdns-5836 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"pdns-2.9.21-57.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pdns-backend-ldap-2.9.21-57.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pdns-backend-mysql-2.9.21-57.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pdns-backend-postgresql-2.9.21-57.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pdns-backend-sqlite2-2.9.21-57.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pdns-backend-sqlite3-2.9.21-57.5") ) flag++;
