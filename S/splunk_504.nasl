...
only on the application's self-reported version number."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.splunk.com/view/SP-CAAAH32");
  script_set_attribute(attribute:"see_also", value:"http://docs.splunk.com/Special:SpecialLatestDoc?t=Documentation/Splunk/latest/ReleaseNotes/5.0.4");
