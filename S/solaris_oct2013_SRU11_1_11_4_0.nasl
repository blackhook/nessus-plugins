...
if (description)
{
  ...
  script_cve_id("CVE-2013-5863", "CVE-2013-5864", "CVE-2013-5865");
  script_bugtraq_id(63073, 63075, 63093);

  script_name(english:"Oracle Solaris Critical Patch Update : oct2013_SRU11_1_11_4_0");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: IPS repository
    daemon). The supported version that is affected is 11.1.
    ...
    accessible data. (CVE-2013-5863)

  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: USB hub driver).
    Supported versions that are affected are 10 and 11.1.
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: Utility/User
    administration). The supported version that is affected
    is 11.1. Easily exploitable vulnerability requiring
    logon to Operating System plus additional
    login/authentication to component or subcomponent.
    Successful attack of this vulnerability can escalate
    attacker privileges resulting in unauthorized ability to
    cause a partial denial of service (partial DOS) of
    Solaris. (CVE-2013-5865)"
  );
  script_set_attribute(
    attribute:"see_also",
