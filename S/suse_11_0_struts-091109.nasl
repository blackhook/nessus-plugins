...
if ( rpm_check(release:"SUSE11.0", reference:"struts-1.2.9-198.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"struts-javadoc-1.2.9-198.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"struts-manual-1.2.9-198.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"struts-webapps-tomcat6-1.2.9-198.4") ) flag++;
