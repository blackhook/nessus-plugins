...
the SUSE-SU-2022:3707-1 advisory.
...
var pkgs = [
    {'reference':'kpartx-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']},
    {'reference':'multipath-tools-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']},
    {'reference':'multipath-tools-devel-0.7.9+232+suse.cbc3754-3.14.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sle-sdk-release-12.5', 'sles-release-12.5']}
];
