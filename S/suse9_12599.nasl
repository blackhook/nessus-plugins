...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : libpng (YOU Patch Number 12599)");
...
assigned."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12599.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"libpng-1.2.5-182.28")) flag++;
if (rpm_check(release:"SUSE9", reference:"libpng-devel-1.2.5-182.28")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"libpng-32bit-9-201003180213")) flag++;
