...
attackers to execute arbitrary code remotely. (CVE-2012-1535)");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=775986");
  script_set_attribute(attribute:"see_also", value:"http://support.novell.com/security/cve/CVE-2012-1535.html");
  script_set_attribute(attribute:"solution", value:
"Apply SAT patch number 6678.");
