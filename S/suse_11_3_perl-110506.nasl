...
if ( rpm_check(release:"SUSE11.3", reference:"perl-5.12.1-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"perl-base-5.12.1-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"perl-32bit-5.12.1-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"perl-base-32bit-5.12.1-2.5.1") ) flag++;
