...
"Update the affected kernel-livepatch-4_12_14-150_63-default and / or kernel-livepatch-4_12_14-150_66-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150.63-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_63-default-13-2.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15', 'SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']}
        ]
      },
      '4.12.14-150.66-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_66-default-11-2.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15', 'SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']}
        ]
      }
    }
  }
