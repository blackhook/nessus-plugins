...
# extracted from openSUSE Security Update kdelibs4-4216.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kdelibs4 (openSUSE-SU-2011:0280-1)");
  script_summary(english:"Check for the kdelibs4-4216 patch");
...
certificate was issued for an IP address (CVE-2011-1094)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00006.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"kdelibs4-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"kdelibs4-branding-upstream-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"kdelibs4-core-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libkde4-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libkde4-devel-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libkdecore4-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libkdecore4-devel-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libkde4-32bit-4.3.5-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libkdecore4-32bit-4.3.5-0.3.1") ) flag++;
