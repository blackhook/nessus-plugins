...
# extracted from openSUSE Security Update freetype2-1910.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : freetype2 (freetype2-1910)");
  script_summary(english:"Check for the freetype2-1910 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"freetype2-2.1.10-18.8") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"freetype2-devel-2.1.10-18.8") ) flag++;
if ( rpm_check(release:"SUSE10.1", cpu:"x86_64", reference:"freetype2-32bit-2.1.10-18.8") ) flag++;
if ( rpm_check(release:"SUSE10.1", cpu:"x86_64", reference:"freetype2-devel-32bit-2.1.10-18.8") ) flag++;
