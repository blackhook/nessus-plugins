...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : net-snmp on SL6.x i386/x86_64 (20120620)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=2679
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?59f708d9"
  );
