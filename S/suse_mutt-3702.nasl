...
# extracted from openSUSE Security Update mutt-3702.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : mutt (mutt-3702)");
  script_summary(english:"Check for the mutt-3702 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"mutt-1.5.13-34") ) flag++;
