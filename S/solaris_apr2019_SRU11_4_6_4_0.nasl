...
security update :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.oracle.com/epmos/faces/DocumentDisplay?id=2525967.1"
  );
  # https://www.oracle.com/ocom/groups/public/@otn/documents/webcontent/5389083.xml
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ccb8c852"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.oracle.com/security-alerts/cpuapr2019.html"
  );
  script_set_attribute(
    attribute:"solution",
