...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rtkit on SL6.x i386/x86_64 (20130924)");
...
condition. (CVE-2013-4326)"
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:rtkit");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:rtkit-debuginfo");
