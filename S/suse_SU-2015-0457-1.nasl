...
# extracted from SUSE update advisory SUSE-SU-2015:0457-1.
...
if (description)
{
  ...
  script_bugtraq_id(71891, 72545);

  script_name(english:"SUSE SLED12 / SLES12 Security Update : dbus-1 (SUSE-SU-2015:0457-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=916343"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=916785"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-0245/"
  );
  # https://www.suse.com/support/update/announcement/2015/suse-su-20150457-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?303abd5c"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"dbus-1-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dbus-1-debuginfo-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dbus-1-debugsource-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dbus-1-x11-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dbus-1-x11-debuginfo-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dbus-1-x11-debugsource-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libdbus-1-3-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libdbus-1-3-debuginfo-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libdbus-1-3-32bit-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libdbus-1-3-debuginfo-32bit-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dbus-1-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dbus-1-debuginfo-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dbus-1-debugsource-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dbus-1-x11-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dbus-1-x11-debuginfo-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dbus-1-x11-debugsource-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"libdbus-1-3-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"libdbus-1-3-32bit-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"libdbus-1-3-debuginfo-1.8.16-14.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"libdbus-1-3-debuginfo-32bit-1.8.16-14.1")) flag++;
