...
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-devel-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-fonts-other-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-fonts-rus-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-fonts-std-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-ijs-devel-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-library-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-omni-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ghostscript-x11-8.62-17.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libgimpprint-4.2.7-258.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libgimpprint-devel-4.2.7-258.2") ) flag++;
