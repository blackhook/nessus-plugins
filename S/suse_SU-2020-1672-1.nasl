...
# extracted from SUSE update advisory SUSE-SU-2020:1672-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : dbus-1 (SUSE-SU-2020:1672-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1140091"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2019-12749/"
  );
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201672-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?def24240"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2020-1672=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2020-1672=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"dbus-1-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"dbus-1-debuginfo-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"dbus-1-debugsource-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"dbus-1-x11-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"dbus-1-x11-debuginfo-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"dbus-1-x11-debugsource-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libdbus-1-3-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libdbus-1-3-32bit-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libdbus-1-3-debuginfo-1.8.22-11.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libdbus-1-3-debuginfo-32bit-1.8.22-11.3.1")) flag++;
