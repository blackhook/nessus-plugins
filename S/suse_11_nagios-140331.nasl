...
if (description)
{
  ...
  script_name(english:"SuSE 11.3 Security Update : nagios (SAT Patch Number 9071)");
...
overflows in its CGI scripts. (CVE-2014-1878)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2014-1878.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 9071.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:3, reference:"nagios-3.0.6-1.25.36.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"nagios-www-3.0.6-1.25.36.1")) flag++;
