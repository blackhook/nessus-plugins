...
# extracted from openSUSE Security Update gv-2338.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gv (gv-2338)");
  script_summary(english:"Check for the gv-2338 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"gv-3.5.8-1156.8") ) flag++;
