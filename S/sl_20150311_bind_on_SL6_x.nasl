...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind on SL6.x, SL7.x i386/x86_64 (20150311)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1503&L=scientific-linux-errata&T=0&P=662
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9fdcdba4"
  );
