...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:0339");

  script_name(english:"Scientific Linux Security Update : linux-firmware on SL7.x (noarch) (2021:0339)");
...
SLSA-2021:0339-1 advisory.

  - hardware: buffer overflow in bluetooth firmware (CVE-2020-12321)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20210339-1");
...
pkgs = [
    {'reference':'iwl100-firmware-39.31.5.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl1000-firmware-39.31.5.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl105-firmware-18.168.6.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl135-firmware-18.168.6.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl2000-firmware-18.168.6.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl2030-firmware-18.168.6.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl3160-firmware-25.30.13.0-80.el7_9', 'release':'SL7'},
    {'reference':'iwl3945-firmware-15.32.2.9-80.el7_9', 'release':'SL7'},
    {'reference':'iwl4965-firmware-228.61.2.24-80.el7_9', 'release':'SL7'},
    {'reference':'iwl5000-firmware-8.83.5.1_1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl5150-firmware-8.24.2.2-80.el7_9', 'release':'SL7'},
    {'reference':'iwl6000-firmware-9.221.4.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl6000g2a-firmware-18.168.6.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl6000g2b-firmware-18.168.6.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl6050-firmware-41.28.5.1-80.el7_9', 'release':'SL7'},
    {'reference':'iwl7260-firmware-25.30.13.0-80.el7_9', 'release':'SL7'},
    {'reference':'linux-firmware-20200421-80.git78c0348.el7_9', 'release':'SL7'}
];
