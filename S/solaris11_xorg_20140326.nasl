...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : xorg (cve_2013_6462_buffer_errors)");
...
security updates :
  ...
  - Stack-based buffer overflow in the bdfReadCharacters
    function in bitmap/ bdfread.c in X.Org libXfont 1.1
    through 1.4.6 allows remote attackers to cause a denial
    of service (crash) or possibly execute arbitrary code
    via a long string in a character name in a BDF font
    file. (CVE-2013-6462)"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2013-6462-buffer-errors-vulnerability-in-xorg"
  );
