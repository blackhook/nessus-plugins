...
# extracted from openSUSE Security Update libpng14-5847.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpng14 (libpng14-5847)");
  script_summary(english:"Check for the libpng14-5847 patch");
...
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-14-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-14-debuginfo-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-compat-devel-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-debugsource-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libpng14-devel-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-14-32bit-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-14-debuginfo-32bit-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-compat-devel-32bit-1.4.4-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libpng14-devel-32bit-1.4.4-3.6.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libpng14");
}
