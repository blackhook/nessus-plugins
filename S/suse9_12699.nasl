...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : dhcpcd (YOU Patch Number 12699)");
...
administrators are advised to check their server setup."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12699.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"dhcpcd-1.3.22pl4-193.19")) flag++;
