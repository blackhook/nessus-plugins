...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : jan2018_SRU11_1_12_5_0");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    ...
    attacker with network access via ICMP to compromise
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: SPARC Platform).
