...
# extracted from SUSE update advisory SUSE-SU-2021:0714-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : freeradius-server (SUSE-SU-2021:0714-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1180525"
  );
  # https://www.suse.com/support/update/announcement/2021/suse-su-20210714-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8698640a"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP2-2021-714=1"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:freeradius-server-python3-debuginfo");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-debugsource-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-devel-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-krb5-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-krb5-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-ldap-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-ldap-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-libs-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-libs-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-mysql-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-mysql-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-perl-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-perl-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-postgresql-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-postgresql-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-python3-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-python3-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-sqlite-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-sqlite-debuginfo-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-utils-3.0.21-3.6.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"freeradius-server-utils-debuginfo-3.0.21-3.6.1")) flag++;
