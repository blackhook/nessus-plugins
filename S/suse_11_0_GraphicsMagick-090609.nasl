...
if ( rpm_check(release:"SUSE11.0", reference:"GraphicsMagick-1.1.11-29.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"GraphicsMagick-devel-1.1.11-29.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libGraphicsMagick++-devel-1.1.11-29.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libGraphicsMagick++1-1.1.11-29.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libGraphicsMagick1-1.1.11-29.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libGraphicsMagickWand0-1.1.11-29.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"perl-GraphicsMagick-1.1.11-29.5") ) flag++;
