...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2978114");
  script_xref(name:"MSKB", value:"2978116");
  script_xref(name:"MSKB", value:"2978120");
  script_xref(name:"MSKB", value:"2978121");
  script_xref(name:"MSKB", value:"2978122");
  script_xref(name:"MSKB", value:"2978124");
  script_xref(name:"MSKB", value:"2978125");
  script_xref(name:"MSKB", value:"2978126");
  script_xref(name:"MSKB", value:"2978127");
  script_xref(name:"MSKB", value:"2978128");
  script_xref(name:"IAVA", value:"2014-A-0173-S");
...
packet sent to a host that is using .NET Remoting.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?e3a3b608");
