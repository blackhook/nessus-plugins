...
# extracted from openSUSE Security Update apache2-mod_jk-6599.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : apache2-mod_jk (apache2-mod_jk-6599)");
  script_summary(english:"Check for the apache2-mod_jk-6599 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"apache2-mod_jk-1.2.21-59.4") ) flag++;
