...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL7.x x86_64 (20200407)");
...
updates."
  ...
  script_set_attribute(
    ...
    value:"* QEMU: Slirp: potential OOB access due to unsafe snprintf() usages"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=20993
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ea10244"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-img-1.5.3-173.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-173.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-173.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-173.el7_8.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-173.el7_8.1")) flag++;
