...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2296199");
...
Format Driver that is affected by two vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-091");
  script_set_attribute(
    attribute:"solution",
    value:
