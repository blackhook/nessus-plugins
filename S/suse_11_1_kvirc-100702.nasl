...
# extracted from openSUSE Security Update kvirc-2642.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kvirc (openSUSE-SU-2010:0354-1)");
  script_summary(english:"Check for the kvirc-2642 patch");
...
directory traversal vulnerability (CVE-2010-2451, CVE-2010-2452)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=613163"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-07/msg00001.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"kvirc-3.4.2-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kvirc-devel-3.4.2-2.25.1") ) flag++;
