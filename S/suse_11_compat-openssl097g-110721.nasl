...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : compat-openssl097g (SAT Patch Number 4913)");
...
"This update adds openssl patches since 2007 for :
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4913.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"compat-openssl097g-0.9.7g-146.20.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"compat-openssl097g-0.9.7g-146.20.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"compat-openssl097g-32bit-0.9.7g-146.20.1")) flag++;
