...
if (description)
{
  ...
  script_cve_id("CVE-2023-31404");
  script_xref(name:"IAVA", value:"2023-A-0241");

  script_name(english:"SAP BusinessObjects Business Intelligence Platform Information Disclosure (3038911)");
...
(Central Management Service) - versions 420, 430, allows an attacker to access information which would otherwise be 
restricted. Some users with specific privileges could have access to credentials of other users. It could let them 
access data sources which would otherwise be restricted.

Note that Nessus has not attempted to exploit these issues but has instead relied only on the application's
self-reported version number.");
  # https://www.sap.com/documents/2022/02/fa865ea4-167e-0010-bca6-c68f7e60039b.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18f404d5");
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3038911");
...
"See vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-31404");
...
var constraints = [
  { 'min_version': '14.2', 'fixed_version' : '14.2.9.3900', 'fixed_display': '4.2 SP009 000200'},
  { 'min_version': '14.3.0', 'fixed_version' : '14.3.0.3909', 'fixed_display': '4.3 SP000 000800'},
  { 'min_version': '14.3.1', 'fixed_version' : '14.3.1.3877', 'fixed_display': '4.3 SP001 000500'}
];
