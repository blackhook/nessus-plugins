...
# SUSE update advisory SUSE-SU-2019:14099-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2019:14099-1");

  script_name(english:"SUSE SLES11 Security Update : libssh2_org (SUSE-SU-2019:14099-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1128481");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1136570");
  # https://lists.suse.com/pipermail/sle-security-updates/2019-June/005594.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d05ac48a");
...
pkgs = [
    {'reference':'libssh2-1-1.4.3-17.9', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'libssh2-1-1.4.3-17.9', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
