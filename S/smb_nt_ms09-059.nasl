...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"975467");
  script_xref(name:"IAVB", value:"2009-B-0054-S");
...
of service.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?ccd9852f");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows 2000, XP, 2003,
Vista and 2008 and 7.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-2524");
