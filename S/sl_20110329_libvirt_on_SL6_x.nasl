...
building , allowing the libvirt source RPM to build as expected."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1103&L=scientific-linux-errata&T=0&P=10660
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7343c030"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libvirt-0.8.1-27.el6_0.5")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-client-0.8.1-27.el6_0.5")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-devel-0.8.1-27.el6_0.5")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-python-0.8.1-27.el6_0.5")) flag++;
