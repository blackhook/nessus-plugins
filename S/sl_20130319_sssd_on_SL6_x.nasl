...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sssd on SL6.x i386/x86_64 (20130319)");
...
This update also fixes the following bugs :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1303&L=scientific-linux-errata&T=0&P=5274
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0066e859"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:libsss_sudo-devel");
