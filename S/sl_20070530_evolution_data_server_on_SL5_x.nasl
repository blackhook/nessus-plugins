...
of a user's authentication credentials. (CVE-2007-1558)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0706&L=scientific-linux-errata&T=0&P=75
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?309c7b14"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL5", reference:"evolution-data-server-1.8.0-15.0.3.el5")) flag++;
if (rpm_check(release:"SL5", reference:"evolution-data-server-devel-1.8.0-15.0.3.el5")) flag++;
