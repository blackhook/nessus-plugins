...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS16-150");
  script_xref(name:"MSKB", value:"3205383");
  script_xref(name:"MSKB", value:"3205386");
  script_xref(name:"MSKB", value:"3206632");
  script_xref(name:"IAVA", value:"2016-A-0348");

  script_name(english:"MS16-150: Security Update for Secure Kernel Mode (3205642)");
  script_summary(english:"Checks for the December 2016 Rollup.");
...
therefore, affected by an elevation of privilege vulnerability in
Windows Secure Kernel Mode due to improper handling of objects in
memory. A local attacker can exploit this, via a specially crafted
application, to bypass virtual trust levels (VTL).");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-150");
...
"Microsoft has released a set of patches for Windows 10 and 2016.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7271");
...
kbs = make_list(
  '3205383', # 10
  '3205386', # 10 Version 1511
  '3206632'  # 10 Version 1607, Server 2016
);
