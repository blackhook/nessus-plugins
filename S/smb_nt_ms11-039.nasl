...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2478656");
  script_xref(name:"MSKB", value:"2478657");
  script_xref(name:"MSKB", value:"2478658");
  script_xref(name:"MSKB", value:"2478659");
  script_xref(name:"MSKB", value:"2478660");
  script_xref(name:"MSKB", value:"2478661");
  script_xref(name:"MSKB", value:"2478662");
  script_xref(name:"MSKB", value:"2478663");
  script_xref(name:"MSKB", value:"2512827");
...
unsafely, resulting in arbitrary code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-039");
  script_set_attribute(
    attribute:"solution",
    value:
