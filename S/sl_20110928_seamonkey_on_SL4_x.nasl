...
restarted for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1109&L=scientific-linux-errata&T=0&P=3979
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aedea8df"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"seamonkey-1.0.9-76.el4")) flag++;
if (rpm_check(release:"SL4", reference:"seamonkey-chat-1.0.9-76.el4")) flag++;
if (rpm_check(release:"SL4", reference:"seamonkey-debuginfo-1.0.9-76.el4")) flag++;
if (rpm_check(release:"SL4", reference:"seamonkey-devel-1.0.9-76.el4")) flag++;
if (rpm_check(release:"SL4", reference:"seamonkey-dom-inspector-1.0.9-76.el4")) flag++;
if (rpm_check(release:"SL4", reference:"seamonkey-js-debugger-1.0.9-76.el4")) flag++;
if (rpm_check(release:"SL4", reference:"seamonkey-mail-1.0.9-76.el4")) flag++;
