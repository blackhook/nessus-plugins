...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : luci on SL6.x i386/x86_64 (20141014)");
...
host running luci. (CVE-2014-3593)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1411&L=scientific-linux-errata&T=0&P=1109
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a26856b2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"luci-0.26.0-63.el6")) flag++;
if (rpm_check(release:"SL6", reference:"luci-debuginfo-0.26.0-63.el6")) flag++;
