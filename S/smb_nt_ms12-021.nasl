...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2669970");
  script_xref(name:"MSKB", value:"2644980");
  script_xref(name:"MSKB", value:"2645410");
...
higher privileges to start Visual Studio.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-021");
