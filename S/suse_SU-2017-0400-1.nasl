...
# extracted from SUSE update advisory SUSE-SU-2017:0400-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : spice (SUSE-SU-2017:0400-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170400-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?68f04714"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch SUSE-SLE-SDK-12-SP1-2017-198=1

SUSE Linux Enterprise Server 12-SP1:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2017-198=1

SUSE Linux Enterprise Desktop 12-SP1:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP1-2017-198=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"libspice-server1-0.12.5-7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.5-7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"spice-debugsource-0.12.5-7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"libspice-server1-0.12.5-7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.5-7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"spice-debugsource-0.12.5-7.1")) flag++;
