...
# extracted from openSUSE Security Update kde4-akonadi-806.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kde4-akonadi (kde4-akonadi-806)");
  script_summary(english:"Check for the kde4-akonadi-806 patch");
...
kdepimlibs4 :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=430825"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=481612"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected kde4-akonadi packages."
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-akonadi");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-akonadi-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-akregator");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-kaddressbook");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-kalarm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-kjots");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-kmail");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-knode");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-knotes");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-kontact");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-korganizer");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-ktimetracker");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kde4-ktnef");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kdepim4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kdepim4-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kdepim4-wizards");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:kdepimlibs4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libakonadi4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libkdepim4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libkdepim4-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libkdepimlibs4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libkdepimlibs4-devel");
...
if ( rpm_check(release:"SUSE11.1", reference:"kde4-akonadi-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-akonadi-devel-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-akregator-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-kaddressbook-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-kalarm-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-kjots-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-kmail-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-knode-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-knotes-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-kontact-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-korganizer-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-ktimetracker-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kde4-ktnef-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim4-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim4-devel-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim4-wizards-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepimlibs4-4.1.3-5.2.6") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libakonadi4-4.1.3-5.2.6") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkdepim4-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkdepim4-devel-4.1.3-3.14.9") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkdepimlibs4-4.1.3-5.2.6") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkdepimlibs4-devel-4.1.3-5.2.6") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "kdepim4");
}
