...
if ( rpm_check(release:"SUSE11.0", reference:"python-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-curses-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-demo-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-devel-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-gdbm-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-idle-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-tk-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-xml-2.5.2-26.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"python-32bit-2.5.2-26.6") ) flag++;
