...
if (description)
{
  ...
  script_cve_id("CVE-2018-2763", "CVE-2018-2764", "CVE-2018-2792", "CVE-2018-2808");

  script_name(english:"Oracle Solaris Critical Patch Update : apr2018_SRU11_3_30_5_0");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: NTPD). The
  ...
  - Vulnerability in the Hardware Management Pack component
    of Oracle Sun Systems Products Suite (subcomponent:
    Ipmitool). The supported version that is affected is
    Prior to 2.4.3. Easily exploitable vulnerability allows
    high privileged attacker with network access via
    multiple protocols to compromise Hardware Management
    Pack. Successful attacks of this vulnerability can
    result in unauthorized update, insert or delete access
    to some of Hardware Management Pack accessible data as
    well as unauthorized read access to a subset of Hardware
    Management Pack accessible data. (CVE-2018-2792)
...
fix_release = "0.5.11-0.175.3.30.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.30.0.5.0", sru:"11.3.30.5.0") > 0) flag++;
