...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 147936-01 (deprecated)");
...
147936 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 147936 instead.");
