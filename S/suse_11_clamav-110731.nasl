...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : ClamAV (SAT Patch Number 4942)");
...
to a DoS condition. CVE-2011-2721 has been assigned to this issue."
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4942.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"clamav-0.97.2-1.2.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"clamav-0.97.2-1.2.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"clamav-0.97.2-1.2.1")) flag++;
