...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python-jinja2 on SL6.x i386/x86_64 (20140611)");
...
For the update to take effect, all applications using python-jinja2
must be restarted."
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1406&L=scientific-linux-errata&T=0&P=1980
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2f0b9a72"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:python-jinja2-debuginfo");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"python-jinja2-2.2.1-2.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"python-jinja2-debuginfo-2.2.1-2.el6_5")) flag++;
