...
if ( rpm_check(release:"SUSE11.0", reference:"MozillaThunderbird-2.0.0.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"MozillaThunderbird-devel-2.0.0.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"MozillaThunderbird-translations-2.0.0.19-0.1") ) flag++;
