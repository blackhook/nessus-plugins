...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : SUSE Manager Client Tools (SUSE-SU-2022:3751-1)");
...
"Update the affected dracut-saltboot, golang-github-lusitaniae-apache_exporter, golang-github-prometheus-node_exporter
and / or spacecmd packages.");
...
var pkgs = [
    {'reference':'golang-github-prometheus-node_exporter-1.3.0-150000.3.18.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15', 'SLE_HPC-ESPOS-release-15', 'SLE_HPC-LTSS-release-15']},
    ...
    {'reference':'dracut-saltboot-0.1.1661440542.6cbe0da-150000.1.38.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.3']},
    {'reference':'golang-github-lusitaniae-apache_exporter-0.11.0-150000.1.12.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.3']},
    {'reference':'spacecmd-4.3.15-150000.3.86.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.3']},
    {'reference':'dracut-saltboot-0.1.1661440542.6cbe0da-150000.1.38.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'golang-github-lusitaniae-apache_exporter-0.11.0-150000.1.12.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'spacecmd-4.3.15-150000.3.86.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'golang-github-prometheus-node_exporter-1.3.0-150000.3.18.1', 'sp':'0', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-ltss-release-15']}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'dracut-saltboot / golang-github-lusitaniae-apache_exporter / etc');
}
