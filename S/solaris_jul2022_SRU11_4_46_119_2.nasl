...
if (description)
{
  ...
  script_cve_id("CVE-2022-21514");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2022_SRU11_4_46_119_2");
...
security update :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    Systems (component: Remote Administration Daemon). The
    ...
    DOS) of Oracle Solaris. CVSS 3.1 Base Score 7.5
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-21514");
