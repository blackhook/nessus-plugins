...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 148565-01 (deprecated)");
...
148565 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 148565 instead.");
