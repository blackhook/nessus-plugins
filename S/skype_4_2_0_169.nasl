...
"The remote Skype client allows deletion of arbitrary XML files.");
...
on the affected system subject to the user's privileges.");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-10-028/");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2010/Mar/115");
