...
# extracted from openSUSE Security Update libpoppler-devel-3335.
#
...
if (description)
{
  ...
  script_summary(english:"Check for the libpoppler-devel-3335 patch");
...
if ( rpm_check(release:"SUSE11.3", reference:"libpoppler-devel-0.12.3-5.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libpoppler-glib-devel-0.12.3-5.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libpoppler-glib4-0.12.3-5.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libpoppler5-0.12.3-5.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"poppler-tools-0.12.3-5.1.1") ) flag++;
