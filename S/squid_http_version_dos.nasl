...
was not built with the 'NODEBUG' define." );
 # http://www.squid-cache.org/Advisories/SQUID-2009_1.txt
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2415a098" );
 # https://www.securityfocus.com/archive/1/500653/30/0/threaded
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?49102613" );
...
/ 3.1.0.5 or later." );
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-0478");
...
foreach port (ports)
{
  ...
  if ("Squid/" >< res || "squid/" >< res)
  {
    ...
    else
    {
      ...
      req = string(
        "GET http://www.example.com/ HTTP/", http_version, "\r\n",
