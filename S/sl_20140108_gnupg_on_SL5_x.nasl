...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gnupg on SL5.x i386/x86_64 (20140108)");
...
the RSA secret key from that system. (CVE-2013-4576)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1401&L=scientific-linux-errata&T=0&P=315
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?25552a98"
  );
  script_set_attribute(
    attribute:"solution", 
