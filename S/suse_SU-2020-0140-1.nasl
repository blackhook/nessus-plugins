...
# extracted from SUSE update advisory SUSE-SU-2020:0140-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : java-11-openjdk (SUSE-SU-2020:0140-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200140-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a37bc404"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-11-openjdk-11.0.6.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-11-openjdk-debuginfo-11.0.6.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-11-openjdk-debugsource-11.0.6.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-11-openjdk-demo-11.0.6.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-11-openjdk-devel-11.0.6.0-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-11-openjdk-headless-11.0.6.0-3.6.1")) flag++;
