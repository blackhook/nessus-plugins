...
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-1.2.11-3.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-backend-mysql-1.2.11-3.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-backend-pgsql-1.2.11-3.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-backend-sqlite-1.2.11-3.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-devel-1.2.11-3.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-fts-lucene-1.2.11-3.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dovecot12-fts-solr-1.2.11-3.1.1") ) flag++;
