...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 127656-07 (deprecated)");
  script_summary(english:"Check for patch 127656-07");

  script_set_attribute(attribute:"synopsis", value:"This plugin has been deprecated.");
  script_set_attribute(
    attribute:"description",
    value:
"5.10_x86 VERITAS NetBackup 6.5 Product Release Update 6.5.6 for x6.
Date this patch was last updated by Sun : May/12/10

This plugin has been deprecated and either replaced with individual
127656 patch-revision plugins, or deemed non-security related."
  );
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 127656 instead.");
