...
# extracted from SUSE update advisory SUSE-SU-2016:3054-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : xorg-x11-libX11 (SUSE-SU-2016:3054-1)");
...
"This update for xorg-x11-libX11 fixes the following issues :
  ...
  - insufficient validation of data from the X server can
    ...
    (XListFonts()) (bsc#1002991, CVE-2016-7942)
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20163054-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06a71749"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-xorg-x11-libX11-12877=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-xorg-x11-libX11-12877=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-xorg-x11-libX11-12877=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"xorg-x11-libX11-32bit-7.4-5.11.65.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"xorg-x11-libX11-32bit-7.4-5.11.65.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"xorg-x11-libX11-7.4-5.11.65.1")) flag++;
