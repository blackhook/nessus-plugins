...
if(description)
{
 ...
 name["english"] = "Solaris 2.5.1 (sparc) : 106787-19";
...
( DMI Server provider , See Problem Description).

You should install this patch for your system to be up-to-date." );
 script_set_attribute(attribute:"solution", value:
"https://getupdates.oracle.com/readme/106787-19" );
...
e =  solaris_check_patch(release:"5.5.1", arch:"sparc", patch:"106787-19", obsoleted_by:"", package:"SUNWmibii SUNWsacom SUNWsadmi SUNWsasnm");
