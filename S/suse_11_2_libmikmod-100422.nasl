...
if ( rpm_check(release:"SUSE11.2", reference:"libmikmod-3.1.11a-118.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libmikmod-devel-3.1.11a-118.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libmikmod-32bit-3.1.11a-118.2.1") ) flag++;
