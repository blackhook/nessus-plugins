...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"917334");
  script_xref(name:"MSKB", value:"917335");
  script_xref(name:"MSKB", value:"917336");
  script_xref(name:"MSKB", value:"917345");
...
handler would result in code execution.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2006/ms06-027");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Word 2000, XP and 2003.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2006-2492");
