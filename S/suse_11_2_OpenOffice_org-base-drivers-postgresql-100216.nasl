...
# extracted from openSUSE Security Update OpenOffice_org-base-drivers-postgresql-1980.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : OpenOffice_org-base-drivers-postgresql (OpenOffice_org-base-drivers-postgresql-1980)");
  script_summary(english:"Check for the OpenOffice_org-base-drivers-postgresql-1980 patch");
...
vulnerabilities :
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:OpenOffice_org-components");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:OpenOffice_org-components-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:OpenOffice_org-components-l10n-prebuilt");
...
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-base-drivers-postgresql-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-components-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-components-devel-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-components-l10n-prebuilt-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-gnome-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-kde-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-kde4-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-core-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-core-devel-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-core-l10n-prebuilt-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-extern-3.1.1.4-1.1.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-extern-devel-3.1.1.4-1.1.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-extern-l10n-prebuilt-3.1.1.4-1.1.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-gui-3.1.1.4-1.1.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-gui-devel-3.1.1.4-1.1.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-gui-l10n-prebuilt-3.1.1.4-1.1.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-mailmerge-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-math-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-officebean-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-testtool-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-writer-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-writer-devel-3.1.1.4-1.2.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-writer-l10n-prebuilt-3.1.1.4-1.2.3") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "OpenOffice_org-base-drivers-postgresql / OpenOffice_org-components / etc");
}
