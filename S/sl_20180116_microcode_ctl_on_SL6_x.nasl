...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : microcode_ctl on SL6.x, SL7.x i386/x86_64 (20180116) (Spectre)");
...
vendor."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f8342d0a"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"microcode_ctl-1.17-25.4.el6_9")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"microcode_ctl-debuginfo-1.17-25.4.el6_9")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"microcode_ctl-2.1-22.5.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"microcode_ctl-debuginfo-2.1-22.5.el7_4")) flag++;
