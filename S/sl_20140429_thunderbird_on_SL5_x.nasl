...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL5.x, SL6.x i386/x86_64 (20140429)");
...
changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1404&L=scientific-linux-errata&T=0&P=2839
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4c3a6475"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
