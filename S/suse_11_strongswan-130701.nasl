...
flag = 0;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"strongswan-4.4.0-6.17.5")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"strongswan-doc-4.4.0-6.17.5")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"strongswan-4.4.0-6.17.5")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"strongswan-doc-4.4.0-6.17.5")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"i586", reference:"strongswan-4.4.0-6.17.5")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"i586", reference:"strongswan-doc-4.4.0-6.17.5")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"x86_64", reference:"strongswan-4.4.0-6.17.5")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"x86_64", reference:"strongswan-doc-4.4.0-6.17.5")) flag++;
