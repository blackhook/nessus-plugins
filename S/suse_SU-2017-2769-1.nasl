...
# extracted from SUSE update advisory SUSE-SU-2017:2769-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2017:2769-1) (BlueBorne)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f1797c76"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
SUSE-SLE-SERVER-12-2017-1714=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_69-default-6-4.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_61-52_69-xen-6-4.1")) flag++;
