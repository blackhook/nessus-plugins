...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gnupg on SL5.x i386/x86_64 (20131024)");
...
holder. (CVE-2013-4351)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1310&L=scientific-linux-errata&T=0&P=2760
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5126f9d7"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:gnupg");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:gnupg-debuginfo");
