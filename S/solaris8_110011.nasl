...
if(description)
{
 ...
 name["english"] = "Solaris 8 (sparc) : 110011-02";
...
e +=  solaris_check_patch(release:"5.8", arch:"sparc", patch:"110011-02", obsoleted_by:"", package:"SUNWab2u", version:"3.0,REV=1999.1209");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
