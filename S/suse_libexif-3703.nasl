...
# extracted from openSUSE Security Update libexif-3703.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libexif (libexif-3703)");
  script_summary(english:"Check for the libexif-3703 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"libexif-0.6.14-20") ) flag++;
if ( rpm_check(release:"SUSE10.2", cpu:"x86_64", reference:"libexif-32bit-0.6.14-20") ) flag++;
