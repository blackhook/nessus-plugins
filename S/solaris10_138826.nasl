...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 138826-12 (deprecated)");
...
138826 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 138826 instead.");
