...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : ipsec-tools (SAT Patch Number 998)");
...
allowed to execute a remote denial of service attack. (CVE-2009-1632)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 998.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_cwe_id(399);

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:11:ipsec-tools");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:0, reference:"ipsec-tools-0.7.1-10.31.1")) flag++;
