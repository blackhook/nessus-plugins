...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3181707");
...
a specially crafted application, to gain elevated privileges.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-134");
...
2008 R2, 2012, 8.1, RT 8.1, 2012 R2, 10, and 2016.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7184");
