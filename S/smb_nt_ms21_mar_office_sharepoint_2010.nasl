...
if (description)
{
  ...
  script_cve_id("CVE-2021-27076");
  script_xref(name:"MSKB", value:"3101541");
  script_xref(name:"MSFT", value:"MS21-3101541");
  script_xref(name:"IAVA", value:"2021-A-0136-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2010 (March 2021)");
...
unauthorized arbitrary commands.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/3101541");
  ...
  { '2':
    {'Server':
      [{
         ...
         'path'         : install['path'],
         'append'       : 'bin',
         'file'         : 'Microsoft.Office.Infopath.Server.dll',
         'version'      : '14.0.7267.5000',
