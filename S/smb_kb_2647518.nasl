...
if (description)
{
  ...
  script_bugtraq_id(51184, 51448);
  script_xref(name:"MSKB", value:"2647518");
...
Explorer.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2647518/microsoft-security-advisory-cumulative-security-update-for-activex-kil");
