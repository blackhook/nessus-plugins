...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : samba (cve_2013_4496_credentials_management)");
...
security updates :
  ...
  - Samba 3.x before 3.6.23, 4.0.x before 4.0.16, and 4.1.x
    before 4.1.6 does not enforce the password-guessing
    protection mechanism for all interfaces, which makes it
    easier for remote attackers to obtain access via
    brute-force ChangePasswordUser2 (1) SAMR or (2) RAP
    attempts. (CVE-2013-4496)"
  );
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2013-4496-credentials-management-vulnerability-in-samba
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f54aa15"
  );
