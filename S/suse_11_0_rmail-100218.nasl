...
if ( rpm_check(release:"SUSE11.0", reference:"rmail-8.14.3-8.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"sendmail-8.14.3-8.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"sendmail-devel-8.14.3-8.2") ) flag++;
