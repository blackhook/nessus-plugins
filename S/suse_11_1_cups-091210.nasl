...
if ( rpm_check(release:"SUSE11.1", reference:"cups-1.3.9-7.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"cups-client-1.3.9-7.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"cups-devel-1.3.9-7.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"cups-libs-1.3.9-7.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"cups-libs-32bit-1.3.9-7.6.1") ) flag++;
