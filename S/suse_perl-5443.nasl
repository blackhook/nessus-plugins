...
# extracted from openSUSE Security Update perl-5443.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : perl (perl-5443)");
  script_summary(english:"Check for the perl-5443 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"perl-5.8.8-36") ) flag++;
if ( rpm_check(release:"SUSE10.2", cpu:"x86_64", reference:"perl-32bit-5.8.8-36") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"perl-5.8.8-76.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"perl-base-5.8.8-76.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"perl-32bit-5.8.8-76.4") ) flag++;
