...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002312");
  script_xref(name:"MSFT", value:"MS23-5002312");
  script_xref(name:"IAVA", value:"2023-A-0084-S");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2013 (February 2023)");
...
affected by multiple vulnerabilities:
  ...
  - An elevation of privilege vulnerability. An attacker can
    ...
    (CVE-2023-21717)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002312");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5002312 to address this issue.");
