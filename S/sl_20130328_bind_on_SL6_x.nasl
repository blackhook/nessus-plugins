...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind on SL6.x i386/x86_64 (20130328)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1303&L=scientific-linux-errata&T=0&P=6558
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e394c0a"
  );
