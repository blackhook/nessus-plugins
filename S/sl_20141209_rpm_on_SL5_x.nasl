...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rpm on SL5.x, SL6.x i386/x86_64 (20141209)");
...
restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1412&L=scientific-linux-errata&T=0&P=1571
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?70063d71"
  );
