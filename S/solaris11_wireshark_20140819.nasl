...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : wireshark (cve_2014_4020_numeric_errors)");
...
security updates :
  ...
  - The dissect_frame function in
    epan/dissectors/packet-frame.c in the frame
    metadissector in Wireshark 1.10.x before 1.10.8
    interprets a negative integer as a length value even
    though it was intended to represent an error condition,
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2014-4020-numeric-errors-vulnerability-in-wireshark
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d1795724"
  );
