...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x i386/x86_64 (20130402)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1304&L=scientific-linux-errata&T=0&P=328
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26776de7"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"firefox-17.0.5-1.el5_9")) flag++;
if (rpm_check(release:"SL5", reference:"firefox-debuginfo-17.0.5-1.el5_9")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-17.0.5-1.el5_9")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-debuginfo-17.0.5-1.el5_9")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-17.0.5-1.el5_9")) flag++;

if (rpm_check(release:"SL6", reference:"firefox-17.0.5-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-17.0.5-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"xulrunner-17.0.5-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"xulrunner-debuginfo-17.0.5-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"xulrunner-devel-17.0.5-1.el6_4")) flag++;
