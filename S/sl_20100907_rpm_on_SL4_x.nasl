...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : rpm on SL4.x i386/x86_64");
...
CVE-2010-2059)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1009&L=scientific-linux-errata&T=0&P=642
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf443704"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"popt-1.9.1-33_nonptl.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"rpm-4.3.3-33_nonptl.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"rpm-build-4.3.3-33_nonptl.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"rpm-devel-4.3.3-33_nonptl.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"rpm-libs-4.3.3-33_nonptl.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"rpm-python-4.3.3-33_nonptl.el4_8.1")) flag++;
