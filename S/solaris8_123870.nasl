...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 123870-05");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"123870-05", obsoleted_by:"", package:"SUNWsrspx", version:"001.002.006") < 0) flag++;
