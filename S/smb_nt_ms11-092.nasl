...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2619339");
  script_xref(name:"MSKB", value:"2619340");
...
to execute arbitrary code subject to the user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-092");
  script_set_attribute(
    attribute:"solution",
