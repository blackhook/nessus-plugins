...
access problems."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00007.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00018.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"krb5-appl-clients-1.0-4.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"krb5-appl-servers-1.0-4.5.1") ) flag++;
