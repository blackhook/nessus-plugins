...
# extracted from openSUSE Security Update clamav-6145.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : clamav (clamav-6145)");
  script_summary(english:"Check for the clamav-6145 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"clamav-0.95-0.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"clamav-db-0.95-0.2") ) flag++;
