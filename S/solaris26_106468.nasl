...
if(description)
{
 ...
 script_name(english: "Solaris 2.6 (sparc) : 106468-06");
...
"http://download.oracle.com/sunalerts/1000684.1.html");
 ...
 script_summary(english: "Check for patch 106468-06");
...
e +=  solaris_check_patch(release:"5.6", arch:"sparc", patch:"106468-06", obsoleted_by:"", package:"SUNWbnuu", version:"11.6.0,REV=1997.07.15.21.46");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
