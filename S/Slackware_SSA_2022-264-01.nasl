...
# extracted from Slackware Security Advisory SSA:2022-264-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 / current bind  Multiple Vulnerabilities (SSA:2022-264-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to bind.");
  script_set_attribute(attribute:"description", value:
"The version of bind installed on the remote host is prior to 9.16.33 / 9.18.7. It is, therefore, affected by multiple
vulnerabilities as referenced in the SSA:2022-264-01 advisory.
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '9.16.33', 'product' : 'bind', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '9.16.33', 'product' : 'bind', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' },
    { 'fixed_version' : '9.18.7', 'product' : 'bind', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'i586' },
    { 'fixed_version' : '9.18.7', 'product' : 'bind', 'os_name' : 'Slackware Linux', 'os_version' : 'current', 'service_pack' : '1', 'arch' : 'x86_64' }
];
