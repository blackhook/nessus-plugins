...
if ( rpm_check(release:"SUSE11.0", reference:"libwmf-0.2.8.4-164.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libwmf-devel-0.2.8.4-164.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libwmf-gnome-0.2.8.4-164.2") ) flag++;
