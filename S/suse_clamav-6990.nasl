...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : clamav (ZYPP Patch Number 6990)");
...
optimizations."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6990.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"clamav-0.96-0.6.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"clamav-0.96-0.6.1")) flag++;
