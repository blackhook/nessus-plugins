...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 126479-26");
  script_summary(english:"Check for patch 126479-26");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 126479-26"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"126479-26", obsoleted_by:"", package:"SUNWmessaging-server-64", version:"6.3,REV=2007.02.26") < 0) flag++;
