...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : apache2 (SUSE-SU-2022:0091-2)");
...
referenced in the SUSE-SU-2022:0091-2 advisory.
...
var pkgs = [
    {'reference':'apache2-event-2.4.51-3.37.1', 'sp':'2', 'release':'SLED15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-packagehub-subpackages-release-15.2', 'sled-release-15.2', 'sles-release-15.2']},
    {'reference':'apache2-event-2.4.51-3.37.1', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-packagehub-subpackages-release-15.2', 'sled-release-15.2', 'sles-release-15.2']}
];
