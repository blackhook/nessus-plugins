...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : ClamAV (ZYPP Patch Number 8526)");
...
security related hardening fixes."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8526.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"clamav-0.97.7-0.5.1")) flag++;
