...
if ( rpm_check(release:"SUSE11.1", reference:"libpng-devel-1.2.31-4.37.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpng12-0-1.2.31-4.37.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpng3-1.2.31-4.37.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libpng-devel-32bit-1.2.31-4.37.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libpng12-0-32bit-1.2.31-4.37.1") ) flag++;
