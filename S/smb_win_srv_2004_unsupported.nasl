...
if (description)
{
  ...
  script_name(english:"Microsoft Windows Server Version 2004 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:"
The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows Server version 2004 is running on the remote host.
Microsoft ended support for Windows Server version 2004 on December 14, 2021.
...
tag           = "microsoft:windows_server_2004";
cpe_ver       = "-:*";
...
# Not Windows Server version 2004
if ("10" >!< os || "Windows 10" >< os_name) audit(AUDIT_OS_NOT, product_name);

# Not Build 19041 (version 2004)
if ("19041" != os_build) audit(AUDIT_OS_NOT, product_name);
