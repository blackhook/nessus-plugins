...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sqlite on SL6.x i386/x86_64 (20150817)");
...
(CVE-2015-3416)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7dd6baa3"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"lemon-3.6.20-1.el6_7.2")) flag++;
if (rpm_check(release:"SL6", reference:"sqlite-3.6.20-1.el6_7.2")) flag++;
if (rpm_check(release:"SL6", reference:"sqlite-debuginfo-3.6.20-1.el6_7.2")) flag++;
if (rpm_check(release:"SL6", reference:"sqlite-devel-3.6.20-1.el6_7.2")) flag++;
if (rpm_check(release:"SL6", reference:"sqlite-doc-3.6.20-1.el6_7.2")) flag++;
if (rpm_check(release:"SL6", reference:"sqlite-tcl-3.6.20-1.el6_7.2")) flag++;
