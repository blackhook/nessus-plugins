...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3045755");
...
(PKU2U) security support provider (SSP).");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2015/3045755");
