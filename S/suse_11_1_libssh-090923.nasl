...
# extracted from openSUSE Security Update libssh-1329.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh (libssh-1329)");
  script_summary(english:"Check for the libssh-1329 patch");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libssh2");
...
if ( rpm_check(release:"SUSE11.1", reference:"libssh-devel-0.2-5.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libssh2-0.2-5.7.1") ) flag++;
