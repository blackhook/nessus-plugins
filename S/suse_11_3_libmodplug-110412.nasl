...
this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00048.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"libmodplug-devel-0.8.7-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libmodplug0-0.8.7-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libmodplug0-32bit-0.8.7-7.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libmodplug-devel / libmodplug0 / libmodplug0-32bit");
}
