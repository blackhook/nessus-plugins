...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : cron (ZYPP Patch Number 3093)");
...
users. (CVE-2005-1038)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 3093.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:0, reference:"cron-4.1-45.10.3")) flag++;
if (rpm_check(release:"SLES10", sp:0, reference:"cron-4.1-45.10.3")) flag++;
