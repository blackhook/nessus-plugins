...
# extracted from openSUSE Security Update struts-5872.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : struts (struts-5872)");
  script_summary(english:"Check for the struts-5872 patch");
...
site scripting (XSS) attacks (CVE-2008-2025)."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:struts-webapps-tomcat5");
...
if ( rpm_check(release:"SUSE10.3", reference:"struts-1.2.9-108.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"struts-javadoc-1.2.9-108.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"struts-manual-1.2.9-108.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"struts-webapps-tomcat5-1.2.9-108.2") ) flag++;
