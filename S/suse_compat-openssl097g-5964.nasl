...
# extracted from openSUSE Security Update compat-openssl097g-5964.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : compat-openssl097g (compat-openssl097g-5964)");
  script_summary(english:"Check for the compat-openssl097g-5964 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"compat-openssl097g-0.9.7g-75.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"compat-openssl097g-32bit-0.9.7g-75.5") ) flag++;
