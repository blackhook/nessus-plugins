...
if (description)
{
  ...
  script_cve_id("CVE-2022-1116", "CVE-2022-1966", "CVE-2022-32250");
...
the SUSE-SU-2022:2214-1 advisory.
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-150300.59.71-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-150300_59_71-default-2-150300.2.2', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.3']}
        ]
      }
    }
  }
