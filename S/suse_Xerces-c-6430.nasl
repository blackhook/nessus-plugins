...
# extracted from openSUSE Security Update Xerces-c-6430.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : Xerces-c (Xerces-c-6430)");
  script_summary(english:"Check for the Xerces-c-6430 patch");
...
(CVE-2009-1885)"
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libXerces-c-27");
...
if ( rpm_check(release:"SUSE10.3", reference:"Xerces-c-2.7.0-75.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libXerces-c-27-2.7.0-75.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libXerces-c-devel-2.7.0-75.2") ) flag++;
