...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libvorbis on SL4.x, SL5.x, SL6.x i386/x86_64 (20120215)");
...
restarted (log out, then log back in) for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=3058
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?374bbfdc"
  );
