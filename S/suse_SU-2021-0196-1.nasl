...
# extracted from SUSE update advisory SUSE-SU-2021:0196-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : mutt (SUSE-SU-2021:0196-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f71b459e"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"mutt-1.10.1-55.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mutt-debuginfo-1.10.1-55.24.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mutt-debugsource-1.10.1-55.24.1")) flag++;
