...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : nagios (SAT Patch Number 1105)");
...
fixed. CVE-2009-2288 has been assigned to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2009-2288.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 1105.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:0, reference:"nagios-3.0.6-1.21.1")) flag++;
if (rpm_check(release:"SLES11", sp:0, reference:"nagios-www-3.0.6-1.21.1")) flag++;
