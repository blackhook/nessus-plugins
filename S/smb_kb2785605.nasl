...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2785605");
...
Adobe Flash ActiveX control :
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2785605/microsoft-security-advisory-update-for-vulnerabilities-in-adobe-flash");
...
"Install Microsoft KB2785605.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-5678");
