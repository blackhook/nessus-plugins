...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ntp on SL7.x x86_64 (20200623)");
...
"Security Fix(es) :
  ...
  - ntp: ntpd using highly predictable transmit timestamps
    could result in time change or DoS (CVE-2020-13817)

  - ntp: DoS on client ntpd using server mode packet
    (CVE-2020-11868)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2006&L=SCIENTIFIC-LINUX-ERRATA&P=12493
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2403b73e"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-4.2.6p5-29.el7_8.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntp-debuginfo-4.2.6p5-29.el7_8.2")) flag++;
if (rpm_check(release:"SL7", reference:"ntp-doc-4.2.6p5-29.el7_8.2")) flag++;
if (rpm_check(release:"SL7", reference:"ntp-perl-4.2.6p5-29.el7_8.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ntpdate-4.2.6p5-29.el7_8.2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sntp-4.2.6p5-29.el7_8.2")) flag++;
