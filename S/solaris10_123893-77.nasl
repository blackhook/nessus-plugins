...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 123893-77");
  script_summary(english:"Check for patch 123893-77");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 123893-77"
  );
  script_set_attribute(
...
running on Solaris platform."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/123893-77"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 123893-77 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:N/A:N");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4239");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:123893");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:124463");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"123893-77", obsoleted_by:"", package:"SUNWcacaort", version:"2.0,REV=15") < 0) flag++;
