...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5435");

  script_name(english:"Scientific Linux Security Update : python-rtslib on SL7.x (noarch) (2020:5435)");
...
SLSA-2020:5435-1 advisory.

  - python-rtslib: weak permissions for /etc/target/saveconfig.json (CVE-2020-14019)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205435-1");
...
"Update the affected python-rtslib and / or python-rtslib-doc packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:python-rtslib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:python-rtslib-doc");
...
pkgs = [
    {'reference':'python-rtslib-2.1.74-1.el7_9', 'release':'SL7'},
    {'reference':'python-rtslib-doc-2.1.74-1.el7_9', 'release':'SL7'}
];
