...
# extracted from SUSE update advisory SUSE-SU-2020:2264-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : postgresql10 (SUSE-SU-2020:2264-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba53a6e7");
...
zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-2020-2264=1

SUSE Linux Enterprise Server 15-LTSS :

zypper in -t patch SUSE-SLE-Product-SLES-15-2020-2264=1

SUSE Linux Enterprise High Performance Computing 15-LTSS :

zypper in -t patch SUSE-SLE-Product-HPC-15-2020-2264=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libecpg6-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libecpg6-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libpq5-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libpq5-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-contrib-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-contrib-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-debugsource-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-devel-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-devel-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plperl-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plperl-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plpython-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plpython-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-pltcl-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-pltcl-debuginfo-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-server-10.14-4.25.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-server-debuginfo-10.14-4.25.1")) flag++;
