...
if(description)
{
 script_id(23182);
 script_version ("1.11");
 name["english"] = "Solaris 2.6 (i386) : 105650-01";
...
e +=  solaris_check_patch(release:"5.6_x86", arch:"i386", patch:"105650-01", obsoleted_by:"", package:"SUNWfw", version:"3.0,PATCH=105650-01");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
