...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mysql on SL5.x i386/x86_64 (20130122)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1301&L=scientific-linux-errata&T=0&P=2955
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7abdaeee"
  );
