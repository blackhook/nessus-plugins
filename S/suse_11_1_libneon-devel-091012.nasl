...
if ( rpm_check(release:"SUSE11.1", reference:"libneon-devel-0.28.3-1.31.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libneon27-0.28.3-1.31.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"neon-0.28.3-1.31.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libneon27-32bit-0.28.3-1.31.1") ) flag++;
