...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"943957");
 script_xref(name:"MSKB", value:"943983");
 script_xref(name:"MSKB", value:"943990");
...
handler would result in code execution.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2008/ms08-009");
