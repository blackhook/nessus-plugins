...
# extracted from openSUSE Security Update mozilla-xulrunner190-832.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mozilla-xulrunner190 (mozilla-xulrunner190-832)");
  script_summary(english:"Check for the mozilla-xulrunner190-832 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner190-1.9.0.9-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner190-devel-1.9.0.9-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner190-gnomevfs-1.9.0.9-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner190-translations-1.9.0.9-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"python-xpcom190-1.9.0.9-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner190-32bit-1.9.0.9-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner190-gnomevfs-32bit-1.9.0.9-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner190-translations-32bit-1.9.0.9-0.1.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mozilla-xulrunner190 / mozilla-xulrunner190-32bit / etc");
}
