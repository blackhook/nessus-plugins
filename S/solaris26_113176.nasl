...
if(description)
{
 ...
 script_name(english: "Solaris 5.6 (sparc) : 113176-03");
...
e +=  solaris_check_patch(release:"5.6", arch:"sparc,i386", patch:"113176-03", obsoleted_by:"", package:"SUNWppmn", version:"2.1");
e +=  solaris_check_patch(release:"5.6", arch:"sparc,i386", patch:"113176-03", obsoleted_by:"", package:"SUNWppro", version:"2.1");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
