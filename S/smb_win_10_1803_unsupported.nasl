...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 Version 1803 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:"
The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 version 1803 is running on the remote host.
Microsoft ended support for Windows 10 version 1803 Home/Pro on November 12, 2019
and ends for Windows 10 version 1803 Enterprise/Educational on May 11, 2021.
...
# Not Build 17134 (version 1803)
if ("17134" != os_build) audit(AUDIT_OS_NOT, product_name);

# EOS Date: May 11, 2021, 12:00 EST
if (
  (unixtime() < 1620705600) &&
