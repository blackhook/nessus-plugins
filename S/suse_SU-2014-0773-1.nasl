...
# extracted from SUSE update advisory SUSE-SU-2014:0773-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES10 Security Update : kernel (SUSE-SU-2014:0773-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2014/suse-su-20140773-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?98cc8d90"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (rpm_check(release:"SLES10", sp:"4", cpu:"s390x", reference:"kernel-default-2.6.16.60-0.107.1")) flag++;
if (rpm_check(release:"SLES10", sp:"4", cpu:"s390x", reference:"kernel-source-2.6.16.60-0.107.1")) flag++;
if (rpm_check(release:"SLES10", sp:"4", cpu:"s390x", reference:"kernel-syms-2.6.16.60-0.107.1")) flag++;
