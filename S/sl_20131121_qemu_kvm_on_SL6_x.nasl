...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL6.x i386/x86_64 (20131121)");
...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=2312
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60a907dd"
  );
