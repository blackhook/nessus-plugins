...
if (description)
{
  ...
  script_cve_id("CVE-2018-2906");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2018_SRU11_3_33_5_0");
...
security update :
  ...
  - Vulnerability in the Hardware Management Pack component
    ...
    11.3. Difficult to exploit vulnerability allows
    unauthenticated attacker with network access via IPMI to
    compromise Hardware Management Pack. Successful attacks
    of this vulnerability can result in unauthorized read
    access to a subset of Hardware Management Pack
    accessible data. (CVE-2018-2906)"
  );
  script_set_attribute(
    attribute:"see_also",
...
fix_release = "0.5.11-0.175.3.33.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.33.0.5.0", sru:"11.3.33.5.0") > 0) flag++;
