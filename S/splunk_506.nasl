...
if (description)
{
  ...
  script_cve_id("CVE-2013-6870");
  script_bugtraq_id(63857);

  script_name(english:"Splunk < 5.0.6 Unspecified XSS");
...
web server is affected by an unspecified cross-site scripting
vulnerability. An attacker can exploit this issue to inject arbitrary
...
only on the application's self-reported version number."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.splunk.com/view/SP-CAAAJCD");
  # http://docs.splunk.com/Documentation/Splunk/5.0.6/ReleaseNotes/MeetSplunk
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4121be55");
  script_set_attribute(attribute:"solution", value:"Upgrade to Splunk 5.0.6 or later.");
...
if (ver_compare(ver:ver,fix:"5.0.6",strict:FALSE) < 0)
{
