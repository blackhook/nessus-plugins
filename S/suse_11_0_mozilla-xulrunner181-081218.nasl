...
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-xulrunner181-1.8.1.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-xulrunner181-devel-1.8.1.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-xulrunner181-l10n-1.8.1.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"mozilla-xulrunner181-32bit-1.8.1.19-0.1") ) flag++;
