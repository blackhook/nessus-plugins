...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5020");

  script_name(english:"Scientific Linux Security Update : tomcat on SL7.x (noarch) (2020:5020)");
...
SLSA-2020:5020-1 advisory.

  - tomcat: Mishandling of Transfer-Encoding header allows for HTTP request smuggling (CVE-2020-1935)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205020-1");
...
pkgs = [
    {'reference':'tomcat-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-admin-webapps-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-docs-webapp-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-el-2.2-api-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-javadoc-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-jsp-2.2-api-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-jsvc-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-lib-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-servlet-3.0-api-7.0.76-16.el7_9', 'release':'SL7'},
    {'reference':'tomcat-webapps-7.0.76-16.el7_9', 'release':'SL7'}
];
