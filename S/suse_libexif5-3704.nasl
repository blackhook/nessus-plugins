...
# extracted from openSUSE Security Update libexif5-3704.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libexif5 (libexif5-3704)");
  script_summary(english:"Check for the libexif5-3704 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"libexif5-0.5.12-39") ) flag++;
