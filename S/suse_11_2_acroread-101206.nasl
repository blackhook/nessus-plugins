...
(AV:N/AC:M/Au:N/C:P/I:P/A:P): Buffer Errors (CWE-119))"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-12/msg00017.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"acroread-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"acroread-cmaps-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"acroread-fonts-ja-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"acroread-fonts-ko-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"acroread-fonts-zh_CN-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"acroread-fonts-zh_TW-9.4.1-0.2.1") ) flag++;
