...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150.72-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_72-default-2-2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15', 'SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']}
        ]
      }
    }
  }
