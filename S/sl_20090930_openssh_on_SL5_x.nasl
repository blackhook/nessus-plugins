...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0910&L=scientific-linux-errata&T=0&P=206
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3c005835"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"openssh-4.3p2-36.el5_4.2")) flag++;
if (rpm_check(release:"SL5", reference:"openssh-askpass-4.3p2-36.el5_4.2")) flag++;
if (rpm_check(release:"SL5", reference:"openssh-clients-4.3p2-36.el5_4.2")) flag++;
if (rpm_check(release:"SL5", reference:"openssh-server-4.3p2-36.el5_4.2")) flag++;
