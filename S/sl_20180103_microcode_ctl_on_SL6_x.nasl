...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : microcode_ctl on SL6.x i386/x86_64 (20180103) (Spectre)");
...
mitigation."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?066ee6b9"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"microcode_ctl-1.17-25.2.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"microcode_ctl-debuginfo-1.17-25.2.el6_9")) flag++;
