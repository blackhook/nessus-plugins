...
if (description)
{
  ...
  script_cve_id("CVE-2020-2558", "CVE-2020-2578", "CVE-2020-2656");
  script_xref(name:"IAVA", value:"2020-A-0018-S");

  script_name(english:"Oracle Solaris Critical Patch Update : jan2020_SRU11_4_16_4_0");
...
security updates :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    ...
    SMB to compromise Oracle Solaris. While the
    ...
    DOS) of Oracle Solaris. (CVE-2020-2558)
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    ...
    attacks of this vulnerability can result in unauthorized
    ability to cause a partial denial of service (partial
    DOS) of Oracle Solaris. (CVE-2020-2578)

  - Vulnerability in the Oracle Solaris product of Oracle
    Systems (component: X Window System). Supported versions
    that are affected are 10 and 11. Easily exploitable
    ...
    Oracle Solaris accessible data. (CVE-2020-2656)"
  );
  script_set_attribute(
    attribute:"see_also",
...
fix_release = "11.4-11.4.16.0.1.4.0";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.16.0.1.4.0", sru:"11.4.16.4.0") > 0) flag++;
