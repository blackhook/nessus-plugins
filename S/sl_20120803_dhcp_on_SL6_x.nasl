...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dhcp on SL6.x i386/x86_64 (20120803)");
...
update, all DHCP servers will be restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1208&L=scientific-linux-errata&T=0&P=871
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c48ff67a"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"dhclient-4.1.1-31.P1.el6_3.1")) flag++;
if (rpm_check(release:"SL6", reference:"dhcp-4.1.1-31.P1.el6_3.1")) flag++;
if (rpm_check(release:"SL6", reference:"dhcp-common-4.1.1-31.P1.el6_3.1")) flag++;
if (rpm_check(release:"SL6", reference:"dhcp-debuginfo-4.1.1-31.P1.el6_3.1")) flag++;
if (rpm_check(release:"SL6", reference:"dhcp-devel-4.1.1-31.P1.el6_3.1")) flag++;
