...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tomcat on SL7.x (noarch) (20170727)");
...
"Security Fix(es) :
  ...
  - A vulnerability was discovered in Tomcat. When running
    ...
    possible, under some circumstances, for that application
    to retain references to the request or response objects
    and thereby access and/or modify information associated
    with another web application. (CVE-2017-5648)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1707&L=scientific-linux-errata&F=&S=&P=11884
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f94e6bea"
  );
...
flag = 0;
if (rpm_check(release:"SL7", reference:"tomcat-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-admin-webapps-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-docs-webapp-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-el-2.2-api-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-javadoc-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-jsp-2.2-api-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-jsvc-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-lib-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-servlet-3.0-api-7.0.69-12.el7_3")) flag++;
if (rpm_check(release:"SL7", reference:"tomcat-webapps-7.0.69-12.el7_3")) flag++;
