...
if (description)
{
  ...
  script_name(english:"SuSE 11.3 Security Update : java-1_6_0-ibm (SAT Patch Number 10299)");
...
"java-1_6_0-ibm was updated to fix two security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 10299.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:3, reference:"java-1_6_0-ibm-1.6.0_sr16.3-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"java-1_6_0-ibm-fonts-1.6.0_sr16.3-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"java-1_6_0-ibm-jdbc-1.6.0_sr16.3-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"i586", reference:"java-1_6_0-ibm-alsa-1.6.0_sr16.3-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"i586", reference:"java-1_6_0-ibm-plugin-1.6.0_sr16.3-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"x86_64", reference:"java-1_6_0-ibm-plugin-1.6.0_sr16.3-0.4.1")) flag++;
