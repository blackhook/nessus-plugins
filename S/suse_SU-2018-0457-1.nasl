...
# extracted from SUSE update advisory SUSE-SU-2018:0457-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : quagga (SUSE-SU-2018:0457-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180457-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6295f87");
  script_set_attribute(attribute:"solution", value:
"To install this SUSE Security Update use YaST online_update.
Alternatively you can run the command listed for your product :

SUSE Linux Enterprise Software Development Kit 11-SP4:zypper in -t
patch sdksp4-quagga-13471=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-quagga-13471=1

SUSE Linux Enterprise Server 11-SP3-LTSS:zypper in -t patch
slessp3-quagga-13471=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-quagga-13471=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-quagga-13471=1

SUSE Linux Enterprise Debuginfo 11-SP3:zypper in -t patch
dbgsp3-quagga-13471=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"quagga-0.99.15-0.30.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"quagga-0.99.15-0.30.3.1")) flag++;
