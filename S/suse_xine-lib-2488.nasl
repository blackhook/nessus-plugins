...
# extracted from openSUSE Security Update xine-lib-2488.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : xine-lib (xine-lib-2488)");
  script_summary(english:"Check for the xine-lib-2488 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"xine-extra-1.1.1-24.17") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"xine-lib-1.1.1-24.17") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"xine-ui-0.99.4-32.14") ) flag++;
if ( rpm_check(release:"SUSE10.1", cpu:"x86_64", reference:"xine-lib-32bit-1.1.1-24.17") ) flag++;
