...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bash on SL5.x, SL6.x i386/x86_64 (20140924) (Shellshock)");
...
crafted-environment-variables-code-injection-attack/");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d4dfe3fd");
