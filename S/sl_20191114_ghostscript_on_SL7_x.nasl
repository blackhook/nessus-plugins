...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ghostscript on SL7.x x86_64 (20191114)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1911&L=SCIENTIFIC-LINUX-ERRATA&P=2628
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c85c0bb7");
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-9.25-2.el7_7.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-cups-9.25-2.el7_7.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-debuginfo-9.25-2.el7_7.3")) flag++;
if (rpm_check(release:"SL7", reference:"ghostscript-doc-9.25-2.el7_7.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"ghostscript-gtk-9.25-2.el7_7.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgs-9.25-2.el7_7.3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgs-devel-9.25-2.el7_7.3")) flag++;
