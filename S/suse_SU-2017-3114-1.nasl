...
# extracted from SUSE update advisory SUSE-SU-2017:3114-1.
...
if (description)
{
  ...
  script_bugtraq_id(68960);

  script_name(english:"SUSE SLES11 Security Update : Recommended update for tboot (SUSE-SU-2017:3114-1)");
  ...
  script_set_attribute(
    ...
    value:
"This update for tboot provides the following fix: Security issue 
fixed :

  - CVE-2014-5118: tboot: bypass of measured boot
    (bsc#889339) Bug fixes :
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=889339"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2014-5118/"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20173114-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6cba58e7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
slessp4-tboot-13354=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-tboot-13354=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"tboot-20120115_1.7.0-0.5.5.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"i586", reference:"tboot-20120115_1.7.0-0.5.5.1")) flag++;
