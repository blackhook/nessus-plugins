...
# extracted from openSUSE Security Update wget-1198.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wget (wget-1198)");
  script_summary(english:"Check for the wget-1198 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"wget-1.11.4-1.28.1") ) flag++;
