...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"954154");
 script_xref(name:"IAVA", value:"2008-A-0064-S");
...
file and send it to a victim on the remote host.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?e000018e");
 ...
 script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-2253");
