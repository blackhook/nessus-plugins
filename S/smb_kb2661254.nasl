...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2661254");
...
over SSL/TLS."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2012/2661254");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2661254/microsoft-security-advisory-update-for-minimum-certificate-key-length");
  script_set_attribute(
    attribute:"solution",
    value:
