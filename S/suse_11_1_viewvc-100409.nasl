...
# extracted from openSUSE Security Update viewvc-2268.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : viewvc (openSUSE-SU-2010:0098-1)");
  script_summary(english:"Check for the viewvc-2268 patch");
...
CVE-2010-0132. This release fixes that again."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-04/msg00004.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"viewvc-1.0.11-0.2.1") ) flag++;
