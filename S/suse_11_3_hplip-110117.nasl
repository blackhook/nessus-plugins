...
hplip's sane backend (CVE-2010-4267)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-01/msg00028.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"hplip-3.10.2-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"hplip-hpijs-3.10.2-2.3.1") ) flag++;
