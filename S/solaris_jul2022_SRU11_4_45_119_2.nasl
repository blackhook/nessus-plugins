...
if (description)
{
  ...
  script_cve_id("CVE-2022-21524");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2022_SRU11_4_45_119_2");
...
security update :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    ...
    SMB to compromise Oracle Solaris. Successful attacks of
    ...
    of Oracle Solaris accessible data. CVSS 3.1 Base Score
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-21524");
...
fix_release = "11.4-11.4.45.0.1.119.2";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.45.0.1.119.2", sru:"11.4.45.119.2") > 0) flag++;
