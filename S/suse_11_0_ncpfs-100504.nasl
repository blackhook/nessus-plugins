...
if ( rpm_check(release:"SUSE11.0", reference:"ncpfs-2.2.6-132.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ncpfs-devel-2.2.6-132.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"ncpfs-32bit-2.2.6-132.4") ) flag++;
