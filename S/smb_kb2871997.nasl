...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2016-A-0327-S");
  script_xref(name:"MSKB", value:"2871997");
...
Desktop Connection and Remote Desktop Protocol.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2016/2871997");
