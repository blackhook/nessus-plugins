...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 150506-01");
  script_summary(english:"Check for patch 150506-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 150506-01"
  );
  script_set_attribute(
...
denial of service (partial DOS) of Solaris."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/150506-01"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"150506-01", obsoleted_by:"", package:"SUNWrcmds", version:"11.9.0,REV=2002.04.06.15.27") < 0) flag++;
