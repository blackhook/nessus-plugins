...
# extracted from SUSE update advisory SUSE-SU-2018:0465-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : unzip (SUSE-SU-2018:0465-1)");
...
"This update for unzip fixes the following issues :
  ...
  - CVE-2018-1000035: Fixed a heap-based buffer overflow in
    password protected ZIP archives (bsc#1080074)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2d1ad2f7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"unzip-6.00-11.18.3.1")) flag++;
