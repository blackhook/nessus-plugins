...
if (description)
{
  ...
  script_bugtraq_id(59186);

  script_name(english:"Oracle Solaris Critical Patch Update : apr2013_SRU5_5");
...
if (solaris_check_release(release:"0.5.11-0.175.1.5.0.5.0", sru:"Solaris 11.1.5.5") > 0) flag++;
