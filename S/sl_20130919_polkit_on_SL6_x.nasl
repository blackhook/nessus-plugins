...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : polkit on SL6.x i386/x86_64 (20130919)");
...
The system must be rebooted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1309&L=scientific-linux-errata&T=0&P=1329
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9533512b"
  );
