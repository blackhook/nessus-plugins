...
# extracted from openSUSE Security Update bytefx-data-mysql-4597.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : bytefx-data-mysql (bytefx-data-mysql-4597)");
  script_summary(english:"Check for the bytefx-data-mysql-4597 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"bytefx-data-mysql-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"ibm-data-db2-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-complete-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-core-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-data-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-data-firebird-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-data-oracle-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-data-postgresql-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-data-sqlite-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-data-sybase-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-devel-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-extras-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-jscript-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-locale-extras-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-nunit-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-web-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mono-winforms-1.2.5-16.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"mono-core-32bit-1.2.5-16.2") ) flag++;
