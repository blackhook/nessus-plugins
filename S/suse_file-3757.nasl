...
# extracted from openSUSE Security Update file-3757.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : file (file-3757)");
  script_summary(english:"Check for the file-3757 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"file-4.16-15.13") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"file-devel-4.16-15.13") ) flag++;
if ( rpm_check(release:"SUSE10.1", cpu:"x86_64", reference:"file-32bit-4.16-15.13") ) flag++;
