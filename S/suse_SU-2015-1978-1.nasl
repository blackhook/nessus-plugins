...
# extracted from SUSE update advisory SUSE-SU-2015:1978-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : MozillaFirefox, mozilla-nspr, mozilla-nss (SUSE-SU-2015:1978-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2015/suse-su-20151978-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c88a9d77"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"2", cpu:"x86_64", reference:"libfreebl3-32bit-3.19.2.1-12.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", cpu:"x86_64", reference:"mozilla-nspr-32bit-4.10.10-16.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", cpu:"x86_64", reference:"mozilla-nss-32bit-3.19.2.1-12.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", cpu:"s390x", reference:"libfreebl3-32bit-3.19.2.1-12.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", cpu:"s390x", reference:"mozilla-nspr-32bit-4.10.10-16.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", cpu:"s390x", reference:"mozilla-nss-32bit-3.19.2.1-12.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"MozillaFirefox-38.4.0esr-25.3")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"MozillaFirefox-branding-SLED-38-12.19")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"MozillaFirefox-translations-38.4.0esr-25.3")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"libfreebl3-3.19.2.1-12.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"mozilla-nspr-4.10.10-16.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"mozilla-nspr-devel-4.10.10-16.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"mozilla-nss-3.19.2.1-12.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"mozilla-nss-devel-3.19.2.1-12.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"mozilla-nss-tools-3.19.2.1-12.1")) flag++;
