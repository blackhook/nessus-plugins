...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 5 for SLE 15 SP2) (SUSE-SU-2021:2387-1)");
...
"Update the affected kernel-livepatch-5_3_18-24_29-default and / or kernel-livepatch-5_3_18-24_37-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_3_18-24_29-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-24.29-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_29-default-9-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      },
      '5.3.18-24.37-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_37-default-9-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-24_29-default / etc');
}
