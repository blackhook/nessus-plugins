...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4103729");
  script_xref(name:"MSFT", value:"MS18-4103729");

  script_name(english:"KB4103729: Security update for Adobe Flash Player (May 2018)");
...
"The remote Windows host is missing security update KB4103729. It is,
...
in Adobe Flash Player.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af93e9fe");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4103729 to address this issue.");
...
# all <= 29.0.0.140
fix = FALSE;
if(ver_compare(ver:iver, fix:"29.0.0.140", strict:FALSE) <= 0)
  fix = "29.0.0.171";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS18-05', kb:'4103729', report);
