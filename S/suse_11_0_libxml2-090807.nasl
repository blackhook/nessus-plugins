...
if ( rpm_check(release:"SUSE11.0", reference:"libxml2-2.6.32-11.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libxml2-devel-2.6.32-11.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libxml2-32bit-2.6.32-11.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libxml2-devel-32bit-2.6.32-11.10") ) flag++;
