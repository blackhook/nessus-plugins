...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : stunnel on SL6.x i386/x86_64 (20130408)");
...
(CVE-2013-1762)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1304&L=scientific-linux-errata&T=0&P=460
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3ca7d294"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:stunnel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:stunnel-debuginfo");
