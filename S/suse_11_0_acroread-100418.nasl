...
if ( rpm_check(release:"SUSE11.0", reference:"acroread-9.3.2-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"acroread-cmaps-9.3.2-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"acroread-fonts-ja-9.3.2-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"acroread-fonts-ko-9.3.2-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"acroread-fonts-zh_CN-9.3.2-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"acroread-fonts-zh_TW-9.3.2-0.1") ) flag++;
