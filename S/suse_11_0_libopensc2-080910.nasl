...
# extracted from openSUSE Security Update libopensc2-186.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libopensc2 (libopensc2-186)");
  script_summary(english:"Check for the libopensc2-186 patch");
...
if ( rpm_check(release:"SUSE11.0", reference:"libopensc2-0.11.4-37.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"opensc-0.11.4-37.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"opensc-devel-0.11.4-37.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libopensc2-32bit-0.11.4-37.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"opensc-32bit-0.11.4-37.4") ) flag++;
