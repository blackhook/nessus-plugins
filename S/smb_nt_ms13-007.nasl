...
if (description)
{
  script_id(63425);
  script_version("1.15");
  script_set_attribute(attribute:"plugin_modification_date", value:"2021/10/11");
...
var bulletin, kbs, winver, productname, rootfile, share, vuln, val, odata_installed, hklm, key, dotNetKeys, subkey, rc, winsxs, patched, files;
...
if(winver == '6.2')
{
   ...
   if(odata_installed)
   {
     ...
     vuln += hotfix_check_winsxs(os:'6.2', files:files, versions:make_list('6.2.9200.16409', '6.2.9200.20509'), max_versions:make_list('6.2.9200.20000', '6.2.9200.99999'), bulletin:bulletin, kb:'2753596');
   }
   else close_registry();
}
