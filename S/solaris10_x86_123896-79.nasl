...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 123896-79");
  script_summary(english:"Check for patch 123896-79");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 123896-79"
  );
  script_set_attribute(
...
running on Solaris platform."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/123896-79"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 123896-79 or higher");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"123896-79", obsoleted_by:"", package:"SUNWcacaort", version:"2.0,REV=15") < 0) flag++;
