...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1090003"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1095918"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2018-14036/"
  );
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183625-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0388a4c4"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
