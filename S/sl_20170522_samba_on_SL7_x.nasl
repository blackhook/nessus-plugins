...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba on SL7.x x86_64 (20170522)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1705&L=scientific-linux-errata&F=&S=&P=5873
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eaab5434"
  );
