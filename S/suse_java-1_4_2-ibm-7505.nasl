...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : IBM Java (ZYPP Patch Number 7505)");
...
http://www.ibm.com/developerworks/java/jdk/alerts/"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7505.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"java-1_4_2-ibm-1.4.2_sr13.9-0.7.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"java-1_4_2-ibm-devel-1.4.2_sr13.9-0.7.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"i586", reference:"java-1_4_2-ibm-jdbc-1.4.2_sr13.9-0.7.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"i586", reference:"java-1_4_2-ibm-plugin-1.4.2_sr13.9-0.7.1")) flag++;
