...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bzip2 on SL6.x i386/x86_64");
...
for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1103&L=scientific-linux-errata&T=0&P=1973
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?acb3cf49"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"bzip2-1.0.5-7.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"bzip2-devel-1.0.5-7.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"bzip2-libs-1.0.5-7.el6_0")) flag++;
