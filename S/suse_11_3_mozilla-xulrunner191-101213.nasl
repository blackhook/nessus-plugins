...
# extracted from openSUSE Security Update mozilla-xulrunner191-3689.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mozilla-xulrunner191 (mozilla-xulrunner191-3689)");
  script_summary(english:"Check for the mozilla-xulrunner191-3689 patch");
...
if ( rpm_check(release:"SUSE11.3", reference:"mozilla-xulrunner191-1.9.1.16-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"mozilla-xulrunner191-devel-1.9.1.16-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"mozilla-xulrunner191-gnomevfs-1.9.1.16-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"mozilla-xulrunner191-translations-common-1.9.1.16-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"mozilla-xulrunner191-translations-other-1.9.1.16-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"python-xpcom191-1.9.1.16-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"mozilla-xulrunner191-32bit-1.9.1.16-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"mozilla-xulrunner191-gnomevfs-32bit-1.9.1.16-0.2.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mpzilla-xulrunner191");
}
