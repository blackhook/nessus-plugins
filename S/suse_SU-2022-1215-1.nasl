...
the SUSE-SU-2022:1215-1 advisory.
...
"Update the affected kernel-livepatch-4_12_14-150_72-default, kernel-livepatch-4_12_14-150_86-default and / or kgraft-
...
var kernel_live_checks = [
  {
    'kernels': {
      ...
      '4.12.14-150.72-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_72-default-14-150000.2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15']}
        ]
      },
      '4.12.14-150.86-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_86-default-2-150000.2.1', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15']}
        ]
      }
    }
  }
