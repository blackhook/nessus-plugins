...
# extracted from openSUSE Security Update java-1_6_0-sun-4147.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : java-1_6_0-sun (java-1_6_0-sun-4147)");
  script_summary(english:"Check for the java-1_6_0-sun-4147 patch");
...
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-sun-1.6.0.u24-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-sun-alsa-1.6.0.u24-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-sun-demo-1.6.0.u24-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-sun-devel-1.6.0.u24-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-sun-jdbc-1.6.0.u24-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-sun-plugin-1.6.0.u24-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-sun-src-1.6.0.u24-1.2.1") ) flag++;
