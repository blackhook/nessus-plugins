...
# extracted from openSUSE Security Update krb5-2267.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : krb5 (openSUSE-SU-2010:0099-1)");
  script_summary(english:"Check for the krb5-2267 patch");
...
freed memory (CVE-2010-0629)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-04/msg00005.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-04/msg00035.html"
  );
...
if ( rpm_check(release:"SUSE11.1", reference:"krb5-1.6.3-132.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"krb5-apps-clients-1.6.3-132.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"krb5-apps-servers-1.6.3-132.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"krb5-client-1.6.3-132.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"krb5-devel-1.6.3-132.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"krb5-server-1.6.3-132.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"krb5-32bit-1.6.3-132.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"krb5-devel-32bit-1.6.3-132.7.1") ) flag++;
