...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:0053");
  script_xref(name:"IAVA", value:"2021-A-0005-S");

  script_name(english:"Scientific Linux Security Update : firefox on SL7.x i686/x86_64 (2021:0053)");
...
SLSA-2021:0053-1 advisory.

  - Mozilla: Use-after-free write when handling a malicious COOKIE-ECHO SCTP chunk (CVE-2020-16044)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20210053-1");
...
pkgs = [
    {'reference':'firefox-78.6.1-1.el7_9', 'cpu':'i686', 'release':'SL7', 'allowmaj':TRUE},
    {'reference':'firefox-78.6.1-1.el7_9', 'cpu':'x86_64', 'release':'SL7', 'allowmaj':TRUE},
    {'reference':'firefox-debuginfo-78.6.1-1.el7_9', 'cpu':'x86_64', 'release':'SL7', 'allowmaj':TRUE}
];
