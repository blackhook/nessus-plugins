...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2009-A-0095-S");
  script_xref(name:"MSFT", value:"MS09-056");
  script_xref(name:"MSKB", value:"974571");
...
CryptoAPI that is affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?c31ec543");
