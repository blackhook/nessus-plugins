...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 12 for SLE 12 SP5) (SUSE-SU-2021:2453-1)");
...
"Update the affected kgraft-patch-4_12_14-122_51-default and / or kgraft-patch-4_12_14-122_54-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.51-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_51-default-10-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-122_51-default / etc');
}
