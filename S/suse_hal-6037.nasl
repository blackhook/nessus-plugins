...
# extracted from openSUSE Security Update hal-6037.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : hal (hal-6037)");
  script_summary(english:"Check for the hal-6037 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"hal-0.5.9_git20070831-13.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"hal-devel-0.5.9_git20070831-13.5") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"hal-32bit-0.5.9_git20070831-13.5") ) flag++;
