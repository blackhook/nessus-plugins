...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : SPAMAssassin (ZYPP Patch Number 3078)");
...
This update also adds some missing dependencies."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2007-0451.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 3078.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:0, reference:"perl-spamassassin-3.1.8-9.2")) flag++;
if (rpm_check(release:"SLED10", sp:0, reference:"spamassassin-3.1.8-9.2")) flag++;
if (rpm_check(release:"SLES10", sp:0, reference:"perl-spamassassin-3.1.8-9.2")) flag++;
if (rpm_check(release:"SLES10", sp:0, reference:"spamassassin-3.1.8-9.2")) flag++;
