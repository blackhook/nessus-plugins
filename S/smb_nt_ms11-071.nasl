...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2570947");
...
to the privileges of the user running the affected component.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-071");
