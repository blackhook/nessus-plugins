...
# extracted from SUSE update advisory SUSE-SU-2020:0025-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : java-1_8_0-openjdk (SUSE-SU-2020:0025-1)");
...
Bug fixes: Add patch to fix hotspot-aarch64 (bsc#1138529).

Note that Tenable Network Security has extracted the preceding
description block directly from the SUSE security advisory. Tenable
has attempted to automatically clean and format it as much as possible
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=1138529");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a6456d4");
...
SUSE-SLE-SERVER-12-SP5-2020-25=1

SUSE Linux Enterprise Server 12-SP4:zypper in -t patch
SUSE-SLE-SERVER-12-SP4-2020-25=1

SUSE Linux Enterprise Desktop 12-SP4:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP4-2020-25=1");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-debugsource-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-demo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-demo-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-devel-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-devel-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-headless-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"java-1_8_0-openjdk-headless-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-debugsource-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-demo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-demo-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-devel-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-devel-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-headless-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"java-1_8_0-openjdk-headless-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"java-1_8_0-openjdk-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"java-1_8_0-openjdk-debuginfo-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"java-1_8_0-openjdk-debugsource-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"java-1_8_0-openjdk-headless-1.8.0.232-27.38.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"java-1_8_0-openjdk-headless-debuginfo-1.8.0.232-27.38.1")) flag++;
