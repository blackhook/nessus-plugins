...
# extracted from openSUSE Security Update quagga-6233.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : quagga (quagga-6233)");
  script_summary(english:"Check for the quagga-6233 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"quagga-0.99.7-37.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"quagga-devel-0.99.7-37.2") ) flag++;
