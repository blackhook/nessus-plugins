...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Samba (ZYPP Patch Number 8449)");
...
. (bnc#764577)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8449.");
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2013/02/23");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"cifs-mount-3.0.36-0.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"ldapsmb-1.34b-25.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"libsmbclient-3.0.36-0.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"libsmbclient-devel-3.0.36-0.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"samba-3.0.36-0.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"samba-client-3.0.36-0.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"samba-doc-3.0.36-0.12.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"samba-krb-printing-3.0.36-0.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"samba-vscan-0.3.6b-43.13.24.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"samba-winbind-3.0.36-0.13.24.1")) flag++;
...
if (rpm_check(release:"SLES10", sp:4, reference:"samba-doc-3.0.36-0.12.24.1")) flag++;
