...
if (description)
{
  ...
  script_cve_id("CVE-2013-6025");
  script_bugtraq_id(63193, 63549);
  script_xref(name:"CERT", value:"303900");
  script_xref(name:"IAVA", value:"2013-A-0217-S");

  script_name(english:"SAP Sybase Adaptive Server Enterprise Information Disclosure (SAP Note 1887341)");
...
"Information in protected files on machines running SAP Sybase ASE may
be disclosed to an attacker.  This information may be used by the
attacker to further target specialized attacks on the system.");
  script_set_attribute(attribute:"see_also", value:"https://service.sap.com/sap/support/notes/1887341");
...
"Apply one of the patches listed in the advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6025");
