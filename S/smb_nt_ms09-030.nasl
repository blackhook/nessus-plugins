...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"969693");
...
to the user's privileges.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-030");
