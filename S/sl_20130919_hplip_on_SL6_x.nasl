...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : hplip on SL6.x i386/x86_64 (20130919)");
...
to the race condition. (CVE-2013-4325)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1309&L=scientific-linux-errata&T=0&P=1455
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a01331ef"
  );
