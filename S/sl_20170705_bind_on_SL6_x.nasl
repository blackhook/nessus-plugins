...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind on SL6.x i386/x86_64 (20170705)");
...
Bug Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1707&L=scientific-linux-errata&F=&S=&P=749
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb3c4a1c"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"bind-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"SL6", reference:"bind-chroot-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"SL6", reference:"bind-debuginfo-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"SL6", reference:"bind-devel-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"SL6", reference:"bind-libs-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"SL6", reference:"bind-sdb-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"SL6", reference:"bind-utils-9.8.2-0.62.rc1.el6_9.4")) flag++;
