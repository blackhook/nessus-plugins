...
# extracted from openSUSE Security Update mutt-3751.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : mutt (mutt-3751)");
  script_summary(english:"Check for the mutt-3751 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"mutt-1.5.9i-27.8") ) flag++;
