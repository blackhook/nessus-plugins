...
if (description)
{
  ...
  script_cve_id("CVE-2016-3642");
  script_bugtraq_id(91222);
  script_xref(name:"CERT", value:"576313");

  script_name(english:"SolarWinds Virtualization Manager Java Object Deserialization RCE");

  script_set_attribute(attribute:"synopsis", value:
"The remote SolarWinds Virtualization Manager server is affected by
a remote code execution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote SolarWinds Virtualization Manager server is affected by a
...
"Upgrade to SolarWinds Virtualization Manager version 6.3.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-3642");
  ...
  script_dependencies("solarwinds_virtualization_manager_detect.nbin", "rmiregistry_detect.nasl");
  script_require_keys("installed_sw/SolarWinds Virtualization Manager");
  script_require_ports("Services/www", 80, 5480, 1099);
...
appname = "SolarWinds Virtualization Manager";
