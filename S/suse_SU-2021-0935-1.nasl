...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1183456"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1183457"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2021-20231/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2021-20232/"
  );
  # https://www.suse.com/support/update/announcement/2021/suse-su-20210935-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eae81045"
  );
  script_set_attribute(
    attribute:"solution",
    value:
