...
# extracted from SUSE update advisory SUSE-SU-2017:0729-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : apache2 (SUSE-SU-2017:0729-1)");
  ...
  script_set_attribute(
    ...
    value:
"This update for apache2 fixes the following issues: Security issues
fixed :
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20170729-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?24e207a7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-apache2-13032=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-apache2-13032=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-apache2-13032=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-2.2.12-69.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-doc-2.2.12-69.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-example-pages-2.2.12-69.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-prefork-2.2.12-69.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-utils-2.2.12-69.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-worker-2.2.12-69.1")) flag++;
