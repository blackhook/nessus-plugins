...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3124280");
...
privileges.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-016");
...
2008 R2, 2012, 8.1, RT 8.1, 2012 R2, and 10.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0051");
