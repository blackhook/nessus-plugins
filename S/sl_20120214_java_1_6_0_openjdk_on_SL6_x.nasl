...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.6.0-openjdk on SL6.x i386/x86_64 (20120214)");
...
OpenJDK Java must be restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=2817
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b5b6622"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"java-1.6.0-openjdk-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.6.0-openjdk-debuginfo-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.6.0-openjdk-demo-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.6.0-openjdk-devel-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.6.0-openjdk-javadoc-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"SL6", reference:"java-1.6.0-openjdk-src-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
