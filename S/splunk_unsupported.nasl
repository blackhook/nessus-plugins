...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0597");
...
security vulnerabilities.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adce25e5");
...
eol_data["^5\."] = make_array(
   'date', 'December 2, 2017',
   'url' , 'http://docs.splunk.com/Documentation/Splunk/5.0/SearchReference/WhatsInThisManual'
);
