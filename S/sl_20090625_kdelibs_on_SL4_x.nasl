...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0906&L=scientific-linux-errata&T=0&P=2068
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7fab6b7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL4", reference:"kdelibs-3.3.1-14.el4")) flag++;
if (rpm_check(release:"SL4", reference:"kdelibs-devel-3.3.1-14.el4")) flag++;

if (rpm_check(release:"SL5", reference:"kdelibs-3.5.4-22.el5_3")) flag++;
if (rpm_check(release:"SL5", reference:"kdelibs-apidocs-3.5.4-22.el5_3")) flag++;
if (rpm_check(release:"SL5", reference:"kdelibs-devel-3.5.4-22.el5_3")) flag++;
