...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : CUPS (ZYPP Patch Number 6174)");
...
CVE-2009-1181 / CVE-2009-1182 / CVE-2009-1183)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6174.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"cups-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLED10", sp:2, reference:"cups-client-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLED10", sp:2, reference:"cups-devel-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLED10", sp:2, reference:"cups-libs-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLED10", sp:2, cpu:"x86_64", reference:"cups-libs-32bit-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"cups-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"cups-client-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"cups-devel-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"cups-libs-1.1.23-40.52")) flag++;
if (rpm_check(release:"SLES10", sp:2, cpu:"x86_64", reference:"cups-libs-32bit-1.1.23-40.52")) flag++;
