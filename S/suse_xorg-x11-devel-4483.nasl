...
# extracted from openSUSE Security Update xorg-x11-devel-4483.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : xorg-x11-devel (xorg-x11-devel-4483)");
  script_summary(english:"Check for the xorg-x11-devel-4483 patch");
  ...
  script_set_attribute(
    ...
    value:"This update prevents a one character overflow in libXfont."
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected xorg-x11-devel packages."
  );
