...
# SUSE update advisory SUSE-SU-2019:14190-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2019:14190-1");

  script_name(english:"SUSE SLES11 Security Update : dnsmasq (SUSE-SU-2019:14190-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1076958");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e5fb9230");
...
pkgs = [
    {'reference':'dnsmasq-2.78-0.17.10', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'dnsmasq-2.78-0.17.10', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
