...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 15 for SLE 15 SP1) (SUSE-SU-2021:2332-1)");
...
"Update the affected kernel-livepatch-4_12_14-197_56-default, kgraft-patch-4_12_14-122_37-default and / or kgraft-
patch-4_12_14-122_63-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.37-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_37-default-13-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      ...
      '4.12.14-197.56-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_56-default-11-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      }
    }
  }
