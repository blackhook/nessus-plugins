...
flaw to alter the content of this server.");
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/1998/Jun/51");
 ...
 script_copyright("This script is Copyright (C) 2003-2018 Tenable Network Security, Inc.");
