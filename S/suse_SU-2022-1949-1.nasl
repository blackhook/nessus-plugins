...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150100.197.111-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150100_197_111-default-3-150100.2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      }
    }
  }
