...
# extracted from openSUSE Security Update gpdf-5213.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gpdf (gpdf-5213)");
  script_summary(english:"Check for the gpdf-5213 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"gpdf-2.10.0-40.7") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gpdf-2.10.0-82.6") ) flag++;
