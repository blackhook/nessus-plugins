...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openldap on SL6.x i386/x86_64 (20140203)");
...
This update also fixes the following bug :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1402&L=scientific-linux-errata&T=0&P=203
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f500667"
  );
