...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : expat on SL6.x, SL7.x i386/x86_64 (20161128)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76991e49"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"expat-2.0.1-13.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"expat-debuginfo-2.0.1-13.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"expat-devel-2.0.1-13.el6_8")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"expat-2.1.0-10.el7_3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"expat-debuginfo-2.1.0-10.el7_3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"expat-devel-2.1.0-10.el7_3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"expat-static-2.1.0-10.el7_3")) flag++;
