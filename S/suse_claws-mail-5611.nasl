...
# extracted from openSUSE Security Update claws-mail-5611.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : claws-mail (claws-mail-5611)");
  script_summary(english:"Check for the claws-mail-5611 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"claws-mail-2.10.0-35.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"claws-mail-devel-2.10.0-35.7") ) flag++;
