...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba on SL6.x i386/x86_64 (20131121)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=1306
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?49a12336"
  );
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libsmbclient / libsmbclient-devel / libtevent / libtevent-devel / etc");
}
