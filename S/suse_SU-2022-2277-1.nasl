...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : haproxy (SUSE-SU-2022:2277-1)");
...
referenced in the SUSE-SU-2022:2277-1 advisory.
...
var pkgs = [
    {'reference':'haproxy-2.4.8+git0.d1f8d41e0-150400.3.3.13', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'haproxy-2.4.8+git0.d1f8d41e0-150400.3.3.13', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-ha-release-15.4']}
];
