...
# extracted from openSUSE Security Update gtk2-2499.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gtk2 (gtk2-2499)");
  script_summary(english:"Check for the gtk2-2499 patch");
...
Additionally a bug in the printer dialog prevent the correct display
...
if ( rpm_check(release:"SUSE10.2", reference:"gtk2-2.10.6-24.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", cpu:"x86_64", reference:"gtk2-32bit-2.10.6-24.2") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gtk2 / gtk2-32bit");
}
