...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kernel on SL6.x i386/x86_64 (20120618)");
...
rebooted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1206&L=scientific-linux-errata&T=0&P=2223
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7591f6e5"
  );
