...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"0001-T-0884");
...
is installed on the remote host.");
  script_set_attribute(attribute:"see_also", value:"https://www.symantec.com/products/endpoint-protection");
...
register_install(
  app_name:appname,
  vendor : 'Symantec',
  product : 'Endpoint Protection Manager',
  path:path,
  version:ver,
  extra:extra,
