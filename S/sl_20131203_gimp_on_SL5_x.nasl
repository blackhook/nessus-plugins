...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gimp on SL5.x, SL6.x i386/x86_64 (20131203)");
...
The GIMP must be restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=1925
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?59064db9"
  );
