...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 115217-05");
  script_summary(english:"Check for patch 115217-05.");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a security patch.");
  script_set_attribute(attribute:"description", value:
"Version 4.0 of Volume Manager on the remote Solaris 8 host is missing
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"115217-05", obsoleted_by:"", package:"VRTSvxvm", version:"4.0,REV=12.06.2003.01.35") < 0) flag++;
