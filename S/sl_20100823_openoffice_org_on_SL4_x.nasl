...
(CVE-2010-2936)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1008&L=scientific-linux-errata&T=0&P=2120
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b10a1305"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"openoffice.org-1.1.5-10.6.0.7.EL4.5")) flag++;
if (rpm_check(release:"SL4", reference:"openoffice.org-i18n-1.1.5-10.6.0.7.EL4.5")) flag++;
if (rpm_check(release:"SL4", reference:"openoffice.org-kde-1.1.5-10.6.0.7.EL4.5")) flag++;
if (rpm_check(release:"SL4", reference:"openoffice.org-libs-1.1.5-10.6.0.7.EL4.5")) flag++;
