...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 120094-36");
  script_summary(english:"Check for patch 120094-36");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 120094-36"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Oct/13/14"
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 120094-36 or higher");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"120094-36", obsoleted_by:"", package:"SUNWxscreensaver-hacks", version:"6.6.2.7400,REV=0.2004.12.15") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"120094-36", obsoleted_by:"", package:"SUNWxwsvr", version:"6.6.2.7400,REV=0.2004.12.15") < 0) flag++;
