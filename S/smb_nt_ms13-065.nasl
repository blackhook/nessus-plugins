...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2868623");
...
system to stop responding until it is restarted."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-065");
  script_set_attribute(
    attribute:"solution",
    value:
