...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"981332");
  script_xref(name:"MSKB", value:"981349");
  script_xref(name:"MSKB", value:"981350");
...
privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-022");
  script_set_attribute(
    attribute:"solution",
    value:
