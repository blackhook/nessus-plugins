...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 143726-01");
  script_summary(english:"Check for patch 143726-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 143726-01"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Feb/26/10"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/143726-01"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 143726-01");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"143726-01", obsoleted_by:"", package:"SUNWntp4u", version:"11.10.0,REV=2009.07.02.12.26") < 0) flag++;
