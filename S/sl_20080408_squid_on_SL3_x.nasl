...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : squid on SL3.x, SL4.x, SL5.x i386/x86_64");
...
resulted in a temporary denial of service. (CVE-2008-1612)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0804&L=scientific-linux-errata&T=0&P=453
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8dda7e0c"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"squid-2.5.STABLE3-9.3E")) flag++;

if (rpm_check(release:"SL4", reference:"squid-2.5.STABLE14-1.4E.el4_6.2")) flag++;

if (rpm_check(release:"SL5", reference:"squid-2.6.STABLE6-5.el5_1.3")) flag++;
