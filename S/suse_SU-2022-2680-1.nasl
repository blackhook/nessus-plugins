...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : buildah (SUSE-SU-2022:2680-1)");
...
referenced in the SUSE-SU-2022:2680-1 advisory.
...
var pkgs = [
    {'reference':'buildah-1.25.1-150400.3.3.28', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4', 'SLE_HPC-release-15.4', 'sle-module-containers-release-15.4', 'sles-release-15.4']},
    {'reference':'buildah-1.25.1-150400.3.3.28', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
