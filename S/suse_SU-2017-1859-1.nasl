...
# extracted from SUSE update advisory SUSE-SU-2017:1859-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : xorg-x11-server (SUSE-SU-2017:1859-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20171859-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ffdf8110"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
SUSE-OpenStack-Cloud-6-2017-1149=1

SUSE Linux Enterprise Server for SAP 12-SP1:zypper in -t patch
SUSE-SLE-SAP-12-SP1-2017-1149=1

SUSE Linux Enterprise Server 12-SP1-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2017-1149=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"xorg-x11-server-7.6_1.15.2-53.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"xorg-x11-server-debuginfo-7.6_1.15.2-53.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"xorg-x11-server-debugsource-7.6_1.15.2-53.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"xorg-x11-server-extra-7.6_1.15.2-53.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"xorg-x11-server-extra-debuginfo-7.6_1.15.2-53.3.1")) flag++;
