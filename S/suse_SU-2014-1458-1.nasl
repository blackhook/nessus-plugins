...
without introducing additional issues."
  ...
  # https://download.suse.com/patch/finder/?keywords=29ed5e7e0df0d224aa13f77da0665ca3
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7ee8992"
  );
  # https://download.suse.com/patch/finder/?keywords=7d581038b5bc4e233d15b95636b1b8eb
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d00f76c"
  );
  script_set_attribute(
    attribute:"see_also",
...
if (isnull(sp)) sp = "0";
if (os_ver == "SLES11" && (! preg(pattern:"^(1|3)$", string:sp))) audit(AUDIT_OS_NOT, "SLES11 SP1/3", os_ver + " SP" + sp);
