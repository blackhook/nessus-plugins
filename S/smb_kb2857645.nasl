...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2857645");

  script_name(english:"MS KB2857645: Update for Vulnerabilities in Adobe Flash Player in Internet Explorer 10");
...
Flash ActiveX control, which could lead to code execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2857645/microsoft-security-advisory-update-for-vulnerabilities-in-adobe-flash");
