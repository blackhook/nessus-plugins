...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : dhcp on SL7.x x86_64 (20161103)");
...
Additional Changes :"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?278f156b"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhclient-4.2.5-47.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-4.2.5-47.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-common-4.2.5-47.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-debuginfo-4.2.5-47.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-devel-4.2.5-47.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"dhcp-libs-4.2.5-47.el7")) flag++;
