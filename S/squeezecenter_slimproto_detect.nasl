...
"A streaming audio service is listening on the remote host.");
...
streaming audio players.");
  script_set_attribute(attribute:"see_also", value:"http://wiki.slimdevices.com/index.php/SlimProtoTCPProtocol");
...
acceptable use and security policies.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:logitech:media_server");
