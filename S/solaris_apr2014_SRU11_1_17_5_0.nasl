...
# extracted from the Oracle CPU for apr2014.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0442", "CVE-2014-0447");
  script_bugtraq_id(66826, 66837);

  script_name(english:"Oracle Solaris Critical Patch Update : apr2014_SRU11_1_17_5_0");
  script_summary(english:"Check for the apr2014 CPU");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: Print Filter
    Utility). Supported versions that are affected are 9, 10
    and 11.1. Easily exploitable vulnerability requiring
    ...
    (partial DOS) of Solaris. (CVE-2014-0442)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://support.oracle.com/epmos/faces/DocumentDisplay?id=1637067.1"
  );
  # https://www.oracle.com/ocom/groups/public/@otn/documents/webcontent/2188432.xml
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b432eeb2"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Install the apr2014 CPU from the Oracle support website."
  );
