...
"This update fixes the following security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-12/msg00008.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"namazu-2.0.20-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"namazu-cgi-2.0.20-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"namazu-devel-2.0.20-2.3.1") ) flag++;
