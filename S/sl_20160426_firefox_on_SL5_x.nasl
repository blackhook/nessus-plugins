...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x, SL7.x i386/x86_64 (20160426)");
...
Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1604&L=scientific-linux-errata&F=&S=&P=15448
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bb988b29"
  );
  script_set_attribute(
    attribute:"solution", 
