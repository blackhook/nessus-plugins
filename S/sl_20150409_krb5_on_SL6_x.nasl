...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : krb5 on SL6.x i386/x86_64 (20150409)");
...
that user. (CVE-2014-9422)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1504&L=scientific-linux-errata&T=0&P=727
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4621a3c"
  );
