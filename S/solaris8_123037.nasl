...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 123037-01");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"123037-01", obsoleted_by:"124519-01 ", package:"SUNWsgee", version:"6.0,REV=2004.06.03.16.00") < 0) flag++;
