...
# extracted from SUSE update advisory SUSE-SU-2014:0414-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED11 / SLES11 Security Update : clamav (SUSE-SU-2014:0414-1)");
...
improvements, including Extraction, decompression, and scanning of
files within the Extensible Archive (XAR)/Apple Disk Image (DMG)
format, support for decompression and scanning of files in the 'Xz'
compression format.
...
without introducing additional issues."
  ...
  # http://download.suse.com/patch/finder/?keywords=1cf7396cf9fd4d3bd7faa89fe18c7661
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?46eb3ffa"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/841815"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/865883"
  );
  # https://www.suse.com/support/update/announcement/2014/suse-su-20140414-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7e600dd9"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
