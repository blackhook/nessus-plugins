...
if (description)
{
  ...
  script_cve_id("CVE-2017-10036", "CVE-2017-10042");
...
10 and 11. Easily exploitable vulnerability allows unauthenticated
attacker with network access via NFSv4 to compromise Solaris.
Successful attacks of this vulnerability can result in unauthorized
ability to cause a hang or frequently repeatable crash (complete DOS)
of Solaris.

Vulnerability in the Solaris component of Oracle Sun Systems Products
Suite (subcomponent: IKE). Supported versions that are affected are 10
and 11. Easily exploitable vulnerability allows unauthenticated
attacker with network access via IKE to compromise Solaris. Successful
...
cause a hang or frequently repeatable crash (complete DOS) of Solaris."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 150400-50 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-10036");
