...
if (description)
{
 ...
 script_name(english:"Microsoft Windows 'Server Operators' Group User List");
 script_summary(english:"Lists users that are in special groups");

 script_set_attribute(attribute:"synopsis", value:"There is at least one user in the 'Server Operators' group.");
...
{
 NetUseDel();
 exit(0, "'Server Operators' group not found.");
}
