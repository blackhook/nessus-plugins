...
if ( rpm_check(release:"SUSE11.3", reference:"python-cupshelpers-1.2.0-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"system-config-printer-1.2.0-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"system-config-printer-lang-1.2.0-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"udev-configure-printer-1.2.0-2.5.1") ) flag++;
