...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 148002-01 (deprecated)");
...
148002 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 148002 instead.");
