...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2010-A-0025-S");
...
arbitrary code subject to the user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?f0f63bb7");
  script_set_attribute(
    attribute:"solution",
    value:
...
Vista, 2008, 7, and 2008 R2."
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-0250");
