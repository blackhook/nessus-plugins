...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 119783-42");
  script_summary(english:"Check for patch 119783-42");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 119783-42"
  );
  script_set_attribute(
...
execution."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/119783-42"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 119783-42 or higher");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119783-42", obsoleted_by:"", package:"SUNWbind", version:"11.10.0,REV=2005.01.08.05.16") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119783-42", obsoleted_by:"", package:"SUNWbindS", version:"11.10.0,REV=2005.01.08.05.16") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"119783-42", obsoleted_by:"", package:"SUNWbindr", version:"11.10.0,REV=2005.01.08.05.16") < 0) flag++;
