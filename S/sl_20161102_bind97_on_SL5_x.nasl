...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind97 on SL5.x i386/x86_64 (20161102)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1611&L=scientific-linux-errata&F=&S=&P=409
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?53522b50"
  );
