...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : perl-58 (cve_2012_5195_buffer_errors)");
...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2012-5195-buffer-errors-vulnerability-in-perl"
  );
