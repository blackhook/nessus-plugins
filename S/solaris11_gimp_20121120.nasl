...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : gimp (cve_2012_4245_arbitrary_code)");
...
security updates :
  ...
  - The scriptfu network server in GIMP 2.6 does not require
    authentication, which allows remote attackers to execute
    arbitrary commands via the python-fu-eval command.
    (CVE-2012-4245)"
  );
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2012-4245-arbitrary-code-execution-vulnerability-in-gimp
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8e3873a9"
  );
