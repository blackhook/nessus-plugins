...
take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1112&L=scientific-linux-errata&T=0&P=354
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?75bd712b"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libarchive-2.8.3-3.el6_1")) flag++;
if (rpm_check(release:"SL6", reference:"libarchive-debuginfo-2.8.3-3.el6_1")) flag++;
if (rpm_check(release:"SL6", reference:"libarchive-devel-2.8.3-3.el6_1")) flag++;
