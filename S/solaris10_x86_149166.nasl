...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 149166-01 (deprecated)");
...
149166 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 149166 instead.");
