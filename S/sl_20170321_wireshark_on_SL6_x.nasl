...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : wireshark on SL6.x i386/x86_64 (20170321)");
...
"Security Fix(es) :
  ...
  - Several denial of service flaws were found in Wireshark.
    Wireshark could crash or stop responding if it read a
    malformed packet off a network, or opened a malicious
    dump file. (CVE-2015-3811, CVE-2015-3812, CVE-2015-3813,
    CVE-2013-4075)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1704&L=scientific-linux-errata&F=&S=&P=2550
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad727d5a"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"wireshark-1.8.10-25.el6")) flag++;
if (rpm_check(release:"SL6", reference:"wireshark-debuginfo-1.8.10-25.el6")) flag++;
if (rpm_check(release:"SL6", reference:"wireshark-devel-1.8.10-25.el6")) flag++;
if (rpm_check(release:"SL6", reference:"wireshark-gnome-1.8.10-25.el6")) flag++;
