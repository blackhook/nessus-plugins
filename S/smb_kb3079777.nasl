...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3079777");
...
affected by multiple remote code execution vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/3079777/microsoft-security-advisory-update-for-vulnerabilities-in-adobe-flash");
