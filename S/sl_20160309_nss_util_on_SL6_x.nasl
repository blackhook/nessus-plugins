...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss-util on SL6.x, SL7.x i386/x86_64 (20160309)");
...
nss- util library must be restarted, or the system rebooted."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1603&L=scientific-linux-errata&F=&S=&P=3846
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b5a0b792"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"nss-util-3.19.1-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"nss-util-debuginfo-3.19.1-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"nss-util-devel-3.19.1-5.el6_7")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"nss-util-3.19.1-9.el7_2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"nss-util-debuginfo-3.19.1-9.el7_2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"nss-util-devel-3.19.1-9.el7_2")) flag++;
