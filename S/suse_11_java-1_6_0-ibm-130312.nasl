...
if (description)
{
  ...
  script_name(english:"SuSE 11.2 Security Update : Java (SAT Patch Number 7481)");
...
Security issues fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=808625"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 7481.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:2, reference:"java-1_6_0-ibm-1.6.0_sr13.0-0.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, reference:"java-1_6_0-ibm-fonts-1.6.0_sr13.0-0.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, reference:"java-1_6_0-ibm-jdbc-1.6.0_sr13.0-0.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"java-1_6_0-ibm-alsa-1.6.0_sr13.0-0.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"java-1_6_0-ibm-plugin-1.6.0_sr13.0-0.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"java-1_6_0-ibm-plugin-1.6.0_sr13.0-0.8.1")) flag++;
