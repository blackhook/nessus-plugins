...
"Update the affected kgraft-patch-4_12_14-95_74-default, kgraft-patch-4_12_14-95_77-default and / or kgraft-
...
var kernel_live_checks = [
  {
    'kernels': {
      ...
      '4.12.14-95.77-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_77-default-9-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      },
      '4.12.14-95.80-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_80-default-7-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kgraft-patch-4_12_14-95_74-default / etc');
}
