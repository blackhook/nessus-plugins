...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xscreensaver on SL4 i386/x86_64");
...
causing XScreenSaver to crash, unlocking the screen. (CVE-2007-1859)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=632
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8cd8d370"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"xscreensaver-4.18-5.rhel4.14")) flag++;
