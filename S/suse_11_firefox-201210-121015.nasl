...
if (description)
{
  ...
  script_name(english:"SuSE 11.2 Security Update : Mozilla Firefox (SAT Patch Number 6951)");
...
fixes bugs and security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 6951.");
