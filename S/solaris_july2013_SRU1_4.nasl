...
if (description)
{
  ...
  script_cve_id("CVE-2013-3787");
  script_bugtraq_id(61248);

  script_name(english:"Oracle Solaris Critical Patch Update : july2013_SRU1_4");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    ...
    network attacks via SCTP. Successful attack of this
    vulnerability can result in unauthorized ability to
    cause a partial denial of service (partial DOS) of
    Solaris. (CVE-2013-3787)"
  );
  script_set_attribute(
    attribute:"see_also",
