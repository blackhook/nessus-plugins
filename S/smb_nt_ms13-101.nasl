...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2887069");
  script_xref(name:"MSKB", value:"2893984");
...
arbitrary amounts of kernel memory or gain elevated privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.secureauth.com/labs/advisories/divide-error-windows-kernel");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/530273/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-101");
  script_set_attribute(
    attribute:"solution",
    value:
