...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : pidgin (cve_2012_3374_buffer_overflow)");
...
security updates :
  ...
  - Buffer overflow in markup.c in the MXit protocol plugin
    in libpurple in Pidgin before 2.10.5 allows remote
    attackers to execute arbitrary code via a crafted inline
    image in a message. (CVE-2012-3374)"
  );
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2012-3374-buffer-overflow-vulnerability-in-pidgin
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?59dd511c"
  );
