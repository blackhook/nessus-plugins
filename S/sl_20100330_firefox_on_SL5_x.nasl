...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1004&L=scientific-linux-errata&T=0&P=76
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e7f6353b"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"firefox-3.0.19-1.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-1.9.0.19-1.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-1.9.0.19-1.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-unstable-1.9.0.19-1.el5_5")) flag++;
