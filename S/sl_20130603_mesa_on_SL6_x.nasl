...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mesa on SL6.x i386/x86_64 (20130603)");
...
this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1306&L=scientific-linux-errata&T=0&P=466
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ceffce3"
  );
