...
if (description)
{
  ...
  script_bugtraq_id(76600, 76601, 76603);
  script_xref(name:"MSFT", value:"MS15-104");
  script_xref(name:"MSKB", value:"3080352");
  script_xref(name:"MSKB", value:"3080353");
  script_xref(name:"MSKB", value:"3080355");
...
in Skype for Business Server and Lync Server :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4e8b2f20");
...
and Skype for Business Server 2015.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2536");
