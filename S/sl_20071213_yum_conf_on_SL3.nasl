...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : yum-conf on SL3.x i386/x86_64");
...
SL 3.0.1"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0712&L=scientific-linux-errata&T=0&P=1888
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4f417bf9"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected yum-conf package."
  );
...
flag = 0;
if (rpm_check(release:"SL3", cpu:"i386", reference:"yum-conf-301-8.SL")) flag++;
