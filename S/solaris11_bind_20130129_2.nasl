...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : bind (cve_2012_5166_denial_of)");
...
security updates :
  ...
  - ISC BIND 9.x before 9.7.6-P4, 9.8.x before 9.8.3-P4,
    9.9.x before 9.9.1-P4, and 9.4-ESV and 9.6-ESV before
    9.6-ESV-R7-P4 allows remote attackers to cause a denial
    of service (named daemon hang) via unspecified
    combinations of resource records. (CVE-2012-5166)"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2012-5166-denial-of-service-vulnerability-in-isc-bind"
  );
