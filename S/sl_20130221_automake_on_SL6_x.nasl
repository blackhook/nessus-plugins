...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : automake on SL6.x (noarch) (20130221)");
...
distcheck'. (CVE-2012-3386)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=5162
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c9c0a591"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:automake");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"automake-1.11.1-4.el6")) flag++;
