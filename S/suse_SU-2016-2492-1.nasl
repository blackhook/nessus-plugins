...
# extracted from SUSE update advisory SUSE-SU-2016:2492-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : ghostscript-library (SUSE-SU-2016:2492-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-7978/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-7979/"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162492-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca0d88b0"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch SUSE-SLE-SDK-12-SP1-2016-1458=1

SUSE Linux Enterprise Server for SAP 12:zypper in -t patch
SUSE-SLE-SAP-12-2016-1458=1

SUSE Linux Enterprise Server 12-SP1:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2016-1458=1

SUSE Linux Enterprise Server 12-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-2016-1458=1

SUSE Linux Enterprise Desktop 12-SP1:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP1-2016-1458=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"ghostscript-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"ghostscript-debuginfo-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"ghostscript-debugsource-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"ghostscript-x11-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"ghostscript-x11-debuginfo-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ghostscript-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ghostscript-debuginfo-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ghostscript-debugsource-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ghostscript-x11-9.15-11.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ghostscript-x11-debuginfo-9.15-11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"ghostscript-9.15-11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"ghostscript-debuginfo-9.15-11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"ghostscript-debugsource-9.15-11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"ghostscript-x11-9.15-11.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"ghostscript-x11-debuginfo-9.15-11.1")) flag++;
