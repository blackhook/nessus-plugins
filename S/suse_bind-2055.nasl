...
# extracted from openSUSE Security Update bind-2055.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : bind (bind-2055)");
  script_summary(english:"Check for the bind-2055 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"bind-9.3.2-17.7") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"bind-devel-9.3.2-17.7") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"bind-libs-9.3.2-17.7") ) flag++;
if ( rpm_check(release:"SUSE10.1", cpu:"x86_64", reference:"bind-libs-32bit-9.3.2-17.7") ) flag++;
