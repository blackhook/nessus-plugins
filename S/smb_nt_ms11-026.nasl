...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2503658");
...
sites, resulting in information disclosure."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-026");
  script_set_attribute(
    attribute:"solution",
    value:
