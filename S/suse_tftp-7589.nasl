...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : tftp (ZYPP Patch Number 7589)");
...
large value for the utimeout option. (CVE-2011-2199)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7589.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"tftp-0.48-1.13.1")) flag++;
