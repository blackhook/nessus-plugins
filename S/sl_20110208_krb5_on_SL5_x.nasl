...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1102&L=scientific-linux-errata&T=0&P=989
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?472cad9b"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"krb5-devel-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"SL5", reference:"krb5-libs-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"SL5", reference:"krb5-server-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"SL5", reference:"krb5-server-ldap-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"SL5", reference:"krb5-workstation-1.6.1-55.el5_6.1")) flag++;
