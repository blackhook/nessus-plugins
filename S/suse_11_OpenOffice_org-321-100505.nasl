...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : OpenOffice_org (SAT Patch Number 2586)");
...
changelog of the OpenOffice_org RPM package."
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 2586.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:1, cpu:"i586", reference:"libpython2_6-1_0-2.6.0-8.9.20")) flag++;
if (rpm_check(release:"SLES11", sp:1, cpu:"x86_64", reference:"libpython2_6-1_0-2.6.0-8.9.20")) flag++;
if (rpm_check(release:"SLES11", sp:1, cpu:"x86_64", reference:"libpython2_6-1_0-32bit-2.6.0-8.9.20")) flag++;
