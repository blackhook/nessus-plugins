...
if(description)
{
 ...
 script_name(english: "Solaris 5.8 (sparc) : 113136-06");
...
e +=  solaris_check_patch(release:"5.8", arch:"sparc", patch:"113136-06", obsoleted_by:"", package:"SDRMsp32", version:"5.3,REV=2002.03.27.15.30");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
