...
# extracted from SUSE update advisory SUSE-SU-2016:1561-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : spice (SUSE-SU-2016:1561-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161561-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?768d5f67"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch SUSE-SLE-SDK-12-2016-928=1

SUSE Linux Enterprise Server 12 :

zypper in -t patch SUSE-SLE-SERVER-12-2016-928=1

SUSE Linux Enterprise Desktop 12 :

zypper in -t patch SUSE-SLE-DESKTOP-12-2016-928=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"libspice-server1-0.12.4-8.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.4-8.9.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"spice-debugsource-0.12.4-8.9.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"libspice-server1-0.12.4-8.9.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"libspice-server1-debuginfo-0.12.4-8.9.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"spice-debugsource-0.12.4-8.9.1")) flag++;
