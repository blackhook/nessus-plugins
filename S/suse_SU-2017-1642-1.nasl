...
# extracted from SUSE update advisory SUSE-SU-2017:1642-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : openvpn (SUSE-SU-2017:1642-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20171642-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?876d6c60"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
slessp4-openvpn-13166=1

SUSE Linux Enterprise Server 11-SP3-LTSS:zypper in -t patch
slessp3-openvpn-13166=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-openvpn-13166=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-openvpn-13166=1

SUSE Linux Enterprise Debuginfo 11-SP3:zypper in -t patch
dbgsp3-openvpn-13166=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"openvpn-2.0.9-143.46.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"openvpn-auth-pam-plugin-2.0.9-143.46.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"openvpn-2.0.9-143.46.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"openvpn-auth-pam-plugin-2.0.9-143.46.1")) flag++;
