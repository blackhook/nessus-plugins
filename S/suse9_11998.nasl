...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : pcre (YOU Patch Number 11998)");
...
CVE-2006-7230)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11998.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"pcre-4.4-109.12")) flag++;
if (rpm_check(release:"SUSE9", reference:"pcre-devel-4.4-109.12")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"pcre-32bit-9-200711270035")) flag++;
