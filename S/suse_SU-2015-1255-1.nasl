...
# extracted from SUSE update advisory SUSE-SU-2015:1255-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 Security Update : flash-player (SUSE-SU-2015:1255-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=937752");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2015-5122/");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2015-5123/");
  # https://www.suse.com/support/update/announcement/2015/suse-su-20151255-1.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6f9e7bc9");
...
flag = 0;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"flash-player-11.2.202.491-96.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"flash-player-gnome-11.2.202.491-96.1")) flag++;
