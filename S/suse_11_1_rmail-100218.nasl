...
# extracted from openSUSE Security Update rmail-2012.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rmail (rmail-2012)");
  script_summary(english:"Check for the rmail-2012 patch");
...
the SSL certificate. (CVE-2009-4565: CVSS v2 Base Score: 7.5)"
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected rmail packages."
  );
...
if ( rpm_check(release:"SUSE11.1", reference:"rmail-8.14.3-50.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"sendmail-8.14.3-50.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"sendmail-devel-8.14.3-50.10.1") ) flag++;
