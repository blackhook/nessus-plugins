...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:4044");

  script_name(english:"Scientific Linux Security Update : flatpak on SL7.x x86_64 (2021:4044)");
...
SLSA-2021:4044-1 advisory.

  - flatpak: Sandbox bypass via recent VFS-manipulating syscalls (CVE-2021-41133)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20214044-1");
...
var pkgs = [
    {'reference':'-flatpak-1.0.9-12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-builder-1.0.0-12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-debuginfo-1.0.9-12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-devel-1.0.9-12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-libs-1.0.9-12.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
