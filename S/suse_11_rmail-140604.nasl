...
if (description)
{
  ...
  script_name(english:"SuSE 11.3 Security Update : sendmail (SAT Patch Number 9345)");
...
"sendmail has been updated to fix the following security issue :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2014-3956.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 9345.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:3, reference:"sendmail-8.14.3-50.24.1")) flag++;
