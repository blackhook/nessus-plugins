...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : IBM Java (ZYPP Patch Number 7440)");
...
The following security issues were fixed :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7440.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:4, reference:"java-1_4_2-ibm-1.4.2_sr13.8-1.7.13")) flag++;
if (rpm_check(release:"SLES10", sp:4, reference:"java-1_4_2-ibm-devel-1.4.2_sr13.8-1.7.13")) flag++;
if (rpm_check(release:"SLES10", sp:4, cpu:"i586", reference:"java-1_4_2-ibm-jdbc-1.4.2_sr13.8-1.7.13")) flag++;
if (rpm_check(release:"SLES10", sp:4, cpu:"i586", reference:"java-1_4_2-ibm-plugin-1.4.2_sr13.8-1.7.13")) flag++;
