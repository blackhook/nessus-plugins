...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : systemd on SL7.x x86_64 (20180131)");
...
"Security Fix(es) :
  ...
  - A race condition was found in systemd. This could result
    in automount requests not being serviced and processes
    using them could hang, causing denial of service.
    (CVE-2018-1049)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1801&L=scientific-linux-errata&F=&S=&P=10196
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1f6faac8"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgudev1-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libgudev1-devel-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-debuginfo-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-devel-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-journal-gateway-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-libs-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-networkd-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-python-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-resolved-219-42.el7_4.7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"systemd-sysv-219-42.el7_4.7")) flag++;
