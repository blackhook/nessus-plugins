...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 138536-01");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"138536-01", obsoleted_by:"", package:"SUNWspssws70", version:"1.0,REV=2006.04.24") < 0) flag++;
