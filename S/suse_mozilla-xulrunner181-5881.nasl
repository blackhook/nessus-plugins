...
# extracted from openSUSE Security Update mozilla-xulrunner181-5881.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : mozilla-xulrunner181 (mozilla-xulrunner181-5881)");
  script_summary(english:"Check for the mozilla-xulrunner181-5881 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"mozilla-xulrunner181-1.8.1.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mozilla-xulrunner181-devel-1.8.1.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"mozilla-xulrunner181-l10n-1.8.1.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"mozilla-xulrunner181-32bit-1.8.1.19-0.1") ) flag++;
