...
# extracted from SUSE update advisory SUSE-SU-2018:1887-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : openssl (SUSE-SU-2018:1887-2)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20181887-2/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ae7e8ee9"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
SUSE-SLE-SERVER-12-SP2-BCL-2018-1276=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl-devel-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-32bit-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-debuginfo-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-debuginfo-32bit-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-hmac-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libopenssl1_0_0-hmac-32bit-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"openssl-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"openssl-debuginfo-1.0.2j-60.30.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"openssl-debugsource-1.0.2j-60.30.1")) flag++;
