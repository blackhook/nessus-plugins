...
if ( rpm_check(release:"SUSE11.0", reference:"gnutls-2.2.2-17.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libgnutls-devel-2.2.2-17.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libgnutls-extra-devel-2.2.2-17.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libgnutls-extra26-2.2.2-17.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libgnutls26-2.2.2-17.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libgnutls26-32bit-2.2.2-17.9") ) flag++;
