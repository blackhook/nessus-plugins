...
# extracted from openSUSE Security Update pdns-2275.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : pdns (pdns-2275)");
  script_summary(english:"Check for the pdns-2275 patch");
...
CVE-2006-4252: Zero second CNAME TTLs can make PowerDNS exhaust
...
if ( rpm_check(release:"SUSE10.1", reference:"pdns-2.9.19-13.4") ) flag++;
