...
# extracted from openSUSE Security Update libvirt-2903.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libvirt (openSUSE-SU-2010:0625-1)");
  script_summary(english:"Check for the libvirt-2903 patch");
...
obtaining privileged resources on the host (CVE-2010-2242)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=619991"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-09/msg00026.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-0.8.1-4.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-client-0.8.1-4.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-devel-0.8.1-4.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libvirt-python-0.8.1-4.2.1") ) flag++;
