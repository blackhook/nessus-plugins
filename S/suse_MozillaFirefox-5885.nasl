...
# extracted from openSUSE Security Update MozillaFirefox-5885.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaFirefox (MozillaFirefox-5885)");
  script_summary(english:"Check for the MozillaFirefox-5885 patch");
...
fixed in Firefox 2.0.0.17. moz_bug_r_a4 demonstrated that it was still
possible to use the feed preview as a vector for JavaScript privilege
escalation. An attacker could use this issue to run arbitrary
...
if ( rpm_check(release:"SUSE10.3", reference:"MozillaFirefox-2.0.0.19-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"MozillaFirefox-translations-2.0.0.19-0.1") ) flag++;
