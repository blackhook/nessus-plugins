...
# extracted from openSUSE Security Update libpoppler3-1035.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpoppler3 (libpoppler3-1035)");
  script_summary(english:"Check for the libpoppler3-1035 patch");
...
be triggered via malformed PDF files."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libpoppler3 package."
  );
...
if ( rpm_check(release:"SUSE11.0", reference:"libpoppler3-0.8.2-1.4") ) flag++;
