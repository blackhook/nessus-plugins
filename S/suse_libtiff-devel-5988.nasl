...
# extracted from openSUSE Security Update libtiff-devel-5988.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libtiff-devel (libtiff-devel-5988)");
  script_summary(english:"Check for the libtiff-devel-5988 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libtiff-devel-3.8.2-68.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libtiff3-3.8.2-68.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"tiff-3.8.2-68.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libtiff-devel-32bit-3.8.2-68.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libtiff3-32bit-3.8.2-68.4") ) flag++;
