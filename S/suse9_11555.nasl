...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : libexif (YOU Patch Number 11555)");
...
it interprets the EXIF tags in prepared JPEG files. (CVE-2007-2645)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11555.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"libexif-0.5.12-118.10")) flag++;
