...
Specially crafted requests could crash mod_proxy_ajp (CVE-2010-0408)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-04/msg00084.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"apache2-2.2.10-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"apache2-devel-2.2.10-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"apache2-example-pages-2.2.10-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"apache2-prefork-2.2.10-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"apache2-utils-2.2.10-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"apache2-worker-2.2.10-2.9.1") ) flag++;
