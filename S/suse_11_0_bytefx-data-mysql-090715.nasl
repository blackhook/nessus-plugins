...
if ( rpm_check(release:"SUSE11.0", reference:"bytefx-data-mysql-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"ibm-data-db2-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-complete-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-core-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-data-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-data-firebird-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-data-oracle-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-data-postgresql-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-data-sqlite-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-data-sybase-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-devel-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-extras-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-jscript-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-locale-extras-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-nunit-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-web-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mono-winforms-1.9.1-6.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"mono-core-32bit-1.9.1-6.5") ) flag++;
