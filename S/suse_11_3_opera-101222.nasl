...
# extracted from openSUSE Security Update opera-3730.
#
...
if (description)
{
  ...
  script_summary(english:"Check for the opera-3730 patch");
...
if ( rpm_check(release:"SUSE11.3", reference:"opera-11.00-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"opera-gtk-11.00-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"opera-kde4-11.00-1.2.1") ) flag++;
