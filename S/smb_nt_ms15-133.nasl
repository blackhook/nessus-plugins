...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3109103");
...
affected host.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-133");
