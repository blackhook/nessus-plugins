...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : automake on SL5.x (noarch) (20140916)");
...
distcheck'. (CVE-2012-3386)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1409&L=scientific-linux-errata&T=0&P=2249
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e84f45d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"automake-1.9.6-3.el5")) flag++;
