...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mysql on SL6.x i386/x86_64 (20130131)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=211
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1570a48b"
  );
