...
# extracted from SUSE update advisory SUSE-SU-2018:0607-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : wavpack (SUSE-SU-2018:0607-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180607-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5ac1de3"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-wavpack-13499=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-wavpack-13499=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-wavpack-13499=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"libwavpack1-4.50.1-1.27.1")) flag++;
