...
# extracted from SUSE update advisory SUSE-SU-2017:1760-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : unrar (SUSE-SU-2017:1760-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20171760-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7d698ccd"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
slessp4-unrar-13191=1

SUSE Linux Enterprise Server 11-SP3-LTSS:zypper in -t patch
slessp3-unrar-13191=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-unrar-13191=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-unrar-13191=1

SUSE Linux Enterprise Debuginfo 11-SP3:zypper in -t patch
dbgsp3-unrar-13191=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"unrar-3.80.2-4.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"unrar-3.80.2-4.1")) flag++;
