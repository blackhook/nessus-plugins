...
# extracted from openSUSE Security Update dhcpcd-4411.
#
...
if (description)
{
  ...
  script_summary(english:"Check for the dhcpcd-4411 patch");
...
if ( rpm_check(release:"SUSE11.3", reference:"dhcpcd-3.2.3-61.66.1") ) flag++;
