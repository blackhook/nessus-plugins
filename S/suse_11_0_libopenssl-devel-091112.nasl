...
if ( rpm_check(release:"SUSE11.0", reference:"libopenssl-devel-0.9.8g-47.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libopenssl0_9_8-0.9.8g-47.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"openssl-0.9.8g-47.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"openssl-certs-0.9.8g-47.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libopenssl0_9_8-32bit-0.9.8g-47.10") ) flag++;
