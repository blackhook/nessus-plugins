...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1122012"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=936786"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=976955"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-3239/"
  );
  # https://www.suse.com/support/update/announcement/2019/suse-su-20190284-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23a43988"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
