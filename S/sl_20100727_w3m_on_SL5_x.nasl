...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : w3m on SL5.x i386/x86_64");
...
by mistake. (CVE-2010-2074)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1007&L=scientific-linux-errata&T=0&P=3151
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?42fd415a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"w3m-0.5.1-17.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"w3m-img-0.5.1-17.el5_5")) flag++;
