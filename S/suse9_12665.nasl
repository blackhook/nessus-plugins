...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : CUPS (YOU Patch Number 12665)");
...
"This update fixes the following vulnerabilities in cups :
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12665.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"cups-1.1.20-108.65")) flag++;
if (rpm_check(release:"SUSE9", reference:"cups-client-1.1.20-108.65")) flag++;
if (rpm_check(release:"SUSE9", reference:"cups-devel-1.1.20-108.65")) flag++;
if (rpm_check(release:"SUSE9", reference:"cups-libs-1.1.20-108.65")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"cups-libs-32bit-9-201010271353")) flag++;
