...
if(description)
{
 ...
 script_name(english: "Solaris 5.7 (sparc) : 113203-04");
...
e +=  solaris_check_patch(release:"5.7", arch:"sparc", patch:"113203-04", obsoleted_by:"", package:"VRTSob", version:"3.0.2.261");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
