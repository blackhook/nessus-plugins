...
if ( rpm_check(release:"SUSE11.0", reference:"compat-openssl097g-0.9.7g-119.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"compat-openssl097g-32bit-0.9.7g-119.3") ) flag++;
