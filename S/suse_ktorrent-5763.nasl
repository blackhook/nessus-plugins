...
# extracted from openSUSE Security Update ktorrent-5763.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : ktorrent (ktorrent-5763)");
  script_summary(english:"Check for the ktorrent-5763 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"ktorrent-2.2.1-32.2") ) flag++;
