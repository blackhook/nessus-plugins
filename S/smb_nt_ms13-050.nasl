...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2839894");
...
must have valid login credentials."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-050");
  script_set_attribute(
    attribute:"solution",
    value:
