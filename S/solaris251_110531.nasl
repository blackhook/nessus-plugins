...
if(description)
{
 ...
 name["english"] = "Solaris 2.5.1 (sparc) : 110531-01";
...
"https://getupdates.oracle.com/readme/110531-01" );
...
e +=  solaris_check_patch(release:"5.5.1", arch:"sparc", patch:"110531-01", obsoleted_by:"", package:"SUNWab2u", version:"3.0,REV=1999.1209");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
