...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sudo on SL6.x i386/x86_64 (20191106)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1911&L=SCIENTIFIC-LINUX-ERRATA&P=850
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2eacff1"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"SL6", reference:"sudo-1.8.6p3-29.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"sudo-debuginfo-1.8.6p3-29.el6_10.2")) flag++;
if (rpm_check(release:"SL6", reference:"sudo-devel-1.8.6p3-29.el6_10.2")) flag++;
