...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x, SL7.x i386/x86_64 (20150401)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1504&L=scientific-linux-errata&T=0&P=204
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8438e7cb"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"firefox-31.6.0-2.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"firefox-debuginfo-31.6.0-2.el5_11")) flag++;

if (rpm_check(release:"SL6", reference:"firefox-31.6.0-2.el6_6")) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-31.6.0-2.el6_6")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-31.6.0-2.el7_1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-31.6.0-2.el7_1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"xulrunner-31.6.0-2.el7_1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"xulrunner-debuginfo-31.6.0-2.el7_1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"xulrunner-devel-31.6.0-2.el7_1")) flag++;
