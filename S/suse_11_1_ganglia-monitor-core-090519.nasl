...
if ( rpm_check(release:"SUSE11.1", reference:"ganglia-monitor-core-2.5.7-172.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"ganglia-monitor-core-devel-2.5.7-172.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"ganglia-monitor-core-gmetad-2.5.7-172.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"ganglia-monitor-core-gmond-2.5.7-172.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"ganglia-webfrontend-2.5.7-172.40.1") ) flag++;
