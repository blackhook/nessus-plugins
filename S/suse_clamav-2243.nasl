...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : clamav (ZYPP Patch Number 2243)");
...
Following issues are fixed by this update :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 2243.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:0, reference:"clamav-0.88.6-1.4")) flag++;
