...
if ( rpm_check(release:"SUSE11.3", reference:"ncpfs-2.2.6-166.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"ncpfs-devel-2.2.6-166.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"ncpfs-32bit-2.2.6-166.3.1") ) flag++;
