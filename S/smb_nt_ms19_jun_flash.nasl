...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4503308");
  script_xref(name:"MSFT", value:"MS19-4503308");

  script_name(english:"KB4503308: Security update for Adobe Flash Player (June 2019)");
...
"The remote Windows host is missing security update KB4503308. It is,
...
in Adobe Flash Player.");
  ...
  # https://support.microsoft.com/en-us/help/4503308/security-update-for-adobe-flash-player
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0248e66d");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4503308 to address this issue.");
...
# all <= 32.0.0.192
fix = FALSE;
if(ver_compare(ver:iver, fix:'32.0.0.192', strict:FALSE) <= 0)
  fix = '32.0.0.207';
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS19-06', kb:'4503308', report);
