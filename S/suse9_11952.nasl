...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : YaST2 (YOU Patch Number 11952)");
...
(i.e. /tmp)."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11952.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"yast2-core-2.9.98.1-0.1")) flag++;
if (rpm_check(release:"SUSE9", reference:"yast2-core-devel-2.9.98.1-0.1")) flag++;
