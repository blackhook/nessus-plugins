...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 119004-02");
  script_summary(english:"Check for patch 119004-02");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 119004-02");
  script_set_attribute(attribute:"description", value:
"NetBackup 4.5MP6 files fix. Date this patch was last updated by Sun :
Apr/14/06");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"119004-02", obsoleted_by:"", package:"VRTSnetbp", version:"4.5,REV=2003.10.15.15.01") < 0) flag++;
