...
# extracted from openSUSE Security Update compat-openssl097g-480.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : compat-openssl097g (compat-openssl097g-480)");
  script_summary(english:"Check for the compat-openssl097g-480 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"compat-openssl097g-0.9.7g-146.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"compat-openssl097g-32bit-0.9.7g-146.9.1") ) flag++;
