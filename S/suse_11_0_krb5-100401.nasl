...
if ( rpm_check(release:"SUSE11.0", reference:"krb5-1.6.3-50.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"krb5-apps-clients-1.6.3-50.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"krb5-apps-servers-1.6.3-50.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"krb5-client-1.6.3-50.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"krb5-devel-1.6.3-50.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"krb5-server-1.6.3-50.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"krb5-32bit-1.6.3-50.9") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"krb5-devel-32bit-1.6.3-50.9") ) flag++;
