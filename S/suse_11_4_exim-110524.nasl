...
# extracted from openSUSE Security Update exim-4604.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : exim (openSUSE-SU-2011:0535-1)");
  script_summary(english:"Check for the exim-4604 patch");
...
"This update fixes a security issues :
  ...
  - exim remote code exection (CVE-2011-1407) also some
    safety improvements regarding STARTTLS."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-05/msg00054.html"
  );
...
if ( rpm_check(release:"SUSE11.4", reference:"exim-4.74-6.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"exim-debuginfo-4.74-6.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"exim-debugsource-4.74-6.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"eximon-4.74-6.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"eximon-debuginfo-4.74-6.9.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"eximstats-html-4.74-6.9.1") ) flag++;
