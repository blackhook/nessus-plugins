...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.8.0-openjdk on SL6.x i386/x86_64 (20150121) (POODLE)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1501&L=scientific-linux-errata&T=0&P=1922
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cc6f8f22"
  );
