...
flag = 0;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"MozillaFirefox-17.0.6esr-0.4.1")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"MozillaFirefox-translations-17.0.6esr-0.4.1")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-17.0.6esr-0.4.1")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-translations-17.0.6esr-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"MozillaFirefox-17.0.6esr-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"MozillaFirefox-translations-17.0.6esr-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-17.0.6esr-0.4.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-translations-17.0.6esr-0.4.1")) flag++;
