...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL6.x i386/x86_64 (20200416)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=2017
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39391896"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-68.7.0-1.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-68.7.0-1.el6_10", allowmaj:TRUE)) flag++;
