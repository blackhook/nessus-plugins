...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : acroread_ja (SAT Patch Number 1170)");
...
"This update of acroread fixes the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 1170.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:0, cpu:"i586", reference:"acroread_ja-8.1.6-0.1.1")) flag++;
