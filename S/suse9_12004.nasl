...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : squid (YOU Patch Number 12004)");
...
reply processing. (CVE-2007-6239)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12004.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"squid-2.5.STABLE5-42.52")) flag++;
