...
if(description)
{
 ...
 script_name(english: "Solaris 5.7 (x86) : 108157-16");
...
e +=  solaris_check_patch(release:"5.7_x86", arch:"i386", patch:"108157-16", obsoleted_by:"", package:"SUNWicgSA", version:"3.0_revB=19990723");
e +=  solaris_check_patch(release:"5.7_x86", arch:"i386", patch:"108157-16", obsoleted_by:"", package:"SUNWicgSS", version:"3.0_revB=19990723");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
