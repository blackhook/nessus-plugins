...
# extracted from openSUSE Security Update ethereal-1932.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : ethereal (ethereal-1932)");
  script_summary(english:"Check for the ethereal-1932 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"ethereal-0.10.14-16.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"ethereal-devel-0.10.14-16.5") ) flag++;
