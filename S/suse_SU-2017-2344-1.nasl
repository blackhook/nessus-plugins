...
# extracted from SUSE update advisory SUSE-SU-2017:2344-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : libzypp, zypper (SUSE-SU-2017:2344-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1008325"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1054671"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1055920"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2017-7436/"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20172344-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?abf6132a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch SUSE-SLE-SDK-12-SP3-2017-1447=1

SUSE Linux Enterprise Server 12-SP3:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2017-1447=1

SUSE Linux Enterprise Desktop 12-SP3:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP3-2017-1447=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"libzypp-16.15.6-2.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libzypp-debuginfo-16.15.6-2.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libzypp-debugsource-16.15.6-2.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"zypper-1.13.32-21.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"zypper-debuginfo-1.13.32-21.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"zypper-debugsource-1.13.32-21.3.2")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libzypp-16.15.6-2.8.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libzypp-debuginfo-16.15.6-2.8.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libzypp-debugsource-16.15.6-2.8.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"zypper-1.13.32-21.3.2")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"zypper-debuginfo-1.13.32-21.3.2")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"zypper-debugsource-1.13.32-21.3.2")) flag++;
