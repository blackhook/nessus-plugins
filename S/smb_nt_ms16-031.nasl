...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3140410");
...
as System.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-031");
...
and 2008 R2");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0087");
