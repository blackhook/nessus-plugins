...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2813707");
...
overwrite files accessible to the user."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-045");
