...
# extracted from openSUSE Security Update mercurial-230.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mercurial (mercurial-230)");
  script_summary(english:"Check for the mercurial-230 patch");
...
(CVE-2008-4297)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=427243"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"mercurial-1.0-30.4") ) flag++;
