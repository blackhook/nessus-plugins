...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2914055");
  script_xref(name:"MSKB", value:"2914057");
  script_xref(name:"MSKB", value:"2914058");
  script_xref(name:"MSKB", value:"2920510");
...
could crash the affected service.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-004");
