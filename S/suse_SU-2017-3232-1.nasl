...
# extracted from SUSE update advisory SUSE-SU-2017:3232-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : openvswitch (SUSE-SU-2017:3232-1)");
  ...
  script_set_attribute(
    ...
    value:
"This update for openvswitch fixes the following issues: Security issue
fixed :

  - CVE-2017-14970: Add upstream patches to fix memory leaks
    (bsc#1061310). Bug fixes :
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1054094"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1057357"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20173232-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc06da60"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
SUSE-SLE-SERVER-12-SP3-2017-2017=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"openvswitch-2.7.0-3.10.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"openvswitch-debuginfo-2.7.0-3.10.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"openvswitch-debugsource-2.7.0-3.10.1")) flag++;
