...
if (description)
{
  ...
  script_cve_id("CVE-2014-6600");
  script_bugtraq_id(72174);

  script_name(english:"Oracle Solaris Critical Patch Update : jan2015_SRU11_2_4_6_0");
...
fix_release = "0.5.11-0.175.2.4.0.6.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.2.4.0.6.0", sru:"11.2.4.6.0") > 0) flag++;
