...
# extracted from openSUSE Security Update xerces-j2-1233.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xerces-j2 (xerces-j2-1233)");
  script_summary(english:"Check for the xerces-j2-1233 patch");
...
XML.CVE-2009-2625 has been assigned to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=530717"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-demo-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-javadoc-apis-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-javadoc-dom3-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-javadoc-impl-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-javadoc-other-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-javadoc-xni-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-scripts-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-xml-apis-2.8.1-238.16.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"xerces-j2-xml-resolver-2.8.1-238.16.1") ) flag++;
