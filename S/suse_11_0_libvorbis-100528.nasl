...
if ( rpm_check(release:"SUSE11.0", reference:"libvorbis-1.2.0-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libvorbis-devel-1.2.0-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libvorbis-32bit-1.2.0-53.3") ) flag++;
