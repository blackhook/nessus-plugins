...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 148112-02 (deprecated)");
  script_summary(english:"Check for patch 148112-02");
...
148112 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/148112-02"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"n/a"
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 148112 instead.");
