...
# extracted from SUSE update advisory SUSE-SU-2021:0195-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : mutt (SUSE-SU-2021:0195-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1181221"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2021-3181/"
  );
  # https://www.suse.com/support/update/announcement/2021/suse-su-20210195-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d7c32150"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"mutt-1.10.1-3.20.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"mutt-debuginfo-1.10.1-3.20.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"mutt-debugsource-1.10.1-3.20.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"mutt-1.10.1-3.20.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"mutt-debuginfo-1.10.1-3.20.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"mutt-debugsource-1.10.1-3.20.1")) flag++;
