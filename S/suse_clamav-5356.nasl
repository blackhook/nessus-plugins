...
# extracted from openSUSE Security Update clamav-5356.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : clamav (clamav-5356)");
  script_summary(english:"Check for the clamav-5356 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update brings clamav to version 0.93.1. It fixes various bugs and
one security issue :
...
if ( rpm_check(release:"SUSE10.2", reference:"clamav-0.93.1-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"clamav-db-0.93.1-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"clamav-0.93.1-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"clamav-db-0.93.1-0.1") ) flag++;
