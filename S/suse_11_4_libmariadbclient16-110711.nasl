...
# extracted from openSUSE Security Update libmariadbclient16-4864.
#
...
if (description)
{
  ...
  script_summary(english:"Check for the libmariadbclient16-4864 patch");
...
This update fixes this problem.
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-07/msg00013.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"libmariadbclient16-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libmariadbclient16-debuginfo-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libmariadbclient_r16-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libmariadbclient_r16-debuginfo-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-bench-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-bench-debuginfo-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-client-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-client-debuginfo-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-debug-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-debug-debuginfo-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-debuginfo-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-debugsource-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-test-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-test-debuginfo-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-tools-5.1.55-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"mariadb-tools-debuginfo-5.1.55-0.5.1") ) flag++;
