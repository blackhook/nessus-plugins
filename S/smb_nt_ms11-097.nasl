...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2620712");
...
vulnerability to gain elevated privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-097");
  script_set_attribute(
    attribute:"solution",
    value:
