...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : quagga (SAT Patch Number 4023)");
...
"This security update of quagga fixes :
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4023.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:1, reference:"quagga-0.99.15-0.4.1")) flag++;
