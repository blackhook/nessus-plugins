...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : unzip on SL3.x i386/x86_64");
...
that user's privileges. (CVE-2008-0888)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0803&L=scientific-linux-errata&T=0&P=1575
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?64f82b9c"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"unzip-5.50-36.EL3")) flag++;
