...
# SUSE update advisory SUSE-SU-2021:14728-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2021:14728-1");

  script_name(english:"SUSE SLES11 Security Update : djvulibre (SUSE-SU-2021:14728-1)");
...
the SUSE-SU-2021:14728-1 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  ...
  # https://lists.suse.com/pipermail/sle-security-updates/2021-May/008785.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?50900688");
...
pkgs = [
    {'reference':'libdjvulibre21-3.5.21-3.9', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'libdjvulibre21-3.5.21-3.9', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
