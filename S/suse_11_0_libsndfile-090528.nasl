...
if ( rpm_check(release:"SUSE11.0", reference:"libsndfile-1.0.17-141.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libsndfile-devel-1.0.17-141.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libsndfile-octave-1.0.17-141.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libsndfile-progs-1.0.17-141.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libsndfile-32bit-1.0.17-141.4") ) flag++;
