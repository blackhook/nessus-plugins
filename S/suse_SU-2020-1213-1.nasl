...
# extracted from SUSE update advisory SUSE-SU-2020:1213-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : rmt-server (SUSE-SU-2020:1213-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201213-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80d971a6"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP1-2020-1213=1

SUSE Linux Enterprise Module for Public Cloud 15-SP1 :

zypper in -t patch SUSE-SLE-Module-Public-Cloud-15-SP1-2020-1213=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"rmt-server-2.5.7-3.15.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"rmt-server-config-2.5.7-3.15.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"rmt-server-debuginfo-2.5.7-3.15.1")) flag++;
