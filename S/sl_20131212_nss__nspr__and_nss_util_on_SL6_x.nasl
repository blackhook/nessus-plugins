...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss, nspr, and nss-util on SL6.x i386/x86_64 (20131212)");
...
nss-util must be restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=4641
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?da9e5c4c"
  );
