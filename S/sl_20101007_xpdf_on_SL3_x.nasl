...
potentially, execute arbitrary code. (SL4 only - CVE-2010-3704)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1010&L=scientific-linux-errata&T=0&P=564
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?358b3f05"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"xpdf-2.02-19.el3")) flag++;

if (rpm_check(release:"SL4", reference:"xpdf-3.00-24.el4_8.1")) flag++;
