...
# SUSE update advisory SUSE-SU-2020:14461-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2020:14461-1");
  script_xref(name:"IAVA", value:"2020-A-0349");
  script_xref(name:"CEA-ID", value:"CEA-2020-0061");

  script_name(english:"SUSE SLES11 Security Update : grub2 (SUSE-SU-2020:14461-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1174421");
  # https://lists.suse.com/pipermail/sle-security-updates/2020-August/007297.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d5daf50");
...
pkgs = [
    {'reference':'grub2-x86_64-efi-2.00-0.66.21', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'grub2-x86_64-xen-2.00-0.66.21', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'grub2-x86_64-efi-2.00-0.66.21', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'},
    {'reference':'grub2-x86_64-xen-2.00-0.66.21', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
