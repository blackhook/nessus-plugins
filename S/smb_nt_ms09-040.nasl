...
if (description)
{
 ...
 script_xref(name:"MSFT", value:"MS09-040");
  script_xref(name:"MSKB", value:"971032");
...
and therefore elevate his privileges.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-040");
