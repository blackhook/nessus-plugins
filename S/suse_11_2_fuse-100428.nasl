...
if ( rpm_check(release:"SUSE11.2", reference:"fuse-2.7.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"fuse-devel-2.7.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"fuse-devel-static-2.7.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libfuse2-2.7.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libfuse2-32bit-2.7.4-3.4.1") ) flag++;
