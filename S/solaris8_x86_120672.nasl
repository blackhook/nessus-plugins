...
if (description)
{
  ...
  script_name(english:"Solaris 8 (x86) : 120672-08");
  script_summary(english:"Check for patch 120672-08");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 120672-08"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Sep/02/08"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/120672-08"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"120672-08", obsoleted_by:"", package:"SUNWmoznav", version:"1.7,REV=10.2005.12.08") < 0) flag++;
if (solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"120672-08", obsoleted_by:"", package:"SUNWmozmail", version:"1.7,REV=10.2005.12.08") < 0) flag++;
