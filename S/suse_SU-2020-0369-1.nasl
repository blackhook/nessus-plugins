...
# extracted from SUSE update advisory SUSE-SU-2020:0369-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : wicked (SUSE-SU-2020:0369-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200369-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e3215c7d"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch SUSE-SLE-SERVER-12-SP4-2020-369=1

SUSE Linux Enterprise Desktop 12-SP4 :

zypper in -t patch SUSE-SLE-DESKTOP-12-SP4-2020-369=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"wicked-0.6.60-2.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"wicked-debuginfo-0.6.60-2.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"wicked-debugsource-0.6.60-2.18.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"wicked-service-0.6.60-2.18.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"wicked-0.6.60-2.18.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"wicked-debuginfo-0.6.60-2.18.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"wicked-debugsource-0.6.60-2.18.1")) flag++;
if (rpm_check(release:"SLED12", sp:"4", cpu:"x86_64", reference:"wicked-service-0.6.60-2.18.1")) flag++;
