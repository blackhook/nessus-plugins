...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3198218");
...
context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-131");
...
8.1, and 10.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7248");
