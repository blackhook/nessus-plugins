...
# extracted from openSUSE Security Update libsvn_auth_gnome_keyring-1-0-4226.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libsvn_auth_gnome_keyring-1-0 (openSUSE-SU-2011:0238-1)");
  script_summary(english:"Check for the libsvn_auth_gnome_keyring-1-0-4226 patch");
...
(CVE-2011-0715)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-03/msg00030.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"libsvn_auth_gnome_keyring-1-0-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libsvn_auth_gnome_keyring-1-0-debuginfo-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libsvn_auth_kwallet-1-0-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libsvn_auth_kwallet-1-0-debuginfo-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-debuginfo-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-debugsource-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-devel-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-perl-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-perl-debuginfo-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-python-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-python-debuginfo-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-ruby-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-ruby-debuginfo-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-server-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-server-debuginfo-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-tools-1.6.16-1.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"subversion-tools-debuginfo-1.6.16-1.3.1") ) flag++;
