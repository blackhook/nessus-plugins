...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5400");

  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (2020:5400)");
...
SLSA-2020:5400-1 advisory.

  - Mozilla: Stack overflow due to incorrect parsing of SMTP server response codes (CVE-2020-26970)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205400-1");
...
pkgs = [
    {'reference':'thunderbird-78.5.1-1.el7_9', 'cpu':'x86_64', 'release':'SL7', 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-78.5.1-1.el7_9', 'cpu':'x86_64', 'release':'SL7', 'allowmaj':TRUE}
];
