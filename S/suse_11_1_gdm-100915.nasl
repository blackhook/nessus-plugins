...
if ( rpm_check(release:"SUSE11.1", reference:"gdm-2.24.0-15.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"gdm-branding-upstream-2.24.0-15.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"gdm-lang-2.24.0-15.1.1") ) flag++;
