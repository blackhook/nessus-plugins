...
if ( rpm_check(release:"SUSE11.1", reference:"libtheora-devel-1.0.beta2-3.97.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libtheora0-1.0.beta2-3.97.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libtheora0-32bit-1.0.beta2-3.97.1") ) flag++;
