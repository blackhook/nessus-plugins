...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : strongswan (SAT Patch Number 966)");
...
CVE-2009-1957 / CVE-2009-1958 have been assigned to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=507742"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2009-1957.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2009-1958.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 966.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:0, reference:"strongswan-4.2.8-1.23.1")) flag++;
if (rpm_check(release:"SLES11", sp:0, reference:"strongswan-doc-4.2.8-1.23.1")) flag++;
