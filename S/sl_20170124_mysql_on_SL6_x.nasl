...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mysql on SL6.x i386/x86_64 (20170124)");
...
"Security Fix(es) :
  ...
  - A race condition was found in the way MySQL performed
    ...
    mysql system user. (CVE-2016-6663, CVE-2016-5616)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1701&L=scientific-linux-errata&F=&S=&P=11125
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?210fc14a"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"mysql-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-bench-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-debuginfo-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-devel-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-embedded-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-embedded-devel-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-libs-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-server-5.1.73-8.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-test-5.1.73-8.el6_8")) flag++;
