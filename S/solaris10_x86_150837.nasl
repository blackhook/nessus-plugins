...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 150837-01 (deprecated)");
...
150837 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 150837 instead.");
