...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mailx on SL6.x, SL7.x i386/x86_64 (20141216)");
...
command line arguments as email addresses."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:mailx");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:mailx-debuginfo");
