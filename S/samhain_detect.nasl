...
logging and management.");
  script_set_attribute(attribute:"see_also", value:"https://www.la-samhna.de/samhain/");
...
security policy.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:samhain_labs:samhain");
...
usernames = make_list("127.0.0.1", "localhost", get_host_name(), get_host_ip(),
                      compat::this_host(), this_host_name());
