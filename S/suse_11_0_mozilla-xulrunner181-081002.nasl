...
# extracted from openSUSE Security Update mozilla-xulrunner181-237.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mozilla-xulrunner181 (mozilla-xulrunner181-237)");
  script_summary(english:"Check for the mozilla-xulrunner181-237 patch");
...
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-xulrunner181-1.8.1.13-22.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-xulrunner181-devel-1.8.1.13-22.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-xulrunner181-l10n-1.8.1.13-22.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"mozilla-xulrunner181-32bit-1.8.1.13-22.1") ) flag++;
