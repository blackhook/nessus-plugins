...
if(description)
{
 script_id(23082);
 script_version ("1.11");
 name["english"] = "Solaris 2.5.1 (i386) : 106719-01";
...
e +=  solaris_check_patch(release:"5.5.1_x86", arch:"i386", patch:"106719-01", obsoleted_by:"", package:"SICGkeymg", version:"1.1.1,PATCH=1");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
