...
if ( rpm_check(release:"SUSE11.3", reference:"jasper-1.900.1-141.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libjasper-1.900.1-141.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libjasper-devel-1.900.1-141.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libjasper-32bit-1.900.1-141.3.1") ) flag++;
