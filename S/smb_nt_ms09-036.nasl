...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"972591");
  script_xref(name:"MSKB", value:"972592");
...
through IIS 7.0 when operating in integrated mode.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-036");
