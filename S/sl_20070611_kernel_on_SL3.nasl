...
The following security bugs were fixed in this update :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0706&L=scientific-linux-errata&T=0&P=3195
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97f24389"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"kernel-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", cpu:"i386", reference:"kernel-BOOT-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", reference:"kernel-doc-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", cpu:"i386", reference:"kernel-hugemem-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", cpu:"i386", reference:"kernel-hugemem-unsupported-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", reference:"kernel-smp-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", reference:"kernel-smp-unsupported-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", reference:"kernel-source-2.4.21-50.EL")) flag++;
if (rpm_check(release:"SL3", reference:"kernel-unsupported-2.4.21-50.EL")) flag++;
