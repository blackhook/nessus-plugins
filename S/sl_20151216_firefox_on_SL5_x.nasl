...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x i386/x86_64 (20151216)");
...
Firefox must be restarted for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=3046
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b735cc7"
  );
  script_set_attribute(
    attribute:"solution", 
