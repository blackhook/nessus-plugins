...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : pcsc-lite (SAT Patch Number 2670)");
...
been assigned to this issue."
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 2670.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"pcsc-lite-1.4.102-1.31.2")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"pcsc-lite-1.4.102-1.31.2")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"pcsc-lite-32bit-1.4.102-1.31.2")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"pcsc-lite-1.4.102-1.31.2")) flag++;
if (rpm_check(release:"SLES11", sp:1, cpu:"s390x", reference:"pcsc-lite-32bit-1.4.102-1.31.2")) flag++;
if (rpm_check(release:"SLES11", sp:1, cpu:"x86_64", reference:"pcsc-lite-32bit-1.4.102-1.31.2")) flag++;
