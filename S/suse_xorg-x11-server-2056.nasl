...
# extracted from openSUSE Security Update xorg-x11-server-2056.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : xorg-x11-server (xorg-x11-server-2056)");
  script_summary(english:"Check for the xorg-x11-server-2056 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"xorg-x11-server-6.9.0-50.24") ) flag++;
