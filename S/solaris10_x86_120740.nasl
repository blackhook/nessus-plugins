...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 120740-08 (deprecated)");
...
120740 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 120740 instead.");
