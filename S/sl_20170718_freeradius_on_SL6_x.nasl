...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : freeradius on SL6.x i386/x86_64 (20170718)");
...
"Security Fix(es) :
  ...
  - An out-of-bounds write flaw was found in the way
    ...
    a specially crafted request packet. (CVE-2017-10979)
  ...
  - Multiple memory leak flaws were found in the way
    FreeRADIUS server handled decoding of DHCP packets. A
    remote attacker could use these flaws to cause the
    FreeRADIUS server to consume an increasing amount of
    memory resources over time, possibly leading to a crash
    due to memory exhaustion, by sending specially crafted
    DHCP packets. (CVE-2017-10980, CVE-2017-10981)
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1707&L=scientific-linux-errata&F=&S=&P=7151
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ece659f3"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"freeradius-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-debuginfo-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-krb5-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-ldap-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-mysql-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-perl-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-postgresql-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-python-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-unixODBC-2.2.6-7.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"freeradius-utils-2.2.6-7.el6_9")) flag++;
