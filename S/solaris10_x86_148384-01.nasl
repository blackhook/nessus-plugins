...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 148384-01");
  script_summary(english:"Check for patch 148384-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 148384-01"
  );
  script_set_attribute(
...
IPv6."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 148384-01 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-0405");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:124445");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:148384");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"148384-01", obsoleted_by:"", package:"SUNWcslr", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"148384-01", obsoleted_by:"", package:"SUNWhea", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
