...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : pidgin on SL5.x, SL6.x i386/x86_64 (20140205)");
...
Pidgin must be restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1402&L=scientific-linux-errata&T=0&P=955
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d5317cb"
  );
