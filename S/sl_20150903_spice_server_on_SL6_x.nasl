...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : spice-server on SL6.x x86_64 (20150903)");
...
process. (CVE-2015-3247)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a8c94532"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"spice-server-0.12.4-12.el6_7.1")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"spice-server-debuginfo-0.12.4-12.el6_7.1")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"spice-server-devel-0.12.4-12.el6_7.1")) flag++;
