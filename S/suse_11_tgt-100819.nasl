...
if (description)
{
  ...
  script_name(english:"SuSE 11 / 11.1 Security Update : tgt (SAT Patch Numbers 2958 / 2959)");
...
vulnerability :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Apply SAT patch number 2958 / 2959 as appropriate."
  );
...
flag = 0;
if (rpm_check(release:"SLES11", sp:0, reference:"tgt-0.9.0-1.27.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"tgt-0.9.10-0.6.1")) flag++;
