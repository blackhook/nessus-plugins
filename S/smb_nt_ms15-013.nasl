...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2910941");
  script_xref(name:"MSKB", value:"2920748");
  script_xref(name:"MSKB", value:"2920795");
  script_xref(name:"MSKB", value:"3033857");
...
to more easily exploit additional vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-013");
