...
# extracted from Slackware Security Advisory SSA:2022-271-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 xorg-server-xwayland  Multiple Vulnerabilities (SSA:2022-271-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to xorg-server-xwayland.");
  script_set_attribute(attribute:"description", value:
"The version of xorg-server-xwayland installed on the remote host is prior to 21.1.4. It is, therefore, affected by
multiple vulnerabilities as referenced in the SSA:2022-271-01 advisory.
...
"Upgrade the affected xorg-server-xwayland package.");
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '21.1.4', 'product' : 'xorg-server-xwayland', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '2_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '21.1.4', 'product' : 'xorg-server-xwayland', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '2_slack15.0', 'arch' : 'x86_64' }
];
