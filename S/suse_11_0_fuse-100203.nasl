...
if ( rpm_check(release:"SUSE11.0", reference:"fuse-2.7.2-32.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"fuse-devel-2.7.2-32.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libfuse2-2.7.2-32.2") ) flag++;
