...
# extracted from openSUSE Security Update java-1_6_0-openjdk-5329.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : java-1_6_0-openjdk (java-1_6_0-openjdk-5329) (BEAST)");

  script_set_attribute(attribute:"synopsis", value:
"The remote openSUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"Oracle/Sun OpenJDK 1.6.0 was updated to the 1.10.4release, fixing lots
...
for more details.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=725167");
...
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-debuginfo-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-debugsource-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-demo-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-devel-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-devel-debuginfo-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-javadoc-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"java-1_6_0-openjdk-src-1.6.0.0_b22.1.10.4-0.3.2") ) flag++;
