...
if (description)
{
  ...
  script_name(english:"Solaris 8 (x86) : 150509-01");
  script_summary(english:"Check for patch 150509-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 150509-01"
  );
  script_set_attribute(
...
denial of service (partial DOS) of Solaris."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/150509-01"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"150509-01", obsoleted_by:"", package:"SUNWcsu", version:"11.8.0,REV=2000.01.08.18.17") < 0) flag++;
