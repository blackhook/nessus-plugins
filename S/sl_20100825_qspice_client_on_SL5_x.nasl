...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qspice-client on SL5.x i386/x86_64");
...
several dependencies for i386 going out with this errata."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1008&L=scientific-linux-errata&T=0&P=2508
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80253777"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"qspice-client-0.3.0-4.el5_5")) flag++;
