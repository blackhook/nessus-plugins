...
# extracted from openSUSE Security Update libxml2-6405.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libxml2 (libxml2-6405)");
  script_summary(english:"Check for the libxml2-6405 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libxml2-2.6.30-4.13") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libxml2-devel-2.6.30-4.13") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libxml2-32bit-2.6.30-4.13") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libxml2-devel-32bit-2.6.30-4.13") ) flag++;
