...
if ( rpm_check(release:"SUSE11.0", reference:"libfreebl3-3.12.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-nss-3.12.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-nss-devel-3.12.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"mozilla-nss-tools-3.12.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libfreebl3-32bit-3.12.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"mozilla-nss-32bit-3.12.6-3.1") ) flag++;
