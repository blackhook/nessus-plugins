...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3011140");
  script_xref(name:"MSKB", value:"2986475");
  script_xref(name:"MSKB", value:"2996150");
...
affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-075");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Exchange 2007 SP3, 2010
SP3, and 2013 SP1 / CU6.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-6319");
