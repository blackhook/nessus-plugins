...
corresponds to the /net entry in the default configuration."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0712&L=scientific-linux-errata&T=0&P=1771
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?039b93cf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"autofs-5.0.1-0.rc2.55.el5.1")) flag++;
