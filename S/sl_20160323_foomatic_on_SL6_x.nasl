...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : foomatic on SL6.x i386/x86_64 (20160323)");
...
to execute arbitrary commands. (CVE-2015-8327, CVE-2015-8560)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1603&L=scientific-linux-errata&F=&S=&P=12966
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6a43e52b"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:foomatic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:foomatic-debuginfo");
...
flag = 0;
if (rpm_check(release:"SL6", reference:"foomatic-4.0.4-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"foomatic-debuginfo-4.0.4-5.el6_7")) flag++;
