...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : postfix on SL6.x i386/x86_64");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1104&L=scientific-linux-errata&T=0&P=946
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ee0bafb1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected postfix and / or postfix-perl-scripts packages."
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"postfix-2.6.6-2.1.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"postfix-perl-scripts-2.6.6-2.1.el6_0")) flag++;
