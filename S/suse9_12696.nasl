...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : dhcpcd (YOU Patch Number 12696)");
...
needs to sanitize the host name offered by the server. (CVE-2011-0996)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12696.");
...
flag = 0;
if (rpm_check(release:"SUSE9", cpu:"i586", reference:"dhcpcd-1.3.22pl4-193.17")) flag++;
