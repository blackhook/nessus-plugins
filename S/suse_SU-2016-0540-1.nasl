...
# extracted from SUSE update advisory SUSE-SU-2016:0540-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : dhcp (SUSE-SU-2016:0540-1)");
...
The following bugs were fixed :
  ...
  - bsc#912098: dhclient could pretend to run while silently
    declining leases

  - bsc#919959: server: Do not log success report before
  ...
  - bsc#910686: Prevent a dependency conflict of dhcp-devel
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=891961"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=910686"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=912098"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=956159"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=960506"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160540-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?37ae680c"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-client-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-client-debuginfo-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-debuginfo-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-debugsource-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-relay-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-relay-debuginfo-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-server-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"dhcp-server-debuginfo-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dhcp-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dhcp-client-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dhcp-client-debuginfo-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dhcp-debuginfo-4.2.6-14.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"dhcp-debugsource-4.2.6-14.3.1")) flag++;
