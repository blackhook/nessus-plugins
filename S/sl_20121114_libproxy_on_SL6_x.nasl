...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libproxy on SL6.x i386/x86_64 (20121114)");
...
take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1211&L=scientific-linux-errata&T=0&P=1572
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83782d97"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libproxy-0.3.0-3.el6_3")) flag++;
if (rpm_check(release:"SL6", reference:"libproxy-bin-0.3.0-3.el6_3")) flag++;
if (rpm_check(release:"SL6", reference:"libproxy-devel-0.3.0-3.el6_3")) flag++;
if (rpm_check(release:"SL6", reference:"libproxy-gnome-0.3.0-3.el6_3")) flag++;
if (rpm_check(release:"SL6", reference:"libproxy-kde-0.3.0-3.el6_3")) flag++;
if (rpm_check(release:"SL6", reference:"libproxy-mozjs-0.3.0-3.el6_3")) flag++;
if (rpm_check(release:"SL6", reference:"libproxy-python-0.3.0-3.el6_3")) flag++;
if (rpm_check(release:"SL6", reference:"libproxy-webkit-0.3.0-3.el6_3")) flag++;
