...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sudo on SL6.x, SL7.x i386/x86_64 (20170623)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1706&L=scientific-linux-errata&F=&S=&P=5804
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?279b944c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"sudo-1.8.6p3-29.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"sudo-debuginfo-1.8.6p3-29.el6_9")) flag++;
if (rpm_check(release:"SL6", reference:"sudo-devel-1.8.6p3-29.el6_9")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sudo-1.8.6p7-23.el7_3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sudo-debuginfo-1.8.6p7-23.el7_3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"sudo-devel-1.8.6p7-23.el7_3")) flag++;
