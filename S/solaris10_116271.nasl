...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 116271-10 (deprecated)");
...
116271 patch-revision plugins, or deemed non-security related."
  );
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 116271 instead.");
