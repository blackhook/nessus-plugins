...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : wpa_supplicant on SL7.x x86_64 (20150611)");
...
restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b9878b1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"wpa_supplicant-2.0-17.el7_1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"wpa_supplicant-debuginfo-2.0-17.el7_1")) flag++;
