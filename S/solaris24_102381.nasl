...
if(description)
{
 ...
 script_name(english: "Solaris 5.4 (sparc) : 102381-01");
...
e +=  solaris_check_patch(release:"5.4", arch:"sparc", patch:"102381-01", obsoleted_by:"", package:"SUNWlicsw", version:"2.0");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
