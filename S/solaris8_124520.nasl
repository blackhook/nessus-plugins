...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 124520-05");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"124520-05", obsoleted_by:"", package:"SUNWsgeex", version:"6.0,REV=2004.06.03.16.00") < 0) flag++;
