...
the SUSE-SU-2022:0504-1 advisory.
...
var pkgs = [
    {'reference':'wpa_supplicant-2.9-23.15.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']}
];
