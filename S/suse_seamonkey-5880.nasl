...
# extracted from openSUSE Security Update seamonkey-5880.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : seamonkey (seamonkey-5880)");
  script_summary(english:"Check for the seamonkey-5880 patch");
  ...
  script_set_attribute(
    ...
    value:
"The Mozilla SeaMonkey browser suite was updated to version 1.1.14.
...
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-1.1.14-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-dom-inspector-1.1.14-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-irc-1.1.14-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-mail-1.1.14-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-spellchecker-1.1.14-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-venkman-1.1.14-1.1") ) flag++;
