...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Acrobat Reader (ZYPP Patch Number 6331)");
...
"This update of acroread fixes the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6331.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"acroread-8.1.6-0.3")) flag++;
