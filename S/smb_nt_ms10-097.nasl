...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2010-B-0113-S");
  script_xref(name:"MSFT", value:"MS10-097");
  script_xref(name:"MSKB", value:"2443105");
...
to the user's privileges.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?eb7b3f50");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3144");
