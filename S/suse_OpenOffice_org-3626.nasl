...
# extracted from openSUSE Security Update OpenOffice_org-3626.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : OpenOffice_org (OpenOffice_org-3626)");
  script_summary(english:"Check for the OpenOffice_org-3626 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-af-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ar-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ca-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-cs-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-da-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-de-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-de-templates-8.2-171.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-es-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-fi-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-fr-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-galleries-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-gnome-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-gu-IN-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-hi-IN-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-hu-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-it-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ja-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-kde-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-mono-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-nb-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-nl-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-nn-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-officebean-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-pl-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-pt-BR-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ru-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-sk-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-sv-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-xh-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-zh-CN-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-zh-TW-2.0.4-38.2.5") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-zu-2.0.4-38.2.5") ) flag++;
