...
# extracted from openSUSE Security Update imp-313.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : imp (imp-313)");
  script_summary(english:"Check for the imp-313 patch");
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=430547"
  );
...
if ( rpm_check(release:"SUSE11.0", reference:"imp-4.1.4-70.2") ) flag++;
