...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS13-062");
  script_xref(name:"MSKB", value:"2849470");
  script_xref(name:"IAVA", value:"2013-A-0163");

  script_name(english:"MS13-062: Vulnerability in Remote Procedure Call Could Allow Elevation of Privilege (2849470)");
...
complete control of an affected system."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-062");
  script_set_attribute(
    attribute:"solution",
    value:
