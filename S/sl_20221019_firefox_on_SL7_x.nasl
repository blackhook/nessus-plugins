...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:6997");
  script_xref(name:"IAVA", value:"2022-A-0491-S");

  script_name(english:"Scientific Linux Security Update : firefox on SL7.x i686/x86_64 (2022:6997)");
...
SLSA-2022:6997-1 advisory.

  - expat: a use-after-free in the doContent function in xmlparse.c (CVE-2022-40674)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20226997-1");
...
var pkgs = [
    {'reference':'firefox-102.3.0-7.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.3.0-7.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-debuginfo-102.3.0-7.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-debuginfo-102.3.0-7.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
