...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2475792");
...
into visiting a specially crafted website.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-009");
