...
# extracted from openSUSE Security Update pcre-4697.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : pcre (pcre-4697)");
  script_summary(english:"Check for the pcre-4697 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"pcre-6.7-23") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"pcre-devel-6.7-23") ) flag++;
if ( rpm_check(release:"SUSE10.2", cpu:"x86_64", reference:"pcre-32bit-6.7-23") ) flag++;
