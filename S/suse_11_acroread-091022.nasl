...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : Acrobat Reader (SAT Patch Number 1425)");
...
CVE-2009-3458 / CVE-2009-3459 / CVE-2009-3462)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 1425.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:0, cpu:"i586", reference:"acroread-8.1.7-0.1.1")) flag++;
