...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 123039-01");
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"123039-01", obsoleted_by:"124521-01 ", package:"SUNWsgeei", version:"6.0,REV=2004.06.03.16.00") < 0) flag++;
