...
if ( rpm_check(release:"SUSE11.3", reference:"postfix-2.7.1-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"postfix-devel-2.7.1-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"postfix-mysql-2.7.1-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"postfix-postgresql-2.7.1-2.6.1") ) flag++;
