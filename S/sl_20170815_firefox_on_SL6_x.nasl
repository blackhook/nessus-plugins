...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL6.x, SL7.x i386/x86_64 (20170815)");
...
Security Fix(es) :
  ...
  - Multiple flaws were found in the processing of malformed
    ...
    Firefox. (CVE-2017-7779, CVE-2017-7798, CVE-2017-7800,
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9e273ab3"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-52.3.0-3.el6_9", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-52.3.0-3.el6_9", allowmaj:TRUE)) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-52.3.0-2.el7_4", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-52.3.0-2.el7_4", allowmaj:TRUE)) flag++;
