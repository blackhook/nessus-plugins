...
# extracted from openSUSE Security Update gnome-screensaver-2152.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gnome-screensaver (gnome-screensaver-2152)");
  script_summary(english:"Check for the gnome-screensaver-2152 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"gnome-screensaver-2.24.0-7.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"gnome-screensaver-lang-2.24.0-7.10.1") ) flag++;
