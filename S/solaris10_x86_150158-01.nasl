...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 150158-01");
  script_summary(english:"Check for patch 150158-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 150158-01"
  );
  script_set_attribute(
...
denial of service (partial DOS) of Solaris."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/150158-01"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 150158-01 or higher");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-5821");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:150158");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"150158-01", obsoleted_by:"", package:"SUNWrcmds", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
