...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2011-0216-denial-of-service-dos-vulnerability-in-libxml2"
  );
  # https://blogs.oracle.com/sunsecurity/cve-2011-3102-numeric-errors-vulnerability-in-libxml2
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22b5c925"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2012-0841-denial-of-service-dos-vulnerability-in-libxml2"
  );
  # https://blogs.oracle.com/sunsecurity/multiple-denial-of-service-dos-vulnerabilities-in-libxml2
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?54a8db0e"
  );
  # https://blogs.oracle.com/sunsecurity/multiple-denial-of-service-dos-vulnerabilities-in-libxml2
  script_set_attribute(
    attribute:"see_also",
