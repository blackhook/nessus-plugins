...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3071088");
  script_xref(name:"MSKB", value:"3071089");
  script_xref(name:"MSKB", value:"3064919");
  script_xref(name:"IAVA", value:"2015-A-0191-S");
...
arbitrary script code execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?0a1edcc0");
