...
# extracted from SUSE update advisory SUSE-SU-2018:3074-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : postgresql10 (SUSE-SU-2018:3074-2)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20183074-2/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?82a7d230"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
SUSE-SLE-SERVER-12-SP2-BCL-2018-2176=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libecpg6-10.5-1.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libecpg6-debuginfo-10.5-1.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libpq5-10.5-1.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libpq5-32bit-10.5-1.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libpq5-debuginfo-10.5-1.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"libpq5-debuginfo-32bit-10.5-1.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-10.5-1.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-contrib-10.5-1.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-contrib-debuginfo-10.5-1.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-debuginfo-10.5-1.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-debugsource-10.5-1.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-libs-debugsource-10.5-1.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-server-10.5-1.3.2")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"postgresql10-server-debuginfo-10.5-1.3.2")) flag++;
