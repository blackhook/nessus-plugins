...
if (description)
{
  ...
  script_cve_id("CVE-2013-5862", "CVE-2014-0447", "CVE-2014-6473", "CVE-2018-2710", "CVE-2018-2717");
  script_bugtraq_id(63072, 66826, 70546);

  script_name(english:"Solaris 10 (sparc) : 150400-59 (deprecated)");
...
150400 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 150400 instead.");
