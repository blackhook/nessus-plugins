...
# extracted from openSUSE Security Update cups-6565.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : cups (cups-6565)");
  script_summary(english:"Check for the cups-6565 patch");
...
pdftops filter when printing such a document (CVE-2009-3608,
CVE-2009-3609)"
  );
...
if ( rpm_check(release:"SUSE10.3", reference:"cups-1.2.12-22.26") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cups-client-1.2.12-22.26") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cups-devel-1.2.12-22.26") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cups-libs-1.2.12-22.26") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cups-libs-32bit-1.2.12-22.26") ) flag++;
