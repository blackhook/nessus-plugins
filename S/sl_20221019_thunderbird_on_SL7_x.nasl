...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:6998");

  script_name(english:"Scientific Linux Security Update : thunderbird on SL7.x x86_64 (2022:6998)");
...
SLSA-2022:6998-1 advisory.

  - expat: a use-after-free in the doContent function in xmlparse.c (CVE-2022-40674)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20226998-1");
...
var pkgs = [
    {'reference':'thunderbird-102.3.0-4.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-102.3.0-4.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
