...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libvirt on SL6.x i386/x86_64 (20180104) (Spectre)");
...
Note: This is the libvirt side of the CVE-2017-5715 mitigation."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5179ad17"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libvirt-0.10.2-62.el6_9.1")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-client-0.10.2-62.el6_9.1")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-debuginfo-0.10.2-62.el6_9.1")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-devel-0.10.2-62.el6_9.1")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"libvirt-lock-sanlock-0.10.2-62.el6_9.1")) flag++;
if (rpm_check(release:"SL6", reference:"libvirt-python-0.10.2-62.el6_9.1")) flag++;
