...
if(description)
{
 ...
 script_name(english: "Solaris 5.9 (sparc) : 137185-12");
...
e +=  solaris_check_patch(release:"5.9", arch:"sparc", patch:"137185-12", obsoleted_by:"", package:"SUNWspsc1", version:"6.0,REV=2007.07.23.16.19");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
