...
if ( rpm_check(release:"SUSE11.0", reference:"cyrus-imapd-2.3.11-31.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"cyrus-imapd-devel-2.3.11-31.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"perl-Cyrus-IMAP-2.3.11-31.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"perl-Cyrus-SIEVE-managesieve-2.3.11-31.4") ) flag++;
