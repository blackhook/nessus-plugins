...
# extracted from openSUSE Security Update MozillaThunderbird-3378.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird (MozillaThunderbird-3378)");
  script_summary(english:"Check for the MozillaThunderbird-3378 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update brings Mozilla Thunderbird to version 3.0.9, fixing
...
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-3.0.9-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-devel-3.0.9-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-translations-common-3.0.9-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-translations-other-3.0.9-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"enigmail-1.0.1-2.3.1") ) flag++;
