...
# extracted from SUSE update advisory SUSE-SU-2016:0390-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : java-1_8_0-ibm (SUSE-SU-2016:0390-1) (SLOTH)");
  ...
  script_set_attribute(
    ...
    value:
"This update for java-1_8_0-ibm fixes the following security issues by
updating to 8.0-2.10 (bsc#963937) :
  ...
  - CVE-2016-0475: An unspecified vulnerability related to
    the Libraries component has partial confidentiality
    impact, partial integrity impact, and no availability
    impact
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c0f5db81"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch SUSE-SLE-SDK-12-SP1-2016-227=1

SUSE Linux Enterprise Server 12-SP1 :

zypper in -t patch SUSE-SLE-SERVER-12-SP1-2016-227=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"java-1_8_0-ibm-alsa-1.8.0_sr2.10-7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"java-1_8_0-ibm-plugin-1.8.0_sr2.10-7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"java-1_8_0-ibm-1.8.0_sr2.10-7.1")) flag++;
