...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : libwmf (ZYPP Patch Number 1833)");
...
This issue is tracked by the Mitre CVE ID CVE-2006-3376."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2006-3376.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 1833.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:0, reference:"libwmf-0.2.8.2-110.5")) flag++;
