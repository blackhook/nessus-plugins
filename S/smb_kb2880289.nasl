...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2880289");
...
Flash ActiveX control, which could lead to code execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2880289/microsoft-security-advisory-update-for-vulnerabilities-in-adobe-flash");
  script_set_attribute(attribute:"solution", value:
"Install Microsoft KB2880289.");
