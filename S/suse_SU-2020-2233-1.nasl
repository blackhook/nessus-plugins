...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1171946"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1172052"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1174458"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-14339/"
  );
  # https://www.suse.com/support/update/announcement/2020/suse-su-20202233-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4333dbb5"
  );
  script_set_attribute(
    attribute:"solution",
    value:
