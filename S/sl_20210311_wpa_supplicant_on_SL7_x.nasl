...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:0808");

  script_name(english:"Scientific Linux Security Update : wpa_supplicant on SL7.x x86_64 (2021:0808)");
...
SLSA-2021:0808-1 advisory.

  - wpa_supplicant: Use-after-free in P2P provision discovery processing (CVE-2021-27803)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20210808-1");
...
pkgs = [
    {'reference':'wpa_supplicant-2.6-12.el7_9.2', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'wpa_supplicant-debuginfo-2.6-12.el7_9.2', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
