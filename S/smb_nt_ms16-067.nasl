...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3155784");
...
mounted USB disk.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-067");
...
and 2012 R2.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0190");
