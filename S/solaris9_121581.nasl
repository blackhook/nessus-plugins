...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 121581-20");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"121581-20", obsoleted_by:"", package:"SUNWcomic", version:"1.0,REV=2003.10.29") < 0) flag++;
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"121581-20", obsoleted_by:"", package:"SUNWcomis", version:"1.0,REV=2003.10.29") < 0) flag++;
