...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : netpbm (YOU Patch Number 12588)");
...
(AV:N/AC:M/Au:N/C:N/I:P/A:P): Buffer Errors (CWE-119))"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12588.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"libnetpbm-1.0.0-618.18")) flag++;
if (rpm_check(release:"SUSE9", reference:"netpbm-10.11.4-172.18")) flag++;
