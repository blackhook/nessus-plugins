...
if (description)
{
  ...
  script_name(english:"Microsoft Windows Server Version 1909 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:
"The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows Server version 1909 is running on the remote host.
Microsoft ended support for Windows Server version 1909 on May 11, 2021.
...
product_name  = "Windows Server version 1909";
tag           = "microsoft:windows_server_1909";
cpe_ver       = "-:*";
...
# Not Windows Server version 1909
