...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : flash-player (ZYPP Patch Number 7518)");
...
http://www.adobe.com/support/security/bulletins/apsb11-12.html"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7518.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"flash-player-10.3.181.14-0.5.1")) flag++;
