...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4465664");
  script_xref(name:"MSFT", value:"MS18-4465664");

  script_name(english:"KB4465664 BitLocker Security Feature Bypass Vulnerability");
  script_summary(english:"Checks for rollup.");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4465664.
It is, therefore, affected by multiple vulnerabilities :
  ...
  # https://support.microsoft.com/en-us/help/4465664/servicing-stack-update-for-windows-10
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9e993999");
  script_set_attribute(attribute:"solution", value:
"Apply Service Stack Update KB4465664.");
...
if (
  hotfix_is_vulnerable(os:"10", sp:0, os_build:"17763", file:"Cmifw.dll", version:"10.0.17763.1", min_version:"10.0.17763.0", dir:"\system32", bulletin:bulletin, kb:"4465664")
)
{
