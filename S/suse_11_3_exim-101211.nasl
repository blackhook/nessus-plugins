...
if ( rpm_check(release:"SUSE11.3", reference:"exim-4.71-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"eximon-4.71-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"eximstats-html-4.71-4.3.1") ) flag++;
