...
# extracted from SUSE update advisory SUSE-SU-2016:2302-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : gd (SUSE-SU-2016:2302-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162302-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b7f0af1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"gd-2.0.36.RC1-52.22.1")) flag++;
