...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tomcat6 on SL6.x (noarch) (20130620)");
...
Tomcat must be restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1306&L=scientific-linux-errata&T=0&P=1723
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ce46f255"
  );
