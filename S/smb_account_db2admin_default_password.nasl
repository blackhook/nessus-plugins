...
if the 'db2admin' account exists from a previous installation.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2000/Dec/97");
...
"Assign a different password to this account as soon as possible.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:ibm:db2_universal_database");
