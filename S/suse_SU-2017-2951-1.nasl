...
# extracted from SUSE update advisory SUSE-SU-2017:2951-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : perl (SUSE-SU-2017:2951-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?34edcc1f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-perl-13339=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-perl-13339=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"perl-32bit-5.10.0-64.81.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"perl-32bit-5.10.0-64.81.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-5.10.0-64.81.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-Module-Build-0.2808.01-0.81.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-Test-Simple-0.72-0.81.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-base-5.10.0-64.81.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"perl-doc-5.10.0-64.81.3.1")) flag++;
