...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 18 for SLE 15) (SUSE-SU-2021:2060-1)");
...
referenced in the SUSE-SU-2021:2060-1 advisory.
...
"Update the affected kernel-livepatch-4_12_14-150_52-default, kgraft-patch-4_4_180-94_124-default and / or kgraft-
patch-4_4_180-94_135-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-4_12_14-150_52-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-150.52-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150_52-default-11-2.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15', 'SLE_HPC-release-15', 'sle-module-live-patching-release-15', 'sles-release-15']}
        ]
      },
      '4.4.180-94.124-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_124-default-11-2.3', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      },
      '4.4.180-94.135-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_135-default-8-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-150_52-default / etc');
}
