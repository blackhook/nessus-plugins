...
the SUSE-SU-2023:1740-3 advisory.
...
var pkgs = [
    {'reference':'libyaml-cpp0_6-0.6.1-4.5.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
    {'reference':'yaml-cpp-devel-0.6.1-4.5.1', 'sp':'2', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2']},
