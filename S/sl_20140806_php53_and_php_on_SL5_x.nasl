...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : php53 and php on SL5.x, SL6.x i386/x86_64 (20140806)");
...
the user running that PHP application. (CVE-2014-3515)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1408&L=scientific-linux-errata&T=0&P=440
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b645fee7"
  );
