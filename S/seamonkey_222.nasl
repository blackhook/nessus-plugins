...
if (description)
{
  ...
  script_name(english:"SeaMonkey < 2.22 Multiple Vulnerabilities");
...
"The installed version of SeaMonkey is earlier than 2.22 and is,
...
mozilla_check_version(installs:installs, product:'seamonkey', fix:'2.22', severity:SECURITY_HOLE, xss:FALSE);
