...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libtiff on SL4.x i386/x86_64");
...
This update also fixes the following bug :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1103&L=scientific-linux-errata&T=0&P=10908
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4abc9afe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"libtiff-3.6.1-18.el4")) flag++;
if (rpm_check(release:"SL4", reference:"libtiff-devel-3.6.1-18.el4")) flag++;
