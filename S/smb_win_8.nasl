...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0027");
...
investigate or acknowledge reports of vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/18581/lifecycle-faq-windows-products");
