...
if(description)
{
 ...
 script_name(english: "Solaris 5.6 (sparc) : 113201-05");
...
e +=  solaris_check_patch(release:"5.6", arch:"sparc", patch:"113201-05", obsoleted_by:"", package:"VRTSvxvm", version:"3.2,REV=08.15.2001.23.27");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
