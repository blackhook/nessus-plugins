...
# extracted from openSUSE Security Update bluez-audio-802.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bluez-audio (bluez-audio-802)");
  script_summary(english:"Check for the bluez-audio-802 patch");
...
The previous bluez update caused problems with the bluez passkey
agent. This second update fixes this."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.0", reference:"bluez-audio-3.32-8.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"bluez-cups-3.32-8.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"bluez-test-3.32-8.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"bluez-utils-3.32-8.7") ) flag++;
