...
referenced in the SUSE-SU-2021:4119-1 advisory.
...
var pkgs = [
    {'reference':'xorg-x11-server-1.19.6-10.29.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-12.5'},
    {'reference':'xorg-x11-server-extra-1.19.6-10.29.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-12.5'},
