...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : libmikmod (ZYPP Patch Number 7004)");
...
linking against libmikmod. (CVE-2009-3995 / CVE-2009-3996)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7004.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"libmikmod-3.1.11-14.10.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, cpu:"x86_64", reference:"libmikmod-32bit-3.1.11-14.10.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"libmikmod-3.1.11-14.10.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"libmikmod-32bit-3.1.11-14.10.1")) flag++;
