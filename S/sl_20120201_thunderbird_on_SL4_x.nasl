...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL4.x, SL5.x i386/x86_64 (20120201)");
...
restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=308
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?af7ff37d"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL4", reference:"thunderbird-1.5.0.12-46.el4")) flag++;
if (rpm_check(release:"SL4", reference:"thunderbird-debuginfo-1.5.0.12-46.el4")) flag++;

if (rpm_check(release:"SL5", reference:"thunderbird-2.0.0.24-28.el5_7")) flag++;
if (rpm_check(release:"SL5", reference:"thunderbird-debuginfo-2.0.0.24-28.el5_7")) flag++;
