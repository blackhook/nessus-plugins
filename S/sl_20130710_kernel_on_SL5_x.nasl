...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kernel on SL5.x i386/x86_64 (20130710)");
...
The system must be rebooted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1307&L=scientific-linux-errata&T=0&P=707
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd1dc6a6"
  );
