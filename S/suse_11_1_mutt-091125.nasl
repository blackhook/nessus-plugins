...
# extracted from openSUSE Security Update mutt-1608.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mutt (mutt-1608)");
  script_summary(english:"Check for the mutt-1608 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"mutt-1.5.17-42.114.1") ) flag++;
