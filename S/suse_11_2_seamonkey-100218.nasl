...
# extracted from openSUSE Security Update seamonkey-2013.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : seamonkey (seamonkey-2013)");
  script_summary(english:"Check for the seamonkey-2013 patch");
  ...
  script_set_attribute(
    ...
    value:
"Mozilla SeaMonkey was upgraded to version 2.0.3, fixing various bugs
and security issues.
...
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-2.0.3-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-dom-inspector-2.0.3-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-irc-2.0.3-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"seamonkey-venkman-2.0.3-0.1.1") ) flag++;
