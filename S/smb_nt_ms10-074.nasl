...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2010-B-0091-S");
...
Note that an exploit involving PowerZip has been published."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?88021359");
  script_set_attribute(
    attribute:"solution",
    value:
...
2008, 7, and 2008 R2."
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3227");
