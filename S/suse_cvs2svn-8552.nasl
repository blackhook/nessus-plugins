...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : subversion (ZYPP Patch Number 8552)");
...
/ CVE-2013-1845)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8552.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"subversion-1.3.1-1.22.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"subversion-devel-1.3.1-1.22.1")) flag++;
