...
if (description)
{
  ...
  script_name(english:"Solaris 7 (sparc) : 116271-10");
  script_summary(english:"Check for patch 116271-10");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 116271-10");
  script_set_attribute(attribute:"description", value:
"NetBackup 5.1 Product Patch MP7. Date this patch was last updated by
Sun : Apr/23/08");
...
if (solaris_check_patch(release:"5.7", arch:"sparc", patch:"116271-10", obsoleted_by:"", package:"VRTSnetbp", version:"5.1,REV=2004.05.11.17.55") < 0) flag++;
