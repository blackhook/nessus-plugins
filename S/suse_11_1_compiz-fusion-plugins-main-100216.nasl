...
if ( rpm_check(release:"SUSE11.1", reference:"compiz-fusion-plugins-main-0.7.8-4.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"compiz-fusion-plugins-main-devel-0.7.8-4.17.1") ) flag++;
