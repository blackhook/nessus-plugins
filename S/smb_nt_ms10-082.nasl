...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2378111");
...
a maliciously crafted web page."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-082");
  script_set_attribute(
    attribute:"solution",
    value:
