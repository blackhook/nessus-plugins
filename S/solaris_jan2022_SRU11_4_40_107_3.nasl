...
if (description)
{
  ...
  script_cve_id("CVE-2022-21375");
  script_xref(name:"IAVA", value:"2022-A-0038");

  script_name(english:"Oracle Solaris Critical Patch Update : jan2022_SRU11_4_40_107_3");
...
security update :
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-21375");
...
fix_release = "11.4-11.4.40.0.1.107.3";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.40.0.1.107.3", sru:"11.4.40.107.3") > 0) flag++;
