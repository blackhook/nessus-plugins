...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"979365");
...
specially crafted Visio file, resulting in arbitrary code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-028");
  script_set_attribute(
    attribute:"solution",
    value:
