...
if ( rpm_check(release:"SUSE11.0", reference:"libtheora-devel-1.0.beta2-4.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libtheora0-1.0.beta2-4.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libtheora0-32bit-1.0.beta2-4.2") ) flag++;
