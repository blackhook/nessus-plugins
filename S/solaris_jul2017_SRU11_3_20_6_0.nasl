...
if (description)
{
  ...
  script_cve_id("CVE-2017-10095");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2017_SRU11_3_20_6_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    ...
    to some of Solaris accessible data. (CVE-2017-10095)"
  );
  script_set_attribute(
    attribute:"see_also",
...
fix_release = "0.5.11-0.175.3.20.0.6.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.20.0.6.0", sru:"11.3.20.6.0") > 0) flag++;
