...
# extracted from openSUSE Security Update libxml-1278.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxml (libxml-1278)");
  script_summary(english:"Check for the libxml-1278 patch");
...
was fixed while parsing the root XML document. (CVE-2009-2414)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=530661"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"libxml-1.8.17-480.52.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libxml-devel-1.8.17-480.52.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libxml-32bit-1.8.17-480.52.2") ) flag++;
