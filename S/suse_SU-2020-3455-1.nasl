...
# extracted from SUSE update advisory SUSE-SU-2020:3455-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : postgresql10 (SUSE-SU-2020:3455-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20203455-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?32efd8a1");
...
zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-2020-3455=1

SUSE Linux Enterprise Server 15-LTSS :

zypper in -t patch SUSE-SLE-Product-SLES-15-2020-3455=1

SUSE Linux Enterprise High Performance Computing 15-LTSS :

zypper in -t patch SUSE-SLE-Product-HPC-15-2020-3455=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libecpg6-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libecpg6-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libpq5-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"libpq5-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-contrib-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-contrib-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-debugsource-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-devel-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-devel-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plperl-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plperl-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plpython-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-plpython-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-pltcl-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-pltcl-debuginfo-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-server-10.15-4.28.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"postgresql10-server-debuginfo-10.15-4.28.1")) flag++;
