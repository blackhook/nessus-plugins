...
the SUSE-SU-2023:0374-1 advisory.
...
var pkgs = [
    {'reference':'xrdp-0.9.10-3.8.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']}
];
