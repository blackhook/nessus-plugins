...
# extracted from SUSE update advisory SUSE-SU-2018:0571-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 Security Update : puppet (SUSE-SU-2018:0571-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1080288"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2017-10689/"
  );
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180571-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dba1c898"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
in -t patch SUSE-SLE-Module-Adv-Systems-Management-12-2018-379=1

SUSE Linux Enterprise Desktop 12-SP3:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP3-2018-379=1

SUSE Linux Enterprise Desktop 12-SP2:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP2-2018-379=1
...
flag = 0;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"puppet-3.8.5-15.9.1")) flag++;
if (rpm_check(release:"SLED12", sp:"2", cpu:"x86_64", reference:"puppet-3.8.5-15.9.1")) flag++;
