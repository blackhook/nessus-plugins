...
relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.samba.org/samba/history/samba-4.1.8.html");
  # https://download.samba.org/pub/samba/patches/security/samba-4.1.7-CVE-2014-0178-CVE-2014-0239.patch
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?76cdeddb");
