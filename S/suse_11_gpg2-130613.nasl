...
flag = 0;
if (rpm_check(release:"SLES11", sp:3, cpu:"s390x", reference:"gpg2-2.0.9-25.33.33.5")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"s390x", reference:"gpg2-lang-2.0.9-25.33.33.5")) flag++;
