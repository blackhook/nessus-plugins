...
if ( rpm_check(release:"SUSE11.1", reference:"seamonkey-2.0.10-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"seamonkey-dom-inspector-2.0.10-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"seamonkey-irc-2.0.10-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"seamonkey-venkman-2.0.10-0.1.1") ) flag++;
