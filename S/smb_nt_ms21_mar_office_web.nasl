...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4493229");
  script_xref(name:"MSKB", value:"4493234");
  script_xref(name:"MSFT", value:"MS21-4493229");
  script_xref(name:"MSFT", value:"MS21-4493234");

  script_name(english:"Security Updates for Microsoft Office Online Server and Microsoft Office Web Apps (March 2021)");
...
by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4493229");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4493234");
...
if (owa_2013_path && (!isnull(owa_2013_sp) && owa_2013_sp == '1'))
{
  ...
  if (hotfix_check_fversion(file:'sword.dll', version:'15.0.5327.1000', min_version:'15.0.0.0', path:path, kb:'4493234', product:'Office Web Apps 2013') == HCF_OLDER)
    vuln = TRUE;
}
...
if (oos_path && (!isnull(oos_sp) && oos_sp == '0'))
{
  ...
  if (hotfix_check_fversion(file:'sword.dll', version:'16.0.10372.20000', min_version:'16.0.0.0', path:path, kb:'4493229', product:'Office Online Server') == HCF_OLDER)
    vuln = TRUE;
}
