...
if ( rpm_check(release:"SUSE11.1", reference:"curl-7.19.0-11.2.16") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libcurl-devel-7.19.0-11.2.16") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libcurl4-7.19.0-11.2.16") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libcurl4-32bit-7.19.0-11.2.16") ) flag++;
