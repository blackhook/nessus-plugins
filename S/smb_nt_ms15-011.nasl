...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3000483");
...
even though it is affected by this vulnerability.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6533d970");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8230f41");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows Vista, 2008, 7,
2008 R2, 8, 2012, 8.1, and 2012 R2.");
  script_set_cvss_base_vector("CVSS2#AV:A/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-0008");
