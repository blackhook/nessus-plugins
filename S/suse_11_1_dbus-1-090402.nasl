...
# extracted from openSUSE Security Update dbus-1-717.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dbus-1 (dbus-1-717)");
  script_summary(english:"Check for the dbus-1-717 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"dbus-1-1.2.10-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"dbus-1-devel-1.2.10-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"dbus-1-32bit-1.2.10-5.4.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "dbus-1 / dbus-1-32bit / dbus-1-devel");
}
