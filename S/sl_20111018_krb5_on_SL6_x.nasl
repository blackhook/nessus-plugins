...
updated packages, the krb5kdc daemon will be restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1110&L=scientific-linux-errata&T=0&P=1728
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a4c1da20"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"krb5-debuginfo-1.9-9.el6_1.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-devel-1.9-9.el6_1.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-libs-1.9-9.el6_1.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-pkinit-openssl-1.9-9.el6_1.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-server-1.9-9.el6_1.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-server-ldap-1.9-9.el6_1.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-workstation-1.9-9.el6_1.2")) flag++;
