...
crash when opened. (CVE-2009-0799, CVE-2009-1181, CVE-2009-1183)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0905&L=scientific-linux-errata&T=0&P=200
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4e520022"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"gpdf-2.8.2-7.7.2.el4_7.4")) flag++;
