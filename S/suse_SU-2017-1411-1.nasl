...
# extracted from SUSE update advisory SUSE-SU-2017:1411-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : squidGuard (SUSE-SU-2017:1411-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=985612"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-8936/"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20171411-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b2b53937"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch SUSE-SLE-RPI-12-SP2-2017-868=1

SUSE Linux Enterprise Server 12-SP2:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2017-868=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"squidGuard-1.4-29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"squidGuard-debuginfo-1.4-29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"squidGuard-debugsource-1.4-29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", cpu:"x86_64", reference:"squidGuard-doc-1.4-29.1")) flag++;
