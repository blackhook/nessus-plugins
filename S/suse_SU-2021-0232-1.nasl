...
# extracted from SUSE update advisory SUSE-SU-2021:0232-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2021:0232-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9db49f4d");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"2", reference:"sudo-1.8.10p3-10.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"sudo-debuginfo-1.8.10p3-10.29.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"sudo-debugsource-1.8.10p3-10.29.1")) flag++;
