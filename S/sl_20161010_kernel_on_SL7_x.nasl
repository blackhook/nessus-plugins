...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kernel on SL7.x x86_64 (20161010)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1610&L=scientific-linux-errata&F=&S=&P=2126
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ba608204"
  );
