...
if (description)
{
  ...
  script_cve_id("CVE-2023-0022");
  script_xref(name:"IAVA", value:"2023-A-0018");

  script_name(english:"SAP BusinessObjects Business Intelligence Platform Code Injection (3262810)");
...
4.2 SP9 P12, 4.3 SP2 P9 or 4.3 SP3. It is, therefore, affected by a vulnerability. SAP BusinessObjects Business
Intelligence Analysis edition for OLAP allows an authenticated attacker to inject malicious code that can be executed by
the application over the network. On successful exploitation, an attacker can perform operations that may completely
compromise the application causing a high impact on the confidentiality, integrity, and availability of the application.

Note that Nessus has not attempted to exploit these issues but has instead relied only on the application's
self-reported version number.");
  # https://www.sap.com/documents/2022/02/fa865ea4-167e-0010-bca6-c68f7e60039b.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18f404d5");
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3262810");
...
"See vendor advisories.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0022");
...
var constraints = [
  # 4.2 SP9 P12, 4.3 SP2 P9, 4.3 SP3
