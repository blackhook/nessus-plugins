...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1012&L=scientific-linux-errata&T=0&P=792
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e9df1038"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"thunderbird-1.5.0.12-34.el4")) flag++;

if (rpm_check(release:"SL5", reference:"thunderbird-2.0.0.24-13.el5_5")) flag++;
