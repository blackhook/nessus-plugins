...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"926121");
...
arbitrary code on this host.");
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7f853c04");
 ...
 script_set_attribute(attribute:"cvss_score_source", value:"CVE-2006-5584");
 ...
 script_copyright(english:"This script is Copyright (C) 2006-2020 Tenable Network Security, Inc.");
...
# Affected software is Microsoft Windows 2000 Service Pack 4
if (hotfix_check_sp_range(win2k:'4') <= 0) audit(AUDIT_OS_SP_NOT_VULN);
