...
# extracted from openSUSE Security Update rubygem-activesupport-4568.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : rubygem-activesupport (rubygem-activesupport-4568)");
  script_summary(english:"Check for the rubygem-activesupport-4568 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"rubygem-activesupport-1.3.1-29") ) flag++;
