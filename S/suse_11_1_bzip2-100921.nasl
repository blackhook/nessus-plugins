...
if ( rpm_check(release:"SUSE11.1", reference:"bzip2-1.0.5-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libbz2-1-1.0.5-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libbz2-devel-1.0.5-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libbz2-1-32bit-1.0.5-34.6.1") ) flag++;
