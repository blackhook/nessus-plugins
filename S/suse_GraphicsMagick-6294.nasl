...
# extracted from openSUSE Security Update GraphicsMagick-6294.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : GraphicsMagick (GraphicsMagick-6294)");
  script_summary(english:"Check for the GraphicsMagick-6294 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"GraphicsMagick-1.1.8-20.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"GraphicsMagick-devel-1.1.8-20.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libGraphicsMagick++-devel-1.1.8-20.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libGraphicsMagick++1-1.1.8-20.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libGraphicsMagick1-1.1.8-20.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libGraphicsMagickWand0-1.1.8-20.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"perl-GraphicsMagick-1.1.8-20.8") ) flag++;
