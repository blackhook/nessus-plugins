...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : gzip (YOU Patch Number 12573)");
...
"The following bug has been fixed :
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12573.");
...
flag = 0;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"gzip-1.3.5-136.16")) flag++;
