...
if ( rpm_check(release:"SUSE11.0", reference:"lighttpd-1.4.19-6.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"lighttpd-mod_cml-1.4.19-6.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"lighttpd-mod_magnet-1.4.19-6.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"lighttpd-mod_mysql_vhost-1.4.19-6.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"lighttpd-mod_rrdtool-1.4.19-6.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"lighttpd-mod_trigger_b4_dl-1.4.19-6.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"lighttpd-mod_webdav-1.4.19-6.4") ) flag++;
