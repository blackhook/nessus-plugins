...
if (description)
{
 ...
 script_xref(name:"IAVA", value:"2007-A-0045-S");
 script_xref(name:"MSFT", value:"MS07-050");
 script_xref(name:"MSKB", value:"938127");
...
into visiting a rogue website.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?84efbcdb");
 script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows 2000, XP, 2003 and
Vista.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:POC/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2007-1749");
