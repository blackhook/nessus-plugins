...
if(description)
{
 script_id(23197);
 script_version ("1.11");
 name["english"] = "Solaris 2.6 (i386) : 110012-02";
...
e +=  solaris_check_patch(release:"5.6_x86", arch:"i386", patch:"110012-02", obsoleted_by:"", package:"SUNWab2u", version:"3.0,REV=1999.1209");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
