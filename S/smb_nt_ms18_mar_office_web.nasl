...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4011023");
  script_xref(name:"MSKB", value:"4011692");
  script_xref(name:"MSKB", value:"4011709");
  script_xref(name:"MSFT", value:"MS18-4011023");
  script_xref(name:"MSFT", value:"MS18-4011692");
  script_xref(name:"MSFT", value:"MS18-4011709");
  script_xref(name:"IAVA", value:"2018-A-0077-S");

  script_name(english:"Security Updates for Microsoft Office Online Server and Microsoft Office Web Apps (March 2018)");
...
vulnerabilities :
  ...
  # https://support.microsoft.com/en-us/help/4011023/descriptionofthesecurityupdateforofficeonlineservermarch13-2018
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?588d8ddf");
  # https://support.microsoft.com/en-us/help/4011692/descriptionofthesecurityupdateforofficewebappsserver2013march13-2018
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e46219d");
  # https://support.microsoft.com/en-us/help/4011709/description-of-the-security-update-for-sharepoint-server-2010-office-w
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f9705e6c");
...
function perform_owa_checks()
{
  ...
  if (owa_2010_path && (!isnull(owa_2010_sp) && owa_2010_sp == "2"))
  {
    ...
    if (hotfix_check_fversion(file:"sword.dll", version:"14.0.7195.5000", min_version:"14.0.0.0", path:path, kb:"4011709", product:"Office Web Apps 2010") == HCF_OLDER)
      vuln = TRUE;
  }
  ...
  if (owa_2013_path && (!isnull(owa_2013_sp) && owa_2013_sp == "1"))
  {
    ...
    if (hotfix_check_fversion(file:"sword.dll", version:"15.0.5015.1000", min_version:"15.0.0.0", path:path, kb:"4011692", product:"Office Web Apps 2013") == HCF_OLDER)
      vuln = TRUE;
  }
  return vuln;
}
...
function perform_oos_checks()
{
  ...
  if(office_online_server_path)
  {
    ...
    if (hotfix_check_fversion(file:"sword.dll", version:"16.0.8431.1025", min_version:"16.0.6000.0", path:path, kb:"4011023", product:"Office Online Server") == HCF_OLDER)
