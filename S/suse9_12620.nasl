...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : libvorbis (YOU Patch Number 12620)");
...
code. The issue has been tracked as CVE-2009-2663."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12620.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"libvorbis-1.0.1-56.10")) flag++;
if (rpm_check(release:"SUSE9", reference:"libvorbis-devel-1.0.1-56.10")) flag++;
if (rpm_check(release:"SUSE9", cpu:"x86_64", reference:"libvorbis-32bit-9-201005281010")) flag++;
