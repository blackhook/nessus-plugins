...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 119466-17");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"119466-17", obsoleted_by:"", package:"SUNWamutl", version:"6.2,REV=04.04.23.20.24") < 0) flag++;
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"119466-17", obsoleted_by:"", package:"SUNWamrsa", version:"6.2,REV=04.04.23.20.25") < 0) flag++;
