...
if (description)
{
  ...
  script_xref(name:"MSKB", value: "2656368");
  script_xref(name:"MSKB", value: "2656369");
  script_xref(name:"MSKB", value: "2656370");
  script_xref(name:"MSKB", value: "2656372");
  script_xref(name:"MSKB", value: "2656373");
  script_xref(name:"MSKB", value: "2656374");
  script_xref(name:"MSKB", value: "2656376");
  script_xref(name:"MSKB", value: "2656378");
...
system running IIS and then executing that page."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.akitasecurity.nl/advisory.html?id=AK20110801");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-025");
  script_set_attribute(
    attribute:"solution",
    value:
