...
# extracted from openSUSE Security Update libxslt-110.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxslt (libxslt-110)");
  script_summary(english:"Check for the libxslt-110 patch");
...
(CVE-2008-2935)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=410256"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"libxslt-1.1.23-13.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libxslt-devel-1.1.23-13.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libxslt-32bit-1.1.23-13.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libxslt-devel-32bit-1.1.23-13.2") ) flag++;
