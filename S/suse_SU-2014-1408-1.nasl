...
# extracted from SUSE update advisory SUSE-SU-2014:1408-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES10 Security Update : wget (SUSE-SU-2014:1408-1)");
...
without introducing additional issues."
  ...
  # https://download.suse.com/patch/finder/?keywords=c335014fcf83b00f5b1e62db97d8b59c
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a075b797"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2014-4877/"
  );
  # https://www.suse.com/support/update/announcement/2014/suse-su-20141408-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9d381ee"
  );
...
flag = 0;
if (rpm_check(release:"SLES10", sp:"4", reference:"wget-1.10.2-15.14.5")) flag++;
