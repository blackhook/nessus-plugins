...
number is included in the error message."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-07/msg00049.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-08/msg00048.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-3.0.6-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-devel-3.0.6-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-translations-common-3.0.6-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-translations-other-3.0.6-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"enigmail-1.0.1-1.1.1") ) flag++;
