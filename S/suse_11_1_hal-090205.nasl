...
# extracted from openSUSE Security Update hal-501.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : hal (hal-501)");
  script_summary(english:"Check for the hal-501 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"hal-0.5.12-10.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"hal-devel-0.5.12-10.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"hal-32bit-0.5.12-10.13.1") ) flag++;
