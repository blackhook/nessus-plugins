...
if ( rpm_check(release:"SUSE11.3", reference:"dbus-1-1.2.24-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"dbus-1-devel-1.2.24-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"dbus-1-32bit-1.2.24-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"dbus-1-devel-32bit-1.2.24-2.3.1") ) flag++;
