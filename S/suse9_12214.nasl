...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : Ruby (YOU Patch Number 12214)");
...
"This update of ruby fixes :
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12214.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"ruby-1.8.1-42.24")) flag++;
