...
# extracted from SUSE update advisory SUSE-SU-2021:1274-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2021:1274-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d9fb145");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"sudo-1.8.27-4.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"sudo-debuginfo-1.8.27-4.15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"sudo-debugsource-1.8.27-4.15.1")) flag++;
