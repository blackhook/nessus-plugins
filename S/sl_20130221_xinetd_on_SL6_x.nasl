...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xinetd on SL6.x i386/x86_64 (20130221)");
...
This update also fixes the following bugs :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=4790
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ad4cf05"
  );
  script_set_attribute(
    attribute:"solution", 
