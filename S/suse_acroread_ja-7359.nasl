...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : acroread_ja (ZYPP Patch Number 7359)");
...
CVE-2011-0608.)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7359.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread_ja-9.4.2-0.5.1")) flag++;
