...
# extracted from openSUSE Security Update rubygem-actionpack-2_3-1934.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rubygem-actionpack-2_3 (rubygem-actionpack-2_3-1934)");
  script_summary(english:"Check for the rubygem-actionpack-2_3-1934 patch");
...
"This update of rubygems fixes two vulnerabilities :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected rubygem-actionpack-2_3 package."
  );
...
if ( rpm_check(release:"SUSE11.2", reference:"rubygem-actionpack-2_3-2.3.2-4.4.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "rubygem-actionpack-2_3");
}
