...
and ends for Windows 10 version 1809 Enterprise/Educational on May 11, 2021.
...
# Server 2019 (all editions) supported until Jan 9 2024
# https://docs.microsoft.com/en-us/windows-server/get-started/windows-server-release-info
if ("server" >< os_name 
    &&  (now < 1704758400 ) # future proof until support ticker comes in, then figure out how to cover 5-yr ESU until 2029-01-09
   )
...
# LTSC builds have a different lifecycle
if ('ltsc' >< os_name) audit(AUDIT_OS_NOT, 'affected');
