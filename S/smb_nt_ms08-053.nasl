...
if (description)
{
 ...
 script_xref(name:"IAVB", value:"2008-B-0057-S");
...
page and entice a victim to visit it.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?dbb72e88");
 script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows 2000, XP, 2003,
Vista and 2008.");
 script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
 script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-3008");
