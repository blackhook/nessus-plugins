...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.6.0-openjdk on SL5.x, SL6.x, SL7.x i386/x86_64 (20150126) (POODLE)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1501&L=scientific-linux-errata&T=0&P=2194
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aca7b185"
  );
