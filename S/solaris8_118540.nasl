...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 118540-42");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"118540-42", obsoleted_by:"122793-12 ", package:"SUNWuwc", version:"6.1,REV=2004.04.29") < 0) flag++;
