...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Linux kernel (ZYPP Patch Number 8527)");
...
XEN :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8527.");
...
if (rpm_check(release:"SLES10", sp:4, cpu:"x86_64", reference:"kernel-default-2.6.16.60-0.101.1")) flag++;
...
if (rpm_check(release:"SLES10", sp:4, cpu:"x86_64", reference:"kernel-source-2.6.16.60-0.101.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, cpu:"x86_64", reference:"kernel-syms-2.6.16.60-0.101.1")) flag++;
