...
if (description)
{
  ...
  script_cve_id("CVE-2020-6796", "CVE-2020-6800");
  script_xref(name:"IAVA", value:"2020-A-0072-S");

  script_name(english:"Scientific Linux Security Update : firefox on SL6.x i386/x86_64 (20200217)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2002&L=SCIENTIFIC-LINUX-ERRATA&P=7769
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ada8841"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"SL6", reference:"firefox-68.5.0-2.el6_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-68.5.0-2.el6_10", allowmaj:TRUE)) flag++;
