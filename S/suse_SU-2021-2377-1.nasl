...
"Update the affected kernel-livepatch-5_3_18-22-default and / or kernel-livepatch-5_3_18-24_9-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-5_3_18-24_9-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-22-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-22-default-13-5.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      },
      '5.3.18-24.9-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_9-default-12-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
