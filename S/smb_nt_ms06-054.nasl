...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"910729");
...
handler would result in code execution.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2006/ms06-054");
