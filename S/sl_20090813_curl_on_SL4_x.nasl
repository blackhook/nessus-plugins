...
updates."
  ...
  script_set_attribute(
    ...
    value:
"CVE-2009-2417 curl: incorrect verification of SSL certificate with NUL
in name
...
Note: This package for SL4 has to be renamed due to poor naming of
rpms."
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0908&L=scientific-linux-errata&T=0&P=1352
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8dbe8613"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"curl-7.12.1-11.1.el4_8.1")) flag++;
if (rpm_check(release:"SL4", reference:"curl-devel-7.12.1-11.1.el4_8.1")) flag++;
