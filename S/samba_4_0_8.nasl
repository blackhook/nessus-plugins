...
the associated patch has been applied.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.samba.org/samba/history/samba-3.5.22.html");
  script_set_attribute(attribute:"see_also", value:"https://www.samba.org/samba/history/samba-3.6.17.html");
  script_set_attribute(attribute:"see_also", value:"https://www.samba.org/samba/history/samba-4.0.8.html");
  # https://download.samba.org/pub/samba/patches/security/samba-4.0.7-CVE-2013-4124.patch
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a31cffce");
