...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2802968");
...
user's credentials."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-13-024/");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/525810/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-020");
