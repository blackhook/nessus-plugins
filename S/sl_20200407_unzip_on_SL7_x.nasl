...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : unzip on SL7.x x86_64 (20200407)");
...
updates."
  ...
  script_set_attribute(
    ...
    value:
"* unzip: overlapping of files in ZIP container leads to denial of
service"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=20363
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?441114ee"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"unzip-6.0-21.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"unzip-debuginfo-6.0-21.el7")) flag++;
