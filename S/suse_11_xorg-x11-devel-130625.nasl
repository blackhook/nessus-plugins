...
if (description)
{
  ...
  script_name(english:"SuSE 11.3 Security Update : xorg-x11-libs (SAT Patch Number 7944)");
...
CVE-2013-1984 / CVE-2013-1985 / CVE-2013-1986 / CVE-2013-1988 /
CVE-2013-1990 / CVE-2013-1991 / CVE-2013-1992 / CVE-2013-1995 /
CVE-2013-1996 / CVE-2013-1998 / CVE-2013-1999 / CVE-2013-2000 /
CVE-2013-2001 / CVE-2013-2003 / CVE-2013-2063"
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 7944.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"xorg-x11-libs-7.4-8.26.38.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"xorg-x11-libs-7.4-8.26.38.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"xorg-x11-libs-32bit-7.4-8.26.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"xorg-x11-libs-7.4-8.26.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"s390x", reference:"xorg-x11-libs-32bit-7.4-8.26.38.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"x86_64", reference:"xorg-x11-libs-32bit-7.4-8.26.38.1")) flag++;
