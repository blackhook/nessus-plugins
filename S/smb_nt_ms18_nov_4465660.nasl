...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4465660");
  script_xref(name:"MSFT", value:"MS18-4465660");

  script_name(english:"KB4465660 BitLocker Security Feature Bypass Vulnerability");
  script_summary(english:"Checks for rollup.");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4465660.
It is, therefore, affected by multiple vulnerabilities :
  ...
  # https://support.microsoft.com/en-us/help/4465660/servicing-stack-update-for-windows-10-version-1703-november-13-2018
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eb375f16");
  script_set_attribute(attribute:"solution", value:
"Apply Cumulative Update KB4465660.");
...
if ( my_os_build != '15063') audit(AUDIT_OS_NOT, 'Build 15063');

kb_installed = get_kb_item('WMI/Installed/Hotfix/KB4465660');
