...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : selinux-policy enhancement update on SL6.x i386/x86_64 (20130221)");
...
bugs."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=3762
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6c9c3df0"
  );
