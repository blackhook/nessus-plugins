...
# extracted from openSUSE Security Update courier-authlib-5871.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : courier-authlib (courier-authlib-5871)");
  script_summary(english:"Check for the courier-authlib-5871 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"courier-authlib-0.59.3-44.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"courier-authlib-devel-0.59.3-44.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"courier-authlib-ldap-0.59.3-44.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"courier-authlib-mysql-0.59.3-44.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"courier-authlib-pgsql-0.59.3-44.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"courier-authlib-pipe-0.59.3-44.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"courier-authlib-userdb-0.59.3-44.4") ) flag++;
