...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3172727");
...
for BitLocker and the device encryption security features.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c1c8dc5");
...
2012 R2, and 10");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-3287");
