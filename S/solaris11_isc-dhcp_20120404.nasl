...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : isc-dhcp (cve_2011_4539_denial_of)");
...
security updates :
  ...
  - dhcpd in ISC DHCP 4.x before 4.2.3-P1 and 4.1-ESV before
    4.1-ESV-R4 does not properly handle regular expressions
    in dhcpd.conf, which allows remote attackers to cause a
    denial of service (daemon crash) via a crafted request
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2011-4539-denial-of-service-vulnerability-in-isc-dhcp"
  );
