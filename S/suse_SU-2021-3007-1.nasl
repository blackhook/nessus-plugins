...
the SUSE-SU-2021:3007-1 advisory.
...
headless packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-2161");
...
var pkgs = [
    {'reference':'java-1_7_0-openjdk-1.7.0.311-43.50.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-12.5'},
    {'reference':'java-1_7_0-openjdk-demo-1.7.0.311-43.50.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-12.5'},
    {'reference':'java-1_7_0-openjdk-devel-1.7.0.311-43.50.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-12.5'},
    {'reference':'java-1_7_0-openjdk-headless-1.7.0.311-43.50.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-12.5'},
