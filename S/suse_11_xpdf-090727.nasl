...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : xpdf (SAT Patch Number 1140)");
...
allow execution of arbitrary code. (CVE-2009-0791)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 1140.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:0, cpu:"i586", reference:"xpdf-tools-3.02-138.26.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"xpdf-tools-3.02-138.26.1")) flag++;
if (rpm_check(release:"SLES11", sp:0, reference:"xpdf-tools-3.02-138.26.1")) flag++;
