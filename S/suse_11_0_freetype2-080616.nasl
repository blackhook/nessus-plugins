...
# extracted from openSUSE Security Update freetype2-41.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : freetype2 (freetype2-41)");
  script_summary(english:"Check for the freetype2-41 patch");
...
reported by iDefense."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=399169"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"freetype2-2.3.5-62.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"freetype2-devel-2.3.5-62.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"freetype2-32bit-2.3.5-62.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"freetype2-devel-32bit-2.3.5-62.2") ) flag++;
