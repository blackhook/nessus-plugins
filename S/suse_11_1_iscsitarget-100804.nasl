...
# extracted from openSUSE Security Update iscsitarget-2877.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : iscsitarget (openSUSE-SU-2010:0604-1)");
  script_summary(english:"Check for the iscsitarget-2877 patch");
...
string vulnerability :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-09/msg00016.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected iscsitarget packages."
  );
...
if ( rpm_check(release:"SUSE11.1", reference:"iscsitarget-0.4.15-89.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"iscsitarget-kmp-debug-0.4.15_2.6.27.48_0.2-89.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"iscsitarget-kmp-default-0.4.15_2.6.27.48_0.2-89.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"iscsitarget-kmp-pae-0.4.15_2.6.27.48_0.2-89.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"iscsitarget-kmp-trace-0.4.15_2.6.27.48_0.2-89.12.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"iscsitarget-kmp-xen-0.4.15_2.6.27.48_0.2-89.12.1") ) flag++;
