...
if (description)
{
  ...
  script_cve_id("CVE-2013-1499");
  script_bugtraq_id(59238);

  script_name(english:"Oracle Solaris Critical Patch Update : apr2013_SRU4_5");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    ...
    Configuration). The supported version that is affected
    is 11. Easily exploitable vulnerability requiring logon
    to Operating System plus additional login/authentication
    to component or subcomponent. Successful attack of this
    vulnerability can escalate attacker privileges resulting
    in unauthorized ability to cause a partial denial of
    service (partial DOS) of Solaris. (CVE-2013-1499)"
  );
  script_set_attribute(
    attribute:"see_also",
...
fix_release = "0.5.11-0.175.1.4.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.1.4.0.5.0", sru:"Solaris 11.1.4.5") > 0) flag++;
