...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 124847-04");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"124847-04", obsoleted_by:"", package:"SUNWuttsc", version:"1.1_15") < 0) flag++;
