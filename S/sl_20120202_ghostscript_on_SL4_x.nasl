...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ghostscript on SL4.x i386/x86_64 (20120202)");
...
which contain backported patches to correct these issues."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=908
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5fcf7943"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2010/10/23");
...
flag = 0;
if (rpm_check(release:"SL4", reference:"ghostscript-7.07-33.13.el4")) flag++;
if (rpm_check(release:"SL4", reference:"ghostscript-debuginfo-7.07-33.13.el4")) flag++;
if (rpm_check(release:"SL4", reference:"ghostscript-devel-7.07-33.13.el4")) flag++;
if (rpm_check(release:"SL4", reference:"ghostscript-gtk-7.07-33.13.el4")) flag++;
