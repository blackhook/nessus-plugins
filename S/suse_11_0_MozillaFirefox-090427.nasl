...
if ( rpm_check(release:"SUSE11.0", reference:"MozillaFirefox-3.0.9-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"MozillaFirefox-translations-3.0.9-0.1") ) flag++;
