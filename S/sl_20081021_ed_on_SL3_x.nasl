...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ed on SL3.x, SL4.x, SL5.x i386/x86_64");
...
arbitrary code when opened in the ed editor. (CVE-2008-3916)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0810&L=scientific-linux-errata&T=0&P=1935
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?33498c1b"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"ed-0.2-33.30E.1")) flag++;

if (rpm_check(release:"SL4", reference:"ed-0.2-36.el4_7.1")) flag++;

if (rpm_check(release:"SL5", reference:"ed-0.2-39.el5_2")) flag++;
