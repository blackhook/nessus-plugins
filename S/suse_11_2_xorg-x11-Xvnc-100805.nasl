...
# extracted from openSUSE Security Update xorg-x11-Xvnc-2875.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xorg-x11-Xvnc (openSUSE-SU-2010:0583-1)");
  script_summary(english:"Check for the xorg-x11-Xvnc-2875 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes a memory corruption in the X Render extension in the
X server.
...
related to an incorrect macro definition."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-09/msg00002.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"xorg-x11-Xvnc-7.4-61.64.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"xorg-x11-server-7.4-61.64.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"xorg-x11-server-extra-7.4-61.64.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"xorg-x11-server-sdk-7.4-61.64.1") ) flag++;
