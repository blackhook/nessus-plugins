...
if ( rpm_check(release:"SUSE11.2", reference:"NetworkManager-0.7.1_git20090811-4.3.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"NetworkManager-devel-0.7.1_git20090811-4.3.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"NetworkManager-glib-0.7.1_git20090811-4.3.3") ) flag++;
