...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2849568");
...
sending a specially crafted ICMP packet to the system."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-064");
