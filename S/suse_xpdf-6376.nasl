...
# extracted from openSUSE Security Update xpdf-6376.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : xpdf (xpdf-6376)");
  script_summary(english:"Check for the xpdf-6376 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"xpdf-3.02-19.10") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"xpdf-tools-3.02-19.10") ) flag++;
