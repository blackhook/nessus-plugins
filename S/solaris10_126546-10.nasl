...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 126546-10");
  script_summary(english:"Check for patch 126546-10");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 126546-10"
  );
  script_set_attribute(
...
Solaris accessible data."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 126546-10 or higher");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-5480");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"126546-10", obsoleted_by:"", package:"SUNWbash", version:"11.10.0,REV=2005.01.08.05.16") < 0) flag++;
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"126546-10", obsoleted_by:"", package:"SUNWbashS", version:"11.10.0,REV=2005.01.08.05.16") < 0) flag++;
