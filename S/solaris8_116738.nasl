...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 116738-23");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"116738-23", obsoleted_by:"", package:"SUNWpsgw", version:"6.2,REV=2003.11.17.14.14") < 0) flag++;
