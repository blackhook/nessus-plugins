...
fixed (CVE-2011-4000)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00008.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00020.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"chasen-2.4.2-60.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"chasen-devel-2.4.2-60.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"perl-Text-ChaSen-2.4.2-60.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "chasen / chasen-devel / perl-Text-ChaSen");
}
