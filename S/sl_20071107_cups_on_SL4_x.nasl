...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : cups on SL4.x i386/x86_64");
...
crash. (CVE-2007-4045)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0711&L=scientific-linux-errata&T=0&P=433
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?149de0ad"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"cups-1.1.22-0.rc1.9.20.2.el4_5.2")) flag++;
if (rpm_check(release:"SL4", reference:"cups-devel-1.1.22-0.rc1.9.20.2.el4_5.2")) flag++;
if (rpm_check(release:"SL4", reference:"cups-libs-1.1.22-0.rc1.9.20.2.el4_5.2")) flag++;
