...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libpng12 on SL7.x x86_64 (20151209)");
...
a specially crafted PNG image. (CVE-2015-7981)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=18795
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e8dd5c5"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
libpng12-devel packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:libpng12");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:libpng12-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:libpng12-devel");
