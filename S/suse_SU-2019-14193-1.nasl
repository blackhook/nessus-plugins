...
# SUSE update advisory SUSE-SU-2019:14193-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2019:14193-1");
  script_xref(name:"IAVA", value:"2019-A-0378-S");

  script_name(english:"SUSE SLES11 Security Update : sudo (SUSE-SU-2019:14193-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1153674");
  # https://lists.suse.com/pipermail/sle-security-updates/2019-October/006032.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?141ef03a");
...
pkgs = [
    {'reference':'sudo-1.7.6p2-0.30.5', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'sudo-1.7.6p2-0.30.5', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
