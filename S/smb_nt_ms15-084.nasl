...
if (description)
{
  ...
  script_cve_id("CVE-2015-2434", "CVE-2015-2440", "CVE-2015-2471");
  script_bugtraq_id(76229, 76232, 76257);
  script_xref(name:"MSFT", value:"MS15-084");
  script_xref(name:"MSKB", value:"2825645");
  script_xref(name:"MSKB", value:"3076895");
...
vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-084");
...
InfoPath 2007 SP3.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2471");
