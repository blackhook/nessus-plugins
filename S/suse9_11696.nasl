...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : tcpdump (YOU Patch Number 11696)");
...
issue is tracked by CVE-2007-3798."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11696.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"tcpdump-3.8.1-49.10")) flag++;
