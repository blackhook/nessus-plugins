...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 119009-11");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"119009-11", obsoleted_by:"", package:"VRTSnetbp", version:"6.0,REV=2005.09.07.19.13") < 0) flag++;
