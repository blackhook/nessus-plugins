...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : build (ZYPP Patch Number 7372)");
...
therefore the build script now uses bsdtar instead. (CVE-2010-4226)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2010-4226.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7372.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"build-2007.05.10-0.16.1")) flag++;
