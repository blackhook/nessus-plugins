...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 127655-07");
  script_summary(english:"Check for patch 127655-07");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 127655-07");
  script_set_attribute(attribute:"description", value:
"VERITAS NetBackup 6.5 Product Release Update 6.5.6 for sparc. Date
this patch was last updated by Sun : May/12/10");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"127655-07", obsoleted_by:"", package:"SYMCnetbp", version:"6.5,REV=2007.07.24.02.54") < 0) flag++;
