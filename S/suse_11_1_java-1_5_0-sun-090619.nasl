...
if ( rpm_check(release:"SUSE11.1", reference:"java-1_5_0-sun-1.5.0_update19-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_5_0-sun-alsa-1.5.0_update19-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_5_0-sun-devel-1.5.0_update19-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_5_0-sun-jdbc-1.5.0_update19-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_5_0-sun-plugin-1.5.0_update19-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_5_0-sun-src-1.5.0_update19-0.1.1") ) flag++;
