...
attacker could exploit this issue to execute arbitrary code.");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-14-127/");
  # https://support.symantec.com/en_US/article.SYMSA1295.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d272b309");
  script_set_attribute(attribute:"solution", value:
"Upgrade to 7.5 SP1 or higher.");
  script_set_cvss_base_vector("CVSS2#AV:A/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-1649");
