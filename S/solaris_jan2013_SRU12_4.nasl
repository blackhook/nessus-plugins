...
if (description)
{
  ...
  script_cve_id("CVE-2013-0407");
  script_bugtraq_id(57393);

  script_name(english:"Oracle Solaris Critical Patch Update : jan2013_SRU12_4");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Products Suite (subcomponent: Kernel/DTrace Framework).
    ...
    repeatable crash (complete DOS). (CVE-2013-0407)"
  );
  script_set_attribute(
    attribute:"see_also",
...
if (solaris_check_release(release:"0.5.11-0.175.0.12.0.4.0", sru:"11/11 SRU12.4") > 0) flag++;
