...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : postgresql-jdbc on SL6.x (noarch) (20200803)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2008&L=SCIENTIFIC-LINUX-ERRATA&P=1680
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?29c2d200"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"SL6", reference:"postgresql-jdbc-8.4.704-4.el6_10")) flag++;
