...
information, log key strokes, and perform other malicious attacks.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/oss-sec/2015/q1/850");
...
"Upgrade to Apache Solr version 4.10.5 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3628");
