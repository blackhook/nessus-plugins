...
if ( rpm_check(release:"SUSE11.2", reference:"gnome-screensaver-2.28.0-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"gnome-screensaver-lang-2.28.0-2.4.1") ) flag++;
