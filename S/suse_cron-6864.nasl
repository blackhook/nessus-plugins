...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : cron (ZYPP Patch Number 6864)");
...
entry.
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6864.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"cron-4.1-45.27.2")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"cron-4.1-45.27.2")) flag++;
