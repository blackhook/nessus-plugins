...
# extracted from openSUSE Security Update java-1_6_0-openjdk-3003.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : java-1_6_0-openjdk (openSUSE-SU-2010:0553-1)");
  script_summary(english:"Check for the java-1_6_0-openjdk-3003 patch");
...
http://blog.fuseyism.com/index.php/2010/07/28/icedtea6-181-released/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://blog.fuseyism.com/index.php/2010/07/28/icedtea6-181-released/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=623905"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-08/msg00061.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"java-1_6_0-openjdk-1.6.0.0_b18-1.1.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"java-1_6_0-openjdk-demo-1.6.0.0_b18-1.1.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"java-1_6_0-openjdk-devel-1.6.0.0_b18-1.1.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"java-1_6_0-openjdk-javadoc-1.6.0.0_b18-1.1.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"java-1_6_0-openjdk-plugin-1.6.0.0_b18-1.1.3") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"java-1_6_0-openjdk-src-1.6.0.0_b18-1.1.3") ) flag++;
