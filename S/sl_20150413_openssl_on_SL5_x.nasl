...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl on SL5.x i386/x86_64 (20150413) (FREAK)");
...
library must be restarted, or the system rebooted."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1504&L=scientific-linux-errata&T=0&P=847
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?453599c1"
  );
