...
# extracted from SUSE update advisory SUSE-SU-2015:1426-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : kvm (SUSE-SU-2015:1426-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2015/suse-su-20151426-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?49f926dd"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"2", cpu:"x86_64", reference:"kvm-0.15.1-0.32.2")) flag++;
if (rpm_check(release:"SLES11", sp:"2", cpu:"i586", reference:"kvm-0.15.1-0.32.2")) flag++;
