...
# extracted from SUSE update advisory SUSE-SU-2018:2843-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : pam_pkcs11 (SUSE-SU-2018:2843-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3399bbce"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
slessp4-pam_pkcs11-13784=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-pam_pkcs11-13784=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"pam_pkcs11-32bit-0.6.0-141.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"pam_pkcs11-32bit-0.6.0-141.3.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"pam_pkcs11-0.6.0-141.3.1")) flag++;
