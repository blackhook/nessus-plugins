...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : gd (ZYPP Patch Number 3895)");
...
CVE-2007-3477 / CVE-2007-3478)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 3895.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:1, reference:"gd-2.0.32-23.10")) flag++;
if (rpm_check(release:"SLES10", sp:1, reference:"gd-2.0.32-23.10")) flag++;
if (rpm_check(release:"SLES10", sp:1, reference:"gd-devel-2.0.32-23.10")) flag++;
