...
# extracted from openSUSE Security Update kdelibs4-4225.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kdelibs4 (openSUSE-SU-2011:0281-1)");
  script_summary(english:"Check for the kdelibs4-4225 patch");
...
certificate was issued for an IP address (CVE-2011-1094)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00007.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"kdelibs4-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kdelibs4-branding-upstream-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kdelibs4-core-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kdelibs4-core-debuginfo-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kdelibs4-debuginfo-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kdelibs4-debugsource-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"kdelibs4-doc-debuginfo-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libkde4-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libkde4-debuginfo-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libkde4-devel-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libkdecore4-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libkdecore4-debuginfo-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libkdecore4-devel-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libkdecore4-devel-debuginfo-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libksuseinstall-devel-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libksuseinstall1-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libksuseinstall1-debuginfo-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libkde4-32bit-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libkde4-debuginfo-32bit-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libkdecore4-32bit-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libkdecore4-debuginfo-32bit-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libksuseinstall1-32bit-4.6.0-6.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libksuseinstall1-debuginfo-32bit-4.6.0-6.13.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "kdelibs4 / kdelibs4-branding-upstream / kdelibs4-core / libkde4 / etc");
}
