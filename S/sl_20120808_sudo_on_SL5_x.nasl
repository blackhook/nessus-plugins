...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : sudo on SL5.x i386/x86_64 (20120808)");
...
This update also fixes the following bugs :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1208&L=scientific-linux-errata&T=0&P=1240
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?49045ac3"
  );
