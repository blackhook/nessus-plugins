...
# extracted from openSUSE Security Update dhcpcd-4357.
#
...
if (description)
{
  ...
  script_summary(english:"Check for the dhcpcd-4357 patch");
...
if ( rpm_check(release:"SUSE11.3", reference:"dhcpcd-3.2.3-61.64.1") ) flag++;
