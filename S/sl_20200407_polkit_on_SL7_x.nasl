...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : polkit on SL7.x x86_64 (20200407)");
...
polkitd"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2004&L=SCIENTIFIC-LINUX-ERRATA&P=9477
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?53df54d2"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"polkit-0.112-26.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"polkit-debuginfo-0.112-26.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"polkit-devel-0.112-26.el7")) flag++;
if (rpm_check(release:"SL7", reference:"polkit-docs-0.112-26.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"polkit-docs-0.112-26.el7")) flag++;
