...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"953733");
 script_xref(name:"IAVT", value:"2008-T-0038-S");
...
and transmit the traffic in cleartext.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2008/ms08-047");
