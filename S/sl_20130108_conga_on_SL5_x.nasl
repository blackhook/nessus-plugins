...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : conga on SL5.x i386/x86_64 (20130108)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1301&L=scientific-linux-errata&T=0&P=1456
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?51399252"
  );
  script_set_attribute(
    attribute:"solution", 
