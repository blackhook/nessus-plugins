...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : httpd on SL5.x, SL6.x i386/x86_64 (20130813)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1308&L=scientific-linux-errata&T=0&P=977
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed38b931"
  );
