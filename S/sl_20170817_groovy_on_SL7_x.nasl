...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : groovy on SL7.x (noarch) (20170817)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7d77dced"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:groovy");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:groovy-javadoc");
...
flag = 0;
if (rpm_check(release:"SL7", reference:"groovy-1.8.9-8.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"groovy-javadoc-1.8.9-8.el7_4")) flag++;
