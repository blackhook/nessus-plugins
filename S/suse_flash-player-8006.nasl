...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : flash-player (ZYPP Patch Number 8006)");
...
"flash-player 11.1.102.63 fixes two security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8006.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"flash-player-10.3.183.16-0.5.1")) flag++;
