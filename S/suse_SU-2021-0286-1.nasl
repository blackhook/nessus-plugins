...
# extracted from SUSE update advisory SUSE-SU-2021:0286-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : cups (SUSE-SU-2021:0286-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6dd7c197"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2021-286=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2021-286=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-client-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-client-debuginfo-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-debuginfo-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-debugsource-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-libs-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-libs-32bit-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-libs-debuginfo-1.7.5-20.33.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"cups-libs-debuginfo-32bit-1.7.5-20.33.1")) flag++;
