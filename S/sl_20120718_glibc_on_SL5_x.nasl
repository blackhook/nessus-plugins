...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : glibc on SL5.x i386/x86_64 (20120718)");
...
which contain backported patches to fix these issues."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=5466
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?abb9952a"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"glibc-2.5-81.el5_8.4")) flag++;
if (rpm_check(release:"SL5", reference:"glibc-common-2.5-81.el5_8.4")) flag++;
if (rpm_check(release:"SL5", reference:"glibc-debuginfo-2.5-81.el5_8.4")) flag++;
if (rpm_check(release:"SL5", reference:"glibc-debuginfo-common-2.5-81.el5_8.4")) flag++;
if (rpm_check(release:"SL5", reference:"glibc-devel-2.5-81.el5_8.4")) flag++;
if (rpm_check(release:"SL5", reference:"glibc-headers-2.5-81.el5_8.4")) flag++;
if (rpm_check(release:"SL5", reference:"glibc-utils-2.5-81.el5_8.4")) flag++;
if (rpm_check(release:"SL5", reference:"nscd-2.5-81.el5_8.4")) flag++;
