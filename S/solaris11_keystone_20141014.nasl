...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : keystone (cve_2014_3621_information_disclosure)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2014-3621-information-disclosure-vulnerability-in-openstack-identity-keystone
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5074fd0c"
  );
