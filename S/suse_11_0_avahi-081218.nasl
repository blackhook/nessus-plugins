...
if ( rpm_check(release:"SUSE11.0", reference:"avahi-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"avahi-compat-howl-devel-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"avahi-compat-mDNSResponder-devel-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"avahi-utils-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"avahi-utils-gtk-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-client3-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-common3-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-core5-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-devel-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-glib-devel-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-glib1-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-gobject-devel-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-gobject0-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libavahi-ui0-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libdns_sd-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libhowl0-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"python-avahi-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libavahi-client3-32bit-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libavahi-common3-32bit-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libavahi-glib1-32bit-0.6.22-68.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libdns_sd-32bit-0.6.22-68.2") ) flag++;
