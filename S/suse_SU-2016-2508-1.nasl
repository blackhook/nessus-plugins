...
# extracted from SUSE update advisory SUSE-SU-2016:2508-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : tiff (SUSE-SU-2016:2508-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=975070"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2016-3991/"
  );
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162508-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b1c98ac6"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch SUSE-SLE-SDK-12-SP1-2016-1461=1

SUSE Linux Enterprise Server 12-SP1:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2016-1461=1

SUSE Linux Enterprise Desktop 12-SP1:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP1-2016-1461=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"libtiff5-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libtiff5-debuginfo-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"tiff-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"tiff-debuginfo-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"tiff-debugsource-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libtiff5-32bit-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libtiff5-debuginfo-32bit-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"libtiff5-32bit-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"libtiff5-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"libtiff5-debuginfo-32bit-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"libtiff5-debuginfo-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"tiff-debuginfo-4.0.6-31.1")) flag++;
if (rpm_check(release:"SLED12", sp:"1", cpu:"x86_64", reference:"tiff-debugsource-4.0.6-31.1")) flag++;
