...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2015-A-0307-S");
  script_xref(name:"CERT", value:"925497");
  script_xref(name:"MSKB", value:"3119884");
...
importing the latest disallowedcert.sst and disallowedcertstl.cab files into the Certificates console.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?556013c5");
