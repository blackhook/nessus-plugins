...
# extracted from openSUSE Security Update novell-ipsec-tools-6307.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : novell-ipsec-tools (novell-ipsec-tools-6307)");
  script_summary(english:"Check for the novell-ipsec-tools-6307 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"novell-ipsec-tools-0.6.3-114.6") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"novell-ipsec-tools-devel-0.6.3-114.6") ) flag++;
