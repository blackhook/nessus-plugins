...
if ( rpm_check(release:"SUSE11.2", reference:"compiz-fusion-plugins-main-0.7.8-14.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"compiz-fusion-plugins-main-devel-0.7.8-14.2.1") ) flag++;
