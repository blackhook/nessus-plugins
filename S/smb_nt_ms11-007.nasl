...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS11-007");
  script_xref(name:"MSKB", value:"2485376");

  script_name(english:"MS11-007: Vulnerability in the OpenType Compact Font Format (CFF) Driver Could Allow Remote Code Execution (2485376)");
...
in kernel mode."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-007");
  script_set_attribute(
    attribute:"solution",
    value:
...
if (
  ...
  hotfix_is_vulnerable(os:"6.1", file:"Atmfd.dll", version:"5.1.2.232", dir:"\system32", bulletin:bulletin, kb:kb) ||

  # Vista / Windows Server 2008
  hotfix_is_vulnerable(os:"6.0", file:"Atmfd.dll", version:"5.1.2.231", dir:"\system32", bulletin:bulletin, kb:kb) ||

  # Windows 2003 and XP x64
  hotfix_is_vulnerable(os:"5.2", sp:2, file:"Atmfd.dll", version:"5.2.2.231", dir:"\system32", bulletin:bulletin, kb:kb) ||

  # Windows XP
  hotfix_is_vulnerable(os:"5.1", arch:"x86", file:"Atmfd.dll", version:"5.1.2.231", dir:"\system32", bulletin:bulletin, kb:kb)
)
{
