...
# extracted from SUSE update advisory SUSE-SU-2021:1814-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : nginx (SUSE-SU-2021:1814-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5bb174b2");
...
zypper in -t patch
SUSE-SLE-Module-Server-Applications-15-SP2-2021-1814=1");
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"nginx-1.16.1-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nginx-debuginfo-1.16.1-3.3.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"nginx-debugsource-1.16.1-3.3.1")) flag++;
