...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4018483");
  script_xref(name:"MSFT", value:"MS17-4018483");

  script_name(english:"KB4018483: Security update for Adobe Flash Player (April 2017)");
...
"The remote Windows host is missing security update KB4018483. It is,
therefore, affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d96e57d7");
...
2012 R2, 10, and 2016.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-3063");
...
# all <= 25.0.0.127
fix = FALSE;
if(ver_compare(ver:iver, fix:"25.0.0.127", strict:FALSE) <= 0)
  fix = "25.0.0.148";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS17-04', kb:'4018483', report);
