...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4022196");
  script_xref(name:"MSFT", value:"MS18-4022196");

  script_name(english:"Security Updates for Microsoft Office Compatibility Products (June 2018)");
...
vulnerability :
  ...
  # https://support.microsoft.com/en-us/help/4022196/description-of-the-security-update-for-microsoft-office-compatibility
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7afc2d77");
...
foreach install (keys(installs))
{
  ...
  if (
      hotfix_check_fversion(path:path, file:"excelcnv.exe", version:"12.0.6800.5000", kb:"4022196", min_version:"12.0.0.0", product:"Microsoft Office Compatibility Pack") == HCF_OLDER
    )
  {
    vuln = TRUE;
    break;
