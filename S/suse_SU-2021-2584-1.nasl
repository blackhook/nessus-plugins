...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 18 for SLE 12 SP4) (SUSE-SU-2021:2584-1)");
...
referenced in the SUSE-SU-2021:2584-1 advisory.
...
"Update the affected kernel-livepatch-4_12_14-197_72-default and / or kgraft-patch-4_12_14-95_68-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-4_12_14-197_72-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-197.72-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_72-default-9-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-197_72-default / etc');
}
