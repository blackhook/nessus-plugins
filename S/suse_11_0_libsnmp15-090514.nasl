...
if ( rpm_check(release:"SUSE11.0", reference:"libsnmp15-5.4.1-77.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"net-snmp-5.4.1-77.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"net-snmp-devel-5.4.1-77.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"perl-SNMP-5.4.1-77.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"snmp-mibs-5.4.1-77.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"net-snmp-32bit-5.4.1-77.6") ) flag++;
