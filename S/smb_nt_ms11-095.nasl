...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2621146");
  script_xref(name:"MSKB", value:"2626416");
...
Directory service.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-095");
