...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 115610-25 (deprecated)");
...
115610 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 115610 instead.");
