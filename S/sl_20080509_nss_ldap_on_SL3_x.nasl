...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss_ldap on SL3.x i386/x86_64");
...
application crashing, or a segmentation fault."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0805&L=scientific-linux-errata&T=0&P=744
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e453bdfe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"nss_ldap-207-21")) flag++;
