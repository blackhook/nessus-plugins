...
# extracted from SUSE update advisory SUSE-SU-2017:2793-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2017:2793-1) (BlueBorne)");
  ...
  script_set_attribute(
    ...
    value:
"This update for the Linux Kernel 3.12.74-60_64_48 fixes one issue. The
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f8f4b731"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
SUSE-SLE-SAP-12-SP1-2017-1736=1

SUSE Linux Enterprise Server 12-SP1-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2017-1736=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"kgraft-patch-3_12_74-60_64_48-default-4-4.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", cpu:"x86_64", reference:"kgraft-patch-3_12_74-60_64_48-xen-4-4.1")) flag++;
