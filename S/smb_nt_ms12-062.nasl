...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2012-B-0089-S");
  script_xref(name:"MSKB", value:"2733631");
  script_xref(name:"MSKB", value:"2721642");
...
could gain elevated privileges.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-062");
