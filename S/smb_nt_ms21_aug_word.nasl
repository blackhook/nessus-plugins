...
# @DEPRECATED@
#
# Disabled on 2022/06/09. Deprecated by smb_nt_ms21_aug_word_c2r.nasl.
##
#
...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Word Products (August 2021) (deprecated)");
...
exit(0, 'This plugin has been deprecated. Use smb_nt_ms21_aug_word_c2r.nasl instead.');
