...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tar on SL5.x, SL4.x i386/x86_64");
...
(CVE-2007-4131)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0708&L=scientific-linux-errata&T=0&P=789
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d7105aad"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"tar-1.14-12.5.1.RHEL4")) flag++;

if (rpm_check(release:"SL5", reference:"tar-1.15.1-23.0.1.el5")) flag++;
