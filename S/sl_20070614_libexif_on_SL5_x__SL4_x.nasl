...
arbitrary code or crash. (CVE-2007-4168)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0706&L=scientific-linux-errata&T=0&P=1882
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5bd0cac2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"libexif-0.5.12-5.1.0.2")) flag++;
if (rpm_check(release:"SL4", reference:"libexif-devel-0.5.12-5.1.0.2")) flag++;

if (rpm_check(release:"SL5", reference:"libexif-0.6.13-4.0.2.el5")) flag++;
if (rpm_check(release:"SL5", reference:"libexif-devel-0.6.13-4.0.2.el5")) flag++;
