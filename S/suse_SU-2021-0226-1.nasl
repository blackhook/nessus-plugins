...
# extracted from SUSE update advisory SUSE-SU-2021:0226-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : sudo (SUSE-SU-2021:0226-1)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d3e4327");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"sudo-1.8.20p2-3.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"sudo-debuginfo-1.8.20p2-3.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"sudo-debugsource-1.8.20p2-3.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"sudo-1.8.20p2-3.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"sudo-debuginfo-1.8.20p2-3.20.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"sudo-debugsource-1.8.20p2-3.20.1")) flag++;
