...
if ( rpm_check(release:"SUSE11.0", reference:"expat-2.0.1-62.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libexpat-devel-2.0.1-62.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libexpat1-2.0.1-62.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libexpat1-32bit-2.0.1-62.4") ) flag++;
