...
# extracted from openSUSE Security Update libvirt-5874.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libvirt (libvirt-5874)");
  script_summary(english:"Check for the libvirt-5874 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libvirt-0.3.0-30.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libvirt-devel-0.3.0-30.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libvirt-python-0.3.0-30.7") ) flag++;
