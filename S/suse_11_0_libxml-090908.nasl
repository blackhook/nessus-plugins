...
if ( rpm_check(release:"SUSE11.0", reference:"libxml-1.8.17-489.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libxml-devel-1.8.17-489.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libxml-32bit-1.8.17-489.2") ) flag++;
