...
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-draw-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-impress-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-impress-devel-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-impress-l10n-prebuilt-3.1.1.4-1.2.2") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-gui-3.1.1.4-1.1.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-gui-devel-3.1.1.4-1.1.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"OpenOffice_org-libs-gui-l10n-prebuilt-3.1.1.4-1.1.8.1") ) flag++;
