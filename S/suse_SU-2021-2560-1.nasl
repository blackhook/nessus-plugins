...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 15 for SLE 15 SP1) (SUSE-SU-2021:2560-1)");
...
"Update the affected kernel-livepatch-4_12_14-197_56-default and / or kernel-livepatch-4_12_14-197_83-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-197.56-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_56-default-12-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
      '4.12.14-197.83-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_83-default-8-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-197_56-default / etc');
}
