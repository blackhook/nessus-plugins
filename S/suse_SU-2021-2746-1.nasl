...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 0 for SLE 15 SP3) (SUSE-SU-2021:2746-1)");
...
"Update the affected kernel-livepatch-5_3_18-57-default, kgraft-patch-4_12_14-122_32-default and / or kgraft-
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.32-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_32-default-16-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      ...
      '5.3.18-57-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-57-default-5-3.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3', 'SLE_HPC-release-15.3', 'sle-module-live-patching-release-15.3', 'sles-release-15.3']}
        ]
      }
    }
  }
