...
# extracted from openSUSE Security Update dovecot-1987.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : dovecot (dovecot-1987)");
  script_summary(english:"Check for the dovecot-1987 patch");
  ...
  script_set_attribute(
    ...
    value:
"Dovecot might have been affected by the multibyte character set SQL
injection issues for instance described in CVE-2006-2314.
...
if ( rpm_check(release:"SUSE10.1", reference:"dovecot-1.0.beta3-13.4") ) flag++;
