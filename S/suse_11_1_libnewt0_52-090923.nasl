...
CVE-2009-2905 has been assigned to this issue."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:python-newt");
...
if ( rpm_check(release:"SUSE11.1", reference:"libnewt0_52-0.52.10-1.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"newt-0.52.10-1.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"newt-devel-0.52.10-1.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"newt-static-0.52.10-1.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"python-newt-0.52.10-1.40.1") ) flag++;
