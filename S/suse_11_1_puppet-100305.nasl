...
(CVE-2010-0156)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-06/msg00000.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"puppet-0.24.5-1.32.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"puppet-server-0.24.5-1.32.1") ) flag++;
