...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2992080");
  script_xref(name:"MSKB", value:"2993928");
  script_xref(name:"MSKB", value:"2993937");
  script_xref(name:"MSKB", value:"2993939");
  script_xref(name:"MSKB", value:"2994397");
...
the privileges of the user running the browser.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-059");
