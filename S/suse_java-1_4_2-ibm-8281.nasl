...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : IBM Java (ZYPP Patch Number 8281)");
  ...
  script_set_attribute(
    ...
    value:
"IBM Java 1.4.2 was updated to SR13 FP13 fixing bugs and security
issues.
...
Also the following bug has been fixed :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8281.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:4, reference:"java-1_4_2-ibm-1.4.2_sr13.13-0.5.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, reference:"java-1_4_2-ibm-devel-1.4.2_sr13.13-0.5.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, cpu:"i586", reference:"java-1_4_2-ibm-jdbc-1.4.2_sr13.13-0.5.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, cpu:"i586", reference:"java-1_4_2-ibm-plugin-1.4.2_sr13.13-0.5.1")) flag++;
