...
if ( rpm_check(release:"SUSE11.1", reference:"libtiff-devel-3.8.2-133.35.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libtiff3-3.8.2-133.35.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"tiff-3.8.2-133.35.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libtiff-devel-32bit-3.8.2-133.35.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libtiff3-32bit-3.8.2-133.35.1") ) flag++;
