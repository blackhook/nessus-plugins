...
Xerces2 Java Parser must be restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1106&L=scientific-linux-errata&T=0&P=2851
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3d46549e"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"xerces-j2-2.7.1-12.6.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-j2-debuginfo-2.7.1-12.6.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-j2-demo-2.7.1-12.6.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-j2-javadoc-apis-2.7.1-12.6.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-j2-javadoc-impl-2.7.1-12.6.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-j2-javadoc-other-2.7.1-12.6.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-j2-javadoc-xni-2.7.1-12.6.el6_0")) flag++;
if (rpm_check(release:"SL6", reference:"xerces-j2-scripts-2.7.1-12.6.el6_0")) flag++;
