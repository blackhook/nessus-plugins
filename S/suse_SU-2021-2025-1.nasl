...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 0 for SLE 15 SP2) (SUSE-SU-2021:2025-1)");
...
"Update the affected kernel-livepatch-5_3_18-22-default, kgraft-patch-4_12_14-122_37-default and / or kgraft-
patch-4_12_14-95_71-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.37-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_37-default-12-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-95.71-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_71-default-5-2.2', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      },
      '5.3.18-22-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-22-default-12-5.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
