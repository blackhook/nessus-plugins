...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ccid on SL6.x i386/x86_64 (20130221)");
...
This update also fixes the following bug :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1303&L=scientific-linux-errata&T=0&P=1296
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b3bbfd18"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"ccid-1.3.9-6.el6")) flag++;
if (rpm_check(release:"SL6", reference:"ccid-debuginfo-1.3.9-6.el6")) flag++;
