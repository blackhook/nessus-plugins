...
CVE-2007-3738)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0707&L=scientific-linux-errata&T=0&P=690
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7637a82"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"thunderbird-1.5.0.12-0.3.SL3")) flag++;

if (rpm_check(release:"SL4", reference:"thunderbird-1.5.0.12-0.3.el4")) flag++;

if (rpm_check(release:"SL5", reference:"thunderbird-1.5.0.12-3.el5")) flag++;
