...
the SUSE-SU-2022:3532-1 advisory.
...
var pkgs = [
    {'reference':'squid-4.17-4.27.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']}
];
