...
"This update fixes the following security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00037.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"squid-2.7.STABLE6-10.11.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"squid-debuginfo-2.7.STABLE6-10.11.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"squid-debugsource-2.7.STABLE6-10.11.1") ) flag++;
