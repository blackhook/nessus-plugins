...
# extracted from openSUSE Security Update cyrus-imapd-6483.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : cyrus-imapd (cyrus-imapd-6483)");
  script_summary(english:"Check for the cyrus-imapd-6483 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-imapd-2.3.8-51.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-imapd-devel-2.3.8-51.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"perl-Cyrus-IMAP-2.3.8-51.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"perl-Cyrus-SIEVE-managesieve-2.3.8-51.2") ) flag++;
