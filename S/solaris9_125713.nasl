...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 125713-02");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"125713-02", obsoleted_by:"", package:"SUNWsrspx", version:"001.002.005") < 0) flag++;
