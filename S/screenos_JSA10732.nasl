...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://kb.juniper.net/InfoCenter/index?page=content&id=JSA10732");
...
"Upgrade to Juniper ScreenOS version 6.3.0r21 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1268");
