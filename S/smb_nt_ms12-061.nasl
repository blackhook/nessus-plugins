...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2719584");
...
on the site.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1012e368");
...
Foundation Server 2010 SP1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-1892");
