...
above.");
  ...
  script_set_attribute(attribute:"cvss_score_rationale", value:"The SQUID-2010_1 advisory mentions that any external server who can determine the squid receiving port can perform the attack, so Authentication is set to None. ");
