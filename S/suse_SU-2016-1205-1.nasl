...
# extracted from SUSE update advisory SUSE-SU-2016:1205-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : libxml2 (SUSE-SU-2016:1205-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161205-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3c0bd963"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch dbgsp4-libxml2-12538=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libxml2-32bit-2.7.6-0.40.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"libxml2-32bit-2.7.6-0.40.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libxml2-2.7.6-0.40.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libxml2-doc-2.7.6-0.40.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libxml2-python-2.7.6-0.40.3")) flag++;
