...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind on SL5.x, SL6.x i386/x86_64 (20120607)");
...
(named) will be restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1206&L=scientific-linux-errata&T=0&P=855
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9fcbc275"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"bind-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"bind-chroot-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"bind-debuginfo-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"bind-devel-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"bind-libbind-devel-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"bind-libs-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"bind-sdb-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"bind-utils-9.3.6-20.P1.el5_8.1")) flag++;
if (rpm_check(release:"SL5", reference:"caching-nameserver-9.3.6-20.P1.el5_8.1")) flag++;

if (rpm_check(release:"SL6", reference:"bind-9.7.3-8.P3.el6_2.3")) flag++;
if (rpm_check(release:"SL6", reference:"bind-chroot-9.7.3-8.P3.el6_2.3")) flag++;
if (rpm_check(release:"SL6", reference:"bind-debuginfo-9.7.3-8.P3.el6_2.3")) flag++;
if (rpm_check(release:"SL6", reference:"bind-devel-9.7.3-8.P3.el6_2.3")) flag++;
if (rpm_check(release:"SL6", reference:"bind-libs-9.7.3-8.P3.el6_2.3")) flag++;
if (rpm_check(release:"SL6", reference:"bind-sdb-9.7.3-8.P3.el6_2.3")) flag++;
if (rpm_check(release:"SL6", reference:"bind-utils-9.7.3-8.P3.el6_2.3")) flag++;
