...
if (description)
{
  script_id(42088);
  script_version("1.12");
  script_cvs_date("Date: 2019/03/20 12:54:43");
...
switch from a cleartext to an encrypted communications channel."  );
  ...
  script_dependencies("smtpserver_detect.nasl", "doublecheck_std_services.nasl");
...
soc = smtp_open(port:port, ehlo:compat::this_host());
