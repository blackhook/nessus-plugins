...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : dhcpcd (ZYPP Patch Number 7453)");
...
administrators are advised to check their server setup."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7453.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"dhcpcd-1.3.22pl4-223.18.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, reference:"dhcpcd-1.3.22pl4-223.18.1")) flag++;
