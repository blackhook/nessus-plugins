...
# extracted from SUSE update advisory SUSE-SU-2021:1760-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : hivex (SUSE-SU-2021:1760-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2021/suse-su-20211760-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?288e719c"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2021-1760=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2021-1760=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"hivex-debuginfo-1.3.10-5.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"hivex-debugsource-1.3.10-5.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libhivex0-1.3.10-5.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libhivex0-debuginfo-1.3.10-5.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"perl-Win-Hivex-1.3.10-5.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"perl-Win-Hivex-debuginfo-1.3.10-5.3.1")) flag++;
