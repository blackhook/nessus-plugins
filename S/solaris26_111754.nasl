...
if (description)
{
  ...
  script_name(english:"Solaris 6 (sparc) : 111754-01");
...
if (solaris_check_patch(release:"5.6", arch:"sparc", patch:"111754-01", obsoleted_by:"", package:"SUNWsspop", version:"3.4.0,REV=2000.08.20.19.44") < 0) flag++;
