...
if ( rpm_check(release:"SUSE11.0", reference:"subversion-1.5.7-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"subversion-devel-1.5.7-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"subversion-perl-1.5.7-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"subversion-python-1.5.7-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"subversion-server-1.5.7-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"subversion-tools-1.5.7-0.1") ) flag++;
