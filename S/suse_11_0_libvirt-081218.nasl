...
if ( rpm_check(release:"SUSE11.0", reference:"libvirt-0.4.0-59.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libvirt-devel-0.4.0-59.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libvirt-python-0.4.0-59.4") ) flag++;
