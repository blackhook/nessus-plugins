...
# extracted from openSUSE Security Update clamav-2242.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : clamav (clamav-2242)");
  script_summary(english:"Check for the clamav-2242 patch");
  ...
  script_set_attribute(
    ...
    value:
"The virus scan engine ClamAV was update to version 0.88.6.
...
if ( rpm_check(release:"SUSE10.1", reference:"clamav-0.88.6-1.4") ) flag++;
