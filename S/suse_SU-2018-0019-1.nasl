...
# extracted from SUSE update advisory SUSE-SU-2018:0019-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : kvm (SUSE-SU-2018:0019-1) (Spectre)");
  ...
  script_set_attribute(
    ...
    value:
"This update for kvm fixes the following issues: Also a mitigation for
a security flaw has been applied :
  ...
  - CVE-2017-5715: QEMU was updated to allow passing through
    ...
    the Intel CPU. (bsc#1068032) Security fixes have been
    applied :

  - CVE-2017-2633: Fix various out of bounds access issues
    in the QEMU vnc infrastructure (bsc#1026612)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1fca2553"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"kvm-1.4.2-60.6.1")) flag++;
