...
# extracted from openSUSE Security Update sylpheed-claws-5606.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : sylpheed-claws (sylpheed-claws-5606)");
  script_summary(english:"Check for the sylpheed-claws-5606 patch");
...
programs like sylpheed-claws that are linked against libclamav need to
be updated as well."
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE10.2", reference:"sylpheed-claws-2.5.5-34") ) flag++;
