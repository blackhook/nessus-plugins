...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2479628");
...
control of the affected system."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-012");
  script_set_attribute(
    attribute:"solution",
    value:
