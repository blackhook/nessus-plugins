...
# extracted from openSUSE Security Update acroread-1426.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : acroread (acroread-1426)");
  script_summary(english:"Check for the acroread-1426 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"acroread-8.1.7-0.1.1") ) flag++;
