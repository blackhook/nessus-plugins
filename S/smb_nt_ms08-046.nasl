...
if (description)
{
 ...
 script_xref(name:"IAVA", value:"2008-A-0060-S");
...
file and entice a victim to open it.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?b8797249");
 script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows 2000, XP and
2003.");
 script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
 script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2008-2245");
