...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3132372");
...
affected by multiple vulnerabilities :
  ...
  - Multiple memory corruption issues exist that allow a
    ...
    CVE-2015-8645)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/3132372/microsoft-security-advisory-update-for-vulnerabilities-in-adobe-flash");
...
"Install Microsoft KB3132372.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-8459");
