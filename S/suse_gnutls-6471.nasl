...
# extracted from openSUSE Security Update gnutls-6471.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gnutls (gnutls-6471)");
  script_summary(english:"Check for the gnutls-6471 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"gnutls-1.6.1-36.9") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"gnutls-devel-1.6.1-36.9") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"gnutls-32bit-1.6.1-36.9") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"gnutls-devel-32bit-1.6.1-36.9") ) flag++;
