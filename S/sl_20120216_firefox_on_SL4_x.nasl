...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL4.x i386/x86_64 (20120216)");
...
restarted for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1202&L=scientific-linux-errata&T=0&P=3433
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?79079504"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"firefox-3.6.26-3.el4")) flag++;
if (rpm_check(release:"SL4", reference:"firefox-debuginfo-3.6.26-3.el4")) flag++;
