...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : ethereal (ZYPP Patch Number 6889)");
...
"This update of ethereal fixes :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6889.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"ethereal-0.10.14-16.40.3")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"ethereal-0.10.14-16.40.3")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"ethereal-devel-0.10.14-16.40.3")) flag++;
