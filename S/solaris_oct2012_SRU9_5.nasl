...
if (description)
{
  ...
  script_cve_id("CVE-2012-3208");
  script_bugtraq_id(56069);

  script_name(english:"Oracle Solaris Critical Patch Update : oct2012_SRU9_5");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Products Suite (subcomponent: Kernel/RCTL). Supported
