...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : Zip (YOU Patch Number 9530)");
...
overflow occurs leading to stack corruption and segmentation fault."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 9530.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"zip-2.3-732.4")) flag++;
