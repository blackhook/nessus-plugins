...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2011-B-0048-S");
  script_xref(name:"MSKB", value:"2485663");
...
leveraged to execute arbitrary code subject to the user's privileges.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-033");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for XP and 2003.");
