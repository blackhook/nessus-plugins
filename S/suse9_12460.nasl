...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : Tomcat (YOU Patch Number 12460)");
...
Additionally, non-security bugs were fixed."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12460.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"apache-jakarta-tomcat-connectors-5.0.19-29.23")) flag++;
if (rpm_check(release:"SUSE9", reference:"apache2-jakarta-tomcat-connectors-5.0.19-29.23")) flag++;
if (rpm_check(release:"SUSE9", reference:"jakarta-tomcat-5.0.19-29.23")) flag++;
if (rpm_check(release:"SUSE9", reference:"jakarta-tomcat-doc-5.0.19-29.23")) flag++;
if (rpm_check(release:"SUSE9", reference:"jakarta-tomcat-examples-5.0.19-29.23")) flag++;
