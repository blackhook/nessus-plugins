...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2478953");
...
joined host can exploit this, resulting in a denial of service.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-005");
