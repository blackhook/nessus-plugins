...
if (description)
{
  ...
  script_bugtraq_id(61903);

  script_name(english:"Serv-U FTP Server < 15.0.0.0 Multiple Security Vulnerabilities");
...
prior to version 15.0.0.0. It is, therefore, potentially affected by
multiple vulnerabilities :

  - An unspecified error exists related to SSL that can be
    exploited to cause a denial of service.

  - An unspecified error exists when using the 'Require 
    Fully Qualified Membership' LDAP login settings.");
