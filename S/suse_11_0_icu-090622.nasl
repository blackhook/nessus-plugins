...
# extracted from openSUSE Security Update icu-1028.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : icu (icu-1028)");
  script_summary(english:"Check for the icu-1028 patch");
...
if ( rpm_check(release:"SUSE11.0", reference:"icu-3.8.1-21.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"icu-data-3.8.1-21.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libicu-3.8.1-21.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libicu-devel-3.8.1-21.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libicu-32bit-3.8.1-21.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libicu-devel-32bit-3.8.1-21.2") ) flag++;
