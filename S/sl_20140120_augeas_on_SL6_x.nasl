...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : augeas on SL6.x i386/x86_64 (20140120)");
...
All running applications using augeas must be restarted for the update
to take effect."
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1401&L=scientific-linux-errata&T=0&P=962
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a36b372d"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"augeas-1.0.0-5.el6_5.1")) flag++;
if (rpm_check(release:"SL6", reference:"augeas-debuginfo-1.0.0-5.el6_5.1")) flag++;
if (rpm_check(release:"SL6", reference:"augeas-devel-1.0.0-5.el6_5.1")) flag++;
if (rpm_check(release:"SL6", reference:"augeas-libs-1.0.0-5.el6_5.1")) flag++;
