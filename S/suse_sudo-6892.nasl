...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : sudo (ZYPP Patch Number 6892)");
...
"This update fixes the following security issue :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6892.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"sudo-1.6.8p12-18.17.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"sudo-1.6.8p12-18.17.1")) flag++;
