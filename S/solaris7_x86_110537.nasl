...
if(description)
{
 ...
 name["english"] = "Solaris 7 (i386) : 110537-01";
...
e +=  solaris_check_patch(release:"5.7_x86", arch:"i386", patch:"110537-01", obsoleted_by:"", package:"SUNWab2u", version:"3.0,REV=1999.1209");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
