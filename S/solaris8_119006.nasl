...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 119006-01");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"119006-01", obsoleted_by:"116264-08 ", package:"VRTSnetbp", version:"5.0,REV=2003.11.06.09.24") < 0) flag++;
