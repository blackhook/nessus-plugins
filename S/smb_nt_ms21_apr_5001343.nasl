...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5001343");
  script_xref(name:"MSFT", value:"MS21-5001343");

  script_name(english:"KB5001343: Windows Azure Stack HCI Security Update (Apr 2021)");
...
Nessus has not tested for this issue but has instead relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5001343");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB5001343 to address this issue.");
