...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 108670-21");
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"108670-21", obsoleted_by:"", package:"SUNWx25b", version:"9.2") < 0) flag++;
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"108670-21", obsoleted_by:"", package:"SUNWx25a", version:"9.2") < 0) flag++;
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"108670-21", obsoleted_by:"", package:"SUNWexpx", version:"1.1") < 0) flag++;
