...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libvirt on SL6.x i386/x86_64 (20130128)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1301&L=scientific-linux-errata&T=0&P=3600
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3c7a9340"
  );
