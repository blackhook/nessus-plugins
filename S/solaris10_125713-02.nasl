...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 125713-02");
...
Date this patch was last updated by Sun : Oct/22/07"
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 125713-02");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_cwe_id(134);

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:125713");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"125713-02", obsoleted_by:"", package:"SUNWsrspx", version:"001.002.005") < 0) flag++;
...
if (flag) {
  ...
  audit(AUDIT_PACKAGE_NOT_INSTALLED, "SUNWsrspx");
}
