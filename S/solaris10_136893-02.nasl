...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 136893-02");
  script_summary(english:"Check for patch 136893-02");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 136893-02"
  );
  script_set_attribute(
...
execution."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 136893-02 or higher");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2577");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:136893");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:138403");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"136893-02", obsoleted_by:"", package:"SUNWaccu", version:"11.10.0,REV=2005.01.21.15.53") < 0) flag++;
...
if (flag) {
  ...
  audit(AUDIT_PACKAGE_NOT_INSTALLED, "SUNWaccu");
}
