...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libgcrypt on SL5.x, SL6.x i386/x86_64 (20131024)");
...
portions of the RSA secret key. (CVE-2013-4242)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1310&L=scientific-linux-errata&T=0&P=2624
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?48d61e90"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
