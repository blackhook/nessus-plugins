...
if (description)
{
  ...
  script_cve_id("CVE-2022-21533");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2022_SRU11_4_47_119_2");
...
security update :
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-21533");
...
fix_release = "11.4-11.4.47.0.1.119.2";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.47.0.1.119.2", sru:"11.4.47.119.2") > 0) flag++;
