...
# extracted from openSUSE Security Update clamav-3531.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : clamav (clamav-3531)");
  script_summary(english:"Check for the clamav-3531 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update of ClamAV fixes several security bugs.
...
if ( rpm_check(release:"SUSE10.2", reference:"clamav-0.90.3-2.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"clamav-db-0.90.3-2.1") ) flag++;
