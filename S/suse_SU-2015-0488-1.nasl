...
without introducing additional issues."
  ...
  # https://download.suse.com/patch/finder/?keywords=13586bdce180bbb68a1aee89f5a4dbe2
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1f1edae6"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2014-8500/"
  );
