...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x i386/srpm/x86_64 (20130917)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1309&L=scientific-linux-errata&T=0&P=919
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?72f8a010"
  );
