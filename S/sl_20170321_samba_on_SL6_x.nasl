...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba on SL6.x i386/x86_64 (20170321)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1704&L=scientific-linux-errata&F=&S=&P=4902
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?88233b9d"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libsmbclient-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"libsmbclient-devel-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-client-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-common-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-debuginfo-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-doc-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-domainjoin-gui-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"samba-glusterfs-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-swat-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-winbind-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-winbind-clients-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-winbind-devel-3.6.23-41.el6")) flag++;
if (rpm_check(release:"SL6", reference:"samba-winbind-krb5-locator-3.6.23-41.el6")) flag++;
