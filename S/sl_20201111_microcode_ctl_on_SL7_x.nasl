...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5083");

  script_name(english:"Scientific Linux Security Update : microcode_ctl on SL7.x x86_64 (2020:5083)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205083-1");
...
pkgs = [
    {'reference':'microcode_ctl-2.1-73.2.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'microcode_ctl-debuginfo-2.1-73.2.el7_9', 'cpu':'x86_64', 'release':'SL7'}
];
