...
if (description)
{
  ...
  script_cve_id("CVE-2018-2908");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2018_SRU11_3_32_4_0");
...
fix_release = "0.5.11-0.175.3.32.0.4.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.32.0.4.0", sru:"11.3.32.4.0") > 0) flag++;
