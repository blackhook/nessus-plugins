...
Saving Time (DST) observations :
  ...
  - Several Argentinian provinces decided not to observe
    Daylight Saving."
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0811&L=scientific-linux-errata&T=0&P=306
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?890b0dca"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"tzdata-2008i-1.el3")) flag++;

if (rpm_check(release:"SL4", reference:"tzdata-2008i-1.el4")) flag++;

if (rpm_check(release:"SL5", reference:"tzdata-2008i-1.el5")) flag++;
