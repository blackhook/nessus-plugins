...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 123038-01");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"123038-01", obsoleted_by:"124520-01 ", package:"SUNWsgeex", version:"6.0,REV=2004.06.03.16.00") < 0) flag++;
