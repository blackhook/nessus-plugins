...
if(description)
{
 script_id(24960);
 script_version ("1.8");
 name["english"] = "Solaris 2.6 (sparc) : 110030-02";
...
e +=  solaris_check_patch(release:"5.6", arch:"sparc", patch:"110030-02", obsoleted_by:"", package:"VRTSvmsa", version:"3.0.4,REV=01.28.2000.09.10");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
