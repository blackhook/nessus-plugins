...
user running them. (CVE-2010-4267)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1101&L=scientific-linux-errata&T=0&P=782
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?141f7874"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"hpijs-1.6.7-6.el5_6.1")) flag++;
if (rpm_check(release:"SL5", reference:"hplip-1.6.7-6.el5_6.1")) flag++;
if (rpm_check(release:"SL5", reference:"libsane-hpaio-1.6.7-6.el5_6.1")) flag++;
