...
if (description)
{
  ...
  script_cve_id("CVE-2022-44691");
  script_xref(name:"IAVA", value:"2022-A-0525-S");

  script_name(english:"Security Updates for Microsoft OneNote C2R (December 2022)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft OneNote Products are affected by a remote code execution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The Microsoft OneNote Products are missing a security update. It is, therefore, affected by a remote code execution
vulnerability.
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-44691");
