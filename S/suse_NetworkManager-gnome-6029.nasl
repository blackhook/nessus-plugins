...
# extracted from openSUSE Security Update NetworkManager-gnome-6029.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : NetworkManager-gnome (NetworkManager-gnome-6029)");
  script_summary(english:"Check for the NetworkManager-gnome-6029 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"NetworkManager-gnome-0.6.5-37.6") ) flag++;
