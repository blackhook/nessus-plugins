...
# extracted from SUSE update advisory SUSE-SU-2014:0470-1.
...
if (description)
{
  ...
  script_bugtraq_id(56289, 56498, 56797, 56798, 58880, 59291, 60701, 60702, 60703, 62708, 62935, 63494, 63931, 63983);

  script_name(english:"SUSE SLES10 Security Update : Xen (SUSE-SU-2014:0470-1)");
  ...
  script_set_attribute(
    ...
    value:
"The SUSE Linux Enterprise 10 Service Pack 3 LTSS Xen hypervisor and
toolset have been updated to fix various security issues :

The following security issues have been addressed :

XSA-20: CVE-2012-4535: Xen 3.4 through 4.2, and possibly earlier
versions, allows local guest OS administrators to cause a denial of
service (Xen infinite loop and physical CPU consumption) by setting a
VCPU with an 'inappropriate deadline'. (bnc#786516)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?272d101f"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2014/suse-su-20140470-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9605316d"
  );
...
flag = 0;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-devel-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-doc-html-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-doc-pdf-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-doc-ps-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-debug-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-default-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-kdump-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-smp-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-libs-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-tools-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-tools-domU-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-tools-ioemu-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-libs-32bit-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-bigsmp-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-kdumppae-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-vmi-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"x86_64", reference:"xen-kmp-vmipae-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-devel-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-doc-html-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-doc-pdf-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-doc-ps-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-debug-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-default-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-kdump-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-smp-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-libs-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-tools-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-tools-domU-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-tools-ioemu-3.2.3_17040_28-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-bigsmp-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-kdumppae-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-vmi-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
if (rpm_check(release:"SLES10", sp:"3", cpu:"i586", reference:"xen-kmp-vmipae-3.2.3_17040_28_2.6.16.60_0.113.9-0.6.21.3")) flag++;
