...
# extracted from openSUSE Security Update libsndfile-6044.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libsndfile (libsndfile-6044)");
  script_summary(english:"Check for the libsndfile-6044 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libsndfile-1.0.17-81.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libsndfile-devel-1.0.17-81.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libsndfile-octave-1.0.17-81.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libsndfile-progs-1.0.17-81.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libsndfile-32bit-1.0.17-81.2") ) flag++;
