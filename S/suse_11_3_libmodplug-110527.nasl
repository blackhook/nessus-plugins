...
if ( rpm_check(release:"SUSE11.3", reference:"libmodplug-devel-0.8.8.3-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libmodplug0-0.8.8.3-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libmodplug0-32bit-0.8.8.3-2.3.1") ) flag++;
