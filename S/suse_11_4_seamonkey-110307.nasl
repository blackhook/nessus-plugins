...
# extracted from openSUSE Security Update seamonkey-4113.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : seamonkey (seamonkey-4113)");
  script_summary(english:"Check for the seamonkey-4113 patch");
...
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-2.0.12-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-debuginfo-2.0.12-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-debugsource-2.0.12-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-dom-inspector-2.0.12-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-irc-2.0.12-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-translations-common-2.0.12-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-translations-other-2.0.12-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"seamonkey-venkman-2.0.12-0.3.1") ) flag++;
