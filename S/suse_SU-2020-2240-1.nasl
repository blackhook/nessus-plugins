...
# extracted from SUSE update advisory SUSE-SU-2020:2240-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : xorg-x11-server (SUSE-SU-2020:2240-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?980c492d"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-Product-WE-15-SP2-2020-2240=1

SUSE Linux Enterprise Module for Development Tools 15-SP2 :

zypper in -t patch
SUSE-SLE-Module-Development-Tools-15-SP2-2020-2240=1

SUSE Linux Enterprise Module for Basesystem 15-SP2 :

zypper in -t patch SUSE-SLE-Module-Basesystem-15-SP2-2020-2240=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"2", reference:"xorg-x11-server-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"xorg-x11-server-debuginfo-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"xorg-x11-server-debugsource-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"xorg-x11-server-extra-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"xorg-x11-server-extra-debuginfo-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLES15", sp:"2", reference:"xorg-x11-server-sdk-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"xorg-x11-server-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"xorg-x11-server-debuginfo-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"xorg-x11-server-debugsource-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"xorg-x11-server-extra-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"xorg-x11-server-extra-debuginfo-1.20.3-22.5.1")) flag++;
if (rpm_check(release:"SLED15", sp:"2", reference:"xorg-x11-server-sdk-1.20.3-22.5.1")) flag++;
