...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kernel on SL6.x i386/x86_64 (20170222)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1702&L=scientific-linux-errata&F=&S=&P=4599
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e474db27"
  );
