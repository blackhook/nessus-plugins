...
only on the application's self-reported version number.");
  ...
  # https://download.samba.org/pub/samba/patches/security/samba-4.1.10-CVE-2014-3560.patch
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eca7bc26");
