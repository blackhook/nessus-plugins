...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 150313-06");
  script_summary(english:"Check for patch 150313-06");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 150313-06"
  );
  script_set_attribute(
...
System hang or frequently repeatable crash (complete DOS)."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 150313-06 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-6508");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:148690");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:150313");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"150313-06", obsoleted_by:"", package:"SUNWiscsir", version:"11.10.0,REV=2005.01.04.14.30") < 0) flag++;
...
if (flag) {
  ...
  audit(AUDIT_PACKAGE_NOT_INSTALLED, "SUNWiscsir");
}
