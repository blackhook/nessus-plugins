...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3143693");
  script_xref(name:"IAVB", value:"2016-B-0069-S");
...
exploit this, via a malicious application, to execute arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?6fe051d2");
...
4.6.1.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0148");
