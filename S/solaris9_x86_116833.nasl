...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 116833-04");
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"116833-04", obsoleted_by:"", package:"SUNWebsc", version:"7.2,REV=172") < 0) flag++;
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"116833-04", obsoleted_by:"", package:"SUNWebsm", version:"7.2,REV=172") < 0) flag++;
