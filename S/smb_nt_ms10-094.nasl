...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2010-A-0176-S");
  script_xref(name:"MSKB", value:"2447961");
...
subject to the user's privileges.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?a676a7c1");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows XP, 2003, Vista,
and 2008.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3965");
