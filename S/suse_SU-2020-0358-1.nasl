...
# extracted from SUSE update advisory SUSE-SU-2020:0358-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : wicked (SUSE-SU-2020:0358-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200358-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3078675a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch SUSE-SLE-SAP-12-SP1-2020-358=1

SUSE Linux Enterprise Server 12-SP1-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP1-2020-358=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"wicked-0.6.60-28.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"wicked-debuginfo-0.6.60-28.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"wicked-debugsource-0.6.60-28.26.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"wicked-service-0.6.60-28.26.1")) flag++;
