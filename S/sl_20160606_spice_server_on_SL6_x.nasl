...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : spice-server on SL6.x x86_64 (20160606)");
...
CVE-2016-2150 issue was discovered by Frediano Ziglio (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?876f2005"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"spice-server-0.12.4-13.el6.1")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"spice-server-debuginfo-0.12.4-13.el6.1")) flag++;
if (rpm_check(release:"SL6", cpu:"x86_64", reference:"spice-server-devel-0.12.4-13.el6.1")) flag++;
