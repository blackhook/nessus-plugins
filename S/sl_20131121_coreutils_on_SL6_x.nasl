...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : coreutils on SL6.x i386/x86_64 (20131121)");
...
strings. (CVE-2013-0221, CVE-2013-0222, CVE-2013-0223)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=2698
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e76295f7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
