...
if ( rpm_check(release:"SUSE11.1", reference:"gstreamer-0_10-plugins-bad-0.10.8-6.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"gstreamer-0_10-plugins-bad-devel-0.10.8-6.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"gstreamer-0_10-plugins-bad-lang-0.10.8-6.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libgstapp-0_10-0-0.10.8-6.6.1") ) flag++;
