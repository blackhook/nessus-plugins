...
update, the squid service will be restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1112&L=scientific-linux-errata&T=0&P=1078
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7798b1b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"squid-3.1.10-1.el6_2.1")) flag++;
if (rpm_check(release:"SL6", reference:"squid-debuginfo-3.1.10-1.el6_2.1")) flag++;
