...
if(description)
{
 ...
 script_name(english: "Solaris 5.7 (sparc) : 109734-13");
...
e +=  solaris_check_patch(release:"5.7", arch:"sparc", patch:"109734-13", obsoleted_by:"", package:"SUNWicgSA", version:"3.1,REV=20000427");
e +=  solaris_check_patch(release:"5.7", arch:"sparc", patch:"109734-13", obsoleted_by:"", package:"SUNWicgSS", version:"3.1,REV=20000427");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
