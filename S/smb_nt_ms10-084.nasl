...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2360937");
...
privileges to the NetworkService account.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-084");
