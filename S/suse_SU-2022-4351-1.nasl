...
the SUSE-SU-2022:4351-1 advisory.
...
var pkgs = [
    {'reference':'osc-0.182.0-15.12.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sle-sdk-release-12.5', 'sles-release-12.5']}
];
