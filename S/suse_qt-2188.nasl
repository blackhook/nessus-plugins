...
# extracted from openSUSE Security Update qt-2188.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : qt (qt-2188)");
  script_summary(english:"Check for the qt-2188 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"qt-4.1.0-29.7") ) flag++;
if ( rpm_check(release:"SUSE10.1", cpu:"x86_64", reference:"qt-32bit-4.1.0-29.7") ) flag++;
