...
# extracted from SUSE update advisory SUSE-SU-2020:0131-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : libssh (SUSE-SU-2020:0131-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200131-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?109680e7");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"libssh-debugsource-0.8.7-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libssh4-0.8.7-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libssh4-32bit-0.8.7-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libssh4-debuginfo-0.8.7-3.6.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"libssh4-debuginfo-32bit-0.8.7-3.6.1")) flag++;
