...
if (description)
{
  ...
  script_cve_id("CVE-2020-2565", "CVE-2020-2605", "CVE-2020-2664", "CVE-2020-2680");
  script_xref(name:"IAVA", value:"2020-A-0018-S");

  script_name(english:"Oracle Solaris Critical Patch Update : jan2020_SRU11_4_17_3_0");
...
security updates :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    Systems (component: Consolidation Infrastructure). The
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    ...
    DOS) of Oracle Solaris. (CVE-2020-2605)
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    ...
    DOS) of Oracle Solaris. (CVE-2020-2680)"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2565");
...
fix_release = "11.4-11.4.17.0.1.3.0";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.17.0.1.3.0", sru:"11.4.17.3.0") > 0) flag++;
