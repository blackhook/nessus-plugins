...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : php53 and php on SL5.x, SL6.x i386/x86_64 (20140930)");
...
restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1410&L=scientific-linux-errata&T=0&P=675
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?de0dc0c3"
  );
