...
if (description)
{
  ...
  script_name(english:"Microsoft Windows Server Version 1903 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:
"The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows Server version 1903 is running on the remote host.
Microsoft ended support for Windows Server version 1903 on December 8, 2020.
...
product_name  = "Windows Server version 1903";
tag           = "microsoft:windows_server_1903";
cpe_ver       = "-:*";
...
# Not Windows Server version 1903
if ("10" >!< os || "Windows 10" >< os_name) audit(AUDIT_OS_NOT, product_name);

# Not Build 18362 (version 1903)
if ("18362" != os_build) audit(AUDIT_OS_NOT, product_name);
