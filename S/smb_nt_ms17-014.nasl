...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2017-A-0060-S");
...
Foundation 2013; and Microsoft Office Web Apps Server 2010 and 2013.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-0053");
  ...
  script_dependencies("office_installed.nasl", "microsoft_sharepoint_installed.nbin", "microsoft_owa_installed.nbin", "microsoft_office_compatibility_pack_installed.nbin", "microsoft_excel_viewer_installed.nbin", "microsoft_word_viewer_installed.nbin", "smb_hotfixes.nasl", "ms_bulletin_checks_possible.nasl");
