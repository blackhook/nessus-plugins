...
if ( rpm_check(release:"SUSE11.0", reference:"imap-2006c1_suse-100.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"imap-devel-2006c1_suse-100.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"imap-lib-2006c1_suse-100.3") ) flag++;
