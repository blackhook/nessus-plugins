...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 120544-36 (deprecated)");
  script_summary(english:"Check for patch 120544-36");
...
120544 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/120544-36"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"n/a"
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 120544 instead.");
