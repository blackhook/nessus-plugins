...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : libexif5 (ZYPP Patch Number 3723)");
...
it interprets the EXIF tags in prepared JPEG files. (CVE-2007-2645)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 3723.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:1, reference:"libexif5-0.5.12-17.7")) flag++;
