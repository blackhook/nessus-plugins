...
causing the symbolic links to vanish when the package is updated."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=2917
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e086a96a"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"gimp-1.2.3-20.3.el3")) flag++;
if (rpm_check(release:"SL3", reference:"gimp-devel-1.2.3-20.3.el3")) flag++;
if (rpm_check(release:"SL3", reference:"gimp-perl-1.2.3-20.3.el3")) flag++;

if (rpm_check(release:"SL4", reference:"gimp-2.0.5-6.2.el4")) flag++;
if (rpm_check(release:"SL4", reference:"gimp-devel-2.0.5-6.2.el4")) flag++;

if (rpm_check(release:"SL5", reference:"gimp-2.2.13-2.el5")) flag++;
if (rpm_check(release:"SL5", reference:"gimp-devel-2.2.13-2.el5")) flag++;
if (rpm_check(release:"SL5", reference:"gimp-libs-2.2.13-2.el5")) flag++;
