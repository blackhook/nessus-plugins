...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"926255");
...
service).");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2006/ms06-075");
