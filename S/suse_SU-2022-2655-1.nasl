...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : postgresql-jdbc (SUSE-SU-2022:2655-1)");
...
referenced in the SUSE-SU-2022:2655-1 advisory.
...
var pkgs = [
    {'reference':'postgresql-jdbc-42.2.25-150400.3.3.2', 'sp':'4', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.4', 'SLE_HPC-release-15.4', 'sle-module-server-applications-release-15.4', 'sles-release-15.4']},
    {'reference':'postgresql-jdbc-42.2.25-150400.3.3.2', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']},
    {'reference':'postgresql-jdbc-javadoc-42.2.25-150400.3.3.2', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.4']}
];
