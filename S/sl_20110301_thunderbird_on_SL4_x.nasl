...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1103&L=scientific-linux-errata&T=0&P=706
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a96d5cd4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"thunderbird-1.5.0.12-35.el4")) flag++;

if (rpm_check(release:"SL5", reference:"thunderbird-2.0.0.24-14.el5_6")) flag++;
