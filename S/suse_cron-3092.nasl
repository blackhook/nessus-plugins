...
# extracted from openSUSE Security Update cron-3092.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : cron (cron-3092)");
  script_summary(english:"Check for the cron-3092 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"cron-4.1-45.10.3") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"cron-4.1-70") ) flag++;
