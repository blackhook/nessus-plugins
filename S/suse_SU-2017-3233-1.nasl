...
# extracted from SUSE update advisory SUSE-SU-2017:3233-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : MozillaFirefox (SUSE-SU-2017:3233-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2017/suse-su-20173233-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b29014a"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-MozillaFirefox-13369=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-MozillaFirefox-13369=1

SUSE Linux Enterprise Server 11-SP3-LTSS:zypper in -t patch
slessp3-MozillaFirefox-13369=1

SUSE Linux Enterprise Point of Sale 11-SP3:zypper in -t patch
sleposp3-MozillaFirefox-13369=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-MozillaFirefox-13369=1

SUSE Linux Enterprise Debuginfo 11-SP3:zypper in -t patch
dbgsp3-MozillaFirefox-13369=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"MozillaFirefox-52.5.0esr-72.17.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"MozillaFirefox-translations-52.5.0esr-72.17.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"MozillaFirefox-52.5.0esr-72.17.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"MozillaFirefox-translations-52.5.0esr-72.17.1")) flag++;
