...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libtiff on SL5.x, SL6.x i386/x86_64 (20120410)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1204&L=scientific-linux-errata&T=0&P=834
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7050b985"
  );
