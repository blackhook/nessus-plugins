...
issues: This security issue was fixed :
  ...
  - CVE-2017-2669: Don't double-expand %variables in keys.
    ...
    SSL default ciphers are now used.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1032248"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=854512"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=932386"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2017-2669/"
  );
  # https://www.suse.com/support/update/announcement/2017/suse-su-20171250-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?285d5562"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
