...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : postgresql on SL6.x i386/x86_64 (20160302)");
...
restarted after installing this update."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1603&L=scientific-linux-errata&F=&S=&P=1445
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78662ebe"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"postgresql-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-contrib-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-debuginfo-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-devel-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-docs-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-libs-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-plperl-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-plpython-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-pltcl-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-server-8.4.20-5.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"postgresql-test-8.4.20-5.el6_7")) flag++;
