...
if (description)
{
  ...
  script_cve_id("CVE-2015-4834");

  script_name(english:"Oracle Solaris Critical Patch Update : oct2015_SRU11_2_14_5_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: Utility/Zones).
    The supported version that is affected is 11.2. Very
    ...
    (partial DOS) of Solaris. (CVE-2015-4834)"
  );
  script_set_attribute(
    attribute:"see_also",
...
if (solaris_check_release(release:"0.5.11-0.175.2.14.0.5.0", sru:"S11.2.14.5.0") > 0) flag++;
