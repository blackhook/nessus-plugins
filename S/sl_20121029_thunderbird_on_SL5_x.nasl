...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL5.x, SL6.x i386/x86_64 (20121029)");
...
changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1210&L=scientific-linux-errata&T=0&P=3162
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a213403e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"thunderbird-10.0.10-1.el5_8")) flag++;

if (rpm_check(release:"SL6", reference:"thunderbird-10.0.10-1.el6_3")) flag++;
