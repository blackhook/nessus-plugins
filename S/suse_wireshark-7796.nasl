...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : wireshark (ZYPP Patch Number 7796)");
...
"This update of wireshark fixes the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7796.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"wireshark-1.4.4-0.41.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, reference:"wireshark-1.4.4-0.41.1")) flag++;
if (rpm_check(release:"SLES10", sp:4, reference:"wireshark-devel-1.4.4-0.41.1")) flag++;
