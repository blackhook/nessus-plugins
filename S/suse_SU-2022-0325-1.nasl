...
the SUSE-SU-2022:0325-1 advisory.
...
"Update the affected kgraft-patch-4_4_180-94_138-default and / or kgraft-patch-4_4_180-94_141-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.4.180-94.138-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_138-default-14-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
      ...
      '4.4.180-94.141-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_141-default-13-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']},
          {'reference':'kgraft-patch-4_4_180-94_141-default-13-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      }
    }
  }
