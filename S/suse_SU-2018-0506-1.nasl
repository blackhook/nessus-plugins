...
# extracted from SUSE update advisory SUSE-SU-2018:0506-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : postgresql94 (SUSE-SU-2018:0506-1)");
...
was updated to version 9.4.16, full release notes:
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180506-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?67d2280d"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-postgresql94-13478=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-postgresql94-13478=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-postgresql94-13478=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libpq5-32bit-9.4.16-0.23.13.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"libpq5-32bit-9.4.16-0.23.13.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libecpg6-9.4.16-0.23.13.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libpq5-9.4.16-0.23.13.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-9.4.16-0.23.13.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-contrib-9.4.16-0.23.13.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-docs-9.4.16-0.23.13.2")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"postgresql94-server-9.4.16-0.23.13.2")) flag++;
