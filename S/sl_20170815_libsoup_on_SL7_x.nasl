...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libsoup on SL7.x x86_64 (20170815)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed7a6516"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libsoup-2.56.0-4.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libsoup-debuginfo-2.56.0-4.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libsoup-devel-2.56.0-4.el7_4")) flag++;
