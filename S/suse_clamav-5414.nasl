...
# extracted from openSUSE Security Update clamav-5414.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : clamav (clamav-5414)");
  script_summary(english:"Check for the clamav-5414 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"clamav-0.93.3-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"clamav-db-0.93.3-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"clamav-0.93.3-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"clamav-db-0.93.3-0.1") ) flag++;
