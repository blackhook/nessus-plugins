...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mailman on SL4.x, SL5.x i386/x86_64");
...
CVE-2010-3089)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1103&L=scientific-linux-errata&T=0&P=577
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf6d5590"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"mailman-2.1.5.1-34.rhel4.7")) flag++;

if (rpm_check(release:"SL5", reference:"mailman-2.1.9-6.el5_6.1")) flag++;
