...
if (description)
{
  ...
  script_cve_id("CVE-2023-21715");
  script_xref(name:"IAVA", value:"2023-A-0082-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/03/07");

  script_name(english:"Security Updates for Microsoft Publisher Products C2R (February 2023)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft Publisher Products are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Publisher Products are missing a security update. It is, therefore, affected by a security features
...
manually perform an update.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-21715");
