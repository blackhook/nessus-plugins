...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : mutt (YOU Patch Number 12553)");
...
minor usability bug introduced with the last security update."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12553.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"mutt-1.5.6i-64.14")) flag++;
