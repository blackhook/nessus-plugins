...
if (description)
{
  ...
  script_cve_id("CVE-2022-27667");
  script_xref(name:"IAVA", value:"2023-A-0241");

  script_name(english:"SAP BusinessObjects Business Intelligence Platform Information Disclosure");
...
information disclosure vulnerability. Under certain conditions, SAP BusinessObjects Business Intelligence platform, 
Client Management Console (CMC) - version 430, allows an attacker to access information which would otherwise be 
...
self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3145769");
...
"See vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-27667");
...
var constraints = [
  { 'min_version': '14.3', 'fixed_version' : '14.3.2.4169', 'fixed_display': '4.3 SP002 000200'}
];
