...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"950762");
...
An attacker may exploit this flaw to crash the remote host remotely.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2008/ms08-036");
