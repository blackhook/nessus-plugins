...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : keystone (cve_2014_7144_cryptographic_issues)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2014-7144-cryptographic-issues-vulnerability-in-openstack-keystonemiddleware
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22ee091e"
  );
