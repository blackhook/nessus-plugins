...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 120740-08");
  script_summary(english:"Check for patch 120740-08");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 120740-08"
  );
  script_set_attribute(
...
denial of service (partial DOS) of Solaris."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/120740-08"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 120740-08 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:P/I:P/A:P");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3129");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:120740");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"120740-08", obsoleted_by:"", package:"SUNWgnome-pdf-viewer", version:"2.6.0,REV=10.0.3.2004.12.16.19.39") < 0) flag++;
...
if (flag) {
  ...
  audit(AUDIT_PACKAGE_NOT_INSTALLED, "SUNWgnome-pdf-viewer");
}
