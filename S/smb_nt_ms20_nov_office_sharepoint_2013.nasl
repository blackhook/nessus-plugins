...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4486733");
  script_xref(name:"MSKB", value:"4486723");
  script_xref(name:"MSFT", value:"MS20-4486733");
  script_xref(name:"MSFT", value:"MS20-4486723");
  script_xref(name:"IAVA", value:"2020-A-0514-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0135");

  script_name(english:"Security Updates for Microsoft SharePoint Server 2013 (November 2020)");
...
affected by multiple vulnerabilities :
  ...
  # https://support.microsoft.com/en-us/help/4486733/security-update-for-sharepoint-foundation-2013-nov-10-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0537e479");
  # https://support.microsoft.com/en-us/help/4486723/security-update-for-sharepoint-server-2013-nov-10-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f70d7304");
