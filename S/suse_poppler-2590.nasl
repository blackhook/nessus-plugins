...
# extracted from openSUSE Security Update poppler-2590.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : poppler (poppler-2590)");
  script_summary(english:"Check for the poppler-2590 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"poppler-0.4.4-19.8") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"poppler-devel-0.4.4-19.8") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"poppler-0.5.4-33.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"poppler-devel-0.5.4-33.1") ) flag++;
