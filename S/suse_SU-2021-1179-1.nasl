...
# extracted from SUSE update advisory SUSE-SU-2021:1179-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : xorg-x11-server (SUSE-SU-2021:1179-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?62c79f06"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-2021-1179=1

SUSE Linux Enterprise Server 15-LTSS :

zypper in -t patch SUSE-SLE-Product-SLES-15-2021-1179=1

SUSE Linux Enterprise High Performance Computing 15-LTSS :

zypper in -t patch SUSE-SLE-Product-HPC-15-2021-1179=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"xorg-x11-server-1.19.6-8.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"xorg-x11-server-debuginfo-1.19.6-8.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"xorg-x11-server-debugsource-1.19.6-8.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"xorg-x11-server-extra-1.19.6-8.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"xorg-x11-server-extra-debuginfo-1.19.6-8.30.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", cpu:"s390x", reference:"xorg-x11-server-sdk-1.19.6-8.30.1")) flag++;
