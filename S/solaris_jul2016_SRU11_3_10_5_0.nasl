...
if (description)
{
  ...
  script_cve_id("CVE-2016-3584", "CVE-2016-5469");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2016_SRU11_3_10_5_0");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: Libadimalloc). The
...
fix_release = "0.5.11-0.175.3.10.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.10.0.5.0", sru:"11.3.10.5.0") > 0) flag++;
