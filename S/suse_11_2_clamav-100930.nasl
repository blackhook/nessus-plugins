...
(CVE-2010-3434) and also contains numerous other bug fixes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-10/msg00046.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"clamav-0.96.3-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"clamav-db-0.96.3-0.1.1") ) flag++;
