...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4056888");
  script_xref(name:"IAVA", value:"2018-A-0019");
  script_xref(name:"IAVA", value:"2018-A-0020");
  script_xref(name:"MSFT", value:"MS18-4056888");
  script_xref(name:"MSKB", value:"4075200");
  script_xref(name:"MSFT", value:"MS18-4075200");

  script_name(english:"KB4056888: Windows 10 Version 1511 January 2018 Security Update (Meltdown)(Spectre)");
  script_summary(english:"Checks for rollup.");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote Windows host is missing security update 4056888
or 4075200. It is, therefore, affected by multiple 
vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef8d5cb7");
  # https://support.microsoft.com/en-us/help/4075200/january18-2018kb4075200osbuild10586-1358
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e93e29c");
  ...
  "Apply Cumulative Update KB4056888 or KB4075200.
...
Notes: 
  ...
  - KB4075200 Addresses an issue with KB4056888 where some 
...
if (
  smb_check_rollup(os:"10",
                   ...
                   rollup_date:"01_2018",
                   bulletin:bulletin,
                   rollup_kb_list:[4056888,4075200])
)
{
