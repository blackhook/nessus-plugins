...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3069114");
...
therefore, affected by multiple vulnerabilities in Windows Journal :
  ...
  - A denial of service vulnerability exists in Windows
    ...
    (CVE-2015-2516)");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-098");
