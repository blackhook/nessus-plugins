...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : util-linux for SL4.x i386/x86_64");
...
(CVE-2006-7108)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=2047
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2b74449b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"util-linux-2.12a-16.EL4.25")) flag++;
