...
if (description)
{
  ...
  script_cve_id("CVE-2013-0346");

  script_name(english:"Oracle Solaris Third-Party Patch Update : tomcat (cve_2013_0346_permissions_privileges)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2013-0346-permissions,-privileges,-and-access-control-vulnerability-in-apache-tomcat
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d3c96dfe"
  );
