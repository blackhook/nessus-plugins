...
if ( rpm_check(release:"SUSE11.1", reference:"acroread-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"acroread-cmaps-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"acroread-fonts-ja-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"acroread-fonts-ko-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"acroread-fonts-zh_CN-9.4.1-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"acroread-fonts-zh_TW-9.4.1-0.2.1") ) flag++;
