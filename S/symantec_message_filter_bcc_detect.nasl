...
phishing attacks."
  ...
  script_set_attribute(attribute:"see_also",value:"https://support.symantec.com/content/unifiedweb/en_US/product.messaging-gateway-for-service-providers.html");
  script_set_attribute(
    attribute:"solution",
    value:"n/a"
  );
...
install = add_install(appname:'smf_bcc', ver:version, dir:dir, port:port, cpe: "cpe:/a:symantec:message_filter");
