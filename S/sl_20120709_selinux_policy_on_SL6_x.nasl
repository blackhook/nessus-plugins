...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : selinux-policy on SL6.x i386/x86_64 (20120709)");
...
with the selinux policy."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=993
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d54a1cfa"
  );
