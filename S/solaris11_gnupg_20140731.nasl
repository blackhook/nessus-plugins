...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2013-4351-cryptographic-issues-vulnerability-in-gnupg
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?527e9023"
  );
  # https://blogs.oracle.com/sunsecurity/cve-2013-4402-input-validation-vulnerability-in-gnupg
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5cde1742"
  );
