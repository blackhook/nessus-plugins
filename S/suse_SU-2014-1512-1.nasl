...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : compat-openssl098 (SUSE-SU-2014:1512-1) (POODLE)");
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/support/kb/doc/?id=7015773");
  # https://www.suse.com/support/update/announcement/2014/suse-su-20141512-1.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?629368a5");
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"compat-openssl098-debugsource-0.9.8j-62.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libopenssl0_9_8-0.9.8j-62.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libopenssl0_9_8-debuginfo-0.9.8j-62.1")) flag++;
