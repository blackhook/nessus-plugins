...
# extracted from openSUSE Security Update libxml2-5873.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxml2 (openSUSE-SU-2012:0342-1)");
  script_summary(english:"Check for the libxml2-5873 patch");
...
(CVE-2012-0841)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-03/msg00008.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"libxml2-2.7.8-16.23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libxml2-debuginfo-2.7.8-16.23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libxml2-debugsource-2.7.8-16.23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libxml2-devel-2.7.8-16.23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libxml2-32bit-2.7.8-16.23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libxml2-debuginfo-32bit-2.7.8-16.23.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libxml2-devel-32bit-2.7.8-16.23.1") ) flag++;
