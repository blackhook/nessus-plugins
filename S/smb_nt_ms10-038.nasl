...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"982299");
  script_xref(name:"MSKB", value:"982308");
  script_xref(name:"MSKB", value:"982331");
  script_xref(name:"MSKB", value:"982333");
...
user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-038");
  script_set_attribute(
    attribute:"solution",
    value:
