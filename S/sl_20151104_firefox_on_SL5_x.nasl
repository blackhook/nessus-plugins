...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x, SL7.x i386/x86_64 (20151104)");
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?91b6fce9"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"firefox-38.4.0-1.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"firefox-debuginfo-38.4.0-1.el5_11")) flag++;

if (rpm_check(release:"SL6", reference:"firefox-38.4.0-1.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-38.4.0-1.el6_7")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-38.4.0-1.el7_1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-38.4.0-1.el7_1")) flag++;
