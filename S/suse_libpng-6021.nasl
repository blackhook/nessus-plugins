...
# extracted from openSUSE Security Update libpng-6021.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libpng (libpng-6021)");
  script_summary(english:"Check for the libpng-6021 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libpng-1.2.18-15.10") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libpng-devel-1.2.18-15.10") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libpng-32bit-1.2.18-15.10") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libpng-devel-32bit-1.2.18-15.10") ) flag++;
