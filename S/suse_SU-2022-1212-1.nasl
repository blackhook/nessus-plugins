...
the SUSE-SU-2022:1212-1 advisory.
...
"Update the affected kernel-livepatch-4_12_14-197_92-default and / or kernel-livepatch-4_12_14-197_99-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-197.92-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_92-default-13-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      },
      '4.12.14-197.99-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_99-default-11-150100.2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.1']}
        ]
      }
    }
  }
