...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : pidgin, gaim and finch (ZYPP Patch Number 5573)");
...
connecting to the ICQ network after a server change on July 1st 2008."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2008-2927.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2008-2955.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2008-3532.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 5573.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"finch-2.3.1-10.9")) flag++;
if (rpm_check(release:"SLED10", sp:2, reference:"libpurple-2.3.1-10.9")) flag++;
if (rpm_check(release:"SLED10", sp:2, reference:"pidgin-2.3.1-10.9")) flag++;
