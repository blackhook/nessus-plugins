...
# extracted from openSUSE Security Update finch-6351.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : finch (finch-6351)");
  script_summary(english:"Check for the finch-6351 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"finch-2.3.1-26.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"finch-devel-2.3.1-26.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libpurple-2.3.1-26.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libpurple-devel-2.3.1-26.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libpurple-meanwhile-2.3.1-26.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libpurple-mono-2.3.1-26.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pidgin-2.3.1-26.8") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pidgin-devel-2.3.1-26.8") ) flag++;
