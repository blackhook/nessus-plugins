...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : freeradius on SL7.x x86_64 (20170802)");
...
"Security Fix(es) :
  ...
  - A denial of service flaw was found in the way FreeRADIUS
    server handled certain attributes in request packets. A
    remote attacker could use this flaw to cause the
    FreeRADIUS server to enter an infinite loop, consume
    increasing amounts of memory resources, and ultimately
    crash by sending a specially crafted request packet.
    (CVE-2017-10985)
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cbef98bf"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-debuginfo-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-devel-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-doc-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-krb5-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-ldap-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-mysql-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-perl-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-postgresql-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-python-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-sqlite-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-unixODBC-3.0.13-8.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"freeradius-utils-3.0.13-8.el7_4")) flag++;
