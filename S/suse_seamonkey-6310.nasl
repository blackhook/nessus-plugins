...
# extracted from openSUSE Security Update seamonkey-6310.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : seamonkey (seamonkey-6310)");
  script_summary(english:"Check for the seamonkey-6310 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-1.1.16-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-dom-inspector-1.1.16-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-irc-1.1.16-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-mail-1.1.16-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-spellchecker-1.1.16-1.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-venkman-1.1.16-1.1") ) flag++;
