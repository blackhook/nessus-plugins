...
if (description)
{
  ...
  script_cve_id("CVE-2014-3566", "CVE-2015-4000", "CVE-2016-4350");
  script_bugtraq_id(70574, 74733, 89557);
...
"Upgrade to SolarWinds SRM Profiler version 6.2.3 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-4350");
