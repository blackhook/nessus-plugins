...
linking against libmikmod (CVE-2009-3995, CVE-2009-3996)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-05/msg00002.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"libmikmod-3.1.11a-71.57.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libmikmod-devel-3.1.11a-71.57.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libmikmod-32bit-3.1.11a-71.57.1") ) flag++;
