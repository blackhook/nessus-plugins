...
if (description)
{
  ...
  script_name(english:"SuSE 11.3 Security Update : ntp (SAT Patch Number 10293)");
...
"ntp has been updated to fix four security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=911792"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 10293.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"ntp-4.2.4p8-1.29.32.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"ntp-doc-4.2.4p8-1.29.32.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"ntp-4.2.4p8-1.29.32.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"ntp-doc-4.2.4p8-1.29.32.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"ntp-4.2.4p8-1.29.32.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"ntp-doc-4.2.4p8-1.29.32.1")) flag++;
