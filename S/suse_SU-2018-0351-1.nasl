...
# extracted from SUSE update advisory SUSE-SU-2018:0351-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : Recommended update for libsndfile (SUSE-SU-2018:0351-1)");
  ...
  script_set_attribute(
    ...
    value:
"  - This update for libsndfile fixes a memory leak in an
    error path.(bsc#1038856)

  - CVE-2017-16942: A divide-by-zero error exists in the
    function wav_w64_read_fmt_chunk() in wav_w64.c, which
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1038856"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180351-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?66b04e90"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-libsndfile-13454=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-libsndfile-13454=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-libsndfile-13454=1
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", cpu:"x86_64", reference:"libsndfile-32bit-1.0.20-2.19.7.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", cpu:"s390x", reference:"libsndfile-32bit-1.0.20-2.19.7.3")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"libsndfile-1.0.20-2.19.7.3")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "Recommended update for libsndfile");
}
