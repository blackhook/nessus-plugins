...
if (description)
{
  ...
  script_cve_id("CVE-2017-10042");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2017_SRU11_3_9_4_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: IKE). Supported
    versions that are affected are 10 and 11. Easily
    exploitable vulnerability allows unauthenticated
    attacker with network access via IKE to compromise
