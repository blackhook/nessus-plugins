...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4457146");
  script_xref(name:"MSFT", value:"MS18-4457146");

  script_name(english:"KB4457146: Security update for Adobe Flash Player (September 2018)");
...
"The remote Windows host is missing security update KB4457146. It is,
...
in Adobe Flash Player.");
  ...
  # https://support.microsoft.com/en-us/help/4457146/security-update-for-adobe-flash-player
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b8a82644");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4457146 to address this issue.");
...
# all <= 30.0.0.154
fix = FALSE;
if(ver_compare(ver:iver, fix:"30.0.0.154", strict:FALSE) <= 0)
  fix = "31.0.0.108";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS18-09', kb:'4457146', report);
