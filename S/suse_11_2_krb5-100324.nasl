...
# extracted from openSUSE Security Update krb5-2188.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2010-0628");

  script_name(english:"openSUSE Security Update : krb5 (krb5-2188)");
  script_summary(english:"Check for the krb5-2188 patch");
...
(kadmind) to crash. CVE-2010-0628 has been assigned to this issue."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=582557"
  );
...
if ( rpm_check(release:"SUSE11.2", reference:"krb5-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-apps-clients-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-apps-servers-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-client-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-devel-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-mini-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-mini-devel-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-plugin-kdb-ldap-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-plugin-preauth-pkinit-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"krb5-server-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"krb5-32bit-1.7-6.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"krb5-devel-32bit-1.7-6.4.1") ) flag++;
