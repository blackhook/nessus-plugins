...
the user running Evolution. (CVE-2008-1109)."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0806&L=scientific-linux-errata&T=0&P=432
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c03f9d22"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL5", reference:"evolution-2.12.3-8.el5_2.2")) flag++;
if (rpm_check(release:"SL5", reference:"evolution-devel-2.12.3-8.el5_2.2")) flag++;
if (rpm_check(release:"SL5", reference:"evolution-help-2.12.3-8.el5_2.2")) flag++;
