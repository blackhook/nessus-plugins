...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tzdata enhancement update on SL5.x, SL6.x i386/x86_64 (20121126)");
...
related problems such as ntp sync errors."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1211&L=scientific-linux-errata&T=0&P=2357
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39c0fcbf"
  );
  script_set_attribute(
    attribute:"solution", 
