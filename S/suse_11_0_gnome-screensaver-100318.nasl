...
if ( rpm_check(release:"SUSE11.0", reference:"gnome-screensaver-2.22.2-24.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"gnome-screensaver-lang-2.22.2-24.2") ) flag++;
