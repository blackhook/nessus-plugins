...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : Cyrus IMAPD (SAT Patch Number 1335)");
...
handling of long headers was improved."
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 1335.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:0, reference:"cyrus-imapd-2.3.11-60.21.1")) flag++;
if (rpm_check(release:"SLES11", sp:0, reference:"perl-Cyrus-IMAP-2.3.11-60.21.1")) flag++;
if (rpm_check(release:"SLES11", sp:0, reference:"perl-Cyrus-SIEVE-managesieve-2.3.11-60.21.1")) flag++;
