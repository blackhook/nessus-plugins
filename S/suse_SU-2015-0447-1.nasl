...
without introducing additional issues."
  ...
  # https://download.suse.com/patch/finder/?keywords=05f52c1e0f407db47eeda7f443c74a59
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bb48d3b4"
  );
  # https://download.suse.com/patch/finder/?keywords=620f31f396ab13eab1f112060f474aba
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b1ea9cff"
  );
  # https://download.suse.com/patch/finder/?keywords=a337580683ba9ef729d391b0364a996a
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78e37051"
  );
  script_set_attribute(
    attribute:"see_also",
...
os_ver = os_ver[1];
if (! preg(pattern:"^(SLES10|SLES11)$", string:os_ver)) audit(AUDIT_OS_NOT, "SUSE SLES10 / SLES11", "SUSE " + os_ver);
