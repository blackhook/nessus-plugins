...
# extracted from openSUSE Security Update libpng-devel-528.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpng-devel (libpng-devel-528)");
  script_summary(english:"Check for the libpng-devel-528 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"libpng-devel-1.2.31-4.36.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpng12-0-1.2.31-4.36.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpng3-1.2.31-4.36.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libpng-devel-32bit-1.2.31-4.36.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libpng12-0-32bit-1.2.31-4.36.1") ) flag++;
