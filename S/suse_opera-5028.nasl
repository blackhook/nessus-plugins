...
# extracted from openSUSE Security Update opera-5028.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : opera (opera-5028)");
  script_summary(english:"Check for the opera-5028 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"opera-9.26-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"opera-9.26-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"opera-9.26-0.1") ) flag++;
