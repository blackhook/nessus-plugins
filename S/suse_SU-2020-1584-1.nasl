...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1172461"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1172506"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-13777/"
  );
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201584-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1e9bac7c"
  );
  script_set_attribute(
    attribute:"solution",
    value:
