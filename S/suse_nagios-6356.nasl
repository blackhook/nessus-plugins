...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : nagios (ZYPP Patch Number 6356)");
...
fixed. CVE-2009-2288 has been assigned to this issue."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6356.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:2, reference:"nagios-2.6-13.19")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"nagios-www-2.6-13.19")) flag++;
