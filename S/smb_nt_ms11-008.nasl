...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2434737");
...
specially crafted Visio file, resulting in arbitrary code execution.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-008");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-11-063/");
