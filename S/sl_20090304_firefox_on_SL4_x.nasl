...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0903&L=scientific-linux-errata&T=0&P=742
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf2db023"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"firefox-3.0.7-1.el4")) flag++;

if (rpm_check(release:"SL5", reference:"firefox-3.0.7-1.el5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-1.9.0.7-1.el5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-1.9.0.7-1.el5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-unstable-1.9.0.7-1.el5")) flag++;
