...
# extracted from openSUSE Security Update opera-2673.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (openSUSE-SU-2010:0368-1)");
  script_summary(english:"Check for the opera-2673 patch");
...
document with many IFRAME elements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-07/msg00008.html"
  );
...
if ( rpm_check(release:"SUSE11.2", reference:"opera-10.60-0.1.1") ) flag++;
