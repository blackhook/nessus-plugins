...
# extracted from SUSE update advisory SUSE-SU-2016:0622-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED11 Security Update : libssh (SUSE-SU-2016:0622-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20160622-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?69605db1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch dbgsp4-libssh-12430=1
...
flag = 0;
if (rpm_check(release:"SLED11", sp:"4", cpu:"x86_64", reference:"libssh2-0.2-5.22.1")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"i586", reference:"libssh2-0.2-5.22.1")) flag++;
