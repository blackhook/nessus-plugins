...
# extracted from SUSE update advisory SUSE-SU-2018:0235-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : gd (SUSE-SU-2018:0235-1)");
  ...
  script_set_attribute(
    ...
    value:
"This update for gd fixes several issues. This security issue was 
fixed :
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1025223"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2018/suse-su-20180235-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?84cd6ff9"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"gd-2.0.36.RC1-52.33.5.1")) flag++;
