...
if (description)
{
  ...
  script_xref(name:"MSFT", value:"MS16-152");
  ...
  script_name(english:"MS16-152: Security Update for Windows Kernel (3199709)");
...
Windows kernel due to improper handling of page fault system calls. A
local attacker can exploit this, via a specially crafted application,
to disclose sensitive information.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-152");
...
"Microsoft has released a set of patches for Windows 10 and 2016.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7258");
