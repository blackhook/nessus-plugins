...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : thunderbird on SL5.x, SL6.x i386/x86_64 (20140319)");
...
changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1403&L=scientific-linux-errata&T=0&P=1824
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?277ed738"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
