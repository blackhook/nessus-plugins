...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : vsftpd (ZYPP Patch Number 5388)");
...
the same file name that lead to a corrupted file on the server."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 5388.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:1, reference:"vsftpd-2.0.4-19.18")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"vsftpd-2.0.4-19.18")) flag++;
