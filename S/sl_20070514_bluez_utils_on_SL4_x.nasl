...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bluez-utils on SL4.x i386/x86_64");
...
Bluetooth connection without any authorization. (CVE-2006-6899)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=2167
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?035f0b80"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"bluez-utils-2.10-2.2")) flag++;
if (rpm_check(release:"SL4", reference:"bluez-utils-cups-2.10-2.2")) flag++;
