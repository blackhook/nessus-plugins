...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : spice-xpi on SL5.x,SL6.x i386/x86_64");
...
files accessible to the user running Firefox. (CVE-2011-0012)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1104&L=scientific-linux-errata&T=0&P=1204
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b37e9a96"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"spice-xpi-2.2-2.3.el5_6.1")) flag++;

if (rpm_check(release:"SL6", reference:"spice-xpi-2.4-1.el6_0.2")) flag++;
