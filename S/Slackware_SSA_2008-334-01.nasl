...
# extracted from Slackware Security Advisory 2008-334-01. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2008-1447", "CVE-2008-3905");
  script_bugtraq_id(30131);
  script_xref(name:"SSA", value:"2008-334-01");
  script_xref(name:"IAVA", value:"2008-A-0045");

  script_name(english:"Slackware 11.0 / 12.0 / 12.1 : ruby (SSA:2008-334-01)");
...
fix bugs and a security issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3dfa6b04"
  );
...
flag = 0;
if (slackware_check(osver:"11.0", pkgname:"ruby", pkgver:"1.8.6_p287", pkgarch:"i486", pkgnum:"1_slack11.0")) flag++;

if (slackware_check(osver:"12.0", pkgname:"ruby", pkgver:"1.8.6_p287", pkgarch:"i486", pkgnum:"1_slack12.0")) flag++;

if (slackware_check(osver:"12.1", pkgname:"ruby", pkgver:"1.8.6_p287", pkgarch:"i486", pkgnum:"1_slack12.1")) flag++;
