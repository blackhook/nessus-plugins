...
if ( rpm_check(release:"SUSE11.0", reference:"NetworkManager-0.7.0.r3685-7.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"NetworkManager-devel-0.7.0.r3685-7.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"NetworkManager-glib-0.7.0.r3685-7.4") ) flag++;
