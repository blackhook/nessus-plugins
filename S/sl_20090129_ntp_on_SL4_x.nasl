...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ntp on SL4.x, SL5.x i386/x86_64");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0901&L=scientific-linux-errata&T=0&P=1899
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c160af07"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"ntp-4.2.0.a.20040617-8.el4_7.1")) flag++;

if (rpm_check(release:"SL5", reference:"ntp-4.2.2p1-9.el5_3.1")) flag++;
