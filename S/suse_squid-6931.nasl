...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : squid (ZYPP Patch Number 6931)");
...
"The following vulnerabilities have been fixed in squid :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6931.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"squid-2.5.STABLE12-18.13.982.2.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"squid-2.5.STABLE12-18.13.982.2.1")) flag++;
