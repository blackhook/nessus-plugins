...
a crafted PDF file. (CVE-2010-2575)."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libkdcraw8");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libkexiv2-8");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libkipi7");
...
if ( rpm_check(release:"SUSE11.3", reference:"gwenview-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kcolorchooser-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kdegraphics4-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kgamma-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kio_kamera-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kolourpaint-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kruler-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"ksnapshot-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkdcraw-devel-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkdcraw8-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkexiv2-8-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkexiv2-devel-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkipi-devel-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkipi7-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libksane-devel-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libksane0-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"okular-4.4.4-2.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"okular-devel-4.4.4-2.1.1") ) flag++;
