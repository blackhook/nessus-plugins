...
# extracted from openSUSE Security Update sudo-5962.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : sudo (sudo-5962)");
  script_summary(english:"Check for the sudo-5962 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"sudo-1.6.9p2-23.4") ) flag++;
