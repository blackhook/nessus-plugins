...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2926765");
  script_xref(name:"MSKB", value:"2962123");
...
host under the privileges of the Local System account.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-027");
