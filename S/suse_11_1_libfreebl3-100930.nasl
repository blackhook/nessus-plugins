...
if ( rpm_check(release:"SUSE11.1", reference:"libfreebl3-3.12.8-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-nspr-4.8.6-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-nspr-devel-4.8.6-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-nss-3.12.8-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-nss-devel-3.12.8-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-nss-tools-3.12.8-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libfreebl3-32bit-3.12.8-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-nspr-32bit-4.8.6-1.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-nss-32bit-3.12.8-1.1.1") ) flag++;
