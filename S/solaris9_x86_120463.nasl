...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 120463-07");
  script_summary(english:"Check for patch 120463-07");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 120463-07"
  );
  script_set_attribute(
...
frequently repeatable crash (complete DOS)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/120463-07"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"120463-07", obsoleted_by:"", package:"SUNWcsr", version:"11.9.0,REV=2002.11.04.02.51") < 0) flag++;
