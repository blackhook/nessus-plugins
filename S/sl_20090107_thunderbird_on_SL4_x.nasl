...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0901&L=scientific-linux-errata&T=0&P=78
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1adf76f4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"thunderbird-1.5.0.12-18.el4")) flag++;

if (rpm_check(release:"SL5", reference:"thunderbird-2.0.0.19-1.el5_2")) flag++;
