...
# extracted from SUSE update advisory SUSE-SU-2014:1464-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : wget (SUSE-SU-2014:1464-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2014/suse-su-20141464-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74b49ab9"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"wget-1.14-7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"wget-debuginfo-1.14-7.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"wget-debugsource-1.14-7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"wget-1.14-7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"wget-debuginfo-1.14-7.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"wget-debugsource-1.14-7.1")) flag++;
