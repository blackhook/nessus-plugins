...
arbitrary html (CVE-2011-3635)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-11/msg00021.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"empathy-2.30.1-3.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"empathy-lang-2.30.1-3.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"nautilus-sendto-plugin-empathy-2.30.1-3.5.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "empathy / empathy-lang / nautilus-sendto-plugin-empathy");
}
