...
Firefox. (CVE-2008-1380)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0804&L=scientific-linux-errata&T=0&P=718
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78b94462"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"firefox-1.5.0.12-0.15.el4")) flag++;

if (rpm_check(release:"SL5", reference:"firefox-1.5.0.12-15.el5_1")) flag++;
if (rpm_check(release:"SL5", reference:"firefox-devel-1.5.0.12-15.el5_1")) flag++;
