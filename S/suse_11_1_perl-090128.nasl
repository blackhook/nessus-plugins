...
if ( rpm_check(release:"SUSE11.1", reference:"perl-5.10.0-62.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"perl-base-5.10.0-62.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"perl-32bit-5.10.0-62.17.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"perl-base-32bit-5.10.0-62.17.1") ) flag++;
