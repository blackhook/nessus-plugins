...
therefore the build script now uses bsdtar instead (CVE-2010-4226)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-03/msg00008.html"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected build package.");
...
if ( rpm_check(release:"SUSE11.2", reference:"build-2010.07.28-1.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "build");
}
