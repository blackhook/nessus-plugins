...
context of the user every time a user visits the compromised page.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0703a0d6");
...
version and patch to apply.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-0743");
...
foreach install (installs[1])
{
  ...
  if (release == '2018' && ver_compare(ver:update, fix:'3.2', minver:'2', strict:FALSE) <= 0 && !isnull(ver_compare(ver:update, fix:'3.2', minver:'2', strict:FALSE)))
  {
