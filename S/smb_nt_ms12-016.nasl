...
if (description)
{
  ...
  script_xref(name:"MSKB", value: "2668562");
  script_xref(name:"MSKB", value: "2633869");
  script_xref(name:"MSKB", value: "2638804");
  script_xref(name:"MSKB", value: "2633870");
  script_xref(name:"MSKB", value: "2633873");
  script_xref(name:"MSKB", value: "2633879");
  script_xref(name:"MSKB", value: "2633877");
  script_xref(name:"MSKB", value: "2633874");
  script_xref(name:"MSKB", value: "2633880");
...
run XAML Browser Applications (XBAPs) or Silverlight applications."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-016");
  script_set_attribute(
    attribute:"solution",
    value:
