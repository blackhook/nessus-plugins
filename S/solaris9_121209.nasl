...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 121209-01");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"121209-01", obsoleted_by:"", package:"SUNWlzag", version:"2.0,REV=rr24") < 0) flag++;
