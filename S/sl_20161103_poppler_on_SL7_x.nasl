...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : poppler on SL7.x x86_64 (20161103)");
...
"Security Fix(es) :
  ...
  - A heap-buffer overflow was found in the poppler library.
    An attacker could create a malicious PDF file that would
    cause applications that use poppler (such as Evince) to
    crash or, potentially, execute arbitrary code when
    opened. (CVE-2015-8868)
...
Additional Changes :"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a61cbde5"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-cpp-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-cpp-devel-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-debuginfo-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-demos-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-devel-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-glib-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-glib-devel-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-qt-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-qt-devel-0.26.5-16.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"poppler-utils-0.26.5-16.el7")) flag++;
