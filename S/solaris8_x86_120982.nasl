...
if(description)
{
 ...
 script_name(english: "Solaris 5.8 (x86) : 120982-18");
...
e +=  solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"120982-18", obsoleted_by:"", package:"SUNWproxy", version:"4.0,REV=2005.08.18.08.09");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
