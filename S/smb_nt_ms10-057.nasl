...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2264397");
  script_xref(name:"MSKB", value:"2264403");
...
user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-057");
  script_set_attribute(
    attribute:"solution",
    value:
