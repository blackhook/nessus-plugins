...
# extracted from openSUSE Security Update xine-devel-861.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xine-devel (xine-devel-861)");
  script_summary(english:"Check for the xine-devel-861 patch");
...
if ( rpm_check(release:"SUSE11.0", reference:"xine-devel-1.1.12-8.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"xine-extra-1.1.12-8.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"xine-lib-1.1.12-8.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"xine-lib-32bit-1.1.12-8.7") ) flag++;
