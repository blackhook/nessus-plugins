...
var pkgs = [
    {'reference':'terraform-provider-helm-2.9.0-150100.3.6.3', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-public-cloud-release-15.1', 'sles-release-15.1']}
];
