...
flaw to hijack user sessions. (CVE-2009-0030)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0901&L=scientific-linux-errata&T=0&P=1638
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d953674a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"squirrelmail-1.4.8-9.el3")) flag++;

if (rpm_check(release:"SL4", reference:"squirrelmail-1.4.8-5.el4_7.3")) flag++;

if (rpm_check(release:"SL5", reference:"squirrelmail-1.4.8-5.el5_2.3")) flag++;
