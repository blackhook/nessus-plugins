...
# extracted from openSUSE Security Update MozillaThunderbird-3546.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaThunderbird (MozillaThunderbird-3546)");
  script_summary(english:"Check for the MozillaThunderbird-3546 patch");
...
if ( rpm_check(release:"SUSE10.2", reference:"MozillaThunderbird-1.5.0.12-3.2") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"MozillaThunderbird-translations-1.5.0.12-3.2") ) flag++;
