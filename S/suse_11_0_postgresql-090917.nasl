...
if ( rpm_check(release:"SUSE11.0", reference:"postgresql-8.3.8-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"postgresql-contrib-8.3.8-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"postgresql-devel-8.3.8-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"postgresql-libs-8.3.8-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"postgresql-server-8.3.8-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"postgresql-libs-32bit-8.3.8-0.1") ) flag++;
