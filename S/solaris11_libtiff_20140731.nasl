...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2013-4243-buffer-errors-vulnerability-in-libtiff"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2013-4244-buffer-errors-vulnerability-in-libtiff"
  );
