...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : python-paste-script on SL6.x i386/x86_64 (20120827)");
...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1208&L=scientific-linux-errata&T=0&P=2699
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2bbe8b35"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:python-paste-script");
