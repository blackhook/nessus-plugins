...
# extracted from openSUSE Security Update gstreamer010-plugins-good-6008.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gstreamer010-plugins-good (gstreamer010-plugins-good-6008)");
  script_summary(english:"Check for the gstreamer010-plugins-good-6008 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"gstreamer010-plugins-good-0.10.6-41.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"gstreamer010-plugins-good-extra-0.10.6-41.4") ) flag++;
