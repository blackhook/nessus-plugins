...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5402");

  script_name(english:"Scientific Linux Security Update : libexif on SL7.x i686/x86_64 (2020:5402)");
...
SLSA-2020:5402-1 advisory.

  - libexif: out of bounds write due to an integer overflow in exif-entry.c (CVE-2020-0452)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205402-1");
...
pkgs = [
    {'reference':'libexif-0.6.22-2.el7_9', 'cpu':'i686', 'release':'SL7'},
    {'reference':'libexif-0.6.22-2.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'libexif-debuginfo-0.6.22-2.el7_9', 'cpu':'i686', 'release':'SL7'},
    {'reference':'libexif-debuginfo-0.6.22-2.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'libexif-devel-0.6.22-2.el7_9', 'cpu':'i686', 'release':'SL7'},
    {'reference':'libexif-devel-0.6.22-2.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'libexif-doc-0.6.22-2.el7_9', 'cpu':'x86_64', 'release':'SL7'}
];
