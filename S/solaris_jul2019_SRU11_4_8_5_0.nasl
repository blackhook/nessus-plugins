...
if (description)
{
  ...
  script_cve_id("CVE-2019-2804", "CVE-2019-5597");

  script_name(english:"Oracle Solaris Critical Patch Update : jul2019_SRU11_4_8_5_0");
...
security updates :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    Sun Systems Products Suite (component: Filesystem).
