...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 139463-02"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Mar/05/09"
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 139463-02");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_cwe_id(264, 399);

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:139463");
...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"139463-02", obsoleted_by:"141415-09 141445-09 140109-02 141734-02 ", package:"SUNWnfsskr", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
