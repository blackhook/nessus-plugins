...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"892313");
...
a license to read the file.");
  script_set_attribute(attribute:"see_also", value:"http://www.benedelman.org/news-010205/");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/892313/fix-updates-for-windows-media-player-9-series-and-for-windows-media-pl");
