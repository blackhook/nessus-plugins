...
if (description)
{
  ...
  script_name(english:"SuSE 11.2 Security Update : nagios (SAT Patch Number 7328)");
  ...
  script_set_attribute(
    ...
    value:
"This update fixes a stack overflow in nagios web interface.
CVE-2012-6096 has been assigned."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2012-6096.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 7328.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:2, reference:"nagios-3.0.6-1.25.28.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, reference:"nagios-www-3.0.6-1.25.28.1")) flag++;
