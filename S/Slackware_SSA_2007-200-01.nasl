...
# extracted from Slackware Security Advisory 2007-200-01. The text 
...
if (description)
{
  ...
  script_xref(name:"SSA", value:"2007-200-01");

  script_name(english:"Slackware 11.0 / 12.0 : firefox (SSA:2007-200-01)");
...
well on earlier Slackware systems."
  ...
  # http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.378219
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea3db745"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (slackware_check(osver:"11.0", pkgname:"mozilla-firefox", pkgver:"2.0.0.5", pkgarch:"i686", pkgnum:"1")) flag++;

if (slackware_check(osver:"12.0", pkgname:"mozilla-firefox", pkgver:"2.0.0.5", pkgarch:"i686", pkgnum:"1")) flag++;
