...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0906&L=scientific-linux-errata&T=0&P=1808
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?269bed0e"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"net-snmp-5.0.9-2.30E.28")) flag++;
if (rpm_check(release:"SL3", reference:"net-snmp-devel-5.0.9-2.30E.28")) flag++;
if (rpm_check(release:"SL3", reference:"net-snmp-libs-5.0.9-2.30E.28")) flag++;
if (rpm_check(release:"SL3", reference:"net-snmp-perl-5.0.9-2.30E.28")) flag++;
if (rpm_check(release:"SL3", reference:"net-snmp-utils-5.0.9-2.30E.28")) flag++;
