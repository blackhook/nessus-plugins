...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2010-A-0173-S");
  script_xref(name:"MSFT", value:"MS10-096");
  script_xref(name:"MSKB", value:"2423089");
...
to the user's privileges.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?7936f9a2");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows XP, 2003, Vista,
2008, 7, and 2008 R2.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3147");
