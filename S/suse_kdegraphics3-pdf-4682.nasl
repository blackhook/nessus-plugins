...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : kdegraphics3-pdf (ZYPP Patch Number 4682)");
...
(CVE-2007-4352 / CVE-2007-5392 / CVE-2007-5393)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 4682.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:1, reference:"kdegraphics3-pdf-3.5.1-23.20")) flag++;
if (rpm_check(release:"SLES10", sp:1, reference:"kdegraphics3-pdf-3.5.1-23.20")) flag++;
