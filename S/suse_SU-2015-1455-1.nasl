...
# extracted from SUSE update advisory SUSE-SU-2015:1455-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED11 / SLES11 Security Update : kvm (SUSE-SU-2015:1455-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2015/suse-su-20151455-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?77d090c7"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"kvm-1.4.2-32.1")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"x86_64", reference:"kvm-1.4.2-32.1")) flag++;
if (rpm_check(release:"SLED11", sp:"4", cpu:"i586", reference:"kvm-1.4.2-32.1")) flag++;
