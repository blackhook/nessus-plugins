...
# extracted from openSUSE Security Update clamav-2263.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav (openSUSE-SU-2010:0149-1)");
  script_summary(english:"Check for the clamav-2263 patch");
  ...
  script_set_attribute(
    ...
    value:
"clamav has been updated to version 0.96.
...
optimizations."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-04/msg00079.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"clamav-0.96-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"clamav-db-0.96-0.3.1") ) flag++;
