...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libpng on SL7.x x86_64 (20151209)");
...
application using the library. (CVE-2015-8126, CVE-2015-8472)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1512&L=scientific-linux-errata&F=&S=&P=18455
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bc53c4e3"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libpng-1.5.13-7.el7_2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libpng-debuginfo-1.5.13-7.el7_2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libpng-devel-1.5.13-7.el7_2")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"libpng-static-1.5.13-7.el7_2")) flag++;
