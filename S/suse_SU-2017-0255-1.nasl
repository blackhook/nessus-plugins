...
# extracted from SUSE update advisory SUSE-SU-2017:0255-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : ntp (SUSE-SU-2017:0255-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b30ab970"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"3", reference:"ntp-4.2.8p9-48.9.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"ntp-doc-4.2.8p9-48.9.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"ntp-4.2.8p9-48.9.1")) flag++;
if (rpm_check(release:"SLES11", sp:"2", reference:"ntp-doc-4.2.8p9-48.9.1")) flag++;
