...
the SUSE-SU-2022:0576-1 advisory.
...
var pkgs = [
    {'reference':'ucode-intel-20220207-3.38.1', 'sp':'5', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']}
];
