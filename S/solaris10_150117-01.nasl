...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 150117-01"
  );
  script_set_attribute(
...
System hang or frequently repeatable crash (complete DOS)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/150117-01"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 150117-01 or higher");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:150117");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"150117-01", obsoleted_by:"148888-04 ", package:"SUNWckr", version:"11.10.0,REV=2005.01.21.15.53") < 0) flag++;
