...
if (description)
{
  ...
  script_name(english:"SuSE 11 Security Update : libapr (SAT Patch Number 1374)");
...
remotely. (CVE-2009-2412)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 1374.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:0, reference:"libapr-util1-1.3.4-12.20.2")) flag++;
if (rpm_check(release:"SLES11", sp:0, reference:"libapr1-1.3.3-11.16.1")) flag++;
