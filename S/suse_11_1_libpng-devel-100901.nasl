...
# extracted from openSUSE Security Update libpng-devel-3065.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpng-devel (openSUSE-SU-2010:0594-1)");
  script_summary(english:"Check for the libpng-devel-3065 patch");
...
(CVE-2010-1205, CVE-2010-2249)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-09/msg00010.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"libpng-devel-1.2.31-4.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpng12-0-1.2.31-4.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpng3-1.2.31-4.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libpng-devel-32bit-1.2.31-4.40.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libpng12-0-32bit-1.2.31-4.40.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libpng-devel / libpng-devel-32bit / libpng12-0 / libpng12-0-32bit / etc");
}
