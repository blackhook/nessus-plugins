...
# extracted from openSUSE Security Update OpenOffice_org-2682.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : OpenOffice_org (OpenOffice_org-2682)");
  script_summary(english:"Check for the OpenOffice_org-2682 patch");
...
This update also brings OpenOffice_org to version 2.0.4.17, same as
SUSE Linux Enterprise Desktop 10 and contains lots of bugfixes.
...
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-af-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ar-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-be-BY-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-bg-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ca-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-cs-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-cy-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-da-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-de-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-el-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-en-GB-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-es-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-et-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-fi-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-fr-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-galleries-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-gnome-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-gu-IN-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-hi-IN-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-hr-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-hu-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-it-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ja-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-kde-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-km-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ko-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-lt-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-mk-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-mono-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-nb-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-nl-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-nn-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-officebean-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-pa-IN-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-pl-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-pt-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-pt-BR-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ru-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-rw-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-sk-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-sl-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-sr-CS-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-st-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-sv-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-tr-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-ts-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-vi-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-xh-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-zh-CN-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-zh-TW-2.0.4-38.2.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"OpenOffice_org-zu-2.0.4-38.2.3") ) flag++;
