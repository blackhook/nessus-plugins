...
# extracted from openSUSE Security Update opera-116.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (opera-116)");
  script_summary(english:"Check for the opera-116 patch");
...
read a canvas image."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=411499"
  );
...
if ( rpm_check(release:"SUSE11.0", reference:"opera-9.51-7.1") ) flag++;
