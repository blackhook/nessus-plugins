...
# extracted from openSUSE Security Update MozillaThunderbird-1091.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird (MozillaThunderbird-1091)");
  script_summary(english:"Check for the MozillaThunderbird-1091 patch");
...
fixes various bugs and security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=515950"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"MozillaThunderbird-2.0.0.22-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaThunderbird-devel-2.0.0.22-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaThunderbird-translations-2.0.0.22-0.1.1") ) flag++;
