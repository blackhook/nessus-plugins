...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : clamav (YOU Patch Number 12662)");
...
bug fixes."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12662.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"clamav-0.96.4-0.1")) flag++;
