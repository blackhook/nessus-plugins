...
# extracted from openSUSE Security Update opera-5867.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : opera (opera-5867)");
  script_summary(english:"Check for the opera-5867 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"opera-9.63-1.1") ) flag++;
