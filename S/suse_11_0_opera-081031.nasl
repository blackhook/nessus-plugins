...
# extracted from openSUSE Security Update opera-276.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (opera-276)");
  script_summary(english:"Check for the opera-276 patch");
...
http://www.opera.com/docs/changelogs/linux/962/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=438134"
  );
...
if ( rpm_check(release:"SUSE11.0", reference:"opera-9.62-0.1") ) flag++;
