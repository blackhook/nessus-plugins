...
# extracted from SUSE update advisory SUSE-SU-2015:1173-1.
...
if (description)
{
  ...
  script_bugtraq_id(73950, 74045);

  script_name(english:"SUSE SLED11 / SLES11 Security Update : ntp (SUSE-SU-2015:1173-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=935409"
  );
  # https://download.suse.com/patch/finder/?keywords=01d100dcc703803037ff705ec9182df6
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e9a55d07"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6b36fca1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"3", reference:"ntp-4.2.4p8-1.29.36.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"ntp-doc-4.2.4p8-1.29.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:"3", cpu:"x86_64", reference:"ntp-4.2.4p8-1.29.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:"3", cpu:"x86_64", reference:"ntp-doc-4.2.4p8-1.29.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:"3", cpu:"i586", reference:"ntp-4.2.4p8-1.29.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:"3", cpu:"i586", reference:"ntp-doc-4.2.4p8-1.29.36.1")) flag++;
