...
referenced in the SUSE-SU-2022:2750-1 advisory.
...
var kernel_live_checks = [
  {
    'kernels': {
      ...
      '4.12.14-150000.150.89-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-150000_150_89-default-6-150000.2.2', 'sp':'0', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15']}
        ]
      }
    }
  }
