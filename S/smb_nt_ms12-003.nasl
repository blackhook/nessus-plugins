...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2646524");
...
complete control of the affected system."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-003");
  script_set_attribute(
    attribute:"solution",
    value:
