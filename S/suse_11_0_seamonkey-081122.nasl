...
# extracted from openSUSE Security Update seamonkey-326.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : seamonkey (seamonkey-326)");
  script_summary(english:"Check for the seamonkey-326 patch");
...
if ( rpm_check(release:"SUSE11.0", reference:"seamonkey-1.1.13-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"seamonkey-dom-inspector-1.1.13-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"seamonkey-irc-1.1.13-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"seamonkey-mail-1.1.13-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"seamonkey-spellchecker-1.1.13-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"seamonkey-venkman-1.1.13-1.1") ) flag++;
