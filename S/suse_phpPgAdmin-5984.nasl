...
# extracted from openSUSE Security Update phpPgAdmin-5984.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : phpPgAdmin (phpPgAdmin-5984)");
  script_summary(english:"Check for the phpPgAdmin-5984 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"phpPgAdmin-4.1.3-19.2") ) flag++;
