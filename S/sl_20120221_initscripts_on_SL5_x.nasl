...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : initscripts on SL5.x i386/x86_64 (20120221)");
...
package, which fixes these issues."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1203&L=scientific-linux-errata&T=0&P=3906
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?005852d8"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
