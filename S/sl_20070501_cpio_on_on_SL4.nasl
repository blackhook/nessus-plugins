...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : cpio on on SL4 i386/x86_64");
...
code with the target user's privileges. (CVE-2005-4268)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=198
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?db3488ee"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"cpio-2.5-13.RHEL4")) flag++;
