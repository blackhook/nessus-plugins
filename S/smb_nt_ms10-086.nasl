...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2010-B-0089-S");
  script_xref(name:"MSFT", value:"MS10-086");
  script_xref(name:"MSKB", value:"2294255");
...
cluster."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?b11fee19");
  script_set_attribute(attribute:"solution", value:"Microsoft has released a patch for Windows 2008 R2.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-3223");
