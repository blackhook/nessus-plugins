...
# extracted from Slackware Security Advisory 2010-060-03. The text 
...
if (description)
{
  ...
  script_xref(name:"SSA", value:"2010-060-03");

  script_name(english:"Slackware 13.0 / current : gzip (SSA:2010-060-03)");
...
-current to fix a security issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2c294eb4"
  );
...
flag = 0;
if (slackware_check(osver:"13.0", arch:"x86_64", pkgname:"gzip", pkgver:"1.4", pkgarch:"x86_64", pkgnum:"1_slack13.0")) flag++;

if (slackware_check(osver:"current", pkgname:"gzip", pkgver:"1.4", pkgarch:"i486", pkgnum:"1")) flag++;
if (slackware_check(osver:"current", arch:"x86_64", pkgname:"gzip", pkgver:"1.4", pkgarch:"x86_64", pkgnum:"1")) flag++;
