...
if (description)
{
  ...
  script_cve_id("CVE-2022-41263", "CVE-2022-41267");
  script_xref(name:"IAVA", value:"2022-A-0516");

  script_name(english:"SAP BusinessObjects Business Intelligence Platform 4.2 < 4.2 SP9 P11 / 4.3 < 4.3 SP2 P8 Multiple Vulnerabilities");
...
4.2 SP9 P11, 4.3 SP2 P8 or 4.3 SP3. It is, therefore, affected by multiple vulnerabilities:

 - A server-side request forgery vulnerability (SSRF) where an attacker with normal BI user privileges can
   upload and replace any file on the Business Objects server at the operating system level, enabling the
   attacker to take full control of the system. (CVE-2022-41267)

 - A missing authentication check allows an authenticated, non-administrator attacker to modify the data
   source information for a document which is otherwise restricted. (CVE-2022-41263)

Note that Nessus has not attempted to exploit these issues but has instead relied only on the application's
self-reported version number.");
  # https://www.sap.com/documents/2022/02/fa865ea4-167e-0010-bca6-c68f7e60039b.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?18f404d5");
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3239475");
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3249648");
...
"See vendor advisories.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-41267");
...
var constraints = [
  ...
  { 'min_version': '14.3', 'fixed_version' : '14.3.2.4429', 'fixed_display': '4.3 SP002 000800 / 4.3 SP003 000000'}
];
