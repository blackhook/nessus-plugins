...
# extracted from openSUSE Security Update opera-2681.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2010-0653", "CVE-2010-1993");

  script_name(english:"openSUSE Security Update : opera (openSUSE-SU-2010:0370-1)");
  script_summary(english:"Check for the opera-2681 patch");
...
document with many IFRAME elements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=583620"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=607823"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=615942"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-07/msg00009.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-07/msg00031.html"
  );
...
if ( rpm_check(release:"SUSE11.3", reference:"opera-10.60-0.1.1") ) flag++;
