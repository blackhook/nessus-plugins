...
if(description)
{
 ...
 name["english"] = "Solaris 2.5.1 (sparc) : 110532-01";
...
e +=  solaris_check_patch(release:"5.5.1", arch:"sparc", patch:"110532-01", obsoleted_by:"", package:"SUNWab2u", version:"3.0,REV=2000.0804");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
