...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : pure-ftpd (ZYPP Patch Number 7723)");
...
Additionally the following bugs have been fixed :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7723.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"pure-ftpd-1.0.22-0.26.1")) flag++;
