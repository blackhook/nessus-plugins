...
if (description)
{
  ...
  script_name(english:"Solaris 9 (x86) : 113124-04");
  script_summary(english:"Check for patch 113124-04");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 113124-04"
  );
  script_set_attribute(
...
crash (complete DOS)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/113124-04"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"113124-04", obsoleted_by:"", package:"SUNWcsr", version:"11.9.0,REV=2002.11.04.02.51") < 0) flag++;
