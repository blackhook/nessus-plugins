...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : neon (ZYPP Patch Number 6549)");
...
memory. (CVE-2009-2473)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6549.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"neon-0.24.7-20.8.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"neon-devel-0.24.7-20.8.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, cpu:"x86_64", reference:"neon-32bit-0.24.7-20.8.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"neon-0.24.7-20.8.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"neon-32bit-0.24.7-20.8.1")) flag++;
