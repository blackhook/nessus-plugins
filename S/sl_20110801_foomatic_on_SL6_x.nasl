...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : foomatic on SL6.x i386/x86_64");
...
contains a backported patch to resolve this issue."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1108&L=scientific-linux-errata&T=0&P=175
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1278495d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"foomatic-4.0.4-1.el6_1.1")) flag++;
