...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : vsftpd (SAT Patch Number 4114)");
...
resulting in denial of service (CVE-2011-0762). This has been fixed."
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4114.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:1, reference:"vsftpd-2.0.7-4.21.1")) flag++;
