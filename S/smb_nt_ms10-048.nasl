...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2160329");
...
that is affected by one or more of the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-048");
  script_set_attribute(
    attribute:"solution",
    value:
