...
Errors (CWE-399)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-03/msg00001.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"avahi-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"avahi-compat-howl-devel-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"avahi-compat-mDNSResponder-devel-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"avahi-lang-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"avahi-utils-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libavahi-client3-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libavahi-common3-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libavahi-core6-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libavahi-devel-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libdns_sd-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libhowl0-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"python-avahi-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libavahi-client3-32bit-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libavahi-common3-32bit-0.6.25-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libdns_sd-32bit-0.6.25-4.7.1") ) flag++;
