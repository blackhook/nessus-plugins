...
# extracted from SUSE update advisory SUSE-SU-2016:2632-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (SUSE-SU-2016:2632-1) (Dirty COW)");
...
The following security bugs were fixed :
  ...
  - CVE-2016-4997: The compat IPT_SO_SET_REPLACE and
    ...
    an unintended decrement (bsc#986362).
...
without introducing additional issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/show_bug.cgi?id=986362");
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162632-1/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a03719fc");
  script_set_attribute(attribute:"solution", value:
"To install this SUSE Security Update use YaST online_update.
Alternatively you can run the command listed for your product :

SUSE Linux Enterprise Server for SAP 12:zypper in -t patch
SUSE-SLE-SAP-12-2016-1554=1

SUSE Linux Enterprise Server 12-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-2016-1554=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_51-52_34-default-6-2.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", cpu:"x86_64", reference:"kgraft-patch-3_12_51-52_34-xen-6-2.1")) flag++;
