...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Acrobat Reader (ZYPP Patch Number 6993)");
...
CVE-2010-1241)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6993.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread-9.3.2-0.4.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread-cmaps-9.3.2-0.4.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread-fonts-ja-9.3.2-0.4.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread-fonts-ko-9.3.2-0.4.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread-fonts-zh_CN-9.3.2-0.4.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"acroread-fonts-zh_TW-9.3.2-0.4.1")) flag++;
