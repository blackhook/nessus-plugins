...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:2328");

  script_name(english:"Scientific Linux Security Update : qt5-qtimageformats on SL7.x i686/x86_64 (2021:2328)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20212328-1");
  script_set_attribute(attribute:"solution", value:
"Update the affected qt5-qtimageformats, qt5-qtimageformats-debuginfo and / or qt5-qtimageformats-doc packages.");
...
pkgs = [
    {'reference':'qt5-qtimageformats-5.9.7-2.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-5.9.7-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-debuginfo-5.9.7-2.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-debuginfo-5.9.7-2.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qt5-qtimageformats-doc-5.9.7-2.el7_9', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
