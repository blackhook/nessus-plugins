...
(CVE-2008-3834)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0901&L=scientific-linux-errata&T=0&P=698
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ba77e9ce"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"dbus-1.0.0-7.el5_2.1")) flag++;
if (rpm_check(release:"SL5", reference:"dbus-devel-1.0.0-7.el5_2.1")) flag++;
if (rpm_check(release:"SL5", reference:"dbus-x11-1.0.0-7.el5_2.1")) flag++;
