...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2862966");
...
cryptography and digital certificate handling in Windows."
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2862966/an-update-is-available-that-improves-management-of-weak-certificate-cr");
  script_set_attribute(
    attribute:"solution",
    value:
