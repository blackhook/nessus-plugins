...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : samba4 on SL6.x i386/x86_64 (20150223)");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1502&L=scientific-linux-errata&T=0&P=1398
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?23c31808"
  );
