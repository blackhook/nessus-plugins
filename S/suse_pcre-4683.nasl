...
# extracted from openSUSE Security Update pcre-4683.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : pcre (pcre-4683)");
  script_summary(english:"Check for the pcre-4683 patch");
...
exploited by attackers to execute arbitrary code. (CVE-2007-1659,
CVE-2007-1660, CVE-2007-1661, CVE-2007-4766, CVE-2007-4767)"
  );
...
if ( rpm_check(release:"SUSE10.3", reference:"pcre-7.2-14.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"pcre-devel-7.2-14.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"pcre-32bit-7.2-14.2") ) flag++;
