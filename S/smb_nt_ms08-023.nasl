...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"948881");
...
the host subject to the user's privileges.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2008/ms08-023");
