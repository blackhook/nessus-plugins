...
# extracted from openSUSE Security Update ConsoleKit-596.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ConsoleKit (ConsoleKit-596)");
  script_summary(english:"Check for the ConsoleKit-596 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"ConsoleKit-0.2.10-60.26.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"ConsoleKit-devel-0.2.10-60.26.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"ConsoleKit-x11-0.2.10-60.26.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"ConsoleKit-32bit-0.2.10-60.26.1") ) flag++;
