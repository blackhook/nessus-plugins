...
# extracted from SUSE update advisory SUSE-SU-2015:1713-1.
...
if (description)
{
  ...
  script_bugtraq_id(74633);

  script_name(english:"SUSE SLED12 / SLES12 Security Update : wireshark (SUSE-SU-2015:1713-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2015/suse-su-20151713-1.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6fc355ef"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"wireshark-1.12.7-15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"wireshark-debuginfo-1.12.7-15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"wireshark-debugsource-1.12.7-15.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"wireshark-1.12.7-15.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"wireshark-debuginfo-1.12.7-15.1")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"wireshark-debugsource-1.12.7-15.1")) flag++;
