...
# extracted from openSUSE Security Update MozillaFirefox-3132.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaFirefox (openSUSE-SU-2010:0632-1)");
  script_summary(english:"Check for the MozillaFirefox-3132 patch");
  ...
  script_set_attribute(
    ...
    value:
"Mozilla Firefox was updated to version 3.6.10, fixing various bugs and
security issues.
...
Berthaume"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-09/msg00029.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"MozillaFirefox-3.6.10-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaFirefox-branding-upstream-3.6.10-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaFirefox-translations-common-3.6.10-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaFirefox-translations-other-3.6.10-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-js192-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner192-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner192-buildsymbols-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner192-devel-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner192-gnome-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner192-translations-common-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"mozilla-xulrunner192-translations-other-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-js192-32bit-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner192-32bit-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner192-gnome-32bit-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner192-translations-common-32bit-1.9.2.10-0.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"mozilla-xulrunner192-translations-other-32bit-1.9.2.10-0.4.1") ) flag++;
