...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 142824-29 (deprecated)");
...
142824 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 142824 instead.");
