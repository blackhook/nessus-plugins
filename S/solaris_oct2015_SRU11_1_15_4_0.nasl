...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : oct2015_SRU11_1_15_4_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: Gzip). Supported
...
if (solaris_check_release(release:"0.5.11-0.175.1.15.0.4.0", sru:"S11.1.15.4.0") > 0) flag++;
