...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : tomcat (cve_2011_3375_information_disclosure)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2011-3375-information-disclosure-vulnerability-in-apache-tomcat
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9dc706f"
  );
