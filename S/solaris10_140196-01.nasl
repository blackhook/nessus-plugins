...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 140196-01"
  );
  script_set_attribute(
...
Date this patch was last updated by Sun : Jan/20/09"
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 140196-01");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"140196-01", obsoleted_by:"139555-08 ", package:"SUNWcsl", version:"11.10.0,REV=2005.01.21.15.53") < 0) flag++;
