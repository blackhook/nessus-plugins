...
the SUSE-SU-2022:4484-1 advisory.
...
var pkgs = [
    {'reference':'xorg-x11-server-1.19.6-4.39.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
    {'reference':'xorg-x11-server-extra-1.19.6-4.39.1', 'sp':'4', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
