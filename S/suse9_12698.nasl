...
if (description)
{
  ...
  script_cve_id("CVE-2011-0996", "CVE-2011-0997");

  script_name(english:"SuSE9 Security Update : dhcp (YOU Patch Number 12698)");
...
needs to sanitize the host name offered by the server. (CVE-2011-0996)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12698.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"dhcp-3.0.1rc13-28.29")) flag++;
if (rpm_check(release:"SUSE9", reference:"dhcp-client-3.0.1rc13-28.29")) flag++;
if (rpm_check(release:"SUSE9", reference:"dhcp-devel-3.0.1rc13-28.29")) flag++;
if (rpm_check(release:"SUSE9", reference:"dhcp-relay-3.0.1rc13-28.29")) flag++;
if (rpm_check(release:"SUSE9", reference:"dhcp-server-3.0.1rc13-28.29")) flag++;
