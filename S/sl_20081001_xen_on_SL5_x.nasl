...
Additionally, the following bug is addressed in this update :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0810&L=scientific-linux-errata&T=0&P=273
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?12048dda"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"xen-3.0.3-64.el5_2.3")) flag++;
if (rpm_check(release:"SL5", reference:"xen-devel-3.0.3-64.el5_2.3")) flag++;
if (rpm_check(release:"SL5", reference:"xen-libs-3.0.3-64.el5_2.3")) flag++;
