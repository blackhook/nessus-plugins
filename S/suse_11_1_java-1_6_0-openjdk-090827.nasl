...
if ( rpm_check(release:"SUSE11.1", reference:"java-1_6_0-openjdk-1.5.1_b16-0.1.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_6_0-openjdk-demo-1.5.1_b16-0.1.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_6_0-openjdk-devel-1.5.1_b16-0.1.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_6_0-openjdk-javadoc-1.5.1_b16-0.1.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_6_0-openjdk-plugin-1.5.1_b16-0.1.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"java-1_6_0-openjdk-src-1.5.1_b16-0.1.2") ) flag++;
