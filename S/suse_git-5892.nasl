...
# extracted from openSUSE Security Update git-5892.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : git (git-5892)");
  script_summary(english:"Check for the git-5892 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"git-1.5.2.4-24.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"git-arch-1.5.2.4-24.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"git-core-1.5.2.4-24.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"git-cvs-1.5.2.4-24.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"git-email-1.5.2.4-24.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"git-svn-1.5.2.4-24.4") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"gitk-1.5.2.4-24.4") ) flag++;
