...
if ( rpm_check(release:"SUSE11.2", reference:"libvirt-0.7.2-1.1.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libvirt-devel-0.7.2-1.1.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libvirt-python-0.7.2-1.1.5.1") ) flag++;
