...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : krb5 on SL6.x i386/x86_64 (20160323)");
...
(krb5kdc, kadmin, and kprop) will be restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1603&L=scientific-linux-errata&F=&S=&P=13676
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bea0ae54"
  );
