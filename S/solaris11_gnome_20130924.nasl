...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2007-4460-symlink-attack-vulnerability-in-id3lib-aka-libid3
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?970742a4"
  );
  # https://blogs.oracle.com/sunsecurity/multiple-vulnerabilities-in-poppler
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b9b3af73"
  );
