...
Upstream advisory: http://otrs.org/advisory/OSA-2011-01-en/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-05/msg00015.html"
  );
...
if ( rpm_check(release:"SUSE11.3", reference:"otrs-2.4.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"otrs-itsm-2.1.1-0.5.1") ) flag++;
