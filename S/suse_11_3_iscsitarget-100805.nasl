...
if ( rpm_check(release:"SUSE11.3", reference:"iscsitarget-1.4.19-4.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"iscsitarget-kmp-default-1.4.19_k2.6.34.0_12-4.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"iscsitarget-kmp-desktop-1.4.19_k2.6.34.0_12-4.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"iscsitarget-kmp-pae-1.4.19_k2.6.34.0_12-4.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"iscsitarget-kmp-xen-1.4.19_k2.6.34.0_12-4.1.1") ) flag++;
