...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : py_pil (cve_2014_3589_input_validation)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2014-3589-input-validation-vulnerability-in-python-imaging-library-pil
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c87d9c44"
  );
