...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4477029");
  script_xref(name:"MSFT", value:"MS18-4477029");

  script_name(english:"KB4477029: Security update for Adobe Flash Player (November 2018)");
...
"The remote Windows host is missing security update KB4477029. It is,
...
in Adobe Flash Player.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a7d62da7");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4477029 to address this issue.");
...
# all <= 31.0.0.148
fix = FALSE;
if(ver_compare(ver:iver, fix:"31.0.0.148", strict:FALSE) <= 0)
  fix = "31.0.0.153";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS18-11', kb:'4477029', report);
