...
if (description)
{
  ...
  script_bugtraq_id(76587, 76590, 76653);
  script_xref(name:"MSFT", value:"MS15-102");
  script_xref(name:"MSKB", value:"3084135");
  script_xref(name:"MSKB", value:"3082089");
...
vulnerabilities in Windows Task Management :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-102");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows Vista, 2008, 7,
2008 R2, 8, 2012, 8.1, 2012 R2, 10.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2528");
