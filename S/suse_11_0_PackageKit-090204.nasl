...
if ( rpm_check(release:"SUSE11.0", reference:"PackageKit-0.2.1-15.10") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"PackageKit-devel-0.2.1-15.10") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "PackageKit / PackageKit-devel");
}
