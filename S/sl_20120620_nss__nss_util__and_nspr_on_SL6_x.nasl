...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss, nss-util, and nspr on SL6.x i386/x86_64 (20120620)");
...
nss-util must be restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=1661
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4280a5d9"
  );
