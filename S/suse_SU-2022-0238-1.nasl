...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 19 for SLE 15 SP2) (SUSE-SU-2022:0238-1)");
...
"Update the affected kernel-livepatch-5_3_18-24_83-default and / or kernel-livepatch-5_3_18-24_86-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-24.83-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_83-default-4-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      },
