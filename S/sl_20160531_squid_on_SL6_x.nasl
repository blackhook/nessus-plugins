...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : squid on SL6.x i386/x86_64 (20160531)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?69b908c0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"squid-3.1.23-16.el6_8.4")) flag++;
if (rpm_check(release:"SL6", reference:"squid-debuginfo-3.1.23-16.el6_8.4")) flag++;
