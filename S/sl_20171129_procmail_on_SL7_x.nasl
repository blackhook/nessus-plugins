...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : procmail on SL7.x x86_64 (20171129)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0bd9483f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"procmail-3.22-36.el7_4.1")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"procmail-debuginfo-3.22-36.el7_4.1")) flag++;
