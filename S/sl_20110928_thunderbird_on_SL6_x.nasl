...
restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1109&L=scientific-linux-errata&T=0&P=3710
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c78a229b"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL6", reference:"thunderbird-3.1.15-1.el6_1")) flag++;
if (rpm_check(release:"SL6", reference:"thunderbird-debuginfo-3.1.15-1.el6_1")) flag++;
