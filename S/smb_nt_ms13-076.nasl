...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2876315");
...
arbitrary amounts of kernel memory or gain elevated privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-076");
  script_set_attribute(
    attribute:"solution",
    value:
