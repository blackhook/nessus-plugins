...
fact, Nessus was able to enumerate some of the valid usernames.");
  script_set_attribute(attribute:"see_also", value:"https://tools.ietf.org/html/rfc3261");
...
function ext_exists(ext, port, proto)
{
  ...
  src = "sip:" + compat::this_host() + ":" + get_source_port(soc);
  dst = "sip:" + ext + "@" + compat::this_host() + ":" + port;
  req =
    'REGISTER ' + dst + ' SIP/2.0\r\n' +
    'To: <' + dst + '>\r\n' +
    'From: Nessus <' + src + '>;tag=' + generate_uuid() + '\r\n' +
    'Via: SIP/2.0/' + toupper(via_protocol) + ' ' + compat::this_host() + '\r\n' +
