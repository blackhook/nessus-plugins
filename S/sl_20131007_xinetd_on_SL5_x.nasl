...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xinetd on SL5.x, SL6.x i386/x86_64 (20131007)");
...
arbitrary code with the privileges of the root user. (CVE-2013-4342)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1310&L=scientific-linux-errata&T=0&P=308
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f584dc7d"
  );
  script_set_attribute(
    attribute:"solution", 
