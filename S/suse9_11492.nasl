...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : man (YOU Patch Number 11492)");
...
exploited by users to run code as root. (CVE-2006-4250)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11492.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"man-2.4.1-214.7")) flag++;
