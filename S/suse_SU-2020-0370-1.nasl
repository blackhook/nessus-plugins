...
# extracted from SUSE update advisory SUSE-SU-2020:0370-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : wicked (SUSE-SU-2020:0370-1)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200370-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?041ac02d"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-Product-SLES_SAP-15-2020-370=1

SUSE Linux Enterprise Server 15-LTSS :

zypper in -t patch SUSE-SLE-Product-SLES-15-2020-370=1

SUSE Linux Enterprise Module for Basesystem 15 :

zypper in -t patch SUSE-SLE-Module-Basesystem-15-2020-370=1

SUSE Linux Enterprise High Performance Computing 15-LTSS :

zypper in -t patch SUSE-SLE-Product-HPC-15-2020-370=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"0", reference:"wicked-0.6.60-3.24.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"wicked-debuginfo-0.6.60-3.24.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"wicked-debugsource-0.6.60-3.24.1")) flag++;
if (rpm_check(release:"SLES15", sp:"0", reference:"wicked-service-0.6.60-3.24.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"wicked-0.6.60-3.24.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"wicked-debuginfo-0.6.60-3.24.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"wicked-debugsource-0.6.60-3.24.1")) flag++;
if (rpm_check(release:"SLED15", sp:"0", reference:"wicked-service-0.6.60-3.24.1")) flag++;
