...
if (description)
{
  ...
  script_cve_id("CVE-2019-2961", "CVE-2019-3008");
  script_xref(name:"IAVA", value:"2019-A-0381-S");

  script_name(english:"Oracle Solaris Critical Patch Update : oct2019_SRU11_4_13_4_0");
...
security updates :
  ...
  - Vulnerability in the Oracle Solaris product of Oracle
    Systems (component: SMF services & legacy daemons). The
    ...
    Oracle Solaris. (CVE-2019-2961)

  - Vulnerability in the Oracle Solaris product of Oracle
    Systems (component: LDAP Library). The supported version
    that is affected is 11. Difficult to exploit
    ...
    service (partial DOS) of Oracle Solaris. (CVE-2019-3008)"
  );
  script_set_attribute(
    attribute:"see_also",
...
fix_release = "11.4-11.4.13.0.1.4.0";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.13.0.1.4.0", sru:"11.4.13.4.0") > 0) flag++;
