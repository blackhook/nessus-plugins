...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2021:4913");

  script_name(english:"Scientific Linux Security Update : mailman on SL7.x x86_64 (2021:4913)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20214913-1");
...
var pkgs = [
    {'reference':'mailman-2.1.15-30.el7_9.2', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mailman-debuginfo-2.1.15-30.el7_9.2', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
