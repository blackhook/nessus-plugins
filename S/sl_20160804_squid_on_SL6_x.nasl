...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : squid on SL6.x i386/x86_64 (20160804)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1608&L=scientific-linux-errata&F=&S=&P=4221
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d414b1b2"
  );
  script_set_attribute(
    attribute:"solution", 
