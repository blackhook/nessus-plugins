...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mysql on SL6.x i386/x86_64 (20130425)");
...
server. (CVE-2012-5614, CVE-2013-1506, CVE-2013-1521, CVE-2013-1531,
...
These updated packages upgrade MySQL to version 5.1.69.

After installing this update, the MySQL server daemon (mysqld) will be
restarted automatically."
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1304&L=scientific-linux-errata&T=0&P=2732
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ef6f65a"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"mysql-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-bench-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-debuginfo-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-devel-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-embedded-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-embedded-devel-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-libs-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-server-5.1.69-1.el6_4")) flag++;
if (rpm_check(release:"SL6", reference:"mysql-test-5.1.69-1.el6_4")) flag++;
