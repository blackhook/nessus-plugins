...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : IBM Java 1.4.2 (ZYPP Patch Number 6508)");
...
IBMPKCS11Impl and IBMJCEFIPS."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6508.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:2, reference:"java-1_4_2-ibm-1.4.2_sr13.1-0.3")) flag++;
if (rpm_check(release:"SLES10", sp:2, reference:"java-1_4_2-ibm-devel-1.4.2_sr13.1-0.3")) flag++;
if (rpm_check(release:"SLES10", sp:2, cpu:"i586", reference:"java-1_4_2-ibm-jdbc-1.4.2_sr13.1-0.3")) flag++;
if (rpm_check(release:"SLES10", sp:2, cpu:"i586", reference:"java-1_4_2-ibm-plugin-1.4.2_sr13.1-0.3")) flag++;
