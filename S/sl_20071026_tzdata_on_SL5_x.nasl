...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tzdata on SL5.x, SL4.x i386/x86_64");
...
timezones :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0710&L=scientific-linux-errata&T=0&P=2550
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2710d90a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"tzdata-2007h-1.el4")) flag++;

if (rpm_check(release:"SL5", reference:"tzdata-2007h-1.el5")) flag++;
