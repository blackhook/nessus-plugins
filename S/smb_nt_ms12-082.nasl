...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2770660");
...
document with embedded content.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-082");
