...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : qemu-kvm on SL7.x x86_64 (20141020)");
...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1410&L=scientific-linux-errata&T=0&P=1189
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e18a4778"
  );
