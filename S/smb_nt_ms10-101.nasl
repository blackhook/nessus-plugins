...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2207559");
  script_xref(name:"MSFT", value:"MS10-101");
  script_xref(name:"IAVB", value:"2010-B-0109-S");
...
denial of service by sending a specially crafted Netlogon RPC service.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?2262ef14");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows 2003, 2008, and
2008 R2.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:N/I:N/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2742");
