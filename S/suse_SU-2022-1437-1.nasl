...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 / openSUSE 15 Security Update : buildah (SUSE-SU-2022:1437-1)");
...
referenced in the SUSE-SU-2022:1437-1 advisory.
...
var pkgs = [
    {'reference':'buildah-1.25.1-150300.8.6.1', 'sp':'3', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.3', 'SLE_HPC-release-15.3', 'sle-module-containers-release-15.3', 'sles-release-15.3']},
    {'reference':'buildah-1.25.1-150300.8.6.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['openSUSE-release-15.3']}
];
