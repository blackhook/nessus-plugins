...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : kernel (Live Patch 15 for SLE 15 SP2) (SUSE-SU-2021:3710-1)");
...
"Update the affected kernel-livepatch-5_3_18-24_37-default and / or kernel-livepatch-5_3_18-24_53_4-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '5.3.18-24.37-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_37-default-14-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      },
      '5.3.18-24.53.4-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_53_4-default-6-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-24_37-default / etc');
}
