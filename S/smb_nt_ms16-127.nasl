...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3194343");
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-127");
...
2012 R2, and 10.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-6992");
...
if (info != '')
{
  ...
  hotfix_add_report(bulletin:'MS16-127', kb:'3194343', report);
