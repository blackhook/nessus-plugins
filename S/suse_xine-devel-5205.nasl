...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : xine-lib (ZYPP Patch Number 5205)");
...
(CVE-2008-1686)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2008-1878.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 5205.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:1, reference:"xine-devel-1.1.1-24.39")) flag++;
if (rpm_check(release:"SLED10", sp:1, reference:"xine-lib-1.1.1-24.39")) flag++;
if (rpm_check(release:"SLED10", sp:1, cpu:"x86_64", reference:"xine-lib-32bit-1.1.1-24.39")) flag++;
