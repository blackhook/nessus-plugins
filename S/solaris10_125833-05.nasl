...
Date this patch was last updated by Sun : Jan/08/10"
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 125833-05");
  script_set_attribute(attribute:"risk_factor", value:"Medium");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:125833");
...
if (flag) {
  ...
  audit(AUDIT_PACKAGE_NOT_INSTALLED, "SUNWscma / SUNWscmc / SUNWscmca / SUNWscmcm / SUNWscmdb / SUNWscmh / etc");
}
