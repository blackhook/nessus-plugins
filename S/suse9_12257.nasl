...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : OpenSSH (YOU Patch Number 12257)");
...
(CVE-2008-4109)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12257.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"openssh-4.1p1-11.44")) flag++;
if (rpm_check(release:"SUSE9", reference:"openssh-askpass-4.1p1-11.44")) flag++;
