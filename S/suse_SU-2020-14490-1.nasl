...
# SUSE update advisory SUSE-SU-2020:14490-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2020:14490-1");
  script_xref(name:"IAVA", value:"2020-A-0349");
  script_xref(name:"CEA-ID", value:"CEA-2020-0061");

  script_name(english:"SUSE SLES11 Security Update : shim (SUSE-SU-2020:14490-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1175626");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1175656");
  # https://lists.suse.com/pipermail/sle-security-updates/2020-September/007428.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a186b8c");
...
pkgs = [
    {'reference':'shim-15+git47-12.5', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'shim-15+git47-12.5', 'sp':'4', 'cpu':'x86_64', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
