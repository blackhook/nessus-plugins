...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : pixman on SL5.x, SL6.x i386/x86_64 (20131220)");
...
take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=5303
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ab109a21"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL5", reference:"pixman-0.22.0-2.2.el5_10")) flag++;
if (rpm_check(release:"SL5", reference:"pixman-debuginfo-0.22.0-2.2.el5_10")) flag++;
if (rpm_check(release:"SL5", reference:"pixman-devel-0.22.0-2.2.el5_10")) flag++;

if (rpm_check(release:"SL6", reference:"pixman-0.26.2-5.1.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"pixman-debuginfo-0.26.2-5.1.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"pixman-devel-0.26.2-5.1.el6_5")) flag++;
