...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1005&L=scientific-linux-errata&T=0&P=2047
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f82be19a"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"mysql-5.0.77-4.el5_5.3")) flag++;
if (rpm_check(release:"SL5", reference:"mysql-bench-5.0.77-4.el5_5.3")) flag++;
if (rpm_check(release:"SL5", reference:"mysql-devel-5.0.77-4.el5_5.3")) flag++;
if (rpm_check(release:"SL5", reference:"mysql-server-5.0.77-4.el5_5.3")) flag++;
if (rpm_check(release:"SL5", reference:"mysql-test-5.0.77-4.el5_5.3")) flag++;
