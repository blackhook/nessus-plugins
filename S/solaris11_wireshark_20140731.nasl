...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : wireshark (cve_2014_2907_denial_of)");
...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2014-2907-denial-of-servicedos-vulnerability-in-wireshark"
  );
