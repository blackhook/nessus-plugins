...
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-3D-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-devel-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-extra-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-fax-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-imaging-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-kamera-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-pdf-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-postscript-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-scan-3.5.9-53.3") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"kdegraphics3-tex-3.5.9-53.3") ) flag++;
