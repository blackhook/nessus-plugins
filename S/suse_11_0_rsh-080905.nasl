...
# extracted from openSUSE Security Update rsh-182.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rsh (rsh-182)");
  script_summary(english:"Check for the rsh-182 patch");
...
This patch fixes it."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=422442"
  );
...
if ( rpm_check(release:"SUSE11.0", reference:"rsh-0.17-680.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"rsh-server-0.17-680.2") ) flag++;
