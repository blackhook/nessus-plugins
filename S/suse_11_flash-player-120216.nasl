...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : flash-player (SAT Patch Number 5817)");
...
Windows only).");
  ...
  script_set_attribute(attribute:"see_also", value:"http://support.novell.com/security/cve/CVE-2012-0751.html");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"flash-player-11.1.102.62-0.14.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"flash-player-11.1.102.62-0.14.1")) flag++;
