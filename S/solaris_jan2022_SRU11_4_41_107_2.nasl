...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : jan2022_SRU11_4_41_107_2");
...
security update :
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-21271");
...
fix_release = "11.4-11.4.41.0.1.107.2";

flag = 0;

if (solaris_check_release(release:"11.4-11.4.41.0.1.107.2", sru:"11.4.41.107.2") > 0) flag++;
