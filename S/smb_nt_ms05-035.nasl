...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"895333");
 script_xref(name:"MSKB", value:"895589");
...
parsing handler would result in code execution.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2005/ms05-035");
