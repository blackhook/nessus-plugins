...
against an APOP server. (CVE-2007-1558)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=2659
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ab8bf734"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"evolution-1.4.5-20.el3")) flag++;
if (rpm_check(release:"SL3", reference:"evolution-devel-1.4.5-20.el3")) flag++;

if (rpm_check(release:"SL4", reference:"evolution-2.0.2-35.0.2.el4")) flag++;
if (rpm_check(release:"SL4", reference:"evolution-devel-2.0.2-35.0.2.el4")) flag++;
