...
# extracted from openSUSE Security Update seamonkey-3372.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : seamonkey (seamonkey-3372)");
  script_summary(english:"Check for the seamonkey-3372 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update brings Mozilla SeaMonkey to version 2.0.9, fixing various
...
if ( rpm_check(release:"SUSE11.3", reference:"seamonkey-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"seamonkey-dom-inspector-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"seamonkey-irc-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"seamonkey-translations-common-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"seamonkey-translations-other-2.0.9-0.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"seamonkey-venkman-2.0.9-0.5.1") ) flag++;
