...
# extracted from SUSE update advisory SUSE-SU-2019:0048-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : helm-mirror (SUSE-SU-2019:0048-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?195a7c0f"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
SUSE-SLE-Module-Containers-15-SP1-2019-48=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"helm-mirror-0.2.1-1.7.1")) flag++;
