...
# extracted from openSUSE Security Update libpoppler-devel-1741.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpoppler-devel (libpoppler-devel-1741)");
  script_summary(english:"Check for the libpoppler-devel-1741 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler-devel-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler-glib-devel-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler-glib4-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler-qt2-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler-qt3-devel-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler-qt4-3-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler-qt4-devel-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpoppler4-0.10.1-1.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"poppler-tools-0.10.1-1.7.1") ) flag++;
