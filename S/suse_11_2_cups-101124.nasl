...
if ( rpm_check(release:"SUSE11.2", reference:"cups-1.3.11-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"cups-client-1.3.11-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"cups-devel-1.3.11-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"cups-libs-1.3.11-4.7.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"cups-libs-32bit-1.3.11-4.7.1") ) flag++;
