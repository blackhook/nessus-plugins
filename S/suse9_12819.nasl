...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : IBM Java JRE and SDK (YOU Patch Number 12819)");
...
The following security issues were fixed :
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12819.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"IBMJava2-JRE-1.4.2_sr13.10-0.7")) flag++;
if (rpm_check(release:"SUSE9", reference:"IBMJava2-SDK-1.4.2_sr13.10-0.7")) flag++;
