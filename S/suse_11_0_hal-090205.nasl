...
if ( rpm_check(release:"SUSE11.0", reference:"hal-0.5.11-8.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"hal-devel-0.5.11-8.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"hal-32bit-0.5.11-8.4") ) flag++;
