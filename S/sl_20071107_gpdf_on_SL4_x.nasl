...
(CVE-2007-4352, CVE-2007-5392, CVE-2007-5393)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0711&L=scientific-linux-errata&T=0&P=657
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3c72fbcc"
  );
...
flag = 0;
if (rpm_check(release:"SL4", reference:"gpdf-2.8.2-7.7.1")) flag++;
