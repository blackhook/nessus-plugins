...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2010-A-0159-S");
  script_xref(name:"MSFT", value:"MS10-089");
  script_xref(name:"MSKB", value:"2433585");
...
remote host has multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?2c0ac321");
  script_set_attribute(
    attribute:"solution",
    value:
