...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 139832-12");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"139832-12", obsoleted_by:"", package:"SUNWsgeex", version:"6.2,REV=2008.07.23.11.44") < 0) flag++;
