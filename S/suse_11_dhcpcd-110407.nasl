...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : dhcpcd (SAT Patch Number 4316)");
...
This update also fixes the following non-security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4316.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"dhcpcd-3.2.3-44.20.1")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"dhcpcd-3.2.3-44.20.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"dhcpcd-3.2.3-44.20.1")) flag++;
