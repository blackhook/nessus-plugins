...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : gpg (ZYPP Patch Number 2994)");
...
default it only prints and handles the first one."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 2994.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:0, reference:"gpg-1.4.2-23.16")) flag++;
if (rpm_check(release:"SLES10", sp:0, reference:"gpg-1.4.2-23.16")) flag++;
