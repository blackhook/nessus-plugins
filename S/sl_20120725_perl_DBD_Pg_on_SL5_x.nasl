...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : perl-DBD-Pg on SL5.x, SL6.x i386/x86_64 (20120725)");
...
take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=6126
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd1418d5"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:perl-DBD-Pg");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:perl-DBD-Pg-debuginfo");
