...
The system must be rebooted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1104&L=scientific-linux-errata&T=0&P=2500
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f50f44ca"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"polkit-0.96-2.el6_0.1")) flag++;
if (rpm_check(release:"SL6", reference:"polkit-desktop-policy-0.96-2.el6_0.1")) flag++;
if (rpm_check(release:"SL6", reference:"polkit-devel-0.96-2.el6_0.1")) flag++;
if (rpm_check(release:"SL6", reference:"polkit-docs-0.96-2.el6_0.1")) flag++;
