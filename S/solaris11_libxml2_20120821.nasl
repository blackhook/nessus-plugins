...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : libxml2 (cve_2010_4008_denial_of)");
...
security updates :
  ...
  - libxml2 before 2.7.8, as used in Google Chrome before
    7.0.517.44, Apple Safari 5.0.2 and earlier, and other
    products, reads from invalid memory locations during
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2010-4008-denial-of-service-dos-vulnerability-in-libxml2"
  );
