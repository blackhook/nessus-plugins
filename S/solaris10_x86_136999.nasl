...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 136999-10 (deprecated)");
...
136999 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 136999 instead.");
