...
# extracted from SUSE update advisory SUSE-SU-2015:1875-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED11 Security Update : java-1_7_0-openjdk (SUSE-SU-2015:1875-2)");
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2015/suse-su-20151875-2.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a4d96524"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
zypper in -t patch dbgsp4-java-1_7_0-openjdk-12179=1

SUSE Linux Enterprise Debuginfo 11-SP3 :

zypper in -t patch dbgsp3-java-1_7_0-openjdk-12179=1
