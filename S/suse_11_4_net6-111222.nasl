...
vulnerability (CVE-2011-4091, CVE-2011-4093)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00003.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00013.html"
  );
...
if ( rpm_check(release:"SUSE11.4", reference:"net6-1.3.14-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"net6-debuginfo-1.3.14-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"net6-debugsource-1.3.14-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"net6-devel-1.3.14-0.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"net6-lang-1.3.14-0.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "net6 / net6-devel / net6-lang / net6-debuginfo / net6-debugsource");
}
