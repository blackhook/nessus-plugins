...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libtool on SL3.x, SL4.x, SL5.x i386/x86_64");
...
library must be restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0912&L=scientific-linux-errata&T=0&P=1023
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9107a29b"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"libtool-1.4.3-7")) flag++;
if (rpm_check(release:"SL3", reference:"libtool-libs-1.4.3-7")) flag++;

if (rpm_check(release:"SL4", reference:"libtool-1.5.6-5.el4_8")) flag++;
if (rpm_check(release:"SL4", reference:"libtool-libs-1.5.6-5.el4_8")) flag++;

if (rpm_check(release:"SL5", reference:"libtool-1.5.22-7.el5_4")) flag++;
if (rpm_check(release:"SL5", reference:"libtool-ltdl-1.5.22-7.el5_4")) flag++;
if (rpm_check(release:"SL5", reference:"libtool-ltdl-devel-1.5.22-7.el5_4")) flag++;
