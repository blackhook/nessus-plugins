...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : dhcpv6 (SAT Patch Number 4317)");
...
needs to sanitize the host name offered by the server. (CVE-2011-0997)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 4317.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:11:dhcpv6");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:1, cpu:"i586", reference:"dhcpv6-1.0.22-3.21.2")) flag++;
if (rpm_check(release:"SLED11", sp:1, cpu:"x86_64", reference:"dhcpv6-1.0.22-3.21.2")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"dhcpv6-1.0.22-3.21.2")) flag++;
