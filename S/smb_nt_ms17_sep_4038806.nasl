...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4038806");
  script_xref(name:"MSFT", value:"MS17-4038806");

  script_name(english:"KB4038806: Security update for Adobe Flash Player (September 2017)");
...
"The remote Windows host is missing security update KB4038806. It is,
therefore, affected by multiple remote code execution vulnerabilies
in Adobe Flash Player.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?65af4a4d");
  # https://support.microsoft.com/en-us/help/4038806/security-update-for-adobe-flash-player-sep-12-2017
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bca86c2c");
