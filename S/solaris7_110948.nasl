...
if (description)
{
  ...
  script_name(english:"Solaris 7 (sparc) : 110948-04");
...
if (solaris_check_patch(release:"5.7", arch:"sparc", patch:"110948-04", obsoleted_by:"", package:"SUNWsspop", version:"3.4.0,REV=2000.08.20.19.44") < 0) flag++;
