...
# extracted from Slackware Security Advisory 2018-032-01. The text 
...
if (description)
{
  ...
  script_xref(name:"SSA", value:"2018-032-01");

  script_name(english:"Slackware 14.1 / 14.2 : mariadb (SSA:2018-032-01)");
...
security issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?64147f2e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (slackware_check(osver:"14.1", pkgname:"mariadb", pkgver:"5.5.59", pkgarch:"i486", pkgnum:"1_slack14.1")) flag++;
if (slackware_check(osver:"14.1", arch:"x86_64", pkgname:"mariadb", pkgver:"5.5.59", pkgarch:"x86_64", pkgnum:"1_slack14.1")) flag++;

if (slackware_check(osver:"14.2", pkgname:"mariadb", pkgver:"10.0.34", pkgarch:"i586", pkgnum:"1_slack14.2")) flag++;
if (slackware_check(osver:"14.2", arch:"x86_64", pkgname:"mariadb", pkgver:"10.0.34", pkgarch:"x86_64", pkgnum:"1_slack14.2")) flag++;
