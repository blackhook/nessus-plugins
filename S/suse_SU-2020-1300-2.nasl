...
# extracted from SUSE update advisory SUSE-SU-2020:1300-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED15 / SLES15 Security Update : gstreamer-plugins-base (SUSE-SU-2020:1300-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26438b8a"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch
SUSE-SLE-Module-Packagehub-Subpackages-15-SP1-2020-1300=1"
  );
...
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"gstreamer-plugins-base-debugsource-1.12.5-3.3.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"gstreamer-plugins-base-debugsource-1.12.5-3.3.1")) flag++;
