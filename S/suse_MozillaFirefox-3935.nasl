...
# extracted from openSUSE Security Update MozillaFirefox-3935.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaFirefox (MozillaFirefox-3935)");
  script_summary(english:"Check for the MozillaFirefox-3935 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"MozillaFirefox-2.0.0.5-1.2") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"MozillaFirefox-translations-2.0.0.5-1.2") ) flag++;
