...
# extracted from openSUSE Security Update unzip-4976.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : unzip (unzip-4976)");
  script_summary(english:"Check for the unzip-4976 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"unzip-5.52-16.6") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"unzip-5.52-36") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"unzip-5.52-77.2") ) flag++;
