...
# extracted from openSUSE Security Update wget-6427.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : wget (wget-6427)");
  script_summary(english:"Check for the wget-6427 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"wget-1.10.2-78.2") ) flag++;
