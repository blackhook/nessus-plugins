...
possible exploitation of similar issues in the future."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0805&L=scientific-linux-errata&T=0&P=862
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?321be839"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"libvorbis-1.0-10.el3")) flag++;
if (rpm_check(release:"SL3", reference:"libvorbis-devel-1.0-10.el3")) flag++;

if (rpm_check(release:"SL4", reference:"libvorbis-1.1.0-3.el4_6.1")) flag++;
if (rpm_check(release:"SL4", reference:"libvorbis-devel-1.1.0-3.el4_6.1")) flag++;

if (rpm_check(release:"SL5", reference:"libvorbis-1.1.2-3.el5_1.2")) flag++;
if (rpm_check(release:"SL5", reference:"libvorbis-devel-1.1.2-3.el5_1.2")) flag++;
