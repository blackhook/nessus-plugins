...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1179748"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1181483"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2020-27828/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2021-3272/"
  );
  # https://www.suse.com/support/update/announcement/2021/suse-su-20210489-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a541b1be"
  );
  script_set_attribute(
    attribute:"solution",
    value:
