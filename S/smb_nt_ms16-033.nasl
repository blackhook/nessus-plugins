...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3139398");
...
elevate privileges, allowing the execution of arbitrary code.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6cd464c8");
...
2008 R2, 2012, 8.1, RT 8.1, 2012 R2, and 10.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0133");
