...
if ( rpm_check(release:"SUSE11.3", reference:"coreutils-7.1-11.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"coreutils-lang-7.1-11.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "coreutils / coreutils-lang");
}
