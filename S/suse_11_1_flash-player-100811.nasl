...
# extracted from openSUSE Security Update flash-player-2895.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : flash-player (openSUSE-SU-2010:0502-1)");
  script_summary(english:"Check for the flash-player-2895 patch");
...
CVE2010-2215, CVE-2010-2216"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-08/msg00030.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"flash-player-10.1.82.76-0.1.1") ) flag++;
