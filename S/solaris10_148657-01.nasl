...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 148657-01");
  script_summary(english:"Check for patch 148657-01");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 148657-01"
  );
  script_set_attribute(
    attribute:"description", 
    value:
"SunOS 5.10: telnet patch.
Date this patch was last updated by Sun : Feb/21/12"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/148657-01"
  );
  script_set_attribute(attribute:"solution", value:"Install patch 148657-01 or higher");
...
if (flag) {
  ...
  audit(AUDIT_PACKAGE_NOT_INSTALLED, "SUNWtnetc");
}
