...
if (description)
{
  ...
  script_name(english:"Shockwave Player <= 11.6.5.635 Multiple Memory Corruption Vulnerabilities (APSB12-17)");
...
that is 11.6.5.635 or earlier and is, therefore, potentially affected by multiple
...
"Upgrade to Adobe Shockwave Player 11.6.6.636 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-2047");
...
latest_vuln_version = "11.6.5.635"; # versions <= this version are vuln
fix = "11.6.6.636";
