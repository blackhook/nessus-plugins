...
# extracted from openSUSE Security Update MozillaThunderbird-5599.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaThunderbird (MozillaThunderbird-5599)");
  script_summary(english:"Check for the MozillaThunderbird-5599 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"MozillaThunderbird-2.0.0.16-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"MozillaThunderbird-translations-2.0.0.16-0.1") ) flag++;
