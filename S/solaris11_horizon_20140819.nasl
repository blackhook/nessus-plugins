...
if (description)
{
  ...
  script_cve_id("CVE-2014-3473", "CVE-2014-3474", "CVE-2014-3475");

  script_name(english:"Oracle Solaris Third-Party Patch Update : horizon (multiple_cross_site_scripting_xss1)");
...
security updates."
  ...
  # https://blogs.oracle.com/sunsecurity/multiple-cross-site-scripting-xss-vulnerabilities-in-openstack-horizon
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7872a91a"
  );
