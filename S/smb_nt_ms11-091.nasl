...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2553084");
  script_xref(name:"MSKB", value:"2596705");
...
execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-091");
  script_set_attribute(
    attribute:"solution",
    value:
