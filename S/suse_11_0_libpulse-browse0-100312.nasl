...
mode' which is not the case by default (CVE-2009-1299)."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:libpulsecore4");
...
if ( rpm_check(release:"SUSE11.0", reference:"libpulse-browse0-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libpulse-devel-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libpulse-mainloop-glib0-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libpulse0-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libpulsecore4-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-esound-compat-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-module-bluetooth-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-module-gconf-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-module-jack-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-module-lirc-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-module-x11-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-module-zeroconf-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pulseaudio-utils-0.9.10-26.7") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libpulse0-32bit-0.9.10-26.7") ) flag++;
