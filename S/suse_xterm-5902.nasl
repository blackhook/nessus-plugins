...
# extracted from openSUSE Security Update xterm-5902.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : xterm (xterm-5902)");
  script_summary(english:"Check for the xterm-5902 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"xterm-229-17.2") ) flag++;
