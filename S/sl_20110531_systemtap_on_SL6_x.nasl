...
contain a backported patch to correct these issues."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1106&L=scientific-linux-errata&T=0&P=4985
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b5b9470c"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"systemtap-1.4-6.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"systemtap-client-1.4-6.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"systemtap-grapher-1.4-6.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"systemtap-initscript-1.4-6.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"systemtap-runtime-1.4-6.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"systemtap-sdt-devel-1.4-6.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"systemtap-server-1.4-6.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"systemtap-testsuite-1.4-6.el6_1.1")) flag++;
