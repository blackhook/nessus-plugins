...
# extracted from openSUSE Security Update libtiff-devel-4405.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libtiff-devel (openSUSE-SU-2011:0409-1)");
  script_summary(english:"Check for the libtiff-devel-4405 patch");
...
overflow in the tiffdump tool (CVE-2010-4665)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00079.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"libtiff-devel-3.8.2-145.150.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libtiff3-3.8.2-145.150.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"tiff-3.8.2-145.150.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libtiff-devel-32bit-3.8.2-145.150.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libtiff3-32bit-3.8.2-145.150.1") ) flag++;
