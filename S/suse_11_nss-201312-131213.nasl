...
if (description)
{
  ...
  script_name(english:"SuSE 11.2 Security Update : libfreebl3 (SAT Patch Number 8648)");
...
in the middle certificates."
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 8648.");
