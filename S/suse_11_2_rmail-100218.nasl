...
if ( rpm_check(release:"SUSE11.2", reference:"rmail-8.14.3-51.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"sendmail-8.14.3-51.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"sendmail-devel-8.14.3-51.5.1") ) flag++;
