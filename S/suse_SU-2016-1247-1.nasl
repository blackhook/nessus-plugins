...
# extracted from SUSE update advisory SUSE-SU-2016:1247-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : ntp (SUSE-SU-2016:1247-1)");
...
Major functional changes :
  ...
  - The 'sntp' commandline tool changed its option handling
    in a major way, some options have been renamed or
    dropped.
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20161247-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4278c688"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"0", reference:"ntp-4.2.8p6-46.5.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ntp-debuginfo-4.2.8p6-46.5.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ntp-debugsource-4.2.8p6-46.5.2")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"ntp-doc-4.2.8p6-46.5.2")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"ntp-4.2.8p6-46.5.2")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"ntp-debuginfo-4.2.8p6-46.5.2")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"ntp-debugsource-4.2.8p6-46.5.2")) flag++;
if (rpm_check(release:"SLED12", sp:"0", cpu:"x86_64", reference:"ntp-doc-4.2.8p6-46.5.2")) flag++;
