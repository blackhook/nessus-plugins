...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2510531");
  script_xref(name:"MSKB", value:"2510581");
  script_xref(name:"MSKB", value:"2510587");
...
code subject to the user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-031");
  script_set_attribute(
    attribute:"solution",
    value:
