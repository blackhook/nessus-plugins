...
"Update the affected kernel-livepatch-5_3_18-24_93-default and / or kernel-livepatch-5_3_18-24_96-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      ...
      '5.3.18-24.96-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-24_96-default-2-2.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-module-live-patching-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-24_93-default / etc');
}
