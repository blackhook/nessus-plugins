...
updates."
  ...
  script_set_attribute(
    ...
    value:
"CVE-2009-2730 gnutls: incorrect verification of SSL certificate with
NUL in name (GNUTLS-SA-2009-4)
...
the application into accepting it by mistake. (CVE-2009-2730)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0908&L=scientific-linux-errata&T=0&P=2454
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c354348"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SL4", reference:"gnutls-1.0.20-4.el4_8.3")) flag++;
if (rpm_check(release:"SL4", reference:"gnutls-devel-1.0.20-4.el4_8.3")) flag++;

if (rpm_check(release:"SL5", reference:"gnutls-1.4.1-3.el5_3.5")) flag++;
if (rpm_check(release:"SL5", reference:"gnutls-devel-1.4.1-3.el5_3.5")) flag++;
if (rpm_check(release:"SL5", reference:"gnutls-utils-1.4.1-3.el5_3.5")) flag++;
