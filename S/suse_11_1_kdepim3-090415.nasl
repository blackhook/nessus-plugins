...
if ( rpm_check(release:"SUSE11.1", reference:"kdepim3-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim3-devel-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim3-kpilot-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim3-mobile-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim3-notes-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kdepim3-time-management-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"kitchensync-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkcal-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkcal-devel-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkcal2-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkmime-devel-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libkmime2-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libktnef-devel-3.5.10-8.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libktnef1-3.5.10-8.14.1") ) flag++;
