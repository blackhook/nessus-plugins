...
# extracted from SUSE update advisory SUSE-SU-2015:1885-2.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : apache2 (SUSE-SU-2015:1885-2)");
...
Following security issue was fixed.
  ...
  - Fix the chunked transfer coding implementation in the
    Apache (bsc#938728, CVE-2015-3183)
...
Bugs fixed :
  ...
  - only enable the port 443 for TCP protocol, not UDP.
    (bsc#931002)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=941676"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2015-3183/"
  );
  # https://www.suse.com/support/update/announcement/2015/suse-su-20151885-2.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c970eb4"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-doc-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-example-pages-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-prefork-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-utils-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"apache2-worker-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"apache2-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"apache2-doc-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"apache2-example-pages-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"apache2-prefork-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"apache2-utils-2.2.12-59.1")) flag++;
if (rpm_check(release:"SLES11", sp:"3", reference:"apache2-worker-2.2.12-59.1")) flag++;
