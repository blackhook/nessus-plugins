...
# extracted from openSUSE Security Update imlib2-318.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : imlib2 (imlib2-318)");
  script_summary(english:"Check for the imlib2-318 patch");
...
file could corrupt memory. (CVE-2008-5187)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=447093"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"imlib2-1.4.0-46.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"imlib2-devel-1.4.0-46.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"imlib2-filters-1.4.0-46.5") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"imlib2-loaders-1.4.0-46.5") ) flag++;
