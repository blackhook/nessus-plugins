...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"975713");
...
vulnerable function, resulting in remote code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-007");
  script_set_attribute(
    attribute:"solution",
    value:
