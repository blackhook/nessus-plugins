...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3193418");
  script_xref(name:"MSKB", value:"3196718");
...
rollup. It is, therefore, affected by the following vulnerabilities :
  ...
  - An elevation of privilege vulnerability exists in
    ...
    (CVE-2016-7222)");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2016/ms16-130");
...
2008 R2, 2012, 8.1, RT 8.1, 2012 R2, 10, and 2016.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-7212");
