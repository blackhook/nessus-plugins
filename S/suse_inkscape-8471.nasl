...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : inkscape (ZYPP Patch Number 8471)");
...
to internal hosts."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8471.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"inkscape-0.43-20.22.1")) flag++;
