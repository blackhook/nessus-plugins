...
# extracted from SUSE update advisory SUSE-SU-2020:0505-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : mariadb (SUSE-SU-2020:0505-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1077717"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  # https://www.suse.com/support/update/announcement/2020/suse-su-20200505-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cbbf57ff"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
SUSE-OpenStack-Cloud-Crowbar-9-2020-505=1

SUSE OpenStack Cloud 9:zypper in -t patch
SUSE-OpenStack-Cloud-9-2020-505=1

SUSE Linux Enterprise Server 12-SP5:zypper in -t patch
SUSE-SLE-SERVER-12-SP5-2020-505=1

SUSE Linux Enterprise Server 12-SP4:zypper in -t patch
SUSE-SLE-SERVER-12-SP4-2020-505=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-client-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-client-debuginfo-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-debuginfo-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-debugsource-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-tools-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"mariadb-tools-debuginfo-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-client-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-client-debuginfo-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-debuginfo-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-debugsource-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-tools-10.2.31-3.25.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"mariadb-tools-debuginfo-10.2.31-3.25.1")) flag++;
