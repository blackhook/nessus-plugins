...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2760405");
  script_xref(name:"MSKB", value:"2760410");
  script_xref(name:"MSKB", value:"2687412");
  script_xref(name:"MSKB", value:"2760416");
  script_xref(name:"MSKB", value:"2760421");
  script_xref(name:"MSKB", value:"2760497");
  script_xref(name:"MSKB", value:"2760498");
...
by tricking a user into opening a specially crafted RTF file.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7072a349");
...
Apps and Microsoft SharePoint Server.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-2539");
