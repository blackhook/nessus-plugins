...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : kdelibs on SL6.x i386/x86_64 (20121030)");
...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1210&L=scientific-linux-errata&T=0&P=3687
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8cbef72a"
  );
