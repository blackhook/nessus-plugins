...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"973443");
  script_xref(name:"MSKB", value:"973444");
  script_xref(name:"MSKB", value:"973866");
...
arbitrary code subject to the user's privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-068");
  script_set_attribute(
    attribute:"solution",
    value:
