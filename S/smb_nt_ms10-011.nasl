...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"978037");
...
An attacker might exploit this to run arbitrary code in kernel mode."
 ...
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-011");
 script_set_attribute(
  attribute:"solution",
