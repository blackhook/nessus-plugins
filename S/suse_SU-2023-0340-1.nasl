...
the SUSE-SU-2023:0340-1 advisory.
...
var pkgs = [
    {'reference':'xrdp-0.9.0~git.1456906198.f422461-21.30.2', 'sp':'4', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.4']},
