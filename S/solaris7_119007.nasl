...
if (description)
{
  ...
  script_name(english:"Solaris 7 (sparc) : 119007-01");
...
if (solaris_check_patch(release:"5.7", arch:"sparc", patch:"119007-01", obsoleted_by:"116271-06 ", package:"VRTSnetbp", version:"5.1,REV=2004.05.11.17.55") < 0) flag++;
