...
# extracted from SUSE update advisory SUSE-SU-2016:2902-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : kvm (SUSE-SU-2016:2902-1)");
...
"This update for kvm fixes the following issues :
  ...
  - Patch queue updated from
    https://gitlab.suse.de/virtualization/qemu.git SLE11-SP4

  - Remove semi-contradictory and now determined erroneous
    statement in kvm-supported.txt regarding not running ntp
    in kvm guest when kvm-clock is used. It is now
    recommended to use ntp in guest in this case.
...
without introducing additional issues."
  ...
  # https://www.suse.com/support/update/announcement/2016/suse-su-20162902-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?427a943c"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"kvm-1.4.2-50.1")) flag++;
