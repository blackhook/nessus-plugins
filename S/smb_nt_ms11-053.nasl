...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2011-A-0100-S");
...
affects systems with Bluetooth capability.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?29b112e3");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-1265");
