...
the channel (CVE-2010-1156)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-04/msg00091.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"irssi-0.8.12-30.71.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"irssi-devel-0.8.12-30.71.1") ) flag++;
