...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"842436");
...
of the script sent by the attacker.");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2004/ms04-026");
