...
(CVE-2008-2933)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0807&L=scientific-linux-errata&T=0&P=1785
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?498c728f"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"devhelp-0.12-18.el5")) flag++;
if (rpm_check(release:"SL5", reference:"devhelp-devel-0.12-18.el5")) flag++;
if (rpm_check(release:"SL5", reference:"firefox-3.0.1-1.el5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-1.9.0.1-1.el5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-1.9.0.1-1.el5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-unstable-1.9.0.1-1.el5")) flag++;
if (rpm_check(release:"SL5", reference:"yelp-2.16.0-20.el5")) flag++;
