...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : perl-58 (cve_2011_3597_improper_input)");
...
security updates :
  ...
  - Eval injection vulnerability in the Digest module before
    1.17 for Perl allows context-dependent attackers to
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2011-3597-improper-input-validation-vulnerability-in-perl
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ba709292"
  );
