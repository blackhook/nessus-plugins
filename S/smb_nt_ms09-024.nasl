...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2009-B-0025-S");
  script_xref(name:"MSFT", value:"MS09-024");
  script_xref(name:"MSKB", value:"967044");
  script_xref(name:"MSKB", value:"969559");
...
privileges.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?430dad64");
...
as well as 2007 Microsoft Office System, Works 8.5 and Works 9.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1533");
