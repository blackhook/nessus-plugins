...
if (description)
{
  ...
  script_name(english:"Solaris 7 (sparc) : 119010-01");
...
if (solaris_check_patch(release:"5.7", arch:"sparc", patch:"119010-01", obsoleted_by:"", package:"VRTSnetbp", version:"5.0,REV=2003.11.06.09.24") < 0) flag++;
