...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libpng on SL6.x i386/x86_64 (20151209)");
...
a specially crafted PNG image. (CVE-2015-7981)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5b8bfd26"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"libpng-1.2.49-2.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"libpng-debuginfo-1.2.49-2.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"libpng-devel-1.2.49-2.el6_7")) flag++;
if (rpm_check(release:"SL6", reference:"libpng-static-1.2.49-2.el6_7")) flag++;
