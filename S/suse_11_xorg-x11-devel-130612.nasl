...
if (description)
{
  ...
  script_name(english:"SuSE 11.2 Security Update : xorg-x11-libs (SAT Patch Number 7846)");
  ...
  script_set_attribute(
    ...
    value:
"This update of xorg-x11-libs fixes several integer and buffer overflow
issues. (bnc#815451, bnc#821663)"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2013-1986.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 7846.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"xorg-x11-devel-7.4-8.26.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"xorg-x11-libs-7.4-8.26.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"xorg-x11-devel-7.4-8.26.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"xorg-x11-libs-7.4-8.26.36.1")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"xorg-x11-libs-32bit-7.4-8.26.36.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, reference:"xorg-x11-libs-7.4-8.26.36.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"s390x", reference:"xorg-x11-libs-32bit-7.4-8.26.36.1")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"xorg-x11-libs-32bit-7.4-8.26.36.1")) flag++;
