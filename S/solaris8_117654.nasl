...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 117654-67");
  script_summary(english:"Check for patch 117654-67");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 117654-67"
  );
  script_set_attribute(
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"117654-67", obsoleted_by:"", package:"SUNWstadm", version:"2.4") < 0) flag++;
