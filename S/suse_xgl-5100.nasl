...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Xgl (ZYPP Patch Number 5100)");
...
CVE-2007-6429 / CVE-2008-0006)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2008-0006.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 5100.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:1, reference:"xgl-cvs_060522-0.37.5")) flag++;
