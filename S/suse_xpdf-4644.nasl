...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : xpdf (ZYPP Patch Number 4644)");
...
CVE-2007-5393)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 4644.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:1, reference:"xpdf-tools-3.01-21.13")) flag++;
if (rpm_check(release:"SLES10", sp:1, reference:"xpdf-tools-3.01-21.13")) flag++;
