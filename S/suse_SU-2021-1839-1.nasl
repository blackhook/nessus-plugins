...
# extracted from SUSE update advisory SUSE-SU-2021:1839-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES15 Security Update : nginx (SUSE-SU-2021:1839-1)");
...
without introducing additional issues.");
  ...
  # https://www.suse.com/support/update/announcement/2021/suse-su-20211839-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?02510540");
...
zypper in -t patch
SUSE-SLE-Product-SUSE-Manager-Server-4.0-2021-1839=1
...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", reference:"nginx-1.16.1-6.13.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nginx-debuginfo-1.16.1-6.13.1")) flag++;
if (rpm_check(release:"SLES15", sp:"1", reference:"nginx-debugsource-1.16.1-6.13.1")) flag++;
