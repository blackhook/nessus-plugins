...
festival_server. CVE-2010-3996 has been assigned to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-10/msg00028.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"festival-1.96-72.71.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"festival-devel-1.96-72.71.1") ) flag++;
