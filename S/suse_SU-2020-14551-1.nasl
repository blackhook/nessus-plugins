...
# SUSE update advisory SUSE-SU-2020:14551-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_xref(name:"SuSE", value:"SUSE-SU-2020:14551-1");

  script_name(english:"SUSE SLES11 Security Update : mutt (SUSE-SU-2020:14551-1)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1179035");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1179113");
  # https://lists.suse.com/pipermail/sle-security-updates/2020-November/007894.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01c0059f");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-28896");
...
pkgs = [
    {'reference':'mutt-1.5.17-42.56', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'SLES_SAP-release-11.4'},
    {'reference':'mutt-1.5.17-42.56', 'sp':'4', 'release':'SLES11', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'sles-release-11.4'}
];
