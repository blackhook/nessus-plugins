...
if (description)
{
  ...
  script_name(english:"Solaris 8 (sparc) : 119008-01");
  script_summary(english:"Check for patch 119008-01");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 119008-01");
...
if (solaris_check_patch(release:"5.8", arch:"sparc", patch:"119008-01", obsoleted_by:"119009-02 ", package:"VRTSnetbp", version:"6.0,REV=2005.09.07.19.13") < 0) flag++;
