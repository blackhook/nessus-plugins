...
if ( rpm_check(release:"SUSE11.0", reference:"gpomme-1.15-38.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pommed-1.15-38.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"wmpomme-1.15-38.2") ) flag++;
