...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ca-certificates on SL6.x (noarch) (20131220)");
...
effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=5576
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?076075f0"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:ca-certificates");
