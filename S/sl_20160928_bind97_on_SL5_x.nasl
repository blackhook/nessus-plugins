...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : bind97 on SL5.x i386/x86_64 (20160928)");
...
"Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1609&L=scientific-linux-errata&F=&S=&P=9507
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?093e4633"
  );
