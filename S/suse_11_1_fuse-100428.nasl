...
if ( rpm_check(release:"SUSE11.1", reference:"fuse-2.7.2-61.18.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"fuse-devel-2.7.2-61.18.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libfuse2-2.7.2-61.18.1") ) flag++;
