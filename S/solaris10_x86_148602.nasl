...
if(description)
{
 ...
 script_name(english: "Solaris 10 (x86) : 148602-01");
script_cve_id("CVE-2012-1681");
 script_set_attribute(attribute: "synopsis", value:
"The remote host is missing Sun Security Patch number 148602-01");
 script_set_attribute(attribute: "description", value:
'SunOS 5.10_x86: sockfs patch.
Date this patch was last updated by Sun : Feb/15/12');
 script_set_attribute(attribute: "solution", value:
"You should install this patch for your system to be up-to-date.");
 script_set_attribute(attribute: "see_also", value:
"https://getupdates.oracle.com/readme/148602-01");
 ...
 script_summary(english: "Check for patch 148602-01");
