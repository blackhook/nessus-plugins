...
if (description)
{
  ...
  script_bugtraq_id(72188);

  script_name(english:"Oracle Solaris Critical Patch Update : jan2015_SRU11_2_6_4_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: KSSL). Supported
    ...
    a subset of Solaris accessible data. (CVE-2014-6481)"
  );
  script_set_attribute(
    attribute:"see_also",
...
fix_release = "0.5.11-0.175.2.6.0.4.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.2.6.0.4.0", sru:"11.2.6.4.0") > 0) flag++;
