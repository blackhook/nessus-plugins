...
# extracted from openSUSE Security Update MozillaThunderbird-3154.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird (MozillaThunderbird-3154)");
  script_summary(english:"Check for the MozillaThunderbird-3154 patch");
  ...
  script_set_attribute(
    ...
    value:
"Mozilla Thunderbird 3.0 was updated to version 3.0.7, fixing various
...
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-3.0.8-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-devel-3.0.8-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-translations-common-3.0.8-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"MozillaThunderbird-translations-other-3.0.8-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"enigmail-1.0.1-2.2.1") ) flag++;
