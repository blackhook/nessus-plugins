...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : mod_nss on SL7.x x86_64 (20161103)");
...
Security Fix(es) :
  ...
  - A flaw was found in the way mod_nss parsed certain
    OpenSSL-style cipher strings. As a result, mod_nss could
    potentially use ciphers that were not intended to be
    enabled. (CVE-2016-3099)
...
Additional Changes :"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?37a0b868"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mod_nss-1.0.14-7.el7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"mod_nss-debuginfo-1.0.14-7.el7")) flag++;
