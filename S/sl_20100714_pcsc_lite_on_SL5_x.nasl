...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : pcsc-lite on SL5.x i386/x86_64");
...
automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1007&L=scientific-linux-errata&T=0&P=1534
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?79f5c86e"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"pcsc-lite-1.4.4-4.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"pcsc-lite-devel-1.4.4-4.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"pcsc-lite-doc-1.4.4-4.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"pcsc-lite-libs-1.4.4-4.el5_5")) flag++;
