...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xorg-x11-server on SL5.x i386/x86_64 (20141211)");
...
CVE-2014-8100, CVE-2014-8101, CVE-2014-8102)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1412&L=scientific-linux-errata&T=0&P=1823
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c55a3fa"
  );
