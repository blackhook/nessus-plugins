...
if (description)
{
  ...
  script_name(english:"Solaris 8 (x86) : 121973-06");
  script_summary(english:"Check for patch 121973-06");

  script_set_attribute(
    attribute:"synopsis", 
    value:"The remote host is missing Sun Security Patch number 121973-06"
  );
  script_set_attribute(
...
frequently repeatable crash (complete DOS)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://getupdates.oracle.com/readme/121973-06"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"121973-06", obsoleted_by:"", package:"SUNWcsr", version:"11.8.0,REV=2000.01.08.18.17") < 0) flag++;
