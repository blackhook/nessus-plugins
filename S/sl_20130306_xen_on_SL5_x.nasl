...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xen on SL5.x i386/x86_64 (20130306)");
...
guests must be restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1303&L=scientific-linux-errata&T=0&P=2309
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38c60940"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"xen-3.0.3-142.el5_9.2")) flag++;
if (rpm_check(release:"SL5", reference:"xen-debuginfo-3.0.3-142.el5_9.2")) flag++;
if (rpm_check(release:"SL5", reference:"xen-devel-3.0.3-142.el5_9.2")) flag++;
if (rpm_check(release:"SL5", reference:"xen-libs-3.0.3-142.el5_9.2")) flag++;
