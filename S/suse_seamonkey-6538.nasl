...
# extracted from openSUSE Security Update seamonkey-6538.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : seamonkey (seamonkey-6538)");
  script_summary(english:"Check for the seamonkey-6538 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-1.1.18-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-dom-inspector-1.1.18-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-irc-1.1.18-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-mail-1.1.18-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-spellchecker-1.1.18-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"seamonkey-venkman-1.1.18-0.1") ) flag++;
