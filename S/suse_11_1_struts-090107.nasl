...
if ( rpm_check(release:"SUSE11.1", reference:"struts-1.2.9-162.163.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"struts-javadoc-1.2.9-162.163.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"struts-manual-1.2.9-162.163.2") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"struts-webapps-tomcat6-1.2.9-162.163.2") ) flag++;
