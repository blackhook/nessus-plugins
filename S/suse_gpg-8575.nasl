...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : gpg (ZYPP Patch Number 8575)");
...
"This update for gpg provides the following fixes :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8575.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"gpg-1.4.2-23.21.1")) flag++;
