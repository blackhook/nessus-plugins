...
# extracted from SUSE update advisory SUSE-SU-2018:3033-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLED12 / SLES12 Security Update : texlive (SUSE-SU-2018:3033-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?141c1440"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
patch SUSE-SLE-SDK-12-SP3-2018-2164=1

SUSE Linux Enterprise Server 12-SP3:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2018-2164=1

SUSE Linux Enterprise Desktop 12-SP3:zypper in -t patch
SUSE-SLE-DESKTOP-12-SP3-2018-2164=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"3", reference:"libkpathsea6-6.2.0dev-22.3.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libkpathsea6-debuginfo-6.2.0dev-22.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libkpathsea6-6.2.0dev-22.3.1")) flag++;
if (rpm_check(release:"SLED12", sp:"3", cpu:"x86_64", reference:"libkpathsea6-debuginfo-6.2.0dev-22.3.1")) flag++;
