...
if (description)
{
  ...
  script_cve_id("CVE-2023-25616");
  script_xref(name:"IAVA", value:"2023-A-0130");

  script_name(english:"SAP BusinessObjects Business Intelligence Platform Code Injection (3245526)");

  script_set_attribute(attribute:"synopsis", value:
"The SAP business intelligence product installed on the remote Windows host is affected by a code injection vulnerability");
...
self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?22ad109b");
...
"See vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-25616");
...
var constraints = [
  ...
  { 'min_version': '14.3',   'fixed_version' : '14.3.2.4429', 'fixed_display': '4.3 SP002 000800'},
  { 'min_version': '14.3.3',   'fixed_version' : '14.3.3.4433', 'fixed_display': '4.3 SP003 000000'}
];
