...
# extracted from openSUSE Security Update dbus-1-4431.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dbus-1 (openSUSE-SU-2011:0401-1)");
  script_summary(english:"Check for the dbus-1-4431 patch");
...
crafted message (CVE-2010-4352)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00075.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"dbus-1-1.2.16-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"dbus-1-devel-1.2.16-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"dbus-1-32bit-1.2.16-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"dbus-1-devel-32bit-1.2.16-5.4.1") ) flag++;
