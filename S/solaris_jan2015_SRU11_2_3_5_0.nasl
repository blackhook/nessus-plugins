...
if (description)
{
  ...
  script_cve_id("CVE-2014-6570", "CVE-2015-0378", "CVE-2015-0397");
  script_bugtraq_id(72147, 72164, 72186);

  script_name(english:"Oracle Solaris Critical Patch Update : jan2015_SRU11_2_3_5_0");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: File System). The
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Systems Products Suite (subcomponent: Libc). The
    supported version that is affected is 11. Easily
    exploitable vulnerability requiring logon to Operating
    System. Successful attack of this vulnerability can
    result in unauthorized ability to cause a partial denial
    of service (partial DOS) of Solaris. (CVE-2015-0378)
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    ...
    System. Successful attack of this vulnerability can
    result in unauthorized ability to cause a partial denial
    of service (partial DOS) of Solaris. (CVE-2015-0397)"
  );
  script_set_attribute(
    attribute:"see_also",
...
fix_release = "0.5.11-0.175.2.3.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.2.3.0.5.0", sru:"11.2.3.5.0") > 0) flag++;
