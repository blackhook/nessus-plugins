...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0636");

  script_name(english:"SSLv2-Only Open Ports Unsupported");
  script_summary(english:"Checks if the remote host has any open ports which solely support SSLv2 which are unsupported");
