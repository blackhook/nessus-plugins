...
# extracted from Slackware Security Advisory 2003-345-01. The text 
...
if (description)
{
  ...
  script_name(english:"Slackware 8.1 / 9.0 / 9.1 / current : cvs security update (SSA:2003-345-01)");
...
should upgrade to the new CVS package."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7e7d94c4"
  );
...
flag = 0;
if (slackware_check(osver:"8.1", pkgname:"cvs", pkgver:"1.11.10", pkgarch:"i386", pkgnum:"1")) flag++;

if (slackware_check(osver:"9.0", pkgname:"cvs", pkgver:"1.11.10", pkgarch:"i386", pkgnum:"1")) flag++;

if (slackware_check(osver:"9.1", pkgname:"cvs", pkgver:"1.11.10", pkgarch:"i486", pkgnum:"1")) flag++;

if (slackware_check(osver:"current", pkgname:"cvs", pkgver:"1.11.10", pkgarch:"i486", pkgnum:"1")) flag++;
