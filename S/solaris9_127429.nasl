...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 127429-07");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"127429-07", obsoleted_by:"", package:"SUNWsgeex", version:"6.1,REV=2007.04.25.10.45") < 0) flag++;
