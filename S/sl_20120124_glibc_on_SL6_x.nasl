...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : glibc on SL6.x i386/x86_64 (20120124)");
...
backported patches to resolve these issues."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1201&L=scientific-linux-errata&T=0&P=1716
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f4297135"
  );
