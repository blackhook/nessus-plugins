...
# extracted from openSUSE Security Update icedtea-web-5422.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2011-2939", "CVE-2011-3377");

  script_name(english:"openSUSE Security Update : icedtea-web (openSUSE-SU-2011:1251-1)");
  script_summary(english:"Check for the icedtea-web-5422 patch");
  ...
  script_set_attribute(
    ...
    value:
"Update to version 1.1.4 of icedtea-web to fix the following issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-11/msg00019.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"icedtea-web-1.1.4-0.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"icedtea-web-javadoc-1.1.4-0.2.1") ) flag++;
