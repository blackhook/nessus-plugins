...
# extracted from openSUSE Security Update flash-player-5183.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : flash-player (openSUSE-SU-2011:1060-1)");
  script_summary(english:"Check for the flash-player-5183 patch");
...
could lead to code execution. (CVE-2011-2430)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-09/msg00028.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"flash-player-10.3.183.10-0.2.1") ) flag++;
