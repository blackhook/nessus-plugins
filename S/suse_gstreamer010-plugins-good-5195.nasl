...
# extracted from openSUSE Security Update gstreamer010-plugins-good-5195.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gstreamer010-plugins-good (gstreamer010-plugins-good-5195)");
  script_summary(english:"Check for the gstreamer010-plugins-good-5195 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"gstreamer010-plugins-good-0.10.2-16.19.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"gstreamer010-plugins-good-extra-0.10.2-16.19.3") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gstreamer010-plugins-good-0.10.4-10") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"gstreamer010-plugins-good-extra-0.10.4-10") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"gstreamer010-plugins-good-0.10.6-41.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"gstreamer010-plugins-good-extra-0.10.6-41.2") ) flag++;
