...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : dhcp-server (YOU Patch Number 11373)");
...
code as the DHCP server."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 11373.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"dhcp-server-3.0.1rc13-28.22")) flag++;
