...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 122073-04");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"122073-04", obsoleted_by:"", package:"VRTSnetbp", version:"6.0,REV=2006.11.09.18.12") < 0) flag++;
