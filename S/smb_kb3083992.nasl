...
if (description)
{
  script_id(85880);
  script_version("1.5");
  script_xref(name:"IAVA", value:"2015-A-0217-S");
  script_set_attribute(attribute:"plugin_modification_date", value:"2021/06/03");

  script_xref(name:"MSKB", value:"3083992");
...
certificates to prevent bypassing publisher rules.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2015/3083992");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/3083992/microsoft-security-advisory-update-to-improve-applocker-certificate-ha");
