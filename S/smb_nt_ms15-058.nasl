...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3045305");
  script_xref(name:"MSKB", value:"3045303");
  script_xref(name:"MSKB", value:"3045311");
  script_xref(name:"MSKB", value:"3045308");
  script_xref(name:"MSKB", value:"3045313");
  script_xref(name:"MSKB", value:"3045312");
  script_xref(name:"MSKB", value:"3045316");
  script_xref(name:"MSKB", value:"3045314");
  script_xref(name:"MSKB", value:"3045318");
  script_xref(name:"MSKB", value:"3045317");
  script_xref(name:"MSKB", value:"3045321");
  script_xref(name:"MSKB", value:"3045319");
  script_xref(name:"MSKB", value:"3045324");
  script_xref(name:"MSKB", value:"3045323");
...
vulnerabilities :
  ...
  - A remote code execution vulnerability exists due to
    ...
    address, to execute arbitrary code. (CVE-2015-1763)");
  # https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-058
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4c135c5d");
