...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 0 for SLE 15 SP2) (SUSE-SU-2021:2538-1)");
...
referenced in the SUSE-SU-2021:2538-1 advisory.
...
"Update the affected kernel-livepatch-5_3_18-22-default, kgraft-patch-4_12_14-95_77-default and / or kgraft-
patch-4_4_180-94_127-default packages.");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-95.77-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-95_77-default-3-2.1', 'sp':'4', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.4']}
        ]
      },
      '4.4.180-94.127-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_127-default-13-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      },
      '5.3.18-22-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-5_3_18-22-default-14-5.2', 'sp':'2', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.2', 'SLE_HPC-release-15.2', 'sle-module-live-patching-release-15.2', 'sles-release-15.2']}
        ]
      }
    }
  }
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-5_3_18-22-default / etc');
}
