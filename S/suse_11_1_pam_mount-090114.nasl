...
# extracted from openSUSE Security Update pam_mount-427.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pam_mount (pam_mount-427)");
  script_summary(english:"Check for the pam_mount-427 patch");
...
11.0 and 11.1)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=465303"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.1", reference:"pam_mount-0.47-12.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"pam_mount-32bit-0.47-12.14.1") ) flag++;
