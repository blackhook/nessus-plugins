...
CVE-2009-3609)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0910&L=scientific-linux-errata&T=0&P=1683
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?75e8b804"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"kdegraphics-3.3.1-15.el4_8.2")) flag++;
if (rpm_check(release:"SL4", reference:"kdegraphics-devel-3.3.1-15.el4_8.2")) flag++;

if (rpm_check(release:"SL5", reference:"kdegraphics-3.5.4-15.el5_4.2")) flag++;
if (rpm_check(release:"SL5", reference:"kdegraphics-devel-3.5.4-15.el5_4.2")) flag++;
