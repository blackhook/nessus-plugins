...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss on SL5.x, SL6.x i386/x86_64 (20140926)");
...
for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1409&L=scientific-linux-errata&T=0&P=1857
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?114eaf2f"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"nss-3.16.1-4.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"nss-debuginfo-3.16.1-4.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"nss-devel-3.16.1-4.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"nss-pkcs11-devel-3.16.1-4.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"nss-tools-3.16.1-4.el5_11")) flag++;

if (rpm_check(release:"SL6", reference:"nss-3.16.1-7.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-debuginfo-3.16.1-7.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-devel-3.16.1-7.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-pkcs11-devel-3.16.1-7.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-softokn-3.14.3-12.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-softokn-debuginfo-3.14.3-12.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-softokn-devel-3.14.3-12.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-softokn-freebl-3.14.3-12.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-softokn-freebl-devel-3.14.3-12.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-sysinit-3.16.1-7.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-tools-3.16.1-7.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-util-3.16.1-2.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-util-debuginfo-3.16.1-2.el6_5")) flag++;
if (rpm_check(release:"SL6", reference:"nss-util-devel-3.16.1-2.el6_5")) flag++;
