...
if ( rpm_check(release:"SUSE11.1", reference:"libexpat0-1.95.8-64.50.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libexpat0-32bit-1.95.8-64.50.1") ) flag++;
