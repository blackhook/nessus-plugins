...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : ImageMagick (ZYPP Patch Number 2048)");
...
"Several security problems have been fixed in ImageMagick :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2006-3743.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2006-3744.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://support.novell.com/security/cve/CVE-2006-4144.html"
  );
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 2048.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:0, reference:"ImageMagick-6.2.5-16.5")) flag++;
if (rpm_check(release:"SLED10", sp:0, reference:"ImageMagick-Magick++-6.2.5-16.5")) flag++;
if (rpm_check(release:"SLED10", sp:0, reference:"ImageMagick-devel-6.2.5-16.5")) flag++;
