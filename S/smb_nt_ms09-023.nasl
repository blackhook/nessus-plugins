...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"963093");
...
systems that was accessible to the logged-on user.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-023");
