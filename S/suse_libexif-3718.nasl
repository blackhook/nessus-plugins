...
# extracted from openSUSE Security Update libexif-3718.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libexif (libexif-3718)");
  script_summary(english:"Check for the libexif-3718 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"libexif-0.6.13-20.6") ) flag++;
if ( rpm_check(release:"SUSE10.1", cpu:"x86_64", reference:"libexif-32bit-0.6.13-20.6") ) flag++;
