...
# extracted from SUSE update advisory SUSE-SU-2020:1842-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : systemd (SUSE-SU-2020:1842-1)");
...
shared/install: try harder to find enablement symlinks when disabling
a unit (bsc#1157315)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1157315"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1161262"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1162698"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1164538"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1165633"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1167622"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1171145"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.suse.com/security/cve/CVE-2019-20386/"
  );
  # https://www.suse.com/support/update/announcement/2020/suse-su-20201842-1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f090989"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"libsystemd0-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libsystemd0-32bit-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libsystemd0-debuginfo-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libsystemd0-debuginfo-32bit-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libudev-devel-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libudev1-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libudev1-32bit-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libudev1-debuginfo-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libudev1-debuginfo-32bit-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"systemd-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"systemd-32bit-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"systemd-debuginfo-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"systemd-debuginfo-32bit-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"systemd-debugsource-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"systemd-devel-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"systemd-sysvinit-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"udev-228-150.86.3")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"udev-debuginfo-228-150.86.3")) flag++;
