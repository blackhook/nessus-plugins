...
if ( rpm_check(release:"SUSE11.2", reference:"freetype2-2.3.9-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"freetype2-devel-2.3.9-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"freetype2-32bit-2.3.9-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"freetype2-devel-32bit-2.3.9-2.6.1") ) flag++;
