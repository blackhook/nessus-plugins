...
# extracted from openSUSE Security Update xrdp-443.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xrdp (xrdp-443)");
  script_summary(english:"Check for the xrdp-443 patch");
...
remotely to execute arbitrary code. Additionally xrdp does not
register remote session as local anymore."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.1", reference:"xrdp-0.4.1-16.6.1") ) flag++;
