...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2442962");
...
LocalSystem privileges."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2010/ms10-100");
  script_set_attribute(
    attribute:"solution",
    value:
