...
if ( rpm_check(release:"SUSE11.0", reference:"pango-1.20.1-20.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pango-devel-1.20.1-20.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"pango-module-thai-lang-1.20.1-20.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"pango-32bit-1.20.1-20.2") ) flag++;
