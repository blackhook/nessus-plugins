...
normally not have permission to access. (CVE-2008-0595)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0802&L=scientific-linux-errata&T=0&P=1666
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?70e5abca"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"dbus-1.0.0-6.3.el5_1")) flag++;
if (rpm_check(release:"SL5", reference:"dbus-devel-1.0.0-6.3.el5_1")) flag++;
if (rpm_check(release:"SL5", reference:"dbus-x11-1.0.0-6.3.el5_1")) flag++;
