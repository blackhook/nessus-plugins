...
if (description)
{
  ...
  script_name(english:"Solaris 6 (sparc) : 119005-02");
...
if (solaris_check_patch(release:"5.6", arch:"sparc", patch:"119005-02", obsoleted_by:"", package:"VRTSnetbp", version:"4.5FP,REV=2003.11.03.15.48") < 0) flag++;
