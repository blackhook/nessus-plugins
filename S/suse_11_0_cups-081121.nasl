...
# extracted from openSUSE Security Update cups-322.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cups (cups-322)");
  script_summary(english:"Check for the cups-322 patch");
...
if ( rpm_check(release:"SUSE11.0", reference:"cups-1.3.7-25.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"cups-client-1.3.7-25.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"cups-devel-1.3.7-25.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"cups-libs-1.3.7-25.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"cups-libs-32bit-1.3.7-25.4") ) flag++;
