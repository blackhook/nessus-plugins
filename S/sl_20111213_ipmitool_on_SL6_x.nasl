...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : ipmitool on SL6.x i386/x86_64");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1112&L=scientific-linux-errata&T=0&P=3019
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ba70ffa4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"ipmitool-1.8.11-12.el6_2.1")) flag++;
if (rpm_check(release:"SL6", reference:"ipmitool-debuginfo-1.8.11-12.el6_2.1")) flag++;
