...
if (description)
{
  ...
  script_name(english:"Squid 3.2.0.11 < 3.x < 3.5.18 / 4.x < 4.0.10 Cache Poisoning Vulnerability (SQUID-2016:7)");
  script_summary(english:"Checks the version of Squid.");

  script_set_attribute(attribute:"synopsis", value:
"The remote proxy server is affected by a cache poisoning
vulnerability.");
  script_set_attribute(attribute:"description", value:
"According to its banner, the version of Squid running on the remote
host is 3.x after 3.2.0.11 and prior to 3.5.18, or 4.x prior to
4.0.10. It is, therefore, affected by a cache poisoning
vulnerability in the handling of HTTP requests.
...
apply the vendor-supplied patch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-4553");
...
constraints = [
  {"min_version":"3.2.0.11", "fixed_version":"3.5.18"},
