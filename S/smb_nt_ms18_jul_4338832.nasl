...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4338832");
  script_xref(name:"MSFT", value:"MS18-4338832");

  script_name(english:"KB4338832: Security update for Adobe Flash Player (July 2018)");
...
"The remote Windows host is missing security update KB4338832. It is,
...
in Adobe Flash Player.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cfcbe8d7");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4338832 to address this issue.");
...
# all <= 30.0.0.113
fix = FALSE;
if(ver_compare(ver:iver, fix:"30.0.0.113", strict:FALSE) <= 0)
  fix = "30.0.0.134";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS18-07', kb:'4338832', report);
