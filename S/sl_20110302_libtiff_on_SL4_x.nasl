...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : libtiff on SL4.x, SL5.x i386/x86_64");
...
this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1103&L=scientific-linux-errata&T=0&P=839
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?16f9ae22"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"libtiff-3.6.1-17.el4")) flag++;
if (rpm_check(release:"SL4", reference:"libtiff-devel-3.6.1-17.el4")) flag++;

if (rpm_check(release:"SL5", reference:"libtiff-3.8.2-7.el5_6.6")) flag++;
if (rpm_check(release:"SL5", reference:"libtiff-devel-3.8.2-7.el5_6.6")) flag++;
