...
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"127717-01", obsoleted_by:"127112-02 127128-11 ", package:"SUNWckr", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
if (solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"127717-01", obsoleted_by:"127112-02 127128-11 ", package:"SUNWhea", version:"11.10.0,REV=2005.01.21.16.34") < 0) flag++;
