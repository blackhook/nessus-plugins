...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:6815");

  script_name(english:"Scientific Linux Security Update : squid on SL7.x x86_64 (2022:6815)");
...
SLSA-2022:6815-1 advisory.

  - squid: buffer-over-read in SSPI and SMB authentication (CVE-2022-41318)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20226815-1");
...
var pkgs = [
    {'reference':'squid-3.5.20-17.el7_9.8', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'squid-debuginfo-3.5.20-17.el7_9.8', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'squid-migration-script-3.5.20-17.el7_9.8', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'squid-sysvinit-3.5.20-17.el7_9.8', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
