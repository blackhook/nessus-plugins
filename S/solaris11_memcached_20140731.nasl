...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : memcached (cve_2013_0179_buffer_errors)");
...
security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2013-0179-buffer-errors-vulnerability-in-memcached"
  );
