...
the SUSE-SU-2023:2304-1 advisory.
...
var pkgs = [
    {'reference':'rmt-server-2.13-150100.3.45.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'rmt-server-config-2.13-150100.3.45.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1']},
    {'reference':'rmt-server-pubcloud-2.13-150100.3.45.1', 'sp':'1', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-public-cloud-release-15.1', 'sles-release-15.1']},
