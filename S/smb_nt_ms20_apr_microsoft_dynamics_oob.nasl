...
if (description)
{
  ...
  script_cve_id("CVE-2020-1221", "CVE-2020-1591");
  script_xref(name:"MSKB", value:"4541722");
  script_xref(name:"MSFT", value:"MS20-4541722");
  script_xref(name:"IAVA", value:"2020-A-0250");
  script_xref(name:"IAVA", value:"2020-A-0355-S");
  script_xref(name:"CEA-ID", value:"CEA-2020-0101");

  script_name(english:"Security Updates for Microsoft Dynamics 365 (on-premises) (April 2020 OOB)");
...
vulnerabilities:
  ...
  - A cross-site scripting vulnerability exists when Microsoft Dynamics 365 (on-premises) does not properly
    ...
    delete content, and inject malicious content in the browser of the user. The security update addresses 
    the vulnerability by helping to ensure that Dynamics Server properly sanitizes web requests. 
    (CVE-2020-1221, CVE-2020-1591)");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/4541722");
  # https://community.dynamics.com/crm/b/crminthefield/posts/service-update-0-15-for-microsoft-dynamics-365-9-0
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ef3b4ab8");
  script_set_attribute(attribute:"solution", value:
"Microsoft has released KB4541722 to address this issue.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-1591");
...
constraints = [
  { 'min_version' : '9.0', 'fixed_version' : '9.0.15.9' }
];
