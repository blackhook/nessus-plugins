...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xulrunner on SL5.x i386/x86_64");
...
restarted for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1010&L=scientific-linux-errata&T=0&P=3603
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0fd6b380"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"xulrunner-1.9.2.11-4.el5_5")) flag++;
if (rpm_check(release:"SL5", reference:"xulrunner-devel-1.9.2.11-4.el5_5")) flag++;
