...
if(description)
{
 ...
 name["english"] = "Solaris 2.6 (sparc) : 107851-26";
...
e +=  solaris_check_patch(release:"5.6", arch:"sparc", patch:"107851-26", obsoleted_by:"", package:"TSIgfxOW", version:"2.1");
e +=  solaris_check_patch(release:"5.6", arch:"sparc", patch:"107851-26", obsoleted_by:"", package:"TSIgfxdrv", version:"2.1");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
