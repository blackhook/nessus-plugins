...
overflow in the tiffdump tool (CVE-2010-4665)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-04/msg00078.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"libtiff-devel-3.9.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libtiff3-3.9.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"tiff-3.9.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libtiff-devel-32bit-3.9.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libtiff3-32bit-3.9.2-5.10.1") ) flag++;
