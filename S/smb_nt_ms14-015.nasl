...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2930275");
...
"The remote Windows host has the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-015");
