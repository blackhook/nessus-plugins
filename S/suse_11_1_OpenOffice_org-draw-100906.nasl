...
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-draw-3.0.0.9-1.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-impress-3.0.0.9-1.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-impress-devel-3.0.0.9-1.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-impress-l10n-prebuilt-3.0.0.9-1.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-libs-gui-3.0.0.9-1.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-libs-gui-devel-3.0.0.9-1.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"OpenOffice_org-libs-gui-l10n-prebuilt-3.0.0.9-1.13.1") ) flag++;
