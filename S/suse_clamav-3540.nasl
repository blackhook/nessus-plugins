...
# extracted from openSUSE Security Update clamav-3540.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : clamav (clamav-3540)");
  script_summary(english:"Check for the clamav-3540 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"clamav-0.90.3-3.1") ) flag++;
