...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2491683");
  script_xref(name:"MSKB", value:"2506212");
...
cover page file, resulting in arbitrary code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-024");
  script_set_attribute(
    attribute:"solution",
    value:
