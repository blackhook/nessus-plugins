...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2972280");
  script_xref(name:"MSKB", value:"2973932");
...
another vulnerability in a low integrity process.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-041");
