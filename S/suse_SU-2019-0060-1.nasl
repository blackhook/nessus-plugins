...
# extracted from SUSE update advisory SUSE-SU-2019:0060-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : LibVNCServer (SUSE-SU-2019:0060-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f556835f"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
SUSE-OpenStack-Cloud-7-2019-60=1

SUSE Linux Enterprise Software Development Kit 12-SP4:zypper in -t
patch SUSE-SLE-SDK-12-SP4-2019-60=1

SUSE Linux Enterprise Software Development Kit 12-SP3:zypper in -t
patch SUSE-SLE-SDK-12-SP3-2019-60=1

SUSE Linux Enterprise Server for SAP 12-SP2:zypper in -t patch
SUSE-SLE-SAP-12-SP2-2019-60=1

SUSE Linux Enterprise Server 12-SP4:zypper in -t patch
SUSE-SLE-SERVER-12-SP4-2019-60=1

SUSE Linux Enterprise Server 12-SP3:zypper in -t patch
SUSE-SLE-SERVER-12-SP3-2019-60=1

SUSE Linux Enterprise Server 12-SP2-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-2019-60=1

SUSE Linux Enterprise Server 12-SP2-BCL:zypper in -t patch
SUSE-SLE-SERVER-12-SP2-BCL-2019-60=1

SUSE Linux Enterprise Server 12-SP1-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2019-60=1

SUSE Linux Enterprise Server 12-LTSS:zypper in -t patch
SUSE-SLE-SERVER-12-2019-60=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"LibVNCServer-debugsource-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libvncclient0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libvncclient0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libvncserver0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"libvncserver0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"LibVNCServer-debugsource-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvncclient0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvncclient0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvncserver0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"libvncserver0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"LibVNCServer-debugsource-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libvncclient0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libvncclient0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libvncserver0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"0", reference:"libvncserver0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"LibVNCServer-debugsource-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libvncclient0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libvncclient0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libvncserver0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"3", reference:"libvncserver0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"LibVNCServer-debugsource-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libvncclient0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libvncclient0-debuginfo-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libvncserver0-0.9.9-17.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"2", reference:"libvncserver0-debuginfo-0.9.9-17.8.1")) flag++;
