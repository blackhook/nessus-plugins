...
condition in ncpfs mounts (CVE-2010-0788 / bnc#550004)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-05/msg00020.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"ncpfs-2.2.6-158.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ncpfs-devel-2.2.6-158.5.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"ncpfs-32bit-2.2.6-158.5.1") ) flag++;
