...
if(description)
{
 ...
 script_name(english: "Solaris 5.9 (sparc) : 117492-01");
...
e +=  solaris_check_patch(release:"5.9", arch:"sparc", patch:"117492-01", obsoleted_by:"", package:"SUNWutdso", version:"1.0_05,REV=2002.12.12.09.10");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
