...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2020:5566");
  script_xref(name:"IAVA", value:"2020-A-0566-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Scientific Linux Security Update : openssl on SL7.x i686/x86_64 (2020:5566)");
...
SLSA-2020:5566-1 advisory.

  - openssl: EDIPARTYNAME NULL pointer de-reference (CVE-2020-1971)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20205566-1");
...
pkgs = [
    {'reference':'openssl-1.0.2k-21.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'openssl-debuginfo-1.0.2k-21.el7_9', 'cpu':'i686', 'release':'SL7'},
    {'reference':'openssl-debuginfo-1.0.2k-21.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'openssl-devel-1.0.2k-21.el7_9', 'cpu':'i686', 'release':'SL7'},
    {'reference':'openssl-devel-1.0.2k-21.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'openssl-libs-1.0.2k-21.el7_9', 'cpu':'i686', 'release':'SL7'},
    {'reference':'openssl-libs-1.0.2k-21.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'openssl-perl-1.0.2k-21.el7_9', 'cpu':'x86_64', 'release':'SL7'},
    {'reference':'openssl-static-1.0.2k-21.el7_9', 'cpu':'i686', 'release':'SL7'},
    {'reference':'openssl-static-1.0.2k-21.el7_9', 'cpu':'x86_64', 'release':'SL7'}
];
