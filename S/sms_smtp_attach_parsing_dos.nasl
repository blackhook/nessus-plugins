...
"Symantec Mail Security for SMTP, which provides antispam and antivirus
protection for the IIS SMTP Service, is installed on the remote
Windows host.
...
cause the mail queue to backup.");
  script_set_attribute(attribute:"see_also", value:"https://secuniaresearch.flexerasoftware.com/secunia_research/2007-48/advisory/");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2007/Jun/593" );
  script_set_attribute(attribute:"see_also", value:"https://support.symantec.com/en_US/article.SYMSA1124.html" );
