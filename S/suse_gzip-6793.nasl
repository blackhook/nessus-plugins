...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : gzip (ZYPP Patch Number 6793)");
...
by this flaw."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6793.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, cpu:"x86_64", reference:"gzip-1.3.5-159.10.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, cpu:"x86_64", reference:"gzip-1.3.5-159.10.1")) flag++;
