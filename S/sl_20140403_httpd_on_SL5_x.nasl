...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : httpd on SL5.x i386/x86_64 (20140403)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1404&L=scientific-linux-errata&T=0&P=321
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d6cc9762"
  );
