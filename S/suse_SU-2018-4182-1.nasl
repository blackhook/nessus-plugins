...
# extracted from SUSE update advisory SUSE-SU-2018:4182-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES11 Security Update : crash (SUSE-SU-2018:4182-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1075785"
  );
  # https://www.suse.com/support/update/announcement/2018/suse-su-20184182-1/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f044e955"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch sdksp4-crash-13913=1

SUSE Linux Enterprise Server 11-SP4:zypper in -t patch
slessp4-crash-13913=1

SUSE Linux Enterprise Debuginfo 11-SP4:zypper in -t patch
dbgsp4-crash-13913=1"
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:crash");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:crash-eppic");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:"4", reference:"crash-7.0.9-30.3.28")) flag++;
if (rpm_check(release:"SLES11", sp:"4", reference:"crash-eppic-7.0.9-30.3.28")) flag++;
