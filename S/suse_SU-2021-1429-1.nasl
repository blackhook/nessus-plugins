...
# extracted from SUSE update advisory SUSE-SU-2021:1429-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : permissions (SUSE-SU-2021:1429-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.suse.com/show_bug.cgi?id=1050467"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cc5958d0"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-OpenStack-Cloud-Crowbar-9-2021-1429=1

SUSE OpenStack Cloud 9 :

zypper in -t patch SUSE-OpenStack-Cloud-9-2021-1429=1

SUSE Linux Enterprise Server for SAP 12-SP4 :

zypper in -t patch SUSE-SLE-SAP-12-SP4-2021-1429=1

SUSE Linux Enterprise Server 12-SP4-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP4-LTSS-2021-1429=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"permissions-20170707-3.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"permissions-debuginfo-20170707-3.27.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"permissions-debugsource-20170707-3.27.1")) flag++;
