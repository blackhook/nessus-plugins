...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : kernel (Live Patch 37 for SLE 12 SP3) (SUSE-SU-2021:2042-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SLES12 host has packages installed that are affected by multiple vulnerabilities as referenced in
the SUSE-SU-2021:2042-1 advisory.
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.4.180-94.138-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_138-default-6-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sles-release-12.3']}
        ]
      },
      '4.4.180-94.141-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_4_180-94_141-default-5-2.2', 'sp':'3', 'cpu':'x86_64', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.3']}
        ]
      }
    }
  }
