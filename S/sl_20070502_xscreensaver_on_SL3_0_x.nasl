...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xscreensaver on SL3.0.x i386/x86_64");
...
causing XScreenSaver to crash, unlocking the screen. (CVE-2007-1859)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=1098
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c0c439d3"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL3", reference:"xscreensaver-4.10-21.el3")) flag++;
