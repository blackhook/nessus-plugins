...
# extracted from openSUSE Security Update libopenssl-devel-5951.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : libopenssl-devel (libopenssl-devel-5951)");
  script_summary(english:"Check for the libopenssl-devel-5951 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"libopenssl-devel-0.9.8e-45.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"libopenssl0_9_8-0.9.8e-45.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"openssl-0.9.8e-45.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"openssl-certs-0.9.8e-45.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"libopenssl0_9_8-32bit-0.9.8e-45.7") ) flag++;
