...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : vixie-cron on SL5.x i386/x86_64 (20120221)");
...
resolves these issues and adds this enhancement."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:vixie-cron");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:vixie-cron-debuginfo");
