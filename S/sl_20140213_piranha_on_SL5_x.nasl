...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : piranha on SL5.x i386/x86_64 (20140213)");
...
administrative credentials. (CVE-2013-6492)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1402&L=scientific-linux-errata&T=0&P=1690
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c7055d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"piranha-0.8.4-26.el5_10.1")) flag++;
if (rpm_check(release:"SL5", reference:"piranha-debuginfo-0.8.4-26.el5_10.1")) flag++;
