...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : ClamAV (ZYPP Patch Number 7661)");
...
to a DoS condition. CVE-2011-2721 has been assigned to this issue."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7661.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"clamav-0.97.2-1.5.2")) flag++;
