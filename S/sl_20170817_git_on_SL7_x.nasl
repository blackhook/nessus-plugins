...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : git on SL7.x x86_64 (20170817)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9839e746"
  );
...
flag = 0;
if (rpm_check(release:"SL7", reference:"emacs-git-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"emacs-git-el-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"git-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"git-all-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"git-bzr-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"git-cvs-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"git-daemon-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"git-debuginfo-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"git-email-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"git-gui-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"git-hg-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"git-p4-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"git-svn-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"gitk-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"gitweb-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"perl-Git-1.8.3.1-12.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"perl-Git-SVN-1.8.3.1-12.el7_4")) flag++;
