...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 123893-81");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"123893-81", obsoleted_by:"", package:"SUNWcacaort", version:"2.0,REV=15") < 0) flag++;
