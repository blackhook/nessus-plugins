...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-1.7.0-openjdk on SL5.x, SL7.x i386/x86_64 (20160421)");
...
"Security Fix(es) :
  ...
  - It was discovered that the Security component in OpenJDK
    ...
    (CVE-2016-0695)");
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1604&L=scientific-linux-errata&F=&S=&P=13345
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3f244eae");
