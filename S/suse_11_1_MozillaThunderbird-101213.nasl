...
if ( rpm_check(release:"SUSE11.1", reference:"MozillaThunderbird-3.0.11-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaThunderbird-devel-3.0.11-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaThunderbird-translations-common-3.0.11-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"MozillaThunderbird-translations-other-3.0.11-0.6.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"enigmail-1.0.1-6.6.1") ) flag++;
