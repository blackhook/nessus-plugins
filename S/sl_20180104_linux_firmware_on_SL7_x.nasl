...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : linux-firmware on SL7.x (noarch) (20180104) (Spectre)");
...
mitigation."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7941fb46"
  );
...
flag = 0;
if (rpm_check(release:"SL7", reference:"iwl100-firmware-39.31.5.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl1000-firmware-39.31.5.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl105-firmware-18.168.6.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl135-firmware-18.168.6.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl2000-firmware-18.168.6.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl2030-firmware-18.168.6.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl3160-firmware-22.0.7.0-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl3945-firmware-15.32.2.9-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl4965-firmware-228.61.2.24-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl5000-firmware-8.83.5.1_1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl5150-firmware-8.24.2.2-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl6000-firmware-9.221.4.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl6000g2a-firmware-17.168.5.3-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl6000g2b-firmware-17.168.5.2-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl6050-firmware-41.28.5.1-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl7260-firmware-22.0.7.0-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"iwl7265-firmware-22.0.7.0-57.el7_4")) flag++;
if (rpm_check(release:"SL7", reference:"linux-firmware-20170606-57.gitc990aae.el7_4")) flag++;
