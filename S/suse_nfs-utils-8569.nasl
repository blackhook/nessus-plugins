...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : nfs-utils (ZYPP Patch Number 8569)");
...
(CVE-2013-1923)(bnc#813464)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8569.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"nfs-utils-1.0.7-36.52.1")) flag++;
