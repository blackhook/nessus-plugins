...
if ( rpm_check(release:"SUSE11.1", reference:"acl-2.2.47-27.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libacl-2.2.47-27.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libacl-devel-2.2.47-27.10.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libacl-32bit-2.2.47-27.10.1") ) flag++;
