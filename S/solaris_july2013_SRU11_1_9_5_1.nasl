...
if (description)
{
  ...
  script_cve_id("CVE-2013-3748", "CVE-2013-3753", "CVE-2013-3797");
  script_bugtraq_id(61239, 61267, 61271);

  script_name(english:"Oracle Solaris Critical Patch Update : july2013_SRU11_1_9_5_1");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: Driver/IDM (iSCSI
    Data Mover)). The supported version that is affected is
    11. Easily exploitable vulnerability allows successful
    unauthenticated network attacks via iSCSI/iSER.
    Successful attack of this vulnerability can result in
    unauthorized Operating System hang or frequently
    repeatable crash (complete DOS). (CVE-2013-3748)

  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: Kernel/STREAMS
    framework). The supported version that is affected is
    11. Easily exploitable vulnerability allows successful
    ...
    (complete DOS). (CVE-2013-3753)

  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: Filesystem/DevFS).
    The supported version that is affected is 11. Difficult
