...
# extracted from openSUSE Security Update openafs-4887.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : openafs (openafs-4887)");
  script_summary(english:"Check for the openafs-4887 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"openafs-1.4.0-21.4") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"openafs-client-1.4.0-21.4") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"openafs-devel-1.4.0-21.4") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"openafs-server-1.4.0-21.4") ) flag++;
