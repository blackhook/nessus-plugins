...
techniques will have to be employed."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-05/msg00046.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-06/msg00039.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"opera-11.11-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"opera-gtk-11.11-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"opera-kde4-11.11-1.2.1") ) flag++;
