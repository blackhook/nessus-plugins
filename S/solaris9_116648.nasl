...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 116648-25");
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"116648-25", obsoleted_by:"", package:"SUNWwbsvr", version:"6.1,REV=2003.11.21.13.47") < 0) flag++;
