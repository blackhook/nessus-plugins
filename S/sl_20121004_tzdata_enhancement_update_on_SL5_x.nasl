...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tzdata enhancement update on SL5.x, SL6.x i386/x86_64 (20121004)");
...
related problems such as ntp sync errors."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1210&L=scientific-linux-errata&T=0&P=1223
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dc7fad9d"
  );
  script_set_attribute(
    attribute:"solution", 
