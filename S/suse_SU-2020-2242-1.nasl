...
# extracted from SUSE update advisory SUSE-SU-2020:2242-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : xorg-x11-server (SUSE-SU-2020:2242-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?09ac5a92"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-SLE-SDK-12-SP5-2020-2242=1

SUSE Linux Enterprise Server 12-SP5 :

zypper in -t patch SUSE-SLE-SERVER-12-SP5-2020-2242=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"5", reference:"xorg-x11-server-1.19.6-10.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"xorg-x11-server-debuginfo-1.19.6-10.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"xorg-x11-server-debugsource-1.19.6-10.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"xorg-x11-server-extra-1.19.6-10.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"5", reference:"xorg-x11-server-extra-debuginfo-1.19.6-10.8.1")) flag++;
