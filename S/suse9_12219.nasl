...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : Postfix (YOU Patch Number 12219)");
...
CVE-2008-2937 have been assigned to this problem."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12219.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"postfix-2.1.1-1.24")) flag++;
