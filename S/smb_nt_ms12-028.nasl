...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2596871");
  script_xref(name:"MSKB", value:"2680317");
  script_xref(name:"MSKB", value:"2680326");
...
arbitrary code on the host subject to the user's privileges.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-028");
