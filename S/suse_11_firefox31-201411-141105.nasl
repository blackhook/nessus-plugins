...
if (description)
{
  ...
  script_name(english:"SuSE 11.3 Security Update : MozillaFirefox (SAT Patch Number 9935)");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"MozillaFirefox-31.2.0esr-0.14.2")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"MozillaFirefox-branding-SLED-31.0-0.8.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"MozillaFirefox-translations-31.2.0esr-0.14.2")) flag++;
...
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"MozillaFirefox-31.2.0esr-0.14.2")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"MozillaFirefox-branding-SLED-31.0-0.8.1")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"MozillaFirefox-translations-31.2.0esr-0.14.2")) flag++;
...
if (rpm_check(release:"SLES11", sp:3, reference:"MozillaFirefox-31.2.0esr-0.14.2")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"MozillaFirefox-branding-SLED-31.0-0.8.1")) flag++;
if (rpm_check(release:"SLES11", sp:3, reference:"MozillaFirefox-translations-31.2.0esr-0.14.2")) flag++;
