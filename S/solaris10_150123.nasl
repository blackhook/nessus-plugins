...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 150123-01 (deprecated)");
...
150123 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 150123 instead.");
