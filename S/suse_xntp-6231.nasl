...
# extracted from openSUSE Security Update xntp-6231.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : xntp (xntp-6231)");
  script_summary(english:"Check for the xntp-6231 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"xntp-4.2.4p3-25.5") ) flag++;
