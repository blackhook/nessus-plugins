...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : gimp (ZYPP Patch Number 8253)");
...
crash) or to potentially execute arbitrary code. (CVE-2012-3481)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 8253.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:4, reference:"gimp-2.2.10-22.46.1")) flag++;
if (rpm_check(release:"SLED10", sp:4, reference:"gimp-devel-2.2.10-22.46.1")) flag++;
