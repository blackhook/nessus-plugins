...
if ( rpm_check(release:"SUSE11.0", reference:"libapr-util1-1.2.12-43.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libapr-util1-dbd-mysql-1.2.12-43.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libapr-util1-dbd-pgsql-1.2.12-43.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libapr-util1-dbd-sqlite3-1.2.12-43.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libapr-util1-devel-1.2.12-43.4") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libapr1-1.2.12-27.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libapr1-devel-1.2.12-27.2") ) flag++;
