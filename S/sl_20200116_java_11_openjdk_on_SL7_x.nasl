...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : java-11-openjdk on SL7.x x86_64 (20200116)");
...
"Security Fix(es) :
  ...
  - OpenJDK: Incorrect handling of unexpected
    CertificateVerify TLS handshake messages (JSSE, 8231780)
    (CVE-2020-2655)
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind2001&L=SCIENTIFIC-LINUX-ERRATA&P=3107
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a28cfad9"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-debug-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-debuginfo-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-demo-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-demo-debug-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-devel-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-devel-debug-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-headless-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-headless-debug-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-javadoc-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-javadoc-debug-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-javadoc-zip-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-javadoc-zip-debug-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-jmods-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-jmods-debug-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-src-11.0.6.10-1.el7_7")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"java-11-openjdk-src-debug-11.0.6.10-1.el7_7")) flag++;
