...
# extracted from openSUSE Security Update hal-6098.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : hal (hal-6098)");
  script_summary(english:"Check for the hal-6098 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"hal-0.5.9_git20070831-13.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"hal-devel-0.5.9_git20070831-13.7") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"hal-32bit-0.5.9_git20070831-13.7") ) flag++;
