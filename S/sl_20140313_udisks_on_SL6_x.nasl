...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : udisks on SL6.x i386/x86_64 (20140313)");
...
with the privileges of the udisks daemon (root). (CVE-2014-0004)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1403&L=scientific-linux-errata&T=0&P=949
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2b71370e"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected packages.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:udisks");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:udisks-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:udisks-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:fermilab:scientific_linux:udisks-devel-docs");
