...
if ( rpm_check(release:"SUSE11.3", reference:"kdelibs4-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kdelibs4-branding-upstream-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"kdelibs4-core-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkde4-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkde4-devel-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkdecore4-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libkdecore4-devel-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libksuseinstall-devel-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libksuseinstall1-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libkde4-32bit-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libkdecore4-32bit-4.4.4-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libksuseinstall1-32bit-4.4.4-3.4.1") ) flag++;
