...
# extracted from SUSE update advisory SUSE-SU-2016:2618-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : quagga (SUSE-SU-2016:2618-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd8bc204"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
patch SUSE-SLE-SDK-12-SP1-2016-1537=1

SUSE Linux Enterprise Server 12-SP1:zypper in -t patch
SUSE-SLE-SERVER-12-SP1-2016-1537=1
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"1", reference:"quagga-0.99.22.1-15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"quagga-debuginfo-0.99.22.1-15.1")) flag++;
if (rpm_check(release:"SLES12", sp:"1", reference:"quagga-debugsource-0.99.22.1-15.1")) flag++;
