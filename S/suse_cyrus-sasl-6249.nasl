...
# extracted from openSUSE Security Update cyrus-sasl-6249.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : cyrus-sasl (cyrus-sasl-6249)");
  script_summary(english:"Check for the cyrus-sasl-6249 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-sasl-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-sasl-crammd5-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-sasl-devel-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-sasl-digestmd5-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-sasl-gssapi-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-sasl-otp-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"cyrus-sasl-plain-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cyrus-sasl-32bit-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cyrus-sasl-crammd5-32bit-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cyrus-sasl-devel-32bit-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cyrus-sasl-digestmd5-32bit-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cyrus-sasl-gssapi-32bit-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cyrus-sasl-otp-32bit-2.1.22-82.2") ) flag++;
if ( rpm_check(release:"SUSE10.3", cpu:"x86_64", reference:"cyrus-sasl-plain-32bit-2.1.22-82.2") ) flag++;
