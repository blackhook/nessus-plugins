...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2847883");
  script_xref(name:"MSKB", value:"2845142");
  script_xref(name:"MSKB", value:"2834902");
  script_xref(name:"MSKB", value:"2834904");
  script_xref(name:"MSKB", value:"2834903");
  script_xref(name:"MSKB", value:"2803821");
...
attacker to gain the same user rights as the local user.");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-13-168/");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-057");
