...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : poppler (ZYPP Patch Number 6743)");
...
"This update of poppler fixes two security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6743.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:3, reference:"poppler-0.4.4-19.26.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"poppler-devel-0.4.4-19.26.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"poppler-glib-0.4.4-19.26.1")) flag++;
if (rpm_check(release:"SLED10", sp:3, reference:"poppler-qt-0.4.4-19.26.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"poppler-0.4.4-19.26.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"poppler-glib-0.4.4-19.26.1")) flag++;
if (rpm_check(release:"SLES10", sp:3, reference:"poppler-qt-0.4.4-19.26.1")) flag++;
