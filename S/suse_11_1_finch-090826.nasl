...
if ( rpm_check(release:"SUSE11.1", reference:"finch-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"finch-devel-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpurple-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpurple-devel-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpurple-lang-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpurple-meanwhile-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libpurple-mono-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"pidgin-2.5.1-3.14.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"pidgin-devel-2.5.1-3.14.1") ) flag++;
