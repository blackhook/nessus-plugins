...
var pkgs = [
    {'reference':'update-alternatives-1.18.4-16.3.5', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']}
];
