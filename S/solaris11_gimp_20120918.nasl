...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : gimp (cve_2012_2763_buffer_overflow)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/cve-2012-2763-buffer-overflow-vulnerability-in-gimp
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?491be38b"
  );
