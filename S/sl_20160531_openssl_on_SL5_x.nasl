...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openssl on SL5.x i386/x86_64 (20160531)");
...
"Security Fix(es) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f2daeaeb"
  );
...
flag = 0;
if (rpm_check(release:"SL5", reference:"openssl-0.9.8e-40.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"openssl-debuginfo-0.9.8e-40.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"openssl-devel-0.9.8e-40.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"openssl-perl-0.9.8e-40.el5_11")) flag++;
