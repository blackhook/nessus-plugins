...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Websphere Community Edition (ZYPP Patch Number 6312)");
...
"This update of WebSphere fixes the following vulnerabilities :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 6312.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:2, reference:"websphere-as_ce-2.1.1.2-0.3")) flag++;
