...
well as read access to a subset of Solaris accessible data."
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 148694-01 or higher");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-3813");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:148694");
