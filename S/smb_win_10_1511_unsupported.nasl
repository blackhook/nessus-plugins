...
if (description)
{
  ...
  script_name(english:"Microsoft Windows 10 Version 1511 Unsupported Version Detection");

  script_set_attribute(attribute:"synopsis", value:"
The remote operating system is no longer supported.");
  script_set_attribute(attribute:"description", value:
"Microsoft Windows 10 version 1511 is running on the remote host.
Microsoft ended support for Windows 10 version 1511 on October 10, 2017.
...
investigate or acknowledge reports of vulnerabilities.");
  # https://support.microsoft.com/en-in/help/4035050/windows-10-serviced-versions-frequently-asked-questions
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6dc46bb2");
...
product_name  = "Windows 10 version 1511";
...
# Not Build 10586 (version 1511)
if ("10586" != os_build || "Windows Server" >< os_name) audit(AUDIT_OS_NOT, product_name);
