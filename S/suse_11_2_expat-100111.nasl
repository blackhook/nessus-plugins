...
if ( rpm_check(release:"SUSE11.2", reference:"expat-2.0.1-92.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libexpat-devel-2.0.1-92.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libexpat1-2.0.1-92.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", cpu:"x86_64", reference:"libexpat1-32bit-2.0.1-92.4.1") ) flag++;
