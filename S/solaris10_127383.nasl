...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 127383-01 (deprecated)");
...
127383 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 127383 instead.");
