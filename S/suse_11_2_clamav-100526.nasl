...
can be used as a remote denial of service attack."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2010-07/msg00024.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.2", reference:"clamav-0.96.1-0.1.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"clamav-db-0.96.1-0.1.1") ) flag++;
