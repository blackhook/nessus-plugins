...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x i386/x86_64 (20170308)");
...
Security Fix(es) :
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1703&L=scientific-linux-errata&F=&S=&P=7158
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?96d41314"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"firefox-45.8.0-2.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"firefox-debuginfo-45.8.0-2.el5_11")) flag++;

if (rpm_check(release:"SL6", reference:"firefox-45.8.0-2.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-45.8.0-2.el6_8")) flag++;
