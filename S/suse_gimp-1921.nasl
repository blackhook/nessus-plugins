...
# extracted from openSUSE Security Update gimp-1921.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : gimp (gimp-1921)");
  script_summary(english:"Check for the gimp-1921 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"gimp-2.2.10-22.5") ) flag++;
