...
# extracted from openSUSE Security Update seamonkey-3986.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : seamonkey (seamonkey-3986)");
  script_summary(english:"Check for the seamonkey-3986 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"seamonkey-1.0.9-1.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"seamonkey-calendar-1.0.9-1.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"seamonkey-dom-inspector-1.0.9-1.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"seamonkey-irc-1.0.9-1.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"seamonkey-mail-1.0.9-1.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"seamonkey-spellchecker-1.0.9-1.3") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"seamonkey-venkman-1.0.9-1.3") ) flag++;
