...
# extracted from Slackware Security Advisory SSA:2022-080-01. The text
...
if (description)
{
  ...
  script_name(english:"Slackware Linux 15.0 bind  Multiple Vulnerabilities (SSA:2022-080-01)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Slackware Linux host is missing a security update to bind.");
  script_set_attribute(attribute:"description", value:
"The version of bind installed on the remote host is prior to 9.16.27. It is, therefore, affected by multiple
vulnerabilities as referenced in the SSA:2022-080-01 advisory.
...
var flag = 0;
var constraints = [
    { 'fixed_version' : '9.16.27', 'product' : 'bind', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'i586' },
    { 'fixed_version' : '9.16.27', 'product' : 'bind', 'os_name' : 'Slackware Linux', 'os_version' : '15.0', 'service_pack' : '1_slack15.0', 'arch' : 'x86_64' }
];
