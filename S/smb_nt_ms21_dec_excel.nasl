...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"5002098");
  script_xref(name:"MSKB", value:"5002105");
  script_xref(name:"MSFT", value:"MS21-5002098");
  script_xref(name:"MSFT", value:"MS21-5002105");
  script_xref(name:"IAVA", value:"2021-A-0578-S");

  script_name(english:"Security Updates for Microsoft Excel Products (December 2021)");
...
It is, therefore, affected by the following vulnerability:
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002098");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/5002105");
...
var checks = make_array(
  '15.0', make_array('sp', 1, 'version', '15.0.5407.1000', 'kb', '5002105'),
  '16.0', make_nested_list(
    make_array('sp', 0, 'version', '16.0.5254.1000', 'channel', 'MSI', 'kb', '5002098')
  )
);
