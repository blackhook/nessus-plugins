...
if (description)
{
  ...
  script_cve_id("CVE-2012-0563", "CVE-2012-1687");
  script_bugtraq_id(54508, 54557);

  script_name(english:"Oracle Solaris Critical Patch Update : jul2012_SRU9_5");
...
security updates :
  ...
  - Vulnerability in the Solaris component of Oracle Sun
    Products Suite (subcomponent: Kerberos/klist). Supported
    ...
    of service (partial DOS) of Solaris. (CVE-2012-0563)

  - Vulnerability in the Solaris component of Oracle Sun
    Products Suite (subcomponent: Logical Domains (LDOM)).
    ...
    Solaris accessible data. (CVE-2012-1687)"
  );
...
if (solaris_check_release(release:"0.5.11-0.175.0.9.0.5.0", sru:"11/11 SRU 9.5") > 0) flag++;
