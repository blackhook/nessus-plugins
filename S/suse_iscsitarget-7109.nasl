...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : iscsitarget (ZYPP Patch Number 7109)");
...
string vulnerability :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7109.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"iscsitarget-0.4.17-3.5.1")) flag++;
