...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2685939");
...
Note that the Remote Desktop Protocol is not enabled by default."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-036");
  script_set_attribute(
    attribute:"solution",
    value:
