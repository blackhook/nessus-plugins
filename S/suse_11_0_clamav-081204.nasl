...
# extracted from openSUSE Security Update clamav-357.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav (clamav-357)");
  script_summary(english:"Check for the clamav-357 patch");
...
(CVE-2008-5314)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=450207"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"clamav-0.94.2-1.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"clamav-db-0.94.2-1.1") ) flag++;
