...
# extracted from openSUSE Security Update MozillaThunderbird-5280.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaThunderbird (MozillaThunderbird-5280)");
  script_summary(english:"Check for the MozillaThunderbird-5280 patch");
  ...
  script_set_attribute(
    ...
    value:
"MozillaThunderbird was updated to version 2.0.0.14, fixing various
...
if ( rpm_check(release:"SUSE10.3", reference:"MozillaThunderbird-2.0.0.14-0.1") ) flag++;
if ( rpm_check(release:"SUSE10.3", reference:"MozillaThunderbird-translations-2.0.0.14-0.1") ) flag++;
