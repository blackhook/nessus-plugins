...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : ethereal (YOU Patch Number 12593)");
...
"This update of ethereal fixes :
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 12593.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"ethereal-0.10.13-2.47")) flag++;
