...
if(description)
{
 ...
 script_name(english: "Solaris 10 (x86) : 140109-03");
 script_xref(name:"IAVT", value:"2009-T-0040-S");
 script_cve_id("CVE-2009-2296");
 script_set_attribute(attribute: "synopsis", value:
"The remote host is missing Sun Security Patch number 140109-03");
...
"http://download.oracle.com/sunalerts/1020673.1.html");
 ...
 script_summary(english: "Check for patch 140109-03");
