...
if (description)
{
  ...
  script_name(english:"SuSE 11.2 Security Update : MozillaFirefox (SAT Patch Number 8545)");
...
Firefox ESR 17.0.10. (CVE-2013-1739)
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 8545.");
...
flag = 0;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-branding-SLED-7-0.6.9.62")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-translations-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"s390x", reference:"MozillaFirefox-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"s390x", reference:"MozillaFirefox-branding-SLED-7-0.6.9.62")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"s390x", reference:"MozillaFirefox-translations-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-17.0.10esr-0.4.2.4")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-branding-SLED-7-0.6.9.62")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"MozillaFirefox-translations-17.0.10esr-0.4.2.4")) flag++;
