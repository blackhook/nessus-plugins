...
if (description)
{
  ...
  script_name(english:"Solaris 10 (x86) : 149068-01 (deprecated)");
...
149068 patch-revision plugins, or deemed non-security related."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Consult specific patch-revision plugins for patch 149068 instead.");
