...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2719662");
...
installing a vulnerable Gadget, resulting in arbitrary code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityAdvisories/2013/2719662");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2719662/microsoft-security-advisory-vulnerabilities-in-gadgets-could-allow-rem");
  ...
  script_set_attribute(attribute:"cvss_score_rationale", value:"CVSS identified.  No associated CVE assigned.");
...
if (hotfix_check_sp(vista:3, win7:2) <= 0 ||
    'Server 2008' >< prodname ||
    'Server (R) 2008' >< prodname ||
    'Windows Embedded' >< prodname ||
    'Small Business Server 2011' >< prodname ||
    'Windows Server 2012' >< prodname)
