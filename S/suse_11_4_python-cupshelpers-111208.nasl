...
# extracted from openSUSE Security Update python-cupshelpers-5530.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-cupshelpers (openSUSE-SU-2011:1331-1)");
  script_summary(english:"Check for the python-cupshelpers-5530 patch");
...
(CVE-2011-2899)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-12/msg00010.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"python-cupshelpers-1.2.5-5.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"system-config-printer-1.2.5-5.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"system-config-printer-debugsource-1.2.5-5.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"system-config-printer-lang-1.2.5-5.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"udev-configure-printer-1.2.5-5.8.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"udev-configure-printer-debuginfo-1.2.5-5.8.1") ) flag++;
