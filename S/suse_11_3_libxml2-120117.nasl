...
overly long names has been fixed. CVE-2011-3919 has been assigned."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-01/msg00040.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"libxml2-2.7.7-4.11.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"libxml2-devel-2.7.7-4.11.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libxml2-32bit-2.7.7-4.11.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"libxml2-devel-32bit-2.7.7-4.11.1") ) flag++;
