...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : tzdata bug fix update on SL5.x, SL6.x i386/x86_64 (20160621)");
...
related problems such as ntp sync errors."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1606&L=scientific-linux-errata&F=&S=&P=8031
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b457b9b8"
  );
  script_set_attribute(
    attribute:"solution", 
