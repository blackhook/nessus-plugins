...
if ( rpm_check(release:"SUSE11.0", reference:"lcms-1.17-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"liblcms-devel-1.17-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"liblcms1-1.17-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"liblcms-devel-32bit-1.17-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"liblcms1-32bit-1.17-40.2") ) flag++;
