...
# extracted from openSUSE Security Update MozillaThunderbird-236.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird (MozillaThunderbird-236)");
  script_summary(english:"Check for the MozillaThunderbird-236 patch");
...
if ( rpm_check(release:"SUSE11.0", reference:"MozillaThunderbird-2.0.0.17-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"MozillaThunderbird-devel-2.0.0.17-0.1") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"MozillaThunderbird-translations-2.0.0.17-0.1") ) flag++;
