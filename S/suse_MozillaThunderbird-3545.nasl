...
# extracted from openSUSE Security Update MozillaThunderbird-3545.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : MozillaThunderbird (MozillaThunderbird-3545)");
  script_summary(english:"Check for the MozillaThunderbird-3545 patch");
...
if ( rpm_check(release:"SUSE10.1", reference:"MozillaThunderbird-1.5.0.12-2.2") ) flag++;
if ( rpm_check(release:"SUSE10.1", reference:"MozillaThunderbird-translations-1.5.0.12-2.2") ) flag++;
