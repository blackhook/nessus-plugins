...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Ogg Vorbis tools (ZYPP Patch Number 5302)");
...
(CVE-2008-1686)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 5302.");
...
flag = 0;
if (rpm_check(release:"SLED10", sp:2, reference:"vorbis-tools-1.1.1-13.7")) flag++;
