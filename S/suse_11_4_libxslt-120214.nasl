...
# extracted from openSUSE Security Update libxslt-5811.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libxslt (openSUSE-SU-2012:0343-1)");
  script_summary(english:"Check for the libxslt-5811 patch");
...
patterns (CVE-2011-3970). This could lead to a Denial of Service."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-03/msg00009.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.4", reference:"libxslt-1.1.26-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libxslt-debuginfo-1.1.26-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libxslt-debugsource-1.1.26-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"libxslt-devel-1.1.26-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libxslt-32bit-1.1.26-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libxslt-debuginfo-32bit-1.1.26-3.4.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", cpu:"x86_64", reference:"libxslt-devel-32bit-1.1.26-3.4.1") ) flag++;
