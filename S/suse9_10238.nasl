...
if (description)
{
  ...
  script_name(english:"SuSE9 Security Update : telnet (YOU Patch Number 10238)");
...
the man page for further details."
  ...
  script_set_attribute(attribute:"solution", value:"Apply YOU patch number 10238.");
...
flag = 0;
if (rpm_check(release:"SUSE9", reference:"telnet-1.1-38.9")) flag++;
