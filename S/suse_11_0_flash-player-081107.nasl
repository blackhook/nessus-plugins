...
# extracted from openSUSE Security Update flash-player-294.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : flash-player (flash-player-294)");
  script_summary(english:"Check for the flash-player-294 patch");
...
CVE-2008-4401, CVE-2008-4503, CVE-2008-4546)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=435201"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=436058"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"flash-player-9.0.151.0-0.1") ) flag++;
