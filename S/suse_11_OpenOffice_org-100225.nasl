...
flag = 0;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-de-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-en-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-es-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-fr-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-it-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-nl-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-pl-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-LanguageTool-sv-1.0.0-1.1.6")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-base-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-base-drivers-postgresql-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-base-extensions-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-calc-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-calc-extensions-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-components-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-draw-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-draw-extensions-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-filters-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-filters-optional-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-gnome-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-ar-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-cs-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-da-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-de-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-en-GB-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-en-US-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-en-US-devel-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-es-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-fr-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-gu-IN-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-hi-IN-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-hu-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-it-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-ja-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-ko-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-nl-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-pl-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-pt-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-pt-BR-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-ru-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-sv-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-zh-CN-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-help-zh-TW-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-icon-themes-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-impress-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-impress-extensions-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-kde-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-af-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-ar-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-ca-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-cs-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-da-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-de-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-el-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-en-GB-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-es-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-extras-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-fi-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-fr-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-gu-IN-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-hi-IN-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-hu-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-it-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-ja-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-ko-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-nb-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-nl-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-nn-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-pl-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-pt-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-pt-BR-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-ru-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-sk-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-sv-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-xh-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-zh-CN-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-zh-TW-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-l10n-zu-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-libs-core-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-libs-extern-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-libs-gui-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-mailmerge-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-math-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-mono-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-officebean-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-openclipart-3-1.25.5")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-pyuno-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-ure-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-writer-3.2.0.7-0.1.1")) flag++;
if (rpm_check(release:"SLED11", sp:0, cpu:"x86_64", reference:"OpenOffice_org-writer-extensions-3.2.0.7-0.1.1")) flag++;
