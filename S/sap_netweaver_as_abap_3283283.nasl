...
if (description)
{
  ...
  script_cve_id("CVE-2023-0013");
  script_xref(name:"IAVA", value:"2023-A-0018");
  script_xref(name:"IAVA", value:"2023-A-0076");

  script_name(english:"SAP NetWeaver AS ABAP XSS (3283283)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SAP NetWeaver ABAP server may be affected by a cross-site scripting vulnerability.");
  script_set_attribute(attribute:"description", value:
"The ABAP Keyword Documentation of SAP NetWeaver Application Server for ABAP and ABAP Platform does not sufficiently
encode user-controlled inputs, resulting in Cross-Site Scripting (XSS) vulnerability. On successful exploitation an
attacker can cause limited impact on confidentiality and integrity of the application.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://launchpad.support.sap.com/#/notes/3283283");
...
"Apply the appropriate patch according to the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-0013");
