...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2723135");
...
Note that the Remote Desktop Protocol is not enabled by default."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/523921/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-053");
