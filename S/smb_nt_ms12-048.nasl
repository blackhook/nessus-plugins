...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2691442");
...
user."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2012/ms12-048");
  script_set_attribute(
    attribute:"solution",
    value:
