...
# extracted from openSUSE Security Update viewvc-6578.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : viewvc (viewvc-6578)");
  script_summary(english:"Check for the viewvc-6578 patch");
...
if ( rpm_check(release:"SUSE10.3", reference:"viewvc-1.0.9-0.1") ) flag++;
