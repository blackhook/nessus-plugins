...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : shadow-utils on SL4.x i386/x86_64");
...
mailbox. (CVE-2006-1174)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0705&L=scientific-linux-errata&T=0&P=1681
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad269b87"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL4", reference:"shadow-utils-4.0.3-61.RHEL4")) flag++;
