...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 17 for SLE 12 SP4) (SUSE-SU-2021:3684-1)");
...
"Update the affected kernel-livepatch-4_12_14-197_99-default, kgraft-patch-4_12_14-122_88-default and / or kgraft-
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.88-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_88-default-2-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-197.99-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_99-default-5-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
