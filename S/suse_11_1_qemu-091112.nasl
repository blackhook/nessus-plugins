...
# extracted from openSUSE Security Update qemu-1537.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : qemu (qemu-1537)");
  script_summary(english:"Check for the qemu-1537 patch");
...
host machine. (CVE-2009-3616: CVSS v2 Base Score: 8.5)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=547554"
  );
...
if ( rpm_check(release:"SUSE11.1", reference:"qemu-0.10.1-0.2.1") ) flag++;
