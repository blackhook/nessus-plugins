...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 13 for SLE 12 SP5) (SUSE-SU-2021:4038-1)");
...
"Update the affected kernel-livepatch-4_12_14-197_75-default, kgraft-patch-4_12_14-122_54-default and / or kgraft-
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.54-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_54-default-14-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-197.75-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_75-default-14-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
