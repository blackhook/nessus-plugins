...
checked for them.");
 ...
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2003/Mar/416");
 ...
 script_copyright("This script is Copyright (C) 2003-2021 Tenable Network Security, Inc.");
