...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2785220");
...
in order to intercept communications."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-006");
  script_set_attribute(
    attribute:"solution",
    value:
