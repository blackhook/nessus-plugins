...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3018943");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/06/15");

  script_name(english:"MS KB3018943: Update for Vulnerabilities in Adobe Flash Player in Internet Explorer");

  script_set_attribute(attribute:"synopsis", value:
"The remote Windows host has a browser plugin that is affected by a
remote code execution vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote host is missing KB3018943. It is, therefore, affected by a
remote code execution vulnerability in Adobe Flash Player due to the
processing of a dereferenced memory pointer.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/3018943/microsoft-security-advisory-update-for-vulnerabilities-in-adobe-flash");
  script_set_attribute(attribute:"solution", value:
"Install Microsoft KB3018943.");
