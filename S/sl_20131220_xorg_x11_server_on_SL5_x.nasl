...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : xorg-x11-server on SL5.x, SL6.x i386/x86_64 (20131220)");
...
(CVE-2013-6424)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1312&L=scientific-linux-errata&T=0&P=5435
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ab56b165"
  );
