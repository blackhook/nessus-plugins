...
if ( rpm_check(release:"SUSE11.0", reference:"libpng-devel-1.2.26-14.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libpng12-0-1.2.26-14.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"libpng3-1.2.26-14.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libpng-devel-32bit-1.2.26-14.6") ) flag++;
if ( rpm_check(release:"SUSE11.0", cpu:"x86_64", reference:"libpng12-0-32bit-1.2.26-14.6") ) flag++;
