...
the SUSE-SU-2023:0471-1 advisory.
...
var pkgs = [
    {'reference':'clamav-0.103.8-3.24.1', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-12.5', 'sles-release-12.5']}
];
