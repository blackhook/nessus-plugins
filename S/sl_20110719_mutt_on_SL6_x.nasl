...
Mutt must be restarted for this update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1107&L=scientific-linux-errata&T=0&P=1320
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aedd2f74"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL6", reference:"mutt-1.5.20-2.20091214hg736b6a.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"mutt-debuginfo-1.5.20-2.20091214hg736b6a.el6_1.1")) flag++;
