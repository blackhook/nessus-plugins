...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : vsftpd (ZYPP Patch Number 7373)");
...
resulting in denial of service (CVE-2011-0762). This has been fixed."
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7373.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"vsftpd-2.0.4-19.18.222.20.1")) flag++;
