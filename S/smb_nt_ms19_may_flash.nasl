...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"4497932");
  script_xref(name:"MSFT", value:"MS19-4497932");

  script_name(english:"KB4497932: Security update for Adobe Flash Player (May 2019)");
...
"The remote Windows host is missing security update KB4497932. It is,
...
in Adobe Flash Player.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ded0465");
  script_set_attribute(attribute:"solution", value:"Microsoft has released KB4497932 to address this issue.");
...
# all <= 32.0.0.171
fix = FALSE;
if(ver_compare(ver:iver, fix:"32.0.0.171", strict:FALSE) <= 0)
  fix = "32.0.0.192";
...
if (info != '')
{
    ...
    hotfix_add_report(bulletin:'MS19-05', kb:'4497932', report);
