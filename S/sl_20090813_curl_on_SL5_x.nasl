...
update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0908&L=scientific-linux-errata&T=0&P=981
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6b81fc78"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"curl-7.15.5-2.1.el5_3.5")) flag++;
if (rpm_check(release:"SL5", reference:"curl-devel-7.15.5-2.1.el5_3.5")) flag++;
