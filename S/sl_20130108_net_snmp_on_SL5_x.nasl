...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : net-snmp on SL5.x i386/x86_64 (20130108)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1301&L=scientific-linux-errata&T=0&P=1209
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b85a7388"
  );
