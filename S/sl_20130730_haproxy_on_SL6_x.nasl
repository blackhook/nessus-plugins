...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : haproxy on SL6.x i386/x86_64 (20130730)");
...
HAProxy instances that use the affected configuration. (CVE-2013-2175)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1307&L=scientific-linux-errata&T=0&P=2441
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c21e6b88"
  );
  script_set_attribute(
    attribute:"solution", 
