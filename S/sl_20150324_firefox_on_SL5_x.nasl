...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x, SL7.x i386/x86_64 (20150324)");
...
to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1503&L=scientific-linux-errata&T=0&P=1780
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d688e6e8"
  );
  script_set_attribute(
    attribute:"solution", 
