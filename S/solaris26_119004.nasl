...
if (description)
{
  ...
  script_name(english:"Solaris 6 (sparc) : 119004-02");
...
if (solaris_check_patch(release:"5.6", arch:"sparc", patch:"119004-02", obsoleted_by:"", package:"VRTSnetbp", version:"4.5,REV=2003.10.15.15.01") < 0) flag++;
