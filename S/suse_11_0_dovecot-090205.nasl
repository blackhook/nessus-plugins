...
# extracted from openSUSE Security Update dovecot-504.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dovecot (dovecot-504)");
  script_summary(english:"Check for the dovecot-504 patch");
...
(CVE-2008-4577)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=435978"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"dovecot-1.0.13-24.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"dovecot-devel-1.0.13-24.2") ) flag++;
