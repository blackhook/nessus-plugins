...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-197.92-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_92-default-2-2.1', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      }
    }
  }
