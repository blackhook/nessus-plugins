...
# extracted from openSUSE Security Update mailman-151.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mailman (mailman-151)");
  script_summary(english:"Check for the mailman-151 patch");
...
(CVE-2008-0564) and a mistake in translation."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=359182"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=409352"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"mailman-2.1.9-159.2") ) flag++;
