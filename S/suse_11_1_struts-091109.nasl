...
# extracted from openSUSE Security Update struts-1530.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : struts (struts-1530)");
  script_summary(english:"Check for the struts-1530 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update of struts fixes a regression caused by the last security
update."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE11.1", reference:"struts-1.2.9-162.164.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"struts-javadoc-1.2.9-162.164.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"struts-manual-1.2.9-162.164.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"struts-webapps-tomcat6-1.2.9-162.164.1") ) flag++;
