...
flag = 0;
if (rpm_check(release:"SLED11", sp:2, cpu:"i586", reference:"wireshark-1.8.9-0.2.5")) flag++;
if (rpm_check(release:"SLED11", sp:2, cpu:"x86_64", reference:"wireshark-1.8.9-0.2.5")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"i586", reference:"wireshark-1.8.9-0.2.5")) flag++;
if (rpm_check(release:"SLED11", sp:3, cpu:"x86_64", reference:"wireshark-1.8.9-0.2.5")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"i586", reference:"wireshark-1.8.9-0.2.5")) flag++;
if (rpm_check(release:"SLES11", sp:2, cpu:"x86_64", reference:"wireshark-1.8.9-0.2.5")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"i586", reference:"wireshark-1.8.9-0.2.5")) flag++;
if (rpm_check(release:"SLES11", sp:3, cpu:"x86_64", reference:"wireshark-1.8.9-0.2.5")) flag++;
