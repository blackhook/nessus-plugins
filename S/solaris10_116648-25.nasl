...
if (description)
{
  ...
  script_name(english:"Solaris 10 (sparc) : 116648-25");
...
Date this patch was last updated by Sun : Sep/20/10"
  ...
  script_set_attribute(attribute:"solution", value:"Install patch 116648-25");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_cwe_id(79, 310);

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:10:116648");
...
if (solaris_check_patch(release:"5.10", arch:"sparc", patch:"116648-25", obsoleted_by:"", package:"SUNWwbsvr", version:"6.1,REV=2003.11.21.13.47") < 0) flag++;
