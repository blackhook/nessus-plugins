...
if (description)
{
 ...
 script_name(english:"Microsoft Windows 'Backup Operators' Group User List");
 script_summary(english:"Lists users that are in special groups");

 script_set_attribute(attribute:"synopsis", value:"There is at least one user in the 'Backup Operators' group.");
...
but have no administrative rights.");
...
sid = raw_string (0x01,0x02,0x00,0x00,0x00,0x00,0x00,0x05,0x20,0x00,0x00,0x00,0x27,0x02,0x00,0x00);
...
if (info)
{
  ...
  report = string(
    "\n",
    report, " of the 'Backup Operators' group :\n",
    "\n",
