...
if (description)
{
  ...
  script_name(english:"SuSE 11.1 Security Update : cyrus-imapd (SAT Patch Number 5096)");
...
arbitrary code. (CVE-2011-3208)"
  ...
  script_set_attribute(attribute:"solution", value:"Apply SAT patch number 5096.");
...
flag = 0;
if (rpm_check(release:"SLES11", sp:1, reference:"cyrus-imapd-2.3.11-60.63.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"perl-Cyrus-IMAP-2.3.11-60.63.1")) flag++;
if (rpm_check(release:"SLES11", sp:1, reference:"perl-Cyrus-SIEVE-managesieve-2.3.11-60.63.1")) flag++;
