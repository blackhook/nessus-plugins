...
if ( rpm_check(release:"SUSE11.1", reference:"icu-4.0-7.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"icu-data-4.0-7.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libicu-4.0-7.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"libicu-devel-4.0-7.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libicu-32bit-4.0-7.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"libicu-devel-32bit-4.0-7.2.1") ) flag++;
