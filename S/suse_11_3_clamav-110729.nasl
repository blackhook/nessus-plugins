...
to a DoS condition. CVE-2011-2721 has been assigned to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2011-08/msg00033.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.3", reference:"clamav-0.97.2-1.2.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"clamav-db-0.97.2-1.2.1") ) flag++;
