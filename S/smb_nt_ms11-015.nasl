...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2011-A-0031-S");
  script_xref(name:"MSFT", value:"MS11-015");
  script_xref(name:"MSKB", value:"2479943");
  script_xref(name:"MSKB", value:"2494132");
...
vulnerabilities in Media Player or Media Center :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?b399ad44");
  script_set_attribute(
    attribute:"solution",
    value:
