...
(CVE-2007-2798)"
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind0706&L=scientific-linux-errata&T=0&P=4042
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?03cfbb04"
  );
...
flag = 0;
if (rpm_check(release:"SL3", reference:"krb5-devel-1.2.7-66")) flag++;
if (rpm_check(release:"SL3", reference:"krb5-libs-1.2.7-66")) flag++;
if (rpm_check(release:"SL3", reference:"krb5-server-1.2.7-66")) flag++;
if (rpm_check(release:"SL3", reference:"krb5-workstation-1.2.7-66")) flag++;
