...
# extracted from openSUSE Security Update courier-authlib-42.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : courier-authlib (courier-authlib-42)");
  script_summary(english:"Check for the courier-authlib-42 patch");
...
injections. (CVE-2008-2667)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=398412"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE11.0", reference:"courier-authlib-0.60.2-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"courier-authlib-devel-0.60.2-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"courier-authlib-ldap-0.60.2-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"courier-authlib-mysql-0.60.2-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"courier-authlib-pgsql-0.60.2-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"courier-authlib-pipe-0.60.2-40.2") ) flag++;
if ( rpm_check(release:"SUSE11.0", reference:"courier-authlib-userdb-0.60.2-40.2") ) flag++;
