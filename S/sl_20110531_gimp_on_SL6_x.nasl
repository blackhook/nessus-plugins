...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : gimp on SL6.x i386/x86_64");
...
must be restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1106&L=scientific-linux-errata&T=0&P=2365
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a3ed46e3"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"gimp-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"gimp-debuginfo-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"gimp-devel-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"gimp-devel-tools-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"gimp-help-browser-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"SL6", reference:"gimp-libs-2.6.9-4.el6_1.1")) flag++;
