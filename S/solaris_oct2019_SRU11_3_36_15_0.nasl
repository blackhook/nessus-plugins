...
if (description)
{
  ...
  script_cve_id("CVE-2019-2765", "CVE-2019-3010");
  script_xref(name:"IAVA", value:"2019-A-0381-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/06/15");

  script_name(english:"Oracle Solaris Critical Patch Update : oct2019_SRU11_3_36_15_0");
...
fix_release = "0.5.11-0.175.3.36.0.15.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.3.36.0.15.0", sru:"11.3.36.15.0") > 0) flag++;
