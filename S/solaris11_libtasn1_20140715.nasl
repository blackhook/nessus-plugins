...
if (description)
{
  ...
  script_cve_id("CVE-2014-3468", "CVE-2014-3469");

  script_name(english:"Oracle Solaris Third-Party Patch Update : libtasn1 (multiple_vulnerabilities_in_gnu_libtasn1)");
...
security updates :
  ...
  # https://blogs.oracle.com/sunsecurity/multiple-vulnerabilities-in-gnu-libtasn1
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?41b59564"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:libtasn1");
...
if (empty_or_null(egrep(string:pkg_list, pattern:"^libtasn1$"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "libtasn1");
...
if (flag)
{
  error_extra = 'Affected package : libtasn1\n' + solaris_get_report2();
  error_extra = ereg_replace(pattern:"version", replace:"OS version", string:error_extra);
  if (report_verbosity > 0) security_warning(port:0, extra:error_extra);
  else security_warning(0);
  exit(0);
}
else audit(AUDIT_PACKAGE_NOT_AFFECTED, "libtasn1");
