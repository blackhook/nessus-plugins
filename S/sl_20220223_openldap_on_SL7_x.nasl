...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"RHSA-2022:0621");

  script_name(english:"Scientific Linux Security Update : openldap on SL7.x i686/x86_64 (2022:0621)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.scientificlinux.org/category/sl-errata/slsa-20220621-1");
...
var pkgs = [
    {'reference':'openldap-2.4.44-25.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-2.4.44-25.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-clients-2.4.44-25.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-debuginfo-2.4.44-25.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-debuginfo-2.4.44-25.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-devel-2.4.44-25.el7_9', 'cpu':'i686', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-devel-2.4.44-25.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-servers-2.4.44-25.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openldap-servers-sql-2.4.44-25.el7_9', 'cpu':'x86_64', 'release':'SL7', 'rpm_spec_vers_cmp':TRUE}
];
