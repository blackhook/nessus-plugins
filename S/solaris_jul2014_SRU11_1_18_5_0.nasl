...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Critical Patch Update : jul2014_SRU11_1_18_5_0");
...
security update :
  ...
  - Vulnerability in the Solaris component of Oracle and Sun
    Systems Products Suite (subcomponent: sockfs). Supported
    versions that are affected are 8, 9, 10 and 11.1. Easily
...
fix_release = "0.5.11-0.175.1.18.0.5.0";

flag = 0;

if (solaris_check_release(release:"0.5.11-0.175.1.18.0.5.0", sru:"11.1.18.5.0") > 0) flag++;
