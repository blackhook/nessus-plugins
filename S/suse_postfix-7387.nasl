...
if (description)
{
  ...
  script_name(english:"SuSE 10 Security Update : Postfix (ZYPP Patch Number 7387)");
...
"The following bug has been fixed :
  ...
  script_set_attribute(attribute:"solution", value:"Apply ZYPP patch number 7387.");
...
flag = 0;
if (rpm_check(release:"SLES10", sp:3, reference:"postfix-2.5.6-4.10.1")) flag++;
