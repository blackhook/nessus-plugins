...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : firefox on SL5.x, SL6.x, SL7.x i386/x86_64 (20161214)");
...
Security Fix(es) :
  ...
  - Multiple flaws were found in the processing of malformed
    ...
    Firefox. (CVE-2016-9893, CVE-2016-9899, CVE-2016-9895,
    CVE-2016-9897, CVE-2016-9898, CVE-2016-9900,
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?726da906"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"SL5", reference:"firefox-45.6.0-1.el5_11")) flag++;
if (rpm_check(release:"SL5", reference:"firefox-debuginfo-45.6.0-1.el5_11")) flag++;

if (rpm_check(release:"SL6", reference:"firefox-45.6.0-1.el6_8")) flag++;
if (rpm_check(release:"SL6", reference:"firefox-debuginfo-45.6.0-1.el6_8")) flag++;

if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-45.6.0-1.el7_3")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"firefox-debuginfo-45.6.0-1.el7_3")) flag++;
