...
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-devel-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-fonts-other-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-fonts-rus-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-fonts-std-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-ijs-devel-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-library-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-omni-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"ghostscript-x11-8.64-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libgimpprint-4.2.7-6.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.2", reference:"libgimpprint-devel-4.2.7-6.3.1") ) flag++;
