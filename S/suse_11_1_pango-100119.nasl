...
# extracted from openSUSE Security Update pango-1829.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pango (pango-1829)");
  script_summary(english:"Check for the pango-1829 patch");
...
if ( rpm_check(release:"SUSE11.1", reference:"pango-1.22.1-2.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"pango-devel-1.22.1-2.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", reference:"pango-module-thai-lang-1.22.1-2.13.1") ) flag++;
if ( rpm_check(release:"SUSE11.1", cpu:"x86_64", reference:"pango-32bit-1.22.1-2.13.1") ) flag++;
