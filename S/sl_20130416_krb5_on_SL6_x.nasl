...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : krb5 on SL6.x i386/x86_64 (20130416)");
...
restarted automatically."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1304&L=scientific-linux-errata&T=0&P=1313
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5a834154"
  );
...
flag = 0;
if (rpm_check(release:"SL6", reference:"krb5-debuginfo-1.10.3-10.el6_4.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-devel-1.10.3-10.el6_4.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-libs-1.10.3-10.el6_4.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-pkinit-openssl-1.10.3-10.el6_4.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-server-1.10.3-10.el6_4.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-server-ldap-1.10.3-10.el6_4.2")) flag++;
if (rpm_check(release:"SL6", reference:"krb5-workstation-1.10.3-10.el6_4.2")) flag++;
