...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : nss and nspr on SL5.x i386/x86_64 (20130131)");
...
restarted for the changes to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1302&L=scientific-linux-errata&T=0&P=602
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8ec100a3"
  );
