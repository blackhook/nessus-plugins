...
if (description)
{
  ...
  script_name(english:"Oracle Solaris Third-Party Patch Update : perl (cve_2014_4330_buffer_errors)");
...
security updates :
  ...
  - The Dumper method in Data::Dumper before 2.154, as used
    ...
    of recursive calls to the DD_dump function.
    (CVE-2014-4330)"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://blogs.oracle.com/sunsecurity/cve-2014-4330-buffer-errors-vulnerability-in-perl"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:solaris:perl");
...
if (empty_or_null(egrep(string:pkg_list, pattern:"^perl$"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "perl");
