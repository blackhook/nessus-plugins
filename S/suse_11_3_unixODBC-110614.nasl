...
if ( rpm_check(release:"SUSE11.3", reference:"unixODBC-2.2.12-204.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", reference:"unixODBC-devel-2.2.12-204.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"unixODBC-32bit-2.2.12-204.3.1") ) flag++;
if ( rpm_check(release:"SUSE11.3", cpu:"x86_64", reference:"unixODBC-devel-32bit-2.2.12-204.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "unixODBC / unixODBC-32bit / unixODBC-devel / unixODBC-devel-32bit");
}
