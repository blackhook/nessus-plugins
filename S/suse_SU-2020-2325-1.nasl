...
# extracted from SUSE update advisory SUSE-SU-2020:2325-1.
...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 Security Update : xorg-x11-server (SUSE-SU-2020:2325-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c6b2d82"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
zypper in -t patch SUSE-OpenStack-Cloud-Crowbar-9-2020-2325=1

SUSE OpenStack Cloud 9 :

zypper in -t patch SUSE-OpenStack-Cloud-9-2020-2325=1

SUSE Linux Enterprise Server for SAP 12-SP4 :

zypper in -t patch SUSE-SLE-SAP-12-SP4-2020-2325=1

SUSE Linux Enterprise Server 12-SP4-LTSS :

zypper in -t patch SUSE-SLE-SERVER-12-SP4-LTSS-2020-2325=1"
  );
...
flag = 0;
if (rpm_check(release:"SLES12", sp:"4", reference:"xorg-x11-server-1.19.6-4.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"xorg-x11-server-debuginfo-1.19.6-4.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"xorg-x11-server-debugsource-1.19.6-4.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"xorg-x11-server-extra-1.19.6-4.8.1")) flag++;
if (rpm_check(release:"SLES12", sp:"4", reference:"xorg-x11-server-extra-debuginfo-1.19.6-4.8.1")) flag++;
