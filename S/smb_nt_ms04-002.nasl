...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"832759");
...
another user's mailbox using Outlook for Web Access");
 script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2004/ms04-002");
