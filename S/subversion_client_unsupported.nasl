...
if (description)
{
  ...
  script_name(english:"Apache Subversion Client Unsupported Version Detection");
...
Apache Subversion Client on the remote host is no longer supported.
...
"Upgrade to a version of Apache Subversion Client that is currently
supported.");
  ...
  script_require_keys("installed_sw/Subversion Client", "Settings/ParanoidReport");
