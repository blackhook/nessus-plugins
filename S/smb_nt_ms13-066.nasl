...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2868846");
  script_xref(name:"MSKB", value:"2843638");
  script_xref(name:"MSKB", value:"2843639");
...
attacker to obtain the AD FS instance account information.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2013/ms13-066");
