...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : evince on SL7.x x86_64 (20170802)");
...
"Security Fix(es) :
  ...
  - It was found that evince did not properly sanitize the
    command line which is run to untar Comic Book Tar (CBT)
    files, thereby allowing command injection. A specially
    crafted CBT file, when opened by evince or evince-
    thumbnailer, could execute arbitrary commands in the
    context of the evince program. (CVE-2017-1000083)"
  );
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1708&L=scientific-linux-errata&F=&S=&P=7506
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d806f83f"
  );
...
flag = 0;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"evince-3.22.1-5.2.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"evince-browser-plugin-3.22.1-5.2.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"evince-debuginfo-3.22.1-5.2.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"evince-devel-3.22.1-5.2.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"evince-dvi-3.22.1-5.2.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"evince-libs-3.22.1-5.2.el7_4")) flag++;
if (rpm_check(release:"SL7", cpu:"x86_64", reference:"evince-nautilus-3.22.1-5.2.el7_4")) flag++;
