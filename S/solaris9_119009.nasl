...
if (description)
{
  ...
  script_name(english:"Solaris 9 (sparc) : 119009-11");
  script_summary(english:"Check for patch 119009-11");

  script_set_attribute(attribute:"synopsis", value:"The remote host is missing Sun Security Patch number 119009-11");
  script_set_attribute(attribute:"description", value:
"VERITAS NetBackup 6.0 Product Jumbo Patch MP7 for GA VERSION=6.0,R.
...
if (solaris_check_patch(release:"5.9", arch:"sparc", patch:"119009-11", obsoleted_by:"", package:"VRTSnetbp", version:"6.0,REV=2005.09.07.19.13") < 0) flag++;
