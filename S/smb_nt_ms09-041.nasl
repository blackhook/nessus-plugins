...
if (description)
{
 ...
 script_xref(name:"MSKB", value:"971657");
 script_xref(name:"IAVB", value:"2009-B-0035-S");
...
with valid credentials to execute arbitrary code on the remote host.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.nessus.org/u?650b9b89");
 script_set_attribute(attribute:"solution", value:
"Microsoft has released a set of patches for Windows XP, 2003, Vista and
Server 2008.");
 script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
 script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-1544");
