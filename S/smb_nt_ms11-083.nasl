...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2588516");
...
execution in kernel mode."
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?66a2846a");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-083");
  script_set_attribute(
    attribute:"solution",
    value:
