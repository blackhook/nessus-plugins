...
if (description)
{
  ...
  script_name(english:"Scientific Linux Security Update : openjpeg on SL6.x i386/x86_64 (20120711)");
...
using OpenJPEG must be restarted for the update to take effect."
  ...
  # https://listserv.fnal.gov/scripts/wa.exe?A2=ind1207&L=scientific-linux-errata&T=0&P=4109
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5101a3aa"
  );
