...
if (description)
{
  ...
  script_name(english:"SUSE SLES12 / SLES15 Security Update : kernel (Live Patch 13 for SLE 15 SP1) (SUSE-SU-2021:2344-1)");
...
"Update the affected kernel-livepatch-4_12_14-197_48-default, kgraft-patch-4_12_14-122_32-default and / or kgraft-
patch-4_12_14-95_65-default packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:suse_linux:kernel-livepatch-4_12_14-197_48-default");
...
var kernel_live_checks = [
  {
    'kernels': {
      '4.12.14-122.32-default': {
        'pkgs': [
          {'reference':'kgraft-patch-4_12_14-122_32-default-14-2.2', 'sp':'5', 'release':'SLES12', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['sle-live-patching-release-12.5']}
        ]
      },
      '4.12.14-197.48-default': {
        'pkgs': [
          {'reference':'kernel-livepatch-4_12_14-197_48-default-12-2.2', 'sp':'1', 'cpu':'x86_64', 'release':'SLES15', 'rpm_spec_vers_cmp':TRUE, 'exists_check':['SLES_SAP-release-15.1', 'SLE_HPC-release-15.1', 'sle-module-live-patching-release-15.1', 'sles-release-15.1']}
        ]
      },
      '4.12.14-95.65-default': {
        'pkgs': [
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'kernel-livepatch-4_12_14-197_48-default / etc');
}
