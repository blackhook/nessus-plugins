...
# extracted from openSUSE Security Update moodle-5487.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE 10 Security Update : moodle (moodle-5487)");
  script_summary(english:"Check for the moodle-5487 patch");
  ...
  script_set_attribute(
    ...
    value:
"Moodle was prone to CSRF (CVE-2008-3325) / XSS (CVE-2008-3326) flaws
which could potentially be exploited to compromise arbitrary accounts."
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE10.2", reference:"moodle-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-af-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ar-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-be-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-bg-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-bs-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ca-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-cs-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-da-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-de-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-el-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-es-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-et-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-eu-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-fa-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-fi-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-fr-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ga-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-gl-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-he-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-hi-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-hr-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-hu-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-id-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-is-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-it-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ja-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ka-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-km-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-kn-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ko-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-lt-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-lv-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-mi_tn-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ms-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-nl-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-nn-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-no-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-pl-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-pt-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ro-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-ru-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-sk-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-sl-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-so-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-sq-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-sr-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-sv-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-th-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-tl-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-tr-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-uk-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-vi-1.7.2-0.9") ) flag++;
if ( rpm_check(release:"SUSE10.2", reference:"moodle-zh_cn-1.7.2-0.9") ) flag++;
