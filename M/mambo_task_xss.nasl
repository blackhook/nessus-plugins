...
checked for them.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2011/Jun/512");
  # https://web.archive.org/web/20101125055311/http://mambo-developer.org/tracker/index.php?do=details&task_id=479&project=3&order=dateopened&sort=desc
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e61cee3a");
