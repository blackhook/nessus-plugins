...
if (description)
{
  ...
  script_name(english:"Firefox < 39.0.3 PDF Reader Arbitrary File Access (Mac OS X)");
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:FALSE, fix:'39.0.3', severity:SECURITY_WARNING);
