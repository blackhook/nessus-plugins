...
if (description)
{
  ...
  script_cve_id("CVE-2021-28448");

  script_name(english:"Security Update for Microsoft Visual Studio Code Kubernetes Tools Extension (April 2021)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an application installed that is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Visual Studio Code Kubernetes Tools Extension is prior to version 1.3.0. It is, therefore, affected by 
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-28448");
  # https://github.com/Azure/vscode-kubernetes-tools/blob/master/CHANGELOG.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da7d4208");
  # https://marketplace.visualstudio.com/items?itemName=ms-kubernetes-tools.vscode-kubernetes-tools
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?634015d4");
  script_set_attribute(attribute:"solution", value:
"Update the Microsoft Visual Studio Code Kubernetes Tools Extension to version 1.3.0 or later.");
  script_set_attribute(attribute:"agent", value:"windows");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-28448");
