...
"The version of Google Chrome installed on the remote macOS host is prior to 76.0.3809.100. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2019_08_stable-channel-update-for-desktop advisory. Note that Nessus has
not tested for this issue but has instead relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3840be38");
...
google_chrome_check_version(fix:'76.0.3809.100', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
