...
These updated packages provide a fix for this vulnerability."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2003/06/05");
...
flag = 0;
if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"kon2-0.3.9b-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"kon2-0.3.9b-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"kon2-0.3.9b-1.1mdk", yank:"mdk")) flag++;
