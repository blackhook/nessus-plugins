...
if (description)
{
  ...
  script_name(english:"Flash Player for Mac <= 10.3.183.50 / 11.5.502.146 Multiple Vulnerabilities (APSB13-04)");
...
remote Mac OS X host is 11.x equal to or earlier than 11.5.502.146, or
10.x equal to or earlier than 10.3.183.50.  It is, therefore,
...
tenx_cutoff_version = "10.3.183.50";
tenx_fixed_version = "10.3.183.51";
elevenx_cutoff_version = "11.5.502.146";
elevenx_fixed_version = "11.5.502.149";
