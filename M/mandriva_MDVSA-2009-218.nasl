...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:218. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:218-1");

  script_name(english:"Mandriva Linux Security Advisory : w3c-libwww (MDVSA-2009:218-1)");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"w3c-libwww-5.4.0-8.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"w3c-libwww-apps-5.4.0-8.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"w3c-libwww-devel-5.4.0-8.1mdv2008.0", yank:"mdv")) flag++;
