...
if (description)
{
  ...
  script_name(english:"ManageEngine ServiceDesk Plus < 14.1 Build 14105 XXE");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server hosts an application that is affected by an XML external entity vulnerability.");
  script_set_attribute(attribute:"description", value:
"An XML external entity vulnerability exists in ManageEngine ServiceDesk Plus prior to 14.1 Build 14105. 
...
number.");
  ...
  # https://www.manageengine.com/products/service-desk/on-premises/readme.html#readme141
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e6badee");
  script_set_attribute(attribute:"solution", value:
"Upgrade to ManageEngine ServiceDesk Plus version 14.1 Build 14105, or later.");
...
var constraints = [
  {'fixed_version': '14.1.14105', 'fixed_display': '14.1 Build 14105'}  
];
