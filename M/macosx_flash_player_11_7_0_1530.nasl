...
if (description)
{
  ...
  script_name(english:"Flash Player for Mac <= 10.3.183.68 / 11.6.602.180 Multiple Vulnerabilities (APSB13-11)");
...
remote Mac OS X host is 11.x equal or prior to 11.6.602.180, or 10.x
...
tenx_cutoff_version = "10.3.183.68";
tenx_fixed_version = "10.3.183.75";
elevenx_cutoff_version = "11.6.602.180";
elevenx_fixed_version = "11.7.700.169";
