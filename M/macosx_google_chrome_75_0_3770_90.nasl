...
"The version of Google Chrome installed on the remote macOS host is prior to 75.0.3770.90. It is, therefore, affected by
a vulnerability as referenced in the 2019_06_stable-channel-update-for-desktop_13 advisory. Note that Nessus has not
...
google_chrome_check_version(fix:'75.0.3770.90', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
