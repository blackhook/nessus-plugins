...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:181. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : python-django (MDVSA-2012:181)");
...
The updated packages have been upgraded to the 1.3.5 version which is
...
flag = 0;
if (rpm_check(release:"MDK2011", reference:"python-django-1.3.5-0.1-mdv2011.0", yank:"mdv")) flag++;
