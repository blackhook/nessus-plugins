...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:186. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:186");

  script_name(english:"Mandriva Linux Security Advisory : puppet (MDVSA-2013:186)");
...
the payload (CVE-2013-3567)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0187.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"puppet-2.7.22-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"puppet-server-2.7.22-1.mbs1")) flag++;
