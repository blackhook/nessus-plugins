...
if (description)
{
  ...
  script_cve_id("CVE-2015-6040", "CVE-2015-6122");
  script_bugtraq_id(78543, 78547);
  script_xref(name:"MSFT", value:"MS15-131");
  script_xref(name:"IAVA", value:"2015-A-0300-S");
  script_xref(name:"MSKB", value:"3119517");
  script_xref(name:"MSKB", value:"3119518");

  script_name(english:"MS15-131: Security Update for Microsoft Office to Address Remote Code Execution (3116111) (Mac OS X)");
...
is affected by multiple memory corruption issues due to improper
handling of objects in memory. A remote attacker can exploit these
issues by convincing a user to open a specially crafted file in an
affected version of Office, resulting in the execution of arbitrary
