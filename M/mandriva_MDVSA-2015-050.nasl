...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:050. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:050");

  script_name(english:"Mandriva Linux Security Advisory : patch (MDVSA-2015:050)");
...
files via a symlink attack in a patch file (CVE-2015-1196)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0068.html"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:patch");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"patch-2.7.4-1.mbs1")) flag++;
