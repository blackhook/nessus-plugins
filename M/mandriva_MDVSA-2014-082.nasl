...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:082. 
...
if (description)
{
  ...
  script_bugtraq_id(65511, 65513);
  script_xref(name:"MDVSA", value:"2014:082");

  script_name(english:"Mandriva Linux Security Advisory : python-imaging (MDVSA-2014:082)");
...
Python Imaging Library (CVE-2014-1933)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0158.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected python-imaging and / or python-imaging-devel
packages."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:python-imaging");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:python-imaging-devel");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"python-imaging-1.1.7-6.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"python-imaging-devel-1.1.7-6.1.mbs1")) flag++;
