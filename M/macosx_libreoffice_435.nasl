...
if (description)
{
  ...
  script_name(english:"LibreOffice < 4.2.8 / 4.3.5 RTF File Handling Code Execution (Mac OS X)");
...
prior to 4.2.8 or 4.3.x prior to 4.3.5. It is, therefore, affected by
