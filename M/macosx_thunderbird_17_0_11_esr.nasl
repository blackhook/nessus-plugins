...
handling handshake packets.");
  ...
  # http://website-archive.mozilla.org/www.mozilla.org/thunderbird_releasenotes/en-US/thunderbird/17.0.11esr/releasenotes/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a92167b3");
...
"Upgrade to Thunderbird ESR 17.0.11 or later.");
