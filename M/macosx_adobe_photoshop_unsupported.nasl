...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0511");
...
security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/ie/photoshop/kb/supported-versions.html");
...
if (ver_compare(ver:version, fix:'20.0', strict:FALSE) < 0)
{
  ...
  if (report_verbosity > 0)
  {
    report = '\n  Product            : ' + product +
             ...
             '\n  Supported versions : CC 2019 / 2020';
