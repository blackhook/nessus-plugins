...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"307298");
...
the telnet service.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2002/ms02-004");
