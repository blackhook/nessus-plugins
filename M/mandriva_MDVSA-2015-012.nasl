...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:012. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:012");

  script_name(english:"Mandriva Linux Security Advisory : jasper (MDVSA-2015:012)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"jasper-1.900.1-14.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64jasper-devel-1.900.1-14.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64jasper-static-devel-1.900.1-14.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64jasper1-1.900.1-14.2.mbs1")) flag++;
