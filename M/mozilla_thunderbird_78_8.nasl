...
"The version of Thunderbird installed on the remote Windows host is prior to 78.8. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-09 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'78.8', severity:SECURITY_WARNING);
