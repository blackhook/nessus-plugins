...
remote web server is affected by multiple vulnerabilities:
  ...
  - A cross-site scripting vulnerability exists in the
    ...
    (CVE-2013-1931)");
  script_set_attribute(attribute:"see_also", value:"https://mantisbt.org/blog/archives/mantisbt/249");
  script_set_attribute(attribute:"see_also", value:"https://mantisbt.org/bugs/view.php?id=15453");
  script_set_attribute(attribute:"see_also", value:"https://mantisbt.org/bugs/view.php?id=15511");
  script_set_attribute(attribute:"see_also", value:"https://mantisbt.org/bugs/view.php?id=15573");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 1.2.15 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1931");
