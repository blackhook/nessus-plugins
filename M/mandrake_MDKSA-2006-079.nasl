...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:079. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:079");

  script_name(english:"Mandrake Linux Security Advisory : ruby (MDKSA-2006:079)");
...
flag = 0;
if (rpm_check(release:"MDK10.2", reference:"ruby-1.8.2-6.3.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"ruby-devel-1.8.2-6.3.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"ruby-doc-1.8.2-6.3.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"ruby-tk-1.8.2-6.3.102mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2006.0", reference:"ruby-1.8.2-7.2.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", reference:"ruby-devel-1.8.2-7.2.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", reference:"ruby-doc-1.8.2-7.2.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", reference:"ruby-tk-1.8.2-7.2.20060mdk", yank:"mdk")) flag++;
