...
if (description)
{
  ...
  script_name(english:"Firefox < 39.0 Multiple Vulnerabilities (Mac OS X) (Logjam)");
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:FALSE, fix:'39.0', severity:SECURITY_HOLE);
