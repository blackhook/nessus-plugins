...
"The version of Thunderbird installed on the remote Windows host is prior to 91.3. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-50 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'91.3', severity:SECURITY_HOLE);
