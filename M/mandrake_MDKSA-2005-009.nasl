...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:009. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:009");

  script_name(english:"Mandrake Linux Security Advisory : mpg123 (MDKSA-2005:009)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"mpg123-0.59r-22.2.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"mpg123-0.59r-22.2.101mdk", yank:"mdk")) flag++;
