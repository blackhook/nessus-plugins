...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:073. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:073");

  script_name(english:"Mandrake Linux Security Advisory : cvs (MDKSA-2005:073)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"cvs-1.11.17-1.2.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"cvs-1.11.17-2.1.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"cvs-1.11.19-1.1.102mdk", yank:"mdk")) flag++;
