...
# extracted from Mandriva Linux Security Advisory MDVSA-2011:155. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2011:155");

  script_name(english:"Mandriva Linux Security Advisory : systemtap (MDVSA-2011:155)");
...
local users to cause a denial of service (divide-by-zero error and
OOPS) via a crafted ELF program with DWARF expressions that are not
properly handled by a stap script that performs stack unwinding (aka
backtracing) (CVE-2011-1781).
...
flag = 0;
if (rpm_check(release:"MDK2011", reference:"systemtap-1.4-1.1-mdv2011.0", yank:"mdv")) flag++;
