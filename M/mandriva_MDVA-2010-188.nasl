...
# Mandriva Linux Security Advisory MDVA-2010:188.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2010:188 : slib");
...
is the correct build of slib for Mandriva 2010.1.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2010:188");
...
if (rpm_check(reference:"slib-3b2-2.1mdv2010.1", release:"MDK2010.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"slib-3b2-2.1mdv2010.1", release:"MDK2010.1", cpu:"noarch", yank:"mdv")) flag++;
