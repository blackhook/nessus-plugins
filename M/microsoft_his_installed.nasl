...
mainframe and mid-range computers.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/collaborate/connect-redirect");
...
app = "Microsoft Host Integration Server";
...
register_install(
  app_name:app,
  vendor : 'Microsoft',
  product : 'Host Integration Server',
  path:path,
