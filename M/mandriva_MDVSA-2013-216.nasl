...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:216. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:216");

  script_name(english:"Mandriva Linux Security Advisory : perl-Proc-ProcessTable (MDVSA-2013:216)");
...
arbitrary files via a symlink attack on /tmp/TTYDEVS (CVE-2011-4363)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0254.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:perl-Proc-ProcessTable");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"perl-Proc-ProcessTable-0.480.0-1.mbs1")) flag++;
