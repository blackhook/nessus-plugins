...
if (description)
{
  ...
  script_name(english:"Firefox < 42 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'42', severity:SECURITY_HOLE);
