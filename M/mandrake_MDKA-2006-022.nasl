...
# Mandrake Linux Security Advisory MDKA-2006:022.
#
...
responsible for this bad behaviour.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDKA-2006:022");
...
if (rpm_check(reference:"module-init-tools-3.2-0.pre8.2.1.20060mdk", release:"MDK2006.0", cpu:"i386", yank:"mdk")) flag++;
