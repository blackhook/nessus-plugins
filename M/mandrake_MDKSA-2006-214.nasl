...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:214. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:214-1");

  script_name(english:"Mandrake Linux Security Advisory : gv (MDKSA-2006:214-1)");
...
gv 3.6.2, and possibly earlier versions, allows user-assisted
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"gv-3.6.1-4.3.20060mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2007.0", reference:"gv-3.6.1-7.2mdv2007.0", yank:"mdv")) flag++;
