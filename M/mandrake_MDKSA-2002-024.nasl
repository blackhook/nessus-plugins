...
# extracted from Mandrake Linux Security Advisory MDKSA-2002:024. 
...
if (description)
{
  ...
  script_cve_id("CVE-2002-0059", "CVE-2002-0080");
  script_xref(name:"MDKSA", value:"2002:024");

  script_name(english:"Mandrake Linux Security Advisory : rsync (MDKSA-2002:024)");
...
this new version of rsync."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=132272"
  );
...
flag = 0;
if (rpm_check(release:"MDK7.1", cpu:"i386", reference:"rsync-2.5.4-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"rsync-2.5.4-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"rsync-2.5.4-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.1", cpu:"i386", reference:"rsync-2.5.4-1.1mdk", yank:"mdk")) flag++;
