...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 78.11. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2021-26 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'78.11', severity:SECURITY_WARNING);
