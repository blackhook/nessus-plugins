...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:058. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:058");

  script_name(english:"Mandriva Linux Security Advisory : freeradius (MDVSA-2014:058)");
...
source uses an unusually long hashed password (CVE-2014-2015)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0088.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-krb5-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-ldap-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-mysql-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-postgresql-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-sqlite-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-unixODBC-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"freeradius-web-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64freeradius-devel-2.1.12-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64freeradius1-2.1.12-9.2.mbs1")) flag++;
