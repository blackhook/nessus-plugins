...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:047. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:047");

  script_name(english:"Mandriva Linux Security Advisory : elfutils (MDVSA-2015:047)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"elfutils-0.152-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64elfutils-devel-0.152-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64elfutils-static-devel-0.152-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64elfutils1-0.152-2.1.mbs1")) flag++;
