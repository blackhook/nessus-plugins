...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:156. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:156");

  script_name(english:"Mandriva Linux Security Advisory : libcap-ng (MDVSA-2015:156)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"lib64cap-ng-devel-0.7.3-4.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"lib64cap-ng0-0.7.3-4.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"libcap-ng-utils-0.7.3-4.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"python-libcap-ng-0.7.3-4.1.mbs2")) flag++;
