...
"The version of Firefox ESR installed on the remote Windows host is prior to 78.4.1. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'78.4.1', min:'78.0.0', severity:SECURITY_HOLE);
