...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 91.9.1");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote Windows host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote Windows host is prior to 91.9.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2022-19 advisory.
...
"Upgrade to Mozilla Firefox ESR version 91.9.1 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'91.9.1', min:'91.0.0', severity:SECURITY_HOLE);
