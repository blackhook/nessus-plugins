...
if (description)
{
  ...
  script_name(english:"MariaDB 10.1.0 < 10.1.35 Multiple Vulnerabilities");
...
10.1.35. It is, therefore, affected by multiple vulnerabilities as
referenced in the mdb-10135-rn advisory.
...
self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-10135-rn");
...
"Upgrade to MariaDB version 10.1.35 or later.");
...
mysql_check_version(variant: 'MariaDB', min:'10.1.0-MariaDB', fixed:make_list('10.1.35-MariaDB'), severity:SECURITY_WARNING);