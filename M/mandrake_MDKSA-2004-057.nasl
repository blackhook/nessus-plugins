...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:057. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:057-1");

  script_name(english:"Mandrake Linux Security Advisory : tripwire (MDKSA-2004:057-1)");
...
correct the problem."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/archive/1/365036"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK9.2", cpu:"i386", reference:"tripwire-2.3.1.2-7.2.92mdk", yank:"mdk")) flag++;
