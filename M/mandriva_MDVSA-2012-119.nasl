...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:119. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : bind (MDVSA-2012:119)");
...
which is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"ftp://ftp.isc.org/isc/bind9/9.7.6-P2/RELEASE-NOTES-BIND-9.7.6-P2.txt"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"ftp://ftp.isc.org/isc/bind9/9.8.3-P2/RELEASE-NOTES-BIND-9.8.3-P2.txt"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (rpm_check(release:"MDK2011", reference:"bind-9.8.3-0.0.P2.0.1-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", reference:"bind-devel-9.8.3-0.0.P2.0.1-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", reference:"bind-doc-9.8.3-0.0.P2.0.1-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", reference:"bind-utils-9.8.3-0.0.P2.0.1-mdv2011.0", yank:"mdv")) flag++;
