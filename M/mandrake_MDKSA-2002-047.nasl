...
# extracted from Mandrake Linux Security Advisory MDKSA-2002:047. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2002:047");

  script_name(english:"Mandrake Linux Security Advisory : util-linux (MDKSA-2002:047)");
...
flag = 0;
if (rpm_check(release:"MDK7.1", cpu:"i386", reference:"util-linux-2.10o-6.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"util-linux-2.10o-6.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"util-linux-2.10s-3.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.1", cpu:"i386", reference:"util-linux-2.11h-3.5mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"losetup-2.11n-4.3mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"mount-2.11n-4.3mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"util-linux-2.11n-4.3mdk", yank:"mdk")) flag++;
