...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:185. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:185");

  script_name(english:"Mandriva Linux Security Advisory : perl-Module-Signature (MDVSA-2013:185)");
...
Arbitrary code execution vulnerability in Module::Signature before
0.72 (CVE-2013-2145)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0184.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"perl-Module-Signature-0.730.0-1.mbs1")) flag++;
