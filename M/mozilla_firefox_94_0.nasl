...
"The version of Firefox installed on the remote Windows host is prior to 94.0. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-48 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'94.0', severity:SECURITY_HOLE);
