...
if (description)
{
  ...
  script_name(english:"Firefox 3.6 < 3.6.16 Invalid HTTP Certificates");
...
"The installed version of Firefox 3.6 is earlier than 3.6.16.  Such
...
or download and install applications.");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 3.6.16 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.6.16', min:'3.6', severity:SECURITY_WARNING);