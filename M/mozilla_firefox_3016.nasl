...
if (description)
{
  ...
  script_bugtraq_id(37360,37361,37362,37363,37364,37365,37366,37367,37370);
  script_xref(name:"Secunia", value:"37699");

  script_name(english:"Firefox < 3.0.16 Multiple Vulnerabilities");
...
"The installed version of Firefox is earlier than 3.0.16.  Such
versions are potentially affected by the following security issues :
  ...
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade to Firefox 3.0.16 or later."
  );
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.0.16', severity:SECURITY_HOLE);