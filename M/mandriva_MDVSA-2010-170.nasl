...
# extracted from Mandriva Linux Security Advisory MDVSA-2010:170. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : wget (MDVSA-2010:170)");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"wget-1.10.2-6.2mdv2008.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2009.0", reference:"wget-1.11.4-1.2mdv2009.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2009.1", reference:"wget-1.11.4-2.2mdv2009.1", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.0", reference:"wget-1.12-1.1mdv2010.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.1", reference:"wget-1.12-4.1mdv2010.1", yank:"mdv")) flag++;
