...
"The version of Firefox ESR installed on the remote Windows host is prior to 68.6. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2020-09 advisory. Note that Nessus has not tested for this issue but
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'68.6', severity:SECURITY_HOLE);
