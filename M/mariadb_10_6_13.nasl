...
if (description)
{
  ...
  script_name(english:"MariaDB 10.6.0 < 10.6.13");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.6.13. It is, therefore, affected by a vulnerability
as referenced in the mariadb-10613-release-notes advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-10613-release-notes");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.6.13 or later.");
...
var constraints = [
  { 'min_version' : '10.6', 'fixed_version' : '10.6.13' }
];
