...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:083. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:083");

  script_name(english:"Mandriva Linux Security Advisory : mozilla-thunderbird (MDVSA-2009:083)");
...
when used with Enigmail extension on x86_64 architecture, would
freeze whenever any Enigmail function was used (bug #45001). Also,
when used on i586 architecture, Thunderbird would crash when sending
an email, if a file with an unknown extension was attached to it. (bug
#46107)

This update also fixes those issues."
  );
  # https://www.mozilla.org/en-US/security/known-vulnerabilities/thunderbird-2.0/#thunderbird2.0.0.21
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aad4eec2"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://qa.mandriva.com/45001"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://qa.mandriva.com/46107"
  );
