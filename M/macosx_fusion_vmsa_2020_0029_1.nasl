...
if (description)
{
  ...
  script_name(english:"VMware Fusion 11.0.x < 11.5.7 Vulnerability (VMSA-2020-0029.1)");
...
"The version of VMware Fusion installed on the remote macOS or Mac OS X host is 11.0.x prior to 11.5.7. It is, therefore,
...
"Update to VMware Fusion version 11.5.7, or later.");
