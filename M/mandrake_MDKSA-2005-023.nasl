...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:023. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:023");

  script_name(english:"Mandrake Linux Security Advisory : bind (MDKSA-2005:023)");
...
flag = 0;
if (rpm_check(release:"MDK10.1", reference:"bind-9.3.0-3.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"bind-devel-9.3.0-3.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"bind-utils-9.3.0-3.1.101mdk", yank:"mdk")) flag++;
