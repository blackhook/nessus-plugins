...
if (now > 1606712400)
  eol_dates["^6\.4($|[^0-9])"] = "2020/11/30";

if (now > 1622260800)
  eol_dates["^7\.0($|[^0-9])"] = "2021/05/29";

eol_urls  = make_array(
  "^7\.0($|[^0-9])", "https://wiki.documentfoundation.org/ReleasePlan/7.0#End_of_Life",
  "^6\.4($|[^0-9])", "https://wiki.documentfoundation.org/ReleasePlan/6.4#End_of_Life",
  "^6\.3($|[^0-9])", "https://wiki.documentfoundation.org/ReleasePlan/6.3#End_of_Life",
  "^6\.2($|[^0-9])", "https://wiki.documentfoundation.org/ReleasePlan/6.2#End_of_Life",
  "^6\.1($|[^0-9])", "https://wiki.documentfoundation.org/ReleasePlan/6.1#End_of_Life",
  "^6\.0($|[^0-9])", "https://wiki.documentfoundation.org/ReleasePlan/6.0#End_of_Life",
  "^5\.4($|[^0-9])", "https://wiki.documentfoundation.org/ReleasePlan/5.4#End_of_Life",
