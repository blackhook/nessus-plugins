...
# extracted from Mandriva Linux Security Advisory MDVSA-2011:196. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : ipmitool (MDVSA-2011:196)");
...
The updated packages have been patched to correct this issue."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:ipmitool");
...
flag = 0;
if (rpm_check(release:"MDK2010.1", reference:"ipmitool-1.8.11-8.1mdv2010.2", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2011", reference:"ipmitool-1.8.11-8.1-mdv2011.0", yank:"mdv")) flag++;
