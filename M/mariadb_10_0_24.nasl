...
if (description)
{
  ...
  script_name(english:"MariaDB 10.0.x < 10.0.24 Multiple Vulnerabilities");
...
10.0.24. It is, therefore, affected by multiple vulnerabilities :
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.org/mariadb-10-0-24-now-available/");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-10024-changelog/");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb/mariadb-10024-release-notes/");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.0.24 or later.");
...
mysql_check_version(variant:'MariaDB', fixed:'10.0.24-MariaDB', min:'10.0', severity:SECURITY_WARNING);
