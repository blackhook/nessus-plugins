...
# extracted from Mandrake Linux Security Advisory MDKSA-2003:051. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2003:051");

  script_name(english:"Mandrake Linux Security Advisory : ethereal (MDKSA-2003:051)");
...
cause a denial of service (DoS) and possibly execute arbitrary code.
...
flag = 0;
if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"ethereal-0.9.11-1.1mdk", yank:"mdk")) flag++;
