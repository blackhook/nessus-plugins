...
# extracted from Mandrake Linux Security Advisory MDKSA-2003:109. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2003:109");

  script_name(english:"Mandrake Linux Security Advisory : gnupg (MDKSA-2003:109)");
...
writing the patch)."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2003/11/28");
...
flag = 0;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"gnupg-1.0.7-3.2.90mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"gnupg-1.2.2-1.2.91mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"gnupg-1.2.3-3.1.92mdk", yank:"mdk")) flag++;
