...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:169. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:169");

  script_name(english:"Mandriva Linux Security Advisory : bugzilla (MDVSA-2014:169)");
...
the character-set requirements of a callback API (CVE-2014-1546)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0349.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"bugzilla-4.2.10-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"bugzilla-contrib-4.2.10-1.mbs1")) flag++;
