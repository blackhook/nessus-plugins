...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 16.0 Multiple Vulnerabilities (Mac OS X)");
...
mozilla_check_version(product:'thunderbird', version:version, path:path, esr:FALSE, fix:'16.0', skippat:'^10\\.0\\.', severity:SECURITY_HOLE, xss:TRUE);
