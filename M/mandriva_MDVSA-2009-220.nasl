...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:220. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : davfs (MDVSA-2009:220-1)");
...
customers."
  ...
  script_set_attribute(attribute:"solution", value:"Update the affected davfs package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:davfs");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"davfs-0.2.4-10.1mdv2008.0", yank:"mdv")) flag++;
