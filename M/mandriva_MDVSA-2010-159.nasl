...
# extracted from Mandriva Linux Security Advisory MDVSA-2010:159. 
...
if (description)
{
  ...
  script_bugtraq_id(40426);
  script_xref(name:"MDVSA", value:"2010:159");

  script_name(english:"Mandriva Linux Security Advisory : gv (MDVSA-2010:159)");
...
flag = 0;
if (rpm_check(release:"MDK2010.0", reference:"gv-3.7.1-0.1mdv2010.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.1", reference:"gv-3.7.1-0.1mdv2010.1", yank:"mdv")) flag++;
