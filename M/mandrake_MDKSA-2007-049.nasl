...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:049. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : spamassassin (MDKSA-2007:049)");
...
resources that could delay or prevent the delivery of mail if a number
of these messages were sent at once.
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"perl-Mail-SpamAssassin-3.1.8-0.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"spamassassin-3.1.8-0.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"spamassassin-spamc-3.1.8-0.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"spamassassin-spamd-3.1.8-0.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"spamassassin-tools-3.1.8-0.1mdv2007.0", yank:"mdv")) flag++;
