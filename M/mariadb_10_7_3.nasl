...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1073-rn");
...
mysql_check_version(variant: 'MariaDB', min:'10.7.0-MariaDB', fixed:make_list('10.7.3-MariaDB'), severity:SECURITY_NOTE);