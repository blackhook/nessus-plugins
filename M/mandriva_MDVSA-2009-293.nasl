...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:293. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : squidGuard (MDVSA-2009:293-1)");
...
customers."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:squidGuard");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"squidGuard-1.2.0-14.1mdv2008.0", yank:"mdv")) flag++;
