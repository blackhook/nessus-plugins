...
# extracted from Mandriva Linux Security Advisory MDVSA-2008:140. 
...
if (description)
{
  ...
  script_cve_id("CVE-2008-1891", "CVE-2008-2376", "CVE-2008-2662", "CVE-2008-2663", "CVE-2008-2664", "CVE-2008-2725", "CVE-2008-2726");
  script_bugtraq_id(29903, 30036);
  script_xref(name:"MDVSA", value:"2008:140");

  script_name(english:"Mandriva Linux Security Advisory : ruby (MDVSA-2008:140)");
...
flag = 0;
if (rpm_check(release:"MDK2008.1", reference:"ruby-1.8.6-9p114.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"ruby-devel-1.8.6-9p114.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"ruby-doc-1.8.6-9p114.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"ruby-tk-1.8.6-9p114.1mdv2008.1", yank:"mdv")) flag++;
