...
if (description)
{
  ...
  script_name(english:"ManageEngine SupportCenter Plus < 11.0 Build 11025 Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server hosts an application that is affected by a privilege escalation vulnerability.");
  script_set_attribute(attribute:"description", value:
"A privilege escalation vulnerability exists in ManageEngine SupportCenter Plus prior to 11.0 Build 11025.
This vulnerability allows an adversary to access restricted data in the Postgres database setup by using 
a specific PostgreSQL function in the query, which enables bypassing the validation mechanism.
...
"Upgrade to ManageEngine SupportCenter Plus version 11.0 Build 11025, or later.");
...
var constraints = [
  {'fixed_version': '11025', 'fixed_display' : '11.0 Build 11025'}
];
