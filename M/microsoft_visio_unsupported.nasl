...
var installs, supported_info, info, vuln, install, path, product, sp, version, verbose_version, supported_version, port, report, s;

installs = get_installs(app_name:"Microsoft Visio", exit_if_not_found:TRUE);

supported_info['2021']['supported_sp']     = 0;
supported_info['2021']['0']['unsupported'] = FALSE;
supported_info['2021']['0']['eos_date']    = "October 13, 2026";

supported_info['2019']['supported_sp']     = 0;
supported_info['2019']['0']['unsupported'] = FALSE;
supported_info['2019']['0']['eos_date']    = "October 14, 2025";
...
supported_info['2010']['2']['unsupported'] = TRUE;
...
supported_info['2007']['3']['unsupported'] = TRUE;
