...
if (description)
{
  ...
  script_name(english:"Microsoft Edge (Chromium) < 86.0.622.69 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 86.0.622.69. It is, therefore, affected
by multiple vulnerabilities as referenced in the ADV200002-11-13-2020 advisory. Note that Nessus has not tested for this
...
"Upgrade to Microsoft Edge version 86.0.622.69 or later.");
