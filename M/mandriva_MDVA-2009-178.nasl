...
# Mandriva Linux Security Advisory MDVA-2009:178.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2009:178 : xkeyboard-config");
...
haldaemon or reboot for this change to take effect.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2009:178");
...
if (rpm_check(reference:"x11-data-xkbdata-1.5-3.2mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"x11-data-xkbdata-1.5-3.2mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
