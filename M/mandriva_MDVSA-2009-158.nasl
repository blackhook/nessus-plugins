...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:158. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:158-3");

  script_name(english:"Mandriva Linux Security Advisory : pango (MDVSA-2009:158-3)");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64pango1.0-devel-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64pango1.0_0-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64pango1.0_0-modules-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libpango1.0-devel-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libpango1.0_0-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libpango1.0_0-modules-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"pango-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"pango-doc-1.18.2-1.1mdv2008.0", yank:"mdv")) flag++;
