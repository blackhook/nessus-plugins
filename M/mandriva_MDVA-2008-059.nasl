...
# Mandriva Linux Security Advisory MDVA-2008:059.
#
...
HorizSync/VertRefresh (needed for edid.lcd.dell-inspiron-6400, bug
#37971)");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2008:059");
...
if (rpm_check(reference:"drakx-kbd-mouse-x11-0.37.3-1.1mdv2008.0", release:"MDK2008.0", cpu:"i386", yank:"mdv")) flag++;

if (rpm_check(reference:"drakx-kbd-mouse-x11-0.37.3-1.1mdv2008.0", release:"MDK2008.0", cpu:"x86_64", yank:"mdv")) flag++;
