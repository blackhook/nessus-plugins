...
"The version of Google Chrome installed on the remote macOS host is prior to 107.0.5304.62. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2022_10_stable-channel-update-for-desktop_25 advisory.
...
google_chrome_check_version(fix:'107.0.5304.62', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
