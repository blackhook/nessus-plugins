...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:112. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : perl-DBD-Pg (MDVSA-2012:112)");
...
server could provide a specially crafted database warning or specially
crafted DBD statement, which once processed by the perl-DBD-Pg
...
flag = 0;
if (rpm_check(release:"MDK2011", reference:"perl-DBD-Pg-2.18.1-1.1-mdv2011.0", yank:"mdv")) flag++;
