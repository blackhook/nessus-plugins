...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 59.0.2 Denial of Service Vulnerability");
...
host is prior to 59.0.2. It is, therefore, affected by a 
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'59.0.2', severity:SECURITY_HOLE);
