...
# extracted from Mandrake Linux Security Advisory MDKSA-2003:116. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2003:116");

  script_name(english:"Mandrake Linux Security Advisory : lftp (MDKSA-2003:116)");
...
flag = 0;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"lftp-2.6.0-1.1.90mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"lftp-2.6.4-2.1.91mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"lftp-2.6.6-2.1.92mdk", yank:"mdk")) flag++;
