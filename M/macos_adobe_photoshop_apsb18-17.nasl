...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 18.x < 18.1.4 / 19.x < 19.1.4 Remote Code Execution Vulnerability (APSB18-17) (macOS)");
...
Mac OS X host is 18.x prior to 18.1.4 (2017.1.4) or
19.x prior to 19.1.4 (2018.1.4). It is, therefore, affected by an
unspecified remote code execution vulnerability.");
