...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:014. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:014");

  script_name(english:"Mandriva Linux Security Advisory : libjpeg (MDVSA-2015:014)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"jpeg-progs-1.2.0-5.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64jpeg-devel-1.2.0-5.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64jpeg-static-devel-1.2.0-5.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64jpeg62-1.2.0-5.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64jpeg8-1.2.0-5.3.mbs1")) flag++;
