...
"The version of Firefox installed on the remote Windows host is prior to 68.0.2. It is, therefore, affected by a
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'68.0.2', severity:SECURITY_WARNING);
