...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:276. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:276-1");

  script_name(english:"Mandriva Linux Security Advisory : python-django (MDVSA-2009:276-1)");
...
customers"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.djangoproject.com/weblog/2009/oct/09/security/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"python-django-1.0.4-0.1mdv2008.0", yank:"mdv")) flag++;
