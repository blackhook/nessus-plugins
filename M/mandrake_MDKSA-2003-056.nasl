...
flag = 0;
if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"xinetd-2.3.11-1.1mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"xinetd-ipv6-2.3.11-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"xinetd-2.3.11-1.1mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"xinetd-ipv6-2.3.11-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"xinetd-2.3.11-1.1mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"xinetd-ipv6-2.3.11-1.1mdk", yank:"mdk")) flag++;
