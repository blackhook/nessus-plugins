...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:186. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:186");

  script_name(english:"Mandrake Linux Security Advisory : kdelibs (MDKSA-2006:186)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"kdelibs-common-3.5.4-19.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"kdelibs-devel-doc-3.5.4-19.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"x86_64", reference:"lib64kdecore4-3.5.4-19.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"x86_64", reference:"lib64kdecore4-devel-3.5.4-19.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"i386", reference:"libkdecore4-3.5.4-19.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"i386", reference:"libkdecore4-devel-3.5.4-19.1mdv2007.0", yank:"mdv")) flag++;
