...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:083. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:083");
  script_xref(name:"MGASA", value:"2012-0293");

  script_name(english:"Mandriva Linux Security Advisory : glib2.0 (MDVSA-2013:083)");
...
It was discovered that the version of glib shipped with MBS 1 does not
...
environment."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:lib64glib2.0-static-devel");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"glib-gettextize-2.32.4-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"glib2.0-common-2.32.4-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64gio2.0_0-2.32.4-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64glib2.0-devel-2.32.4-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64glib2.0-static-devel-2.32.4-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64glib2.0_0-2.32.4-1.mbs1")) flag++;
