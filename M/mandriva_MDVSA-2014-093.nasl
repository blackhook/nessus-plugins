...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:093. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:093");

  script_name(english:"Mandriva Linux Security Advisory : couchdb (MDVSA-2014:093)");
...
to /_uuids (CVE-2014-2668)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0203.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"couchdb-1.2.1-1.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"couchdb-bin-1.2.1-1.1.mbs1")) flag++;
