...
if (description)
{
  ...
  script_name(english:"MariaDB 10.2.0 < 10.2.22 Multiple Vulnerabilities");
  script_summary(english:"Checks the version of MariaDB.");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.2.22. It is, therefore, affected by two
vulnerabilities as referenced in the mdb-10222-rn advisory. They are as follows:
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-10222-rn");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.2.22 or later.");
...
mysql_check_version(variant: 'MariaDB', min:'10.2.0-MariaDB', fixed:make_list('10.2.22-MariaDB'), severity:SECURITY_WARNING, paranoid: false);
