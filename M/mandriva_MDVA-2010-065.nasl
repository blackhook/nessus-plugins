...
# Mandriva Linux Security Advisory MDVA-2010:065.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2010:065 : mandriva-release");
...
"Add the extended maintainance access support for 2008.0");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2010:065");
