...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:106. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:106");

  script_name(english:"Mandrake Linux Security Advisory : spamassassin (MDKSA-2005:106)");
...
flag = 0;
if (rpm_check(release:"MDK10.1", reference:"perl-Mail-SpamAssassin-3.0.4-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"spamassassin-3.0.4-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"spamassassin-spamc-3.0.4-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"spamassassin-spamd-3.0.4-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"spamassassin-tools-3.0.4-0.1.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"perl-Mail-SpamAssassin-3.0.4-0.1.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"spamassassin-3.0.4-0.1.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"spamassassin-spamc-3.0.4-0.1.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"spamassassin-spamd-3.0.4-0.1.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"spamassassin-tools-3.0.4-0.1.102mdk", yank:"mdk")) flag++;
