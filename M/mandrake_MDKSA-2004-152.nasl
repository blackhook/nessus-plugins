...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:152. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:152");

  script_name(english:"Mandrake Linux Security Advisory : ethereal (MDKSA-2004:152)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"ethereal-0.10.8-0.1.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"ethereal-0.10.8-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"ethereal-tools-0.10.8-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", cpu:"x86_64", reference:"lib64ethereal0-0.10.8-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", cpu:"i386", reference:"libethereal0-0.10.8-0.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"tethereal-0.10.8-0.1.101mdk", yank:"mdk")) flag++;
