...
if (description)
{
  ...
  script_name(english:"MySQL 5.5.x < 5.5.62 Multiple Vulnerabilities (October 2018 CPU)");
...
5.5.62. It is, therefore, affected by multiple vulnerabilities as
...
var constraints = [{ 'min_version' : '5.5.0', 'fixed_version' : '5.5.62'}];
