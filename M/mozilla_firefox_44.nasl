...
if (description)
{
  ...
  script_name(english:"Firefox < 44 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'44', severity:SECURITY_HOLE);
