...
if (description)
{
  ...
  script_name(english:"Mambo Open Source < 4.5.2.3 Multiple Vulnerabilities");
...
from the following flaws :
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2005/Jun/189");
  script_set_attribute(attribute:"see_also", value:"https://secuniaresearch.flexerasoftware.com/advisories/15710");
