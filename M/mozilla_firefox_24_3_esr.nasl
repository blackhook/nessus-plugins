...
if (description)
{
  ...
  script_name(english:"Firefox ESR 24.x < 24.3 Multiple Vulnerabilities");
...
"The installed version of Firefox ESR 24.x is earlier than 24.3, and
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'24.3', min:'24.0', severity:SECURITY_HOLE, xss:FALSE);
