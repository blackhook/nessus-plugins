...
"The version of Thunderbird installed on the remote Windows host is prior to 102.5. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2022-49 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'102.5', severity:SECURITY_HOLE);
