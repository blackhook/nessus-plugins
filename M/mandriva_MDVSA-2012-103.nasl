...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:103. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : automake (MDVSA-2012:103)");
...
flag = 0;
if (rpm_check(release:"MDK2011", reference:"automake-1.11.1-3.1-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", reference:"automake1.7-1.7.9-12.1-mdv2011.0", yank:"mdv")) flag++;
