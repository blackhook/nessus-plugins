...
# extracted from Mozilla Foundation Security Advisory mfsa2019-02.
...
if (description)
{
  ...
  script_xref(name:"MFSA", value:"2019-02");

  script_name(english:"Mozilla Firefox ESR < 60.5");
...
vulnerabilities as referenced in the mfsa2019-02 advisory.
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:TRUE, fix:'60.5', severity:SECURITY_HOLE);
