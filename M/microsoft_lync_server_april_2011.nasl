...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2011-B-0074-S");
...
resulting in arbitrary script code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"http://foofus.net/?p=363");
  script_set_attribute(attribute:"see_also", value:"http://foofus.net/?page_id=372");
  script_set_attribute(attribute:"see_also", value:"https://support.microsoft.com/en-us/help/2500441/description-of-the-update-package-for-lync-server-2010-web-components");
  script_set_attribute(
    attribute:"solution",
    value:
