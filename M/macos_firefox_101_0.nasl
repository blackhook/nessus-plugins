...
# extracted from Mozilla Foundation Security Advisory mfsa2022-20.
...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 101.0");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 101.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2022-20 advisory.
  ...
  - An attacker could have caused an uninitialized variable on the stack to be mistakenly freed, causing a
    potentially exploitable crash. (CVE-2022-1919)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2022-20/");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'101.0', severity:SECURITY_HOLE);
