...
# extracted from Mandriva Linux Security Advisory MDVSA-2011:109. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : webmin (MDVSA-2011:109)");
...
The updated packages have been upgraded to the 1.550 version which is
...
flag = 0;
if (rpm_check(release:"MDK2009.0", reference:"webmin-1.550-0.2mdv2009.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.1", reference:"webmin-1.550-0.2mdv2010.2", yank:"mdv")) flag++;
