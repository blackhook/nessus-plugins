...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:032. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:032");

  script_name(english:"Mandrake Linux Security Advisory : xpdf (MDKSA-2006:032)");
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"xpdf-3.01-1.2.20060mdk", yank:"mdk")) flag++;
