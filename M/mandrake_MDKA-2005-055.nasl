...
# Mandrake Linux Security Advisory MDKA-2005:055.
#
...
(telinit 3 if you use a graphical login, or exit X if you use
startx).");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDKA-2005:055");
...
if (rpm_check(reference:"acpid-1.0.4-6.2.20060mdk", release:"MDK2006.0", cpu:"i386", yank:"mdk")) flag++;
