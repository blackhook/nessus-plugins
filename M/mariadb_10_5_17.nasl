...
vulnerabilities as referenced in the mariadb-10517-release-notes advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-10517-release-notes");
...
mysql_check_version(variant: 'MariaDB', min:'10.5.0-MariaDB', fixed:make_list('10.5.17-MariaDB'), severity:SECURITY_HOLE);