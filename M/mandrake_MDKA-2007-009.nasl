...
# Mandrake Linux Security Advisory MDKA-2007:009.
#
...
issue.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDKA-2007:009");
...
if (rpm_check(reference:"perl-SOAP-Lite-0.69-2.1mdv2007.0", release:"MDK2007.0", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"perl-SOAP-Lite-0.69-2.1mdv2007.0", release:"MDK2007.0", cpu:"noarch", yank:"mdv")) flag++;
