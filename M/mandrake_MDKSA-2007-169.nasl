...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:169. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : gdm (MDKSA-2007:169)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"gdm-2.16.0-2.2mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"gdm-Xnest-2.16.0-2.2mdv2007.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2007.1", reference:"gdm-2.18.0-3.1mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"gdm-Xnest-2.18.0-3.1mdv2007.1", yank:"mdv")) flag++;
