...
# Mandriva Linux Security Advisory MDVA-2008:124.
#
...
Finally, it also makes MandrivaUpdate fit in laptop screens (i.e.
when the resolution only has 480 horizontal lines).");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2008:124");
...
if (rpm_check(reference:"rpmdrake-4.9.13.4-1mdv2008.1", release:"MDK2008.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"rpmdrake-4.9.13.4-1mdv2008.1", release:"MDK2008.1", cpu:"noarch", yank:"mdv")) flag++;
