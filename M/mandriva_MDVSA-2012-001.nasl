...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:001. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : fcgi (MDVSA-2012:001)");
...
The updated packages have been patched to correct this issue."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:perl-FCGI");
...
flag = 0;
if (rpm_check(release:"MDK2010.1", reference:"perl-FCGI-0.710.0-1.1mdv2010.2", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2011", reference:"perl-FCGI-0.730.0-1.1-mdv2011.0", yank:"mdv")) flag++;
