...
script code in a user's browser.");
  script_set_attribute(attribute:"see_also", value:"https://mantisbt.org/bugs/view.php?id=15415");
  script_set_attribute(attribute:"see_also", value:"https://mantisbt.org/bugs/view.php?id=15416");
