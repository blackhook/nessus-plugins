...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:210. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:210");

  script_name(english:"Mandrake Linux Security Advisory : syslinux (MDKSA-2006:210)");
...
private copy of libpng, and as such could be susceptible to some of
...
Packages have been patched to correct these issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected pxelinux, syslinux and / or syslinux-devel
packages."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:syslinux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:syslinux-devel");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", cpu:"i386", reference:"pxelinux-3.20-3.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"i386", reference:"syslinux-3.20-3.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"i386", reference:"syslinux-devel-3.20-3.1mdv2007.0", yank:"mdv")) flag++;
