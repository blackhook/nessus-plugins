...
# extracted from Mandriva Linux Security Advisory MDVSA-2008:185. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : python-django (MDVSA-2008:185)");
...
addition, they provide other bug fixes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.djangoproject.com/weblog/2008/sep/02/security/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK2007.1", reference:"python-django-0.95.4-0.1mdv2007.1", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2008.0", reference:"python-django-0.96.3-0.1mdv2008.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2008.1", reference:"python-django-0.96.3-0.1mdv2008.1", yank:"mdv")) flag++;
