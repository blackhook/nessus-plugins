...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:208. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:208");

  script_name(english:"Mandriva Linux Security Advisory : setup (MDVSA-2015:208)");
...
files, and rpmdrake might propose the user to use those basically
empty files, thus leading to loss of passwords or partition table.
This new update ensures that such .rpmnew files are not kept after the
update."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0162.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", reference:"setup-2.7.20-10.2.mbs2")) flag++;
