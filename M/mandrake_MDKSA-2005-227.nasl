...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:227. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:227");

  script_name(english:"Mandrake Linux Security Advisory : ethereal (MDKSA-2005:227)");
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"ethereal-0.10.13-0.5.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", reference:"ethereal-tools-0.10.13-0.5.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", cpu:"x86_64", reference:"lib64ethereal0-0.10.13-0.5.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", cpu:"i386", reference:"libethereal0-0.10.13-0.5.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", reference:"tethereal-0.10.13-0.5.20060mdk", yank:"mdk")) flag++;
