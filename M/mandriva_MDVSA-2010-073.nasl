...
# extracted from Mandriva Linux Security Advisory MDVSA-2010:073. 
...
if (description)
{
  ...
  script_bugtraq_id(36958, 37048, 38510, 38524);
  script_xref(name:"MDVSA", value:"2010:073-1");

  script_name(english:"Mandriva Linux Security Advisory : cups (MDVSA-2010:073-1)");
...
scripting (XSS) attacks and HTTP response splitting attacks via
vectors related to (a) the product's web interface, (b) the
configuration of the print system, and (c) the titles of printed jobs
(CVE-2009-2820).
...
because of an incomplete fix for CVE-2009-3553 (CVE-2010-0302).
...
flag = 0;
if (rpm_check(release:"MDK2010.0", reference:"cups-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2010.0", reference:"cups-common-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2010.0", reference:"cups-serial-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2010.0", cpu:"x86_64", reference:"lib64cups2-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2010.0", cpu:"x86_64", reference:"lib64cups2-devel-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2010.0", cpu:"i386", reference:"libcups2-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2010.0", cpu:"i386", reference:"libcups2-devel-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2010.0", reference:"php-cups-1.4.1-12.1mdv2010.0", yank:"mdv")) flag++;
