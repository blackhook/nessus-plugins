...
"The version of Thunderbird installed on the remote Windows host is prior to 91.10. It is, therefore, affected by
multiple vulnerabilities as referenced in the mfsa2022-22 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'91.10', severity:SECURITY_HOLE);
