...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:070. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : evolution (MDKSA-2007:070)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"evolution-2.8.0-1.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"evolution-devel-2.8.0-1.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"evolution-mono-2.8.0-1.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"evolution-pilot-2.8.0-1.1mdv2007.0", yank:"mdv")) flag++;
