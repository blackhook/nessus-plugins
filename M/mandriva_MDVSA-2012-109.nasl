...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:109. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : libxslt (MDVSA-2012:109)");
...
flag = 0;
if (rpm_check(release:"MDK2011", cpu:"x86_64", reference:"lib64xslt-devel-1.1.26-4.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", cpu:"x86_64", reference:"lib64xslt1-1.1.26-4.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", cpu:"i386", reference:"libxslt-devel-1.1.26-4.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", cpu:"i386", reference:"libxslt1-1.1.26-4.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", reference:"python-libxslt-1.1.26-4.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", reference:"xsltproc-1.1.26-4.2-mdv2011.0", yank:"mdv")) flag++;
