...
if (description)
{
  ...
  script_name(english:"MySQL 5.7.x < 5.7.21 Multiple Vulnerabilities (January 2018 CPU)");
...
5.7.21. It is, therefore, affected by multiple vulnerabilities as
...
"Upgrade to MySQL version 5.7.21 or later.");
...
var constraints = [{ 'min_version' : '5.7.0', 'fixed_version' : '5.7.21'}];
