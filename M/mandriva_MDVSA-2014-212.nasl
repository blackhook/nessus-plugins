...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:212. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:212");

  script_name(english:"Mandriva Linux Security Advisory : wget (MDVSA-2014:212)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"wget-1.13.4-3.2.mbs1")) flag++;
