...
if (description)
{
  ...
  script_name(english:"Thunderbird 10.0.x < 10.0.5 Multiple Vulnerabilities (Mac OS X)");
...
mozilla_check_version(product:'thunderbird', version:version, path:path, fix:'10.0.5', min:'10.0', severity:SECURITY_HOLE, xss:TRUE);