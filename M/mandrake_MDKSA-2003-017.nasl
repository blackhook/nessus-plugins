...
# extracted from Mandrake Linux Security Advisory MDKSA-2003:017. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2003:017-1");

  script_name(english:"Mandrake Linux Security Advisory : pam (MDKSA-2003:017-1)");
