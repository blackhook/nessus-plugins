...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:048. 
...
if (description)
{
  ...
  script_bugtraq_id(53719);
  script_xref(name:"MDVSA", value:"2013:048");

  script_name(english:"Mandriva Linux Security Advisory : ncpfs (MDVSA-2013:048)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"ipxutils-2.2.6-11.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ncpfs-devel-2.2.6-11.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ncpfs2.3-2.2.6-11.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"ncpfs-2.2.6-11.1.mbs1")) flag++;
