...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:092. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:092");

  script_name(english:"Mandrake Linux Security Advisory : gzip (MDKSA-2005:092)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"gzip-1.2.4a-13.2.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"gzip-1.2.4a-13.2.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"gzip-1.2.4a-14.1.102mdk", yank:"mdk")) flag++;
