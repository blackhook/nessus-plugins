...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3142577");
  script_xref(name:"MSKB", value:"3154208");

  script_name(english:"MS16-042: Security Update for Microsoft Office (3148775) (Mac OS X)");
...
context of the current user.");
  script_set_attribute(attribute:"see_also", value:"https://technet.microsoft.com/en-us/library/security/MS16-042");
