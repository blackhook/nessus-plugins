...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:103. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:103");

  script_name(english:"Mandrake Linux Security Advisory : sudo (MDKSA-2005:103)");
...
The updated packages have been patched to correct this problem."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.sudo.ws/sudo/alerts/path_race.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"sudo-1.6.7-0.p5.2.2.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"sudo-1.6.8p1-1.2.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"sudo-1.6.8p1-2.1.102mdk", yank:"mdk")) flag++;
