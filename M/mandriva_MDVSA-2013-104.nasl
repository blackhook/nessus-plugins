...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:104. 
...
if (description)
{
  ...
  script_bugtraq_id(53646);
  script_xref(name:"MDVSA", value:"2013:104");
  script_xref(name:"MGASA", value:"2012-0182");

  script_name(english:"Mandriva Linux Security Advisory : mosh (MDVSA-2013:104)");
...
emulator (CVE-2012-2385)."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:mosh");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"mosh-1.1.3-2.1.mbs1")) flag++;
