...
"The version of Google Chrome installed on the remote macOS host is prior to 86.0.4240.198. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2020_11_stable-channel-update-for-desktop_11 advisory. Note that Nessus
...
google_chrome_check_version(fix:'86.0.4240.198', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
