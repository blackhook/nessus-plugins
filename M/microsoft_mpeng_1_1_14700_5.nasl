...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2018-A-0096-S");

  script_name(english:"Microsoft Malware Protection Engine < 1.1.14700.5 RCE");
...
on the remote Windows host is prior to 1.1.14700.5. It is, therefore,
affected by a remote code execution vulnerability which could allow
an attacker who successfully exploited this vulnerability to
execute arbitrary code in the security context of the LocalSystem
account and take control of the system. An attacker could then
...
used by any of the following applications :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cb49367b");
...
information on how to verify that MMPE has been updated.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-0986");
...
fixed_engine_version = "1.1.14700.5";
last_vulnerable = "1.1.14600.4";
