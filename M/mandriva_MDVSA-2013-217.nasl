...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:217. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:217");

  script_name(english:"Mandriva Linux Security Advisory : spice (MDVSA-2013:217)");
...
flaw in server/red_channel.c to crash the guest (CVE-2013-4130)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0255.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64spice-server-devel-0.12.2-5.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64spice-server1-0.12.2-5.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"spice-client-0.12.2-5.1.mbs1")) flag++;
