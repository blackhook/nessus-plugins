...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:101. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:101");

  script_name(english:"Mandriva Linux Security Advisory : owncloud (MDVSA-2014:101)");
...
See the upstream Changelog for more information."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0209.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://owncloud.org:443/changelog/"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"owncloud-5.0.16-1.mbs1")) flag++;
