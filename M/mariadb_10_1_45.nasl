...
if (description)
{
  ...
  script_cve_id("CVE-2020-2752", "CVE-2020-2812", "CVE-2020-2814");

  script_name(english:"MariaDB 10.1.0 < 10.1.45 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.1.45. It is, therefore, affected by multiple
vulnerabilities as referenced in the mdb-10145-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-10145-rn");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.1.45 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:H/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-2814");
...
mysql_check_version(variant: 'MariaDB', min:'10.1.0-MariaDB', fixed:make_list('10.1.45-MariaDB'), severity:SECURITY_WARNING);