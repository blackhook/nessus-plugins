...
# extracted from Mandriva Linux Security Advisory MDVSA-2010:078. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : sudo (MDVSA-2010:078-1)");
...
flag = 0;
if (rpm_check(release:"MDK2009.0", reference:"sudo-1.6.9p17-1.4mdv2009.0", yank:"mdv")) flag++;
