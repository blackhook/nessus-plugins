...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:212. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:212");

  script_name(english:"Mandriva Linux Security Advisory : otrs (MDVSA-2013:212)");
...
(CVE-2013-4717)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0247.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"otrs-3.2.9-1.mbs1")) flag++;
