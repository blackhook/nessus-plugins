...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:248. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:248");

  script_name(english:"Mandriva Linux Security Advisory : xinetd (MDVSA-2013:248)");
...
arbitrary code with the privileges of the root user (CVE-2013-4342)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0302.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"xinetd-2.3.15-1.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"xinetd-simple-services-2.3.15-1.1.mbs1")) flag++;
