...
# extracted from Mandrake Linux Security Advisory MDKSA-2001:020. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2001:020-1");

  script_name(english:"Mandrake Linux Security Advisory : cups (MDKSA-2001:020-1)");
...
Now you can update the cups packages properly via MandrakeUpdate."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected cups, cups-common and / or cups-devel packages."
  );
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2001/02/05");
...
flag = 0;
if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"cups-1.1.6-3.1mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"cups-common-1.1.6-3.1mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"cups-devel-1.1.6-3.1mdk", yank:"mdk")) flag++;
