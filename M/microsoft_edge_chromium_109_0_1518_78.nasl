...
if (description)
{
  ...
  script_cve_id("CVE-2023-21720");
  script_xref(name:"IAVA", value:"2023-A-0071-S");

  script_name(english:"Microsoft Edge (Chromium) < 109.0.1518.78 Tampering (CVE-2023-21720)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by tampering.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 109.0.1518.78. It is, therefore, affected
by a vulnerability as referenced in the February 2, 2023 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2023-21720");
...
"Upgrade to Microsoft Edge version 109.0.1518.78 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-21720");
