...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 52.3 Multiple Vulnerabilities");
...
host is prior to 52.3. It is, therefore, affected by multiple vulnerabilities,
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'52.3', min:'52', severity:SECURITY_HOLE);
