...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:159. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:159");

  script_name(english:"Mandriva Linux Security Advisory : jasper (MDVSA-2015:159)");
...
(CVE-2014-8158)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0539.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0038.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"jasper-1.900.1-16.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"lib64jasper-devel-1.900.1-16.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"lib64jasper-static-devel-1.900.1-16.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"lib64jasper1-1.900.1-16.1.mbs2")) flag++;
