...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:002. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:002");

  script_name(english:"Mandriva Linux Security Advisory : pcre (MDVSA-2015:002)");
...
to crash while parsing malicious regular expressions (CVE-2014-8964)."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected lib64pcre-devel, lib64pcre0 and / or pcre
packages."
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64pcre-devel-8.21-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64pcre0-8.21-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"pcre-8.21-2.1.mbs1")) flag++;
