...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:030. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:030");

  script_name(english:"Mandriva Linux Security Advisory : bugzilla (MDVSA-2015:030)");
...
(CVE-2014-8630)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0048.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"bugzilla-4.2.13-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"bugzilla-contrib-4.2.13-1.mbs1")) flag++;
