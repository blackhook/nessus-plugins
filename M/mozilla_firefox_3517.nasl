...
if (description)
{
  ...
  script_cve_id("CVE-2010-1585", "CVE-2010-3777", "CVE-2011-0051", 
    "CVE-2011-0053", "CVE-2011-0054", "CVE-2011-0055", "CVE-2011-0056", 
  ...
  script_name(english:"Firefox 3.5 < 3.5.17 Multiple Vulnerabilities");
...
versions are potentially affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2010/Apr/202");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2010-74/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-01/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-02/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-03/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-04/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-05/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-06/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-07/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-08/");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-10/");
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?64946117");

  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 3.5.17 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.5.17', min:'3.5', severity:SECURITY_HOLE);