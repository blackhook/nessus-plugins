...
if (description)
{
  ...
  script_cve_id("CVE-2016-5612", "CVE-2016-5630", "CVE-2016-6662");
  script_bugtraq_id(92912);
  script_xref(name:"EDB-ID", value:"40360");

  script_name(english:"MariaDB 10.0.x < 10.0.27 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB running on the remote host is 10.0.x prior to
10.0.27. It is, therefore, affected by multiple vulnerabilities :
  ...
  - A denial of service vulnerability exists in the
    my_double_round() function within file sql/item_func.cc
    when handling specially crafted queries. An
  ...
  script_set_attribute(attribute:"see_also", value:"https://mariadb.org/mariadb-10-0-27-now-available/");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-10027-changelog/");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-10027-release-notes/");
...
mysql_check_version(variant:'MariaDB', fixed:'10.0.27-MariaDB', min:'10.0', severity:SECURITY_HOLE);
