...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:282. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:282");

  script_name(english:"Mandriva Linux Security Advisory : perl-HTTP-Body (MDVSA-2013:282)");
...
further checks (CVE-2013-4407)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0352.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:perl-HTTP-Body");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"perl-HTTP-Body-1.150.0-2.1.mbs1")) flag++;
