...
# extracted from Mandriva Linux Security Advisory MDVSA-2010:081. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : apache-mod_auth_shadow (MDVSA-2010:081)");
...
The updated packages have been patched to correct this issue."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected apache-mod_auth_shadow package."
  );
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"apache-mod_auth_shadow-2.2-4.1mdv2008.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2009.1", reference:"apache-mod_auth_shadow-2.2-9.1mdv2009.1", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.0", reference:"apache-mod_auth_shadow-2.2-11.1mdv2010.0", yank:"mdv")) flag++;
