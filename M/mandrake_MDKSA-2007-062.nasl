...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:062. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : xine-lib (MDKSA-2007:062)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", cpu:"x86_64", reference:"lib64xine1-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"x86_64", reference:"lib64xine1-devel-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"i386", reference:"libxine1-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", cpu:"i386", reference:"libxine1-devel-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-aa-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-arts-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-dxr3-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-esd-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-flac-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-gnomevfs-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-image-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-plugins-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-sdl-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"xine-smb-1.1.2-3.4mdv2007.0", yank:"mdv")) flag++;
