...
if (description)
{
  ...
  script_name(english:"Firefox < 6.0.1 Out-of-Date CA List");
...
"The installed version of Firefox is earlier than 6.0.1 and is 
...
");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 6.0.1 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'6.0.1', skippat:'^3\\.6\\.', severity:SECURITY_WARNING);