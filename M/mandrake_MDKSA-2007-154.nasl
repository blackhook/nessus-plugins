...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:154. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2007:154");

  script_name(english:"Mandrake Linux Security Advisory : xine-ui (MDKSA-2007:154)");
...
flag = 0;
if (rpm_check(release:"MDK2007.1", reference:"xine-ui-0.99.4-8.1mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"xine-ui-aa-0.99.4-8.1mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"xine-ui-fb-0.99.4-8.1mdv2007.1", yank:"mdv")) flag++;
