...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:120. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:120");

  script_name(english:"Mandriva Linux Security Advisory : wpa_supplicant (MDVSA-2015:120)");
  ...
  script_set_attribute(
    ...
    value:
"Updated wpa_supplicant and hostapd packages fix security 
vulnerability :
...
Using the Mandriva wpa_supplicant package, systems are exposed to the
vulnerability if operating as a WPS registrar."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0429.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"wpa_supplicant-2.0-3.1.mbs2")) flag++;
