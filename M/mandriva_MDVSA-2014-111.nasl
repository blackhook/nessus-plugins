...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:111. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:111");

  script_name(english:"Mandriva Linux Security Advisory : otrs (MDVSA-2014:111)");
...
tricking the user into clicking links in OTRS (CVE-2014-2554)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0194.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"otrs-3.2.16-1.mbs1")) flag++;
