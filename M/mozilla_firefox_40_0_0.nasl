...
if (description)
{
  ...
  script_name(english:"Firefox < 40 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'40', severity:SECURITY_HOLE, xss:FALSE);
