...
# Mandriva Linux Security Advisory MDVA-2009:117.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2009:117 : ruby-RubyGems");
...
the installed gems. This update fixes this issue.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2009:117");
...
if (rpm_check(reference:"ruby-RubyGems-1.3.4-2.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"ruby-RubyGems-1.3.4-2.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
