...
ColdFusion, is available through the remote web server.");
  script_set_attribute(attribute:"see_also", value:"https://www.getmura.com/");
...
"n/a");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:getmura:mura_cms");
