...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:234. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:234");

  script_name(english:"Mandriva Linux Security Advisory : libksba (MDVSA-2014:234)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ksba-devel-1.3.2-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ksba8-1.3.2-1.mbs1")) flag++;
