...
for them.");
  script_set_attribute(attribute:"see_also", value:"https://cirt.net/MySQL+Eventum");
  script_set_attribute(attribute:"see_also", value:"https://bugs.mysql.com/bug.php?id=7552");
...
"Upgrade to MySQL Eventum 1.4 or later.");
  ...
  script_dependencies("mysql_eventum_detect.nasl", "cross_site_scripting.nasl");
