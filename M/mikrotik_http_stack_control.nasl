...
if (description)
{
  ...
  script_name(english:"MikroTik RouterOS HTTP Server Arbitrary Write RCE (ChimayRed)");
...
Note that this vulnerability is reportedly part of the ChimayRed
exploit from the Vault 7 leaks.");
