...
if (description)
{
  ...
  script_name(english:"Firefox < 16.0 Multiple Vulnerabilities (Mac OS X)");
...
affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2012-78/");
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:FALSE, fix:'16.0', skippat:'10\\.0\\.', severity:SECURITY_HOLE, xss:TRUE);
