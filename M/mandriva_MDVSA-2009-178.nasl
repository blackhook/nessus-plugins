...
certificate (CVE-2009-3024).

This update provides a fix for this vulnerability.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVSA-2009:178");
...
if (rpm_check(reference:"perl-IO-Socket-SSL-1.15-1.1mdv2009.0", release:"MDK2009.0", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"perl-IO-Socket-SSL-1.15-1.1mdv2009.0", release:"MDK2009.0", cpu:"noarch", yank:"mdv")) flag++;
