...
"The version of Google Chrome installed on the remote macOS host is prior to 83.0.4103.116. It is, therefore, affected by
a vulnerability as referenced in the 2020_06_stable-channel-update-for-desktop_22 advisory. Note that Nessus has not
...
google_chrome_check_version(fix:'83.0.4103.116', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
