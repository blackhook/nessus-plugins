...
if (description)
{
  ...
  script_name(english:"MySQL 5.6.x < 5.6.30 Multiple Vulnerabilities (DROWN)");
...
5.6.30. It is, therefore, affected by multiple vulnerabilities :
...
mysql_check_version(fixed:'5.6.30', min:'5.6', severity:SECURITY_HOLE);
