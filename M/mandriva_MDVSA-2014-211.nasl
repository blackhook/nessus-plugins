...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:211. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:211");

  script_name(english:"Mandriva Linux Security Advisory : wpa_supplicant (MDVSA-2014:211)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"wpa_supplicant-1.0-3.1.mbs1")) flag++;
