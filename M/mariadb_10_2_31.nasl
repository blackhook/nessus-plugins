...
if (description)
{
  ...
  script_name(english:"MariaDB 10.2.0 < 10.2.31 A Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by a vulnerability");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.2.31. It is, therefore, affected by a vulnerability
as referenced in the mdb-10231-rn advisory.
...
"Upgrade to MariaDB version 10.2.31 or later.");
...
mysql_check_version(variant: 'MariaDB', min:'10.2.0-MariaDB', fixed:make_list('10.2.31-MariaDB'), severity:SECURITY_WARNING);