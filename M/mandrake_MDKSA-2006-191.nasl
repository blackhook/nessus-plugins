...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:191. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:191");

  script_name(english:"Mandrake Linux Security Advisory : screen (MDKSA-2006:191)");
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"screen-4.0.2-6.1.20060mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2007.0", reference:"screen-4.0.2-9.1mdv2007.0", yank:"mdv")) flag++;
