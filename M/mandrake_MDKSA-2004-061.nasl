...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:061. 
...
if (description)
{
  ...
  script_xref(name:"CERT", value:"317350");
  script_xref(name:"CERT", value:"654390");
  script_xref(name:"MDKSA", value:"2004:061");

  script_name(english:"Mandrake Linux Security Advisory : dhcp (MDKSA-2004:061)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"dhcp-client-3.0-1.rc14.0.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", reference:"dhcp-common-3.0-1.rc14.0.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", reference:"dhcp-devel-3.0-1.rc14.0.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", reference:"dhcp-relay-3.0-1.rc14.0.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", reference:"dhcp-server-3.0-1.rc14.0.1.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"dhcp-client-3.0-1.rc14.0.1.92mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.2", reference:"dhcp-common-3.0-1.rc14.0.1.92mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.2", reference:"dhcp-devel-3.0-1.rc14.0.1.92mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.2", reference:"dhcp-relay-3.0-1.rc14.0.1.92mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.2", reference:"dhcp-server-3.0-1.rc14.0.1.92mdk", yank:"mdk")) flag++;
