...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:071. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:071");

  script_name(english:"Mandriva Linux Security Advisory : yaml (MDVSA-2014:071)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64yaml-devel-0.1.6-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64yaml0_2-0.1.6-1.mbs1")) flag++;
