...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:057. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:057");

  script_name(english:"Mandrake Linux Security Advisory : gnupg (MDKSA-2005:057)");
...
all public key-encrypted messages and files."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.pgp.com/library/ctocorner/openpgp.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"gnupg-1.2.4-1.1.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"gnupg-1.2.4-1.1.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"gnupg-1.2.3-3.2.92mdk", yank:"mdk")) flag++;
