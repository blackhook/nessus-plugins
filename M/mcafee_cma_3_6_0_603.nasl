...
the CMA Framework Service to crash.");
   # https://visibleprocrastinations.wordpress.com/2008/11/28/common-management-agent-3x-epolicy-orchestrator-agent-3x/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0d5d433c");
