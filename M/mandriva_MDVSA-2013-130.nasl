...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:130. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:130");
  script_xref(name:"MGASA", value:"2013-0097");

  script_name(english:"Mandriva Linux Security Advisory : stunnel (MDVSA-2013:130)");
...
The updated packages also fixes the following :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://wiki.mageia.org/en/Support/Advisories/MGAA-2012-0196"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"stunnel-4.55-1.mbs1")) flag++;
