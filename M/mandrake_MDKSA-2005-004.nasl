...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:004. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:004");

  script_name(english:"Mandrake Linux Security Advisory : nasm (MDKSA-2005:004)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"nasm-0.98.38-1.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", reference:"nasm-doc-0.98.38-1.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", reference:"nasm-rdoff-0.98.38-1.1.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"nasm-0.98.38-1.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"nasm-doc-0.98.38-1.1.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"nasm-rdoff-0.98.38-1.1.101mdk", yank:"mdk")) flag++;
