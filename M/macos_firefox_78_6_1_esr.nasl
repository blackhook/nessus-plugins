...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 78.6.1");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 78.6.1. It is, therefore, affected
by a vulnerability as referenced in the mfsa2021-01 advisory.
...
"Upgrade to Mozilla Firefox ESR version 78.6.1 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'78.6.1', min:'78.0.0', severity:SECURITY_WARNING);
