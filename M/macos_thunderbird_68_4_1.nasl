...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 68.4.1. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2020-04 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'68.4.1', xss:TRUE, severity:SECURITY_WARNING);
