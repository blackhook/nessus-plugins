...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:259. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:259");

  script_name(english:"Mandriva Linux Security Advisory : x11-server (MDVSA-2013:259)");
...
request that triggers memory-allocation failure (CVE-2013-4396)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0317.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-common-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-devel-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"x11-server-source-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-xdmx-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-xephyr-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-xfake-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-xfbdev-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-xnest-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-xorg-1.11.4-12.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"x11-server-xvfb-1.11.4-12.3.mbs1")) flag++;
