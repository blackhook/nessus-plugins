...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:038. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:038");

  script_name(english:"Mandrake Linux Security Advisory : sysklogd (MDKSA-2004:038)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"sysklogd-1.4.1-5.1.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"sysklogd-1.4.1-5.1.91mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"sysklogd-1.4.1-5.1.92mdk", yank:"mdk")) flag++;
