...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:010. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:010");

  script_name(english:"Mandrake Linux Security Advisory : mutt (MDKSA-2004:010)");
...
flag = 0;
if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"mutt-1.4.1i-1.2.91mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"mutt-1.4.1i-3.1.92mdk", yank:"mdk")) flag++;
