...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:211. 
...
if (description)
{
  ...
  script_bugtraq_id(61328);
  script_xref(name:"MDVSA", value:"2013:211");

  script_name(english:"Mandriva Linux Security Advisory : lcms2 (MDVSA-2013:211)");
...
cause Little CMS to crash (CVE-2013-4160)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0240.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected lcms2, lib64lcms2-devel and / or lib64lcms2_2
packages."
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lcms2-2.5-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64lcms2-devel-2.5-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64lcms2_2-2.5-1.mbs1")) flag++;
