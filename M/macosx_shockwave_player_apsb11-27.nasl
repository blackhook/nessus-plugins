...
if (description)
{
  ...
  script_name(english:"Adobe Shockwave Player <= 11.6.1.629 Multiple Memory Corruption Vulnerabilities (APSB11-27) (Mac OS X)");
...
that is 11.6.1.629 or earlier. It is, therefore, affected by multiple
...
"Upgrade to Adobe Shockwave 11.6.3.633 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2011-2449");
