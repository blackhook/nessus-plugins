...
# Mandriva Linux Security Advisory MDVA-2010:085.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2010:085 : dhcp");
...
in ldap support being non-functional. This update fixes the issue.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2010:085");
