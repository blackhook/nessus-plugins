...
# extracted from Mandrake Linux Security Advisory MDKSA-2001:016. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2001:016");

  script_name(english:"Mandrake Linux Security Advisory : webmin (MDKSA-2001:016)");
...
flag = 0;
if (rpm_check(release:"MDK7.1", reference:"webmin-0.84-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.2", reference:"webmin-0.84-1.1mdk", yank:"mdk")) flag++;
