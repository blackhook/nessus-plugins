...
"The version of Thunderbird installed on the remote Windows host is prior to 102.5.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2022-50 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'102.5.1', severity:SECURITY_HOLE);
