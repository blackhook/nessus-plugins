...
"The version of Thunderbird installed on the remote macOS or Mac OS X host is prior to 102.1. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2022-32 advisory.
...
mozilla_check_version(version:version, path:path, product:'thunderbird', esr:FALSE, fix:'102.1', severity:SECURITY_HOLE);
