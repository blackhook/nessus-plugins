...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mariadb-1074-release-notes");
...
mysql_check_version(variant: 'MariaDB', min:'10.7.0-MariaDB', fixed:make_list('10.7.4-MariaDB'), severity:SECURITY_WARNING);