...
# extracted from Mandrake Linux Security Advisory MDKSA-2001:084. 
...
if (description)
{
  ...
  script_cve_id("CVE-2001-1147");
  script_xref(name:"MDKSA", value:"2001:084");

  script_name(english:"Mandrake Linux Security Advisory : util-linux (MDKSA-2001:084)");
...
flag = 0;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"util-linux-2.10s-3.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.1", cpu:"i386", reference:"util-linux-2.11h-3.1mdk", yank:"mdk")) flag++;
