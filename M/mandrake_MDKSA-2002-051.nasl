...
# extracted from Mandrake Linux Security Advisory MDKSA-2002:051. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2002:051");

  script_name(english:"Mandrake Linux Security Advisory : xchat (MDKSA-2002:051)");
...
flag = 0;
if (rpm_check(release:"MDK7.1", cpu:"i386", reference:"xchat-1.8.9-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"xchat-1.8.9-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"xchat-1.8.9-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.1", cpu:"i386", reference:"xchat-1.8.9-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"xchat-1.8.9-1.1mdk", yank:"mdk")) flag++;
