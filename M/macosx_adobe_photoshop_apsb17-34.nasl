...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 18.x < 18.1.2 Multiple Vulnerabilities (APSB17-34) (macOS)");
...
Mac OS X host is 18.x prior to 18.1.2 (2017.1.2). It is, therefore,
affected by multiple vulnerabilities. This includes two remote code
...
"Upgrade to Adobe Photoshop CC version 18.1.2 (2017.1.2) or later.");
...
# version 18.x < 18.1.2 Vuln
if ( version =~ "^18\." )
  fix = '18.1.2';
else
  audit(AUDIT_NOT_INST, app + " 18.x");
