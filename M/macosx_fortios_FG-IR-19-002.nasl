...
# @DEPRECATED@
#
# Disabled on 2020/11/18. Deprecated by fortios_FG-IR-19-002.nasl
...
if (description)
{
  ...
  script_name(english:"Fortinet FortiOS (Mac OS X) < 5.2.15, 5.4.0 < 6.0.5 SSL VPN Web Portal Host Header Redirection (FG-IR-19-002) (deprecated)");
  script_summary(english:"Checks the version of FortiOS.");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"The plugin was deprecated due to checking hosts for FortiClient instead of FortiOS. Use fortios_FG-IR-19-002.nasl
(plugin ID 125889) instead.");
...
exit(0, 'This plugin has been deprecated. Use fortios_FG-IR-19-002.nasl (plugin ID 125889) instead.');
