...
if (description)
{
  ...
  script_cvs_date("$Date: 2017/06/09 22:01:14 $");

  script_name(english:"Mozilla Thunderbird 3.1.x < 3.1.14 Untrusted CA");
...
DigiNotar root certificate.");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Thunderbird 3.1.14 or later.");
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'3.1.14', min:'3.1.0', severity:SECURITY_WARNING);