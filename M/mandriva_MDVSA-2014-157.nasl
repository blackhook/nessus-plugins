...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:157. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:157");

  script_name(english:"Mandriva Linux Security Advisory : ipython (MDVSA-2014:157)");
...
(CVE-2014-3429)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0320.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:ipython");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"ipython-1.1.0-1.1.mbs1")) flag++;
