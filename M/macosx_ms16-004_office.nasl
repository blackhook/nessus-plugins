...
if (description)
{
  ...
  script_cve_id("CVE-2016-0010", "CVE-2016-0035");
  script_xref(name:"MSFT", value:"MS16-004");
  script_xref(name:"IAVA", value:"2016-A-0011-S");
  script_xref(name:"MSKB", value:"3133699");
  script_xref(name:"MSKB", value:"3133711");

  script_name(english:"MS16-004: Security Update for Microsoft Office to Address Remote Code Execution (3124585) (Mac OS X)");
...
"Microsoft has released patches for Office for Mac 2011 and Office 2016
for Mac.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0035");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:microsoft:powerpoint_for_mac:2016");
