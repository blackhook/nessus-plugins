...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:295. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:295");

  script_name(english:"Mandriva Linux Security Advisory : gnupg (MDVSA-2013:295)");
...
The updated packages have been patched to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.gnupg.org/pipermail/gnupg-devel/2013-December/028102.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"gnupg-1.4.12-3.3.mbs1")) flag++;
