...
if (description)
{
  ...
  script_name(english:"Firefox < 40.0.3 Multiple Vulnerabilities (Mac OS X)");
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:FALSE, fix:'40.0.3', severity:SECURITY_HOLE);
