...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:281. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:281");

  script_name(english:"Mandriva Linux Security Advisory : nginx (MDVSA-2013:281)");
...
have potential other impact (CVE-2013-4547)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0349.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"nginx-1.0.15-3.1.mbs1")) flag++;
