...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:042. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:042");

  script_name(english:"Mandrake Linux Security Advisory : gpdf (MDKSA-2005:042)");
...
(formerly CVE-2004-0888). This also affects applications like gpdf,
...
flag = 0;
if (rpm_check(release:"MDK10.0", cpu:"amd64", reference:"gpdf-0.112-2.6.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", cpu:"x86_64", reference:"gpdf-0.132-3.5.101mdk", yank:"mdk")) flag++;
