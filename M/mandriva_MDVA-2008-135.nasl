...
# Mandriva Linux Security Advisory MDVA-2008:135.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2008:135 : draksnapshot");
...
files");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2008:135");
...
if (rpm_check(reference:"draksnapshot-0.19-2.1mdv2008.1", release:"MDK2008.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"draksnapshot-0.19-2.1mdv2008.1", release:"MDK2008.1", cpu:"noarch", yank:"mdv")) flag++;
