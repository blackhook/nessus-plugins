...
if (description)
{
  ...
  script_cve_id("CVE-2019-3613");
  script_xref(name:"IAVA", value:"2020-A-0108");

  script_name(english:"McAfee Agent 5.5.x prior to 5.5.4 / 5.6.x prior to 5.6.4 DLL Search Order Hijacking (SB10320)");

  script_set_attribute(attribute:"synopsis", value:
"A security management agent installed on the remote host is affected by a DLL search order hijacking vulnerability.");
...
prior to 5.5.4 / 5.6.x prior to 5.6.4. It is, therefore, affected by a DLL search order hijacking vulnerability. 
it allows attackers with local access to execute arbitrary code via execution from a compromised folder.");
...
"Upgrade to McAfee Agent version 5.5.4, 5.6.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-3613");
...
var constraints = [
  { 'min_version' : '5.0.0', 'fixed_version' : '5.5.4'},
