...
packages."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2005/06/07");
...
flag = 0;
if (rpm_check(release:"MDK10.1", reference:"a2ps-4.13b-5.2.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"a2ps-devel-4.13b-5.2.101mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.1", reference:"a2ps-static-devel-4.13b-5.2.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"a2ps-4.13b-6.1.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"a2ps-devel-4.13b-6.1.102mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.2", reference:"a2ps-static-devel-4.13b-6.1.102mdk", yank:"mdk")) flag++;
