...
if (description)
{
  ...
  script_name(english:"Firefox ESR 31.x < 31.6 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'31.6', min:'31.0', severity:SECURITY_HOLE, xss:FALSE, xsrf:TRUE);
