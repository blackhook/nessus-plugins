...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:013. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:013");

  script_name(english:"Mandrake Linux Security Advisory : mailman (MDKSA-2004:013)");
...
'create' CGI script (CVE-2003-0992). This affects version 2.1 earlier
than 2.1.3."
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"mailman-2.0.14-1.1.91mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"mailman-2.1.2-9.3.92mdk", yank:"mdk")) flag++;
