...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 31.5 Multiple Vulnerabilities (Mac OS X)");
...
mozilla_check_version(product:'thunderbird', version:version, path:path, esr:FALSE, fix:'31.5', min:'31.0', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
