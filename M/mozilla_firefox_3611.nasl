...
if (description)
{
  ...
  script_name(english:"Firefox 3.6 < 3.6.11 Multiple Vulnerabilities");
...
"The installed version of Firefox 3.6 is earlier than 3.6.11.  Such
versions are potentially affected by the following security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 3.6.11 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.6.11', min:'3.6', severity:SECURITY_HOLE);