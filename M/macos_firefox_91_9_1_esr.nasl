...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 91.9.1. It is, therefore, affected
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'91.9.1', min:'91.0.0', severity:SECURITY_HOLE);
