...
if (description)
{
  ...
  script_name(english:"MySQL Cluster 7.3.x < 7.3.17 DD Subcomponent Arbitrary Data Manipulation (April 2017 CPU)");
...
of service condition.");
  # https://dev.mysql.com/doc/relnotes/mysql-cluster/7.3/en/mysql-cluster-news-7-3-17.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ff9301b1");
...
mysql_check_version(variant:'Cluster', fixed:'7.3.17', min:'7.3', severity:SECURITY_WARNING);
