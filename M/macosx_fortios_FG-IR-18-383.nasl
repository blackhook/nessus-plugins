...
# @DEPRECATED@
#
# Disabled on 2020/11/18. Deprecated by fortios_FG-IR-18-383.nasl
...
if (description)
{
  ...
  script_name(english:"Fortinet FortiOS (Mac OS X) 5.6.0 < 5.6.8 / 6.0.x < 6.0.5 multiple pre-auth XSS vulnerabilities on SSL VPN (FG-IR-18-383) (deprecated)");
  script_summary(english:"Checks the version of FortiOS.");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"The plugin was deprecated due to checking hosts for FortiClient instead of FortiOS. Use fortios_FG-IR-18-383.nasl
(plugin ID 128278) instead.");
...
exit(0, 'This plugin has been deprecated. Use fortios_FG-IR-18-383.nasl (plugin ID 128278) instead.');
