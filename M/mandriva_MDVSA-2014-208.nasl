...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:208. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:208");

  script_name(english:"Mandriva Linux Security Advisory : phpmyadmin (MDVSA-2014:208)");
...
(CVE-2014-8326)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0420.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"phpmyadmin-4.2.10.1-1.mbs1")) flag++;
