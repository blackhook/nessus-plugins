...
reportedly affected by several critical vulnerabilities :
  ...
  # https://github.com/deyu260/blog-1/blob/master/flashplayer_crash_on_netstream_play.md
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bc89ef3e");
  script_set_attribute(
    attribute:"see_also", 
