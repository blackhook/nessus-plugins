...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:105. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : fetchmail (MDKSA-2007:105)");
...
no longer be considered secure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.fetchmail.info/fetchmail-SA-2007-01.txt"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"fetchmail-6.3.4-3.2mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"fetchmail-daemon-6.3.4-3.2mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"fetchmailconf-6.3.4-3.2mdv2007.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2007.1", reference:"fetchmail-6.3.6-1.1mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"fetchmail-daemon-6.3.6-1.1mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"fetchmailconf-6.3.6-1.1mdv2007.1", yank:"mdv")) flag++;
