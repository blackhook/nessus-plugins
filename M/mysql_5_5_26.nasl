...
if (description)
{
  ...
  script_bugtraq_id(56013, 56018, 56028, 56041);
  
  script_name(english:"MySQL 5.5 < 5.5.26 Multiple Vulnerabilities");
...
5.5.26 and is, therefore, affected by vulnerabilities in the following
components :
  ...
  script_set_attribute(attribute:"see_also", value:"http://dev.mysql.com/doc/refman/5.5/en/news-5-5-26.html");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to MySQL version 5.5.26 or later.");
...
mysql_check_version(fixed:'5.5.26', min:'5.5', severity:SECURITY_WARNING);
