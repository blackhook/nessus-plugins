...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:198. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:198");

  script_name(english:"Mandriva Linux Security Advisory : java-1.8.0-openjdk (MDVSA-2015:198)");
...
The updated packages provides a solution for these security issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4ee64ad9"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:0069"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:java-1.8.0-openjdk");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:java-1.8.0-openjdk-accessibility");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:java-1.8.0-openjdk-demo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:java-1.8.0-openjdk-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:java-1.8.0-openjdk-headless");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:java-1.8.0-openjdk-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:java-1.8.0-openjdk-src");
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"java-1.8.0-openjdk-1.8.0.40-5.b25.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"java-1.8.0-openjdk-accessibility-1.8.0.40-5.b25.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"java-1.8.0-openjdk-demo-1.8.0.40-5.b25.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"java-1.8.0-openjdk-devel-1.8.0.40-5.b25.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"java-1.8.0-openjdk-headless-1.8.0.40-5.b25.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", reference:"java-1.8.0-openjdk-javadoc-1.8.0.40-5.b25.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"java-1.8.0-openjdk-src-1.8.0.40-5.b25.1.mbs2")) flag++;
