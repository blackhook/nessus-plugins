...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Office (January 2021) (macOS)");
...
multiple remote code execution vulnerabilities in Word and Excel.
...
number.");
  ...
  # https://docs.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#january-13-2021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d578d8a");
...
apps = make_list('Microsoft Word', 'Microsoft Excel');
report = '';

#2019
min_ver_19 = '16.17.0';
fix_ver_19 = '16.45';
fix_disp_19 = '16.45 (21011103)';
