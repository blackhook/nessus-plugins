...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:108. 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-2856", "CVE-2014-3537", "CVE-2014-5029", "CVE-2014-5030", "CVE-2014-5031", "CVE-2014-9679");
  script_xref(name:"MDVSA", value:"2015:108");

  script_name(english:"Mandriva Linux Security Advisory : cups (MDVSA-2015:108)");
...
(CVE-2014-9679)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0313.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0067.html"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:cups-filesystem");
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"cups-1.7.0-8.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"cups-common-1.7.0-8.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", reference:"cups-filesystem-1.7.0-8.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"lib64cups2-1.7.0-8.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"lib64cups2-devel-1.7.0-8.1.mbs2")) flag++;
