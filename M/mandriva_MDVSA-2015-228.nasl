...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:228. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:228");

  script_name(english:"Mandriva Linux Security Advisory : nodejs (MDVSA-2015:228)");
...
other bugs."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0186.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"nodejs-0.10.38-1.mbs2")) flag++;
