...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1067-rn");
...
mysql_check_version(variant: 'MariaDB', min:'10.6.0-MariaDB', fixed:make_list('10.6.7-MariaDB'), severity:SECURITY_NOTE);