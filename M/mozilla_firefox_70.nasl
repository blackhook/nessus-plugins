...
if (description)
{
  ...
  script_name(english:"Firefox < 7.0 Multiple Vulnerabilities");
...
potentially affected by the following security issues :
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 7 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'7.0', skippat:'^3\\.6\\.', severity:SECURITY_HOLE);