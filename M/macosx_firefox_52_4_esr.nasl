...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 52.4 Multiple Vulnerabilities (macOS)");
...
Mac OS X host is prior to 52.4. It is, therefore, affected by multiple vulnerabilities,
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'52.4', min:'52', severity:SECURITY_HOLE);
