...
if (description)
{
  ...
  script_name(english:"Thunderbird ESR 17.x < 17.0.3 Multiple Vulnerabilities (Mac OS X)");
...
mozilla_check_version(product:'thunderbird', version:version, path:path, esr:TRUE, fix:'17.0.3', min:'17.0', severity:SECURITY_HOLE);