...
"The version of Google Chrome installed on the remote macOS host is prior to 108.0.5359.124. It is, therefore, affected
...
google_chrome_check_version(fix:'108.0.5359.124', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
