...
# extracted from Mandrake Linux Security Advisory MDKSA-2000:052. 
...
if (description)
{
  ...
  script_cve_id("CVE-2000-1059");
  script_xref(name:"MDKSA", value:"2000:052");

  script_name(english:"Mandrake Linux Security Advisory : xinitrc (MDKSA-2000:052)");
...
logins or multiple users."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected xinitrc package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:xinitrc");
...
flag = 0;
if (rpm_check(release:"MDK7.0", reference:"xinitrc-2.4.4-11mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.1", reference:"xinitrc-2.4.4-24mdk", yank:"mdk")) flag++;
