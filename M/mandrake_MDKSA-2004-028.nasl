...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:028. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:028");

  script_name(english:"Mandrake Linux Security Advisory : cvs (MDKSA-2004:028)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", cpu:"i386", reference:"cvs-1.11.14-0.1.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"cvs-1.11.14-0.1.91mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"cvs-1.11.14-0.1.92mdk", yank:"mdk")) flag++;
