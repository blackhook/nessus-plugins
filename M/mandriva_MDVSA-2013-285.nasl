...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:285. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:285");

  script_name(english:"Mandriva Linux Security Advisory : bugzilla (MDVSA-2013:285)");
...
sortkey parameter (CVE-2013-1742).
...
CVE-2012-4189 (CVE-2013-1743).

The updated packages have been upgraded to the 4.2.7 version which is
not affected by these issues."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.bugzilla.org/releases/4.2.6/release-notes.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.bugzilla.org/releases/4.2.7/release-notes.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"bugzilla-4.2.7-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"bugzilla-contrib-4.2.7-1.mbs1")) flag++;
