...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:070. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:070");
  script_xref(name:"MGASA", value:"2012-0282");

  script_name(english:"Mandriva Linux Security Advisory : dbus (MDVSA-2013:070)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"dbus-1.4.16-6.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"dbus-doc-1.4.16-6.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"dbus-x11-1.4.16-6.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64dbus-1-devel-1.4.16-6.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64dbus-1_3-1.4.16-6.1.mbs1")) flag++;
