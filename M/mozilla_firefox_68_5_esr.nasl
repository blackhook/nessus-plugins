...
# extracted from Mozilla Foundation Security Advisory mfsa2020-06.
...
"The version of Firefox installed on the remote Windows host is prior to 68.5. It is, therefore, affected by multiple
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'68.5', severity:SECURITY_WARNING);
