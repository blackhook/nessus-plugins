...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1063-rn");
...
mysql_check_version(variant: 'MariaDB', min:'10.6.0-MariaDB', fixed:make_list('10.6.3-MariaDB'), severity:SECURITY_WARNING);