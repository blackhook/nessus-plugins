...
# extracted from Mandriva Linux Security Advisory MDVSA-2008:175. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : yelp (MDVSA-2008:175)");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"yelp-2.20.0-3.7mdv2008.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2008.1", reference:"yelp-2.22.0-2.4mdv2008.1", yank:"mdv")) flag++;
