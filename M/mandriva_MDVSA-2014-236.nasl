...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:236. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:236");

  script_name(english:"Mandriva Linux Security Advisory : file (MDVSA-2014:236)");
...
This could possibly lead to file executable crash (CVE-2014-3710)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0439.html"
  );
  ...
  script_set_attribute(attribute:"plugin_publication_date", value:"2014/11/30");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"file-5.12-1.6.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64magic-devel-5.12-1.6.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64magic-static-devel-5.12-1.6.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64magic1-5.12-1.6.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"python-magic-5.12-1.6.mbs1")) flag++;
