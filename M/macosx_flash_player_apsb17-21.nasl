...
if (description)
{
  ...
  script_name(english:"Adobe Flash Player for Mac <= 26.0.0.131 Multiple Vulnerabilities (APSB17-21)");
...
OS X host is equal or prior to version 26.0.0.131. It is, therefore,
