...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:138. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:138");

  script_name(english:"Mandriva Linux Security Advisory : patch (MDVSA-2015:138)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"patch-2.7.4-1.mbs2")) flag++;
