...
therefore, affected by multiple vulnerabilities as referenced in the apsb21-28 advisory. Note that Nessus has not tested
...
constraints = [
  { 'min_version' : '21.0.0', 'max_version' : '21.2.6', 'fixed_version' : '21.2.7' },
  { 'min_version' : '22.0.0', 'max_version' : '22.3.0', 'fixed_version' : '22.3.1' }
];
