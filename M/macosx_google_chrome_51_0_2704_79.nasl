...
if (description)
{
  ...
  script_name(english:"Google Chrome < 51.0.2704.79 Multiple Vulnerabilities (Mac OS X)");
...
google_chrome_check_version(fix:'51.0.2704.79', severity:SECURITY_WARNING);
