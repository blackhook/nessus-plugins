...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:231. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:231");

  script_name(english:"Mandrake Linux Security Advisory : gdm (MDKSA-2006:231)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"gdm-2.16.0-2.1mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"gdm-Xnest-2.16.0-2.1mdv2007.0", yank:"mdv")) flag++;
