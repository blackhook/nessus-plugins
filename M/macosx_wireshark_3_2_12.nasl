...
if (description)
{
  ...
  script_name(english:"Wireshark 3.2.x < 3.2.12 A Vulnerability (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS / Mac OS X host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Wireshark installed on the remote macOS / Mac OS X host is prior to 3.2.12. It is, therefore, affected by
a vulnerability as referenced in the wireshark-3.2.12 advisory.
