...
the following components :
  ...
  - Server Privileges
  - Server Replication");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-5167-release-notes/");
  script_set_attribute(attribute:"see_also", value:"http://dev.mysql.com/doc/refman/5.1/en/news-5-1-67.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 5.1.67 or later.");
...
mysql_check_version(variant:'MariaDB', fixed:'5.1.67-MariaDB', min:'5.1', severity:SECURITY_WARNING);
