...
if (description)
{
  ...
  script_name(english:"Splunk Enterprise 8.1.x < 8.1.7.2 / 8.2.x < 8.2.3.3 Log4j (macOS)");
...
"Upgrade Splunk Enterprise to version 8.1.7.2, 8.2.3.2, 8.2.4, or later.");
  ...
  script_dependencies("macos_splunk_installed.nbin");
  script_require_keys("installed_sw/Splunk", "Host/MacOSX/Version");
...
if (!get_kb_item('Host/MacOSX/Version'))
  audit(AUDIT_OS_NOT, 'macOS / Mac OS X');
...
# dfs not enabled, report not vuln
else {
