...
"The version of Google Chrome installed on the remote macOS host is prior to 84.0.4147.125. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2020_08_stable-channel-update-for-desktop advisory. Note that Nessus has
...
google_chrome_check_version(fix:'84.0.4147.125', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
