...
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 82.0.3. It is, therefore, affected by
a vulnerability as referenced in the mfsa2020-49 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'82.0.3', severity:SECURITY_HOLE);
