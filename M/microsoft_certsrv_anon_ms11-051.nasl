...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"2518295");
...
client-side script into the user's web browser instance.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2011/ms11-051");
