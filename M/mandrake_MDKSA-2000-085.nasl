...
# extracted from Mandrake Linux Security Advisory MDKSA-2000:085. 
...
if (description)
{
  ...
  script_cve_id("CVE-2001-0066");
  script_xref(name:"MDKSA", value:"2000:085");

  script_name(english:"Mandrake Linux Security Advisory : slocate (MDKSA-2000:085)");
...
flag = 0;
if (rpm_check(release:"MDK6.0", cpu:"i386", reference:"slocate-2.4-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK6.1", cpu:"i386", reference:"slocate-2.4-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.0", cpu:"i386", reference:"slocate-2.4-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.1", cpu:"i386", reference:"slocate-2.4-1.2mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"slocate-2.4-1.1mdk", yank:"mdk")) flag++;
