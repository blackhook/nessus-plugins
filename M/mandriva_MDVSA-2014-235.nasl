...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:235. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:235");

  script_name(english:"Mandriva Linux Security Advisory : perl-Plack (MDVSA-2014:235)");
...
whitelist of generated files (CVE-2014-5269)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0486.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:perl-Plack");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"perl-Plack-0.998.500-3.1.mbs1")) flag++;
