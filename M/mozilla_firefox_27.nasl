...
if (description)
{
  ...
  script_name(english:"Firefox < 27.0 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'27.0', severity:SECURITY_HOLE, xss:FALSE);
