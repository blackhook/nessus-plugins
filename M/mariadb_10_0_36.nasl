...
if (description)
{
  ...
  script_bugtraq_id(104766, 104776, 104786);

  script_name(english:"MariaDB 10.0.0 < 10.0.36 Multiple Vulnerabilities");
...
10.0.36. It is, therefore, affected by multiple vulnerabilities as
referenced in the mdb-10036-rn advisory.
  ...
  to some of accessible data. (CVE-2018-3058, CVE-2018-3066)
...
self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-10036-rn");
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-14693");
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-15953");
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-16119");
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-16124");
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-16267");
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-16456");
  ...
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-16851");
  script_set_attribute(attribute:"see_also", value:"https://jira.mariadb.org/browse/MDEV-16855");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MariaDB version 10.0.36 or later.");
...
mysql_check_version(variant: 'MariaDB', min:'10.0.0-MariaDB', fixed:make_list('10.0.36-MariaDB'), severity:SECURITY_WARNING);