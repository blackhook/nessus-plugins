...
# extracted from Mandrake Linux Security Advisory MDKSA-2000:028. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2000:028");

  script_name(english:"Mandrake Linux Security Advisory : kon2 (MDKSA-2000:028)");
...
code into the stack, thus spawning a root shell."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:kon2");
...
flag = 0;
if (rpm_check(release:"MDK7.0", cpu:"i386", reference:"kon2-0.3.8-15mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.1", cpu:"i386", reference:"kon2-0.3.8-15mdk", yank:"mdk")) flag++;
