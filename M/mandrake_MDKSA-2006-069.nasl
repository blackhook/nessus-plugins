...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:069. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:069");

  script_name(english:"Mandrake Linux Security Advisory : openvpn (MDKSA-2006:069)");
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"openvpn-2.0.1-2.2.20060mdk", yank:"mdk")) flag++;
