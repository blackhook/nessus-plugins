...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:096. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:096");

  script_name(english:"Mandriva Linux Security Advisory : python-jinja2 (MDVSA-2014:096)");
...
(CVE-2014-1402)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0028.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:python-jinja2");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"python-jinja2-2.5.5-8.1.mbs1")) flag++;
