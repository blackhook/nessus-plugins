...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:035. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:035");

  script_name(english:"Mandriva Linux Security Advisory : libvirt (MDVSA-2015:035)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64virt-devel-1.1.3.8-1.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64virt0-1.1.3.8-1.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"libvirt-utils-1.1.3.8-1.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"python-libvirt-1.1.3.8-1.2.mbs1")) flag++;
