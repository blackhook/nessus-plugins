...
if (description)
{
  ...
  script_name(english:"Firefox ESR 24.x < 24.8.1 NSS Signature Verification Vulnerability");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'24.8.1', min:'24.0', severity:SECURITY_HOLE, xss:FALSE);
