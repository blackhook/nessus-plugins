...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird ESR 17.x < 17.0.9 Multiple Vulnerabilities");
...
"The installed version of Thunderbird ESR 17.x is earlier than 17.0.9
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:TRUE, fix:'17.0.9', min:'17.0', severity:SECURITY_HOLE, xss:FALSE);
