...
if (description)
{
  ...
  script_cve_id("CVE-2016-5612", "CVE-2016-6662");
...
5.5.51. It is, therefore, affected by multiple vulnerabilities:
  ...
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-5551-changelog/");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-5551-release-notes/");
