...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Office Products (July 2020) (macOS)");
...
therefore, affected by multiple vulnerabilities:
  ...
  - An information disclosure vulnerability exists when Microsoft Office software reads out of bound memory
    due to an uninitialized variable, which could disclose the contents of memory. An attacker who
    successfully exploited the vulnerability could view out of bound memory. (CVE-2020-1342)
  
  - A remote code execution vulnerability exists in the way that DirectWrite handles objects in memory. An
    attacker who successfully exploited this vulnerability could take control of the affected system. An
    attacker could then install programs; view, change, or delete data; or create new accounts with full user
    rights. (CVE-2020-1409)
  
  - An information disclosure vulnerability exists when Microsoft Office improperly discloses the contents of
  ...
  - A remote code execution vulnerability exists in Microsoft Word software when it fails to properly handle
    ...
    actions on behalf of the logged-on user with the same permissions as the current user. (CVE-2020-1446,
    CVE-2020-1447)");
  ...
  # https://docs.microsoft.com/en-us/officeupdates/release-notes-office-for-mac#july-14-2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7e189d9e");
  # https://docs.microsoft.com/en-us/officeupdates/release-notes-office-2016-mac#july-2020-release
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4dc744c6");
...
"Microsoft has released a set of patches for Microsoft Office for Mac.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-1409");
...
min_ver_16 = '16';
fix_ver_16 = '16.16.24';
fix_disp_16 = '16.16.24 (20071300)';

#2019
min_ver_19 = '16.17.0';
fix_ver_19 = '16.39';
fix_disp_19 = '16.39 (20071300)';
