...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 17.0 Multiple Vulnerabilities");
...
"The installed version of Thunderbird is earlier than 17.0 and thus,
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'17.0', severity:SECURITY_HOLE, xss:TRUE, xsrf:TRUE);
