...
if (description)
{
  ...
  script_name(english:"Firefox ESR 24.x < 24.8.1 NSS Signature Verification Vulnerability (Mac OS X)");
...
"Upgrade to Firefox ESR 24.8.1 or later.");
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:TRUE, fix:'24.8.1', min:'24.0', severity:SECURITY_HOLE, xss:FALSE);
