...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:083. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:083");

  script_name(english:"Mandrake Linux Security Advisory : gdm (MDKSA-2006:083)");
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"gdm-2.8.0.4-1.1.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", reference:"gdm-Xnest-2.8.0.4-1.1.20060mdk", yank:"mdk")) flag++;
