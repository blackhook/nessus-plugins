...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:201. 
...
if (description)
{
  ...
  script_cve_id("CVE-2006-5170", "CVE-2006-5379");
  script_bugtraq_id(20880);
  script_xref(name:"MDKSA", value:"2006:201");

  script_name(english:"Mandrake Linux Security Advisory : pam_ldap (MDKSA-2006:201)");
...
Updated packages have been patched to correct this issue."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected pam_ldap package."
  );
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"pam_ldap-180-2.1.20060mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2007.0", reference:"pam_ldap-180-4.1mdv2007.0", yank:"mdv")) flag++;
