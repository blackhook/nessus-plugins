...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:244. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:244");

  script_name(english:"Mandriva Linux Security Advisory : davfs2 (MDVSA-2013:244)");
...
The updated packages have been patched to correct this issue."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:davfs2");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"davfs2-1.4.6-2.1.mbs1")) flag++;
