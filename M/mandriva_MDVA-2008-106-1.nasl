...
# Mandriva Linux Security Advisory MDVA-2008:106-1.
#
...
built against the old OpenOffice.org. This update fixes that.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2008:106-1");
...
if (rpm_check(reference:"openoffice.org-voikko-2.2-4.4mdv2008.1", release:"MDK2008.1", cpu:"i386", yank:"mdv")) flag++;

if (rpm_check(reference:"openoffice.org64-voikko-2.2-4.4mdv2008.1", release:"MDK2008.1", cpu:"x86_64", yank:"mdv")) flag++;
