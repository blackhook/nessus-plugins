...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:089. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:089");

  script_name(english:"Mandrake Linux Security Advisory : kphone (MDKSA-2006:089)");
...
Packages have been patched to correct this issue."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:kphone");
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"kphone-4.2-5.1.20060mdk", yank:"mdk")) flag++;
