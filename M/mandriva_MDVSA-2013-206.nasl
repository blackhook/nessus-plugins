...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:206. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:206");

  script_name(english:"Mandriva Linux Security Advisory : owncloud (MDVSA-2013:206)");
...
This update provides OwnCloud 5.0.9, which fixes these issues, as well
as several other bugs."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0220.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"owncloud-5.0.9-1.1.mbs1")) flag++;
