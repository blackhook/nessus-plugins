...
if (description)
{
  ...
  script_name(english:"MariaDB 5.1 < 5.1.69 NAME_CONST Query DoS");
...
"The version of MariaDB 5.1 running on the remote host is a version
prior to 5.1.69. It is, therefore, potentially affected by a denial of
...
"Upgrade to MariaDB version 5.1.69 or later. Alternatively, apply the
...
mysql_check_version(variant:'MariaDB', fixed:'5.1.69-MariaDB', min:'5.1', severity:SECURITY_WARNING);
