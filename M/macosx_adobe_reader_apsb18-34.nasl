...
if (description)
{
  ...
  script_name(english:"Adobe Reader <= 15.006.30448 / 17.011.30099 / 18.011.20058 Multiple Vulnerabilities (APSB18-34) (macOS)");
...
"Upgrade to Adobe Reader 15.006.30452 / 17.011.30102 / 18.011.20063 or later.");
...
{
  constraints = [
    { "min_version" : "17.8", "max_version":"17.011.30096", "fixed_version" : "17.011.30102" }
  ];
}
else
{
  constraints = [
    { "min_version" : "15.6", "max_version":"15.006.30434", "fixed_version" : "15.006.30452" },
    { "min_version" : "18.8", "max_version":"18.011.20055", "fixed_version" : "18.011.20063" }
  ];
}
