...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:013. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:013");

  script_name(english:"Mandriva Linux Security Advisory : libxfont (MDVSA-2014:013)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64xfont1-1.4.5-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64xfont1-devel-1.4.5-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64xfont1-static-devel-1.4.5-2.1.mbs1")) flag++;
