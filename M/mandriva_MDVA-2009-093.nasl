...
# Mandriva Linux Security Advisory MDVA-2009:093.
#
...
the problem making ipset work fine.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2009:093");
...
if (rpm_check(reference:"ipset-2.3.3a-1.2mdv2009.0", release:"MDK2009.0", cpu:"i386", yank:"mdv")) flag++;

if (rpm_check(reference:"ipset-2.3.3a-1.2mdv2009.0", release:"MDK2009.0", cpu:"x86_64", yank:"mdv")) flag++;
