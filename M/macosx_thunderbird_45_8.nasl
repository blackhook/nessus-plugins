...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 45.8 Multiple Vulnerabilities (macOS)");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', fix:'45.8', severity:SECURITY_HOLE);
