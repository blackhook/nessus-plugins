...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:017. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:017");

  script_name(english:"Mandrake Linux Security Advisory : xpdf (MDKSA-2005:017)");
  ...
  script_set_attribute(
    ...
    value:
"A buffer overflow vulnerability was discovered in the xpdf PDF viewer,
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"xpdf-3.00-5.4.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"xpdf-3.00-7.3.101mdk", yank:"mdk")) flag++;
