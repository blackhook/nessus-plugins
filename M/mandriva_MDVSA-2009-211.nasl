...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:211. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:211-1");

  script_name(english:"Mandriva Linux Security Advisory : expat (MDVSA-2009:211-1)");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"expat-2.0.1-4.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64expat1-2.0.1-4.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64expat1-devel-2.0.1-4.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libexpat1-2.0.1-4.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libexpat1-devel-2.0.1-4.1mdv2008.0", yank:"mdv")) flag++;
