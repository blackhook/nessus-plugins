...
if (description)
{
  ...
  script_name(english:"Wireshark 2.2.x < 2.2.13 / 2.4.x < 2.4.5 Multiple DoS Vulnerabilities (MacOS)");
...
is 2.2.x prior to 2.2.13 or 2.4.x prior to 2.4.5. It is, therefore, 
