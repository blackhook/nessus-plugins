...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:011. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:011");

  script_name(english:"Mandriva Linux Security Advisory : nail (MDVSA-2015:011)");
...
(CVE-2004-2771, CVE-2014-7844)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0538.html"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected nail package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:nail");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"nail-12.4-8.1.mbs1")) flag++;
