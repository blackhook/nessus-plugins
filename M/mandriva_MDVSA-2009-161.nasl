...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:161. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:161-1");

  script_name(english:"Mandriva Linux Security Advisory : squid (MDVSA-2009:161-1)");
...
Upstream Bug 2728: regression: assertion failed: http.cc:705: !eof"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.squid-cache.org/Advisories/SQUID-2009_2.txt"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK2008.1", reference:"squid-3.0-1.3mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"squid-cachemgr-3.0-1.3mdv2008.1", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2009.0", reference:"squid-3.0-8.3mdv2009.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.0", reference:"squid-cachemgr-3.0-8.3mdv2009.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2009.1", reference:"squid-3.0-14.2mdv2009.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.1", reference:"squid-cachemgr-3.0-14.2mdv2009.1", yank:"mdv")) flag++;
