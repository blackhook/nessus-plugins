...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:292. 
...
if (description)
{
  ...
  script_bugtraq_id(36591, 36846);
  script_xref(name:"MDVSA", value:"2009:292-1");

  script_name(english:"Mandriva Linux Security Advisory : wireshark (MDVSA-2009:292-1)");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"dumpcap-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64wireshark-devel-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64wireshark0-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libwireshark-devel-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libwireshark0-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"rawshark-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"tshark-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"wireshark-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"wireshark-tools-1.0.10-0.1mdv2008.0", yank:"mdv")) flag++;
