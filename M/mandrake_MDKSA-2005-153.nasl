...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:153. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:153");

  script_name(english:"Mandrake Linux Security Advisory : gnumeric (MDKSA-2005:153)");
...
flag = 0;
if (rpm_check(release:"MDK10.1", reference:"gnumeric-1.2.13-3.1.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"gnumeric-1.4.2-1.1.102mdk", yank:"mdk")) flag++;
