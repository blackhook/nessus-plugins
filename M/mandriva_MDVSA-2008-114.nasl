...
# extracted from Mandriva Linux Security Advisory MDVSA-2008:114. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : util-linux-ng (MDVSA-2008:114)");
...
hide activities by modifying portions of log events.
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"util-linux-ng-2.13-3.4mdv2008.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2008.1", reference:"util-linux-ng-2.13.1-5.1mdv2008.1", yank:"mdv")) flag++;
