...
if (description)
{
  ...
  script_cve_id("CVE-2023-21719");
  script_xref(name:"IAVA", value:"2023-A-0051-S");

  script_name(english:"Microsoft Edge (Chromium) < 109.0.1518.61 Security Feature Bypass (CVE-2023-21719)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has an web browser installed that is affected by security feature bypass.");
  script_set_attribute(attribute:"description", value:
"The version of Microsoft Edge installed on the remote Windows host is prior to 109.0.1518.61. It is, therefore, affected
by a vulnerability as referenced in the January 19, 2023 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://msrc.microsoft.com/update-guide/vulnerability/CVE-2023-21719");
...
"Upgrade to Microsoft Edge version 109.0.1518.61 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2023-21719");
