...
if (description)
{
  ...
  script_name(english:"Adobe InDesign < 17.4.1 / 18.0 < 18.2 Application denial-of-service (APSB23-12) (macOS)");
...
"The version of Adobe InDesign installed on the remote macOS host is prior to 17.4.1, 18.2. It is, therefore, affected by
a vulnerability as referenced in the APSB23-12 advisory.
