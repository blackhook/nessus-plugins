...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:101. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:101");

  script_name(english:"Mandrake Linux Security Advisory : tcpdump (MDKSA-2005:101)");
...
flag = 0;
if (rpm_check(release:"MDK10.1", reference:"tcpdump-3.8.3-2.2.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"tcpdump-3.8.3-2.2.102mdk", yank:"mdk")) flag++;
