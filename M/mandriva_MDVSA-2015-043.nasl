...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:043. 
...
if (description)
{
  ...
  script_bugtraq_id(71989);
  script_xref(name:"MDVSA", value:"2015:043");

  script_name(english:"Mandriva Linux Security Advisory : otrs (MDVSA-2015:043)");
...
webservice is configured and not additionally secured (CVE-2014-9324)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0031.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"otrs-3.2.17-1.mbs1")) flag++;
