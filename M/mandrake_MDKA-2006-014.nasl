...
# Mandrake Linux Security Advisory MDKA-2006:014.
#
...
when the Palm was unplugged. Now, this file is not longer created. If
the symlink is already on the user's system, it can safely be removed
manually.

Updated packages have been patched to correct the issue.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDKA-2006:014");
...
if (rpm_check(reference:"dynamic-0.26.2-1.1.20060mdk", release:"MDK2006.0", cpu:"noarch", yank:"mdk")) flag++;
