...
information could be used to mount further attacks."
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2012/Dec/9");
...
{
  enumerated_users = join(enumerated_users, sep:'\n');
  enumerated_users = data_protection::sanitize_user_enum(users:enumerated_users);
  report =
