...
"The version of Google Chrome installed on the remote macOS host is prior to 75.0.3770.142. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2019_07_stable-channel-update-for-desktop advisory. Note that Nessus has
...
google_chrome_check_version(fix:'75.0.3770.142', severity:SECURITY_WARNING);
