...
# extracted from Mandrake Linux Security Advisory MDKSA-2003:088. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2003:088");

  script_name(english:"Mandrake Linux Security Advisory : pam_ldap (MDKSA-2003:088)");
...
upgrade immediately."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2003/09/02");
...
flag = 0;
if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"nss_ldap-207-1.1mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"pam_ldap-164-1.1mdk", yank:"mdk")) flag++;
