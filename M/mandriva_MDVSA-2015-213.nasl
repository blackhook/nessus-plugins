...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:213. 
...
if (description)
{
  ...
  script_bugtraq_id(66458);
  script_xref(name:"MDVSA", value:"2015:213");

  script_name(english:"Mandriva Linux Security Advisory : lftp (MDVSA-2015:213)");
...
lftp incorrectly validates wildcard SSL certificates containing
...
SSL certificates. The curl package was fixed in MDVSA-2015:098."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0165.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected lftp, lib64lftp-devel and / or lib64lftp0
packages."
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lftp-4.3.5-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64lftp-devel-4.3.5-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64lftp0-4.3.5-2.1.mbs1")) flag++;
