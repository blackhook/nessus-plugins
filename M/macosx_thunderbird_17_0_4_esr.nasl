...
if (description)
{
  ...
  script_name(english:"Thunderbird ESR 17.x < 17.0.4 nsHTMLEditor Use-After-Free (Mac OS X)");
...
affected by a use-after-free vulnerability."
  ...
  script_set_attribute(
    ...
    value:
"The installed version of Thunderbird ESR 17.x is potentially affected a
...
mozilla_check_version(product:'thunderbird', version:version, path:path, esr:TRUE, fix:'17.0.4', min:'17.0', severity:SECURITY_HOLE);
