...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:136. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:136");

  script_name(english:"Mandriva Linux Security Advisory : perl (MDVSA-2015:136)");
...
lead to a code path that shouldn't be hit. This can lead to crashes in
other software, such as Bugzilla.
...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0406.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"perl-5.18.1-5.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"perl-base-5.18.1-5.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"perl-devel-5.18.1-5.1.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", reference:"perl-doc-5.18.1-5.1.mbs2")) flag++;
