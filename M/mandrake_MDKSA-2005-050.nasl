...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:050. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:050");

  script_name(english:"Mandrake Linux Security Advisory : gftp (MDKSA-2005:050)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"gftp-2.0.16-4.1.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"gftp-2.0.17-4.1.101mdk", yank:"mdk")) flag++;
