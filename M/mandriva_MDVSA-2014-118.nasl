...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:118. 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3421", "CVE-2014-3422", "CVE-2014-3423");
  script_bugtraq_id(67253);
  script_xref(name:"MDVSA", value:"2014:118");

  script_name(english:"Mandriva Linux Security Advisory : emacs (MDVSA-2014:118)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-23.3-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-common-23.3-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-doc-23.3-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"emacs-el-23.3-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-leim-23.3-9.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-nox-23.3-9.2.mbs1")) flag++;
