...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:043. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:043");

  script_name(english:"Mandriva Linux Security Advisory : gnutls (MDVSA-2014:043)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"gnutls-3.0.28-1.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64gnutls-devel-3.0.28-1.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64gnutls-ssl27-3.0.28-1.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64gnutls28-3.0.28-1.1.mbs1")) flag++;
