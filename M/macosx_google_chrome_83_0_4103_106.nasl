...
"The version of Google Chrome installed on the remote macOS host is prior to 83.0.4103.106. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2020_06_stable-channel-update-for-desktop_15 advisory. Note that Nessus
...
google_chrome_check_version(fix:'83.0.4103.106', severity:SECURITY_WARNING, xss:FALSE, xsrf:FALSE);
