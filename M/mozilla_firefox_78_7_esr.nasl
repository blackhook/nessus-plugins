...
"The version of Firefox ESR installed on the remote Windows host is prior to 78.7. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-04 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'78.7', min:'78.0.0', severity:SECURITY_WARNING);
