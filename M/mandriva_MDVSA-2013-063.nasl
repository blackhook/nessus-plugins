...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:063. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:063");
  script_xref(name:"MGASA", value:"2012-0265");

  script_name(english:"Mandriva Linux Security Advisory : bip (MDVSA-2013:063)");
...
descriptors (CVE-2012-0806)."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:bip");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"bip-0.8.8-6.1.mbs1")) flag++;
