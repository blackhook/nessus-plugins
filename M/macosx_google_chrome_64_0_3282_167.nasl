...
if (description)
{
  ...
  script_name(english:"Google Chrome < 64.0.3282.167 V8 JSFunction::CalculateInstanceSizeForDerivedClass() RCE (macOS)");
...
to 64.0.3282.167. It is, therefore, affected by a flaw in the
...
google_chrome_check_version(fix:'64.0.3282.167', severity:SECURITY_WARNING);
