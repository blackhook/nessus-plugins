...
if (description)
{
  ...
  script_xref(name:"APPLE-SA", value:"APPLE-SA-2014-10-16-5");

  script_name(english:"Mac OS X : OS X Server < 2.2.5 SSLv3 Information Disclosure (POODLE)");
...
that is prior to version 2.2.5. It is, therefore, affected by an
...
issue.");
  script_set_attribute(attribute:"see_also", value:"http://support.apple.com/kb/HT6529");
  script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/533725/30/0/threaded");
