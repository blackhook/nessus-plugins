...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:161. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : html2ps (MDVSA-2012:161)");
...
flag = 0;
if (rpm_check(release:"MDK2011", reference:"html2ps-2.0-2.b7.0.1-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", reference:"xhtml2ps-2.0-2.b7.0.1-mdv2011.0", yank:"mdv")) flag++;
