...
if (description)
{
  ...
  script_name(english:"LibreOffice < 5.4.6 or 6.x < 6.0.2 Heap Buffer Overflow (macOS)");
...
"The LibreOffice installed on the remote macOS host is either 5.x prior
to 5.4.6 or 6.x prior to 6.0.2. A heap-based buffer overflow condition 
