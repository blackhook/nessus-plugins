...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:257. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:257");

  script_name(english:"Mandriva Linux Security Advisory : qemu (MDVSA-2009:257)");
...
flag = 0;
if (rpm_check(release:"MDK2009.0", reference:"dkms-kqemu-1.4.0-0.pre1.0.2mdv2009.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.0", reference:"qemu-0.9.1-0.r5137.1.2mdv2009.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.0", reference:"qemu-img-0.9.1-0.r5137.1.2mdv2009.0", yank:"mdv")) flag++;
