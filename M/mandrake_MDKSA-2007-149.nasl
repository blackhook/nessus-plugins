...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:149. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : bind (MDKSA-2007:149)");
...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.isc.org/index.pl?/sw/bind/bind-security.php"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"bind-9.3.2-8.3mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"bind-devel-9.3.2-8.3mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"bind-utils-9.3.2-8.3mdv2007.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2007.1", reference:"bind-9.4.1-0.2mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"bind-devel-9.4.1-0.2mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"bind-utils-9.4.1-0.2mdv2007.1", yank:"mdv")) flag++;
