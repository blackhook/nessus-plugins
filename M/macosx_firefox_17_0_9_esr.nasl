...
if (description)
{
  ...
  script_name(english:"Firefox ESR 17.x < 17.0.9 Multiple Vulnerabilities (Mac OS X)");
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:TRUE, fix:'17.0.9', min:'17.0', severity:SECURITY_HOLE, xss:FALSE);
