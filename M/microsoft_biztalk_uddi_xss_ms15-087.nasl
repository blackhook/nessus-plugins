...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"3073893");
  script_xref(name:"MSKB", value:"3087119");
...
cross-site scripting flaw and not the specific OS variant.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/2015/ms15-087");
