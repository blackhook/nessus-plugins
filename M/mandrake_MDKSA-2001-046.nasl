...
# extracted from Mandrake Linux Security Advisory MDKSA-2001:046. 
...
if (description)
{
  ...
  script_cve_id("CVE-2001-0496");
  script_xref(name:"MDKSA", value:"2001:046-3");

  script_name(english:"Mandrake Linux Security Advisory : kdelibs (MDKSA-2001:046-3)");
...
that did not work properly with the previous update."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:kdelibs-devel-static-libraries");
...
flag = 0;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"arts-2.1.2-4mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"kdelibs-2.1.2-4mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"kdelibs-devel-2.1.2-4mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"kdelibs-devel-static-libraries-2.1.2-4mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"libarts2-2.1.2-4mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"libarts2-devel-2.1.2-4mdk", yank:"mdk")) flag++;
