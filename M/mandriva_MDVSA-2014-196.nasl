...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:196. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:196");

  script_name(english:"Mandriva Linux Security Advisory : rsyslog (MDVSA-2014:196)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-dbi-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-docs-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-gnutls-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-gssapi-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-mysql-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-pgsql-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-relp-5.8.10-6.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"rsyslog-snmp-5.8.10-6.2.mbs1")) flag++;
