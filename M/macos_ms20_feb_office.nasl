...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Office Products (February 2020) (macOS)");
...
therefore, affected by a remote code execution vulnerability due to Microsoft Excel improperly handling objects in 
memory. An attacker who successfully exploited the vulnerability could run arbitrary code in the context of the current
user. To exploit the vulnerability, an attacker has to entice the logged on user to click a link or open a specially 
crafted file to gain control of the system with the privileges of the logged on user.");
...
min_ver_16 = '16';
fix_ver_16 = '16.16.19';
fix_disp_16 = '16.16.19 (20021000)';

#2019
min_ver_19 = '16.17.0';
fix_ver_19 = '16.34';
fix_disp_19 = '16.34 (20020900)';
