...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:048. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:048");

  script_name(english:"Mandrake Linux Security Advisory : cvs (MDKSA-2004:048)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"cvs-1.11.14-0.2.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"cvs-1.11.14-0.2.91mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.2", reference:"cvs-1.11.14-0.2.92mdk", yank:"mdk")) flag++;
