...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 52.8 Multiple Critical Vulnerabilities");
...
"The version of Mozilla Firefox ESR installed on the remote Windows
    host is prior to 52.8. It is, therefore, affected by multiple critical
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'52.8', min:'52', severity:SECURITY_HOLE);
