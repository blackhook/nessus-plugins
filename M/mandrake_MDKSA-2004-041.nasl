...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:041. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:041");

  script_name(english:"Mandrake Linux Security Advisory : proftpd (MDKSA-2004:041)");
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"proftpd-1.2.9-3.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", reference:"proftpd-anonymous-1.2.9-3.1.100mdk", yank:"mdk")) flag++;
