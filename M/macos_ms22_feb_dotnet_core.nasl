...
if (description)
{
  ...
  script_name(english:"Security Update for .NET Core (February 2022) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The Microsoft .NET core installations on the remote macOS host are missing a security update.");
  script_set_attribute(attribute:"description", value:
"The Microsoft .NET core installation on the remote macOS host is version 5.0 prior to 5.0.14 or version 6.0 prior to
6.0.2. It is, therefore, affected by a denial of service (DoS) vulnerability. An attacker can exploit this issue to
...
"Update to .NET Core Runtime version 5.0.14 or 6.0.2");
