...
if (description)
{
  ...
  script_name(english:"VMware Fusion 10.x < 10.1.3 Out-of-Bounds Read Vulnerability (VMSA-2018-0026) (macOS)");
...
host is affected by an out-of-bounds read vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of VMware Fusion installed on the remote macOS or
Mac OS X host is 10.x prior to 10.1.3. It is, therefore, affected by
an out-of-bounds read vulnerability in SVGA devices. An attacker with
