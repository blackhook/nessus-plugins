...
if (description)
{
  ...
  script_name(english:"Firefox < 3.0.18 Multiple Vulnerabilities");
...
"The installed version of Firefox is earlier than 3.0.18.  Such
versions are potentially affected by the following security issues :
  ...
  - A cross-site scripting exists issue due to 
  ...
  script_set_attribute(attribute:"solution",value:"Upgrade to Firefox 3.0.18 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.0.18', severity:SECURITY_HOLE);