...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:162. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:162");

  script_name(english:"Mandrake Linux Security Advisory : gpdf (MDKSA-2004:162)");
...
versions of xpdf <= xpdf-3.0 and several programs, like gpdf, which
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"gpdf-0.112-2.4.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"gpdf-0.132-3.3.101mdk", yank:"mdk")) flag++;
