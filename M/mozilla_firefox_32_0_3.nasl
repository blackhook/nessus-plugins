...
if (description)
{
  ...
  script_name(english:"Firefox < 32.0.3 NSS Signature Verification Vulnerability");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'32.0.3', severity:SECURITY_HOLE, xss:FALSE);
