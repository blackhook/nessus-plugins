...
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 68.0.2. It is, therefore, 
affected by a vulnerability as referenced in the mfsa2019-24 advisory. 
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'68.0.2', min:'68.0.0', severity:SECURITY_WARNING);
