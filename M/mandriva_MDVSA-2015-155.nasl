...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:155. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:155");

  script_name(english:"Mandriva Linux Security Advisory : gnupg (MDVSA-2015:155)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"gnupg-1.4.12-3.6.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64gcrypt-devel-1.5.4-1.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64gcrypt11-1.5.4-1.1.mbs1")) flag++;
