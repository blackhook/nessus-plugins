...
"The version of Thunderbird installed on the remote Windows host is prior to 91.9.1. It is, therefore, affected by
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'91.9.1', severity:SECURITY_HOLE);
