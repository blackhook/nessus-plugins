...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:223. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : pdftohtml (MDKSA-2007:223)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"pdftohtml-0.36-5.3mdv2007.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2007.1", reference:"pdftohtml-0.39-1.2mdv2007.1", yank:"mdv")) flag++;
