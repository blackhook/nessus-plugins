...
flag = 0;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"glibc-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"glibc-devel-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"glibc-i18ndata-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"glibc-profile-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"glibc-static-devel-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"glibc-utils-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"ldconfig-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"nscd-2.2.5-16.4.90mdk", yank:"mdk")) flag++;
