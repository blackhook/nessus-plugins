...
"The version of Thunderbird installed on the remote Windows host is prior to 78.10.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2021-19 advisory.
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'78.10.1', severity:SECURITY_WARNING);
