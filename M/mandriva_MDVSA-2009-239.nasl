...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:239. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:239");

  script_name(english:"Mandriva Linux Security Advisory : openssl (MDVSA-2009:239)");
...
flag = 0;
if (rpm_check(release:"MDK2009.1", cpu:"x86_64", reference:"lib64openssl0.9.8-0.9.8k-1.2mdv2009.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.1", cpu:"x86_64", reference:"lib64openssl0.9.8-devel-0.9.8k-1.2mdv2009.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.1", cpu:"x86_64", reference:"lib64openssl0.9.8-static-devel-0.9.8k-1.2mdv2009.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.1", cpu:"i386", reference:"libopenssl0.9.8-0.9.8k-1.2mdv2009.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.1", cpu:"i386", reference:"libopenssl0.9.8-devel-0.9.8k-1.2mdv2009.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.1", cpu:"i386", reference:"libopenssl0.9.8-static-devel-0.9.8k-1.2mdv2009.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.1", reference:"openssl-0.9.8k-1.2mdv2009.1", yank:"mdv")) flag++;
