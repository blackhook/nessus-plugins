...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:008. 
...
if (description)
{
  ...
  script_bugtraq_id(64109, 64118, 64121, 64140, 64142);
  script_xref(name:"MDVSA", value:"2014:008");

  script_name(english:"Mandriva Linux Security Advisory : openjpeg (MDVSA-2014:008)");
...
CVE-2013-6052, CVE-2013-6053, CVE-2013-6887)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0005.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64openjpeg-devel-1.5.0-2.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64openjpeg1-1.5.0-2.2.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"openjpeg-1.5.0-2.2.mbs1")) flag++;
