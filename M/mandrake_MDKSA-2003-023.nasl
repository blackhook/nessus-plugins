...
# extracted from Mandrake Linux Security Advisory MDKSA-2003:023. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2003:023");

  script_name(english:"Mandrake Linux Security Advisory : lynx (MDKSA-2003:023)");
...
flag = 0;
if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"lynx-2.8.5-0.10mdk.dev.8", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"lynx-2.8.5-0.10mdk.dev.8", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.1", cpu:"i386", reference:"lynx-2.8.5-0.10mdk.dev.8", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"lynx-2.8.5-0.10mdk.dev.8", yank:"mdk")) flag++;

if (rpm_check(release:"MDK9.0", cpu:"i386", reference:"lynx-2.8.5-0.10mdk.dev.8", yank:"mdk")) flag++;
