...
"The version of Firefox ESR installed on the remote Windows host is prior to 78.9. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2021-11 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'78.9', min:'78.0.0', severity:SECURITY_WARNING);
