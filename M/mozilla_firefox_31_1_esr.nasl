...
if (description)
{
  ...
  script_name(english:"Firefox ESR 31.x < 31.1 Multiple Vulnerabilities");
...
to 31.1. It is, therefore, affected by the following vulnerabilities :
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'31.1', min:'31.0', severity:SECURITY_HOLE, xss:FALSE);
