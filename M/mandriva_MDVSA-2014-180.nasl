...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:180. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:180");

  script_name(english:"Mandriva Linux Security Advisory : gnupg (MDVSA-2014:180)");
...
side-channel attack (CVE-2014-5270)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0381.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"gnupg-1.4.12-3.5.mbs1")) flag++;
