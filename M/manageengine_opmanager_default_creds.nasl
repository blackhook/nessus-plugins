...
to gain administrative access to the remote host.");
  # https://pitstop.manageengine.com/portal/kb/articles/pgsql-submitquery-do-vulnerability
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cab0ef7c");
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2015/Sep/66");
  script_set_attribute(attribute:"solution", value:
"Apply the patch referenced in the vendor advisory.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:ND");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7765");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_set_attribute(attribute:"exploit_framework_core", value:"true");
  script_set_attribute(attribute:"d2_elliot_name", value:"ManageEngine OpManager SQL Injection");
