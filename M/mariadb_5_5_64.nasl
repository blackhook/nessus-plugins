...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-5564-rn");
...
mysql_check_version(variant: 'MariaDB', min:'5.5.0-MariaDB', fixed:make_list('5.5.64-MariaDB'), severity:SECURITY_WARNING, paranoid: false);
