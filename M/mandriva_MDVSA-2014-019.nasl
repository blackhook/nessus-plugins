...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:019. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:019");

  script_name(english:"Mandriva Linux Security Advisory : elinks (MDVSA-2014:019)");
...
to fix this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0014.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"elinks-0.12-2.2.mbs1")) flag++;
