...
if (description)
{
  ...
  script_name(english:"Firefox 10.0.x < 10.0.5 Multiple Vulnerabilities");
...
the following security issues :
  ...
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade to Firefox 10.0.5 ESR or later."
  );
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'10.0.5', min:'10.0', severity:SECURITY_HOLE, xss:TRUE);