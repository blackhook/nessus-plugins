...
# extracted from Mozilla Foundation Security Advisory mfsa2021-49.
...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 91.3");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 91.3. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2021-49 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2021-49/");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'91.3', min:'91.0.0', severity:SECURITY_HOLE);
