...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:036. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:036");

  script_name(english:"Mandriva Linux Security Advisory : exif (MDVSA-2013:036)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"exif-0.6.21-1.mbs1")) flag++;
