...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 24.1 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'24.1', severity:SECURITY_HOLE, xss:FALSE);
