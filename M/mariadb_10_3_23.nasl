...
if (description)
{
  ...
  script_name(english:"MariaDB 10.3.0 < 10.3.23 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"The remote database server is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of MariaDB installed on the remote host is prior to 10.3.23. It is, therefore, affected by multiple
vulnerabilities as referenced in the mdb-10323-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-10323-rn");
...
mysql_check_version(variant: 'MariaDB', min:'10.3.0-MariaDB', fixed:make_list('10.3.23-MariaDB'), severity:SECURITY_WARNING);