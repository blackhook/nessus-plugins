...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:191. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:191-1");

  script_name(english:"Mandriva Linux Security Advisory : OpenEXR (MDVSA-2009:191-1)");
...
customers"
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:lib64OpenEXR4");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:libOpenEXR-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:libOpenEXR4");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"OpenEXR-1.4.0-3.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64OpenEXR-devel-1.4.0-3.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"x86_64", reference:"lib64OpenEXR4-1.4.0-3.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libOpenEXR-devel-1.4.0-3.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", cpu:"i386", reference:"libOpenEXR4-1.4.0-3.1mdv2008.0", yank:"mdv")) flag++;
