...
# extracted from Mandriva Linux Security Advisory MDVSA-2011:036. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : mailman (MDVSA-2011:036)");
...
flag = 0;
if (rpm_check(release:"MDK2009.0", reference:"mailman-2.1.11-1.3mdv2009.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.0", reference:"mailman-2.1.12-3.3mdv2010.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.1", reference:"mailman-2.1.13-1.3mdv2010.2", yank:"mdv")) flag++;
