...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:134. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : xfsdump (MDKSA-2007:134)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"xfsdump-2.2.42-2.1mdv2007.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2007.1", reference:"xfsdump-2.2.42-3.1mdv2007.1", yank:"mdv")) flag++;
