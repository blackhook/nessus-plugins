...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:076. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:076");
  script_xref(name:"MGASA", value:"2012-0261");

  script_name(english:"Mandriva Linux Security Advisory : emacs (MDVSA-2013:076)");
...
to gain privileges via a crafted Lisp expression in a Project.ede file
in the directory, or a parent directory, of an opened file
(CVE-2012-0035).
...
(mga#7759)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugs.mageia.org/show_bug.cgi?id=7759"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-23.3-9.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-common-23.3-9.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-doc-23.3-9.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"emacs-el-23.3-9.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-leim-23.3-9.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"emacs-nox-23.3-9.1.mbs1")) flag++;
