...
# extracted from Mozilla Foundation Security Advisory mfsa2022-34.
...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 102.2");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 102.2. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2022-34 advisory.
  ...
  - A data race could occur in the <code>PK11ChangePW</code> function, potentially leading to a use-after-free
    vulnerability.  In Firefox, this lock protected the data when a user changed their master password.
    (CVE-2022-38476)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2022-34/");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'102.2', min:'102.0.0', severity:SECURITY_HOLE);
