...
# extracted from Mandrake Linux Security Advisory MDKSA-2002:003. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2002:003");

  script_name(english:"Mandrake Linux Security Advisory : sudo (MDKSA-2002:003)");
...
using."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2002/01/15");
...
flag = 0;
if (rpm_check(release:"MDK7.1", cpu:"i386", reference:"sudo-1.6.4-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK7.2", cpu:"i386", reference:"sudo-1.6.4-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"sudo-1.6.4-1.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.1", cpu:"i386", reference:"sudo-1.6.4-1.1mdk", yank:"mdk")) flag++;
