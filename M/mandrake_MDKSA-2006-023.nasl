...
The updated packages have been patched to correct this problem."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected perl-Net_SSLeay package."
  );
...
flag = 0;
if (rpm_check(release:"MDK10.1", reference:"perl-Net_SSLeay-1.25-4.1.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"perl-Net_SSLeay-1.25-4.1.102mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2006.0", reference:"perl-Net_SSLeay-1.25-4.1.20060mdk", yank:"mdk")) flag++;
