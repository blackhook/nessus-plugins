...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird 24.x < 24.8.1 NSS Signature Verification Vulnerability (Mac OS X)");
...
mozilla_check_version(product:'thunderbird', version:version, path:path, esr:FALSE, fix:'24.8.1', min:'24.0', severity:SECURITY_HOLE, xss:FALSE);
