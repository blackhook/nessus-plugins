...
if (description)
{
  ...
  script_name(english:"Adobe Acrobat <= 2015.006.30505 / 2017.011.30155 / 2019.021.20056 Multiple Vulnerabilities (APSB19-55) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"The version of Adobe Acrobat installed on the remote macOS host is
affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Acrobat installed on the remote macOS host is a version prior or equal to 2015.006.30505,
2017.011.30155, or 2019.021.20056. It is, therefore, affected by multiple vulnerabilities. Note that Nessus has not
...
constraints = [
  ...
  { 'min_version' : '17.8', 'max_version' : '17.011.30155', 'fixed_version' : '17.011.30156' },
