...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:187. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:187");

  script_name(english:"Mandrake Linux Security Advisory : dia (MDKSA-2005:187)");
...
flag = 0;
if (rpm_check(release:"MDK10.2", reference:"dia-0.94-4.1.102mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2006.0", reference:"dia-0.94-6.1.20060mdk", yank:"mdk")) flag++;
