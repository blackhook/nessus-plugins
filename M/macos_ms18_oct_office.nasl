...
if (description)
{
  ...
  script_cve_id("CVE-2018-8432");
  script_bugtraq_id(105458);

  script_name(english:"Security Update for Microsoft Office (October 2018) (macOS)");
...
affected by the following vulnerability:
  ...
  - A remote code execution vulnerability exists in the way that
    Microsoft Graphics Components handle objects in memory. An
    attacker who successfully exploited the vulnerability could
    execute arbitrary code on a target system. To exploit the
    vulnerability, a user would have to open a specially crafted
    file. The security update addresses the vulnerability by
    correcting how Microsoft Graphics Components handle objects in
    memory.(CVE-2018-8432)");
  # https://docs.microsoft.com/en-us/officeupdates/release-notes-office-2016-mac#october-2018-release
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2602191f");
  # https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8432
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bd0f0cef");
...
Mac.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-8432");
...
min_ver_19 = '16.17.0';
fix_ver_19 = '16.18.0';
fix_disp_19 = '16.18.0 (18101400)';

#2016
min_ver_16 = '16';
fix_ver_16 = '16.16.3';
fix_disp_16 = '16.16.3 (18101500)';
report = '';
