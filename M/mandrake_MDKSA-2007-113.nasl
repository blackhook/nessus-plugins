...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:113. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : mutt (MDKSA-2007:113)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"mutt-1.5.11-5.2mdv2007.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.0", reference:"mutt-utf8-1.5.11-5.2mdv2007.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2007.1", reference:"mutt-1.5.14-1.1mdv2007.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2007.1", reference:"mutt-utf8-1.5.14-1.1mdv2007.1", yank:"mdv")) flag++;
