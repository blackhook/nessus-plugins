...
"The version of Thunderbird installed on the remote Windows host is prior to 78.5.1. It is, therefore, affected by a
vulnerability as referenced in the mfsa2020-53 advisory. Note that Nessus has not tested for this issue but has instead
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'78.5.1', severity:SECURITY_HOLE);
