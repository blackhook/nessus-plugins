...
router to proxy arbitrary traffic or bypass the router's firewall.");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/research/tra-2019-07");
  script_set_attribute(attribute:"solution", value:
"Upgrade to MikroTik RouterOS 6.42.12 / 6.43.12 or later.");
...
# request to 255.255.255.255 port 80 req: {bff0005:1,u3:4294967295,u4:80,uff0006:1,uff0007:1,s7:'nessus',Uff0001:[104]} 
