...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:035. 
...
if (description)
{
  ...
  script_bugtraq_id(64493);
  script_xref(name:"MDVSA", value:"2014:035");

  script_name(english:"Mandriva Linux Security Advisory : libpng (MDVSA-2014:035)");
...
NULL palette, related to pngrtran.c and pngset.c (CVE-2013-6954)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2014-0075.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64png-devel-1.5.10-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64png12-devel-1.2.49-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64png12_0-1.2.49-2.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64png15_15-1.5.10-2.1.mbs1")) flag++;
