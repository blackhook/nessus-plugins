...
"The version of Firefox ESR installed on the remote Windows host is prior to 68.6.1. It is, therefore, affected by
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'68.6.1', min:'68.0.0', severity:SECURITY_WARNING);
