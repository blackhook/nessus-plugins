...
if (description)
{
  ...
  script_name(english:"Firefox < 25.0.1 NSS and NSPR Multiple Vulnerabilities (Mac OS X)");
...
mozilla_check_version(product:'firefox', version:version, path:path, esr:FALSE, fix:'25.0.1', severity:SECURITY_HOLE, xss:FALSE);
