...
# extracted from Mandrake Linux Security Advisory MDKSA-2003:070. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2003:070");

  script_name(english:"Mandrake Linux Security Advisory : ethereal (MDKSA-2003:070)");
...
in ethereal that can be exploited using specially crafted packets to
cause ethereal to consume excessive amounts of memory, crash, or even
...
flag = 0;
if (rpm_check(release:"MDK9.1", cpu:"i386", reference:"ethereal-0.9.13-1.1mdk", yank:"mdk")) flag++;
