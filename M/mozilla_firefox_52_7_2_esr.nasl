...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 52.7.2 Multiple Code Execution Vulnerabilities");
...
host is prior to 52.7.2. It is, therefore, affected by multiple code
execution vulnerabilities. A out-of-bounds write flaw exists in
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'52.7.2', min:'52', severity:SECURITY_HOLE);
