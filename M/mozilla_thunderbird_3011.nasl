...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 3.0.11 Multiple Vulnerabilities");
...
"The installed version of Thunderbird is earlier than 3.0.11.  Such
versions are potentially affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7915c63");

  script_set_attribute(attribute:"solution", value:"Upgrade to Thunderbird 3.0.11 or later.");
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'3.0.11', severity:SECURITY_HOLE);