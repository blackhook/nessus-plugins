...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:220. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:220");

  script_name(english:"Mandriva Linux Security Advisory : lcms (MDVSA-2013:220)");
...
be exploited through user input (CVE-2013-4276)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0260.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=991757"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lcms-1.19-7.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64lcms-devel-1.19-7.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64lcms1-1.19-7.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"python-lcms-1.19-7.1.mbs1")) flag++;
