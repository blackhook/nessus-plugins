...
if (description)
{
  ...
  script_name(english:"MariaDB 10.5.0 < 10.5.9 A Vulnerability");
...
referenced in the mdb-1059-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1059-rn");
...
mysql_check_version(variant: 'MariaDB', min:'10.5.0-MariaDB', fixed:make_list('10.5.9-MariaDB'), severity:SECURITY_HOLE);