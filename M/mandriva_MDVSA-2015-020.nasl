...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:020. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:020");

  script_name(english:"Mandriva Linux Security Advisory : libssh (MDVSA-2015:020)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ssh-devel-0.5.2-2.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ssh4-0.5.2-2.3.mbs1")) flag++;
