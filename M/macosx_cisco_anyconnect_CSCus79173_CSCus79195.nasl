...
if (description)
{
  ...
  script_name(english:"Mac OS X : Cisco AnyConnect Secure Mobility Client < 3.1.8009.0 / 4.0.x < 4.0.2052.0 / 4.1.x < 4.1.28.0 Multiple Vulnerabilities");
...
Mac OS X host is a version prior to 3.1.8009.0, or is version 4.0.x
prior to 4.0.2052.0, or version 4.1.x prior to 4.1.28.0. It is,
