...
if (description)
{
  ...
  script_cve_id("CVE-2010-1585", "CVE-2011-0051", "CVE-2011-0053", 
    "CVE-2011-0054", "CVE-2011-0055", "CVE-2011-0056", "CVE-2011-0057",
    "CVE-2011-0058", "CVE-2011-0059", "CVE-2011-0061", "CVE-2011-0062"
  );
  script_bugtraq_id(
    46368, 
    46643, 
  ...
  script_name(english:"Firefox 3.6 < 3.6.14 Multiple Vulnerabilities");
...
versions are potentially affected by multiple vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-09/");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 3.6.14 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.6.14', min:'3.6', severity:SECURITY_HOLE);
