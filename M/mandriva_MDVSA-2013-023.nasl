...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:023. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:023-1");

  script_name(english:"Mandriva Linux Security Advisory : coreutils (MDVSA-2013:023-1)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"coreutils-8.15-3.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"coreutils-doc-8.15-3.1.mbs1")) flag++;
