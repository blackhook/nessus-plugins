...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:043. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:043");

  script_name(english:"Mandrake Linux Security Advisory : xpdf (MDKSA-2005:043)");
...
(formerly CVE-2004-0888). This also affects applications that use
...
flag = 0;
if (rpm_check(release:"MDK10.0", cpu:"amd64", reference:"xpdf-3.00-5.5.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", cpu:"x86_64", reference:"xpdf-3.00-7.4.101mdk", yank:"mdk")) flag++;
