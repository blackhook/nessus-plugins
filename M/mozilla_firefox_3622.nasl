...
if (description)
{
  ...
  script_name(english:"Firefox 3.6.x < 3.6.22 Untrusted CA");
...
"The installed version of Firefox 3.6.x is earlier than 3.6.22.  Due
...
several intermediates in this version of Firefox. 

Note this is a further fix to MFSA 2011-34, which removed the
DigiNotar root certificate.");

  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2011-35/");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 3.6.22 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.6.22', min:'3.6', severity:SECURITY_WARNING);