...
if (description)
{
  ...
  script_name(english:"Adobe AIR for Mac 3.x <= 3.6.0.6090 Multiple Vulnerabilities (APSB13-11)");
...
Mac OS X host is 3.6.0.6090 or earlier.  It is, therefore, reportedly
affected by multiple vulnerabilities :
...
fixed_version_for_report = '3.7.0.1530';
