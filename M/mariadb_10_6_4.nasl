...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1064-rn");
...
mysql_check_version(variant: 'MariaDB', min:'10.6.0-MariaDB', fixed:make_list('10.6.4-MariaDB'), severity:SECURITY_HOLE);