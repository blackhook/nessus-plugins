...
if (description)
{
  ...
  script_name(english:"Firefox ESR 17.x < 17.0.3 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'17.0.3', min:'17.0', severity:SECURITY_HOLE);
