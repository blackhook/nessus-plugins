...
if (description)
{
  ...
  script_name(english:"Oracle MySQL 5.5.x < 5.5.32 Optimizer DoS (January 2016 CPU)");
...
prior to 5.5.32. It is, therefore, affected by an unspecified flaw in
...
exploit this to cause a denial of service condition.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://dev.mysql.com/doc/relnotes/mysql/5.5/en/news-5-5-32.html");
