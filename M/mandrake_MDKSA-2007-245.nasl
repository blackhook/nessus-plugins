...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:245. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : wpa_supplicant (MDKSA-2007:245)");
...
Updated package fixes this issue."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected wpa_gui and / or wpa_supplicant packages."
  );
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"wpa_gui-0.6.0-1.1mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"wpa_supplicant-0.6.0-1.1mdv2008.0", yank:"mdv")) flag++;
