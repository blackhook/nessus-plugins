...
"The version of Firefox installed on the remote macOS or Mac OS X host is prior to 91.0.1. It is, therefore, affected by
a vulnerability as referenced in the mfsa2021-37 advisory.
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:FALSE, fix:'91.0.1', severity:SECURITY_WARNING);
