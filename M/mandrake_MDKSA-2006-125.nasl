...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:125. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:125");

  script_name(english:"Mandrake Linux Security Advisory : webmin (MDKSA-2006:125)");
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"webmin-1.220-9.4.20060mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK2006.0", cpu:"x86_64", reference:"webmin-1.220-9.4.20060mdk", yank:"mdk")) flag++;
