...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:044. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : ekiga (MDKSA-2007:044)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"ekiga-2.0.3-1.1mdv2007.0", yank:"mdv")) flag++;
