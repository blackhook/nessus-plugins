...
if (description)
{
  ...
  script_name(english:"Firefox ESR < 38.1 Multiple Vulnerabilities (Logjam)");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'38.1', min:'38.0', severity:SECURITY_HOLE);
