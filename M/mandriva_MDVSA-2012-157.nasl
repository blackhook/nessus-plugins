...
# extracted from Mandriva Linux Security Advisory MDVSA-2012:157. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : openjpeg (MDVSA-2012:157)");
...
flag = 0;
if (rpm_check(release:"MDK2011", cpu:"x86_64", reference:"lib64openjpeg-devel-1.3-8.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", cpu:"x86_64", reference:"lib64openjpeg2-1.3-8.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", cpu:"i386", reference:"libopenjpeg-devel-1.3-8.2-mdv2011.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2011", cpu:"i386", reference:"libopenjpeg2-1.3-8.2-mdv2011.0", yank:"mdv")) flag++;
