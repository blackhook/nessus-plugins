...
# extracted from Mandriva Linux Security Advisory MDVSA-2010:052. 
...
if (description)
{
  ...
  script_bugtraq_id(38432);
  script_xref(name:"MDVSA", value:"2010:052");

  script_name(english:"Mandriva Linux Security Advisory : sudo (MDVSA-2010:052)");
...
flag = 0;
if (rpm_check(release:"MDK2009.0", reference:"sudo-1.6.9p17-1.3mdv2009.0", yank:"mdv")) flag++;
