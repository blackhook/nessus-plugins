...
"The version of Firefox installed on the remote Windows host is prior to 100.0.2. It is, therefore, affected by multiple
vulnerabilities as referenced in the mfsa2022-19 advisory.
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'100.0.2', severity:SECURITY_HOLE);
