...
# Mandriva Linux Security Advisory MDVA-2009:097.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2009:097 : drakx-net");
...
translations were updated.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2009:097");
...
if (rpm_check(reference:"drakx-net-0.75.1-1.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"drakx-net-text-0.75.1-1.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"libdrakx-net-0.75.1-1.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"drakx-net-0.75.1-1.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"drakx-net-text-0.75.1-1.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"libdrakx-net-0.75.1-1.1mdv2009.1", release:"MDK2009.1", cpu:"noarch", yank:"mdv")) flag++;
