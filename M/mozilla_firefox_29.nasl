...
if (description)
{
  ...
  script_name(english:"Firefox < 29.0 Multiple Vulnerabilities");
...
"The installed version of Firefox is a version prior to 29.0 and is,
therefore, potentially affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2014-35/");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'29.0', severity:SECURITY_HOLE, xss:TRUE);
