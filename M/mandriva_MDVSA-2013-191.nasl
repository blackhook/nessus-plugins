...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:191. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:191");

  script_name(english:"Mandriva Linux Security Advisory : fail2ban (MDVSA-2013:191)");
...
arbitrary addresses, thus causing a denial of service (CVE-2013-2178)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0192.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"fail2ban-0.8.6-3.2.mbs1")) flag++;
