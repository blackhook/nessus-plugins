...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:222. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:222");

  script_name(english:"Mandrake Linux Security Advisory : mailman (MDKSA-2005:222)");
...
flag = 0;
if (rpm_check(release:"MDK10.1", reference:"mailman-2.1.5-7.5.101mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.2", reference:"mailman-2.1.5-15.2.102mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2006.0", reference:"mailman-2.1.6-6.2.20060mdk", yank:"mdk")) flag++;
