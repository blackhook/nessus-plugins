...
if (description)
{
  ...
  script_name(english:"MySQL Enterprise Monitor 3.2.x < 3.2.5.1141 Multiple Vulnerabilities (SWEET32) (January 2017 CPU)");
...
It is, therefore, affected by multiple vulnerabilities :
  ...
  - An out-of-bounds read error exists in the bundled
    ...
    (CVE-2016-6306)");
  # https://dev.mysql.com/doc/relnotes/mysql-monitor/3.2/en/news-3-2-5.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4584e9f8");
...
"Upgrade to MySQL Enterprise Monitor version 3.2.5.1141 or later as
