...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:237. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:237");

  script_name(english:"Mandrake Linux Security Advisory : cpio (MDKSA-2005:237)");
...
flag = 0;
if (rpm_check(release:"MDK10.2", reference:"cpio-2.6-3.3.102mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2006.0", reference:"cpio-2.6-5.1.20060mdk", yank:"mdk")) flag++;
