...
# extracted from Mandrake Linux Security Advisory MDKSA-2004:027. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2004:027");

  script_name(english:"Mandrake Linux Security Advisory : ipsec-tools (MDKSA-2004:027)");
...
to this issue. The provided package updates ipsec-tools to 0.2.5."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected ipsec-tools and / or libipsec-tools0 packages."
  );
...
flag = 0;
if (rpm_check(release:"MDK10.0", cpu:"i386", reference:"ipsec-tools-0.2.5-0.1.100mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK10.0", cpu:"i386", reference:"libipsec-tools0-0.2.5-0.1.100mdk", yank:"mdk")) flag++;
