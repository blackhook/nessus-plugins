...
if (description)
{
  ...
  script_name(english:"Firefox < 22.0 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'22.0', severity:SECURITY_HOLE, xss:TRUE, xsrf:TRUE);
