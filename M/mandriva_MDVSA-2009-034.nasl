...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:034. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:034");

  script_name(english:"Mandriva Linux Security Advisory : squid (MDVSA-2009:034)");
...
flag = 0;
if (rpm_check(release:"MDK2008.1", reference:"squid-3.0-1.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"squid-cachemgr-3.0-1.1mdv2008.1", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2009.0", reference:"squid-3.0-8.1mdv2009.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.0", reference:"squid-cachemgr-3.0-8.1mdv2009.0", yank:"mdv")) flag++;
