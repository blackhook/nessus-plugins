...
if (description)
{
  ...
  script_name(english:"Google Chrome < 47.0.2526.73 Multiple Vulnerabilities (Mac OS X)");
...
vulnerabilities :
  ...
  - A security bypass vulnerability exists in Google PDFium
    due to improper restriction of certain URLs (e.g. allows
    working links to 'chrome://'). An attacker can exploit
...
google_chrome_check_version(fix:'47.0.2526.73', severity:SECURITY_HOLE);
