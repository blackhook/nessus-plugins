...
# Mandriva Linux Security Advisory MDVA-2008:201.
#
...
for registered Powerpack users.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2008:201");
...
if (rpm_check(reference:"mdkonline-2.72-1.1mdv2009.0", release:"MDK2009.0", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"mdkonline-2.72-1.1mdv2009.0", release:"MDK2009.0", cpu:"noarch", yank:"mdv")) flag++;
