...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:165. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:165");

  script_name(english:"Mandriva Linux Security Advisory : bind (MDVSA-2015:165)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"bind-9.10.1.P2-7.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"bind-devel-9.10.1.P2-7.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", reference:"bind-doc-9.10.1.P2-7.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"bind-sdb-9.10.1.P2-7.mbs2")) flag++;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"bind-utils-9.10.1.P2-7.mbs2")) flag++;
