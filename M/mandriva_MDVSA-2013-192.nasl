...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:192. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:192");

  script_name(english:"Mandriva Linux Security Advisory : php-radius (MDVSA-2013:192)");
...
The updated packages have been upgraded to the 1.2.7 version which is
not affected by this issue."
  );
  # http://pecl.php.net/package-changelog.php?package=radius&amp;release=1.2.7
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f6948140"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected php-radius package."
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"php-radius-1.2.7-1.mbs1")) flag++;
