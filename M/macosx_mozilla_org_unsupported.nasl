...
all_unsupported_data = make_array(
  ...
  'Mozilla Firefox', make_array(
    '^6[0]\\.', 'https://www.mozilla.org/en-US/security/known-vulnerabilities/firefox/',
    '^5[0-9]\\.', 'https://www.mozilla.org/en-US/security/known-vulnerabilities/firefox/',
  ...
  'Mozilla Firefox ESR', make_array(
    '^5[01]\\.|^52\\.[0-8]\\.', 'https://www.mozilla.org/en-US/security/known-vulnerabilities/firefox-esr/',
    '^[1-4][0-9]\\.', 'https://wiki.mozilla.org/Releases#Previous_Releases'
  ),
  ...
  'Mozilla Thunderbird', make_array(
    '^5[01]\\.|^52\\.[01]\\.', 'https://www.mozilla.org/en-US/security/known-vulnerabilities/firefox-esr/',
    '^4[0-9]\\.', 'https://wiki.mozilla.org/Releases#Previous_Releases',
    '^3[0-9]\\.', 'https://wiki.mozilla.org/Releases#Previous_Releases',
    '^2[0-9]\\.', 'https://wiki.mozilla.org/Releases#Previous_Releases',
    '^1[0-9]\\.', 'https://wiki.mozilla.org/Releases#Previous_Releases',
