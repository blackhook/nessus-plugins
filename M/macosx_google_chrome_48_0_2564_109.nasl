...
if (description)
{
  ...
  script_name(english:"Google Chrome < 48.0.2564.109 Multiple Vulnerabilities (Mac OS X)");
...
google_chrome_check_version(fix:'48.0.2564.109', severity:SECURITY_WARNING);
