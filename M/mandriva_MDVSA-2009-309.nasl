...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:309. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:309");

  script_name(english:"Mandriva Linux Security Advisory : ntp (MDVSA-2009:309)");
...
flag = 0;
if (rpm_check(release:"MDK2008.0", reference:"ntp-4.2.4-10.2mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"ntp-client-4.2.4-10.2mdv2008.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.0", reference:"ntp-doc-4.2.4-10.2mdv2008.0", yank:"mdv")) flag++;
