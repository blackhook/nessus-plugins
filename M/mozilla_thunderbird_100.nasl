...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 10.0 Multiple Vulnerabilities");
...
"The installed version of Thunderbird is earlier than 10.0 and thus, 
...
mozilla_check_version(installs:installs, product:'thunderbird', esr:FALSE, fix:'10.0', skippat:'^3\\.6\\.', severity:SECURITY_HOLE, xss:TRUE);
