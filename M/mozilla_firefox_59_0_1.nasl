...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 59.0.1 Multiple Code Execution Vulnerabilities");
...
is prior to 59.0.1. It is, therefore, affected by multiple code
...
mozilla_check_version(installs:installs, product:'firefox', fix:'59.0.1', severity:SECURITY_HOLE);
