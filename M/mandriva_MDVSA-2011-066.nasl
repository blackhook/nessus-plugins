...
# extracted from Mandriva Linux Security Advisory MDVSA-2011:066. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : rsync (MDVSA-2011:066)");
...
possibly execute arbitrary code via malformed data (CVE-2011-1097).
...
flag = 0;
if (rpm_check(release:"MDK2009.0", reference:"rsync-3.0.4-1.1mdv2009.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.0", reference:"rsync-3.0.6-1.1mdv2010.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.1", reference:"rsync-3.0.7-1.1mdv2010.2", yank:"mdv")) flag++;
