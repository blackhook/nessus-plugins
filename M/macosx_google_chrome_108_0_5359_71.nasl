...
"The version of Google Chrome installed on the remote macOS host is prior to 108.0.5359.71. It is, therefore, affected by
multiple vulnerabilities as referenced in the 2022_11_stable-channel-update-for-desktop_29 advisory.
...
google_chrome_check_version(fix:'108.0.5359.71', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
