...
# extracted from Mandrake Linux Security Advisory MDKSA-2002:053. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2002:053");

  script_name(english:"Mandrake Linux Security Advisory : xinetd (MDKSA-2002:053)");
...
talk to xinetd, resulting in a crash of xinetd."
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2002/08/26");
...
flag = 0;
if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"xinetd-2.3.7-1.1mdk", yank:"mdk")) flag++;
if (rpm_check(release:"MDK8.2", cpu:"i386", reference:"xinetd-ipv6-2.3.7-1.1mdk", yank:"mdk")) flag++;
