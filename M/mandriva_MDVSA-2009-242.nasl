...
# extracted from Mandriva Linux Security Advisory MDVSA-2009:242. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2009:242");

  script_name(english:"Mandriva Linux Security Advisory : dovecot (MDVSA-2009:242)");
...
flag = 0;
if (rpm_check(release:"MDK2009.0", reference:"dovecot-1.1.6-0.2mdv2009.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.0", reference:"dovecot-devel-1.1.6-0.2mdv2009.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.0", reference:"dovecot-plugins-gssapi-1.1.6-0.2mdv2009.0", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2009.0", reference:"dovecot-plugins-ldap-1.1.6-0.2mdv2009.0", yank:"mdv")) flag++;
