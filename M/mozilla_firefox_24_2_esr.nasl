...
if (description)
{
  ...
  script_name(english:"Firefox ESR 24.x < 24.2 Multiple Vulnerabilities");
...
"The installed version of Firefox ESR 24.x is earlier than 24.2, and
...
"Upgrade to Firefox ESR 24.2 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'24.2', min:'24.0', severity:SECURITY_HOLE, xss:FALSE);
