...
if (description)
{
  ...
  script_name(english:"ManageEngine Password Manager Pro < 12.2 Build 12210 SQLi");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is running a web application affected by a SQL injection vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of ManageEngine Password Manager Pro prior to 12.2 Build 12210. It is, therefore,
...
"Upgrade to ManageEngine Password Manager Pro version 12.2 Build 12210 or later.");
...
var constraints = [
  { 'max_version':'12200', 'fixed_version' : '12210', 'fixed_display' : '12.2 Build 12210' }
];
