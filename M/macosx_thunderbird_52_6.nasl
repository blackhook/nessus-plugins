...
if (description)
{
  ...
  script_name(english:"Mozilla Thunderbird < 52.6 Multiple Vulnerabilities (macOS)");
...
mozilla_check_version(version:version, path:path, product:'thunderbird', fix:'52.6', severity:SECURITY_HOLE);
