...
if (description)
{
  ...
  script_name(english:"Security Updates for Microsoft Office Products (April 2020) (macOS)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The Microsoft Office application installed on the remote macOS or
Mac OS X host is missing a security update. It is, therefore, affected
by a remote code execution vulnerability in Microsoft Word software
due to failure to properly handle objects in memory. An attacker could
use a specially crafted file to perform actions in the security
context of the current user. To exploit this issue, an attacker
would have to convince the user to click a link, typically by way of
an enticement in an email or Instant Messenger message, and then
...
min_ver_16 = '16';
fix_ver_16 = '16.16.21';
fix_disp_16 = '16.16.21 (20041301)';

#2019
min_ver_19 = '16.17.0';
fix_ver_19 = '16.36';
fix_disp_19 = '16.36 (20041300)';
