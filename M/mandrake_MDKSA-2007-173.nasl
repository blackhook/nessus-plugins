...
# extracted from Mandrake Linux Security Advisory MDKSA-2007:173. 
...
if (description)
{
  ...
  script_name(english:"Mandrake Linux Security Advisory : tar (MDKSA-2007:173)");
...
flag = 0;
if (rpm_check(release:"MDK2007.0", reference:"tar-1.15.91-1.2mdv2007.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2007.1", reference:"tar-1.16-3.1mdv2007.1", yank:"mdv")) flag++;
