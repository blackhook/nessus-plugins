...
if (description)
{
  ...
  script_cve_id("CVE-2015-7744", "CVE-2016-0610", "CVE-2016-3471");
  script_bugtraq_id(81198, 81245, 91913);
...
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-1019-release-notes/");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/library/mariadb-1019-changelog/");
