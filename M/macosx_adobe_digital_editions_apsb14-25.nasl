...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.0.1 Information Disclosure (APSB14-25) (Mac OS X)");
  script_summary(english:"Checks version of Adobe Digital Editions on Mac OS X");

  script_set_attribute(attribute:"synopsis", value:
"The version of Adobe Digital Editions on the remote Mac OS X host is
affected by an information disclosure vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Digital Editions installed on the remote Mac OS X
host is prior to 4.0.1. It is, therefore, affected by an information
...
"Upgrade to Adobe Digital Editions 4.0.1 or later.");
