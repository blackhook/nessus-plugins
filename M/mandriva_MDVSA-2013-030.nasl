...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:030. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2013:030");

  script_name(english:"Mandriva Linux Security Advisory : arpwatch (MDVSA-2013:030)");
...
NOTE: This advisory was previousely given the MDVSA-2013:017
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"arpwatch-2.1a15-10.1.mbs1")) flag++;
