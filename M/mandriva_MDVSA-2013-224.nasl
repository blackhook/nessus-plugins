...
# extracted from Mandriva Linux Security Advisory MDVSA-2013:224. 
...
if (description)
{
  ...
  script_bugtraq_id(62019);
  script_xref(name:"MDVSA", value:"2013:224");

  script_name(english:"Mandriva Linux Security Advisory : libtiff (MDVSA-2013:224)");
...
execution of arbitrary code (CVE-2013-4244)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2013-0267.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64tiff-devel-4.0.1-3.4.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64tiff-static-devel-4.0.1-3.4.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64tiff5-4.0.1-3.4.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"libtiff-progs-4.0.1-3.4.mbs1")) flag++;
