...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:046. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:046");

  script_name(english:"Mandriva Linux Security Advisory : phpmyadmin (MDVSA-2014:046)");
...
Additionally phpseclib packages has been added due to new
dependencies."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.phpmyadmin.net/home_page/security/PMASA-2014-1.php"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", reference:"phpmyadmin-4.1.7-1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", reference:"phpseclib-0.3.5-1.mbs1")) flag++;
