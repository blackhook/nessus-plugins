...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:055. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:055");

  script_name(english:"Mandrake Linux Security Advisory : gnupg (MDKSA-2006:055)");
...
flag = 0;
if (rpm_check(release:"MDK10.2", reference:"gnupg-1.4.2.2-0.1.102mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK2006.0", reference:"gnupg-1.4.2.2-0.1.20060mdk", yank:"mdk")) flag++;
