...
# Mandriva Linux Security Advisory MDVA-2009:251.
#
...
if (description)
{
  ...
  script_name(english:"MDVA-2009:251 : mdkonline");
...
Last but not least, it now more efficient system power usage");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDVA-2009:251");
...
if (rpm_check(reference:"mdkonline-2.77.14-1.1mdv2008.1", release:"MDK2008.1", cpu:"noarch", yank:"mdv")) flag++;
if (rpm_check(reference:"mdkonline-2.77.14-1.1mdv2008.1", release:"MDK2008.1", cpu:"noarch", yank:"mdv")) flag++;
