...
# extracted from Mozilla Foundation Security Advisory mfsa2021-04.
...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox ESR < 78.7");

  script_set_attribute(attribute:"synopsis", value:
"A web browser installed on the remote macOS or Mac OS X host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Firefox ESR installed on the remote macOS or Mac OS X host is prior to 78.7. It is, therefore, affected
by multiple vulnerabilities as referenced in the mfsa2021-04 advisory.
...
"Upgrade to Mozilla Firefox ESR version 78.7 or later.");
...
mozilla_check_version(version:version, path:path, product:'firefox', esr:TRUE, fix:'78.7', min:'78.0.0', severity:SECURITY_WARNING);
