...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:125. 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-8767", "CVE-2014-8769", "CVE-2014-9140", "CVE-2015-0261", "CVE-2015-2153", "CVE-2015-2154", "CVE-2015-2155");
  script_xref(name:"MDVSA", value:"2015:125");

  script_name(english:"Mandriva Linux Security Advisory : tcpdump (MDVSA-2015:125)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", cpu:"x86_64", reference:"tcpdump-4.4.0-0.2.mbs2")) flag++;
