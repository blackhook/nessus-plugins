...
# extracted from Mandriva Linux Security Advisory MDVSA-2011:031. 
...
if (description)
{
  ...
  script_cve_id("CVE-2011-0696", "CVE-2011-0697", "CVE-2011-0698");
  script_bugtraq_id(46296);
  script_xref(name:"MDVSA", value:"2011:031");

  script_name(english:"Mandriva Linux Security Advisory : python-django (MDVSA-2011:031)");
...
flag = 0;
if (rpm_check(release:"MDK2010.0", reference:"python-django-1.1.4-0.1mdv2010.0", yank:"mdv")) flag++;

if (rpm_check(release:"MDK2010.1", reference:"python-django-1.1.4-0.1mdv2010.2", yank:"mdv")) flag++;
