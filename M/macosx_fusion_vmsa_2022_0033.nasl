...
if (description)
{
  ...
  script_name(english:"VMware Fusion 12.0.x < 12.2.5 Heap Out-of-bounds Write (VMSA-2022-0033)");
...
"VMware Fusion 12.0.x < 12.2.5 installed on the remote macOS or Mac OS X host contain a heap 
out-of-bounds write vulnerability in the USB 2.0 controller (EHCI). A malicious actor with 
local administrative privileges on a virtual machine may exploit this issue to execute code 
as the virtual machine's VMX process running on the host. (CVE-2022-31705)
