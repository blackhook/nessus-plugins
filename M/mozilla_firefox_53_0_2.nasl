...
if (description)
{
  ...
  script_name(english:"Mozilla Firefox < 53.0.2 ANGLE Graphics Library RCE");
...
"Upgrade to Mozilla Firefox version 53.0.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-5031");
...
mozilla_check_version(installs:installs, product:'firefox', fix:'53.0.2', severity:SECURITY_WARNING);
