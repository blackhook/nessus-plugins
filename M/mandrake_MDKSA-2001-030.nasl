...
# extracted from Mandrake Linux Security Advisory MDKSA-2001:030. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2001:030-1");

  script_name(english:"Mandrake Linux Security Advisory : sgml-tools (MDKSA-2001:030-1)");
...
dependency on the wrong version of sgml-common which made it
impossible to upgrade the software. New packages have been released
that fix this problem."
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected sgml-tools package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:N");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:mandriva:linux:sgml-tools");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:mandrakesoft:mandrake_linux:7.1");

  script_set_attribute(attribute:"patch_publication_date", value:"2001/03/20");
...
flag = 0;
if (rpm_check(release:"MDK7.1", cpu:"i386", reference:"sgml-tools-1.0.9-8.3mdk", yank:"mdk")) flag++;
