...
# extracted from Mandriva Linux Security Advisory MDVSA-2014:107. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2014:107");

  script_name(english:"Mandriva Linux Security Advisory : libtasn1 (MDVSA-2014:107)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64tasn1-devel-3.6-1.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64tasn1_6-3.6-1.3.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"libtasn1-tools-3.6-1.3.mbs1")) flag++;
