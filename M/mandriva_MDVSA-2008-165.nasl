...
# extracted from Mandriva Linux Security Advisory MDVSA-2008:165. 
...
if (description)
{
  ...
  script_name(english:"Mandriva Linux Security Advisory : perl (MDVSA-2008:165)");
...
flag = 0;
if (rpm_check(release:"MDK2008.1", reference:"perl-5.10.0-13.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"perl-base-5.10.0-13.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"perl-devel-5.10.0-13.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"perl-doc-5.10.0-13.1mdv2008.1", yank:"mdv")) flag++;
if (rpm_check(release:"MDK2008.1", reference:"perl-suid-5.10.0-13.1mdv2008.1", yank:"mdv")) flag++;
