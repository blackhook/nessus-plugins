...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:045. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:045");

  script_name(english:"Mandriva Linux Security Advisory : e2fsprogs (MDVSA-2015:045)");
...
flag = 0;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"e2fsprogs-1.42.2-3.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ext2fs-devel-1.42.2-3.1.mbs1")) flag++;
if (rpm_check(release:"MDK-MBS1", cpu:"x86_64", reference:"lib64ext2fs2-1.42.2-3.1.mbs1")) flag++;
