...
if (description)
{
  ...
  script_name(english:"MySQL Cluster 7.4.x < 7.4.15 DD Subcomponent Arbitrary Data Manipulation (April 2017 CPU)");
...
to 7.4.15. It is, therefore, affected by an arbitrary data
...
of service condition.");
  # https://dev.mysql.com/doc/relnotes/mysql-cluster/7.4/en/mysql-cluster-news-7-4-15.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c9fee2f5");
...
"Upgrade to MySQL Cluster version 7.4.15 or later as referenced in the
...
mysql_check_version(variant:'Cluster', fixed:'7.4.15', min:'7.4', severity:SECURITY_WARNING);
