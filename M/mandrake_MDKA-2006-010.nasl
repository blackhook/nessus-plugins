...
# Mandrake Linux Security Advisory MDKA-2006:010.
#
...
are now available - fix translation for all programs; a new
klamav.pot file generated against the full string translation code -
full English and Brazilian Portuguese are now available");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDKA-2006:010");
...
if (rpm_check(reference:"klamav-0.32-1.1.20060mdk", release:"MDK2006.0", cpu:"i386", yank:"mdk")) flag++;
