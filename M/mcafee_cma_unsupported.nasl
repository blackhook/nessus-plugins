...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0547");
...
security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://www.mcafee.com/enterprise/en-us/support/product-eol.html#product=mcafee_agent");
