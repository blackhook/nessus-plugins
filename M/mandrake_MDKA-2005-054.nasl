...
# Mandrake Linux Security Advisory MDKA-2005:054.
#
...
The updated package has been fixed to correct this problem.");
  script_set_attribute(attribute:"see_also", value:"http://www.mandriva.com/security/advisories?name=MDKA-2005:054");
...
if (rpm_check(reference:"autofs-4.1.4-4.1.20060mdk", release:"MDK2006.0", cpu:"i386", yank:"mdk")) flag++;
