...
vulnerabilities as referenced in the mdb-1084-rn advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://mariadb.com/kb/en/mdb-1084-rn");
...
mysql_check_version(variant: 'MariaDB', min:'10.8.0-MariaDB', fixed:make_list('10.8.4-MariaDB'), severity:SECURITY_HOLE);