...
if (description)
{
  ...
  script_cve_id("CVE-2022-40772");
  script_xref(name:"IAVA", value:"2022-A-0497-S");

  script_name(english:"ManageEngine ServiceDesk Plus MSP < 10.6 Build 10609 Privilege Escalation");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server hosts an application that is affected by a privilege escalation vulnerability.");
  script_set_attribute(attribute:"description", value:
"A privilege escalation vulnerability exists in ManageEngine ServiceDesk Plus MSP prior to 10.6 Build
10609. This vulnerability allows an adversary to access restricted data in the Postgres database setup 
by using a specific PostgreSQL function in the query, which enables bypassing the validation mechanism.
...
number.");
  ...
  # https://www.manageengine.com/products/service-desk-msp/readme.html#10609
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1614844f");
  script_set_attribute(attribute:"solution", value:
"Upgrade to ManageEngine ServiceDesk Plus MSP version 10.6 Build 10609, or later.");
...
var constraints = [
  {'fixed_version': '10.6.10609', 'fixed_display': '10.6 Build 10609'}  
];
