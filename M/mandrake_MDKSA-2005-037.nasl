...
# extracted from Mandrake Linux Security Advisory MDKSA-2005:037. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2005:037");

  script_name(english:"Mandrake Linux Security Advisory : mailman (MDKSA-2005:037)");
...
directory traversal exploit using URLs of the form '.../....///' to
access private Mailman configuration data.
...
flag = 0;
if (rpm_check(release:"MDK10.0", reference:"mailman-2.1.4-2.3.100mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK10.1", reference:"mailman-2.1.5-7.3.101mdk", yank:"mdk")) flag++;
