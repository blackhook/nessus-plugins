...
if (description)
{
  ...
  script_name(english:"Firefox 3.6 < 3.6.12 Buffer Overflow");
...
"The installed version of Firefox 3.6 is earlier than 3.6.12.  Such
...
exploited in the wild.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a7474ff"); # http://www.mozilla.org/security/known-vulnerabilities/firefox36.html#firefox3.6.12

  script_set_attribute(attribute:"solution", value:"Upgrade to Firefox 3.6.12 or later.");
...
mozilla_check_version(installs:installs, product:'firefox', esr:FALSE, fix:'3.6.12', min:'3.6', severity:SECURITY_HOLE);