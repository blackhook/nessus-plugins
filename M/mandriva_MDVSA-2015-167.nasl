...
# extracted from Mandriva Linux Security Advisory MDVSA-2015:167. 
...
if (description)
{
  ...
  script_xref(name:"MDVSA", value:"2015:167");

  script_name(english:"Mandriva Linux Security Advisory : glpi (MDVSA-2015:167)");
...
information can in fact see the information when selecting cost as a
search criteria (CVE-2014-5032).
...
SQL commands via the condition parameter (CVE-2014-9258)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://advisories.mageia.org/MGASA-2015-0017.html"
  );
...
flag = 0;
if (rpm_check(release:"MDK-MBS2", reference:"glpi-0.84.3-3.1.mbs2")) flag++;
