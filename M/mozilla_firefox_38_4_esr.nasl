...
if (description)
{
  ...
  script_name(english:"Firefox ESR < 38.4 Multiple Vulnerabilities");
...
mozilla_check_version(installs:installs, product:'firefox', esr:TRUE, fix:'38.4', severity:SECURITY_HOLE);
