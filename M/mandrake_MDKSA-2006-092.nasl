...
# extracted from Mandrake Linux Security Advisory MDKSA-2006:092. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2006:092");

  script_name(english:"Mandrake Linux Security Advisory : mpg123 (MDKSA-2006:092)");
...
impacts via a certain MP3 file, as demonstrated by mpg1DoS3.
...
flag = 0;
if (rpm_check(release:"MDK2006.0", reference:"mpg123-0.59r-23.1.20060mdk", yank:"mdk")) flag++;
