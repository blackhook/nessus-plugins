...
# extracted from Mandrake Linux Security Advisory MDKSA-2002:021. 
...
if (description)
{
  ...
  script_xref(name:"MDKSA", value:"2002:021");

  script_name(english:"Mandrake Linux Security Advisory : mod_frontpage (MDKSA-2002:021)");
...
2002 extensions."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected mod_frontpage package."
  );
...
flag = 0;
if (rpm_check(release:"MDK8.0", cpu:"i386", reference:"mod_frontpage-1.6.1-3.1mdk", yank:"mdk")) flag++;

if (rpm_check(release:"MDK8.1", cpu:"i386", reference:"mod_frontpage-1.6.1-3.1mdk", yank:"mdk")) flag++;
