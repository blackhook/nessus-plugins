...
provided packages which are patched to fix both problems."
  ...
  # http://web.archive.org/web/20050309011613/http://lists.netsys.com:80/pipermail/full-disclosure/2003-September/010287.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c115d47"
  );
  script_set_attribute(
    attribute:"see_also",
