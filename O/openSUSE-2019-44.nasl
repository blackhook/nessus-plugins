...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2019-44 patch");
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1119368"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1119419"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.haproxy.org/download/1.8/src/CHANGELOG"
  );
  script_set_attribute(
    attribute:"solution", 
