...
# extracted from openSUSE Security Update openSUSE-2016-1220.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gd (openSUSE-2016-1220)");
  script_summary(english:"Check for the openSUSE-2016-1220 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"gd-2.1.0-7.19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"gd-debuginfo-2.1.0-7.19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"gd-debugsource-2.1.0-7.19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"gd-devel-2.1.0-7.19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libgd3-2.1.0-7.19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libgd3-debuginfo-2.1.0-7.19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libgd3-32bit-2.1.0-7.19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libgd3-debuginfo-32bit-2.1.0-7.19.1") ) flag++;
