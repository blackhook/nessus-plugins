...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 / 5 : ghostscript (ELSA-2009-0345)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:0345 :
...
packages, which contain a backported patch to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-March/000920.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-March/000922.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-March/000925.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"ghostscript-7.05-32.1.17")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"ghostscript-7.05-32.1.17")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"ghostscript-devel-7.05-32.1.17")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"ghostscript-devel-7.05-32.1.17")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"hpijs-1.3-32.1.17")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"hpijs-1.3-32.1.17")) flag++;

if (rpm_check(release:"EL4", reference:"ghostscript-7.07-33.2.el4_7.5")) flag++;
if (rpm_check(release:"EL4", reference:"ghostscript-devel-7.07-33.2.el4_7.5")) flag++;
if (rpm_check(release:"EL4", reference:"ghostscript-gtk-7.07-33.2.el4_7.5")) flag++;

if (rpm_check(release:"EL5", reference:"ghostscript-8.15.2-9.4.el5_3.4")) flag++;
if (rpm_check(release:"EL5", reference:"ghostscript-devel-8.15.2-9.4.el5_3.4")) flag++;
if (rpm_check(release:"EL5", reference:"ghostscript-gtk-8.15.2-9.4.el5_3.4")) flag++;
