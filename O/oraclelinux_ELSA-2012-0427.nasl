...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0427 :
...
be restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-March/002718.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libtasn1-2.3-3.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"libtasn1-devel-2.3-3.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"libtasn1-tools-2.3-3.el6_2.1")) flag++;
