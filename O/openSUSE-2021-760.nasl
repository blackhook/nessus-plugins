...
# extracted from openSUSE Security Update openSUSE-2021-760.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : lz4 (openSUSE-2021-760)");
  script_summary(english:"Check for the openSUSE-2021-760 patch");
...
"This update for lz4 fixes the following issues :
  ...
  - CVE-2021-3520: Fixed memory corruption due to an integer
    overflow bug caused by memmove argument (bsc#1185438).

This update was imported from the SUSE:SLE-15:Update update project."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1185438"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected lz4 packages.");
...
if ( rpm_check(release:"SUSE15.2", reference:"liblz4-1-1.8.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"liblz4-1-debuginfo-1.8.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"liblz4-devel-1.8.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"lz4-1.8.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"lz4-debuginfo-1.8.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"lz4-debugsource-1.8.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"liblz4-1-32bit-1.8.0-lp152.5.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"liblz4-1-32bit-debuginfo-1.8.0-lp152.5.3.1") ) flag++;
