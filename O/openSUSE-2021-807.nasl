...
# extracted from openSUSE Security Update openSUSE-2021-807.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libX11 (openSUSE-2021-807)");
  script_summary(english:"Check for the openSUSE-2021-807 patch");
...
"This update for libX11 fixes the following issues :
  ...
  - CVE-2021-31535: Fixed missing request length checks in
    libX11 (bsc#1182506).
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182506"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.2", reference:"libX11-6-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libX11-6-debuginfo-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libX11-data-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libX11-debugsource-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libX11-devel-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libX11-xcb1-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"libX11-xcb1-debuginfo-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libX11-6-32bit-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libX11-6-32bit-debuginfo-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libX11-devel-32bit-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libX11-xcb1-32bit-1.6.5-lp152.5.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"libX11-xcb1-32bit-debuginfo-1.6.5-lp152.5.15.1") ) flag++;
