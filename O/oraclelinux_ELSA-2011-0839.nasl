...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0839 :
...
must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-June/002165.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"gimp-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"gimp-devel-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"gimp-devel-tools-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"gimp-help-browser-2.6.9-4.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"gimp-libs-2.6.9-4.el6_1.1")) flag++;
