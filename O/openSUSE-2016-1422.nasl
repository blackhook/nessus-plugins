...
# extracted from openSUSE Security Update openSUSE-2016-1422.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libXtst (openSUSE-2016-1422)");
  script_summary(english:"Check for the openSUSE-2016-1422 patch");
...
"This update of libXtst fixes the following security issue :
  ...
  - malicious data sent from an untrusted or compromised X
    server could cause out of boundary memory access or
    endless loops (Denial of Service). (boo#1003012,
...
if ( rpm_check(release:"SUSE13.2", reference:"libXtst-debugsource-1.2.2-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libXtst-devel-1.2.2-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libXtst6-1.2.2-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libXtst6-debuginfo-1.2.2-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libXtst-devel-32bit-1.2.2-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libXtst6-32bit-1.2.2-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libXtst6-debuginfo-32bit-1.2.2-4.3.1") ) flag++;
