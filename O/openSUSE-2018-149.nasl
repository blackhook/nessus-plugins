...
# extracted from openSUSE Security Update openSUSE-2018-149.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2018-6187", "CVE-2018-6192", "CVE-2018-6544");

  script_name(english:"openSUSE Security Update : mupdf (openSUSE-2018-149)");
  script_summary(english:"Check for the openSUSE-2018-149 patch");
...
These security issues were fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1077407"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1077755"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1079100"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.3", reference:"mupdf-1.12.0-28.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mupdf-devel-static-1.12.0-28.1") ) flag++;
