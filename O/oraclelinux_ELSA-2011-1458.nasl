...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1458 :
...
(named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-November/002470.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-November/002471.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"bind-9.3.6-16.P1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind-chroot-9.3.6-16.P1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind-devel-9.3.6-16.P1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind-libbind-devel-9.3.6-16.P1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind-libs-9.3.6-16.P1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind-sdb-9.3.6-16.P1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind-utils-9.3.6-16.P1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"caching-nameserver-9.3.6-16.P1.el5_7.1")) flag++;

if (rpm_check(release:"EL6", reference:"bind-9.7.3-2.el6_1.P3.3")) flag++;
if (rpm_check(release:"EL6", reference:"bind-chroot-9.7.3-2.el6_1.P3.3")) flag++;
if (rpm_check(release:"EL6", reference:"bind-devel-9.7.3-2.el6_1.P3.3")) flag++;
if (rpm_check(release:"EL6", reference:"bind-libs-9.7.3-2.el6_1.P3.3")) flag++;
if (rpm_check(release:"EL6", reference:"bind-sdb-9.7.3-2.el6_1.P3.3")) flag++;
if (rpm_check(release:"EL6", reference:"bind-utils-9.7.3-2.el6_1.P3.3")) flag++;
