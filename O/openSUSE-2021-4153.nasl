...
# openSUSE Security Update openSUSE-SU-2021:4153-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : openssh (openSUSE-SU-2021:4153-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:4153-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/YUBQLVRKYJRPQIBMWLSE4P7CEU335GGW/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc63eca7");
...
var pkgs = [
    {'reference':'openssh-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssh-askpass-gnome-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssh-cavs-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssh-clients-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssh-common-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssh-fips-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssh-helpers-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'openssh-server-8.4p1-3.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
