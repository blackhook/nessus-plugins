...
# Security Advisory OVMSA-2014-0001.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : xen (OVMSA-2014-0001)");
...
18206135] [CVE-2014-XXXX]"
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2014-February/000203.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d139b1a1"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"xen-4.1.3-25.el5.88.3")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-devel-4.1.3-25.el5.88.3")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-tools-4.1.3-25.el5.88.3")) flag++;
