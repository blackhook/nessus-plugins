...
if (description)
{
  ...
  script_name(english:"OpenJDK 7 <= 7u231 / 8 <= 8u222 / 11.0.0 <= 11.0.4 / 13.0.0 <= 13.0.0 Multiple Vulnerabilities (2019-10-15)");

  script_set_attribute(attribute:"synopsis", value:
"OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenJDK installed on the remote host is prior to 7 <= 7u231 / 8 <= 8u222 / 11.0.0 <= 11.0.4 / 13.0.0 <=
13.0.0. It is, therefore, affected by multiple vulnerabilities as referenced in the 2019-10-15 advisory.
...
versions from the referenced OpenJDK security advisory.
  ...
  - Vulnerability in the Java SE product of Oracle Java SE (component: Hotspot). Supported versions that are
    ...
    can result in unauthorized read access to a subset of Java SE accessible data and unauthorized ability to
    cause a partial denial of service (partial DOS) of Java SE. Note: This vulnerability applies to Java
    ...
    that load and run only trusted code (e.g., code installed by an administrator). CVSS 3.0 Base Score 4.8
    (Confidentiality and Availability impacts). CVSS Vector: (CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:N/A:L).
    (CVE-2019-2977)
  ...
  - Vulnerability in the Java SE, Java SE Embedded product of Oracle Java SE (component: Security). Supported
    ...
    exploit vulnerability allows unauthenticated attacker with network access via multiple protocols to
    compromise Java SE, Java SE Embedded. Successful attacks of this vulnerability can result in unauthorized
    read access to a subset of Java SE, Java SE Embedded accessible data. Note: This vulnerability applies to
    Java deployments, typically in clients running sandboxed Java Web Start applications or sandboxed Java
    applets (in Java SE 8), that load and run untrusted code (e.g., code that comes from the internet) and
    rely on the Java sandbox for security. This vulnerability can also be exploited by using APIs in the
    specified Component, e.g., through a web service which supplies data to the APIs. CVSS 3.0 Base Score 3.7
    (Confidentiality impacts). CVSS Vector: (CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:N/A:N). (CVE-2019-2894)
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://openjdk.java.net/groups/vulnerability/advisories/2019-10-15");
  script_set_attribute(attribute:"solution", value:
"Upgrade to an OpenJDK version greater than 7u231 / 8u222 / 11.0.4 / 13.0.0");
...
var constraints = [
  { 'min_version' : '7.0.0', 'max_version' : '7.0.231', 'fixed_display' : 'Upgrade to a version greater than 7u231' },
  { 'min_version' : '8.0.0', 'max_version' : '8.0.222', 'fixed_display' : 'Upgrade to a version greater than 8u222' },
  { 'min_version' : '11.0.0', 'max_version' : '11.0.4', 'fixed_display' : 'Upgrade to a version greater than 11.0.4' },
  { 'min_version' : '13.0.0', 'max_version' : '13.0.0', 'fixed_display' : 'Upgrade to a version greater than 13.0.0' }
];
