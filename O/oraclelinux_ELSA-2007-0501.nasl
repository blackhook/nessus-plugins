...
# Oracle Linux Security Advisory ELSA-2007-0501 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : libexif (ELSA-2007-0501)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0501 :
...
contain a backported patch and are not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000175.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000225.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"libexif-0.5.12-5.1.0.2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"libexif-0.5.12-5.1.0.2")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"libexif-devel-0.5.12-5.1.0.2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"libexif-devel-0.5.12-5.1.0.2")) flag++;

if (rpm_check(release:"EL5", reference:"libexif-0.6.13-4.0.2.el5")) flag++;
if (rpm_check(release:"EL5", reference:"libexif-devel-0.6.13-4.0.2.el5")) flag++;
