...
# extracted from openSUSE Security Update openSUSE-2018-9.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kernel-firmware (openSUSE-2018-9) (Spectre)");
  script_summary(english:"Check for the openSUSE-2018-9 patch");
...
processor to mitigate an attack on the branch predictor that could
...
if ( rpm_check(release:"SUSE42.2", reference:"kernel-firmware-20170530-7.12.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"ucode-amd-20170530-7.12.1") ) flag++;
