...
# Oracle Linux Security Advisory ELSA-2007-0235 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : util-linux (ELSA-2007-0235)");
...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-May/000145.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"util-linux-2.12a-16.EL4.25")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"util-linux-2.12a-16.EL4.25")) flag++;
