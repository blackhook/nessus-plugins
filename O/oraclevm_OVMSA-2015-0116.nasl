...
# Security Advisory OVMSA-2015-0116.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 : net-snmp (OVMSA-2015-0116)");
...
critical security updates :
  ...
  - Fixed parsing of invalid variables in incoming packets
    (#1248410)"
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2015-August/000364.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eddb50c1"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"net-snmp-5.5-54.0.1.el6_7.1")) flag++;
if (rpm_check(release:"OVS3.3", reference:"net-snmp-libs-5.5-54.0.1.el6_7.1")) flag++;
if (rpm_check(release:"OVS3.3", reference:"net-snmp-utils-5.5-54.0.1.el6_7.1")) flag++;
