...
# extracted from openSUSE Security Update openSUSE-2020-2067.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.14 (openSUSE-2020-2067)");
  script_summary(english:"Check for the openSUSE-2020-2067 patch");
...
if ( rpm_check(release:"SUSE15.2", reference:"go1.14-1.14.12-lp152.2.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"go1.14-race-1.14.12-lp152.2.12.1") ) flag++;
