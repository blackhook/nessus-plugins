...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-3973.html");
...
pkgs = [
    {'reference':'spamassassin-3.4.0-6.el7', 'cpu':'aarch64', 'release':'7'},
    {'reference':'spamassassin-3.4.0-6.el7', 'cpu':'x86_64', 'release':'7'}
];
