...
# Oracle Linux Security Advisory ELSA-2009-1500 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : xpdf (ELSA-2009-1500)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:1500 :
...
backported patch to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-October/001204.html"
  );
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"xpdf-2.02-17.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"xpdf-2.02-17.el3")) flag++;
