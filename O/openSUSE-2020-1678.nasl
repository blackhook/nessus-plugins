...
# extracted from openSUSE Security Update openSUSE-2020-1678.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : crmsh (openSUSE-2020-1678)");
  script_summary(english:"Check for the openSUSE-2020-1678 patch");
...
if ( rpm_check(release:"SUSE15.2", reference:"crmsh-4.2.0+git.1602225426.5f84efb5-lp152.4.27.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"crmsh-scripts-4.2.0+git.1602225426.5f84efb5-lp152.4.27.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"crmsh-test-4.2.0+git.1602225426.5f84efb5-lp152.4.27.1") ) flag++;
