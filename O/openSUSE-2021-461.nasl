...
# extracted from openSUSE Security Update openSUSE-2021-461.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tor (openSUSE-2021-461)");
...
- https://lists.torproject.org/pipermail/tor-announce/2021-March/000216.html
  ...
  + Disable the dump_desc() function that we used to dump
    unparseable information to disk (CVE-2021-28089)

  + Fix a bug in appending detached signatures to a pending
    consensus document that could be used to crash a
    directory authority (CVE-2021-28090)

  - Ship geoip files based on the IPFire Location Database");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1183726");
  # https://lists.torproject.org/pipermail/tor-announce/2021-March/000216.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?282a2bf5");
...
if ( rpm_check(release:"SUSE15.2", reference:"tor-0.4.5.7-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tor-debuginfo-0.4.5.7-lp152.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tor-debugsource-0.4.5.7-lp152.2.9.1") ) flag++;
