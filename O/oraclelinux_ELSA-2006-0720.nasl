...
# Oracle Linux Security Advisory ELSA-2006-0720 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 : kdelibs (ELSA-2006-0720)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2006:0720 :
...
backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2006-November/000013.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-March/000101.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"kdelibs-3.1.3-6.12.0.1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"kdelibs-3.1.3-6.12.0.1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"kdelibs-devel-3.1.3-6.12.0.1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"kdelibs-devel-3.1.3-6.12.0.1")) flag++;

if (rpm_check(release:"EL4", cpu:"i386", reference:"kdelibs-3.3.1-6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"kdelibs-3.3.1-6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"kdelibs-devel-3.3.1-6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"kdelibs-devel-3.3.1-6.1")) flag++;
