...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:0276 :
...
restart') for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-February/003296.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libvirt-0.10.2-18.0.1.el6")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-client-0.10.2-18.0.1.el6")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-devel-0.10.2-18.0.1.el6")) flag++;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"libvirt-lock-sanlock-0.10.2-18.0.1.el6")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-python-0.10.2-18.0.1.el6")) flag++;
