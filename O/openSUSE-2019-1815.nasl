...
if ( rpm_check(release:"SUSE15.1", reference:"chromium-75.0.3770.142-lp151.2.12.4", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debuginfo-75.0.3770.142-lp151.2.12.4", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debugsource-75.0.3770.142-lp151.2.12.4", allowmaj:TRUE) ) flag++;
