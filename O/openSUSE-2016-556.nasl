...
# extracted from openSUSE Security Update openSUSE-2016-556.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : giflib (openSUSE-2016-556)");
  script_summary(english:"Check for the openSUSE-2016-556 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"giflib-debugsource-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"giflib-devel-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"giflib-progs-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"giflib-progs-debuginfo-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgif6-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgif6-debuginfo-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"giflib-devel-32bit-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgif6-32bit-5.0.5-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgif6-debuginfo-32bit-5.0.5-10.1") ) flag++;
