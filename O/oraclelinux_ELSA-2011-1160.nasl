...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 / 6 : dhcp (ELSA-2011-1160)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1160 :
...
update, all DHCP servers will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-August/002280.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-August/002281.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-August/002282.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", reference:"dhclient-3.0.1-68.el4")) flag++;
if (rpm_check(release:"EL4", reference:"dhcp-3.0.1-68.el4")) flag++;
if (rpm_check(release:"EL4", reference:"dhcp-devel-3.0.1-68.el4")) flag++;

if (rpm_check(release:"EL5", reference:"dhclient-3.0.5-29.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"dhcp-3.0.5-29.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"dhcp-devel-3.0.5-29.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"libdhcp4client-3.0.5-29.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"libdhcp4client-devel-3.0.5-29.el5_7.1")) flag++;

if (rpm_check(release:"EL6", reference:"dhclient-4.1.1-19.P1.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"dhcp-4.1.1-19.P1.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"dhcp-devel-4.1.1-19.P1.el6_1.1")) flag++;
