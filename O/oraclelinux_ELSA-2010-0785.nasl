...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : quagga (ELSA-2010-0785)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0785 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-October/001697.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-October/001701.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"quagga-0.98.3-4.el4_8.1")) flag++;
if (rpm_check(release:"EL4", reference:"quagga-contrib-0.98.3-4.el4_8.1")) flag++;
if (rpm_check(release:"EL4", reference:"quagga-devel-0.98.3-4.el4_8.1")) flag++;

if (rpm_check(release:"EL5", reference:"quagga-0.98.6-5.el5_5.2")) flag++;
if (rpm_check(release:"EL5", reference:"quagga-contrib-0.98.6-5.el5_5.2")) flag++;
if (rpm_check(release:"EL5", reference:"quagga-devel-0.98.6-5.el5_5.2")) flag++;
