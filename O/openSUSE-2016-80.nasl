...
# extracted from openSUSE Security Update openSUSE-2016-80.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : roundcubemail (openSUSE-2016-80)");
  script_summary(english:"Check for the openSUSE-2016-80 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"roundcubemail-1.1.4-6.1") ) flag++;
