...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2014:0370 :
...
automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-April/004062.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"httpd-2.2.15-30.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"httpd-devel-2.2.15-30.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"httpd-manual-2.2.15-30.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"httpd-tools-2.2.15-30.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"mod_ssl-2.2.15-30.0.1.el6_5")) flag++;
