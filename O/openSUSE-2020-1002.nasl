...
# extracted from openSUSE Security Update openSUSE-2020-1002.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-ipaddress (openSUSE-2020-1002)");
  script_summary(english:"Check for the openSUSE-2020-1002 patch");
...
if ( rpm_check(release:"SUSE15.2", reference:"python-ipaddress-1.0.18-lp152.4.3.1") ) flag++;
