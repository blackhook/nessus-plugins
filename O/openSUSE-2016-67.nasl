...
# extracted from openSUSE Security Update openSUSE-2016-67.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cups-filters (openSUSE-2016-67)");
  script_summary(english:"Check for the openSUSE-2016-67 patch");
...
CVE-2015-8327 adds backtick and semicolon to the list of
illegal shell escape characters (bsc#957531).
...
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-cups-browsed-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-cups-browsed-debuginfo-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-debuginfo-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-debugsource-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-devel-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-foomatic-rip-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-foomatic-rip-debuginfo-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-ghostscript-1.0.58-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cups-filters-ghostscript-debuginfo-1.0.58-12.1") ) flag++;
