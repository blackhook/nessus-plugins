...
# extracted from openSUSE Security Update openSUSE-2016-497.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : giflib (openSUSE-2016-497)");
  script_summary(english:"Check for the openSUSE-2016-497 patch");
...
Heap buffer overflow in gif2rgb (CVE-2016-3977)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=974847"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.1", reference:"giflib-debugsource-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"giflib-devel-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"giflib-progs-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"giflib-progs-debuginfo-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libgif6-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libgif6-debuginfo-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"giflib-devel-32bit-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libgif6-32bit-5.0.5-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libgif6-debuginfo-32bit-5.0.5-2.9.1") ) flag++;
