...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1085 :
...
restarted (log out, then log back in) for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-July/002243.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"freetype-2.3.11-6.el6_1.6")) flag++;
if (rpm_check(release:"EL6", reference:"freetype-demos-2.3.11-6.el6_1.6")) flag++;
if (rpm_check(release:"EL6", reference:"freetype-devel-2.3.11-6.el6_1.6")) flag++;
