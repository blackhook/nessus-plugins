...
# Oracle Linux Security Advisory ELSA-2011-0181 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : openoffice.org (ELSA-2011-0181)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0181 :
...
for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-January/001807.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"openoffice.org-1.1.5-10.7.el4_8.10")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"openoffice.org-1.1.5-10.7.el4_8.10")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"openoffice.org-i18n-1.1.5-10.7.el4_8.10")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"openoffice.org-i18n-1.1.5-10.7.el4_8.10")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"openoffice.org-kde-1.1.5-10.7.el4_8.10")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"openoffice.org-libs-1.1.5-10.7.el4_8.10")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"openoffice.org-libs-1.1.5-10.7.el4_8.10")) flag++;
