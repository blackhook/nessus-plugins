...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : samba3x (ELSA-2017-1272) (SambaCry)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"From Red Hat Security Advisory 2017:1272 :
...
issue. Upstream acknowledges steelo as the original reporter.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2017-May/006957.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected samba3x packages.");
...
flag = 0;
if (rpm_check(release:"EL5", reference:"samba3x-3.6.23-13.0.2.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-client-3.6.23-13.0.2.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-common-3.6.23-13.0.2.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-doc-3.6.23-13.0.2.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-domainjoin-gui-3.6.23-13.0.2.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-swat-3.6.23-13.0.2.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-winbind-3.6.23-13.0.2.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-winbind-devel-3.6.23-13.0.2.el5_11")) flag++;
