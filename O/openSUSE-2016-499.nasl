...
# extracted from openSUSE Security Update openSUSE-2016-499.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xerces-c (openSUSE-2016-499)");
  script_summary(english:"Check for the openSUSE-2016-499 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"libxerces-c-3_1-3.1.1-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libxerces-c-3_1-debuginfo-3.1.1-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libxerces-c-devel-3.1.1-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"xerces-c-3.1.1-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"xerces-c-debuginfo-3.1.1-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"xerces-c-debugsource-3.1.1-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libxerces-c-3_1-32bit-3.1.1-16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libxerces-c-3_1-debuginfo-32bit-3.1.1-16.1") ) flag++;
