...
# extracted from openSUSE Security Update openSUSE-2013-75.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : coreutils (openSUSE-SU-2013:0232-1)");
  script_summary(english:"Check for the openSUSE-2013-75 patch");
...
"  - Avoid segmentation fault in 'join -i' with long line
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-02/msg00001.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.1", reference:"coreutils-8.14-3.19.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"coreutils-debuginfo-8.14-3.19.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"coreutils-debugsource-8.14-3.19.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"coreutils-lang-8.14-3.19.1") ) flag++;
