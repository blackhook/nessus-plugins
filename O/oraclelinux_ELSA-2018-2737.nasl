...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:2737 :
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-September/008045.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"mod_perl-2.0.4-12.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"mod_perl-devel-2.0.4-12.el6_10")) flag++;
