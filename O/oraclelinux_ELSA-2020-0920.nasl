...
[0.9.11-9.1]
- Fix CVE-2019-15690 (an integer overflow in HandleCursorShape() in a 
client)
(bug #1814342)"
  );
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-March/009755.html");
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"libvncserver-0.9.11-9.el8_1.2")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"libvncserver-devel-0.9.11-9.el8_1.2")) flag++;
