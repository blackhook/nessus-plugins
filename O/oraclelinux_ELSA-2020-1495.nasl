...
"From Red Hat Security Advisory 2020:1495 :
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-April/009847.html");
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"thunderbird-68.7.0-1.0.1.el8_1", allowmaj:TRUE)) flag++;
