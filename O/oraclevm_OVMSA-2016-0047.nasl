...
# Security Advisory OVMSA-2016-0047.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : kernel-uek (OVMSA-2016-0047)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2016-May/000458.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"kernel-uek-4.1.12-37.2.2.el6uek")) flag++;
if (rpm_check(release:"OVS3.4", reference:"kernel-uek-firmware-4.1.12-37.2.2.el6uek")) flag++;
