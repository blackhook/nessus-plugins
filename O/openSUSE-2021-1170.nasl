...
# openSUSE Security Update openSUSE-SU-2021:1170-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : isync (openSUSE-SU-2021:1170-1)");
...
openSUSE-SU-2021:1170-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1186939");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/6A6P63QN4YYJFZ5R2SZQBKXYFGDXZYW4/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f0cad55");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-3578");
...
"Update the affected isync package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-3578");
...
var pkgs = [
    {'reference':'isync-1.3.6-lp152.4.6.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
