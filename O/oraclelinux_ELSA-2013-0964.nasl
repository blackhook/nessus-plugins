...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-June/003539.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"tomcat6-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-admin-webapps-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-docs-webapp-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-el-2.1-api-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-javadoc-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-jsp-2.1-api-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-lib-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-servlet-2.5-api-6.0.24-57.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"tomcat6-webapps-6.0.24-57.el6_4")) flag++;
