...
ELSA-2018-2164 advisory.
  ...
  - A flaw was found in the way the Linux kernel handled exceptions delivered after a stack switch operation
    via Mov SS or Pop SS instructions. During the stack switch operation, processor does not deliver
    interrupts and exceptions, they are delivered once the first instruction after the stack switch is
    executed. An unprivileged system user could use this flaw to crash the system kernel resulting in DoS.
    This CVE-2018-10872 was assigned due to regression of CVE-2018-8897 in Red Hat Enterprise Linux 6.10 GA
    kernel. No other versions are affected by this CVE. (CVE-2018-10872)
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-2.6.32-754.2.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-2.6.32'},
    ...
    {'reference':'kernel-firmware-2.6.32-754.2.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
