...
# extracted from openSUSE Security Update openSUSE-2012-89.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (openSUSE-2012-89)");
  script_summary(english:"Check for the openSUSE-2012-89 patch");
...
http://www.opera.com/docs/changelogs/unix/1161/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f22e0758"
  );
  # http://www.opera.com/support/kb/view/1008/
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE12.1", reference:"opera-11.61-6.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"opera-gtk-11.61-6.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"opera-kde4-11.61-6.1") ) flag++;
