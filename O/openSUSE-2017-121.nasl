...
# extracted from openSUSE Security Update openSUSE-2017-121.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libgit2 (openSUSE-2017-121)");
  script_summary(english:"Check for the openSUSE-2017-121 patch");
...
"This update for libgit2 fixes the following issues :
  ...
  - CVE-2016-8568: Fixed and out-of-bounds read in
    git_oid_nfmt (bsc#1003810).

  - CVE-2016-8569: DoS using a NULL pointer dereference in
    git_commit_message (bsc#1003810)."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.1", reference:"libgit2-22-0.22.1-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgit2-22-debuginfo-0.22.1-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgit2-debugsource-0.22.1-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgit2-devel-0.22.1-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgit2-22-32bit-0.22.1-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgit2-22-debuginfo-32bit-0.22.1-5.1") ) flag++;
