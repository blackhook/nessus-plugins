...
# extracted from openSUSE Security Update openSUSE-2017-560.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libressl (openSUSE-2017-560)");
  script_summary(english:"Check for the openSUSE-2017-560 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"libcrypto41-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libcrypto41-debuginfo-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libressl-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libressl-debuginfo-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libressl-debugsource-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libressl-devel-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libssl43-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libssl43-debuginfo-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libtls15-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libtls15-debuginfo-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libcrypto41-32bit-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libcrypto41-debuginfo-32bit-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libressl-devel-32bit-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libssl43-32bit-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libssl43-debuginfo-32bit-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libtls15-32bit-2.5.3-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libtls15-debuginfo-32bit-2.5.3-13.1") ) flag++;
