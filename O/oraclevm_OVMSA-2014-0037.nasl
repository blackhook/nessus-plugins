...
# Security Advisory OVMSA-2014-0037.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : ovs-agent (OVMSA-2014-0037) (POODLE)");
...
critical security updates :
  ...
  - Allow to create more than 6 bonds Singed-off-by: Adnan
    Misherfi");
  # https://oss.oracle.com/pipermail/oraclevm-errata/2014-November/000241.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7109f25f");
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"ovs-agent-3.2.8-1.3")) flag++;
