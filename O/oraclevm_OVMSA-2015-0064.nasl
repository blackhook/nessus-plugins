...
# Security Advisory OVMSA-2015-0064.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 : xen (OVMSA-2015-0064)");
...
OVMSA-2015-0064 for details."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2015-June/000312.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"xen-4.3.0-55.el6.22.46")) flag++;
if (rpm_check(release:"OVS3.3", reference:"xen-tools-4.3.0-55.el6.22.46")) flag++;
