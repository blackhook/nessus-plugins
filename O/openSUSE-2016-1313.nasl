...
# extracted from openSUSE Security Update openSUSE-2016-1313.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : memcached (openSUSE-2016-1313)");
  script_summary(english:"Check for the openSUSE-2016-1313 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"memcached-1.4.20-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"memcached-debuginfo-1.4.20-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"memcached-debugsource-1.4.20-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"memcached-1.4.22-6.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"memcached-debuginfo-1.4.22-6.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"memcached-debugsource-1.4.22-6.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"memcached-devel-1.4.22-6.1") ) flag++;
