...
# extracted from openSUSE Security Update openSUSE-2012-840.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh (openSUSE-SU-2012:1620-1)");
  script_summary(english:"Check for the openSUSE-2012-840 patch");
...
could have security implications (Code execution, Denial of Service)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-12/msg00014.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.2", reference:"libssh-debugsource-0.5.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libssh-devel-0.5.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libssh4-0.5.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libssh4-debuginfo-0.5.2-2.4.1") ) flag++;
