...
# Security Advisory OVMSA-2016-0146.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : bind (OVMSA-2016-0146)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2016-October/000565.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?20e89d70"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"bind-libs-9.3.6-25.P1.el5_11.10")) flag++;
if (rpm_check(release:"OVS3.2", reference:"bind-utils-9.3.6-25.P1.el5_11.10")) flag++;
