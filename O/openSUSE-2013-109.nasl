...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2013-109 patch");
...
Also check out http://www.opera.com/docs/changelogs/unix/1213"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-02/msg00025.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-02/msg00088.html"
  );
  script_set_attribute(
    attribute:"solution", 
