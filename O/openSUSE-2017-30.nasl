...
# extracted from openSUSE Security Update openSUSE-2017-30.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : syncthing / syncthing-gtk (openSUSE-2017-30)");
  script_summary(english:"Check for the openSUSE-2017-30 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"syncthing-0.14.16-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"syncthing-gtk-0.9.2.3-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"syncthing-gtk-lang-0.9.2.3-3.1") ) flag++;
