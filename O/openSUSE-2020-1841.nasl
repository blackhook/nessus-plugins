...
# extracted from openSUSE Security Update openSUSE-2020-1841.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tigervnc (openSUSE-2020-1841)");
  script_summary(english:"Check for the openSUSE-2020-1841 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176733"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.1", reference:"libXvnc-devel-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libXvnc1-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libXvnc1-debuginfo-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tigervnc-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tigervnc-debuginfo-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tigervnc-debugsource-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tigervnc-x11vnc-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"xorg-x11-Xvnc-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"xorg-x11-Xvnc-debuginfo-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"xorg-x11-Xvnc-java-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"xorg-x11-Xvnc-module-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"xorg-x11-Xvnc-module-debuginfo-1.9.0-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"xorg-x11-Xvnc-novnc-1.9.0-lp151.4.9.1") ) flag++;
