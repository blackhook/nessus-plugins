...
# extracted from openSUSE Security Update openSUSE-2016-876.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xerces-c (openSUSE-2016-876)");
  script_summary(english:"Check for the openSUSE-2016-876 patch");
...
"This update for xerces-c fixes the following issues :
  ...
  - CVE-2016-4463 Apache Xerces-C XML Parser Crashes on
    Malformed DT (boo#985860) 

  - CVE-2016-2099 Exception handling mistake causing use
    after free (boo#979208)"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.2", reference:"libxerces-c-3_1-3.1.4-13.9.2") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libxerces-c-3_1-debuginfo-3.1.4-13.9.2") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libxerces-c-devel-3.1.4-13.9.2") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"xerces-c-3.1.4-13.9.2") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"xerces-c-debuginfo-3.1.4-13.9.2") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"xerces-c-debugsource-3.1.4-13.9.2") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libxerces-c-3_1-32bit-3.1.4-13.9.2") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libxerces-c-3_1-debuginfo-32bit-3.1.4-13.9.2") ) flag++;
