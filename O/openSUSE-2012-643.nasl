...
# extracted from openSUSE Security Update openSUSE-2012-643.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dhcp (openSUSE-SU-2012:1252-1)");
  script_summary(english:"Check for the openSUSE-2012-643 patch");
...
"  - Update to ISC dhcp-4.2.4-P2 release, providing a
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-09/msg00103.html"
  );
...
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-client-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-client-debuginfo-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-debuginfo-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-debugsource-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-devel-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-relay-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-relay-debuginfo-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-server-4.2.4.P2-0.6.13.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"dhcp-server-debuginfo-4.2.4.P2-0.6.13.1") ) flag++;
