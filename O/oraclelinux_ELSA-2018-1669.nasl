...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : libvirt (ELSA-2018-1669) (Spectre)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:1669 :
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-May/007756.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libvirt-0.10.2-62.0.1.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-client-0.10.2-62.0.1.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-devel-0.10.2-62.0.1.el6_9.2")) flag++;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"libvirt-lock-sanlock-0.10.2-62.0.1.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-python-0.10.2-62.0.1.el6_9.2")) flag++;
