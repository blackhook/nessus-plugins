...
# openSUSE Security Update openSUSE-SU-2021:2664-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : golang-github-prometheus-prometheus (openSUSE-SU-2021:2664-1)");
...
openSUSE-SU-2021:2664-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/W3KPAMVZLF5BC7A6E5Z2QSNUUFHXGK6B/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?faf8fefa");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-29622");
  script_set_attribute(attribute:"solution", value:
"Update the affected golang-github-prometheus-prometheus package.");
...
var pkgs = [
    {'reference':'golang-github-prometheus-prometheus-2.27.1-3.8.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'golang-github-prometheus-prometheus');
}
