...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-549 patch");
...
Update to 0.22.0
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1169381"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected crawl packages."
  );
