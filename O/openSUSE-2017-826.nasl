...
# extracted from openSUSE Security Update openSUSE-2017-826.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xorg-x11-server (openSUSE-2017-826)");
  script_summary(english:"Check for the openSUSE-2017-826 patch");
...
"This update for xorg-x11-server fixes the following issues :
  ...
  - Improve retrieval of entropy for generating random
    authentication cookies (bsc#1025084)
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1047154"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.3", reference:"xorg-x11-server-7.6_1.18.3-22.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xorg-x11-server-debuginfo-7.6_1.18.3-22.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xorg-x11-server-debugsource-7.6_1.18.3-22.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xorg-x11-server-extra-7.6_1.18.3-22.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xorg-x11-server-extra-debuginfo-7.6_1.18.3-22.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xorg-x11-server-sdk-7.6_1.18.3-22.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xorg-x11-server-source-7.6_1.18.3-22.1") ) flag++;
