...
daemon (named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-June/002853.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"bind97-9.7.0-10.P2.el5_8.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-chroot-9.7.0-10.P2.el5_8.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-devel-9.7.0-10.P2.el5_8.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-libs-9.7.0-10.P2.el5_8.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-utils-9.7.0-10.P2.el5_8.1")) flag++;
