...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1081 :
...
which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-July/002932.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-July/002933.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"sudo-1.7.2p1-14.el5_8")) flag++;

if (rpm_check(release:"EL6", reference:"sudo-1.7.4p5-12.el6_3")) flag++;
