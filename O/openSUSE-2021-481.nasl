...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2021-481 patch");
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1183370"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1183371"
  );
