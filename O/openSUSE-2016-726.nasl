...
# extracted from openSUSE Security Update openSUSE-2016-726.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav-database (openSUSE-2016-726)");
  script_summary(english:"Check for the openSUSE-2016-726 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"clamav-database-201606130003-109.1") ) flag++;
