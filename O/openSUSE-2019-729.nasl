...
# extracted from openSUSE Security Update openSUSE-2019-729.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ant (openSUSE-2019-729)");
  script_summary(english:"Check for the openSUSE-2019-729 patch");
