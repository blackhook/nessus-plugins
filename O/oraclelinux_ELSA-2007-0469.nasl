...
# Oracle Linux Security Advisory ELSA-2007-0469 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : gdb (ELSA-2007-0469)");
...
contains backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000182.html"
  );
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"gdb-6.3.0.0-1.138.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"gdb-6.3.0.0-1.138.el3")) flag++;
