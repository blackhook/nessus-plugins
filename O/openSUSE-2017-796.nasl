...
# extracted from openSUSE Security Update openSUSE-2017-796.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libgcrypt (openSUSE-2017-796)");
  script_summary(english:"Check for the openSUSE-2017-796 patch");
...
This update was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1046607"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt-cavs-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt-cavs-debuginfo-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt-debugsource-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt-devel-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt-devel-debuginfo-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt20-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt20-debuginfo-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libgcrypt20-hmac-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libgcrypt-devel-32bit-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libgcrypt-devel-debuginfo-32bit-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libgcrypt20-32bit-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libgcrypt20-debuginfo-32bit-1.6.1-34.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libgcrypt20-hmac-32bit-1.6.1-34.6.1") ) flag++;
