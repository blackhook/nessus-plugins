...
# Oracle Linux Security Advisory ELSA-2010-0895 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : systemtap (ELSA-2010-0895)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0895 :
...
contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-November/001743.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"systemtap-0.6.2-2.0.1.el4_8.3")) flag++;
if (rpm_check(release:"EL4", reference:"systemtap-runtime-0.6.2-2.0.1.el4_8.3")) flag++;
if (rpm_check(release:"EL4", reference:"systemtap-testsuite-0.6.2-2.0.1.el4_8.3")) flag++;
