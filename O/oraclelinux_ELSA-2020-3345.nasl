...
"From Red Hat Security Advisory 2020:3345 :
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-August/010225.html");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-68.11.0-1.0.1.el6_10", allowmaj:TRUE)) flag++;
