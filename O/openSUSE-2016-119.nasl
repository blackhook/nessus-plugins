...
# extracted from openSUSE Security Update openSUSE-2016-119.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ecryptfs-utils (openSUSE-2016-119)");
  script_summary(english:"Check for the openSUSE-2016-119 patch");
...
"This update for ecryptfs-utils fixes the following issues :
  ...
  - CVE-2014-9687: A default salt value reduced complexity
    of offline precomputation attacks (bsc#920160) This
    update was imported from the SUSE:SLE-12:Update update
    project."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=920160"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=962052"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.1", reference:"ecryptfs-utils-103-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"ecryptfs-utils-debuginfo-103-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"ecryptfs-utils-debugsource-103-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"ecryptfs-utils-32bit-103-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"ecryptfs-utils-debuginfo-32bit-103-3.1") ) flag++;
