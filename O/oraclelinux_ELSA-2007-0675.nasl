...
# Oracle Linux Security Advisory ELSA-2007-0675 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : perl-Net-DNS (ELSA-2007-0675)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0675 :
...
contains backported patches to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-July/000261.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"perl-Net-DNS-0.48-2.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"perl-Net-DNS-0.48-2.el4")) flag++;
