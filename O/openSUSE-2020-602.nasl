...
# extracted from openSUSE Security Update openSUSE-2020-602.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : webkit2gtk3 (openSUSE-2020-602)");
  script_summary(english:"Check for the openSUSE-2020-602 patch");
...
Security issues fixed :
  ...
  - CVE-2020-10018: Fixed a denial of service because the
    m_deferredFocusedNodeChange data structure was
    mishandled (bsc#1165528).

  - CVE-2020-11793: Fixed a potential arbitrary code
    execution caused by a use-after-free vulnerability
    (bsc#1169658).

Non-security issues fixed :

  - Add API to enable Process Swap on (Cross-site)
    Navigation.
  ...
  - Add about:gpu to show information about the graphics
    stack.
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1165528"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1169658"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.1", reference:"libjavascriptcoregtk-4_0-18-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libjavascriptcoregtk-4_0-18-debuginfo-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwebkit2gtk-4_0-37-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwebkit2gtk-4_0-37-debuginfo-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libwebkit2gtk3-lang-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"typelib-1_0-JavaScriptCore-4_0-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"typelib-1_0-WebKit2-4_0-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"typelib-1_0-WebKit2WebExtension-4_0-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit-jsc-4-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit-jsc-4-debuginfo-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit2gtk-4_0-injected-bundles-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit2gtk-4_0-injected-bundles-debuginfo-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit2gtk3-debugsource-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit2gtk3-devel-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit2gtk3-minibrowser-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"webkit2gtk3-minibrowser-debuginfo-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libjavascriptcoregtk-4_0-18-32bit-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libjavascriptcoregtk-4_0-18-32bit-debuginfo-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libwebkit2gtk-4_0-37-32bit-2.28.1-lp151.2.15.2") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libwebkit2gtk-4_0-37-32bit-debuginfo-2.28.1-lp151.2.15.2") ) flag++;
