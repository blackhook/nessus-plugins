...
# extracted from openSUSE Security Update openSUSE-2016-170.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : curl (openSUSE-2016-170)");
  script_summary(english:"Check for the openSUSE-2016-170 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"curl-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"curl-debuginfo-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"curl-debugsource-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libcurl-devel-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libcurl4-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libcurl4-debuginfo-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libcurl-devel-32bit-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libcurl4-32bit-7.42.1-2.50.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libcurl4-debuginfo-32bit-7.42.1-2.50.1") ) flag++;
