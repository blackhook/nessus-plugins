...
# extracted from openSUSE Security Update openSUSE-2016-1233.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : quagga (openSUSE-2016-1233)");
  script_summary(english:"Check for the openSUSE-2016-1233 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"quagga-0.99.24.1-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"quagga-debuginfo-0.99.24.1-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"quagga-debugsource-0.99.24.1-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"quagga-devel-0.99.24.1-14.1") ) flag++;
