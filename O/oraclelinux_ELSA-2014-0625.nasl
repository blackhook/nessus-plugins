...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2014:0625 :
...
the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-June/004170.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openssl-1.0.1e-16.el6_5.14")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-devel-1.0.1e-16.el6_5.14")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-perl-1.0.1e-16.el6_5.14")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-static-1.0.1e-16.el6_5.14")) flag++;
