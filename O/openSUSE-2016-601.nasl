...
# extracted from openSUSE Security Update openSUSE-2016-601.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cacti (openSUSE-2016-601)");
  script_summary(english:"Check for the openSUSE-2016-601 patch");
...
Security issues fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=971357"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=974013"
  );
...
if ( rpm_check(release:"SUSE13.2", reference:"cacti-0.8.8f-4.16.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"cacti-0.8.8f-11.1") ) flag++;
