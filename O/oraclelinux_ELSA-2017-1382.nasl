...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:1382 :
...
Red Hat would like to thank Qualys Security for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-May/006960.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-May/006965.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"sudo-1.8.6p3-28.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"sudo-devel-1.8.6p3-28.el6_9")) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"sudo-1.8.6p7-22.el7_3")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"sudo-devel-1.8.6p7-22.el7_3")) flag++;
