...
# Security Advisory OVMSA-2016-0165.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 : xen (OVMSA-2016-0165)");
...
OVMSA-2016-0165 for details."
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2016-November/000590.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e07e422b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"xen-4.3.0-55.el6.119.60")) flag++;
if (rpm_check(release:"OVS3.3", reference:"xen-tools-4.3.0-55.el6.119.60")) flag++;
