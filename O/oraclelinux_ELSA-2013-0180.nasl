...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:0180 :
...
daemon (mysqld) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-January/003219.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"mysql-5.0.95-5.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"mysql-bench-5.0.95-5.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"mysql-devel-5.0.95-5.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"mysql-server-5.0.95-5.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"mysql-test-5.0.95-5.el5_9")) flag++;
