...
# extracted from openSUSE Security Update openSUSE-2016-49.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openssh (openSUSE-2016-49)");
  script_summary(english:"Check for the openSUSE-2016-49 patch");
...
client and a commercial SSH server."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-077"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.1", reference:"openssh-6.2p2-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"openssh-askpass-gnome-6.2p2-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"openssh-askpass-gnome-debuginfo-6.2p2-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"openssh-debuginfo-6.2p2-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"openssh-debugsource-6.2p2-3.7.1") ) flag++;
