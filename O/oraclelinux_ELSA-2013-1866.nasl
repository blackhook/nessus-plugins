...
# Oracle Linux Security Advisory ELSA-2013-1866 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : ca-certificates (ELSA-2013-1866)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:1866 :
...
restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-December/003894.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"ca-certificates-2013.1.95-65.1.el6_5")) flag++;
