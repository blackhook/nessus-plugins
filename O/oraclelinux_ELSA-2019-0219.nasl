...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:0219 :
...
Holler, and Jed Davis as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-January/008451.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-60.5.0-2.0.1.el7", allowmaj:TRUE)) flag++;
