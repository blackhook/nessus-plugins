...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-5825.html");
...
pkgs = [
    {'reference':'kubeadm-1.12.10-1.0.15.el7', 'cpu':'x86_64', 'release':'7'},
    {'reference':'kubeadm-ha-setup-0.0.2-1.0.73.el7', 'cpu':'x86_64', 'release':'7'},
    {'reference':'kubectl-1.12.10-1.0.15.el7', 'cpu':'x86_64', 'release':'7'},
    {'reference':'kubelet-1.12.10-1.0.15.el7', 'cpu':'x86_64', 'release':'7'},
    {'reference':'kubernetes-cni-0.7.1-1.0.3.el7', 'cpu':'x86_64', 'release':'7'},
    {'reference':'kubernetes-cni-plugins-0.8.6-1.0.3.el7', 'cpu':'x86_64', 'release':'7'}
];
