...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2021-25 patch");
...
"This update for kitty fixes the following issue :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1180298"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected kitty packages."
  );
