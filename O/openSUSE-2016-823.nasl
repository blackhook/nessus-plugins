...
# extracted from openSUSE Security Update openSUSE-2016-823.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : spice (openSUSE-2016-823)");
  script_summary(english:"Check for the openSUSE-2016-823 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"libspice-server-devel-0.12.4-4.12.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libspice-server1-0.12.4-4.12.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libspice-server1-debuginfo-0.12.4-4.12.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"spice-client-0.12.4-4.12.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"spice-client-debuginfo-0.12.4-4.12.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"spice-debugsource-0.12.4-4.12.1") ) flag++;
