...
# openSUSE Security Update openSUSE-SU-2021:1366-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : rpm (openSUSE-SU-2021:1366-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2021:1366-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/WOGLQWSIIR4HYRWXGETEIHB6SM6A2MNK/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?42d08f1c");
...
var pkgs = [
    {'reference':'python2-rpm-4.14.1-lp152.18.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-rpm-4.14.1-lp152.18.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-32bit-4.14.1-lp152.18.3.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-4.14.1-lp152.18.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-build-4.14.1-lp152.18.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'rpm-devel-4.14.1-lp152.18.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python2-rpm / python3-rpm / rpm / rpm-32bit / rpm-build / rpm-devel');
}
