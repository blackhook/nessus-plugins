...
# extracted from openSUSE Security Update openSUSE-2016-78.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jasper (openSUSE-2016-78)");
  script_summary(english:"Check for the openSUSE-2016-78 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"jasper-1.900.1-163.16.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"jasper-debuginfo-1.900.1-163.16.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"jasper-debugsource-1.900.1-163.16.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libjasper-devel-1.900.1-163.16.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libjasper1-1.900.1-163.16.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libjasper1-debuginfo-1.900.1-163.16.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libjasper1-32bit-1.900.1-163.16.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libjasper1-debuginfo-32bit-1.900.1-163.16.1") ) flag++;
