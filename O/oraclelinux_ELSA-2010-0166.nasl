...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0166 :
...
must be restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-March/001414.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"gnutls-1.4.1-3.el5_4.8")) flag++;
if (rpm_check(release:"EL5", reference:"gnutls-devel-1.4.1-3.el5_4.8")) flag++;
if (rpm_check(release:"EL5", reference:"gnutls-utils-1.4.1-3.el5_4.8")) flag++;
