...
# Oracle Linux Security Advisory ELSA-2011-1267 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 6 : thunderbird (ELSA-2011-1267)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1267 :
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002340.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002345.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"thunderbird-1.5.0.12-43.0.1.el4")) flag++;

if (rpm_check(release:"EL6", reference:"thunderbird-3.1.14-1.0.2.el6_1")) flag++;
