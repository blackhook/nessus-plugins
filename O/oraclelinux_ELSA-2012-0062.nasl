...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0062 :
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-January/002570.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"t1lib-5.1.2-6.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"t1lib-apps-5.1.2-6.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"t1lib-devel-5.1.2-6.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"t1lib-static-5.1.2-6.el6_2.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "t1lib / t1lib-apps / t1lib-devel / t1lib-static");
}
