...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:1700 :
...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-May/007762.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"procps-ng-3.3.10-17.el7_5.2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"procps-ng-devel-3.3.10-17.el7_5.2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"procps-ng-i18n-3.3.10-17.el7_5.2")) flag++;
