...
# Oracle Linux Security Advisory ELSA-2012-0085 respectively.
#
...
if (description)
{
  ...
  script_bugtraq_id(51756, 51786);
  script_xref(name:"RHSA", value:"2012:0085");

  script_name(english:"Oracle Linux 4 : thunderbird (ELSA-2012-0085)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0085 :
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002587.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL4", reference:"thunderbird-1.5.0.12-46.0.1.el4", allowmaj:TRUE)) flag++;
