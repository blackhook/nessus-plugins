...
# extracted from openSUSE Security Update openSUSE-2019-689.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : chromium (openSUSE-2019-689)");
  script_summary(english:"Check for the openSUSE-2019-689 patch");
...
if ( rpm_check(release:"SUSE15.0", reference:"chromium-69.0.3497.92-lp150.2.13.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debuginfo-69.0.3497.92-lp150.2.13.1", allowmaj:TRUE) ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debugsource-69.0.3497.92-lp150.2.13.1", allowmaj:TRUE) ) flag++;
