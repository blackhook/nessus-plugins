...
# extracted from openSUSE Security Update openSUSE-2015-400.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : e2fsprogs (openSUSE-2015-400)");
  script_summary(english:"Check for the openSUSE-2015-400 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"e2fsprogs-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"e2fsprogs-debuginfo-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"e2fsprogs-debugsource-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"e2fsprogs-devel-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libcom_err-devel-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libcom_err2-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libcom_err2-debuginfo-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libext2fs-devel-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libext2fs2-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libext2fs2-debuginfo-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"e2fsprogs-debuginfo-32bit-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libcom_err-devel-32bit-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libcom_err2-32bit-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libcom_err2-debuginfo-32bit-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libext2fs-devel-32bit-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libext2fs2-32bit-1.42.8-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libext2fs2-debuginfo-32bit-1.42.8-2.8.1") ) flag++;
