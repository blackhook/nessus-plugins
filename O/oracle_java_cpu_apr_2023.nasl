...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0213");

  script_name(english:"Oracle Java SE Multiple Vulnerabilities (April 2023 CPU)");
...
vulnerabilities as referenced in the April 2023 CPU advisory:
  ...
  - Vulnerability in the Oracle Java SE, Oracle GraalVM Enterprise Edition product of Oracle Java SE 
    (component: JSSE). Supported versions that are affected are Oracle Java SE: 8u361, 8u361-perf, 
    ...
    all Oracle Java SE, Oracle GraalVM Enterprise Edition accessible data. (CVE-2023-21930)

  - Vulnerability in the Oracle Java SE, Oracle GraalVM Enterprise Edition product of Oracle Java SE 
    (component: Swing). Supported versions that are affected are Oracle Java SE: 8u361, 8u361-perf, 
    11.0.18, 17.0.6, 20; Oracle GraalVM Enterprise Edition: 20.3.9, 21.3.5 and 22.3.1. Easily exploitable 
  ...
  - Vulnerability in the Oracle Java SE, Oracle GraalVM Enterprise Edition product of Oracle Java SE 
    ...
    Edition accessible data. (CVE-2023-21954)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.oracle.com/security-alerts/cpuapr2023.html#AppendixJAVA");
...
"Apply the appropriate patch according to the April 2023 Oracle Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2023-21948");
...
var constraints = [
  { 'min_version' : '8.0.0', 'fixed_version' : '8.0.371', 'fixed_display' : 'Upgrade to version 8.0.371 or greater' },
  { 'min_version' : '11.0.0', 'fixed_version' : '11.0.19', 'fixed_display' : 'Upgrade to version 11.0.19 or greater' },
  { 'min_version' : '17.0.0', 'fixed_version' : '17.0.7', 'fixed_display' : 'Upgrade to version 17.0.7 or greater' },
  { 'min_version' : '20.0.0', 'fixed_version' : '20.0.1', 'fixed_display' : 'Upgrade to version 20.0.1 or greater' }
];
