...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-3908.html");
...
pkgs = [
    {'reference':'cpio-2.11-28.el7', 'cpu':'aarch64', 'release':'7'},
    {'reference':'cpio-2.11-28.el7', 'cpu':'x86_64', 'release':'7'}
];
