...
# Security Advisory OVMSA-2018-0011.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : microcode_ctl (OVMSA-2018-0011) (Spectre)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b7e3546"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"microcode_ctl-1.17-25.4.0.1.el6_9")) flag++;
