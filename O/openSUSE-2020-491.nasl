...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-491 patch");
...
"This update for exim fixes the following issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1154183"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160726"
  );
