...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2018-1097 patch");
...
following security fixes (MFSA 2018-24) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1110506"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1110507"
  );
  script_set_attribute(
    attribute:"solution", 
