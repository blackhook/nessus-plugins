...
# extracted from openSUSE Security Update openSUSE-2020-1405.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.14 (openSUSE-2020-1405)");
  script_summary(english:"Check for the openSUSE-2020-1405 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"go1.14-1.14.7-lp151.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"go1.14-race-1.14.7-lp151.13.1") ) flag++;
