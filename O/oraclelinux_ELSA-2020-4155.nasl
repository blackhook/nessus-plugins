...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-4155.html");
...
pkgs = [
    {'reference':'thunderbird-78.3.1-1.0.1.el8_2', 'cpu':'aarch64', 'release':'8', 'allowmaj':TRUE},
    {'reference':'thunderbird-78.3.1-1.0.1.el8_2', 'cpu':'x86_64', 'release':'8', 'allowmaj':TRUE}
];
