...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2015:1510 :
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2015-July/005222.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"clutter-1.14.4-12.el7_1.1")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"clutter-devel-1.14.4-12.el7_1.1")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"clutter-doc-1.14.4-12.el7_1.1")) flag++;
