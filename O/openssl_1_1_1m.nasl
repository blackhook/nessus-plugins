...
referenced in the 1.1.1m advisory.
  ...
  - There is a carry propagation bug in the MIPS32 and MIPS64 squaring procedure. Many EC algorithms are
    ...
    OpenSSL 1.1.1m (Affected 1.1.1-1.1.1l). (CVE-2021-4160)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://github.com/openssl/openssl/commit/e9e726506cd2a3fd9c0f12daf8cc1fe934c7dddb
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a8e0061e");
...
openssl_check_version(fixed:'1.1.1m', min:'1.1.1', severity:SECURITY_WARNING);
