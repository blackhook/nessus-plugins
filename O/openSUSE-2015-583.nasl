...
# extracted from openSUSE Security Update openSUSE-2015-583.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : spice (openSUSE-2015-583)");
  script_summary(english:"Check for the openSUSE-2015-583 patch");
  ...
  script_set_attribute(
    ...
    value:
"Spice was updated to fix a heap corruption in the spice server
(CVE-2015-3247)."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.2", reference:"libspice-server-devel-0.12.4-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libspice-server1-0.12.4-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libspice-server1-debuginfo-0.12.4-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"spice-client-0.12.4-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"spice-client-debuginfo-0.12.4-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"spice-debugsource-0.12.4-4.3.1") ) flag++;
