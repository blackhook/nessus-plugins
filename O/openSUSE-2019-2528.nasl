...
# extracted from openSUSE Security Update openSUSE-2019-2528.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ucode-intel (openSUSE-2019-2528)");
  script_summary(english:"Check for the openSUSE-2019-2528 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"ucode-intel-20191112a-lp151.2.12.1") ) flag++;
