...
# Oracle Linux Security Advisory ELSA-2007-0723 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : thunderbird (ELSA-2007-0723)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0723 :
...
which contain backported patches that correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-July/000271.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"thunderbird-1.5.0.12-0.3.el4.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"thunderbird-1.5.0.12-0.3.el4.0.1")) flag++;
