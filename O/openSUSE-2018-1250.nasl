...
# extracted from openSUSE Security Update openSUSE-2018-1250.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pam_pkcs11 (openSUSE-2018-1250)");
  script_summary(english:"Check for the openSUSE-2018-1250 patch");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "pam_pkcs11 / pam_pkcs11-debuginfo / pam_pkcs11-debugsource / etc");
}
