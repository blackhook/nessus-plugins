...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0018 :
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-January/002546.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libxml2-2.7.6-4.0.1.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-devel-2.7.6-4.0.1.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-python-2.7.6-4.0.1.el6_2.1")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-static-2.7.6-4.0.1.el6_2.1")) flag++;
