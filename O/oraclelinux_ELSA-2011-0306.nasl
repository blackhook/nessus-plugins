...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0306 :
...
this update, the smb service will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/001964.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"samba3x-3.5.4-0.70.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-client-3.5.4-0.70.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-common-3.5.4-0.70.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-doc-3.5.4-0.70.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-domainjoin-gui-3.5.4-0.70.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-swat-3.5.4-0.70.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-winbind-3.5.4-0.70.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"samba3x-winbind-devel-3.5.4-0.70.el5_6.1")) flag++;
