...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-698 patch");
...
https://doc.powerdns.com/recursor/changelog/4.1.html#change-4.1.16"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1171553"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://doc.powerdns.com/recursor/changelog/4.1.html#change-4.1.16"
  );
  script_set_attribute(
    attribute:"solution",
