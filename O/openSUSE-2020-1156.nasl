...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-1156 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173257"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected python-rtslib-fb packages."
  );
