...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:1470 :
...
restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-September/001174.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"openssh-4.3p2-36.el5_4.2")) flag++;
if (rpm_check(release:"EL5", reference:"openssh-askpass-4.3p2-36.el5_4.2")) flag++;
if (rpm_check(release:"EL5", reference:"openssh-clients-4.3p2-36.el5_4.2")) flag++;
if (rpm_check(release:"EL5", reference:"openssh-server-4.3p2-36.el5_4.2")) flag++;
