...
# Security Advisory OVMSA-2015-0058.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-2752", "CVE-2015-2756", "CVE-2015-3456");
  script_bugtraq_id(72577, 73448, 74640);
  script_xref(name:"IAVA", value:"2015-A-0112");

  script_name(english:"OracleVM 3.2 : xen (OVMSA-2015-0058) (Venom)");
...
by :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2015-May/000309.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"xen-4.1.3-25.el5.127.36.1")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-devel-4.1.3-25.el5.127.36.1")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-tools-4.1.3-25.el5.127.36.1")) flag++;
