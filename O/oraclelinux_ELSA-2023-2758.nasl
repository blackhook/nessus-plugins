...
var appstreams = {
    'container-tools:ol8': [
      {'reference':'cockpit-podman-63.1-1.module+el8.8.0+21045+adcb6a64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'container-selinux-2.205.0-2.module+el8.8.0+21045+adcb6a64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'podman-docker-4.4.1-8.module+el8.8.0+21045+adcb6a64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'python3-podman-4.4.1-1.module+el8.8.0+21045+adcb6a64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udica-0.2.6-20.module+el8.8.0+21045+adcb6a64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
