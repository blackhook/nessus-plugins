...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2016:2872 :
...
These issues were discovered by Florian Weimer (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-December/006553.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-December/006554.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"sudo-1.8.6p3-25.el6_8")) flag++;
if (rpm_check(release:"EL6", reference:"sudo-devel-1.8.6p3-25.el6_8")) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"sudo-1.8.6p7-21.el7_3")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"sudo-devel-1.8.6p7-21.el7_3")) flag++;
