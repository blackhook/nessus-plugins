...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : qemu-kvm (ELSA-2018-2001) (Spectre)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:2001 :
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-June/007816.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"qemu-img-1.5.3-156.el7_5.3")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-156.el7_5.3")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-156.el7_5.3")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-156.el7_5.3")) flag++;
