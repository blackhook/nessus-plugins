...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-4032.html");
...
pkgs = [
    {'reference':'dbus-1.10.24-15.0.1.el7', 'cpu':'aarch64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-1.10.24-15.0.1.el7', 'cpu':'x86_64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-devel-1.10.24-15.0.1.el7', 'cpu':'aarch64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-devel-1.10.24-15.0.1.el7', 'cpu':'i686', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-devel-1.10.24-15.0.1.el7', 'cpu':'x86_64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-doc-1.10.24-15.0.1.el7', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-libs-1.10.24-15.0.1.el7', 'cpu':'aarch64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-libs-1.10.24-15.0.1.el7', 'cpu':'i686', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-libs-1.10.24-15.0.1.el7', 'cpu':'x86_64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-tests-1.10.24-15.0.1.el7', 'cpu':'aarch64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-tests-1.10.24-15.0.1.el7', 'cpu':'x86_64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-x11-1.10.24-15.0.1.el7', 'cpu':'aarch64', 'release':'7', 'epoch':'1'},
    {'reference':'dbus-x11-1.10.24-15.0.1.el7', 'cpu':'x86_64', 'release':'7', 'epoch':'1'}
];
