...
# extracted from openSUSE Security Update openSUSE-2020-340.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaFirefox (openSUSE-2020-340)");
  script_summary(english:"Check for the openSUSE-2020-340 patch");
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1132665"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-68.6.0-lp151.2.33.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-branding-upstream-68.6.0-lp151.2.33.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-buildsymbols-68.6.0-lp151.2.33.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-debuginfo-68.6.0-lp151.2.33.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-debugsource-68.6.0-lp151.2.33.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-devel-68.6.0-lp151.2.33.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-translations-common-68.6.0-lp151.2.33.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"MozillaFirefox-translations-other-68.6.0-lp151.2.33.1") ) flag++;
