...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0455 :
...
rebooted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-April/002084.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"polkit-0.96-2.el6_0.1")) flag++;
if (rpm_check(release:"EL6", reference:"polkit-desktop-policy-0.96-2.el6_0.1")) flag++;
if (rpm_check(release:"EL6", reference:"polkit-devel-0.96-2.el6_0.1")) flag++;
if (rpm_check(release:"EL6", reference:"polkit-docs-0.96-2.el6_0.1")) flag++;
