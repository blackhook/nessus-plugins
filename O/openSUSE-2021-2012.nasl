...
# openSUSE Security Update openSUSE-SU-2021:2012-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-urllib3 (openSUSE-SU-2021:2012-1)");
...
openSUSE-SU-2021:2012-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1a41b204");
...
pkgs = [
    {'reference':'python3-urllib3-1.25.10-4.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
