...
# extracted from openSUSE Security Update openSUSE-2020-264.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libexif (openSUSE-2020-264)");
  script_summary(english:"Check for the openSUSE-2020-264 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"libexif-debugsource-0.6.21-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libexif-devel-0.6.21-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libexif12-0.6.21-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libexif12-debuginfo-0.6.21-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libexif-devel-32bit-0.6.21-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libexif12-32bit-0.6.21-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libexif12-32bit-debuginfo-0.6.21-lp151.4.3.1") ) flag++;
