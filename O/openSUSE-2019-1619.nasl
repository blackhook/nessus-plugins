...
# extracted from openSUSE Security Update openSUSE-2019-1619.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : GraphicsMagick (openSUSE-2019-1619)");
  script_summary(english:"Check for the openSUSE-2019-1619 patch");
...
"This update for GraphicsMagick fixes the following issues :
  ...
  - disable indirect reads that disclosed file contents from
    the local system (boo#1138425)"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-debuginfo-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-debugsource-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"GraphicsMagick-devel-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick++-Q16-12-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick++-Q16-12-debuginfo-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick++-devel-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick-Q16-3-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick-Q16-3-debuginfo-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagick3-config-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagickWand-Q16-2-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libGraphicsMagickWand-Q16-2-debuginfo-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-GraphicsMagick-1.3.29-lp151.4.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"perl-GraphicsMagick-debuginfo-1.3.29-lp151.4.6.1") ) flag++;
