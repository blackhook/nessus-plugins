...
# Security Advisory OVMSA-2017-0152.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-1000251", "CVE-2017-1000365", "CVE-2017-12134");

  script_name(english:"OracleVM 3.3 : Unbreakable / etc (OVMSA-2017-0152) (BlueBorne) (Stack Clash)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2017-September/000781.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dd9815ba"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"kernel-uek-3.8.13-118.19.7.el6uek")) flag++;
if (rpm_check(release:"OVS3.3", reference:"kernel-uek-firmware-3.8.13-118.19.7.el6uek")) flag++;
