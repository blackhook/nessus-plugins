...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0847 :
...
which contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-August/000724.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"libtiff-3.8.2-7.el5_2.2")) flag++;
if (rpm_check(release:"EL5", reference:"libtiff-devel-3.8.2-7.el5_2.2")) flag++;
