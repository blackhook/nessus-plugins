...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : elinks (ELSA-2007-0933)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0933 :
...
which contains a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-October/000349.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-October/000350.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-October/000351.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"elinks-0.9.2-3.3.5.2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"elinks-0.9.2-3.3.5.2")) flag++;

if (rpm_check(release:"EL5", reference:"elinks-0.11.1-5.1.0.1.el5")) flag++;
