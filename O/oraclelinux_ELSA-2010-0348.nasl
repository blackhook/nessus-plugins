...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : kdebase (ELSA-2010-0348)");
...
'/var/run/xdmctl/'."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-April/001436.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-April/001437.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"kdebase-3.3.1-13.0.1.el4_8.1")) flag++;
if (rpm_check(release:"EL4", reference:"kdebase-devel-3.3.1-13.0.1.el4_8.1")) flag++;

if (rpm_check(release:"EL5", reference:"kdebase-3.5.4-21.0.1.el5_5.1")) flag++;
if (rpm_check(release:"EL5", reference:"kdebase-devel-3.5.4-21.0.1.el5_5.1")) flag++;
