...
# openSUSE Security Update openSUSE-SU-2021:3348-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : systemd (openSUSE-SU-2021:3348-1)");
...
openSUSE-SU-2021:3348-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7ae9b9e5");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-33910");
  script_set_attribute(attribute:"solution", value:
"Update the affected systemd-bash-completion package.");
...
var pkgs = [
    {'reference':'systemd-bash-completion-234-24.93.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'systemd-bash-completion');
}
