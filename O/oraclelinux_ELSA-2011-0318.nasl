...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 / 6 : libtiff (ELSA-2011-0318)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0318 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/001972.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/001973.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/001974.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"libtiff-3.6.1-17.el4")) flag++;
if (rpm_check(release:"EL4", reference:"libtiff-devel-3.6.1-17.el4")) flag++;

if (rpm_check(release:"EL5", reference:"libtiff-3.8.2-7.el5_6.6")) flag++;
if (rpm_check(release:"EL5", reference:"libtiff-devel-3.8.2-7.el5_6.6")) flag++;

if (rpm_check(release:"EL6", reference:"libtiff-3.9.4-1.el6_0.1")) flag++;
if (rpm_check(release:"EL6", reference:"libtiff-devel-3.9.4-1.el6_0.1")) flag++;
if (rpm_check(release:"EL6", reference:"libtiff-static-3.9.4-1.el6_0.1")) flag++;
