...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:2640 :
...
number."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2020-June/010071.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"unbound-1.4.20-29.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"unbound-devel-1.4.20-29.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"unbound-libs-1.4.20-29.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"unbound-python-1.4.20-29.el6_10.1")) flag++;
