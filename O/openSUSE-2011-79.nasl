...
# extracted from openSUSE Security Update openSUSE-2011-79.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : namazu (openSUSE-2011-79)");
  script_summary(english:"Check for the openSUSE-2011-79 patch");
...
if ( rpm_check(release:"SUSE12.1", reference:"namazu-2.0.20-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"namazu-cgi-2.0.20-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"namazu-cgi-debuginfo-2.0.20-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"namazu-debuginfo-2.0.20-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"namazu-debugsource-2.0.20-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"namazu-devel-2.0.20-7.3.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "namazu / namazu-cgi / namazu-cgi-debuginfo / namazu-debuginfo / etc");
}
