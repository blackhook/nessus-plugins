...
# extracted from openSUSE Security Update openSUSE-2020-1658.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : permissions (openSUSE-2020-1658)");
  script_summary(english:"Check for the openSUSE-2020-1658 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1161335"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1176625"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.1", reference:"permissions-20181116-lp151.4.27.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"permissions-debuginfo-20181116-lp151.4.27.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"permissions-debugsource-20181116-lp151.4.27.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"permissions-zypp-plugin-20181116-lp151.4.27.1") ) flag++;
