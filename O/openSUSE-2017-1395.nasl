...
# extracted from openSUSE Security Update openSUSE-2017-1395.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pdns-recursor (openSUSE-2017-1395)");
  script_summary(english:"Check for the openSUSE-2017-1395 patch");
...
"This update for pdns-recursor fixes the following issues :
  ...
  - CVE-2017-15120: parsing error while handling
    authoritative answers containing a CNAME of a different
    class than IN, leading to a recursor crash via a NULL
    pointer dereference. (boo#1072170)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1072170"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.3", reference:"pdns-recursor-4.0.5-6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"pdns-recursor-debuginfo-4.0.5-6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"pdns-recursor-debugsource-4.0.5-6.1") ) flag++;
