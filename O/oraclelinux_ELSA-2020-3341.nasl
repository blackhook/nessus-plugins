...
"From Red Hat Security Advisory 2020:3341 :
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-August/010205.html");
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"thunderbird-68.11.0-1.0.1.el8_2", allowmaj:TRUE)) flag++;
