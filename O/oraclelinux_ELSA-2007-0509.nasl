...
# Oracle Linux Security Advisory ELSA-2007-0509 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 : evolution (ELSA-2007-0509)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0509 :
...
contain a backported patch which resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000187.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000188.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"evolution-1.4.5-21.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"evolution-1.4.5-21.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"evolution-devel-1.4.5-21.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"evolution-devel-1.4.5-21.el3")) flag++;

if (rpm_check(release:"EL4", cpu:"i386", reference:"evolution-2.0.2-35.0.4.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"evolution-2.0.2-35.0.4.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"evolution-devel-2.0.2-35.0.4.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"evolution-devel-2.0.2-35.0.4.el4")) flag++;
