...
# extracted from openSUSE Security Update openSUSE-2017-156.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rabbitmq-server (openSUSE-2017-156)");
  script_summary(english:"Check for the openSUSE-2017-156 patch");
...
"This update for rabbitmq-server fixes the following issue :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1017642"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected rabbitmq-server packages."
  );
...
if ( rpm_check(release:"SUSE42.2", reference:"erlang-rabbitmq-client-3.5.8-3.2") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"rabbitmq-server-3.5.8-3.2") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"rabbitmq-server-plugins-3.5.8-3.2") ) flag++;
