...
# extracted from OracleVM Security Advisory OVMSA-2022-0029.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2022-33746");

  script_name(english:"OracleVM 3.4 : xen (OVMSA-2022-0029)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/cve/CVE-2022-33746.html");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/OVMSA-2022-0029.html");
...
var pkgs = [
    {'reference':'xen-4.4.4-222.0.50.el6', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'xen-4.4.4-222'},
    {'reference':'xen-tools-4.4.4-222.0.50.el6', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'xen-tools-4.4.4-222'}
];
