...
if (description)
{
  ...
  script_name(english:"Oracle JDeveloper ADF Faces Unspecified Remote Code Execution (October 2017 CPU)");
...
missing a security patch. It is, therefore, affected by vulnerability 
in the Spatial (Apache Groovy) component of Oracle Database Server.
Please see the vendor advisory for additional information.");
...
var constraints = [
  { 'min_version':'12.1.3.0', 'fixed_version':'12.1.3.0.171017', 'missing_patch':'26826138' },
  { 'min_version':'12.2.1.1', 'fixed_version':'12.2.1.1.171017', 'missing_patch':'26752339' }
];
