...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : firefox (ELSA-2009-1095)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:1095 :
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-June/001027.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-June/001029.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"firefox-3.0.11-4.0.1.el4")) flag++;

if (rpm_check(release:"EL5", reference:"firefox-3.0.11-2.0.1.el5_3")) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-1.9.0.11-3.0.1.el5_3")) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-devel-1.9.0.11-3.0.1.el5_3")) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-devel-unstable-1.9.0.11-3.0.1.el5_3")) flag++;
