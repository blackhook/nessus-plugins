...
# extracted from openSUSE Security Update openSUSE-2014-5.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pixman (openSUSE-SU-2014:0011-1)");
  script_summary(english:"Check for the openSUSE-2014-5 patch");
...
"  - Added
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2014-01/msg00005.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.2", reference:"libpixman-1-0-0.24.4-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libpixman-1-0-debuginfo-0.24.4-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libpixman-1-0-devel-0.24.4-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"pixman-debugsource-0.24.4-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"libpixman-1-0-32bit-0.24.4-4.8.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"libpixman-1-0-debuginfo-32bit-0.24.4-4.8.1") ) flag++;
