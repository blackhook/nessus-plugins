...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:0515 :
...
The CVE-2017-15135 issue was discovered by Martin Poole (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-March/007577.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"389-ds-base-1.2.11.15-94.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"389-ds-base-devel-1.2.11.15-94.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"389-ds-base-libs-1.2.11.15-94.el6_9")) flag++;
