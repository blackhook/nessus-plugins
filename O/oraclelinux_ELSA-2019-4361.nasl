...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:4361 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-December/009488.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"fribidi-1.0.4-7.el8_1")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"fribidi-devel-1.0.4-7.el8_1")) flag++;
