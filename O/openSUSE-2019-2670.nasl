...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2019-2670 patch");
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1155075"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://features.opensuse.org/321706"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected munge packages."
  );
