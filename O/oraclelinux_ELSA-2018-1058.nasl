...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:1058 :
...
Initiative as the original reporter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-April/007625.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libvorbis-1.3.3-8.el7.1")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libvorbis-devel-1.3.3-8.el7.1")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libvorbis-devel-docs-1.3.3-8.el7.1")) flag++;
