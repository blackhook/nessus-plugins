...
# extracted from openSUSE Security Update openSUSE-2020-22.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libgcrypt (openSUSE-2020-22)");
  script_summary(english:"Check for the openSUSE-2020-22 patch");
...
Security issues fixed :
  ...
  - CVE-2019-13627: Mitigation against an ECDSA timing
    attack (bsc#1148987).
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1155338"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1155339"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt-cavs-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt-cavs-debuginfo-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt-debugsource-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt-devel-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt-devel-debuginfo-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt20-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt20-debuginfo-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libgcrypt20-hmac-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgcrypt-devel-32bit-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgcrypt-devel-32bit-debuginfo-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgcrypt20-32bit-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgcrypt20-32bit-debuginfo-1.8.2-lp151.9.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libgcrypt20-hmac-32bit-1.8.2-lp151.9.7.1") ) flag++;
