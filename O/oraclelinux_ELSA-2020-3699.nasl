...
ELSA-2020-3699 advisory. Note that Nessus has not tested for this issue but has instead relied only on the application's
self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-3699.html");
...
pkgs = [
    {'reference':'aspnetcore-runtime-3.1-3.1.8-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'aspnetcore-targeting-pack-3.1-3.1.8-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-3.1.108-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-apphost-pack-3.1-3.1.8-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-host-3.1.8-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-hostfxr-3.1-3.1.8-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-runtime-3.1-3.1.8-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-sdk-3.1-3.1.108-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-targeting-pack-3.1-3.1.8-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'dotnet-templates-3.1-3.1.108-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'},
    {'reference':'netstandard-targeting-pack-2.1-3.1.108-2.0.1.el8_2', 'cpu':'x86_64', 'release':'8'}
];
