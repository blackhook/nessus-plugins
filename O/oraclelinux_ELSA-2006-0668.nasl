...
# Oracle Linux Security Advisory ELSA-2006-0668 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : squirrelmail (ELSA-2006-0668)");
...
httpd service to ensure that the new version functions correctly."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2006-November/000008.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"squirrelmail-1.4.8-2.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"squirrelmail-1.4.8-2.1")) flag++;
