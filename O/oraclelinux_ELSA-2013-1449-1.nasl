...
# Oracle Linux Security Advisory ELSA-2013-1449-1 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : kernel (ELSA-2013-1449-1)");
...
must be rebooted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-October/003756.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_exists(release:"EL5", rpm:"kernel-2.6.18") && rpm_check(release:"EL5", reference:"kernel-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-PAE-2.6.18") && rpm_check(release:"EL5", cpu:"i386", reference:"kernel-PAE-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-PAE-devel-2.6.18") && rpm_check(release:"EL5", cpu:"i386", reference:"kernel-PAE-devel-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-debug-2.6.18") && rpm_check(release:"EL5", reference:"kernel-debug-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-debug-devel-2.6.18") && rpm_check(release:"EL5", reference:"kernel-debug-devel-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-devel-2.6.18") && rpm_check(release:"EL5", reference:"kernel-devel-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-doc-2.6.18") && rpm_check(release:"EL5", reference:"kernel-doc-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-headers-2.6.18") && rpm_check(release:"EL5", reference:"kernel-headers-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-xen-2.6.18") && rpm_check(release:"EL5", reference:"kernel-xen-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_exists(release:"EL5", rpm:"kernel-xen-devel-2.6.18") && rpm_check(release:"EL5", reference:"kernel-xen-devel-2.6.18-371.1.2.0.1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"ocfs2-2.6.18-371.1.2.0.1.el5-1.4.10-1.el5")) flag++;
if (rpm_check(release:"EL5", cpu:"i386", reference:"ocfs2-2.6.18-371.1.2.0.1.el5PAE-1.4.10-1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"ocfs2-2.6.18-371.1.2.0.1.el5debug-1.4.10-1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"ocfs2-2.6.18-371.1.2.0.1.el5xen-1.4.10-1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"oracleasm-2.6.18-371.1.2.0.1.el5-2.0.5-1.el5")) flag++;
if (rpm_check(release:"EL5", cpu:"i386", reference:"oracleasm-2.6.18-371.1.2.0.1.el5PAE-2.0.5-1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"oracleasm-2.6.18-371.1.2.0.1.el5debug-2.0.5-1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"oracleasm-2.6.18-371.1.2.0.1.el5xen-2.0.5-1.el5")) flag++;
