...
ELSA-2014-0786 advisory.
  ...
  - Use-after-free vulnerability in the nfqnl_zcopy function in net/netfilter/nfnetlink_queue_core.c in the
    ...
    skb_zerocopy function in net/core/skbuff.c before the vulnerability was announced. (CVE-2014-2568)
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-123.4.2.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
