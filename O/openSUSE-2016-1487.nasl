...
# extracted from openSUSE Security Update openSUSE-2016-1487.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gc (openSUSE-2016-1487)");
  script_summary(english:"Check for the openSUSE-2016-1487 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"gc-debugsource-7.2d-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"gc-devel-7.2d-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libgc1-7.2d-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libgc1-debuginfo-7.2d-4.3.1") ) flag++;
