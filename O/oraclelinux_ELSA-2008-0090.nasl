...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : icu (ELSA-2008-0090)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0090 :
...
contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-January/000499.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"icu-3.6-5.11.1")) flag++;
if (rpm_check(release:"EL5", reference:"libicu-3.6-5.11.1")) flag++;
if (rpm_check(release:"EL5", reference:"libicu-devel-3.6-5.11.1")) flag++;
if (rpm_check(release:"EL5", reference:"libicu-doc-3.6-5.11.1")) flag++;
