...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-3970.html");
...
pkgs = [
    {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'aarch64', 'release':'7'},
    {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'x86_64', 'release':'7'}
];
