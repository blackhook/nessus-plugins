...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:1803 :
...
packages, which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-December/003861.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libjpeg-turbo-1.2.1-3.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"libjpeg-turbo-devel-1.2.1-3.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"libjpeg-turbo-static-1.2.1-3.el6_5")) flag++;
