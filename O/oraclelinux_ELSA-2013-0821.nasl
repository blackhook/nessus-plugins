...
changes to take effect.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2013-May/003468.html");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-17.0.6-2.0.1.el6_4", allowmaj:TRUE)) flag++;
