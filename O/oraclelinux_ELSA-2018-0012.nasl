...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : microcode_ctl (ELSA-2018-0012) (Spectre)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:0012 :
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-January/007433.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"microcode_ctl-2.1-22.2.el7")) flag++;
