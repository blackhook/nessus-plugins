...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : krb5 (ELSA-2007-0562)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0562 :
...
which contain backported fixes to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000251.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000253.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"krb5-devel-1.3.4-49")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"krb5-devel-1.3.4-49")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"krb5-libs-1.3.4-49")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"krb5-libs-1.3.4-49")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"krb5-server-1.3.4-49")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"krb5-server-1.3.4-49")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"krb5-workstation-1.3.4-49")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"krb5-workstation-1.3.4-49")) flag++;

if (rpm_check(release:"EL5", reference:"krb5-devel-1.5-26")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-libs-1.5-26")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-server-1.5-26")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-workstation-1.5-26")) flag++;
