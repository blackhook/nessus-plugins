...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-628 patch");
...
Non-security issues fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1171041"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected sqliteodbc packages."
  );
