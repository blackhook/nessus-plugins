...
management on Oracle Sun servers."
  ...
  script_set_attribute(attribute:"see_also", value:"https://docs.oracle.com/cd/E19860-01/E21549/z400000c1393879.html");
...
install = add_install(appname:'ilom', port:port, dir:'', ver:ver, cpe: "cpe:/o:oracle:integrated_lights_out_manager_firmware");
