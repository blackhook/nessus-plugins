...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2015-October/005472.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kmod-kvm-83-274.0.1.el5_11")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kmod-kvm-debug-83-274.0.1.el5_11")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kvm-83-274.0.1.el5_11")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kvm-qemu-img-83-274.0.1.el5_11")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kvm-tools-83-274.0.1.el5_11")) flag++;
