...
"From Red Hat Security Advisory 2012:0135 :
...
OpenJDK Java must be restarted for the update to take effect.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002611.html");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"java-1.6.0-openjdk-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.6.0-openjdk-demo-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.6.0-openjdk-devel-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.6.0-openjdk-javadoc-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.6.0-openjdk-src-1.6.0.0-1.43.1.10.6.el6_2")) flag++;
