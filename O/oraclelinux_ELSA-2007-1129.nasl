...
# Oracle Linux Security Advisory ELSA-2007-1129 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : autofs5 (ELSA-2007-1129)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:1129 :
...
Red Hat would like to thank Josh Lange for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-December/000446.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"autofs5-5.0.1-0.rc2.55.el4_6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"autofs5-5.0.1-0.rc2.55.el4_6.1")) flag++;
