...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : vim (ELSA-2007-0346)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0346 :
...
Enterprise Linux 2.1, 3, or 4."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000210.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"vim-X11-7.0.109-3.el5.3")) flag++;
if (rpm_check(release:"EL5", reference:"vim-common-7.0.109-3.el5.3")) flag++;
if (rpm_check(release:"EL5", reference:"vim-enhanced-7.0.109-3.el5.3")) flag++;
if (rpm_check(release:"EL5", reference:"vim-minimal-7.0.109-3.el5.3")) flag++;
