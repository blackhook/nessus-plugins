...
# openSUSE Security Update openSUSE-SU-2022:0277-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 : Test update for SUSE:SLE-15-SP2:Update (security) (openSUSE-SU-2022:0277-1)");
...
openSUSE-SU-2022:0277-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?303be41d");
...
var pkgs = [
    {'reference':'update-test-security-5.1-33.2', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
