...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2015:2081 :
...
after installing this update."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2015-November/005549.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"postgresql-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-contrib-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-devel-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-docs-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-libs-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-plperl-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-plpython-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-pltcl-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-server-8.4.20-4.el6_7")) flag++;
if (rpm_check(release:"EL6", reference:"postgresql-test-8.4.20-4.el6_7")) flag++;
