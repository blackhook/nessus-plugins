...
# Security Advisory OVMSA-2013-0070.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : xen (OVMSA-2013-0070)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2013-September/000181.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3f81eae5"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"xen-4.1.3-25.el5.53.25")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-devel-4.1.3-25.el5.53.25")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-tools-4.1.3-25.el5.53.25")) flag++;
