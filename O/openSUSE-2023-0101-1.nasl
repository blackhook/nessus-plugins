...
# openSUSE Security Update openSUSE-SU-2023:0101-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : pdns-recursor (openSUSE-SU-2023:0101-1)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6fa9361");
...
var pkgs = [
    {'reference':'pdns-recursor-4.6.6-bp154.2.6.1', 'cpu':'aarch64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pdns-recursor-4.6.6-bp154.2.6.1', 'cpu':'x86_64', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
