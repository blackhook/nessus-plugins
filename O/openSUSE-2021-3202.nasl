...
# openSUSE Security Update openSUSE-SU-2021:3202-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : linuxptp (openSUSE-SU-2021:3202-1)");
...
openSUSE-SU-2021:3202-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?181b7b4f");
...
var pkgs = [
    {'reference':'linuxptp-3.1.1-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
