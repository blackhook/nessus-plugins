...
# openSUSE Security Update openSUSE-SU-2023:0062-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-Django (openSUSE-SU-2023:0062-1)");
...
number.");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/IX7ZJWZJPRJ2P2GOWJ4MFYVZQU4QXSSE/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?39230565");
...
var pkgs = [
    {'reference':'python3-Django-2.2.28-bp154.2.9.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
