...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:3071 :
...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-October/007313.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"ntp-4.2.6p5-12.0.1.el6_9.1")) flag++;
if (rpm_check(release:"EL6", reference:"ntp-doc-4.2.6p5-12.0.1.el6_9.1")) flag++;
if (rpm_check(release:"EL6", reference:"ntp-perl-4.2.6p5-12.0.1.el6_9.1")) flag++;
if (rpm_check(release:"EL6", reference:"ntpdate-4.2.6p5-12.0.1.el6_9.1")) flag++;
