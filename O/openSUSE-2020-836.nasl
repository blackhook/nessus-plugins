...
# extracted from openSUSE Security Update openSUSE-2020-836.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rmt-server (openSUSE-2020-836)");
  script_summary(english:"Check for the openSUSE-2020-836 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"rmt-server-2.5.7-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"rmt-server-config-2.5.7-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"rmt-server-debuginfo-2.5.7-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"rmt-server-debugsource-2.5.7-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"rmt-server-pubcloud-2.5.7-lp151.2.15.1") ) flag++;
