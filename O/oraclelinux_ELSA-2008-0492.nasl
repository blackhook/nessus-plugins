...
# Oracle Linux Security Advisory ELSA-2008-0492 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : gnutls (ELSA-2008-0492)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0492 :
...
which contain a backported patch that corrects these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-May/000598.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"gnutls-1.0.20-4.el4_6")) flag++;
if (rpm_check(release:"EL4", reference:"gnutls-devel-1.0.20-4.el4_6")) flag++;
