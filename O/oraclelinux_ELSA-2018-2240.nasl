...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:2240 :
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-July/007899.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openslp-2.0.0-7.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openslp-devel-2.0.0-7.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openslp-server-2.0.0-7.el7_5")) flag++;
