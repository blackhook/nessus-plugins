...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:1024 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-May/008704.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"flatpak-1.0.2-5.el7_6")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"flatpak-builder-1.0.0-5.el7_6")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"flatpak-devel-1.0.2-5.el7_6")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"flatpak-libs-1.0.2-5.el7_6")) flag++;
