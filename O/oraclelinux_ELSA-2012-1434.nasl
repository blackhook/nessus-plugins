...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1434 :
...
must be restarted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-November/003113.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"icedtea-web-1.2.2-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"icedtea-web-javadoc-1.2.2-1.el6_3")) flag++;
