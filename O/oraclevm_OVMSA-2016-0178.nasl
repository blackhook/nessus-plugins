...
# Security Advisory OVMSA-2016-0178.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : xen (OVMSA-2016-0178)");
...
critical security updates :
  ...
  - From: Jan Beulich Subject: x86emul: CMPXCHG8B ignores
    ...
    Conflicts: xen/arch/x86/x86_emulate/x86_emulate.c"
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2016-December/000605.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c35bf899"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"xen-4.1.3-25.el5.223.46")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-devel-4.1.3-25.el5.223.46")) flag++;
if (rpm_check(release:"OVS3.2", reference:"xen-tools-4.1.3-25.el5.223.46")) flag++;
