...
# extracted from openSUSE Security Update openSUSE-2020-709.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (openSUSE-2020-709)");
  script_summary(english:"Check for the openSUSE-2020-709 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"opera-68.0.3618.104-lp151.2.18.1") ) flag++;
