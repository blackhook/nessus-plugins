...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:2798 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-September/009179.html"
  );
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"patch-2.7.6-9.el8_0")) flag++;
