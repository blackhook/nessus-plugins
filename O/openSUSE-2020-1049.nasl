...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-1049 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1172410"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/containernetworking/plugins/releases/tag/v0.8.6"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected cni-plugins package."
  );
