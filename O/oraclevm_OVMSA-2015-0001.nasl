...
# Security Advisory OVMSA-2015-0001.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : ntp (OVMSA-2015-0001)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2015-January/000254.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e0af960c"
  );
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"ntp-4.2.2p1-18.100.1.el5_11")) flag++;
