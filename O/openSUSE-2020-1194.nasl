...
# extracted from openSUSE Security Update openSUSE-2020-1194.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.13 (openSUSE-2020-1194)");
  script_summary(english:"Check for the openSUSE-2020-1194 patch");
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1149259");
...
if ( rpm_check(release:"SUSE15.2", reference:"go1.13-1.13.15-lp152.2.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"go1.13-race-1.13.15-lp152.2.7.1") ) flag++;
