...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:0896 :
...
number."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2020-March/009743.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"icu-4.2.1-15.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"libicu-4.2.1-15.el6_10")) flag++;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"libicu-devel-4.2.1-15.el6_10")) flag++;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"libicu-doc-4.2.1-15.el6_10")) flag++;
