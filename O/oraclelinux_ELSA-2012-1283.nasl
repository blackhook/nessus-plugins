...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1283 :
...
OpenJPEG must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-September/003035.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openjpeg-1.3-9.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"openjpeg-devel-1.3-9.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"openjpeg-libs-1.3-9.el6_3")) flag++;
