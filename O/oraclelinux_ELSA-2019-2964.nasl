...
if (description)
{
  script_id(129574);
  script_version("1.2");
  script_cvs_date("Date: 2019/10/08  9:44:55");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:2964 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-October/009219.html"
  );
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"patch-2.7.1-12.el7_7")) flag++;
