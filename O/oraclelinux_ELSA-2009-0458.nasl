...
# Oracle Linux Security Advisory ELSA-2009-0458 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : gpdf (ELSA-2009-0458)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:0458 :
...
backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-April/000992.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", reference:"gpdf-2.8.2-7.7.2.el4_7.4")) flag++;
