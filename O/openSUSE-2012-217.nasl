...
# extracted from openSUSE Security Update openSUSE-2012-217.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpng (openSUSE-SU-2012:0491-1)");
  script_summary(english:"Check for the openSUSE-2012-217 patch");
  ...
  script_set_attribute(
    ...
    value:
"specially crafted png files could cause a memory corruption in
libpng's png_set_text_2()"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-04/msg00031.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.1", reference:"libpng12-0-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng12-0-debuginfo-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng12-compat-devel-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng12-debugsource-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng12-devel-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng14-14-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng14-14-debuginfo-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng14-compat-devel-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng14-debugsource-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpng14-devel-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng12-0-32bit-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng12-0-debuginfo-32bit-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng12-compat-devel-32bit-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng12-devel-32bit-1.2.49-9.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng14-14-32bit-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng14-14-debuginfo-32bit-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng14-compat-devel-32bit-1.4.11-3.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"libpng14-devel-32bit-1.4.11-3.9.1") ) flag++;
