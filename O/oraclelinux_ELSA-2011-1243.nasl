...
# Oracle Linux Security Advisory ELSA-2011-1243 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 6 : thunderbird (ELSA-2011-1243)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1243 :
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002323.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002331.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002332.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
os_ver = os_ver[1];
if (! preg(pattern:"^(4|6)([^0-9]|$)", string:os_ver)) audit(AUDIT_OS_NOT, "Oracle Linux 4 / 6", "Oracle Linux " + os_ver);
...
flag = 0;
if (rpm_check(release:"EL4", reference:"thunderbird-1.5.0.12-42.0.1.el4")) flag++;

if (rpm_check(release:"EL6", reference:"thunderbird-3.1.12-2.0.1.el6_1")) flag++;
