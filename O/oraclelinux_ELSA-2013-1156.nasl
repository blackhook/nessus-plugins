...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:1156 :
...
updated packages, the httpd daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-August/003628.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-August/003629.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"httpd-2.2.3-82.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"httpd-devel-2.2.3-82.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"httpd-manual-2.2.3-82.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"mod_ssl-2.2.3-82.0.1.el5_9")) flag++;

if (rpm_check(release:"EL6", reference:"httpd-2.2.15-29.0.1.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"httpd-devel-2.2.15-29.0.1.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"httpd-manual-2.2.15-29.0.1.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"httpd-tools-2.2.15-29.0.1.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"mod_ssl-2.2.15-29.0.1.el6_4")) flag++;
