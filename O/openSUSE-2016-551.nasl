...
# extracted from openSUSE Security Update openSUSE-2016-551.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jq (openSUSE-2016-551)");
  script_summary(english:"Check for the openSUSE-2016-551 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"jq-1.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"jq-debuginfo-1.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"jq-debugsource-1.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libjq-devel-1.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libjq1-1.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libjq1-debuginfo-1.4-2.3.1") ) flag++;
