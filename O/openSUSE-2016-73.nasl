...
# extracted from openSUSE Security Update openSUSE-2016-73.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bind (openSUSE-2016-73)");
  script_summary(english:"Check for the openSUSE-2016-73 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"bind-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-chrootenv-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-debuginfo-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-debugsource-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-devel-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-libs-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-libs-debuginfo-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-lwresd-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-lwresd-debuginfo-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-utils-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"bind-utils-debuginfo-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"bind-libs-32bit-9.9.4P2-2.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"bind-libs-debuginfo-32bit-9.9.4P2-2.23.1") ) flag++;
