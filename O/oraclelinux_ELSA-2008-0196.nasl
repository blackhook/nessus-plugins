...
# Oracle Linux Security Advisory ELSA-2008-0196 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : unzip (ELSA-2008-0196)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0196 :
...
which contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-March/000546.html"
  );
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"unzip-5.50-36.EL3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"unzip-5.50-36.EL3")) flag++;
