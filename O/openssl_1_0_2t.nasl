...
to tested version. It is, therefore, affected by multiple
vulnerabilities :
...
relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?27ebc9b1");
...
openssl_check_version(fixed:"1.0.2t", min:"1.0.2", severity:SECURITY_WARNING);
