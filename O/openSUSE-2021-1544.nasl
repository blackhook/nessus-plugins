...
# openSUSE Security Update openSUSE-SU-2021:1544-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : aaa_base (openSUSE-SU-2021:1544-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:1544-1 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/5WMZSFNE2UF2HGG4IVMMTWRZTXGA6OBK/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?97251714");
...
var pkgs = [
    {'reference':'aaa_base-84.87+git20180409.04c9dae-lp152.14.10.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aaa_base-extras-84.87+git20180409.04c9dae-lp152.14.10.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aaa_base-malloccheck-84.87+git20180409.04c9dae-lp152.14.10.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'aaa_base-wsl-84.87+git20180409.04c9dae-lp152.14.10.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
