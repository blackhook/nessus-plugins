...
# extracted from openSUSE Security Update openSUSE-2016-39.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openssh (openSUSE-2016-39)");
  script_summary(english:"Check for the openSUSE-2016-39 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"openssh-6.6p1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openssh-askpass-gnome-6.6p1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openssh-askpass-gnome-debuginfo-6.6p1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openssh-debuginfo-6.6p1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openssh-debugsource-6.6p1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openssh-fips-6.6p1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openssh-helpers-6.6p1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openssh-helpers-debuginfo-6.6p1-5.3.1") ) flag++;
