...
"From Red Hat Security Advisory 2020:3253 :
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-July/010188.html");
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-68.11.0-1.0.1.el7_8", allowmaj:TRUE)) flag++;
