...
# Security Advisory OVMSA-2017-0160.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : dnsmasq (OVMSA-2017-0160)");
...
critical security updates :
  ...
  - Resolves: #1154953 - use both SO_REUSEADDR and
    SO_REUSEPORT

  - Resolves: #1288617 - add missing patch file

  - Resolves: #1288617 - dnsmasq: Non-interactive startup
    might lead to 100% cpu &nbsp  consumption"
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2017-October/000784.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?067820c4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.4", reference:"dnsmasq-2.48-18.el6_9")) flag++;
