...
automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-November/002443.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-November/002445.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"openswan-2.6.21-5.el5_7.6")) flag++;
if (rpm_check(release:"EL5", reference:"openswan-doc-2.6.21-5.el5_7.6")) flag++;

if (rpm_check(release:"EL6", reference:"openswan-2.6.32-4.el6_1.4")) flag++;
if (rpm_check(release:"EL6", reference:"openswan-doc-2.6.32-4.el6_1.4")) flag++;
