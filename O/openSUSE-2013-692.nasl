...
# extracted from openSUSE Security Update openSUSE-2013-692.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libzypp (openSUSE-SU-2013:1432-1)");
  script_summary(english:"Check for the openSUSE-2013-692 patch");
...
sign the repository (CVE-2013-3704)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-09/msg00022.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.3", reference:"libzypp-12.15.0-1.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libzypp-debuginfo-12.15.0-1.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libzypp-debugsource-12.15.0-1.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libzypp-devel-12.15.0-1.17.1") ) flag++;
