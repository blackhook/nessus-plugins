...
this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-November/002456.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"icedtea-web-1.0.6-1.el6_1")) flag++;
if (rpm_check(release:"EL6", reference:"icedtea-web-javadoc-1.0.6-1.el6_1")) flag++;
