...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 / 7 : thunderbird (ELSA-2016-0258)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2016:0258 :
...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-February/005824.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-February/005825.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-38.6.0-1.0.1.el6_7", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"thunderbird-38.6.0-1.0.1.el7_2", allowmaj:TRUE)) flag++;
