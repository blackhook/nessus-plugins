...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:0253 :
...
These issues were discovered by Frediano Ziglio (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-February/006694.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"spice-server-0.12.4-13.el6_8.2")) flag++;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"spice-server-devel-0.12.4-13.el6_8.2")) flag++;
