...
# extracted from openSUSE Security Update openSUSE-2014-6.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pixman (openSUSE-SU-2014:0007-1)");
  script_summary(english:"Check for the openSUSE-2014-6 patch");
...
"  - Added
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2014-01/msg00001.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.3", reference:"libpixman-1-0-0.28.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libpixman-1-0-debuginfo-0.28.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libpixman-1-0-devel-0.28.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"pixman-debugsource-0.28.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", cpu:"x86_64", reference:"libpixman-1-0-32bit-0.28.2-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", cpu:"x86_64", reference:"libpixman-1-0-debuginfo-32bit-0.28.2-2.4.1") ) flag++;
