...
# extracted from openSUSE Security Update openSUSE-2016-219.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : claws-mail (openSUSE-2016-219)");
  script_summary(english:"Check for the openSUSE-2016-219 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"claws-mail-3.11.0-3.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"claws-mail-debuginfo-3.11.0-3.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"claws-mail-debugsource-3.11.0-3.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"claws-mail-devel-3.11.0-3.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"claws-mail-lang-3.11.0-3.11.1") ) flag++;
