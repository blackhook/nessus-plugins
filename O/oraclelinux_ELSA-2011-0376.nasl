...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0376 :
...
system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/002021.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/002027.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"dbus-1.1.2-15.el5_6")) flag++;
if (rpm_check(release:"EL5", reference:"dbus-devel-1.1.2-15.el5_6")) flag++;
if (rpm_check(release:"EL5", reference:"dbus-libs-1.1.2-15.el5_6")) flag++;
if (rpm_check(release:"EL5", reference:"dbus-x11-1.1.2-15.el5_6")) flag++;

if (rpm_check(release:"EL6", reference:"dbus-1.2.24-4.el6_0")) flag++;
if (rpm_check(release:"EL6", reference:"dbus-devel-1.2.24-4.el6_0")) flag++;
if (rpm_check(release:"EL6", reference:"dbus-doc-1.2.24-4.el6_0")) flag++;
if (rpm_check(release:"EL6", reference:"dbus-libs-1.2.24-4.el6_0")) flag++;
if (rpm_check(release:"EL6", reference:"dbus-x11-1.2.24-4.el6_0")) flag++;
