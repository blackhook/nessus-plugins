...
# Oracle Linux Security Advisory ELSA-2010-0505 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : perl-Archive-Tar (ELSA-2010-0505)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0505 :
...
Archive::Tar module must be restarted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-July/001513.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-July/001514.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"perl-Archive-Tar-1.39.1-1.el4_8.1")) flag++;

if (rpm_check(release:"EL5", reference:"perl-Archive-Tar-1.39.1-1.el5_5.1")) flag++;
