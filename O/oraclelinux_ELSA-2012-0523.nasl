...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0523 :
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-April/002776.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-April/002779.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"libpng-1.2.10-17.el5_8")) flag++;
if (rpm_check(release:"EL5", reference:"libpng-devel-1.2.10-17.el5_8")) flag++;

if (rpm_check(release:"EL6", reference:"libpng-1.2.49-1.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"libpng-devel-1.2.49-1.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"libpng-static-1.2.49-1.el6_2")) flag++;
