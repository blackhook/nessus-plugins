...
# extracted from openSUSE Security Update openSUSE-2017-998.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav-database (openSUSE-2017-998)");
  script_summary(english:"Check for the openSUSE-2017-998 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"clamav-database-201709040007-54.76.1") ) flag++;
