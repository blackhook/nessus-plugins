...
# extracted from openSUSE Security Update openSUSE-2015-765.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dracut (openSUSE-2015-765)");
  script_summary(english:"Check for the openSUSE-2015-765 patch");
...
security issues :
  ...
  - CVE-2015-0794: Use mktemp instead of hardcoded
    filenames, possible vulnerability (bnc#935338).
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=935993"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.2", reference:"dracut-037-17.30.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dracut-debuginfo-037-17.30.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dracut-debugsource-037-17.30.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dracut-fips-037-17.30.1") ) flag++;
