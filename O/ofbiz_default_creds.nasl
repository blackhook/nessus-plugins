...
issue to perform administrative actions.");
  # https://cwiki.apache.org/confluence/login.action?os_destination=%2Fpages%2Fviewpage.action%3FspaceKey%3DOFBTECH%26title%3Dapache-ofbiz-technical-production-setup-guide.html&permissionViolation=true
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b4a07db");
  script_set_attribute(attribute:"solution", value:
"Secure each account with a strong password.");
