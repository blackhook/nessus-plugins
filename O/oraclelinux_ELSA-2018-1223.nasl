...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:1223 :
...
and Kevin Backhouse (lgtm.com / Semmle) as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-April/007644.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"librelp-1.2.12-1.el7_5.1")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"librelp-devel-1.2.12-1.el7_5.1")) flag++;
