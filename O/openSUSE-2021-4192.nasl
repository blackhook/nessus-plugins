...
# openSUSE Security Update openSUSE-SU-2021:4192-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : permissions (openSUSE-SU-2021:4192-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:4192-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2384569");
...
var pkgs = [
    {'reference':'permissions-20181225-23.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'permissions-zypp-plugin-20181225-23.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
