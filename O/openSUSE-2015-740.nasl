...
# extracted from openSUSE Security Update openSUSE-2015-740.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : krb5 (openSUSE-2015-740)");
  script_summary(english:"Check for the openSUSE-2015-740 patch");
...
These security issues were fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=948011"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.1", reference:"krb5-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-client-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-client-debuginfo-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-debuginfo-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-debugsource-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-devel-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-mini-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-mini-debuginfo-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-mini-debugsource-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-mini-devel-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-plugin-kdb-ldap-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-plugin-kdb-ldap-debuginfo-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-plugin-preauth-otp-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-plugin-preauth-otp-debuginfo-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-plugin-preauth-pkinit-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-plugin-preauth-pkinit-debuginfo-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-server-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"krb5-server-debuginfo-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"krb5-32bit-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"krb5-debuginfo-32bit-1.12.1-21.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"krb5-devel-32bit-1.12.1-21.1") ) flag++;
