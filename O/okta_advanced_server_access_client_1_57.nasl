...
if (description)
{
  ...
  script_cve_id("CVE-2022-24295");

  script_name(english:"Okta Advanced Server Access Client < 1.57.0 Command Injection");
...
vulnerability via a specially crafted URL.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://trust.okta.com/security-advisories/okta-advanced-server-access-client-cve-2022-24295/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?95e63904");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 1.57.0 or later");
  script_set_attribute(attribute:"agent", value:"windows");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-24295");
  ...
  script_dependencies("okta_advanced_server_access_client_win_installed.nbin");
  script_require_keys("installed_sw/Okta Advanced Server Access Client", "SMB/Registry/Enumerated");
...
var app_info = vcf::get_app_info(app:'Okta Advanced Server Access Client', win_local:TRUE);
