...
# extracted from openSUSE Security Update openSUSE-2016-970.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sqlite3 (openSUSE-2016-970)");
  script_summary(english:"Check for the openSUSE-2016-970 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"libsqlite3-0-3.8.10.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libsqlite3-0-debuginfo-3.8.10.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"sqlite3-3.8.10.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"sqlite3-debuginfo-3.8.10.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"sqlite3-debugsource-3.8.10.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"sqlite3-devel-3.8.10.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libsqlite3-0-32bit-3.8.10.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libsqlite3-0-debuginfo-32bit-3.8.10.2-7.1") ) flag++;
