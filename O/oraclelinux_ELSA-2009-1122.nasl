...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:1122 :
...
contain backported patches to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-June/001053.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"icu-3.6-5.11.4")) flag++;
if (rpm_check(release:"EL5", reference:"libicu-3.6-5.11.4")) flag++;
if (rpm_check(release:"EL5", reference:"libicu-devel-3.6-5.11.4")) flag++;
if (rpm_check(release:"EL5", reference:"libicu-doc-3.6-5.11.4")) flag++;
