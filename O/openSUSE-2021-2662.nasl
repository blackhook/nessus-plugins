...
# openSUSE Security Update openSUSE-SU-2021:2662-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : grafana (openSUSE-SU-2021:2662-1)");
...
the openSUSE-SU-2021:2662-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CQXNKFCX2C74T7LPZZCRD6GK2WWJTT4B/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f844f017");
...
var pkgs = [
    {'reference':'grafana-7.5.7-3.12.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
