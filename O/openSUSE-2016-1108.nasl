...
# extracted from openSUSE Security Update openSUSE-2016-1108.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gd (openSUSE-2016-1108)");
  script_summary(english:"Check for the openSUSE-2016-1108 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"gd-2.1.0-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gd-debuginfo-2.1.0-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gd-debugsource-2.1.0-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gd-devel-2.1.0-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gd-32bit-2.1.0-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gd-debuginfo-32bit-2.1.0-10.1") ) flag++;
