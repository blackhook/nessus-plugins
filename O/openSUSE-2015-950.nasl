...
# extracted from openSUSE Security Update openSUSE-2015-950.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bind (openSUSE-2015-950)");
  script_summary(english:"Check for the openSUSE-2015-950 patch");
...
"This update for bind fixes the following security issue :
  ...
  - CVE-2015-8000: Fix remote denial of service by
    misparsing incoming responses (bsc#958861). This update
...
if ( rpm_check(release:"SUSE42.1", reference:"bind-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-chrootenv-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-debuginfo-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-debugsource-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-devel-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-libs-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-libs-debuginfo-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-lwresd-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-lwresd-debuginfo-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-utils-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"bind-utils-debuginfo-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"bind-libs-32bit-9.9.6P1-27.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"bind-libs-debuginfo-32bit-9.9.6P1-27.1") ) flag++;
