...
# extracted from openSUSE Security Update openSUSE-2016-687.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav-database (openSUSE-2016-687)");
  script_summary(english:"Check for the openSUSE-2016-687 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"clamav-database-201606060002-105.1") ) flag++;
