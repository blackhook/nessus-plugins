...
# extracted from openSUSE Security Update openSUSE-2020-1178.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.13 (openSUSE-2020-1178)");
  script_summary(english:"Check for the openSUSE-2020-1178 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"go1.13-1.13.15-lp151.8.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"go1.13-race-1.13.15-lp151.8.1") ) flag++;
