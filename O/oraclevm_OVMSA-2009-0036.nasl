...
# Security Advisory OVMSA-2009-0036.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 2.2 : ntp (OVMSA-2009-0036)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2010-January/000044.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?abe1120f"
  );
...
flag = 0;
if (rpm_check(release:"OVS2.2", reference:"ntp-4.2.2p1-9.el5_4.1")) flag++;
