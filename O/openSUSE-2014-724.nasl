...
# extracted from openSUSE Security Update openSUSE-2014-724.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rubygem-actionpack-3_2 (openSUSE-SU-2014:1515-1)");
  script_summary(english:"Check for the openSUSE-2014-724 patch");
...
These security issues were fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=903662"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=905727"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2014-11/msg00112.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.3", reference:"rubygem-actionpack-3_2-3.2.12-1.32.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"rubygem-actionpack-3_2-3.2.13-2.28.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"rubygem-actionpack-3_2-3.2.17-3.4.1") ) flag++;
