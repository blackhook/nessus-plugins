...
# extracted from openSUSE Security Update openSUSE-2015-524.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2015-1334");

  script_name(english:"openSUSE Security Update : lxc (openSUSE-2015-524)");
  script_summary(english:"Check for the openSUSE-2015-524 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"lxc-0.9.0-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"lxc-debuginfo-0.9.0-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"lxc-debugsource-0.9.0-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"lxc-devel-0.9.0-3.8.1") ) flag++;
