...
# Oracle Linux Security Advisory ELSA-2007-0150 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 : freetype (ELSA-2007-0150)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0150 :
...
Red Hat would like to thank iDefense for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-April/000120.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-April/000122.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"freetype-2.1.4-6.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"freetype-2.1.4-6.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"freetype-devel-2.1.4-6.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"freetype-devel-2.1.4-6.el3")) flag++;

if (rpm_check(release:"EL4", cpu:"i386", reference:"freetype-2.1.9-5.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"freetype-2.1.9-5.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"freetype-demos-2.1.9-5.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"freetype-demos-2.1.9-5.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"freetype-devel-2.1.9-5.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"freetype-devel-2.1.9-5.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"freetype-utils-2.1.9-5.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"freetype-utils-2.1.9-5.el4")) flag++;
