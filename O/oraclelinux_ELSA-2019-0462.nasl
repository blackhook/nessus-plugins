...
"From Red Hat Security Advisory 2019:0462 :
...
the CVE page(s) listed in the References section.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2019-March/008514.html");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"java-1.7.0-openjdk-1.7.0.211-2.6.17.1.0.1.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.7.0-openjdk-demo-1.7.0.211-2.6.17.1.0.1.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.7.0-openjdk-devel-1.7.0.211-2.6.17.1.0.1.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.211-2.6.17.1.0.1.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"java-1.7.0-openjdk-src-1.7.0.211-2.6.17.1.0.1.el6_10")) flag++;
