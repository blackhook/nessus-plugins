...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2014:0322 :
...
restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-March/004033.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"net-snmp-5.3.2.2-22.0.2.el5_10.1")) flag++;
if (rpm_check(release:"EL5", reference:"net-snmp-devel-5.3.2.2-22.0.2.el5_10.1")) flag++;
if (rpm_check(release:"EL5", reference:"net-snmp-libs-5.3.2.2-22.0.2.el5_10.1")) flag++;
if (rpm_check(release:"EL5", reference:"net-snmp-perl-5.3.2.2-22.0.2.el5_10.1")) flag++;
if (rpm_check(release:"EL5", reference:"net-snmp-utils-5.3.2.2-22.0.2.el5_10.1")) flag++;
