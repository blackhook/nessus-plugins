...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0979 :
...
restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-February/001848.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openssl-1.0.0-4.el6_0.2")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-devel-1.0.0-4.el6_0.2")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-perl-1.0.0-4.el6_0.2")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-static-1.0.0-4.el6_0.2")) flag++;
