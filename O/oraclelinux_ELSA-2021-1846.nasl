...
var appstreams = {
    'idm:DL1': [
      ...
      {'reference':'ipa-client-common-4.9.2-3.0.1.module+el8.4.0+20162+a92f1bfa', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ipa-common-4.9.2-3.0.1.module+el8.4.0+20162+a92f1bfa', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-healthcheck-0.7-3.module+el8.4.0+20088+3d202164', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-healthcheck-core-0.7-3.module+el8.4.0+20089+f3f9be88', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-python-compat-4.9.2-3.0.1.module+el8.4.0+20162+a92f1bfa', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-selinux-4.9.2-3.0.1.module+el8.4.0+20162+a92f1bfa', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-ipaclient-4.9.2-3.0.1.module+el8.4.0+20162+a92f1bfa', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipalib-4.9.2-3.0.1.module+el8.4.0+20162+a92f1bfa', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
