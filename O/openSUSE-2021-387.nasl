...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2021-387 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182357"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182614"
  );
  script_set_attribute(
    attribute:"solution",
