...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:0654 :
...
Technical Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-March/006811.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"coreutils-8.4-46.0.1.el6")) flag++;
if (rpm_check(release:"EL6", reference:"coreutils-libs-8.4-46.0.1.el6")) flag++;
