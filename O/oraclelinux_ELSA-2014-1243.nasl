...
# Oracle Linux Security Advisory ELSA-2014-1243 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : automake (ELSA-2014-1243)");
...
which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-September/004458.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"automake-1.9.6-3.el5")) flag++;
