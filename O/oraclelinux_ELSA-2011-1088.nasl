...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1088 :
...
contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-July/002245.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"systemtap-1.4-6.0.1.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"systemtap-client-1.4-6.0.1.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"systemtap-grapher-1.4-6.0.1.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"systemtap-initscript-1.4-6.0.1.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"systemtap-runtime-1.4-6.0.1.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"systemtap-sdt-devel-1.4-6.0.1.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"systemtap-server-1.4-6.0.1.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"systemtap-testsuite-1.4-6.0.1.el6_1.2")) flag++;
