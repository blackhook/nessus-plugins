...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:1500 :
...
gc must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-November/003787.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"gc-7.1-12.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"gc-devel-7.1-12.el6_4")) flag++;
