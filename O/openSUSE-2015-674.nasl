...
# extracted from openSUSE Security Update openSUSE-2015-674.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-django (openSUSE-2015-674)");
  script_summary(english:"Check for the openSUSE-2015-674 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"python-django-1.5.12-0.2.14.1") ) flag++;
