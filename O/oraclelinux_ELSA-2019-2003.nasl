...
"From Red Hat Security Advisory 2019:2003 :
...
the CVE page(s) listed in the References section.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2019-July/008956.html");
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"icedtea-web-1.7.1-2.el7_6")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"icedtea-web-devel-1.7.1-2.el7_6")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"icedtea-web-javadoc-1.7.1-2.el7_6")) flag++;
