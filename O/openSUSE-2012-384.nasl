...
# extracted from openSUSE Security Update openSUSE-2012-384.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2012-2318");

  script_name(english:"openSUSE Security Update : pidgin (openSUSE-SU-2012:0866-1)");
  script_summary(english:"Check for the openSUSE-2012-384 patch");
...
"Changes in pidgin :
  ...
  - bnc#761155, CVE-2012-2318, remote crash via specially
    crafted MSN notification message"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-07/msg00027.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.1", reference:"finch-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"finch-debuginfo-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"finch-devel-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-branding-upstream-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-debuginfo-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-devel-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-lang-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-meanwhile-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-meanwhile-debuginfo-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-tcl-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpurple-tcl-debuginfo-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pidgin-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pidgin-debuginfo-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pidgin-debugsource-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pidgin-devel-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pidgin-evolution-2.10.1-8.12.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pidgin-evolution-debuginfo-2.10.1-8.12.1") ) flag++;
