...
# extracted from openSUSE Security Update openSUSE-2020-1960.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kernel-firmware (openSUSE-2020-1960)");
  script_summary(english:"Check for the openSUSE-2020-1960 patch");
...
"This update for kernel-firmware fixes the following issue :
  ...
  - CVE-2020-12321: Updated the Intel Bluetooth firmware for
    buffer overflow security bugs (bsc#1178671).
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1178671"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.1", reference:"kernel-firmware-20200107-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ucode-amd-20200107-lp151.2.15.1") ) flag++;
