...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:0649 :
...
Initiative as the original reporter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-April/007601.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libvorbis-1.2.3-5.el6_9.1")) flag++;
if (rpm_check(release:"EL6", reference:"libvorbis-devel-1.2.3-5.el6_9.1")) flag++;
if (rpm_check(release:"EL6", reference:"libvorbis-devel-docs-1.2.3-5.el6_9.1")) flag++;
