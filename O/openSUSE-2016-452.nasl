...
# extracted from openSUSE Security Update openSUSE-2016-452.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mercurial (openSUSE-2016-452)");
  script_summary(english:"Check for the openSUSE-2016-452 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"mercurial-3.1.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"mercurial-debuginfo-3.1.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"mercurial-debugsource-3.1.2-7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"mercurial-lang-3.1.2-7.1") ) flag++;
