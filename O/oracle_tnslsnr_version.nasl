...
connect to it.");
  ...
  script_copyright(english:"(C) 2001-2022 James W. Abendschan <jwa@jammed.com> (GPL)");
...
function oracle_version(port)
{
    ...
    var app = "Oracle Database tnslsnr";
    var service = "oracle_tnslsnr";
    var cpe = "cpe:/a:oracle:listener";
