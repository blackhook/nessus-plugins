...
# extracted from openSUSE Security Update openSUSE-2017-15.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird (openSUSE-2017-15)");
  script_summary(english:"Check for the openSUSE-2017-15 patch");
...
but are potentially risks in browser or browser-like
contexts.
...
The following vulnerabilities were fixed: (boo#1015422)
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.mozilla.org/show_bug.cgi?id=1293985"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.1", reference:"MozillaThunderbird-45.6.0-70.95.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaThunderbird-buildsymbols-45.6.0-70.95.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaThunderbird-debuginfo-45.6.0-70.95.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaThunderbird-debugsource-45.6.0-70.95.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaThunderbird-devel-45.6.0-70.95.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaThunderbird-translations-common-45.6.0-70.95.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaThunderbird-translations-other-45.6.0-70.95.1") ) flag++;
