...
# Security Advisory OVMSA-2012-0034.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.1 : xen (OVMSA-2012-0034)");
...
critical security updates :
  ...
  - Add 'allowhugepage' flag as a synonym for
    'allowsuperpage' for compatibility with previous
    releases."
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2012-August/000095.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6b78b0f8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.1", reference:"xen-4.1.2-18.el5.9")) flag++;
if (rpm_check(release:"OVS3.1", reference:"xen-devel-4.1.2-18.el5.9")) flag++;
if (rpm_check(release:"OVS3.1", reference:"xen-tools-4.1.2-18.el5.9")) flag++;
