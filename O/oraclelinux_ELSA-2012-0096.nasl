...
# Oracle Linux Security Advisory ELSA-2012-0096 respectively.
#
...
if (description)
{
  ...
  script_bugtraq_id(40467, 43932);
  script_xref(name:"RHSA", value:"2012:0096");

  script_name(english:"Oracle Linux 4 : ghostscript (ELSA-2012-0096)");
...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002592.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"ghostscript-7.07-33.13.el4")) flag++;
if (rpm_check(release:"EL4", reference:"ghostscript-devel-7.07-33.13.el4")) flag++;
if (rpm_check(release:"EL4", reference:"ghostscript-gtk-7.07-33.13.el4")) flag++;
