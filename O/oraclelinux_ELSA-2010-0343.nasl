...
must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-April/001432.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"krb5-devel-1.6.1-36.el5_5.2")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-libs-1.6.1-36.el5_5.2")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-server-1.6.1-36.el5_5.2")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-workstation-1.6.1-36.el5_5.2")) flag++;
