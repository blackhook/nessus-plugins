...
# extracted from openSUSE Security Update openSUSE-2021-194.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.14 (openSUSE-2021-194)");
...
if ( rpm_check(release:"SUSE15.2", reference:"go1.14-1.14.14-lp152.2.18.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"go1.14-race-1.14.14-lp152.2.18.1") ) flag++;
