...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:2251 :
...
and OSS-Fuzz as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-July/007908.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-52.9.1-1.0.1.el6", allowmaj:TRUE)) flag++;
