...
# extracted from openSUSE Security Update openSUSE-2015-877.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird (openSUSE-2015-877)");
  script_summary(english:"Check for the openSUSE-2015-877 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"MozillaThunderbird-38.4.0-4.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"MozillaThunderbird-buildsymbols-38.4.0-4.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"MozillaThunderbird-debuginfo-38.4.0-4.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"MozillaThunderbird-debugsource-38.4.0-4.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"MozillaThunderbird-devel-38.4.0-4.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"MozillaThunderbird-translations-common-38.4.0-4.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"MozillaThunderbird-translations-other-38.4.0-4.2") ) flag++;
