...
# extracted from openSUSE Security Update openSUSE-2016-324.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : OpenVPN (openSUSE-2016-324)");
  script_summary(english:"Check for the openSUSE-2016-324 patch");
...
"This update for OpenVPN fixes the following vulnerabilities :
  ...
  - boo#959714: heap overflow on read accessing getaddrinfo
    result 
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=934237"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=959714"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.2", reference:"openvpn-2.3.4-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openvpn-auth-pam-plugin-2.3.4-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openvpn-auth-pam-plugin-debuginfo-2.3.4-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openvpn-debuginfo-2.3.4-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openvpn-debugsource-2.3.4-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openvpn-down-root-plugin-2.3.4-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openvpn-down-root-plugin-debuginfo-2.3.4-2.10.1") ) flag++;
