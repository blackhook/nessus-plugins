...
"From Red Hat Security Advisory 2018:2884 :
...
SecuriTeam Secure Disclosure program.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2018-October/008113.html");
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-60.2.2-1.0.1.el7_5", allowmaj:TRUE)) flag++;
