...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:1764 :
...
contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-November/003822.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"ruby-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-devel-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-docs-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-irb-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-libs-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-rdoc-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-ri-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-static-1.8.7.352-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"ruby-tcltk-1.8.7.352-13.el6")) flag++;
