...
backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-October/001709.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"glibc-2.5-49.el5_5.7")) flag++;
if (rpm_check(release:"EL5", reference:"glibc-common-2.5-49.el5_5.7")) flag++;
if (rpm_check(release:"EL5", reference:"glibc-devel-2.5-49.el5_5.7")) flag++;
if (rpm_check(release:"EL5", reference:"glibc-headers-2.5-49.el5_5.7")) flag++;
if (rpm_check(release:"EL5", reference:"glibc-utils-2.5-49.el5_5.7")) flag++;
if (rpm_check(release:"EL5", reference:"nscd-2.5-49.el5_5.7")) flag++;
