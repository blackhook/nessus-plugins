...
# extracted from openSUSE Security Update openSUSE-2019-592.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : blueman (openSUSE-2019-592)");
  script_summary(english:"Check for the openSUSE-2019-592 patch");
...
if ( rpm_check(release:"SUSE15.0", reference:"blueman-2.0.6-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"blueman-debuginfo-2.0.6-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"blueman-debugsource-2.0.6-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"blueman-lang-2.0.6-lp150.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"thunar-sendto-blueman-2.0.6-lp150.5.1") ) flag++;
