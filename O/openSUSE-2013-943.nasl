...
# extracted from openSUSE Security Update openSUSE-2013-943.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ruby20 (openSUSE-SU-2013:1834-1)");
  script_summary(english:"Check for the openSUSE-2013-943 patch");
...
"the following security issue was fixed in ruby20 :
  ...
  - fix CVE-2013-4164: heap overflow in float point parsing
    (bnc#851803) The file CVE-2013-4164.patch contains the
    patch"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-12/msg00027.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-2.0.0.p247-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-debuginfo-2.0.0.p247-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-debugsource-2.0.0.p247-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-devel-2.0.0.p247-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-devel-extra-2.0.0.p247-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-doc-ri-2.0.0.p247-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-tk-2.0.0.p247-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"ruby20-tk-debuginfo-2.0.0.p247-3.7.1") ) flag++;
