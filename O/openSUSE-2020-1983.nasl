...
# extracted from openSUSE Security Update openSUSE-2020-1983.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tcpdump (openSUSE-2020-1983)");
  script_summary(english:"Check for the openSUSE-2020-1983 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"tcpdump-4.9.2-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tcpdump-debuginfo-4.9.2-lp151.4.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tcpdump-debugsource-4.9.2-lp151.4.9.1") ) flag++;
