...
# extracted from openSUSE Security Update openSUSE-2016-1421.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libXrender (openSUSE-2016-1421)");
  script_summary(english:"Check for the openSUSE-2016-1421 patch");
...
"This update of libXrender fixes the following issues :
  ...
  - insufficient validation of data from the X server could
    cause out of boundary memory writes (boo#1003002,
...
if ( rpm_check(release:"SUSE13.2", reference:"libXrender-debugsource-0.9.8-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libXrender-devel-0.9.8-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libXrender1-0.9.8-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libXrender1-debuginfo-0.9.8-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libXrender-devel-32bit-0.9.8-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libXrender1-32bit-0.9.8-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libXrender1-debuginfo-32bit-0.9.8-4.3.1") ) flag++;
