...
# extracted from openSUSE Security Update openSUSE-2015-825.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libpng16 (openSUSE-2015-825)");
  script_summary(english:"Check for the openSUSE-2015-825 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"libpng16-16-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libpng16-16-debuginfo-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libpng16-compat-devel-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libpng16-debugsource-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libpng16-devel-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libpng16-tools-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libpng16-tools-debuginfo-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libpng16-16-32bit-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libpng16-16-debuginfo-32bit-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libpng16-compat-devel-32bit-1.6.8-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libpng16-devel-32bit-1.6.8-4.1") ) flag++;
