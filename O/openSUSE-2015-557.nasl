...
# extracted from openSUSE Security Update openSUSE-2015-557.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ansible (openSUSE-2015-557)");
  script_summary(english:"Check for the openSUSE-2015-557 patch");
...
"  - Fix CVE-2015-3908 to remove tabs and use spaces instead.
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=941863"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.2", reference:"ansible-1.7.1-2.8.1") ) flag++;
