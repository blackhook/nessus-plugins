...
# extracted from openSUSE Security Update openSUSE-2017-941.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mercurial (openSUSE-2017-941)");
  script_summary(english:"Check for the openSUSE-2017-941 patch");
...
Mercurial was updated to 4.2.3, a security fix update for 
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1052696"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1053344"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.2", reference:"mercurial-3.8.3-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"mercurial-debuginfo-3.8.3-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"mercurial-debugsource-3.8.3-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"mercurial-lang-3.8.3-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mercurial-4.2.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mercurial-debuginfo-4.2.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mercurial-debugsource-4.2.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"mercurial-lang-4.2.3-4.1") ) flag++;
