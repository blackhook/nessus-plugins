...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:0897 :
...
number."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2020-March/009717.html"
  );
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"icu-50.2-4.el7_7")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libicu-50.2-4.el7_7")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libicu-devel-50.2-4.el7_7")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libicu-doc-50.2-4.el7_7")) flag++;
