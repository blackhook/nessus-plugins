...
# openSUSE Security Update openSUSE-SU-2021:3857-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-sqlparse (openSUSE-SU-2021:3857-1)");
...
openSUSE-SU-2021:3857-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/IYCTMYSALFWYSEWJYEO6WJYBAK6J5D4X/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?61811d21");
...
"Update the affected python3-sqlparse package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:python3-sqlparse");
...
var pkgs = [
    {'reference':'python3-sqlparse-0.4.2-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
