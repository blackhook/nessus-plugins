...
take effect.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2013-May/003469.html");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2013-May/003470.html");
...
flag = 0;
if (rpm_check(release:"EL5", reference:"firefox-17.0.6-1.0.1.el5_9", allowmaj:TRUE)) flag++;
...
if (rpm_check(release:"EL6", reference:"firefox-17.0.6-1.0.1.el6_4", allowmaj:TRUE)) flag++;
