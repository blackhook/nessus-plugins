...
ELSA-2013-1051 advisory.
  ...
  - The tcp_read_sock function in net/ipv4/tcp.c in the Linux kernel before 2.6.34 does not properly manage
    ...
    system call for a TCP socket. (CVE-2013-2128)
...
var pkgs = [
    ...
    {'reference':'kernel-firmware-2.6.32-358.14.1.el6', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-firmware-2.6.32'},
