...
# extracted from openSUSE Security Update openSUSE-2016-770.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2016-4809");

  script_name(english:"openSUSE Security Update : libarchive (openSUSE-2016-770)");
  script_summary(english:"Check for the openSUSE-2016-770 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"bsdtar-3.1.2-7.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"bsdtar-debuginfo-3.1.2-7.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libarchive-debugsource-3.1.2-7.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libarchive-devel-3.1.2-7.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libarchive13-3.1.2-7.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libarchive13-debuginfo-3.1.2-7.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libarchive13-32bit-3.1.2-7.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libarchive13-debuginfo-32bit-3.1.2-7.11.1") ) flag++;
