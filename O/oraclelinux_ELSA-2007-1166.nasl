...
# Oracle Linux Security Advisory ELSA-2007-1166 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : libexif (ELSA-2007-1166)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:1166 :
...
which contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-December/000457.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"libexif-0.5.12-5.1.0.2.el4_6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"libexif-0.5.12-5.1.0.2.el4_6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"libexif-devel-0.5.12-5.1.0.2.el4_6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"libexif-devel-0.5.12-5.1.0.2.el4_6.1")) flag++;
