...
# extracted from openSUSE Security Update openSUSE-2016-130.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : privoxy (openSUSE-2016-130)");
  script_summary(english:"Check for the openSUSE-2016-130 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"privoxy-3.0.24-8.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"privoxy-debuginfo-3.0.24-8.11.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"privoxy-debugsource-3.0.24-8.11.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"privoxy-3.0.24-6.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"privoxy-debuginfo-3.0.24-6.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"privoxy-debugsource-3.0.24-6.1") ) flag++;
