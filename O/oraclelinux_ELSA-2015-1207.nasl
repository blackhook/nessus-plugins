...
flag = 0;
if (rpm_check(release:"EL5", reference:"firefox-38.1.0-1.0.1.el5_11", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL6", reference:"firefox-38.1.0-1.0.1.el6_6", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-38.1.0-1.0.1.el7_1", allowmaj:TRUE)) flag++;
