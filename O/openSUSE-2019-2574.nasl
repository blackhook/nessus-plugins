...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2019-2574 patch");
...
Other issue addressed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1154401"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1156188"
  );
  script_set_attribute(
    attribute:"solution", 
