...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2018-697 patch");
...
a detailed list of changes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://hackage.haskell.org/package/git-annex-6.20180626/changelog"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1098062"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1098364"
  );
  script_set_attribute(
    attribute:"solution", 
