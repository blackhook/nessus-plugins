...
http://www.opera.com/support/kb/view/1025/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ebf356d6"
  );
  # http://www.opera.com/support/kb/view/1025/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a8ababd3"
  );
  # http://www.opera.com/support/kb/view/1026/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?207fc210"
  );
  # http://www.opera.com/support/kb/view/1027/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ffb92c6b"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-08/msg00024.html"
  );
  script_set_attribute(
    attribute:"see_also",
