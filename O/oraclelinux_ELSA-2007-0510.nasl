...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : evolution-data-server (ELSA-2007-0510)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0510 :
...
packages, which contain a backported patch which resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000204.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"evolution-data-server-1.8.0-15.0.4.el5")) flag++;
if (rpm_check(release:"EL5", reference:"evolution-data-server-devel-1.8.0-15.0.4.el5")) flag++;
