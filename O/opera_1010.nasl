...
10.10.  Such versions are potentially affected by multiple issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://web.archive.org/web/20170921232308/http://www.opera.com:80/docs/changelogs/windows/1010/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.securityfocus.com/archive/1/507980/30/0/threaded"
  );
  script_set_attribute(
    attribute:"solution",
