...
http://dev.mysql.com/doc/refman/5.5/en/news-5-5-28.html"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://dev.mysql.com/doc/refman/5.5/en/news-5-5-27.html"
  );
  # http://dev.mysql.com/doc/refman/5.5/en/news-5-5-28.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://dev.mysql.com/doc/refman/5.5/en/news-5-5-28.html"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-01/msg00004.html"
  );
  script_set_attribute(
    attribute:"solution", 
