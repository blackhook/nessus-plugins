...
# extracted from openSUSE Security Update openSUSE-2020-1962.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kernel-firmware (openSUSE-2020-1962)");
  script_summary(english:"Check for the openSUSE-2020-1962 patch");
...
if ( rpm_check(release:"SUSE15.2", reference:"kernel-firmware-20200107-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"ucode-amd-20200107-lp152.2.3.1") ) flag++;
