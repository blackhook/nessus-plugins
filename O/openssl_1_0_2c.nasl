...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.2 < 1.0.2c ASN.1 Encoder Negative Zero Value Handling RCE");
...
OpenSSL 1.0.2 prior to 1.0.2c. It is, therefore, affected by a remote
...
openssl_check_version(fixed:'1.0.2c', min:"1.0.2", severity:SECURITY_HOLE);
