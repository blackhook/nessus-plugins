...
# extracted from openSUSE Security Update openSUSE-2019-1327.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : java-11-openjdk (openSUSE-2019-1327)");
  script_summary(english:"Check for the openSUSE-2019-1327 patch");
...
Security issues fixed :
  ...
  - CVE-2019-2602: Fixed excessive use of CPU time in the
    BigDecimal implementation (bsc#1132728).

  - CVE-2019-2684: Fixed a flaw in the RMI registry
    implementation which could lead to selection of an
    incorrect skeleton class (bsc#1132732).
...
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-accessibility-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-accessibility-debuginfo-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-debuginfo-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-debugsource-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-demo-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-devel-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-headless-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-javadoc-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-jmods-11.0.3.0-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"java-11-openjdk-src-11.0.3.0-lp150.2.16.1") ) flag++;
