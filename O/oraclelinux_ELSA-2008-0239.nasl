...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0239 :
...
backported patches to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-April/000578.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"poppler-0.5.4-4.4.el5_1")) flag++;
if (rpm_check(release:"EL5", reference:"poppler-devel-0.5.4-4.4.el5_1")) flag++;
if (rpm_check(release:"EL5", reference:"poppler-utils-0.5.4-4.4.el5_1")) flag++;
