...
# Oracle Linux Security Advisory ELSA-2009-0409 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : krb5 (ELSA-2009-0409)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:0409 :
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-April/000957.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", reference:"krb5-devel-1.3.4-60.el4_7.2")) flag++;
if (rpm_check(release:"EL4", reference:"krb5-libs-1.3.4-60.el4_7.2")) flag++;
if (rpm_check(release:"EL4", reference:"krb5-server-1.3.4-60.el4_7.2")) flag++;
if (rpm_check(release:"EL4", reference:"krb5-workstation-1.3.4-60.el4_7.2")) flag++;
