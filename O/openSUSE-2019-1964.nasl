...
# extracted from openSUSE Security Update openSUSE-2019-1964.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tcpdump (openSUSE-2019-1964)");
  script_summary(english:"Check for the openSUSE-2019-1964 patch");
...
Security issues fixed :
  ...
  - CVE-2019-1010220: Fixed a buffer over-read in
    print_prefix() which may expose data (bsc#1142439).
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1142439"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.1", reference:"tcpdump-4.9.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tcpdump-debuginfo-4.9.2-lp151.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"tcpdump-debugsource-4.9.2-lp151.4.3.1") ) flag++;
