...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 / 5 : libvorbis (ELSA-2009-1219)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:1219 :
...
restarted (log out, then log back in) for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-August/001123.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-August/001124.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-August/001126.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libvorbis-1.0-11.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libvorbis-1.0-11.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libvorbis-devel-1.0-11.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libvorbis-devel-1.0-11.el3")) flag++;

if (rpm_check(release:"EL4", reference:"libvorbis-1.1.0-3.0.1.el4_8.2")) flag++;
if (rpm_check(release:"EL4", reference:"libvorbis-devel-1.1.0-3.0.1.el4_8.2")) flag++;

if (rpm_check(release:"EL5", reference:"libvorbis-1.1.2-3.el5_3.3")) flag++;
if (rpm_check(release:"EL5", reference:"libvorbis-devel-1.1.2-3.el5_3.3")) flag++;
