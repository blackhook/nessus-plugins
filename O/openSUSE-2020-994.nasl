...
# extracted from openSUSE Security Update openSUSE-2020-994.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : slirp4netns (openSUSE-2020-994)");
  script_summary(english:"Check for the openSUSE-2020-994 patch");
...
if ( rpm_check(release:"SUSE15.2", reference:"slirp4netns-0.4.7-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"slirp4netns-debuginfo-0.4.7-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"slirp4netns-debugsource-0.4.7-lp152.2.3.1") ) flag++;
