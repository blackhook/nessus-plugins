...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0429 :
...
must be restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-March/002724.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"gnutls-2.8.5-4.el6_2.2")) flag++;
if (rpm_check(release:"EL6", reference:"gnutls-devel-2.8.5-4.el6_2.2")) flag++;
if (rpm_check(release:"EL6", reference:"gnutls-guile-2.8.5-4.el6_2.2")) flag++;
if (rpm_check(release:"EL6", reference:"gnutls-utils-2.8.5-4.el6_2.2")) flag++;
