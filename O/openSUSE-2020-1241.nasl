...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-1241 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174922"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174923"
  );
  script_set_attribute(
    attribute:"solution",
