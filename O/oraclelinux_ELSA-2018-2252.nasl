...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:2252 :
...
and OSS-Fuzz as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-July/007907.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"thunderbird-52.9.1-1.0.1.el7_5", allowmaj:TRUE)) flag++;
