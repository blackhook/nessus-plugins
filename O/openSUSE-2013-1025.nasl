...
# extracted from openSUSE Security Update openSUSE-2013-1025.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : v8 (openSUSE-SU-2013:1960-1)");
  script_summary(english:"Check for the openSUSE-2013-1025 patch");
...
"  - Update spec-file to fit the changes in V8 (addition of
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-12/msg00122.html"
  );
...
if ( rpm_check(release:"SUSE12.3", reference:"libv8-3-3.22.24.8-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libv8-3-debuginfo-3.22.24.8-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"v8-devel-3.22.24.8-2.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"v8-private-headers-devel-3.22.24.8-2.4.1") ) flag++;
