...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-April/000950.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"gstreamer-plugins-base-0.10.20-3.0.1.el5_3")) flag++;
if (rpm_check(release:"EL5", reference:"gstreamer-plugins-base-devel-0.10.20-3.0.1.el5_3")) flag++;
