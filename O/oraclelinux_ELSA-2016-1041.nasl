...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 / 7 : thunderbird (ELSA-2016-1041)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2016:1041 :
...
Tyson Smith as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-May/006031.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-May/006055.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-38.8.0-2.0.1.el6_8", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"thunderbird-38.8.0-1.0.1.el7_2", allowmaj:TRUE)) flag++;
