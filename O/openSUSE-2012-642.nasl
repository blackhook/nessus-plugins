...
# extracted from openSUSE Security Update openSUSE-2012-642.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dhcp (openSUSE-SU-2012:1254-1)");
  script_summary(english:"Check for the openSUSE-2012-642 patch");
...
"  - Update to ISC dhcp-4.2.4-P2 release, providing a
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-09/msg00105.html"
  );
...
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-client-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-client-debuginfo-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-debuginfo-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-debugsource-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-devel-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-relay-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-relay-debuginfo-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-server-4.2.4.P2-0.30.1") ) flag++;
if ( rpm_check(release:"SUSE11.4", reference:"dhcp-server-debuginfo-4.2.4.P2-0.30.1") ) flag++;
