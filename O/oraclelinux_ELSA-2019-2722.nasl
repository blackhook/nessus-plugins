...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:2722 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-September/009154.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"libwmf-0.2.9-8.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"libwmf-devel-0.2.9-8.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"libwmf-lite-0.2.9-8.el8_0")) flag++;
