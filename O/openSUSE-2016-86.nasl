...
# extracted from openSUSE Security Update openSUSE-2016-86.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cgit (openSUSE-2016-86)");
  script_summary(english:"Check for the openSUSE-2016-86 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"cgit-0.12-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"cgit-debuginfo-0.12-11.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"cgit-debugsource-0.12-11.6.1") ) flag++;
