...
# extracted from openSUSE Security Update openSUSE-2016-416.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libqt4 (openSUSE-2016-416)");
  script_summary(english:"Check for the openSUSE-2016-416 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-debugsource-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-devel-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-devel-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-devel-doc-data-4.8.6-7.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-devel-doc-debuginfo-4.8.6-7.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-devel-doc-debugsource-4.8.6-7.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-linguist-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-linguist-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-private-headers-devel-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-qt3support-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-qt3support-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-mysql-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-mysql-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-plugins-debugsource-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-postgresql-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-postgresql-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-sqlite-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-sqlite-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-unixODBC-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-sql-unixODBC-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-x11-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libqt4-x11-debuginfo-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"qt4-x11-tools-4.8.6-7.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"qt4-x11-tools-debuginfo-4.8.6-7.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-debuginfo-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-qt3support-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-qt3support-debuginfo-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-debuginfo-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-mysql-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-mysql-debuginfo-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-postgresql-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-postgresql-debuginfo-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-sqlite-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-sqlite-debuginfo-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-unixODBC-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-sql-unixODBC-debuginfo-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-x11-32bit-4.8.6-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libqt4-x11-debuginfo-32bit-4.8.6-7.1") ) flag++;
