...
# extracted from openSUSE Security Update openSUSE-2019-2504.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ucode-intel (openSUSE-2019-2504)");
  script_summary(english:"Check for the openSUSE-2019-2504 patch");
...
if ( rpm_check(release:"SUSE15.0", reference:"ucode-intel-20191112-lp150.2.30.1") ) flag++;
