...
# extracted from openSUSE Security Update openSUSE-2021-835.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : nginx (openSUSE-2021-835)");
...
project.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1186126");
...
if ( rpm_check(release:"SUSE15.2", reference:"nginx-1.16.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nginx-debuginfo-1.16.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nginx-debugsource-1.16.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"nginx-source-1.16.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"vim-plugin-nginx-1.16.1-lp152.2.3.1") ) flag++;
