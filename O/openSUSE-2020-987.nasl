...
# extracted from openSUSE Security Update openSUSE-2020-987.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : slirp4netns (openSUSE-2020-987)");
  script_summary(english:"Check for the openSUSE-2020-987 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1172380"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected slirp4netns packages."
  );
...
if ( rpm_check(release:"SUSE15.1", reference:"slirp4netns-0.4.7-lp151.2.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"slirp4netns-debuginfo-0.4.7-lp151.2.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"slirp4netns-debugsource-0.4.7-lp151.2.12.1") ) flag++;
