...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:2308 :
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-July/007918.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openslp-2.0.0-3.el6")) flag++;
if (rpm_check(release:"EL6", reference:"openslp-devel-2.0.0-3.el6")) flag++;
if (rpm_check(release:"EL6", reference:"openslp-server-2.0.0-3.el6")) flag++;
