...
# Oracle Linux Security Advisory ELSA-2010-0520 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : libtiff (ELSA-2010-0520)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0520 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-July/001519.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libtiff-3.5.7-34.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libtiff-3.5.7-34.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libtiff-devel-3.5.7-34.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libtiff-devel-3.5.7-34.el3")) flag++;
