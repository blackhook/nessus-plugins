...
"From Red Hat Security Advisory 2018:2835 :
...
original reporters.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2018-September/008088.html");
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-60.2.1-1.0.1.el7_5", allowmaj:TRUE)) flag++;
