...
var appstreams = {
    'container-tools:4.0': [
      {'reference':'cockpit-podman-46-1.module+el8.8.0+20984+ab6ce66c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'container-selinux-2.199.0-1.module+el8.8.0+20984+ab6ce66c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'podman-docker-4.0.2-20.module+el8.8.0+20984+ab6ce66c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2'},
      {'reference':'python3-podman-4.0.0-1.module+el8.8.0+20984+ab6ce66c', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'udica-0.2.6-3.module+el8.8.0+20984+ab6ce66c', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
