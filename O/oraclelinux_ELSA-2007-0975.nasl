...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : flac (ELSA-2007-0975)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0975 :
...
contains a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-October/000367.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-October/000368.html"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:xmms-flac");
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"flac-1.1.0-7.el4_5.2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"flac-1.1.0-7.el4_5.2")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"flac-devel-1.1.0-7.el4_5.2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"flac-devel-1.1.0-7.el4_5.2")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"xmms-flac-1.1.0-7.el4_5.2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"xmms-flac-1.1.0-7.el4_5.2")) flag++;

if (rpm_check(release:"EL5", reference:"flac-1.1.2-28.el5_0.1")) flag++;
if (rpm_check(release:"EL5", reference:"flac-devel-1.1.2-28.el5_0.1")) flag++;
