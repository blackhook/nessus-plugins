...
# openSUSE Security Update openSUSE-SU-2021:2404-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : systemd (openSUSE-SU-2021:2404-1)");
...
openSUSE-SU-2021:2404-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67052d90");
...
pkgs = [
    {'reference':'systemd-bash-completion-234-24.90.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
