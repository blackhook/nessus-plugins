...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 / 6 : cyrus-imapd (ELSA-2011-1317)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1317 :
...
installing the update, cyrus-imapd will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002362.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002363.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002366.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"cyrus-imapd-2.2.12-16.0.1.el4")) flag++;
if (rpm_check(release:"EL4", reference:"cyrus-imapd-devel-2.2.12-16.0.1.el4")) flag++;
if (rpm_check(release:"EL4", reference:"cyrus-imapd-murder-2.2.12-16.0.1.el4")) flag++;
if (rpm_check(release:"EL4", reference:"cyrus-imapd-nntp-2.2.12-16.0.1.el4")) flag++;
if (rpm_check(release:"EL4", reference:"cyrus-imapd-utils-2.2.12-16.0.1.el4")) flag++;
if (rpm_check(release:"EL4", reference:"perl-Cyrus-2.2.12-16.0.1.el4")) flag++;

if (rpm_check(release:"EL5", reference:"cyrus-imapd-2.3.7-12.0.1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"cyrus-imapd-devel-2.3.7-12.0.1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"cyrus-imapd-perl-2.3.7-12.0.1.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"cyrus-imapd-utils-2.3.7-12.0.1.el5_7.1")) flag++;

if (rpm_check(release:"EL6", reference:"cyrus-imapd-2.3.16-6.el6_1.3")) flag++;
if (rpm_check(release:"EL6", reference:"cyrus-imapd-devel-2.3.16-6.el6_1.3")) flag++;
if (rpm_check(release:"EL6", reference:"cyrus-imapd-utils-2.3.16-6.el6_1.3")) flag++;
