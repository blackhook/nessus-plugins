...
# Oracle Linux Security Advisory ELSA-2009-0340 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : libpng (ELSA-2009-0340)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:0340 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-March/000904.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libpng-1.2.2-29")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libpng-1.2.2-29")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libpng-devel-1.2.2-29")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libpng-devel-1.2.2-29")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libpng10-1.0.13-20")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libpng10-1.0.13-20")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libpng10-devel-1.0.13-20")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libpng10-devel-1.0.13-20")) flag++;
