...
# extracted from openSUSE Security Update openSUSE-2015-547.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaFirefox (openSUSE-2015-547)");
...
"- update to Firefox 40.0 (bnc#940806)
  ...
  - MFSA 2015-78/CVE-2015-4495 (bmo#1179262, bmo#1178058)
    ...
    reader");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=940806");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=940918");
...
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-40.0-82.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-branding-openSUSE-40-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-branding-upstream-40.0-82.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-buildsymbols-40.0-82.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-debuginfo-40.0-82.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-debugsource-40.0-82.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-devel-40.0-82.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-translations-common-40.0-82.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"MozillaFirefox-translations-other-40.0-82.1") ) flag++;
