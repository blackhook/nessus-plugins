...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : glibc (ELSA-2017-1480) (Stack Clash)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:1480 :
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-June/006989.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"glibc-2.12-1.209.0.3.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"glibc-common-2.12-1.209.0.3.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"glibc-devel-2.12-1.209.0.3.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"glibc-headers-2.12-1.209.0.3.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"glibc-static-2.12-1.209.0.3.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"glibc-utils-2.12-1.209.0.3.el6_9.2")) flag++;
if (rpm_check(release:"EL6", reference:"nscd-2.12-1.209.0.3.el6_9.2")) flag++;
