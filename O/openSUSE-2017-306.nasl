...
# extracted from openSUSE Security Update openSUSE-2017-306.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : util-linux (openSUSE-2017-306)");
  script_summary(english:"Check for the openSUSE-2017-306 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1020985"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.2", reference:"libblkid-devel-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libblkid-devel-static-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libblkid1-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libblkid1-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libfdisk-devel-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libfdisk-devel-static-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libfdisk1-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libfdisk1-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libmount-devel-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libmount-devel-static-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libmount1-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libmount1-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libsmartcols-devel-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libsmartcols-devel-static-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libsmartcols1-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libsmartcols1-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libuuid-devel-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libuuid-devel-static-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libuuid1-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libuuid1-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"python-libmount-2.28-10.2") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"python-libmount-debuginfo-2.28-10.2") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"python-libmount-debugsource-2.28-10.2") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"util-linux-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"util-linux-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"util-linux-debugsource-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"util-linux-lang-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"util-linux-systemd-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"util-linux-systemd-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"util-linux-systemd-debugsource-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"uuidd-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"uuidd-debuginfo-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libblkid-devel-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libblkid1-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libblkid1-debuginfo-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libmount-devel-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libmount1-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libmount1-debuginfo-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libuuid-devel-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libuuid1-32bit-2.28-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libuuid1-debuginfo-32bit-2.28-10.1") ) flag++;
