...
# Security Advisory OVMSA-2014-0018.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 : bash (OVMSA-2014-0018)");
...
critical security updates :
  ...
  - Check for fishy environment Resolves: #1141645"
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2014-September/000219.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf8d15ff"
  );
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"bash-4.1.2-15.el6_5.1")) flag++;
