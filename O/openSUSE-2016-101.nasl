...
# extracted from openSUSE Security Update openSUSE-2016-101.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tiff (openSUSE-2016-101)");
  script_summary(english:"Check for the openSUSE-2016-101 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"libtiff-devel-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libtiff5-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libtiff5-debuginfo-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"tiff-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"tiff-debuginfo-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"tiff-debugsource-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libtiff-devel-32bit-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libtiff5-32bit-4.0.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libtiff5-debuginfo-32bit-4.0.6-3.1") ) flag++;
