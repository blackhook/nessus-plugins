...
# Oracle Linux Security Advisory ELSA-2010-0399 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : tetex (ELSA-2010-0399)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0399 :
...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-May/001455.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"tetex-2.0.2-22.0.1.EL4.16")) flag++;
if (rpm_check(release:"EL4", reference:"tetex-afm-2.0.2-22.0.1.EL4.16")) flag++;
if (rpm_check(release:"EL4", reference:"tetex-doc-2.0.2-22.0.1.EL4.16")) flag++;
if (rpm_check(release:"EL4", reference:"tetex-dvips-2.0.2-22.0.1.EL4.16")) flag++;
if (rpm_check(release:"EL4", reference:"tetex-fonts-2.0.2-22.0.1.EL4.16")) flag++;
if (rpm_check(release:"EL4", reference:"tetex-latex-2.0.2-22.0.1.EL4.16")) flag++;
if (rpm_check(release:"EL4", reference:"tetex-xdvi-2.0.2-22.0.1.EL4.16")) flag++;
