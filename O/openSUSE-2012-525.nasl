...
# extracted from openSUSE Security Update openSUSE-2012-525.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pcp (openSUSE-SU-2012:1036-1)");
  script_summary(english:"Check for the openSUSE-2012-525 patch");
...
"Update to pcp-3.6.5.
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-08/msg00034.html"
  );
...
if ( rpm_check(release:"SUSE12.1", reference:"libpcp-devel-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpcp-devel-debuginfo-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpcp3-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"libpcp3-debuginfo-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pcp-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pcp-debuginfo-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pcp-debugsource-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pcp-import-iostat2pcp-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pcp-import-mrtg2pcp-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pcp-import-sar2pcp-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pcp-import-sheet2pcp-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"perl-PCP-LogImport-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"perl-PCP-LogImport-debuginfo-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"perl-PCP-LogSummary-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"perl-PCP-MMV-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"perl-PCP-MMV-debuginfo-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"perl-PCP-PMDA-3.6.5-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"perl-PCP-PMDA-debuginfo-3.6.5-5.4.1") ) flag++;
