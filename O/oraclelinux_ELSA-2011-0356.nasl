...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0356 :
...
packages, the krb5kdc daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/002006.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"krb5-devel-1.8.2-3.el6_0.6")) flag++;
if (rpm_check(release:"EL6", reference:"krb5-libs-1.8.2-3.el6_0.6")) flag++;
if (rpm_check(release:"EL6", reference:"krb5-pkinit-openssl-1.8.2-3.el6_0.6")) flag++;
if (rpm_check(release:"EL6", reference:"krb5-server-1.8.2-3.el6_0.6")) flag++;
if (rpm_check(release:"EL6", reference:"krb5-server-ldap-1.8.2-3.el6_0.6")) flag++;
if (rpm_check(release:"EL6", reference:"krb5-workstation-1.8.2-3.el6_0.6")) flag++;
