...
# extracted from openSUSE Security Update openSUSE-2020-207.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wicked (openSUSE-2020-207)");
  script_summary(english:"Check for the openSUSE-2020-207 patch");
...
"This update for wicked fixes the following issues :
  ...
  - CVE-2019-18903: Fixed a use-after-free when receiving
    invalid DHCP6 IA_PD option (bsc#1160904).

  - CVE-2020-7217: Fixed a memory leak in DHCP4 fsm when
    processing packets for other client ids (bsc#1160906).
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160904"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1160906"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE15.1", reference:"wicked-0.6.60-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wicked-debuginfo-0.6.60-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wicked-debugsource-0.6.60-lp151.2.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"wicked-service-0.6.60-lp151.2.9.1") ) flag++;
