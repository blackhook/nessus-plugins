...
# extracted from openSUSE Security Update openSUSE-2021-161.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mutt (openSUSE-2021-161)");
  script_summary(english:"Check for the openSUSE-2021-161 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"mutt-1.10.1-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mutt-debuginfo-1.10.1-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mutt-debugsource-1.10.1-lp151.2.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"mutt-lang-1.10.1-lp151.2.15.1") ) flag++;
