...
# extracted from openSUSE Security Update openSUSE-2015-655.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : polkit (openSUSE-2015-655)");
  script_summary(english:"Check for the openSUSE-2015-655 patch");
...
The following vulnerabilities were fixed :
  ...
  - CVE-2015-3256: various memory corruption vulnerabilities
    in use of the JavaScript interpreter, possibly leading
...
if ( rpm_check(release:"SUSE13.1", reference:"libpolkit0-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libpolkit0-debuginfo-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"polkit-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"polkit-debuginfo-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"polkit-debugsource-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"polkit-devel-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"polkit-devel-debuginfo-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"typelib-1_0-Polkit-1_0-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libpolkit0-32bit-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libpolkit0-debuginfo-32bit-0.113-9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libpolkit0-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libpolkit0-debuginfo-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"polkit-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"polkit-debuginfo-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"polkit-debugsource-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"polkit-devel-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"polkit-devel-debuginfo-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"typelib-1_0-Polkit-1_0-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libpolkit0-32bit-0.113-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libpolkit0-debuginfo-32bit-0.113-3.8.1") ) flag++;
