...
# extracted from openSUSE Security Update openSUSE-2014-599.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wpa_supplicant (openSUSE-SU-2014:1314-1)");
  script_summary(english:"Check for the openSUSE-2014-599 patch");
...
"  - add
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2014-10/msg00028.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.1", reference:"wpa_supplicant-2.0-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"wpa_supplicant-debuginfo-2.0-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"wpa_supplicant-debugsource-2.0-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"wpa_supplicant-gui-2.0-3.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"wpa_supplicant-gui-debuginfo-2.0-3.8.1") ) flag++;
