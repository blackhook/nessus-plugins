...
# openSUSE Security Update openSUSE-SU-2021:1249-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : gifsicle (openSUSE-SU-2021:1249-1)");
...
openSUSE-SU-2021:1249-1 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e38204b7");
...
var pkgs = [
    {'reference':'gifsicle-1.93-bp153.2.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'gifsicle-1.93-bp153.2.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
