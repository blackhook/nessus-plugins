...
# openSUSE Security Update openSUSE-SU-2021:3294-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : nodejs8 (openSUSE-SU-2021:3294-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:3294-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75b26a3b");
...
var pkgs = [
    {'reference':'nodejs8-8.17.0-10.15.11', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nodejs8-devel-8.17.0-10.15.11', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'npm8-8.17.0-10.15.11', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
