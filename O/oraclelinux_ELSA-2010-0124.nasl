...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0124 :
...
contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-March/001369.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"systemtap-0.9.7-5.el5_4.3")) flag++;
if (rpm_check(release:"EL5", reference:"systemtap-client-0.9.7-5.el5_4.3")) flag++;
if (rpm_check(release:"EL5", reference:"systemtap-initscript-0.9.7-5.el5_4.3")) flag++;
if (rpm_check(release:"EL5", reference:"systemtap-runtime-0.9.7-5.el5_4.3")) flag++;
if (rpm_check(release:"EL5", reference:"systemtap-sdt-devel-0.9.7-5.el5_4.3")) flag++;
if (rpm_check(release:"EL5", reference:"systemtap-server-0.9.7-5.el5_4.3")) flag++;
if (rpm_check(release:"EL5", reference:"systemtap-testsuite-0.9.7-5.el5_4.3")) flag++;
