...
flag = 0;
if (rpm_check(release:"EL5", reference:"firefox-24.7.0-1.0.1.el5_10", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL6", reference:"firefox-24.7.0-1.0.1.el6_5", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-24.7.0-1.0.1.el7_0", allowmaj:TRUE)) flag++;
