...
- Add sudo_strtoid() tests for -1 and range errors. [Orabug: 30421281]");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2019-October/009232.html");
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"sudo-1.8.25p1-4.0.1.el8_0.1")) flag++;
