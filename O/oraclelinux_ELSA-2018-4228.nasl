...
- Merge upstream patch to fix CVE-2018-0739");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2018-September/008083.html");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openssl-1.0.1e-57.0.5.el6")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-devel-1.0.1e-57.0.5.el6")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-perl-1.0.1e-57.0.5.el6")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-static-1.0.1e-57.0.5.el6")) flag++;
