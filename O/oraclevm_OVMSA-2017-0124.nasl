...
# Security Advisory OVMSA-2017-0124.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : glibc (OVMSA-2017-0124) (Stack Clash)");
...
critical security updates :
  ...
  - Mitigation for CVE-2017-1000366 glibc: heap/stack gap
    jumping via unbounded stack allocations."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2017-July/000753.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"glibc-2.5-123.0.2.el5_11.3")) flag++;
if (rpm_check(release:"OVS3.2", reference:"glibc-common-2.5-123.0.2.el5_11.3")) flag++;
if (rpm_check(release:"OVS3.2", reference:"nscd-2.5-123.0.2.el5_11.3")) flag++;
