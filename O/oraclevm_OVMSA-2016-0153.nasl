...
# Security Advisory OVMSA-2016-0153.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : bind (OVMSA-2016-0153)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2016-November/000575.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?73ea24ba"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"bind-libs-9.3.6-25.P1.el5_11.11")) flag++;
if (rpm_check(release:"OVS3.2", reference:"bind-utils-9.3.6-25.P1.el5_11.11")) flag++;
