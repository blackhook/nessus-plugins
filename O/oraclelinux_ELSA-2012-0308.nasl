...
which correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-March/002659.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"busybox-1.2.0-13.el5")) flag++;
if (rpm_check(release:"EL5", reference:"busybox-anaconda-1.2.0-13.el5")) flag++;
