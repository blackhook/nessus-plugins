...
# openSUSE Security Update openSUSE-SU-2021:1625-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : runc (openSUSE-SU-2021:1625-1)");
...
openSUSE-SU-2021:1625-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8c31308c");
...
var pkgs = [
    {'reference':'runc-1.0.3-lp152.2.12.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
