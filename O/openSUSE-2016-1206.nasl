...
# extracted from openSUSE Security Update openSUSE-2016-1206.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dbus-1 (openSUSE-2016-1206)");
  script_summary(english:"Check for the openSUSE-2016-1206 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"dbus-1-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dbus-1-debuginfo-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dbus-1-debugsource-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dbus-1-devel-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dbus-1-x11-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dbus-1-x11-debuginfo-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dbus-1-x11-debugsource-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libdbus-1-3-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libdbus-1-3-debuginfo-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"dbus-1-debuginfo-32bit-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"dbus-1-devel-32bit-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libdbus-1-3-32bit-1.8.22-19.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libdbus-1-3-debuginfo-32bit-1.8.22-19.1") ) flag++;
