...
ELSA-2017-3511 advisory.
  ...
  - RunC allowed additional container processes via 'runc exec' to be ptraced by the pid 1 of the container.
    This allows the main processes of the container, if running as root, to gain access to file-descriptors of
    these new processes during the initialization and can lead to container escapes or modification of runC
    state before the process is fully placed inside the container. (CVE-2016-9962)
...
var pkgs = [
    {'reference':'docker-engine-1.12.6-1.0.1.el6', 'cpu':'x86_64', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'docker-engine-1.12.6-1.0.1.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'docker-engine-selinux-1.12.6-1.0.1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
