...
# extracted from openSUSE Security Update openSUSE-2017-444.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav-database (openSUSE-2017-444)");
  script_summary(english:"Check for the openSUSE-2017-444 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"clamav-database-201704030005-240.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"clamav-database-201704030005-54.9.1") ) flag++;
