...
# extracted from Red Hat Security Advisory RHSA-2007:0534 and 
# Oracle Linux Security Advisory ELSA-2007-0534 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2007:0534");

  script_name(english:"Oracle Linux 4 : httpd (ELSA-2007-0534)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0534 :
...
Apache after installing this update."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000249.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"httpd-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"httpd-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"httpd-devel-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"httpd-devel-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"httpd-manual-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"httpd-manual-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"httpd-suexec-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"httpd-suexec-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"mod_ssl-2.0.52-32.2.ent.0.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"mod_ssl-2.0.52-32.2.ent.0.1")) flag++;
