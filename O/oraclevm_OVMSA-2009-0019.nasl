...
# Security Advisory OVMSA-2009-0019.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 2.1 : curl (OVMSA-2009-0019)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2009-August/000030.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f870841c"
  );
...
flag = 0;
if (rpm_check(release:"OVS2.1", reference:"curl-7.15.5-2.1.el5_3.5")) flag++;
