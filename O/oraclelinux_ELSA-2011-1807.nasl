...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1807 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-December/002511.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"jasper-1.900.1-15.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"jasper-devel-1.900.1-15.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"jasper-libs-1.900.1-15.el6_1.1")) flag++;
if (rpm_check(release:"EL6", reference:"jasper-utils-1.900.1-15.el6_1.1")) flag++;
