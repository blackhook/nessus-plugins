...
if ( rpm_check(release:"SUSE42.2", reference:"konversation-1.6.2-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"konversation-debuginfo-1.6.2-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"konversation-debugsource-1.6.2-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"konversation-lang-1.6.2-2.3.1") ) flag++;
