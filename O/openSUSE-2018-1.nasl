...
# extracted from openSUSE Security Update openSUSE-2018-1.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kernel-firmware (openSUSE-2018-1) (Spectre)");
  script_summary(english:"Check for the openSUSE-2018-1 patch");
...
processor to mitigate a attack on the branch predictor that could lead
to information disclosure from e.g. kernel memory (bsc#1068032
CVE-2017-5715).
...
if ( rpm_check(release:"SUSE42.3", reference:"kernel-firmware-20170530-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"ucode-amd-20170530-14.1") ) flag++;
