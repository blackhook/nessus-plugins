...
# Oracle Linux Security Advisory ELSA-2007-0022 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 : squirrelmail (ELSA-2007-0022)");
...
manually is recommended."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-February/000045.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-March/000104.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"squirrelmail-1.4.8-4.el3.0.1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"squirrelmail-1.4.8-4.el3.0.1")) flag++;

if (rpm_check(release:"EL4", cpu:"i386", reference:"squirrelmail-1.4.8-4.el4.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"squirrelmail-1.4.8-4.el4.1")) flag++;
