...
# Oracle Linux Security Advisory ELSA-2010-0500 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : firefox (ELSA-2010-0500)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0500 :
...
must be restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-June/001509.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"firefox-3.6.4-8.0.1.el4")) flag++;
