...
# Oracle Linux Security Advisory ELSA-2008-0576 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : rdesktop (ELSA-2008-0576)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0576 :
...
contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-July/000693.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rdesktop-1.2.0-3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rdesktop-1.2.0-3")) flag++;
