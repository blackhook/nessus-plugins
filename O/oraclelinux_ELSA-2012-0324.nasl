...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0324 :
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002626.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-March/002684.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"libxml2-2.6.26-2.1.15.0.1.el5_8.2")) flag++;
if (rpm_check(release:"EL5", reference:"libxml2-devel-2.6.26-2.1.15.0.1.el5_8.2")) flag++;
if (rpm_check(release:"EL5", reference:"libxml2-python-2.6.26-2.1.15.0.1.el5_8.2")) flag++;

if (rpm_check(release:"EL6", reference:"libxml2-2.7.6-4.0.1.el6_2.4")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-devel-2.7.6-4.0.1.el6_2.4")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-python-2.7.6-4.0.1.el6_2.4")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-static-2.7.6-4.0.1.el6_2.4")) flag++;
