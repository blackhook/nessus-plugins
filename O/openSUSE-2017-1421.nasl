...
# extracted from openSUSE Security Update openSUSE-2017-1421.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : phpMyAdmin (openSUSE-2017-1421)");
  script_summary(english:"Check for the openSUSE-2017-1421 patch");
...
version 4.7.7 :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1074066"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.2", reference:"phpMyAdmin-4.7.7-33.12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"phpMyAdmin-4.7.7-6.1") ) flag++;
