...
ELSA-2014-1023 advisory.
  ...
  - The arch_dup_task_struct function in the Transactional Memory (TM) implementation in
    ...
    Transactional state. (CVE-2014-2673)

  - arch/s390/kernel/ptrace.c in the Linux kernel before 3.15.8 on the s390 platform does not properly
    restrict address-space control operations in PTRACE_POKEUSR_AREA requests, which allows local users to
    obtain read and write access to kernel memory locations, and consequently gain privileges, via a crafted
    application that makes a ptrace system call. (CVE-2014-3534)
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-123.6.3.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
