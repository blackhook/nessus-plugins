...
# extracted from openSUSE Security Update openSUSE-2017-104.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : icoutils (openSUSE-2017-104)");
  script_summary(english:"Check for the openSUSE-2017-104 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"icoutils-0.31.1-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"icoutils-debuginfo-0.31.1-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"icoutils-debugsource-0.31.1-7.1") ) flag++;
