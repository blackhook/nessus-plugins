...
# extracted from openSUSE Security Update openSUSE-2017-495.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gstreamer-plugins-good (openSUSE-2017-495)");
  script_summary(english:"Check for the openSUSE-2017-495 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-plugins-good-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-plugins-good-debuginfo-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-plugins-good-debugsource-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-plugins-good-extra-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-plugins-good-extra-debuginfo-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-plugins-good-lang-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-plugins-good-32bit-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-plugins-good-debuginfo-32bit-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-plugins-good-extra-32bit-1.4.5-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-plugins-good-extra-debuginfo-32bit-1.4.5-8.1") ) flag++;
