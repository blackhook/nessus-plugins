...
# extracted from openSUSE Security Update openSUSE-2016-931.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sqlite3 (openSUSE-2016-931)");
  script_summary(english:"Check for the openSUSE-2016-931 patch");
...
"This update for sqlite3 fixes the following issues :
  ...
  - CVE-2016-6153: Tempdir Selection Vulnerability could
    have led to data leakage under very specific,
    non-default circumstances (boo#987394)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=987394"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.2", reference:"libsqlite3-0-3.8.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libsqlite3-0-debuginfo-3.8.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"sqlite3-3.8.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"sqlite3-debuginfo-3.8.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"sqlite3-debugsource-3.8.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"sqlite3-devel-3.8.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libsqlite3-0-32bit-3.8.6-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libsqlite3-0-debuginfo-32bit-3.8.6-3.1") ) flag++;
