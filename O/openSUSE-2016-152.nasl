...
# extracted from openSUSE Security Update openSUSE-2016-152.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : curl (openSUSE-2016-152)");
  script_summary(english:"Check for the openSUSE-2016-152 patch");
...
The following non-security bugs were fixed :
  ...
  - boo#936676: secure_getenv or __secure_getenv may not be
    detected correctly at build time

The following tracked bugs only affect the test suite :

  - boo#962996: Expired cookie in test 46 caused test
    failures

  - boo#934333: Curl test suite was not run, is now enabled
    during build
...
This update was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=934333"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=936676"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.1", reference:"curl-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"curl-debuginfo-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"curl-debugsource-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libcurl-devel-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libcurl4-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libcurl4-debuginfo-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libcurl-devel-32bit-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libcurl4-32bit-7.37.0-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libcurl4-debuginfo-32bit-7.37.0-7.1") ) flag++;
