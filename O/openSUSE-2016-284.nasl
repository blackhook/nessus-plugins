...
# extracted from openSUSE Security Update openSUSE-2016-284.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dhcp (openSUSE-2016-284)");
  script_summary(english:"Check for the openSUSE-2016-284 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-client-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-client-debuginfo-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-debuginfo-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-debugsource-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-devel-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-relay-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-relay-debuginfo-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-server-4.3.3-4.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dhcp-server-debuginfo-4.3.3-4.1") ) flag++;
