...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-3848.html");
...
pkgs = [
    {'reference':'libmspack-0.5-0.8.alpha.el7', 'cpu':'aarch64', 'release':'7'},
    {'reference':'libmspack-0.5-0.8.alpha.el7', 'cpu':'i686', 'release':'7'},
    {'reference':'libmspack-0.5-0.8.alpha.el7', 'cpu':'x86_64', 'release':'7'},
    {'reference':'libmspack-devel-0.5-0.8.alpha.el7', 'cpu':'aarch64', 'release':'7'},
    {'reference':'libmspack-devel-0.5-0.8.alpha.el7', 'cpu':'i686', 'release':'7'},
    {'reference':'libmspack-devel-0.5-0.8.alpha.el7', 'cpu':'x86_64', 'release':'7'}
];
