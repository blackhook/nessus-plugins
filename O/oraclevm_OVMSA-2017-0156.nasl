...
# Security Advisory OVMSA-2017-0156.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 : nss (OVMSA-2017-0156)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a57ea91d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"nss-3.28.4-4.0.1.el6_9")) flag++;
if (rpm_check(release:"OVS3.3", reference:"nss-sysinit-3.28.4-4.0.1.el6_9")) flag++;
if (rpm_check(release:"OVS3.3", reference:"nss-tools-3.28.4-4.0.1.el6_9")) flag++;
