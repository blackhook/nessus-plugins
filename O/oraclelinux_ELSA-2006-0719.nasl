...
# Oracle Linux Security Advisory ELSA-2006-0719 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : nss_ldap (ELSA-2006-0719)");
...
contain a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2006-November/000019.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"nss_ldap-226-17")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"nss_ldap-226-17")) flag++;
