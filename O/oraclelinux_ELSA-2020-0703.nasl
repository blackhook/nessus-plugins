...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:0703 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2020-March/009679.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"http-parser-2.7.1-8.el7_7.2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"http-parser-devel-2.7.1-8.el7_7.2")) flag++;
