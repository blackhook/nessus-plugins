...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:0690 :
...
update, the BIND daemon (named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-March/003392.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"bind97-9.7.0-17.P2.el5_9.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-chroot-9.7.0-17.P2.el5_9.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-devel-9.7.0-17.P2.el5_9.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-libs-9.7.0-17.P2.el5_9.1")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-utils-9.7.0-17.P2.el5_9.1")) flag++;
