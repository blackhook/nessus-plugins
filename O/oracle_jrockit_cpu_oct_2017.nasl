...
if (description)
{
  ...
  script_name(english:"Oracle JRockit R28.3.15 Multiple Vulnerabilities (October 2017 CPU)");
...
R28.3.15. It is, therefore, affected by multiple vulnerabilities. See advisory for details.");
  # http://www.oracle.com/technetwork/security-advisory/cpuoct2017-3236626.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e07fa0e");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Oracle JRockit version R28.3.16 or later as referenced in
the October 2017 Oracle Critical Patch Update advisory.");
