...
# extracted from openSUSE Security Update openSUSE-2016-295.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh2_org (openSUSE-2016-295)");
  script_summary(english:"Check for the openSUSE-2016-295 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"libssh2-1-1.5.0-9.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libssh2-1-debuginfo-1.5.0-9.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libssh2-devel-1.5.0-9.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libssh2_org-debugsource-1.5.0-9.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libssh2-1-32bit-1.5.0-9.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libssh2-1-debuginfo-32bit-1.5.0-9.7.1") ) flag++;
