...
# extracted from openSUSE Security Update openSUSE-2016-1073.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wget (openSUSE-2016-1073)");
  script_summary(english:"Check for the openSUSE-2016-1073 patch");
...
"This update for wget fixes the following issues :
  ...
  - CVE-2016-7098: Fixed a potential race condition by
    ...
    to the current user only. (boo#995964)"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.2", reference:"wget-1.16-4.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"wget-debuginfo-1.16-4.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"wget-debugsource-1.16-4.10.1") ) flag++;
