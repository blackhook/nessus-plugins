...
# Oracle Linux Security Advisory ELSA-2011-1161 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : freetype (ELSA-2011-1161)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1161 :
...
restarted (log out, then log back in) for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-August/002283.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"freetype-2.1.9-19.el4")) flag++;
if (rpm_check(release:"EL4", reference:"freetype-demos-2.1.9-19.el4")) flag++;
if (rpm_check(release:"EL4", reference:"freetype-devel-2.1.9-19.el4")) flag++;
if (rpm_check(release:"EL4", reference:"freetype-utils-2.1.9-19.el4")) flag++;
