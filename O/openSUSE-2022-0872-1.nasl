...
# openSUSE Security Update openSUSE-SU-2022:0872-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : stunnel (openSUSE-SU-2022:0872-1)");
...
openSUSE-SU-2022:0872-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0745b8c4");
...
var pkgs = [
    {'reference':'stunnel-5.62-3.14.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
