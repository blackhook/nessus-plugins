...
# openSUSE Security Update openSUSE-SU-2021:1601-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : log4j (openSUSE-SU-2021:1601-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2021:1601-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1193743");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/YLSFAYMV5DOWQ3EO5252SX7QTCHNCWGK/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?594a3b77");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-44228");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-45046");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:disruptor");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:disruptor-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:jakarta-servlet");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:jakarta-servlet-javadoc");
...
var pkgs = [
    {'reference':'disruptor-3.4.4-lp152.2.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'disruptor-javadoc-3.4.4-lp152.2.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jakarta-servlet-5.0.0-lp152.2.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'jakarta-servlet-javadoc-5.0.0-lp152.2.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-2.16.0-lp152.3.9.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-javadoc-2.16.0-lp152.3.9.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-jcl-2.16.0-lp152.3.9.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'log4j-slf4j-2.16.0-lp152.3.9.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'disruptor / disruptor-javadoc / jakarta-servlet / etc');
}
