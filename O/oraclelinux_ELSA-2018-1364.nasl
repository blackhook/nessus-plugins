...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:1364 :
...
Red Hat would like to thank Greg Kubok for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-May/007686.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"389-ds-base-1.2.11.15-95.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"389-ds-base-devel-1.2.11.15-95.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"389-ds-base-libs-1.2.11.15-95.el6_9")) flag++;
