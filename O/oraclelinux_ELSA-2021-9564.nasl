...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : Unbreakable Enterprise kernel (ELSA-2021-9564)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Oracle Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ELSA-2021-9564 advisory.
...
if (machine_uptrack_level)
{
  ...
  var fixed_uptrack_levels = ['5.4.17-2136.301.1.2.el8uek'];
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-5.4.17-2136.301.1.2.el8uek', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-5.4.17'}
];
