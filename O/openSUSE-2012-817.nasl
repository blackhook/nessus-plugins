...
# extracted from openSUSE Security Update openSUSE-2012-817.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaFirefox (openSUSE-SU-2012:1583-1)");
  script_summary(english:"Check for the openSUSE-2012-817 patch");
...
"Changes in MozillaFirefox :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-11/msg00090.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-branding-upstream-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-buildsymbols-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-debuginfo-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-debugsource-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-devel-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-translations-common-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"MozillaFirefox-translations-other-17.0-2.54.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-17.0-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-branding-upstream-17.0-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-buildsymbols-17.0-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-debuginfo-17.0-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-debugsource-17.0-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-devel-17.0-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-translations-common-17.0-2.25.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"MozillaFirefox-translations-other-17.0-2.25.1") ) flag++;
