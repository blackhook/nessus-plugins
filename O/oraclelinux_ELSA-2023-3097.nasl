...
# extracted from Oracle Linux Security Advisory ELSA-2023-3097.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : gssntlmssp (ELSA-2023-3097)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2023-3097.html");
...
"Update the affected gssntlmssp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:gssntlmssp");
