...
(CVE-2017-1000117)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-August/007136.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"emacs-git-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"emacs-git-el-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"git-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"git-all-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"git-cvs-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"git-daemon-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"git-email-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"git-gui-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"git-svn-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"gitk-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"gitweb-1.7.1-9.el6_9")) flag++;
if (rpm_check(release:"EL6", reference:"perl-Git-1.7.1-9.el6_9")) flag++;
