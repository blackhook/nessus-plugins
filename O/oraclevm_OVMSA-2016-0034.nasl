...
# Security Advisory OVMSA-2016-0034.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 / 3.4 : nss-util (OVMSA-2016-0034)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2016-March/000446.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?48f54b3e"
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2016-March/000423.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?73d6a362"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"nss-util-3.19.1-5.el6_7")) flag++;

if (rpm_check(release:"OVS3.4", reference:"nss-util-3.19.1-5.el6_7")) flag++;
