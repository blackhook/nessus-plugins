...
# extracted from openSUSE Security Update openSUSE-2013-865.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : varnish (openSUSE-SU-2013:1683-1)");
  script_summary(english:"Check for the openSUSE-2013-865 patch");
...
"This update fixes the following security issue with varnish :
  ...
  - bnc#839358: Deactivate libpcre JIT"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=839358"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-11/msg00033.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.1", reference:"libvarnishapi1-3.0.3-4.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libvarnishapi1-debuginfo-3.0.3-4.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"varnish-3.0.3-4.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"varnish-debuginfo-3.0.3-4.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"varnish-debugsource-3.0.3-4.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"varnish-devel-3.0.3-4.5.1") ) flag++;
