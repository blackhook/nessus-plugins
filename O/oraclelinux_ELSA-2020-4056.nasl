...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-4056.html");
...
pkgs = [
    {'reference':'qemu-guest-agent-0.12.1.2-2.506.el6_10.8', 'cpu':'i686', 'release':'6', 'epoch':'2'},
    {'reference':'qemu-guest-agent-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'6', 'epoch':'2'},
    {'reference':'qemu-img-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'6', 'epoch':'2'},
    {'reference':'qemu-kvm-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'6', 'epoch':'2'},
    {'reference':'qemu-kvm-tools-0.12.1.2-2.506.el6_10.8', 'cpu':'x86_64', 'release':'6', 'epoch':'2'}
];
