...
# extracted from Oracle Linux Security Advisory ELSA-2018-4019.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : microcode_ctl (ELSA-2018-4019) (Spectre)");
...
- Revert updated Intel 20180108 microcode for CPUIDs: {CVE-2017-5715}
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-January/007467.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"microcode_ctl-1.17-25.4.0.2.el6_9")) flag++;
