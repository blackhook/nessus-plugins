...
# Security Advisory OVMSA-2018-0270.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 / 3.4 : python-paramiko (OVMSA-2018-0270)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2018-November/000903.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6f81cf3e"
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2018-November/000904.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?04fe2c55"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"python-paramiko-1.7.5-5.el6_10")) flag++;

if (rpm_check(release:"OVS3.4", reference:"python-paramiko-1.7.5-5.el6_10")) flag++;
