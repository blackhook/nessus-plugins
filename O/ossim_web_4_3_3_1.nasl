...
SQL commands as the MySQL 'root' user.");
  # http://web.archive.org/web/20131121031919/http://forums.alienvault.com:80/discussion/1873/security-advisory-all-alienvault-versions-prior-to-v4-3-3-1
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac83258e");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2014/Feb/18");
