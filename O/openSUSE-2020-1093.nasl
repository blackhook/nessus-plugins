...
# extracted from openSUSE Security Update openSUSE-2020-1093.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : perl-YAML-LibYAML (openSUSE-2020-1093)");
  script_summary(english:"Check for the openSUSE-2020-1093 patch");
...
if ( rpm_check(release:"SUSE15.2", reference:"perl-YAML-LibYAML-0.69-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"perl-YAML-LibYAML-debuginfo-0.69-lp152.4.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"perl-YAML-LibYAML-debugsource-0.69-lp152.4.3.1") ) flag++;
