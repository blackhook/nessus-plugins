...
ELSA-2018-2384 advisory.
  ...
  - A elevation of privilege vulnerability in the Upstream kernel skcipher. Product: Android. Versions:
    Android kernel. Android ID: A-64386293. References: Upstream kernel. (CVE-2017-13215)
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-862.11.6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-whitelists-3.10.0'},
