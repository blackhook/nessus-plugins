...
# Security Advisory OVMSA-2014-0010.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.1 : xen (OVMSA-2014-0010)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2014-June/000212.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.1", reference:"xen-4.1.2-18.el5.119")) flag++;
if (rpm_check(release:"OVS3.1", reference:"xen-devel-4.1.2-18.el5.119")) flag++;
if (rpm_check(release:"OVS3.1", reference:"xen-tools-4.1.2-18.el5.119")) flag++;
