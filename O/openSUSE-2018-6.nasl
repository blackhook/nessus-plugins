...
# extracted from openSUSE Security Update openSUSE-2018-6.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav-database (openSUSE-2018-6)");
  script_summary(english:"Check for the openSUSE-2018-6 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"clamav-database-201801010008-54.124.1") ) flag++;
