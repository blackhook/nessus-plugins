...
# Oracle Linux Security Advisory ELSA-2012-0142 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : firefox (ELSA-2012-0142)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0142 :
...
restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002616.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL4", reference:"firefox-3.6.26-3.0.1.el4", allowmaj:TRUE)) flag++;
