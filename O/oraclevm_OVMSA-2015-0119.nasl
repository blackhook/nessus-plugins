...
# Security Advisory OVMSA-2015-0119.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 : bind (OVMSA-2015-0119)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2015-September/000367.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3d951179"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"bind-libs-9.8.2-0.37.rc1.el6_7.4")) flag++;
if (rpm_check(release:"OVS3.3", reference:"bind-utils-9.8.2-0.37.rc1.el6_7.4")) flag++;
