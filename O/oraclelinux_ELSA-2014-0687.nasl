...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2014:0687 :
...
applications linked to the libtasn1 library must be restarted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-July/004277.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libtasn1-3.3-5.el7_0")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libtasn1-devel-3.3-5.el7_0")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libtasn1-tools-3.3-5.el7_0")) flag++;
