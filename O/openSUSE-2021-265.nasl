...
# extracted from openSUSE Security Update openSUSE-2021-265.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : privoxy (openSUSE-2021-265)");
  script_summary(english:"Check for the openSUSE-2021-265 patch");
...
"This update for privoxy fixes the following issues :
  ...
  - Prevent an assertion from getting triggered by a crafted
    CGI request. Commit 5bba5b89193fa. OVE-20210130-0001.
    CVE-2021-20217 Reported by: Joshua Rogers (Opera)

  - Fixed a memory leak when decompression fails
    'unexpectedly'. Commit f431d61740cc0. OVE-20210128-0001.
    CVE-2021-20216
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1181650"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.2", reference:"privoxy-3.0.31-lp152.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"privoxy-debuginfo-3.0.31-lp152.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"privoxy-debugsource-3.0.31-lp152.3.6.1") ) flag++;
