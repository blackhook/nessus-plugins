...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.x < 1.0.2q Multiple Vulnerabilities");
...
host is 1.0.x prior to 1.0.2q. It is, therefore, affected by a denial
...
openssl_check_version(fixed:'1.0.2q', min:"1.0.2", severity:SECURITY_WARNING);
