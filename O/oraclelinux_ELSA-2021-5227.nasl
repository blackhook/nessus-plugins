...
ELSA-2021-5227 advisory.
  ...
  - A flaw was found in the Linux kernel. A corrupted timer tree caused the task wakeup to be missing in the
    ...
    highest threat from this vulnerability is system availability. (CVE-2021-20317) (CVE-2021-20321)
...
var pkgs = [
    ...
    {'reference':'kernel-abi-stablelists-4.18.0-348.7.1.el8_5', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-abi-stablelists-4.18.0'},
