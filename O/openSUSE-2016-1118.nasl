...
# extracted from openSUSE Security Update openSUSE-2016-1118.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gtk2 (openSUSE-2016-1118)");
  script_summary(english:"Check for the openSUSE-2016-1118 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-branding-SLED-42.1-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-branding-openSUSE-42.1-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-branding-upstream-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-data-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-debugsource-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-devel-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-devel-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-clearlooks-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-clearlooks-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-crux-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-crux-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-glide-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-glide-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-hcengine-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-hcengine-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-industrial-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-industrial-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-mist-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-mist-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-redmond95-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-redmond95-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-thinice-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engine-thinice-debuginfo-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engines-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engines-debugsource-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-engines-devel-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-amharic-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-amharic-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-inuktitut-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-inuktitut-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-multipress-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-multipress-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-thai-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-thai-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-vietnamese-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-vietnamese-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-xim-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodule-xim-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodules-tigrigna-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-immodules-tigrigna-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-lang-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-theme-clearlooks-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-theme-crux-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-theme-industrial-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-theme-mist-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-theme-redmond95-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-theme-thinice-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-tools-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gtk2-tools-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgtk-2_0-0-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgtk-2_0-0-debuginfo-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"typelib-1_0-Gtk-2_0-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-devel-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-devel-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-clearlooks-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-clearlooks-debuginfo-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-crux-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-crux-debuginfo-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-glide-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-glide-debuginfo-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-industrial-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-industrial-debuginfo-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-mist-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-mist-debuginfo-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-redmond95-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-redmond95-debuginfo-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-thinice-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-engine-thinice-debuginfo-32bit-2.20.2-29.3") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-amharic-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-amharic-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-inuktitut-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-inuktitut-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-multipress-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-multipress-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-thai-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-thai-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-vietnamese-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-vietnamese-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-xim-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodule-xim-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodules-tigrigna-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-immodules-tigrigna-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-tools-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gtk2-tools-debuginfo-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgtk-2_0-0-32bit-2.24.31-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgtk-2_0-0-debuginfo-32bit-2.24.31-11.2") ) flag++;
