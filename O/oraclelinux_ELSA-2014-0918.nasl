...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : thunderbird (ELSA-2014-0918)");
...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-July/004240.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-24.7.0-1.0.1.el6_5", allowmaj:TRUE)) flag++;
