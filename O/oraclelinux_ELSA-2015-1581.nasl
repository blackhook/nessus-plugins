...
"From Red Hat Security Advisory 2015:1581 :
...
take effect.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2015-August/005306.html");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2015-August/005307.html");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2015-August/005308.html");
...
flag = 0;
if (rpm_check(release:"EL5", reference:"firefox-38.1.1-1.0.1.el5_11", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL6", reference:"firefox-38.1.1-1.0.1.el6_7", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-38.1.1-1.0.1.el7_1", allowmaj:TRUE)) flag++;
