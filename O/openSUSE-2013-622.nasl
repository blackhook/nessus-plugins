...
"java-1_7_0-openjdk was updated to icedtea-2.4.1 (bnc#828665) 
  ...
  - relax build requires, so every java-devel >= 1.7.0 can
    match");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=781690");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.novell.com/show_bug.cgi?id=828665");
  script_set_attribute(attribute:"see_also", value:"https://lists.opensuse.org/opensuse-updates/2013-08/msg00001.html");
