...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:1224 :
...
this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-April/007646.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-command-not-found-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-cron-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-glib-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-glib-devel-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-gstreamer-plugin-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-gtk3-module-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-yum-1.1.5-2.0.1.el7_5")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"PackageKit-yum-plugin-1.1.5-2.0.1.el7_5")) flag++;
