...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : gd (ELSA-2010-0003)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0003 :
...
backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-January/001299.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-January/001301.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", reference:"gd-2.0.28-5.4E.0.1.el4_8.1")) flag++;
if (rpm_check(release:"EL4", reference:"gd-devel-2.0.28-5.4E.0.1.el4_8.1")) flag++;
if (rpm_check(release:"EL4", reference:"gd-progs-2.0.28-5.4E.0.1.el4_8.1")) flag++;

if (rpm_check(release:"EL5", reference:"gd-2.0.33-9.4.el5_4.2")) flag++;
if (rpm_check(release:"EL5", reference:"gd-devel-2.0.33-9.4.el5_4.2")) flag++;
if (rpm_check(release:"EL5", reference:"gd-progs-2.0.33-9.4.el5_4.2")) flag++;
