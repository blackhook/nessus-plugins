...
enhancements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-November/003812.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"coreutils-8.4-31.0.1.el6")) flag++;
if (rpm_check(release:"EL6", reference:"coreutils-libs-8.4-31.0.1.el6")) flag++;
