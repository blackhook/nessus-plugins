...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 / 6 : libpng (ELSA-2012-0317)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0317 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002621.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002622.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-February/002623.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"libpng-1.2.7-9.el4")) flag++;
if (rpm_check(release:"EL4", reference:"libpng-devel-1.2.7-9.el4")) flag++;
if (rpm_check(release:"EL4", reference:"libpng10-1.0.16-10.el4")) flag++;
if (rpm_check(release:"EL4", reference:"libpng10-devel-1.0.16-10.el4")) flag++;

if (rpm_check(release:"EL5", reference:"libpng-1.2.10-15.el5_7")) flag++;
if (rpm_check(release:"EL5", reference:"libpng-devel-1.2.10-15.el5_7")) flag++;

if (rpm_check(release:"EL6", reference:"libpng-1.2.46-2.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"libpng-devel-1.2.46-2.el6_2")) flag++;
if (rpm_check(release:"EL6", reference:"libpng-static-1.2.46-2.el6_2")) flag++;
