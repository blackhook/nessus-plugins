...
module_ver = get_kb_item('Host/RedHat/appstream/idm');
...
appstreams = {
    'idm:DL1': [
      ...
      {'reference':'ipa-client-common-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ipa-common-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-healthcheck-0.7-3.module+el8.4.0+20088+3d202164', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-healthcheck-core-0.7-3.module+el8.4.0+20088+3d202164', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-python-compat-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-selinux-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'ipa-server-common-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'ipa-server-dns-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'python3-ipaclient-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipalib-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipaserver-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-ipatests-4.9.2-3.0.1.module+el8.4.0+20161+5ecb5b37', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
