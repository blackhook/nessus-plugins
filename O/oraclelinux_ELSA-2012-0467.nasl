...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0467 :
...
restarted (log out, then log back in) for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-April/002734.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-April/002738.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"freetype-2.2.1-31.el5_8.1")) flag++;
if (rpm_check(release:"EL5", reference:"freetype-demos-2.2.1-31.el5_8.1")) flag++;
if (rpm_check(release:"EL5", reference:"freetype-devel-2.2.1-31.el5_8.1")) flag++;

if (rpm_check(release:"EL6", reference:"freetype-2.3.11-6.el6_2.9")) flag++;
if (rpm_check(release:"EL6", reference:"freetype-demos-2.3.11-6.el6_2.9")) flag++;
if (rpm_check(release:"EL6", reference:"freetype-devel-2.3.11-6.el6_2.9")) flag++;
