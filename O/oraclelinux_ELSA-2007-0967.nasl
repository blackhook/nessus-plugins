...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : pcre (ELSA-2007-0967)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0967 :
...
disclosing these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-November/000377.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"pcre-6.6-2.el5_0.1")) flag++;
if (rpm_check(release:"EL5", reference:"pcre-devel-6.6-2.el5_0.1")) flag++;
