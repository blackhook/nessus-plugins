...
# extracted from openSUSE Security Update openSUSE-2020-934.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ntp (openSUSE-2020-934)");
  script_summary(english:"Check for the openSUSE-2020-934 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"ntp-4.2.8p15-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ntp-debuginfo-4.2.8p15-lp151.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ntp-debugsource-4.2.8p15-lp151.2.3.1") ) flag++;
