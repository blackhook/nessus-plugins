...
# extracted from openSUSE Security Update openSUSE-2016-328.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh (openSUSE-2016-328)");
  script_summary(english:"Check for the openSUSE-2016-328 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"libssh-debugsource-0.6.3-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libssh-devel-0.6.3-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libssh4-0.6.3-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libssh4-debuginfo-0.6.3-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libssh4-32bit-0.6.3-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libssh4-debuginfo-32bit-0.6.3-10.1") ) flag++;
