...
# Security Advisory OVMSA-2013-0073.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.1 : xen (OVMSA-2013-0073)");
...
critical security updates :
  ...
  - bug 17571611 (CVE-2013-4368)"
  );
  # https://oss.oracle.com/pipermail/oraclevm-errata/2013-October/000184.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?097f78bd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.1", reference:"xen-4.1.2-18.el5.112")) flag++;
if (rpm_check(release:"OVS3.1", reference:"xen-devel-4.1.2-18.el5.112")) flag++;
if (rpm_check(release:"OVS3.1", reference:"xen-tools-4.1.2-18.el5.112")) flag++;
