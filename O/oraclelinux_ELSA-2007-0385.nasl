...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 / 5 : fetchmail (ELSA-2007-0385)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0385 :
...
contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000169.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000170.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-June/000215.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"fetchmail-6.2.0-3.el3.4")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"fetchmail-6.2.0-3.el3.4")) flag++;

if (rpm_check(release:"EL4", cpu:"i386", reference:"fetchmail-6.2.5-6.0.1.el4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"fetchmail-6.2.5-6.0.1.el4")) flag++;

if (rpm_check(release:"EL5", reference:"fetchmail-6.3.6-1.0.1.el5")) flag++;
