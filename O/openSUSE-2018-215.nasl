...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : zziplib (openSUSE-2018-215)");
  script_summary(english:"Check for the openSUSE-2018-215 patch");
  ...
  script_set_attribute(
    ...
    value:
"This update for zziplib to 0.13.67 contains multiple bug and security
fixes :
...
This update was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1034539"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1078497"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1078701"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1079096"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.3", reference:"libzzip-0-13-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libzzip-0-13-debuginfo-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"zziplib-debugsource-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"zziplib-devel-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"zziplib-devel-debuginfo-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libzzip-0-13-32bit-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"libzzip-0-13-debuginfo-32bit-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"zziplib-devel-32bit-0.13.67-13.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", cpu:"x86_64", reference:"zziplib-devel-debuginfo-32bit-0.13.67-13.3.1") ) flag++;
