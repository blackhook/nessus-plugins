...
# extracted from openSUSE Security Update openSUSE-2017-105.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : icoutils (openSUSE-2017-105)");
  script_summary(english:"Check for the openSUSE-2017-105 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"icoutils-0.31.1-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"icoutils-debuginfo-0.31.1-8.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"icoutils-debugsource-0.31.1-8.1") ) flag++;
