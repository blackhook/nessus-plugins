...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:0708 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2020-March/009684.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected http-parser package."
  );
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"http-parser-2.8.0-5.el8_1.2")) flag++;
