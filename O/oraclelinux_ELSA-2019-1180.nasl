...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : libvirt (ELSA-2019-1180) (MDSUM/RIDL) (MFBDS/RIDL/ZombieLoad) (MLPDS/RIDL) (MSBDS/Fallout)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Oracle Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"From Red Hat Security Advisory 2019:1180 :
...
the CVE page(s) listed in the References section.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2019-May/008727.html");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libvirt-0.10.2-64.0.1.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-client-0.10.2-64.0.1.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-devel-0.10.2-64.0.1.el6_10.1")) flag++;
if (rpm_check(release:"EL6", cpu:"x86_64", reference:"libvirt-lock-sanlock-0.10.2-64.0.1.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"libvirt-python-0.10.2-64.0.1.el6_10.1")) flag++;
