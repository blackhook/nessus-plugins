...
# Oracle Linux Security Advisory ELSA-2007-0011 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 : libgsf (ELSA-2007-0011)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0011 :
...
packages, which contain a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-January/000040.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-March/000093.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libgsf");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:libgsf-devel");
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libgsf-1.6.0-7")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libgsf-1.6.0-7")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"libgsf-devel-1.6.0-7")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"libgsf-devel-1.6.0-7")) flag++;

if (rpm_check(release:"EL4", cpu:"i386", reference:"libgsf-1.10.1-2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"libgsf-1.10.1-2")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"libgsf-devel-1.10.1-2")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"libgsf-devel-1.10.1-2")) flag++;
