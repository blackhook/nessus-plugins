...
# extracted from openSUSE Security Update openSUSE-2016-1074.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libtorrent-rasterbar (openSUSE-2016-1074)");
  script_summary(english:"Check for the openSUSE-2016-1074 patch");
...
"This update for libtorrent-rasterbar fixes the following issues :
  ...
  - Add a new 'preformatted' type to bencode entry variant
    type.
...
if ( rpm_check(release:"SUSE42.1", reference:"libtorrent-rasterbar-debugsource-1.0.10-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libtorrent-rasterbar-devel-1.0.10-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libtorrent-rasterbar8-1.0.10-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libtorrent-rasterbar8-debuginfo-1.0.10-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"python-libtorrent-rasterbar-1.0.10-11.2") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"python-libtorrent-rasterbar-debuginfo-1.0.10-11.2") ) flag++;
