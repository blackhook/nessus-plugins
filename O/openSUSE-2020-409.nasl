...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-409 patch");
...
CVE-2019-2435) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1122204"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected python-mysql-connector-python packages."
  );
