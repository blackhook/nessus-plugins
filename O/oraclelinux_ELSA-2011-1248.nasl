...
# extracted from Red Hat Security Advisory RHSA-2011:1248 and 
# Oracle Linux Security Advisory ELSA-2011-1248 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:1248");

  script_name(english:"Oracle Linux 6 : ca-certificates (ELSA-2011-1248)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1248 :
...
that CA as untrusted. (BZ#734381)
...
restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002335.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:ca-certificates");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"ca-certificates-2010.63-3.el6_1.5")) flag++;
