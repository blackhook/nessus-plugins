...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0256 :
...
automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-February/001878.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"dhclient-4.1.1-12.P1.el6_0.2")) flag++;
if (rpm_check(release:"EL6", reference:"dhcp-4.1.1-12.P1.el6_0.2")) flag++;
if (rpm_check(release:"EL6", reference:"dhcp-devel-4.1.1-12.P1.el6_0.2")) flag++;
