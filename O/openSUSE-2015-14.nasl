...
# extracted from openSUSE Security Update openSUSE-2015-14.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : jasper (openSUSE-SU-2015:0039-1)");
  script_summary(english:"Check for the openSUSE-2015-14 patch");
...
"The follow issues were fixed with this update :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2015-01/msg00014.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.3", reference:"jasper-1.900.1-156.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"jasper-debuginfo-1.900.1-156.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"jasper-debugsource-1.900.1-156.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libjasper-devel-1.900.1-156.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libjasper1-1.900.1-156.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"libjasper1-debuginfo-1.900.1-156.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", cpu:"x86_64", reference:"libjasper1-32bit-1.900.1-156.9.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", cpu:"x86_64", reference:"libjasper1-debuginfo-32bit-1.900.1-156.9.1") ) flag++;
