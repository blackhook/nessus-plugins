...
# extracted from openSUSE Security Update openSUSE-2016-664.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : Chromium (openSUSE-2016-664)");
  script_summary(english:"Check for the openSUSE-2016-664 patch");
