...
# extracted from openSUSE Security Update openSUSE-2017-1210.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wget (openSUSE-2017-1210)");
  script_summary(english:"Check for the openSUSE-2017-1210 patch");
...
This update was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1064715"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1064716"
  );
...
if ( rpm_check(release:"SUSE42.2", reference:"wget-1.14-8.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"wget-debuginfo-1.14-8.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"wget-debugsource-1.14-8.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wget-1.14-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wget-debuginfo-1.14-12.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"wget-debugsource-1.14-12.1") ) flag++;
