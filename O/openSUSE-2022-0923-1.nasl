...
# openSUSE Security Update openSUSE-SU-2022:0923-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 : Test update for SUSE:SLE-15-SP4:Update (security) (openSUSE-SU-2022:0923-1)");
...
openSUSE-SU-2022:0923-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1194507");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/NJA3J2QL4G6LCJHC2XZT2XWXJRGJTCS7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c25ec7d3");
...
var pkgs = [
    {'reference':'update-test-security-5.1-150200.35.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
