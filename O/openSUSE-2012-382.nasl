...
# extracted from openSUSE Security Update openSUSE-2012-382.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : bind (openSUSE-SU-2012:0864-1)");
  script_summary(english:"Check for the openSUSE-2012-382 patch");
...
Non-security fixes :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-07/msg00025.html"
  );
...
if ( rpm_check(release:"SUSE12.1", reference:"bind-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-chrootenv-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-debuginfo-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-debugsource-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-devel-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-libs-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-libs-debuginfo-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-lwresd-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-lwresd-debuginfo-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-utils-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"bind-utils-debuginfo-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"bind-libs-32bit-9.8.3P1-4.14.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", cpu:"x86_64", reference:"bind-libs-debuginfo-32bit-9.8.3P1-4.14.1") ) flag++;
