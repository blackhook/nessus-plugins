...
if (description)
{
  ...
  script_bugtraq_id(48056, 51084, 51300, 52107, 53540, 54718);
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1288 :
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-September/003039.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-September/003040.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"libxml2-2.6.26-2.1.15.0.1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"libxml2-devel-2.6.26-2.1.15.0.1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"libxml2-python-2.6.26-2.1.15.0.1.el5_8.5")) flag++;

if (rpm_check(release:"EL6", reference:"libxml2-2.7.6-8.0.1.el6_3.3")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-devel-2.7.6-8.0.1.el6_3.3")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-python-2.7.6-8.0.1.el6_3.3")) flag++;
if (rpm_check(release:"EL6", reference:"libxml2-static-2.7.6-8.0.1.el6_3.3")) flag++;
