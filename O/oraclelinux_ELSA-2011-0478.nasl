...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0478 :
...
libvirtd restart') for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-May/002111.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"libvirt-0.8.2-15.0.1.el5_6.4")) flag++;
if (rpm_check(release:"EL5", reference:"libvirt-devel-0.8.2-15.0.1.el5_6.4")) flag++;
if (rpm_check(release:"EL5", reference:"libvirt-python-0.8.2-15.0.1.el5_6.4")) flag++;
