...
# extracted from openSUSE Security Update openSUSE-2016-92.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openldap2 (openSUSE-2016-92) (Logjam)");
...
It also fixes the following non-security bugs :
  ...
  - bsc#904028: Add missing dependency binutils used by
    %pre.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.opensuse.org/show_bug.cgi?id=904028");
...
if ( rpm_check(release:"SUSE13.2", reference:"compat-libldap-2_3-0-2.3.37-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"compat-libldap-2_3-0-debuginfo-2.3.37-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libldap-2_4-2-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libldap-2_4-2-debuginfo-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-back-meta-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-back-meta-debuginfo-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-back-perl-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-back-perl-debuginfo-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-back-sql-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-back-sql-debuginfo-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-client-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-client-debuginfo-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-client-debugsource-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-debuginfo-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-debugsource-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-devel-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"openldap2-devel-static-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libldap-2_4-2-32bit-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libldap-2_4-2-debuginfo-32bit-2.4.39-8.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"openldap2-devel-32bit-2.4.39-8.9.1") ) flag++;
