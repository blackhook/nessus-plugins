...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:0420 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-February/008499.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"polkit-0.96-11.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"polkit-desktop-policy-0.96-11.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"polkit-devel-0.96-11.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"polkit-docs-0.96-11.el6_10.1")) flag++;
