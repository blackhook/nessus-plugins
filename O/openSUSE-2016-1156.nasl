...
# extracted from openSUSE Security Update openSUSE-2016-1156.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : php5 (openSUSE-2016-1156)");
  script_summary(english:"Check for the openSUSE-2016-1156 patch");
...
This update was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=987530"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.1", reference:"apache2-mod_php5-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"apache2-mod_php5-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-bcmath-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-bcmath-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-bz2-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-bz2-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-calendar-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-calendar-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-ctype-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-ctype-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-curl-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-curl-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-dba-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-dba-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-debugsource-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-devel-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-dom-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-dom-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-enchant-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-enchant-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-exif-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-exif-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-fastcgi-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-fastcgi-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-fileinfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-fileinfo-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-firebird-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-firebird-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-fpm-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-fpm-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-ftp-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-ftp-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-gd-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-gd-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-gettext-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-gettext-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-gmp-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-gmp-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-iconv-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-iconv-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-imap-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-imap-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-intl-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-intl-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-json-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-json-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-ldap-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-ldap-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mbstring-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mbstring-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mcrypt-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mcrypt-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mssql-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mssql-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mysql-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-mysql-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-odbc-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-odbc-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-opcache-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-opcache-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-openssl-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-openssl-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pcntl-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pcntl-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pdo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pdo-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pear-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pgsql-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pgsql-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-phar-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-phar-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-posix-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-posix-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pspell-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-pspell-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-readline-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-readline-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-shmop-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-shmop-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-snmp-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-snmp-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-soap-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-soap-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sockets-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sockets-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sqlite-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sqlite-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-suhosin-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-suhosin-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sysvmsg-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sysvmsg-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sysvsem-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sysvsem-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sysvshm-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-sysvshm-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-tidy-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-tidy-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-tokenizer-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-tokenizer-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-wddx-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-wddx-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xmlreader-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xmlreader-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xmlrpc-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xmlrpc-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xmlwriter-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xmlwriter-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xsl-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-xsl-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-zip-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-zip-debuginfo-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-zlib-5.5.14-59.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"php5-zlib-debuginfo-5.5.14-59.1") ) flag++;
