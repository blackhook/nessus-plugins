...
# extracted from OracleVM Security Advisory OVMSA-2021-0023.
##
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : kernel-uek (OVMSA-2021-0023)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/OVMSA-2021-0023.html");
...
if (machine_uptrack_level)
{
  ...
  var fixed_uptrack_levels = ['4.1.12-124.52.5.el6uek'];
  foreach var fixed_uptrack_level ( fixed_uptrack_levels ) {
    if (rpm_spec_vers_cmp(a:trimmed_uptrack_level, b:fixed_uptrack_level) >= 0)
    {
      audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for OVMSA-2021-0023');
    }
  }
...
var pkgs = [
    {'reference':'kernel-uek-4.1.12-124.52.5.el6uek', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-4.1.12'},
    {'reference':'kernel-uek-firmware-4.1.12-124.52.5.el6uek', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-4.1.12'}
];
