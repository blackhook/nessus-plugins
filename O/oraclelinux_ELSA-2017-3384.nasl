...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:3384 :
...
Red Hat would like to thank Samuel Thibault for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-December/007399.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"liblouis-2.5.2-12.el7_4")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"liblouis-devel-2.5.2-12.el7_4")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"liblouis-doc-2.5.2-12.el7_4")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"liblouis-python-2.5.2-12.el7_4")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"liblouis-utils-2.5.2-12.el7_4")) flag++;
