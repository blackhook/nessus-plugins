...
# extracted from openSUSE Security Update openSUSE-2014-755.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : icecast (openSUSE-SU-2014:1593-1)");
  script_summary(english:"Check for the openSUSE-2014-755 patch");
...
This security issue was fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2014-12/msg00038.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.2", reference:"icecast-2.4.0-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"icecast-debuginfo-2.4.0-2.8.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"icecast-debugsource-2.4.0-2.8.1") ) flag++;
