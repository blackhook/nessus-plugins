...
[orabug 22766491]"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-February/005830.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"openssh-4.3p2-82.0.1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"openssh-askpass-4.3p2-82.0.1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"openssh-clients-4.3p2-82.0.1.el5")) flag++;
if (rpm_check(release:"EL5", reference:"openssh-server-4.3p2-82.0.1.el5")) flag++;
