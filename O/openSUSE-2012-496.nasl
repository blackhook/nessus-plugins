...
# extracted from openSUSE Security Update openSUSE-2012-496.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2012-3441");

  script_name(english:"openSUSE Security Update : icinga (openSUSE-SU-2012:0968-1)");
  script_summary(english:"Check for the openSUSE-2012-496 patch");
...
"  - fixed icinga-create_mysqldb.sh - it granted icinga
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=767319"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-08/msg00012.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.1", reference:"icinga-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-debuginfo-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-debugsource-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-devel-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-idoutils-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-idoutils-debuginfo-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-idoutils-mysql-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-idoutils-oracle-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-idoutils-pgsql-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-plugins-eventhandlers-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-www-1.5.1-5.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"icinga-www-debuginfo-1.5.1-5.4.1") ) flag++;
