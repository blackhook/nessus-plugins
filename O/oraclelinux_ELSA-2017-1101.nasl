...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2017:1101 :
...
issue. Upstream acknowledges Ronald Crane as the original reporter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2017-April/006893.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"nss-3.21.3-2.0.1.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"nss-devel-3.21.3-2.0.1.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"nss-pkcs11-devel-3.21.3-2.0.1.el5_11")) flag++;
if (rpm_check(release:"EL5", reference:"nss-tools-3.21.3-2.0.1.el5_11")) flag++;
