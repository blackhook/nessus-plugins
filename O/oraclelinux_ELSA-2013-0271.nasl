...
if (rpm_check(release:"EL5", reference:"firefox-17.0.3-1.0.1.el5_9", allowmaj:TRUE)) flag++;
...
if (rpm_check(release:"EL6", reference:"firefox-17.0.3-1.0.1.el6_3", allowmaj:TRUE)) flag++;
