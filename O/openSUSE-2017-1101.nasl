...
# extracted from openSUSE Security Update openSUSE-2017-1101.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : vlc (openSUSE-2017-1101)");
  script_summary(english:"Check for the openSUSE-2017-1101 patch");
...
For the various other fixes introduced by 2.2.6 please see the
changelog."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.2", reference:"libvlc5-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libvlc5-debuginfo-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libvlccore8-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libvlccore8-debuginfo-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-codec-gstreamer-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-codec-gstreamer-debuginfo-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-debuginfo-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-debugsource-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-devel-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-lang-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-noX-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-noX-debuginfo-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-qt-2.2.6-32.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"vlc-qt-debuginfo-2.2.6-32.3.1") ) flag++;
