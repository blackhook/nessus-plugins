...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1130 :
...
for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-August/002967.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"xen-3.0.3-135.el5_8.4")) flag++;
if (rpm_check(release:"EL5", reference:"xen-devel-3.0.3-135.el5_8.4")) flag++;
if (rpm_check(release:"EL5", reference:"xen-libs-3.0.3-135.el5_8.4")) flag++;
