...
# extracted from openSUSE Security Update openSUSE-2013-412.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : strongswan (openSUSE-SU-2013:0873-1)");
  script_summary(english:"Check for the openSUSE-2013-412 patch");
...
"  - Applied upstream patch for security vulnerability
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-06/msg00010.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-debugsource-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-ipsec-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-ipsec-debuginfo-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-libs0-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-libs0-debuginfo-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-mysql-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-mysql-debuginfo-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-nm-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-nm-debuginfo-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-sqlite-5.0.1-4.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"strongswan-sqlite-debuginfo-5.0.1-4.4.1") ) flag++;
