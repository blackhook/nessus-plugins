...
# extracted from openSUSE Security Update openSUSE-2017-1082.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : freexl (openSUSE-2017-1082)");
  script_summary(english:"Check for the openSUSE-2017-1082 patch");
...
These security issues were fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1058431"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1058433"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.2", reference:"freexl-debugsource-1.0.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"freexl-devel-1.0.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libfreexl1-1.0.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libfreexl1-debuginfo-1.0.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freexl-debugsource-1.0.4-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"freexl-devel-1.0.4-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libfreexl1-1.0.4-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libfreexl1-debuginfo-1.0.4-5.1") ) flag++;
