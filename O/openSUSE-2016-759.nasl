...
# extracted from openSUSE Security Update openSUSE-2016-759.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : obs-service-source_validator (openSUSE-2016-759)");
  script_summary(english:"Check for the openSUSE-2016-759 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"obs-service-source_validator-0.6+git20160531.fbfe336-11.1") ) flag++;
