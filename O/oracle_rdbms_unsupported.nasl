...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0574");
...
# 19c expires April 2027. 21c is an 'innovation release', support expires April 2024 (no ESP).
fixed = '19.0.0.0';
supported_versions = '19c / 21c';
