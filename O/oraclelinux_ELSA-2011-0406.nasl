...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0406 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/002046.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"quagga-0.99.15-5.el6_0.2")) flag++;
if (rpm_check(release:"EL6", reference:"quagga-contrib-0.99.15-5.el6_0.2")) flag++;
if (rpm_check(release:"EL6", reference:"quagga-devel-0.99.15-5.el6_0.2")) flag++;
