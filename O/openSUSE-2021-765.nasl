...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2021-765 patch");
...
"This update for Botan fixes the following issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1182670"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected Botan packages."
  );
