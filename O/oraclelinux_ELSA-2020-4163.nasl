...
number.");
  script_set_attribute(attribute:"see_also", value:"http://linux.oracle.com/errata/ELSA-2020-4163.html");
...
pkgs = [
    {'reference':'thunderbird-78.3.1-1.0.1.el7_9', 'cpu':'aarch64', 'release':'7', 'allowmaj':TRUE},
    {'reference':'thunderbird-78.3.1-1.0.1.el7_9', 'cpu':'x86_64', 'release':'7', 'allowmaj':TRUE}
];
