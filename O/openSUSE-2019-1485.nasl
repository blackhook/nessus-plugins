...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2019-1485 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1130831"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=944458"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected screen packages."
  );
