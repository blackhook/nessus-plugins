...
# extracted from openSUSE Security Update openSUSE-2016-925.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libidn (openSUSE-2016-925)");
  script_summary(english:"Check for the openSUSE-2016-925 patch");
...
Security issues fixed :
  ...
  - CVE-2015-8948, CVE-2016-6262: Fixed an
    out-of-bounds-read when reading one zero byte as input
    (bsc#990189).

  - CVE-2016-6263: Fixed stringprep_utf8_nfkc_normalize to
    reject invalid UTF-8 (bsc#boo#990191).

Included bugfixes :

  - Fixed crash in idna_to_unicode_8z8z and
    idna_to_unicode_8zlz (introduced in 1.31).
...
if ( rpm_check(release:"SUSE13.2", reference:"libidn-debugsource-1.33-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libidn-devel-1.33-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libidn-tools-1.33-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libidn-tools-debuginfo-1.33-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libidn11-1.33-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libidn11-debuginfo-1.33-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libidn11-32bit-1.33-3.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libidn11-debuginfo-32bit-1.33-3.6.1") ) flag++;
