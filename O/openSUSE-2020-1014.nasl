...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-1014 patch");
...
"This update for google-compute-engine fixes the following issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1169978"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1173258"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected google-compute-engine packages."
  );
