...
# extracted from openSUSE Security Update openSUSE-2016-394.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libssh (openSUSE-2016-394)");
  script_summary(english:"Check for the openSUSE-2016-394 patch");
...
This fix was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=965875"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.2", reference:"libssh-debugsource-0.6.3-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libssh-devel-0.6.3-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libssh4-0.6.3-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libssh4-debuginfo-0.6.3-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libssh4-32bit-0.6.3-2.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libssh4-debuginfo-32bit-0.6.3-2.10.1") ) flag++;
