...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2016:0430 :
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-March/005853.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"xerces-c-3.1.1-8.el7_2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"xerces-c-devel-3.1.1-8.el7_2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"xerces-c-doc-3.1.1-8.el7_2")) flag++;
