...
# Oracle Linux Security Advisory ELSA-2012-1122 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : bind97 (ELSA-2012-1122)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1122 :
...
(named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-July/002963.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"bind97-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-chroot-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-devel-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-libs-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"EL5", reference:"bind97-utils-9.7.0-10.P2.el5_8.2")) flag++;
