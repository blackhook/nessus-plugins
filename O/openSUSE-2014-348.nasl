...
# extracted from openSUSE Security Update openSUSE-2014-348.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : python-eyeD3 (openSUSE-SU-2014:0620-1)");
  script_summary(english:"Check for the openSUSE-2014-348 patch");
...
"This python-eyeD3 fixes the following security issue.
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2014-05/msg00028.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE13.1", reference:"python-eyeD3-0.7.3-3.4.1") ) flag++;
