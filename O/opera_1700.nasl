...
if (description)
{
  ...
  script_bugtraq_id(62885);

  script_name(english:"Opera < 17 Multiple Vulnerabilities");
...
to version 17. It is, therefore, reportedly affected by multiple
unspecified vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20170922104138/http://www.opera.com:80/docs/changelogs/unified/1700/");
  script_set_attribute(attribute:"solution", value:"Upgrade to Opera 17 or later.");
