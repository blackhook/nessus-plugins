...
# openSUSE Security Update openSUSE-SU-2022:0774-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : tcpdump (openSUSE-SU-2022:0774-1)");
...
openSUSE-SU-2022:0774-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6289acae");
...
var pkgs = [
    {'reference':'tcpdump-4.9.2-3.18.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
