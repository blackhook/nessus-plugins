...
# Oracle Linux Security Advisory ELSA-2007-0245 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : cpio (ELSA-2007-0245)");
...
which contains backported fixes to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-May/000148.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"cpio-2.5-13.RHEL4")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"cpio-2.5-13.RHEL4")) flag++;
