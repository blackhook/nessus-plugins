...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : xorg-x11-xfs (ELSA-2007-0520)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0520 :
...
this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-July/000263.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"xorg-x11-xfs-1.0.2-4")) flag++;
if (rpm_check(release:"EL5", reference:"xorg-x11-xfs-utils-1.0.2-4")) flag++;
