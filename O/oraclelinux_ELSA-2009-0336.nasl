...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:0336 :
...
contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-March/000930.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"glib2-2.12.3-4.el5_3.1")) flag++;
if (rpm_check(release:"EL5", reference:"glib2-devel-2.12.3-4.el5_3.1")) flag++;
