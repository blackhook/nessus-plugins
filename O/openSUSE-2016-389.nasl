...
# extracted from openSUSE Security Update openSUSE-2016-389.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : graphite2 (openSUSE-2016-389)");
  script_summary(english:"Check for the openSUSE-2016-389 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"graphite2-1.3.1-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"graphite2-debuginfo-1.3.1-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"graphite2-debugsource-1.3.1-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"graphite2-devel-1.3.1-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgraphite2-3-1.3.1-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgraphite2-3-debuginfo-1.3.1-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgraphite2-3-32bit-1.3.1-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgraphite2-3-debuginfo-32bit-1.3.1-3.1") ) flag++;
