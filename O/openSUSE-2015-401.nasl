...
# extracted from openSUSE Security Update openSUSE-2015-401.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : fuse (openSUSE-2015-401)");
  script_summary(english:"Check for the openSUSE-2015-401 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"fuse-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"fuse-debuginfo-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"fuse-debugsource-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"fuse-devel-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"fuse-devel-static-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libfuse2-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libfuse2-debuginfo-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libulockmgr1-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libulockmgr1-debuginfo-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libfuse2-32bit-2.9.4-2.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", cpu:"x86_64", reference:"libfuse2-debuginfo-32bit-2.9.4-2.3.1") ) flag++;
