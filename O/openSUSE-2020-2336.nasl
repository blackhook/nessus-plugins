...
# extracted from openSUSE Security Update openSUSE-2020-2336.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ovmf (openSUSE-2020-2336)");
  script_summary(english:"Check for the openSUSE-2020-2336 patch");
...
"This update for ovmf fixes the following issues :
  ...
  - CVE-2019-14584: Fixed a null dereference in
...
if ( rpm_check(release:"SUSE15.1", reference:"ovmf-2017+git1510945757.b2662641d5-lp151.11.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"ovmf-tools-2017+git1510945757.b2662641d5-lp151.11.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"qemu-ovmf-ia32-2017+git1510945757.b2662641d5-lp151.11.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"qemu-ovmf-x86_64-2017+git1510945757.b2662641d5-lp151.11.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"qemu-ovmf-x86_64-debug-2017+git1510945757.b2662641d5-lp151.11.12.1") ) flag++;
