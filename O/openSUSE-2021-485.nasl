...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2021-485 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1183728"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected eclipse packages."
  );
