...
# extracted from openSUSE Security Update openSUSE-2012-765.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cgit (openSUSE-SU-2012:1461-1)");
  script_summary(english:"Check for the openSUSE-2012-765 patch");
...
due to improperly quoted arguments."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-11/msg00008.html"
  );
