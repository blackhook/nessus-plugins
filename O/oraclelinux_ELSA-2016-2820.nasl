...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2016:2820 :
...
CVE-2016-8705)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-November/006536.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"memcached-1.4.4-3.el6_8.1")) flag++;
if (rpm_check(release:"EL6", reference:"memcached-devel-1.4.4-3.el6_8.1")) flag++;
