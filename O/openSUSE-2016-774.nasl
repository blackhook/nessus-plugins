...
# extracted from openSUSE Security Update openSUSE-2016-774.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libtorrent-rasterbar (openSUSE-2016-774)");
  script_summary(english:"Check for the openSUSE-2016-774 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"libtorrent-rasterbar-debugsource-0.16.17-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libtorrent-rasterbar-devel-0.16.17-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libtorrent-rasterbar7-0.16.17-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libtorrent-rasterbar7-debuginfo-0.16.17-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"python-libtorrent-rasterbar-0.16.17-2.5.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"python-libtorrent-rasterbar-debuginfo-0.16.17-2.5.1") ) flag++;
