...
# Security Advisory OVMSA-2014-0019.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : bash (OVMSA-2014-0019)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2014-September/000220.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?93476dbb"
  );
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"bash-3.2-33.el5.1")) flag++;
