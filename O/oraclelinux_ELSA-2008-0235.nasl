...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : speex (ELSA-2008-0235)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0235 :
...
which contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-April/000572.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-April/000573.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"speex-1.0.4-4.el4_6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"speex-1.0.4-4.el4_6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"speex-devel-1.0.4-4.el4_6.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"speex-devel-1.0.4-4.el4_6.1")) flag++;

if (rpm_check(release:"EL5", reference:"speex-1.0.5-4.el5_1.1")) flag++;
if (rpm_check(release:"EL5", reference:"speex-devel-1.0.5-4.el5_1.1")) flag++;
