...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-1579 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1152930"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174477"
  );
  script_set_attribute(
    attribute:"solution",
