...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:0913 :
...
number."
  ...
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-March/009758.html");
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libvncserver-0.9.9-14.el7_7")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"libvncserver-devel-0.9.9-14.el7_7")) flag++;
