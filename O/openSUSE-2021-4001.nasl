...
# openSUSE Security Update openSUSE-SU-2021:4001-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python-pip (openSUSE-SU-2021:4001-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:4001-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/6BN7ZQZP5LV6NPIUJPUMF2NJNETRO5VW/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1bcf4fdb");
...
var pkgs = [
    {'reference':'python2-pip-20.0.2-6.15.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pip-20.0.2-6.15.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
