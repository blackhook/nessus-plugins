...
# openSUSE Security Update openSUSE-SU-2021:1825-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : lz4 (openSUSE-SU-2021:1825-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:1825-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1185438");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/MA4LQPPDXUEKHDKVDM24RJVHSV2EC67P/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f95aecf9");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2021-3520");
  script_set_attribute(attribute:"solution", value:
"Update the affected liblz4-1, liblz4-1-32bit, liblz4-devel and / or lz4 packages.");
...
pkgs = [
    {'reference':'liblz4-1-1.9.2-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'liblz4-1-32bit-1.9.2-3.3.1', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'liblz4-devel-1.9.2-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'lz4-1.9.2-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'liblz4-1 / liblz4-1-32bit / liblz4-devel / lz4');
}
