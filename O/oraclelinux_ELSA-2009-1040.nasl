...
# Oracle Linux Security Advisory ELSA-2009-1040 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : ntp (ELSA-2009-1040)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:1040 :
...
the update, the ntpd daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-May/001016.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", reference:"ntp-4.2.0.a.20040617-8.el4_7.2")) flag++;
