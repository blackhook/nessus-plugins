...
# extracted from openSUSE Security Update openSUSE-2016-478.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tiff (openSUSE-2016-478)");
  script_summary(english:"Check for the openSUSE-2016-478 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"libtiff-devel-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libtiff5-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"libtiff5-debuginfo-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"tiff-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"tiff-debuginfo-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"tiff-debugsource-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libtiff-devel-32bit-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libtiff5-32bit-4.0.6-10.23.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"libtiff5-debuginfo-32bit-4.0.6-10.23.1") ) flag++;
