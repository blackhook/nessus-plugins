...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:0726 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2020-March/009673.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"sudo-1.8.6p3-29.0.1.el6_10.3")) flag++;
if (rpm_check(release:"EL6", reference:"sudo-devel-1.8.6p3-29.0.1.el6_10.3")) flag++;
