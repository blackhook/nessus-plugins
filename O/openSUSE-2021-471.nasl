...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2021-471 patch");
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177125"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1177222"
  );
  script_set_attribute(
    attribute:"solution",
