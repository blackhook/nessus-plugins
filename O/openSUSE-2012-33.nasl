...
# extracted from openSUSE Security Update openSUSE-2012-33.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : acroread (openSUSE-2012-33)");
...
if ( rpm_check(release:"SUSE12.1", reference:"acroread-9.4.7-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"acroread-cmaps-9.4.1-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"acroread-fonts-ja-9.4.1-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"acroread-fonts-ko-9.4.1-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"acroread-fonts-zh_CN-9.4.1-3.7.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"acroread-fonts-zh_TW-9.4.1-3.7.1") ) flag++;
