...
# Security Advisory OVMSA-2017-0046.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : Unbreakable / etc (OVMSA-2017-0046)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38bea068"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"kernel-uek-2.6.39-400.294.3.el5uek")) flag++;
if (rpm_check(release:"OVS3.2", reference:"kernel-uek-firmware-2.6.39-400.294.3.el5uek")) flag++;
