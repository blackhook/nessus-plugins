...
# Security Advisory OVMSA-2013-0010.
#
...
if (description)
{
  ...
  script_bugtraq_id(57433, 57740, 57743, 57744);

  script_name(english:"OracleVM 3.1 : kernel-uek (OVMSA-2013-0010)");
...
critical security updates :
  ...
  - netback: correct netbk_tx_err to handle wrap around.
    (Ian Campbell) [Orabug: 16243309] (CVE-2013-0216
    CVE-2013-0217)
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2013-February/000125.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5d1ed3fc"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.1", reference:"kernel-uek-2.6.39-200.1.16.el5uek")) flag++;
if (rpm_check(release:"OVS3.1", reference:"kernel-uek-firmware-2.6.39-200.1.16.el5uek")) flag++;
