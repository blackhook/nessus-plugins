...
# openSUSE Security Update openSUSE-SU-2021:4018-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : fetchmail (openSUSE-SU-2021:4018-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2021:4018-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZEYREAP5E4PNL4UXB7R6OYSFSQ5VNFHB/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2a822b03");
...
var pkgs = [
    {'reference':'fetchmail-6.4.22-20.20.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'fetchmailconf-6.4.22-20.20.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
