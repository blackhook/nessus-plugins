...
# extracted from openSUSE Security Update openSUSE-2016-1381.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sudo (openSUSE-2016-1381)");
  script_summary(english:"Check for the openSUSE-2016-1381 patch");
...
Sudo was updated to the package from SUSE:SLE-12-SP2:Update,
incorporating the following new feature :
...
The following bug fixes are included :
  ...
  # https://features.opensuse.org/818850
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.2", reference:"sudo-1.8.10p3-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"sudo-debuginfo-1.8.10p3-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"sudo-debugsource-1.8.10p3-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"sudo-devel-1.8.10p3-7.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"sudo-test-1.8.10p3-7.1") ) flag++;
