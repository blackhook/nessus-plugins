...
# extracted from openSUSE Security Update openSUSE-2017-463.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : lxc (openSUSE-2017-463)");
  script_summary(english:"Check for the openSUSE-2017-463 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"lxc-1.1.5-15.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"lxc-debuginfo-1.1.5-15.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"lxc-debugsource-1.1.5-15.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"lxc-devel-1.1.5-15.3.1") ) flag++;
