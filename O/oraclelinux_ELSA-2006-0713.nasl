...
# Oracle Linux Security Advisory ELSA-2006-0713 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 : python (ELSA-2006-0713)");
...
contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2006-November/000012.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-March/000102.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"python-2.2.3-6.5")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"python-devel-2.2.3-6.5")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"python-tools-2.2.3-6.5")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"tkinter-2.2.3-6.5")) flag++;

if (rpm_check(release:"EL4", cpu:"i386", reference:"python-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"python-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"python-devel-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"python-devel-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"python-docs-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"python-docs-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"python-tools-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"python-tools-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"tkinter-2.3.4-14.3")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"tkinter-2.3.4-14.3")) flag++;
