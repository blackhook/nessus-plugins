...
# extracted from openSUSE Security Update openSUSE-2015-381.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : coreutils (openSUSE-2015-381)");
  script_summary(english:"Check for the openSUSE-2015-381 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"coreutils-8.23-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"coreutils-debuginfo-8.23-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"coreutils-debugsource-8.23-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"coreutils-lang-8.23-2.9.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"coreutils-testsuite-8.23-2.9.1") ) flag++;
