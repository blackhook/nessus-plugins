...
# extracted from Red Hat Security Advisory RHSA-2018:3090 and 
# Oracle Linux Security Advisory ELSA-2018-3090 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:3090");

  script_name(english:"Oracle Linux 7 : ovmf (ELSA-2018-3090)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:3090 :
...
Enterprise Linux 7.6 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-November/008194.html"
  );
...
var flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"OVMF-20180508-3.gitee3198e672e2.el7", epoch:"0")) flag++;
