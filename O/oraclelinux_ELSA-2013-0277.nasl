...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:0277 :
...
which fix these issues and add these enhancements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-February/003276.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"dnsmasq-2.48-13.el6")) flag++;
if (rpm_check(release:"EL6", reference:"dnsmasq-utils-2.48-13.el6")) flag++;
