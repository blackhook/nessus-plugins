...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : firefox (ELSA-2010-0112)");
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-February/001359.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-February/001361.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"firefox-3.0.18-1.0.1.el4")) flag++;

if (rpm_check(release:"EL5", reference:"firefox-3.0.18-1.0.1.el5_4")) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-1.9.0.18-1.0.1.el5_4")) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-devel-1.9.0.18-1.0.1.el5_4")) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-devel-unstable-1.9.0.18-1.0.1.el5_4")) flag++;
