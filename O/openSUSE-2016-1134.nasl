...
# extracted from openSUSE Security Update openSUSE-2016-1134.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : openssl (openSUSE-2016-1134)");
  script_summary(english:"Check for the openSUSE-2016-1134 patch");
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=982745"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.1", reference:"libopenssl-devel-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libopenssl1_0_0-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libopenssl1_0_0-debuginfo-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libopenssl1_0_0-hmac-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"openssl-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"openssl-debuginfo-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"openssl-debugsource-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libopenssl-devel-32bit-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libopenssl1_0_0-32bit-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libopenssl1_0_0-debuginfo-32bit-1.0.1i-18.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libopenssl1_0_0-hmac-32bit-1.0.1i-18.1") ) flag++;
