...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2014:1172 :
...
which contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-September/004417.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-September/004418.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-September/004419.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"procmail-3.22-17.1.2.0.1")) flag++;

if (rpm_check(release:"EL6", reference:"procmail-3.22-25.1.el6_5.1")) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"procmail-3.22-34.el7_0.1")) flag++;
