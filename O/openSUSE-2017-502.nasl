...
# extracted from openSUSE Security Update openSUSE-2017-502.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gstreamer-0_10-plugins-base (openSUSE-2017-502)");
  script_summary(english:"Check for the openSUSE-2017-502 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-0_10-plugin-gnomevfs-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-0_10-plugin-gnomevfs-debuginfo-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-0_10-plugins-base-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-0_10-plugins-base-debuginfo-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-0_10-plugins-base-debugsource-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-0_10-plugins-base-devel-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-0_10-plugins-base-lang-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgstapp-0_10-0-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgstapp-0_10-0-debuginfo-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgstinterfaces-0_10-0-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgstinterfaces-0_10-0-debuginfo-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"typelib-1_0-GstApp-0_10-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"typelib-1_0-GstInterfaces-0_10-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-0_10-plugins-base-32bit-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-0_10-plugins-base-debuginfo-32bit-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgstapp-0_10-0-32bit-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgstapp-0_10-0-debuginfo-32bit-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgstinterfaces-0_10-0-32bit-0.10.36-17.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgstinterfaces-0_10-0-debuginfo-32bit-0.10.36-17.1") ) flag++;
