...
# extracted from openSUSE Security Update openSUSE-2019-1089.
#
...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2019-1089 patch");
...
Security issue fixed :
  ...
  - CVE-2018-20105: Pass SSL password to Cheetah CLI
    interface securely (bsc#1119835)
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1120672"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1123562"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE15.0", reference:"yast2-rmt-1.2.2-lp150.2.19.1") ) flag++;
