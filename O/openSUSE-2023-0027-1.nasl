...
# openSUSE Security Update openSUSE-SU-2023:0027-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : tor (openSUSE-SU-2023:0027-1)");
...
SU-2023:0027-1 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1207110");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZPODUVSWM4YV6IOZPFEOTJC3KTPJWJ3S/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e9275427");
...
var pkgs = [
    {'reference':'tor-0.4.7.13-bp154.2.12.1', 'release':'SUSE15.4', 'rpm_spec_vers_cmp':TRUE}
];
