...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1054 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-July/002916.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-July/002917.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"libtiff-3.8.2-15.el5_8")) flag++;
if (rpm_check(release:"EL5", reference:"libtiff-devel-3.8.2-15.el5_8")) flag++;

if (rpm_check(release:"EL6", reference:"libtiff-3.9.4-6.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"libtiff-devel-3.9.4-6.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"libtiff-static-3.9.4-6.el6_3")) flag++;
