...
if (description)
{
  ...
  script_name(english:"Oracle E-Business (January 2014 CPU)");
...
missing the January 2014 Critical Patch Update (CPU). It is,
...
Critical Patch Update advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-5890");
