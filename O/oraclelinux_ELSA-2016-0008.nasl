...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 / 7 : openssl (ELSA-2016-0008) (SLOTH)");
...
restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-January/005660.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2016-January/005665.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openssl-1.0.1e-42.el6_7.2")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-devel-1.0.1e-42.el6_7.2")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-perl-1.0.1e-42.el6_7.2")) flag++;
if (rpm_check(release:"EL6", reference:"openssl-static-1.0.1e-42.el6_7.2")) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openssl-1.0.1e-51.el7_2.2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openssl-devel-1.0.1e-51.el7_2.2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openssl-libs-1.0.1e-51.el7_2.2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openssl-perl-1.0.1e-51.el7_2.2")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"openssl-static-1.0.1e-51.el7_2.2")) flag++;
