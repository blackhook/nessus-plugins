...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : perl-Net-DNS (ELSA-2007-0674)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0674 :
...
contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-July/000264.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"perl-Net-DNS-0.59-3.el5")) flag++;
