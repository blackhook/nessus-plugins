...
appstreams = {
    'nginx:1.18': [
      ...
      {'reference':'nginx-all-modules-1.18.0-3.0.1.module+el8.4.0+20183+8c128c59.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'nginx-filesystem-1.18.0-3.0.1.module+el8.4.0+20183+8c128c59.1', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
