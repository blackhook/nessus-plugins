...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-1206 patch");
...
"This update for chromium fixes the following issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1174497"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1175044"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1175085"
  );
  script_set_attribute(
    attribute:"solution",
