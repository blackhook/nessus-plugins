...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:0592 :
...
Red Hat would like to thank Chris McCown for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-March/007596.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"slf4j-1.7.4-4.el7_4")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"slf4j-javadoc-1.7.4-4.el7_4")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"slf4j-manual-1.7.4-4.el7_4")) flag++;
