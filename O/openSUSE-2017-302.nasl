...
# extracted from openSUSE Security Update openSUSE-2017-302.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gstreamer (openSUSE-2017-302)");
  script_summary(english:"Check for the openSUSE-2017-302 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-debuginfo-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-debugsource-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-devel-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-lang-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-utils-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"gstreamer-utils-debuginfo-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgstreamer-1_0-0-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"libgstreamer-1_0-0-debuginfo-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"typelib-1_0-Gst-1_0-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-32bit-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"gstreamer-debuginfo-32bit-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgstreamer-1_0-0-32bit-1.4.5-5.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", cpu:"x86_64", reference:"libgstreamer-1_0-0-debuginfo-32bit-1.4.5-5.1") ) flag++;
