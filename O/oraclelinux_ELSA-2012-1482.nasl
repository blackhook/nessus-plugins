...
flag = 0;
if (rpm_check(release:"EL5", reference:"firefox-10.0.11-1.0.1.el5_8", allowmaj:TRUE)) flag++;
...
if (rpm_check(release:"EL6", reference:"firefox-10.0.11-1.0.1.el6_3", allowmaj:TRUE)) flag++;
