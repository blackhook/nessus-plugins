...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 / 4 / 5 : wireshark (ELSA-2009-1100)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:1100 :
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-June/001033.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-June/001035.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-June/001038.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"wireshark-1.0.8-0.1.EL3.1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"wireshark-1.0.8-0.1.EL3.1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"wireshark-gnome-1.0.8-0.1.EL3.1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"wireshark-gnome-1.0.8-0.1.EL3.1")) flag++;

if (rpm_check(release:"EL4", reference:"wireshark-1.0.8-1.0.1.el4_8.1")) flag++;
if (rpm_check(release:"EL4", reference:"wireshark-gnome-1.0.8-1.0.1.el4_8.1")) flag++;

if (rpm_check(release:"EL5", reference:"wireshark-1.0.8-1.0.1.el5_3.1")) flag++;
if (rpm_check(release:"EL5", reference:"wireshark-gnome-1.0.8-1.0.1.el5_3.1")) flag++;
