...
# extracted from openSUSE Security Update openSUSE-2015-700.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : wpa_supplicant (openSUSE-2015-700)");
  script_summary(english:"Check for the openSUSE-2015-700 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"wpa_supplicant-2.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"wpa_supplicant-debuginfo-2.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"wpa_supplicant-debugsource-2.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"wpa_supplicant-gui-2.2-5.10.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"wpa_supplicant-gui-debuginfo-2.2-5.10.1") ) flag++;
