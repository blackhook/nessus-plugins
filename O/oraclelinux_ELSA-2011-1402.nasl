...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 / 6 : freetype (ELSA-2011-1402)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1402 :
...
restarted (log out, then log back in) for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-October/002428.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-October/002429.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-October/002430.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"freetype-2.1.9-20.el4")) flag++;
if (rpm_check(release:"EL4", reference:"freetype-demos-2.1.9-20.el4")) flag++;
if (rpm_check(release:"EL4", reference:"freetype-devel-2.1.9-20.el4")) flag++;
if (rpm_check(release:"EL4", reference:"freetype-utils-2.1.9-20.el4")) flag++;

if (rpm_check(release:"EL5", reference:"freetype-2.2.1-28.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"freetype-demos-2.2.1-28.el5_7.1")) flag++;
if (rpm_check(release:"EL5", reference:"freetype-devel-2.2.1-28.el5_7.1")) flag++;

if (rpm_check(release:"EL6", reference:"freetype-2.3.11-6.el6_1.7")) flag++;
if (rpm_check(release:"EL6", reference:"freetype-demos-2.3.11-6.el6_1.7")) flag++;
if (rpm_check(release:"EL6", reference:"freetype-devel-2.3.11-6.el6_1.7")) flag++;
