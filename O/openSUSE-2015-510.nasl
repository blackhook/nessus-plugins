...
# extracted from openSUSE Security Update openSUSE-2015-510.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : cacti (openSUSE-2015-510)");
  script_summary(english:"Check for the openSUSE-2015-510 patch");
...
In addition, this update contains upstream bug fixes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=937997"
  );
...
if ( rpm_check(release:"SUSE13.1", reference:"cacti-0.8.8e-14.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"cacti-0.8.8e-4.10.1") ) flag++;
