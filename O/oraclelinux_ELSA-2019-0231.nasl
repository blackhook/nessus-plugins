...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:0231 :
...
This issue was discovered by Christophe Fergeau (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-January/008455.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"spice-server-0.14.0-6.el7_6.1")) flag++;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"spice-server-devel-0.14.0-6.el7_6.1")) flag++;
