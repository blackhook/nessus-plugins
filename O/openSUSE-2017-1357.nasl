...
# extracted from openSUSE Security Update openSUSE-2017-1357.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libXfont (openSUSE-2017-1357)");
  script_summary(english:"Check for the openSUSE-2017-1357 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"libXfont-debugsource-1.5.1-9.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libXfont-devel-1.5.1-9.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libXfont1-1.5.1-9.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libXfont1-debuginfo-1.5.1-9.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libXfont-devel-32bit-1.5.1-9.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libXfont1-32bit-1.5.1-9.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libXfont1-debuginfo-32bit-1.5.1-9.3.1") ) flag++;
