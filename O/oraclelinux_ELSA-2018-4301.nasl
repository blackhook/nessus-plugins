...
if (machine_uptrack_level)
{
  ...
  var fixed_uptrack_levels = ['2.6.39-400.304.1.el6uek'];
...
var pkgs = [
    ...
    {'reference':'kernel-uek-doc-2.6.39-400.304.1.el6uek', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-doc-2.6.39'},
    {'reference':'kernel-uek-firmware-2.6.39-400.304.1.el6uek', 'release':'6', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'kernel-uek-firmware-2.6.39'}
];
