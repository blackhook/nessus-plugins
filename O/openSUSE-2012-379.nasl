...
# extracted from openSUSE Security Update openSUSE-2012-379.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : opera (openSUSE-SU-2012:0865-1)");
  script_summary(english:"Check for the openSUSE-2012-379 patch");
...
"  - update to 12.00
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-07/msg00026.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.1", reference:"opera-12.00-16.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"opera-gtk-12.00-16.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"opera-kde4-12.00-16.1") ) flag++;
