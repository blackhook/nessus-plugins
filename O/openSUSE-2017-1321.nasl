...
# extracted from openSUSE Security Update openSUSE-2017-1321.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xen (openSUSE-2017-1321)");
  script_summary(english:"Check for the openSUSE-2017-1321 patch");
...
if ( rpm_check(release:"SUSE42.3", reference:"xen-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-debugsource-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-devel-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-doc-html-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-libs-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-libs-debuginfo-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-tools-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-tools-debuginfo-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-tools-domU-4.9.1_02-13.2") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"xen-tools-domU-debuginfo-4.9.1_02-13.2") ) flag++;
