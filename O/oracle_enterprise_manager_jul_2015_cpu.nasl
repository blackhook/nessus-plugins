...
if (description)
{
  ...
  script_cve_id("CVE-2015-2646", "CVE-2015-2647", "CVE-2015-4735");
  script_bugtraq_id(75828, 75834, 75836);
...
Control.");
  # https://www.oracle.com/technetwork/topics/security/cpujul2015-2367936.html#AppendixEM
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5ae9eb68");
