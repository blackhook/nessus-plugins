...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-February/003939.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openldap-2.4.23-34.el6_5.1")) flag++;
if (rpm_check(release:"EL6", reference:"openldap-clients-2.4.23-34.el6_5.1")) flag++;
if (rpm_check(release:"EL6", reference:"openldap-devel-2.4.23-34.el6_5.1")) flag++;
if (rpm_check(release:"EL6", reference:"openldap-servers-2.4.23-34.el6_5.1")) flag++;
if (rpm_check(release:"EL6", reference:"openldap-servers-sql-2.4.23-34.el6_5.1")) flag++;
