...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:1518 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-August/008980.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-11.0.3.7-2.0.1.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-demo-11.0.3.7-2.0.1.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-devel-11.0.3.7-2.0.1.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-headless-11.0.3.7-2.0.1.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-javadoc-11.0.3.7-2.0.1.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-javadoc-zip-11.0.3.7-2.0.1.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-jmods-11.0.3.7-2.0.1.el8_0")) flag++;
if (rpm_check(release:"EL8", cpu:"x86_64", reference:"java-11-openjdk-src-11.0.3.7-2.0.1.el8_0")) flag++;
