...
# extracted from openSUSE Security Update openSUSE-2014-470.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : apache2-mod_wsgi (openSUSE-2014-470)");
  script_summary(english:"Check for the openSUSE-2014-470 patch");
