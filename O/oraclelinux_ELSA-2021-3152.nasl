...
# extracted from Oracle Linux Security Advisory ELSA-2021-3152.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 8 : exiv2 (ELSA-2021-3152) (deprecated)");
  ...
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-3152.html");
