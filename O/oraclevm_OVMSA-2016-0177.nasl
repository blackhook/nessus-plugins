...
# Security Advisory OVMSA-2016-0177.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 : xen (OVMSA-2016-0177)");
...
critical security updates :
  ...
  # https://oss.oracle.com/pipermail/oraclevm-errata/2016-December/000604.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?66b29c94"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"xen-4.3.0-55.el6.119.63")) flag++;
if (rpm_check(release:"OVS3.3", reference:"xen-tools-4.3.0-55.el6.119.63")) flag++;
