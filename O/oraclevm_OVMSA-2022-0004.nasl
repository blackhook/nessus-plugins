...
# extracted from OracleVM Security Advisory OVMSA-2022-0004.
##
...
if (description)
{
  ...
  script_cve_id("CVE-2021-28705", "CVE-2021-28706", "CVE-2021-28709");

  script_name(english:"OracleVM 3.4 : xen (OVMSA-2022-0004)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/OVMSA-2022-0004.html");
...
"Update the affected xen / xen-tools packages.");
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2022/01/07");
...
var pkgs = [
    {'reference':'xen-4.4.4-155.0.105.el6', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'xen-4.4.4-155'},
    {'reference':'xen-tools-4.4.4-155.0.105.el6', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'xen-tools-4.4.4-155'}
];
