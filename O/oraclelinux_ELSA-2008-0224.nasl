...
# Oracle Linux Security Advisory ELSA-2008-0224 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : thunderbird (ELSA-2008-0224)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0224 :
...
contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-April/000584.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"thunderbird-1.5.0.12-11.el4.0.1")) flag++;
