...
# openSUSE Security Update openSUSE-SU-2021:2872-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : php7 (openSUSE-SU-2021:2872-1)");
...
openSUSE-SU-2021:2872-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?674e4fe9");
...
var pkgs = [
    {'reference':'php7-wddx-7.2.5-4.82.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
