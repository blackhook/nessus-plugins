...
# extracted from openSUSE Security Update openSUSE-2020-121.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sarg (openSUSE-2020-121)");
  script_summary(english:"Check for the openSUSE-2020-121 patch");
...
"This update for aubio fixes the following issues :
  ...
  - CVE-2019-1010224: Fixed a denial of service caused by
    NULL pointer dereference (boo#1142435)."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"solution", value:"Update the affected sarg packages.");
...
if ( rpm_check(release:"SUSE15.1", reference:"aubio-debugsource-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"aubio-tools-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"aubio-tools-debuginfo-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libaubio-devel-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libaubio5-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"libaubio5-debuginfo-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libaubio5-32bit-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"libaubio5-32bit-debuginfo-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python-aubio-debugsource-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python2-aubio-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python2-aubio-debuginfo-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-aubio-0.4.6-lp151.6.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", cpu:"x86_64", reference:"python3-aubio-debuginfo-0.4.6-lp151.6.7.1") ) flag++;
