...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:1363 :
...
(named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-October/003076.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-October/003079.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"bind-9.3.6-20.P1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"bind-chroot-9.3.6-20.P1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"bind-devel-9.3.6-20.P1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"bind-libbind-devel-9.3.6-20.P1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"bind-libs-9.3.6-20.P1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"bind-sdb-9.3.6-20.P1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"bind-utils-9.3.6-20.P1.el5_8.5")) flag++;
if (rpm_check(release:"EL5", reference:"caching-nameserver-9.3.6-20.P1.el5_8.5")) flag++;

if (rpm_check(release:"EL6", reference:"bind-9.8.2-0.10.rc1.el6_3.5")) flag++;
if (rpm_check(release:"EL6", reference:"bind-chroot-9.8.2-0.10.rc1.el6_3.5")) flag++;
if (rpm_check(release:"EL6", reference:"bind-devel-9.8.2-0.10.rc1.el6_3.5")) flag++;
if (rpm_check(release:"EL6", reference:"bind-libs-9.8.2-0.10.rc1.el6_3.5")) flag++;
if (rpm_check(release:"EL6", reference:"bind-sdb-9.8.2-0.10.rc1.el6_3.5")) flag++;
if (rpm_check(release:"EL6", reference:"bind-utils-9.8.2-0.10.rc1.el6_3.5")) flag++;
