...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2014:0369 :
...
automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-April/004063.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"httpd-2.2.3-85.0.1.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"httpd-devel-2.2.3-85.0.1.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"httpd-manual-2.2.3-85.0.1.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"mod_ssl-2.2.3-85.0.1.el5_10")) flag++;
