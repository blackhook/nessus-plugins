...
# Oracle Linux Security Advisory ELSA-2013-1861 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 / 6 : nss (ELSA-2013-1861)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:1861 :
...
be restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-December/003893.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-December/003895.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"nss-3.15.3-4.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"nss-devel-3.15.3-4.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"nss-pkcs11-devel-3.15.3-4.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"nss-tools-3.15.3-4.el5_10")) flag++;

if (rpm_check(release:"EL6", reference:"nss-3.15.3-3.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"nss-devel-3.15.3-3.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"nss-pkcs11-devel-3.15.3-3.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"nss-sysinit-3.15.3-3.0.1.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"nss-tools-3.15.3-3.0.1.el6_5")) flag++;
