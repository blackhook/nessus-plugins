...
# Oracle Linux Security Advisory ELSA-2007-0968 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : pcre (ELSA-2007-0968)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:0968 :
...
disclosing these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-November/000381.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"pcre-4.5-4.el4_5.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"pcre-4.5-4.el4_5.1")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"pcre-devel-4.5-4.el4_5.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"pcre-devel-4.5-4.el4_5.1")) flag++;
