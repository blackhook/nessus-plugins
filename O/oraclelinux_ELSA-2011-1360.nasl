...
# Oracle Linux Security Advisory ELSA-2011-1360 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : xorg-x11 (ELSA-2011-1360)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1360 :
...
server instances must be restarted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-October/002391.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"xorg-x11-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-Mesa-libGL-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-Mesa-libGLU-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-Xdmx-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-Xnest-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-Xvfb-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-deprecated-libs-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-deprecated-libs-devel-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-devel-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-doc-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-font-utils-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-libs-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-sdk-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-tools-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-twm-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-xauth-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-xdm-6.8.2-1.0.1.EL.70")) flag++;
if (rpm_check(release:"EL4", reference:"xorg-x11-xfs-6.8.2-1.0.1.EL.70")) flag++;
