...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1293 :
...
update, the squid service will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002356.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"squid-3.1.10-1.el6_1.1")) flag++;
