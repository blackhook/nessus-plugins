...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1247 :
...
this update, the rsyslog daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-September/002334.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"rsyslog-4.6.2-3.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-gnutls-4.6.2-3.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-gssapi-4.6.2-3.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-mysql-4.6.2-3.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-pgsql-4.6.2-3.el6_1.2")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-relp-4.6.2-3.el6_1.2")) flag++;
