...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:1225 :
...
and Kevin Backhouse (lgtm.com / Semmle) as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-April/007645.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"librelp-1.2.7-3.el6_9.1")) flag++;
if (rpm_check(release:"EL6", reference:"librelp-devel-1.2.7-3.el6_9.1")) flag++;
