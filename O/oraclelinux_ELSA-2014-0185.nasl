...
which contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-February/003981.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2014-February/003982.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"openswan-2.6.32-7.3.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"openswan-doc-2.6.32-7.3.el5_10")) flag++;

if (rpm_check(release:"EL6", reference:"openswan-2.6.32-27.2.el6_5")) flag++;
if (rpm_check(release:"EL6", reference:"openswan-doc-2.6.32-27.2.el6_5")) flag++;
