...
# extracted from openSUSE Security Update openSUSE-2019-2527.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ucode-intel (openSUSE-2019-2527)");
  script_summary(english:"Check for the openSUSE-2019-2527 patch");
...
"This update for ucode-intel fixes the following issues :
  ...
  - Updated to 20191112 official security release
    (bsc#1155988)
...
if ( rpm_check(release:"SUSE15.0", reference:"ucode-intel-20191112a-lp150.2.33.1") ) flag++;
