...
"From Red Hat Security Advisory 2020:1331 :
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-April/009770.html");
...
flag = 0;
if (rpm_check(release:"EL6", reference:"ipmitool-1.8.15-3.el6_10")) flag++;
