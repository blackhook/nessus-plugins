...
if (description)
{
  ...
  script_name(english:"Opera < 19 Multiple Vulnerabilities");
...
to version 19. It is, therefore, reportedly affected by multiple
unspecified vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20170922204441/http://www.opera.com:80/docs/changelogs/unified/1900/");
  script_set_attribute(attribute:"solution", value:"Upgrade to Opera 19 or later.");
