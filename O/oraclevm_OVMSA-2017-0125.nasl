...
# Security Advisory OVMSA-2017-0125.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.2 : sudo (OVMSA-2017-0125)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2017-July/000754.html"
  );
...
flag = 0;
if (rpm_check(release:"OVS3.2", reference:"sudo-1.7.2p1-29.0.2.el5_10")) flag++;
