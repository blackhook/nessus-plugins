...
flag = 0;
if (rpm_exists(rpm:"xen-4.4.4-75", release:"OVS3.4") && rpm_check(release:"OVS3.4", reference:"xen-4.4.4-75.0.1.el6")) flag++;
if (rpm_exists(rpm:"xen-tools-4.4.4-75", release:"OVS3.4") && rpm_check(release:"OVS3.4", reference:"xen-tools-4.4.4-75.0.1.el6")) flag++;
