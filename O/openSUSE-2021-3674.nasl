...
# openSUSE Security Update openSUSE-SU-2021:3674-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : samba (openSUSE-SU-2021:3674-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by multiple vulnerabilities as referenced in
the openSUSE-SU-2021:3674-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZYEHJEQQ7LEL2T775B7QLR3IFR6LJGLZ/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1764e46f");
...
var pkgs = [
    {'reference':'libsamba-policy-python-devel-4.9.5+git.471.5edbe3dcae7-3.57.2', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsamba-policy0-32bit-4.9.5+git.471.5edbe3dcae7-3.57.2', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libsamba-policy0-4.9.5+git.471.5edbe3dcae7-3.57.2', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'samba-libs-python-32bit-4.9.5+git.471.5edbe3dcae7-3.57.2', 'cpu':'x86_64', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'samba-libs-python-4.9.5+git.471.5edbe3dcae7-3.57.2', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'samba-python-4.9.5+git.471.5edbe3dcae7-3.57.2', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libsamba-policy-python-devel / libsamba-policy0 / etc');
}
