...
# extracted from openSUSE Security Update openSUSE-2021-190.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.14 (openSUSE-2021-190)");
...
if ( rpm_check(release:"SUSE15.1", reference:"go1.14-1.14.14-lp151.28.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"go1.14-race-1.14.14-lp151.28.1") ) flag++;
