...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0199 :
...
updated packages, the krb5kdc daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-February/001816.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", reference:"krb5-devel-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-libs-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-server-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-server-ldap-1.6.1-55.el5_6.1")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-workstation-1.6.1-55.el5_6.1")) flag++;
