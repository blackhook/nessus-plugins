...
# extracted from openSUSE Security Update openSUSE-2016-732.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : monit (openSUSE-2016-732)");
  script_summary(english:"Check for the openSUSE-2016-732 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"monit-5.10-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"monit-debuginfo-5.10-10.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"monit-debugsource-5.10-10.1") ) flag++;
