...
# extracted from openSUSE Security Update openSUSE-2016-299.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pigz (openSUSE-2016-299)");
  script_summary(english:"Check for the openSUSE-2016-299 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"pigz-2.3-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"pigz-debuginfo-2.3-4.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"pigz-debugsource-2.3-4.3.1") ) flag++;
