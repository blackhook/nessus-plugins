...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:3193 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-October/009301.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"firefox-68.2.0-1.0.1.el7_7", allowmaj:TRUE)) flag++;
