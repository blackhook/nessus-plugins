...
# Oracle Linux Security Advisory ELSA-2011-0887 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : thunderbird (ELSA-2011-0887)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0887 :
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-June/002195.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"thunderbird-1.5.0.12-39.0.1.el4")) flag++;
