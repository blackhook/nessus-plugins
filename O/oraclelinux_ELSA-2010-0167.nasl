...
# Oracle Linux Security Advisory ELSA-2010-0167 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : gnutls (ELSA-2010-0167)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0167 :
...
must be restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-March/001410.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"gnutls-1.0.20-4.0.1.el4_8.7")) flag++;
if (rpm_check(release:"EL4", reference:"gnutls-devel-1.0.20-4.0.1.el4_8.7")) flag++;
