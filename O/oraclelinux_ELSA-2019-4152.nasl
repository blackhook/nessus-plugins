...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2019:4152 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2019-December/009443.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"nss-softokn-3.44.0-6.0.1.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"nss-softokn-devel-3.44.0-6.0.1.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"nss-softokn-freebl-3.44.0-6.0.1.el6_10")) flag++;
if (rpm_check(release:"EL6", reference:"nss-softokn-freebl-devel-3.44.0-6.0.1.el6_10")) flag++;
