...
if (description)
{
  ...
  script_name(english:"OpenJDK 8 <= 8u362 / 11.0.0 <= 11.0.18 / 17.0.0 <= 17.0.6 / 20.0.0 <= 20.0.0 Multiple Vulnerabilities (2023-04-18");

  script_set_attribute(attribute:"synopsis", value:
"OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of OpenJDK installed on the remote host is prior to 8 <= 8u362 / 11.0.0 <= 11.0.18 / 17.0.0 <= 17.0.6 /
20.0.0 <= 20.0.0. It is, therefore, affected by multiple vulnerabilities as referenced in the 2023-04-18 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://openjdk.java.net/groups/vulnerability/advisories/2023-04-18");
...
var constraints = [
  { 'min_version' : '8.0.0', 'max_version' : '8.0.362', 'fixed_display' : 'Upgrade to a version greater than 8u362' },
  { 'min_version' : '11.0.0', 'max_version' : '11.0.18', 'fixed_display' : 'Upgrade to a version greater than 11.0.18' },
  { 'min_version' : '17.0.0', 'max_version' : '17.0.6', 'fixed_display' : 'Upgrade to a version greater than 17.0.6' },
  { 'min_version' : '20.0.0', 'max_version' : '20.0.0', 'fixed_display' : 'Upgrade to a version greater than 20.0.0' }
];
