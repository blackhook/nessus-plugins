...
# openSUSE Security Update openSUSE-SU-2021:1815-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : nginx (openSUSE-SU-2021:1815-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:1815-1 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1186126");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/HKTQ3CIPQ5OLG2MFTQXWBRDD66NWPZBF/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1905dd30");
...
pkgs = [
    {'reference':'nginx-1.19.8-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'nginx-source-1.19.8-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'vim-plugin-nginx-1.19.8-3.3.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
