...
# extracted from openSUSE Security Update openSUSE-2012-870.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : xen (openSUSE-SU-2012:1685-1)");
  script_summary(english:"Check for the openSUSE-2012-870 patch");
...
"This update of XEN fixes various denial of service bugs.
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-12/msg00046.html"
  );
...
if ( rpm_check(release:"SUSE12.2", reference:"xen-debugsource-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-devel-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-kmp-default-4.1.3_06_k3.4.11_2.16-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-kmp-default-debuginfo-4.1.3_06_k3.4.11_2.16-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-kmp-desktop-4.1.3_06_k3.4.11_2.16-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-kmp-desktop-debuginfo-4.1.3_06_k3.4.11_2.16-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-kmp-pae-4.1.3_06_k3.4.11_2.16-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-kmp-pae-debuginfo-4.1.3_06_k3.4.11_2.16-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-libs-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-libs-debuginfo-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-tools-domU-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"xen-tools-domU-debuginfo-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"xen-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"xen-doc-html-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"xen-doc-pdf-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"xen-libs-32bit-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"xen-libs-debuginfo-32bit-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"xen-tools-4.1.3_06-5.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", cpu:"x86_64", reference:"xen-tools-debuginfo-4.1.3_06-5.17.1") ) flag++;
