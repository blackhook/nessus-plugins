...
# extracted from openSUSE Security Update openSUSE-2021-162.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : mutt (openSUSE-2021-162)");
  script_summary(english:"Check for the openSUSE-2021-162 patch");
...
"This update for mutt fixes the following issue :
  ...
  - CVE-2021-3181: Fixed a memory leak in recipient parsing
    (bsc#1181221).
...
This update was imported from the SUSE:SLE-15:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1181221"
  );
...
if ( rpm_check(release:"SUSE15.2", reference:"mutt-1.10.1-lp152.3.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mutt-debuginfo-1.10.1-lp152.3.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mutt-debugsource-1.10.1-lp152.3.15.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mutt-lang-1.10.1-lp152.3.15.1") ) flag++;
