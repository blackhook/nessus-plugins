...
# extracted from openSUSE Security Update openSUSE-2013-693.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2013-3704");

  script_name(english:"openSUSE Security Update : libzypp (openSUSE-SU-2013:1433-1)");
  script_summary(english:"Check for the openSUSE-2013-693 patch");
...
sign the repository (CVE-2013-3704)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.novell.com/show_bug.cgi?id=828672"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-09/msg00023.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.2", reference:"libzypp-11.13.0-2.29.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libzypp-debuginfo-11.13.0-2.29.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libzypp-debugsource-11.13.0-2.29.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"libzypp-devel-11.13.0-2.29.1") ) flag++;
