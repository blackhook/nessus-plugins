...
if (description)
{
  ...
  script_name(english:"OpenSSL 1.0.2 < 1.0.2u Procedure Overflow Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"The remote service is affected by a procedure overflow vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of OpenSSL installed on the remote host is prior to 1.0.2u. It is, therefore, affected by a
vulnerability as referenced in the 1.0.2u advisory.
...
openssl_check_version(fixed:"1.0.2u-dev", min:"1.0.2", severity:SECURITY_WARNING);
