...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0818 :
...
backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-August/000707.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"hpijs-1.6.7-4.1.el5_2.4")) flag++;
if (rpm_check(release:"EL5", reference:"hplip-1.6.7-4.1.el5_2.4")) flag++;
if (rpm_check(release:"EL5", reference:"libsane-hpaio-1.6.7-4.1.el5_2.4")) flag++;
