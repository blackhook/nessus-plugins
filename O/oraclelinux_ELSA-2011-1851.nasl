...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 / 5 : krb5 (ELSA-2011-1851)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:1851 :
...
which contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-December/002536.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-December/002537.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", reference:"krb5-devel-1.3.4-65.el4")) flag++;
if (rpm_check(release:"EL4", reference:"krb5-libs-1.3.4-65.el4")) flag++;
if (rpm_check(release:"EL4", reference:"krb5-server-1.3.4-65.el4")) flag++;
if (rpm_check(release:"EL4", reference:"krb5-workstation-1.3.4-65.el4")) flag++;

if (rpm_check(release:"EL5", reference:"krb5-devel-1.6.1-63.el5_7")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-libs-1.6.1-63.el5_7")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-server-1.6.1-63.el5_7")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-server-ldap-1.6.1-63.el5_7")) flag++;
if (rpm_check(release:"EL5", reference:"krb5-workstation-1.6.1-63.el5_7")) flag++;
