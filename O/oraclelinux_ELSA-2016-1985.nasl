...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-45.4.0-1.0.1.el6_8", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"thunderbird-45.4.0-1.0.1.el7_2", allowmaj:TRUE)) flag++;
