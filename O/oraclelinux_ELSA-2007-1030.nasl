...
# Oracle Linux Security Advisory ELSA-2007-1030 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : xpdf (ELSA-2007-1030)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:1030 :
...
backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-November/000389.html"
  );
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"xpdf-2.02-11.el3")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"xpdf-2.02-11.el3")) flag++;
