...
flag = 0;
if (rpm_check(release:"EL6", reference:"thunderbird-38.4.0-1.0.1.el6_7", allowmaj:TRUE)) flag++;

if (rpm_check(release:"EL7", cpu:"x86_64", reference:"thunderbird-38.4.0-1.0.1.el7_2", allowmaj:TRUE)) flag++;
