...
if (description)
{
  ...
  script_name(english:"Oracle Linux 5 : poppler (ELSA-2007-1026)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:1026 :
...
backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-November/000413.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL5", reference:"poppler-0.5.4-4.3.el5_1")) flag++;
if (rpm_check(release:"EL5", reference:"poppler-devel-0.5.4-4.3.el5_1")) flag++;
if (rpm_check(release:"EL5", reference:"poppler-utils-0.5.4-4.3.el5_1")) flag++;
