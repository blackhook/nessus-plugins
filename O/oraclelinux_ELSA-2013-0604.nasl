...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:0604 :
...
OpenJDK Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-March/003337.html"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:oracle:linux:jva-1.6.0-openjdk-1.6.0.0ava-1.6.0-openjdk-demo");
...
flag = 0;
if (rpm_check(release:"EL5", reference:"java-1.6.0-openjdk-1.6.0.0-1.36.1.11.9.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"java-1.6.0-openjdk-demo-1.6.0.0-1.36.1.11.9.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"java-1.6.0-openjdk-devel-1.6.0.0-1.36.1.11.9.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"java-1.6.0-openjdk-javadoc-1.6.0.0-1.36.1.11.9.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", reference:"java-1.6.0-openjdk-src-1.6.0.0-1.36.1.11.9.0.1.el5_9")) flag++;
if (rpm_check(release:"EL5", cpu:"i386", reference:"jva-1.6.0-openjdk-1.6.0.0ava-1.6.0-openjdk-demo-1.6.0.0-1.36.1.11.9.0.1.el5_9")) flag++;
