...
# extracted from openSUSE Security Update openSUSE-2017-823.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ncurses (openSUSE-2017-823)");
  script_summary(english:"Check for the openSUSE-2017-823 patch");
...
This update was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1000662"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE42.2", reference:"libncurses5-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libncurses5-debuginfo-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libncurses6-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libncurses6-debuginfo-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"ncurses-debugsource-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"ncurses-devel-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"ncurses-devel-debuginfo-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"ncurses-utils-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"ncurses-utils-debuginfo-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"tack-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"tack-debuginfo-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"terminfo-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"terminfo-base-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libncurses5-32bit-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libncurses5-debuginfo-32bit-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libncurses6-32bit-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"libncurses6-debuginfo-32bit-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"ncurses-devel-32bit-5.9-55.3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", cpu:"x86_64", reference:"ncurses-devel-debuginfo-32bit-5.9-55.3.1") ) flag++;
