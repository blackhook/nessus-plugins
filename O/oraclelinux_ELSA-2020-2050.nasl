...
"From Red Hat Security Advisory 2020:2050 :
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://oss.oracle.com/pipermail/el-errata/2020-May/009909.html");
...
flag = 0;
if (rpm_check(release:"EL7", cpu:"x86_64", reference:"thunderbird-68.8.0-1.0.1.el7_8", allowmaj:TRUE)) flag++;
