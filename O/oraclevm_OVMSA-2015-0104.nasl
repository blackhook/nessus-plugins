...
# Security Advisory OVMSA-2015-0104.
#
...
if (description)
{
  ...
  script_bugtraq_id(72643, 72842, 74243);

  script_name(english:"OracleVM 3.3 : kernel-uek (OVMSA-2015-0104)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2015-July/000348.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"kernel-uek-3.8.13-68.3.5.el6uek")) flag++;
if (rpm_check(release:"OVS3.3", reference:"kernel-uek-firmware-3.8.13-68.3.5.el6uek")) flag++;
