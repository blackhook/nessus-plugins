...
# extracted from openSUSE Security Update openSUSE-2016-333.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libotr / libotr2 (openSUSE-2016-333)");
  script_summary(english:"Check for the openSUSE-2016-333 patch");
...
if ( rpm_check(release:"SUSE13.1", reference:"libotr-debugsource-4.0.0-5.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr-devel-4.0.0-5.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr-tools-4.0.0-5.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr-tools-debuginfo-4.0.0-5.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr2-3.2.1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr2-debuginfo-3.2.1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr2-debugsource-3.2.1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr2-devel-3.2.1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr2-tools-3.2.1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr2-tools-debuginfo-3.2.1-5.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr5-4.0.0-5.7.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"libotr5-debuginfo-4.0.0-5.7.1") ) flag++;
