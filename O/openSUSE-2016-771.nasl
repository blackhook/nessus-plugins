...
# extracted from openSUSE Security Update openSUSE-2016-771.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : p7zip (openSUSE-2016-771)");
  script_summary(english:"Check for the openSUSE-2016-771 patch");
...
if ( rpm_check(release:"SUSE42.1", reference:"p7zip-9.20.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"p7zip-debuginfo-9.20.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"p7zip-debugsource-9.20.1-15.1") ) flag++;
