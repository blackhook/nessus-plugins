...
# Oracle Linux Security Advisory ELSA-2009-0362 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : NetworkManager (ELSA-2009-0362)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:0362 :
...
contain a backported patch that corrects this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-March/000933.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"NetworkManager-0.3.1-5.el4")) flag++;
if (rpm_check(release:"EL4", reference:"NetworkManager-gnome-0.3.1-5.el4")) flag++;
