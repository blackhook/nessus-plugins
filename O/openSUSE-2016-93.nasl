...
# extracted from openSUSE Security Update openSUSE-2016-93.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : ecryptfs-utils (openSUSE-2016-93)");
  script_summary(english:"Check for the openSUSE-2016-93 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"ecryptfs-utils-104-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"ecryptfs-utils-debuginfo-104-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"ecryptfs-utils-debugsource-104-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"ecryptfs-utils-32bit-104-3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", cpu:"x86_64", reference:"ecryptfs-utils-debuginfo-32bit-104-3.1") ) flag++;
