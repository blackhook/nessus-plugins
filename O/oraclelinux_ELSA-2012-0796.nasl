...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2012:0796 :
...
daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-July/002901.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"rsyslog-5.8.10-2.el6")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-gnutls-5.8.10-2.el6")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-gssapi-5.8.10-2.el6")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-mysql-5.8.10-2.el6")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-pgsql-5.8.10-2.el6")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-relp-5.8.10-2.el6")) flag++;
if (rpm_check(release:"EL6", reference:"rsyslog-snmp-5.8.10-2.el6")) flag++;
