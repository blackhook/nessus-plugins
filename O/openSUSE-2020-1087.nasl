...
# extracted from openSUSE Security Update openSUSE-2020-1087.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : go1.13 (openSUSE-2020-1087)");
  script_summary(english:"Check for the openSUSE-2020-1087 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"go1.13-1.13.14-lp151.5.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"go1.13-race-1.13.14-lp151.5.1") ) flag++;
