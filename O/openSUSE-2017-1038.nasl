...
# extracted from openSUSE Security Update openSUSE-2017-1038.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : clamav-database (openSUSE-2017-1038)");
  script_summary(english:"Check for the openSUSE-2017-1038 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"clamav-database-201709110007-54.79.1") ) flag++;
