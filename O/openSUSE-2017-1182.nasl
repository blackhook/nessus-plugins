...
# extracted from openSUSE Security Update openSUSE-2017-1182.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : salt (openSUSE-2017-1182)");
  script_summary(english:"Check for the openSUSE-2017-1182 patch");
...
if ( rpm_check(release:"SUSE42.3", reference:"salt-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-api-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-bash-completion-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-cloud-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-fish-completion-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-master-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-minion-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-proxy-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-ssh-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-syndic-2017.7.2-14.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"salt-zsh-completion-2017.7.2-14.1") ) flag++;
