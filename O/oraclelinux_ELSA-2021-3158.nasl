...
# extracted from Oracle Linux Security Advisory ELSA-2021-3158.
##
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 7 : exiv2 (ELSA-2021-3158) (deprecated)");
  ...
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/ELSA-2021-3158.html");
