...
vulnerabilities as referenced in the 1.0.2zg advisory.
  ...
  - There is a type confusion vulnerability relating to X.400 address processing inside an X.509 GeneralName.
    ...
    developed by Hugo Landau. Fixed in OpenSSL 1.0.2zg (Affected since 1.0.2). (CVE-2023-0286)
  ...
  - The public API function BIO_new_NDEF is a helper function used for streaming ASN.1 data via a BIO. It is
    ...
    Privacy). Fix developed by Viktor Dukhovni. Fix developed by Matt Caswell. Fixed in OpenSSL 1.0.2zg
    (Affected since 1.0.2). (CVE-2023-0215)
...
var constraints = [{ 'min_version' : '1.0.2', 'fixed_version' : '1.0.2zg'}];
