...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-500 patch");
...
"This update for nagios to version 4.4.5 fixes the following issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1028975"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1119832"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1156309"
  );
  script_set_attribute(
    attribute:"solution", 
