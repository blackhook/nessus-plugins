...
# extracted from openSUSE Security Update openSUSE-2020-1986.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : tcpdump (openSUSE-2020-1986)");
  script_summary(english:"Check for the openSUSE-2020-1986 patch");
...
"This update for tcpdump fixes the following issues :
  ...
  - CVE-2020-8037: Fixed an issue where PPP decapsulator did
    not allocate the right buffer size (bsc#1178466).

This update was imported from the SUSE:SLE-15:Update update project."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1178466"
  );
  script_set_attribute(
    attribute:"solution",
...
if ( rpm_check(release:"SUSE15.2", reference:"tcpdump-4.9.2-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tcpdump-debuginfo-4.9.2-lp152.7.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"tcpdump-debugsource-4.9.2-lp152.7.3.1") ) flag++;
