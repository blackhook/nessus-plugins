...
# extracted from openSUSE Security Update openSUSE-2017-228.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : spice (openSUSE-2017-228)");
  script_summary(english:"Check for the openSUSE-2017-228 patch");
...
if ( rpm_check(release:"SUSE42.2", reference:"libspice-server-devel-0.12.7-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libspice-server1-0.12.7-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"libspice-server1-debuginfo-0.12.7-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"spice-client-0.12.7-3.1") ) flag++;
if ( rpm_check(release:"SUSE42.2", reference:"spice-debugsource-0.12.7-3.1") ) flag++;
