...
# openSUSE Security Update openSUSE-SU-2021:0931-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : roundcubemail (openSUSE-SU-2021:0931-1)");
...
the openSUSE-SU-2021:0931-1 advisory.

  - Cross Site Scripting (XSS) vulneraibility in Roundcube mail .4.4 via database host and user in
    /installer/test.php. (CVE-2020-18670)
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1187706");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.suse.com/1187707");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/BPPHYZD6Y3QJBTGPLX66Y3DJ3KCNEUJQ/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2466e352");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-18670");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2020-18671");
...
pkgs = [
    {'reference':'roundcubemail-1.3.16-lp152.4.6.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
