...
# extracted from openSUSE Security Update openSUSE-2016-1441.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : perl-DBD-mysql (openSUSE-2016-1441)");
  script_summary(english:"Check for the openSUSE-2016-1441 patch");
...
"This update for perl-DBD-mysql fixes the following issues :
  ...
  - perl-DBD-mysql could crash when executing maliciously
    crafted prepared statements. (CVE-2016-1251,
    boo#1012546)"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.2", reference:"perl-DBD-mysql-4.021-8.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"perl-DBD-mysql-debuginfo-4.021-8.3.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"perl-DBD-mysql-debugsource-4.021-8.3.1") ) flag++;
