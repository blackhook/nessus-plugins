...
# extracted from openSUSE Security Update openSUSE-2016-845.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : shotwell (openSUSE-2016-845)");
  script_summary(english:"Check for the openSUSE-2016-845 patch");
