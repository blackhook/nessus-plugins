...
if (description)
{
  ...
  script_bugtraq_id(57385, 57388, 57391, 57405, 57410, 57412, 57414, 57416, 57417);
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:0219 :
...
daemon (mysqld) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-February/003236.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"mysql-5.1.67-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"mysql-bench-5.1.67-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"mysql-devel-5.1.67-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"mysql-embedded-5.1.67-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"mysql-embedded-devel-5.1.67-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"mysql-libs-5.1.67-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"mysql-server-5.1.67-1.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"mysql-test-5.1.67-1.el6_3")) flag++;
