...
# extracted from openSUSE Security Update openSUSE-2020-1780.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : MozillaThunderbird and mozilla-nspr (openSUSE-2020-1780)");
  script_summary(english:"Check for the openSUSE-2020-1780 patch");
...
if ( rpm_check(release:"SUSE15.2", reference:"mozilla-nspr-4.25.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mozilla-nspr-debuginfo-4.25.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mozilla-nspr-debugsource-4.25.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", reference:"mozilla-nspr-devel-4.25.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"MozillaThunderbird-78.4.0-lp152.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"MozillaThunderbird-debuginfo-78.4.0-lp152.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"MozillaThunderbird-debugsource-78.4.0-lp152.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"MozillaThunderbird-translations-common-78.4.0-lp152.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"MozillaThunderbird-translations-other-78.4.0-lp152.2.13.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"mozilla-nspr-32bit-4.25.1-lp152.2.3.1") ) flag++;
if ( rpm_check(release:"SUSE15.2", cpu:"x86_64", reference:"mozilla-nspr-32bit-debuginfo-4.25.1-lp152.2.3.1") ) flag++;
