...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0998 :
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-December/001778.html"
  );
...
flag = 0;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kmod-kvm-83-164.0.1.el5_5.30")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kvm-83-164.0.1.el5_5.30")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kvm-qemu-img-83-164.0.1.el5_5.30")) flag++;
if (rpm_check(release:"EL5", cpu:"x86_64", reference:"kvm-tools-83-164.0.1.el5_5.30")) flag++;
