...
# extracted from openSUSE Security Update openSUSE-2021-169.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : sudo (openSUSE-2021-169)");
...
if ( rpm_check(release:"SUSE15.1", reference:"sudo-1.8.22-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sudo-debuginfo-1.8.22-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sudo-debugsource-1.8.22-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sudo-devel-1.8.22-lp151.5.12.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"sudo-test-1.8.22-lp151.5.12.1") ) flag++;
