...
# Oracle Linux Security Advisory ELSA-2007-1024 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : kdegraphics (ELSA-2007-1024)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:1024 :
...
packages, which contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-November/000394.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"kdegraphics-3.3.1-6.el4_5")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"kdegraphics-3.3.1-6.el4_5")) flag++;
if (rpm_check(release:"EL4", cpu:"i386", reference:"kdegraphics-devel-3.3.1-6.el4_5")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"kdegraphics-devel-3.3.1-6.el4_5")) flag++;
