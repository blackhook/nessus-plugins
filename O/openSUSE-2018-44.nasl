...
This security issue was fixed :
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected python-openpyxl package."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:N/A:P");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:N/UI:R/S:C/C:H/I:N/A:H");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:python-openpyxl");
...
if ( rpm_check(release:"SUSE42.2", reference:"python-openpyxl-2.2.2-4.5.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"python-openpyxl-2.2.2-7.1") ) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python-openpyxl");
}
