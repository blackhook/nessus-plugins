...
# extracted from openSUSE Security Update openSUSE-2018-162.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : libreoffice (openSUSE-2018-162)");
  script_summary(english:"Check for the openSUSE-2018-162 patch");
...
LibreOffice was updated to 5.4.5.1 :
  ...
  - CVE-2018-6871: Fixes data exposure when using WEBSERVICE
    (bsc#1080249)
...
project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1080249"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-base-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-base-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-base-drivers-mysql-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-base-drivers-mysql-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-base-drivers-postgresql-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-base-drivers-postgresql-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-branding-upstream-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-calc-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-calc-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-calc-extensions-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-debugsource-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-draw-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-draw-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-filters-optional-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-gdb-pretty-printers-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-glade-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-gnome-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-gnome-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-gtk3-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-gtk3-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-icon-theme-breeze-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-icon-theme-galaxy-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-icon-theme-hicontrast-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-icon-theme-sifr-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-icon-theme-tango-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-impress-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-impress-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-kde4-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-kde4-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-af-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ar-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-as-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-bg-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-bn-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-br-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ca-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-cs-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-cy-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-da-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-de-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-dz-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-el-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-en-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-eo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-es-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-et-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-eu-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-fa-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-fi-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-fr-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ga-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-gl-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-gu-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-he-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-hi-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-hr-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-hu-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-it-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ja-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-kk-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-kn-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ko-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-lt-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-lv-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-mai-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ml-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-mr-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-nb-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-nl-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-nn-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-nr-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-nso-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-or-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-pa-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-pl-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-pt_BR-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-pt_PT-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ro-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ru-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-si-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-sk-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-sl-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-sr-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ss-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-st-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-sv-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ta-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-te-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-th-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-tn-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-tr-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ts-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-uk-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-ve-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-xh-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-zh_CN-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-zh_TW-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-l10n-zu-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-mailmerge-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-math-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-math-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-officebean-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-officebean-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-pyuno-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-pyuno-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-sdk-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-sdk-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-writer-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-writer-debuginfo-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreoffice-writer-extensions-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreofficekit-5.4.5.1-15.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"libreofficekit-devel-5.4.5.1-15.1") ) flag++;
