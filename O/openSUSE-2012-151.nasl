...
# extracted from openSUSE Security Update openSUSE-2012-151.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : flash-player (openSUSE-SU-2012:0349-1)");
  script_summary(english:"Check for the openSUSE-2012-151 patch");
...
"flash-player 11.1.102.63 fixes two security issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2012-03/msg00014.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.1", reference:"flash-player-11.1.102.63-9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"flash-player-gnome-11.1.102.63-9.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"flash-player-kde4-11.1.102.63-9.1") ) flag++;
