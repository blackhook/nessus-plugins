...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2020:0197 :
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2020-January/009535.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"python-reportlab-2.3-3.el6_10.1")) flag++;
if (rpm_check(release:"EL6", reference:"python-reportlab-docs-2.3-3.el6_10.1")) flag++;
