...
# openSUSE Security Update openSUSE-SU-2021:1102-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : linuxptp (openSUSE-SU-2021:1102-1)");
...
openSUSE-SU-2021:1102-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?348ee3fc");
...
"Update the affected linuxptp package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:linuxptp");
...
var pkgs = [
    {'reference':'linuxptp-1.8+git65.g303b08c-lp152.4.3.1', 'cpu':'x86_64', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
