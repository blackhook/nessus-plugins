...
# extracted from openSUSE Security Update openSUSE-2013-1003.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rubygem-activesupport-3_2 (openSUSE-SU-2013:1931-1)");
  script_summary(english:"Check for the openSUSE-2013-1003 patch");
...
rubygem-activesupport-3_2 :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-12/msg00094.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.2", reference:"rubygem-activesupport-3_2-3.2.12-2.17.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"rubygem-activesupport-3_2-3.2.12-1.4.1") ) flag++;
if ( rpm_check(release:"SUSE13.1", reference:"rubygem-activesupport-3_2-3.2.13-3.4.1") ) flag++;
