...
attacks because it does not properly verify server certificates.");
  script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20170708033606/http://www.opera.com/docs/changelogs/windows/1217/");
  script_set_attribute(attribute:"see_also", value:"https://blogs.opera.com/security/2014/04/heartbleed-heartaches/");
