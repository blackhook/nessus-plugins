...
# openSUSE Security Update openSUSE-SU-2022:0064-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : python39-pip (openSUSE-SU-2022:0064-1)");
...
openSUSE-SU-2022:0064-1 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?86bea6f6");
...
"Update the affected python39-pip package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:python39-pip");
...
var pkgs = [
    {'reference':'python39-pip-20.2.4-7.8.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
