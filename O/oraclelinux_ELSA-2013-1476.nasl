...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2013:1476 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-October/003774.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2013-October/003776.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL5", reference:"firefox-17.0.10-1.0.1.el5_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-17.0.10-1.0.1.el5_10")) flag++;
if (rpm_check(release:"EL5", reference:"xulrunner-devel-17.0.10-1.0.1.el5_10")) flag++;

if (rpm_check(release:"EL6", reference:"firefox-17.0.10-1.0.1.el6_4", allowmaj:TRUE)) flag++;
if (rpm_check(release:"EL6", reference:"xulrunner-17.0.10-1.0.1.el6_4")) flag++;
if (rpm_check(release:"EL6", reference:"xulrunner-devel-17.0.10-1.0.1.el6_4")) flag++;
