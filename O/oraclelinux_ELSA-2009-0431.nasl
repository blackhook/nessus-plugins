...
# Oracle Linux Security Advisory ELSA-2009-0431 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : kdegraphics (ELSA-2009-0431)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2009:0431 :
...
backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2009-April/000972.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"kdegraphics-3.3.1-13.el4")) flag++;
if (rpm_check(release:"EL4", reference:"kdegraphics-devel-3.3.1-13.el4")) flag++;
