...
# extracted from OracleVM Security Advisory OVMSA-2021-0012.
##
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.4 : sudo (OVMSA-2021-0012)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/cve/CVE-2021-3156.html");
  script_set_attribute(attribute:"see_also", value:"https://linux.oracle.com/errata/OVMSA-2021-0012.html");
...
var pkgs = [
    {'reference':'sudo-1.8.6p3-29.0.3.el6_10.3', 'cpu':'x86_64', 'release':'3.4', 'rpm_spec_vers_cmp':TRUE}
];
