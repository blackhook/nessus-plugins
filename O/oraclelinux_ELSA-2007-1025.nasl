...
# Oracle Linux Security Advisory ELSA-2007-1025 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : gpdf (ELSA-2007-1025)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2007:1025 :
...
backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2007-November/000386.html"
  );
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"gpdf-2.8.2-7.7.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"gpdf-2.8.2-7.7.1")) flag++;
