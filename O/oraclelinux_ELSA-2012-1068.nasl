...
using OpenJPEG must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2012-July/002925.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"openjpeg-1.3-8.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"openjpeg-devel-1.3-8.el6_3")) flag++;
if (rpm_check(release:"EL6", reference:"openjpeg-libs-1.3-8.el6_3")) flag++;
