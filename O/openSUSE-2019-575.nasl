...
# extracted from openSUSE Security Update openSUSE-2019-575.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : java-11-openjdk (openSUSE-2019-575)");
  script_summary(english:"Check for the openSUSE-2019-575 patch");
