...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-273 patch");
...
Security issues fixed :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1164572"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1164574"
  );
  script_set_attribute(
    attribute:"solution", 
