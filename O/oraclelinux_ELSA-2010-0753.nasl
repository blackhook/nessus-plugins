...
# Oracle Linux Security Advisory ELSA-2010-0753 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : kdegraphics (ELSA-2010-0753)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0753 :
...
backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-October/001683.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", reference:"kdegraphics-3.3.1-18.el4_8.1")) flag++;
if (rpm_check(release:"EL4", reference:"kdegraphics-devel-3.3.1-18.el4_8.1")) flag++;
