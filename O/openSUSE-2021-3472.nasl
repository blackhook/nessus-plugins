...
# openSUSE Security Update openSUSE-SU-2021:3472-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : flatpak (openSUSE-SU-2021:3472-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote SUSE host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote SUSE Linux SUSE15 host has packages installed that are affected by a vulnerability as referenced in the
openSUSE-SU-2021:3472-1 advisory.
...
number.");
  ...
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/QXL4FA3WICXGFNYWHOG3GKOXZERBN6TL/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?75a1f138");
...
var pkgs = [
    {'reference':'flatpak-1.10.5-4.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-devel-1.10.5-4.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-zsh-completion-1.10.5-4.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libflatpak0-1.10.5-4.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'system-user-flatpak-1.10.5-4.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'typelib-1_0-Flatpak-1_0-1.10.5-4.9.1', 'release':'SUSE15.3', 'rpm_spec_vers_cmp':TRUE}
];
