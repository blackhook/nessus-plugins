...
# extracted from openSUSE Security Update openSUSE-2013-811.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dropbear (openSUSE-SU-2013:1616-1)");
  script_summary(english:"Check for the openSUSE-2013-811 patch");
...
"dropbear was updated to version 2013.60 to fix following bugs :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-10/msg00061.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE12.3", reference:"dropbear-2013.60-7.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"dropbear-debuginfo-2013.60-7.4.1") ) flag++;
if ( rpm_check(release:"SUSE12.3", reference:"dropbear-debugsource-2013.60-7.4.1") ) flag++;
