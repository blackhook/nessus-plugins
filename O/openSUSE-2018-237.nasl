...
# extracted from openSUSE Security Update openSUSE-2018-237.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : rsync (openSUSE-2018-237)");
  script_summary(english:"Check for the openSUSE-2018-237 patch");
...
This update was imported from the SUSE:SLE-12:Update update project."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1076503"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( rpm_check(release:"SUSE42.3", reference:"rsync-3.1.0-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"rsync-debuginfo-3.1.0-13.1") ) flag++;
if ( rpm_check(release:"SUSE42.3", reference:"rsync-debugsource-3.1.0-13.1") ) flag++;
