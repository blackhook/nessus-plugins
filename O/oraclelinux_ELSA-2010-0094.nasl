...
# Oracle Linux Security Advisory ELSA-2010-0094 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 4 : HelixPlayer (ELSA-2010-0094)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2010:0094 :
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2010-February/001348.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL4", cpu:"i386", reference:"HelixPlayer-1.0.6-1.0.1.el4_8.1")) flag++;
if (rpm_check(release:"EL4", cpu:"x86_64", reference:"HelixPlayer-1.0.6-1.0.1.el4_8.1")) flag++;
