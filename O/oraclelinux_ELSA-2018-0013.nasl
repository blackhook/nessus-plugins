...
if (description)
{
  ...
  script_name(english:"Oracle Linux 6 : microcode_ctl (ELSA-2018-0013) (Spectre)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2018:0013 :
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2018-January/007435.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"EL6", reference:"microcode_ctl-1.17-25.2.el6_9")) flag++;
