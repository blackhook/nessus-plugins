...
# extracted from openSUSE Security Update openSUSE-2020-2334.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : kdeconnect-kde (openSUSE-2020-2334)");
  script_summary(english:"Check for the openSUSE-2020-2334 patch");
...
if ( rpm_check(release:"SUSE15.1", reference:"kdeconnect-kde-1.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"kdeconnect-kde-debuginfo-1.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"kdeconnect-kde-debugsource-1.3.3-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"kdeconnect-kde-lang-1.3.3-lp151.2.6.1") ) flag++;
