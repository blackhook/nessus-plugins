...
# Oracle Linux Security Advisory ELSA-2008-0039 respectively.
#
...
if (description)
{
  ...
  script_name(english:"Oracle Linux 3 : postgresql (ELSA-2008-0039)");
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2008:0039 :
...
include PostgreSQL 7.3.21 and resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2008-January/000483.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-contrib-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-contrib-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-devel-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-devel-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-docs-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-docs-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-jdbc-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-jdbc-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-libs-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-libs-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-pl-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-pl-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-python-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-python-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-server-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-server-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-tcl-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-tcl-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"i386", reference:"rh-postgresql-test-7.3.21-1")) flag++;
if (rpm_check(release:"EL3", cpu:"x86_64", reference:"rh-postgresql-test-7.3.21-1")) flag++;
