...
# extracted from openSUSE Security Update openSUSE-2015-636.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : froxlor (openSUSE-2015-636)");
  script_summary(english:"Check for the openSUSE-2015-636 patch");
  ...
  script_set_attribute(
    ...
    value:
"froxlor was updated to version 0.9.34 (bnc#846355), fixing bugs and
bringing features."
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE13.1", reference:"froxlor-0.9.34-14.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"froxlor-0.9.34-3.3.1") ) flag++;
