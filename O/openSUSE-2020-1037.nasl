...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2020-1037 patch");
...
"This update for singularity fixes the following issues :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1125369"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1128598"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1159550"
  );
  script_set_attribute(
    attribute:"see_also",
