...
# Security Advisory OVMSA-2017-0114.
#
...
if (description)
{
  ...
  script_name(english:"OracleVM 3.3 / 3.4 : sudo (OVMSA-2017-0114)");
...
critical security updates :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2017-June/000742.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/oraclevm-errata/2017-June/000741.html"
  );
...
flag = 0;
if (rpm_check(release:"OVS3.3", reference:"sudo-1.8.6p3-29.el6_9")) flag++;

if (rpm_check(release:"OVS3.4", reference:"sudo-1.8.6p3-29.el6_9")) flag++;
