...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0390 :
...
a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-March/002036.html"
  );
...
flag = 0;
if (rpm_check(release:"EL6", reference:"rsync-3.0.6-5.el6_0.1")) flag++;
