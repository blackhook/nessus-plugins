...
# extracted from openSUSE Security Update openSUSE-2013-736.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : gpg2 (openSUSE-SU-2013:1526-1)");
  script_summary(english:"Check for the openSUSE-2013-736 patch");
...
"  - GnuPG treated no-usage-permitted keys as
  ...
  - added gpg2-CVE-2013-4351.patch
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.opensuse.org/opensuse-updates/2013-10/msg00003.html"
  );
...
if ( rpm_check(release:"SUSE12.2", reference:"gpg2-2.0.19-2.11.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"gpg2-debuginfo-2.0.19-2.11.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"gpg2-debugsource-2.0.19-2.11.1") ) flag++;
if ( rpm_check(release:"SUSE12.2", reference:"gpg2-lang-2.0.19-2.11.1") ) flag++;
