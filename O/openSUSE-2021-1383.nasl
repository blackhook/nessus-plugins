...
# openSUSE Security Update openSUSE-SU-2021:1383-1. The text itself
# is copyright (C) SUSE.
##
...
if (description)
{
  ...
  script_name(english:"openSUSE 15 Security Update : ssh-audit (openSUSE-SU-2021:1383-1)");
...
openSUSE-SU-2021:1383-1 advisory.
...
number.");
  # https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/HMNIMCAHIBHI4ABCI2JE3E6E2SYDAP2T/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c78eec47");
  script_set_attribute(attribute:"see_also", value:"https://www.suse.com/security/cve/CVE-2018-15473");
  script_set_attribute(attribute:"solution", value:
"Update the affected ssh-audit package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:novell:opensuse:ssh-audit");
...
var pkgs = [
    {'reference':'ssh-audit-2.5.0-lp152.2.3.1', 'release':'SUSE15.2', 'rpm_spec_vers_cmp':TRUE}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'ssh-audit');
}
