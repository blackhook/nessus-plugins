...
# extracted from openSUSE Security Update openSUSE-2012-85.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : pdns (openSUSE-2012-85)");
  script_summary(english:"Check for the openSUSE-2012-85 patch");
  ...
  script_set_attribute(
    ...
    value:"specially crafted request could lead to denial of service"
  );
  script_set_attribute(
    attribute:"see_also",
...
if ( rpm_check(release:"SUSE12.1", reference:"pdns-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-ldap-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-ldap-debuginfo-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-mysql-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-mysql-debuginfo-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-postgresql-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-postgresql-debuginfo-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-sqlite2-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-sqlite2-debuginfo-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-sqlite3-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-backend-sqlite3-debuginfo-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-debuginfo-2.9.22-7.3.1") ) flag++;
if ( rpm_check(release:"SUSE12.1", reference:"pdns-debugsource-2.9.22-7.3.1") ) flag++;
