...
# extracted from openSUSE Security Update openSUSE-2016-912.
#
...
if (description)
{
  ...
  script_name(english:"openSUSE Security Update : dropbear (openSUSE-2016-912)");
  script_summary(english:"Check for the openSUSE-2016-912 patch");
...
if ( rpm_check(release:"SUSE13.2", reference:"dropbear-2016.74-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dropbear-debuginfo-2016.74-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE13.2", reference:"dropbear-debugsource-2016.74-2.6.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dropbear-2016.74-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dropbear-debuginfo-2016.74-11.1") ) flag++;
if ( rpm_check(release:"SUSE42.1", reference:"dropbear-debugsource-2016.74-11.1") ) flag++;
