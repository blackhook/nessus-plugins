...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"From Red Hat Security Advisory 2011:0452 :
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://oss.oracle.com/pipermail/el-errata/2011-April/002079.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"EL6", reference:"libtiff-3.9.4-1.el6_0.3")) flag++;
if (rpm_check(release:"EL6", reference:"libtiff-devel-3.9.4-1.el6_0.3")) flag++;
if (rpm_check(release:"EL6", reference:"libtiff-static-3.9.4-1.el6_0.3")) flag++;
