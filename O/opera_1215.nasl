...
and therefore is reportedly affected by the following vulnerabilities :
  ...
  - An unspecified, moderate severity issue exists that has an
    unspecified impact.");
  script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20180219151916/http://www.opera.com/security/advisory/1046");
  script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20170202083335/http://www.opera.com/security/advisory/1047");
...
"Upgrade to Opera 12.15 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-3211");
