...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : java-1.8.0-openjdk / etc (VZLSA-2017-1108)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1108.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f60dde0");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017-1108");
...
"Update the affected java-1.8.0-openjdk / etc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:java-1.8.0-openjdk-accessibility");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:java-1.8.0-openjdk-accessibility-debug");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:java-1.8.0-openjdk-javadoc-zip");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:java-1.8.0-openjdk-javadoc-zip-debug");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-accessibility-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-accessibility-debug-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-debug-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-demo-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-demo-debug-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-devel-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-devel-debug-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-headless-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-headless-debug-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-javadoc-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-javadoc-debug-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-javadoc-zip-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-javadoc-zip-debug-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-src-1.8.0.131-2.b11.vl7",
        "java-1.8.0-openjdk-src-debug-1.8.0.131-2.b11.vl7"];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "java-1.8.0-openjdk / etc");
}
