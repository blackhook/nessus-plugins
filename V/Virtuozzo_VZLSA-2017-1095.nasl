...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : bind / bind-chroot / bind-devel / bind-libs / etc (VZLSA-2017-1095)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1095.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ebd4557c");
...
pkgs = ["bind-9.9.4-38.vl7.3",
        "bind-chroot-9.9.4-38.vl7.3",
        "bind-devel-9.9.4-38.vl7.3",
        "bind-libs-9.9.4-38.vl7.3",
        "bind-libs-lite-9.9.4-38.vl7.3",
        "bind-license-9.9.4-38.vl7.3",
        "bind-lite-devel-9.9.4-38.vl7.3",
        "bind-pkcs11-9.9.4-38.vl7.3",
        "bind-pkcs11-devel-9.9.4-38.vl7.3",
        "bind-pkcs11-libs-9.9.4-38.vl7.3",
        "bind-pkcs11-utils-9.9.4-38.vl7.3",
        "bind-sdb-9.9.4-38.vl7.3",
        "bind-sdb-chroot-9.9.4-38.vl7.3",
        "bind-utils-9.9.4-38.vl7.3"];
