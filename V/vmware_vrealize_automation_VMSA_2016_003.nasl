...
the execution of arbitrary script code in a user's browser session.");
  script_set_attribute(attribute:"see_also", value:"https://www.vmware.com/security/advisories/VMSA-2016-0003.html");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2016/Mar/55");
...
"Upgrade to VMware vRealize Automation version 6.2.4 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2344");
