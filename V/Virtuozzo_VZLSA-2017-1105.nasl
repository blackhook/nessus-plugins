...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : bind / bind-chroot / bind-devel / bind-libs / etc (VZLSA-2017-1105)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1105.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56726af9");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017-1105");
...
pkgs = ["bind-9.8.2-0.62.rc1.vl6.1",
        "bind-chroot-9.8.2-0.62.rc1.vl6.1",
        "bind-devel-9.8.2-0.62.rc1.vl6.1",
        "bind-libs-9.8.2-0.62.rc1.vl6.1",
        "bind-sdb-9.8.2-0.62.rc1.vl6.1",
        "bind-utils-9.8.2-0.62.rc1.vl6.1"];
