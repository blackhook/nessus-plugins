...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2019-A-0387-S");
  script_xref(name:"IAVA", value:"2020-A-0022-S");

  script_name(english:"Oracle VM VirtualBox 5.2.x < 5.2.34 / 6.0.x < 6.0.14 (Oct 2019 CPU)");
