...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2017-053)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://help.virtuozzo.com/customer/portal/articles/2828916");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-30.10-23.2-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?69652e77");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-30.10-23.2-1.vl7"
  )
);
