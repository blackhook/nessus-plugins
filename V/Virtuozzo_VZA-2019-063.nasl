...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : parallels-kernel-modules / etc (VZA-2019-063)");
...
affected by the following vulnerability :
  ...
  - Fixed possible corruption of VM configuration after
    restoration from backup by means of third-party
    solutions. The built-in backup restoration tool 'prlctl
    restore' is not affected. User data inside restored VMs
    is not affected.
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://virtuozzosupport.force.com/s/article/VZA-2019-063");
...
pkgs = ["parallels-kernel-modules-6.12.26096.1233688-1.el6",
        "parallels-reconfiguration-6.12.26096.1233688-1",
        "parallels-server-6.12.26096.1233688-1.el6",
        "parallels-server-bios-6.12.26096.1233688-1.el6",
        "parallels-server-bm-release-6.0.12-3746",
        "parallels-server-cli-6.12.26096.1233688-1.el6",
        "parallels-server-docs-6.12.26096.1233688-1.el6.el6",
        "parallels-server-efi-6.12.26096.1233688-1.el6",
        "parallels-server-lib-6.12.26096.1233688-1.el6",
        "parallels-server-transporter-agents-6.12.26096.1233688-1.el6",
        "parallels-server-vi-cli-6.12.26096.1233688-1.el6",
        "parallels-server-vmm-6.12.26096.1233688-1.el6",
        "parallels-server-vncserver-6.12.26096.1233688-1.el6",
        "parallels-server-vzvncserver-6.12.26096.1233688-1.el6",
        "parallels-virtualization-sdk-6.12.26096.1233688-1.el6",
        "parallels-virtualization-sdk-devel-6.12.26096.1233688-1.el6",
        "parallels-virtualization-sdk-docs-6.12.26096.1233688-1.el6",
        "parallels-web-6.12.26096.1233688-1",
        "python-parallels-virtualization-sdk-6.12.26096.1233688-1.el6"];
