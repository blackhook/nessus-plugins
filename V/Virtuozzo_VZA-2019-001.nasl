...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2019-001)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://virtuozzosupport.force.com/s/article/VZA-2019-001");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-63.3-70.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de92f710");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-64.7-70.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?00c4e3ef");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-63.3-70.0-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-862.11.6.vz7.64.7",
    "patch","readykernel-patch-64.7-70.0-1.vl7"
  )
);
