...
if (description)
{
  ...
  script_name(english:"VMware ESX / ESXi Arbitrary File Modification (VMSA-2013-0016) (remote check)");
...
"The remote VMware ESX / ESXi host is missing a security-related patch.
It is, therefore, affected by an arbitrary file modification
vulnerability due to improper handling of certain Virtual Machine file
descriptors. A local attacker can exploit this to read or modify
arbitrary files.");
