...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : parallels-server-bm-release / vzkernel / etc (VZA-2017-096)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://help.virtuozzo.com/customer/portal/articles/2892717");
...
pkgs = ["parallels-server-bm-release-6.0.12-3686",
        "vzkernel-2.6.32-042stab125.5",
        "vzkernel-devel-2.6.32-042stab125.5",
        "vzkernel-firmware-2.6.32-042stab125.5",
        "vzmodules-2.6.32-042stab125.5",
        "vzmodules-devel-2.6.32-042stab125.5"];
