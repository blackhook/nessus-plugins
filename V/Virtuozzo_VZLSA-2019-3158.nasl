...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : java-1.7.0-openjdk / java-1.7.0-openjdk-demo / etc (VZLSA-2019-3158)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2019-3158.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f5f2a02");
...
pkgs = ["java-1.7.0-openjdk-1.7.0.241-2.6.20.0.vl6",
        "java-1.7.0-openjdk-demo-1.7.0.241-2.6.20.0.vl6",
        "java-1.7.0-openjdk-devel-1.7.0.241-2.6.20.0.vl6",
        "java-1.7.0-openjdk-javadoc-1.7.0.241-2.6.20.0.vl6",
        "java-1.7.0-openjdk-src-1.7.0.241-2.6.20.0.vl6"];
