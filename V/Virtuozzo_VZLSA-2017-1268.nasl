...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : libtirpc / libtirpc-devel (VZLSA-2017-1268)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1268.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9baf6469");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017-1268");
...
pkgs = ["libtirpc-0.2.1-13.vl6",
        "libtirpc-devel-0.2.1-13.vl6"];
