...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : java-1.8.0-openjdk / java-1.8.0-openjdk-debug / etc (VZLSA-2017-2998)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-2998.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?cc86d816");
...
pkgs = ["java-1.8.0-openjdk-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-debug-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-demo-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-demo-debug-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-devel-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-devel-debug-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-headless-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-headless-debug-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-javadoc-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-javadoc-debug-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-src-1.8.0.151-1.b12.vl6",
        "java-1.8.0-openjdk-src-debug-1.8.0.151-1.b12.vl6"];
