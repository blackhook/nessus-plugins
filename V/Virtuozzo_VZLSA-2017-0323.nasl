...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : kernel / kernel-PAE / kernel-PAE-devel / etc (VZLSA-2017-0323)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-0323.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?79480178");
...
"Update the affected kernel / kernel-PAE / kernel-PAE-devel / etc package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:kernel-PAE");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:kernel-PAE-devel");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:kernel-xen");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:kernel-xen-devel");
...
pkgs = ["kernel-2.6.18-419.vl5",
        "kernel-PAE-2.6.18-419.vl5",
        "kernel-PAE-devel-2.6.18-419.vl5",
        "kernel-debug-2.6.18-419.vl5",
        "kernel-debug-devel-2.6.18-419.vl5",
        "kernel-devel-2.6.18-419.vl5",
        "kernel-doc-2.6.18-419.vl5",
        "kernel-headers-2.6.18-419.vl5",
        "kernel-headers-2.6.18-419.vl5.i386",
        "kernel-xen-2.6.18-419.vl5",
        "kernel-xen-devel-2.6.18-419.vl5"];
