...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : nss / nss-devel / nss-pkcs11-devel / nss-sysinit / etc (VZLSA-2017-1365)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1365.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e86a082");
...
pkgs = ["nss-3.28.4-1.2.vl7",
        "nss-devel-3.28.4-1.2.vl7",
        "nss-pkcs11-devel-3.28.4-1.2.vl7",
        "nss-sysinit-3.28.4-1.2.vl7",
        "nss-tools-3.28.4-1.2.vl7"];
