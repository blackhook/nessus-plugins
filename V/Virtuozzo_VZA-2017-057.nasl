...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2017-057)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://help.virtuozzo.com/customer/portal/articles/2833163");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-30.10-24.0-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3a80a4d7");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-30.10-24.0-1.vl7"
  )
);
