...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : rpcbind (VZLSA-2017-1267)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1267.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0dbcd9d2");
...
"Update the affected rpcbind package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:rpcbind");
