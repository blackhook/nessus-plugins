...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2019-003)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://virtuozzosupport.force.com/s/article/VZA-2019-003");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-30.15-70.1-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?829b4f10");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-33.22-70.1-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a669234");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-30.15-70.1-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-514.26.1.vz7.33.22",
    "patch","readykernel-patch-33.22-70.1-1.vl7"
  )
);
