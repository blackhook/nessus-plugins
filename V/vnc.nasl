...
if(description)
{
 ...
 script_cvs_date("$Date: 2017/06/12 22:01:06 $");
...
host to be displayed on another." );
 script_set_attribute(attribute:"see_also", value:"https://en.wikipedia.org/wiki/Vnc" );
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 2000-2017 Patrick Naubert");
