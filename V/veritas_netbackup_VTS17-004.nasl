...
if (description)
{
  ...
  script_cve_id("CVE-2017-8856", "CVE-2017-8857", "CVE-2017-8858");
  script_bugtraq_id(98379, 98381, 98384);
...
host is 7.7.x or 8.0.x and may be missing a vendor-supplied security
...
referenced in the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-8858");
...
# Client and Media Server are not affected
install_type = app_info['Install type'];
if ("Client" >< install_type || "Media Server" >< install_type)
