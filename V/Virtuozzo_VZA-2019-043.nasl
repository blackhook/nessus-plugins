...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2019-043)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://virtuozzosupport.force.com/s/article/VZA-2019-043");
  script_set_attribute(attribute:"see_also", value:"https://readykernel.com/patch/1515/");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-85.17-80.0-1.vl7"
  )
);
