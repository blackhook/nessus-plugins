...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : nss-util / nss-util-devel (VZLSA-2017-1100)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1100.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6a14d746");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017-1100");
...
"Update the affected nss-util / nss-util-devel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:nss-util");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:virtuozzo:virtuozzo:nss-util-devel");
...
pkgs = ["nss-util-3.28.4-1.vl6",
        "nss-util-devel-3.28.4-1.vl6"];
