...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : kernel / kernel-abi-whitelists / kernel-debug / etc (VZLSA-2017-1484)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1484.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f21a3a24");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017-1484");
...
pkgs = ["kernel-3.10.0-514.21.2.vl7",
        "kernel-abi-whitelists-3.10.0-514.21.2.vl7",
        "kernel-debug-3.10.0-514.21.2.vl7",
        "kernel-debug-devel-3.10.0-514.21.2.vl7",
        "kernel-devel-3.10.0-514.21.2.vl7",
        "kernel-doc-3.10.0-514.21.2.vl7",
        "kernel-headers-3.10.0-514.21.2.vl7",
        "kernel-tools-3.10.0-514.21.2.vl7",
        "kernel-tools-libs-3.10.0-514.21.2.vl7",
        "kernel-tools-libs-devel-3.10.0-514.21.2.vl7",
        "perf-3.10.0-514.21.2.vl7",
        "python-perf-3.10.0-514.21.2.vl7"];
