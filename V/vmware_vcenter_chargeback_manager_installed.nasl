...
installed on the remote Windows host.");
  # https://www.vmware.com/products/vcenter-chargeback.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?689050a2");
...
register_install(
  app_name:app,
  vendor : 'VMware',
  product : 'vCenter Chargeback Manager',
  path:path,
  version:version,
