...
if (description)
{
  ...
  script_name(english:"VMware OT Asset Information");

  script_set_attribute(attribute:"synopsis", value:"The remote host is a VMware OT device.");
  script_set_attribute(attribute:"description", value:
  "It is possible to obtain attributes of the remote VMware OT device.
