...
if (description)
{
  ...
  script_name(english:"ESXi 5.1 < Build 1142907 NFC Traffic Denial of Service (remote check)");
  script_summary(english:"Checks ESXi version and build number");

  script_set_attribute(attribute:"synopsis", value:
"The remote VMware ESXi 5.1 host is affected by denial of service
vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote VMware ESXi 5.1 host is affected by an unspecified error
related to handling Network File Copy (NFC) traffic that could allow
denial of service attacks.");
  # https://kb.vmware.com/selfservice/microsites/search.do?cmd=displayKC&externalId=2052151
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ae86d75d");
  script_set_attribute(attribute:"see_also", value:"https://www.vmware.com/security/advisories/VMSA-2013-0011.html");
  script_set_attribute(attribute:"solution", value:"Apply patch ESXi510-201307101-SG.");
