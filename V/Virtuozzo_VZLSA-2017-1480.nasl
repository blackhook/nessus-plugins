...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : glibc / glibc-common / glibc-devel / glibc-headers / etc (VZLSA-2017-1480)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1480.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f62417e7");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2017-1480");
...
pkgs = ["glibc-2.12-1.209.vl6.2",
        "glibc-common-2.12-1.209.vl6.2",
        "glibc-devel-2.12-1.209.vl6.2",
        "glibc-headers-2.12-1.209.vl6.2",
        "glibc-static-2.12-1.209.vl6.2",
        "glibc-utils-2.12-1.209.vl6.2",
        "nscd-2.12-1.209.vl6.2"];
