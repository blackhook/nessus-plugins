...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : sudo / sudo-devel (VZLSA-2017-1574)");
...
it as much as possible without introducing additional issues.");
  # http://repo.virtuozzo.com/vzlinux/announcements/json/VZLSA-2017-1574.json
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?28a9fead");
...
pkgs = ["sudo-1.8.6p3-29.vl6",
        "sudo-devel-1.8.6p3-29.vl6"];
