...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"0001-T-0737");
...
or Linux PC is installed on the remote host.");
  script_set_attribute(attribute:"see_also", value:"https://www.vmware.com/products/workstation-player.html");
...
if(!isnull(installstring))
  player_version = get_kb_item(installstring + "/DisplayVersion");
