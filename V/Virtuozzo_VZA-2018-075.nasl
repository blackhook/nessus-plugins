...
if (description)
{
  ...
  script_name(english:"Virtuozzo 6 : parallels-server-bm-release / vzkernel / etc (VZA-2018-075)");
...
remote host is affected by the following vulnerabilities :
  ...
  - A flaw named FragmentSmack was found in the way the
    ...
    a denial of service on the system.
  ...
  - An integer overflow flaw was found in the Linux
    ...
    their privileges on the system (Mutagen Astronomy).
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://virtuozzosupport.force.com/s/article/VZA-2018-075");
...
pkgs = ["parallels-server-bm-release-6.0.12-3724",
        "vzkernel-2.6.32-042stab134.3",
        "vzkernel-devel-2.6.32-042stab134.3",
        "vzkernel-firmware-2.6.32-042stab134.3",
        "vzmodules-2.6.32-042stab134.3",
        "vzmodules-devel-2.6.32-042stab134.3"];
