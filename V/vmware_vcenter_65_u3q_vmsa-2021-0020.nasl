...
if (description)
{
  ...
  script_name(english:"VMware vCenter Server < 6.5 U3q Multiple Vulnerabilities (VMSA-2021-0020)");
...
"The version of VMware vCenter Server installed on the remote host is 6.5 prior to 6.5 U3q. It is, therefore, affected
...
"Upgrade to VMware vCenter Server 6.5 U3q or later or apply the workaround mentioned in the advisory.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-22014");
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-22015");

  script_set_attribute(attribute:"exploitability_ease", value:"Exploits are available");
  script_set_attribute(attribute:"exploit_available", value:"true");
  script_set_attribute(attribute:"metasploit_name", value:'VMware vCenter vScalation Priv Esc');
...
if (isnull(match)) audit(AUDIT_OS_NOT, 'VMware vCenter 6.5');

var ver = match[1];
if (ver !~ "^6\.5$") audit(AUDIT_OS_NOT, 'VMware vCenter 6.5');
