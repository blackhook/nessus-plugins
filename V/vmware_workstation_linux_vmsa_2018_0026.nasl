...
if (description)
{
  ...
  script_name(english:"VMware Workstation 14.x < 14.1.3 Out-of-Bounds Read Vulnerability (VMSA-2018-0026) (Linux)");
...
is 14.x prior to 14.1.3. It is, therefore, affected by an
