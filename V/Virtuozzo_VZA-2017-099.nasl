...
if (description)
{
  ...
  script_name(english:"Virtuozzo 7 : readykernel-patch (VZA-2017-099)");
...
possible without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://help.virtuozzo.com/customer/portal/articles/2896650");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-15.2-36.1-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da1b5002");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-18.7-36.1-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?14e22aa7");
  # https://readykernel.com/patch/Virtuozzo-7/readykernel-patch-20.18-36.1-1.vl7/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c69d3a0");
...
checks = make_list2(
  make_array(
    ...
    "patch","readykernel-patch-15.2-36.1-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-327.36.1.vz7.18.7",
    "patch","readykernel-patch-18.7-36.1-1.vl7"
  ),
  make_array(
    "kernel","vzkernel-3.10.0-327.36.1.vz7.20.18",
    "patch","readykernel-patch-20.18-36.1-1.vl7"
  )
);
