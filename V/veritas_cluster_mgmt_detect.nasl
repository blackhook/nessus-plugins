...
tests will be disabled on this port." );
 script_set_attribute(attribute:"see_also", value:"https://en.wikipedia.org/wiki/Veritas_Cluster_Server");
...
{
  add_install(appname:'veritas_cluster_mgmt', dir:'/', port:port, cpe: "cpe:/a:symantec:veritas_cluster_server_management_console");
