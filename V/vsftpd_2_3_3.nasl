...
relied on the version in vsftpd's banner.");
  script_set_attribute(attribute:"see_also", value:"https://downloads.securityfocus.com/vulnerabilities/exploits/46617.c");
  script_set_attribute(attribute:"see_also", value:"ftp://vsftpd.beasts.org/users/cevans/untar/vsftpd-2.3.3/Changelog");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2011/Mar/9");
