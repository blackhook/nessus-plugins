...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.06 : xorg-x11-server Multiple Vulnerabilities (NS-SA-2021-0003)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.06, has xorg-x11-server packages installed that are affected by
...
pkgs = {
  'CGSL MAIN 4.06': [
    'xorg-x11-server-Xdmx-1.17.4-18.el6.centos',
    'xorg-x11-server-Xephyr-1.17.4-18.el6.centos',
    'xorg-x11-server-Xnest-1.17.4-18.el6.centos',
    'xorg-x11-server-Xorg-1.17.4-18.el6.centos',
    'xorg-x11-server-Xvfb-1.17.4-18.el6.centos',
    'xorg-x11-server-common-1.17.4-18.el6.centos',
    'xorg-x11-server-devel-1.17.4-18.el6.centos',
    'xorg-x11-server-source-1.17.4-18.el6.centos'
  ]
};
