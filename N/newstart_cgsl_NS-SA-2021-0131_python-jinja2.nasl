...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : python-jinja2 Vulnerability (NS-SA-2021-0131)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has python-jinja2 packages installed that are affected by a
vulnerability:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2019-10906");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'python3-jinja2-2.10.3-4.module_el8.3.0+441+3b561464'
  ]
};
