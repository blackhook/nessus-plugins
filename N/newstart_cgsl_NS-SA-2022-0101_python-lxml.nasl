...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : python-lxml Vulnerability (NS-SA-2022-0101)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has python-lxml packages installed that are affected by a
vulnerability:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2021-43818");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'python3-lxml-4.4.1-4.module_el8.2.0+317+61fa6e7d'
  ]
};
