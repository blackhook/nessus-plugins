...
# extracted from ZTE advisory NS-SA-2019-0100. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : rpcbind Vulnerability (NS-SA-2019-0100)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has rpcbind packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0100");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL rpcbind packages. Note that updated packages may not be available yet. Please contact ZTE
