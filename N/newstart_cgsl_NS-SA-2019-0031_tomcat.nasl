...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : tomcat Vulnerability (NS-SA-2019-0031)");
...
a vulnerability:
  ...
  - An improper handing of overflow in the UTF-8 decoder
    ...
    Versions Affected: Apache Tomcat 9.0.0.M9 to 9.0.7,
    8.5.0 to 8.5.30, 8.0.0.RC1 to 8.0.51, and 7.0.28 to
    7.0.86. (CVE-2018-1336)
