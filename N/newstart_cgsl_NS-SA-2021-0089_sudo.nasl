...
# extracted from ZTE advisory NS-SA-2021-0089. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : sudo Vulnerability (NS-SA-2021-0089)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0089");
...
pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'sudo-debuginfo-1.8.29-6.el8_3.1',
    'sudo-debugsource-1.8.29-6.el8_3.1',
    'sudo-devel-1.8.29-6.el8_3.1'
  ]
};
