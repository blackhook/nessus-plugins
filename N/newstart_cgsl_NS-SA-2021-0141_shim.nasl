...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : shim Vulnerability (NS-SA-2021-0141)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has shim packages installed that are affected by a
vulnerability:
...
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:shim-unsigned-ia32");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:shim-unsigned-ia32-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:shim-unsigned-x64");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:shim-unsigned-x64-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:shim-unsigned-ia32");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:shim-unsigned-ia32-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:shim-unsigned-x64");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:shim-unsigned-x64-debuginfo");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'shim-unsigned-ia32-debuginfo-15-7.el7_9',
    'shim-unsigned-x64-15-7.el7_9',
    'shim-unsigned-x64-debuginfo-15-7.el7_9'
  ],
  'CGSL MAIN 5.05': [
    'shim-unsigned-ia32-15-7.el7_9',
    'shim-unsigned-ia32-debuginfo-15-7.el7_9',
