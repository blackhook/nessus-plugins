...
has a remote command execution vulnerability."
  ...
  # https://packetstormsecurity.com/files/120038/Nagios-XI-2012R1.5b-XSS-Command-Execution-SQL-Injection-CSRF.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2b85ff36");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2013/Feb/10");
