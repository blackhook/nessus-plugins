...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : firefox Multiple Vulnerabilities (NS-SA-2020-0011)");
...
pkgs = {
  "CGSL CORE 5.04": [
    "firefox-68.4.1-1.el7.centos",
    "firefox-debuginfo-68.4.1-1.el7.centos"
  ],
  "CGSL MAIN 5.04": [
    "firefox-68.4.1-1.el7.centos",
    "firefox-debuginfo-68.4.1-1.el7.centos"
