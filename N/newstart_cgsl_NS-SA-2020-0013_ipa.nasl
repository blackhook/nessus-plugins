...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : ipa Multiple Vulnerabilities (NS-SA-2020-0013)");
...
multiple vulnerabilities:
  ...
  - A flaw was found in the way that FreeIPA's batch
    ...
    flaw to produce log file content with passwords exposed.
    (CVE-2019-10195)
  ...
  - A flaw was found in the way the internal function
    ...
    executed on the server hosting the IPA server.
    (CVE-2019-14867)
