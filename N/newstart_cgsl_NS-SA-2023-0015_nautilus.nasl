...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : nautilus Multiple Vulnerabilities (NS-SA-2023-0015)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has nautilus packages installed that are affected
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:nautilus");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:nautilus-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:nautilus-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:nautilus-extensions");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:nautilus");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:nautilus-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:nautilus-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:nautilus-extensions");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'nautilus-debuginfo-3.26.3.1-7.el7',
    'nautilus-devel-3.26.3.1-7.el7',
    'nautilus-extensions-3.26.3.1-7.el7'
  ],
  'CGSL MAIN 5.05': [
    'nautilus-3.26.3.1-7.el7',
    'nautilus-debuginfo-3.26.3.1-7.el7',
