...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : logrotate Multiple Vulnerabilities (NS-SA-2022-0095)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has logrotate packages installed that are affected by multiple
vulnerabilities:
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'logrotate-3.14.0-3.el8.cgslv6_2'
  ]
};
