...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : ovmf Multiple Vulnerabilities (NS-SA-2021-0180)");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'OVMF-20180508-6.gitee3198e672e2.el7.cgslv5_5.0.1.g7d971ab'
  ],
  'CGSL MAIN 5.05': [
    'OVMF-20180508-6.gitee3198e672e2.el7.cgslv5_5.0.1.g7d971ab'
  ]
