...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 5.04 : samba Multiple Vulnerabilities (NS-SA-2019-0003)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 5.04, has samba packages installed that are affected by multiple
vulnerabilities:

  - A memory disclosure flaw was found in samba. An attacker
    could retrieve parts of server memory, which could
    contain potentially sensitive data, by sending
...
pkgs = {
  "CGSL MAIN 5.04": [
    "ctdb-4.6.2-12.el7_4",
    "ctdb-tests-4.6.2-12.el7_4",
    "libsmbclient-4.6.2-12.el7_4",
    "libsmbclient-devel-4.6.2-12.el7_4",
    "libwbclient-4.6.2-12.el7_4",
    "libwbclient-devel-4.6.2-12.el7_4",
    "samba-4.6.2-12.el7_4",
    "samba-client-4.6.2-12.el7_4",
    "samba-client-libs-4.6.2-12.el7_4",
    "samba-common-4.6.2-12.el7_4",
    "samba-common-libs-4.6.2-12.el7_4",
    "samba-common-tools-4.6.2-12.el7_4",
    "samba-dc-4.6.2-12.el7_4",
    "samba-dc-libs-4.6.2-12.el7_4",
    "samba-debuginfo-4.6.2-12.el7_4",
    "samba-devel-4.6.2-12.el7_4",
    "samba-krb5-printing-4.6.2-12.el7_4",
    "samba-libs-4.6.2-12.el7_4",
    "samba-pidl-4.6.2-12.el7_4",
    "samba-python-4.6.2-12.el7_4",
    "samba-test-4.6.2-12.el7_4",
    "samba-test-libs-4.6.2-12.el7_4",
    "samba-vfs-glusterfs-4.6.2-12.el7_4",
    "samba-winbind-4.6.2-12.el7_4",
    "samba-winbind-clients-4.6.2-12.el7_4",
    "samba-winbind-krb5-locator-4.6.2-12.el7_4",
    "samba-winbind-modules-4.6.2-12.el7_4"
  ]
};
