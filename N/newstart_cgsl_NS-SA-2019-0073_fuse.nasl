...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : fuse Vulnerability (NS-SA-2019-0073)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has fuse packages installed that are affected by a
vulnerability:
  ...
  - A vulnerability was discovered in fuse. When SELinux is
    ...
    system with the 'allow_other' mount option regardless of
    whether 'user_allow_other' is set in the fuse
...
"Upgrade the vulnerable CGSL fuse packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
