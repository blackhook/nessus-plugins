...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : microcode_ctl Vulnerability (NS-SA-2021-0134)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has microcode_ctl packages installed that are affected by a
vulnerability:
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'microcode_ctl-20200609-2.20210216.1.el8_3'
  ]
};
