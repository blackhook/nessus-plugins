...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : java-1.8.0-openjdk Multiple Vulnerabilities (NS-SA-2019-0146)");
...
pkgs = {
  "CGSL MAIN 4.05": [
    ...
    "java-1.8.0-openjdk-debuginfo-1.8.0.191.b12-0.el6_10",
