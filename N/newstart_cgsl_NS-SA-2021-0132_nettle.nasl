...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : nettle Vulnerability (NS-SA-2021-0132)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has nettle packages installed that are affected by a
vulnerability:
...
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:nettle-debugsource");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'nettle-debuginfo-3.4.1-4.el8_3',
    'nettle-debugsource-3.4.1-4.el8_3',
    'nettle-devel-3.4.1-4.el8_3'
  ]
};
