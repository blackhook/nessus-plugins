...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : poppler Vulnerability (NS-SA-2019-0118)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has poppler packages installed that are affected by a
vulnerability:
...
pkgs = {
  "CGSL MAIN 4.05": [
    "poppler-0.12.4-12.el6_9",
    "poppler-glib-0.12.4-12.el6_9",
    "poppler-qt4-0.12.4-12.el6_9",
    "poppler-utils-0.12.4-12.el6_9"
  ]
};
