...
# extracted from ZTE advisory NS-SA-2022-0038. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : wpa_supplicant Vulnerability (NS-SA-2022-0038)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has wpa_supplicant packages installed that are
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2022-0038");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2021-27803");
...
ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:wpa_supplicant");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:wpa_supplicant-debuginfo");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'wpa_supplicant-debuginfo-2.6-12.el7_9.2'
  ],
  'CGSL MAIN 5.05': [
    'wpa_supplicant-2.6-12.el7_9.2',
    'wpa_supplicant-debuginfo-2.6-12.el7_9.2'
