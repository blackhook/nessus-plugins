...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : osinfo-db Vulnerability (NS-SA-2023-0026)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has osinfo-db packages installed that are affected
by a vulnerability:
...
"Upgrade the vulnerable CGSL osinfo-db packages. Note that updated packages may not be available yet. Please contact ZTE
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:osinfo-db");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:osinfo-db");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'osinfo-db');
}
