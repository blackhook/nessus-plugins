...
# extracted from ZTE advisory NS-SA-2021-0114. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : openldap Vulnerability (NS-SA-2021-0114)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0114");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-25692");
...
var pkgs = {
  'CGSL CORE 5.04': [
    ...
    'openldap-debuginfo-2.4.44-23.el7_9',
    'openldap-devel-2.4.44-23.el7_9',
    'openldap-servers-2.4.44-23.el7_9',
    'openldap-servers-sql-2.4.44-23.el7_9'
  ],
  'CGSL MAIN 5.04': [
    'openldap-2.4.44-23.el7_9',
    'openldap-clients-2.4.44-23.el7_9',
