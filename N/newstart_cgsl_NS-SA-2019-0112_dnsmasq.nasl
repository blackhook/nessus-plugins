...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : dnsmasq Vulnerability (NS-SA-2019-0112)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has dnsmasq packages installed that are affected by a
vulnerability:
