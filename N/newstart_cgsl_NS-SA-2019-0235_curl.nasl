...
if (description)
{
  ...
  script_bugtraq_id(106379);

  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : curl Vulnerability (NS-SA-2019-0235)");
...
pkgs = {
  "CGSL CORE 5.05": [
    "curl-7.29.0-54.el7",
    "curl-debuginfo-7.29.0-54.el7",
    "libcurl-7.29.0-54.el7",
    "libcurl-devel-7.29.0-54.el7"
  ],
  "CGSL MAIN 5.05": [
    "curl-7.29.0-54.el7",
    "curl-debuginfo-7.29.0-54.el7",
