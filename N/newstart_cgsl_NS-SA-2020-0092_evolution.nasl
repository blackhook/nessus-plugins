...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : evolution Vulnerability (NS-SA-2020-0092)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has evolution packages installed that are affected
by a vulnerability:
...
"Upgrade the vulnerable CGSL evolution packages. Note that updated packages may not be available yet. Please contact ZTE
...
pkgs = {
  'CGSL CORE 5.05': [
    ...
    'evolution-debuginfo-3.28.5-8.el7',
