...
# extracted from ZTE advisory NS-SA-2020-0047. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : firefox Multiple Vulnerabilities (NS-SA-2020-0047)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0047");
...
pkgs = {
  'CGSL MAIN 4.05': [
    'firefox-68.7.0-2.el6.centos',
    'firefox-debuginfo-68.7.0-2.el6.centos'
  ]
};
