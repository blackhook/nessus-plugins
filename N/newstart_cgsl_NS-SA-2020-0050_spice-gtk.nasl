...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : spice-gtk Vulnerability (NS-SA-2020-0050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has spice-gtk packages installed that are affected by a
vulnerability:
...
pkgs = {
  'CGSL MAIN 4.05': [
    ...
    'spice-gtk-debuginfo-0.26-8.el6_10.2',
