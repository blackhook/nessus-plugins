...
if (description)
{
  ...
  script_bugtraq_id(106084, 107008);

  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : firefox Multiple Vulnerabilities (NS-SA-2019-0056)");
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "firefox-debuginfo-60.5.1-1.el7.centos"
  ],
  "CGSL MAIN 5.04": [
    "firefox-60.5.1-1.el7.centos",
    "firefox-debuginfo-60.5.1-1.el7.centos"
