...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : tomcat6 Vulnerability (NS-SA-2020-0048)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has tomcat6 packages installed that are affected by a
vulnerability:
...
pkgs = {
  'CGSL MAIN 4.05': [
    'tomcat6-6.0.24-114.el6_10',
    'tomcat6-admin-webapps-6.0.24-114.el6_10',
    'tomcat6-docs-webapp-6.0.24-114.el6_10',
    'tomcat6-el-2.1-api-6.0.24-114.el6_10',
    'tomcat6-javadoc-6.0.24-114.el6_10',
    'tomcat6-jsp-2.1-api-6.0.24-114.el6_10',
    'tomcat6-lib-6.0.24-114.el6_10',
    'tomcat6-servlet-2.5-api-6.0.24-114.el6_10',
    'tomcat6-webapps-6.0.24-114.el6_10'
  ]
};
