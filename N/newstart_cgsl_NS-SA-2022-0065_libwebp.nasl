...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libwebp Multiple Vulnerabilities (NS-SA-2022-0065)");
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libwebp-debugsource");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libwebp-java-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libwebp-tools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libwebp-tools-debuginfo");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'libwebp-debuginfo-1.0.0-3.el8_4',
    'libwebp-debugsource-1.0.0-3.el8_4',
    'libwebp-devel-1.0.0-3.el8_4',
    'libwebp-java-1.0.0-3.el8_4',
    'libwebp-java-debuginfo-1.0.0-3.el8_4',
    'libwebp-tools-1.0.0-3.el8_4',
    'libwebp-tools-debuginfo-1.0.0-3.el8_4'
  ]
};
