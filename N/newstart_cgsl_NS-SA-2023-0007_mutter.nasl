...
# extracted from ZTE advisory NS-SA-2023-0007. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : mutter Multiple Vulnerabilities (NS-SA-2023-0007)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has mutter packages installed that are affected by
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2023-0007");
...
"Upgrade the vulnerable CGSL mutter packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:mutter");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:mutter-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:mutter-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mutter");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mutter-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mutter-devel");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'mutter-3.28.3-30.el7',
    'mutter-debuginfo-3.28.3-30.el7',
    'mutter-devel-3.28.3-30.el7'
  ],
  'CGSL MAIN 5.05': [
    'mutter-3.28.3-30.el7',
    'mutter-debuginfo-3.28.3-30.el7',
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mutter');
}
