...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : thunderbird Multiple Vulnerabilities (NS-SA-2020-0042)");
...
pkgs = {
  'CGSL CORE 5.04': [
    'thunderbird-68.6.0-1.el7.centos',
    'thunderbird-debuginfo-68.6.0-1.el7.centos'
  ],
  'CGSL MAIN 5.04': [
    'thunderbird-68.6.0-1.el7.centos',
    'thunderbird-debuginfo-68.6.0-1.el7.centos'
