...
# extracted from ZTE advisory NS-SA-2022-0043. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : linuxptp Vulnerability (NS-SA-2022-0043)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has linuxptp packages installed that are affected
by a vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2022-0043");
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:linuxptp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:linuxptp-debuginfo");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'linuxptp-debuginfo-2.0-2.el7_9.1'
  ],
  'CGSL MAIN 5.05': [
    'linuxptp-2.0-2.el7_9.1',
    'linuxptp-debuginfo-2.0-2.el7_9.1'
