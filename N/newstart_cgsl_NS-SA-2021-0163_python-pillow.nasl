...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : python-pillow Vulnerability (NS-SA-2021-0163)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-5313");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'python-pillow-devel-2.0.0-21.gitd1c6db8.el7',
    'python-pillow-doc-2.0.0-21.gitd1c6db8.el7',
    'python-pillow-qt-2.0.0-21.gitd1c6db8.el7',
    'python-pillow-sane-2.0.0-21.gitd1c6db8.el7',
    'python-pillow-tk-2.0.0-21.gitd1c6db8.el7'
  ],
  'CGSL MAIN 5.05': [
    'python-pillow-2.0.0-21.gitd1c6db8.el7',
    'python-pillow-devel-2.0.0-21.gitd1c6db8.el7',
