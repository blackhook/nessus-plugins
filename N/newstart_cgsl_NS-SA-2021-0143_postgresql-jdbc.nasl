...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : postgresql-jdbc Vulnerability (NS-SA-2021-0143)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has postgresql-jdbc packages installed that are
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-13692");
...
contact ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:postgresql-jdbc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:postgresql-jdbc-javadoc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:postgresql-jdbc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:postgresql-jdbc-javadoc");
