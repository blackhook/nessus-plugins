...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : libssh2 Vulnerability (NS-SA-2019-0172)");
...
by a vulnerability:
  ...
  - An out of bounds read flaw was discovered in libssh2
    ...
    with an exit status message and no payload are parsed. A
    remote attacker who compromises a SSH server may be able
    to cause a Denial of Service or read data in the client
...
pkgs = {
  "CGSL CORE 5.05": [
    ...
    "libssh2-debuginfo-1.4.3-12.el7_6.3",
    "libssh2-devel-1.4.3-12.el7_6.3",
    "libssh2-docs-1.4.3-12.el7_6.3"
  ],
  "CGSL MAIN 5.05": [
    "libssh2-1.4.3-12.el7_6.3",
    "libssh2-debuginfo-1.4.3-12.el7_6.3",
