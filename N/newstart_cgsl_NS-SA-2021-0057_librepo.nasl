...
# extracted from ZTE advisory NS-SA-2021-0057. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : librepo Vulnerability (NS-SA-2021-0057)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has librepo packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0057");
...
pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'librepo-debuginfo-1.11.0-3.el8_2',
    'librepo-debugsource-1.11.0-3.el8_2',
    'librepo-devel-1.11.0-3.el8_2',
    'python3-librepo-1.11.0-3.el8_2',
    'python3-librepo-debuginfo-1.11.0-3.el8_2'
  ]
};
