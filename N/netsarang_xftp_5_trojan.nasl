...
if (description)
{
  ...
  script_name(english: "NetSarang Xftp 5 Backdoor Trojan (ShadowPad)");
  script_summary(english:"Checks the Xftp 5 install for a trojaned nssock2.dll file.");

  script_set_attribute(attribute:"synopsis", value:
"The remote host contains an application that is affected by a trojan
backdoor.");
  script_set_attribute(attribute:"description", value:
"The Xftp 5, an FTP client for Windows, installed on the remote host
has a nssock2.dll file identified by its MD5 hash that is infected
...
path = get_registry_value(
  handle:hklm,
  item:"SOFTWARE\NetSarang\Xftp\5\Path"
);
