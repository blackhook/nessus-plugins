...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.01 : mod_auth_mellon Vulnerability (NS-SA-2020-0034)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.01, has mod_auth_mellon packages installed that are affected by a
vulnerability:

  - mod_auth_mellon through 0.14.2 has an Open Redirect via
    the login?ReturnTo= substring, as demonstrated by
    omitting the // after http: in the target URL.
    (CVE-2019-13038)
...
pkgs = {
  "CGSL MAIN 6.01": [
    ...
    "mod_auth_mellon-debuginfo-0.14.0-11.el8",
    "mod_auth_mellon-debugsource-0.14.0-11.el8",
    "mod_auth_mellon-diagnostics-0.14.0-11.el8",
    "mod_auth_mellon-diagnostics-debuginfo-0.14.0-11.el8"
  ]
};
