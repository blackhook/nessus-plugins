...
# extracted from ZTE advisory NS-SA-2019-0206. The text
...
if (description)
{
  ...
  script_bugtraq_id(105758, 107174);
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : openssl Multiple Vulnerabilities (NS-SA-2019-0206)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0206");
...
pkgs = {
  "CGSL CORE 5.04": [
    "openssl-1.0.2k-19.el7.cgslv5.0.1.g72bc563.lite",
    "openssl-crypto-1.0.2k-19.el7.cgslv5.0.1.g72bc563.lite",
    "openssl-debuginfo-1.0.2k-19.el7.cgslv5.0.1.g72bc563.lite",
    "openssl-devel-1.0.2k-19.el7.cgslv5.0.1.g72bc563.lite",
    "openssl-libs-1.0.2k-19.el7.cgslv5.0.1.g72bc563.lite",
    "openssl-perl-1.0.2k-19.el7.cgslv5.0.1.g72bc563.lite",
    "openssl-static-1.0.2k-19.el7.cgslv5.0.1.g72bc563.lite"
  ],
  "CGSL MAIN 5.04": [
    "openssl-1.0.2k-19.el7.cgslv5",
    "openssl-debuginfo-1.0.2k-19.el7.cgslv5",
    "openssl-devel-1.0.2k-19.el7.cgslv5",
    "openssl-libs-1.0.2k-19.el7.cgslv5",
    "openssl-perl-1.0.2k-19.el7.cgslv5",
    "openssl-static-1.0.2k-19.el7.cgslv5"
  ]
};
