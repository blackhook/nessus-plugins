...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : wpa_supplicant Vulnerability (NS-SA-2021-0128)");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'wpa_supplicant-debuginfo-2.9-2.el8_3.1',
    'wpa_supplicant-debugsource-2.9-2.el8_3.1'
  ]
};
