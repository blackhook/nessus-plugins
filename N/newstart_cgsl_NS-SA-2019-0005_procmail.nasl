...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 5.04 : procmail Vulnerability (NS-SA-2019-0005)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 5.04, has procmail packages installed that are affected by a
vulnerability:

  - A heap-based buffer overflow flaw was found in
    procmail's formail utility. A remote attacker could send
    a specially crafted email that, when processed by
    formail, could cause formail to crash or, possibly,
...
"Upgrade the vulnerable CGSL procmail packages. Note that updated packages may not be available yet. Please contact ZTE
