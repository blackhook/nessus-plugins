...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : libvorbis Vulnerability (NS-SA-2019-0026)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has libvorbis packages installed that are affected
by a vulnerability:
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "libvorbis-debuginfo-1.3.3-8.el7.1",
