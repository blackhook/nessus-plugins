...
service or local network scanning.");
  # https://www.sec-consult.com/files/20090305-0_echo_nextapp_xml_injection.txt
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d492d37e");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2009/Mar/96");
  script_set_attribute(attribute:"see_also", value:"http://echo.nextapp.com/site/node/5742");
