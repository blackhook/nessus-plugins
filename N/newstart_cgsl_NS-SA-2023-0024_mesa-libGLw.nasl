...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : mesa-libGLw Multiple Vulnerabilities (NS-SA-2023-0024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has mesa-libGLw packages installed that are
...
"Upgrade the vulnerable CGSL mesa-libGLw packages. Note that updated packages may not be available yet. Please contact
ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:mesa-libGLw");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:mesa-libGLw-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:mesa-libGLw-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mesa-libGLw");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mesa-libGLw-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:mesa-libGLw-devel");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'mesa-libGLw-debuginfo-8.0.0-5.el7',
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'mesa-libGLw');
}
