...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : ipmitool Vulnerability (NS-SA-2020-0077)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has ipmitool packages installed that are affected
by a vulnerability:
...
pkgs = {
  'CGSL CORE 5.04': [
    'bmc-snmp-proxy-1.8.18-9.el7_7',
    'exchange-bmc-os-info-1.8.18-9.el7_7',
    'ipmitool-1.8.18-9.el7_7',
    'ipmitool-debuginfo-1.8.18-9.el7_7'
  ],
  'CGSL MAIN 5.04': [
    'bmc-snmp-proxy-1.8.18-9.el7_7',
    'exchange-bmc-os-info-1.8.18-9.el7_7',
