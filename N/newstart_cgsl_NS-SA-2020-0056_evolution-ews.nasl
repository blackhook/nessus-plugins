...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : evolution-ews Vulnerability (NS-SA-2020-0056)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has evolution-ews packages installed that are
...
"Upgrade the vulnerable CGSL evolution-ews packages. Note that updated packages may not be available yet. Please contact
...
pkgs = {
  'CGSL CORE 5.04': [
    ...
    'evolution-ews-debuginfo-3.28.5-5.el7',
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'evolution-ews');
}
