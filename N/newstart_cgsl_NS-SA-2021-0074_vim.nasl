...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : vim Vulnerability (NS-SA-2021-0074)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has vim packages installed that are affected by a
vulnerability:
...
pkgs = {
  'CGSL MAIN 6.02': [
    'vim-X11-8.0.1763-15.el8',
    'vim-X11-debuginfo-8.0.1763-15.el8',
    'vim-common-8.0.1763-15.el8',
    'vim-common-debuginfo-8.0.1763-15.el8',
    'vim-debuginfo-8.0.1763-15.el8',
    'vim-debugsource-8.0.1763-15.el8',
    'vim-enhanced-8.0.1763-15.el8',
    'vim-enhanced-debuginfo-8.0.1763-15.el8',
    'vim-filesystem-8.0.1763-15.el8',
    'vim-minimal-8.0.1763-15.el8',
    'vim-minimal-debuginfo-8.0.1763-15.el8'
  ]
};
