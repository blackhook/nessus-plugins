...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : java-1.7.0-openjdk Multiple Vulnerabilities (NS-SA-2019-0142)");
...
pkgs = {
  "CGSL MAIN 4.05": [
    ...
    "java-1.7.0-openjdk-debuginfo-1.7.0.201-2.6.16.0.el6_10",
