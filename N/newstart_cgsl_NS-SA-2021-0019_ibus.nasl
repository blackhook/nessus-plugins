...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : ibus Vulnerability (NS-SA-2021-0019)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has ibus packages installed that are affected by a
vulnerability:
...
pkgs = {
  'CGSL CORE 5.04': [
    ...
    'ibus-debuginfo-1.5.17-12.el7_9',
