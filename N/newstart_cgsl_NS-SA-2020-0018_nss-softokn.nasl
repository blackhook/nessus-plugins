...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : nss-softokn Vulnerability (NS-SA-2020-0018)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has nss-softokn packages installed that are affected by a
vulnerability:
...
"Upgrade the vulnerable CGSL nss-softokn packages. Note that updated packages may not be available yet. Please contact
...
pkgs = {
  "CGSL MAIN 4.05": [
    ...
    "nss-softokn-debuginfo-3.44.0-6.el6_10",
