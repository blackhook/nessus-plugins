...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : spice Vulnerability (NS-SA-2021-0040)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has spice packages installed that are affected by
a vulnerability:
...
pkgs = {
  'CGSL MAIN 5.04': [
    'spice-server-0.14.0-9.el7_9.1',
    'spice-server-devel-0.14.0-9.el7_9.1'
  ]
};
