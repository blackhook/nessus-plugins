...
# extracted from ZTE advisory NS-SA-2020-0053. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : icu Vulnerability (NS-SA-2020-0053)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has icu packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0053");
  script_set_attribute(attribute:"solution", value:
"Upgrade the vulnerable CGSL icu packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
...
pkgs = {
  'CGSL MAIN 4.05': [
    'icu-4.2.1-15.el6_10',
    'icu-debuginfo-4.2.1-15.el6_10',
    'libicu-4.2.1-15.el6_10',
    'libicu-devel-4.2.1-15.el6_10',
    'libicu-doc-4.2.1-15.el6_10'
  ]
};
