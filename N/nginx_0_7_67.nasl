...
if (description)
{
  ...
  script_cve_id("CVE-2010-2266");

  script_name(english:"nginx < 0.7.67 / 0.8.x < 0.8.41 DoS");
...
version of nginx hosted on the remote web server is less than 0.7.67
or 0.8.x prior to 0.8.41. It is, therefore, affected by a remote
denial of service (DoS) vulnerability as noted in the vendor advisory.");
  script_set_attribute(attribute:"see_also", value:"http://nginx.org/en/security_advisories.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to nginx version 0.7.67 / 0.8.41 or later.");
  script_set_attribute(attribute:"agent", value:"unix");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:L");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-2266");
...
constraints = [
  ...
  {'fixed_version' : '0.8.41', 'min_version' : '0.8.0'}
];
