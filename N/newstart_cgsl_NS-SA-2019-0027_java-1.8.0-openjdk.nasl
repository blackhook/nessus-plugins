...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : java-1.8.0-openjdk Multiple Vulnerabilities (NS-SA-2019-0027)");
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "java-1.8.0-openjdk-debuginfo-1.8.0.181-3.b13.el7_5",
