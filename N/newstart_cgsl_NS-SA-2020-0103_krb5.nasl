...
if (description)
{
  ...
  script_bugtraq_id(106334);

  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : krb5 Vulnerability (NS-SA-2020-0103)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has krb5 packages installed that are affected by a
vulnerability:
...
pkgs = {
  'CGSL CORE 5.05': [
    'krb5-debuginfo-1.15.1-37.el7_7.2',
