...
# extracted from ZTE advisory NS-SA-2021-0106. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2020-8625", "CVE-2021-25215");
  script_xref(name:"IAVA", value:"2021-A-0101-S");
  script_xref(name:"IAVA", value:"2021-A-0206-S");

  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : bind Multiple Vulnerabilities (NS-SA-2021-0106)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0106");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-8625");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2021-25215");
...
var pkgs = {
  'CGSL CORE 5.04': [
    'bind-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-chroot-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-debuginfo-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-devel-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-export-devel-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-export-libs-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-libs-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-libs-lite-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-license-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-lite-devel-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-pkcs11-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-pkcs11-devel-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-pkcs11-libs-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-pkcs11-utils-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-sdb-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-sdb-chroot-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-utils-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133'
  ],
  'CGSL MAIN 5.04': [
    'bind-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
    'bind-chroot-9.11.4-26.P2.el7_9.5.cgslv5.0.3.gc060133',
