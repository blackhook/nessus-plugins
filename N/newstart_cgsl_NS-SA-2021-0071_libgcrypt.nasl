...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libgcrypt Vulnerability (NS-SA-2021-0071)");
...
pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'libgcrypt-debuginfo-1.8.5-4.el8',
    'libgcrypt-debugsource-1.8.5-4.el8',
    'libgcrypt-devel-1.8.5-4.el8',
    'libgcrypt-devel-debuginfo-1.8.5-4.el8'
  ]
};
