...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : thunderbird Multiple Vulnerabilities (NS-SA-2019-0062)");
...
pkgs = {
  "CGSL CORE 5.04": [
    "thunderbird-60.6.1-1.el7.centos",
    "thunderbird-debuginfo-60.6.1-1.el7.centos"
  ],
  "CGSL MAIN 5.04": [
    "thunderbird-60.6.1-1.el7.centos",
    "thunderbird-debuginfo-60.6.1-1.el7.centos"
