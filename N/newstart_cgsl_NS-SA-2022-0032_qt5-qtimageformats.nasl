...
# extracted from ZTE advisory NS-SA-2022-0032. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : qt5-qtimageformats Multiple Vulnerabilities (NS-SA-2022-0032)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2022-0032");
...
contact ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:qt5-qtimageformats");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:qt5-qtimageformats-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:qt5-qtimageformats-doc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:qt5-qtimageformats");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:qt5-qtimageformats-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:qt5-qtimageformats-doc");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'qt5-qtimageformats-5.9.7-2.el7_9',
    'qt5-qtimageformats-debuginfo-5.9.7-2.el7_9',
    'qt5-qtimageformats-doc-5.9.7-2.el7_9'
  ],
  'CGSL MAIN 5.05': [
    'qt5-qtimageformats-5.9.7-2.el7_9',
    'qt5-qtimageformats-debuginfo-5.9.7-2.el7_9',
