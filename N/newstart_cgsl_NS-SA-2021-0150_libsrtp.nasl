...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : libsrtp Multiple Vulnerabilities (NS-SA-2021-0150)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has libsrtp packages installed that are affected
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2013-2139");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2015-6360");
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:libsrtp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:libsrtp-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libsrtp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libsrtp-devel");
