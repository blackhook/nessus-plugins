...
and delete arbitrary files on the affected system.");
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-14-296/");
  script_set_attribute(attribute:"see_also", value:"https://support.microfocus.com/kb/doc.php?id=7015566");
...
"Upgrade to GroupWise 2014 SP1 or higher.");
  ...
  script_require_keys("installed_sw/Novell GroupWise Admin Console");
