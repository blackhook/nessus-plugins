...
Note that exploitation requires that an attacker to be authenticated."
  ...
  # https://www.nccgroup.trust/en/learning-research-centre/security-testing-audit-compliance-resources/technical-advisories/nagios-xi-network-monitor-blind-sql-injection/#.ULkcoeSE36U
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?017d663e");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2012/Jul/10");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2012/Nov/116");
