...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : gcab Vulnerability (NS-SA-2019-0020)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has gcab packages installed that are affected by a
vulnerability:
  ...
  - A stack-based buffer overflow within GNOME gcab through
    ...
    crafted .cab file. (CVE-2018-5345)
...
"Upgrade the vulnerable CGSL gcab packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
