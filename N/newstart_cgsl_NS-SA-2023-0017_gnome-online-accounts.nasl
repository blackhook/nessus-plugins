...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : gnome-online-accounts Vulnerability (NS-SA-2023-0017)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has gnome-online-accounts packages installed that
...
"Upgrade the vulnerable CGSL gnome-online-accounts packages. Note that updated packages may not be available yet. Please
contact ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:gnome-online-accounts");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:gnome-online-accounts-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:gnome-online-accounts-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:gnome-online-accounts");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:gnome-online-accounts-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:gnome-online-accounts-devel");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'gnome-online-accounts-debuginfo-3.28.2-1.el7',
    'gnome-online-accounts-devel-3.28.2-1.el7'
  ],
  'CGSL MAIN 5.05': [
    'gnome-online-accounts-3.28.2-1.el7',
    'gnome-online-accounts-debuginfo-3.28.2-1.el7',
