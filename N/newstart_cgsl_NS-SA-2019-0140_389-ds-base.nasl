...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : 389-ds-base Vulnerability (NS-SA-2019-0140)");
...
pkgs = {
  "CGSL MAIN 4.05": [
    "389-ds-base-1.2.11.15-97.el6_10",
    "389-ds-base-debuginfo-1.2.11.15-97.el6_10",
    "389-ds-base-devel-1.2.11.15-97.el6_10",
    "389-ds-base-libs-1.2.11.15-97.el6_10"
  ]
};
