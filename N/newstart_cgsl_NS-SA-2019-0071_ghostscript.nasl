...
if (description)
{
  ...
  script_bugtraq_id(107520, 107855);

  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : ghostscript Multiple Vulnerabilities (NS-SA-2019-0071)");
...
affected by multiple vulnerabilities:
  ...
  - It was found that the forceput operator could be
    ...
    crafted PostScript file could use this flaw in order to,
    for example, have access to the file system outside of
    the constrains imposed by -dSAFER. (CVE-2019-3838)
