...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : gd Multiple Vulnerabilities (NS-SA-2021-0066)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has gd packages installed that are affected by multiple
vulnerabilities:
...
pkgs = {
  'CGSL MAIN 6.02': [
    'gd-2.2.5-7.el8',
    'gd-debuginfo-2.2.5-7.el8',
    'gd-debugsource-2.2.5-7.el8',
    'gd-devel-2.2.5-7.el8',
    'gd-progs-2.2.5-7.el8',
    'gd-progs-debuginfo-2.2.5-7.el8'
  ]
};
