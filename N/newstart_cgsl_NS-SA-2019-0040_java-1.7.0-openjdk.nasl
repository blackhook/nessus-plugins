...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : java-1.7.0-openjdk Multiple Vulnerabilities (NS-SA-2019-0040)");
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "java-1.7.0-openjdk-accessibility-1.7.0.201-2.6.16.1.el7_6",
    "java-1.7.0-openjdk-debuginfo-1.7.0.201-2.6.16.1.el7_6",
    "java-1.7.0-openjdk-demo-1.7.0.201-2.6.16.1.el7_6",
    "java-1.7.0-openjdk-devel-1.7.0.201-2.6.16.1.el7_6",
    "java-1.7.0-openjdk-headless-1.7.0.201-2.6.16.1.el7_6",
    "java-1.7.0-openjdk-javadoc-1.7.0.201-2.6.16.1.el7_6",
    "java-1.7.0-openjdk-src-1.7.0.201-2.6.16.1.el7_6"
  ],
  "CGSL MAIN 5.04": [
    "java-1.7.0-openjdk-1.7.0.201-2.6.16.1.el7_6",
    "java-1.7.0-openjdk-accessibility-1.7.0.201-2.6.16.1.el7_6",
