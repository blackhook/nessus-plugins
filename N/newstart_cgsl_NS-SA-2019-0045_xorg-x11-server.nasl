...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : xorg-x11-server Vulnerability (NS-SA-2019-0045)");
...
affected by a vulnerability:
  ...
  - An incorrect permission check for -modulepath and
    ...
    system via physical console to escalate their privileges
...
pkgs = {
  "CGSL CORE 5.04": [
    "xorg-x11-server-Xdmx-1.20.1-5.1.el7",
    "xorg-x11-server-Xephyr-1.20.1-5.1.el7",
    "xorg-x11-server-Xnest-1.20.1-5.1.el7",
    "xorg-x11-server-Xorg-1.20.1-5.1.el7",
    "xorg-x11-server-Xvfb-1.20.1-5.1.el7",
    "xorg-x11-server-Xwayland-1.20.1-5.1.el7",
    "xorg-x11-server-common-1.20.1-5.1.el7",
    "xorg-x11-server-debuginfo-1.20.1-5.1.el7",
    "xorg-x11-server-devel-1.20.1-5.1.el7",
    "xorg-x11-server-source-1.20.1-5.1.el7"
  ],
  "CGSL MAIN 5.04": [
    "xorg-x11-server-Xdmx-1.20.1-5.1.el7",
    "xorg-x11-server-Xephyr-1.20.1-5.1.el7",
