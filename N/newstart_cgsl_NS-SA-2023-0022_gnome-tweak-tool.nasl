...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : gnome-tweak-tool Vulnerability (NS-SA-2023-0022)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has gnome-tweak-tool packages installed that are
...
"Upgrade the vulnerable CGSL gnome-tweak-tool packages. Note that updated packages may not be available yet. Please
contact ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:gnome-tweak-tool");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:gnome-tweak-tool");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gnome-tweak-tool');
}
