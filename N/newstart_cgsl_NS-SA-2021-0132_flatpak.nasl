...
# extracted from ZTE advisory NS-SA-2021-0132. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : flatpak Vulnerability (NS-SA-2021-0132)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has flatpak packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0132");
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:flatpak-debugsource");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:flatpak-libs-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:flatpak-selinux");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:flatpak-session-helper");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:flatpak-session-helper-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:flatpak-tests");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:flatpak-tests-debuginfo");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'flatpak-debuginfo-1.6.2-6.el8_3',
    'flatpak-debugsource-1.6.2-6.el8_3',
    'flatpak-devel-1.6.2-6.el8_3',
    'flatpak-libs-1.6.2-6.el8_3',
    'flatpak-libs-debuginfo-1.6.2-6.el8_3',
    'flatpak-selinux-1.6.2-6.el8_3',
    'flatpak-session-helper-1.6.2-6.el8_3',
    'flatpak-session-helper-debuginfo-1.6.2-6.el8_3',
    'flatpak-tests-1.6.2-6.el8_3',
    'flatpak-tests-debuginfo-1.6.2-6.el8_3'
  ]
};
