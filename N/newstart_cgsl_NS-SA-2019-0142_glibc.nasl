...
# extracted from ZTE advisory NS-SA-2019-0142. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : glibc Multiple Vulnerabilities (NS-SA-2019-0142)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0142");
...
pkgs = {
  "CGSL MAIN 4.05": [
    ...
    "glibc-debuginfo-2.12-1.212.el6",
    "glibc-debuginfo-common-2.12-1.212.el6",
    "glibc-devel-2.12-1.212.el6",
    "glibc-headers-2.12-1.212.el6",
    "glibc-static-2.12-1.212.el6",
    "glibc-utils-2.12-1.212.el6",
    "nscd-2.12-1.212.el6"
  ]
};
