...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : libsndfile Vulnerability (NS-SA-2020-0107)");
...
pkgs = {
  'CGSL CORE 5.05': [
    ...
    'libsndfile-debuginfo-1.0.25-11.el7',
    'libsndfile-devel-1.0.25-11.el7',
    'libsndfile-utils-1.0.25-11.el7'
  ],
  'CGSL MAIN 5.05': [
    'libsndfile-1.0.25-11.el7',
    'libsndfile-debuginfo-1.0.25-11.el7',
