...
if (description)
{
 ...
 script_cvs_date("Date: 2018/11/15 20:50:27");
  ...
  script_cve_id("CVE-2007-5057");
  script_bugtraq_id(25761);

  script_name(english:"NetSupport Manager Client Spoofing Remote Authentication Bypass");
...
control of the affected system.");
 script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/480240/30/0/threaded");
 script_set_attribute(attribute:"see_also", value:"http://www.netsupportsoftware.com/support/td.asp?td=543" );
 script_set_attribute(attribute:"solution", value:"Upgrade to NetSupport Manager version 10.20.0004 or later.");
