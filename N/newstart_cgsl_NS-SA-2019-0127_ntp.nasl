...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : ntp Multiple Vulnerabilities (NS-SA-2019-0127)");
...
pkgs = {
  "CGSL MAIN 4.05": [
    "ntp-4.2.6p5-12.el6.centos.2",
    "ntp-debuginfo-4.2.6p5-12.el6.centos.2",
    "ntp-doc-4.2.6p5-12.el6.centos.2",
    "ntp-perl-4.2.6p5-12.el6.centos.2",
    "ntpdate-4.2.6p5-12.el6.centos.2"
  ]
};
