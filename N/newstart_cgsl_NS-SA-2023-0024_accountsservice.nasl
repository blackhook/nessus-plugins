...
# extracted from ZTE advisory NS-SA-2023-0024. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : accountsservice Multiple Vulnerabilities (NS-SA-2023-0024)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has accountsservice packages installed that are
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2023-0024");
...
"Upgrade the vulnerable CGSL accountsservice packages. Note that updated packages may not be available yet. Please
contact ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:accountsservice");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:accountsservice-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:accountsservice-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:accountsservice-libs");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:accountsservice");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:accountsservice-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:accountsservice-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:accountsservice-libs");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'accountsservice-debuginfo-0.6.50-7.el7',
    'accountsservice-devel-0.6.50-7.el7',
