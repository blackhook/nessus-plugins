...
# extracted from ZTE advisory NS-SA-2019-0002. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 5.04 : curl Vulnerability (NS-SA-2019-0002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 5.04, has curl packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0002");
...
pkgs = {
  "CGSL MAIN 5.04": [
    "curl-7.29.0-42.el7_4.1",
    "curl-debuginfo-7.29.0-42.el7_4.1",
    "libcurl-7.29.0-42.el7_4.1",
    "libcurl-devel-7.29.0-42.el7_4.1"
  ]
};
