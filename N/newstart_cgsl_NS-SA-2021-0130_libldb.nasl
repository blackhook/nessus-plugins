...
# extracted from ZTE advisory NS-SA-2021-0130. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libldb Vulnerability (NS-SA-2021-0130)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libldb packages installed that are affected by a
vulnerability:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0130");
...
more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:ldb-tools-debuginfo");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:libldb-debugsource");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:python3-ldb-debuginfo");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'ldb-tools-2.1.3-3.el8_3',
    'ldb-tools-debuginfo-2.1.3-3.el8_3',
    'libldb-2.1.3-3.el8_3',
    'libldb-debuginfo-2.1.3-3.el8_3',
    'libldb-debugsource-2.1.3-3.el8_3',
    'libldb-devel-2.1.3-3.el8_3',
    'python3-ldb-2.1.3-3.el8_3',
    'python3-ldb-debuginfo-2.1.3-3.el8_3',
    'python3-ldb-devel-2.1.3-3.el8_3'
  ]
};
