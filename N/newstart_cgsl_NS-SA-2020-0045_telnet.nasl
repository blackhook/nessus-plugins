...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : telnet Vulnerability (NS-SA-2020-0045)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has telnet packages installed that are affected by a
vulnerability:
...
"Upgrade the vulnerable CGSL telnet packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
...
pkgs = {
  'CGSL MAIN 4.05': [
    'telnet-0.17-49.el6_10',
    'telnet-debuginfo-0.17-49.el6_10',
    'telnet-server-0.17-49.el6_10'
  ]
};
