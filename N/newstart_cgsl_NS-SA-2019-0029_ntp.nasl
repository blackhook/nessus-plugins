...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : ntp Multiple Vulnerabilities (NS-SA-2019-0029)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has ntp packages installed that are affected by
...
pkgs = {
  "CGSL CORE 5.04": [
    "ntp-4.2.6p5-28.el7.centos",
    "ntp-debuginfo-4.2.6p5-28.el7.centos",
    "ntp-doc-4.2.6p5-28.el7.centos",
    "ntp-perl-4.2.6p5-28.el7.centos",
    "ntpdate-4.2.6p5-28.el7.centos",
    "sntp-4.2.6p5-28.el7.centos"
  ],
  "CGSL MAIN 5.04": [
    "ntp-4.2.6p5-28.el7.centos",
    "ntp-debuginfo-4.2.6p5-28.el7.centos",
