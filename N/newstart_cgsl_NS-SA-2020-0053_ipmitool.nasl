...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : ipmitool Vulnerability (NS-SA-2020-0053)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has ipmitool packages installed that are affected by a
vulnerability:
...
"Upgrade the vulnerable CGSL ipmitool packages. Note that updated packages may not be available yet. Please contact ZTE
...
pkgs = {
  'CGSL MAIN 4.05': [
    'ipmitool-1.8.15-3.el6_10',
    'ipmitool-debuginfo-1.8.15-3.el6_10'
  ]
};
