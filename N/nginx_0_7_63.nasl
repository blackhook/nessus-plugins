...
if (description)
{
  ...
  script_name(english:"nginx < 0.7.63 / 0.8.x < 0.8.17 Directory Traversal");
...
version of nginx hosted on the remote web server is less than 0.7.63
or 0.8.x prior to 0.8.17. It is, therefore, affected by a directory
traversal vulnerability as noted in the vendor advisory.");
...
"Upgrade to nginx version 0.7.63 / 0.8.17 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2009-3898");
...
constraints = [
  ...
  {'fixed_version' : '0.8.17', 'min_version' : '0.8.0'}
];
