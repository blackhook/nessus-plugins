...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : keepalived Vulnerability (NS-SA-2019-0051)");
...
affected by a vulnerability:
  ...
  - Heap-based buffer overflow vulnerability in
    extract_status_code() function in lib/html.c that parses
    HTTP status code returned from web server allows
