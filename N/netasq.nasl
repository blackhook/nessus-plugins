...
You should not let them know such information." );
 script_set_attribute(attribute:"see_also", value:"http://www.netasq.com/landing/netasq-en.html" );
...
script_set_attribute(attribute:"cpe", value:"x-cpe:/h:netasq:ips_firewall");
