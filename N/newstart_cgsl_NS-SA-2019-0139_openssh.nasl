...
# extracted from ZTE advisory NS-SA-2019-0139. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : openssh Multiple Vulnerabilities (NS-SA-2019-0139)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has openssh packages installed that are affected by multiple
vulnerabilities:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2019-0139");
...
pkgs = {
  "CGSL MAIN 4.05": [
    "openssh-5.3p1-123.el6_9.cgsl7731",
    "openssh-askpass-5.3p1-123.el6_9.cgsl7731",
    "openssh-clients-5.3p1-123.el6_9.cgsl7731",
    "openssh-debuginfo-5.3p1-123.el6_9.cgsl7731",
    "openssh-ldap-5.3p1-123.el6_9.cgsl7731",
    "openssh-server-5.3p1-123.el6_9.cgsl7731",
    "pam_ssh_agent_auth-0.9.3-123.el6_9.cgsl7731"
  ]
};
