...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : libtirpc Vulnerability (NS-SA-2019-0106)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has libtirpc packages installed that are affected by a
vulnerability:
...
"Upgrade the vulnerable CGSL libtirpc packages. Note that updated packages may not be available yet. Please contact ZTE
