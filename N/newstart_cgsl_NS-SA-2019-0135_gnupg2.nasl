...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : gnupg2 Vulnerability (NS-SA-2019-0135)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has gnupg2 packages installed that are affected by a
vulnerability:
...
pkgs = {
  "CGSL MAIN 4.05": [
    ...
    "gnupg2-debuginfo-2.0.14-9.el6_10",
    "gnupg2-smime-2.0.14-9.el6_10"
  ]
};
