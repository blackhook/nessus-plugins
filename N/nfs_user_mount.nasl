...
if (description)
{
 script_id(15984);
 script_version("1.14");
 script_cvs_date("Date: 2018/08/01 14:54:45");
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 2003-2018 Renaud Deraison (modified 2004 Michael Stone)");
 script_family(english:"RPC");

 script_dependencies("rpc_portmap.nasl", "showmount.nasl", "nfs_mount.nasl");
