...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : cryptsetup Vulnerability (NS-SA-2021-0087)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has cryptsetup packages installed that are affected by a
vulnerability:
...
"Upgrade the vulnerable CGSL cryptsetup packages. Note that updated packages may not be available yet. Please contact ZTE
...
pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'cryptsetup-debuginfo-2.3.3-2.el8',
    'cryptsetup-debugsource-2.3.3-2.el8',
    'cryptsetup-devel-2.3.3-2.el8',
    'cryptsetup-libs-2.3.3-2.el8',
    'cryptsetup-libs-debuginfo-2.3.3-2.el8',
    'cryptsetup-reencrypt-2.3.3-2.el8',
    'cryptsetup-reencrypt-debuginfo-2.3.3-2.el8',
    'integritysetup-2.3.3-2.el8',
    'integritysetup-debuginfo-2.3.3-2.el8',
    'veritysetup-2.3.3-2.el8',
    'veritysetup-debuginfo-2.3.3-2.el8'
  ]
};
