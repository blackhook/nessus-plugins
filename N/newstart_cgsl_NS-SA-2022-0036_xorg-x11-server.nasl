...
# extracted from ZTE advisory NS-SA-2022-0036. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : xorg-x11-server Vulnerability (NS-SA-2022-0036)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2022-0036");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2021-3472");
...
contact ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:xorg-x11-server-debuginfo");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'xorg-x11-server-Xdmx-1.20.4-16.el7_9',
    'xorg-x11-server-Xephyr-1.20.4-16.el7_9',
    'xorg-x11-server-Xnest-1.20.4-16.el7_9',
    'xorg-x11-server-Xorg-1.20.4-16.el7_9',
    'xorg-x11-server-Xvfb-1.20.4-16.el7_9',
    'xorg-x11-server-Xwayland-1.20.4-16.el7_9',
    'xorg-x11-server-common-1.20.4-16.el7_9',
    'xorg-x11-server-debuginfo-1.20.4-16.el7_9',
    'xorg-x11-server-devel-1.20.4-16.el7_9',
    'xorg-x11-server-source-1.20.4-16.el7_9'
  ],
  'CGSL MAIN 5.05': [
    'xorg-x11-server-Xdmx-1.20.4-16.el7_9',
    'xorg-x11-server-Xephyr-1.20.4-16.el7_9',
