...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : glusterfs Vulnerability (NS-SA-2019-0064)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has glusterfs packages installed that are affected
by a vulnerability:
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "glusterfs-debuginfo-3.12.2-18.el7",
