...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : docker-ce Vulnerability (NS-SA-2021-0181)");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'docker-ce-17.03.3-1.el7.2103050614git20db173',
    'docker-ce-debuginfo-17.03.3-1.el7.2103050614git20db173'
  ],
  'CGSL MAIN 5.05': [
    'docker-ce-17.03.3-1.el7.2103050614git20db173',
    'docker-ce-debuginfo-17.03.3-1.el7.2103050614git20db173'
