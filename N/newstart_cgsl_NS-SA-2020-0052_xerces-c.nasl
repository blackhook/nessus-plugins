...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : xerces-c Vulnerability (NS-SA-2020-0052)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 4.05, has xerces-c packages installed that are affected by a
vulnerability:

  - The Apache Xerces-C 3.0.0 to 3.2.2 XML parser contains a use-after-free error triggered during the
...
pkgs = {
  'CGSL MAIN 4.05': [
    'xerces-c-3.0.1-21.el6_10',
    'xerces-c-debuginfo-3.0.1-21.el6_10',
    'xerces-c-devel-3.0.1-21.el6_10',
    'xerces-c-doc-3.0.1-21.el6_10'
  ]
};
