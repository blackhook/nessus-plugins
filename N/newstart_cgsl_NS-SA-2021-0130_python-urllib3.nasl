...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : python-urllib3 Vulnerability (NS-SA-2021-0130)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has python-urllib3 packages installed that are affected by a
vulnerability:
...
ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:python3-urllib3");
