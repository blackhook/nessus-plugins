...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : tigervnc Vulnerability (NS-SA-2022-0084)");

  script_set_attribute(attribute:"synopsis", value:
"The remote NewStart CGSL host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has tigervnc packages installed that are affected by a
vulnerability:
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-26117");
...
for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_main:tigervnc-selinux");
...
var pkgs = {
  'CGSL MAIN 6.02': [
    'tigervnc-license-1.11.0-9.el8',
    'tigervnc-selinux-1.11.0-9.el8',
    'tigervnc-server-1.11.0-9.el8',
    'tigervnc-server-minimal-1.11.0-9.el8'
  ]
};
