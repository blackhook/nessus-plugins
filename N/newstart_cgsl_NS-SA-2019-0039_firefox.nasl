...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : firefox Multiple Vulnerabilities (NS-SA-2019-0039)");
...
pkgs = {
  "CGSL CORE 5.04": [
    "firefox-60.4.0-1.el7.centos.0.1",
    "firefox-debuginfo-60.4.0-1.el7.centos.0.1"
  ],
  "CGSL MAIN 5.04": [
    "firefox-60.4.0-1.el7.centos.0.1",
    "firefox-debuginfo-60.4.0-1.el7.centos.0.1"
