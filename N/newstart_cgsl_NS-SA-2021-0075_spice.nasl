...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : spice Vulnerability (NS-SA-2021-0075)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has spice packages installed that are affected by a
vulnerability:
...
"Upgrade the vulnerable CGSL spice packages. Note that updated packages may not be available yet. Please contact ZTE for
more information.");
...
pkgs = {
  'CGSL MAIN 6.02': [
    'spice-debugsource-0.14.2-1.el8_2.1',
    'spice-server-0.14.2-1.el8_2.1',
    'spice-server-debuginfo-0.14.2-1.el8_2.1',
    'spice-server-devel-0.14.2-1.el8_2.1'
  ]
};
