...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libvncserver Vulnerability (NS-SA-2021-0050)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libvncserver packages installed that are affected by a
vulnerability:
...
pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'libvncserver-debuginfo-0.9.11-15.el8_2.1',
    'libvncserver-debugsource-0.9.11-15.el8_2.1',
    'libvncserver-devel-0.9.11-15.el8_2.1'
  ]
};
