...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.01 : thunderbird Multiple Vulnerabilities (NS-SA-2020-0036)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.01, has thunderbird packages installed that are affected by
multiple vulnerabilities:

  - By encoding Unicode whitespace characters within the
    From email header, an attacker can spoof the sender
    email address that Thunderbird displays. This
    vulnerability affects Thunderbird < 68.8.0.
    (CVE-2020-12397)
  ...
  - Under certain conditions, when running the nsDocShell
    ...
    this flaw. This vulnerability affects Thunderbird <
    68.7.0, Firefox < 74.0.1, and Firefox ESR < 68.6.1.
    (CVE-2020-6819)
  ...
  - Under certain conditions, when handling a
    ...
    abusing this flaw. This vulnerability affects
    Thunderbird < 68.7.0, Firefox < 74.0.1, and Firefox ESR
    < 68.6.1. (CVE-2020-6820)
  ...
  - When reading from areas partially or fully outside the
    ...
    sensitive data disclosure. This vulnerability affects
    Thunderbird < 68.7.0, Firefox ESR < 68.7, and Firefox <
    75. (CVE-2020-6821)
  ...
  - On 32-bit builds, an out of bounds write could have
    ...
    arbitrary code. This vulnerability affects Thunderbird <
    68.7.0, Firefox ESR < 68.7, and Firefox < 75.
    (CVE-2020-6822)

  - Mozilla developers and community members Tyson Smith and
    Christian Holler reported memory safety bugs present in
    Firefox 74 and Firefox ESR 68.6. Some of these bugs
    ...
    affects Thunderbird < 68.7.0, Firefox ESR < 68.7, and
    Firefox < 75. (CVE-2020-6825)

  - A race condition when running shutdown code for Web
    Worker led to a use-after-free vulnerability. This
    resulted in a potentially exploitable crash. This
    vulnerability affects Firefox ESR < 68.8, Firefox < 76,
  ...
  - A buffer overflow could occur when parsing and
    ...
    This vulnerability affects Firefox ESR < 68.8, Firefox <
    76, and Thunderbird < 68.8.0. (CVE-2020-6831)
  ...
  - The 'Copy as cURL' feature of Devtools' network tab did
    ...
    local files. This vulnerability affects Firefox ESR <
    68.8, Firefox < 76, and Thunderbird < 68.8.0.
    (CVE-2020-12392)

  - Mozilla developers and community members reported memory
    safety bugs present in Firefox 75 and Firefox ESR 68.7.
    Some of these bugs showed evidence of memory corruption
    and we presume that with enough effort some of these
    could have been exploited to run arbitrary code. This
    vulnerability affects Firefox ESR < 68.8, Firefox < 76,
    and Thunderbird < 68.8.0. (CVE-2020-12395)
...
pkgs = {
  "CGSL MAIN 6.01": [
    ...
    "thunderbird-debuginfo-68.8.0-1.el8_2",
    "thunderbird-debugsource-68.8.0-1.el8_2"
  ]
};
