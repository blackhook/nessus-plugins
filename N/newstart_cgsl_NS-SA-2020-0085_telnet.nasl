...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : telnet Vulnerability (NS-SA-2020-0085)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.05 / MAIN 5.05, has telnet packages installed that are affected by
a vulnerability:
...
pkgs = {
  'CGSL CORE 5.05': [
    ...
    'telnet-debuginfo-0.17-65.el7_8',
    'telnet-server-0.17-65.el7_8'
  ],
  'CGSL MAIN 5.05': [
    'telnet-0.17-65.el7_8',
    'telnet-debuginfo-0.17-65.el7_8',
