...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : java-1.7.0-openjdk Multiple Vulnerabilities (NS-SA-2019-0131)");
...
pkgs = {
  "CGSL MAIN 4.05": [
    ...
    "java-1.7.0-openjdk-debuginfo-1.7.0.191-2.6.15.4.el6_10",
    "java-1.7.0-openjdk-demo-1.7.0.191-2.6.15.4.el6_10",
    "java-1.7.0-openjdk-devel-1.7.0.191-2.6.15.4.el6_10",
    "java-1.7.0-openjdk-javadoc-1.7.0.191-2.6.15.4.el6_10",
    "java-1.7.0-openjdk-src-1.7.0.191-2.6.15.4.el6_10"
  ]
};
