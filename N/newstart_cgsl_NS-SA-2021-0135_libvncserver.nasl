...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : libvncserver Vulnerability (NS-SA-2021-0135)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2017-18922");
...
ZTE for more information.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:libvncserver");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:libvncserver-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:zte:cgsl_core:libvncserver-devel");
...
var pkgs = {
  'CGSL CORE 5.05': [
    ...
    'libvncserver-debuginfo-0.9.9-14.el7_8.1',
