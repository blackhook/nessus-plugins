...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : wpa_supplicant Vulnerability (NS-SA-2019-0072)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version CORE 5.04 / MAIN 5.04, has wpa_supplicant packages installed that are
affected by a vulnerability:
  ...
  - An issue was discovered in rsn_supp/wpa.c in
    ...
    the vulnerability to recover sensitive information.
    (CVE-2018-14526)
...
pkgs = {
  "CGSL CORE 5.04": [
    ...
    "wpa_supplicant-debuginfo-2.6-12.el7"
  ],
  "CGSL MAIN 5.04": [
    "wpa_supplicant-2.6-12.el7",
    "wpa_supplicant-debuginfo-2.6-12.el7"
