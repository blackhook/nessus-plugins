...
# extracted from ZTE advisory NS-SA-2020-0046. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 4.05 : thunderbird Multiple Vulnerabilities (NS-SA-2020-0046)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2020-0046");
...
pkgs = {
  'CGSL MAIN 4.05': [
    'thunderbird-68.7.0-1.el6.centos',
    'thunderbird-debuginfo-68.7.0-1.el6.centos'
  ]
};
