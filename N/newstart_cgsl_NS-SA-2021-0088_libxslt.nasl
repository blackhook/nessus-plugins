...
# extracted from ZTE advisory NS-SA-2021-0088. The text
...
if (description)
{
  ...
  script_name(english:"NewStart CGSL MAIN 6.02 : libxslt Multiple Vulnerabilities (NS-SA-2021-0088)");

  script_set_attribute(attribute:"synopsis", value:
"The remote machine is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The remote NewStart CGSL host, running version MAIN 6.02, has libxslt packages installed that are affected by multiple
vulnerabilities:
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/notice/NS-SA-2021-0088");
...
pkgs = {
  'CGSL MAIN 6.02': [
    ...
    'libxslt-debuginfo-1.1.32-5.el8',
    'libxslt-debugsource-1.1.32-5.el8',
    'libxslt-devel-1.1.32-5.el8'
  ]
};
