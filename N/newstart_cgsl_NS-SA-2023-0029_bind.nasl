...
if (description)
{
  ...
  script_cve_id("CVE-2021-25214", "CVE-2022-38177", "CVE-2022-38178");
  script_xref(name:"IAVA", value:"2021-A-0206-S");
  script_xref(name:"IAVA", value:"2022-A-0387-S");

  script_name(english:"NewStart CGSL CORE 5.04 / MAIN 5.04 : bind Multiple Vulnerabilities (NS-SA-2023-0029)");
...
var pkgs = {
  'CGSL CORE 5.04': [
    'bind-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-chroot-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-debuginfo-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-devel-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-export-devel-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-export-libs-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-libs-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-libs-lite-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-license-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-lite-devel-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-pkcs11-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-pkcs11-devel-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-pkcs11-libs-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-pkcs11-utils-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-sdb-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-sdb-chroot-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-utils-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a'
  ],
  'CGSL MAIN 5.04': [
    'bind-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
    'bind-chroot-9.11.4-26.P2.el7_9.10.cgslv5.0.1.g744662a',
