...
could allow arbitrary code execution."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.zerodayinitiative.com/advisories/ZDI-13-096/");
  # Download
  script_set_attribute(attribute:"see_also", value:"http://download.novell.com/Download?buildid=IVBoF47txKo~&patch_redirect=true&old_patch=k6yH0sy992E~");
  # Advisory
  script_set_attribute(attribute:"see_also", value:"https://support.microfocus.com/kb/doc.php?id=7012344");
