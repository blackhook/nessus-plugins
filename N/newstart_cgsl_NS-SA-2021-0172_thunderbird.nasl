...
if (description)
{
  ...
  script_name(english:"NewStart CGSL CORE 5.05 / MAIN 5.05 : thunderbird Multiple Vulnerabilities (NS-SA-2021-0172)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://security.gd-linux.com/info/CVE-2020-26970");
...
var pkgs = {
  'CGSL CORE 5.05': [
    'thunderbird-78.6.0-1.el7.centos'
  ],
  'CGSL MAIN 5.05': [
    'thunderbird-78.6.0-1.el7.centos'
  ]
