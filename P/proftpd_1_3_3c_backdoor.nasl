...
aware of it."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.theregister.co.uk/2010/12/02/proftpd_backdoored/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://xorl.wordpress.com/2010/12/02/news-proftpd-owned-and-backdoored/"
  );
  script_set_attribute(
    attribute:"see_also",
    ...
    if (report_verbosity > 0)
    {
      ...
      if (report_verbosity > 1)
      {
        report += 
          ...
          data_protection::sanitize_uid(output:info) +
          crap(data:"-", length:30) + " snip " + crap(data:"-", length:30) + '\n';
      }
