...
if (description)
{
  ...
  script_cve_id("CVE-2012-6593", "CVE-2012-6602");
  script_bugtraq_id(62124, 62126);

  script_name(english:"Palo Alto Networks PAN-OS < 3.1.10 / 4.x < 4.0.4 Multiple Command Injections");
...
prior to 3.1.10 / 4.0.4. It is, therefore, affected by multiple
command injection vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/4");
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/13");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PAN-OS version 3.1.10 / 4.0.4 or later.");
