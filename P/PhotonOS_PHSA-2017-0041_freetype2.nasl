...
if (rpm_check(release:"PhotonOS-1.0", reference:"freetype2-2.7.1-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"freetype2-debuginfo-2.7.1-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"freetype2-devel-2.7.1-4.ph1")) flag++;
