...
if (rpm_check(release:"PhotonOS-1.0", reference:"sqlite-autoconf-3.18.0-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"sqlite-autoconf-debuginfo-3.18.0-2.ph1")) flag++;
