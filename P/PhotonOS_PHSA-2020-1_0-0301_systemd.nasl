...
if (description)
{
  ...
  script_cve_id("CVE-2020-1712", "CVE-2020-13776");

  script_name(english:"Photon OS 1.0: Systemd PHSA-2020-1.0-0301");
...
"Update the affected Linux packages.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2020-1712");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"systemd-228-59.ph1")) flag++;
