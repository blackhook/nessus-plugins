...
issues.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.php-fusion.co.uk/infusions/news/news.php?readmore=569");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 7.02.06 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:H/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-7375");
...
key = "";
hash = HMAC_SHA256(data:data + time, key:key);
