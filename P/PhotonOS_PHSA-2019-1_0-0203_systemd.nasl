...
if (description)
{
  ...
  script_cve_id("CVE-2018-15686");

  script_name(english:"Photon OS 1.0: Systemd PHSA-2019-1.0-0203");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"systemd-228-49.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"systemd-debuginfo-228-49.ph1")) flag++;
