...
"The remote web server hosts a web-based LDAP client written in PHP.");
  script_set_attribute(attribute:"description", value:
"The remote host is running phpLDAPadmin, an open source web-based
LDAP client written in PHP.");
  script_set_attribute(attribute:"see_also", value:"http://phpldapadmin.sourceforge.net/wiki/index.php/Main_Page");
