...
if (rpm_check(release:"PhotonOS-3.0", reference:"libvirt-4.7.0-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"libvirt-debuginfo-4.7.0-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"libvirt-devel-4.7.0-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"libvirt-docs-4.7.0-4.ph3")) flag++;
