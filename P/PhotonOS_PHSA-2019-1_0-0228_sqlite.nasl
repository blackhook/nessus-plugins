...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Sqlite PHSA-2019-1.0-0228");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"sqlite-autoconf-3.27.2-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"sqlite-autoconf-debuginfo-3.27.2-1.ph1")) flag++;
