...
workaround.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://doc.powerdns.com/md/changelog/#changelog-recursor-3.6.1");
...
patch or workaround referenced in the vendor advisory.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-3614");
