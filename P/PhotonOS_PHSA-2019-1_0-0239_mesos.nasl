...
if (description)
{
  ...
  script_cve_id("CVE-2019-0204");
  script_bugtraq_id(107260);

  script_name(english:"Photon OS 1.0: Mesos PHSA-2019-1.0-0239");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"mesos-1.5.3-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"mesos-debuginfo-1.5.3-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"mesos-devel-1.5.3-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"mesos-python-1.5.3-1.ph1")) flag++;
