...
if (description)
{
  ...
  script_cve_id("CVE-2018-12123");
  script_bugtraq_id(107512);

  script_name(english:"Photon OS 1.0: Nodejs PHSA-2020-1.0-0306");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nodejs-8.11.4-5.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nodejs-devel-8.11.4-5.ph1")) flag++;
