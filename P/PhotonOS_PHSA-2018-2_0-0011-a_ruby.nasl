...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Ruby PHSA-2018-2.0-0011-(a)");
...
if (rpm_check(release:"PhotonOS-2.0", reference:"ruby-2.4.3-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"ruby-debuginfo-2.4.3-1.ph2")) flag++;
