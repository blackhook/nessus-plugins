...
"An update of the patch package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-3.0-0025.md");
...
if (rpm_check(release:"PhotonOS-3.0", reference:"patch-2.7.6-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"patch-debuginfo-2.7.6-4.ph3")) flag++;
