...
# extracted from VMware Security Advisory PHSA-2018-1.0-0144. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0 : unzip (PhotonOS-PHSA-2018-1.0-0144) (deprecated)");
  script_summary(english:"Checks the rpm output for the updated packages.");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"An update of {'unzip'} packages of Photon OS has been released.");
  # https://github.com/vmware/photon/wiki/Security-Updates-1.0-144
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe03b3f3");
