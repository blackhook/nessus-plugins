...
if (rpm_check(release:"PhotonOS-2.0", reference:"polkit-0.113-3.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"polkit-debuginfo-0.113-3.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"polkit-devel-0.113-3.ph2")) flag++;
