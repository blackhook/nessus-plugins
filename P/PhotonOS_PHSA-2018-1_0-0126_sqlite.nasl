...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Sqlite PHSA-2018-1.0-0126");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"sqlite-autoconf-3.22.0-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"sqlite-autoconf-debuginfo-3.22.0-2.ph1")) flag++;
