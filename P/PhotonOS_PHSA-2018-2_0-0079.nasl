...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Mysql PHSA-2018-2.0-0079 (deprecated)");
...
"An update of 'mysql' packages of Photon OS has been released.");
  # https://github.com/vmware/photon/wiki/Security-Updates-2-79
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dc1cb579");
...
pkgs = [
  "mysql-5.7.23-1.ph2",
  "mysql-debuginfo-5.7.23-1.ph2",
  "mysql-devel-5.7.23-1.ph2"
];
