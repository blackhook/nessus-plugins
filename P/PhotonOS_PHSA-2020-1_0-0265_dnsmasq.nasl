...
# extracted from VMware Security Advisory PHSA-2020-1.0-0265. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Dnsmasq PHSA-2020-1.0-0265");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the dnsmasq package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-265.md");
...
if (rpm_exists(rpm:"dnsmasq-2.79", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"dnsmasq-2.79-1.ph1")) flag++;
if (rpm_exists(rpm:"dnsmasq-2.79", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"src", reference:"dnsmasq-2.79-1.ph1.src")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.79-1.ph1")) flag++;
