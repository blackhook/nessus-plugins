...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libxslt PHSA-2019-1.0-0263");
...
if (rpm_exists(rpm:"libxslt-1.1", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libxslt-1.1.29-8.ph1")) flag++;
if (rpm_exists(rpm:"libxslt-1.1", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"src", reference:"libxslt-1.1.29-8.ph1.src")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libxslt-debuginfo-1.1.29-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libxslt-devel-1.1.29-8.ph1")) flag++;
