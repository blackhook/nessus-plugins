...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Kubernetes PHSA-2019-1.0-0242");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"kubernetes-1.12.7-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"kubernetes-debuginfo-1.12.7-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"kubernetes-kubeadm-1.12.7-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"kubernetes-kubectl-extras-1.12.7-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"kubernetes-pause-1.12.7-2.ph1")) flag++;
