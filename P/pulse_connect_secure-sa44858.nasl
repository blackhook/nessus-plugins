...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2021-A-0363-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0039");
...
"Upgrade to Pulse Connect Secure version 9.1R12 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-22938");
