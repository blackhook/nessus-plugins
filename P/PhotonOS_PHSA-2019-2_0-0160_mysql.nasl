...
if (rpm_check(release:"PhotonOS-2.0", reference:"mysql-5.7.26-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"mysql-debuginfo-5.7.26-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"mysql-devel-5.7.26-1.ph2")) flag++;
