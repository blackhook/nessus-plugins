...
if (description)
{
  ...
  script_name(english:"ProFTPD 1.3.4d / 1.3.5rc3 Denial of Service");
...
remote host is earlier than 1.3.5rc4 and is affected by a Denial
of Service vulnerability in the mod_sftp_pam module.");
  script_set_attribute(attribute:"see_also", value:"http://bugs.proftpd.org/show_bug.cgi?id=3973");
  script_set_attribute(attribute:"solution", value:
"Upgrade to ProFTPD version 1.3.5rc4 or later.");
...
if (
  version =~ "^1\.3\.4d($|[^0-9])" ||
  version =~ "^1\.3\.5rc3($|[^0-9])"
)
{
  report =
    '\n  Version source    : ' + chomp(banner) +
    '\n  Installed version : ' + version +
    '\n  Fixed version     : 1.3.5rc4\n';
