...
if (description)
{
  ...
  script_cve_id("CVE-2019-1567");
  script_bugtraq_id(107216);

  script_name(english:"Palo Alto Expedition Cross-Site Scripting (PAN-SA-2019-0003)");

  script_set_attribute(attribute:"synopsis", value:
"The reported version of Palo Alto Expedition is vulnerable to Cross-Site Scripting.");
  script_set_attribute(attribute:"description", value:
"A cross-site scripting (XSS) vulnerability exists in Palo Alto Expedition Migration Tool in version 1.1.x prior to
1.1.7 due to improper validation of user-supplied input before returning it to users. An authenticated remote
attacker may be able to inject arbitrary JavaScript or HTML in the User Mapping settings.");
  script_set_attribute(attribute:"see_also", value:"https://security.paloaltonetworks.com/CVE-2019-1567");
  script_set_attribute(attribute:"solution", value:
"Update to Palo Alto Expedition version 1.1.7 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-1567");
...
constraints = [
  { 'min_version' : '1.1', 'fixed_version' : '1.1.7' }
];
