...
if (rpm_check(release:"PhotonOS-1.0", reference:"libgcrypt-1.7.6-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libgcrypt-debuginfo-1.7.6-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libgcrypt-devel-1.7.6-3.ph1")) flag++;
