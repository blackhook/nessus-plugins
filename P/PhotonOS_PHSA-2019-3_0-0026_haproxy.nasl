...
if (rpm_check(release:"PhotonOS-3.0", reference:"haproxy-2.0.3-1.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"haproxy-debuginfo-2.0.3-1.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"haproxy-doc-2.0.3-1.ph3")) flag++;
