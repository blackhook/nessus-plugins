...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Openvswitch PHSA-2021-1.0-0366");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openvswitch-2.6.1-7.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openvswitch-devel-2.6.1-7.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'openvswitch-doc-2.6.1-7.ph1')) flag++;
