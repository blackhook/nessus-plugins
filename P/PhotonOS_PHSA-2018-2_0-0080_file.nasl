...
if (rpm_check(release:"PhotonOS-2.0", reference:"file-5.30-4.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"file-debuginfo-5.30-4.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"file-devel-5.30-4.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"file-libs-5.30-4.ph2")) flag++;
