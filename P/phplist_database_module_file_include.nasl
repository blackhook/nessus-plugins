...
subject to permissions of the web server user id.");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/430475/30/30/threaded");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/430597");
...
if (!isnull(matches))
{
  ...
  if ("class=webblermenu>PHPlist" >< res)
  {
    ...
    )
    {
      ...
      {
        contenst = data_protection::redact_etc_passwd(output:contents);
        report = string(
