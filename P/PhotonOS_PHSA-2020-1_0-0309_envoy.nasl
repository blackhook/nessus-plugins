...
if (description)
{
  ...
  script_cve_id("CVE-2020-8663", "CVE-2020-12604");

  script_name(english:"Photon OS 1.0: Envoy PHSA-2020-1.0-0309");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"envoy-1.15.0-1.ph1")) flag++;
