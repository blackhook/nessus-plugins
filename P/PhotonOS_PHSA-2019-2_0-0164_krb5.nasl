...
if (rpm_check(release:"PhotonOS-2.0", reference:"krb5-1.17-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"krb5-debuginfo-1.17-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"krb5-devel-1.17-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"krb5-lang-1.17-1.ph2")) flag++;
