...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Systemd PHSA-2018-1.0-0116");
...
"An update of the systemd package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-116.md");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"systemd-228-45.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"systemd-debuginfo-228-45.ph1")) flag++;
