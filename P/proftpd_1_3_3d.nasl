...
relied on the version in ProFTPD's banner.");
  script_set_attribute(attribute:"see_also", value:"http://phrack.org/issues/67/7.html#article");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4652");
