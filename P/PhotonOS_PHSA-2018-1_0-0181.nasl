...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Httpd PHSA-2018-1.0-0181 (deprecated)");
...
"An update of 'httpd' packages of Photon OS has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-181");
...
pkgs = [
  "httpd-2.4.34-1.ph1",
  "httpd-debuginfo-2.4.34-1.ph1",
  "httpd-devel-2.4.34-1.ph1",
  "httpd-docs-2.4.34-1.ph1",
  "httpd-tools-2.4.34-1.ph1"
];
