...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Libgcrypt / Libsoup PHSA-2018-2.0-0091 (deprecated)");
  script_summary(english:"Checks the rpm output for the updated packages.");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"An update of 'libgcrypt', 'libsoup' packages of Photon OS has been
released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-91");
...
pkgs = [
  ...
  "libgcrypt-debuginfo-1.8.1-2.ph2",
  "libgcrypt-devel-1.8.1-2.ph2",
  "libsoup-2.57.1-4.ph2",
  "libsoup-debuginfo-2.57.1-4.ph2",
  "libsoup-devel-2.57.1-4.ph2",
  "libsoup-doc-2.57.1-4.ph2",
  "libsoup-lang-2.57.1-4.ph2"
];
