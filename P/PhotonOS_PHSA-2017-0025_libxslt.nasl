...
if (rpm_check(release:"PhotonOS-1.0", reference:"libxslt-1.1.29-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libxslt-debuginfo-1.1.29-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libxslt-devel-1.1.29-4.ph1")) flag++;
