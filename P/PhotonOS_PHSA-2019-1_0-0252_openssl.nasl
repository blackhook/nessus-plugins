...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Openssl PHSA-2019-1.0-0252");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"openssl-1.0.2t-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"openssl-debuginfo-1.0.2t-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"openssl-devel-1.0.2t-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"openssl-perl-1.0.2t-1.ph1")) flag++;
