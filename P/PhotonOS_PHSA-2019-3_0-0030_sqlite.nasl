...
if (rpm_check(release:"PhotonOS-3.0", reference:"sqlite-3.27.2-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"sqlite-debuginfo-3.27.2-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"sqlite-devel-3.27.2-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"sqlite-libs-3.27.2-4.ph3")) flag++;
