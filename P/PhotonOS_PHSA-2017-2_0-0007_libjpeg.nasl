...
if (rpm_check(release:"PhotonOS-2.0", reference:"libjpeg-turbo-1.5.2-2.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libjpeg-turbo-debuginfo-1.5.2-2.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libjpeg-turbo-devel-1.5.2-2.ph2")) flag++;
