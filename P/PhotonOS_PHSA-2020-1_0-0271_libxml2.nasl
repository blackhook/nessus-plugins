...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libxml2 PHSA-2020-1.0-0271");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libxml2-2.9.10-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libxml2-debuginfo-2.9.10-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libxml2-devel-2.9.10-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libxml2-python-2.9.10-1.ph1")) flag++;
