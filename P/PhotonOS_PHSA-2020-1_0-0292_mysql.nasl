...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Mysql PHSA-2020-1.0-0292");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"mysql-5.7.30-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"mysql-debuginfo-5.7.30-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"mysql-devel-5.7.30-1.ph1")) flag++;
