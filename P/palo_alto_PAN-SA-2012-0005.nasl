...
if (description)
{
  ...
  script_cve_id("CVE-2012-6594");
  script_bugtraq_id(62128);

  script_name(english:"Palo Alto Networks PAN-OS < 3.1.11 / 4.0.x < 4.0.8 / 4.1.x < 4.1.1 Command Injection");
...
prior to 3.1.11 / 4.0.8 / 4.1.1. It is, therefore, affected by a
command injection vulnerability that allows an authenticated user to
inject arbitrary shell commands via the CLI."
  );
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/5");
  script_set_attribute(attribute:"solution", value:
"Upgrade to PAN-OS version 3.1.11 / 4.0.8 / 4.1.1 or later.");
