...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libmspack PHSA-2018-1.0-0167");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"libmspack-0.5alpha-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libmspack-debuginfo-0.5alpha-4.ph1")) flag++;
