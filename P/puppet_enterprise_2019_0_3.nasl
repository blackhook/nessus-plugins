...
if (description)
{
  ...
  script_cve_id("CVE-2019-10694");

  script_name(english:"Puppet Enterprise x < 2018.1.9 / 2019.x.x < 2019.0.3 Default Password Vulnerabilities");
...
"The admin account is using a default password. An unauthenticated,
remote attacker can exploit this gain privileged or administrator
access to the system.");
  script_set_attribute(attribute:"see_also", value:"https://puppet.com/security/cve/CVE-2019-10694");
...
"Upgrade to Puppet Enterprise version 2018.1.9, 2019.0.3, or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-10694");
...
constraints = [
  {"min_version" : "4.0.0", "fixed_version" : "5.5.16", "fixed_display" : "Puppet Enterprise (2018.1.9)"}, 
  {"min_version" : "6.0.0", "fixed_version" : "6.0.9", "fixed_display" : "Puppet Enterprise (2019.0.3)"}, 
];
