...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libssh2 PHSA-2019-1.0-0220");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"libssh2-1.8.0-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libssh2-debuginfo-1.8.0-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libssh2-devel-1.8.0-2.ph1")) flag++;
