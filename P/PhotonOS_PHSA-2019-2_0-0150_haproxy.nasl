...
if (rpm_check(release:"PhotonOS-2.0", reference:"haproxy-1.9.6-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"haproxy-debuginfo-1.9.6-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"haproxy-doc-1.9.6-1.ph2")) flag++;
