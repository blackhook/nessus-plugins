...
if (rpm_check(release:"PhotonOS-2.0", reference:"libgd-2.2.5-4.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libgd-debuginfo-2.2.5-4.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libgd-devel-2.2.5-4.ph2")) flag++;
