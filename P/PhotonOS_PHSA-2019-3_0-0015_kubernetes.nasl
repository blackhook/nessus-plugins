...
if (rpm_check(release:"PhotonOS-3.0", reference:"kubernetes-1.12.7-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"kubernetes-debuginfo-1.12.7-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"kubernetes-kubeadm-1.12.7-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"kubernetes-kubectl-extras-1.12.7-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"kubernetes-pause-1.12.7-2.ph3")) flag++;
