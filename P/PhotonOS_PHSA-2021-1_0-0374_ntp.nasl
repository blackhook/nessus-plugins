...
# extracted from VMware Security Advisory PHSA-2021-1.0-0374. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Ntp PHSA-2021-1.0-0374");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the ntp package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-374.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'ntp-4.2.8p14-4.ph1')) flag++;
