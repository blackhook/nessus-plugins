...
if (description)
{
  ...
  script_name(english:"pfSense < 2.2.2 Multiple Vulnerabilities (SA-15_05)");
...
install is prior to 2.2.2. It is, therefore, affected by multiple
vulnerabilities as stated in the referenced vendor advisories.");
  # https://www.pfsense.org/security/advisories/pfSense-SA-15_05.webgui.asc
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?40e8709f");
  script_set_attribute(attribute:"solution", value:
"Upgrade to pfSense version 2.2.2 or later.");
