...
if (rpm_check(release:"PhotonOS-3.0", reference:"libssh2-1.8.2-1.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"libssh2-debuginfo-1.8.2-1.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"libssh2-devel-1.8.2-1.ph3")) flag++;
