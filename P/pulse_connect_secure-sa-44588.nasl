...
if (description)
{
  ...
  script_name(english:"Pulse Connect Secure < 9.1R8.2 (SA44588)");
...
to 9.1R8.2. It is, therefore, affected by multiple vulnerabilities:
...
"Upgrade to Pulse Connect Secure version 9.1R8.2 or later.");
...
# full ver from https://www-prev.pulsesecure.net/download/techpubs/current/2158/pulse-connect-secure/pcs/9.1rx/9.1r8/ps-pcs-sa-9.1r8.2-releasenotes.pdf
constraints = [
 {'fixed_version':'9.1.8.8511', 'fixed_display':'9.1R8.2'}
];
