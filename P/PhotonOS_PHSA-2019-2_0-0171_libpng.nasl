...
if (rpm_check(release:"PhotonOS-2.0", reference:"libpng-1.6.35-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libpng-debuginfo-1.6.35-1.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libpng-devel-1.6.35-1.ph2")) flag++;
