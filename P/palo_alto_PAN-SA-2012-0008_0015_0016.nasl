...
if (description)
{
  ...
  script_cve_id("CVE-2012-6597", "CVE-2012-6604", "CVE-2012-6605");
  script_bugtraq_id(62116, 62122, 62127);

  script_name(english:"Palo Alto Networks PAN-OS < 3.1.11 / 4.0.x < 4.0.9 Multiple Vulnerabilities");
...
prior to 3.1.11 / 4.0.9. It is, therefore, affected by multiple
vulnerabilities :

  - A denial of service vulnerability exists that allows an
    authenticated attacker to crash the device via a
    specially crafted command sent to the CLI.
  ...
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/8");
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/15");
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/16");
  script_set_attribute(attribute:"solution", value:"Upgrade to PAN-OS version 3.1.11 / 4.0.9 or later.");
