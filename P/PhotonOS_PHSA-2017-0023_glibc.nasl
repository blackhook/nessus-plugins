...
if (rpm_check(release:"PhotonOS-1.0", reference:"glibc-2.22-13.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"glibc-devel-2.22-13.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"glibc-lang-2.22-13.ph1")) flag++;
