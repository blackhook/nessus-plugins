...
if (description)
{
  ...
  script_bugtraq_id(102985);

  script_name(english:"Photon OS 2.0 : binutils (PhotonOS-PHSA-2018-2.0-0021) (deprecated)");
...
"An update of {'binutils'} packages of Photon OS has been released.");
  # https://github.com/vmware/photon/wiki/Security-Updates-2-21
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?05b5461d");
...
pkgs = [
  "binutils-2.30-2.ph2",
  "binutils-debuginfo-2.30-2.ph2",
  "binutils-devel-2.30-2.ph2"
];
