...
if (rpm_check(release:"PhotonOS-1.0", reference:"gnutls-3.4.11-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"gnutls-debuginfo-3.4.11-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"gnutls-devel-3.4.11-4.ph1")) flag++;
