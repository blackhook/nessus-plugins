...
if (description)
{
  script_id(121673);
  script_version("1.4");
  script_set_attribute(attribute:"plugin_modification_date", value:"2019/03/28");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"vim-7.4-7.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"vim-extra-7.4-7.ph1")) flag++;
