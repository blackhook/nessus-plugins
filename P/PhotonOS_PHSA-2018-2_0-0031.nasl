...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0 : postgresql (PhotonOS-PHSA-2018-2.0-0031) (deprecated)");
...
"An update of {'postgresql'} packages of Photon OS has been released.");
  # https://github.com/vmware/photon/wiki/Security-Updates-2-31
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3aad5682");
...
pkgs = [
  "postgresql-9.6.8-1.ph2",
  "postgresql-debuginfo-9.6.8-1.ph2",
  "postgresql-devel-9.6.8-1.ph2",
  "postgresql-libs-9.6.8-1.ph2"
];
