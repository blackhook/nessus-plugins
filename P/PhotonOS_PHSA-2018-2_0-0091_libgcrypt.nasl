...
if (rpm_check(release:"PhotonOS-2.0", reference:"libgcrypt-1.8.1-2.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libgcrypt-debuginfo-1.8.1-2.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"libgcrypt-devel-1.8.1-2.ph2")) flag++;
