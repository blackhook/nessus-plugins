...
if (rpm_exists(rpm:"unzip-6.0", release:"PhotonOS-3.0") && rpm_check(release:"PhotonOS-3.0", cpu:"aarch64", reference:"unzip-6.0-14.ph3")) flag++;
if (rpm_exists(rpm:"unzip-6.0", release:"PhotonOS-3.0") && rpm_check(release:"PhotonOS-3.0", cpu:"x86_64", reference:"unzip-6.0-14.ph3")) flag++;
if (rpm_exists(rpm:"unzip-debuginfo-6.0", release:"PhotonOS-3.0") && rpm_check(release:"PhotonOS-3.0", cpu:"aarch64", reference:"unzip-debuginfo-6.0-14.ph3")) flag++;
if (rpm_exists(rpm:"unzip-debuginfo-6.0", release:"PhotonOS-3.0") && rpm_check(release:"PhotonOS-3.0", cpu:"x86_64", reference:"unzip-debuginfo-6.0-14.ph3")) flag++;
