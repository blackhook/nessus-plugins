...
if (rpm_check(release:"PhotonOS-3.0", reference:"mercurial-4.7.1-4.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"mercurial-debuginfo-4.7.1-4.ph3")) flag++;
