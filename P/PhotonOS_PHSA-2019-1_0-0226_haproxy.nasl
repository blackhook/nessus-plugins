...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Haproxy PHSA-2019-1.0-0226");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"haproxy-1.8.14-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"haproxy-debuginfo-1.8.14-4.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"haproxy-doc-1.8.14-4.ph1")) flag++;
