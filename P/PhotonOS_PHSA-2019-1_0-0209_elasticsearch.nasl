...
if (description)
{
  ...
  script_bugtraq_id(106318);

  script_name(english:"Photon OS 1.0: Elasticsearch PHSA-2019-1.0-0209");
...
if (rpm_exists(rpm:"elasticsearch-6.4", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"elasticsearch-6.4.3-1.ph1")) flag++;
if (rpm_exists(rpm:"elasticsearch-6.4", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"src", reference:"elasticsearch-6.4.3-1.ph1.src")) flag++;
