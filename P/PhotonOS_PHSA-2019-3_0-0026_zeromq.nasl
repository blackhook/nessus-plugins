...
if (rpm_check(release:"PhotonOS-3.0", reference:"zeromq-4.2.3-3.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"zeromq-debuginfo-4.2.3-3.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"zeromq-devel-4.2.3-3.ph3")) flag++;
