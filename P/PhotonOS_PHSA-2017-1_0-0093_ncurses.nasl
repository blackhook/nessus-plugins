...
if (rpm_check(release:"PhotonOS-1.0", reference:"ncurses-6.0-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"ncurses-compat-6.0-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"ncurses-debuginfo-6.0-8.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"ncurses-devel-6.0-8.ph1")) flag++;
