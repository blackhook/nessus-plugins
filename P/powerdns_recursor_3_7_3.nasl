...
if (description)
{
 ...
 script_name(english:"PowerDNS Recursor 3.x < 3.7.3 Label Decompression DoS");
...
3.7.3. It is, therefore, affected by a denial of service vulnerability
due to improper validation of user-supplied input when handling
self-referential names during label decompression. An unauthenticated,
...
"Upgrade to PowerDNS Recursor 3.7.3 or later. Alternatively, apply the
...
if (version =~ "^3\.[56]([^0-9]|$)" || version =~ "^3\.7(\.[0-2])?([^0-9.]|$)")
{
