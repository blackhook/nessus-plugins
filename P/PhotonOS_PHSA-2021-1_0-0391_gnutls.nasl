...
# extracted from VMware Security Advisory PHSA-2021-1.0-0391. The text
...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Gnutls PHSA-2021-1.0-0391");

  script_set_attribute(attribute:"synopsis", value:
"The remote PhotonOS host is missing multiple security updates.");
  script_set_attribute(attribute:"description", value:
"An update of the gnutls package has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-1.0-391.md");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-3.6.15-3.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'gnutls-devel-3.6.15-3.ph1')) flag++;
