...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Nss PHSA-2021-1.0-0404");
...
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nss-3.44-4.ph1')) flag++;
if (rpm_check(release:'PhotonOS-1.0', cpu:'x86_64', reference:'nss-devel-3.44-4.ph1')) flag++;
