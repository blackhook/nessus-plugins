...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Blktrace PHSA-2018-1.0-0167");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"blktrace-1.1.0-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"blktrace-debuginfo-1.1.0-3.ph1")) flag++;
