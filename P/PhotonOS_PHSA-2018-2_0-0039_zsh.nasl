...
if (rpm_check(release:"PhotonOS-2.0", reference:"zsh-5.3.1-7.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"zsh-debuginfo-5.3.1-7.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"zsh-html-5.3.1-7.ph2")) flag++;
