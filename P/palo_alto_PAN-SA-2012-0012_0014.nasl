...
if (description)
{
  ...
  script_cve_id("CVE-2012-6601", "CVE-2012-6603");
  script_bugtraq_id(62115, 62121);

  script_name(english:"Palo Alto Networks PAN-OS < 3.1.12 / 4.0.x < 4.0.10 / 4.1.x < 4.1.4 Multiple Vulnerabilities");
...
prior to 3.1.12 / 4.0.10 / 4.1.4. It is, therefore, affected by
multiple vulnerabilities :
  ...
  - A vulnerability exists that allows an unauthenticated
    user to gain administrator access without supplying
    credentials. (CVE-2012-6603 / PAN-SA-2012-0014)"
  );
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/12");
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/14");
  script_set_attribute(attribute:"solution", value:"Upgrade to PAN-OS version 3.1.12 / 4.0.10 / 4.1.4 or later.");
