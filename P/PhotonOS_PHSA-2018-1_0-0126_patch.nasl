...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Patch PHSA-2018-1.0-0126");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"patch-2.7.5-3.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"patch-debuginfo-2.7.5-3.ph1")) flag++;
