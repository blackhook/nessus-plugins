...
if (rpm_check(release:"PhotonOS-3.0", reference:"libarchive-3.3.3-3.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"libarchive-debuginfo-3.3.3-3.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"libarchive-devel-3.3.3-3.ph3")) flag++;
