...
if (description)
{
  ...
  script_cve_id("CVE-2019-7614", "CVE-2020-7014");

  script_name(english:"Photon OS 1.0: Elasticsearch PHSA-2020-1.0-0301");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"elasticsearch-6.8.9-1.ph1")) flag++;
