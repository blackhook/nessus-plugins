...
privileges of the user running the affected application." );
 script_set_attribute(attribute:"see_also", value:"https://secuniaresearch.flexerasoftware.com/secunia_research/2006-42/advisory/" );
 script_set_attribute(attribute:"see_also", value:"http://picozip.com/pz-changelog" );
