...
if (rpm_check(release:"PhotonOS-3.0", reference:"expat-2.2.6-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"expat-debuginfo-2.2.6-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"expat-devel-2.2.6-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"expat-libs-2.2.6-2.ph3")) flag++;
