...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libgcrypt PHSA-2020-1.0-0288");
...
if (rpm_exists(rpm:"libgcrypt-1.7", release:"PhotonOS-1.0") && rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libgcrypt-1.7.6-6.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libgcrypt-debuginfo-1.7.6-6.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"libgcrypt-devel-1.7.6-6.ph1")) flag++;
