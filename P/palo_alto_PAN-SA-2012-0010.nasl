...
if (description)
{
  ...
  script_cve_id("CVE-2012-6599");
  script_bugtraq_id(62117);

  script_name(english:"Palo Alto Networks PAN-OS < 4.0.8 / 4.1.x < 4.1.1 Command Injection");
...
prior to 4.0.8 / 4.1.1. It is, therefore, affected by a command
injection vulnerability that allows an authenticated user to inject
arbitrary shell commands via the CLI.

Note that the 3.0 branch is not affected by this vulnerability."
  );
  script_set_attribute(attribute:"see_also", value:"https://securityadvisories.paloaltonetworks.com/Home/Detail/10");
  script_set_attribute(attribute:"solution", value:"Upgrade to PAN-OS version 4.0.8 / 4.1.1 or later.");
