...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0 : unzip (PhotonOS-PHSA-2018-2.0-0052) (deprecated)");
...
"An update of {'unzip'} packages of Photon OS has been released.");
  ...
  # https://github.com/vmware/photon/wiki/Security-Updates-2-52
    script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5813fbc6");
