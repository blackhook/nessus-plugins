...
if (rpm_check(release:"PhotonOS-2.0", reference:"perl-5.24.1-6.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"perl-apparmor-2.13-3.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"perl-debuginfo-5.24.1-6.ph2")) flag++;
