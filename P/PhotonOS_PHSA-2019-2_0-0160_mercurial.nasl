...
if (rpm_check(release:"PhotonOS-2.0", reference:"mercurial-4.5.3-3.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"mercurial-debuginfo-4.5.3-3.ph2")) flag++;
