...
if (rpm_check(release:"PhotonOS-3.0", reference:"unbound-1.8.0-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"unbound-debuginfo-1.8.0-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"unbound-devel-1.8.0-2.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"unbound-docs-1.8.0-2.ph3")) flag++;
