...
if (rpm_check(release:"PhotonOS-1.0", reference:"bindutils-9.10.4-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"bindutils-debuginfo-9.10.4-2.ph1")) flag++;
