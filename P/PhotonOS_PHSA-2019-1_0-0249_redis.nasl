...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Redis PHSA-2019-1.0-0249");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"redis-4.0.14-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"redis-debuginfo-4.0.14-1.ph1")) flag++;
