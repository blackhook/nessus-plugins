...
if (description)
{
  ...
  script_name(english:"Photon OS 2.0: Httpd PHSA-2018-2.0-0089 (deprecated)");
...
"An update of 'httpd' packages of Photon OS has been released.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/vmware/photon/wiki/Security-Updates-2-89");
...
pkgs = [
  "httpd-2.4.34-1.ph2",
  "httpd-debuginfo-2.4.34-1.ph2",
  "httpd-devel-2.4.34-1.ph2",
  "httpd-docs-2.4.34-1.ph2",
  "httpd-tools-2.4.34-1.ph2"
];
