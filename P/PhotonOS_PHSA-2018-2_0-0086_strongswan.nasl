...
if (rpm_check(release:"PhotonOS-2.0", reference:"strongswan-5.5.2-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"strongswan-debuginfo-5.5.2-5.ph2")) flag++;
