...
if (description)
{
  ...
  script_bugtraq_id(106092);

  script_name(english:"Photon OS 1.0: Nettle PHSA-2020-1.0-0289");
...
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nettle-3.4.1-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nettle-debuginfo-3.4.1-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", cpu:"x86_64", reference:"nettle-devel-3.4.1-1.ph1")) flag++;
