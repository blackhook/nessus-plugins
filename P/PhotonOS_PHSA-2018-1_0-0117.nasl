...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Go PHSA-2018-1.0-0117 (deprecated)");
...
"An update of 'go' packages of Photon OS has been released.");
  # https://github.com/vmware/photon/wiki/Security-Updates-1.0-117
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fe1d250d");
