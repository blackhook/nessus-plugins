...
if (rpm_check(release:"PhotonOS-1.0", reference:"cairo-1.14.8-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"cairo-debuginfo-1.14.8-2.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"cairo-devel-1.14.8-2.ph1")) flag++;
