...
if (description)
{
  ...
  script_cve_id("CVE-2017-18078", "CVE-2018-6574");

  script_name(english:"Photon OS 2.0 : systemd / go (PhotonOS-PHSA-2018-2.0-0026) (deprecated)");
  script_summary(english:"Checks the rpm output for the updated packages.");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"An update of {'systemd', 'go'} packages of Photon OS has been
released.");
  # https://github.com/vmware/photon/wiki/Security-Updates-2-26
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d10419f0");
...
pkgs = [
  "go-1.9.4-1.ph2",
  "go-debuginfo-1.9.4-1.ph2",
  "systemd-233-12.ph2",
  "systemd-debuginfo-233-12.ph2",
  "systemd-devel-233-12.ph2",
  "systemd-lang-233-12.ph2"
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "systemd / go");
}
