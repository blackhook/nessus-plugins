...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libpng PHSA-2019-1.0-0246");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"libpng-1.6.35-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libpng-debuginfo-1.6.35-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libpng-devel-1.6.35-1.ph1")) flag++;
