...
if (rpm_check(release:"PhotonOS-2.0", reference:"expat-2.2.4-2.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"expat-debuginfo-2.2.4-2.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"expat-devel-2.2.4-2.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"expat-libs-2.2.4-2.ph2")) flag++;
