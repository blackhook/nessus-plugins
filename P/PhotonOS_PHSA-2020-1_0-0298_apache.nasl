...
if (description)
{
  ...
  script_cve_id("CVE-2020-1945", "CVE-2020-9484");
  script_xref(name:"IAVA", value:"2020-A-0225-S");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");
  script_xref(name:"CEA-ID", value:"CEA-2021-0025");

  script_name(english:"Photon OS 1.0: Apache PHSA-2020-1.0-0298");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"apache-ant-1.10.8-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"apache-tomcat-8.5.51-2.ph1")) flag++;
