...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Vim PHSA-2018-1.0-0167");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"vim-7.4-10.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"vim-extra-7.4-10.ph1")) flag++;
