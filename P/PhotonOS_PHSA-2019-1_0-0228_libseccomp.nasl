...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Libseccomp PHSA-2019-1.0-0228");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"libseccomp-2.4.0-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libseccomp-debuginfo-2.4.0-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"libseccomp-devel-2.4.0-1.ph1")) flag++;
