...
even read-only access is sufficient." );
 script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/470835/30/0/threaded" );
...
"Restrict network access to the device management interfaces." );
 ...
 script_end_attributes();
    ...
    script_copyright(english:"This script is Copyright (C) 2007-2021 nnposter");
