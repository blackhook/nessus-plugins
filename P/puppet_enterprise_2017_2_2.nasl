...
if (description)
{
  ...
  script_name(english:"Puppet Enterprise < 2017.2.2 Arbitrary Code Execution Vulnerability");
...
exists in RBAC and classifier errors. An unauthenticated, attacker 
can exploit this, to use specially formatted strings w/ specific 
characters as classifier node group names or RBAC role
display names to crash the service.");
  script_set_attribute(attribute:"see_also", value:"https://puppet.com/security/cve/CVE-2017-2296");
...
"Upgrade to Puppet Enterprise version 2016.4.12 / 2017.3.7 / 2018.1.1 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-2296");
...
constraints = [
  {"min_version" : "5.5.0", "fixed_version" : "5.5.6" , "fixed_display" : "Puppet Enterprise (2017.2.2)" } 
];
