...
if (rpm_check(release:"PhotonOS-2.0", reference:"dhcp-client-4.3.5-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"dhcp-debuginfo-4.3.5-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"dhcp-devel-4.3.5-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"dhcp-libs-4.3.5-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"dhcp-server-4.3.5-5.ph2")) flag++;
