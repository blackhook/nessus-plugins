...
if (rpm_check(release:"PhotonOS-3.0", reference:"openssl-1.0.2t-1.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"openssl-debuginfo-1.0.2t-1.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"openssl-devel-1.0.2t-1.ph3")) flag++;
if (rpm_check(release:"PhotonOS-3.0", reference:"openssl-perl-1.0.2t-1.ph3")) flag++;
