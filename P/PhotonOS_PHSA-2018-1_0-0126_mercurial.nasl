...
if (description)
{
  ...
  script_name(english:"Photon OS 1.0: Mercurial PHSA-2018-1.0-0126");
...
if (rpm_check(release:"PhotonOS-1.0", reference:"mercurial-4.5.3-1.ph1")) flag++;
if (rpm_check(release:"PhotonOS-1.0", reference:"mercurial-debuginfo-4.5.3-1.ph1")) flag++;
