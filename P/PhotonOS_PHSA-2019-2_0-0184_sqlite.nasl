...
if (rpm_check(release:"PhotonOS-2.0", reference:"sqlite-3.27.2-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"sqlite-debuginfo-3.27.2-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"sqlite-devel-3.27.2-5.ph2")) flag++;
if (rpm_check(release:"PhotonOS-2.0", reference:"sqlite-libs-3.27.2-5.ph2")) flag++;
