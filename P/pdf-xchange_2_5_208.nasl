...
execution.");
  script_set_attribute(attribute:"see_also", value:"https://www.tracker-software.com/company/news_press_events/view/123");
  ...
  script_copyright(english:"This script is Copyright (C) 2003-2018 -2013 Tenable Network Security, Inc.");
