...
if (rpm_exists(rpm:"python-cryptography-2.3", release:"PhotonOS-2.0") && rpm_check(release:"PhotonOS-2.0", cpu:"src", reference:"python-cryptography-2.3.1-1.ph2.src")) flag++;
