...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-685.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-685");

  script_name(english:"Amazon Linux AMI : php56 / php55 (ALAS-2016-685)");
  ...
  script_set_attribute(
    ...
    value:
"A stack overflow vulnerability was reported that may occur when
decompressing tar archives due to phar_tar_writeheaders() potentially
copying non-terminated linknames from entries parsed by
phar_parse_tarfile()."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-685.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"ALA", reference:"php55-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-bcmath-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-cli-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-common-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-dba-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-debuginfo-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-devel-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-embedded-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-enchant-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-fpm-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-gd-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-gmp-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-imap-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-intl-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-ldap-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mbstring-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mcrypt-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mssql-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mysqlnd-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-odbc-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-opcache-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-pdo-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-pgsql-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-process-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-pspell-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-recode-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-snmp-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-soap-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-tidy-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-xml-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-xmlrpc-5.5.33-1.113.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-bcmath-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-cli-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-common-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-dba-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-dbg-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-debuginfo-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-devel-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-embedded-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-enchant-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-fpm-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-gd-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-gmp-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-imap-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-intl-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-ldap-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-mbstring-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-mcrypt-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-mssql-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-mysqlnd-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-odbc-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-opcache-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-pdo-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-pgsql-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-process-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-pspell-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-recode-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-snmp-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-soap-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-tidy-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-xml-5.6.19-1.123.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php56-xmlrpc-5.6.19-1.123.amzn1")) flag++;
