...
if(description)
{
 script_id(43541);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828788";
...
"The remote host is missing AIX PTF U828788 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828788"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828788", package:"bos.net.nfs.cachefs.6.1.3.1") < 0 ) 
