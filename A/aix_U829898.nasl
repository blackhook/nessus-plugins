...
if(description)
{
 script_id(44478);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829898";
...
"The remote host is missing AIX PTF U829898 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829898"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829898", package:"bos.rte.libpthreads.5.3.11.1") < 0 ) 
