...
if(description)
{
 script_id(38572);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824997";
...
"The remote host is missing AIX PTF U824997 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824997"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824997", package:"bos.net.nfs.cachefs.5.3.7.4") < 0 ) 
