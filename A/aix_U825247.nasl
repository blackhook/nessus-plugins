...
if(description)
{
 script_id(42518);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825247";
...
"The remote host is missing AIX PTF U825247 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825247"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825247", package:"devices.scsi.disk.rte.5.3.9.3") < 0 ) 
