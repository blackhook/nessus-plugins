...
if(description)
{
 script_id(38373);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822049";
...
"The remote host is missing AIX PTF U822049 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822049"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822049", package:"bos.perf.proctools.5.3.8.2") < 0 ) 
