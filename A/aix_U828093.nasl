...
if(description)
{
 script_id(43920);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828093";
...
"The remote host is missing AIX PTF U828093 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828093"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828093", package:"bos.adt.debug.6.1.4.1") < 0 ) 
