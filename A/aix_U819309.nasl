...
if(description)
{
 script_id(34511);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819309";
...
"The remote host is missing AIX PTF U819309 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819309"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819309", package:"bos.rte.serv_aid.5.3.7.2") < 0 ) 
