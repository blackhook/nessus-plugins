...
if(description)
{
 script_id(45189);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830074";
...
"The remote host is missing AIX PTF U830074 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830074"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830074", package:"bos.cifs_fs.rte.5.3.10.2") < 0 ) 
