...
if (description)
{
  ...
  script_bugtraq_id(92886);

  script_name(english:"Asterisk 13.10.x < 13.11.1 ACK Handling Unrecognized Username NULL Pointer Dereference DoS (AST-2016-006)");
...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2016-006.html");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2016/Sep/15");
...
foreach kb_name (keys(asterisk_kbs))
{
  ...
  # Open Source 13.10.0
  if (version =~ "^13\.10\.0([^0-9]|$)" && "cert" >!< tolower(version))
  {
    fixed = "13.11.1";
