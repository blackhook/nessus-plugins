...
if(description)
{
 script_id(43932);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828105";
...
"The remote host is missing AIX PTF U828105 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828105"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828105", package:"bos.acct.6.1.4.1") < 0 ) 
