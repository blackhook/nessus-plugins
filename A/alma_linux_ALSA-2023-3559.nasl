...
# AlmaLinux Security Advisory ALSA-2023:3559.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:3559");

  script_name(english:"AlmaLinux 9 : c-ares (ALSA-2023:3559)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-3559.html");
