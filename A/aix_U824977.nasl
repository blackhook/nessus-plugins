...
if(description)
{
 script_id(38552);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824977";
...
"The remote host is missing AIX PTF U824977 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824977"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824977", package:"bos.rte.filesystem.5.3.7.7") < 0 ) 
