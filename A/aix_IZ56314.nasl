...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : bind (IZ56314)");
  script_summary(english:"Check for APAR IZ56314");
...
if (aix_check_ifix(release:"5.3", ml:"10", patch:"IZ56314_10", package:"bos.net.tcp.server", minfilesetver:"5.3.10.0", maxfilesetver:"5.3.10.0") < 0) flag++;
