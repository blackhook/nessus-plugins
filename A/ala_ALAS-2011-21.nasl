...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-21.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-21");
  script_xref(name:"RHSA", value:"2011:1444");

  script_name(english:"Amazon Linux AMI : nss (ALAS-2011-21)");
...
company as found at digicert.com."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2011-21.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nss-3.12.10-2.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-debuginfo-3.12.10-2.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-devel-3.12.10-2.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-pkcs11-devel-3.12.10-2.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-sysinit-3.12.10-2.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-tools-3.12.10-2.23.amzn1")) flag++;
