...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : cmdque (IV47428)");
  script_summary(english:"Check for APAR IV47428");
...
if (aix_check_ifix(release:"6.1", ml:"08", sp:"03", patch:"IV47428s3a", package:"bos.rte.printers", minfilesetver:"6.1.8.0", maxfilesetver:"6.1.8.15") < 0) flag++;
