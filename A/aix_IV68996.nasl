...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : bind9 (IV68996)");
  script_summary(english:"Check for APAR IV68996");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"04", patch:"IV68996s4a", package:"bos.net.tcp.server", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.30") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"04", patch:"IV68996s4a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.30") < 0) flag++;
