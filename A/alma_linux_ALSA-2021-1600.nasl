...
# AlmaLinux Security Advisory ALSA-2021:1600.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:1600");

  script_name(english:"AlmaLinux 8 : opensc (ALSA-2021:1600)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-1600.html");
