...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : bind (IZ56317)");
  script_summary(english:"Check for APAR IZ56317");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ56317_02", package:"bos.net.tcp.server", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.2") < 0) flag++;
