...
# AlmaLinux Security Advisory ALSA-2020:3176.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:3176");

  script_name(english:"AlmaLinux 8 : postgresql-jdbc (ALSA-2020:3176)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2020:3176 advisory.

  - PostgreSQL JDBC Driver (aka PgJDBC) before 42.2.13 allows XXE. (CVE-2020-13692)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-3176.html");
