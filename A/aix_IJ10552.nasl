...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 1 : solaris (IJ10552)");
  script_summary(english:"Check for APAR IJ10552");
...
if (aix_check_ifix(release:"7.2", ml:"01", sp:"02", patch:"IJ10552s2a", package:"core", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"03", patch:"IJ10552s3a", package:"core", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"04", patch:"IJ10552s4a", package:"core", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.3") < 0) flag++;
