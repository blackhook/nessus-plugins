...
if(description)
{
 script_id(35504);
 script_version("1.6");
 name["english"] = "AIX 520010 : U823524";
...
"The remote host is missing AIX PTF U823524 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823524"; 
...
if ( aix_check_patch(ml:"520010", patch:"U823524", package:"devices.iscsi_sw.rte.5.2.0.108") < 0 ) 
