...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : muxatmd (IZ48499)");
  script_summary(english:"Check for APAR IZ48499");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ48499_07", package:"devices.common.IBM.atm.rte", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
