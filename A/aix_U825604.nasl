...
if(description)
{
 script_id(39230);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825604";
...
"The remote host is missing AIX PTF U825604 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825604"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825604", package:"bos.perf.proctools.6.1.2.1") < 0 ) 
