...
if(description)
{
 script_id(44563);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830436";
...
"The remote host is missing AIX PTF U830436 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830436"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830436", package:"bos.acct.6.1.4.2") < 0 ) 
