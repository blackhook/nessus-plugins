...
if(description)
{
 script_id(38370);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822046";
...
"The remote host is missing AIX PTF U822046 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822046"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822046", package:"bos.acct.5.3.8.4") < 0 ) 
