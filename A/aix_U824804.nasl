...
if(description)
{
 script_id(38482);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824804";
...
"The remote host is missing AIX PTF U824804 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824804"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824804", package:"devices.fcp.tape.rte.5.3.9.2") < 0 ) 
