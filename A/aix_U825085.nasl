...
if(description)
{
 script_id(38626);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825085";
...
"The remote host is missing AIX PTF U825085 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825085"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825085", package:"devices.common.IBM.sissas.rte.5.3.8.3") < 0 ) 
