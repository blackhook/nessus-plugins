...
if(description)
{
 script_id(44567);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830440";
...
"The remote host is missing AIX PTF U830440 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830440"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830440", package:"bos.net.tcp.server.6.1.4.2") < 0 ) 
