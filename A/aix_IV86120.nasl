...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : nettcp (IV86120) (SLOTH)");
  script_summary(english:"Check for APAR IV86120");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV86120m9a", package:"bos.net.tcp.client", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.10") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV86120m9a", package:"bos.net.tcp.server", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.6") < 0) flag++;
