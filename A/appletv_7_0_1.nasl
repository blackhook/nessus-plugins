...
vulnerabilities :
  ...
  - A error exists that permits unencrypted connections for
    ...
    (CVE-2014-4428)");
  script_set_attribute(attribute:"see_also", value:"https://support.apple.com/en-us/HT203118");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/533746/30/0/threaded");
...
available for 3rd generation and later models.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-4428");
