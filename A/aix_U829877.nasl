...
if(description)
{
 script_id(44457);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829877";
...
"The remote host is missing AIX PTF U829877 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829877"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829877", package:"bos.rte.aio.5.3.11.1") < 0 ) 
