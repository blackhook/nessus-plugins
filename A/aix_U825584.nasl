...
if(description)
{
 script_id(39213);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825584";
...
"The remote host is missing AIX PTF U825584 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825584"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825584", package:"bos.rte.serv_aid.6.1.2.1") < 0 ) 
