...
if(description)
{
 script_id(42592);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829372";
...
"The remote host is missing AIX PTF U829372 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829372"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829372", package:"bos.rte.serv_aid.5.3.9.3") < 0 ) 
