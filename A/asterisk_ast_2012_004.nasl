...
if (description)
{
  ...
  script_cve_id("CVE-2012-2414");
  script_bugtraq_id(53206);

  script_name(english:"Asterisk Manager User Unauthorized Shell Access (AST-2012-004)");
...
that could allow an authenticated, remote attacker to run arbitrary
commands with the credentials of the Asterisk server.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2012-004.html");
  script_set_attribute(attribute:"see_also", value:"https://issues.asterisk.org/jira/browse/ASTERISK-17465");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Asterisk 1.6.2.24 / 1.8.11.1 / 10.3.1 / C.3.7.4 or apply
