...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : nimsh (IJ37419)");
  script_summary(english:"Check for APAR IJ37419");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"07", patch:"IJ37419m9a", package:"bos.sysmgt.nim.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.37") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ37419m9a", package:"bos.sysmgt.nim.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.37") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ37419m9a", package:"bos.sysmgt.nim.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.37") < 0) flag++;
