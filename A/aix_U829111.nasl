...
if(description)
{
 script_id(44441);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829111";
...
"The remote host is missing AIX PTF U829111 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829111"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829111", package:"bos.mp.5.3.11.2") < 0 ) 
