...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : kernel (IJ42938)");
  script_summary(english:"Check for APAR IJ42938");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ42938m1a", package:"bos.cluster.rte", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ42938s2a", package:"bos.cluster.rte", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
