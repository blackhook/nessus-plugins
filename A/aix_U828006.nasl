...
# from AIX Security PTF U828006. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 5 : bos.net.nfs.client (U828006)");
  script_summary(english:"Check for PTF U828006");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U828006, which is related to the
...
"
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ73599");
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610005", patch:"U828006", package:"bos.net.nfs.client.6.1.5.1") < 0 ) flag++;
