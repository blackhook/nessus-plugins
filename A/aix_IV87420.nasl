...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : ntp (IV87420) (deprecated)");
  script_summary(english:"Check for APAR IV87420");
...
if (aix_check_ifix(release:"7.1", ml:"04", sp:"00", patch:"IV87420m0a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"01", patch:"IV87420m0a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"02", patch:"IV87420m2a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.1") < 0) flag++;
