...
if(description)
{
 script_id(43913);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828086";
...
"The remote host is missing AIX PTF U828086 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828086"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828086", package:"devices.chrp.base.rte.6.1.4.2") < 0 ) 
