...
if(description)
{
 script_id(38276);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821386";
...
"The remote host is missing AIX PTF U821386 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821386"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821386", package:"bos.sysmgt.serv_aid.5.3.7.7") < 0 ) 
