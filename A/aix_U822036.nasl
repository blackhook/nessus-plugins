...
if(description)
{
 script_id(38360);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822036";
...
"The remote host is missing AIX PTF U822036 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822036"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822036", package:"bos.rte.aio.5.3.8.4") < 0 ) 
