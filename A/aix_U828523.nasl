...
if(description)
{
 script_id(41844);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828523";
...
"The remote host is missing AIX PTF U828523 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828523"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828523", package:"bos.rte.aio.6.1.1.5") < 0 ) 
