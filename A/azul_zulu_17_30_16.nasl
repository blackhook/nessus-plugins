...
if (description)
{
  ...
  script_name(english:"Azul Zulu Java Multiple Vulnerabilities (2021-10-19)");

  script_set_attribute(attribute:"synopsis", value:
"Azul Zulu OpenJDK is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Azul Zulu installed on the remote host is prior to 6 < 6.43 / 7 < 7.49.0.14 / 8 < 8.57.0.14 / 11 <
11.51.16 / 13 < 13.43.12 / 15 < 15.35.12 / 17 < 17.30.16. It is, therefore, affected by multiple vulnerabilities as
referenced in the 2021-10-19 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://docs.azul.com/core/zulu-openjdk/release-notes/october-2021");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the October 2021 Azul Zulu OpenJDK Patch Update advisory.");
...
{
  var constraints = [
    { 'min_version' : '6.0.0', 'fixed_version' : '6.43', 'fixed_display' : 'Upgrade to a version 6.43 (SA) and above' },
    { 'min_version' : '7.0.0', 'fixed_version' : '7.49.0.14', 'fixed_display' : 'Upgrade to a version 7.49.0.14 (SA) and above' },
    { 'min_version' : '8.0.0', 'fixed_version' : '8.57.0.14', 'fixed_display' : 'Upgrade to a version 8.57.0.14 (SA) and above' },
    { 'min_version' : '11.0.0', 'fixed_version' : '11.51.16', 'fixed_display' : 'Upgrade to a version 11.51.16 (SA) and above' },
    { 'min_version' : '13.0.0', 'fixed_version' : '13.43.12', 'fixed_display' : 'Upgrade to a version 13.43.12 (SA) and above' },
    { 'min_version' : '15.0.0', 'fixed_version' : '15.35.12', 'fixed_display' : 'Upgrade to a version 15.35.12 (SA) and above' },
    { 'min_version' : '17.0.0', 'fixed_version' : '17.30.16', 'fixed_display' : 'Upgrade to a version 17.30.16 (SA) and above' }
  ];
}
else if ('CA' == package_type)
{
  var constraints = [
    { 'min_version' : '7.0.0', 'fixed_version' : '7.50.0.11', 'fixed_display' : 'Upgrade to a version 7.50.0.11 (CA) and above' },
    { 'min_version' : '8.0.0', 'fixed_version' : '8.58.0.13', 'fixed_display' : 'Upgrade to a version 8.58.0.13 (CA) and above' },
    { 'min_version' : '11.0.0', 'fixed_version' : '11.52.13', 'fixed_display' : 'Upgrade to a version 11.52.13 (CA) and above' },
    { 'min_version' : '13.0.0', 'fixed_version' : '13.44.13', 'fixed_display' : 'Upgrade to a version 13.44.13 (CA) and above' },
    { 'min_version' : '15.0.0', 'fixed_version' : '15.36.13', 'fixed_display' : 'Upgrade to a version 15.36.13 (CA) and above' },
    { 'min_version' : '17.0.0', 'fixed_version' : '17.30.15', 'fixed_display' : 'Upgrade to a version 17.30.15 (CA) and above' }
  ];
}
else
{
