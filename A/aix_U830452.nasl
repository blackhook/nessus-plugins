...
if(description)
{
 script_id(44578);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830452";
...
"The remote host is missing AIX PTF U830452 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830452"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830452", package:"devices.scsi.disk.rte.6.1.4.1") < 0 ) 
