...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : malloc (IV62805)");
  script_summary(english:"Checks for APAR IV62805.");
...
"Install the appropriate interim fix. If interim fix IV60935s3a is
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"03", patch:"IV62805s3a", package:"bos.rte.libc", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.15") < 0) flag++;
