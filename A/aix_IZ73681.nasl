...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 11 : pcnfsd (IZ73681)");
  script_summary(english:"Check for APAR IZ73681");
...
if (aix_check_ifix(release:"5.3", ml:"11", patch:"IZ73681_11", package:"bos.net.nfs.client", minfilesetver:"5.3.11.0", maxfilesetver:"5.3.11.3") < 0) flag++;
