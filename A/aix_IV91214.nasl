...
# @DEPRECATED@
#
# Disabled on 2017/07/20. Deprecated by aix_bind_advisory14.nasl.
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : bind (IV91214) (deprecated)");
  script_summary(english:"Check for APAR IV91214");
...
supersedence with replacement plugin aix_bind_advisory14.nasl (plugin
id 102126)."
  );
  script_set_attribute(
    attribute:"see_also",
...
exit(0, "This plugin has been deprecated. Use aix_bind_advisory14.nasl (plugin ID 102126) instead.");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"04", patch:"IV91214m4b", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.48") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV91214m5b", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.48") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV91214m6a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.48") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV91214m7b", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.48") < 0) flag++;
