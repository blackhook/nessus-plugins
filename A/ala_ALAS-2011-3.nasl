...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-3.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-3");
  script_xref(name:"RHSA", value:"2011:1248");

  script_name(english:"Amazon Linux AMI : ca-certificates (ALAS-2011-3)");
