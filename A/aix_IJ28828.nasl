...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : gencore (IJ28828)");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"00", patch:"(IJ28828m1a|IJ31049m1a)", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"01", patch:"(IJ28828m1a|IJ31049m1a)", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
