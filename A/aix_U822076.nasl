...
if(description)
{
 script_id(38400);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822076";
...
"The remote host is missing AIX PTF U822076 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822076"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822076", package:"bos.sysmgt.serv_aid.5.3.8.4") < 0 ) 
