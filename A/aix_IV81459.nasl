...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : mustendd (IV81459)");
  script_summary(english:"Check for APAR IV81459");
...
if (aix_check_ifix(release:"7.1", ml:"04", sp:"00", patch:"IV81459s1b", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.0") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"01", patch:"IV81459s1b", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.0") < 0) flag++;
