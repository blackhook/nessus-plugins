...
if(description)
{
 script_id(32292);
 script_version("1.6");
 name["english"] = "AIX 520010 : U815081";
...
script_set_attribute(attribute:"plugin_modification_date", value:"2021/01/05");
 ...
 summary["english"] = "Check for PTF U815081"; 
...
if ( aix_check_patch(ml:"520010", patch:"U815081", package:"devices.pci.1410ff01.rte.5.2.0.106") < 0 ) 
