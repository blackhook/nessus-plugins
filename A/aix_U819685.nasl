...
if(description)
{
 script_id(34858);
 script_version("1.6");
 name["english"] = "AIX 610000 : U819685";
...
"The remote host is missing AIX PTF U819685 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819685"; 
...
if ( aix_check_patch(ml:"610000", patch:"U819685", package:"bos.rte.serv_aid.6.1.0.6") < 0 ) 
