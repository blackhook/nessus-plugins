...
if(description)
{
 script_id(43523);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828769";
...
"The remote host is missing AIX PTF U828769 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828769"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828769", package:"devices.common.IBM.sissas.rte.6.1.3.2") < 0 ) 
