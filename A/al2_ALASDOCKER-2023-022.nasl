...
var pkgs = [
    {'reference':'docker-20.10.23-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'docker-20.10.23-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'docker-debuginfo-20.10.23-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'docker-debuginfo-20.10.23-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'}
];
