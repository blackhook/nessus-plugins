...
# from AIX Security PTF U817175. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 : bos.acct (U817175)");
  script_summary(english:"Check for PTF U817175");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U817175, which is related to the
...
/usr/bin/iostat."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ22349"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610000", patch:"U817175", package:"bos.acct.6.1.0.5") < 0 ) flag++;
