...
if(description)
{
 script_id(35495);
 script_version("1.6");
 name["english"] = "AIX 520010 : U820241";
...
"The remote host is missing AIX PTF U820241 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820241"; 
...
if ( aix_check_patch(ml:"520010", patch:"U820241", package:"bos.net.tcp.server.5.2.0.110") < 0 ) 
