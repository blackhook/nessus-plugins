...
if(description)
{
 script_id(34544);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819440";
...
"The remote host is missing AIX PTF U819440 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819440"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819440", package:"bos.sysmgt.serv_aid.5.3.0.69") < 0 ) 
