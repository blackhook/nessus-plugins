...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : sendmail (IZ72836)");
  script_summary(english:"Check for APAR IZ72836");
...
if (aix_check_ifix(release:"5.3", ml:"10", patch:"IZ72836_10", package:"bos.net.tcp.client", minfilesetver:"5.3.10.0", maxfilesetver:"5.3.10.2") < 0) flag++;
