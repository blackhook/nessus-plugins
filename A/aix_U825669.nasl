...
if(description)
{
 script_id(39251);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825669";
...
"The remote host is missing AIX PTF U825669 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825669"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825669", package:"bos.rte.serv_aid.6.1.1.4") < 0 ) 
