...
if(description)
{
 script_id(44544);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829965";
...
"The remote host is missing AIX PTF U829965 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829965"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829965", package:"devices.pciex.14103f03.diag.5.3.11.1") < 0 ) 
