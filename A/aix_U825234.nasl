...
if(description)
{
 script_id(39738);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825234";
...
"The remote host is missing AIX PTF U825234 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825234"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825234", package:"devices.pciex.8680c71014108003.rte.5.3.9.2") < 0 ) 
