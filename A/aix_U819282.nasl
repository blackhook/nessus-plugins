...
if(description)
{
 script_id(33664);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819282";
...
"The remote host is missing AIX PTF U819282 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819282"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819282", package:"bos.pmapi.pmsvcs.5.3.7.1") < 0 ) 
