...
# from AIX Security PTF U860787. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : bos.rte.odm (U860787)");
  script_summary(english:"Check for PTF U860787");
...
to libodm.a bug."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV60312"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710001", patch:"U860787", package:"bos.rte.odm.7.1.1.17") < 0 ) flag++;
