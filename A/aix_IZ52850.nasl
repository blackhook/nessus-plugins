...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : libtt (IZ52850)");
  script_summary(english:"Check for APAR IZ52850");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ52850_02", package:"X11.Dt.ToolTalk", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.0") < 0) flag++;
