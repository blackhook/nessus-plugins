...
if(description)
{
 script_id(38248);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820033";
...
"The remote host is missing AIX PTF U820033 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820033"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820033", package:"devices.chrp.base.rte.5.3.9.2") < 0 ) 
