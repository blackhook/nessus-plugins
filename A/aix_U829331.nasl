...
if(description)
{
 script_id(44299);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829331";
...
"The remote host is missing AIX PTF U829331 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829331"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829331", package:"bos.rte.libpthreads.5.3.10.1") < 0 ) 
