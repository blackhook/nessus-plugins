...
if(description)
{
 script_id(42669);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829496";
...
"The remote host is missing AIX PTF U829496 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829496"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829496", package:"devices.iscsi_sw.rte.5.3.8.3") < 0 ) 
