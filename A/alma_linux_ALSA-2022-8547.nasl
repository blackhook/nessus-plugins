...
# AlmaLinux Security Advisory ALSA-2022:8547.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8547");
  script_xref(name:"IAVA", value:"2022-A-0492-S");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2022:8547)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-8547.html");
...
var pkgs = [
    {'reference':'thunderbird-102.5.0-2.el8_7.alma.plus', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.5.0-2.el8_7.alma.plus', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
