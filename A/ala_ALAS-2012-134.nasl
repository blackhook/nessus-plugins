...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-134.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-134");
  script_xref(name:"RHSA", value:"2012:1288");

  script_name(english:"Amazon Linux AMI : libxml2 (ALAS-2012-134)");
...
of the user running the application. (CVE-2011-3102)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-134.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libxml2-2.7.8-9.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-debuginfo-2.7.8-9.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-devel-2.7.8-9.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-python-2.7.8-9.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-static-2.7.8-9.22.amzn1")) flag++;
