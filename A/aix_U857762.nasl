...
# from AIX Security PTF U857762. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : devices.common.IBM.ib.rte (U857762)");
  script_summary(english:"Check for PTF U857762");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U857762, which is related to the
...
authority."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV43582"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV43828"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610006", patch:"U857762", package:"devices.common.IBM.ib.rte.6.1.6.22") < 0 ) flag++;
