...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-484.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-484");

  script_name(english:"Amazon Linux AMI : puppet (ALAS-2015-484)");
...
puppet/confine."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2015-484.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"puppet-2.7.25-1.4.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"puppet-server-2.7.25-1.4.amzn1")) flag++;
