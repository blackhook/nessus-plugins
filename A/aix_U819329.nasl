...
if(description)
{
 script_id(34531);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819329";
...
"The remote host is missing AIX PTF U819329 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819329"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819329", package:"devices.pciex.8680c71014108003.rte.5.3.7.1") < 0 ) 
