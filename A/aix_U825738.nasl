...
if(description)
{
 script_id(41682);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825738";
...
"The remote host is missing AIX PTF U825738 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825738"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825738", package:"bos.rte.install.6.1.1.7") < 0 ) 
