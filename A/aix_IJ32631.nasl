...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ32631)");
  script_summary(english:"Check for APAR IJ32631");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"01", patch:"IJ32631m1a", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ32631s2a", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.3") < 0) flag++;
