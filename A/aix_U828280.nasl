...
if(description)
{
 script_id(41717);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828280";
...
"The remote host is missing AIX PTF U828280 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828280"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828280", package:"bos.rte.bind_cmds.6.1.2.4") < 0 ) 
