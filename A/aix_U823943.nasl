...
if(description)
{
 script_id(39091);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823943";
...
"The remote host is missing AIX PTF U823943 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823943"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823943", package:"bos.rte.bind_cmds.6.1.1.5") < 0 ) 
