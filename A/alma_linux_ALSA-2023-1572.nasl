...
# AlmaLinux Security Advisory ALSA-2023:1572.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:1572");

  script_name(english:"AlmaLinux 8 : pesign (ALSA-2023:1572)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-1572.html");
...
"Update the affected pesign package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:pesign");
