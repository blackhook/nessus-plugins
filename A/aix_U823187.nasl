...
if(description)
{
 script_id(44161);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823187";
...
"The remote host is missing AIX PTF U823187 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823187"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823187", package:"bos.rte.bind_cmds.5.3.10.1") < 0 ) 
