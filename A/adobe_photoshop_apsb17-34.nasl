...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 18.x < 18.1.2  Multiple Vulnerabilities (APSB17-12)");
...
is 18.x prior to 18.1.2 (2017.1.2). It is, therefore, affected by
multiple vulnerabilities. This includes two remote code execution
vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/photoshop/apsb17-34.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Adobe Photoshop CC 18.1.2 (2017.1.2) or later.");
...
if ( ver =~ "^18\." )
  ...
  audit(AUDIT_NOT_INST, app_name + " 18.x");
