...
# from AIX Security PTF U857552. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : devices.common.IBM.ib.rte (U857552)");
  script_summary(english:"Check for PTF U857552");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U857552, which is related to the
...
authority."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV43561"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV43829"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710002", patch:"U857552", package:"devices.common.IBM.ib.rte.7.1.2.16") < 0 ) flag++;
