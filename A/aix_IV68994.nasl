...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : bind9 (IV68994)");
  script_summary(english:"Check for APAR IV68994");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"04", patch:"IV68994s4a", package:"bos.net.tcp.server", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.30") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"04", patch:"IV68994s4a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.30") < 0) flag++;
