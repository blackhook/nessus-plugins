...
# AlmaLinux Security Advisory ALSA-2022:1932.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:1932");

  script_name(english:"AlmaLinux 8 : python-lxml (ALSA-2022:1932)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-1932.html");
