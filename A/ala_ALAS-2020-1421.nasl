...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : python26-rsa (ALAS-2020-1421)");
...
vulnerability as referenced in the ALAS-2020-1421 advisory.
...
pkgs = [
    {'reference':'python26-rsa-3.4.1-1.9.amzn1', 'release':'ALA'},
    {'reference':'python27-rsa-3.4.1-1.9.amzn1', 'release':'ALA'}
];
