...
if(description)
{
 script_id(43316);
 script_version("1.5");
 name["english"] = "AIX 610002 : U831071";
...
"The remote host is missing AIX PTF U831071 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U831071"; 
...
if ( aix_check_patch(ml:"610002", patch:"U831071", package:"bos.rte.net.6.1.2.1") < 0 ) 
