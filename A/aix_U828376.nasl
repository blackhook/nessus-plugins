...
if(description)
{
 script_id(43188);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828376";
...
"The remote host is missing AIX PTF U828376 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828376"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828376", package:"devices.common.IBM.sissas.rte.6.1.2.5") < 0 ) 
