...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : ntp (IV68426)");
  script_summary(english:"Check for APAR IV68426");
...
if (aix_check_ifix(release:"6.1", ml:"08", sp:"05", patch:"IV68426m5b", package:"bos.net.tcp.client", minfilesetver:"6.1.8.0", maxfilesetver:"6.1.8.19") < 0) flag++;
