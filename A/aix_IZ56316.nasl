...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : bind (IZ56316)");
  script_summary(english:"Check for APAR IZ56316");
...
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ56316_01", package:"bos.net.tcp.server", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.5") < 0) flag++;
