...
if(description)
{
 script_id(44013);
 script_version("1.5");
 name["english"] = "AIX 610004 : U830390";
...
"The remote host is missing AIX PTF U830390 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830390"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830390", package:"bos.rte.serv_aid.6.1.4.1") < 0 ) 
