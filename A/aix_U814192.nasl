...
# from AIX Security PTF U814192. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 6 : printers.rte (U814192)");
  script_summary(english:"Check for PTF U814192");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U814192, which is related to the
...
command is vulnerable: /usr/lib/lpd/pio/etc/piomkpq."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ10841"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530006", patch:"U814192", package:"printers.rte.5.3.0.63") < 0 ) flag++;
