...
if (description)
{
  ...
  script_name(english:"Adobe Photoshop CC 18.x < 18.1.6 / 19.x < 19.1.6 Multiple Vulnerabilities (APSB18-28)");
...
is 18.x prior to 18.1.6 (2017.1.6) or 19.x prior to 19.1.6 (2018.1.6).
It is, therefore, affected by two unspecified remote code execution
vulnerabilities.");
