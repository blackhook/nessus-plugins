...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : sysproc (IV91456)");
  script_summary(english:"Check for APAR IV91456");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"00", patch:"IV91456s0a", package:"bos.mp64", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"01", patch:"IV91456s1a", package:"bos.mp64", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV91456s2a", package:"bos.mp64", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
