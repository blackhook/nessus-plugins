...
if(description)
{
 script_id(33731);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819422";
...
"The remote host is missing AIX PTF U819422 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819422"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819422", package:"bos.alt_disk_install.boot_images.5.3.0.63") < 0 ) 
