...
if(description)
{
 script_id(43974);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828151";
...
"The remote host is missing AIX PTF U828151 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828151"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828151", package:"bos.net.tcp.server.6.1.4.1") < 0 ) 
