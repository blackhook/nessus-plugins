...
if(description)
{
 script_id(42581);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829361";
...
"The remote host is missing AIX PTF U829361 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829361"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829361", package:"devices.iscsi_sw.rte.5.3.9.2") < 0 ) 
