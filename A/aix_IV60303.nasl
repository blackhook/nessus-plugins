...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : libodm (IV60303)");
  script_summary(english:"Check for APAR IV60303");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"02", patch:"IV60303s2a", package:"bos.rte.odm", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.0") < 0) flag++;
