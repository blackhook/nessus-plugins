...
if(description)
{
 script_id(45332);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830231";
...
"The remote host is missing AIX PTF U830231 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830231"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830231", package:"devices.iscsi_sw.rte.5.3.9.3") < 0 ) 
