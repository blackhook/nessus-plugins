...
if(description)
{
 script_id(44440);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829110";
...
"The remote host is missing AIX PTF U829110 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829110"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829110", package:"bos.sysmgt.serv_aid.5.3.11.1") < 0 ) 
