...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : cmsd (IZ62571)");
  script_summary(english:"Check for APAR IZ62571");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ62571_02", package:"X11.Dt.rte", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.1") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ62571_02", package:"X11.Dt.lib", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.1") < 0) flag++;
