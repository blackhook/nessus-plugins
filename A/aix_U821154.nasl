...
if(description)
{
 script_id(34641);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821154";
...
"The remote host is missing AIX PTF U821154 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821154"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821154", package:"devices.pci.14106902.rte.5.3.0.67") < 0 ) 
