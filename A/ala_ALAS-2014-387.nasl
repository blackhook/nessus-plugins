...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-387.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-387");
  script_xref(name:"RHSA", value:"2014:0907");

  script_name(english:"Amazon Linux AMI : java-1.6.0-openjdk (ALAS-2014-387)");
...
allowing an attacker to recover the negotiated key. (CVE-2014-4263)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-387.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-1.6.0.0-67.1.13.4.65.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-debuginfo-1.6.0.0-67.1.13.4.65.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-demo-1.6.0.0-67.1.13.4.65.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-devel-1.6.0.0-67.1.13.4.65.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-javadoc-1.6.0.0-67.1.13.4.65.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-src-1.6.0.0-67.1.13.4.65.amzn1")) flag++;
