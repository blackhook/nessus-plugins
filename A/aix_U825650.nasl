...
if(description)
{
 script_id(39233);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825650";
...
"The remote host is missing AIX PTF U825650 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825650"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825650", package:"devices.pci.77102224.com.6.1.1.3") < 0 ) 
