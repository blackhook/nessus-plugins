...
if(description)
{
 script_id(34870);
 script_version("1.6");
 name["english"] = "AIX 610000 : U819697";
...
"The remote host is missing AIX PTF U819697 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819697"; 
...
if ( aix_check_patch(ml:"610000", patch:"U819697", package:"devices.pci.1410d002.diag.6.1.0.1") < 0 ) 
