...
if(description)
{
 script_id(42543);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825272";
...
"The remote host is missing AIX PTF U825272 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825272"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825272", package:"devices.pci.14106902.rte.5.3.9.3") < 0 ) 
