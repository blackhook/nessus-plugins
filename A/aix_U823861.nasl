...
if(description)
{
 script_id(39039);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823861";
...
"The remote host is missing AIX PTF U823861 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823861"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823861", package:"devices.iscsi_sw.rte.6.1.0.4") < 0 ) 
