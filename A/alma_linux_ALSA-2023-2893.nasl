...
# AlmaLinux Security Advisory ALSA-2023:2893.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2893");

  script_name(english:"AlmaLinux 8 : python-mako (ALSA-2023:2893)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-2893.html");
...
"Update the affected python3-mako package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:python3-mako");
