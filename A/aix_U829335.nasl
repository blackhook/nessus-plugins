...
if(description)
{
 script_id(45142);
 script_version("1.4");
 name["english"] = "AIX 530010 : U829335";
...
"The remote host is missing AIX PTF U829335 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829335"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829335", package:"bos.mp.5.3.10.3") < 0 ) 
