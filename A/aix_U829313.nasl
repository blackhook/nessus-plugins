...
# from AIX Security PTF U829313. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : X11.Dt.ToolTalk (U829313)");
  script_summary(english:"Check for PTF U829313");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U829313, which is related to the
security of the package X11.Dt.ToolTalk."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ52847"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530010", patch:"U829313", package:"X11.Dt.ToolTalk.5.3.10.1") < 0 ) flag++;
