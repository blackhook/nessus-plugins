...
if(description)
{
 script_id(38245);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820030";
...
"The remote host is missing AIX PTF U820030 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820030"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820030", package:"devices.pci.14106902.rte.5.3.9.1") < 0 ) 
