...
if(description)
{
 script_id(34553);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819449";
...
"The remote host is missing AIX PTF U819449 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819449"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819449", package:"bos.64bit.5.3.0.69") < 0 ) 
