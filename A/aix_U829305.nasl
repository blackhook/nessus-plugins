...
if(description)
{
 script_id(44274);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829305";
...
"The remote host is missing AIX PTF U829305 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829305"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829305", package:"devices.common.IBM.fc.rte.5.3.10.1") < 0 ) 
