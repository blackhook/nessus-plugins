...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : ftpd (IZ83274)");
  script_summary(english:"Check for APAR IZ83274");
...
if (aix_check_ifix(release:"5.3", ml:"10", patch:"IZ83274_10", package:"bos.net.tcp.client", minfilesetver:"5.3.10.0", maxfilesetver:"5.3.10.4") < 0) flag++;
