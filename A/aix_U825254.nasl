...
if(description)
{
 script_id(42525);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825254";
...
"The remote host is missing AIX PTF U825254 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825254"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825254", package:"bos.mp.5.3.9.5") < 0 ) 
