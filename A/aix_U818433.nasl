...
if(description)
{
 script_id(35843);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818433";
...
"The remote host is missing AIX PTF U818433 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818433"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818433", package:"devices.ide.cdrom.rte.6.1.0.4") < 0 ) 
