...
if(description)
{
 script_id(44292);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829323";
...
"The remote host is missing AIX PTF U829323 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829323"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829323", package:"bos.rte.aio.5.3.10.1") < 0 ) 
