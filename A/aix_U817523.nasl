...
if(description)
{
 script_id(32295);
 script_version("1.6");
 name["english"] = "AIX 520010 : U817523";
...
script_set_attribute(attribute:"plugin_modification_date", value:"2021/01/05");
 ...
 summary["english"] = "Check for PTF U817523"; 
...
if ( aix_check_patch(ml:"520010", patch:"U817523", package:"devices.scsi.disk.rte.5.2.0.109") < 0 ) 
