...
# AlmaLinux Security Advisory ALSA-2022:6175.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:6175");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2022:6175)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-6175.html");
...
var pkgs = [
    {'reference':'firefox-91.13.0-1.el8_6.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-91.13.0-1.el8_6.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
