...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-424.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-424");

  script_name(english:"Amazon Linux AMI : nss (ALAS-2014-424)");
...
signature to an application using NSS."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-424.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nss-3.16.2-7.49.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-debuginfo-3.16.2-7.49.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-devel-3.16.2-7.49.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-pkcs11-devel-3.16.2-7.49.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-sysinit-3.16.2-7.49.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-tools-3.16.2-7.49.amzn1")) flag++;
