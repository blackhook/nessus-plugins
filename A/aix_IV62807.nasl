...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : malloc (IV62807)");
  script_summary(english:"Checks for APAR IV62807.");
...
"Install the appropriate interim fix. If interim fix IV61314s4a is
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"04", patch:"IV62807s4a", package:"bos.rte.libc", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.17") < 0) flag++;
