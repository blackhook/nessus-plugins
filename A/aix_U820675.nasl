...
if(description)
{
 script_id(35866);
 script_version("1.6");
 name["english"] = "AIX 610000 : U820675";
...
"The remote host is missing AIX PTF U820675 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820675"; 
...
if ( aix_check_patch(ml:"610000", patch:"U820675", package:"bos.perf.tools.6.1.0.8") < 0 ) 
