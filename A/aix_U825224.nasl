...
if(description)
{
 script_id(39728);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825224";
...
"The remote host is missing AIX PTF U825224 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825224"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825224", package:"bos.acct.5.3.9.2") < 0 ) 
