...
if(description)
{
 script_id(38568);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824993";
...
"The remote host is missing AIX PTF U824993 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824993"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824993", package:"devices.pci.14106902.rte.5.3.7.6") < 0 ) 
