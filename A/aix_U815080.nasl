...
if(description)
{
 script_id(32291);
 script_version("1.6");
 name["english"] = "AIX 520010 : U815080";
...
script_set_attribute(attribute:"plugin_modification_date", value:"2021/01/05");
 ...
 summary["english"] = "Check for PTF U815080"; 
...
if ( aix_check_patch(ml:"520010", patch:"U815080", package:"devices.iscsi_sw.rte.5.2.0.107") < 0 ) 
