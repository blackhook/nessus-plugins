...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : at (IZ43455)");
  script_summary(english:"Check for APAR IZ43455");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ43455_08", package:"bos.rte.cron", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.1") < 0) flag++;
