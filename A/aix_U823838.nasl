...
if(description)
{
 script_id(39016);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823838";
...
"The remote host is missing AIX PTF U823838 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823838"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823838", package:"bos.rte.install.6.1.0.9") < 0 ) 
