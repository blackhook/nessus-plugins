...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-451.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-451");

  script_name(english:"Amazon Linux AMI : php55 (ALAS-2014-451)");
...
application using fileinfo via a specially crafted ELF file."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-451.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"php55-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-bcmath-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-cli-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-common-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-dba-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-debuginfo-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-devel-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-embedded-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-enchant-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-fpm-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-gd-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-gmp-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-imap-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-intl-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-ldap-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mbstring-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mcrypt-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mssql-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-mysqlnd-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-odbc-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-opcache-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-pdo-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-pgsql-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-process-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-pspell-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-recode-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-snmp-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-soap-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-tidy-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-xml-5.5.19-2.93.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php55-xmlrpc-5.5.19-2.93.amzn1")) flag++;
