...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : kernel (IJ43875)");
  script_summary(english:"Check for APAR IJ43875");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ43875m1b", package:"bos.mp64", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.4") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ43875m2b", package:"bos.mp64", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.4") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"03", patch:"IJ43875s3a", package:"bos.mp64", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.4") < 0) flag++;
