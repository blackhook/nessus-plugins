...
if(description)
{
 script_id(45252);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830137";
...
"The remote host is missing AIX PTF U830137 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830137"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830137", package:"bos.rte.serv_aid.5.3.10.2") < 0 ) 
