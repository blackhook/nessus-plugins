...
if(description)
{
 script_id(38504);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824826";
...
"The remote host is missing AIX PTF U824826 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824826"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824826", package:"devices.ide.cdrom.rte.5.3.9.1") < 0 ) 
