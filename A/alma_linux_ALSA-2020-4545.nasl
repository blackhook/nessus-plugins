...
# AlmaLinux Security Advisory ALSA-2020:4545.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:4545");
  script_xref(name:"IAVA", value:"2020-A-0203");

  script_name(english:"AlmaLinux 8 : libssh (ALSA-2020:4545)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
ALSA-2020:4545 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-4545.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected libssh and / or libssh-config packages.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libssh / libssh-config');
}
