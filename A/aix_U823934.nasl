...
if(description)
{
 script_id(39082);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823934";
...
"The remote host is missing AIX PTF U823934 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823934"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823934", package:"perfagent.tools.6.1.1.3") < 0 ) 
