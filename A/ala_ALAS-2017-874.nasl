...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-874.
#
...
if (description)
{
  ...
  script_cve_id("CVE-2017-10970", "CVE-2017-12065", "CVE-2017-12066");
  script_xref(name:"ALAS", value:"2017-874");

  script_name(english:"Amazon Linux AMI : cacti (ALAS-2017-874)");
...
lib/html_validate.php. (CVE-2017-10970)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-874.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"cacti-1.1.16-1.16.amzn1")) flag++;
