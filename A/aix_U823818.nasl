...
if(description)
{
 script_id(35888);
 script_version("1.6");
 name["english"] = "AIX 610000 : U823818";
...
"The remote host is missing AIX PTF U823818 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823818"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823818", package:"perfagent.tools.6.1.0.4") < 0 ) 
