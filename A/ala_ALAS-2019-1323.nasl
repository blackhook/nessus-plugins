...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:"Remotely exploitable NULL pointer dereference bug (CVE-2019-12412)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2019-1323.html"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Run 'yum update libapreq2' to update your system."
  );
