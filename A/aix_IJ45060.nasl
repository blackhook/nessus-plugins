...
if (aix_check_ifix(release:"7.3", ml:"01", sp:"01", patch:"IJ45060s1a", package:"bos.rte.control", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"01", sp:"02", patch:"IJ45060s2a", package:"bos.rte.control", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.1") < 0) flag++;
