...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-935.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-935");

  script_name(english:"Amazon Linux AMI : sssd (ALAS-2017-935)");
...
use this flaw to retrieve it. (CVE-2017-12173)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-935.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libipa_hbac-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libipa_hbac-devel-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_autofs-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_certmap-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_certmap-devel-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_idmap-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_idmap-devel-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_nss_idmap-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_nss_idmap-devel-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_simpleifp-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_simpleifp-devel-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsss_sudo-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-libipa_hbac-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-libsss_nss_idmap-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-sss-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-sss-murmur-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-sssdconfig-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-ad-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-client-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-common-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-common-pac-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-dbus-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-debuginfo-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-ipa-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-krb5-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-krb5-common-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-ldap-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-libwbclient-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-libwbclient-devel-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-proxy-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-tools-1.15.2-50.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sssd-winbind-idmap-1.15.2-50.34.amzn1")) flag++;
