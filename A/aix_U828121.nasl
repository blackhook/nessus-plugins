...
if(description)
{
 script_id(43945);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828121";
...
"The remote host is missing AIX PTF U828121 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828121"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828121", package:"bos.net.nfs.cachefs.6.1.4.2") < 0 ) 
