...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-453.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-453");

  script_name(english:"Amazon Linux AMI : file (ALAS-2014-453)");
...
application using fileinfo via a specially crafted ELF file."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-453.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"file-5.19-7.24.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-debuginfo-5.19-7.24.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-devel-5.19-7.24.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-libs-5.19-7.24.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-static-5.19-7.24.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python-magic-5.19-7.24.amzn1")) flag++;
