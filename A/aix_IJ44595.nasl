...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 1 : kernel (IJ44595)");
  script_summary(english:"Check for APAR IJ44595");
...
if (aix_check_ifix(release:"7.3", ml:"01", sp:"01", patch:"IJ44595s1a", package:"bos.perf.perfstat", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.1") < 0) flag++;
