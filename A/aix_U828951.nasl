...
if(description)
{
 script_id(43288);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828951";
...
"The remote host is missing AIX PTF U828951 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828951"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828951", package:"devices.fcp.tape.rte.6.1.1.5") < 0 ) 
