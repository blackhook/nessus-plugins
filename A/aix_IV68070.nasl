...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : lvm (IV68070)");
  script_summary(english:"Check for APAR IV68070");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV68070s9b", package:"bos.rte.lvm", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.8") < 0) flag++;
