...
if(description)
{
 script_id(34614);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821108";
...
"The remote host is missing AIX PTF U821108 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821108"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821108", package:"bos.adt.debug.5.3.7.2") < 0 ) 
