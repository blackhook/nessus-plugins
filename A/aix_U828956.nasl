...
if(description)
{
 script_id(43293);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828956";
...
"The remote host is missing AIX PTF U828956 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828956"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828956", package:"devices.common.IBM.sissas.rte.6.1.1.5") < 0 ) 
