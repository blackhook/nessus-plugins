...
if(description)
{
 script_id(35165);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821936";
...
"The remote host is missing AIX PTF U821936 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821936"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821936", package:"bos.rte.filesystem.5.3.0.69") < 0 ) 
