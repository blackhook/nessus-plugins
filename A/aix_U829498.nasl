...
if(description)
{
 script_id(42671);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829498";
...
"The remote host is missing AIX PTF U829498 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829498"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829498", package:"devices.pciex.8680c71014108003.rte.5.3.8.4") < 0 ) 
