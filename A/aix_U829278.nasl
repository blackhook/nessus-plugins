...
if(description)
{
 script_id(44247);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829278";
...
"The remote host is missing AIX PTF U829278 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829278"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829278", package:"devices.pci.1410bd02.diag.5.3.10.1") < 0 ) 
