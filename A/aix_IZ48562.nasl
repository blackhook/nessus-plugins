...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : muxatmd (IZ48562)");
  script_summary(english:"Check for APAR IZ48562");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ48562_02", package:"devices.common.IBM.atm.rte", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.0") < 0) flag++;
