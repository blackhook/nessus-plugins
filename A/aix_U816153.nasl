...
if(description)
{
 script_id(31870);
 script_version("1.7");
 name["english"] = "AIX 610000 : U816153";
...
"The remote host is missing AIX PTF U816153 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U816153"; 
...
if ( aix_check_patch(ml:"610000", patch:"U816153", package:"devices.common.IBM.atm.rte.6.1.0.1") < 0 ) 
