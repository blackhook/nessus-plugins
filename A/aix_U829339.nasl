...
if(description)
{
 script_id(45145);
 script_version("1.4");
 name["english"] = "AIX 530010 : U829339";
...
"The remote host is missing AIX PTF U829339 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829339"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829339", package:"devices.pci.14106902.rte.5.3.10.3") < 0 ) 
