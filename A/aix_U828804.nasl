...
if(description)
{
 script_id(43554);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828804";
...
"The remote host is missing AIX PTF U828804 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828804"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828804", package:"bos.64bit.6.1.3.2") < 0 ) 
