...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 3 : qoslist (IZ71554)");
  script_summary(english:"Check for APAR IZ71554");
...
if (aix_check_ifix(release:"6.1", ml:"03", patch:"IZ71554_03", package:"bos.net.tcp.server", minfilesetver:"6.1.3.0", maxfilesetver:"6.1.3.2") < 0) flag++;
