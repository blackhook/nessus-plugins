...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator 26.x < 26.0.0 Multiple Vulnerabilities (APSB21-98)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Illustrator installed on remote Windows host is affected by multiple vulnerabilities");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Illustrator installed on the remote Windows host is prior to 26.0.0. It is, therefore, affected by
multiple vulnerabilities as referenced in the apsb21-98 advisory. Note that Nessus has not tested for this issue but has
...
"Upgrade to Adobe Illustrator version 26.0.0 or later.");
...
var constraints = [
  {'fixed_version': '25.4.2', 'fixed_display': '26.0.0'}
];
