...
if(description)
{
 script_id(43508);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828751";
...
"The remote host is missing AIX PTF U828751 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828751"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828751", package:"devices.scsi.disk.rte.6.1.3.2") < 0 ) 
