...
if(description)
{
 script_id(39223);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825596";
...
"The remote host is missing AIX PTF U825596 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825596"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825596", package:"devices.common.IBM.sissas.rte.6.1.2.3") < 0 ) 
