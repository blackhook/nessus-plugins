...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : nimsh (IJ37705)");
  script_summary(english:"Check for APAR IJ37705");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"03", patch:"IJ37705m4a", package:"bos.sysmgt.nim.client", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"04", patch:"IJ37705m4a", package:"bos.sysmgt.nim.client", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"05", patch:"IJ37705m5a", package:"bos.sysmgt.nim.client", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.4") < 0) flag++;
