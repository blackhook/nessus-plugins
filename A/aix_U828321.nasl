...
if(description)
{
 script_id(41757);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828321";
...
"The remote host is missing AIX PTF U828321 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828321"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828321", package:"bos.perf.proctools.6.1.2.2") < 0 ) 
