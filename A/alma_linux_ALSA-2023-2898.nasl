...
# AlmaLinux Security Advisory ALSA-2023:2898.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2898");

  script_name(english:"AlmaLinux 8 : libtar (ALSA-2023:2898)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-2898.html");
...
"Update the affected libtar package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:libtar");
