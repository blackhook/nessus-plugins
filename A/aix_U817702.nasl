...
# from AIX Security PTF U817702. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : bos.acct (U817702)");
  script_summary(english:"Check for PTF U817702");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U817702, which is related to the
...
/usr/bin/iostat."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ22351"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530007", patch:"U817702", package:"bos.acct.5.3.7.4") < 0 ) flag++;
