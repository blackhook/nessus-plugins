...
if (description)
{
  ...
  script_bugtraq_id(60412, 61287);

  script_name(english:"AIX 6.1 TL 6 : infiniband (IV43582)");
  script_summary(english:"Check for APAR IV43582");
...
authority."
  ...
  # https://aix.software.ibm.com/aix/efixes/security/infiniband_advisory.asc
  script_set_attribute(
    attribute:"see_also",
...
if (aix_check_ifix(release:"6.1", ml:"06", sp:"11", patch:"iv43582mBa", package:"devices.common.IBM.ib.rte", minfilesetver:"6.1.6.0", maxfilesetver:"6.1.6.21") < 0) flag++;
