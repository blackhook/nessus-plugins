...
if(description)
{
 script_id(44280);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829311";
...
"The remote host is missing AIX PTF U829311 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829311"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829311", package:"devices.ide.cdrom.rte.5.3.10.1") < 0 ) 
