...
if(description)
{
 script_id(38244);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820029";
...
"The remote host is missing AIX PTF U820029 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820029"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820029", package:"devices.iscsi_sw.rte.5.3.9.1") < 0 ) 
