...
if(description)
{
 script_id(43241);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828846";
...
"The remote host is missing AIX PTF U828846 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828846"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828846", package:"devices.fcp.tape.rte.6.1.2.4") < 0 ) 
