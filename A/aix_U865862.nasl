...
# from AIX Security PTF U865862. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : bos.rte.lvm (U865862)");
  script_summary(english:"Check for PTF U865862");
...
allow a local user to gain root privileges."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV67907"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610009", patch:"U865862", package:"bos.rte.lvm.6.1.9.45") < 0 ) flag++;
