...
if(description)
{
 script_id(45245);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830130";
...
"The remote host is missing AIX PTF U830130 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830130"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830130", package:"bos.perf.proctools.5.3.10.2") < 0 ) 
