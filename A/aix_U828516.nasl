...
if(description)
{
 script_id(41837);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828516";
...
"The remote host is missing AIX PTF U828516 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828516"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828516", package:"bos.perf.proctools.6.1.1.2") < 0 ) 
