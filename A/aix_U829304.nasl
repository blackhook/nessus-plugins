...
if(description)
{
 script_id(44273);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829304";
...
"The remote host is missing AIX PTF U829304 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829304"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829304", package:"bos.net.nfs.cachefs.5.3.10.1") < 0 ) 
