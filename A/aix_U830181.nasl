...
if(description)
{
 script_id(45282);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830181";
...
"The remote host is missing AIX PTF U830181 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830181"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830181", package:"devices.pciex.b3154a63.rte.5.3.9.6") < 0 ) 
