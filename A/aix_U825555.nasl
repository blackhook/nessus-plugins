...
if(description)
{
 script_id(39185);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825555";
...
"The remote host is missing AIX PTF U825555 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825555"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825555", package:"devices.pci.77102224.com.6.1.2.2") < 0 ) 
