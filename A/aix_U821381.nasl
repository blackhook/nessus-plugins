...
if(description)
{
 script_id(38271);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821381";
...
"The remote host is missing AIX PTF U821381 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821381"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821381", package:"devices.iscsi_sw.rte.5.3.7.3") < 0 ) 
