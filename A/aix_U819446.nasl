...
if(description)
{
 script_id(34550);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819446";
...
"The remote host is missing AIX PTF U819446 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819446"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819446", package:"devices.pciex.14103f03.diag.5.3.0.4") < 0 ) 
