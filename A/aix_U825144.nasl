...
if(description)
{
 script_id(42488);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825144";
...
"The remote host is missing AIX PTF U825144 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825144"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825144", package:"bos.rte.bind_cmds.5.3.8.5") < 0 ) 
