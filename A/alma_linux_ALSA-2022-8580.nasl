...
# AlmaLinux Security Advisory ALSA-2022:8580.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8580");
  script_xref(name:"IAVA", value:"2022-A-0491-S");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2022:8580)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8580.html");
...
var pkgs = [
    {'reference':'firefox-102.5.0-1.el9_1.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.5.0-1.el9_1.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
