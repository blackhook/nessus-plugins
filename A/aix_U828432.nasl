...
if(description)
{
 script_id(43466);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828432";
...
"The remote host is missing AIX PTF U828432 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828432"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828432", package:"devices.pciex.8680c71014108003.rte.6.1.3.2") < 0 ) 
