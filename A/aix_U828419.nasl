...
if(description)
{
 script_id(43458);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828419";
...
"The remote host is missing AIX PTF U828419 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828419"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828419", package:"bos.sysmgt.serv_aid.6.1.3.2") < 0 ) 
