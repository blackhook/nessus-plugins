...
if(description)
{
 script_id(45156);
 script_version("1.4");
 name["english"] = "AIX 530010 : U829350";
...
"The remote host is missing AIX PTF U829350 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829350"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829350", package:"bos.rte.install.5.3.10.3") < 0 ) 
