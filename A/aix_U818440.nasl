...
if(description)
{
 script_id(35850);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818440";
...
"The remote host is missing AIX PTF U818440 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818440"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818440", package:"bos.sysmgt.nim.client.6.1.0.5") < 0 ) 
