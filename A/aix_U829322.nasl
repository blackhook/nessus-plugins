...
if(description)
{
 script_id(44291);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829322";
...
"The remote host is missing AIX PTF U829322 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829322"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829322", package:"bos.pmapi.pmsvcs.5.3.10.1") < 0 ) 
