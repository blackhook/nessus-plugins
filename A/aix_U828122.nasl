...
if(description)
{
 script_id(43946);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828122";
...
"The remote host is missing AIX PTF U828122 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828122"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828122", package:"bos.rte.filesystem.6.1.4.2") < 0 ) 
