...
# AlmaLinux Security Advisory ALSA-2023:2373.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2373");
  script_xref(name:"IAVB", value:"2022-B-0035-S");

  script_name(english:"AlmaLinux 9 : wireshark (ALSA-2023:2373)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2373.html");
...
"Update the affected wireshark, wireshark-cli and / or wireshark-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:wireshark");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:wireshark-cli");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:wireshark-devel");
