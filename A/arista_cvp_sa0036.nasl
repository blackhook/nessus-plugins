...
if (description)
{
  ...
  script_name(english:"Arista Networks CloudVision Portal DoS (SA0036)");
...
(DoS) vulnerability where the Linux kernel is forced to make expensive calls to tcp_collapse_ofo_queue() and
...
constraints = [
  {'min_version' : '2015.1', 'fixed_version':'2018.2.0'}
];
