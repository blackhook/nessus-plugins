...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : lquerylv (IV88053)");
  script_summary(english:"Check for APAR IV88053");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"00", patch:"IV88053s2a", package:"bos.rte.lvm", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"01", patch:"IV88053s2a", package:"bos.rte.lvm", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV88053s2a", package:"bos.rte.lvm", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
