...
if(description)
{
 script_id(43540);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828787";
...
"The remote host is missing AIX PTF U828787 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828787"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828787", package:"devices.pciex.b3154a63.rte.6.1.3.4") < 0 ) 
