...
if(description)
{
 script_id(33732);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819423";
...
"The remote host is missing AIX PTF U819423 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819423"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819423", package:"bos.alt_disk_install.rte.5.3.0.64") < 0 ) 
