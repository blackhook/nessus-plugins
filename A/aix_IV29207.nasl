...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : fuser (IV29207)");
  script_summary(english:"Check for APAR IV29207");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"01", patch:"IV29207s0a", package:"bos.rte.filesystem", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.0") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"02", sp:"02", patch:"IV29207s0a", package:"bos.rte.filesystem", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.0") < 0) flag++;
