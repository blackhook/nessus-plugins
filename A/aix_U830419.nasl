...
if(description)
{
 script_id(44547);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830419";
...
"The remote host is missing AIX PTF U830419 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830419"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830419", package:"bos.net.nfs.cachefs.6.1.4.3") < 0 ) 
