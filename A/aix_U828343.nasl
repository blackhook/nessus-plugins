...
if(description)
{
 script_id(41779);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828343";
...
"The remote host is missing AIX PTF U828343 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828343"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828343", package:"devices.iscsi_sw.rte.6.1.2.3") < 0 ) 
