...
if(description)
{
 script_id(38545);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824970";
...
"The remote host is missing AIX PTF U824970 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824970"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824970", package:"bos.cifs_fs.rte.5.3.7.2") < 0 ) 
