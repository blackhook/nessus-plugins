...
from other computers and interact with them on a network."
  ...
  script_set_attribute(
    attribute:"see_also", 
    value:"https://support.apple.com/?path=Mac/10.4/en/mh896.html"
  );

  script_set_attribute(
    attribute:"see_also", 
    value:"https://support.apple.com/?path=Mac/10.5/en/8418.html"
  );

  script_set_attribute(
    attribute:"see_also", 
    value:"https://support.apple.com/?path=Mac/10.6/en/8418.html"
  );
