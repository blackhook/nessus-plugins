...
if(description)
{
 script_id(42596);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829376";
...
"The remote host is missing AIX PTF U829376 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829376"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829376", package:"devices.common.IBM.sissas.rte.5.3.9.4") < 0 ) 
