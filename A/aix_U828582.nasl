...
if(description)
{
 script_id(43201);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828582";
...
"The remote host is missing AIX PTF U828582 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828582"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828582", package:"bos.net.tcp.server.6.1.1.7") < 0 ) 
