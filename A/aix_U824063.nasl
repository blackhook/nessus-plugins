...
if(description)
{
 script_id(39144);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824063";
...
"The remote host is missing AIX PTF U824063 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824063"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824063", package:"bos.64bit.6.1.2.4") < 0 ) 
