...
if(description)
{
 ...
 script_name(english: "AIX 530009 : U826311");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826311");
...
if ( aix_check_patch(ml:"530009", patch:"U826311", package:"devices.pci.1410c302.rte.5.3.9.0") < 0 ) 
