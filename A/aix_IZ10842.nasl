...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : pioout (IZ10842)");
  script_summary(english:"Check for APAR IZ10842");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ10842_07", package:"printers.rte", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.0") < 0) flag++;
