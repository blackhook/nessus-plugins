...
if(description)
{
 script_id(39721);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825217";
...
"The remote host is missing AIX PTF U825217 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825217"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825217", package:"bos.64bit.5.3.9.4") < 0 ) 
