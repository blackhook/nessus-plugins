...
if(description)
{
 script_id(38500);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824822";
...
"The remote host is missing AIX PTF U824822 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824822"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824822", package:"X11.base.rte.5.3.9.1") < 0 ) 
