...
# AlmaLinux Security Advisory ALSA-2021:4130.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4130");
  script_xref(name:"IAVA", value:"2021-A-0527-S");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2021:4130)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4130.html");
...
var pkgs = [
    {'reference':'thunderbird-91.3.0-2.el8_4.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
