...
if(description)
{
 script_id(38272);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821382";
...
"The remote host is missing AIX PTF U821382 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821382"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821382", package:"perfagent.tools.5.3.7.4") < 0 ) 
