...
if(description)
{
 script_id(39023);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823845";
...
"The remote host is missing AIX PTF U823845 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823845"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823845", package:"bos.net.tcp.server.6.1.0.8") < 0 ) 
