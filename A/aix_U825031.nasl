...
if(description)
{
 script_id(38606);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825031";
...
"The remote host is missing AIX PTF U825031 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825031"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825031", package:"devices.common.IBM.sissas.rte.5.3.7.6") < 0 ) 
