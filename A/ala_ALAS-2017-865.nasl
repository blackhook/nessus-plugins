...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-865.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-865");

  script_name(english:"Amazon Linux AMI : freeradius (ALAS-2017-865)");
...
handles decoding of DHCP packets. A remote attacker could use this
flaw to crash the FreeRADIUS server by sending a specially crafted
DHCP request. (CVE-2017-10982)
...
decoding of DHCP packets. A remote attacker could use this flaw to
cause the FreeRADIUS server to consume an increasing amount of memory
resources over time possibly leading to a crash due to memory
exhaustion. (CVE-2017-10980)
...
cause the FreeRADIUS server to consume an increasing amount of memory
resources over time, possibly leading to a crash due to memory
exhaustion, by sending specially crafted DHCP packets.
(CVE-2017-10981)
...
Out-of-bounds read/write due to improper output buffer size check in
make_secret() :
...
packet. (CVE-2017-10978)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-865.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"freeradius-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-debuginfo-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-krb5-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-ldap-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-mysql-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-perl-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-postgresql-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-python-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-unixODBC-2.2.6-7.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-utils-2.2.6-7.16.amzn1")) flag++;
