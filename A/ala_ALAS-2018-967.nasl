...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-967.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-967");

  script_name(english:"Amazon Linux AMI : libvpx (ALAS-2018-967)");
...
frame width (CVE-2017-13194)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2018-967.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libvpx-1.2.0-1.1.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libvpx-debuginfo-1.2.0-1.1.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libvpx-devel-1.2.0-1.1.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libvpx-utils-1.2.0-1.1.amzn1")) flag++;
