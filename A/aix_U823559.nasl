...
if(description)
{
 script_id(35538);
 script_version("1.6");
 name["english"] = "AIX 520010 : U823559";
...
"The remote host is missing AIX PTF U823559 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823559"; 
...
if ( aix_check_patch(ml:"520010", patch:"U823559", package:"bos.rte.bind_cmds.5.2.0.109") < 0 ) 
