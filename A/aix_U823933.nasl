...
if(description)
{
 script_id(39081);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823933";
...
"The remote host is missing AIX PTF U823933 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823933"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823933", package:"bos.perf.tools.6.1.1.5") < 0 ) 
