...
if(description)
{
 script_id(45299);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830198";
...
"The remote host is missing AIX PTF U830198 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830198"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830198", package:"bos.rte.filesystem.5.3.9.4") < 0 ) 
