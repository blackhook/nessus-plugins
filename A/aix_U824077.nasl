...
if(description)
{
 script_id(39158);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824077";
...
"The remote host is missing AIX PTF U824077 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824077"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824077", package:"devices.pci.1410bd02.diag.6.1.2.2") < 0 ) 
