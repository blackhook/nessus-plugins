...
if(description)
{
 script_id(39199);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825569";
...
"The remote host is missing AIX PTF U825569 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825569"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825569", package:"devices.ide.cdrom.rte.6.1.2.2") < 0 ) 
