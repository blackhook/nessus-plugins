...
# extracted from Amazon Linux 2 Security Advisory ALAS-2018-996.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : stunnel / amazon-efs-utils (ALAS-2018-996)");
...
stunnel to encrypt data in transit to EFS"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2018-996.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"AL2", reference:"amazon-efs-utils-1.2-1.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"stunnel-4.56-6.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"stunnel-debuginfo-4.56-6.amzn2.0.1")) flag++;
