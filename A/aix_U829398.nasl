...
if(description)
{
 script_id(42618);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829398";
...
"The remote host is missing AIX PTF U829398 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829398"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829398", package:"devices.pciex.8680c71014108003.rte.5.3.9.3") < 0 ) 
