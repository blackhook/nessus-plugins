...
if(description)
{
 script_id(41725);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828288";
...
"The remote host is missing AIX PTF U828288 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828288"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828288", package:"devices.vdevice.hvterm1.rte.6.1.2.1") < 0 ) 
