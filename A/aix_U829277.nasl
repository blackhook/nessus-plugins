...
if(description)
{
 script_id(44246);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829277";
...
"The remote host is missing AIX PTF U829277 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829277"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829277", package:"bos.rte.filesystem.5.3.10.1") < 0 ) 
