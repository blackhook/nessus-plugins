...
if(description)
{
 script_id(35844);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818434";
...
"The remote host is missing AIX PTF U818434 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818434"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818434", package:"devices.pciex.8680c71014108003.rte.6.1.0.3") < 0 ) 
