...
if(description)
{
 script_id(34636);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821149";
...
"The remote host is missing AIX PTF U821149 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821149"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821149", package:"devices.ide.cdrom.rte.5.3.0.66") < 0 ) 
