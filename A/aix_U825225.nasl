...
if(description)
{
 script_id(39729);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825225";
...
"The remote host is missing AIX PTF U825225 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825225"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825225", package:"bos.rte.bind_cmds.5.3.9.3") < 0 ) 
