...
if(description)
{
 script_id(39182);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825552";
...
"The remote host is missing AIX PTF U825552 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825552"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825552", package:"bos.adt.debug.6.1.2.2") < 0 ) 
