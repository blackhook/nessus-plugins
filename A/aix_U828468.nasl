...
if(description)
{
 script_id(43486);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828468";
...
"The remote host is missing AIX PTF U828468 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828468"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828468", package:"bos.net.nfs.adt.6.1.3.1") < 0 ) 
