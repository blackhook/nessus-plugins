...
if(description)
{
 script_id(39180);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825549";
...
"The remote host is missing AIX PTF U825549 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825549"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825549", package:"bos.rte.aio.6.1.2.3") < 0 ) 
