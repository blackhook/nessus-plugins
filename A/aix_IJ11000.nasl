...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : xorg (IJ11000)");
  script_summary(english:"Check for APAR IJ11000");
...
if (aix_check_ifix(release:"6.1", ml:"09", patch:"IJ11000s0b", package:"X11.base.rte", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.100") < 0) flag++;
