...
# from AIX Security PTF U828301. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : bos.net.tcp.server (U828301)");
  script_summary(english:"Check for PTF U828301");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U828301, which is related to the
...
/usr/sbin/named9."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ56317"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610002", patch:"U828301", package:"bos.net.tcp.server.6.1.2.3") < 0 ) flag++;
