...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-666.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-666");

  script_name(english:"Amazon Linux AMI : sos (ALAS-2016-666)");
...
privileges on the system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-666.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Run 'yum update sos' to update your system."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:sos");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"sos-3.2-28.17.amzn1")) flag++;
