...
if(description)
{
 ...
 script_name(english: "AIX 520010 : U815079");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U815079");
...
if ( aix_check_patch(ml:"520010", patch:"U815079", package:"devices.pci.1410bd02.diag.5.2.0.2") < 0 ) 
