...
if(description)
{
 script_id(39139);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824058";
...
"The remote host is missing AIX PTF U824058 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824058"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824058", package:"bos.net.nfs.adt.6.1.2.1") < 0 ) 
