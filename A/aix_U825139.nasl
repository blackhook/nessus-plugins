...
if(description)
{
 script_id(42483);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825139";
...
"The remote host is missing AIX PTF U825139 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825139"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825139", package:"bos.perf.tools.5.3.8.7") < 0 ) 
