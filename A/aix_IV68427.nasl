...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : ntp (IV68427)");
  script_summary(english:"Check for APAR IV68427");
...
special packets that trigger buffer overflow."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/ntp_advisory2.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV68427m9a", package:"bos.net.tcp.client", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.10") < 0) flag++;
