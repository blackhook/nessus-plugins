...
if(description)
{
 script_id(44495);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829915";
...
"The remote host is missing AIX PTF U829915 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829915"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829915", package:"devices.pci.14106902.rte.5.3.11.1") < 0 ) 
