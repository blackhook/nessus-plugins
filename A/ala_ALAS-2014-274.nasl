...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-274.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-274");
  script_xref(name:"RHSA", value:"2013:1861");

  script_name(english:"Amazon Linux AMI : nss (ALAS-2014-274)");
...
intermediate certificate as untrusted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-274.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nss-3.15.3-3.32.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-debuginfo-3.15.3-3.32.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-devel-3.15.3-3.32.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-pkcs11-devel-3.15.3-3.32.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-sysinit-3.15.3-3.32.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-tools-3.15.3-3.32.amzn1")) flag++;
