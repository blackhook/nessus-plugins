...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-941.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-941");

  script_name(english:"Amazon Linux AMI : docker (ALAS-2018-941)");
...
bombing. (CVE-2017-14992)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2018-941.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", cpu:"x86_64", reference:"docker-17.09.1ce-1.111.amzn1")) flag++;
if (rpm_check(release:"ALA", cpu:"x86_64", reference:"docker-debuginfo-17.09.1ce-1.111.amzn1")) flag++;
