...
if(description)
{
 script_id(38222);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820007";
...
"The remote host is missing AIX PTF U820007 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820007"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820007", package:"bos.acct.5.3.9.1") < 0 ) 
