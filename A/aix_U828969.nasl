...
if(description)
{
 script_id(43306);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828969";
...
"The remote host is missing AIX PTF U828969 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828969"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828969", package:"bos.net.nfs.cachefs.6.1.1.3") < 0 ) 
