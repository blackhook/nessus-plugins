...
if(description)
{
 script_id(39163);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824082";
...
"The remote host is missing AIX PTF U824082 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824082"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824082", package:"bos.net.tcp.server.6.1.2.2") < 0 ) 
