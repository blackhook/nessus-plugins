...
if(description)
{
 script_id(44459);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829879";
...
"The remote host is missing AIX PTF U829879 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829879"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829879", package:"bos.rte.install.5.3.11.2") < 0 ) 
