...
if (description)
{
  ...
  script_name(english:"Asterisk Remote Crash Vulnerability in Skinny Channel Driver (AST-2012-009)");
...
Note the fix for AST-2012-008 was incomplete.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2012-009.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Asterisk 10.5.1 or apply the patches listed in the Asterisk
advisory.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-3553");
