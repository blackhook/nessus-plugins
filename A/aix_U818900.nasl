...
if(description)
{
 script_id(33980);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818900";
...
"The remote host is missing AIX PTF U818900 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818900"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818900", package:"bos.alt_disk_install.rte.6.1.0.2") < 0 ) 
