...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-570.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-570");
  script_xref(name:"RHSA", value:"2015:1229");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/03/24");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"Amazon Linux AMI : java-1.7.0-openjdk (ALAS-2015-570) (Bar Mitzvah) (Logjam)");
...
(CVE-2015-2625)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2015-570.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-1.7.0.85-2.6.1.3.61.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-debuginfo-1.7.0.85-2.6.1.3.61.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-demo-1.7.0.85-2.6.1.3.61.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-devel-1.7.0.85-2.6.1.3.61.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-javadoc-1.7.0.85-2.6.1.3.61.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-src-1.7.0.85-2.6.1.3.61.amzn1")) flag++;
