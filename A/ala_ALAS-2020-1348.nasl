...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"FreeType before 2.6.1 has a heap-based buffer over-read in
T1_Get_Private_Dict in type1/t1parse.c. (CVE-2015-9381)
...
FT_New_Memory_Face operation. (CVE-2015-9382)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1348.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"freetype-2.3.11-19.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freetype-debuginfo-2.3.11-19.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freetype-demos-2.3.11-19.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freetype-devel-2.3.11-19.15.amzn1")) flag++;
