...
# from AIX Security PTF U829509. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : bos.net.tcp.server (U829509)");
  script_summary(english:"Check for PTF U829509");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U829509, which is related to the
...
/usr/sbin/named9."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ56312"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530008", patch:"U829509", package:"bos.net.tcp.server.5.3.8.6") < 0 ) flag++;
