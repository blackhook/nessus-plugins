...
if(description)
{
 script_id(38473);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824795";
...
"The remote host is missing AIX PTF U824795 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824795"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824795", package:"bos.sysmgt.nim.client.5.3.9.1") < 0 ) 
