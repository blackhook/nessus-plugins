...
if(description)
{
 script_id(45187);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830072";
...
"The remote host is missing AIX PTF U830072 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830072"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830072", package:"bos.sysmgt.nim.client.5.3.10.2") < 0 ) 
