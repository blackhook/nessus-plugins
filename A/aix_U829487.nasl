...
if(description)
{
 script_id(42660);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829487";
...
"The remote host is missing AIX PTF U829487 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829487"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829487", package:"bos.rte.libpthreads.5.3.8.2") < 0 ) 
