...
if(description)
{
 script_id(42502);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825158";
...
"The remote host is missing AIX PTF U825158 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825158"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825158", package:"bos.perf.proctools.5.3.8.3") < 0 ) 
