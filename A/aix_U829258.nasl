...
if(description)
{
 script_id(44227);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829258";
...
"The remote host is missing AIX PTF U829258 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829258"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829258", package:"bos.rte.install.5.3.10.2") < 0 ) 
