...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : bind (IV80188) (deprecated)");
  script_summary(english:"Check for APAR IV80188");
...
if ( oslevel != "AIX 6.1" ) audit(AUDIT_OS_NOT, "AIX 6.1", oslevel);
...
if ( ml != "09" || sp != "06" )  audit(AUDIT_OS_NOT, "AIX 6.1 ML 09 SP 06", oslevel_description);
...
ifixes_6_1 = "(IV80188s6a|IV81279s6a)";

if (aix_check_ifix(release:"6.1", ml:"09", sp:"06", patch:ifixes_6_1, package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.101") < 0) flag++;
