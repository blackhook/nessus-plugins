...
if(description)
{
 script_id(41697);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825791";
...
"The remote host is missing AIX PTF U825791 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825791"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825791", package:"bos.rte.install.6.1.0.10") < 0 ) 
