...
if(description)
{
 script_id(39095);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823947";
...
"The remote host is missing AIX PTF U823947 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823947"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823947", package:"bos.net.tcp.server.6.1.1.5") < 0 ) 
