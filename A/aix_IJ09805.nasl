...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 3 : solaris (IJ09805)");
  script_summary(english:"Check for APAR IJ09805");
...
if (aix_check_ifix(release:"7.2", ml:"03", sp:"00", patch:"IJ09805s0a", package:"core", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"03", sp:"01", patch:"IJ09805s0a", package:"core", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.0") < 0) flag++;
