...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : ps (IZ11243)");
  script_summary(english:"Check for APAR IZ11243");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ11243_07", package:"bos.rte.control", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.3") < 0) flag++;
