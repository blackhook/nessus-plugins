...
if(description)
{
 script_id(38350);
 script_version("1.5");
 name["english"] = "AIX 530006 : U822005";
...
"The remote host is missing AIX PTF U822005 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822005"; 
...
if ( aix_check_patch(ml:"530006", patch:"U822005", package:"bos.rte.install.5.3.0.71") < 0 ) 
