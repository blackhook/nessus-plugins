...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-578.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-578");

  script_name(english:"Amazon Linux AMI : httpd (ALAS-2015-578)");
...
possibly leading to HTTP request smuggling attacks."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2015-578.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"httpd-2.2.31-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"httpd-debuginfo-2.2.31-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"httpd-devel-2.2.31-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"httpd-manual-2.2.31-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"httpd-tools-2.2.31-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mod_ssl-2.2.31-1.6.amzn1")) flag++;
