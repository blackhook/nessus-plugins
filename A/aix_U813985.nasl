...
# from AIX Security PTF U813985. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 6 : bos.diag.util (U813985)");
  script_summary(english:"Check for PTF U813985");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U813985, which is related to the
...
/usr/sbin/lsmcode."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ15100"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530006", patch:"U813985", package:"bos.diag.util.5.3.0.65") < 0 ) flag++;
