...
# AlmaLinux Security Advisory ALSA-2022:7928.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7928");

  script_name(english:"AlmaLinux 8 : device-mapper-multipath (ALSA-2022:7928)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7928.html");
