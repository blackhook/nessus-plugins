...
# AlmaLinux Security Advisory ALSA-2021:0809.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:0809");

  script_name(english:"AlmaLinux 8 : wpa_supplicant (ALSA-2021:0809)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-0809.html");
