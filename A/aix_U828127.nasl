...
if(description)
{
 script_id(43951);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828127";
...
"The remote host is missing AIX PTF U828127 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828127"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828127", package:"bos.rte.libpthreads.6.1.4.1") < 0 ) 
