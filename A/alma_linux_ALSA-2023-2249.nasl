...
# AlmaLinux Security Advisory ALSA-2023:2249.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2249");

  script_name(english:"AlmaLinux 9 : xorg-x11-server-Xwayland (ALSA-2023:2249)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2249.html");
