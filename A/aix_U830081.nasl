...
if(description)
{
 script_id(45196);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830081";
...
"The remote host is missing AIX PTF U830081 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830081"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830081", package:"devices.common.IBM.sissas.rte.5.3.10.2") < 0 ) 
