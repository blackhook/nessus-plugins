...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : infiniband (IV43580)");
  script_summary(english:"Check for APAR IV43580");
...
if (aix_check_ifix(release:"6.1", ml:"08", sp:"02", patch:"iv43580m2a", package:"devices.common.IBM.ib.rte", minfilesetver:"6.1.8.0", maxfilesetver:"6.1.8.15") < 0) flag++;
