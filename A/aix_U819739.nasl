...
if(description)
{
 script_id(34911);
 script_version("1.6");
 name["english"] = "AIX 610000 : U819739";
...
"The remote host is missing AIX PTF U819739 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819739"; 
...
if ( aix_check_patch(ml:"610000", patch:"U819739", package:"bos.sysmgt.serv_aid.6.1.0.5") < 0 ) 
