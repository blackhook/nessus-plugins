...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : pconsole (IV89385)");
  script_summary(english:"Check for APAR IV89385");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV89385s7a", package:"lwi.runtime", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.100") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV89385s7a", package:"lwi.runtime", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.100") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV89385s7a", package:"lwi.runtime", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.100") < 0) flag++;
