...
if(description)
{
 script_id(39743);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825239";
...
"The remote host is missing AIX PTF U825239 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825239"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825239", package:"bos.perf.tools.5.3.9.4") < 0 ) 
