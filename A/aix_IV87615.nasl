...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : ntp (IV87615) (deprecated)");
  script_summary(english:"Check for APAR IV87615");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV87615m5a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV87615m6a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV87615m7a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
