...
if(description)
{
 script_id(33307);
 script_version("1.6");
 name["english"] = "AIX 610000 : U817160";
...
"The remote host is missing AIX PTF U817160 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U817160"; 
...
if ( aix_check_patch(ml:"610000", patch:"U817160", package:"bos.net.nfs.cachefs.6.1.0.4") < 0 ) 
