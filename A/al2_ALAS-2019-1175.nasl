...
# extracted from Amazon Linux 2 Security Advisory ALAS-2019-1175.
#
...
if (description)
{
  script_id(122861);
  script_version("1.1");
  script_cvs_date("Date: 2019/03/15 10:28:26");

  script_xref(name:"ALAS", value:"2019-1175");

  script_name(english:"Amazon Linux 2 : filesystem (ALAS-2019-1175)");
  ...
  script_set_attribute(
    ...
    value:
"Images built for the Amazon Linux 2.0.20190218 release included system
...
state. The latest Amazon Linux 2 AMIs, on-premises VM images, and
Docker Hub listings already include these updates."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2019-1175.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"filesystem-3.2-25.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"filesystem-content-3.2-25.amzn2.0.1")) flag++;
