...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : infiniband (IV43756)");
  script_summary(english:"Check for APAR IV43756");
...
if (aix_check_ifix(release:"7.1", ml:"01", sp:"07", patch:"iv43756m7a", package:"devices.common.IBM.ib.rte", minfilesetver:"7.1.1.0", maxfilesetver:"7.1.1.18") < 0) flag++;
