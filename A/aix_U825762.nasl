...
if(description)
{
 script_id(39274);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825762";
...
"The remote host is missing AIX PTF U825762 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825762"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825762", package:"bos.perf.proctools.6.1.0.2") < 0 ) 
