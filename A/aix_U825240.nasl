...
if(description)
{
 script_id(39744);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825240";
...
"The remote host is missing AIX PTF U825240 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825240"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825240", package:"devices.chrp.base.rte.5.3.9.3") < 0 ) 
