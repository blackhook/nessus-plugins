...
# extracted from Amazon Linux AMI Security Advisory ALAS-2020-1471.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : golang (ALAS-2020-1471) (deprecated)");
...
multiple vulnerabilities as referenced in the ALAS-2020-1471 advisory.
...
This plugin has been deprecated due to Amazon pulling the previously published advisory.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2020-1471.html");
