...
if(description)
{
 ...
 script_name(english: "AIX 530009 : U826314");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826314");
...
if ( aix_check_patch(ml:"530009", patch:"U826314", package:"devices.pciex.df1000f1df1024f1.rte.5.3.9.0") < 0 ) 
