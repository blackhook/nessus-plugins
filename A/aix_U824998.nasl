...
if(description)
{
 script_id(38573);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824998";
...
"The remote host is missing AIX PTF U824998 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824998"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824998", package:"bos.net.tcp.server.5.3.7.7") < 0 ) 
