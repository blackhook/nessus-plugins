...
'sip.conf'.");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/489818/100/0/threaded");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2008-003.html");
...
foreach kb_name (keys(asterisk_kbs))
{
  ...
  data = 'v=0\r\n' +
         'o=user1 53655765 2353687637 IN IP4 ' + compat::this_host() + '\r\n' +
         's=-\r\n' +
         'c=IN IP4 ' +  compat::this_host() + '\r\n' +
         't=0 0\r\n' +
         'm=audio 6000 RTP/AVP 0\r\n' +
         'a=rtpmap:0 PCMU/8000';

  invite = 'INVITE sip:service@' + get_host_ip() + ':' + port + ' SIP/2.0\r\n' +
           'Via: SIP/2.0/' + toupper(via_protocol) + ' ' + compat::this_host() + ':5060;branch=z9hG4bKfe06f452-2dd6-db11-6d02-000b7d0dc672;rport\r\n' +
           'From: "' + SCRIPT_NAME + '" <sip:nessus@' + compat::this_host() + ':' + port + '>;tag=de92d852-2dd6-db11-9d02-000b7d0dc672\r\n' +
           'To: <sip:nessus@' + get_host_ip() + ':' + port + '>\r\n' +
           'Call-ID: cee2c112a8faaedd9daf1f94a4ce7095@' +  compat::this_host() + '\r\n' +
           'CSeq: 1 INVITE\r\n' +
           "Contact: <sip:nessus@" + compat::this_host() + '>\r\n' +
           'Max-Forwards: 70\r\n' +
           'Subject: ' + SCRIPT_NAME + '\r\n' +
