...
# from AIX Security PTF U865621. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : X11.base.rte (U865621)");
  script_summary(english:"Check for PTF U865621");
...
request that triggers memory-allocation failure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV52181"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610007", patch:"U865621", package:"X11.base.rte.6.1.7.17") < 0 ) flag++;
