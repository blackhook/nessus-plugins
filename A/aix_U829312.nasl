...
if(description)
{
 script_id(44281);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829312";
...
"The remote host is missing AIX PTF U829312 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829312"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829312", package:"devices.fcp.tape.rte.5.3.10.1") < 0 ) 
