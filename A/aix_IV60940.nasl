...
# @DEPRECATED@
#
# This plugin has been deprecated. The patch has been superseded, use plugin aix_IV62808.nasl.
#
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : malloc (IV60940)");
  script_summary(english:"Checks for APAR IV60940.");
...
# Deprecated.
exit(0, "This plugin has been deprecated. Use aix_IV62802.nasl (plugin #77266) instead.");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"03", patch:"IV60940s3a", package:"bos.rte.libc", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.15") < 0) flag++;
