...
# from AIX Security PTF U849815. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 5 : bos.net.tcp.client (U849815)");
  script_summary(english:"Check for PTF U849815");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U849815, which is related to the
...
an attacker could exploit this vulnerability to cause a kernel panic."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV13751"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610005", patch:"U849815", package:"bos.net.tcp.client.6.1.5.9") < 0 ) flag++;
