...
if(description)
{
 script_id(43479);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828457";
...
"The remote host is missing AIX PTF U828457 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828457"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828457", package:"bos.pmapi.pmsvcs.6.1.3.1") < 0 ) 
