...
if(description)
{
 script_id(41882);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828562";
...
"The remote host is missing AIX PTF U828562 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828562"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828562", package:"bos.cifs_fs.rte.6.1.1.5") < 0 ) 
