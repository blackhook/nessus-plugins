...
if(description)
{
 script_id(39234);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825651";
...
"The remote host is missing AIX PTF U825651 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825651"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825651", package:"devices.scsi.disk.rte.6.1.1.4") < 0 ) 
