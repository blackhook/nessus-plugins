...
if(description)
{
 script_id(39114);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823966";
...
"The remote host is missing AIX PTF U823966 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823966"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823966", package:"devices.pci.1410bd02.diag.6.1.1.2") < 0 ) 
