...
if(description)
{
 script_id(41650);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825614";
...
"The remote host is missing AIX PTF U825614 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825614"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825614", package:"bos.rte.install.6.1.2.5") < 0 ) 
