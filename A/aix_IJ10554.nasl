...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : solaris (IJ10554)");
  script_summary(english:"Check for APAR IJ10554");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IJ10554s9a", package:"bos.net.tcp.client", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.10") < 0) flag++;
