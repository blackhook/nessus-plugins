...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-883.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-883");

  script_name(english:"Amazon Linux AMI : subversion / mod_dav_svn (ALAS-2017-883)");
...
containing a malicious commit. (CVE-2017-9800)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-883.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"ALA", reference:"mod24_dav_svn-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mod_dav_svn-1.9.7-1.54.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mod_dav_svn-debuginfo-1.9.7-1.54.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-debuginfo-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-devel-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-javahl-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-libs-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-perl-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-python26-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-python27-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-ruby-1.9.7-1.58.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"subversion-tools-1.9.7-1.58.amzn1")) flag++;
