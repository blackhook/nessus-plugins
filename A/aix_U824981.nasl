...
if(description)
{
 script_id(38556);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824981";
...
"The remote host is missing AIX PTF U824981 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824981"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824981", package:"devices.scsi.disk.rte.5.3.7.6") < 0 ) 
