...
# AlmaLinux Security Advisory ALSA-2022:0496.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:0496");
  script_xref(name:"IAVA", value:"2022-A-0078-S");
  script_xref(name:"IAVA", value:"2022-A-0064-S");

  script_name(english:"AlmaLinux 8 : .NET 6.0 (ALSA-2022:0496)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:0496 advisory.

  - .NET Denial of Service Vulnerability. (CVE-2022-21986)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-0496.html");
