...
if(description)
{
 script_id(42640);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829420";
...
"The remote host is missing AIX PTF U829420 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829420"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829420", package:"bos.net.nfs.cachefs.5.3.9.2") < 0 ) 
