...
if(description)
{
 script_id(38472);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824794";
...
"The remote host is missing AIX PTF U824794 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824794"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824794", package:"bos.net.nfs.adt.5.3.9.1") < 0 ) 
