...
# extracted from Amazon Linux AMI Security Advisory ALAS-2018-943.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2018-943");

  script_name(english:"Amazon Linux AMI : python35 / python34 (ALAS-2018-943)");
...
(CVE-2017-1000158)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2018-943.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
flag = 0;
if (rpm_check(release:"ALA", reference:"python34-3.4.7-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python34-debuginfo-3.4.7-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python34-devel-3.4.7-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python34-libs-3.4.7-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python34-test-3.4.7-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python34-tools-3.4.7-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python35-3.5.4-13.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python35-debuginfo-3.5.4-13.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python35-devel-3.5.4-13.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python35-libs-3.5.4-13.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python35-test-3.5.4-13.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python35-tools-3.5.4-13.10.amzn1")) flag++;
