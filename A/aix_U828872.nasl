...
if(description)
{
 script_id(43266);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828872";
...
"The remote host is missing AIX PTF U828872 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828872"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828872", package:"bos.rte.aio.6.1.2.5") < 0 ) 
