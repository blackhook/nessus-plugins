...
if(description)
{
 script_id(33672);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819292";
...
"The remote host is missing AIX PTF U819292 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819292"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819292", package:"bos.net.nfs.cachefs.5.3.7.3") < 0 ) 
