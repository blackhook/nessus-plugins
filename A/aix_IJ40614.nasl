...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : bind (IJ40614)");
  script_summary(english:"Check for APAR IJ40614");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ40614m2b", package:"bos.net.tcp.bind", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ40614m2b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ40614m2b", package:"bos.net.tcp.bind", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ40614m2b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
