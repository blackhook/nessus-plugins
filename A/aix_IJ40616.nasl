...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : bind (IJ40616)");
  script_summary(english:"Check for APAR IJ40616");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"03", patch:"IJ40616m5b", package:"bos.net.tcp.bind", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"03", patch:"IJ40616m5b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"04", patch:"IJ40616m5b", package:"bos.net.tcp.bind", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"04", patch:"IJ40616m5b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"05", patch:"IJ40616m5b", package:"bos.net.tcp.bind", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"05", patch:"IJ40616m5b", package:"bos.net.tcp.bind_utils", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.3") < 0) flag++;
