...
if(description)
{
 script_id(33634);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819252";
...
"The remote host is missing AIX PTF U819252 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819252"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819252", package:"bos.alt_disk_install.rte.5.3.7.2") < 0 ) 
