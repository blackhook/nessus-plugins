...
if(description)
{
 script_id(44167);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823193";
...
"The remote host is missing AIX PTF U823193 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823193"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823193", package:"bos.mp.5.3.10.2") < 0 ) 
