...
if(description)
{
 script_id(43527);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828773";
...
"The remote host is missing AIX PTF U828773 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828773"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828773", package:"devices.pci.77102224.com.6.1.3.4") < 0 ) 
