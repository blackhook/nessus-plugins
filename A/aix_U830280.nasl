...
# from AIX Security PTF U830280. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : bos.net.nfs.client (U830280)");
  script_summary(english:"Check for PTF U830280");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U830280, which is related to the
...
"
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ73590");
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530012", patch:"U830280", package:"bos.net.nfs.client.5.3.12.1") < 0 ) flag++;
