...
if(description)
{
 script_id(43981);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828159";
...
"The remote host is missing AIX PTF U828159 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828159"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828159", package:"devices.pci.77102224.com.6.1.4.2") < 0 ) 
