...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : unix (IZ21481)");
  script_summary(english:"Check for APAR IZ21481");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ21481_8a", package:"bos.mp", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.1") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ21481_8b", package:"bos.mp", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.1") < 0) flag++;
