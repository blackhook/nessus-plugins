...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : lpd (IJ39877)");
  script_summary(english:"Check for APAR IJ39877");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ39877s1a", package:"bos.rte.printers", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.0") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ39877s1a", package:"bos.rte.printers", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.0") < 0) flag++;
