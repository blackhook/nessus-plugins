...
# from AIX Security PTF U825668. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : bos.rte.cron (U825668)");
  script_summary(english:"Check for PTF U825668");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825668, which is related to the
...
/usr/bin/at."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ43458"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610001", patch:"U825668", package:"bos.rte.cron.6.1.1.3") < 0 ) flag++;
