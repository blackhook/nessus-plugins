...
if(description)
{
 script_id(44460);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829880";
...
"The remote host is missing AIX PTF U829880 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829880"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829880", package:"bos.rte.bind_cmds.5.3.11.1") < 0 ) 
