...
# from AIX Security PTF U806039. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.2 TL 8 : bos.net.tcp.client (U806039)");
  script_summary(english:"Check for PTF U806039");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U806039, which is related to the
...
if ( aix_check_patch(ml:"520008", patch:"U806039", package:"bos.net.tcp.client.5.2.0.88") < 0 ) flag++;
