...
if(description)
{
 script_id(41804);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828369";
...
"The remote host is missing AIX PTF U828369 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828369"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828369", package:"bos.pmapi.pmsvcs.6.1.2.4") < 0 ) 
