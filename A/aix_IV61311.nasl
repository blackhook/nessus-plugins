...
# @DEPRECATED@
#
# This plugin has been deprecated. The patch has been superseded, use plugin aix_IV62803.nasl.
#
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : malloc (IV61311)");
  script_summary(english:"Checks for APAR IV61311.");
...
# Deprecated.
exit(0, "This plugin has been deprecated. Use aix_IV62803.nasl (plugin #77262) instead.");
...
if (aix_check_ifix(release:"6.1", ml:"08", sp:"04", patch:"IV61311s4a", package:"bos.rte.libc", minfilesetver:"6.1.8.0", maxfilesetver:"6.1.8.17") < 0) flag++;
