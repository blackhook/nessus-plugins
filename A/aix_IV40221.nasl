...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : tftp (IV40221)");
  script_summary(english:"Check for APAR IV40221");
...
if (aix_check_ifix(release:"6.1", ml:"06", sp:"11", patch:"IV40221s11", package:"bos.net.tcp.client", minfilesetver:"6.1.6.0", maxfilesetver:"6.1.6.22") < 0) flag++;
