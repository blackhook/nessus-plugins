...
if(description)
{
 script_id(39640);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825045";
...
"The remote host is missing AIX PTF U825045 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825045"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825045", package:"bos.rte.bind_cmds.5.3.7.4") < 0 ) 
