...
"Further information about this update can be found in the Corretto 11
change log
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"java-11-amazon-corretto-11.0.7+10-1.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"java-11-amazon-corretto-headless-11.0.7+10-1.amzn2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"java-11-amazon-corretto-javadoc-11.0.7+10-1.amzn2")) flag++;
