...
# AlmaLinux Security Advisory ALSA-2023:3318.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:3318");
  script_xref(name:"IAVB", value:"2023-B-0029-S");

  script_name(english:"AlmaLinux 9 : go-toolset and golang (ALSA-2023:3318)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-3318.html");
...
var pkgs = [
    ...
    {'reference':'golang-race-1.19.9-2.el9_2', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
