...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 1 : sysproc (IV90234)");
  script_summary(english:"Check for APAR IV90234");
...
if (aix_check_ifix(release:"7.2", ml:"01", sp:"00", patch:"IV90234s0a", package:"bos.mp64", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
