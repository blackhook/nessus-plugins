...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : kernel (IJ43072)");
  script_summary(english:"Check for APAR IJ43072");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ43072s8a", package:"bos.net.nfs.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.38") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43072sAa", package:"bos.net.nfs.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.38") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"10", patch:"IJ43072sAa", package:"bos.net.nfs.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.38") < 0) flag++;
