...
if(description)
{
 script_id(43237);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828842";
...
"The remote host is missing AIX PTF U828842 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828842"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828842", package:"devices.common.IBM.ib.rte.6.1.2.6") < 0 ) 
