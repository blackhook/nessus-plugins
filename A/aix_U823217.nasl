...
if(description)
{
 script_id(44191);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823217";
...
"The remote host is missing AIX PTF U823217 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823217"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823217", package:"bos.rte.serv_aid.5.3.10.1") < 0 ) 
