...
if(description)
{
 script_id(39276);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825764";
...
"The remote host is missing AIX PTF U825764 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825764"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825764", package:"bos.rte.serv_aid.6.1.0.7") < 0 ) 
