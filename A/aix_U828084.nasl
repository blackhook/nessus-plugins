...
if(description)
{
 script_id(43911);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828084";
...
"The remote host is missing AIX PTF U828084 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828084"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828084", package:"devices.pci.14106902.rte.6.1.4.1") < 0 ) 
