...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 1 : ntp (IV92067) (deprecated)");
  script_summary(english:"Check for APAR IV92067");
...
if (aix_check_ifix(release:"7.2", ml:"01", sp:"00", patch:"IV92067s1a", package:"bos.net.tcp.ntp", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"00", patch:"IV92067s1a", package:"bos.net.tcp.ntpd", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"01", patch:"IV92067s1a", package:"bos.net.tcp.ntp", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"01", patch:"IV92067s1a", package:"bos.net.tcp.ntpd", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
