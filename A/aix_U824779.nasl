...
if(description)
{
 script_id(38457);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824779";
...
"The remote host is missing AIX PTF U824779 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824779"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824779", package:"devices.pciex.b3154a63.rte.5.3.9.3") < 0 ) 
