...
if(description)
{
 script_id(41671);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825636";
...
"The remote host is missing AIX PTF U825636 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825636"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825636", package:"devices.common.IBM.ib.rte.6.1.2.5") < 0 ) 
