...
if(description)
{
 script_id(45260);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830145";
...
"The remote host is missing AIX PTF U830145 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830145"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830145", package:"bos.acct.5.3.10.2") < 0 ) 
