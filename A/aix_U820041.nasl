...
if(description)
{
 script_id(38256);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820041";
...
"The remote host is missing AIX PTF U820041 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820041"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820041", package:"bos.mp.5.3.9.3") < 0 ) 
