...
if(description)
{
 script_id(35160);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821931";
...
"The remote host is missing AIX PTF U821931 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821931"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821931", package:"bos.perf.tools.5.3.0.68") < 0 ) 
