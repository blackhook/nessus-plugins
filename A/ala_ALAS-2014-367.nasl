...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-367.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-367");

  script_name(english:"Amazon Linux AMI : php54 (ALAS-2014-367)");
...
perform a DNS query."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-367.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"php54-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-bcmath-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-cli-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-common-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-dba-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-debuginfo-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-devel-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-embedded-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-enchant-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-fpm-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-gd-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-imap-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-intl-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-ldap-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-mbstring-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-mcrypt-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-mssql-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-mysql-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-mysqlnd-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-odbc-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-pdo-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-pgsql-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-process-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-pspell-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-recode-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-snmp-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-soap-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-tidy-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-xml-5.4.30-1.56.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php54-xmlrpc-5.4.30-1.56.amzn1")) flag++;
