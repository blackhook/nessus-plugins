...
if(description)
{
 script_id(35885);
 script_version("1.6");
 name["english"] = "AIX 610000 : U823815";
...
"The remote host is missing AIX PTF U823815 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823815"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823815", package:"devices.pci.77102224.com.6.1.0.5") < 0 ) 
