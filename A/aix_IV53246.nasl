...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : xorg (IV53246)");
  script_summary(english:"Check for APAR IV53246");
...
if (aix_check_ifix(release:"7.1", ml:"03", patch:"IV53246s0a", package:"X11.base.rte", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.2") < 0) flag++;
