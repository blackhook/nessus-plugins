...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : lquerylv (IV88658)");
  script_summary(english:"Check for APAR IV88658");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV88658s9a", package:"bos.rte.lvm", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.8") < 0) flag++;
