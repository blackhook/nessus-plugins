...
if(description)
{
 script_id(39071);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823923";
...
"The remote host is missing AIX PTF U823923 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823923"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823923", package:"bos.alt_disk_install.rte.6.1.1.3") < 0 ) 
