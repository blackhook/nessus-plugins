...
if(description)
{
 script_id(38232);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820017";
...
"The remote host is missing AIX PTF U820017 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820017"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820017", package:"bos.adt.debug.5.3.9.1") < 0 ) 
