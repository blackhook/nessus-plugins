...
if(description)
{
 script_id(44470);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829890";
...
"The remote host is missing AIX PTF U829890 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829890"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829890", package:"devices.common.IBM.ib.rte.5.3.11.2") < 0 ) 
