...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : nettcp (IV73975) (POODLE)");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"(IV73975s5a|IV75646m5a)", package:"bos.net.tcp.client", minfilesetver:"7.1.0.0", maxfilesetver:"7.1.3.48") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"(IV73975s5a|IV75646m5a)", package:"bos.net.tcp.server", minfilesetver:"7.1.0.0", maxfilesetver:"7.1.3.45") < 0) flag++;
