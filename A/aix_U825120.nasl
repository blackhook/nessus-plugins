...
if(description)
{
 script_id(39682);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825120";
...
"The remote host is missing AIX PTF U825120 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825120"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825120", package:"devices.common.IBM.sissas.rte.5.3.8.4") < 0 ) 
