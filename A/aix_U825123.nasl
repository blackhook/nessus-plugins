...
if(description)
{
 script_id(39684);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825123";
...
"The remote host is missing AIX PTF U825123 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825123"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825123", package:"devices.pci.77102224.com.5.3.8.3") < 0 ) 
