...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : bind (IV89831) (deprecated)");
  script_summary(english:"Check for APAR IV89831");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"00", patch:"IV89831m1a", package:"utils", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"00", patch:"IV89831m1a", package:"bos.net.tcp.bind", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"01", patch:"IV89831m1a", package:"utils", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"01", patch:"IV89831m1a", package:"bos.net.tcp.bind", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV89831m2a", package:"utils", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV89831m2a", package:"bos.net.tcp.bind", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
