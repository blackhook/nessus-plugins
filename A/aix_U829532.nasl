...
if(description)
{
 script_id(42704);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829532";
...
"The remote host is missing AIX PTF U829532 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829532"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829532", package:"bos.net.nfs.cachefs.5.3.8.4") < 0 ) 
