...
if(description)
{
 script_id(38413);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822089";
...
"The remote host is missing AIX PTF U822089 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822089"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822089", package:"bos.adt.debug.5.3.8.3") < 0 ) 
