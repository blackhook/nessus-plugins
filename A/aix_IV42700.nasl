...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : tftp (IV42700)");
  script_summary(english:"Check for APAR IV42700");
...
if (aix_check_ifix(release:"7.1", ml:"01", sp:"07", patch:"IV42700s7a", package:"bos.net.tcp.client", minfilesetver:"7.1.1.0", maxfilesetver:"7.1.1.18") < 0) flag++;
