...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-226.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-226");

  script_name(english:"Amazon Linux AMI : libgcrypt (ALAS-2013-226)");
...
Flush+Reload."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-226.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libgcrypt-1.4.5-9.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libgcrypt-debuginfo-1.4.5-9.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libgcrypt-devel-1.4.5-9.12.amzn1")) flag++;
