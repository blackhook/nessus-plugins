...
if(description)
{
 script_id(34892);
 script_version("1.6");
 name["english"] = "AIX 610000 : U819719";
...
"The remote host is missing AIX PTF U819719 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819719"; 
...
if ( aix_check_patch(ml:"610000", patch:"U819719", package:"devices.pci.14106902.rte.6.1.0.4") < 0 ) 
