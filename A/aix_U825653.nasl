...
if(description)
{
 script_id(39236);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825653";
...
"The remote host is missing AIX PTF U825653 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825653"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825653", package:"devices.ide.cdrom.rte.6.1.1.3") < 0 ) 
