...
if (description)
{
  ...
  script_name(english:"Asterisk 13.x < 13.18.5 / 14.x < 14.7.5 / 15.x < 15.1.5 / 13.13 < 13.18-cert2 Crash in PJSIP (AST-2017-014)");
...
remote host is 13.x prior to 13.18.5, 14.x prior to 14.7.5, 15.x prior
to 15.1.5, or 13.18 prior to 13.18-cert2. It is therefore, affected by
a remote denial of service attack as
described in AST-2017-014.

Note that Nessus has not tested for these issues but has instead
relied only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2017-014.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Asterisk version 13.18.5 / 14.7.5 / 15.1.4 / 13.18-cert2 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-17850");
