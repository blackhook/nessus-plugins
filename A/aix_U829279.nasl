...
if(description)
{
 script_id(44248);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829279";
...
"The remote host is missing AIX PTF U829279 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829279"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829279", package:"devices.pciex.8680c71014108003.rte.5.3.10.2") < 0 ) 
