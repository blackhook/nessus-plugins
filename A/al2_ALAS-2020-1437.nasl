...
the polkit_backend_interactive_authority_check_authorization function
in polkitd allows to test for authentication and trigger
authentication of unrelated processes owned by other users. This may
result in a local DoS and information disclosure. (CVE-2018-1116)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1437.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"AL2", reference:"polkit-0.112-26.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"polkit-debuginfo-0.112-26.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"polkit-devel-0.112-26.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"polkit-docs-0.112-26.amzn2")) flag++;
