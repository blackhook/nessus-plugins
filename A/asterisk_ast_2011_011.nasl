...
if (description)
{
  ...
  script_cve_id("CVE-2011-2536", "CVE-2011-2666");
  script_bugtraq_id(47676, 48008, 48485);

  script_name(english:"Asterisk Invalid INVITE / REGISTER SIP Request Username Enumeration (AST-2011-011)");
...
users by sending malformed SIP INVITE and REGISTER requests.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2011-011.html");
  script_set_attribute(attribute:"solution", value:
"Update to Asterisk 1.4.41.2 / 1.6.2.18.2 / 1.8.4.4 / C.3.7.3 or
later.");
