...
host is prior to 4.5.7. It is, therefore, affected by multiple
vulnerabilities. This includes an XML External Entity (XXE)
vulnerability, four out-of-bounds read vulnerabilities, and a memory
