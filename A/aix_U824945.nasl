...
if(description)
{
 script_id(44431);
 script_version("1.4");
 name["english"] = "AIX 530011 : U824945";
...
"The remote host is missing AIX PTF U824945 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824945"; 
...
if ( aix_check_patch(ml:"530011", patch:"U824945", package:"devices.common.IBM.fc.rte.5.3.11.1") < 0 ) 
