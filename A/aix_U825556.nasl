...
if(description)
{
 script_id(39186);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825556";
...
"The remote host is missing AIX PTF U825556 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825556"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825556", package:"devices.scsi.disk.rte.6.1.2.3") < 0 ) 
