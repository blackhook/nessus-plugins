...
if(description)
{
 script_id(35120);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821288";
...
"The remote host is missing AIX PTF U821288 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821288"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821288", package:"devices.scsi.disk.rte.5.3.0.68") < 0 ) 
