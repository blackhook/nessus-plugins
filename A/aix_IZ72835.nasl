...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : sendmail (IZ72835)");
  script_summary(english:"Check for APAR IZ72835");
...
if (aix_check_ifix(release:"5.3", ml:"09", patch:"IZ72835_09", package:"bos.net.tcp.client", minfilesetver:"5.3.9.0", maxfilesetver:"5.3.9.7") < 0) flag++;
