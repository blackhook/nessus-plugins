...
if(description)
{
 script_id(35897);
 script_version("1.6");
 name["english"] = "AIX 610000 : U823827";
...
"The remote host is missing AIX PTF U823827 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823827"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823827", package:"bos.rte.install.6.1.0.8") < 0 ) 
