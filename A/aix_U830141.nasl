...
if(description)
{
 script_id(45256);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830141";
...
"The remote host is missing AIX PTF U830141 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830141"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830141", package:"devices.iscsi_sw.rte.5.3.10.2") < 0 ) 
