...
if(description)
{
 script_id(43202);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828583";
...
"The remote host is missing AIX PTF U828583 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828583"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828583", package:"bos.perf.tools.6.1.1.7") < 0 ) 
