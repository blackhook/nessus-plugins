...
if(description)
{
 script_id(45205);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830090";
...
"The remote host is missing AIX PTF U830090 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830090"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830090", package:"devices.common.IBM.ib.rte.5.3.10.3") < 0 ) 
