...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : fuser (IV28749)");
  script_summary(english:"Check for APAR IV28749");
...
vulnerability via the -k argument to kill a process of another user."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/fuser_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"6.1", ml:"07", sp:"05", patch:"IV28749s05", package:"bos.rte.filesystem", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.17") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"07", sp:"06", patch:"IV28749s6a", package:"bos.rte.filesystem", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.17") < 0) flag++;
