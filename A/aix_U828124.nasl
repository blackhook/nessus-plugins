...
if(description)
{
 script_id(43948);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828124";
...
"The remote host is missing AIX PTF U828124 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828124"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828124", package:"bos.rte.bind_cmds.6.1.4.1") < 0 ) 
