...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : errpt (IZ22347)");
  script_summary(english:"Check for APAR IZ22347");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ22347_07", package:"aid", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
