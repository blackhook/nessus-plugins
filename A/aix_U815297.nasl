...
if(description)
{
 script_id(31230);
 script_version("1.6");
 name["english"] = "AIX 610000 : U815297";
...
"The remote host is missing AIX PTF U815297 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U815297"; 
...
if ( aix_check_patch(ml:"610000", patch:"U815297", package:"bos.perf.proctools.6.1.0.1") < 0 ) 
