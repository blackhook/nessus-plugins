...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : efs (IJ35078)");
  script_summary(english:"Check for APAR IJ35078");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ35078s3a", package:"bos.rte.security", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.100") < 0) flag++;
