...
if(description)
{
 script_id(38636);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825095";
...
"The remote host is missing AIX PTF U825095 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825095"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825095", package:"bos.rte.serv_aid.5.3.8.4") < 0 ) 
