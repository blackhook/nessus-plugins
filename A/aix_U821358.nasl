...
if(description)
{
 script_id(35146);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821358";
...
"The remote host is missing AIX PTF U821358 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821358"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821358", package:"devices.scsi.disk.rte.5.3.7.5") < 0 ) 
