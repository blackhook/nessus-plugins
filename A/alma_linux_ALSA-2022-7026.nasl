...
# AlmaLinux Security Advisory ALSA-2022:7026.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7026");

  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2022:7026)");
...
var pkgs = [
    {'reference':'thunderbird-102.3.0-4.el9_0.alma.plus', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.3.0-4.el9_0.alma.plus', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
