...
if(description)
{
 script_id(41931);
 script_version("1.5");
 name["english"] = "AIX 610000 : U828625";
...
"The remote host is missing AIX PTF U828625 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828625"; 
...
if ( aix_check_patch(ml:"610000", patch:"U828625", package:"devices.pci.77102224.com.6.1.0.7") < 0 ) 
