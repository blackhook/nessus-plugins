...
if(description)
{
 script_id(44565);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830438";
...
"The remote host is missing AIX PTF U830438 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830438"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830438", package:"devices.sata.rte.6.1.4.1") < 0 ) 
