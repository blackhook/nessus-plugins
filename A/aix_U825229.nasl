...
# from AIX Security PTF U825229. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : devices.common.IBM.atm.rte (U825229)");
  script_summary(english:"Check for PTF U825229");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825229, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48501"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530009", patch:"U825229", package:"devices.common.IBM.atm.rte.5.3.9.1") < 0 ) flag++;
