...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-182.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-182");
  script_xref(name:"RHSA", value:"2013:0748");

  script_name(english:"Amazon Linux AMI : krb5 (ALAS-2013-182)");
...
specially crafted TGS request. (CVE-2013-1416)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-182.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"krb5-debuginfo-1.10.3-10.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-devel-1.10.3-10.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-libs-1.10.3-10.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-pkinit-openssl-1.10.3-10.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-server-1.10.3-10.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-server-ldap-1.10.3-10.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-workstation-1.10.3-10.25.amzn1")) flag++;
