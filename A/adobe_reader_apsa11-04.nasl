...
if (description)
{
  ...
  script_name(english:"Adobe Reader < 9.4.7 Multiple Memory Corruption Vulnerabilities (APSB11-30)");
...
else exit(0, 'The Adobe Reader '+version_report+' install on the host is not affected.');
