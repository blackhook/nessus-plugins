...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 3 : pcnfsd (IZ75440)");
  script_summary(english:"Check for APAR IZ75440");
...
if (aix_check_ifix(release:"6.1", ml:"03", patch:"IZ75440_03", package:"bos.net.nfs.client", minfilesetver:"6.1.3.0", maxfilesetver:"6.1.3.3") < 0) flag++;
