...
if (description)
{
  ...
  script_name(english:"Adobe Animate < 21.0.7 Multiple Vulnerabilities (APSB21-50)");
...
multiple vulnerabilities.
  ...
  - Adobe Animate is affected by an out-of-bounds read vulnerability. Successful exploitation could lead to
    arbitrary code execution. (CVE-2021-28621)

  - Adobe Animate is affected by heap-based buffer overflow vulnerabilities. Successful exploitation could
    lead to arbitrary code execution. (CVE-2021-28620, CVE-2021-28629)

  - Adobe Animate is affected by an out-of-bounds write vulnerability. Successful exploitation could lead to
    arbitrary code execution. (CVE-2021-28622)
...
"Upgrade to Adobe Animate version 21.0.7 or later.");
  ...
  script_set_attribute(attribute:"cvss3_score_source", value:"CVE-2021-28629");
...
var constraints = [{ 'fixed_version' : '21.0.7' }];
