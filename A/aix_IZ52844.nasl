...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : libtt (IZ52844)");
  script_summary(english:"Check for APAR IZ52844");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ52844_07", package:"X11.Dt.ToolTalk", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.0") < 0) flag++;
