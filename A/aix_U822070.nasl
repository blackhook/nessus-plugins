...
if(description)
{
 script_id(38394);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822070";
...
"The remote host is missing AIX PTF U822070 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822070"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822070", package:"bos.64bit.5.3.8.5") < 0 ) 
