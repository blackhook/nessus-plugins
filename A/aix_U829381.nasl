...
if(description)
{
 script_id(42601);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829381";
...
"The remote host is missing AIX PTF U829381 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829381"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829381", package:"bos.sysmgt.serv_aid.5.3.9.3") < 0 ) 
