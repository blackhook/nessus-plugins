...
# AlmaLinux Security Advisory ALSA-2022:9074.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:9074");
  ...
  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2022:9074)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-9074.html");
...
var pkgs = [
    {'reference':'thunderbird-102.6.0-2.el8_7.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.6.0-2.el8_7.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
