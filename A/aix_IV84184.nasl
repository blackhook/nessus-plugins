...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : mustendd (IV84184)");
  script_summary(english:"Check for APAR IV84184");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV84184s9a", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.3") < 0) flag++;
