...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-29.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-29");
  script_xref(name:"RHSA", value:"2011:1807");

  script_name(english:"Amazon Linux AMI : jasper (ALAS-2011-29)");
...
potentially, execute arbitrary code."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2011-29.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"jasper-1.900.1-15.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"jasper-debuginfo-1.900.1-15.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"jasper-devel-1.900.1-15.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"jasper-libs-1.900.1-15.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"jasper-utils-1.900.1-15.5.amzn1")) flag++;
