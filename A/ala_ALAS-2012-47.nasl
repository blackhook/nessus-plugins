...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-47.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-47");
  script_xref(name:"RHSA", value:"2012:0136");

  script_name(english:"Amazon Linux AMI : libvorbis (ALAS-2012-47)");
...
(CVE-2012-0444)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-47.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Run 'yum update libvorbis' to update your system."
  );
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libvorbis-1.2.3-4.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libvorbis-debuginfo-1.2.3-4.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libvorbis-devel-1.2.3-4.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libvorbis-devel-docs-1.2.3-4.6.amzn1")) flag++;
