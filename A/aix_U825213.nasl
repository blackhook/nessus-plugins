...
if(description)
{
 script_id(39717);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825213";
...
"The remote host is missing AIX PTF U825213 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825213"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825213", package:"bos.rte.serv_aid.5.3.9.2") < 0 ) 
