...
# AlmaLinux Security Advisory ALSA-2022:7458.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7458");

  script_name(english:"AlmaLinux 8 : flatpak-builder (ALSA-2022:7458)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7458.html");
...
"Update the affected flatpak-builder package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:flatpak-builder");
