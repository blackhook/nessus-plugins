...
# AlmaLinux Security Advisory ALSA-2022:1964.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:1964");

  script_name(english:"AlmaLinux 8 : fetchmail (ALSA-2022:1964)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-1964.html");
...
"Update the affected fetchmail package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:fetchmail");
