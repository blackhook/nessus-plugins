...
# from AIX Security PTF U815051. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.2 TL 10 : bos.rte.control (U815051)");
  script_summary(english:"Check for PTF U815051");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U815051, which is related to the
...
/usr/bin/ps."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ11242"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"520010", patch:"U815051", package:"bos.rte.control.5.2.0.109") < 0 ) flag++;
