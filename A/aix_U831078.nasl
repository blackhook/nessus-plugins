...
if(description)
{
 script_id(43323);
 script_version("1.5");
 name["english"] = "AIX 610002 : U831078";
...
"The remote host is missing AIX PTF U831078 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U831078"; 
...
if ( aix_check_patch(ml:"610002", patch:"U831078", package:"bos.net.nfs.cachefs.6.1.2.2") < 0 ) 
