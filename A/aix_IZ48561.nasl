...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : muxatmd (IZ48561)");
  script_summary(english:"Check for APAR IZ48561");
...
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ48561_01", package:"devices.common.IBM.atm.rte", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.0") < 0) flag++;
