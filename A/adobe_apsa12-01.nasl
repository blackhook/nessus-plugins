...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2012-B-0099-S");
  script_xref(name:"IAVB", value:"2012-B-0100-S");
...
revoked certificate :
  ...
  - Adobe Bridge
    ...
    - Shockwave Player
    - SpeedGrade CS6");
  script_set_attribute(attribute:"see_also", value:"https://www.adobe.com/support/security/advisories/apsa12-01.html");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/x-productkb/global/certificate-updates.html");
  # http://blogs.adobe.com/security/2012/09/inappropriate-use-of-adobe-code-signing-certificate.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?89081e80");
