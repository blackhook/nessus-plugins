...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-28.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-28");
  script_xref(name:"RHSA", value:"2011:1790");

  script_name(english:"Amazon Linux AMI : krb5 (ALAS-2011-28)");
...
specially crafted TGS request. (CVE-2011-1530)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2011-28.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"krb5-debuginfo-1.9-22.20.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-devel-1.9-22.20.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-libs-1.9-22.20.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-pkinit-openssl-1.9-22.20.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-server-1.9-22.20.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-server-ldap-1.9-22.20.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"krb5-workstation-1.9-22.20.amzn1")) flag++;
