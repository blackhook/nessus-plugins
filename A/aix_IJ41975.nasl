...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ41975)");
  script_summary(english:"Check for APAR IJ41975");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ41975m3a", package:"bos.cluster.rte", minfilesetver:"7.2.5.101", maxfilesetver:"7.2.5.102") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ41975m3b", package:"bos.cluster.rte", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.2") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ41975m3b", package:"bos.cluster.rte", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.100") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ41975s4a", package:"bos.cluster.rte", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.2") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ41975s4a", package:"bos.cluster.rte", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.102") < 0) flag++;
