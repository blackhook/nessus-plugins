...
# from AIX Security PTF U865667. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : bos.rte.odm (U865667)");
  script_summary(english:"Check for PTF U865667");
...
to libodm.a bug."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV60311"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610008", patch:"U865667", package:"bos.rte.odm.6.1.8.16") < 0 ) flag++;
