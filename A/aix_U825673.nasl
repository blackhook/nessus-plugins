...
if(description)
{
 script_id(39255);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825673";
...
"The remote host is missing AIX PTF U825673 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825673"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825673", package:"devices.common.IBM.sissas.rte.6.1.1.3") < 0 ) 
