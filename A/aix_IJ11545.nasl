...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : xorg (IJ11545)");
  script_summary(english:"Check for APAR IJ11545");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"03", patch:"IJ11545s0a", package:"X11.base.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.31") < 0) flag++;
