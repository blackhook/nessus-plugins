...
if(description)
{
 script_id(39693);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825132";
...
"The remote host is missing AIX PTF U825132 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825132"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825132", package:"bos.net.nfs.adt.5.3.8.2") < 0 ) 
