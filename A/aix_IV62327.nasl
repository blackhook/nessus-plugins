...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : bind9 (IV62327)");
  script_summary(english:"Check for APAR IV62327");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV62327m9a", package:"bos.net.tcp.server", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.6") < 0) flag++;
