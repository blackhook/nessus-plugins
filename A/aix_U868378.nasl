...
# from AIX Security PTF U868378. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : bos.rte.lvm (U868378)");
  script_summary(english:"Check for PTF U868378");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U868378, which is related to the
...
allow a local user to gain root privileges."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV68082"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610008", patch:"U868378", package:"bos.rte.lvm.6.1.8.20") < 0 ) flag++;
