...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-633.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-633");

  script_name(english:"Amazon Linux AMI : libldb (ALAS-2016-633)");
...
consume an excessive amount of memory and crash.
...
could use this flaw to read heap-memory pages from the server."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-633.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Run 'yum update libldb' to update your system."
  );
...
flag = 0;
if (rpm_check(release:"ALA", reference:"ldb-tools-1.1.20-1.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libldb-1.1.20-1.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libldb-debuginfo-1.1.20-1.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libldb-devel-1.1.20-1.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"pyldb-1.1.20-1.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"pyldb-devel-1.1.20-1.7.amzn1")) flag++;
