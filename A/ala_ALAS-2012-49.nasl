...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-49.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-49");
  script_xref(name:"RHSA", value:"2012:0317");

  script_name(english:"Amazon Linux AMI : libpng (ALAS-2012-49)");
...
application. (CVE-2011-3026)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-49.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libpng-1.2.46-2.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libpng-debuginfo-1.2.46-2.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libpng-devel-1.2.46-2.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libpng-static-1.2.46-2.10.amzn1")) flag++;
