...
if(description)
{
 script_id(34612);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821106";
...
"The remote host is missing AIX PTF U821106 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821106"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821106", package:"bos.acct.5.3.7.6") < 0 ) 
