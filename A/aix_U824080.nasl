...
if(description)
{
 script_id(39161);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824080";
...
"The remote host is missing AIX PTF U824080 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824080"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824080", package:"devices.iscsi_sw.rte.6.1.2.2") < 0 ) 
