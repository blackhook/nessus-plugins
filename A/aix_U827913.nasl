...
if(description)
{
 script_id(43417);
 script_version("1.5");
 name["english"] = "AIX 610003 : U827913";
...
"The remote host is missing AIX PTF U827913 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U827913"; 
...
if ( aix_check_patch(ml:"610003", patch:"U827913", package:"devices.pci.14106902.rte.6.1.3.2") < 0 ) 
