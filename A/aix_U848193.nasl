...
# from AIX Security PTF U848193. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : bos.net.tcp.client (U848193)");
  script_summary(english:"Check for PTF U848193");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U848193, which is related to the
...
if ( aix_check_patch(ml:"610007", patch:"U848193", package:"bos.net.tcp.client.6.1.7.4") < 0 ) flag++;
