...
if(description)
{
 script_id(33616);
 script_version("1.6");
 name["english"] = "AIX 530007 : U817736";
...
"The remote host is missing AIX PTF U817736 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U817736"; 
...
if ( aix_check_patch(ml:"530007", patch:"U817736", package:"perfagent.tools.5.3.7.3") < 0 ) 
