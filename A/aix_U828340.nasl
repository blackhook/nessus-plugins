...
if(description)
{
 script_id(41776);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828340";
...
"The remote host is missing AIX PTF U828340 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828340"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828340", package:"devices.common.IBM.atm.rte.6.1.2.2") < 0 ) 
