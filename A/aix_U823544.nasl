...
if(description)
{
 script_id(35524);
 script_version("1.6");
 name["english"] = "AIX 520010 : U823544";
...
"The remote host is missing AIX PTF U823544 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823544"; 
...
if ( aix_check_patch(ml:"520010", patch:"U823544", package:"bos.sysmgt.nim.client.5.2.0.108") < 0 ) 
