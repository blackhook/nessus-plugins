...
if (description)
{
  ...
  script_bugtraq_id(105065);

  script_name(english:"Adobe Creative Cloud Desktop <= 4.5.0.324 Privilege Escalation Vulnerability (APSB18-20)");
...
Windows host is 4.5.0.324 or earlier. It is, therefore, 
affected by a dll hijacking & privilege escalation vulnerability 
as noted in the APSB18-20 advisory.
...
"Upgrade to Adobe Creative Cloud Desktop version 4.5.5.342 or later.");
