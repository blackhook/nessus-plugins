...
# AlmaLinux Security Advisory ALSA-2023:0902.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0902");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/03/07");

  script_name(english:"AlmaLinux 8 : webkit2gtk3 (ALSA-2023:0902)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2023:0902 advisory.

  - A type confusion issue was addressed with improved checks. (CVE-2023-23529)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-0902.html");
