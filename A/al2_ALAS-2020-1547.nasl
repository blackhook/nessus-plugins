...
if (description)
{
  ...
  script_name(english:"Amazon Linux 2 : spice-debuginfo (ALAS-2020-1547)");
...
vulnerability as referenced in the ALAS2-2020-1547 advisory.
...
pkgs = [
    {'reference':'spice-debuginfo-0.14.0-9.amzn2.1', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'spice-server-0.14.0-9.amzn2.1', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'spice-server-devel-0.14.0-9.amzn2.1', 'cpu':'x86_64', 'release':'AL2'}
];
