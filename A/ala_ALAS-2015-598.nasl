...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-598.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-598");
  script_xref(name:"RHSA", value:"2015:1447");

  script_name(english:"Amazon Linux AMI : grep (ALAS-2015-598)");
...
(CVE-2015-1345)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2015-598.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"grep-2.20-1.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"grep-debuginfo-2.20-1.14.amzn1")) flag++;
