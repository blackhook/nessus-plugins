...
if(description)
{
 script_id(41668);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825633";
...
"The remote host is missing AIX PTF U825633 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825633"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825633", package:"bos.rte.filesystem.6.1.2.4") < 0 ) 
