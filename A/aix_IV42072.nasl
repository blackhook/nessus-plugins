...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : inet (IV42072)");
  script_summary(english:"Check for APAR IV42072");
...
if (aix_check_ifix(release:"6.1", ml:"07", sp:"07", patch:"IV42072s7a", package:"bos.net.tcp.client", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.18") < 0) flag++;
