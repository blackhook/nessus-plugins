...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : pcnfsd (IZ73874)");
  script_summary(english:"Check for APAR IZ73874");
...
if (aix_check_ifix(release:"5.3", ml:"09", patch:"IZ73874_09", package:"bos.net.nfs.client", minfilesetver:"5.3.9.0", maxfilesetver:"5.3.9.5") < 0) flag++;
