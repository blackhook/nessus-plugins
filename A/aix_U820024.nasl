...
if(description)
{
 script_id(38239);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820024";
...
"The remote host is missing AIX PTF U820024 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820024"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820024", package:"bos.cifs_fs.rte.5.3.9.1") < 0 ) 
