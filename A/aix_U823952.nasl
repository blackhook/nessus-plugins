...
if(description)
{
 script_id(39100);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823952";
...
"The remote host is missing AIX PTF U823952 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823952"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823952", package:"bos.cifs_fs.rte.6.1.1.4") < 0 ) 
