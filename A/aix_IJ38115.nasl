...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : audit (IJ38115)");
  script_summary(english:"Check for APAR IJ38115");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"03", patch:"IJ38115m5a", package:"bos.rte.security", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"04", patch:"IJ38115m5a", package:"bos.rte.security", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"05", patch:"IJ38115m5a", package:"bos.rte.security", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.4") < 0) flag++;
