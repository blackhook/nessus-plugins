...
# AlmaLinux Security Advisory ALSA-2022:7024.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7024");
  script_xref(name:"IAVA", value:"2022-A-0491-S");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2022:7024)");
...
var pkgs = [
    {'reference':'firefox-102.3.0-7.el8_6.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.3.0-7.el8_6.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
