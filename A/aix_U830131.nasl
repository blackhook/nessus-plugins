...
if(description)
{
 script_id(45246);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830131";
...
"The remote host is missing AIX PTF U830131 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830131"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830131", package:"bos.alt_disk_install.rte.5.3.10.2") < 0 ) 
