...
if(description)
{
 script_id(34560);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819456";
...
"The remote host is missing AIX PTF U819456 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819456"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819456", package:"bos.rte.serv_aid.5.3.0.64") < 0 ) 
