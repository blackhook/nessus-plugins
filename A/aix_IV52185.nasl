...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : xorg (IV52185)");
  script_summary(english:"Check for APAR IV52185");
...
if (aix_check_ifix(release:"7.1", ml:"01", patch:"IV52185s0a", package:"X11.base.rte", minfilesetver:"7.1.1.0", maxfilesetver:"7.1.1.15") < 0) flag++;
