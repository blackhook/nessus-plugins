...
if(description)
{
 script_id(33630);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819248";
...
"The remote host is missing AIX PTF U819248 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819248"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819248", package:"X11.base.rte.5.3.7.4") < 0 ) 
