...
if(description)
{
 script_id(38275);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821385";
...
"The remote host is missing AIX PTF U821385 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821385"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821385", package:"bos.perf.tools.5.3.7.7") < 0 ) 
