...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 1 : variant4 (IJ05820) (Spectre)");
  script_summary(english:"Check for APAR IJ05820");
...
if (aix_check_ifix(release:"7.2", ml:"01", sp:"02", patch:"IJ05820m2a", package:"bos.mp64", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"03", patch:"IJ05820m3a", package:"bos.mp64", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"04", patch:"IJ05820m4a", package:"bos.mp64", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.5") < 0) flag++;
