...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : sendmail (IJ02918)");
  script_summary(english:"Check for APAR IJ02918");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"03", patch:"IJ02918s3a", package:"bos.net.tcp.sendmail", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"04", patch:"IJ02918s3a", package:"bos.net.tcp.sendmail", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"05", patch:"IJ02918s3a", package:"bos.net.tcp.sendmail", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"06", patch:"IJ02918sp6", package:"bos.net.tcp.sendmail", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.3") < 0) flag++;
