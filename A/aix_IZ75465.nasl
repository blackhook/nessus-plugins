...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : pcnfsd (IZ75465)");
  script_summary(english:"Check for APAR IZ75465");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ75465_02", package:"bos.net.nfs.client", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.7") < 0) flag++;
