...
# from AIX Security PTF U828317. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : X11.Dt.ToolTalk (U828317)");
  script_summary(english:"Check for PTF U828317");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U828317, which is related to the
...
/usr/dt/lib/libtt.a /usr/dt/bin/rpc.ttdbserver."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ52850"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610002", patch:"U828317", package:"X11.Dt.ToolTalk.6.1.2.1") < 0 ) flag++;
