...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : libodm (IV60314)");
  script_summary(english:"Check for APAR IV60314");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"04", patch:"IV60314s4a", package:"bos.rte.odm", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.15") < 0) flag++;
