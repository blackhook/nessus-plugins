...
if(description)
{
 script_id(39088);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823940";
...
"The remote host is missing AIX PTF U823940 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823940"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823940", package:"devices.pci.14106902.rte.6.1.1.5") < 0 ) 
