...
if(description)
{
 script_id(43294);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828957";
...
"The remote host is missing AIX PTF U828957 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828957"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828957", package:"devices.scsi.disk.rte.6.1.1.6") < 0 ) 
