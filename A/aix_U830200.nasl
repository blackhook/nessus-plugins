...
if(description)
{
 script_id(45301);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830200";
...
"The remote host is missing AIX PTF U830200 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830200"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830200", package:"bos.rte.install.5.3.9.6") < 0 ) 
