...
if(description)
{
 script_id(41824);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828503";
...
"The remote host is missing AIX PTF U828503 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828503"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828503", package:"bos.net.nfs.adt.6.1.1.2") < 0 ) 
