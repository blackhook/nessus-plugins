...
if(description)
{
 script_id(38367);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822043";
...
"The remote host is missing AIX PTF U822043 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822043"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822043", package:"devices.pci.77102224.com.5.3.8.2") < 0 ) 
