...
to zero, the request body was interpreted as a pipelined
request.(CVE-2020-10108)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1372.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"ALA", reference:"python26-twisted-web-8.2.0-6.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-twisted-web-8.2.0-6.6.amzn1")) flag++;
