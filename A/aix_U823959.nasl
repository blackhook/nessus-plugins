...
if(description)
{
 script_id(39107);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823959";
...
"The remote host is missing AIX PTF U823959 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823959"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823959", package:"bos.acct.6.1.1.5") < 0 ) 
