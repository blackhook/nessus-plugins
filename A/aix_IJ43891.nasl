...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : kernel (IJ43891)");
  script_summary(english:"Check for APAR IJ43891");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ43891s2a", package:"bos.perf.perfstat", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ43891s2a", package:"bos.perf.perfstat", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"03", patch:"IJ43891s3a", package:"bos.perf.perfstat", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
