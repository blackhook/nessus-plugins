...
if(description)
{
 script_id(43448);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828402";
...
"The remote host is missing AIX PTF U828402 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828402"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828402", package:"bos.alt_disk_install.rte.6.1.3.1") < 0 ) 
