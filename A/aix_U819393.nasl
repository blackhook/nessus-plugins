...
if(description)
{
 script_id(33702);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819393";
...
"The remote host is missing AIX PTF U819393 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819393"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819393", package:"bos.rte.bind_cmds.5.3.0.64") < 0 ) 
