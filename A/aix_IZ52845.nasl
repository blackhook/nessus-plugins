...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : libtt (IZ52845)");
  script_summary(english:"Check for APAR IZ52845");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ52845_08", package:"X11.Dt.ToolTalk", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.0") < 0) flag++;
