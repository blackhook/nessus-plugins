...
if(description)
{
 script_id(35849);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818439";
...
"The remote host is missing AIX PTF U818439 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818439"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818439", package:"bos.rte.bind_cmds.6.1.0.6") < 0 ) 
