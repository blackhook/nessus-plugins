...
# AlmaLinux Security Advisory ALSA-2021:4519.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4519");

  script_name(english:"AlmaLinux 8 : autotrace (ALSA-2021:4519)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4519.html");
...
"Update the affected autotrace package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:autotrace");
...
var pkgs = [
    {'reference':'autotrace-0.31.1-53.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'autotrace-0.31.1-53.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
