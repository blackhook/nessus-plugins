...
if(description)
{
 script_id(43297);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828960";
...
"The remote host is missing AIX PTF U828960 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828960"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828960", package:"devices.iscsi_sw.rte.6.1.1.5") < 0 ) 
