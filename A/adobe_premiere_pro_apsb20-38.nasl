...
if (description)
{
  ...
  script_name(english:"Adobe Premiere Pro < 14.3 Arbitrary Code Execution (APSB20-38)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Premiere Pro installed on the remote Windows host is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Adobe Premiere Pro installed on the remote Windows host is prior to 14.3
It is, therefore, affected by an out-of-bounds read vulnerability that could lead to Arbitrary Code Execution.
...
only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d011a2e1");
