...
if(description)
{
 script_id(34542);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819438";
...
"The remote host is missing AIX PTF U819438 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819438"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819438", package:"bos.net.tcp.server.5.3.0.70") < 0 ) 
