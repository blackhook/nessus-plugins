...
modifying BASH_CMDS, thus allowing the user to execute any command
with the permissions of the shell. (CVE-2019-9924)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1379.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"ALA", reference:"bash-4.2.46-34.43.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bash-debuginfo-4.2.46-34.43.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bash-doc-4.2.46-34.43.amzn1")) flag++;
