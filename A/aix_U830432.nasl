...
if(description)
{
 script_id(44559);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830432";
...
"The remote host is missing AIX PTF U830432 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830432"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830432", package:"devices.pci.77102224.com.6.1.4.3") < 0 ) 
