...
if(description)
{
 script_id(44452);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829872";
...
"The remote host is missing AIX PTF U829872 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829872"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829872", package:"devices.pciex.8680c71014108003.rte.5.3.11.1") < 0 ) 
