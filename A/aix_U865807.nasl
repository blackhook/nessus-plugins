...
# from AIX Security PTF U865807. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : bos.rte.odm (U865807)");
  script_summary(english:"Check for PTF U865807");
...
to libodm.a bug."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV60313"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610007", patch:"U865807", package:"bos.rte.odm.6.1.7.17") < 0 ) flag++;
