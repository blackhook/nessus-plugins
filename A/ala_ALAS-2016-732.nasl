...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-732.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-732");

  script_name(english:"Amazon Linux AMI : samba (ALAS-2016-732)");
...
the server."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-732.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"ctdb-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"ctdb-devel-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"ctdb-tests-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsmbclient-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libsmbclient-devel-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libwbclient-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libwbclient-devel-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-client-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-client-libs-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-common-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-common-libs-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-common-tools-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-debuginfo-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-devel-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-libs-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-pidl-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-python-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-test-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-test-devel-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-test-libs-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-winbind-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-winbind-clients-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-winbind-krb5-locator-4.2.10-7.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"samba-winbind-modules-4.2.10-7.34.amzn1")) flag++;
