...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : sendmail (IZ72528)");
  script_summary(english:"Check for APAR IZ72528");
...
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ72528_01", package:"bos.net.tcp.client", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.7") < 0) flag++;
