...
# from AIX Security PTF U858320. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 : bos.net.tcp.client (U858320)");
  script_summary(english:"Check for PTF U858320");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U858320, which is related to the
...
a users .forward. This apples to sendmail_ssl and sendmail_nossl."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV22964"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710000", patch:"U858320", package:"bos.net.tcp.client.7.1.0.24") < 0 ) flag++;
