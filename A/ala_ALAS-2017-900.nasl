...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-900.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-900");

  script_name(english:"Amazon Linux AMI : file (ALAS-2017-900)");
  ...
  script_set_attribute(
    ...
    value:
"An issue in file allowed an attacker to overwrite a fixed 20-byte
stack buffer with a specially crafted .notes section in an ELF binary."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-900.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"file-5.30-11.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-debuginfo-5.30-11.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-devel-5.30-11.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-libs-5.30-11.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"file-static-5.30-11.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python26-magic-5.30-11.34.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"python27-magic-5.30-11.34.amzn1")) flag++;
