...
# AlmaLinux Security Advisory ALSA-2023:2784.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2784");
  script_xref(name:"IAVB", value:"2022-B-0042-S");

  script_name(english:"AlmaLinux 8 : grafana (ALSA-2023:2784)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-2784.html");
