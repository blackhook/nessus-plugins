...
# from AIX Security PTF U825763. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 : devices.common.IBM.atm.rte (U825763)");
  script_summary(english:"Check for PTF U825763");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825763, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48502"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610000", patch:"U825763", package:"devices.common.IBM.atm.rte.6.1.0.2") < 0 ) flag++;
