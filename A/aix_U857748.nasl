...
# from AIX Security PTF U857748. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : bos.net.tcp.client (U857748)");
  script_summary(english:"Check for PTF U857748");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U857748, which is related to the
...
IPv6 address is configured on any of the network interfaces."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV37925"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610006", patch:"U857748", package:"bos.net.tcp.client.6.1.6.23") < 0 ) flag++;
