...
if(description)
{
 script_id(43239);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828844";
...
"The remote host is missing AIX PTF U828844 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828844"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828844", package:"devices.ide.cdrom.rte.6.1.2.3") < 0 ) 
