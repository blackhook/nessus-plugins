...
and management of avast! antivirus within an enterprise.");
  script_set_attribute(attribute:"see_also", value:"https://www.avast.com/index");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/a:vmware:ams");
...
myip = split(compat::this_host(), sep:".", keep:FALSE);
req =
  mkbyte(int(myip[0])) +
    mkbyte(int(myip[1])) +
    mkbyte(int(myip[2])) +
