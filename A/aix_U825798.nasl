...
if(description)
{
 script_id(41704);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825798";
...
"The remote host is missing AIX PTF U825798 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825798"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825798", package:"bos.perf.tools.6.1.0.10") < 0 ) 
