...
if(description)
{
 script_id(39278);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825766";
...
"The remote host is missing AIX PTF U825766 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825766"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825766", package:"devices.pci.1410bd02.diag.6.1.0.5") < 0 ) 
