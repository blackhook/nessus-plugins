...
if(description)
{
 script_id(38253);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820038";
...
"The remote host is missing AIX PTF U820038 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820038"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820038", package:"bos.rte.install.5.3.9.3") < 0 ) 
