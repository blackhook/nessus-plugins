...
if(description)
{
 script_id(33068);
 script_version("1.6");
 name["english"] = "AIX 610001 : U818171";
...
"The remote host is missing AIX PTF U818171 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818171"; 
...
if ( aix_check_patch(ml:"610001", patch:"U818171", package:"bos.net.nfs.adt.6.1.1.1") < 0 ) 
