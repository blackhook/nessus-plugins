...
if(description)
{
 script_id(45224);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830109";
...
"The remote host is missing AIX PTF U830109 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830109"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830109", package:"devices.pciex.8680c71014108003.rte.5.3.10.3") < 0 ) 
