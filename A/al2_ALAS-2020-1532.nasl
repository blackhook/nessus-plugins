...
multiple vulnerabilities as referenced in the ALAS2-2020-1532 advisory.
...
pkgs = [
    {'reference':'libtiff-4.0.3-35.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libtiff-4.0.3-35.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libtiff-4.0.3-35.amzn2', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'libtiff-debuginfo-4.0.3-35.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libtiff-debuginfo-4.0.3-35.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libtiff-debuginfo-4.0.3-35.amzn2', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'libtiff-devel-4.0.3-35.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libtiff-devel-4.0.3-35.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libtiff-devel-4.0.3-35.amzn2', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'libtiff-static-4.0.3-35.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libtiff-static-4.0.3-35.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libtiff-static-4.0.3-35.amzn2', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'libtiff-tools-4.0.3-35.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libtiff-tools-4.0.3-35.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libtiff-tools-4.0.3-35.amzn2', 'cpu':'x86_64', 'release':'AL2'}
];
