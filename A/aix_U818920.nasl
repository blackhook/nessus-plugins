...
if(description)
{
 script_id(34000);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818920";
...
"The remote host is missing AIX PTF U818920 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818920"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818920", package:"devices.pciex.14103f03.diag.6.1.0.2") < 0 ) 
