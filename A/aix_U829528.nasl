...
if(description)
{
 script_id(42701);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829528";
...
"The remote host is missing AIX PTF U829528 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829528"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829528", package:"devices.fcp.tape.rte.5.3.8.5") < 0 ) 
