...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 0 : swcons (IZ18341)");
  script_summary(english:"Check for APAR IZ18341");
...
if (aix_check_ifix(release:"6.1", ml:"00", patch:"IZ18341_00", package:"bos.rte.console", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.0.0") < 0) flag++;
