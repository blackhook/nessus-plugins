...
# AlmaLinux Security Advisory ALSA-2021:1756.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:1756");

  script_name(english:"AlmaLinux 8 : qt5-qtbase (ALSA-2021:1756)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-1756.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected qt5-qtbase-static package.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'qt5-qtbase-static');
}
