...
if(description)
{
 script_id(42662);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829489";
...
"The remote host is missing AIX PTF U829489 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829489"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829489", package:"bos.rte.filesystem.5.3.8.6") < 0 ) 
