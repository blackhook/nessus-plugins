...
# from AIX Security PTF U832875. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : bos.net.tcp.client (U832875)");
  script_summary(english:"Check for PTF U832875");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U832875, which is related to the
...
"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ71608"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530010", patch:"U832875", package:"bos.net.tcp.client.5.3.10.3") < 0 ) flag++;
