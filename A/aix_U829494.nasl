...
if(description)
{
 script_id(42667);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829494";
...
"The remote host is missing AIX PTF U829494 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829494"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829494", package:"devices.common.IBM.sissas.rte.5.3.8.5") < 0 ) 
