...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : bellmail (IV91007) (deprecated)");
  script_summary(english:"Check for APAR IV91007");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV91007s7a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV91007s7a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV91007s7a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
