...
if(description)
{
 script_id(34516);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819314";
...
"The remote host is missing AIX PTF U819314 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819314"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819314", package:"bos.cifs_fs.rte.5.3.7.1") < 0 ) 
