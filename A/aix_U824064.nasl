...
if(description)
{
 script_id(39145);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824064";
...
"The remote host is missing AIX PTF U824064 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824064"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824064", package:"bos.alt_disk_install.rte.6.1.2.2") < 0 ) 
