...
if(description)
{
 ...
 script_name(english: "AIX 530009 : U826310");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826310");
...
if ( aix_check_patch(ml:"530009", patch:"U826310", package:"devices.pci.1410a803.rte.5.3.9.0") < 0 ) 
