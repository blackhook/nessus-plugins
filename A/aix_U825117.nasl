...
if(description)
{
 script_id(39679);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825117";
...
"The remote host is missing AIX PTF U825117 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825117"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825117", package:"bos.acct.5.3.8.5") < 0 ) 
