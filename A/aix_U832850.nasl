...
# from AIX Security PTF U832850. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 11 : bos.net.nfs.client (U832850)");
  script_summary(english:"Check for PTF U832850");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U832850, which is related to the
...
"
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ73681");
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530011", patch:"U832850", package:"bos.net.nfs.client.5.3.11.4") < 0 ) flag++;
