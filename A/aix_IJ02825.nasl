...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : aixbase (IJ02825)");
  script_summary(english:"Check for APAR IJ02825");
...
if (aix_check_ifix(release:"7.1", ml:"04", sp:"03", patch:"IJ02825s3a", package:"bos.cluster.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.32") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"04", patch:"IJ02825s4a", package:"bos.cluster.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.32") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"05", patch:"IJ02825s5a", package:"bos.cluster.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.32") < 0) flag++;
