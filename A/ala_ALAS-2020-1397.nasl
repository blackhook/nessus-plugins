...
7.4.6, when HTTP file uploads are allowed, supplying overly long
filenames or field names could lead PHP engine to try to allocate
oversized memory storage, hit the memory limit and stop processing the
request, without cleaning up temporary files created by upload
request. This potentially could lead to accumulation of uncleaned
temporary files exhausting the disk space on the target server.
(CVE-2019-11048)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1397.html"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
flag = 0;
if (rpm_check(release:"ALA", reference:"php72-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-bcmath-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-cli-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-common-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-dba-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-dbg-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-debuginfo-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-devel-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-embedded-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-enchant-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-fpm-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-gd-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-gmp-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-imap-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-intl-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-json-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-ldap-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-mbstring-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-mysqlnd-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-odbc-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-opcache-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pdo-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pdo-dblib-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pgsql-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-process-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-pspell-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-recode-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-snmp-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-soap-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-tidy-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-xml-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php72-xmlrpc-7.2.31-1.23.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-bcmath-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-cli-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-common-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-dba-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-dbg-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-debuginfo-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-devel-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-embedded-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-enchant-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-fpm-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-gd-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-gmp-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-imap-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-intl-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-json-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-ldap-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-mbstring-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-mysqlnd-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-odbc-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-opcache-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pdo-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pdo-dblib-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pgsql-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-process-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-pspell-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-recode-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-snmp-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-soap-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-tidy-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-xml-7.3.19-1.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php73-xmlrpc-7.3.19-1.26.amzn1")) flag++;
