...
if(description)
{
 script_id(42578);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829358";
...
"The remote host is missing AIX PTF U829358 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829358"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829358", package:"devices.chrp.base.rte.5.3.9.4") < 0 ) 
