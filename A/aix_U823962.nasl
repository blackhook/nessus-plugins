...
if(description)
{
 script_id(39110);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823962";
...
"The remote host is missing AIX PTF U823962 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823962"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823962", package:"devices.common.IBM.ib.rte.6.1.1.5") < 0 ) 
