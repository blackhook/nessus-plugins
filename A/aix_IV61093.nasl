...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : bind9 (IV61093)");
  script_summary(english:"Check for APAR IV61093");
...
if (aix_check_ifix(release:"7.1", ml:"01", sp:"09", patch:"IV61093s9a", package:"bos.net.tcp.server", minfilesetver:"7.1.1.0", maxfilesetver:"7.1.1.20") < 0) flag++;
