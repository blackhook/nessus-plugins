...
# AlmaLinux Security Advisory ALSA-2021:1206.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:1206");

  script_name(english:"AlmaLinux 8 : gnutls and nettle (ALSA-2021:1206)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2021:1206 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-1206.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected gnutls and / or nettle packages.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'gnutls / nettle');
}
