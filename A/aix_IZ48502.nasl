...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 0 : muxatmd (IZ48502)");
  script_summary(english:"Check for APAR IZ48502");
...
if (aix_check_ifix(release:"6.1", ml:"00", patch:"IZ48502_00", package:"devices.common.IBM.atm.rte", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.0.1") < 0) flag++;
