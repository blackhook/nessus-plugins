...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-770.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-770");

  script_name(english:"Amazon Linux AMI : openssh (ALAS-2016-770)");
...
arbitrary code as root."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-770.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"openssh-6.6.1p1-31.62.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssh-clients-6.6.1p1-31.62.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssh-debuginfo-6.6.1p1-31.62.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssh-keycat-6.6.1p1-31.62.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssh-ldap-6.6.1p1-31.62.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssh-server-6.6.1p1-31.62.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"pam_ssh_agent_auth-0.9.3-9.31.62.amzn1")) flag++;
