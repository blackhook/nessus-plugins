...
if(description)
{
 script_id(44009);
 script_version("1.5");
 name["english"] = "AIX 610004 : U830386";
...
"The remote host is missing AIX PTF U830386 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830386"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830386", package:"devices.pci.1410bd02.diag.6.1.4.1") < 0 ) 
