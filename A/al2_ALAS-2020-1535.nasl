...
multiple vulnerabilities as referenced in the ALAS2-2020-1535 advisory.
...
pkgs = [
    {'reference':'libxslt-1.1.28-6.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libxslt-1.1.28-6.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libxslt-1.1.28-6.amzn2', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'libxslt-debuginfo-1.1.28-6.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libxslt-debuginfo-1.1.28-6.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libxslt-debuginfo-1.1.28-6.amzn2', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'libxslt-devel-1.1.28-6.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libxslt-devel-1.1.28-6.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libxslt-devel-1.1.28-6.amzn2', 'cpu':'x86_64', 'release':'AL2'},
    {'reference':'libxslt-python-1.1.28-6.amzn2', 'cpu':'aarch64', 'release':'AL2'},
    {'reference':'libxslt-python-1.1.28-6.amzn2', 'cpu':'i686', 'release':'AL2'},
    {'reference':'libxslt-python-1.1.28-6.amzn2', 'cpu':'x86_64', 'release':'AL2'}
];
