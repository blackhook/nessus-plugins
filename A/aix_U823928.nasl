...
if(description)
{
 script_id(39076);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823928";
...
"The remote host is missing AIX PTF U823928 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823928"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823928", package:"bos.64bit.6.1.1.3") < 0 ) 
