...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : xorg (IJ11544)");
  script_summary(english:"Check for APAR IJ11544");
...
if (aix_check_ifix(release:"7.1", ml:"04", patch:"IJ11544s0a", package:"X11.base.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.30") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"00", patch:"IJ11544s0a", package:"X11.base.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.31") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"01", patch:"IJ11544s0a", package:"X11.base.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.31") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"02", patch:"IJ11544s0a", package:"X11.base.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.31") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"03", patch:"IJ11544s0a", package:"X11.base.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.30") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"03", patch:"IJ11545s0a", package:"X11.base.rte", minfilesetver:"7.1.5.31", maxfilesetver:"7.1.5.31") < 0) flag++;
