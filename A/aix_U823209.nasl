...
if(description)
{
 script_id(44183);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823209";
...
"The remote host is missing AIX PTF U823209 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823209"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823209", package:"bos.64bit.5.3.10.2") < 0 ) 
