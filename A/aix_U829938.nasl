...
if(description)
{
 script_id(44518);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829938";
...
"The remote host is missing AIX PTF U829938 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829938"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829938", package:"bos.net.nfs.cachefs.5.3.11.2") < 0 ) 
