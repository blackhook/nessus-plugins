...
if(description)
{
 script_id(35129);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821341";
...
"The remote host is missing AIX PTF U821341 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821341"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821341", package:"bos.perf.tools.5.3.7.6") < 0 ) 
