...
if(description)
{
 script_id(42496);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825152";
...
"The remote host is missing AIX PTF U825152 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825152"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825152", package:"bos.rte.install.5.3.8.8") < 0 ) 
