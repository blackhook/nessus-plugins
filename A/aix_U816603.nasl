...
if(description)
{
 script_id(32887);
 script_version("1.6");
 name["english"] = "AIX 530006 : U816603";
...
"The remote host is missing AIX PTF U816603 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U816603"; 
...
if ( aix_check_patch(ml:"530006", patch:"U816603", package:"devices.common.IBM.atm.rte.5.3.0.63") < 0 ) 
