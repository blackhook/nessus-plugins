...
if(description)
{
 script_id(39042);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823864";
...
"The remote host is missing AIX PTF U823864 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823864"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823864", package:"devices.pci.77102224.com.6.1.0.6") < 0 ) 
