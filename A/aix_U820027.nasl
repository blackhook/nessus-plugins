...
if(description)
{
 script_id(38242);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820027";
...
"The remote host is missing AIX PTF U820027 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820027"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820027", package:"bos.rte.bind_cmds.5.3.9.2") < 0 ) 
