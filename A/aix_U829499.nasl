...
if(description)
{
 script_id(42672);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829499";
...
"The remote host is missing AIX PTF U829499 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829499"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829499", package:"bos.64bit.5.3.8.7") < 0 ) 
