...
if(description)
{
 script_id(39059);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823911";
...
"The remote host is missing AIX PTF U823911 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823911"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823911", package:"bos.rte.aio.6.1.1.4") < 0 ) 
