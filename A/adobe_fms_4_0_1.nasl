...
if (description)
{
  ...
  script_bugtraq_id(44753, 44756, 44757);
...
following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.adobe.com/support/security/bulletins/apsb10-27.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Flash Media Server 3.0.7, 3.5.5, 4.0.1 or later.");
