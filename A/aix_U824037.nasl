...
if(description)
{
 script_id(39122);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824037";
...
"The remote host is missing AIX PTF U824037 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824037"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824037", package:"bos.rte.bind_cmds.6.1.2.3") < 0 ) 
