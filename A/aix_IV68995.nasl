...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : bind9 (IV68995)");
  script_summary(english:"Check for APAR IV68995");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"06", patch:"IV68995s6a", package:"bos.net.tcp.server", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.18") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"02", sp:"06", patch:"IV68995s6a", package:"bos.net.tcp.client", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.19") < 0) flag++;
