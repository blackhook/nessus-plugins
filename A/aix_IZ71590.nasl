...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : qoslist (IZ71590)");
  script_summary(english:"Check for APAR IZ71590");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ71590_02", package:"bos.net.tcp.server", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.4") < 0) flag++;
