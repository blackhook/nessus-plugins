...
if(description)
{
 script_id(43429);
 script_version("1.5");
 name["english"] = "AIX 610003 : U827938";
...
"The remote host is missing AIX PTF U827938 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U827938"; 
...
if ( aix_check_patch(ml:"610003", patch:"U827938", package:"bos.perf.proctools.6.1.3.1") < 0 ) 
