...
if(description)
{
 script_id(43490);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828732";
...
"The remote host is missing AIX PTF U828732 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828732"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828732", package:"devices.chrp.base.rte.6.1.3.3") < 0 ) 
