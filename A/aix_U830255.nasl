...
# from AIX Security PTF U830255. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : bos.net.tcp.client (U830255)");
  script_summary(english:"Check for PTF U830255");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U830255, which is related to the
...
"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ71093"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530009", patch:"U830255", package:"bos.net.tcp.client.5.3.9.8") < 0 ) flag++;
