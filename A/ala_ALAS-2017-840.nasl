...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-840.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-840");

  script_name(english:"Amazon Linux AMI : libtirpc (ALAS-2017-840)");
...
attacker sending thousands of messages to rpcbind could cause its
memory usage to grow without bound, eventually causing it to be
terminated by the OOM killer. (CVE-2017-8779)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-840.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libtirpc-0.2.4-0.8.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libtirpc-debuginfo-0.2.4-0.8.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libtirpc-devel-0.2.4-0.8.14.amzn1")) flag++;
