...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : nettcp (IV86117) (SLOTH)");
  script_summary(english:"Check for APAR IV86117");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV86117m7a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV86117m7a", package:"bos.net.tcp.server", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
