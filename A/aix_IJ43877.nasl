...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ43877)");
  script_summary(english:"Check for APAR IJ43877");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43877s3a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43877s3a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ43877s4a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ43877s4a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"IJ43877s5a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"IJ43877s5a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
