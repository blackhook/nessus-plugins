...
#@DEPRECATED@
#
# Disabled on 2014/03/10.  Deprecated by aix_U841068.nasl, aix_U848193.nasl
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : large_send (IV14209)");
  script_summary(english:"Check for APAR IV14209");
...
exit(0, 'This plugin has been deprecated.  Use plugin #72839 (aix_U841068.nasl) and #72844 (aix_U848193.nasl) instead.');
...
if (aix_check_ifix(release:"6.1", ml:"07", sp:"02", patch:"IV14209s02", package:"bos.net.tcp.client", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.3") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"07", sp:"03", patch:"IV14209s03", package:"bos.net.tcp.client", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.3") < 0) flag++;
