...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : lvm (IV68478)");
  script_summary(english:"Check for APAR IV68478");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"05", patch:"IV68478s5b", package:"bos.rte.lvm", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.19") < 0) flag++;
