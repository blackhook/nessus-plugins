...
if(description)
{
 script_id(33687);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819378";
...
"The remote host is missing AIX PTF U819378 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819378"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819378", package:"bos.net.nfs.adt.5.3.0.63") < 0 ) 
