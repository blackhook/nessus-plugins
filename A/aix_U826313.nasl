...
if(description)
{
 ...
 script_name(english: "AIX 530009 : U826313");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826313");
...
if ( aix_check_patch(ml:"530009", patch:"U826313", package:"devices.pciex.7710322577107601.rte.5.3.9.0") < 0 ) 
