...
# AlmaLinux Security Advisory ALSA-2023:2366.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2366");

  script_name(english:"AlmaLinux 9 : emacs (ALSA-2023:2366)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2366.html");
