...
if(description)
{
 script_id(45203);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830088";
...
"The remote host is missing AIX PTF U830088 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830088"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830088", package:"devices.pci.77102224.com.5.3.10.3") < 0 ) 
