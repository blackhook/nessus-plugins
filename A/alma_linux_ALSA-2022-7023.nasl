...
# AlmaLinux Security Advisory ALSA-2022:7023.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7023");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2022:7023)");
...
var pkgs = [
    {'reference':'thunderbird-102.3.0-4.el8_6.alma.plus', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.3.0-4.el8_6.alma.plus', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
