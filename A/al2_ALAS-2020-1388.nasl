...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"A heap use-after-free vulnerability was found in systemd, where
asynchronous Polkit queries are performed while handling dbus
messages. A local unprivileged attacker can abuse this flaw to crash
systemd services or potentially execute code and elevate their
privileges, by sending specially crafted dbus messages.
(CVE-2020-1712)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1388.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"libgudev1-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"libgudev1-devel-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-debuginfo-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-devel-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-journal-gateway-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-libs-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-networkd-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-python-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-resolved-219-57.amzn2.0.12")) flag++;
if (rpm_check(release:"AL2", reference:"systemd-sysv-219-57.amzn2.0.12")) flag++;
