...
if(description)
{
 script_id(43263);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828869";
...
"The remote host is missing AIX PTF U828869 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828869"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828869", package:"bos.perf.tools.6.1.2.6") < 0 ) 
