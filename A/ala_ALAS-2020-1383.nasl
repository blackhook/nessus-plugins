...
current working directory of the victim's system. (CVE-2018-10916)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1383.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"ALA", reference:"lftp-4.4.8-12.30.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"lftp-debuginfo-4.4.8-12.30.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"lftp-scripts-4.4.8-12.30.amzn1")) flag++;
