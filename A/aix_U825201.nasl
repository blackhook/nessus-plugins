...
if(description)
{
 script_id(39705);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825201";
...
"The remote host is missing AIX PTF U825201 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825201"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825201", package:"perfagent.tools.5.3.9.3") < 0 ) 
