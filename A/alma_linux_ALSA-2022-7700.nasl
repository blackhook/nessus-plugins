...
# AlmaLinux Security Advisory ALSA-2022:7700.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7700");

  script_name(english:"AlmaLinux 8 : gdisk (ALSA-2022:7700)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7700.html");
...
"Update the affected gdisk package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:gdisk");
