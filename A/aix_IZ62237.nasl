...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : cmsd (IZ62237)");
  script_summary(english:"Check for APAR IZ62237");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ62237_08", package:"X11.Dt.rte", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.1") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ62237_08", package:"X11.Dt.lib", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.0") < 0) flag++;
