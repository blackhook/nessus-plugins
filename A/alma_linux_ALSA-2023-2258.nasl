...
# AlmaLinux Security Advisory ALSA-2023:2258.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2258");

  script_name(english:"AlmaLinux 9 : python-mako (ALSA-2023:2258)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2258.html");
