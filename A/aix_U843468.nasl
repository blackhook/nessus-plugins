...
# from AIX Security PTF U843468. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : bos.net.tcp.client (U843468)");
  script_summary(english:"Check for PTF U843468");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U843468, which is related to the
...
an attacker could exploit this vulnerability to cause a kernel panic."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV08787"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV08255"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710001", patch:"U843468", package:"bos.net.tcp.client.7.1.1.15") < 0 ) flag++;
