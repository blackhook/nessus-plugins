...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-222.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-222");

  script_name(english:"Amazon Linux AMI : cacti (ALAS-2013-222)");
...
arbitrary SQL commands via unspecified vectors."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-222.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"cacti-0.8.8b-2.10.amzn1")) flag++;
