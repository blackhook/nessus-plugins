...
if(description)
{
 script_id(41809);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828488";
...
"The remote host is missing AIX PTF U828488 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828488"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828488", package:"bos.alt_disk_install.rte.6.1.1.4") < 0 ) 
