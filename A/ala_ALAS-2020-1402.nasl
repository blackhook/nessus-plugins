...
flag = 0;
if (rpm_check(release:"ALA", reference:"mysql56-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-bench-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-common-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-debuginfo-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-devel-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-embedded-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-embedded-devel-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-errmsg-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-libs-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-server-5.6.49-1.37.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"mysql56-test-5.6.49-1.37.amzn1")) flag++;
