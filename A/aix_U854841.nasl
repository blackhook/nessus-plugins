...
# from AIX Security PTF U854841. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 : bos.rte.filesystem (U854841)");
  script_summary(english:"Check for PTF U854841");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U854841, which is related to the
...
vulnerability via the -k argument to kill a process of another user."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV28754"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710000", patch:"U854841", package:"bos.rte.filesystem.7.1.0.20") < 0 ) flag++;
