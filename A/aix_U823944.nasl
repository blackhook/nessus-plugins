...
if(description)
{
 script_id(39092);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823944";
...
"The remote host is missing AIX PTF U823944 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823944"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823944", package:"bos.rte.filesystem.6.1.1.5") < 0 ) 
