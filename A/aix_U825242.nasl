...
if(description)
{
 script_id(42513);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825242";
...
"The remote host is missing AIX PTF U825242 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825242"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825242", package:"perfagent.tools.5.3.9.4") < 0 ) 
