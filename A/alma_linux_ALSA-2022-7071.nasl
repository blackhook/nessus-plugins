...
# AlmaLinux Security Advisory ALSA-2022:7071.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7071");
  script_xref(name:"IAVA", value:"2022-A-0435-S");
  script_xref(name:"IAVA", value:"2023-A-0132-S");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2022:7071)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7071.html");
...
var pkgs = [
    {'reference':'firefox-102.4.0-1.el9_0.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.4.0-1.el9_0.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
