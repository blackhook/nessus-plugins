...
if(description)
{
 script_id(44243);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829274";
...
"The remote host is missing AIX PTF U829274 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829274"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829274", package:"bos.adt.debug.5.3.10.1") < 0 ) 
