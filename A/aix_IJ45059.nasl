...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : libxml2 (IJ45059)");
  script_summary(english:"Check for APAR IJ45059");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ45059m2a", package:"bos.rte.control", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.2") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ45059m2a", package:"bos.rte.control", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.2") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"03", patch:"IJ45059m2b", package:"bos.rte.control", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.2") < 0) flag++;
