...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : tftp (IV42935)");
  script_summary(english:"Check for APAR IV42935");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"02", patch:"IV42935s2a", package:"bos.net.tcp.client", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.15") < 0) flag++;
