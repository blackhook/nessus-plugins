...
if (description)
{
  ...
  script_name(english:"Adobe InDesign <= 16.3 Multiple Arbitrary Code Execution Vulnerabilities (APSB21-73)");
...
"The version of Adobe InDesign installed on the remote Windows host is prior or equal to 16.3. It is, therefore,
...
var constraints = [
  { 'fixed_version':'16.3.1', 'fixed_display':'16.4' }
];
