...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 11.x < 11.0.2.9.3 Vulnerability");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 11 < 11.0.2.9.3. It is, therefore, affected by a
vulnerability as referenced in the corretto-11-2019-Mar-19 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 11.0.2.9.3 or later");
...
var constraints = [
  { 'min_version' : '11.0', 'fixed_version' : '11.0.2.9.3' }
];
