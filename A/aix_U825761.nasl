...
if(description)
{
 script_id(39273);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825761";
...
"The remote host is missing AIX PTF U825761 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825761"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825761", package:"perfagent.tools.6.1.0.5") < 0 ) 
