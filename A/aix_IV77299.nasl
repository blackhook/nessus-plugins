...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : netstat (IV77299)");
  script_summary(english:"Check for APAR IV77299");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV77299s5b", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.45") < 0) flag++;
