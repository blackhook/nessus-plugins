...
if(description)
{
 script_id(39267);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825754";
...
"The remote host is missing AIX PTF U825754 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825754"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825754", package:"bos.rte.filesystem.6.1.0.8") < 0 ) 
