...
if(description)
{
 script_id(43240);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828845";
...
"The remote host is missing AIX PTF U828845 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828845"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828845", package:"devices.common.IBM.fc.rte.6.1.2.4") < 0 ) 
