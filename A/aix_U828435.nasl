...
# from AIX Security PTF U828435. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 3 : bos.net.tcp.server (U828435)");
  script_summary(english:"Check for PTF U828435");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U828435, which is related to the
...
/usr/sbin/named9."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ56318"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610003", patch:"U828435", package:"bos.net.tcp.server.6.1.3.1") < 0 ) flag++;
