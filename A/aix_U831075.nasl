...
if(description)
{
 script_id(43320);
 script_version("1.5");
 name["english"] = "AIX 610002 : U831075";
...
"The remote host is missing AIX PTF U831075 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U831075"; 
...
if ( aix_check_patch(ml:"610002", patch:"U831075", package:"bos.rte.serv_aid.6.1.2.3") < 0 ) 
