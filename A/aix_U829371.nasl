...
if(description)
{
 script_id(42591);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829371";
...
"The remote host is missing AIX PTF U829371 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829371"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829371", package:"bos.perf.proctools.5.3.9.2") < 0 ) 
