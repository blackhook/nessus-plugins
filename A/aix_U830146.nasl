...
if(description)
{
 script_id(45261);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830146";
...
"The remote host is missing AIX PTF U830146 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830146"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830146", package:"devices.fcp.tape.rte.5.3.10.2") < 0 ) 
