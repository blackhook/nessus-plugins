...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : kernel (IJ43967)");
  script_summary(english:"Check for APAR IJ43967");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ43967m8a", package:"bos.mp64", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43967m9a", package:"bos.mp64", minfilesetver:"7.1.5.45", maxfilesetver:"7.1.5.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43967m9b", package:"bos.mp64", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.44") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"10", patch:"IJ43967mAa", package:"bos.mp64", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"11", patch:"IJ43967sBa", package:"bos.mp64", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.47") < 0) flag++;
