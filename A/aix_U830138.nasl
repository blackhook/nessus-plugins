...
if(description)
{
 script_id(45253);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830138";
...
"The remote host is missing AIX PTF U830138 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830138"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830138", package:"bos.net.tcp.server.5.3.10.2") < 0 ) 
