...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-400.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-400");

  script_name(english:"Amazon Linux AMI : glibc (ALAS-2014-400)");
...
the privileges of that application."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-400.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"glibc-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-common-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-debuginfo-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-debuginfo-common-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-devel-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-headers-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-static-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-utils-2.17-55.86.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nscd-2.17-55.86.amzn1")) flag++;
