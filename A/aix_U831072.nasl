...
if(description)
{
 script_id(43317);
 script_version("1.5");
 name["english"] = "AIX 610002 : U831072";
...
"The remote host is missing AIX PTF U831072 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U831072"; 
...
if ( aix_check_patch(ml:"610002", patch:"U831072", package:"bos.rte.filesystem.6.1.2.5") < 0 ) 
