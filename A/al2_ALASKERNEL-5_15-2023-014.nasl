...
if (description)
{
  ...
  script_cve_id("CVE-2022-4129", "CVE-2023-1652");
...
"The version of kernel installed on the remote host is prior to 5.15.93-55.139. It is, therefore, affected by a
vulnerability as referenced in the ALAS2KERNEL-5.15-2023-014 advisory.
...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2022-4129", "CVE-2023-1652");
