...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 8.x < 8.262.10.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 8 < 8.262.10.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-8-2020-Jul-14 advisory.

  - core-libs/java.util.concurrent (CVE-2020-14556)

  - security-libs/javax.net.ssl (CVE-2020-14577)

  - security-libs/java.security (CVE-2020-14578, CVE-2020-14579)
  ...
  - javafx/graphics (CVE-2020-14664)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  # https://github.com/corretto/corretto-8/blob/develop/CHANGELOG.md#corretto-version-8262101
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b306575");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 8.262.10.1 or later");
...
var constraints = [
  { 'min_version' : '8.0', 'fixed_version' : '8.262.10.1' }
];
