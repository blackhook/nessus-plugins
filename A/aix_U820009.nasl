...
if(description)
{
 script_id(38224);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820009";
...
"The remote host is missing AIX PTF U820009 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820009"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820009", package:"devices.common.IBM.fc.rte.5.3.9.2") < 0 ) 
