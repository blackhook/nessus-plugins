...
if(description)
{
 script_id(45170);
 script_version("1.4");
 name["english"] = "AIX 530009 : U829447";
...
"The remote host is missing AIX PTF U829447 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829447"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829447", package:"bos.rte.bind_cmds.5.3.9.5") < 0 ) 
