...
# from AIX Security PTF U860216. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : X11.base.rte (U860216)");
  script_summary(english:"Check for PTF U860216");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U860216, which is related to the
...
request that triggers memory-allocation failure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV52978"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610009", patch:"U860216", package:"X11.base.rte.6.1.9.15") < 0 ) flag++;
