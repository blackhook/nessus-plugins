...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ44427m2a", package:"bos.net.tcp.bind", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ44427m2a", package:"bos.net.tcp.bind", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"03", patch:"IJ44427s3a", package:"bos.net.tcp.bind", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.1") < 0) flag++;
