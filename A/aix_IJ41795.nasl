...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ41795)");
  script_summary(english:"Check for APAR IJ41795");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ41795m2a", package:"bos.mp64", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ41795m2a", package:"bos.mp64", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.105") < 0) flag++;
