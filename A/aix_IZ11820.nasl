...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : kernel (IZ11820)");
  script_summary(english:"Check for APAR IZ11820");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ11820_7a", package:"bos.mp64", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ11820_7a", package:"bos.mp", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ11820_7a", package:"bos.rte.lvm", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.0") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ11820_7b", package:"bos.mp64", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ11820_7b", package:"bos.mp", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ11820_7b", package:"bos.rte.lvm", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.0") < 0) flag++;
