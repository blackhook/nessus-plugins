...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : wpar (IV08320)");
  script_summary(english:"Check for APAR IV08320");
...
if (aix_check_ifix(release:"7.1", ml:"01", sp:"00", patch:"IV08320s00", package:"bos.mp64", minfilesetver:"7.1.1.0", maxfilesetver:"7.1.1.0") < 0) flag++;
