...
if(description)
{
 script_id(44001);
 script_version("1.5");
 name["english"] = "AIX 610004 : U830376";
...
"The remote host is missing AIX PTF U830376 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830376"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830376", package:"bos.alt_disk_install.rte.6.1.4.2") < 0 ) 
