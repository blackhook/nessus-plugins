...
if(description)
{
 script_id(44466);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829886";
...
"The remote host is missing AIX PTF U829886 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829886"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829886", package:"perfagent.tools.5.3.11.1") < 0 ) 
