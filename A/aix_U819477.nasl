...
if(description)
{
 script_id(34579);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819477";
...
"The remote host is missing AIX PTF U819477 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819477"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819477", package:"devices.iscsi_sw.rte.5.3.0.63") < 0 ) 
