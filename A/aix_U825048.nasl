...
if(description)
{
 script_id(39643);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825048";
...
"The remote host is missing AIX PTF U825048 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825048"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825048", package:"bos.acct.5.3.7.8") < 0 ) 
