...
if(description)
{
 script_id(39137);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824055";
...
"The remote host is missing AIX PTF U824055 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824055"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824055", package:"bos.net.nfs.cachefs.6.1.2.1") < 0 ) 
