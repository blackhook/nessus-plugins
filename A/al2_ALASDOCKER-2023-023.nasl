...
var pkgs = [
    {'reference':'containerd-1.6.19-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'containerd-1.6.19-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'containerd-debuginfo-1.6.19-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'containerd-debuginfo-1.6.19-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'containerd-stress-1.6.19-1.amzn2.0.1', 'cpu':'aarch64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'},
    {'reference':'containerd-stress-1.6.19-1.amzn2.0.1', 'cpu':'x86_64', 'release':'AL2', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'docker-.0.0.0'}
];
