...
if(description)
{
 script_id(41828);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828507";
...
"The remote host is missing AIX PTF U828507 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828507"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828507", package:"devices.iscsi_sw.rte.6.1.1.4") < 0 ) 
