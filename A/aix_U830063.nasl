...
if(description)
{
 script_id(45178);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830063";
...
"The remote host is missing AIX PTF U830063 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830063"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830063", package:"bos.rte.filesystem.5.3.10.2") < 0 ) 
