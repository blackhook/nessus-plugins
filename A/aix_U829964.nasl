...
if(description)
{
 script_id(44543);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829964";
...
"The remote host is missing AIX PTF U829964 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829964"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829964", package:"devices.scsi.disk.rte.5.3.11.1") < 0 ) 
