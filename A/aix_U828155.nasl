...
if(description)
{
 script_id(43977);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828155";
...
"The remote host is missing AIX PTF U828155 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828155"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828155", package:"devices.pciex.8680c71014108003.rte.6.1.4.1") < 0 ) 
