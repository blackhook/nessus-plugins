...
if(description)
{
 script_id(39062);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823914";
...
"The remote host is missing AIX PTF U823914 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823914"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823914", package:"bos.rte.install.6.1.1.6") < 0 ) 
