...
# from AIX Security PTF U816533. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : bos.rte.control (U816533)");
  script_summary(english:"Check for PTF U816533");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U816533, which is related to the
...
/usr/bin/ps."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ11243"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530007", patch:"U816533", package:"bos.rte.control.5.3.7.4") < 0 ) flag++;
