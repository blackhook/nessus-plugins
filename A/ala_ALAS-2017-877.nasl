...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-877.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-877");

  script_name(english:"Amazon Linux AMI : glibc (ALAS-2017-877)");
...
function. An excessively long string passed to the function could
...
cause applications, which process long strings with the nan function,
to crash or, potentially, execute arbitrary code. (CVE-2014-9761)
...
(CVE-2015-8776)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-877.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"glibc-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-common-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-debuginfo-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-debuginfo-common-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-devel-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-headers-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-static-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"glibc-utils-2.17-196.172.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nscd-2.17-196.172.amzn1")) flag++;
