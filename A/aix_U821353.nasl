...
if(description)
{
 script_id(35141);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821353";
...
"The remote host is missing AIX PTF U821353 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821353"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821353", package:"bos.mp.5.3.7.9") < 0 ) 
