...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : bellmail (IV92250) (deprecated)");
  script_summary(english:"Check for APAR IV92250");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV92250m71", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.48") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV92250m71", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.48") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV92250m71", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.48") < 0) flag++;
