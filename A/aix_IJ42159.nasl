...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ42159)");
  script_summary(english:"Check for APAR IJ42159");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ42159s3a", package:"bos.net.nfs.client", minfilesetver:"7.2.5.102", maxfilesetver:"7.2.5.102") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ42159s3b", package:"bos.net.nfs.client", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ42159s3b", package:"bos.net.nfs.client", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ42159s4a", package:"bos.net.nfs.client", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ42159s4a", package:"bos.net.nfs.client", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
