...
if(description)
{
 script_id(43522);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828768";
...
"The remote host is missing AIX PTF U828768 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828768"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828768", package:"devices.ide.cdrom.rte.6.1.3.1") < 0 ) 
