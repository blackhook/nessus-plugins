...
if(description)
{
 script_id(41818);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828497";
...
"The remote host is missing AIX PTF U828497 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828497"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828497", package:"devices.common.IBM.ib.rte.6.1.1.6") < 0 ) 
