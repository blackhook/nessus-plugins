...
if(description)
{
 script_id(44240);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829271";
...
"The remote host is missing AIX PTF U829271 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829271"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829271", package:"bos.alt_disk_install.rte.5.3.10.1") < 0 ) 
