...
# from AIX Security PTF U825246. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : bos.net.tcp.server (U825246)");
  script_summary(english:"Check for PTF U825246");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825246, which is related to the
...
/usr/sbin/named9."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ56313"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530009", patch:"U825246", package:"bos.net.tcp.server.5.3.9.2") < 0 ) flag++;
