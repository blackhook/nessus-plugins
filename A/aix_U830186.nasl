...
if(description)
{
 script_id(45287);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830186";
...
"The remote host is missing AIX PTF U830186 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830186"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830186", package:"devices.common.IBM.ib.rte.5.3.9.6") < 0 ) 
