...
if(description)
{
 script_id(39112);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823964";
...
"The remote host is missing AIX PTF U823964 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823964"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823964", package:"devices.pciex.b3154a63.rte.6.1.1.5") < 0 ) 
