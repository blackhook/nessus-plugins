...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : cmsd (IZ62570)");
  script_summary(english:"Check for APAR IZ62570");
...
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ62570_01", package:"X11.Dt.rte", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.1") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ62570_01", package:"X11.Dt.lib", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.0") < 0) flag++;
