...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : infiniband (IV43561)");
  script_summary(english:"Check for APAR IV43561");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"02", patch:"iv43561m2a", package:"devices.common.IBM.ib.rte", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.15") < 0) flag++;
