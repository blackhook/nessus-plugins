...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : aixbase (IJ02726)");
  script_summary(english:"Check for APAR IJ02726");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"08", patch:"IJ02726s8a", package:"bos.cluster.rte", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.300") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"09", patch:"IJ02726s9a", package:"bos.cluster.rte", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.300") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"10", patch:"IJ02726sAa", package:"bos.cluster.rte", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.300") < 0) flag++;
