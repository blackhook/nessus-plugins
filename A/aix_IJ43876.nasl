...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ43876)");
  script_summary(english:"Check for APAR IJ43876");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43876s3a", package:"bos.perf.perfstat", minfilesetver:"7.2.5.101", maxfilesetver:"7.2.5.101") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43876s3b", package:"bos.perf.perfstat", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ43876s3b", package:"bos.perf.perfstat", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.100") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ43876s4a", package:"bos.perf.perfstat", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ43876s4a", package:"bos.perf.perfstat", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"IJ43876s5a", package:"bos.perf.perfstat", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"05", patch:"IJ43876s5a", package:"bos.perf.perfstat", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
