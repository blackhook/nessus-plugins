...
if(description)
{
 script_id(34554);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819450";
...
"The remote host is missing AIX PTF U819450 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819450"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819450", package:"bos.cifs_fs.rte.5.3.0.63") < 0 ) 
