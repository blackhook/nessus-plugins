...
if(description)
{
 script_id(44528);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829948";
...
"The remote host is missing AIX PTF U829948 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829948"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829948", package:"bos.net.nfs.adt.5.3.11.1") < 0 ) 
