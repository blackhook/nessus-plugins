...
if(description)
{
 script_id(39167);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824086";
...
"The remote host is missing AIX PTF U824086 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824086"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824086", package:"bos.acct.6.1.2.3") < 0 ) 
