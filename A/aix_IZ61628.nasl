...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : cmsd (IZ61628)");
  script_summary(english:"Check for APAR IZ61628");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ61628_07", package:"X11.Dt.rte", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.3") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ61628_07", package:"X11.Dt.lib", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
