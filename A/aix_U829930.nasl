...
if(description)
{
 script_id(44510);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829930";
...
"The remote host is missing AIX PTF U829930 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829930"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829930", package:"bos.sysmgt.nim.client.5.3.11.2") < 0 ) 
