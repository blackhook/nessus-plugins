...
if(description)
{
 script_id(35832);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818422";
...
"The remote host is missing AIX PTF U818422 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818422"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818422", package:"bos.rte.filesystem.6.1.0.7") < 0 ) 
