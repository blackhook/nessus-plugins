...
if(description)
{
 script_id(44568);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830441";
...
"The remote host is missing AIX PTF U830441 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830441"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830441", package:"bos.cifs_fs.rte.6.1.4.2") < 0 ) 
