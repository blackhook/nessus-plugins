...
if(description)
{
 script_id(39735);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825231";
...
"The remote host is missing AIX PTF U825231 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825231"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825231", package:"devices.common.IBM.sissas.rte.5.3.9.3") < 0 ) 
