...
if(description)
{
 script_id(38249);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820034";
...
"The remote host is missing AIX PTF U820034 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820034"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820034", package:"bos.perf.proctools.5.3.9.1") < 0 ) 
