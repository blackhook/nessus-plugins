...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : lpd (IJ39875)");
  script_summary(english:"Check for APAR IJ39875");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"03", patch:"IJ39875s5a", package:"bos.rte.printers", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"04", patch:"IJ39875s5a", package:"bos.rte.printers", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"05", patch:"IJ39875s5a", package:"bos.rte.printers", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"06", patch:"IJ39875s5a", package:"bos.rte.printers", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.1") < 0) flag++;
