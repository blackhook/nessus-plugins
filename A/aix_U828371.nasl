...
if(description)
{
 script_id(41806);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828371";
...
"The remote host is missing AIX PTF U828371 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828371"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828371", package:"bos.net.nfs.adt.6.1.2.2") < 0 ) 
