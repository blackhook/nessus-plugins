...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2023-A-0145");

  script_name(english:"Adobe Illustrator 27.x < 27.3.1 Multiple Vulnerabilities (APSB23-19)");
...
var constraints = [
  { 'min_version' : '27.0.0', 'max_version' : '27.2.0', 'fixed_version' : '27.3.1' }
];
