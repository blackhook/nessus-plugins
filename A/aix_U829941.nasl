...
if(description)
{
 script_id(44521);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829941";
...
"The remote host is missing AIX PTF U829941 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829941"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829941", package:"devices.pci.1410bd02.diag.5.3.11.1") < 0 ) 
