...
# from AIX Security PTF U825102. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : devices.common.IBM.atm.rte (U825102)");
  script_summary(english:"Check for PTF U825102");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825102, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48500"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530008", patch:"U825102", package:"devices.common.IBM.atm.rte.5.3.8.1") < 0 ) flag++;
