...
if(description)
{
 script_id(43491);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828733";
...
"The remote host is missing AIX PTF U828733 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828733"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828733", package:"bos.rte.serv_aid.6.1.3.2") < 0 ) 
