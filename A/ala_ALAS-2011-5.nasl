...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-5.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-5");

  script_name(english:"Amazon Linux AMI : perl-FCGI (ALAS-2011-5)");
...
authentication via crafted HTTP headers."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Run 'yum update perl-FCGI' to update your system."
  );
