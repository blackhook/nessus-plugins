...
# from AIX Security PTF U857842. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 : bos.net.tcp.server (U857842)");
  script_summary(english:"Check for PTF U857842");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U857842, which is related to the
...
record will cause named to lock up."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV30366"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710000", patch:"U857842", package:"bos.net.tcp.server.7.1.0.20") < 0 ) flag++;
