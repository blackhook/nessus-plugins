...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : pcnfsd (IZ73757)");
  script_summary(english:"Check for APAR IZ73757");
...
if (aix_check_ifix(release:"5.3", ml:"10", patch:"IZ73757_10", package:"bos.net.nfs.client", minfilesetver:"5.3.10.0", maxfilesetver:"5.3.10.3") < 0) flag++;
