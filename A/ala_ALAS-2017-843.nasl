...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-843.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-843");
  script_xref(name:"RHSA", value:"2017:1382");

  script_name(english:"Amazon Linux AMI : sudo (ALAS-2017-843)");
...
commands via sudo could use this flaw to escalate their privileges to
root.
...
(CVE-2017-1000367)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-843.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"sudo-1.8.6p3-28.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sudo-debuginfo-1.8.6p3-28.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sudo-devel-1.8.6p3-28.25.amzn1")) flag++;
