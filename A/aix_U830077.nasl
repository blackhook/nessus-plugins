...
if(description)
{
 script_id(45192);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830077";
...
"The remote host is missing AIX PTF U830077 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830077"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830077", package:"devices.scsi.disk.rte.5.3.10.2") < 0 ) 
