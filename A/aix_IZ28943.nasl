...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : swcons (IZ28943)");
  script_summary(english:"Check for APAR IZ28943");
...
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ28943_01", package:"bos.rte.console", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.0") < 0) flag++;
