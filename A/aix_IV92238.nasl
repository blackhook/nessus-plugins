...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : bellmail (IV92238) (deprecated)");
  script_summary(english:"Check for APAR IV92238");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"06", patch:"IV92238m8a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.200") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"07", patch:"IV92238m8a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.200") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"08", patch:"IV92238m8a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.200") < 0) flag++;
