...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : nimsh (IJ36593)");
  script_summary(english:"Check for APAR IJ36593");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ36593m1a", package:"bos.sysmgt.nim.client", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.0") < 0) flag++;
