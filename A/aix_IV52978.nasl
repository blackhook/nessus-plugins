...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : xorg (IV52978)");
  script_summary(english:"Check for APAR IV52978");
...
if (aix_check_ifix(release:"6.1", ml:"09", patch:"IV52978s0a", package:"X11.base.rte", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.2") < 0) flag++;
