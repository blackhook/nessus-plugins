...
if(description)
{
 script_id(38377);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822053";
...
"The remote host is missing AIX PTF U822053 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822053"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822053", package:"bos.rte.install.5.3.8.6") < 0 ) 
