...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : wparcre (IV51421)");
  script_summary(english:"Check for APAR IV51421");
...
ftp is allowed to access all files within the WPAR."
  ...
  script_set_attribute(attribute:"see_also", value:"https://aix.software.ibm.com/aix/efixes/security/wparcre_advisory.asc");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"03", patch:"IV51421s52", package:"vwpar.52.rte", minfilesetver:"1.1.2.0", maxfilesetver:"1.1.2.17") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"02", sp:"03", patch:"IV51421s53", package:"vwpar.53.rte", minfilesetver:"1.1.2.0", maxfilesetver:"1.1.2.15") < 0) flag++;
