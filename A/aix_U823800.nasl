...
if(description)
{
 script_id(35871);
 script_version("1.6");
 name["english"] = "AIX 610000 : U823800";
...
"The remote host is missing AIX PTF U823800 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823800"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823800", package:"devices.common.IBM.sissas.rte.6.1.0.6") < 0 ) 
