...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-613.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-613");

  script_name(english:"Amazon Linux AMI : git (ALAS-2015-613)");
...
arbitrary code on the user's system."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2015-613.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"emacs-git-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"emacs-git-el-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-all-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-bzr-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-cvs-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-daemon-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-debuginfo-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-email-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-hg-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-p4-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-svn-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"gitweb-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"perl-Git-2.4.3-7.42.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"perl-Git-SVN-2.4.3-7.42.amzn1")) flag++;
