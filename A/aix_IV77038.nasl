...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : netstat (IV77038)");
  script_summary(english:"Check for APAR IV77038");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"07", patch:"IV77038s7b", package:"bos.net.tcp.client", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.20") < 0) flag++;
