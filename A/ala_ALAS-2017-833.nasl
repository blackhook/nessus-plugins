...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-833.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-833");
  script_xref(name:"RHSA", value:"2017:1202");

  script_name(english:"Amazon Linux AMI : bind (ALAS-2017-833)");
...
(CVE-2017-3139)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-833.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"bind-9.8.2-0.62.rc1.55.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-chroot-9.8.2-0.62.rc1.55.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-debuginfo-9.8.2-0.62.rc1.55.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-devel-9.8.2-0.62.rc1.55.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-libs-9.8.2-0.62.rc1.55.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-sdb-9.8.2-0.62.rc1.55.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-utils-9.8.2-0.62.rc1.55.amzn1")) flag++;
