...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : bind9 (IV68997)");
  script_summary(english:"Check for APAR IV68997");
...
http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2014-8500"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/bind9_advisory7.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV68997m9a", package:"bos.net.tcp.server", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.6") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV68997m9a", package:"bos.net.tcp.client", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.10") < 0) flag++;
