...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : kernel (IJ43099)");
  script_summary(english:"Check for APAR IJ43099");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ43099m8a", package:"bos.cluster.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.39") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43099m9a", package:"bos.cluster.rte", minfilesetver:"7.1.5.38", maxfilesetver:"7.1.5.39") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43099m9b", package:"bos.cluster.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.37") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"10", patch:"IJ43099sAa", package:"bos.cluster.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.39") < 0) flag++;
