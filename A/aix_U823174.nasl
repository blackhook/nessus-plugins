...
if(description)
{
 script_id(44148);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823174";
...
"The remote host is missing AIX PTF U823174 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823174"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823174", package:"bos.perf.tools.5.3.10.1") < 0 ) 
