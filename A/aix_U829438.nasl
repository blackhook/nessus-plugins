...
if(description)
{
 script_id(45162);
 script_version("1.4");
 name["english"] = "AIX 530009 : U829438";
...
"The remote host is missing AIX PTF U829438 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829438"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829438", package:"bos.perf.tools.5.3.9.6") < 0 ) 
