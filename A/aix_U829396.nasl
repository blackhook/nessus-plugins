...
if(description)
{
 script_id(42616);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829396";
...
"The remote host is missing AIX PTF U829396 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829396"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829396", package:"devices.pci.1410bd02.diag.5.3.9.3") < 0 ) 
