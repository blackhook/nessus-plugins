...
# AlmaLinux Security Advisory ALSA-2022:8207.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8207");

  script_name(english:"AlmaLinux 9 : openjpeg2 (ALSA-2022:8207)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8207.html");
