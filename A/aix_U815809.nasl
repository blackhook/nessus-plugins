...
if(description)
{
 script_id(32294);
 script_version("1.6");
 name["english"] = "AIX 520010 : U815809";
...
script_set_attribute(attribute:"plugin_modification_date", value:"2021/01/05");
 ...
 summary["english"] = "Check for PTF U815809"; 
...
if ( aix_check_patch(ml:"520010", patch:"U815809", package:"devices.ide.cdrom.rte.5.2.0.108") < 0 ) 
