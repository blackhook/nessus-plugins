...
if(description)
{
 script_id(39047);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823869";
...
"The remote host is missing AIX PTF U823869 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823869"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823869", package:"bos.perf.tools.6.1.0.9") < 0 ) 
