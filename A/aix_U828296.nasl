...
if(description)
{
 script_id(41733);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828296";
...
"The remote host is missing AIX PTF U828296 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828296"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828296", package:"devices.pci.1410bd02.diag.6.1.2.3") < 0 ) 
