...
if (description)
{
  script_id(146570);
  script_version("1.2");
  script_set_attribute(attribute:"plugin_modification_date", value:"2021/02/18");
...
pkgs = [
    {'reference':'ImageMagick-6.9.10.68-3.23.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'ImageMagick-6.9.10.68-3.23.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'ImageMagick-c++-6.9.10.68-3.23.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'ImageMagick-c++-6.9.10.68-3.23.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'ImageMagick-c++-devel-6.9.10.68-3.23.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'ImageMagick-c++-devel-6.9.10.68-3.23.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'ImageMagick-debuginfo-6.9.10.68-3.23.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'ImageMagick-debuginfo-6.9.10.68-3.23.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'ImageMagick-devel-6.9.10.68-3.23.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'ImageMagick-devel-6.9.10.68-3.23.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'ImageMagick-doc-6.9.10.68-3.23.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'ImageMagick-doc-6.9.10.68-3.23.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'ImageMagick-perl-6.9.10.68-3.23.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'ImageMagick-perl-6.9.10.68-3.23.amzn1', 'cpu':'x86_64', 'release':'ALA'}
];
