...
if(description)
{
 script_id(42620);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829400";
...
"The remote host is missing AIX PTF U829400 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829400"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829400", package:"bos.sysmgt.nim.client.5.3.9.2") < 0 ) 
