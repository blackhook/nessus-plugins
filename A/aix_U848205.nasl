...
# from AIX Security PTF U848205. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 : bos.net.tcp.client (U848205)");
  script_summary(english:"Check for PTF U848205");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U848205, which is related to the
...
an attacker could exploit this vulnerability to cause a kernel panic."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV14210"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710000", patch:"U848205", package:"bos.net.tcp.client.7.1.0.19") < 0 ) flag++;
