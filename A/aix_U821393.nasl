...
if(description)
{
 script_id(38283);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821393";
...
"The remote host is missing AIX PTF U821393 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821393"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821393", package:"bos.64bit.5.3.7.6") < 0 ) 
