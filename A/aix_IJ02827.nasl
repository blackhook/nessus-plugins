...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : aixbase (IJ02827)");
  script_summary(english:"Check for APAR IJ02827");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"03", patch:"IJ02827s3a", package:"bos.cluster.rte", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"04", patch:"IJ02827s4a", package:"bos.cluster.rte", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"05", patch:"IJ02827s5a", package:"bos.cluster.rte", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.5") < 0) flag++;
