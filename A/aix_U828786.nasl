...
if(description)
{
 script_id(43539);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828786";
...
"The remote host is missing AIX PTF U828786 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828786"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828786", package:"bos.rte.install.6.1.3.3") < 0 ) 
