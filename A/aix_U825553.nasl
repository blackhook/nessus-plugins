...
if(description)
{
 script_id(39183);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825553";
...
"The remote host is missing AIX PTF U825553 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825553"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825553", package:"devices.fcp.tape.rte.6.1.2.3") < 0 ) 
