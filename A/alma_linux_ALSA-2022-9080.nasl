...
# AlmaLinux Security Advisory ALSA-2022:9080.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:9080");
  ...
  script_name(english:"AlmaLinux 9 : thunderbird (ALSA-2022:9080)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-9080.html");
...
var pkgs = [
    {'reference':'thunderbird-102.6.0-2.el9_1.alma.plus', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.6.0-2.el9_1.alma.plus', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
