...
the privileges under which Asterisk runs.");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/472804/30/0/threaded");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/ASA-2007-010.html");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2007/Apr/652");
...
foreach kb_name (keys(asterisk_kbs))
{
  ...
  'CSeq: 1 INVITE\r\n' +
  "Via: SIP/2.0/" + toupper(via_protocol) + " " + compat::this_host() + ":" + port + ';branch=z9hG4bKfe06f452-2dd6-db11-6d02-000b7d0dc672;rport\r\n' +
  'User-Agent: NGS/2.0\r\n' +
  ...
  "Contact: <sip:nessus@" + compat::this_host() + ":" + port + ';transport=udp>\r\n' +
  ...
  '\r\n' +
  'v=0\r\n' +
  "o=rtp 1160124458839569000 160124458839569000 IN IP4 " + compat::this_host() + '\r\n' +
  's=-\r\n' +
