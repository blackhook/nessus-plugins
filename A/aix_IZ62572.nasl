...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 3 : cmsd (IZ62572)");
  script_summary(english:"Check for APAR IZ62572");
...
if (aix_check_ifix(release:"6.1", ml:"03", patch:"IZ62572_03", package:"X11.Dt.rte", minfilesetver:"6.1.3.0", maxfilesetver:"6.1.3.1") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"03", patch:"IZ62572_03", package:"X11.Dt.lib", minfilesetver:"6.1.3.0", maxfilesetver:"6.1.3.1") < 0) flag++;
