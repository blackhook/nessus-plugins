...
if(description)
{
 script_id(32835);
 script_version("1.6");
 name["english"] = "AIX 530007 : U816512";
...
"The remote host is missing AIX PTF U816512 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U816512"; 
...
if ( aix_check_patch(ml:"530007", patch:"U816512", package:"devices.common.IBM.atm.rte.5.3.7.2") < 0 ) 
