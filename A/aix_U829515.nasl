...
if(description)
{
 script_id(42688);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829515";
...
"The remote host is missing AIX PTF U829515 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829515"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829515", package:"devices.pci.1410bd02.diag.5.3.8.6") < 0 ) 
