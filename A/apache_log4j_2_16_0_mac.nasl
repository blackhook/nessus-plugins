...
# @DEPRECATED@
#
# Disabled on 2020/12/30. Deprecated by apache_log4j_2_16_0.nasl.
##
...
if (description)
{
  ...
  script_name(english:"Apache Log4j 2.x < 2.16.0 RCE (MacOS) (deprecated)");

  script_set_attribute(attribute:"synopsis", value:
"This plugin has been deprecated.");
  script_set_attribute(attribute:"description", value:
"This plugin has been deprecated as a duplicated of apache_log4j_2_16_0.nasl (156057).");
...
exit(0, 'This plugin has been deprecated as a duplicated of apache_log4j_2_16_0.nasl (156057). Use 156057 instead');