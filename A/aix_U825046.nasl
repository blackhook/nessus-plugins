...
if(description)
{
 script_id(39641);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825046";
...
"The remote host is missing AIX PTF U825046 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825046"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825046", package:"bos.perf.tools.5.3.7.8") < 0 ) 
