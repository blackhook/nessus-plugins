...
#@DEPRECATED@
#
# Disabled on 2014/03/10.  Deprecated by aix_U849815.nasl
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 5 : icmp (IV13751)");
  script_summary(english:"Check for APAR IV13751");
...
exit(0, 'This plugin has been deprecated.  Use plugin #72847 (aix_U849815.nasl) instead.');
...
if (aix_check_ifix(release:"6.1", ml:"05", sp:"07", patch:"IV13751m01", package:"bos.net.tcp.client", minfilesetver:"6.1.5.0", maxfilesetver:"6.1.5.7") < 0) flag++;
