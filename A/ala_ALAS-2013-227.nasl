...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-227.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-227");

  script_name(english:"Amazon Linux AMI : nagios (ALAS-2013-227)");
  ...
  script_set_attribute(
    ...
    value:
"nagios.upgrade_to_v3.sh allows local users to overwrite arbitrary
files via a symlink attack on a temporary nagioscfg file with a
predictable name in /tmp/."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-227.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nagios-3.5.1-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nagios-common-3.5.1-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nagios-debuginfo-3.5.1-1.6.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nagios-devel-3.5.1-1.6.amzn1")) flag++;
