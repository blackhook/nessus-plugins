...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"HTTP request smuggling in Node.js 10, 12, and 13 causes malicious
payload delivery when transfer-encoding is malformed (CVE-2019-15605)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1417.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"http-parser-2.7.1-8.amzn2.2")) flag++;
if (rpm_check(release:"AL2", reference:"http-parser-debuginfo-2.7.1-8.amzn2.2")) flag++;
if (rpm_check(release:"AL2", reference:"http-parser-devel-2.7.1-8.amzn2.2")) flag++;
