...
if(description)
{
 script_id(38379);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822055";
...
"The remote host is missing AIX PTF U822055 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822055"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822055", package:"bos.rte.filesystem.5.3.8.5") < 0 ) 
