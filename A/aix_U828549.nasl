...
if(description)
{
 script_id(41869);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828549";
...
"The remote host is missing AIX PTF U828549 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828549"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828549", package:"devices.pciex.b3154a63.rte.6.1.1.6") < 0 ) 
