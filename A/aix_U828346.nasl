...
if(description)
{
 script_id(41782);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828346";
...
"The remote host is missing AIX PTF U828346 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828346"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828346", package:"bos.alt_disk_install.rte.6.1.2.3") < 0 ) 
