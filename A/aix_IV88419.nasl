...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : lquerylv (IV88419)");
  script_summary(english:"Check for APAR IV88419");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV88419s7a", package:"bos.rte.lvm", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV88419s7a", package:"bos.rte.lvm", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV88419s7a", package:"bos.rte.lvm", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
