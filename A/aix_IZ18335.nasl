...
if (description)
{
  ...
  script_name(english:"AIX 5.2 TL 0 : swcons (IZ18335)");
  script_summary(english:"Check for APAR IZ18335");
...
/usr/sbin/swcons."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/swcons_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"5.2", ml:"00", patch:"IZ18335_10", package:"bos.rte.console", minfilesetver:"5.2.0.0", maxfilesetver:"5.2.0.107") < 0) flag++;
