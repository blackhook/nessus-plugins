...
if(description)
{
 script_id(41860);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828540";
...
"The remote host is missing AIX PTF U828540 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828540"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828540", package:"devices.chrp.base.rte.6.1.1.5") < 0 ) 
