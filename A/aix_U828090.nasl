...
if(description)
{
 script_id(43917);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828090";
...
"The remote host is missing AIX PTF U828090 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828090"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828090", package:"bos.sysmgt.nim.client.6.1.4.2") < 0 ) 
