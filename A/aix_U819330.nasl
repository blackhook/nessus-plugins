...
if(description)
{
 script_id(34532);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819330";
...
"The remote host is missing AIX PTF U819330 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819330"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819330", package:"devices.ide.cdrom.rte.5.3.7.4") < 0 ) 
