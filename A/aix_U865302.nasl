...
# from AIX Security PTF U865302. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : bos.rte.odm (U865302)");
  script_summary(english:"Check for PTF U865302");
...
to libodm.a bug."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV60314"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710002", patch:"U865302", package:"bos.rte.odm.7.1.2.16") < 0 ) flag++;
