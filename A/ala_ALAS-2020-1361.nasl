...
common/unistr.cpp. (CVE-2020-10531)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1361.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"icu-50.2-4.0.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"icu-debuginfo-50.2-4.0.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libicu-50.2-4.0.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libicu-devel-50.2-4.0.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libicu-doc-50.2-4.0.amzn1")) flag++;
