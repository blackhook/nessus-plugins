...
if(description)
{
 script_id(44157);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823183";
...
"The remote host is missing AIX PTF U823183 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823183"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823183", package:"devices.common.IBM.ib.rte.5.3.10.2") < 0 ) 
