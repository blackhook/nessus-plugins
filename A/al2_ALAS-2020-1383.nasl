...
specific network configuration. (CVE-2019-16276)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1383.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"golang-1.13.4-1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"golang-bin-1.13.4-1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-docs-1.13.4-1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-misc-1.13.4-1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"golang-race-1.13.4-1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-src-1.13.4-1.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"golang-tests-1.13.4-1.amzn2.0.1")) flag++;
