...
if(description)
{
 script_id(45249);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830134";
...
"The remote host is missing AIX PTF U830134 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830134"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830134", package:"devices.sata.rte.5.3.10.1") < 0 ) 
