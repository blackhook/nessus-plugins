...
if(description)
{
 script_id(41715);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825809";
...
"The remote host is missing AIX PTF U825809 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825809"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825809", package:"bos.rte.filesystem.6.1.0.9") < 0 ) 
