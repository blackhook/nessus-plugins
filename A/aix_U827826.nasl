...
if(description)
{
 script_id(43901);
 script_version("1.5");
 name["english"] = "AIX 610004 : U827826";
...
"The remote host is missing AIX PTF U827826 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U827826"; 
...
if ( aix_check_patch(ml:"610004", patch:"U827826", package:"devices.common.IBM.fc.rte.6.1.4.1") < 0 ) 
