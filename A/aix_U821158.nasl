...
if(description)
{
 script_id(34645);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821158";
...
"The remote host is missing AIX PTF U821158 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821158"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821158", package:"bos.rte.aio.5.3.0.64") < 0 ) 
