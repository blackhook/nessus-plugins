...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : ftp (IV30669)");
  script_summary(english:"Check for APAR IV30669");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"01", patch:"IV30669s1a", package:"bos.mp64", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.1") < 0) flag++;
