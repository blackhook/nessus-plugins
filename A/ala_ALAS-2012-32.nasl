...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-32.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-32");

  script_name(english:"Amazon Linux AMI : cacti (ALAS-2012-32)");
  ...
  script_set_attribute(
    ...
    value:
"The release notes for Cacti 0.8.7i indicate that two security
...
issued."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-32.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"cacti-0.8.7i-2.3.amzn1")) flag++;
