...
if(description)
{
 script_id(38402);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822078";
...
"The remote host is missing AIX PTF U822078 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822078"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822078", package:"bos.mp.5.3.8.6") < 0 ) 
