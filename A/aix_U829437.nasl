...
if(description)
{
 script_id(45161);
 script_version("1.4");
 name["english"] = "AIX 530009 : U829437";
...
"The remote host is missing AIX PTF U829437 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829437"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829437", package:"bos.sysmgt.nim.client.5.3.9.3") < 0 ) 
