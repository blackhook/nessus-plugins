...
if(description)
{
 script_id(29104);
 script_version("1.6");
 name["english"] = "AIX 530006 : U813572";
...
"The remote host is missing AIX PTF U813572 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U813572"; 
...
if ( aix_check_patch(ml:"530006", patch:"U813572", package:"bos.pmapi.pmsvcs.5.3.0.63") < 0 ) 
