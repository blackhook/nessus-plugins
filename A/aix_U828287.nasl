...
if(description)
{
 script_id(41724);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828287";
...
"The remote host is missing AIX PTF U828287 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828287"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828287", package:"devices.chrp.base.rte.6.1.2.6") < 0 ) 
