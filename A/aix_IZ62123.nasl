...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : cmsd (IZ62123)");
  script_summary(english:"Check for APAR IZ62123");
...
if (aix_check_ifix(release:"5.3", ml:"10", patch:"IZ62123_10", package:"X11.Dt.rte", minfilesetver:"5.3.10.0", maxfilesetver:"5.3.10.0") < 0) flag++;
