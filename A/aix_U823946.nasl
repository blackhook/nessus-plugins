...
if(description)
{
 script_id(39094);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823946";
...
"The remote host is missing AIX PTF U823946 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823946"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823946", package:"bos.net.nfs.cachefs.6.1.1.2") < 0 ) 
