...
# AlmaLinux Security Advisory ALSA-2022:7111.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7111");
  script_xref(name:"IAVA", value:"2022-A-0299-S");

  script_name(english:"AlmaLinux 8 : samba (ALSA-2022:7111)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:7111 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-7111.html");
...
var pkgs = [
    ...
    {'reference':'samba-winexe-4.15.5-10.el8_6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
