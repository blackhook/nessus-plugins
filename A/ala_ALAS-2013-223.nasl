...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-223.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-223");

  script_name(english:"Amazon Linux AMI : 389-ds-base (ALAS-2013-223)");
...
389 Directory Server does not properly restrict access to entity
attributes, which allows remote authenticated users to obtain
sensitive information via a search query for the attribute."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-223.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"389-ds-base-1.3.1.8-1.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-debuginfo-1.3.1.8-1.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-devel-1.3.1.8-1.5.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-libs-1.3.1.8-1.5.amzn1")) flag++;
