...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : xorg (IV52186)");
  script_summary(english:"Check for APAR IV52186");
...
if (aix_check_ifix(release:"7.1", ml:"02", patch:"IV52186s0a", package:"X11.base.rte", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.0") < 0) flag++;
