...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : xorg (IV52181)");
  script_summary(english:"Check for APAR IV52181");
...
request that triggers memory-allocation failure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/xorg_advisory2.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"6.1", ml:"07", patch:"IV52181s0a", package:"X11.base.rte", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.16") < 0) flag++;
