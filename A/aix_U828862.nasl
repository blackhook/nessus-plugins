...
if(description)
{
 script_id(43256);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828862";
...
"The remote host is missing AIX PTF U828862 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828862"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828862", package:"perfagent.tools.6.1.2.6") < 0 ) 
