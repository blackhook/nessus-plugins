...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-66.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-66");
  script_xref(name:"RHSA", value:"2012:0467");

  script_name(english:"Amazon Linux AMI : freetype (ALAS-2012-66)");
...
linked against FreeType, it could cause the application to crash."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-66.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"freetype-2.3.11-6.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freetype-debuginfo-2.3.11-6.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freetype-demos-2.3.11-6.12.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freetype-devel-2.3.11-6.12.amzn1")) flag++;
