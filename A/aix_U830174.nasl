...
if(description)
{
 script_id(45275);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830174";
...
"The remote host is missing AIX PTF U830174 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830174"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830174", package:"devices.common.IBM.sissas.rte.5.3.9.5") < 0 ) 
