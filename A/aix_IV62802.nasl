...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : malloc (IV62802)");
  script_summary(english:"Checks for APAR IV62802.");
...
"Install the appropriate interim fix. If interim fix IV61313s9a is
...
if (aix_check_ifix(release:"6.1", ml:"07", sp:"09", patch:"IV62802s9a", package:"bos.rte.libc", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.20") < 0) flag++;
