...
# AlmaLinux Security Advisory ALSA-2023:1592.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:1592");

  script_name(english:"AlmaLinux 9 : tigervnc (ALSA-2023:1592)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-1592.html");
