...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : at (IZ43456)");
  script_summary(english:"Check for APAR IZ43456");
...
if (aix_check_ifix(release:"5.3", ml:"09", patch:"IZ43456_09", package:"bos.rte.cron", minfilesetver:"5.3.9.0", maxfilesetver:"5.3.9.0") < 0) flag++;
