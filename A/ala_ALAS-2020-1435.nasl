...
multiple vulnerabilities as referenced in the ALAS-2020-1435 advisory.
...
pkgs = [
    {'reference':'dovecot-2.2.36-6.21.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'dovecot-2.2.36-6.21.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'dovecot-debuginfo-2.2.36-6.21.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'dovecot-debuginfo-2.2.36-6.21.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'dovecot-devel-2.2.36-6.21.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'dovecot-devel-2.2.36-6.21.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'dovecot-mysql-2.2.36-6.21.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'dovecot-mysql-2.2.36-6.21.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'dovecot-pgsql-2.2.36-6.21.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'dovecot-pgsql-2.2.36-6.21.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'dovecot-pigeonhole-2.2.36-6.21.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'dovecot-pigeonhole-2.2.36-6.21.amzn1', 'cpu':'x86_64', 'release':'ALA'}
];
