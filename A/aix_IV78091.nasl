...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : bind (IV78091)");
  script_summary(english:"Check for APAR IV78091");
...
vulnerability to cause a denial of service."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/bind_advisory9.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"05", patch:"IV78091m5a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.45") < 0) flag++;
