...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 1 : xorg (IJ11547)");
  script_summary(english:"Check for APAR IJ11547");
...
if (aix_check_ifix(release:"7.2", ml:"01", patch:"IJ11547s0a", package:"X11.base.rte", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
