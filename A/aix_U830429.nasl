...
if(description)
{
 script_id(44556);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830429";
...
"The remote host is missing AIX PTF U830429 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830429"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830429", package:"devices.common.IBM.ib.rte.6.1.4.3") < 0 ) 
