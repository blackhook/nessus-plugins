...
read and application crash) via a crafted ELF file. (CVE-2018-10360)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1452.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"AL2", reference:"file-5.11-36.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"file-debuginfo-5.11-36.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"file-devel-5.11-36.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"file-libs-5.11-36.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"file-static-5.11-36.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"python-magic-5.11-36.amzn2.0.1")) flag++;
