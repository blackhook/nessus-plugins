...
if(description)
{
 script_id(39148);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824067";
...
"The remote host is missing AIX PTF U824067 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824067"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824067", package:"bos.rte.libpthreads.6.1.2.2") < 0 ) 
