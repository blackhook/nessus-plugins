...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : kernel (IJ43098)");
  script_summary(english:"Check for APAR IJ43098");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ43098s8a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.41") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43098s9a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.40", maxfilesetver:"7.1.5.41") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43098s9b", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.39") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"10", patch:"IJ43098sAa", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.41") < 0) flag++;
