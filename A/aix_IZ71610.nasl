...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 11 : xntpd (IZ71610)");
  script_summary(english:"Check for APAR IZ71610");
...
excessively.'."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/xntpd_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"5.3", ml:"11", patch:"IZ71610_11", package:"bos.net.tcp.client", minfilesetver:"5.3.11.0", maxfilesetver:"5.3.11.2") < 0) flag++;
