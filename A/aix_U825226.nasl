...
if(description)
{
 script_id(39730);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825226";
...
"The remote host is missing AIX PTF U825226 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825226"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825226", package:"devices.pci.77102224.com.5.3.9.2") < 0 ) 
