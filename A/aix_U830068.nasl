...
if(description)
{
 script_id(45183);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830068";
...
"The remote host is missing AIX PTF U830068 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830068"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830068", package:"bos.perf.tools.5.3.10.2") < 0 ) 
