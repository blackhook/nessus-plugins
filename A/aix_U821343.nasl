...
if(description)
{
 script_id(35131);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821343";
...
"The remote host is missing AIX PTF U821343 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821343"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821343", package:"bos.rte.filesystem.5.3.7.6") < 0 ) 
