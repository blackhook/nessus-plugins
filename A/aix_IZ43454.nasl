...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : at (IZ43454)");
  script_summary(english:"Check for APAR IZ43454");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ43454_07", package:"bos.rte.cron", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.1") < 0) flag++;
