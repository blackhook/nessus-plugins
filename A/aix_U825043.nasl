...
if(description)
{
 script_id(39638);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825043";
...
"The remote host is missing AIX PTF U825043 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825043"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825043", package:"bos.rte.serv_aid.5.3.7.4") < 0 ) 
