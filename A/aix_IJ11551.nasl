...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : xorg (IJ11551)");
  script_summary(english:"Check for APAR IJ11551");
...
if (aix_check_ifix(release:"5.3", ml:"12", patch:"IJ11551s0a", package:"X11.base.rte", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.2") < 0) flag++;
