...
if (description)
{
  ...
  script_name(english:"Default Password (CenturyL1nk) for 'admin' Account");

  script_set_attribute(attribute:"synopsis", value:
"The remote system can be accessed with a default administrator
account.");
  script_set_attribute(attribute:"description", value:
"The account 'admin' on the remote host has the password 'CenturyL1nk'.
An attacker may leverage this issue to gain access, likely as an
administrator, to the affected system.");
  # https://packetstormsecurity.com/files/144903/Actiontec-C1000A-Modem-Backdoor-Account.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba1cf598");
