...
if(description)
{
 script_id(44446);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829866";
...
"The remote host is missing AIX PTF U829866 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829866"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829866", package:"bos.alt_disk_install.rte.5.3.11.1") < 0 ) 
