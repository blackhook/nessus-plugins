...
if(description)
{
 script_id(43985);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828163";
...
"The remote host is missing AIX PTF U828163 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828163"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828163", package:"bos.64bit.6.1.4.1") < 0 ) 
