...
if(description)
{
 script_id(41720);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828283";
...
"The remote host is missing AIX PTF U828283 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828283"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828283", package:"devices.pci.14106902.rte.6.1.2.3") < 0 ) 
