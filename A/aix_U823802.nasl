...
if(description)
{
 script_id(35873);
 script_version("1.6");
 name["english"] = "AIX 610000 : U823802";
...
"The remote host is missing AIX PTF U823802 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823802"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823802", package:"devices.fcp.tape.rte.6.1.0.5") < 0 ) 
