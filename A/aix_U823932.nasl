...
if(description)
{
 script_id(39080);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823932";
...
"The remote host is missing AIX PTF U823932 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823932"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823932", package:"bos.perf.proctools.6.1.1.1") < 0 ) 
