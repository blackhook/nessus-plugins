...
if(description)
{
 script_id(39021);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823843";
...
"The remote host is missing AIX PTF U823843 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823843"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823843", package:"bos.rte.aio.6.1.0.4") < 0 ) 
