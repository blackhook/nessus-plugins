...
if(description)
{
 script_id(43545);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828794";
...
"The remote host is missing AIX PTF U828794 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828794"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828794", package:"bos.rte.aio.6.1.3.3") < 0 ) 
