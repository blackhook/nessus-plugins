...
if(description)
{
 ...
 script_name(english: "AIX 520010 : U817524");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U817524");
...
if ( aix_check_patch(ml:"520010", patch:"U817524", package:"bos.rte.net.5.2.0.86") < 0 ) 
