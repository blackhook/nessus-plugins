...
if(description)
{
 script_id(45173);
 script_version("1.4");
 name["english"] = "AIX 530009 : U829450";
...
"The remote host is missing AIX PTF U829450 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829450"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829450", package:"devices.pci.77102224.com.5.3.9.4") < 0 ) 
