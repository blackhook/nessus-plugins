...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : lvm (IV67908)");
  script_summary(english:"Check for APAR IV67908");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"04", patch:"IV67908s4b", package:"bos.rte.lvm", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.30") < 0) flag++;
