...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : pconsole (IV93624)");
  script_summary(english:"Check for APAR IV93624");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"07", patch:"IV93624s3b", package:"sysmgt.pconsole.rte", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.99") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"08", patch:"IV93624s3b", package:"sysmgt.pconsole.rte", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.99") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"09", patch:"IV93624s3b", package:"sysmgt.pconsole.rte", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.99") < 0) flag++;
