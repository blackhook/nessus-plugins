...
if(description)
{
 script_id(35502);
 script_version("1.6");
 name["english"] = "AIX 520010 : U820476";
...
"The remote host is missing AIX PTF U820476 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820476"; 
...
if ( aix_check_patch(ml:"520010", patch:"U820476", package:"devices.ide.cdrom.rte.5.2.0.109") < 0 ) 
