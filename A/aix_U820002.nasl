...
if(description)
{
 script_id(38217);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820002";
...
"The remote host is missing AIX PTF U820002 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820002"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820002", package:"bos.perf.tools.5.3.9.3") < 0 ) 
