...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : unix (IZ22369)");
  script_summary(english:"Check for APAR IZ22369");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ22369_7a", package:"bos.mp", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.4") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ22369_7b", package:"bos.mp", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.4") < 0) flag++;
