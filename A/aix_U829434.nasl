...
if(description)
{
 script_id(45158);
 script_version("1.4");
 name["english"] = "AIX 530009 : U829434";
...
"The remote host is missing AIX PTF U829434 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829434"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829434", package:"bos.mp.5.3.9.6") < 0 ) 
