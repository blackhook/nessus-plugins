...
if(description)
{
 script_id(39245);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825662";
...
"The remote host is missing AIX PTF U825662 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825662"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825662", package:"X11.base.rte.6.1.1.3") < 0 ) 
