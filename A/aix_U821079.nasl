...
if(description)
{
 script_id(34585);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821079";
...
"The remote host is missing AIX PTF U821079 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821079"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821079", package:"bos.rte.libpthreads.5.3.7.3") < 0 ) 
