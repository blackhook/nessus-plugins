...
if(description)
{
 script_id(33685);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819305";
...
"The remote host is missing AIX PTF U819305 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819305"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819305", package:"bos.net.nfs.adt.5.3.7.2") < 0 ) 
