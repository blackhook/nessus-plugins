...
# from AIX Security PTF U815029. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.2 TL 10 : printers.rte (U815029)");
  script_summary(english:"Check for PTF U815029");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U815029, which is related to the
...
command is vulnerable: /usr/lib/lpd/pio/etc/piomkpq."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ10840"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"520010", patch:"U815029", package:"printers.rte.5.2.0.107") < 0 ) flag++;
