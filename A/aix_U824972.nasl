...
if(description)
{
 script_id(38547);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824972";
...
"The remote host is missing AIX PTF U824972 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824972"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824972", package:"bos.rte.serv_aid.5.3.7.3") < 0 ) 
