...
if(description)
{
 script_id(34522);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819320";
...
"The remote host is missing AIX PTF U819320 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819320"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819320", package:"bos.sysmgt.serv_aid.5.3.7.6") < 0 ) 
