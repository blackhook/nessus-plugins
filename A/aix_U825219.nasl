...
if(description)
{
 script_id(39723);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825219";
...
"The remote host is missing AIX PTF U825219 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825219"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825219", package:"devices.common.IBM.ib.rte.5.3.9.4") < 0 ) 
