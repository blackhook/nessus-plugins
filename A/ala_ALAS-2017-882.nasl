...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-882.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-882");

  script_name(english:"Amazon Linux AMI : git (ALAS-2017-882)");
...
repository or a legitimate repository containing a malicious
commit.(CVE-2017-1000117)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-882.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"emacs-git-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"emacs-git-el-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-all-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-bzr-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-cvs-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-daemon-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-debuginfo-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-email-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-hg-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-p4-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"git-svn-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"gitweb-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"perl-Git-2.13.5-1.53.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"perl-Git-SVN-2.13.5-1.53.amzn1")) flag++;
