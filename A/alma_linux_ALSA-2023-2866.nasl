...
# AlmaLinux Security Advisory ALSA-2023:2866.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2866");
  script_xref(name:"IAVB", value:"2022-B-0042-S");
  script_xref(name:"IAVB", value:"2022-B-0059-S");

  script_name(english:"AlmaLinux 8 : git-lfs (ALSA-2023:2866)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-2866.html");
