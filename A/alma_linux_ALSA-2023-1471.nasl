...
# AlmaLinux Security Advisory ALSA-2023:1471.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:1471");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/04/20");

  script_name(english:"AlmaLinux 9 : kpatch-patch (ALSA-2023:1471)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-1471.html");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for ALSA-2023:1471');
  }
  else
  {
