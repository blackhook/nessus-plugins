...
if(description)
{
 script_id(38496);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824818";
...
"The remote host is missing AIX PTF U824818 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824818"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824818", package:"devices.pci.1410bd02.diag.5.3.9.2") < 0 ) 
