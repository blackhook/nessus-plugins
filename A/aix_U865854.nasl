...
# from AIX Security PTF U865854. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : bos.rte.lvm (U865854)");
  script_summary(english:"Check for PTF U865854");
...
allow a local user to gain root privileges."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV67908"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710003", patch:"U865854", package:"bos.rte.lvm.7.1.3.45") < 0 ) flag++;
