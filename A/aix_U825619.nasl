...
if(description)
{
 script_id(41655);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825619";
...
"The remote host is missing AIX PTF U825619 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825619"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825619", package:"bos.acct.6.1.2.4") < 0 ) 
