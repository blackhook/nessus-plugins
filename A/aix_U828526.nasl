...
if(description)
{
 script_id(41847);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828526";
...
"The remote host is missing AIX PTF U828526 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828526"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828526", package:"bos.sysmgt.serv_aid.6.1.1.4") < 0 ) 
