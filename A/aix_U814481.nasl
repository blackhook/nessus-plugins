...
if(description)
{
 script_id(32813);
 script_version("1.6");
 name["english"] = "AIX 610001 : U814481";
...
"The remote host is missing AIX PTF U814481 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U814481"; 
...
if ( aix_check_patch(ml:"610001", patch:"U814481", package:"bos.net.nfs.cachefs.6.1.1.1") < 0 ) 
