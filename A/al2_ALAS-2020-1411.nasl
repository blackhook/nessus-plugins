...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Integer Overflow or Wraparound leads to Heap-based Buffer Overflow
(CVE-2019-15690)"
  );
...
flag = 0;
if (rpm_check(release:"AL2", reference:"libvncserver-0.9.9-14.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libvncserver-debuginfo-0.9.9-14.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libvncserver-devel-0.9.9-14.amzn2")) flag++;
