...
if(description)
{
 script_id(42619);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829399";
...
"The remote host is missing AIX PTF U829399 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829399"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829399", package:"bos.cifs_fs.rte.5.3.9.2") < 0 ) 
