...
if(description)
{
 script_id(43283);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828946";
...
"The remote host is missing AIX PTF U828946 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828946"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828946", package:"bos.rte.filesystem.6.1.1.7") < 0 ) 
