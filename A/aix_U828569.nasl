...
if(description)
{
 script_id(41889);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828569";
...
"The remote host is missing AIX PTF U828569 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828569"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828569", package:"devices.common.IBM.sissas.rte.6.1.1.4") < 0 ) 
