...
if(description)
{
 script_id(38493);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824815";
...
"The remote host is missing AIX PTF U824815 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824815"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824815", package:"devices.common.IBM.sissas.rte.5.3.9.2") < 0 ) 
