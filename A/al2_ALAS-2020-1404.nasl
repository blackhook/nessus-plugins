...
tgetpass.c.(CVE-2019-18634)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1404.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"sudo-1.8.23-4.amzn2.2")) flag++;
if (rpm_check(release:"AL2", reference:"sudo-debuginfo-1.8.23-4.amzn2.2")) flag++;
if (rpm_check(release:"AL2", reference:"sudo-devel-1.8.23-4.amzn2.2")) flag++;
