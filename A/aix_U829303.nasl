...
if(description)
{
 script_id(44272);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829303";
...
"The remote host is missing AIX PTF U829303 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829303"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829303", package:"devices.common.IBM.sissas.rte.5.3.10.1") < 0 ) 
