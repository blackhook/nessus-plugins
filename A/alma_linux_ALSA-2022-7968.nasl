...
# AlmaLinux Security Advisory ALSA-2022:7968.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7968");

  script_name(english:"AlmaLinux 9 : virt-v2v (ALSA-2022:7968)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7968.html");
...
var pkgs = [
    {'reference':'virt-v2v-2.0.7-6.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
