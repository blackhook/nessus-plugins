...
if(description)
{
 script_id(38483);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824805";
...
"The remote host is missing AIX PTF U824805 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824805"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824805", package:"devices.pciex.8680c71014108003.rte.5.3.9.1") < 0 ) 
