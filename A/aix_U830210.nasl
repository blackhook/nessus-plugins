...
if(description)
{
 script_id(45311);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830210";
...
"The remote host is missing AIX PTF U830210 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830210"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830210", package:"perfagent.tools.5.3.9.5") < 0 ) 
