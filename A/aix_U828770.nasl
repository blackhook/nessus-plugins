...
if(description)
{
 script_id(43524);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828770";
...
"The remote host is missing AIX PTF U828770 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828770"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828770", package:"devices.fcp.tape.rte.6.1.3.1") < 0 ) 
