...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 3 : xntpd (IZ71614)");
  script_summary(english:"Check for APAR IZ71614");
...
if (aix_check_ifix(release:"6.1", ml:"03", patch:"IZ71614_03", package:"bos.net.tcp.client", minfilesetver:"6.1.3.0", maxfilesetver:"6.1.3.3") < 0) flag++;
