...
if(description)
{
 script_id(32242);
 script_version("1.6");
 name["english"] = "AIX 520010 : U815031";
...
"The remote host is missing AIX PTF U815031 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U815031"; 
...
if ( aix_check_patch(ml:"520010", patch:"U815031", package:"devices.pci.14106902.rte.5.2.0.109") < 0 ) 
