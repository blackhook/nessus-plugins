...
the following vulnerabilities :
  ...
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix32j5b&S_TACT=105AGX05&S_CMP=JDK
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aacaab25");
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix64j5b&S_TACT=105AGX05&S_CMP=JDK
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?70623e16");
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix32j6b&S_TACT=105AGX05&S_CMP=JDK
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d08dc51");
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix64j6b&S_TACT=105AGX05&S_CMP=JDK
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ca2561a");
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix32j7b&S_TACT=105AGX05&S_CMP=JDK
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a624fae8");
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix64j7b&S_TACT=105AGX05&S_CMP=JDK
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?aa3fc787");
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix32j7r1&S_TACT=105AGX05&S_CMP=JDK
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e42e2673");
  # https://www14.software.ibm.com/webapp/iwm/web/preLogin.do?source=dka&S_PKG=aix64j7r1&S_TACT=105AGX05&S_CMP=JDK
