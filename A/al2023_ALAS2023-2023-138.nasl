...
if (get_one_kb_item("Host/kpatch/kernel-cves"))
{
  ...
  var cve_list = make_list("CVE-2023-1032", "CVE-2023-1077", "CVE-2023-1118", "CVE-2023-1829", "CVE-2023-1998");
...
var pkgs = [
    ...
    {'reference':'kernel-headers-6.1.19-30.43.amzn2023', 'cpu':'i686', 'release':'AL-2023', 'rpm_spec_vers_cmp':TRUE},
