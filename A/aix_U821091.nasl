...
if(description)
{
 script_id(34597);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821091";
...
"The remote host is missing AIX PTF U821091 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821091"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821091", package:"devices.pci.77102224.com.5.3.7.5") < 0 ) 
