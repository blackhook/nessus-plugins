...
if(description)
{
 script_id(45182);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830067";
...
"The remote host is missing AIX PTF U830067 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830067"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830067", package:"perfagent.tools.5.3.10.2") < 0 ) 
