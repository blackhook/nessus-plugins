...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 0 : pioout (IZ10844)");
  script_summary(english:"Check for APAR IZ10844");
...
if (aix_check_ifix(release:"6.1", ml:"00", patch:"IZ10844_00", package:"printers.rte", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.0.0") < 0) flag++;
