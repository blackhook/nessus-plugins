...
if(description)
{
 script_id(41686);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825780";
...
"The remote host is missing AIX PTF U825780 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825780"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825780", package:"bos.net.nfs.client.6.1.0.10") < 0 ) 
