...
if(description)
{
 script_id(39012);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823834";
...
"The remote host is missing AIX PTF U823834 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823834"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823834", package:"devices.chrp.base.rte.6.1.0.8") < 0 ) 
