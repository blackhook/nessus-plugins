...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-735.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-735");

  script_name(english:"Amazon Linux AMI : squid (ALAS-2016-735)");
...
It was found that the fix for CVE-2016-4051 did not properly prevent
the stack overflow in the munge_other_line() function. A remote
attacker could send specially crafted data to the Squid proxy, which
would exploit the cachemgr CGI utility, possibly triggering execution
of arbitrary code. (CVE-2016-5408)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-735.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"squid-3.1.23-16.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"squid-debuginfo-3.1.23-16.22.amzn1")) flag++;
