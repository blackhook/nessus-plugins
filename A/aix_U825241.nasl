...
if(description)
{
 script_id(39745);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825241";
...
"The remote host is missing AIX PTF U825241 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825241"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825241", package:"bos.rte.install.5.3.9.4") < 0 ) 
