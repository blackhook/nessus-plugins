...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 1 : lpd (IJ44564)");
  script_summary(english:"Check for APAR IJ44564");
...
if (aix_check_ifix(release:"7.3", ml:"01", sp:"01", patch:"IJ44564m1a", package:"printers.rte", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.0") < 0) flag++;
