...
if(description)
{
 script_id(35152);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821364";
...
"The remote host is missing AIX PTF U821364 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821364"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821364", package:"bos.rte.install.5.3.7.8") < 0 ) 
