...
# AlmaLinux Security Advisory ALSA-2023:2193.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2193");

  script_name(english:"AlmaLinux 9 : butane (ALSA-2023:2193)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2193.html");
...
"Update the affected butane package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:butane");
...
var pkgs = [
    {'reference':'butane-0.16.0-1.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'butane-0.16.0-1.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
