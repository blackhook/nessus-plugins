...
if(description)
{
 script_id(44519);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829939";
...
"The remote host is missing AIX PTF U829939 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829939"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829939", package:"bos.net.tcp.server.5.3.11.1") < 0 ) 
