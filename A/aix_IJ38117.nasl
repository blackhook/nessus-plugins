...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : audit (IJ38117)");
  script_summary(english:"Check for APAR IJ38117");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ38117m3a", package:"bos.rte.security", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.2") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ38117m3a", package:"bos.rte.security", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
