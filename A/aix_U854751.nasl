...
# from AIX Security PTF U854751. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : bos.mp64 (U854751)");
  script_summary(english:"Check for PTF U854751");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U854751, which is related to the
...
but can read files like /etc/rc.wpars under ftp."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV28715"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610006", patch:"U854751", package:"bos.mp64.6.1.6.22") < 0 ) flag++;
