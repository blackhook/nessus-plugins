...
if(description)
{
 script_id(45248);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830133";
...
"The remote host is missing AIX PTF U830133 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830133"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830133", package:"devices.pciex.b3154a63.rte.5.3.10.3") < 0 ) 
