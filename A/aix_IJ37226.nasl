...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : bind (IJ37226)");
  script_summary(english:"Check for APAR IJ37226");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"(IJ37226s1b|IJ40614m2b)", package:"bos.net.tcp.bind", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.0") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"(IJ37226s1b|IJ40614m2b)", package:"bos.net.tcp.bind_utils", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.0") < 0) flag++;
