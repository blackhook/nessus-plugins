...
if(description)
{
 script_id(38554);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824979";
...
"The remote host is missing AIX PTF U824979 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824979"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824979", package:"devices.chrp.base.rte.5.3.7.6") < 0 ) 
