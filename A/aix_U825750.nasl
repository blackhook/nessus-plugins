...
if(description)
{
 script_id(39263);
 script_version("1.5");
 name["english"] = "AIX 610000 : U825750";
...
"The remote host is missing AIX PTF U825750 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825750"; 
...
if ( aix_check_patch(ml:"610000", patch:"U825750", package:"bos.alt_disk_install.rte.6.1.0.3") < 0 ) 
