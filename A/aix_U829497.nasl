...
if(description)
{
 script_id(42670);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829497";
...
"The remote host is missing AIX PTF U829497 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829497"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829497", package:"devices.pci.14106902.rte.5.3.8.6") < 0 ) 
