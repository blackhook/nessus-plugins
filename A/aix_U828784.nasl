...
if(description)
{
 script_id(43537);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828784";
...
"The remote host is missing AIX PTF U828784 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828784"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828784", package:"bos.rte.filesystem.6.1.3.2") < 0 ) 
