...
if(description)
{
 script_id(35892);
 script_version("1.6");
 name["english"] = "AIX 610000 : U823822";
...
"The remote host is missing AIX PTF U823822 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823822"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823822", package:"bos.rte.libpthreads.6.1.0.4") < 0 ) 
