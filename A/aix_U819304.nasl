...
if(description)
{
 script_id(33684);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819304";
...
"The remote host is missing AIX PTF U819304 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819304"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819304", package:"bos.alt_disk_install.boot_images.5.3.7.3") < 0 ) 
