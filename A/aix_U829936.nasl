...
if(description)
{
 script_id(44516);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829936";
...
"The remote host is missing AIX PTF U829936 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829936"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829936", package:"bos.perf.proctools.5.3.11.1") < 0 ) 
