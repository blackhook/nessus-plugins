...
if(description)
{
 script_id(43451);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828405";
...
"The remote host is missing AIX PTF U828405 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828405"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828405", package:"bos.rte.bind_cmds.6.1.3.1") < 0 ) 
