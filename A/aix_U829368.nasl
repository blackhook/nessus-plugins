...
if(description)
{
 script_id(42588);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829368";
...
"The remote host is missing AIX PTF U829368 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829368"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829368", package:"bos.rte.install.5.3.9.5") < 0 ) 
