...
# from AIX Security PTF U825576. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : devices.common.IBM.atm.rte (U825576)");
  script_summary(english:"Check for PTF U825576");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825576, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48562"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610002", patch:"U825576", package:"devices.common.IBM.atm.rte.6.1.2.1") < 0 ) flag++;
