...
if(description)
{
 script_id(43919);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828092";
...
"The remote host is missing AIX PTF U828092 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828092"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828092", package:"bos.rte.aio.6.1.4.1") < 0 ) 
