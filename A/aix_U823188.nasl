...
if(description)
{
 script_id(44162);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823188";
...
"The remote host is missing AIX PTF U823188 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823188"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823188", package:"bos.sysmgt.serv_aid.5.3.10.1") < 0 ) 
