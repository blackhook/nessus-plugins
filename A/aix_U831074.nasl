...
if(description)
{
 script_id(43319);
 script_version("1.5");
 name["english"] = "AIX 610002 : U831074";
...
"The remote host is missing AIX PTF U831074 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U831074"; 
...
if ( aix_check_patch(ml:"610002", patch:"U831074", package:"bos.rte.install.6.1.2.6") < 0 ) 
