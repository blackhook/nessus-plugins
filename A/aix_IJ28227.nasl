...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : power9 (IJ28227)");
  script_summary(english:"Check for APAR IJ28227");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"00", patch:"(IJ28227s0a|IJ28827m0a)", package:"bos.mp64", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.6") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"01", patch:"(IJ28227s1a|IJ28827m1a)", package:"bos.mp64", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.6") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"02", patch:"(IJ28227s2a|IJ28827m2a)", package:"bos.mp64", minfilesetver:"7.2.4.5", maxfilesetver:"7.2.4.6") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"02", patch:"(IJ28227s2b|IJ28827m2b)", package:"bos.mp64", minfilesetver:"7.2.4.4", maxfilesetver:"7.2.4.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"02", patch:"(IJ28227s2c|IJ28827m2c)", package:"bos.mp64", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.3") < 0) flag++;
