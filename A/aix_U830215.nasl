...
if(description)
{
 script_id(45316);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830215";
...
"The remote host is missing AIX PTF U830215 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830215"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830215", package:"devices.pci.1410bd02.diag.5.3.9.4") < 0 ) 
