...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-664.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-664");

  script_name(english:"Amazon Linux AMI : 389-ds-base (ALAS-2016-664)");
...
service)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-664.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"389-ds-base-1.3.4.0-26.47.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-debuginfo-1.3.4.0-26.47.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-devel-1.3.4.0-26.47.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-libs-1.3.4.0-26.47.amzn1")) flag++;
