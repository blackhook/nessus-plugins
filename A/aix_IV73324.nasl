...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : nettcp (IV73324) (POODLE)");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"05", patch:"(IV73324s5a|IV75643m5a)", package:"bos.net.tcp.client", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.9.48") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"05", patch:"(IV73324s5a|IV75643m5a)", package:"bos.net.tcp.server", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.9.45") < 0) flag++;
