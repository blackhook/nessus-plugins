...
if(description)
{
 script_id(43244);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828849";
...
"The remote host is missing AIX PTF U828849 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828849"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828849", package:"bos.64bit.6.1.2.6") < 0 ) 
