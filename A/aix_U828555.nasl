...
if(description)
{
 script_id(41875);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828555";
...
"The remote host is missing AIX PTF U828555 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828555"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828555", package:"bos.sysmgt.nim.client.6.1.1.5") < 0 ) 
