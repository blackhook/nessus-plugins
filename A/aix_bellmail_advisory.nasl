...
if (description)
{
  ...
  script_bugtraq_id(94979);
  script_xref(name:"EDB-ID", value:"40950");

  script_name(english:"AIX bellmail Advisory : bellmail_advisory.asc (IV91006) (IV91007) (IV91008) (IV91010) (IV91011)");
...
by a privilege escalation vulnerability due the use of insecure
permissions. A local attacker can exploit this, via a specially
crafted command, to gain root privileges.");
  script_set_attribute(attribute:"see_also", value:"https://aix.software.ibm.com/aix/efixes/security/bellmail_advisory.asc");
...
"A fix is available and can be downloaded from the IBM AIX website.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-8972");
    ...
    "09": {
      ...
      "07": {
        "bos.net.tcp.client": {
          "minfilesetver":"6.1.9.0",
          "maxfilesetver":"6.1.9.200",
          "patch":"(IV91006s8a|IV92238m8a|IV97356m9a)"
        }
      },
      "08": {
        "bos.net.tcp.client": {
    ...
    "04": {
      ...
      "03": {
        "bos.net.tcp.client": {
          "minfilesetver":"7.1.4.0",
          "maxfilesetver":"7.1.4.30",
          "patch":"(IV91008s3a|IV92240m3a|IV99497m5a)"
        }
      }
    }
  },
   ...
   "01": {
      ...
      "01": {
        "bos.net.tcp.client_core": {
          "minfilesetver":"7.2.1.0",
          "maxfilesetver":"7.2.1.0",
          "patch":"(IV91011s1a|IV92242m1a|IV99499m3a)"
        }
      }
    }
  }
