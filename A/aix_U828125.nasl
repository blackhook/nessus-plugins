...
if(description)
{
 script_id(43949);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828125";
...
"The remote host is missing AIX PTF U828125 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828125"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828125", package:"bos.rte.install.6.1.4.3") < 0 ) 
