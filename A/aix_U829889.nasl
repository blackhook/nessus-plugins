...
if(description)
{
 script_id(44469);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829889";
...
"The remote host is missing AIX PTF U829889 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829889"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829889", package:"devices.common.IBM.sissas.rte.5.3.11.1") < 0 ) 
