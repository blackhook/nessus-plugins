...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : ntp (IV87419) (deprecated)");
  script_summary(english:"Check for APAR IV87419");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"05", patch:"IV87419m5d", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.102") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"06", patch:"IV87419m6a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.102") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"07", patch:"IV87419m7a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.102") < 0) flag++;
