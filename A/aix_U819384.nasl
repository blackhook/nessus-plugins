...
if(description)
{
 script_id(33693);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819384";
...
"The remote host is missing AIX PTF U819384 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819384"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819384", package:"perfagent.tools.5.3.0.66") < 0 ) 
