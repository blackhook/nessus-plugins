...
if(description)
{
 script_id(33017);
 script_version("1.6");
 name["english"] = "AIX 530007 : U817623";
...
"The remote host is missing AIX PTF U817623 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U817623"; 
...
if ( aix_check_patch(ml:"530007", patch:"U817623", package:"bos.perf.proctools.5.3.7.2") < 0 ) 
