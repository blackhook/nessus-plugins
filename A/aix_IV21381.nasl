...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : libodm (IV21381)");
  script_summary(english:"Check for APAR IV21381");
...
if (aix_check_ifix(release:"6.1", ml:"07", sp:"04", patch:"IV21381", package:"bos.rte.odm", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.15") < 0) flag++;
