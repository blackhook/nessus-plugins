...
if(description)
{
 script_id(41826);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828505";
...
"The remote host is missing AIX PTF U828505 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828505"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828505", package:"devices.pciex.8680c71014108003.rte.6.1.1.4") < 0 ) 
