...
# AlmaLinux Security Advisory ALSA-2021:4181.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:4181");

  script_name(english:"AlmaLinux 8 : mutt (ALSA-2021:4181)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-4181.html");
...
"Update the affected mutt package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:mutt");
