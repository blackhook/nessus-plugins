...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : libodm (IV21379)");
  script_summary(english:"Check for APAR IV21379");
...
if (aix_check_ifix(release:"6.1", ml:"06", sp:"07", patch:"IV21379", package:"bos.rte.odm", minfilesetver:"6.1.6.0", maxfilesetver:"6.1.6.15") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"06", sp:"08", patch:"IV21379.61", package:"bos.rte.odm", minfilesetver:"6.1.6.0", maxfilesetver:"6.1.6.15") < 0) flag++;
