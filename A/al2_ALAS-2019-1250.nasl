...
flag = 0;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"thunderbird-60.7.2-2.amzn2.0.1", allowmaj:TRUE)) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"thunderbird-debuginfo-60.7.2-2.amzn2.0.1", allowmaj:TRUE)) flag++;
