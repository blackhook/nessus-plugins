...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : muxatmd (IZ48500)");
  script_summary(english:"Check for APAR IZ48500");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ48500_08", package:"devices.common.IBM.atm.rte", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.0") < 0) flag++;
