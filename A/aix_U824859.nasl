...
if(description)
{
 script_id(38536);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824859";
...
"The remote host is missing AIX PTF U824859 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824859"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824859", package:"bos.rte.serv_aid.5.3.9.1") < 0 ) 
