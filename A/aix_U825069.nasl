...
if(description)
{
 script_id(38614);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825069";
...
"The remote host is missing AIX PTF U825069 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825069"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825069", package:"bos.cifs_fs.rte.5.3.8.2") < 0 ) 
