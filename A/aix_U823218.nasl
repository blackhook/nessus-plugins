...
if(description)
{
 script_id(44192);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823218";
...
"The remote host is missing AIX PTF U823218 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823218"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823218", package:"bos.perf.proctools.5.3.10.1") < 0 ) 
