...
if(description)
{
 script_id(41729);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828292";
...
"The remote host is missing AIX PTF U828292 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828292"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828292", package:"bos.perf.tools.6.1.2.5") < 0 ) 
