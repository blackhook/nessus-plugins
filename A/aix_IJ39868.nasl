...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : lpd (IJ39868)");
  script_summary(english:"Check for APAR IJ39868");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"07", patch:"IJ39868s9a", package:"bos.rte.printers", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.33") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ39868s9a", package:"bos.rte.printers", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.33") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ39868s9a", package:"bos.rte.printers", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.33") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"10", patch:"IJ39868s9a", package:"bos.rte.printers", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.33") < 0) flag++;
