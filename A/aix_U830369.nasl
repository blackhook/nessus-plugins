...
if(description)
{
 script_id(43995);
 script_version("1.5");
 name["english"] = "AIX 610004 : U830369";
...
"The remote host is missing AIX PTF U830369 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830369"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830369", package:"bos.sysmgt.serv_aid.6.1.4.1") < 0 ) 
