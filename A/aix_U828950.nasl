...
if(description)
{
 script_id(43287);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828950";
...
"The remote host is missing AIX PTF U828950 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828950"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828950", package:"bos.64bit.6.1.1.5") < 0 ) 
