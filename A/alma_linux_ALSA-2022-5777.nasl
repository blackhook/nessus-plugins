...
# AlmaLinux Security Advisory ALSA-2022:5777.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:5777");
  script_xref(name:"IAVA", value:"2022-A-0298-S");

  script_name(english:"AlmaLinux 8 : firefox (5777) (ALSA-2022:5777)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-5777.html");
...
var pkgs = [
    {'reference':'firefox-91.12.0-2.el8_6.alma', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-91.12.0-2.el8_6.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
