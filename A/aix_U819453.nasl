...
if(description)
{
 script_id(34557);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819453";
...
"The remote host is missing AIX PTF U819453 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819453"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819453", package:"bos.adt.debug.5.3.0.62") < 0 ) 
