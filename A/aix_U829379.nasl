...
if(description)
{
 script_id(42599);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829379";
...
"The remote host is missing AIX PTF U829379 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829379"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829379", package:"bos.alt_disk_install.rte.5.3.9.2") < 0 ) 
