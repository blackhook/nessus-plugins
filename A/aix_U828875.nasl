...
if(description)
{
 script_id(43268);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828875";
...
"The remote host is missing AIX PTF U828875 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828875"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828875", package:"devices.chrp.base.rte.6.1.2.7") < 0 ) 
