...
if(description)
{
 script_id(38447);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824769";
...
"The remote host is missing AIX PTF U824769 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824769"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824769", package:"bos.rte.libpthreads.5.3.9.1") < 0 ) 
