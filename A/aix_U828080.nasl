...
if(description)
{
 script_id(43907);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828080";
...
"The remote host is missing AIX PTF U828080 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828080"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828080", package:"devices.common.IBM.ib.rte.6.1.4.2") < 0 ) 
