...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : ksh (IJ30557)");
  script_summary(english:"Check for APAR IJ30557");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"00", patch:"IJ30557s2a", package:"bos.rte.shell", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.2") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"01", patch:"IJ30557s2a", package:"bos.rte.shell", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.2") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ30557s2a", package:"bos.rte.shell", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.2") < 0) flag++;
