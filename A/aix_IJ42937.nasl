...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 0 : kernel (IJ42937)");
  script_summary(english:"Check for APAR IJ42937");
...
if (aix_check_ifix(release:"7.3", ml:"00", sp:"01", patch:"IJ42937s1a", package:"bos.net.tcp.client_core", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.2") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"00", sp:"02", patch:"IJ42937s2a", package:"bos.net.tcp.client_core", minfilesetver:"7.3.0.0", maxfilesetver:"7.3.0.2") < 0) flag++;
