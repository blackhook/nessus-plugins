...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : sendmail (IJ02915)");
  script_summary(english:"Check for APAR IJ02915");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"09", patch:"IJ02915s9a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.315") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"10", patch:"IJ02915s9a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.315") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"11", patch:"IJ02915s9a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.315") < 0) flag++;
