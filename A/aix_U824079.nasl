...
if(description)
{
 script_id(39160);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824079";
...
"The remote host is missing AIX PTF U824079 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824079"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824079", package:"devices.chrp.base.rte.6.1.2.4") < 0 ) 
