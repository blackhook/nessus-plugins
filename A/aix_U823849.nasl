...
if(description)
{
 script_id(39027);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823849";
...
"The remote host is missing AIX PTF U823849 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823849"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823849", package:"bos.net.nfs.cachefs.6.1.0.5") < 0 ) 
