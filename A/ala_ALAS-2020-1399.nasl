...
(CVE-2018-10756)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1399.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"ALA", reference:"transmission-3.00-1.1.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"transmission-cli-3.00-1.1.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"transmission-common-3.00-1.1.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"transmission-daemon-3.00-1.1.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"transmission-debuginfo-3.00-1.1.amzn1")) flag++;
