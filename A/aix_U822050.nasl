...
if(description)
{
 script_id(38374);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822050";
...
"The remote host is missing AIX PTF U822050 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822050"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822050", package:"bos.perf.tools.5.3.8.5") < 0 ) 
