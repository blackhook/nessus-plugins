...
if(description)
{
 script_id(42485);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825141";
...
"The remote host is missing AIX PTF U825141 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825141"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825141", package:"bos.mp.5.3.8.8") < 0 ) 
