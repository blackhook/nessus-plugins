...
private attributes, such as password hashes. (CVE-2019-14824)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1381.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"389-ds-base-1.3.9.1-12.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-debuginfo-1.3.9.1-12.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-devel-1.3.9.1-12.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-libs-1.3.9.1-12.amzn2.0.1")) flag++;
if (rpm_check(release:"AL2", reference:"389-ds-base-snmp-1.3.9.1-12.amzn2.0.1")) flag++;
