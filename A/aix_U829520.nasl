...
if(description)
{
 script_id(42693);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829520";
...
"The remote host is missing AIX PTF U829520 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829520"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829520", package:"devices.pci.77102224.com.5.3.8.4") < 0 ) 
