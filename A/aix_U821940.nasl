...
if(description)
{
 script_id(35169);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821940";
...
"The remote host is missing AIX PTF U821940 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821940"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821940", package:"bos.rte.install.5.3.0.70") < 0 ) 
