...
if (description)
{
  ...
  script_name(english:"Adobe Digital Editions < 4.5.10 Out-Of-Bounds Read Vulnerability (APSB19-04)");
...
host is prior to 4.5.10. It is, therefore, affected by multiple
vulnerabilities.");
