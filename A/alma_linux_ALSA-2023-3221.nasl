...
# AlmaLinux Security Advisory ALSA-2023:3221.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:3221");
  script_xref(name:"IAVA", value:"2023-A-0255-S");

  script_name(english:"AlmaLinux 8 : thunderbird (ALSA-2023:3221)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-3221.html");
...
var pkgs = [
    {'reference':'thunderbird-102.11.0-1.el8_7.alma.plus', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-102.11.0-1.el8_7.alma.plus', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
