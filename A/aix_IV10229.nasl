...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 5 : wpar (IV10229)");
  script_summary(english:"Check for APAR IV10229");
...
if (aix_check_ifix(release:"6.1", ml:"05", sp:"08", patch:"IV10229s07", package:"bos.mp64", minfilesetver:"6.1.5.0", maxfilesetver:"6.1.5.8") < 0) flag++;
