...
if (description)
{
  ...
  script_name(english:"Asterisk PJProject TCP Connection DoS (AST-2016-005)");
...
13.1-cert5. It is, therefore, affected by a flaw in PJProject due to a
failure to close TCP connections after receiving new ones. An
unauthenticated, remote attacker can exploit this, by opening multiple
connections without sending data, to exhaust the number of allowed TCP
connections, resulting in a denial of service condition.

Note that Nessus has not tested for this issue but has instead relied
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2016-005.html");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2016/Apr/86");
