...
if(description)
{
 script_id(43916);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828089";
...
"The remote host is missing AIX PTF U828089 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828089"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828089", package:"X11.base.rte.6.1.4.1") < 0 ) 
