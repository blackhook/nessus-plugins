...
# from AIX Security PTF U841068. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : bos.net.tcp.client (U841068)");
  script_summary(english:"Check for PTF U841068");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U841068, which is related to the
...
an attacker could exploit this vulnerability to cause a kernel panic."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV08677"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV14209"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV07188"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610007", patch:"U841068", package:"bos.net.tcp.client.6.1.7.15") < 0 ) flag++;
