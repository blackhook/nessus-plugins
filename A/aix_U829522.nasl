...
if(description)
{
 script_id(42695);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829522";
...
"The remote host is missing AIX PTF U829522 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829522"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829522", package:"devices.scsi.disk.rte.5.3.8.6") < 0 ) 
