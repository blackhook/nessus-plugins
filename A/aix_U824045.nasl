...
if(description)
{
 script_id(39130);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824045";
...
"The remote host is missing AIX PTF U824045 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824045"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824045", package:"devices.pci.14106902.rte.6.1.2.2") < 0 ) 
