...
if(description)
{
 script_id(44173);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823199";
...
"The remote host is missing AIX PTF U823199 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823199"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823199", package:"devices.iscsi_sw.rte.5.3.10.1") < 0 ) 
