...
if(description)
{
 script_id(43467);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828433";
...
"The remote host is missing AIX PTF U828433 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828433"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828433", package:"devices.pci.1410bd02.diag.6.1.3.1") < 0 ) 
