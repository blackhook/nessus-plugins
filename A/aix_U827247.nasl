...
# from AIX Security PTF U827247. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.2 TL 10 : X11.Dt.ToolTalk (U827247)");
  script_summary(english:"Check for PTF U827247");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U827247, which is related to the
...
/usr/dt/lib/libtt.a /usr/dt/bin/rpc.ttdbserver."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ52842"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"520010", patch:"U827247", package:"X11.Dt.ToolTalk.5.2.0.106") < 0 ) flag++;
