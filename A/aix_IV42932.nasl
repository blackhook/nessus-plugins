...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : tftp (IV42932)");
  script_summary(english:"Check for APAR IV42932");
...
root via tftp client."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/tftp_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"6.1", ml:"07", sp:"07", patch:"IV42932s7a", package:"bos.net.tcp.client", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.18") < 0) flag++;
