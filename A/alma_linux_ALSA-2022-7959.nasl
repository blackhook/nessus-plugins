...
# AlmaLinux Security Advisory ALSA-2022:7959.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7959");

  script_name(english:"AlmaLinux 9 : guestfs-tools (ALSA-2022:7959)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7959.html");
...
"Update the affected guestfs-tools and / or virt-win-reg packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:guestfs-tools");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:virt-win-reg");
