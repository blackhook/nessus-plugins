...
if(description)
{
 script_id(39210);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825581";
...
"The remote host is missing AIX PTF U825581 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825581"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825581", package:"bos.sysmgt.nim.client.6.1.2.3") < 0 ) 
