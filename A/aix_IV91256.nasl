...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : bind (IV91256) (deprecated)");
  script_summary(english:"Check for APAR IV91256");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"00", patch:"IV91256m1b", package:"core", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.2") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"01", patch:"IV91256m1b", package:"core", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.2") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"02", patch:"IV91256m2b", package:"core", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.2") < 0) flag++;
