...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : sendmail (IZ72515)");
  script_summary(english:"Check for APAR IZ72515");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ72515_02", package:"bos.net.tcp.client", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.6") < 0) flag++;
