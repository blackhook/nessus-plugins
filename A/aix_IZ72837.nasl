...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 11 : sendmail (IZ72837)");
  script_summary(english:"Check for APAR IZ72837");
...
if (aix_check_ifix(release:"5.3", ml:"11", patch:"IZ72837_11", package:"bos.net.tcp.client", minfilesetver:"5.3.11.0", maxfilesetver:"5.3.11.2") < 0) flag++;
