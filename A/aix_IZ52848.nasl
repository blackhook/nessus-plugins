...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 0 : libtt (IZ52848)");
  script_summary(english:"Check for APAR IZ52848");
...
if (aix_check_ifix(release:"6.1", ml:"00", patch:"IZ52848_00", package:"X11.Dt.ToolTalk", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.0.0") < 0) flag++;
