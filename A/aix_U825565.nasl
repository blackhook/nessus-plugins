...
if(description)
{
 script_id(39195);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825565";
...
"The remote host is missing AIX PTF U825565 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825565"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825565", package:"devices.common.IBM.fc.rte.6.1.2.3") < 0 ) 
