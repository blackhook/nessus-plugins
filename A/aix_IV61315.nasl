...
# @DEPRECATED@
#
# This plugin has been deprecated. The patch has been superseded, use plugin aix_IV62806.nasl.
#
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : malloc (IV61315)");
  script_summary(english:"Checks for APAR IV61315.");
...
# Deprecated.
exit(0, "This plugin has been deprecated. Use aix_IV62806.nasl (plugin #77264) instead.");
...
if (aix_check_ifix(release:"7.1", ml:"01", sp:"09", patch:"IV61315s9a", package:"bos.rte.libc", minfilesetver:"7.1.1.0", maxfilesetver:"7.1.1.20") < 0) flag++;
