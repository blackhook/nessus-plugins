...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-265.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-265");
  script_xref(name:"RHSA", value:"2013:1829");

  script_name(english:"Amazon Linux AMI : nss (ALAS-2013-265)");
...
(CVE-2013-5606)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-265.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nss-3.15.3-2.31.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-debuginfo-3.15.3-2.31.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-devel-3.15.3-2.31.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-pkcs11-devel-3.15.3-2.31.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-sysinit-3.15.3-2.31.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-tools-3.15.3-2.31.amzn1")) flag++;
