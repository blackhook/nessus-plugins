...
if(description)
{
 script_id(42575);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829354";
...
"The remote host is missing AIX PTF U829354 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829354"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829354", package:"bos.64bit.5.3.9.5") < 0 ) 
