...
if(description)
{
 script_id(38569);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824994";
...
"The remote host is missing AIX PTF U824994 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824994"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824994", package:"devices.pciex.8680c71014108003.rte.5.3.7.2") < 0 ) 
