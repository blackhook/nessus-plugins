...
if(description)
{
 script_id(35853);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818443";
...
"The remote host is missing AIX PTF U818443 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818443"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818443", package:"X11.base.rte.6.1.0.6") < 0 ) 
