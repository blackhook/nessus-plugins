...
if(description)
{
 ...
 script_name(english: "AIX 530008 : U826309");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826309");
...
if ( aix_check_patch(ml:"530008", patch:"U826309", package:"devices.pciex.7710322577107601.rte.5.3.8.0") < 0 ) 
