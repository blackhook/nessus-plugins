...
if(description)
{
 script_id(43192);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828573";
...
"The remote host is missing AIX PTF U828573 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828573"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828573", package:"devices.pciex.b3154a63.rte.6.1.1.7") < 0 ) 
