...
vulnerability to execute arbitrary code on the affected device."
  ...
  script_set_attribute(
    attribute:"see_also", 
    value:"https://support.apple.com/en-us/HT202347"
  );
  script_set_attribute(
    attribute:"see_also", 
    value:"https://lists.apple.com/archives/security-announce/2011/Nov/msg00002.html"
  );
  script_set_attribute(
    attribute:"see_also", 
    value:"https://www.securityfocus.com/archive/1/520482/30/0/threaded"
  );
