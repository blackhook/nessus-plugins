...
if(description)
{
 script_id(32232);
 script_version("1.6");
 name["english"] = "AIX 520010 : U815014";
...
"The remote host is missing AIX PTF U815014 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U815014"; 
...
if ( aix_check_patch(ml:"520010", patch:"U815014", package:"devices.common.IBM.atm.rte.5.2.0.97") < 0 ) 
