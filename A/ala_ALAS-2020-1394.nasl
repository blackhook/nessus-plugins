...
(CVE-2019-18609)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1394.html"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Run 'yum update librabbitmq' to update your system."
  );
...
flag = 0;
if (rpm_check(release:"ALA", reference:"librabbitmq-0.1-0.2.hgfb6fca832fd2.3.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"librabbitmq-debuginfo-0.1-0.2.hgfb6fca832fd2.3.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"librabbitmq-devel-0.1-0.2.hgfb6fca832fd2.3.amzn1")) flag++;
