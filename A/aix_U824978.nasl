...
if(description)
{
 script_id(38553);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824978";
...
"The remote host is missing AIX PTF U824978 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824978"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824978", package:"bos.mp.5.3.7.10") < 0 ) 
