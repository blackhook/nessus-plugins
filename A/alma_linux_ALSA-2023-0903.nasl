...
# AlmaLinux Security Advisory ALSA-2023:0903.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:0903");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/03/07");

  script_name(english:"AlmaLinux 9 : webkit2gtk3 (ALSA-2023:0903)");
...
ALSA-2023:0903 advisory.

  - A type confusion issue was addressed with improved checks. (CVE-2023-23529)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-0903.html");
