...
if(description)
{
 script_id(38398);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822074";
...
"The remote host is missing AIX PTF U822074 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822074"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822074", package:"perfagent.tools.5.3.8.3") < 0 ) 
