...
if(description)
{
 script_id(39029);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823851";
...
"The remote host is missing AIX PTF U823851 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823851"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823851", package:"bos.cifs_fs.rte.6.1.0.4") < 0 ) 
