...
if(description)
{
 script_id(38519);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824842";
...
"The remote host is missing AIX PTF U824842 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824842"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824842", package:"bos.net.nfs.cachefs.5.3.9.1") < 0 ) 
