...
if(description)
{
 script_id(44004);
 script_version("1.5");
 name["english"] = "AIX 610004 : U830380";
...
"The remote host is missing AIX PTF U830380 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830380"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830380", package:"bos.perf.proctools.6.1.4.1") < 0 ) 
