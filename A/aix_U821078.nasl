...
if(description)
{
 script_id(34584);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821078";
...
"The remote host is missing AIX PTF U821078 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821078"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821078", package:"bos.sysmgt.nim.client.5.3.7.2") < 0 ) 
