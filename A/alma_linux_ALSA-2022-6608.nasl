...
# AlmaLinux Security Advisory ALSA-2022:6608.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:6608");

  script_name(english:"AlmaLinux 9 : dbus-broker (ALSA-2022:6608)");
...
ALSA-2022:6608 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-6608.html");
...
"Update the affected dbus-broker package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:dbus-broker");
