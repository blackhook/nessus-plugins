...
# AlmaLinux Security Advisory ALSA-2023:2805.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2805");

  script_name(english:"AlmaLinux 8 : xorg-x11-server-Xwayland (ALSA-2023:2805)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-2805.html");
