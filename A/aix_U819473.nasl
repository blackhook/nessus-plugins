...
if(description)
{
 script_id(34575);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819473";
...
"The remote host is missing AIX PTF U819473 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819473"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819473", package:"bos.sysmgt.nim.client.5.3.0.65") < 0 ) 
