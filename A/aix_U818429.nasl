...
if(description)
{
 script_id(35839);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818429";
...
"The remote host is missing AIX PTF U818429 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818429"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818429", package:"devices.chrp.base.rte.6.1.0.7") < 0 ) 
