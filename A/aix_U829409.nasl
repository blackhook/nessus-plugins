...
if(description)
{
 script_id(42629);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829409";
...
"The remote host is missing AIX PTF U829409 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829409"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829409", package:"devices.fcp.tape.rte.5.3.9.3") < 0 ) 
