...
if(description)
{
 script_id(42506);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825162";
...
"The remote host is missing AIX PTF U825162 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825162"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825162", package:"bos.alt_disk_install.rte.5.3.8.5") < 0 ) 
