...
if(description)
{
 script_id(43496);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828738";
...
"The remote host is missing AIX PTF U828738 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828738"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828738", package:"bos.net.tcp.server.6.1.3.2") < 0 ) 
