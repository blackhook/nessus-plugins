...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 0 : at (IZ43453)");
  script_summary(english:"Check for APAR IZ43453");
...
/usr/bin/at."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/at_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"5.3", ml:"00", patch:"IZ43453_06", package:"bos.rte.cron", minfilesetver:"5.3.0.0", maxfilesetver:"5.3.0.63") < 0) flag++;
