...
is, therefore, affected by multiple vulnerabilities :
  ...
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c04762372
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5d7c6cdd");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c04872416
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8c82659");
  # https://support.hpe.com/hpsc/doc/public/display?docId=emr_na-c04863612
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8482e3a9");
  script_set_attribute(attribute:"solution", value:
"Upgrade to HP ArcSight Logger 6.0 P2 or later.");
  script_set_attribute(attribute:"agent", value:"unix");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-6030");
