...
if (description)
{
  ...
  script_name(english:"AIX 7.3 TL 1 : librts (IJ45246)");
  script_summary(english:"Check for APAR IJ45246");
...
if (aix_check_ifix(release:"7.3", ml:"01", sp:"01", patch:"IJ45246s1a", package:"bos.mp64", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"01", sp:"01", patch:"IJ45246s1a", package:"bos.rte.serv_aid", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.1") < 0) flag++;
if (aix_check_ifix(release:"7.3", ml:"01", sp:"01", patch:"IJ45246s1a", package:"bos.sysmgt.serv_aid", minfilesetver:"7.3.1.0", maxfilesetver:"7.3.1.0") < 0) flag++;
