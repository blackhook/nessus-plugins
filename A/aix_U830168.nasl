...
if(description)
{
 script_id(45269);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830168";
...
"The remote host is missing AIX PTF U830168 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830168"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830168", package:"bos.64bit.5.3.9.6") < 0 ) 
