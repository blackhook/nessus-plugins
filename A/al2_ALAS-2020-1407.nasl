...
iSCSI Block driver in QEMU versions 2.12.0 before 4.2.1 handled a
response coming from an iSCSI server while checking the status of a
Logical Address Block (LBA) in an iscsi_co_block_status() routine. A
remote user could use this flaw to crash the QEMU process, resulting
in a denial of service or potential execution of arbitrary code with
privileges of the QEMU process on the host. (CVE-2020-1711)");
...
flag = 0;
if (rpm_check(release:"AL2", reference:"ivshmem-tools-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-audio-alsa-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-audio-oss-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-audio-pa-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-audio-sdl-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-block-curl-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-block-dmg-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-block-iscsi-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-block-nfs-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", cpu:"x86_64", reference:"qemu-block-rbd-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-block-ssh-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-common-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-debuginfo-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-guest-agent-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-img-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-kvm-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-kvm-core-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-system-aarch64-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-system-aarch64-core-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-system-x86-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-system-x86-core-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-ui-curses-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-ui-gtk-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-ui-sdl-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-user-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-user-binfmt-3.1.0-8.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"qemu-user-static-3.1.0-8.amzn2.0.2")) flag++;
