...
if(description)
{
 script_id(42529);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825258";
...
"The remote host is missing AIX PTF U825258 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825258"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825258", package:"bos.rte.bind_cmds.5.3.9.4") < 0 ) 
