...
#@DEPRECATED@
#
# Disabled on 2014/03/10.  Deprecated by aix_U849877.nasl
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : icmp (IV13820)");
  script_summary(english:"Check for APAR IV13820");
...
exit(0, 'This plugin has been deprecated.  Use plugin #72848 (aix_U849877.nasl) instead.');
...
if (aix_check_ifix(release:"6.1", ml:"06", sp:"16", patch:"IV13820m06", package:"bos.net.tcp.client", minfilesetver:"6.1.6.0", maxfilesetver:"6.1.6.16") < 0) flag++;
