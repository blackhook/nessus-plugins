...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 0 : inet (IV42264)");
  script_summary(english:"Check for APAR IV42264");
...
IPv6 address is configured on any of the network interfaces."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/inet_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"7.1", ml:"00", sp:"08", patch:"IV42264s8a", package:"bos.net.tcp.client", minfilesetver:"7.1.0.0", maxfilesetver:"7.1.0.23") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"00", sp:"09", patch:"IV42264s9a", package:"bos.net.tcp.client", minfilesetver:"7.1.0.0", maxfilesetver:"7.1.0.23") < 0) flag++;
