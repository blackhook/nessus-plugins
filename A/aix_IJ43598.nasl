...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ43598)");
  script_summary(english:"Check for APAR IJ43598");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ43598s2b", package:"bos.net.tcp.client_core", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ43598s2b", package:"bos.net.tcp.client_core", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.104") < 0) flag++;
