...
if(description)
{
 script_id(38417);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822093";
...
"The remote host is missing AIX PTF U822093 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822093"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822093", package:"devices.ide.cdrom.rte.5.3.8.3") < 0 ) 
