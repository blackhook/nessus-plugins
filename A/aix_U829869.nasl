...
if(description)
{
 script_id(44449);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829869";
...
"The remote host is missing AIX PTF U829869 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829869"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829869", package:"devices.pci.77102224.com.5.3.11.2") < 0 ) 
