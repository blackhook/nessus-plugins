...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 2 : aixbase (IJ02729)");
  script_summary(english:"Check for APAR IJ02729");
...
if (aix_check_ifix(release:"7.2", ml:"02", sp:"00", patch:"IJ02729s1a", package:"bos.cluster.rte", minfilesetver:"7.2.2.0", maxfilesetver:"7.2.2.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"02", sp:"01", patch:"IJ02729s1a", package:"bos.cluster.rte", minfilesetver:"7.2.2.0", maxfilesetver:"7.2.2.0") < 0) flag++;
