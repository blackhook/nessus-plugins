...
if(description)
{
 script_id(41830);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828509";
...
"The remote host is missing AIX PTF U828509 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828509"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828509", package:"devices.pci.14106902.rte.6.1.1.6") < 0 ) 
