...
if(description)
{
 script_id(38216);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820001";
...
"The remote host is missing AIX PTF U820001 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820001"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820001", package:"perfagent.tools.5.3.9.2") < 0 ) 
