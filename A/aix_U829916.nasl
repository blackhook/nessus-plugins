...
if(description)
{
 script_id(44496);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829916";
...
"The remote host is missing AIX PTF U829916 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829916"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829916", package:"devices.pci.c1110358.rte.5.3.11.1") < 0 ) 
