...
if(description)
{
 script_id(34930);
 script_version("1.6");
 name["english"] = "AIX 610000 : U819758";
...
"The remote host is missing AIX PTF U819758 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819758"; 
...
if ( aix_check_patch(ml:"610000", patch:"U819758", package:"bos.rte.aio.6.1.0.3") < 0 ) 
