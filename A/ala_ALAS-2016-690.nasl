...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-690.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-690");

  script_name(english:"Amazon Linux AMI : foomatic (ALAS-2016-690)");
...
to execute arbitrary commands. (CVE-2015-8560)
...
(CVE-2010-5325)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-690.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Run 'yum update foomatic' to update your system."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:foomatic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:foomatic-debuginfo");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"foomatic-4.0.4-5.11.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"foomatic-debuginfo-4.0.4-5.11.amzn1")) flag++;
