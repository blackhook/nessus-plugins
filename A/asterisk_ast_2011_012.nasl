...
if (description)
{
  ...
  script_name(english:"Asterisk SIP Channel Driver Uninitialized Variable Request Parsing DoS (AST-2011-012)");
...
user when parsing an invalid SIP URI.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2011-012.html");
