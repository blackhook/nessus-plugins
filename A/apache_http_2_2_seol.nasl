...
if (description)
{
  ...
  script_name(english:"Apache httpd SEoL (2.1.x <= x <= 2.2.x)");

  script_set_attribute(attribute:"synopsis", value:
"An unsupported version of Apache httpd is installed on the remote host.");
  script_set_attribute(attribute:"description", value:
"According to its version, Apache httpd is between 2.1.x and 2.2.x. It is, therefore, no longer maintained by its vendor
or provider.
