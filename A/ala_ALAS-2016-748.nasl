...
# extracted from Amazon Linux AMI Security Advisory ALAS-2016-748.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2016-748");

  script_name(english:"Amazon Linux AMI : java-1.6.0-openjdk (ALAS-2016-748)");
...
CVE-2016-3550)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2016-748.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-1.6.0.40-1.13.12.6.75.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-debuginfo-1.6.0.40-1.13.12.6.75.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-demo-1.6.0.40-1.13.12.6.75.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-devel-1.6.0.40-1.13.12.6.75.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-javadoc-1.6.0.40-1.13.12.6.75.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.6.0-openjdk-src-1.6.0.40-1.13.12.6.75.amzn1")) flag++;
