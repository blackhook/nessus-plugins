...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-286.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-286");
  script_xref(name:"RHSA", value:"2014:0044");

  script_name(english:"Amazon Linux AMI : augeas (ALAS-2014-286)");
...
unprivileged local users to modify their content. (CVE-2013-6412)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-286.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"augeas-1.0.0-5.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"augeas-debuginfo-1.0.0-5.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"augeas-devel-1.0.0-5.7.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"augeas-libs-1.0.0-5.7.amzn1")) flag++;
