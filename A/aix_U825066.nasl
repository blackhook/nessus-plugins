...
if(description)
{
 script_id(39661);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825066";
...
"The remote host is missing AIX PTF U825066 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825066"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825066", package:"devices.chrp.base.rte.5.3.7.7") < 0 ) 
