...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : ntp (IV68429)");
  script_summary(english:"Check for APAR IV68429");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"05", patch:"IV68429m5b", package:"bos.net.tcp.client", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.19") < 0) flag++;
