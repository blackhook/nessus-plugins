...
# AlmaLinux Security Advisory ALSA-2022:6700.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:6700");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2022:6700)");
...
ALSA-2022:6700 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-6700.html");
...
"Update the affected firefox package.");
  ...
  script_cwe_id(120, 240, 416, 784, 1021);
...
var pkgs = [
    {'reference':'firefox-102.3.0-6.el9_0.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-102.3.0-6.el9_0.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
