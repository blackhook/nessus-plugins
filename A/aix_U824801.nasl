...
if(description)
{
 script_id(38479);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824801";
...
"The remote host is missing AIX PTF U824801 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824801"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824801", package:"bos.alt_disk_install.rte.5.3.9.1") < 0 ) 
