...
pkgs = [
    {'reference':'libxslt-1.1.28-6.15.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'libxslt-1.1.28-6.15.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'libxslt-debuginfo-1.1.28-6.15.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'libxslt-debuginfo-1.1.28-6.15.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'libxslt-devel-1.1.28-6.15.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'libxslt-devel-1.1.28-6.15.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'libxslt-python26-1.1.28-6.15.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'libxslt-python26-1.1.28-6.15.amzn1', 'cpu':'x86_64', 'release':'ALA'},
    {'reference':'libxslt-python27-1.1.28-6.15.amzn1', 'cpu':'i686', 'release':'ALA'},
    {'reference':'libxslt-python27-1.1.28-6.15.amzn1', 'cpu':'x86_64', 'release':'ALA'}
];
