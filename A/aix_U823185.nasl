...
# from AIX Security PTF U823185. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 10 : bos.net.tcp.server (U823185)");
  script_summary(english:"Check for PTF U823185");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U823185, which is related to the
...
/usr/sbin/named9."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ56314"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530010", patch:"U823185", package:"bos.net.tcp.server.5.3.10.1") < 0 ) flag++;
