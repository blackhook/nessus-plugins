...
if(description)
{
 script_id(43461);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828423";
...
"The remote host is missing AIX PTF U828423 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828423"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828423", package:"devices.vdevice.hvterm1.rte.6.1.3.1") < 0 ) 
