...
# from AIX Security PTF U865364. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : X11.base.rte (U865364)");
  script_summary(english:"Check for PTF U865364");
...
request that triggers memory-allocation failure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV52184"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610008", patch:"U865364", package:"X11.base.rte.6.1.8.16") < 0 ) flag++;
