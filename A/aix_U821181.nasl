...
if(description)
{
 script_id(34661);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821181";
...
"The remote host is missing AIX PTF U821181 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821181"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821181", package:"devices.pci.77102224.com.5.3.0.67") < 0 ) 
