...
if(description)
{
 script_id(44169);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823195";
...
"The remote host is missing AIX PTF U823195 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823195"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823195", package:"devices.scsi.disk.rte.5.3.10.1") < 0 ) 
