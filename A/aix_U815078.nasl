...
if(description)
{
 ...
 script_name(english: "AIX 520010 : U815078");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U815078");
...
if ( aix_check_patch(ml:"520010", patch:"U815078", package:"bos.rte.libpthreads.5.2.0.108") < 0 ) 
