...
if(description)
{
 script_id(39134);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824051";
...
"The remote host is missing AIX PTF U824051 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824051"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824051", package:"devices.common.IBM.ib.rte.6.1.2.4") < 0 ) 
