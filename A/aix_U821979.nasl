...
if(description)
{
 script_id(38324);
 script_version("1.5");
 name["english"] = "AIX 530006 : U821979";
...
"The remote host is missing AIX PTF U821979 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821979"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821979", package:"bos.64bit.5.3.0.70") < 0 ) 
