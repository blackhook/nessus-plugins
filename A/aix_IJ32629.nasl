...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 3 : kernel (IJ32629)");
  script_summary(english:"Check for APAR IJ32629");
...
if (aix_check_ifix(release:"7.2", ml:"03", sp:"05", patch:"IJ32629m5a", package:"bos.mp64", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.21") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"03", sp:"06", patch:"IJ32629m6a", package:"bos.mp64", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.21") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"03", sp:"07", patch:"IJ32629s7a", package:"bos.mp64", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.21") < 0) flag++;
