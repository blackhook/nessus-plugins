...
alienform.cgi." );
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2002/Jun/73" );
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 2002-2021 Andrew Hintz (http://guh.nu)");
