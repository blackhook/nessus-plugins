...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-412.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-412");
  script_xref(name:"RHSA", value:"2014:1193");

  script_name(english:"Amazon Linux AMI : axis (ALAS-2014-412)");
...
using a specially crafted X.509 certificate. (CVE-2014-3596)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-412.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"axis-1.2.1-7.5.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"axis-javadoc-1.2.1-7.5.14.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"axis-manual-1.2.1-7.5.14.amzn1")) flag++;
