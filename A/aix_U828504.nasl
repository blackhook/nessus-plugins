...
if(description)
{
 script_id(41825);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828504";
...
"The remote host is missing AIX PTF U828504 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828504"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828504", package:"devices.scsi.disk.rte.6.1.1.5") < 0 ) 
