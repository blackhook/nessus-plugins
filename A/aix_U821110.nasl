...
if(description)
{
 script_id(34616);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821110";
...
"The remote host is missing AIX PTF U821110 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821110"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821110", package:"bos.64bit.5.3.7.5") < 0 ) 
