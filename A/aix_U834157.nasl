...
# from AIX Security PTF U834157. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 3 : bos.net.nfs.client (U834157)");
  script_summary(english:"Check for PTF U834157");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U834157, which is related to the
...
"
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ75440");
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610003", patch:"U834157", package:"bos.net.nfs.client.6.1.3.4") < 0 ) flag++;
