...
# from AIX Security PTF U822098. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : bos.rte.cron (U822098)");
  script_summary(english:"Check for PTF U822098");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U822098, which is related to the
...
/usr/bin/at."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ43455"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530008", patch:"U822098", package:"bos.rte.cron.5.3.8.2") < 0 ) flag++;
