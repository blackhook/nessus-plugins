...
# AlmaLinux Security Advisory ALSA-2021:5013.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2021:5013");
  script_xref(name:"IAVA", value:"2021-A-0569-S");

  script_name(english:"AlmaLinux 8 : firefox (ALSA-2021:5013)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2021-5013.html");
...
var pkgs = [
    {'reference':'firefox-91.4.0-1.el8_5.alma', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
