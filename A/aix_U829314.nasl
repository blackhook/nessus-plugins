...
if(description)
{
 script_id(44283);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829314";
...
"The remote host is missing AIX PTF U829314 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829314"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829314", package:"bos.sysmgt.nim.client.5.3.10.1") < 0 ) 
