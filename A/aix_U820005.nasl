...
if(description)
{
 script_id(38220);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820005";
...
"The remote host is missing AIX PTF U820005 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820005"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820005", package:"bos.sysmgt.serv_aid.5.3.9.2") < 0 ) 
