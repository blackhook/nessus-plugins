...
http: in the target URL. (CVE-2019-13038)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1436.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"AL2", reference:"mod_auth_mellon-0.14.0-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"mod_auth_mellon-debuginfo-0.14.0-8.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"mod_auth_mellon-diagnostics-0.14.0-8.amzn2")) flag++;
