...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ44116)");
  script_summary(english:"Check for APAR IJ44116");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ44116s2a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ44116s2a", package:"bos.pfcdd.rte", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
