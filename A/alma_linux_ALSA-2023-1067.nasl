...
# AlmaLinux Security Advisory ALSA-2023:1067.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:1067");

  script_name(english:"AlmaLinux 9 : pesign (ALSA-2023:1067)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-1067.html");
