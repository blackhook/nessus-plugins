...
if(description)
{
 script_id(32293);
 script_version("1.6");
 name["english"] = "AIX 520010 : U815082";
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U815082"; 
...
if ( aix_check_patch(ml:"520010", patch:"U815082", package:"devices.chrp.base.rte.5.2.0.109") < 0 ) 
