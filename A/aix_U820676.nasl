...
if(description)
{
 script_id(35867);
 script_version("1.6");
 name["english"] = "AIX 610000 : U820676";
...
"The remote host is missing AIX PTF U820676 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820676"; 
...
if ( aix_check_patch(ml:"610000", patch:"U820676", package:"bos.cifs_fs.rte.6.1.0.3") < 0 ) 
