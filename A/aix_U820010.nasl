...
if(description)
{
 script_id(38225);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820010";
...
"The remote host is missing AIX PTF U820010 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820010"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820010", package:"devices.pci.77102224.com.5.3.9.1") < 0 ) 
