...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 8 : xorg (IV52184)");
  script_summary(english:"Check for APAR IV52184");
...
if (aix_check_ifix(release:"6.1", ml:"08", patch:"IV52184s0a", package:"X11.base.rte", minfilesetver:"6.1.8.0", maxfilesetver:"6.1.8.0") < 0) flag++;
