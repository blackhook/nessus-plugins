...
if(description)
{
 script_id(32298);
 script_version("1.6");
 name["english"] = "AIX 520010 : U818045";
...
script_set_attribute(attribute:"plugin_modification_date", value:"2021/01/05");
 ...
 summary["english"] = "Check for PTF U818045"; 
...
if ( aix_check_patch(ml:"520010", patch:"U818045", package:"devices.pci.ad100501.rte.5.2.0.106") < 0 ) 
