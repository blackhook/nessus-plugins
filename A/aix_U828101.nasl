...
if(description)
{
 script_id(43928);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828101";
...
"The remote host is missing AIX PTF U828101 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828101"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828101", package:"bos.rte.boot.6.1.4.1") < 0 ) 
