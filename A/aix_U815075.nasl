...
if(description)
{
 ...
 script_name(english: "AIX 520010 : U815075");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U815075");
...
if ( aix_check_patch(ml:"520010", patch:"U815075", package:"bos.net.tcp.smit.5.2.0.107") < 0 ) 
