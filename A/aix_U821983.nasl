...
if(description)
{
 script_id(38328);
 script_version("1.5");
 name["english"] = "AIX 530006 : U821983";
...
"The remote host is missing AIX PTF U821983 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821983"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821983", package:"bos.rte.serv_aid.5.3.0.65") < 0 ) 
