...
if(description)
{
 script_id(38618);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825076";
...
"The remote host is missing AIX PTF U825076 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825076"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825076", package:"devices.iscsi_sw.rte.5.3.8.2") < 0 ) 
