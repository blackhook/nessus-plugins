...
if(description)
{
 script_id(38448);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824770";
...
"The remote host is missing AIX PTF U824770 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824770"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824770", package:"bos.64bit.5.3.9.3") < 0 ) 
