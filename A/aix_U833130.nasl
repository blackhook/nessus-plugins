...
# from AIX Security PTF U833130. The text itself is copyright (C)
...
if (description)
{
  ...
  script_bugtraq_id(47125);

  script_name(english:"AIX 6.1 TL 6 : bos.rte.security (U833130)");
  script_summary(english:"Check for PTF U833130");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U833130, which is related to the
...
not be affected."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ97416"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610006", patch:"U833130", package:"bos.rte.security.6.1.6.15") < 0 ) flag++;
