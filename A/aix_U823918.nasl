...
if(description)
{
 script_id(39066);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823918";
...
"The remote host is missing AIX PTF U823918 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823918"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823918", package:"devices.chrp.base.rte.6.1.1.4") < 0 ) 
