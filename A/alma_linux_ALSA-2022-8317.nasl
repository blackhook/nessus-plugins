...
# AlmaLinux Security Advisory ALSA-2022:8317.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8317");
  script_xref(name:"IAVA", value:"2022-A-0299-S");

  script_name(english:"AlmaLinux 9 : samba (ALSA-2022:8317)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8317.html");
...
var pkgs = [
    {'reference':'ctdb-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'samba-winexe-4.16.4-101.el9', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
