...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : bind (IV81281) (deprecated)");
  script_summary(english:"Check for APAR IV81281");
...
if (aix_check_ifix(release:"7.1", ml:"04", sp:"00", patch:"IV81281m0b", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.0") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"01", patch:"IV81281m1a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.0") < 0) flag++;
