...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : errpt (IZ21494)");
  script_summary(english:"Check for APAR IZ21494");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ21494_08", package:"aid", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.0") < 0) flag++;
