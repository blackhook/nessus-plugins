...
if(description)
{
 script_id(38590);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825015";
...
"The remote host is missing AIX PTF U825015 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825015"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825015", package:"bos.alt_disk_install.rte.5.3.7.3") < 0 ) 
