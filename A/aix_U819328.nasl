...
if(description)
{
 script_id(34530);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819328";
...
"The remote host is missing AIX PTF U819328 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819328"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819328", package:"devices.pci.14106902.rte.5.3.7.5") < 0 ) 
