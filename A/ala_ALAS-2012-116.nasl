...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-116.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-116");

  script_name(english:"Amazon Linux AMI : php (ALAS-2012-116)");
...
unknown impact and remote attack vectors, related to an 'overflow.'"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-116.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"php-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-bcmath-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-cli-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-common-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-dba-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-debuginfo-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-devel-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-embedded-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-fpm-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-gd-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-imap-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-intl-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-ldap-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-mbstring-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-mcrypt-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-mssql-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-mysql-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-mysqlnd-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-odbc-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-pdo-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-pgsql-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-process-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-pspell-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-recode-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-snmp-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-soap-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-tidy-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-xml-5.3.15-1.22.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"php-xmlrpc-5.3.15-1.22.amzn1")) flag++;
