...
# AlmaLinux Security Advisory ALSA-2023:2459.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2459");

  script_name(english:"AlmaLinux 9 : device-mapper-multipath (ALSA-2023:2459)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2459.html");
