...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-581.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-581");
  script_xref(name:"RHSA", value:"2015:1287");

  script_name(english:"Amazon Linux AMI : freeradius (ALAS-2015-581)");
...
crash."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2015-581.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"freeradius-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-debuginfo-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-krb5-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-ldap-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-mysql-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-perl-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-postgresql-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-python-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-unixODBC-2.2.6-4.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"freeradius-utils-2.2.6-4.15.amzn1")) flag++;
