...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 0 : lsmcode (IZ15100)");
  script_summary(english:"Check for APAR IZ15100");
...
if (aix_check_ifix(release:"5.3", ml:"00", patch:"IZ15100_05", package:"bos.diag.util", minfilesetver:"5.3.0.50", maxfilesetver:"5.3.0.51") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"00", patch:"IZ15100_05", package:"bos.diag.util", minfilesetver:"5.3.0.60", maxfilesetver:"5.3.0.64") < 0) flag++;
