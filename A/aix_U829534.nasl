...
if(description)
{
 script_id(42706);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829534";
...
"The remote host is missing AIX PTF U829534 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829534"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829534", package:"bos.sysmgt.nim.client.5.3.8.4") < 0 ) 
