...
if (description)
{
  ...
  script_name(english:"Default Password ('scpuser') for 'scpuser' Account");

  script_set_attribute(attribute:"synopsis", value:
"The remote system can be accessed with a default user account.");
  script_set_attribute(attribute:"description", value:
"The account 'scpuser' on the remote host has the password 'scpuser'.
An attacker may leverage this issue to gain access, possibly as an
