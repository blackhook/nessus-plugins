...
# from AIX Security PTF U817348. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : bos.acct (U817348)");
  script_summary(english:"Check for PTF U817348");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U817348, which is related to the
...
/usr/bin/iostat."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ21506"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530008", patch:"U817348", package:"bos.acct.5.3.8.1") < 0 ) flag++;
