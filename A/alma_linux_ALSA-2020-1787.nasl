...
# AlmaLinux Security Advisory ALSA-2020:1787.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:1787");

  script_name(english:"AlmaLinux 8 : unzip (ALSA-2020:1787)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-1787.html");
...
"Update the affected unzip package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:unzip");
