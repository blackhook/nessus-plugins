...
if(description)
{
 script_id(44239);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829270";
...
"The remote host is missing AIX PTF U829270 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829270"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829270", package:"bos.net.nfs.client.5.3.10.2") < 0 ) 
