...
if (description)
{
  ...
  script_xref(name:"SECUNIA", value:"44973");
  script_xref(name:"SECUNIA", value:"45048");

  script_name(english:"Asterisk Multiple Channel Drivers Denial of Service (AST-2011-008 / AST-2011-009 / AST-2011-010)");
...
of service vulnerabilities :
  ...
  - A memory address can be inadvertently transmitted over
    ...
    (AST-2011-010)");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2011-008.html");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2011-009.html");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2011-010.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Asterisk 1.4.41.1, 1.6.2.18.1, 1.8.4.3, C.3.7.3 or later.");
