...
if(description)
{
 script_id(43236);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828841";
...
"The remote host is missing AIX PTF U828841 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828841"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828841", package:"devices.pci.77102224.com.6.1.2.4") < 0 ) 
