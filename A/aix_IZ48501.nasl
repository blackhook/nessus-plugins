...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : muxatmd (IZ48501)");
  script_summary(english:"Check for APAR IZ48501");
...
if (aix_check_ifix(release:"5.3", ml:"09", patch:"IZ48501_09", package:"devices.common.IBM.atm.rte", minfilesetver:"5.3.9.0", maxfilesetver:"5.3.9.0") < 0) flag++;
