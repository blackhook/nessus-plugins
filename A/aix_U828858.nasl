...
if(description)
{
 script_id(43252);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828858";
...
"The remote host is missing AIX PTF U828858 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828858"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828858", package:"devices.pciex.b3154a63.rte.6.1.2.6") < 0 ) 
