...
if(description)
{
 script_id(44153);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823179";
...
"The remote host is missing AIX PTF U823179 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823179"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823179", package:"devices.pciex.b3154a63.rte.5.3.10.2") < 0 ) 
