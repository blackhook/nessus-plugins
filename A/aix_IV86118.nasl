...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : nettcp (IV86118) (SLOTH)");
  script_summary(english:"Check for APAR IV86118");
...
if (aix_check_ifix(release:"7.1", ml:"04", patch:"IV86118m2a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.1") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", patch:"IV86118m2a", package:"bos.net.tcp.server", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.1") < 0) flag++;
