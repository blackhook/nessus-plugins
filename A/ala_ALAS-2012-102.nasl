...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-102.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-102");
  script_xref(name:"RHSA", value:"2012:0973");

  script_name(english:"Amazon Linux AMI : nss (ALAS-2012-102)");
...
untrusted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-102.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nss-3.13.3-8.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-debuginfo-3.13.3-8.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-devel-3.13.3-8.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-pkcs11-devel-3.13.3-8.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-sysinit-3.13.3-8.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-tools-3.13.3-8.25.amzn1")) flag++;
