...
if(description)
{
 script_id(43492);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828734";
...
"The remote host is missing AIX PTF U828734 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828734"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828734", package:"devices.iscsi_sw.rte.6.1.3.2") < 0 ) 
