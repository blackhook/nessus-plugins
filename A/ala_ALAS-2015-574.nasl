...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-574.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-574");

  script_name(english:"Amazon Linux AMI : gnupg2 (ALAS-2015-574)");
  ...
  script_set_attribute(
    ...
    value:
"It was reported that gnupg2 keyring DB code did not reject packets
which don't belong into a keyring, which may lead to invalid read of
sizeof (int)."
  );
  # https://blog.fuzzing-project.org/5-Multiple-issues-in-GnuPG-found-through-keyring-fuzzing-TFPA-0012015.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f139eeaf"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2015-574.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"gnupg2-2.0.28-1.30.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"gnupg2-debuginfo-2.0.28-1.30.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"gnupg2-smime-2.0.28-1.30.amzn1")) flag++;
