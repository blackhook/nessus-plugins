...
if(description)
{
 script_id(41854);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828533";
...
"The remote host is missing AIX PTF U828533 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828533"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828533", package:"bos.64bit.6.1.1.4") < 0 ) 
