...
if(description)
{
 script_id(41739);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828303";
...
"The remote host is missing AIX PTF U828303 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828303"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828303", package:"bos.sysmgt.serv_aid.6.1.2.2") < 0 ) 
