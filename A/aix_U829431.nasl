...
if(description)
{
 script_id(42650);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829431";
...
"The remote host is missing AIX PTF U829431 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829431"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829431", package:"bos.rte.libpthreads.5.3.9.2") < 0 ) 
