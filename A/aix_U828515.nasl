...
if(description)
{
 script_id(41836);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828515";
...
"The remote host is missing AIX PTF U828515 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828515"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828515", package:"bos.rte.filesystem.6.1.1.6") < 0 ) 
