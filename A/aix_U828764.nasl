...
if(description)
{
 script_id(43518);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828764";
...
"The remote host is missing AIX PTF U828764 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828764"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828764", package:"perfagent.tools.6.1.3.2") < 0 ) 
