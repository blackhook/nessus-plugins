...
if (description)
{
  ...
  script_name(english:"Adobe Illustrator 26.x < 26.1.0 A Vulnerability (APSB22-15)");

  script_set_attribute(attribute:"synopsis", value:
"Adobe Illustrator installed on remote host is affected by a vulnerability");
...
"Upgrade to Adobe Illustrator version 26.1.0 or later.");
  ...
  script_dependencies("adobe_illustrator_installed.nasl", "macos_adobe_illustrator_installed.nbin");
  script_require_keys("installed_sw/Adobe Illustrator");
...
var app_info = vcf::combined_get_app_info(app:'Adobe Illustrator');

var constraints = [
  { 'min_version' : '26.0.0', 'max_version' : '26.0.3', 'fixed_version' : '26.1.0' }
];
