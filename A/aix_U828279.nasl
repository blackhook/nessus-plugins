...
if(description)
{
 script_id(41716);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828279";
...
"The remote host is missing AIX PTF U828279 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828279"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828279", package:"bos.rte.serv_aid.6.1.2.2") < 0 ) 
