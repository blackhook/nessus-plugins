...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : swcons (IZ18334)");
  script_summary(english:"Check for APAR IZ18334");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ18334_08", package:"bos.rte.console", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.0") < 0) flag++;
