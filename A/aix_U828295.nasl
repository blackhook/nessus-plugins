...
if(description)
{
 script_id(41732);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828295";
...
"The remote host is missing AIX PTF U828295 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828295"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828295", package:"perfagent.tools.6.1.2.5") < 0 ) 
