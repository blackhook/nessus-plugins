...
if(description)
{
 script_id(43301);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828964";
...
"The remote host is missing AIX PTF U828964 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828964"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828964", package:"devices.pci.77102224.com.6.1.1.5") < 0 ) 
