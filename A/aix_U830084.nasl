...
if(description)
{
 script_id(45199);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830084";
...
"The remote host is missing AIX PTF U830084 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830084"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830084", package:"bos.64bit.5.3.10.3") < 0 ) 
