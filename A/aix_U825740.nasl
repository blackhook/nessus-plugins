...
if(description)
{
 script_id(41684);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825740";
...
"The remote host is missing AIX PTF U825740 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825740"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825740", package:"perfagent.tools.6.1.1.4") < 0 ) 
