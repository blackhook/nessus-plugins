...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1309.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : sudo (ALAS-2019-1309)");
...
https://www.sudo.ws/alerts/minus_1_uid.html"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2019-1309.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"ALA", reference:"sudo-1.8.6p3-29.28.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sudo-debuginfo-1.8.6p3-29.28.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"sudo-devel-1.8.6p3-29.28.amzn1")) flag++;
