...
if(description)
{
 script_id(39695);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825134";
...
"The remote host is missing AIX PTF U825134 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825134"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825134", package:"devices.chrp.base.rte.5.3.8.6") < 0 ) 
