...
if(description)
{
 script_id(43504);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828747";
...
"The remote host is missing AIX PTF U828747 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828747"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828747", package:"devices.common.IBM.fc.rte.6.1.3.1") < 0 ) 
