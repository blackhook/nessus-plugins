...
if(description)
{
 script_id(43444);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828390";
...
"The remote host is missing AIX PTF U828390 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828390"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828390", package:"devices.common.IBM.atm.rte.6.1.3.1") < 0 ) 
