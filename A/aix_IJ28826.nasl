...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 3 : gencore (IJ28826)");
  script_summary(english:"Check for APAR IJ28826");
...
if (aix_check_ifix(release:"7.2", ml:"03", sp:"03", patch:"IJ28826m3a", package:"bos.mp64", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.19") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"03", sp:"04", patch:"IJ28826m4a", package:"bos.mp64", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.19") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"03", sp:"05", patch:"IJ28826m5a", package:"bos.mp64", minfilesetver:"7.2.3.0", maxfilesetver:"7.2.3.19") < 0) flag++;
