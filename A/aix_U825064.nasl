...
if(description)
{
 script_id(39659);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825064";
...
"The remote host is missing AIX PTF U825064 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825064"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825064", package:"devices.pciex.8680c71014108003.rte.5.3.7.3") < 0 ) 
