...
if(description)
{
 script_id(38273);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821383";
...
"The remote host is missing AIX PTF U821383 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821383"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821383", package:"bos.sysmgt.nim.client.5.3.7.3") < 0 ) 
