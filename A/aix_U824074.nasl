...
if(description)
{
 script_id(39155);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824074";
...
"The remote host is missing AIX PTF U824074 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824074"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824074", package:"devices.pciex.b3154a63.rte.6.1.2.4") < 0 ) 
