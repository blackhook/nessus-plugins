...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : bind (IV81280) (deprecated)");
  script_summary(english:"Check for APAR IV81280");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"04", patch:"IV81280m4b", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.46") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV81280m5a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.46") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV81280m6a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.46") < 0) flag++;
