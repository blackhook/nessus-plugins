...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-183.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-183");
  script_xref(name:"RHSA", value:"2013:0751");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/06/15");

  script_name(english:"Amazon Linux AMI : java-1.7.0-openjdk (ALAS-2013-183)");
...
(CVE-2013-2415)");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2013-183.html");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-1.7.0.19-2.3.9.1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-debuginfo-1.7.0.19-2.3.9.1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-demo-1.7.0.19-2.3.9.1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-devel-1.7.0.19-2.3.9.1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-javadoc-1.7.0.19-2.3.9.1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"java-1.7.0-openjdk-src-1.7.0.19-2.3.9.1.25.amzn1")) flag++;
