...
if(description)
{
 script_id(35143);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821355";
...
"The remote host is missing AIX PTF U821355 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821355"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821355", package:"devices.pci.1410bd02.diag.5.3.7.5") < 0 ) 
