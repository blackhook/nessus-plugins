...
if(description)
{
 script_id(44017);
 script_version("1.5");
 name["english"] = "AIX 610004 : U830407";
...
"The remote host is missing AIX PTF U830407 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830407"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830407", package:"bos.net.nfs.adt.6.1.4.2") < 0 ) 
