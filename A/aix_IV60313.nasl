...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 7 : libodm (IV60313)");
  script_summary(english:"Check for APAR IV60313");
...
if (aix_check_ifix(release:"6.1", ml:"07", sp:"09", patch:"IV60313s9a", package:"bos.rte.odm", minfilesetver:"6.1.7.0", maxfilesetver:"6.1.7.16") < 0) flag++;
