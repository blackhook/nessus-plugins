...
if(description)
{
 script_id(39678);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825116";
...
"The remote host is missing AIX PTF U825116 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825116"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825116", package:"bos.64bit.5.3.8.6") < 0 ) 
