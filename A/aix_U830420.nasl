...
if(description)
{
 script_id(44548);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830420";
...
"The remote host is missing AIX PTF U830420 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830420"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830420", package:"perfagent.tools.6.1.4.3") < 0 ) 
