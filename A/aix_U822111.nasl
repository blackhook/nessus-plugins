...
if(description)
{
 script_id(38434);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822111";
...
"The remote host is missing AIX PTF U822111 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822111"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822111", package:"devices.pciex.8680c71014108003.rte.5.3.8.2") < 0 ) 
