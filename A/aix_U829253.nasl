...
if(description)
{
 script_id(44223);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829253";
...
"The remote host is missing AIX PTF U829253 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829253"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829253", package:"devices.pci.14106902.rte.5.3.10.2") < 0 ) 
