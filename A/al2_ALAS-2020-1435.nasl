...
executable sndfile-deinterleave. (CVE-2018-13139)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1435.html"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Run 'yum update libsndfile' to update your system."
  );
...
flag = 0;
if (rpm_check(release:"AL2", reference:"libsndfile-1.0.25-11.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libsndfile-debuginfo-1.0.25-11.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libsndfile-devel-1.0.25-11.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libsndfile-utils-1.0.25-11.amzn2")) flag++;
