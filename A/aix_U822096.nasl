...
if(description)
{
 script_id(38420);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822096";
...
"The remote host is missing AIX PTF U822096 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822096"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822096", package:"devices.scsi.disk.rte.5.3.8.5") < 0 ) 
