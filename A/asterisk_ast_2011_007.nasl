...
if (description)
{
  ...
  script_xref(name:"SECUNIA", value:"44828");

  script_name(english:"Asterisk SIP Channel Driver Denial of Service (AST-2011-007)");
...
running on the remote host is 1.8.x prior to 1.8.4.2. It, therefore,
could be affected by a denial of service vulnerability.

If a remote attacker initiates a SIP call and the recipient picks up,
the remote user can reply with a malformed Contact header that will
cause Asterisk to crash.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2011-007.html");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2011/Jun/27");
