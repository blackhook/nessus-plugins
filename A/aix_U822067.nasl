...
if(description)
{
 script_id(38391);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822067";
...
"The remote host is missing AIX PTF U822067 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822067"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822067", package:"devices.pci.14106902.rte.5.3.8.4") < 0 ) 
