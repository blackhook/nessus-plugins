...
if(description)
{
 script_id(44259);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829290";
...
"The remote host is missing AIX PTF U829290 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829290"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829290", package:"bos.cifs_fs.rte.5.3.10.1") < 0 ) 
