...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-184.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-184");
  script_xref(name:"RHSA", value:"2013:0742");

  script_name(english:"Amazon Linux AMI : 389-ds-base (ALAS-2013-184)");
...
obtain access to information outside of the rootDSE. (CVE-2013-1897)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-184.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"389-ds-base-1.3.0.6-1.3.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-debuginfo-1.3.0.6-1.3.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-devel-1.3.0.6-1.3.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"389-ds-base-libs-1.3.0.6-1.3.amzn1")) flag++;
