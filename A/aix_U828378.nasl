...
if(description)
{
 script_id(43190);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828378";
...
"The remote host is missing AIX PTF U828378 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828378"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828378", package:"devices.scsi.disk.rte.6.1.2.5") < 0 ) 
