...
if(description)
{
 script_id(39694);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825133";
...
"The remote host is missing AIX PTF U825133 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825133"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825133", package:"devices.pciex.8680c71014108003.rte.5.3.8.3") < 0 ) 
