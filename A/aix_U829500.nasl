...
if(description)
{
 script_id(42673);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829500";
...
"The remote host is missing AIX PTF U829500 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829500"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829500", package:"devices.common.IBM.ib.rte.5.3.8.7") < 0 ) 
