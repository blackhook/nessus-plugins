...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ41974)");
  script_summary(english:"Check for APAR IJ41974");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ41974s3a", package:"bos.net.tcp.client_core", minfilesetver:"7.2.5.102", maxfilesetver:"7.2.5.104") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ41974s3b", package:"bos.net.tcp.client_core", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ41974s3b", package:"bos.net.tcp.client_core", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ41974s4a", package:"bos.net.tcp.client_core", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.4") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ41974s4a", package:"bos.net.tcp.client_core", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.104") < 0) flag++;
