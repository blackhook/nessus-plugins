...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1321.
#
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : golang (ALAS-2019-1321)");
...
specific network configuration. (CVE-2019-16276)"
  ...
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2019-1321.html");
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"golang-1.12.8-1.52.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"golang-bin-1.12.8-1.52.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"golang-docs-1.12.8-1.52.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"golang-misc-1.12.8-1.52.amzn1")) flag++;
if (rpm_check(release:"ALA", cpu:"x86_64", reference:"golang-race-1.12.8-1.52.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"golang-src-1.12.8-1.52.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"golang-tests-1.12.8-1.52.amzn1")) flag++;
