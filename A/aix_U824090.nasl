...
if(description)
{
 script_id(39171);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824090";
...
"The remote host is missing AIX PTF U824090 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824090"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824090", package:"perfagent.tools.6.1.2.4") < 0 ) 
