...
if(description)
{
 script_id(44271);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829302";
...
"The remote host is missing AIX PTF U829302 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829302"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829302", package:"devices.vdevice.hvterm1.rte.5.3.10.1") < 0 ) 
