...
# from AIX Security PTF U855520. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : bos.rte.filesystem (U855520)");
  script_summary(english:"Check for PTF U855520");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U855520, which is related to the
...
vulnerability via the -k argument to kill a process of another user."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV28151"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610006", patch:"U855520", package:"bos.rte.filesystem.6.1.6.21") < 0 ) flag++;
