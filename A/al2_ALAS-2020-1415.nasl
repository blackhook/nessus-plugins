...
creating a specially crafted XML file that would crash the application
or potentially lead to arbitrary code execution. (CVE-2018-1311)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1415.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"xerces-c-3.1.1-10.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"xerces-c-debuginfo-3.1.1-10.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"xerces-c-devel-3.1.1-10.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"xerces-c-doc-3.1.1-10.amzn2")) flag++;
