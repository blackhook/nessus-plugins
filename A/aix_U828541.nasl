...
if(description)
{
 script_id(41861);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828541";
...
"The remote host is missing AIX PTF U828541 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828541"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828541", package:"devices.pci.1410bd02.diag.6.1.1.3") < 0 ) 
