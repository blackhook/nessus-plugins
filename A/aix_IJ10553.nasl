...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : solaris (IJ10553)");
  script_summary(english:"Check for APAR IJ10553");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"04", patch:"IJ10553s4a", package:"core", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"05", patch:"IJ10553s5a", package:"core", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.5") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"06", patch:"IJ10553s6a", package:"core", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.5") < 0) flag++;
