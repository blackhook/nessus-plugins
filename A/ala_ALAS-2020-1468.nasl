...
# extracted from Amazon Linux AMI Security Advisory ALAS-2020-1468.
##
...
if (description)
{
  ...
  script_name(english:"Amazon Linux AMI : vim-common (ALAS-2020-1468) (deprecated)");
...
vulnerability as referenced in the ALAS-2020-1468 advisory.
...
This plugin has been deprecated due to Amazon pulling the previously published advisory.");
  script_set_attribute(attribute:"see_also", value:"https://alas.aws.amazon.com/ALAS-2020-1468.html");
