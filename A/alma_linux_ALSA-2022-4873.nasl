...
# AlmaLinux Security Advisory ALSA-2022:4873.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:4873");

  script_name(english:"AlmaLinux 9 : firefox (ALSA-2022:4873)");
...
ALSA-2022:4873 advisory.

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-4873.html");
...
var pkgs = [
    {'reference':'firefox-91.10.0-1.el9_0.alma', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-91.10.0-1.el9_0.alma', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
