...
if(description)
{
 script_id(34588);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821082";
...
"The remote host is missing AIX PTF U821082 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821082"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821082", package:"devices.pciex.14103f03.diag.5.3.7.2") < 0 ) 
