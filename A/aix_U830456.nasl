...
if(description)
{
 script_id(44582);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830456";
...
"The remote host is missing AIX PTF U830456 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830456"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830456", package:"devices.pciex.14103f03.diag.6.1.4.1") < 0 ) 
