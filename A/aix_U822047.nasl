...
if(description)
{
 script_id(38371);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822047";
...
"The remote host is missing AIX PTF U822047 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822047"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822047", package:"bos.net.tcp.server.5.3.8.5") < 0 ) 
