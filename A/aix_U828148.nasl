...
if(description)
{
 script_id(43972);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828148";
...
"The remote host is missing AIX PTF U828148 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828148"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828148", package:"devices.common.IBM.sissas.rte.6.1.4.1") < 0 ) 
