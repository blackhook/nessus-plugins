...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : syscall (IV22694)");
  script_summary(english:"Check for APAR IV22694");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"06", patch:"IV22694s06", package:"bos.rte.tty", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.4") < 0) flag++;
