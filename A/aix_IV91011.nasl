...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 1 : bellmail (IV91011) (deprecated)");
  script_summary(english:"Check for APAR IV91011");
...
if (aix_check_ifix(release:"7.2", ml:"01", sp:"00", patch:"IV91011s1a", package:"core", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"01", patch:"IV91011s1a", package:"core", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
