...
if(description)
{
 script_id(39041);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823863";
...
"The remote host is missing AIX PTF U823863 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823863"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823863", package:"devices.pci.14106902.rte.6.1.0.5") < 0 ) 
