...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 0 : mustendd (IV81357)");
  script_summary(english:"Check for APAR IV81357");
...
if (aix_check_ifix(release:"7.2", ml:"00", sp:"00", patch:"IV81357s0a", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"00", sp:"01", patch:"IV81357s1a", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"7.2.0.0", maxfilesetver:"7.2.0.0") < 0) flag++;
