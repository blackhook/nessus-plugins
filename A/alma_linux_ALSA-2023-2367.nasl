...
# AlmaLinux Security Advisory ALSA-2023:2367.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2367");
  script_xref(name:"IAVB", value:"2022-B-0059-S");

  script_name(english:"AlmaLinux 9 : containernetworking-plugins (ALSA-2023:2367)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2367.html");
