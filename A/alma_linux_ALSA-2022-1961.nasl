...
# AlmaLinux Security Advisory ALSA-2022:1961.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:1961");

  script_name(english:"AlmaLinux 8 : cairo and pixman (ALSA-2022:1961)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:1961 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-1961.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:cairo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:cairo-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:cairo-gobject");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:cairo-gobject-devel");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cairo / cairo-devel / cairo-gobject / cairo-gobject-devel / pixman / etc');
}
