...
if(description)
{
 script_id(35829);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818419";
...
"The remote host is missing AIX PTF U818419 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818419"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818419", package:"bos.net.tcp.server.6.1.0.7") < 0 ) 
