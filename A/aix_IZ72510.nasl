...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 3 : sendmail (IZ72510)");
  script_summary(english:"Check for APAR IZ72510");
...
if (aix_check_ifix(release:"6.1", ml:"03", patch:"IZ72510_03", package:"bos.net.tcp.client", minfilesetver:"6.1.3.0", maxfilesetver:"6.1.3.3") < 0) flag++;
