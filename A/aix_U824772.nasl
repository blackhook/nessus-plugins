...
if(description)
{
 script_id(38450);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824772";
...
"The remote host is missing AIX PTF U824772 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824772"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824772", package:"bos.net.tcp.server.5.3.9.1") < 0 ) 
