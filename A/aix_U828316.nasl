...
if(description)
{
 script_id(41752);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828316";
...
"The remote host is missing AIX PTF U828316 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828316"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828316", package:"bos.sysmgt.nim.client.6.1.2.4") < 0 ) 
