...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : bellmail (IV91008) (deprecated)");
  script_summary(english:"Check for APAR IV91008");
...
if (aix_check_ifix(release:"7.1", ml:"04", sp:"01", patch:"IV91008s3a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.30") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"02", patch:"IV91008s3a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.30") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"03", patch:"IV91008s3a", package:"bos.net.tcp.client", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.30") < 0) flag++;
