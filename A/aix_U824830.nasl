...
if(description)
{
 script_id(38507);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824830";
...
"The remote host is missing AIX PTF U824830 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824830"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824830", package:"bos.rte.aio.5.3.9.2") < 0 ) 
