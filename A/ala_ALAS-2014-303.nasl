...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-303.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-303");
  script_xref(name:"RHSA", value:"2014:0185");

  script_name(english:"Amazon Linux AMI : openswan (ALAS-2014-303)");
...
connections to be dropped. (CVE-2013-6466)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-303.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"openswan-2.6.37-3.17.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openswan-debuginfo-2.6.37-3.17.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openswan-doc-2.6.37-3.17.amzn1")) flag++;
