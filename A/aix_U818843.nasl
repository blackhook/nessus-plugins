...
# from AIX Security PTF U818843. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 : bos.mp64 (U818843)");
  script_summary(english:"Check for PTF U818843");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U818843, which is related to the
...
/usr/lib/boot/unix_up."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ22370"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ23645"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610000", patch:"U818843", package:"bos.mp64.6.1.0.6") < 0 ) flag++;
