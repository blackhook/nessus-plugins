...
if(description)
{
 script_id(43195);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828576";
...
"The remote host is missing AIX PTF U828576 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828576"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828576", package:"bos.rte.install.6.1.1.8") < 0 ) 
