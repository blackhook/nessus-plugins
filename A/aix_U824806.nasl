...
if(description)
{
 script_id(38484);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824806";
...
"The remote host is missing AIX PTF U824806 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824806"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824806", package:"devices.scsi.disk.rte.5.3.9.2") < 0 ) 
