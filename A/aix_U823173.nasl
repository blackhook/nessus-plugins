...
if(description)
{
 script_id(44147);
 script_version("1.5");
 name["english"] = "AIX 530010 : U823173";
...
"The remote host is missing AIX PTF U823173 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823173"; 
...
if ( aix_check_patch(ml:"530010", patch:"U823173", package:"bos.acct.5.3.10.1") < 0 ) 
