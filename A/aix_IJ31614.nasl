...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : ksh (IJ31614)");
  script_summary(english:"Check for APAR IJ31614");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"02", patch:"IJ31614s1a", package:"bos.rte.shell", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"03", patch:"IJ31614s1a", package:"bos.rte.shell", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"04", patch:"IJ31614s1a", package:"bos.rte.shell", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.3") < 0) flag++;
