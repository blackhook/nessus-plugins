...
# AlmaLinux Security Advisory ALSA-2023:2357.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2357");
  ...
  script_name(english:"AlmaLinux 9 : git-lfs (ALSA-2023:2357)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2357.html");
...
"Update the affected git-lfs package.");
  ...
  script_cwe_id(1325, 400, 444, 770);
