...
if(description)
{
 script_id(45181);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830066";
...
"The remote host is missing AIX PTF U830066 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830066"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830066", package:"bos.net.nfs.client.5.3.10.3") < 0 ) 
