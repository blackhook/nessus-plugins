...
if (description)
{
  ...
  script_xref(name:"EDB-ID", value:"18855");

  script_name(english:"Asterisk ast_parse_digest Function HTTP Digest Authentication String Parsing Remote Overflow (AST-2012-003)");
...
inject arbitrary code by sending an arbitrarily long string value for
HTTP Digest Authentication.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2012-003.html");
  script_set_attribute(attribute:"see_also", value:"https://issues.asterisk.org/jira/browse/ASTERISK-19542");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Asterisk 1.8.10.1 / 10.2.1 or apply the patches listed in
