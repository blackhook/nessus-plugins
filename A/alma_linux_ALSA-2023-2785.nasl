...
# AlmaLinux Security Advisory ALSA-2023:2785.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2785");

  script_name(english:"AlmaLinux 8 : grafana-pcp (ALSA-2023:2785)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2023-2785.html");
