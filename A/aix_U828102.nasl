...
if(description)
{
 script_id(43929);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828102";
...
"The remote host is missing AIX PTF U828102 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828102"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828102", package:"bos.perf.tools.6.1.4.2") < 0 ) 
