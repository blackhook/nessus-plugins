...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : iostat (IZ22351)");
  script_summary(english:"Check for APAR IZ22351");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ22351_07", package:"bos.acct", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.2") < 0) flag++;
