...
# AlmaLinux Security Advisory ALSA-2020:4469.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:4469");

  script_name(english:"AlmaLinux 8 : cups (ALSA-2020:4469)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-4469.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected cups-libs package.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cups-libs');
}
