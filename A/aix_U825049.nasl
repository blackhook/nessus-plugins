...
if(description)
{
 script_id(39644);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825049";
...
"The remote host is missing AIX PTF U825049 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825049"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825049", package:"bos.64bit.5.3.7.7") < 0 ) 
