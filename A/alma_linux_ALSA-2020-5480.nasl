...
# AlmaLinux Security Advisory ALSA-2020:5480.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:5480");

  script_name(english:"AlmaLinux 8 : net-snmp (ALSA-2020:5480)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-5480.html");
  script_set_attribute(attribute:"solution", value:
"Update the affected net-snmp-libs package.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'net-snmp-libs');
}
