...
if(description)
{
 script_id(39020);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823842";
...
"The remote host is missing AIX PTF U823842 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823842"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823842", package:"bos.rte.bind_cmds.6.1.0.7") < 0 ) 
