...
# AlmaLinux Security Advisory ALSA-2022:0495.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:0495");
  script_xref(name:"IAVA", value:"2022-A-0101");

  script_name(english:"AlmaLinux 8 : .NET 5.0 (ALSA-2022:0495)");

  script_set_attribute(attribute:"synopsis", value:
"The remote AlmaLinux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote AlmaLinux 8 host has packages installed that are affected by a vulnerability as referenced in the
ALSA-2022:0495 advisory.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-0495.html");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:dotnet-sdk-5.0-source-built-artifacts");
