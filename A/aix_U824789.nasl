...
if(description)
{
 script_id(38467);
 script_version("1.5");
 name["english"] = "AIX 530009 : U824789";
...
"The remote host is missing AIX PTF U824789 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824789"; 
...
if ( aix_check_patch(ml:"530009", patch:"U824789", package:"devices.common.IBM.ib.rte.5.3.9.3") < 0 ) 
