...
if(description)
{
 script_id(41892);
 script_version("1.5");
 name["english"] = "AIX 610000 : U828586";
...
"The remote host is missing AIX PTF U828586 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828586"; 
...
if ( aix_check_patch(ml:"610000", patch:"U828586", package:"devices.iscsi_sw.rte.6.1.0.5") < 0 ) 
