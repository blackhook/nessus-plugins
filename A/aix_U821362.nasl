...
if(description)
{
 script_id(35150);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821362";
...
"The remote host is missing AIX PTF U821362 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821362"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821362", package:"devices.common.IBM.sissas.rte.5.3.7.5") < 0 ) 
