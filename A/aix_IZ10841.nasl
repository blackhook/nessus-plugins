...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 0 : pioout (IZ10841)");
  script_summary(english:"Check for APAR IZ10841");
...
command is vulnerable: /usr/lib/lpd/pio/etc/piomkpq."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/pioout_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"5.3", ml:"00", patch:"IZ10841_05", package:"printers.rte", minfilesetver:"5.3.0.0", maxfilesetver:"5.3.0.62") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"00", patch:"IZ10841_06", package:"printers.rte", minfilesetver:"5.3.0.0", maxfilesetver:"5.3.0.62") < 0) flag++;
