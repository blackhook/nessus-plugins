...
if(description)
{
 script_id(39113);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823965";
...
"The remote host is missing AIX PTF U823965 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823965"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823965", package:"devices.iscsi_sw.rte.6.1.1.3") < 0 ) 
