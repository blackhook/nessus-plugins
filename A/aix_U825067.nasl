...
if(description)
{
 script_id(39662);
 script_version("1.5");
 name["english"] = "AIX 530007 : U825067";
...
"The remote host is missing AIX PTF U825067 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825067"; 
...
if ( aix_check_patch(ml:"530007", patch:"U825067", package:"bos.rte.install.5.3.7.10") < 0 ) 
