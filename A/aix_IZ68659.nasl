...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 8 : xntpd (IZ68659)");
  script_summary(english:"Check for APAR IZ68659");
...
if (aix_check_ifix(release:"5.3", ml:"08", patch:"IZ68659_08", package:"bos.net.tcp.client", minfilesetver:"5.3.8.0", maxfilesetver:"5.3.8.11") < 0) flag++;
