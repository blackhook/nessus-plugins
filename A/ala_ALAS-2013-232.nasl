...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-232.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-232");
  script_xref(name:"RHSA", value:"2013:1409");

  script_name(english:"Amazon Linux AMI : xinetd (ALAS-2013-232)");
...
arbitrary code with the privileges of the root user. (CVE-2013-4342)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-232.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Run 'yum update xinetd' to update your system."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:H/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:xinetd");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:amazon:linux:xinetd-debuginfo");
...
flag = 0;
if (rpm_check(release:"ALA", reference:"xinetd-2.3.14-39.9.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"xinetd-debuginfo-2.3.14-39.9.amzn1")) flag++;
