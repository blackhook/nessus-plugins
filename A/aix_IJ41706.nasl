...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 4 : kernel (IJ41706)");
  script_summary(english:"Check for APAR IJ41706");
...
if (aix_check_ifix(release:"7.2", ml:"04", sp:"04", patch:"IJ41706m4a", package:"bos.mp64", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.10") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"05", patch:"IJ41706m5a", package:"bos.mp64", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.10") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"04", sp:"06", patch:"IJ41706s6a", package:"bos.mp64", minfilesetver:"7.2.4.0", maxfilesetver:"7.2.4.10") < 0) flag++;
