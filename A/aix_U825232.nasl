...
if(description)
{
 script_id(39736);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825232";
...
"The remote host is missing AIX PTF U825232 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825232"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825232", package:"devices.pciex.b3154a63.rte.5.3.9.4") < 0 ) 
