...
if (description)
{
  ...
  script_name(english:"Asterisk 13.x < 13.21.1 / 14.x < 14.7.7 / 13.13 < 13.18-cert4 / 13.21 < 13.21-cert2 Information Disclosure Vulnerability (AST-2018-008)");
...
remote host is 13.x prior to 13.21.1, 14.x prior to 14.7.7,
or 13.18 prior to 13.18-cert4. It is therefore, affected by
a remote denial of service attack as
described in AST-2018-008.
...
"Upgrade to Asterisk version 13.21.1 / 14.7.7 / 13.18-cert4 / 13.21-cert2 or later.");
