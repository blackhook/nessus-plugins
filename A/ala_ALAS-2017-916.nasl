...
# extracted from Amazon Linux AMI Security Advisory ALAS-2017-916.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2017-916");

  script_name(english:"Amazon Linux AMI : wget (ALAS-2017-916)");
...
A heap-based buffer overflow, when processing chunked encoded HTTP
responses, was found in wget. By tricking an unsuspecting user into
connecting to a malicious HTTP server, an attacker could exploit this
flaw to potentially execute arbitrary code. (CVE-2017-13090)
...
responses was found in wget. By tricking an unsuspecting user into
connecting to a malicious HTTP server, an attacker could exploit this
flaw to potentially execute arbitrary code. (CVE-2017-13089)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2017-916.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"wget-1.18-3.28.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"wget-debuginfo-1.18-3.28.amzn1")) flag++;
