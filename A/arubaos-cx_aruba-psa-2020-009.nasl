...
if (description)
{
  ...
  script_cve_id("CVE-2020-7121");

  script_name(english:"ArubaOS-CX < 10.04.3031 Memory Corruption (ARUBA-PSA-2020-009)");

  script_set_attribute(attribute:"synopsis", value:
"An application installed on the remote host is affected by a memory corruption vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of ArubaOS-CX installed on the remote host is prior to version 10.04.3031. Two memory corruption
...
"Upgrade to ArubaOS-CX version 10.04.3031, 10.05.0001 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-7121");
...
var constraints = [
  {'max_version' : '10.04.3030', 'fixed_display' : '10.04.3031, 10.05.0001 and above' }
];
