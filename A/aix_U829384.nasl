...
if(description)
{
 script_id(42604);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829384";
...
"The remote host is missing AIX PTF U829384 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829384"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829384", package:"bos.rte.aio.5.3.9.3") < 0 ) 
