...
# from AIX Security PTF U825657. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : devices.common.IBM.atm.rte (U825657)");
  script_summary(english:"Check for PTF U825657");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825657, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48561"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610001", patch:"U825657", package:"devices.common.IBM.atm.rte.6.1.1.1") < 0 ) flag++;
