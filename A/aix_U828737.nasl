...
if(description)
{
 script_id(43495);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828737";
...
"The remote host is missing AIX PTF U828737 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828737"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828737", package:"bos.sysmgt.nim.client.6.1.3.2") < 0 ) 
