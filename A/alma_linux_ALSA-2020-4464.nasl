...
# AlmaLinux Security Advisory ALSA-2020:4464.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2020:4464");

  script_name(english:"AlmaLinux 8 : libxslt (ALSA-2020:4464)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2020-4464.html");
...
var pkgs = [
    {'reference':'libxslt-1.1.32-5.el8', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
