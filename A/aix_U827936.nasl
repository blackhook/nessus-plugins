...
if(description)
{
 script_id(43428);
 script_version("1.5");
 name["english"] = "AIX 610003 : U827936";
...
"The remote host is missing AIX PTF U827936 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U827936"; 
...
if ( aix_check_patch(ml:"610003", patch:"U827936", package:"bos.acct.6.1.3.1") < 0 ) 
