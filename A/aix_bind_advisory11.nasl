...
if (description)
{
  ...
  script_bugtraq_id(81329);

  script_name(english:"AIX bind Advisory : bind_advisory11.asc (IV81278) (IV81279) (IV81280) (IV81281) (IV81282)");
...
a denial of service vulnerability due to improper handling of certain
string formatting options. An authenticated, remote attacker can
exploit this, via a malformed Address Prefix List (APL) record, to
cause an INSIST assertion failure and daemon exit.");
  script_set_attribute(attribute:"see_also", value:"https://aix.software.ibm.com/aix/efixes/security/bind_advisory11.asc");
    ...
    "12": {
      "09": {
        "bos.net.tcp.client": {
          ...
          "patch":"(IV81278m9a|IV85298m9a|IV90056m9a|IV91253m9b|IV93366m9a|IV88957m9a|IV98825m9a)"
        },
        "bos.net.tcp.server": {
          "minfilesetver":"5.3.12.0",
    ...
    "09": {
      ...
      "05": {
        "bos.net.tcp.client": {
          "minfilesetver":"6.1.9.0",
          "maxfilesetver":"6.1.9.101",
          "patch":"(IV81279m5a|IV84456s5b|IV84984m5b|IV89828m5a|IV79071m5a)"
        }
      },
      "06": {
        "bos.net.tcp.client": {
          "minfilesetver":"6.1.9.0",
          "maxfilesetver":"6.1.9.101",
          "patch":"(IV81279s6a|IV84456s6a|IV84984m6a|IV89828m6a|IV91254m6b|IV93361m8a|IV79071m6a)"
        }
      }
    }
  },
    ...
    "03": {
      ...
      "05": {
        "bos.net.tcp.client": {
          ...
          "patch":"(IV81280m5a|IV84457s5a|IV85296m5a|IV89830m5a|IV91214m5b|IV82331m5a)"
        }
      },
      "06": {
        "bos.net.tcp.client": {
          ...
          "patch":"(IV81280m6a|IV84457s6a|IV85296m6a|IV89830m6d|IV91214m6a|IV93362m8a|IV82331m6a)"
        }
      }
    },
    "04": {
      ...
      "01": {
        "bos.net.tcp.client": {
          "minfilesetver":"7.1.4.0",
          "maxfilesetver":"7.1.4.0",
          "patch":"(IV81281m1a|IV84458s1a|IV84947m1a|IV89829m1a|IV91255m1b|IV93363m3a)"
        }
      }
    }
  },
   ...
   "00": {
      "00": {
        "bos.net.tcp.client": {
          ...
          "patch":"(IV81282m0a|IV89831m1a|IV91256m1b)"
        }
      },
      "01": {
        "bos.net.tcp.client": {
          ...
          "patch":"(IV81282m1a|IV84459s1a|IV85297m1a|IV89831m1a|IV91256m1b|IV93403m3a)"
        }
      }
    }
  }
