...
attacker to gain privileged access to the device."
  ...
  # https://dariusfreamon.wordpress.com/2013/12/07/alvarion-breezeaccess-vl-default-credentials/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b651eac1");
