...
if(description)
{
 script_id(35865);
 script_version("1.6");
 name["english"] = "AIX 610000 : U820674";
...
"The remote host is missing AIX PTF U820674 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820674"; 
...
if ( aix_check_patch(ml:"610000", patch:"U820674", package:"bos.acct.6.1.0.8") < 0 ) 
