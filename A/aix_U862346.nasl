...
# from AIX Security PTF U862346. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : X11.base.rte (U862346)");
  script_summary(english:"Check for PTF U862346");
...
request that triggers memory-allocation failure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV52186"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710002", patch:"U862346", package:"X11.base.rte.7.1.2.16") < 0 ) flag++;
