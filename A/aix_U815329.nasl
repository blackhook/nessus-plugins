...
# from AIX Security PTF U815329. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 : printers.rte (U815329)");
  script_summary(english:"Check for PTF U815329");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U815329, which is related to the
...
command is vulnerable: /usr/lib/lpd/pio/etc/piomkpq."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ10844"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610000", patch:"U815329", package:"printers.rte.6.1.0.1") < 0 ) flag++;
