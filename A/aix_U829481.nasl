...
if(description)
{
 script_id(42657);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829481";
...
"The remote host is missing AIX PTF U829481 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829481"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829481", package:"bos.sysmgt.serv_aid.5.3.8.5") < 0 ) 
