...
if(description)
{
 script_id(43536);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828783";
...
"The remote host is missing AIX PTF U828783 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828783"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828783", package:"bos.rte.net.6.1.3.1") < 0 ) 
