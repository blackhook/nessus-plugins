...
if(description)
{
 script_id(34555);
 script_version("1.6");
 name["english"] = "AIX 530006 : U819451";
...
"The remote host is missing AIX PTF U819451 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819451"; 
...
if ( aix_check_patch(ml:"530006", patch:"U819451", package:"bos.acct.5.3.0.67") < 0 ) 
