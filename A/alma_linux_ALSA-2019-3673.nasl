...
# AlmaLinux Security Advisory ALSA-2019:3673.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2019:3673");

  script_name(english:"AlmaLinux 8 : lldpad (ALSA-2019:3673)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2019-3673.html");
...
"Update the affected lldpad package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:lldpad");
