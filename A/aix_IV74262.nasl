...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : ntp (IV74262)");
  script_summary(english:"Check for APAR IV74262");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"06", patch:"IV74262s6a", package:"bos.net.tcp.client", minfilesetver:"7.1.0.0", maxfilesetver:"7.1.2.20") < 0) flag++;
