...
if(description)
{
 script_id(39162);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824081";
...
"The remote host is missing AIX PTF U824081 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824081"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824081", package:"bos.cifs_fs.rte.6.1.2.2") < 0 ) 
