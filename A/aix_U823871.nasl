...
if(description)
{
 script_id(39049);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823871";
...
"The remote host is missing AIX PTF U823871 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823871"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823871", package:"bos.64bit.6.1.0.8") < 0 ) 
