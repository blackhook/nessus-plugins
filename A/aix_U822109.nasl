...
if(description)
{
 script_id(38432);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822109";
...
"The remote host is missing AIX PTF U822109 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822109"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822109", package:"devices.pci.1410bd02.diag.5.3.8.5") < 0 ) 
