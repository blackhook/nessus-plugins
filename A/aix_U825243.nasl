...
if(description)
{
 script_id(42514);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825243";
...
"The remote host is missing AIX PTF U825243 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825243"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825243", package:"bos.perf.tools.5.3.9.5") < 0 ) 
