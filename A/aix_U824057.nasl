...
if(description)
{
 script_id(39138);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824057";
...
"The remote host is missing AIX PTF U824057 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824057"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824057", package:"bos.perf.tools.6.1.2.4") < 0 ) 
