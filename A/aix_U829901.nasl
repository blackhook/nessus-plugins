...
if(description)
{
 script_id(44481);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829901";
...
"The remote host is missing AIX PTF U829901 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829901"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829901", package:"bos.64bit.5.3.11.1") < 0 ) 
