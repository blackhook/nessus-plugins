...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : sendmail (IJ03121)");
  script_summary(english:"Check for APAR IJ03121");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"00", patch:"IJ03121s0a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.15") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"01", patch:"IJ03121s0a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.15") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"02", patch:"IJ03121s0a", package:"bos.net.tcp.client", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.15") < 0) flag++;
