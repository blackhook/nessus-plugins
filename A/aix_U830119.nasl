...
if(description)
{
 script_id(45234);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830119";
...
"The remote host is missing AIX PTF U830119 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830119"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830119", package:"devices.pci.1410bd02.diag.5.3.10.2") < 0 ) 
