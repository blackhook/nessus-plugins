...
if (description)
{
  ...
  script_name(english:"Asterisk main/udptl.c Buffer Overflows (AST-2011-002)");
...
so this finding may be a false positive.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2011-002.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Asterisk 1.4.39.2 / 1.6.1.22 / 1.6.2.16.2 / 1.8.2.4 or
