...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-438.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-438");
  script_xref(name:"RHSA", value:"2014:1388");

  script_name(english:"Amazon Linux AMI : cups (ALAS-2014-438)");
...
CVE-2014-5030 , CVE-2014-5031)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-438.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"cups-1.4.2-67.20.al12")) flag++;
if (rpm_check(release:"ALA", reference:"cups-debuginfo-1.4.2-67.20.al12")) flag++;
if (rpm_check(release:"ALA", reference:"cups-devel-1.4.2-67.20.al12")) flag++;
if (rpm_check(release:"ALA", reference:"cups-libs-1.4.2-67.20.al12")) flag++;
if (rpm_check(release:"ALA", reference:"cups-lpd-1.4.2-67.20.al12")) flag++;
if (rpm_check(release:"ALA", reference:"cups-php-1.4.2-67.20.al12")) flag++;
