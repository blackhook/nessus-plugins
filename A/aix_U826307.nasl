...
if(description)
{
 ...
 script_name(english: "AIX 530008 : U826307");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826307");
...
if ( aix_check_patch(ml:"530008", patch:"U826307", package:"devices.pci.1410c302.rte.5.3.8.0") < 0 ) 
