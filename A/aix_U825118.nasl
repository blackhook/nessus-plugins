...
if(description)
{
 script_id(39680);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825118";
...
"The remote host is missing AIX PTF U825118 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825118"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825118", package:"bos.mp.5.3.8.7") < 0 ) 
