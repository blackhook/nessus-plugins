...
if(description)
{
 script_id(35840);
 script_version("1.6");
 name["english"] = "AIX 610000 : U818430";
...
"The remote host is missing AIX PTF U818430 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U818430"; 
...
if ( aix_check_patch(ml:"610000", patch:"U818430", package:"devices.scsi.disk.rte.6.1.0.4") < 0 ) 
