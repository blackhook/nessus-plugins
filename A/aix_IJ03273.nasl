...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : sendmail (IJ03273)");
  script_summary(english:"Check for APAR IJ03273");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IJ03273s9a", package:"bos.net.tcp.client", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.10") < 0) flag++;
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IJ03273s9a", package:"bos.net.tcp.server", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.6") < 0) flag++;
