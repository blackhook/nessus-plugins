...
# from AIX Security PTF U829609. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : X11.Dt.ToolTalk (U829609)");
  script_summary(english:"Check for PTF U829609");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U829609, which is related to the
...
/usr/dt/lib/libtt.a /usr/dt/bin/rpc.ttdbserver."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ52844"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530007", patch:"U829609", package:"X11.Dt.ToolTalk.5.3.7.1") < 0 ) flag++;
