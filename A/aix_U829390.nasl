...
if(description)
{
 script_id(42610);
 script_version("1.5");
 name["english"] = "AIX 530009 : U829390";
...
"The remote host is missing AIX PTF U829390 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829390"; 
...
if ( aix_check_patch(ml:"530009", patch:"U829390", package:"devices.pciex.b3154a63.rte.5.3.9.5") < 0 ) 
