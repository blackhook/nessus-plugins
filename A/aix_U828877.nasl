...
if(description)
{
 script_id(43270);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828877";
...
"The remote host is missing AIX PTF U828877 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828877"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828877", package:"bos.net.tcp.server.6.1.2.4") < 0 ) 
