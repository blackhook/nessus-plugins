...
if(description)
{
 script_id(38250);
 script_version("1.5");
 name["english"] = "AIX 530009 : U820035";
...
"The remote host is missing AIX PTF U820035 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820035"; 
...
if ( aix_check_patch(ml:"530009", patch:"U820035", package:"bos.rte.filesystem.5.3.9.2") < 0 ) 
