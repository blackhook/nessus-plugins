...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : nettcp (IV82331) (SLOTH) (deprecated)");
  script_summary(english:"Check for APAR IV82331");
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV82331m5a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV82331m5a", package:"bos.net.tcp.server", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV82331m6a", package:"bos.net.tcp.client", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV82331m6a", package:"bos.net.tcp.server", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.47") < 0) flag++;
