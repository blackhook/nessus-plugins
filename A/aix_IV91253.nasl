...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : bind (IV91253) (deprecated)");
  script_summary(english:"Check for APAR IV91253");
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV91253m9b", package:"bos.net.tcp.client", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.10") < 0) flag++;
