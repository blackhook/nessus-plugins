...
if(description)
{
 script_id(39742);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825238";
...
"The remote host is missing AIX PTF U825238 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825238"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825238", package:"bos.net.nfs.adt.5.3.9.2") < 0 ) 
