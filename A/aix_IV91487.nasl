...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : sysproc (IV91487)");
  script_summary(english:"Check for APAR IV91487");
...
if (aix_check_ifix(release:"7.1", ml:"04", sp:"01", patch:"IV91487s1a", package:"bos.mp64", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.30") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"02", patch:"IV91487s2a", package:"bos.mp64", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.30") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"03", patch:"IV91487s3a", package:"bos.mp64", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.30") < 0) flag++;
