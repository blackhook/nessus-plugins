...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 2 : solaris (IJ10130)");
  script_summary(english:"Check for APAR IJ10130");
...
if (aix_check_ifix(release:"7.2", ml:"02", sp:"00", patch:"IJ10130s0a", package:"core", minfilesetver:"7.2.2.0", maxfilesetver:"7.2.2.16") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"02", sp:"01", patch:"IJ10130s0a", package:"core", minfilesetver:"7.2.2.0", maxfilesetver:"7.2.2.16") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"02", sp:"02", patch:"IJ10130s2a", package:"core", minfilesetver:"7.2.2.0", maxfilesetver:"7.2.2.15") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"02", sp:"02", patch:"IJ10130s2b", package:"core", minfilesetver:"7.2.2.16", maxfilesetver:"7.2.2.16") < 0) flag++;
