...
if(description)
{
 script_id(32288);
 script_version("1.6");
 name["english"] = "AIX 520010 : U815077";
...
script_set_attribute(attribute:"plugin_modification_date", value:"2021/01/05");
 ...
 summary["english"] = "Check for PTF U815077"; 
...
if ( aix_check_patch(ml:"520010", patch:"U815077", package:"bos.sysmgt.nim.client.5.2.0.107") < 0 ) 
