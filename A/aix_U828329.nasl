...
if(description)
{
 script_id(41765);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828329";
...
"The remote host is missing AIX PTF U828329 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828329"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828329", package:"devices.pciex.b3154a63.rte.6.1.2.5") < 0 ) 
