...
# AlmaLinux Security Advisory ALSA-2023:2592.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2592");
  script_xref(name:"IAVB", value:"2022-B-0042-S");

  script_name(english:"AlmaLinux 9 : golang-github-cpuguy83-md2man (ALSA-2023:2592)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2592.html");
...
"Update the affected golang-github-cpuguy83-md2man package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:golang-github-cpuguy83-md2man");
