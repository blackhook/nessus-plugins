...
# from AIX Security PTF U854884. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 1 : bos.mp64 (U854884)");
  script_summary(english:"Check for PTF U854884");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U854884, which is related to the
...
but can read files like /etc/rc.wpars under ftp."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV28787"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710001", patch:"U854884", package:"bos.mp64.7.1.1.18") < 0 ) flag++;
