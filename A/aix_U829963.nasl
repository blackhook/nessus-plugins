...
if(description)
{
 script_id(44542);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829963";
...
"The remote host is missing AIX PTF U829963 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829963"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829963", package:"devices.sata.rte.5.3.11.1") < 0 ) 
