...
if(description)
{
 script_id(38390);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822066";
...
"The remote host is missing AIX PTF U822066 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822066"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822066", package:"devices.chrp.base.rte.5.3.8.5") < 0 ) 
