...
# @DEPRECATED@
#
# This plugin has been deprecated. The patch has been superseded, use plugin aix_IV62805.nasl.
#
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : malloc (IV60935)");
  script_summary(english:"Checks for APAR IV60935.");
...
# Deprecated.
exit(0, "This plugin has been deprecated. Use aix_IV62805.nasl (plugin #77263) instead.");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"03", patch:"IV60935s3a", package:"bos.rte.libc", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.15") < 0) flag++;
