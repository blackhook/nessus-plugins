...
if(description)
{
 script_id(35537);
 script_version("1.6");
 name["english"] = "AIX 520010 : U823558";
...
"The remote host is missing AIX PTF U823558 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823558"; 
...
if ( aix_check_patch(ml:"520010", patch:"U823558", package:"bos.rte.install.5.2.0.112") < 0 ) 
