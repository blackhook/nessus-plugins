...
if(description)
{
 script_id(42684);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829511";
...
"The remote host is missing AIX PTF U829511 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829511"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829511", package:"bos.cifs_fs.rte.5.3.8.3") < 0 ) 
