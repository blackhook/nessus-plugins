...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : at (IZ43459)");
  script_summary(english:"Check for APAR IZ43459");
...
if (aix_check_ifix(release:"6.1", ml:"02", patch:"IZ43459_02", package:"bos.rte.cron", minfilesetver:"6.1.2.0", maxfilesetver:"6.1.2.0") < 0) flag++;
