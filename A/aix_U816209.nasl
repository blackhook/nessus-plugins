...
if(description)
{
 script_id(31924);
 script_version("1.7");
 name["english"] = "AIX 610000 : U816209";
...
"The remote host is missing AIX PTF U816209 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U816209"; 
...
if ( aix_check_patch(ml:"610000", patch:"U816209", package:"devices.vdevice.hvterm1.rte.6.1.0.1") < 0 ) 
