...
if(description)
{
 script_id(39192);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825562";
...
"The remote host is missing AIX PTF U825562 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825562"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825562", package:"X11.base.rte.6.1.2.2") < 0 ) 
