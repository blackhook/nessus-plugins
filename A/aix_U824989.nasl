...
if(description)
{
 script_id(38564);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824989";
...
"The remote host is missing AIX PTF U824989 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824989"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824989", package:"bos.rte.install.5.3.7.9") < 0 ) 
