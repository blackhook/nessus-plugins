...
argument. (CVE-2019-11324)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1389.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"python2-pip-9.0.3-1.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"python3-pip-9.0.3-1.amzn2.0.2")) flag++;
