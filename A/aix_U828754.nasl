...
if(description)
{
 script_id(43510);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828754";
...
"The remote host is missing AIX PTF U828754 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828754"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828754", package:"devices.common.IBM.ib.rte.6.1.3.4") < 0 ) 
