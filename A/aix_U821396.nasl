...
if(description)
{
 script_id(38286);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821396";
...
"The remote host is missing AIX PTF U821396 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821396"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821396", package:"bos.acct.5.3.7.7") < 0 ) 
