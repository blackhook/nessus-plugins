...
if(description)
{
 script_id(42482);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825138";
...
"The remote host is missing AIX PTF U825138 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825138"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825138", package:"perfagent.tools.5.3.8.5") < 0 ) 
