...
if(description)
{
 script_id(39168);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824087";
...
"The remote host is missing AIX PTF U824087 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824087"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824087", package:"bos.pmapi.pmsvcs.6.1.2.3") < 0 ) 
