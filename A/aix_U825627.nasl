...
if(description)
{
 script_id(41662);
 script_version("1.5");
 name["english"] = "AIX 610002 : U825627";
...
"The remote host is missing AIX PTF U825627 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825627"; 
...
if ( aix_check_patch(ml:"610002", patch:"U825627", package:"bos.64bit.6.1.2.5") < 0 ) 
