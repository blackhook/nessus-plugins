...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : swcons (IZ18338)");
  script_summary(english:"Check for APAR IZ18338");
...
if (aix_check_ifix(release:"5.3", ml:"07", patch:"IZ18338_07", package:"bos.rte.console", minfilesetver:"5.3.7.0", maxfilesetver:"5.3.7.0") < 0) flag++;
