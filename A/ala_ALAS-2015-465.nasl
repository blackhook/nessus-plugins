...
# extracted from Amazon Linux AMI Security Advisory ALAS-2015-465.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2015-465");
  script_xref(name:"RHSA", value:"2014:1984");

  script_name(english:"Amazon Linux AMI : bind (ALAS-2015-465)");
...
crash. (CVE-2014-8500)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2015-465.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"bind-9.8.2-0.30.rc1.35.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-chroot-9.8.2-0.30.rc1.35.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-debuginfo-9.8.2-0.30.rc1.35.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-devel-9.8.2-0.30.rc1.35.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-libs-9.8.2-0.30.rc1.35.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-sdb-9.8.2-0.30.rc1.35.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-utils-9.8.2-0.30.rc1.35.amzn1")) flag++;
