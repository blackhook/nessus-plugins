...
# from AIX Security PTF U821986. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 6 : bos.rte.cron (U821986)");
  script_summary(english:"Check for PTF U821986");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U821986, which is related to the
...
/usr/bin/at."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ43453"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530006", patch:"U821986", package:"bos.rte.cron.5.3.0.64") < 0 ) flag++;
