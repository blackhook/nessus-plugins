...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : lpd (IJ39876)");
  script_summary(english:"Check for APAR IJ39876");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ39876s3a", package:"bos.rte.printers", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"03", patch:"IJ39876s3a", package:"bos.rte.printers", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.100") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ39876s3a", package:"bos.rte.printers", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"04", patch:"IJ39876s3a", package:"bos.rte.printers", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.100") < 0) flag++;
