...
if(description)
{
 script_id(45278);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830177";
...
"The remote host is missing AIX PTF U830177 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830177"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830177", package:"bos.net.tcp.server.5.3.9.3") < 0 ) 
