...
# from AIX Security PTF U825041. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : devices.common.IBM.atm.rte (U825041)");
  script_summary(english:"Check for PTF U825041");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825041, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48499"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530007", patch:"U825041", package:"devices.common.IBM.atm.rte.5.3.7.3") < 0 ) flag++;
