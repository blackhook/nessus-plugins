...
if(description)
{
 script_id(45242);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830127";
...
"The remote host is missing AIX PTF U830127 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830127"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830127", package:"bos.rte.aio.5.3.10.2") < 0 ) 
