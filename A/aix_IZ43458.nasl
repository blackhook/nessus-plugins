...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 1 : at (IZ43458)");
  script_summary(english:"Check for APAR IZ43458");
...
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ43458_01", package:"bos.rte.cron", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.2") < 0) flag++;
