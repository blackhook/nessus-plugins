...
if(description)
{
 script_id(44513);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829933";
...
"The remote host is missing AIX PTF U829933 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829933"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829933", package:"X11.base.rte.5.3.11.1") < 0 ) 
