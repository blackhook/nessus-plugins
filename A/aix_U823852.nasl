...
if(description)
{
 script_id(39030);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823852";
...
"The remote host is missing AIX PTF U823852 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823852"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823852", package:"bos.acct.6.1.0.9") < 0 ) 
