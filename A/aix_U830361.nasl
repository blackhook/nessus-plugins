...
if(description)
{
 script_id(43987);
 script_version("1.5");
 name["english"] = "AIX 610004 : U830361";
...
"The remote host is missing AIX PTF U830361 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830361"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830361", package:"bos.cifs_fs.rte.6.1.4.1") < 0 ) 
