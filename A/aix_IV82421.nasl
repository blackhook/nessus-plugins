...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : mustendd (IV82421)");
  script_summary(english:"Check for APAR IV82421");
...
adapter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/mustendd_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"7.1", ml:"03", sp:"04", patch:"IV82421s4a", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.46") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"05", patch:"IV82421s5a", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.46") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"03", sp:"06", patch:"IV82421s6a", package:"devices.pciex.e4145616e4140518.rte", minfilesetver:"7.1.3.0", maxfilesetver:"7.1.3.46") < 0) flag++;
