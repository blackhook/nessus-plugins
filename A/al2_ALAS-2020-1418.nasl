...
common/unistr.cpp. (CVE-2020-10531)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1418.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"AL2", reference:"icu-50.2-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"icu-debuginfo-50.2-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libicu-50.2-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libicu-devel-50.2-4.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libicu-doc-50.2-4.amzn2")) flag++;
