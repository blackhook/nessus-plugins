...
# AlmaLinux Security Advisory ALSA-2022:8393.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:8393");

  script_name(english:"AlmaLinux 9 : logrotate (ALSA-2022:8393)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-8393.html");
...
"Update the affected logrotate package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:alma:linux:logrotate");
