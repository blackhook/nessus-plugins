...
if(description)
{
 script_id(44268);
 script_version("1.5");
 name["english"] = "AIX 530010 : U829299";
...
"The remote host is missing AIX PTF U829299 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829299"; 
...
if ( aix_check_patch(ml:"530010", patch:"U829299", package:"devices.pci.77102224.com.5.3.10.2") < 0 ) 
