...
if(description)
{
 ...
 script_name(english: "AIX 530007 : U826305");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826305");
...
if ( aix_check_patch(ml:"530007", patch:"U826305", package:"devices.pciex.7710322577107601.rte.5.3.7.0") < 0 ) 
