...
emulated Android device.");
  script_set_attribute(attribute:"see_also", value:"https://developer.android.com/studio/command-line/adb");
...
emulator software to listen on local interfaces only.");
  ...
  script_set_attribute(attribute:"cpe", value:"cpe:/o:google:android");
