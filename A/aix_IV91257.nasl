...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 1 : bind (IV91257) (deprecated)");
  script_summary(english:"Check for APAR IV91257");
...
if (aix_check_ifix(release:"7.2", ml:"01", sp:"00", patch:"IV91257m0a", package:"core", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"01", sp:"01", patch:"IV91257m1a", package:"core", minfilesetver:"7.2.1.0", maxfilesetver:"7.2.1.0") < 0) flag++;
