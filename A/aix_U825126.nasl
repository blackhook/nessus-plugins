...
if(description)
{
 script_id(39687);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825126";
...
"The remote host is missing AIX PTF U825126 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825126"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825126", package:"devices.pci.14106902.rte.5.3.8.5") < 0 ) 
