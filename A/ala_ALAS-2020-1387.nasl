...
flag = 0;
if (rpm_check(release:"ALA", reference:"telnet-0.17-49.9.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"telnet-debuginfo-0.17-49.9.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"telnet-server-0.17-49.9.amzn1")) flag++;
