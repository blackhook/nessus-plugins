...
# extracted from Amazon Linux AMI Security Advisory ALAS-2019-1257.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2019-1257");

  script_name(english:"Amazon Linux AMI : GraphicsMagick (ALAS-2019-1257)");
...
2018, 343 issues have been opened by oss-fuzz and 331 of those issues
have been resolved. The issues list is available at
https://bugs.chromium.org/p/oss-fuzz/issues/list under search term
'graphicsmagick'"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2019-1257.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"GraphicsMagick-1.3.32-1.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"GraphicsMagick-c++-1.3.32-1.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"GraphicsMagick-c++-devel-1.3.32-1.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"GraphicsMagick-debuginfo-1.3.32-1.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"GraphicsMagick-devel-1.3.32-1.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"GraphicsMagick-doc-1.3.32-1.16.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"GraphicsMagick-perl-1.3.32-1.16.amzn1")) flag++;
