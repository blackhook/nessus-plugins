...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-213.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-213");

  script_name(english:"Amazon Linux AMI : puppet (ALAS-2013-213)");
...
arbitrary code via a crafted REST API call."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-213.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"puppet-2.7.22-1.0.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"puppet-debuginfo-2.7.22-1.0.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"puppet-server-2.7.22-1.0.amzn1")) flag++;
