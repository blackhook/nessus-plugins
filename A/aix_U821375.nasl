...
if(description)
{
 script_id(38265);
 script_version("1.5");
 name["english"] = "AIX 530007 : U821375";
...
"The remote host is missing AIX PTF U821375 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821375"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821375", package:"devices.pci.77102224.com.5.3.7.6") < 0 ) 
