...
# from AIX Security PTF U829619. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : bos.net.tcp.server (U829619)");
  script_summary(english:"Check for PTF U829619");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U829619, which is related to the
...
/usr/sbin/named9."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ56311"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530007", patch:"U829619", package:"bos.net.tcp.server.5.3.7.8") < 0 ) flag++;
