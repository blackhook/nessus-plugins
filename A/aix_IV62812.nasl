...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 12 : malloc (IV62812)");
  script_summary(english:"Check for APAR IV62812");
...
the _LIB_INIT_DBG and _LIB_INIT_DBG_FILE environment variables."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/malloc_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"5.3", ml:"12", sp:"09", patch:"IV62812s9a", package:"bos.rte.libc", minfilesetver:"5.3.12.0", maxfilesetver:"5.3.12.9") < 0) flag++;
