...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-138.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-138");
  script_xref(name:"RHSA", value:"2012:1363");

  script_name(english:"Amazon Linux AMI : bind (ALAS-2012-138)");
...
configurations, to lockup. (CVE-2012-5166)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-138.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"bind-9.8.2-0.10.rc1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-chroot-9.8.2-0.10.rc1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-debuginfo-9.8.2-0.10.rc1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-devel-9.8.2-0.10.rc1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-libs-9.8.2-0.10.rc1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-sdb-9.8.2-0.10.rc1.25.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"bind-utils-9.8.2-0.10.rc1.25.amzn1")) flag++;
