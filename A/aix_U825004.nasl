...
# from AIX Security PTF U825004. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 7 : bos.rte.cron (U825004)");
  script_summary(english:"Check for PTF U825004");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825004, which is related to the
...
/usr/bin/at."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ43454"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530007", patch:"U825004", package:"bos.rte.cron.5.3.7.2") < 0 ) flag++;
