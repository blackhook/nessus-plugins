...
if(description)
{
 script_id(41678);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825734";
...
"The remote host is missing AIX PTF U825734 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825734"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825734", package:"bos.rte.bind_cmds.6.1.1.6") < 0 ) 
