...
if(description)
{
 script_id(45313);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830212";
...
"The remote host is missing AIX PTF U830212 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830212"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830212", package:"bos.sysmgt.serv_aid.5.3.9.4") < 0 ) 
