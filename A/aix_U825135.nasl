...
if(description)
{
 script_id(39696);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825135";
...
"The remote host is missing AIX PTF U825135 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825135"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825135", package:"bos.rte.install.5.3.8.7") < 0 ) 
