...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-188.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-188");

  script_name(english:"Amazon Linux AMI : libxml2 (ALAS-2013-188)");
...
complexity."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-188.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libxml2-2.7.8-10.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-debuginfo-2.7.8-10.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-devel-2.7.8-10.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-python-2.7.8-10.26.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libxml2-static-2.7.8-10.26.amzn1")) flag++;
