...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 6 : inet (IV37925)");
  script_summary(english:"Check for APAR IV37925");
...
if (aix_check_ifix(release:"6.1", ml:"06", sp:"11", patch:"IV37925sBa", package:"bos.net.tcp.client", minfilesetver:"6.1.6.0", maxfilesetver:"6.1.6.22") < 0) flag++;
