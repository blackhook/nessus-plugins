...
if(description)
{
 script_id(39668);
 script_version("1.5");
 name["english"] = "AIX 530008 : U825105";
...
"The remote host is missing AIX PTF U825105 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825105"; 
...
if ( aix_check_patch(ml:"530008", patch:"U825105", package:"bos.perf.tools.5.3.8.6") < 0 ) 
