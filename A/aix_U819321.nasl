...
if(description)
{
 script_id(34523);
 script_version("1.6");
 name["english"] = "AIX 530007 : U819321";
...
"The remote host is missing AIX PTF U819321 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819321"; 
...
if ( aix_check_patch(ml:"530007", patch:"U819321", package:"bos.net.tcp.server.5.3.7.6") < 0 ) 
