...
if (description)
{
  ...
  script_name(english:"Apache >= 2.4.30 < 2.4.49 mod_proxy_uwsgi");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of Apache httpd installed on the remote host greater than 2.4.30 and is prior to 2.4.49. It is, therefore,
affected by a vulnerability as referenced in the 2.4.49 changelog. A carefully crafted request uri-path can cause
mod_proxy_uwsgi to read above the allocated memory and crash (DoS).
...
var constraints = [
  { 'min_version' : '2.4.30', 'fixed_version' : '2.4.49', 'modules':['mod_proxy_uwsgi'] }
];
