...
if(description)
{
 script_id(41721);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828284";
...
"The remote host is missing AIX PTF U828284 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828284"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828284", package:"devices.pciex.8680c71014108003.rte.6.1.2.2") < 0 ) 
