...
if(description)
{
 script_id(34649);
 script_version("1.6");
 name["english"] = "AIX 530006 : U821162";
...
"The remote host is missing AIX PTF U821162 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821162"; 
...
if ( aix_check_patch(ml:"530006", patch:"U821162", package:"devices.pci.1410d002.diag.5.3.0.62") < 0 ) 
