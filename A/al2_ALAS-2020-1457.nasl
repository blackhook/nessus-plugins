...
(CVE-2019-13636)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1457.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"AL2", reference:"patch-2.7.1-12.amzn2.0.2")) flag++;
if (rpm_check(release:"AL2", reference:"patch-debuginfo-2.7.1-12.amzn2.0.2")) flag++;
