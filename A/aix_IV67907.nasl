...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : lvm (IV67907)");
  script_summary(english:"Check for APAR IV67907");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"04", patch:"IV67907s4b", package:"bos.rte.lvm", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.30") < 0) flag++;
