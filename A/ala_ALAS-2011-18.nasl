...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-18.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-18");
  script_xref(name:"RHSA", value:"2011:1422");

  script_name(english:"Amazon Linux AMI : openswan (ALAS-2011-18)");
...
have the cryptographic helpers enabled."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2011-18.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"openswan-2.6.37-2.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openswan-debuginfo-2.6.37-2.15.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openswan-doc-2.6.37-2.15.amzn1")) flag++;
