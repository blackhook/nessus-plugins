...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 11.x < 11.0.8.10.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 11 < 11.0.8.10.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-11-2020-Jul-14 advisory.
...
number.");
  # https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md#july-2020-critical-patch-update-corretto-version-1108101
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3181087");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 11.0.8.10.1 or later");
...
var constraints = [
  { 'min_version' : '11.0', 'fixed_version' : '11.0.8.10.1' }
];
