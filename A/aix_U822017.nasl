...
# from AIX Security PTF U822017. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 6 : devices.common.IBM.atm.rte (U822017)");
  script_summary(english:"Check for PTF U822017");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U822017, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48496"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"530006", patch:"U822017", package:"devices.common.IBM.atm.rte.5.3.0.64") < 0 ) flag++;
