...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : nettcp (IV78624) (SLOTH)");
  script_summary(english:"Check for APAR IV78624");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"05", patch:"IV78624m5a", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.102") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"05", patch:"IV78624m5a", package:"bos.net.tcp.server", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.101") < 0) flag++;
