...
flag = 0;
if (rpm_check(release:"AL2", reference:"libnghttp2-1.41.0-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"libnghttp2-devel-1.41.0-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"nghttp2-1.41.0-1.amzn2")) flag++;
if (rpm_check(release:"AL2", reference:"nghttp2-debuginfo-1.41.0-1.amzn2")) flag++;
