...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-2.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-2");
  script_xref(name:"RHSA", value:"2011:1317");

  script_name(english:"Amazon Linux AMI : cyrus-imapd (ALAS-2011-2)");
