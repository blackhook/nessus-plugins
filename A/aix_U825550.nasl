...
# from AIX Security PTF U825550. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 2 : bos.rte.cron (U825550)");
  script_summary(english:"Check for PTF U825550");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U825550, which is related to the
...
/usr/bin/at."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ43459"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610002", patch:"U825550", package:"bos.rte.cron.6.1.2.1") < 0 ) flag++;
