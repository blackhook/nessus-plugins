...
if(description)
{
 script_id(43965);
 script_version("1.5");
 name["english"] = "AIX 610004 : U828141";
...
"The remote host is missing AIX PTF U828141 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828141"; 
...
if ( aix_check_patch(ml:"610004", patch:"U828141", package:"devices.pci.c1110358.rte.6.1.4.1") < 0 ) 
