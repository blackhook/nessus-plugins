...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 0 : cmsd (IZ62569)");
  script_summary(english:"Check for APAR IZ62569");
...
/usr/dt/bin/rpc.cmsd /usr/dt/lib/libcsa.a."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/cmsd_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"6.1", ml:"00", patch:"IZ62569_00", package:"X11.Dt.rte", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.0.3") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"00", patch:"IZ62569_00", package:"X11.Dt.lib", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.0.2") < 0) flag++;
