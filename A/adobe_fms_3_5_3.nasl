...
vulnerabilities :
  ...
  - A directory traversal vulnerability can lead to FMS
    ...
    (CVE-2009-3792)");
  script_set_attribute(attribute:"see_also", value:"https://www.adobe.com/support/security/bulletins/apsb09-18.html");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Flash Media Server 3.0.5 / 3.5.3 or later.");
