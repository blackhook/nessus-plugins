...
# from AIX Security PTF U860289. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 3 : X11.base.rte (U860289)");
  script_summary(english:"Check for PTF U860289");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U860289, which is related to the
...
request that triggers memory-allocation failure."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IV53246"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"710003", patch:"U860289", package:"X11.base.rte.7.1.3.15") < 0 ) flag++;
