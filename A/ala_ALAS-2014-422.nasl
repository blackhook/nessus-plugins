...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-422.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-422");

  script_name(english:"Amazon Linux AMI : nss-util (ALAS-2014-422)");
...
signature to an application using NSS."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-422.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nss-util-3.16.2-2.4.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-util-debuginfo-3.16.2-2.4.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-util-devel-3.16.2-2.4.amzn1")) flag++;
