...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : kernel (IJ43674)");
  script_summary(english:"Check for APAR IJ43674");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ43674s2b", package:"bos.net.nfs.client", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.3") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ43674s2b", package:"bos.net.nfs.client", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.101") < 0) flag++;
