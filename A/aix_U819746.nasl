...
if(description)
{
 script_id(34918);
 script_version("1.6");
 name["english"] = "AIX 610000 : U819746";
...
"The remote host is missing AIX PTF U819746 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U819746"; 
...
if ( aix_check_patch(ml:"610000", patch:"U819746", package:"devices.pci.1410bd02.diag.6.1.0.4") < 0 ) 
