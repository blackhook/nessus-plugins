...
if (description)
{
  ...
  script_name(english:"AIX 7.2 TL 5 : nimsh (IJ37706)");
  script_summary(english:"Check for APAR IJ37706");
...
if (aix_check_ifix(release:"7.2", ml:"05", sp:"01", patch:"IJ37706m2a", package:"bos.sysmgt.nim.client", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"01", patch:"IJ37706m2a", package:"bos.sysmgt.nim.client", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.100") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ37706m2a", package:"bos.sysmgt.nim.client", minfilesetver:"7.2.5.0", maxfilesetver:"7.2.5.1") < 0) flag++;
if (aix_check_ifix(release:"7.2", ml:"05", sp:"02", patch:"IJ37706m2a", package:"bos.sysmgt.nim.client", minfilesetver:"7.2.5.100", maxfilesetver:"7.2.5.100") < 0) flag++;
