...
if(description)
{
 script_id(41906);
 script_version("1.5");
 name["english"] = "AIX 610000 : U828600";
...
"The remote host is missing AIX PTF U828600 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828600"; 
...
if ( aix_check_patch(ml:"610000", patch:"U828600", package:"bos.64bit.6.1.0.9") < 0 ) 
