...
if (description)
{
  ...
  script_cve_id("CVE-2010-0961");

  script_name(english:"AIX 6.1 TL 1 : qoslist (IZ71869)");
  script_summary(english:"Check for APAR IZ71869");
...
/usr/sbin/qoslist."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://aix.software.ibm.com/aix/efixes/security/qoslist_advisory.asc"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (aix_check_ifix(release:"6.1", ml:"01", patch:"IZ71869_01", package:"bos.net.tcp.server", minfilesetver:"6.1.1.0", maxfilesetver:"6.1.1.7") < 0) flag++;
