...
"The remote web server hosts a repository management application.");
...
ANT.");
  script_set_attribute(attribute:"see_also", value:"http://archiva.apache.org/index.cgi");
...
foreach dir (dirs)
{
  ...
  if (
    (
      ...
      '<a target="_blank" href="http://archiva.apache.org/index.cgi">Apache Archiva' >< res[2]
    ) &&
