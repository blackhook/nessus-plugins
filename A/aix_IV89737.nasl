...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 4 : pconsole (IV89737)");
  script_summary(english:"Check for APAR IV89737");
...
if (aix_check_ifix(release:"7.1", ml:"04", sp:"00", patch:"IV89737s2a", package:"sysmgt.pconsole.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.0") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"01", patch:"IV89737s2a", package:"sysmgt.pconsole.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.0") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"04", sp:"02", patch:"IV89737s2a", package:"sysmgt.pconsole.rte", minfilesetver:"7.1.4.0", maxfilesetver:"7.1.4.0") < 0) flag++;
