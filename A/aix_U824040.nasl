...
if(description)
{
 script_id(39125);
 script_version("1.5");
 name["english"] = "AIX 610002 : U824040";
...
"The remote host is missing AIX PTF U824040 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824040"; 
...
if ( aix_check_patch(ml:"610002", patch:"U824040", package:"bos.rte.install.6.1.2.4") < 0 ) 
