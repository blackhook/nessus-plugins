...
if(description)
{
 script_id(38399);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822075";
...
"The remote host is missing AIX PTF U822075 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822075"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822075", package:"bos.sysmgt.nim.client.5.3.8.3") < 0 ) 
