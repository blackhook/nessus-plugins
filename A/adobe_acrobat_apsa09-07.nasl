...
# adobe_acrobat_apsb10-02.nasl (plugin ID 43875)
...
if (description)
{
  ...
  script_name(english:"Adobe Acrobat Doc.media.newPlayer Use-After-Free Arbitrary Code Execution");
...
a code execution vulnerability."
  ...
  script_set_attribute(
    ...
    value:
"The version of Adobe Acrobat on the remote host allows execution of
...
execution."
  ...
  script_set_attribute(
    attribute:"solution",
    value:
"If Acrobat 9.2 / 8.1.7 is installed, apply the JavaScript blacklist
workaround.  If earlier versions are installed, disable JavaScript
(refer to Adobe's advisory for more information)."
  );
...
)
{
  ...
  keys = make_list(
    'SOFTWARE\\Policies\\Adobe\\Adobe Acrobat\\'+ver[0]+'.0\\FeatureLockDown\\cJavaScriptPerms',
    'SOFTWARE\\Adobe\\Adobe Acrobat\\'+ver[0]+'.0\\JavaScriptPerms'
  );
