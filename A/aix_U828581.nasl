...
if(description)
{
 script_id(43200);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828581";
...
"The remote host is missing AIX PTF U828581 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828581"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828581", package:"bos.sysmgt.nim.client.6.1.1.6") < 0 ) 
