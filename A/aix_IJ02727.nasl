...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : aixbase (IJ02727)");
  script_summary(english:"Check for APAR IJ02727");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"00", patch:"IJ02727s1a", package:"bos.cluster.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.0") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"01", patch:"IJ02727s1a", package:"bos.cluster.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.0") < 0) flag++;
