...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 2 : inet (IV42095)");
  script_summary(english:"Check for APAR IV42095");
...
if (aix_check_ifix(release:"7.1", ml:"02", sp:"02", patch:"IV42095s2a", package:"bos.net.tcp.client", minfilesetver:"7.1.2.0", maxfilesetver:"7.1.2.15") < 0) flag++;
