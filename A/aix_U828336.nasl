...
if(description)
{
 script_id(41772);
 script_version("1.5");
 name["english"] = "AIX 610002 : U828336";
...
"The remote host is missing AIX PTF U828336 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828336"; 
...
if ( aix_check_patch(ml:"610002", patch:"U828336", package:"bos.cifs_fs.rte.6.1.2.3") < 0 ) 
