...
if(description)
{
 script_id(45177);
 script_version("1.4");
 name["english"] = "AIX 530010 : U830062";
...
"The remote host is missing AIX PTF U830062 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830062"; 
...
if ( aix_check_patch(ml:"530010", patch:"U830062", package:"bos.rte.bind_cmds.5.3.10.2") < 0 ) 
