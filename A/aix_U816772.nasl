...
if(description)
{
 script_id(33608);
 script_version("1.6");
 name["english"] = "AIX 530006 : U816772";
...
"The remote host is missing AIX PTF U816772 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U816772"; 
...
if ( aix_check_patch(ml:"530006", patch:"U816772", package:"bos.net.nfs.cachefs.5.3.0.65") < 0 ) 
