...
if(description)
{
 script_id(42539);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825268";
...
"The remote host is missing AIX PTF U825268 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825268"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825268", package:"bos.acct.5.3.9.3") < 0 ) 
