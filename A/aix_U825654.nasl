...
if(description)
{
 script_id(39237);
 script_version("1.5");
 name["english"] = "AIX 610001 : U825654";
...
"The remote host is missing AIX PTF U825654 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825654"; 
...
if ( aix_check_patch(ml:"610001", patch:"U825654", package:"devices.fcp.tape.rte.6.1.1.4") < 0 ) 
