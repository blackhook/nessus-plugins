...
# extracted from Amazon Linux AMI Security Advisory ALAS-2014-423.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2014-423");

  script_name(english:"Amazon Linux AMI : nss-softokn (ALAS-2014-423)");
...
signature to an application using NSS."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2014-423.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"nss-softokn-3.16.2-2.2.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-softokn-debuginfo-3.16.2-2.2.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-softokn-devel-3.16.2-2.2.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-softokn-freebl-3.16.2-2.2.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"nss-softokn-freebl-devel-3.16.2-2.2.amzn1")) flag++;
