...
# extracted from Amazon Linux AMI Security Advisory ALAS-2013-161.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2013-161");
  script_xref(name:"RHSA", value:"2013:0277");

  script_name(english:"Amazon Linux AMI : dnsmasq (ALAS-2013-161)");
...
service via DNS amplification attacks. (CVE-2012-3411)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2013-161.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"dnsmasq-2.48-13.9.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"dnsmasq-debuginfo-2.48-13.9.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"dnsmasq-utils-2.48-13.9.amzn1")) flag++;
