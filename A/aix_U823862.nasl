...
if(description)
{
 script_id(39040);
 script_version("1.5");
 name["english"] = "AIX 610000 : U823862";
...
"The remote host is missing AIX PTF U823862 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823862"; 
...
if ( aix_check_patch(ml:"610000", patch:"U823862", package:"devices.scsi.disk.rte.6.1.0.5") < 0 ) 
