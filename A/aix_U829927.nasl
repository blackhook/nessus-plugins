...
if(description)
{
 script_id(44507);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829927";
...
"The remote host is missing AIX PTF U829927 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829927"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829927", package:"bos.cifs_fs.rte.5.3.11.1") < 0 ) 
