...
if(description)
{
 script_id(44522);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829942";
...
"The remote host is missing AIX PTF U829942 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829942"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829942", package:"bos.rte.serv_aid.5.3.11.1") < 0 ) 
