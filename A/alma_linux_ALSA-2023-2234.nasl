...
# AlmaLinux Security Advisory ALSA-2023:2234.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2023:2234");

  script_name(english:"AlmaLinux 9 : sysstat (ALSA-2023:2234)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2023-2234.html");
...
var pkgs = [
    {'reference':'sysstat-12.5.4-5.el9', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'sysstat-12.5.4-5.el9', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
