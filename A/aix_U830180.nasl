...
if(description)
{
 script_id(45281);
 script_version("1.4");
 name["english"] = "AIX 530009 : U830180";
...
"The remote host is missing AIX PTF U830180 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830180"; 
...
if ( aix_check_patch(ml:"530009", patch:"U830180", package:"bos.alt_disk_install.rte.5.3.9.3") < 0 ) 
