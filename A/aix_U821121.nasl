...
if(description)
{
 script_id(34627);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821121";
...
"The remote host is missing AIX PTF U821121 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821121"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821121", package:"devices.pci.1410d002.diag.5.3.7.1") < 0 ) 
