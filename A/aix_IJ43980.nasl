...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : kernel (IJ43980)");
  script_summary(english:"Check for APAR IJ43980");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ43980sAa", package:"bos.pfcdd.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.34") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"09", patch:"IJ43980sAa", package:"bos.pfcdd.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.34") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"10", patch:"IJ43980sAa", package:"bos.pfcdd.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.34") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"11", patch:"IJ43980sBa", package:"bos.pfcdd.rte", minfilesetver:"7.1.5.0", maxfilesetver:"7.1.5.34") < 0) flag++;
