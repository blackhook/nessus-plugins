...
if(description)
{
 script_id(43480);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828458";
...
"The remote host is missing AIX PTF U828458 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828458"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828458", package:"bos.cifs_fs.rte.6.1.3.1") < 0 ) 
