...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 0 : infiniband (IV43562)");
  script_summary(english:"Check for APAR IV43562");
...
if (aix_check_ifix(release:"7.1", ml:"00", sp:"09", patch:"iv43562m9", package:"devices.common.IBM.ib.rte", minfilesetver:"7.1.0.0", maxfilesetver:"7.1.0.21") < 0) flag++;
