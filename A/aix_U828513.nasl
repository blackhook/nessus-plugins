...
if(description)
{
 script_id(41834);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828513";
...
"The remote host is missing AIX PTF U828513 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828513"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828513", package:"bos.rte.serv_aid.6.1.1.5") < 0 ) 
