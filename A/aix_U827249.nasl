...
# from AIX Security PTF U827249. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 5.2 TL 10 : devices.common.IBM.atm.rte (U827249)");
  script_summary(english:"Check for PTF U827249");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U827249, which is related to the
...
/usr/sbin/muxatmd."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ48495"
  );
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"520010", patch:"U827249", package:"devices.common.IBM.atm.rte.5.2.0.98") < 0 ) flag++;
