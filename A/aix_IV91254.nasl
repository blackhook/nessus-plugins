...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 9 : bind (IV91254) (deprecated)");
  script_summary(english:"Check for APAR IV91254");
...
if (aix_check_ifix(release:"6.1", ml:"09", sp:"06", patch:"IV91254m6b", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.200") < 0) flag++;
if (aix_check_ifix(release:"6.1", ml:"09", sp:"07", patch:"IV91254m7b", package:"bos.net.tcp.client", minfilesetver:"6.1.9.0", maxfilesetver:"6.1.9.200") < 0) flag++;
