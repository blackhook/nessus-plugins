...
(CVE-2020-12762)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/AL2/ALAS-2020-1442.html"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"AL2", reference:"json-c-0.11-4.amzn2.0.4")) flag++;
if (rpm_check(release:"AL2", reference:"json-c-debuginfo-0.11-4.amzn2.0.4")) flag++;
if (rpm_check(release:"AL2", reference:"json-c-devel-0.11-4.amzn2.0.4")) flag++;
if (rpm_check(release:"AL2", reference:"json-c-doc-0.11-4.amzn2.0.4")) flag++;
