...
if(description)
{
 script_id(42551);
 script_version("1.5");
 name["english"] = "AIX 530009 : U825280";
...
"The remote host is missing AIX PTF U825280 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U825280"; 
...
if ( aix_check_patch(ml:"530009", patch:"U825280", package:"bos.rte.filesystem.5.3.9.3") < 0 ) 
