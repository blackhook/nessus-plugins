...
if(description)
{
 script_id(44462);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829882";
...
"The remote host is missing AIX PTF U829882 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829882"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829882", package:"bos.perf.tools.5.3.11.1") < 0 ) 
