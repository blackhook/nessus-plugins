...
# extracted from Amazon Linux AMI Security Advisory ALAS-2011-8.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2011-8");
  script_xref(name:"RHSA", value:"2011:1402");

  script_name(english:"Amazon Linux AMI : freetype (ALAS-2011-8)");
