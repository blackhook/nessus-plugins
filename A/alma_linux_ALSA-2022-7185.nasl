...
# AlmaLinux Security Advisory ALSA-2022:7185.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:7185");

  script_name(english:"AlmaLinux 9 : device-mapper-multipath (ALSA-2022:7185)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/9/ALSA-2022-7185.html");
...
var pkgs = [
    ...
    {'reference':'device-mapper-multipath-devel-0.8.7-7.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'device-mapper-multipath-libs-0.8.7-7.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'kpartx-0.8.7-7.el9_0.1', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
