...
if(description)
{
 script_id(43547);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828797";
...
"The remote host is missing AIX PTF U828797 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828797"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828797", package:"bos.rte.libpthreads.6.1.3.1") < 0 ) 
