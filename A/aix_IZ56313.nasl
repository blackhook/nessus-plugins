...
if (description)
{
  ...
  script_name(english:"AIX 5.3 TL 9 : bind (IZ56313)");
  script_summary(english:"Check for APAR IZ56313");
...
if (aix_check_ifix(release:"5.3", ml:"09", patch:"IZ56313_09", package:"bos.net.tcp.server", minfilesetver:"5.3.9.0", maxfilesetver:"5.3.9.1") < 0) flag++;
