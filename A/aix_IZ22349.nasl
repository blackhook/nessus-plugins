...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 0 : iostat (IZ22349)");
  script_summary(english:"Check for APAR IZ22349");
...
if (aix_check_ifix(release:"6.1", ml:"00", patch:"IZ22349_00", package:"bos.acct", minfilesetver:"6.1.0.0", maxfilesetver:"6.1.0.4") < 0) flag++;
