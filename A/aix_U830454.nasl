...
if(description)
{
 script_id(44580);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830454";
...
"The remote host is missing AIX PTF U830454 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830454"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830454", package:"bos.rte.install.6.1.4.4") < 0 ) 
