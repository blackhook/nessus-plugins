...
if(description)
{
 script_id(34589);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821083";
...
"The remote host is missing AIX PTF U821083 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821083"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821083", package:"devices.iscsi_sw.rte.5.3.7.2") < 0 ) 
