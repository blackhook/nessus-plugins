...
if(description)
{
 script_id(35862);
 script_version("1.6");
 name["english"] = "AIX 610000 : U820671";
...
"The remote host is missing AIX PTF U820671 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U820671"; 
...
if ( aix_check_patch(ml:"610000", patch:"U820671", package:"devices.iscsi_sw.rte.6.1.0.3") < 0 ) 
