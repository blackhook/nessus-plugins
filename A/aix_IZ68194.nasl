...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 4 : qoslist (IZ68194)");
  script_summary(english:"Check for APAR IZ68194");
...
if (aix_check_ifix(release:"6.1", ml:"04", patch:"IZ68194_04", package:"bos.net.tcp.server", minfilesetver:"6.1.4.0", maxfilesetver:"6.1.4.1") < 0) flag++;
