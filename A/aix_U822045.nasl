...
if(description)
{
 script_id(38369);
 script_version("1.5");
 name["english"] = "AIX 530008 : U822045";
...
"The remote host is missing AIX PTF U822045 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U822045"; 
...
if ( aix_check_patch(ml:"530008", patch:"U822045", package:"bos.net.nfs.cachefs.5.3.8.3") < 0 ) 
