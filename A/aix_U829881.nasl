...
if(description)
{
 script_id(44461);
 script_version("1.4");
 name["english"] = "AIX 530011 : U829881";
...
"The remote host is missing AIX PTF U829881 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829881"; 
...
if ( aix_check_patch(ml:"530011", patch:"U829881", package:"bos.rte.filesystem.5.3.11.2") < 0 ) 
