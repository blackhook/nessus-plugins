...
# from AIX Security PTF U833953. The text itself is copyright (C)
...
if (description)
{
  ...
  script_name(english:"AIX 6.1 TL 4 : bos.net.nfs.client (U833953)");
  script_summary(english:"Check for PTF U833953");
  ...
  script_set_attribute(
    ...
    value:
"The remote host is missing AIX PTF U833953, which is related to the
...
"
  ...
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=isg1IZ75369");
  script_set_attribute(
    attribute:"solution", 
...
if ( aix_check_patch(ml:"610004", patch:"U833953", package:"bos.net.nfs.client.6.1.4.5") < 0 ) flag++;
