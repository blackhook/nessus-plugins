...
if (description)
{
  ...
  script_name(english:"AIX 7.1 TL 5 : ksh (IJ31606)");
  script_summary(english:"Check for APAR IJ31606");
...
if (aix_check_ifix(release:"7.1", ml:"05", sp:"06", patch:"IJ31606s6a", package:"bos.rte.shell", minfilesetver:"7.1.5.30", maxfilesetver:"7.1.5.36") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"07", patch:"IJ31606s7a", package:"bos.rte.shell", minfilesetver:"7.1.5.30", maxfilesetver:"7.1.5.36") < 0) flag++;
if (aix_check_ifix(release:"7.1", ml:"05", sp:"08", patch:"IJ31606s7a", package:"bos.rte.shell", minfilesetver:"7.1.5.30", maxfilesetver:"7.1.5.36") < 0) flag++;
