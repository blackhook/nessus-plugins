...
if(description)
{
 script_id(42702);
 script_version("1.5");
 name["english"] = "AIX 530008 : U829529";
...
"The remote host is missing AIX PTF U829529 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U829529"; 
...
if ( aix_check_patch(ml:"530008", patch:"U829529", package:"devices.pciex.b3154a63.rte.5.3.8.7") < 0 ) 
