...
if(description)
{
 script_id(44566);
 script_version("1.4");
 name["english"] = "AIX 610004 : U830439";
...
"The remote host is missing AIX PTF U830439 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U830439"; 
...
if ( aix_check_patch(ml:"610004", patch:"U830439", package:"devices.pciex.b3154a63.rte.6.1.4.2") < 0 ) 
