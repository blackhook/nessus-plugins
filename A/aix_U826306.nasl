...
if(description)
{
 ...
 script_name(english: "AIX 530008 : U826306");
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 script_summary(english: "Check for PTF U826306");
...
if ( aix_check_patch(ml:"530008", patch:"U826306", package:"devices.pci.1410a803.rte.5.3.8.0") < 0 ) 
