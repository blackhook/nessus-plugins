...
if(description)
{
 script_id(43499);
 script_version("1.5");
 name["english"] = "AIX 610003 : U828742";
...
"The remote host is missing AIX PTF U828742 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828742"; 
...
if ( aix_check_patch(ml:"610003", patch:"U828742", package:"bos.perf.tools.6.1.3.2") < 0 ) 
