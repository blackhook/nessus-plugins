...
if(description)
{
 script_id(34609);
 script_version("1.6");
 name["english"] = "AIX 530007 : U821103";
...
"The remote host is missing AIX PTF U821103 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U821103"; 
...
if ( aix_check_patch(ml:"530007", patch:"U821103", package:"bos.rte.aio.5.3.7.2") < 0 ) 
