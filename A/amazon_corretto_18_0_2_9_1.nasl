...
if (description)
{
  ...
  script_name(english:"Amazon Corretto Java 18.x < 18.0.2.9.1 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"Amazon Corretto is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of Amazon Corretto installed on the remote host is prior to 18 < 18.0.2.9.1. It is, therefore, affected by
multiple vulnerabilities as referenced in the corretto-18-2022-Jul-19 advisory.
...
number.");
  # https://github.com/corretto/corretto-18/blob/develop/CHANGELOG.md#corretto-version-180291
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc0a999e");
  script_set_attribute(attribute:"solution", value:
"Update to Amazon Corretto Java 18.0.2.9.1 or later");
...
var constraints = [
  { 'min_version' : '18.0', 'fixed_version' : '18.0.2.9.1' }
];
