...
# extracted from Amazon Linux AMI Security Advisory ALAS-2012-106.
#
...
if (description)
{
  ...
  script_xref(name:"ALAS", value:"2012-106");
  script_xref(name:"RHSA", value:"2012:1054");

  script_name(english:"Amazon Linux AMI : libtiff (ALAS-2012-106)");
...
(CVE-2012-2113)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2012-106.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"libtiff-3.9.4-6.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libtiff-debuginfo-3.9.4-6.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libtiff-devel-3.9.4-6.10.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"libtiff-static-3.9.4-6.10.amzn1")) flag++;
