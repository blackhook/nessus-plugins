...
# AlmaLinux Security Advisory ALSA-2022:0001.
##
...
if (description)
{
  ...
  script_xref(name:"ALSA", value:"2022:0001");

  script_name(english:"AlmaLinux 8 : grafana (ALSA-2022:0001)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.almalinux.org/8/ALSA-2022-0001.html");
