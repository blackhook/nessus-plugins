...
if(description)
{
 script_id(39078);
 script_version("1.5");
 name["english"] = "AIX 610001 : U823930";
...
"The remote host is missing AIX PTF U823930 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U823930"; 
...
if ( aix_check_patch(ml:"610001", patch:"U823930", package:"bos.rte.libpthreads.6.1.1.4") < 0 ) 
