...
if (description)
{
  ...
  script_cve_id("CVE-2012-2415");
  script_bugtraq_id(53210);

  script_name(english:"Asterisk Heap-Based Buffer Overflow in Skinny Channel Driver (AST-2012-005)");
...
that could allow a remote attacker to crash the server, or possibly
inject arbitrary code by sending repeated KEYPAD_BUTTON_MESSAGE events
over a Skinny channel to overflow a buffer.");
  script_set_attribute(attribute:"see_also", value:"http://downloads.asterisk.org/pub/security/AST-2012-005.html");
  script_set_attribute(attribute:"see_also", value:"https://issues.asterisk.org/jira/browse/ASTERISK-19592");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Asterisk 1.6.2.24 / 1.8.11.1 / 10.3.1 or apply the patches
