...
if(description)
{
 script_id(38566);
 script_version("1.5");
 name["english"] = "AIX 530007 : U824991";
...
"The remote host is missing AIX PTF U824991 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U824991"; 
...
if ( aix_check_patch(ml:"530007", patch:"U824991", package:"devices.pci.1410bd02.diag.5.3.7.6") < 0 ) 
