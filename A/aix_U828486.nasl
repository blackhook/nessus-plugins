...
if(description)
{
 script_id(41807);
 script_version("1.5");
 name["english"] = "AIX 610001 : U828486";
...
"The remote host is missing AIX PTF U828486 which is related
...
"Run 'suma -x -a RqType=Security' on the remote system");
 ...
 summary["english"] = "Check for PTF U828486"; 
...
if ( aix_check_patch(ml:"610001", patch:"U828486", package:"bos.perf.tools.6.1.1.6") < 0 ) 
