...
1.0.2t (Affected 1.0.2-1.0.2s). (CVE-2019-1563)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://alas.aws.amazon.com/ALAS-2020-1344.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"ALA", reference:"openssl-1.0.2k-16.151.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-debuginfo-1.0.2k-16.151.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-devel-1.0.2k-16.151.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-perl-1.0.2k-16.151.amzn1")) flag++;
if (rpm_check(release:"ALA", reference:"openssl-static-1.0.2k-16.151.amzn1")) flag++;
