...
to take effect."
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-2724");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-31.8.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-31.8.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-31.8.0-1.el7.centos", allowmaj:TRUE)) flag++;
