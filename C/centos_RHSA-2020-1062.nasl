...
if (description)
{
  ...
  script_name(english:"CentOS 7 : dovecot (CESA-2020:1062)");
...
referenced in the RHSA-2020:1062 advisory.
  ...
  - dovecot: Buffer overflow in indexer-worker process
    results in privilege escalation (CVE-2019-7524)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number."
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-April/012433.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1fa041f"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"dovecot-2.2.36-6.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"dovecot-devel-2.2.36-6.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"dovecot-mysql-2.2.36-6.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"dovecot-pgsql-2.2.36-6.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"dovecot-pigeonhole-2.2.36-6.el7")) flag++;
