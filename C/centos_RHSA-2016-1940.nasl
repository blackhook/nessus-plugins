...
# CentOS Errata and Security Advisory 2016:1940 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : openssl (CESA-2016:1940)");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"openssl-1.0.1e-48.el6_8.3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"openssl-devel-1.0.1e-48.el6_8.3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"openssl-perl-1.0.1e-48.el6_8.3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"openssl-static-1.0.1e-48.el6_8.3")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openssl-1.0.1e-51.el7_2.7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openssl-devel-1.0.1e-51.el7_2.7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openssl-libs-1.0.1e-51.el7_2.7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openssl-perl-1.0.1e-51.el7_2.7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openssl-static-1.0.1e-51.el7_2.7")) flag++;
