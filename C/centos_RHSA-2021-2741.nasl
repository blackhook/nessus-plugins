...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2021:2741)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-July/048343.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f2bff16");
...
pkgs = [
    {'reference':'firefox-78.12.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
