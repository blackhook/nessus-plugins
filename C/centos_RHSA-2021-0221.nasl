...
if (description)
{
  ...
  script_name(english:"CentOS 7 : sudo (CESA-2021:0221)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:0221 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4f678dbc");
...
pkgs = [
    {'reference':'sudo-1.8.23-10.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'sudo-devel-1.8.23-10.el7_9.1', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'sudo-devel-1.8.23-10.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
