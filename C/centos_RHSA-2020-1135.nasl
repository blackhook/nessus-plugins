...
if (description)
{
  ...
  script_name(english:"CentOS 7 : polkit (CESA-2020:1135)");
...
the RHSA-2020:1135 advisory.
  ...
  - polkit: Improper authorization in
    ...
    function in polkitd (CVE-2018-1116)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number."
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-April/012566.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83f3f8a5"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-0.112-26.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-devel-0.112-26.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"polkit-docs-0.112-26.el7")) flag++;
