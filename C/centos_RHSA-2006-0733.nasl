...
which contain Firefox version 1.5.0.8 that corrects these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-November/013378.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?107f7f75"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-November/013381.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e50a638"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-November/013382.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1964c11c"
  );
  script_set_attribute(
    attribute:"solution", 
