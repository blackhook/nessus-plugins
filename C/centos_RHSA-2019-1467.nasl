...
# CentOS Errata and Security Advisory 2019:1467 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : python (CESA-2019:1467)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-June/023334.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e733beab"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"python-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"python-devel-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"python-libs-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"python-test-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"python-tools-2.6.6-68.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tkinter-2.6.6-68.el6_10")) flag++;
