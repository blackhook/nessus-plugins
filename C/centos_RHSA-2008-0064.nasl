...
which contain a backported patch to resolve this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2008-January/014622.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ffb00c5e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2008-January/014623.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74a02e63"
  );
  script_set_attribute(
    attribute:"solution", 
