...
# CentOS Errata and Security Advisory 2010:0339 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : java-1.6.0-openjdk (CESA-2010:0339)");
...
OpenJDK Java must be restarted for the update to take effect.");
  # https://lists.centos.org/pipermail/centos-announce/2010-June/016727.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b786cefe");
  # https://lists.centos.org/pipermail/centos-announce/2010-June/016728.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?98064f08");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-1.6.0.0-1.11.b16.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-demo-1.6.0.0-1.11.b16.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-devel-1.6.0.0-1.11.b16.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-javadoc-1.6.0.0-1.11.b16.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-src-1.6.0.0-1.11.b16.el5")) flag++;
