...
# CentOS Errata and Security Advisory 2009:0002 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 / 5 : thunderbird (CESA-2009:0002)");
...
restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-January/015524.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a1154459"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-January/015525.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?658cb404"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-January/015558.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2bea0f55"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-January/015559.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d1398f30"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"thunderbird-1.5.0.12-18.el4.centos")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"thunderbird-1.5.0.12-18.el4.centos")) flag++;

if (rpm_check(release:"CentOS-5", reference:"thunderbird-2.0.0.19-1.el5.centos")) flag++;
