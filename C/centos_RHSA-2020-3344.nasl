...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2020:3344)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-August/035797.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6600b5d4");
...
pkgs = [
    {'reference':'thunderbird-68.11.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
