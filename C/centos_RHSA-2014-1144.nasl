...
take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-September/020532.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c569605f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-September/020533.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b4e105cf"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-September/020535.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?13f15304"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-September/020538.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a6a19e60"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-24.8.0-2.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-24.8.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-24.8.0-1.el7.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"xulrunner-24.8.0-1.el7.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"xulrunner-devel-24.8.0-1.el7.centos", allowmaj:TRUE)) flag++;
