...
# CentOS Errata and Security Advisory 2018:0262 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : thunderbird (CESA-2018:0262)");
...
Nils, and Xisigr as the original reporters."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-February/022761.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4ca9326f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2018-February/022762.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?27a06129"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-52.6.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-52.6.0-1.el7.centos", allowmaj:TRUE)) flag++;
