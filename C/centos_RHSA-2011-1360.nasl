...
server instances must be restarted for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2011-November/018161.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b59d1fce"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-November/018162.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d72bc013"
  );
  script_set_attribute(
    attribute:"solution", 
