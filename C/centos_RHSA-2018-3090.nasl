...
# CentOS Errata and Security Advisory 2018:3090 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ovmf (CESA-2018:3090)");
...
Enterprise Linux 7.6 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-November/005597.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c3700fef"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"OVMF-20180508-3.gitee3198e672e2.el7")) flag++;
