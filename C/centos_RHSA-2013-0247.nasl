...
# CentOS Errata and Security Advisory 2013:0247 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 / 6 : java-1.7.0-openjdk (CESA-2013:0247)");
...
OpenJDK Java must be restarted for the update to take effect.");
  # https://lists.centos.org/pipermail/centos-announce/2013-February/019232.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2606f032");
  # https://lists.centos.org/pipermail/centos-announce/2013-February/019234.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?281ce88f");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-1.7.0.9-2.3.5.3.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-demo-1.7.0.9-2.3.5.3.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-devel-1.7.0.9-2.3.5.3.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-javadoc-1.7.0.9-2.3.5.3.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-src-1.7.0.9-2.3.5.3.el5_9")) flag++;

if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-1.7.0.9-2.3.5.3.el6_3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-demo-1.7.0.9-2.3.5.3.el6_3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-devel-1.7.0.9-2.3.5.3.el6_3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.9-2.3.5.3.el6_3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-src-1.7.0.9-2.3.5.3.el6_3")) flag++;
