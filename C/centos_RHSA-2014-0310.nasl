...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-24.4.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-24.4.0-1.el6.centos", allowmaj:TRUE)) flag++;
