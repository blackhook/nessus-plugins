...
if (description)
{
  ...
  script_name(english:"CylancePROTECT 2.0.x < 2.0.1480 SSL Validation (Cy2008-002)");
  script_summary(english:"Checks the version CyProtect.exe.");

  script_set_attribute(attribute:"synopsis", value:
"The version of CylancePROTECT installed on the remote host is
affected by an SSL validation vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of CylancePROTECT installed on the remote host is a
version 2.0.x prior to 2.0.1480. It is, therefore, affected by an SSL
...
"Upgrade to CylancePROTECT version 2.0.1480 or later.");
  ...
  script_dependencies("cylance_protect_installed.nbin");
  script_require_keys("SMB/Registry/Enumerated", "installed_sw/CylancePROTECT");
...
app_info = vcf::get_app_info(app:"CylancePROTECT", win_local:TRUE);
