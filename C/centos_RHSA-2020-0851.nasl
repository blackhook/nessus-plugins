...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-virtualenv (CESA-2020:0851)");
...
number."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea942c49"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"python-virtualenv-15.1.0-4.el7_7")) flag++;
