...
# CentOS Errata and Security Advisory 2015:2596 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libpng (CESA-2015:2596)");
...
which contain a backported patch to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2015-December/002746.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?61a7b85f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libpng-1.5.13-7.el7_2")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libpng-devel-1.5.13-7.el7_2")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libpng-static-1.5.13-7.el7_2")) flag++;
