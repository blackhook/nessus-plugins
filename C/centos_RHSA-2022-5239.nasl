...
if (description)
{
  ...
  script_name(english:"CentOS 7 : 389-ds-base (CESA-2022:5239)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2022:5239 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-August/073609.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3d4e6e9e");
