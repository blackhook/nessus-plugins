...
to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-October/019998.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ddc6edb8"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-October/019999.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?173f0ec9"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-5590");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-17.0.10-1.el5.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-17.0.10-1.el5_10", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-devel-17.0.10-1.el5_10", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-17.0.10-1.el6.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-17.0.10-1.el6.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-devel-17.0.10-1.el6.centos", allowmaj:TRUE)) flag++;
