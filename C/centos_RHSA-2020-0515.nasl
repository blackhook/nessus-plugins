...
if (description)
{
  ...
  script_name(english:"CentOS 6 : ksh (CESA-2020:0515)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-February/035640.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fa0d78b7"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"ksh-20120801-38.el6_10")) flag++;
