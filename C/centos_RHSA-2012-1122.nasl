...
# extracted from Red Hat Security Advisory RHSA-2012:1122 and 
# CentOS Errata and Security Advisory 2012:1122 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : bind97 (CESA-2012:1122)");
...
(named) will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-July/018770.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?867653ff"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"bind97-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-chroot-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-devel-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-libs-9.7.0-10.P2.el5_8.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-utils-9.7.0-10.P2.el5_8.2")) flag++;
