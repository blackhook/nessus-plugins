...
# Red Hat Security Advisory RHSA-2022:1939. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : squid:4 (CESA-2022:1939)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:1939 advisory.
...
var pkgs = [
    ...
    {'reference':'squid-4.15-3.module_el8.6.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-4.15-3.module_el8.6.0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
