...
restarted (log out, then log back in) for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-October/018965.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fca58441"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-4513");
