...
# CentOS Errata and Security Advisory 2019:4024 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : SDL (CESA-2019:4024)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-December/023538.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e9d555d"
  );
  # https://lists.centos.org/pipermail/centos-announce/2019-December/035576.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eed0e001"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"SDL-1.2.15-15.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"SDL-devel-1.2.15-15.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"SDL-static-1.2.15-15.el7_7")) flag++;
