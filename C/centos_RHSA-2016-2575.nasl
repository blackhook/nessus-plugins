...
# CentOS Errata and Security Advisory 2016:2575 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : curl (CESA-2016:2575)");
...
Enterprise Linux 7.3 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2016-November/003582.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?65313fae"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"curl-7.29.0-35.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libcurl-7.29.0-35.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libcurl-devel-7.29.0-35.el7.centos")) flag++;
