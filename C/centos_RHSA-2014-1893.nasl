...
# CentOS Errata and Security Advisory 2014:1893 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : libXfont (CESA-2014:1893)");
...
server instances must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-November/020782.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2caeca3f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"libXfont-1.2.2-1.0.6.el5_11")) flag++;
if (rpm_check(release:"CentOS-5", reference:"libXfont-devel-1.2.2-1.0.6.el5_11")) flag++;
