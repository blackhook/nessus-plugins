...
# CentOS Errata and Security Advisory 2018:2001 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : qemu-kvm (CESA-2018:2001) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-July/022957.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?aee7b5c7"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-img-1.5.3-156.el7_5.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-156.el7_5.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-156.el7_5.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-156.el7_5.3")) flag++;
