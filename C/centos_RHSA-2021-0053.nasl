...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2021:0053)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0896f7d6");
...
pkgs = [
    {'reference':'firefox-78.6.1-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'allowmaj':TRUE},
    {'reference':'firefox-78.6.1-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
