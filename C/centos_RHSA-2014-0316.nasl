...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-March/020218.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?785000cc"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-March/020219.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c9bbcf71"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-1493");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-24.4.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-24.4.0-1.el6.centos", allowmaj:TRUE)) flag++;
