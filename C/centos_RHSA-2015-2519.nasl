...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2015-November/021509.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fa7a23c1"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-November/021510.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ac8bfe4e"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2015-December/002724.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f04eed7d"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-4513");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-38.4.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-38.4.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-38.4.0-1.el7.centos", allowmaj:TRUE)) flag++;
