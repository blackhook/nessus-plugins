...
# CentOS Errata and Security Advisory 2018:2180 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : gnupg2 (CESA-2018:2180)");
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?52ac46cd"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"gnupg2-2.0.14-9.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"gnupg2-smime-2.0.14-9.el6_10")) flag++;
