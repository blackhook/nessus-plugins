...
# CentOS Errata and Security Advisory 2017:1364 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : nss (CESA-2017:1364)");
...
updated CA list on June 12, 2017. (BZ# 1448488)"
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-May/022449.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3ff0e706"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"nss-3.28.4-3.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"nss-devel-3.28.4-3.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"nss-pkcs11-devel-3.28.4-3.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"nss-sysinit-3.28.4-3.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"nss-tools-3.28.4-3.el6_9")) flag++;
