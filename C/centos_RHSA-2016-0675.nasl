...
# CentOS Errata and Security Advisory 2016:0675 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : java-1.7.0-openjdk (CESA-2016:0675)");
...
website.");
  # https://lists.centos.org/pipermail/centos-announce/2016-April/021837.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9a63c6a8");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-1.7.0.101-2.6.6.1.el6_7")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-demo-1.7.0.101-2.6.6.1.el6_7")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-devel-1.7.0.101-2.6.6.1.el6_7")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.101-2.6.6.1.el6_7")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-src-1.7.0.101-2.6.6.1.el6_7")) flag++;
