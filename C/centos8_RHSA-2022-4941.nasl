...
# Red Hat Security Advisory RHSA-2022:4941. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : subversion:1.14 (CESA-2022:4941)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:4941 advisory.
...
var appstreams = {
    'subversion:1.14': [
      {'reference':'libserf-1.3.9-9.module_el8.4.0+632+d2bf8782', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libserf-1.3.9-9.module_el8.4.0+632+d2bf8782', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'utf8proc-2.1.1-5.module_el8.4.0+632+d2bf8782', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'utf8proc-2.1.1-5.module_el8.4.0+632+d2bf8782', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
