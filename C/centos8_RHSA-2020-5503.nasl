...
# Red Hat Security Advisory RHSA-2020:5503. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : mariadb-connector-c (CESA-2020:5503)");
...
"Update the affected mariadb-connector-c, mariadb-connector-c-config and / or mariadb-connector-c-devel packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:mariadb-connector-c");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:mariadb-connector-c-config");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:mariadb-connector-c-devel");
