...
# CentOS Errata and Security Advisory 2018:3406 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : python-paramiko (CESA-2018:3406)");
...
listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-November/023076.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?def6f457"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"python-paramiko-1.7.5-5.el6_10")) flag++;
