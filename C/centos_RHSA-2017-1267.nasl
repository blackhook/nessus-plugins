...
# CentOS Errata and Security Advisory 2017:1267 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : rpcbind (CESA-2017:1267)");
...
terminated by the OOM killer. (CVE-2017-8779)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e86cfc2a"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"rpcbind-0.2.0-13.el6_9")) flag++;
