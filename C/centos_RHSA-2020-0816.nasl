...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2020:0816)");
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035686.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a1b8c49c"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-68.6.0-1.el6.centos", allowmaj:TRUE)) flag++;
