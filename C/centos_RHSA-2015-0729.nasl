...
# CentOS Errata and Security Advisory 2015:0729 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 / 6 / 7 : setroubleshoot (CESA-2015:0729)");
...
packages, which contain a backported patch to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2015-April/021037.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f0ea378d"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-March/020998.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80591a29"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-March/020999.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f02e3633"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"setroubleshoot-2.0.5-7.el5_11")) flag++;
if (rpm_check(release:"CentOS-5", reference:"setroubleshoot-server-2.0.5-7.el5_11")) flag++;

if (rpm_check(release:"CentOS-6", reference:"setroubleshoot-3.0.47-6.el6_6.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"setroubleshoot-doc-3.0.47-6.el6_6.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"setroubleshoot-server-3.0.47-6.el6_6.1")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"setroubleshoot-3.2.17-4.1.el7_1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"setroubleshoot-server-3.2.17-4.1.el7_1")) flag++;
