...
# CentOS Errata and Security Advisory 2009:0410 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 3 : krb5 (CESA-2009:0410)");
...
effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-April/015726.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3d67f2f4"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-April/015730.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?13674709"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-April/015731.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2813614e"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-3", reference:"krb5-devel-1.2.7-70")) flag++;
if (rpm_check(release:"CentOS-3", reference:"krb5-libs-1.2.7-70")) flag++;
if (rpm_check(release:"CentOS-3", reference:"krb5-server-1.2.7-70")) flag++;
if (rpm_check(release:"CentOS-3", reference:"krb5-workstation-1.2.7-70")) flag++;
