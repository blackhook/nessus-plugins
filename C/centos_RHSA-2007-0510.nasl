...
packages, which contain a backported patch which resolves this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-June/013986.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?78173b60"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-June/013987.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6ff50aeb"
  );
  script_set_attribute(
    attribute:"solution", 
