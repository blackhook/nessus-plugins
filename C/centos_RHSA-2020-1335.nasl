...
if (description)
{
  ...
  script_name(english:"CentOS 6 : telnet (CESA-2020:1335)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-April/035694.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fd0e8602");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"telnet-0.17-49.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"telnet-server-0.17-49.el6_10")) flag++;
