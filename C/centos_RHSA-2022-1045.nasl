...
if (description)
{
  ...
  script_name(english:"CentOS 7 : httpd (CESA-2022:1045)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:1045 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?031d98cd");
...
var pkgs = [
    ...
    {'reference':'httpd-manual-2.4.6-97.el7.centos.5', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'mod_proxy_html-2.4.6-97.el7.centos.5', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_session-2.4.6-97.el7.centos.5', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'mod_ssl-2.4.6-97.el7.centos.5', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
