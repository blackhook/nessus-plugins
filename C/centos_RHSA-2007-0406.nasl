...
packages, which contain a backported fix to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-June/013927.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea51933e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-June/013928.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?12ca13f3"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-June/013961.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?85ae4e62"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-June/013962.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?868df450"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-June/014016.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?080fe44e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-June/014017.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?119d763c"
  );
  script_set_attribute(
    attribute:"solution", 
