...
if (description)
{
  ...
  script_name(english:"CentOS 7 : xterm (CESA-2021:0617)");
...
CESA-2021:0617 advisory.

  - xterm: crash when processing combining characters (CVE-2021-27135)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-April/048315.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3c94667d");
...
pkgs = [
    {'reference':'xterm-295-3.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
