...
# CentOS Errata and Security Advisory 2010:0398 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : kernel (CESA-2010:0398)");
...
rebooted for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016683.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?98a1ae7e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016684.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4ec32941"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"kernel-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", cpu:"i386", reference:"kernel-PAE-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", cpu:"i386", reference:"kernel-PAE-devel-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"kernel-debug-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"kernel-debug-devel-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"kernel-devel-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"kernel-doc-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"kernel-headers-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"kernel-xen-2.6.18-194.3.1.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"kernel-xen-devel-2.6.18-194.3.1.el5")) flag++;
