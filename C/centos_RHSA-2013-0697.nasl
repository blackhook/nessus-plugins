...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-April/019675.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c3afcef8"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-April/019678.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea58f257"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-17.0.5-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-17.0.5-1.el6.centos", allowmaj:TRUE)) flag++;
