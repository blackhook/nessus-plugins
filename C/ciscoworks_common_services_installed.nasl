...
installed on the remote Windows host.");
  script_set_attribute(attribute:"see_also", value:"https://www.cisco.com/c/en/us/obsolete/cloud-systems-management/ciscoworks-common-services-software.html");
...
register_install(
  app_name:app,
  vendor : 'Cisco',
  product : 'CiscoWorks Common Services',
  path:path,
  version:version,
