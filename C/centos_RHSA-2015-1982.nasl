...
take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2015-November/021467.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e740ea16"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-November/021471.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f1a38801"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-November/021474.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fc3ee24d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-38.4.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-38.4.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-38.4.0-1.el7.centos", allowmaj:TRUE)) flag++;
