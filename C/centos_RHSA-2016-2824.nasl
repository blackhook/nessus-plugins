...
Red Hat would like to thank Gustavo Grieco for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2016-November/022162.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?81f339af"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2016-November/003690.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4b0c39a6"
  );
  script_set_attribute(
    attribute:"solution", 
