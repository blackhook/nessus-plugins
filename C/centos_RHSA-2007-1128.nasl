...
Red Hat would like to thank Josh Lange for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-December/014507.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?66c19c38"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-December/014508.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1482a191"
  );
  script_set_attribute(
    attribute:"solution", 
