...
if (description)
{
  ...
  script_name(english:"CentOS 7 : dnsmasq (CESA-2020:3878)");
...
CESA-2020:3878 advisory.

  - dnsmasq: memory leak in the create_helper() function in /src/helper.c (CVE-2019-14834)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-October/012682.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d7b07c10");
...
pkgs = [
    {'reference':'dnsmasq-2.76-16.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'dnsmasq-utils-2.76-16.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
