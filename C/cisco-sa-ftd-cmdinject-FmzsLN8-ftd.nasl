...
if (description)
{
  ...
  script_cve_id("CVE-2021-34752");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvy16573");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvy19225");
  script_xref(name:"CISCO-SA", value:"cisco-sa-ftd-cmdinject-FmzsLN8");
  script_xref(name:"IAVA", value:"2021-A-0508-S");

  script_name(english:"Cisco Firepower Threat Defense Software Command Injection (cisco-sa-ftd-cmdinject-FmzsLN8)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"A vulnerability in the CLI of Cisco FTD Software could allow an authenticated, local attacker with administrative 
privileges to execute arbitrary commands with root privileges on the underlying operating system of an affected device.

This vulnerability is due to insufficient validation of user-supplied command arguments. An attacker could exploit this
 vulnerability by submitting crafted input to the affected commands
...
version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvy16573");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvy19225");
...
"Upgrade to the relevant fixed version referenced in Cisco bug IDs CSCvy16573, CSCvy19225");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-34752");
