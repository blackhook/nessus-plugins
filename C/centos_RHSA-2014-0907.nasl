...
OpenJDK Java must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-July/020422.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d5857578"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-July/020423.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4a2f4597"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-July/020426.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8a1a2d14"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-2490");
