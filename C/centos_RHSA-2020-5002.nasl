...
if (description)
{
  ...
  script_name(english:"CentOS 7 : curl (CESA-2020:5002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2020:5002 advisory.

  - curl: Incorrect argument check can allow remote servers to overwrite local files (CVE-2020-8177)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-November/035840.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?143f17d2");
...
pkgs = [
    {'reference':'curl-7.29.0-59.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'libcurl-7.29.0-59.el7_9.1', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libcurl-7.29.0-59.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'libcurl-devel-7.29.0-59.el7_9.1', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libcurl-devel-7.29.0-59.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
