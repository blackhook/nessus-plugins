...
# CentOS Errata and Security Advisory 2006:0727-1 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 3 / 4 : texinfo (CESA-2006:0727-1)");
...
contain backported patches and are not vulnerable to these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-November/013358.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f2c3702"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-November/013359.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0c90f54e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-3", cpu:"ia64", reference:"info-4.5-3.el3.1")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"ia64", reference:"texinfo-4.5-3.el3.1")) flag++;

if (rpm_check(release:"CentOS-4", cpu:"ia64", reference:"info-4.7-5.el4.2")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"ia64", reference:"texinfo-4.7-5.el4.2")) flag++;
