...
(named) will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-October/018934.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c05c642e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2012-October/018938.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?91c638b9"
  );
