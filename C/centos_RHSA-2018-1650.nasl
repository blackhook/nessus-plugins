...
# CentOS Errata and Security Advisory 2018:1650 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : java-1.8.0-openjdk (CESA-2018:1650) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022833.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1f66f58f"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-debug-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-demo-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-demo-debug-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-devel-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-devel-debug-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-headless-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-headless-debug-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-javadoc-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-javadoc-debug-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-src-1.8.0.171-8.b10.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.8.0-openjdk-src-debug-1.8.0.171-8.b10.el6_9")) flag++;
