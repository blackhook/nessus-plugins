...
affected by the following vulnerabilities :
  ...
  script_set_attribute(attribute:"see_also", value:"https://github.com/Cisco-Talos/clamav-devel/blob/0.97/ChangeLog");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.clamav.net/show_bug.cgi?id=6808");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.clamav.net/show_bug.cgi?id=7053");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.clamav.net/show_bug.cgi?id=7055");
  script_set_attribute(attribute:"solution", value:
"Upgrade to ClamAV 0.97.8 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-2020");
