...
if(description)
{
 ...
 script_name(english:"Cisco IOS System Timers Remote Overflow (CSCei61732)");
...
vulnerable to a heap overflow attack. 

An attacker may exploit this flaw to crash the remote device or to 
execute arbitrary code remotely." );
 script_set_attribute(attribute:"solution", value:
"http://www.nessus.org/u?c22defc9" );
 script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C");
 script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
 script_set_attribute(attribute:"exploitability_ease", value:"No known exploits are available");
 script_set_attribute(attribute:"exploit_available", value:"false");
 script_set_attribute(attribute:"plugin_publication_date", value: "2005/11/03");
...
if ( "SEB" >< version &&
     check_release(version:version, 
		   ...
		   newest:"12.2(25)SEB4") ) vuln ++;

if ( "SEC" >< version &&
     check_release(version:version, 
		   patched:make_list("12.2(25)SEC2"),
		   newest:"12.2(25)SEC2") ) vuln ++;

if ( "SED" >< version &&
     check_release(version:version, 
		   patched:make_list("12.2(25)SED"),
