...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2021:0656)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5b3bf5ca");
...
pkgs = [
    {'reference':'firefox-78.8.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
