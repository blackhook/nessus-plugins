...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libX11 (CESA-2020:4908)");
...
CESA-2020:4908 advisory.

  - libX11: integer overflow leads to double free in locale handling (CVE-2020-14363)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-November/012875.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dcdafe94");
...
pkgs = [
    {'reference':'libX11-1.6.7-3.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libX11-1.6.7-3.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'libX11-common-1.6.7-3.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'libX11-devel-1.6.7-3.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libX11-devel-1.6.7-3.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
