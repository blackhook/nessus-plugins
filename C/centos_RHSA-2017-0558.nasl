...
Micro's Zero Day Initiative as the original reporters."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-March/022344.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d473d92d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-52.0-5.el7.centos", allowmaj:TRUE)) flag++;
