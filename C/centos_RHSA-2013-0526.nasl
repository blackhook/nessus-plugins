...
which corrects this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019283.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?564714d4"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2013-February/000474.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6614b578"
  );
  script_set_attribute(
    attribute:"solution", 
