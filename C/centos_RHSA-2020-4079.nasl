...
if (description)
{
  ...
  script_name(english:"CentOS 7 : qemu-kvm (CESA-2020:4079)");
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-November/012881.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0e7177f9");
...
pkgs = [
    {'reference':'qemu-img-1.5.3-175.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qemu-kvm-1.5.3-175.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qemu-kvm-common-1.5.3-175.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qemu-kvm-tools-1.5.3-175.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
