...
if (description)
{
  ...
  script_name(english:"CentOS 6 : python-twisted-web (CESA-2020:1962)");
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-April/035711.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a0249ae3"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"python-twisted-web-8.2.0-6.el6_10")) flag++;
