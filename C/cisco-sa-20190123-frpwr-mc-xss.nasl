...
code in a user's browser session.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?43abc8b2");
...
if (report_paranoia == 2)
  collib::push({'equal': '6.3.0', 'fixed_display': 'See vendor advisory'}, list:constraints);
