...
which contains backported patches that resolve these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2005-August/012006.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?61e1fc1a"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-August/012007.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c9eaa046"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-August/012012.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bff7f1e2"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-August/012013.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f5609162"
  );
  script_set_attribute(
    attribute:"solution", 
