...
following denial of service vulnerabilities :
  ...
  - A flaw exists in the 9.0 branch due to the lack of
    ...
    CSCub28920)");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20130227-cucm
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d0a59d7d");
