...
document, resulting in arbitrary code execution."
  ...
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20120314-asaclient
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2fc37374");
  script_set_attribute(
    attribute:"solution",
    value:
