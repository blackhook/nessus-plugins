...
if (description)
{
  ...
  script_name(english:"CentOS 7 : dhcp (CESA-2021:2357)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:2357 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-June/048334.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f7373545");
...
pkgs = [
    {'reference':'dhclient-4.2.5-83.el7.centos.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dhcp-4.2.5-83.el7.centos.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dhcp-common-4.2.5-83.el7.centos.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dhcp-devel-4.2.5-83.el7.centos.1', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dhcp-devel-4.2.5-83.el7.centos.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dhcp-libs-4.2.5-83.el7.centos.1', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'dhcp-libs-4.2.5-83.el7.centos.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
