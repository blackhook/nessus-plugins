...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2022:4870)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-August/073621.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?71f191a2");
...
var pkgs = [
    {'reference':'firefox-91.10.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
