...
if (description)
{
  ...
  script_cve_id("CVE-2020-3537");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvu71188");
  script_xref(name:"CISCO-SA", value:"cisco-sa-jabber-G3NSjPn7");
  script_xref(name:"IAVA", value:"2020-A-0399-S");

  script_name(english:"Cisco Jabber for Windows Universal Naming Convention Link Handling (cisco-sa-jabber-G3NSjPn7)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, Cisco Jabber is affected by a vulnerability due to improper validation of
message contents. An authenticated, remote attacker can exploit this, by sending specially crafted messages that contain
Universal Naming Convention (UNC) links to a targeted user and convincing the user to follow the provided link in order
to cause the application to access a remote system, possibly allowing the attacker to gain sensitive information.

Please see the included Cisco BIDs and Cisco Security Advisory for more information.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-jabber-G3NSjPn7
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ba328a69");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvu71188");
...
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvu71188");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-3537");
