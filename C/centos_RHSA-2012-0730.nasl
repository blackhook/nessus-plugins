...
# CentOS Errata and Security Advisory 2012:0730 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : java-1.6.0-openjdk (CESA-2012:0730)");
...
OpenJDK Java must be restarted for the update to take effect.");
  # https://lists.centos.org/pipermail/centos-announce/2012-June/018683.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c787829b");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-1.6.0.0-1.27.1.10.8.el5_8")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-demo-1.6.0.0-1.27.1.10.8.el5_8")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-devel-1.6.0.0-1.27.1.10.8.el5_8")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-javadoc-1.6.0.0-1.27.1.10.8.el5_8")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.6.0-openjdk-src-1.6.0.0-1.27.1.10.8.el5_8")) flag++;
