...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mod_auth_openidc (CESA-2020:3970)");
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-October/012780.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?916b76ad");
...
pkgs = [
    {'reference':'mod_auth_openidc-1.8.8-7.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
