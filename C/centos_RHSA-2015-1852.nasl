...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2015-October/021422.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?34751cc9"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-October/021423.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5a0773f8"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-October/021424.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ef2b941a"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-38.3.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-38.3.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-38.3.0-1.el7.centos", allowmaj:TRUE)) flag++;
