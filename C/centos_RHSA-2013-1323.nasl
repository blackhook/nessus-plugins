...
# CentOS Errata and Security Advisory 2013:1323 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : ccid (CESA-2013:1323)");
...
contains backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2013-October/000828.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8299afa2"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"ccid-1.3.8-2.el5")) flag++;
