...
the update, the ntpd daemon will restart automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2015-October/021447.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9f427c34"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-October/021448.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?60e5d4af"
  );
