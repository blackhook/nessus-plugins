...
file, resulting in arbitrary code execution."
  ...
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20120404-webex
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e6ad1fb0");
  script_set_attribute(
    attribute:"solution",
    value:
