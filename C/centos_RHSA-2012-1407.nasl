...
# CentOS Errata and Security Advisory 2012:1407 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 / 6 : firefox (CESA-2012:1407)");
...
to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-October/018958.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?47e4fa33"
  );
  # https://lists.centos.org/pipermail/centos-announce/2012-October/018959.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5f409b23"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-10.0.10-1.el5.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-10.0.10-1.el5_8", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-devel-10.0.10-1.el5_8", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-10.0.10-1.el6.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-10.0.10-1.el6.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-6", reference:"xulrunner-devel-10.0.10-1.el6.centos", allowmaj:TRUE)) flag++;
