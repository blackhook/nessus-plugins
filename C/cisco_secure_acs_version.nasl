...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"0001-T-0557");
...
It is possible to get the ACS version number via SSH."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.cisco.com/c/en/us/products/security/secure-access-control-system/index.html");
