...
on the remote host. PRSM is the management tool used for Cisco ASA CX.");
  script_set_attribute(attribute:"see_also", value:"https://www.cisco.com/c/en/us/products/security/prime-security-manager/index.html");
...
register_install(
  app_name : app,
  vendor : 'Cisco',
  product : 'Prime Security Manager',
  version  : ver,
  path     : page,
  port     : port,
