...
# Red Hat Security Advisory RHSA-2019:1696. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2019:1696)");
...
pkgs = [
    {'reference':'firefox-60.7.2-3.el8_0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-60.7.2-3.el8_0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
