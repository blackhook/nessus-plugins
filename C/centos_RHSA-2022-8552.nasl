...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2022:8552)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-November/073659.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d59fd815");
...
var pkgs = [
    {'reference':'firefox-102.5.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
