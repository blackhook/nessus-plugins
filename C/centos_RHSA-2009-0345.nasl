...
packages, which contain a backported patch to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-April/015810.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d51cbc29"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-April/015811.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2f387c3e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-March/015688.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1e86dfad"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-March/015689.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ce2568f5"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-March/015696.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b20192b1"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-March/015697.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?643f48fd"
  );
  script_set_attribute(
    attribute:"solution", 
