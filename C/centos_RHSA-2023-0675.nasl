...
if (description)
{
  ...
  script_name(english:"CentOS 7 : tigervnc and xorg-x11-server (CESA-2023:0675)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2023:0675 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b4a5ee73");
...
var pkgs = [
    ...
    {'reference':'xorg-x11-server-devel-1.20.4-22.el7_9', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-devel-1.20.4-22.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-source-1.20.4-22.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
