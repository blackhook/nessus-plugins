...
# CentOS Errata and Security Advisory 2017:1201 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : thunderbird (CESA-2017:1201)");
...
reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7652a62f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2017-May/022406.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a1e6860e"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-52.1.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-52.1.0-1.el7.centos", allowmaj:TRUE)) flag++;
