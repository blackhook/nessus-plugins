...
# Red Hat Security Advisory RHSA-2020:1293. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : nodejs:12 (CESA-2020:1293)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2020:1293 advisory.
...
var appstreams = {
    'nodejs:12': [
      {'reference':'nodejs-12.16.1-2.module_el8.1.0+295+e9ddcc19', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-12.16.1-2.module_el8.1.0+295+e9ddcc19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-devel-12.16.1-2.module_el8.1.0+295+e9ddcc19', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-devel-12.16.1-2.module_el8.1.0+295+e9ddcc19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-docs-12.16.1-2.module_el8.1.0+295+e9ddcc19', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'nodejs-docs-12.16.1-2.module_el8.1.0+295+e9ddcc19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      ...
      {'reference':'npm-6.13.4-1.12.16.1.2.module_el8.1.0+295+e9ddcc19', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'npm-6.13.4-1.12.16.1.2.module_el8.1.0+295+e9ddcc19', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
