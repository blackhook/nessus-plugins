...
if (description)
{
  ...
  script_cve_id("CVE-2020-14515");

  script_name(english:"CodeMeter < 6.90 License forging Vulnerability");
...
installed on the remote host is prior to 6.90. It is
affected by an issue in the license-file signature checking mechanism, which allows attackers to build
arbitrary license files, including forging a valid license file as if it were a valid license file of an existing
vendor. Only CmActLicense Update Files with CmActLicense Firm Codes are affected.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?de385bfd");
...
"Upgrade to CodeMeter 6.90 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-14515");
