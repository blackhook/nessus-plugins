...
# Red Hat Security Advisory RHSA-2019:1623. The text
...
if (description)
{
  ...
  script_bugtraq_id(108761, 108810, 108835);
  script_xref(name:"RHSA", value:"2019:1623");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/06/13");
  script_xref(name:"CEA-ID", value:"CEA-2019-0458");

  script_name(english:"CentOS 8 : thunderbird (CESA-2019:1623)");
