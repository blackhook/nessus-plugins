...
if (description)
{
  ...
  script_name(english:"CentOS 7 : tomcat (CESA-2020:5020)");
...
CESA-2020:5020 advisory.

  - tomcat: Mishandling of Transfer-Encoding header allows for HTTP request smuggling (CVE-2020-1935)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-November/035829.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?90f8e0b9");
...
pkgs = [
    {'reference':'tomcat-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-admin-webapps-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-docs-webapp-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-el-2.2-api-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-javadoc-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-jsp-2.2-api-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-jsvc-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-lib-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-servlet-3.0-api-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'tomcat-webapps-7.0.76-16.el7_9', 'sp':'9', 'release':'CentOS-7'}
];
