...
if (description)
{
  ...
  script_name(english:"CentOS 7 : curl (CESA-2020:3916)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e2add91e");
...
pkgs = [
    {'reference':'curl-7.29.0-59.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'libcurl-7.29.0-59.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libcurl-7.29.0-59.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'libcurl-devel-7.29.0-59.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libcurl-devel-7.29.0-59.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
