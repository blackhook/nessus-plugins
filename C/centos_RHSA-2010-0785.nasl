...
to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017097.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?338b1b73"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017098.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b64b742"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017115.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7401a5bc"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017116.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?44196775"
  );
  script_set_attribute(
    attribute:"solution", 
