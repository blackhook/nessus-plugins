...
if (description)
{
  ...
  script_name(english:"CentOS 7 : qemu-kvm (CESA-2021:2322)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:2322 advisory.

  - QEMU: ide: atapi: OOB access while processing read commands (CVE-2020-29443)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-June/048327.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e7d19ce6");
...
pkgs = [
    {'reference':'qemu-img-1.5.3-175.el7_9.4', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qemu-kvm-1.5.3-175.el7_9.4', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qemu-kvm-common-1.5.3-175.el7_9.4', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'qemu-kvm-tools-1.5.3-175.el7_9.4', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
