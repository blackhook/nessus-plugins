...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2020:1429)");
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-April/035699.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2cc4842"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-68.7.0-2.el6.centos", allowmaj:TRUE)) flag++;
