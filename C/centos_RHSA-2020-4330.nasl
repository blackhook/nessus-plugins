...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2020:4330)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9c933594");
...
pkgs = [
    {'reference':'firefox-78.4.0-2.el6.centos', 'cpu':'i686', 'release':'CentOS-6', 'allowmaj':TRUE},
    {'reference':'firefox-78.4.0-2.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'allowmaj':TRUE}
];
