...
# CentOS Errata and Security Advisory 2018:1669 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : libvirt (CESA-2018:1669) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022845.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3e4d4223"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"libvirt-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libvirt-client-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libvirt-devel-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"libvirt-lock-sanlock-0.10.2-62.el6_9.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libvirt-python-0.10.2-62.el6_9.2")) flag++;
