...
# Red Hat Security Advisory RHSA-2021:1983. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : idm:DL1 (CESA-2021:1983)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:1983 advisory.
...
pkgs = [
    {'reference':'custodia-0.6.0-3.module_el8.1.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-custodia-0.6.0-3.module_el8.1.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-jwcrypto-0.5.0-1.module_el8.1.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-kdcproxy-0.4-5.module_el8.2.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-pyusb-1.0.0-9.module_el8.1.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-qrcode-5.1-12.module_el8.1.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-qrcode-core-5.1-12.module_el8.1.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-yubico-1.3.2-9.module_el8.1.0', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
