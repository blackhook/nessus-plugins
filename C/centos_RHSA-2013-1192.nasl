...
# CentOS Errata and Security Advisory 2013:1192 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : spice-server (CESA-2013:1192)");
...
be restarted for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-September/019923.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f62dda6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"spice-server-0.12.0-12.el6_4.3")) flag++;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"spice-server-devel-0.12.0-12.el6_4.3")) flag++;
