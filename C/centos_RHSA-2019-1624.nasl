...
the CVE page(s) listed in the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8a4cee99");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-60.7.2-2.el6.centos", allowmaj:TRUE)) flag++;
