...
# CentOS Errata and Security Advisory 2017:3269 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : procmail (CESA-2017:3269)");
...
execute arbitrary code as the user running formail. (CVE-2017-16844)"
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-November/022647.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?87525da4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"procmail-3.22-36.el7_4.1")) flag++;
