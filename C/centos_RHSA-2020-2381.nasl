...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2020:2381)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-June/035746.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?eafa0473");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-68.9.0-1.el7.centos", allowmaj:TRUE)) flag++;
