...
using the Xerces-J must be restarted for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-September/020603.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f7c3949b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-September/020605.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6b44b23"
  );
  script_set_attribute(
    attribute:"solution", 
