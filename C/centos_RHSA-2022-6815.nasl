...
if (description)
{
  ...
  script_name(english:"CentOS 7 : squid (CESA-2022:6815)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:6815 advisory.

  - squid: buffer-over-read in SSPI and SMB authentication (CVE-2022-41318)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-October/073646.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?970d7fa2");
...
var pkgs = [
    {'reference':'squid-3.5.20-17.el7_9.8', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'squid-migration-script-3.5.20-17.el7_9.8', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'squid-sysvinit-3.5.20-17.el7_9.8', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
