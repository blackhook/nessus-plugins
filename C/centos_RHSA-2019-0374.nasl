...
# CentOS Errata and Security Advisory 2019:0374 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2019:0374)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-February/023195.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0865d255"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-60.5.1-1.el7.centos", allowmaj:TRUE)) flag++;
