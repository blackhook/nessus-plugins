...
authenticated, resulting in a denial of service."
  ...
  # https://bst.cloudapps.cisco.com/bugsearch/bug/CSCtc12426
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?78a30c9c");
  script_set_attribute(
    attribute:"solution",
    value:
...
details for CSCtc12426."
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-1350");
