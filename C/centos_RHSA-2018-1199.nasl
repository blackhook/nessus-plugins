...
# CentOS Errata and Security Advisory 2018:1199 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : patch (CESA-2018:1199)");
...
listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022819.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0965d561"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"patch-2.6-8.el6_9")) flag++;
