...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-rtslib (CESA-2020:5435)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?92a856a0");
...
pkgs = [
    {'reference':'python-rtslib-2.1.74-1.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'python-rtslib-doc-2.1.74-1.el7_9', 'sp':'9', 'release':'CentOS-7'}
];
