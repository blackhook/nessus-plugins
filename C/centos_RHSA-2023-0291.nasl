...
if (description)
{
  ...
  script_name(english:"CentOS 7 : sudo (CESA-2023:0291)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2023:0291 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4a76a606");
...
var pkgs = [
    ...
    {'reference':'sudo-devel-1.8.23-10.el7_9.3', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
