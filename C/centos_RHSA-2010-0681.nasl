...
take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-September/016968.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6cb4807d"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-September/016969.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e03ba4a2"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-September/016976.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5a53a2d1"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-September/016977.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fcfd90f0"
  );
  script_set_attribute(
    attribute:"solution", 
