...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2022:5776)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-August/073625.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?0a35800b");
...
var pkgs = [
    {'reference':'firefox-91.12.0-2.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
