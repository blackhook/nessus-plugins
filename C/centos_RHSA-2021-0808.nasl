...
if (description)
{
  ...
  script_name(english:"CentOS 7 : wpa_supplicant (CESA-2021:0808)");
...
CESA-2021:0808 advisory.

  - wpa_supplicant: Use-after-free in P2P provision discovery processing (CVE-2021-27803)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-March/048292.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b18784a9");
...
pkgs = [
    {'reference':'wpa_supplicant-2.6-12.el7_9.2', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
