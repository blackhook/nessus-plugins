...
packages, which contain a backported fix for this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-January/013458.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f4071a17"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-January/013459.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf2772f6"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-January/013472.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?850a1510"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-January/013473.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a8311daa"
  );
  script_set_attribute(
    attribute:"solution", 
