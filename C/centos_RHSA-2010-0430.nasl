...
# CentOS Errata and Security Advisory 2010:0430 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : postgresql84 (CESA-2010:0430)");
...
will be automatically restarted after installing this update."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016653.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a30d526f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016654.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bcb9f5a0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-contrib-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-devel-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-docs-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-libs-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-plperl-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-plpython-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-pltcl-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-python-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-server-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-tcl-8.4.4-1.el5_5.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"postgresql84-test-8.4.4-1.el5_5.1")) flag++;
