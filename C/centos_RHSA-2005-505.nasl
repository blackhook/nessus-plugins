...
# extracted from Red Hat Security Advisory RHSA-2005:505 and 
# CentOS Errata and Security Advisory 2005:505 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : tcpdump (CESA-2005:505)");
...
these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2005-June/011815.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bde5a3d7"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-June/011816.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83f1c970"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-June/011839.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4b4de2d8"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", reference:"arpwatch-2.1a13-10.RHEL4")) flag++;
if (rpm_check(release:"CentOS-4", reference:"libpcap-0.8.3-10.RHEL4")) flag++;
if (rpm_check(release:"CentOS-4", reference:"tcpdump-3.8.2-10.RHEL4")) flag++;
