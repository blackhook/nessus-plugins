...
if (description)
{
  ...
  script_cve_id("CVE-2018-0399");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvg71044");
  script_xref(name:"CISCO-SA", value:"cisco-sa-20180718-finesse");

  script_name(english:"Cisco Finesse Information Disclosure (cisco-sa-20180718-finesse)");
  script_summary(english:"Checks the Cisco Finesse version.");

  script_set_attribute(attribute:"synopsis", value:
"The remote host is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, Cisco Finesse Software is affected by an information disclosure vulnerability.
The vulnerability in the web-based management interface could allow an unauthenticated, remote attacker to retrieve a 
cleartext password from an affected system.
...
Please see the included Cisco BIDs and Cisco Security Advisory for more information");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvg71044");
  script_set_attribute(attribute:"solution", value:
"Apply the patch or upgrade to the version recommended in Cisco bug ID CSCvg71044");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2018-0399");
...
# doing affected < fixed
constraints = [
  { 'min_version':'11.5.1', 'fixed_version':'11.5.2', 'fixed_display':'11.5(1)ES6, Bug ID: CSCvg71044', 'es_version':'6' }
];
