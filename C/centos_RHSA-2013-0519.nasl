...
automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019458.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c9a26bb"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2013-February/000649.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?11c38792"
  );
  script_set_attribute(
    attribute:"solution", 
