...
Tyson Smith as the original reporters."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2016-May/021890.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b061f93b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2016-May/021892.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?544c7adc"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2016-May/003103.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1fe67443"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-2805");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-38.8.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-38.8.0-2.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-38.8.0-1.el7.centos", allowmaj:TRUE)) flag++;
