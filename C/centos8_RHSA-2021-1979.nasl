...
# Red Hat Security Advisory RHSA-2021:1979. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : squid:4 (CESA-2021:1979)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:1979 advisory.
...
pkgs = [
    ...
    {'reference':'squid-4.11-4.module_el8.4.0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'},
    {'reference':'squid-4.11-4.module_el8.4.0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
];
