...
# CentOS Errata and Security Advisory 2019:0373 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2019:0373)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-February/023194.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?355eec12"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-60.5.1-1.el6.centos", allowmaj:TRUE)) flag++;
