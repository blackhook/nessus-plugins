...
if (description)
{
  ...
  script_cve_id("CVE-2014-2139");
  script_bugtraq_id(66684);
  script_xref(name:"CISCO-BUG-ID", value:"CSCug97315");
  script_xref(name:"IAVB", value:"2014-B-0038");

  script_name(english:"Cisco ONS 15454 Controller Card DoS (CSCug97315)");
...
allow an unauthenticated, remote attacker to prevent system access to
the flash memory on the control card, resulting in a denial of service
condition.");
  # https://tools.cisco.com/security/center/viewAlert.x?alertId=33681
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fc23bc62");
  script_set_attribute(attribute:"see_also",value:"https://tools.cisco.com/bugsearch/bug/CSCug97315");
