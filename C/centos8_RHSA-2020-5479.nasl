...
# Red Hat Security Advisory RHSA-2020:5479. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : linux-firmware (CESA-2020:5479)");
...
pkgs = [
    ...
    {'reference':'libertas-usb8388-firmware-20200619-101.git3890db36.el8_3', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
