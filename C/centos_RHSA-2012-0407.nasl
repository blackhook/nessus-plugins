...
# CentOS Errata and Security Advisory 2012:0407 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 / 6 : libpng (CESA-2012:0407)");
...
restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-March/018507.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43f7b64e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2012-March/018508.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f930ee5c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"libpng-1.2.10-16.el5_8")) flag++;
if (rpm_check(release:"CentOS-5", reference:"libpng-devel-1.2.10-16.el5_8")) flag++;

if (rpm_check(release:"CentOS-6", reference:"libpng-1.2.48-1.el6_2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libpng-devel-1.2.48-1.el6_2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libpng-static-1.2.48-1.el6_2")) flag++;
