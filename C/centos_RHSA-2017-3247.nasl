...
# CentOS Errata and Security Advisory 2017:3247 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : firefox (CESA-2017:3247)");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-52.5.0-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-52.5.0-1.el7.centos", allowmaj:TRUE)) flag++;
