...
if (description)
{
  ...
  script_name(english:"CentOS 7 : net-snmp (CESA-2020:5350)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c8aed21b");
...
pkgs = [
    {'reference':'net-snmp-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-agent-libs-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'net-snmp-agent-libs-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-devel-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'net-snmp-devel-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-gui-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-libs-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'net-snmp-libs-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-perl-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-python-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-sysvinit-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'net-snmp-utils-5.7.2-49.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
