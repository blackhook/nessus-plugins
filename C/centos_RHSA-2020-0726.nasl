...
if (description)
{
  ...
  script_name(english:"CentOS 6 : sudo (CESA-2020:0726)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035656.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7234dee0"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"sudo-1.8.6p3-29.el6_10.3")) flag++;
if (rpm_check(release:"CentOS-6", reference:"sudo-devel-1.8.6p3-29.el6_10.3")) flag++;
