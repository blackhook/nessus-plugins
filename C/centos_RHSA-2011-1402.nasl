...
# CentOS Errata and Security Advisory 2011:1402 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 / 5 : freetype (CESA-2011:1402)");
...
restarted (log out, then log back in) for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2011-November/018173.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?08c4a99b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-November/018174.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?72d83d10"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-October/018133.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3acb6c07"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-October/018134.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b2e59ee"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"freetype-2.1.9-20.el4")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"freetype-2.1.9-20.el4")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"freetype-demos-2.1.9-20.el4")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"freetype-demos-2.1.9-20.el4")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"freetype-devel-2.1.9-20.el4")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"freetype-devel-2.1.9-20.el4")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"freetype-utils-2.1.9-20.el4")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"freetype-utils-2.1.9-20.el4")) flag++;

if (rpm_check(release:"CentOS-5", reference:"freetype-2.2.1-28.el5_7.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"freetype-demos-2.2.1-28.el5_7.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"freetype-devel-2.2.1-28.el5_7.1")) flag++;
