...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2020:2824)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-July/035776.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4717c6fd");
...
pkgs = [
    {'reference':'firefox-68.10.0-1.el6.centos', 'cpu':'i686', 'release':'CentOS-6', 'allowmaj':TRUE},
    {'reference':'firefox-68.10.0-1.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'allowmaj':TRUE}
];
