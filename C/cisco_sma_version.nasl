...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"0001-T-0548");
...
##
function report_and_exit(ver, model, source, port)
{
  var report, display_ver, host;
...
{
  model = pregmatch(string:ver_cmd, pattern:'Model: (.+)');
  version = pregmatch(string:ver_cmd, pattern:'Version: ([0-9.-]+)');
