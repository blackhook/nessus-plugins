...
# CentOS Errata and Security Advisory 2010:0809 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : xulrunner (CESA-2010:0809)");
...
update, applications using XULRunner must be restarted for the changes
to take effect."
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017131.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?da9d5126"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017132.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?590054c7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-1.9.2.11-4.el5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"xulrunner-devel-1.9.2.11-4.el5")) flag++;
