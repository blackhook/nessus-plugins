...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2020:3253)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-August/035798.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4b9c7841");
...
pkgs = [
    {'reference':'firefox-68.11.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'allowmaj':TRUE},
    {'reference':'firefox-68.11.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
