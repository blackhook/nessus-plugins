...
be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2011-May/017508.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?52c12f65"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-May/017509.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4253b3e1"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-May/017512.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dc2efbe9"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-May/017513.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d23f5cfb"
  );
  script_set_attribute(
    attribute:"solution", 
