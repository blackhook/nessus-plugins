...
# Red Hat Security Advisory RHSA-2020:3050. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : cloud-init (CESA-2020:3050)");
...
pkgs = [
    {'reference':'cloud-init-19.4-1.el8.7', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
