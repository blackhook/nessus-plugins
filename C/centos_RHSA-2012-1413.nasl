...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-October/018962.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?25debb1b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2012-October/018963.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?42c34fdf"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-10.0.10-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-10.0.10-1.el6.centos", allowmaj:TRUE)) flag++;
