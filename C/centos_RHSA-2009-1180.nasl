...
the update, the BIND daemon (named) will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-July/016058.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e7ee78f9"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-July/016059.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?090953ff"
  );
