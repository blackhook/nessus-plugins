...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-February/020137.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1d3a033c"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-February/020139.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5ff4f51b"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-24.3.0-2.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-24.3.0-2.el6.centos", allowmaj:TRUE)) flag++;
