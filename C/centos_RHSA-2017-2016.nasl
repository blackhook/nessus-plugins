...
# CentOS Errata and Security Advisory 2017:2016 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : curl (CESA-2017:2016)");
...
Enterprise Linux 7.4 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2017-August/004064.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?229c4e46"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"curl-7.29.0-42.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libcurl-7.29.0-42.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libcurl-devel-7.29.0-42.el7")) flag++;
