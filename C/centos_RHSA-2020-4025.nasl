...
if (description)
{
  ...
  script_name(english:"CentOS 7 : qt5-qtbase (CESA-2020:4025)");
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-October/012820.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c2bf3eb1");
...
pkgs = [
    {'reference':'qt5-qtbase-5.9.7-4.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-common-5.9.7-4.el7', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-devel-5.9.7-4.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-devel-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-doc-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-examples-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-gui-5.9.7-4.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-gui-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-mysql-5.9.7-4.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-mysql-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-odbc-5.9.7-4.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-odbc-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-postgresql-5.9.7-4.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-postgresql-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-static-5.9.7-4.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'qt5-qtbase-static-5.9.7-4.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'qt5-rpm-macros-5.9.7-4.el7', 'release':'CentOS-7'}
];
