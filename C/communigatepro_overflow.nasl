...
It was possible to crash this service by :
  ...
  - First, connecting to port 8010 and sending 70 KB     of data (AAA[...]AAA) followed by '\r
'.

  - Then, connecting to port 25.

A remote attacker could exploit this to crash the service, or possibly execute arbitrary code.");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/1999/Dec/62");
