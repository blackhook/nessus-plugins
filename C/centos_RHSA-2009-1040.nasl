...
# extracted from Red Hat Security Advisory RHSA-2009:1040 and 
# CentOS Errata and Security Advisory 2009:1040 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : ntp (CESA-2009:1040)");
...
the update, the ntpd daemon will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-May/015884.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7934145"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-4", cpu:"ia64", reference:"ntp-4.2.0.a.20040617-8.c4.2")) flag++;
