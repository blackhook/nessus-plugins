...
# CentOS Errata and Security Advisory 2018:1124 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : python-paramiko (CESA-2018:1124)");
...
listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022821.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8e0bc15b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"python-paramiko-1.7.5-4.el6_9")) flag++;
