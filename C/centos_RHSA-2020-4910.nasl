...
if (description)
{
  ...
  script_name(english:"CentOS 7 : xorg-x11-server (CESA-2020:4910)");
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-November/012889.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1533b21d");
...
pkgs = [
    {'reference':'xorg-x11-server-common-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-devel-1.20.4-12.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-devel-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-source-1.20.4-12.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-Xdmx-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-Xephyr-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-Xnest-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-Xorg-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-Xvfb-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'xorg-x11-server-Xwayland-1.20.4-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
