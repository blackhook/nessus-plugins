...
# CentOS Errata and Security Advisory 2018:2916 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : spamassassin (CESA-2018:2916)");
...
listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2020-February/035628.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?995a11ad");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"spamassassin-3.4.0-5.el7_7")) flag++;
