...
if (description)
{
  ...
  script_name(english:"CentOS 7 : sqlite (CESA-2020:0227)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-January/035616.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8dccc7c6"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"lemon-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sqlite-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sqlite-devel-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sqlite-doc-3.7.17-8.el7_7.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sqlite-tcl-3.7.17-8.el7_7.1")) flag++;
