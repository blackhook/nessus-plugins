...
# CentOS Errata and Security Advisory 2018:3052 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : wget (CESA-2018:3052)");
...
Enterprise Linux 7.6 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-November/005704.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9be59ca7"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"wget-1.14-18.el7")) flag++;
