...
# CentOS Errata and Security Advisory 2017:0254 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : spice (CESA-2017:0254)");
...
These issues were discovered by Frediano Ziglio (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8bffd121"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"spice-server-0.12.4-20.el7_3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"spice-server-devel-0.12.4-20.el7_3")) flag++;
