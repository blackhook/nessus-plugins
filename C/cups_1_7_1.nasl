...
configurations.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.cups.org/blog/2014-01-08-cups-1.7.1.html");
...
"Upgrade to CUPS version 1.7.1 or later, or apply the vendor patch.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-6891");
