...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2023:1333)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2023-March/086391.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b93789d2");
...
var pkgs = [
    {'reference':'firefox-102.9.0-3.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
