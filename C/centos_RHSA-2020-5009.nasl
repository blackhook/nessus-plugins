...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python (CESA-2020:5009)");
...
CESA-2020:5009 advisory.

  - python: infinite loop in the tarfile module via crafted TAR archive (CVE-2019-20907)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-November/035822.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?80c3597e");
...
pkgs = [
    {'reference':'python-2.7.5-90.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'python-debug-2.7.5-90.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'python-devel-2.7.5-90.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'python-libs-2.7.5-90.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'python-libs-2.7.5-90.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'python-test-2.7.5-90.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'python-tools-2.7.5-90.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'tkinter-2.7.5-90.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
