...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2011-B-0087-S");
...
specially crafted HTTP POST requests.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2011/Jul/224");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2011/Jul/225");
  script_set_attribute(attribute:"see_also", value:"https://support.citrix.com/article/CTX129430");
