...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mariadb (CESA-2020:4026)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2020:4026 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-October/012775.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a6173a2a");
...
pkgs = [
    {'reference':'mariadb-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'mariadb-bench-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'mariadb-devel-5.5.68-1.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'mariadb-devel-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'mariadb-embedded-5.5.68-1.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'mariadb-embedded-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'mariadb-embedded-devel-5.5.68-1.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'mariadb-embedded-devel-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'mariadb-libs-5.5.68-1.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'mariadb-libs-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'mariadb-server-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'mariadb-test-5.5.68-1.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
