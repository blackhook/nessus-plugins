...
# CentOS Errata and Security Advisory 2010:0362 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : scsi-target-utils (CESA-2010:0362)");
...
effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016657.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bc3f7df8"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016658.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6765aaf0"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"scsi-target-utils-0.0-6.20091205snap.el5_5.2")) flag++;
