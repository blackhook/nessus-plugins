...
attacker can exploit this to make the system unresponsive.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20120912-asacx
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f1947679");
