...
# CentOS Errata and Security Advisory 2014:1004 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : yum-updatesd (CESA-2014:1004)");
...
automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-August/020462.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7c9c4fde"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:yum-updatesd");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"yum-updatesd-0.9-6.el5_10")) flag++;
