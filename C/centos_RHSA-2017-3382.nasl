...
# CentOS Errata and Security Advisory 2017:3382 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : firefox (CESA-2017:3382)");
...
issue. Upstream acknowledges Konark as the original reporter."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-December/022683.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00970dd4"
  );
  # https://lists.centos.org/pipermail/centos-announce/2017-December/022687.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6da0b99b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"firefox-52.5.1-1.el6.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-52.5.1-1.el7.centos", allowmaj:TRUE)) flag++;
