...
# CentOS Errata and Security Advisory 2018:3347 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-paramiko (CESA-2018:3347)");
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ea368ca8"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2018-November/005758.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?16420d8c"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python-paramiko");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:python-paramiko-doc");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"python-paramiko-2.1.1-9.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"python-paramiko-doc-2.1.1-9.el7")) flag++;
