...
if (description)
{
  ...
  script_cve_id("CVE-2019-17366");

  script_name(english:"Citrix ADM Authentication Bypass (CTX261735)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"An authentication bypass vulnerability exists in Citrix Application Delivery Management (ADM). An authenticated,
...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://support.citrix.com/article/CTX261735");
  script_set_attribute(attribute:"solution", value:
"Upgrade to version 12.1-54.13, 13.0-41.20 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:P/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-17366");
...
var constraints = [
  {'min_version': '12.0', 'fixed_version': '12.1.54.13', 'fixed_display': '12.1-54.13'},
  {'min_version': '13.0', 'fixed_version': '13.0.41.20', 'fixed_display': '13.0-41.20'}
];
