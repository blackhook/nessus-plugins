...
# extracted from Red Hat Security Advisory RHSA-2006:0451 and 
# CentOS Errata and Security Advisory 2006:0451 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : xorg-x11 (CESA-2006:0451)");
...
This issue does not affect Red Hat Enterprise Linux 2.1 or 3."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012885.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c5b31e81"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012888.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?be53d3f4"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012889.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?61ff2e2c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-Mesa-libGL-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-Mesa-libGLU-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-Xdmx-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-Xnest-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-Xvfb-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-deprecated-libs-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-deprecated-libs-devel-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-devel-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-doc-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-font-utils-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-libs-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-sdk-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-tools-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-twm-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-xauth-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-xdm-6.8.2-1.EL.13.25.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"xorg-x11-xfs-6.8.2-1.EL.13.25.1")) flag++;
