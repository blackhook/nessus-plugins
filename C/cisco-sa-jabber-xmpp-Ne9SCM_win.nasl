...
if (description)
{
  ...
  script_name(english:"Cisco Jabber Client For Windows XMPP Stanza Smuggling (cisco-sa-jabber-xmpp-Ne9SCM)");

  script_set_attribute(attribute:"synopsis", value:
"An application on the remote host is missing a vendor-supplied security patch.");
  script_set_attribute(attribute:"description", value:
"According to its self-reported version, Cisco Jabber for Windows is affected by a stanza smuggling vulnerability due
...
var constraints = [
    { 'fixed_version' : '12.6.6' },
    { 'min_version' : '12.7', 'fixed_version' : '12.7.6' },
    { 'min_version' : '12.8', 'fixed_version' : '12.8.7' },
    { 'min_version' : '12.9', 'fixed_version' : '12.9.7' },
