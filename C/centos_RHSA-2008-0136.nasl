...
# CentOS Errata and Security Advisory 2008:0136 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : tk (CESA-2008:0136)");
...
contain a backported patches to resolve these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014700.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9bbcd9bc"
  );
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014701.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a7bb47dc"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"tk-8.4.13-5.el5_1.1")) flag++;
if (rpm_check(release:"CentOS-5", reference:"tk-devel-8.4.13-5.el5_1.1")) flag++;
