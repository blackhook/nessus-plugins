...
if (description)
{
  ...
  script_name(english:"CentOS 7 : aide (CESA-2022:0473)");
...
CESA-2022:0473 advisory.

  - aide: heap-based buffer overflow on outputs larger than B64_BUF (CVE-2021-45417)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-February/073556.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?bea02ad4");
...
var pkgs = [
    {'reference':'aide-0.15.1-13.el7_9.1', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
