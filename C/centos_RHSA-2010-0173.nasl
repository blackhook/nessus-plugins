...
restarted."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016582.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd966d3d"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016583.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b4178ca1"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016611.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ccde2a64"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016612.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e149c4b1"
  );
  script_set_attribute(
    attribute:"solution", 
