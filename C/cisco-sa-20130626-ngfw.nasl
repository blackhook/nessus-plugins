...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2013-A-0132-S");
...
and/or stops processing/inspecting traffic.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20130626-ngfw
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ecb29a4");
