...
which contain backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-February/018417.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?484e9bb6"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4820");
