...
if (description)
{
  ...
  script_name(english:"CentOS 7 : linuxptp (CESA-2021:2658)");
...
CESA-2021:2658 advisory.

  - linuxptp: missing length check of forwarded messages (CVE-2021-3570)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-July/048341.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?91d24a07");
...
pkgs = [
    {'reference':'linuxptp-2.0-2.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
