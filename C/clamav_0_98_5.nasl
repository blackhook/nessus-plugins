...
by the following vulnerabilities :
  ...
  - Errors exist related to scanning maliciously crafted
    ...
    (CVE-2014-9050)");
  # https://github.com/Cisco-Talos/clamav-devel/commit/2f578ecb5831cfb7931ec3d043e8cab33c595da9
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d623816c");
  # https://github.com/Cisco-Talos/clamav-devel/commit/fc3794a54d2affe5770c1f876484a871c783e91e
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5db34d44");
  script_set_attribute(attribute:"see_also", value:"https://blog.clamav.net/2014/11/clamav-0985-has-been-released.html");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.clamav.net/show_bug.cgi?id=11088");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/oss-sec/2014/q4/752");
