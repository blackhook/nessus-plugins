...
# CentOS Errata and Security Advisory 2019:1626 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2019:1626)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-July/023343.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b4ac802");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-60.7.2-2.el7.centos", allowmaj:TRUE)) flag++;
