...
# CentOS Errata and Security Advisory 2008:0153 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 3 / 4 : cups (CESA-2008:0153)");
...
contain backported patches to resolve this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014708.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8f1208fd"
  );
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014709.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00c64258"
  );
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014712.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a1e05b7"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-3", cpu:"i386", reference:"cups-1.1.17-13.3.51")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"x86_64", reference:"cups-1.1.17-13.3.51")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"i386", reference:"cups-devel-1.1.17-13.3.51")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"x86_64", reference:"cups-devel-1.1.17-13.3.51")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"i386", reference:"cups-libs-1.1.17-13.3.51")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"x86_64", reference:"cups-libs-1.1.17-13.3.51")) flag++;

if (rpm_check(release:"CentOS-4", cpu:"ia64", reference:"cups-1.1.17-13.3.51")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"ia64", reference:"cups-devel-1.1.17-13.3.51")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"ia64", reference:"cups-libs-1.1.17-13.3.51")) flag++;
