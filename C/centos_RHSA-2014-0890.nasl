...
# CentOS Errata and Security Advisory 2014:0890 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : java-1.7.0-openjdk (CESA-2014:0890)");
...
OpenJDK Java must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-July/020414.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ed698304"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-2483");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-1.7.0.65-2.5.1.2.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-demo-1.7.0.65-2.5.1.2.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-devel-1.7.0.65-2.5.1.2.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-javadoc-1.7.0.65-2.5.1.2.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-src-1.7.0.65-2.5.1.2.el5_10")) flag++;
