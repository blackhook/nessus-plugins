...
# CentOS Errata and Security Advisory 2018:1319 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : kernel (CESA-2018:1319) (Meltdown)");
...
https://access.redhat.com/ articles/3431591"
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022827.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a9e9484b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"kernel-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"kernel-abi-whitelists-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"kernel-debug-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"kernel-debug-devel-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"kernel-devel-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"kernel-doc-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"kernel-firmware-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"kernel-headers-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"perf-2.6.32-696.28.1.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"python-perf-2.6.32-696.28.1.el6")) flag++;
