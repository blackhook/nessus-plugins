...
if (description)
{
  ...
  script_name(english:"CentOS 7 : icu (CESA-2020:0897)");
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035682.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b1c5f9c"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"icu-50.2-4.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libicu-50.2-4.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libicu-devel-50.2-4.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libicu-doc-50.2-4.el7_7")) flag++;
