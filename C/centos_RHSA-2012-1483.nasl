...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-November/019004.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c43c1dac"
  );
  # https://lists.centos.org/pipermail/centos-announce/2012-November/019009.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bb934c8b"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-10.0.11-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-10.0.11-1.el6.centos", allowmaj:TRUE)) flag++;
