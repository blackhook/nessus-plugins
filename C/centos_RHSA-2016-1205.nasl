...
# CentOS Errata and Security Advisory 2016:1205 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : spice (CESA-2016:1205)");
...
CVE-2016-2150 issue was discovered by Frediano Ziglio (Red Hat)."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2016-June/021904.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?eceb645f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"spice-server-0.12.4-15.el7_2.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"spice-server-devel-0.12.4-15.el7_2.1")) flag++;
