...
# extracted from Red Hat Security Advisory RHSA-2006:0194 and 
# CentOS Errata and Security Advisory 2006:0194 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : gd (CESA-2006:0194)");
...
backported patch and is not vulnerable to these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-February/012605.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?70a06fec"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-February/012608.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5cc5bd40"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-February/012609.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7cde0256"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-4", reference:"gd-2.0.28-4.4E.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"gd-devel-2.0.28-4.4E.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"gd-progs-2.0.28-4.4E.1")) flag++;
