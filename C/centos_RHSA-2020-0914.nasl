...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2020:0914)");
...
referenced in the RHSA-2020:0914 advisory.
  ...
  - usrsctp: Out of bounds reads in
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035685.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b93c9a51"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-68.6.0-1.el6.centos", allowmaj:TRUE)) flag++;
