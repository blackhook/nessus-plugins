...
backported security patch to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-July/013025.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d4adf06b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-July/013044.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8231b7c"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-July/013045.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd783c67"
  );
  script_set_attribute(
    attribute:"solution", 
