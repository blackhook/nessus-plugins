...
# CentOS Errata and Security Advisory 2018:0023 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : qemu-kvm (CESA-2018:0023) (Spectre)");
...
issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-January/022705.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97849753"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-img-1.5.3-141.el7_4.6")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-1.5.3-141.el7_4.6")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-141.el7_4.6")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-141.el7_4.6")) flag++;
