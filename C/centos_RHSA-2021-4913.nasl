...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mailman (CESA-2021:4913)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-December/060969.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?07fc496c");
...
var pkgs = [
    {'reference':'mailman-2.1.15-30.el7_9.2', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
