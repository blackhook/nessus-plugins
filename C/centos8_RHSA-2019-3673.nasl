...
# Red Hat Security Advisory RHSA-2019:3673. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : lldpad (CESA-2019:3673)");
...
"Update the affected lldpad package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:lldpad");
