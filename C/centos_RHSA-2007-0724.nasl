...
which contain backported patches that correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-July/014052.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2c451ff7"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-July/014053.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f58beb05"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-July/014061.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?433636bc"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-July/014062.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?97cbf494"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-July/014066.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80bf359b"
  );
  script_set_attribute(
    attribute:"solution", 
