...
# CentOS Errata and Security Advisory 2010:0750 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 3 : xpdf (CESA-2010:0750)");
...
backported patch to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017045.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2578629"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017046.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5bbdf300"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-3", cpu:"i386", reference:"xpdf-2.02-19.el3")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"x86_64", reference:"xpdf-2.02-19.el3")) flag++;
