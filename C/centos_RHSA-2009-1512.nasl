...
a backported patch to resolve these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-October/016193.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cc87d79c"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-October/016194.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd00bfcc"
  );
  script_set_attribute(
    attribute:"solution", 
