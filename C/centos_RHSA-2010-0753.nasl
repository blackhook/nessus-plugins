...
backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017053.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9db366e4"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017054.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a4f92315"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017061.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4d0f1d2e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017062.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9b8a5d91"
  );
  script_set_attribute(
    attribute:"solution", 
