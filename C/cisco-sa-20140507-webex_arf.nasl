...
if (description)
{
  ...
  script_name(english:"Cisco WebEx ARF Player Multiple Vulnerabilities (cisco-sa-20140507-webex)");
...
arbitrary code execution.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20140507-webex
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fffbbf6f");
...
if (
  # T27LDSP32EP16
  hotfix_is_vulnerable(file:'nbrpd.dll', version:'2029.1232.1116.2300', min_version:'2029.0.0.0', path:path) ||
  # T28
  hotfix_is_vulnerable(file:'nbrpd.dll', version:'2028.1208.1100.2300', min_version:'2028.0.0.0', path:path) ||
  # Orion2.0.0.FCS
