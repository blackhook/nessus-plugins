...
# CentOS Errata and Security Advisory 2018:0013 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : microcode_ctl (CESA-2018:0013) (Spectre)");
...
issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-January/022700.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0b9b7833"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"microcode_ctl-1.17-25.2.el6_9")) flag++;
