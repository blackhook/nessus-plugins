...
# CentOS Errata and Security Advisory 2013:0603 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : java-1.7.0-openjdk (CESA-2013:0603)");
...
OpenJDK Java must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019268.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ca57bee7"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-1.7.0.9-2.3.8.0.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-demo-1.7.0.9-2.3.8.0.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-devel-1.7.0.9-2.3.8.0.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-javadoc-1.7.0.9-2.3.8.0.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-src-1.7.0.9-2.3.8.0.el5_9")) flag++;
