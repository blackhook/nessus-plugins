...
# Red Hat Security Advisory RHSA-2020:4667. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : mailman:2.1 (CESA-2020:4667)");
...
var appstreams = {
    'mailman:2.1': [
      {'reference':'mailman-2.1.29-10.module_el8.3.0+548+3169411d', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mailman-2.1.29-10.module_el8.3.0+548+3169411d', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
};
