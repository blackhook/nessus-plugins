...
# CentOS Errata and Security Advisory 2011:1790 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : krb5 (CESA-2011:1790)");
...
packages, the krb5kdc daemon will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2011-December/018344.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5e6f24f4"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"krb5-devel-1.9-22.el6_2.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"krb5-libs-1.9-22.el6_2.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"krb5-pkinit-openssl-1.9-22.el6_2.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"krb5-server-1.9-22.el6_2.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"krb5-server-ldap-1.9-22.el6_2.1")) flag++;
if (rpm_check(release:"CentOS-6", reference:"krb5-workstation-1.9-22.el6_2.1")) flag++;
