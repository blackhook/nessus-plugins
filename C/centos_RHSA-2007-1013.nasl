...
contain backported patches to resolve these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-November/014437.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1917f49f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-November/014438.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?641d777d"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-November/014444.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2c70b558"
  );
  script_set_attribute(
    attribute:"solution", 
