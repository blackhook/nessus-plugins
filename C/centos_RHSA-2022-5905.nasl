...
if (description)
{
  ...
  script_name(english:"CentOS 7 : xorg-x11-server (CESA-2022:5905)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2022:5905 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-August/073627.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?72a41fe8");
...
var pkgs = [
    ...
    {'reference':'xorg-x11-server-devel-1.20.4-18.el7_9', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-devel-1.20.4-18.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'xorg-x11-server-source-1.20.4-18.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
