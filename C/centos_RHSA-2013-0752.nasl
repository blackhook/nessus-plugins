...
# CentOS Errata and Security Advisory 2013:0752 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : java-1.7.0-openjdk (CESA-2013:0752)");
...
OpenJDK Java must be restarted for the update to take effect.");
  # https://lists.centos.org/pipermail/centos-announce/2013-April/019693.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1f650e1c");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-1.7.0.19-2.3.9.1.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-demo-1.7.0.19-2.3.9.1.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-devel-1.7.0.19-2.3.9.1.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-javadoc-1.7.0.19-2.3.9.1.el5_9")) flag++;
if (rpm_check(release:"CentOS-5", reference:"java-1.7.0-openjdk-src-1.7.0.19-2.3.9.1.el5_9")) flag++;
