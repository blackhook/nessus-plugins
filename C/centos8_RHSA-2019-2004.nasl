...
# Red Hat Security Advisory RHSA-2019:2004. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : icedtea-web (CESA-2019:2004)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2019:2004 advisory.

  - icedtea-web: unsigned code injection in a signed JAR file (CVE-2019-10181)

  - icedtea-web: path traversal while processing  elements of JNLP files results in arbitrary file
