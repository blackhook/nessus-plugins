...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2020:3631)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-September/035808.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c57a443c");
...
pkgs = [
    {'reference':'thunderbird-68.12.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
