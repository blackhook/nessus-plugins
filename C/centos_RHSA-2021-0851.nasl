...
if (description)
{
  ...
  script_name(english:"CentOS 7 : pki-core (CESA-2021:0851)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2021:0851 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-March/048287.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d94e6d0");
...
pkgs = [
    {'reference':'pki-base-10.5.18-12.el7_9', 'sp':'9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-base-java-10.5.18-12.el7_9', 'sp':'9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-ca-10.5.18-12.el7_9', 'sp':'9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-javadoc-10.5.18-12.el7_9', 'sp':'9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-kra-10.5.18-12.el7_9', 'sp':'9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-server-10.5.18-12.el7_9', 'sp':'9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-symkey-10.5.18-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-tools-10.5.18-12.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
