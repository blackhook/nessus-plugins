...
these bugs and add these enhancements."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019515.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0f361646"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2013-February/000707.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?38ff20bf"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected sssd packages.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-0220");
