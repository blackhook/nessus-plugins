...
privileges of the user running vim. (CVE-2016-1248)"
  ...
  # https://lists.centos.org/pipermail/centos-announce/2016-December/022185.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3b737ded"
  );
  # https://lists.centos.org/pipermail/centos-announce/2016-December/022187.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?49d1fa01"
  );
