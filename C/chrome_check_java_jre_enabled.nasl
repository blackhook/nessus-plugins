...
if (description)
{
  ...
  script_name(english:"Oracle Java JRE Enabled (Google Chrome)");

  script_set_attribute(attribute:"synopsis", value:
"The remote host has Java JRE enabled for Google Chrome.");
  script_set_attribute(attribute:"description", value:
"Oracle Java JRE is enabled in Google Chrome.");
