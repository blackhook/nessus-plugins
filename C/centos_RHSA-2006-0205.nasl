...
which contain a backported patch that is not vulnerable to this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-February/012639.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cb64e2e1"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-February/012646.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?383d0fbf"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-February/012649.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?33466f32"
  );
  script_set_attribute(
    attribute:"solution", 
