...
if (description)
{
  ...
  script_name(english:"CentOS 7 : postgresql-jdbc (CESA-2020:3285)");
...
CESA-2020:3285 advisory.

  - postgresql-jdbc: XML external entity (XXE) vulnerability in PgSQLXML (CVE-2020-13692)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-August/035788.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fae151e6");
...
pkgs = [
    {'reference':'postgresql-jdbc-9.2.1002-8.el7_8', 'sp':'8', 'release':'CentOS-7'},
    {'reference':'postgresql-jdbc-javadoc-9.2.1002-8.el7_8', 'sp':'8', 'release':'CentOS-7'}
];
