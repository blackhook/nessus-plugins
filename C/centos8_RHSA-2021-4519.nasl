...
# Red Hat Security Advisory RHSA-2021:4519. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : autotrace (CESA-2021:4519)");
...
var pkgs = [
    {'reference':'autotrace-0.31.1-53.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
