...
nss-util must be restarted for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020069.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f655cb2"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020070.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7685b760"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020071.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2e697226"
  );
  script_set_attribute(
    attribute:"solution", 
