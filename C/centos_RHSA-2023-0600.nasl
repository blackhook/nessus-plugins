...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2023:0600)");
...
CESA-2023:0600 advisory.

  - Mozilla: Revocation status of S/Mime signature certificates was not checked (CVE-2023-0430)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2023-February/086374.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?060135a2");
