...
if (description)
{
  ...
  script_xref(name:"IAVB", value:"2010-B-0112-S");
...
attacks.");
  script_set_attribute(attribute:"see_also", value:"https://support.citrix.com/article/CTX127541");
  script_set_attribute(attribute:"solution", value:"Upgrade to Citrix Web Interface 5.4.0 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2010-4515");
