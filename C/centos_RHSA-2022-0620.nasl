...
if (description)
{
  ...
  script_name(english:"CentOS 7 : kernel (CESA-2022:0620)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2022:0620 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a13dc1ac");
...
var pkgs = [
    ...
    {'reference':'kernel-abi-whitelists-3.10.0-1160.59.1.el7', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
