...
# CentOS Errata and Security Advisory 2019:2471 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : openssl (CESA-2019:2471)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-August/023403.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1eab707f");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"openssl-1.0.1e-58.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"openssl-devel-1.0.1e-58.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"openssl-perl-1.0.1e-58.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"openssl-static-1.0.1e-58.el6_10")) flag++;
