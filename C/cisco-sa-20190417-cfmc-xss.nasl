...
if (description)
{
  ...
  script_cve_id("CVE-2019-1802");
  script_xref(name:"CISCO-SA", value:"cisco-sa-20190417-cfmc-xss");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvn99712");
  script_xref(name:"IAVA", value:"2019-A-0204-S");

  script_name(english:"Cisco Firepower Management Center 6.2.3.x < 6.2.3.12 / 6.3.0.x < 6.3.0.3 / 6.4.0 XSS (cisco-sa-20190417-cfmc-xss)");
...
session.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d3f95d44");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID(s) CSCvn99712.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:S/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:H/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-1802");
...
constraints = [
  {'min_version': '6.2.3', 'fixed_version': '6.2.3.12'},
  {'min_version': '6.3.0', 'fixed_version': '6.3.0.3'}
];

if (report_paranoia == 2)
  collib::push({'equal': '6.4.0', 'fixed_display': 'See vendor advisory'}, list:constraints);
