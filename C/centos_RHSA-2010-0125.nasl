...
# CentOS Errata and Security Advisory 2010:0125 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : systemtap (CESA-2010:0125)");
...
contain a backported patch to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016535.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?af816a24"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016536.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26acfe43"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"systemtap-0.6.2-2.el4_8.1")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"systemtap-0.6.2-2.el4_8.1")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"systemtap-runtime-0.6.2-2.el4_8.1")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"systemtap-runtime-0.6.2-2.el4_8.1")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"systemtap-testsuite-0.6.2-2.el4_8.1")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"systemtap-testsuite-0.6.2-2.el4_8.1")) flag++;
