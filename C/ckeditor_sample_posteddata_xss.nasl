...
However, Nessus did not test for these additional issues.");
  # https://packetstormsecurity.com/files/120387/CKEditor-4.0.1-CSRF-XSS-Path-Disclosure.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?043899a3");
  script_set_attribute(attribute:"see_also", value:"https://ckeditor.com/blog/CKEditor-4.0.1.1-Released/");
