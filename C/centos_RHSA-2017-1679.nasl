...
# CentOS Errata and Security Advisory 2017:1679 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : bind (CESA-2017:1679)");
...
(BZ#1458234)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?53269585"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"bind-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"CentOS-6", reference:"bind-chroot-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"CentOS-6", reference:"bind-devel-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"CentOS-6", reference:"bind-libs-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"CentOS-6", reference:"bind-sdb-9.8.2-0.62.rc1.el6_9.4")) flag++;
if (rpm_check(release:"CentOS-6", reference:"bind-utils-9.8.2-0.62.rc1.el6_9.4")) flag++;
