...
if (description)
{
  ...
  script_name(english:"CentOS 7 : java-1.8.0-openjdk (CESA-2020:2968)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2020:2968 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-August/035792.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b46b694b");
...
pkgs = [
    {'reference':'java-1.8.0-openjdk-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-accessibility-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-accessibility-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-demo-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-demo-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-devel-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-devel-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-headless-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-headless-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-javadoc-1.8.0.262.b10-0.el7_8', 'sp':'8', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-javadoc-zip-1.8.0.262.b10-0.el7_8', 'sp':'8', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-src-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-1.8.0-openjdk-src-1.8.0.262.b10-0.el7_8', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'}
];
