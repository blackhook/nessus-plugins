...
which contain a backported patch that resolves this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2005-December/012456.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0e85b5fb"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-December/012461.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c0f652d"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-December/012462.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d6f59acf"
  );
  script_set_attribute(
    attribute:"solution", 
