...
# CentOS Errata and Security Advisory 2018:1647 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : java-1.7.0-openjdk (CESA-2018:1647) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-May/022834.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83873a75"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-demo-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-devel-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-javadoc-1.7.0.181-2.6.14.8.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"java-1.7.0-openjdk-src-1.7.0.181-2.6.14.8.el6_9")) flag++;
