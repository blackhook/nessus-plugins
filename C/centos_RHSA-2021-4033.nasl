...
if (description)
{
  ...
  script_name(english:"CentOS 7 : binutils (CESA-2021:4033)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:4033 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-November/048395.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1e8640f1");
...
var pkgs = [
    {'reference':'binutils-2.27-44.base.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-devel-2.27-44.base.el7_9.1', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'binutils-devel-2.27-44.base.el7_9.1', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
