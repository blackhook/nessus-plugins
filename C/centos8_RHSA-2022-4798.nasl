...
# Red Hat Security Advisory RHSA-2022:4798. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : maven:3.5 (CESA-2022:4798)");
...
var appstreams = {
    'maven:3.5': [
      {'reference':'httpcomponents-client-4.5.5-5.module_el8.6.0+1030+8d97e896', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
