...
# CentOS Errata and Security Advisory 2013:1269 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 / 6 : thunderbird (CESA-2013:1269)");
...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-September/019942.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b5dc4505"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-September/019944.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?0329204b"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-17.0.9-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-17.0.9-1.el6.centos", allowmaj:TRUE)) flag++;
