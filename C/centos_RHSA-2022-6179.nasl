...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2022:6179)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-September/073633.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b2b23b66");
...
var pkgs = [
    {'reference':'firefox-91.13.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
