...
# Red Hat Security Advisory RHSA-2022:7700. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : gdisk (CESA-2022:7700)");
...
"Update the affected gdisk package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:gdisk");
