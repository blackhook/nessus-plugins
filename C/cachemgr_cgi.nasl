...
perform a port scan from the cgi-host machine.");
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/1999/Jul/183");
...
--- end srm.conf segment ---");
 ...
 script_copyright(english:"This script is Copyright (C) 1999-2021 A. de Bernis");
