...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2020:0905)");
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035683.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?484e1bd0"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-68.6.0-1.el7.centos", allowmaj:TRUE)) flag++;
