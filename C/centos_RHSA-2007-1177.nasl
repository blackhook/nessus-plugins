...
Red Hat would like to thank Tim Baum for reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-December/014529.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?045c42fb"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-December/014545.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f62adf20"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-December/014546.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f9468647"
  );
  script_set_attribute(
    attribute:"solution", 
