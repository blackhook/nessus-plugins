...
# CentOS Errata and Security Advisory 2014:0369 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : httpd (CESA-2014:0369)");
...
automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-April/020246.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?52c32c9d"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"httpd-2.2.3-85.el5.centos")) flag++;
if (rpm_check(release:"CentOS-5", reference:"httpd-devel-2.2.3-85.el5.centos")) flag++;
if (rpm_check(release:"CentOS-5", reference:"httpd-manual-2.2.3-85.el5.centos")) flag++;
if (rpm_check(release:"CentOS-5", reference:"mod_ssl-2.2.3-85.el5.centos")) flag++;
