...
# CentOS Errata and Security Advisory 2019:0232 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : spice-server (CESA-2019:0232)");
...
This issue was discovered by Christophe Fergeau (Red Hat)."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-February/023189.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3c756c9e"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"spice-server-0.12.4-16.el6_10.3")) flag++;
if (rpm_check(release:"CentOS-6", cpu:"x86_64", reference:"spice-server-devel-0.12.4-16.el6_10.3")) flag++;
