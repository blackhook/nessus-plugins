...
this update, the OpenLDAP daemons will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2011-April/017375.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5b12f629"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-April/017376.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?01def188"
  );
  script_set_attribute(
    attribute:"solution", 
