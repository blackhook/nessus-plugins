...
# Red Hat Security Advisory RHSA-2021:4058. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : samba (CESA-2021:4058)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:4058 advisory.
...
var pkgs = [
    ...
    {'reference':'samba-winexe-4.13.3-5.el8_4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
