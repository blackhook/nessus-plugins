...
pixman must be restarted for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020089.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00b741e0"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020091.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?638a4948"
  );
  script_set_attribute(
    attribute:"solution", 
