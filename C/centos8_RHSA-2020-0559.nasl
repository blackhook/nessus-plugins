...
# Red Hat Security Advisory RHSA-2020:0559. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : ksh (CESA-2020:0559)");
...
pkgs = [
    {'reference':'ksh-20120801-253.el8_1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'ksh-20120801-253.el8_1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
