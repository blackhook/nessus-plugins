...
if (description)
{
  ...
  script_name(english:"CentOS 6 : postgresql-jdbc (CESA-2020:3284)");
...
CESA-2020:3284 advisory.

  - postgresql-jdbc: XML external entity (XXE) vulnerability in PgSQLXML (CVE-2020-13692)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-August/035794.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2ec77748");
...
pkgs = [
    {'reference':'postgresql-jdbc-8.4.704-4.el6_10', 'sp':'10', 'release':'CentOS-6'}
];
