...
installing the update, cyrus-imapd will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2011-September/017746.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9b4977e"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-September/017747.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e1b82d88"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-September/018066.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8b1a853b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-September/018067.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e0f511d9"
  );
  script_set_attribute(
    attribute:"solution", 
