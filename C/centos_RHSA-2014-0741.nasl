...
# CentOS Errata and Security Advisory 2014:0741 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 / 6 : firefox (CESA-2014:0741)");
...
take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-June/020361.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?12a92ffb"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-June/020365.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd9f5f47"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-24.6.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-24.6.0-1.el6.centos", allowmaj:TRUE)) flag++;
