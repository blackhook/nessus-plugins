...
# CentOS Errata and Security Advisory 2012:0902 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : cifs-utils (CESA-2012:0902)");
...
these enhancements."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-July/018721.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a1a39f55"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:cifs-utils");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"cifs-utils-4.8.1-10.el6")) flag++;
