...
# Red Hat Security Advisory RHSA-2022:4797. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : maven:3.6 (CESA-2022:4797)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:4797 advisory.
...
var appstreams = {
    'maven:3.6': [
      {'reference':'guava-28.1-3.module_el8.6.0+1031+e2e9e02c', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'httpcomponents-client-4.5.10-4.module_el8.6.0+1031+e2e9e02c', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'maven-3.6.2-7.module_el8.6.0+1031+e2e9e02c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'maven-lib-3.6.2-7.module_el8.6.0+1031+e2e9e02c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'maven-openjdk11-3.6.2-7.module_el8.6.0+1031+e2e9e02c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'maven-openjdk17-3.6.2-7.module_el8.6.0+1031+e2e9e02c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'maven-openjdk8-3.6.2-7.module_el8.6.0+1031+e2e9e02c', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
};
