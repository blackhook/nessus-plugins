...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2021:4116)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-November/048400.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e1e2ffcf");
...
"Update the affected firefox package.");
  ...
  script_cwe_id(416, 732, 829, 1021);
...
var pkgs = [
    {'reference':'firefox-91.3.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
