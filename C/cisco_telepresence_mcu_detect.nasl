...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"0001-T-0560");
...
video teleconferencing device.");
  script_set_attribute(attribute:"see_also", value:"https://www.cisco.com/c/en/us/products/collaboration-endpoints/index.html");
