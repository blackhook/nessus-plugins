...
(SIDN Labs) as the original reporters."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2016-November/022136.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2cf33bb0"
  );
  # https://lists.centos.org/pipermail/centos-announce/2016-November/022137.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2bb6e530"
  );
