...
if (description)
{
  ...
  script_name(english:"CentOS 7 : cups (CESA-2020:3864)");
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-October/012674.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c6ed9a6c");
...
pkgs = [
    {'reference':'cups-1.6.3-51.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'cups-client-1.6.3-51.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'cups-devel-1.6.3-51.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'cups-devel-1.6.3-51.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'cups-filesystem-1.6.3-51.el7', 'release':'CentOS-7'},
    {'reference':'cups-ipptool-1.6.3-51.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'cups-libs-1.6.3-51.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'cups-libs-1.6.3-51.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'cups-lpd-1.6.3-51.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
