...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2021:3498)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-September/048364.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b392f6e7");
...
var pkgs = [
    {'reference':'firefox-78.14.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
