...
normally restricted to administrative users only.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20150916-pcp
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d2e3202b");
