...
automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-January/019099.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5c96afaf"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2013-January/000384.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?92b25a33"
  );
  script_set_attribute(
    attribute:"solution", 
