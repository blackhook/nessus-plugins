...
# CentOS Errata and Security Advisory 2013:0714 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : stunnel (CESA-2013:0714)");
...
contains a backported patch to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-April/019681.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bd30840d"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:stunnel");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"stunnel-4.29-3.el6_4")) flag++;
