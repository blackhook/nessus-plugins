...
# CentOS Errata and Security Advisory 2018:3005 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2018:3005)");
...
after restarting Firefox. (BZ#1638082)");
  # https://lists.centos.org/pipermail/centos-announce/2018-October/023072.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f50063c5");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-60.3.0-1.el7.centos", allowmaj:TRUE)) flag++;
