...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2020:3345)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-August/035795.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?03768b8d");
...
pkgs = [
    {'reference':'thunderbird-68.11.0-1.el6.centos', 'cpu':'i686', 'release':'CentOS-6', 'allowmaj':TRUE},
    {'reference':'thunderbird-68.11.0-1.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'allowmaj':TRUE}
];
