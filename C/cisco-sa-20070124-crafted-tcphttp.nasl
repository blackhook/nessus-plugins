...
# See http://www.cisco.com/en/US/products/csa/cisco-sa-20070124-crafted-tcp.html
#
...
if (description)
{
 ...
 script_xref(name:"CISCO-BUG-ID", value:"CSCee73956");
 script_xref(name:"CISCO-BUG-ID", value:"CSCek37177");
 script_xref(name:"CISCO-SA", value:"cisco-sa-20070124-crafted-tcp");

 script_name(english:"Crafted TCP Packet Can Cause Denial of Service");
