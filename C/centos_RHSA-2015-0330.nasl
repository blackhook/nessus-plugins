...
# CentOS Errata and Security Advisory 2015:0330 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : pcre (CESA-2015:0330)");
...
enhancement."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2015-March/001738.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fe58769f"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"pcre-8.32-14.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"pcre-devel-8.32-14.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"pcre-static-8.32-14.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"pcre-tools-8.32-14.el7")) flag++;
