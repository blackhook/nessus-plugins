...
# CentOS Errata and Security Advisory 2010:0400 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : tetex (CESA-2010:0400)");
...
which contain backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016661.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2095d829"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016662.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7efd23fe"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"tetex-3.0-33.8.el5_5.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"tetex-afm-3.0-33.8.el5_5.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"tetex-doc-3.0-33.8.el5_5.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"tetex-dvips-3.0-33.8.el5_5.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"tetex-fonts-3.0-33.8.el5_5.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"tetex-latex-3.0-33.8.el5_5.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"tetex-xdvi-3.0-33.8.el5_5.5")) flag++;
