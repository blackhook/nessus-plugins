...
# CentOS Errata and Security Advisory 2017:1263 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libtirpc (CESA-2017:1263)");
...
terminated by the OOM killer. (CVE-2017-8779)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43304b17"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libtirpc-0.2.4-0.8.el7_3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libtirpc-devel-0.2.4-0.8.el7_3")) flag++;
