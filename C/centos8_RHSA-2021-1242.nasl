...
# Red Hat Security Advisory RHSA-2021:1242. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : mariadb:10.3 and mariadb-devel:10.3 (CESA-2021:1242)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:1242 advisory.
...
var appstreams = {
    'mariadb-devel:10.3': [
      {'reference':'galera-25.3.32-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mariadb-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-backup-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-common-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-devel-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-embedded-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-embedded-devel-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-errmsg-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-gssapi-server-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-oqgraph-engine-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-server-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-server-galera-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-server-utils-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'},
      {'reference':'mariadb-test-10.3.28-1.module_el8.3.0+757+d382997d', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'3'}
    ]
};
