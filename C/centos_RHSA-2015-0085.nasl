...
OpenJDK Java must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2015-January/020898.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b81fbc6"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-January/020900.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?445ccfd7"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-January/020903.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?52cc4d6c"
  );
  script_set_attribute(
    attribute:"solution", 
