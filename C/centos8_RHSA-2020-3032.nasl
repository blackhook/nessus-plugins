...
# Red Hat Security Advisory RHSA-2020:3032. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : mod_auth_openidc:2.3 (CESA-2020:3032)");
...
var appstreams = {
    'mod_auth_openidc:2.3': [
      {'reference':'mod_auth_openidc-2.3.7-4.module_el8.2.0+463+d53af530.3', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mod_auth_openidc-2.3.7-4.module_el8.2.0+463+d53af530.3', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
