...
# CentOS Errata and Security Advisory 2013:1500 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : gc (CESA-2013:1500)");
...
gc must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-November/020015.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c39827c2"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:gc");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:gc-devel");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"gc-7.1-12.el6_4")) flag++;
if (rpm_check(release:"CentOS-6", reference:"gc-devel-7.1-12.el6_4")) flag++;
