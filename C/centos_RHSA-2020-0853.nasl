...
if (description)
{
  ...
  script_name(english:"CentOS 7 : zsh (CESA-2020:0853)");
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035665.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?221ddab2"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"zsh-5.0.2-34.el7_7.2")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"zsh-html-5.0.2-34.el7_7.2")) flag++;
