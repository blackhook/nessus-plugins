...
restarted for the changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-July/016038.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7be3d616"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-July/016039.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b575c7c6"
  );
  script_set_attribute(
    attribute:"solution", 
