...
# extracted from Red Hat Security Advisory RHSA-2005:074 and 
# CentOS Errata and Security Advisory 2005:074 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 3 : rsh (CESA-2005:074)");
...
resolve these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011673.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?035a9f34"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011724.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?31f88127"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011725.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1ec086a5"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011733.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83900f9b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011734.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c384a982"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-3", reference:"rsh-0.17-17.6")) flag++;
if (rpm_check(release:"CentOS-3", reference:"rsh-server-0.17-17.6")) flag++;
