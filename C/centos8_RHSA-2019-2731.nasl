...
# Red Hat Security Advisory RHSA-2019:2731. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : .NET Core on Red Hat Enterprise Linux (CESA-2019:2731)");
