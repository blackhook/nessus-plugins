...
affected by the following issues :
  ...
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20121010-asa
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?96e11331");
  script_set_attribute(attribute:"solution", value:
"Apply the relevant patch referenced in Cisco Security Advisory
cisco-sa-20121010-asa.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:C/I:P/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-4661");
