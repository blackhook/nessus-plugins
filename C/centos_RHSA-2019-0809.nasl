...
# CentOS Errata and Security Advisory 2019:0809 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ovmf (CESA-2019:0809)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-April/023280.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a7137ed6"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"OVMF-20180508-3.gitee3198e672e2.el7_6.1")) flag++;
