...
if (description)
{
  ...
  script_name(english:"CentOS 6 : icu (CESA-2020:0896)");
...
number."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035688.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43e63298"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"icu-4.2.1-15.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libicu-4.2.1-15.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libicu-devel-4.2.1-15.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libicu-doc-4.2.1-15.el6_10")) flag++;
