...
contains backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-October/019989.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d92af4dc"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-October/019990.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd1e2d34"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-6085");
