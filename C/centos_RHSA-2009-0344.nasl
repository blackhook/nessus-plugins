...
# CentOS Errata and Security Advisory 2009:0344 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : libsoup (CESA-2009:0344)");
...
must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-March/015678.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?86571949"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-May/015898.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2ba207e5"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-May/015899.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d5d5f7d7"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:evolution28-libsoup");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:evolution28-libsoup-devel");
...
flag = 0;
if (rpm_check(release:"CentOS-4", reference:"evolution28-libsoup-2.2.98-5.el4.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"evolution28-libsoup-devel-2.2.98-5.el4.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"libsoup-2.2.1-4.el4.1")) flag++;
if (rpm_check(release:"CentOS-4", reference:"libsoup-devel-2.2.1-4.el4.1")) flag++;
