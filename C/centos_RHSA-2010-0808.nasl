...
the update, Firefox must be restarted for the changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017127.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?29b1803b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-October/017128.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a14335f3"
  );
  script_set_attribute(
    attribute:"solution", 
