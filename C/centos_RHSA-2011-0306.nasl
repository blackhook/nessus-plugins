...
this update, the smb service will be restarted automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2011-April/017391.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?01790d02"
  );
  # https://lists.centos.org/pipermail/centos-announce/2011-April/017392.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c2354aef"
  );
  script_set_attribute(
    attribute:"solution", 
