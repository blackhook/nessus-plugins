...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2020:5099)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?52a5e766");
...
pkgs = [
    {'reference':'firefox-78.4.1-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'allowmaj':TRUE},
    {'reference':'firefox-78.4.1-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
