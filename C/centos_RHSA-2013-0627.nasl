...
restarted for the changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019642.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2c72d49a"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019643.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3021c932"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-17.0.3-2.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-17.0.3-2.el6.centos", allowmaj:TRUE)) flag++;
