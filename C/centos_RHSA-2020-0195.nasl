...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-reportlab (CESA-2020:0195)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-January/035614.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1c4f066c"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected python-reportlab packages."
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"python-reportlab-2.5-9.el7_7.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"python-reportlab-docs-2.5-9.el7_7.1")) flag++;
