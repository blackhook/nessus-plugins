...
if (description)
{
  ...
  script_xref(name:"CISCO-BUG-ID", value:"CSCwc12673");
  script_xref(name:"CISCO-SA", value:"cisco-sa-ucm-access-dMKvV2DY");
  script_xref(name:"IAVA", value:"2022-A-0266");

  script_name(english:"Cisco Unity Connection Improper Access Control (cisco-sa-ucm-access-dMKvV2DY)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"The version of Cisco Unity Connection installed on the remote host is 14.x prior to 14SU2. It is, therefore, affected
by an improper access control vulnerability. An authenticated attacker with read-only privileges can exploit this
vulnerability to perform a set of administrative actions they should not be able to.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwc12673");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCwc12673");
...
var constraints = [
  # https://software.cisco.com/download/home/286328409/type/286319533/release/14SU2?i=!pp
  {'min_version': '14,0', 'fixed_version': '14.0.1.12900.69', 'fixed_display': '14SU2'}
];
