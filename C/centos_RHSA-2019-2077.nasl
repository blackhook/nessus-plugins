...
# extracted from Red Hat Security Advisory RHSA-2019:2077 and 
# CentOS Errata and Security Advisory 2019:2077 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ntp (CESA-2019:2077)");
...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?165f5139"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntp-4.2.6p5-29.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntp-doc-4.2.6p5-29.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntp-perl-4.2.6p5-29.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ntpdate-4.2.6p5-29.el7.centos")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sntp-4.2.6p5-29.el7.centos")) flag++;
