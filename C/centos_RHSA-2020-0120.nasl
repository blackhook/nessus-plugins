...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2020:0120)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2020-January/035602.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9648a39b");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"thunderbird-68.4.1-2.el7.centos", allowmaj:TRUE)) flag++;
