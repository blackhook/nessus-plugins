...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2021:2206)");
...
CESA-2021:2206 advisory.

  - Mozilla: Memory safety bugs fixed in Firefox 89 and Firefox ESR 78.11 (CVE-2021-29967)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-June/048317.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?660a0446");
...
pkgs = [
    {'reference':'firefox-78.11.0-3.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
