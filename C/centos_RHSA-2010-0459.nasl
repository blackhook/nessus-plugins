...
effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-June/016729.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?680068eb"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-June/016730.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b4a6f618"
  );
  script_set_attribute(
    attribute:"solution", 
