...
if (description)
{
  ...
  script_name(english:"CentOS 7 : tigervnc (CESA-2023:0045)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2023:0045 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2023-January/086362.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6777635c");
...
var pkgs = [
    ...
    {'reference':'tigervnc-icons-1.8.0-23.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-license-1.8.0-23.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-1.8.0-23.el7_9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'tigervnc-server-applet-1.8.0-23.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
