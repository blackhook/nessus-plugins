...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libvncserver (CESA-2020:3281)");
...
CESA-2020:3281 advisory.

  - libvncserver: websocket decoding buffer overflow (CVE-2017-18922)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2020-August/035790.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a47221f7");
...
pkgs = [
    {'reference':'libvncserver-0.9.9-14.el7_8.1', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libvncserver-0.9.9-14.el7_8.1', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'libvncserver-devel-0.9.9-14.el7_8.1', 'sp':'8', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libvncserver-devel-0.9.9-14.el7_8.1', 'sp':'8', 'cpu':'x86_64', 'release':'CentOS-7'}
];
