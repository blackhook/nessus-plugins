...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libcroco (CESA-2020:4072)");
...
CESA-2020:4072 advisory.

  - libcroco: Stack overflow in function cr_parser_parse_any_core in cr-parser.c (CVE-2020-12825)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-November/012873.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?01211c44");
...
pkgs = [
    {'reference':'libcroco-0.6.12-6.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libcroco-0.6.12-6.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'libcroco-devel-0.6.12-6.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'libcroco-devel-0.6.12-6.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
