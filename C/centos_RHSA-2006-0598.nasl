...
# extracted from Red Hat Security Advisory RHSA-2006:0598 and 
# CentOS Errata and Security Advisory 2006:0598 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : gimp (CESA-2006:0598)");
...
contain a backported fix to correct this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-July/013032.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?63cda0ac"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-July/013038.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f74c317f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-July/013039.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?09dd3d35"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-4", reference:"gimp-2.0.5-6")) flag++;
if (rpm_check(release:"CentOS-4", reference:"gimp-devel-2.0.5-6")) flag++;
