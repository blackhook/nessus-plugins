...
# CentOS Errata and Security Advisory 2017:2459 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libsoup (CESA-2017:2459)");
...
reporting this issue."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2017-August/004678.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d0ee3dec"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libsoup-2.56.0-4.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libsoup-devel-2.56.0-4.el7_4")) flag++;
