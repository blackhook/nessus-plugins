...
# CentOS Errata and Security Advisory 2019:3755 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : sudo (CESA-2019:3755)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2019-November/023510.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c3e60c4b");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"sudo-1.8.6p3-29.el6_10.2")) flag++;
if (rpm_check(release:"CentOS-6", reference:"sudo-devel-1.8.6p3-29.el6_10.2")) flag++;
