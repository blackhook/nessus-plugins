...
XULRunner must be restarted for the changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-February/018440.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7f8d3356"
  );
  # https://lists.centos.org/pipermail/centos-announce/2012-February/018443.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?94e861db"
  );
  script_set_attribute(
    attribute:"solution", 
