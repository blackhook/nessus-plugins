...
to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-July/016765.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fb9f892b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-July/016766.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cd0980bd"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-July/016807.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b3963a55"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-July/016808.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4785d6fd"
  );
  script_set_attribute(
    attribute:"solution", 
