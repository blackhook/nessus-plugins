...
contain a backported patch, and are not vulnerable to this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011758.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?dc6fb02b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011759.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?db98bb5f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011763.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?20225440"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-May/011764.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7eee4fc2"
  );
  script_set_attribute(
    attribute:"solution", 
