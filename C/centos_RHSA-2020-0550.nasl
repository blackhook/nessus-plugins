...
if (description)
{
  ...
  script_name(english:"CentOS 7 : openjpeg2 (CESA-2020:0550)");
  ...
  script_set_attribute(
    ...
    value:
"An update for openjpeg2 is now available for Red Hat Enterprise Linux
7.
...
in openjp2/t1.c (CVE-2020-8112)

For more details about the security issue(s), including the impact, a
CVSS score, acknowledgments, and other related information, refer to
the CVE page(s) listed in the References section."
  );
  # https://lists.centos.org/pipermail/centos-announce/2020-February/035644.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2bb2ad1c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openjpeg2-2.3.1-3.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openjpeg2-devel-2.3.1-3.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openjpeg2-devel-docs-2.3.1-3.el7_7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"openjpeg2-tools-2.3.1-3.el7_7")) flag++;
