...
# CentOS Errata and Security Advisory 2019:2003 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : icedtea-web (CESA-2019:2003)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-April/012466.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e4b9fc7b");
...
"Update the affected icedtea-web packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:icedtea-web-devel");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"icedtea-web-1.7.1-2.el7_6")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"icedtea-web-devel-1.7.1-2.el7_6")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"icedtea-web-javadoc-1.7.1-2.el7_6")) flag++;
