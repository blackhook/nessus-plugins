...
if (description)
{
  ...
  script_name(english:"CentOS 6 : tomcat6 (CESA-2020:0912)");
...
documented in Red Hat advisory RHSA-2020:0912."
  );
  # https://lists.centos.org/pipermail/centos-announce/2020-March/035687.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?76261018"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-admin-webapps-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-docs-webapp-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-el-2.1-api-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-javadoc-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-jsp-2.1-api-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-lib-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-servlet-2.5-api-6.0.24-114.el6_10")) flag++;
if (rpm_check(release:"CentOS-6", reference:"tomcat6-webapps-6.0.24-114.el6_10")) flag++;
