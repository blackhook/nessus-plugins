...
other users in the process.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://secuniaresearch.flexerasoftware.com/secunia_research/2011-68/");
...
soc = open_sock_tcp(port, transport:ENCAPS_IP, timeout:get_read_timeout() + 5);
