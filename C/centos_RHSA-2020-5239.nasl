...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2020:5239)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3bb2cd04");
...
pkgs = [
    {'reference':'firefox-78.5.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'allowmaj':TRUE},
    {'reference':'firefox-78.5.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
