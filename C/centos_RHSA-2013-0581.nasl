...
effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019260.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d2f55acd"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-March/019627.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?277a00c2"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2013-March/000813.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7ffc1e28"
  );
  script_set_attribute(
    attribute:"solution", 
