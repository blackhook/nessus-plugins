...
automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-June/015999.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?06e7ae56"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-June/016000.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cf674c1a"
  );
  script_set_attribute(
    attribute:"solution", 
