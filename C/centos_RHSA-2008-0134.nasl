...
contain backported patches which resolve these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014691.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b6c62a2f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014706.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d9877493"
  );
  # https://lists.centos.org/pipermail/centos-announce/2008-February/014707.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c1c53650"
  );
  script_set_attribute(
    attribute:"solution", 
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "expect / expect-devel / expectk / itcl / tcl / tcl-devel / tcl-html / etc");
}
