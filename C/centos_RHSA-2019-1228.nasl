...
# CentOS Errata and Security Advisory 2019:1228 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : wget (CESA-2019:1228)");
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?29125c5a"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"wget-1.14-18.el7_6.1")) flag++;
