...
restarted for the changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-February/018444.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?39a81b8a"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-3.1.18-2.el6.centos", allowmaj:TRUE)) flag++;
