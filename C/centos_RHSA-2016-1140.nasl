...
# CentOS Errata and Security Advisory 2016:1140 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : squid34 (CESA-2016:1140)");
...
attack. (CVE-2016-4556)"
  ...
  # https://lists.centos.org/pipermail/centos-announce/2016-May/021897.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?faf57fb2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"squid34-3.4.14-9.el6_8.3")) flag++;
