...
if (description)
{
  ...
  script_name(english:"Cisco Content Security Management Appliance Web UI Default Credentials");
...
"It is possible to log into Cisco Content Security Management
Appliance's web management console using default credentials.");
  # https://www.cisco.com/c/dam/en/us/td/docs/security/security_management/sma/sma7-9/SMA_7-9_User_Guide.pdf
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?894b7420");
...
password.");
  ...
  script_dependencies("cisco_sma_web_detect.nasl");
...
app_name = "Cisco Content Security Management Appliance Web UI";
install = get_install_from_kb(appname:"cisco_sma", port:port, exit_on_fail:FALSE);
