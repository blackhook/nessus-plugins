...
if (description)
{
  ...
  script_cve_id("CVE-2022-20865");
  script_xref(name:"CISCO-SA", value:"cisco-sa-fxos-cmdinj-TxcLNZNH");
  script_xref(name:"CISCO-BUG-ID", value:"CSCwc38361");
  script_xref(name:"IAVA", value:"2022-A-0343");

  script_name(english:"Cisco FXOS Software Unidirectional Link Detection Command Injection (cisco-sa-fxos-cmdinj-TxcLNZNH)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?552131fe");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwc38361");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug IDs CSCwc38361");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:M/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-20865");
