...
# Red Hat Security Advisory RHSA-2020:2070. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : libreswan (CESA-2020:2070)");
...
pkgs = [
    {'reference':'libreswan-3.29-7.el8_2', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libreswan-3.29-7.el8_2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
