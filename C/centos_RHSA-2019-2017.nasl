...
# extracted from Red Hat Security Advisory RHSA-2019:2017 and 
# CentOS Errata and Security Advisory 2019:2017 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : zsh (CESA-2019:2017)");
...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/006195.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?16be18ab"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"zsh-5.0.2-33.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"zsh-html-5.0.2-33.el7")) flag++;
