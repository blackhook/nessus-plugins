...
# Red Hat Security Advisory RHSA-2023:3067. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : autotrace (CESA-2023:3067)");
...
var pkgs = [
    {'reference':'autotrace-0.31.1-55.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'autotrace-0.31.1-55.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
