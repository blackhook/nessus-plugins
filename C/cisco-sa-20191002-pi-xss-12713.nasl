...
if (description)
{
  ...
  script_cve_id("CVE-2019-12713");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvq27936");
  script_xref(name:"CISCO-SA", value:"cisco-sa-20191002-pi-xss-12713");

  script_name(english:"Cisco Prime Infrastructure Cross-Site Scripting (cisco-sa-20191002-pi-xss-12713)");
...
The vulnerability is due to insufficient validation of user-supplied input by the web-based management interface of the
affected software. An attacker could exploit this vulnerability by persuading a user of the interface to click a
...
Please see the included Cisco BIDs and Cisco Security Advisory for more information");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7929002b");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvq27936");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvq27936");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-12713");
