...
if (description)
{
  ...
  script_name(english:"CentOS 6 : firefox (CESA-2020:3558)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?5f2577fe");
...
pkgs = [
    {'reference':'firefox-68.12.0-1.el6.centos', 'cpu':'i686', 'release':'CentOS-6', 'allowmaj':TRUE},
    {'reference':'firefox-68.12.0-1.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6', 'allowmaj':TRUE}
];
