...
if (description)
{
  ...
  script_cve_id("CVE-2015-0663");
  script_bugtraq_id(73122);
  script_xref(name:"CISCO-BUG-ID", value:"CSCus79392");

  script_name(english:"Cisco AnyConnect Secure Mobility Client < 3.1.10010.0 / 4.0.x < 4.0.4013.0 / 4.1.x < 4.1.4011.0 IPC File Write Vulnerability");
...
4.0.4013.0, or version 4.1.x prior to 4.1.4011.0. It is, therefore,
affected by a flaw that allows unauthenticated IPC commands to write
files. A local, authenticated attacker, using a specially crafted IPC
command, can write or overwrite arbitrary files.");
  script_set_attribute(attribute:"see_also", value:"https://tools.cisco.com/security/center/viewAlert.x?alertId=37863");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Cisco AnyConnect Secure Mobility Client version
3.1.10010.0 / 4.0.4013.0 / 4.1.4011.0 or later");
...
if (ver =~ "^4\.1\." && (ver_compare(ver:ver, fix:'4.1.4011.0', strict:FALSE) < 0))
  fix = '4.1.4011.0';
else if (ver =~ "^4\.0\." && (ver_compare(ver:ver, fix:'4.0.4013.0', strict:FALSE) < 0))
  fix = '4.0.4013.0';
