...
if (description)
{
  ...
  script_cve_id("CVE-2020-3601");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvv34214");
  script_xref(name:"CISCO-SA", value:"cisco-sa-staros-priv-esc-gGCUMFxv");
  script_xref(name:"IAVA", value:"2020-A-0451");

  script_name(english:"Cisco StarOS Privilege Escalation (cisco-sa-staros-priv-esc-gGCUMFxv)");
...
Please see the included Cisco BIDs and Cisco Security Advisory for more information.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?feddeef7");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvv34214");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvv34214");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:H/UI:N/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-3601");
