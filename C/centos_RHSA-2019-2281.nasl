...
# extracted from Red Hat Security Advisory RHSA-2019:2281 and 
# CentOS Errata and Security Advisory 2019:2281 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ghostscript (CESA-2019:2281)");
...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/005884.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43a40c24"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-9.25-2.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-cups-9.25-2.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-doc-9.25-2.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-gtk-9.25-2.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libgs-9.25-2.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libgs-devel-9.25-2.el7")) flag++;
