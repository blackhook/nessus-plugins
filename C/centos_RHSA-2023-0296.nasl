...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2023:0296)");
...
number.");
  # https://lists.centos.org/pipermail/centos-announce/2023-January/086353.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b1edd034");
...
var pkgs = [
    {'reference':'firefox-102.7.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
