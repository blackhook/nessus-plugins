...
if (description)
{
  ...
  script_cve_id("CVE-2021-1567");
  script_xref(name:"CISCO-BUG-ID", value:"CSCvx52084");
  script_xref(name:"CISCO-SA", value:"cisco-sa-anyconnect-pos-dll-ff8j6dFv");
  script_xref(name:"IAVA", value:"2021-A-0290-S");

  script_name(english:"Cisco AnyConnect Secure Mobility Client for Windows with VPN Posture (HostScan) Module DLL Hijacking Vulnerability (cisco-sa-anyconnect-pos-dll-ff8j6dFv)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch (cisco-sa-anyconnect-pos-dll-ff8j6dFv)");
...
vulnerability as referenced in the cisco-sa-anyconnect-pos-dll-ff8j6dFv advisory. Note that Nessus has not tested for
this issue but has instead relied only on the application's self-reported version number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?56ff9e0a");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvx52084");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvx52084");
  script_set_attribute(attribute:"agent", value:"windows");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:C/I:C/A:C");
  script_set_cvss_temporal_vector("CVSS2#E:F/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:H/PR:L/UI:R/S:U/C:H/I:H/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:F/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2021-1567");
