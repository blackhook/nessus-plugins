...
# extracted from Red Hat Security Advisory RHSA-2007:1030 and 
# CentOS Errata and Security Advisory 2007:1030 respectively.
#
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2007:1030");

  script_name(english:"CentOS 3 : xpdf (CESA-2007:1030)");
...
backported patches to resolve these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-November/014376.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b7cd6250"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-November/014382.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2463c4ec"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-November/014383.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?805df126"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-3", reference:"xpdf-2.02-11.el3")) flag++;
