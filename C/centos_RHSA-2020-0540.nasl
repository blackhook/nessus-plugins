...
if (description)
{
  ...
  script_name(english:"CentOS 7 : sudo (CESA-2020:0540)");
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74285a6d"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-1.8.23-4.el7_7.2")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-devel-1.8.23-4.el7_7.2")) flag++;
