...
# CentOS Errata and Security Advisory 2018:3761 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : ghostscript (CESA-2018:3761)");
...
been re-added to support those use cases. (BZ#1654290)"
  ...
  # https://lists.centos.org/pipermail/centos-announce/2018-December/023101.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?391d0f86"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-9.07-31.el7_6.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-cups-9.07-31.el7_6.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-devel-9.07-31.el7_6.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-doc-9.07-31.el7_6.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"ghostscript-gtk-9.07-31.el7_6.3")) flag++;
