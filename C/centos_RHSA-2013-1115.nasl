...
# CentOS Errata and Security Advisory 2013:1115 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : bind97 (CESA-2013:1115)");
...
automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-July/019880.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?8fa45874"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"bind97-9.7.0-17.P2.el5_9.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-chroot-9.7.0-17.P2.el5_9.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-devel-9.7.0-17.P2.el5_9.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-libs-9.7.0-17.P2.el5_9.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"bind97-utils-9.7.0-17.P2.el5_9.2")) flag++;
