...
# Red Hat Security Advisory RHSA-2021:1574. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : NetworkManager and libnma (CESA-2021:1574)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:1574 advisory.
...
"Update the affected libnma and / or libnma-devel packages.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'libnma / libnma-devel');
}
