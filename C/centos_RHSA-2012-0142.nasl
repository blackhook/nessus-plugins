...
restarted for the changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-February/018441.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7acfa334"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"firefox-3.6.26-3.el4.centos", allowmaj:TRUE)) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"firefox-3.6.26-3.el4.centos", allowmaj:TRUE)) flag++;
