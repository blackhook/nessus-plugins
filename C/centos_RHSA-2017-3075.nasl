...
# CentOS Errata and Security Advisory 2017:3075 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : wget (CESA-2017:3075)");
...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cdad3d4f"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"wget-1.14-15.el7_4.1")) flag++;
