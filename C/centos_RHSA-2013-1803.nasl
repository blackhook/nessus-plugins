...
# CentOS Errata and Security Advisory 2013:1803 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : libjpeg-turbo (CESA-2013:1803)");
...
packages, which contain backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020054.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cb78fc3b"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"libjpeg-turbo-1.2.1-3.el6_5")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libjpeg-turbo-devel-1.2.1-3.el6_5")) flag++;
if (rpm_check(release:"CentOS-6", reference:"libjpeg-turbo-static-1.2.1-3.el6_5")) flag++;
