...
take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-June/018694.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a5c69b1b"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-0044");
