...
if (description)
{
  ...
  script_name(english:"CentOS 7 : java-11-openjdk (CESA-2020:4307)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2020:4307 advisory.
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-November/012871.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?c71715f9");
...
pkgs = [
    {'reference':'java-11-openjdk-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-demo-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-demo-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-devel-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-devel-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-headless-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-headless-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-javadoc-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-javadoc-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-javadoc-zip-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-javadoc-zip-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-jmods-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-jmods-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-src-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-src-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-static-libs-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'java-11-openjdk-static-libs-11.0.9.11-0.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7'}
];
