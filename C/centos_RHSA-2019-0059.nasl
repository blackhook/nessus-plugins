...
# CentOS Errata and Security Advisory 2019:0059 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libvncserver (CESA-2019:0059)");
...
listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-January/023144.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?085e9bc4"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libvncserver-0.9.9-13.el7_6")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libvncserver-devel-0.9.9-13.el7_6")) flag++;
