...
if (description)
{
  ...
  script_name(english:"CentOS 7 : gzip (CESA-2022:2191)");
...
CESA-2022:2191 advisory.

  - gzip: arbitrary-file-write vulnerability (CVE-2022-1271)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-May/073585.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?6e0c48c4");
