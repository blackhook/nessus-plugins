...
# extracted from Red Hat Security Advisory RHSA-2007:0022 and 
# CentOS Errata and Security Advisory 2007:0022 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 3 / 4 : squirrelmail (CESA-2007:0022)");
...
manually is recommended."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2007-February/013500.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?05c0a774"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-February/013501.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?2a4f781b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-February/013502.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf4c6772"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-January/013487.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?631a383c"
  );
  # https://lists.centos.org/pipermail/centos-announce/2007-January/013488.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?62506789"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-3", cpu:"i386", reference:"squirrelmail-1.4.8-4.el3.centos.1")) flag++;
if (rpm_check(release:"CentOS-3", cpu:"x86_64", reference:"squirrelmail-1.4.8-4.el3.centos.1")) flag++;

if (rpm_check(release:"CentOS-4", reference:"squirrelmail-1.4.8-4.el4")) flag++;
