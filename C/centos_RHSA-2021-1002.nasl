...
if (description)
{
  ...
  script_name(english:"CentOS 7 : flatpak (CESA-2021:1002)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:1002 advisory.

  - flatpak: file forwarding feature can be used to gain unprivileged access to files (CVE-2021-21381)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2021-August/048346.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a4a66ee8");
...
var pkgs = [
    {'reference':'flatpak-1.0.9-11.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-builder-1.0.0-11.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-devel-1.0.9-11.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'flatpak-libs-1.0.9-11.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
