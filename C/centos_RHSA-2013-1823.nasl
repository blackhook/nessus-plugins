...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020068.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b60bfded"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020072.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?d305d56d"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-24.2.0-2.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-24.2.0-1.el6.centos", allowmaj:TRUE)) flag++;
