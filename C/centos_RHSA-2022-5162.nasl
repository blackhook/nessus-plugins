...
if (description)
{
  ...
  script_name(english:"CentOS 7 : postgresql (CESA-2022:5162)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:5162 advisory.

  - postgresql: Autovacuum, REINDEX, and others omit security restricted operation sandbox (CVE-2022-1552)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-August/073617.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?da94aca7");
...
var pkgs = [
    {'reference':'postgresql-9.2.24-8.el7_9', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'postgresql-devel-9.2.24-8.el7_9', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'postgresql-libs-9.2.24-8.el7_9', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'postgresql-static-9.2.24-8.el7_9', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
