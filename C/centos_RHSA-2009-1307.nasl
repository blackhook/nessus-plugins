...
which resolve these issues and add these enhancements."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-September/016145.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?72ae1203"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-September/016146.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fe32bbd5"
  );
  script_set_attribute(
    attribute:"solution", 
