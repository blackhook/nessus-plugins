...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2020:0123)");
...
the CVE page(s) listed in the References section.");
  # https://lists.centos.org/pipermail/centos-announce/2020-January/035601.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ddf4ecf1");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-68.4.1-2.el6.centos", allowmaj:TRUE)) flag++;
