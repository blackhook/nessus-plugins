...
the device with TCP connection requests.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20130515-mse
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ee4dbe26");
