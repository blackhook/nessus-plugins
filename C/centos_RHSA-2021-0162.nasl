...
if (description)
{
  ...
  script_name(english:"CentOS 7 : xstream (CESA-2021:0162)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2021:0162 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60dd584b");
...
pkgs = [
    {'reference':'xstream-1.3.1-12.el7_9', 'sp':'9', 'release':'CentOS-7'},
    {'reference':'xstream-javadoc-1.3.1-12.el7_9', 'sp':'9', 'release':'CentOS-7'}
];
