...
packages, which contain backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-August/020470.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?5bed0c16"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-August/020473.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1b8d33b9"
  );
  script_set_attribute(
    attribute:"solution", 
