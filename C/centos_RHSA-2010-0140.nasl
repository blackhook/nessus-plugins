...
restart your X session for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016560.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9e743ba9"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016561.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?48d97f98"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016566.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4286e245"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016567.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9be7d719"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016568.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3601f293"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016569.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?61f2b9a4"
  );
  script_set_attribute(
    attribute:"solution", 
