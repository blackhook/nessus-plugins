...
issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2008-March/014752.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?42563491"
  );
  # https://lists.centos.org/pipermail/centos-announce/2008-March/014753.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?db68b415"
  );
  script_set_attribute(
    attribute:"solution", 
