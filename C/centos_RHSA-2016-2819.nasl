...
# CentOS Errata and Security Advisory 2016:2819 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : memcached (CESA-2016:2819)");
...
(CVE-2016-8706)"
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2016-November/003682.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?fd1975cb"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-8704");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"memcached-1.4.15-10.el7_3.1")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"memcached-devel-1.4.15-10.el7_3.1")) flag++;
