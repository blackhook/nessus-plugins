...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2020:4310)");
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-November/012868.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?adc60dc2");
...
pkgs = [
    {'reference':'firefox-78.4.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'allowmaj':TRUE},
    {'reference':'firefox-78.4.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
