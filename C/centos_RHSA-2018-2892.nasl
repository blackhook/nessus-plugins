...
# CentOS Errata and Security Advisory 2018:2892 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : glusterfs (CESA-2018:2892)");
...
reporting this issue.");
  # https://lists.centos.org/pipermail/centos-announce/2018-October/023058.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45850655");
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-api-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-api-devel-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-cli-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-client-xlators-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-devel-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-fuse-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-libs-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"glusterfs-rdma-3.12.2-18.el6")) flag++;
if (rpm_check(release:"CentOS-6", reference:"python2-gluster-3.12.2-18.el6")) flag++;
