...
# Changes by Tenable:
# - Revised plugin title, revamped desc to cover multiple scripts (4/28/09)
...
issues." );
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2006/Nov/418" );
