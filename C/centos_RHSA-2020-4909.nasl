...
if (description)
{
  ...
  script_name(english:"CentOS 7 : thunderbird (CESA-2020:4909)");
...
number.");
  # https://lists.centos.org/pipermail/centos-cr-announce/2020-November/012869.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d28ed346");
...
pkgs = [
    {'reference':'thunderbird-78.4.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
