...
issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2005-July/011984.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?ad4ba666"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-July/011985.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?201d5e5b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-July/011994.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b1aea541"
  );
  script_set_attribute(
    attribute:"solution", 
