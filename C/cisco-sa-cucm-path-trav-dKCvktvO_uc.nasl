...
if (description)
{
  ...
  script_name(english:"Cisco Unity Connect Path Traversal (cisco-sa-cucm-path-trav-dKCvktvO)");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"The version of Cisco Unity Connection installed on the remote host is prior to 14SU1. It is, therefore, affected by a
path traversal vulnerability in the web-based management interface that allows an authenticated, remote attacker to
access sensitive data. This is caused by improperly validated data.
...
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCvy89691");
...
var constraints = [
  { 'fixed_version': '14.0.1.11900.132', 'fixed_display' : '14SU1' }
];
