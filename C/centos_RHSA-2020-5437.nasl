...
if (description)
{
  ...
  script_name(english:"CentOS 7 : kernel (CESA-2020:5437)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e2f5434");
...
pkgs = [
    {'reference':'bpftool-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-abi-whitelists-3.10.0-1160.11.1.el7', 'release':'CentOS-7'},
    {'reference':'kernel-debug-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-debug-devel-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-devel-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-headers-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-tools-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-tools-libs-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'kernel-tools-libs-devel-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'perf-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'python-perf-3.10.0-1160.11.1.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
