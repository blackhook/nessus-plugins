...
# CentOS Errata and Security Advisory 2014:2025 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : ntp (CESA-2014:2025)");
...
the update, the ntpd daemon will restart automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-December/020851.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b872d222"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"ntp-4.2.2p1-18.el5.centos")) flag++;
