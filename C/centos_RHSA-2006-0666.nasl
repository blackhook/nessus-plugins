...
contain a backported patch and is not vulnerable to this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-September/013218.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3a2ef24a"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-September/013250.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6553bd54"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-September/013251.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c1a5d459"
  );
  script_set_attribute(
    attribute:"solution", 
