...
# CentOS Errata and Security Advisory 2009:1232 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 / 5 : gnutls (CESA-2009:1232)");
...
which contain a backported patch that corrects this issue."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-August/016111.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?897036af"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-August/016112.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?33e7a995"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-August/016115.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?04b00768"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-August/016116.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4e54384f"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"gnutls-1.0.20-4.el4_8.3")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"gnutls-1.0.20-4.el4_8.3")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"gnutls-devel-1.0.20-4.el4_8.3")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"gnutls-devel-1.0.20-4.el4_8.3")) flag++;

if (rpm_check(release:"CentOS-5", reference:"gnutls-1.4.1-3.el5_3.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"gnutls-devel-1.4.1-3.el5_3.5")) flag++;
if (rpm_check(release:"CentOS-5", reference:"gnutls-utils-1.4.1-3.el5_3.5")) flag++;
