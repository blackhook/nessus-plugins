...
# Red Hat Security Advisory RHSA-2020:0130. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : .NET Core on Red Hat Enterprise Linux (CESA-2020:0130)");
...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:aspnetcore-runtime-3.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:aspnetcore-targeting-pack-3.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dotnet-apphost-pack-3.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dotnet-host");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dotnet-hostfxr-3.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dotnet-runtime-3.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dotnet-sdk-3.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dotnet-targeting-pack-3.0");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:dotnet-templates-3.0");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'aspnetcore-runtime-3.0 / aspnetcore-targeting-pack-3.0 / etc');
}
