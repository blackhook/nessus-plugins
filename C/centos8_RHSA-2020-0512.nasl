...
# Red Hat Security Advisory RHSA-2020:0512. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : firefox (CESA-2020:0512)");
...
pkgs = [
    {'reference':'firefox-68.5.0-2.el8_1', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'firefox-68.5.0-2.el8_1', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
