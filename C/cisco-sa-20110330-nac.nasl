...
remote/unauthenticated attacker access to a protected network."
  ...
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20110330-nac
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?fcc4c3cf");
  script_set_attribute(
    attribute:"solution",
    value:
