...
# CentOS Errata and Security Advisory 2016:2872 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : sudo (CESA-2016:2872)");
...
These issues were discovered by Florian Weimer (Red Hat)."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2016-December/022171.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1bf5041f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2017-June/022469.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?143478c6"
  );
  # https://lists.centos.org/pipermail/centos-cr-announce/2016-December/003710.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22c0473e"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"sudo-1.8.6p3-25.el6_8")) flag++;
if (rpm_check(release:"CentOS-6", reference:"sudo-devel-1.8.6p3-25.el6_8")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-1.8.6p7-21.el7_3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-devel-1.8.6p7-21.el7_3")) flag++;
