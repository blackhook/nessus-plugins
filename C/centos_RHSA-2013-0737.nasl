...
using mod_dav_svn, for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-April/019687.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?890c3115"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-April/019688.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3d050442"
  );
  script_set_attribute(
    attribute:"solution", 
