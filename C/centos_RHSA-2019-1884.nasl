...
# CentOS Errata and Security Advisory 2019:1884 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : libssh2 (CESA-2019:1884)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2019-July/023383.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e2d553cb"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libssh2-1.4.3-12.el7_6.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libssh2-devel-1.4.3-12.el7_6.3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libssh2-docs-1.4.3-12.el7_6.3")) flag++;
