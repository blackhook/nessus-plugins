...
contain backported fixes for these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012890.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b3d5791f"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012891.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1fab6779"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012894.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?80aed1ef"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012895.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3db898e8"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012897.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e193f496"
  );
  # https://lists.centos.org/pipermail/centos-announce/2006-May/012900.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?21d6ee2d"
  );
  script_set_attribute(
    attribute:"solution", 
