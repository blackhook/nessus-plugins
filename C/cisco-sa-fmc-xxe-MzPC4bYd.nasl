...
if (description)
{
  ...
  script_cve_id("CVE-2022-20938");
  script_xref(name:"CISCO-BUG-ID", value:"CSCwb53694");
  script_xref(name:"CISCO-SA", value:"cisco-sa-fmc-xxe-MzPC4bYd");
  script_xref(name:"IAVA", value:"2022-A-0486");

  script_name(english:"Cisco Firepower Management Center Software XXE Injection (cisco-sa-fmc-xxe-MzPC4bYd)");
...
therefore, affected by a vulnerability in the module import function of the administrative interface of Cisco Firepower
Management Center (FMC) Software due to insufficient validation of the XML syntax when importing a module. An 
authenticated, remote attacker could exploit this vulnerability by supplying a specially crafted XML file to the 
function. A successful exploit could allow the attacker to read sensitive data that would normally not be revealed.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-fmc-xxe-MzPC4bYd
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4808b723");
  script_set_attribute(attribute:"see_also", value:"https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwb53694");
  script_set_attribute(attribute:"solution", value:
"Upgrade to the relevant fixed version referenced in Cisco bug ID CSCwb53694");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:P/I:N/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:L/I:N/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-20938");
