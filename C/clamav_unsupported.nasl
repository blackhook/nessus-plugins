...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"0001-A-0528");
...
security vulnerabilities.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/Cisco-Talos/clamav-faq/blob/master/faq/faq-eol.md");
