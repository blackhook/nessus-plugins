...
OpenJDK Java must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2014-July/020413.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?6dc931b4"
  );
  # https://lists.centos.org/pipermail/centos-announce/2014-July/020415.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?4bfb1de9"
  );
  script_set_attribute(
    attribute:"solution", 
