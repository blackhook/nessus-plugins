...
# CentOS Errata and Security Advisory 2017:1574 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 / 7 : sudo (CESA-2017:1574)");
...
escalate their privileges to root. (CVE-2017-1000368)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c45b7881"
  );
  # https://lists.centos.org/pipermail/centos-announce/2017-June/022470.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?56af12da"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"sudo-1.8.6p3-29.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"sudo-devel-1.8.6p3-29.el6_9")) flag++;

if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-1.8.6p7-23.el7_3")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"sudo-devel-1.8.6p7-23.el7_3")) flag++;
