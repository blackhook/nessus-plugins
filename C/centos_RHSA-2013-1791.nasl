...
# CentOS Errata and Security Advisory 2013:1791 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : nspr / nss (CESA-2013:1791)");
...
restarted for this update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020046.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?beb8cbfb"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020047.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?9969c7a4"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-1741");
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"nspr-4.10.2-2.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"nspr-devel-4.10.2-2.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"nss-3.15.3-3.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"nss-devel-3.15.3-3.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"nss-pkcs11-devel-3.15.3-3.el5_10")) flag++;
if (rpm_check(release:"CentOS-5", reference:"nss-tools-3.15.3-3.el5_10")) flag++;
