...
applications that are allowed on the affected Citrix server.");
 script_set_attribute(attribute:"see_also", value:"https://packetstormsecurity.com/files/29932/hackingcitrix.txt.html");
 script_set_attribute(attribute:"see_also", value:"https://seclists.org/bugtraq/2002/Sep/292");
...
script_set_attribute(attribute:"plugin_publication_date", value:"2002/10/09");
 ...
 script_copyright(english:"This script is Copyright (C) 2002-2020 John Lampe...j_lampe@bellsouth.net");
