...
the update, the ntpd daemon will restart automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2009-December/016352.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c8d2e8e8"
  );
  # https://lists.centos.org/pipermail/centos-announce/2009-December/016353.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?71040c20"
  );
