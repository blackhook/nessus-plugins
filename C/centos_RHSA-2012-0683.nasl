...
# CentOS Errata and Security Advisory 2012:0683 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : bind-dyndb-ldap (CESA-2012:0683)");
...
update to take effect, the named service must be restarted."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-May/018652.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?589ad826"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"bind-dyndb-ldap-0.2.0-7.el6_2.1")) flag++;
