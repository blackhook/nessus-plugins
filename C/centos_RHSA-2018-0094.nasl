...
# extracted from Red Hat Security Advisory RHSA-2018:0094 and 
# CentOS Errata and Security Advisory 2018:0094 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : linux-firmware (CESA-2018:0094) (Spectre)");
...
hardware vendor."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?bf810aab"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl100-firmware-39.31.5.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl1000-firmware-39.31.5.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl105-firmware-18.168.6.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl135-firmware-18.168.6.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl2000-firmware-18.168.6.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl2030-firmware-18.168.6.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl3160-firmware-22.0.7.0-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl3945-firmware-15.32.2.9-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl4965-firmware-228.61.2.24-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl5000-firmware-8.83.5.1_1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl5150-firmware-8.24.2.2-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl6000-firmware-9.221.4.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl6000g2a-firmware-17.168.5.3-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl6000g2b-firmware-17.168.5.2-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl6050-firmware-41.28.5.1-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl7260-firmware-22.0.7.0-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"iwl7265-firmware-22.0.7.0-58.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"linux-firmware-20170606-58.gitc990aae.el7_4")) flag++;
