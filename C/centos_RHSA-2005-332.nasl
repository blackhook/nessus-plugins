...
# CentOS Errata and Security Advisory 2005:332 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 3 / 4 : xloadimage (CESA-2005:332)");
...
contains backported patches to correct these issues."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2005-April/011574.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?3b12ed99"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-April/011576.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?83c219c7"
  );
  # https://lists.centos.org/pipermail/centos-announce/2005-April/011582.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?803a5105"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-3", cpu:"ia64", reference:"xloadimage-4.1-34.RHEL3")) flag++;

if (rpm_check(release:"CentOS-4", reference:"xloadimage-4.1-34.RHEL4")) flag++;
