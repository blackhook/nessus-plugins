...
# extracted from Red Hat Security Advisory RHSA-2010:0558 and 
# CentOS Errata and Security Advisory 2010:0558 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 4 : firefox (CESA-2010:0558)");
...
the update, Firefox must be restarted for the changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-August/016880.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?74957a5a"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-August/016881.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?f5cf892c"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-4", cpu:"i386", reference:"firefox-3.6.7-3.el4.centos")) flag++;
if (rpm_check(release:"CentOS-4", cpu:"x86_64", reference:"firefox-3.6.7-3.el4.centos")) flag++;
