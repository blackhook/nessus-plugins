...
# extracted from Red Hat Security Advisory RHSA-2019:2033 and 
# CentOS Errata and Security Advisory 2019:2033 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : patch (CESA-2019:2033)");
...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/006040.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7056fd6c"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"patch-2.7.1-11.el7")) flag++;
