...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2021:0992)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?ac0ae4c0");
...
"Update the affected firefox package.");
  ...
  script_cwe_id(120, 125, 200, 1021);
...
pkgs = [
    {'reference':'firefox-78.9.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
