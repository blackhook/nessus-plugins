...
must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016613.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?cbb2bc56"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-March/016614.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?984b9a0d"
  );
  script_set_attribute(
    attribute:"solution", 
