...
# Red Hat Security Advisory RHSA-2020:4464. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : libxslt (CESA-2020:4464)");
...
pkgs = [
    {'reference':'libxslt-1.1.32-5.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-1.1.32-5.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.32-5.el8', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'libxslt-devel-1.1.32-5.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
];
