...
# CentOS Errata and Security Advisory 2017:0893 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 6 : 389-ds-base (CESA-2017:0893)");
...
plug-in now supports any syntax. (BZ#1435365)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?e13021d2"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"389-ds-base-1.2.11.15-91.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"389-ds-base-devel-1.2.11.15-91.el6_9")) flag++;
if (rpm_check(release:"CentOS-6", reference:"389-ds-base-libs-1.2.11.15-91.el6_9")) flag++;
