...
if (description)
{
  ...
  script_name(english:"CentOS 7 : firefox (CESA-2020:3556)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?45a176f2");
...
pkgs = [
    {'reference':'firefox-68.12.0-1.el7.centos', 'cpu':'i686', 'release':'CentOS-7', 'allowmaj':TRUE},
    {'reference':'firefox-68.12.0-1.el7.centos', 'cpu':'x86_64', 'release':'CentOS-7', 'allowmaj':TRUE}
];
