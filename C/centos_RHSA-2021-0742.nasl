...
if (description)
{
  ...
  script_name(english:"CentOS 7 : screen (CESA-2021:0742)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8e69bf27");
...
pkgs = [
    {'reference':'screen-4.1.0-0.27.20120314git3c2946.el7_9', 'sp':'9', 'cpu':'x86_64', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE}
];
