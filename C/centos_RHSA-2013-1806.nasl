...
automatically."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020056.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1da140fe"
  );
  # https://lists.centos.org/pipermail/centos-announce/2013-December/020057.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?85f372c3"
  );
  script_set_attribute(
    attribute:"solution", 
