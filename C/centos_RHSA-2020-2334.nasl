...
if (description)
{
  ...
  script_name(english:"CentOS 7 : freerdp (CESA-2020:2334)");
...
documented in Red Hat advisory RHSA-2020:2334."
  );
  # https://lists.centos.org/pipermail/centos-announce/2020-June/035742.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?486ef3ad"
  );
  script_set_attribute(
    attribute:"solution",
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2020-11521");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"freerdp-2.0.0-4.rc4.el7_8")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"freerdp-devel-2.0.0-4.rc4.el7_8")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"freerdp-libs-2.0.0-4.rc4.el7_8")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libwinpr-2.0.0-4.rc4.el7_8")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"libwinpr-devel-2.0.0-4.rc4.el7_8")) flag++;
