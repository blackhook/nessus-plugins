...
if (description)
{
  ...
  script_name(english:"CentOS 6 : thunderbird (CESA-2020:0574)");
...
the CVE page(s) listed in the References section."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2020-February/035649.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?01064cf5"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-6", reference:"thunderbird-68.5.0-1.el6.centos", allowmaj:TRUE)) flag++;
