...
# Red Hat Security Advisory RHSA-2021:4130. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : thunderbird (CESA-2021:4130)");
...
var pkgs = [
    {'reference':'thunderbird-91.3.0-2.el8_4', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-91.3.0-2.el8_4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
