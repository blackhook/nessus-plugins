...
communications.");
  # https://tools.cisco.com/security/center/viewAlert.x?alertId=30858
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?9d78491b");
  script_set_attribute(attribute:"solution", value:
"Apply the relevant patch referenced in Cisco Bug Id CSCte90338.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2012-4074");
