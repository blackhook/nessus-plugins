...
web server uses a known default set of credentials ('admin / default)'."
  ...
  # https://www.cisco.com/c/en/us/td/docs/app_ntwk_services/waas/waas_mobile/v3-5-5/release/note/WAASMobile3-5-5RN.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f8958349");
