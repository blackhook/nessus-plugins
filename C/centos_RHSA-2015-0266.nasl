...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2015-February/020949.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?22af42d7"
  );
  # https://lists.centos.org/pipermail/centos-announce/2015-February/020950.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?00b7906f"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-31.5.0-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-31.5.0-1.el6.centos", allowmaj:TRUE)) flag++;
