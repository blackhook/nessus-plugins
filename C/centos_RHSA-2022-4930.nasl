...
if (description)
{
  ...
  script_name(english:"CentOS 7 : python-twisted-web (CESA-2022:4930)");
...
CESA-2022:4930 advisory.

  - python-twisted: possible http request smuggling (CVE-2022-24801)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2022-August/073619.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?2f9bcaaf");
