...
Chen, and Nathan Froyd as the original reporters."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-March/022334.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?43846dbf"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"firefox-52.0-4.el7.centos", allowmaj:TRUE)) flag++;
