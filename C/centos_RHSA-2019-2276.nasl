...
# extracted from Red Hat Security Advisory RHSA-2019:2276 and 
# CentOS Errata and Security Advisory 2019:2276 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : mercurial (CESA-2019:2276)");
...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2019-August/005992.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?75ca7e30"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"emacs-mercurial-2.6.2-10.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"emacs-mercurial-el-2.6.2-10.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"mercurial-2.6.2-10.el7")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"mercurial-hgk-2.6.2-10.el7")) flag++;
