...
if (description)
{
  ...
  script_name(english:"CentOS 7 : pki-core (CESA-2022:8799)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2022:8799 advisory.

  - pki-core: access to external entities when parsing XML can lead to XXE (CVE-2022-2414)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  # https://lists.centos.org/pipermail/centos-announce/2023-January/086368.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d13444c6");
...
var pkgs = [
    {'reference':'pki-base-10.5.18-24.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-base-java-10.5.18-24.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-ca-10.5.18-24.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-javadoc-10.5.18-24.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-kra-10.5.18-24.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'pki-server-10.5.18-24.el7_9', 'release':'CentOS-7', 'rpm_spec_vers_cmp':TRUE},
