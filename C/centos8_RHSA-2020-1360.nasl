...
# Red Hat Security Advisory RHSA-2020:1360. The text
...
if (description)
{
  ...
  script_name(english:"CentOS 8 : container-tools:1.0 (CESA-2020:1360)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 8 host has packages installed that are affected by a vulnerability as referenced in the
CESA-2020:1360 advisory.
...
var appstreams = {
    'container-tools:1.0': [
      ...
      {'reference':'slirp4netns-0.1-4.dev.gitc4e1bc5.module_el8.1.0+299+10c6b3e0', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'slirp4netns-0.1-4.dev.gitc4e1bc5.module_el8.1.0+299+10c6b3e0', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
};
