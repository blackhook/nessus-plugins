...
changes to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2012-March/018498.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?144c5b08"
  );
  # https://lists.centos.org/pipermail/centos-announce/2012-March/018500.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?1ccc62a8"
  );
  script_set_attribute(
    attribute:"solution",
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"thunderbird-10.0.3-1.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"thunderbird-10.0.3-1.el6.centos", allowmaj:TRUE)) flag++;
