...
# CentOS Errata and Security Advisory 2017:0459 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 / 6 : firefox (CESA-2017:0459)");
...
Chen, and Nathan Froyd as the original reporters."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2017-March/022326.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?42c694e2"
  );
  # https://lists.centos.org/pipermail/centos-announce/2017-March/022327.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b79f2dda"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"firefox-45.8.0-2.el5.centos", allowmaj:TRUE)) flag++;

if (rpm_check(release:"CentOS-6", reference:"firefox-45.8.0-2.el6.centos", allowmaj:TRUE)) flag++;
