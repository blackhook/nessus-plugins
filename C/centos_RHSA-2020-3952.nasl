...
if (description)
{
  ...
  script_name(english:"CentOS 7 : expat (CESA-2020:3952)");

  script_set_attribute(attribute:"synopsis", value:
"The remote CentOS Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote CentOS Linux 7 host has packages installed that are affected by multiple vulnerabilities as referenced in the
CESA-2020:3952 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b3f4ea56");
...
pkgs = [
    {'reference':'expat-2.1.0-12.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'expat-2.1.0-12.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'expat-devel-2.1.0-12.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'expat-devel-2.1.0-12.el7', 'cpu':'x86_64', 'release':'CentOS-7'},
    {'reference':'expat-static-2.1.0-12.el7', 'cpu':'i686', 'release':'CentOS-7'},
    {'reference':'expat-static-2.1.0-12.el7', 'cpu':'x86_64', 'release':'CentOS-7'}
];
