...
# CentOS Errata and Security Advisory 2017:2486 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 7 : groovy (CESA-2017:2486)");
...
objects are subject to this vulnerability. (CVE-2016-6814)"
  ...
  # https://lists.centos.org/pipermail/centos-cr-announce/2017-August/004692.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?b8182e21"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:groovy");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:centos:centos:groovy-javadoc");
...
flag = 0;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"groovy-1.8.9-8.el7_4")) flag++;
if (rpm_check(release:"CentOS-7", cpu:"x86_64", reference:"groovy-javadoc-1.8.9-8.el7_4")) flag++;
