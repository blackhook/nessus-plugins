...
# CentOS Errata and Security Advisory 2010:0343 respectively.
#
...
if (description)
{
  ...
  script_name(english:"CentOS 5 : krb5 (CESA-2010:0343)");
...
must be restarted for the update to take effect."
  ...
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016688.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4c64c5b"
  );
  # https://lists.centos.org/pipermail/centos-announce/2010-May/016690.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?26927f21"
  );
...
flag = 0;
if (rpm_check(release:"CentOS-5", reference:"krb5-devel-1.6.1-36.el5_5.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"krb5-libs-1.6.1-36.el5_5.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"krb5-server-1.6.1-36.el5_5.2")) flag++;
if (rpm_check(release:"CentOS-5", reference:"krb5-workstation-1.6.1-36.el5_5.2")) flag++;
