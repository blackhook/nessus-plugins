...
if (description)
{
  ...
  script_name(english:"CentOS 6 : xorg-x11-server (CESA-2020:4953)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a3c4eb40");
...
pkgs = [
    {'reference':'xorg-x11-server-common-1.17.4-18.el6.centos', 'cpu':'i686', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-common-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-devel-1.17.4-18.el6.centos', 'cpu':'i686', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-devel-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-source-1.17.4-18.el6.centos', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xdmx-1.17.4-18.el6.centos', 'cpu':'i686', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xdmx-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xephyr-1.17.4-18.el6.centos', 'cpu':'i686', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xephyr-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xnest-1.17.4-18.el6.centos', 'cpu':'i686', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xnest-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xorg-1.17.4-18.el6.centos', 'cpu':'i686', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xorg-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xvfb-1.17.4-18.el6.centos', 'cpu':'i686', 'release':'CentOS-6'},
    {'reference':'xorg-x11-server-Xvfb-1.17.4-18.el6.centos', 'cpu':'x86_64', 'release':'CentOS-6'}
];
