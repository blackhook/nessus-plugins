...
# extracted from Red Hat Security Advisory RHSA-2009:1144. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2009:1144");

  script_name(english:"RHEL 4 : JBoss EAP (RHSA-2009:1144)");
...
upgrade to these updated packages."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1144"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL4", reference:"jboss-seam-1.2.1-1.ep1.19.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jboss-seam-docs-1.2.1-1.ep1.19.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossas-4.2.0-4.GA_CP07.5.ep1.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossas-4.2.0.GA_CP07-bin-4.2.0-4.GA_CP07.5.ep1.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossas-client-4.2.0-4.GA_CP07.5.ep1.el4")) flag++;
  ...
  if (rpm_check(release:"RHEL4", reference:"rh-eap-docs-4.2.0-5.GA_CP07.ep1.1.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"rh-eap-docs-examples-4.2.0-5.GA_CP07.ep1.1.el4")) flag++;
