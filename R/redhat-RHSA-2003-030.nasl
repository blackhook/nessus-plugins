...
# extracted from Red Hat Security Advisory RHSA-2003:030. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2003:030");

  script_name(english:"RHEL 2.1 : lynx (RHSA-2003:030)");
...
contain a patch to correct this isssue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1405"
  );
  # http://www.mail-archive.com/bugtraq@securityfocus.com/msg08897.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.mail-archive.com/bugtraq@securityfocus.com/msg08897.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:030"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"lynx-2.8.4-18.1")) flag++;
