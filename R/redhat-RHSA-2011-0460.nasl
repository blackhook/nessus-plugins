...
# extracted from Red Hat Security Advisory RHSA-2011:0460. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:0460");
  script_xref(name:"IAVB", value:"2011-B-0086");

  script_name(english:"RHEL 4 / 5 : jboss-seam2 (RHSA-2011:0460)");
...
this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-1484"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:0460"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"jboss-seam2-2.0.2.FP-1.ep1.27.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jboss-seam2-docs-2.0.2.FP-1.ep1.27.el4")) flag++;

  if (rpm_check(release:"RHEL5", reference:"jboss-seam2-2.0.2.FP-1.ep1.27.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jboss-seam2-docs-2.0.2.FP-1.ep1.27.el5")) flag++;
