...
# extracted from Red Hat Security Advisory RHSA-2003:068. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2003:068");

  script_name(english:"RHEL 2.1 : vnc (RHSA-2003:068)");
...
All users of VNC are advised to upgrade to these erratum packages,
which contain a patch to correct this issue."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1511"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:068"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"vnc-3.3.3r2-18.6")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"vnc-doc-3.3.3r2-18.6")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"vnc-server-3.3.3r2-18.6")) flag++;
