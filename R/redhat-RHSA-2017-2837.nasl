...
(Google Security Team) for reporting these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2837"
  );
  script_set_attribute(
    attribute:"see_also",
...
{  sp = get_kb_item("Host/RedHat/minor_release");
  ...
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"s390x", reference:"dnsmasq-2.66-21.el7_3.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"s390x", reference:"dnsmasq-2.66-14.el7_2.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"dnsmasq-2.66-21.el7_3.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"dnsmasq-2.66-14.el7_2.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"s390x", reference:"dnsmasq-debuginfo-2.66-21.el7_3.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"s390x", reference:"dnsmasq-debuginfo-2.66-14.el7_2.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.66-21.el7_3.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.66-14.el7_2.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"s390x", reference:"dnsmasq-utils-2.66-21.el7_3.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"s390x", reference:"dnsmasq-utils-2.66-14.el7_2.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"dnsmasq-utils-2.66-21.el7_3.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"dnsmasq-utils-2.66-14.el7_2.2")) flag++;
