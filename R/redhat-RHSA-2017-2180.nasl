...
mem_get_bits_rectangle function. A specially crafted postscript
document could cause a crash in the context of the gs process.
(CVE-2017-7207)
...
Enterprise Linux 7.4 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2180"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-7207"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"ghostscript-9.07-28.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"ghostscript-cups-9.07-28.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ghostscript-cups-9.07-28.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"ghostscript-debuginfo-9.07-28.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"ghostscript-devel-9.07-28.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"ghostscript-doc-9.07-28.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"ghostscript-gtk-9.07-28.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ghostscript-gtk-9.07-28.el7")) flag++;
