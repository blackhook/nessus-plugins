...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"An update for dhcp is now available for Red Hat Enterprise Linux 6.5
...
reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1460"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dhclient-4.1.1-38.P1.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dhcp-4.1.1-38.P1.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dhcp-common-4.1.1-38.P1.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"i686", reference:"dhcp-debuginfo-4.1.1-38.P1.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dhcp-debuginfo-4.1.1-38.P1.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"i686", reference:"dhcp-devel-4.1.1-38.P1.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dhcp-devel-4.1.1-38.P1.el6_5.1")) flag++;
