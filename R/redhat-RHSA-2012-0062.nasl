...
# extracted from Red Hat Security Advisory RHSA-2012:0062. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : t1lib (RHSA-2012:0062)");
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:0062"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:t1lib");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:t1lib-apps");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:t1lib-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:t1lib-devel");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:t1lib-static");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"t1lib-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"t1lib-apps-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"t1lib-apps-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"t1lib-apps-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"t1lib-debuginfo-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"t1lib-devel-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"t1lib-static-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"t1lib-static-5.1.2-6.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"t1lib-static-5.1.2-6.el6_2.1")) flag++;
