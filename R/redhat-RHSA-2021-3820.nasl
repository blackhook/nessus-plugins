...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.8.15 packages and (RHSA-2021:3820)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-21670");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-21671");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2007749");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2007750");
  script_set_attribute(attribute:"solution", value:
"Update the affected butane and / or jenkins packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'butane-0.12.1-2.rhaos4.8.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'butane-0.12.1-2.rhaos4.8.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'jenkins-2.289.3.1633554819-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
