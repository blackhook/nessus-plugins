...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 7 : nss and nspr (RHSA-2014:0916)");
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0916"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"nspr-4.10.6-1.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nspr-debuginfo-4.10.6-1.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nspr-devel-4.10.6-1.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-3.15.3-7.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-debuginfo-3.15.3-7.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-devel-3.15.3-7.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-pkcs11-devel-3.15.3-7.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"nss-tools-3.15.3-7.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"nss-tools-3.15.3-7.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"nss-tools-3.15.3-7.el5_10")) flag++;


  if (rpm_check(release:"RHEL7", reference:"nspr-4.10.6-1.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nspr-debuginfo-4.10.6-1.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nspr-devel-4.10.6-1.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-3.15.4-7.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-debuginfo-3.15.4-7.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-devel-3.15.4-7.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"nss-pkcs11-devel-3.15.4-7.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"nss-sysinit-3.15.4-7.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"nss-sysinit-3.15.4-7.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"nss-tools-3.15.4-7.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"nss-tools-3.15.4-7.el7_0")) flag++;
