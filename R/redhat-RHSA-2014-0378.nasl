...
# extracted from Red Hat Security Advisory RHSA-2014:0378. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0378");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/25");

  script_name(english:"RHEL 6 : rhev-hypervisor6 (RHSA-2014:0378) (Heartbleed)");
...
to upgrade to this updated package, which corrects this issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:0378");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rhev-hypervisor6-6.5-20140407.0.el6ev")) flag++;
