...
escalate their privileges to root. (CVE-2017-1000368)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.sudo.ws/alerts/linux_tty.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:1574"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-1000368"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"sudo-1.8.6p3-29.el6_9")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"sudo-1.8.6p3-29.el6_9")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"sudo-1.8.6p3-29.el6_9")) flag++;

  if (rpm_check(release:"RHEL6", reference:"sudo-debuginfo-1.8.6p3-29.el6_9")) flag++;

  if (rpm_check(release:"RHEL6", reference:"sudo-devel-1.8.6p3-29.el6_9")) flag++;


  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"sudo-1.8.6p7-23.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"sudo-1.8.6p7-23.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"sudo-debuginfo-1.8.6p7-23.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"sudo-devel-1.8.6p7-23.el7_3")) flag++;
