...
# extracted from Red Hat Security Advisory RHSA-2013:1060. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1060");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/04/18");

  script_name(english:"RHEL 5 / 6 : java-1.7.0-ibm (RHSA-2013:1060)");
...
CVE-2013-2400, CVE-2013-2407, CVE-2013-2412, CVE-2013-2437,
CVE-2013-2442, CVE-2013-2444, CVE-2013-2446, CVE-2013-2447,
...
CVE-2013-2460, CVE-2013-2462, CVE-2013-2463, CVE-2013-2464,
...
instances of IBM Java must be restarted for the update to take effect.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:1060");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-2458");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-2449");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-2460");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-2462");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-2400");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-3744");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-3006");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-3007");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-3008");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2013-3010");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", sp:"9", reference:"java-1.7.0-ibm-1.7.0.5.0-1jpp.2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", sp:"9", reference:"java-1.7.0-ibm-demo-1.7.0.5.0-1jpp.2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", sp:"9", reference:"java-1.7.0-ibm-devel-1.7.0.5.0-1jpp.2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", sp:"9", reference:"java-1.7.0-ibm-jdbc-1.7.0.5.0-1jpp.2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", sp:"9", cpu:"i386", reference:"java-1.7.0-ibm-plugin-1.7.0.5.0-1jpp.2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", sp:"9", cpu:"x86_64", reference:"java-1.7.0-ibm-plugin-1.7.0.5.0-1jpp.2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", sp:"9", reference:"java-1.7.0-ibm-src-1.7.0.5.0-1jpp.2.el5_9")) flag++;


  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"java-1.7.0-ibm-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"java-1.7.0-ibm-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"java-1.7.0-ibm-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"java-1.7.0-ibm-demo-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"java-1.7.0-ibm-demo-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"java-1.7.0-ibm-demo-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"java-1.7.0-ibm-devel-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"java-1.7.0-ibm-devel-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"java-1.7.0-ibm-devel-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"java-1.7.0-ibm-jdbc-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"java-1.7.0-ibm-jdbc-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"java-1.7.0-ibm-jdbc-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"java-1.7.0-ibm-plugin-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"java-1.7.0-ibm-plugin-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"java-1.7.0-ibm-src-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"java-1.7.0-ibm-src-1.7.0.5.0-1jpp.2.el6_4")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"java-1.7.0-ibm-src-1.7.0.5.0-1jpp.2.el6_4")) flag++;
