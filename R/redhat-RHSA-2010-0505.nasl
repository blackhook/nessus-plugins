...
Archive::Tar module must be restarted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-4829"
  );
  # http://cpansearch.perl.org/src/KANE/Archive-Tar-1.39_01/CHANGES
  script_set_attribute(
    attribute:"see_also",
    value:"https://fastapi.metacpan.org/source/KANE/Archive-Tar-1.39_01/CHANGES"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0505"
  );
  script_set_attribute(
    attribute:"solution", 
