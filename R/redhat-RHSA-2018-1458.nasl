...
reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1458"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"dhclient-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"dhclient-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"dhclient-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"dhcp-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"dhcp-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"dhcp-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"dhcp-common-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"dhcp-common-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"dhcp-common-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", reference:"dhcp-debuginfo-4.1.1-49.P1.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", reference:"dhcp-devel-4.1.1-49.P1.el6_7.1")) flag++;
