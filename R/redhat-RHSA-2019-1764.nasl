...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:1764"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"firefox-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"firefox-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"firefox-debuginfo-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"firefox-debuginfo-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"firefox-debugsource-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"firefox-debugsource-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;
