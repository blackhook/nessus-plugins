...
contain backported fixes for these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:035"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"libtiff-3.6.1-8")) flag++;
  if (rpm_check(release:"RHEL4", reference:"libtiff-devel-3.6.1-8")) flag++;
