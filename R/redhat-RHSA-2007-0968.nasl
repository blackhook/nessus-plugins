...
disclosing these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0968"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"pcre-4.5-4.el4_5.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"pcre-devel-4.5-4.el4_5.1")) flag++;
