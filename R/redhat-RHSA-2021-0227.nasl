...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.6p3-29.el6_10.4', 'cpu':'i686', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.6p3-29.el6_10.4', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.6p3-29.el6_10.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'i686', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'s390', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.6p3-29.el6_10.4', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
