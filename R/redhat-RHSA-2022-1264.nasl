...
the RHSA-2022:1264 advisory.
  ...
  - waitress: Inconsistent Interpretation of HTTP Requests ('HTTP Request Smuggling') (CVE-2022-24761)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-24761");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1264");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2065086");
  script_set_attribute(attribute:"solution", value:
"Update the affected python2-waitress package.");
