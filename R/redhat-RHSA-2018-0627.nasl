...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : JBoss EAP (RHSA-2018:0627)");
...
Platform 6.4 for Red Hat Enterprise Linux 5, Red Hat Enterprise Linux
...
Hat JBoss Enterprise Application Platform 6.4.
...
Red Hat would like to thank Chris McCown for reporting CVE-2018-8088."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:0627"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected slf4j-eap6 package."
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL6", reference:"slf4j-eap6-1.7.2-14.redhat_4.1.ep6.el6")) flag++;

  if (rpm_check(release:"RHEL7", reference:"slf4j-eap6-1.7.2-14.redhat_4.1.ep6.el7")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "slf4j-eap6");
  }
}
