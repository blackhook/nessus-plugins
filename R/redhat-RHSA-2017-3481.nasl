...
# extracted from Red Hat Security Advisory RHSA-2017:3481. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:3481");

  script_name(english:"RHEL 7 : heketi (RHSA-2017:3481)");
  ...
  script_set_attribute(
    ...
    value:
"An update for heketi is now available for Red Hat Gluster Storage 3.3
...
* A security-check flaw was found in the way the Heketi server API
handled user requests. An authenticated Heketi user could send
specially crafted requests to the Heketi server, resulting in remote
command execution as the user running Heketi server and possibly
privilege escalation. (CVE-2017-15103)

* An access flaw was found in heketi, where the heketi.json
configuration file was world readable. An attacker having local access
to the Heketi server could read plain-text passwords from the
heketi.json file. (CVE-2017-15104)

Red Hat would like to thank Markus Krell (NTT Security) for reporting
CVE-2017-15103. The CVE-2017-15104 issue was discovered by Siddharth
Sharma (Red Hat)."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:3481"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-15103"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-15104"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"heketi-5.0.0-19.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"heketi-client-5.0.0-19.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"python-heketi-5.0.0-19.el7")) flag++;
