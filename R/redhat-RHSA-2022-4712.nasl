...
"Update the affected python-paramiko-doc and / or python3-paramiko packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-paramiko-doc-2.4.3-3.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'},
      {'reference':'python3-paramiko-2.4.3-3.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
