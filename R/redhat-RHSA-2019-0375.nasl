...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:0375"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-8308"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"flatpak-1.0.2-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"flatpak-1.0.2-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"flatpak-builder-1.0.0-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"flatpak-builder-1.0.0-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"flatpak-debuginfo-1.0.2-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"flatpak-debuginfo-1.0.2-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"flatpak-devel-1.0.2-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"flatpak-devel-1.0.2-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"flatpak-libs-1.0.2-4.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"flatpak-libs-1.0.2-4.el7_6")) flag++;
