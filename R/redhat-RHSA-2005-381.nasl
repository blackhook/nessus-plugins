...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : nasm (RHSA-2005:381)");
...
which contains backported fixes for these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-1287"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-1194"
  );
  # http://tigger.uic.edu/~jlongs2/holes/nasm.txt
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?7b2a0544"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:381"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"nasm-0.98-8.EL21")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"nasm-doc-0.98-8.EL21")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"nasm-rdoff-0.98-8.EL21")) flag++;

  if (rpm_check(release:"RHEL3", reference:"nasm-0.98.35-3.EL3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"nasm-0.98.38-3.EL4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"nasm-doc-0.98.38-3.EL4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"nasm-rdoff-0.98.38-3.EL4")) flag++;
