...
# extracted from Red Hat Security Advisory RHSA-2010:0386. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2010:0386");

  script_name(english:"RHEL 3 : redhat-release (EOL Notice) (RHSA-2010:0386)");
...
Red Hat website: http://www.redhat.com/security/updates/errata/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2010-0386.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"RHEL3", reference:"redhat-release-3AS-13.9.8")) flag++;
if (rpm_check(release:"RHEL3", cpu:"i386", reference:"redhat-release-3WS-13.9.8")) flag++;
if (rpm_check(release:"RHEL3", cpu:"i386", reference:"redhat-release-3ES-13.9.8")) flag++;
if (rpm_check(release:"RHEL3", cpu:"x86_64", reference:"redhat-release-3ES-13.9.8")) flag++;
if (rpm_check(release:"RHEL3", cpu:"x86_64", reference:"redhat-release-3WS-13.9.8")) flag++;
