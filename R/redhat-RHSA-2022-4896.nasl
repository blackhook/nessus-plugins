...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Virtualization security, bug fix, and enhancement update [ovirt-4.5.0] (Important) (RHSA-2022:4896)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-1271");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2073310");
...
"Update the affected redhat-virtualization-host-image-update package.");
  ...
  script_cwe_id(20, 119, 179, 416, 787, 835, 1173);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.5.0-202205291010_8.6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
