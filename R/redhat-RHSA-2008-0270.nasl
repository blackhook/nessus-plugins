...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : libvorbis (RHSA-2008:0270)");
...
which contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0270"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"libvorbis-1.0-10.el3")) flag++;

  if (rpm_check(release:"RHEL3", reference:"libvorbis-devel-1.0-10.el3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"libvorbis-1.1.0-3.el4_6.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libvorbis-devel-1.1.0-3.el4_6.1")) flag++;


  if (rpm_check(release:"RHEL5", reference:"libvorbis-1.1.2-3.el5_1.2")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libvorbis-devel-1.1.2-3.el5_1.2")) flag++;
