...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : JBoss EAP (RHSA-2014:0793)");
...
update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0793"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2014-0248"
  );
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL5", rpm:"jboss-seam2-") || rpm_exists(release:"RHEL6", rpm:"jboss-seam2-"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "JBoss EAP");
