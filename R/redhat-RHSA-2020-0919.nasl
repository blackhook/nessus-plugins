...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1812199");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1812200");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1812201");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1812202");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1812203");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1812204");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1812205");
...
"Update the affected thunderbird package.");
  ...
  script_cwe_id(20, 78, 120, 125, 200, 416);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'thunderbird-68.6.0-1.el8_1', 'sp':'2', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-68.6.0-1.el8_1', 'sp':'2', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-68.6.0-1.el8_1', 'sp':'4', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-68.6.0-1.el8_1', 'sp':'4', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'thunderbird-68.6.0-1.el8_1', 'sp':'6', 'cpu':'ppc64le', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
      {'reference':'thunderbird-68.6.0-1.el8_1', 'sp':'6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
