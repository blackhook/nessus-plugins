...
# extracted from Red Hat Security Advisory RHSA-2007:0674. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 5 : perl-Net-DNS (RHSA-2007:0674)");
...
contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-3409"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0674"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"perl-Net-DNS-0.31-4.el3")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"perl-Net-DNS-0.59-3.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"perl-Net-DNS-0.59-3.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"perl-Net-DNS-0.59-3.el5")) flag++;
