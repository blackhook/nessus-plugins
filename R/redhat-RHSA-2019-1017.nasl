...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:1017"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"ghostscript-9.07-31.el7_6.11")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"ghostscript-cups-9.07-31.el7_6.11")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ghostscript-cups-9.07-31.el7_6.11")) flag++;

  if (rpm_check(release:"RHEL7", reference:"ghostscript-debuginfo-9.07-31.el7_6.11")) flag++;

  if (rpm_check(release:"RHEL7", reference:"ghostscript-devel-9.07-31.el7_6.11")) flag++;

  if (rpm_check(release:"RHEL7", reference:"ghostscript-doc-9.07-31.el7_6.11")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"ghostscript-gtk-9.07-31.el7_6.11")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ghostscript-gtk-9.07-31.el7_6.11")) flag++;
