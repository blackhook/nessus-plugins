...
"Update the affected openstack-dashboard and / or python-django-horizon packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-dashboard-13.0.3-7.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python-django-horizon-13.0.3-7.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
