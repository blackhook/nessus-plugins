...
"Update the affected libexif, libexif-devel and / or libexif-doc packages.");
  ...
  script_cwe_id(125, 369, 400, 416, 456, 787, 805, 822);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libexif-0.6.22-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libexif-devel-0.6.22-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
