...
which contain a backported patch that is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-0481"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0205"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"libpng-1.2.7-1.el4.2")) flag++;
  if (rpm_check(release:"RHEL4", reference:"libpng-devel-1.2.7-1.el4.2")) flag++;
