...
"Update the affected jenkins-2-plugins and / or python2-rsa packages.");
  ...
  script_cwe_id(79, 200, 222, 327, 400);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jenkins-2-plugins-4.5.1596698303-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python2-rsa-4.5-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
