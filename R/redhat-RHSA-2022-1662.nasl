...
"Update the affected rh-maven36-maven-shared-utils and / or rh-maven36-maven-shared-utils-javadoc packages.");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'rh-maven36-maven-shared-utils / rh-maven36-maven-shared-utils-javadoc');
}
