...
advisory. Documentation for these bug fixes and enhancements will be
...
enhancements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-4083"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:1536"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"sos-2.2-17.el6")) flag++;
