...
will be automatically restarted after installing this update."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-3433"
  );
  # http://www.postgresql.org/docs/8.1/interactive/sql-createfunction.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/8.1/sql-createfunction.html"
  );
  # http://www.postgresql.org/docs/8.4/static/release.html
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0908"
  );
