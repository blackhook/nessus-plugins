...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:2285"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2018-19044"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"keepalived-1.3.5-16.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"keepalived-debuginfo-1.3.5-16.el7")) flag++;
