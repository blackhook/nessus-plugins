...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.7.32 packages and (RHSA-2021:3635)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-25741");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3635");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1993749");
