...
# extracted from Red Hat Security Advisory RHSA-2003:061. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2003:061");

  script_name(english:"RHEL 2.1 : netpbm (RHSA-2003:061)");
...
patches that correct these vulnerabilities."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0146"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:061"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"netpbm-9.24-9.AS21.2")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"netpbm-devel-9.24-9.AS21.2")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"netpbm-progs-9.24-9.AS21.2")) flag++;
