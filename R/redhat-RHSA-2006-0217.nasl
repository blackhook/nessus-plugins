...
# extracted from Red Hat Security Advisory RHSA-2006:0217. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2006:0217");

  script_name(english:"RHEL 2.1 : metamail (RHSA-2006:0217)");
...
contains a backported patch that is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-0709"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0217"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"metamail-2.7-30")) flag++;
