...
# extracted from Red Hat Security Advisory RHSA-2007:0353. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : evolution (RHSA-2007:0353)");
...
contain a backported patch which resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0353"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"evolution-1.4.5-20.el3")) flag++;

  if (rpm_check(release:"RHEL3", reference:"evolution-devel-1.4.5-20.el3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"evolution-2.0.2-35.0.2.el4")) flag++;

  if (rpm_check(release:"RHEL4", reference:"evolution-devel-2.0.2-35.0.2.el4")) flag++;
