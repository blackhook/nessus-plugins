...
loaded a page containing the malicious SWF content. (CVE-2017-11292)");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-11292");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"flash-plugin-27.0.0.170-1.el6_9")) flag++;
