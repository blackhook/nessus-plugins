...
# extracted from Red Hat Security Advisory RHSA-2009:0340. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : libpng (RHSA-2009:0340)");
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0340"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"libpng-1.2.2-29")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libpng-devel-1.2.2-29")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libpng10-1.0.13-20")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libpng10-devel-1.0.13-20")) flag++;
