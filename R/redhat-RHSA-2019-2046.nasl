...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:2046"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"polkit-0.112-22.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"polkit-debuginfo-0.112-22.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"polkit-devel-0.112-22.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"polkit-docs-0.112-22.el7")) flag++;
