...
# extracted from Red Hat Security Advisory RHSA-2007:0150. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : freetype (RHSA-2007:0150)");
...
Red Hat would like to thank iDefense for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0150"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"freetype-2.1.4-6.el3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"freetype-devel-2.1.4-6.el3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"freetype-2.1.9-5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"freetype-demos-2.1.9-5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"freetype-devel-2.1.9-5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"freetype-utils-2.1.9-5.el4")) flag++;

  if (rpm_check(release:"RHEL5", reference:"freetype-2.2.1-17.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"freetype-demos-2.2.1-17.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"freetype-demos-2.2.1-17.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"freetype-demos-2.2.1-17.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"freetype-devel-2.2.1-17.el5")) flag++;
