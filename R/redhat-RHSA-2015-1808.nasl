...
All rubygem-openshift-origin-console users are advised to upgrade to
...
this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1808"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-5274"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected rubygem-openshift-origin-console package."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-console-1.34.1.3-1.el6")) flag++;
