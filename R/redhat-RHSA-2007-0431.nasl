...
# extracted from Red Hat Security Advisory RHSA-2007:0431. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : shadow-utils (RHSA-2007:0431)");
...
package, which contains backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-1174"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0431"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"shadow-utils-4.0.3-29.RHEL3")) flag++;
