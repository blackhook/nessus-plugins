...
addition, Net-SNMP 5.0.9 fixes a number of other minor bugs."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0935"
  );
  # http://sourceforge.net/forum/forum.php?forum_id=308015
  script_set_attribute(
    attribute:"see_also",
    value:"https://sourceforge.net/p/legacy_/forum/forum.php?forum_id=308015"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:023"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
