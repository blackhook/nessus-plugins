...
# extracted from Red Hat Security Advisory RHSA-2017:0127. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:0127");

  script_name(english:"RHEL 7 : runc (RHSA-2017:0127)");
...
(Docker) as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0127"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"runc-1.0.0-1.rc2.el7")) flag++;
