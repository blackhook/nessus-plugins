...
# extracted from Red Hat Security Advisory RHSA-2015:0800. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : openssl (RHSA-2015:0800) (FREAK)");
...
be restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:0800"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"openssl-0.9.8e-33.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"openssl-debuginfo-0.9.8e-33.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"openssl-devel-0.9.8e-33.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"openssl-perl-0.9.8e-33.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"openssl-perl-0.9.8e-33.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"openssl-perl-0.9.8e-33.el5_11")) flag++;
