...
if (description)
{
  ...
  script_name(english:"RHEL 6 : Storage Server (RHSA-2014:1692) (POODLE)");
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openssl-1.0.1e-30.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openssl-debuginfo-1.0.1e-30.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openssl-devel-1.0.1e-30.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openssl-perl-1.0.1e-30.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openssl-static-1.0.1e-30.el6_6.2")) flag++;
