...
"Update the affected python-django-bash-completion and / or python3-django packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python-django-bash-completion-2.1.11-1.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-django-2.1.11-1.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
