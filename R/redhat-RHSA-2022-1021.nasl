...
"Update the affected haproxy22 and / or jenkins-2-plugins packages.");
  ...
  script_cwe_id(20, 59, 78, 200, 400);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy22-2.2.15-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'jenkins-2-plugins-4.9.1647580879-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
