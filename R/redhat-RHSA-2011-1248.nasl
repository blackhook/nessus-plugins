...
# extracted from Red Hat Security Advisory RHSA-2011:1248. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : ca-certificates (RHSA-2011:1248)");
...
restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:1248"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"ca-certificates-2010.63-3.el6_1.5")) flag++;
