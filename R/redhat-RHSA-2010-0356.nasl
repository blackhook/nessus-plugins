...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-0886"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-0887"
  );
  # http://www.oracle.com/technology/deploy/security/alerts/
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.oracle.com/technology/deploy/security/alerts/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0356"
  );
