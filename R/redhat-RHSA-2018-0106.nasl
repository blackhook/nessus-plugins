...
# extracted from Red Hat Security Advisory RHSA-2018:0106. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0106");
  script_xref(name:"IAVA", value:"2018-A-0020");

  script_name(english:"RHEL 6 : qemu-kvm (RHSA-2018:0106) (Spectre)");
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:0106"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"qemu-guest-agent-0.12.1.2-2.355.el6_4.10")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"qemu-guest-agent-win32-0.12.1.2-2.355.el6_4.10")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"qemu-img-0.12.1.2-2.355.el6_4.10")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"qemu-kvm-0.12.1.2-2.355.el6_4.10")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"qemu-kvm-debuginfo-0.12.1.2-2.355.el6_4.10")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"qemu-kvm-tools-0.12.1.2-2.355.el6_4.10")) flag++;
