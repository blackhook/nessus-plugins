...
# extracted from Red Hat Security Advisory RHSA-2005:364. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:364");

  script_name(english:"RHEL 2.1 : logwatch (RHSA-2005:364)");
...
which contain backported fixes for this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-1061"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:364"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", reference:"logwatch-2.6-2.EL2")) flag++;
