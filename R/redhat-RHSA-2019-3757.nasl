...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:3757"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"s390x", reference:"patch-2.7.1-11.el7_5")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"x86_64", reference:"patch-2.7.1-11.el7_5")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"s390x", reference:"patch-debuginfo-2.7.1-11.el7_5")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"x86_64", reference:"patch-debuginfo-2.7.1-11.el7_5")) flag++;
