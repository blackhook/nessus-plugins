...
if (description)
{
  ...
  script_name(english:"RHEL 7 : Satellite Server (RHSA-2019:2777)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"An update for qpid-proton is now available for Red Hat Satellite 6.5
for RHEL 7.
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL7", rpm:"satellite-6.5"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "Satellite 6.5");
