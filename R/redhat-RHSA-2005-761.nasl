...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : pcre (RHSA-2005:761)");
...
backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-2491"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:761"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"pcre-3.4-2.2")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"pcre-devel-3.4-2.2")) flag++;

  if (rpm_check(release:"RHEL3", reference:"pcre-3.9-10.2")) flag++;
  if (rpm_check(release:"RHEL3", reference:"pcre-devel-3.9-10.2")) flag++;

  if (rpm_check(release:"RHEL4", reference:"pcre-4.5-3.2.RHEL4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"pcre-devel-4.5-3.2.RHEL4")) flag++;
