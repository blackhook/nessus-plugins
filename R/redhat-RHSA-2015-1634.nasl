...
# extracted from Red Hat Security Advisory RHSA-2015:1634. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : sqlite (RHSA-2015:1634)");
...
contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1634"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"lemon-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"lemon-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"lemon-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"sqlite-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"sqlite-debuginfo-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"sqlite-devel-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"sqlite-doc-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"sqlite-doc-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"sqlite-doc-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"sqlite-tcl-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"sqlite-tcl-3.6.20-1.el6_7.2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"sqlite-tcl-3.6.20-1.el6_7.2")) flag++;
