...
else
{
  ...
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"x86_64", reference:"bind-sdb-9.9.4-61.el7_5.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"s390x", reference:"bind-sdb-chroot-9.9.4-61.el7_5.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"x86_64", reference:"bind-sdb-chroot-9.9.4-61.el7_5.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"s390x", reference:"bind-utils-9.9.4-61.el7_5.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"x86_64", reference:"bind-utils-9.9.4-61.el7_5.2")) flag++;
