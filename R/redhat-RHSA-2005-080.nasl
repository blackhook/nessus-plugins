...
# extracted from Red Hat Security Advisory RHSA-2005:080. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:080");

  script_name(english:"RHEL 3 : cpio (RHSA-2005:080)");
...
resolves this issue, and adds support for large files (> 2GB)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:080"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"cpio-2.5-3e.3")) flag++;
