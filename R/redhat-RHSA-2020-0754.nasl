...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2017-18635");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0754");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1765660");
  script_set_attribute(attribute:"solution", value:
"Update the affected novnc package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'novnc-1.1.0-2.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
