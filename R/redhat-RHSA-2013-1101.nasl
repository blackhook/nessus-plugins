...
# extracted from Red Hat Security Advisory RHSA-2013:1101. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1101");

  script_name(english:"RHEL 6 : virtio-win (RHSA-2013:1101)");
...
which corrects this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1101"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"virtio-win-1.6.5-6.el6_4")) flag++;
