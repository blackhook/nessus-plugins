...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"An update for wget is now available for Red Hat Enterprise Linux 7.4
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:3168"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"wget-1.14-15.el7_4.2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"wget-debuginfo-1.14-15.el7_4.2")) flag++;
