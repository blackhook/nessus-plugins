...
# extracted from Red Hat Security Advisory RHSA-2012:1015. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2012:1015");

  script_name(english:"RHEL 6 : redhat-release (EOL Notice) (RHSA-2012:1015)");
...
https://access.redhat.com/support/policy/updates/errata/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-1015.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"RHEL6", cpu:"i686", reference:"redhat-release-server-6Server-6.0.0.39.el6_0")) flag++;
if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"redhat-release-server-6Server-6.0.0.39.el6_0")) flag++;
if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"redhat-release-server-6Server-6.0.0.39.el6_0")) flag++;
