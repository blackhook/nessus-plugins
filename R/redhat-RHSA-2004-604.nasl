...
# extracted from Red Hat Security Advisory RHSA-2004:604. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:604");

  script_name(english:"RHEL 3 : gaim (RHSA-2004:604)");
...
includes various bug fixes, as well as a backported security patch."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0891"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:604"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"gaim-1.0.1-1.RHEL3")) flag++;
