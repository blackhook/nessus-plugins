...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : mikmod (RHSA-2005:506)");
...
these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0427"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:506"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"mikmod-3.1.6-14.EL21")) flag++;

  if (rpm_check(release:"RHEL3", reference:"mikmod-3.1.6-22.EL3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"mikmod-devel-3.1.6-22.EL3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"mikmod-3.1.6-32.EL4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"mikmod-devel-3.1.6-32.EL4")) flag++;
