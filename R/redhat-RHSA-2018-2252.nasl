...
and OSS-Fuzz as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2252"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"thunderbird-52.9.1-1.el7_5", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"thunderbird-debuginfo-52.9.1-1.el7_5", allowmaj:TRUE)) flag++;
