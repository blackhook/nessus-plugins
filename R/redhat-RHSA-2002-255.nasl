...
bug fix patches."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-0180"
  );
  # http://marc.theaimsgroup.com/?l=bugtraq&m=101888467527673
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=bugtraq&m=101888467527673"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2002:255"
  );
  script_set_attribute(
    attribute:"solution", 
