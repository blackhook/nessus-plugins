...
if (description)
{
  ...
  script_name(english:"RHEL 7 : Virtualization (RHSA-2018:1274)");
  ...
  script_set_attribute(
    ...
    value:
"An update for python-paramiko is now available for Red Hat
Virtualization 4 Management Agent for RHEL 7 and Red Hat
Virtualization Manager 4.1.
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1274"
  );
  script_set_attribute(
    attribute:"see_also",
