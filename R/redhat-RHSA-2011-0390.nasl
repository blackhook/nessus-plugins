...
a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-1097"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:0390"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rsync-debuginfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"rsync-3.0.6-5.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"rsync-3.0.6-5.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsync-3.0.6-5.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"rsync-debuginfo-3.0.6-5.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"rsync-debuginfo-3.0.6-5.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"rsync-debuginfo-3.0.6-5.el6_0.1")) flag++;
