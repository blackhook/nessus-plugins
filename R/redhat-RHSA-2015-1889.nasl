...
# extracted from Red Hat Security Advisory RHSA-2015:1889. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : spice-server (RHSA-2015:1889)");
...
which contains backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1889"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"spice-server-0.12.4-12.el6_7.3")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"spice-server-debuginfo-0.12.4-12.el6_7.3")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"spice-server-devel-0.12.4-12.el6_7.3")) flag++;
