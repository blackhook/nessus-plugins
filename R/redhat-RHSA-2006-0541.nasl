...
# extracted from Red Hat Security Advisory RHSA-2006:0541. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : dia (RHSA-2006:0541)");
...
backported patches and are not vulnerable to these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-2453"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-2480"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0541"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"dia-0.94-5.7.1")) flag++;
