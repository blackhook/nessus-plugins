...
# extracted from Red Hat Security Advisory RHSA-2009:1102. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : cscope (RHSA-2009:1102)");
...
instances of cscope must be restarted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1102"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"cscope-15.5-15.1.el5_3.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"cscope-15.5-15.1.el5_3.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"cscope-15.5-15.1.el5_3.1")) flag++;
