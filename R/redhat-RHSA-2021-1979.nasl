...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1939925");
  ...
  'squid:4': [
    ...
    },
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.11-4.module+el8.4.0+10676+a969168e.2', 'sp':'6', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    },
    {
      'repo_relative_urls': [
