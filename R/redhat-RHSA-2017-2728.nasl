...
as the original reporter of CVE-2017-7547."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/current/release-9-2-22.html"
  );
  # https://www.postgresql.org/docs/current/static/release-9-2-23.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/current/release-9-2-23.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2728"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-7547"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"postgresql-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-contrib-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-contrib-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"postgresql-debuginfo-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"postgresql-devel-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-docs-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-docs-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"postgresql-libs-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-plperl-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-plperl-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-plpython-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-plpython-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-pltcl-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-pltcl-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-server-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-server-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"postgresql-static-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-test-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-test-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"postgresql-upgrade-9.2.23-1.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"postgresql-upgrade-9.2.23-1.el7_4")) flag++;
