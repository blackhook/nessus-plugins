...
# extracted from Red Hat Security Advisory RHSA-2014:0625. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : openssl (RHSA-2014:0625)");
...
the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0625"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"openssl-1.0.1e-16.el6_5.14")) flag++;

  if (rpm_check(release:"RHEL6", reference:"openssl-debuginfo-1.0.1e-16.el6_5.14")) flag++;

  if (rpm_check(release:"RHEL6", reference:"openssl-devel-1.0.1e-16.el6_5.14")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"openssl-perl-1.0.1e-16.el6_5.14")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"openssl-perl-1.0.1e-16.el6_5.14")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openssl-perl-1.0.1e-16.el6_5.14")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"openssl-static-1.0.1e-16.el6_5.14")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"openssl-static-1.0.1e-16.el6_5.14")) flag++;
