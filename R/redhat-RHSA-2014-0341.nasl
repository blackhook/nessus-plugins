...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0341"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"wireshark-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"wireshark-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"wireshark-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"wireshark-debuginfo-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"wireshark-debuginfo-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"wireshark-debuginfo-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"wireshark-gnome-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"wireshark-gnome-1.0.15-6.el5_10")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"wireshark-gnome-1.0.15-6.el5_10")) flag++;
