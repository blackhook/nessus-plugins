...
update, avahi-daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-1002"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:0436"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"avahi-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-compat-howl-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-compat-howl-devel-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-compat-libdns_sd-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-compat-libdns_sd-devel-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-devel-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-glib-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-glib-devel-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-qt3-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"avahi-qt3-devel-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"avahi-tools-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"avahi-tools-0.6.16-10.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"avahi-tools-0.6.16-10.el5_6")) flag++;
