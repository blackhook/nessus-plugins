...
update replaces the packages with signed versions"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-0382"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2002:124"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2002/06/25");
