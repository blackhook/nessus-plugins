...
# extracted from Red Hat Security Advisory RHSA-2005:807. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : curl (RHSA-2005:807)");
...
which contain a backported patch that resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3185"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:807"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"curl-7.10.6-7.rhel3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"curl-devel-7.10.6-7.rhel3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"curl-7.12.1-6.rhel4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"curl-devel-7.12.1-6.rhel4")) flag++;
