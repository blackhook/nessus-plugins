...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-46195");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8415");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2046300");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mingw32-cpp-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-gcc-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-gcc-c++-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw32-libgcc-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-cpp-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-gcc-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-gcc-c++-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mingw64-libgcc-12.0.1-11.2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
