...
# extracted from Red Hat Security Advisory RHSA-2016:1224. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1224");

  script_name(english:"RHEL 6 : qemu-kvm-rhev (RHSA-2016:1224)");
...
Tang (360 Marvel Team) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:1224"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-img-rhev-0.12.1.2-2.479.el6_7.5")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-kvm-rhev-0.12.1.2-2.479.el6_7.5")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-kvm-rhev-debuginfo-0.12.1.2-2.479.el6_7.5")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-kvm-rhev-tools-0.12.1.2-2.479.el6_7.5")) flag++;
