...
location." );
 script_set_attribute(attribute:"see_also", value:"https://www.owasp.org/index.php/Phishing" );
...
script_copyright(english:"This script is Copyright (C) 2008-2021 Westpoint Ltd");
