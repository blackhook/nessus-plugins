...
# extracted from Red Hat Security Advisory RHSA-2015:1043. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1043");

  script_name(english:"RHEL 6 : virtio-win (RHSA-2015:1043)");
...
bugs is now available for Red Hat Enterprise Linux 6 Supplementary.
...
crash from occurring. (BZ#1210196)
...
which contains backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1043"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-3215"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"virtio-win-1.7.4-1.el6_6")) flag++;
