...
# extracted from Red Hat Security Advisory RHSA-2013:1260. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1260");

  script_name(english:"RHEL 6 : rhev-hypervisor6 (RHSA-2013:1260)");
...
to upgrade to this updated package, which corrects these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHBA-2013:1261"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1260"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-4130"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rhev-hypervisor6-6.4-20130912.1.el6_4")) flag++;
