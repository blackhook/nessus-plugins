...
Enterprise Linux 8.1 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:3433"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-14809"
  );
...
appstreams = {
    'go-toolset:rhel8': [
      {'reference':'go-toolset-1.12.8-1.module+el8.1.0+4089+be929cf8', 'cpu':'aarch64', 'release':'8'},
      {'reference':'go-toolset-1.12.8-1.module+el8.1.0+4089+be929cf8', 'cpu':'s390x', 'release':'8'},
      {'reference':'go-toolset-1.12.8-1.module+el8.1.0+4089+be929cf8', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-1.12.8-2.module+el8.1.0+4089+be929cf8', 'cpu':'aarch64', 'release':'8'},
      {'reference':'golang-1.12.8-2.module+el8.1.0+4089+be929cf8', 'cpu':'s390x', 'release':'8'},
      {'reference':'golang-1.12.8-2.module+el8.1.0+4089+be929cf8', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-bin-1.12.8-2.module+el8.1.0+4089+be929cf8', 'cpu':'aarch64', 'release':'8'},
      {'reference':'golang-bin-1.12.8-2.module+el8.1.0+4089+be929cf8', 'cpu':'s390x', 'release':'8'},
      {'reference':'golang-bin-1.12.8-2.module+el8.1.0+4089+be929cf8', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-docs-1.12.8-2.module+el8.1.0+4089+be929cf8', 'release':'8'},
      {'reference':'golang-misc-1.12.8-2.module+el8.1.0+4089+be929cf8', 'release':'8'},
      {'reference':'golang-race-1.12.8-2.module+el8.1.0+4089+be929cf8', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-src-1.12.8-2.module+el8.1.0+4089+be929cf8', 'release':'8'},
      {'reference':'golang-tests-1.12.8-2.module+el8.1.0+4089+be929cf8', 'release':'8'}
    ],
};
