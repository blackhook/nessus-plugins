...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:0832"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-6133"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"i686", reference:"polkit-0.96-7.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"polkit-0.96-7.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"i686", reference:"polkit-debuginfo-0.96-7.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"polkit-debuginfo-0.96-7.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", reference:"polkit-desktop-policy-0.96-7.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"i686", reference:"polkit-devel-0.96-7.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"polkit-devel-0.96-7.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"polkit-docs-0.96-7.el6_6.1")) flag++;
