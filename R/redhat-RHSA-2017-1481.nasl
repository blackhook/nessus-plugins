...
if (description)
{
  ...
  script_name(english:"RHEL 7 : glibc (RHSA-2017:1481) (Stack Clash)");
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:1481"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"glibc-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"glibc-common-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glibc-common-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"glibc-debuginfo-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"glibc-debuginfo-common-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"glibc-devel-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"glibc-headers-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glibc-headers-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"glibc-static-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"glibc-utils-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"glibc-utils-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"nscd-2.17-157.el7_3.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"nscd-2.17-157.el7_3.4")) flag++;
