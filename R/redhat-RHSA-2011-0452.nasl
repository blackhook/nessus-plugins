...
processed certain TIFF image files that were compressed with the JPEG
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-5022"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:0452"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"libtiff-3.9.4-1.el6_0.3")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libtiff-debuginfo-3.9.4-1.el6_0.3")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libtiff-devel-3.9.4-1.el6_0.3")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"libtiff-static-3.9.4-1.el6_0.3")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"libtiff-static-3.9.4-1.el6_0.3")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libtiff-static-3.9.4-1.el6_0.3")) flag++;
