...
security issue is now available for Red Hat OpenShift Enterprise 2.1.
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0530"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2014-0233"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected rubygem-openshift-origin-node package."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rubygem-openshift-origin-node-1.23.9.4-1.el6")) flag++;
