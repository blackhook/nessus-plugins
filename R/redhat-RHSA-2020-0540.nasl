...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1796944");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'sudo-1.8.23-4.el7_7.2', 'sp':'7', 'cpu':'ppc64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.23-4.el7_7.2', 'sp':'7', 'cpu':'ppc64le', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.23-4.el7_7.2', 'sp':'7', 'cpu':'s390x', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-1.8.23-4.el7_7.2', 'sp':'7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sudo-devel-1.8.23-4.el7_7.2', 'sp':'7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      ...
      {'reference':'sudo-devel-1.8.23-4.el7_7.2', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
