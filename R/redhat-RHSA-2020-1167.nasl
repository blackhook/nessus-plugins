...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1757258");
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'nbdkit / nbdkit-basic-plugins / nbdkit-devel / nbdkit-example-plugins / etc');
}
