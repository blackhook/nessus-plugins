...
# extracted from Red Hat Security Advisory RHSA-2014:1955. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:1955");

  script_name(english:"RHEL 6 : wget (RHSA-2014:1955)");
...
which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:1955"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2014-4877"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"i686", reference:"wget-1.12-1.12.el6_5")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"s390x", reference:"wget-1.12-1.12.el6_5")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"wget-1.12-1.12.el6_5")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"i686", reference:"wget-debuginfo-1.12-1.12.el6_5")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"s390x", reference:"wget-debuginfo-1.12-1.12.el6_5")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"wget-debuginfo-1.12-1.12.el6_5")) flag++;
