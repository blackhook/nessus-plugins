...
# extracted from Red Hat Security Advisory RHSA-2011:1240. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:1240");

  script_name(english:"RHEL 4 : redhat-release (EOL Notice) (RHSA-2011:1240)");
...
https://access.redhat.com/support/policy/updates/errata/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2011-1240.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"RHEL4", reference:"redhat-release-4AS-10.2")) flag++;
if (rpm_check(release:"RHEL4", cpu:"i386", reference:"redhat-release-4WS-10.2")) flag++;
if (rpm_check(release:"RHEL4", cpu:"i386", reference:"redhat-release-4ES-10.2")) flag++;
if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"redhat-release-4ES-10.2")) flag++;
if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"redhat-release-4WS-10.2")) flag++;
