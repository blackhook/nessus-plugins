...
# extracted from Red Hat Security Advisory RHSA-2017:2285. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : authconfig (RHSA-2017:2285)");
...
Enterprise Linux 7.4 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2285"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-7488"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
authconfig-gtk packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:authconfig");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:authconfig-debuginfo");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:authconfig-gtk");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"authconfig-6.2.8-30.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"authconfig-6.2.8-30.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"authconfig-debuginfo-6.2.8-30.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"authconfig-debuginfo-6.2.8-30.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"authconfig-gtk-6.2.8-30.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"authconfig-gtk-6.2.8-30.el7")) flag++;
