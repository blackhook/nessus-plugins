...
referenced in the RHSA-2022:6969 advisory.
  ...
  - tripleo-ansible: /var/lib/mistral/overcloud discoverable (CVE-2022-3101)

  - tripleo-ansible: /etc/openstack/clouds.yaml discoverable (CVE-2022-3146)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-3101");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-3146");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:6969");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2123870");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2124721");
  script_set_attribute(attribute:"solution", value:
"Update the affected python3-tripleo-common and / or tripleo-ansible packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-tripleo-common-11.4.1-1.20211201113404.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'tripleo-ansible-0.5.1-1.20220114163454.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'python3-tripleo-common-11.7.1-2.20220318011206.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'tripleo-ansible-0.8.1-2.20220406160116.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
