...
# Rocky Linux Security Advisory RLSA-2023:1470.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:1470");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/04/20");

  script_name(english:"Rocky Linux 9 : kernel (RLSA-2023:1470)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:1470");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, 'KSplice hotfix for RLSA-2023:1470');
  }
  else
  {
...
var pkgs = [
    ...
    {'reference':'bpftool-debuginfo-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-debug-debuginfo-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-debuginfo-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-headers-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'kernel-tools-debuginfo-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'perf-debuginfo-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-perf-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    {'reference':'python3-perf-debuginfo-5.14.0-162.22.2.el9_1', 'cpu':'aarch64', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
];
