...
# extracted from Red Hat Security Advisory RHSA-2013:1869. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : pixman (RHSA-2013:1869)");
...
pixman must be restarted for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1869"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-6425"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"pixman-0.22.0-2.2.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"pixman-0.22.0-2.2.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"pixman-debuginfo-0.22.0-2.2.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"pixman-debuginfo-0.22.0-2.2.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"pixman-devel-0.22.0-2.2.el5_10")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"pixman-devel-0.22.0-2.2.el5_10")) flag++;


  if (rpm_check(release:"RHEL6", reference:"pixman-0.26.2-5.1.el6_5")) flag++;

  if (rpm_check(release:"RHEL6", reference:"pixman-debuginfo-0.26.2-5.1.el6_5")) flag++;

  if (rpm_check(release:"RHEL6", reference:"pixman-devel-0.26.2-5.1.el6_5")) flag++;
