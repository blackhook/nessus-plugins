...
* Thunderbird fails to authenticate with gmail with ssl/tls and OAuth2
(BZ# 1725919)"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:1799"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"thunderbird-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"thunderbird-debuginfo-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"thunderbird-debugsource-60.8.0-1.el8_0", allowmaj:TRUE)) flag++;
