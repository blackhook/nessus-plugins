...
# extracted from Red Hat Security Advisory RHSA-2002:294. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2002:294");

  script_name(english:"RHEL 2.1 : fetchmail (RHSA-2002:294)");
...
containing a backported fix which corrects this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1365"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.e-matters.de/unternehmen/news/security-advisory-05_2002"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2002:294"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"fetchmail-5.9.0-21.7.3")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"fetchmailconf-5.9.0-21.7.3")) flag++;
