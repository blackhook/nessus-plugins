...
us."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0015"
  );
  # http://security.e-matters.de/advisories/012003.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.e-matters.de/unternehmen/news/security-advisory-01_2003"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:013"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2003/02/07");
