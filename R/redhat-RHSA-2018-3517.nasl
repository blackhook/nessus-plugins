...
if (description)
{
  ...
  script_name(english:"RHEL 6 : JBoss EAP (RHSA-2018:3517)");
...
This asynchronous patch is a security update for the RichFaces package
in Red Hat JBoss Enterprise Application Platform 5.2.
...
See https://access.redhat.com/solutions/3660371 for specific
information regarding this flaw.

For more details about the security issue(s), including the impact, a
CVSS score, and other related information, refer to the CVE page(s)
listed in the References section.

Red Hat would like to thank Joao Filho Matos Figueiredo for reporting
this issue."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/solutions/3660371"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:3517"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2018-14667"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL6", reference:"richfaces-3.3.1-6.SP3_patch_03.ep5.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"richfaces-demo-3.3.1-6.SP3_patch_03.ep5.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"richfaces-framework-3.3.1-6.SP3_patch_03.ep5.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"richfaces-root-3.3.1-6.SP3_patch_03.ep5.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"richfaces-ui-3.3.1-6.SP3_patch_03.ep5.el6")) flag++;
