...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 / 8 : JBoss EAP (RHSA-2019:2973)");
...
This asynchronous patch is a security update for
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:2973"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected eap7-wildfly-elytron package."
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL6", reference:"eap7-wildfly-elytron-1.6.4-3.Final_redhat_00002.1.el6")) flag++;

  if (rpm_check(release:"RHEL7", reference:"eap7-wildfly-elytron-1.6.4-3.Final_redhat_00002.1.el7")) flag++;

  if (rpm_check(release:"RHEL8", reference:"eap7-wildfly-elytron-1.6.4-3.Final_redhat_00002.1.el8")) flag++;
