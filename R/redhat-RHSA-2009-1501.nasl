...
# extracted from Red Hat Security Advisory RHSA-2009:1501. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : xpdf (RHSA-2009:1501)");
...
backported patch to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1501"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"xpdf-3.00-22.el4_8.1")) flag++;
