...
referenced in the RHSA-2022:8062 advisory.
  ...
  - unbound: novel ghost domain attack that allows attackers to trigger continued resolvability of malicious
    domain names (CVE-2022-30698, CVE-2022-30699)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-30698");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-30699");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8062");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2116725");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2116729");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-unbound-1.16.2-2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-1.16.2-2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-devel-1.16.2-2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'unbound-libs-1.16.2-2.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
