...
# extracted from Red Hat Security Advisory RHSA-2004:191. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:191");

  script_name(english:"RHEL 2.1 : cadaver (RHSA-2004:191)");
  ...
  script_set_attribute(
    ...
    value:
"An updated cadaver package is now available that fixes a vulnerability
in neon which could be exploitable by a malicious DAV server.
...
assigned the name CVE-2004-0398 to this issue.
...
This issue does not affect Red Hat Enterprise Linux 3."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0398"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:191"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"cadaver-0.22.1-1.0")) flag++;
