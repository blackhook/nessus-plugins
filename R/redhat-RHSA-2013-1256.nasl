...
# extracted from Red Hat Security Advisory RHSA-2013:1256. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1256");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2013:1256)");
  ...
  script_set_attribute(
    ...
    value:
"An updated Adobe Flash Player package that fixes four security issues
...
which upgrades Flash Player to version 11.2.202.310."
  );
  # http://www.adobe.com/support/security/bulletins/apsb13-21.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.adobe.com/support/security/bulletins/apsb13-21.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1256"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-5324"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-3361"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-3363"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-3362"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", sp:"9", reference:"flash-plugin-11.2.202.310-1.el5")) flag++;


  if (rpm_check(release:"RHEL6", reference:"flash-plugin-11.2.202.310-1.el6")) flag++;
