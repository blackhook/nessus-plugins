...
# extracted from Red Hat Security Advisory RHSA-2007:1128. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : autofs (RHSA-2007:1128)");
...
Red Hat would like to thank Josh Lange for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-5964"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:1128"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"autofs-5.0.1-0.rc2.55.el5.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"autofs-5.0.1-0.rc2.55.el5.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"autofs-5.0.1-0.rc2.55.el5.1")) flag++;
