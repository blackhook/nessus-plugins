...
# extracted from Red Hat Security Advisory RHSA-2013:1193. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2013-2185");
  script_xref(name:"RHSA", value:"2013:1193");

  script_name(english:"RHEL 5 / 6 : jbossweb (RHSA-2013:1193)");
  ...
  script_set_attribute(
    ...
    value:
"An updated jbossweb package that fixes one security issue is now
available for Red Hat JBoss Enterprise Application Platform 6.1.0 for
...
running the application server process. (CVE-2013-2185)
...
Red Hat Enterprise Linux 5 and 6 are advised to upgrade to this
updated package. The JBoss server process must be restarted for the
update to take effect."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1193"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-2185"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"jbossweb-7.2.0-3.redhat_2.ep6.el5")) flag++;

  if (rpm_check(release:"RHEL6", reference:"jbossweb-7.2.0-3.redhat_2.ep6.el6")) flag++;
