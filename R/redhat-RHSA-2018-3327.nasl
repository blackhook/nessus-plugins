...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-14679");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-14680");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-14681");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-14682");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"i686", reference:"libmspack-0.5-0.6.alpha.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"libmspack-0.5-0.6.alpha.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"i686", reference:"libmspack-debuginfo-0.5-0.6.alpha.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"libmspack-debuginfo-0.5-0.6.alpha.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"i686", reference:"libmspack-devel-0.5-0.6.alpha.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"libmspack-devel-0.5-0.6.alpha.el7")) flag++;
