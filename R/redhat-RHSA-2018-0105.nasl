...
# extracted from Red Hat Security Advisory RHSA-2018:0105. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2018:0105");
  script_xref(name:"IAVA", value:"2018-A-0020");

  script_name(english:"RHEL 6 : qemu-kvm (RHSA-2018:0105) (Spectre)");
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:0105"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-guest-agent-0.12.1.2-2.415.el6_5.17")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-img-0.12.1.2-2.415.el6_5.17")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-kvm-0.12.1.2-2.415.el6_5.17")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-kvm-debuginfo-0.12.1.2-2.415.el6_5.17")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-kvm-tools-0.12.1.2-2.415.el6_5.17")) flag++;
