...
# extracted from Red Hat Security Advisory RHSA-2016:2575. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : curl (RHSA-2016:2575)");
...
Enterprise Linux 7.3 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:2575"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-5419"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-5420"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-7141"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"curl-7.29.0-35.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"curl-7.29.0-35.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"curl-debuginfo-7.29.0-35.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libcurl-7.29.0-35.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libcurl-devel-7.29.0-35.el7")) flag++;
