...
# extracted from Red Hat Security Advisory RHSA-2009:0269. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : gstreamer-plugins (RHSA-2009:0269)");
...
nautilus-media) must be restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-0398"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0269"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"gstreamer-plugins-0.6.0-19")) flag++;
  if (rpm_check(release:"RHEL3", reference:"gstreamer-plugins-devel-0.6.0-19")) flag++;
