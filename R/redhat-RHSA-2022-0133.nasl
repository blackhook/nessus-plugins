...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Virtualization Host security and bug fix update [ovirt-4.4.9] Async #2 (Important) (RHSA-2022:0133)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.9-202201072228_8.5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
