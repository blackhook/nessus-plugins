...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2091"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"s390x", reference:"patch-2.7.1-10.el7_4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"patch-2.7.1-10.el7_4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"s390x", reference:"patch-debuginfo-2.7.1-10.el7_4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"patch-debuginfo-2.7.1-10.el7_4")) flag++;
