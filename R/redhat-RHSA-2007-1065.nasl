...
# extracted from Red Hat Security Advisory RHSA-2007:1065. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2007:1065");

  script_name(english:"RHEL 2.1 : pcre (RHSA-2007:1065)");
...
regular expressions. If an application linked against PCRE parses a
...
Red Hat would like to thank Ludwig Nussel for reporting these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-1660"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:1065"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"pcre-3.4-2.4")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"pcre-devel-3.4-2.4")) flag++;
