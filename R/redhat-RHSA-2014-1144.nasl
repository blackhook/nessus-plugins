...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:1144"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-24.8.0-2.el5_10", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-24.8.0-2.el5_10", allowmaj:TRUE)) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-24.8.0-1.el6_5", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-24.8.0-1.el6_5", allowmaj:TRUE)) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-24.8.0-1.el7_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-24.8.0-1.el7_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL7", reference:"xulrunner-24.8.0-1.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"xulrunner-debuginfo-24.8.0-1.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", reference:"xulrunner-devel-24.8.0-1.el7_0")) flag++;
