...
# extracted from Red Hat Security Advisory RHSA-2016:1060. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:1060");

  script_name(english:"RHEL 6 : postgresql92 in Satellite Server (RHSA-2016:1060)");
...
was found in the PostgreSQL handling code for regular expressions. A
...
reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:1060"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"postgresql92-postgresql-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"postgresql92-postgresql-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"postgresql92-postgresql-contrib-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"postgresql92-postgresql-contrib-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"postgresql92-postgresql-libs-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"postgresql92-postgresql-libs-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"postgresql92-postgresql-pltcl-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"postgresql92-postgresql-pltcl-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"postgresql92-postgresql-server-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"postgresql92-postgresql-server-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"postgresql92-postgresql-upgrade-9.2.15-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"postgresql92-postgresql-upgrade-9.2.15-2.el6")) flag++;
