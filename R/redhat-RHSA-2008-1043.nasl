...
# extracted from Red Hat Security Advisory RHSA-2008:1043. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2008-3104", "CVE-2008-3108");
  script_bugtraq_id(30140, 30147);
  script_xref(name:"RHSA", value:"2008:1043");

  script_name(english:"RHEL 3 / 4 / 5 : java-1.4.2-bea (RHSA-2008:1043)");
...
Supplementary, contains security flaws and should not be used.
...
The java-1.4.2-bea packages are vulnerable to important security flaws
...
triggered in java-1.4.2-bea by calling the 'appletviewer' application.
...
This update removes the java-1.4.2-bea packages due to their known
security vulnerabilities."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.oracle.com/technology/software/products/jrockit/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:1043"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected java-1.4.2-bea-uninstall package."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:java-1.4.2-bea-uninstall");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", cpu:"i686", reference:"java-1.4.2-bea-uninstall-1.4.2.16-1jpp.3.el3")) flag++;


  if (rpm_check(release:"RHEL4", cpu:"i686", reference:"java-1.4.2-bea-uninstall-1.4.2.16-1jpp.7.el4")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i686", reference:"java-1.4.2-bea-uninstall-1.4.2.16-1jpp.3.el5")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "java-1.4.2-bea-uninstall");
  }
}
