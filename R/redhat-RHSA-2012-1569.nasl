...
# extracted from Red Hat Security Advisory RHSA-2012:1569. The text 
...
if (description)
{
  ...
  script_bugtraq_id(56892, 56896, 56898, 56900);
  script_xref(name:"RHSA", value:"2012:1569");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2012:1569)");
...
which upgrades Flash Player to version 11.2.202.258."
  );
  # http://www.adobe.com/support/security/bulletins/apsb12-27.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.adobe.com/support/security/bulletins/apsb12-27.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:1569"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-5678"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-5676"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-5677"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"flash-plugin-11.2.202.258-1.el5")) flag++;


  if (rpm_check(release:"RHEL6", reference:"flash-plugin-11.2.202.258-1.el6")) flag++;
