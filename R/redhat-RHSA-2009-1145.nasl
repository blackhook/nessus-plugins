...
# extracted from Red Hat Security Advisory RHSA-2009:1145. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2009:1145");

  script_name(english:"RHEL 5 : JBoss EAP (RHSA-2009:1145)");
...
upgrade to these updated packages."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1145"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL5", reference:"glassfish-jaxb-2.1.4-1.11.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"glassfish-jaxb-javadoc-2.1.4-1.11.1.ep1.el5")) flag++;
  ...
  if (rpm_check(release:"RHEL5", reference:"jboss-messaging-1.4.0-2.SP3_CP08.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jboss-remoting-2.2.3-2.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jboss-seam-1.2.1-3.JBPAPP_4_3_0_GA.ep1.11.el5.1")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jboss-seam-docs-1.2.1-3.JBPAPP_4_3_0_GA.ep1.11.el5.1")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jbossas-4.3.0-4.GA_CP05.6.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jbossas-4.3.0.GA_CP05-bin-4.3.0-4.GA_CP05.6.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jbossas-client-4.3.0-4.GA_CP05.6.1.ep1.el5")) flag++;
  ...
  if (rpm_check(release:"RHEL5", reference:"jbossws-2.0.1-3.SP2_CP06.3.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jbossws-common-1.0.0-2.GA_CP04.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jbossws-framework-2.0.1-1.GA_CP04.2.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jbossws-native42-2.0.1-3.SP2_CP06.3.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jbossws-spi-1.0.0-1.GA_CP02.1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"jgroups-2.4.6-1.ep1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"rh-eap-docs-4.3.0-5.GA_CP05.ep1.2.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"rh-eap-docs-examples-4.3.0-5.GA_CP05.ep1.2.1.el5")) flag++;
