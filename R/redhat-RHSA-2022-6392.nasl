...
if (description)
{
  ...
  script_name(english:"RHEL 8 : RHV RHEL Host (ovirt-host) [ovirt-4.5.2] (RHSA-2022:6392)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-ovirt-dashboard-0.16.2-1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
