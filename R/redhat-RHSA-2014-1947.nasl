...
# extracted from Red Hat Security Advisory RHSA-2014:1947. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3561");
  script_xref(name:"RHSA", value:"2014:1947");

  script_name(english:"RHEL 6 : rhevm-log-collector (RHSA-2014:1947)");
...
package, which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:1947"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2014-3561"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected rhevm-log-collector package."
  );
...
{
  flag = 0;
  if (rpm_exists(rpm:"rhevm-log-collector-3.4.", release:"RHEL6") && rpm_check(release:"RHEL6", reference:"rhevm-log-collector-3.4.5-2.el6ev")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "rhevm-log-collector");
  }
}
