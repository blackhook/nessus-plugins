...
reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2459"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-2885"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"libsoup-2.56.0-4.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libsoup-debuginfo-2.56.0-4.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libsoup-devel-2.56.0-4.el7_4")) flag++;
