...
# extracted from Red Hat Security Advisory RHSA-2017:1552. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:1552");

  script_name(english:"RHEL 6 : jboss-ec2-eap (RHSA-2017:1552)");
...
parameters for the JSP Servlet. (CVE-2016-6796)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:1552"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"jboss-ec2-eap-7.5.16-1.Final_redhat_1.ep6.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"jboss-ec2-eap-samples-7.5.16-1.Final_redhat_1.ep6.el6")) flag++;
