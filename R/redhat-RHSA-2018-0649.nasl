...
Initiative as the original reporter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:0649"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"libvorbis-1.2.3-5.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"libvorbis-debuginfo-1.2.3-5.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"libvorbis-devel-1.2.3-5.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"libvorbis-devel-docs-1.2.3-5.el6_9.1")) flag++;
