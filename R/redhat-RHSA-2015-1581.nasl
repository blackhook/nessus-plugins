...
# extracted from Red Hat Security Advisory RHSA-2015:1581. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 / 7 : firefox (RHSA-2015:1581)");
...
take effect.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8b5eaff4");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/articles/1563163");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1581");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2015-4495");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-38.1.1-1.el5_11", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-38.1.1-1.el5_11", allowmaj:TRUE)) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-38.1.1-1.el6_7", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-38.1.1-1.el6_7", allowmaj:TRUE)) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-38.1.1-1.el7_1", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-38.1.1-1.el7_1", allowmaj:TRUE)) flag++;
