...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : samba (RHSA-2008:0288)");
...
contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0288"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-2.2.12-1.21as.9.3")) flag++;

  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-client-2.2.12-1.21as.9.3")) flag++;

  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-common-2.2.12-1.21as.9.3")) flag++;

  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-swat-2.2.12-1.21as.9.3")) flag++;


  if (rpm_check(release:"RHEL3", reference:"samba-3.0.9-1.3E.15")) flag++;

  if (rpm_check(release:"RHEL3", reference:"samba-client-3.0.9-1.3E.15")) flag++;

  if (rpm_check(release:"RHEL3", reference:"samba-common-3.0.9-1.3E.15")) flag++;

  if (rpm_check(release:"RHEL3", reference:"samba-swat-3.0.9-1.3E.15")) flag++;


  if (rpm_check(release:"RHEL4", reference:"samba-3.0.25b-1.el4_6.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"samba-client-3.0.25b-1.el4_6.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"samba-common-3.0.25b-1.el4_6.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"samba-swat-3.0.25b-1.el4_6.5")) flag++;
