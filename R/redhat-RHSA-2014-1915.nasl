...
# extracted from Red Hat Security Advisory RHSA-2014:1915. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:1915");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/06/15");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2014:1915)");
...
which upgrades Flash Player to version 11.2.202.424.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1915");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2014-8439");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"flash-plugin-11.2.202.424-1.el5")) flag++;


  if (rpm_check(release:"RHEL6", reference:"flash-plugin-11.2.202.424-1.el6")) flag++;
