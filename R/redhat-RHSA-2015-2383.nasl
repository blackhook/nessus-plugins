...
which correct these issues and add these enhancements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:2383"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-1867"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pacemaker-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-cli-1.1.13-10.el7")) flag++;
  ...
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-cluster-libs-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pacemaker-cluster-libs-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-cts-1.1.13-10.el7")) flag++;
  ...
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-debuginfo-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pacemaker-debuginfo-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-doc-1.1.13-10.el7")) flag++;
  ...
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-libs-1.1.13-10.el7")) flag++;
  ...
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-libs-devel-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pacemaker-libs-devel-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-nagios-plugins-metadata-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pacemaker-nagios-plugins-metadata-1.1.13-10.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pacemaker-remote-1.1.13-10.el7")) flag++;
