...
# extracted from Red Hat Security Advisory RHSA-2003:045. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2003:045");

  script_name(english:"RHEL 2.1 : w3m (RHSA-2003:045)");
...
W3M 0.2.1 and a patch to correct these vulnerabilities."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1335"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1348"
  );
  # http://mi.med.tohoku.ac.jp/~satodai/w3m-dev-en/200211.month/838.html
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?20fdb87f"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:045"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"w3m-0.2.1-11.AS21.1")) flag++;
