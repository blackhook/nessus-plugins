...
# extracted from Red Hat Security Advisory RHSA-2007:0065. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : bluez-utils (RHSA-2007:0065)");
...
which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-6899"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0065"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", cpu:"i386", reference:"bluez-utils-2.10-2.2")) flag++;

  if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"bluez-utils-2.10-2.2")) flag++;

  if (rpm_check(release:"RHEL4", cpu:"i386", reference:"bluez-utils-cups-2.10-2.2")) flag++;

  if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"bluez-utils-cups-2.10-2.2")) flag++;
