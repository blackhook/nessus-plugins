...
# extracted from Red Hat Security Advisory RHSA-2008:1036. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : firefox (RHSA-2008:1036)");
...
contain backported patches that correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-5505"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-5510"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:1036"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"firefox-3.0.5-1.el4")) flag++;

  if (rpm_check(release:"RHEL4", reference:"nspr-4.7.3-1.el4")) flag++;

  if (rpm_check(release:"RHEL4", reference:"nspr-devel-4.7.3-1.el4")) flag++;

  if (rpm_check(release:"RHEL4", reference:"nss-3.12.2.0-1.el4")) flag++;

  if (rpm_check(release:"RHEL4", reference:"nss-devel-3.12.2.0-1.el4")) flag++;


  if (rpm_check(release:"RHEL5", reference:"firefox-3.0.5-1.el5_2")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nspr-4.7.3-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nspr-devel-4.7.3-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-3.12.2.0-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-devel-3.12.2.0-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-pkcs11-devel-3.12.2.0-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"nss-tools-3.12.2.0-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"nss-tools-3.12.2.0-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"nss-tools-3.12.2.0-2.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"xulrunner-1.9.0.5-1.el5_2")) flag++;

  if (rpm_check(release:"RHEL5", reference:"xulrunner-devel-1.9.0.5-1.el5_2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"xulrunner-devel-unstable-1.9.0.5-1.el5_2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"xulrunner-devel-unstable-1.9.0.5-1.el5_2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"xulrunner-devel-unstable-1.9.0.5-1.el5_2")) flag++;
