...
if (description)
{
  ...
  script_name(english:"RHEL 7 : Red Hat Single Sign-On 7.2.7 (RHSA-2019:0856)");
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:0856"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"rh-sso7-keycloak-3.4.17-1.Final_redhat_00001.1.jbcs.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"rh-sso7-keycloak-server-3.4.17-1.Final_redhat_00001.1.jbcs.el7")) flag++;
