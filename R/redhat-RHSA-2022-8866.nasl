...
the RHSA-2022:8866 advisory.
  ...
  - AngularJS: Prototype pollution in merge function could result in code injection (CVE-2019-10768)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-10768");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8866");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1813309");
  script_set_attribute(attribute:"solution", value:
"Update the affected XStatic-Angular-common and / or python3-XStatic-Angular packages.");
