...
# extracted from Red Hat Security Advisory RHSA-2016:1086. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : libndp (RHSA-2016:1086)");
...
this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:1086"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-3698"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libndp-debuginfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"libndp-1.2-6.el7_2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libndp-debuginfo-1.2-6.el7_2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libndp-devel-1.2-6.el7_2")) flag++;
