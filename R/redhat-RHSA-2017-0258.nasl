...
privileges to root. (CVE-2016-9566)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0258"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected nagios-common and / or nagios-debuginfo packages."
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"nagios-debuginfo-3.5.1-9.el7")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "nagios-common / nagios-debuginfo");
  }
}
