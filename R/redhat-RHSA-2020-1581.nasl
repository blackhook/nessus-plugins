...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2018-19840");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2018-19841");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-11498");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-1010315");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-1010317");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-1010319");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1581");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1661448");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1661449");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1704633");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1729418");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1737740");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1737747");
...
"Update the affected wavpack and / or wavpack-devel packages.");
  ...
  script_cwe_id(20, 125, 369, 456, 665, 835);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'wavpack-5.1.0-15.el8', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wavpack-devel-5.1.0-15.el8', 'sp':'2', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'wavpack-5.1.0-15.el8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wavpack-devel-5.1.0-15.el8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'wavpack-5.1.0-15.el8', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'wavpack-devel-5.1.0-15.el8', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
