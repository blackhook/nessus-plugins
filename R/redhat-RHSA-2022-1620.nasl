...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : OpenShift Container Platform 4.6.57 packages and (RHSA-2022:1620)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-0711");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2053666");
...
"Update the affected haproxy20 and / or jenkins-2-plugins packages.");
  ...
  script_cwe_id(20, 59, 78, 179, 200, 400, 522, 835);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'haproxy20-2.0.16-5.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'haproxy20-2.0.16-5.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'jenkins-2-plugins-4.6.1650364520-1.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'haproxy20-2.0.16-3.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
