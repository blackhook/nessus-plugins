...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-1343");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-1473");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-2068");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-2097");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2087911");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2087913");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2097310");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2104905");
...
"Update the affected packages.");
  ...
  script_cwe_id(77, 295, 325, 401, 404);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openssl-3.0.1-41.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-devel-3.0.1-41.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-libs-3.0.1-41.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'openssl-perl-3.0.1-41.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  },
  {
    'repo_relative_urls': [
