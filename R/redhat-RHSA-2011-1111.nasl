...
# extracted from Red Hat Security Advisory RHSA-2011:1111. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:1111");

  script_xref(name:"IAVA", value:"0001-A-0645");

  script_name(english:"RHEL 5 : redhat-release (EOL Notice) (RHSA-2011:1111)");
...
Extended Update Support Add-On (EUS) 5.4.
...
https://access.redhat.com/support/policy/updates/errata/"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2011-1111.html"
  );
  script_set_attribute(
    attribute:"solution", 
...
flag = 0;
if (rpm_check(release:"RHEL5", sp:"4", cpu:"i386", reference:"redhat-release-5Server-5.4.0.7")) flag++;
if (rpm_check(release:"RHEL5", sp:"4", cpu:"s390x", reference:"redhat-release-5Server-5.4.0.7")) flag++;
if (rpm_check(release:"RHEL5", sp:"4", cpu:"x86_64", reference:"redhat-release-5Server-5.4.0.7")) flag++;
