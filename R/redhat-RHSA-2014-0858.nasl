...
# extracted from Red Hat Security Advisory RHSA-2014:0858. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0858");

  script_name(english:"RHEL 6 : MRG (RHSA-2014:0858)");
...
which corrects these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0858"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2014-0174"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-2682"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL6", reference:"cumin-0.1.5797-3.el6")) flag++;
