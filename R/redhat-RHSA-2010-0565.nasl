...
# extracted from Red Hat Security Advisory RHSA-2010:0565. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : w3m (RHSA-2010:0565)");
...
a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-2074"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0565"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:w3m-img");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"w3m-0.5.1-17.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"w3m-0.5.1-17.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"w3m-0.5.1-17.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"w3m-img-0.5.1-17.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"w3m-img-0.5.1-17.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"w3m-img-0.5.1-17.el5_5")) flag++;
