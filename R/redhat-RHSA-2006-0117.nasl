...
# extracted from Red Hat Security Advisory RHSA-2006:0117. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : vixie-cron (RHSA-2006:0117)");
...
contains backported patches and is not vulnerable to these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-1038"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0117"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"vixie-cron-4.1-10.EL3")) flag++;
