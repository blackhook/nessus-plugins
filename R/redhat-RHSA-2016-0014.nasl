...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : Storage Server (RHSA-2016:0014)");
...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:0014"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ldb-tools-1.1.20-3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libldb-1.1.20-3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libldb-debuginfo-1.1.20-3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libldb-devel-1.1.20-3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"pyldb-1.1.20-3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"pyldb-devel-1.1.20-3.el6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ldb-tools-1.1.20-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"libldb-1.1.20-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"libldb-debuginfo-1.1.20-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"libldb-devel-1.1.20-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pyldb-1.1.20-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pyldb-devel-1.1.20-3.el7")) flag++;
