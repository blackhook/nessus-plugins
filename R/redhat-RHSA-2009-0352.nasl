...
# extracted from Red Hat Security Advisory RHSA-2009:0352. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : gstreamer-plugins-base (RHSA-2009:0352)");
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-0586"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0352"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
gstreamer-plugins-base-devel packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:gstreamer-plugins-base-devel");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"gstreamer-plugins-base-0.10.20-3.0.1.el5_3")) flag++;

  if (rpm_check(release:"RHEL5", reference:"gstreamer-plugins-base-devel-0.10.20-3.0.1.el5_3")) flag++;
