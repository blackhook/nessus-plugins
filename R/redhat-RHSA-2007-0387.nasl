...
# extracted from Red Hat Security Advisory RHSA-2007:0387. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : tcpdump (RHSA-2007:0387)");
...
which contain backported patches that correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0387"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"arpwatch-2.1a13-12.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"libpcap-0.8.3-12.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"tcpdump-3.8.2-12.el4")) flag++;
