...
Virtual Machines. This package contains a sample 64-bit UEFI firmware
for QEMU and KVM.
...
Enterprise Linux 8.1 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:3338"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected edk2-ovmf package."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", reference:"edk2-ovmf-20190308git89910a39dcfd-6.el8")) flag++;
