...
# extracted from Red Hat Security Advisory RHSA-2015:1235. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1235");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/05/04");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2015:1235)");
...
containing the malicious SWF content. (CVE-2015-5122, CVE-2015-5123)

All users of Adobe Flash Player should install this updated package,
which upgrades Flash Player to version 11.2.202.491.");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsb15-18.html");
  script_set_attribute(attribute:"see_also", value:"https://helpx.adobe.com/security/products/flash-player/apsa15-04.html");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1235");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2015-5123");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2015-5122");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"flash-plugin-11.2.202.491-1.el5")) flag++;


  if (rpm_check(release:"RHEL6", reference:"flash-plugin-11.2.202.491-1.el6_6")) flag++;
