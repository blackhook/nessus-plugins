...
if (description)
{
  ...
  script_name(english:"RHEL 6 : Red Hat Single Sign-On 7.2.7 (RHSA-2019:0857)");
...
This release of Red Hat Single Sign-On 7.2.7 serves as a replacement
for Red Hat Single Sign-On 7.2.6, and includes bug fixes and
enhancements.
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:0857"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-3868"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rh-sso7-keycloak-3.4.17-1.Final_redhat_00001.1.jbcs.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rh-sso7-keycloak-server-3.4.17-1.Final_redhat_00001.1.jbcs.el6")) flag++;
