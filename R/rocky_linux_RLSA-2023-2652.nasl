...
# Rocky Linux Security Advisory RLSA-2023:2652.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:2652");

  script_name(english:"Rocky Linux 9 : pcs (RLSA-2023:2652)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:2652");
...
var pkgs = [
    ...
    {'reference':'pcs-0.11.4-7.el9_2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
    ...
    {'reference':'pcs-snmp-0.11.4-7.el9_2', 'cpu':'s390x', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
