...
version, which corrects these issues and adds these enhancements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:2066"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-5245"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"userspace-rcu-0.7.9-2.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"userspace-rcu-debuginfo-0.7.9-2.el7")) flag++;
