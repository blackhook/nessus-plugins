...
# extracted from Red Hat Security Advisory RHSA-2021:3231. The text
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2021:3231");

  script_name(english:"RHEL 8 : exiv2 (RHSA-2021:3231) (deprecated)");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:3231");
