...
referenced in the RHSA-2022:6590 advisory.
  ...
  - mysql: Server: Optimizer unspecified vulnerability (CPU Oct 2022) (CVE-2022-21607, CVE-2022-21638,
    CVE-2022-21641)
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mysql-8.0.30-3.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-common-8.0.30-3.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-devel-8.0.30-3.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-errmsg-8.0.30-3.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-libs-8.0.30-3.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-server-8.0.30-3.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'mysql-test-8.0.30-3.el9_0', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
