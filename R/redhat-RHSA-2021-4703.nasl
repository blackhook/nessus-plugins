...
"Update the affected ansible and / or ovirt-ansible-collection packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ansible-2.9.27-1.el8ae', 'release':'8', 'el_string':'el8ae', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'},
      {'reference':'ovirt-ansible-collection-1.6.5-1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
