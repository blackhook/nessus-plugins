...
# extracted from Red Hat Security Advisory RHSA-2009:1219. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : libvorbis (RHSA-2009:1219)");
...
restarted (log out, then log back in) for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-2663"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1219"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"libvorbis-1.0-11.el3")) flag++;

  if (rpm_check(release:"RHEL3", reference:"libvorbis-devel-1.0-11.el3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"libvorbis-1.1.0-3.el4_8.2")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libvorbis-devel-1.1.0-3.el4_8.2")) flag++;


  if (rpm_check(release:"RHEL5", reference:"libvorbis-1.1.2-3.el5_3.3")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libvorbis-devel-1.1.2-3.el5_3.3")) flag++;
