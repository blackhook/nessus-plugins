...
# extracted from Red Hat Security Advisory RHSA-2005:747. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:747");

  script_name(english:"RHEL 2.1 : slocate (RHSA-2005:747)");
...
searches through a nightly-updated central database for files that
match a given pattern.

A bug was found in the way slocate processes very long paths. A local
user could create a carefully crafted directory structure that would
prevent updatedb from completing its file system scan, resulting in an
incomplete slocate database. The Common Vulnerabilities and Exposures
project has assigned the name CVE-2005-2499 to this issue.
...
backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:747"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"slocate-2.7-1.el2.1")) flag++;
