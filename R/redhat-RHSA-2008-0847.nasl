...
# extracted from Red Hat Security Advisory RHSA-2008:0847. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : libtiff (RHSA-2008:0847)");
...
which contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0847"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"libtiff-3.8.2-7.el5_2.2")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libtiff-devel-3.8.2-7.el5_2.2")) flag++;
