...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-0192"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:0318"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"libtiff-3.6.1-17.el4")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libtiff-devel-3.6.1-17.el4")) flag++;


  if (rpm_check(release:"RHEL5", reference:"libtiff-3.8.2-7.el5_6.6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libtiff-devel-3.8.2-7.el5_6.6")) flag++;


  if (rpm_check(release:"RHEL6", reference:"libtiff-3.9.4-1.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libtiff-debuginfo-3.9.4-1.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libtiff-devel-3.9.4-1.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"libtiff-static-3.9.4-1.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"libtiff-static-3.9.4-1.el6_0.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libtiff-static-3.9.4-1.el6_0.1")) flag++;
