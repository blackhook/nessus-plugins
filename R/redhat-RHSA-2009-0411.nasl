...
# extracted from Red Hat Security Advisory RHSA-2009:0411. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : device-mapper-multipath (RHSA-2009:0411)");
...
# service multipathd restart"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-0115"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.redhat.com/show_bug.cgi?id=494582"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0411"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"device-mapper-multipath-0.4.5-31.el4_7.1")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"device-mapper-multipath-0.4.7-23.el5_3.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"device-mapper-multipath-0.4.7-23.el5_3.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"device-mapper-multipath-0.4.7-23.el5_3.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"kpartx-0.4.7-23.el5_3.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"kpartx-0.4.7-23.el5_3.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"kpartx-0.4.7-23.el5_3.2")) flag++;
