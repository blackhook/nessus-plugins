...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : cvs (RHSA-2005:387)");
...
includes a backported patch to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-0753"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:387"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"cvs-1.11.1p1-18")) flag++;

  if (rpm_check(release:"RHEL3", reference:"cvs-1.11.2-27")) flag++;

  if (rpm_check(release:"RHEL4", reference:"cvs-1.11.17-7.RHEL4")) flag++;
