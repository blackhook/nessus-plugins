...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Virtualization Host security, bug fix and enhancement update (4.4.4-2) (Moderate) (RHSA-2021:0976)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.4-20210307.0.el8_3', 'release':'8', 'el_string':'el8_3', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
