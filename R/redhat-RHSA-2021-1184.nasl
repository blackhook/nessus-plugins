...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cockpit-ovirt-dashboard-0.14.20-1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
