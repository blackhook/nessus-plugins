...
# extracted from Red Hat Security Advisory RHSA-2005:875. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : curl (RHSA-2005:875)");
...
which contain a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-4077"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:875"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"curl-7.12.1-8.rhel4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"curl-devel-7.12.1-8.rhel4")) flag++;
