...
# extracted from Red Hat Security Advisory RHSA-2005:345. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : slocate (RHSA-2005:345)");
...
contains backported patches and is not affected by these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:345"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"slocate-2.7-3.RHEL3.6")) flag++;
