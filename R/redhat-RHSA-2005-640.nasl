...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : fetchmail (RHSA-2005:640)");
...
contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-2335"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:640"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"fetchmail-5.9.0-21.7.3.el2.1.1")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"fetchmailconf-5.9.0-21.7.3.el2.1.1")) flag++;

  if (rpm_check(release:"RHEL3", reference:"fetchmail-6.2.0-3.el3.2")) flag++;

  if (rpm_check(release:"RHEL4", reference:"fetchmail-6.2.5-6.el4.2")) flag++;
