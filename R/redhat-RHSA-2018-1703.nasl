...
and Kevin Backhouse (lgtm.com / Semmle) as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1703"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"i686", reference:"librelp-1.2.0-4.el7_2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"librelp-1.2.0-4.el7_2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"i686", reference:"librelp-debuginfo-1.2.0-4.el7_2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"librelp-debuginfo-1.2.0-4.el7_2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"i686", reference:"librelp-devel-1.2.0-4.el7_2")) flag++;
  if (rpm_check(release:"RHEL7", sp:"2", cpu:"x86_64", reference:"librelp-devel-1.2.0-4.el7_2")) flag++;
