...
# extracted from Red Hat Security Advisory RHSA-2003:404. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2003:404");

  script_name(english:"RHEL 2.1 / 3 : lftp (RHSA-2003:404)");
...
alerting us to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0963"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:404"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"lftp-2.4.9-2")) flag++;

  if (rpm_check(release:"RHEL3", reference:"lftp-2.6.3-5")) flag++;
