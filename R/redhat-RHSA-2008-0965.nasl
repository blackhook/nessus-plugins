...
# extracted from Red Hat Security Advisory RHSA-2008:0965. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 / 5 : lynx (RHSA-2008:0965)");
...
which contains backported patches correcting these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-7234"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-4690"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0965"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"lynx-2.8.4-18.1.3")) flag++;


  if (rpm_check(release:"RHEL3", reference:"lynx-2.8.5-11.3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"lynx-2.8.5-18.2.el4_7.1")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"lynx-2.8.5-28.1.el5_2.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"lynx-2.8.5-28.1.el5_2.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"lynx-2.8.5-28.1.el5_2.1")) flag++;
