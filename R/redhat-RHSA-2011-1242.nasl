...
# extracted from Red Hat Security Advisory RHSA-2011:1242. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 / 6 : firefox (RHSA-2011:1242)");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"firefox-3.6.20-3.el4")) flag++;


  if (rpm_check(release:"RHEL5", reference:"xulrunner-1.9.2.20-3.el5_7")) flag++;

  if (rpm_check(release:"RHEL5", reference:"xulrunner-devel-1.9.2.20-3.el5_7")) flag++;


  if (rpm_check(release:"RHEL6", reference:"xulrunner-1.9.2.20-3.el6_1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"xulrunner-debuginfo-1.9.2.20-3.el6_1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"xulrunner-devel-1.9.2.20-3.el6_1")) flag++;
