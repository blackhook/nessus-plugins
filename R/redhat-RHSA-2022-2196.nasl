...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-23267");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-29117");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-29145");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:2196");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2083647");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2083649");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2083650");
...
"Update the affected packages.");
  ...
  script_cwe_id(20, 179, 551, 565, 770);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet50-aspnetcore-runtime-5.0-5.0.17-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-aspnetcore-targeting-pack-5.0-5.0.17-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-5.0.214-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-apphost-pack-5.0-5.0.17-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-host-5.0.17-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-hostfxr-5.0-5.0.17-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-runtime-5.0-5.0.17-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-sdk-5.0-5.0.214-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-sdk-5.0-source-built-artifacts-5.0.214-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-targeting-pack-5.0-5.0.17-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-templates-5.0-5.0.214-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-netstandard-targeting-pack-2.1-5.0.214-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'}
    ]
  }
];
