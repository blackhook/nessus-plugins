...
# extracted from Red Hat Security Advisory RHSA-2016:0009. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : libldb (RHSA-2016:0009)");
...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:0009"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-3223"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ldb-tools-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"ldb-tools-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ldb-tools-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libldb-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libldb-debuginfo-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libldb-devel-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"pyldb-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"pyldb-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"pyldb-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"pyldb-devel-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"pyldb-devel-1.1.13-3.el6_7.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"pyldb-devel-1.1.13-3.el6_7.1")) flag++;


  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"ldb-tools-1.1.20-1.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"ldb-tools-1.1.20-1.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libldb-1.1.20-1.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libldb-debuginfo-1.1.20-1.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libldb-devel-1.1.20-1.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"pyldb-1.1.20-1.el7_2.2")) flag++;

  if (rpm_check(release:"RHEL7", reference:"pyldb-devel-1.1.20-1.el7_2.2")) flag++;
