...
# extracted from Red Hat Security Advisory RHSA-2006:0486. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : mailman (RHSA-2006:0486)");
...
contains backported patches to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-0052"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0486"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"mailman-2.1.5.1-25.rhel3.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"mailman-2.1.5.1-34.rhel4.3")) flag++;
