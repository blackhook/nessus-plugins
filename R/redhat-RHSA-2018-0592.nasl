...
Red Hat would like to thank Chris McCown for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:0592"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"slf4j-1.7.4-4.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"slf4j-javadoc-1.7.4-4.el7_4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"slf4j-manual-1.7.4-4.el7_4")) flag++;
