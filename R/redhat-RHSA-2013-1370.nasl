...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : jboss-remoting in JBoss EWP (RHSA-2013:1370)");
...
JBoss server process must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1370"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-4210"
  );
  script_set_attribute(
    attribute:"solution", 
