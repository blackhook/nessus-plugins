...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1537125");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1552628");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1552631");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1553398");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1575536");
...
"Update the affected curl, libcurl and / or libcurl-devel packages.");
  ...
  script_cwe_id(122, 125, 200, 201, 476, 787);
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'libcurl-7.29.0-46.el7_5.1', 'sp':'5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libcurl-devel-7.29.0-46.el7_5.1', 'sp':'5', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
