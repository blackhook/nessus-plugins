...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 8 : Red Hat JBoss Enterprise Application Platform 7.3 (RHSA-2021:3217)");
...
in the RHSA-2021:3217 advisory.
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'eap7-undertow-2.0.38-2.SP2_redhat_00001.1.el8eap', 'release':'8', 'el_string':'el8eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7-jboss'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'eap7-undertow-2.0.38-2.SP2_redhat_00001.1.el6eap', 'release':'6', 'el_string':'el6eap', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap7-jboss'}
    ]
  }
];
