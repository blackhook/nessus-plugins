...
and add the enhancements noted in the Technical Notes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-4341"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:0560"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"sssd-1.5.1-34.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"sssd-1.5.1-34.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"sssd-1.5.1-34.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"sssd-client-1.5.1-34.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"sssd-debuginfo-1.5.1-34.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"sssd-tools-1.5.1-34.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"sssd-tools-1.5.1-34.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"sssd-tools-1.5.1-34.el6")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "sssd / sssd-client / sssd-debuginfo / sssd-tools");
  }
}
