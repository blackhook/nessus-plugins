...
# extracted from Red Hat Security Advisory RHSA-2013:0214. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : nss and nspr (RHSA-2013:0214)");
...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:0214"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"nspr-4.9.2-2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nspr-debuginfo-4.9.2-2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nspr-devel-4.9.2-2.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-3.13.6-3.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-debuginfo-3.13.6-3.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-devel-3.13.6-3.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", reference:"nss-pkcs11-devel-3.13.6-3.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"nss-tools-3.13.6-3.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"nss-tools-3.13.6-3.el5_9")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"nss-tools-3.13.6-3.el5_9")) flag++;
