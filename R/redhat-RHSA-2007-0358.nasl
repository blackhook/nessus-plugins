...
# extracted from Red Hat Security Advisory RHSA-2007:0358. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : squirrelmail (RHSA-2007:0358)");
...
contains a backported patch to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-1262"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-2589"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.squirrelmail.org/security/issue/2007-05-09"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0358"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"squirrelmail-1.4.8-6.el3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"squirrelmail-1.4.8-4.0.1.el4")) flag++;


  if (rpm_check(release:"RHEL5", reference:"squirrelmail-1.4.8-4.0.1.el5")) flag++;
