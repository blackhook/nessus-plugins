...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-31.5.3-1.el5_11", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-31.5.3-1.el5_11", allowmaj:TRUE)) flag++;


  if (rpm_check(release:"RHEL6", sp:"6", cpu:"s390", reference:"firefox-31.5.3-1.el5_11", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", sp:"6", cpu:"s390x", reference:"firefox-31.5.3-1.el5_11", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", sp:"6", cpu:"s390", reference:"firefox-debuginfo-31.5.3-1.el5_11", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", sp:"6", cpu:"s390x", reference:"firefox-debuginfo-31.5.3-1.el5_11", allowmaj:TRUE)) flag++;


  if (rpm_check(release:"RHEL7", reference:"firefox-31.5.3-3.el7_1", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL7", reference:"firefox-debuginfo-31.5.3-3.el7_1", allowmaj:TRUE)) flag++;
