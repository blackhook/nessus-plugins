...
# extracted from Red Hat Security Advisory RHSA-2004:498. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:498");

  script_name(english:"RHEL 2.1 : samba (RHSA-2004:498)");
...
an upgrade to Samba-2.2.12, which is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0815"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:498"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-2.2.12-1.21as")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-client-2.2.12-1.21as")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-common-2.2.12-1.21as")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"samba-swat-2.2.12-1.21as")) flag++;
