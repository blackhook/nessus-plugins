...
# extracted from Red Hat Security Advisory RHSA-2011:0001. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2011:0001");

  script_xref(name:"IAVA", value:"0001-A-0631");

  script_name(english:"RHEL 3 / 4 : redhat-release (EOL Notice) (RHSA-2011:0001)");
...
and Proxy 4.x prior to April 30th, 2011."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2011-0001.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected rhn-satellite-config package."
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rhn-satellite-config");
...
flag = 0;
if (rpm_check(release:"RHEL3", reference:"rhn-satellite-config-4.2.3-2")) flag++;

if (rpm_check(release:"RHEL4", reference:"rhn-satellite-config-4.2.3-3")) flag++;
