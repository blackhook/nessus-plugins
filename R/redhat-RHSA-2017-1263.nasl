...
# extracted from Red Hat Security Advisory RHSA-2017:1263. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : libtirpc (RHSA-2017:1263)");
...
terminated by the OOM killer. (CVE-2017-8779)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:1263"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"libtirpc-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libtirpc-debuginfo-0.2.4-0.8.el7_3")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libtirpc-devel-0.2.4-0.8.el7_3")) flag++;
