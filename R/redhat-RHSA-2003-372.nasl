...
# extracted from Red Hat Security Advisory RHSA-2003:372. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2003:372");

  script_name(english:"RHEL 2.1 : wget (RHSA-2003:372)");
...
backported security patch and is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1565"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:372"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"wget-1.8.2-14.72")) flag++;
