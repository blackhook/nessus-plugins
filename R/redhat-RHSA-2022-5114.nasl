...
referenced in the RHSA-2022:5114 advisory.
  ...
  - openstack-barbican: Barbican allows authenticated users to add/modify/delete arbitrary metadata on any
    secret (CVE-2022-23451)

  - openstack-barbican: Barbican allows anyone with an admin role to add their secrets to a different
    project's containers (CVE-2022-23452)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-23451");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-23452");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:5114");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2025089");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2025090");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-barbican-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-barbican-api-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-barbican-common-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-barbican-keystone-listener-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'openstack-barbican-worker-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'},
      {'reference':'python3-barbican-9.0.2-2.20220122185348.c718783.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openstack-'}
    ]
  }
];
