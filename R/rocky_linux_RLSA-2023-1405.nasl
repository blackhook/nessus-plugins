...
# Rocky Linux Security Advisory RLSA-2023:1405.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:1405");
  script_xref(name:"IAVA", value:"2022-A-0518-S");

  script_name(english:"Rocky Linux 8 : openssl (RLSA-2023:1405)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Rocky Linux host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Rocky Linux 8 host has packages installed that are affected by multiple vulnerabilities as referenced in the
RLSA-2023:1405 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:1405");
...
var pkgs = [
    ...
    {'reference':'openssl-debuginfo-1.1.1k-9.el8_7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-debuginfo-1.1.1k-9.el8_7', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-debuginfo-1.1.1k-9.el8_7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-debugsource-1.1.1k-9.el8_7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-debugsource-1.1.1k-9.el8_7', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-debugsource-1.1.1k-9.el8_7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    ...
    {'reference':'openssl-libs-debuginfo-1.1.1k-9.el8_7', 'cpu':'aarch64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-libs-debuginfo-1.1.1k-9.el8_7', 'cpu':'i686', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
    {'reference':'openssl-libs-debuginfo-1.1.1k-9.el8_7', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
