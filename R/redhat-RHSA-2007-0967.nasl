...
# extracted from Red Hat Security Advisory RHSA-2007:0967. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : pcre (RHSA-2007:0967)");
...
disclosing these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0967"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"pcre-6.6-2.el5_0.1")) flag++;
  if (rpm_check(release:"RHEL5", reference:"pcre-devel-6.6-2.el5_0.1")) flag++;
