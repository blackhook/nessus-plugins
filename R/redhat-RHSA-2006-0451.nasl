...
This issue does not affect Red Hat Enterprise Linux 2.1 or 3."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-1526"
  );
  # http://lists.freedesktop.org/archives/xorg/2006-May/015136.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.freedesktop.org/archives/xorg/2006-May/015136.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0451"
  );
