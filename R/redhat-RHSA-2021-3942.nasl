...
"Update the affected openvswitch2.11, openvswitch2.11-devel and / or python-openvswitch2.11 packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'},
      {'reference':'openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'},
      {'reference':'openvswitch2.11-devel-2.11.3-89.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'},
      {'reference':'openvswitch2.11-devel-2.11.3-89.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'},
      {'reference':'python-openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'ppc64le', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'},
      {'reference':'python-openvswitch2.11-2.11.3-89.el7fdp', 'cpu':'x86_64', 'release':'7', 'el_string':'el7fdp', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
