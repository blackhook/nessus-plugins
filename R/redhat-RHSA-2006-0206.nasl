...
# extracted from Red Hat Security Advisory RHSA-2006:0206. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : kdegraphics (RHSA-2006:0206)");
...
a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-0301"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0206"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"kdegraphics-3.3.1-3.7")) flag++;
  if (rpm_check(release:"RHEL4", reference:"kdegraphics-devel-3.3.1-3.7")) flag++;
