...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-2002");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-2124");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-2194");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-2235");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-28466");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'kernel-abi-stablelists-5.14.0-284.18.1.el9_2', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
  ...
  },
  {
    ...
    'pkgs': [
      ...
      {'reference':'kernel-abi-stablelists-5.14.0-284.18.1.el9_2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
