...
# extracted from Red Hat Security Advisory RHSA-2020:2342. The text
...
if (description)
{
  ...
  script_cve_id("CVE-2019-14378", "CVE-2020-7039", "CVE-2020-8608");
  script_xref(name:"RHSA", value:"2020:2342");

  script_name(english:"RHEL 7 : qemu-kvm-rhev bug fix update (Important) (RHSA-2020:2342)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 host has packages installed that are affected by multiple vulnerabilities as
referenced in the RHSA-2020:2342 advisory.
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2342");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'qemu-img-rhev-2.12.0-18.el7_6.11', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'rhevm-4'},
      {'reference':'qemu-kvm-common-rhev-2.12.0-18.el7_6.11', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'rhevm-4'},
      {'reference':'qemu-kvm-rhev-2.12.0-18.el7_6.11', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'rhevm-4'},
      {'reference':'qemu-kvm-tools-rhev-2.12.0-18.el7_6.11', 'cpu':'x86_64', 'release':'7', 'el_string':'el7_6', 'rpm_spec_vers_cmp':TRUE, 'epoch':'10', 'exists_check':'rhevm-4'}
    ]
  }
];
