...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-0181");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-0182");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-0198");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1789031");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1834950");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1840347");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1840350");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1847131");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1847133");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1852487");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1852490");
...
"Update the affected libexif and / or libexif-devel packages.");
  ...
  script_cwe_id(125, 190, 369, 400, 416, 456, 787, 805, 822);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libexif-0.6.22-4.el8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libexif-devel-0.6.22-4.el8', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'libexif-0.6.22-4.el8', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'libexif-devel-0.6.22-4.el8', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
