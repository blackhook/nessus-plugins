...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Virtualization Host security and enhancement update [ovirt-4.4.10] Async #2 (Important) (RHSA-2022:1053)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.4.10-202203211649_8.5', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
