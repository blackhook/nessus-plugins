...
Linux 6.4 Advanced Update Support, Red Hat Enterprise Linux 6.5
Advanced Update Support, Red Hat Enterprise Linux 6.6 Advanced Update
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1125"
  );
  script_set_attribute(
    attribute:"see_also",
...
{  sp = get_kb_item("Host/RedHat/minor_release");
  ...
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"6", reference:"python-paramiko-1.7.5-4.el6_6")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", reference:"python-paramiko-1.7.5-4.el6_4")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", reference:"python-paramiko-1.7.5-4.el6_7")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", reference:"python-paramiko-1.7.5-4.el6_5")) flag++;
