...
which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1804"
  );
  script_set_attribute(
    attribute:"see_also",
...
packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libjpeg-debuginfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"libjpeg-6b-38")) flag++;
  if (rpm_check(release:"RHEL5", reference:"libjpeg-debuginfo-6b-38")) flag++;
  if (rpm_check(release:"RHEL5", reference:"libjpeg-devel-6b-38")) flag++;
