...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-14526");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"wpa_supplicant-2.6-12.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"wpa_supplicant-2.6-12.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"wpa_supplicant-debuginfo-2.6-12.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"wpa_supplicant-debuginfo-2.6-12.el7")) flag++;
