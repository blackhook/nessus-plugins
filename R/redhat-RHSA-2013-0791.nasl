...
# extracted from Red Hat Security Advisory RHSA-2013:0791. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:0791");

  script_name(english:"RHEL 6 : qemu-kvm-rhev (RHSA-2013:0791)");
...
update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:0791"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-img-rhev-0.12.1.2-2.355.el6_4.5")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-kvm-rhev-0.12.1.2-2.355.el6_4.5")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-kvm-rhev-debuginfo-0.12.1.2-2.355.el6_4.5")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"qemu-kvm-rhev-tools-0.12.1.2-2.355.el6_4.5")) flag++;
