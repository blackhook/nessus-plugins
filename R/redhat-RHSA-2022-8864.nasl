...
referenced in the RHSA-2022:8864 advisory.
  ...
  - python-ujson: improper decoding of escaped surrogate characters may lead to string corruption, key
    confusion or value overwriting (CVE-2022-31116)

  - python-ujson: Potential double free of buffer during string decoding (CVE-2022-31117)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-31116");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-31117");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8864");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2104739");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2104740");
