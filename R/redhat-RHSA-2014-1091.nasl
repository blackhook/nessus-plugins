...
which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:1091"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"mod_wsgi-3.4-12.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"mod_wsgi-3.4-12.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"mod_wsgi-debuginfo-3.4-12.el7_0")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"mod_wsgi-debuginfo-3.4-12.el7_0")) flag++;
