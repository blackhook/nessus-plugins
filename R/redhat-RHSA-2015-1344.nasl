...
# extracted from Red Hat Security Advisory RHSA-2015:1344. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : autofs (RHSA-2015:1344)");
...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1344"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"autofs-5.0.5-113.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"autofs-5.0.5-113.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"autofs-5.0.5-113.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"autofs-debuginfo-5.0.5-113.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"autofs-debuginfo-5.0.5-113.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"autofs-debuginfo-5.0.5-113.el6")) flag++;
