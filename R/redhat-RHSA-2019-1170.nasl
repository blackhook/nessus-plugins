...
* efi_bgrt_init fails to ioremap error during boot (BZ#1692284)");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2016-7913");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2016-8633");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-11600");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-12190");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-13215");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-16939");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-17558");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-1000407");
