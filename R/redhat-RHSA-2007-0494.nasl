...
provided by Dirk Muller that protects against this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-2022"
  );
  # http://www.adobe.com/support/security/advisories/apsa07-03.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.adobe.com/support/security/advisories/apsa07-03.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0494"
  );
  script_set_attribute(
    attribute:"solution", 
