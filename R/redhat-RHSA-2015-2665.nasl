...
# extracted from Red Hat Security Advisory RHSA-2015:2665. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:2665");

  script_name(english:"RHEL 6 : chromium-browser (RHSA-2015:2665)");
...
changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:2665"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-6792"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"chromium-browser-47.0.2526.106-1.el6", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"chromium-browser-47.0.2526.106-1.el6", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"chromium-browser-debuginfo-47.0.2526.106-1.el6", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"chromium-browser-debuginfo-47.0.2526.106-1.el6", allowmaj:TRUE)) flag++;
