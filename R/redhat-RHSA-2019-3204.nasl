...
"An update for sudo is now available for Red Hat Enterprise Linux 7.5
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"s390x", reference:"sudo-1.8.19p2-14.el7_5.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", cpu:"x86_64", reference:"sudo-1.8.19p2-14.el7_5.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", reference:"sudo-debuginfo-1.8.19p2-14.el7_5.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"5", reference:"sudo-devel-1.8.19p2-14.el7_5.1")) flag++;
