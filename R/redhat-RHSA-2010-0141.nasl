...
contains backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0141"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"tar-1.14-13.el4_8.1")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"tar-1.15.1-23.0.1.el5_4.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"tar-1.15.1-23.0.1.el5_4.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"tar-1.15.1-23.0.1.el5_4.2")) flag++;
