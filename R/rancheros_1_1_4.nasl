...
if (description)
{
  ...
  script_name(english:"RancherOS < 1.1.4 Information Disclosure");

  script_set_attribute(attribute:"synopsis", value:
"The remote device is missing a vendor-supplied security patch");
  script_set_attribute(attribute:"description", value:
"The remote host is running a version of Rancheros prior to v1.1.4, hence is
vulnerable to unauthorized disclosure of information vulnerability.
...
local user access via a side-channel analysis.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://github.com/rancher/os/releases/tag/v1.1.4");
  script_set_attribute(attribute:"solution", value:
"Upgrade to RancherOS v1.1.4 or later");
