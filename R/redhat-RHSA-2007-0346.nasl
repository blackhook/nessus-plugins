...
# extracted from Red Hat Security Advisory RHSA-2007:0346. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : vim (RHSA-2007:0346)");
...
Enterprise Linux 2.1, 3, or 4."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-2438"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0346"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"vim-X11-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"vim-X11-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"vim-X11-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"vim-common-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"vim-common-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"vim-common-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"vim-enhanced-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"vim-enhanced-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"vim-enhanced-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"vim-minimal-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"vim-minimal-7.0.109-3.el5.3")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"vim-minimal-7.0.109-3.el5.3")) flag++;
