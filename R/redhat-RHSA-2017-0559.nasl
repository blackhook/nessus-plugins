...
# extracted from Red Hat Security Advisory RHSA-2017:0559. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : openjpeg (RHSA-2017:0559)");
...
Product Security)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0559"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"openjpeg-1.3-16.el6_8")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"openjpeg-1.3-16.el6_8")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"openjpeg-1.3-16.el6_8")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openjpeg-debuginfo-1.3-16.el6_8")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openjpeg-devel-1.3-16.el6_8")) flag++;
  if (rpm_check(release:"RHEL6", reference:"openjpeg-libs-1.3-16.el6_8")) flag++;
