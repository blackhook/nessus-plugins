...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-1328");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8219");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2076058");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'mutt-2.2.6-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'5'}
    ]
  },
  {
    'repo_relative_urls': [
