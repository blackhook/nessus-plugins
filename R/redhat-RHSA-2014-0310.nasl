...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0310"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-24.4.0-1.el5_10", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-24.4.0-1.el5_10", allowmaj:TRUE)) flag++;


  if (rpm_check(release:"RHEL6", reference:"firefox-24.4.0-1.el6_5", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-24.4.0-1.el6_5", allowmaj:TRUE)) flag++;
