...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:3071"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ntp-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"ntp-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ntp-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ntp-debuginfo-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"ntp-debuginfo-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ntp-debuginfo-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"ntp-doc-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ntp-perl-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"ntp-perl-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ntp-perl-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ntpdate-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"ntpdate-4.2.6p5-12.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ntpdate-4.2.6p5-12.el6_9.1")) flag++;
