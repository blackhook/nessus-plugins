...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2094"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2018-1000156"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected patch and / or patch-debuginfo packages."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"patch-2.6-8.el6_7")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"patch-2.6-8.el6_7")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"patch-2.6-8.el6_7")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"patch-debuginfo-2.6-8.el6_7")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"patch-debuginfo-2.6-8.el6_7")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"patch-debuginfo-2.6-8.el6_7")) flag++;
