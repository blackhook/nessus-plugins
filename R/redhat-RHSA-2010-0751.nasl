...
# extracted from Red Hat Security Advisory RHSA-2010:0751. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : xpdf (RHSA-2010:0751)");
...
backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0751"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"xpdf-3.00-24.el4_8.1")) flag++;
