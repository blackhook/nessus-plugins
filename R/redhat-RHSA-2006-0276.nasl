...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : php (RHSA-2006:0276)");
...
backported patches that resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3883"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-1490"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0276"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"php-4.3.2-30.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"php-devel-4.3.2-30.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"php-imap-4.3.2-30.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"php-ldap-4.3.2-30.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"php-mysql-4.3.2-30.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"php-odbc-4.3.2-30.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"php-pgsql-4.3.2-30.ent")) flag++;

  if (rpm_check(release:"RHEL4", reference:"php-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-devel-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-domxml-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-gd-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-imap-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-ldap-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-mbstring-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-mysql-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-ncurses-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-odbc-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-pear-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-pgsql-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-snmp-4.3.9-3.12")) flag++;
  if (rpm_check(release:"RHEL4", reference:"php-xmlrpc-4.3.9-3.12")) flag++;
