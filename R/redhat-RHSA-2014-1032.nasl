...
# extracted from Red Hat Security Advisory RHSA-2014:1032. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:1032");

  script_name(english:"RHEL 5 : redhat-ds-base (RHSA-2014:1032)");
...
Red Hat Directory Server, which is the default configuration, the
server returned replicated metadata when the directory was searched
while debugging was enabled. A remote attacker could use this flaw to
...
restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:1032"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"redhat-ds-base-8.2.11-15.el5dsrv")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"redhat-ds-base-devel-8.2.11-15.el5dsrv")) flag++;
