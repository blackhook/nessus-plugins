...
# extracted from Red Hat Security Advisory RHSA-2005:848. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : libc-client (RHSA-2005:848)");
...
which contain a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:848"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libc-client and / or libc-client-devel packages."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"libc-client-2002e-14")) flag++;
  if (rpm_check(release:"RHEL4", reference:"libc-client-devel-2002e-14")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libc-client / libc-client-devel");
  }
}
