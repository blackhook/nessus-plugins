...
"Update the affected devtoolset-11-binutils and / or devtoolset-11-binutils-devel packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'devtoolset-11-binutils-devel-2.36.1-1.el7.1', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
