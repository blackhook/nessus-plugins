...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet60-aspnetcore-runtime-6.0-6.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-aspnetcore-targeting-pack-6.0-6.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-6.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-apphost-pack-6.0-6.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-host-6.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-hostfxr-6.0-6.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-runtime-6.0-6.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-sdk-6.0-6.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-sdk-6.0-source-built-artifacts-6.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-targeting-pack-6.0-6.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-dotnet-templates-6.0-6.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'rh-dotnet60-netstandard-targeting-pack-2.1-6.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
