...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"sudo-1.8.6p3-29.el6_10.2")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"sudo-1.8.6p3-29.el6_10.2")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"sudo-1.8.6p3-29.el6_10.2")) flag++;
  if (rpm_check(release:"RHEL6", reference:"sudo-debuginfo-1.8.6p3-29.el6_10.2")) flag++;
  if (rpm_check(release:"RHEL6", reference:"sudo-devel-1.8.6p3-29.el6_10.2")) flag++;
