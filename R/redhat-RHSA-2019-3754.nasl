...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"sudo-1.8.6p3-15.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"i686", reference:"sudo-debuginfo-1.8.6p3-15.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"sudo-debuginfo-1.8.6p3-15.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"i686", reference:"sudo-devel-1.8.6p3-15.el6_6.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"sudo-devel-1.8.6p3-15.el6_6.2")) flag++;
