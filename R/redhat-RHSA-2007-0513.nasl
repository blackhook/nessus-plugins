...
# extracted from Red Hat Security Advisory RHSA-2007:0513. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 / 5 : gimp (RHSA-2007:0513)");
...
contain a backported fix to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-4519"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-2949"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-3741"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0513"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"gimp-1.2.1-7.8.el2_1")) flag++;

  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"gimp-devel-1.2.1-7.8.el2_1")) flag++;

  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"gimp-perl-1.2.1-7.8.el2_1")) flag++;


  if (rpm_check(release:"RHEL3", reference:"gimp-1.2.3-20.9.el3")) flag++;

  if (rpm_check(release:"RHEL3", reference:"gimp-devel-1.2.3-20.9.el3")) flag++;

  if (rpm_check(release:"RHEL3", reference:"gimp-perl-1.2.3-20.9.el3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"gimp-2.0.5-7.0.7.el4")) flag++;

  if (rpm_check(release:"RHEL4", reference:"gimp-devel-2.0.5-7.0.7.el4")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"gimp-2.2.13-2.0.7.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"gimp-2.2.13-2.0.7.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"gimp-2.2.13-2.0.7.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"gimp-devel-2.2.13-2.0.7.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"gimp-libs-2.2.13-2.0.7.el5")) flag++;
