...
https://github.com/ansible/ansible/blob/v2.8.6/changelogs/CHANGELOG-v2
.8.rst

for details on bug fixes in this release.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/ansible/ansible/blob/v2.8.6/changelogs/");
...
else
{
  ...
  if (rpm_check(release:"RHEL7", reference:"ansible-2.8.6-1.el7")) flag++;

  if (rpm_check(release:"RHEL8", reference:"ansible-2.8.6-1.el8")) flag++;
