...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 9 : Red Hat JBoss Web Server 5.7.1 release and (RHSA-2022:8917)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 7 / 9 host has a package installed that is affected by multiple vulnerabilities as
referenced in the RHSA-2022:8917 advisory.
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-native-1.2.31-11.redhat_11.el9jws', 'cpu':'x86_64', 'release':'9', 'el_string':'el9jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-native-1.2.31-11.redhat_11.el7jws', 'cpu':'x86_64', 'release':'7', 'el_string':'el7jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'}
    ]
  }
];
