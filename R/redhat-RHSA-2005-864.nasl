...
# extracted from Red Hat Security Advisory RHSA-2005:864. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : udev (RHSA-2005:864)");
...
contain a backported patch and are not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3631"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:864"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"udev-039-10.10.EL4.3")) flag++;
