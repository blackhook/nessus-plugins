...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1510"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-3213"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"clutter-1.14.4-12.el7_1.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"clutter-debuginfo-1.14.4-12.el7_1.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"clutter-devel-1.14.4-12.el7_1.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"clutter-doc-1.14.4-12.el7_1.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"clutter-doc-1.14.4-12.el7_1.1")) flag++;
