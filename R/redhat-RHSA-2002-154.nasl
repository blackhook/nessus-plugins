...
# extracted from Red Hat Security Advisory RHSA-2002:154. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2002:154");

  script_name(english:"RHEL 2.1 : mm (RHSA-2002:154)");
...
Thanks to Marcus Meissner for providing a patch for this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-0658"
  );
  # http://www.engelschall.com/sw/mm/
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.ossp.org/pkg/lib/mm/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2002:154"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected mm and / or mm-devel packages."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mm-devel");
  script_set_attribute(attribute:"cpe", value:"cpe:/o:redhat:enterprise_linux:2.1");

  script_set_attribute(attribute:"vuln_publication_date", value:"2002/08/12");
  script_set_attribute(attribute:"patch_publication_date", value:"2002/07/26");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"mm-1.1.3-8")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"mm-devel-1.1.3-8")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mm / mm-devel");
  }
}
