...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 / 6 : bash (RHSA-2014:1294) (Shellshock)");
...
contain a backported patch to correct this issue.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2014:1294");
...
{  sp = get_kb_item("Host/RedHat/minor_release");
  ...
  flag = 0;
  if (rpm_check(release:"RHEL4", cpu:"i386", reference:"bash-3.0-27.el4.2")) flag++;

  if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"bash-3.0-27.el4.2")) flag++;
...
if (sp == "2") {   if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"bash-4.1.2-9.el6_2.1")) flag++; }
  else { if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"bash-4.1.2-15.el6_4.1")) flag++; }
...
if (sp == "2") {   if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"bash-debuginfo-4.1.2-9.el6_2.1")) flag++; }
  else { if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"bash-debuginfo-4.1.2-15.el6_4.1")) flag++; }
