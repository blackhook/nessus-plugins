...
"Update the affected devtoolset-10-binutils and / or devtoolset-10-binutils-devel packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'devtoolset-10-binutils-devel-2.35-5.el7.3', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
