...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"An updated rubygems package that fixes one security issue is now
available for Red Hat OpenShift Enterprise 2.0.2.
...
All users of Red Hat OpenShift Enterprise 2.0.2 are advised to upgrade
to this updated package, which contains a backported patch to correct
this issue."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0207"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected rubygems and / or rubygems-devel packages."
  );
...
else
{
  ...
  if (rpm_exists(rpm:"rubygems-1.8", release:"RHEL6") && rpm_check(release:"RHEL6", reference:"rubygems-1.8.24-5.el6")) flag++;
  if (rpm_exists(rpm:"rubygems-devel-1.8", release:"RHEL6") && rpm_check(release:"RHEL6", reference:"rubygems-devel-1.8.24-5.el6")) flag++;
