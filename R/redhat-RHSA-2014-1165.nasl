...
# extracted from Red Hat Security Advisory RHSA-2014:1165. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:1165");

  script_name(english:"RHEL 4 : nss (RHSA-2014:1165)");
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:1165"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected nss, nss-devel and / or nss-tools packages."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", cpu:"i386", reference:"nss-3.12.10-7.el4")) flag++;
  if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"nss-3.12.10-7.el4")) flag++;
  if (rpm_check(release:"RHEL4", cpu:"i386", reference:"nss-devel-3.12.10-7.el4")) flag++;
  if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"nss-devel-3.12.10-7.el4")) flag++;
  if (rpm_check(release:"RHEL4", cpu:"i386", reference:"nss-tools-3.12.10-7.el4")) flag++;
  if (rpm_check(release:"RHEL4", cpu:"x86_64", reference:"nss-tools-3.12.10-7.el4")) flag++;
