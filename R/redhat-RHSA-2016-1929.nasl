...
host. (BZ#1367519)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:1929"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-4443"
  );
...
else
{
  ...
  if (rpm_exists(rpm:"rhevm-userportal-debuginfo-3.6.", release:"RHEL6") && rpm_check(release:"RHEL6", reference:"rhevm-userportal-debuginfo-3.6.9.2-0.1.el6")) flag++;
  ...
  if (rpm_exists(rpm:"rhevm-webadmin-portal-debuginfo-3.6.", release:"RHEL6") && rpm_check(release:"RHEL6", reference:"rhevm-webadmin-portal-debuginfo-3.6.9.2-0.1.el6")) flag++;
