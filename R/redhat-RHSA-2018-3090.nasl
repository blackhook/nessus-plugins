...
# extracted from Red Hat Security Advisory RHSA-2018:3090. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : ovmf (RHSA-2018:3090)");
...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3090");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"OVMF-20180508-3.gitee3198e672e2.el7")) flag++;
