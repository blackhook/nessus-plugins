...
reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1455"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"s390x", reference:"dhclient-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"dhclient-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"s390x", reference:"dhcp-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"dhcp-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"s390x", reference:"dhcp-common-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"dhcp-common-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", reference:"dhcp-debuginfo-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", reference:"dhcp-devel-4.2.5-58.el7_4.4")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", reference:"dhcp-libs-4.2.5-58.el7_4.4")) flag++;
