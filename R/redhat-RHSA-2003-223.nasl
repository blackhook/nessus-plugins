...
reestablished."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1563"
  );
  # http://marc.theaimsgroup.com/?l=stunnel-users&m=103600188215117
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=stunnel-users&m=103600188215117"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:223"
  );
  script_set_attribute(
    attribute:"solution", 
