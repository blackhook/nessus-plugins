...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"sudo-1.8.23-3.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"6", cpu:"x86_64", reference:"sudo-1.8.23-3.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"6", reference:"sudo-debuginfo-1.8.23-3.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390", reference:"sudo-debuginfo-1.8.23-3.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"sudo-debuginfo-1.8.23-3.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", sp:"6", reference:"sudo-devel-1.8.23-3.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390", reference:"sudo-devel-1.8.23-3.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"sudo-devel-1.8.23-3.el7_6.1")) flag++;
