...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : xloadimage (RHSA-2005:332)");
...
contains backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-0638"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:332"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"xloadimage-4.1-34.RHEL2.1")) flag++;

  if (rpm_check(release:"RHEL3", reference:"xloadimage-4.1-34.RHEL3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"xloadimage-4.1-34.RHEL4")) flag++;
