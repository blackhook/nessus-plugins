...
# extracted from Red Hat Security Advisory RHSA-2012:0683. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : bind-dyndb-ldap (RHSA-2012:0683)");
...
update to take effect, the named service must be restarted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:0683"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-2134"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"bind-dyndb-ldap-0.2.0-7.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"bind-dyndb-ldap-0.2.0-7.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"bind-dyndb-ldap-0.2.0-7.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"bind-dyndb-ldap-debuginfo-0.2.0-7.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"bind-dyndb-ldap-debuginfo-0.2.0-7.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"bind-dyndb-ldap-debuginfo-0.2.0-7.el6_2.1")) flag++;
