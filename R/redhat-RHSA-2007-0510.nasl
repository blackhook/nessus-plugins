...
# extracted from Red Hat Security Advisory RHSA-2007:0510. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : evolution-data-server (RHSA-2007:0510)");
...
packages, which contain a backported patch which resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0510"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"evolution-data-server-1.8.0-15.0.4.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"evolution-data-server-devel-1.8.0-15.0.4.el5")) flag++;
