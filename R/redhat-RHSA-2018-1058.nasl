...
Initiative as the original reporter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1058"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"libvorbis-1.3.3-8.el7.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libvorbis-debuginfo-1.3.3-8.el7.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libvorbis-devel-1.3.3-8.el7.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libvorbis-devel-docs-1.3.3-8.el7.1")) flag++;
