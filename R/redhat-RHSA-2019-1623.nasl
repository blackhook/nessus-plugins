...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"thunderbird-60.7.2-2.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"thunderbird-debuginfo-60.7.2-2.el8_0", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"thunderbird-debugsource-60.7.2-2.el8_0", allowmaj:TRUE)) flag++;
