...
# extracted from Red Hat Security Advisory RHSA-2007:0860. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : tar (RHSA-2007:0860)");
...
replacement backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-4131"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0860"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"tar-1.14-12.5.1.RHEL4")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"tar-1.15.1-23.0.1.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"tar-1.15.1-23.0.1.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"tar-1.15.1-23.0.1.el5")) flag++;
