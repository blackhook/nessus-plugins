...
corrects these issues and add these enhancements."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:2290"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-3225"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pcs-0.9.143-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"pcs-0.9.143-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"pcs-debuginfo-0.9.143-15.el7")) flag++;
