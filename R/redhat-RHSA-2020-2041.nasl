  ...
  'squid:4': [
    ...
    },
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.4-8.module+el8.2.0+6449+6ba3df3e.1', 'sp':'4', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.4-8.module+el8.2.0+6449+6ba3df3e.1', 'sp':'6', 'release':'8', 'el_string':'el8.2.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    },
    {
      'repo_relative_urls': [
