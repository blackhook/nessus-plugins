...
# extracted from Red Hat Security Advisory RHSA-2007:0384. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 : krb5 (RHSA-2007:0384)");
...
which contain backported fixes to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-2442"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-2443"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-2798"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0384"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"krb5-devel-1.2.2-47")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"krb5-libs-1.2.2-47")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"krb5-server-1.2.2-47")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"krb5-workstation-1.2.2-47")) flag++;

  if (rpm_check(release:"RHEL3", reference:"krb5-devel-1.2.7-66")) flag++;
  if (rpm_check(release:"RHEL3", reference:"krb5-libs-1.2.7-66")) flag++;
  if (rpm_check(release:"RHEL3", reference:"krb5-server-1.2.7-66")) flag++;
  if (rpm_check(release:"RHEL3", reference:"krb5-workstation-1.2.7-66")) flag++;
