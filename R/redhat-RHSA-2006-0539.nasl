...
# extracted from Red Hat Security Advisory RHSA-2006:0539. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : vixie-cron (RHSA-2006:0539)");
...
which contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-2607"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0539"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"vixie-cron-4.1-44.EL4")) flag++;
