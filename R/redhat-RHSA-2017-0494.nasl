...
and code maintainability in the shadow copy module. (BZ#1385663)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0494"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL6", rpm:"glusterfs-server"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "Gluster Storage");
  ...
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"samba-debuginfo-4.4.6-4.el6")) flag++;
