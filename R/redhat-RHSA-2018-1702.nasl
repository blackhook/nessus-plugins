...
and Kevin Backhouse (lgtm.com / Semmle) as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1702"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"7", reference:"librelp-1.2.7-3.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", reference:"librelp-debuginfo-1.2.7-3.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", reference:"librelp-devel-1.2.7-3.el6_7.1")) flag++;
