...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : expat (RHSA-2009:1625)");
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-3560"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"expat-1.95.5-6.2")) flag++;

  if (rpm_check(release:"RHEL3", reference:"expat-devel-1.95.5-6.2")) flag++;


  if (rpm_check(release:"RHEL4", reference:"expat-1.95.7-4.el4_8.2")) flag++;

  if (rpm_check(release:"RHEL4", reference:"expat-devel-1.95.7-4.el4_8.2")) flag++;


  if (rpm_check(release:"RHEL5", reference:"expat-1.95.8-8.3.el5_4.2")) flag++;

  if (rpm_check(release:"RHEL5", reference:"expat-devel-1.95.8-8.3.el5_4.2")) flag++;
