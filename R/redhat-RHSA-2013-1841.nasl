...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1841"
  );
  script_set_attribute(
    attribute:"see_also",
...
{  sp = get_kb_item("Host/RedHat/minor_release");
  ...
  if (rpm_check(release:"RHEL5", sp:"6", cpu:"i386", reference:"nss-debuginfo-3.12.8-8.el5_6")) flag++;
  if (rpm_check(release:"RHEL5", sp:"6", cpu:"x86_64", reference:"nss-debuginfo-3.12.8-8.el5_6")) flag++;
