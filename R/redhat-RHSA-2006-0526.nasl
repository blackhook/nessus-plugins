...
containing PostgreSQL version 7.4.13, which corrects these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-0591"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-2313"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-2314"
  );
  # http://www.postgresql.org/docs/techdocs.52
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.postgresql.org/docs/techdocs.52/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0526"
  );
