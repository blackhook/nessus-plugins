...
"Update the affected packages.");
  ...
  script_cwe_id(200, 287, 367, 400, 416, 476, 670, 770);
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'servicemesh-2.1.2-4.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-2.1.2-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-cni-2.1.2-4.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-cni-2.1.2-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-pilot-agent-2.1.2-4.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-pilot-agent-2.1.2-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-pilot-discovery-2.1.2-4.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-pilot-discovery-2.1.2-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-proxy-2.1.2-4.el8', 'cpu':'s390x', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-proxy-2.1.2-4.el8', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'},
      {'reference':'servicemesh-proxy-wasm-2.1.2-4.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'servicemesh'}
    ]
  }
];
