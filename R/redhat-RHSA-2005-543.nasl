...
backported patch and are not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-1992"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:543"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"irb-1.8.1-7.EL4.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"ruby-1.8.1-7.EL4.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"ruby-devel-1.8.1-7.EL4.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"ruby-docs-1.8.1-7.EL4.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"ruby-libs-1.8.1-7.EL4.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"ruby-mode-1.8.1-7.EL4.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"ruby-tcltk-1.8.1-7.EL4.1")) flag++;
