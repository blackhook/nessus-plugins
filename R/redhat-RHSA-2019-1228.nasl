...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:1228"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"wget-1.14-18.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"wget-1.14-18.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"wget-debuginfo-1.14-18.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"wget-debuginfo-1.14-18.el7_6.1")) flag++;
