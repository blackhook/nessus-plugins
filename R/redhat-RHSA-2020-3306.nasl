...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 8 : Red Hat JBoss Web Server 5.3.2 (RHSA-2020:3306)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-admin-webapps-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-docs-webapp-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-el-3.0-api-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-javadoc-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-jsp-2.3-api-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-lib-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-selinux-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-servlet-4.0-api-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-webapps-9.0.30-5.redhat_6.1.el8jws', 'release':'8', 'el_string':'el8jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jws5-tomcat-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-admin-webapps-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-docs-webapp-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-el-3.0-api-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-javadoc-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-jsp-2.3-api-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-lib-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-selinux-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-servlet-4.0-api-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'},
      {'reference':'jws5-tomcat-webapps-9.0.30-5.redhat_6.1.el6jws', 'release':'6', 'el_string':'el6jws', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'jws-5'}
    ]
  }
];
