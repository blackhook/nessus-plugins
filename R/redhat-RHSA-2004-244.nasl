...
# extracted from Red Hat Security Advisory RHSA-2004:244. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:244");

  script_name(english:"RHEL 2.1 : tripwire (RHSA-2004:244)");
...
(cve.mitre.org) has assigned the name CVE-2004-0536 to this issue.

Users of Tripwire are advised to upgrade to this erratum package which
contains a backported security patch to correct this issue. The
erratum package also contains some minor bug fixes."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0536"
  );
  # http://marc.theaimsgroup.com/?l=bugtraq&m=108627481507249
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=bugtraq&m=108627481507249"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:244"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected tripwire package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:tripwire");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"tripwire-2.3.1-18")) flag++;
