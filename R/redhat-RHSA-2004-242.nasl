...
# extracted from Red Hat Security Advisory RHSA-2004:242. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:242");

  script_name(english:"RHEL 3 : squid (RHSA-2004:242)");
...
backported patch that is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0541"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:242"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"squid-2.5.STABLE3-6.3E")) flag++;
