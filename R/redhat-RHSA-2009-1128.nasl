...
# extracted from Red Hat Security Advisory RHSA-2009:1128. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : kdelibs (RHSA-2009:1128)");
...
(log out, then log back in) for this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-1698"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1128"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"kdelibs-3.1.3-6.13")) flag++;
  if (rpm_check(release:"RHEL3", reference:"kdelibs-devel-3.1.3-6.13")) flag++;
