...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:0523"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-3048"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"libpng-1.2.10-17.el5_8")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libpng-devel-1.2.10-17.el5_8")) flag++;


  if (rpm_check(release:"RHEL6", reference:"libpng-1.2.49-1.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libpng-debuginfo-1.2.49-1.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libpng-devel-1.2.49-1.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"libpng-static-1.2.49-1.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"libpng-static-1.2.49-1.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libpng-static-1.2.49-1.el6_2")) flag++;
