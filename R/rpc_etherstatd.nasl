...
if (description)
{
 ...
 script_set_attribute(attribute:"plugin_modification_date", value:"2020/09/22");
  ...
  script_xref(name:"IAVA", value:"0001-A-0589");

 script_name(english:"RPC etherstatd Service Detection");
...
"The etherstatd RPC service is running. If you do not use this service,
