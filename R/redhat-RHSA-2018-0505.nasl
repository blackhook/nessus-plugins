...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:0505"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"mailman-2.1.15-26.el7_4.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"mailman-2.1.15-26.el7_4.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"mailman-debuginfo-2.1.15-26.el7_4.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"mailman-debuginfo-2.1.15-26.el7_4.1")) flag++;
