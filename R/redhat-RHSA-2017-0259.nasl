...
privileges to root. (CVE-2016-9566)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0259"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-9565"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-9566"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected nagios, nagios-common and / or nagios-debuginfo
packages."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"nagios-3.5.1-9.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"nagios-common-3.5.1-9.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"nagios-debuginfo-3.5.1-9.el6")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "nagios / nagios-common / nagios-debuginfo");
  }
}
