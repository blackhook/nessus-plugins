...
Solutions section below."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-0653"
  );
  # http://marc.theaimsgroup.com/?l=apache-modssl&m=102491918531562
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=apache-modssl&m=102491918531562"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2002:136"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2002/07/11");
