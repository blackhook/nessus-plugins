...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Ceph Storage 5.3 Bug fix and (RHSA-2023:0980)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Redhat Enterprise Linux 8 host has packages installed that are affected by a vulnerability as referenced in
the RHSA-2023:0980 advisory.

  - Ceph: ceph-crash.service allows local ceph user to root exploit (CVE-2022-3650)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-3650");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:0980");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2136909");
...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'ceph-base-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-base-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-base-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'ceph-common-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-common-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-common-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'ceph-fuse-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-fuse-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-fuse-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'ceph-immutable-object-cache-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-immutable-object-cache-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-immutable-object-cache-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'ceph-mib-16.2.10-138.el9cp', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'ceph-resource-agents-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-resource-agents-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-resource-agents-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'ceph-selinux-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-selinux-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'ceph-selinux-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'cephadm-16.2.10-138.el9cp', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'cephfs-top-16.2.10-138.el9cp', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'libcephfs-devel-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libcephfs-devel-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libcephfs-devel-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'libcephfs2-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libcephfs2-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libcephfs2-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'librados-devel-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librados-devel-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librados-devel-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'librados2-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librados2-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librados2-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'libradospp-devel-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libradospp-devel-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libradospp-devel-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'libradosstriper1-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libradosstriper1-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'libradosstriper1-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'librbd-devel-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librbd-devel-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librbd-devel-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'librbd1-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librbd1-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librbd1-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'librgw-devel-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librgw-devel-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librgw-devel-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'librgw2-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librgw2-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'librgw2-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'python3-ceph-argparse-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-ceph-argparse-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-ceph-argparse-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'python3-ceph-common-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-ceph-common-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-ceph-common-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'python3-cephfs-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-cephfs-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-cephfs-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'python3-rados-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-rados-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-rados-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'python3-rbd-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-rbd-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-rbd-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'python3-rgw-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-rgw-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'python3-rgw-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      ...
      {'reference':'rbd-nbd-16.2.10-138.el9cp', 'cpu':'ppc64le', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'rbd-nbd-16.2.10-138.el9cp', 'cpu':'s390x', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'},
      {'reference':'rbd-nbd-16.2.10-138.el9cp', 'cpu':'x86_64', 'release':'8', 'el_string':'el9cp', 'rpm_spec_vers_cmp':TRUE, 'epoch':'2', 'exists_check':'ceph-mon-'}
    ]
  }
];
