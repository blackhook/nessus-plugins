...
# extracted from Red Hat Security Advisory RHSA-2009:1181. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : bind (RHSA-2009:1181)");
...
the update, the BIND daemon (named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1181"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"bind-9.2.4-25.el3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"bind-chroot-9.2.4-25.el3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"bind-devel-9.2.4-25.el3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"bind-libs-9.2.4-25.el3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"bind-utils-9.2.4-25.el3")) flag++;
