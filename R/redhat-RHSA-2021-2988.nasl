...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-36740");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2988");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1982409");
...
var appstreams = {
  'varnish:6': [
    ...
    },
    {
      ...
      'pkgs': [
        {'reference':'varnish-6.0.6-2.module+el8.4.0+11921+1a6539fc.1', 'sp':'6', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-devel-6.0.6-2.module+el8.4.0+11921+1a6539fc.1', 'sp':'6', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
        {'reference':'varnish-docs-6.0.6-2.module+el8.4.0+11921+1a6539fc.1', 'sp':'6', 'release':'8', 'el_string':'el8.4.0', 'rpm_spec_vers_cmp':TRUE},
