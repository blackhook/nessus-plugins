...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 7 : Red Hat JBoss Enterprise Application Platform 6.4 (RHSA-2020:3730)");
...
in the RHSA-2020:3730 advisory.
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'jbossweb-7.5.31-3.Final_redhat_3.1.ep6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6-jboss'}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'jbossweb-7.5.31-3.Final_redhat_3.1.ep6.el5', 'release':'5', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'eap6-jboss'}
    ]
  }
];
