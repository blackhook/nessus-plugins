...
# extracted from Red Hat Security Advisory RHSA-2009:1122. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : icu (RHSA-2009:1122)");
...
contain backported patches to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-0153"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1122"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"icu-3.6-5.11.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"icu-3.6-5.11.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"icu-3.6-5.11.4")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libicu-3.6-5.11.4")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libicu-devel-3.6-5.11.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"libicu-doc-3.6-5.11.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"libicu-doc-3.6-5.11.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"libicu-doc-3.6-5.11.4")) flag++;
