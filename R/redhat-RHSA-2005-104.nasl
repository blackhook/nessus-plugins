...
# extracted from Red Hat Security Advisory RHSA-2005:104. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:104");

  script_name(english:"RHEL 2.1 / 3 : mod_python (RHSA-2005:104)");
...
which contains a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-0088"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:104"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"mod_python-2.7.8-3.1")) flag++;

  if (rpm_check(release:"RHEL3", reference:"mod_python-3.0.3-5.ent")) flag++;
