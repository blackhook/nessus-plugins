...
# extracted from Red Hat Security Advisory RHSA-2007:0011. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : libgsf (RHSA-2007:0011)");
...
packages, which contain a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-4514"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0011"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libgsf and / or libgsf-devel packages."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:libgsf-devel");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"libgsf-1.6.0-7")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libgsf-devel-1.6.0-7")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libgsf-1.10.1-2")) flag++;
  if (rpm_check(release:"RHEL4", reference:"libgsf-devel-1.10.1-2")) flag++;
