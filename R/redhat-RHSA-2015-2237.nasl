...
# extracted from Red Hat Security Advisory RHSA-2015:2237. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : rest (RHSA-2015:2237)");
...
restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:2237"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2015-2675"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:rest-debuginfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"rest-0.7.92-3.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"rest-debuginfo-0.7.92-3.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"rest-devel-0.7.92-3.el7")) flag++;
