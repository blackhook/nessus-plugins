...
included with Retina Network Security Scanner.");
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.beyondtrust.com/products/retina-network-security-scanner/"
  );
...
app = "eEye Retina Wireless Scanner (Standalone)";
