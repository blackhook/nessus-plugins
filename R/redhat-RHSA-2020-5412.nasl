...
"Update the affected python3-XStatic-jQuery224 package.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'python3-XStatic-jQuery224-2.2.4.1-3.el8ost', 'release':'8', 'el_string':'el8ost', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
