...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-0178"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-0179"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0332"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"firefox-3.0.19-1.el4")) flag++;


  if (rpm_check(release:"RHEL5", reference:"firefox-3.0.19-1.el5_5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"xulrunner-1.9.0.19-1.el5_5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"xulrunner-devel-1.9.0.19-1.el5_5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"xulrunner-devel-unstable-1.9.0.19-1.el5_5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"xulrunner-devel-unstable-1.9.0.19-1.el5_5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"xulrunner-devel-unstable-1.9.0.19-1.el5_5")) flag++;
