...
The redhat-certification package provides partners with a unified
web-based user interface to certify their products for use on Red Hat
Infrastructure. It can currently be used in the latest releases of Red
Hat Certified Cloud and Service Provider Certification, Red Hat
OpenStack Certification and Red Hat Hardware Certification Programs.

Security Fix(es) :

* redhat-certification: rhcertStore.py:__saveResultsFile allows to
write any file (CVE-2018-10870)

* redhat-certification: /download allows to download any file
(CVE-2018-10869)

* redhat-certification: resource consumption in
DocumentBase:loadFiltered (CVE-2018-10864)
...
Security)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2373"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2018-10864"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2018-10869"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2018-10870"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"redhat-certification-5.16-20180809.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"redhat-certification-backend-5.16-20180809.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"redhat-certification-baremetal-5.16-20180809.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"redhat-certification-cloud-5.16-20180809.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"redhat-certification-hardware-5.16-20180809.1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"redhat-certification-hardware-preview-5.16-20180809.1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"redhat-certification-openstack-5.16-20180809.el7")) flag++;
