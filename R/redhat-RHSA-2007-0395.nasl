...
# extracted from Red Hat Security Advisory RHSA-2007:0395. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : mod_perl (RHSA-2007:0395)");
...
contain a backported fix to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0395"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"mod_perl-1.99_09-12.ent")) flag++;

  if (rpm_check(release:"RHEL3", reference:"mod_perl-devel-1.99_09-12.ent")) flag++;


  if (rpm_check(release:"RHEL4", reference:"mod_perl-1.99_16-4.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"mod_perl-devel-1.99_16-4.5")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"mod_perl-2.0.2-6.3.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"mod_perl-2.0.2-6.3.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"mod_perl-2.0.2-6.3.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"mod_perl-devel-2.0.2-6.3.el5")) flag++;
