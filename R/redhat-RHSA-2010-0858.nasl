...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-0405"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0858"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:bzip2-debuginfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"bzip2-1.0.5-7.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"bzip2-1.0.5-7.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"bzip2-1.0.5-7.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", reference:"bzip2-debuginfo-1.0.5-7.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", reference:"bzip2-devel-1.0.5-7.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", reference:"bzip2-libs-1.0.5-7.el6_0")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "bzip2 / bzip2-debuginfo / bzip2-devel / bzip2-libs");
  }
}
