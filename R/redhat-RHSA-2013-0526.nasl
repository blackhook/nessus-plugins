...
# extracted from Red Hat Security Advisory RHSA-2013:0526. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : automake (RHSA-2013:0526)");
...
which corrects this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:0526"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-3386"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"automake-1.11.1-4.el6")) flag++;
