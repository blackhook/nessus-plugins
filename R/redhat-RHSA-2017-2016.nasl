...
# extracted from Red Hat Security Advisory RHSA-2017:2016. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : curl (RHSA-2017:2016)");
...
Enterprise Linux 7.4 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2016"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-7167"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"curl-7.29.0-42.el7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"curl-7.29.0-42.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"curl-debuginfo-7.29.0-42.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libcurl-7.29.0-42.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"libcurl-devel-7.29.0-42.el7")) flag++;
