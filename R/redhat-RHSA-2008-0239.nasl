...
# extracted from Red Hat Security Advisory RHSA-2008:0239. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : poppler (RHSA-2008:0239)");
...
backported patches to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0239"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"poppler-0.5.4-4.4.el5_1")) flag++;

  if (rpm_check(release:"RHEL5", reference:"poppler-devel-0.5.4-4.4.el5_1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"poppler-utils-0.5.4-4.4.el5_1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"poppler-utils-0.5.4-4.4.el5_1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"poppler-utils-0.5.4-4.4.el5_1")) flag++;
