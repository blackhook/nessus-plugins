...
(named) will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:1364"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-5166"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"bind97-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"bind97-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"bind97-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"bind97-chroot-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"bind97-chroot-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"bind97-chroot-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", reference:"bind97-debuginfo-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", reference:"bind97-devel-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", reference:"bind97-libs-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"bind97-utils-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"bind97-utils-9.7.0-10.P2.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"bind97-utils-9.7.0-10.P2.el5_8.4")) flag++;
