...
a patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1914"
  );
  # http://marc.theaimsgroup.com/?l=bugtraq&m=102701096228027
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=bugtraq&m=102701096228027"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:583"
  );
  script_set_attribute(
    attribute:"solution", 
