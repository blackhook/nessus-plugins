...
# extracted from Red Hat Security Advisory RHSA-2007:0501. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : libexif (RHSA-2007:0501)");
...
contain a backported patch and are not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-4168"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0501"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"libexif-0.5.12-5.1.0.2")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libexif-devel-0.5.12-5.1.0.2")) flag++;


  if (rpm_check(release:"RHEL5", reference:"libexif-0.6.13-4.0.2.el5")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libexif-devel-0.6.13-4.0.2.el5")) flag++;
