...
# extracted from Red Hat Security Advisory RHSA-2008:0884. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : libxml2 (RHSA-2008:0884)");
...
which contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-3529"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0884"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"libxml2-2.5.10-13")) flag++;

  if (rpm_check(release:"RHEL3", reference:"libxml2-devel-2.5.10-13")) flag++;

  if (rpm_check(release:"RHEL3", reference:"libxml2-python-2.5.10-13")) flag++;


  if (rpm_check(release:"RHEL4", reference:"libxml2-2.6.16-12.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libxml2-devel-2.6.16-12.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libxml2-python-2.6.16-12.5")) flag++;


  if (rpm_check(release:"RHEL5", reference:"libxml2-2.6.26-2.1.2.6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libxml2-devel-2.6.26-2.1.2.6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"libxml2-python-2.6.26-2.1.2.6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"libxml2-python-2.6.26-2.1.2.6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"libxml2-python-2.6.26-2.1.2.6")) flag++;
