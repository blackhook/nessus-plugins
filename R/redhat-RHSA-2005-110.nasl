...
contain backported patches to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:110"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"emacs-21.3-19.EL.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"emacs-common-21.3-19.EL.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"emacs-el-21.3-19.EL.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"emacs-leim-21.3-19.EL.1")) flag++;
  if (rpm_check(release:"RHEL4", reference:"emacs-nox-21.3-19.EL.1")) flag++;
