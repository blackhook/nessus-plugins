...
# extracted from Red Hat Security Advisory RHSA-2008:0224. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : thunderbird (RHSA-2008:0224)");
...
contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0224"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"thunderbird-1.5.0.12-11.el4")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"thunderbird-1.5.0.12-12.el5_1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"thunderbird-1.5.0.12-12.el5_1")) flag++;
