...
# extracted from Red Hat Security Advisory RHSA-2016:2138. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2016:2138");

  script_name(english:"RHEL 5 : java-1.7.0-ibm (RHSA-2016:2138)");
...
CVE-2016-5554, CVE-2016-5556, CVE-2016-5573, CVE-2016-5597)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:2138"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-1.7.0.9.60-1jpp.1.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-demo-1.7.0.9.60-1jpp.1.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-devel-1.7.0.9.60-1jpp.1.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-jdbc-1.7.0.9.60-1jpp.1.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"java-1.7.0-ibm-plugin-1.7.0.9.60-1jpp.1.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"java-1.7.0-ibm-plugin-1.7.0.9.60-1jpp.1.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-src-1.7.0.9.60-1jpp.1.el5_11")) flag++;
