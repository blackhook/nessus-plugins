...
# extracted from Red Hat Security Advisory RHSA-2006:0760. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : thunderbird (RHSA-2006:0760)");
...
Thunderbird version 1.5.0.9 that corrects these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0760"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"thunderbird-1.5.0.9-0.1.el4")) flag++;
