...
# extracted from Red Hat Security Advisory RHSA-2006:0184. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : kdelibs (RHSA-2006:0184)");
...
well as two bug fixes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-0019"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0184"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"kdelibs-3.3.1-3.14")) flag++;
  if (rpm_check(release:"RHEL4", reference:"kdelibs-devel-3.3.1-3.14")) flag++;
