...
if (description)
{
  ...
  script_name(english:"RHEL 6 : MRG (RHSA-2011:1250)");
...
Enterprise MRG 2.0 for Red Hat Enterprise Linux 6.
...
In addition, these updated packages for Red Hat Enterprise Linux 6
...
Technical Notes."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-2925"
  );
  # https://access.redhat.com/kb/docs/DOC-58404
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/articles/53254"
  );
  # https://docs.redhat.com/docs/en-US/Red_Hat_Enterprise_MRG/2.0/html/
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:1250"
  );
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"condor-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"condor-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"condor-aviary-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"condor-aviary-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"condor-classads-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"condor-classads-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"condor-debuginfo-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"condor-debuginfo-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"condor-ec2-enhanced-1.2-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"condor-ec2-enhanced-hooks-1.2-3.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"condor-job-hooks-1.5-4.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"condor-kbdd-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"condor-kbdd-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"condor-low-latency-1.2-2.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"condor-qmf-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"condor-qmf-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"condor-vm-gahp-7.6.3-0.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"condor-wallaby-base-db-1.14-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"condor-wallaby-client-4.1-4.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"condor-wallaby-tools-4.1-4.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"cumin-0.1.4916-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"python-condorec2e-1.2-3.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"python-condorutils-1.5-4.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"python-wallabyclient-4.1-4.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"ruby-rhubarb-0.4.0-1.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"ruby-wallaby-0.10.5-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"wallaby-0.10.5-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", reference:"wallaby-utils-0.10.5-6.el6")) flag++;
