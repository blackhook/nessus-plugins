...
evolution-data-server must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0355"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"evolution-2.0.2-41.el4_7.2")) flag++;

  if (rpm_check(release:"RHEL4", reference:"evolution-data-server-1.0.2-14.el4_7.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"evolution-data-server-devel-1.0.2-14.el4_7.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"evolution-devel-2.0.2-41.el4_7.2")) flag++;
