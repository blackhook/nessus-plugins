...
if (description)
{
  ...
  script_name(english:"RHEL 7 : RHV-H enhancement and security update (redhat-virtualization-host) 4.3.14 (Moderate) (RHSA-2021:1051)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.14-20210322.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
