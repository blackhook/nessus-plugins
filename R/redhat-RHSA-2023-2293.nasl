...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-2393");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'idm-pki-acme-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-base-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-ca-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-est-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-java-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-kra-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-server-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'idm-pki-tools-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'python3-idm-pki-11.3.0-1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'idm-pki-acme / idm-pki-base / idm-pki-ca / idm-pki-est / idm-pki-java / etc');
}
