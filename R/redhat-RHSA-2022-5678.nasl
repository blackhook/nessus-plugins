...
if (description)
{
  ...
  script_name(english:"RHEL 8 : Red Hat Virtualization security, bug fix, and enhancement update [ovirt-4.5.1] (Important) (RHSA-2022:5678)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.5.1-202207170705_8.6', 'cpu':'x86_64', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
