...
Container Platform 3.8.44. See the following advisory for the
container images for this release :

https://access.redhat.com/errata/RHBA-2018:3550

All OpenShift Container Platform 3.8 users are advised to upgrade to
these updated packages."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHBA-2018:3550"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:3551"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_exists(rpm:"atomic-openshift-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-clients-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-clients-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-clients-redistributable-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-clients-redistributable-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-cluster-capacity-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-cluster-capacity-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-descheduler-0.3.0-1.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-docker-excluder-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"atomic-openshift-docker-excluder-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-dockerregistry-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-dockerregistry-3.8.44-1.git.224.90f9341.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-excluder-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"atomic-openshift-excluder-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-federation-services-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-federation-services-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-master-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-master-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-node-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-node-3.8.44-1.git.0.9be0abd.el7")) flag++;
  ...
  if (rpm_exists(rpm:"atomic-openshift-pod-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-pod-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-sdn-ovs-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-sdn-ovs-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-service-catalog-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-service-catalog-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-template-service-broker-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-template-service-broker-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-tests-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-tests-3.8.44-1.git.0.9be0abd.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-utils-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"atomic-openshift-utils-3.8.44-1.git.0.2bfde74.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-3.8.44-1.git.0.2bfde74.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-docs-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-docs-3.8.44-1.git.0.2bfde74.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-playbooks-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-playbooks-3.8.44-1.git.0.2bfde74.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-roles-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-roles-3.8.44-1.git.0.2bfde74.el7")) flag++;
  ...
  if (rpm_exists(rpm:"tuned-profiles-atomic-openshift-node-3.8", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"tuned-profiles-atomic-openshift-node-3.8.44-1.git.0.9be0abd.el7")) flag++;
