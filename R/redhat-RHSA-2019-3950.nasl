...
[Updated 3 December 2019] The packages distributed via this erratum
did not include the fix for CVE-2019-13616 as claimed. RHSA-2019:4024
was released on 2 December 2019 to address this issue.
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:3950"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"SDL-1.2.15-14.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"SDL-debuginfo-1.2.15-14.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"SDL-devel-1.2.15-14.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"SDL-static-1.2.15-14.el7_7")) flag++;
