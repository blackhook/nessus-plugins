...
# extracted from Red Hat Security Advisory RHSA-2004:174. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:174");

  script_name(english:"RHEL 2.1 / 3 : utempter (RHSA-2004:174)");
...
vulnerability."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0233"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:174"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:utempter");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"utempter-0.5.5-1.2.1EL.0")) flag++;

  if (rpm_check(release:"RHEL3", reference:"utempter-0.5.5-1.3EL.0")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "utempter");
  }
}
