...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"sudo-1.8.19p2-12.el7_4.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"i686", reference:"sudo-debuginfo-1.8.19p2-12.el7_4.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"sudo-debuginfo-1.8.19p2-12.el7_4.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"i686", reference:"sudo-devel-1.8.19p2-12.el7_4.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"4", cpu:"x86_64", reference:"sudo-devel-1.8.19p2-12.el7_4.1")) flag++;
