...
the RHSA-2023:2120 advisory.
  ...
  - Malicious IKEv1 Aggressive Mode packets can crash libreswan [fedora-all] (CVE-2023-30570)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2023-30570");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'libreswan-4.6-3.el9_1.1', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
