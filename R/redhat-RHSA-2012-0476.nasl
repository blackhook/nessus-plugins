...
# extracted from Red Hat Security Advisory RHSA-2012:0476. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2012:0476");

  script_name(english:"RHEL 5 : MRG (RHSA-2012:0476)");
...
this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:0476"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-1575"
  );
  ...
  script_set_attribute(attribute:"vuln_publication_date", value:"2012/04/22");
...
else
{
  ...
  if (rpm_check(release:"RHEL5", reference:"cumin-0.1.5192-4.el5")) flag++;
