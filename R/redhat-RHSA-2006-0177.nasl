...
# extracted from Red Hat Security Advisory RHSA-2006:0177. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : gpdf (RHSA-2006:0177)");
...
backported patch to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3624"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3625"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3626"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3627"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0177"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"gpdf-2.8.2-7.4")) flag++;
