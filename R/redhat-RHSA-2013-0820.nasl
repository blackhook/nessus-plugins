...
take effect.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?a134523f");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2013:0820");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-17.0.6-1.el5_9", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-17.0.6-1.el5_9", allowmaj:TRUE)) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"firefox-17.0.6-1.el6_4", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-17.0.6-1.el6_4", allowmaj:TRUE)) flag++;
