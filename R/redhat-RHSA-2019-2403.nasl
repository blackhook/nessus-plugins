...
* augeas: Improper handling of escaped strings leading to memory
corruption (CVE-2017-7555)
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:2403"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-7555"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"augeas-1.4.0-2.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"augeas-debuginfo-1.4.0-2.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"augeas-debuginfo-1.4.0-2.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"augeas-devel-1.4.0-2.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"augeas-devel-1.4.0-2.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"i686", reference:"augeas-libs-1.4.0-2.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"augeas-libs-1.4.0-2.el7_3.1")) flag++;
