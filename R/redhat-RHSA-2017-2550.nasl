...
# extracted from Red Hat Security Advisory RHSA-2017:2550. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : poppler (RHSA-2017:2550)");
...
(CVE-2017-9776)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2550"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"poppler-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-debuginfo-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-devel-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-glib-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-glib-devel-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-qt-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-qt-devel-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-qt4-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", reference:"poppler-qt4-devel-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"poppler-utils-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"poppler-utils-0.12.4-12.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"poppler-utils-0.12.4-12.el6_9")) flag++;
