...
# extracted from Red Hat Security Advisory RHSA-2008:0222. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : firefox (RHSA-2008:0222)");
...
contain backported patches that correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0222"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"firefox-1.5.0.12-0.15.el4")) flag++;


  if (rpm_check(release:"RHEL5", reference:"firefox-1.5.0.12-15.el5_1")) flag++;

  if (rpm_check(release:"RHEL5", reference:"firefox-devel-1.5.0.12-15.el5_1")) flag++;
