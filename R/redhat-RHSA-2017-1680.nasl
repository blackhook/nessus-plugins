...
(BZ#1459649)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://kb.isc.org/docs/aa-01503"
  );
  # https://kb.isc.org/article/AA-01504
  script_set_attribute(
    attribute:"see_also",
    value:"https://kb.isc.org/docs/aa-01504"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:1680"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-3142"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-3143"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"bind-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"bind-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"bind-chroot-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"bind-chroot-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-debuginfo-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-devel-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-libs-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-libs-lite-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-license-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-lite-devel-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"bind-pkcs11-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"bind-pkcs11-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-pkcs11-devel-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"bind-pkcs11-libs-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"bind-pkcs11-utils-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"bind-pkcs11-utils-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"bind-sdb-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"bind-sdb-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"bind-sdb-chroot-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"bind-sdb-chroot-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"bind-utils-9.9.4-50.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"bind-utils-9.9.4-50.el7_3.1")) flag++;
