...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : Virtualization (RHSA-2018:1711) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1711"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL6", reference:"rhev-hypervisor7-7.3-20180521.1.el6")) flag++;

  if (rpm_check(release:"RHEL7", reference:"rhev-hypervisor7-7.3-20180521.1.el7")) flag++;
