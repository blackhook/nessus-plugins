...
# extracted from Red Hat Security Advisory RHSA-2014:1893. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : libXfont (RHSA-2014:1893)");
...
server instances must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:1893"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"libXfont-1.2.2-1.0.6.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"libXfont-debuginfo-1.2.2-1.0.6.el5_11")) flag++;
  if (rpm_check(release:"RHEL5", reference:"libXfont-devel-1.2.2-1.0.6.el5_11")) flag++;
