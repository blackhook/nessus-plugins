...
# extracted from Red Hat Security Advisory RHSA-2017:2838. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : dnsmasq (RHSA-2017:2838)");
...
(Google Security Team) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2838"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dnsmasq-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dnsmasq-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dnsmasq-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dnsmasq-debuginfo-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dnsmasq-debuginfo-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dnsmasq-utils-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dnsmasq-utils-2.48-18.el6_9")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dnsmasq-utils-2.48-18.el6_9")) flag++;
