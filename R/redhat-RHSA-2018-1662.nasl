...
if (description)
{
  ...
  script_name(english:"RHEL 7 : qemu-kvm (RHSA-2018:1662) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1662"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-img-1.5.3-126.el7_3.14")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-1.5.3-126.el7_3.14")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-126.el7_3.14")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-126.el7_3.14")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-126.el7_3.14")) flag++;
