...
package, which fixes these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:0312"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-1198"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"initscripts-8.45.42-1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"initscripts-8.45.42-1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"initscripts-8.45.42-1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"initscripts-debuginfo-8.45.42-1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"initscripts-debuginfo-8.45.42-1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"initscripts-debuginfo-8.45.42-1.el5")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "initscripts / initscripts-debuginfo");
  }
}
