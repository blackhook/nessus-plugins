...
# extracted from Red Hat Security Advisory RHSA-2005:019. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:019");

  script_name(english:"RHEL 2.1 / 3 : libtiff (RHSA-2005:019)");
...
utility. An attacker who has the ability to trick a user into opening
a malicious TIFF file with tiffdump could possibly execute arbitrary
...
contain backported fixes for these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-1183"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-1308"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:019"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"libtiff-3.5.5-19")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"libtiff-devel-3.5.5-19")) flag++;

  if (rpm_check(release:"RHEL3", reference:"libtiff-3.5.7-22.el3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libtiff-devel-3.5.7-22.el3")) flag++;
