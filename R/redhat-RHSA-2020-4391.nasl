...
"Update the affected openstack-cinder and / or python-cinder packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-cinder-12.0.10-19.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python-cinder-12.0.10-19.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
