...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-28116");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1939");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1939939");
  ...
  'squid:4': [
    {
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.15-3.module+el8.6.0+14176+9782b8ab', 'sp':'6', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    },
    {
      'repo_relative_urls': [
      ...
      'pkgs': [
        ...
        {'reference':'squid-4.15-3.module+el8.6.0+14176+9782b8ab', 'release':'8', 'el_string':'el8.6.0', 'rpm_spec_vers_cmp':TRUE, 'epoch':'7'}
      ]
    }
  ]
};
