...
# extracted from Red Hat Security Advisory RHSA-2009:0296. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : icu (RHSA-2009:0296)");
...
protection mechanisms, or display information in a manner misleading
to the user. (CVE-2008-1036)
...
contain backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-1036"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0296"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"icu-3.6-5.11.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"icu-3.6-5.11.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"icu-3.6-5.11.2")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libicu-3.6-5.11.2")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libicu-devel-3.6-5.11.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"libicu-doc-3.6-5.11.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"libicu-doc-3.6-5.11.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"libicu-doc-3.6-5.11.2")) flag++;
