...
"Update the affected atomic-openshift-dockerregistry and / or jenkins-2-plugins packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'atomic-openshift-dockerregistry-3.11.705-1.g0fa231c.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'},
      {'reference':'jenkins-2-plugins-3.11.1650628887-1.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-ansible'}
    ]
  }
];
