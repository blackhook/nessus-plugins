...
"Update the affected openstack-keystone and / or python-keystone packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'openstack-keystone-13.0.4-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'},
      {'reference':'python-keystone-13.0.4-3.el7ost', 'release':'7', 'el_string':'el7ost', 'rpm_spec_vers_cmp':TRUE, 'epoch':'1'}
    ]
  }
];
