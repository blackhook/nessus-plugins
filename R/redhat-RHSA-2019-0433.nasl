...
See https://github.com/ansible/ansible/blob/v2.6.14/changelogs/
CHANGELOG-v2.6.rst for details on bug fixes in this release."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:0433"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL7", reference:"ansible-2.6.14-1.el7")) flag++;
