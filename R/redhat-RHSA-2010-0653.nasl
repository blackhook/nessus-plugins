...
# extracted from Red Hat Security Advisory RHSA-2010:0653. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : ImageMagick (RHSA-2010:0653)");
...
effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-1882"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0653"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"ImageMagick-6.0.7.1-20.el4_8.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"ImageMagick-c++-6.0.7.1-20.el4_8.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"ImageMagick-c++-devel-6.0.7.1-20.el4_8.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"ImageMagick-devel-6.0.7.1-20.el4_8.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"ImageMagick-perl-6.0.7.1-20.el4_8.1")) flag++;
