...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0809"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"xulrunner-1.9.2.11-4.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"xulrunner-devel-1.9.2.11-4.el5_5")) flag++;
