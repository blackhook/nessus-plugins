...
See: https://github.com/ansible/ansible/blob/v2.8.2/changelogs/
CHANGELOG-v2.8.rst for details on bug fixes in this release."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://github.com/ansible/ansible/blob/v2.8.2/changelogs/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:1706"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL7", rpm:"ansible-2.[0-5]") || rpm_exists(release:"RHEL8", rpm:"ansible-2.[0-5]"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "Red Hat Ansible 2.0 - 2.5");

  if (rpm_check(release:"RHEL7", reference:"ansible-2.8.2-1.el7")) flag++;

  if (rpm_check(release:"RHEL8", reference:"ansible-2.8.2-1.el8")) flag++;
