...
# extracted from Red Hat Security Advisory RHSA-2014:0885. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2014:0885");

  script_name(english:"RHEL 5 / 6 : JBoss EAP (RHSA-2014:0885)");
...
update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0885"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2014-3530"
  );
  script_set_attribute(
    attribute:"solution", 
...
else
{
  ...
  if (rpm_check(release:"RHEL5", reference:"picketlink-federation-2.1.5-3_patch_01.ep5.el5")) flag++;

  if (rpm_check(release:"RHEL6", reference:"picketlink-federation-2.1.5-3_patch_01.el6_5")) flag++;
