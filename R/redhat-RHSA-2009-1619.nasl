...
# extracted from Red Hat Security Advisory RHSA-2009:1619. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : dstat (RHSA-2009:1619)");
...
a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-3894"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1619"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:dstat");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"dstat-0.6.6-3.el5_4.1")) flag++;
