...
# extracted from Red Hat Security Advisory RHSA-2009:1502. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : kdegraphics (RHSA-2009:1502)");
...
a backported patch to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1502"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"kdegraphics-3.5.4-15.el5_4.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"kdegraphics-3.5.4-15.el5_4.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"kdegraphics-devel-3.5.4-15.el5_4.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"kdegraphics-devel-3.5.4-15.el5_4.2")) flag++;
