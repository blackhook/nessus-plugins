...
resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:165"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"rsh-0.17-25.3")) flag++;
  if (rpm_check(release:"RHEL4", reference:"rsh-server-0.17-25.3")) flag++;
