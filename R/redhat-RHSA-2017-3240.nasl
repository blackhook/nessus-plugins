...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : JBoss EAP (RHSA-2017:3240) (Optionsbleed)");
...
functions of each core dump. (BZ#1508885)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/articles/3229231"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:3240"
  );
  script_set_attribute(
    attribute:"see_also",
