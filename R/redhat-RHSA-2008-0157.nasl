...
# extracted from Red Hat Security Advisory RHSA-2008:0157. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : cups (RHSA-2008:0157)");
...
contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-0882"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0157"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"cups-1.2.4-11.14.el5_1.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"cups-1.2.4-11.14.el5_1.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"cups-1.2.4-11.14.el5_1.4")) flag++;

  if (rpm_check(release:"RHEL5", reference:"cups-devel-1.2.4-11.14.el5_1.4")) flag++;

  if (rpm_check(release:"RHEL5", reference:"cups-libs-1.2.4-11.14.el5_1.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"cups-lpd-1.2.4-11.14.el5_1.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"cups-lpd-1.2.4-11.14.el5_1.4")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"cups-lpd-1.2.4-11.14.el5_1.4")) flag++;
