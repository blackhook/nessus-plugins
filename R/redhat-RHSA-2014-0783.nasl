...
httpd service for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bz.apache.org/bugzilla/show_bug.cgi?id=53104"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0783"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL6", cpu:"i386", reference:"httpd-debuginfo-2.2.22-27.ep6.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"httpd-debuginfo-2.2.22-27.ep6.el6")) flag++;
