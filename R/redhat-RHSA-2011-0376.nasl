...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : dbus (RHSA-2011:0376)");
...
system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-4352"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:0376"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"dbus-1.1.2-15.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"dbus-devel-1.1.2-15.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", reference:"dbus-libs-1.1.2-15.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"dbus-x11-1.1.2-15.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"dbus-x11-1.1.2-15.el5_6")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"dbus-x11-1.1.2-15.el5_6")) flag++;


  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dbus-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dbus-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dbus-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", reference:"dbus-debuginfo-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", reference:"dbus-devel-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", reference:"dbus-doc-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", reference:"dbus-libs-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dbus-x11-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dbus-x11-1.2.24-4.el6_0")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dbus-x11-1.2.24-4.el6_0")) flag++;
