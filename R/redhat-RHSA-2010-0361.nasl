...
# extracted from Red Hat Security Advisory RHSA-2010:0361. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : sudo (RHSA-2010:0361)");
...
backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2010-1163"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0361"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"sudo-1.7.2p1-6.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"sudo-1.7.2p1-6.el5_5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"sudo-1.7.2p1-6.el5_5")) flag++;
