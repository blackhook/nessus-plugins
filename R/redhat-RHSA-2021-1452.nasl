...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : Red Hat Ceph Storage security, bug fix, and enhancement Update (Important) (RHSA-2021:1452)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-25678");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1892109");
