...
# extracted from Red Hat Security Advisory RHSA-2008:0235. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : speex (RHSA-2008:0235)");
...
which contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-1686"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0235"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected speex and / or speex-devel packages."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"speex-1.0.4-4.el4_6.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"speex-devel-1.0.4-4.el4_6.1")) flag++;


  if (rpm_check(release:"RHEL5", reference:"speex-1.0.5-4.el5_1.1")) flag++;

  if (rpm_check(release:"RHEL5", reference:"speex-devel-1.0.5-4.el5_1.1")) flag++;
