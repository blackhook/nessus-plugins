...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:2593"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-12527"
  );
...
appstreams = {
    'squid:4': [
      ...
      {'reference':'squid-4.4-5.module+el8.0.0+4045+70edde92', 'cpu':'aarch64', 'release':'8', 'epoch':'7'},
      {'reference':'squid-4.4-5.module+el8.0.0+4045+70edde92', 'cpu':'s390x', 'release':'8', 'epoch':'7'},
      {'reference':'squid-4.4-5.module+el8.0.0+4045+70edde92', 'cpu':'x86_64', 'release':'8', 'epoch':'7'},
      {'reference':'squid-debugsource-4.4-5.module+el8.0.0+4045+70edde92', 'cpu':'aarch64', 'release':'8', 'epoch':'7'},
      {'reference':'squid-debugsource-4.4-5.module+el8.0.0+4045+70edde92', 'cpu':'s390x', 'release':'8', 'epoch':'7'},
      {'reference':'squid-debugsource-4.4-5.module+el8.0.0+4045+70edde92', 'cpu':'x86_64', 'release':'8', 'epoch':'7'}
    ],
};
