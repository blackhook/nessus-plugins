...
# extracted from Red Hat Security Advisory RHSA-2015:1488. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1488");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/03/24");
  script_xref(name:"CEA-ID", value:"CEA-2021-0004");

  script_name(english:"RHEL 5 : java-1.7.0-ibm (RHSA-2015:1488) (Logjam)");
...
instances of IBM Java must be restarted for the update to take effect.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2015:1488");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-1.7.0.9.10-1jpp.2.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-demo-1.7.0.9.10-1jpp.2.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-devel-1.7.0.9.10-1jpp.2.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-jdbc-1.7.0.9.10-1jpp.2.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"java-1.7.0-ibm-plugin-1.7.0.9.10-1jpp.2.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"java-1.7.0-ibm-plugin-1.7.0.9.10-1jpp.2.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-src-1.7.0.9.10-1jpp.2.el5")) flag++;
