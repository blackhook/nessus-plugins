...
# extracted from Red Hat Security Advisory RHSA-2009:1039. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : ntp (RHSA-2009:1039)");
...
the update, the ntpd daemon will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-1252"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1039"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"ntp-4.2.2p1-9.el5_3.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"ntp-4.2.2p1-9.el5_3.2")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"ntp-4.2.2p1-9.el5_3.2")) flag++;
