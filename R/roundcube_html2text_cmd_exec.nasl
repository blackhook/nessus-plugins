...
under which the web server operates.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/archive/1/499489/30/0/threaded");
        ...
        if (report_verbosity > 0)
        {
          ...
          if (report_verbosity > 1)
          {
            ...
            report = string(
              ...
              "\n",
              "  ", str_replace(find:'\n', replace:'\n  ', string:data_protection::sanitize_uid(output:output)), "\n"
            );
          }
