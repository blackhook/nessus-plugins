...
Container Platform 3.9.51. See the following advisory for the
...
these updated packages and images."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2908"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:fluentd-debuginfo");
...
{
  flag = 0;
  if (rpm_exists(rpm:"atomic-openshift-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-clients-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-clients-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-clients-redistributable-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-clients-redistributable-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-cluster-capacity-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-cluster-capacity-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-docker-excluder-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"atomic-openshift-docker-excluder-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-dockerregistry-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-dockerregistry-3.9.51-1.git.353.7685923.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-excluder-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"atomic-openshift-excluder-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-federation-services-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-federation-services-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-master-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-master-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-node-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-node-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-pod-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-pod-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-sdn-ovs-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-sdn-ovs-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-service-catalog-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-service-catalog-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-template-service-broker-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-template-service-broker-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-tests-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-tests-3.9.51-1.git.0.dc3a40b.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-utils-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"atomic-openshift-utils-3.9.51-1.git.0.c4968ca.el7")) flag++;
  if (rpm_exists(rpm:"atomic-openshift-web-console-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"atomic-openshift-web-console-3.9.51-1.git.268.c379530.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"fluentd-0.12.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"fluentd-debuginfo-0.12.43-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"fluentd-doc-0.12.43-3.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-3.9.51-1.git.0.c4968ca.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-docs-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-docs-3.9.51-1.git.0.c4968ca.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-playbooks-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-playbooks-3.9.51-1.git.0.c4968ca.el7")) flag++;
  if (rpm_exists(rpm:"openshift-ansible-roles-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", reference:"openshift-ansible-roles-3.9.51-1.git.0.c4968ca.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"openshift-elasticsearch-plugin-2.4.4.23__redhat_1-3.el7")) flag++;
  if (rpm_exists(rpm:"prometheus-node-exporter-3.9", release:"RHEL7") && rpm_check(release:"RHEL7", cpu:"x86_64", reference:"prometheus-node-exporter-3.9.51-1.git.1060.2055e02.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"rubygem-fluent-plugin-kubernetes_metadata_filter-1.0.3-2.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"rubygem-fluent-plugin-kubernetes_metadata_filter-doc-1.0.3-2.el7")) flag++;
