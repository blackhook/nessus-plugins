...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"An updated Thunderbird package that fixes a security issue is now
...
A bug was found in the way Thunderbird handled cookies when loading
...
which contains Thunderbird version 1.0 and is not vulnerable to this
issue."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:094"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"thunderbird-1.0-1.1.EL4")) flag++;
