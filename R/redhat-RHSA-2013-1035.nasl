...
# extracted from Red Hat Security Advisory RHSA-2013:1035. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2013:1035");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2013:1035)");
...
which upgrades Flash Player to version 11.2.202.297."
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1035"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-3347"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-3345"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2013-3344"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", sp:"9", reference:"flash-plugin-11.2.202.297-1.el5")) flag++;


  if (rpm_check(release:"RHEL6", reference:"flash-plugin-11.2.202.297-1.el6")) flag++;
