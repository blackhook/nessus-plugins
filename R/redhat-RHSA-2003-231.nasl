...
a backported patch correcting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0440"
  );
  # http://www.debian.org/security/2003/dsa-339
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.debian.org/security/2003/dsa-339"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:231"
  );
  script_set_attribute(
    attribute:"solution", 
