...
Enterprise Linux 7.7 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:2136"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-3858"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-3861"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"libssh2-1.8.0-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"libssh2-debuginfo-1.8.0-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"libssh2-devel-1.8.0-3.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"libssh2-docs-1.8.0-3.el7")) flag++;
