...
# extracted from Red Hat Security Advisory RHSA-2013:1323. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : ccid (RHSA-2013:1323)");
...
contains backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2013:1323"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"ccid-1.3.8-2.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"ccid-1.3.8-2.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"ccid-debuginfo-1.3.8-2.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"ccid-debuginfo-1.3.8-2.el5")) flag++;
