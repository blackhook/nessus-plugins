...
(BZ#1712471)");
  script_set_attribute(attribute:"see_also", value:"https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/");
  script_set_attribute(attribute:"see_also", value:"https://github.com/dotnet/core/blob/master/release-notes/2.1/2.1.11/");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2019:1259");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2019-0757");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2019-0820");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2019-0980");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2019-0981");
