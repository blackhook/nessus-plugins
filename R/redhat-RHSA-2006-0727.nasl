...
# extracted from Red Hat Security Advisory RHSA-2006:0727. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : texinfo (RHSA-2006:0727)");
...
contain backported patches and are not vulnerable to these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-3011"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2006-4810"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0727"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:info");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:texinfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"info-4.0b-3.el2.1")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"texinfo-4.0b-3.el2.1")) flag++;

  if (rpm_check(release:"RHEL3", reference:"info-4.5-3.el3.1")) flag++;
  if (rpm_check(release:"RHEL3", reference:"texinfo-4.5-3.el3.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"info-4.7-5.el4.2")) flag++;
  if (rpm_check(release:"RHEL4", reference:"texinfo-4.7-5.el4.2")) flag++;
