...
# extracted from Red Hat Security Advisory RHSA-2005:518. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : gaim (RHSA-2005:518)");
...
contains version 1.3.1 and is not vulnerable to these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-1269"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-1934"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:518"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"gaim-1.3.1-0.el3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"gaim-1.3.1-0.el4")) flag++;
