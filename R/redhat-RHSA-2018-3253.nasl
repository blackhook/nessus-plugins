...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2016-9396");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2017-1000050");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"jasper-1.900.1-33.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"jasper-1.900.1-33.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"jasper-debuginfo-1.900.1-33.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"jasper-devel-1.900.1-33.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"jasper-libs-1.900.1-33.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"jasper-utils-1.900.1-33.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"jasper-utils-1.900.1-33.el7")) flag++;
