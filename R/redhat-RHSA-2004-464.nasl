...
# extracted from Red Hat Security Advisory RHSA-2004:464. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:464");

  script_name(english:"RHEL 2.1 : mc (RHSA-2004:464)");
...
backported patches and is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0494"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:464"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"gmc-4.5.51-36.4")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"mc-4.5.51-36.4")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"mcserv-4.5.51-36.4")) flag++;
