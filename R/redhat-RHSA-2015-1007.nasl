...
# extracted from Red Hat Security Advisory RHSA-2015:1007. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1007");

  script_name(english:"RHEL 5 : java-1.7.0-ibm (RHSA-2015:1007) (Bar Mitzvah)");
...
packages, containing the IBM Java SE 7 SR9 release. All running
instances of IBM Java must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1007"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-1.7.0.9.0-1jpp.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-demo-1.7.0.9.0-1jpp.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-devel-1.7.0.9.0-1jpp.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-jdbc-1.7.0.9.0-1jpp.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"java-1.7.0-ibm-plugin-1.7.0.9.0-1jpp.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"java-1.7.0-ibm-plugin-1.7.0.9.0-1jpp.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"java-1.7.0-ibm-src-1.7.0.9.0-1jpp.1.el5")) flag++;
