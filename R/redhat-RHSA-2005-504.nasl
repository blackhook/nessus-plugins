...
# extracted from Red Hat Security Advisory RHSA-2005:504. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : telnet (RHSA-2005:504)");
...
a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:504"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"telnet-0.17-20.EL2.4")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"telnet-server-0.17-20.EL2.4")) flag++;

  if (rpm_check(release:"RHEL3", reference:"telnet-0.17-26.EL3.3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"telnet-server-0.17-26.EL3.3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"telnet-0.17-31.EL4.3")) flag++;
  if (rpm_check(release:"RHEL4", reference:"telnet-server-0.17-31.EL4.3")) flag++;
