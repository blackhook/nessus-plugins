...
referenced in the RHSA-2022:7238 advisory.
  ...
  - Puppetlabs-mysql: Command Injection in the puppetlabs-mysql module (CVE-2022-3276)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-3276");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:7238");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2132541");
  script_set_attribute(attribute:"solution", value:
"Update the affected puppet-mysql package.");
