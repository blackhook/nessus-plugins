...
else
{
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"bpftool-debuginfo-4.18.0-80.4.2.el8_0")) flag++;
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"kernel-debug-debuginfo-4.18.0-80.4.2.el8_0")) flag++;
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"kernel-debuginfo-4.18.0-80.4.2.el8_0")) flag++;
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"kernel-debuginfo-common-aarch64-4.18.0-80.4.2.el8_0")) flag++;
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"kernel-tools-debuginfo-4.18.0-80.4.2.el8_0")) flag++;
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"kernel-tools-libs-devel-4.18.0-80.4.2.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", sp:"0", cpu:"x86_64", reference:"kernel-tools-libs-devel-4.18.0-80.4.2.el8_0")) flag++;
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"perf-debuginfo-4.18.0-80.4.2.el8_0")) flag++;
  ...
  if (rpm_check(release:"RHEL8", sp:"0", cpu:"aarch64", reference:"python3-perf-debuginfo-4.18.0-80.4.2.el8_0")) flag++;
