...
# extracted from Red Hat Security Advisory RHSA-2011:1441. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : icedtea-web (RHSA-2011:1441)");
...
this update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-3377"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:1441"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"icedtea-web-1.0.6-1.el6_1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"icedtea-web-1.0.6-1.el6_1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"icedtea-web-debuginfo-1.0.6-1.el6_1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"icedtea-web-debuginfo-1.0.6-1.el6_1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"icedtea-web-javadoc-1.0.6-1.el6_1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"icedtea-web-javadoc-1.0.6-1.el6_1")) flag++;
