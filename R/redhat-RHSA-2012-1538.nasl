...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : jabberd in Satellite Server (RHSA-2012:1538)");
...
available for Red Hat Network Satellite 5.5 for Red Hat Enterprise
Linux 5 and 6.
...
Solution section for details."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:1538"
  );
  script_set_attribute(
    attribute:"see_also",
