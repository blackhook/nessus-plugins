...
# extracted from Red Hat Security Advisory RHSA-2008:0146. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : gd (RHSA-2008:0146)");
...
backported patches which resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-3472"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-3473"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-3475"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-3476"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0146"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"gd-2.0.28-5.4E.el4_6.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"gd-devel-2.0.28-5.4E.el4_6.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"gd-progs-2.0.28-5.4E.el4_6.1")) flag++;


  if (rpm_check(release:"RHEL5", reference:"gd-2.0.33-9.4.el5_1.1")) flag++;

  if (rpm_check(release:"RHEL5", reference:"gd-devel-2.0.33-9.4.el5_1.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"gd-progs-2.0.33-9.4.el5_1.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"gd-progs-2.0.33-9.4.el5_1.1")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"gd-progs-2.0.33-9.4.el5_1.1")) flag++;
