...
(Google Security Team) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2839"
  );
  script_set_attribute(
    attribute:"see_also",
...
{  sp = get_kb_item("Host/RedHat/minor_release");
  ...
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"dnsmasq-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"dnsmasq-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"dnsmasq-2.48-14.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"dnsmasq-2.48-13.el6_4.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"dnsmasq-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"dnsmasq-2.48-5.el6_2.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dnsmasq-2.48-13.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"dnsmasq-debuginfo-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"dnsmasq-debuginfo-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.48-14.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.48-13.el6_4.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"2", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.48-5.el6_2.2")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.48-13.el6_5.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"i686", reference:"dnsmasq-utils-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"s390x", reference:"dnsmasq-utils-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"dnsmasq-utils-2.48-14.el6_6.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"4", cpu:"x86_64", reference:"dnsmasq-utils-2.48-13.el6_4.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"7", cpu:"x86_64", reference:"dnsmasq-utils-2.48-16.el6_7.1")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"dnsmasq-utils-2.48-13.el6_5.1")) flag++;
