...
(CVE-2016-8706)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2016:2819"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-8704"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-8705"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2016-8706"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"memcached-1.4.15-10.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"memcached-1.4.15-10.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"memcached-debuginfo-1.4.15-10.el7_3.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"memcached-devel-1.4.15-10.el7_3.1")) flag++;
