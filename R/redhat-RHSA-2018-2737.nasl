...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2737"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-2767"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
mod_perl-devel packages."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:mod_perl-debuginfo");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"mod_perl-2.0.4-12.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"mod_perl-2.0.4-12.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"mod_perl-2.0.4-12.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", reference:"mod_perl-debuginfo-2.0.4-12.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", reference:"mod_perl-devel-2.0.4-12.el6_10")) flag++;
