...
the original reporter."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:0230"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"polkit-0.112-18.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"polkit-debuginfo-0.112-18.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"polkit-devel-0.112-18.el7_6.1")) flag++;

  if (rpm_check(release:"RHEL7", reference:"polkit-docs-0.112-18.el7_6.1")) flag++;
