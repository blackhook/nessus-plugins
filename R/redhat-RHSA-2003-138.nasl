...
vulnerability."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0196"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0201"
  );
  # http://www.digitaldefense.net/labs/advisories/DDI-1013.txt
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.digitaldefense.com/"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:138"
  );
