...
# extracted from Red Hat Security Advisory RHSA-2008:0064. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : libXfont (RHSA-2008:0064)");
...
which contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0064"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"libXfont-1.2.2-1.0.3.el5_1")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libXfont-devel-1.2.2-1.0.3.el5_1")) flag++;
