...
# extracted from Red Hat Security Advisory RHSA-2007:1029. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : xpdf (RHSA-2007:1029)");
...
backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:1029"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"xpdf-3.00-14.el4")) flag++;
