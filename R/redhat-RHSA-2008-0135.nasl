...
# extracted from Red Hat Security Advisory RHSA-2008:0135. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : tk (RHSA-2008:0135)");
...
contain a backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0135"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"tk-8.4.7-3.el4_6.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"tk-devel-8.4.7-3.el4_6.1")) flag++;
