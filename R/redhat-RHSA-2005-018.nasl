...
# extracted from Red Hat Security Advisory RHSA-2005:018. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:018");

  script_name(english:"RHEL 3 : xpdf (RHSA-2005:018)");
...
All users of the Xpdf packages should upgrade to these updated
packages, which resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:018"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"xpdf-2.02-9.4")) flag++;
