...
if (description)
{
  ...
  script_name(english:"RHEL 7 : qemu-kvm (RHSA-2018:0027) (Spectre)");
...
issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:0027"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-img-1.5.3-126.el7_3.13")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-1.5.3-126.el7_3.13")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-common-1.5.3-126.el7_3.13")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-debuginfo-1.5.3-126.el7_3.13")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"qemu-kvm-tools-1.5.3-126.el7_3.13")) flag++;
