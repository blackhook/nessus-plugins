...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-3826");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-4285");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2023:3269");
  script_set_attribute(attribute:"solution", value:
"Update the affected devtoolset-12-binutils and / or devtoolset-12-binutils-devel packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'devtoolset-12-binutils-2.36.1-6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'devtoolset-12-binutils-devel-2.36.1-6.el7', 'release':'7', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
