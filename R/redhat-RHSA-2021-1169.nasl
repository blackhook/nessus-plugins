...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'ovirt-engine-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-backend-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-dbscripts-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-health-check-bundler-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-restapi-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-base-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-plugin-cinderlib-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-plugin-imageio-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-plugin-ovirt-engine-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-plugin-ovirt-engine-common-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-plugin-vmconsole-proxy-helper-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-setup-plugin-websocket-proxy-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-tools-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-tools-backup-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-vmconsole-proxy-helper-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-webadmin-portal-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-engine-websocket-proxy-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'ovirt-web-ui-1.6.7-1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'python3-ovirt-engine-lib-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'},
      {'reference':'rhvm-4.4.5.9-0.1.el8ev', 'release':'8', 'el_string':'el8ev', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rhevm-4'}
    ]
  }
];
