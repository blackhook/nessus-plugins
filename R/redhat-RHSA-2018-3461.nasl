...
reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:3461"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL7", reference:"ansible-2.5.11-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"ansible-doc-2.5.11-1.el7")) flag++;
