...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : ipsec-tools (RHSA-2005:232)");
...
contains backported patches, and is not vulnerable to these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-0398"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:232"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"ipsec-tools-0.2.5-0.7")) flag++;

  if (rpm_check(release:"RHEL4", reference:"ipsec-tools-0.3.3-6")) flag++;
