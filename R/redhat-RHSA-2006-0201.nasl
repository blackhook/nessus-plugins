...
# extracted from Red Hat Security Advisory RHSA-2006:0201. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : xpdf (RHSA-2006:0201)");
...
providing a patch."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2006:0201"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"xpdf-3.00-11.12")) flag++;
