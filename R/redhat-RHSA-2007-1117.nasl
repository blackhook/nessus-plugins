...
# extracted from Red Hat Security Advisory RHSA-2007:1117. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2007:1117");

  script_name(english:"RHEL 4 : samba (RHSA-2007:1117)");
...
contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2007-1117.html"
  );
...
flag = 0;
if (rpm_check(release:"RHEL4", sp:"5", reference:"samba-3.0.10-2.el4_5.2")) flag++;
if (rpm_check(release:"RHEL4", sp:"5", reference:"samba-client-3.0.10-2.el4_5.2")) flag++;
if (rpm_check(release:"RHEL4", sp:"5", reference:"samba-common-3.0.10-2.el4_5.2")) flag++;
if (rpm_check(release:"RHEL4", sp:"5", reference:"samba-swat-3.0.10-2.el4_5.2")) flag++;
