...
# extracted from Red Hat Security Advisory RHSA-2005:812. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : wget (RHSA-2005:812)");
...
which contain a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:812"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"wget-1.10.2-0.AS21")) flag++;

  if (rpm_check(release:"RHEL3", reference:"wget-1.10.2-0.30E")) flag++;

  if (rpm_check(release:"RHEL4", reference:"wget-1.10.2-0.40E")) flag++;
