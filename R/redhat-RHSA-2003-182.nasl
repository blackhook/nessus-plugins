...
# extracted from Red Hat Security Advisory RHSA-2003:182. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2003:182");

  script_name(english:"RHEL 2.1 : ghostscript (RHSA-2003:182)");
...
which are not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0354"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:182"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"ghostscript-6.51-16.3")) flag++;
