...
# extracted from Red Hat Security Advisory RHSA-2004:156. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2003-0991", "CVE-2004-0182");
  script_xref(name:"RHSA", value:"2004:156");

  script_name(english:"RHEL 2.1 : mailman (RHSA-2004:156)");
...
correct a DoS (Denial of Service) vulnerability where an attacker
could send a carefully-crafted message and cause mailman to crash.
...
assigned the name CVE-2004-0182 to this issue.

Users of Mailman are advised to upgrade to these updated packages,
which include an updated patch and are not vulnerable to this issue."
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0182"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:156"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"mailman-2.0.13-6")) flag++;
