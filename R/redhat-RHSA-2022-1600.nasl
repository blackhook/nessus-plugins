...
the RHSA-2022:1600 advisory.

  - cri-o: Default inheritable capabilities for linux container should be empty (CVE-2022-27652)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-27652");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:1600");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2066839");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.23.2-8.rhaos4.10.git8ad5d25.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
