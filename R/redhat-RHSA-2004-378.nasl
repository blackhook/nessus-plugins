...
# extracted from Red Hat Security Advisory RHSA-2004:378. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:378");

  script_name(english:"RHEL 2.1 / 3 : ethereal (RHSA-2004:378)");
...
contain a version that is not vulnerable to these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0633"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0634"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0635"
  );
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:378"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"ethereal-0.10.5-0.AS21.2")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"ethereal-gnome-0.10.5-0.AS21.2")) flag++;

  if (rpm_check(release:"RHEL3", reference:"ethereal-0.10.5-0.30E.2")) flag++;
  if (rpm_check(release:"RHEL3", reference:"ethereal-gnome-0.10.5-0.30E.2")) flag++;
