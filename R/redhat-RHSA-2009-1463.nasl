...
# extracted from Red Hat Security Advisory RHSA-2009:1463. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : newt (RHSA-2009:1463)");
...
for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-2905"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1463"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:newt");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:newt-devel");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"newt-0.51.5-2.el3")) flag++;

  if (rpm_check(release:"RHEL3", reference:"newt-devel-0.51.5-2.el3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"newt-0.51.6-10.el4_8.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"newt-devel-0.51.6-10.el4_8.1")) flag++;


  if (rpm_check(release:"RHEL5", reference:"newt-0.52.2-12.el5_4.1")) flag++;

  if (rpm_check(release:"RHEL5", reference:"newt-devel-0.52.2-12.el5_4.1")) flag++;
