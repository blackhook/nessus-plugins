...
This issue was discovered by Dominic Geevarghes (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0257"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2017-2614"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"ovirt-engine-extension-aaa-jdbc-1.1.3-1.el7")) flag++;
