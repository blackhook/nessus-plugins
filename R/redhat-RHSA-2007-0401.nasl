...
# extracted from Red Hat Security Advisory RHSA-2007:0401. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : thunderbird (RHSA-2007:0401)");
...
Thunderbird version 1.5.0.12 that corrects these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0401"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"thunderbird-1.5.0.12-0.1.el4")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"thunderbird-1.5.0.12-1.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"thunderbird-1.5.0.12-1.el5")) flag++;
