...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'dhcp-client-4.4.2-17.b1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-common-4.4.2-17.b1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-relay-4.4.2-17.b1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'},
      {'reference':'dhcp-server-4.4.2-17.b1.el9', 'sp':'2', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'epoch':'12'}
    ]
  },
  {
    'repo_relative_urls': [
