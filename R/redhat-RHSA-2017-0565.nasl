...
Technical Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0565"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-camlp4-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-camlp4-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-camlp4-devel-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-camlp4-devel-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-debuginfo-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-debuginfo-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-docs-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-docs-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-emacs-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-emacs-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-labltk-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-labltk-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-labltk-devel-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-labltk-devel-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-ocamldoc-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-ocamldoc-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-runtime-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-runtime-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-source-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-source-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"ocaml-x11-3.11.2-5.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-x11-3.11.2-5.el6")) flag++;
