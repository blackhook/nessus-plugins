...
# extracted from Red Hat Security Advisory RHSA-2004:465. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:465");

  script_name(english:"RHEL 2.1 / 3 : imlib (RHSA-2004:465)");
...
backported patches and is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0817"
  );
  # http://bugzilla.gnome.org/show_bug.cgi?id=151034
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.gnome.org/show_bug.cgi?id=151034"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:465"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"imlib-1.9.13-4.2")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"imlib-cfgeditor-1.9.13-4.2")) flag++;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"imlib-devel-1.9.13-4.2")) flag++;

  if (rpm_check(release:"RHEL3", reference:"imlib-1.9.13-13.3")) flag++;
  if (rpm_check(release:"RHEL3", reference:"imlib-devel-1.9.13-13.3")) flag++;
