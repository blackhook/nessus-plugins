...
var constraints = [
  {
    ...
    'pkgs': [
      ...
      {'reference':'rh-dotnet31-aspnetcore-runtime-3.1-3.1.1-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-aspnetcore-targeting-pack-3.1-3.1.1-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-3.1.101-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-apphost-pack-3.1-3.1.1-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-host-3.1.1-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-hostfxr-3.1-3.1.1-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-runtime-3.1-3.1.1-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-sdk-3.1-3.1.101-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-targeting-pack-3.1-3.1.1-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-dotnet-templates-3.1-3.1.101-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'},
      {'reference':'rh-dotnet31-netstandard-targeting-pack-2.1-3.1.101-4.el7', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet30'}
    ]
  }
];
