...
# extracted from Red Hat Security Advisory RHSA-2018:3127. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : 389-ds-base (RHSA-2018:3127)");
...
Enterprise Linux 7.6 Release Notes linked from the References section.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2018:3127");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/cve-2018-14648");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"389-ds-base-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"389-ds-base-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"389-ds-base-debuginfo-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"389-ds-base-debuginfo-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"389-ds-base-devel-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"389-ds-base-devel-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"389-ds-base-libs-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"389-ds-base-libs-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"389-ds-base-snmp-1.3.8.4-15.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"389-ds-base-snmp-1.3.8.4-15.el7")) flag++;
