...
# extracted from Red Hat Security Advisory RHSA-2015:1378. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : hivex (RHSA-2015:1378)");
...
which contain backported patches to correct these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1378"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"hivex-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"hivex-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"hivex-debuginfo-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"hivex-debuginfo-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"hivex-devel-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"hivex-devel-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-hivex-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"ocaml-hivex-devel-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"perl-hivex-1.3.3-4.3.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"python-hivex-1.3.3-4.3.el6")) flag++;
