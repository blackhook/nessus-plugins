...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:0420"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"polkit-0.96-11.el6_10.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"polkit-debuginfo-0.96-11.el6_10.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"polkit-desktop-policy-0.96-11.el6_10.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"polkit-devel-0.96-11.el6_10.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"polkit-docs-0.96-11.el6_10.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"polkit-docs-0.96-11.el6_10.1")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"polkit-docs-0.96-11.el6_10.1")) flag++;
