...
# extracted from Red Hat Security Advisory RHSA-2012:1546. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2012:1546");

  script_xref(name:"IAVA", value:"0001-A-0628");

  script_name(english:"RHEL 4 : redhat-release (EOL Notice) (RHSA-2012:1546)");
  ...
  script_set_attribute(
    ...
    value:
"This is the End Of Life notification for RHN Satellite Server 5
versions released to run on Red Hat Enterprise Linux 4.
...
Linux 4"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2012-1546.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
