...
# extracted from Red Hat Security Advisory RHSA-2012:0468. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : libtiff (RHSA-2012:0468)");
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:0468"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2012-1173"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"libtiff-3.8.2-14.el5_8")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libtiff-devel-3.8.2-14.el5_8")) flag++;


  if (rpm_check(release:"RHEL6", reference:"libtiff-3.9.4-5.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libtiff-debuginfo-3.9.4-5.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"libtiff-devel-3.9.4-5.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"libtiff-static-3.9.4-5.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"libtiff-static-3.9.4-5.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"libtiff-static-3.9.4-5.el6_2")) flag++;
