...
contain backported patches which resolves these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2008-1109"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0515"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"evolution28-2.8.0-53.el4_6.3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"evolution28-devel-2.8.0-53.el4_6.3")) flag++;
