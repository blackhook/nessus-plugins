...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-1323"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2003-0615"
  );
  # http://marc.theaimsgroup.com/?l=bugtraq&m=105880349328877
  script_set_attribute(
    attribute:"see_also",
    value:"https://marc.info/?l=bugtraq&m=105880349328877"
  );
  # http://bugs6.perl.org/rt2/Ticket/Display.html?id=17744
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c4b4e33a"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2003:257"
  );
