...
# extracted from Red Hat Security Advisory RHSA-2009:0344. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : libsoup (RHSA-2009:0344)");
...
must be restarted for the update to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-0585"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0344"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:evolution28-libsoup");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:redhat:enterprise_linux:evolution28-libsoup-devel");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"evolution28-libsoup-2.2.98-5.el4.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"evolution28-libsoup-devel-2.2.98-5.el4.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libsoup-2.2.1-4.el4.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libsoup-devel-2.2.1-4.el4.1")) flag++;


  if (rpm_check(release:"RHEL5", reference:"libsoup-2.2.98-2.el5_3.1")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libsoup-devel-2.2.98-2.el5_3.1")) flag++;
