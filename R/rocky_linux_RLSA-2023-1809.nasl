...
# Rocky Linux Security Advisory RLSA-2023:1809.
##
...
if (description)
{
  ...
  script_xref(name:"RLSA", value:"2023:1809");
  script_xref(name:"IAVA", value:"2023-A-0166-S");
  script_xref(name:"IAVA", value:"2023-A-0199-S");

  script_name(english:"Rocky Linux 9 : thunderbird (RLSA-2023:1809)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://errata.rockylinux.org/RLSA-2023:1809");
...
var pkgs = [
    {'reference':'thunderbird-102.10.0-2.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debuginfo-102.10.0-2.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE},
    {'reference':'thunderbird-debugsource-102.10.0-2.el9_1', 'cpu':'x86_64', 'release':'9', 'rpm_spec_vers_cmp':TRUE, 'allowmaj':TRUE}
];
