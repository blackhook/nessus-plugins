...
the RHSA-2022:0990 advisory.
  ...
  - openstack-neutron: Routes middleware memory leak for nonexistent controllers (CVE-2021-40797)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-40797");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:0990");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2003248");
