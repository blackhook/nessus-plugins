...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'rh-dotnet50-aspnetcore-runtime-5.0-5.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-aspnetcore-targeting-pack-5.0-5.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-5.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-apphost-pack-5.0-5.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-host-5.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-hostfxr-5.0-5.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-runtime-5.0-5.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-sdk-5.0-5.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-targeting-pack-5.0-5.0.2-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-dotnet-templates-5.0-5.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'},
      {'reference':'rh-dotnet50-netstandard-targeting-pack-2.1-5.0.102-1.el7_9', 'cpu':'x86_64', 'release':'7', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'rh-dotnet50'}
    ]
  }
];
