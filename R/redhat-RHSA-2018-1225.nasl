...
and Kevin Backhouse (lgtm.com / Semmle) as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1225"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"librelp-1.2.7-3.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"librelp-debuginfo-1.2.7-3.el6_9.1")) flag++;
  if (rpm_check(release:"RHEL6", reference:"librelp-devel-1.2.7-3.el6_9.1")) flag++;
