...
The go-toolset:rhel8 module provides Go Toolset, a compiler toolset
for building applications using the Go language and compiler suite.
...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:1519"
  );
  script_set_attribute(
    attribute:"see_also",
...
appstreams = {
    'go-toolset:rhel8': [
      {'reference':'go-toolset-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'aarch64', 'release':'8'},
      {'reference':'go-toolset-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'s390x', 'release':'8'},
      {'reference':'go-toolset-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'aarch64', 'release':'8'},
      {'reference':'golang-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'s390x', 'release':'8'},
      {'reference':'golang-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-bin-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'aarch64', 'release':'8'},
      {'reference':'golang-bin-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'s390x', 'release':'8'},
      {'reference':'golang-bin-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-docs-1.11.5-2.module+el8.0.0+3175+261ae921', 'release':'8'},
      {'reference':'golang-misc-1.11.5-2.module+el8.0.0+3175+261ae921', 'release':'8'},
      {'reference':'golang-race-1.11.5-2.module+el8.0.0+3175+261ae921', 'cpu':'x86_64', 'release':'8'},
      {'reference':'golang-src-1.11.5-2.module+el8.0.0+3175+261ae921', 'release':'8'},
      {'reference':'golang-tests-1.11.5-2.module+el8.0.0+3175+261ae921', 'release':'8'}
    ],
};
