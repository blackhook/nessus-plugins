...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 : mailman (RHSA-2005:235)");
  ...
  script_set_attribute(
    ...
    value:
"An updated mailman package that corrects a cross-site scripting flaw
is now available.
...
Utils.websafe() to quote the html."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-1177"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:235"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"mailman-2.1.5-25.rhel3")) flag++;

  if (rpm_check(release:"RHEL4", reference:"mailman-2.1.5-33.rhel4")) flag++;
