...
# extracted from Red Hat Security Advisory RHSA-2012:0143. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : xulrunner (RHSA-2012:0143)");
...
XULRunner must be restarted for the changes to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:0143"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"xulrunner-1.9.2.26-2.el5_7")) flag++;

  if (rpm_check(release:"RHEL5", reference:"xulrunner-devel-1.9.2.26-2.el5_7")) flag++;


  if (rpm_check(release:"RHEL6", reference:"xulrunner-1.9.2.26-2.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"xulrunner-debuginfo-1.9.2.26-2.el6_2")) flag++;

  if (rpm_check(release:"RHEL6", reference:"xulrunner-devel-1.9.2.26-2.el6_2")) flag++;
