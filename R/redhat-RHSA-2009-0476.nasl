...
# extracted from Red Hat Security Advisory RHSA-2009:0476. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : pango (RHSA-2009:0476)");
...
session."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-1194"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:0476"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"pango-1.2.5-8")) flag++;

  if (rpm_check(release:"RHEL3", reference:"pango-devel-1.2.5-8")) flag++;


  if (rpm_check(release:"RHEL4", reference:"evolution28-pango-1.14.9-11.el4_7")) flag++;

  if (rpm_check(release:"RHEL4", reference:"evolution28-pango-devel-1.14.9-11.el4_7")) flag++;

  if (rpm_check(release:"RHEL4", reference:"pango-1.6.0-14.4_7")) flag++;

  if (rpm_check(release:"RHEL4", reference:"pango-devel-1.6.0-14.4_7")) flag++;


  if (rpm_check(release:"RHEL5", reference:"pango-1.14.9-5.el5_3")) flag++;

  if (rpm_check(release:"RHEL5", reference:"pango-devel-1.14.9-5.el5_3")) flag++;
