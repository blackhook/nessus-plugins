...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"7", cpu:"s390x", reference:"sudo-1.8.23-4.el7_7.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"7", cpu:"x86_64", reference:"sudo-1.8.23-4.el7_7.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"7", reference:"sudo-debuginfo-1.8.23-4.el7_7.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"7", reference:"sudo-devel-1.8.23-4.el7_7.1")) flag++;
