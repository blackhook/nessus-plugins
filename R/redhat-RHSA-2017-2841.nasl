...
# extracted from Red Hat Security Advisory RHSA-2017:2841. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2017:2841");
  script_xref(name:"IAVA", value:"2017-A-0284-S");

  script_name(english:"RHEL 5 : dnsmasq (RHSA-2017:2841)");
...
(Google Security Team) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://rhn.redhat.com/errata/RHSA-2017-2841.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.redhat.com/security/data/cve/CVE-2017-14491.html"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected dnsmasq and / or dnsmasq-debuginfo packages."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", sp:"9", cpu:"i386", reference:"dnsmasq-2.45-2.el5_9.1")) flag++;
  if (rpm_check(release:"RHEL5", sp:"9", cpu:"x86_64", reference:"dnsmasq-2.45-2.el5_9.1")) flag++;
  if (rpm_check(release:"RHEL5", sp:"9", cpu:"i386", reference:"dnsmasq-debuginfo-2.45-2.el5_9.1")) flag++;
  if (rpm_check(release:"RHEL5", sp:"9", cpu:"x86_64", reference:"dnsmasq-debuginfo-2.45-2.el5_9.1")) flag++;
  ...
  else
  {
    ...
    else audit(AUDIT_PACKAGE_NOT_INSTALLED, "dnsmasq / dnsmasq-debuginfo");
  }
}
