...
# extracted from Red Hat Security Advisory RHSA-2008:0576. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : rdesktop (RHSA-2008:0576)");
...
contain a backported patch to resolve this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2008:0576"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"rdesktop-1.2.0-3")) flag++;
