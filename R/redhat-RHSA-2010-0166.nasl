...
must be restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2010:0166"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"gnutls-1.4.1-3.el5_4.8")) flag++;

  if (rpm_check(release:"RHEL5", reference:"gnutls-devel-1.4.1-3.el5_4.8")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"gnutls-utils-1.4.1-3.el5_4.8")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"gnutls-utils-1.4.1-3.el5_4.8")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"gnutls-utils-1.4.1-3.el5_4.8")) flag++;
