...
# extracted from Red Hat Security Advisory RHSA-2009:1682. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : kdegraphics (RHSA-2009:1682)");
...
a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2009-4035"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2009:1682"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"kdegraphics-3.3.1-17.el4_8.1")) flag++;

  if (rpm_check(release:"RHEL4", reference:"kdegraphics-devel-3.3.1-17.el4_8.1")) flag++;
