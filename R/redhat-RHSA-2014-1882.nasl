...
instances of IBM Java must be restarted for the update to take effect.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHEA-2014:1619");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"java-1.7.0-ibm-1.7.0.8.0-1jpp.1.el6_6")) flag++;
  ...
  if (rpm_check(release:"RHEL6", reference:"java-1.7.0-ibm-devel-1.7.0.8.0-1jpp.1.el6_6")) flag++;
