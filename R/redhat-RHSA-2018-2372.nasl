...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"An update for cobbler is now available for Red Hat Satellite 5.6, Red
Hat Satellite 5.7, and Red Hat Satellite 5.8.
...
installs, and re-installing existing Linux machines. Cobbler has a
XMLRPC API for integration with other applications.
...
This issue was discovered by Cedric Buissart (Red Hat)."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2372"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2018-10931"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"cobbler-2.0.7-44.1.el6sat")) flag++;
