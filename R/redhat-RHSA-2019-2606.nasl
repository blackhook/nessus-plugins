...
* kde.csh profile file contains bourne-shell code (BZ#1740042)"
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:2606"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2019-14744"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"kde-settings-19-23.10.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kde-settings-ksplash-19-23.10.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kde-settings-minimal-19-23.10.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kde-settings-plasma-19-23.10.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kde-settings-pulseaudio-19-23.10.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kdelibs-4.14.8-11.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kdelibs-apidocs-4.14.8-11.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"kdelibs-common-4.14.8-11.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"kdelibs-common-4.14.8-11.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kdelibs-debuginfo-4.14.8-11.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kdelibs-devel-4.14.8-11.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"kdelibs-ktexteditor-4.14.8-11.el7_7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"qt-settings-19-23.10.el7_7")) flag++;
