...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : Ansible security and bug fix update (2.8.8) (Moderate) (RHSA-2020:0216)");
...
referenced in the RHSA-2020:0216 advisory.
  ...
  - Ansible: vulnerability in solaris_zone module via crafted solaris zone (CVE-2019-14904)

  - Ansible: malicious code could craft filename in nxos_file_copy module (CVE-2019-14905)

Note that Nessus has not tested for these issues but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-14904");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2019-14905");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:0216");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1776943");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1776944");
