...
update, all DHCP servers will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2011-4539"
  );
  # http://www.isc.org/software/dhcp/advisories/cve-2011-4539
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?c5cbd4af"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:1819"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dhclient-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dhclient-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dhclient-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dhcp-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dhcp-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dhcp-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"dhcp-common-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"dhcp-common-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"dhcp-common-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"dhcp-debuginfo-4.1.1-25.P1.el6_2.1")) flag++;

  if (rpm_check(release:"RHEL6", reference:"dhcp-devel-4.1.1-25.P1.el6_2.1")) flag++;
