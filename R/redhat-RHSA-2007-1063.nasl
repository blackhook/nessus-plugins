...
# extracted from Red Hat Security Advisory RHSA-2007:1063. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : pcre (RHSA-2007:1063)");
...
Red Hat would like to thank Ludwig Nussel for reporting these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:1063"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"pcre-3.9-10.4")) flag++;
  if (rpm_check(release:"RHEL3", reference:"pcre-devel-3.9-10.4")) flag++;
