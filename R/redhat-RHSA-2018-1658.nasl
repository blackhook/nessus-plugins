...
if (description)
{
  ...
  script_name(english:"RHEL 6 : qemu-kvm (RHSA-2018:1658) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1658"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"qemu-guest-agent-0.12.1.2-2.448.el6_6.6")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"qemu-img-0.12.1.2-2.448.el6_6.6")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"qemu-kvm-0.12.1.2-2.448.el6_6.6")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"qemu-kvm-debuginfo-0.12.1.2-2.448.el6_6.6")) flag++;
  if (rpm_check(release:"RHEL6", sp:"6", cpu:"x86_64", reference:"qemu-kvm-tools-0.12.1.2-2.448.el6_6.6")) flag++;
