...
# extracted from Red Hat Security Advisory RHSA-2015:0716. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : openssl (RHSA-2015:0716)");
...
be restarted, or the system rebooted."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:0716"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"openssl-1.0.1e-42.el7_1.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"openssl-1.0.1e-42.el7_1.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"openssl-debuginfo-1.0.1e-42.el7_1.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"openssl-devel-1.0.1e-42.el7_1.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"openssl-libs-1.0.1e-42.el7_1.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"openssl-perl-1.0.1e-42.el7_1.4")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"openssl-perl-1.0.1e-42.el7_1.4")) flag++;

  if (rpm_check(release:"RHEL7", reference:"openssl-static-1.0.1e-42.el7_1.4")) flag++;
