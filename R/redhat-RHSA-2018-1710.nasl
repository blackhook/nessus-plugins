...
if (description)
{
  ...
  script_name(english:"RHEL 7 : Virtualization (RHSA-2018:1710) (Spectre)");
...
Center) and Jann Horn (Google Project Zero) for reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1710"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL7", rpm:"redhat-virtualization-host-image-update-3.6"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "Virtualization");

  if (rpm_check(release:"RHEL7", reference:"redhat-virtualization-host-image-update-3.6-20180521.0.el7_3")) flag++;
