...
# extracted from Red Hat Security Advisory RHSA-2015:1439. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 6 : wpa_supplicant (RHSA-2015:1439)");
...
wpa_supplicant service will be restarted automatically."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1439"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"wpa_supplicant-0.7.3-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"wpa_supplicant-0.7.3-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"wpa_supplicant-0.7.3-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"wpa_supplicant-debuginfo-0.7.3-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"wpa_supplicant-debuginfo-0.7.3-6.el6")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"wpa_supplicant-debuginfo-0.7.3-6.el6")) flag++;
