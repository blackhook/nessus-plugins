...
# extracted from Red Hat Security Advisory RHSA-2015:1031. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2015:1031");

  script_name(english:"RHEL 6 : qemu-kvm (RHSA-2015:1031) (Venom)");
...
to take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2015:1031"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"i686", reference:"qemu-guest-agent-0.12.1.2-2.415.el6_5.15")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-guest-agent-0.12.1.2-2.415.el6_5.15")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-img-0.12.1.2-2.415.el6_5.15")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-kvm-0.12.1.2-2.415.el6_5.15")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"i686", reference:"qemu-kvm-debuginfo-0.12.1.2-2.415.el6_5.15")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-kvm-debuginfo-0.12.1.2-2.415.el6_5.15")) flag++;
  if (rpm_check(release:"RHEL6", sp:"5", cpu:"x86_64", reference:"qemu-kvm-tools-0.12.1.2-2.415.el6_5.15")) flag++;
