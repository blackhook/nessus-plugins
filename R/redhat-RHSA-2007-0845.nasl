...
# extracted from Red Hat Security Advisory RHSA-2007:0845. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : libvorbis (RHSA-2007:0845)");
...
which contains backported patches that resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0845"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"libvorbis-1.0-8.el3")) flag++;

  if (rpm_check(release:"RHEL3", reference:"libvorbis-devel-1.0-8.el3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"libvorbis-1.1.0-2.el4.5")) flag++;

  if (rpm_check(release:"RHEL4", reference:"libvorbis-devel-1.1.0-2.el4.5")) flag++;


  if (rpm_check(release:"RHEL5", reference:"libvorbis-1.1.2-3.el5.0")) flag++;

  if (rpm_check(release:"RHEL5", reference:"libvorbis-devel-1.1.2-3.el5.0")) flag++;
