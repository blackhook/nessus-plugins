...
if (description)
{
  ...
  script_name(english:"RHEL 7 : Virtualization Manager (RHSA-2019:1204) (MDSUM/RIDL) (MFBDS/RIDL/ZombieLoad) (MLPDS/RIDL) (MSBDS/Fallout)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Red Hat host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"An update for vdsm is now available for Red Hat Virtualization 4.2 for
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-api-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-client-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-common-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-gluster-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-hook-checkips-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-cpuflags-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-ethtool-options-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-hook-extra-ipv4-addrs-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-fcoe-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-localdisk-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-macspoof-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-nestedvt-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-openstacknet-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-vhostmd-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-hook-vmfex-dev-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-http-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-jsonrpc-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"vdsm-network-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-python-4.20.49-1.el7")) flag++;
  if (rpm_check(release:"RHEL7", reference:"vdsm-yajsonrpc-4.20.49-1.el7")) flag++;
