...
# extracted from Red Hat Security Advisory RHSA-2007:0157. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : xorg-x11-apps and libX11 (RHSA-2007:0157)");
...
this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0157"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected libX11, libX11-devel and / or xorg-x11-apps
packages."
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"libX11-1.0.3-8.0.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", reference:"libX11-devel-1.0.3-8.0.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"xorg-x11-apps-7.1-4.0.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"xorg-x11-apps-7.1-4.0.1.el5")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"xorg-x11-apps-7.1-4.0.1.el5")) flag++;
