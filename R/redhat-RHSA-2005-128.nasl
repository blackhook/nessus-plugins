...
# extracted from Red Hat Security Advisory RHSA-2005:128. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2005:128");

  script_name(english:"RHEL 3 : imap (RHSA-2005:128)");
...
contain a backported patch and are not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-0198"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:128"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"imap-2002d-11")) flag++;
  if (rpm_check(release:"RHEL3", reference:"imap-devel-2002d-11")) flag++;
  if (rpm_check(release:"RHEL3", reference:"imap-utils-2002d-11")) flag++;
