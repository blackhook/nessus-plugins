...
if (description)
{
  ...
  script_name(english:"RHEL 8 : OpenShift Container Platform 4.11.17 packages and (RHSA-2022:8626)");
...
number.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2113814");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2124669");
  script_set_attribute(attribute:"solution", value:
"Update the affected cri-o and / or cri-tools packages.");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'cri-o-1.24.3-6.rhaos4.11.gitc4567c0.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'},
      {'reference':'cri-tools-1.24.2-7.el8', 'release':'8', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'openshift-hyperkube'}
    ]
  }
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'cri-o / cri-tools');
}
