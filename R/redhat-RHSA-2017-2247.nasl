...
# extracted from Red Hat Security Advisory RHSA-2017:2247. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 7 : tomcat (RHSA-2017:2247)");
...
Enterprise Linux 7.4 Release Notes linked from the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:2247"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", reference:"tomcat-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-admin-webapps-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-docs-webapp-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-el-2.2-api-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-javadoc-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-jsp-2.2-api-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-jsvc-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-lib-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-servlet-3.0-api-7.0.76-2.el7")) flag++;

  if (rpm_check(release:"RHEL7", reference:"tomcat-webapps-7.0.76-2.el7")) flag++;
