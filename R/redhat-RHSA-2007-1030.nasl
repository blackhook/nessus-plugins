...
# extracted from Red Hat Security Advisory RHSA-2007:1030. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 : xpdf (RHSA-2007:1030)");
...
backported patches to resolve these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:1030"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"xpdf-2.02-11.el3")) flag++;
