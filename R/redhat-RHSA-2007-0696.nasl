...
which contains version 9.0.47.0. and is not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-3456"
  );
  # http://www.adobe.com/support/security/bulletins/apsb07-12.html
  script_set_attribute(
    attribute:"see_also",
    value:"https://www.adobe.com/support/security/bulletins/apsb07-12.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0696"
  );
  script_set_attribute(
    attribute:"solution", 
