...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2018-1122");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:1265");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1575466");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'procps-ng-3.3.10-17.el7_5.4', 'sp':'5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'procps-ng-devel-3.3.10-17.el7_5.4', 'sp':'5', 'release':'7', 'rpm_spec_vers_cmp':TRUE},
