...
the RHSA-2022:8873 advisory.
  ...
  - python-oslo-utils: incorrect password masking in debug output (CVE-2022-0718)

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2022-0718");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2022:8873");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/2056850");
  script_set_attribute(attribute:"solution", value:
"Update the affected python-oslo-utils-lang and / or python3-oslo-utils packages.");
