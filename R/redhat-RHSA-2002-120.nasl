...
# extracted from Red Hat Security Advisory RHSA-2002:120. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2002:120");

  script_name(english:"RHEL 2.1 : LPRng (RHSA-2002:120)");
...
spooler IP port; as a result those installations already reject remote
job submissions.
...
NOTE: There are special instructions for installing this update at the
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2002-0378"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2002:120"
  );
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2002/08/09");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"LPRng-3.7.4-28.1")) flag++;
