...
# extracted from Red Hat Security Advisory RHSA-2007:0933. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 : elinks (RHSA-2007:0933)");
...
which contains a backported patch that resolves this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-5034"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0933"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL4", reference:"elinks-0.9.2-3.3.5.2")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"elinks-0.11.1-5.1.0.1.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"elinks-0.11.1-5.1.0.1.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"elinks-0.11.1-5.1.0.1.el5")) flag++;
