...
if (description)
{
  ...
  script_name(english:"RHEL 7 : Virtualization Manager (RHSA-2019:2439)");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"rhvm-appliance-4.3-20190722.0.el7")) flag++;
