...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 8 : AMQ Clients 2.8.0 Release (Moderate) (RHSA-2020:3817)");
...
referenced in the RHSA-2020:3817 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-9488");
  ...
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1831139");
