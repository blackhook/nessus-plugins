...
issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/knowledgebase"
  );
  # http://kbase.redhat.com/faq/FAQ_42_11697.shtm
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/kb/FAQ_42_11697.shtm"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0939"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for RHSA-2007:0939");
  }
  else
  {
