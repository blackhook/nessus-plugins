...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'log4j-1.2.14-6.7.el6_10', 'cpu':'i686', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-1.2.14-6.7.el6_10', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-1.2.14-6.7.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.14-6.7.el6_10', 'cpu':'i686', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.14-6.7.el6_10', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-javadoc-1.2.14-6.7.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.14-6.7.el6_10', 'cpu':'i686', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.14-6.7.el6_10', 'cpu':'s390x', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'log4j-manual-1.2.14-6.7.el6_10', 'cpu':'x86_64', 'release':'6', 'el_string':'el6_10', 'rpm_spec_vers_cmp':TRUE}
    ]
  }
];
