...
# extracted from Red Hat Security Advisory RHSA-2007:0345. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 3 / 4 / 5 : vixie-cron (RHSA-2007:0345)");
...
which contain a backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2007-1856"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2007:0345"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"vixie-cron-4.1-19.EL3")) flag++;


  if (rpm_check(release:"RHEL4", reference:"vixie-cron-4.1-47.EL4")) flag++;


  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"vixie-cron-4.1-70.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"vixie-cron-4.1-70.el5")) flag++;

  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"vixie-cron-4.1-70.el5")) flag++;
