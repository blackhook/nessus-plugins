...
# extracted from Red Hat Security Advisory RHSA-2017:0459. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 / 6 : firefox (RHSA-2017:0459)");
...
Chen, and Nathan Froyd as the original reporters."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2017:0459"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"firefox-45.8.0-2.el5_11", allowmaj:TRUE)) flag++;
  if (rpm_check(release:"RHEL5", reference:"firefox-debuginfo-45.8.0-2.el5_11", allowmaj:TRUE)) flag++;

  if (rpm_check(release:"RHEL6", reference:"firefox-45.8.0-2.el6_8", allowmaj:TRUE)) flag++;
  if (rpm_check(release:"RHEL6", reference:"firefox-debuginfo-45.8.0-2.el6_8", allowmaj:TRUE)) flag++;
