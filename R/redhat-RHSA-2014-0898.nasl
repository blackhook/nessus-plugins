...
if (description)
{
  ...
  script_name(english:"RHEL 4 / 5 / 6 : JBoss EWP (RHSA-2014:0898)");
...
take effect."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2014:0898"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (rpm_check(release:"RHEL4", reference:"picketlink-federation-2.1.5-3_patch_01.ep5.el4")) flag++;
