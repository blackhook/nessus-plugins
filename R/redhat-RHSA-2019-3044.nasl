...
if (description)
{
  ...
  script_name(english:"RHEL 6 : Red Hat Single Sign-On 7.3.4 (RHSA-2019:3044)");
...
listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:3044"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", reference:"rh-sso7-keycloak-4.8.13-1.Final_redhat_00001.1.el6sso")) flag++;
  if (rpm_check(release:"RHEL6", reference:"rh-sso7-keycloak-server-4.8.13-1.Final_redhat_00001.1.el6sso")) flag++;
