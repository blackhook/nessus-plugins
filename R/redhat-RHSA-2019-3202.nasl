...
See:
https://github.com/ansible/ansible/blob/v2.7.14/changelogs/CHANGELOG-v
2.7.rst for details on bug fixes in this release.");
  script_set_attribute(attribute:"see_also", value:"https://github.com/ansible/ansible/blob/v2.7.14/changelogs/");
...
else
{
  ...
  if (rpm_check(release:"RHEL7", reference:"ansible-2.7.14-1.el7")) flag++;
