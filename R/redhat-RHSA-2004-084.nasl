...
# extracted from Red Hat Security Advisory RHSA-2004:084. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:084");

  script_name(english:"RHEL 3 : httpd (RHSA-2004:084)");
...
packages, which contain backported patches that address these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2004-0113"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:084"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2004/03/23");
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"httpd-2.0.46-32.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"httpd-devel-2.0.46-32.ent")) flag++;
  if (rpm_check(release:"RHEL3", reference:"mod_ssl-2.0.46-32.ent")) flag++;
