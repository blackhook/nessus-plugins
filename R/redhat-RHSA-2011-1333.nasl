...
if (description)
{
  ...
  script_bugtraq_id(49710, 49714, 49715, 49716, 49717, 49718);
  script_xref(name:"RHSA", value:"2011:1333");

  script_name(english:"RHEL 5 / 6 : flash-plugin (RHSA-2011:1333)");
...
APSB11-26, listed in the References section.
...
which upgrades Flash Player to version 10.3.183.10."
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2011:1333"
  );
  script_set_attribute(
    attribute:"solution", 
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"flash-plugin-10.3.183.10-1.el5")) flag++;


  if (rpm_check(release:"RHEL6", reference:"flash-plugin-10.3.183.10-1.el6")) flag++;
