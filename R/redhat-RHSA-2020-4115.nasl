...
if (description)
{
  ...
  script_name(english:"RHEL 7 : redhat-release-virtualization-host and redhat-virtualization-host (RHSA-2020:4115)");
...
var constraints = [
  {
    ...
    'pkgs': [
      {'reference':'redhat-virtualization-host-image-update-4.3.11-20200922.0.el7_9', 'release':'7', 'el_string':'el7_9', 'rpm_spec_vers_cmp':TRUE, 'exists_check':'redhat-release-virtualization-host-4'}
    ]
  }
];
