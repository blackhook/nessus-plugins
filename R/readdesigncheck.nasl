...
http://[target]/names.nsf/view?ReadDesign" );
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?06bb48db");
...
a custom error page (e.g., /CustomError)." );
 ...
 script_set_attribute(attribute:"cvss_score_rationale", value:"Score based on analysis of the limited information available");
...
nsf =  get_kb_list('www/', port, '/content/extensions/nsf');
if ( ! isnull(nsf) ) {
	nsf = make_list(nsf);
	file = nsf[0];
	}
