...
# extracted from Red Hat Security Advisory RHSA-2010:0376. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 4 : JBoss EAP (RHSA-2010:0376)");
...
Red Hat Enterprise Linux 4 as JBEAP 4.2.0.CP09.
...
a bug fix included in the RHSA-2009:0346 update re-introduced the
...
upgrade to these updated packages.");
  ...
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2010:0376");
...
else
{
  ...
  if (rpm_check(release:"RHEL4", reference:"jboss-seam-1.2.1-1.ep1.24.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jboss-seam-docs-1.2.1-1.ep1.24.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossas-4.2.0-6.GA_CP09.6.ep1.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossas-4.2.0.GA_CP09-bin-4.2.0-6.GA_CP09.6.ep1.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"jbossas-client-4.2.0-6.GA_CP09.6.ep1.el4")) flag++;
  ...
  if (rpm_check(release:"RHEL4", reference:"rh-eap-docs-4.2.0-7.GA_CP09.ep1.5.el4")) flag++;
  if (rpm_check(release:"RHEL4", reference:"rh-eap-docs-examples-4.2.0-7.GA_CP09.ep1.5.el4")) flag++;
