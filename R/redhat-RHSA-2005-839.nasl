...
# extracted from Red Hat Security Advisory RHSA-2005:839. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 2.1 / 3 / 4 : lynx (RHSA-2005:839)");
...
backported patch to correct this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/security/cve/cve-2005-2929"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2005:839"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL2.1", cpu:"i386", reference:"lynx-2.8.4-18.1.2")) flag++;

  if (rpm_check(release:"RHEL3", reference:"lynx-2.8.5-11.2")) flag++;

  if (rpm_check(release:"RHEL4", reference:"lynx-2.8.5-18.2")) flag++;
