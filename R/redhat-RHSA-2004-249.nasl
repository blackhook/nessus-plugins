...
# extracted from Red Hat Security Advisory RHSA-2004:249. The text 
...
if (description)
{
  ...
  script_xref(name:"RHSA", value:"2004:249");

  script_name(english:"RHEL 3 : libpng (RHSA-2004:249)");
...
backported security fix and are not vulnerable to this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2004:249"
  );
...
{
  flag = 0;
  if (rpm_check(release:"RHEL3", reference:"libpng-1.2.2-24")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libpng-devel-1.2.2-24")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libpng10-1.0.13-14")) flag++;
  if (rpm_check(release:"RHEL3", reference:"libpng10-devel-1.0.13-14")) flag++;
