...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-12861");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2020-12865");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2020:2902");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1850556");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1850598");
...
var constraints = [
  ...
  },
  {
    ...
    'pkgs': [
      {'reference':'sane-backends-1.0.27-19.el8_2.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-daemon-1.0.27-19.el8_2.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-devel-1.0.27-19.el8_2.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-doc-1.0.27-19.el8_2.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-cameras-1.0.27-19.el8_2.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-scanners-1.0.27-19.el8_2.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-libs-1.0.27-19.el8_2.1', 'sp':'4', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
    ...
    'pkgs': [
      {'reference':'sane-backends-1.0.27-19.el8_2.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-daemon-1.0.27-19.el8_2.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-devel-1.0.27-19.el8_2.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-doc-1.0.27-19.el8_2.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-cameras-1.0.27-19.el8_2.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-drivers-scanners-1.0.27-19.el8_2.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE},
      {'reference':'sane-backends-libs-1.0.27-19.el8_2.1', 'sp':'6', 'release':'8', 'rpm_spec_vers_cmp':TRUE}
    ]
  },
  {
    'repo_relative_urls': [
