...
if (description)
{
  ...
  script_name(english:"RHEL 7 / 8 : Ansible security and bug fix update (2.9.23) (Important) (RHSA-2021:2663)");
...
number.");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/security/cve/CVE-2021-3583");
  script_set_attribute(attribute:"see_also", value:"https://access.redhat.com/errata/RHSA-2021:2663");
  script_set_attribute(attribute:"see_also", value:"https://bugzilla.redhat.com/1968412");
