...
# extracted from Red Hat Security Advisory RHSA-2012:1097. The text 
...
if (description)
{
  ...
  script_name(english:"RHEL 5 : glibc (RHSA-2012:1097)");
...
which contain backported patches to fix these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2012:1097"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL5", reference:"glibc-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"glibc-common-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"glibc-common-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"glibc-common-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", reference:"glibc-debuginfo-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"glibc-debuginfo-common-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", reference:"glibc-devel-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"glibc-headers-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"glibc-headers-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"glibc-headers-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"glibc-utils-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"glibc-utils-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"glibc-utils-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"i386", reference:"nscd-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"s390x", reference:"nscd-2.5-81.el5_8.4")) flag++;
  if (rpm_check(release:"RHEL5", cpu:"x86_64", reference:"nscd-2.5-81.el5_8.4")) flag++;
