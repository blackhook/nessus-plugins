...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-accessibility-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-accessibility-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-debugsource-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-debugsource-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-demo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-demo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-demo-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-demo-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-demo-slowdebug-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-devel-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-devel-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-devel-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-devel-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-devel-slowdebug-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-headless-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-headless-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-headless-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-headless-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-headless-slowdebug-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", reference:"java-1.8.0-openjdk-javadoc-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", reference:"java-1.8.0-openjdk-javadoc-zip-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-slowdebug-debuginfo-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"java-1.8.0-openjdk-src-1.8.0.232.b09-0.el8_0")) flag++;

  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"java-1.8.0-openjdk-src-1.8.0.232.b09-0.el8_0")) flag++;
