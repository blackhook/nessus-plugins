...
if (description)
{
  ...
  script_name(english:"RHEL 6 / 7 : Virtualization (RHSA-2018:2404) (Foreshadow)");
...
Hypervisor and Agents Extended Lifecycle Support for Red Hat
Enterprise Linux 7.
...
these issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:2404"
  );
  script_set_attribute(
    attribute:"see_also",
...
else
{
  ...
  if (! (rpm_exists(release:"RHEL6", rpm:"rhev-hypervisor7-") || rpm_exists(release:"RHEL7", rpm:"rhev-hypervisor7-"))) audit(AUDIT_PACKAGE_NOT_INSTALLED, "Virtualization");

  if (rpm_check(release:"RHEL6", reference:"rhev-hypervisor7-7.3-20180813.0.el6")) flag++;

  if (rpm_check(release:"RHEL7", reference:"rhev-hypervisor7-7.3-20180813.0.el7")) flag++;
