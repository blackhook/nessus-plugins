...
reporting this issue."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2018:1456"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"s390x", reference:"dhclient-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"dhclient-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"s390x", reference:"dhcp-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"dhcp-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"s390x", reference:"dhcp-common-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", cpu:"x86_64", reference:"dhcp-common-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", reference:"dhcp-debuginfo-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", reference:"dhcp-devel-4.2.5-47.el7_3.1")) flag++;
  if (rpm_check(release:"RHEL7", sp:"3", reference:"dhcp-libs-4.2.5-47.el7_3.1")) flag++;
