...
if (description)
{
  ...
  script_name(english:"IBM Java 7.1 < 7.1.5.17 / 8.0 < 8.0.8.0 Multiple Vulnerabilities");

  script_set_attribute(attribute:"synopsis", value:
"IBM Java is affected by multiple vulnerabilities.");
  script_set_attribute(attribute:"description", value:
"The version of IBM Java installed on the remote host is prior to 7.1 < 7.1.5.17 / 8.0 < 8.0.8.0. It is, therefore,
affected by multiple vulnerabilities as referenced in the Oracle January 17 2023 CPU advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IJ45272");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IX90193");
  # https://www.ibm.com/support/pages/java-sdk-security-vulnerabilities#Oracle_January_17_2023_CPU
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8ec202a3");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the Oracle January 17 2023 CPU advisory.");
...
var constraints = [
  { 'min_version' : '7.1.0', 'fixed_version' : '7.1.5.17' },
  { 'min_version' : '8.0.0', 'fixed_version' : '8.0.8.0' }
];
