...
if (description)
{
  ...
  script_name(english:"IBM Java 7.0 < 7.0.10.70 / 7.1 < 7.1.4.70 / 8.0 < 8.0.6.15");
...
is, therefore, affected by a vulnerability as referenced in the IBM Security Update August 2020 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IJ26671");
  # https://www.ibm.com/support/pages/java-sdk-security-vulnerabilities#IBM_Security_Update_August_2020
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?31ac8068");
