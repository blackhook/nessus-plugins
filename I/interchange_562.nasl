...
the application fails to limit access from its search functions.");
  script_set_attribute(attribute:"see_also", value:"http://ftp.icdevgroup.org/interchange/5.6/ANNOUNCEMENT-5.6.2.txt");
  script_set_attribute(attribute:"see_also", value:"http://www.icdevgroup.org/i/dev/news?mv_arg=00038");
