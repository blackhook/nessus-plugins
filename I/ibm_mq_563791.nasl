...
if (description)
{
  ...
  script_cve_id("CVE-2017-1760");

  script_name(english:"IBM MQ 7.5 <= 7.5.0.8 / 8.0 <= 8.0.0.6 / 9.0 <= 9.0.0.1 LTS / 9.0.1 <= 9.0.3  CD (563791)");
...
9.0 could allow a local user to crash the queue manager agent thread and expose some sensitive information. IBM X-Force
ID: 126454.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/563791");
  script_set_attribute(attribute:"solution", value:
"Upgrade to IBM MQ 8.0.0.7, 9.0.4 CD, 9.0.0.2 or later. Alternatively, install the interim fix for APAR IT20398 where appropriate.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-1760");
...
{
  constraints = [
    { 'min_version' : '9.0.1', 'max_version' : '9.0.3', 'fixed_display' : '9.0.4'}
  ];
}
else
{
  constraints = [
    { 'min_version' : '7.5', 'max_version' : '7.5.0.8', 'fixed_display' : 'APAR IT20398'},
    { 'min_version' : '8.0', 'max_version' : '8.0.0.6', 'fixed_version' : '8.0.0.7'},
    { 'min_version' : '9.0', 'max_version' : '9.0.0.1', 'fixed_version' : '9.0.0.2'}
  ];
}
