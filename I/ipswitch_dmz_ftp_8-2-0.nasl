...
if (description)
{
  ...
  script_cve_id("CVE-2015-7675", "CVE-2015-7677", "CVE-2015-7680");
  script_bugtraq_id(83191, 83196, 83198);
...
prior to 8.2. It is, therefore, affected by multiple vulnerabilities :
  ...
  # https://docs.ipswitch.com/MOVEit/DMZ82/ReleaseNotes/MOVEitReleaseNotes82.pdf
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?3520757f");
  script_set_attribute(attribute:"see_also", value:"https://seclists.org/fulldisclosure/2016/Jan/95");
...
"Upgrade to Ipswitch MOVEit DMZ version 8.2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2015-7680");
