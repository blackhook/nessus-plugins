...
total control of the machine.");
  # https://en.wikipedia.org/wiki/IBM_Remote_Supervisor_Adapter#Default_Password
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1d40069a");
