...
control.");
  # https://www.ibm.com/blogs/psirt/ibm-security-bulletin-ibm-spss-samplepower-vsflex8l-activex-control-combolist-property-remote-code-execution-vulnerability-cve-2014-0895/
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8785a03e");
...
"Upgrade to IBM SPSS SamplePower 3.0.1 IF 2 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2014-0895");
