...
if (description)
{
  ...
  script_name(english:"iLO 3 < 1.88 / iLO 4 < 2.44 XSS Vulnerability");
...
code in a user's browser session.");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4ec97475");
  script_set_attribute(attribute:"solution", value:
"For iLO 3, upgrade firmware to 1.88 or later. For iLO 4, upgrade firmware to 2.44 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-4406");
...
var constraints = [
  {'generation' : '3', 'fixed_version' : '1.88'}, 
  {'generation' : '4', 'fixed_version' : '2.44'}
];
