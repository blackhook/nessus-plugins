...
if (description)
{
  ...
  script_cve_id("CVE-2016-0269", "CVE-2016-0293");
  script_bugtraq_id(91690, 92593);

  script_name(english:"IBM BigFix Server 9.1.x < 9.1.1275.0 Multiple XSS");
...
"According to its self-reported version, the IBM BigFix Server running
on the remote host is version 9.1.x prior to 9.1.1275.0. It is,
therefore, affected by multiple vulnerabilities :

  - A reflected cross-site scripting (XSS) vulnerability
    exists in the BES gather function due to improper
    validation of input before returning it to users. An
    unauthenticated, remote attacker can exploit this, via a
    specially crafted URL, to execute arbitrary script code
    in a user's browser session. (CVE-2016-0269)

  - A reflected cross-site scripting vulnerability exists
    when handling .beswrpt files due to improper validation
    of input before returning it to users. An
    unauthenticated, remote attacker can exploit this, via a
    specially crafted URL, to execute arbitrary script code
    in a user's browser session. (CVE-2016-0293)
...
"Upgrade to IBM BigFix Server version 9.1.1275.0 or later.");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:C/C:L/I:L/A:N");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-0293");
