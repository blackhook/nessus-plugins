...
if (description)
{
  ...
  script_name(english:"IBM InfoSphere Data Replication Dashboard Unpassworded User Enumeration");
  script_summary(english:"Gets a list of users");

  script_set_attribute(attribute:"synopsis", value:
"It is possible to enumerate the list of users that do not require
authentication for a web application hosted on the remote host.");
  script_set_attribute(attribute:"description", value:
"The version of IBM InfoSphere Data Replication Dashboard hosted on the
remote web server displays its list of users that can authenticate
without using a password.  A remote, unauthenticated attacker could use
this information to gain unauthorized access to the application.");
...
10.2.0.0-b113 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2013-0584");
...
url = install['dir'] + '/getUsers.do?no_pd=YES';
...
{
  trailer =
    'Which returned the following list of users that can login without\n' +
    'a password :\n';
