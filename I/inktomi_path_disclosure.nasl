...
#
# Changes by Tenable:
# - Revised plugin title, minor fixes to description (1/13/2009)
...
an attacker." );
 script_set_attribute(attribute:"see_also", value:"https://www.corsaire.com/404/" );
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 2004-2021 Westpoint Limited and Corsaire Limited");
...
port = get_http_port(default:8765, embedded:TRUE);
