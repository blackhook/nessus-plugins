...
if (description)
{
  ...
  script_xref(name:"IAVA", value:"2016-A-0335-S");
...
to affect all previous versions.");
  # https://docs.ipswitch.com/NM/63_WhatsUpGoldv165/01_ReleaseNotes/index.htm
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?26923871");
  script_set_attribute(attribute:"see_also", value:"https://www.tenable.com/security/research/tra-2016-15");
...
"Upgrade to Ipswitch WhatsUp Gold version 16.5.0 or later.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2016-1000000");
...
if (ver_compare(ver:ver_ui, fix:fix, strict:FALSE) == -1)
{
