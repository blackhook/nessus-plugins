...
if (description)
{
  ...
  script_cve_id("CVE-2019-4261");

  script_name(english:"IBM MQ 7.1 <= 7.1.0.9 / 7.5 <= 7.5.0.9 / 8.0 <= 8.0.0.11 / 9.0 <= 9.0.0.6 LTS / 9.1 <= 9.1.0.2 LTS / 9.1 <= 9.1.2 CD (886887)");

  script_set_attribute(attribute:"synopsis", value:
"The remote web server is affected by a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM MQ Server running on the remote host is affected by a vulnerability. IBM WebSphere MQ V7.1, 7.5, IBM
MQ V8, IBM MQ V9.0LTS, IBM MQ V9.1 LTS, and IBM MQ V9.1 CD are vulnerable to a denial of service attack caused by
specially crafted messages. IBM X-Force ID: 160013.

Note that Nessus has not tested for this issue but has instead relied only on the application's self-reported version
number.");
  script_set_attribute(attribute:"see_also", value:"https://www.ibm.com/support/pages/node/886887");
  script_set_attribute(attribute:"solution", value:
"Upgrade to IBM MQ 8.0.0.12, 9.0.0.7, 9.1.0.3, 9.1.3 or later. Alternatively, install APAR IT25916 where appropriate.");
  script_set_attribute(attribute:"agent", value:"all");
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:S/C:N/I:N/A:P");
  script_set_cvss_temporal_vector("CVSS2#E:U/RL:OF/RC:C");
  script_set_cvss3_base_vector("CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_set_cvss3_temporal_vector("CVSS:3.0/E:U/RL:O/RC:C");
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2019-4261");
...
{
  constraints = [
    { 'min_version' : '9.1', 'max_version': '9.1.2', 'fixed_version' : '9.1.3'}
  ];
}
else
{
  constraints = [
    { 'min_version' : '7.1', 'max_version' : '7.1.0.9', 'fixed_display' : 'APAR IT25916'},
    { 'min_version' : '7.5', 'max_version' : '7.5.0.9', 'fixed_display' : 'APAR IT25916'},
