...
Note that this plugin does not run over IPv6.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2002-1623");
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?8d6444d2");
  script_set_attribute(attribute:"see_also", value:"https://www.ernw.de/download/pskattack.pdf");
  # https://web.archive.org/web/20131031201444/http://www.vpnc.org/ietf-ipsec/99.ipsec/msg01451.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d77bc12e");
  script_set_attribute(attribute:"see_also", value:"https://www.securityfocus.com/bid/7423");
...
var hash_list     = make_list(IKE1_HASH_SHA1, IKE1_HASH_MD5, IKE1_HASH_SHA2_256, IKE1_HASH_SHA2_384, IKE1_HASH_SHA2_512);
 

var group_list  = make_list(IKE_GROUP_MODP_768,  IKE_GROUP_MODP_1024, IKE_GROUP_MODP_1536, 
...
#
var group, proposal, sa, x, dh_x, ke, nonce, id, payloads, icookie, rcookie, hdr, res, ret;
foreach group (group_list)
{
  ...
  # debugging
  dbg::log(src:SCRIPT_NAME, msg:'hrdr =\n' + obj_rep(hdr) + '\n' );
