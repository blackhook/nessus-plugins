...
if (description)
{
  ...
  script_xref(name:"MSKB", value:"234905");
...
execution.");
  script_set_attribute(attribute:"see_also", value:"https://docs.microsoft.com/en-us/security-updates/SecurityBulletins/1999/ms99-019");
...
"Apply the patch from the bulletin referenced above.");
  ...
  script_copyright(english:"This script is Copyright (C) 1999-2022 Tenable Network Security, Inc. / Modifications by HD Moore <hdmoore@digitaldefense.net>");

  script_dependencies("find_service1.nasl", "www_too_long_url.nasl", "http_version.nasl", "www_fingerprinting_hmap.nasl");
