...
if (description)
{
  ...
  script_cve_id("CVE-2020-27221");

  script_name(english:"IBM Java 7.1 < 7.1.4.80 / 8.0 < 8.0.6.25 / 11.0 < 11.0.10.0");

  script_set_attribute(attribute:"synopsis", value:
"IBM Java is affected a vulnerability.");
  script_set_attribute(attribute:"description", value:
"The version of IBM Java installed on the remote host is prior to 7.1 < 7.1.4.80 / 8.0 < 8.0.6.25 / 11.0 < 11.0.10.0. It
is, therefore, affected by a vulnerability as referenced in the IBM Security Update February 2021 advisory.
...
number.");
  script_set_attribute(attribute:"see_also", value:"http://www-01.ibm.com/support/docview.wss?uid=swg1IJ29698");
  # https://www.ibm.com/support/pages/java-sdk-security-vulnerabilities#IBM_Security_Update_February_2021
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?60c5bfb2");
  script_set_attribute(attribute:"solution", value:
"Apply the appropriate patch according to the IBM Security Update February 2021 advisory.");
...
var constraints = [
  ...
  { 'min_version' : '11.0.0', 'fixed_version' : '11.0.10.0' }
];
