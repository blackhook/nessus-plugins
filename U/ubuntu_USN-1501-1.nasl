...
# extracted from Ubuntu Security Notice USN-1501-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(54388);
  script_xref(name:"USN", value:"1501-1");

  script_name(english:"Ubuntu 12.04 LTS : nova vulnerability (USN-1501-1)");
...
instance lookup calls based on passed scheduler hints. An
authenticated attacker could use this to cause a denial of service.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1501-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"python-nova", pkgver:"2012.1+stable~20120612-3ee026e-0ubuntu1.2")) flag++;
