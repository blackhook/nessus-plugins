...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : Zsh vulnerabilities (USN-3608-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3608-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"zsh", pkgver:"5.0.2-3ubuntu6.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"zsh", pkgver:"5.1.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"zsh", pkgver:"5.2-5ubuntu1.2")) flag++;
