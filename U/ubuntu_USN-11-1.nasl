...
# extracted from Ubuntu Security Notice USN-11-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : libgd2 vulnerabilities (USN-11-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"libgd-tools", pkgver:"2.0.23-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd2", pkgver:"2.0.23-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd2-dev", pkgver:"2.0.23-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd2-noxpm", pkgver:"2.0.23-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd2-noxpm-dev", pkgver:"2.0.23-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd2-xpm", pkgver:"2.0.23-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd2-xpm-dev", pkgver:"2.0.23-2ubuntu0.1")) flag++;
