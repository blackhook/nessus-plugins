...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : X.Org X Server vulnerabilities (USN-4488-1)");
...
the input extension protocol. A local attacker could possibly use this
issue to escalate privileges. (CVE-2020-14346) Jan-Niklas Sohn
discovered that the X.Org X Server incorrectly initialized memory. A
local attacker could possibly use this issue to obtain sensitive
information. (CVE-2020-14347) Jan-Niklas Sohn discovered that the
X.Org X Server incorrectly handled the XkbSelectEvents function. A
local attacker could possibly use this issue to escalate privileges.
(CVE-2020-14361) Jan-Niklas Sohn discovered that the X.Org X Server
incorrectly handled the XRecordRegisterClients function. A local
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4488-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Update the affected xserver-xorg-core, xserver-xorg-core-hwe-16.04 and
/ or xserver-xorg-core-hwe-18.04 packages."
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"xserver-xorg-core", pkgver:"2:1.18.4-0ubuntu0.9")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"xserver-xorg-core-hwe-16.04", pkgver:"2:1.19.6-1ubuntu4.1~16.04.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"xserver-xorg-core", pkgver:"2:1.19.6-1ubuntu4.5")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"xserver-xorg-core-hwe-18.04", pkgver:"2:1.20.8-2ubuntu2.2~18.04.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"xserver-xorg-core", pkgver:"2:1.20.8-2ubuntu2.3")) flag++;
