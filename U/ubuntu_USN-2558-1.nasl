...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : mailman vulnerability (USN-2558-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2558-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"mailman", pkgver:"1:2.1.14-3ubuntu0.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"mailman", pkgver:"1:2.1.16-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"mailman", pkgver:"1:2.1.18-1ubuntu0.1")) flag++;
