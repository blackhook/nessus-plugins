...
# extracted from Ubuntu Security Notice USN-1142-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1142-1");

  script_name(english:"Ubuntu 11.04 : gdm vulnerability (USN-1142-1)");
  ...
  script_set_attribute(
    ...
    value:
"Henne Vogelsang discovered that under certain PolicyKit
configurations, GDM could be made to launch a browser. A local
attacker could exploit this to gain access to files with the
privileges of the gdm user. PolicyKit is not configured in this manner
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1142-1/"
  );
...
if (ubuntu_check(osver:"11.04", pkgname:"gdm", pkgver:"2.32.1-0ubuntu3.2")) flag++;
