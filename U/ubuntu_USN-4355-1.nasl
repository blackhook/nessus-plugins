...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : PulseAudio vulnerability (USN-4355-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4355-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected pulseaudio package."
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"pulseaudio", pkgver:"1:8.0-0ubuntu3.12")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"pulseaudio", pkgver:"1:11.1-1ubuntu7.7")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"pulseaudio", pkgver:"1:13.0-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"pulseaudio", pkgver:"1:13.99.1-1ubuntu3.2")) flag++;
