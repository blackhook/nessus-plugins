...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : zsh vulnerabilities (USN-3593-1)");
...
variables. An attacker could possibly use this issue to gain
privileged access to the system. This issue only affected Ubuntu 14.04
LTS. (CVE-2014-10070)
...
only affected Ubuntu 14.04 LTS. (CVE-2014-10071)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3593-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"zsh", pkgver:"5.0.2-3ubuntu6.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"zsh", pkgver:"5.1.1-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"zsh", pkgver:"5.2-5ubuntu1.1")) flag++;
