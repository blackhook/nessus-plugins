...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : usb-creator vulnerability (USN-2576-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2576-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"usb-creator-common", pkgver:"0.2.38.3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"usb-creator-common", pkgver:"0.2.56.3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"usb-creator-common", pkgver:"0.2.62ubuntu0.3")) flag++;
