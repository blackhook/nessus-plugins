...
# extracted from Ubuntu Security Notice USN-234-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 / 5.10 : cpio vulnerability (USN-234-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"cpio", pkgver:"2.5-1.1ubuntu0.3")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"cpio", pkgver:"2.5-1.1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"cpio", pkgver:"2.5-1.2ubuntu1.1")) flag++;
