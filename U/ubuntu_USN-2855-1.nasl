...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : samba vulnerabilities (USN-2855-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2855-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"samba", pkgver:"2:3.6.3-2ubuntu2.13")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"samba", pkgver:"2:4.1.6+dfsg-1ubuntu2.14.04.11")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"samba", pkgver:"2:4.1.13+dfsg-4ubuntu3.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"samba", pkgver:"2:4.1.17+dfsg-4ubuntu3.1")) flag++;
