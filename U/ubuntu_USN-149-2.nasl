...
# extracted from Ubuntu Security Notice USN-149-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 : mozilla-firefox regressions (USN-149-2)");
...
if (ubuntu_check(osver:"5.04", pkgname:"mozilla-firefox", pkgver:"1.0.6-0ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"mozilla-firefox-dev", pkgver:"1.0.6-0ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"mozilla-firefox-dom-inspector", pkgver:"1.0.6-0ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"mozilla-firefox-gnome-support", pkgver:"1.0.6-0ubuntu0.1")) flag++;
