...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-3911-1 fixed vulnerabilities in file. One of the backported
security fixes introduced a regression that caused the interpreter
string to be truncated. This update fixes the problem.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3911-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"file", pkgver:"1:5.25-2ubuntu1.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libmagic1", pkgver:"1:5.25-2ubuntu1.4")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"file", pkgver:"1:5.32-2ubuntu0.4")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libmagic1", pkgver:"1:5.32-2ubuntu0.4")) flag++;
