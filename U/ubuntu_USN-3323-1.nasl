...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 / 17.04 : eglibc, glibc vulnerability (USN-3323-1) (Stack Clash)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3323-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"libc6", pkgver:"2.19-0ubuntu6.13")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libc6", pkgver:"2.23-0ubuntu9")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"libc6", pkgver:"2.24-3ubuntu2.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libc6", pkgver:"2.24-9ubuntu2.2")) flag++;
