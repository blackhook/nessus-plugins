...
# extracted from Ubuntu Security Notice USN-3199-3. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3199-3");

  script_name(english:"Ubuntu 12.04 LTS : python-crypto vulnerability (USN-3199-3)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3199-3/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"12.04", pkgname:"python-crypto", pkgver:"2.4.1-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python3-crypto", pkgver:"2.4.1-1ubuntu0.2")) flag++;
