...
# extracted from Ubuntu Security Notice USN-2149-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 : gtk+3.0 update (USN-2149-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2149-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libgtk-3-0", pkgver:"3.4.2-0ubuntu0.7")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libgtk-3-0", pkgver:"3.6.0-0ubuntu3.3")) flag++;
