...
# extracted from Ubuntu Security Notice USN-252-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 / 5.10 : gnupg vulnerability (USN-252-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"gnupg", pkgver:"1.2.4-4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"gnupg", pkgver:"1.2.5-3ubuntu5.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"gnupg", pkgver:"1.4.1-1ubuntu1.1")) flag++;
