...
# extracted from Ubuntu Security Notice USN-1179-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1179-1");

  script_name(english:"Ubuntu 11.04 : clamav vulnerability (USN-1179-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that the hash processing code in libclamav
improperly handled messages with certain hashes. This could allow a
remote attacker to craft a document that could cause clamav to crash,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1179-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.04", pkgname:"libclamav6", pkgver:"0.97+dfsg-2ubuntu1.1")) flag++;
