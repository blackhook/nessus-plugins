...
# extracted from Ubuntu Security Notice USN-638-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.10 / 8.04 LTS : yelp vulnerability (USN-638-1)");
...
user were tricked into opening a specially crafted URI, a remote
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/638-1/"
  );
...
if (ubuntu_check(osver:"7.10", pkgname:"yelp", pkgver:"2.20.0-0ubuntu3.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"yelp", pkgver:"2.22.1-0ubuntu2.8.04.3")) flag++;
