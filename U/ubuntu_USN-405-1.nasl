...
# extracted from Ubuntu Security Notice USN-405-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(21903);
  script_xref(name:"USN", value:"405-1");

  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : fetchmail vulnerability (USN-405-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/405-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"5.10", pkgname:"fetchmail", pkgver:"6.2.5-13ubuntu3.3")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"fetchmail-ssl", pkgver:"6.2.5-13ubuntu3.3")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"fetchmailconf", pkgver:"6.2.5-13ubuntu3.3")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"fetchmail", pkgver:"6.3.2-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"fetchmailconf", pkgver:"6.3.2-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"fetchmail", pkgver:"6.3.4-1ubuntu4.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"fetchmailconf", pkgver:"6.3.4-1ubuntu4.1")) flag++;
