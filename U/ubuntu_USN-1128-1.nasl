...
# extracted from Ubuntu Security Notice USN-1128-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 10.10 / 11.04 : vino vulnerabilities (USN-1128-1)");
...
framebuffer requests. A remote attacker could use this flaw to cause
Vino to crash, leading to a denial of service.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1128-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"vino", pkgver:"2.22.2-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"vino", pkgver:"2.28.2-0ubuntu2.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"vino", pkgver:"2.32.0-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"vino", pkgver:"2.32.1-0ubuntu2.1")) flag++;
