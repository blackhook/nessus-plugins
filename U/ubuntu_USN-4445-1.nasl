...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : Ghostscript vulnerability (USN-4445-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4445-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"20.04", pkgname:"ghostscript", pkgver:"9.50~dfsg-5ubuntu4.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libgs9", pkgver:"9.50~dfsg-5ubuntu4.1")) flag++;
