...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : libjpeg-turbo vulnerability (USN-4386-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4386-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libjpeg-turbo8", pkgver:"1.4.2-0ubuntu3.4")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libjpeg-turbo8", pkgver:"1.5.2-0ubuntu5.18.04.4")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libjpeg-turbo8", pkgver:"2.0.3-0ubuntu1.19.10.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libjpeg-turbo8", pkgver:"2.0.3-0ubuntu1.20.04.1")) flag++;
