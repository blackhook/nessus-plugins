...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : File Roller vulnerability (USN-4332-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4332-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"20.04", pkgname:"file-roller", pkgver:"3.36.1-1ubuntu0.1")) flag++;
