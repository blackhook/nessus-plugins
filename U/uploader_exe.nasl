...
arbitrary CGI and then execute them.");
 script_set_attribute(attribute:"see_also", value:"https://insecure.org/sploits/oreily.website.uploader.exe.html");
 script_set_attribute(attribute:"see_also", value:"http://web.archive.org/web/20070810043351/http://xforce.iss.net:80/xforce/xfdb/294");
