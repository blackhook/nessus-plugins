...
# extracted from Ubuntu Security Notice USN-1659-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1659-1");

  script_name(english:"Ubuntu 10.04 LTS / 11.10 / 12.04 LTS / 12.10 : gimp vulnerability (USN-1659-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that GIMP incorrectly handled malformed XWD files.
If a user were tricked into opening a specially crafted XWD file, an
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1659-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"gimp", pkgver:"2.6.8-2ubuntu1.6")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"gimp", pkgver:"2.6.11-2ubuntu4.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"gimp", pkgver:"2.6.12-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"gimp", pkgver:"2.8.2-1ubuntu1.1")) flag++;
