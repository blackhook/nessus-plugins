...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.10 : OpenJDK vulnerability (USN-3875-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3875-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jdk", pkgver:"8u191-b12-2ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre", pkgver:"8u191-b12-2ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-headless", pkgver:"8u191-b12-2ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-jamvm", pkgver:"8u191-b12-2ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"openjdk-11-jdk", pkgver:"11.0.1+13-3ubuntu3.18.10.1")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"openjdk-11-jre", pkgver:"11.0.1+13-3ubuntu3.18.10.1")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"openjdk-11-jre-headless", pkgver:"11.0.1+13-3ubuntu3.18.10.1")) flag++;
