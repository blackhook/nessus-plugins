...
if (machine_kernel_release)
{
  ...
  if (preg(pattern:"^16.04$", string:os_release)) {
    kernel_pattern = "^(4.15.0-\d+-aws)$";
    kernel_mappings = {
            "4.15.0-\d+-aws" : "4.15.0-1156"
    };
  };
  if (preg(pattern:"^18.04$", string:os_release)) {
    kernel_pattern = "^4.15.0-\d+-(aws|generic|generic-lpae|kvm|lowlatency)$";
    kernel_mappings = {
            "4.15.0-\d+(-generic|-generic-lpae|-lowlatency)" : "4.15.0-211",
            "4.15.0-\d+-aws" : "4.15.0-1156",
            "4.15.0-\d+-kvm" : "4.15.0-1140"
    };
  };
