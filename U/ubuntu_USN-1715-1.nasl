...
# extracted from Ubuntu Security Notice USN-1715-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(57747);
  script_xref(name:"USN", value:"1715-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 : keystone vulnerability (USN-1715-1)");
...
validation when handling certain error conditions. An unauthenticated
user could exploit this to cause a denial of service in Keystone API
servers via disk space exhaustion.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1715-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"python-keystone", pkgver:"2012.1+stable~20120824-a16a0ab9-0ubuntu2.4")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"python-keystone", pkgver:"2012.2.1-0ubuntu1.1")) flag++;
