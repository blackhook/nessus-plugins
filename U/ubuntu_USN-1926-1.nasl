...
# extracted from Ubuntu Security Notice USN-1926-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.04 : spice vulnerability (USN-1926-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1926-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.04", pkgname:"libspice-server1", pkgver:"0.12.2-0nocelt2expubuntu1.1")) flag++;
