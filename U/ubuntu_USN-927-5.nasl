...
# extracted from Ubuntu Security Notice USN-927-5. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS : nspr update (USN-927-5)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/927-5/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"8.04", pkgname:"libnspr4-0d", pkgver:"4.8-0ubuntu0.8.04.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libnspr4-0d-dbg", pkgver:"4.8-0ubuntu0.8.04.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libnspr4-dev", pkgver:"4.8-0ubuntu0.8.04.1")) flag++;
