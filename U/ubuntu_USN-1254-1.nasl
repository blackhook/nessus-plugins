...
# extracted from Ubuntu Security Notice USN-1254-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : thunderbird vulnerabilities (USN-1254-1)");
...
privilege escalation in addons, also affected Thunderbird 3.1. An
attacker could potentially exploit a user who had installed an add-on
that used loadSubscript in vulnerable ways. (CVE-2011-3647)
...
would potentially allow an attacker to remotely crash Thunderbird.
(CVE-2011-3650).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1254-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"thunderbird", pkgver:"3.1.16+build2+nobinonly-0ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"thunderbird", pkgver:"3.1.16+build2+nobinonly-0ubuntu0.10.10.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"thunderbird", pkgver:"3.1.16+build2+nobinonly-0ubuntu0.11.04.1")) flag++;
