...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.04 : libmspack vulnerabilities (USN-3394-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3394-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libmspack0", pkgver:"0.5-1ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libmspack0", pkgver:"0.5-1ubuntu0.17.04.1")) flag++;
