...
{
  if (! preg(pattern:"^(5.19.0-\d+-(aws|azure|generic|generic-64k|generic-lpae|kvm|lowlatency|lowlatency-64k|oracle|raspi|raspi-nolpae))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.19.0-\d+(-aws|-azure)" : "5.19.0-1022",
    "5.19.0-\d+(-generic|-generic-64k|-generic-lpae)" : "5.19.0-38",
    "5.19.0-\d+(-lowlatency|-lowlatency-64k)" : "5.19.0-1021",
    "5.19.0-\d+(-raspi|-raspi-nolpae)" : "5.19.0-1015",
    "5.19.0-\d+-kvm" : "5.19.0-1020",
    "5.19.0-\d+-oracle" : "5.19.0-1019"
  };
