...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 20.10 : Python vulnerability (USN-4973-1)");
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'idle-python3.8', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'libpython3.8', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'libpython3.8-dev', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'libpython3.8-minimal', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'libpython3.8-stdlib', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'libpython3.8-testsuite', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'python3.8', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'python3.8-dev', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'python3.8-examples', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'python3.8-minimal', 'pkgver': '3.8.6-1ubuntu0.3'},
    {'osver': '20.10', 'pkgname': 'python3.8-venv', 'pkgver': '3.8.6-1ubuntu0.3'}
];
