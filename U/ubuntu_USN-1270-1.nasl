...
# extracted from Ubuntu Security Notice USN-1270-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.10 / 11.04 / 11.10 : software-center vulnerability (USN-1270-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1270-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected software-center package."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:software-center");
...
if (ubuntu_check(osver:"10.10", pkgname:"software-center", pkgver:"3.0.10ubuntu0.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"software-center", pkgver:"4.0.5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"software-center", pkgver:"5.0.2ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "software-center");
}
