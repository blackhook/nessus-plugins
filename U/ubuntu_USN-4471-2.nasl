...
regression making nsExtendCacheTime not settable. This update fixes
the problem adding the cacheTime feature flag.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4471-2/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"libsnmp-base", pkgver:"5.7.3+dfsg-1ubuntu4.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libsnmp-perl", pkgver:"5.7.3+dfsg-1ubuntu4.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libsnmp30", pkgver:"5.7.3+dfsg-1ubuntu4.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"snmpd", pkgver:"5.7.3+dfsg-1ubuntu4.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libsnmp-base", pkgver:"5.7.3+dfsg-1.8ubuntu3.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libsnmp-perl", pkgver:"5.7.3+dfsg-1.8ubuntu3.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libsnmp30", pkgver:"5.7.3+dfsg-1.8ubuntu3.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"snmpd", pkgver:"5.7.3+dfsg-1.8ubuntu3.6")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libsnmp-base / libsnmp-perl / libsnmp30 / snmpd");
}
