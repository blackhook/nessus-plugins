...
# extracted from Ubuntu Security Notice USN-675-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.10 / 8.04 LTS : pidgin vulnerabilities (USN-675-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/675-1/"
  );
...
if (ubuntu_check(osver:"7.10", pkgname:"finch", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"finch-dev", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"gaim", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"libpurple-bin", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"libpurple-dev", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"libpurple0", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"pidgin", pkgver:"1:2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"pidgin-data", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"pidgin-dbg", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"pidgin-dev", pkgver:"2.2.1-1ubuntu4.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"finch", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"finch-dev", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"gaim", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libpurple-bin", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libpurple-dev", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libpurple0", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"pidgin", pkgver:"1:2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"pidgin-data", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"pidgin-dbg", pkgver:"2.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"pidgin-dev", pkgver:"2.4.1-1ubuntu2.2")) flag++;
