...
# extracted from Ubuntu Security Notice USN-1833-1. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2013-1929", "CVE-2013-1979", "CVE-2013-3301");
  script_bugtraq_id(58908, 59055, 59538);
  script_xref(name:"USN", value:"1833-1");

  script_name(english:"Ubuntu 12.04 LTS : linux vulnerabilities (USN-1833-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1833-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2013-1929", "CVE-2013-1979", "CVE-2013-3301");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1833-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-44-generic", pkgver:"3.2.0-44.69")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-44-generic-pae", pkgver:"3.2.0-44.69")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-44-highbank", pkgver:"3.2.0-44.69")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-44-virtual", pkgver:"3.2.0-44.69")) flag++;
