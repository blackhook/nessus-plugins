...
# extracted from Ubuntu Security Notice USN-1342-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS : linux-lts-backport-oneiric vulnerability (USN-1342-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1342-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1342-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-generic", pkgver:"3.0.0-15.26~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-generic-pae", pkgver:"3.0.0-15.26~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-server", pkgver:"3.0.0-15.26~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-virtual", pkgver:"3.0.0-15.26~lucid1")) flag++;
