...
# extracted from Ubuntu Security Notice USN-167-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 : awstats vulnerability (USN-167-1)");
...
if (ubuntu_check(osver:"5.04", pkgname:"awstats", pkgver:"6.3-1ubuntu0.1")) flag++;
