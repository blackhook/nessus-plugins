...
# extracted from Ubuntu Security Notice USN-1157-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.04 : mozvoikko, ubufox, webfav update (USN-1157-2)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-1157-1 fixed vulnerabilities in Firefox. This update provides
updated packages for use with Firefox 5.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1157-2/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"11.04", pkgname:"xul-ext-mozvoikko", pkgver:"1.9.0~svn20101114r3591-0ubuntu3.11.04.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"xul-ext-ubufox", pkgver:"0.9.1-0ubuntu0.11.04.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"xul-ext-webfav", pkgver:"1.17-0ubuntu5.1")) flag++;
