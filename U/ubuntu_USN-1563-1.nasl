...
# extracted from Ubuntu Security Notice USN-1563-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS : linux-lts-backport-oneiric vulnerability (USN-1563-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1563-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2012-2372");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1563-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-25-generic", pkgver:"3.0.0-25.41~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-25-generic-pae", pkgver:"3.0.0-25.41~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-25-server", pkgver:"3.0.0-25.41~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-25-virtual", pkgver:"3.0.0-25.41~lucid1")) flag++;
