...
# extracted from Ubuntu Security Notice USN-3212-4. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3212-4");

  script_name(english:"Ubuntu 12.04 LTS : tiff vulnerabilities (USN-3212-4)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-3212-1 fixed several issues in LibTIFF. This update provides a
subset of corresponding update for Ubuntu 12.04 ESM.
...
It was discovered that LibTIFF is vulnerable to a heap buffer overflow
in the resulting in DoS or code execution via a crafted BitsPerSample
value. (CVE-2017-5225)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3212-4/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"12.04", pkgname:"libtiff-tools", pkgver:"3.9.5-2ubuntu1.11")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libtiff4", pkgver:"3.9.5-2ubuntu1.11")) flag++;
