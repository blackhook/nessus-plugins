...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 : Python Crypto vulnerability (USN-3199-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3199-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"python-crypto", pkgver:"2.6.1-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"python3-crypto", pkgver:"2.6.1-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-crypto", pkgver:"2.6.1-6ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-crypto", pkgver:"2.6.1-6ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"python-crypto", pkgver:"2.6.1-6ubuntu0.16.10.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"python3-crypto", pkgver:"2.6.1-6ubuntu0.16.10.2")) flag++;
