...
# extracted from Ubuntu Security Notice USN-2273-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2273-1");

  script_name(english:"Ubuntu 13.10 : linux vulnerability (USN-2273-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2273-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2273-1");
  }
  else
  {
...
if (ubuntu_check(osver:"13.10", pkgname:"linux-image-3.11.0-24-generic", pkgver:"3.11.0-24.42")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"linux-image-3.11.0-24-generic-lpae", pkgver:"3.11.0-24.42")) flag++;
