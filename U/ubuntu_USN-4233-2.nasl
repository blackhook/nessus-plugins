...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"USN-4233-1 disabled SHA1 being used for digital signature operations
in GnuTLS. In certain network environments, certificates using SHA1
may still be in use. This update adds the %VERIFY_ALLOW_BROKEN and
...
As a security improvement, this update marks SHA1 as being untrusted
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4233-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libgnutls30", pkgver:"3.4.10-4ubuntu1.7")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libgnutls30", pkgver:"3.5.18-1ubuntu1.3")) flag++;
