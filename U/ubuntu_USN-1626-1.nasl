...
# extracted from Ubuntu Security Notice USN-1626-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 : glance vulnerability (USN-1626-1)");
  ...
  script_set_attribute(
    ...
    value:
"Gabe Westmaas discovered that Glance did not always properly enforce
access controls when deleting images. An authenticated user could
delete arbitrary images by using the v1 API under certain
circumstances.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1626-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"python-glance", pkgver:"2012.1.3+stable~20120821-120fcf-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"python-glance", pkgver:"2012.2-0ubuntu2.2")) flag++;
