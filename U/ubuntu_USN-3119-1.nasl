...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 16.04 LTS / 16.10 : bind9 vulnerability (USN-3119-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3119-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"bind9", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.19")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-3ubuntu0.10")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-8ubuntu1.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-10.1ubuntu1.1")) flag++;
