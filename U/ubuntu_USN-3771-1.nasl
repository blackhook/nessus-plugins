...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3771-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libstrongswan", pkgver:"5.1.2-0ubuntu2.10")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"strongswan", pkgver:"5.1.2-0ubuntu2.10")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libstrongswan", pkgver:"5.3.5-1ubuntu3.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"strongswan", pkgver:"5.3.5-1ubuntu3.7")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libstrongswan", pkgver:"5.6.2-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"strongswan", pkgver:"5.6.2-1ubuntu2.2")) flag++;
