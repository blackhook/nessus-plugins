...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : Net-SNMP vulnerability (USN-4410-1)");
...
user could potentially cause a DoS by sending a crafted request to the
server. (CVE-2019-20892).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4410-1/"
  );
...
if (ubuntu_check(osver:"20.04", pkgname:"libsnmp-base", pkgver:"5.8+dfsg-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libsnmp-perl", pkgver:"5.8+dfsg-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libsnmp35", pkgver:"5.8+dfsg-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"snmpd", pkgver:"5.8+dfsg-2ubuntu2.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libsnmp-base / libsnmp-perl / libsnmp35 / snmpd");
}
