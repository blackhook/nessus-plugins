...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : advancecomp vulnerability (USN-3570-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3570-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"advancecomp", pkgver:"1.18-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"advancecomp", pkgver:"1.20-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"advancecomp", pkgver:"2.0-1ubuntu0.1")) flag++;
