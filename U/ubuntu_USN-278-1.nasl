...
# extracted from Ubuntu Security Notice USN-278-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 / 5.10 : gdm vulnerabilitiy (USN-278-1)");
...
if (ubuntu_check(osver:"5.04", pkgname:"gdm", pkgver:"2.6.0.7-0ubuntu7.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"gdm", pkgver:"2.8.0.5-0ubuntu1.1")) flag++;
