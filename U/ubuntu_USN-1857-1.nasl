...
# extracted from Ubuntu Security Notice USN-1857-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1857-1");

  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 : libxext vulnerability (USN-1857-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1857-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxext6 package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libxext6", pkgver:"2:1.1.1-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libxext6", pkgver:"2:1.3.0-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxext6", pkgver:"2:1.3.1-2ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxext6", pkgver:"2:1.3.1-2ubuntu0.13.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxext6");
}
