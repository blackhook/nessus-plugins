...
# extracted from Ubuntu Security Notice USN-684-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"684-1");

  script_name(english:"Ubuntu 8.10 : clamav vulnerability (USN-684-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/684-1/"
  );
...
if (ubuntu_check(osver:"8.10", pkgname:"clamav", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"clamav-base", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"clamav-daemon", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"clamav-dbg", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"clamav-docs", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"clamav-freshclam", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"clamav-milter", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"clamav-testfiles", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"libclamav-dev", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"libclamav5", pkgver:"0.94.dfsg.2-1ubuntu0.1")) flag++;
