...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 20.10 : tar vulnerabilities (USN-4692-1)");
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'tar', 'pkgver': '1.30+dfsg-7ubuntu0.20.10.1'},
    {'osver': '20.10', 'pkgname': 'tar-scripts', 'pkgver': '1.30+dfsg-7ubuntu0.20.10.1'}
];
