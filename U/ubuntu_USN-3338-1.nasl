...
# extracted from Ubuntu Security Notice USN-3338-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3338-1");
  script_xref(name:"IAVA", value:"2017-A-0288-S");

  script_name(english:"Ubuntu 12.04 LTS : linux vulnerabilities (USN-3338-1)");
...
immediately available from the package repository and its mirrors.");
  ...
  script_copyright(english:"Ubuntu Security Notice (C) 2017-2023 Canonical, Inc. / NASL script (C) 2017-2023 Tenable Network Security, Inc.");
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-128-generic", pkgver:"3.2.0-128.173")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-128-generic-pae", pkgver:"3.2.0-128.173")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-128-highbank", pkgver:"3.2.0-128.173")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-128-virtual", pkgver:"3.2.0-128.173")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-generic", pkgver:"3.2.0.128.142")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-generic-pae", pkgver:"3.2.0.128.142")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-highbank", pkgver:"3.2.0.128.142")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-virtual", pkgver:"3.2.0.128.142")) flag++;
