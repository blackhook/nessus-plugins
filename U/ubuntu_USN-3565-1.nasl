...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : exim4 vulnerability (USN-3565-1)");
...
decoding operations. A remote attacker could use this issue to cause
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3565-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"exim4-daemon-heavy", pkgver:"4.82-3ubuntu2.4")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"exim4-daemon-light", pkgver:"4.82-3ubuntu2.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"exim4-daemon-heavy", pkgver:"4.86.2-2ubuntu2.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"exim4-daemon-light", pkgver:"4.86.2-2ubuntu2.3")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"exim4-daemon-heavy", pkgver:"4.89-5ubuntu1.3")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"exim4-daemon-light", pkgver:"4.89-5ubuntu1.3")) flag++;
