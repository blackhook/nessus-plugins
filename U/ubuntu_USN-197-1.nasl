...
# extracted from Ubuntu Security Notice USN-197-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : shorewall vulnerability (USN-197-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected shorewall package."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:shorewall");
...
if (ubuntu_check(osver:"4.10", pkgname:"shorewall", pkgver:"2.0.2-4ubuntu2.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"shorewall", pkgver:"2.0.13-1ubuntu0.1")) flag++;
