...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS : apt vulnerability (USN-2353-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2353-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"apt", pkgver:"0.7.25.3ubuntu9.17.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"apt", pkgver:"0.8.16~exp12ubuntu10.20.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"apt", pkgver:"1.0.1ubuntu2.4.1")) flag++;
