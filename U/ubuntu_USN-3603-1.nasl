...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : Paramiko vulnerability (USN-3603-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3603-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"python-paramiko", pkgver:"1.10.1-1git1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-paramiko", pkgver:"1.16.0-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-paramiko", pkgver:"1.16.0-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"python-paramiko", pkgver:"2.0.0-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"python3-paramiko", pkgver:"2.0.0-1ubuntu0.1")) flag++;
