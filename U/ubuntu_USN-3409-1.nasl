...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3409-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected fontforge and / or fontforge-common packages."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"fontforge", pkgver:"20120731.b-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"fontforge-common", pkgver:"20120731.b-5ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "fontforge / fontforge-common");
}
