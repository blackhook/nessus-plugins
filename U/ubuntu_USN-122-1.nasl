...
# extracted from Ubuntu Security Notice USN-122-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : squid vulnerability (USN-122-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"squid", pkgver:"2.5.5-6ubuntu0.8")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"squid-cgi", pkgver:"2.5.5-6ubuntu0.8")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"squid-common", pkgver:"2.5.5-6ubuntu0.8")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"squidclient", pkgver:"2.5.5-6ubuntu0.8")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"squid", pkgver:"2.5.8-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"squid-cgi", pkgver:"2.5.8-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"squid-common", pkgver:"2.5.8-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"squidclient", pkgver:"2.5.8-3ubuntu1.1")) flag++;
