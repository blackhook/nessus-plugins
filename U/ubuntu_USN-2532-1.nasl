...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 14.10 : cups-filters vulnerability (USN-2532-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that cups-browsed incorrectly filtered remote
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2532-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected cups-browsed package."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"cups-browsed", pkgver:"1.0.52-0ubuntu1.4")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"cups-browsed", pkgver:"1.0.61-0ubuntu2.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "cups-browsed");
}
