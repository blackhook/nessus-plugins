...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3719-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"mutt", pkgver:"1.5.21-6.4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"mutt-patched", pkgver:"1.5.21-6.4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"mutt", pkgver:"1.5.24-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"mutt-patched", pkgver:"1.5.24-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"mutt", pkgver:"1.9.4-3ubuntu0.1")) flag++;
