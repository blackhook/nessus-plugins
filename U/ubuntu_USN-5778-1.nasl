...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : X.Org X Server vulnerabilities (USN-5778-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 18.04 LTS / 20.04 LTS host has packages installed that are affected by multiple vulnerabilities as
referenced in the USN-5778-1 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'xnest', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xorg-server-source', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xserver-common', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xserver-xephyr', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xserver-xorg-core', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xserver-xorg-dev', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xserver-xorg-legacy', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xvfb', 'pkgver': '2:21.1.4-2ubuntu1.3'},
    {'osver': '22.10', 'pkgname': 'xwayland', 'pkgver': '2:22.1.3-2ubuntu0.2'}
];
