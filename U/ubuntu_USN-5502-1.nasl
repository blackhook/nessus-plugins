...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.10 / 22.04 LTS : OpenSSL vulnerability (USN-5502-1)");
...
vulnerability as referenced in the USN-5502-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'libssl-dev', 'pkgver': '1.1.1l-1ubuntu1.6'},
    {'osver': '21.10', 'pkgname': 'libssl1.1', 'pkgver': '1.1.1l-1ubuntu1.6'},
    {'osver': '21.10', 'pkgname': 'openssl', 'pkgver': '1.1.1l-1ubuntu1.6'},
