...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : CUPS vulnerabilities (USN-4340-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that CUPS incorrectly handled certain language
values. A local attacker could possibly use this issue to cause CUPS
to crash, leading to a denial of service, or possibly obtain sensitive
information. This issue only applied to Ubuntu 16.04 LTS, Ubuntu 18.04
LTS, and Ubuntu 19.10. (CVE-2019-2228)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4340-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"cups", pkgver:"2.1.3-4ubuntu0.11")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"cups", pkgver:"2.2.7-1ubuntu2.8")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"cups", pkgver:"2.2.12-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"cups", pkgver:"2.3.1-9ubuntu1.1")) flag++;
