...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : Django vulnerability (USN-5868-1)");
...
vulnerability as referenced in the USN-5868-1 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'python3-django', 'pkgver': '3:3.2.15-1ubuntu1.2'}
];
