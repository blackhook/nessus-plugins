...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : quagga vulnerabilities (USN-3573-1)");
...
Quagga BGP daemon when processing certain forms of UPDATE message. A
...
check the data sent with a NOTIFY to a peer. An attacker could use
this to expose sensitive information or possibly cause a denial of
service. This issue only affected Ubuntu 17.10. (CVE-2018-5378)
...
use this to possibly expose sensitive information or possibly cause a
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3573-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected quagga and / or quagga-bgpd packages."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"quagga", pkgver:"0.99.22.4-3ubuntu1.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"quagga", pkgver:"0.99.24.1-2ubuntu1.4")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"quagga", pkgver:"1.1.1-3ubuntu0.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"quagga-bgpd", pkgver:"1.1.1-3ubuntu0.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "quagga / quagga-bgpd");
}
