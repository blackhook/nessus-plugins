...
{
  if (! preg(pattern:"^(4.15.0-\d+-(aws|oracle))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.15.0-\d+-aws" : "4.15.0-1151",
    "4.15.0-\d+-oracle" : "4.15.0-1115"
  };
