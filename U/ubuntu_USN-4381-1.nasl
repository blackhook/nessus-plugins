...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : python-django vulnerabilities (USN-4381-1)");
...
cache keys. A remote attacker could possibly use this issue to cause a
denial of service and obtain sensitive information. (CVE-2020-13254)
...
could possibly use this issue to perform XSS attacks. (CVE-2020-13596).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4381-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"python-django", pkgver:"1.8.7-1ubuntu5.13")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-django", pkgver:"1.8.7-1ubuntu5.13")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python-django", pkgver:"1:1.11.11-1ubuntu1.9")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python3-django", pkgver:"1:1.11.11-1ubuntu1.9")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"python-django", pkgver:"1:1.11.22-1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"python3-django", pkgver:"1:1.11.22-1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"python3-django", pkgver:"2:2.2.12-1ubuntu0.1")) flag++;
