...
{
  if (! preg(pattern:"^(4.15.0-\d{3}-(generic|generic-lpae|lowlatency)|4.15.0-\d{4}-(dell300x|kvm|oracle|raspi2|snapdragon))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.15.0-\d{3}-(generic|generic-lpae|lowlatency)" : "4.15.0-194",
    "4.15.0-\d{4}-dell300x" : "4.15.0-1054",
    "4.15.0-\d{4}-kvm" : "4.15.0-1128",
    "4.15.0-\d{4}-oracle" : "4.15.0-1107",
    "4.15.0-\d{4}-raspi2" : "4.15.0-1120",
    "4.15.0-\d{4}-snapdragon" : "4.15.0-1138"
  };
