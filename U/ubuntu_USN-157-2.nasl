...
# extracted from Ubuntu Security Notice USN-157-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : updated enigmail (USN-157-2)");
...
if (ubuntu_check(osver:"4.10", pkgname:"mozilla-enigmail", pkgver:"0.92-1ubuntu04.10.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"mozilla-thunderbird-enigmail", pkgver:"0.92-1ubuntu04.10.1")) flag++;
