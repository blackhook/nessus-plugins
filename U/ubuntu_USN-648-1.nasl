...
# extracted from Ubuntu Security Notice USN-648-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS : nasm vulnerability (USN-648-1)");
...
assembling a specially crafted ASM file, a remote attacker could
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/648-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"nasm", pkgver:"0.99.06-2ubuntu0.1")) flag++;
