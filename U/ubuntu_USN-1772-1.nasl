...
# extracted from Ubuntu Security Notice USN-1772-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(58616);
  script_xref(name:"USN", value:"1772-1");

  script_name(english:"Ubuntu 12.10 : keystone vulnerability (USN-1772-1)");
...
verification checks when configured to use PKI. If the keystone server
was configured to use PKI and services or users requested online
verification, an attacker could potentially exploit this to bypass
revocation checks. Keystone uses UUID tokens by default in Ubuntu.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1772-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.10", pkgname:"python-keystone", pkgver:"2012.2.1-0ubuntu1.3")) flag++;
