...
# extracted from Ubuntu Security Notice USN-1400-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(52456, 52457, 52458, 52459, 52460, 52463, 52464, 52465, 52467);
  script_xref(name:"USN", value:"1400-1");

  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 / 11.10 : firefox vulnerabilities (USN-1400-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1400-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"firefox", pkgver:"11.0+build1-0ubuntu0.10.04.2")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"firefox", pkgver:"11.0+build1-0ubuntu0.10.10.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"firefox", pkgver:"11.0+build1-0ubuntu0.11.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"firefox", pkgver:"11.0+build1-0ubuntu0.11.10.1")) flag++;
