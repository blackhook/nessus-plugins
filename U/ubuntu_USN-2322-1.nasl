...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : glance vulnerability (USN-2322-1)");
  ...
  script_set_attribute(
    ...
    value:
"Thomas Leaman and Stuart McLaren discovered that OpenStack Glance did
not properly honor the image_size_cap configuration option. A remote
authenticated attacker could exploit this to cause a denial of service
via disk consumption.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2322-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"14.04", pkgname:"glance-common", pkgver:"1:2014.1.2-0ubuntu1.1")) flag++;
