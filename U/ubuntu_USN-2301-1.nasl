...
# extracted from Ubuntu Security Notice USN-2301-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : jinja2 vulnerabilities (USN-2301-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Jinja2 incorrectly handled temporary cache
files and directories. A local attacker could use this issue to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2301-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"python-jinja2", pkgver:"2.6-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python3-jinja2", pkgver:"2.6-1ubuntu0.1")) flag++;
