...
# extracted from Ubuntu Security Notice USN-1513-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 11.04 / 11.10 / 12.04 LTS : libexif vulnerabilities (USN-1513-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1513-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"8.04", pkgname:"libexif12", pkgver:"0.6.16-2.1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libexif12", pkgver:"0.6.19-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libexif12", pkgver:"0.6.20-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libexif12", pkgver:"0.6.20-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libexif12", pkgver:"0.6.20-2ubuntu0.1")) flag++;
