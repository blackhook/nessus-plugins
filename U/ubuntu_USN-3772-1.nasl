...
logging. A local attacker could possibly use this issue to cause a
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3772-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"udisks2", pkgver:"2.7.6-3ubuntu0.2")) flag++;
