...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3656-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2017-17975", "CVE-2017-18193", "CVE-2017-18222", "CVE-2018-1065", "CVE-2018-1068", "CVE-2018-1130", "CVE-2018-5803", "CVE-2018-7480", "CVE-2018-7757", "CVE-2018-7995", "CVE-2018-8781", "CVE-2018-8822");
...
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-1090-raspi2", pkgver:"4.4.0-1090.98")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-1093-snapdragon", pkgver:"4.4.0-1093.98")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-raspi2", pkgver:"4.4.0.1090.90")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-snapdragon", pkgver:"4.4.0.1093.85")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "linux-image-4.4-raspi2 / linux-image-4.4-snapdragon / etc");
}
