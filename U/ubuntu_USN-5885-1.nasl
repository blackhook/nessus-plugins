...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.04 LTS / 22.10 : APR vulnerability (USN-5885-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'libapr1', 'pkgver': '1.7.0-8ubuntu0.22.10.1'},
    {'osver': '22.10', 'pkgname': 'libapr1-dev', 'pkgver': '1.7.0-8ubuntu0.22.10.1'}
];
