...
# extracted from Ubuntu Security Notice USN-2014-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.10 : openssh vulnerability (USN-2014-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2014-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.10", pkgname:"openssh-server", pkgver:"1:6.2p2-6ubuntu0.1")) flag++;
