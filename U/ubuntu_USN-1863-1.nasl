...
# extracted from Ubuntu Security Notice USN-1863-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 : libxrender vulnerability (USN-1863-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1863-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxrender1 package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libxrender1", pkgver:"1:0.9.5-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libxrender1", pkgver:"1:0.9.6-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxrender1", pkgver:"1:0.9.7-1ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxrender1", pkgver:"1:0.9.7-1ubuntu0.13.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxrender1");
}
