...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 / 19.10 : SpamAssassin vulnerabilities (USN-4237-1)");
...
SpamAssassin to consume resources, resulting in a denial of service.
(CVE-2019-12420).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4237-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"spamassassin", pkgver:"3.4.2-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"spamassassin", pkgver:"3.4.2-0ubuntu0.18.04.2")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"spamassassin", pkgver:"3.4.2-1ubuntu0.19.04.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"spamassassin", pkgver:"3.4.2-1ubuntu0.19.10.1")) flag++;
