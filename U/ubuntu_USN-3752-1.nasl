...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3752-1/"
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-1018-gcp", pkgver:"4.15.0-1018.19")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-1020-aws", pkgver:"4.15.0-1020.20")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-1020-kvm", pkgver:"4.15.0-1020.20")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-1021-raspi2", pkgver:"4.15.0-1021.23")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-33-generic", pkgver:"4.15.0-33.36")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-33-generic-lpae", pkgver:"4.15.0-33.36")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-33-lowlatency", pkgver:"4.15.0-33.36")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-4.15.0-33-snapdragon", pkgver:"4.15.0-33.36")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-aws", pkgver:"4.15.0.1020.20")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-gcp", pkgver:"4.15.0.1018.20")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-generic", pkgver:"4.15.0.33.35")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-generic-lpae", pkgver:"4.15.0.33.35")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-gke", pkgver:"4.15.0.1018.20")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-kvm", pkgver:"4.15.0.1020.20")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-lowlatency", pkgver:"4.15.0.33.35")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-raspi2", pkgver:"4.15.0.1021.19")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-snapdragon", pkgver:"4.15.0.33.35")) flag++;
