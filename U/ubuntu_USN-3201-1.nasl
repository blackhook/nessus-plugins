...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 16.04 LTS / 16.10 : bind9 vulnerabilities (USN-3201-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Bind incorrectly handled rewriting certain
query responses when using both DNS64 and RPZ. A remote attacker could
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3201-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"bind9", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.21")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-3ubuntu0.13")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-8ubuntu1.5")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-10.1ubuntu1.3")) flag++;
