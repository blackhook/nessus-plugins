...
# extracted from Ubuntu Security Notice USN-22-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : samba vulnerability (USN-22-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"libpam-smbpass", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libsmbclient", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libsmbclient-dev", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"python2.3-samba", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"samba", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"samba-common", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"samba-doc", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"smbclient", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"smbfs", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"swat", pkgver:"3.0.7-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"winbind", pkgver:"3.0.7-1ubuntu6.1")) flag++;
