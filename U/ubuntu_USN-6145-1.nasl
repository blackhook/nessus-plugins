...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM / 20.04 LTS / 22.04 LTS / 22.10 / 23.04 : Sysstat vulnerabilities (USN-6145-1)");
...
affected by multiple vulnerabilities as referenced in the USN-6145-1 advisory.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'isag', 'pkgver': '11.2.0-1ubuntu0.3+esm2'},
    {'osver': '16.04', 'pkgname': 'sysstat', 'pkgver': '11.2.0-1ubuntu0.3+esm2'},
    {'osver': '18.04', 'pkgname': 'isag', 'pkgver': '11.6.1-1ubuntu0.2+esm1'},
    {'osver': '18.04', 'pkgname': 'sysstat', 'pkgver': '11.6.1-1ubuntu0.2+esm1'},
    {'osver': '20.04', 'pkgname': 'isag', 'pkgver': '12.2.0-2ubuntu0.3'},
    {'osver': '20.04', 'pkgname': 'sysstat', 'pkgver': '12.2.0-2ubuntu0.3'},
    {'osver': '22.04', 'pkgname': 'isag', 'pkgver': '12.5.2-2ubuntu0.2'},
    {'osver': '22.04', 'pkgname': 'sysstat', 'pkgver': '12.5.2-2ubuntu0.2'},
    {'osver': '22.10', 'pkgname': 'isag', 'pkgver': '12.5.6-1ubuntu0.2'},
    {'osver': '22.10', 'pkgname': 'sysstat', 'pkgver': '12.5.6-1ubuntu0.2'},
    {'osver': '23.04', 'pkgname': 'isag', 'pkgver': '12.6.1-1ubuntu0.1'},
    {'osver': '23.04', 'pkgname': 'sysstat', 'pkgver': '12.6.1-1ubuntu0.1'}
];
