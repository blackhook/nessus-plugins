...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : rsync vulnerabilities (USN-5921-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'rsync', 'pkgver': '3.2.7-0ubuntu0.22.10.1'}
];
