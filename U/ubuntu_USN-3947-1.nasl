...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS / 18.10 : Libxslt vulnerability (USN-3947-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3947-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libxslt1.1", pkgver:"1.1.28-2ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libxslt1.1", pkgver:"1.1.28-2.1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libxslt1.1", pkgver:"1.1.29-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"libxslt1.1", pkgver:"1.1.32-2ubuntu0.1")) flag++;
