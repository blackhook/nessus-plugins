...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Django vulnerability (USN-4975-2)");
...
USN-4975-2 advisory. Note that Nessus has not tested for this issue but has instead relied only on the application's
...
pkgs = [
    {'osver': '16.04', 'pkgname': 'python-django', 'pkgver': '1.8.7-1ubuntu5.15+esm3'},
    {'osver': '16.04', 'pkgname': 'python-django-common', 'pkgver': '1.8.7-1ubuntu5.15+esm3'},
    {'osver': '16.04', 'pkgname': 'python3-django', 'pkgver': '1.8.7-1ubuntu5.15+esm3'}
];
