...
# extracted from Ubuntu Security Notice USN-1856-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : libxcursor vulnerability (USN-1856-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1856-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libxcursor1", pkgver:"1:1.1.12-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxcursor1", pkgver:"1:1.1.13-1ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxcursor1", pkgver:"1:1.1.13-1ubuntu0.13.04.1")) flag++;
