...
# extracted from Ubuntu Security Notice USN-1385-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.04 / 11.10 : apt vulnerability (USN-1385-1)");
  ...
  script_set_attribute(
    ...
    value:
"Simon Ruderich discovered that APT incorrectly handled repositories
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1385-1/"
  );
...
if (ubuntu_check(osver:"11.04", pkgname:"apt", pkgver:"0.8.13.2ubuntu4.4")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"apt", pkgver:"0.8.16~exp5ubuntu13.2")) flag++;
