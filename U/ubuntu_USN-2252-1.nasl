...
# extracted from Ubuntu Security Notice USN-2252-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS : linux-ec2 vulnerabilities (USN-2252-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2252-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2252-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-366-ec2", pkgver:"2.6.32-366.80")) flag++;
