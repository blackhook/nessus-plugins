...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3761-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"firefox", pkgver:"62.0+build2-0ubuntu0.14.04.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"firefox", pkgver:"62.0+build2-0ubuntu0.16.04.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"firefox", pkgver:"62.0+build2-0ubuntu0.18.04.3")) flag++;
