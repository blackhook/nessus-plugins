...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3585-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"python-twisted", pkgver:"13.2.0-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"python-twisted-bin", pkgver:"13.2.0-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"python-twisted-web", pkgver:"13.2.0-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-twisted", pkgver:"16.0.0-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-twisted-bin", pkgver:"16.0.0-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-twisted-web", pkgver:"16.0.0-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-twisted", pkgver:"16.0.0-1ubuntu0.2")) flag++;
