...
# extracted from Ubuntu Security Notice USN-1775-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS : linux vulnerabilities (USN-1775-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1775-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1775-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-386", pkgver:"2.6.32-46.105")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-generic", pkgver:"2.6.32-46.105")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-generic-pae", pkgver:"2.6.32-46.105")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-lpia", pkgver:"2.6.32-46.105")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-preempt", pkgver:"2.6.32-46.105")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-server", pkgver:"2.6.32-46.105")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-versatile", pkgver:"2.6.32-46.105")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-46-virtual", pkgver:"2.6.32-46.105")) flag++;
