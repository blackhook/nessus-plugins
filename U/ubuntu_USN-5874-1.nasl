...
{
  if (! preg(pattern:"^(5.4.0-\d{3}-(generic|generic-lpae|lowlatency)|5.4.0-\d{4}-(aws|gcp|ibm|oracle))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.4.0-\d{3}-(generic|generic-lpae|lowlatency)" : "5.4.0-139",
    "5.4.0-\d{4}-aws" : "5.4.0-1096",
    "5.4.0-\d{4}-gcp" : "5.4.0-1100",
    "5.4.0-\d{4}-ibm" : "5.4.0-1044",
