...
# extracted from Ubuntu Security Notice USN-1290-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 : krb5 vulnerability (USN-1290-1)");
  ...
  script_set_attribute(
    ...
    value:
"Simo Sorce discovered that a NULL pointer dereference existed in the
Kerberos Key Distribution Center (KDC). An authenticated remote
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1290-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected krb5-kdc package."
  );
...
if (ubuntu_check(osver:"11.10", pkgname:"krb5-kdc", pkgver:"1.9.1+dfsg-1ubuntu2.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "krb5-kdc");
}
