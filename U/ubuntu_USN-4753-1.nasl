...
"Update the affected linux-image-5.10.0-1014-oem, linux-image-oem-20.04-edge and / or linux-image-oem-20.04b packages.");
...
pkgs = [
    {'osver': '20.04', 'pkgname': 'linux-image-5.10.0-1014-oem', 'pkgver': '5.10.0-1014.15'},
    {'osver': '20.04', 'pkgname': 'linux-image-oem-20.04-edge', 'pkgver': '5.10.0.1014.15'},
    {'osver': '20.04', 'pkgname': 'linux-image-oem-20.04b', 'pkgver': '5.10.0.1014.15'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'linux-image-5.10.0-1014-oem / linux-image-oem-20.04-edge / etc');
}