...
only on the application's self-reported version number.");
  script_set_attribute(attribute:"see_also", value:"https://nlnetlabs.nl/pipermail/unbound-users/2011-June/001917.html");
  script_set_attribute(attribute:"see_also", value:"https://www.internetsociety.org/sites/default/files/12_1.pdf");
  script_set_attribute(attribute:"solution", value:
"Upgrade to Unbound version 1.4.11 or later.");
