...
# extracted from Ubuntu Security Notice USN-1890-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : firefox vulnerabilities (USN-1890-1)");
...
Frederic Buclin discovered that the X-Frame-Options header is
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/1890-1/");
...
if (ubuntu_check(osver:"12.04", pkgname:"firefox", pkgver:"22.0+build2-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"firefox", pkgver:"22.0+build2-0ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"firefox", pkgver:"22.0+build2-0ubuntu0.13.04.1")) flag++;
