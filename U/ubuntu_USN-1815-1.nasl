...
# extracted from Ubuntu Security Notice USN-1815-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(59537, 59538);
  script_xref(name:"USN", value:"1815-1");

  script_name(english:"Ubuntu 13.04 : linux vulnerabilities (USN-1815-1)");
...
Andy Lutomirski discovered a privilege escalation in the Linux
kernel's user namespaces. A local user could exploit the flaw to gain
administrative privileges. (CVE-2013-1959).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1815-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2013-1959", "CVE-2013-1979");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1815-1");
  }
  else
  {
...
if (ubuntu_check(osver:"13.04", pkgname:"linux-image-3.8.0-19-generic", pkgver:"3.8.0-19.30")) flag++;
