...
patches."
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that GNOME Keyring incorrectly cleared out
credentials supplied to the PAM module. A local attacker could
possibly use this issue to discover login credentials.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3894-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Update the affected gnome-keyring and / or libpam-gnome-keyring
packages."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"gnome-keyring", pkgver:"3.10.1-1ubuntu4.4")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libpam-gnome-keyring", pkgver:"3.10.1-1ubuntu4.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"gnome-keyring", pkgver:"3.18.3-0ubuntu2.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libpam-gnome-keyring", pkgver:"3.18.3-0ubuntu2.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gnome-keyring / libpam-gnome-keyring");
}
