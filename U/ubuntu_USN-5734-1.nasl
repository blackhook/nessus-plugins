...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : FreeRDP vulnerabilities (USN-5734-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'freerdp2-dev', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'freerdp2-shadow-x11', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'freerdp2-wayland', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'freerdp2-x11', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libfreerdp-client2-2', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libfreerdp-server2-2', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libfreerdp-shadow-subsystem2-2', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libfreerdp-shadow2-2', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libfreerdp2-2', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libuwac0-0', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libuwac0-dev', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libwinpr-tools2-2', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libwinpr2-2', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'libwinpr2-dev', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'winpr-utils', 'pkgver': '2.8.1+dfsg1-0ubuntu1.1'}
];
