...
# extracted from Ubuntu Security Notice USN-1308-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(50409);
  script_xref(name:"USN", value:"1308-1");

  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 10.10 / 11.04 / 11.10 : bzip2 vulnerability (USN-1308-1)");
  ...
  script_set_attribute(
    ...
    value:
"vladz discovered that executables compressed by bzexe insecurely
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1308-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"bzip2", pkgver:"1.0.4-2ubuntu4.2")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"bzip2", pkgver:"1.0.5-4ubuntu0.2")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"bzip2", pkgver:"1.0.5-4ubuntu1.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"bzip2", pkgver:"1.0.5-6ubuntu1.11.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"bzip2", pkgver:"1.0.5-6ubuntu1.11.10.1")) flag++;
