...
# extracted from Ubuntu Security Notice USN-42-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : xine-lib vulnerabilities (USN-42-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"libxine-dev", pkgver:"1-rc5-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxine1", pkgver:"1-rc5-1ubuntu2.1")) flag++;
