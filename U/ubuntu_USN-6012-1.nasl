...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.04 LTS / 22.10 : Smarty vulnerability (USN-6012-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 22.04 LTS / 22.10 host has a package installed that is affected by a vulnerability as referenced in
the USN-6012-1 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'smarty3', 'pkgver': '3.1.39-2ubuntu1.22.10.1'}
];
