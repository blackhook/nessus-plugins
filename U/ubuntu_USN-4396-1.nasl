...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : libexif vulnerabilities (USN-4396-1)");
...
It was discovered that libexif incorrectly handled certain inputs. An
attacker could possibly use this issue to cause a remote denial of
service. (CVE-2020-0198)

It was discovered that libexif incorrectly handled certain inputs. An
attacker could possibly use this issue to expose sensitive information
or cause a crash. (CVE-2020-13112)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4396-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libexif12", pkgver:"0.6.21-2ubuntu0.5")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libexif12", pkgver:"0.6.21-4ubuntu0.5")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libexif12", pkgver:"0.6.21-5.1ubuntu0.5")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libexif12", pkgver:"0.6.21-6ubuntu0.3")) flag++;
