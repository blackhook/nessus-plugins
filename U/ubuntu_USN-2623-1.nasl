...
# extracted from Ubuntu Security Notice USN-2623-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2623-1");

  script_name(english:"Ubuntu 12.04 LTS : ipsec-tools vulnerability (USN-2623-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2623-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected racoon package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"racoon", pkgver:"1:0.8.0-9ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "racoon");
}
