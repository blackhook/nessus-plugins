...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 22.10 : OpenStack Glance vulnerability (USN-5835-2)");
...
referenced in the USN-5835-2 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'glance', 'pkgver': '2:25.0.0-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'glance-api', 'pkgver': '2:25.0.0-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'glance-common', 'pkgver': '2:25.0.0-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'python3-glance', 'pkgver': '2:25.0.0-0ubuntu1.1'}
];
