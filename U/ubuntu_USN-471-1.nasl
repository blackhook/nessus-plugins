...
# extracted from Ubuntu Security Notice USN-471-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 / 7.04 : libexif vulnerability (USN-471-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/471-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"6.06", pkgname:"libexif-dev", pkgver:"0.6.12-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libexif12", pkgver:"0.6.12-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libexif-dev", pkgver:"0.6.13-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libexif12", pkgver:"0.6.13-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"libexif-dev", pkgver:"0.6.13-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"libexif12", pkgver:"0.6.13-5ubuntu0.1")) flag++;
