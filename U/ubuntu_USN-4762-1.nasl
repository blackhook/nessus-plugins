...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 20.10 : OpenSSH vulnerability (USN-4762-1)");
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'openssh-client', 'pkgver': '1:8.3p1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'openssh-client-udeb', 'pkgver': '1:8.3p1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'openssh-server', 'pkgver': '1:8.3p1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'openssh-server-udeb', 'pkgver': '1:8.3p1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'openssh-sftp-server', 'pkgver': '1:8.3p1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'openssh-tests', 'pkgver': '1:8.3p1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'ssh', 'pkgver': '1:8.3p1-1ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'ssh-askpass-gnome', 'pkgver': '1:8.3p1-1ubuntu0.1'}
];
