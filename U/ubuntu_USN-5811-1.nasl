...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : Sudo vulnerabilities (USN-5811-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'sudo', 'pkgver': '1.9.11p3-1ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'sudo-ldap', 'pkgver': '1.9.11p3-1ubuntu1.1'}
];
