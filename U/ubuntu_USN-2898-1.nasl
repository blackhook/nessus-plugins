...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 : gtk+2.0, gtk+3.0 vulnerability (USN-2898-1)");
...
A remote attacker could use this issue to cause GTK+ applications to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2898-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libgtk-3-0 and / or libgtk2.0-0 packages."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libgtk-3-0", pkgver:"3.4.2-0ubuntu0.9")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgtk2.0-0", pkgver:"2.24.10-0ubuntu6.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libgtk2.0-0", pkgver:"2.24.23-0ubuntu1.4")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libgtk2.0-0", pkgver:"2.24.28-1ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libgtk-3-0 / libgtk2.0-0");
}
