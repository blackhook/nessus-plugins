...
# extracted from Ubuntu Security Notice USN-78-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : mailman vulnerabilities (USN-78-2)");
...
if (ubuntu_check(osver:"4.10", pkgname:"mailman", pkgver:"2.1.5-1ubuntu2.4")) flag++;
