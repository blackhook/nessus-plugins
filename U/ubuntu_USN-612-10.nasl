...
# extracted from Ubuntu Security Notice USN-612-10. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.04 / 7.10 / 8.04 LTS : openvpn regression (USN-612-10)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/612-10/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"7.04", pkgname:"openvpn", pkgver:"2.0.9-5ubuntu0.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"openvpn", pkgver:"2.0.9-8ubuntu0.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"openvpn", pkgver:"2.1~rc7-1ubuntu3.3")) flag++;
