...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : X.Org X Server vulnerability (USN-4490-1)");
...
the XkbSetNames function. A local attacker could possibly use this
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4490-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"16.04", pkgname:"xserver-xorg-core", pkgver:"2:1.18.4-0ubuntu0.10")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"xserver-xorg-core-hwe-16.04", pkgver:"2:1.19.6-1ubuntu4.1~16.04.4")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"xserver-xorg-core", pkgver:"2:1.19.6-1ubuntu4.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"xserver-xorg-core-hwe-18.04", pkgver:"2:1.20.8-2ubuntu2.2~18.04.3")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"xserver-xorg-core", pkgver:"2:1.20.8-2ubuntu2.4")) flag++;
