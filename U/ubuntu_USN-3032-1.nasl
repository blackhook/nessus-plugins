...
if (description)
{
  ...
  script_name(english:"Ubuntu 15.10 / 16.04 LTS : ecryptfs-utils vulnerability (USN-3032-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that eCryptfs incorrectly configured the encrypted
swap partition for certain drive types. An attacker could use this
issue to discover sensitive information.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3032-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"15.10", pkgname:"ecryptfs-utils", pkgver:"108-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"ecryptfs-utils", pkgver:"111-0ubuntu1.1")) flag++;
