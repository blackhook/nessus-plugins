...
# extracted from Ubuntu Security Notice USN-1824-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS : linux vulnerabilities (USN-1824-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1824-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2012-6549", "CVE-2013-1826", "CVE-2013-1860", "CVE-2013-1928", "CVE-2013-2634");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1824-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-386", pkgver:"2.6.32-47.109")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-generic", pkgver:"2.6.32-47.109")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-generic-pae", pkgver:"2.6.32-47.109")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-lpia", pkgver:"2.6.32-47.109")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-preempt", pkgver:"2.6.32-47.109")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-server", pkgver:"2.6.32-47.109")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-versatile", pkgver:"2.6.32-47.109")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-47-virtual", pkgver:"2.6.32-47.109")) flag++;
