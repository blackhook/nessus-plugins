...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : ecryptfs-utils vulnerability (USN-2876-1)");
  ...
  script_set_attribute(
    ...
    value:
"Jann Horn discovered that mount.ecryptfs_private would mount over
certain directories in the proc filesystem. A local attacker could use
this to escalate their privileges. (CVE-2016-1572).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2876-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"ecryptfs-utils", pkgver:"96-0ubuntu3.5")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"ecryptfs-utils", pkgver:"104-0ubuntu1.14.04.4")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"ecryptfs-utils", pkgver:"107-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"ecryptfs-utils", pkgver:"108-0ubuntu1.1")) flag++;
