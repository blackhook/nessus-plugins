...
# extracted from Ubuntu Security Notice USN-658-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.10 / 8.04 LTS : moodle vulnerability (USN-658-1)");
  ...
  script_set_attribute(
    ...
    value:
"Lukasz Pilorz discovered that the HTML filtering used in Moodle was
not strict enough. A remote attacker could send malicious requests to
Moodle and execute arbitrary code as the web server user.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/658-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"7.10", pkgname:"moodle", pkgver:"1.8.2-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"moodle", pkgver:"1.8.2-1ubuntu4.1")) flag++;
