...
# extracted from Ubuntu Security Notice USN-688-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.10 / 8.04 LTS / 8.10 : compiz-fusion-plugins-main vulnerability (USN-688-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/688-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected compiz-fusion-plugins-main package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:C/I:C/A:C");
  script_cwe_id(264);

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:compiz-fusion-plugins-main");
...
if (ubuntu_check(osver:"7.10", pkgname:"compiz-fusion-plugins-main", pkgver:"0.5.2+git20070928-0ubuntu2.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"compiz-fusion-plugins-main", pkgver:"0.7.4-0ubuntu6.2")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"compiz-fusion-plugins-main", pkgver:"0.7.8-0ubuntu2.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "compiz-fusion-plugins-main");
}
