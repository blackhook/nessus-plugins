...
# extracted from Ubuntu Security Notice USN-612-6. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.04 / 7.10 / 8.04 LTS : openvpn regression (USN-612-6)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/612-6/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected openssl-blacklist and / or openvpn packages."
  );
...
if (ubuntu_check(osver:"7.04", pkgname:"openssl-blacklist", pkgver:"0.1-0ubuntu0.7.04.2")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"openvpn", pkgver:"2.0.9-5ubuntu0.2")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"openssl-blacklist", pkgver:"0.1-0ubuntu0.7.10.2")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"openvpn", pkgver:"2.0.9-8ubuntu0.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"openssl-blacklist", pkgver:"0.1-0ubuntu0.8.04.2")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"openvpn", pkgver:"2.1~rc7-1ubuntu3.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "openssl-blacklist / openvpn");
}
