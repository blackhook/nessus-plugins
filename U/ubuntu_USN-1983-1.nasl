...
# extracted from Ubuntu Security Notice USN-1983-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : python2.7 vulnerabilities (USN-1983-1)");
...
denial of service. This issue only affected Ubuntu 13.04.
(CVE-2013-2099)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1983-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"python2.7", pkgver:"2.7.3-0ubuntu3.4")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python2.7-minimal", pkgver:"2.7.3-0ubuntu3.4")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"python2.7", pkgver:"2.7.3-5ubuntu4.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"python2.7-minimal", pkgver:"2.7.3-5ubuntu4.3")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"python2.7", pkgver:"2.7.4-2ubuntu3.2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"python2.7-minimal", pkgver:"2.7.4-2ubuntu3.2")) flag++;
