...
# extracted from Ubuntu Security Notice USN-1662-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 / 12.04 LTS / 12.10 : apt vulnerability (USN-1662-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that APT set inappropriate permissions on the
term.log file. A local attacker could use this flaw to possibly obtain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1662-1/"
  );
...
if (ubuntu_check(osver:"11.10", pkgname:"apt", pkgver:"0.8.16~exp5ubuntu13.6")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"apt", pkgver:"0.8.16~exp12ubuntu10.7")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"apt", pkgver:"0.9.7.5ubuntu5.2")) flag++;
