...
# extracted from Ubuntu Security Notice USN-3152-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3152-2");

  script_name(english:"Ubuntu 16.10 : linux-raspi2 vulnerabilities (USN-3152-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3152-2/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-3152-2");
  }
  else
  {
...
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-4.8.0-1020-raspi2", pkgver:"4.8.0-1020.23")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-raspi2", pkgver:"4.8.0.1020.23")) flag++;
