...
# extracted from Ubuntu Security Notice USN-842-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 8.04 LTS / 8.10 / 9.04 : wget vulnerability (USN-842-1)");
...
with zero bytes in the Common Name. A remote attacker could exploit
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/842-1/"
  );
...
if (ubuntu_check(osver:"6.06", pkgname:"wget", pkgver:"1.10.2-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"wget", pkgver:"1.10.2-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"wget", pkgver:"1.11.4-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"9.04", pkgname:"wget", pkgver:"1.11.4-2ubuntu1.1")) flag++;
