...
# extracted from Ubuntu Security Notice USN-2011-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 / 13.10 : libav vulnerabilities (USN-2011-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2011-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libavcodec53", pkgver:"4:0.8.8-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libavformat53", pkgver:"4:0.8.8-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libavcodec53", pkgver:"6:0.8.8-0ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libavformat53", pkgver:"6:0.8.8-0ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libavcodec53", pkgver:"6:0.8.8-0ubuntu0.13.04.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libavformat53", pkgver:"6:0.8.8-0ubuntu0.13.04.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libavcodec53", pkgver:"6:0.8.8-0ubuntu0.13.10.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libavformat53", pkgver:"6:0.8.8-0ubuntu0.13.10.1")) flag++;
