...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Cron regression (USN-5259-3)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'cron', 'pkgver': '3.0pl1-128ubuntu2+esm2'},
    {'osver': '18.04', 'pkgname': 'cron', 'pkgver': '3.0pl1-128.1ubuntu1.2'}
];
