...
# extracted from Ubuntu Security Notice USN-2259-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(67309, 67321, 68048);
  script_xref(name:"USN", value:"2259-1");

  script_name(english:"Ubuntu 12.04 LTS : linux vulnerabilities (USN-2259-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2259-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2014-1739", "CVE-2014-3144", "CVE-2014-3145");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2259-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-65-generic", pkgver:"3.2.0-65.98")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-65-generic-pae", pkgver:"3.2.0-65.98")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-65-highbank", pkgver:"3.2.0-65.98")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-65-virtual", pkgver:"3.2.0-65.98")) flag++;
