...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 : freetype vulnerabilities (USN-2739-1)");
...
hang, resulting in a denial of service, or possibly expose
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2739-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libfreetype6", pkgver:"2.4.8-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libfreetype6", pkgver:"2.5.2-1ubuntu2.5")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"libfreetype6", pkgver:"2.5.2-2ubuntu3.1")) flag++;
