...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 / 17.04 : bind9 vulnerabilities (USN-3346-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3346-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-3ubuntu0.15")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-8ubuntu1.7")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-10.1ubuntu1.7")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-10.1ubuntu5.1")) flag++;
