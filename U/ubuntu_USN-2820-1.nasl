...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : dpkg vulnerability (USN-2820-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2820-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"dpkg", pkgver:"1.16.1.2ubuntu7.7")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"dpkg", pkgver:"1.17.5ubuntu5.5")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"dpkg", pkgver:"1.17.25ubuntu1.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"dpkg", pkgver:"1.18.2ubuntu5.1")) flag++;
