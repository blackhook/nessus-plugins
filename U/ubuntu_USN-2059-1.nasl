...
# extracted from Ubuntu Security Notice USN-2059-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2059-1");

  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 / 13.10 : gnupg vulnerability (USN-2059-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2059-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"gnupg", pkgver:"1.4.10-2ubuntu1.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"gnupg", pkgver:"1.4.11-3ubuntu2.5")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"gnupg", pkgver:"1.4.11-3ubuntu4.4")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"gnupg", pkgver:"1.4.12-7ubuntu1.3")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"gnupg", pkgver:"1.4.14-1ubuntu2.1")) flag++;
