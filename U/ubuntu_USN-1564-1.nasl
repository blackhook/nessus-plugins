...
# extracted from Ubuntu Security Notice USN-1564-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(55524);
  script_xref(name:"USN", value:"1564-1");

  script_name(english:"Ubuntu 12.04 LTS : keystone vulnerability (USN-1564-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1564-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"keystone", pkgver:"2012.1+stable~20120824-a16a0ab9-0ubuntu2.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python-keystone", pkgver:"2012.1+stable~20120824-a16a0ab9-0ubuntu2.2")) flag++;
