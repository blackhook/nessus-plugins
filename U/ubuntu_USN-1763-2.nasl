...
# extracted from Ubuntu Security Notice USN-1763-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 11.10 / 12.04 LTS / 12.10 : nspr update (USN-1763-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1763-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libnspr4-0d", pkgver:"4.9.5-0ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libnspr4", pkgver:"4.9.5-0ubuntu0.11.10.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libnspr4", pkgver:"4.9.5-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libnspr4", pkgver:"4.9.5-0ubuntu0.12.10.1")) flag++;
