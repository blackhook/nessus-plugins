...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.04 : HAProxy vulnerabilities (USN-5063-1)");
...
var pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'haproxy', 'pkgver': '2.2.9-1ubuntu0.2'},
    {'osver': '21.04', 'pkgname': 'vim-haproxy', 'pkgver': '2.2.9-1ubuntu0.2'}
];
