...
# extracted from Ubuntu Security Notice USN-1731-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1731-1");

  script_name(english:"Ubuntu 12.10 : cinder vulnerability (USN-1731-1)");
  ...
  script_set_attribute(
    ...
    value:
"Stuart Stent discovered that Cinder would allow XML entity processing.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1731-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.10", pkgname:"python-cinder", pkgver:"2012.2.1-0ubuntu1.1")) flag++;
