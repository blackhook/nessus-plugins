...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Ryan Finnie discovered that the rsync daemon incorrectly handled
invalid usernames. A remote attacker could use this issue to cause
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2171-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"rsync", pkgver:"3.1.0-2ubuntu0.1")) flag++;
