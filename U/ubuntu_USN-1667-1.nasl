...
# extracted from Ubuntu Security Notice USN-1667-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS : bogofilter vulnerability (USN-1667-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1667-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected bogofilter-bdb and / or bogofilter-sqlite
packages."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"bogofilter-bdb", pkgver:"1.2.1-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"bogofilter-sqlite", pkgver:"1.2.1-0ubuntu1.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "bogofilter-bdb / bogofilter-sqlite");
}
