...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.10 : runc vulnerabilities (USN-4297-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that runC incorrectly checked mount targets. An
attacker with a malicious container image could possibly mount over
the /proc directory and escalate privileges. This issue only affected
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4297-1/"
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"runc", pkgver:"1.0.0~rc10-0ubuntu1~18.04.2")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"runc", pkgver:"1.0.0~rc10-0ubuntu1~19.10.2")) flag++;
