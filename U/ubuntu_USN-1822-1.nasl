...
# extracted from Ubuntu Security Notice USN-1822-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : firefox vulnerabilities (USN-1822-1)");
...
invoking Firefox. (CVE-2013-0801, CVE-2013-1669)

Cody Crews discovered that some constructors could be used to bypass
restrictions enforced by their Chrome Object Wrapper (COW). An
attacker could exploit this to conduct cross-site scripting (XSS)
attacks. (CVE-2013-1670)

It was discovered that the file input element could expose the full
local path under certain conditions. An attacker could potentially
exploit this to steal sensitive information. (CVE-2013-1671)

A use-after-free was discovered when resizing video content whilst it
is playing. An attacker could potentially exploit this to execute code
with the privileges of the user invoking Firefox. (CVE-2013-1674)
...
the user invoking Firefox. (CVE-2013-1676, CVE-2013-1677,
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/1822-1/");
...
if (ubuntu_check(osver:"12.04", pkgname:"firefox", pkgver:"21.0+build2-0ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"firefox", pkgver:"21.0+build2-0ubuntu0.12.10.2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"firefox", pkgver:"21.0+build2-0ubuntu0.13.04.2")) flag++;
