...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.04 / 17.10 : openjdk-8 vulnerabilities (USN-3473-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3473-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jdk", pkgver:"8u151-b12-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jdk-headless", pkgver:"8u151-b12-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre", pkgver:"8u151-b12-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-headless", pkgver:"8u151-b12-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-jamvm", pkgver:"8u151-b12-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-zero", pkgver:"8u151-b12-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"openjdk-8-jdk", pkgver:"8u151-b12-0ubuntu0.17.04.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"openjdk-8-jdk-headless", pkgver:"8u151-b12-0ubuntu0.17.04.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"openjdk-8-jre", pkgver:"8u151-b12-0ubuntu0.17.04.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"openjdk-8-jre-headless", pkgver:"8u151-b12-0ubuntu0.17.04.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"openjdk-8-jre-zero", pkgver:"8u151-b12-0ubuntu0.17.04.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"openjdk-8-jdk", pkgver:"8u151-b12-0ubuntu0.17.10.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"openjdk-8-jdk-headless", pkgver:"8u151-b12-0ubuntu0.17.10.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"openjdk-8-jre", pkgver:"8u151-b12-0ubuntu0.17.10.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"openjdk-8-jre-headless", pkgver:"8u151-b12-0ubuntu0.17.10.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"openjdk-8-jre-zero", pkgver:"8u151-b12-0ubuntu0.17.10.2")) flag++;
