...
# extracted from Ubuntu Security Notice USN-1980-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : vino vulnerability (USN-1980-1)");
  ...
  script_set_attribute(
    ...
    value:
"Jonathan Claudius discovered that Vino incorrectly handled closing
invalid connections. A remote attacker could use this issue to cause
Vino to consume resources, resulting in a denial of service.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1980-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"vino", pkgver:"3.4.2-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"vino", pkgver:"3.6.0-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"vino", pkgver:"3.6.2-0ubuntu4.1")) flag++;
