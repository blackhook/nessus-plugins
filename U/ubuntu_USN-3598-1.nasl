...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : curl vulnerabilities (USN-3598-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3598-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"curl", pkgver:"7.35.0-1ubuntu2.15")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libcurl3", pkgver:"7.35.0-1ubuntu2.15")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libcurl3-gnutls", pkgver:"7.35.0-1ubuntu2.15")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libcurl3-nss", pkgver:"7.35.0-1ubuntu2.15")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"curl", pkgver:"7.47.0-1ubuntu2.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libcurl3", pkgver:"7.47.0-1ubuntu2.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libcurl3-gnutls", pkgver:"7.47.0-1ubuntu2.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libcurl3-nss", pkgver:"7.47.0-1ubuntu2.7")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"curl", pkgver:"7.55.1-1ubuntu2.4")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libcurl3", pkgver:"7.55.1-1ubuntu2.4")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libcurl3-gnutls", pkgver:"7.55.1-1ubuntu2.4")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libcurl3-nss", pkgver:"7.55.1-1ubuntu2.4")) flag++;
