...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Marcin Noga discovered that LibreOffice incorrectly handled PPT
documents. If a user were tricked into opening a specially crafted PPT
document, a remote attacker could cause LibreOffice to crash, and
possibly execute arbitrary code. (CVE-2017-12607)

Marcin Noga discovered that LibreOffice incorrectly handled Word
documents. If a user were tricked into opening a specially crafted
Word document, a remote attacker could cause LibreOffice to crash, and
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3472-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libreoffice-core", pkgver:"1:4.2.8-0ubuntu5.2")) flag++;
