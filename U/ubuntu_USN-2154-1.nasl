...
# extracted from Ubuntu Security Notice USN-2154-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2154-1");

  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.10 : ca-certificates update (USN-2154-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2154-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"ca-certificates", pkgver:"20130906ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"ca-certificates", pkgver:"20130906ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"ca-certificates", pkgver:"20130906ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"ca-certificates", pkgver:"20130906ubuntu0.13.10.1")) flag++;
