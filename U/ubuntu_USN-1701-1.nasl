...
# extracted from Ubuntu Security Notice USN-1701-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(55548);
  script_xref(name:"USN", value:"1701-1");

  script_name(english:"Ubuntu 10.04 LTS / 11.10 / 12.04 LTS / 12.10 : vino vulnerability (USN-1701-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1701-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"vino", pkgver:"2.28.2-0ubuntu2.2")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"vino", pkgver:"3.2.0-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"vino", pkgver:"3.4.2-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"vino", pkgver:"3.6.0-0ubuntu1.1")) flag++;
