...
# extracted from Ubuntu Security Notice USN-1601-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 11.04 / 11.10 / 12.04 LTS : bind9 vulnerability (USN-1601-1)");
  ...
  script_set_attribute(
    ...
    value:
"Jake Montgomery discovered that Bind incorrectly handled certain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1601-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"bind9", pkgver:"1:9.4.2.dfsg.P2-2ubuntu0.12")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"bind9", pkgver:"1:9.7.0.dfsg.P1-1ubuntu0.8")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"bind9", pkgver:"1:9.7.3.dfsg-1ubuntu2.7")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"bind9", pkgver:"1:9.7.3.dfsg-1ubuntu4.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"bind9", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.4")) flag++;
