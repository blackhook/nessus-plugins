...
# extracted from Ubuntu Security Notice USN-1584-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(54705);
  script_xref(name:"USN", value:"1584-1");

  script_name(english:"Ubuntu 12.04 LTS : transmission vulnerability (USN-1584-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1584-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"transmission-common", pkgver:"2.51-0ubuntu1.1")) flag++;
