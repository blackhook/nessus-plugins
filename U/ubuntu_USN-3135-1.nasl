...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 16.04 LTS / 16.10 : gst-plugins-good0.10, gst-plugins-good1.0 vulnerability (USN-3135-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3135-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"12.04", pkgname:"gstreamer0.10-plugins-good", pkgver:"0.10.31-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"gstreamer0.10-plugins-good", pkgver:"0.10.31-3+nmu1ubuntu5.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"gstreamer1.0-plugins-good", pkgver:"1.2.4-1~ubuntu1.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"gstreamer1.0-plugins-good", pkgver:"1.8.2-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"gstreamer1.0-plugins-good", pkgver:"1.8.3-1ubuntu1.1")) flag++;
