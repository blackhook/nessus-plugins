...
# extracted from Ubuntu Security Notice USN-1652-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1652-1");

  script_name(english:"Ubuntu 10.04 LTS : linux-lts-backport-oneiric vulnerabilities (USN-1652-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1652-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1652-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-28-generic", pkgver:"3.0.0-28.45~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-28-generic-pae", pkgver:"3.0.0-28.45~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-28-server", pkgver:"3.0.0-28.45~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-28-virtual", pkgver:"3.0.0-28.45~lucid1")) flag++;
