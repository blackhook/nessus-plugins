...
# extracted from Ubuntu Security Notice USN-1114-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1114-1");

  script_name(english:"Ubuntu 9.10 / 10.04 LTS / 10.10 : kdenetwork vulnerability (USN-1114-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1114-1/"
  );
  script_set_attribute(attribute:"solution", value:"Update the affected kget package.");
...
if (ubuntu_check(osver:"9.10", pkgname:"kget", pkgver:"4:4.3.2-0ubuntu4.5")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"kget", pkgver:"4:4.4.5-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"kget", pkgver:"4:4.5.1-0ubuntu2.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "kget");
}
