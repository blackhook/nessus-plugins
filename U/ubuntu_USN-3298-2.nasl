...
# extracted from Ubuntu Security Notice USN-3298-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 17.04 : miniupnpc vulnerability (USN-3298-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3298-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"17.04", pkgname:"libminiupnpc10", pkgver:"1.9.20140610-2ubuntu2.17.04.1")) flag++;
