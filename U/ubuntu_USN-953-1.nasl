...
# extracted from Ubuntu Security Notice USN-953-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"953-1");

  script_name(english:"Ubuntu 8.04 LTS / 9.04 / 9.10 / 10.04 LTS : fastjar vulnerability (USN-953-1)");
...
containing '..' when unpacking archives. If a user or an automated
system were tricked into unpacking a specially crafted jar file,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/953-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"8.04", pkgname:"fastjar", pkgver:"2:0.95-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"9.04", pkgname:"fastjar", pkgver:"2:0.97-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"9.10", pkgname:"fastjar", pkgver:"2:0.98-1ubuntu0.9.10.1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"fastjar", pkgver:"2:0.98-1ubuntu0.10.04.1")) flag++;
