...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.04 : sssd vulnerability (USN-3526-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3526-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected sssd, sssd-common and / or sssd-tools packages."
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"sssd", pkgver:"1.13.4-1ubuntu1.10")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"sssd-common", pkgver:"1.13.4-1ubuntu1.10")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"sssd-tools", pkgver:"1.13.4-1ubuntu1.10")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"sssd", pkgver:"1.15.2-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"sssd-common", pkgver:"1.15.2-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"sssd-tools", pkgver:"1.15.2-1ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "sssd / sssd-common / sssd-tools");
}
