...
if (machine_kernel_release)
{
  ...
  if (preg(pattern:"^18.04$", string:os_release)) {
    kernel_pattern = "^4.15.0-\d+-(aws|dell300x|generic|generic-lpae|kvm|lowlatency|oracle|raspi2)$";
    kernel_mappings = {
            "4.15.0-\d+(-generic|-generic-lpae|-lowlatency)" : "4.15.0-208",
            "4.15.0-\d+-aws" : "4.15.0-1153",
            "4.15.0-\d+-dell300x" : "4.15.0-1062",
            "4.15.0-\d+-kvm" : "4.15.0-1137",
            "4.15.0-\d+-oracle" : "4.15.0-1116",
            "4.15.0-\d+-raspi2" : "4.15.0-1129"
    };
  };
