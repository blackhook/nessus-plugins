...
# extracted from Ubuntu Security Notice USN-1166-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(47652, 48241);
  script_xref(name:"USN", value:"1166-1");

  script_name(english:"Ubuntu 10.04 LTS : oprofile vulnerabilities (USN-1166-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1166-1/"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:oprofile");
...
if (ubuntu_check(osver:"10.04", pkgname:"oprofile", pkgver:"0.9.6-1ubuntu4.4")) flag++;
