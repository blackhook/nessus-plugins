...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 : ICU vulnerability (USN-4305-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"Andre Bargull discovered that ICU incorrectly handled certain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4305-1/"
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libicu63");
...
if (ubuntu_check(osver:"16.04", pkgname:"libicu55", pkgver:"55.1-7ubuntu0.5")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libicu60", pkgver:"60.2-3ubuntu3.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libicu63", pkgver:"63.2-2ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libicu48 / libicu52 / libicu55 / libicu60 / libicu63");
}
