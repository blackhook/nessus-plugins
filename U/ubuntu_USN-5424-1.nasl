...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.10 / 22.04 LTS : OpenLDAP vulnerability (USN-5424-1)");
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'ldap-utils', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'libldap-2.5-0', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'libldap-common', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'libldap-dev', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'libldap2-dev', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'slapd', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'slapd-contrib', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'slapd-smbk5pwd', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'slapi-dev', 'pkgver': '2.5.6+dfsg-1~exp1ubuntu1.1'},
