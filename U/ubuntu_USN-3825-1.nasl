...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS / 18.10 : mod_perl vulnerability (USN-3825-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3825-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected libapache2-mod-perl2 package."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"libapache2-mod-perl2", pkgver:"2.0.8+httpd24-r1449661-6ubuntu2.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libapache2-mod-perl2", pkgver:"2.0.9-4ubuntu1.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libapache2-mod-perl2", pkgver:"2.0.10-2ubuntu3.18.04.1")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"libapache2-mod-perl2", pkgver:"2.0.10-2ubuntu3.18.10.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libapache2-mod-perl2");
}
