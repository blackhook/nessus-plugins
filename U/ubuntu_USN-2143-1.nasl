...
# extracted from Ubuntu Security Notice USN-2143-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(66161);
  script_xref(name:"USN", value:"2143-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.10 : cups-filters vulnerabilities (USN-2143-1)");
...
execute arbitrary code with the privileges of the lp user. This issue
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2143-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected cups-filters package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"cups-filters", pkgver:"1.0.18-0ubuntu0.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"cups-filters", pkgver:"1.0.24-2ubuntu0.2")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"cups-filters", pkgver:"1.0.40-0ubuntu1.1")) flag++;
