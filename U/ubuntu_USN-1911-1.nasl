...
# extracted from Ubuntu Security Notice USN-1911-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1911-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : lcms2 vulnerability (USN-1911-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1911-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected liblcms2-2 package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"liblcms2-2", pkgver:"2.2+git20110628-2ubuntu3.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"liblcms2-2", pkgver:"2.2+git20110628-2ubuntu4.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"liblcms2-2", pkgver:"2.4-0ubuntu3.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "liblcms2-2");
}
