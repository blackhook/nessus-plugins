...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 : OpenLDAP vulnerabilities (USN-4078-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4078-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"slapd", pkgver:"2.4.42+dfsg-2ubuntu3.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"slapd", pkgver:"2.4.45+dfsg-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"slapd", pkgver:"2.4.47+dfsg-3ubuntu2.1")) flag++;
