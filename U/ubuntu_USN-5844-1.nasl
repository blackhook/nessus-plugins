...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : OpenSSL vulnerabilities (USN-5844-1)");
...
vulnerabilities as referenced in the USN-5844-1 advisory.
  ...
  - An invalid pointer dereference on read can be triggered when an application tries to check a malformed DSA
    ...
    such as FIPS 140-3. Thanks to Kurt Roeckx. Fix developed by Shane Lontis from Oracle. Fixed in OpenSSL
    3.0.8 (Affected since 3.0.0). (CVE-2023-0217)
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'libssl-dev', 'pkgver': '3.0.5-2ubuntu2.1'},
    {'osver': '22.10', 'pkgname': 'libssl3', 'pkgver': '3.0.5-2ubuntu2.1'},
    {'osver': '22.10', 'pkgname': 'openssl', 'pkgver': '3.0.5-2ubuntu2.1'}
];
