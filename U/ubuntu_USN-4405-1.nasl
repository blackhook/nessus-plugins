...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : GLib Networking vulnerability (USN-4405-1)");
...
verification if the application failed to specify the server identity.
A remote attacker could use this to perform a person-in-the-middle
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4405-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"glib-networking", pkgver:"2.48.2-1~ubuntu16.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"glib-networking", pkgver:"2.56.0-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"glib-networking", pkgver:"2.62.1-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"glib-networking", pkgver:"2.64.2-1ubuntu0.1")) flag++;
