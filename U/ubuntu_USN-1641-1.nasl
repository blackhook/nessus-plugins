...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1641-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"python-keystone", pkgver:"2012.1+stable~20120824-a16a0ab9-0ubuntu2.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"python-keystone", pkgver:"2012.2-0ubuntu1.2")) flag++;
