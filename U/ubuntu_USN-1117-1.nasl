...
# extracted from Ubuntu Security Notice USN-1117-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 9.10 / 10.04 LTS / 10.10 : policykit-1 vulnerability (USN-1117-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1117-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"9.10", pkgname:"libpolkit-backend-1-0", pkgver:"0.94-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libpolkit-backend-1-0", pkgver:"0.96-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libpolkit-backend-1-0", pkgver:"0.96-2ubuntu1.1")) flag++;
