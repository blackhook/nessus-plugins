...
# extracted from Ubuntu Security Notice USN-15-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : lvm10 vulnerability (USN-15-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(attribute:"solution", value:"Update the affected lvm10 package.");
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:P/A:N");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:lvm10");
...
if (ubuntu_check(osver:"4.10", pkgname:"lvm10", pkgver:"1.0.8-4ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "lvm10");
}
