...
# extracted from Ubuntu Security Notice USN-1889-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : haproxy vulnerability (USN-1889-1)");
  ...
  script_set_attribute(
    ...
    value:
"David Torgerson discovered that HAProxy incorrectly parsed certain
HTTP headers. A remote attacker could use this issue to cause HAProxy
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1889-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"haproxy", pkgver:"1.4.18-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"haproxy", pkgver:"1.4.18-0ubuntu2.2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"haproxy", pkgver:"1.4.18-0ubuntu3.1")) flag++;
