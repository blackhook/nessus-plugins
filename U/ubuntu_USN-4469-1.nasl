...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : Ghostscript vulnerabilities (USN-4469-1)");
...
processing a specially crafted file, a remote attacker could use this
issue to cause Ghostscript to crash, resulting in a denial of service,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4469-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"ghostscript", pkgver:"9.26~dfsg+0-0ubuntu0.16.04.13")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libgs9", pkgver:"9.26~dfsg+0-0ubuntu0.16.04.13")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"ghostscript", pkgver:"9.26~dfsg+0-0ubuntu0.18.04.13")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libgs9", pkgver:"9.26~dfsg+0-0ubuntu0.18.04.13")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"ghostscript", pkgver:"9.50~dfsg-5ubuntu4.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libgs9", pkgver:"9.50~dfsg-5ubuntu4.2")) flag++;
