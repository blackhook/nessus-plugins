...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : linux vulnerability (USN-2598-2)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-2598-1 fixed vulnerabilities in the Linux kernel, however an
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2598-2/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-52-generic", pkgver:"3.13.0-52.86")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-52-generic-lpae", pkgver:"3.13.0-52.86")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-52-lowlatency", pkgver:"3.13.0-52.86")) flag++;
