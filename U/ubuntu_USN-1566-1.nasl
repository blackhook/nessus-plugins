...
# extracted from Ubuntu Security Notice USN-1566-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 11.04 / 11.10 / 12.04 LTS : bind9 vulnerability (USN-1566-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1566-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"libdns36", pkgver:"1:9.4.2.dfsg.P2-2ubuntu0.11")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libdns64", pkgver:"1:9.7.0.dfsg.P1-1ubuntu0.7")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libdns69", pkgver:"1:9.7.3.dfsg-1ubuntu2.6")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libdns69", pkgver:"1:9.7.3.dfsg-1ubuntu4.4")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libdns81", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.3")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libdns36 / libdns64 / libdns69 / libdns81");
}
