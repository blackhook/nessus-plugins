...
# extracted from Ubuntu Security Notice USN-1234-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1234-1");

  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : acpid vulnerability (USN-1234-1)");
  ...
  script_set_attribute(
    ...
    value:
"Vasiliy Kulikov discovered that acpid did not properly handle
connections from poorly behaving clients. A local attacker could
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1234-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"acpid", pkgver:"1.0.10-5ubuntu2.2")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"acpid", pkgver:"1.0.10-5ubuntu4.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"acpid", pkgver:"1:2.0.7-1ubuntu2.1")) flag++;
