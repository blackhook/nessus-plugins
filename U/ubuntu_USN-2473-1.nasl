...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS : coreutils vulnerabilities (USN-2473-1)");
...
on a directory tree under /tmp. This issue only affected Ubuntu 10.04
LTS. (CVE-2009-4135)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2473-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"coreutils", pkgver:"7.4-2ubuntu3.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"coreutils", pkgver:"8.13-3ubuntu3.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"coreutils", pkgver:"8.21-1ubuntu5.1")) flag++;
