...
# extracted from Ubuntu Security Notice USN-1648-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 : linux vulnerabilities (USN-1648-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1648-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1648-1");
  }
  else
  {
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-28-generic", pkgver:"3.0.0-28.45")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-28-generic-pae", pkgver:"3.0.0-28.45")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-28-server", pkgver:"3.0.0-28.45")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-28-virtual", pkgver:"3.0.0-28.45")) flag++;
