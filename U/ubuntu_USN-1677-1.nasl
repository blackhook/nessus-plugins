...
# extracted from Ubuntu Security Notice USN-1677-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 : linux vulnerability (USN-1677-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1677-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1677-1");
  }
  else
  {
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-29-generic", pkgver:"3.0.0-29.46")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-29-generic-pae", pkgver:"3.0.0-29.46")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-29-server", pkgver:"3.0.0-29.46")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-29-virtual", pkgver:"3.0.0-29.46")) flag++;
