...
# extracted from Ubuntu Security Notice USN-399-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : w3m vulnerabilities (USN-399-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/399-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"5.10", pkgname:"w3m", pkgver:"0.5.1-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"w3m-img", pkgver:"0.5.1-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"w3m", pkgver:"0.5.1-4ubuntu2.6.06")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"w3m-img", pkgver:"0.5.1-4ubuntu2.6.06")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"w3m", pkgver:"0.5.1-4ubuntu2.6.10")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"w3m-img", pkgver:"0.5.1-4ubuntu2.6.10")) flag++;
