...
# extracted from Ubuntu Security Notice USN-1851-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(60193);
  script_xref(name:"USN", value:"1851-1");

  script_name(english:"Ubuntu 13.04 : python-keystoneclient vulnerability (USN-1851-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1851-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.04", pkgname:"python-keystoneclient", pkgver:"1:0.2.3-0ubuntu2.2")) flag++;
