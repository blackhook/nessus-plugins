...
# extracted from Ubuntu Security Notice USN-1341-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.10 : linux vulnerabilities (USN-1341-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1341-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2011-1162", "CVE-2011-1759", "CVE-2011-2182", "CVE-2011-2203", "CVE-2011-4110");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1341-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.10", pkgname:"linux-image-2.6.35-32-generic", pkgver:"2.6.35-32.64")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"linux-image-2.6.35-32-generic-pae", pkgver:"2.6.35-32.64")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"linux-image-2.6.35-32-server", pkgver:"2.6.35-32.64")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"linux-image-2.6.35-32-versatile", pkgver:"2.6.35-32.64")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"linux-image-2.6.35-32-virtual", pkgver:"2.6.35-32.64")) flag++;
