...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : batik vulnerability (USN-3280-1)");
...
handled XML external entities. A remote attacker could possibly use
this issue to obtain sensitive files from the filesystem, or cause a
denial of service.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3280-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libbatik-java", pkgver:"1.7.ubuntu-8ubuntu2.14.04.2")) flag++;
