...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 16.04 LTS / 16.10 : bind9 vulnerabilities (USN-3172-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Bind incorrectly handled certain malformed
responses to an ANY query. A remote attacker could possibly use this
...
It was discovered that Bind incorrectly handled certain malformed DS
record responses. A remote attacker could possibly use this issue to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3172-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"bind9", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.20")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-3ubuntu0.11")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-8ubuntu1.4")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"bind9", pkgver:"1:9.10.3.dfsg.P4-10.1ubuntu1.2")) flag++;
