...
# extracted from Ubuntu Security Notice USN-128-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : nasm vulnerability (USN-128-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"nasm", pkgver:"0.98.38-1.1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"nasm", pkgver:"0.98.38-1ubuntu0.2")) flag++;
