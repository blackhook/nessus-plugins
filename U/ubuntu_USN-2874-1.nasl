...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : bind9 vulnerability (USN-2874-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Bind incorrectly handled certain APL data. A
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2874-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"bind9", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.15")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-3ubuntu0.7")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-9ubuntu0.5")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-11ubuntu1.2")) flag++;
