...
# extracted from Ubuntu Security Notice USN-2051-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2051-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 / 13.10 : gimp vulnerability (USN-2051-1)");
...
XWD files. If a user were tricked into opening a specially crafted XWD
file, an attacker could cause GIMP to crash, or possibly execute
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2051-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"gimp", pkgver:"2.6.12-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"gimp", pkgver:"2.8.2-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"gimp", pkgver:"2.8.4-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"gimp", pkgver:"2.8.6-1ubuntu1.1")) flag++;
