...
# extracted from Ubuntu Security Notice USN-91-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : libexif vulnerabilities (USN-91-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libexif-dev and / or libexif10 packages."
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libexif-dev");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libexif10");
...
if (ubuntu_check(osver:"4.10", pkgname:"libexif-dev", pkgver:"0.6.9-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libexif10", pkgver:"0.6.9-1ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libexif-dev / libexif10");
}
