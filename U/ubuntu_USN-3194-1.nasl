...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS : openjdk-7 vulnerabilities (USN-3194-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3194-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"icedtea-7-jre-cacao", pkgver:"7u121-2.6.8-1ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"icedtea-7-jre-jamvm", pkgver:"7u121-2.6.8-1ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"openjdk-7-jdk", pkgver:"7u121-2.6.8-1ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"openjdk-7-jre", pkgver:"7u121-2.6.8-1ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"openjdk-7-jre-headless", pkgver:"7u121-2.6.8-1ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"openjdk-7-jre-lib", pkgver:"7u121-2.6.8-1ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"openjdk-7-jre-zero", pkgver:"7u121-2.6.8-1ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"icedtea-7-jre-jamvm", pkgver:"7u121-2.6.8-1ubuntu0.14.04.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"openjdk-7-jdk", pkgver:"7u121-2.6.8-1ubuntu0.14.04.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"openjdk-7-jre", pkgver:"7u121-2.6.8-1ubuntu0.14.04.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"openjdk-7-jre-headless", pkgver:"7u121-2.6.8-1ubuntu0.14.04.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"openjdk-7-jre-zero", pkgver:"7u121-2.6.8-1ubuntu0.14.04.3")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "icedtea-7-jre-cacao / icedtea-7-jre-jamvm / openjdk-7-jdk / etc");
}
