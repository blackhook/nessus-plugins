...
# extracted from Ubuntu Security Notice USN-1576-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 11.04 / 11.10 / 12.04 LTS : dbus regressions (USN-1576-2)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-1576-1 fixed vulnerabilities in DBus. The update caused a
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1576-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"8.04", pkgname:"dbus", pkgver:"1.1.20-1ubuntu3.9")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libdbus-1-3", pkgver:"1.1.20-1ubuntu3.9")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"dbus", pkgver:"1.2.16-2ubuntu4.7")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libdbus-1-3", pkgver:"1.2.16-2ubuntu4.7")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"dbus", pkgver:"1.4.6-1ubuntu6.4")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libdbus-1-3", pkgver:"1.4.6-1ubuntu6.4")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"dbus", pkgver:"1.4.14-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libdbus-1-3", pkgver:"1.4.14-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"dbus", pkgver:"1.4.18-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libdbus-1-3", pkgver:"1.4.18-1ubuntu1.3")) flag++;
