...
# extracted from Ubuntu Security Notice USN-1872-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.04 : php5 vulnerability (USN-1872-1)");
...
quoted_printable_encode function. An attacker could use this flaw to
cause PHP to crash, resulting in a denial of service, or to possibly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1872-1/"
  );
...
if (ubuntu_check(osver:"13.04", pkgname:"php5", pkgver:"5.4.9-4ubuntu2.1")) flag++;
