...
# extracted from Ubuntu Security Notice USN-1315-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 / 11.10 : jasper vulnerabilities (USN-1315-1)");
  ...
  script_set_attribute(
    ...
    value:
"Jonathan Foote discovered that JasPer incorrectly handled certain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1315-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libjasper1", pkgver:"1.900.1-7ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libjasper1", pkgver:"1.900.1-7ubuntu0.10.10.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libjasper1", pkgver:"1.900.1-7ubuntu2.11.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libjasper1", pkgver:"1.900.1-7ubuntu2.11.10.1")) flag++;
