...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2650-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"wpasupplicant", pkgver:"0.7.3-6ubuntu2.4")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"hostapd", pkgver:"2.1-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"wpasupplicant", pkgver:"2.1-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"hostapd", pkgver:"2.1-0ubuntu4.2")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"wpasupplicant", pkgver:"2.1-0ubuntu4.2")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"hostapd", pkgver:"2.1-0ubuntu7.2")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"wpasupplicant", pkgver:"2.1-0ubuntu7.2")) flag++;
