...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : ClamAV vulnerability (USN-5233-2)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'clamav', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'clamav-base', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'clamav-daemon', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'clamav-freshclam', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'clamav-milter', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'clamav-testfiles', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'clamdscan', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'libclamav-dev', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'libclamav9', 'pkgver': '0.103.5+dfsg-0ubuntu0.16.04.1+esm1'}
];
