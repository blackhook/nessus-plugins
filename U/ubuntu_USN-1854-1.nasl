...
# extracted from Ubuntu Security Notice USN-1854-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1854-1");

  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 : libx11 vulnerabilities (USN-1854-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1854-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libx11-6 package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libx11-6", pkgver:"2:1.3.2-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libx11-6", pkgver:"2:1.4.99.1-0ubuntu2.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libx11-6", pkgver:"2:1.5.0-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libx11-6", pkgver:"2:1.5.0-1ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libx11-6");
}
