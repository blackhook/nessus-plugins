...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Mailman vulnerabilities (USN-5151-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'mailman', 'pkgver': '1:2.1.20-1ubuntu0.6+esm2'},
    {'osver': '18.04', 'pkgname': 'mailman', 'pkgver': '1:2.1.26-1ubuntu0.5'}
];
