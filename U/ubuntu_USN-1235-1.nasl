...
# extracted from Ubuntu Security Notice USN-1235-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS : open-iscsi vulnerability (USN-1235-1)");
...
to overwrite arbitrary files with root privileges.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1235-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"8.04", pkgname:"open-iscsi", pkgver:"2.0.865-1ubuntu3.5")) flag++;
