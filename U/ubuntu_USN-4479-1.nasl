...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : Django vulnerabilities (USN-4479-1)");
...
incorrectly handled directory permissions. A local attacker could
possibly use this issue to obtain sensitive information, or escalate
permissions.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4479-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"20.04", pkgname:"python3-django", pkgver:"2:2.2.12-1ubuntu0.2")) flag++;
