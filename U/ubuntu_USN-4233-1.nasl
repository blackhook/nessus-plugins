...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : gnutls28 update (USN-4233-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4233-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libgnutls30", pkgver:"3.4.10-4ubuntu1.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libgnutls30", pkgver:"3.5.18-1ubuntu1.2")) flag++;
