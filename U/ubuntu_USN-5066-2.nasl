...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : PySAML2 vulnerability (USN-5066-2)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.4+esm1'},
    {'osver': '16.04', 'pkgname': 'python3-pysaml2', 'pkgver': '3.0.0-3ubuntu1.16.04.4+esm1'}
];
