...
# extracted from Ubuntu Security Notice USN-2394-1. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-3610", "CVE-2014-3611", "CVE-2014-3646", "CVE-2014-3647", "CVE-2014-7145");
  script_bugtraq_id(69867, 70742, 70743, 70745, 70748);
  script_xref(name:"USN", value:"2394-1");

  script_name(english:"Ubuntu 12.04 LTS : linux-lts-trusty vulnerabilities (USN-2394-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2394-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2014-3610", "CVE-2014-3611", "CVE-2014-3646", "CVE-2014-3647", "CVE-2014-7145");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2394-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-39-generic", pkgver:"3.13.0-39.66~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-39-generic-lpae", pkgver:"3.13.0-39.66~precise1")) flag++;
