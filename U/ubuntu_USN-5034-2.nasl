...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : c-ares vulnerability (USN-5034-2)");
...
pkgs = [
    {'osver': '16.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.10.0-3ubuntu0.2+esm1'},
    {'osver': '16.04', 'pkgname': 'libc-ares2', 'pkgver': '1.10.0-3ubuntu0.2+esm1'}
];
