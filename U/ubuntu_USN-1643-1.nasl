...
# extracted from Ubuntu Security Notice USN-1643-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(49858, 49911, 56287, 56562);
  script_xref(name:"USN", value:"1643-1");

  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 11.10 / 12.04 LTS / 12.10 : perl vulnerabilities (USN-1643-1)");
...
vulnerable to a heap-based buffer overflow via a crafted Unicode
string. An attacker could use this overflow to cause a denial of
service. (CVE-2011-2939)
...
newlines in Set-Cookie or P3P (Platform for Privacy Preferences
Project) headers. An attacker could use this to inject arbitrary
headers into responses from applications that use CGI.pm.
(CVE-2012-5526).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1643-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"perl", pkgver:"5.8.8-12ubuntu0.7")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"perl", pkgver:"5.10.1-8ubuntu2.2")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"perl", pkgver:"5.12.4-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"perl", pkgver:"5.14.2-6ubuntu2.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"perl", pkgver:"5.14.2-13ubuntu0.1")) flag++;
