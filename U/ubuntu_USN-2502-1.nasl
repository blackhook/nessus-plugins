...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : unzip vulnerabilities (USN-2502-1)");
...
if (ubuntu_check(osver:"12.04", pkgname:"unzip", pkgver:"6.0-4ubuntu2.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"unzip", pkgver:"6.0-9ubuntu1.3")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"unzip", pkgver:"6.0-12ubuntu1.3")) flag++;
