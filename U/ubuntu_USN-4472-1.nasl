...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : PostgreSQL vulnerabilities (USN-4472-1)");
...
attacker could possibly use this issue to execute arbitrary SQL code.
This issue only affected Ubuntu 18.04 LTS and Ubuntu 20.04 LTS.
(CVE-2020-14349) Andres Freund discovered that PostgreSQL incorrectly
handled search path elements in CREATE EXTENSION. A remote attacker
could possibly use this issue to execute arbitrary SQL code.
(CVE-2020-14350).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4472-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Update the affected postgresql-10, postgresql-12 and / or
...
if (ubuntu_check(osver:"16.04", pkgname:"postgresql-9.5", pkgver:"9.5.23-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"postgresql-10", pkgver:"10.14-0ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"postgresql-12", pkgver:"12.4-0ubuntu0.20.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "postgresql-10 / postgresql-12 / postgresql-9.5");
}
