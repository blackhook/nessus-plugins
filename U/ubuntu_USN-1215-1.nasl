...
# extracted from Ubuntu Security Notice USN-1215-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 10.10 / 11.04 : apt vulnerabilities (USN-1215-1)");
...
potentially be used to install altered packages. This update corrects
the issue by disabling the net-update option completely. A future
update will re-enable the option with corrected verification.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1215-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"apt", pkgver:"0.7.9ubuntu17.3")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"apt", pkgver:"0.7.25.3ubuntu9.7")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"apt", pkgver:"0.8.3ubuntu7.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"apt", pkgver:"0.8.13.2ubuntu4.2")) flag++;
