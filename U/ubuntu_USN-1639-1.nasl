...
# extracted from Ubuntu Security Notice USN-1639-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(56650);
  script_xref(name:"USN", value:"1639-1");

  script_name(english:"Ubuntu 12.10 : unity-firefox-extension vulnerability (USN-1639-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that unity-firefox-extension incorrectly handled
certain callbacks. A remote attacker could use this issue to cause
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1639-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.10", pkgname:"xul-ext-unity", pkgver:"2.4.1-0ubuntu1.1")) flag++;
