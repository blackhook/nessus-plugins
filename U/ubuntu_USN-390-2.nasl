...
# extracted from Ubuntu Security Notice USN-390-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : evince vulnerability (USN-390-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/390-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"5.10", pkgname:"evince", pkgver:"0.4.0-0ubuntu4.3")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"evince", pkgver:"0.5.2-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"evince", pkgver:"0.6.1-0ubuntu1.2")) flag++;
