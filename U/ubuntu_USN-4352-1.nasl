...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : openldap vulnerability (USN-4352-1)");
...
remote attacker could possibly use this issue to cause OpenLDAP to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4352-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"slapd", pkgver:"2.4.42+dfsg-2ubuntu3.8")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"slapd", pkgver:"2.4.45+dfsg-1ubuntu1.5")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"slapd", pkgver:"2.4.48+dfsg-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"slapd", pkgver:"2.4.49+dfsg-2ubuntu1.2")) flag++;
