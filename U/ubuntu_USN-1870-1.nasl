...
# extracted from Ubuntu Security Notice USN-1870-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 : libxxf86vm vulnerability (USN-1870-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1870-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxxf86vm1 package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libxxf86vm1", pkgver:"1:1.1.0-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libxxf86vm1", pkgver:"1:1.1.1-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxxf86vm1", pkgver:"1:1.1.2-1ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxxf86vm1", pkgver:"1:1.1.2-1ubuntu0.13.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxxf86vm1");
}
