...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : linux-lts-xenial vulnerabilities (USN-3312-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3312-2/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-4.4.0-79-generic", pkgver:"4.4.0-79.100~14.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-4.4.0-79-generic-lpae", pkgver:"4.4.0-79.100~14.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-4.4.0-79-lowlatency", pkgver:"4.4.0-79.100~14.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-generic-lpae-lts-xenial", pkgver:"4.4.0.79.64")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-generic-lts-xenial", pkgver:"4.4.0.79.64")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-lowlatency-lts-xenial", pkgver:"4.4.0.79.64")) flag++;
