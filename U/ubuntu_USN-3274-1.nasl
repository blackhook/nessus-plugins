...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 / 17.04 : icu vulnerabilities (USN-3274-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3274-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libicu52", pkgver:"52.1-3ubuntu0.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libicu55", pkgver:"55.1-7ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"libicu57", pkgver:"57.1-4ubuntu0.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libicu57", pkgver:"57.1-5ubuntu0.1")) flag++;
