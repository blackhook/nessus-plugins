...
# extracted from Ubuntu Security Notice USN-259-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 : irssi-text vulnerability (USN-259-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected irssi-text package."
  );
...
if (ubuntu_check(osver:"5.10", pkgname:"irssi-text", pkgver:"0.8.9+0.8.10rc5-0ubuntu4.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "irssi-text");
}
