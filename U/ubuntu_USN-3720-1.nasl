...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3720-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"18.04", pkgname:"python-cryptography", pkgver:"2.1.4-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python3-cryptography", pkgver:"2.1.4-1ubuntu1.2")) flag++;
