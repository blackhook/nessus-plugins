...
# extracted from Ubuntu Security Notice USN-1340-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(48236, 50370, 50663, 50750, 50755, 51371);
  script_xref(name:"USN", value:"1340-1");

  script_name(english:"Ubuntu 10.04 LTS : linux-lts-backport-oneiric vulnerabilities (USN-1340-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1340-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2011-2203", "CVE-2011-4077", "CVE-2011-4110", "CVE-2011-4132", "CVE-2011-4330", "CVE-2012-0044");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1340-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-generic", pkgver:"3.0.0-15.25~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-generic-pae", pkgver:"3.0.0-15.25~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-server", pkgver:"3.0.0-15.25~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-15-virtual", pkgver:"3.0.0-15.25~lucid1")) flag++;
