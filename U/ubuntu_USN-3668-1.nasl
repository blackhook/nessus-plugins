...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : exempi vulnerabilities (USN-3668-1)");
...
crafted file, a remote attacker could cause Exempi to hang or crash,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3668-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected exempi and / or libexempi3 packages."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"exempi", pkgver:"2.2.1-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libexempi3", pkgver:"2.2.1-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"exempi", pkgver:"2.2.2-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libexempi3", pkgver:"2.2.2-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"exempi", pkgver:"2.4.3-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libexempi3", pkgver:"2.4.3-1ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "exempi / libexempi3");
}
