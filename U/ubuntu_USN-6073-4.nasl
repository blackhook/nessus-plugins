...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 22.10 / 23.04 : os-brick vulnerability (USN-6073-4)");
...
as referenced in the USN-6073-4 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'os-brick-common', 'pkgver': '6.1.0-0ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'python3-os-brick', 'pkgver': '6.1.0-0ubuntu1.1'},
