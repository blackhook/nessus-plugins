...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.04 / 21.10 : Django vulnerability (USN-5178-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS / 21.04 / 21.10 host has a package installed that is affected by a vulnerability as
referenced in the USN-5178-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'python3-django', 'pkgver': '2:2.2.20-1ubuntu0.3'},
    {'osver': '21.10', 'pkgname': 'python3-django', 'pkgver': '2:2.2.24-1ubuntu1.1'}
];
