...
filter. A remote attacker could use this issue to cause HAProxy to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3011-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"haproxy", pkgver:"1.6.3-1ubuntu0.1")) flag++;
