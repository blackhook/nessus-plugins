...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : jasper vulnerabilities (USN-2483-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2483-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libjasper1", pkgver:"1.900.1-13ubuntu0.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libjasper1", pkgver:"1.900.1-14ubuntu3.2")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"libjasper1", pkgver:"1.900.1-debian1-2ubuntu0.2")) flag++;
