...
# extracted from Ubuntu Security Notice USN-309-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 : libmms vulnerability (USN-309-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libmms-dev and / or libmms0 packages."
  );
...
if (ubuntu_check(osver:"5.10", pkgname:"libmms-dev", pkgver:"0.1-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libmms0", pkgver:"0.1-0ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libmms-dev / libmms0");
}
