...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : linux-azure vulnerability (USN-3488-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3488-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.11.0-1015-azure", pkgver:"4.11.0-1015.15")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-azure", pkgver:"4.11.0.1015.15")) flag++;
