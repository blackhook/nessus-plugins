...
# extracted from Ubuntu Security Notice USN-3149-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3149-2");

  script_name(english:"Ubuntu 12.04 LTS : linux-lts-trusty vulnerability (USN-3149-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3149-2/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-3149-2");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-105-generic", pkgver:"3.13.0-105.152~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-105-generic-lpae", pkgver:"3.13.0-105.152~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-generic-lpae-lts-trusty", pkgver:"3.13.0.105.96")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-generic-lts-trusty", pkgver:"3.13.0.105.96")) flag++;
