...
{
  if (! preg(pattern:"^(5.19.0-\d+-(raspi|raspi-nolpae))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.19.0-\d+(-raspi|-raspi-nolpae)" : "5.19.0-1014"
  };
