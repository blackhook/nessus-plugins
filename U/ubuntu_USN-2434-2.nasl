...
# extracted from Ubuntu Security Notice USN-2434-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2434-2");

  script_name(english:"Ubuntu 10.04 LTS : ghostscript vulnerability (USN-2434-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2434-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libgs8", pkgver:"8.71.dfsg.1-0ubuntu5.6")) flag++;
