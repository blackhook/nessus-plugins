...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 20.10 : PEAR vulnerability (USN-4723-1)");
...
vulnerability as referenced in the USN-4723-1 advisory.
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'php-pear', 'pkgver': '1:1.10.9+submodules+notgz-1ubuntu0.20.10.2'}
];
