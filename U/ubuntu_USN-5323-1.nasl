...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.10 : NBD vulnerabilities (USN-5323-1)");
...
vulnerabilities as referenced in the USN-5323-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'nbd-client', 'pkgver': '1:3.21-1ubuntu0.1'},
    {'osver': '21.10', 'pkgname': 'nbd-server', 'pkgver': '1:3.21-1ubuntu0.1'}
];
