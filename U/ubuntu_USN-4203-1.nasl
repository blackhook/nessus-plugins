...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 / 19.10 : NSS vulnerability (USN-4203-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4203-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libnss3", pkgver:"2:3.28.4-0ubuntu0.16.04.8")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libnss3", pkgver:"2:3.35-2ubuntu2.5")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"libnss3", pkgver:"2:3.42-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libnss3", pkgver:"2:3.45-1ubuntu2.1")) flag++;
