...
"Update the affected linux-image-5.6.0-1056-oem and / or linux-image-oem-20.04 packages.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2020-35519', 'CVE-2021-28375', 'CVE-2021-29646', 'CVE-2021-29650', 'CVE-2021-30002');
...
pkgs = [
    {'osver': '20.04', 'pkgname': 'linux-image-5.6.0-1056-oem', 'pkgver': '5.6.0-1056.60'},
    {'osver': '20.04', 'pkgname': 'linux-image-oem-20.04', 'pkgver': '5.6.0.1056.52'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'linux-image-5.6.0-1056-oem / linux-image-oem-20.04');
}