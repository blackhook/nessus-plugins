...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : xorg-server, xorg-server-hwe-16.04, xorg-server-lts-xenial vulnerabilities (USN-3456-1)");
...
remotely, could use these issues to crash the server, or possibly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3456-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"xserver-xorg-core", pkgver:"2:1.15.1-0ubuntu2.11")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"xserver-xorg-core-lts-xenial", pkgver:"2:1.18.3-1ubuntu2.3~trusty4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"xserver-xorg-core", pkgver:"2:1.18.4-0ubuntu0.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"xserver-xorg-core-hwe-16.04", pkgver:"2:1.19.3-1ubuntu1~16.04.4")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"xserver-xorg-core", pkgver:"2:1.19.3-1ubuntu1.3")) flag++;
