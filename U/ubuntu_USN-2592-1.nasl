...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 / 15.04 : libxml-libxml-perl vulnerability (USN-2592-1)");
...
expand_entities parameter in certain situations. A remote attacker
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2592-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libxml-libxml-perl", pkgver:"1.89+dfsg-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libxml-libxml-perl", pkgver:"2.0108+dfsg-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"libxml-libxml-perl", pkgver:"2.0116+dfsg-1ubuntu0.14.10.1")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"libxml-libxml-perl", pkgver:"2.0116+dfsg-1ubuntu0.15.04.1")) flag++;
