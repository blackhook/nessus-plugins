...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS : libgcrypt11 vulnerability (USN-2339-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2339-2/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libgcrypt11 package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libgcrypt11", pkgver:"1.4.4-5ubuntu2.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgcrypt11", pkgver:"1.5.0-3ubuntu0.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libgcrypt11", pkgver:"1.5.3-2ubuntu4.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libgcrypt11");
}
