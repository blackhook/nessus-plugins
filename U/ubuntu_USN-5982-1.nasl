...
{
  if (! preg(pattern:"^(5.15.0-\d+-(aws|azure|azure-fde|gcp|generic|generic-64k|generic-lpae|gkeop|lowlatency|lowlatency-64k|oracle|raspi|raspi-nolpae))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.15.0-\d+(-generic|-generic-64k|-generic-lpae|-lowlatency|-lowlatency-64k)" : "5.15.0-69",
    "5.15.0-\d+(-raspi|-raspi-nolpae)" : "5.15.0-1026",
    "5.15.0-\d+-aws" : "5.15.0-1033",
    "5.15.0-\d+-azure" : "5.15.0-1035",
    "5.15.0-\d+-azure-fde" : "5.15.0-1035",
    "5.15.0-\d+-gcp" : "5.15.0-1031",
    "5.15.0-\d+-gkeop" : "5.15.0-1017",
    "5.15.0-\d+-oracle" : "5.15.0-1032"
  };
