...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.10 : Django vulnerabilities (USN-5269-1)");
...
vulnerabilities as referenced in the USN-5269-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'python3-django', 'pkgver': '2:2.2.24-1ubuntu1.3'}
];
