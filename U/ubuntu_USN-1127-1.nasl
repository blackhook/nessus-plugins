...
# extracted from Ubuntu Security Notice USN-1127-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : usb-creator vulnerability (USN-1127-1)");
...
restrictions when performing privileged disk operations. A local
attacker could use this flaw to perform certain disk operations, such
as unmount arbitrary mountpoints.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1127-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"usb-creator-common", pkgver:"0.2.22.3")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"usb-creator-common", pkgver:"0.2.25.3")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"usb-creator-common", pkgver:"0.2.28.3")) flag++;
