...
# extracted from Ubuntu Security Notice USN-1015-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.10 : libvpx vulnerability (USN-1015-1)");
...
WebM file, an attacker could cause a denial of service or possibly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1015-1/"
  );
...
if (ubuntu_check(osver:"10.10", pkgname:"libvpx", pkgver:"0.9.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libvpx-dev", pkgver:"0.9.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libvpx-doc", pkgver:"0.9.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libvpx0", pkgver:"0.9.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libvpx0-dbg", pkgver:"0.9.2-1ubuntu0.1")) flag++;
