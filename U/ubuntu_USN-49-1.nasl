...
# extracted from Ubuntu Security Notice USN-49-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : debmake vulnerability (USN-49-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected debmake package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:N/I:P/A:N");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:debmake");
...
if (ubuntu_check(osver:"4.10", pkgname:"debmake", pkgver:"3.7.4ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "debmake");
}
