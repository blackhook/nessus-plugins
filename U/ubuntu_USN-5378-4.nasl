...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : Gzip vulnerability (USN-5378-4)");
...
var pkgs = [
    {'osver': '14.04', 'pkgname': 'gzip', 'pkgver': '1.6-3ubuntu1+esm1'},
    {'osver': '16.04', 'pkgname': 'gzip', 'pkgver': '1.6-4ubuntu1+esm1'}
];
