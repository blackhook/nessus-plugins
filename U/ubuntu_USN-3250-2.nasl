...
# extracted from Ubuntu Security Notice USN-3250-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3250-2");

  script_name(english:"Ubuntu 12.04 LTS : linux-lts-trusty vulnerability (USN-3250-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3250-2/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-3250-2");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-115-generic", pkgver:"3.13.0-115.162~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-115-generic-lpae", pkgver:"3.13.0-115.162~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-generic-lpae-lts-trusty", pkgver:"3.13.0.115.106")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-generic-lts-trusty", pkgver:"3.13.0.115.106")) flag++;
