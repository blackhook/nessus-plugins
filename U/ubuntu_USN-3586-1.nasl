...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : isc-dhcp vulnerabilities (USN-3586-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3586-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"isc-dhcp-client", pkgver:"4.2.4-7ubuntu12.12")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"isc-dhcp-relay", pkgver:"4.2.4-7ubuntu12.12")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"isc-dhcp-server", pkgver:"4.2.4-7ubuntu12.12")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"isc-dhcp-server-ldap", pkgver:"4.2.4-7ubuntu12.12")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"isc-dhcp-client", pkgver:"4.3.3-5ubuntu12.9")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"isc-dhcp-relay", pkgver:"4.3.3-5ubuntu12.9")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"isc-dhcp-server", pkgver:"4.3.3-5ubuntu12.9")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"isc-dhcp-server-ldap", pkgver:"4.3.3-5ubuntu12.9")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"isc-dhcp-client", pkgver:"4.3.5-3ubuntu2.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"isc-dhcp-relay", pkgver:"4.3.5-3ubuntu2.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"isc-dhcp-server", pkgver:"4.3.5-3ubuntu2.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"isc-dhcp-server-ldap", pkgver:"4.3.5-3ubuntu2.2")) flag++;
