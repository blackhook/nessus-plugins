...
# extracted from Ubuntu Security Notice USN-2149-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2149-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.10 : librsvg vulnerability (USN-2149-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2149-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"librsvg2-2", pkgver:"2.36.1-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"librsvg2-2", pkgver:"2.36.3-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"librsvg2-2", pkgver:"2.36.4-2ubuntu0.1")) flag++;
