...
# extracted from Ubuntu Security Notice USN-1008-3. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1008-3");

  script_name(english:"Ubuntu 10.04 LTS : libvirt update (USN-1008-3)");
...
10.04 LTS reverted a recent bug fix update. This update fixes the
problem.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1008-3/"
  );
  ...
  script_set_attribute(attribute:"patch_publication_date", value:"2010/10/23");
...
if (ubuntu_check(osver:"10.04", pkgname:"libvirt-bin", pkgver:"0.7.5-5ubuntu27.6")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libvirt-dev", pkgver:"0.7.5-5ubuntu27.6")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libvirt-doc", pkgver:"0.7.5-5ubuntu27.6")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libvirt0", pkgver:"0.7.5-5ubuntu27.6")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libvirt0-dbg", pkgver:"0.7.5-5ubuntu27.6")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"python-libvirt", pkgver:"0.7.5-5ubuntu27.6")) flag++;
