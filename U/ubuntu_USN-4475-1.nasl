...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 : Chrony vulnerability (USN-4475-1)");
...
links. An attacker could possibly use this issue to cause a denial of
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4475-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"chrony", pkgver:"3.2-4ubuntu4.5")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"chrony", pkgver:"3.5-6ubuntu6.2")) flag++;
