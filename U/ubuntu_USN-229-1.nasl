...
# extracted from Ubuntu Security Notice USN-229-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 : zope2.8 vulnerability (USN-229-1)");
...
if (ubuntu_check(osver:"5.10", pkgname:"zope2.8", pkgver:"2.8.1-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"zope2.8-sandbox", pkgver:"2.8.1-5ubuntu0.1")) flag++;
