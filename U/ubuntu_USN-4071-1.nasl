...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 : Patch vulnerabilities (USN-4071-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4071-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"patch", pkgver:"2.7.5-1ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"patch", pkgver:"2.7.6-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"patch", pkgver:"2.7.6-3ubuntu0.1")) flag++;
