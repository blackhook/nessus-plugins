...
# extracted from Ubuntu Security Notice USN-1859-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 : libxi vulnerabilities (USN-1859-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1859-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxi6 package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libxi6", pkgver:"2:1.3-3ubuntu0.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libxi6", pkgver:"2:1.6.0-0ubuntu2.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxi6", pkgver:"2:1.6.1-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxi6", pkgver:"2:1.6.99.1-0ubuntu3.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxi6");
}
