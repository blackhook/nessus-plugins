...
# extracted from Ubuntu Security Notice USN-88-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : reportbug information disclosure (USN-88-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected reportbug package."
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:reportbug");
...
if (ubuntu_check(osver:"4.10", pkgname:"reportbug", pkgver:"2.62ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "reportbug");
}
