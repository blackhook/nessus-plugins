...
# extracted from Ubuntu Security Notice USN-1338-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.04 : rsyslog vulnerability (USN-1338-1)");
  ...
  script_set_attribute(
    ...
    value:
"Peter Eisentraut discovered that Rsyslog would not properly perform
input validation when configured to use imfile. If an attacker were
able to craft messages in a file that Rsyslog monitored, an attacker
could cause a denial of service. The imfile module is disabled by
default in Ubuntu.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1338-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.04", pkgname:"rsyslog", pkgver:"4.6.4-2ubuntu4.2")) flag++;
