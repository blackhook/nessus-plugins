...
{
  if (! preg(pattern:"^(4.15.0-\d{4}-(aws|aws-hwe))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.15.0-\d{4}-(aws|aws-hwe)" : "4.15.0-1142"
  };
