...
# extracted from Ubuntu Security Notice USN-97-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : xfree86 vulnerability (USN-97-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"lbxproxy", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libdps-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libdps1", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libdps1-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libice-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libice6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libice6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libsm-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libsm6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libsm6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libx11-6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libx11-6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libx11-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxaw6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxaw6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxaw6-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxaw7", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxaw7-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxaw7-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxext-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxext6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxext6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxft1", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxft1-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxi-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxi6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxi6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxmu-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxmu6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxmu6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxmuu-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxmuu1", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxmuu1-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxp-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxp6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxp6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxpm-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxpm4", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxpm4-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxrandr-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxrandr2", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxrandr2-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxt-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxt6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxt6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxtrap-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxtrap6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxtrap6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxtst-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxtst6", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxtst6-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxv-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxv1", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxv1-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"pm-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"proxymngr", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"twm", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"x-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"x-window-system", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"x-window-system-core", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"x-window-system-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xbase-clients", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xdm", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-100dpi", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-100dpi-transcoded", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-75dpi", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-75dpi-transcoded", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-base", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-base-transcoded", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-cyrillic", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfonts-scalable", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfree86-common", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfs", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xfwp", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-dri", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-dri-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-gl", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-gl-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-gl-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-glu", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-glu-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa-glu-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa3", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibmesa3-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibosmesa-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibosmesa4", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibosmesa4-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibs", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibs-data", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibs-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibs-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibs-pic", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibs-static-dev", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xlibs-static-pic", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xmh", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xnest", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xprt", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xserver-common", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xserver-xfree86", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xserver-xfree86-dbg", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xspecs", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xterm", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xutils", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"xvfb", pkgver:"4.3.0.dfsg.1-6ubuntu25.2")) flag++;
