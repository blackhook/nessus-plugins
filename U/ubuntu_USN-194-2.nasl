...
# extracted from Ubuntu Security Notice USN-194-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 / 5.10 : texinfo regression bug fix (USN-194-2)");
...
if (ubuntu_check(osver:"5.04", pkgname:"info", pkgver:"4.7-2.2ubuntu1.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"texinfo", pkgver:"4.7-2.2ubuntu1.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"info", pkgver:"4.7-2.2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"texinfo", pkgver:"4.7-2.2ubuntu2.1")) flag++;
