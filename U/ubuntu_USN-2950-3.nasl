...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 / 16.04 LTS : samba regressions (USN-2950-3) (Badlock)");
  ...
  script_set_attribute(
    ...
    value:
"USN-2950-1 fixed vulnerabilities in Samba. The fixes introduced in
Samba 4.3.8 caused certain regressions and interoperability issues.

This update resolves some of these issues by updating to Samba 4.3.9
in Ubuntu 14.04 LTS, Ubuntu 15.10 and Ubuntu 16.04 LTS. Backported
regression fixes were added to Samba 3.6.25 in Ubuntu 12.04 LTS.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2950-3/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"samba", pkgver:"2:3.6.25-0ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"samba", pkgver:"2:4.3.9+dfsg-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"samba", pkgver:"2:4.3.9+dfsg-0ubuntu0.15.10.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"samba", pkgver:"2:4.3.9+dfsg-0ubuntu0.16.04.1")) flag++;
