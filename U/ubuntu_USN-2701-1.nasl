...
# extracted from Ubuntu Security Notice USN-2701-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : linux-lts-trusty vulnerabilities (USN-2701-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2701-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2701-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-61-generic", pkgver:"3.13.0-61.100~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-61-generic-lpae", pkgver:"3.13.0-61.100~precise1")) flag++;
