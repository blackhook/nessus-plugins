...
{
  if (! preg(pattern:"^(4.15.0-\d{4}-(oracle|snapdragon)|5.4.0-\d{3}-(generic|generic-lpae|lowlatency)|5.4.0-\d{4}-(aws|gkeop))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.15.0-\d{4}-oracle" : "4.15.0-1113",
    "4.15.0-\d{4}-snapdragon" : "4.15.0-1144",
    "5.4.0-\d{3}-(generic|generic-lpae|lowlatency)" : "5.4.0-137",
    "5.4.0-\d{4}-aws" : "5.4.0-1094",
    "5.4.0-\d{4}-gkeop" : "5.4.0-1062"
  };
