...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 20.10 : PyYAML vulnerability (USN-4940-1)");
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'python3-yaml', 'pkgver': '5.3.1-2ubuntu0.1'}
];
