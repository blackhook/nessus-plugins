...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.04 : python-pysaml2 vulnerability (USN-3402-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that PySAML2 incorrectly handled certain SAML XML
requests and responses. A remote attacker could use this issue to read
arbitrary files.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3402-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"python-pysaml2", pkgver:"3.0.0-3ubuntu1.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-pysaml2", pkgver:"3.0.0-3ubuntu1.16.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"python-pysaml2", pkgver:"3.0.0-3ubuntu1.17.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"python3-pysaml2", pkgver:"3.0.0-3ubuntu1.17.04.1")) flag++;
