...
# extracted from Ubuntu Security Notice USN-2168-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.10 : python-imaging vulnerabilities (USN-2168-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2168-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"python-imaging", pkgver:"1.1.7-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python-imaging", pkgver:"1.1.7-4ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"python-imaging", pkgver:"1.1.7-4ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"python-imaging", pkgver:"1.1.7+2.0.0-1ubuntu1.1")) flag++;
