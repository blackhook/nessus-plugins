...
# extracted from Ubuntu Security Notice USN-2789-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : xscreensaver vulnerability (USN-2789-1)");
...
external monitor. An attacker with physical access could use this flaw
to gain access to a locked session.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2789-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"xscreensaver", pkgver:"5.15-2ubuntu1.1")) flag++;
