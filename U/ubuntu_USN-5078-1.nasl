...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.04 : Squashfs-Tools vulnerability (USN-5078-1)");
...
referenced in the USN-5078-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'squashfs-tools', 'pkgver': '1:4.4-2ubuntu0.2'}
];
