...
# extracted from Ubuntu Security Notice USN-1115-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.10 : language-selector vulnerability (USN-1115-1)");
  ...
  script_set_attribute(
    ...
    value:
"Romain Perier discovered that the language-selector D-Bus backend did
not correctly check for Policy Kit authorizations. A local attacker
could exploit this to inject shell commands into the system-wide
locale configuration file, leading to root privilege escalation.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1115-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.10", pkgname:"language-selector-common", pkgver:"0.6.7")) flag++;
