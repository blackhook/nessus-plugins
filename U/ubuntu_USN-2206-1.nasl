...
# extracted from Ubuntu Security Notice USN-2206-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.10 : horizon vulnerability (USN-2206-1)");
...
perform input sanitization for Heat templates. If a user were tricked
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2206-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.10", pkgname:"openstack-dashboard", pkgver:"1:2013.2.3-0ubuntu1.1")) flag++;
