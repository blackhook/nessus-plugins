...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : linux vulnerability (USN-2204-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2204-1/");
...
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-24-generic", pkgver:"3.13.0-24.47")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-24-generic-lpae", pkgver:"3.13.0-24.47")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-24-lowlatency", pkgver:"3.13.0-24.47")) flag++;
