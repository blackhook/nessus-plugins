...
# extracted from Ubuntu Security Notice USN-1956-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1956-1");

  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 : hplip vulnerability (USN-1956-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that HPLIP was using polkit in an unsafe manner. A
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1956-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"hplip", pkgver:"3.10.2-2ubuntu2.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"hplip", pkgver:"3.12.2-1ubuntu3.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"hplip", pkgver:"3.12.6-3ubuntu4.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"hplip", pkgver:"3.13.3-1ubuntu0.1")) flag++;
