...
# extracted from Ubuntu Security Notice USN-1497-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 / 12.04 LTS : nova vulnerabilities (USN-1497-1)");
...
arbitrary files of the host running Nova. A remote attacker could use
this to cause a denial of service or possibly gain privileges.
(CVE-2012-3361).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1497-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.10", pkgname:"python-nova", pkgver:"2011.3-0ubuntu6.9")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python-nova", pkgver:"2012.1+stable~20120612-3ee026e-0ubuntu1.1")) flag++;
