...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : rpm vulnerabilities (USN-2479-1)");
  ...
  script_set_attribute(
    ...
    value:
"Florian Weimer discovered that RPM incorrectly handled temporary
files. A local attacker could use this issue to execute arbitrary
code. (CVE-2013-6435)
...
malicious package file, a remote attacker could use this issue to
cause RPM to crash, resulting in a denial of service, or possibly
execute arbitrary code. (CVE-2014-8118).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2479-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"rpm", pkgver:"4.9.1.1-1ubuntu0.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"rpm", pkgver:"4.11.1-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"rpm", pkgver:"4.11.2-3ubuntu0.1")) flag++;
