...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.10 : Gzip vulnerability (USN-5378-1)");
...
referenced in the USN-5378-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'gzip', 'pkgver': '1.10-4ubuntu1.1'},
    {'osver': '21.10', 'pkgname': 'gzip-win32', 'pkgver': '1.10-4ubuntu1.1'}
];
