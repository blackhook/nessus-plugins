...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : rabbitmq-server vulnerability (USN-3374-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3374-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected rabbitmq-server package."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"rabbitmq-server", pkgver:"3.2.4-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"rabbitmq-server", pkgver:"3.5.7-1ubuntu0.16.04.2")) flag++;
