...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS : lxml vulnerability (USN-5225-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-lxml', 'pkgver': '3.5.0-1ubuntu0.4+esm2'},
    {'osver': '16.04', 'pkgname': 'python3-lxml', 'pkgver': '3.5.0-1ubuntu0.4+esm2'},
    {'osver': '18.04', 'pkgname': 'python-lxml', 'pkgver': '4.2.1-1ubuntu0.6'},
    {'osver': '18.04', 'pkgname': 'python3-lxml', 'pkgver': '4.2.1-1ubuntu0.6'},
    {'osver': '20.04', 'pkgname': 'python-lxml', 'pkgver': '4.5.0-1ubuntu0.5'},
    {'osver': '20.04', 'pkgname': 'python3-lxml', 'pkgver': '4.5.0-1ubuntu0.5'}
];
