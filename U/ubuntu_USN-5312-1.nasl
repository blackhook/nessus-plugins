...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.10 : HAProxy vulnerability (USN-5312-1)");
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'haproxy', 'pkgver': '2.2.9-2ubuntu2.1'},
    {'osver': '21.10', 'pkgname': 'vim-haproxy', 'pkgver': '2.2.9-2ubuntu2.1'}
];
