...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.10 / 14.04 LTS : cinder vulnerability (USN-2248-1)");
...
Cinder did not properly set up its sudo configuration. If a different
flaw was found in OpenStack Cinder, this vulnerability could be used
to escalate privileges. (CVE-2013-1068).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2248-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.10", pkgname:"python-cinder", pkgver:"1:2013.2.3-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"python-cinder", pkgver:"1:2014.1-0ubuntu1.1")) flag++;
