...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 13.10 / 14.04 LTS : transmission vulnerability (USN-2279-1)");
  ...
  script_set_attribute(
    ...
    value:
"Ben Hawkes discovered that Transmission incorrectly handled certain
peer messages. A remote attacker could use this issue to cause a
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2279-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"transmission-common", pkgver:"2.51-0ubuntu1.4")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"transmission-common", pkgver:"2.82-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"transmission-common", pkgver:"2.82-1.1ubuntu3.1")) flag++;
