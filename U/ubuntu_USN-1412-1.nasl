...
# extracted from Ubuntu Security Notice USN-1412-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(50312);
  script_xref(name:"USN", value:"1412-1");

  script_name(english:"Ubuntu 11.10 : linux vulnerability (USN-1412-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1412-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2011-3347");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1412-1");
  }
  else
  {
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-17-generic", pkgver:"3.0.0-17.30")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-17-generic-pae", pkgver:"3.0.0-17.30")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-17-server", pkgver:"3.0.0-17.30")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-17-virtual", pkgver:"3.0.0-17.30")) flag++;
