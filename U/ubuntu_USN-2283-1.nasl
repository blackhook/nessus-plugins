...
# extracted from Ubuntu Security Notice USN-2283-1. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2014-0131", "CVE-2014-4608", "CVE-2014-4943");
  script_bugtraq_id(66101, 68214, 68683);
  script_xref(name:"USN", value:"2283-1");

  script_name(english:"Ubuntu 12.04 LTS : linux vulnerabilities (USN-2283-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2283-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2014-0131", "CVE-2014-4608", "CVE-2014-4943");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2283-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-67-generic", pkgver:"3.2.0-67.101")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-67-generic-pae", pkgver:"3.2.0-67.101")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-67-highbank", pkgver:"3.2.0-67.101")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-67-virtual", pkgver:"3.2.0-67.101")) flag++;
