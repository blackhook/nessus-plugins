...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 20.10 : lxml vulnerability (USN-4896-1)");
...
vulnerability as referenced in the USN-4896-1 advisory.
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'python3-lxml', 'pkgver': '4.5.2-1ubuntu0.4'}
];
