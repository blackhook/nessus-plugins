...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : mailman vulnerability (USN-3563-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Mailman incorrectly handled certain web
scripts. An attacker could possibly use this to inject arbitrary code.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3563-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"mailman", pkgver:"1:2.1.16-2ubuntu0.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"mailman", pkgver:"1:2.1.20-1ubuntu0.3")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"mailman", pkgver:"1:2.1.23-1ubuntu0.2")) flag++;
