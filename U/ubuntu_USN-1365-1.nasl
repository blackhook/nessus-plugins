...
# extracted from Ubuntu Security Notice USN-1365-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.10 / 11.04 / 11.10 : Puppet vulnerability (USN-1365-1)");
...
circumstances. An attacker on an authenticated puppet node could
exploit this to view or manipulate resources on other Puppet nodes.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1365-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.10", pkgname:"puppet-common", pkgver:"2.6.1-0ubuntu2.5")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"puppet-common", pkgver:"2.6.4-2ubuntu2.7")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"puppet-common", pkgver:"2.7.1-1ubuntu3.4")) flag++;
