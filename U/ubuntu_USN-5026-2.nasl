...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : QPDF vulnerabilities (USN-5026-2)");
...
pkgs = [
    {'osver': '16.04', 'pkgname': 'libqpdf-dev', 'pkgver': '8.0.2-3~16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'libqpdf21', 'pkgver': '8.0.2-3~16.04.1+esm1'},
    {'osver': '16.04', 'pkgname': 'qpdf', 'pkgver': '8.0.2-3~16.04.1+esm1'}
];
