...
# extracted from Ubuntu Security Notice USN-629-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 7.04 / 7.10 / 8.04 LTS : mozilla-thunderbird, thunderbird vulnerabilities (USN-629-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/629-1/"
  );
