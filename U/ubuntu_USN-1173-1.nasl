...
# extracted from Ubuntu Security Notice USN-1173-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1173-1");

  script_name(english:"Ubuntu 10.10 / 11.04 : freetype vulnerability (USN-1173-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1173-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.10", pkgname:"libfreetype6", pkgver:"2.4.2-2ubuntu0.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libfreetype6", pkgver:"2.4.4-1ubuntu2.1")) flag++;
