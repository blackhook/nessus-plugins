...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.04 : poppler vulnerability (USN-4091-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4091-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Update the affected libpoppler73, libpoppler85 and / or poppler-utils
packages."
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"libpoppler73", pkgver:"0.62.0-2ubuntu2.10")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"poppler-utils", pkgver:"0.62.0-2ubuntu2.10")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"libpoppler85", pkgver:"0.74.0-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"poppler-utils", pkgver:"0.74.0-0ubuntu1.3")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libpoppler73 / libpoppler85 / poppler-utils");
}
