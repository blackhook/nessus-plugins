...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS / 14.10 : unzip vulnerability (USN-2489-1)");
...
if (ubuntu_check(osver:"10.04", pkgname:"unzip", pkgver:"6.0-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"unzip", pkgver:"6.0-4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"unzip", pkgver:"6.0-9ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"unzip", pkgver:"6.0-12ubuntu1.2")) flag++;
