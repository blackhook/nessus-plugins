...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : bind9 vulnerability (USN-2503-1)");
...
Management. A remote attacker could use this issue to cause bind to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2503-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"bind9", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.10")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-3ubuntu0.2")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"bind9", pkgver:"1:9.9.5.dfsg-4.3ubuntu0.2")) flag++;
