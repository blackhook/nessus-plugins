...
# extracted from Ubuntu Security Notice USN-1869-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1869-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : libxxf86dga vulnerabilities (USN-1869-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1869-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxxf86dga1 package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libxxf86dga1", pkgver:"2:1.1.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxxf86dga1", pkgver:"2:1.1.3-2ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxxf86dga1", pkgver:"2:1.1.3-2ubuntu0.13.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxxf86dga1");
}
