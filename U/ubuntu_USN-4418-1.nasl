...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : OpenEXR vulnerabilities (USN-4418-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4418-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"libopenexr22", pkgver:"2.2.0-10ubuntu2.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openexr", pkgver:"2.2.0-10ubuntu2.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libopenexr22", pkgver:"2.2.0-11.1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"openexr", pkgver:"2.2.0-11.1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libopenexr23", pkgver:"2.2.1-4.1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"openexr", pkgver:"2.2.1-4.1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libopenexr24", pkgver:"2.3.0-6ubuntu0.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"openexr", pkgver:"2.3.0-6ubuntu0.2")) flag++;
