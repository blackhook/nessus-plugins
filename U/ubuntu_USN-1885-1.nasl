...
# extracted from Ubuntu Security Notice USN-1885-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1885-1");

  script_name(english:"Ubuntu 12.04 LTS : libkdcraw vulnerability (USN-1885-1)");
...
specially crafted raw image, applications linked against libKDcraw
could be made to crash, resulting in a denial of service, or possibly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1885-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libkdcraw20", pkgver:"4:4.8.5-0ubuntu0.2")) flag++;
