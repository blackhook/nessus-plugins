...
# extracted from Ubuntu Security Notice USN-2454-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.10 : exiv2 vulnerability (USN-2454-1)");
...
specially crafted video file, a remote attacker could cause Exiv2 to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2454-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libexiv2-13 package."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:N/I:N/A:P");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libexiv2-13");
...
if (ubuntu_check(osver:"14.10", pkgname:"libexiv2-13", pkgver:"0.24-2ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libexiv2-13");
}
