...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS / 18.10 : libarchive vulnerabilities (USN-3859-1)");
...
service. CVE-2018-1000880 affected only Ubuntu 18.04 LTS and Ubuntu
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3859-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libarchive13", pkgver:"3.1.2-7ubuntu2.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libarchive13", pkgver:"3.1.2-11ubuntu0.16.04.5")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libarchive13", pkgver:"3.2.2-3.1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"libarchive13", pkgver:"3.2.2-5ubuntu0.1")) flag++;
