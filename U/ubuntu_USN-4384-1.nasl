...
if (description)
{
  ...
  script_name(english:"Ubuntu 19.10 / 20.04 : gnutls28 vulnerability (USN-4384-1)");
...
encryption keys. A remote attacker could possibly use this issue to
bypass authentication or recover sensitive information.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4384-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"19.10", pkgname:"libgnutls30", pkgver:"3.6.9-5ubuntu1.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libgnutls30", pkgver:"3.6.13-2ubuntu1.1")) flag++;
