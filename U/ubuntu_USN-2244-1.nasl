...
# extracted from Ubuntu Security Notice USN-2244-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2244-1");

  script_name(english:"Ubuntu 12.04 LTS / 13.10 : libav vulnerability (USN-2244-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2244-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (! preg(pattern:"^(12\.04|13\.10)$", string:release)) audit(AUDIT_OS_NOT, "Ubuntu 12.04 / 13.10", "Ubuntu " + release);
...
if (ubuntu_check(osver:"12.04", pkgname:"libavcodec53", pkgver:"4:0.8.12-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libavformat53", pkgver:"4:0.8.12-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libavcodec53", pkgver:"6:0.8.12-0ubuntu0.13.10.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libavformat53", pkgver:"6:0.8.12-0ubuntu0.13.10.1")) flag++;
