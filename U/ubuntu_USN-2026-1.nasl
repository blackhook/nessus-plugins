...
# extracted from Ubuntu Security Notice USN-2026-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.10 : libvirt vulnerability (USN-2026-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2026-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.10", pkgname:"libvirt0", pkgver:"1.1.1-0ubuntu8.1")) flag++;
