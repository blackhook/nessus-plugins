...
# extracted from Ubuntu Security Notice USN-223-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 : inkscape vulnerability (USN-223-1)");
...
if (ubuntu_check(osver:"5.04", pkgname:"inkscape", pkgver:"0.40-2ubuntu1.1")) flag++;
