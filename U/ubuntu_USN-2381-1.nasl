...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS : rsyslog vulnerabilities (USN-2381-1)");
...
An attacker could use this issue to send malformed messages to the
Rsyslog server and cause it to stop responding, resulting in a denial
of service and possibly message loss. (CVE-2014-3634, CVE-2014-3683).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2381-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"rsyslog", pkgver:"4.2.0-2ubuntu8.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"rsyslog", pkgver:"5.8.6-1ubuntu8.9")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"rsyslog", pkgver:"7.4.4-1ubuntu2.3")) flag++;
