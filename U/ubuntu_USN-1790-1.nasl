...
# extracted from Ubuntu Security Notice USN-1790-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(58101, 58240, 58468);
  script_xref(name:"USN", value:"1790-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 : libav vulnerabilities (USN-1790-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1790-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libavcodec53", pkgver:"4:0.8.6-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libavformat53", pkgver:"4:0.8.6-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libavcodec53", pkgver:"6:0.8.6-0ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libavformat53", pkgver:"6:0.8.6-0ubuntu0.12.10.1")) flag++;
