...
# extracted from Ubuntu Security Notice USN-2215-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 13.10 : libgadu vulnerability (USN-2215-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2215-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libgadu3", pkgver:"1:1.11.1-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libgadu3", pkgver:"1:1.11.2-1ubuntu1.2")) flag++;
