...
# extracted from Ubuntu Security Notice USN-78-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : mailman vulnerabilities (USN-78-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"mailman", pkgver:"2.1.5-1ubuntu2.3")) flag++;
