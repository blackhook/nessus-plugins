...
the USN-5432-1 advisory.
  ...
  - An issue has been found in libpng 1.6.34. It is a SEGV in the function png_free_data in png.c, related to
    the recommended error handling for png_read_image. (CVE-2018-14048)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libpng12-0', 'pkgver': '1.2.54-1ubuntu1.1+esm1'},
    {'osver': '16.04', 'pkgname': 'libpng12-dev', 'pkgver': '1.2.54-1ubuntu1.1+esm1'},
    {'osver': '16.04', 'pkgname': 'libpng3', 'pkgver': '1.2.54-1ubuntu1.1+esm1'}
];
