...
# extracted from Ubuntu Security Notice USN-139-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : gaim vulnerability (USN-139-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"gaim", pkgver:"1.0.0-1ubuntu1.5")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"gaim", pkgver:"1.1.4-1ubuntu4.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"gaim-data", pkgver:"1.1.4-1ubuntu4.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"gaim-dev", pkgver:"1.1.4-1ubuntu4.2")) flag++;
