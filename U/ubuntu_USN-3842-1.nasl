...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS / 18.10 : CUPS vulnerability (USN-3842-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3842-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"cups", pkgver:"1.7.2-0ubuntu1.11")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"cups", pkgver:"2.1.3-4ubuntu0.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"cups", pkgver:"2.2.7-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"cups", pkgver:"2.2.8-5ubuntu1.1")) flag++;
