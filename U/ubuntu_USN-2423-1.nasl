...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : clamav vulnerabilities (USN-2423-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2423-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"clamav", pkgver:"0.98.5+addedllvm-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"clamav", pkgver:"0.98.5+addedllvm-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"clamav", pkgver:"0.98.5+dfsg-0ubuntu0.14.10.1")) flag++;
