...
# extracted from Ubuntu Security Notice USN-1847-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.04 : linux vulnerability (USN-1847-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1847-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1847-1");
  }
  else
  {
...
if (ubuntu_check(osver:"13.04", pkgname:"linux-image-3.8.0-23-generic", pkgver:"3.8.0-23.34")) flag++;
