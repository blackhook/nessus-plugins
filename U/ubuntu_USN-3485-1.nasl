...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : linux, linux-aws, linux-gke, linux-kvm, linux-raspi2, linux-snapdragon vulnerabilities (USN-3485-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3485-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-101-generic", pkgver:"4.4.0-101.124")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-101-generic-lpae", pkgver:"4.4.0-101.124")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-101-lowlatency", pkgver:"4.4.0-101.124")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-1010-kvm", pkgver:"4.4.0-1010.15")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-1034-gke", pkgver:"4.4.0-1034.34")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-1041-aws", pkgver:"4.4.0-1041.50")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-1077-raspi2", pkgver:"4.4.0-1077.85")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-1079-snapdragon", pkgver:"4.4.0-1079.84")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-aws", pkgver:"4.4.0.1041.43")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-generic", pkgver:"4.4.0.101.106")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-generic-lpae", pkgver:"4.4.0.101.106")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-gke", pkgver:"4.4.0.1034.35")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-kvm", pkgver:"4.4.0.1010.10")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-lowlatency", pkgver:"4.4.0.101.106")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-raspi2", pkgver:"4.4.0.1077.77")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-snapdragon", pkgver:"4.4.0.1079.71")) flag++;
