...
# extracted from Ubuntu Security Notice USN-392-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : xine-lib vulnerability (USN-392-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/392-1/"
  );
...
if (ubuntu_check(osver:"5.10", pkgname:"libxine-dev", pkgver:"1.0.1-1ubuntu10.7")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libxine1c2", pkgver:"1.0.1-1ubuntu10.7")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libxine-dev", pkgver:"1.1.1+ubuntu2-7.5")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libxine-main1", pkgver:"1.1.1+ubuntu2-7.5")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libxine-dev", pkgver:"1.1.2+repacked1-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libxine-main1", pkgver:"1.1.2+repacked1-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libxine1", pkgver:"1.1.2+repacked1-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libxine1-dbg", pkgver:"1.1.2+repacked1-0ubuntu3.2")) flag++;
