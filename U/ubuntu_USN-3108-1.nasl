...
# extracted from Ubuntu Security Notice USN-3108-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3108-1");

  script_name(english:"Ubuntu 12.04 LTS : bind9 vulnerability (USN-3108-1)");
...
packets with malformed options. A remote attacker could possibly use
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3108-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"bind9", pkgver:"1:9.8.1.dfsg.P1-4ubuntu0.18")) flag++;
