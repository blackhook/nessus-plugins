...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : clamav vulnerabilities (USN-3592-1)");
...
Hanno Bock discovered that ClamAV incorrectly handled parsing certain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3592-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"clamav", pkgver:"0.99.4+addedllvm-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"clamav", pkgver:"0.99.4+addedllvm-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"clamav", pkgver:"0.99.4+addedllvm-0ubuntu0.17.10.1")) flag++;
