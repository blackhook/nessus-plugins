...
# extracted from Ubuntu Security Notice USN-238-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 : blender vulnerability (USN-238-2)");
...
if (ubuntu_check(osver:"5.10", pkgname:"blender", pkgver:"2.37a-1ubuntu1.1")) flag++;
