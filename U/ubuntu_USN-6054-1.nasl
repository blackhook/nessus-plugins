...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 / 23.04 : Django vulnerability (USN-6054-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'python3-django', 'pkgver': '3:3.2.15-1ubuntu1.3'},
