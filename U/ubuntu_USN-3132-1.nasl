...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 16.04 LTS / 16.10 : tar vulnerability (USN-3132-1)");
  ...
  script_set_attribute(
    ...
    value:
"Harry Sintonen discovered that tar incorrectly handled extracting
files when path names are specified on the command line. If a user or
automated system were tricked into processing a specially crafted
archive, an attacker could possibly overwrite arbitrary files.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3132-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"tar", pkgver:"1.26-4ubuntu1.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"tar", pkgver:"1.27.1-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"tar", pkgver:"1.28-2.1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"tar", pkgver:"1.29b-1ubuntu0.1")) flag++;
