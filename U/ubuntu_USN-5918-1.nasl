...
{
  if (! preg(pattern:"^(5.4.0-\d+(-bluefield))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.4.0-\d+-bluefield" : "5.4.0-1058"
  };
