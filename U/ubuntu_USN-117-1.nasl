...
# extracted from Ubuntu Security Notice USN-117-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : cvs vulnerability (USN-117-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"cvs", pkgver:"1.12.9-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"cvs", pkgver:"1.12.9-1ubuntu0.1")) flag++;
