...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : Pillow vulnerabilities (USN-4430-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4430-2/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected python3-pil package."
  );
...
if (ubuntu_check(osver:"20.04", pkgname:"python3-pil", pkgver:"7.0.0-4ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "python3-pil");
}
