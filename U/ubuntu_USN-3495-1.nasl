...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 / 17.10 : optipng vulnerability (USN-3495-1)");
...
attacker could use this issue with a specially crafted image file to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3495-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"optipng", pkgver:"0.6.4-1ubuntu0.14.04.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"optipng", pkgver:"0.7.6-1ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"optipng", pkgver:"0.7.6-1ubuntu0.17.04.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"optipng", pkgver:"0.7.6-1ubuntu0.17.10.1")) flag++;
