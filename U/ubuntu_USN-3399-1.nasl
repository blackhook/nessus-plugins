...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : cvs vulnerability (USN-3399-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3399-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"cvs", pkgver:"2:1.12.13+real-12ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"cvs", pkgver:"2:1.12.13+real-15ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"cvs", pkgver:"2:1.12.13+real-22ubuntu0.1")) flag++;
