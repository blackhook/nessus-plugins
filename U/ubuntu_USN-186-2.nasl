...
# extracted from Ubuntu Security Notice USN-186-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : mozilla-firefox vulnerabilities (USN-186-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:
"Update the affected mozilla-firefox and / or
mozilla-firefox-dom-inspector packages."
  );
...
if (ubuntu_check(osver:"4.10", pkgname:"mozilla-firefox", pkgver:"1.0.7-0ubuntu0.0.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"mozilla-firefox-dom-inspector", pkgver:"1.0.7-0ubuntu0.0.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "mozilla-firefox / mozilla-firefox-dom-inspector");
}
