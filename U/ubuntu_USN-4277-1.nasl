...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 : libexif vulnerabilities (USN-4277-1)");
...
information or cause a denial of service. This issue only affected
Ubuntu 12.04 ESM, Ubuntu 14.04 ESM and Ubuntu 16.04 LTS.
(CVE-2016-6328)

Lili Xu and Bingchang Liu discovered that libexif incorrectly handled
certain files. An attacker could possibly use this issue to access
sensitive information or cause a denial of service. This issue only
affected Ubuntu 12.04 ESM, Ubuntu 14.04 ESM and Ubuntu 16.04 LTS.
(CVE-2017-7544)

It was discovered that libexif incorrectly handled certain files. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4277-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libexif12", pkgver:"0.6.21-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libexif12", pkgver:"0.6.21-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libexif12", pkgver:"0.6.21-5.1ubuntu0.1")) flag++;
