...
# extracted from Ubuntu Security Notice USN-1309-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.04 / 11.10 : isc-dhcp vulnerability (USN-1309-1)");
...
malformed packets when configured to evaluate regular expressions. A
remote attacker could use this issue to cause DHCP to crash, resulting
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1309-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.04", pkgname:"isc-dhcp-server", pkgver:"4.1.1-P1-15ubuntu9.3")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"isc-dhcp-server", pkgver:"4.1.1-P1-17ubuntu10.1")) flag++;
