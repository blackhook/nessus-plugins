...
# extracted from Ubuntu Security Notice USN-1845-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1845-1");

  script_name(english:"Ubuntu 12.04 LTS : linux-lts-quantal vulnerability (USN-1845-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1845-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1845-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.5.0-32-generic", pkgver:"3.5.0-32.53~precise1")) flag++;
