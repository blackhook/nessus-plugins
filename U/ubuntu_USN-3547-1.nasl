...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : libtasn1-6 vulnerabilities (USN-3547-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Libtasn1 incorrectly handled certain files. If
a user were tricked into opening a crafted file, an attacker could
...
attacker could possibly use this to cause Libtasn1 to hang, resulting
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3547-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libtasn1-6", pkgver:"3.4-3ubuntu0.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libtasn1-6", pkgver:"4.7-3ubuntu0.16.04.3")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libtasn1-6", pkgver:"4.12-2.1ubuntu0.1")) flag++;
