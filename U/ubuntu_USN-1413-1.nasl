...
# extracted from Ubuntu Security Notice USN-1413-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 : nova vulnerability (USN-1413-1)");
  ...
  script_set_attribute(
    ...
    value:
"Dan Prince discovered that Nova did not properly perform input
validation on the length of server names. An authenticated attacker
could issue requests using long server names to exhaust the storage
resources containing the Nova API log file.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1413-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.10", pkgname:"python-nova", pkgver:"2011.3-0ubuntu6.5")) flag++;
