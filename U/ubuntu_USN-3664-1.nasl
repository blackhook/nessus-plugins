...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.10 / 18.04 LTS : Apport vulnerability (USN-3664-1)");
...
certain files are missing from /proc. A local attacker could possibly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3664-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"apport", pkgver:"2.20.1-0ubuntu2.18")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"apport", pkgver:"2.20.7-0ubuntu3.9")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"apport", pkgver:"2.20.9-0ubuntu7.1")) flag++;
