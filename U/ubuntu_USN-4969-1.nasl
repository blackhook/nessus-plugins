...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 20.10 : DHCP vulnerability (USN-4969-1)");
...
referenced in the USN-4969-1 advisory.
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'isc-dhcp-client', 'pkgver': '4.4.1-2.1ubuntu10.1'},
    {'osver': '20.10', 'pkgname': 'isc-dhcp-client-ddns', 'pkgver': '4.4.1-2.1ubuntu10.1'},
    {'osver': '20.10', 'pkgname': 'isc-dhcp-client-udeb', 'pkgver': '4.4.1-2.1ubuntu10.1'},
    {'osver': '20.10', 'pkgname': 'isc-dhcp-common', 'pkgver': '4.4.1-2.1ubuntu10.1'},
    {'osver': '20.10', 'pkgname': 'isc-dhcp-dev', 'pkgver': '4.4.1-2.1ubuntu10.1'},
    {'osver': '20.10', 'pkgname': 'isc-dhcp-relay', 'pkgver': '4.4.1-2.1ubuntu10.1'},
    {'osver': '20.10', 'pkgname': 'isc-dhcp-server', 'pkgver': '4.4.1-2.1ubuntu10.1'},
    {'osver': '20.10', 'pkgname': 'isc-dhcp-server-ldap', 'pkgver': '4.4.1-2.1ubuntu10.1'}
];
