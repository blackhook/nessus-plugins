...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : SQLite vulnerability (USN-4438-1)");
...
optimization. An attacker could use this issue to cause SQLite to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4438-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"20.04", pkgname:"libsqlite3-0", pkgver:"3.31.1-4ubuntu0.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"sqlite3", pkgver:"3.31.1-4ubuntu0.2")) flag++;
