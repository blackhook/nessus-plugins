...
# extracted from Ubuntu Security Notice USN-1687-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1687-1");

  script_name(english:"Ubuntu 10.04 LTS / 11.10 / 12.04 LTS / 12.10 : nss vulnerability (USN-1687-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1687-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libnss3-1d", pkgver:"3.14.1-0ckbi1.93ubuntu.0.10.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libnss3-1d", pkgver:"3.14.1-0ckbi1.93ubuntu.0.11.10.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libnss3-1d", pkgver:"3.14.1-0ckbi1.93ubuntu.0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libnss3-1d", pkgver:"3.14.1-0ckbi1.93ubuntu.0.12.10.1")) flag++;
