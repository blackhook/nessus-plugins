...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.04 : HTMLDOC vulnerability (USN-5198-1)");
...
var pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'htmldoc', 'pkgver': '1.9.11-2ubuntu0.1'},
    {'osver': '21.04', 'pkgname': 'htmldoc-common', 'pkgver': '1.9.11-2ubuntu0.1'}
];
