...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 15.04 / 15.10 : icedtea-web vulnerabilities (USN-2817-1)");
...
remote attacker could possibly use this issue to inject applets into
the .appletTrustSettings configuration file and bypass user approval.
(CVE-2015-5234)

Andrea Palazzo discovered that IcedTea Web incorrectly determined the
origin of unsigned applets. A remote attacker could possibly use this
issue to bypass user approval, or to trick the user into approving
applet execution. (CVE-2015-5235).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2817-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"icedtea-6-plugin", pkgver:"1.5.3-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"icedtea-7-plugin", pkgver:"1.5.3-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"icedtea-7-plugin", pkgver:"1.5.3-0ubuntu0.15.04.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"icedtea-7-plugin", pkgver:"1.5.3-0ubuntu0.15.10.1")) flag++;
