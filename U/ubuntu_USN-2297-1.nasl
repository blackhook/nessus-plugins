...
# extracted from Ubuntu Security Notice USN-2297-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : acpi-support vulnerability (USN-2297-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2297-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected acpi-support package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:M/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:acpi-support");
...
if (ubuntu_check(osver:"12.04", pkgname:"acpi-support", pkgver:"0.140.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "acpi-support");
}
