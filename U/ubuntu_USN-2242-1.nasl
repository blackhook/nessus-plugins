...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 13.10 / 14.04 LTS : dpkg vulnerabilities (USN-2242-1)");
...
unpacking source packages. If a user or an automated system were
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2242-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"dpkg-dev", pkgver:"1.15.5.6ubuntu4.9")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libdpkg-perl", pkgver:"1.16.1.2ubuntu7.5")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libdpkg-perl", pkgver:"1.16.12ubuntu1.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libdpkg-perl", pkgver:"1.17.5ubuntu5.3")) flag++;
