...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS / 14.10 : wget vulnerability (USN-2393-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2393-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"wget", pkgver:"1.12-1.1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"wget", pkgver:"1.13.4-2ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"wget", pkgver:"1.15-1ubuntu1.14.04.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"wget", pkgver:"1.15-1ubuntu1.14.10.1")) flag++;
