...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 / 17.10 : wget vulnerabilities (USN-3464-1)");
  ...
  script_set_attribute(
    ...
    value:
"Antti Levomaki, Christian Jalio, and Joonas Pihlaja discovered that
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3464-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"wget", pkgver:"1.15-1ubuntu1.14.04.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"wget", pkgver:"1.17.1-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"wget", pkgver:"1.18-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"wget", pkgver:"1.19.1-3ubuntu1.1")) flag++;
