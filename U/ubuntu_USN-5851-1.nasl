...
{
  if (! preg(pattern:"^(5.15.0-\d{2}-(generic|generic-64k|generic-lpae|lowlatency|lowlatency-64k)|5.15.0-\d{4}-(azure|gkeop|ibm|kvm|oracle|raspi|raspi-nolpae))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.15.0-\d{2}-(generic|generic-64k|generic-lpae|lowlatency|lowlatency-64k)" : "5.15.0-60",
    "5.15.0-\d{4}-(raspi|raspi-nolpae)" : "5.15.0-1024",
    "5.15.0-\d{4}-azure" : "5.15.0-1033",
    "5.15.0-\d{4}-gkeop" : "5.15.0-1015",
    "5.15.0-\d{4}-ibm" : "5.15.0-1025",
    "5.15.0-\d{4}-kvm" : "5.15.0-1028",
    "5.15.0-\d{4}-oracle" : "5.15.0-1029"
  };
