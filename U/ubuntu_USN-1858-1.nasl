...
# extracted from Ubuntu Security Notice USN-1858-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(60125);
  script_xref(name:"USN", value:"1858-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : libxfixes vulnerability (USN-1858-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1858-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxfixes3 package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libxfixes3", pkgver:"1:5.0-4ubuntu4.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxfixes3", pkgver:"1:5.0-4ubuntu5.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxfixes3", pkgver:"1:5.0-4ubuntu5.13.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxfixes3");
}
