...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 / 18.04 LTS : Firefox regressions (USN-3705-2)");
  ...
  script_set_attribute(
    ...
    value:
"USN-3705-1 fixed vulnerabilities in Firefox. The update introduced
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3705-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"firefox", pkgver:"61.0.1+build1-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"firefox", pkgver:"61.0.1+build1-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"firefox", pkgver:"61.0.1+build1-0ubuntu0.17.10.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"firefox", pkgver:"61.0.1+build1-0ubuntu0.18.04.1")) flag++;
