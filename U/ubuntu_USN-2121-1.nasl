...
# extracted from Ubuntu Security Notice USN-2121-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2121-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.10 : gnutls26 vulnerability (USN-2121-1)");
...
intermediate certificates. This resulted in them being considered to
be a valid CA certificate by default, which was contrary to documented
behaviour.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2121-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libgnutls26", pkgver:"2.12.14-5ubuntu3.6")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libgnutls26", pkgver:"2.12.14-5ubuntu4.5")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libgnutls26", pkgver:"2.12.23-1ubuntu4.1")) flag++;
