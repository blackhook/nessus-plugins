...
# extracted from Ubuntu Security Notice USN-594-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"594-1");

  script_name(english:"Ubuntu 6.06 LTS / 6.10 : libnet-dns-perl vulnerability (USN-594-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Net::DNS did not correctly validate the size of
DNS replies. A remote attacker could send a specially crafted DNS
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/594-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"6.06", pkgname:"libnet-dns-perl", pkgver:"0.53-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libnet-dns-perl", pkgver:"0.57-1ubuntu1.1")) flag++;
