...
# extracted from Ubuntu Security Notice USN-2114-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.10 : linux vulnerabilities (USN-2114-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2114-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2013-2929", "CVE-2013-4592", "CVE-2013-6378", "CVE-2013-6380");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2114-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.10", pkgname:"linux-image-3.5.0-46-generic", pkgver:"3.5.0-46.70")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"linux-image-3.5.0-46-highbank", pkgver:"3.5.0-46.70")) flag++;
