...
# extracted from Ubuntu Security Notice USN-1143-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1143-1");

  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : dovecot vulnerability (USN-1143-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1143-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"dovecot-common", pkgver:"1:1.2.9-1ubuntu6.4")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"dovecot-common", pkgver:"1:1.2.12-1ubuntu8.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"dovecot-common", pkgver:"1:1.2.15-3ubuntu2.1")) flag++;
