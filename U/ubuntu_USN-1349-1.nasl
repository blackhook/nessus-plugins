...
# extracted from Ubuntu Security Notice USN-1349-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 / 11.10 : xorg vulnerability (USN-1349-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that the X wrapper incorrectly checked certain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1349-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected xserver-xorg package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"xserver-xorg", pkgver:"1:7.5+5ubuntu1.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"xserver-xorg", pkgver:"1:7.5+6ubuntu3.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"xserver-xorg", pkgver:"1:7.6+4ubuntu3.2")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"xserver-xorg", pkgver:"1:7.6+7ubuntu7.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "xserver-xorg");
}
