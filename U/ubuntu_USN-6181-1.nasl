...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.10 / 23.04 : Ruby vulnerabilities (USN-6181-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 22.10 / 23.04 host has packages installed that are affected by multiple vulnerabilities as referenced
in the USN-6181-1 advisory.
...
if (! ('22.10' >< os_release || '23.04' >< os_release)) audit(AUDIT_OS_NOT, 'Ubuntu 22.10 / 23.04', 'Ubuntu ' + os_release);
...
var pkgs = [
    {'osver': '22.10', 'pkgname': 'libruby3.1', 'pkgver': '3.1.2-2ubuntu0.22.10.1'},
    {'osver': '22.10', 'pkgname': 'ruby3.1', 'pkgver': '3.1.2-2ubuntu0.22.10.1'},
    {'osver': '22.10', 'pkgname': 'ruby3.1-dev', 'pkgver': '3.1.2-2ubuntu0.22.10.1'},
