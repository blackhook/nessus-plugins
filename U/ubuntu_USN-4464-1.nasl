...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : GNOME Shell vulnerability (USN-4464-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that GNOME Shell incorrectly handled the login
screen password dialog. Sensitive information could possibly be
exposed during user logout.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4464-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"20.04", pkgname:"gnome-shell", pkgver:"3.36.4-1ubuntu1~20.04.2")) flag++;
