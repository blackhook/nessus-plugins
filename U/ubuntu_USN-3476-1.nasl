...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 / 17.10 : postgresql-common vulnerabilities (USN-3476-1)");
...
14.04 LTS and Ubuntu 16.04 LTS. (CVE-2016-1255)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3476-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"postgresql-common", pkgver:"154ubuntu1.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"postgresql-common", pkgver:"173ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"postgresql-common", pkgver:"179ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"postgresql-common", pkgver:"184ubuntu1.1")) flag++;
