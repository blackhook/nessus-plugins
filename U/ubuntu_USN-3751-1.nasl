...
patches."
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Spice incorrectly handled certain messages. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3751-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"libspice-server1", pkgver:"0.12.4-0nocelt2ubuntu1.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libspice-protocol-dev", pkgver:"0.12.10-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libspice-server1", pkgver:"0.14.0-1ubuntu2.2")) flag++;
