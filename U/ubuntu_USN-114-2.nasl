...
# extracted from Ubuntu Security Notice USN-114-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 : kdelibs fixed packages (USN-114-2)");
...
if (ubuntu_check(osver:"5.04", pkgname:"kdelibs", pkgver:"3.4.0-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"kdelibs-bin", pkgver:"3.4.0-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"kdelibs-data", pkgver:"3.4.0-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"kdelibs4", pkgver:"3.4.0-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"kdelibs4-dev", pkgver:"3.4.0-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"kdelibs4-doc", pkgver:"3.4.0-0ubuntu3.2")) flag++;
