...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : Sysstat vulnerability (USN-5748-1)");
...
vulnerability as referenced in the USN-5748-1 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'isag', 'pkgver': '12.5.6-1ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'sysstat', 'pkgver': '12.5.6-1ubuntu0.1'}
];
