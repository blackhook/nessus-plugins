...
# extracted from Ubuntu Security Notice USN-3285-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.10 / 17.04 : lightdm vulnerability (USN-3285-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3285-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.10", pkgname:"lightdm", pkgver:"1.19.5-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"lightdm", pkgver:"1.22.0-0ubuntu2.1")) flag++;
