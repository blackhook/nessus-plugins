...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 : apt vulnerability (USN-3156-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3156-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"apt", pkgver:"1.0.1ubuntu2.17")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"apt", pkgver:"1.2.15ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"apt", pkgver:"1.3.2ubuntu0.1")) flag++;
