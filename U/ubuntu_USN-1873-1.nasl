...
# extracted from Ubuntu Security Notice USN-1873-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(58282, 60237);
  script_xref(name:"USN", value:"1873-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : telepathy-gabble vulnerabilities (USN-1873-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1873-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"telepathy-gabble", pkgver:"0.16.0-0ubuntu3.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"telepathy-gabble", pkgver:"0.16.1-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"telepathy-gabble", pkgver:"0.16.5-0ubuntu1.1")) flag++;
