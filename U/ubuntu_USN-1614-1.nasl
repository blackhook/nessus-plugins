...
# extracted from Ubuntu Security Notice USN-1614-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(55757, 56115);
  script_xref(name:"USN", value:"1614-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 : ruby1.9.1 vulnerabilities (USN-1614-1)");
  ...
  script_set_attribute(
    ...
    value:
"Tyler Hicks and Shugo Maeda discovered that Ruby incorrectly allowed
...
USN-1602-1 fixed these vulnerabilities in other Ubuntu releases. This
update provides the corresponding updates for Ubuntu 12.10.
(CVE-2012-4464, CVE-2012-4466)

Peter Bex discovered that Ruby incorrectly handled file path strings
when opening files. An attacker could use this flaw to open or create
unexpected files. (CVE-2012-4522).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1614-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libruby1.9.1", pkgver:"1.9.3.0-1ubuntu2.4")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libruby1.9.1", pkgver:"1.9.3.194-1ubuntu1.2")) flag++;
