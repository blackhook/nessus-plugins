...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : samba vulnerabilities (USN-3426-1)");
...
across DFS redirects. A remote attacker could use this issue to
perform a man in the middle attack. (CVE-2017-12151)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3426-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"samba", pkgver:"2:4.3.11+dfsg-0ubuntu0.14.04.12")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"samba", pkgver:"2:4.3.11+dfsg-0ubuntu0.16.04.11")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"samba", pkgver:"2:4.5.8+dfsg-0ubuntu0.17.04.7")) flag++;
