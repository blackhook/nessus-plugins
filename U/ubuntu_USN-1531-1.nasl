...
# extracted from Ubuntu Security Notice USN-1531-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1531-1");

  script_name(english:"Ubuntu 11.04 : linux vulnerabilities (USN-1531-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1531-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2012-2136", "CVE-2012-2372", "CVE-2012-2390");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1531-1");
  }
  else
  {
...
if (ubuntu_check(osver:"11.04", pkgname:"linux-image-2.6.38-15-generic", pkgver:"2.6.38-15.65")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"linux-image-2.6.38-15-generic-pae", pkgver:"2.6.38-15.65")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"linux-image-2.6.38-15-server", pkgver:"2.6.38-15.65")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"linux-image-2.6.38-15-versatile", pkgver:"2.6.38-15.65")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"linux-image-2.6.38-15-virtual", pkgver:"2.6.38-15.65")) flag++;
