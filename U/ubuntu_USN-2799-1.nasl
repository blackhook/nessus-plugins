...
# extracted from Ubuntu Security Notice USN-2799-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 15.04 : linux vulnerabilities (USN-2799-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2799-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2015-2925", "CVE-2015-5257");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2799-1");
  }
  else
  {
...
if (ubuntu_check(osver:"15.04", pkgname:"linux-image-3.19.0-32-generic", pkgver:"3.19.0-32.37")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"linux-image-3.19.0-32-generic-lpae", pkgver:"3.19.0-32.37")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"linux-image-3.19.0-32-lowlatency", pkgver:"3.19.0-32.37")) flag++;
