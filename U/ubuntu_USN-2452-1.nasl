...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS / 14.10 : nss vulnerability (USN-2452-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2452-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libnss3-1d", pkgver:"3.17.1-0ubuntu0.10.04.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libnss3", pkgver:"3.17.1-0ubuntu0.12.04.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libnss3", pkgver:"2:3.17.1-0ubuntu0.14.04.2")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"libnss3", pkgver:"2:3.17.1-0ubuntu1.1")) flag++;
