...
# extracted from Ubuntu Security Notice USN-1732-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 : openssl regression (USN-1732-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security-related
patches.");
  script_set_attribute(attribute:"description", value:
"USN-1732-1 fixed vulnerabilities in OpenSSL. The fix for CVE-2013-0166
and CVE-2012-2686 introduced a regression causing decryption failures
on hardware supporting AES-NI. This update temporarily reverts the
security fix pending further investigation. We apologize for the
inconvenience.
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/1732-2/");
  script_set_attribute(attribute:"solution", value:
"Update the affected libssl1.0.0 and / or openssl packages.");
...
if (ubuntu_check(osver:"12.04", pkgname:"libssl1.0.0", pkgver:"1.0.1-4ubuntu5.7")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"openssl", pkgver:"1.0.1-4ubuntu5.7")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libssl1.0.0", pkgver:"1.0.1c-3ubuntu2.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"openssl", pkgver:"1.0.1c-3ubuntu2.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libssl1.0.0 / openssl");
}
