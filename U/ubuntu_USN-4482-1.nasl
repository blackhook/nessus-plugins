...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : Ark vulnerability (USN-4482-1)");
...
tar archive that, when opened, would create files outside the
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4482-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"ark", pkgver:"4:15.12.3-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"ark", pkgver:"4:17.12.3-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"ark", pkgver:"4:19.12.3-0ubuntu1.2")) flag++;
