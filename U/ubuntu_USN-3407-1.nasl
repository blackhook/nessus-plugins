...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.04 : pyjwt vulnerability (USN-3407-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3407-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected python-jwt and / or python3-jwt packages."
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"python-jwt", pkgver:"1.3.0-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-jwt", pkgver:"1.3.0-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"python-jwt", pkgver:"1.4.2-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"python3-jwt", pkgver:"1.4.2-1ubuntu0.1")) flag++;
