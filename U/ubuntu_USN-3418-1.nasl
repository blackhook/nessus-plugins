...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : gdk-pixbuf vulnerabilities (USN-3418-1)");
...
opening a specially crafted jpeg file, a remote attacker could use
this flaw to cause GDK-PixBuf to crash, resulting in a denial of
service, or possibly execute arbitrary code. (CVE-2017-2862)

It was discovered that the GDK-PixBuf library did not properly handle
certain tiff images. If an user or automated system were tricked into
opening a specially crafted tiff file, a remote attacker could use
this flaw to cause GDK-PixBuf to crash, resulting in a denial of
service, or possibly execute arbitrary code. (CVE-2017-2870)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3418-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libgdk-pixbuf2.0-0", pkgver:"2.30.7-0ubuntu1.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libgdk-pixbuf2.0-0", pkgver:"2.32.2-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libgdk-pixbuf2.0-0", pkgver:"2.36.5-3ubuntu0.2")) flag++;
