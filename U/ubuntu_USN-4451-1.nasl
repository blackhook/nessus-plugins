...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : ppp vulnerability (USN-4451-1)");
...
discovered that ppp incorrectly handled module loading. A local
attacker could use this issue to load arbitrary kernel modules and
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4451-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"ppp", pkgver:"2.4.7-1+2ubuntu1.16.04.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"ppp", pkgver:"2.4.7-2+2ubuntu1.3")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"ppp", pkgver:"2.4.7-2+4.1ubuntu5.1")) flag++;
