...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4079-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected libsox2 and / or sox packages."
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"libsox2", pkgver:"14.4.1-5+deb8u4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"sox", pkgver:"14.4.1-5+deb8u4ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libsox2 / sox");
}
