...
protocol. A remote attacker could use this issue to cause ppp to
crash, resulting in a denial of service, or possibly bypass
authentication.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3810-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"ppp", pkgver:"2.4.5-5.1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"ppp", pkgver:"2.4.7-1+2ubuntu1.16.04.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"ppp", pkgver:"2.4.7-2+2ubuntu1.1")) flag++;
