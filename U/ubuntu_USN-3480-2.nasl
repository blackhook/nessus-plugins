...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.04 / 17.10 : apport regressions (USN-3480-2)");
...
introduced a regression in the ability to handle crashes for users
that configured their systems to use the Upstart init system in Ubuntu
16.04 LTS and Ubuntu 17.04. The fix for CVE-2017-14180 temporarily
...
Sander Bos discovered that Apport incorrectly handled core
dumps for processes in a different PID namespace. A local
attacker could use this issue to perform a denial of service
via resource exhaustion or possibly gain root privileges.
(CVE-2017-14180).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3480-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"apport", pkgver:"2.20.1-0ubuntu2.13")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"apport", pkgver:"2.20.4-0ubuntu4.8")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"apport", pkgver:"2.20.7-0ubuntu3.5")) flag++;
