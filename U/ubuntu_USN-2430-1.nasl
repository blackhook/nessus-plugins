...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 : openvpn vulnerability (USN-2430-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2430-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"openvpn", pkgver:"2.2.1-8ubuntu1.4")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"openvpn", pkgver:"2.3.2-7ubuntu3.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"openvpn", pkgver:"2.3.2-9ubuntu1.1")) flag++;
