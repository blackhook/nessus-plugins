...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.10 : cryptsetup vulnerability (USN-5286-1)");
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'cryptsetup', 'pkgver': '2:2.3.7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'cryptsetup-bin', 'pkgver': '2:2.3.7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'cryptsetup-initramfs', 'pkgver': '2:2.3.7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'cryptsetup-run', 'pkgver': '2:2.3.7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'libcryptsetup-dev', 'pkgver': '2:2.3.7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'libcryptsetup12', 'pkgver': '2:2.3.7-0ubuntu0.21.10.1'}
];
