...
{
  if (! preg(pattern:"^(5.4.0-\d+-(aws|azure|gcp|generic|generic-lpae|gke|gkeop|kvm|lowlatency|oracle))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.4.0-\d+(-generic|-generic-lpae|-lowlatency)" : "5.4.0-144",
    "5.4.0-\d+-aws" : "5.4.0-1097",
    "5.4.0-\d+-azure" : "5.4.0-1104",
    "5.4.0-\d+-gcp" : "5.4.0-1101",
    "5.4.0-\d+-gke" : "5.4.0-1095",
    "5.4.0-\d+-gkeop" : "5.4.0-1065",
    "5.4.0-\d+-kvm" : "5.4.0-1087",
    "5.4.0-\d+-oracle" : "5.4.0-1094"
  };
