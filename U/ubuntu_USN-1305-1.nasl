...
# extracted from Ubuntu Security Notice USN-1305-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1305-1");

  script_name(english:"Ubuntu 11.10 : nova vulnerability (USN-1305-1)");
  ...
  script_set_attribute(
    ...
    value:
"David Black discovered that Nova did not properly perform input
validation during image registration. An attacker could exploit this
by registering a crafted image using the EC2 API or S3/RegisterImage
method and overwrite files as the nova user.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1305-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.10", pkgname:"python-nova", pkgver:"2011.3-0ubuntu6.3")) flag++;
