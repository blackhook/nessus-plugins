...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 15.04 / 15.10 : cups-filters vulnerability (USN-2831-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2831-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"14.04", pkgname:"cups-filters", pkgver:"1.0.52-0ubuntu1.6")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"cups-filters", pkgver:"1.0.67-0ubuntu2.5")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"cups-filters", pkgver:"1.0.76-1ubuntu0.1")) flag++;
