...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : Json-smart vulnerabilities (USN-6011-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'libjson-smart-java', 'pkgver': '2.2-2ubuntu0.22.10.1'}
];
