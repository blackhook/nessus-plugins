...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3976-3/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"samba", pkgver:"2:4.3.11+dfsg-0ubuntu0.16.04.21")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"samba", pkgver:"2:4.7.6+dfsg~ubuntu-0ubuntu2.11")) flag++;
