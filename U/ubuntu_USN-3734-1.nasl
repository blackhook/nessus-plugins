...
this to possibly construct a class that caused a denial of service
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3734-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jdk", pkgver:"8u181-b13-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre", pkgver:"8u181-b13-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-headless", pkgver:"8u181-b13-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-jamvm", pkgver:"8u181-b13-0ubuntu0.16.04.1")) flag++;
