...
header set to 'localhost.localdomain' from the loopback interface. If
a user were tricked in to opening a specially crafted website in their
web browser, an attacker could potentially exploit this to obtain
sensitive information or control printers, via a DNS rebinding attack.
(CVE-2017-18190).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3577-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"cups", pkgver:"1.7.2-0ubuntu1.9")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"cups", pkgver:"2.1.3-4ubuntu0.4")) flag++;
