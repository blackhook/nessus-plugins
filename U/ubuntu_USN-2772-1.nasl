...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 : postgresql-9.1, postgresql-9.3, postgresql-9.4 vulnerabilities (USN-2772-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2772-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"12.04", pkgname:"postgresql-9.1", pkgver:"9.1.19-0ubuntu0.12.04")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"postgresql-9.3", pkgver:"9.3.10-0ubuntu0.14.04")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"postgresql-9.4", pkgver:"9.4.5-0ubuntu0.15.04")) flag++;
