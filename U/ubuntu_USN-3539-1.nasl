...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3539-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected gimp and / or libgimp2.0 packages."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"gimp", pkgver:"2.8.10-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libgimp2.0", pkgver:"2.8.10-0ubuntu1.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gimp / libgimp2.0");
}
