...
# extracted from Ubuntu Security Notice USN-45-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : nasm vulnerability (USN-45-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"nasm", pkgver:"0.98.38-1ubuntu0.1")) flag++;
