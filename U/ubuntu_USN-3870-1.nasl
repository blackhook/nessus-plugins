...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS / 18.10 : Spice vulnerability (USN-3870-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3870-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libspice-server1", pkgver:"0.12.4-0nocelt2ubuntu1.8")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libspice-server1", pkgver:"0.12.6-4ubuntu0.4")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libspice-server1", pkgver:"0.14.0-1ubuntu2.4")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"libspice-server1", pkgver:"0.14.0-1ubuntu4.2")) flag++;
