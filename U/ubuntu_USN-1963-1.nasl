...
# extracted from Ubuntu Security Notice USN-1963-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(62506);
  script_xref(name:"USN", value:"1963-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : usb-creator vulnerability (USN-1963-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that usb-creator was using polkit in an unsafe
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1963-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"usb-creator-common", pkgver:"0.2.38.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"usb-creator-common", pkgver:"0.2.40ubuntu2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"usb-creator-common", pkgver:"0.2.47.1")) flag++;
