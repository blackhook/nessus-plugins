...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 14.10 : apport vulnerability (USN-2569-2)");
  ...
  script_set_attribute(
    ...
    value:
"USN-2569-1 fixed a vulnerability in Apport. Tavis Ormandy discovered
that the fixed packages were still vulnerable to a privilege
escalation attack. This update completely disables crash report
handling for containers until a more complete solution is available.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2569-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"14.04", pkgname:"apport", pkgver:"2.14.1-0ubuntu3.10")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"apport", pkgver:"2.14.7-0ubuntu8.4")) flag++;
