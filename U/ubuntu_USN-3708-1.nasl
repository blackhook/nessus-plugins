...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : openslp-dfsg vulnerabilities (USN-3708-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3708-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libslp1", pkgver:"1.2.1-9ubuntu0.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libslp1", pkgver:"1.2.1-11ubuntu0.16.04.1")) flag++;
