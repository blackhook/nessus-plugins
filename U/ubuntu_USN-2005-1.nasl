...
# extracted from Ubuntu Security Notice USN-2005-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(61689, 61692, 61693);
  script_xref(name:"USN", value:"2005-1");

  script_name(english:"Ubuntu 13.04 : cinder vulnerabilities (USN-2005-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2005-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.04", pkgname:"python-cinder", pkgver:"1:2013.1.3-0ubuntu2.1")) flag++;
