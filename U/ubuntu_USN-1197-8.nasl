...
# extracted from Ubuntu Security Notice USN-1197-8. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 : ca-certificates-java regression (USN-1197-8)");
  ...
  script_set_attribute(
    ...
    value:
"USN-1197-7 fixed a vulnerability in ca-certificates-java. The new
package broke upgrades from Ubuntu 11.04 to Ubuntu 11.10. This update
fixes the problem.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1197-8/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.10", pkgname:"ca-certificates-java", pkgver:"20110912ubuntu3.2")) flag++;
