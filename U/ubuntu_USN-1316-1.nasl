...
# extracted from Ubuntu Security Notice USN-1316-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1316-1");

  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 / 11.10 : t1lib vulnerability (USN-1316-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1316-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.10.10.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.11.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.11.10.1")) flag++;
