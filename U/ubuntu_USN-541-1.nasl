...
# extracted from Ubuntu Security Notice USN-541-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.10 : emacs22 vulnerability (USN-541-1)");
...
non-default ':safe', a remote attacker could execute arbitrary
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/541-1/"
  );
...
if (ubuntu_check(osver:"7.10", pkgname:"emacs", pkgver:"22.1-0ubuntu5.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"emacs22", pkgver:"22.1-0ubuntu5.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"emacs22-bin-common", pkgver:"22.1-0ubuntu5.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"emacs22-common", pkgver:"22.1-0ubuntu5.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"emacs22-el", pkgver:"22.1-0ubuntu5.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"emacs22-gtk", pkgver:"22.1-0ubuntu5.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"emacs22-nox", pkgver:"22.1-0ubuntu5.1")) flag++;
