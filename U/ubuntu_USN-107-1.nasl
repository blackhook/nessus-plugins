...
# extracted from Ubuntu Security Notice USN-107-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : ipsec-tools vulnerability (USN-107-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"ipsec-tools", pkgver:"0.3.3-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"racoon", pkgver:"0.3.3-1ubuntu0.1")) flag++;
