...
# extracted from Ubuntu Security Notice USN-1224-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1224-1");

  script_name(english:"Ubuntu 11.04 : rsyslog vulnerability (USN-1224-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that rsyslog had an off-by-two error when parsing
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1224-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.04", pkgname:"rsyslog", pkgver:"4.6.4-2ubuntu4.1")) flag++;
