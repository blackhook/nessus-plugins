...
# extracted from Ubuntu Security Notice USN-1818-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1818-1");

  script_name(english:"Ubuntu 12.04 LTS : mesa vulnerability (USN-1818-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1818-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libegl1-mesa", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgbm1", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgl1-mesa-dri", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgl1-mesa-glx", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgl1-mesa-swx11", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libglapi-mesa", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgles1-mesa", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libgles2-mesa", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libglu1-mesa", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libopenvg1-mesa", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libosmesa6", pkgver:"8.0.4-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libxatracker1", pkgver:"8.0.4-0ubuntu0.5")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libegl1-mesa / libgbm1 / libgl1-mesa-dri / libgl1-mesa-glx / etc");
}
