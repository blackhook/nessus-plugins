...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS : Django vulnerability (USN-6203-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'python3-django', 'pkgver': '3:3.2.15-1ubuntu1.4'},
