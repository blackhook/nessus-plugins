...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 / 18.04 LTS : libpng vulnerabilities (USN-3712-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3712-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected libpng12-0 and / or libpng16-16 packages."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"libpng12-0", pkgver:"1.2.50-1ubuntu2.14.04.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libpng12-0", pkgver:"1.2.54-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libpng16-16", pkgver:"1.6.34-1ubuntu0.17.10.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libpng16-16", pkgver:"1.6.34-1ubuntu0.18.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libpng12-0 / libpng16-16");
}
