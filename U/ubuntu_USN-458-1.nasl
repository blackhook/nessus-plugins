...
# extracted from Ubuntu Security Notice USN-458-1. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2007-0901", "CVE-2007-0902", "CVE-2007-2423", "CVE-2007-2637");
  script_xref(name:"USN", value:"458-1");

  script_name(english:"Ubuntu 6.06 LTS / 6.10 / 7.04 : moin vulnerabilities (USN-458-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/458-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"6.06", pkgname:"moinmoin-common", pkgver:"1.5.2-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"python-moinmoin", pkgver:"1.5.2-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"python2.4-moinmoin", pkgver:"1.5.2-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"moinmoin-common", pkgver:"1.5.3-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"python-moinmoin", pkgver:"1.5.3-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"python2.4-moinmoin", pkgver:"1.5.3-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"moinmoin-common", pkgver:"1.5.3-1.1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"python-moinmoin", pkgver:"1.5.3-1.1ubuntu3.1")) flag++;
