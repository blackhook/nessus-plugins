...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 : Expat vulnerability (USN-4132-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4132-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"lib64expat1", pkgver:"2.1.0-7ubuntu0.16.04.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libexpat1", pkgver:"2.1.0-7ubuntu0.16.04.5")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libexpat1", pkgver:"2.2.5-3ubuntu0.2")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"libexpat1", pkgver:"2.2.6-1ubuntu0.19.5")) flag++;
