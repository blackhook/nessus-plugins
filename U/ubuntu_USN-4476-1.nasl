...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : NSS vulnerability (USN-4476-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4476-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libnss3", pkgver:"2:3.28.4-0ubuntu0.16.04.14")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libnss3", pkgver:"2:3.35-2ubuntu2.12")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libnss3", pkgver:"2:3.49.1-1ubuntu1.5")) flag++;
