...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 / 17.04 : libgcrypt11, libgcrypt20 vulnerabilities (USN-3347-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3347-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libgcrypt11", pkgver:"1.5.3-2ubuntu4.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libgcrypt20", pkgver:"1.6.5-2ubuntu0.3")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"libgcrypt20", pkgver:"1.7.2-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libgcrypt20", pkgver:"1.7.6-1ubuntu0.1")) flag++;
