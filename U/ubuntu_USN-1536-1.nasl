...
# extracted from Ubuntu Security Notice USN-1536-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1536-1");

  script_name(english:"Ubuntu 11.04 / 11.10 / 12.04 LTS : libreoffice vulnerability (USN-1536-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1536-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.04", pkgname:"libreoffice-core", pkgver:"1:3.3.4-0ubuntu1.4")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libreoffice-core", pkgver:"1:3.4.4-0ubuntu1.4")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libreoffice-core", pkgver:"1:3.5.4-0ubuntu1.1")) flag++;
