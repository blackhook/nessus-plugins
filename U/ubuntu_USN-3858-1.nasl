...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 18.10 : HAProxy vulnerabilities (USN-3858-1)");
...
It was discovered that HAProxy incorrectly handled certain requests. A
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3858-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"haproxy", pkgver:"1.6.3-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"haproxy", pkgver:"1.8.8-1ubuntu0.3")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"haproxy", pkgver:"1.8.13-2ubuntu0.1")) flag++;
