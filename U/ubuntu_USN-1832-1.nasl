...
# extracted from Ubuntu Security Notice USN-1832-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1832-1");

  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.04 : tiff vulnerabilities (USN-1832-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1832-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libtiff4", pkgver:"3.9.2-2ubuntu0.13")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libtiff4", pkgver:"3.9.5-2ubuntu1.5")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libtiff5", pkgver:"4.0.2-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libtiff5", pkgver:"4.0.2-4ubuntu2.1")) flag++;
