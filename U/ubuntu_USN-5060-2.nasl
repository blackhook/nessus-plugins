...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : NTFS-3G vulnerabilities (USN-5060-2)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'ntfs-3g', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.3+esm1'},
    {'osver': '16.04', 'pkgname': 'ntfs-3g-dev', 'pkgver': '1:2015.3.14AR.1-1ubuntu0.3+esm1'}
];
