...
# extracted from Ubuntu Security Notice USN-665-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 7.10 : netpbm-free vulnerability (USN-665-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/665-1/"
  );
...
if (ubuntu_check(osver:"6.06", pkgname:"libnetpbm10", pkgver:"10.0-10ubuntu1.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libnetpbm10-dev", pkgver:"10.0-10ubuntu1.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libnetpbm9", pkgver:"10.0-10ubuntu1.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libnetpbm9-dev", pkgver:"10.0-10ubuntu1.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"netpbm", pkgver:"2:10.0-10ubuntu1.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"libnetpbm10", pkgver:"10.0-11ubuntu0.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"libnetpbm10-dev", pkgver:"10.0-11ubuntu0.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"libnetpbm9", pkgver:"10.0-11ubuntu0.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"libnetpbm9-dev", pkgver:"10.0-11ubuntu0.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"netpbm", pkgver:"2:10.0-11ubuntu0.1")) flag++;
