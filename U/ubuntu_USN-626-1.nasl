...
# extracted from Ubuntu Security Notice USN-626-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS : firefox-3.0, xulrunner-1.9 vulnerabilities (USN-626-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/626-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"firefox", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-3.0", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-3.0-dev", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-3.0-dom-inspector", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-3.0-gnome-support", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-3.0-venkman", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-dev", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-dom-inspector", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-gnome-support", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-granparadiso", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-granparadiso-dev", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-granparadiso-dom-inspector", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-granparadiso-gnome-support", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-libthai", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-trunk", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-trunk-dev", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-trunk-dom-inspector", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-trunk-gnome-support", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"firefox-trunk-venkman", pkgver:"3.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"xulrunner-1.9", pkgver:"1.9.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"xulrunner-1.9-dev", pkgver:"1.9.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"xulrunner-1.9-dom-inspector", pkgver:"1.9.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"xulrunner-1.9-gnome-support", pkgver:"1.9.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"xulrunner-1.9-venkman", pkgver:"1.9.0.1+build1+nobinonly-0ubuntu0.8.04.3")) flag++;
