...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : openssh vulnerabilities (USN-2869-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that the OpenSSH client experimental support for
resuming connections contained multiple security issues. A malicious
server could use this issue to leak client memory to the server,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2869-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"openssh-client", pkgver:"1:5.9p1-5ubuntu1.8")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"openssh-client", pkgver:"1:6.6p1-2ubuntu2.4")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"openssh-client", pkgver:"1:6.7p1-5ubuntu1.4")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"openssh-client", pkgver:"1:6.9p1-2ubuntu0.1")) flag++;
