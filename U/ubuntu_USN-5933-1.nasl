...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.04 LTS / 22.10 : Libtpms vulnerabilities (USN-5933-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'libtpms-dev', 'pkgver': '0.9.3-0ubuntu1.22.10.1'},
    {'osver': '22.10', 'pkgname': 'libtpms0', 'pkgver': '0.9.3-0ubuntu1.22.10.1'}
];
