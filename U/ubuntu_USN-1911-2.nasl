...
# extracted from Ubuntu Security Notice USN-1911-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.04 : ghostscript vulnerability (USN-1911-2)");
  ...
  script_set_attribute(
    ...
    value:
"USN-1911-1 fixed vulnerabilities in Little CMS. This update provides
the corresponding updates for Ghostscript.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1911-2/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libgs9 package."
  );
...
if (ubuntu_check(osver:"13.04", pkgname:"libgs9", pkgver:"9.07~dfsg2-0ubuntu3.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libgs9");
}
