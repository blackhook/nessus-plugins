...
# extracted from Ubuntu Security Notice USN-1489-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1489-1");

  script_name(english:"Ubuntu 10.04 LTS : linux-lts-backport-oneiric vulnerability (USN-1489-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1489-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2012-2375");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1489-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-22-generic", pkgver:"3.0.0-22.36~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-22-generic-pae", pkgver:"3.0.0-22.36~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-22-server", pkgver:"3.0.0-22.36~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-22-virtual", pkgver:"3.0.0-22.36~lucid1")) flag++;
