...
regression leading to errors being appended to the log file. This
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3215-2/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"munin", pkgver:"2.0.19-3ubuntu0.3")) flag++;
