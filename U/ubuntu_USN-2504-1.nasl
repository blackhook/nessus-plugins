...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS / 14.10 : nss update (USN-2504-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"The NSS package contained outdated CA certificates. This update
refreshes the NSS package to version 3.17.4 which includes the latest
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2504-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libnss3-1d", pkgver:"3.17.4-0ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libnss3", pkgver:"3.17.4-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libnss3", pkgver:"2:3.17.4-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"libnss3", pkgver:"2:3.17.4-0ubuntu0.14.10.1")) flag++;
