...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 16.04 LTS : eog vulnerability (USN-3069-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3069-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"eog", pkgver:"3.4.2-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"eog", pkgver:"3.10.2-0ubuntu5.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"eog", pkgver:"3.18.2-1ubuntu2.1")) flag++;
