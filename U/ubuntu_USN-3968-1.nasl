...
restriction when used with certain applications. A local attacker
could possibly use this issue to bypass configured restrictions and
execute arbitrary commands. (CVE-2016-7076)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3968-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"sudo", pkgver:"1.8.16-0ubuntu1.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"sudo-ldap", pkgver:"1.8.16-0ubuntu1.6")) flag++;
