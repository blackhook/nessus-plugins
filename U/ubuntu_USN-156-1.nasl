...
# extracted from Ubuntu Security Notice USN-156-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : tiff vulnerability (USN-156-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"libtiff-tools", pkgver:"3.6.1-1.1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libtiff4", pkgver:"3.6.1-1.1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libtiff4-dev", pkgver:"3.6.1-1.1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libtiff-tools", pkgver:"3.6.1-5ubuntu0.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libtiff4", pkgver:"3.6.1-5ubuntu0.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libtiff4-dev", pkgver:"3.6.1-5ubuntu0.2")) flag++;
