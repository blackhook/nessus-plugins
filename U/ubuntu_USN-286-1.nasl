...
# extracted from Ubuntu Security Notice USN-286-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(18078);
  script_xref(name:"USN", value:"286-1");

  script_name(english:"Ubuntu 5.04 / 5.10 : dia vulnerabilities (USN-286-1)");
...
tricking a user into opening a specially crafted dia file, or a file
with a specially crafted name, this could be exploited to execute
...
if (ubuntu_check(osver:"5.04", pkgname:"dia", pkgver:"0.94.0-5ubuntu1.3")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"dia-common", pkgver:"0.94.0-5ubuntu1.3")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"dia-gnome", pkgver:"0.94.0-5ubuntu1.3")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"dia-libs", pkgver:"0.94.0-5ubuntu1.3")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"dia", pkgver:"0.94.0-11ubuntu1.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"dia-common", pkgver:"0.94.0-11ubuntu1.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"dia-gnome", pkgver:"0.94.0-11ubuntu1.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"dia-libs", pkgver:"0.94.0-11ubuntu1.2")) flag++;
