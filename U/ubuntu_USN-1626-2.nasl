...
# extracted from Ubuntu Security Notice USN-1626-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1626-2");

  script_name(english:"Ubuntu 12.10 : glance vulnerability (USN-1626-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1626-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.10", pkgname:"python-glance", pkgver:"2012.2-0ubuntu2.3")) flag++;
