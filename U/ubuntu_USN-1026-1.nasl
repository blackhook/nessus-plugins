...
# extracted from Ubuntu Security Notice USN-1026-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(41160);
  script_xref(name:"USN", value:"1026-1");

  script_name(english:"Ubuntu 10.04 LTS : paste vulnerability (USN-1026-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1026-1/"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:python-paste");
...
if (ubuntu_check(osver:"10.04", pkgname:"python-paste", pkgver:"1.7.2-4ubuntu1.2")) flag++;
