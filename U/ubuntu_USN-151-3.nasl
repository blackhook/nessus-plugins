...
# extracted from Ubuntu Security Notice USN-151-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 / 5.10 : aide vulnerabilities (USN-151-3)");
...
if (ubuntu_check(osver:"4.10", pkgname:"aide", pkgver:"0.10-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"aide", pkgver:"0.10-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"aide", pkgver:"0.10-6.1ubuntu0.1")) flag++;
