...
# extracted from Ubuntu Security Notice USN-1197-7. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 / 11.10 : ca-certificates-java vulnerability (USN-1197-7)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1197-7/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected ca-certificates-java package."
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:ca-certificates-java");
...
if (ubuntu_check(osver:"10.04", pkgname:"ca-certificates-java", pkgver:"20100406ubuntu1.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"ca-certificates-java", pkgver:"20100412ubuntu0.10.10.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"ca-certificates-java", pkgver:"20100412ubuntu0.11.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"ca-certificates-java", pkgver:"20110912ubuntu3.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "ca-certificates-java");
}
