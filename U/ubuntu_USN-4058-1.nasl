...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Bash incorrectly handled the restricted shell.
An attacker could possibly use this issue to escape restrictions and
execute any command.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4058-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"bash", pkgver:"4.3-14ubuntu1.4")) flag++;
