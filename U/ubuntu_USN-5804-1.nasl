...
referenced in the USN-5804-1 advisory.
...
{
  if (! preg(pattern:"^(4.15.0-\d{3}-(generic|generic-lpae|lowlatency)|4.15.0-\d{4}-(aws|aws-hwe|azure|gcp|kvm)|5.4.0-\d{3}-(generic|generic-lpae|lowlatency)|5.4.0-\d{4}-(aws|gcp|ibm|kvm|oracle))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.15.0-\d{3}-(generic|generic-lpae|lowlatency)" : "4.15.0-202",
    "4.15.0-\d{3}-(generic|lowlatency)" : "4.15.0-202",
    "4.15.0-\d{4}-(aws|aws-hwe)" : "4.15.0-1148",
    "4.15.0-\d{4}-azure" : "4.15.0-1159",
    "4.15.0-\d{4}-gcp" : "4.15.0-1143",
    "4.15.0-\d{4}-kvm" : "4.15.0-1134",
    "5.4.0-\d{3}-(generic|generic-lpae|lowlatency)" : "5.4.0-137",
    "5.4.0-\d{4}-aws" : "5.4.0-1094",
    "5.4.0-\d{4}-gcp" : "5.4.0-1098",
    "5.4.0-\d{4}-ibm" : "5.4.0-1042",
    "5.4.0-\d{4}-kvm" : "5.4.0-1084",
    "5.4.0-\d{4}-oracle" : "5.4.0-1092"
  };
