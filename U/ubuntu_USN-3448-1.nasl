...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : keystone vulnerability (USN-3448-1)");
...
federation mapping when there are rules in which group-based
assignments are not used. A remote authenticated user may receive all
the roles assigned to a project regardless of the federation mapping,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3448-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"keystone", pkgver:"2:9.3.0-0ubuntu3.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-keystone", pkgver:"2:9.3.0-0ubuntu3.1")) flag++;
