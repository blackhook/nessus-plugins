...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 / 17.10 : apport vulnerabilities (USN-3480-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3480-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"apport", pkgver:"2.14.1-0ubuntu3.27")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"apport", pkgver:"2.20.1-0ubuntu2.12")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"apport", pkgver:"2.20.4-0ubuntu4.7")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"apport", pkgver:"2.20.7-0ubuntu3.4")) flag++;
