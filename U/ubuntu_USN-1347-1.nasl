...
# extracted from Ubuntu Security Notice USN-1347-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(47168);
  script_xref(name:"USN", value:"1347-1");

  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : evince vulnerability (USN-1347-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1347-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libevdocument2 and / or libevdocument3 packages."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libevdocument2", pkgver:"2.30.3-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libevdocument3", pkgver:"2.32.0-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libevdocument3", pkgver:"2.32.0-0ubuntu12.4")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libevdocument2 / libevdocument3");
}
