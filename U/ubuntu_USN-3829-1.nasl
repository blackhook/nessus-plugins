...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 18.04 LTS / 18.10 : Git vulnerabilities (USN-3829-1)");
...
It was discovered that Git incorrectly handled certain inputs. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3829-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"git", pkgver:"1:1.9.1-1ubuntu0.10")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"git", pkgver:"1:2.7.4-0ubuntu1.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"git", pkgver:"1:2.17.1-1ubuntu0.4")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"git", pkgver:"1:2.19.1-1ubuntu1.1")) flag++;
