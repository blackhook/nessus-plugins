...
# extracted from Ubuntu Security Notice USN-2703-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2703-1");

  script_name(english:"Ubuntu 15.04 : cinder vulnerability (USN-2703-1)");
...
untrusted data. An attacker could use this to read arbitrary files
from the Cinder host.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2703-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"15.04", pkgname:"python-cinder", pkgver:"1:2015.1.0-0ubuntu1.1")) flag++;
