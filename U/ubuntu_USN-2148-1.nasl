...
# extracted from Ubuntu Security Notice USN-2148-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(66074, 66292);
  script_xref(name:"USN", value:"2148-1");

  script_name(english:"Ubuntu 13.10 : freetype vulnerabilities (USN-2148-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2148-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.10", pkgname:"libfreetype6", pkgver:"2.4.12-0ubuntu1.1")) flag++;
