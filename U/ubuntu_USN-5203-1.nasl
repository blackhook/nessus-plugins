...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.04 / 21.10 : Apache Log4j 2 vulnerability (USN-5203-1)");
...
var pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'liblog4j2-java', 'pkgver': '2.17.0-0.21.04.1'},
    {'osver': '21.10', 'pkgname': 'liblog4j2-java', 'pkgver': '2.17.0-0.21.10.1'}
];
