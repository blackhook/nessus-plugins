...
{
  if (! preg(pattern:"^(5.15.0-\d+-(aws|azure|azure-fde|gcp|generic|generic-64k|generic-lpae|gke|lowlatency|lowlatency-64k))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.15.0-\d+(-generic|-generic-64k|-generic-lpae|-lowlatency|-lowlatency-64k)" : "5.15.0-67",
    "5.15.0-\d+-aws" : "5.15.0-1031",
    "5.15.0-\d+-azure" : "5.15.0-1034",
    "5.15.0-\d+-azure-fde" : "5.15.0-1034",
    "5.15.0-\d+-gcp" : "5.15.0-1030",
    "5.15.0-\d+-gke" : "5.15.0-1028"
  };
...
{
  var cve_list = make_list('CVE-2022-3169', 'CVE-2022-3344', 'CVE-2022-3435', 'CVE-2022-3521', 'CVE-2022-3545', 'CVE-2022-4139', 'CVE-2022-4379', 'CVE-2022-42328', 'CVE-2022-42329', 'CVE-2022-45869', 'CVE-2022-47518', 'CVE-2022-47519', 'CVE-2022-47520', 'CVE-2022-47521', 'CVE-2023-0179', 'CVE-2023-0461', 'CVE-2023-0468');
