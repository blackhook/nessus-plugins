...
# extracted from Ubuntu Security Notice USN-254-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 / 5.10 : noweb vulnerability (USN-254-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected nowebm package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:H/Au:N/C:N/I:P/A:N");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:nowebm");
...
if (ubuntu_check(osver:"4.10", pkgname:"nowebm", pkgver:"2.10c-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"nowebm", pkgver:"2.10c-3.1ubuntu5.04.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"nowebm", pkgver:"2.10c-3.1ubuntu5.10.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "nowebm");
}
