...
{
  if (! preg(pattern:"^(4.15.0-\d+-(aws|dell300x|gcp|generic|generic-lpae|lowlatency|oracle))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.15.0-\d+(-generic|-generic-lpae|-lowlatency)" : "4.15.0-206",
    "4.15.0-\d+-aws" : "4.15.0-1151",
    "4.15.0-\d+-dell300x" : "4.15.0-1061",
