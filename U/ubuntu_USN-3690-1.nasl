...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 / 18.04 LTS : AMD Microcode update (USN-3690-1) (Spectre)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3690-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected amd64-microcode package."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"amd64-microcode", pkgver:"3.20180524.1~ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"amd64-microcode", pkgver:"3.20180524.1~ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"amd64-microcode", pkgver:"3.20180524.1~ubuntu0.17.10.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"amd64-microcode", pkgver:"3.20180524.1~ubuntu0.18.04.1")) flag++;
