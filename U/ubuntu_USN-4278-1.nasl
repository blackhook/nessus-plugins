...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.10 : Firefox vulnerabilities (USN-4278-1)");
...
potentially exploit these to cause a denial of service, conduct
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4278-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"firefox", pkgver:"73.0+build3-0ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"firefox", pkgver:"73.0+build3-0ubuntu0.19.10.1")) flag++;
