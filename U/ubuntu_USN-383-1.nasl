...
# extracted from Ubuntu Security Notice USN-383-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : libpng vulnerability (USN-383-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/383-1/"
  );
...
if (ubuntu_check(osver:"5.10", pkgname:"libpng10-0", pkgver:"1.0.18-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libpng10-dev", pkgver:"1.0.18-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libpng2", pkgver:"1.0.18-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libpng2-dev", pkgver:"1.0.18-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libpng12-0", pkgver:"1.2.8rel-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libpng12-dev", pkgver:"1.2.8rel-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libpng3", pkgver:"1.2.8rel-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libpng12-0", pkgver:"1.2.8rel-5.1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libpng12-dev", pkgver:"1.2.8rel-5.1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"libpng3", pkgver:"1.2.8rel-5.1ubuntu0.1")) flag++;
