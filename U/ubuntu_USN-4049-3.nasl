...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : glib2.0 regression (USN-4049-3)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-4049-1 fixed a vulnerability in GLib. The update introduced a
regression in Ubuntu 16.04 LTS causing a possibly memory leak. This
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4049-3/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libglib2.0-0", pkgver:"2.48.2-0ubuntu4.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libglib2.0-bin", pkgver:"2.48.2-0ubuntu4.4")) flag++;
