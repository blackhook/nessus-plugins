...
# extracted from Ubuntu Security Notice USN-2646-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.10 : linux vulnerability (USN-2646-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2646-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2646-1");
  }
  else
  {
...
if (ubuntu_check(osver:"14.10", pkgname:"linux-image-3.16.0-41-generic", pkgver:"3.16.0-41.55")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"linux-image-3.16.0-41-generic-lpae", pkgver:"3.16.0-41.55")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"linux-image-3.16.0-41-lowlatency", pkgver:"3.16.0-41.55")) flag++;
