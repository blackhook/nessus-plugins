...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : Paramiko vulnerability (USN-5351-2)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'python-paramiko', 'pkgver': '1.16.0-1ubuntu0.2+esm2'},
    {'osver': '16.04', 'pkgname': 'python3-paramiko', 'pkgver': '1.16.0-1ubuntu0.2+esm2'}
];
