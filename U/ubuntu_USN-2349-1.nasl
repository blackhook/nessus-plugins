...
# extracted from Ubuntu Security Notice USN-2349-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(69170);
  script_xref(name:"USN", value:"2349-1");

  script_name(english:"Ubuntu 12.04 LTS : libav vulnerabilities (USN-2349-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2349-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libavcodec53", pkgver:"4:0.8.16-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libavformat53", pkgver:"4:0.8.16-0ubuntu0.12.04.1")) flag++;
