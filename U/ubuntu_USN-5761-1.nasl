...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : ca-certificates update (USN-5761-1)");
...
vulnerability as referenced in the USN-5761-1 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'ca-certificates', 'pkgver': '20211016ubuntu0.22.10.1'}
];
