...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : ruby1.9.1, ruby2.3 vulnerabilities (USN-3528-1)");
...
arbitrary code via a crafted user name. This issue only affected
Ubuntu 16.04 LTS and Ubuntu 17.10. (CVE-2017-10784)

It was discovered that Ruby incorrectly handled certain strings. An
attacker could use this to cause a denial of service. This issue only
affected Ubuntu 16.04 LTS and Ubuntu 17.10. (CVE-2017-14033)
...
attacker could use this to execute arbitrary code. (CVE-2017-17790).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3528-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"libruby1.9.1", pkgver:"1.9.3.484-2ubuntu1.7")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"ruby1.9.1", pkgver:"1.9.3.484-2ubuntu1.7")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"ruby1.9.3", pkgver:"1.9.3.484-2ubuntu1.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libruby2.3", pkgver:"2.3.1-2~16.04.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"ruby2.3", pkgver:"2.3.1-2~16.04.5")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libruby2.3", pkgver:"2.3.3-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"ruby2.3", pkgver:"2.3.3-1ubuntu1.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libruby1.9.1 / libruby2.3 / ruby1.9.1 / ruby1.9.3 / ruby2.3");
}
