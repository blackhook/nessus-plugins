...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 : Firefox vulnerabilities (USN-4299-1)");
...
potentially exploit these to cause a denial of service, spoof the URL
or other browser chrome, obtain sensitive information, bypass Content
Security Policy (CSP) protections, or execute arbitrary code.
(CVE-2019-20503, CVE-2020-6805, CVE-2020-6806, CVE-2020-6807,
CVE-2020-6808, CVE-2020-6810, CVE-2020-6812, CVE-2020-6813,
CVE-2020-6814, CVE-2020-6815)

It was discovered that Web Extensions with the all-url permission
could access local files. If a user were tricked in to installing a
specially crafted extension, an attacker could potentially exploit
this to obtain sensitive information. (CVE-2020-6809)

It was discovered that the Devtools' 'Copy as cURL' feature did not
fully escape website-controlled data. If a user were tricked in to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4299-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"firefox", pkgver:"74.0+build3-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"firefox", pkgver:"74.0+build3-0ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"firefox", pkgver:"74.0+build3-0ubuntu0.19.10.1")) flag++;
