...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : Apache Commons Net vulnerability (USN-6037-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'libcommons-net-java', 'pkgver': '3.6-1+deb11u1build0.22.10.1'}
];
