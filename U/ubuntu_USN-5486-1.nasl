...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.10 / 22.04 LTS : Intel Microcode vulnerabilities (USN-5486-1)");
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'intel-microcode', 'pkgver': '3.20220510.0ubuntu0.21.10.1'},
