...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS : emacs24 vulnerability (USN-3427-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3427-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected emacs24 package."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"emacs24", pkgver:"24.3+1-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"emacs24", pkgver:"24.5+1-6ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "emacs24");
}
