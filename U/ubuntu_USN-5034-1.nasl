...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.04 : c-ares vulnerability (USN-5034-1)");
...
referenced in the USN-5034-1 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
...
pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'libc-ares-dev', 'pkgver': '1.17.1-1ubuntu0.1'},
    {'osver': '21.04', 'pkgname': 'libc-ares2', 'pkgver': '1.17.1-1ubuntu0.1'}
];
