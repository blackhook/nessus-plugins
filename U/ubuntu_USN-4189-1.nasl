...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.04 / 19.10 : DPDK vulnerability (USN-4189-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4189-1/"
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"dpdk", pkgver:"17.11.8-0~ubuntu18.04.2")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"dpdk", pkgver:"18.11.4-1ubuntu0.19.04.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"dpdk", pkgver:"18.11.4-1ubuntu0.19.10.1")) flag++;
