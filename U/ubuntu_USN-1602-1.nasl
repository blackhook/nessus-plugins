...
# extracted from Ubuntu Security Notice USN-1602-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : ruby1.9.1 vulnerabilities (USN-1602-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1602-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libruby1.9.1", pkgver:"1.9.3.0-1ubuntu2.3")) flag++;
