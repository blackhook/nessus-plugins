...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"As a security improvement, this update adjusts the private-files
abstraction to disallow writing to thumbnailer configuration files.
Additionally adjust the private-files, private-files-strict and
user-files abstractions to disallow writes on parent directories of
sensitive files.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3784-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"apparmor", pkgver:"2.10.95-0ubuntu2.6~14.04.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"apparmor", pkgver:"2.10.95-0ubuntu2.10")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"apparmor", pkgver:"2.12-4ubuntu5.1")) flag++;
