...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3788-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"texlive-binaries", pkgver:"2013.20130729.30972-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"texlive-binaries", pkgver:"2015.20160222.37495-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"texlive-binaries", pkgver:"2017.20170613.44572-8ubuntu0.1")) flag++;
