...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.04 : wpa_supplicant and hostapd vulnerability (USN-4098-1)");
...
use this issue to recover certain passwords.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4098-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"hostapd", pkgver:"2:2.6-15ubuntu2.4")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"wpasupplicant", pkgver:"2:2.6-15ubuntu2.4")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"hostapd", pkgver:"2:2.6-21ubuntu3.2")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"wpasupplicant", pkgver:"2:2.6-21ubuntu3.2")) flag++;
