...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 20.10 / 21.04 : OpenVPN vulnerabilities (USN-4933-1)");
...
vulnerabilities as referenced in the USN-4933-1 advisory.
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'openvpn', 'pkgver': '2.4.9-3ubuntu1.1'},
    {'osver': '21.04', 'pkgname': 'openvpn', 'pkgver': '2.5.1-1ubuntu1.1'}
];
