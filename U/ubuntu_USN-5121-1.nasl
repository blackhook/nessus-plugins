...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : Mailman vulnerabilities (USN-5121-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'mailman', 'pkgver': '1:2.1.20-1ubuntu0.6+esm1'},
    {'osver': '18.04', 'pkgname': 'mailman', 'pkgver': '1:2.1.26-1ubuntu0.4'}
];
