...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 22.10 : Linux kernel vulnerabilities (USN-5814-1)");
...
vulnerabilities as referenced in the USN-5814-1 advisory.
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1023-inteliotg");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1015-lowlatency");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1015-lowlatency-64k");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1017-azure");
...
{
  if (! preg(pattern:"^(5.15.0-\d{2}-(lowlatency|lowlatency-64k)|5.15.0-\d{4}-(gkeop|intel-iotg|oracle)|5.19.0-\d{4}-(azure|lowlatency|lowlatency-64k))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.15.0-\d{2}-(lowlatency|lowlatency-64k)" : "5.15.0-58",
    "5.15.0-\d{4}-gkeop" : "5.15.0-1013",
    "5.15.0-\d{4}-intel-iotg" : "5.15.0-1023",
    "5.15.0-\d{4}-oracle" : "5.15.0-1027",
    "5.19.0-\d{4}-(lowlatency|lowlatency-64k)" : "5.19.0-1015",
    "5.19.0-\d{4}-azure" : "5.19.0-1017"
  };
