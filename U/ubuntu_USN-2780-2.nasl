...
# extracted from Ubuntu Security Notice USN-2780-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 15.10 : miniupnpc vulnerability (USN-2780-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2780-2/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libminiupnpc10 package."
  );
...
if (ubuntu_check(osver:"15.10", pkgname:"libminiupnpc10", pkgver:"1.9.20140610-2ubuntu2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libminiupnpc10");
}
