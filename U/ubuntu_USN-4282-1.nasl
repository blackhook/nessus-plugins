...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.10 : PostgreSQL vulnerability (USN-4282-1)");
...
checks when handling the 'ALTER ... DEPENDS ON EXTENSION' sub-commands.
A remote attacker could possibly use this issue to drop any function,
procedure, materialized view, index, or trigger under certain
conditions.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4282-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"postgresql-10", pkgver:"10.12-0ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"postgresql-11", pkgver:"11.7-0ubuntu0.19.10.1")) flag++;
