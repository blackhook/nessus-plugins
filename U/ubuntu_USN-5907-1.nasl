...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : c-ares vulnerability (USN-5907-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'libc-ares-dev', 'pkgver': '1.18.1-1ubuntu0.22.10.1'},
    {'osver': '22.10', 'pkgname': 'libc-ares2', 'pkgver': '1.18.1-1ubuntu0.22.10.1'}
];
