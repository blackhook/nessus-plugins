...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/1032-1/");
...
"Update the affected packages.");
  ...
  script_copyright(english:"Ubuntu Security Notice (C) 2010-2022 Canonical, Inc. / NASL script (C) 2010-2022 and is owned by Tenable, Inc. or an Affiliate thereof.");
...
if (! preg(pattern:"^(6\.06|8\.04|9\.10)$", string:release)) audit(AUDIT_OS_NOT, "Ubuntu 6.06 / 8.04 / 9.10", "Ubuntu " + release);
