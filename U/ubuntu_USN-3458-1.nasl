...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 / 17.10 : icu vulnerability (USN-3458-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3458-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libicu52", pkgver:"52.1-3ubuntu0.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libicu55", pkgver:"55.1-7ubuntu0.3")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libicu57", pkgver:"57.1-5ubuntu0.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libicu57", pkgver:"57.1-6ubuntu0.2")) flag++;
