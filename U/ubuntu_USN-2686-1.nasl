...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 : apache2 vulnerabilities (USN-2686-1)");
...
ap_some_auth_required API. A remote attacker could possibly use this
issue to bypass intended access restrictions. This issue only affected
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2686-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"apache2.2-bin", pkgver:"2.2.22-1ubuntu1.10")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"apache2.2-bin", pkgver:"2.4.7-1ubuntu4.5")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"apache2.2-bin", pkgver:"2.4.10-9ubuntu1.1")) flag++;
