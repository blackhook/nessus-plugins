...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that MoinMoin incorrectly handled certain inputs. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3794-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"python-moinmoin", pkgver:"1.9.7-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-moinmoin", pkgver:"1.9.8-1ubuntu1.16.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python-moinmoin", pkgver:"1.9.9-1ubuntu1.1")) flag++;
