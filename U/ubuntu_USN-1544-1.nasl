...
# extracted from Ubuntu Security Notice USN-1544-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 11.04 / 11.10 / 12.04 LTS : imagemagick vulnerability (USN-1544-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"Tom Lane discovered that ImageMagick would not always properly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1544-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"imagemagick", pkgver:"7:6.5.7.8-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"libmagick++2", pkgver:"7:6.5.7.8-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"imagemagick", pkgver:"7:6.6.2.6-1ubuntu4.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libmagick++3", pkgver:"7:6.6.2.6-1ubuntu4.2")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"imagemagick", pkgver:"8:6.6.0.4-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libmagick++3", pkgver:"8:6.6.0.4-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"imagemagick", pkgver:"8:6.6.9.7-5ubuntu3.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libmagick++4", pkgver:"8:6.6.9.7-5ubuntu3.2")) flag++;
