...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 / 19.10 : cpio vulnerability (USN-4176-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4176-1/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"cpio", pkgver:"2.11+dfsg-5ubuntu1.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"cpio", pkgver:"2.12+dfsg-6ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"cpio", pkgver:"2.12+dfsg-6ubuntu0.19.04.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"cpio", pkgver:"2.12+dfsg-9ubuntu0.1")) flag++;
