...
{
  if (! preg(pattern:"^(5.15.0-\d+-(ibm|raspi|raspi-nolpae))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.15.0-\d+(-raspi|-raspi-nolpae)" : "5.15.0-1025",
    "5.15.0-\d+-ibm" : "5.15.0-1026"
  };
