...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 18.10 : Django vulnerability (USN-3890-1)");
...
numbers. A remote attacker could possibly use this issue to cause
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3890-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"python-django", pkgver:"1.8.7-1ubuntu5.8")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-django", pkgver:"1.8.7-1ubuntu5.8")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python-django", pkgver:"1:1.11.11-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python3-django", pkgver:"1:1.11.11-1ubuntu1.3")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"python-django", pkgver:"1:1.11.15-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"python3-django", pkgver:"1:1.11.15-1ubuntu1.2")) flag++;
