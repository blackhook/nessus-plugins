...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.15.0-1013-kvm");
...
{
  if (! preg(pattern:"^(5.15.0-\d{2}-(generic|generic-64k|generic-lpae|lowlatency|lowlatency-64k)|5.15.0-\d{4}-(aws|azure|gke|ibm|kvm))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.15.0-\d{2}-(generic|generic-64k|generic-lpae|lowlatency|lowlatency-64k)" : "5.15.0-41",
    "5.15.0-\d{4}-aws" : "5.15.0-1015",
    "5.15.0-\d{4}-azure" : "5.15.0-1014",
    "5.15.0-\d{4}-gke" : "5.15.0-1011",
    "5.15.0-\d{4}-ibm" : "5.15.0-1010",
    "5.15.0-\d{4}-kvm" : "5.15.0-1013"
  };
