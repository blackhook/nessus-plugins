...
# extracted from Ubuntu Security Notice USN-3178-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : icoutils vulnerabilities (USN-3178-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that icoutils incorrectly handled memory when
processing certain files. If a user or automated system were tricked
into opening a specially crafted file, an attacker could cause
icoutils to crash, resulting in a denial of service, or possibly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3178-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"12.04", pkgname:"icoutils", pkgver:"0.29.1-2ubuntu0.1")) flag++;
