...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that LibreOffice unconditionally executed certain
VBA macros, contrary to user expectations.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2253-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"14.04", pkgname:"libreoffice-core", pkgver:"1:4.2.4-0ubuntu2")) flag++;
