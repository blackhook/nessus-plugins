...
if (description)
{
  ...
  script_name(english:"Ubuntu 17.10 / 18.04 LTS : devscripts vulnerability (USN-3704-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3704-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"17.10", pkgname:"devscripts", pkgver:"2.17.9ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"devscripts", pkgver:"2.17.12ubuntu1.1")) flag++;
