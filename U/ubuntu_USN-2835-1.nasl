...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : git vulnerability (USN-2835-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2835-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"git", pkgver:"1:1.7.9.5-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"git", pkgver:"1:1.9.1-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"git", pkgver:"1:2.1.4-2.1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"git", pkgver:"1:2.5.0-1ubuntu0.1")) flag++;
