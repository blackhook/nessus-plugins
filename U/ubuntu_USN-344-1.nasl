...
# extracted from Ubuntu Security Notice USN-344-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"344-1");

  script_name(english:"Ubuntu 5.04 / 5.10 / 6.06 LTS : libxfont, xorg vulnerabilities (USN-344-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/344-1/"
  );
...
if (ubuntu_check(osver:"5.04", pkgname:"lbxproxy", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libdmx-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libdmx1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libdmx1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libdps-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libdps1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libdps1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libfs-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libfs6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libfs6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libice-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libice6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libice6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libsm-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libsm6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libsm6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libx11-6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libx11-6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libx11-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxau-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxau6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxau6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw6-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw7", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw7-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw7-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw8", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw8-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxaw8-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxcomposite-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxcomposite1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxcomposite1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxdamage-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxdamage1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxdamage1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxdmcp-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxdmcp6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxdmcp6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxevie-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxevie1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxevie1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxext-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxext6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxext6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxfixes-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxfixes3", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxfixes3-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxi-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxi6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxi6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxinerama-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxinerama1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxinerama1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxkbfile-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxkbfile1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxkbfile1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxkbui-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxkbui1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxkbui1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxmu-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxmu6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxmu6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxmuu-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxmuu1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxmuu1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxp-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxp6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxp6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxpm-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxpm4", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxpm4-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxrandr-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxrandr2", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxrandr2-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxres-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxres1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxres1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxss-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxss1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxss1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxt-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxt6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxt6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxtrap-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxtrap6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxtrap6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxtst-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxtst6", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxtst6-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxv-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxv1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxv1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxvmc-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxvmc1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxvmc1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86dga-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86dga1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86dga1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86misc-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86misc1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86misc1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86rush-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86rush1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86rush1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86vm-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86vm1", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxxf86vm1-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"pm-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"proxymngr", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"twm", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"x-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"x-window-system", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"x-window-system-core", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"x-window-system-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xbase-clients", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xdm", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xdmx", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-100dpi", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-100dpi-transcoded", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-75dpi", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-75dpi-transcoded", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-base", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-base-transcoded", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-cyrillic", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfonts-scalable", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfree86-common", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfs", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xfwp", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-dri", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-dri-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-gl", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-gl-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-gl-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-glu", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-glu-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa-glu-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa3", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibmesa3-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibosmesa-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibosmesa4", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibosmesa4-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibs", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibs-data", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibs-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibs-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibs-pic", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibs-static-dev", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xlibs-static-pic", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xmh", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xnest", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xorg-common", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xprt", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xserver-common", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xserver-xorg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xserver-xorg-dbg", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xspecs", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xterm", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xutils", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"xvfb", pkgver:"6.8.2-10.4")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libxfont-dev", pkgver:"0.99.0+cvs.20050909-1.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libxfont1", pkgver:"1:0.99.0+cvs.20050909-1.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libxfont1-dbg", pkgver:"0.99.0+cvs.20050909-1.2")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libxfont-dev", pkgver:"1.0.0-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libxfont1", pkgver:"1:1.0.0-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libxfont1-dbg", pkgver:"1.0.0-0ubuntu3.2")) flag++;
