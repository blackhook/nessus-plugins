...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 / 17.10 : quagga vulnerabilities (USN-3471-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"Andreas Jaggi discovered that Quagga incorrectly handled certain BGP
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3471-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"quagga", pkgver:"0.99.22.4-3ubuntu1.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"quagga", pkgver:"0.99.24.1-2ubuntu1.3")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"quagga", pkgver:"1.1.1-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"quagga-bgpd", pkgver:"1.1.1-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"quagga", pkgver:"1.1.1-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"quagga-bgpd", pkgver:"1.1.1-3ubuntu0.1")) flag++;
