...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2963-1/");
...
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jdk", pkgver:"8u91-b14-0ubuntu4~16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jdk-headless", pkgver:"8u91-b14-0ubuntu4~16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre", pkgver:"8u91-b14-0ubuntu4~16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-headless", pkgver:"8u91-b14-0ubuntu4~16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-jamvm", pkgver:"8u91-b14-0ubuntu4~16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-jre-zero", pkgver:"8u91-b14-0ubuntu4~16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"openjdk-8-source", pkgver:"8u91-b14-0ubuntu4~16.04.1")) flag++;
