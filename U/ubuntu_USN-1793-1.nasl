...
# extracted from Ubuntu Security Notice USN-1793-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : linux vulnerabilities (USN-1793-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1793-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2013-0914", "CVE-2013-1767", "CVE-2013-1792", "CVE-2013-2546", "CVE-2013-2547", "CVE-2013-2548");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1793-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-40-generic", pkgver:"3.2.0-40.64")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-40-generic-pae", pkgver:"3.2.0-40.64")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-40-highbank", pkgver:"3.2.0-40.64")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-40-virtual", pkgver:"3.2.0-40.64")) flag++;
