...
# extracted from Ubuntu Security Notice USN-24-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : openssl script vulnerability (USN-24-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"libssl-dev", pkgver:"0.9.7d-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libssl0.9.7", pkgver:"0.9.7d-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"openssl", pkgver:"0.9.7d-3ubuntu0.1")) flag++;
