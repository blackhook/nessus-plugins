...
# extracted from Ubuntu Security Notice USN-1860-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1860-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : libxinerama vulnerability (USN-1860-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1860-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxinerama1 package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libxinerama1", pkgver:"2:1.1.1-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxinerama1", pkgver:"2:1.1.2-1ubuntu0.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxinerama1", pkgver:"2:1.1.2-1ubuntu0.13.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxinerama1");
}
