...
# extracted from Ubuntu Security Notice USN-3316-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3316-1");

  script_name(english:"Ubuntu 17.04 : freeradius vulnerability (USN-3316-1)");
  ...
  script_set_attribute(
    ...
    value:
"Stefan Winter and Lubos Pavlicek discovered that FreeRADIUS
incorrectly handled the TLS session cache. A remote attacker could
possibly use this issue to bypass authentication by resuming an
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3316-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"17.04", pkgname:"freeradius", pkgver:"3.0.12+dfsg-4ubuntu1.1")) flag++;
