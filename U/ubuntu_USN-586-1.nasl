...
# extracted from Ubuntu Security Notice USN-586-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 / 7.04 / 7.10 : mailman vulnerability (USN-586-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/586-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"6.06", pkgname:"mailman", pkgver:"2.1.5-9ubuntu4.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"mailman", pkgver:"1:2.1.8-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"mailman", pkgver:"1:2.1.9-4ubuntu1.2")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"mailman", pkgver:"1:2.1.9-8ubuntu0.2")) flag++;
