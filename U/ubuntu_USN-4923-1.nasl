...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 20.10 : EDK II vulnerabilities (USN-4923-1)");
...
referenced in the USN-4923-1 advisory. Note that Nessus has not tested for this issue but has instead relied only on the
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'ovmf', 'pkgver': '2020.05-5ubuntu0.2'},
    {'osver': '20.10', 'pkgname': 'qemu-efi', 'pkgver': '2020.05-5ubuntu0.2'},
    {'osver': '20.10', 'pkgname': 'qemu-efi-aarch64', 'pkgver': '2020.05-5ubuntu0.2'},
    {'osver': '20.10', 'pkgname': 'qemu-efi-arm', 'pkgver': '2020.05-5ubuntu0.2'}
];
