...
# extracted from Ubuntu Security Notice USN-194-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : texinfo vulnerability (USN-194-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"info", pkgver:"4.6-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"texinfo", pkgver:"4.6-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"info", pkgver:"4.7-2.2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"texinfo", pkgver:"4.7-2.2ubuntu1.1")) flag++;
