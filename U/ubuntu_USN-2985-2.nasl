...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 : eglibc, glibc regression (USN-2985-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2985-2/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected libc-bin, libc6 and / or libc6-dev packages."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libc-bin", pkgver:"2.15-0ubuntu10.15")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libc6", pkgver:"2.15-0ubuntu10.15")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libc6-dev", pkgver:"2.15-0ubuntu10.15")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libc-bin", pkgver:"2.19-0ubuntu6.9")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libc6", pkgver:"2.19-0ubuntu6.9")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libc6-dev", pkgver:"2.19-0ubuntu6.9")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libc-bin", pkgver:"2.21-0ubuntu4.3")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libc6", pkgver:"2.21-0ubuntu4.3")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libc6-dev", pkgver:"2.21-0ubuntu4.3")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libc-bin / libc6 / libc6-dev");
}
