...
# extracted from Ubuntu Security Notice USN-427-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : enigmail vulnerability (USN-427-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/427-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"5.10", pkgname:"mozilla-thunderbird-enigmail", pkgver:"2:0.94-0ubuntu0.5.10.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"mozilla-thunderbird-enigmail", pkgver:"2:0.94-0ubuntu4.3")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"mozilla-thunderbird-enigmail", pkgver:"2:0.94-0ubuntu5.1")) flag++;
