...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.10 : Thunderbird vulnerabilities (USN-4328-1)");
...
of service, conduct cross-site scripting (XSS) attacks, obtain
sensitive information, or execute arbitrary code. (CVE-2019-20503,
CVE-2020-6798, CVE-2020-6800, CVE-2020-6805, CVE-2020-6806,
CVE-2020-6807, CVE-2020-6812, CVE-2020-6814, CVE-2020-6819,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4328-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"thunderbird", pkgver:"1:68.7.0+build1-0ubuntu0.18.04.1")) flag++;
