...
# extracted from Ubuntu Security Notice USN-3284-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 17.04 : openvpn vulnerabilities (USN-3284-1)");
...
this to cause a denial of service (application crash). (CVE-2017-7479).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3284-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"17.04", pkgname:"openvpn", pkgver:"2.4.0-4ubuntu1.2")) flag++;
