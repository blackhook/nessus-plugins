...
cause a denial of service (init crash leading to system
unavailability).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3094-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"systemd", pkgver:"229-4ubuntu10")) flag++;
