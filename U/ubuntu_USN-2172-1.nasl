...
# extracted from Ubuntu Security Notice USN-2172-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.10 : cups vulnerability (USN-2172-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2172-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"cups", pkgver:"1.4.3-1ubuntu1.11")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"cups", pkgver:"1.5.3-0ubuntu8.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"cups", pkgver:"1.6.1-0ubuntu11.6")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"cups", pkgver:"1.7.0~rc1-0ubuntu5.3")) flag++;
