...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 14.10 : samba vulnerability (USN-2481-1)");
  ...
  script_set_attribute(
    ...
    value:
"Andrew Bartlett discovered that Samba incorrectly handled delegation
of authority when being used as an Active Directory Domain Controller.
An attacker given delegation privileges could use this issue to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2481-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"samba", pkgver:"2:4.1.6+dfsg-1ubuntu2.14.04.4")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"samba", pkgver:"2:4.1.11+dfsg-1ubuntu2.1")) flag++;
