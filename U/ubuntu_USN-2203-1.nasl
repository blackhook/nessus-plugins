...
# extracted from Ubuntu Security Notice USN-2203-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2203-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/06/02");

  script_name(english:"Ubuntu 13.10 : linux vulnerability (USN-2203-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2203-1/");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2203-1");
  }
  else
  {
...
if (ubuntu_check(osver:"13.10", pkgname:"linux-image-3.11.0-20-generic", pkgver:"3.11.0-20.35")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"linux-image-3.11.0-20-generic-lpae", pkgver:"3.11.0-20.35")) flag++;
