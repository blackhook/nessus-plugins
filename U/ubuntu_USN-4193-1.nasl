...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 / 19.10 : Ghostscript vulnerability (USN-4193-1)");
...
could possibly use this issue to access arbitrary files, execute
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4193-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"ghostscript", pkgver:"9.26~dfsg+0-0ubuntu0.16.04.12")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libgs9", pkgver:"9.26~dfsg+0-0ubuntu0.16.04.12")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"ghostscript", pkgver:"9.26~dfsg+0-0ubuntu0.18.04.12")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libgs9", pkgver:"9.26~dfsg+0-0ubuntu0.18.04.12")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"ghostscript", pkgver:"9.26~dfsg+0-0ubuntu7.4")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"libgs9", pkgver:"9.26~dfsg+0-0ubuntu7.4")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"ghostscript", pkgver:"9.27~dfsg+0-0ubuntu3.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libgs9", pkgver:"9.27~dfsg+0-0ubuntu3.1")) flag++;
