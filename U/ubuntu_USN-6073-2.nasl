...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 22.10 / 23.04 : Glance_store vulnerability (USN-6073-2)");
...
as referenced in the USN-6073-2 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'python3-glance-store', 'pkgver': '4.1.0-0ubuntu1.1'},
