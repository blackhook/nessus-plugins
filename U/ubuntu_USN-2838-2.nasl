...
# extracted from Ubuntu Security Notice USN-2838-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : foomatic-filters vulnerability (USN-2838-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2838-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"foomatic-filters", pkgver:"4.0.16-0ubuntu0.4")) flag++;
