...
# extracted from Ubuntu Security Notice USN-265-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 : libcairo vulnerability (USN-265-1)");
...
if (ubuntu_check(osver:"5.10", pkgname:"libcairo2", pkgver:"1.0.2-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libcairo2-dev", pkgver:"1.0.2-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"libcairo2-doc", pkgver:"1.0.2-0ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libcairo2 / libcairo2-dev / libcairo2-doc");
}
