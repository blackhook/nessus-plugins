...
# extracted from Ubuntu Security Notice USN-927-6. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 9.04 : nss vulnerability (USN-927-6)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-927-1 fixed vulnerabilities in NSS on Ubuntu 9.10. This update
provides the corresponding updates for Ubuntu 9.04.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/927-6/"
  );
...
if (! preg(pattern:"^(9\.04)$", string:release)) audit(AUDIT_OS_NOT, "Ubuntu 9.04", "Ubuntu " + release);
...
if (ubuntu_check(osver:"9.04", pkgname:"libnss3-0d", pkgver:"3.12.6-0ubuntu0.9.04.1")) flag++;
if (ubuntu_check(osver:"9.04", pkgname:"libnss3-1d", pkgver:"3.12.6-0ubuntu0.9.04.1")) flag++;
if (ubuntu_check(osver:"9.04", pkgname:"libnss3-1d-dbg", pkgver:"3.12.6-0ubuntu0.9.04.1")) flag++;
if (ubuntu_check(osver:"9.04", pkgname:"libnss3-dev", pkgver:"3.12.6-0ubuntu0.9.04.1")) flag++;
if (ubuntu_check(osver:"9.04", pkgname:"libnss3-tools", pkgver:"3.12.6-0ubuntu0.9.04.1")) flag++;
