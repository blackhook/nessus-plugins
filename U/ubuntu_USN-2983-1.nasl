...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 / 16.04 LTS : expat vulnerability (USN-2983-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2983-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"12.04", pkgname:"lib64expat1", pkgver:"2.0.1-7.2ubuntu1.3")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libexpat1", pkgver:"2.0.1-7.2ubuntu1.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"lib64expat1", pkgver:"2.1.0-4ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libexpat1", pkgver:"2.1.0-4ubuntu1.2")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"lib64expat1", pkgver:"2.1.0-7ubuntu0.15.10.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libexpat1", pkgver:"2.1.0-7ubuntu0.15.10.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"lib64expat1", pkgver:"2.1.0-7ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libexpat1", pkgver:"2.1.0-7ubuntu0.16.04.1")) flag++;
