...
# extracted from Ubuntu Security Notice USN-75-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : cpio vulnerability (USN-75-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"cpio", pkgver:"2.5-1.1ubuntu0.1")) flag++;
