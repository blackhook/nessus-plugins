...
# extracted from Ubuntu Security Notice USN-243-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 : tuxpaint vulnerability (USN-243-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"Javier Fernandez-Sanguino Pena discovered that the tuxpaint-import.sh
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected tuxpaint and / or tuxpaint-data packages."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:tuxpaint");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:tuxpaint-data");
...
if (ubuntu_check(osver:"5.10", pkgname:"tuxpaint", pkgver:"0.9.14-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"tuxpaint-data", pkgver:"0.9.14-2ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "tuxpaint / tuxpaint-data");
}
