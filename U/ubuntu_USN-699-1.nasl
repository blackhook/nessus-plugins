...
# extracted from Ubuntu Security Notice USN-699-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(28870, 31931);
  script_xref(name:"USN", value:"699-1");

  script_name(english:"Ubuntu 6.06 LTS : blender vulnerabilities (USN-699-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/699-1/"
  );
  script_set_attribute(
    attribute:"solution", 
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:blender");
...
if (ubuntu_check(osver:"6.06", pkgname:"blender", pkgver:"2.41-1ubuntu4.1")) flag++;
