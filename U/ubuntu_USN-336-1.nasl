...
# extracted from Ubuntu Security Notice USN-336-1. The text 
...
if (description)
{
  ...
  script_cve_id("CVE-2005-4807");
  script_xref(name:"USN", value:"336-1");

  script_name(english:"Ubuntu 5.04 / 5.10 : binutils vulnerability (USN-336-1)");
...
if (ubuntu_check(osver:"5.04", pkgname:"binutils", pkgver:"2.15-5ubuntu2.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"binutils-dev", pkgver:"2.15-5ubuntu2.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"binutils-doc", pkgver:"2.15-5ubuntu2.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"binutils-multiarch", pkgver:"2.15-5ubuntu2.4")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"binutils", pkgver:"2.16.1-2ubuntu6.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"binutils-dev", pkgver:"2.16.1-2ubuntu6.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"binutils-doc", pkgver:"2.16.1-2ubuntu6.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"binutils-multiarch", pkgver:"2.16.1-2ubuntu6.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"binutils-static", pkgver:"2.16.1-2ubuntu6.2")) flag++;
