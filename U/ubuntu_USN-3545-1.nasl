...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : Thunderbird vulnerabilities (USN-3545-1)");
...
of service, or execute arbitrary code. (CVE-2018-5125, CVE-2018-5127,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3545-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"thunderbird", pkgver:"1:52.7.0+build1-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"thunderbird", pkgver:"1:52.7.0+build1-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"thunderbird", pkgver:"1:52.7.0+build1-0ubuntu0.17.10.1")) flag++;
