...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that IPRoute incorrectly handled certain inputs. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4357-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"iproute2", pkgver:"4.15.0-2ubuntu1.1")) flag++;
