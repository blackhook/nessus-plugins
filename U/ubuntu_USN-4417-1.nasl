...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : NSS vulnerability (USN-4417-1)");
...
discovered that NSS incorrectly handled RSA key generation. A local
attacker could possibly use this issue to perform a timing attack and
recover RSA keys.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4417-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libnss3", pkgver:"2:3.28.4-0ubuntu0.16.04.12")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libnss3", pkgver:"2:3.35-2ubuntu2.9")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libnss3", pkgver:"2:3.45-1ubuntu2.4")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libnss3", pkgver:"2:3.49.1-1ubuntu1.2")) flag++;
