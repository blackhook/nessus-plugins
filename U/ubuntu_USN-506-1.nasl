...
# extracted from Ubuntu Security Notice USN-506-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 / 7.04 : tar vulnerability (USN-506-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/506-1/"
  );
...
if (ubuntu_check(osver:"6.06", pkgname:"tar", pkgver:"1.15.1-2ubuntu2.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"tar", pkgver:"1.15.91-2ubuntu0.4")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"tar", pkgver:"1.16-2ubuntu0.1")) flag++;
