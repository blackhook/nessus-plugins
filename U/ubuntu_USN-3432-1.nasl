...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : ca-certificates update (USN-3432-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3432-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"ca-certificates", pkgver:"20170717~14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"ca-certificates", pkgver:"20170717~16.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"ca-certificates", pkgver:"20170717~17.04.1")) flag++;
