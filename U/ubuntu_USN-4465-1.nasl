...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4465-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2020-12655", "CVE-2020-12771", "CVE-2020-15393", "CVE-2020-24394");
...
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-1033-aws", pkgver:"5.3.0-1033.35")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-1033-gke", pkgver:"5.3.0-1033.35")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-1035-azure", pkgver:"5.3.0-1035.36")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-65-generic", pkgver:"5.3.0-65.59")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-65-lowlatency", pkgver:"5.3.0-65.59")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-azure", pkgver:"5.3.0.1035.31")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-gke-5.3", pkgver:"5.3.0.1033.18")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-gkeop-5.3", pkgver:"5.3.0.65.121")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "linux-image-5.3-aws / linux-image-5.3-azure / etc");
}
