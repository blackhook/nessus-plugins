...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3747-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Update the affected openjdk-11-jre, openjdk-11-jre-headless and / or
openjdk-11-jre-zero packages."
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"openjdk-11-jre", pkgver:"10.0.2+13-1ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"openjdk-11-jre-headless", pkgver:"10.0.2+13-1ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"openjdk-11-jre-zero", pkgver:"10.0.2+13-1ubuntu0.18.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "openjdk-11-jre / openjdk-11-jre-headless / openjdk-11-jre-zero");
}
