...
# extracted from Ubuntu Security Notice USN-2388-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.10 : openjdk-7 vulnerabilities (USN-2388-2)");
...
related to data integrity. (CVE-2014-6502, CVE-2014-6512,
CVE-2014-6519, CVE-2014-6527, CVE-2014-6558)
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2388-2/"
  );
...
if (ubuntu_check(osver:"14.10", pkgname:"icedtea-7-jre-jamvm", pkgver:"7u71-2.5.3-0ubuntu1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"openjdk-7-jre", pkgver:"7u71-2.5.3-0ubuntu1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"openjdk-7-jre-headless", pkgver:"7u71-2.5.3-0ubuntu1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"openjdk-7-jre-lib", pkgver:"7u71-2.5.3-0ubuntu1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"openjdk-7-jre-zero", pkgver:"7u71-2.5.3-0ubuntu1")) flag++;
