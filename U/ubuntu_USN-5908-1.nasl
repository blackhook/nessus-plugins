...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.04 LTS / 22.10 : Sudo vulnerability (USN-5908-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'sudo', 'pkgver': '1.9.11p3-1ubuntu1.2'},
    {'osver': '22.10', 'pkgname': 'sudo-ldap', 'pkgver': '1.9.11p3-1ubuntu1.2'}
];
