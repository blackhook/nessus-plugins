...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Matthias Gerstner discovered that LXC incorrectly handled the
lxc-user-nic utility. A local attacker could possibly use this issue
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3730-1/"
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"lxc", pkgver:"3.0.1-0ubuntu1~18.04.2")) flag++;
