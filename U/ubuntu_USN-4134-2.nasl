...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 : IBus regression (USN-4134-2)");
  ...
  script_set_attribute(
    ...
    value:
"USN-4134-1 fixed a vulnerability in IBus. The security fix introduced
a regression when being used with Qt applications. This update reverts
the security fix pending further investigation.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4134-2/"
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"ibus", pkgver:"1.5.11-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"ibus", pkgver:"1.5.17-3ubuntu5.2")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"ibus", pkgver:"1.5.19-1ubuntu2.2")) flag++;
