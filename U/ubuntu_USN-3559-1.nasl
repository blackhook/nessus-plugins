...
# extracted from Ubuntu Security Notice USN-3559-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3559-1");

  script_name(english:"Ubuntu 17.10 : python-django vulnerabilities (USN-3559-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Django incorrectly handled certain requests. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3559-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"17.10", pkgname:"python-django", pkgver:"1:1.11.4-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"python3-django", pkgver:"1:1.11.4-1ubuntu1.1")) flag++;
