...
# extracted from Ubuntu Security Notice USN-111-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : squid vulnerability (USN-111-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"squid", pkgver:"2.5.5-6ubuntu0.7")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"squid-cgi", pkgver:"2.5.5-6ubuntu0.7")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"squid-common", pkgver:"2.5.5-6ubuntu0.7")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"squidclient", pkgver:"2.5.5-6ubuntu0.7")) flag++;
