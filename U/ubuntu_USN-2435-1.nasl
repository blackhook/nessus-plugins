...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS / 14.10 : graphviz vulnerability (USN-2435-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2435-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"graphviz", pkgver:"2.20.2-8ubuntu3.2")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"graphviz", pkgver:"2.26.3-10ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"graphviz", pkgver:"2.36.0-0ubuntu3.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"graphviz", pkgver:"2.38.0-5ubuntu0.1")) flag++;
