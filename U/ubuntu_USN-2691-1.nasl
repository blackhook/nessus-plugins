...
# extracted from Ubuntu Security Notice USN-2691-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 15.04 : linux vulnerabilities (USN-2691-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2691-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2015-1333", "CVE-2015-3290", "CVE-2015-3291", "CVE-2015-5157");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2691-1");
  }
  else
  {
...
if (ubuntu_check(osver:"15.04", pkgname:"linux-image-3.19.0-25-generic", pkgver:"3.19.0-25.26")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"linux-image-3.19.0-25-generic-lpae", pkgver:"3.19.0-25.26")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"linux-image-3.19.0-25-lowlatency", pkgver:"3.19.0-25.26")) flag++;
