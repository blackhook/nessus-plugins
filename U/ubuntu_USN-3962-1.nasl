...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 18.10 : libpng vulnerability (USN-3962-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3962-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected libpng16-16 package."
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"libpng16-16", pkgver:"1.6.34-1ubuntu0.18.04.2")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"libpng16-16", pkgver:"1.6.34-2ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libpng16-16");
}
