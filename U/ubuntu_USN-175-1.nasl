...
# extracted from Ubuntu Security Notice USN-175-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : ntp vulnerability (USN-175-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"ntp", pkgver:"4.2.0a-10ubuntu2.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"ntp-doc", pkgver:"4.2.0a-10ubuntu2.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"ntp-refclock", pkgver:"4.2.0a-10ubuntu2.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"ntp-server", pkgver:"4.2.0a-10ubuntu2.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"ntp-simple", pkgver:"4.2.0a-10ubuntu2.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"ntpdate", pkgver:"4.2.0a-10ubuntu2.1")) flag++;
