...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 / 17.10 : procmail vulnerability (USN-3483-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3483-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"procmail", pkgver:"3.22-21ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"procmail", pkgver:"3.22-25ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"procmail", pkgver:"3.22-25ubuntu0.17.04.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"procmail", pkgver:"3.22-25ubuntu0.17.10.1")) flag++;
