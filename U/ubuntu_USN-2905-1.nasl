...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 15.10 : oxide-qt vulnerability (USN-2905-1)");
  ...
  script_set_attribute(
    ...
    value:
"A security issue was discovered in Chromium. If a user were tricked in
to opening a specially crafted website, an attacker could potentially
exploit this to bypass same-origin restrictions or a sandbox
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2905-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"14.04", pkgname:"liboxideqtcore0", pkgver:"1.12.7-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"liboxideqtcore0", pkgver:"1.12.7-0ubuntu0.15.10.1")) flag++;
