...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS : php7.2 vulnerability (USN-3702-2)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"USN-3702-1 fixed a vulnerability in PHP. PHP 7.2.7 did not actually
include the fix for CVE-2018-12882. This update adds a backported
...
It was discovered that PHP incorrectly handled exif tags in certain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3702-2/"
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"libapache2-mod-php7.2", pkgver:"7.2.7-0ubuntu0.18.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"php7.2-cgi", pkgver:"7.2.7-0ubuntu0.18.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"php7.2-cli", pkgver:"7.2.7-0ubuntu0.18.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"php7.2-fpm", pkgver:"7.2.7-0ubuntu0.18.04.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libapache2-mod-php7.2 / php7.2-cgi / php7.2-cli / php7.2-fpm");
}
