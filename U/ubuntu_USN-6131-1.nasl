...
if (machine_kernel_release)
{
  ...
  var extra = '';
  if ('18.04' >< os_release) {
    kernel_pattern = "^5.4.0-\d+-(azure|gcp|generic|generic-lpae|ibm|lowlatency|oracle)$";
    kernel_mappings = {
            "5.4.0-\d+(-generic|-generic-lpae|-lowlatency)" : "5.4.0-150",
            "5.4.0-\d+-azure" : "5.4.0-1109",
            "5.4.0-\d+-gcp" : "5.4.0-1106",
            "5.4.0-\d+-ibm" : "5.4.0-1050",
            "5.4.0-\d+-oracle" : "5.4.0-1102"
    };
  };
  if ('20.04' >< os_release) {
    ...
    kernel_mappings = {
            "5.4.0-\d+(-generic|-generic-lpae|-lowlatency)" : "5.4.0-150",
            "5.4.0-\d+-aws" : "5.4.0-1103",
            "5.4.0-\d+-azure" : "5.4.0-1109",
            "5.4.0-\d+-gcp" : "5.4.0-1106",
            "5.4.0-\d+-gke" : "5.4.0-1100",
            "5.4.0-\d+-gkeop" : "5.4.0-1070",
            "5.4.0-\d+-ibm" : "5.4.0-1050",
            "5.4.0-\d+-kvm" : "5.4.0-1092",
            "5.4.0-\d+-oracle" : "5.4.0-1102"
    };
  };
