...
# extracted from Ubuntu Security Notice USN-373-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : mutt vulnerabilities (USN-373-1)");
...
default), other local users could overwrite arbitrary files owned by
the user running mutt. This vulnerability is more likely when the temp
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/373-1/"
  );
...
if (ubuntu_check(osver:"5.10", pkgname:"mutt", pkgver:"1.5.9-2ubuntu1.2")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"mutt", pkgver:"1.5.11-3ubuntu2.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"mutt", pkgver:"1.5.12-1ubuntu1.1")) flag++;
