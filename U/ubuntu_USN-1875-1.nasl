...
# extracted from Ubuntu Security Notice USN-1875-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.10 / 13.04 : keystone vulnerabilities (USN-1875-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1875-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.10", pkgname:"python-keystone", pkgver:"2012.2.4-0ubuntu3.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"python-keystone", pkgver:"1:2013.1.1-0ubuntu2.1")) flag++;
