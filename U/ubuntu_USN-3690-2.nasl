...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : amd64-microcode regression (USN-3690-2) (Spectre)");
...
family processors required for the corresponding Linux
kernel updates.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3690-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"amd64-microcode", pkgver:"3.20180524.1~ubuntu0.14.04.2+really20130710.1")) flag++;
