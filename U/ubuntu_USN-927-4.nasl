...
# extracted from Ubuntu Security Notice USN-927-4. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS : nss vulnerability (USN-927-4)");
...
provides the corresponding updates for Ubuntu 8.04 LTS.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/927-4/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"libnss3-0d", pkgver:"3.12.6-0ubuntu0.8.04.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libnss3-1d", pkgver:"3.12.6-0ubuntu0.8.04.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libnss3-1d-dbg", pkgver:"3.12.6-0ubuntu0.8.04.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libnss3-dev", pkgver:"3.12.6-0ubuntu0.8.04.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"libnss3-tools", pkgver:"3.12.6-0ubuntu0.8.04.1")) flag++;
