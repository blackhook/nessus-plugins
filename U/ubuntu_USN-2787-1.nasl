...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : audiofile vulnerability (USN-2787-1)");
  ...
  script_set_attribute(
    ...
    value:
"Fabrizio Gennari discovered that audiofile incorrectly handled
changing both the sample format and the number of channels. If a user
or automated system were tricked into processing a specially crafted
file, audiofile could be made to crash, leading to a denial of
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2787-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libaudiofile1", pkgver:"0.3.3-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libaudiofile1", pkgver:"0.3.6-2ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"libaudiofile1", pkgver:"0.3.6-2ubuntu0.15.04.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libaudiofile1", pkgver:"0.3.6-2ubuntu0.15.10.1")) flag++;
