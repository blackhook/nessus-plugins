...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : linux-lts-utopic vulnerabilities (USN-2797-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2797-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2015-0272", "CVE-2015-2925", "CVE-2015-5257", "CVE-2015-5283");
...
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.16.0-52-generic", pkgver:"3.16.0-52.71~14.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.16.0-52-generic-lpae", pkgver:"3.16.0-52.71~14.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.16.0-52-lowlatency", pkgver:"3.16.0-52.71~14.04.1")) flag++;
