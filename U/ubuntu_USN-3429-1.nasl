...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : libplist vulnerability (USN-3429-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3429-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"libplist-utils", pkgver:"1.10-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libplist1", pkgver:"1.10-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"python-plist", pkgver:"1.10-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libplist-utils", pkgver:"1.12-3.1ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libplist3", pkgver:"1.12-3.1ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python-plist", pkgver:"1.12-3.1ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libplist-utils", pkgver:"1.12-3.1ubuntu0.17.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libplist3", pkgver:"1.12-3.1ubuntu0.17.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"python-plist", pkgver:"1.12-3.1ubuntu0.17.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libplist-utils / libplist1 / libplist3 / python-plist");
}
