...
if (description)
{
  ...
  script_name(english:"Ubuntu 17.10 / 18.04 LTS : WavPack vulnerabilities (USN-3637-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3637-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"17.10", pkgname:"wavpack", pkgver:"5.1.0-2ubuntu0.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"wavpack", pkgver:"5.1.0-2ubuntu1.1")) flag++;
