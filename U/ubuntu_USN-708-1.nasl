...
# extracted from Ubuntu Security Notice USN-708-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.10 : hplip vulnerability (USN-708-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/708-1/"
  );
...
if (ubuntu_check(osver:"7.10", pkgname:"hpijs", pkgver:"2.7.7+2.7.7.dfsg.1-0ubuntu5.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"hpijs-ppds", pkgver:"2.7.7+2.7.7.dfsg.1-0ubuntu5.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"hplip", pkgver:"2.7.7.dfsg.1-0ubuntu5.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"hplip-data", pkgver:"2.7.7.dfsg.1-0ubuntu5.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"hplip-dbg", pkgver:"2.7.7.dfsg.1-0ubuntu5.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"hplip-doc", pkgver:"2.7.7.dfsg.1-0ubuntu5.3")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"hplip-gui", pkgver:"2.7.7.dfsg.1-0ubuntu5.3")) flag++;
