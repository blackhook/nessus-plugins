...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 18.10 : GStreamer Base Plugins vulnerability (USN-3958-1)");
...
crafted RTSP stream with a GStreamer application, an attacker could
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3958-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"16.04", pkgname:"gstreamer0.10-plugins-base", pkgver:"0.10.36-2ubuntu0.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"gstreamer1.0-plugins-base", pkgver:"1.8.3-1ubuntu0.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"gstreamer1.0-plugins-base", pkgver:"1.14.1-1ubuntu1~ubuntu18.04.2")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"gstreamer1.0-plugins-base", pkgver:"1.14.4-1ubuntu1.1")) flag++;
