...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : intel-microcode update (USN-3531-3) (Spectre)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3531-3/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"intel-microcode", pkgver:"3.20180312.0~ubuntu14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"intel-microcode", pkgver:"3.20180312.0~ubuntu16.04.1")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"intel-microcode", pkgver:"3.20180312.0~ubuntu17.10.1")) flag++;
