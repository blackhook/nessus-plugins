...
# extracted from Ubuntu Security Notice USN-12-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : ppp Denial of Service (USN-12-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected ppp and / or ppp-dev packages."
  );
...
if (ubuntu_check(osver:"4.10", pkgname:"ppp", pkgver:"2.4.2+20040428-2ubuntu6.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"ppp-dev", pkgver:"2.4.2+20040428-2ubuntu6.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "ppp / ppp-dev");
}
