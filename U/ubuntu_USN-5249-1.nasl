...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.10 : USBView vulnerability (USN-5249-1)");
...
referenced in the USN-5249-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'usbview', 'pkgver': '2.0-21-g6fe2f4f-2ubuntu0.21.10.3'}
];
