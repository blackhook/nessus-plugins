...
# extracted from Ubuntu Security Notice USN-1232-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 : xorg-server vulnerability (USN-1232-3)");
...
was found on Ubuntu 10.04 LTS that affected GLX support, and
USN-1232-2 was released to temporarily disable the problematic
security fix. This update includes a revised fix for CVE-2010-4818.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1232-3/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"xserver-xorg-core", pkgver:"2:1.7.6-2ubuntu7.10")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"xserver-xorg-core", pkgver:"2:1.9.0-0ubuntu7.6")) flag++;
