...
# extracted from Ubuntu Security Notice USN-1124-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 9.10 / 10.04 LTS / 10.10 : rsync vulnerability (USN-1124-1)");
...
recursion, deletion and ownership options were used. If a user were
tricked into connecting to a malicious server, a remote attacker could
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1124-1/"
  );
...
if (ubuntu_check(osver:"9.10", pkgname:"rsync", pkgver:"3.0.6-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"rsync", pkgver:"3.0.7-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"rsync", pkgver:"3.0.7-2ubuntu1.1")) flag++;
