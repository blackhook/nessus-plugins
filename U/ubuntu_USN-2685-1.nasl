...
# extracted from Ubuntu Security Notice USN-2685-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.10 : Linux kernel vulnerabilities (USN-2685-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2685-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2685-1");
  }
  else
  {
