...
# extracted from Ubuntu Security Notice USN-3083-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : linux-lts-trusty vulnerabilities (USN-3083-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3083-2/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2015-8767", "CVE-2016-3841");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-3083-2");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-96-generic", pkgver:"3.13.0-96.143~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-96-generic-lpae", pkgver:"3.13.0-96.143~precise1")) flag++;
