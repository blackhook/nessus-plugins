...
# extracted from Ubuntu Security Notice USN-2130-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.10 : tomcat6, tomcat7 vulnerabilities (USN-2130-1)");
...
HTTP headers. A remote attacker could possibly use this flaw to
...
a denial of service. (CVE-2013-4322)

It was discovered that Tomcat incorrectly applied the
disableURLRewriting setting when handling a session id in a URL. A
remote attacker could possibly use this flaw to conduct session
fixation attacks. This issue only applied to Ubuntu 12.04 LTS.
(CVE-2014-0033)

It was discovered that Tomcat incorrectly handled malformed
Content-Type headers and multipart requests. A remote attacker could
use this flaw to cause the Tomcat server to stop responding, resulting
in a denial of service. This issue only applied to Ubuntu 12.10 and
Ubuntu 13.10. (CVE-2014-0050).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2130-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libtomcat6-java", pkgver:"6.0.24-2ubuntu1.15")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libtomcat6-java", pkgver:"6.0.35-1ubuntu3.4")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libtomcat7-java", pkgver:"7.0.30-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libtomcat7-java", pkgver:"7.0.42-1ubuntu0.1")) flag++;
