...
# extracted from Ubuntu Security Notice USN-248-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 / 5.10 : unzip regression fix (USN-248-2)");
...
if (ubuntu_check(osver:"4.10", pkgname:"unzip", pkgver:"5.51-2ubuntu0.4")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"unzip", pkgver:"5.51-2ubuntu1.4")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"unzip", pkgver:"5.52-3ubuntu2.2")) flag++;
