...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : SoX vulnerabilities (USN-5904-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'libsox-dev', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox-fmt-all', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox-fmt-alsa', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox-fmt-ao', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox-fmt-base', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox-fmt-mp3', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox-fmt-oss', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox-fmt-pulse', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'libsox3', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'sox', 'pkgver': '14.4.2+git20190427-3ubuntu0.1'}
];
