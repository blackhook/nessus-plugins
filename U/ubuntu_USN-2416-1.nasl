...
# extracted from Ubuntu Security Notice USN-2416-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(68214, 70314);
  script_xref(name:"USN", value:"2416-1");

  script_name(english:"Ubuntu 10.04 LTS : linux-ec2 vulnerabilities (USN-2416-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2416-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2014-4608", "CVE-2014-7975");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2416-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-2.6.32-372-ec2", pkgver:"2.6.32-372.89")) flag++;
