...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that FreeType incorrectly handled certain font
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4126-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libfreetype6", pkgver:"2.6.1-0.1ubuntu2.4")) flag++;
