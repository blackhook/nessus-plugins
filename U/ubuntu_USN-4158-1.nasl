...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 : tiff vulnerabilities (USN-4158-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4158-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libtiff-tools", pkgver:"4.0.6-1ubuntu0.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libtiff5", pkgver:"4.0.6-1ubuntu0.7")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libtiff-tools", pkgver:"4.0.9-5ubuntu0.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libtiff5", pkgver:"4.0.9-5ubuntu0.3")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"libtiff-tools", pkgver:"4.0.10-4ubuntu0.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"libtiff5", pkgver:"4.0.10-4ubuntu0.1")) flag++;
