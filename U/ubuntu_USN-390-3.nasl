...
# extracted from Ubuntu Security Notice USN-390-3. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 : evince-gtk vulnerability (USN-390-3)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/390-3/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected evince-gtk package."
  );
...
if (ubuntu_check(osver:"6.06", pkgname:"evince-gtk", pkgver:"0.5.2-0ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"evince-gtk", pkgver:"0.5.2-0ubuntu4.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "evince-gtk");
}
