...
# extracted from Ubuntu Security Notice USN-141-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : tcpdump vulnerability (USN-141-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"tcpdump", pkgver:"3.8.3-3ubuntu0.3")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"tcpdump", pkgver:"3.8.3-3ubuntu0.4")) flag++;
