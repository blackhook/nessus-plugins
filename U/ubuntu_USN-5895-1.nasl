...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : MPlayer vulnerabilities (USN-5895-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'mencoder', 'pkgver': '2:1.2.1-1ubuntu1.1+esm1'},
    {'osver': '16.04', 'pkgname': 'mplayer', 'pkgver': '2:1.2.1-1ubuntu1.1+esm1'},
    {'osver': '16.04', 'pkgname': 'mplayer-gui', 'pkgver': '2:1.2.1-1ubuntu1.1+esm1'},
    {'osver': '16.04', 'pkgname': 'mplayer2', 'pkgver': '2:1.2.1-1ubuntu1.1+esm1'},
    {'osver': '18.04', 'pkgname': 'mencoder', 'pkgver': '2:1.3.0-7ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'mplayer', 'pkgver': '2:1.3.0-7ubuntu0.2'},
    {'osver': '18.04', 'pkgname': 'mplayer-gui', 'pkgver': '2:1.3.0-7ubuntu0.2'},
    {'osver': '20.04', 'pkgname': 'mencoder', 'pkgver': '2:1.3.0-8+deb10u1build0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'mplayer', 'pkgver': '2:1.3.0-8+deb10u1build0.20.04.1'},
    {'osver': '20.04', 'pkgname': 'mplayer-gui', 'pkgver': '2:1.3.0-8+deb10u1build0.20.04.1'},
    {'osver': '22.04', 'pkgname': 'mencoder', 'pkgver': '2:1.4+ds1-3ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'mplayer', 'pkgver': '2:1.4+ds1-3ubuntu0.1'},
    {'osver': '22.04', 'pkgname': 'mplayer-gui', 'pkgver': '2:1.4+ds1-3ubuntu0.1'},
    {'osver': '22.10', 'pkgname': 'mencoder', 'pkgver': '2:1.4+ds1-3ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'mplayer', 'pkgver': '2:1.4+ds1-3ubuntu1.1'},
    {'osver': '22.10', 'pkgname': 'mplayer-gui', 'pkgver': '2:1.4+ds1-3ubuntu1.1'}
];
