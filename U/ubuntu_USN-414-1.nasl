...
# extracted from Ubuntu Security Notice USN-414-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 : squid vulnerabilities (USN-414-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/414-1/"
  );
...
if (ubuntu_check(osver:"6.06", pkgname:"squid", pkgver:"2.5.12-4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"squid-cgi", pkgver:"2.5.12-4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"squid-common", pkgver:"2.5.12-4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"squidclient", pkgver:"2.5.12-4ubuntu2.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"squid", pkgver:"2.6.1-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"squid-cgi", pkgver:"2.6.1-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"squid-common", pkgver:"2.6.1-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"squidclient", pkgver:"2.6.1-3ubuntu1.2")) flag++;
