...
# extracted from Ubuntu Security Notice USN-1037-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 : ifupdown update (USN-1037-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1037-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected ifupdown package."
  );
  script_set_attribute(attribute:"risk_factor", value:"High");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:ifupdown");
...
if (ubuntu_check(osver:"10.04", pkgname:"ifupdown", pkgver:"0.6.8ubuntu29.2")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"ifupdown", pkgver:"0.6.10ubuntu3.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "ifupdown");
}
