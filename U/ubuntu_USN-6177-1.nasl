...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 20.04 LTS / 22.04 LTS : Jettison vulnerabilities (USN-6177-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 ESM / 20.04 LTS / 22.04 LTS host has a package installed that is affected by multiple
vulnerabilities as referenced in the USN-6177-1 advisory.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libjettison-java', 'pkgver': '1.2-3ubuntu0.1~esm1'},
    {'osver': '18.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.0-1ubuntu0.18.04.1~esm1'},
    {'osver': '20.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.0-1ubuntu0.20.04.1'},
    {'osver': '22.04', 'pkgname': 'libjettison-java', 'pkgver': '1.4.1-1ubuntu0.22.04.1'},
    {'osver': '22.10', 'pkgname': 'libjettison-java', 'pkgver': '1.4.1-1ubuntu0.22.10.1'}
];
