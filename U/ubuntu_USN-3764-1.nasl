...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3764-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"zsh", pkgver:"5.0.2-3ubuntu6.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"zsh", pkgver:"5.1.1-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"zsh", pkgver:"5.4.2-3ubuntu3.1")) flag++;
