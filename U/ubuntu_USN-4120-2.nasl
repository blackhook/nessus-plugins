...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.04 : systemd regression (USN-4120-2)");
  ...
  script_set_attribute(
    ...
    value:
"USN-4120-1 fixed a vulnerability in systemd. The update included a
recent SRU from the updates pocket that introduced networking problems
for some users. This update fixes the problem.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4120-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"systemd", pkgver:"237-3ubuntu10.29")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"systemd", pkgver:"240-6ubuntu5.7")) flag++;
