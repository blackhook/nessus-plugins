...
denial of service, or possibly escalate privileges if kernel symlink
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3748-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"base-files", pkgver:"10.1ubuntu2.2")) flag++;
