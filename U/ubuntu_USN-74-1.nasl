...
# extracted from Ubuntu Security Notice USN-74-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : postfix vulnerability (USN-74-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"postfix", pkgver:"2.1.3-1ubuntu17.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"postfix-dev", pkgver:"2.1.3-1ubuntu17.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"postfix-doc", pkgver:"2.1.3-1ubuntu17.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"postfix-ldap", pkgver:"2.1.3-1ubuntu17.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"postfix-mysql", pkgver:"2.1.3-1ubuntu17.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"postfix-pcre", pkgver:"2.1.3-1ubuntu17.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"postfix-pgsql", pkgver:"2.1.3-1ubuntu17.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"postfix-tls", pkgver:"2.1.3-1ubuntu17.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "postfix / postfix-dev / postfix-doc / postfix-ldap / postfix-mysql / etc");
}
