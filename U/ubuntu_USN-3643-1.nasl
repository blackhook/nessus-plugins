...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 / 18.04 LTS : wget vulnerability (USN-3643-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3643-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"wget", pkgver:"1.15-1ubuntu1.14.04.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"wget", pkgver:"1.17.1-1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"wget", pkgver:"1.19.1-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"wget", pkgver:"1.19.4-1ubuntu2.1")) flag++;
