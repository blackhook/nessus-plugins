...
USN-6113-1 advisory.
  ...
  - An integer underflow bug in the process_EXIF function of the exif.c file of jhead 3.00 raises a heap-based
    buffer over-read when processing a malicious JPEG file, which may allow a remote attacker to cause a
    denial-of-service attack or unspecified other impact. (CVE-2018-6612)
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'jhead', 'pkgver': '1:3.00-4+deb9u1ubuntu0.1~esm4'}
];
