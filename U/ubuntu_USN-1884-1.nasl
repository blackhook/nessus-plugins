...
# extracted from Ubuntu Security Notice USN-1884-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : libraw vulnerability (USN-1884-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that LibRaw incorrectly handled broken full-color
images. If a user or automated system were tricked into processing a
specially crafted raw image, applications linked against LibRaw could
be made to crash, resulting in a denial of service, or possibly
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1884-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libraw5", pkgver:"0.14.4-0ubuntu2.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libraw5", pkgver:"0.14.7-0ubuntu1.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libraw5", pkgver:"0.14.7-0ubuntu1.13.04.1")) flag++;
