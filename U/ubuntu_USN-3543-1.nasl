...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : rsync vulnerabilities (USN-3543-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3543-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"rsync", pkgver:"3.1.0-2ubuntu0.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"rsync", pkgver:"3.1.1-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"rsync", pkgver:"3.1.2-2ubuntu0.2")) flag++;
