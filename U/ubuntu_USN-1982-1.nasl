...
# extracted from Ubuntu Security Notice USN-1982-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS : python2.6 vulnerability (USN-1982-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1982-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"python2.6", pkgver:"2.6.5-1ubuntu6.2")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"python2.6-minimal", pkgver:"2.6.5-1ubuntu6.2")) flag++;
