...
# extracted from Ubuntu Security Notice USN-2597-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : linux-lts-trusty vulnerability (USN-2597-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2597-2/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-52-generic", pkgver:"3.13.0-52.86~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-52-generic-lpae", pkgver:"3.13.0-52.86~precise1")) flag++;
