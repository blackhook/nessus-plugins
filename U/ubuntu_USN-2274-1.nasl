...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : linux vulnerability (USN-2274-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2274-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-30-generic", pkgver:"3.13.0-30.55")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-30-generic-lpae", pkgver:"3.13.0-30.55")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-30-lowlatency", pkgver:"3.13.0-30.55")) flag++;
