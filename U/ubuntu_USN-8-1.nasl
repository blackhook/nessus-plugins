...
# extracted from Ubuntu Security Notice USN-8-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : gaim vulnerabilities (USN-8-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"gaim", pkgver:"1.0.0-1ubuntu1.1")) flag++;
