...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 18.10 : LibRaw vulnerabilities (USN-3989-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3989-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libraw15", pkgver:"0.17.1-1ubuntu0.5")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libraw16", pkgver:"0.18.8-1ubuntu0.3")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"libraw16", pkgver:"0.18.13-1ubuntu0.1")) flag++;
