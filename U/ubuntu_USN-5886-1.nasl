...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : Intel Microcode vulnerabilities (USN-5886-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20230214.0ubuntu0.16.04.1+esm1'},
    {'osver': '18.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20230214.0ubuntu0.18.04.1'},
    {'osver': '20.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20230214.0ubuntu0.20.04.1'},
    {'osver': '22.04', 'pkgname': 'intel-microcode', 'pkgver': '3.20230214.0ubuntu0.22.04.1'},
    {'osver': '22.10', 'pkgname': 'intel-microcode', 'pkgver': '3.20230214.0ubuntu0.22.10.1'}
];
