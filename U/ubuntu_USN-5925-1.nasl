...
{
  if (! preg(pattern:"^(4.15.0-\d+-(kvm|raspi2|snapdragon))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.15.0-\d+-kvm" : "4.15.0-1136",
    "4.15.0-\d+-raspi2" : "4.15.0-1128",
    "4.15.0-\d+-snapdragon" : "4.15.0-1146"
  };
