...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 / 17.04 : sudo vulnerability (USN-3304-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3304-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"sudo", pkgver:"1.8.9p5-1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"sudo-ldap", pkgver:"1.8.9p5-1ubuntu1.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"sudo", pkgver:"1.8.16-0ubuntu1.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"sudo-ldap", pkgver:"1.8.16-0ubuntu1.4")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"sudo", pkgver:"1.8.16-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"sudo-ldap", pkgver:"1.8.16-0ubuntu3.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"sudo", pkgver:"1.8.19p1-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"sudo-ldap", pkgver:"1.8.19p1-1ubuntu1.1")) flag++;
