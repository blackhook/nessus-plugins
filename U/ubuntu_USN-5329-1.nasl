...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS : tar vulnerability (USN-5329-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'tar', 'pkgver': '1.28-2.1ubuntu0.2+esm1'},
    {'osver': '16.04', 'pkgname': 'tar-scripts', 'pkgver': '1.28-2.1ubuntu0.2+esm1'},
    {'osver': '18.04', 'pkgname': 'tar', 'pkgver': '1.29b-2ubuntu0.3'},
    {'osver': '18.04', 'pkgname': 'tar-scripts', 'pkgver': '1.29b-2ubuntu0.3'}
];
