...
# extracted from Ubuntu Security Notice USN-1687-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 11.10 / 12.04 LTS / 12.10 : nspr update (USN-1687-2)");
  ...
  script_set_attribute(
    ...
    value:
"USN-1687-1 fixed a vulnerability NSS. This update provides the NSPR
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1687-2/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libnspr4-0d package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libnspr4-0d", pkgver:"4.9.4-0ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libnspr4-0d", pkgver:"4.9.4-0ubuntu0.11.10.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libnspr4-0d", pkgver:"4.9.4-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libnspr4-0d", pkgver:"4.9.4-0ubuntu0.12.10.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libnspr4-0d");
}
