...
# extracted from Ubuntu Security Notice USN-158-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : gzip vulnerability (USN-158-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"gzip", pkgver:"1.3.5-9ubuntu3.3")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"gzip", pkgver:"1.3.5-9ubuntu3.4")) flag++;
