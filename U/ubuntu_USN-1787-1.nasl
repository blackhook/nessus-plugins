...
# extracted from Ubuntu Security Notice USN-1787-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 : linux vulnerabilities (USN-1787-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1787-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2013-0914", "CVE-2013-1767", "CVE-2013-1792");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1787-1");
  }
  else
  {
...
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-32-generic", pkgver:"3.0.0-32.51")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-32-generic-pae", pkgver:"3.0.0-32.51")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-32-server", pkgver:"3.0.0-32.51")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"linux-image-3.0.0-32-virtual", pkgver:"3.0.0-32.51")) flag++;
