...
# extracted from Ubuntu Security Notice USN-675-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS : gaim vulnerability (USN-675-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/675-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"6.06", pkgname:"gaim", pkgver:"1:1.5.0+1.5.1cvs20051015-1ubuntu10.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"gaim-data", pkgver:"1.5.0+1.5.1cvs20051015-1ubuntu10.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"gaim-dev", pkgver:"1.5.0+1.5.1cvs20051015-1ubuntu10.1")) flag++;
