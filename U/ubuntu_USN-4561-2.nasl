...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 20.04 LTS / 20.10 : Rack vulnerabilities (USN-4561-2)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 LTS / 20.04 LTS / 20.10 host has a package installed that is affected by multiple
vulnerabilities as referenced in the USN-4561-2 advisory.
...
if (! preg(pattern:"^(16\.04|20\.04|20\.10)$", string:release)) audit(AUDIT_OS_NOT, 'Ubuntu 16.04 / 20.04 / 20.10', 'Ubuntu ' + release);
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'ruby-rack', 'pkgver': '2.1.1-5ubuntu0.1'}
];
