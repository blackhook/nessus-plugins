...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 20.10 : Pygments vulnerability (USN-4897-1)");
...
vulnerability as referenced in the USN-4897-1 advisory.
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'python3-pygments', 'pkgver': '2.3.1+dfsg-4ubuntu0.2'}
];
