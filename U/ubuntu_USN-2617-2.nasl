...
# extracted from Ubuntu Security Notice USN-2617-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 15.04 : ntfs-3g vulnerability (USN-2617-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2617-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"15.04", pkgname:"ntfs-3g", pkgver:"1:2014.2.15AR.3-1ubuntu0.1")) flag++;
