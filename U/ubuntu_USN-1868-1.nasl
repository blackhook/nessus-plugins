...
# extracted from Ubuntu Security Notice USN-1868-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1868-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : libxvmc vulnerabilities (USN-1868-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1868-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libxvmc1 package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libxvmc1", pkgver:"2:1.0.6-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libxvmc1", pkgver:"2:1.0.7-1ubuntu1.12.10.1")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"libxvmc1", pkgver:"2:1.0.7-1ubuntu1.13.04.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libxvmc1");
}
