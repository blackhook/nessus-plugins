...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3633-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Update the affected linux-image-4.4-euclid and / or linux-image-euclid
packages."
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2017-16995");
...
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-9026-euclid", pkgver:"4.4.0-9026.28")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-euclid", pkgver:"4.4.0.9026.27")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "linux-image-4.4-euclid / linux-image-euclid");
}
