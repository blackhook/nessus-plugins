...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : libsndfile vulnerability (USN-5409-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'libsndfile1', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm2'},
    {'osver': '16.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm2'},
    {'osver': '16.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.0.25-10ubuntu0.16.04.3+esm2'}
];
