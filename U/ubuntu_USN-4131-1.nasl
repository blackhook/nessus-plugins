...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.04 : VLC vulnerabilities (USN-4131-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that VLC incorrectly handled certain media files. If
a user were tricked into opening a specially crafted file, a remote
attacker could use this issue to cause VLC to crash, resulting in a
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4131-1/"
  );
...
if (ubuntu_check(osver:"18.04", pkgname:"vlc", pkgver:"3.0.8-0ubuntu18.04.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"vlc", pkgver:"3.0.8-0ubuntu19.04.1")) flag++;
