...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 : firefox regression (USN-2702-3)");
  ...
  script_set_attribute(
    ...
    value:
"USN-2702-1 fixed vulnerabilities in Firefox. After upgrading, some
users in the US reported that their default search engine switched to
Yahoo. This update fixes the problem.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2702-3/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"firefox", pkgver:"40.0+build4-0ubuntu0.12.04.4")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"firefox", pkgver:"40.0+build4-0ubuntu0.14.04.4")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"firefox", pkgver:"40.0+build4-0ubuntu0.15.04.4")) flag++;
