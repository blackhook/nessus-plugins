...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 / 17.04 : ghostscript regression (USN-3272-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3272-2/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"ghostscript", pkgver:"9.10~dfsg-0ubuntu10.9")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"ghostscript-x", pkgver:"9.10~dfsg-0ubuntu10.9")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libgs9", pkgver:"9.10~dfsg-0ubuntu10.9")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libgs9-common", pkgver:"9.10~dfsg-0ubuntu10.9")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"ghostscript", pkgver:"9.18~dfsg~0-0ubuntu2.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"ghostscript-x", pkgver:"9.18~dfsg~0-0ubuntu2.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libgs9", pkgver:"9.18~dfsg~0-0ubuntu2.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libgs9-common", pkgver:"9.18~dfsg~0-0ubuntu2.6")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"ghostscript", pkgver:"9.19~dfsg+1-0ubuntu6.6")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"ghostscript-x", pkgver:"9.19~dfsg+1-0ubuntu6.6")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"libgs9", pkgver:"9.19~dfsg+1-0ubuntu6.6")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"libgs9-common", pkgver:"9.19~dfsg+1-0ubuntu6.6")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"ghostscript", pkgver:"9.19~dfsg+1-0ubuntu7.4")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"ghostscript-x", pkgver:"9.19~dfsg+1-0ubuntu7.4")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libgs9", pkgver:"9.19~dfsg+1-0ubuntu7.4")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libgs9-common", pkgver:"9.19~dfsg+1-0ubuntu7.4")) flag++;
