...
if (description)
{
  ...
  script_name(english:"Ubuntu 21.10 / 22.04 LTS : logrotate vulnerability (USN-5447-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 21.10 / 22.04 LTS host has a package installed that is affected by a vulnerability as referenced in
the USN-5447-1 advisory.
...
if (! ('21.10' >< os_release || '22.04' >< os_release)) audit(AUDIT_OS_NOT, 'Ubuntu 21.10 / 22.04', 'Ubuntu ' + os_release);
...
var pkgs = [
    {'osver': '21.10', 'pkgname': 'logrotate', 'pkgver': '3.18.0-2ubuntu1.1'},
