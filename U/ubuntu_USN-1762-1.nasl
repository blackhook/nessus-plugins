...
# extracted from Ubuntu Security Notice USN-1762-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(58700);
  script_xref(name:"USN", value:"1762-1");

  script_name(english:"Ubuntu 11.10 / 12.04 LTS / 12.10 : apt vulnerability (USN-1762-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1762-1/"
  );
...
if (ubuntu_check(osver:"11.10", pkgname:"apt", pkgver:"0.8.16~exp5ubuntu13.7")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"apt", pkgver:"0.8.16~exp12ubuntu10.10")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"apt", pkgver:"0.9.7.5ubuntu5.4")) flag++;
