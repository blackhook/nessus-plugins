...
# extracted from Ubuntu Security Notice USN-572-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 7.04 / 7.10 : apt-listchanges vulnerability (USN-572-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/572-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected apt-listchanges package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_cwe_id(94);

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:apt-listchanges");
...
if (ubuntu_check(osver:"7.04", pkgname:"apt-listchanges", pkgver:"2.72ubuntu6.1")) flag++;
if (ubuntu_check(osver:"7.10", pkgname:"apt-listchanges", pkgver:"2.74ubuntu3.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "apt-listchanges");
}
