...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : git vulnerability (USN-3438-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Git incorrectly handled certain subcommands
such as cvsserver. A remote attacker could possibly use this issue via
shell metacharacters in modules names to execute arbitrary code.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3438-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"git", pkgver:"1:1.9.1-1ubuntu0.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"git", pkgver:"1:2.7.4-0ubuntu1.3")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"git", pkgver:"1:2.11.0-2ubuntu0.3")) flag++;
