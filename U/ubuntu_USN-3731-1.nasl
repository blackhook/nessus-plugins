...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that LFTP incorrectly handled certain files. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3731-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"lftp", pkgver:"4.4.13-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"lftp", pkgver:"4.6.3a-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"lftp", pkgver:"4.8.1-1ubuntu0.1")) flag++;
