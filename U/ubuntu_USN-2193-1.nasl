...
# extracted from Ubuntu Security Notice USN-2193-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(66774);
  script_xref(name:"USN", value:"2193-1");

  script_name(english:"Ubuntu 13.10 : glance vulnerability (USN-2193-1)");
  ...
  script_set_attribute(
    ...
    value:
"Paul McMillan discovered that the Sheepdog backend in OpenStack Glance
did not properly handle untrusted input. A remote authenticated
attacker exploit this to execute arbitrary commands as the glance
user.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2193-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"13.10", pkgname:"python-glance", pkgver:"1:2013.2.3-0ubuntu1.1")) flag++;
