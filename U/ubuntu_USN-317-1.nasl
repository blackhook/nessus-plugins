...
# extracted from Ubuntu Security Notice USN-317-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(18856);
  script_xref(name:"USN", value:"317-1");

  script_name(english:"Ubuntu 5.10 : zope2.8 vulnerability (USN-317-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected zope2.8 and / or zope2.8-sandbox packages."
  );
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:zope2.8");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:zope2.8-sandbox");
...
if (ubuntu_check(osver:"5.10", pkgname:"zope2.8", pkgver:"2.8.1-5ubuntu0.2")) flag++;
if (ubuntu_check(osver:"5.10", pkgname:"zope2.8-sandbox", pkgver:"2.8.1-5ubuntu0.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "zope2.8 / zope2.8-sandbox");
}
