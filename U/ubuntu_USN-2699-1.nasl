...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 : hplip vulnerability (USN-2699-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2699-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected hplip-data package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"hplip-data", pkgver:"3.12.2-1ubuntu3.5")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"hplip-data", pkgver:"3.14.3-0ubuntu3.4")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"hplip-data", pkgver:"3.15.2-0ubuntu4.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "hplip-data");
}
