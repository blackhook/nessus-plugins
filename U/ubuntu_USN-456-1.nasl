...
# extracted from Ubuntu Security Notice USN-456-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS : net-snmp vulnerability (USN-456-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/456-1/"
  );
...
if (ubuntu_check(osver:"6.06", pkgname:"libsnmp-base", pkgver:"5.2.1.2-4ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libsnmp-perl", pkgver:"5.2.1.2-4ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libsnmp9", pkgver:"5.2.1.2-4ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"libsnmp9-dev", pkgver:"5.2.1.2-4ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"snmp", pkgver:"5.2.1.2-4ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"snmpd", pkgver:"5.2.1.2-4ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"tkmib", pkgver:"5.2.1.2-4ubuntu2.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libsnmp-base / libsnmp-perl / libsnmp9 / libsnmp9-dev / snmp / etc");
}
