...
# extracted from Ubuntu Security Notice USN-17-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : passwd vulnerabilities (USN-17-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"login", pkgver:"4.0.3-28.5ubuntu6.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"passwd", pkgver:"4.0.3-28.5ubuntu6.1")) flag++;
