...
# extracted from Ubuntu Security Notice USN-1197-5. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : ca-certificates vulnerability (USN-1197-5)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1197-5/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"ca-certificates", pkgver:"20090814ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"ca-certificates", pkgver:"20090814ubuntu0.10.10.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"ca-certificates", pkgver:"20090814+nmu2ubuntu0.1")) flag++;
