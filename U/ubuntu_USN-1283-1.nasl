...
# extracted from Ubuntu Security Notice USN-1283-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 10.04 LTS / 10.10 / 11.04 : apt vulnerability (USN-1283-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1283-1/"
  );
...
if (ubuntu_check(osver:"8.04", pkgname:"apt", pkgver:"0.7.9ubuntu17.4")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"apt", pkgver:"0.7.25.3ubuntu9.9")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"apt", pkgver:"0.8.3ubuntu7.3")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"apt", pkgver:"0.8.13.2ubuntu4.3")) flag++;
