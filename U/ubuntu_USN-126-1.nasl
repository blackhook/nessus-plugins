...
# extracted from Ubuntu Security Notice USN-126-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : gnutls11, gnutls10 vulnerability (USN-126-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"gnutls-bin", pkgver:"1.0.4-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgnutls-doc", pkgver:"1.0.4-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgnutls10", pkgver:"1.0.4-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgnutls10-dev", pkgver:"1.0.4-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"gnutls-bin", pkgver:"1.0.16-13ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libgnutls11", pkgver:"1.0.16-13ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libgnutls11-dbg", pkgver:"1.0.16-13ubuntu0.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libgnutls11-dev", pkgver:"1.0.16-13ubuntu0.1")) flag++;
