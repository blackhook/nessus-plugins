...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : DBus vulnerability (USN-4398-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4398-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"dbus", pkgver:"1.10.6-1ubuntu3.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libdbus-1-3", pkgver:"1.10.6-1ubuntu3.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"dbus", pkgver:"1.12.2-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libdbus-1-3", pkgver:"1.12.2-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"dbus", pkgver:"1.12.14-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"libdbus-1-3", pkgver:"1.12.14-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"dbus", pkgver:"1.12.16-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libdbus-1-3", pkgver:"1.12.16-2ubuntu2.1")) flag++;
