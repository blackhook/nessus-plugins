...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 14.10 / 15.04 : strongswan vulnerability (USN-2628-1)");
...
certain IKEv2 setups. A malicious server could possibly use this issue
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2628-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected strongswan-ike package."
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"strongswan-ike", pkgver:"5.1.2-0ubuntu2.3")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"strongswan-ike", pkgver:"5.1.2-0ubuntu3.3")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"strongswan-ike", pkgver:"5.1.2-0ubuntu5.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "strongswan-ike");
}
