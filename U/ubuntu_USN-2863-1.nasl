...
# extracted from Ubuntu Security Notice USN-2863-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : openssl vulnerability (USN-2863-1) (SLOTH)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2863-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libssl1.0.0", pkgver:"1.0.1-4ubuntu5.33")) flag++;
