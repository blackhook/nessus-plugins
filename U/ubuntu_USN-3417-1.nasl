...
# extracted from Ubuntu Security Notice USN-3417-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 17.04 : libgcrypt20 vulnerability (USN-3417-1)");
...
was susceptible to an attack via side channels. A local attacker could
use this attack to recover Curve25519 private keys.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3417-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"17.04", pkgname:"libgcrypt20", pkgver:"1.7.6-1ubuntu0.2")) flag++;
