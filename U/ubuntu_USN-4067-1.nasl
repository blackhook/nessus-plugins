...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4067-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"evince", pkgver:"3.18.2-1ubuntu4.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"evince-common", pkgver:"3.18.2-1ubuntu4.6")) flag++;
