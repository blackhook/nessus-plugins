...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : apache2 vulnerability (USN-3370-1)");
...
mod_auth_digest module incorrectly cleared values when processing
certain requests. A remote attacker could use this issue to cause the
server to crash, resulting in a denial or service, or possibly obtain
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3370-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"apache2-bin", pkgver:"2.4.7-1ubuntu4.17")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"apache2-bin", pkgver:"2.4.18-2ubuntu3.4")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"apache2-bin", pkgver:"2.4.25-3ubuntu2.2")) flag++;
