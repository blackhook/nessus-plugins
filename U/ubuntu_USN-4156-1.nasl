...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4156-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected libsdl1.2debian package."
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"libsdl1.2debian", pkgver:"1.2.15+dfsg1-3ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libsdl1.2debian", pkgver:"1.2.15+dfsg2-0.1ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libsdl1.2debian");
}
