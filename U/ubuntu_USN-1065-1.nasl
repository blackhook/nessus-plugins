...
# extracted from Ubuntu Security Notice USN-1065-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 9.10 / 10.04 LTS / 10.10 : shadow vulnerability (USN-1065-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1065-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"9.10", pkgname:"login", pkgver:"4.1.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"9.10", pkgname:"passwd", pkgver:"1:4.1.4.1-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"login", pkgver:"4.1.4.2-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"passwd", pkgver:"1:4.1.4.2-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"login", pkgver:"4.1.4.2-1ubuntu3.2")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"passwd", pkgver:"1:4.1.4.2-1ubuntu3.2")) flag++;
