...
# extracted from Ubuntu Security Notice USN-1539-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(53614, 53721, 54279, 54283);
  script_xref(name:"USN", value:"1539-1");

  script_name(english:"Ubuntu 10.04 LTS : linux-lts-backport-oneiric vulnerabilities (USN-1539-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1539-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2012-2136", "CVE-2012-2373", "CVE-2012-2390", "CVE-2012-3375", "CVE-2012-3400", "CVE-2012-3511");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-1539-1");
  }
  else
  {
...
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-24-generic", pkgver:"3.0.0-24.40~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-24-generic-pae", pkgver:"3.0.0-24.40~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-24-server", pkgver:"3.0.0-24.40~lucid1")) flag++;
if (ubuntu_check(osver:"10.04", pkgname:"linux-image-3.0.0-24-virtual", pkgver:"3.0.0-24.40~lucid1")) flag++;
