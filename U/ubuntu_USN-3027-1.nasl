...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : tomcat8 vulnerability (USN-3027-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3027-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected tomcat8 package."
  );
...
if (ubuntu_check(osver:"16.04", pkgname:"tomcat8", pkgver:"8.0.32-1ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "tomcat8");
}
