...
# extracted from Ubuntu Security Notice USN-1525-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1525-1");

  script_name(english:"Ubuntu 12.04 LTS : calligra vulnerability (USN-1525-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1525-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected calligra package."
  );
  script_set_cvss_base_vector("CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:calligra");
...
if (ubuntu_check(osver:"12.04", pkgname:"calligra", pkgver:"1:2.4.0-0ubuntu2.1")) flag++;
