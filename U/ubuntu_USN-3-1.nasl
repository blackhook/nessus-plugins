...
# extracted from Ubuntu Security Notice USN-3-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : GhostScript utility script vulnerabilities (USN-3-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected gs-common package."
  );
...
if (ubuntu_check(osver:"4.10", pkgname:"gs-common", pkgver:"0.3.6ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "gs-common");
}
