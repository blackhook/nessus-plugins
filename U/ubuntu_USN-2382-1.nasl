...
credentials after being redirected. An attacker could possibly use
this issue to obtain authentication credentials intended for another
site. (CVE-2014-1829, CVE-2014-1830).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2382-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"python-requests", pkgver:"2.2.1-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"python3-requests", pkgver:"2.2.1-1ubuntu0.1")) flag++;
