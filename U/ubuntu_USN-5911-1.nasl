...
if (description)
{
  ...
  script_name(english:"Ubuntu 22.04 LTS / 22.10 : Linux kernel vulnerabilities (USN-5911-1)");
...
referenced in the USN-5911-1 advisory.
...
"Update the affected kernel package.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2022-47521");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1018--gcp");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1018--ibm");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1020-aws");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-5.19.0-1021-azure");
...
{
  if (! preg(pattern:"^(5.19.0-\d+-(aws|azure|gcp|generic|generic-64k|generic-lpae|ibm))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.19.0-\d+(-gcp|-ibm)" : "5.19.0-1018",
    "5.19.0-\d+(-generic|-generic-64k|-generic-lpae)" : "5.19.0-35",
    "5.19.0-\d+-aws" : "5.19.0-1020",
    "5.19.0-\d+-azure" : "5.19.0-1021"
  };
