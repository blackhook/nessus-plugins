...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS : lua5.1 vulnerability (USN-2338-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2338-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected liblua5.1-0 and / or lua5.1 packages."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"liblua5.1-0", pkgver:"5.1.4-12ubuntu1.1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"lua5.1", pkgver:"5.1.4-12ubuntu1.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"liblua5.1-0", pkgver:"5.1.5-5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"lua5.1", pkgver:"5.1.5-5ubuntu0.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "liblua5.1-0 / lua5.1");
}
