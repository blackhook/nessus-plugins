...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 / 18.04 LTS : Libgcrypt vulnerability (USN-3689-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"Keegan Ryan discovered that Libgcrypt was susceptible to a
side-channel attack. A local attacker could possibly use this attack
to recover ECDSA private keys.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3689-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libgcrypt11", pkgver:"1.5.3-2ubuntu4.6")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libgcrypt20", pkgver:"1.6.5-2ubuntu0.5")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libgcrypt20", pkgver:"1.7.8-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libgcrypt20", pkgver:"1.8.1-4ubuntu1.1")) flag++;
