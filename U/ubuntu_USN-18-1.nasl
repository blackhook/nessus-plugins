...
# extracted from Ubuntu Security Notice USN-18-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : zip vulnerability (USN-18-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:zip");
...
if (ubuntu_check(osver:"4.10", pkgname:"zip", pkgver:"2.30-6ubuntu0.1")) flag++;
