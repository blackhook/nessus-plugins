...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 12.10 / 13.10 / 14.04 LTS : dpkg vulnerability (USN-2183-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2183-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"dpkg-dev", pkgver:"1.15.5.6ubuntu4.7")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libdpkg-perl", pkgver:"1.16.1.2ubuntu7.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libdpkg-perl", pkgver:"1.16.7ubuntu6.1")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libdpkg-perl", pkgver:"1.16.12ubuntu1.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libdpkg-perl", pkgver:"1.17.5ubuntu5.1")) flag++;
