...
{
  if (! preg(pattern:"^(5.4.0-\d+-(aws|azure|gcp|generic|generic-lpae|gke|gkeop|ibm|kvm|lowlatency|oracle|raspi))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "5.4.0-\d+(-generic|-generic-lpae|-lowlatency)" : "5.4.0-146",
    "5.4.0-\d+-aws" : "5.4.0-1099",
    "5.4.0-\d+-azure" : "5.4.0-1105",
    "5.4.0-\d+-gcp" : "5.4.0-1102",
    "5.4.0-\d+-gke" : "5.4.0-1096",
    "5.4.0-\d+-gkeop" : "5.4.0-1066",
    "5.4.0-\d+-ibm" : "5.4.0-1046",
    "5.4.0-\d+-kvm" : "5.4.0-1088",
    "5.4.0-\d+-oracle" : "5.4.0-1098",
    "5.4.0-\d+-raspi" : "5.4.0-1082"
  };
