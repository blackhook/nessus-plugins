...
# extracted from Ubuntu Security Notice USN-389-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : gnupg vulnerability (USN-389-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/389-1/"
  );
...
if (ubuntu_check(osver:"5.10", pkgname:"gnupg", pkgver:"1.4.1-1ubuntu1.5")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"gnupg", pkgver:"1.4.2.2-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"gnupg", pkgver:"1.4.3-2ubuntu3.1")) flag++;
