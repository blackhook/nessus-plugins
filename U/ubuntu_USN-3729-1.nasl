...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3729-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libxcursor1", pkgver:"1:1.1.14-1ubuntu0.14.04.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libxcursor1", pkgver:"1:1.1.14-1ubuntu0.16.04.2")) flag++;
