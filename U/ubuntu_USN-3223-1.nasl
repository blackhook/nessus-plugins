...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS : kde4libs vulnerability (USN-3223-1)");
  ...
  script_set_attribute(
    ...
    value:
"Itzik Kotler, Yonatan Fridburg, and Amit Klein discovered that
KDE-Libs incorrectly handled certain PAC files. A remote attacker
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3223-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"12.04", pkgname:"kdelibs5-plugins", pkgver:"4:4.8.5-0ubuntu0.6")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"kdelibs5-plugins", pkgver:"4:4.13.3-0ubuntu0.4")) flag++;
