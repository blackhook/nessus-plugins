...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 : libvirt vulnerability (USN-4452-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"Trent Shea working with Trend Micro's Zero Day Initiative, discovered
that the libvirt package set incorrect permissions on the UNIX domain
socket. A local attacker could use this issue to access libvirt and
escalate privileges.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4452-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
"Update the affected libvirt-daemon, libvirt-daemon-system and / or
libvirt0 packages."
  );
...
if (ubuntu_check(osver:"20.04", pkgname:"libvirt-daemon", pkgver:"6.0.0-0ubuntu8.3")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libvirt-daemon-system", pkgver:"6.0.0-0ubuntu8.3")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libvirt0", pkgver:"6.0.0-0ubuntu8.3")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libvirt-daemon / libvirt-daemon-system / libvirt0");
}
