...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 19.10 : OpenSMTPD vulnerabilities (USN-4294-1)");
...
unauthenticated attacker could use this vulnerability to execute
arbitrary shell commands as any non-root user. (CVE-2020-8794)

It was discovered that OpenSMTPD did not properly handle hardlinks
under certain conditions. An unprivileged local attacker could read
the first line of any file on the filesystem. (CVE-2020-8793).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4294-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"opensmtpd", pkgver:"6.0.3p1-1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"opensmtpd", pkgver:"6.0.3p1-6ubuntu0.2")) flag++;
