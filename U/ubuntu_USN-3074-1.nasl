...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3074-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"file-roller", pkgver:"3.10.2.1-0ubuntu4.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"file-roller", pkgver:"3.16.5-0ubuntu1.2")) flag++;
