...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 / 15.04 : fuse vulnerability (USN-2617-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2617-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"fuse", pkgver:"2.8.6-2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"fuse", pkgver:"2.9.2-4ubuntu4.14.04.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"fuse", pkgver:"2.9.2-4ubuntu4.14.10.1")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"fuse", pkgver:"2.9.2-4ubuntu4.15.04.1")) flag++;
