...
# extracted from Ubuntu Security Notice USN-1694-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(57138);
  script_xref(name:"USN", value:"1694-1");

  script_name(english:"Ubuntu 12.10 : rpm vulnerability (USN-1694-1)");
...
attacker could create a specially crafted rpm with an invalid
signature which could pass the signature validation check.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1694-1/"
  );
...
if (ubuntu_check(osver:"12.10", pkgname:"rpm", pkgver:"4.10.0-4ubuntu0.1")) flag++;
