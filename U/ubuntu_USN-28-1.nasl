...
# extracted from Ubuntu Security Notice USN-28-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : sudo vulnerability (USN-28-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"sudo", pkgver:"1.6.7p5-1ubuntu4.1")) flag++;
