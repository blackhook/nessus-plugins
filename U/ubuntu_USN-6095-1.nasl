...
if (machine_kernel_release)
{
  ...
  if (preg(pattern:"^16.04$", string:os_release)) {
    kernel_pattern = "^4.15.0-\d+-(gcp|generic|lowlatency)$";
    kernel_mappings = {
            "4.15.0-\d+(-generic|-lowlatency)" : "4.15.0-211",
            "4.15.0-\d+-gcp" : "4.15.0-1150"
    };
  };
  if (preg(pattern:"^18.04$", string:os_release)) {
    kernel_pattern = "^4.15.0-\d+-(raspi2|snapdragon)$";
    kernel_mappings = {
            "4.15.0-\d+-raspi2" : "4.15.0-1132",
            "4.15.0-\d+-snapdragon" : "4.15.0-1150"
    };
  };
