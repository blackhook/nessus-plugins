...
# extracted from Ubuntu Security Notice USN-866-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"866-1");

  script_name(english:"Ubuntu 9.10 : gnome-screensaver vulnerability (USN-866-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that gnome-screensaver did not always re-enable
itself after applications requested it to ignore idle timers. This may
result in the screen not being automatically locked after the
inactivity timeout is reached, permitting an attacker with physical
access to gain access to an unlocked session.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/866-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"9.10", pkgname:"gnome-screensaver", pkgver:"2.28.0-0ubuntu3.1")) flag++;
