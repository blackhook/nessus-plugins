...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 : perl vulnerabilities (USN-2916-1)");
...
expressions with an invalid backreference. An attacker could use this
issue to cause Perl to crash, resulting in a denial of service, or
possibly execute arbitrary code. (CVE-2013-7422)
...
consume memory and crash, resulting in a denial of service.
(CVE-2014-4330)

Stephane Chazelas discovered that Perl incorrectly handled duplicate
environment variables. An attacker could possibly use this issue to
bypass the taint protection mechanism. (CVE-2016-2381).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2916-1/"
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"perl", pkgver:"5.14.2-6ubuntu2.5")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"perl", pkgver:"5.18.2-2ubuntu1.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"perl", pkgver:"5.20.2-6ubuntu0.2")) flag++;
