...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : python-django vulnerability (USN-3039-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that Django incorrectly handled the admin's
add/change related popup. A remote attacker could possibly use this
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3039-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"python-django", pkgver:"1.8.7-1ubuntu5.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-django", pkgver:"1.8.7-1ubuntu5.1")) flag++;
