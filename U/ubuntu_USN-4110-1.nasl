...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 : Dovecot vulnerability (USN-4110-1)");
...
handled certain data. An attacker could possibly use this issue to
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4110-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"dovecot-core", pkgver:"1:2.2.22-1ubuntu2.11")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"dovecot-core", pkgver:"1:2.2.33.2-1ubuntu4.4")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"dovecot-core", pkgver:"1:2.3.4.1-1ubuntu2.3")) flag++;
