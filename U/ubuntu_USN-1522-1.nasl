...
# extracted from Ubuntu Security Notice USN-1522-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1522-1");

  script_name(english:"Ubuntu 10.04 LTS / 11.04 / 11.10 / 12.04 LTS : qemu-kvm vulnerability (USN-1522-1)");
...
overwrite files with root privilege, or obtain sensitive information
from the guest.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1522-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"qemu-kvm", pkgver:"0.12.3+noroms-0ubuntu9.19")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"qemu-kvm", pkgver:"0.14.0+noroms-0ubuntu4.6")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"qemu-kvm", pkgver:"0.14.1+noroms-0ubuntu6.4")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"qemu-kvm", pkgver:"1.0+noroms-0ubuntu14.1")) flag++;
