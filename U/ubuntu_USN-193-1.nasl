...
# extracted from Ubuntu Security Notice USN-193-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 : dia vulnerability (USN-193-1)");
...
if (ubuntu_check(osver:"5.04", pkgname:"dia", pkgver:"0.94.0-5ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"dia-common", pkgver:"0.94.0-5ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"dia-gnome", pkgver:"0.94.0-5ubuntu1.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"dia-libs", pkgver:"0.94.0-5ubuntu1.1")) flag++;
