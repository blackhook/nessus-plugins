...
# extracted from Ubuntu Security Notice USN-2356-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(69396, 69428, 69489);
  script_xref(name:"USN", value:"2356-1");

  script_name(english:"Ubuntu 12.04 LTS : linux vulnerabilities (USN-2356-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2356-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2014-3601", "CVE-2014-5471", "CVE-2014-5472");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2356-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-69-generic", pkgver:"3.2.0-69.103")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-69-generic-pae", pkgver:"3.2.0-69.103")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-69-highbank", pkgver:"3.2.0-69.103")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-69-virtual", pkgver:"3.2.0-69.103")) flag++;
