...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 22.04 LTS / 22.10 : OpenStack Swift vulnerability (USN-5852-1)");
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'python3-swift', 'pkgver': '2.30.1-0ubuntu1'},
    {'osver': '22.10', 'pkgname': 'swift', 'pkgver': '2.30.1-0ubuntu1'},
    {'osver': '22.10', 'pkgname': 'swift-account', 'pkgver': '2.30.1-0ubuntu1'},
    {'osver': '22.10', 'pkgname': 'swift-container', 'pkgver': '2.30.1-0ubuntu1'},
    {'osver': '22.10', 'pkgname': 'swift-object', 'pkgver': '2.30.1-0ubuntu1'},
    {'osver': '22.10', 'pkgname': 'swift-object-expirer', 'pkgver': '2.30.1-0ubuntu1'},
    {'osver': '22.10', 'pkgname': 'swift-proxy', 'pkgver': '2.30.1-0ubuntu1'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'python3-swift / swift / swift-account / swift-container / swift-object / etc');
}
