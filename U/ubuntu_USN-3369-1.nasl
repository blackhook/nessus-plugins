...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : freeradius vulnerabilities (USN-3369-1)");
  ...
  script_set_attribute(
    ...
    value:
"Guido Vranken discovered that FreeRADIUS incorrectly handled memory
when decoding packets. A remote attacker could use this issue to cause
FreeRADIUS to crash or hang, resulting in a denial of service, or
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3369-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"freeradius", pkgver:"2.1.12+dfsg-1.2ubuntu8.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"freeradius", pkgver:"2.2.8+dfsg-0.1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"freeradius", pkgver:"3.0.12+dfsg-4ubuntu1.2")) flag++;
