...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : MySQL vulnerabilities (USN-4441-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4441-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"16.04", pkgname:"mysql-server-5.7", pkgver:"5.7.31-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"mysql-server-5.7", pkgver:"5.7.31-0ubuntu0.18.04.1")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"mysql-server-8.0", pkgver:"8.0.21-0ubuntu0.20.04.3")) flag++;
