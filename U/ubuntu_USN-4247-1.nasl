...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.04 / 19.10 : python-apt vulnerabilities (USN-4247-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4247-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"python-apt", pkgver:"1.1.0~beta1ubuntu0.16.04.7")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"python3-apt", pkgver:"1.1.0~beta1ubuntu0.16.04.7")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python-apt", pkgver:"1.6.5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"python3-apt", pkgver:"1.6.5ubuntu0.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"python-apt", pkgver:"1.8.5~ubuntu0.2")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"python3-apt", pkgver:"1.8.5~ubuntu0.2")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"python-apt", pkgver:"1.9.0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"python3-apt", pkgver:"1.9.0ubuntu1.2")) flag++;
