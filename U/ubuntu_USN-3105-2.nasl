...
# extracted from Ubuntu Security Notice USN-3105-2. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"3105-2");
  script_xref(name:"IAVA", value:"2016-A-0306-S");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2022/03/24");

  script_name(english:"Ubuntu 12.04 LTS : linux-lts-trusty vulnerability (USN-3105-2) (Dirty COW)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3105-2/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-3105-2");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-100-generic", pkgver:"3.13.0-100.147~precise1")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.13.0-100-generic-lpae", pkgver:"3.13.0-100.147~precise1")) flag++;
