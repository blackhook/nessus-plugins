...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : tar vulnerability (USN-5900-1)");
...
a vulnerability as referenced in the USN-5900-1 advisory.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'tar', 'pkgver': '1.28-2.1ubuntu0.2+esm2'},
    {'osver': '16.04', 'pkgname': 'tar-scripts', 'pkgver': '1.28-2.1ubuntu0.2+esm2'},
    {'osver': '18.04', 'pkgname': 'tar', 'pkgver': '1.29b-2ubuntu0.4'},
    {'osver': '18.04', 'pkgname': 'tar-scripts', 'pkgver': '1.29b-2ubuntu0.4'},
    {'osver': '20.04', 'pkgname': 'tar', 'pkgver': '1.30+dfsg-7ubuntu0.20.04.3'},
    {'osver': '20.04', 'pkgname': 'tar-scripts', 'pkgver': '1.30+dfsg-7ubuntu0.20.04.3'},
    {'osver': '22.04', 'pkgname': 'tar', 'pkgver': '1.34+dfsg-1ubuntu0.1.22.04.1'},
    {'osver': '22.04', 'pkgname': 'tar-scripts', 'pkgver': '1.34+dfsg-1ubuntu0.1.22.04.1'},
    {'osver': '22.10', 'pkgname': 'tar', 'pkgver': '1.34+dfsg-1ubuntu0.1.22.10.1'},
    {'osver': '22.10', 'pkgname': 'tar-scripts', 'pkgver': '1.34+dfsg-1ubuntu0.1.22.10.1'}
];
