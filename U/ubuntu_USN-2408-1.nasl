...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : neutron vulnerability (USN-2408-1)");
  ...
  script_set_attribute(
    ...
    value:
"Elena Ezhova discovered that OpenStack Neutron did not properly
perform access control checks for attributes. A remote authenticated
attacker could exploit this to bypass intended access controls and
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2408-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"14.04", pkgname:"python-neutron", pkgver:"1:2014.1.3-0ubuntu1.1")) flag++;
