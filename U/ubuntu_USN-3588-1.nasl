...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 : memcached vulnerabilities (USN-3588-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3588-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"memcached", pkgver:"1.4.14-0ubuntu9.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"memcached", pkgver:"1.4.25-2ubuntu1.3")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"memcached", pkgver:"1.4.33-1ubuntu3.2")) flag++;
