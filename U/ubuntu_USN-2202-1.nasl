...
# extracted from Ubuntu Security Notice USN-2202-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2202-1");
  script_xref(name:"CISA-KNOWN-EXPLOITED", value:"2023/06/02");

  script_name(english:"Ubuntu 12.10 : linux vulnerability (USN-2202-1)");
...
without introducing additional issues.");
  script_set_attribute(attribute:"see_also", value:"https://usn.ubuntu.com/2202-1/");
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2202-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.10", pkgname:"linux-image-3.5.0-49-generic", pkgver:"3.5.0-49.74")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"linux-image-3.5.0-49-highbank", pkgver:"3.5.0-49.74")) flag++;
