...
"Update the affected linux-image-5.10.0-1021-oem, linux-image-oem-20.04-edge and / or linux-image-oem-20.04b packages.");
...
if (get_one_kb_item('Host/ksplice/kernel-cves'))
{
  ...
  cve_list = make_list('CVE-2020-25639', 'CVE-2021-28038', 'CVE-2021-28375', 'CVE-2021-28950');
...
pkgs = [
    {'osver': '20.04', 'pkgname': 'linux-image-5.10.0-1021-oem', 'pkgver': '5.10.0-1021.22'},
    {'osver': '20.04', 'pkgname': 'linux-image-oem-20.04-edge', 'pkgver': '5.10.0.1021.22'},
    {'osver': '20.04', 'pkgname': 'linux-image-oem-20.04b', 'pkgver': '5.10.0.1021.22'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'linux-image-5.10.0-1021-oem / linux-image-oem-20.04-edge / etc');
}