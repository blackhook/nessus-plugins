...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 14.10 / 15.04 : wpa vulnerability (USN-2577-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2577-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"14.04", pkgname:"wpasupplicant", pkgver:"2.1-0ubuntu1.2")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"wpasupplicant", pkgver:"2.1-0ubuntu4.1")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"wpasupplicant", pkgver:"2.1-0ubuntu7.1")) flag++;
