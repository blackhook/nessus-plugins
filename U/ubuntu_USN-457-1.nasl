...
# extracted from Ubuntu Security Notice USN-457-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 / 7.04 : elinks vulnerability (USN-457-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/457-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"6.06", pkgname:"elinks", pkgver:"0.10.6-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"elinks-lite", pkgver:"0.10.6-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"elinks", pkgver:"0.11.1-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"elinks-lite", pkgver:"0.11.1-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"elinks", pkgver:"0.11.1-1.2ubuntu2.1")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"elinks-lite", pkgver:"0.11.1-1.2ubuntu2.1")) flag++;
