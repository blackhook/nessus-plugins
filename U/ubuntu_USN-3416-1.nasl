...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : thunderbird vulnerabilities (USN-3416-1)");
...
context, an attacker could potentially exploit these to bypass
same-origin restrictions, bypass CSP restrictions, obtain sensitive
information, spoof the origin of modal alerts, cause a denial of
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3416-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"thunderbird", pkgver:"1:52.3.0+build1-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"thunderbird", pkgver:"1:52.3.0+build1-0ubuntu0.16.04.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"thunderbird", pkgver:"1:52.3.0+build1-0ubuntu0.17.04.1")) flag++;
