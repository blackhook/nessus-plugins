...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 20.10 / 21.04 : Django vulnerability (USN-4932-1)");
...
as referenced in the USN-4932-1 advisory. Note that Nessus has not tested for this issue but has instead relied only on
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'python3-django', 'pkgver': '2:2.2.16-1ubuntu0.4'},
    {'osver': '21.04', 'pkgname': 'python3-django', 'pkgver': '2:2.2.20-1ubuntu0.1'}
];
