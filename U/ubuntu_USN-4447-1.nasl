...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 : libssh vulnerability (USN-4447-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that libssh incorrectly handled certain requests. An
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4447-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"libssh-4", pkgver:"0.6.3-4.3ubuntu0.6")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libssh-4", pkgver:"0.8.0~20170825.94fa1e38-1ubuntu0.7")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"libssh-4", pkgver:"0.9.3-2ubuntu2.1")) flag++;
