...
# extracted from Ubuntu Security Notice USN-2678-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : linux vulnerabilities (USN-2678-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2678-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2015-1805", "CVE-2015-4700");
  if (ksplice_cves_check(cve_list))
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-2678-1");
  }
  else
  {
...
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-88-generic", pkgver:"3.2.0-88.126")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-88-generic-pae", pkgver:"3.2.0-88.126")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-88-highbank", pkgver:"3.2.0-88.126")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"linux-image-3.2.0-88-virtual", pkgver:"3.2.0-88.126")) flag++;
