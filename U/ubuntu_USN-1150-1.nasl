...
# extracted from Ubuntu Security Notice USN-1150-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : thunderbird vulnerabilities (USN-1150-1)");
...
accessed. An attacker could potentially use this to crash Thunderbird
...
this to crash Thunderbird or execute arbitrary code with the
...
invoking Thunderbird. (CVE-2011-2371)

Multiple use-after-free vulnerabilities were discovered. An attacker
could potentially use these to execute arbitrary code with the
privileges of the user invoking Thunderbird. (CVE-2011-0083,
CVE-2011-0085, CVE-2011-2363)

David Chan discovered that cookies did not honor same-origin
conventions. This could potentially lead to cookie data being leaked
to a third-party. (CVE-2011-2362).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1150-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"thunderbird", pkgver:"3.1.11+build2+nobinonly-0ubuntu0.10.04.1")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"thunderbird", pkgver:"3.1.11+build2+nobinonly-0ubuntu0.10.10.1")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"thunderbird", pkgver:"3.1.11+build2+nobinonly-0ubuntu0.11.04.1")) flag++;
