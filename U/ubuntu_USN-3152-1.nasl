...
# extracted from Ubuntu Security Notice USN-3152-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.10 : linux vulnerability (USN-3152-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3152-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  {
    audit(AUDIT_PATCH_INSTALLED, "KSplice hotfix for USN-3152-1");
  }
  else
  {
...
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-4.8.0-30-generic", pkgver:"4.8.0-30.32")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-4.8.0-30-generic-lpae", pkgver:"4.8.0-30.32")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-4.8.0-30-lowlatency", pkgver:"4.8.0-30.32")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-generic", pkgver:"4.8.0.30.39")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-generic-lpae", pkgver:"4.8.0.30.39")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"linux-image-lowlatency", pkgver:"4.8.0.30.39")) flag++;
