...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : linux vulnerabilities (USN-3070-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3070-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-36-generic", pkgver:"4.4.0-36.55")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-36-generic-lpae", pkgver:"4.4.0-36.55")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.4.0-36-lowlatency", pkgver:"4.4.0-36.55")) flag++;
