...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 : PHP vulnerabilities (USN-4330-1)");
...
information. This issue only affected Ubuntu 14.04 ESM, Ubuntu 16.04
LTS, Ubuntu 18.04 LTS and Ubuntu 19.10. (CVE-2020-7066).
