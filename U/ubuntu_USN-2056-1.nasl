...
# extracted from Ubuntu Security Notice USN-2056-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : djvulibre vulnerability (USN-2056-1)");
...
a specially crafted DjVu file, applications could be made to crash,
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2056-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libdjvulibre21", pkgver:"3.5.24-9ubuntu0.1")) flag++;
