...
# extracted from Ubuntu Security Notice USN-2082-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.10 / 13.04 / 13.10 : cups vulnerability (USN-2082-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2082-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected cups-client package."
  );
...
if (ubuntu_check(osver:"12.10", pkgname:"cups-client", pkgver:"1.6.1-0ubuntu11.5")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"cups-client", pkgver:"1.6.2-1ubuntu8")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"cups-client", pkgver:"1.7.0~rc1-0ubuntu5.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "cups-client");
}
