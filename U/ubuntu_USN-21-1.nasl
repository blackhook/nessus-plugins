...
# extracted from Ubuntu Security Notice USN-21-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : libgd vulnerabilities (USN-21-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"libgd-dev", pkgver:"1.8.4-36ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd-noxpm-dev", pkgver:"1.8.4-36ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd-xpm-dev", pkgver:"1.8.4-36ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd1", pkgver:"1.8.4-36ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd1-noxpm", pkgver:"1.8.4-36ubuntu0.1")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libgd1-xpm", pkgver:"1.8.4-36ubuntu0.1")) flag++;
