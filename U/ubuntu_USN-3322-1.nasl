...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 16.10 / 17.04 : exim4 vulnerability (USN-3322-1) (Stack Clash)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3322-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"exim4-daemon-heavy", pkgver:"4.82-3ubuntu2.3")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"exim4-daemon-light", pkgver:"4.82-3ubuntu2.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"exim4-daemon-heavy", pkgver:"4.86.2-2ubuntu2.2")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"exim4-daemon-light", pkgver:"4.86.2-2ubuntu2.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"exim4-daemon-heavy", pkgver:"4.87-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"exim4-daemon-light", pkgver:"4.87-3ubuntu1.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"exim4-daemon-heavy", pkgver:"4.88-5ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"exim4-daemon-light", pkgver:"4.88-5ubuntu1.1")) flag++;
