...
"Update the affected packages.");
  ...
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-184-generic");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-184-generic-lpae");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:linux-image-3.13.0-184-lowlatency");
...
pkgs = [
    {'osver': '18.04', 'pkgname': 'linux-image-5.0.0-1051-gke', 'pkgver': '5.0.0-1051.53'},
    {'osver': '18.04', 'pkgname': 'linux-image-5.3.0-1037-raspi2', 'pkgver': '5.3.0-1037.39'},
    {'osver': '18.04', 'pkgname': 'linux-image-5.3.0-1040-gke', 'pkgver': '5.3.0-1040.43'},
    {'osver': '18.04', 'pkgname': 'linux-image-5.3.0-70-generic', 'pkgver': '5.3.0-70.66'},
    {'osver': '18.04', 'pkgname': 'linux-image-5.3.0-70-lowlatency', 'pkgver': '5.3.0-70.66'},
    {'osver': '18.04', 'pkgname': 'linux-image-gke-5.0', 'pkgver': '5.0.0.1051.35'},
    {'osver': '18.04', 'pkgname': 'linux-image-gke-5.3', 'pkgver': '5.3.0.1040.23'},
    {'osver': '18.04', 'pkgname': 'linux-image-gkeop-5.3', 'pkgver': '5.3.0.70.127'},
    {'osver': '18.04', 'pkgname': 'linux-image-raspi2-hwe-18.04', 'pkgver': '5.3.0.1037.26'}
];
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, 'linux-image-5.0.0-1051-gke / linux-image-5.3.0-1037-raspi2 / etc');
}