...
# extracted from Ubuntu Security Notice USN-1466-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 11.10 / 12.04 LTS : nova vulnerability (USN-1466-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1466-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.10", pkgname:"python-nova", pkgver:"2011.3-0ubuntu6.7")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python-nova", pkgver:"2012.1-0ubuntu2.2")) flag++;
