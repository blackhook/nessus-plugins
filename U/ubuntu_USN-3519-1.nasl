...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.04 : tomcat7, tomcat8 vulnerabilities (USN-3519-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3519-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"libtomcat7-java", pkgver:"7.0.52-1ubuntu0.13")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"tomcat7", pkgver:"7.0.52-1ubuntu0.13")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libtomcat8-java", pkgver:"8.0.32-1ubuntu1.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"tomcat8", pkgver:"8.0.32-1ubuntu1.5")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libtomcat8-java", pkgver:"8.0.38-2ubuntu2.2")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"tomcat8", pkgver:"8.0.38-2ubuntu2.2")) flag++;
