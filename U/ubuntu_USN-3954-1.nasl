...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 18.10 / 19.04 : FreeRADIUS vulnerabilities (USN-3954-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3954-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"18.04", pkgname:"freeradius", pkgver:"3.0.16+dfsg-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"18.10", pkgname:"freeradius", pkgver:"3.0.16+dfsg-3ubuntu1.1")) flag++;
if (ubuntu_check(osver:"19.04", pkgname:"freeradius", pkgver:"3.0.17+dfsg-1ubuntu2.1")) flag++;
