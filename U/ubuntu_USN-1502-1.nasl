...
# extracted from Ubuntu Security Notice USN-1502-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS : xorg-server vulnerability (USN-1502-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1502-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"xserver-xorg-core", pkgver:"2:1.11.4-0ubuntu10.5")) flag++;
