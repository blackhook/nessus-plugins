...
# extracted from Ubuntu Security Notice USN-1266-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(50384);
  script_xref(name:"USN", value:"1266-1");

  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 / 11.10 : openldap vulnerability (USN-1266-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1266-1/"
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"slapd", pkgver:"2.4.21-0ubuntu5.6")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"slapd", pkgver:"2.4.23-0ubuntu3.7")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"slapd", pkgver:"2.4.23-6ubuntu6.1")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"slapd", pkgver:"2.4.25-1.1ubuntu4.1")) flag++;
