...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : linux-gcp vulnerability (USN-3484-3)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3484-3/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-4.10.0-1009-gcp", pkgver:"4.10.0-1009.9")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"linux-image-gcp", pkgver:"4.10.0.1009.11")) flag++;
