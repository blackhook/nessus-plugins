...
# extracted from Ubuntu Security Notice USN-3262-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 17.04 : curl vulnerability (USN-3262-1)");
...
when resuming a TLS session. A remote attacker could use this to
hijack a previously authenticated connection.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3262-1/"
  );
...
if (ubuntu_check(osver:"17.04", pkgname:"curl", pkgver:"7.52.1-4ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libcurl3", pkgver:"7.52.1-4ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libcurl3-gnutls", pkgver:"7.52.1-4ubuntu1.1")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"libcurl3-nss", pkgver:"7.52.1-4ubuntu1.1")) flag++;
