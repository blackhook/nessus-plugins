...
if (machine_kernel_release)
{
  ...
  if (preg(pattern:"^18.04$", string:os_release)) {
    kernel_pattern = "^5.4.0-\d+-(aws|azure|gcp|generic|generic-lpae|ibm|lowlatency|oracle|raspi)$";
    kernel_mappings = {
            "5.4.0-\d+(-generic|-generic-lpae|-lowlatency)" : "5.4.0-147",
            "5.4.0-\d+-aws" : "5.4.0-1100",
            "5.4.0-\d+-azure" : "5.4.0-1106",
            "5.4.0-\d+-gcp" : "5.4.0-1103",
            "5.4.0-\d+-ibm" : "5.4.0-1047",
            "5.4.0-\d+-oracle" : "5.4.0-1099",
            "5.4.0-\d+-raspi" : "5.4.0-1083"
    };
  };
  if (preg(pattern:"^20.04$", string:os_release)) {
    kernel_pattern = "^5.4.0-\d+-(aws|azure|gcp|generic|generic-lpae|gke|gkeop|ibm|kvm|lowlatency|oracle|raspi)$";
    kernel_mappings = {
            "5.4.0-\d+(-generic|-generic-lpae|-lowlatency)" : "5.4.0-147",
            "5.4.0-\d+-aws" : "5.4.0-1100",
            "5.4.0-\d+-azure" : "5.4.0-1106",
            "5.4.0-\d+-gcp" : "5.4.0-1103",
            "5.4.0-\d+-gke" : "5.4.0-1097",
            "5.4.0-\d+-gkeop" : "5.4.0-1067",
            "5.4.0-\d+-ibm" : "5.4.0-1047",
            "5.4.0-\d+-kvm" : "5.4.0-1089",
            "5.4.0-\d+-oracle" : "5.4.0-1099",
            "5.4.0-\d+-raspi" : "5.4.0-1083"
    };
  };
