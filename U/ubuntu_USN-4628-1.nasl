...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 20.10 : Intel Microcode vulnerabilities (USN-4628-1)");
...
vulnerabilities as referenced in the USN-4628-1 advisory. Note that Nessus has not tested for this issue but has instead
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'intel-microcode', 'pkgver': '3.20201110.0ubuntu0.20.10.1'}
];
