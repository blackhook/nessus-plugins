...
# extracted from Ubuntu Security Notice USN-453-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 : rdesktop regression (USN-453-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/453-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"6.06", pkgname:"rdesktop", pkgver:"1.4.1-1.1ubuntu0.6.06")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"rdesktop", pkgver:"1.4.1-1.1ubuntu0.6.10")) flag++;
