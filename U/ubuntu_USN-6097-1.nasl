...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS : Linux PTP vulnerability (USN-6097-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'linuxptp', 'pkgver': '1.6-1ubuntu0.1~esm1'},
    {'osver': '18.04', 'pkgname': 'linuxptp', 'pkgver': '1.8-1ubuntu0.1'},
    {'osver': '20.04', 'pkgname': 'linuxptp', 'pkgver': '1.9.2-1ubuntu0.1'}
];
