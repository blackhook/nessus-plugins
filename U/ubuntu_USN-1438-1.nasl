...
# extracted from Ubuntu Security Notice USN-1438-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(53297);
  script_xref(name:"USN", value:"1438-1");

  script_name(english:"Ubuntu 11.10 / 12.04 LTS : nova vulnerability (USN-1438-1)");
  ...
  script_set_attribute(
    ...
    value:
"Dan Prince discovered that Nova did not enforce quotas for security
groups and rules added to security groups. An authenticated user could
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1438-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.10", pkgname:"python-nova", pkgver:"2011.3-0ubuntu6.6")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python-nova", pkgver:"2012.1-0ubuntu2.1")) flag++;
