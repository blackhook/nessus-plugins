...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : AdvanceCOMP vulnerabilities (USN-5838-1)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'advancecomp', 'pkgver': '1.20-1ubuntu0.2+esm2'},
    {'osver': '18.04', 'pkgname': 'advancecomp', 'pkgver': '2.1-1ubuntu0.18.04.3'},
    {'osver': '20.04', 'pkgname': 'advancecomp', 'pkgver': '2.1-2.1ubuntu0.20.04.1'},
    {'osver': '22.04', 'pkgname': 'advancecomp', 'pkgver': '2.1-2.1ubuntu2.1'},
    {'osver': '22.10', 'pkgname': 'advancecomp', 'pkgver': '2.3-1ubuntu0.22.10.1'}
];
