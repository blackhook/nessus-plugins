...
# extracted from Ubuntu Security Notice USN-776-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.04 LTS / 8.10 : kvm vulnerabilities (USN-776-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/776-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"8.04", pkgname:"kvm", pkgver:"1:62+dfsg-0ubuntu8.1")) flag++;
if (ubuntu_check(osver:"8.04", pkgname:"kvm-source", pkgver:"62+dfsg-0ubuntu8.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"kvm", pkgver:"1:72+dfsg-1ubuntu6.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"kvm-source", pkgver:"72+dfsg-1ubuntu6.1")) flag++;
