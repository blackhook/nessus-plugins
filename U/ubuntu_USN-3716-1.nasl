...
for the upcoming Root Zone KSK Rollover.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3716-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"16.04", pkgname:"dnsmasq", pkgver:"2.75-1ubuntu0.16.04.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"dnsmasq-base", pkgver:"2.75-1ubuntu0.16.04.5")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"dnsmasq-utils", pkgver:"2.75-1ubuntu0.16.04.5")) flag++;
