...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.04 : curl vulnerabilities (USN-5021-1)");
...
vulnerabilities as referenced in the USN-5021-1 advisory.
...
pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'curl', 'pkgver': '7.74.0-1ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libcurl3-gnutls', 'pkgver': '7.74.0-1ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libcurl3-nss', 'pkgver': '7.74.0-1ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libcurl4', 'pkgver': '7.74.0-1ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libcurl4-gnutls-dev', 'pkgver': '7.74.0-1ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libcurl4-nss-dev', 'pkgver': '7.74.0-1ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libcurl4-openssl-dev', 'pkgver': '7.74.0-1ubuntu2.1'}
];
