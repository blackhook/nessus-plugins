...
# extracted from Ubuntu Security Notice USN-51-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : tetex-bin vulnerability (USN-51-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"Javier Fernandez-Sanguino Pena noticed that 'xdvizilla', an auxiliary
...
if (ubuntu_check(osver:"4.10", pkgname:"libkpathsea-dev", pkgver:"2.0.2-21ubuntu0.4")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libkpathsea3", pkgver:"2.0.2-21ubuntu0.4")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"tetex-bin", pkgver:"2.0.2-21ubuntu0.4")) flag++;
