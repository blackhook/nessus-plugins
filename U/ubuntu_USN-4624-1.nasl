...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 20.10 : libexif vulnerability (USN-4624-1)");
...
vulnerability as referenced in the USN-4624-1 advisory.
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'libexif-dev', 'pkgver': '0.6.22-2ubuntu0.1'},
    {'osver': '20.10', 'pkgname': 'libexif12', 'pkgver': '0.6.22-2ubuntu0.1'}
];
