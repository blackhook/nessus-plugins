...
# extracted from Ubuntu Security Notice USN-1721-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1721-1");

  script_name(english:"Ubuntu 12.10 : curl vulnerability (USN-1721-1)");
...
patches."
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that curl incorrectly handled SASL authentication
when communicating over POP3, SMTP or IMAP. If a user or automated
system were tricked into processing a specially crafted URL, an
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1721-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"12.10", pkgname:"libcurl3", pkgver:"7.27.0-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libcurl3-gnutls", pkgver:"7.27.0-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libcurl3-nss", pkgver:"7.27.0-1ubuntu1.1")) flag++;
