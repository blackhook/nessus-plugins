...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : linux vulnerabilities (USN-2420-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2420-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-40-generic", pkgver:"3.13.0-40.69")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-40-generic-lpae", pkgver:"3.13.0-40.69")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-40-lowlatency", pkgver:"3.13.0-40.69")) flag++;
