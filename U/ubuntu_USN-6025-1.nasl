...
if (machine_kernel_release)
{
  ...
  if (preg(pattern:"^20.04$", string:os_release)) {
    kernel_pattern = "^5.15.0-\d+-(aws|azure|gcp|gke|lowlatency|lowlatency-64k|oracle)$";
    kernel_mappings = {
            "5.15.0-\d+(-lowlatency|-lowlatency-64k)" : "5.15.0-70",
            "5.15.0-\d+-aws" : "5.15.0-1034",
            "5.15.0-\d+-azure" : "5.15.0-1036",
            "5.15.0-\d+-gcp" : "5.15.0-1032",
            "5.15.0-\d+-gke" : "5.15.0-1031",
            "5.15.0-\d+-oracle" : "5.15.0-1033"
    };
  };
  if (preg(pattern:"^22.04$", string:os_release)) {
    kernel_pattern = "^5.15.0-\d+-(aws|azure-fde|gcp|generic|generic-64k|generic-lpae|gke|gkeop|ibm|kvm|lowlatency|lowlatency-64k|oracle|raspi|raspi-nolpae)$";
    kernel_mappings = {
            "5.15.0-\d+(-generic|-generic-64k|-generic-lpae|-lowlatency|-lowlatency-64k)" : "5.15.0-70",
            "5.15.0-\d+(-gke|-kvm)" : "5.15.0-1031",
            "5.15.0-\d+(-raspi|-raspi-nolpae)" : "5.15.0-1027",
            "5.15.0-\d+-aws" : "5.15.0-1034",
            "5.15.0-\d+-azure-fde" : "5.15.0-1036",
            "5.15.0-\d+-gcp" : "5.15.0-1032",
            "5.15.0-\d+-gkeop" : "5.15.0-1018",
            "5.15.0-\d+-ibm" : "5.15.0-1028",
            "5.15.0-\d+-oracle" : "5.15.0-1033"
    };
  };
