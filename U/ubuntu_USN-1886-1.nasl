...
# extracted from Ubuntu Security Notice USN-1886-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.04 : puppet vulnerability (USN-1886-1)");
...
attacker on an untrusted client could use this issue to execute
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1886-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"puppet-common", pkgver:"2.7.11-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"puppet-common", pkgver:"2.7.18-1ubuntu1.2")) flag++;
if (ubuntu_check(osver:"13.04", pkgname:"puppet-common", pkgver:"2.7.18-4ubuntu1.1")) flag++;
