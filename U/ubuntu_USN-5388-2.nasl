...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.10 : OpenJDK vulnerabilities (USN-5388-2)");
...
referenced in the USN-5388-2 advisory.
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'openjdk-17-demo', 'pkgver': '17.0.3+7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'openjdk-17-jdk', 'pkgver': '17.0.3+7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'openjdk-17-jdk-headless', 'pkgver': '17.0.3+7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'openjdk-17-jre', 'pkgver': '17.0.3+7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'openjdk-17-jre-headless', 'pkgver': '17.0.3+7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'openjdk-17-jre-zero', 'pkgver': '17.0.3+7-0ubuntu0.21.10.1'},
    {'osver': '21.10', 'pkgname': 'openjdk-17-source', 'pkgver': '17.0.3+7-0ubuntu0.21.10.1'},
