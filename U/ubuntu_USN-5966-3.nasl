...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : amanda regression (USN-5966-3)");
...
vulnerabilities as referenced in the USN-5966-3 advisory.
  ...
  - local privilege escalation [fedora-all] (CVE-2022-37704)

  - crafted arguments to the runtar SUID binary leads to local privilege escalation to root [fedora-all]
    (CVE-2022-37705)
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'amanda-client', 'pkgver': '1:3.5.1-9ubuntu0.3'},
    {'osver': '22.10', 'pkgname': 'amanda-common', 'pkgver': '1:3.5.1-9ubuntu0.3'},
    {'osver': '22.10', 'pkgname': 'amanda-server', 'pkgver': '1:3.5.1-9ubuntu0.3'}
];
