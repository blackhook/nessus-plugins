...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 : libgcrypt11, libgcrypt20 vulnerability (USN-2896-1)");
...
that Libgcrypt was susceptible to an attack via physical side
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2896-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libgcrypt11", pkgver:"1.5.0-3ubuntu0.5")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libgcrypt11", pkgver:"1.5.3-2ubuntu4.3")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libgcrypt20", pkgver:"1.6.3-2ubuntu1.1")) flag++;
