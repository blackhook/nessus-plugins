...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS : BusyBox vulnerability (USN-5179-2)");
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'busybox', 'pkgver': '1:1.22.0-15ubuntu1.4+esm1'},
    {'osver': '16.04', 'pkgname': 'busybox-initramfs', 'pkgver': '1:1.22.0-15ubuntu1.4+esm1'},
    {'osver': '16.04', 'pkgname': 'busybox-static', 'pkgver': '1:1.22.0-15ubuntu1.4+esm1'},
    {'osver': '16.04', 'pkgname': 'busybox-syslogd', 'pkgver': '1:1.22.0-15ubuntu1.4+esm1'},
    {'osver': '16.04', 'pkgname': 'udhcpc', 'pkgver': '1:1.22.0-15ubuntu1.4+esm1'},
    {'osver': '16.04', 'pkgname': 'udhcpd', 'pkgver': '1:1.22.0-15ubuntu1.4+esm1'}
];
