...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.04 : libsndfile vulnerability (USN-5025-1)");
...
referenced in the USN-5025-1 advisory.
...
pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'libsndfile1', 'pkgver': '1.0.31-1ubuntu1.1'},
    {'osver': '21.04', 'pkgname': 'libsndfile1-dev', 'pkgver': '1.0.31-1ubuntu1.1'},
    {'osver': '21.04', 'pkgname': 'sndfile-programs', 'pkgver': '1.0.31-1ubuntu1.1'}
];
