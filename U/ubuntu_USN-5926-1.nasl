...
{
  if (! preg(pattern:"^(4.4.0-\d+-(generic|kvm|lowlatency))$", string:machine_kernel_release)) audit(AUDIT_INST_VER_NOT_VULN, 'kernel ' + machine_kernel_release);
  var extra = '';
  var kernel_mappings = {
    "4.4.0-\d+(-generic|-lowlatency)" : "4.4.0-237",
    "4.4.0-\d+-kvm" : "4.4.0-1117"
  };
