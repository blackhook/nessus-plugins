...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4484-1/"
  );
...
if (get_one_kb_item("Host/ksplice/kernel-cves"))
{
  ...
  cve_list = make_list("CVE-2020-14356");
...
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-1032-raspi2", pkgver:"5.3.0-1032.34")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-1034-aws", pkgver:"5.3.0-1034.36")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-1034-gke", pkgver:"5.3.0-1034.36")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-66-generic", pkgver:"5.3.0-66.60")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-5.3.0-66-lowlatency", pkgver:"5.3.0-66.60")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-aws", pkgver:"5.3.0.1034.33")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-gke-5.3", pkgver:"5.3.0.1034.19")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-gkeop-5.3", pkgver:"5.3.0.66.123")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"linux-image-raspi2-hwe-18.04", pkgver:"5.3.0.1032.22")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "linux-image-5.3-aws / linux-image-5.3-generic / linux-image-5.3-gke / etc");
}
