...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 16.04 LTS / 16.10 : dbus vulnerabilities (USN-3116-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3116-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"12.04", pkgname:"dbus", pkgver:"1.4.18-1ubuntu1.8")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"libdbus-1-3", pkgver:"1.4.18-1ubuntu1.8")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"dbus", pkgver:"1.6.18-0ubuntu4.4")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libdbus-1-3", pkgver:"1.6.18-0ubuntu4.4")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"dbus", pkgver:"1.10.6-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libdbus-1-3", pkgver:"1.10.6-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"dbus", pkgver:"1.10.10-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"16.10", pkgname:"libdbus-1-3", pkgver:"1.10.10-1ubuntu1.1")) flag++;
