...
# extracted from Ubuntu Security Notice USN-2160-1. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"2160-1");

  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.10 : libyaml vulnerability (USN-2160-1)");
  ...
  script_set_attribute(
    ...
    value:
"Ivan Fratric discovered that LibYAML incorrectly handled certain
malformed YAML documents. An attacker could use this issue to cause
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2160-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libyaml-0-2", pkgver:"0.1.4-2ubuntu0.12.04.3")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libyaml-0-2", pkgver:"0.1.4-2ubuntu0.12.10.3")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libyaml-0-2", pkgver:"0.1.4-2ubuntu0.13.10.3")) flag++;
