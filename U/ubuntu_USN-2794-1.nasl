...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS : linux vulnerabilities (USN-2794-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2794-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-67-generic", pkgver:"3.13.0-67.110")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-67-generic-lpae", pkgver:"3.13.0-67.110")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"linux-image-3.13.0-67-lowlatency", pkgver:"3.13.0-67.110")) flag++;
