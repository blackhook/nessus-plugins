...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.04 : Squashfs-Tools vulnerability (USN-5078-3)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing a security update.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 20.04 LTS / 21.04 host has a package installed that is affected by a vulnerability as referenced in
the USN-5078-3 advisory.
...
var pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'squashfs-tools', 'pkgver': '1:4.4-2ubuntu0.3'}
];
