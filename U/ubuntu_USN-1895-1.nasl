...
# extracted from Ubuntu Security Notice USN-1895-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 13.04 : libvirt vulnerability (USN-1895-1)");
  ...
  script_set_attribute(
    ...
    value:
"It was discovered that libvirt incorrectly handled certain storage
pool requests. A remote attacker could use this issue to cause libvirt
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1895-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libvirt0 package."
  );
...
if (ubuntu_check(osver:"13.04", pkgname:"libvirt0", pkgver:"1.0.2-0ubuntu11.13.04.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libvirt0");
}
