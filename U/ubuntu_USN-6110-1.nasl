...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 ESM / 18.04 ESM / 20.04 ESM / 22.04 ESM / 22.10 / 23.04 : Jhead vulnerabilities (USN-6110-1)");

  script_set_attribute(attribute:"synopsis", value:
"The remote Ubuntu host is missing one or more security updates.");
  script_set_attribute(attribute:"description", value:
"The remote Ubuntu 16.04 ESM / 18.04 ESM / 20.04 ESM / 22.04 ESM / 22.10 / 23.04 host has a package installed that is
affected by multiple vulnerabilities as referenced in the USN-6110-1 advisory.
...
var pkgs = [
    {'osver': '16.04', 'pkgname': 'jhead', 'pkgver': '1:3.00-4+deb9u1ubuntu0.1~esm3'},
    {'osver': '18.04', 'pkgname': 'jhead', 'pkgver': '1:3.00-8~ubuntu0.2+esm1'},
    {'osver': '20.04', 'pkgname': 'jhead', 'pkgver': '1:3.04-1ubuntu0.2+esm1'},
    {'osver': '22.04', 'pkgname': 'jhead', 'pkgver': '1:3.06.0.1-2ubuntu0.22.04.1+esm1'},
    {'osver': '22.10', 'pkgname': 'jhead', 'pkgver': '1:3.06.0.1-2ubuntu0.22.10.2'},
    {'osver': '23.04', 'pkgname': 'jhead', 'pkgver': '1:3.06.0.1-6ubuntu0.23.04.1'}
];
