...
# extracted from Ubuntu Security Notice USN-189-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(13159, 13291);
  script_xref(name:"USN", value:"189-1");

  script_name(english:"Ubuntu 4.10 / 5.04 : cpio vulnerabilities (USN-189-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"cpio", pkgver:"2.5-1.1ubuntu0.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"cpio", pkgver:"2.5-1.1ubuntu1.1")) flag++;
