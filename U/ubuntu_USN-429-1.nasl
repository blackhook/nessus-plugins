...
# extracted from Ubuntu Security Notice USN-429-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 / 6.06 LTS / 6.10 : tcpdump vulnerability (USN-429-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/429-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"5.10", pkgname:"tcpdump", pkgver:"3.9.1-1ubuntu1.1")) flag++;
if (ubuntu_check(osver:"6.06", pkgname:"tcpdump", pkgver:"3.9.4-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"tcpdump", pkgver:"3.9.4-4ubuntu0.1")) flag++;
