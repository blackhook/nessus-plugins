...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 21.04 : Libgcrypt vulnerabilities (USN-5080-1)");
...
vulnerabilities as referenced in the USN-5080-1 advisory.
...
var pkgs = [
    ...
    {'osver': '21.04', 'pkgname': 'libgcrypt-mingw-w64-dev', 'pkgver': '1.8.7-2ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libgcrypt20', 'pkgver': '1.8.7-2ubuntu2.1'},
    {'osver': '21.04', 'pkgname': 'libgcrypt20-dev', 'pkgver': '1.8.7-2ubuntu2.1'}
];
