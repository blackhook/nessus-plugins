...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 20.10 : Flatpak vulnerability (USN-4951-1)");
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'flatpak', 'pkgver': '1.8.2-1ubuntu0.2'},
    {'osver': '20.10', 'pkgname': 'flatpak-tests', 'pkgver': '1.8.2-1ubuntu0.2'},
    {'osver': '20.10', 'pkgname': 'gir1.2-flatpak-1.0', 'pkgver': '1.8.2-1ubuntu0.2'},
    {'osver': '20.10', 'pkgname': 'libflatpak-dev', 'pkgver': '1.8.2-1ubuntu0.2'},
    {'osver': '20.10', 'pkgname': 'libflatpak0', 'pkgver': '1.8.2-1ubuntu0.2'}
];
