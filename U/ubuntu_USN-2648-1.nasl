...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 14.10 / 15.04 : aptdaemon vulnerability (USN-2648-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2648-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"aptdaemon", pkgver:"0.43+bzr805-0ubuntu10")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"aptdaemon", pkgver:"1.1.1-1ubuntu5.2")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"aptdaemon", pkgver:"1.1.1+bzr980-0ubuntu1.1")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"aptdaemon", pkgver:"1.1.1+bzr982-0ubuntu3.1")) flag++;
