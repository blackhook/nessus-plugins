...
# extracted from Ubuntu Security Notice USN-1335-1. The text 
...
if (description)
{
  ...
  script_bugtraq_id(45678, 47168, 47169);
  script_xref(name:"USN", value:"1335-1");

  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 / 11.10 : t1lib vulnerabilities (USN-1335-1)");
  ...
  script_set_attribute(
    ...
    value:
"Jon Larimer discovered that t1lib did not properly parse AFM fonts. If
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1335-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libt1-5 package."
  );
...
if (ubuntu_check(osver:"10.04", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.10.04.2")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.10.10.2")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.11.04.2")) flag++;
if (ubuntu_check(osver:"11.10", pkgname:"libt1-5", pkgver:"5.1.2-3ubuntu0.11.10.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libt1-5");
}
