...
# extracted from Ubuntu Security Notice USN-70-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 : libdbi-perl vulnerabilities (USN-70-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libdbi-perl package."
  );
...
if (ubuntu_check(osver:"4.10", pkgname:"libdbi-perl", pkgver:"1.42-3ubuntu0.1")) flag++;
