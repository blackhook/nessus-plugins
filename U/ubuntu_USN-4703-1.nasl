...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 20.04 LTS / 20.10 : Mutt vulnerability (USN-4703-1)");
...
vulnerability as referenced in the USN-4703-1 advisory.
...
pkgs = [
    ...
    {'osver': '20.10', 'pkgname': 'mutt', 'pkgver': '1.14.6-1ubuntu0.2'}
];
