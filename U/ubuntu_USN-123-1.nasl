...
# extracted from Ubuntu Security Notice USN-123-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 4.10 / 5.04 : xine-lib vulnerabilities (USN-123-1)");
...
if (ubuntu_check(osver:"4.10", pkgname:"libxine-dev", pkgver:"1-rc5-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"4.10", pkgname:"libxine1", pkgver:"1-rc5-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxine-dev", pkgver:"1.0-1ubuntu3.1")) flag++;
if (ubuntu_check(osver:"5.04", pkgname:"libxine1", pkgver:"1.0-1ubuntu3.1")) flag++;
