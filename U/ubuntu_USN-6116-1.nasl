...
if (description)
{
  ...
  script_name(english:"Ubuntu 18.04 LTS / 20.04 LTS / 22.04 LTS / 22.10 : hawk vulnerability (USN-6116-1)");
...
vulnerability as referenced in the USN-6116-1 advisory.
...
var pkgs = [
    ...
    {'osver': '22.10', 'pkgname': 'node-hawk', 'pkgver': '8.0.1+dfsg-1ubuntu0.22.10.1'}
];
