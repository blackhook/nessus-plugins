...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 : pam regression (USN-2935-2)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2935-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"12.04", pkgname:"libpam-modules", pkgver:"1.1.3-7ubuntu2.2")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libpam-modules", pkgver:"1.1.8-1ubuntu2.2")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libpam-modules", pkgver:"1.1.8-3.1ubuntu3.2")) flag++;
