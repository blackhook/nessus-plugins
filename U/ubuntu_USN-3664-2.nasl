...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"USN-3664-1 fixed a vulnerability in Apport. Sander Bos reported that
Ubuntu 14.04 LTS was also vulnerable to this issue, but was
incorrectly omitted from the previous updates. This update provides
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3664-2/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"apport", pkgver:"2.14.1-0ubuntu3.29")) flag++;
