...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 17.04 / 17.10 : apport regression (USN-3480-3)");
...
regression in the container support. This update addresses the
problem.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3480-3/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"apport", pkgver:"2.20.1-0ubuntu2.15")) flag++;
if (ubuntu_check(osver:"17.04", pkgname:"apport", pkgver:"2.20.4-0ubuntu4.10")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"apport", pkgver:"2.20.7-0ubuntu3.7")) flag++;
