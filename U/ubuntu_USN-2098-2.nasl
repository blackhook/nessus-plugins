...
# extracted from Ubuntu Security Notice USN-2098-2. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 12.10 / 13.10 : libyaml regression (USN-2098-2)");
...
introduced a regression that caused parsing failures for certain valid
YAML files. This update fixes the problem.
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2098-2/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"libyaml-0-2", pkgver:"0.1.4-2ubuntu0.12.04.2")) flag++;
if (ubuntu_check(osver:"12.10", pkgname:"libyaml-0-2", pkgver:"0.1.4-2ubuntu0.12.10.2")) flag++;
if (ubuntu_check(osver:"13.10", pkgname:"libyaml-0-2", pkgver:"0.1.4-2ubuntu0.13.10.2")) flag++;
