...
# extracted from Ubuntu Security Notice USN-500-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 6.06 LTS / 6.10 / 7.04 : rsync vulnerability (USN-500-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/500-1/"
  );
...
if (ubuntu_check(osver:"6.06", pkgname:"rsync", pkgver:"2.6.6-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"6.10", pkgname:"rsync", pkgver:"2.6.8-2ubuntu3.1")) flag++;
if (ubuntu_check(osver:"7.04", pkgname:"rsync", pkgver:"2.6.9-3ubuntu1.1")) flag++;
