...
# extracted from Ubuntu Security Notice USN-1197-6. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 10.10 / 11.04 : qt4-x11 vulnerability (USN-1197-6)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1197-6/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"10.04", pkgname:"libqt4-network", pkgver:"4:4.6.2-0ubuntu5.3")) flag++;
if (ubuntu_check(osver:"10.10", pkgname:"libqt4-network", pkgver:"4:4.7.0-0ubuntu4.4")) flag++;
if (ubuntu_check(osver:"11.04", pkgname:"libqt4-network", pkgver:"4:4.7.2-0ubuntu6.3")) flag++;
