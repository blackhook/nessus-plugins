...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.04 / 15.10 : thunderbird vulnerabilities (USN-2859-1)");
  ...
  script_set_attribute(
    ...
    value:
"Andrei Vaida, Jesse Ruderman, Bob Clary, and Jesse Ruderman discovered
...
invoking Thunderbird. (CVE-2015-7201)
...
with the privileges of the user invoking Thunderbird. (CVE-2015-7205)
...
crash, or execute arbitrary code with the privileges of the user
invoking Thunderbird. (CVE-2015-7213)
...
could potentially exploit this to obtain sensitive information and
read local files. (CVE-2015-7214).
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/2859-1/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"12.04", pkgname:"thunderbird", pkgver:"1:38.5.1+build2-0ubuntu0.12.04.1")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"thunderbird", pkgver:"1:38.5.1+build2-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"15.04", pkgname:"thunderbird", pkgver:"1:38.5.1+build2-0ubuntu0.15.04.1")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"thunderbird", pkgver:"1:38.5.1+build2-0ubuntu0.15.10.1")) flag++;
