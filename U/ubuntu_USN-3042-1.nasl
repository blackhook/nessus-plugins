...
if (description)
{
  ...
  script_name(english:"Ubuntu 12.04 LTS / 14.04 LTS / 15.10 : kde4libs vulnerability (USN-3042-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3042-1/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"Update the affected libkdecore5 package."
  );
...
if (ubuntu_check(osver:"12.04", pkgname:"libkdecore5", pkgver:"4:4.8.5-0ubuntu0.5")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"libkdecore5", pkgver:"4:4.13.3-0ubuntu0.3")) flag++;
if (ubuntu_check(osver:"15.10", pkgname:"libkdecore5", pkgver:"4:4.14.13-0ubuntu1.1")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libkdecore5");
}
