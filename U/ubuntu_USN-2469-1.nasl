...
if (description)
{
  ...
  script_name(english:"Ubuntu 10.04 LTS / 12.04 LTS / 14.04 LTS / 14.10 : python-django vulnerabilities (USN-2469-1)");
...
if (ubuntu_check(osver:"10.04", pkgname:"python-django", pkgver:"1.1.1-2ubuntu1.14")) flag++;
if (ubuntu_check(osver:"12.04", pkgname:"python-django", pkgver:"1.3.1-4ubuntu1.13")) flag++;
if (ubuntu_check(osver:"14.04", pkgname:"python-django", pkgver:"1.6.1-2ubuntu0.6")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"python-django", pkgver:"1.6.6-1ubuntu2.1")) flag++;
if (ubuntu_check(osver:"14.10", pkgname:"python3-django", pkgver:"1.6.6-1ubuntu2.1")) flag++;
