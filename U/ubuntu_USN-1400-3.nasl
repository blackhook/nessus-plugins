...
# extracted from Ubuntu Security Notice USN-1400-3. The text 
...
if (description)
{
  ...
  script_xref(name:"USN", value:"1400-3");

  script_name(english:"Ubuntu 11.10 : thunderbird vulnerabilities (USN-1400-3)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/1400-3/"
  );
  script_set_attribute(
    attribute:"solution", 
...
if (ubuntu_check(osver:"11.10", pkgname:"thunderbird", pkgver:"11.0+build1-0ubuntu0.11.10.1")) flag++;
