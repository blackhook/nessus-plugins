...
# extracted from Ubuntu Security Notice USN-217-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.10 : inkscape vulnerability (USN-217-1)");
...
if (ubuntu_check(osver:"5.10", pkgname:"inkscape", pkgver:"0.42-1build1ubuntu0.1")) flag++;
