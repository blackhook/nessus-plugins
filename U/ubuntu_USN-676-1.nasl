...
# extracted from Ubuntu Security Notice USN-676-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 8.10 : webkit vulnerability (USN-676-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/676-1/"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
if (ubuntu_check(osver:"8.10", pkgname:"libwebkit-1.0-1", pkgver:"1.0.1-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"libwebkit-1.0-1-dbg", pkgver:"1.0.1-2ubuntu0.1")) flag++;
if (ubuntu_check(osver:"8.10", pkgname:"libwebkit-dev", pkgver:"1.0.1-2ubuntu0.1")) flag++;
