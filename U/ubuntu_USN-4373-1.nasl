...
if (description)
{
  ...
  script_name(english:"Ubuntu 16.04 LTS / 18.04 LTS / 19.10 / 20.04 : Thunderbird vulnerabilities (USN-4373-1)");
...
of service, or execute arbitrary code. (CVE-2020-6831, CVE-2020-12387,
CVE-2020-12395)

It was discovered that the Devtools' 'Copy as cURL' feature did
not properly escape the HTTP POST data of a request. If a user were
tricked in to using the 'Copy as cURL' feature to copy and paste a
command with specially crafted data in to a terminal, an attacker
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/4373-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"16.04", pkgname:"thunderbird", pkgver:"1:68.8.0+build2-0ubuntu0.16.04.2")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"thunderbird", pkgver:"1:68.8.0+build2-0ubuntu0.18.04.2")) flag++;
if (ubuntu_check(osver:"19.10", pkgname:"thunderbird", pkgver:"1:68.8.0+build2-0ubuntu0.19.10.2")) flag++;
if (ubuntu_check(osver:"20.04", pkgname:"thunderbird", pkgver:"1:68.8.0+build2-0ubuntu0.20.04.2")) flag++;
