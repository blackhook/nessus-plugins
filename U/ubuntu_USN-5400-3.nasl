...
if (description)
{
  ...
  script_name(english:"Ubuntu 20.04 LTS / 21.10 / 22.04 LTS : MySQL regression (USN-5400-3)");
...
referenced in the USN-5400-3 advisory.
...
var pkgs = [
    ...
    {'osver': '21.10', 'pkgname': 'libmysqlclient-dev', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'libmysqlclient21', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-client', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-client-8.0', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-client-core-8.0', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-router', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-server', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-server-8.0', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-server-core-8.0', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-source-8.0', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-testsuite', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
    {'osver': '21.10', 'pkgname': 'mysql-testsuite-8.0', 'pkgver': '8.0.29-0ubuntu0.21.10.2'},
