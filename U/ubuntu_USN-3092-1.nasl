...
if (description)
{
  ...
  script_set_attribute(
    ...
    value:
"Stefan Metzmacher discovered that Samba incorrectly handled certain
flags in SMB2/3 client connections. A remote attacker could use this
issue to disable client signing and impersonate servers by performing
a man in the middle attack.

Samba has been updated to 4.3.11 in Ubuntu 14.04 LTS and Ubuntu 16.04
LTS. In addition to the security fix, the updated packages contain bug
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3092-1/"
  );
...
if (ubuntu_check(osver:"14.04", pkgname:"samba", pkgver:"2:4.3.11+dfsg-0ubuntu0.14.04.1")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"samba", pkgver:"2:4.3.11+dfsg-0ubuntu0.16.04.1")) flag++;
