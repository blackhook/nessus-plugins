...
if (description)
{
  ...
  script_name(english:"Ubuntu 14.04 LTS / 16.04 LTS / 17.10 / 18.04 LTS : libsoup2.4 vulnerability (USN-3701-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://usn.ubuntu.com/3701-1/"
  );
  script_set_attribute(
    attribute:"solution",
...
if (ubuntu_check(osver:"14.04", pkgname:"libsoup2.4-1", pkgver:"2.44.2-1ubuntu2.3")) flag++;
if (ubuntu_check(osver:"16.04", pkgname:"libsoup2.4-1", pkgver:"2.52.2-1ubuntu0.3")) flag++;
if (ubuntu_check(osver:"17.10", pkgname:"libsoup2.4-1", pkgver:"2.60.1-1ubuntu0.1")) flag++;
if (ubuntu_check(osver:"18.04", pkgname:"libsoup2.4-1", pkgver:"2.62.1-1ubuntu0.1")) flag++;
