...
# extracted from Ubuntu Security Notice USN-113-1. The text 
...
if (description)
{
  ...
  script_name(english:"Ubuntu 5.04 : libnet-ssleay-perl vulnerability (USN-113-1)");
...
without introducing additional issues."
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Update the affected libnet-ssleay-perl package."
  );
  script_set_cvss_base_vector("CVSS2#AV:L/AC:L/Au:N/C:P/I:P/A:P");

  script_set_attribute(attribute:"plugin_type", value:"local");
  script_set_attribute(attribute:"cpe", value:"p-cpe:/a:canonical:ubuntu_linux:libnet-ssleay-perl");
...
if (ubuntu_check(osver:"5.04", pkgname:"libnet-ssleay-perl", pkgver:"1.25-1ubuntu0.2")) flag++;
...
else
{
  ...
  else audit(AUDIT_PACKAGE_NOT_INSTALLED, "libnet-ssleay-perl");
}
