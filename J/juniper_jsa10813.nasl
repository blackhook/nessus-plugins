...
if (description)
{
  ...
  script_cve_id("CVE-2017-10610");
  script_xref(name:"JSA", value:"JSA10813");

  script_name(english:"Juniper Junos SRX Flowd Crash Vulnerability (JSA10813)");
...
within a NAT64 IPv6 to IPv4 tunnel may cause the flowd process to crash.");
  # https://kb.juniper.net/InfoCenter/index?page=content&id=JSA10813&actp=METADATA
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e847046b");
...
# Affects 12.1X46, 12.3X48, 15.1X49
fixes = make_array();
