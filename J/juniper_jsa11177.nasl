...
number.");
  script_set_attribute(attribute:"see_also", value:"https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2017-1087");
  script_set_attribute(attribute:"see_also", value:"https://kb.juniper.net/JSA11177");
