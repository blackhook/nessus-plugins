...
var constraints = [
    {'max_version' : '1.1', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Agent Server Parameter Plugin']},
    {'max_version' : '1.10', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Beaker builder Plugin']},
    {'max_version' : '1.1', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Convertigo Mobile Platform Plugin']},
    {'max_version' : '1.9', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['CRX Content Package Deployer Plugin']},
    {'max_version' : '0.0.4', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Date Parameter Plugin']},
    {'max_version' : '1.0.1', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Dynamic Extended Choice Parameter Plugin']},
    {'max_version' : '1.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['EasyQA Plugin']},
    {'max_version' : '2.0.3', 'fixed_version' : '2.0.4', 'plugin' : jenkins_plugin_mappings['Embeddable Build Status Plugin']},
    {'max_version' : '0.0.7', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Filesystem List Parameter Plugin']},
    {'max_version' : '0.0.4', 'fixed_version' : '0.0.5', 'plugin' : jenkins_plugin_mappings['Hidden Parameter Plugin']},
    {'max_version' : '1.10', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Image Tag Parameter Plugin']},
    {'max_version' : '1.1', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Jianliao Notification Plugin']},
    {'max_version' : '1119', 'fixed_version' : '1119.1121', 'fixed_display' : '1119.1121.vc43d0fc45561', 'plugin' : jenkins_plugin_mappings['JUnit Plugin']},
    {'max_version' : '2.1', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Maven Metadata Plugin for Jenkins CI server Plugin']},
    {'max_version' : '1.25', 'fixed_version' : '1.26', 'plugin' : jenkins_plugin_mappings['Nested View Plugin']},
    {'max_version' : '4.8.0.77', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['NS-ND Integration Performance Publisher Plugin']},
    {'max_version' : '4.0.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['ontrack Jenkins Plugin']},
    {'max_version' : '1.0.1', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Package Version Plugin']},
    {'max_version' : '448', 'fixed_version' : '449', 'fixed_display' : '449.v77f0e8b_845c4', 'plugin' : jenkins_plugin_mappings['Pipeline: Input Step Plugin']},
    {'max_version' : '1.0.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Readonly Parameter Plugin']},
    {'max_version' : '2.2.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Repository Connector Plugin']},
    {'max_version' : '1.5.2', 'fixed_version' : '1.6.0', 'plugin' : jenkins_plugin_mappings['REST List Parameter Plugin']},
    {'max_version' : '1.204', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Sauce OnDemand Plugin']},
    {'max_version' : '1.0.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Squash TM Publisher (Squash4Jenkins) Plugin']},
    {'max_version' : '0.3.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Stash Branch Parameter Plugin']},
    {'max_version' : '1.5.4', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['ThreadFix Plugin']},
    {'max_version' : '3.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['vRealize Orchestrator Plugin']},
    {'max_version' : '3.0.8', 'fixed_version' : '3.1.0', 'plugin' : jenkins_plugin_mappings['xUnit Plugin']}
];
