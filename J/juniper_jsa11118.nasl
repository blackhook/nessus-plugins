...
version number.");
  script_set_attribute(attribute:"see_also", value:"https://kb.juniper.net/JSA11118");
...
if (model =~ '^ACX5448')
{
  append_element(var:vuln_ranges, value:{'min_ver':'18.2', 'fixed_ver':'18.2R3-S8'});
  append_element(var:vuln_ranges, value:{'min_ver':'18.3', 'fixed_ver':'18.3R3-S5'});
  append_element(var:vuln_ranges, value:{'min_ver':'18.4', 'fixed_ver':'18.4R1-S6'});
  append_element(var:vuln_ranges, value:{'min_ver':'19.1', 'fixed_ver':'19.1R3-S5'});
  append_element(var:vuln_ranges, value:{'min_ver':'19.2', 'fixed_ver':'19.2R2'});
  append_element(var:vuln_ranges, value:{'min_ver':'19.3', 'fixed_ver':'19.3R3'});
  append_element(var:vuln_ranges, value:{'min_ver':'19.4', 'fixed_ver':'19.4R3'});
  append_element(var:vuln_ranges, value:{'min_ver':'20.1', 'fixed_ver':'20.1R2'});
}
