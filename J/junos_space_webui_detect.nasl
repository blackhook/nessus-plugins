...
for Junos Space, was detected on the remote host."
  ...
  script_set_attribute(attribute:"see_also", value:"https://www.juniper.net/us/en/products-services/network-management/");
...
install = add_install(appname:'junos_space', dir:dir, port:port, cpe: "cpe:/a:juniper:junos_space");
