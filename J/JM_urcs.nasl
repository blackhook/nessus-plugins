...
the remote system to launch other attacks.");
  script_set_attribute(attribute:"see_also", value:"https://sourceforge.net/projects/urcs/");
...
intended to be installed.");
  ...
  script_copyright(english:"This script is Copyright(C) 2004-2022 J.Mlodzianowski");
