...
if (description)
{
  ...
  script_name(english:"Juniper Junos IS-IS hello DoS (PSN-2012-07-647)");
  ...
  script_set_attribute(
    ...
    value:
"According to its self-reported version number, the rpd daemon
on remote Junos router may crash when processing malformed IS-IS
hello messages."
  );
  # http://www.juniper.net/alerts/viewalert.jsp?actionBtn=Search&txtAlertNumber=PSN-2012-07-647&viewMode=view
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?af4a39cd");
  script_set_attribute(
    attribute:"solution",
    value:
