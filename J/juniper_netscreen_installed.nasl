...
if (description)
{
  ...
  script_xref(name:"IAVT", value:"0001-T-0914");
  ...
  # https://www.juniper.net/documentation/en_US/release-independent/netscreen-remote/information-products/pathway-pages/netscreen-remote/product/index.html
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e32c172f");
...
register_install(
  ...
  path:path,
  vendor:"Juniper",
  product:"NetScreen Remote VPN Client",
  version:version,
