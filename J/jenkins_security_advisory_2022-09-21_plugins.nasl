...
var constraints = [
    {'max_version' : '1.0.24', 'fixed_version' : '1.0.25', 'plugin' : jenkins_plugin_mappings['Anchore Container Image Scanner Plugin']},
    {'max_version' : '2.2.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Apprenda Plugin']},
    {'max_version' : '1.4.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['BigPanda Notifier Plugin']},
    {'max_version' : '1.22', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['build-publisher Plugin']},
    {'max_version' : '1.0.14', 'fixed_version' : '1.0.15', 'plugin' : jenkins_plugin_mappings['Compuware Common Configuration Plugin']},
    {'max_version' : '1.0.0', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['CONS3RT Plugin']},
    {'max_version' : '2.40.00', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['DotCi Plugin']},
    {'max_version' : '1.7', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['extreme-feedback Plugin']},
    {'max_version' : '4.8.0.134', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['NS-ND Integration Performance Publisher Plugin']},
    {'max_version' : '2.8', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['RQM Plugin']},
    {'max_version' : '3.6.11', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Rundeck Plugin']},
    {'max_version' : '1.5', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['SCM HttpClient Plugin']},
    {'max_version' : '117', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Security Inspector Plugin']},
    {'max_version' : '1.0.4', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['SmallTest Plugin']},
    {'max_version' : '1.0.7', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['View26 Test-Reporting Plugin']},
    {'max_version' : '1.0.1', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Walti Plugin']},
    {'max_version' : '1.0.2', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['WildFly Deployer Plugin']},
    {'max_version' : '10.0.3.503', 'fixed_display' : 'See vendor advisory', 'plugin' : jenkins_plugin_mappings['Worksoft Execution Manager Plugin']}
];
